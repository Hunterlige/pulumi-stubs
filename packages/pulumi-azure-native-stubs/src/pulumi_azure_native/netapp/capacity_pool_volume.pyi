...
class CapacityPoolVolume(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., avs_data_store: Optional[pulumi.Input[Union[_builtins.str, AvsDataStore]]] = ..., backup_id: Optional[pulumi.Input[_builtins.str]] = ..., capacity_pool_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., cool_access: Optional[pulumi.Input[_builtins.bool]] = ..., cool_access_retrieval_policy: Optional[pulumi.Input[Union[_builtins.str, CoolAccessRetrievalPolicy]]] = ..., cool_access_tiering_policy: Optional[pulumi.Input[Union[_builtins.str, CoolAccessTieringPolicy]]] = ..., coolness_period: Optional[pulumi.Input[_builtins.int]] = ..., creation_token: Optional[pulumi.Input[_builtins.str]] = ..., data_protection: Optional[pulumi.Input[Union[VolumePropertiesDataProtectionArgs, VolumePropertiesDataProtectionArgsDict]]] = ..., default_group_quota_in_ki_bs: Optional[pulumi.Input[_builtins.float]] = ..., default_user_quota_in_ki_bs: Optional[pulumi.Input[_builtins.float]] = ..., delete_base_snapshot: Optional[pulumi.Input[_builtins.bool]] = ..., enable_subvolumes: Optional[pulumi.Input[Union[_builtins.str, EnableSubvolumes]]] = ..., encryption_key_source: Optional[pulumi.Input[Union[_builtins.str, EncryptionKeySource]]] = ..., export_policy: Optional[pulumi.Input[Union[VolumePropertiesExportPolicyArgs, VolumePropertiesExportPolicyArgsDict]]] = ..., is_default_quota_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_large_volume: Optional[pulumi.Input[_builtins.bool]] = ..., is_restoring: Optional[pulumi.Input[_builtins.bool]] = ..., kerberos_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., key_vault_private_endpoint_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., ldap_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., network_features: Optional[pulumi.Input[Union[_builtins.str, NetworkFeatures]]] = ..., placement_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[PlacementKeyValuePairsArgs, PlacementKeyValuePairsArgsDict]]]]] = ..., pool_name: Optional[pulumi.Input[_builtins.str]] = ..., protocol_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., proximity_placement_group: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., security_style: Optional[pulumi.Input[Union[_builtins.str, SecurityStyle]]] = ..., service_level: Optional[pulumi.Input[Union[_builtins.str, ServiceLevel]]] = ..., smb_access_based_enumeration: Optional[pulumi.Input[Union[_builtins.str, SmbAccessBasedEnumeration]]] = ..., smb_continuously_available: Optional[pulumi.Input[_builtins.bool]] = ..., smb_encryption: Optional[pulumi.Input[_builtins.bool]] = ..., smb_non_browsable: Optional[pulumi.Input[Union[_builtins.str, SmbNonBrowsable]]] = ..., snapshot_directory_visible: Optional[pulumi.Input[_builtins.bool]] = ..., snapshot_id: Optional[pulumi.Input[_builtins.str]] = ..., subnet_id: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., throughput_mibps: Optional[pulumi.Input[_builtins.float]] = ..., unix_permissions: Optional[pulumi.Input[_builtins.str]] = ..., usage_threshold: Optional[pulumi.Input[_builtins.float]] = ..., volume_name: Optional[pulumi.Input[_builtins.str]] = ..., volume_spec_name: Optional[pulumi.Input[_builtins.str]] = ..., volume_type: Optional[pulumi.Input[_builtins.str]] = ..., zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: CapacityPoolVolumeArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> CapacityPoolVolume:
