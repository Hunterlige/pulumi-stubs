...
class ElasticCapacityPoolArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[ElasticCapacityPoolPropertiesArgs]] = ...,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[ElasticCapacityPoolPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[ElasticCapacityPoolPropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class ElasticCapacityPool(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.ElasticCapacityPoolPropertiesResponse]: ...
    @_builtins.property
