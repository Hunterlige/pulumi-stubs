...
@pulumi.input_type
class BackupArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], backup_vault_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], volume_resource_id: pulumi.Input[_builtins.str], backup_name: Optional[pulumi.Input[_builtins.str]] = ..., label: Optional[pulumi.Input[_builtins.str]] = ..., snapshot_name: Optional[pulumi.Input[_builtins.str]] = ..., use_existing_snapshot: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def volume_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def use_existing_snapshot(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class Backup(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., backup_name: Optional[pulumi.Input[_builtins.str]] = ..., backup_vault_name: Optional[pulumi.Input[_builtins.str]] = ..., label: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., snapshot_name: Optional[pulumi.Input[_builtins.str]] = ..., use_existing_snapshot: Optional[pulumi.Input[_builtins.bool]] = ..., volume_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
