...
class ElasticVolumeArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[ElasticVolumePropertiesArgs]] = ...,
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[ElasticVolumePropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class ElasticVolume(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[ElasticVolumePropertiesArgs, ElasticVolumePropertiesArgsDict]
            ]
        ] = ...,
