...
class ElasticBackupPolicyArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[ElasticBackupPolicyPropertiesArgs]] = ...,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[ElasticBackupPolicyPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[ElasticBackupPolicyPropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class ElasticBackupPolicy(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.ElasticBackupPolicyPropertiesResponse]: ...
    @_builtins.property
