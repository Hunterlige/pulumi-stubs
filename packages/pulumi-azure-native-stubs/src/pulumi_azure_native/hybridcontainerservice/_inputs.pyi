...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AADProfileArgs', 'AADProfileArgsDict', 'AddonProfilesArgs', 'AddonProfilesArgsDict', 'AgentPoolExtendedLocationArgs', 'AgentPoolExtendedLocationArgsDict', 'AgentPoolProvisioningStatusErrorArgs', 'AgentPoolProvisioningStatusErrorArgsDict', 'AgentPoolProvisioningStatusProvisioningStatusArgs', ..., 'AgentPoolProvisioningStatusStatusArgs', 'AgentPoolProvisioningStatusStatusArgsDict', 'ArcAgentProfileArgs', 'ArcAgentProfileArgsDict', 'CloudProviderProfileInfraNetworkProfileArgs', 'CloudProviderProfileInfraNetworkProfileArgsDict', 'CloudProviderProfileInfraStorageProfileArgs', 'CloudProviderProfileInfraStorageProfileArgsDict', 'CloudProviderProfileArgs', 'CloudProviderProfileArgsDict', ..., ..., 'ControlPlaneProfileArgs', 'ControlPlaneProfileArgsDict', 'ExtendedLocationArgs', 'ExtendedLocationArgsDict', 'HttpProxyConfigArgs', 'HttpProxyConfigArgsDict', 'LinuxProfilePropertiesPublicKeysArgs', 'LinuxProfilePropertiesPublicKeysArgsDict', 'LinuxProfilePropertiesSshArgs', 'LinuxProfilePropertiesSshArgsDict', 'LinuxProfilePropertiesArgs', 'LinuxProfilePropertiesArgsDict', 'LoadBalancerProfileArgs', 'LoadBalancerProfileArgsDict', 'NamedAgentPoolProfileArgs', 'NamedAgentPoolProfileArgsDict', 'NetworkProfileArgs', 'NetworkProfileArgsDict', 'ProvisionedClusterIdentityArgs', 'ProvisionedClusterIdentityArgsDict', 'ProvisionedClustersAllPropertiesArgs', 'ProvisionedClustersAllPropertiesArgsDict', 'ProvisionedClustersCommonPropertiesFeaturesArgs', ..., 'ProvisionedClustersExtendedLocationArgs', 'ProvisionedClustersExtendedLocationArgsDict', 'StorageSpacesExtendedLocationArgs', 'StorageSpacesExtendedLocationArgsDict', 'StorageSpacesPropertiesErrorArgs', 'StorageSpacesPropertiesErrorArgsDict', 'StorageSpacesPropertiesHciStorageProfileArgs', 'StorageSpacesPropertiesHciStorageProfileArgsDict', 'StorageSpacesPropertiesProvisioningStatusArgs', 'StorageSpacesPropertiesProvisioningStatusArgsDict', 'StorageSpacesPropertiesStatusArgs', 'StorageSpacesPropertiesStatusArgsDict', 'StorageSpacesPropertiesVmwareStorageProfileArgs', ..., 'StorageSpacesPropertiesArgs', 'StorageSpacesPropertiesArgsDict', 'VirtualNetworksExtendedLocationArgs', 'VirtualNetworksExtendedLocationArgsDict', 'VirtualNetworksPropertiesHciArgs', 'VirtualNetworksPropertiesHciArgsDict', 'VirtualNetworksPropertiesInfraVnetProfileArgs', 'VirtualNetworksPropertiesInfraVnetProfileArgsDict', 'VirtualNetworksPropertiesNetworkCloudArgs', 'VirtualNetworksPropertiesNetworkCloudArgsDict', 'VirtualNetworksPropertiesVipPoolArgs', 'VirtualNetworksPropertiesVipPoolArgsDict', 'VirtualNetworksPropertiesVmipPoolArgs', 'VirtualNetworksPropertiesVmipPoolArgsDict', 'VirtualNetworksPropertiesVmwareArgs', 'VirtualNetworksPropertiesVmwareArgsDict', 'VirtualNetworksPropertiesArgs', 'VirtualNetworksPropertiesArgsDict', 'WindowsProfileArgs', 'WindowsProfileArgsDict']
...
class AddonProfilesArgs:
    def __init__(__self__, *, config: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class AgentPoolProvisioningStatusProvisioningStatusArgs:
    def __init__(__self__, *, error: Optional[pulumi.Input[AgentPoolProvisioningStatusErrorArgs]] = ..., operation_id: Optional[pulumi.Input[_builtins.str]] = ..., phase: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @error.setter
    def error(self, value: Optional[pulumi.Input[AgentPoolProvisioningStatusErrorArgs]]): # -> None:
        ...
...
class AgentPoolProvisioningStatusStatusArgs:
    def __init__(__self__, *, error_message: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_status: Optional[pulumi.Input[AgentPoolProvisioningStatusProvisioningStatusArgs]] = ..., ready_replicas: Optional[pulumi.Input[_builtins.int]] = ..., replicas: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def provisioning_status(self, value: Optional[pulumi.Input[AgentPoolProvisioningStatusProvisioningStatusArgs]]): # -> None:
        ...
    ...
    def ready_replicas(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ArcAgentProfileArgs:
    def __init__(__self__, *, agent_auto_upgrade: Optional[pulumi.Input[Union[_builtins.str, AutoUpgradeOptions]]] = ..., agent_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CloudProviderProfileInfraNetworkProfileArgs:
    def __init__(__self__, *, vnet_subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def vnet_subnet_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class CloudProviderProfileInfraStorageProfileArgs:
    def __init__(__self__, *, storage_space_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def storage_space_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class CloudProviderProfileArgs:
    def __init__(__self__, *, infra_network_profile: Optional[pulumi.Input[CloudProviderProfileInfraNetworkProfileArgs]] = ..., infra_storage_profile: Optional[pulumi.Input[CloudProviderProfileInfraStorageProfileArgs]] = ...) -> None:
    ...
    def infra_network_profile(self, value: Optional[pulumi.Input[CloudProviderProfileInfraNetworkProfileArgs]]): # -> None:
        ...
    ...
    def infra_storage_profile(self, value: Optional[pulumi.Input[CloudProviderProfileInfraStorageProfileArgs]]): # -> None:
        ...
...
class ControlPlaneEndpointProfileControlPlaneEndpointArgs:
    def __init__(__self__, *, host_ip: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ControlPlaneProfileArgs:
    def __init__(__self__, *, availability_zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., cloud_provider_profile: Optional[pulumi.Input[CloudProviderProfileArgs]] = ..., control_plane_endpoint: Optional[pulumi.Input[ControlPlaneEndpointProfileControlPlaneEndpointArgs]] = ..., count: Optional[pulumi.Input[_builtins.int]] = ..., linux_profile: Optional[pulumi.Input[LinuxProfilePropertiesArgs]] = ..., max_count: Optional[pulumi.Input[_builtins.int]] = ..., max_pods: Optional[pulumi.Input[_builtins.int]] = ..., min_count: Optional[pulumi.Input[_builtins.int]] = ..., mode: Optional[pulumi.Input[Union[_builtins.str, Mode]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., node_image_version: Optional[pulumi.Input[_builtins.str]] = ..., node_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., node_taints: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., os_type: Optional[pulumi.Input[Union[_builtins.str, OsType]]] = ..., vm_size: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def control_plane_endpoint(self, value: Optional[pulumi.Input[ControlPlaneEndpointProfileControlPlaneEndpointArgs]]): # -> None:
        ...
    ...
    def linux_profile(self, value: Optional[pulumi.Input[LinuxProfilePropertiesArgs]]): # -> None:
        ...
...
class HttpProxyConfigArgs:
    def __init__(__self__, *, http_proxy: Optional[pulumi.Input[_builtins.str]] = ..., https_proxy: Optional[pulumi.Input[_builtins.str]] = ..., no_proxy: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., password: Optional[pulumi.Input[_builtins.str]] = ..., trusted_ca: Optional[pulumi.Input[_builtins.str]] = ..., username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LinuxProfilePropertiesSshArgs:
    def __init__(__self__, *, public_keys: Optional[pulumi.Input[Sequence[pulumi.Input[LinuxProfilePropertiesPublicKeysArgs]]]] = ...) -> None:
    ...
    @public_keys.setter
    def public_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LinuxProfilePropertiesPublicKeysArgs]]]]): # -> None:
        ...
...
class LinuxProfilePropertiesArgs:
    def __init__(__self__, *, admin_username: Optional[pulumi.Input[_builtins.str]] = ..., ssh: Optional[pulumi.Input[LinuxProfilePropertiesSshArgs]] = ...) -> None:
    ...
    @ssh.setter
    def ssh(self, value: Optional[pulumi.Input[LinuxProfilePropertiesSshArgs]]): # -> None:
        ...
...
class NamedAgentPoolProfileArgs:
    def __init__(__self__, *, availability_zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., cloud_provider_profile: Optional[pulumi.Input[CloudProviderProfileArgs]] = ..., count: Optional[pulumi.Input[_builtins.int]] = ..., max_count: Optional[pulumi.Input[_builtins.int]] = ..., max_pods: Optional[pulumi.Input[_builtins.int]] = ..., min_count: Optional[pulumi.Input[_builtins.int]] = ..., mode: Optional[pulumi.Input[Union[_builtins.str, Mode]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., node_image_version: Optional[pulumi.Input[_builtins.str]] = ..., node_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., node_taints: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., os_type: Optional[pulumi.Input[Union[_builtins.str, OsType]]] = ..., vm_size: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NetworkProfileArgs:
    def __init__(__self__, *, dns_service_ip: Optional[pulumi.Input[_builtins.str]] = ..., load_balancer_profile: Optional[pulumi.Input[LoadBalancerProfileArgs]] = ..., load_balancer_sku: Optional[pulumi.Input[Union[_builtins.str, LoadBalancerSku]]] = ..., network_policy: Optional[pulumi.Input[Union[_builtins.str, NetworkPolicy]]] = ..., pod_cidr: Optional[pulumi.Input[_builtins.str]] = ..., pod_cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., service_cidr: Optional[pulumi.Input[_builtins.str]] = ..., service_cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ProvisionedClustersAllPropertiesArgs:
    def __init__(__self__, *, aad_profile: Optional[pulumi.Input[AADProfileArgs]] = ..., addon_profiles: Optional[pulumi.Input[Mapping[str, pulumi.Input[AddonProfilesArgs]]]] = ..., agent_pool_profiles: Optional[pulumi.Input[Sequence[pulumi.Input[NamedAgentPoolProfileArgs]]]] = ..., cloud_provider_profile: Optional[pulumi.Input[CloudProviderProfileArgs]] = ..., control_plane: Optional[pulumi.Input[ControlPlaneProfileArgs]] = ..., enable_rbac: Optional[pulumi.Input[_builtins.bool]] = ..., features: Optional[pulumi.Input[ProvisionedClustersCommonPropertiesFeaturesArgs]] = ..., http_proxy_config: Optional[pulumi.Input[HttpProxyConfigArgs]] = ..., kubernetes_version: Optional[pulumi.Input[_builtins.str]] = ..., linux_profile: Optional[pulumi.Input[LinuxProfilePropertiesArgs]] = ..., network_profile: Optional[pulumi.Input[NetworkProfileArgs]] = ..., node_resource_group: Optional[pulumi.Input[_builtins.str]] = ..., windows_profile: Optional[pulumi.Input[WindowsProfileArgs]] = ...) -> None:
    ...
    def addon_profiles(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[AddonProfilesArgs]]]]): # -> None:
        ...
    ...
    def agent_pool_profiles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NamedAgentPoolProfileArgs]]]]): # -> None:
        ...
    ...
    def control_plane(self, value: Optional[pulumi.Input[ControlPlaneProfileArgs]]): # -> None:
        ...
    ...
    @features.setter
    def features(self, value: Optional[pulumi.Input[ProvisionedClustersCommonPropertiesFeaturesArgs]]): # -> None:
        ...
    ...
    def http_proxy_config(self, value: Optional[pulumi.Input[HttpProxyConfigArgs]]): # -> None:
        ...
    ...
    def node_resource_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def windows_profile(self, value: Optional[pulumi.Input[WindowsProfileArgs]]): # -> None:
        ...
...
class ProvisionedClustersCommonPropertiesFeaturesArgs:
    def __init__(__self__, *, arc_agent_profile: Optional[pulumi.Input[ArcAgentProfileArgs]] = ...) -> None:
...
class StorageSpacesPropertiesHciStorageProfileArgs:
    def __init__(__self__, *, moc_group: Optional[pulumi.Input[_builtins.str]] = ..., moc_location: Optional[pulumi.Input[_builtins.str]] = ..., moc_storage_container: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @moc_group.setter
    def moc_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @moc_location.setter
    def moc_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def moc_storage_container(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StorageSpacesPropertiesProvisioningStatusArgs:
    def __init__(__self__, *, error: Optional[pulumi.Input[StorageSpacesPropertiesErrorArgs]] = ..., operation_id: Optional[pulumi.Input[_builtins.str]] = ..., phase: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @error.setter
    def error(self, value: Optional[pulumi.Input[StorageSpacesPropertiesErrorArgs]]): # -> None:
        ...
...
class StorageSpacesPropertiesStatusArgs:
    def __init__(__self__, *, provisioning_status: Optional[pulumi.Input[StorageSpacesPropertiesProvisioningStatusArgs]] = ...) -> None:
    ...
    @provisioning_status.setter
    def provisioning_status(self, value: Optional[pulumi.Input[StorageSpacesPropertiesProvisioningStatusArgs]]): # -> None:
        ...
...
class StorageSpacesPropertiesVmwareStorageProfileArgs:
    def __init__(__self__, *, datacenter: Optional[pulumi.Input[_builtins.str]] = ..., datastore: Optional[pulumi.Input[_builtins.str]] = ..., folder: Optional[pulumi.Input[_builtins.str]] = ..., resource_pool: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StorageSpacesPropertiesArgs:
    def __init__(__self__, *, hci_storage_profile: Optional[pulumi.Input[StorageSpacesPropertiesHciStorageProfileArgs]] = ..., status: Optional[pulumi.Input[StorageSpacesPropertiesStatusArgs]] = ..., vmware_storage_profile: Optional[pulumi.Input[StorageSpacesPropertiesVmwareStorageProfileArgs]] = ...) -> None:
    ...
    def hci_storage_profile(self, value: Optional[pulumi.Input[StorageSpacesPropertiesHciStorageProfileArgs]]): # -> None:
        ...
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[StorageSpacesPropertiesStatusArgs]]): # -> None:
        ...
    ...
    def vmware_storage_profile(self, value: Optional[pulumi.Input[StorageSpacesPropertiesVmwareStorageProfileArgs]]): # -> None:
        ...
...
class VirtualNetworksPropertiesHciArgs:
    def __init__(__self__, *, moc_group: Optional[pulumi.Input[_builtins.str]] = ..., moc_location: Optional[pulumi.Input[_builtins.str]] = ..., moc_vnet_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def moc_vnet_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VirtualNetworksPropertiesInfraVnetProfileArgs:
    def __init__(__self__, *, hci: Optional[pulumi.Input[VirtualNetworksPropertiesHciArgs]] = ..., network_cloud: Optional[pulumi.Input[VirtualNetworksPropertiesNetworkCloudArgs]] = ..., vmware: Optional[pulumi.Input[VirtualNetworksPropertiesVmwareArgs]] = ...) -> None:
    ...
    @hci.setter
    def hci(self, value: Optional[pulumi.Input[VirtualNetworksPropertiesHciArgs]]): # -> None:
        ...
    ...
    def network_cloud(self, value: Optional[pulumi.Input[VirtualNetworksPropertiesNetworkCloudArgs]]): # -> None:
        ...
    ...
    @vmware.setter
    def vmware(self, value: Optional[pulumi.Input[VirtualNetworksPropertiesVmwareArgs]]): # -> None:
        ...
...
class VirtualNetworksPropertiesNetworkCloudArgs:
    def __init__(__self__, *, network_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @network_id.setter
    def network_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VirtualNetworksPropertiesVmwareArgs:
    def __init__(__self__, *, segment_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VirtualNetworksPropertiesArgs:
    def __init__(__self__, *, dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., gateway: Optional[pulumi.Input[_builtins.str]] = ..., infra_vnet_profile: Optional[pulumi.Input[VirtualNetworksPropertiesInfraVnetProfileArgs]] = ..., ip_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., vip_pool: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualNetworksPropertiesVipPoolArgs]]]] = ..., vmip_pool: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualNetworksPropertiesVmipPoolArgs]]]] = ...) -> None:
    ...
    def infra_vnet_profile(self, value: Optional[pulumi.Input[VirtualNetworksPropertiesInfraVnetProfileArgs]]): # -> None:
        ...
    ...
    def ip_address_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @vip_pool.setter
    def vip_pool(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualNetworksPropertiesVipPoolArgs]]]]): # -> None:
        ...
    ...
    @vmip_pool.setter
    def vmip_pool(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualNetworksPropertiesVmipPoolArgs]]]]): # -> None:
        ...
...
class WindowsProfileArgs:
    def __init__(__self__, *, admin_password: Optional[pulumi.Input[_builtins.str]] = ..., admin_username: Optional[pulumi.Input[_builtins.str]] = ..., enable_csi_proxy: Optional[pulumi.Input[_builtins.bool]] = ..., license_type: Optional[pulumi.Input[Union[_builtins.str, LicenseType]]] = ...) -> None:
