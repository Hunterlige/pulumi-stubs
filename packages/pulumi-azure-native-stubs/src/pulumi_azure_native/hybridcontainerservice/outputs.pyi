...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AADProfileResponseResponse', 'AddonProfilesResponse', 'AddonStatusResponse', 'AgentPoolProvisioningStatusResponseError', ..., 'AgentPoolProvisioningStatusResponseStatus', 'AgentPoolResponseExtendedLocation', 'ArcAgentProfileResponse', 'ArcAgentStatusResponse', 'CloudProviderProfileResponse', 'CloudProviderProfileResponseInfraNetworkProfile', 'CloudProviderProfileResponseInfraStorageProfile', ..., 'ControlPlaneProfileResponse', 'CredentialResultResponse', 'ExtendedLocationResponse', 'HttpProxyConfigResponseResponse', 'KubernetesPatchVersionsResponse', 'KubernetesVersionProfileResponseProperties', 'KubernetesVersionPropertiesResponse', 'KubernetesVersionReadinessResponse', 'LinuxProfilePropertiesResponse', 'LinuxProfilePropertiesResponsePublicKeys', 'LinuxProfilePropertiesResponseSsh', 'ListCredentialResponseResponseError', 'ListCredentialResponseResponseProperties', 'LoadBalancerProfileResponse', 'NamedAgentPoolProfileResponse', 'NetworkProfileResponse', 'ProvisionedClusterIdentityResponse', 'ProvisionedClustersCommonPropertiesResponseError', ..., ..., ..., 'ProvisionedClustersCommonPropertiesResponseStatus', 'ProvisionedClustersResponsePropertiesResponse', ..., 'StorageSpacesPropertiesResponse', 'StorageSpacesPropertiesResponseError', 'StorageSpacesPropertiesResponseHciStorageProfile', 'StorageSpacesPropertiesResponseProvisioningStatus', 'StorageSpacesPropertiesResponseStatus', ..., 'StorageSpacesResponseExtendedLocation', 'SystemDataResponse', 'VirtualNetworksPropertiesResponse', 'VirtualNetworksPropertiesResponseError', 'VirtualNetworksPropertiesResponseHci', 'VirtualNetworksPropertiesResponseInfraVnetProfile', 'VirtualNetworksPropertiesResponseNetworkCloud', ..., 'VirtualNetworksPropertiesResponseStatus', 'VirtualNetworksPropertiesResponseVipPool', 'VirtualNetworksPropertiesResponseVmipPool', 'VirtualNetworksPropertiesResponseVmware', 'VirtualNetworksResponseExtendedLocation', 'VmSkuCapabilitiesResponse', 'VmSkuProfileResponseProperties', 'VmSkuPropertiesResponse', 'WindowsProfileResponseResponse']
@pulumi.output_type
class AADProfileResponseResponse(dict):
    ...
    def __init__(__self__, *, admin_group_object_ids: Optional[Sequence[_builtins.str]] = ..., client_app_id: Optional[_builtins.str] = ..., enable_azure_rbac: Optional[_builtins.bool] = ..., managed: Optional[_builtins.bool] = ..., server_app_id: Optional[_builtins.str] = ..., tenant_id: Optional[_builtins.str] = ...) -> None:
...
class AddonProfilesResponse(dict):
    ...
    def __init__(__self__, *, config: Optional[Mapping[str, _builtins.str]] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class AddonStatusResponse(dict):
    ...
    def __init__(__self__, *, error_message: Optional[_builtins.str] = ..., phase: Optional[_builtins.str] = ..., ready: Optional[_builtins.bool] = ...) -> None:
...
class AgentPoolProvisioningStatusResponseProvisioningStatus(dict):
    ...
    def __init__(__self__, *, error: Optional[outputs.AgentPoolProvisioningStatusResponseError] = ..., operation_id: Optional[_builtins.str] = ..., phase: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class AgentPoolProvisioningStatusResponseStatus(dict):
    ...
    def __init__(__self__, *, error_message: Optional[_builtins.str] = ..., provisioning_status: Optional[outputs.AgentPoolProvisioningStatusResponseProvisioningStatus] = ..., ready_replicas: Optional[_builtins.int] = ..., replicas: Optional[_builtins.int] = ...) -> None:
...
class ArcAgentProfileResponse(dict):
    ...
    def __init__(__self__, *, agent_auto_upgrade: Optional[_builtins.str] = ..., agent_version: Optional[_builtins.str] = ...) -> None:
...
class ArcAgentStatusResponse(dict):
    ...
    def __init__(__self__, *, agent_version: Optional[_builtins.str] = ..., core_count: Optional[_builtins.float] = ..., deployment_state: Optional[_builtins.str] = ..., error_message: Optional[_builtins.str] = ..., last_connectivity_time: Optional[_builtins.str] = ..., managed_identity_certificate_expiration_time: Optional[_builtins.str] = ..., onboarding_public_key: Optional[_builtins.str] = ...) -> None:
...
class CloudProviderProfileResponse(dict):
    ...
    def __init__(__self__, *, infra_network_profile: Optional[outputs.CloudProviderProfileResponseInfraNetworkProfile] = ..., infra_storage_profile: Optional[outputs.CloudProviderProfileResponseInfraStorageProfile] = ...) -> None:
...
class CloudProviderProfileResponseInfraNetworkProfile(dict):
    ...
    def __init__(__self__, *, vnet_subnet_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CloudProviderProfileResponseInfraStorageProfile(dict):
    ...
    def __init__(__self__, *, storage_space_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ControlPlaneEndpointProfileResponseControlPlaneEndpoint(dict):
    ...
    def __init__(__self__, *, host_ip: Optional[_builtins.str] = ..., port: Optional[_builtins.str] = ...) -> None:
...
class ControlPlaneProfileResponse(dict):
    ...
    def __init__(__self__, *, availability_zones: Optional[Sequence[_builtins.str]] = ..., cloud_provider_profile: Optional[outputs.CloudProviderProfileResponse] = ..., control_plane_endpoint: Optional[outputs.ControlPlaneEndpointProfileResponseControlPlaneEndpoint] = ..., count: Optional[_builtins.int] = ..., linux_profile: Optional[outputs.LinuxProfilePropertiesResponse] = ..., max_count: Optional[_builtins.int] = ..., max_pods: Optional[_builtins.int] = ..., min_count: Optional[_builtins.int] = ..., mode: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., node_image_version: Optional[_builtins.str] = ..., node_labels: Optional[Mapping[str, _builtins.str]] = ..., node_taints: Optional[Sequence[_builtins.str]] = ..., os_type: Optional[_builtins.str] = ..., vm_size: Optional[_builtins.str] = ...) -> None:
...
class HttpProxyConfigResponseResponse(dict):
    ...
    def __init__(__self__, *, http_proxy: Optional[_builtins.str] = ..., https_proxy: Optional[_builtins.str] = ..., no_proxy: Optional[Sequence[_builtins.str]] = ..., trusted_ca: Optional[_builtins.str] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class KubernetesPatchVersionsResponse(dict):
    ...
    def __init__(__self__, *, readiness: Optional[Sequence[outputs.KubernetesVersionReadinessResponse]] = ..., upgrades: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class KubernetesVersionProfileResponseProperties(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, values: Optional[Sequence[outputs.KubernetesVersionPropertiesResponse]] = ...) -> None:
...
class KubernetesVersionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, is_preview: _builtins.bool, patch_versions: Mapping[str, outputs.KubernetesPatchVersionsResponse], version: _builtins.str) -> None:
...
class KubernetesVersionReadinessResponse(dict):
    ...
    def __init__(__self__, *, error_message: _builtins.str, os_type: Optional[_builtins.str] = ..., ready: _builtins.bool, os_sku: Optional[_builtins.str] = ...) -> None:
...
class LinuxProfilePropertiesResponse(dict):
    ...
    def __init__(__self__, *, admin_username: Optional[_builtins.str] = ..., ssh: Optional[outputs.LinuxProfilePropertiesResponseSsh] = ...) -> None:
...
class LinuxProfilePropertiesResponseSsh(dict):
    ...
    def __init__(__self__, *, public_keys: Optional[Sequence[outputs.LinuxProfilePropertiesResponsePublicKeys]] = ...) -> None:
...
class ListCredentialResponseResponseProperties(dict):
    def __init__(__self__, *, kubeconfigs: Sequence[outputs.CredentialResultResponse]) -> None:
...
class LoadBalancerProfileResponse(dict):
    ...
    def __init__(__self__, *, availability_zones: Optional[Sequence[_builtins.str]] = ..., cloud_provider_profile: Optional[outputs.CloudProviderProfileResponse] = ..., count: Optional[_builtins.int] = ..., linux_profile: Optional[outputs.LinuxProfilePropertiesResponse] = ..., max_count: Optional[_builtins.int] = ..., max_pods: Optional[_builtins.int] = ..., min_count: Optional[_builtins.int] = ..., mode: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., node_image_version: Optional[_builtins.str] = ..., node_labels: Optional[Mapping[str, _builtins.str]] = ..., node_taints: Optional[Sequence[_builtins.str]] = ..., os_type: Optional[_builtins.str] = ..., vm_size: Optional[_builtins.str] = ...) -> None:
...
class NamedAgentPoolProfileResponse(dict):
    ...
    def __init__(__self__, *, availability_zones: Optional[Sequence[_builtins.str]] = ..., cloud_provider_profile: Optional[outputs.CloudProviderProfileResponse] = ..., count: Optional[_builtins.int] = ..., max_count: Optional[_builtins.int] = ..., max_pods: Optional[_builtins.int] = ..., min_count: Optional[_builtins.int] = ..., mode: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., node_image_version: Optional[_builtins.str] = ..., node_labels: Optional[Mapping[str, _builtins.str]] = ..., node_taints: Optional[Sequence[_builtins.str]] = ..., os_type: Optional[_builtins.str] = ..., vm_size: Optional[_builtins.str] = ...) -> None:
...
class NetworkProfileResponse(dict):
    ...
    def __init__(__self__, *, dns_service_ip: Optional[_builtins.str] = ..., load_balancer_profile: Optional[outputs.LoadBalancerProfileResponse] = ..., load_balancer_sku: Optional[_builtins.str] = ..., network_policy: Optional[_builtins.str] = ..., pod_cidr: Optional[_builtins.str] = ..., pod_cidrs: Optional[Sequence[_builtins.str]] = ..., service_cidr: Optional[_builtins.str] = ..., service_cidrs: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ProvisionedClustersCommonPropertiesResponseFeatures(dict):
    ...
    def __init__(__self__, *, arc_agent_profile: Optional[outputs.ArcAgentProfileResponse] = ...) -> None:
...
class ProvisionedClustersCommonPropertiesResponseFeaturesStatus(dict):
    ...
    def __init__(__self__, *, arc_agent_status: Optional[outputs.ArcAgentStatusResponse] = ...) -> None:
...
class ProvisionedClustersCommonPropertiesResponseProvisioningStatus(dict):
    ...
    def __init__(__self__, *, error: Optional[outputs.ProvisionedClustersCommonPropertiesResponseError] = ..., operation_id: Optional[_builtins.str] = ..., phase: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class ProvisionedClustersCommonPropertiesResponseStatus(dict):
    ...
    def __init__(__self__, *, addon_status: Optional[Mapping[str, outputs.AddonStatusResponse]] = ..., error_message: Optional[_builtins.str] = ..., features_status: Optional[outputs.ProvisionedClustersCommonPropertiesResponseFeaturesStatus] = ..., provisioning_status: Optional[outputs.ProvisionedClustersCommonPropertiesResponseProvisioningStatus] = ...) -> None:
...
class ProvisionedClustersResponsePropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, status: outputs.ProvisionedClustersCommonPropertiesResponseStatus, aad_profile: Optional[outputs.AADProfileResponseResponse] = ..., addon_profiles: Optional[Mapping[str, outputs.AddonProfilesResponse]] = ..., agent_pool_profiles: Optional[Sequence[outputs.NamedAgentPoolProfileResponse]] = ..., cloud_provider_profile: Optional[outputs.CloudProviderProfileResponse] = ..., control_plane: Optional[outputs.ControlPlaneProfileResponse] = ..., enable_rbac: Optional[_builtins.bool] = ..., features: Optional[outputs.ProvisionedClustersCommonPropertiesResponseFeatures] = ..., http_proxy_config: Optional[outputs.HttpProxyConfigResponseResponse] = ..., kubernetes_version: Optional[_builtins.str] = ..., linux_profile: Optional[outputs.LinuxProfilePropertiesResponse] = ..., network_profile: Optional[outputs.NetworkProfileResponse] = ..., node_resource_group: Optional[_builtins.str] = ..., windows_profile: Optional[outputs.WindowsProfileResponseResponse] = ...) -> None:
...
class StorageSpacesPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, hci_storage_profile: Optional[outputs.StorageSpacesPropertiesResponseHciStorageProfile] = ..., status: Optional[outputs.StorageSpacesPropertiesResponseStatus] = ..., vmware_storage_profile: Optional[outputs.StorageSpacesPropertiesResponseVmwareStorageProfile] = ...) -> None:
...
class StorageSpacesPropertiesResponseHciStorageProfile(dict):
    ...
    def __init__(__self__, *, moc_group: Optional[_builtins.str] = ..., moc_location: Optional[_builtins.str] = ..., moc_storage_container: Optional[_builtins.str] = ...) -> None:
...
class StorageSpacesPropertiesResponseProvisioningStatus(dict):
    ...
    def __init__(__self__, *, error: Optional[outputs.StorageSpacesPropertiesResponseError] = ..., operation_id: Optional[_builtins.str] = ..., phase: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class StorageSpacesPropertiesResponseStatus(dict):
    ...
    def __init__(__self__, *, provisioning_status: Optional[outputs.StorageSpacesPropertiesResponseProvisioningStatus] = ...) -> None:
...
class StorageSpacesPropertiesResponseVmwareStorageProfile(dict):
    ...
    def __init__(__self__, *, datacenter: Optional[_builtins.str] = ..., datastore: Optional[_builtins.str] = ..., folder: Optional[_builtins.str] = ..., resource_pool: Optional[_builtins.str] = ...) -> None:
...
class VirtualNetworksPropertiesResponse(dict):
    ...
    def __init__(__self__, *, dhcp_servers: Sequence[_builtins.str], provisioning_state: _builtins.str, status: outputs.VirtualNetworksPropertiesResponseStatus, vlan_id: _builtins.str, dns_servers: Optional[Sequence[_builtins.str]] = ..., gateway: Optional[_builtins.str] = ..., infra_vnet_profile: Optional[outputs.VirtualNetworksPropertiesResponseInfraVnetProfile] = ..., ip_address_prefix: Optional[_builtins.str] = ..., vip_pool: Optional[Sequence[outputs.VirtualNetworksPropertiesResponseVipPool]] = ..., vmip_pool: Optional[Sequence[outputs.VirtualNetworksPropertiesResponseVmipPool]] = ...) -> None:
...
class VirtualNetworksPropertiesResponseHci(dict):
    ...
    def __init__(__self__, *, moc_group: Optional[_builtins.str] = ..., moc_location: Optional[_builtins.str] = ..., moc_vnet_name: Optional[_builtins.str] = ...) -> None:
...
class VirtualNetworksPropertiesResponseInfraVnetProfile(dict):
    ...
    def __init__(__self__, *, hci: Optional[outputs.VirtualNetworksPropertiesResponseHci] = ..., network_cloud: Optional[outputs.VirtualNetworksPropertiesResponseNetworkCloud] = ..., vmware: Optional[outputs.VirtualNetworksPropertiesResponseVmware] = ...) -> None:
...
class VirtualNetworksPropertiesResponseProvisioningStatus(dict):
    ...
    def __init__(__self__, *, error: Optional[outputs.VirtualNetworksPropertiesResponseError] = ..., operation_id: Optional[_builtins.str] = ..., phase: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class VirtualNetworksPropertiesResponseStatus(dict):
    ...
    def __init__(__self__, *, provisioning_status: Optional[outputs.VirtualNetworksPropertiesResponseProvisioningStatus] = ...) -> None:
...
class VmSkuProfileResponseProperties(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, values: Optional[Sequence[outputs.VmSkuPropertiesResponse]] = ...) -> None:
...
class VmSkuPropertiesResponse(dict):
    ...
    def __init__(__self__, *, capabilities: Sequence[outputs.VmSkuCapabilitiesResponse], name: _builtins.str, resource_type: _builtins.str, size: _builtins.str, tier: _builtins.str) -> None:
...
class WindowsProfileResponseResponse(dict):
    ...
    def __init__(__self__, *, admin_username: Optional[_builtins.str] = ..., enable_csi_proxy: Optional[_builtins.bool] = ..., license_type: Optional[_builtins.str] = ...) -> None:
