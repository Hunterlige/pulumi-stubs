...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *, deid_service_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[PrivateEndpointConnectionPropertiesArgs]] = ...) -> None:
    ...
    def deid_service_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
