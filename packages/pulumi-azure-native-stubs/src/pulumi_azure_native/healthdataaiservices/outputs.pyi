...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DeidServicePropertiesResponse', 'ManagedServiceIdentityResponse', 'PrivateEndpointConnectionPropertiesResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
class DeidServicePropertiesResponse(dict):
    ...
    def __init__(__self__, *, private_endpoint_connections: Sequence[outputs.PrivateEndpointConnectionResponse], provisioning_state: _builtins.str, service_url: _builtins.str, public_network_access: Optional[_builtins.str] = ...) -> None:
