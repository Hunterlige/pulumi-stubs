...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetPredictionResult', 'AwaitableGetPredictionResult', 'get_prediction', 'get_prediction_output']
@pulumi.output_type
class GetPredictionResult:
    
    def __init__(__self__, auto_analyze=..., azure_api_version=..., description=..., display_name=..., grades=..., id=..., involved_interaction_types=..., involved_kpi_types=..., involved_relationships=..., mappings=..., name=..., negative_outcome_expression=..., positive_outcome_expression=..., prediction_name=..., primary_profile_type=..., provisioning_state=..., scope_expression=..., score_label=..., system_generated_entities=..., tenant_id=..., type=...) -> None:
        ...
...
class AwaitableGetPredictionResult(GetPredictionResult):
    def __await__(self): # -> Generator[Never, Any, GetPredictionResult]:
        ...
    


def get_prediction(hub_name: Optional[_builtins.str] = ..., prediction_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetPredictionResult:
    
    ...

def get_prediction_output(hub_name: Optional[pulumi.Input[_builtins.str]] = ..., prediction_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetPredictionResult]:
