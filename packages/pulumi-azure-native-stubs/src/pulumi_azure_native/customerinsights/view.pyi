...
@pulumi.input_type
class ViewArgs:
    def __init__(__self__, *, definition: pulumi.Input[_builtins.str], hub_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., user_id: Optional[pulumi.Input[_builtins.str]] = ..., view_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class View(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., definition: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., hub_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., user_id: Optional[pulumi.Input[_builtins.str]] = ..., view_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> View:
