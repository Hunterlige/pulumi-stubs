...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AssignmentPrincipalArgs', 'AssignmentPrincipalArgsDict', 'ConnectorMappingAvailabilityArgs', 'ConnectorMappingAvailabilityArgsDict', 'ConnectorMappingCompleteOperationArgs', 'ConnectorMappingCompleteOperationArgsDict', 'ConnectorMappingErrorManagementArgs', 'ConnectorMappingErrorManagementArgsDict', 'ConnectorMappingFormatArgs', 'ConnectorMappingFormatArgsDict', 'ConnectorMappingPropertiesArgs', 'ConnectorMappingPropertiesArgsDict', 'ConnectorMappingStructureArgs', 'ConnectorMappingStructureArgsDict', 'HubBillingInfoFormatArgs', 'HubBillingInfoFormatArgsDict', 'KpiAliasArgs', 'KpiAliasArgsDict', 'KpiExtractArgs', 'KpiExtractArgsDict', 'KpiThresholdsArgs', 'KpiThresholdsArgsDict', 'ParticipantProfilePropertyReferenceArgs', 'ParticipantProfilePropertyReferenceArgsDict', 'ParticipantPropertyReferenceArgs', 'ParticipantPropertyReferenceArgsDict', 'PredictionGradesArgs', 'PredictionGradesArgsDict', 'PredictionMappingsArgs', 'PredictionMappingsArgsDict', 'ProfileEnumValidValuesFormatArgs', 'ProfileEnumValidValuesFormatArgsDict', 'PropertyDefinitionArgs', 'PropertyDefinitionArgsDict', 'RelationshipLinkFieldMappingArgs', 'RelationshipLinkFieldMappingArgsDict', 'RelationshipTypeFieldMappingArgs', 'RelationshipTypeFieldMappingArgsDict', 'RelationshipTypeMappingArgs', 'RelationshipTypeMappingArgsDict', 'ResourceSetDescriptionArgs', 'ResourceSetDescriptionArgsDict', 'StrongIdArgs', 'StrongIdArgsDict', 'TypePropertiesMappingArgs', 'TypePropertiesMappingArgsDict']
...
class AssignmentPrincipalArgs:
    def __init__(__self__, *, principal_id: pulumi.Input[_builtins.str], principal_type: pulumi.Input[_builtins.str], principal_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def principal_metadata(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ConnectorMappingAvailabilityArgs:
    def __init__(__self__, *, interval: pulumi.Input[_builtins.int], frequency: Optional[pulumi.Input[FrequencyTypes]] = ...) -> None:
    ...
    @frequency.setter
    def frequency(self, value: Optional[pulumi.Input[FrequencyTypes]]): # -> None:
        ...
...
class ConnectorMappingCompleteOperationArgs:
    def __init__(__self__, *, completion_operation_type: Optional[pulumi.Input[CompletionOperationTypes]] = ..., destination_folder: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def completion_operation_type(self, value: Optional[pulumi.Input[CompletionOperationTypes]]): # -> None:
        ...
    ...
    def destination_folder(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectorMappingErrorManagementArgs:
    def __init__(__self__, *, error_management_type: pulumi.Input[ErrorManagementTypes], error_limit: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def error_management_type(self, value: pulumi.Input[ErrorManagementTypes]): # -> None:
        ...
    ...
    @error_limit.setter
    def error_limit(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ConnectorMappingFormatArgs:
    def __init__(__self__, *, format_type: pulumi.Input[FormatTypes], accept_language: Optional[pulumi.Input[_builtins.str]] = ..., array_separator: Optional[pulumi.Input[_builtins.str]] = ..., column_delimiter: Optional[pulumi.Input[_builtins.str]] = ..., quote_character: Optional[pulumi.Input[_builtins.str]] = ..., quote_escape_character: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @format_type.setter
    def format_type(self, value: pulumi.Input[FormatTypes]): # -> None:
        ...
    ...
    def array_separator(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def column_delimiter(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def quote_escape_character(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectorMappingPropertiesArgs:
    def __init__(__self__, *, availability: pulumi.Input[ConnectorMappingAvailabilityArgs], complete_operation: pulumi.Input[ConnectorMappingCompleteOperationArgs], error_management: pulumi.Input[ConnectorMappingErrorManagementArgs], format: pulumi.Input[ConnectorMappingFormatArgs], structure: pulumi.Input[Sequence[pulumi.Input[ConnectorMappingStructureArgs]]], file_filter: Optional[pulumi.Input[_builtins.str]] = ..., folder_path: Optional[pulumi.Input[_builtins.str]] = ..., has_header: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @availability.setter
    def availability(self, value: pulumi.Input[ConnectorMappingAvailabilityArgs]): # -> None:
        ...
    ...
    def complete_operation(self, value: pulumi.Input[ConnectorMappingCompleteOperationArgs]): # -> None:
        ...
    ...
    def error_management(self, value: pulumi.Input[ConnectorMappingErrorManagementArgs]): # -> None:
        ...
    ...
    @format.setter
    def format(self, value: pulumi.Input[ConnectorMappingFormatArgs]): # -> None:
        ...
    ...
    @structure.setter
    def structure(self, value: pulumi.Input[Sequence[pulumi.Input[ConnectorMappingStructureArgs]]]): # -> None:
        ...
    ...
    @file_filter.setter
    def file_filter(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @has_header.setter
    def has_header(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ConnectorMappingStructureArgs:
    def __init__(__self__, *, column_name: pulumi.Input[_builtins.str], property_name: pulumi.Input[_builtins.str], custom_format_specifier: Optional[pulumi.Input[_builtins.str]] = ..., is_encrypted: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def property_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def custom_format_specifier(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class HubBillingInfoFormatArgs:
    def __init__(__self__, *, max_units: Optional[pulumi.Input[_builtins.int]] = ..., min_units: Optional[pulumi.Input[_builtins.int]] = ..., sku_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class KpiAliasArgs:
    def __init__(__self__, *, alias_name: pulumi.Input[_builtins.str], expression: pulumi.Input[_builtins.str]) -> None:
...
class KpiExtractArgs:
    def __init__(__self__, *, expression: pulumi.Input[_builtins.str], extract_name: pulumi.Input[_builtins.str]) -> None:
    ...
    @extract_name.setter
    def extract_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class KpiThresholdsArgs:
    def __init__(__self__, *, increasing_kpi: pulumi.Input[_builtins.bool], lower_limit: pulumi.Input[_builtins.float], upper_limit: pulumi.Input[_builtins.float]) -> None:
    ...
    def increasing_kpi(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    @lower_limit.setter
    def lower_limit(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @upper_limit.setter
    def upper_limit(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class ParticipantProfilePropertyReferenceArgs:
    def __init__(__self__, *, interaction_property_name: pulumi.Input[_builtins.str], profile_property_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def interaction_property_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def profile_property_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ParticipantPropertyReferenceArgs:
    def __init__(__self__, *, source_property_name: pulumi.Input[_builtins.str], target_property_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def source_property_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def target_property_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PredictionGradesArgs:
    def __init__(__self__, *, grade_name: Optional[pulumi.Input[_builtins.str]] = ..., max_score_threshold: Optional[pulumi.Input[_builtins.int]] = ..., min_score_threshold: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @grade_name.setter
    def grade_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_score_threshold(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def min_score_threshold(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class PredictionMappingsArgs:
    def __init__(__self__, *, grade: pulumi.Input[_builtins.str], reason: pulumi.Input[_builtins.str], score: pulumi.Input[_builtins.str]) -> None:
...
class ProfileEnumValidValuesFormatArgs:
    def __init__(__self__, *, localized_value_names: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., value: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def localized_value_names(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class PropertyDefinitionArgs:
    def __init__(__self__, *, field_name: pulumi.Input[_builtins.str], field_type: pulumi.Input[_builtins.str], array_value_separator: Optional[pulumi.Input[_builtins.str]] = ..., enum_valid_values: Optional[pulumi.Input[Sequence[pulumi.Input[ProfileEnumValidValuesFormatArgs]]]] = ..., is_array: Optional[pulumi.Input[_builtins.bool]] = ..., is_available_in_graph: Optional[pulumi.Input[_builtins.bool]] = ..., is_enum: Optional[pulumi.Input[_builtins.bool]] = ..., is_flag_enum: Optional[pulumi.Input[_builtins.bool]] = ..., is_image: Optional[pulumi.Input[_builtins.bool]] = ..., is_localized_string: Optional[pulumi.Input[_builtins.bool]] = ..., is_name: Optional[pulumi.Input[_builtins.bool]] = ..., is_required: Optional[pulumi.Input[_builtins.bool]] = ..., max_length: Optional[pulumi.Input[_builtins.int]] = ..., property_id: Optional[pulumi.Input[_builtins.str]] = ..., schema_item_prop_link: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def array_value_separator(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def enum_valid_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ProfileEnumValidValuesFormatArgs]]]]): # -> None:
        ...
    ...
    @is_array.setter
    def is_array(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_available_in_graph(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @is_enum.setter
    def is_enum(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @is_flag_enum.setter
    def is_flag_enum(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @is_image.setter
    def is_image(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_localized_string(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @is_name.setter
    def is_name(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @is_required.setter
    def is_required(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @max_length.setter
    def max_length(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @property_id.setter
    def property_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def schema_item_prop_link(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RelationshipLinkFieldMappingArgs:
    def __init__(__self__, *, interaction_field_name: pulumi.Input[_builtins.str], relationship_field_name: pulumi.Input[_builtins.str], link_type: Optional[pulumi.Input[LinkTypes]] = ...) -> None:
    ...
    def interaction_field_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def relationship_field_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @link_type.setter
    def link_type(self, value: Optional[pulumi.Input[LinkTypes]]): # -> None:
        ...
...
class RelationshipTypeFieldMappingArgs:
    def __init__(__self__, *, profile_field_name: pulumi.Input[_builtins.str], related_profile_key_property: pulumi.Input[_builtins.str]) -> None:
    ...
    def profile_field_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def related_profile_key_property(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RelationshipTypeMappingArgs:
    def __init__(__self__, *, field_mappings: pulumi.Input[Sequence[pulumi.Input[RelationshipTypeFieldMappingArgs]]]) -> None:
    ...
    def field_mappings(self, value: pulumi.Input[Sequence[pulumi.Input[RelationshipTypeFieldMappingArgs]]]): # -> None:
        ...
...
class ResourceSetDescriptionArgs:
    def __init__(__self__, *, elements: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., exceptions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @elements.setter
    def elements(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @exceptions.setter
    def exceptions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
@pulumi.input_type
class StrongIdArgs:
    def __init__(__self__, *, key_property_names: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], strong_id_name: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., display_name: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def key_property_names(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def strong_id_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TypePropertiesMappingArgs:
    def __init__(__self__, *, source_property_name: pulumi.Input[_builtins.str], target_property_name: pulumi.Input[_builtins.str], link_type: Optional[pulumi.Input[LinkTypes]] = ...) -> None:
