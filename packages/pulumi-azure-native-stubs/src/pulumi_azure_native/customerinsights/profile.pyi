...
@pulumi.input_type
class ProfileArgs:
    def __init__(__self__, *, hub_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], api_entity_set_name: Optional[pulumi.Input[_builtins.str]] = ..., attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]] = ..., description: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., display_name: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., entity_type: Optional[pulumi.Input[EntityTypes]] = ..., fields: Optional[pulumi.Input[Sequence[pulumi.Input[PropertyDefinitionArgs]]]] = ..., instances_count: Optional[pulumi.Input[_builtins.int]] = ..., large_image: Optional[pulumi.Input[_builtins.str]] = ..., localized_attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]] = ..., medium_image: Optional[pulumi.Input[_builtins.str]] = ..., profile_name: Optional[pulumi.Input[_builtins.str]] = ..., schema_item_type_link: Optional[pulumi.Input[_builtins.str]] = ..., small_image: Optional[pulumi.Input[_builtins.str]] = ..., strong_ids: Optional[pulumi.Input[Sequence[pulumi.Input[StrongIdArgs]]]] = ..., timestamp_field_name: Optional[pulumi.Input[_builtins.str]] = ..., type_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def api_entity_set_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @attributes.setter
    def attributes(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]]): # -> None:
        ...
    ...
    @entity_type.setter
    def entity_type(self, value: Optional[pulumi.Input[EntityTypes]]): # -> None:
        ...
    ...
    def instances_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @large_image.setter
    def large_image(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def localized_attributes(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]]): # -> None:
        ...
    ...
    @medium_image.setter
    def medium_image(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def schema_item_type_link(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @small_image.setter
    def small_image(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @strong_ids.setter
    def strong_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StrongIdArgs]]]]): # -> None:
        ...
    ...
    def timestamp_field_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Profile(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., api_entity_set_name: Optional[pulumi.Input[_builtins.str]] = ..., attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]] = ..., description: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., display_name: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., entity_type: Optional[pulumi.Input[EntityTypes]] = ..., fields: Optional[pulumi.Input[Sequence[pulumi.Input[Union[PropertyDefinitionArgs, PropertyDefinitionArgsDict]]]]] = ..., hub_name: Optional[pulumi.Input[_builtins.str]] = ..., instances_count: Optional[pulumi.Input[_builtins.int]] = ..., large_image: Optional[pulumi.Input[_builtins.str]] = ..., localized_attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]]] = ..., medium_image: Optional[pulumi.Input[_builtins.str]] = ..., profile_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., schema_item_type_link: Optional[pulumi.Input[_builtins.str]] = ..., small_image: Optional[pulumi.Input[_builtins.str]] = ..., strong_ids: Optional[pulumi.Input[Sequence[pulumi.Input[Union[StrongIdArgs, StrongIdArgsDict]]]]] = ..., timestamp_field_name: Optional[pulumi.Input[_builtins.str]] = ..., type_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
