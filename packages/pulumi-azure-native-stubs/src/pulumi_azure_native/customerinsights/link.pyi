...
@pulumi.input_type
class LinkArgs:
    def __init__(__self__, *, hub_name: pulumi.Input[_builtins.str], participant_property_references: pulumi.Input[Sequence[pulumi.Input[ParticipantPropertyReferenceArgs]]], resource_group_name: pulumi.Input[_builtins.str], source_entity_type: pulumi.Input[EntityType], source_entity_type_name: pulumi.Input[_builtins.str], target_entity_type: pulumi.Input[EntityType], target_entity_type_name: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., display_name: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., link_name: Optional[pulumi.Input[_builtins.str]] = ..., mappings: Optional[pulumi.Input[Sequence[pulumi.Input[TypePropertiesMappingArgs]]]] = ..., operation_type: Optional[pulumi.Input[InstanceOperationType]] = ..., reference_only: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def participant_property_references(self, value: pulumi.Input[Sequence[pulumi.Input[ParticipantPropertyReferenceArgs]]]): # -> None:
        ...
    ...
    def source_entity_type(self, value: pulumi.Input[EntityType]): # -> None:
        ...
    ...
    def source_entity_type_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def target_entity_type(self, value: pulumi.Input[EntityType]): # -> None:
        ...
    ...
    def target_entity_type_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @mappings.setter
    def mappings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TypePropertiesMappingArgs]]]]): # -> None:
        ...
    ...
    def operation_type(self, value: Optional[pulumi.Input[InstanceOperationType]]): # -> None:
        ...
    ...
    def reference_only(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class Link(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., description: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., display_name: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., hub_name: Optional[pulumi.Input[_builtins.str]] = ..., link_name: Optional[pulumi.Input[_builtins.str]] = ..., mappings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[TypePropertiesMappingArgs, TypePropertiesMappingArgsDict]]]]] = ..., operation_type: Optional[pulumi.Input[InstanceOperationType]] = ..., participant_property_references: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ParticipantPropertyReferenceArgs, ParticipantPropertyReferenceArgsDict]]]]] = ..., reference_only: Optional[pulumi.Input[_builtins.bool]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., source_entity_type: Optional[pulumi.Input[EntityType]] = ..., source_entity_type_name: Optional[pulumi.Input[_builtins.str]] = ..., target_entity_type: Optional[pulumi.Input[EntityType]] = ..., target_entity_type_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Link:
