...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetRoleAssignmentResult', 'AwaitableGetRoleAssignmentResult', 'get_role_assignment', 'get_role_assignment_output']
@pulumi.output_type
class GetRoleAssignmentResult:
    
    def __init__(__self__, assignment_name=..., azure_api_version=..., conflation_policies=..., connectors=..., description=..., display_name=..., id=..., interactions=..., kpis=..., links=..., name=..., principals=..., profiles=..., provisioning_state=..., relationship_links=..., relationships=..., role=..., role_assignments=..., sas_policies=..., segments=..., tenant_id=..., type=..., views=..., widget_types=...) -> None:
        ...
...
class AwaitableGetRoleAssignmentResult(GetRoleAssignmentResult):
    def __await__(self): # -> Generator[Never, Any, GetRoleAssignmentResult]:
        ...
    


def get_role_assignment(assignment_name: Optional[_builtins.str] = ..., hub_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetRoleAssignmentResult:
    
    ...

def get_role_assignment_output(assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., hub_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetRoleAssignmentResult]:
