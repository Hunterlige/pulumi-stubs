...
@pulumi.input_type
class ProfileArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], sku: pulumi.Input[SkuArgs], identity: Optional[pulumi.Input[ManagedServiceIdentityArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., log_scrubbing: Optional[pulumi.Input[ProfileLogScrubbingArgs]] = ..., origin_response_timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ..., profile_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def log_scrubbing(self, value: Optional[pulumi.Input[ProfileLogScrubbingArgs]]): # -> None:
        ...
    ...
    def origin_response_timeout_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class Profile(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., identity: Optional[pulumi.Input[Union[ManagedServiceIdentityArgs, ManagedServiceIdentityArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., log_scrubbing: Optional[pulumi.Input[Union[ProfileLogScrubbingArgs, ProfileLogScrubbingArgsDict]]] = ..., origin_response_timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ..., profile_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[SkuArgs, SkuArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
