...
@pulumi.input_type
class SecretArgs:
    def __init__(__self__, *, profile_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], parameters: Optional[pulumi.Input[Union[AzureFirstPartyManagedCertificateParametersArgs, CustomerCertificateParametersArgs, ManagedCertificateParametersArgs, UrlSigningKeyParametersArgs]]] = ..., secret_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Union[AzureFirstPartyManagedCertificateParametersArgs, CustomerCertificateParametersArgs, ManagedCertificateParametersArgs, UrlSigningKeyParametersArgs]]]): # -> None:
        ...
...
class Secret(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., parameters: Optional[pulumi.Input[Union[Union[AzureFirstPartyManagedCertificateParametersArgs, AzureFirstPartyManagedCertificateParametersArgsDict], Union[CustomerCertificateParametersArgs, CustomerCertificateParametersArgsDict], Union[ManagedCertificateParametersArgs, ManagedCertificateParametersArgsDict], Union[UrlSigningKeyParametersArgs, UrlSigningKeyParametersArgsDict]]]] = ..., profile_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., secret_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
