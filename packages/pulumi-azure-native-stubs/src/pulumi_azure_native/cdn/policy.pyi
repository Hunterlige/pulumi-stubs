...
@pulumi.input_type
class PolicyArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], sku: pulumi.Input[SkuArgs], custom_rules: Optional[pulumi.Input[CustomRuleListArgs]] = ..., extended_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., managed_rules: Optional[pulumi.Input[ManagedRuleSetListArgs]] = ..., policy_name: Optional[pulumi.Input[_builtins.str]] = ..., policy_settings: Optional[pulumi.Input[PolicySettingsArgs]] = ..., rate_limit_rules: Optional[pulumi.Input[RateLimitRuleListArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def rate_limit_rules(self, value: Optional[pulumi.Input[RateLimitRuleListArgs]]): # -> None:
        ...
...
class Policy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., custom_rules: Optional[pulumi.Input[Union[CustomRuleListArgs, CustomRuleListArgsDict]]] = ..., extended_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., managed_rules: Optional[pulumi.Input[Union[ManagedRuleSetListArgs, ManagedRuleSetListArgsDict]]] = ..., policy_name: Optional[pulumi.Input[_builtins.str]] = ..., policy_settings: Optional[pulumi.Input[Union[PolicySettingsArgs, PolicySettingsArgsDict]]] = ..., rate_limit_rules: Optional[pulumi.Input[Union[RateLimitRuleListArgs, RateLimitRuleListArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[SkuArgs, SkuArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
