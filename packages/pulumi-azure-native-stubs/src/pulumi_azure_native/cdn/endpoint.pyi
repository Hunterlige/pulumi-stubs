...
@pulumi.input_type
class EndpointArgs:
    def __init__(__self__, *, origins: pulumi.Input[Sequence[pulumi.Input[DeepCreatedOriginArgs]]], profile_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], content_types_to_compress: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., default_origin_group: Optional[pulumi.Input[ResourceReferenceArgs]] = ..., delivery_policy: Optional[pulumi.Input[EndpointPropertiesUpdateParametersDeliveryPolicyArgs]] = ..., endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., geo_filters: Optional[pulumi.Input[Sequence[pulumi.Input[GeoFilterArgs]]]] = ..., is_compression_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_http_allowed: Optional[pulumi.Input[_builtins.bool]] = ..., is_https_allowed: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., optimization_type: Optional[pulumi.Input[Union[_builtins.str, OptimizationType]]] = ..., origin_groups: Optional[pulumi.Input[Sequence[pulumi.Input[DeepCreatedOriginGroupArgs]]]] = ..., origin_host_header: Optional[pulumi.Input[_builtins.str]] = ..., origin_path: Optional[pulumi.Input[_builtins.str]] = ..., probe_path: Optional[pulumi.Input[_builtins.str]] = ..., query_string_caching_behavior: Optional[pulumi.Input[QueryStringCachingBehavior]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., url_signing_keys: Optional[pulumi.Input[Sequence[pulumi.Input[UrlSigningKeyArgs]]]] = ..., web_application_firewall_policy_link: Optional[pulumi.Input[EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkArgs]] = ...) -> None:
    ...
    @origins.setter
    def origins(self, value: pulumi.Input[Sequence[pulumi.Input[DeepCreatedOriginArgs]]]): # -> None:
        ...
    ...
    def default_origin_group(self, value: Optional[pulumi.Input[ResourceReferenceArgs]]): # -> None:
        ...
    ...
    def delivery_policy(self, value: Optional[pulumi.Input[EndpointPropertiesUpdateParametersDeliveryPolicyArgs]]): # -> None:
        ...
    ...
    @geo_filters.setter
    def geo_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[GeoFilterArgs]]]]): # -> None:
        ...
    ...
    def is_http_allowed(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_https_allowed(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def optimization_type(self, value: Optional[pulumi.Input[Union[_builtins.str, OptimizationType]]]): # -> None:
        ...
    ...
    def origin_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DeepCreatedOriginGroupArgs]]]]): # -> None:
        ...
    ...
    def query_string_caching_behavior(self, value: Optional[pulumi.Input[QueryStringCachingBehavior]]): # -> None:
        ...
    ...
    def url_signing_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[UrlSigningKeyArgs]]]]): # -> None:
        ...
    ...
    def web_application_firewall_policy_link(self, value: Optional[pulumi.Input[EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkArgs]]): # -> None:
        ...
...
class Endpoint(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., content_types_to_compress: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., default_origin_group: Optional[pulumi.Input[Union[ResourceReferenceArgs, ResourceReferenceArgsDict]]] = ..., delivery_policy: Optional[pulumi.Input[Union[EndpointPropertiesUpdateParametersDeliveryPolicyArgs, EndpointPropertiesUpdateParametersDeliveryPolicyArgsDict]]] = ..., endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., geo_filters: Optional[pulumi.Input[Sequence[pulumi.Input[Union[GeoFilterArgs, GeoFilterArgsDict]]]]] = ..., is_compression_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_http_allowed: Optional[pulumi.Input[_builtins.bool]] = ..., is_https_allowed: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., optimization_type: Optional[pulumi.Input[Union[_builtins.str, OptimizationType]]] = ..., origin_groups: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DeepCreatedOriginGroupArgs, DeepCreatedOriginGroupArgsDict]]]]] = ..., origin_host_header: Optional[pulumi.Input[_builtins.str]] = ..., origin_path: Optional[pulumi.Input[_builtins.str]] = ..., origins: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DeepCreatedOriginArgs, DeepCreatedOriginArgsDict]]]]] = ..., probe_path: Optional[pulumi.Input[_builtins.str]] = ..., profile_name: Optional[pulumi.Input[_builtins.str]] = ..., query_string_caching_behavior: Optional[pulumi.Input[QueryStringCachingBehavior]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., url_signing_keys: Optional[pulumi.Input[Sequence[pulumi.Input[Union[UrlSigningKeyArgs, UrlSigningKeyArgsDict]]]]] = ..., web_application_firewall_policy_link: Optional[pulumi.Input[Union[EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkArgs, EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkArgsDict]]] = ..., __props__=...) -> None:
