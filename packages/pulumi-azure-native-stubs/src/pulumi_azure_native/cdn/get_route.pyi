...
class GetRouteResult:
    ...
    def __init__(__self__, azure_api_version=..., cache_configuration=..., custom_domains=..., deployment_status=..., enabled_state=..., endpoint_name=..., forwarding_protocol=..., https_redirect=..., id=..., link_to_default_domain=..., name=..., origin_group=..., origin_path=..., patterns_to_match=..., provisioning_state=..., rule_sets=..., supported_protocols=..., system_data=..., type=...) -> None:
        ...
...
def get_route(endpoint_name: Optional[_builtins.str] = ..., profile_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., route_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetRouteResult:
    
    ...

def get_route_output(endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., profile_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., route_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetRouteResult]:
