...
class AFDDomainHttpsCustomizedCipherSuiteSetResponse(dict):
    ...
    def __init__(__self__, *, cipher_suite_set_for_tls12: Optional[Sequence[_builtins.str]] = ..., cipher_suite_set_for_tls13: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AFDDomainHttpsParametersResponse(dict):
    ...
    def __init__(__self__, *, certificate_type: _builtins.str, cipher_suite_set_type: Optional[_builtins.str] = ..., customized_cipher_suite_set: Optional[outputs.AFDDomainHttpsCustomizedCipherSuiteSetResponse] = ..., minimum_tls_version: Optional[_builtins.str] = ..., secret: Optional[outputs.ResourceReferenceResponse] = ...) -> None:
...
class ActivatedResourceReferenceResponse(dict):
    ...
    def __init__(__self__, *, is_active: _builtins.bool, id: Optional[_builtins.str] = ...) -> None:
...
class AfdRouteCacheConfigurationResponse(dict):
    ...
    def __init__(__self__, *, compression_settings: Optional[outputs.CompressionSettingsResponse] = ..., query_parameters: Optional[_builtins.str] = ..., query_string_caching_behavior: Optional[_builtins.str] = ...) -> None:
...
class AzureFirstPartyManagedCertificateParametersResponse(dict):
    ...
    def __init__(__self__, *, certificate_authority: _builtins.str, expiration_date: _builtins.str, secret_source: outputs.ResourceReferenceResponse, subject: _builtins.str, thumbprint: _builtins.str, type: _builtins.str, subject_alternative_names: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CacheConfigurationResponse(dict):
    ...
    def __init__(__self__, *, cache_behavior: Optional[_builtins.str] = ..., cache_duration: Optional[_builtins.str] = ..., is_compression_enabled: Optional[_builtins.str] = ..., query_parameters: Optional[_builtins.str] = ..., query_string_caching_behavior: Optional[_builtins.str] = ...) -> None:
...
class CacheExpirationActionParametersResponse(dict):
    ...
    def __init__(__self__, *, cache_behavior: _builtins.str, cache_type: _builtins.str, type_name: _builtins.str, cache_duration: Optional[_builtins.str] = ...) -> None:
...
class CacheKeyQueryStringActionParametersResponse(dict):
    ...
    def __init__(__self__, *, query_string_behavior: _builtins.str, type_name: _builtins.str, query_parameters: Optional[_builtins.str] = ...) -> None:
...
class CdnCertificateSourceParametersResponse(dict):
    ...
    def __init__(__self__, *, certificate_type: _builtins.str, type_name: _builtins.str) -> None:
...
class CdnManagedHttpsParametersResponse(dict):
    ...
    def __init__(__self__, *, certificate_source: _builtins.str, certificate_source_parameters: outputs.CdnCertificateSourceParametersResponse, protocol_type: _builtins.str, minimum_tls_version: Optional[_builtins.str] = ...) -> None:
...
class ClientPortMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *, operator: _builtins.str, type_name: _builtins.str, match_values: Optional[Sequence[_builtins.str]] = ..., negate_condition: Optional[_builtins.bool] = ..., transforms: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CompressionSettingsResponse(dict):
    ...
    def __init__(__self__, *, content_types_to_compress: Optional[Sequence[_builtins.str]] = ..., is_compression_enabled: Optional[_builtins.bool] = ...) -> None:
...
class CookiesMatchConditionParametersResponse(dict):
    ...
    def __init__(__self__, *, operator: _builtins.str, type_name: _builtins.str, match_values: Optional[Sequence[_builtins.str]] = ..., negate_condition: Optional[_builtins.bool] = ..., selector: Optional[_builtins.str] = ..., transforms: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CustomRuleListResponse(dict):
    ...
    def __init__(__self__, *, rules: Optional[Sequence[outputs.CustomRuleResponse]] = ...) -> None:
...
class CustomRuleResponse(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, match_conditions: Sequence[outputs.MatchConditionResponse], name: _builtins.str, priority: _builtins.int, enabled_state: Optional[_builtins.str] = ...) -> None:
...
class CustomerCertificateParametersResponse(dict):
    ...
    def __init__(__self__, *, certificate_authority: _builtins.str, expiration_date: _builtins.str, secret_source: outputs.ResourceReferenceResponse, subject: _builtins.str, subject_alternative_names: Sequence[_builtins.str], thumbprint: _builtins.str, type: _builtins.str, secret_version: Optional[_builtins.str] = ..., use_latest_version: Optional[_builtins.bool] = ...) -> None:
...
class DeepCreatedCustomDomainResponse(dict):
    ...
    def __init__(__self__, *, host_name: _builtins.str, name: _builtins.str, validation_data: Optional[_builtins.str] = ...) -> None:
...
class DeepCreatedOriginGroupResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, origins: Sequence[outputs.ResourceReferenceResponse], health_probe_settings: Optional[outputs.HealthProbeParametersResponse] = ..., response_based_origin_error_detection_settings: Optional[outputs.ResponseBasedOriginErrorDetectionParametersResponse] = ..., traffic_restoration_time_to_healed_or_new_endpoints_in_minutes: Optional[_builtins.int] = ...) -> None:
...
class DeepCreatedOriginResponse(dict):
    ...
    def __init__(__self__, *, host_name: _builtins.str, name: _builtins.str, private_endpoint_status: _builtins.str, enabled: Optional[_builtins.bool] = ..., http_port: Optional[_builtins.int] = ..., https_port: Optional[_builtins.int] = ..., origin_host_header: Optional[_builtins.str] = ..., priority: Optional[_builtins.int] = ..., private_link_alias: Optional[_builtins.str] = ..., private_link_approval_message: Optional[_builtins.str] = ..., private_link_location: Optional[_builtins.str] = ..., private_link_resource_id: Optional[_builtins.str] = ..., weight: Optional[_builtins.int] = ...) -> None:
...
class DeliveryRuleCacheExpirationActionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.CacheExpirationActionParametersResponse) -> None:
...
class DeliveryRuleCacheKeyQueryStringActionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.CacheKeyQueryStringActionParametersResponse) -> None:
...
class DeliveryRuleClientPortConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.ClientPortMatchConditionParametersResponse) -> None:
...
class DeliveryRuleCookiesConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.CookiesMatchConditionParametersResponse) -> None:
...
class DeliveryRuleHostNameConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.HostNameMatchConditionParametersResponse) -> None:
...
class DeliveryRuleHttpVersionConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.HttpVersionMatchConditionParametersResponse) -> None:
...
class DeliveryRuleIsDeviceConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.IsDeviceMatchConditionParametersResponse) -> None:
...
class DeliveryRulePostArgsConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.PostArgsMatchConditionParametersResponse) -> None:
...
class DeliveryRuleQueryStringConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.QueryStringMatchConditionParametersResponse) -> None:
...
class DeliveryRuleRemoteAddressConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.RemoteAddressMatchConditionParametersResponse) -> None:
...
class DeliveryRuleRequestBodyConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.RequestBodyMatchConditionParametersResponse) -> None:
...
class DeliveryRuleRequestHeaderActionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.HeaderActionParametersResponse) -> None:
...
class DeliveryRuleRequestHeaderConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.RequestHeaderMatchConditionParametersResponse) -> None:
...
class DeliveryRuleRequestMethodConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.RequestMethodMatchConditionParametersResponse) -> None:
...
class DeliveryRuleRequestSchemeConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.RequestSchemeMatchConditionParametersResponse) -> None:
...
class DeliveryRuleRequestUriConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.RequestUriMatchConditionParametersResponse) -> None:
...
class DeliveryRuleResponse(dict):
    ...
    def __init__(__self__, *, actions: Sequence[Any], order: _builtins.int, conditions: Optional[Sequence[Any]] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class DeliveryRuleRouteConfigurationOverrideActionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.RouteConfigurationOverrideActionParametersResponse) -> None:
...
class DeliveryRuleServerPortConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.ServerPortMatchConditionParametersResponse) -> None:
...
class DeliveryRuleSocketAddrConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.SocketAddrMatchConditionParametersResponse) -> None:
...
class DeliveryRuleSslProtocolConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.SslProtocolMatchConditionParametersResponse) -> None:
...
class DeliveryRuleUrlFileExtensionConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.UrlFileExtensionMatchConditionParametersResponse) -> None:
...
class DeliveryRuleUrlFileNameConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.UrlFileNameMatchConditionParametersResponse) -> None:
...
class DeliveryRuleUrlPathConditionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.UrlPathMatchConditionParametersResponse) -> None:
...
class DomainValidationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, expiration_date: _builtins.str, validation_token: _builtins.str) -> None:
...
class EdgeActionAttachmentResponse(dict):
    ...
    def __init__(__self__, *, attached_resource_id: _builtins.str, id: _builtins.str) -> None:
...
class EndpointPropertiesUpdateParametersDeliveryPolicyResponse(dict):
    ...
    def __init__(__self__, *, rules: Sequence[outputs.DeliveryRuleResponse], description: Optional[_builtins.str] = ...) -> None:
...
class GeoFilterResponse(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, country_codes: Sequence[_builtins.str], relative_path: _builtins.str) -> None:
...
class HeaderActionParametersResponse(dict):
    ...
    def __init__(__self__, *, header_action: _builtins.str, header_name: _builtins.str, type_name: _builtins.str, value: Optional[_builtins.str] = ...) -> None:
...
class HealthProbeParametersResponse(dict):
    ...
    def __init__(__self__, *, probe_interval_in_seconds: Optional[_builtins.int] = ..., probe_path: Optional[_builtins.str] = ..., probe_protocol: Optional[_builtins.str] = ..., probe_request_type: Optional[_builtins.str] = ...) -> None:
...
class HttpErrorRangeParametersResponse(dict):
    ...
    def __init__(__self__, *, begin: Optional[_builtins.int] = ..., end: Optional[_builtins.int] = ...) -> None:
...
class KeyVaultCertificateSourceParametersResponse(dict):
    ...
    def __init__(__self__, *, delete_rule: _builtins.str, resource_group_name: _builtins.str, secret_name: _builtins.str, subscription_id: _builtins.str, type_name: _builtins.str, update_rule: _builtins.str, vault_name: _builtins.str, secret_version: Optional[_builtins.str] = ...) -> None:
...
class KeyVaultSigningKeyParametersResponse(dict):
    ...
    def __init__(__self__, *, resource_group_name: _builtins.str, secret_name: _builtins.str, secret_version: _builtins.str, subscription_id: _builtins.str, type_name: _builtins.str, vault_name: _builtins.str) -> None:
...
class LoadBalancingSettingsParametersResponse(dict):
    ...
    def __init__(__self__, *, additional_latency_in_milliseconds: Optional[_builtins.int] = ..., sample_size: Optional[_builtins.int] = ..., successful_samples_required: Optional[_builtins.int] = ...) -> None:
...
class ManagedCertificateParametersResponse(dict):
    ...
    def __init__(__self__, *, expiration_date: _builtins.str, subject: _builtins.str, type: _builtins.str) -> None:
...
class ManagedRuleOverrideResponse(dict):
    ...
    def __init__(__self__, *, rule_id: _builtins.str, action: Optional[_builtins.str] = ..., enabled_state: Optional[_builtins.str] = ...) -> None:
...
class ManagedRuleSetListResponse(dict):
    ...
    def __init__(__self__, *, managed_rule_sets: Optional[Sequence[outputs.ManagedRuleSetResponse]] = ...) -> None:
...
class ManagedRuleSetResponse(dict):
    ...
    def __init__(__self__, *, rule_set_type: _builtins.str, rule_set_version: _builtins.str, anomaly_score: Optional[_builtins.int] = ..., rule_group_overrides: Optional[Sequence[outputs.ManagedRuleGroupOverrideResponse]] = ...) -> None:
...
class MatchConditionResponse(dict):
    ...
    def __init__(__self__, *, match_value: Sequence[_builtins.str], match_variable: _builtins.str, operator: _builtins.str, negate_condition: Optional[_builtins.bool] = ..., selector: Optional[_builtins.str] = ..., transforms: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class OriginAuthenticationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, scope: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ..., user_assigned_identity: Optional[outputs.ResourceReferenceResponse] = ...) -> None:
...
class OriginGroupOverrideActionParametersResponse(dict):
    ...
    def __init__(__self__, *, origin_group: outputs.ResourceReferenceResponse, type_name: _builtins.str) -> None:
...
class OriginGroupOverrideActionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.OriginGroupOverrideActionParametersResponse) -> None:
...
class OriginGroupOverrideResponse(dict):
    ...
    def __init__(__self__, *, forwarding_protocol: Optional[_builtins.str] = ..., origin_group: Optional[outputs.ResourceReferenceResponse] = ...) -> None:
...
class PolicySettingsResponse(dict):
    ...
    def __init__(__self__, *, default_custom_block_response_body: Optional[_builtins.str] = ..., default_custom_block_response_status_code: Optional[_builtins.float] = ..., default_redirect_url: Optional[_builtins.str] = ..., enabled_state: Optional[_builtins.str] = ..., mode: Optional[_builtins.str] = ...) -> None:
...
class ProfileLogScrubbingResponse(dict):
    ...
    def __init__(__self__, *, scrubbing_rules: Optional[Sequence[outputs.ProfileScrubbingRulesResponse]] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class RateLimitRuleListResponse(dict):
    ...
    def __init__(__self__, *, rules: Optional[Sequence[outputs.RateLimitRuleResponse]] = ...) -> None:
...
class RateLimitRuleResponse(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, match_conditions: Sequence[outputs.MatchConditionResponse], name: _builtins.str, priority: _builtins.int, rate_limit_duration_in_minutes: _builtins.int, rate_limit_threshold: _builtins.int, enabled_state: Optional[_builtins.str] = ...) -> None:
...
class ResponseBasedOriginErrorDetectionParametersResponse(dict):
    ...
    def __init__(__self__, *, http_error_ranges: Optional[Sequence[outputs.HttpErrorRangeParametersResponse]] = ..., response_based_detected_error_types: Optional[_builtins.str] = ..., response_based_failover_threshold_percentage: Optional[_builtins.int] = ...) -> None:
...
class RouteConfigurationOverrideActionParametersResponse(dict):
    ...
    def __init__(__self__, *, type_name: _builtins.str, cache_configuration: Optional[outputs.CacheConfigurationResponse] = ..., origin_group_override: Optional[outputs.OriginGroupOverrideResponse] = ...) -> None:
...
class SecurityPolicyWebApplicationFirewallAssociationResponse(dict):
    ...
    def __init__(__self__, *, domains: Optional[Sequence[outputs.ActivatedResourceReferenceResponse]] = ..., patterns_to_match: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SecurityPolicyWebApplicationFirewallParametersResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, associations: Optional[Sequence[outputs.SecurityPolicyWebApplicationFirewallAssociationResponse]] = ..., waf_policy: Optional[outputs.ResourceReferenceResponse] = ...) -> None:
...
class SharedPrivateLinkResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, group_id: Optional[_builtins.str] = ..., private_link: Optional[outputs.ResourceReferenceResponse] = ..., private_link_location: Optional[_builtins.str] = ..., request_message: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class TargetEndpointResponse(dict):
    ...
    def __init__(__self__, *, ports: Optional[Sequence[_builtins.int]] = ..., target_fqdn: Optional[_builtins.str] = ...) -> None:
...
class UrlRedirectActionParametersResponse(dict):
    ...
    def __init__(__self__, *, redirect_type: _builtins.str, type_name: _builtins.str, custom_fragment: Optional[_builtins.str] = ..., custom_hostname: Optional[_builtins.str] = ..., custom_path: Optional[_builtins.str] = ..., custom_query_string: Optional[_builtins.str] = ..., destination_protocol: Optional[_builtins.str] = ...) -> None:
...
class UrlRedirectActionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.UrlRedirectActionParametersResponse) -> None:
...
class UrlRewriteActionParametersResponse(dict):
    ...
    def __init__(__self__, *, destination: _builtins.str, source_pattern: _builtins.str, type_name: _builtins.str, preserve_unmatched_path: Optional[_builtins.bool] = ...) -> None:
...
class UrlRewriteActionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.UrlRewriteActionParametersResponse) -> None:
...
class UrlSigningActionParametersResponse(dict):
    ...
    def __init__(__self__, *, type_name: _builtins.str, algorithm: Optional[_builtins.str] = ..., parameter_name_override: Optional[Sequence[outputs.UrlSigningParamIdentifierResponse]] = ...) -> None:
...
class UrlSigningActionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: outputs.UrlSigningActionParametersResponse) -> None:
...
class UrlSigningKeyParametersResponse(dict):
    ...
    def __init__(__self__, *, key_id: _builtins.str, secret_source: outputs.ResourceReferenceResponse, secret_version: _builtins.str, type: _builtins.str) -> None:
...
class UrlSigningKeyResponse(dict):
    ...
    def __init__(__self__, *, key_id: _builtins.str, key_source_parameters: outputs.KeyVaultSigningKeyParametersResponse) -> None:
...
class UrlSigningParamIdentifierResponse(dict):
    ...
    def __init__(__self__, *, param_indicator: _builtins.str, param_name: _builtins.str) -> None:
...
class UserManagedHttpsParametersResponse(dict):
    ...
    def __init__(__self__, *, certificate_source: _builtins.str, certificate_source_parameters: outputs.KeyVaultCertificateSourceParametersResponse, protocol_type: _builtins.str, minimum_tls_version: Optional[_builtins.str] = ...) -> None:
