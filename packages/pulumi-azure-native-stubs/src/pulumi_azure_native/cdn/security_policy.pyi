...
class SecurityPolicyArgs:
    def __init__(
        ...
        *,
        ...
        parameters: Optional[
            pulumi.Input[SecurityPolicyWebApplicationFirewallParametersArgs]
        ] = ...,
    ...
    def parameters(
        self,
    ) -> Optional[pulumi.Input[SecurityPolicyWebApplicationFirewallParametersArgs]]: ...
    @parameters.setter
    def parameters(
        self,
        value: Optional[
...
class SecurityPolicy(pulumi.CustomResource):
    ...
    def parameters(
        ...
        Optional[outputs.SecurityPolicyWebApplicationFirewallParametersResponse]
    ]: ...
    @_builtins.property
    @pulumi.getter(name="profileName")
