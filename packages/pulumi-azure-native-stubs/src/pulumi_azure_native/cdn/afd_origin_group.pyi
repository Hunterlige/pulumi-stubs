...
class AFDOriginGroupArgs:
    def __init__(__self__, *, profile_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], authentication: Optional[pulumi.Input[OriginAuthenticationPropertiesArgs]] = ..., health_probe_settings: Optional[pulumi.Input[HealthProbeParametersArgs]] = ..., load_balancing_settings: Optional[pulumi.Input[LoadBalancingSettingsParametersArgs]] = ..., origin_group_name: Optional[pulumi.Input[_builtins.str]] = ..., session_affinity_state: Optional[pulumi.Input[Union[_builtins.str, EnabledState]]] = ..., traffic_restoration_time_to_healed_or_new_endpoints_in_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def authentication(self, value: Optional[pulumi.Input[OriginAuthenticationPropertiesArgs]]): # -> None:
        ...
    ...
    def load_balancing_settings(self, value: Optional[pulumi.Input[LoadBalancingSettingsParametersArgs]]): # -> None:
        ...
    ...
    def session_affinity_state(self, value: Optional[pulumi.Input[Union[_builtins.str, EnabledState]]]): # -> None:
        ...
...
class AFDOriginGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., authentication: Optional[pulumi.Input[Union[OriginAuthenticationPropertiesArgs, OriginAuthenticationPropertiesArgsDict]]] = ..., health_probe_settings: Optional[pulumi.Input[Union[HealthProbeParametersArgs, HealthProbeParametersArgsDict]]] = ..., load_balancing_settings: Optional[pulumi.Input[Union[LoadBalancingSettingsParametersArgs, LoadBalancingSettingsParametersArgsDict]]] = ..., origin_group_name: Optional[pulumi.Input[_builtins.str]] = ..., profile_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., session_affinity_state: Optional[pulumi.Input[Union[_builtins.str, EnabledState]]] = ..., traffic_restoration_time_to_healed_or_new_endpoints_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: AFDOriginGroupArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> AFDOriginGroup:
