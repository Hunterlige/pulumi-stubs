...
@pulumi.input_type
class OriginArgs:
    def __init__(__self__, *, endpoint_name: pulumi.Input[_builtins.str], host_name: pulumi.Input[_builtins.str], profile_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], enabled: Optional[pulumi.Input[_builtins.bool]] = ..., http_port: Optional[pulumi.Input[_builtins.int]] = ..., https_port: Optional[pulumi.Input[_builtins.int]] = ..., origin_host_header: Optional[pulumi.Input[_builtins.str]] = ..., origin_name: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.int]] = ..., private_link_alias: Optional[pulumi.Input[_builtins.str]] = ..., private_link_approval_message: Optional[pulumi.Input[_builtins.str]] = ..., private_link_location: Optional[pulumi.Input[_builtins.str]] = ..., private_link_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., weight: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class Origin(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., host_name: Optional[pulumi.Input[_builtins.str]] = ..., http_port: Optional[pulumi.Input[_builtins.int]] = ..., https_port: Optional[pulumi.Input[_builtins.int]] = ..., origin_host_header: Optional[pulumi.Input[_builtins.str]] = ..., origin_name: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.int]] = ..., private_link_alias: Optional[pulumi.Input[_builtins.str]] = ..., private_link_approval_message: Optional[pulumi.Input[_builtins.str]] = ..., private_link_location: Optional[pulumi.Input[_builtins.str]] = ..., private_link_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., profile_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., weight: Optional[pulumi.Input[_builtins.int]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: OriginArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Origin:
