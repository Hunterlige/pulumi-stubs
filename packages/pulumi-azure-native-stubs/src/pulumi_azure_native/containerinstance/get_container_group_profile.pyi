...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetContainerGroupProfileResult', 'AwaitableGetContainerGroupProfileResult', 'get_container_group_profile', 'get_container_group_profile_output']
@pulumi.output_type
class GetContainerGroupProfileResult:
    
    def __init__(__self__, azure_api_version=..., confidential_compute_properties=..., containers=..., diagnostics=..., encryption_properties=..., extensions=..., id=..., image_registry_credentials=..., init_containers=..., ip_address=..., location=..., name=..., os_type=..., priority=..., restart_policy=..., revision=..., sku=..., tags=..., type=..., volumes=..., zones=...) -> None:
        ...
...
class AwaitableGetContainerGroupProfileResult(GetContainerGroupProfileResult):
    def __await__(self): # -> Generator[Never, Any, GetContainerGroupProfileResult]:
        ...
    


def get_container_group_profile(container_group_profile_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetContainerGroupProfileResult:
    
    ...

def get_container_group_profile_output(container_group_profile_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetContainerGroupProfileResult]:
