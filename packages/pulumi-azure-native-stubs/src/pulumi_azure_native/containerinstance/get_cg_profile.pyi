...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetCGProfileResult', 'AwaitableGetCGProfileResult', 'get_cg_profile', 'get_cg_profile_output']
@pulumi.output_type
class GetCGProfileResult:
    
    def __init__(__self__, azure_api_version=..., confidential_compute_properties=..., containers=..., diagnostics=..., encryption_properties=..., extensions=..., id=..., image_registry_credentials=..., init_containers=..., ip_address=..., location=..., name=..., os_type=..., priority=..., registered_revisions=..., restart_policy=..., revision=..., security_context=..., shutdown_grace_period=..., sku=..., system_data=..., tags=..., time_to_live=..., type=..., use_krypton=..., volumes=..., zones=...) -> None:
        ...
...
class AwaitableGetCGProfileResult(GetCGProfileResult):
    def __await__(self): # -> Generator[Never, Any, GetCGProfileResult]:
        ...
    


def get_cg_profile(container_group_profile_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetCGProfileResult:
    
    ...

def get_cg_profile_output(container_group_profile_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetCGProfileResult]:
