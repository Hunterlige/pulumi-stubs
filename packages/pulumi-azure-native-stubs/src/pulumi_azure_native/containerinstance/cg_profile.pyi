...
@pulumi.input_type
class CGProfileArgs:
    def __init__(__self__, *, containers: pulumi.Input[Sequence[pulumi.Input[ContainerArgs]]], os_type: pulumi.Input[Union[_builtins.str, OperatingSystemTypes]], resource_group_name: pulumi.Input[_builtins.str], confidential_compute_properties: Optional[pulumi.Input[ConfidentialComputePropertiesArgs]] = ..., container_group_profile_name: Optional[pulumi.Input[_builtins.str]] = ..., diagnostics: Optional[pulumi.Input[ContainerGroupDiagnosticsArgs]] = ..., encryption_properties: Optional[pulumi.Input[EncryptionPropertiesArgs]] = ..., extensions: Optional[pulumi.Input[Sequence[pulumi.Input[DeploymentExtensionSpecArgs]]]] = ..., image_registry_credentials: Optional[pulumi.Input[Sequence[pulumi.Input[ImageRegistryCredentialArgs]]]] = ..., init_containers: Optional[pulumi.Input[Sequence[pulumi.Input[InitContainerDefinitionArgs]]]] = ..., ip_address: Optional[pulumi.Input[IpAddressArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[Union[_builtins.str, Priority]]] = ..., restart_policy: Optional[pulumi.Input[Union[_builtins.str, ContainerGroupRestartPolicy]]] = ..., security_context: Optional[pulumi.Input[SecurityContextDefinitionArgs]] = ..., shutdown_grace_period: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[_builtins.str, ContainerGroupSku]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., time_to_live: Optional[pulumi.Input[_builtins.str]] = ..., use_krypton: Optional[pulumi.Input[_builtins.bool]] = ..., volumes: Optional[pulumi.Input[Sequence[pulumi.Input[VolumeArgs]]]] = ..., zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @priority.setter
    def priority(self, value: Optional[pulumi.Input[Union[_builtins.str, Priority]]]): # -> None:
        ...
    ...
    def shutdown_grace_period(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @use_krypton.setter
    def use_krypton(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class CGProfile(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., confidential_compute_properties: Optional[pulumi.Input[Union[ConfidentialComputePropertiesArgs, ConfidentialComputePropertiesArgsDict]]] = ..., container_group_profile_name: Optional[pulumi.Input[_builtins.str]] = ..., containers: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ContainerArgs, ContainerArgsDict]]]]] = ..., diagnostics: Optional[pulumi.Input[Union[ContainerGroupDiagnosticsArgs, ContainerGroupDiagnosticsArgsDict]]] = ..., encryption_properties: Optional[pulumi.Input[Union[EncryptionPropertiesArgs, EncryptionPropertiesArgsDict]]] = ..., extensions: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DeploymentExtensionSpecArgs, DeploymentExtensionSpecArgsDict]]]]] = ..., image_registry_credentials: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ImageRegistryCredentialArgs, ImageRegistryCredentialArgsDict]]]]] = ..., init_containers: Optional[pulumi.Input[Sequence[pulumi.Input[Union[InitContainerDefinitionArgs, InitContainerDefinitionArgsDict]]]]] = ..., ip_address: Optional[pulumi.Input[Union[IpAddressArgs, IpAddressArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., os_type: Optional[pulumi.Input[Union[_builtins.str, OperatingSystemTypes]]] = ..., priority: Optional[pulumi.Input[Union[_builtins.str, Priority]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., restart_policy: Optional[pulumi.Input[Union[_builtins.str, ContainerGroupRestartPolicy]]] = ..., security_context: Optional[pulumi.Input[Union[SecurityContextDefinitionArgs, SecurityContextDefinitionArgsDict]]] = ..., shutdown_grace_period: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[_builtins.str, ContainerGroupSku]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., time_to_live: Optional[pulumi.Input[_builtins.str]] = ..., use_krypton: Optional[pulumi.Input[_builtins.bool]] = ..., volumes: Optional[pulumi.Input[Sequence[pulumi.Input[Union[VolumeArgs, VolumeArgsDict]]]]] = ..., zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: CGProfileArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> CGProfile:
