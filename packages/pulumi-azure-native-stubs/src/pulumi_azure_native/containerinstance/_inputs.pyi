...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApiEntityReferenceArgs', 'ApiEntityReferenceArgsDict', 'ApplicationGatewayBackendAddressPoolArgs', 'ApplicationGatewayBackendAddressPoolArgsDict', 'ApplicationGatewayArgs', 'ApplicationGatewayArgsDict', 'AzureFileVolumeArgs', 'AzureFileVolumeArgsDict', 'ConfidentialComputePropertiesArgs', 'ConfidentialComputePropertiesArgsDict', 'ConfigMapArgs', 'ConfigMapArgsDict', 'ContainerExecArgs', 'ContainerExecArgsDict', 'ContainerGroupDiagnosticsArgs', 'ContainerGroupDiagnosticsArgsDict', 'ContainerGroupIdentityArgs', 'ContainerGroupIdentityArgsDict', 'ContainerGroupProfileReferenceDefinitionArgs', 'ContainerGroupProfileReferenceDefinitionArgsDict', 'ContainerGroupProfileStubArgs', 'ContainerGroupProfileStubArgsDict', 'ContainerGroupSubnetIdArgs', 'ContainerGroupSubnetIdArgsDict', 'ContainerHttpGetArgs', 'ContainerHttpGetArgsDict', 'ContainerPortArgs', 'ContainerPortArgsDict', 'ContainerProbeArgs', 'ContainerProbeArgsDict', 'ContainerArgs', 'ContainerArgsDict', 'DeploymentExtensionSpecArgs', 'DeploymentExtensionSpecArgsDict', 'DnsConfigurationArgs', 'DnsConfigurationArgsDict', 'ElasticProfileContainerGroupNamingPolicyArgs', 'ElasticProfileContainerGroupNamingPolicyArgsDict', 'ElasticProfileGuidNamingPolicyArgs', 'ElasticProfileGuidNamingPolicyArgsDict', 'ElasticProfileArgs', 'ElasticProfileArgsDict', 'EncryptionPropertiesArgs', 'EncryptionPropertiesArgsDict', 'EnvironmentVariableArgs', 'EnvironmentVariableArgsDict', 'FileSharePropertiesArgs', 'FileSharePropertiesArgsDict', 'FileShareArgs', 'FileShareArgsDict', 'GitRepoVolumeArgs', 'GitRepoVolumeArgsDict', 'GpuResourceArgs', 'GpuResourceArgsDict', 'HttpHeaderArgs', 'HttpHeaderArgsDict', 'ImageRegistryCredentialArgs', 'ImageRegistryCredentialArgsDict', 'InitContainerDefinitionArgs', 'InitContainerDefinitionArgsDict', 'IpAddressArgs', 'IpAddressArgsDict', 'LoadBalancerBackendAddressPoolArgs', 'LoadBalancerBackendAddressPoolArgsDict', 'LoadBalancerArgs', 'LoadBalancerArgsDict', 'LogAnalyticsArgs', 'LogAnalyticsArgsDict', 'NGroupCGPropertyContainerPropertiesArgs', 'NGroupCGPropertyContainerPropertiesArgsDict', 'NGroupCGPropertyContainerArgs', 'NGroupCGPropertyContainerArgsDict', 'NGroupCGPropertyVolumeArgs', 'NGroupCGPropertyVolumeArgsDict', 'NGroupContainerGroupPropertiesArgs', 'NGroupContainerGroupPropertiesArgsDict', 'NGroupIdentityArgs', 'NGroupIdentityArgsDict', 'NetworkProfileArgs', 'NetworkProfileArgsDict', 'PlacementProfileArgs', 'PlacementProfileArgsDict', 'PortArgs', 'PortArgsDict', 'ResourceLimitsArgs', 'ResourceLimitsArgsDict', 'ResourceRequestsArgs', 'ResourceRequestsArgsDict', 'ResourceRequirementsArgs', 'ResourceRequirementsArgsDict', 'SecurityContextCapabilitiesDefinitionArgs', 'SecurityContextCapabilitiesDefinitionArgsDict', 'SecurityContextDefinitionArgs', 'SecurityContextDefinitionArgsDict', 'StandbyPoolProfileDefinitionArgs', 'StandbyPoolProfileDefinitionArgsDict', 'StorageProfileArgs', 'StorageProfileArgsDict', 'UpdateProfileRollingUpdateProfileArgs', 'UpdateProfileRollingUpdateProfileArgsDict', 'UpdateProfileArgs', 'UpdateProfileArgsDict', 'VolumeMountArgs', 'VolumeMountArgsDict', 'VolumeArgs', 'VolumeArgsDict']
...
class ApplicationGatewayArgs:
    def __init__(__self__, *, backend_address_pools: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationGatewayBackendAddressPoolArgs]]]] = ..., resource: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def backend_address_pools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationGatewayBackendAddressPoolArgs]]]]): # -> None:
        ...
...
class AzureFileVolumeArgs:
    def __init__(__self__, *, share_name: pulumi.Input[_builtins.str], storage_account_name: pulumi.Input[_builtins.str], read_only: Optional[pulumi.Input[_builtins.bool]] = ..., storage_account_key: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_key_reference: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def storage_account_key_reference(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConfidentialComputePropertiesArgs:
    def __init__(__self__, *, cce_policy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @cce_policy.setter
    def cce_policy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class ConfigMapArgs:
    def __init__(__self__, *, key_value_pairs: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def key_value_pairs(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ContainerExecArgs:
    def __init__(__self__, *, command: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ContainerGroupDiagnosticsArgs:
    def __init__(__self__, *, log_analytics: Optional[pulumi.Input[LogAnalyticsArgs]] = ...) -> None:
    ...
    def log_analytics(self, value: Optional[pulumi.Input[LogAnalyticsArgs]]): # -> None:
        ...
...
class ContainerGroupProfileReferenceDefinitionArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., revision: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ContainerGroupProfileStubArgs:
    def __init__(__self__, *, container_group_properties: Optional[pulumi.Input[NGroupContainerGroupPropertiesArgs]] = ..., network_profile: Optional[pulumi.Input[NetworkProfileArgs]] = ..., resource: Optional[pulumi.Input[ApiEntityReferenceArgs]] = ..., revision: Optional[pulumi.Input[_builtins.int]] = ..., storage_profile: Optional[pulumi.Input[StorageProfileArgs]] = ...) -> None:
    ...
    def container_group_properties(self, value: Optional[pulumi.Input[NGroupContainerGroupPropertiesArgs]]): # -> None:
        ...
    ...
    @resource.setter
    def resource(self, value: Optional[pulumi.Input[ApiEntityReferenceArgs]]): # -> None:
        ...
...
class ContainerHttpGetArgs:
    def __init__(__self__, *, port: pulumi.Input[_builtins.int], http_headers: Optional[pulumi.Input[Sequence[pulumi.Input[HttpHeaderArgs]]]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., scheme: Optional[pulumi.Input[Union[_builtins.str, Scheme]]] = ...) -> None:
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HttpHeaderArgs]]]]): # -> None:
        ...
...
class ContainerPortArgs:
    def __init__(__self__, *, port: pulumi.Input[_builtins.int], protocol: Optional[pulumi.Input[Union[_builtins.str, ContainerNetworkProtocol]]] = ...) -> None:
    ...
    @protocol.setter
    def protocol(self, value: Optional[pulumi.Input[Union[_builtins.str, ContainerNetworkProtocol]]]): # -> None:
        ...
...
class ContainerProbeArgs:
    def __init__(__self__, *, exec_: Optional[pulumi.Input[ContainerExecArgs]] = ..., failure_threshold: Optional[pulumi.Input[_builtins.int]] = ..., http_get: Optional[pulumi.Input[ContainerHttpGetArgs]] = ..., initial_delay_seconds: Optional[pulumi.Input[_builtins.int]] = ..., period_seconds: Optional[pulumi.Input[_builtins.int]] = ..., success_threshold: Optional[pulumi.Input[_builtins.int]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @exec_.setter
    def exec_(self, value: Optional[pulumi.Input[ContainerExecArgs]]): # -> None:
        ...
    ...
    @http_get.setter
    def http_get(self, value: Optional[pulumi.Input[ContainerHttpGetArgs]]): # -> None:
        ...
...
@pulumi.input_type
class ContainerArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], command: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., config_map: Optional[pulumi.Input[ConfigMapArgs]] = ..., environment_variables: Optional[pulumi.Input[Sequence[pulumi.Input[EnvironmentVariableArgs]]]] = ..., image: Optional[pulumi.Input[_builtins.str]] = ..., liveness_probe: Optional[pulumi.Input[ContainerProbeArgs]] = ..., ports: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerPortArgs]]]] = ..., readiness_probe: Optional[pulumi.Input[ContainerProbeArgs]] = ..., resources: Optional[pulumi.Input[ResourceRequirementsArgs]] = ..., security_context: Optional[pulumi.Input[SecurityContextDefinitionArgs]] = ..., volume_mounts: Optional[pulumi.Input[Sequence[pulumi.Input[VolumeMountArgs]]]] = ...) -> None:
    ...
    @config_map.setter
    def config_map(self, value: Optional[pulumi.Input[ConfigMapArgs]]): # -> None:
        ...
    ...
    def liveness_probe(self, value: Optional[pulumi.Input[ContainerProbeArgs]]): # -> None:
        ...
    ...
    @ports.setter
    def ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerPortArgs]]]]): # -> None:
        ...
    ...
    def readiness_probe(self, value: Optional[pulumi.Input[ContainerProbeArgs]]): # -> None:
        ...
    ...
    @resources.setter
    def resources(self, value: Optional[pulumi.Input[ResourceRequirementsArgs]]): # -> None:
        ...
    ...
    def security_context(self, value: Optional[pulumi.Input[SecurityContextDefinitionArgs]]): # -> None:
        ...
...
class DeploymentExtensionSpecArgs:
    def __init__(__self__, *, extension_type: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], version: pulumi.Input[_builtins.str], protected_settings: Optional[Any] = ..., settings: Optional[Any] = ...) -> None:
    ...
    def extension_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DnsConfigurationArgs:
    def __init__(__self__, *, name_servers: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], options: Optional[pulumi.Input[_builtins.str]] = ..., search_domains: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def search_domains(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ElasticProfileContainerGroupNamingPolicyArgs:
    def __init__(__self__, *, guid_naming_policy: Optional[pulumi.Input[ElasticProfileGuidNamingPolicyArgs]] = ...) -> None:
    ...
    def guid_naming_policy(self, value: Optional[pulumi.Input[ElasticProfileGuidNamingPolicyArgs]]): # -> None:
        ...
...
class ElasticProfileArgs:
    def __init__(__self__, *, container_group_naming_policy: Optional[pulumi.Input[ElasticProfileContainerGroupNamingPolicyArgs]] = ..., desired_count: Optional[pulumi.Input[_builtins.int]] = ..., maintain_desired_count: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def container_group_naming_policy(self, value: Optional[pulumi.Input[ElasticProfileContainerGroupNamingPolicyArgs]]): # -> None:
        ...
    ...
    def maintain_desired_count(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class EncryptionPropertiesArgs:
    def __init__(__self__, *, key_name: pulumi.Input[_builtins.str], key_version: pulumi.Input[_builtins.str], vault_base_url: pulumi.Input[_builtins.str], identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def vault_base_url(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class EnvironmentVariableArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], secure_value: Optional[pulumi.Input[_builtins.str]] = ..., secure_value_reference: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def secure_value_reference(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FileSharePropertiesArgs:
    def __init__(__self__, *, share_access_tier: Optional[pulumi.Input[AzureFileShareAccessTier]] = ..., share_access_type: Optional[pulumi.Input[AzureFileShareAccessType]] = ...) -> None:
    ...
    def share_access_tier(self, value: Optional[pulumi.Input[AzureFileShareAccessTier]]): # -> None:
        ...
    ...
    def share_access_type(self, value: Optional[pulumi.Input[AzureFileShareAccessType]]): # -> None:
        ...
...
@pulumi.input_type
class FileShareArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[FileSharePropertiesArgs]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[FileSharePropertiesArgs]]): # -> None:
        ...
...
class GitRepoVolumeArgs:
    def __init__(__self__, *, repository: pulumi.Input[_builtins.str], directory: Optional[pulumi.Input[_builtins.str]] = ..., revision: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class GpuResourceArgs:
    def __init__(__self__, *, count: pulumi.Input[_builtins.int], sku: pulumi.Input[Union[_builtins.str, GpuSku]]) -> None:
    ...
    @sku.setter
    def sku(self, value: pulumi.Input[Union[_builtins.str, GpuSku]]): # -> None:
        ...
...
class ImageRegistryCredentialArgs:
    def __init__(__self__, *, server: pulumi.Input[_builtins.str], identity: Optional[pulumi.Input[_builtins.str]] = ..., identity_url: Optional[pulumi.Input[_builtins.str]] = ..., password: Optional[pulumi.Input[_builtins.str]] = ..., password_reference: Optional[pulumi.Input[_builtins.str]] = ..., username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @identity_url.setter
    def identity_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def password_reference(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InitContainerDefinitionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], command: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., environment_variables: Optional[pulumi.Input[Sequence[pulumi.Input[EnvironmentVariableArgs]]]] = ..., image: Optional[pulumi.Input[_builtins.str]] = ..., security_context: Optional[pulumi.Input[SecurityContextDefinitionArgs]] = ..., volume_mounts: Optional[pulumi.Input[Sequence[pulumi.Input[VolumeMountArgs]]]] = ...) -> None:
...
@pulumi.input_type
class IpAddressArgs:
    def __init__(__self__, *, ports: pulumi.Input[Sequence[pulumi.Input[PortArgs]]], type: pulumi.Input[Union[_builtins.str, ContainerGroupIpAddressType]], auto_generated_domain_name_label_scope: Optional[pulumi.Input[Union[_builtins.str, DnsNameLabelReusePolicy]]] = ..., dns_name_label: Optional[pulumi.Input[_builtins.str]] = ..., ip: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ports.setter
    def ports(self, value: pulumi.Input[Sequence[pulumi.Input[PortArgs]]]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ContainerGroupIpAddressType]]): # -> None:
        ...
    ...
    def auto_generated_domain_name_label_scope(self, value: Optional[pulumi.Input[Union[_builtins.str, DnsNameLabelReusePolicy]]]): # -> None:
        ...
    ...
    def dns_name_label(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LoadBalancerArgs:
    def __init__(__self__, *, backend_address_pools: Optional[pulumi.Input[Sequence[pulumi.Input[LoadBalancerBackendAddressPoolArgs]]]] = ...) -> None:
    ...
    @backend_address_pools.setter
    def backend_address_pools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LoadBalancerBackendAddressPoolArgs]]]]): # -> None:
        ...
...
class LogAnalyticsArgs:
    def __init__(__self__, *, workspace_id: pulumi.Input[_builtins.str], workspace_key: pulumi.Input[_builtins.str], log_type: Optional[pulumi.Input[Union[_builtins.str, LogAnalyticsLogType]]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., workspace_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def workspace_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @log_type.setter
    def log_type(self, value: Optional[pulumi.Input[Union[_builtins.str, LogAnalyticsLogType]]]): # -> None:
        ...
...
class NGroupCGPropertyContainerPropertiesArgs:
    def __init__(__self__, *, volume_mounts: Optional[pulumi.Input[Sequence[pulumi.Input[VolumeMountArgs]]]] = ...) -> None:
...
class NGroupCGPropertyContainerArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[NGroupCGPropertyContainerPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[NGroupCGPropertyContainerPropertiesArgs]]): # -> None:
        ...
...
class NGroupCGPropertyVolumeArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], azure_file: Optional[pulumi.Input[AzureFileVolumeArgs]] = ...) -> None:
    ...
    @azure_file.setter
    def azure_file(self, value: Optional[pulumi.Input[AzureFileVolumeArgs]]): # -> None:
        ...
...
class NGroupContainerGroupPropertiesArgs:
    def __init__(__self__, *, containers: Optional[pulumi.Input[Sequence[pulumi.Input[NGroupCGPropertyContainerArgs]]]] = ..., subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerGroupSubnetIdArgs]]]] = ..., volumes: Optional[pulumi.Input[Sequence[pulumi.Input[NGroupCGPropertyVolumeArgs]]]] = ...) -> None:
    ...
    @containers.setter
    def containers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NGroupCGPropertyContainerArgs]]]]): # -> None:
        ...
    ...
    @volumes.setter
    def volumes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NGroupCGPropertyVolumeArgs]]]]): # -> None:
        ...
...
class NetworkProfileArgs:
    def __init__(__self__, *, application_gateway: Optional[pulumi.Input[ApplicationGatewayArgs]] = ..., load_balancer: Optional[pulumi.Input[LoadBalancerArgs]] = ...) -> None:
    ...
    def application_gateway(self, value: Optional[pulumi.Input[ApplicationGatewayArgs]]): # -> None:
        ...
    ...
    def load_balancer(self, value: Optional[pulumi.Input[LoadBalancerArgs]]): # -> None:
        ...
...
class PlacementProfileArgs:
    def __init__(__self__, *, fault_domain_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def fault_domain_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
@pulumi.input_type
class PortArgs:
    def __init__(__self__, *, port: pulumi.Input[_builtins.int], protocol: Optional[pulumi.Input[Union[_builtins.str, ContainerGroupNetworkProtocol]]] = ...) -> None:
    ...
    @protocol.setter
    def protocol(self, value: Optional[pulumi.Input[Union[_builtins.str, ContainerGroupNetworkProtocol]]]): # -> None:
        ...
...
class ResourceLimitsArgs:
    def __init__(__self__, *, cpu: Optional[pulumi.Input[_builtins.float]] = ..., gpu: Optional[pulumi.Input[GpuResourceArgs]] = ..., memory_in_gb: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @gpu.setter
    def gpu(self, value: Optional[pulumi.Input[GpuResourceArgs]]): # -> None:
        ...
...
class ResourceRequestsArgs:
    def __init__(__self__, *, cpu: pulumi.Input[_builtins.float], memory_in_gb: pulumi.Input[_builtins.float], gpu: Optional[pulumi.Input[GpuResourceArgs]] = ...) -> None:
...
class SecurityContextCapabilitiesDefinitionArgs:
    def __init__(__self__, *, add: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., drop: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @add.setter
    def add(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @drop.setter
    def drop(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class SecurityContextDefinitionArgs:
    def __init__(__self__, *, allow_privilege_escalation: Optional[pulumi.Input[_builtins.bool]] = ..., capabilities: Optional[pulumi.Input[SecurityContextCapabilitiesDefinitionArgs]] = ..., privileged: Optional[pulumi.Input[_builtins.bool]] = ..., run_as_group: Optional[pulumi.Input[_builtins.int]] = ..., run_as_user: Optional[pulumi.Input[_builtins.int]] = ..., seccomp_profile: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @capabilities.setter
    def capabilities(self, value: Optional[pulumi.Input[SecurityContextCapabilitiesDefinitionArgs]]): # -> None:
        ...
    ...
    def seccomp_profile(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StandbyPoolProfileDefinitionArgs:
    def __init__(__self__, *, fail_container_group_create_on_reuse_failure: Optional[pulumi.Input[_builtins.bool]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def fail_container_group_create_on_reuse_failure(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class StorageProfileArgs:
    def __init__(__self__, *, file_shares: Optional[pulumi.Input[Sequence[pulumi.Input[FileShareArgs]]]] = ...) -> None:
    ...
    @file_shares.setter
    def file_shares(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FileShareArgs]]]]): # -> None:
        ...
...
class UpdateProfileRollingUpdateProfileArgs:
    def __init__(__self__, *, in_place_update: Optional[pulumi.Input[_builtins.bool]] = ..., max_batch_percent: Optional[pulumi.Input[_builtins.int]] = ..., max_unhealthy_percent: Optional[pulumi.Input[_builtins.int]] = ..., pause_time_between_batches: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def in_place_update(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def max_batch_percent(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_unhealthy_percent(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class UpdateProfileArgs:
    def __init__(__self__, *, rolling_update_profile: Optional[pulumi.Input[UpdateProfileRollingUpdateProfileArgs]] = ..., update_mode: Optional[pulumi.Input[Union[_builtins.str, NGroupUpdateMode]]] = ...) -> None:
    ...
    def rolling_update_profile(self, value: Optional[pulumi.Input[UpdateProfileRollingUpdateProfileArgs]]): # -> None:
        ...
    ...
    @update_mode.setter
    def update_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, NGroupUpdateMode]]]): # -> None:
        ...
...
@pulumi.input_type
class VolumeArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], azure_file: Optional[pulumi.Input[AzureFileVolumeArgs]] = ..., empty_dir: Optional[Any] = ..., git_repo: Optional[pulumi.Input[GitRepoVolumeArgs]] = ..., secret: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., secret_reference: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @empty_dir.setter
    def empty_dir(self, value: Optional[Any]): # -> None:
        ...
    ...
    @git_repo.setter
    def git_repo(self, value: Optional[pulumi.Input[GitRepoVolumeArgs]]): # -> None:
        ...
    ...
    @secret.setter
    def secret(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def secret_reference(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
