...
__all__ = [
    ...
    "AwaitableGetConfigurationReferenceResult",
    "get_configuration_reference",
    "get_configuration_reference_output",
]
...
def get_configuration_reference(
    configuration_reference_name: Optional[_builtins.str] = ...,
    resource_uri: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetConfigurationReferenceResult: ...
def get_configuration_reference_output(
...
) -> pulumi.Output[GetConfigurationReferenceResult]: ...
