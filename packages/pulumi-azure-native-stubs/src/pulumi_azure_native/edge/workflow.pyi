...
@pulumi.input_type
class WorkflowArgs:
    def __init__(__self__, *, context_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], extended_location: Optional[pulumi.Input[AzureResourceManagerCommonTypesExtendedLocationArgs]] = ..., workflow_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
