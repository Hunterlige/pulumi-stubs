...
@pulumi.input_type
class ExecutionArgs:
    def __init__(__self__, *, context_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], version_name: pulumi.Input[_builtins.str], workflow_name: pulumi.Input[_builtins.str], execution_name: Optional[pulumi.Input[_builtins.str]] = ..., extended_location: Optional[pulumi.Input[AzureResourceManagerCommonTypesExtendedLocationArgs]] = ..., properties: Optional[pulumi.Input[ExecutionPropertiesArgs]] = ...) -> None:
    ...
    def execution_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[ExecutionPropertiesArgs]]): # -> None:
        ...
...
class Execution(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., context_name: Optional[pulumi.Input[_builtins.str]] = ..., execution_name: Optional[pulumi.Input[_builtins.str]] = ..., extended_location: Optional[pulumi.Input[Union[AzureResourceManagerCommonTypesExtendedLocationArgs, AzureResourceManagerCommonTypesExtendedLocationArgsDict]]] = ..., properties: Optional[pulumi.Input[Union[ExecutionPropertiesArgs, ExecutionPropertiesArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., version_name: Optional[pulumi.Input[_builtins.str]] = ..., workflow_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Execution:
