...
class TargetArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[TargetPropertiesArgs]] = ...,
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[TargetPropertiesArgs]]): ...
    @_builtins.property
    @pulumi.getter
    def tags(
        self,
...
class Target(pulumi.CustomResource):
    ...
    def __init__(
        ...
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[
            pulumi.Input[Union[TargetPropertiesArgs, TargetPropertiesArgsDict]]
        ] = ...,
