...
class SolutionVersionArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[SolutionVersionPropertiesArgs]] = ...,
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[SolutionVersionPropertiesArgs]]
    ): ...
    @_builtins.property
...
class SolutionVersion(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[SolutionVersionPropertiesArgs, SolutionVersionPropertiesArgsDict]
            ]
        ] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.SolutionVersionPropertiesResponse]: ...
    @_builtins.property
