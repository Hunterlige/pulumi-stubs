...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConfigurationProfileAssignmentPropertiesArgs', 'ConfigurationProfileAssignmentPropertiesArgsDict', 'ConfigurationProfilePropertiesArgs', 'ConfigurationProfilePropertiesArgsDict']
...
class ConfigurationProfileAssignmentPropertiesArgs:
    def __init__(__self__, *, configuration_profile: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def configuration_profile(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
