...
class AwaitableGetConfigurationProfilesVersionResult(
    GetConfigurationProfilesVersionResult
):
    def __await__(self): ...

def get_configuration_profiles_version(
    configuration_profile_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    version_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetConfigurationProfilesVersionResult: ...
def get_configuration_profiles_version_output(
...
) -> pulumi.Output[GetConfigurationProfilesVersionResult]: ...
