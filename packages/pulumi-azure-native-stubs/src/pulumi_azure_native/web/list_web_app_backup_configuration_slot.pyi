...
class AwaitableListWebAppBackupConfigurationSlotResult(
    ListWebAppBackupConfigurationSlotResult
):
    def __await__(self): ...

def list_web_app_backup_configuration_slot(
    name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    slot: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableListWebAppBackupConfigurationSlotResult: ...
def list_web_app_backup_configuration_slot_output(
    name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    slot: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[ListWebAppBackupConfigurationSlotResult]: ...
