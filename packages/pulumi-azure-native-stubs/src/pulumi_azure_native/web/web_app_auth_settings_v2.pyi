...
class WebAppAuthSettingsV2(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: WebAppAuthSettingsV2Args, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppAuthSettingsV2:
