...
class WebAppAuthSettings(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., aad_claims_authorization: Optional[pulumi.Input[_builtins.str]] = ..., additional_login_params: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allowed_audiences: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allowed_external_redirect_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., auth_file_path: Optional[pulumi.Input[_builtins.str]] = ..., client_id: Optional[pulumi.Input[_builtins.str]] = ..., client_secret: Optional[pulumi.Input[_builtins.str]] = ..., client_secret_certificate_thumbprint: Optional[pulumi.Input[_builtins.str]] = ..., client_secret_setting_name: Optional[pulumi.Input[_builtins.str]] = ..., config_version: Optional[pulumi.Input[_builtins.str]] = ..., default_provider: Optional[pulumi.Input[BuiltInAuthenticationProvider]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., facebook_app_id: Optional[pulumi.Input[_builtins.str]] = ..., facebook_app_secret: Optional[pulumi.Input[_builtins.str]] = ..., facebook_app_secret_setting_name: Optional[pulumi.Input[_builtins.str]] = ..., facebook_o_auth_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., git_hub_client_id: Optional[pulumi.Input[_builtins.str]] = ..., git_hub_client_secret: Optional[pulumi.Input[_builtins.str]] = ..., git_hub_client_secret_setting_name: Optional[pulumi.Input[_builtins.str]] = ..., git_hub_o_auth_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., google_client_id: Optional[pulumi.Input[_builtins.str]] = ..., google_client_secret: Optional[pulumi.Input[_builtins.str]] = ..., google_client_secret_setting_name: Optional[pulumi.Input[_builtins.str]] = ..., google_o_auth_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., is_auth_from_file: Optional[pulumi.Input[_builtins.str]] = ..., issuer: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., microsoft_account_client_id: Optional[pulumi.Input[_builtins.str]] = ..., microsoft_account_client_secret: Optional[pulumi.Input[_builtins.str]] = ..., microsoft_account_client_secret_setting_name: Optional[pulumi.Input[_builtins.str]] = ..., microsoft_account_o_auth_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., runtime_version: Optional[pulumi.Input[_builtins.str]] = ..., token_refresh_extension_hours: Optional[pulumi.Input[_builtins.float]] = ..., token_store_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., twitter_consumer_key: Optional[pulumi.Input[_builtins.str]] = ..., twitter_consumer_secret: Optional[pulumi.Input[_builtins.str]] = ..., twitter_consumer_secret_setting_name: Optional[pulumi.Input[_builtins.str]] = ..., unauthenticated_client_action: Optional[pulumi.Input[UnauthenticatedClientAction]] = ..., validate_issuer: Optional[pulumi.Input[_builtins.bool]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: WebAppAuthSettingsArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppAuthSettings:
