...
class AwaitableGetWebAppRelayServiceConnectionResult(
    GetWebAppRelayServiceConnectionResult
):
    def __await__(self): ...

def get_web_app_relay_service_connection(
    entity_name: Optional[_builtins.str] = ...,
    name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetWebAppRelayServiceConnectionResult: ...
def get_web_app_relay_service_connection_output(
    entity_name: Optional[pulumi.Input[_builtins.str]] = ...,
    name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetWebAppRelayServiceConnectionResult]: ...
