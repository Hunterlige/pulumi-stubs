...
class AwaitableGetStaticSiteUserProvidedFunctionAppForStaticSiteResult(GetStaticSiteUserProvidedFunctionAppForStaticSiteResult):
    def __await__(self): # -> Generator[Never, Any, GetStaticSiteUserProvidedFunctionAppForStaticSiteResult]:
        ...
    


def get_static_site_user_provided_function_app_for_static_site(function_app_name: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetStaticSiteUserProvidedFunctionAppForStaticSiteResult:
    
    ...

def get_static_site_user_provided_function_app_for_static_site_output(function_app_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetStaticSiteUserProvidedFunctionAppForStaticSiteResult]:
