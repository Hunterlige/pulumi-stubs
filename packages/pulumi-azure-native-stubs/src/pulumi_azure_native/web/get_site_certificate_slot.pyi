...
__all__ = [
    ...
    "AwaitableGetSiteCertificateSlotResult",
    "get_site_certificate_slot",
    "get_site_certificate_slot_output",
]
...
def get_site_certificate_slot_output(
...
) -> pulumi.Output[GetSiteCertificateSlotResult]: ...
