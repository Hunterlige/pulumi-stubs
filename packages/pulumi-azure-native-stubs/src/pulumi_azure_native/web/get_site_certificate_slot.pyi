...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetSiteCertificateSlotResult', 'AwaitableGetSiteCertificateSlotResult', 'get_site_certificate_slot', 'get_site_certificate_slot_output']
@pulumi.output_type
...
class AwaitableGetSiteCertificateSlotResult(GetSiteCertificateSlotResult):
    def __await__(self): # -> Generator[Never, Any, GetSiteCertificateSlotResult]:
        ...
    


def get_site_certificate_slot(certificate_name: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., slot: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetSiteCertificateSlotResult:
    
    ...

def get_site_certificate_slot_output(certificate_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., slot: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetSiteCertificateSlotResult]:
