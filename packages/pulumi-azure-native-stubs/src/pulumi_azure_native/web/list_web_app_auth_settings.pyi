...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ListWebAppAuthSettingsResult', 'AwaitableListWebAppAuthSettingsResult', 'list_web_app_auth_settings', 'list_web_app_auth_settings_output']
@pulumi.output_type
...
class AwaitableListWebAppAuthSettingsResult(ListWebAppAuthSettingsResult):
    def __await__(self): # -> Generator[Never, Any, ListWebAppAuthSettingsResult]:
        ...
    


def list_web_app_auth_settings(name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableListWebAppAuthSettingsResult:
    
    ...

def list_web_app_auth_settings_output(name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[ListWebAppAuthSettingsResult]:
