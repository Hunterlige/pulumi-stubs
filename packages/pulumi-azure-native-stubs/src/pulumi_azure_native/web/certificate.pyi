...
class CertificateArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], canonical_name: Optional[pulumi.Input[_builtins.str]] = ..., domain_validation_method: Optional[pulumi.Input[_builtins.str]] = ..., host_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., key_vault_id: Optional[pulumi.Input[_builtins.str]] = ..., key_vault_secret_name: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., password: Optional[pulumi.Input[_builtins.str]] = ..., pfx_blob: Optional[pulumi.Input[_builtins.str]] = ..., server_farm_id: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
@pulumi.type_token("azure-native:web:Certificate")
class Certificate(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., canonical_name: Optional[pulumi.Input[_builtins.str]] = ..., domain_validation_method: Optional[pulumi.Input[_builtins.str]] = ..., host_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., key_vault_id: Optional[pulumi.Input[_builtins.str]] = ..., key_vault_secret_name: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., password: Optional[pulumi.Input[_builtins.str]] = ..., pfx_blob: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., server_farm_id: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
