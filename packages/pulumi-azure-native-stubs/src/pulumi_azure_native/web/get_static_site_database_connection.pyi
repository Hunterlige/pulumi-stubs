...
class AwaitableGetStaticSiteDatabaseConnectionResult(
    GetStaticSiteDatabaseConnectionResult
):
    def __await__(self): ...

def get_static_site_database_connection(
    database_connection_name: Optional[_builtins.str] = ...,
    name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetStaticSiteDatabaseConnectionResult: ...
def get_static_site_database_connection_output(
    database_connection_name: Optional[pulumi.Input[_builtins.str]] = ...,
    name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetStaticSiteDatabaseConnectionResult]: ...
