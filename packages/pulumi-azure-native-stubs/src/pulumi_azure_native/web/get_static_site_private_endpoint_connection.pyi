...
class AwaitableGetStaticSitePrivateEndpointConnectionResult(
    GetStaticSitePrivateEndpointConnectionResult
):
    def __await__(self): ...

def get_static_site_private_endpoint_connection(
...
def get_static_site_private_endpoint_connection_output(
    name: Optional[pulumi.Input[_builtins.str]] = ...,
    private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetStaticSitePrivateEndpointConnectionResult]: ...
