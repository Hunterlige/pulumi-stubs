...
class WebAppHybridConnectionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], namespace_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], hostname: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., relay_arm_uri: Optional[pulumi.Input[_builtins.str]] = ..., relay_name: Optional[pulumi.Input[_builtins.str]] = ..., send_key_name: Optional[pulumi.Input[_builtins.str]] = ..., send_key_value: Optional[pulumi.Input[_builtins.str]] = ..., service_bus_namespace: Optional[pulumi.Input[_builtins.str]] = ..., service_bus_suffix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WebAppHybridConnection(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppHybridConnection:
