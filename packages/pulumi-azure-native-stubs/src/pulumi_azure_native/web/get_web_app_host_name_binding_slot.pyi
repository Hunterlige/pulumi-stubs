...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetWebAppHostNameBindingSlotResult', 'AwaitableGetWebAppHostNameBindingSlotResult', 'get_web_app_host_name_binding_slot', 'get_web_app_host_name_binding_slot_output']
@pulumi.output_type
...
class AwaitableGetWebAppHostNameBindingSlotResult(GetWebAppHostNameBindingSlotResult):
    def __await__(self): # -> Generator[Never, Any, GetWebAppHostNameBindingSlotResult]:
        ...
    


def get_web_app_host_name_binding_slot(host_name: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., slot: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetWebAppHostNameBindingSlotResult:
    
    ...

def get_web_app_host_name_binding_slot_output(host_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., slot: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetWebAppHostNameBindingSlotResult]:
