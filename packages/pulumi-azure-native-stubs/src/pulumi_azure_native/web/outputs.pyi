...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AllowedAudiencesValidationResponse', 'AllowedPrincipalsResponse', 'ApiConnectionDefinitionResponseProperties', 'ApiConnectionTestLinkResponse', 'ApiOAuthSettingsParameterResponse', 'ApiOAuthSettingsResponse', 'ApiReferenceResponse', 'ApiResourceBackendServiceResponse', 'ApiResourceDefinitionsResponse', 'AppLogsConfigurationResponse', 'AppRegistrationResponse', 'AppleRegistrationResponse', 'AppleResponse', 'ApplicationLogsConfigResponse', 'ArcConfigurationResponse', 'ArmIdWrapperResponse', 'ArmPlanResponse', 'AseV3NetworkingConfigurationResponse', 'AuthPlatformResponse', 'AzureActiveDirectoryLoginResponse', 'AzureActiveDirectoryRegistrationResponse', 'AzureActiveDirectoryResponse', 'AzureActiveDirectoryValidationResponse', 'AzureBlobStorageApplicationLogsConfigResponse', 'AzureBlobStorageHttpLogsConfigResponse', 'AzureResourceErrorInfoResponse', 'AzureStaticWebAppsRegistrationResponse', 'AzureStaticWebAppsResponse', 'AzureStorageInfoValueResponse', 'AzureTableStorageApplicationLogsConfigResponse', 'BackupItemResponse', 'BackupScheduleResponse', 'BlobStorageTokenStoreResponse', 'CapabilityResponse', 'ClientRegistrationResponse', 'ConnStringValueTypePairResponse', 'ConnectionErrorResponse', 'ConnectionGatewayDefinitionResponseProperties', 'ConnectionGatewayReferenceResponse', 'ConnectionParameterResponse', 'ConnectionStatusDefinitionResponse', 'ConsentLinkDefinitionResponse', 'ContainerAppsConfigurationResponse', 'CookieExpirationResponse', 'CustomApiPropertiesDefinitionResponse', 'CustomDnsSuffixConfigurationResponse', 'CustomOpenIdConnectProviderResponse', 'DaprConfigResponse', 'DatabaseBackupSettingResponse', 'DatabaseConnectionOverviewResponse', 'DefaultAuthorizationPolicyResponse', 'EnabledConfigResponse', 'EnvironmentVariableResponse', 'ErrorEntityResponse', 'ExpressionResponse', 'ExpressionRootResponse', 'ExtendedLocationResponse', 'FacebookResponse', 'FileSystemApplicationLogsConfigResponse', 'FileSystemHttpLogsConfigResponse', 'FileSystemTokenStoreResponse', 'ForwardProxyResponse', 'FrontEndConfigurationResponse', 'FunctionAppConfigResponse', 'FunctionsAlwaysReadyConfigResponse', 'FunctionsDeploymentResponse', 'FunctionsDeploymentResponseAuthentication', 'FunctionsDeploymentResponseStorage', 'FunctionsRuntimeResponse', 'FunctionsScaleAndConcurrencyResponse', 'FunctionsScaleAndConcurrencyResponseHttp', 'FunctionsScaleAndConcurrencyResponseTriggers', 'GitHubActionCodeConfigurationResponse', 'GitHubActionConfigurationResponse', 'GitHubActionContainerConfigurationResponse', 'GitHubResponse', 'GlobalValidationResponse', 'GoogleResponse', 'HostNameSslStateResponse', 'HostingEnvironmentProfileResponse', 'HttpLogsConfigResponse', 'HttpSettingsResponse', 'HttpSettingsRoutesResponse', 'IdentifierResponse', 'IdentityProvidersResponse', 'JwtClaimChecksResponse', 'KubeEnvironmentProfileResponse', 'LegacyMicrosoftAccountResponse', 'LogAnalyticsConfigurationResponse', 'LoginResponse', 'LoginRoutesResponse', 'LoginScopesResponse', 'ManagedServiceIdentityResponse', 'NameValuePairResponse', 'NonceResponse', 'OpenIdConnectClientCredentialResponse', 'OpenIdConnectConfigResponse', 'OpenIdConnectLoginResponse', 'OpenIdConnectRegistrationResponse', 'OutboundVnetRoutingResponse', 'PrivateLinkConnectionStateResponse', 'RemotePrivateEndpointConnectionResponse', 'ResourceConfigResponse', ..., 'ServerFarmInstanceResponse', 'SiteDnsConfigResponse', 'SkuCapacityResponse', 'SkuDescriptionResponse', 'SlotSwapStatusResponse', 'StaticSiteBuildPropertiesResponse', ..., 'StaticSiteLinkedBackendResponse', 'StaticSiteTemplateOptionsResponse', 'StaticSiteUserARMResourceResponse', 'StaticSiteUserProvidedFunctionAppResponse', 'TokenStoreResponse', 'TwitterRegistrationResponse', 'TwitterResponse', 'UserAssignedIdentityResponse', 'VirtualNetworkProfileResponse', 'VnetRouteResponse', 'VolumeMountResponse', 'WorkflowEnvelopeResponseProperties', 'WorkflowHealthResponse', 'WorkflowTriggerListCallbackUrlQueriesResponse', 'WsdlDefinitionResponse', 'WsdlServiceResponse']
@pulumi.output_type
...
class ApiConnectionDefinitionResponseProperties(dict):
    ...
    def __init__(__self__, *, api: Optional[outputs.ApiReferenceResponse] = ..., changed_time: Optional[_builtins.str] = ..., created_time: Optional[_builtins.str] = ..., custom_parameter_values: Optional[Mapping[str, _builtins.str]] = ..., display_name: Optional[_builtins.str] = ..., non_secret_parameter_values: Optional[Mapping[str, _builtins.str]] = ..., parameter_values: Optional[Mapping[str, _builtins.str]] = ..., statuses: Optional[Sequence[outputs.ConnectionStatusDefinitionResponse]] = ..., test_links: Optional[Sequence[outputs.ApiConnectionTestLinkResponse]] = ...) -> None:
...
class ApiConnectionTestLinkResponse(dict):
    ...
    def __init__(__self__, *, method: Optional[_builtins.str] = ..., request_uri: Optional[_builtins.str] = ...) -> None:
...
class ApiOAuthSettingsParameterResponse(dict):
    ...
    def __init__(__self__, *, options: Optional[Any] = ..., ui_definition: Optional[Any] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class ApiOAuthSettingsResponse(dict):
    ...
    def __init__(__self__, *, client_id: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., custom_parameters: Optional[Mapping[str, outputs.ApiOAuthSettingsParameterResponse]] = ..., identity_provider: Optional[_builtins.str] = ..., properties: Optional[Any] = ..., redirect_url: Optional[_builtins.str] = ..., scopes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ApiReferenceResponse(dict):
    ...
    def __init__(__self__, *, brand_color: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., icon_uri: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., swagger: Optional[Any] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ApplicationLogsConfigResponse(dict):
    ...
    def __init__(__self__, *, azure_blob_storage: Optional[outputs.AzureBlobStorageApplicationLogsConfigResponse] = ..., azure_table_storage: Optional[outputs.AzureTableStorageApplicationLogsConfigResponse] = ..., file_system: Optional[outputs.FileSystemApplicationLogsConfigResponse] = ...) -> None:
...
class ArcConfigurationResponse(dict):
    ...
    def __init__(__self__, *, artifact_storage_access_mode: Optional[_builtins.str] = ..., artifact_storage_class_name: Optional[_builtins.str] = ..., artifact_storage_mount_path: Optional[_builtins.str] = ..., artifact_storage_node_name: Optional[_builtins.str] = ..., artifacts_storage_type: Optional[_builtins.str] = ..., front_end_service_configuration: Optional[outputs.FrontEndConfigurationResponse] = ...) -> None:
        ...
...
class ArmPlanResponse(dict):
    ...
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., product: Optional[_builtins.str] = ..., promotion_code: Optional[_builtins.str] = ..., publisher: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class AseV3NetworkingConfigurationResponse(dict):
    ...
    def __init__(__self__, *, external_inbound_ip_addresses: Sequence[_builtins.str], id: _builtins.str, internal_inbound_ip_addresses: Sequence[_builtins.str], linux_outbound_ip_addresses: Sequence[_builtins.str], name: _builtins.str, type: _builtins.str, windows_outbound_ip_addresses: Sequence[_builtins.str], allow_new_private_endpoint_connections: Optional[_builtins.bool] = ..., ftp_enabled: Optional[_builtins.bool] = ..., inbound_ip_address_override: Optional[_builtins.str] = ..., kind: Optional[_builtins.str] = ..., remote_debug_enabled: Optional[_builtins.bool] = ...) -> None:
...
class AuthPlatformResponse(dict):
    ...
    def __init__(__self__, *, config_file_path: Optional[_builtins.str] = ..., enabled: Optional[_builtins.bool] = ..., runtime_version: Optional[_builtins.str] = ...) -> None:
...
class AzureBlobStorageApplicationLogsConfigResponse(dict):
    ...
    def __init__(__self__, *, level: Optional[_builtins.str] = ..., retention_in_days: Optional[_builtins.int] = ..., sas_url: Optional[_builtins.str] = ...) -> None:
...
class AzureBlobStorageHttpLogsConfigResponse(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., retention_in_days: Optional[_builtins.int] = ..., sas_url: Optional[_builtins.str] = ...) -> None:
...
class AzureStorageInfoValueResponse(dict):
    ...
    def __init__(__self__, *, state: _builtins.str, access_key: Optional[_builtins.str] = ..., account_name: Optional[_builtins.str] = ..., mount_path: Optional[_builtins.str] = ..., protocol: Optional[_builtins.str] = ..., share_name: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class AzureTableStorageApplicationLogsConfigResponse(dict):
    ...
    def __init__(__self__, *, sas_url: _builtins.str, level: Optional[_builtins.str] = ...) -> None:
...
class BackupItemResponse(dict):
    ...
    def __init__(__self__, *, backup_id: _builtins.int, blob_name: _builtins.str, correlation_id: _builtins.str, created: _builtins.str, databases: Sequence[outputs.DatabaseBackupSettingResponse], finished_time_stamp: _builtins.str, id: _builtins.str, last_restore_time_stamp: _builtins.str, log: _builtins.str, name: _builtins.str, scheduled: _builtins.bool, size_in_bytes: _builtins.float, status: _builtins.str, storage_account_url: _builtins.str, type: _builtins.str, website_size_in_bytes: _builtins.float, kind: Optional[_builtins.str] = ...) -> None:
...
class BackupScheduleResponse(dict):
    ...
    def __init__(__self__, *, frequency_interval: Optional[_builtins.int] = ..., frequency_unit: Optional[_builtins.str] = ..., keep_at_least_one_backup: Optional[_builtins.bool] = ..., last_execution_time: _builtins.str, retention_period_in_days: Optional[_builtins.int] = ..., start_time: Optional[_builtins.str] = ...) -> None:
...
class BlobStorageTokenStoreResponse(dict):
    ...
    def __init__(__self__, *, sas_url_setting_name: Optional[_builtins.str] = ...) -> None:
...
class CapabilityResponse(dict):
    ...
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., reason: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class ConnectionErrorResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, type: _builtins.str, code: Optional[_builtins.str] = ..., etag: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ConnectionGatewayDefinitionResponseProperties(dict):
    ...
    def __init__(__self__, *, backend_uri: Optional[_builtins.str] = ..., connection_gateway_installation: Optional[outputs.ConnectionGatewayReferenceResponse] = ..., contact_information: Optional[Sequence[_builtins.str]] = ..., description: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., machine_name: Optional[_builtins.str] = ..., status: Optional[Any] = ...) -> None:
...
class ConnectionGatewayReferenceResponse(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ConnectionParameterResponse(dict):
    ...
    def __init__(__self__, *, o_auth_settings: Optional[outputs.ApiOAuthSettingsResponse] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ConnectionStatusDefinitionResponse(dict):
    ...
    def __init__(__self__, *, error: Optional[outputs.ConnectionErrorResponse] = ..., status: Optional[_builtins.str] = ..., target: Optional[_builtins.str] = ...) -> None:
...
class ConsentLinkDefinitionResponse(dict):
    ...
    def __init__(__self__, *, display_name: Optional[_builtins.str] = ..., first_party_login_uri: Optional[_builtins.str] = ..., link: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class ContainerAppsConfigurationResponse(dict):
    ...
    def __init__(__self__, *, app_subnet_resource_id: Optional[_builtins.str] = ..., control_plane_subnet_resource_id: Optional[_builtins.str] = ..., dapr_ai_instrumentation_key: Optional[_builtins.str] = ..., docker_bridge_cidr: Optional[_builtins.str] = ..., platform_reserved_cidr: Optional[_builtins.str] = ..., platform_reserved_dns_ip: Optional[_builtins.str] = ...) -> None:
...
class CustomApiPropertiesDefinitionResponse(dict):
    ...
    def __init__(__self__, *, api_definitions: Optional[outputs.ApiResourceDefinitionsResponse] = ..., api_type: Optional[_builtins.str] = ..., backend_service: Optional[outputs.ApiResourceBackendServiceResponse] = ..., brand_color: Optional[_builtins.str] = ..., capabilities: Optional[Sequence[_builtins.str]] = ..., connection_parameters: Optional[Mapping[str, outputs.ConnectionParameterResponse]] = ..., description: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., icon_uri: Optional[_builtins.str] = ..., runtime_urls: Optional[Sequence[_builtins.str]] = ..., swagger: Optional[Any] = ..., wsdl_definition: Optional[outputs.WsdlDefinitionResponse] = ...) -> None:
...
class CustomDnsSuffixConfigurationResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, provisioning_details: _builtins.str, provisioning_state: _builtins.str, type: _builtins.str, certificate_url: Optional[_builtins.str] = ..., dns_suffix: Optional[_builtins.str] = ..., key_vault_reference_identity: Optional[_builtins.str] = ..., kind: Optional[_builtins.str] = ...) -> None:
...
class DaprConfigResponse(dict):
    ...
    def __init__(__self__, *, app_id: Optional[_builtins.str] = ..., app_port: Optional[_builtins.int] = ..., enable_api_logging: Optional[_builtins.bool] = ..., enabled: Optional[_builtins.bool] = ..., http_max_request_size: Optional[_builtins.int] = ..., http_read_buffer_size: Optional[_builtins.int] = ..., log_level: Optional[_builtins.str] = ...) -> None:
...
class DatabaseBackupSettingResponse(dict):
    ...
    def __init__(__self__, *, database_type: _builtins.str, connection_string: Optional[_builtins.str] = ..., connection_string_name: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class DatabaseConnectionOverviewResponse(dict):
    ...
    def __init__(__self__, *, configuration_files: Sequence[outputs.StaticSiteDatabaseConnectionConfigurationFileOverviewResponse], connection_identity: _builtins.str, name: _builtins.str, region: _builtins.str, resource_id: _builtins.str) -> None:
...
class FileSystemHttpLogsConfigResponse(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., retention_in_days: Optional[_builtins.int] = ..., retention_in_mb: Optional[_builtins.int] = ...) -> None:
...
class FunctionAppConfigResponse(dict):
    ...
    def __init__(__self__, *, deployment: Optional[outputs.FunctionsDeploymentResponse] = ..., runtime: Optional[outputs.FunctionsRuntimeResponse] = ..., scale_and_concurrency: Optional[outputs.FunctionsScaleAndConcurrencyResponse] = ...) -> None:
...
class FunctionsAlwaysReadyConfigResponse(dict):
    ...
    def __init__(__self__, *, instance_count: Optional[_builtins.int] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class FunctionsDeploymentResponse(dict):
    ...
    def __init__(__self__, *, storage: Optional[outputs.FunctionsDeploymentResponseStorage] = ...) -> None:
...
class FunctionsDeploymentResponseAuthentication(dict):
    ...
    def __init__(__self__, *, storage_account_connection_string_name: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ..., user_assigned_identity_resource_id: Optional[_builtins.str] = ...) -> None:
...
class FunctionsDeploymentResponseStorage(dict):
    ...
    def __init__(__self__, *, authentication: Optional[outputs.FunctionsDeploymentResponseAuthentication] = ..., type: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class FunctionsScaleAndConcurrencyResponse(dict):
    ...
    def __init__(__self__, *, always_ready: Optional[Sequence[outputs.FunctionsAlwaysReadyConfigResponse]] = ..., instance_memory_mb: Optional[_builtins.int] = ..., maximum_instance_count: Optional[_builtins.int] = ..., triggers: Optional[outputs.FunctionsScaleAndConcurrencyResponseTriggers] = ...) -> None:
...
class FunctionsScaleAndConcurrencyResponseHttp(dict):
    ...
    def __init__(__self__, *, per_instance_concurrency: Optional[_builtins.int] = ...) -> None:
...
class FunctionsScaleAndConcurrencyResponseTriggers(dict):
    ...
    def __init__(__self__, *, http: Optional[outputs.FunctionsScaleAndConcurrencyResponseHttp] = ...) -> None:
...
class GitHubActionCodeConfigurationResponse(dict):
    ...
    def __init__(__self__, *, runtime_stack: Optional[_builtins.str] = ..., runtime_version: Optional[_builtins.str] = ...) -> None:
...
class GitHubActionConfigurationResponse(dict):
    ...
    def __init__(__self__, *, code_configuration: Optional[outputs.GitHubActionCodeConfigurationResponse] = ..., container_configuration: Optional[outputs.GitHubActionContainerConfigurationResponse] = ..., generate_workflow_file: Optional[_builtins.bool] = ..., is_linux: Optional[_builtins.bool] = ...) -> None:
...
class GitHubActionContainerConfigurationResponse(dict):
    ...
    def __init__(__self__, *, image_name: Optional[_builtins.str] = ..., password: Optional[_builtins.str] = ..., server_url: Optional[_builtins.str] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class GlobalValidationResponse(dict):
    ...
    def __init__(__self__, *, excluded_paths: Optional[Sequence[_builtins.str]] = ..., redirect_to_provider: Optional[_builtins.str] = ..., require_authentication: Optional[_builtins.bool] = ..., unauthenticated_client_action: Optional[_builtins.str] = ...) -> None:
...
class HostNameSslStateResponse(dict):
    ...
    def __init__(__self__, *, host_type: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., ssl_state: Optional[_builtins.str] = ..., thumbprint: Optional[_builtins.str] = ..., to_update: Optional[_builtins.bool] = ..., virtual_ip: Optional[_builtins.str] = ...) -> None:
...
class HttpLogsConfigResponse(dict):
    ...
    def __init__(__self__, *, azure_blob_storage: Optional[outputs.AzureBlobStorageHttpLogsConfigResponse] = ..., file_system: Optional[outputs.FileSystemHttpLogsConfigResponse] = ...) -> None:
...
class IdentifierResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, type: _builtins.str, kind: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class OutboundVnetRoutingResponse(dict):
    ...
    def __init__(__self__, *, all_traffic: Optional[_builtins.bool] = ..., application_traffic: Optional[_builtins.bool] = ..., backup_restore_traffic: Optional[_builtins.bool] = ..., content_share_traffic: Optional[_builtins.bool] = ..., image_pull_traffic: Optional[_builtins.bool] = ...) -> None:
...
class RemotePrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, provisioning_state: _builtins.str, type: _builtins.str, ip_addresses: Optional[Sequence[_builtins.str]] = ..., kind: Optional[_builtins.str] = ..., private_endpoint: Optional[outputs.ArmIdWrapperResponse] = ..., private_link_service_connection_state: Optional[outputs.PrivateLinkConnectionStateResponse] = ...) -> None:
...
class ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *, error: Optional[outputs.ErrorEntityResponse] = ..., id: Optional[_builtins.str] = ..., identity: Optional[outputs.ManagedServiceIdentityResponse] = ..., location: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., plan: Optional[outputs.ArmPlanResponse] = ..., properties: Optional[outputs.RemotePrivateEndpointConnectionResponse] = ..., sku: Optional[outputs.SkuDescriptionResponse] = ..., status: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., type: Optional[_builtins.str] = ..., zones: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServerFarmInstanceResponse(dict):
    ...
    def __init__(__self__, *, instance_name: Optional[_builtins.str] = ..., ip_address: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class SiteDnsConfigResponse(dict):
    ...
    def __init__(__self__, *, dns_legacy_sort_order: _builtins.bool, dns_alt_server: Optional[_builtins.str] = ..., dns_max_cache_timeout: Optional[_builtins.int] = ..., dns_retry_attempt_count: Optional[_builtins.int] = ..., dns_retry_attempt_timeout: Optional[_builtins.int] = ..., dns_servers: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SkuCapacityResponse(dict):
    ...
    def __init__(__self__, *, default: Optional[_builtins.int] = ..., elastic_maximum: Optional[_builtins.int] = ..., maximum: Optional[_builtins.int] = ..., minimum: Optional[_builtins.int] = ..., scale_type: Optional[_builtins.str] = ...) -> None:
...
class SkuDescriptionResponse(dict):
    ...
    def __init__(__self__, *, capabilities: Optional[Sequence[outputs.CapabilityResponse]] = ..., capacity: Optional[_builtins.int] = ..., family: Optional[_builtins.str] = ..., locations: Optional[Sequence[_builtins.str]] = ..., name: Optional[_builtins.str] = ..., size: Optional[_builtins.str] = ..., sku_capacity: Optional[outputs.SkuCapacityResponse] = ..., tier: Optional[_builtins.str] = ...) -> None:
...
class SlotSwapStatusResponse(dict):
    ...
    def __init__(__self__, *, destination_slot_name: _builtins.str, source_slot_name: _builtins.str, timestamp_utc: _builtins.str) -> None:
...
class StaticSiteBuildPropertiesResponse(dict):
    ...
    def __init__(__self__, *, api_build_command: Optional[_builtins.str] = ..., api_location: Optional[_builtins.str] = ..., app_artifact_location: Optional[_builtins.str] = ..., app_build_command: Optional[_builtins.str] = ..., app_location: Optional[_builtins.str] = ..., github_action_secret_name_override: Optional[_builtins.str] = ..., output_location: Optional[_builtins.str] = ..., skip_github_action_workflow_generation: Optional[_builtins.bool] = ...) -> None:
...
class StaticSiteDatabaseConnectionConfigurationFileOverviewResponse(dict):
    ...
    def __init__(__self__, *, contents: _builtins.str, file_name: _builtins.str, type: _builtins.str) -> None:
...
class StaticSiteLinkedBackendResponse(dict):
    ...
    def __init__(__self__, *, created_on: _builtins.str, provisioning_state: _builtins.str, backend_resource_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ...) -> None:
...
class StaticSiteTemplateOptionsResponse(dict):
    ...
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., is_private: Optional[_builtins.bool] = ..., owner: Optional[_builtins.str] = ..., repository_name: Optional[_builtins.str] = ..., template_repository_url: Optional[_builtins.str] = ...) -> None:
...
class StaticSiteUserARMResourceResponse(dict):
    ...
    def __init__(__self__, *, display_name: _builtins.str, id: _builtins.str, name: _builtins.str, provider: _builtins.str, type: _builtins.str, user_id: _builtins.str, kind: Optional[_builtins.str] = ..., roles: Optional[_builtins.str] = ...) -> None:
...
class StaticSiteUserProvidedFunctionAppResponse(dict):
    ...
    def __init__(__self__, *, created_on: _builtins.str, id: _builtins.str, name: _builtins.str, type: _builtins.str, function_app_region: Optional[_builtins.str] = ..., function_app_resource_id: Optional[_builtins.str] = ..., kind: Optional[_builtins.str] = ...) -> None:
...
class TokenStoreResponse(dict):
    ...
    def __init__(__self__, *, azure_blob_storage: Optional[outputs.BlobStorageTokenStoreResponse] = ..., enabled: Optional[_builtins.bool] = ..., file_system: Optional[outputs.FileSystemTokenStoreResponse] = ..., token_refresh_extension_hours: Optional[_builtins.float] = ...) -> None:
...
class VirtualNetworkProfileResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, type: _builtins.str, subnet: Optional[_builtins.str] = ...) -> None:
...
class VnetRouteResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, type: _builtins.str, end_address: Optional[_builtins.str] = ..., kind: Optional[_builtins.str] = ..., route_type: Optional[_builtins.str] = ..., start_address: Optional[_builtins.str] = ...) -> None:
...
class VolumeMountResponse(dict):
    ...
    def __init__(__self__, *, container_mount_path: _builtins.str, volume_sub_path: _builtins.str, data: Optional[_builtins.str] = ..., read_only: Optional[_builtins.bool] = ...) -> None:
...
class WorkflowEnvelopeResponseProperties(dict):
    ...
    def __init__(__self__, *, files: Optional[Mapping[str, Any]] = ..., flow_state: Optional[_builtins.str] = ..., health: Optional[outputs.WorkflowHealthResponse] = ...) -> None:
...
class WsdlDefinitionResponse(dict):
    ...
    def __init__(__self__, *, content: Optional[_builtins.str] = ..., import_method: Optional[_builtins.str] = ..., service: Optional[outputs.WsdlServiceResponse] = ..., url: Optional[_builtins.str] = ...) -> None:
