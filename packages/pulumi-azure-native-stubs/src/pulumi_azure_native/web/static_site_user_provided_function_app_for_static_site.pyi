...
class StaticSiteUserProvidedFunctionAppForStaticSite(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., function_app_name: Optional[pulumi.Input[_builtins.str]] = ..., function_app_region: Optional[pulumi.Input[_builtins.str]] = ..., function_app_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., is_forced: Optional[pulumi.Input[_builtins.bool]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: StaticSiteUserProvidedFunctionAppForStaticSiteArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> StaticSiteUserProvidedFunctionAppForStaticSite:
