...
class AwaitableGetWebAppAuthSettingsV2WithoutSecretsResult(
    GetWebAppAuthSettingsV2WithoutSecretsResult
):
    def __await__(self): ...

def get_web_app_auth_settings_v2_without_secrets(
    name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetWebAppAuthSettingsV2WithoutSecretsResult: ...
def get_web_app_auth_settings_v2_without_secrets_output(
    name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetWebAppAuthSettingsV2WithoutSecretsResult]: ...
