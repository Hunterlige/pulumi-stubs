...
class WebAppConnectionStringsArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], kind: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[ConnStringValueTypePairArgs]]]] = ...) -> None:
...
class WebAppConnectionStrings(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: WebAppConnectionStringsArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppConnectionStrings:
