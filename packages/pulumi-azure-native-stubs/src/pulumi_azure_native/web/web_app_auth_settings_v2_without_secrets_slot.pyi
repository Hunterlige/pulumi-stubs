...
class WebAppAuthSettingsV2WithoutSecretsSlotArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], slot: pulumi.Input[_builtins.str], global_validation: Optional[pulumi.Input[GlobalValidationArgs]] = ..., http_settings: Optional[pulumi.Input[HttpSettingsArgs]] = ..., identity_providers: Optional[pulumi.Input[IdentityProvidersArgs]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., login: Optional[pulumi.Input[LoginArgs]] = ..., platform: Optional[pulumi.Input[AuthPlatformArgs]] = ...) -> None:
...
class WebAppAuthSettingsV2WithoutSecretsSlot(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppAuthSettingsV2WithoutSecretsSlot:
