...
class WebAppHostNameBindingSlot(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., azure_resource_name: Optional[pulumi.Input[_builtins.str]] = ..., azure_resource_type: Optional[pulumi.Input[AzureResourceType]] = ..., custom_host_name_dns_record_type: Optional[pulumi.Input[CustomHostNameDnsRecordType]] = ..., domain_id: Optional[pulumi.Input[_builtins.str]] = ..., host_name: Optional[pulumi.Input[_builtins.str]] = ..., host_name_type: Optional[pulumi.Input[HostNameType]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., site_name: Optional[pulumi.Input[_builtins.str]] = ..., slot: Optional[pulumi.Input[_builtins.str]] = ..., ssl_state: Optional[pulumi.Input[SslState]] = ..., thumbprint: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: WebAppHostNameBindingSlotArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppHostNameBindingSlot:
