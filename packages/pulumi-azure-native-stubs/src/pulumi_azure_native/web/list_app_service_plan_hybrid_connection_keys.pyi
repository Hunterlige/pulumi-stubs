...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ListAppServicePlanHybridConnectionKeysResult', ..., 'list_app_service_plan_hybrid_connection_keys', ...]
@pulumi.output_type
...
class AwaitableListAppServicePlanHybridConnectionKeysResult(ListAppServicePlanHybridConnectionKeysResult):
    def __await__(self): # -> Generator[Never, Any, ListAppServicePlanHybridConnectionKeysResult]:
        ...
    


def list_app_service_plan_hybrid_connection_keys(name: Optional[_builtins.str] = ..., namespace_name: Optional[_builtins.str] = ..., relay_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableListAppServicePlanHybridConnectionKeysResult:
    
    ...

def list_app_service_plan_hybrid_connection_keys_output(name: Optional[pulumi.Input[_builtins.str]] = ..., namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., relay_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[ListAppServicePlanHybridConnectionKeysResult]:
