...
class WebAppSitePushSettingsSlotArgs:
    def __init__(__self__, *, is_push_enabled: pulumi.Input[_builtins.bool], name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], slot: pulumi.Input[_builtins.str], dynamic_tags_json: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., tag_whitelist_json: Optional[pulumi.Input[_builtins.str]] = ..., tags_requiring_auth: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WebAppSitePushSettingsSlot(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., dynamic_tags_json: Optional[pulumi.Input[_builtins.str]] = ..., is_push_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., slot: Optional[pulumi.Input[_builtins.str]] = ..., tag_whitelist_json: Optional[pulumi.Input[_builtins.str]] = ..., tags_requiring_auth: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: WebAppSitePushSettingsSlotArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppSitePushSettingsSlot:
