...
@pulumi.type_token("azure-native:web:WebAppSiteContainerSlot")
class WebAppSiteContainerSlot(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., auth_type: Optional[pulumi.Input[AuthType]] = ..., container_name: Optional[pulumi.Input[_builtins.str]] = ..., environment_variables: Optional[pulumi.Input[Sequence[pulumi.Input[Union[EnvironmentVariableArgs, EnvironmentVariableArgsDict]]]]] = ..., image: Optional[pulumi.Input[_builtins.str]] = ..., inherit_app_settings_and_connection_strings: Optional[pulumi.Input[_builtins.bool]] = ..., is_main: Optional[pulumi.Input[_builtins.bool]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., password_secret: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., slot: Optional[pulumi.Input[_builtins.str]] = ..., start_up_command: Optional[pulumi.Input[_builtins.str]] = ..., target_port: Optional[pulumi.Input[_builtins.str]] = ..., user_managed_identity_client_id: Optional[pulumi.Input[_builtins.str]] = ..., user_name: Optional[pulumi.Input[_builtins.str]] = ..., volume_mounts: Optional[pulumi.Input[Sequence[pulumi.Input[Union[VolumeMountArgs, VolumeMountArgsDict]]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: WebAppSiteContainerSlotArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppSiteContainerSlot:
