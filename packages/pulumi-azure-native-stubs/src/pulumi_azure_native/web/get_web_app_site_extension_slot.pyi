...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetWebAppSiteExtensionSlotResult', 'AwaitableGetWebAppSiteExtensionSlotResult', 'get_web_app_site_extension_slot', 'get_web_app_site_extension_slot_output']
@pulumi.output_type
class GetWebAppSiteExtensionSlotResult:
    
    def __init__(__self__, authors=..., azure_api_version=..., comment=..., description=..., download_count=..., extension_id=..., extension_type=..., extension_url=..., feed_url=..., icon_url=..., id=..., installed_date_time=..., installer_command_line_params=..., kind=..., license_url=..., local_is_latest_version=..., local_path=..., name=..., project_url=..., provisioning_state=..., published_date_time=..., summary=..., title=..., type=..., version=...) -> None:
        ...
...
class AwaitableGetWebAppSiteExtensionSlotResult(GetWebAppSiteExtensionSlotResult):
    def __await__(self): # -> Generator[Never, Any, GetWebAppSiteExtensionSlotResult]:
        ...
    


def get_web_app_site_extension_slot(name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., site_extension_id: Optional[_builtins.str] = ..., slot: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetWebAppSiteExtensionSlotResult:
    
    ...

def get_web_app_site_extension_slot_output(name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., site_extension_id: Optional[pulumi.Input[_builtins.str]] = ..., slot: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetWebAppSiteExtensionSlotResult]:
