...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetWebAppSiteContainerSlotResult', 'AwaitableGetWebAppSiteContainerSlotResult', 'get_web_app_site_container_slot', 'get_web_app_site_container_slot_output']
@pulumi.output_type
...
class AwaitableGetWebAppSiteContainerSlotResult(GetWebAppSiteContainerSlotResult):
    def __await__(self): # -> Generator[Never, Any, GetWebAppSiteContainerSlotResult]:
        ...
    


def get_web_app_site_container_slot(container_name: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., slot: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetWebAppSiteContainerSlotResult:
    
    ...

def get_web_app_site_container_slot_output(container_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., slot: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetWebAppSiteContainerSlotResult]:
