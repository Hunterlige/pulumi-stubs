...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetWebAppSlotResult', 'AwaitableGetWebAppSlotResult', 'get_web_app_slot', 'get_web_app_slot_output']
@pulumi.output_type
...
class AwaitableGetWebAppSlotResult(GetWebAppSlotResult):
    def __await__(self): # -> Generator[Never, Any, GetWebAppSlotResult]:
        ...
    


def get_web_app_slot(name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., slot: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetWebAppSlotResult:
    
    ...

def get_web_app_slot_output(name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., slot: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetWebAppSlotResult]:
