...
class AppServiceEnvironmentPrivateEndpointConnectionArgs:
    def __init__(
        ...
        *,
        ...
        private_link_service_connection_state: Optional[
            pulumi.Input[PrivateLinkConnectionStateArgs]
        ] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
    ...
    def private_link_service_connection_state(
        self,
    ) -> Optional[pulumi.Input[PrivateLinkConnectionStateArgs]]: ...
    @private_link_service_connection_state.setter
    def private_link_service_connection_state(
        self, value: Optional[pulumi.Input[PrivateLinkConnectionStateArgs]]
    ): ...
...
class AppServiceEnvironmentPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(
        ...
        private_link_service_connection_state: Optional[
            pulumi.Input[
                Union[
                    PrivateLinkConnectionStateArgs, PrivateLinkConnectionStateArgsDict
                ]
            ]
        ] = ...,
    ...
    def private_endpoint(
        self,
    ) -> pulumi.Output[Optional[outputs.ArmIdWrapperResponse]]: ...
    @_builtins.property
    @pulumi.getter(name="privateLinkServiceConnectionState")
    def private_link_service_connection_state(
        self,
    ) -> pulumi.Output[Optional[outputs.PrivateLinkConnectionStateResponse]]: ...
    @_builtins.property
