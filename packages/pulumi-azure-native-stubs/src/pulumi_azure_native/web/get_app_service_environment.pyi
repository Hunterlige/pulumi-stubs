...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetAppServiceEnvironmentResult', 'AwaitableGetAppServiceEnvironmentResult', 'get_app_service_environment', 'get_app_service_environment_output']
@pulumi.output_type
class GetAppServiceEnvironmentResult:
    
    def __init__(__self__, azure_api_version=..., cluster_settings=..., custom_dns_suffix_configuration=..., dedicated_host_count=..., dns_suffix=..., front_end_scale_factor=..., has_linux_workers=..., id=..., internal_load_balancing_mode=..., ipssl_address_count=..., kind=..., location=..., maximum_number_of_machines=..., multi_role_count=..., multi_size=..., name=..., networking_configuration=..., provisioning_state=..., status=..., suspended=..., tags=..., type=..., upgrade_availability=..., upgrade_preference=..., user_whitelisted_ip_ranges=..., virtual_network=..., zone_redundant=...) -> None:
        ...
...
class AwaitableGetAppServiceEnvironmentResult(GetAppServiceEnvironmentResult):
    def __await__(self): # -> Generator[Never, Any, GetAppServiceEnvironmentResult]:
        ...
    


def get_app_service_environment(name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAppServiceEnvironmentResult:
    
    ...

def get_app_service_environment_output(name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAppServiceEnvironmentResult]:
