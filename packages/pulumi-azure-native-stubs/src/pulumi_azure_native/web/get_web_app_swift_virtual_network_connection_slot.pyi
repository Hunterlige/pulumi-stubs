...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetWebAppSwiftVirtualNetworkConnectionSlotResult', ..., 'get_web_app_swift_virtual_network_connection_slot', ...]
@pulumi.output_type
...
class AwaitableGetWebAppSwiftVirtualNetworkConnectionSlotResult(GetWebAppSwiftVirtualNetworkConnectionSlotResult):
    def __await__(self): # -> Generator[Never, Any, GetWebAppSwiftVirtualNetworkConnectionSlotResult]:
        ...
    


def get_web_app_swift_virtual_network_connection_slot(name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., slot: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetWebAppSwiftVirtualNetworkConnectionSlotResult:
    
    ...

def get_web_app_swift_virtual_network_connection_slot_output(name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., slot: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetWebAppSwiftVirtualNetworkConnectionSlotResult]:
