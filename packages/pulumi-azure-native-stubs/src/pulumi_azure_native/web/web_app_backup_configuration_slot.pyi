...
class WebAppBackupConfigurationSlotArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], slot: pulumi.Input[_builtins.str], storage_account_url: pulumi.Input[_builtins.str], backup_name: Optional[pulumi.Input[_builtins.str]] = ..., backup_schedule: Optional[pulumi.Input[BackupScheduleArgs]] = ..., databases: Optional[pulumi.Input[Sequence[pulumi.Input[DatabaseBackupSettingArgs]]]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WebAppBackupConfigurationSlot(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., backup_name: Optional[pulumi.Input[_builtins.str]] = ..., backup_schedule: Optional[pulumi.Input[Union[BackupScheduleArgs, BackupScheduleArgsDict]]] = ..., databases: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DatabaseBackupSettingArgs, DatabaseBackupSettingArgsDict]]]]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., slot: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_url: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: WebAppBackupConfigurationSlotArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppBackupConfigurationSlot:
