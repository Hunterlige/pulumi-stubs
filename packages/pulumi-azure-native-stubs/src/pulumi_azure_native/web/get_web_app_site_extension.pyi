...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetWebAppSiteExtensionResult', 'AwaitableGetWebAppSiteExtensionResult', 'get_web_app_site_extension', 'get_web_app_site_extension_output']
@pulumi.output_type
...
class AwaitableGetWebAppSiteExtensionResult(GetWebAppSiteExtensionResult):
    def __await__(self): # -> Generator[Never, Any, GetWebAppSiteExtensionResult]:
        ...
    


def get_web_app_site_extension(name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., site_extension_id: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetWebAppSiteExtensionResult:
    
    ...

def get_web_app_site_extension_output(name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., site_extension_id: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetWebAppSiteExtensionResult]:
