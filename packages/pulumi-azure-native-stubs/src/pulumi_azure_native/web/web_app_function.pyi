...
class WebAppFunctionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], config: Optional[Any] = ..., config_href: Optional[pulumi.Input[_builtins.str]] = ..., files: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., function_app_id: Optional[pulumi.Input[_builtins.str]] = ..., function_name: Optional[pulumi.Input[_builtins.str]] = ..., href: Optional[pulumi.Input[_builtins.str]] = ..., invoke_url_template: Optional[pulumi.Input[_builtins.str]] = ..., is_disabled: Optional[pulumi.Input[_builtins.bool]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., language: Optional[pulumi.Input[_builtins.str]] = ..., script_href: Optional[pulumi.Input[_builtins.str]] = ..., script_root_path_href: Optional[pulumi.Input[_builtins.str]] = ..., secrets_file_href: Optional[pulumi.Input[_builtins.str]] = ..., test_data: Optional[pulumi.Input[_builtins.str]] = ..., test_data_href: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WebAppFunction(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., config: Optional[Any] = ..., config_href: Optional[pulumi.Input[_builtins.str]] = ..., files: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., function_app_id: Optional[pulumi.Input[_builtins.str]] = ..., function_name: Optional[pulumi.Input[_builtins.str]] = ..., href: Optional[pulumi.Input[_builtins.str]] = ..., invoke_url_template: Optional[pulumi.Input[_builtins.str]] = ..., is_disabled: Optional[pulumi.Input[_builtins.bool]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., language: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., script_href: Optional[pulumi.Input[_builtins.str]] = ..., script_root_path_href: Optional[pulumi.Input[_builtins.str]] = ..., secrets_file_href: Optional[pulumi.Input[_builtins.str]] = ..., test_data: Optional[pulumi.Input[_builtins.str]] = ..., test_data_href: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: WebAppFunctionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppFunction:
