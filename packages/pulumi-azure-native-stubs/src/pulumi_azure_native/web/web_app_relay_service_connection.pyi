...
class WebAppRelayServiceConnectionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], biztalk_uri: Optional[pulumi.Input[_builtins.str]] = ..., entity_connection_string: Optional[pulumi.Input[_builtins.str]] = ..., entity_name: Optional[pulumi.Input[_builtins.str]] = ..., hostname: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., resource_connection_string: Optional[pulumi.Input[_builtins.str]] = ..., resource_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WebAppRelayServiceConnection(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: WebAppRelayServiceConnectionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppRelayServiceConnection:
