...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DataPartitionNamesArgs', 'DataPartitionNamesArgsDict', 'EnergyServicePropertiesArgs', 'EnergyServicePropertiesArgsDict']
...
class EnergyServicePropertiesArgs:
    def __init__(__self__, *, auth_app_id: Optional[pulumi.Input[_builtins.str]] = ..., data_partition_names: Optional[pulumi.Input[Sequence[pulumi.Input[DataPartitionNamesArgs]]]] = ...) -> None:
        ...
    ...
    @auth_app_id.setter
    def auth_app_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def data_partition_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataPartitionNamesArgs]]]]): # -> None:
        ...
