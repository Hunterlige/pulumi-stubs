...
class EnergyServiceArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[EnergyServicePropertiesArgs]] = ...,
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[EnergyServicePropertiesArgs]]
    ): ...
    @_builtins.property
...
class EnergyService(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[EnergyServicePropertiesArgs, EnergyServicePropertiesArgsDict]
            ]
        ] = ...,
