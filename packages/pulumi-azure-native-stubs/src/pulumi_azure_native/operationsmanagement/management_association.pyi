...
class ManagementAssociationArgs:
    def __init__(
        ...
        *,
        ...
        management_association_name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[pulumi.Input[ManagementAssociationPropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def management_association_name(
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[ManagementAssociationPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[ManagementAssociationPropertiesArgs]]
    ): ...
...
class ManagementAssociation(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.ManagementAssociationPropertiesResponse]: ...
    @_builtins.property
    @pulumi.getter
