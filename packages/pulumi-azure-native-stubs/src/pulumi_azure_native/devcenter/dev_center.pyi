...
class DevCenterArgs:
    def __init__(
        ...
        *,
        ...
        project_catalog_settings: Optional[
            pulumi.Input[DevCenterProjectCatalogSettingsArgs]
        ] = ...,
    ...
    def dev_center_name(self, value: Optional[pulumi.Input[_builtins.str]]): ...
    @_builtins.property
    ...
    def project_catalog_settings(
        self,
    ) -> Optional[pulumi.Input[DevCenterProjectCatalogSettingsArgs]]: ...
    @project_catalog_settings.setter
    def project_catalog_settings(
        self, value: Optional[pulumi.Input[DevCenterProjectCatalogSettingsArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class DevCenter(pulumi.CustomResource):
    ...
    def project_catalog_settings(
        self,
    ) -> pulumi.Output[Optional[outputs.DevCenterProjectCatalogSettingsResponse]]: ...
    @_builtins.property
