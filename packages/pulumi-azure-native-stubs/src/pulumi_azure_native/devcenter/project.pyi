...
@pulumi.input_type
class ProjectArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], catalog_settings: Optional[pulumi.Input[ProjectCatalogSettingsArgs]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., dev_center_id: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[ManagedServiceIdentityArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., max_dev_boxes_per_user: Optional[pulumi.Input[_builtins.int]] = ..., project_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def catalog_settings(self, value: Optional[pulumi.Input[ProjectCatalogSettingsArgs]]): # -> None:
        ...
    ...
    def dev_center_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_dev_boxes_per_user(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class Project(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., catalog_settings: Optional[pulumi.Input[Union[ProjectCatalogSettingsArgs, ProjectCatalogSettingsArgsDict]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., dev_center_id: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[Union[ManagedServiceIdentityArgs, ManagedServiceIdentityArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., max_dev_boxes_per_user: Optional[pulumi.Input[_builtins.int]] = ..., project_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
