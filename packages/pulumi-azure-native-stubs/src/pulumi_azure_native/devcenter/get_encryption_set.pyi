...
class GetEncryptionSetResult:
    ...
    def devbox_disks_encryption_enable_status(self) -> Optional[_builtins.str]: ...
    @_builtins.property
    @pulumi.getter
...
def get_encryption_set(
    dev_center_name: Optional[_builtins.str] = ...,
    encryption_set_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetEncryptionSetResult: ...
def get_encryption_set_output(
...
) -> pulumi.Output[GetEncryptionSetResult]: ...
