...
class ProjectCatalog(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., ado_git: Optional[pulumi.Input[Union[GitCatalogArgs, GitCatalogArgsDict]]] = ..., catalog_name: Optional[pulumi.Input[_builtins.str]] = ..., git_hub: Optional[pulumi.Input[Union[GitCatalogArgs, GitCatalogArgsDict]]] = ..., project_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sync_type: Optional[pulumi.Input[Union[_builtins.str, CatalogSyncType]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ProjectCatalogArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ProjectCatalog:
