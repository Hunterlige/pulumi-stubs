...
class GetPoolResult:
    ...
    def __init__(__self__, azure_api_version=..., dev_box_count=..., dev_box_definition_name=..., display_name=..., health_status=..., health_status_details=..., id=..., license_type=..., local_administrator=..., location=..., managed_virtual_network_regions=..., name=..., network_connection_name=..., provisioning_state=..., single_sign_on_status=..., stop_on_disconnect=..., system_data=..., tags=..., type=..., virtual_network_type=...) -> None:
        ...
...
def get_pool(pool_name: Optional[_builtins.str] = ..., project_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetPoolResult:
    
    ...

def get_pool_output(pool_name: Optional[pulumi.Input[_builtins.str]] = ..., project_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetPoolResult]:
