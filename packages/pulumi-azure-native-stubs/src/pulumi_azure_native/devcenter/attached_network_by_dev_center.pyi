...
class AttachedNetworkByDevCenterArgs:
    def __init__(__self__, *, dev_center_name: pulumi.Input[_builtins.str], network_connection_id: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], attached_network_connection_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def network_connection_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def attached_network_connection_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AttachedNetworkByDevCenter(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., attached_network_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., dev_center_name: Optional[pulumi.Input[_builtins.str]] = ..., network_connection_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: AttachedNetworkByDevCenterArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> AttachedNetworkByDevCenter:
