...
@pulumi.input_type
class ConsoleArgs:
    def __init__(__self__, *, properties: pulumi.Input[ConsoleCreatePropertiesArgs], console_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[ConsoleCreatePropertiesArgs]): # -> None:
        ...
...
class Console(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., console_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[ConsoleCreatePropertiesArgs, ConsoleCreatePropertiesArgsDict]]] = ..., __props__=...) -> None:
