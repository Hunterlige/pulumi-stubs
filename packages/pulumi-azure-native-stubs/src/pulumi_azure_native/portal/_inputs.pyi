...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConfigurationPropertiesArgs', 'ConfigurationPropertiesArgsDict', 'ConsoleCreatePropertiesArgs', 'ConsoleCreatePropertiesArgsDict', 'DashboardLensArgs', 'DashboardLensArgsDict', 'DashboardPartMetadataArgs', 'DashboardPartMetadataArgsDict', 'DashboardPartsPositionArgs', 'DashboardPartsPositionArgsDict', 'DashboardPartsArgs', 'DashboardPartsArgsDict', 'DashboardPropertiesWithProvisioningStateArgs', 'DashboardPropertiesWithProvisioningStateArgsDict', 'StorageProfileArgs', 'StorageProfileArgsDict', 'TerminalSettingsArgs', 'TerminalSettingsArgsDict', 'UserPropertiesArgs', 'UserPropertiesArgsDict']
...
class ConfigurationPropertiesArgs:
    def __init__(__self__, *, enforce_private_markdown_storage: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def enforce_private_markdown_storage(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ConsoleCreatePropertiesArgs:
    def __init__(__self__, *, os_type: pulumi.Input[Union[_builtins.str, OsType]], provisioning_state: Optional[pulumi.Input[Union[_builtins.str, ProvisioningState]]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @os_type.setter
    def os_type(self, value: pulumi.Input[Union[_builtins.str, OsType]]): # -> None:
        ...
...
class DashboardLensArgs:
    def __init__(__self__, *, order: pulumi.Input[_builtins.int], parts: pulumi.Input[Sequence[pulumi.Input[DashboardPartsArgs]]], metadata: Optional[Any] = ...) -> None:
    ...
    @parts.setter
    def parts(self, value: pulumi.Input[Sequence[pulumi.Input[DashboardPartsArgs]]]): # -> None:
        ...
...
class DashboardPartMetadataArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], inputs: Optional[pulumi.Input[Sequence[Any]]] = ..., settings: Optional[pulumi.Input[Mapping[str, Any]]] = ...) -> None:
    ...
    @inputs.setter
    def inputs(self, value: Optional[pulumi.Input[Sequence[Any]]]): # -> None:
        ...
    ...
    @settings.setter
    def settings(self, value: Optional[pulumi.Input[Mapping[str, Any]]]): # -> None:
        ...
...
class DashboardPartsPositionArgs:
    def __init__(__self__, *, col_span: pulumi.Input[_builtins.int], row_span: pulumi.Input[_builtins.int], x: pulumi.Input[_builtins.int], y: pulumi.Input[_builtins.int], metadata: Optional[Any] = ...) -> None:
    ...
    @col_span.setter
    def col_span(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @row_span.setter
    def row_span(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @x.setter
    def x(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @y.setter
    def y(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class DashboardPartsArgs:
    def __init__(__self__, *, position: pulumi.Input[DashboardPartsPositionArgs], metadata: Optional[pulumi.Input[DashboardPartMetadataArgs]] = ...) -> None:
    ...
    @position.setter
    def position(self, value: pulumi.Input[DashboardPartsPositionArgs]): # -> None:
        ...
    ...
    @metadata.setter
    def metadata(self, value: Optional[pulumi.Input[DashboardPartMetadataArgs]]): # -> None:
        ...
...
class DashboardPropertiesWithProvisioningStateArgs:
    def __init__(__self__, *, lenses: Optional[pulumi.Input[Sequence[pulumi.Input[DashboardLensArgs]]]] = ..., metadata: Optional[Any] = ...) -> None:
    ...
    @lenses.setter
    def lenses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DashboardLensArgs]]]]): # -> None:
        ...
...
class StorageProfileArgs:
    def __init__(__self__, *, disk_size_in_gb: Optional[pulumi.Input[_builtins.int]] = ..., file_share_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disk_size_in_gb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class TerminalSettingsArgs:
    def __init__(__self__, *, font_size: Optional[pulumi.Input[Union[_builtins.str, FontSize]]] = ..., font_style: Optional[pulumi.Input[Union[_builtins.str, FontStyle]]] = ...) -> None:
    ...
    @font_size.setter
    def font_size(self, value: Optional[pulumi.Input[Union[_builtins.str, FontSize]]]): # -> None:
        ...
    ...
    @font_style.setter
    def font_style(self, value: Optional[pulumi.Input[Union[_builtins.str, FontStyle]]]): # -> None:
        ...
...
class UserPropertiesArgs:
    def __init__(__self__, *, preferred_location: pulumi.Input[_builtins.str], preferred_os_type: pulumi.Input[Union[_builtins.str, OsType]], preferred_shell_type: pulumi.Input[Union[_builtins.str, ShellType]], storage_profile: pulumi.Input[StorageProfileArgs], terminal_settings: pulumi.Input[TerminalSettingsArgs]) -> None:
    ...
    def preferred_location(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def preferred_os_type(self, value: pulumi.Input[Union[_builtins.str, OsType]]): # -> None:
        ...
    ...
    def preferred_shell_type(self, value: pulumi.Input[Union[_builtins.str, ShellType]]): # -> None:
        ...
    ...
    def terminal_settings(self, value: pulumi.Input[TerminalSettingsArgs]): # -> None:
        ...
