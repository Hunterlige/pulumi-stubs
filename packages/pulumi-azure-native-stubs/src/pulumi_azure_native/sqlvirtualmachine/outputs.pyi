...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AADAuthenticationSettingsResponse', 'AdditionalFeaturesServerConfigurationsResponse', 'AgConfigurationResponse', 'AgReplicaResponse', 'AssessmentSettingsResponse', 'AutoBackupSettingsResponse', 'AutoPatchingSettingsResponse', 'KeyVaultCredentialSettingsResponse', 'LoadBalancerConfigurationResponse', 'MultiSubnetIpConfigurationResponse', 'PrivateIPAddressResponse', 'ResourceIdentityResponse', 'SQLInstanceSettingsResponse', 'SQLStorageSettingsResponse', 'SQLTempDbSettingsResponse', 'ScheduleResponse', 'ServerConfigurationsManagementSettingsResponse', 'SqlConnectivityUpdateSettingsResponse', 'SqlStorageUpdateSettingsResponse', 'SqlWorkloadTypeUpdateSettingsResponse', 'StorageConfigurationSettingsResponse', 'SystemDataResponse', 'TroubleshootingAdditionalPropertiesResponse', 'TroubleshootingStatusResponse', 'UnhealthyReplicaInfoResponse', 'VirtualMachineIdentityResponse', 'WsfcDomainCredentialsResponse', 'WsfcDomainProfileResponse']
@pulumi.output_type
...
class AdditionalFeaturesServerConfigurationsResponse(dict):
    ...
    def __init__(__self__, *, is_r_services_enabled: Optional[_builtins.bool] = ...) -> None:
...
class AgConfigurationResponse(dict):
    ...
    def __init__(__self__, *, replicas: Optional[Sequence[outputs.AgReplicaResponse]] = ...) -> None:
...
class AgReplicaResponse(dict):
    ...
    def __init__(__self__, *, commit: Optional[_builtins.str] = ..., failover: Optional[_builtins.str] = ..., readable_secondary: Optional[_builtins.str] = ..., role: Optional[_builtins.str] = ..., sql_virtual_machine_instance_id: Optional[_builtins.str] = ...) -> None:
...
class AssessmentSettingsResponse(dict):
    ...
    def __init__(__self__, *, enable: Optional[_builtins.bool] = ..., run_immediately: Optional[_builtins.bool] = ..., schedule: Optional[outputs.ScheduleResponse] = ...) -> None:
...
class AutoBackupSettingsResponse(dict):
    ...
    def __init__(__self__, *, backup_schedule_type: Optional[_builtins.str] = ..., backup_system_dbs: Optional[_builtins.bool] = ..., days_of_week: Optional[Sequence[_builtins.str]] = ..., enable: Optional[_builtins.bool] = ..., enable_encryption: Optional[_builtins.bool] = ..., full_backup_frequency: Optional[_builtins.str] = ..., full_backup_start_time: Optional[_builtins.int] = ..., full_backup_window_hours: Optional[_builtins.int] = ..., log_backup_frequency: Optional[_builtins.int] = ..., retention_period: Optional[_builtins.int] = ..., storage_account_url: Optional[_builtins.str] = ..., storage_container_name: Optional[_builtins.str] = ...) -> None:
...
class AutoPatchingSettingsResponse(dict):
    ...
    def __init__(__self__, *, additional_vm_patch: Optional[_builtins.str] = ..., day_of_week: Optional[_builtins.str] = ..., enable: Optional[_builtins.bool] = ..., maintenance_window_duration: Optional[_builtins.int] = ..., maintenance_window_starting_hour: Optional[_builtins.int] = ...) -> None:
...
class KeyVaultCredentialSettingsResponse(dict):
    ...
    def __init__(__self__, *, azure_key_vault_url: Optional[_builtins.str] = ..., credential_name: Optional[_builtins.str] = ..., enable: Optional[_builtins.bool] = ..., service_principal_name: Optional[_builtins.str] = ...) -> None:
...
class LoadBalancerConfigurationResponse(dict):
    ...
    def __init__(__self__, *, load_balancer_resource_id: Optional[_builtins.str] = ..., private_ip_address: Optional[outputs.PrivateIPAddressResponse] = ..., probe_port: Optional[_builtins.int] = ..., public_ip_address_resource_id: Optional[_builtins.str] = ..., sql_virtual_machine_instances: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class MultiSubnetIpConfigurationResponse(dict):
    ...
    def __init__(__self__, *, private_ip_address: outputs.PrivateIPAddressResponse, sql_virtual_machine_instance: _builtins.str) -> None:
...
class PrivateIPAddressResponse(dict):
    ...
    def __init__(__self__, *, ip_address: Optional[_builtins.str] = ..., subnet_resource_id: Optional[_builtins.str] = ...) -> None:
...
class SQLInstanceSettingsResponse(dict):
    ...
    def __init__(__self__, *, collation: Optional[_builtins.str] = ..., is_ifi_enabled: Optional[_builtins.bool] = ..., is_lpim_enabled: Optional[_builtins.bool] = ..., is_optimize_for_ad_hoc_workloads_enabled: Optional[_builtins.bool] = ..., max_dop: Optional[_builtins.int] = ..., max_server_memory_mb: Optional[_builtins.int] = ..., min_server_memory_mb: Optional[_builtins.int] = ...) -> None:
...
class SQLStorageSettingsResponse(dict):
    ...
    def __init__(__self__, *, default_file_path: Optional[_builtins.str] = ..., luns: Optional[Sequence[_builtins.int]] = ..., use_storage_pool: Optional[_builtins.bool] = ...) -> None:
...
class SQLTempDbSettingsResponse(dict):
    ...
    def __init__(__self__, *, data_file_count: Optional[_builtins.int] = ..., data_file_size: Optional[_builtins.int] = ..., data_growth: Optional[_builtins.int] = ..., default_file_path: Optional[_builtins.str] = ..., log_file_size: Optional[_builtins.int] = ..., log_growth: Optional[_builtins.int] = ..., luns: Optional[Sequence[_builtins.int]] = ..., persist_folder: Optional[_builtins.bool] = ..., persist_folder_path: Optional[_builtins.str] = ..., use_storage_pool: Optional[_builtins.bool] = ...) -> None:
...
class ScheduleResponse(dict):
    ...
    def __init__(__self__, *, day_of_week: Optional[_builtins.str] = ..., enable: Optional[_builtins.bool] = ..., monthly_occurrence: Optional[_builtins.int] = ..., start_time: Optional[_builtins.str] = ..., weekly_interval: Optional[_builtins.int] = ...) -> None:
...
class ServerConfigurationsManagementSettingsResponse(dict):
    ...
    def __init__(__self__, *, additional_features_server_configurations: Optional[outputs.AdditionalFeaturesServerConfigurationsResponse] = ..., azure_ad_authentication_settings: Optional[outputs.AADAuthenticationSettingsResponse] = ..., sql_connectivity_update_settings: Optional[outputs.SqlConnectivityUpdateSettingsResponse] = ..., sql_instance_settings: Optional[outputs.SQLInstanceSettingsResponse] = ..., sql_storage_update_settings: Optional[outputs.SqlStorageUpdateSettingsResponse] = ..., sql_workload_type_update_settings: Optional[outputs.SqlWorkloadTypeUpdateSettingsResponse] = ...) -> None:
...
class SqlConnectivityUpdateSettingsResponse(dict):
    ...
    def __init__(__self__, *, connectivity_type: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ...) -> None:
...
class SqlStorageUpdateSettingsResponse(dict):
    ...
    def __init__(__self__, *, disk_configuration_type: Optional[_builtins.str] = ..., disk_count: Optional[_builtins.int] = ..., starting_device_id: Optional[_builtins.int] = ...) -> None:
...
class SqlWorkloadTypeUpdateSettingsResponse(dict):
    ...
    def __init__(__self__, *, sql_workload_type: Optional[_builtins.str] = ...) -> None:
...
class StorageConfigurationSettingsResponse(dict):
    ...
    def __init__(__self__, *, disk_configuration_type: Optional[_builtins.str] = ..., sql_data_settings: Optional[outputs.SQLStorageSettingsResponse] = ..., sql_log_settings: Optional[outputs.SQLStorageSettingsResponse] = ..., sql_system_db_on_data_disk: Optional[_builtins.bool] = ..., sql_temp_db_settings: Optional[outputs.SQLTempDbSettingsResponse] = ..., storage_workload_type: Optional[_builtins.str] = ...) -> None:
...
class TroubleshootingAdditionalPropertiesResponse(dict):
    ...
    def __init__(__self__, *, unhealthy_replica_info: Optional[outputs.UnhealthyReplicaInfoResponse] = ...) -> None:
...
class TroubleshootingStatusResponse(dict):
    ...
    def __init__(__self__, *, end_time_utc: _builtins.str, last_trigger_time_utc: _builtins.str, properties: outputs.TroubleshootingAdditionalPropertiesResponse, root_cause: _builtins.str, start_time_utc: _builtins.str, troubleshooting_scenario: Optional[_builtins.str] = ...) -> None:
...
class UnhealthyReplicaInfoResponse(dict):
    ...
    def __init__(__self__, *, availability_group_name: Optional[_builtins.str] = ...) -> None:
...
class VirtualMachineIdentityResponse(dict):
    ...
    def __init__(__self__, *, resource_id: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class WsfcDomainCredentialsResponse(dict):
    ...
    def __init__(__self__, *, cluster_bootstrap_account_password: Optional[_builtins.str] = ..., cluster_operator_account_password: Optional[_builtins.str] = ..., sql_service_account_password: Optional[_builtins.str] = ...) -> None:
...
class WsfcDomainProfileResponse(dict):
    ...
    def __init__(__self__, *, cluster_bootstrap_account: Optional[_builtins.str] = ..., cluster_operator_account: Optional[_builtins.str] = ..., cluster_subnet_type: Optional[_builtins.str] = ..., domain_fqdn: Optional[_builtins.str] = ..., file_share_witness_path: Optional[_builtins.str] = ..., is_sql_service_account_gmsa: Optional[_builtins.bool] = ..., ou_path: Optional[_builtins.str] = ..., sql_service_account: Optional[_builtins.str] = ..., storage_account_url: Optional[_builtins.str] = ...) -> None:
