...
class ReplicationPolicyArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[CreatePolicyInputPropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[CreatePolicyInputPropertiesArgs]]
    ): ...
...
class ReplicationPolicy(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    CreatePolicyInputPropertiesArgs, CreatePolicyInputPropertiesArgsDict
                ]
            ]
        ] = ...,
