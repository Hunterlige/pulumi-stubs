...
class ReplicationStorageClassificationMappingArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[StorageMappingInputPropertiesArgs]] = ...,
        storage_classification_mapping_name: Optional[
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[StorageMappingInputPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[StorageMappingInputPropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter(name="storageClassificationMappingName")
    def storage_classification_mapping_name(
        self,
