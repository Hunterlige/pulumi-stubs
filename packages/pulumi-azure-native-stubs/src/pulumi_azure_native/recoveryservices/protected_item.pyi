...
class ProtectedItemArgs:
    def __init__(__self__, *, container_name: pulumi.Input[_builtins.str], fabric_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], vault_name: pulumi.Input[_builtins.str], e_tag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[AzureFileshareProtectedItemArgs, AzureIaaSClassicComputeVMProtectedItemArgs, AzureIaaSComputeVMProtectedItemArgs, AzureIaaSVMProtectedItemArgs, AzureSqlProtectedItemArgs, AzureVmWorkloadProtectedItemArgs, AzureVmWorkloadSAPAseDatabaseProtectedItemArgs, AzureVmWorkloadSAPHanaDBInstanceProtectedItemArgs, AzureVmWorkloadSAPHanaDatabaseProtectedItemArgs, AzureVmWorkloadSQLDatabaseProtectedItemArgs, DPMProtectedItemArgs, GenericProtectedItemArgs, MabFileFolderProtectedItemArgs]]] = ..., protected_item_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def protected_item_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ProtectedItem(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ProtectedItem:
