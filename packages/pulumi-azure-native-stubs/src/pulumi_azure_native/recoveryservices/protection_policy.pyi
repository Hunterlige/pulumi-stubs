        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    ...
                    Union[
                        AzureSqlProtectionPolicyArgs, AzureSqlProtectionPolicyArgsDict
                    ],
                    Union[
                        AzureVmWorkloadProtectionPolicyArgs,
                        AzureVmWorkloadProtectionPolicyArgsDict,
                    ],
                    Union[GenericProtectionPolicyArgs, GenericProtectionPolicyArgsDict],
                    Union[MabProtectionPolicyArgs, MabProtectionPolicyArgsDict],
                ]
            ]
        ] = ...,
