        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    ...
                    Union[AzureSqlContainerArgs, AzureSqlContainerArgsDict],
                    Union[AzureStorageContainerArgs, AzureStorageContainerArgsDict],
                    Union[
                        AzureVMAppContainerProtectionContainerArgs,
                        AzureVMAppContainerProtectionContainerArgsDict,
                    ],
                    Union[AzureWorkloadContainerArgs, AzureWorkloadContainerArgsDict],
                    Union[DpmContainerArgs, DpmContainerArgsDict],
                    Union[GenericContainerArgs, GenericContainerArgsDict],
                    Union[IaaSVMContainerArgs, IaaSVMContainerArgsDict],
                    Union[MabContainerArgs, MabContainerArgsDict],
                ]
            ]
        ] = ...,
