...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetMetadataResult', 'AwaitableGetMetadataResult', 'get_metadata', 'get_metadata_output']
@pulumi.output_type
class GetMetadataResult:
    
    def __init__(__self__, author=..., azure_api_version=..., categories=..., content_id=..., content_schema_version=..., custom_version=..., dependencies=..., etag=..., first_publish_date=..., icon=..., id=..., kind=..., last_publish_date=..., name=..., parent_id=..., preview_images=..., preview_images_dark=..., providers=..., source=..., support=..., system_data=..., threat_analysis_tactics=..., threat_analysis_techniques=..., type=..., version=...) -> None:
        ...
...
class AwaitableGetMetadataResult(GetMetadataResult):
    def __await__(self): # -> Generator[Never, Any, GetMetadataResult]:
        ...
    


def get_metadata(metadata_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., workspace_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetMetadataResult:
    
    ...

def get_metadata_output(metadata_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetMetadataResult]:
