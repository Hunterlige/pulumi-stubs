...
class IncidentRelationArgs:
    def __init__(__self__, *, incident_id: pulumi.Input[_builtins.str], related_resource_id: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], workspace_name: pulumi.Input[_builtins.str], relation_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class IncidentRelation(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., incident_id: Optional[pulumi.Input[_builtins.str]] = ..., related_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., relation_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: IncidentRelationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> IncidentRelation:
