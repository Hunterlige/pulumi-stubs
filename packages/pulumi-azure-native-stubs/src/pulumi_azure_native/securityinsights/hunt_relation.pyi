...
class HuntRelationArgs:
    def __init__(__self__, *, hunt_id: pulumi.Input[_builtins.str], related_resource_id: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], workspace_name: pulumi.Input[_builtins.str], hunt_relation_id: Optional[pulumi.Input[_builtins.str]] = ..., labels: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @hunt_id.setter
    def hunt_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def hunt_relation_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class HuntRelation(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., hunt_id: Optional[pulumi.Input[_builtins.str]] = ..., hunt_relation_id: Optional[pulumi.Input[_builtins.str]] = ..., labels: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., related_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: HuntRelationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> HuntRelation:
