...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetWatchlistResult', 'AwaitableGetWatchlistResult', 'get_watchlist', 'get_watchlist_output']
@pulumi.output_type
class GetWatchlistResult:
    
    def __init__(__self__, azure_api_version=..., content_type=..., created=..., created_by=..., default_duration=..., description=..., display_name=..., etag=..., id=..., is_deleted=..., items_search_key=..., labels=..., name=..., number_of_lines_to_skip=..., provider=..., provisioning_state=..., raw_content=..., source=..., source_type=..., system_data=..., tenant_id=..., type=..., updated=..., updated_by=..., upload_status=..., watchlist_alias=..., watchlist_id=..., watchlist_type=...) -> None:
        ...
...
class AwaitableGetWatchlistResult(GetWatchlistResult):
    def __await__(self): # -> Generator[Never, Any, GetWatchlistResult]:
        ...
    


def get_watchlist(resource_group_name: Optional[_builtins.str] = ..., watchlist_alias: Optional[_builtins.str] = ..., workspace_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetWatchlistResult:
    
    ...

def get_watchlist_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., watchlist_alias: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetWatchlistResult]:
