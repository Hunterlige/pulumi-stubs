...
class GetVirtualNetworkResult:
    ...
    def __init__(__self__, azure_api_version=..., custom_resource_name=..., extended_location=..., id=..., inventory_item_id=..., kind=..., location=..., mo_name=..., mo_ref_id=..., name=..., provisioning_state=..., statuses=..., system_data=..., tags=..., type=..., uuid=..., v_center_id=...) -> None:
        ...
