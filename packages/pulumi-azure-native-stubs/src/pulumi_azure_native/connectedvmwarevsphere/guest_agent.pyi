...
class GuestAgentArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], virtual_machine_name: pulumi.Input[_builtins.str], credentials: Optional[pulumi.Input[GuestCredentialArgs]] = ..., http_proxy_config: Optional[pulumi.Input[HttpProxyConfigurationArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., private_link_scope_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_action: Optional[pulumi.Input[Union[_builtins.str, ProvisioningAction]]] = ...) -> None:
...
class GuestAgent(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., credentials: Optional[pulumi.Input[Union[GuestCredentialArgs, GuestCredentialArgsDict]]] = ..., http_proxy_config: Optional[pulumi.Input[Union[HttpProxyConfigurationArgs, HttpProxyConfigurationArgsDict]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., private_link_scope_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_action: Optional[pulumi.Input[Union[_builtins.str, ProvisioningAction]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., virtual_machine_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: GuestAgentArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> GuestAgent:
