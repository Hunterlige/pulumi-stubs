...
class Datastore(pulumi.CustomResource):
    ...
    def capacity_gb(self) -> pulumi.Output[_builtins.float]:
    ...
    def free_space_gb(self) -> pulumi.Output[_builtins.float]:
