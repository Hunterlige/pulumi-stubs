...
class AssessmentArgs:
    def __init__(__self__, *, assessment_name: Optional[pulumi.Input[_builtins.str]] = ..., locale: Optional[pulumi.Input[_builtins.str]] = ..., type_id: Optional[pulumi.Input[_builtins.str]] = ..., workload_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @type_id.setter
    def type_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Assessment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., assessment_name: Optional[pulumi.Input[_builtins.str]] = ..., locale: Optional[pulumi.Input[_builtins.str]] = ..., type_id: Optional[pulumi.Input[_builtins.str]] = ..., workload_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: Optional[AssessmentArgs] = ..., opts: Optional[pulumi.ResourceOptions] = ...) -> None:
