...
__all__ = ['AccessMode', 'AggregationTypeEnum', 'AlertSeverity', 'AuthenticationKind', 'ComparisonOperationType', 'ConditionOperator', 'CriterionType', 'DependenciesAggregationType', 'DimensionOperator', 'DiscoveryRuleKind', 'DiscoveryRuleRecommendedSignalsBehavior', 'DiscoveryRuleRelationshipDiscoveryBehavior', 'DynamicThresholdDirection', 'DynamicThresholdModel', 'DynamicThresholdOperator', 'DynamicThresholdSensitivity', 'EntityImpact', 'ExporterType', 'ExtendedLocationType', 'ExternalNetworkingMode', 'IdentityType', 'IncidentManagementService', 'JsonMapperElement', 'Kind', 'KnownColumnDefinitionType', 'KnownDataCollectionEndpointResourceKind', 'KnownDataCollectionRuleResourceKind', 'KnownDataFlowStreams', 'KnownExtensionDataSourceStreams', 'KnownLogFileTextSettingsRecordStartTimestampFormat', 'KnownLogFilesDataSourceFormat', 'KnownPerfCounterDataSourceStreams', 'KnownPrometheusForwarderDataSourceStreams', 'KnownPublicNetworkAccessOptions', 'KnownSyslogDataSourceFacilityNames', 'KnownSyslogDataSourceLogLevels', 'KnownSyslogDataSourceStreams', 'KnownWindowsEventLogDataSourceStreams', 'ManagedServiceIdentityType', 'MetricAggregationType', 'MetricStatisticType', 'Odatatype', 'OperationType', 'Operator', 'PipelineType', 'PredictiveAutoscalePolicyScaleMode', 'PrivateEndpointServiceConnectionStatus', 'ProcessorType', 'PublicNetworkAccess', 'ReceiverType', 'RecurrenceFrequency', 'RefreshInterval', 'ScaleDirection', 'ScaleRuleMetricDimensionOperationType', 'ScaleType', 'ScopedResourceKind', 'SignalKind', 'SignalOperator', 'Status', 'StreamEncodingType', 'SyslogProtocol', 'TimeAggregation', 'TimeAggregationType']
