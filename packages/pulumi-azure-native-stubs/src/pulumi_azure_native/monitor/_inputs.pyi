...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessModeSettingsExclusionArgs', 'AccessModeSettingsExclusionArgsDict', 'AccessModeSettingsArgs', 'AccessModeSettingsArgsDict', 'ActionGroupArgs', 'ActionGroupArgsDict', 'ActionListArgs', 'ActionListArgsDict', 'ActionsArgs', 'ActionsArgsDict', 'AlertConfigurationArgs', 'AlertConfigurationArgsDict', 'AlertRuleAllOfConditionArgs', 'AlertRuleAllOfConditionArgsDict', 'AlertRuleAnyOfOrLeafConditionArgs', 'AlertRuleAnyOfOrLeafConditionArgsDict', 'AlertRuleLeafConditionArgs', 'AlertRuleLeafConditionArgsDict', ..., ..., 'ArmRoleReceiverArgs', 'ArmRoleReceiverArgsDict', 'AutomationRunbookReceiverArgs', 'AutomationRunbookReceiverArgsDict', 'AutoscaleNotificationArgs', 'AutoscaleNotificationArgsDict', 'AutoscaleProfileArgs', 'AutoscaleProfileArgsDict', 'AzureAppPushReceiverArgs', 'AzureAppPushReceiverArgsDict', 'AzureFunctionReceiverArgs', 'AzureFunctionReceiverArgsDict', 'AzureMonitorWorkspaceLogsApiConfigArgs', 'AzureMonitorWorkspaceLogsApiConfigArgsDict', 'AzureMonitorWorkspaceLogsExporterArgs', 'AzureMonitorWorkspaceLogsExporterArgsDict', 'AzureMonitorWorkspaceSignalGroupArgs', 'AzureMonitorWorkspaceSignalGroupArgsDict', ..., ..., 'AzureResourceSignalGroupArgs', 'AzureResourceSignalGroupArgsDict', 'BatchProcessorArgs', 'BatchProcessorArgsDict', 'CacheConfigurationArgs', 'CacheConfigurationArgsDict', 'ColumnDefinitionArgs', 'ColumnDefinitionArgsDict', 'ConcurrencyConfigurationArgs', 'ConcurrencyConfigurationArgsDict', 'ConditionFailingPeriodsArgs', 'ConditionFailingPeriodsArgsDict', 'ConditionArgs', 'ConditionArgsDict', 'DataCollectionEndpointNetworkAclsArgs', 'DataCollectionEndpointNetworkAclsArgsDict', 'DataCollectionEndpointResourceIdentityArgs', 'DataCollectionEndpointResourceIdentityArgsDict', 'DataCollectionRuleDataSourcesArgs', 'DataCollectionRuleDataSourcesArgsDict', 'DataCollectionRuleDestinationsArgs', 'DataCollectionRuleDestinationsArgsDict', 'DataCollectionRuleResourceIdentityArgs', 'DataCollectionRuleResourceIdentityArgsDict', 'DataFlowArgs', 'DataFlowArgsDict', 'DataImportSourcesEventHubArgs', 'DataImportSourcesEventHubArgsDict', 'DataSourcesSpecDataImportsArgs', 'DataSourcesSpecDataImportsArgsDict', 'DependenciesSignalGroupArgs', 'DependenciesSignalGroupArgsDict', 'DestinationsSpecAzureMonitorMetricsArgs', 'DestinationsSpecAzureMonitorMetricsArgsDict', 'DimensionArgs', 'DimensionArgsDict', 'DynamicDetectionRuleArgs', 'DynamicDetectionRuleArgsDict', 'DynamicMetricCriteriaArgs', 'DynamicMetricCriteriaArgsDict', 'DynamicThresholdFailingPeriodsArgs', 'DynamicThresholdFailingPeriodsArgsDict', 'EmailNotificationArgs', 'EmailNotificationArgsDict', 'EmailReceiverArgs', 'EmailReceiverArgsDict', 'EntityAlertsArgs', 'EntityAlertsArgsDict', 'EntityCoordinatesArgs', 'EntityCoordinatesArgsDict', 'EntityPropertiesArgs', 'EntityPropertiesArgsDict', 'EvaluationRuleArgs', 'EvaluationRuleArgsDict', 'EventHubDestinationArgs', 'EventHubDestinationArgsDict', 'EventHubDirectDestinationArgs', 'EventHubDirectDestinationArgsDict', 'EventHubReceiverArgs', 'EventHubReceiverArgsDict', 'ExporterArgs', 'ExporterArgsDict', 'ExtensionDataSourceArgs', 'ExtensionDataSourceArgsDict', 'HealthModelPropertiesArgs', 'HealthModelPropertiesArgsDict', 'IconDefinitionArgs', 'IconDefinitionArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'IisLogsDataSourceArgs', 'IisLogsDataSourceArgsDict', 'IncidentReceiverArgs', 'IncidentReceiverArgsDict', 'IncidentServiceConnectionArgs', 'IncidentServiceConnectionArgsDict', 'IssuePropertiesArgs', 'IssuePropertiesArgsDict', 'ItsmReceiverArgs', 'ItsmReceiverArgsDict', 'JsonArrayMapperArgs', 'JsonArrayMapperArgsDict', 'JsonMapperDestinationFieldArgs', 'JsonMapperDestinationFieldArgsDict', 'JsonMapperSourceFieldArgs', 'JsonMapperSourceFieldArgsDict', 'LogAnalyticsDestinationArgs', 'LogAnalyticsDestinationArgsDict', 'LogAnalyticsQuerySignalDefinitionPropertiesArgs', ..., 'LogAnalyticsSignalGroupArgs', 'LogAnalyticsSignalGroupArgsDict', 'LogFileSettingsTextArgs', 'LogFileSettingsTextArgsDict', 'LogFilesDataSourceSettingsArgs', 'LogFilesDataSourceSettingsArgsDict', 'LogFilesDataSourceArgs', 'LogFilesDataSourceArgsDict', 'LogSettingsArgs', 'LogSettingsArgsDict', 'LogicAppReceiverArgs', 'LogicAppReceiverArgsDict', 'ManagedIdentityAuthenticationSettingPropertiesArgs', ..., 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'ManagementGroupLogSettingsArgs', 'ManagementGroupLogSettingsArgsDict', 'MetricAlertActionArgs', 'MetricAlertActionArgsDict', ..., ..., ..., ..., 'MetricCriteriaArgs', 'MetricCriteriaArgsDict', 'MetricDimensionArgs', 'MetricDimensionArgsDict', 'MetricSettingsArgs', 'MetricSettingsArgsDict', 'MetricTriggerArgs', 'MetricTriggerArgsDict', 'ModelDiscoverySettingsArgs', 'ModelDiscoverySettingsArgsDict', 'MonitoringAccountDestinationArgs', 'MonitoringAccountDestinationArgsDict', 'NetworkingConfigurationArgs', 'NetworkingConfigurationArgsDict', 'NetworkingRouteArgs', 'NetworkingRouteArgsDict', 'OtlpReceiverArgs', 'OtlpReceiverArgsDict', 'PerfCounterDataSourceArgs', 'PerfCounterDataSourceArgsDict', 'PersistenceConfigurationsArgs', 'PersistenceConfigurationsArgsDict', 'PipelineGroupPropertiesArgs', 'PipelineGroupPropertiesArgsDict', 'PipelineArgs', 'PipelineArgsDict', 'PlatformTelemetryDataSourceArgs', 'PlatformTelemetryDataSourceArgsDict', 'PredictiveAutoscalePolicyArgs', 'PredictiveAutoscalePolicyArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'ProcessorArgs', 'ProcessorArgsDict', 'PrometheusForwarderDataSourceArgs', 'PrometheusForwarderDataSourceArgsDict', 'PrometheusMetricsSignalDefinitionPropertiesArgs', ..., 'ReceiverArgs', 'ReceiverArgsDict', 'RecordMapArgs', 'RecordMapArgsDict', 'RecurrenceArgs', 'RecurrenceArgsDict', 'RecurrentScheduleArgs', 'RecurrentScheduleArgsDict', 'RelationshipPropertiesArgs', 'RelationshipPropertiesArgsDict', 'ResourceGraphQueryDiscoveryRulePropertiesArgs', 'ResourceGraphQueryDiscoveryRulePropertiesArgsDict', 'ResourceMapArgs', 'ResourceMapArgsDict', 'ResourceMetricSignalDefinitionPropertiesArgs', 'ResourceMetricSignalDefinitionPropertiesArgsDict', 'RetentionPolicyArgs', 'RetentionPolicyArgsDict', 'RuleResolveConfigurationArgs', 'RuleResolveConfigurationArgsDict', 'ScaleActionArgs', 'ScaleActionArgsDict', 'ScaleCapacityArgs', 'ScaleCapacityArgsDict', 'ScaleRuleMetricDimensionArgs', 'ScaleRuleMetricDimensionArgsDict', 'ScaleRuleArgs', 'ScaleRuleArgsDict', 'ScheduledQueryRuleCriteriaArgs', 'ScheduledQueryRuleCriteriaArgsDict', 'SchemaMapArgs', 'SchemaMapArgsDict', 'ScopeMapArgs', 'ScopeMapArgsDict', 'ServiceArgs', 'ServiceArgsDict', 'SignalAssignmentArgs', 'SignalAssignmentArgsDict', 'SignalGroupArgs', 'SignalGroupArgsDict', 'SmsReceiverArgs', 'SmsReceiverArgsDict', 'StorageBlobDestinationArgs', 'StorageBlobDestinationArgsDict', 'StorageTableDestinationArgs', 'StorageTableDestinationArgsDict', 'StreamDeclarationArgs', 'StreamDeclarationArgsDict', 'SubscriptionLogSettingsArgs', 'SubscriptionLogSettingsArgsDict', 'SyslogDataSourceArgs', 'SyslogDataSourceArgsDict', 'SyslogReceiverArgs', 'SyslogReceiverArgsDict', 'TcpExporterArgs', 'TcpExporterArgsDict', 'ThresholdRuleArgs', 'ThresholdRuleArgsDict', 'TimeWindowArgs', 'TimeWindowArgsDict', 'UdpReceiverArgs', 'UdpReceiverArgsDict', 'VoiceReceiverArgs', 'VoiceReceiverArgsDict', 'WebhookNotificationArgs', 'WebhookNotificationArgsDict', 'WebhookReceiverArgs', 'WebhookReceiverArgsDict', 'WebtestLocationAvailabilityCriteriaArgs', 'WebtestLocationAvailabilityCriteriaArgsDict', 'WindowsEventLogDataSourceArgs', 'WindowsEventLogDataSourceArgsDict', 'WindowsFirewallLogsDataSourceArgs', 'WindowsFirewallLogsDataSourceArgsDict']
...
class AccessModeSettingsExclusionArgs:
    def __init__(__self__, *, ingestion_access_mode: Optional[pulumi.Input[Union[_builtins.str, AccessMode]]] = ..., private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., query_access_mode: Optional[pulumi.Input[Union[_builtins.str, AccessMode]]] = ...) -> None:
    ...
    def ingestion_access_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, AccessMode]]]): # -> None:
        ...
    ...
    def query_access_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, AccessMode]]]): # -> None:
        ...
...
class AccessModeSettingsArgs:
    def __init__(__self__, *, ingestion_access_mode: pulumi.Input[Union[_builtins.str, AccessMode]], query_access_mode: pulumi.Input[Union[_builtins.str, AccessMode]], exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[AccessModeSettingsExclusionArgs]]]] = ...) -> None:
    ...
    @ingestion_access_mode.setter
    def ingestion_access_mode(self, value: pulumi.Input[Union[_builtins.str, AccessMode]]): # -> None:
        ...
    ...
    @query_access_mode.setter
    def query_access_mode(self, value: pulumi.Input[Union[_builtins.str, AccessMode]]): # -> None:
        ...
    ...
    @exclusions.setter
    def exclusions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AccessModeSettingsExclusionArgs]]]]): # -> None:
        ...
...
class ActionGroupArgs:
    def __init__(__self__, *, action_group_id: pulumi.Input[_builtins.str], webhook_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def action_group_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def webhook_properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ActionListArgs:
    def __init__(__self__, *, action_groups: Optional[pulumi.Input[Sequence[pulumi.Input[ActionGroupArgs]]]] = ...) -> None:
    ...
    def action_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ActionGroupArgs]]]]): # -> None:
        ...
...
@pulumi.input_type
class ActionsArgs:
    def __init__(__self__, *, action_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., action_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., custom_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @action_groups.setter
    def action_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def action_properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AlertConfigurationArgs:
    def __init__(__self__, *, severity: pulumi.Input[Union[_builtins.str, AlertSeverity]], action_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def action_group_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AlertRuleAllOfConditionArgs:
    def __init__(__self__, *, all_of: pulumi.Input[Sequence[pulumi.Input[AlertRuleAnyOfOrLeafConditionArgs]]]) -> None:
    ...
    @all_of.setter
    def all_of(self, value: pulumi.Input[Sequence[pulumi.Input[AlertRuleAnyOfOrLeafConditionArgs]]]): # -> None:
        ...
...
class AlertRuleAnyOfOrLeafConditionArgs:
    def __init__(__self__, *, any_of: Optional[pulumi.Input[Sequence[pulumi.Input[AlertRuleLeafConditionArgs]]]] = ..., contains_any: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., equals: Optional[pulumi.Input[_builtins.str]] = ..., field: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @any_of.setter
    def any_of(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AlertRuleLeafConditionArgs]]]]): # -> None:
        ...
    ...
    @contains_any.setter
    def contains_any(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @equals.setter
    def equals(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AlertRuleLeafConditionArgs:
    def __init__(__self__, *, contains_any: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., equals: Optional[pulumi.Input[_builtins.str]] = ..., field: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ApplicationInsightsTopologyDiscoveryRulePropertiesArgs:
    def __init__(__self__, *, add_recommended_signals: pulumi.Input[Union[_builtins.str, DiscoveryRuleRecommendedSignalsBehavior]], application_insights_resource_id: pulumi.Input[_builtins.str], authentication_setting: pulumi.Input[_builtins.str], discover_relationships: pulumi.Input[Union[_builtins.str, DiscoveryRuleRelationshipDiscoveryBehavior]], discovery_rule_kind: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def add_recommended_signals(self, value: pulumi.Input[Union[_builtins.str, DiscoveryRuleRecommendedSignalsBehavior]]): # -> None:
        ...
    ...
    def application_insights_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def authentication_setting(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def discover_relationships(self, value: pulumi.Input[Union[_builtins.str, DiscoveryRuleRelationshipDiscoveryBehavior]]): # -> None:
        ...
    ...
    def discovery_rule_kind(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ArmRoleReceiverArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], role_id: pulumi.Input[_builtins.str], use_common_alert_schema: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def use_common_alert_schema(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class AutomationRunbookReceiverArgs:
    def __init__(__self__, *, automation_account_id: pulumi.Input[_builtins.str], is_global_runbook: pulumi.Input[_builtins.bool], runbook_name: pulumi.Input[_builtins.str], webhook_resource_id: pulumi.Input[_builtins.str], managed_identity: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., service_uri: Optional[pulumi.Input[_builtins.str]] = ..., use_common_alert_schema: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def automation_account_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def is_global_runbook(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    @runbook_name.setter
    def runbook_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def webhook_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @service_uri.setter
    def service_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AutoscaleNotificationArgs:
    def __init__(__self__, *, operation: pulumi.Input[OperationType], email: Optional[pulumi.Input[EmailNotificationArgs]] = ..., webhooks: Optional[pulumi.Input[Sequence[pulumi.Input[WebhookNotificationArgs]]]] = ...) -> None:
    ...
    @operation.setter
    def operation(self, value: pulumi.Input[OperationType]): # -> None:
        ...
    ...
    @email.setter
    def email(self, value: Optional[pulumi.Input[EmailNotificationArgs]]): # -> None:
        ...
    ...
    @webhooks.setter
    def webhooks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WebhookNotificationArgs]]]]): # -> None:
        ...
...
class AutoscaleProfileArgs:
    def __init__(__self__, *, capacity: pulumi.Input[ScaleCapacityArgs], name: pulumi.Input[_builtins.str], rules: pulumi.Input[Sequence[pulumi.Input[ScaleRuleArgs]]], fixed_date: Optional[pulumi.Input[TimeWindowArgs]] = ..., recurrence: Optional[pulumi.Input[RecurrenceArgs]] = ...) -> None:
    ...
    @capacity.setter
    def capacity(self, value: pulumi.Input[ScaleCapacityArgs]): # -> None:
        ...
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Sequence[pulumi.Input[ScaleRuleArgs]]]): # -> None:
        ...
    ...
    @fixed_date.setter
    def fixed_date(self, value: Optional[pulumi.Input[TimeWindowArgs]]): # -> None:
        ...
...
class AzureAppPushReceiverArgs:
    def __init__(__self__, *, email_address: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str]) -> None:
...
class AzureFunctionReceiverArgs:
    def __init__(__self__, *, function_app_resource_id: pulumi.Input[_builtins.str], function_name: pulumi.Input[_builtins.str], http_trigger_url: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], managed_identity: Optional[pulumi.Input[_builtins.str]] = ..., use_common_alert_schema: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def function_app_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def http_trigger_url(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AzureMonitorWorkspaceLogsApiConfigArgs:
    def __init__(__self__, *, data_collection_endpoint_url: pulumi.Input[_builtins.str], data_collection_rule: pulumi.Input[_builtins.str], schema: pulumi.Input[SchemaMapArgs], stream: pulumi.Input[_builtins.str]) -> None:
    ...
    def data_collection_endpoint_url(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def data_collection_rule(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @schema.setter
    def schema(self, value: pulumi.Input[SchemaMapArgs]): # -> None:
        ...
    ...
    @stream.setter
    def stream(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AzureMonitorWorkspaceLogsExporterArgs:
    def __init__(__self__, *, api: pulumi.Input[AzureMonitorWorkspaceLogsApiConfigArgs], cache: Optional[pulumi.Input[CacheConfigurationArgs]] = ..., concurrency: Optional[pulumi.Input[ConcurrencyConfigurationArgs]] = ...) -> None:
    ...
    @api.setter
    def api(self, value: pulumi.Input[AzureMonitorWorkspaceLogsApiConfigArgs]): # -> None:
        ...
    ...
    @cache.setter
    def cache(self, value: Optional[pulumi.Input[CacheConfigurationArgs]]): # -> None:
        ...
    ...
    @concurrency.setter
    def concurrency(self, value: Optional[pulumi.Input[ConcurrencyConfigurationArgs]]): # -> None:
        ...
...
class AzureMonitorWorkspaceSignalGroupArgs:
    def __init__(__self__, *, authentication_setting: pulumi.Input[_builtins.str], azure_monitor_workspace_resource_id: pulumi.Input[_builtins.str], signal_assignments: Optional[pulumi.Input[Sequence[pulumi.Input[SignalAssignmentArgs]]]] = ...) -> None:
    ...
    def azure_monitor_workspace_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def signal_assignments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SignalAssignmentArgs]]]]): # -> None:
        ...
...
class AzureResourceSignalGroupArgs:
    def __init__(__self__, *, authentication_setting: pulumi.Input[_builtins.str], azure_resource_id: pulumi.Input[_builtins.str], signal_assignments: Optional[pulumi.Input[Sequence[pulumi.Input[SignalAssignmentArgs]]]] = ...) -> None:
    ...
    def azure_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BatchProcessorArgs:
    def __init__(__self__, *, batch_size: Optional[pulumi.Input[_builtins.int]] = ..., timeout: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class CacheConfigurationArgs:
    def __init__(__self__, *, max_storage_usage: Optional[pulumi.Input[_builtins.int]] = ..., retention_period: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def max_storage_usage(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ColumnDefinitionArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, KnownColumnDefinitionType]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, KnownColumnDefinitionType]]]): # -> None:
        ...
...
class ConcurrencyConfigurationArgs:
    def __init__(__self__, *, batch_queue_size: Optional[pulumi.Input[_builtins.int]] = ..., worker_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def batch_queue_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ConditionFailingPeriodsArgs:
    def __init__(__self__, *, min_failing_periods_to_alert: Optional[pulumi.Input[_builtins.float]] = ..., number_of_evaluation_periods: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def min_failing_periods_to_alert(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def number_of_evaluation_periods(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
@pulumi.input_type
class ConditionArgs:
    def __init__(__self__, *, alert_sensitivity: Optional[pulumi.Input[_builtins.str]] = ..., criterion_type: Optional[pulumi.Input[Union[_builtins.str, CriterionType]]] = ..., dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[DimensionArgs]]]] = ..., failing_periods: Optional[pulumi.Input[ConditionFailingPeriodsArgs]] = ..., ignore_data_before: Optional[pulumi.Input[_builtins.str]] = ..., metric_measure_column: Optional[pulumi.Input[_builtins.str]] = ..., metric_name: Optional[pulumi.Input[_builtins.str]] = ..., min_recurrence_count: Optional[pulumi.Input[_builtins.float]] = ..., operator: Optional[pulumi.Input[Union[_builtins.str, ConditionOperator]]] = ..., query: Optional[pulumi.Input[_builtins.str]] = ..., resource_id_column: Optional[pulumi.Input[_builtins.str]] = ..., threshold: Optional[pulumi.Input[_builtins.float]] = ..., time_aggregation: Optional[pulumi.Input[Union[_builtins.str, TimeAggregation]]] = ...) -> None:
    ...
    def alert_sensitivity(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def criterion_type(self, value: Optional[pulumi.Input[Union[_builtins.str, CriterionType]]]): # -> None:
        ...
    ...
    @dimensions.setter
    def dimensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DimensionArgs]]]]): # -> None:
        ...
    ...
    def failing_periods(self, value: Optional[pulumi.Input[ConditionFailingPeriodsArgs]]): # -> None:
        ...
    ...
    def ignore_data_before(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def metric_measure_column(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def min_recurrence_count(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @operator.setter
    def operator(self, value: Optional[pulumi.Input[Union[_builtins.str, ConditionOperator]]]): # -> None:
        ...
    ...
    def resource_id_column(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def time_aggregation(self, value: Optional[pulumi.Input[Union[_builtins.str, TimeAggregation]]]): # -> None:
        ...
...
class DataCollectionEndpointNetworkAclsArgs:
    def __init__(__self__, *, public_network_access: Optional[pulumi.Input[Union[_builtins.str, KnownPublicNetworkAccessOptions]]] = ...) -> None:
    ...
    def public_network_access(self, value: Optional[pulumi.Input[Union[_builtins.str, KnownPublicNetworkAccessOptions]]]): # -> None:
        ...
...
class DataCollectionRuleDataSourcesArgs:
    def __init__(__self__, *, data_imports: Optional[pulumi.Input[DataSourcesSpecDataImportsArgs]] = ..., extensions: Optional[pulumi.Input[Sequence[pulumi.Input[ExtensionDataSourceArgs]]]] = ..., iis_logs: Optional[pulumi.Input[Sequence[pulumi.Input[IisLogsDataSourceArgs]]]] = ..., log_files: Optional[pulumi.Input[Sequence[pulumi.Input[LogFilesDataSourceArgs]]]] = ..., performance_counters: Optional[pulumi.Input[Sequence[pulumi.Input[PerfCounterDataSourceArgs]]]] = ..., platform_telemetry: Optional[pulumi.Input[Sequence[pulumi.Input[PlatformTelemetryDataSourceArgs]]]] = ..., prometheus_forwarder: Optional[pulumi.Input[Sequence[pulumi.Input[PrometheusForwarderDataSourceArgs]]]] = ..., syslog: Optional[pulumi.Input[Sequence[pulumi.Input[SyslogDataSourceArgs]]]] = ..., windows_event_logs: Optional[pulumi.Input[Sequence[pulumi.Input[WindowsEventLogDataSourceArgs]]]] = ..., windows_firewall_logs: Optional[pulumi.Input[Sequence[pulumi.Input[WindowsFirewallLogsDataSourceArgs]]]] = ...) -> None:
    ...
    @data_imports.setter
    def data_imports(self, value: Optional[pulumi.Input[DataSourcesSpecDataImportsArgs]]): # -> None:
        ...
    ...
    @extensions.setter
    def extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExtensionDataSourceArgs]]]]): # -> None:
        ...
    ...
    @iis_logs.setter
    def iis_logs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IisLogsDataSourceArgs]]]]): # -> None:
        ...
    ...
    @log_files.setter
    def log_files(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogFilesDataSourceArgs]]]]): # -> None:
        ...
    ...
    def performance_counters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PerfCounterDataSourceArgs]]]]): # -> None:
        ...
    ...
    def platform_telemetry(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlatformTelemetryDataSourceArgs]]]]): # -> None:
        ...
    ...
    def prometheus_forwarder(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PrometheusForwarderDataSourceArgs]]]]): # -> None:
        ...
    ...
    @syslog.setter
    def syslog(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SyslogDataSourceArgs]]]]): # -> None:
        ...
    ...
    def windows_event_logs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WindowsEventLogDataSourceArgs]]]]): # -> None:
        ...
    ...
    def windows_firewall_logs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WindowsFirewallLogsDataSourceArgs]]]]): # -> None:
        ...
...
class DataCollectionRuleDestinationsArgs:
    def __init__(__self__, *, azure_monitor_metrics: Optional[pulumi.Input[DestinationsSpecAzureMonitorMetricsArgs]] = ..., event_hubs: Optional[pulumi.Input[Sequence[pulumi.Input[EventHubDestinationArgs]]]] = ..., event_hubs_direct: Optional[pulumi.Input[Sequence[pulumi.Input[EventHubDirectDestinationArgs]]]] = ..., log_analytics: Optional[pulumi.Input[Sequence[pulumi.Input[LogAnalyticsDestinationArgs]]]] = ..., monitoring_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[MonitoringAccountDestinationArgs]]]] = ..., storage_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[StorageBlobDestinationArgs]]]] = ..., storage_blobs_direct: Optional[pulumi.Input[Sequence[pulumi.Input[StorageBlobDestinationArgs]]]] = ..., storage_tables_direct: Optional[pulumi.Input[Sequence[pulumi.Input[StorageTableDestinationArgs]]]] = ...) -> None:
    ...
    def azure_monitor_metrics(self, value: Optional[pulumi.Input[DestinationsSpecAzureMonitorMetricsArgs]]): # -> None:
        ...
    ...
    @event_hubs.setter
    def event_hubs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventHubDestinationArgs]]]]): # -> None:
        ...
    ...
    def event_hubs_direct(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventHubDirectDestinationArgs]]]]): # -> None:
        ...
    ...
    def log_analytics(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogAnalyticsDestinationArgs]]]]): # -> None:
        ...
    ...
    def monitoring_accounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MonitoringAccountDestinationArgs]]]]): # -> None:
        ...
    ...
    def storage_accounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StorageBlobDestinationArgs]]]]): # -> None:
        ...
    ...
    def storage_blobs_direct(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StorageBlobDestinationArgs]]]]): # -> None:
        ...
    ...
    def storage_tables_direct(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StorageTableDestinationArgs]]]]): # -> None:
        ...
...
@pulumi.input_type
class DataFlowArgs:
    def __init__(__self__, *, built_in_transform: Optional[pulumi.Input[_builtins.str]] = ..., destinations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., output_stream: Optional[pulumi.Input[_builtins.str]] = ..., streams: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownDataFlowStreams]]]]] = ..., transform_kql: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def built_in_transform(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def output_stream(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @streams.setter
    def streams(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownDataFlowStreams]]]]]): # -> None:
        ...
    ...
    def transform_kql(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataImportSourcesEventHubArgs:
    def __init__(__self__, *, consumer_group: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., stream: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @stream.setter
    def stream(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataSourcesSpecDataImportsArgs:
    def __init__(__self__, *, event_hub: Optional[pulumi.Input[DataImportSourcesEventHubArgs]] = ...) -> None:
    ...
    @event_hub.setter
    def event_hub(self, value: Optional[pulumi.Input[DataImportSourcesEventHubArgs]]): # -> None:
        ...
...
class DependenciesSignalGroupArgs:
    def __init__(__self__, *, aggregation_type: Optional[pulumi.Input[Union[_builtins.str, DependenciesAggregationType]]] = ..., degraded_threshold: Optional[pulumi.Input[_builtins.str]] = ..., unhealthy_threshold: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def aggregation_type(self, value: pulumi.Input[Union[_builtins.str, DependenciesAggregationType]]): # -> None:
        ...
    ...
    def degraded_threshold(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def unhealthy_threshold(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class DimensionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], operator: pulumi.Input[Union[_builtins.str, DimensionOperator]], values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, DimensionOperator]]): # -> None:
        ...
...
class DynamicDetectionRuleArgs:
    def __init__(__self__, *, dynamic_threshold_direction: pulumi.Input[Union[_builtins.str, DynamicThresholdDirection]], dynamic_threshold_model: pulumi.Input[Union[_builtins.str, DynamicThresholdModel]], model_sensitivity: pulumi.Input[_builtins.float], training_start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dynamic_threshold_direction(self, value: pulumi.Input[Union[_builtins.str, DynamicThresholdDirection]]): # -> None:
        ...
    ...
    def dynamic_threshold_model(self, value: pulumi.Input[Union[_builtins.str, DynamicThresholdModel]]): # -> None:
        ...
    ...
    def model_sensitivity(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def training_start_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DynamicMetricCriteriaArgs:
    def __init__(__self__, *, alert_sensitivity: pulumi.Input[Union[_builtins.str, DynamicThresholdSensitivity]], criterion_type: pulumi.Input[_builtins.str], failing_periods: pulumi.Input[DynamicThresholdFailingPeriodsArgs], metric_name: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], operator: pulumi.Input[Union[_builtins.str, DynamicThresholdOperator]], time_aggregation: pulumi.Input[Union[_builtins.str, AggregationTypeEnum]], dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[MetricDimensionArgs]]]] = ..., ignore_data_before: Optional[pulumi.Input[_builtins.str]] = ..., metric_namespace: Optional[pulumi.Input[_builtins.str]] = ..., skip_metric_validation: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @alert_sensitivity.setter
    def alert_sensitivity(self, value: pulumi.Input[Union[_builtins.str, DynamicThresholdSensitivity]]): # -> None:
        ...
    ...
    @criterion_type.setter
    def criterion_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @failing_periods.setter
    def failing_periods(self, value: pulumi.Input[DynamicThresholdFailingPeriodsArgs]): # -> None:
        ...
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, DynamicThresholdOperator]]): # -> None:
        ...
    ...
    @time_aggregation.setter
    def time_aggregation(self, value: pulumi.Input[Union[_builtins.str, AggregationTypeEnum]]): # -> None:
        ...
    ...
    @dimensions.setter
    def dimensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MetricDimensionArgs]]]]): # -> None:
        ...
    ...
    def metric_namespace(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def skip_metric_validation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DynamicThresholdFailingPeriodsArgs:
    def __init__(__self__, *, min_failing_periods_to_alert: pulumi.Input[_builtins.float], number_of_evaluation_periods: pulumi.Input[_builtins.float]) -> None:
    ...
    @min_failing_periods_to_alert.setter
    def min_failing_periods_to_alert(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @number_of_evaluation_periods.setter
    def number_of_evaluation_periods(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class EmailNotificationArgs:
    def __init__(__self__, *, custom_emails: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., send_to_subscription_administrator: Optional[pulumi.Input[_builtins.bool]] = ..., send_to_subscription_co_administrators: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def send_to_subscription_administrator(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def send_to_subscription_co_administrators(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class EmailReceiverArgs:
    def __init__(__self__, *, email_address: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], use_common_alert_schema: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class EntityAlertsArgs:
    def __init__(__self__, *, degraded: Optional[pulumi.Input[AlertConfigurationArgs]] = ..., unhealthy: Optional[pulumi.Input[AlertConfigurationArgs]] = ...) -> None:
    ...
    @degraded.setter
    def degraded(self, value: Optional[pulumi.Input[AlertConfigurationArgs]]): # -> None:
        ...
    ...
    @unhealthy.setter
    def unhealthy(self, value: Optional[pulumi.Input[AlertConfigurationArgs]]): # -> None:
        ...
...
class EntityCoordinatesArgs:
    def __init__(__self__, *, x: pulumi.Input[_builtins.float], y: pulumi.Input[_builtins.float]) -> None:
    ...
    @x.setter
    def x(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @y.setter
    def y(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class EntityPropertiesArgs:
    def __init__(__self__, *, alerts: Optional[pulumi.Input[EntityAlertsArgs]] = ..., canvas_position: Optional[pulumi.Input[EntityCoordinatesArgs]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., health_objective: Optional[pulumi.Input[_builtins.float]] = ..., icon: Optional[pulumi.Input[IconDefinitionArgs]] = ..., impact: Optional[pulumi.Input[Union[_builtins.str, EntityImpact]]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., signals: Optional[pulumi.Input[SignalGroupArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @alerts.setter
    def alerts(self, value: Optional[pulumi.Input[EntityAlertsArgs]]): # -> None:
        ...
    ...
    def canvas_position(self, value: Optional[pulumi.Input[EntityCoordinatesArgs]]): # -> None:
        ...
    ...
    def health_objective(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @icon.setter
    def icon(self, value: Optional[pulumi.Input[IconDefinitionArgs]]): # -> None:
        ...
    ...
    @impact.setter
    def impact(self, value: Optional[pulumi.Input[Union[_builtins.str, EntityImpact]]]): # -> None:
        ...
    ...
    @signals.setter
    def signals(self, value: Optional[pulumi.Input[SignalGroupArgs]]): # -> None:
        ...
...
class EvaluationRuleArgs:
    def __init__(__self__, *, degraded_rule: Optional[pulumi.Input[ThresholdRuleArgs]] = ..., dynamic_detection_rule: Optional[pulumi.Input[DynamicDetectionRuleArgs]] = ..., unhealthy_rule: Optional[pulumi.Input[ThresholdRuleArgs]] = ...) -> None:
    ...
    def degraded_rule(self, value: Optional[pulumi.Input[ThresholdRuleArgs]]): # -> None:
        ...
    ...
    def dynamic_detection_rule(self, value: Optional[pulumi.Input[DynamicDetectionRuleArgs]]): # -> None:
        ...
    ...
    def unhealthy_rule(self, value: Optional[pulumi.Input[ThresholdRuleArgs]]): # -> None:
        ...
...
class EventHubDestinationArgs:
    def __init__(__self__, *, event_hub_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EventHubReceiverArgs:
    def __init__(__self__, *, event_hub_name: pulumi.Input[_builtins.str], event_hub_name_space: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], subscription_id: pulumi.Input[_builtins.str], managed_identity: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., use_common_alert_schema: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def event_hub_name_space(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
@pulumi.input_type
class ExporterArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], type: pulumi.Input[Union[_builtins.str, ExporterType]], azure_monitor_workspace_logs: Optional[pulumi.Input[AzureMonitorWorkspaceLogsExporterArgs]] = ..., tcp: Optional[pulumi.Input[TcpExporterArgs]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ExporterType]]): # -> None:
        ...
    ...
    def azure_monitor_workspace_logs(self, value: Optional[pulumi.Input[AzureMonitorWorkspaceLogsExporterArgs]]): # -> None:
        ...
    ...
    @tcp.setter
    def tcp(self, value: Optional[pulumi.Input[TcpExporterArgs]]): # -> None:
        ...
...
class ExtensionDataSourceArgs:
    def __init__(__self__, *, extension_name: pulumi.Input[_builtins.str], extension_settings: Optional[Any] = ..., input_data_sources: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., streams: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownExtensionDataSourceStreams]]]]] = ...) -> None:
    ...
    def extension_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def extension_settings(self, value: Optional[Any]): # -> None:
        ...
    ...
    def input_data_sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @streams.setter
    def streams(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownExtensionDataSourceStreams]]]]]): # -> None:
        ...
...
class HealthModelPropertiesArgs:
    def __init__(__self__, *, discovery: Optional[pulumi.Input[ModelDiscoverySettingsArgs]] = ...) -> None:
    ...
    @discovery.setter
    def discovery(self, value: Optional[pulumi.Input[ModelDiscoverySettingsArgs]]): # -> None:
        ...
...
class IconDefinitionArgs:
    def __init__(__self__, *, icon_name: pulumi.Input[_builtins.str], custom_data: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @icon_name.setter
    def icon_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class IisLogsDataSourceArgs:
    def __init__(__self__, *, streams: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], log_directories: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @streams.setter
    def streams(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def log_directories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class IncidentReceiverArgs:
    def __init__(__self__, *, connection: pulumi.Input[IncidentServiceConnectionArgs], incident_management_service: pulumi.Input[Union[_builtins.str, IncidentManagementService]], mappings: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], name: pulumi.Input[_builtins.str]) -> None:
    ...
    @connection.setter
    def connection(self, value: pulumi.Input[IncidentServiceConnectionArgs]): # -> None:
        ...
    ...
    def incident_management_service(self, value: pulumi.Input[Union[_builtins.str, IncidentManagementService]]): # -> None:
        ...
...
class IncidentServiceConnectionArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str]) -> None:
...
class IssuePropertiesArgs:
    def __init__(__self__, *, impact_time: pulumi.Input[_builtins.str], severity: pulumi.Input[_builtins.str], status: pulumi.Input[Union[_builtins.str, Status]], title: pulumi.Input[_builtins.str]) -> None:
    ...
    @impact_time.setter
    def impact_time(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ItsmReceiverArgs:
    def __init__(__self__, *, connection_id: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], region: pulumi.Input[_builtins.str], ticket_configuration: pulumi.Input[_builtins.str], workspace_id: pulumi.Input[_builtins.str]) -> None:
    ...
    def ticket_configuration(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class JsonArrayMapperArgs:
    def __init__(__self__, *, keys: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], destination_field: Optional[pulumi.Input[JsonMapperDestinationFieldArgs]] = ..., source_field: Optional[pulumi.Input[JsonMapperSourceFieldArgs]] = ...) -> None:
    ...
    def destination_field(self, value: Optional[pulumi.Input[JsonMapperDestinationFieldArgs]]): # -> None:
        ...
    ...
    @source_field.setter
    def source_field(self, value: Optional[pulumi.Input[JsonMapperSourceFieldArgs]]): # -> None:
        ...
...
class JsonMapperDestinationFieldArgs:
    def __init__(__self__, *, destination: Optional[pulumi.Input[Union[_builtins.str, JsonMapperElement]]] = ..., field_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @destination.setter
    def destination(self, value: Optional[pulumi.Input[Union[_builtins.str, JsonMapperElement]]]): # -> None:
        ...
...
class JsonMapperSourceFieldArgs:
    def __init__(__self__, *, field_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LogAnalyticsDestinationArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LogAnalyticsQuerySignalDefinitionPropertiesArgs:
    def __init__(__self__, *, evaluation_rules: pulumi.Input[EvaluationRuleArgs], query_text: pulumi.Input[_builtins.str], signal_kind: pulumi.Input[_builtins.str], data_unit: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., refresh_interval: Optional[pulumi.Input[Union[_builtins.str, RefreshInterval]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., time_grain: Optional[pulumi.Input[_builtins.str]] = ..., value_column_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def evaluation_rules(self, value: pulumi.Input[EvaluationRuleArgs]): # -> None:
        ...
    ...
    @query_text.setter
    def query_text(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @signal_kind.setter
    def signal_kind(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @data_unit.setter
    def data_unit(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def refresh_interval(self, value: Optional[pulumi.Input[Union[_builtins.str, RefreshInterval]]]): # -> None:
        ...
    ...
    @time_grain.setter
    def time_grain(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def value_column_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LogAnalyticsSignalGroupArgs:
    def __init__(__self__, *, authentication_setting: pulumi.Input[_builtins.str], log_analytics_workspace_resource_id: pulumi.Input[_builtins.str], signal_assignments: Optional[pulumi.Input[Sequence[pulumi.Input[SignalAssignmentArgs]]]] = ...) -> None:
...
class LogFileSettingsTextArgs:
    def __init__(__self__, *, record_start_timestamp_format: pulumi.Input[Union[_builtins.str, KnownLogFileTextSettingsRecordStartTimestampFormat]]) -> None:
    ...
    def record_start_timestamp_format(self, value: pulumi.Input[Union[_builtins.str, KnownLogFileTextSettingsRecordStartTimestampFormat]]): # -> None:
        ...
...
class LogFilesDataSourceSettingsArgs:
    def __init__(__self__, *, text: Optional[pulumi.Input[LogFileSettingsTextArgs]] = ...) -> None:
    ...
    @text.setter
    def text(self, value: Optional[pulumi.Input[LogFileSettingsTextArgs]]): # -> None:
        ...
...
class LogFilesDataSourceArgs:
    def __init__(__self__, *, file_patterns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], format: pulumi.Input[Union[_builtins.str, KnownLogFilesDataSourceFormat]], streams: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], name: Optional[pulumi.Input[_builtins.str]] = ..., settings: Optional[pulumi.Input[LogFilesDataSourceSettingsArgs]] = ...) -> None:
    ...
    def file_patterns(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @format.setter
    def format(self, value: pulumi.Input[Union[_builtins.str, KnownLogFilesDataSourceFormat]]): # -> None:
        ...
    ...
    @settings.setter
    def settings(self, value: Optional[pulumi.Input[LogFilesDataSourceSettingsArgs]]): # -> None:
        ...
...
class LogSettingsArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], category: Optional[pulumi.Input[_builtins.str]] = ..., category_group: Optional[pulumi.Input[_builtins.str]] = ..., retention_policy: Optional[pulumi.Input[RetentionPolicyArgs]] = ...) -> None:
    ...
    def category_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LogicAppReceiverArgs:
    def __init__(__self__, *, callback_url: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], resource_id: pulumi.Input[_builtins.str], managed_identity: Optional[pulumi.Input[_builtins.str]] = ..., use_common_alert_schema: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class ManagedIdentityAuthenticationSettingPropertiesArgs:
    def __init__(__self__, *, authentication_kind: pulumi.Input[_builtins.str], managed_identity_name: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authentication_kind(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def managed_identity_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ManagementGroupLogSettingsArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], category: Optional[pulumi.Input[_builtins.str]] = ..., category_group: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MetricAlertActionArgs:
    def __init__(__self__, *, action_group_id: Optional[pulumi.Input[_builtins.str]] = ..., web_hook_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def web_hook_properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class MetricAlertMultipleResourceMultipleMetricCriteriaArgs:
    def __init__(__self__, *, odata_type: pulumi.Input[_builtins.str], all_of: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DynamicMetricCriteriaArgs, MetricCriteriaArgs]]]]] = ...) -> None:
    ...
    @odata_type.setter
    def odata_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @all_of.setter
    def all_of(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DynamicMetricCriteriaArgs, MetricCriteriaArgs]]]]]): # -> None:
        ...
...
class MetricAlertSingleResourceMultipleMetricCriteriaArgs:
    def __init__(__self__, *, odata_type: pulumi.Input[_builtins.str], all_of: Optional[pulumi.Input[Sequence[pulumi.Input[MetricCriteriaArgs]]]] = ...) -> None:
    ...
    @all_of.setter
    def all_of(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MetricCriteriaArgs]]]]): # -> None:
        ...
...
class MetricCriteriaArgs:
    def __init__(__self__, *, criterion_type: pulumi.Input[_builtins.str], metric_name: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], operator: pulumi.Input[Union[_builtins.str, Operator]], threshold: pulumi.Input[_builtins.float], time_aggregation: pulumi.Input[Union[_builtins.str, AggregationTypeEnum]], dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[MetricDimensionArgs]]]] = ..., metric_namespace: Optional[pulumi.Input[_builtins.str]] = ..., skip_metric_validation: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class MetricDimensionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], operator: pulumi.Input[_builtins.str], values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
...
class MetricSettingsArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], category: Optional[pulumi.Input[_builtins.str]] = ..., retention_policy: Optional[pulumi.Input[RetentionPolicyArgs]] = ..., time_grain: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MetricTriggerArgs:
    def __init__(__self__, *, metric_name: pulumi.Input[_builtins.str], metric_resource_uri: pulumi.Input[_builtins.str], operator: pulumi.Input[ComparisonOperationType], statistic: pulumi.Input[MetricStatisticType], threshold: pulumi.Input[_builtins.float], time_aggregation: pulumi.Input[TimeAggregationType], time_grain: pulumi.Input[_builtins.str], time_window: pulumi.Input[_builtins.str], dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[ScaleRuleMetricDimensionArgs]]]] = ..., divide_per_instance: Optional[pulumi.Input[_builtins.bool]] = ..., metric_namespace: Optional[pulumi.Input[_builtins.str]] = ..., metric_resource_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def metric_resource_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[ComparisonOperationType]): # -> None:
        ...
    ...
    @statistic.setter
    def statistic(self, value: pulumi.Input[MetricStatisticType]): # -> None:
        ...
    ...
    @time_aggregation.setter
    def time_aggregation(self, value: pulumi.Input[TimeAggregationType]): # -> None:
        ...
    ...
    @time_grain.setter
    def time_grain(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @dimensions.setter
    def dimensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ScaleRuleMetricDimensionArgs]]]]): # -> None:
        ...
    ...
    def divide_per_instance(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def metric_resource_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ModelDiscoverySettingsArgs:
    def __init__(__self__, *, add_recommended_signals: pulumi.Input[Union[_builtins.str, DiscoveryRuleRecommendedSignalsBehavior]], scope: pulumi.Input[_builtins.str], identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MonitoringAccountDestinationArgs:
    def __init__(__self__, *, account_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def account_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NetworkingConfigurationArgs:
    def __init__(__self__, *, external_networking_mode: pulumi.Input[Union[_builtins.str, ExternalNetworkingMode]], routes: pulumi.Input[Sequence[pulumi.Input[NetworkingRouteArgs]]], host: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def external_networking_mode(self, value: pulumi.Input[Union[_builtins.str, ExternalNetworkingMode]]): # -> None:
        ...
    ...
    @routes.setter
    def routes(self, value: pulumi.Input[Sequence[pulumi.Input[NetworkingRouteArgs]]]): # -> None:
        ...
...
class NetworkingRouteArgs:
    def __init__(__self__, *, receiver: pulumi.Input[_builtins.str], path: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., subdomain: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @receiver.setter
    def receiver(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PerfCounterDataSourceArgs:
    def __init__(__self__, *, counter_specifiers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., sampling_frequency_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., streams: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownPerfCounterDataSourceStreams]]]]] = ...) -> None:
    ...
    def counter_specifiers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def sampling_frequency_in_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @streams.setter
    def streams(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownPerfCounterDataSourceStreams]]]]]): # -> None:
        ...
...
class PersistenceConfigurationsArgs:
    def __init__(__self__, *, persistent_volume_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def persistent_volume_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PipelineGroupPropertiesArgs:
    def __init__(__self__, *, exporters: pulumi.Input[Sequence[pulumi.Input[ExporterArgs]]], processors: pulumi.Input[Sequence[pulumi.Input[ProcessorArgs]]], receivers: pulumi.Input[Sequence[pulumi.Input[ReceiverArgs]]], service: pulumi.Input[ServiceArgs], networking_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkingConfigurationArgs]]]] = ..., replicas: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @exporters.setter
    def exporters(self, value: pulumi.Input[Sequence[pulumi.Input[ExporterArgs]]]): # -> None:
        ...
    ...
    @processors.setter
    def processors(self, value: pulumi.Input[Sequence[pulumi.Input[ProcessorArgs]]]): # -> None:
        ...
    ...
    @receivers.setter
    def receivers(self, value: pulumi.Input[Sequence[pulumi.Input[ReceiverArgs]]]): # -> None:
        ...
    ...
    @service.setter
    def service(self, value: pulumi.Input[ServiceArgs]): # -> None:
        ...
    ...
    def networking_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkingConfigurationArgs]]]]): # -> None:
        ...
    ...
    @replicas.setter
    def replicas(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
@pulumi.input_type
class PipelineArgs:
    def __init__(__self__, *, exporters: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], name: pulumi.Input[_builtins.str], receivers: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], type: pulumi.Input[Union[_builtins.str, PipelineType]], processors: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @exporters.setter
    def exporters(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @receivers.setter
    def receivers(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, PipelineType]]): # -> None:
        ...
    ...
    @processors.setter
    def processors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class PlatformTelemetryDataSourceArgs:
    def __init__(__self__, *, streams: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PredictiveAutoscalePolicyArgs:
    def __init__(__self__, *, scale_mode: pulumi.Input[PredictiveAutoscalePolicyScaleMode], scale_look_ahead_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @scale_mode.setter
    def scale_mode(self, value: pulumi.Input[PredictiveAutoscalePolicyScaleMode]): # -> None:
        ...
    ...
    def scale_look_ahead_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class ProcessorArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], type: pulumi.Input[Union[_builtins.str, ProcessorType]], batch: Optional[pulumi.Input[BatchProcessorArgs]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ProcessorType]]): # -> None:
        ...
    ...
    @batch.setter
    def batch(self, value: Optional[pulumi.Input[BatchProcessorArgs]]): # -> None:
        ...
...
class PrometheusForwarderDataSourceArgs:
    def __init__(__self__, *, label_include_filter: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., streams: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownPrometheusForwarderDataSourceStreams]]]]] = ...) -> None:
    ...
    def label_include_filter(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @streams.setter
    def streams(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownPrometheusForwarderDataSourceStreams]]]]]): # -> None:
        ...
...
class PrometheusMetricsSignalDefinitionPropertiesArgs:
    def __init__(__self__, *, evaluation_rules: pulumi.Input[EvaluationRuleArgs], query_text: pulumi.Input[_builtins.str], signal_kind: pulumi.Input[_builtins.str], data_unit: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., refresh_interval: Optional[pulumi.Input[Union[_builtins.str, RefreshInterval]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., time_grain: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class ReceiverArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], type: pulumi.Input[Union[_builtins.str, ReceiverType]], otlp: Optional[pulumi.Input[OtlpReceiverArgs]] = ..., syslog: Optional[pulumi.Input[SyslogReceiverArgs]] = ..., udp: Optional[pulumi.Input[UdpReceiverArgs]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ReceiverType]]): # -> None:
        ...
    ...
    @otlp.setter
    def otlp(self, value: Optional[pulumi.Input[OtlpReceiverArgs]]): # -> None:
        ...
    ...
    @syslog.setter
    def syslog(self, value: Optional[pulumi.Input[SyslogReceiverArgs]]): # -> None:
        ...
    ...
    @udp.setter
    def udp(self, value: Optional[pulumi.Input[UdpReceiverArgs]]): # -> None:
        ...
...
@pulumi.input_type
class RecordMapArgs:
    def __init__(__self__, *, from_: pulumi.Input[_builtins.str], to: pulumi.Input[_builtins.str]) -> None:
    ...
    @to.setter
    def to(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RecurrenceArgs:
    def __init__(__self__, *, frequency: pulumi.Input[RecurrenceFrequency], schedule: pulumi.Input[RecurrentScheduleArgs]) -> None:
    ...
    @schedule.setter
    def schedule(self, value: pulumi.Input[RecurrentScheduleArgs]): # -> None:
        ...
...
class RecurrentScheduleArgs:
    def __init__(__self__, *, days: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], hours: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]], minutes: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]], time_zone: pulumi.Input[_builtins.str]) -> None:
    ...
    @days.setter
    def days(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class RelationshipPropertiesArgs:
    def __init__(__self__, *, child_entity_name: pulumi.Input[_builtins.str], parent_entity_name: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def child_entity_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def parent_entity_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ResourceGraphQueryDiscoveryRulePropertiesArgs:
    def __init__(__self__, *, add_recommended_signals: pulumi.Input[Union[_builtins.str, DiscoveryRuleRecommendedSignalsBehavior]], authentication_setting: pulumi.Input[_builtins.str], discover_relationships: pulumi.Input[Union[_builtins.str, DiscoveryRuleRelationshipDiscoveryBehavior]], discovery_rule_kind: pulumi.Input[_builtins.str], resource_graph_query: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def resource_graph_query(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ResourceMetricSignalDefinitionPropertiesArgs:
    def __init__(__self__, *, aggregation_type: pulumi.Input[Union[_builtins.str, MetricAggregationType]], evaluation_rules: pulumi.Input[EvaluationRuleArgs], metric_name: pulumi.Input[_builtins.str], metric_namespace: pulumi.Input[_builtins.str], signal_kind: pulumi.Input[_builtins.str], time_grain: pulumi.Input[_builtins.str], data_unit: Optional[pulumi.Input[_builtins.str]] = ..., dimension: Optional[pulumi.Input[_builtins.str]] = ..., dimension_filter: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., refresh_interval: Optional[pulumi.Input[Union[_builtins.str, RefreshInterval]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @aggregation_type.setter
    def aggregation_type(self, value: pulumi.Input[Union[_builtins.str, MetricAggregationType]]): # -> None:
        ...
    ...
    @metric_namespace.setter
    def metric_namespace(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @dimension.setter
    def dimension(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def dimension_filter(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RuleResolveConfigurationArgs:
    def __init__(__self__, *, auto_resolved: Optional[pulumi.Input[_builtins.bool]] = ..., time_to_resolve: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def auto_resolved(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def time_to_resolve(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ScaleActionArgs:
    def __init__(__self__, *, cooldown: pulumi.Input[_builtins.str], direction: pulumi.Input[ScaleDirection], type: pulumi.Input[ScaleType], value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @cooldown.setter
    def cooldown(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @direction.setter
    def direction(self, value: pulumi.Input[ScaleDirection]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: pulumi.Input[ScaleType]): # -> None:
        ...
...
class ScaleCapacityArgs:
    def __init__(__self__, *, default: pulumi.Input[_builtins.str], maximum: pulumi.Input[_builtins.str], minimum: pulumi.Input[_builtins.str]) -> None:
    ...
    @maximum.setter
    def maximum(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @minimum.setter
    def minimum(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ScaleRuleMetricDimensionArgs:
    def __init__(__self__, *, dimension_name: pulumi.Input[_builtins.str], operator: pulumi.Input[Union[_builtins.str, ScaleRuleMetricDimensionOperationType]], values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, ScaleRuleMetricDimensionOperationType]]): # -> None:
        ...
...
@pulumi.input_type
class ScaleRuleArgs:
    def __init__(__self__, *, metric_trigger: pulumi.Input[MetricTriggerArgs], scale_action: pulumi.Input[ScaleActionArgs]) -> None:
    ...
    def metric_trigger(self, value: pulumi.Input[MetricTriggerArgs]): # -> None:
        ...
    ...
    @scale_action.setter
    def scale_action(self, value: pulumi.Input[ScaleActionArgs]): # -> None:
        ...
...
class ScheduledQueryRuleCriteriaArgs:
    def __init__(__self__, *, all_of: Optional[pulumi.Input[Sequence[pulumi.Input[ConditionArgs]]]] = ...) -> None:
    ...
    @all_of.setter
    def all_of(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ConditionArgs]]]]): # -> None:
        ...
...
@pulumi.input_type
class SchemaMapArgs:
    def __init__(__self__, *, record_map: pulumi.Input[Sequence[pulumi.Input[RecordMapArgs]]], resource_map: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceMapArgs]]]] = ..., scope_map: Optional[pulumi.Input[Sequence[pulumi.Input[ScopeMapArgs]]]] = ...) -> None:
    ...
    @record_map.setter
    def record_map(self, value: pulumi.Input[Sequence[pulumi.Input[RecordMapArgs]]]): # -> None:
        ...
    ...
    @resource_map.setter
    def resource_map(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceMapArgs]]]]): # -> None:
        ...
    ...
    @scope_map.setter
    def scope_map(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ScopeMapArgs]]]]): # -> None:
        ...
...
@pulumi.input_type
class ServiceArgs:
    def __init__(__self__, *, pipelines: pulumi.Input[Sequence[pulumi.Input[PipelineArgs]]], persistence: Optional[pulumi.Input[PersistenceConfigurationsArgs]] = ...) -> None:
    ...
    @pipelines.setter
    def pipelines(self, value: pulumi.Input[Sequence[pulumi.Input[PipelineArgs]]]): # -> None:
        ...
    ...
    @persistence.setter
    def persistence(self, value: Optional[pulumi.Input[PersistenceConfigurationsArgs]]): # -> None:
        ...
...
class SignalAssignmentArgs:
    def __init__(__self__, *, signal_definitions: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def signal_definitions(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class SignalGroupArgs:
    def __init__(__self__, *, azure_log_analytics: Optional[pulumi.Input[LogAnalyticsSignalGroupArgs]] = ..., azure_monitor_workspace: Optional[pulumi.Input[AzureMonitorWorkspaceSignalGroupArgs]] = ..., azure_resource: Optional[pulumi.Input[AzureResourceSignalGroupArgs]] = ..., dependencies: Optional[pulumi.Input[DependenciesSignalGroupArgs]] = ...) -> None:
    ...
    def azure_log_analytics(self, value: Optional[pulumi.Input[LogAnalyticsSignalGroupArgs]]): # -> None:
        ...
    ...
    def azure_monitor_workspace(self, value: Optional[pulumi.Input[AzureMonitorWorkspaceSignalGroupArgs]]): # -> None:
        ...
    ...
    def azure_resource(self, value: Optional[pulumi.Input[AzureResourceSignalGroupArgs]]): # -> None:
        ...
    ...
    @dependencies.setter
    def dependencies(self, value: Optional[pulumi.Input[DependenciesSignalGroupArgs]]): # -> None:
        ...
...
class SmsReceiverArgs:
    def __init__(__self__, *, country_code: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], phone_number: pulumi.Input[_builtins.str]) -> None:
...
class StorageBlobDestinationArgs:
    def __init__(__self__, *, container_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StorageTableDestinationArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., table_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StreamDeclarationArgs:
    def __init__(__self__, *, columns: Optional[pulumi.Input[Sequence[pulumi.Input[ColumnDefinitionArgs]]]] = ...) -> None:
    ...
    @columns.setter
    def columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ColumnDefinitionArgs]]]]): # -> None:
        ...
...
class SyslogDataSourceArgs:
    def __init__(__self__, *, facility_names: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownSyslogDataSourceFacilityNames]]]]] = ..., log_levels: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownSyslogDataSourceLogLevels]]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., streams: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownSyslogDataSourceStreams]]]]] = ...) -> None:
    ...
    def facility_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownSyslogDataSourceFacilityNames]]]]]): # -> None:
        ...
    ...
    @log_levels.setter
    def log_levels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownSyslogDataSourceLogLevels]]]]]): # -> None:
        ...
    ...
    @streams.setter
    def streams(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownSyslogDataSourceStreams]]]]]): # -> None:
        ...
...
class SyslogReceiverArgs:
    def __init__(__self__, *, endpoint: pulumi.Input[_builtins.str], protocol: Optional[pulumi.Input[Union[_builtins.str, SyslogProtocol]]] = ...) -> None:
    ...
    @protocol.setter
    def protocol(self, value: Optional[pulumi.Input[Union[_builtins.str, SyslogProtocol]]]): # -> None:
        ...
...
class ThresholdRuleArgs:
    def __init__(__self__, *, operator: pulumi.Input[Union[_builtins.str, SignalOperator]], threshold: pulumi.Input[_builtins.str]) -> None:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, SignalOperator]]): # -> None:
        ...
...
class TimeWindowArgs:
    def __init__(__self__, *, end: pulumi.Input[_builtins.str], start: pulumi.Input[_builtins.str], time_zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class UdpReceiverArgs:
    def __init__(__self__, *, endpoint: pulumi.Input[_builtins.str], encoding: Optional[pulumi.Input[Union[_builtins.str, StreamEncodingType]]] = ..., json_array_mapper: Optional[pulumi.Input[JsonArrayMapperArgs]] = ..., read_queue_length: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @encoding.setter
    def encoding(self, value: Optional[pulumi.Input[Union[_builtins.str, StreamEncodingType]]]): # -> None:
        ...
    ...
    def json_array_mapper(self, value: Optional[pulumi.Input[JsonArrayMapperArgs]]): # -> None:
        ...
    ...
    def read_queue_length(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class WebhookNotificationArgs:
    def __init__(__self__, *, properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., service_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WebhookReceiverArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], service_uri: pulumi.Input[_builtins.str], identifier_uri: Optional[pulumi.Input[_builtins.str]] = ..., managed_identity: Optional[pulumi.Input[_builtins.str]] = ..., object_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., use_aad_auth: Optional[pulumi.Input[_builtins.bool]] = ..., use_common_alert_schema: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @service_uri.setter
    def service_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def identifier_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @use_aad_auth.setter
    def use_aad_auth(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class WebtestLocationAvailabilityCriteriaArgs:
    def __init__(__self__, *, component_id: pulumi.Input[_builtins.str], failed_location_count: pulumi.Input[_builtins.float], odata_type: pulumi.Input[_builtins.str], web_test_id: pulumi.Input[_builtins.str]) -> None:
    ...
    def failed_location_count(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @web_test_id.setter
    def web_test_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class WindowsEventLogDataSourceArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., streams: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownWindowsEventLogDataSourceStreams]]]]] = ..., x_path_queries: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @streams.setter
    def streams(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, KnownWindowsEventLogDataSourceStreams]]]]]): # -> None:
        ...
    ...
    def x_path_queries(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
