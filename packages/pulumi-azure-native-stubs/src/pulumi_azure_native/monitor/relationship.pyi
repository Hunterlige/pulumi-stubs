...
class RelationshipArgs:
    def __init__(__self__, *, azure_monitor_workspace_name: pulumi.Input[_builtins.str], health_model_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], properties: Optional[pulumi.Input[RelationshipPropertiesArgs]] = ..., relationship_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[RelationshipPropertiesArgs]]): # -> None:
        ...
...
class Relationship(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., azure_monitor_workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., health_model_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[RelationshipPropertiesArgs, RelationshipPropertiesArgsDict]]] = ..., relationship_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
