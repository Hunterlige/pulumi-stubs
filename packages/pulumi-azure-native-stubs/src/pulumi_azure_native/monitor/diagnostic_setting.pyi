...
class DiagnosticSettingArgs:
    def __init__(__self__, *, resource_uri: pulumi.Input[_builtins.str], event_hub_authorization_rule_id: Optional[pulumi.Input[_builtins.str]] = ..., event_hub_name: Optional[pulumi.Input[_builtins.str]] = ..., log_analytics_destination_type: Optional[pulumi.Input[_builtins.str]] = ..., logs: Optional[pulumi.Input[Sequence[pulumi.Input[LogSettingsArgs]]]] = ..., marketplace_partner_id: Optional[pulumi.Input[_builtins.str]] = ..., metrics: Optional[pulumi.Input[Sequence[pulumi.Input[MetricSettingsArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., service_bus_rule_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_id: Optional[pulumi.Input[_builtins.str]] = ..., workspace_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def log_analytics_destination_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @logs.setter
    def logs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogSettingsArgs]]]]): # -> None:
        ...
    ...
    @metrics.setter
    def metrics(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MetricSettingsArgs]]]]): # -> None:
        ...
...
class DiagnosticSetting(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., event_hub_authorization_rule_id: Optional[pulumi.Input[_builtins.str]] = ..., event_hub_name: Optional[pulumi.Input[_builtins.str]] = ..., log_analytics_destination_type: Optional[pulumi.Input[_builtins.str]] = ..., logs: Optional[pulumi.Input[Sequence[pulumi.Input[Union[LogSettingsArgs, LogSettingsArgsDict]]]]] = ..., marketplace_partner_id: Optional[pulumi.Input[_builtins.str]] = ..., metrics: Optional[pulumi.Input[Sequence[pulumi.Input[Union[MetricSettingsArgs, MetricSettingsArgsDict]]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_uri: Optional[pulumi.Input[_builtins.str]] = ..., service_bus_rule_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_id: Optional[pulumi.Input[_builtins.str]] = ..., workspace_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: DiagnosticSettingArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> DiagnosticSetting:
    ...
    @_builtins.property
    @pulumi.getter(name="logAnalyticsDestinationType")
    def log_analytics_destination_type(self) -> pulumi.Output[Optional[_builtins.str]]:
