...
class AuthenticationSettingArgs:
    def __init__(__self__, *, azure_monitor_workspace_name: pulumi.Input[_builtins.str], health_model_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], authentication_setting_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[ManagedIdentityAuthenticationSettingPropertiesArgs]] = ...) -> None:
...
@pulumi.type_token("azure-native:monitor:AuthenticationSetting")
class AuthenticationSetting(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., authentication_setting_name: Optional[pulumi.Input[_builtins.str]] = ..., azure_monitor_workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., health_model_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[ManagedIdentityAuthenticationSettingPropertiesArgs, ManagedIdentityAuthenticationSettingPropertiesArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
