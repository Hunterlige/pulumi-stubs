...
class PipelineGroupArgs:
    def __init__(
        ...
        *,
        ...
        pipeline_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[pulumi.Input[PipelineGroupPropertiesArgs]] = ...,
    ...
    def pipeline_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input[PipelineGroupPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[PipelineGroupPropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class PipelineGroup(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[PipelineGroupPropertiesArgs, PipelineGroupPropertiesArgsDict]
            ]
        ] = ...,
