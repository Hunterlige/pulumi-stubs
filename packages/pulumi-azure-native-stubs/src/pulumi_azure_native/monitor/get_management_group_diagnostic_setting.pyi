...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetManagementGroupDiagnosticSettingResult', 'AwaitableGetManagementGroupDiagnosticSettingResult', 'get_management_group_diagnostic_setting', 'get_management_group_diagnostic_setting_output']
@pulumi.output_type
...
class AwaitableGetManagementGroupDiagnosticSettingResult(GetManagementGroupDiagnosticSettingResult):
    def __await__(self): # -> Generator[Never, Any, GetManagementGroupDiagnosticSettingResult]:
        ...
    


def get_management_group_diagnostic_setting(management_group_id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetManagementGroupDiagnosticSettingResult:
    
    ...

def get_management_group_diagnostic_setting_output(management_group_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetManagementGroupDiagnosticSettingResult]:
