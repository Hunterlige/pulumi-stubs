...
class SubscriptionDiagnosticSettingArgs:
    def __init__(
        ...
        *,
        ...
        logs: Optional[
            pulumi.Input[Sequence[pulumi.Input[SubscriptionLogSettingsArgs]]]
        ] = ...,
...
class SubscriptionDiagnosticSetting(pulumi.CustomResource):
        ...
        logs: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[
                            SubscriptionLogSettingsArgs, SubscriptionLogSettingsArgsDict
                        ]
                    ]
                ]
            ]
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[SubscriptionDiagnosticSettingArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
    ...
    def logs(
        self,
    ) -> pulumi.Output[Optional[Sequence[outputs.SubscriptionLogSettingsResponse]]]: ...
    @_builtins.property
    @pulumi.getter(name="marketplacePartnerId")
