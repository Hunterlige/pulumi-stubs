...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *, private_link_service_connection_state: pulumi.Input[PrivateLinkServiceConnectionStateArgs], resource_group_name: pulumi.Input[_builtins.str], scope_name: pulumi.Input[_builtins.str], private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.type_token("azure-native:monitor:PrivateEndpointConnection")
class PrivateEndpointConnection(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., private_link_service_connection_state: Optional[pulumi.Input[Union[PrivateLinkServiceConnectionStateArgs, PrivateLinkServiceConnectionStateArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., scope_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
