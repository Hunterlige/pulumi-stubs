...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetActionGroupResult', 'AwaitableGetActionGroupResult', 'get_action_group', 'get_action_group_output']
@pulumi.output_type
class GetActionGroupResult:
    
    def __init__(__self__, arm_role_receivers=..., automation_runbook_receivers=..., azure_api_version=..., azure_app_push_receivers=..., azure_function_receivers=..., email_receivers=..., enabled=..., event_hub_receivers=..., group_short_name=..., id=..., identity=..., incident_receivers=..., itsm_receivers=..., location=..., logic_app_receivers=..., name=..., sms_receivers=..., tags=..., type=..., voice_receivers=..., webhook_receivers=...) -> None:
        ...
...
class AwaitableGetActionGroupResult(GetActionGroupResult):
    def __await__(self): # -> Generator[Never, Any, GetActionGroupResult]:
        ...
    


def get_action_group(action_group_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetActionGroupResult:
    
    ...

def get_action_group_output(action_group_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetActionGroupResult]:
