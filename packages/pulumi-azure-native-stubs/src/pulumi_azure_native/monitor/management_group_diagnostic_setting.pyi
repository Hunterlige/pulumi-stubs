...
class ManagementGroupDiagnosticSettingArgs:
    def __init__(__self__, *, management_group_id: pulumi.Input[_builtins.str], event_hub_authorization_rule_id: Optional[pulumi.Input[_builtins.str]] = ..., event_hub_name: Optional[pulumi.Input[_builtins.str]] = ..., logs: Optional[pulumi.Input[Sequence[pulumi.Input[ManagementGroupLogSettingsArgs]]]] = ..., marketplace_partner_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., service_bus_rule_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_id: Optional[pulumi.Input[_builtins.str]] = ..., workspace_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @logs.setter
    def logs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ManagementGroupLogSettingsArgs]]]]): # -> None:
        ...
...
class ManagementGroupDiagnosticSetting(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., event_hub_authorization_rule_id: Optional[pulumi.Input[_builtins.str]] = ..., event_hub_name: Optional[pulumi.Input[_builtins.str]] = ..., logs: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ManagementGroupLogSettingsArgs, ManagementGroupLogSettingsArgsDict]]]]] = ..., management_group_id: Optional[pulumi.Input[_builtins.str]] = ..., marketplace_partner_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., service_bus_rule_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_id: Optional[pulumi.Input[_builtins.str]] = ..., workspace_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ManagementGroupDiagnosticSettingArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ManagementGroupDiagnosticSetting:
