...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessModeSettingsExclusionResponse', 'AccessModeSettingsResponse', 'ActionGroupResponse', 'ActionListResponse', 'ActionsResponse', 'AlertConfigurationResponse', 'AlertRuleAllOfConditionResponse', 'AlertRuleAnyOfOrLeafConditionResponse', 'AlertRuleLeafConditionResponse', ..., 'ArmRoleReceiverResponse', 'AutomationRunbookReceiverResponse', 'AutoscaleNotificationResponse', 'AutoscaleProfileResponse', 'AutoscaleSettingResponse', 'AzureAppPushReceiverResponse', 'AzureFunctionReceiverResponse', 'AzureMonitorWorkspaceLogsApiConfigResponse', 'AzureMonitorWorkspaceLogsExporterResponse', ..., 'AzureMonitorWorkspaceResponseMetrics', 'AzureMonitorWorkspaceSignalGroupResponse', ..., 'AzureResourceSignalGroupResponse', 'BatchProcessorResponse', 'CacheConfigurationResponse', 'ColumnDefinitionResponse', 'ConcurrencyConfigurationResponse', 'ConditionResponse', 'ConditionResponseFailingPeriods', 'DataCollectionEndpointResourceResponseIdentity', 'DataCollectionEndpointResourceResponseSystemData', 'DataCollectionEndpointResponseConfigurationAccess', ..., 'DataCollectionEndpointResponseLogsIngestion', 'DataCollectionEndpointResponseMetadata', 'DataCollectionEndpointResponseMetricsIngestion', 'DataCollectionEndpointResponseNetworkAcls', ..., 'DataCollectionRuleAssociationResponseMetadata', 'DataCollectionRuleResourceResponseIdentity', 'DataCollectionRuleResourceResponseSystemData', 'DataCollectionRuleResponseDataSources', 'DataCollectionRuleResponseDestinations', 'DataCollectionRuleResponseMetadata', 'DataFlowResponse', 'DataImportSourcesResponseEventHub', 'DataSourcesSpecResponseDataImports', 'DependenciesSignalGroupResponse', 'DestinationsSpecResponseAzureMonitorMetrics', 'DiagnosticSettingsCategoryResourceResponse', 'DimensionResponse', 'DiscoveryErrorResponse', 'DynamicDetectionRuleResponse', 'DynamicMetricCriteriaResponse', 'DynamicThresholdFailingPeriodsResponse', 'EmailNotificationResponse', 'EmailReceiverResponse', 'EntityAlertsResponse', 'EntityCoordinatesResponse', 'EntityPropertiesResponse', 'EvaluationRuleResponse', 'EventHubDestinationResponse', 'EventHubDirectDestinationResponse', 'EventHubReceiverResponse', 'ExporterResponse', 'ExtensionDataSourceResponse', 'HealthModelPropertiesResponse', 'IconDefinitionResponse', 'IdentityResponse', 'IisLogsDataSourceResponse', 'IncidentReceiverResponse', 'IncidentServiceConnectionResponse', 'InvestigationExecutionResponse', 'InvestigationMetadataResponse', 'InvestigationScopeResponse', 'IssuePropertiesResponse', 'ItsmReceiverResponse', 'JsonArrayMapperResponse', 'JsonMapperDestinationFieldResponse', 'JsonMapperSourceFieldResponse', 'LocationSpecResponse', 'LogAnalyticsDestinationResponse', ..., 'LogAnalyticsSignalGroupResponse', 'LogFileSettingsResponseText', 'LogFilesDataSourceResponse', 'LogFilesDataSourceResponseSettings', 'LogSettingsResponse', 'LogicAppReceiverResponse', ..., 'ManagedServiceIdentityResponse', 'ManagementGroupLogSettingsResponse', 'MetricAlertActionResponse', ..., ..., 'MetricCriteriaResponse', 'MetricDimensionResponse', 'MetricSettingsResponse', 'MetricTriggerResponse', 'ModelDiscoverySettingsResponse', 'MonitoringAccountDestinationResponse', 'NetworkingConfigurationResponse', 'NetworkingRouteResponse', 'OriginResponse', 'OtlpReceiverResponse', 'PerfCounterDataSourceResponse', 'PersistenceConfigurationsResponse', 'PipelineGroupPropertiesResponse', 'PipelineResponse', 'PlatformTelemetryDataSourceResponse', 'PredictiveAutoscalePolicyResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointConnectionResponseV1', 'PrivateEndpointResponse', 'PrivateLinkScopedResourceResponse', 'PrivateLinkServiceConnectionStateResponse', 'ProcessorResponse', 'PrometheusForwarderDataSourceResponse', ..., 'ReceiverResponse', 'RecordMapResponse', 'RecurrenceResponse', 'RecurrentScheduleResponse', 'RelatedAlertResponse', 'RelatedResourceResponse', 'RelationshipPropertiesResponse', 'ResourceGraphQueryDiscoveryRulePropertiesResponse', 'ResourceMapResponse', 'ResourceMetricSignalDefinitionPropertiesResponse', 'RetentionPolicyResponse', 'RuleResolveConfigurationResponse', 'RunParametersResponse', 'ScaleActionResponse', 'ScaleCapacityResponse', 'ScaleRuleMetricDimensionResponse', 'ScaleRuleResponse', 'ScheduledQueryRuleCriteriaResponse', 'SchemaMapResponse', 'ScopeMapResponse', 'ServiceResponse', 'SignalAssignmentResponse', 'SignalGroupResponse', 'SmsReceiverResponse', 'StorageBlobDestinationResponse', 'StorageTableDestinationResponse', 'StreamDeclarationResponse', 'SubscriptionLogSettingsResponse', 'SyslogDataSourceResponse', 'SyslogReceiverResponse', 'SystemDataResponse', 'TcpExporterResponse', 'ThresholdRuleResponse', 'TimeWindowResponse', 'UdpReceiverResponse', 'UserAssignedIdentityResponse', 'UserIdentityPropertiesResponse', 'VoiceReceiverResponse', 'WebhookNotificationResponse', 'WebhookReceiverResponse', 'WebhookReceiverResponseV1', 'WebtestLocationAvailabilityCriteriaResponse', 'WindowsEventLogDataSourceResponse', 'WindowsFirewallLogsDataSourceResponse']
@pulumi.output_type
class AccessModeSettingsExclusionResponse(dict):
    ...
    def __init__(__self__, *, ingestion_access_mode: Optional[_builtins.str] = ..., private_endpoint_connection_name: Optional[_builtins.str] = ..., query_access_mode: Optional[_builtins.str] = ...) -> None:
...
class AccessModeSettingsResponse(dict):
    ...
    def __init__(__self__, *, ingestion_access_mode: _builtins.str, query_access_mode: _builtins.str, exclusions: Optional[Sequence[outputs.AccessModeSettingsExclusionResponse]] = ...) -> None:
...
class ActionGroupResponse(dict):
    ...
    def __init__(__self__, *, action_group_id: _builtins.str, webhook_properties: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ActionListResponse(dict):
    ...
    def __init__(__self__, *, action_groups: Optional[Sequence[outputs.ActionGroupResponse]] = ...) -> None:
...
class ActionsResponse(dict):
    ...
    def __init__(__self__, *, action_groups: Optional[Sequence[_builtins.str]] = ..., action_properties: Optional[Mapping[str, _builtins.str]] = ..., custom_properties: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class AlertConfigurationResponse(dict):
    ...
    def __init__(__self__, *, severity: _builtins.str, action_group_ids: Optional[Sequence[_builtins.str]] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class AlertRuleAllOfConditionResponse(dict):
    ...
    def __init__(__self__, *, all_of: Sequence[outputs.AlertRuleAnyOfOrLeafConditionResponse]) -> None:
...
class AlertRuleAnyOfOrLeafConditionResponse(dict):
    ...
    def __init__(__self__, *, any_of: Optional[Sequence[outputs.AlertRuleLeafConditionResponse]] = ..., contains_any: Optional[Sequence[_builtins.str]] = ..., equals: Optional[_builtins.str] = ..., field: Optional[_builtins.str] = ...) -> None:
...
class AlertRuleLeafConditionResponse(dict):
    ...
    def __init__(__self__, *, contains_any: Optional[Sequence[_builtins.str]] = ..., equals: Optional[_builtins.str] = ..., field: Optional[_builtins.str] = ...) -> None:
...
class ApplicationInsightsTopologyDiscoveryRulePropertiesResponse(dict):
    ...
    def __init__(__self__, *, add_recommended_signals: _builtins.str, application_insights_resource_id: _builtins.str, authentication_setting: _builtins.str, deletion_date: _builtins.str, discover_relationships: _builtins.str, discovery_rule_kind: _builtins.str, entity_name: _builtins.str, error: outputs.DiscoveryErrorResponse, provisioning_state: _builtins.str, display_name: Optional[_builtins.str] = ...) -> None:
...
class ArmRoleReceiverResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, role_id: _builtins.str, use_common_alert_schema: Optional[_builtins.bool] = ...) -> None:
...
class AutomationRunbookReceiverResponse(dict):
    ...
    def __init__(__self__, *, automation_account_id: _builtins.str, is_global_runbook: _builtins.bool, runbook_name: _builtins.str, webhook_resource_id: _builtins.str, managed_identity: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., service_uri: Optional[_builtins.str] = ..., use_common_alert_schema: Optional[_builtins.bool] = ...) -> None:
...
class AutoscaleNotificationResponse(dict):
    ...
    def __init__(__self__, *, operation: _builtins.str, email: Optional[outputs.EmailNotificationResponse] = ..., webhooks: Optional[Sequence[outputs.WebhookNotificationResponse]] = ...) -> None:
...
class AutoscaleProfileResponse(dict):
    ...
    def __init__(__self__, *, capacity: outputs.ScaleCapacityResponse, name: _builtins.str, rules: Sequence[outputs.ScaleRuleResponse], fixed_date: Optional[outputs.TimeWindowResponse] = ..., recurrence: Optional[outputs.RecurrenceResponse] = ...) -> None:
...
class AutoscaleSettingResponse(dict):
    ...
    def __init__(__self__, *, profiles: Sequence[outputs.AutoscaleProfileResponse], enabled: Optional[_builtins.bool] = ..., name: Optional[_builtins.str] = ..., notifications: Optional[Sequence[outputs.AutoscaleNotificationResponse]] = ..., predictive_autoscale_policy: Optional[outputs.PredictiveAutoscalePolicyResponse] = ..., target_resource_location: Optional[_builtins.str] = ..., target_resource_uri: Optional[_builtins.str] = ...) -> None:
...
class AzureAppPushReceiverResponse(dict):
    ...
    def __init__(__self__, *, email_address: _builtins.str, name: _builtins.str) -> None:
...
class AzureFunctionReceiverResponse(dict):
    ...
    def __init__(__self__, *, function_app_resource_id: _builtins.str, function_name: _builtins.str, http_trigger_url: _builtins.str, name: _builtins.str, managed_identity: Optional[_builtins.str] = ..., use_common_alert_schema: Optional[_builtins.bool] = ...) -> None:
...
class AzureMonitorWorkspaceLogsApiConfigResponse(dict):
    ...
    def __init__(__self__, *, data_collection_endpoint_url: _builtins.str, data_collection_rule: _builtins.str, schema: outputs.SchemaMapResponse, stream: _builtins.str) -> None:
...
class AzureMonitorWorkspaceLogsExporterResponse(dict):
    ...
    def __init__(__self__, *, api: outputs.AzureMonitorWorkspaceLogsApiConfigResponse, cache: Optional[outputs.CacheConfigurationResponse] = ..., concurrency: Optional[outputs.ConcurrencyConfigurationResponse] = ...) -> None:
...
class AzureMonitorWorkspaceResponseDefaultIngestionSettings(dict):
    ...
    def __init__(__self__, *, data_collection_endpoint_resource_id: _builtins.str, data_collection_rule_resource_id: _builtins.str) -> None:
...
class AzureMonitorWorkspaceResponseMetrics(dict):
    ...
    def __init__(__self__, *, internal_id: _builtins.str, prometheus_query_endpoint: _builtins.str) -> None:
...
class AzureMonitorWorkspaceSignalGroupResponse(dict):
    ...
    def __init__(__self__, *, authentication_setting: _builtins.str, azure_monitor_workspace_resource_id: _builtins.str, signal_assignments: Optional[Sequence[outputs.SignalAssignmentResponse]] = ...) -> None:
...
class AzureResourceSignalGroupResponse(dict):
    ...
    def __init__(__self__, *, authentication_setting: _builtins.str, azure_resource_id: _builtins.str, signal_assignments: Optional[Sequence[outputs.SignalAssignmentResponse]] = ...) -> None:
...
class BatchProcessorResponse(dict):
    ...
    def __init__(__self__, *, batch_size: Optional[_builtins.int] = ..., timeout: Optional[_builtins.int] = ...) -> None:
...
class CacheConfigurationResponse(dict):
    ...
    def __init__(__self__, *, max_storage_usage: Optional[_builtins.int] = ..., retention_period: Optional[_builtins.int] = ...) -> None:
...
class ConcurrencyConfigurationResponse(dict):
    ...
    def __init__(__self__, *, batch_queue_size: Optional[_builtins.int] = ..., worker_count: Optional[_builtins.int] = ...) -> None:
...
class ConditionResponse(dict):
    ...
    def __init__(__self__, *, alert_sensitivity: Optional[_builtins.str] = ..., criterion_type: Optional[_builtins.str] = ..., dimensions: Optional[Sequence[outputs.DimensionResponse]] = ..., failing_periods: Optional[outputs.ConditionResponseFailingPeriods] = ..., ignore_data_before: Optional[_builtins.str] = ..., metric_measure_column: Optional[_builtins.str] = ..., metric_name: Optional[_builtins.str] = ..., min_recurrence_count: Optional[_builtins.float] = ..., operator: Optional[_builtins.str] = ..., query: Optional[_builtins.str] = ..., resource_id_column: Optional[_builtins.str] = ..., threshold: Optional[_builtins.float] = ..., time_aggregation: Optional[_builtins.str] = ...) -> None:
...
class ConditionResponseFailingPeriods(dict):
    ...
    def __init__(__self__, *, min_failing_periods_to_alert: Optional[_builtins.float] = ..., number_of_evaluation_periods: Optional[_builtins.float] = ...) -> None:
...
class DataCollectionEndpointResponseFailoverConfiguration(dict):
    ...
    def __init__(__self__, *, active_location: Optional[_builtins.str] = ..., locations: Optional[Sequence[outputs.LocationSpecResponse]] = ...) -> None:
...
class DataCollectionEndpointResponseMetadata(dict):
    ...
    def __init__(__self__, *, provisioned_by: _builtins.str, provisioned_by_resource_id: _builtins.str) -> None:
...
class DataCollectionEndpointResponseNetworkAcls(dict):
    ...
    def __init__(__self__, *, public_network_access: Optional[_builtins.str] = ...) -> None:
...
class DataCollectionRuleResponseDataSources(dict):
    ...
    def __init__(__self__, *, data_imports: Optional[outputs.DataSourcesSpecResponseDataImports] = ..., extensions: Optional[Sequence[outputs.ExtensionDataSourceResponse]] = ..., iis_logs: Optional[Sequence[outputs.IisLogsDataSourceResponse]] = ..., log_files: Optional[Sequence[outputs.LogFilesDataSourceResponse]] = ..., performance_counters: Optional[Sequence[outputs.PerfCounterDataSourceResponse]] = ..., platform_telemetry: Optional[Sequence[outputs.PlatformTelemetryDataSourceResponse]] = ..., prometheus_forwarder: Optional[Sequence[outputs.PrometheusForwarderDataSourceResponse]] = ..., syslog: Optional[Sequence[outputs.SyslogDataSourceResponse]] = ..., windows_event_logs: Optional[Sequence[outputs.WindowsEventLogDataSourceResponse]] = ..., windows_firewall_logs: Optional[Sequence[outputs.WindowsFirewallLogsDataSourceResponse]] = ...) -> None:
...
class DataCollectionRuleResponseDestinations(dict):
    ...
    def __init__(__self__, *, azure_monitor_metrics: Optional[outputs.DestinationsSpecResponseAzureMonitorMetrics] = ..., event_hubs: Optional[Sequence[outputs.EventHubDestinationResponse]] = ..., event_hubs_direct: Optional[Sequence[outputs.EventHubDirectDestinationResponse]] = ..., log_analytics: Optional[Sequence[outputs.LogAnalyticsDestinationResponse]] = ..., monitoring_accounts: Optional[Sequence[outputs.MonitoringAccountDestinationResponse]] = ..., storage_accounts: Optional[Sequence[outputs.StorageBlobDestinationResponse]] = ..., storage_blobs_direct: Optional[Sequence[outputs.StorageBlobDestinationResponse]] = ..., storage_tables_direct: Optional[Sequence[outputs.StorageTableDestinationResponse]] = ...) -> None:
...
class DataFlowResponse(dict):
    ...
    def __init__(__self__, *, built_in_transform: Optional[_builtins.str] = ..., destinations: Optional[Sequence[_builtins.str]] = ..., output_stream: Optional[_builtins.str] = ..., streams: Optional[Sequence[_builtins.str]] = ..., transform_kql: Optional[_builtins.str] = ...) -> None:
...
class DataImportSourcesResponseEventHub(dict):
    ...
    def __init__(__self__, *, consumer_group: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., stream: Optional[_builtins.str] = ...) -> None:
...
class DataSourcesSpecResponseDataImports(dict):
    ...
    def __init__(__self__, *, event_hub: Optional[outputs.DataImportSourcesResponseEventHub] = ...) -> None:
...
class DependenciesSignalGroupResponse(dict):
    ...
    def __init__(__self__, *, aggregation_type: Optional[_builtins.str] = ..., degraded_threshold: Optional[_builtins.str] = ..., unhealthy_threshold: Optional[_builtins.str] = ...) -> None:
...
class DiagnosticSettingsCategoryResourceResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str, category_groups: Optional[Sequence[_builtins.str]] = ..., category_type: Optional[_builtins.str] = ...) -> None:
...
class DiscoveryErrorResponse(dict):
    ...
    def __init__(__self__, *, context: Sequence[_builtins.str], message: _builtins.str) -> None:
...
class DynamicDetectionRuleResponse(dict):
    ...
    def __init__(__self__, *, dynamic_threshold_direction: _builtins.str, dynamic_threshold_model: _builtins.str, model_sensitivity: _builtins.float, training_start_time: Optional[_builtins.str] = ...) -> None:
...
class DynamicMetricCriteriaResponse(dict):
    ...
    def __init__(__self__, *, alert_sensitivity: _builtins.str, criterion_type: _builtins.str, failing_periods: outputs.DynamicThresholdFailingPeriodsResponse, metric_name: _builtins.str, name: _builtins.str, operator: _builtins.str, time_aggregation: _builtins.str, dimensions: Optional[Sequence[outputs.MetricDimensionResponse]] = ..., ignore_data_before: Optional[_builtins.str] = ..., metric_namespace: Optional[_builtins.str] = ..., skip_metric_validation: Optional[_builtins.bool] = ...) -> None:
...
class DynamicThresholdFailingPeriodsResponse(dict):
    ...
    def __init__(__self__, *, min_failing_periods_to_alert: _builtins.float, number_of_evaluation_periods: _builtins.float) -> None:
...
class EmailNotificationResponse(dict):
    ...
    def __init__(__self__, *, custom_emails: Optional[Sequence[_builtins.str]] = ..., send_to_subscription_administrator: Optional[_builtins.bool] = ..., send_to_subscription_co_administrators: Optional[_builtins.bool] = ...) -> None:
...
class EmailReceiverResponse(dict):
    ...
    def __init__(__self__, *, email_address: _builtins.str, name: _builtins.str, status: _builtins.str, use_common_alert_schema: Optional[_builtins.bool] = ...) -> None:
...
class EntityAlertsResponse(dict):
    ...
    def __init__(__self__, *, degraded: Optional[outputs.AlertConfigurationResponse] = ..., unhealthy: Optional[outputs.AlertConfigurationResponse] = ...) -> None:
...
class EntityPropertiesResponse(dict):
    ...
    def __init__(__self__, *, deletion_date: _builtins.str, discovered_by: _builtins.str, health_state: _builtins.str, provisioning_state: _builtins.str, alerts: Optional[outputs.EntityAlertsResponse] = ..., canvas_position: Optional[outputs.EntityCoordinatesResponse] = ..., display_name: Optional[_builtins.str] = ..., health_objective: Optional[_builtins.float] = ..., icon: Optional[outputs.IconDefinitionResponse] = ..., impact: Optional[_builtins.str] = ..., kind: Optional[_builtins.str] = ..., signals: Optional[outputs.SignalGroupResponse] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class EvaluationRuleResponse(dict):
    ...
    def __init__(__self__, *, degraded_rule: Optional[outputs.ThresholdRuleResponse] = ..., dynamic_detection_rule: Optional[outputs.DynamicDetectionRuleResponse] = ..., unhealthy_rule: Optional[outputs.ThresholdRuleResponse] = ...) -> None:
...
class EventHubDestinationResponse(dict):
    ...
    def __init__(__self__, *, event_hub_resource_id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class EventHubReceiverResponse(dict):
    ...
    def __init__(__self__, *, event_hub_name: _builtins.str, event_hub_name_space: _builtins.str, name: _builtins.str, subscription_id: _builtins.str, managed_identity: Optional[_builtins.str] = ..., tenant_id: Optional[_builtins.str] = ..., use_common_alert_schema: Optional[_builtins.bool] = ...) -> None:
...
class ExporterResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, type: _builtins.str, azure_monitor_workspace_logs: Optional[outputs.AzureMonitorWorkspaceLogsExporterResponse] = ..., tcp: Optional[outputs.TcpExporterResponse] = ...) -> None:
...
class ExtensionDataSourceResponse(dict):
    ...
    def __init__(__self__, *, extension_name: _builtins.str, extension_settings: Optional[Any] = ..., input_data_sources: Optional[Sequence[_builtins.str]] = ..., name: Optional[_builtins.str] = ..., streams: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class HealthModelPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, query_endpoint: _builtins.str, discovery: Optional[outputs.ModelDiscoverySettingsResponse] = ...) -> None:
...
class IconDefinitionResponse(dict):
    ...
    def __init__(__self__, *, icon_name: _builtins.str, custom_data: Optional[_builtins.str] = ...) -> None:
...
class IisLogsDataSourceResponse(dict):
    ...
    def __init__(__self__, *, streams: Sequence[_builtins.str], log_directories: Optional[Sequence[_builtins.str]] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class IncidentReceiverResponse(dict):
    ...
    def __init__(__self__, *, connection: outputs.IncidentServiceConnectionResponse, incident_management_service: _builtins.str, mappings: Mapping[str, _builtins.str], name: _builtins.str) -> None:
...
class InvestigationExecutionResponse(dict):
    ...
    def __init__(__self__, *, run_state: _builtins.str, completed_at: Optional[_builtins.str] = ...) -> None:
...
class InvestigationMetadataResponse(dict):
    ...
    def __init__(__self__, *, created_at: _builtins.str, execution: outputs.InvestigationExecutionResponse, id: _builtins.str, run_parameters: outputs.RunParametersResponse) -> None:
...
class InvestigationScopeResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, origin: outputs.OriginResponse, relevance: Optional[_builtins.str] = ...) -> None:
...
class IssuePropertiesResponse(dict):
    ...
    def __init__(__self__, *, impact_time: _builtins.str, investigations: Sequence[outputs.InvestigationMetadataResponse], investigations_count: _builtins.int, provisioning_state: _builtins.str, severity: _builtins.str, status: _builtins.str, title: _builtins.str) -> None:
...
class ItsmReceiverResponse(dict):
    ...
    def __init__(__self__, *, connection_id: _builtins.str, name: _builtins.str, region: _builtins.str, ticket_configuration: _builtins.str, workspace_id: _builtins.str) -> None:
...
class JsonArrayMapperResponse(dict):
    ...
    def __init__(__self__, *, keys: Sequence[_builtins.str], destination_field: Optional[outputs.JsonMapperDestinationFieldResponse] = ..., source_field: Optional[outputs.JsonMapperSourceFieldResponse] = ...) -> None:
...
class JsonMapperDestinationFieldResponse(dict):
    ...
    def __init__(__self__, *, destination: Optional[_builtins.str] = ..., field_name: Optional[_builtins.str] = ...) -> None:
...
class LocationSpecResponse(dict):
    ...
    def __init__(__self__, *, location: Optional[_builtins.str] = ..., provisioning_status: Optional[_builtins.str] = ...) -> None:
...
class LogAnalyticsDestinationResponse(dict):
    ...
    def __init__(__self__, *, workspace_id: _builtins.str, name: Optional[_builtins.str] = ..., workspace_resource_id: Optional[_builtins.str] = ...) -> None:
...
class LogAnalyticsQuerySignalDefinitionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, deletion_date: _builtins.str, evaluation_rules: outputs.EvaluationRuleResponse, provisioning_state: _builtins.str, query_text: _builtins.str, signal_kind: _builtins.str, data_unit: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., refresh_interval: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., time_grain: Optional[_builtins.str] = ..., value_column_name: Optional[_builtins.str] = ...) -> None:
...
class LogAnalyticsSignalGroupResponse(dict):
    ...
    def __init__(__self__, *, authentication_setting: _builtins.str, log_analytics_workspace_resource_id: _builtins.str, signal_assignments: Optional[Sequence[outputs.SignalAssignmentResponse]] = ...) -> None:
...
class LogFilesDataSourceResponse(dict):
    ...
    def __init__(__self__, *, file_patterns: Sequence[_builtins.str], format: _builtins.str, streams: Sequence[_builtins.str], name: Optional[_builtins.str] = ..., settings: Optional[outputs.LogFilesDataSourceResponseSettings] = ...) -> None:
...
class LogFilesDataSourceResponseSettings(dict):
    ...
    def __init__(__self__, *, text: Optional[outputs.LogFileSettingsResponseText] = ...) -> None:
...
class LogSettingsResponse(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, category: Optional[_builtins.str] = ..., category_group: Optional[_builtins.str] = ..., retention_policy: Optional[outputs.RetentionPolicyResponse] = ...) -> None:
...
class LogicAppReceiverResponse(dict):
    ...
    def __init__(__self__, *, callback_url: _builtins.str, name: _builtins.str, resource_id: _builtins.str, managed_identity: Optional[_builtins.str] = ..., use_common_alert_schema: Optional[_builtins.bool] = ...) -> None:
...
class ManagedIdentityAuthenticationSettingPropertiesResponse(dict):
    ...
    def __init__(__self__, *, authentication_kind: _builtins.str, managed_identity_name: _builtins.str, provisioning_state: _builtins.str, display_name: Optional[_builtins.str] = ...) -> None:
...
class ManagementGroupLogSettingsResponse(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, category: Optional[_builtins.str] = ..., category_group: Optional[_builtins.str] = ...) -> None:
...
class MetricAlertActionResponse(dict):
    ...
    def __init__(__self__, *, action_group_id: Optional[_builtins.str] = ..., web_hook_properties: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class MetricAlertMultipleResourceMultipleMetricCriteriaResponse(dict):
    ...
    def __init__(__self__, *, odata_type: _builtins.str, all_of: Optional[Sequence[Any]] = ...) -> None:
...
class MetricAlertSingleResourceMultipleMetricCriteriaResponse(dict):
    ...
    def __init__(__self__, *, odata_type: _builtins.str, all_of: Optional[Sequence[outputs.MetricCriteriaResponse]] = ...) -> None:
...
class MetricCriteriaResponse(dict):
    ...
    def __init__(__self__, *, criterion_type: _builtins.str, metric_name: _builtins.str, name: _builtins.str, operator: _builtins.str, threshold: _builtins.float, time_aggregation: _builtins.str, dimensions: Optional[Sequence[outputs.MetricDimensionResponse]] = ..., metric_namespace: Optional[_builtins.str] = ..., skip_metric_validation: Optional[_builtins.bool] = ...) -> None:
...
class MetricSettingsResponse(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, category: Optional[_builtins.str] = ..., retention_policy: Optional[outputs.RetentionPolicyResponse] = ..., time_grain: Optional[_builtins.str] = ...) -> None:
...
class MetricTriggerResponse(dict):
    ...
    def __init__(__self__, *, metric_name: _builtins.str, metric_resource_uri: _builtins.str, operator: _builtins.str, statistic: _builtins.str, threshold: _builtins.float, time_aggregation: _builtins.str, time_grain: _builtins.str, time_window: _builtins.str, dimensions: Optional[Sequence[outputs.ScaleRuleMetricDimensionResponse]] = ..., divide_per_instance: Optional[_builtins.bool] = ..., metric_namespace: Optional[_builtins.str] = ..., metric_resource_location: Optional[_builtins.str] = ...) -> None:
...
class ModelDiscoverySettingsResponse(dict):
    ...
    def __init__(__self__, *, add_recommended_signals: _builtins.str, scope: _builtins.str, identity: Optional[_builtins.str] = ...) -> None:
...
class MonitoringAccountDestinationResponse(dict):
    ...
    def __init__(__self__, *, account_id: _builtins.str, account_resource_id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class NetworkingConfigurationResponse(dict):
    ...
    def __init__(__self__, *, external_networking_mode: _builtins.str, routes: Sequence[outputs.NetworkingRouteResponse], host: Optional[_builtins.str] = ...) -> None:
...
class NetworkingRouteResponse(dict):
    ...
    def __init__(__self__, *, receiver: _builtins.str, path: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., subdomain: Optional[_builtins.str] = ...) -> None:
...
class OriginResponse(dict):
    ...
    def __init__(__self__, *, added_by: _builtins.str, added_by_type: _builtins.str) -> None:
...
class PerfCounterDataSourceResponse(dict):
    ...
    def __init__(__self__, *, counter_specifiers: Optional[Sequence[_builtins.str]] = ..., name: Optional[_builtins.str] = ..., sampling_frequency_in_seconds: Optional[_builtins.int] = ..., streams: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class PipelineGroupPropertiesResponse(dict):
    ...
    def __init__(__self__, *, exporters: Sequence[outputs.ExporterResponse], processors: Sequence[outputs.ProcessorResponse], provisioning_state: _builtins.str, receivers: Sequence[outputs.ReceiverResponse], service: outputs.ServiceResponse, networking_configurations: Optional[Sequence[outputs.NetworkingConfigurationResponse]] = ..., replicas: Optional[_builtins.int] = ...) -> None:
...
class PipelineResponse(dict):
    ...
    def __init__(__self__, *, exporters: Sequence[_builtins.str], name: _builtins.str, receivers: Sequence[_builtins.str], type: _builtins.str, processors: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class PlatformTelemetryDataSourceResponse(dict):
    ...
    def __init__(__self__, *, streams: Sequence[_builtins.str], name: Optional[_builtins.str] = ...) -> None:
...
class PredictiveAutoscalePolicyResponse(dict):
    ...
    def __init__(__self__, *, scale_mode: _builtins.str, scale_look_ahead_time: Optional[_builtins.str] = ...) -> None:
...
class ProcessorResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, type: _builtins.str, batch: Optional[outputs.BatchProcessorResponse] = ...) -> None:
...
class PrometheusForwarderDataSourceResponse(dict):
    ...
    def __init__(__self__, *, label_include_filter: Optional[Mapping[str, _builtins.str]] = ..., name: Optional[_builtins.str] = ..., streams: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class PrometheusMetricsSignalDefinitionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, deletion_date: _builtins.str, evaluation_rules: outputs.EvaluationRuleResponse, provisioning_state: _builtins.str, query_text: _builtins.str, signal_kind: _builtins.str, data_unit: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., refresh_interval: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., time_grain: Optional[_builtins.str] = ...) -> None:
...
class ReceiverResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, type: _builtins.str, otlp: Optional[outputs.OtlpReceiverResponse] = ..., syslog: Optional[outputs.SyslogReceiverResponse] = ..., udp: Optional[outputs.UdpReceiverResponse] = ...) -> None:
...
class RecurrenceResponse(dict):
    ...
    def __init__(__self__, *, frequency: _builtins.str, schedule: outputs.RecurrentScheduleResponse) -> None:
...
class RecurrentScheduleResponse(dict):
    ...
    def __init__(__self__, *, days: Sequence[_builtins.str], hours: Sequence[_builtins.int], minutes: Sequence[_builtins.int], time_zone: _builtins.str) -> None:
...
class RelatedAlertResponse(dict):
    ...
    def __init__(__self__, *, added_at: _builtins.str, id: _builtins.str, last_modified_at: _builtins.str, origin: outputs.OriginResponse, relevance: _builtins.str) -> None:
...
class RelationshipPropertiesResponse(dict):
    ...
    def __init__(__self__, *, child_entity_name: _builtins.str, deletion_date: _builtins.str, discovered_by: _builtins.str, parent_entity_name: _builtins.str, provisioning_state: _builtins.str, display_name: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ResourceGraphQueryDiscoveryRulePropertiesResponse(dict):
    ...
    def __init__(__self__, *, add_recommended_signals: _builtins.str, authentication_setting: _builtins.str, deletion_date: _builtins.str, discover_relationships: _builtins.str, discovery_rule_kind: _builtins.str, entity_name: _builtins.str, error: outputs.DiscoveryErrorResponse, provisioning_state: _builtins.str, resource_graph_query: _builtins.str, display_name: Optional[_builtins.str] = ...) -> None:
...
class ResourceMetricSignalDefinitionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, aggregation_type: _builtins.str, deletion_date: _builtins.str, evaluation_rules: outputs.EvaluationRuleResponse, metric_name: _builtins.str, metric_namespace: _builtins.str, provisioning_state: _builtins.str, signal_kind: _builtins.str, time_grain: _builtins.str, data_unit: Optional[_builtins.str] = ..., dimension: Optional[_builtins.str] = ..., dimension_filter: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., refresh_interval: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class RuleResolveConfigurationResponse(dict):
    ...
    def __init__(__self__, *, auto_resolved: Optional[_builtins.bool] = ..., time_to_resolve: Optional[_builtins.str] = ...) -> None:
...
class RunParametersResponse(dict):
    ...
    def __init__(__self__, *, alerts: Sequence[outputs.InvestigationScopeResponse], impact_time: _builtins.str, resources: Sequence[outputs.InvestigationScopeResponse]) -> None:
...
class ScaleActionResponse(dict):
    ...
    def __init__(__self__, *, cooldown: _builtins.str, direction: _builtins.str, type: _builtins.str, value: Optional[_builtins.str] = ...) -> None:
...
class ScaleCapacityResponse(dict):
    ...
    def __init__(__self__, *, default: _builtins.str, maximum: _builtins.str, minimum: _builtins.str) -> None:
...
class ScaleRuleMetricDimensionResponse(dict):
    ...
    def __init__(__self__, *, dimension_name: _builtins.str, operator: _builtins.str, values: Sequence[_builtins.str]) -> None:
...
class ScaleRuleResponse(dict):
    ...
    def __init__(__self__, *, metric_trigger: outputs.MetricTriggerResponse, scale_action: outputs.ScaleActionResponse) -> None:
...
class ScheduledQueryRuleCriteriaResponse(dict):
    ...
    def __init__(__self__, *, all_of: Optional[Sequence[outputs.ConditionResponse]] = ...) -> None:
...
class SchemaMapResponse(dict):
    ...
    def __init__(__self__, *, record_map: Sequence[outputs.RecordMapResponse], resource_map: Optional[Sequence[outputs.ResourceMapResponse]] = ..., scope_map: Optional[Sequence[outputs.ScopeMapResponse]] = ...) -> None:
...
class ServiceResponse(dict):
    ...
    def __init__(__self__, *, pipelines: Sequence[outputs.PipelineResponse], persistence: Optional[outputs.PersistenceConfigurationsResponse] = ...) -> None:
...
class SignalGroupResponse(dict):
    ...
    def __init__(__self__, *, azure_log_analytics: Optional[outputs.LogAnalyticsSignalGroupResponse] = ..., azure_monitor_workspace: Optional[outputs.AzureMonitorWorkspaceSignalGroupResponse] = ..., azure_resource: Optional[outputs.AzureResourceSignalGroupResponse] = ..., dependencies: Optional[outputs.DependenciesSignalGroupResponse] = ...) -> None:
...
class SmsReceiverResponse(dict):
    ...
    def __init__(__self__, *, country_code: _builtins.str, name: _builtins.str, phone_number: _builtins.str, status: _builtins.str) -> None:
...
class StorageBlobDestinationResponse(dict):
    ...
    def __init__(__self__, *, container_name: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., storage_account_resource_id: Optional[_builtins.str] = ...) -> None:
...
class StorageTableDestinationResponse(dict):
    ...
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., storage_account_resource_id: Optional[_builtins.str] = ..., table_name: Optional[_builtins.str] = ...) -> None:
...
class StreamDeclarationResponse(dict):
    ...
    def __init__(__self__, *, columns: Optional[Sequence[outputs.ColumnDefinitionResponse]] = ...) -> None:
...
class SyslogDataSourceResponse(dict):
    ...
    def __init__(__self__, *, facility_names: Optional[Sequence[_builtins.str]] = ..., log_levels: Optional[Sequence[_builtins.str]] = ..., name: Optional[_builtins.str] = ..., streams: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SyslogReceiverResponse(dict):
    ...
    def __init__(__self__, *, endpoint: _builtins.str, protocol: Optional[_builtins.str] = ...) -> None:
...
class ThresholdRuleResponse(dict):
    ...
    def __init__(__self__, *, operator: _builtins.str, threshold: _builtins.str) -> None:
...
class TimeWindowResponse(dict):
    ...
    def __init__(__self__, *, end: _builtins.str, start: _builtins.str, time_zone: Optional[_builtins.str] = ...) -> None:
...
class UdpReceiverResponse(dict):
    ...
    def __init__(__self__, *, endpoint: _builtins.str, encoding: Optional[_builtins.str] = ..., json_array_mapper: Optional[outputs.JsonArrayMapperResponse] = ..., read_queue_length: Optional[_builtins.int] = ...) -> None:
...
class VoiceReceiverResponse(dict):
    ...
    def __init__(__self__, *, country_code: _builtins.str, name: _builtins.str, phone_number: _builtins.str) -> None:
...
class WebhookNotificationResponse(dict):
    ...
    def __init__(__self__, *, properties: Optional[Mapping[str, _builtins.str]] = ..., service_uri: Optional[_builtins.str] = ...) -> None:
...
class WebhookReceiverResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, service_uri: _builtins.str, identifier_uri: Optional[_builtins.str] = ..., managed_identity: Optional[_builtins.str] = ..., object_id: Optional[_builtins.str] = ..., tenant_id: Optional[_builtins.str] = ..., use_aad_auth: Optional[_builtins.bool] = ..., use_common_alert_schema: Optional[_builtins.bool] = ...) -> None:
...
class WebhookReceiverResponseV1(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, service_uri: _builtins.str, identifier_uri: Optional[_builtins.str] = ..., object_id: Optional[_builtins.str] = ..., tenant_id: Optional[_builtins.str] = ..., use_aad_auth: Optional[_builtins.bool] = ..., use_common_alert_schema: Optional[_builtins.bool] = ...) -> None:
...
class WebtestLocationAvailabilityCriteriaResponse(dict):
    ...
    def __init__(__self__, *, component_id: _builtins.str, failed_location_count: _builtins.float, odata_type: _builtins.str, web_test_id: _builtins.str) -> None:
...
class WindowsEventLogDataSourceResponse(dict):
    ...
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., streams: Optional[Sequence[_builtins.str]] = ..., x_path_queries: Optional[Sequence[_builtins.str]] = ...) -> None:
