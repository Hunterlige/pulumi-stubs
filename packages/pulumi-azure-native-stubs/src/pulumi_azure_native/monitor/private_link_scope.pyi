...
class PrivateLinkScope(pulumi.CustomResource):
    ...
    def __init__(
        ...
        access_mode_settings: Optional[
            pulumi.Input[Union[AccessModeSettingsArgs, AccessModeSettingsArgsDict]]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def access_mode_settings(
        self,
    ) -> pulumi.Output[outputs.AccessModeSettingsResponse]: ...
    @_builtins.property
    ...
    def private_endpoint_connections(
        self,
    ) -> pulumi.Output[Sequence[outputs.PrivateEndpointConnectionResponseV1]]: ...
    @_builtins.property
