...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AssociatedTenantPropertiesResponse', 'AzurePlanResponse', 'BillingProfilePropertiesResponse', 'BillingProfilePropertiesResponseBillTo', 'BillingProfilePropertiesResponseCurrentPaymentTerm', ..., 'BillingProfilePropertiesResponseShipTo', 'BillingProfilePropertiesResponseSoldTo', 'BillingRoleAssignmentPropertiesResponse', 'InvoiceSectionPropertiesResponse', 'InvoiceSectionWithCreateSubPermissionResponse', 'PaymentTermResponse', 'SpendingLimitDetailsResponse', 'SystemDataResponse']
@pulumi.output_type
class AssociatedTenantPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_billing_request_id: _builtins.str, provisioning_state: _builtins.str, billing_management_state: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., provisioning_management_state: Optional[_builtins.str] = ..., tenant_id: Optional[_builtins.str] = ...) -> None:
...
class AzurePlanResponse(dict):
    ...
    def __init__(__self__, *, product_id: Optional[_builtins.str] = ..., sku_description: Optional[_builtins.str] = ..., sku_id: Optional[_builtins.str] = ...) -> None:
...
class BillingProfilePropertiesResponse(dict):
    ...
    def __init__(__self__, *, billing_relationship_type: _builtins.str, currency: _builtins.str, has_read_access: _builtins.bool, invoice_day: _builtins.int, other_payment_terms: Sequence[outputs.PaymentTermResponse], provisioning_state: _builtins.str, spending_limit: _builtins.str, spending_limit_details: Sequence[outputs.SpendingLimitDetailsResponse], status: _builtins.str, status_reason_code: _builtins.str, system_id: _builtins.str, target_clouds: Sequence[_builtins.str], bill_to: Optional[outputs.BillingProfilePropertiesResponseBillTo] = ..., current_payment_term: Optional[outputs.BillingProfilePropertiesResponseCurrentPaymentTerm] = ..., display_name: Optional[_builtins.str] = ..., enabled_azure_plans: Optional[Sequence[outputs.AzurePlanResponse]] = ..., indirect_relationship_info: Optional[outputs.BillingProfilePropertiesResponseIndirectRelationshipInfo] = ..., invoice_email_opt_in: Optional[_builtins.bool] = ..., invoice_recipients: Optional[Sequence[_builtins.str]] = ..., po_number: Optional[_builtins.str] = ..., ship_to: Optional[outputs.BillingProfilePropertiesResponseShipTo] = ..., sold_to: Optional[outputs.BillingProfilePropertiesResponseSoldTo] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class BillingProfilePropertiesResponseBillTo(dict):
    ...
    def __init__(__self__, *, address_line1: _builtins.str, country: _builtins.str, address_line2: Optional[_builtins.str] = ..., address_line3: Optional[_builtins.str] = ..., city: Optional[_builtins.str] = ..., company_name: Optional[_builtins.str] = ..., district: Optional[_builtins.str] = ..., email: Optional[_builtins.str] = ..., first_name: Optional[_builtins.str] = ..., is_valid_address: Optional[_builtins.bool] = ..., last_name: Optional[_builtins.str] = ..., middle_name: Optional[_builtins.str] = ..., phone_number: Optional[_builtins.str] = ..., postal_code: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ...) -> None:
...
class BillingProfilePropertiesResponseCurrentPaymentTerm(dict):
    ...
    def __init__(__self__, *, is_default: _builtins.bool, end_date: Optional[_builtins.str] = ..., start_date: Optional[_builtins.str] = ..., term: Optional[_builtins.str] = ...) -> None:
...
class BillingProfilePropertiesResponseIndirectRelationshipInfo(dict):
    ...
    def __init__(__self__, *, billing_account_name: Optional[_builtins.str] = ..., billing_profile_name: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ...) -> None:
...
class BillingRoleAssignmentPropertiesResponse(dict):
    ...
    def __init__(__self__, *, billing_account_display_name: _builtins.str, billing_account_id: _builtins.str, billing_profile_display_name: _builtins.str, billing_profile_id: _builtins.str, billing_request_id: _builtins.str, created_by_principal_id: _builtins.str, created_by_principal_puid: _builtins.str, created_by_principal_tenant_id: _builtins.str, created_by_user_email_address: _builtins.str, created_on: _builtins.str, customer_display_name: _builtins.str, customer_id: _builtins.str, invoice_section_display_name: _builtins.str, invoice_section_id: _builtins.str, modified_by_principal_id: _builtins.str, modified_by_principal_puid: _builtins.str, modified_by_principal_tenant_id: _builtins.str, modified_by_user_email_address: _builtins.str, modified_on: _builtins.str, principal_display_name: _builtins.str, principal_tenant_name: _builtins.str, principal_type: _builtins.str, provisioning_state: _builtins.str, role_definition_id: _builtins.str, principal_id: Optional[_builtins.str] = ..., principal_puid: Optional[_builtins.str] = ..., principal_tenant_id: Optional[_builtins.str] = ..., scope: Optional[_builtins.str] = ..., user_authentication_type: Optional[_builtins.str] = ..., user_email_address: Optional[_builtins.str] = ...) -> None:
...
class InvoiceSectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, system_id: _builtins.str, display_name: Optional[_builtins.str] = ..., reason_code: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., target_cloud: Optional[_builtins.str] = ...) -> None:
...
class InvoiceSectionWithCreateSubPermissionResponse(dict):
    ...
    def __init__(__self__, *, billing_profile_display_name: _builtins.str, billing_profile_id: _builtins.str, billing_profile_spending_limit: _builtins.str, billing_profile_status: _builtins.str, billing_profile_status_reason_code: _builtins.str, billing_profile_system_id: _builtins.str, enabled_azure_plans: Sequence[outputs.AzurePlanResponse], invoice_section_display_name: _builtins.str, invoice_section_id: _builtins.str, invoice_section_system_id: _builtins.str) -> None:
...
class SpendingLimitDetailsResponse(dict):
    ...
    def __init__(__self__, *, amount: Optional[_builtins.float] = ..., currency: Optional[_builtins.str] = ..., end_date: Optional[_builtins.str] = ..., start_date: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
