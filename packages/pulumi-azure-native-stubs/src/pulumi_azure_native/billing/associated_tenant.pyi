...
class AssociatedTenantArgs:
    def __init__(
        ...
        *,
        ...
        associated_tenant_name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[pulumi.Input[AssociatedTenantPropertiesArgs]] = ...,
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[AssociatedTenantPropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class AssociatedTenant(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    AssociatedTenantPropertiesArgs, AssociatedTenantPropertiesArgsDict
                ]
            ]
        ] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.AssociatedTenantPropertiesResponse]: ...
    @_builtins.property
