...
class BillingRoleAssignmentByDepartmentArgs:
    def __init__(__self__, *, billing_account_name: pulumi.Input[_builtins.str], department_name: pulumi.Input[_builtins.str], billing_role_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[BillingRoleAssignmentPropertiesArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def department_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BillingRoleAssignmentByDepartment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., billing_account_name: Optional[pulumi.Input[_builtins.str]] = ..., billing_role_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., department_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[BillingRoleAssignmentPropertiesArgs, BillingRoleAssignmentPropertiesArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: BillingRoleAssignmentByDepartmentArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> BillingRoleAssignmentByDepartment:
