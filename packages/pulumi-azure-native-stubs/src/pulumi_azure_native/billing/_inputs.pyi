...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AssociatedTenantPropertiesArgs', 'AssociatedTenantPropertiesArgsDict', 'AzurePlanArgs', 'AzurePlanArgsDict', 'BillingProfilePropertiesBillToArgs', 'BillingProfilePropertiesBillToArgsDict', 'BillingProfilePropertiesCurrentPaymentTermArgs', 'BillingProfilePropertiesCurrentPaymentTermArgsDict', ..., ..., 'BillingProfilePropertiesShipToArgs', 'BillingProfilePropertiesShipToArgsDict', 'BillingProfilePropertiesSoldToArgs', 'BillingProfilePropertiesSoldToArgsDict', 'BillingProfilePropertiesArgs', 'BillingProfilePropertiesArgsDict', 'BillingRoleAssignmentPropertiesArgs', 'BillingRoleAssignmentPropertiesArgsDict', 'InvoiceSectionPropertiesArgs', 'InvoiceSectionPropertiesArgsDict']
...
class AssociatedTenantPropertiesArgs:
    def __init__(__self__, *, billing_management_state: Optional[pulumi.Input[Union[_builtins.str, BillingManagementTenantState]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_management_state: Optional[pulumi.Input[Union[_builtins.str, ProvisioningTenantState]]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def billing_management_state(self, value: Optional[pulumi.Input[Union[_builtins.str, BillingManagementTenantState]]]): # -> None:
        ...
    ...
    def provisioning_management_state(self, value: Optional[pulumi.Input[Union[_builtins.str, ProvisioningTenantState]]]): # -> None:
        ...
...
@pulumi.input_type
class AzurePlanArgs:
    def __init__(__self__, *, product_id: Optional[pulumi.Input[_builtins.str]] = ..., sku_description: Optional[pulumi.Input[_builtins.str]] = ..., sku_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def sku_description(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BillingProfilePropertiesBillToArgs:
    def __init__(__self__, *, address_line1: pulumi.Input[_builtins.str], country: pulumi.Input[_builtins.str], address_line2: Optional[pulumi.Input[_builtins.str]] = ..., address_line3: Optional[pulumi.Input[_builtins.str]] = ..., city: Optional[pulumi.Input[_builtins.str]] = ..., company_name: Optional[pulumi.Input[_builtins.str]] = ..., district: Optional[pulumi.Input[_builtins.str]] = ..., email: Optional[pulumi.Input[_builtins.str]] = ..., first_name: Optional[pulumi.Input[_builtins.str]] = ..., is_valid_address: Optional[pulumi.Input[_builtins.bool]] = ..., last_name: Optional[pulumi.Input[_builtins.str]] = ..., middle_name: Optional[pulumi.Input[_builtins.str]] = ..., phone_number: Optional[pulumi.Input[_builtins.str]] = ..., postal_code: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def is_valid_address(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @middle_name.setter
    def middle_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BillingProfilePropertiesCurrentPaymentTermArgs:
    def __init__(__self__, *, end_date: Optional[pulumi.Input[_builtins.str]] = ..., start_date: Optional[pulumi.Input[_builtins.str]] = ..., term: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @term.setter
    def term(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BillingProfilePropertiesIndirectRelationshipInfoArgs:
    def __init__(__self__, *, billing_account_name: Optional[pulumi.Input[_builtins.str]] = ..., billing_profile_name: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def billing_account_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def billing_profile_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BillingProfilePropertiesArgs:
    def __init__(__self__, *, bill_to: Optional[pulumi.Input[BillingProfilePropertiesBillToArgs]] = ..., current_payment_term: Optional[pulumi.Input[BillingProfilePropertiesCurrentPaymentTermArgs]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., enabled_azure_plans: Optional[pulumi.Input[Sequence[pulumi.Input[AzurePlanArgs]]]] = ..., indirect_relationship_info: Optional[pulumi.Input[BillingProfilePropertiesIndirectRelationshipInfoArgs]] = ..., invoice_email_opt_in: Optional[pulumi.Input[_builtins.bool]] = ..., invoice_recipients: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., po_number: Optional[pulumi.Input[_builtins.str]] = ..., ship_to: Optional[pulumi.Input[BillingProfilePropertiesShipToArgs]] = ..., sold_to: Optional[pulumi.Input[BillingProfilePropertiesSoldToArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @bill_to.setter
    def bill_to(self, value: Optional[pulumi.Input[BillingProfilePropertiesBillToArgs]]): # -> None:
        ...
    ...
    def current_payment_term(self, value: Optional[pulumi.Input[BillingProfilePropertiesCurrentPaymentTermArgs]]): # -> None:
        ...
    ...
    def enabled_azure_plans(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AzurePlanArgs]]]]): # -> None:
        ...
    ...
    def indirect_relationship_info(self, value: Optional[pulumi.Input[BillingProfilePropertiesIndirectRelationshipInfoArgs]]): # -> None:
        ...
    ...
    def invoice_email_opt_in(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def invoice_recipients(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @po_number.setter
    def po_number(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @ship_to.setter
    def ship_to(self, value: Optional[pulumi.Input[BillingProfilePropertiesShipToArgs]]): # -> None:
        ...
    ...
    @sold_to.setter
    def sold_to(self, value: Optional[pulumi.Input[BillingProfilePropertiesSoldToArgs]]): # -> None:
        ...
...
class BillingRoleAssignmentPropertiesArgs:
    def __init__(__self__, *, role_definition_id: pulumi.Input[_builtins.str], principal_id: Optional[pulumi.Input[_builtins.str]] = ..., principal_puid: Optional[pulumi.Input[_builtins.str]] = ..., principal_tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[_builtins.str]] = ..., user_authentication_type: Optional[pulumi.Input[_builtins.str]] = ..., user_email_address: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def principal_puid(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def principal_tenant_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def user_authentication_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def user_email_address(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InvoiceSectionPropertiesArgs:
    def __init__(__self__, *, display_name: Optional[pulumi.Input[_builtins.str]] = ..., reason_code: Optional[pulumi.Input[Union[_builtins.str, InvoiceSectionStateReasonCode]]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, InvoiceSectionState]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_cloud: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @reason_code.setter
    def reason_code(self, value: Optional[pulumi.Input[Union[_builtins.str, InvoiceSectionStateReasonCode]]]): # -> None:
        ...
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[_builtins.str, InvoiceSectionState]]]): # -> None:
        ...
    ...
    @target_cloud.setter
    def target_cloud(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
