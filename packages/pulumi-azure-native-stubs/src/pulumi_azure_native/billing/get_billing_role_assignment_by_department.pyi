...
class AwaitableGetBillingRoleAssignmentByDepartmentResult(
    GetBillingRoleAssignmentByDepartmentResult
):
    def __await__(self): ...

def get_billing_role_assignment_by_department(
    billing_account_name: Optional[_builtins.str] = ...,
    billing_role_assignment_name: Optional[_builtins.str] = ...,
    department_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetBillingRoleAssignmentByDepartmentResult: ...
def get_billing_role_assignment_by_department_output(
...
) -> pulumi.Output[GetBillingRoleAssignmentByDepartmentResult]: ...
