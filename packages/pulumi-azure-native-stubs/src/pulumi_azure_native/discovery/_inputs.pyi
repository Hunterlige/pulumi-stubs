...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureNetAppFilesStoreArgs', 'AzureNetAppFilesStoreArgsDict', 'AzureStorageBlobStoreArgs', 'AzureStorageBlobStoreArgsDict', 'BookshelfKeyVaultPropertiesArgs', 'BookshelfKeyVaultPropertiesArgsDict', 'BookshelfPropertiesArgs', 'BookshelfPropertiesArgsDict', 'ChatModelDeploymentPropertiesArgs', 'ChatModelDeploymentPropertiesArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'KeyVaultPropertiesArgs', 'KeyVaultPropertiesArgsDict', 'NodePoolPropertiesArgs', 'NodePoolPropertiesArgsDict', 'PrivateEndpointConnectionPropertiesArgs', 'PrivateEndpointConnectionPropertiesArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'ProjectPropertiesArgs', 'ProjectPropertiesArgsDict', 'ProjectSettingsArgs', 'ProjectSettingsArgsDict', 'StorageAssetPropertiesArgs', 'StorageAssetPropertiesArgsDict', 'StorageContainerPropertiesArgs', 'StorageContainerPropertiesArgsDict', 'SupercomputerIdentitiesArgs', 'SupercomputerIdentitiesArgsDict', 'SupercomputerPropertiesArgs', 'SupercomputerPropertiesArgsDict', 'ToolPropertiesArgs', 'ToolPropertiesArgsDict', 'WorkspacePropertiesArgs', 'WorkspacePropertiesArgsDict']
...
class AzureNetAppFilesStoreArgs:
    def __init__(__self__, *, kind: pulumi.Input[_builtins.str], net_app_volume_id: pulumi.Input[_builtins.str]) -> None:
    ...
    def net_app_volume_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AzureStorageBlobStoreArgs:
    def __init__(__self__, *, kind: pulumi.Input[_builtins.str], storage_account_id: pulumi.Input[_builtins.str]) -> None:
...
class BookshelfKeyVaultPropertiesArgs:
    def __init__(__self__, *, identity_client_id: pulumi.Input[_builtins.str], key_name: pulumi.Input[_builtins.str], key_vault_uri: pulumi.Input[_builtins.str], key_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def identity_client_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BookshelfPropertiesArgs:
    def __init__(__self__, *, customer_managed_keys: Optional[pulumi.Input[Union[_builtins.str, CustomerManagedKeys]]] = ..., key_vault_properties: Optional[pulumi.Input[BookshelfKeyVaultPropertiesArgs]] = ..., log_analytics_cluster_id: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint_subnet_id: Optional[pulumi.Input[_builtins.str]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., search_subnet_id: Optional[pulumi.Input[_builtins.str]] = ..., workload_identities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def customer_managed_keys(self, value: Optional[pulumi.Input[Union[_builtins.str, CustomerManagedKeys]]]): # -> None:
        ...
    ...
    def key_vault_properties(self, value: Optional[pulumi.Input[BookshelfKeyVaultPropertiesArgs]]): # -> None:
        ...
    ...
    def log_analytics_cluster_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def private_endpoint_subnet_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def search_subnet_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def workload_identities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ChatModelDeploymentPropertiesArgs:
    def __init__(__self__, *, model_format: pulumi.Input[_builtins.str], model_name: pulumi.Input[_builtins.str]) -> None:
    ...
    @model_format.setter
    def model_format(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class KeyVaultPropertiesArgs:
    def __init__(__self__, *, key_name: pulumi.Input[_builtins.str], key_vault_uri: pulumi.Input[_builtins.str], key_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NodePoolPropertiesArgs:
    def __init__(__self__, *, max_node_count: pulumi.Input[_builtins.int], subnet_id: pulumi.Input[_builtins.str], vm_size: pulumi.Input[Union[_builtins.str, VmSize]], min_node_count: Optional[pulumi.Input[_builtins.int]] = ..., scale_set_priority: Optional[pulumi.Input[Union[_builtins.str, ScaleSetPriority]]] = ...) -> None:
    ...
    @vm_size.setter
    def vm_size(self, value: pulumi.Input[Union[_builtins.str, VmSize]]): # -> None:
        ...
...
class ProjectPropertiesArgs:
    def __init__(__self__, *, settings: Optional[pulumi.Input[ProjectSettingsArgs]] = ..., storage_container_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @settings.setter
    def settings(self, value: Optional[pulumi.Input[ProjectSettingsArgs]]): # -> None:
        ...
    ...
    def storage_container_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ProjectSettingsArgs:
    def __init__(__self__, *, behavior_preferences: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def behavior_preferences(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StorageAssetPropertiesArgs:
    def __init__(__self__, *, description: pulumi.Input[_builtins.str], path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StorageContainerPropertiesArgs:
    def __init__(__self__, *, storage_store: pulumi.Input[Union[AzureNetAppFilesStoreArgs, AzureStorageBlobStoreArgs]]) -> None:
    ...
    def storage_store(self, value: pulumi.Input[Union[AzureNetAppFilesStoreArgs, AzureStorageBlobStoreArgs]]): # -> None:
        ...
...
class SupercomputerIdentitiesArgs:
    def __init__(__self__, *, cluster_identity: pulumi.Input[IdentityArgs], kubelet_identity: pulumi.Input[IdentityArgs], workload_identities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def cluster_identity(self, value: pulumi.Input[IdentityArgs]): # -> None:
        ...
    ...
    def kubelet_identity(self, value: pulumi.Input[IdentityArgs]): # -> None:
        ...
...
class SupercomputerPropertiesArgs:
    def __init__(__self__, *, identities: pulumi.Input[SupercomputerIdentitiesArgs], subnet_id: pulumi.Input[_builtins.str], customer_managed_keys: Optional[pulumi.Input[Union[_builtins.str, CustomerManagedKeys]]] = ..., disk_encryption_set_id: Optional[pulumi.Input[_builtins.str]] = ..., log_analytics_cluster_id: Optional[pulumi.Input[_builtins.str]] = ..., management_subnet_id: Optional[pulumi.Input[_builtins.str]] = ..., outbound_type: Optional[pulumi.Input[Union[_builtins.str, NetworkEgressType]]] = ..., system_sku: Optional[pulumi.Input[Union[_builtins.str, SystemSku]]] = ...) -> None:
    ...
    @identities.setter
    def identities(self, value: pulumi.Input[SupercomputerIdentitiesArgs]): # -> None:
        ...
    ...
    def management_subnet_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def outbound_type(self, value: Optional[pulumi.Input[Union[_builtins.str, NetworkEgressType]]]): # -> None:
        ...
    ...
    @system_sku.setter
    def system_sku(self, value: Optional[pulumi.Input[Union[_builtins.str, SystemSku]]]): # -> None:
        ...
...
class ToolPropertiesArgs:
    def __init__(__self__, *, definition_content: Any, version: pulumi.Input[_builtins.str], environment_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def definition_content(self, value: Any): # -> None:
        ...
...
class WorkspacePropertiesArgs:
    def __init__(__self__, *, workspace_identity: pulumi.Input[IdentityArgs], agent_subnet_id: Optional[pulumi.Input[_builtins.str]] = ..., customer_managed_keys: Optional[pulumi.Input[Union[_builtins.str, CustomerManagedKeys]]] = ..., key_vault_properties: Optional[pulumi.Input[KeyVaultPropertiesArgs]] = ..., log_analytics_cluster_id: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint_subnet_id: Optional[pulumi.Input[_builtins.str]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., supercomputer_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., workspace_subnet_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def workspace_identity(self, value: pulumi.Input[IdentityArgs]): # -> None:
        ...
    ...
    def agent_subnet_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def supercomputer_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def workspace_subnet_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
