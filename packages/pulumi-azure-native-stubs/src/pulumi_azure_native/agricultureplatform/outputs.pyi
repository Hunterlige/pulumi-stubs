...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AgriServiceConfigResponse', 'AgriServiceResourcePropertiesResponse', 'DataConnectorCredentialMapResponse', 'DataConnectorCredentialsResponse', 'DataManagerForAgricultureSolutionResponse', 'InstalledSolutionMapResponse', 'ManagedOnBehalfOfConfigurationResponse', 'ManagedServiceIdentityResponse', 'MarketPlaceOfferDetailsResponse', 'MoboBrokerResourceResponse', 'SkuResponse', 'SolutionResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
class AgriServiceConfigResponse(dict):
    ...
    def __init__(__self__, *, app_service_resource_id: _builtins.str, cosmos_db_resource_id: _builtins.str, instance_uri: _builtins.str, key_vault_resource_id: _builtins.str, redis_cache_resource_id: _builtins.str, storage_account_resource_id: _builtins.str, version: _builtins.str) -> None:
...
class DataConnectorCredentialMapResponse(dict):
    ...
    def __init__(__self__, *, key: _builtins.str, value: outputs.DataConnectorCredentialsResponse) -> None:
...
class DataConnectorCredentialsResponse(dict):
    ...
    def __init__(__self__, *, client_id: Optional[_builtins.str] = ..., key_name: Optional[_builtins.str] = ..., key_vault_uri: Optional[_builtins.str] = ..., key_version: Optional[_builtins.str] = ..., kind: Optional[_builtins.str] = ...) -> None:
...
class DataManagerForAgricultureSolutionResponse(dict):
    ...
    def __init__(__self__, *, access_azure_data_manager_for_agriculture_application_id: _builtins.str, access_azure_data_manager_for_agriculture_application_name: _builtins.str, data_access_scopes: Sequence[_builtins.str], is_validate_input: _builtins.bool, market_place_offer_details: outputs.MarketPlaceOfferDetailsResponse, partner_id: _builtins.str, partner_tenant_id: _builtins.str, saas_application_id: _builtins.str, solution_id: _builtins.str) -> None:
...
class InstalledSolutionMapResponse(dict):
    ...
    def __init__(__self__, *, key: _builtins.str, value: outputs.SolutionResponse) -> None:
...
class MarketPlaceOfferDetailsResponse(dict):
    ...
    def __init__(__self__, *, publisher_id: _builtins.str, saas_offer_id: _builtins.str) -> None:
...
class SolutionResponse(dict):
    ...
    def __init__(__self__, *, application_name: Optional[_builtins.str] = ..., market_place_publisher_id: Optional[_builtins.str] = ..., partner_id: Optional[_builtins.str] = ..., plan_id: Optional[_builtins.str] = ..., saas_subscription_id: Optional[_builtins.str] = ..., saas_subscription_name: Optional[_builtins.str] = ...) -> None:
