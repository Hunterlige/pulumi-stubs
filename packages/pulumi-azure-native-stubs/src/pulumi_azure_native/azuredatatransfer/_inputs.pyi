...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AntivirusRulesetArgs', 'AntivirusRulesetArgsDict', 'ArchiveRulesetArgs', 'ArchiveRulesetArgsDict', 'ConnectionPropertiesArgs', 'ConnectionPropertiesArgsDict', 'DataSizeRulesetArgs', 'DataSizeRulesetArgsDict', 'FlowProfilePropertiesArgs', 'FlowProfilePropertiesArgsDict', 'FlowProfileRulesetsArgs', 'FlowProfileRulesetsArgsDict', 'FlowPropertiesArgs', 'FlowPropertiesArgsDict', 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'MessagingOptionsArgs', 'MessagingOptionsArgsDict', 'MimeFilterRulesetArgs', 'MimeFilterRulesetArgsDict', 'MimeTypeFilterArgs', 'MimeTypeFilterArgsDict', 'PipelinePropertiesArgs', 'PipelinePropertiesArgsDict', 'PlanArgs', 'PlanArgsDict', 'SchemaArgs', 'SchemaArgsDict', 'SelectedResourceArgs', 'SelectedResourceArgsDict', 'StreamSourceAddressesArgs', 'StreamSourceAddressesArgsDict', 'SubscriberArgs', 'SubscriberArgsDict', 'TextMatchingRulesetArgs', 'TextMatchingRulesetArgsDict', 'TextMatchArgs', 'TextMatchArgsDict', 'XmlFilterRulesetArgs', 'XmlFilterRulesetArgsDict']
...
class AntivirusRulesetArgs:
    def __init__(__self__, *, av_solutions: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AntivirusSolutions]]]]] = ...) -> None:
    ...
    @av_solutions.setter
    def av_solutions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AntivirusSolutions]]]]]): # -> None:
        ...
...
class ArchiveRulesetArgs:
    def __init__(__self__, *, maximum_compression_ratio_limit: Optional[pulumi.Input[_builtins.float]] = ..., maximum_depth_limit: Optional[pulumi.Input[_builtins.float]] = ..., maximum_expansion_size_limit: Optional[pulumi.Input[_builtins.float]] = ..., minimum_size_for_expansion: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def maximum_compression_ratio_limit(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def maximum_depth_limit(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def maximum_expansion_size_limit(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def minimum_size_for_expansion(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class ConnectionPropertiesArgs:
    def __init__(__self__, *, pipeline: pulumi.Input[_builtins.str], direction: Optional[pulumi.Input[Union[_builtins.str, Direction]]] = ..., flow_types: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, FlowType]]]]] = ..., justification: Optional[pulumi.Input[_builtins.str]] = ..., pin: Optional[pulumi.Input[_builtins.str]] = ..., policies: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., primary_contact: Optional[pulumi.Input[_builtins.str]] = ..., remote_subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., requirement_id: Optional[pulumi.Input[_builtins.str]] = ..., schema_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., schemas: Optional[pulumi.Input[Sequence[pulumi.Input[SchemaArgs]]]] = ..., secondary_contacts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @direction.setter
    def direction(self, value: Optional[pulumi.Input[Union[_builtins.str, Direction]]]): # -> None:
        ...
    ...
    @flow_types.setter
    def flow_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, FlowType]]]]]): # -> None:
        ...
    ...
    @pin.setter
    def pin(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @policies.setter
    def policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def remote_subscription_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def requirement_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @schema_uris.setter
    def schema_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @schemas.setter
    def schemas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SchemaArgs]]]]): # -> None:
        ...
    ...
    def secondary_contacts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DataSizeRulesetArgs:
    def __init__(__self__, *, maximum: Optional[pulumi.Input[_builtins.float]] = ..., minimum: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
...
class FlowProfilePropertiesArgs:
    def __init__(__self__, *, description: pulumi.Input[_builtins.str], replication_scenario: pulumi.Input[Union[_builtins.str, DataClassType]], status: pulumi.Input[Union[_builtins.str, FlowProfileStatus]], rulesets: Optional[pulumi.Input[FlowProfileRulesetsArgs]] = ...) -> None:
    ...
    def replication_scenario(self, value: pulumi.Input[Union[_builtins.str, DataClassType]]): # -> None:
        ...
    ...
    @status.setter
    def status(self, value: pulumi.Input[Union[_builtins.str, FlowProfileStatus]]): # -> None:
        ...
    ...
    @rulesets.setter
    def rulesets(self, value: Optional[pulumi.Input[FlowProfileRulesetsArgs]]): # -> None:
        ...
...
class FlowProfileRulesetsArgs:
    def __init__(__self__, *, antivirus: Optional[pulumi.Input[AntivirusRulesetArgs]] = ..., archives: Optional[pulumi.Input[ArchiveRulesetArgs]] = ..., data_size: Optional[pulumi.Input[DataSizeRulesetArgs]] = ..., mime_filters: Optional[pulumi.Input[MimeFilterRulesetArgs]] = ..., text_matching: Optional[pulumi.Input[TextMatchingRulesetArgs]] = ..., xml_filters: Optional[pulumi.Input[XmlFilterRulesetArgs]] = ...) -> None:
    ...
    @antivirus.setter
    def antivirus(self, value: Optional[pulumi.Input[AntivirusRulesetArgs]]): # -> None:
        ...
    ...
    @archives.setter
    def archives(self, value: Optional[pulumi.Input[ArchiveRulesetArgs]]): # -> None:
        ...
    ...
    @data_size.setter
    def data_size(self, value: Optional[pulumi.Input[DataSizeRulesetArgs]]): # -> None:
        ...
    ...
    @mime_filters.setter
    def mime_filters(self, value: Optional[pulumi.Input[MimeFilterRulesetArgs]]): # -> None:
        ...
    ...
    def text_matching(self, value: Optional[pulumi.Input[TextMatchingRulesetArgs]]): # -> None:
        ...
    ...
    @xml_filters.setter
    def xml_filters(self, value: Optional[pulumi.Input[XmlFilterRulesetArgs]]): # -> None:
        ...
...
class FlowPropertiesArgs:
    def __init__(__self__, *, connection: Optional[pulumi.Input[SelectedResourceArgs]] = ..., customer_managed_key_vault_uri: Optional[pulumi.Input[_builtins.str]] = ..., data_type: Optional[pulumi.Input[Union[_builtins.str, DataType]]] = ..., destination_endpoint_ports: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.float]]]] = ..., destination_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., flow_type: Optional[pulumi.Input[Union[_builtins.str, FlowType]]] = ..., key_vault_uri: Optional[pulumi.Input[_builtins.str]] = ..., messaging_options: Optional[pulumi.Input[MessagingOptionsArgs]] = ..., passphrase: Optional[pulumi.Input[_builtins.str]] = ..., policies: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., schema: Optional[pulumi.Input[SchemaArgs]] = ..., service_bus_queue_id: Optional[pulumi.Input[_builtins.str]] = ..., source_addresses: Optional[pulumi.Input[StreamSourceAddressesArgs]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, FlowStatus]]] = ..., storage_account_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_container_name: Optional[pulumi.Input[_builtins.str]] = ..., stream_id: Optional[pulumi.Input[_builtins.str]] = ..., stream_latency: Optional[pulumi.Input[_builtins.float]] = ..., stream_protocol: Optional[pulumi.Input[Union[_builtins.str, StreamProtocol]]] = ...) -> None:
    ...
    @connection.setter
    def connection(self, value: Optional[pulumi.Input[SelectedResourceArgs]]): # -> None:
        ...
    ...
    def customer_managed_key_vault_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def destination_endpoint_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.float]]]]): # -> None:
        ...
    ...
    def destination_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @flow_type.setter
    def flow_type(self, value: Optional[pulumi.Input[Union[_builtins.str, FlowType]]]): # -> None:
        ...
    ...
    def messaging_options(self, value: Optional[pulumi.Input[MessagingOptionsArgs]]): # -> None:
        ...
    ...
    @schema.setter
    def schema(self, value: Optional[pulumi.Input[SchemaArgs]]): # -> None:
        ...
    ...
    def service_bus_queue_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def source_addresses(self, value: Optional[pulumi.Input[StreamSourceAddressesArgs]]): # -> None:
        ...
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[_builtins.str, FlowStatus]]]): # -> None:
        ...
    ...
    @stream_id.setter
    def stream_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def stream_latency(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def stream_protocol(self, value: Optional[pulumi.Input[Union[_builtins.str, StreamProtocol]]]): # -> None:
        ...
...
class MessagingOptionsArgs:
    def __init__(__self__, *, billing_tier: Optional[pulumi.Input[Union[_builtins.str, FlowBillingTier]]] = ...) -> None:
    ...
    @billing_tier.setter
    def billing_tier(self, value: Optional[pulumi.Input[Union[_builtins.str, FlowBillingTier]]]): # -> None:
        ...
...
class MimeFilterRulesetArgs:
    def __init__(__self__, *, filters: Optional[pulumi.Input[Sequence[pulumi.Input[MimeTypeFilterArgs]]]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, FilterType]]] = ...) -> None:
    ...
    @filters.setter
    def filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MimeTypeFilterArgs]]]]): # -> None:
        ...
...
class MimeTypeFilterArgs:
    def __init__(__self__, *, extensions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., media: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @media.setter
    def media(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipelinePropertiesArgs:
    def __init__(__self__, *, remote_cloud: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[_builtins.str]] = ..., flow_types: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, FlowType]]]]] = ..., policies: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., subscribers: Optional[pulumi.Input[Sequence[pulumi.Input[SubscriberArgs]]]] = ...) -> None:
    ...
    @remote_cloud.setter
    def remote_cloud(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @subscribers.setter
    def subscribers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SubscriberArgs]]]]): # -> None:
        ...
...
@pulumi.input_type
class SchemaArgs:
    def __init__(__self__, *, connection_id: Optional[pulumi.Input[_builtins.str]] = ..., content: Optional[pulumi.Input[_builtins.str]] = ..., direction: Optional[pulumi.Input[Union[_builtins.str, SchemaDirection]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., schema_type: Optional[pulumi.Input[Union[_builtins.str, SchemaType]]] = ..., schema_uri: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, SchemaStatus]]] = ...) -> None:
    ...
    @direction.setter
    def direction(self, value: Optional[pulumi.Input[Union[_builtins.str, SchemaDirection]]]): # -> None:
        ...
    ...
    @schema_uri.setter
    def schema_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[_builtins.str, SchemaStatus]]]): # -> None:
        ...
...
class SelectedResourceArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., subscription_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StreamSourceAddressesArgs:
    def __init__(__self__, *, source_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class SubscriberArgs:
    def __init__(__self__, *, email: Optional[pulumi.Input[_builtins.str]] = ..., notifications: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def notifications(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class TextMatchingRulesetArgs:
    def __init__(__self__, *, deny: Optional[pulumi.Input[Sequence[pulumi.Input[TextMatchArgs]]]] = ...) -> None:
    ...
    @deny.setter
    def deny(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TextMatchArgs]]]]): # -> None:
        ...
...
@pulumi.input_type
class TextMatchArgs:
    def __init__(__self__, *, case_sensitivity: Optional[pulumi.Input[Union[_builtins.str, Casing]]] = ..., match_type: Optional[pulumi.Input[Union[_builtins.str, MatchType]]] = ..., text: pulumi.Input[_builtins.str]) -> None:
    ...
    def case_sensitivity(self, value: pulumi.Input[Union[_builtins.str, Casing]]): # -> None:
        ...
    ...
    @match_type.setter
    def match_type(self, value: pulumi.Input[Union[_builtins.str, MatchType]]): # -> None:
        ...
...
class XmlFilterRulesetArgs:
    def __init__(__self__, *, default_namespace: Optional[pulumi.Input[_builtins.str]] = ..., reference: Optional[pulumi.Input[Union[_builtins.str, XmlReferenceType]]] = ..., schema: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @reference.setter
    def reference(self, value: Optional[pulumi.Input[Union[_builtins.str, XmlReferenceType]]]): # -> None:
        ...
