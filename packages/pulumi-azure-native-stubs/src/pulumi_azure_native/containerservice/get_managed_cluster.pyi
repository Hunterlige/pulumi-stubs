...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetManagedClusterResult', 'AwaitableGetManagedClusterResult', 'get_managed_cluster', 'get_managed_cluster_output']
@pulumi.output_type
class GetManagedClusterResult:
    
    def __init__(__self__, aad_profile=..., addon_profiles=..., agent_pool_profiles=..., ai_toolchain_operator_profile=..., api_server_access_profile=..., auto_scaler_profile=..., auto_upgrade_profile=..., azure_api_version=..., azure_monitor_profile=..., azure_portal_fqdn=..., bootstrap_profile=..., current_kubernetes_version=..., disable_local_accounts=..., disk_encryption_set_id=..., dns_prefix=..., e_tag=..., enable_rbac=..., extended_location=..., fqdn=..., fqdn_subdomain=..., http_proxy_config=..., id=..., identity=..., identity_profile=..., ingress_profile=..., kind=..., kubernetes_version=..., linux_profile=..., location=..., max_agent_pools=..., metrics_profile=..., name=..., network_profile=..., node_provisioning_profile=..., node_resource_group=..., node_resource_group_profile=..., oidc_issuer_profile=..., pod_identity_profile=..., power_state=..., private_fqdn=..., private_link_resources=..., provisioning_state=..., public_network_access=..., resource_uid=..., security_profile=..., service_mesh_profile=..., service_principal_profile=..., sku=..., status=..., storage_profile=..., support_plan=..., system_data=..., tags=..., type=..., upgrade_settings=..., windows_profile=..., workload_auto_scaler_profile=...) -> None:
        ...
...
class AwaitableGetManagedClusterResult(GetManagedClusterResult):
    def __await__(self): # -> Generator[Never, Any, GetManagedClusterResult]:
        ...
    


def get_managed_cluster(resource_group_name: Optional[_builtins.str] = ..., resource_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetManagedClusterResult:
    
    ...

def get_managed_cluster_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetManagedClusterResult]:
