...
class ManagementLockByScopeArgs:
    def __init__(__self__, *, level: pulumi.Input[Union[_builtins.str, LockLevel]], scope: pulumi.Input[_builtins.str], lock_name: Optional[pulumi.Input[_builtins.str]] = ..., notes: Optional[pulumi.Input[_builtins.str]] = ..., owners: Optional[pulumi.Input[Sequence[pulumi.Input[ManagementLockOwnerArgs]]]] = ...) -> None:
...
class ManagementLockByScope(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., level: Optional[pulumi.Input[Union[_builtins.str, LockLevel]]] = ..., lock_name: Optional[pulumi.Input[_builtins.str]] = ..., notes: Optional[pulumi.Input[_builtins.str]] = ..., owners: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ManagementLockOwnerArgs, ManagementLockOwnerArgsDict]]]]] = ..., scope: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ManagementLockByScopeArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ManagementLockByScope:
