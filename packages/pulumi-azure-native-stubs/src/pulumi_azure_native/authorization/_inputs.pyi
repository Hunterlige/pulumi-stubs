...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessReviewHistoryInstanceArgs', 'AccessReviewHistoryInstanceArgsDict', 'AccessReviewInstanceArgs', 'AccessReviewInstanceArgsDict', 'AccessReviewRecurrenceRangeArgs', 'AccessReviewRecurrenceRangeArgsDict', 'AccessReviewReviewerArgs', 'AccessReviewReviewerArgsDict', 'AccessReviewScopeArgs', 'AccessReviewScopeArgsDict', 'ApprovalSettingsArgs', 'ApprovalSettingsArgsDict', 'ApprovalStageArgs', 'ApprovalStageArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'ManagementLockOwnerArgs', 'ManagementLockOwnerArgsDict', 'NonComplianceMessageArgs', 'NonComplianceMessageArgsDict', 'OverrideArgs', 'OverrideArgsDict', 'PIMOnlyModeSettingsArgs', 'PIMOnlyModeSettingsArgsDict', 'ParameterDefinitionsValueMetadataArgs', 'ParameterDefinitionsValueMetadataArgsDict', 'ParameterDefinitionsValueArgs', 'ParameterDefinitionsValueArgsDict', 'ParameterValuesValueArgs', 'ParameterValuesValueArgsDict', 'PermissionArgs', 'PermissionArgsDict', 'PolicyDefinitionGroupArgs', 'PolicyDefinitionGroupArgsDict', 'PolicyDefinitionReferenceArgs', 'PolicyDefinitionReferenceArgsDict', 'PolicyVariableColumnArgs', 'PolicyVariableColumnArgsDict', 'PolicyVariableValueColumnValueArgs', 'PolicyVariableValueColumnValueArgsDict', 'PrivateLinkAssociationPropertiesArgs', 'PrivateLinkAssociationPropertiesArgsDict', 'ResourceSelectorArgs', 'ResourceSelectorArgsDict', ..., ..., ..., ..., ..., ..., 'RoleManagementPolicyApprovalRuleArgs', 'RoleManagementPolicyApprovalRuleArgsDict', 'RoleManagementPolicyAuthenticationContextRuleArgs', ..., 'RoleManagementPolicyEnablementRuleArgs', 'RoleManagementPolicyEnablementRuleArgsDict', 'RoleManagementPolicyExpirationRuleArgs', 'RoleManagementPolicyExpirationRuleArgsDict', 'RoleManagementPolicyNotificationRuleArgs', 'RoleManagementPolicyNotificationRuleArgsDict', 'RoleManagementPolicyPimOnlyModeRuleArgs', 'RoleManagementPolicyPimOnlyModeRuleArgsDict', 'RoleManagementPolicyRuleTargetArgs', 'RoleManagementPolicyRuleTargetArgsDict', 'SelectorArgs', 'SelectorArgsDict', 'UserSetArgs', 'UserSetArgsDict', 'UsersOrServicePrincipalSetArgs', 'UsersOrServicePrincipalSetArgsDict']
...
class AccessReviewHistoryInstanceArgs:
    def __init__(__self__, *, display_name: Optional[pulumi.Input[_builtins.str]] = ..., expiration: Optional[pulumi.Input[_builtins.str]] = ..., fulfilled_date_time: Optional[pulumi.Input[_builtins.str]] = ..., review_history_period_end_date_time: Optional[pulumi.Input[_builtins.str]] = ..., review_history_period_start_date_time: Optional[pulumi.Input[_builtins.str]] = ..., run_date_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def fulfilled_date_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def review_history_period_end_date_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def review_history_period_start_date_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def run_date_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AccessReviewInstanceArgs:
    def __init__(__self__, *, backup_reviewers: Optional[pulumi.Input[Sequence[pulumi.Input[AccessReviewReviewerArgs]]]] = ..., end_date_time: Optional[pulumi.Input[_builtins.str]] = ..., reviewers: Optional[pulumi.Input[Sequence[pulumi.Input[AccessReviewReviewerArgs]]]] = ..., start_date_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def backup_reviewers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AccessReviewReviewerArgs]]]]): # -> None:
        ...
    ...
    @reviewers.setter
    def reviewers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AccessReviewReviewerArgs]]]]): # -> None:
        ...
...
class AccessReviewRecurrenceRangeArgs:
    def __init__(__self__, *, end_date: Optional[pulumi.Input[_builtins.str]] = ..., number_of_occurrences: Optional[pulumi.Input[_builtins.int]] = ..., start_date: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, AccessReviewRecurrenceRangeType]]] = ...) -> None:
    ...
    def number_of_occurrences(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, AccessReviewRecurrenceRangeType]]]): # -> None:
        ...
...
class AccessReviewScopeArgs:
    def __init__(__self__, *, exclude_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., exclude_role_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., expand_nested_memberships: Optional[pulumi.Input[_builtins.bool]] = ..., inactive_duration: Optional[pulumi.Input[_builtins.str]] = ..., include_access_below_resource: Optional[pulumi.Input[_builtins.bool]] = ..., include_inherited_access: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def exclude_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def exclude_role_definition_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def expand_nested_memberships(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def inactive_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def include_access_below_resource(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def include_inherited_access(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ApprovalSettingsArgs:
    def __init__(__self__, *, approval_mode: Optional[pulumi.Input[Union[_builtins.str, ApprovalMode]]] = ..., approval_stages: Optional[pulumi.Input[Sequence[pulumi.Input[ApprovalStageArgs]]]] = ..., is_approval_required: Optional[pulumi.Input[_builtins.bool]] = ..., is_approval_required_for_extension: Optional[pulumi.Input[_builtins.bool]] = ..., is_requestor_justification_required: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def approval_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, ApprovalMode]]]): # -> None:
        ...
    ...
    def approval_stages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ApprovalStageArgs]]]]): # -> None:
        ...
    ...
    def is_approval_required(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_approval_required_for_extension(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_requestor_justification_required(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ApprovalStageArgs:
    def __init__(__self__, *, approval_stage_time_out_in_days: Optional[pulumi.Input[_builtins.int]] = ..., escalation_approvers: Optional[pulumi.Input[Sequence[pulumi.Input[UserSetArgs]]]] = ..., escalation_time_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., is_approver_justification_required: Optional[pulumi.Input[_builtins.bool]] = ..., is_escalation_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., primary_approvers: Optional[pulumi.Input[Sequence[pulumi.Input[UserSetArgs]]]] = ...) -> None:
    ...
    def approval_stage_time_out_in_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def escalation_approvers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[UserSetArgs]]]]): # -> None:
        ...
    ...
    def escalation_time_in_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def is_approver_justification_required(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_escalation_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def primary_approvers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[UserSetArgs]]]]): # -> None:
        ...
...
class ManagementLockOwnerArgs:
    def __init__(__self__, *, application_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NonComplianceMessageArgs:
    def __init__(__self__, *, message: pulumi.Input[_builtins.str], policy_definition_reference_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class OverrideArgs:
    def __init__(__self__, *, kind: Optional[pulumi.Input[Union[_builtins.str, OverrideKind]]] = ..., selectors: Optional[pulumi.Input[Sequence[pulumi.Input[SelectorArgs]]]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @kind.setter
    def kind(self, value: Optional[pulumi.Input[Union[_builtins.str, OverrideKind]]]): # -> None:
        ...
    ...
    @selectors.setter
    def selectors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SelectorArgs]]]]): # -> None:
        ...
...
class PIMOnlyModeSettingsArgs:
    def __init__(__self__, *, excluded_assignment_types: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ExcludedPrincipalTypes]]]]] = ..., excludes: Optional[pulumi.Input[Sequence[pulumi.Input[UsersOrServicePrincipalSetArgs]]]] = ..., mode: Optional[pulumi.Input[Union[_builtins.str, PIMOnlyMode]]] = ...) -> None:
    ...
    def excluded_assignment_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ExcludedPrincipalTypes]]]]]): # -> None:
        ...
    ...
    @excludes.setter
    def excludes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[UsersOrServicePrincipalSetArgs]]]]): # -> None:
        ...
    ...
    @mode.setter
    def mode(self, value: Optional[pulumi.Input[Union[_builtins.str, PIMOnlyMode]]]): # -> None:
        ...
...
class ParameterDefinitionsValueMetadataArgs:
    def __init__(__self__, *, assign_permissions: Optional[pulumi.Input[_builtins.bool]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., strong_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def assign_permissions(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @strong_type.setter
    def strong_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ParameterDefinitionsValueArgs:
    def __init__(__self__, *, allowed_values: Optional[pulumi.Input[Sequence[Any]]] = ..., default_value: Optional[Any] = ..., metadata: Optional[pulumi.Input[ParameterDefinitionsValueMetadataArgs]] = ..., schema: Optional[Any] = ..., type: Optional[pulumi.Input[Union[_builtins.str, ParameterType]]] = ...) -> None:
    ...
    def allowed_values(self, value: Optional[pulumi.Input[Sequence[Any]]]): # -> None:
        ...
    ...
    def default_value(self, value: Optional[Any]): # -> None:
        ...
    ...
    @metadata.setter
    def metadata(self, value: Optional[pulumi.Input[ParameterDefinitionsValueMetadataArgs]]): # -> None:
        ...
...
class PermissionArgs:
    def __init__(__self__, *, actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., data_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., not_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., not_data_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @not_actions.setter
    def not_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class PolicyDefinitionGroupArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], additional_metadata_id: Optional[pulumi.Input[_builtins.str]] = ..., category: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def additional_metadata_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PolicyDefinitionReferenceArgs:
    def __init__(__self__, *, policy_definition_id: pulumi.Input[_builtins.str], definition_version: Optional[pulumi.Input[_builtins.str]] = ..., group_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[ParameterValuesValueArgs]]]] = ..., policy_definition_reference_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def policy_definition_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PolicyVariableValueColumnValueArgs:
    def __init__(__self__, *, column_name: pulumi.Input[_builtins.str], column_value: Any) -> None:
    ...
    @column_value.setter
    def column_value(self, value: Any): # -> None:
        ...
...
class PrivateLinkAssociationPropertiesArgs:
    def __init__(__self__, *, private_link: Optional[pulumi.Input[_builtins.str]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccessOptions]]] = ...) -> None:
    ...
    @private_link.setter
    def private_link(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def public_network_access(self, value: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccessOptions]]]): # -> None:
        ...
...
class ResourceSelectorArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., selectors: Optional[pulumi.Input[Sequence[pulumi.Input[SelectorArgs]]]] = ...) -> None:
...
class RoleEligibilityScheduleRequestPropertiesExpirationArgs:
    def __init__(__self__, *, duration: Optional[pulumi.Input[_builtins.str]] = ..., end_date_time: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, Type]]] = ...) -> None:
...
class RoleEligibilityScheduleRequestPropertiesScheduleInfoArgs:
    def __init__(__self__, *, expiration: Optional[pulumi.Input[RoleEligibilityScheduleRequestPropertiesExpirationArgs]] = ..., start_date_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @expiration.setter
    def expiration(self, value: Optional[pulumi.Input[RoleEligibilityScheduleRequestPropertiesExpirationArgs]]): # -> None:
        ...
...
class RoleEligibilityScheduleRequestPropertiesTicketInfoArgs:
    def __init__(__self__, *, ticket_number: Optional[pulumi.Input[_builtins.str]] = ..., ticket_system: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ticket_number(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ticket_system(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RoleManagementPolicyApprovalRuleArgs:
    def __init__(__self__, *, rule_type: pulumi.Input[_builtins.str], id: Optional[pulumi.Input[_builtins.str]] = ..., setting: Optional[pulumi.Input[ApprovalSettingsArgs]] = ..., target: Optional[pulumi.Input[RoleManagementPolicyRuleTargetArgs]] = ...) -> None:
    ...
    @setting.setter
    def setting(self, value: Optional[pulumi.Input[ApprovalSettingsArgs]]): # -> None:
        ...
    ...
    @target.setter
    def target(self, value: Optional[pulumi.Input[RoleManagementPolicyRuleTargetArgs]]): # -> None:
        ...
...
class RoleManagementPolicyAuthenticationContextRuleArgs:
    def __init__(__self__, *, rule_type: pulumi.Input[_builtins.str], claim_value: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., is_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., target: Optional[pulumi.Input[RoleManagementPolicyRuleTargetArgs]] = ...) -> None:
    ...
    @claim_value.setter
    def claim_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RoleManagementPolicyEnablementRuleArgs:
    def __init__(__self__, *, rule_type: pulumi.Input[_builtins.str], enabled_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, EnablementRules]]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., target: Optional[pulumi.Input[RoleManagementPolicyRuleTargetArgs]] = ...) -> None:
    ...
    def enabled_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, EnablementRules]]]]]): # -> None:
        ...
...
class RoleManagementPolicyExpirationRuleArgs:
    def __init__(__self__, *, rule_type: pulumi.Input[_builtins.str], exception_members: Optional[pulumi.Input[Sequence[pulumi.Input[UserSetArgs]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., is_expiration_required: Optional[pulumi.Input[_builtins.bool]] = ..., maximum_duration: Optional[pulumi.Input[_builtins.str]] = ..., target: Optional[pulumi.Input[RoleManagementPolicyRuleTargetArgs]] = ...) -> None:
    ...
    def exception_members(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[UserSetArgs]]]]): # -> None:
        ...
    ...
    def is_expiration_required(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def maximum_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RoleManagementPolicyNotificationRuleArgs:
    def __init__(__self__, *, rule_type: pulumi.Input[_builtins.str], id: Optional[pulumi.Input[_builtins.str]] = ..., is_default_recipients_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., notification_level: Optional[pulumi.Input[Union[_builtins.str, NotificationLevel]]] = ..., notification_recipients: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., notification_type: Optional[pulumi.Input[Union[_builtins.str, NotificationDeliveryMechanism]]] = ..., recipient_type: Optional[pulumi.Input[Union[_builtins.str, RecipientType]]] = ..., target: Optional[pulumi.Input[RoleManagementPolicyRuleTargetArgs]] = ...) -> None:
    ...
    def is_default_recipients_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def notification_level(self, value: Optional[pulumi.Input[Union[_builtins.str, NotificationLevel]]]): # -> None:
        ...
    ...
    def notification_recipients(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def notification_type(self, value: Optional[pulumi.Input[Union[_builtins.str, NotificationDeliveryMechanism]]]): # -> None:
        ...
    ...
    def recipient_type(self, value: Optional[pulumi.Input[Union[_builtins.str, RecipientType]]]): # -> None:
        ...
...
class RoleManagementPolicyPimOnlyModeRuleArgs:
    def __init__(__self__, *, rule_type: pulumi.Input[_builtins.str], id: Optional[pulumi.Input[_builtins.str]] = ..., pim_only_mode_settings: Optional[pulumi.Input[PIMOnlyModeSettingsArgs]] = ..., target: Optional[pulumi.Input[RoleManagementPolicyRuleTargetArgs]] = ...) -> None:
    ...
    def pim_only_mode_settings(self, value: Optional[pulumi.Input[PIMOnlyModeSettingsArgs]]): # -> None:
        ...
...
class RoleManagementPolicyRuleTargetArgs:
    def __init__(__self__, *, caller: Optional[pulumi.Input[_builtins.str]] = ..., enforced_settings: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., inheritable_settings: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., level: Optional[pulumi.Input[_builtins.str]] = ..., operations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., target_objects: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @caller.setter
    def caller(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def enforced_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def inheritable_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @operations.setter
    def operations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def target_objects(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
@pulumi.input_type
class SelectorArgs:
    def __init__(__self__, *, in_: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., kind: Optional[pulumi.Input[Union[_builtins.str, SelectorKind]]] = ..., not_in: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @in_.setter
    def in_(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @kind.setter
    def kind(self, value: Optional[pulumi.Input[Union[_builtins.str, SelectorKind]]]): # -> None:
        ...
    ...
    @not_in.setter
    def not_in(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
@pulumi.input_type
class UserSetArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., is_backup: Optional[pulumi.Input[_builtins.bool]] = ..., user_type: Optional[pulumi.Input[Union[_builtins.str, UserType]]] = ...) -> None:
    ...
    @is_backup.setter
    def is_backup(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @user_type.setter
    def user_type(self, value: Optional[pulumi.Input[Union[_builtins.str, UserType]]]): # -> None:
        ...
...
class UsersOrServicePrincipalSetArgs:
    def __init__(__self__, *, display_name: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, UserType]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, UserType]]]): # -> None:
        ...
