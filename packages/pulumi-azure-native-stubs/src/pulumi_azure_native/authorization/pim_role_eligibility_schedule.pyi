...
class PimRoleEligibilityScheduleArgs:
    def __init__(__self__, *, principal_id: pulumi.Input[_builtins.str], role_definition_id: pulumi.Input[_builtins.str], scope: pulumi.Input[_builtins.str], condition: Optional[pulumi.Input[_builtins.str]] = ..., condition_version: Optional[pulumi.Input[_builtins.str]] = ..., justification: Optional[pulumi.Input[_builtins.str]] = ..., schedule_info: Optional[pulumi.Input[RoleEligibilityScheduleRequestPropertiesScheduleInfoArgs]] = ..., target_role_eligibility_schedule_id: Optional[pulumi.Input[_builtins.str]] = ..., target_role_eligibility_schedule_instance_id: Optional[pulumi.Input[_builtins.str]] = ..., ticket_info: Optional[pulumi.Input[RoleEligibilityScheduleRequestPropertiesTicketInfoArgs]] = ...) -> None:
    ...
    def condition_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def schedule_info(self, value: Optional[pulumi.Input[RoleEligibilityScheduleRequestPropertiesScheduleInfoArgs]]): # -> None:
        ...
    ...
    def target_role_eligibility_schedule_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_role_eligibility_schedule_instance_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @ticket_info.setter
    def ticket_info(self, value: Optional[pulumi.Input[RoleEligibilityScheduleRequestPropertiesTicketInfoArgs]]): # -> None:
        ...
...
class PimRoleEligibilitySchedule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., condition: Optional[pulumi.Input[_builtins.str]] = ..., condition_version: Optional[pulumi.Input[_builtins.str]] = ..., justification: Optional[pulumi.Input[_builtins.str]] = ..., principal_id: Optional[pulumi.Input[_builtins.str]] = ..., role_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., schedule_info: Optional[pulumi.Input[Union[RoleEligibilityScheduleRequestPropertiesScheduleInfoArgs, RoleEligibilityScheduleRequestPropertiesScheduleInfoArgsDict]]] = ..., scope: Optional[pulumi.Input[_builtins.str]] = ..., target_role_eligibility_schedule_id: Optional[pulumi.Input[_builtins.str]] = ..., target_role_eligibility_schedule_instance_id: Optional[pulumi.Input[_builtins.str]] = ..., ticket_info: Optional[pulumi.Input[Union[RoleEligibilityScheduleRequestPropertiesTicketInfoArgs, RoleEligibilityScheduleRequestPropertiesTicketInfoArgsDict]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: PimRoleEligibilityScheduleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> PimRoleEligibilitySchedule:
    ...
    @_builtins.property
    @pulumi.getter(name="targetRoleEligibilityScheduleId")
    def target_role_eligibility_schedule_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="targetRoleEligibilityScheduleInstanceId")
    def target_role_eligibility_schedule_instance_id(self) -> pulumi.Output[Optional[_builtins.str]]:
