...
class ManagementLockAtSubscriptionLevelArgs:
    def __init__(__self__, *, level: pulumi.Input[Union[_builtins.str, LockLevel]], lock_name: Optional[pulumi.Input[_builtins.str]] = ..., notes: Optional[pulumi.Input[_builtins.str]] = ..., owners: Optional[pulumi.Input[Sequence[pulumi.Input[ManagementLockOwnerArgs]]]] = ...) -> None:
...
class ManagementLockAtSubscriptionLevel(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., level: Optional[pulumi.Input[Union[_builtins.str, LockLevel]]] = ..., lock_name: Optional[pulumi.Input[_builtins.str]] = ..., notes: Optional[pulumi.Input[_builtins.str]] = ..., owners: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ManagementLockOwnerArgs, ManagementLockOwnerArgsDict]]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ManagementLockAtSubscriptionLevelArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ManagementLockAtSubscriptionLevel:
