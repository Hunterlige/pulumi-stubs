...
class RoleManagementPolicyAssignmentArgs:
    def __init__(__self__, *, scope: pulumi.Input[_builtins.str], policy_id: Optional[pulumi.Input[_builtins.str]] = ..., role_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., role_management_policy_assignment_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def role_management_policy_assignment_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RoleManagementPolicyAssignment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., policy_id: Optional[pulumi.Input[_builtins.str]] = ..., role_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., role_management_policy_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: RoleManagementPolicyAssignmentArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> RoleManagementPolicyAssignment:
