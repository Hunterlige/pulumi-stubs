...
class AwaitableGetManagementLockAtResourceGroupLevelResult(
    GetManagementLockAtResourceGroupLevelResult
):
    def __await__(self): ...

def get_management_lock_at_resource_group_level(
    lock_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetManagementLockAtResourceGroupLevelResult: ...
def get_management_lock_at_resource_group_level_output(
    lock_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetManagementLockAtResourceGroupLevelResult]: ...
