...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetPolicySetDefinitionResult', 'AwaitableGetPolicySetDefinitionResult', 'get_policy_set_definition', 'get_policy_set_definition_output']
@pulumi.output_type
...
class AwaitableGetPolicySetDefinitionResult(GetPolicySetDefinitionResult):
    def __await__(self): # -> Generator[Never, Any, GetPolicySetDefinitionResult]:
        ...
    


def get_policy_set_definition(expand: Optional[_builtins.str] = ..., policy_set_definition_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetPolicySetDefinitionResult:
    
    ...

def get_policy_set_definition_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., policy_set_definition_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetPolicySetDefinitionResult]:
