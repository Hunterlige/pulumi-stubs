...
class AwaitableGetAccessReviewHistoryDefinitionByIdResult(
    GetAccessReviewHistoryDefinitionByIdResult
):
    def __await__(self): ...

def get_access_review_history_definition_by_id(
    history_definition_id: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetAccessReviewHistoryDefinitionByIdResult: ...
def get_access_review_history_definition_by_id_output(
    history_definition_id: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetAccessReviewHistoryDefinitionByIdResult]: ...
