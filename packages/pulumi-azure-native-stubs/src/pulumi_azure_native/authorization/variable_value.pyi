...
class VariableValueArgs:
    def __init__(__self__, *, values: pulumi.Input[Sequence[pulumi.Input[PolicyVariableValueColumnValueArgs]]], variable_name: pulumi.Input[_builtins.str], variable_value_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VariableValue(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., values: Optional[pulumi.Input[Sequence[pulumi.Input[Union[PolicyVariableValueColumnValueArgs, PolicyVariableValueColumnValueArgsDict]]]]] = ..., variable_name: Optional[pulumi.Input[_builtins.str]] = ..., variable_value_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: VariableValueArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> VariableValue:
