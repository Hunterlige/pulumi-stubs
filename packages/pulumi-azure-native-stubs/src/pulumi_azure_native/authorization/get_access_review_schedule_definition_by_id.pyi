...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetAccessReviewScheduleDefinitionByIdResult', ..., 'get_access_review_schedule_definition_by_id', 'get_access_review_schedule_definition_by_id_output']
@pulumi.output_type
...
class AwaitableGetAccessReviewScheduleDefinitionByIdResult(GetAccessReviewScheduleDefinitionByIdResult):
    def __await__(self): # -> Generator[Never, Any, GetAccessReviewScheduleDefinitionByIdResult]:
        ...
    


def get_access_review_schedule_definition_by_id(schedule_definition_id: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAccessReviewScheduleDefinitionByIdResult:
    
    ...

def get_access_review_schedule_definition_by_id_output(schedule_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAccessReviewScheduleDefinitionByIdResult]:
