...
class RoleAssignmentArgs:
    def __init__(__self__, *, principal_id: pulumi.Input[_builtins.str], role_definition_id: pulumi.Input[_builtins.str], scope: pulumi.Input[_builtins.str], condition: Optional[pulumi.Input[_builtins.str]] = ..., condition_version: Optional[pulumi.Input[_builtins.str]] = ..., delegated_managed_identity_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., principal_type: Optional[pulumi.Input[Union[_builtins.str, PrincipalType]]] = ..., role_assignment_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def delegated_managed_identity_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def role_assignment_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RoleAssignment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., condition: Optional[pulumi.Input[_builtins.str]] = ..., condition_version: Optional[pulumi.Input[_builtins.str]] = ..., delegated_managed_identity_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., principal_id: Optional[pulumi.Input[_builtins.str]] = ..., principal_type: Optional[pulumi.Input[Union[_builtins.str, PrincipalType]]] = ..., role_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., role_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
