...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetScopeAccessReviewScheduleDefinitionByIdResult', ..., 'get_scope_access_review_schedule_definition_by_id', ...]
@pulumi.output_type
class GetScopeAccessReviewScheduleDefinitionByIdResult:
    
    def __init__(__self__, auto_apply_decisions_enabled=..., azure_api_version=..., backup_reviewers=..., default_decision=..., default_decision_enabled=..., description_for_admins=..., description_for_reviewers=..., display_name=..., id=..., instance_duration_in_days=..., instances=..., interval=..., justification_required_on_approval=..., mail_notifications_enabled=..., name=..., principal_id=..., principal_name=..., principal_type=..., range=..., recommendation_look_back_duration=..., recommendations_enabled=..., reminder_notifications_enabled=..., reviewers=..., reviewers_type=..., scope=..., status=..., type=..., user_principal_name=...) -> None:
        ...
...
class AwaitableGetScopeAccessReviewScheduleDefinitionByIdResult(GetScopeAccessReviewScheduleDefinitionByIdResult):
    def __await__(self): # -> Generator[Never, Any, GetScopeAccessReviewScheduleDefinitionByIdResult]:
        ...
    


def get_scope_access_review_schedule_definition_by_id(schedule_definition_id: Optional[_builtins.str] = ..., scope: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetScopeAccessReviewScheduleDefinitionByIdResult:
    
    ...

def get_scope_access_review_schedule_definition_by_id_output(schedule_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetScopeAccessReviewScheduleDefinitionByIdResult]:
