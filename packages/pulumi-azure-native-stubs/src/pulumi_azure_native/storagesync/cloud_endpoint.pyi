...
class CloudEndpointArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], storage_sync_service_name: pulumi.Input[_builtins.str], sync_group_name: pulumi.Input[_builtins.str], azure_file_share_name: Optional[pulumi.Input[_builtins.str]] = ..., cloud_endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., friendly_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cloud_endpoint_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def storage_account_tenant_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CloudEndpoint(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., azure_file_share_name: Optional[pulumi.Input[_builtins.str]] = ..., cloud_endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., friendly_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_sync_service_name: Optional[pulumi.Input[_builtins.str]] = ..., sync_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: CloudEndpointArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> CloudEndpoint:
