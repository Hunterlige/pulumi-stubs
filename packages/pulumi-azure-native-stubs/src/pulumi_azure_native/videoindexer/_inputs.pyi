...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'StorageServicesForPutRequestArgs', 'StorageServicesForPutRequestArgsDict']
...
class StorageServicesForPutRequestArgs:
    def __init__(__self__, *, resource_id: Optional[pulumi.Input[_builtins.str]] = ..., user_assigned_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
