...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ManagedServiceIdentityResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'StorageServicesForPutRequestResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
...
class StorageServicesForPutRequestResponse(dict):
    ...
    def __init__(__self__, *, resource_id: Optional[_builtins.str] = ..., user_assigned_identity: Optional[_builtins.str] = ...) -> None:
