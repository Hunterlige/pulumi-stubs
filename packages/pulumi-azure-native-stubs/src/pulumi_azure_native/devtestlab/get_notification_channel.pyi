...
class GetNotificationChannelResult:
    ...
    def __init__(__self__, azure_api_version=..., created_date=..., description=..., email_recipient=..., events=..., id=..., location=..., name=..., notification_locale=..., provisioning_state=..., system_data=..., tags=..., type=..., unique_identifier=..., web_hook_url=...) -> None:
        ...
...
def get_notification_channel(expand: Optional[_builtins.str] = ..., lab_name: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetNotificationChannelResult:
    
    ...

def get_notification_channel_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., lab_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetNotificationChannelResult]:
