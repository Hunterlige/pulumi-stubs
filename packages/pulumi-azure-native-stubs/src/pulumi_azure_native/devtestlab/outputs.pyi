...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicableScheduleResponse', 'ArmTemplateParameterPropertiesResponse', 'ArtifactDeploymentStatusPropertiesResponse', 'ArtifactInstallPropertiesResponse', 'ArtifactParameterPropertiesResponse', 'AttachNewDataDiskOptionsResponse', 'BulkCreationParametersResponse', 'ComputeDataDiskResponse', 'ComputeVmInstanceViewStatusResponse', 'ComputeVmPropertiesResponse', 'CustomImagePropertiesCustomResponse', 'CustomImagePropertiesFromPlanResponse', 'CustomImagePropertiesFromVmResponse', 'DataDiskPropertiesResponse', 'DataDiskStorageTypeInfoResponse', 'DayDetailsResponse', 'EnvironmentDeploymentPropertiesResponse', 'EventResponse', 'ExternalSubnetResponse', 'FormulaPropertiesFromVmResponse', 'GalleryImageReferenceResponse', 'HourDetailsResponse', 'IdentityPropertiesResponse', 'InboundNatRuleResponse', 'LabAnnouncementPropertiesResponse', 'LabSupportPropertiesResponse', 'LabVhdResponse', 'LabVirtualMachineCreationParameterResponse', 'LinuxOsInfoResponse', 'NetworkInterfacePropertiesResponse', 'NotificationSettingsResponse', 'PortResponse', 'ScheduleCreationParameterResponse', 'ScheduleResponse', 'SharedPublicIpAddressConfigurationResponse', 'SubnetOverrideResponse', 'SubnetResponse', 'SubnetSharedPublicIpAddressConfigurationResponse', 'SystemDataResponse', 'UserIdentityResponse', 'UserSecretStoreResponse', 'WeekDetailsResponse', 'WindowsOsInfoResponse']
@pulumi.output_type
class ApplicableScheduleResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str, lab_vms_shutdown: Optional[outputs.ScheduleResponse] = ..., lab_vms_startup: Optional[outputs.ScheduleResponse] = ..., location: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ArtifactDeploymentStatusPropertiesResponse(dict):
    ...
    def __init__(__self__, *, artifacts_applied: Optional[_builtins.int] = ..., deployment_status: Optional[_builtins.str] = ..., total_artifacts: Optional[_builtins.int] = ...) -> None:
...
class ArtifactInstallPropertiesResponse(dict):
    ...
    def __init__(__self__, *, artifact_id: Optional[_builtins.str] = ..., artifact_title: Optional[_builtins.str] = ..., deployment_status_message: Optional[_builtins.str] = ..., install_time: Optional[_builtins.str] = ..., parameters: Optional[Sequence[outputs.ArtifactParameterPropertiesResponse]] = ..., status: Optional[_builtins.str] = ..., vm_extension_status_message: Optional[_builtins.str] = ...) -> None:
...
class AttachNewDataDiskOptionsResponse(dict):
    ...
    def __init__(__self__, *, disk_name: Optional[_builtins.str] = ..., disk_size_gi_b: Optional[_builtins.int] = ..., disk_type: Optional[_builtins.str] = ...) -> None:
...
class BulkCreationParametersResponse(dict):
    ...
    def __init__(__self__, *, instance_count: Optional[_builtins.int] = ...) -> None:
...
class ComputeDataDiskResponse(dict):
    ...
    def __init__(__self__, *, disk_size_gi_b: Optional[_builtins.int] = ..., disk_uri: Optional[_builtins.str] = ..., managed_disk_id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class ComputeVmInstanceViewStatusResponse(dict):
    ...
    def __init__(__self__, *, code: Optional[_builtins.str] = ..., display_status: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ...) -> None:
...
class ComputeVmPropertiesResponse(dict):
    ...
    def __init__(__self__, *, data_disk_ids: Optional[Sequence[_builtins.str]] = ..., data_disks: Optional[Sequence[outputs.ComputeDataDiskResponse]] = ..., network_interface_id: Optional[_builtins.str] = ..., os_disk_id: Optional[_builtins.str] = ..., os_type: Optional[_builtins.str] = ..., statuses: Optional[Sequence[outputs.ComputeVmInstanceViewStatusResponse]] = ..., vm_size: Optional[_builtins.str] = ...) -> None:
...
class CustomImagePropertiesCustomResponse(dict):
    ...
    def __init__(__self__, *, os_type: _builtins.str, image_name: Optional[_builtins.str] = ..., sys_prep: Optional[_builtins.bool] = ...) -> None:
...
class CustomImagePropertiesFromPlanResponse(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., offer: Optional[_builtins.str] = ..., publisher: Optional[_builtins.str] = ...) -> None:
...
class CustomImagePropertiesFromVmResponse(dict):
    ...
    def __init__(__self__, *, linux_os_info: Optional[outputs.LinuxOsInfoResponse] = ..., source_vm_id: Optional[_builtins.str] = ..., windows_os_info: Optional[outputs.WindowsOsInfoResponse] = ...) -> None:
...
class DataDiskPropertiesResponse(dict):
    ...
    def __init__(__self__, *, attach_new_data_disk_options: Optional[outputs.AttachNewDataDiskOptionsResponse] = ..., existing_lab_disk_id: Optional[_builtins.str] = ..., host_caching: Optional[_builtins.str] = ...) -> None:
...
class DataDiskStorageTypeInfoResponse(dict):
    ...
    def __init__(__self__, *, lun: Optional[_builtins.str] = ..., storage_type: Optional[_builtins.str] = ...) -> None:
...
class EnvironmentDeploymentPropertiesResponse(dict):
    ...
    def __init__(__self__, *, arm_template_id: Optional[_builtins.str] = ..., parameters: Optional[Sequence[outputs.ArmTemplateParameterPropertiesResponse]] = ...) -> None:
...
class GalleryImageReferenceResponse(dict):
    ...
    def __init__(__self__, *, offer: Optional[_builtins.str] = ..., os_type: Optional[_builtins.str] = ..., publisher: Optional[_builtins.str] = ..., sku: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class IdentityPropertiesResponse(dict):
    ...
    def __init__(__self__, *, client_secret_url: Optional[_builtins.str] = ..., principal_id: Optional[_builtins.str] = ..., tenant_id: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class InboundNatRuleResponse(dict):
    ...
    def __init__(__self__, *, backend_port: Optional[_builtins.int] = ..., frontend_port: Optional[_builtins.int] = ..., transport_protocol: Optional[_builtins.str] = ...) -> None:
...
class LabAnnouncementPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, unique_identifier: _builtins.str, enabled: Optional[_builtins.str] = ..., expiration_date: Optional[_builtins.str] = ..., expired: Optional[_builtins.bool] = ..., markdown: Optional[_builtins.str] = ..., title: Optional[_builtins.str] = ...) -> None:
...
class LabSupportPropertiesResponse(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.str] = ..., markdown: Optional[_builtins.str] = ...) -> None:
...
class LabVirtualMachineCreationParameterResponse(dict):
    ...
    def __init__(__self__, *, allow_claim: Optional[_builtins.bool] = ..., artifacts: Optional[Sequence[outputs.ArtifactInstallPropertiesResponse]] = ..., bulk_creation_parameters: Optional[outputs.BulkCreationParametersResponse] = ..., created_date: Optional[_builtins.str] = ..., custom_image_id: Optional[_builtins.str] = ..., data_disk_parameters: Optional[Sequence[outputs.DataDiskPropertiesResponse]] = ..., disallow_public_ip_address: Optional[_builtins.bool] = ..., environment_id: Optional[_builtins.str] = ..., expiration_date: Optional[_builtins.str] = ..., gallery_image_reference: Optional[outputs.GalleryImageReferenceResponse] = ..., is_authentication_with_ssh_key: Optional[_builtins.bool] = ..., lab_subnet_name: Optional[_builtins.str] = ..., lab_virtual_network_id: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., network_interface: Optional[outputs.NetworkInterfacePropertiesResponse] = ..., notes: Optional[_builtins.str] = ..., owner_object_id: Optional[_builtins.str] = ..., owner_user_principal_name: Optional[_builtins.str] = ..., password: Optional[_builtins.str] = ..., plan_id: Optional[_builtins.str] = ..., schedule_parameters: Optional[Sequence[outputs.ScheduleCreationParameterResponse]] = ..., size: Optional[_builtins.str] = ..., ssh_key: Optional[_builtins.str] = ..., storage_type: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., user_name: Optional[_builtins.str] = ...) -> None:
...
class LinuxOsInfoResponse(dict):
    ...
    def __init__(__self__, *, linux_os_state: Optional[_builtins.str] = ...) -> None:
...
class NetworkInterfacePropertiesResponse(dict):
    ...
    def __init__(__self__, *, dns_name: Optional[_builtins.str] = ..., private_ip_address: Optional[_builtins.str] = ..., public_ip_address: Optional[_builtins.str] = ..., public_ip_address_id: Optional[_builtins.str] = ..., rdp_authority: Optional[_builtins.str] = ..., shared_public_ip_address_configuration: Optional[outputs.SharedPublicIpAddressConfigurationResponse] = ..., ssh_authority: Optional[_builtins.str] = ..., subnet_id: Optional[_builtins.str] = ..., virtual_network_id: Optional[_builtins.str] = ...) -> None:
...
class NotificationSettingsResponse(dict):
    ...
    def __init__(__self__, *, email_recipient: Optional[_builtins.str] = ..., notification_locale: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., time_in_minutes: Optional[_builtins.int] = ..., webhook_url: Optional[_builtins.str] = ...) -> None:
...
class PortResponse(dict):
    ...
    def __init__(__self__, *, backend_port: Optional[_builtins.int] = ..., transport_protocol: Optional[_builtins.str] = ...) -> None:
...
class ScheduleCreationParameterResponse(dict):
    ...
    def __init__(__self__, *, location: _builtins.str, daily_recurrence: Optional[outputs.DayDetailsResponse] = ..., hourly_recurrence: Optional[outputs.HourDetailsResponse] = ..., name: Optional[_builtins.str] = ..., notification_settings: Optional[outputs.NotificationSettingsResponse] = ..., status: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., target_resource_id: Optional[_builtins.str] = ..., task_type: Optional[_builtins.str] = ..., time_zone_id: Optional[_builtins.str] = ..., weekly_recurrence: Optional[outputs.WeekDetailsResponse] = ...) -> None:
...
class ScheduleResponse(dict):
    ...
    def __init__(__self__, *, created_date: _builtins.str, id: _builtins.str, name: _builtins.str, provisioning_state: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str, unique_identifier: _builtins.str, daily_recurrence: Optional[outputs.DayDetailsResponse] = ..., hourly_recurrence: Optional[outputs.HourDetailsResponse] = ..., location: Optional[_builtins.str] = ..., notification_settings: Optional[outputs.NotificationSettingsResponse] = ..., status: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., target_resource_id: Optional[_builtins.str] = ..., task_type: Optional[_builtins.str] = ..., time_zone_id: Optional[_builtins.str] = ..., weekly_recurrence: Optional[outputs.WeekDetailsResponse] = ...) -> None:
...
class SharedPublicIpAddressConfigurationResponse(dict):
    ...
    def __init__(__self__, *, inbound_nat_rules: Optional[Sequence[outputs.InboundNatRuleResponse]] = ...) -> None:
...
class SubnetOverrideResponse(dict):
    ...
    def __init__(__self__, *, lab_subnet_name: Optional[_builtins.str] = ..., resource_id: Optional[_builtins.str] = ..., shared_public_ip_address_configuration: Optional[outputs.SubnetSharedPublicIpAddressConfigurationResponse] = ..., use_in_vm_creation_permission: Optional[_builtins.str] = ..., use_public_ip_address_permission: Optional[_builtins.str] = ..., virtual_network_pool_name: Optional[_builtins.str] = ...) -> None:
...
class SubnetResponse(dict):
    ...
    def __init__(__self__, *, allow_public_ip: Optional[_builtins.str] = ..., lab_subnet_name: Optional[_builtins.str] = ..., resource_id: Optional[_builtins.str] = ...) -> None:
...
class SubnetSharedPublicIpAddressConfigurationResponse(dict):
    ...
    def __init__(__self__, *, allowed_ports: Optional[Sequence[outputs.PortResponse]] = ...) -> None:
...
class UserIdentityResponse(dict):
    ...
    def __init__(__self__, *, app_id: Optional[_builtins.str] = ..., object_id: Optional[_builtins.str] = ..., principal_id: Optional[_builtins.str] = ..., principal_name: Optional[_builtins.str] = ..., tenant_id: Optional[_builtins.str] = ...) -> None:
...
class UserSecretStoreResponse(dict):
    ...
    def __init__(__self__, *, key_vault_id: Optional[_builtins.str] = ..., key_vault_uri: Optional[_builtins.str] = ...) -> None:
...
class WeekDetailsResponse(dict):
    ...
    def __init__(__self__, *, time: Optional[_builtins.str] = ..., weekdays: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class WindowsOsInfoResponse(dict):
    ...
    def __init__(__self__, *, windows_os_state: Optional[_builtins.str] = ...) -> None:
