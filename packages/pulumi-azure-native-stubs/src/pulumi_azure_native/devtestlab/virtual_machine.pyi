...
class VirtualMachine(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., allow_claim: Optional[pulumi.Input[_builtins.bool]] = ..., artifacts: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ArtifactInstallPropertiesArgs, ArtifactInstallPropertiesArgsDict]]]]] = ..., created_date: Optional[pulumi.Input[_builtins.str]] = ..., custom_image_id: Optional[pulumi.Input[_builtins.str]] = ..., data_disk_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DataDiskPropertiesArgs, DataDiskPropertiesArgsDict]]]]] = ..., disallow_public_ip_address: Optional[pulumi.Input[_builtins.bool]] = ..., environment_id: Optional[pulumi.Input[_builtins.str]] = ..., expiration_date: Optional[pulumi.Input[_builtins.str]] = ..., gallery_image_reference: Optional[pulumi.Input[Union[GalleryImageReferenceArgs, GalleryImageReferenceArgsDict]]] = ..., is_authentication_with_ssh_key: Optional[pulumi.Input[_builtins.bool]] = ..., lab_name: Optional[pulumi.Input[_builtins.str]] = ..., lab_subnet_name: Optional[pulumi.Input[_builtins.str]] = ..., lab_virtual_network_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., network_interface: Optional[pulumi.Input[Union[NetworkInterfacePropertiesArgs, NetworkInterfacePropertiesArgsDict]]] = ..., notes: Optional[pulumi.Input[_builtins.str]] = ..., owner_object_id: Optional[pulumi.Input[_builtins.str]] = ..., owner_user_principal_name: Optional[pulumi.Input[_builtins.str]] = ..., password: Optional[pulumi.Input[_builtins.str]] = ..., plan_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., schedule_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ScheduleCreationParameterArgs, ScheduleCreationParameterArgsDict]]]]] = ..., size: Optional[pulumi.Input[_builtins.str]] = ..., ssh_key: Optional[pulumi.Input[_builtins.str]] = ..., storage_type: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., user_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
