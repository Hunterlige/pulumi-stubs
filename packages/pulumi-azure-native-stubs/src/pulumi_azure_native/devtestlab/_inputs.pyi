...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ArmTemplateParameterPropertiesArgs', 'ArmTemplateParameterPropertiesArgsDict', 'ArtifactInstallPropertiesArgs', 'ArtifactInstallPropertiesArgsDict', 'ArtifactParameterPropertiesArgs', 'ArtifactParameterPropertiesArgsDict', 'AttachNewDataDiskOptionsArgs', 'AttachNewDataDiskOptionsArgsDict', 'BulkCreationParametersArgs', 'BulkCreationParametersArgsDict', 'CustomImagePropertiesCustomArgs', 'CustomImagePropertiesCustomArgsDict', 'CustomImagePropertiesFromPlanArgs', 'CustomImagePropertiesFromPlanArgsDict', 'CustomImagePropertiesFromVmArgs', 'CustomImagePropertiesFromVmArgsDict', 'DataDiskPropertiesArgs', 'DataDiskPropertiesArgsDict', 'DataDiskStorageTypeInfoArgs', 'DataDiskStorageTypeInfoArgsDict', 'DayDetailsArgs', 'DayDetailsArgsDict', 'EnvironmentDeploymentPropertiesArgs', 'EnvironmentDeploymentPropertiesArgsDict', 'EventArgs', 'EventArgsDict', 'FormulaPropertiesFromVmArgs', 'FormulaPropertiesFromVmArgsDict', 'GalleryImageReferenceArgs', 'GalleryImageReferenceArgsDict', 'HourDetailsArgs', 'HourDetailsArgsDict', 'IdentityPropertiesArgs', 'IdentityPropertiesArgsDict', 'InboundNatRuleArgs', 'InboundNatRuleArgsDict', 'LabAnnouncementPropertiesArgs', 'LabAnnouncementPropertiesArgsDict', 'LabSupportPropertiesArgs', 'LabSupportPropertiesArgsDict', 'LabVirtualMachineCreationParameterArgs', 'LabVirtualMachineCreationParameterArgsDict', 'LinuxOsInfoArgs', 'LinuxOsInfoArgsDict', 'NetworkInterfacePropertiesArgs', 'NetworkInterfacePropertiesArgsDict', 'NotificationSettingsArgs', 'NotificationSettingsArgsDict', 'PortArgs', 'PortArgsDict', 'ScheduleCreationParameterArgs', 'ScheduleCreationParameterArgsDict', 'SharedPublicIpAddressConfigurationArgs', 'SharedPublicIpAddressConfigurationArgsDict', 'SubnetOverrideArgs', 'SubnetOverrideArgsDict', 'SubnetSharedPublicIpAddressConfigurationArgs', 'SubnetSharedPublicIpAddressConfigurationArgsDict', 'SubnetArgs', 'SubnetArgsDict', 'UserIdentityArgs', 'UserIdentityArgsDict', 'UserSecretStoreArgs', 'UserSecretStoreArgsDict', 'WeekDetailsArgs', 'WeekDetailsArgsDict', 'WindowsOsInfoArgs', 'WindowsOsInfoArgsDict']
...
class ArtifactInstallPropertiesArgs:
    def __init__(__self__, *, artifact_id: Optional[pulumi.Input[_builtins.str]] = ..., artifact_title: Optional[pulumi.Input[_builtins.str]] = ..., deployment_status_message: Optional[pulumi.Input[_builtins.str]] = ..., install_time: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ArtifactParameterPropertiesArgs]]]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., vm_extension_status_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def artifact_title(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def deployment_status_message(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @install_time.setter
    def install_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ArtifactParameterPropertiesArgs]]]]): # -> None:
        ...
    ...
    def vm_extension_status_message(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AttachNewDataDiskOptionsArgs:
    def __init__(__self__, *, disk_name: Optional[pulumi.Input[_builtins.str]] = ..., disk_size_gi_b: Optional[pulumi.Input[_builtins.int]] = ..., disk_type: Optional[pulumi.Input[Union[_builtins.str, StorageType]]] = ...) -> None:
...
class BulkCreationParametersArgs:
    def __init__(__self__, *, instance_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class CustomImagePropertiesCustomArgs:
    def __init__(__self__, *, os_type: pulumi.Input[Union[_builtins.str, CustomImageOsType]], image_name: Optional[pulumi.Input[_builtins.str]] = ..., sys_prep: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @os_type.setter
    def os_type(self, value: pulumi.Input[Union[_builtins.str, CustomImageOsType]]): # -> None:
        ...
    ...
    @sys_prep.setter
    def sys_prep(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class CustomImagePropertiesFromPlanArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., offer: Optional[pulumi.Input[_builtins.str]] = ..., publisher: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CustomImagePropertiesFromVmArgs:
    def __init__(__self__, *, linux_os_info: Optional[pulumi.Input[LinuxOsInfoArgs]] = ..., source_vm_id: Optional[pulumi.Input[_builtins.str]] = ..., windows_os_info: Optional[pulumi.Input[WindowsOsInfoArgs]] = ...) -> None:
    ...
    def linux_os_info(self, value: Optional[pulumi.Input[LinuxOsInfoArgs]]): # -> None:
        ...
    ...
    @source_vm_id.setter
    def source_vm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def windows_os_info(self, value: Optional[pulumi.Input[WindowsOsInfoArgs]]): # -> None:
        ...
...
class DataDiskPropertiesArgs:
    def __init__(__self__, *, attach_new_data_disk_options: Optional[pulumi.Input[AttachNewDataDiskOptionsArgs]] = ..., existing_lab_disk_id: Optional[pulumi.Input[_builtins.str]] = ..., host_caching: Optional[pulumi.Input[Union[_builtins.str, HostCachingOptions]]] = ...) -> None:
    ...
    def attach_new_data_disk_options(self, value: Optional[pulumi.Input[AttachNewDataDiskOptionsArgs]]): # -> None:
        ...
    ...
    def existing_lab_disk_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @host_caching.setter
    def host_caching(self, value: Optional[pulumi.Input[Union[_builtins.str, HostCachingOptions]]]): # -> None:
        ...
...
class DataDiskStorageTypeInfoArgs:
    def __init__(__self__, *, lun: Optional[pulumi.Input[_builtins.str]] = ..., storage_type: Optional[pulumi.Input[Union[_builtins.str, StorageType]]] = ...) -> None:
    ...
    @lun.setter
    def lun(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DayDetailsArgs:
    def __init__(__self__, *, time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EnvironmentDeploymentPropertiesArgs:
    def __init__(__self__, *, arm_template_id: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ArmTemplateParameterPropertiesArgs]]]] = ...) -> None:
    ...
    def arm_template_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ArmTemplateParameterPropertiesArgs]]]]): # -> None:
        ...
...
@pulumi.input_type
class EventArgs:
    def __init__(__self__, *, event_name: Optional[pulumi.Input[Union[_builtins.str, NotificationChannelEventType]]] = ...) -> None:
    ...
    @event_name.setter
    def event_name(self, value: Optional[pulumi.Input[Union[_builtins.str, NotificationChannelEventType]]]): # -> None:
        ...
...
class FormulaPropertiesFromVmArgs:
    def __init__(__self__, *, lab_vm_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @lab_vm_id.setter
    def lab_vm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GalleryImageReferenceArgs:
    def __init__(__self__, *, offer: Optional[pulumi.Input[_builtins.str]] = ..., os_type: Optional[pulumi.Input[_builtins.str]] = ..., publisher: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class HourDetailsArgs:
    def __init__(__self__, *, minute: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class IdentityPropertiesArgs:
    def __init__(__self__, *, client_secret_url: Optional[pulumi.Input[_builtins.str]] = ..., principal_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, ManagedIdentityType]]] = ...) -> None:
    ...
    def client_secret_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InboundNatRuleArgs:
    def __init__(__self__, *, backend_port: Optional[pulumi.Input[_builtins.int]] = ..., frontend_port: Optional[pulumi.Input[_builtins.int]] = ..., transport_protocol: Optional[pulumi.Input[Union[_builtins.str, TransportProtocol]]] = ...) -> None:
    ...
    def transport_protocol(self, value: Optional[pulumi.Input[Union[_builtins.str, TransportProtocol]]]): # -> None:
        ...
...
class LabAnnouncementPropertiesArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[Union[_builtins.str, EnableStatus]]] = ..., expiration_date: Optional[pulumi.Input[_builtins.str]] = ..., expired: Optional[pulumi.Input[_builtins.bool]] = ..., markdown: Optional[pulumi.Input[_builtins.str]] = ..., title: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @enabled.setter
    def enabled(self, value: Optional[pulumi.Input[Union[_builtins.str, EnableStatus]]]): # -> None:
        ...
    ...
    @markdown.setter
    def markdown(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LabSupportPropertiesArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[Union[_builtins.str, EnableStatus]]] = ..., markdown: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LabVirtualMachineCreationParameterArgs:
    def __init__(__self__, *, allow_claim: Optional[pulumi.Input[_builtins.bool]] = ..., artifacts: Optional[pulumi.Input[Sequence[pulumi.Input[ArtifactInstallPropertiesArgs]]]] = ..., bulk_creation_parameters: Optional[pulumi.Input[BulkCreationParametersArgs]] = ..., created_date: Optional[pulumi.Input[_builtins.str]] = ..., custom_image_id: Optional[pulumi.Input[_builtins.str]] = ..., data_disk_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[DataDiskPropertiesArgs]]]] = ..., disallow_public_ip_address: Optional[pulumi.Input[_builtins.bool]] = ..., environment_id: Optional[pulumi.Input[_builtins.str]] = ..., expiration_date: Optional[pulumi.Input[_builtins.str]] = ..., gallery_image_reference: Optional[pulumi.Input[GalleryImageReferenceArgs]] = ..., is_authentication_with_ssh_key: Optional[pulumi.Input[_builtins.bool]] = ..., lab_subnet_name: Optional[pulumi.Input[_builtins.str]] = ..., lab_virtual_network_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., network_interface: Optional[pulumi.Input[NetworkInterfacePropertiesArgs]] = ..., notes: Optional[pulumi.Input[_builtins.str]] = ..., owner_object_id: Optional[pulumi.Input[_builtins.str]] = ..., owner_user_principal_name: Optional[pulumi.Input[_builtins.str]] = ..., password: Optional[pulumi.Input[_builtins.str]] = ..., plan_id: Optional[pulumi.Input[_builtins.str]] = ..., schedule_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ScheduleCreationParameterArgs]]]] = ..., size: Optional[pulumi.Input[_builtins.str]] = ..., ssh_key: Optional[pulumi.Input[_builtins.str]] = ..., storage_type: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., user_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @allow_claim.setter
    def allow_claim(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @artifacts.setter
    def artifacts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ArtifactInstallPropertiesArgs]]]]): # -> None:
        ...
    ...
    def bulk_creation_parameters(self, value: Optional[pulumi.Input[BulkCreationParametersArgs]]): # -> None:
        ...
    ...
    def custom_image_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def data_disk_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataDiskPropertiesArgs]]]]): # -> None:
        ...
    ...
    def disallow_public_ip_address(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def gallery_image_reference(self, value: Optional[pulumi.Input[GalleryImageReferenceArgs]]): # -> None:
        ...
    ...
    def is_authentication_with_ssh_key(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def lab_subnet_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def lab_virtual_network_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def network_interface(self, value: Optional[pulumi.Input[NetworkInterfacePropertiesArgs]]): # -> None:
        ...
    ...
    def owner_object_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def owner_user_principal_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def schedule_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ScheduleCreationParameterArgs]]]]): # -> None:
        ...
    ...
    @ssh_key.setter
    def ssh_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LinuxOsInfoArgs:
    def __init__(__self__, *, linux_os_state: Optional[pulumi.Input[Union[_builtins.str, LinuxOsState]]] = ...) -> None:
    ...
    def linux_os_state(self, value: Optional[pulumi.Input[Union[_builtins.str, LinuxOsState]]]): # -> None:
        ...
...
class NetworkInterfacePropertiesArgs:
    def __init__(__self__, *, dns_name: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., public_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., public_ip_address_id: Optional[pulumi.Input[_builtins.str]] = ..., rdp_authority: Optional[pulumi.Input[_builtins.str]] = ..., shared_public_ip_address_configuration: Optional[pulumi.Input[SharedPublicIpAddressConfigurationArgs]] = ..., ssh_authority: Optional[pulumi.Input[_builtins.str]] = ..., subnet_id: Optional[pulumi.Input[_builtins.str]] = ..., virtual_network_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def rdp_authority(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def shared_public_ip_address_configuration(self, value: Optional[pulumi.Input[SharedPublicIpAddressConfigurationArgs]]): # -> None:
        ...
    ...
    def ssh_authority(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NotificationSettingsArgs:
    def __init__(__self__, *, email_recipient: Optional[pulumi.Input[_builtins.str]] = ..., notification_locale: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, EnableStatus]]] = ..., time_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., webhook_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[_builtins.str, EnableStatus]]]): # -> None:
        ...
    ...
    def time_in_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
@pulumi.input_type
class PortArgs:
    def __init__(__self__, *, backend_port: Optional[pulumi.Input[_builtins.int]] = ..., transport_protocol: Optional[pulumi.Input[Union[_builtins.str, TransportProtocol]]] = ...) -> None:
...
class ScheduleCreationParameterArgs:
    def __init__(__self__, *, daily_recurrence: Optional[pulumi.Input[DayDetailsArgs]] = ..., hourly_recurrence: Optional[pulumi.Input[HourDetailsArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., notification_settings: Optional[pulumi.Input[NotificationSettingsArgs]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, EnableStatus]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., task_type: Optional[pulumi.Input[_builtins.str]] = ..., time_zone_id: Optional[pulumi.Input[_builtins.str]] = ..., weekly_recurrence: Optional[pulumi.Input[WeekDetailsArgs]] = ...) -> None:
    ...
    def daily_recurrence(self, value: Optional[pulumi.Input[DayDetailsArgs]]): # -> None:
        ...
    ...
    def hourly_recurrence(self, value: Optional[pulumi.Input[HourDetailsArgs]]): # -> None:
        ...
    ...
    def notification_settings(self, value: Optional[pulumi.Input[NotificationSettingsArgs]]): # -> None:
        ...
    ...
    def weekly_recurrence(self, value: Optional[pulumi.Input[WeekDetailsArgs]]): # -> None:
        ...
...
class SharedPublicIpAddressConfigurationArgs:
    def __init__(__self__, *, inbound_nat_rules: Optional[pulumi.Input[Sequence[pulumi.Input[InboundNatRuleArgs]]]] = ...) -> None:
...
class SubnetOverrideArgs:
    def __init__(__self__, *, lab_subnet_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ..., shared_public_ip_address_configuration: Optional[pulumi.Input[SubnetSharedPublicIpAddressConfigurationArgs]] = ..., use_in_vm_creation_permission: Optional[pulumi.Input[Union[_builtins.str, UsagePermissionType]]] = ..., use_public_ip_address_permission: Optional[pulumi.Input[Union[_builtins.str, UsagePermissionType]]] = ..., virtual_network_pool_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @shared_public_ip_address_configuration.setter
    def shared_public_ip_address_configuration(self, value: Optional[pulumi.Input[SubnetSharedPublicIpAddressConfigurationArgs]]): # -> None:
        ...
    ...
    def use_in_vm_creation_permission(self, value: Optional[pulumi.Input[Union[_builtins.str, UsagePermissionType]]]): # -> None:
        ...
    ...
    def use_public_ip_address_permission(self, value: Optional[pulumi.Input[Union[_builtins.str, UsagePermissionType]]]): # -> None:
        ...
    ...
    def virtual_network_pool_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SubnetSharedPublicIpAddressConfigurationArgs:
    def __init__(__self__, *, allowed_ports: Optional[pulumi.Input[Sequence[pulumi.Input[PortArgs]]]] = ...) -> None:
    ...
    def allowed_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PortArgs]]]]): # -> None:
        ...
...
@pulumi.input_type
class SubnetArgs:
    def __init__(__self__, *, allow_public_ip: Optional[pulumi.Input[Union[_builtins.str, UsagePermissionType]]] = ..., lab_subnet_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allow_public_ip(self, value: Optional[pulumi.Input[Union[_builtins.str, UsagePermissionType]]]): # -> None:
        ...
...
class UserIdentityArgs:
    def __init__(__self__, *, app_id: Optional[pulumi.Input[_builtins.str]] = ..., object_id: Optional[pulumi.Input[_builtins.str]] = ..., principal_id: Optional[pulumi.Input[_builtins.str]] = ..., principal_name: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def principal_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WeekDetailsArgs:
    def __init__(__self__, *, time: Optional[pulumi.Input[_builtins.str]] = ..., weekdays: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @weekdays.setter
    def weekdays(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class WindowsOsInfoArgs:
    def __init__(__self__, *, windows_os_state: Optional[pulumi.Input[Union[_builtins.str, WindowsOsState]]] = ...) -> None:
    ...
    def windows_os_state(self, value: Optional[pulumi.Input[Union[_builtins.str, WindowsOsState]]]): # -> None:
        ...
