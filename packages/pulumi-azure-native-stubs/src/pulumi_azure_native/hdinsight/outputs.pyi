...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationGetEndpointResponse', 'ApplicationGetHttpsEndpointResponse', 'ApplicationPropertiesResponse', 'AutoscaleCapacityResponse', 'AutoscaleRecurrenceResponse', 'AutoscaleResponse', 'AutoscaleScheduleResponse', 'AutoscaleTimeAndCapacityResponse', 'AzureMonitorSelectedConfigurationsResponse', 'AzureMonitorTableConfigurationResponse', 'ClientGroupInfoResponse', 'ClusterDefinitionResponse', 'ClusterGetPropertiesResponse', 'ClusterIdentityResponse', 'ComputeIsolationPropertiesResponse', 'ComputeProfileResponse', 'ConnectivityEndpointResponse', 'DataDisksGroupsResponse', 'DiskEncryptionPropertiesResponse', 'EncryptionInTransitPropertiesResponse', 'ErrorsResponse', 'ExcludedServicesConfigResponse', 'HardwareProfileResponse', 'IPConfigurationResponse', 'IpTagResponse', 'KafkaRestPropertiesResponse', 'LinuxOperatingSystemProfileResponse', 'NetworkPropertiesResponse', 'OsProfileResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkConfigurationResponse', 'PrivateLinkServiceConnectionStateResponse', 'QuotaInfoResponse', 'ResourceIdResponse', 'RoleResponse', 'RuntimeScriptActionResponse', 'ScriptActionResponse', 'SecurityProfileResponse', 'SshProfileResponse', 'SshPublicKeyResponse', 'StorageAccountResponse', 'StorageProfileResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse', 'VirtualNetworkProfileResponse']
@pulumi.output_type
class ApplicationGetEndpointResponse(dict):
    ...
    def __init__(__self__, *, destination_port: Optional[_builtins.int] = ..., location: Optional[_builtins.str] = ..., private_ip_address: Optional[_builtins.str] = ..., public_port: Optional[_builtins.int] = ...) -> None:
...
class ApplicationGetHttpsEndpointResponse(dict):
    ...
    def __init__(__self__, *, location: _builtins.str, public_port: _builtins.int, access_modes: Optional[Sequence[_builtins.str]] = ..., destination_port: Optional[_builtins.int] = ..., disable_gateway_auth: Optional[_builtins.bool] = ..., private_ip_address: Optional[_builtins.str] = ...) -> None:
...
class ApplicationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, application_state: _builtins.str, created_date: _builtins.str, marketplace_identifier: _builtins.str, provisioning_state: _builtins.str, application_type: Optional[_builtins.str] = ..., compute_profile: Optional[outputs.ComputeProfileResponse] = ..., errors: Optional[Sequence[outputs.ErrorsResponse]] = ..., https_endpoints: Optional[Sequence[outputs.ApplicationGetHttpsEndpointResponse]] = ..., install_script_actions: Optional[Sequence[outputs.RuntimeScriptActionResponse]] = ..., private_link_configurations: Optional[Sequence[outputs.PrivateLinkConfigurationResponse]] = ..., ssh_endpoints: Optional[Sequence[outputs.ApplicationGetEndpointResponse]] = ..., uninstall_script_actions: Optional[Sequence[outputs.RuntimeScriptActionResponse]] = ...) -> None:
...
class AutoscaleRecurrenceResponse(dict):
    ...
    def __init__(__self__, *, schedule: Optional[Sequence[outputs.AutoscaleScheduleResponse]] = ..., time_zone: Optional[_builtins.str] = ...) -> None:
...
class AutoscaleResponse(dict):
    ...
    def __init__(__self__, *, capacity: Optional[outputs.AutoscaleCapacityResponse] = ..., recurrence: Optional[outputs.AutoscaleRecurrenceResponse] = ...) -> None:
...
class AutoscaleScheduleResponse(dict):
    ...
    def __init__(__self__, *, days: Optional[Sequence[_builtins.str]] = ..., time_and_capacity: Optional[outputs.AutoscaleTimeAndCapacityResponse] = ...) -> None:
...
class AutoscaleTimeAndCapacityResponse(dict):
    ...
    def __init__(__self__, *, max_instance_count: Optional[_builtins.int] = ..., min_instance_count: Optional[_builtins.int] = ..., time: Optional[_builtins.str] = ...) -> None:
...
class AzureMonitorSelectedConfigurationsResponse(dict):
    ...
    def __init__(__self__, *, configuration_version: Optional[_builtins.str] = ..., global_configurations: Optional[Mapping[str, _builtins.str]] = ..., table_list: Optional[Sequence[outputs.AzureMonitorTableConfigurationResponse]] = ...) -> None:
...
class ClientGroupInfoResponse(dict):
    ...
    def __init__(__self__, *, group_id: Optional[_builtins.str] = ..., group_name: Optional[_builtins.str] = ...) -> None:
...
class ClusterDefinitionResponse(dict):
    ...
    def __init__(__self__, *, blueprint: Optional[_builtins.str] = ..., component_version: Optional[Mapping[str, _builtins.str]] = ..., configurations: Optional[Any] = ..., kind: Optional[_builtins.str] = ...) -> None:
...
class ClusterGetPropertiesResponse(dict):
    ...
    def __init__(__self__, *, cluster_definition: outputs.ClusterDefinitionResponse, private_endpoint_connections: Sequence[outputs.PrivateEndpointConnectionResponse], cluster_hdp_version: Optional[_builtins.str] = ..., cluster_id: Optional[_builtins.str] = ..., cluster_state: Optional[_builtins.str] = ..., cluster_version: Optional[_builtins.str] = ..., compute_isolation_properties: Optional[outputs.ComputeIsolationPropertiesResponse] = ..., compute_profile: Optional[outputs.ComputeProfileResponse] = ..., connectivity_endpoints: Optional[Sequence[outputs.ConnectivityEndpointResponse]] = ..., created_date: Optional[_builtins.str] = ..., disk_encryption_properties: Optional[outputs.DiskEncryptionPropertiesResponse] = ..., encryption_in_transit_properties: Optional[outputs.EncryptionInTransitPropertiesResponse] = ..., errors: Optional[Sequence[outputs.ErrorsResponse]] = ..., excluded_services_config: Optional[outputs.ExcludedServicesConfigResponse] = ..., kafka_rest_properties: Optional[outputs.KafkaRestPropertiesResponse] = ..., min_supported_tls_version: Optional[_builtins.str] = ..., network_properties: Optional[outputs.NetworkPropertiesResponse] = ..., os_type: Optional[_builtins.str] = ..., private_link_configurations: Optional[Sequence[outputs.PrivateLinkConfigurationResponse]] = ..., provisioning_state: Optional[_builtins.str] = ..., quota_info: Optional[outputs.QuotaInfoResponse] = ..., security_profile: Optional[outputs.SecurityProfileResponse] = ..., storage_profile: Optional[outputs.StorageProfileResponse] = ..., tier: Optional[_builtins.str] = ...) -> None:
...
class ComputeIsolationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, enable_compute_isolation: Optional[_builtins.bool] = ..., host_sku: Optional[_builtins.str] = ...) -> None:
...
class ComputeProfileResponse(dict):
    ...
    def __init__(__self__, *, roles: Optional[Sequence[outputs.RoleResponse]] = ...) -> None:
...
class ConnectivityEndpointResponse(dict):
    ...
    def __init__(__self__, *, location: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., private_ip_address: Optional[_builtins.str] = ..., protocol: Optional[_builtins.str] = ...) -> None:
...
class DataDisksGroupsResponse(dict):
    ...
    def __init__(__self__, *, disk_size_gb: _builtins.int, storage_account_type: _builtins.str, disks_per_node: Optional[_builtins.int] = ...) -> None:
...
class DiskEncryptionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, encryption_algorithm: Optional[_builtins.str] = ..., encryption_at_host: Optional[_builtins.bool] = ..., key_name: Optional[_builtins.str] = ..., key_version: Optional[_builtins.str] = ..., msi_resource_id: Optional[_builtins.str] = ..., vault_uri: Optional[_builtins.str] = ...) -> None:
...
class EncryptionInTransitPropertiesResponse(dict):
    ...
    def __init__(__self__, *, is_encryption_in_transit_enabled: Optional[_builtins.bool] = ...) -> None:
...
class ExcludedServicesConfigResponse(dict):
    ...
    def __init__(__self__, *, excluded_services_config_id: Optional[_builtins.str] = ..., excluded_services_list: Optional[_builtins.str] = ...) -> None:
...
class IPConfigurationResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, provisioning_state: _builtins.str, type: _builtins.str, primary: Optional[_builtins.bool] = ..., private_ip_address: Optional[_builtins.str] = ..., private_ip_allocation_method: Optional[_builtins.str] = ..., subnet: Optional[outputs.ResourceIdResponse] = ...) -> None:
...
class KafkaRestPropertiesResponse(dict):
    ...
    def __init__(__self__, *, client_group_info: Optional[outputs.ClientGroupInfoResponse] = ..., configuration_override: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class LinuxOperatingSystemProfileResponse(dict):
    ...
    def __init__(__self__, *, password: Optional[_builtins.str] = ..., ssh_profile: Optional[outputs.SshProfileResponse] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class NetworkPropertiesResponse(dict):
    ...
    def __init__(__self__, *, outbound_dependencies_managed_type: Optional[_builtins.str] = ..., private_link: Optional[_builtins.str] = ..., public_ip_tag: Optional[outputs.IpTagResponse] = ..., resource_provider_connection: Optional[_builtins.str] = ...) -> None:
...
class OsProfileResponse(dict):
    ...
    def __init__(__self__, *, linux_operating_system_profile: Optional[outputs.LinuxOperatingSystemProfileResponse] = ...) -> None:
...
class PrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, link_identifier: _builtins.str, name: _builtins.str, private_endpoint: outputs.PrivateEndpointResponse, private_link_service_connection_state: outputs.PrivateLinkServiceConnectionStateResponse, provisioning_state: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str) -> None:
...
class PrivateLinkConfigurationResponse(dict):
    ...
    def __init__(__self__, *, group_id: _builtins.str, id: _builtins.str, ip_configurations: Sequence[outputs.IPConfigurationResponse], name: _builtins.str, provisioning_state: _builtins.str, type: _builtins.str) -> None:
...
class RoleResponse(dict):
    ...
    def __init__(__self__, *, autoscale_configuration: Optional[outputs.AutoscaleResponse] = ..., data_disks_groups: Optional[Sequence[outputs.DataDisksGroupsResponse]] = ..., encrypt_data_disks: Optional[_builtins.bool] = ..., hardware_profile: Optional[outputs.HardwareProfileResponse] = ..., min_instance_count: Optional[_builtins.int] = ..., name: Optional[_builtins.str] = ..., os_profile: Optional[outputs.OsProfileResponse] = ..., script_actions: Optional[Sequence[outputs.ScriptActionResponse]] = ..., target_instance_count: Optional[_builtins.int] = ..., v_m_group_name: Optional[_builtins.str] = ..., virtual_network_profile: Optional[outputs.VirtualNetworkProfileResponse] = ...) -> None:
...
class RuntimeScriptActionResponse(dict):
    ...
    def __init__(__self__, *, application_name: _builtins.str, name: _builtins.str, roles: Sequence[_builtins.str], uri: _builtins.str, parameters: Optional[_builtins.str] = ...) -> None:
...
class ScriptActionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: _builtins.str, uri: _builtins.str) -> None:
...
class SecurityProfileResponse(dict):
    ...
    def __init__(__self__, *, aadds_resource_id: Optional[_builtins.str] = ..., cluster_users_group_dns: Optional[Sequence[_builtins.str]] = ..., directory_type: Optional[_builtins.str] = ..., domain: Optional[_builtins.str] = ..., domain_user_password: Optional[_builtins.str] = ..., domain_username: Optional[_builtins.str] = ..., ldaps_urls: Optional[Sequence[_builtins.str]] = ..., msi_resource_id: Optional[_builtins.str] = ..., organizational_unit_dn: Optional[_builtins.str] = ...) -> None:
...
class SshPublicKeyResponse(dict):
    ...
    def __init__(__self__, *, certificate_data: Optional[_builtins.str] = ...) -> None:
...
class StorageAccountResponse(dict):
    ...
    def __init__(__self__, *, container: Optional[_builtins.str] = ..., enable_secure_channel: Optional[_builtins.bool] = ..., file_system: Optional[_builtins.str] = ..., fileshare: Optional[_builtins.str] = ..., is_default: Optional[_builtins.bool] = ..., key: Optional[_builtins.str] = ..., msi_resource_id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., resource_id: Optional[_builtins.str] = ..., saskey: Optional[_builtins.str] = ...) -> None:
...
class StorageProfileResponse(dict):
    ...
    def __init__(__self__, *, storageaccounts: Optional[Sequence[outputs.StorageAccountResponse]] = ...) -> None:
...
class UserAssignedIdentityResponse(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, principal_id: _builtins.str, tenant_id: Optional[_builtins.str] = ...) -> None:
...
class VirtualNetworkProfileResponse(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., subnet: Optional[_builtins.str] = ...) -> None:
