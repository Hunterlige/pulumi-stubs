...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationGetEndpointArgs', 'ApplicationGetEndpointArgsDict', 'ApplicationGetHttpsEndpointArgs', 'ApplicationGetHttpsEndpointArgsDict', 'ApplicationPropertiesArgs', 'ApplicationPropertiesArgsDict', 'AutoscaleCapacityArgs', 'AutoscaleCapacityArgsDict', 'AutoscaleRecurrenceArgs', 'AutoscaleRecurrenceArgsDict', 'AutoscaleScheduleArgs', 'AutoscaleScheduleArgsDict', 'AutoscaleTimeAndCapacityArgs', 'AutoscaleTimeAndCapacityArgsDict', 'AutoscaleArgs', 'AutoscaleArgsDict', 'AzureMonitorSelectedConfigurationsArgs', 'AzureMonitorSelectedConfigurationsArgsDict', 'AzureMonitorTableConfigurationArgs', 'AzureMonitorTableConfigurationArgsDict', 'ClientGroupInfoArgs', 'ClientGroupInfoArgsDict', 'ClusterCreatePropertiesArgs', 'ClusterCreatePropertiesArgsDict', 'ClusterDefinitionArgs', 'ClusterDefinitionArgsDict', 'ClusterIdentityArgs', 'ClusterIdentityArgsDict', 'ComputeIsolationPropertiesArgs', 'ComputeIsolationPropertiesArgsDict', 'ComputeProfileArgs', 'ComputeProfileArgsDict', 'DataDisksGroupsArgs', 'DataDisksGroupsArgsDict', 'DiskEncryptionPropertiesArgs', 'DiskEncryptionPropertiesArgsDict', 'EncryptionInTransitPropertiesArgs', 'EncryptionInTransitPropertiesArgsDict', 'ErrorsArgs', 'ErrorsArgsDict', 'HardwareProfileArgs', 'HardwareProfileArgsDict', 'IPConfigurationArgs', 'IPConfigurationArgsDict', 'IpTagArgs', 'IpTagArgsDict', 'KafkaRestPropertiesArgs', 'KafkaRestPropertiesArgsDict', 'LinuxOperatingSystemProfileArgs', 'LinuxOperatingSystemProfileArgsDict', 'NetworkPropertiesArgs', 'NetworkPropertiesArgsDict', 'OsProfileArgs', 'OsProfileArgsDict', 'PrivateLinkConfigurationArgs', 'PrivateLinkConfigurationArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'ResourceIdArgs', 'ResourceIdArgsDict', 'RoleArgs', 'RoleArgsDict', 'RuntimeScriptActionArgs', 'RuntimeScriptActionArgsDict', 'ScriptActionArgs', 'ScriptActionArgsDict', 'SecurityProfileArgs', 'SecurityProfileArgsDict', 'SshProfileArgs', 'SshProfileArgsDict', 'SshPublicKeyArgs', 'SshPublicKeyArgsDict', 'StorageAccountArgs', 'StorageAccountArgsDict', 'StorageProfileArgs', 'StorageProfileArgsDict', 'UserAssignedIdentityArgs', 'UserAssignedIdentityArgsDict', 'VirtualNetworkProfileArgs', 'VirtualNetworkProfileArgsDict']
...
class ApplicationGetEndpointArgs:
    def __init__(__self__, *, destination_port: Optional[pulumi.Input[_builtins.int]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., public_port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @public_port.setter
    def public_port(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ApplicationGetHttpsEndpointArgs:
    def __init__(__self__, *, access_modes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., destination_port: Optional[pulumi.Input[_builtins.int]] = ..., disable_gateway_auth: Optional[pulumi.Input[_builtins.bool]] = ..., private_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., sub_domain_suffix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disable_gateway_auth(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def sub_domain_suffix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApplicationPropertiesArgs:
    def __init__(__self__, *, application_type: Optional[pulumi.Input[_builtins.str]] = ..., compute_profile: Optional[pulumi.Input[ComputeProfileArgs]] = ..., errors: Optional[pulumi.Input[Sequence[pulumi.Input[ErrorsArgs]]]] = ..., https_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationGetHttpsEndpointArgs]]]] = ..., install_script_actions: Optional[pulumi.Input[Sequence[pulumi.Input[RuntimeScriptActionArgs]]]] = ..., private_link_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateLinkConfigurationArgs]]]] = ..., ssh_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationGetEndpointArgs]]]] = ..., uninstall_script_actions: Optional[pulumi.Input[Sequence[pulumi.Input[RuntimeScriptActionArgs]]]] = ...) -> None:
    ...
    def compute_profile(self, value: Optional[pulumi.Input[ComputeProfileArgs]]): # -> None:
        ...
    ...
    @errors.setter
    def errors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ErrorsArgs]]]]): # -> None:
        ...
    ...
    def https_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationGetHttpsEndpointArgs]]]]): # -> None:
        ...
    ...
    def install_script_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuntimeScriptActionArgs]]]]): # -> None:
        ...
    ...
    def private_link_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateLinkConfigurationArgs]]]]): # -> None:
        ...
    ...
    def ssh_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationGetEndpointArgs]]]]): # -> None:
        ...
    ...
    def uninstall_script_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuntimeScriptActionArgs]]]]): # -> None:
        ...
...
class AutoscaleRecurrenceArgs:
    def __init__(__self__, *, schedule: Optional[pulumi.Input[Sequence[pulumi.Input[AutoscaleScheduleArgs]]]] = ..., time_zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @schedule.setter
    def schedule(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AutoscaleScheduleArgs]]]]): # -> None:
        ...
...
class AutoscaleScheduleArgs:
    def __init__(__self__, *, days: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, DaysOfWeek]]]]] = ..., time_and_capacity: Optional[pulumi.Input[AutoscaleTimeAndCapacityArgs]] = ...) -> None:
    ...
    @days.setter
    def days(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, DaysOfWeek]]]]]): # -> None:
        ...
    ...
    def time_and_capacity(self, value: Optional[pulumi.Input[AutoscaleTimeAndCapacityArgs]]): # -> None:
        ...
...
class AutoscaleTimeAndCapacityArgs:
    def __init__(__self__, *, max_instance_count: Optional[pulumi.Input[_builtins.int]] = ..., min_instance_count: Optional[pulumi.Input[_builtins.int]] = ..., time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class AutoscaleArgs:
    def __init__(__self__, *, capacity: Optional[pulumi.Input[AutoscaleCapacityArgs]] = ..., recurrence: Optional[pulumi.Input[AutoscaleRecurrenceArgs]] = ...) -> None:
    ...
    @capacity.setter
    def capacity(self, value: Optional[pulumi.Input[AutoscaleCapacityArgs]]): # -> None:
        ...
    ...
    @recurrence.setter
    def recurrence(self, value: Optional[pulumi.Input[AutoscaleRecurrenceArgs]]): # -> None:
        ...
...
class AzureMonitorSelectedConfigurationsArgs:
    def __init__(__self__, *, configuration_version: Optional[pulumi.Input[_builtins.str]] = ..., global_configurations: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., table_list: Optional[pulumi.Input[Sequence[pulumi.Input[AzureMonitorTableConfigurationArgs]]]] = ...) -> None:
    ...
    def global_configurations(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @table_list.setter
    def table_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AzureMonitorTableConfigurationArgs]]]]): # -> None:
        ...
...
class ClientGroupInfoArgs:
    def __init__(__self__, *, group_id: Optional[pulumi.Input[_builtins.str]] = ..., group_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterCreatePropertiesArgs:
    def __init__(__self__, *, cluster_definition: Optional[pulumi.Input[ClusterDefinitionArgs]] = ..., cluster_version: Optional[pulumi.Input[_builtins.str]] = ..., compute_isolation_properties: Optional[pulumi.Input[ComputeIsolationPropertiesArgs]] = ..., compute_profile: Optional[pulumi.Input[ComputeProfileArgs]] = ..., disk_encryption_properties: Optional[pulumi.Input[DiskEncryptionPropertiesArgs]] = ..., encryption_in_transit_properties: Optional[pulumi.Input[EncryptionInTransitPropertiesArgs]] = ..., kafka_rest_properties: Optional[pulumi.Input[KafkaRestPropertiesArgs]] = ..., min_supported_tls_version: Optional[pulumi.Input[_builtins.str]] = ..., network_properties: Optional[pulumi.Input[NetworkPropertiesArgs]] = ..., os_type: Optional[pulumi.Input[Union[_builtins.str, OSType]]] = ..., private_link_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateLinkConfigurationArgs]]]] = ..., security_profile: Optional[pulumi.Input[SecurityProfileArgs]] = ..., storage_profile: Optional[pulumi.Input[StorageProfileArgs]] = ..., tier: Optional[pulumi.Input[Union[_builtins.str, Tier]]] = ...) -> None:
    ...
    def cluster_definition(self, value: Optional[pulumi.Input[ClusterDefinitionArgs]]): # -> None:
        ...
    ...
    def cluster_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def compute_isolation_properties(self, value: Optional[pulumi.Input[ComputeIsolationPropertiesArgs]]): # -> None:
        ...
    ...
    def disk_encryption_properties(self, value: Optional[pulumi.Input[DiskEncryptionPropertiesArgs]]): # -> None:
        ...
    ...
    def encryption_in_transit_properties(self, value: Optional[pulumi.Input[EncryptionInTransitPropertiesArgs]]): # -> None:
        ...
    ...
    def kafka_rest_properties(self, value: Optional[pulumi.Input[KafkaRestPropertiesArgs]]): # -> None:
        ...
    ...
    def min_supported_tls_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def network_properties(self, value: Optional[pulumi.Input[NetworkPropertiesArgs]]): # -> None:
        ...
    ...
    @tier.setter
    def tier(self, value: Optional[pulumi.Input[Union[_builtins.str, Tier]]]): # -> None:
        ...
...
class ClusterDefinitionArgs:
    def __init__(__self__, *, blueprint: Optional[pulumi.Input[_builtins.str]] = ..., component_version: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., configurations: Optional[Any] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @blueprint.setter
    def blueprint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def component_version(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def configurations(self, value: Optional[Any]): # -> None:
        ...
...
class ClusterIdentityArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[Union[_builtins.str, ResourceIdentityType]]] = ..., user_assigned_identities: Optional[pulumi.Input[Mapping[str, pulumi.Input[UserAssignedIdentityArgs]]]] = ...) -> None:
...
class ComputeIsolationPropertiesArgs:
    def __init__(__self__, *, enable_compute_isolation: Optional[pulumi.Input[_builtins.bool]] = ..., host_sku: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def enable_compute_isolation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @host_sku.setter
    def host_sku(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ComputeProfileArgs:
    def __init__(__self__, *, roles: Optional[pulumi.Input[Sequence[pulumi.Input[RoleArgs]]]] = ...) -> None:
...
class DataDisksGroupsArgs:
    def __init__(__self__, *, disks_per_node: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def disks_per_node(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class DiskEncryptionPropertiesArgs:
    def __init__(__self__, *, encryption_algorithm: Optional[pulumi.Input[Union[_builtins.str, JsonWebKeyEncryptionAlgorithm]]] = ..., encryption_at_host: Optional[pulumi.Input[_builtins.bool]] = ..., key_name: Optional[pulumi.Input[_builtins.str]] = ..., key_version: Optional[pulumi.Input[_builtins.str]] = ..., msi_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., vault_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def encryption_algorithm(self, value: Optional[pulumi.Input[Union[_builtins.str, JsonWebKeyEncryptionAlgorithm]]]): # -> None:
        ...
    ...
    def msi_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EncryptionInTransitPropertiesArgs:
    def __init__(__self__, *, is_encryption_in_transit_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def is_encryption_in_transit_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class HardwareProfileArgs:
    def __init__(__self__, *, vm_size: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class IPConfigurationArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], primary: Optional[pulumi.Input[_builtins.bool]] = ..., private_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_allocation_method: Optional[pulumi.Input[Union[_builtins.str, PrivateIPAllocationMethod]]] = ..., subnet: Optional[pulumi.Input[ResourceIdArgs]] = ...) -> None:
    ...
    def private_ip_allocation_method(self, value: Optional[pulumi.Input[Union[_builtins.str, PrivateIPAllocationMethod]]]): # -> None:
        ...
...
class KafkaRestPropertiesArgs:
    def __init__(__self__, *, client_group_info: Optional[pulumi.Input[ClientGroupInfoArgs]] = ..., configuration_override: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def client_group_info(self, value: Optional[pulumi.Input[ClientGroupInfoArgs]]): # -> None:
        ...
    ...
    def configuration_override(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class LinuxOperatingSystemProfileArgs:
    def __init__(__self__, *, password: Optional[pulumi.Input[_builtins.str]] = ..., ssh_profile: Optional[pulumi.Input[SshProfileArgs]] = ..., username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ssh_profile.setter
    def ssh_profile(self, value: Optional[pulumi.Input[SshProfileArgs]]): # -> None:
        ...
...
class NetworkPropertiesArgs:
    def __init__(__self__, *, outbound_dependencies_managed_type: Optional[pulumi.Input[Union[_builtins.str, OutboundDependenciesManagedType]]] = ..., private_link: Optional[pulumi.Input[Union[_builtins.str, PrivateLink]]] = ..., public_ip_tag: Optional[pulumi.Input[IpTagArgs]] = ..., resource_provider_connection: Optional[pulumi.Input[Union[_builtins.str, ResourceProviderConnection]]] = ...) -> None:
    ...
    def outbound_dependencies_managed_type(self, value: Optional[pulumi.Input[Union[_builtins.str, OutboundDependenciesManagedType]]]): # -> None:
        ...
    ...
    @private_link.setter
    def private_link(self, value: Optional[pulumi.Input[Union[_builtins.str, PrivateLink]]]): # -> None:
        ...
    ...
    def public_ip_tag(self, value: Optional[pulumi.Input[IpTagArgs]]): # -> None:
        ...
    ...
    def resource_provider_connection(self, value: Optional[pulumi.Input[Union[_builtins.str, ResourceProviderConnection]]]): # -> None:
        ...
...
@pulumi.input_type
class OsProfileArgs:
    def __init__(__self__, *, linux_operating_system_profile: Optional[pulumi.Input[LinuxOperatingSystemProfileArgs]] = ...) -> None:
    ...
    def linux_operating_system_profile(self, value: Optional[pulumi.Input[LinuxOperatingSystemProfileArgs]]): # -> None:
        ...
...
class PrivateLinkConfigurationArgs:
    def __init__(__self__, *, group_id: pulumi.Input[_builtins.str], ip_configurations: pulumi.Input[Sequence[pulumi.Input[IPConfigurationArgs]]], name: pulumi.Input[_builtins.str]) -> None:
...
@pulumi.input_type
class RoleArgs:
    def __init__(__self__, *, autoscale_configuration: Optional[pulumi.Input[AutoscaleArgs]] = ..., data_disks_groups: Optional[pulumi.Input[Sequence[pulumi.Input[DataDisksGroupsArgs]]]] = ..., encrypt_data_disks: Optional[pulumi.Input[_builtins.bool]] = ..., hardware_profile: Optional[pulumi.Input[HardwareProfileArgs]] = ..., min_instance_count: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., os_profile: Optional[pulumi.Input[OsProfileArgs]] = ..., script_actions: Optional[pulumi.Input[Sequence[pulumi.Input[ScriptActionArgs]]]] = ..., target_instance_count: Optional[pulumi.Input[_builtins.int]] = ..., v_m_group_name: Optional[pulumi.Input[_builtins.str]] = ..., virtual_network_profile: Optional[pulumi.Input[VirtualNetworkProfileArgs]] = ...) -> None:
    ...
    def autoscale_configuration(self, value: Optional[pulumi.Input[AutoscaleArgs]]): # -> None:
        ...
    ...
    def data_disks_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataDisksGroupsArgs]]]]): # -> None:
        ...
    ...
    def encrypt_data_disks(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def script_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ScriptActionArgs]]]]): # -> None:
        ...
    ...
    def target_instance_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def v_m_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def virtual_network_profile(self, value: Optional[pulumi.Input[VirtualNetworkProfileArgs]]): # -> None:
        ...
...
class RuntimeScriptActionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], roles: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], uri: pulumi.Input[_builtins.str], parameters: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ScriptActionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], parameters: pulumi.Input[_builtins.str], uri: pulumi.Input[_builtins.str]) -> None:
...
class SecurityProfileArgs:
    def __init__(__self__, *, aadds_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., cluster_users_group_dns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., directory_type: Optional[pulumi.Input[Union[_builtins.str, DirectoryType]]] = ..., domain: Optional[pulumi.Input[_builtins.str]] = ..., domain_user_password: Optional[pulumi.Input[_builtins.str]] = ..., domain_username: Optional[pulumi.Input[_builtins.str]] = ..., ldaps_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., msi_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., organizational_unit_dn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def aadds_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def cluster_users_group_dns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def directory_type(self, value: Optional[pulumi.Input[Union[_builtins.str, DirectoryType]]]): # -> None:
        ...
    ...
    def domain_user_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def domain_username(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @ldaps_urls.setter
    def ldaps_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def organizational_unit_dn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SshPublicKeyArgs:
    def __init__(__self__, *, certificate_data: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def certificate_data(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StorageAccountArgs:
    def __init__(__self__, *, container: Optional[pulumi.Input[_builtins.str]] = ..., enable_secure_channel: Optional[pulumi.Input[_builtins.bool]] = ..., file_system: Optional[pulumi.Input[_builtins.str]] = ..., fileshare: Optional[pulumi.Input[_builtins.str]] = ..., is_default: Optional[pulumi.Input[_builtins.bool]] = ..., key: Optional[pulumi.Input[_builtins.str]] = ..., msi_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ..., saskey: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def enable_secure_channel(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @file_system.setter
    def file_system(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @fileshare.setter
    def fileshare(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @saskey.setter
    def saskey(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StorageProfileArgs:
    def __init__(__self__, *, storageaccounts: Optional[pulumi.Input[Sequence[pulumi.Input[StorageAccountArgs]]]] = ...) -> None:
    ...
    def storageaccounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StorageAccountArgs]]]]): # -> None:
        ...
...
class VirtualNetworkProfileArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., subnet: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
