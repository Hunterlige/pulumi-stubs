...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = [..., ..., 'CustomerManagedKeyEncryptionPropertiesArgs', 'CustomerManagedKeyEncryptionPropertiesArgsDict', 'EncryptionPropertiesArgs', 'EncryptionPropertiesArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict']
...
class CustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentityArgs:
    def __init__(__self__, *, identity_type: Optional[pulumi.Input[CmkIdentityType]] = ..., user_assigned_identity_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def identity_type(self, value: Optional[pulumi.Input[CmkIdentityType]]): # -> None:
        ...
...
class CustomerManagedKeyEncryptionPropertiesArgs:
    def __init__(__self__, *, key_encryption_key_identity: Optional[pulumi.Input[CustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentityArgs]] = ..., key_encryption_key_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def key_encryption_key_identity(self, value: Optional[pulumi.Input[CustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentityArgs]]): # -> None:
        ...
...
class EncryptionPropertiesArgs:
    def __init__(__self__, *, customer_managed_key_encryption: Optional[pulumi.Input[CustomerManagedKeyEncryptionPropertiesArgs]] = ...) -> None:
    ...
    def customer_managed_key_encryption(self, value: Optional[pulumi.Input[CustomerManagedKeyEncryptionPropertiesArgs]]): # -> None:
        ...
