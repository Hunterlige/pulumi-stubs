...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CustomerManagedKeyEncryptionPropertiesResponse', ..., 'EncryptionPropertiesResponse', 'FluidRelayEndpointsResponse', 'IdentityResponse', 'IdentityResponseUserAssignedIdentities', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'SystemDataResponse']
@pulumi.output_type
class CustomerManagedKeyEncryptionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, key_encryption_key_identity: Optional[outputs.CustomerManagedKeyEncryptionPropertiesResponseKeyEncryptionKeyIdentity] = ..., key_encryption_key_url: Optional[_builtins.str] = ...) -> None:
...
class EncryptionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, customer_managed_key_encryption: Optional[outputs.CustomerManagedKeyEncryptionPropertiesResponse] = ...) -> None:
...
class FluidRelayEndpointsResponse(dict):
    ...
    def __init__(__self__, *, orderer_endpoints: Sequence[_builtins.str], service_endpoints: Sequence[_builtins.str], storage_endpoints: Sequence[_builtins.str]) -> None:
