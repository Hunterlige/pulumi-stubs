...
class SecretSyncArgs:
    def __init__(__self__, *, kubernetes_secret_type: pulumi.Input[Union[_builtins.str, KubernetesSecretType]], object_secret_mapping: pulumi.Input[Sequence[pulumi.Input[KubernetesSecretObjectMappingArgs]]], resource_group_name: pulumi.Input[_builtins.str], secret_provider_class_name: pulumi.Input[_builtins.str], service_account_name: pulumi.Input[_builtins.str], extended_location: Optional[pulumi.Input[AzureResourceManagerCommonTypesExtendedLocationArgs]] = ..., force_synchronization: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., secret_sync_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def kubernetes_secret_type(self, value: pulumi.Input[Union[_builtins.str, KubernetesSecretType]]): # -> None:
        ...
    ...
    def object_secret_mapping(self, value: pulumi.Input[Sequence[pulumi.Input[KubernetesSecretObjectMappingArgs]]]): # -> None:
        ...
    ...
    def secret_provider_class_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def service_account_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def force_synchronization(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def secret_sync_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SecretSync(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., extended_location: Optional[pulumi.Input[Union[AzureResourceManagerCommonTypesExtendedLocationArgs, AzureResourceManagerCommonTypesExtendedLocationArgsDict]]] = ..., force_synchronization: Optional[pulumi.Input[_builtins.str]] = ..., kubernetes_secret_type: Optional[pulumi.Input[Union[_builtins.str, KubernetesSecretType]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., object_secret_mapping: Optional[pulumi.Input[Sequence[pulumi.Input[Union[KubernetesSecretObjectMappingArgs, KubernetesSecretObjectMappingArgsDict]]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., secret_provider_class_name: Optional[pulumi.Input[_builtins.str]] = ..., secret_sync_name: Optional[pulumi.Input[_builtins.str]] = ..., service_account_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: SecretSyncArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SecretSync:
