...
class AzureKeyVaultSecretProviderClassArgs:
    def __init__(
        ...
        *,
        ...
        objects: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def keyvault_name(self, value: pulumi.Input[_builtins.str]): ...
    @_builtins.property
    ...
    def azure_key_vault_secret_provider_class_name(
        self,
    ...
    @objects.setter
    def objects(self, value: Optional[pulumi.Input[_builtins.str]]): ...
    @_builtins.property
    @pulumi.getter
    def tags(
        self,
