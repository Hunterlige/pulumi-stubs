...
def get_shared_private_link_resource(resource_group_name: Optional[_builtins.str] = ..., search_service_name: Optional[_builtins.str] = ..., shared_private_link_resource_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetSharedPrivateLinkResourceResult:
    
    ...

def get_shared_private_link_resource_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., search_service_name: Optional[pulumi.Input[_builtins.str]] = ..., shared_private_link_resource_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetSharedPrivateLinkResourceResult]:
