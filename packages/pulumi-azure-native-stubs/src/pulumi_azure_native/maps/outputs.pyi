...
class CreatorPropertiesResponse(dict):
    ...
    def __init__(
        ...
        *,
        ...
        consumed_storage_unit_size_in_bytes: Optional[_builtins.int] = ...,
        total_storage_unit_size_in_bytes: Optional[_builtins.int] = ...,
    ) -> None: ...
    @_builtins.property
...
class EncryptionResponseCustomerManagedKeyEncryption(dict):
    ...
    def __init__(
        ...
        *,
        key_encryption_key_identity: Optional[
            outputs.EncryptionResponseKeyEncryptionKeyIdentity
        ] = ...,
    ...
    def key_encryption_key_identity(
        self,
    ) -> Optional[outputs.EncryptionResponseKeyEncryptionKeyIdentity]: ...
    @_builtins.property
...
class LinkedResourceResponse(dict):
    ...
    def get(self, key: str, default=...) -> Any: ...
    def __init__(
        __self__, *, id: _builtins.str, unique_name: _builtins.str
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
...
class MapsAccountPropertiesResponse(dict):
    ...
    def __init__(
        ...
        *,
        ...
        cors: Optional[outputs.CorsRulesResponse] = ...,
        disable_local_auth: Optional[_builtins.bool] = ...,
        encryption: Optional[outputs.EncryptionResponse] = ...,
        linked_resources: Optional[Sequence[outputs.LinkedResourceResponse]] = ...,
        locations: Optional[
            Sequence[outputs.MapsAccountPropertiesResponseLocations]
        ] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter(name="provisioningState")
    ...
    def linked_resources(
        self,
    ) -> Optional[Sequence[outputs.LinkedResourceResponse]]: ...
    @_builtins.property
    @pulumi.getter
    def locations(
        self,
    ) -> Optional[Sequence[outputs.MapsAccountPropertiesResponseLocations]]: ...
...
class PrivateAtlasPropertiesResponse(dict):
    ...
    def get(self, key: str, default=...) -> Any: ...
    def __init__(
        __self__, *, provisioning_state: Optional[_builtins.str] = ...
    ) -> None: ...
    @_builtins.property
    @pulumi.getter(name="provisioningState")
