...
class AssociationsInterfaceArgs:
    def __init__(
        ...
        *,
        ...
        subnet: Optional[pulumi.Input[AssociationSubnetArgs]] = ...,
    ...
    def association_type(
        self,
    ) -> pulumi.Input[Union[_builtins.str, AssociationType]]: ...
    @association_type.setter
    def association_type(
        self, value: pulumi.Input[Union[_builtins.str, AssociationType]]
    ): ...
    @_builtins.property
...
class AssociationsInterface(pulumi.CustomResource):
    ...
    def __init__(
        ...
        subnet: Optional[
            pulumi.Input[Union[AssociationSubnetArgs, AssociationSubnetArgsDict]]
        ] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
