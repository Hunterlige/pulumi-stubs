...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AssociationSubnetResponse', 'ResourceIdResponse', 'SecurityPolicyConfigurationsResponse', 'SystemDataResponse', 'WafPolicyResponse', 'WafSecurityPolicyResponse']
@pulumi.output_type
...
class SecurityPolicyConfigurationsResponse(dict):
    ...
    def __init__(__self__, *, waf_security_policy: Optional[outputs.WafSecurityPolicyResponse] = ...) -> None:
