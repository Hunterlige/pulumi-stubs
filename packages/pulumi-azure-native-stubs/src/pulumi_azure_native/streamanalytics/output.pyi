...
class Output(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., datasource: Optional[pulumi.Input[Union[Union[AzureDataLakeStoreOutputDataSourceArgs, AzureDataLakeStoreOutputDataSourceArgsDict], Union[AzureFunctionOutputDataSourceArgs, AzureFunctionOutputDataSourceArgsDict], Union[AzureSqlDatabaseOutputDataSourceArgs, AzureSqlDatabaseOutputDataSourceArgsDict], Union[AzureSynapseOutputDataSourceArgs, AzureSynapseOutputDataSourceArgsDict], Union[AzureTableOutputDataSourceArgs, AzureTableOutputDataSourceArgsDict], Union[BlobOutputDataSourceArgs, BlobOutputDataSourceArgsDict], Union[DocumentDbOutputDataSourceArgs, DocumentDbOutputDataSourceArgsDict], Union[EventHubOutputDataSourceArgs, EventHubOutputDataSourceArgsDict], Union[EventHubV2OutputDataSourceArgs, EventHubV2OutputDataSourceArgsDict], Union[GatewayMessageBusOutputDataSourceArgs, GatewayMessageBusOutputDataSourceArgsDict], Union[PowerBIOutputDataSourceArgs, PowerBIOutputDataSourceArgsDict], Union[ServiceBusQueueOutputDataSourceArgs, ServiceBusQueueOutputDataSourceArgsDict], Union[ServiceBusTopicOutputDataSourceArgs, ServiceBusTopicOutputDataSourceArgsDict]]]] = ..., job_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., output_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., serialization: Optional[pulumi.Input[Union[Union[AvroSerializationArgs, AvroSerializationArgsDict], Union[CsvSerializationArgs, CsvSerializationArgsDict], Union[JsonSerializationArgs, JsonSerializationArgsDict], Union[ParquetSerializationArgs, ParquetSerializationArgsDict]]]] = ..., size_window: Optional[pulumi.Input[_builtins.int]] = ..., time_window: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: OutputInitArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Output:
