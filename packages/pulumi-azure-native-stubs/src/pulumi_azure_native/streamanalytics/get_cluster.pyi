...
class GetClusterResult:
    ...
    def __init__(__self__, azure_api_version=..., capacity_allocated=..., capacity_assigned=..., cluster_id=..., created_date=..., etag=..., id=..., location=..., name=..., provisioning_state=..., sku=..., tags=..., type=...) -> None:
        ...
