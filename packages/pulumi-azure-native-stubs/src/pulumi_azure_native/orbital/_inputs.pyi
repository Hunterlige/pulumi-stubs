...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ContactParametersContactProfile', 'ContactParametersContactProfileDict', 'ContactProfileLinkChannelArgs', 'ContactProfileLinkChannelArgsDict', 'ContactProfileLinkArgs', 'ContactProfileLinkArgsDict', 'ContactProfileThirdPartyConfigurationArgs', 'ContactProfileThirdPartyConfigurationArgsDict', 'ContactProfilesPropertiesNetworkConfigurationArgs', ..., 'ContactsPropertiesContactProfileArgs', 'ContactsPropertiesContactProfileArgsDict', 'EdgeSitesPropertiesGlobalCommunicationsSiteArgs', ..., 'EndPointArgs', 'EndPointArgsDict', 'GeoCatalogPropertiesArgs', 'GeoCatalogPropertiesArgsDict', ..., ..., 'L2ConnectionsPropertiesEdgeSiteArgs', 'L2ConnectionsPropertiesEdgeSiteArgsDict', ..., ..., 'L2ConnectionsPropertiesGroundStationArgs', 'L2ConnectionsPropertiesGroundStationArgsDict', 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'SpacecraftLinkArgs', 'SpacecraftLinkArgsDict']
...
class ContactProfileLinkChannelArgs:
    def __init__(__self__, *, bandwidth_m_hz: pulumi.Input[_builtins.float], center_frequency_m_hz: pulumi.Input[_builtins.float], end_point: pulumi.Input[EndPointArgs], name: pulumi.Input[_builtins.str], decoding_configuration: Optional[pulumi.Input[_builtins.str]] = ..., demodulation_configuration: Optional[pulumi.Input[_builtins.str]] = ..., encoding_configuration: Optional[pulumi.Input[_builtins.str]] = ..., modulation_configuration: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def bandwidth_m_hz(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def center_frequency_m_hz(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @end_point.setter
    def end_point(self, value: pulumi.Input[EndPointArgs]): # -> None:
        ...
    ...
    def decoding_configuration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def demodulation_configuration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def encoding_configuration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def modulation_configuration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ContactProfileLinkArgs:
    def __init__(__self__, *, channels: pulumi.Input[Sequence[pulumi.Input[ContactProfileLinkChannelArgs]]], direction: pulumi.Input[Union[_builtins.str, Direction]], name: pulumi.Input[_builtins.str], polarization: pulumi.Input[Union[_builtins.str, Polarization]], eirpd_bw: Optional[pulumi.Input[_builtins.float]] = ..., gain_over_temperature: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @channels.setter
    def channels(self, value: pulumi.Input[Sequence[pulumi.Input[ContactProfileLinkChannelArgs]]]): # -> None:
        ...
    ...
    @polarization.setter
    def polarization(self, value: pulumi.Input[Union[_builtins.str, Polarization]]): # -> None:
        ...
    ...
    @eirpd_bw.setter
    def eirpd_bw(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def gain_over_temperature(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class ContactProfileThirdPartyConfigurationArgs:
    def __init__(__self__, *, mission_configuration: pulumi.Input[_builtins.str], provider_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def mission_configuration(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
@pulumi.input_type
class EndPointArgs:
    def __init__(__self__, *, end_point_name: pulumi.Input[_builtins.str], ip_address: pulumi.Input[_builtins.str], port: pulumi.Input[_builtins.str], protocol: pulumi.Input[Union[_builtins.str, Protocol]]) -> None:
...
class GeoCatalogPropertiesArgs:
    def __init__(__self__, *, auto_generated_domain_name_label_scope: Optional[pulumi.Input[Union[_builtins.str, AutoGeneratedDomainNameLabelScope]]] = ..., tier: Optional[pulumi.Input[Union[_builtins.str, CatalogTier]]] = ...) -> None:
    ...
    @tier.setter
    def tier(self, value: Optional[pulumi.Input[Union[_builtins.str, CatalogTier]]]): # -> None:
        ...
...
class SpacecraftLinkArgs:
    def __init__(__self__, *, bandwidth_m_hz: pulumi.Input[_builtins.float], center_frequency_m_hz: pulumi.Input[_builtins.float], direction: pulumi.Input[Union[_builtins.str, Direction]], name: pulumi.Input[_builtins.str], polarization: pulumi.Input[Union[_builtins.str, Polarization]]) -> None:
