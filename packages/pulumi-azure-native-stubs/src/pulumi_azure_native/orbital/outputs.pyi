...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AuthorizedGroundstationResponse', 'AvailableContactsResponse', 'AvailableContactsResponseSpacecraft', 'ContactProfileLinkChannelResponse', 'ContactProfileLinkResponse', 'ContactProfileThirdPartyConfigurationResponse', ..., 'ContactsPropertiesResponseAntennaConfiguration', 'ContactsPropertiesResponseContactProfile', ..., 'EndPointResponse', 'GeoCatalogPropertiesResponse', ..., 'L2ConnectionsPropertiesResponseEdgeSite', 'L2ConnectionsPropertiesResponseGroundStation', ..., 'ManagedServiceIdentityResponse', 'ResourceIdListResultResponseValue', 'SpacecraftLinkResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
class AuthorizedGroundstationResponse(dict):
    ...
    def __init__(__self__, *, expiration_date: _builtins.str, ground_station: _builtins.str) -> None:
...
class AvailableContactsResponse(dict):
    ...
    def __init__(__self__, *, end_azimuth_degrees: _builtins.float, end_elevation_degrees: _builtins.float, ground_station_name: _builtins.str, maximum_elevation_degrees: _builtins.float, rx_end_time: _builtins.str, rx_start_time: _builtins.str, start_azimuth_degrees: _builtins.float, start_elevation_degrees: _builtins.float, tx_end_time: _builtins.str, tx_start_time: _builtins.str, spacecraft: Optional[outputs.AvailableContactsResponseSpacecraft] = ...) -> None:
...
class ContactProfileLinkChannelResponse(dict):
    ...
    def __init__(__self__, *, bandwidth_m_hz: _builtins.float, center_frequency_m_hz: _builtins.float, end_point: outputs.EndPointResponse, name: _builtins.str, decoding_configuration: Optional[_builtins.str] = ..., demodulation_configuration: Optional[_builtins.str] = ..., encoding_configuration: Optional[_builtins.str] = ..., modulation_configuration: Optional[_builtins.str] = ...) -> None:
...
class ContactProfileLinkResponse(dict):
    ...
    def __init__(__self__, *, channels: Sequence[outputs.ContactProfileLinkChannelResponse], direction: _builtins.str, name: _builtins.str, polarization: _builtins.str, eirpd_bw: Optional[_builtins.float] = ..., gain_over_temperature: Optional[_builtins.float] = ...) -> None:
...
class ContactProfileThirdPartyConfigurationResponse(dict):
    ...
    def __init__(__self__, *, mission_configuration: _builtins.str, provider_name: _builtins.str) -> None:
...
class ContactsPropertiesResponseAntennaConfiguration(dict):
    ...
    def __init__(__self__, *, destination_ip: Optional[_builtins.str] = ..., source_ips: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class EndPointResponse(dict):
    ...
    def __init__(__self__, *, end_point_name: _builtins.str, ip_address: _builtins.str, port: _builtins.str, protocol: _builtins.str) -> None:
...
class GeoCatalogPropertiesResponse(dict):
    ...
    def __init__(__self__, *, catalog_uri: _builtins.str, provisioning_state: _builtins.str, auto_generated_domain_name_label_scope: Optional[_builtins.str] = ..., tier: Optional[_builtins.str] = ...) -> None:
...
class SpacecraftLinkResponse(dict):
    ...
    def __init__(__self__, *, authorizations: Sequence[outputs.AuthorizedGroundstationResponse], bandwidth_m_hz: _builtins.float, center_frequency_m_hz: _builtins.float, direction: _builtins.str, name: _builtins.str, polarization: _builtins.str) -> None:
