...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ResourceMetadataArgs', 'ResourceMetadataArgsDict', 'ScopingAnswerArgs', 'ScopingAnswerArgsDict', 'StorageInfoArgs', 'StorageInfoArgsDict']
...
class ResourceMetadataArgs:
    def __init__(__self__, *, resource_id: pulumi.Input[_builtins.str], account_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_kind: Optional[pulumi.Input[_builtins.str]] = ..., resource_origin: Optional[pulumi.Input[Union[_builtins.str, ResourceOrigin]]] = ..., resource_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def resource_origin(self, value: Optional[pulumi.Input[Union[_builtins.str, ResourceOrigin]]]): # -> None:
        ...
...
class ScopingAnswerArgs:
    def __init__(__self__, *, answers: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], question_id: pulumi.Input[_builtins.str]) -> None:
    ...
    @answers.setter
    def answers(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @question_id.setter
    def question_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class StorageInfoArgs:
    def __init__(__self__, *, account_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
