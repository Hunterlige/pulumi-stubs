...
class BackupPolicyInitArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], vault_name: pulumi.Input[_builtins.str], backup_policy_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[BackupPolicyArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[BackupPolicyArgs]]): # -> None:
        ...
...
class BackupPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., backup_policy_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[BackupPolicyArgs, BackupPolicyArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., vault_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: BackupPolicyInitArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
