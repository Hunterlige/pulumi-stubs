...
@pulumi.input_type
class ScheduleArgs:
    def __init__(__self__, *, automation_account_name: pulumi.Input[_builtins.str], frequency: pulumi.Input[Union[_builtins.str, ScheduleFrequency]], name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], start_time: pulumi.Input[_builtins.str], advanced_schedule: Optional[pulumi.Input[AdvancedScheduleArgs]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., expiry_time: Optional[pulumi.Input[_builtins.str]] = ..., interval: Optional[Any] = ..., schedule_name: Optional[pulumi.Input[_builtins.str]] = ..., time_zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @interval.setter
    def interval(self, value: Optional[Any]): # -> None:
        ...
...
class Schedule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., advanced_schedule: Optional[pulumi.Input[Union[AdvancedScheduleArgs, AdvancedScheduleArgsDict]]] = ..., automation_account_name: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., expiry_time: Optional[pulumi.Input[_builtins.str]] = ..., frequency: Optional[pulumi.Input[Union[_builtins.str, ScheduleFrequency]]] = ..., interval: Optional[Any] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., schedule_name: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ..., time_zone: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
