...
class GetAutomationAccountResult:
    ...
    def automation_hybrid_service_url(self) -> Optional[_builtins.str]: ...
    @_builtins.property
    ...
    def public_network_access(self) -> Optional[_builtins.bool]: ...
    @_builtins.property
    @pulumi.getter
