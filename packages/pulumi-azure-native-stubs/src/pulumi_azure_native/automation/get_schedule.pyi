...
class GetScheduleResult:
    ...
    def __init__(__self__, advanced_schedule=..., azure_api_version=..., creation_time=..., description=..., expiry_time=..., expiry_time_offset_minutes=..., frequency=..., id=..., interval=..., is_enabled=..., last_modified_time=..., name=..., next_run=..., next_run_offset_minutes=..., start_time=..., start_time_offset_minutes=..., system_data=..., time_zone=..., type=...) -> None:
        ...
...
def get_schedule(automation_account_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., schedule_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetScheduleResult:
    
    ...

def get_schedule_output(automation_account_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., schedule_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetScheduleResult]:
