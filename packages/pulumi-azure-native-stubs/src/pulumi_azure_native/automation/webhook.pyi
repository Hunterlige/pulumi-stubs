...
@pulumi.input_type
class WebhookArgs:
    def __init__(__self__, *, automation_account_name: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], expiry_time: Optional[pulumi.Input[_builtins.str]] = ..., is_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., run_on: Optional[pulumi.Input[_builtins.str]] = ..., runbook: Optional[pulumi.Input[RunbookAssociationPropertyArgs]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ..., webhook_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @runbook.setter
    def runbook(self, value: Optional[pulumi.Input[RunbookAssociationPropertyArgs]]): # -> None:
        ...
...
class Webhook(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., automation_account_name: Optional[pulumi.Input[_builtins.str]] = ..., expiry_time: Optional[pulumi.Input[_builtins.str]] = ..., is_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., run_on: Optional[pulumi.Input[_builtins.str]] = ..., runbook: Optional[pulumi.Input[Union[RunbookAssociationPropertyArgs, RunbookAssociationPropertyArgsDict]]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ..., webhook_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
