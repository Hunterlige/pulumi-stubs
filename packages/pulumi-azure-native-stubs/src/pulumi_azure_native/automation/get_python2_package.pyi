...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetPython2PackageResult', 'AwaitableGetPython2PackageResult', 'get_python2_package', 'get_python2_package_output']
@pulumi.output_type
...
class AwaitableGetPython2PackageResult(GetPython2PackageResult):
    def __await__(self): # -> Generator[Never, Any, GetPython2PackageResult]:
        ...
    


def get_python2_package(automation_account_name: Optional[_builtins.str] = ..., package_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetPython2PackageResult:
    
    ...

def get_python2_package_output(automation_account_name: Optional[pulumi.Input[_builtins.str]] = ..., package_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetPython2PackageResult]:
