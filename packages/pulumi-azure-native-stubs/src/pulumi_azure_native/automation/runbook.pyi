...
@pulumi.input_type
class RunbookArgs:
    def __init__(__self__, *, automation_account_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], runbook_type: pulumi.Input[Union[_builtins.str, RunbookTypeEnum]], description: Optional[pulumi.Input[_builtins.str]] = ..., draft: Optional[pulumi.Input[RunbookDraftArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., log_activity_trace: Optional[pulumi.Input[_builtins.int]] = ..., log_progress: Optional[pulumi.Input[_builtins.bool]] = ..., log_verbose: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., publish_content_link: Optional[pulumi.Input[ContentLinkArgs]] = ..., runbook_name: Optional[pulumi.Input[_builtins.str]] = ..., runtime_environment: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @runbook_type.setter
    def runbook_type(self, value: pulumi.Input[Union[_builtins.str, RunbookTypeEnum]]): # -> None:
        ...
    ...
    @draft.setter
    def draft(self, value: Optional[pulumi.Input[RunbookDraftArgs]]): # -> None:
        ...
    ...
    def log_activity_trace(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @log_progress.setter
    def log_progress(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @log_verbose.setter
    def log_verbose(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def publish_content_link(self, value: Optional[pulumi.Input[ContentLinkArgs]]): # -> None:
        ...
    ...
    @runbook_name.setter
    def runbook_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Runbook(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., automation_account_name: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., draft: Optional[pulumi.Input[Union[RunbookDraftArgs, RunbookDraftArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., log_activity_trace: Optional[pulumi.Input[_builtins.int]] = ..., log_progress: Optional[pulumi.Input[_builtins.bool]] = ..., log_verbose: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., publish_content_link: Optional[pulumi.Input[Union[ContentLinkArgs, ContentLinkArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., runbook_name: Optional[pulumi.Input[_builtins.str]] = ..., runbook_type: Optional[pulumi.Input[Union[_builtins.str, RunbookTypeEnum]]] = ..., runtime_environment: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: RunbookArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Runbook:
