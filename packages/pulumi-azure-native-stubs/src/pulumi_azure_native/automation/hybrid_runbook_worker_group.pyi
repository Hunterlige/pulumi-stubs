...
class HybridRunbookWorkerGroupArgs:
    def __init__(
        ...
        *,
        ...
        credential: Optional[
            pulumi.Input[RunAsCredentialAssociationPropertyArgs]
        ] = ...,
    ...
    def credential(
        self,
    ) -> Optional[pulumi.Input[RunAsCredentialAssociationPropertyArgs]]: ...
    @credential.setter
    def credential(
        self, value: Optional[pulumi.Input[RunAsCredentialAssociationPropertyArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter(name="hybridRunbookWorkerGroupName")
    def hybrid_runbook_worker_group_name(
        self,
...
class HybridRunbookWorkerGroup(pulumi.CustomResource):
    ...
    def credential(
        ...
        Optional[outputs.RunAsCredentialAssociationPropertyResponse]
    ]: ...
    @_builtins.property
