...
class CertificateArgs:
    def __init__(
        ...
        *,
        ...
        is_exportable: Optional[pulumi.Input[_builtins.bool]] = ...,
    ...
    @base64_value.setter
    def base64_value(self, value: pulumi.Input[_builtins.str]): ...
    @_builtins.property
    @pulumi.getter
    ...
    def is_exportable(self, value: Optional[pulumi.Input[_builtins.bool]]): ...
    @_builtins.property
    @pulumi.getter
...
class Certificate(pulumi.CustomResource):
    ...
    def __init__(
        ...
        base64_value: Optional[pulumi.Input[_builtins.str]] = ...,
        certificate_name: Optional[pulumi.Input[_builtins.str]] = ...,
        description: Optional[pulumi.Input[_builtins.str]] = ...,
        is_exportable: Optional[pulumi.Input[_builtins.bool]] = ...,
