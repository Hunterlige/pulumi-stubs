...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ElseConditionResponse', 'IfConditionResponse', 'ManagedServiceIdentityResponse', 'StorageTaskActionResponse', 'StorageTaskOperationResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
class ElseConditionResponse(dict):
    
    def __init__(__self__, *, operations: Sequence[outputs.StorageTaskOperationResponse]) -> None:
...
class IfConditionResponse(dict):
    ...
    def __init__(__self__, *, condition: _builtins.str, operations: Sequence[outputs.StorageTaskOperationResponse]) -> None:
...
class StorageTaskActionResponse(dict):
    ...
    def __init__(__self__, *, if_: outputs.IfConditionResponse, else_: Optional[outputs.ElseConditionResponse] = ...) -> None:
...
class StorageTaskOperationResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, on_failure: Optional[_builtins.str] = ..., on_success: Optional[_builtins.str] = ..., parameters: Optional[Mapping[str, _builtins.str]] = ...) -> None:
