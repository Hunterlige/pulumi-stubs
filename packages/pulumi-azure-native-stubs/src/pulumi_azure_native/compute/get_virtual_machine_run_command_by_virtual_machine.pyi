...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetVirtualMachineRunCommandByVirtualMachineResult', ..., 'get_virtual_machine_run_command_by_virtual_machine', ...]
@pulumi.output_type
...
class AwaitableGetVirtualMachineRunCommandByVirtualMachineResult(GetVirtualMachineRunCommandByVirtualMachineResult):
    def __await__(self): # -> Generator[Never, Any, GetVirtualMachineRunCommandByVirtualMachineResult]:
        ...
    


def get_virtual_machine_run_command_by_virtual_machine(expand: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., run_command_name: Optional[_builtins.str] = ..., vm_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetVirtualMachineRunCommandByVirtualMachineResult:
    
    ...

def get_virtual_machine_run_command_by_virtual_machine_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., run_command_name: Optional[pulumi.Input[_builtins.str]] = ..., vm_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetVirtualMachineRunCommandByVirtualMachineResult]:
