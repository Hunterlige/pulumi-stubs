...
class GalleryScriptVersionArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[GalleryScriptVersionPropertiesArgs]] = ...,
    ...
    def gallery_script_version_name(
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[GalleryScriptVersionPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[GalleryScriptVersionPropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class GalleryScriptVersion(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.GalleryScriptVersionPropertiesResponse]: ...
    @_builtins.property
