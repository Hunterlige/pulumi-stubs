...
@pulumi.input_type
class DiskArgs:
    def __init__(__self__, *, creation_data: pulumi.Input[CreationDataArgs], resource_group_name: pulumi.Input[_builtins.str], bursting_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., completion_percent: Optional[pulumi.Input[_builtins.float]] = ..., data_access_auth_mode: Optional[pulumi.Input[Union[_builtins.str, DataAccessAuthMode]]] = ..., disk_access_id: Optional[pulumi.Input[_builtins.str]] = ..., disk_iops_read_only: Optional[pulumi.Input[_builtins.float]] = ..., disk_iops_read_write: Optional[pulumi.Input[_builtins.float]] = ..., disk_m_bps_read_only: Optional[pulumi.Input[_builtins.float]] = ..., disk_m_bps_read_write: Optional[pulumi.Input[_builtins.float]] = ..., disk_name: Optional[pulumi.Input[_builtins.str]] = ..., disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., encryption: Optional[pulumi.Input[EncryptionArgs]] = ..., encryption_settings_collection: Optional[pulumi.Input[EncryptionSettingsCollectionArgs]] = ..., extended_location: Optional[pulumi.Input[ExtendedLocationArgs]] = ..., hyper_v_generation: Optional[pulumi.Input[Union[_builtins.str, HyperVGeneration]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., max_shares: Optional[pulumi.Input[_builtins.int]] = ..., network_access_policy: Optional[pulumi.Input[Union[_builtins.str, NetworkAccessPolicy]]] = ..., optimized_for_frequent_attach: Optional[pulumi.Input[_builtins.bool]] = ..., os_type: Optional[pulumi.Input[OperatingSystemTypes]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., purchase_plan: Optional[pulumi.Input[DiskPurchasePlanArgs]] = ..., security_profile: Optional[pulumi.Input[DiskSecurityProfileArgs]] = ..., sku: Optional[pulumi.Input[DiskSkuArgs]] = ..., supported_capabilities: Optional[pulumi.Input[SupportedCapabilitiesArgs]] = ..., supports_hibernation: Optional[pulumi.Input[_builtins.bool]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tier: Optional[pulumi.Input[_builtins.str]] = ..., zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def bursting_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def disk_iops_read_only(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def disk_m_bps_read_only(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @max_shares.setter
    def max_shares(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def optimized_for_frequent_attach(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class Disk(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., bursting_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., completion_percent: Optional[pulumi.Input[_builtins.float]] = ..., creation_data: Optional[pulumi.Input[Union[CreationDataArgs, CreationDataArgsDict]]] = ..., data_access_auth_mode: Optional[pulumi.Input[Union[_builtins.str, DataAccessAuthMode]]] = ..., disk_access_id: Optional[pulumi.Input[_builtins.str]] = ..., disk_iops_read_only: Optional[pulumi.Input[_builtins.float]] = ..., disk_iops_read_write: Optional[pulumi.Input[_builtins.float]] = ..., disk_m_bps_read_only: Optional[pulumi.Input[_builtins.float]] = ..., disk_m_bps_read_write: Optional[pulumi.Input[_builtins.float]] = ..., disk_name: Optional[pulumi.Input[_builtins.str]] = ..., disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., encryption: Optional[pulumi.Input[Union[EncryptionArgs, EncryptionArgsDict]]] = ..., encryption_settings_collection: Optional[pulumi.Input[Union[EncryptionSettingsCollectionArgs, EncryptionSettingsCollectionArgsDict]]] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationArgs, ExtendedLocationArgsDict]]] = ..., hyper_v_generation: Optional[pulumi.Input[Union[_builtins.str, HyperVGeneration]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., max_shares: Optional[pulumi.Input[_builtins.int]] = ..., network_access_policy: Optional[pulumi.Input[Union[_builtins.str, NetworkAccessPolicy]]] = ..., optimized_for_frequent_attach: Optional[pulumi.Input[_builtins.bool]] = ..., os_type: Optional[pulumi.Input[OperatingSystemTypes]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., purchase_plan: Optional[pulumi.Input[Union[DiskPurchasePlanArgs, DiskPurchasePlanArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., security_profile: Optional[pulumi.Input[Union[DiskSecurityProfileArgs, DiskSecurityProfileArgsDict]]] = ..., sku: Optional[pulumi.Input[Union[DiskSkuArgs, DiskSkuArgsDict]]] = ..., supported_capabilities: Optional[pulumi.Input[Union[SupportedCapabilitiesArgs, SupportedCapabilitiesArgsDict]]] = ..., supports_hibernation: Optional[pulumi.Input[_builtins.bool]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tier: Optional[pulumi.Input[_builtins.str]] = ..., zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
    ...
    @_builtins.property
    @pulumi.getter(name="optimizedForFrequentAttach")
    def optimized_for_frequent_attach(self) -> pulumi.Output[Optional[_builtins.bool]]:
