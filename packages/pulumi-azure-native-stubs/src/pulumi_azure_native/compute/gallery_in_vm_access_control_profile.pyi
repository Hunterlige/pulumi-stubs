...
class GalleryInVMAccessControlProfileArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[
            pulumi.Input[GalleryInVMAccessControlProfilePropertiesArgs]
        ] = ...,
    ...
    def in_vm_access_control_profile_name(
        self,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[GalleryInVMAccessControlProfilePropertiesArgs]]: ...
    @properties.setter
    def properties(
        self,
        value: Optional[pulumi.Input[GalleryInVMAccessControlProfilePropertiesArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class GalleryInVMAccessControlProfile(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.GalleryInVMAccessControlProfilePropertiesResponse]: ...
    @_builtins.property
