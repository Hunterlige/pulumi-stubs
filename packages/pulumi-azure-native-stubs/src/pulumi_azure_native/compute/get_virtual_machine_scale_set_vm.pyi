...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetVirtualMachineScaleSetVMResult', 'AwaitableGetVirtualMachineScaleSetVMResult', 'get_virtual_machine_scale_set_vm', 'get_virtual_machine_scale_set_vm_output']
@pulumi.output_type
class GetVirtualMachineScaleSetVMResult:
    
    def __init__(__self__, additional_capabilities=..., availability_set=..., azure_api_version=..., diagnostics_profile=..., etag=..., hardware_profile=..., id=..., identity=..., instance_id=..., instance_view=..., latest_model_applied=..., license_type=..., location=..., model_definition_applied=..., name=..., network_profile=..., network_profile_configuration=..., os_profile=..., plan=..., protection_policy=..., provisioning_state=..., resilient_vm_deletion_status=..., resources=..., security_profile=..., sku=..., storage_profile=..., system_data=..., tags=..., time_created=..., type=..., user_data=..., vm_id=..., zones=...) -> None:
        ...
...
class AwaitableGetVirtualMachineScaleSetVMResult(GetVirtualMachineScaleSetVMResult):
    def __await__(self): # -> Generator[Never, Any, GetVirtualMachineScaleSetVMResult]:
        ...
    


def get_virtual_machine_scale_set_vm(expand: Optional[_builtins.str] = ..., instance_id: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., vm_scale_set_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetVirtualMachineScaleSetVMResult:
    
    ...

def get_virtual_machine_scale_set_vm_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., instance_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., vm_scale_set_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetVirtualMachineScaleSetVMResult]:
