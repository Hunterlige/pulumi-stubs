...
__all__ = ['AccessControlRulesMode', 'AllocationStrategy', 'Architecture', 'CachingTypes', 'CloudServiceSlotType', 'CloudServiceUpgradeMode', 'ComponentName', 'ConfidentialVMEncryptionType', 'ConsistencyModeTypes', 'CopyCompletionErrorReason', 'DataAccessAuthMode', 'DedicatedHostLicenseTypes', 'DeleteOptions', 'DiffDiskOptions', 'DiffDiskPlacement', 'DiskControllerTypes', 'DiskCreateOption', 'DiskCreateOptionTypes', 'DiskDeleteOptionTypes', 'DiskDetachOptionTypes', 'DiskEncryptionSetIdentityType', 'DiskEncryptionSetType', 'DiskSecurityTypes', 'DiskStorageAccountTypes', 'DomainNameLabelScopeTypes', 'EdgeZoneStorageAccountType', 'EncryptionType', 'EndpointAccess', 'EndpointTypes', 'ExtendedLocationTypes', 'GalleryApplicationCustomActionParameterType', 'GalleryApplicationScriptRebootBehavior', 'GalleryExtendedLocationType', 'GalleryScriptParameterType', 'GallerySharingPermissionTypes', 'HostCaching', 'HyperVGeneration', 'HyperVGenerationTypes', 'IPVersion', 'IPVersions', 'IntervalInMins', 'LinuxPatchAssessmentMode', 'LinuxVMGuestPatchAutomaticByPlatformRebootSetting', 'LinuxVMGuestPatchMode', 'Mode', 'Modes', 'NetworkAccessPolicy', 'NetworkApiVersion', 'NetworkInterfaceAuxiliaryMode', 'NetworkInterfaceAuxiliarySku', 'OperatingSystemStateTypes', 'OperatingSystemTypes', 'OrchestrationMode', 'PassName', 'PrivateEndpointServiceConnectionStatus', 'ProtocolTypes', 'ProvisionedBandwidthCopyOption', 'ProximityPlacementGroupType', 'PublicIPAddressSkuName', 'PublicIPAddressSkuTier', 'PublicIPAllocationMethod', 'PublicNetworkAccess', 'RebalanceBehavior', 'RebalanceStrategy', 'RepairAction', 'ReplicationMode', 'ResilientVMDeletionStatus', 'ResourceIdentityType', 'RestorePointEncryptionType', 'SecurityEncryptionTypes', 'SecurityTypes', 'SettingNames', 'SnapshotStorageAccountTypes', 'StatusLevelTypes', 'StorageAccountStrategy', 'StorageAccountType', 'StorageAccountTypes', 'UefiKeyType', 'UefiSignatureTemplateName', 'UpgradeMode', 'VirtualMachineEvictionPolicyTypes', 'VirtualMachinePriorityTypes', 'VirtualMachineScaleSetScaleInRules', 'VirtualMachineSizeTypes', 'WindowsPatchAssessmentMode', ..., 'WindowsVMGuestPatchMode', 'ZonalPlatformFaultDomainAlignMode', 'ZonePlacementPolicyType']
