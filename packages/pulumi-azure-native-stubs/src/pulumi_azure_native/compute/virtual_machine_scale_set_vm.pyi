...
class VirtualMachineScaleSetVMArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], vm_scale_set_name: pulumi.Input[_builtins.str], additional_capabilities: Optional[pulumi.Input[AdditionalCapabilitiesArgs]] = ..., availability_set: Optional[pulumi.Input[SubResourceArgs]] = ..., diagnostics_profile: Optional[pulumi.Input[DiagnosticsProfileArgs]] = ..., hardware_profile: Optional[pulumi.Input[HardwareProfileArgs]] = ..., identity: Optional[pulumi.Input[VirtualMachineIdentityArgs]] = ..., instance_id: Optional[pulumi.Input[_builtins.str]] = ..., license_type: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., network_profile: Optional[pulumi.Input[NetworkProfileArgs]] = ..., network_profile_configuration: Optional[pulumi.Input[VirtualMachineScaleSetVMNetworkProfileConfigurationArgs]] = ..., os_profile: Optional[pulumi.Input[OSProfileArgs]] = ..., plan: Optional[pulumi.Input[PlanArgs]] = ..., protection_policy: Optional[pulumi.Input[VirtualMachineScaleSetVMProtectionPolicyArgs]] = ..., resilient_vm_deletion_status: Optional[pulumi.Input[Union[_builtins.str, ResilientVMDeletionStatus]]] = ..., security_profile: Optional[pulumi.Input[SecurityProfileArgs]] = ..., storage_profile: Optional[pulumi.Input[StorageProfileArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., user_data: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def vm_scale_set_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def network_profile_configuration(self, value: Optional[pulumi.Input[VirtualMachineScaleSetVMNetworkProfileConfigurationArgs]]): # -> None:
        ...
    ...
    def protection_policy(self, value: Optional[pulumi.Input[VirtualMachineScaleSetVMProtectionPolicyArgs]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="resilientVMDeletionStatus")
    def resilient_vm_deletion_status(self) -> Optional[pulumi.Input[Union[_builtins.str, ResilientVMDeletionStatus]]]:
        
        ...
    
    @resilient_vm_deletion_status.setter
    def resilient_vm_deletion_status(self, value: Optional[pulumi.Input[Union[_builtins.str, ResilientVMDeletionStatus]]]): # -> None:
        ...
...
class VirtualMachineScaleSetVM(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., additional_capabilities: Optional[pulumi.Input[Union[AdditionalCapabilitiesArgs, AdditionalCapabilitiesArgsDict]]] = ..., availability_set: Optional[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]] = ..., diagnostics_profile: Optional[pulumi.Input[Union[DiagnosticsProfileArgs, DiagnosticsProfileArgsDict]]] = ..., hardware_profile: Optional[pulumi.Input[Union[HardwareProfileArgs, HardwareProfileArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[VirtualMachineIdentityArgs, VirtualMachineIdentityArgsDict]]] = ..., instance_id: Optional[pulumi.Input[_builtins.str]] = ..., license_type: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., network_profile: Optional[pulumi.Input[Union[NetworkProfileArgs, NetworkProfileArgsDict]]] = ..., network_profile_configuration: Optional[pulumi.Input[Union[VirtualMachineScaleSetVMNetworkProfileConfigurationArgs, VirtualMachineScaleSetVMNetworkProfileConfigurationArgsDict]]] = ..., os_profile: Optional[pulumi.Input[Union[OSProfileArgs, OSProfileArgsDict]]] = ..., plan: Optional[pulumi.Input[Union[PlanArgs, PlanArgsDict]]] = ..., protection_policy: Optional[pulumi.Input[Union[VirtualMachineScaleSetVMProtectionPolicyArgs, VirtualMachineScaleSetVMProtectionPolicyArgsDict]]] = ..., resilient_vm_deletion_status: Optional[pulumi.Input[Union[_builtins.str, ResilientVMDeletionStatus]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., security_profile: Optional[pulumi.Input[Union[SecurityProfileArgs, SecurityProfileArgsDict]]] = ..., storage_profile: Optional[pulumi.Input[Union[StorageProfileArgs, StorageProfileArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., user_data: Optional[pulumi.Input[_builtins.str]] = ..., vm_scale_set_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: VirtualMachineScaleSetVMArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> VirtualMachineScaleSetVM:
    ...
    @_builtins.property
    @pulumi.getter(name="resilientVMDeletionStatus")
    def resilient_vm_deletion_status(self) -> pulumi.Output[Optional[_builtins.str]]:
