...
class GetDiskResult:
    ...
    def __init__(__self__, azure_api_version=..., bursting_enabled=..., bursting_enabled_time=..., completion_percent=..., creation_data=..., data_access_auth_mode=..., disk_access_id=..., disk_iops_read_only=..., disk_iops_read_write=..., disk_m_bps_read_only=..., disk_m_bps_read_write=..., disk_size_bytes=..., disk_size_gb=..., disk_state=..., encryption=..., encryption_settings_collection=..., extended_location=..., hyper_v_generation=..., id=..., last_ownership_update_time=..., location=..., managed_by=..., managed_by_extended=..., max_shares=..., name=..., network_access_policy=..., optimized_for_frequent_attach=..., os_type=..., property_updates_in_progress=..., provisioning_state=..., public_network_access=..., purchase_plan=..., security_profile=..., share_info=..., sku=..., supported_capabilities=..., supports_hibernation=..., system_data=..., tags=..., tier=..., time_created=..., type=..., unique_id=..., zones=...) -> None:
        ...
...
def get_disk(disk_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDiskResult:
    
    ...

def get_disk_output(disk_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDiskResult]:
