...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetVirtualMachineScaleSetVMRunCommandResult', ..., 'get_virtual_machine_scale_set_vm_run_command', ...]
@pulumi.output_type
class GetVirtualMachineScaleSetVMRunCommandResult:
    
    def __init__(__self__, async_execution=..., azure_api_version=..., error_blob_managed_identity=..., error_blob_uri=..., id=..., instance_view=..., location=..., name=..., output_blob_managed_identity=..., output_blob_uri=..., parameters=..., protected_parameters=..., provisioning_state=..., run_as_password=..., run_as_user=..., source=..., system_data=..., tags=..., timeout_in_seconds=..., treat_failure_as_deployment_failure=..., type=...) -> None:
        ...
...
class AwaitableGetVirtualMachineScaleSetVMRunCommandResult(GetVirtualMachineScaleSetVMRunCommandResult):
    def __await__(self): # -> Generator[Never, Any, GetVirtualMachineScaleSetVMRunCommandResult]:
        ...
    


def get_virtual_machine_scale_set_vm_run_command(expand: Optional[_builtins.str] = ..., instance_id: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., run_command_name: Optional[_builtins.str] = ..., vm_scale_set_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetVirtualMachineScaleSetVMRunCommandResult:
    
    ...

def get_virtual_machine_scale_set_vm_run_command_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., instance_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., run_command_name: Optional[pulumi.Input[_builtins.str]] = ..., vm_scale_set_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetVirtualMachineScaleSetVMRunCommandResult]:
