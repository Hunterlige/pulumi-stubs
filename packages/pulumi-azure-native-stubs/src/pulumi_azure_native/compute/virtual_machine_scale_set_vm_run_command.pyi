...
class VirtualMachineScaleSetVMRunCommand(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., async_execution: Optional[pulumi.Input[_builtins.bool]] = ..., error_blob_managed_identity: Optional[pulumi.Input[Union[RunCommandManagedIdentityArgs, RunCommandManagedIdentityArgsDict]]] = ..., error_blob_uri: Optional[pulumi.Input[_builtins.str]] = ..., instance_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., output_blob_managed_identity: Optional[pulumi.Input[Union[RunCommandManagedIdentityArgs, RunCommandManagedIdentityArgsDict]]] = ..., output_blob_uri: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union[RunCommandInputParameterArgs, RunCommandInputParameterArgsDict]]]]] = ..., protected_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union[RunCommandInputParameterArgs, RunCommandInputParameterArgsDict]]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., run_as_password: Optional[pulumi.Input[_builtins.str]] = ..., run_as_user: Optional[pulumi.Input[_builtins.str]] = ..., run_command_name: Optional[pulumi.Input[_builtins.str]] = ..., source: Optional[pulumi.Input[Union[VirtualMachineRunCommandScriptSourceArgs, VirtualMachineRunCommandScriptSourceArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., timeout_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., treat_failure_as_deployment_failure: Optional[pulumi.Input[_builtins.bool]] = ..., vm_scale_set_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: VirtualMachineScaleSetVMRunCommandArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> VirtualMachineScaleSetVMRunCommand:
