...
class GalleryImageArgs:
    def __init__(__self__, *, gallery_name: pulumi.Input[_builtins.str], identifier: pulumi.Input[GalleryImageIdentifierArgs], os_state: pulumi.Input[OperatingSystemStateTypes], os_type: pulumi.Input[OperatingSystemTypes], resource_group_name: pulumi.Input[_builtins.str], allow_update_image: Optional[pulumi.Input[_builtins.bool]] = ..., architecture: Optional[pulumi.Input[Union[_builtins.str, Architecture]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., disallowed: Optional[pulumi.Input[DisallowedArgs]] = ..., end_of_life_date: Optional[pulumi.Input[_builtins.str]] = ..., eula: Optional[pulumi.Input[_builtins.str]] = ..., features: Optional[pulumi.Input[Sequence[pulumi.Input[GalleryImageFeatureArgs]]]] = ..., gallery_image_name: Optional[pulumi.Input[_builtins.str]] = ..., hyper_v_generation: Optional[pulumi.Input[Union[_builtins.str, HyperVGeneration]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., privacy_statement_uri: Optional[pulumi.Input[_builtins.str]] = ..., purchase_plan: Optional[pulumi.Input[ImagePurchasePlanArgs]] = ..., recommended: Optional[pulumi.Input[RecommendedMachineConfigurationArgs]] = ..., release_note_uri: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @identifier.setter
    def identifier(self, value: pulumi.Input[GalleryImageIdentifierArgs]): # -> None:
        ...
    ...
    def allow_update_image(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @disallowed.setter
    def disallowed(self, value: Optional[pulumi.Input[DisallowedArgs]]): # -> None:
        ...
    ...
    @features.setter
    def features(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[GalleryImageFeatureArgs]]]]): # -> None:
        ...
    ...
    def gallery_image_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def purchase_plan(self, value: Optional[pulumi.Input[ImagePurchasePlanArgs]]): # -> None:
        ...
    ...
    @recommended.setter
    def recommended(self, value: Optional[pulumi.Input[RecommendedMachineConfigurationArgs]]): # -> None:
        ...
...
class GalleryImage(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., allow_update_image: Optional[pulumi.Input[_builtins.bool]] = ..., architecture: Optional[pulumi.Input[Union[_builtins.str, Architecture]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., disallowed: Optional[pulumi.Input[Union[DisallowedArgs, DisallowedArgsDict]]] = ..., end_of_life_date: Optional[pulumi.Input[_builtins.str]] = ..., eula: Optional[pulumi.Input[_builtins.str]] = ..., features: Optional[pulumi.Input[Sequence[pulumi.Input[Union[GalleryImageFeatureArgs, GalleryImageFeatureArgsDict]]]]] = ..., gallery_image_name: Optional[pulumi.Input[_builtins.str]] = ..., gallery_name: Optional[pulumi.Input[_builtins.str]] = ..., hyper_v_generation: Optional[pulumi.Input[Union[_builtins.str, HyperVGeneration]]] = ..., identifier: Optional[pulumi.Input[Union[GalleryImageIdentifierArgs, GalleryImageIdentifierArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., os_state: Optional[pulumi.Input[OperatingSystemStateTypes]] = ..., os_type: Optional[pulumi.Input[OperatingSystemTypes]] = ..., privacy_statement_uri: Optional[pulumi.Input[_builtins.str]] = ..., purchase_plan: Optional[pulumi.Input[Union[ImagePurchasePlanArgs, ImagePurchasePlanArgsDict]]] = ..., recommended: Optional[pulumi.Input[Union[RecommendedMachineConfigurationArgs, RecommendedMachineConfigurationArgsDict]]] = ..., release_note_uri: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: GalleryImageArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> GalleryImage:
