...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetVirtualMachineScaleSetResult', 'AwaitableGetVirtualMachineScaleSetResult', 'get_virtual_machine_scale_set', 'get_virtual_machine_scale_set_output']
@pulumi.output_type
class GetVirtualMachineScaleSetResult:
    
    def __init__(__self__, additional_capabilities=..., automatic_repairs_policy=..., azure_api_version=..., constrained_maximum_capacity=..., do_not_run_extensions_on_overprovisioned_vms=..., etag=..., extended_location=..., host_group=..., id=..., identity=..., location=..., name=..., orchestration_mode=..., overprovision=..., plan=..., platform_fault_domain_count=..., priority_mix_policy=..., provisioning_state=..., proximity_placement_group=..., resiliency_policy=..., scale_in_policy=..., scheduled_events_policy=..., single_placement_group=..., sku=..., sku_profile=..., spot_restore_policy=..., system_data=..., tags=..., time_created=..., type=..., unique_id=..., upgrade_policy=..., virtual_machine_profile=..., zonal_platform_fault_domain_align_mode=..., zone_balance=..., zones=...) -> None:
        ...
    ...
    def do_not_run_extensions_on_overprovisioned_vms(self) -> Optional[_builtins.bool]:
...
class AwaitableGetVirtualMachineScaleSetResult(GetVirtualMachineScaleSetResult):
    def __await__(self): # -> Generator[Never, Any, GetVirtualMachineScaleSetResult]:
        ...
    


def get_virtual_machine_scale_set(expand: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., vm_scale_set_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetVirtualMachineScaleSetResult:
    
    ...

def get_virtual_machine_scale_set_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., vm_scale_set_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetVirtualMachineScaleSetResult]:
