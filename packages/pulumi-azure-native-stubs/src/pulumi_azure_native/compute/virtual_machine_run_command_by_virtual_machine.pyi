...
class VirtualMachineRunCommandByVirtualMachineArgs:
    def __init__(
        ...
        *,
        ...
        source: Optional[pulumi.Input[VirtualMachineRunCommandScriptSourceArgs]] = ...,
    ...
    def source(
        self,
    ) -> Optional[pulumi.Input[VirtualMachineRunCommandScriptSourceArgs]]: ...
    @source.setter
    def source(
        self, value: Optional[pulumi.Input[VirtualMachineRunCommandScriptSourceArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
