...
class GetVirtualMachineResult:
    ...
    def __init__(__self__, additional_capabilities=..., application_profile=..., availability_set=..., azure_api_version=..., billing_profile=..., capacity_reservation=..., diagnostics_profile=..., etag=..., eviction_policy=..., extended_location=..., extensions_time_budget=..., hardware_profile=..., host=..., host_group=..., id=..., identity=..., instance_view=..., license_type=..., location=..., managed_by=..., name=..., network_profile=..., os_profile=..., placement=..., plan=..., platform_fault_domain=..., priority=..., provisioning_state=..., proximity_placement_group=..., resources=..., scheduled_events_policy=..., scheduled_events_profile=..., security_profile=..., storage_profile=..., system_data=..., tags=..., time_created=..., type=..., user_data=..., virtual_machine_scale_set=..., vm_id=..., zones=...) -> None:
        ...
...
def get_virtual_machine(expand: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., vm_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetVirtualMachineResult:
    
    ...

def get_virtual_machine_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., vm_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetVirtualMachineResult]:
