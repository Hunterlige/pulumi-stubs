...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ArmIdentityResponse', 'ArmUserIdentityResponse', 'CertificatePropertiesResponse', 'CloudToDevicePropertiesResponse', 'EnrichmentPropertiesResponse', 'EventHubPropertiesResponse', 'FallbackRoutePropertiesResponse', 'FeedbackPropertiesResponse', 'IotHubLocationDescriptionResponse', 'IotHubPropertiesResponse', 'IotHubSkuInfoResponse', 'IpFilterRuleResponse', 'ManagedIdentityResponse', 'MessagingEndpointPropertiesResponse', 'NetworkRuleSetIpRuleResponse', 'NetworkRuleSetPropertiesResponse', 'PrivateEndpointConnectionPropertiesResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'RoutePropertiesResponse', 'RoutingCosmosDBSqlApiPropertiesResponse', 'RoutingEndpointsResponse', 'RoutingEventHubPropertiesResponse', 'RoutingPropertiesResponse', 'RoutingServiceBusQueueEndpointPropertiesResponse', 'RoutingServiceBusTopicEndpointPropertiesResponse', 'RoutingStorageContainerPropertiesResponse', 'SharedAccessSignatureAuthorizationRuleResponse', 'StorageEndpointPropertiesResponse', 'SystemDataResponse']
@pulumi.output_type
class ArmIdentityResponse(dict):
    ...
    def __init__(__self__, *, principal_id: _builtins.str, tenant_id: _builtins.str, type: Optional[_builtins.str] = ..., user_assigned_identities: Optional[Mapping[str, outputs.ArmUserIdentityResponse]] = ...) -> None:
...
class CertificatePropertiesResponse(dict):
    ...
    def __init__(__self__, *, created: _builtins.str, expiry: _builtins.str, subject: _builtins.str, thumbprint: _builtins.str, updated: _builtins.str, certificate: Optional[_builtins.str] = ..., is_verified: Optional[_builtins.bool] = ...) -> None:
...
class CloudToDevicePropertiesResponse(dict):
    ...
    def __init__(__self__, *, default_ttl_as_iso8601: Optional[_builtins.str] = ..., feedback: Optional[outputs.FeedbackPropertiesResponse] = ..., max_delivery_count: Optional[_builtins.int] = ...) -> None:
...
class EnrichmentPropertiesResponse(dict):
    ...
    def __init__(__self__, *, endpoint_names: Sequence[_builtins.str], key: _builtins.str, value: _builtins.str) -> None:
...
class EventHubPropertiesResponse(dict):
    ...
    def __init__(__self__, *, endpoint: _builtins.str, partition_ids: Sequence[_builtins.str], path: _builtins.str, partition_count: Optional[_builtins.int] = ..., retention_time_in_days: Optional[_builtins.float] = ...) -> None:
...
class FallbackRoutePropertiesResponse(dict):
    ...
    def __init__(__self__, *, endpoint_names: Sequence[_builtins.str], is_enabled: _builtins.bool, source: _builtins.str, condition: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class FeedbackPropertiesResponse(dict):
    ...
    def __init__(__self__, *, lock_duration_as_iso8601: Optional[_builtins.str] = ..., max_delivery_count: Optional[_builtins.int] = ..., ttl_as_iso8601: Optional[_builtins.str] = ...) -> None:
...
class IotHubLocationDescriptionResponse(dict):
    ...
    def __init__(__self__, *, location: Optional[_builtins.str] = ..., role: Optional[_builtins.str] = ...) -> None:
...
class IotHubPropertiesResponse(dict):
    ...
    def __init__(__self__, *, host_name: _builtins.str, locations: Sequence[outputs.IotHubLocationDescriptionResponse], provisioning_state: _builtins.str, state: _builtins.str, allowed_fqdn_list: Optional[Sequence[_builtins.str]] = ..., authorization_policies: Optional[Sequence[outputs.SharedAccessSignatureAuthorizationRuleResponse]] = ..., cloud_to_device: Optional[outputs.CloudToDevicePropertiesResponse] = ..., comments: Optional[_builtins.str] = ..., disable_device_sas: Optional[_builtins.bool] = ..., disable_local_auth: Optional[_builtins.bool] = ..., disable_module_sas: Optional[_builtins.bool] = ..., enable_data_residency: Optional[_builtins.bool] = ..., enable_file_upload_notifications: Optional[_builtins.bool] = ..., event_hub_endpoints: Optional[Mapping[str, outputs.EventHubPropertiesResponse]] = ..., features: Optional[_builtins.str] = ..., ip_filter_rules: Optional[Sequence[outputs.IpFilterRuleResponse]] = ..., messaging_endpoints: Optional[Mapping[str, outputs.MessagingEndpointPropertiesResponse]] = ..., min_tls_version: Optional[_builtins.str] = ..., network_rule_sets: Optional[outputs.NetworkRuleSetPropertiesResponse] = ..., private_endpoint_connections: Optional[Sequence[outputs.PrivateEndpointConnectionResponse]] = ..., public_network_access: Optional[_builtins.str] = ..., restrict_outbound_network_access: Optional[_builtins.bool] = ..., routing: Optional[outputs.RoutingPropertiesResponse] = ..., storage_endpoints: Optional[Mapping[str, outputs.StorageEndpointPropertiesResponse]] = ...) -> None:
...
class IotHubSkuInfoResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, tier: _builtins.str, capacity: Optional[_builtins.float] = ...) -> None:
...
class IpFilterRuleResponse(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, filter_name: _builtins.str, ip_mask: _builtins.str) -> None:
...
class NetworkRuleSetIpRuleResponse(dict):
    ...
    def __init__(__self__, *, filter_name: _builtins.str, ip_mask: _builtins.str, action: Optional[_builtins.str] = ...) -> None:
...
class NetworkRuleSetPropertiesResponse(dict):
    ...
    def __init__(__self__, *, apply_to_built_in_event_hub_endpoint: _builtins.bool, ip_rules: Sequence[outputs.NetworkRuleSetIpRuleResponse], default_action: Optional[_builtins.str] = ...) -> None:
...
class PrivateEndpointConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, private_link_service_connection_state: outputs.PrivateLinkServiceConnectionStateResponse, private_endpoint: Optional[outputs.PrivateEndpointResponse] = ...) -> None:
...
class PrivateLinkServiceConnectionStateResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, status: _builtins.str, actions_required: Optional[_builtins.str] = ...) -> None:
...
class RoutePropertiesResponse(dict):
    ...
    def __init__(__self__, *, endpoint_names: Sequence[_builtins.str], is_enabled: _builtins.bool, name: _builtins.str, source: _builtins.str, condition: Optional[_builtins.str] = ...) -> None:
...
class RoutingCosmosDBSqlApiPropertiesResponse(dict):
    ...
    def __init__(__self__, *, container_name: _builtins.str, database_name: _builtins.str, endpoint_uri: _builtins.str, id: _builtins.str, name: _builtins.str, authentication_type: Optional[_builtins.str] = ..., identity: Optional[outputs.ManagedIdentityResponse] = ..., partition_key_name: Optional[_builtins.str] = ..., partition_key_template: Optional[_builtins.str] = ..., primary_key: Optional[_builtins.str] = ..., resource_group: Optional[_builtins.str] = ..., secondary_key: Optional[_builtins.str] = ..., subscription_id: Optional[_builtins.str] = ...) -> None:
...
class RoutingEndpointsResponse(dict):
    ...
    def __init__(__self__, *, cosmos_db_sql_containers: Optional[Sequence[outputs.RoutingCosmosDBSqlApiPropertiesResponse]] = ..., event_hubs: Optional[Sequence[outputs.RoutingEventHubPropertiesResponse]] = ..., service_bus_queues: Optional[Sequence[outputs.RoutingServiceBusQueueEndpointPropertiesResponse]] = ..., service_bus_topics: Optional[Sequence[outputs.RoutingServiceBusTopicEndpointPropertiesResponse]] = ..., storage_containers: Optional[Sequence[outputs.RoutingStorageContainerPropertiesResponse]] = ...) -> None:
...
class RoutingEventHubPropertiesResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, authentication_type: Optional[_builtins.str] = ..., connection_string: Optional[_builtins.str] = ..., endpoint_uri: Optional[_builtins.str] = ..., entity_path: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., identity: Optional[outputs.ManagedIdentityResponse] = ..., resource_group: Optional[_builtins.str] = ..., subscription_id: Optional[_builtins.str] = ...) -> None:
...
class RoutingPropertiesResponse(dict):
    ...
    def __init__(__self__, *, endpoints: Optional[outputs.RoutingEndpointsResponse] = ..., enrichments: Optional[Sequence[outputs.EnrichmentPropertiesResponse]] = ..., fallback_route: Optional[outputs.FallbackRoutePropertiesResponse] = ..., routes: Optional[Sequence[outputs.RoutePropertiesResponse]] = ...) -> None:
...
class RoutingStorageContainerPropertiesResponse(dict):
    ...
    def __init__(__self__, *, container_name: _builtins.str, name: _builtins.str, authentication_type: Optional[_builtins.str] = ..., batch_frequency_in_seconds: Optional[_builtins.int] = ..., connection_string: Optional[_builtins.str] = ..., encoding: Optional[_builtins.str] = ..., endpoint_uri: Optional[_builtins.str] = ..., file_name_format: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., identity: Optional[outputs.ManagedIdentityResponse] = ..., max_chunk_size_in_bytes: Optional[_builtins.int] = ..., resource_group: Optional[_builtins.str] = ..., subscription_id: Optional[_builtins.str] = ...) -> None:
...
class SharedAccessSignatureAuthorizationRuleResponse(dict):
    ...
    def __init__(__self__, *, key_name: _builtins.str, rights: _builtins.str, primary_key: Optional[_builtins.str] = ..., secondary_key: Optional[_builtins.str] = ...) -> None:
...
class StorageEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *, connection_string: _builtins.str, container_name: _builtins.str, authentication_type: Optional[_builtins.str] = ..., identity: Optional[outputs.ManagedIdentityResponse] = ..., sas_ttl_as_iso8601: Optional[_builtins.str] = ...) -> None:
