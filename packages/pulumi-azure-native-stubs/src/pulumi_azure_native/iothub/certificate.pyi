...
class CertificateArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], resource_name: pulumi.Input[_builtins.str], certificate_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[CertificatePropertiesArgs]] = ...) -> None:
...
@pulumi.type_token("azure-native:iothub:Certificate")
