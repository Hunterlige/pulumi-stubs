...
class OnlineExperimentationWorkspaceArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[
            pulumi.Input[OnlineExperimentationWorkspacePropertiesArgs]
        ] = ...,
        sku: Optional[pulumi.Input[OnlineExperimentationWorkspaceSkuArgs]] = ...,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[OnlineExperimentationWorkspacePropertiesArgs]]: ...
    @properties.setter
    def properties(
        self,
        value: Optional[pulumi.Input[OnlineExperimentationWorkspacePropertiesArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter
    ...
    @sku.setter
    def sku(
        self, value: Optional[pulumi.Input[OnlineExperimentationWorkspaceSkuArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class OnlineExperimentationWorkspace(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.OnlineExperimentationWorkspacePropertiesResponse]: ...
    @_builtins.property
    @pulumi.getter
    def sku(
        self,
    ) -> pulumi.Output[Optional[outputs.OnlineExperimentationWorkspaceSkuResponse]]: ...
    @_builtins.property
