...
class GetOnlineExperimentationWorkspaceResult:
    ...
    def properties(
        self,
    ) -> outputs.OnlineExperimentationWorkspacePropertiesResponse: ...
    @_builtins.property
    @pulumi.getter
...
class AwaitableGetOnlineExperimentationWorkspaceResult(
    GetOnlineExperimentationWorkspaceResult
):
    def __await__(self): ...

def get_online_experimentation_workspace(
    resource_group_name: Optional[_builtins.str] = ...,
    workspace_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetOnlineExperimentationWorkspaceResult: ...
def get_online_experimentation_workspace_output(
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    workspace_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetOnlineExperimentationWorkspaceResult]: ...
