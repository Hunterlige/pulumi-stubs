...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AttestationEvidenceResponse', 'ErrorDefinitionResponse', 'RemediationDeploymentResponse', 'RemediationDeploymentSummaryResponse', 'RemediationFiltersResponse', 'RemediationPropertiesResponseFailureThreshold', 'SystemDataResponse', 'TypedErrorInfoResponse']
@pulumi.output_type
class AttestationEvidenceResponse(dict):
    ...
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., source_uri: Optional[_builtins.str] = ...) -> None:
...
class ErrorDefinitionResponse(dict):
    ...
    def __init__(__self__, *, additional_info: Sequence[outputs.TypedErrorInfoResponse], code: _builtins.str, details: Sequence[outputs.ErrorDefinitionResponse], message: _builtins.str, target: _builtins.str) -> None:
...
class RemediationDeploymentResponse(dict):
    ...
    def __init__(__self__, *, created_on: _builtins.str, deployment_id: _builtins.str, error: outputs.ErrorDefinitionResponse, last_updated_on: _builtins.str, remediated_resource_id: _builtins.str, resource_location: _builtins.str, status: _builtins.str) -> None:
...
class RemediationDeploymentSummaryResponse(dict):
    ...
    def __init__(__self__, *, failed_deployments: _builtins.int, successful_deployments: _builtins.int, total_deployments: _builtins.int) -> None:
...
class RemediationFiltersResponse(dict):
    ...
    def __init__(__self__, *, locations: Optional[Sequence[_builtins.str]] = ..., resource_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
