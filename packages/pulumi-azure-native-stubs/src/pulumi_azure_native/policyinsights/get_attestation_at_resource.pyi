...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetAttestationAtResourceResult', 'AwaitableGetAttestationAtResourceResult', 'get_attestation_at_resource', 'get_attestation_at_resource_output']
@pulumi.output_type
...
class AwaitableGetAttestationAtResourceResult(GetAttestationAtResourceResult):
    def __await__(self): # -> Generator[Never, Any, GetAttestationAtResourceResult]:
        ...
    


def get_attestation_at_resource(attestation_name: Optional[_builtins.str] = ..., resource_id: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAttestationAtResourceResult:
    
    ...

def get_attestation_at_resource_output(attestation_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAttestationAtResourceResult]:
