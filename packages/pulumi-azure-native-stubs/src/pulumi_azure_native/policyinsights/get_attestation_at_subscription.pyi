...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetAttestationAtSubscriptionResult', 'AwaitableGetAttestationAtSubscriptionResult', 'get_attestation_at_subscription', 'get_attestation_at_subscription_output']
@pulumi.output_type
...
class AwaitableGetAttestationAtSubscriptionResult(GetAttestationAtSubscriptionResult):
    def __await__(self): # -> Generator[Never, Any, GetAttestationAtSubscriptionResult]:
        ...
    


def get_attestation_at_subscription(attestation_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAttestationAtSubscriptionResult:
    
    ...

def get_attestation_at_subscription_output(attestation_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAttestationAtSubscriptionResult]:
