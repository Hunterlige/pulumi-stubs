...
class AttestationAtResourceGroupArgs:
    def __init__(__self__, *, policy_assignment_id: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], assessment_date: Optional[pulumi.Input[_builtins.str]] = ..., attestation_name: Optional[pulumi.Input[_builtins.str]] = ..., comments: Optional[pulumi.Input[_builtins.str]] = ..., compliance_state: Optional[pulumi.Input[Union[_builtins.str, ComplianceState]]] = ..., evidence: Optional[pulumi.Input[Sequence[pulumi.Input[AttestationEvidenceArgs]]]] = ..., expires_on: Optional[pulumi.Input[_builtins.str]] = ..., metadata: Optional[Any] = ..., owner: Optional[pulumi.Input[_builtins.str]] = ..., policy_definition_reference_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AttestationAtResourceGroup(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> AttestationAtResourceGroup:
