...
@pulumi.input_type
class WorkspaceArgs:
    def __init__(__self__, *, owner_email: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], user_storage_account_id: pulumi.Input[_builtins.str], key_vault_identifier_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[SkuArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @owner_email.setter
    def owner_email(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def user_storage_account_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def key_vault_identifier_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Workspace(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., key_vault_identifier_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., owner_email: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[SkuArgs, SkuArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., user_storage_account_id: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
