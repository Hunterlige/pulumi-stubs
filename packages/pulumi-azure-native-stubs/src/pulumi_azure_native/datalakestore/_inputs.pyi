...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CreateFirewallRuleWithAccountParametersArgs', 'CreateFirewallRuleWithAccountParametersArgsDict', 'CreateTrustedIdProviderWithAccountParametersArgs', ..., 'CreateVirtualNetworkRuleWithAccountParametersArgs', ..., 'EncryptionConfigArgs', 'EncryptionConfigArgsDict', 'EncryptionIdentityArgs', 'EncryptionIdentityArgsDict', 'KeyVaultMetaInfoArgs', 'KeyVaultMetaInfoArgsDict']
...
class CreateFirewallRuleWithAccountParametersArgs:
    def __init__(__self__, *, end_ip_address: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], start_ip_address: pulumi.Input[_builtins.str]) -> None:
...
class CreateTrustedIdProviderWithAccountParametersArgs:
    def __init__(__self__, *, id_provider: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str]) -> None:
...
class CreateVirtualNetworkRuleWithAccountParametersArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], subnet_id: pulumi.Input[_builtins.str]) -> None:
...
class EncryptionConfigArgs:
    def __init__(__self__, *, type: pulumi.Input[EncryptionConfigType], key_vault_meta_info: Optional[pulumi.Input[KeyVaultMetaInfoArgs]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[EncryptionConfigType]): # -> None:
        ...
    ...
    def key_vault_meta_info(self, value: Optional[pulumi.Input[KeyVaultMetaInfoArgs]]): # -> None:
        ...
...
class EncryptionIdentityArgs:
    ...
    @type.setter
    def type(self, value: pulumi.Input[EncryptionIdentityType]): # -> None:
        ...
...
class KeyVaultMetaInfoArgs:
    def __init__(__self__, *, encryption_key_name: pulumi.Input[_builtins.str], encryption_key_version: pulumi.Input[_builtins.str], key_vault_resource_id: pulumi.Input[_builtins.str]) -> None:
    ...
    def encryption_key_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def encryption_key_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def key_vault_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
