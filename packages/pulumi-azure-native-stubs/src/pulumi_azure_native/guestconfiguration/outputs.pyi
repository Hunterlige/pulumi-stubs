...
class AssignmentReportResourceResponse(dict):
    ...
    def __init__(__self__, *, compliance_status: _builtins.str, properties: Any, resource_id: _builtins.str, reasons: Optional[Sequence[outputs.AssignmentReportResourceComplianceReasonResponse]] = ...) -> None:
...
class AssignmentReportResponse(dict):
    ...
    def __init__(__self__, *, compliance_status: _builtins.str, end_time: _builtins.str, id: _builtins.str, operation_type: _builtins.str, report_id: _builtins.str, start_time: _builtins.str, assignment: Optional[outputs.AssignmentInfoResponse] = ..., resources: Optional[Sequence[outputs.AssignmentReportResourceResponse]] = ..., vm: Optional[outputs.VMInfoResponse] = ...) -> None:
...
class ConfigurationSettingResponse(dict):
    ...
    def __init__(__self__, *, action_after_reboot: _builtins.str, allow_module_overwrite: _builtins.bool, configuration_mode: _builtins.str, configuration_mode_frequency_mins: Optional[_builtins.float] = ..., reboot_if_needed: _builtins.bool, refresh_frequency_mins: Optional[_builtins.float] = ...) -> None:
...
class GuestConfigurationAssignmentPropertiesResponse(dict):
    ...
    def __init__(__self__, *, assignment_hash: _builtins.str, compliance_status: _builtins.str, last_compliance_status_checked: _builtins.str, latest_report_id: _builtins.str, parameter_hash: _builtins.str, provisioning_state: _builtins.str, resource_type: _builtins.str, target_resource_id: _builtins.str, context: Optional[_builtins.str] = ..., guest_configuration: Optional[outputs.GuestConfigurationNavigationResponse] = ..., latest_assignment_report: Optional[outputs.AssignmentReportResponse] = ..., vmss_vm_list: Optional[Sequence[outputs.VMSSVMInfoResponse]] = ...) -> None:
...
class GuestConfigurationNavigationResponse(dict):
    ...
    def __init__(__self__, *, assignment_source: _builtins.str, configuration_setting: outputs.ConfigurationSettingResponse, content_type: _builtins.str, assignment_type: Optional[_builtins.str] = ..., configuration_parameter: Optional[Sequence[outputs.ConfigurationParameterResponse]] = ..., configuration_protected_parameter: Optional[Sequence[outputs.ConfigurationParameterResponse]] = ..., content_hash: Optional[_builtins.str] = ..., content_managed_identity: Optional[_builtins.str] = ..., content_uri: Optional[_builtins.str] = ..., kind: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class VMSSVMInfoResponse(dict):
    ...
    def __init__(__self__, *, compliance_status: _builtins.str, last_compliance_checked: _builtins.str, latest_report_id: _builtins.str, vm_id: _builtins.str, vm_resource_id: _builtins.str) -> None:
