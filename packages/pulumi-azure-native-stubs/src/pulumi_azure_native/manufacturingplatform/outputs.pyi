...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AdxProfileResponse', 'AksProfileResponse', 'ApplicationVersionResponse', 'CmkProfileResponse', 'DatabaseProfileResponse', 'DenyAssignmentExclusionResponse', 'EventHubProfileResponse', 'FabricProfileResponse', 'FunctionAppProfileResponse', 'ManagedOnBehalfOfConfigurationResponse', 'ManagedResourceGroupConfigurationResponse', 'ManagedServiceIdentityResponse', 'MdsResourcePropertiesResponse', 'MoboBrokerResourceResponse', 'MonitoringProfileResponse', 'OpenAIProfileResponse', 'RedisProfileResponse', 'SkuResponse', 'StorageProfileResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse', 'UserManagedOpenAIProfileResponse']
@pulumi.output_type
class AdxProfileResponse(dict):
    ...
    def __init__(__self__, *, data_ingestion_uri: _builtins.str, id: _builtins.str, uri: _builtins.str) -> None:
...
class ApplicationVersionResponse(dict):
    ...
    def __init__(__self__, *, is_deprecated: _builtins.bool, is_latest: _builtins.bool, is_preview: _builtins.bool, version: _builtins.str) -> None:
...
class EventHubProfileResponse(dict):
    ...
    def __init__(__self__, *, adx_instance_id: _builtins.str, host_name: _builtins.str) -> None:
...
class FabricProfileResponse(dict):
    ...
    def __init__(__self__, *, key_uri: _builtins.str, one_lake_path: _builtins.str, one_lake_uri: _builtins.str) -> None:
...
class MdsResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, aad_application_id: _builtins.str, adx_profile: outputs.AdxProfileResponse, aks_profile: outputs.AksProfileResponse, database_profile: outputs.DatabaseProfileResponse, event_hub_profile: outputs.EventHubProfileResponse, function_app_profile: outputs.FunctionAppProfileResponse, managed_on_behalf_of_configuration: outputs.ManagedOnBehalfOfConfigurationResponse, managed_resource_group_configuration: outputs.ManagedResourceGroupConfigurationResponse, monitoring_profile: outputs.MonitoringProfileResponse, provisioning_state: _builtins.str, redis_profile: outputs.RedisProfileResponse, service_url: _builtins.str, storage_profile: outputs.StorageProfileResponse, aks_admin_group_id: Optional[_builtins.str] = ..., cmk_profile: Optional[outputs.CmkProfileResponse] = ..., deny_assignment_exclusions: Optional[Sequence[outputs.DenyAssignmentExclusionResponse]] = ..., enable_copilot: Optional[_builtins.bool] = ..., enable_diagnostic_settings: Optional[_builtins.bool] = ..., fabric_profile: Optional[outputs.FabricProfileResponse] = ..., open_ai_profile: Optional[outputs.OpenAIProfileResponse] = ..., redundancy_state: Optional[_builtins.str] = ..., resource_state: Optional[_builtins.str] = ..., user_managed_open_ai_profile: Optional[outputs.UserManagedOpenAIProfileResponse] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class OpenAIProfileResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, embedding_model_capacity: Optional[_builtins.int] = ..., embedding_model_name: Optional[_builtins.str] = ..., embedding_model_sku_name: Optional[_builtins.str] = ..., embedding_model_version: Optional[_builtins.str] = ..., gpt_model_capacity: Optional[_builtins.int] = ..., gpt_model_name: Optional[_builtins.str] = ..., gpt_model_sku_name: Optional[_builtins.str] = ..., gpt_model_version: Optional[_builtins.str] = ...) -> None:
...
class UserManagedOpenAIProfileResponse(dict):
    ...
    def __init__(__self__, *, embedding_model_deployment_name: _builtins.str, embedding_model_type: _builtins.str, gpt_model_deployment_name: _builtins.str, id: _builtins.str) -> None:
