...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EncryptionPropertiesIdentityResponse', 'EncryptionPropertiesResponse', 'ManagedServiceIdentityResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
...
class EncryptionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, identity: Optional[outputs.EncryptionPropertiesIdentityResponse] = ..., key_url: Optional[_builtins.str] = ...) -> None:
