...
@pulumi.input_type
class MachineArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], agent_upgrade: Optional[pulumi.Input[AgentUpgradeArgs]] = ..., client_public_key: Optional[pulumi.Input[_builtins.str]] = ..., expand: Optional[pulumi.Input[_builtins.str]] = ..., extensions: Optional[pulumi.Input[Sequence[pulumi.Input[MachineExtensionInstanceViewArgs]]]] = ..., identity: Optional[pulumi.Input[IdentityArgs]] = ..., kind: Optional[pulumi.Input[Union[_builtins.str, ArcKindEnum]]] = ..., license_profile: Optional[pulumi.Input[LicenseProfileMachineInstanceViewArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., location_data: Optional[pulumi.Input[LocationDataArgs]] = ..., machine_name: Optional[pulumi.Input[_builtins.str]] = ..., mssql_discovered: Optional[pulumi.Input[_builtins.str]] = ..., os_profile: Optional[pulumi.Input[OSProfileArgs]] = ..., os_type: Optional[pulumi.Input[_builtins.str]] = ..., parent_cluster_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., private_link_scope_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., service_statuses: Optional[pulumi.Input[ServiceStatusesArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., vm_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def agent_upgrade(self, value: Optional[pulumi.Input[AgentUpgradeArgs]]): # -> None:
        ...
    ...
    @expand.setter
    def expand(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @extensions.setter
    def extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MachineExtensionInstanceViewArgs]]]]): # -> None:
        ...
    ...
    @kind.setter
    def kind(self, value: Optional[pulumi.Input[Union[_builtins.str, ArcKindEnum]]]): # -> None:
        ...
    ...
    def license_profile(self, value: Optional[pulumi.Input[LicenseProfileMachineInstanceViewArgs]]): # -> None:
        ...
    ...
    def location_data(self, value: Optional[pulumi.Input[LocationDataArgs]]): # -> None:
        ...
    ...
    def mssql_discovered(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def parent_cluster_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def service_statuses(self, value: Optional[pulumi.Input[ServiceStatusesArgs]]): # -> None:
        ...
    ...
    @vm_id.setter
    def vm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Machine(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., agent_upgrade: Optional[pulumi.Input[Union[AgentUpgradeArgs, AgentUpgradeArgsDict]]] = ..., client_public_key: Optional[pulumi.Input[_builtins.str]] = ..., expand: Optional[pulumi.Input[_builtins.str]] = ..., extensions: Optional[pulumi.Input[Sequence[pulumi.Input[Union[MachineExtensionInstanceViewArgs, MachineExtensionInstanceViewArgsDict]]]]] = ..., identity: Optional[pulumi.Input[Union[IdentityArgs, IdentityArgsDict]]] = ..., kind: Optional[pulumi.Input[Union[_builtins.str, ArcKindEnum]]] = ..., license_profile: Optional[pulumi.Input[Union[LicenseProfileMachineInstanceViewArgs, LicenseProfileMachineInstanceViewArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., location_data: Optional[pulumi.Input[Union[LocationDataArgs, LocationDataArgsDict]]] = ..., machine_name: Optional[pulumi.Input[_builtins.str]] = ..., mssql_discovered: Optional[pulumi.Input[_builtins.str]] = ..., os_profile: Optional[pulumi.Input[Union[OSProfileArgs, OSProfileArgsDict]]] = ..., os_type: Optional[pulumi.Input[_builtins.str]] = ..., parent_cluster_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., private_link_scope_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., service_statuses: Optional[pulumi.Input[Union[ServiceStatusesArgs, ServiceStatusesArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., vm_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: MachineArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Machine:
