...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetMachineRunCommandResult', 'AwaitableGetMachineRunCommandResult', 'get_machine_run_command', 'get_machine_run_command_output']
@pulumi.output_type
class GetMachineRunCommandResult:
    
    def __init__(__self__, async_execution=..., azure_api_version=..., error_blob_managed_identity=..., error_blob_uri=..., id=..., instance_view=..., location=..., name=..., output_blob_managed_identity=..., output_blob_uri=..., parameters=..., protected_parameters=..., provisioning_state=..., run_as_password=..., run_as_user=..., source=..., system_data=..., tags=..., timeout_in_seconds=..., type=...) -> None:
        ...
...
class AwaitableGetMachineRunCommandResult(GetMachineRunCommandResult):
    def __await__(self): # -> Generator[Never, Any, GetMachineRunCommandResult]:
        ...
    


def get_machine_run_command(machine_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., run_command_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetMachineRunCommandResult:
    
    ...

def get_machine_run_command_output(machine_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., run_command_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetMachineRunCommandResult]:
