...
class MachineRunCommandArgs:
    def __init__(__self__, *, machine_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], async_execution: Optional[pulumi.Input[_builtins.bool]] = ..., error_blob_managed_identity: Optional[pulumi.Input[RunCommandManagedIdentityArgs]] = ..., error_blob_uri: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., output_blob_managed_identity: Optional[pulumi.Input[RunCommandManagedIdentityArgs]] = ..., output_blob_uri: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[RunCommandInputParameterArgs]]]] = ..., protected_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[RunCommandInputParameterArgs]]]] = ..., run_as_password: Optional[pulumi.Input[_builtins.str]] = ..., run_as_user: Optional[pulumi.Input[_builtins.str]] = ..., run_command_name: Optional[pulumi.Input[_builtins.str]] = ..., source: Optional[pulumi.Input[MachineRunCommandScriptSourceArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., timeout_in_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @source.setter
    def source(self, value: Optional[pulumi.Input[MachineRunCommandScriptSourceArgs]]): # -> None:
        ...
...
class MachineRunCommand(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., async_execution: Optional[pulumi.Input[_builtins.bool]] = ..., error_blob_managed_identity: Optional[pulumi.Input[Union[RunCommandManagedIdentityArgs, RunCommandManagedIdentityArgsDict]]] = ..., error_blob_uri: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., machine_name: Optional[pulumi.Input[_builtins.str]] = ..., output_blob_managed_identity: Optional[pulumi.Input[Union[RunCommandManagedIdentityArgs, RunCommandManagedIdentityArgsDict]]] = ..., output_blob_uri: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union[RunCommandInputParameterArgs, RunCommandInputParameterArgsDict]]]]] = ..., protected_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union[RunCommandInputParameterArgs, RunCommandInputParameterArgsDict]]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., run_as_password: Optional[pulumi.Input[_builtins.str]] = ..., run_as_user: Optional[pulumi.Input[_builtins.str]] = ..., run_command_name: Optional[pulumi.Input[_builtins.str]] = ..., source: Optional[pulumi.Input[Union[MachineRunCommandScriptSourceArgs, MachineRunCommandScriptSourceArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., timeout_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: MachineRunCommandArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> MachineRunCommand:
