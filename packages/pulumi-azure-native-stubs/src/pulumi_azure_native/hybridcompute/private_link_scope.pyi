...
class PrivateLinkScopeArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[
            pulumi.Input[HybridComputePrivateLinkScopePropertiesArgs]
        ] = ...,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[HybridComputePrivateLinkScopePropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[HybridComputePrivateLinkScopePropertiesArgs]]
    ): ...
    @_builtins.property
...
class PrivateLinkScope(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.HybridComputePrivateLinkScopePropertiesResponse]: ...
    @_builtins.property
