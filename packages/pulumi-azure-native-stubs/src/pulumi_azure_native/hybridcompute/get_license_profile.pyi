...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetLicenseProfileResult', 'AwaitableGetLicenseProfileResult', 'get_license_profile', 'get_license_profile_output']
@pulumi.output_type
class GetLicenseProfileResult:
    
    def __init__(__self__, assigned_license=..., assigned_license_immutable_id=..., azure_api_version=..., billing_end_date=..., billing_start_date=..., disenrollment_date=..., enrollment_date=..., error=..., esu_eligibility=..., esu_key_state=..., esu_keys=..., id=..., location=..., name=..., product_features=..., product_type=..., provisioning_state=..., server_type=..., software_assurance_customer=..., subscription_status=..., system_data=..., tags=..., type=...) -> None:
        ...
...
class AwaitableGetLicenseProfileResult(GetLicenseProfileResult):
    def __await__(self): # -> Generator[Never, Any, GetLicenseProfileResult]:
        ...
    


def get_license_profile(license_profile_name: Optional[_builtins.str] = ..., machine_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetLicenseProfileResult:
    
    ...

def get_license_profile_output(license_profile_name: Optional[pulumi.Input[_builtins.str]] = ..., machine_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetLicenseProfileResult]:
