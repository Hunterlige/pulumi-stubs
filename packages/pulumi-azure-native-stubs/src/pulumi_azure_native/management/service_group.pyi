...
class ServiceGroupArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[ServiceGroupPropertiesArgs]] = ...,
...
class ServiceGroup(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[ServiceGroupPropertiesArgs, ServiceGroupPropertiesArgsDict]
            ]
        ] = ...,
        service_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[ServiceGroupArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
