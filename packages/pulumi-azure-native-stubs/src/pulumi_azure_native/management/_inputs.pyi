...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CreateManagementGroupDetailsArgs', 'CreateManagementGroupDetailsArgsDict', 'CreateParentGroupInfoArgs', 'CreateParentGroupInfoArgsDict', 'ParentServiceGroupPropertiesArgs', 'ParentServiceGroupPropertiesArgsDict', 'ServiceGroupPropertiesArgs', 'ServiceGroupPropertiesArgsDict']
...
class CreateManagementGroupDetailsArgs:
    def __init__(__self__, *, parent: Optional[pulumi.Input[CreateParentGroupInfoArgs]] = ...) -> None:
    ...
    @parent.setter
    def parent(self, value: Optional[pulumi.Input[CreateParentGroupInfoArgs]]): # -> None:
        ...
...
class ServiceGroupPropertiesArgs:
    def __init__(__self__, *, display_name: Optional[pulumi.Input[_builtins.str]] = ..., parent: Optional[pulumi.Input[ParentServiceGroupPropertiesArgs]] = ...) -> None:
    ...
    @parent.setter
    def parent(self, value: Optional[pulumi.Input[ParentServiceGroupPropertiesArgs]]): # -> None:
        ...
