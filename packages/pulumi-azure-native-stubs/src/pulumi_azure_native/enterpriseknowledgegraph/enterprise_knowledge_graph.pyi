...
class EnterpriseKnowledgeGraphArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[
            pulumi.Input[EnterpriseKnowledgeGraphPropertiesArgs]
        ] = ...,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[EnterpriseKnowledgeGraphPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[EnterpriseKnowledgeGraphPropertiesArgs]]
    ): ...
    @_builtins.property
...
class EnterpriseKnowledgeGraph(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.EnterpriseKnowledgeGraphPropertiesResponse]: ...
    @_builtins.property
    @pulumi.getter
