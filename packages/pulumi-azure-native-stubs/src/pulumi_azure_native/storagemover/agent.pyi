...
@pulumi.input_type
class AgentArgs:
    def __init__(__self__, *, arc_resource_id: pulumi.Input[_builtins.str], arc_vm_uuid: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], storage_mover_name: pulumi.Input[_builtins.str], agent_name: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., upload_limit_schedule: Optional[pulumi.Input[UploadLimitScheduleArgs]] = ...) -> None:
    ...
    def arc_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @arc_vm_uuid.setter
    def arc_vm_uuid(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def upload_limit_schedule(self, value: Optional[pulumi.Input[UploadLimitScheduleArgs]]): # -> None:
        ...
...
class Agent(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., agent_name: Optional[pulumi.Input[_builtins.str]] = ..., arc_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., arc_vm_uuid: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_mover_name: Optional[pulumi.Input[_builtins.str]] = ..., upload_limit_schedule: Optional[pulumi.Input[Union[UploadLimitScheduleArgs, UploadLimitScheduleArgsDict]]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Agent:
    ...
    def error_details(self) -> pulumi.Output[outputs.AgentPropertiesErrorDetailsResponse]:
        ...
