...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AgentPropertiesErrorDetailsResponse', 'AzureKeyVaultSmbCredentialsResponse', ..., 'AzureStorageSmbFileShareEndpointPropertiesResponse', 'ConnectionPropertiesResponse', 'NfsMountEndpointPropertiesResponse', 'SmbMountEndpointPropertiesResponse', 'SystemDataResponse', 'TimeResponse', 'UploadLimitScheduleResponse', 'UploadLimitWeeklyRecurrenceResponse']
@pulumi.output_type
...
class AzureKeyVaultSmbCredentialsResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, password_uri: Optional[_builtins.str] = ..., username_uri: Optional[_builtins.str] = ...) -> None:
...
class AzureStorageBlobContainerEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *, blob_container_name: _builtins.str, endpoint_type: _builtins.str, provisioning_state: _builtins.str, storage_account_resource_id: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class AzureStorageSmbFileShareEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *, endpoint_type: _builtins.str, file_share_name: _builtins.str, provisioning_state: _builtins.str, storage_account_resource_id: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class ConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, connection_status: _builtins.str, private_endpoint_name: _builtins.str, private_endpoint_resource_id: _builtins.str, private_link_service_id: _builtins.str, provisioning_state: _builtins.str, description: Optional[_builtins.str] = ..., job_list: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class NfsMountEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *, endpoint_type: _builtins.str, export: _builtins.str, host: _builtins.str, provisioning_state: _builtins.str, description: Optional[_builtins.str] = ..., nfs_version: Optional[_builtins.str] = ...) -> None:
...
class SmbMountEndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *, endpoint_type: _builtins.str, host: _builtins.str, provisioning_state: _builtins.str, share_name: _builtins.str, credentials: Optional[outputs.AzureKeyVaultSmbCredentialsResponse] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class TimeResponse(dict):
    ...
    def __init__(__self__, *, hour: _builtins.int, minute: Optional[_builtins.float] = ...) -> None:
...
class UploadLimitScheduleResponse(dict):
    ...
    def __init__(__self__, *, weekly_recurrences: Optional[Sequence[outputs.UploadLimitWeeklyRecurrenceResponse]] = ...) -> None:
...
class UploadLimitWeeklyRecurrenceResponse(dict):
    ...
    def __init__(__self__, *, days: Sequence[_builtins.str], end_time: outputs.TimeResponse, limit_in_mbps: _builtins.int, start_time: outputs.TimeResponse) -> None:
