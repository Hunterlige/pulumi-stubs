...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DnsSecurityRuleActionArgs', 'DnsSecurityRuleActionArgsDict', 'IpConfigurationArgs', 'IpConfigurationArgsDict', 'SubResourceArgs', 'SubResourceArgsDict', 'TargetDnsServerArgs', 'TargetDnsServerArgsDict']
...
class DnsSecurityRuleActionArgs:
    def __init__(__self__, *, action_type: Optional[pulumi.Input[Union[_builtins.str, ActionType]]] = ..., block_response_code: Optional[pulumi.Input[Union[_builtins.str, BlockResponseCode]]] = ...) -> None:
    ...
    @action_type.setter
    def action_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ActionType]]]): # -> None:
        ...
    ...
    def block_response_code(self, value: Optional[pulumi.Input[Union[_builtins.str, BlockResponseCode]]]): # -> None:
        ...
...
class IpConfigurationArgs:
    def __init__(__self__, *, subnet: pulumi.Input[SubResourceArgs], private_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_allocation_method: Optional[pulumi.Input[Union[_builtins.str, IpAllocationMethod]]] = ...) -> None:
...
class TargetDnsServerArgs:
    def __init__(__self__, *, ip_address: pulumi.Input[_builtins.str], port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
