...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApiKeyResponse', 'DataPlaneProxyPropertiesResponse', 'EncryptionPropertiesResponse', 'KeyVaultPropertiesResponse', 'PrivateEndpointConnectionReferenceResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'ResourceIdentityResponse', 'SkuResponse', 'SystemDataResponse', 'UserIdentityResponse']
@pulumi.output_type
class ApiKeyResponse(dict):
    
    def __init__(__self__, *, connection_string: _builtins.str, id: _builtins.str, last_modified: _builtins.str, name: _builtins.str, read_only: _builtins.bool, value: _builtins.str) -> None:
...
class DataPlaneProxyPropertiesResponse(dict):
    ...
    def __init__(__self__, *, authentication_mode: Optional[_builtins.str] = ..., private_link_delegation: Optional[_builtins.str] = ...) -> None:
...
class EncryptionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, key_vault_properties: Optional[outputs.KeyVaultPropertiesResponse] = ...) -> None:
...
class KeyVaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *, identity_client_id: Optional[_builtins.str] = ..., key_identifier: Optional[_builtins.str] = ...) -> None:
