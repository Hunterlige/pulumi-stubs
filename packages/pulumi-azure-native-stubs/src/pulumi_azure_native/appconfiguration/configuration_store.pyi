...
class ConfigurationStoreArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], sku: pulumi.Input[SkuArgs], config_store_name: Optional[pulumi.Input[_builtins.str]] = ..., create_mode: Optional[pulumi.Input[CreateMode]] = ..., data_plane_proxy: Optional[pulumi.Input[DataPlaneProxyPropertiesArgs]] = ..., disable_local_auth: Optional[pulumi.Input[_builtins.bool]] = ..., enable_purge_protection: Optional[pulumi.Input[_builtins.bool]] = ..., encryption: Optional[pulumi.Input[EncryptionPropertiesArgs]] = ..., identity: Optional[pulumi.Input[ResourceIdentityArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., soft_delete_retention_in_days: Optional[pulumi.Input[_builtins.int]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def config_store_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def data_plane_proxy(self, value: Optional[pulumi.Input[DataPlaneProxyPropertiesArgs]]): # -> None:
        ...
...
class ConfigurationStore(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., config_store_name: Optional[pulumi.Input[_builtins.str]] = ..., create_mode: Optional[pulumi.Input[CreateMode]] = ..., data_plane_proxy: Optional[pulumi.Input[Union[DataPlaneProxyPropertiesArgs, DataPlaneProxyPropertiesArgsDict]]] = ..., disable_local_auth: Optional[pulumi.Input[_builtins.bool]] = ..., enable_purge_protection: Optional[pulumi.Input[_builtins.bool]] = ..., encryption: Optional[pulumi.Input[Union[EncryptionPropertiesArgs, EncryptionPropertiesArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[ResourceIdentityArgs, ResourceIdentityArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[SkuArgs, SkuArgsDict]]] = ..., soft_delete_retention_in_days: Optional[pulumi.Input[_builtins.int]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ConfigurationStoreArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ConfigurationStore:
    ...
    @_builtins.property
    @pulumi.getter(name="softDeleteRetentionInDays")
    def soft_delete_retention_in_days(self) -> pulumi.Output[Optional[_builtins.int]]:
