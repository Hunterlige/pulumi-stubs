...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DataPlaneProxyPropertiesArgs', 'DataPlaneProxyPropertiesArgsDict', 'EncryptionPropertiesArgs', 'EncryptionPropertiesArgsDict', 'KeyVaultPropertiesArgs', 'KeyVaultPropertiesArgsDict', 'PrivateEndpointArgs', 'PrivateEndpointArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'ResourceIdentityArgs', 'ResourceIdentityArgsDict', 'SkuArgs', 'SkuArgsDict']
...
class DataPlaneProxyPropertiesArgs:
    def __init__(__self__, *, authentication_mode: Optional[pulumi.Input[Union[_builtins.str, AuthenticationMode]]] = ..., private_link_delegation: Optional[pulumi.Input[Union[_builtins.str, PrivateLinkDelegation]]] = ...) -> None:
    ...
    def private_link_delegation(self, value: Optional[pulumi.Input[Union[_builtins.str, PrivateLinkDelegation]]]): # -> None:
        ...
...
class EncryptionPropertiesArgs:
    def __init__(__self__, *, key_vault_properties: Optional[pulumi.Input[KeyVaultPropertiesArgs]] = ...) -> None:
...
class KeyVaultPropertiesArgs:
    def __init__(__self__, *, identity_client_id: Optional[pulumi.Input[_builtins.str]] = ..., key_identifier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
