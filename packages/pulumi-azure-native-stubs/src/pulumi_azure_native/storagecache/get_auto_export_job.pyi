...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetAutoExportJobResult', 'AwaitableGetAutoExportJobResult', 'get_auto_export_job', 'get_auto_export_job_output']
@pulumi.output_type
class GetAutoExportJobResult:
    
    def __init__(__self__, admin_status=..., auto_export_prefixes=..., azure_api_version=..., current_iteration_files_discovered=..., current_iteration_files_exported=..., current_iteration_files_failed=..., current_iteration_mi_b_discovered=..., current_iteration_mi_b_exported=..., export_iteration_count=..., id=..., last_completion_time_utc=..., last_started_time_utc=..., last_successful_iteration_completion_time_utc=..., location=..., name=..., provisioning_state=..., state=..., status_code=..., status_message=..., system_data=..., tags=..., total_files_exported=..., total_files_failed=..., total_mi_b_exported=..., type=...) -> None:
        ...
...
class AwaitableGetAutoExportJobResult(GetAutoExportJobResult):
    def __await__(self): # -> Generator[Never, Any, GetAutoExportJobResult]:
        ...
    


def get_auto_export_job(aml_filesystem_name: Optional[_builtins.str] = ..., auto_export_job_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAutoExportJobResult:
    
    ...

def get_auto_export_job_output(aml_filesystem_name: Optional[pulumi.Input[_builtins.str]] = ..., auto_export_job_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAutoExportJobResult]:
