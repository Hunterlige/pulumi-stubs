...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetAmlFilesystemResult', 'AwaitableGetAmlFilesystemResult', 'get_aml_filesystem', 'get_aml_filesystem_output']
@pulumi.output_type
class GetAmlFilesystemResult:
    
    def __init__(__self__, azure_api_version=..., client_info=..., encryption_settings=..., filesystem_subnet=..., health=..., hsm=..., id=..., identity=..., location=..., maintenance_window=..., name=..., provisioning_state=..., root_squash_settings=..., sku=..., storage_capacity_ti_b=..., system_data=..., tags=..., throughput_provisioned_m_bps=..., type=..., zones=...) -> None:
        ...
...
class AwaitableGetAmlFilesystemResult(GetAmlFilesystemResult):
    def __await__(self): # -> Generator[Never, Any, GetAmlFilesystemResult]:
        ...
    


def get_aml_filesystem(aml_filesystem_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAmlFilesystemResult:
    
    ...

def get_aml_filesystem_output(aml_filesystem_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAmlFilesystemResult]:
