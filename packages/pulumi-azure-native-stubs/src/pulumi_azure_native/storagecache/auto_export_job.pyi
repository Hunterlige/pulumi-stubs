...
class AutoExportJobArgs:
    def __init__(__self__, *, aml_filesystem_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], admin_status: Optional[pulumi.Input[Union[_builtins.str, AutoExportJobAdminStatus]]] = ..., auto_export_job_name: Optional[pulumi.Input[_builtins.str]] = ..., auto_export_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, AutoExportStatusType]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @admin_status.setter
    def admin_status(self, value: Optional[pulumi.Input[Union[_builtins.str, AutoExportJobAdminStatus]]]): # -> None:
        ...
    ...
    def auto_export_job_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def auto_export_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[_builtins.str, AutoExportStatusType]]]): # -> None:
        ...
...
class AutoExportJob(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., admin_status: Optional[pulumi.Input[Union[_builtins.str, AutoExportJobAdminStatus]]] = ..., aml_filesystem_name: Optional[pulumi.Input[_builtins.str]] = ..., auto_export_job_name: Optional[pulumi.Input[_builtins.str]] = ..., auto_export_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, AutoExportStatusType]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: AutoExportJobArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> AutoExportJob:
