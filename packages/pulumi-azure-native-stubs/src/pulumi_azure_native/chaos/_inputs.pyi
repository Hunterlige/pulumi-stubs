...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BranchArgs', 'BranchArgsDict', 'ContinuousActionArgs', 'ContinuousActionArgsDict', 'CustomerDataStoragePropertiesArgs', 'CustomerDataStoragePropertiesArgsDict', 'DelayActionArgs', 'DelayActionArgsDict', 'DiscreteActionArgs', 'DiscreteActionArgsDict', 'ExperimentIdentityArgs', 'ExperimentIdentityArgsDict', 'ExperimentPropertiesArgs', 'ExperimentPropertiesArgsDict', 'KeyValuePairArgs', 'KeyValuePairArgsDict', 'ListSelectorArgs', 'ListSelectorArgsDict', 'QuerySelectorArgs', 'QuerySelectorArgsDict', 'SimpleFilterParametersArgs', 'SimpleFilterParametersArgsDict', 'SimpleFilterArgs', 'SimpleFilterArgsDict', 'StepArgs', 'StepArgsDict', 'TargetReferenceArgs', 'TargetReferenceArgsDict']
...
@pulumi.input_type
class BranchArgs:
    def __init__(__self__, *, actions: pulumi.Input[Sequence[pulumi.Input[Union[ContinuousActionArgs, DelayActionArgs, DiscreteActionArgs]]]], name: pulumi.Input[_builtins.str]) -> None:
    ...
    @actions.setter
    def actions(self, value: pulumi.Input[Sequence[pulumi.Input[Union[ContinuousActionArgs, DelayActionArgs, DiscreteActionArgs]]]]): # -> None:
        ...
...
class ContinuousActionArgs:
    def __init__(__self__, *, duration: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], parameters: pulumi.Input[Sequence[pulumi.Input[KeyValuePairArgs]]], selector_id: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str]) -> None:
    ...
    @parameters.setter
    def parameters(self, value: pulumi.Input[Sequence[pulumi.Input[KeyValuePairArgs]]]): # -> None:
        ...
    ...
    @selector_id.setter
    def selector_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class CustomerDataStoragePropertiesArgs:
    def __init__(__self__, *, blob_container_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DelayActionArgs:
    def __init__(__self__, *, duration: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str]) -> None:
...
class DiscreteActionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], parameters: pulumi.Input[Sequence[pulumi.Input[KeyValuePairArgs]]], selector_id: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str]) -> None:
...
class ExperimentPropertiesArgs:
    def __init__(__self__, *, selectors: pulumi.Input[Sequence[pulumi.Input[Union[ListSelectorArgs, QuerySelectorArgs]]]], steps: pulumi.Input[Sequence[pulumi.Input[StepArgs]]], customer_data_storage: Optional[pulumi.Input[CustomerDataStoragePropertiesArgs]] = ...) -> None:
    ...
    @selectors.setter
    def selectors(self, value: pulumi.Input[Sequence[pulumi.Input[Union[ListSelectorArgs, QuerySelectorArgs]]]]): # -> None:
        ...
    ...
    @steps.setter
    def steps(self, value: pulumi.Input[Sequence[pulumi.Input[StepArgs]]]): # -> None:
        ...
    ...
    def customer_data_storage(self, value: Optional[pulumi.Input[CustomerDataStoragePropertiesArgs]]): # -> None:
        ...
...
class ListSelectorArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], targets: pulumi.Input[Sequence[pulumi.Input[TargetReferenceArgs]]], type: pulumi.Input[_builtins.str], filter: Optional[pulumi.Input[SimpleFilterArgs]] = ...) -> None:
    ...
    @targets.setter
    def targets(self, value: pulumi.Input[Sequence[pulumi.Input[TargetReferenceArgs]]]): # -> None:
        ...
    ...
    @filter.setter
    def filter(self, value: Optional[pulumi.Input[SimpleFilterArgs]]): # -> None:
        ...
...
class QuerySelectorArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], query_string: pulumi.Input[_builtins.str], subscription_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], type: pulumi.Input[_builtins.str], filter: Optional[pulumi.Input[SimpleFilterArgs]] = ...) -> None:
    ...
    def subscription_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class SimpleFilterParametersArgs:
    def __init__(__self__, *, zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class SimpleFilterArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], parameters: Optional[pulumi.Input[SimpleFilterParametersArgs]] = ...) -> None:
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[SimpleFilterParametersArgs]]): # -> None:
        ...
...
@pulumi.input_type
class StepArgs:
    def __init__(__self__, *, branches: pulumi.Input[Sequence[pulumi.Input[BranchArgs]]], name: pulumi.Input[_builtins.str]) -> None:
    ...
    @branches.setter
    def branches(self, value: pulumi.Input[Sequence[pulumi.Input[BranchArgs]]]): # -> None:
        ...
...
class TargetReferenceArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], type: pulumi.Input[Union[_builtins.str, TargetReferenceType]]) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, TargetReferenceType]]): # -> None:
        ...
