...
class ExperimentArgs:
    def __init__(
        ...
        *,
        ...
        identity: Optional[pulumi.Input[ExperimentIdentityArgs]] = ...,
...
class Experiment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        experiment_name: Optional[pulumi.Input[_builtins.str]] = ...,
        identity: Optional[
            pulumi.Input[Union[ExperimentIdentityArgs, ExperimentIdentityArgsDict]]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[
            pulumi.Input[Union[ExperimentPropertiesArgs, ExperimentPropertiesArgsDict]]
        ] = ...,
    ...
    def identity(
        self,
    ) -> pulumi.Output[Optional[outputs.ExperimentIdentityResponse]]: ...
    @_builtins.property
    @pulumi.getter
