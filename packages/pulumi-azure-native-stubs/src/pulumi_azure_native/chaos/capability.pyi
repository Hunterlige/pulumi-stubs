...
class CapabilityArgs:
    def __init__(__self__, *, parent_provider_namespace: pulumi.Input[_builtins.str], parent_resource_name: pulumi.Input[_builtins.str], parent_resource_type: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], target_name: pulumi.Input[_builtins.str], capability_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def parent_provider_namespace(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def parent_resource_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class Capability(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., capability_name: Optional[pulumi.Input[_builtins.str]] = ..., parent_provider_namespace: Optional[pulumi.Input[_builtins.str]] = ..., parent_resource_name: Optional[pulumi.Input[_builtins.str]] = ..., parent_resource_type: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Capability:
