...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApprovalSettingsResponse', 'ApproverResponse', 'CommunityEndpointDestinationRuleResponse', 'EnclaveAddressSpacesModelResponse', 'EnclaveDefaultSettingsModelResponse', 'EnclaveEndpointDestinationRuleResponse', 'EnclaveVirtualNetworkModelResponse', 'GovernedServiceItemResponse', 'MaintenanceModeConfigurationModelResponse', 'ManagedOnBehalfOfConfigurationResponse', 'ManagedServiceIdentityResponse', 'MandatoryApproverResponse', 'MoboBrokerResourceResponse', 'PrincipalResponse', 'RequestMetadataResponse', 'RoleAssignmentItemResponse', 'SubnetConfigurationResponse', 'SystemDataResponse', 'TransitOptionParamsResponse', 'TransitOptionResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
class ApprovalSettingsResponse(dict):
    ...
    def __init__(__self__, *, connection_creation: Optional[_builtins.str] = ..., connection_deletion: Optional[_builtins.str] = ..., connection_update: Optional[_builtins.str] = ..., enclave_creation: Optional[_builtins.str] = ..., enclave_deletion: Optional[_builtins.str] = ..., endpoint_creation: Optional[_builtins.str] = ..., endpoint_deletion: Optional[_builtins.str] = ..., endpoint_update: Optional[_builtins.str] = ..., maintenance_mode: Optional[_builtins.str] = ..., mandatory_approvers: Optional[Sequence[outputs.MandatoryApproverResponse]] = ..., minimum_approvers_required: Optional[_builtins.float] = ..., notification_on_approval_action: Optional[_builtins.str] = ..., notification_on_approval_creation: Optional[_builtins.str] = ..., notification_on_approval_deletion: Optional[_builtins.str] = ..., service_catalog_deployment: Optional[_builtins.str] = ...) -> None:
...
class ApproverResponse(dict):
    ...
    def __init__(__self__, *, approver_entra_id: _builtins.str, last_updated_at: _builtins.str, action_performed: Optional[_builtins.str] = ...) -> None:
...
class CommunityEndpointDestinationRuleResponse(dict):
    ...
    def __init__(__self__, *, destination: Optional[_builtins.str] = ..., destination_type: Optional[_builtins.str] = ..., endpoint_rule_name: Optional[_builtins.str] = ..., ports: Optional[_builtins.str] = ..., protocols: Optional[Sequence[_builtins.str]] = ..., transit_hub_resource_id: Optional[_builtins.str] = ...) -> None:
...
class EnclaveAddressSpacesModelResponse(dict):
    ...
    def __init__(__self__, *, enclave_address_space: Optional[_builtins.str] = ..., managed_address_space: Optional[_builtins.str] = ...) -> None:
...
class EnclaveDefaultSettingsModelResponse(dict):
    ...
    def __init__(__self__, *, key_vault_resource_id: _builtins.str, log_analytics_resource_id_collection: Sequence[_builtins.str], storage_account_resource_id: _builtins.str, diagnostic_destination: Optional[_builtins.str] = ...) -> None:
...
class EnclaveEndpointDestinationRuleResponse(dict):
    ...
    def __init__(__self__, *, destination: Optional[_builtins.str] = ..., endpoint_rule_name: Optional[_builtins.str] = ..., ports: Optional[_builtins.str] = ..., protocols: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class EnclaveVirtualNetworkModelResponse(dict):
    ...
    def __init__(__self__, *, allow_subnet_communication: Optional[_builtins.bool] = ..., custom_cidr_range: Optional[_builtins.str] = ..., network_name: Optional[_builtins.str] = ..., network_size: Optional[_builtins.str] = ..., subnet_configurations: Optional[Sequence[outputs.SubnetConfigurationResponse]] = ...) -> None:
...
class GovernedServiceItemResponse(dict):
    ...
    def __init__(__self__, *, initiatives: Sequence[_builtins.str], service_id: _builtins.str, service_name: _builtins.str, enforcement: Optional[_builtins.str] = ..., option: Optional[_builtins.str] = ..., policy_action: Optional[_builtins.str] = ...) -> None:
...
class MaintenanceModeConfigurationModelResponse(dict):
    ...
    def __init__(__self__, *, mode: Optional[_builtins.str] = ..., justification: Optional[_builtins.str] = ..., principals: Optional[Sequence[outputs.PrincipalResponse]] = ...) -> None:
...
class ManagedOnBehalfOfConfigurationResponse(dict):
    ...
    def __init__(__self__, *, mobo_broker_resources: Optional[Sequence[outputs.MoboBrokerResourceResponse]] = ...) -> None:
...
class RequestMetadataResponse(dict):
    ...
    def __init__(__self__, *, resource_action: _builtins.str, approval_callback_payload: Optional[_builtins.str] = ..., approval_callback_route: Optional[_builtins.str] = ..., approval_status: Optional[_builtins.str] = ...) -> None:
...
class RoleAssignmentItemResponse(dict):
    ...
    def __init__(__self__, *, role_definition_id: _builtins.str, principals: Optional[Sequence[outputs.PrincipalResponse]] = ...) -> None:
...
class SubnetConfigurationResponse(dict):
    ...
    def __init__(__self__, *, address_prefix: _builtins.str, network_prefix_size: _builtins.int, network_security_group_resource_id: _builtins.str, subnet_name: _builtins.str, subnet_resource_id: _builtins.str, subnet_delegation: Optional[_builtins.str] = ...) -> None:
...
class TransitOptionParamsResponse(dict):
    ...
    def __init__(__self__, *, remote_virtual_network_id: Optional[_builtins.str] = ..., scale_units: Optional[_builtins.float] = ...) -> None:
...
class TransitOptionResponse(dict):
    ...
    def __init__(__self__, *, params: Optional[outputs.TransitOptionParamsResponse] = ..., type: Optional[_builtins.str] = ...) -> None:
