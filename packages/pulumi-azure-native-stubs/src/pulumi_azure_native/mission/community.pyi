...
@pulumi.input_type
class CommunityArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], address_space: Optional[pulumi.Input[_builtins.str]] = ..., approval_settings: Optional[pulumi.Input[ApprovalSettingsArgs]] = ..., community_name: Optional[pulumi.Input[_builtins.str]] = ..., community_role_assignments: Optional[pulumi.Input[Sequence[pulumi.Input[RoleAssignmentItemArgs]]]] = ..., dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., firewall_sku: Optional[pulumi.Input[Union[_builtins.str, FirewallSKU]]] = ..., governed_service_list: Optional[pulumi.Input[Sequence[pulumi.Input[GovernedServiceItemArgs]]]] = ..., identity: Optional[pulumi.Input[ManagedServiceIdentityArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., maintenance_mode_configuration: Optional[pulumi.Input[MaintenanceModeConfigurationModelArgs]] = ..., policy_override: Optional[pulumi.Input[Union[_builtins.str, PolicyOverride]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def approval_settings(self, value: Optional[pulumi.Input[ApprovalSettingsArgs]]): # -> None:
        ...
    ...
    def community_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def community_role_assignments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RoleAssignmentItemArgs]]]]): # -> None:
        ...
    ...
    def policy_override(self, value: Optional[pulumi.Input[Union[_builtins.str, PolicyOverride]]]): # -> None:
        ...
...
class Community(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., address_space: Optional[pulumi.Input[_builtins.str]] = ..., approval_settings: Optional[pulumi.Input[Union[ApprovalSettingsArgs, ApprovalSettingsArgsDict]]] = ..., community_name: Optional[pulumi.Input[_builtins.str]] = ..., community_role_assignments: Optional[pulumi.Input[Sequence[pulumi.Input[Union[RoleAssignmentItemArgs, RoleAssignmentItemArgsDict]]]]] = ..., dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., firewall_sku: Optional[pulumi.Input[Union[_builtins.str, FirewallSKU]]] = ..., governed_service_list: Optional[pulumi.Input[Sequence[pulumi.Input[Union[GovernedServiceItemArgs, GovernedServiceItemArgsDict]]]]] = ..., identity: Optional[pulumi.Input[Union[ManagedServiceIdentityArgs, ManagedServiceIdentityArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., maintenance_mode_configuration: Optional[pulumi.Input[Union[MaintenanceModeConfigurationModelArgs, MaintenanceModeConfigurationModelArgsDict]]] = ..., policy_override: Optional[pulumi.Input[Union[_builtins.str, PolicyOverride]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: CommunityArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Community:
