...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetVirtualEnclaveResult', 'AwaitableGetVirtualEnclaveResult', 'get_virtual_enclave', 'get_virtual_enclave_output']
@pulumi.output_type
class GetVirtualEnclaveResult:
    
    def __init__(__self__, azure_api_version=..., bastion_enabled=..., community_resource_id=..., enclave_address_spaces=..., enclave_default_settings=..., enclave_role_assignments=..., enclave_virtual_network=..., governed_service_list=..., id=..., identity=..., location=..., maintenance_mode_configuration=..., managed_on_behalf_of_configuration=..., managed_resource_group_name=..., name=..., provisioning_state=..., resource_collection=..., system_data=..., tags=..., type=..., workload_role_assignments=...) -> None:
        ...
...
class AwaitableGetVirtualEnclaveResult(GetVirtualEnclaveResult):
    def __await__(self): # -> Generator[Never, Any, GetVirtualEnclaveResult]:
        ...
    


def get_virtual_enclave(resource_group_name: Optional[_builtins.str] = ..., virtual_enclave_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetVirtualEnclaveResult:
    
    ...

def get_virtual_enclave_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., virtual_enclave_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetVirtualEnclaveResult]:
