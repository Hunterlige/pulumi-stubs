...
@pulumi.input_type
class WorkflowArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], access_control: Optional[pulumi.Input[FlowAccessControlConfigurationArgs]] = ..., definition: Optional[Any] = ..., endpoints_configuration: Optional[pulumi.Input[FlowEndpointsConfigurationArgs]] = ..., identity: Optional[pulumi.Input[ManagedServiceIdentityArgs]] = ..., integration_account: Optional[pulumi.Input[ResourceReferenceArgs]] = ..., integration_service_environment: Optional[pulumi.Input[ResourceReferenceArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[WorkflowParameterArgs]]]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, WorkflowState]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., workflow_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def access_control(self, value: Optional[pulumi.Input[FlowAccessControlConfigurationArgs]]): # -> None:
        ...
    ...
    @definition.setter
    def definition(self, value: Optional[Any]): # -> None:
        ...
    ...
    def integration_account(self, value: Optional[pulumi.Input[ResourceReferenceArgs]]): # -> None:
        ...
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[WorkflowParameterArgs]]]]): # -> None:
        ...
...
class Workflow(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., access_control: Optional[pulumi.Input[Union[FlowAccessControlConfigurationArgs, FlowAccessControlConfigurationArgsDict]]] = ..., definition: Optional[Any] = ..., endpoints_configuration: Optional[pulumi.Input[Union[FlowEndpointsConfigurationArgs, FlowEndpointsConfigurationArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[ManagedServiceIdentityArgs, ManagedServiceIdentityArgsDict]]] = ..., integration_account: Optional[pulumi.Input[Union[ResourceReferenceArgs, ResourceReferenceArgsDict]]] = ..., integration_service_environment: Optional[pulumi.Input[Union[ResourceReferenceArgs, ResourceReferenceArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[WorkflowParameterArgs, WorkflowParameterArgsDict]]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, WorkflowState]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., workflow_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
