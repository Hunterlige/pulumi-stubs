...
class AwaitableListIntegrationAccountPartnerContentCallbackUrlResult(
    ListIntegrationAccountPartnerContentCallbackUrlResult
):
    def __await__(self): ...

def list_integration_account_partner_content_callback_url(
...
) -> pulumi.Output[ListIntegrationAccountPartnerContentCallbackUrlResult]: ...
