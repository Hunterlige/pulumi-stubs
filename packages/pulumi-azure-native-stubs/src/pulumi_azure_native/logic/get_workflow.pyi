...
class GetWorkflowResult:
    ...
    def __init__(__self__, access_control=..., access_endpoint=..., azure_api_version=..., changed_time=..., created_time=..., definition=..., endpoints_configuration=..., id=..., identity=..., integration_account=..., integration_service_environment=..., location=..., name=..., parameters=..., provisioning_state=..., sku=..., state=..., tags=..., type=..., version=...) -> None:
        ...
