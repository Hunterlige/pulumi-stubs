...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AdmCredentialArgs', 'AdmCredentialArgsDict', 'ApnsCredentialArgs', 'ApnsCredentialArgsDict', 'BaiduCredentialArgs', 'BaiduCredentialArgsDict', 'BrowserCredentialArgs', 'BrowserCredentialArgsDict', 'FcmV1CredentialArgs', 'FcmV1CredentialArgsDict', 'GcmCredentialArgs', 'GcmCredentialArgsDict', 'IpRuleArgs', 'IpRuleArgsDict', 'MpnsCredentialArgs', 'MpnsCredentialArgsDict', 'NetworkAclsArgs', 'NetworkAclsArgsDict', 'PnsCredentialsArgs', 'PnsCredentialsArgsDict', 'PrivateEndpointConnectionPropertiesArgs', 'PrivateEndpointConnectionPropertiesArgsDict', 'PublicInternetAuthorizationRuleArgs', 'PublicInternetAuthorizationRuleArgsDict', 'RemotePrivateLinkServiceConnectionStateArgs', 'RemotePrivateLinkServiceConnectionStateArgsDict', 'SkuArgs', 'SkuArgsDict', 'WnsCredentialArgs', 'WnsCredentialArgsDict', 'XiaomiCredentialArgs', 'XiaomiCredentialArgsDict']
...
class AdmCredentialArgs:
    def __init__(__self__, *, auth_token_url: pulumi.Input[_builtins.str], client_id: pulumi.Input[_builtins.str], client_secret: pulumi.Input[_builtins.str]) -> None:
    ...
    def auth_token_url(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ApnsCredentialArgs:
    def __init__(__self__, *, endpoint: pulumi.Input[_builtins.str], apns_certificate: Optional[pulumi.Input[_builtins.str]] = ..., app_id: Optional[pulumi.Input[_builtins.str]] = ..., app_name: Optional[pulumi.Input[_builtins.str]] = ..., certificate_key: Optional[pulumi.Input[_builtins.str]] = ..., key_id: Optional[pulumi.Input[_builtins.str]] = ..., thumbprint: Optional[pulumi.Input[_builtins.str]] = ..., token: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def apns_certificate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def certificate_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BaiduCredentialArgs:
    def __init__(__self__, *, baidu_api_key: pulumi.Input[_builtins.str], baidu_end_point: pulumi.Input[_builtins.str], baidu_secret_key: pulumi.Input[_builtins.str]) -> None:
    ...
    def baidu_api_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def baidu_end_point(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def baidu_secret_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BrowserCredentialArgs:
    def __init__(__self__, *, subject: pulumi.Input[_builtins.str], vapid_private_key: pulumi.Input[_builtins.str], vapid_public_key: pulumi.Input[_builtins.str]) -> None:
    ...
    def vapid_private_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def vapid_public_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class FcmV1CredentialArgs:
    def __init__(__self__, *, client_email: pulumi.Input[_builtins.str], private_key: pulumi.Input[_builtins.str], project_id: pulumi.Input[_builtins.str]) -> None:
    ...
    @client_email.setter
    def client_email(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class GcmCredentialArgs:
    def __init__(__self__, *, google_api_key: pulumi.Input[_builtins.str], gcm_endpoint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def google_api_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @gcm_endpoint.setter
    def gcm_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class IpRuleArgs:
    def __init__(__self__, *, ip_mask: pulumi.Input[_builtins.str], rights: pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AccessRights]]]]) -> None:
    ...
    @rights.setter
    def rights(self, value: pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AccessRights]]]]): # -> None:
        ...
...
class MpnsCredentialArgs:
    def __init__(__self__, *, certificate_key: pulumi.Input[_builtins.str], mpns_certificate: pulumi.Input[_builtins.str], thumbprint: pulumi.Input[_builtins.str]) -> None:
    ...
    @certificate_key.setter
    def certificate_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def mpns_certificate(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class NetworkAclsArgs:
    def __init__(__self__, *, ip_rules: Optional[pulumi.Input[Sequence[pulumi.Input[IpRuleArgs]]]] = ..., public_network_rule: Optional[pulumi.Input[PublicInternetAuthorizationRuleArgs]] = ...) -> None:
    ...
    def public_network_rule(self, value: Optional[pulumi.Input[PublicInternetAuthorizationRuleArgs]]): # -> None:
        ...
...
class PnsCredentialsArgs:
    def __init__(__self__, *, adm_credential: Optional[pulumi.Input[AdmCredentialArgs]] = ..., apns_credential: Optional[pulumi.Input[ApnsCredentialArgs]] = ..., baidu_credential: Optional[pulumi.Input[BaiduCredentialArgs]] = ..., browser_credential: Optional[pulumi.Input[BrowserCredentialArgs]] = ..., fcm_v1_credential: Optional[pulumi.Input[FcmV1CredentialArgs]] = ..., gcm_credential: Optional[pulumi.Input[GcmCredentialArgs]] = ..., mpns_credential: Optional[pulumi.Input[MpnsCredentialArgs]] = ..., wns_credential: Optional[pulumi.Input[WnsCredentialArgs]] = ..., xiaomi_credential: Optional[pulumi.Input[XiaomiCredentialArgs]] = ...) -> None:
    ...
    def adm_credential(self, value: Optional[pulumi.Input[AdmCredentialArgs]]): # -> None:
        ...
    ...
    def apns_credential(self, value: Optional[pulumi.Input[ApnsCredentialArgs]]): # -> None:
        ...
    ...
    def baidu_credential(self, value: Optional[pulumi.Input[BaiduCredentialArgs]]): # -> None:
        ...
    ...
    def browser_credential(self, value: Optional[pulumi.Input[BrowserCredentialArgs]]): # -> None:
        ...
    ...
    def fcm_v1_credential(self, value: Optional[pulumi.Input[FcmV1CredentialArgs]]): # -> None:
        ...
    ...
    def gcm_credential(self, value: Optional[pulumi.Input[GcmCredentialArgs]]): # -> None:
        ...
    ...
    def mpns_credential(self, value: Optional[pulumi.Input[MpnsCredentialArgs]]): # -> None:
        ...
    ...
    def wns_credential(self, value: Optional[pulumi.Input[WnsCredentialArgs]]): # -> None:
        ...
    ...
    def xiaomi_credential(self, value: Optional[pulumi.Input[XiaomiCredentialArgs]]): # -> None:
        ...
...
class PrivateEndpointConnectionPropertiesArgs:
    def __init__(__self__, *, private_link_service_connection_state: Optional[pulumi.Input[RemotePrivateLinkServiceConnectionStateArgs]] = ..., provisioning_state: Optional[pulumi.Input[Union[_builtins.str, PrivateEndpointConnectionProvisioningState]]] = ...) -> None:
    ...
    def private_link_service_connection_state(self, value: Optional[pulumi.Input[RemotePrivateLinkServiceConnectionStateArgs]]): # -> None:
        ...
    ...
    def provisioning_state(self, value: Optional[pulumi.Input[Union[_builtins.str, PrivateEndpointConnectionProvisioningState]]]): # -> None:
        ...
...
class PublicInternetAuthorizationRuleArgs:
    def __init__(__self__, *, rights: pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AccessRights]]]]) -> None:
...
class RemotePrivateLinkServiceConnectionStateArgs:
    def __init__(__self__, *, status: Optional[pulumi.Input[Union[_builtins.str, PrivateLinkConnectionStatus]]] = ...) -> None:
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[_builtins.str, PrivateLinkConnectionStatus]]]): # -> None:
        ...
...
@pulumi.input_type
class SkuArgs:
    def __init__(__self__, *, name: pulumi.Input[Union[_builtins.str, SkuName]], capacity: Optional[pulumi.Input[_builtins.int]] = ..., family: Optional[pulumi.Input[_builtins.str]] = ..., size: Optional[pulumi.Input[_builtins.str]] = ..., tier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WnsCredentialArgs:
    def __init__(__self__, *, certificate_key: Optional[pulumi.Input[_builtins.str]] = ..., package_sid: Optional[pulumi.Input[_builtins.str]] = ..., secret_key: Optional[pulumi.Input[_builtins.str]] = ..., windows_live_endpoint: Optional[pulumi.Input[_builtins.str]] = ..., wns_certificate: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @package_sid.setter
    def package_sid(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def windows_live_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def wns_certificate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class XiaomiCredentialArgs:
    def __init__(__self__, *, app_secret: Optional[pulumi.Input[_builtins.str]] = ..., endpoint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
