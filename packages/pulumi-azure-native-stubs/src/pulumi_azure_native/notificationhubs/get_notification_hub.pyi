...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetNotificationHubResult', 'AwaitableGetNotificationHubResult', 'get_notification_hub', 'get_notification_hub_output']
@pulumi.output_type
class GetNotificationHubResult:
    
    def __init__(__self__, adm_credential=..., apns_credential=..., authorization_rules=..., azure_api_version=..., baidu_credential=..., browser_credential=..., daily_max_active_devices=..., fcm_v1_credential=..., gcm_credential=..., id=..., location=..., mpns_credential=..., name=..., registration_ttl=..., sku=..., system_data=..., tags=..., type=..., wns_credential=..., xiaomi_credential=...) -> None:
        ...
...
class AwaitableGetNotificationHubResult(GetNotificationHubResult):
    def __await__(self): # -> Generator[Never, Any, GetNotificationHubResult]:
        ...
    


def get_notification_hub(namespace_name: Optional[_builtins.str] = ..., notification_hub_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetNotificationHubResult:
    
    ...

def get_notification_hub_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., notification_hub_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetNotificationHubResult]:
