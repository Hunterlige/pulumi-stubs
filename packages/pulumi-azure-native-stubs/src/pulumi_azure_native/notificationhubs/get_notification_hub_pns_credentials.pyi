...
class AwaitableGetNotificationHubPnsCredentialsResult(
    GetNotificationHubPnsCredentialsResult
):
    def __await__(self): ...

def get_notification_hub_pns_credentials(
    namespace_name: Optional[_builtins.str] = ...,
    notification_hub_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetNotificationHubPnsCredentialsResult: ...
def get_notification_hub_pns_credentials_output(
...
) -> pulumi.Output[GetNotificationHubPnsCredentialsResult]: ...
