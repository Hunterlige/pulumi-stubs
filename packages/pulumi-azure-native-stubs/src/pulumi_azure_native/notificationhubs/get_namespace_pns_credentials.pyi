...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetNamespacePnsCredentialsResult', 'AwaitableGetNamespacePnsCredentialsResult', 'get_namespace_pns_credentials', 'get_namespace_pns_credentials_output']
@pulumi.output_type
...
class AwaitableGetNamespacePnsCredentialsResult(GetNamespacePnsCredentialsResult):
    def __await__(self): # -> Generator[Never, Any, GetNamespacePnsCredentialsResult]:
        ...
    


def get_namespace_pns_credentials(namespace_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetNamespacePnsCredentialsResult:
    
    ...

def get_namespace_pns_credentials_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetNamespacePnsCredentialsResult]:
