...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'ServiceAccessPolicyEntryResponse', 'ServiceAuthenticationConfigurationInfoResponse', 'ServiceCorsConfigurationInfoResponse', 'ServiceCosmosDbConfigurationInfoResponse', 'ServiceExportConfigurationInfoResponse', 'ServicesPropertiesResponse', 'ServicesResourceResponseIdentity', 'SystemDataResponse']
@pulumi.output_type
...
class ServiceCorsConfigurationInfoResponse(dict):
    ...
    def __init__(__self__, *, allow_credentials: Optional[_builtins.bool] = ..., headers: Optional[Sequence[_builtins.str]] = ..., max_age: Optional[_builtins.float] = ..., methods: Optional[Sequence[_builtins.str]] = ..., origins: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServiceCosmosDbConfigurationInfoResponse(dict):
    ...
    def __init__(__self__, *, key_vault_key_uri: Optional[_builtins.str] = ..., offer_throughput: Optional[_builtins.float] = ...) -> None:
...
class ServicesPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, access_policies: Optional[Sequence[outputs.ServiceAccessPolicyEntryResponse]] = ..., authentication_configuration: Optional[outputs.ServiceAuthenticationConfigurationInfoResponse] = ..., cors_configuration: Optional[outputs.ServiceCorsConfigurationInfoResponse] = ..., cosmos_db_configuration: Optional[outputs.ServiceCosmosDbConfigurationInfoResponse] = ..., export_configuration: Optional[outputs.ServiceExportConfigurationInfoResponse] = ..., private_endpoint_connections: Optional[Sequence[outputs.PrivateEndpointConnectionResponse]] = ..., public_network_access: Optional[_builtins.str] = ...) -> None:
