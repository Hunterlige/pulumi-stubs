...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetFileShareResult', 'AwaitableGetFileShareResult', 'get_file_share', 'get_file_share_output']
@pulumi.output_type
class GetFileShareResult:
    
    def __init__(__self__, access_tier=..., access_tier_change_time=..., access_tier_status=..., azure_api_version=..., deleted=..., deleted_time=..., enabled_protocols=..., etag=..., file_share_paid_bursting=..., id=..., included_burst_iops=..., last_modified_time=..., lease_duration=..., lease_state=..., lease_status=..., max_burst_credits_for_iops=..., metadata=..., name=..., next_allowed_provisioned_bandwidth_downgrade_time=..., next_allowed_provisioned_iops_downgrade_time=..., next_allowed_quota_downgrade_time=..., provisioned_bandwidth_mibps=..., provisioned_iops=..., remaining_retention_days=..., root_squash=..., share_quota=..., share_usage_bytes=..., signed_identifiers=..., snapshot_time=..., type=..., version=...) -> None:
        ...
...
class AwaitableGetFileShareResult(GetFileShareResult):
    def __await__(self): # -> Generator[Never, Any, GetFileShareResult]:
        ...
    


def get_file_share(account_name: Optional[_builtins.str] = ..., expand: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., share_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetFileShareResult:
    
    ...

def get_file_share_output(account_name: Optional[pulumi.Input[_builtins.str]] = ..., expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., share_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetFileShareResult]:
