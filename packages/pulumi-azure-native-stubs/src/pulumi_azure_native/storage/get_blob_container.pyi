...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetBlobContainerResult', 'AwaitableGetBlobContainerResult', 'get_blob_container', 'get_blob_container_output']
@pulumi.output_type
class GetBlobContainerResult:
    
    def __init__(__self__, azure_api_version=..., default_encryption_scope=..., deleted=..., deleted_time=..., deny_encryption_scope_override=..., enable_nfs_v3_all_squash=..., enable_nfs_v3_root_squash=..., etag=..., has_immutability_policy=..., has_legal_hold=..., id=..., immutability_policy=..., immutable_storage_with_versioning=..., last_modified_time=..., lease_duration=..., lease_state=..., lease_status=..., legal_hold=..., metadata=..., name=..., public_access=..., remaining_retention_days=..., type=..., version=...) -> None:
        ...
...
class AwaitableGetBlobContainerResult(GetBlobContainerResult):
    def __await__(self): # -> Generator[Never, Any, GetBlobContainerResult]:
        ...
    


def get_blob_container(account_name: Optional[_builtins.str] = ..., container_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetBlobContainerResult:
    
    ...

def get_blob_container_output(account_name: Optional[pulumi.Input[_builtins.str]] = ..., container_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetBlobContainerResult]:
