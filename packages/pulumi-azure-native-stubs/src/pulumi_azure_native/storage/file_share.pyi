...
@pulumi.input_type
class FileShareArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], access_tier: Optional[pulumi.Input[Union[_builtins.str, ShareAccessTier]]] = ..., enabled_protocols: Optional[pulumi.Input[Union[_builtins.str, EnabledProtocols]]] = ..., expand: Optional[pulumi.Input[_builtins.str]] = ..., file_share_paid_bursting: Optional[pulumi.Input[FileSharePropertiesFileSharePaidBurstingArgs]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., provisioned_bandwidth_mibps: Optional[pulumi.Input[_builtins.int]] = ..., provisioned_iops: Optional[pulumi.Input[_builtins.int]] = ..., root_squash: Optional[pulumi.Input[Union[_builtins.str, RootSquashType]]] = ..., share_name: Optional[pulumi.Input[_builtins.str]] = ..., share_quota: Optional[pulumi.Input[_builtins.int]] = ..., signed_identifiers: Optional[pulumi.Input[Sequence[pulumi.Input[SignedIdentifierArgs]]]] = ...) -> None:
    ...
    @access_tier.setter
    def access_tier(self, value: Optional[pulumi.Input[Union[_builtins.str, ShareAccessTier]]]): # -> None:
        ...
    ...
    def enabled_protocols(self, value: Optional[pulumi.Input[Union[_builtins.str, EnabledProtocols]]]): # -> None:
        ...
    ...
    def file_share_paid_bursting(self, value: Optional[pulumi.Input[FileSharePropertiesFileSharePaidBurstingArgs]]): # -> None:
        ...
    ...
    def provisioned_bandwidth_mibps(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @root_squash.setter
    def root_squash(self, value: Optional[pulumi.Input[Union[_builtins.str, RootSquashType]]]): # -> None:
        ...
    ...
    @share_quota.setter
    def share_quota(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def signed_identifiers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SignedIdentifierArgs]]]]): # -> None:
        ...
...
class FileShare(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., access_tier: Optional[pulumi.Input[Union[_builtins.str, ShareAccessTier]]] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., enabled_protocols: Optional[pulumi.Input[Union[_builtins.str, EnabledProtocols]]] = ..., expand: Optional[pulumi.Input[_builtins.str]] = ..., file_share_paid_bursting: Optional[pulumi.Input[Union[FileSharePropertiesFileSharePaidBurstingArgs, FileSharePropertiesFileSharePaidBurstingArgsDict]]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., provisioned_bandwidth_mibps: Optional[pulumi.Input[_builtins.int]] = ..., provisioned_iops: Optional[pulumi.Input[_builtins.int]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., root_squash: Optional[pulumi.Input[Union[_builtins.str, RootSquashType]]] = ..., share_name: Optional[pulumi.Input[_builtins.str]] = ..., share_quota: Optional[pulumi.Input[_builtins.int]] = ..., signed_identifiers: Optional[pulumi.Input[Sequence[pulumi.Input[Union[SignedIdentifierArgs, SignedIdentifierArgsDict]]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: FileShareArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> FileShare:
    ...
    def next_allowed_provisioned_bandwidth_downgrade_time(self) -> pulumi.Output[_builtins.str]:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="nextAllowedProvisionedIopsDowngradeTime")
    def next_allowed_provisioned_iops_downgrade_time(self) -> pulumi.Output[_builtins.str]:
