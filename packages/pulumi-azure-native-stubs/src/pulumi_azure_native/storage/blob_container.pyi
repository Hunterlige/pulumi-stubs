...
class BlobContainerArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], container_name: Optional[pulumi.Input[_builtins.str]] = ..., default_encryption_scope: Optional[pulumi.Input[_builtins.str]] = ..., deny_encryption_scope_override: Optional[pulumi.Input[_builtins.bool]] = ..., enable_nfs_v3_all_squash: Optional[pulumi.Input[_builtins.bool]] = ..., enable_nfs_v3_root_squash: Optional[pulumi.Input[_builtins.bool]] = ..., immutable_storage_with_versioning: Optional[pulumi.Input[ImmutableStorageWithVersioningArgs]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., public_access: Optional[pulumi.Input[PublicAccess]] = ...) -> None:
    ...
    def default_encryption_scope(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def deny_encryption_scope_override(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_nfs_v3_all_squash(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_nfs_v3_root_squash(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def immutable_storage_with_versioning(self, value: Optional[pulumi.Input[ImmutableStorageWithVersioningArgs]]): # -> None:
        ...
    ...
    def public_access(self, value: Optional[pulumi.Input[PublicAccess]]): # -> None:
        ...
...
class BlobContainer(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., container_name: Optional[pulumi.Input[_builtins.str]] = ..., default_encryption_scope: Optional[pulumi.Input[_builtins.str]] = ..., deny_encryption_scope_override: Optional[pulumi.Input[_builtins.bool]] = ..., enable_nfs_v3_all_squash: Optional[pulumi.Input[_builtins.bool]] = ..., enable_nfs_v3_root_squash: Optional[pulumi.Input[_builtins.bool]] = ..., immutable_storage_with_versioning: Optional[pulumi.Input[Union[ImmutableStorageWithVersioningArgs, ImmutableStorageWithVersioningArgsDict]]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., public_access: Optional[pulumi.Input[PublicAccess]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: BlobContainerArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> BlobContainer:
