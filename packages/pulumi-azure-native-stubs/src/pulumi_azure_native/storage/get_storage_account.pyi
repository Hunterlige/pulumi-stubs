...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetStorageAccountResult', 'AwaitableGetStorageAccountResult', 'get_storage_account', 'get_storage_account_output']
@pulumi.output_type
class GetStorageAccountResult:
    
    def __init__(__self__, access_tier=..., account_migration_in_progress=..., allow_blob_public_access=..., allow_cross_tenant_replication=..., allow_shared_key_access=..., allowed_copy_scope=..., azure_api_version=..., azure_files_identity_based_authentication=..., blob_restore_status=..., creation_time=..., custom_domain=..., default_to_o_auth_authentication=..., dns_endpoint_type=..., enable_extended_groups=..., enable_https_traffic_only=..., enable_nfs_v3=..., encryption=..., extended_location=..., failover_in_progress=..., geo_replication_stats=..., id=..., identity=..., immutable_storage_with_versioning=..., is_hns_enabled=..., is_local_user_enabled=..., is_sftp_enabled=..., is_sku_conversion_blocked=..., key_creation_time=..., key_policy=..., kind=..., large_file_shares_state=..., last_geo_failover_time=..., location=..., minimum_tls_version=..., name=..., network_rule_set=..., primary_endpoints=..., primary_location=..., private_endpoint_connections=..., provisioning_state=..., public_network_access=..., routing_preference=..., sas_policy=..., secondary_endpoints=..., secondary_location=..., sku=..., status_of_primary=..., status_of_secondary=..., storage_account_sku_conversion_status=..., tags=..., type=...) -> None:
        ...
...
class AwaitableGetStorageAccountResult(GetStorageAccountResult):
    def __await__(self): # -> Generator[Never, Any, GetStorageAccountResult]:
        ...
    


def get_storage_account(account_name: Optional[_builtins.str] = ..., expand: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetStorageAccountResult:
    
    ...

def get_storage_account_output(account_name: Optional[pulumi.Input[_builtins.str]] = ..., expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetStorageAccountResult]:
