...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessPolicyArgs', 'AccessPolicyArgsDict', 'AccountImmutabilityPolicyPropertiesArgs', 'AccountImmutabilityPolicyPropertiesArgsDict', 'ActiveDirectoryPropertiesArgs', 'ActiveDirectoryPropertiesArgsDict', 'AzureFilesIdentityBasedAuthenticationArgs', 'AzureFilesIdentityBasedAuthenticationArgsDict', 'BlobInventoryCreationTimeArgs', 'BlobInventoryCreationTimeArgsDict', 'BlobInventoryPolicyDefinitionArgs', 'BlobInventoryPolicyDefinitionArgsDict', 'BlobInventoryPolicyFilterArgs', 'BlobInventoryPolicyFilterArgsDict', 'BlobInventoryPolicyRuleArgs', 'BlobInventoryPolicyRuleArgsDict', 'BlobInventoryPolicySchemaArgs', 'BlobInventoryPolicySchemaArgsDict', 'ChangeFeedArgs', 'ChangeFeedArgsDict', 'CorsRulesArgs', 'CorsRulesArgsDict', 'CorsRuleArgs', 'CorsRuleArgsDict', 'CustomDomainArgs', 'CustomDomainArgsDict', 'DateAfterCreationArgs', 'DateAfterCreationArgsDict', 'DateAfterModificationArgs', 'DateAfterModificationArgsDict', 'DeleteRetentionPolicyArgs', 'DeleteRetentionPolicyArgsDict', 'EncryptionIdentityArgs', 'EncryptionIdentityArgsDict', 'EncryptionScopeKeyVaultPropertiesArgs', 'EncryptionScopeKeyVaultPropertiesArgsDict', 'EncryptionServicesArgs', 'EncryptionServicesArgsDict', 'EncryptionServiceArgs', 'EncryptionServiceArgsDict', 'EncryptionArgs', 'EncryptionArgsDict', 'ExecutionTargetArgs', 'ExecutionTargetArgsDict', 'ExecutionTriggerArgs', 'ExecutionTriggerArgsDict', 'ExtendedLocationArgs', 'ExtendedLocationArgsDict', 'FileSharePropertiesFileSharePaidBurstingArgs', 'FileSharePropertiesFileSharePaidBurstingArgsDict', 'IPRuleArgs', 'IPRuleArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'ImmutableStorageAccountArgs', 'ImmutableStorageAccountArgsDict', 'ImmutableStorageWithVersioningArgs', 'ImmutableStorageWithVersioningArgsDict', 'KeyPolicyArgs', 'KeyPolicyArgsDict', 'KeyVaultPropertiesArgs', 'KeyVaultPropertiesArgsDict', 'LastAccessTimeTrackingPolicyArgs', 'LastAccessTimeTrackingPolicyArgsDict', 'ManagementPolicyActionArgs', 'ManagementPolicyActionArgsDict', 'ManagementPolicyBaseBlobArgs', 'ManagementPolicyBaseBlobArgsDict', 'ManagementPolicyDefinitionArgs', 'ManagementPolicyDefinitionArgsDict', 'ManagementPolicyFilterArgs', 'ManagementPolicyFilterArgsDict', 'ManagementPolicyRuleArgs', 'ManagementPolicyRuleArgsDict', 'ManagementPolicySchemaArgs', 'ManagementPolicySchemaArgsDict', 'ManagementPolicySnapShotArgs', 'ManagementPolicySnapShotArgsDict', 'ManagementPolicyVersionArgs', 'ManagementPolicyVersionArgsDict', 'MultichannelArgs', 'MultichannelArgsDict', 'NetworkRuleSetArgs', 'NetworkRuleSetArgsDict', 'ObjectReplicationPolicyFilterArgs', 'ObjectReplicationPolicyFilterArgsDict', 'ObjectReplicationPolicyPropertiesMetricsArgs', 'ObjectReplicationPolicyPropertiesMetricsArgsDict', 'ObjectReplicationPolicyRuleArgs', 'ObjectReplicationPolicyRuleArgsDict', 'PermissionScopeArgs', 'PermissionScopeArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'ProtocolSettingsArgs', 'ProtocolSettingsArgsDict', 'ResourceAccessRuleArgs', 'ResourceAccessRuleArgsDict', 'RestorePolicyPropertiesArgs', 'RestorePolicyPropertiesArgsDict', 'RoutingPreferenceArgs', 'RoutingPreferenceArgsDict', 'SasPolicyArgs', 'SasPolicyArgsDict', 'SignedIdentifierArgs', 'SignedIdentifierArgsDict', 'SkuArgs', 'SkuArgsDict', 'SmbSettingArgs', 'SmbSettingArgsDict', 'SshPublicKeyArgs', 'SshPublicKeyArgsDict', 'StorageTaskAssignmentExecutionContextArgs', 'StorageTaskAssignmentExecutionContextArgsDict', 'StorageTaskAssignmentPropertiesArgs', 'StorageTaskAssignmentPropertiesArgsDict', 'StorageTaskAssignmentReportArgs', 'StorageTaskAssignmentReportArgsDict', 'TableAccessPolicyArgs', 'TableAccessPolicyArgsDict', 'TableSignedIdentifierArgs', 'TableSignedIdentifierArgsDict', 'TagFilterArgs', 'TagFilterArgsDict', 'TriggerParametersArgs', 'TriggerParametersArgsDict', 'VirtualNetworkRuleArgs', 'VirtualNetworkRuleArgsDict']
...
class AccessPolicyArgs:
    def __init__(__self__, *, expiry_time: Optional[pulumi.Input[_builtins.str]] = ..., permission: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AccountImmutabilityPolicyPropertiesArgs:
    def __init__(__self__, *, allow_protected_append_writes: Optional[pulumi.Input[_builtins.bool]] = ..., immutability_period_since_creation_in_days: Optional[pulumi.Input[_builtins.int]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, AccountImmutabilityPolicyState]]] = ...) -> None:
    ...
    @_builtins.property
    @pulumi.getter
    def state(self) -> Optional[pulumi.Input[Union[_builtins.str, AccountImmutabilityPolicyState]]]:
        
        ...
    
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[_builtins.str, AccountImmutabilityPolicyState]]]): # -> None:
        ...
...
class ActiveDirectoryPropertiesArgs:
    def __init__(__self__, *, domain_guid: pulumi.Input[_builtins.str], domain_name: pulumi.Input[_builtins.str], account_type: Optional[pulumi.Input[Union[_builtins.str, AccountType]]] = ..., azure_storage_sid: Optional[pulumi.Input[_builtins.str]] = ..., domain_sid: Optional[pulumi.Input[_builtins.str]] = ..., forest_name: Optional[pulumi.Input[_builtins.str]] = ..., net_bios_domain_name: Optional[pulumi.Input[_builtins.str]] = ..., sam_account_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @domain_guid.setter
    def domain_guid(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def account_type(self) -> Optional[pulumi.Input[Union[_builtins.str, AccountType]]]:
        
        ...
    
    @account_type.setter
    def account_type(self, value: Optional[pulumi.Input[Union[_builtins.str, AccountType]]]): # -> None:
        ...
    ...
    def azure_storage_sid(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @domain_sid.setter
    def domain_sid(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @forest_name.setter
    def forest_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def net_bios_domain_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def sam_account_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AzureFilesIdentityBasedAuthenticationArgs:
    def __init__(__self__, *, directory_service_options: pulumi.Input[Union[_builtins.str, DirectoryServiceOptions]], active_directory_properties: Optional[pulumi.Input[ActiveDirectoryPropertiesArgs]] = ..., default_share_permission: Optional[pulumi.Input[Union[_builtins.str, DefaultSharePermission]]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="directoryServiceOptions")
    def directory_service_options(self) -> pulumi.Input[Union[_builtins.str, DirectoryServiceOptions]]:
        
        ...
    
    @directory_service_options.setter
    def directory_service_options(self, value: pulumi.Input[Union[_builtins.str, DirectoryServiceOptions]]): # -> None:
        ...
    ...
    def active_directory_properties(self, value: Optional[pulumi.Input[ActiveDirectoryPropertiesArgs]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="defaultSharePermission")
    def default_share_permission(self) -> Optional[pulumi.Input[Union[_builtins.str, DefaultSharePermission]]]:
        
        ...
    
    @default_share_permission.setter
    def default_share_permission(self, value: Optional[pulumi.Input[Union[_builtins.str, DefaultSharePermission]]]): # -> None:
        ...
...
class BlobInventoryCreationTimeArgs:
    def __init__(__self__, *, last_n_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @last_n_days.setter
    def last_n_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class BlobInventoryPolicyDefinitionArgs:
    def __init__(__self__, *, format: pulumi.Input[Union[_builtins.str, Format]], object_type: pulumi.Input[Union[_builtins.str, ObjectType]], schedule: pulumi.Input[Union[_builtins.str, Schedule]], schema_fields: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], filters: Optional[pulumi.Input[BlobInventoryPolicyFilterArgs]] = ...) -> None:
    ...
    @object_type.setter
    def object_type(self, value: pulumi.Input[Union[_builtins.str, ObjectType]]): # -> None:
        ...
    ...
    @schedule.setter
    def schedule(self, value: pulumi.Input[Union[_builtins.str, Schedule]]): # -> None:
        ...
    ...
    def schema_fields(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @filters.setter
    def filters(self, value: Optional[pulumi.Input[BlobInventoryPolicyFilterArgs]]): # -> None:
        ...
...
class BlobInventoryPolicyFilterArgs:
    def __init__(__self__, *, blob_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., creation_time: Optional[pulumi.Input[BlobInventoryCreationTimeArgs]] = ..., exclude_prefix: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., include_blob_versions: Optional[pulumi.Input[_builtins.bool]] = ..., include_deleted: Optional[pulumi.Input[_builtins.bool]] = ..., include_snapshots: Optional[pulumi.Input[_builtins.bool]] = ..., prefix_match: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="blobTypes")
    def blob_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @blob_types.setter
    def blob_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def creation_time(self, value: Optional[pulumi.Input[BlobInventoryCreationTimeArgs]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="excludePrefix")
    def exclude_prefix(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @exclude_prefix.setter
    def exclude_prefix(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def include_blob_versions(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def include_deleted(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def include_snapshots(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="prefixMatch")
    def prefix_match(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @prefix_match.setter
    def prefix_match(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class BlobInventoryPolicyRuleArgs:
    def __init__(__self__, *, definition: pulumi.Input[BlobInventoryPolicyDefinitionArgs], destination: pulumi.Input[_builtins.str], enabled: pulumi.Input[_builtins.bool], name: pulumi.Input[_builtins.str]) -> None:
    ...
    @definition.setter
    def definition(self, value: pulumi.Input[BlobInventoryPolicyDefinitionArgs]): # -> None:
        ...
...
class BlobInventoryPolicySchemaArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], rules: pulumi.Input[Sequence[pulumi.Input[BlobInventoryPolicyRuleArgs]]], type: pulumi.Input[Union[_builtins.str, InventoryRuleType]]) -> None:
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Sequence[pulumi.Input[BlobInventoryPolicyRuleArgs]]]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, InventoryRuleType]]): # -> None:
        ...
...
class ChangeFeedArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., retention_in_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
@pulumi.input_type
class CorsRuleArgs:
    def __init__(__self__, *, allowed_headers: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], allowed_methods: pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AllowedMethods]]]], allowed_origins: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], exposed_headers: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], max_age_in_seconds: pulumi.Input[_builtins.int]) -> None:
    ...
    def allowed_methods(self) -> pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AllowedMethods]]]]:
        
        ...
    
    @allowed_methods.setter
    def allowed_methods(self, value: pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AllowedMethods]]]]): # -> None:
        ...
    ...
    def exposed_headers(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def max_age_in_seconds(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class CustomDomainArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], use_sub_domain_name: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def use_sub_domain_name(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DateAfterCreationArgs:
    def __init__(__self__, *, days_after_creation_greater_than: pulumi.Input[_builtins.float], days_after_last_tier_change_greater_than: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def days_after_creation_greater_than(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="daysAfterLastTierChangeGreaterThan")
    def days_after_last_tier_change_greater_than(self) -> Optional[pulumi.Input[_builtins.float]]:
        
        ...
    
    @days_after_last_tier_change_greater_than.setter
    def days_after_last_tier_change_greater_than(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class DateAfterModificationArgs:
    def __init__(__self__, *, days_after_creation_greater_than: Optional[pulumi.Input[_builtins.float]] = ..., days_after_last_access_time_greater_than: Optional[pulumi.Input[_builtins.float]] = ..., days_after_last_tier_change_greater_than: Optional[pulumi.Input[_builtins.float]] = ..., days_after_modification_greater_than: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="daysAfterCreationGreaterThan")
    def days_after_creation_greater_than(self) -> Optional[pulumi.Input[_builtins.float]]:
        
        ...
    
    @days_after_creation_greater_than.setter
    def days_after_creation_greater_than(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="daysAfterLastAccessTimeGreaterThan")
    def days_after_last_access_time_greater_than(self) -> Optional[pulumi.Input[_builtins.float]]:
        
        ...
    
    @days_after_last_access_time_greater_than.setter
    def days_after_last_access_time_greater_than(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def days_after_modification_greater_than(self) -> Optional[pulumi.Input[_builtins.float]]:
        
        ...
    
    @days_after_modification_greater_than.setter
    def days_after_modification_greater_than(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class DeleteRetentionPolicyArgs:
    def __init__(__self__, *, allow_permanent_delete: Optional[pulumi.Input[_builtins.bool]] = ..., days: Optional[pulumi.Input[_builtins.int]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def allow_permanent_delete(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class EncryptionIdentityArgs:
    def __init__(__self__, *, encryption_federated_identity_client_id: Optional[pulumi.Input[_builtins.str]] = ..., encryption_user_assigned_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="encryptionFederatedIdentityClientId")
    def encryption_federated_identity_client_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @encryption_federated_identity_client_id.setter
    def encryption_federated_identity_client_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="encryptionUserAssignedIdentity")
    def encryption_user_assigned_identity(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @encryption_user_assigned_identity.setter
    def encryption_user_assigned_identity(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EncryptionServicesArgs:
    def __init__(__self__, *, blob: Optional[pulumi.Input[EncryptionServiceArgs]] = ..., file: Optional[pulumi.Input[EncryptionServiceArgs]] = ..., queue: Optional[pulumi.Input[EncryptionServiceArgs]] = ..., table: Optional[pulumi.Input[EncryptionServiceArgs]] = ...) -> None:
    ...
    @blob.setter
    def blob(self, value: Optional[pulumi.Input[EncryptionServiceArgs]]): # -> None:
        ...
    ...
    @file.setter
    def file(self, value: Optional[pulumi.Input[EncryptionServiceArgs]]): # -> None:
        ...
    ...
    @queue.setter
    def queue(self, value: Optional[pulumi.Input[EncryptionServiceArgs]]): # -> None:
        ...
    ...
    @table.setter
    def table(self, value: Optional[pulumi.Input[EncryptionServiceArgs]]): # -> None:
        ...
...
class EncryptionServiceArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., key_type: Optional[pulumi.Input[Union[_builtins.str, KeyType]]] = ...) -> None:
    ...
    @key_type.setter
    def key_type(self, value: Optional[pulumi.Input[Union[_builtins.str, KeyType]]]): # -> None:
        ...
...
class EncryptionArgs:
    def __init__(__self__, *, encryption_identity: Optional[pulumi.Input[EncryptionIdentityArgs]] = ..., key_source: Optional[pulumi.Input[Union[_builtins.str, KeySource]]] = ..., key_vault_properties: Optional[pulumi.Input[KeyVaultPropertiesArgs]] = ..., require_infrastructure_encryption: Optional[pulumi.Input[_builtins.bool]] = ..., services: Optional[pulumi.Input[EncryptionServicesArgs]] = ...) -> None:
    ...
    @services.setter
    def services(self, value: Optional[pulumi.Input[EncryptionServicesArgs]]): # -> None:
        ...
...
class ExecutionTargetArgs:
    def __init__(__self__, *, exclude_prefix: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., prefix: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @_builtins.property
    @pulumi.getter
    def prefix(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @prefix.setter
    def prefix(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ExecutionTriggerArgs:
    def __init__(__self__, *, parameters: pulumi.Input[TriggerParametersArgs], type: pulumi.Input[TriggerType]) -> None:
    ...
    @parameters.setter
    def parameters(self, value: pulumi.Input[TriggerParametersArgs]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: pulumi.Input[TriggerType]): # -> None:
        ...
...
class FileSharePropertiesFileSharePaidBurstingArgs:
    def __init__(__self__, *, paid_bursting_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., paid_bursting_max_bandwidth_mibps: Optional[pulumi.Input[_builtins.int]] = ..., paid_bursting_max_iops: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def paid_bursting_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="paidBurstingMaxBandwidthMibps")
    def paid_bursting_max_bandwidth_mibps(self) -> Optional[pulumi.Input[_builtins.int]]:
        
        ...
    
    @paid_bursting_max_bandwidth_mibps.setter
    def paid_bursting_max_bandwidth_mibps(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def paid_bursting_max_iops(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
@pulumi.input_type
class IPRuleArgs:
    def __init__(__self__, *, i_p_address_or_range: pulumi.Input[_builtins.str], action: Optional[pulumi.Input[Action]] = ...) -> None:
    ...
    def i_p_address_or_range(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @action.setter
    def action(self, value: Optional[pulumi.Input[Action]]): # -> None:
        ...
...
class ImmutableStorageAccountArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., immutability_policy: Optional[pulumi.Input[AccountImmutabilityPolicyPropertiesArgs]] = ...) -> None:
    ...
    def immutability_policy(self, value: Optional[pulumi.Input[AccountImmutabilityPolicyPropertiesArgs]]): # -> None:
        ...
...
@pulumi.input_type
class KeyPolicyArgs:
    def __init__(__self__, *, key_expiration_period_in_days: pulumi.Input[_builtins.int]) -> None:
    ...
    def key_expiration_period_in_days(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class KeyVaultPropertiesArgs:
    def __init__(__self__, *, key_name: Optional[pulumi.Input[_builtins.str]] = ..., key_vault_uri: Optional[pulumi.Input[_builtins.str]] = ..., key_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LastAccessTimeTrackingPolicyArgs:
    def __init__(__self__, *, enable: pulumi.Input[_builtins.bool], blob_type: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., name: Optional[pulumi.Input[Union[_builtins.str, Name]]] = ..., tracking_granularity_in_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def blob_type(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @blob_type.setter
    def blob_type(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @name.setter
    def name(self, value: Optional[pulumi.Input[Union[_builtins.str, Name]]]): # -> None:
        ...
    ...
    def tracking_granularity_in_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ManagementPolicyActionArgs:
    def __init__(__self__, *, base_blob: Optional[pulumi.Input[ManagementPolicyBaseBlobArgs]] = ..., snapshot: Optional[pulumi.Input[ManagementPolicySnapShotArgs]] = ..., version: Optional[pulumi.Input[ManagementPolicyVersionArgs]] = ...) -> None:
    ...
    @base_blob.setter
    def base_blob(self, value: Optional[pulumi.Input[ManagementPolicyBaseBlobArgs]]): # -> None:
        ...
    ...
    @snapshot.setter
    def snapshot(self, value: Optional[pulumi.Input[ManagementPolicySnapShotArgs]]): # -> None:
        ...
    ...
    @version.setter
    def version(self, value: Optional[pulumi.Input[ManagementPolicyVersionArgs]]): # -> None:
        ...
...
class ManagementPolicyBaseBlobArgs:
    def __init__(__self__, *, delete: Optional[pulumi.Input[DateAfterModificationArgs]] = ..., enable_auto_tier_to_hot_from_cool: Optional[pulumi.Input[_builtins.bool]] = ..., tier_to_archive: Optional[pulumi.Input[DateAfterModificationArgs]] = ..., tier_to_cold: Optional[pulumi.Input[DateAfterModificationArgs]] = ..., tier_to_cool: Optional[pulumi.Input[DateAfterModificationArgs]] = ..., tier_to_hot: Optional[pulumi.Input[DateAfterModificationArgs]] = ...) -> None:
    ...
    @delete.setter
    def delete(self, value: Optional[pulumi.Input[DateAfterModificationArgs]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="enableAutoTierToHotFromCool")
    def enable_auto_tier_to_hot_from_cool(self) -> Optional[pulumi.Input[_builtins.bool]]:
        
        ...
    
    @enable_auto_tier_to_hot_from_cool.setter
    def enable_auto_tier_to_hot_from_cool(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def tier_to_archive(self, value: Optional[pulumi.Input[DateAfterModificationArgs]]): # -> None:
        ...
    ...
    @tier_to_cold.setter
    def tier_to_cold(self, value: Optional[pulumi.Input[DateAfterModificationArgs]]): # -> None:
        ...
    ...
    @tier_to_cool.setter
    def tier_to_cool(self, value: Optional[pulumi.Input[DateAfterModificationArgs]]): # -> None:
        ...
    ...
    @tier_to_hot.setter
    def tier_to_hot(self, value: Optional[pulumi.Input[DateAfterModificationArgs]]): # -> None:
        ...
...
class ManagementPolicyDefinitionArgs:
    def __init__(__self__, *, actions: pulumi.Input[ManagementPolicyActionArgs], filters: Optional[pulumi.Input[ManagementPolicyFilterArgs]] = ...) -> None:
    ...
    @actions.setter
    def actions(self, value: pulumi.Input[ManagementPolicyActionArgs]): # -> None:
        ...
    ...
    @filters.setter
    def filters(self, value: Optional[pulumi.Input[ManagementPolicyFilterArgs]]): # -> None:
        ...
...
class ManagementPolicyFilterArgs:
    def __init__(__self__, *, blob_types: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], blob_index_match: Optional[pulumi.Input[Sequence[pulumi.Input[TagFilterArgs]]]] = ..., prefix_match: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @blob_types.setter
    def blob_types(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def blob_index_match(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TagFilterArgs]]]]): # -> None:
        ...
...
class ManagementPolicyRuleArgs:
    def __init__(__self__, *, definition: pulumi.Input[ManagementPolicyDefinitionArgs], name: pulumi.Input[_builtins.str], type: pulumi.Input[Union[_builtins.str, RuleType]], enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @definition.setter
    def definition(self, value: pulumi.Input[ManagementPolicyDefinitionArgs]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, RuleType]]): # -> None:
        ...
...
class ManagementPolicySchemaArgs:
    def __init__(__self__, *, rules: pulumi.Input[Sequence[pulumi.Input[ManagementPolicyRuleArgs]]]) -> None:
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Sequence[pulumi.Input[ManagementPolicyRuleArgs]]]): # -> None:
        ...
...
class ManagementPolicySnapShotArgs:
    def __init__(__self__, *, delete: Optional[pulumi.Input[DateAfterCreationArgs]] = ..., tier_to_archive: Optional[pulumi.Input[DateAfterCreationArgs]] = ..., tier_to_cold: Optional[pulumi.Input[DateAfterCreationArgs]] = ..., tier_to_cool: Optional[pulumi.Input[DateAfterCreationArgs]] = ..., tier_to_hot: Optional[pulumi.Input[DateAfterCreationArgs]] = ...) -> None:
    ...
    @delete.setter
    def delete(self, value: Optional[pulumi.Input[DateAfterCreationArgs]]): # -> None:
        ...
    ...
    @tier_to_archive.setter
    def tier_to_archive(self, value: Optional[pulumi.Input[DateAfterCreationArgs]]): # -> None:
        ...
    ...
    @tier_to_cold.setter
    def tier_to_cold(self, value: Optional[pulumi.Input[DateAfterCreationArgs]]): # -> None:
        ...
    ...
    @tier_to_cool.setter
    def tier_to_cool(self, value: Optional[pulumi.Input[DateAfterCreationArgs]]): # -> None:
        ...
    ...
    @tier_to_hot.setter
    def tier_to_hot(self, value: Optional[pulumi.Input[DateAfterCreationArgs]]): # -> None:
        ...
...
class NetworkRuleSetArgs:
    def __init__(__self__, *, default_action: Optional[pulumi.Input[DefaultAction]] = ..., bypass: Optional[pulumi.Input[Union[_builtins.str, Bypass]]] = ..., ip_rules: Optional[pulumi.Input[Sequence[pulumi.Input[IPRuleArgs]]]] = ..., resource_access_rules: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceAccessRuleArgs]]]] = ..., virtual_network_rules: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualNetworkRuleArgs]]]] = ...) -> None:
    ...
    def default_action(self, value: pulumi.Input[DefaultAction]): # -> None:
        ...
    ...
    @bypass.setter
    def bypass(self, value: Optional[pulumi.Input[Union[_builtins.str, Bypass]]]): # -> None:
        ...
    ...
    def resource_access_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceAccessRuleArgs]]]]): # -> None:
        ...
...
class ObjectReplicationPolicyFilterArgs:
    def __init__(__self__, *, min_creation_time: Optional[pulumi.Input[_builtins.str]] = ..., prefix_match: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def min_creation_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ObjectReplicationPolicyRuleArgs:
    def __init__(__self__, *, destination_container: pulumi.Input[_builtins.str], source_container: pulumi.Input[_builtins.str], filters: Optional[pulumi.Input[ObjectReplicationPolicyFilterArgs]] = ..., rule_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def destination_container(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def source_container(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @filters.setter
    def filters(self, value: Optional[pulumi.Input[ObjectReplicationPolicyFilterArgs]]): # -> None:
        ...
...
class PermissionScopeArgs:
    def __init__(__self__, *, permissions: pulumi.Input[_builtins.str], resource_name: pulumi.Input[_builtins.str], service: pulumi.Input[_builtins.str]) -> None:
...
class PrivateLinkServiceConnectionStateArgs:
    def __init__(__self__, *, action_required: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, PrivateEndpointServiceConnectionStatus]]] = ...) -> None:
    ...
    def action_required(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ProtocolSettingsArgs:
    def __init__(__self__, *, smb: Optional[pulumi.Input[SmbSettingArgs]] = ...) -> None:
    ...
    @smb.setter
    def smb(self, value: Optional[pulumi.Input[SmbSettingArgs]]): # -> None:
        ...
...
class ResourceAccessRuleArgs:
    def __init__(__self__, *, resource_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RestorePolicyPropertiesArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class RoutingPreferenceArgs:
    def __init__(__self__, *, publish_internet_endpoints: Optional[pulumi.Input[_builtins.bool]] = ..., publish_microsoft_endpoints: Optional[pulumi.Input[_builtins.bool]] = ..., routing_choice: Optional[pulumi.Input[Union[_builtins.str, RoutingChoice]]] = ...) -> None:
    ...
    def publish_internet_endpoints(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def publish_microsoft_endpoints(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="routingChoice")
    def routing_choice(self) -> Optional[pulumi.Input[Union[_builtins.str, RoutingChoice]]]:
        
        ...
    
    @routing_choice.setter
    def routing_choice(self, value: Optional[pulumi.Input[Union[_builtins.str, RoutingChoice]]]): # -> None:
        ...
...
@pulumi.input_type
class SasPolicyArgs:
    def __init__(__self__, *, expiration_action: Optional[pulumi.Input[Union[_builtins.str, ExpirationAction]]] = ..., sas_expiration_period: pulumi.Input[_builtins.str]) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="expirationAction")
    def expiration_action(self) -> pulumi.Input[Union[_builtins.str, ExpirationAction]]:
        
        ...
    
    @expiration_action.setter
    def expiration_action(self, value: pulumi.Input[Union[_builtins.str, ExpirationAction]]): # -> None:
        ...
    ...
    def sas_expiration_period(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class SignedIdentifierArgs:
    def __init__(__self__, *, access_policy: Optional[pulumi.Input[AccessPolicyArgs]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def access_policy(self, value: Optional[pulumi.Input[AccessPolicyArgs]]): # -> None:
        ...
...
class SmbSettingArgs:
    def __init__(__self__, *, authentication_methods: Optional[pulumi.Input[_builtins.str]] = ..., channel_encryption: Optional[pulumi.Input[_builtins.str]] = ..., kerberos_ticket_encryption: Optional[pulumi.Input[_builtins.str]] = ..., multichannel: Optional[pulumi.Input[MultichannelArgs]] = ..., versions: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authentication_methods(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def channel_encryption(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def kerberos_ticket_encryption(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @multichannel.setter
    def multichannel(self, value: Optional[pulumi.Input[MultichannelArgs]]): # -> None:
        ...
    ...
    @versions.setter
    def versions(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SshPublicKeyArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StorageTaskAssignmentExecutionContextArgs:
    def __init__(__self__, *, trigger: pulumi.Input[ExecutionTriggerArgs], target: Optional[pulumi.Input[ExecutionTargetArgs]] = ...) -> None:
    ...
    @trigger.setter
    def trigger(self, value: pulumi.Input[ExecutionTriggerArgs]): # -> None:
        ...
    ...
    @target.setter
    def target(self, value: Optional[pulumi.Input[ExecutionTargetArgs]]): # -> None:
        ...
...
class StorageTaskAssignmentPropertiesArgs:
    def __init__(__self__, *, description: pulumi.Input[_builtins.str], enabled: pulumi.Input[_builtins.bool], execution_context: pulumi.Input[StorageTaskAssignmentExecutionContextArgs], report: pulumi.Input[StorageTaskAssignmentReportArgs], task_id: pulumi.Input[_builtins.str]) -> None:
    ...
    def execution_context(self, value: pulumi.Input[StorageTaskAssignmentExecutionContextArgs]): # -> None:
        ...
    ...
    @report.setter
    def report(self, value: pulumi.Input[StorageTaskAssignmentReportArgs]): # -> None:
        ...
...
class TableAccessPolicyArgs:
    def __init__(__self__, *, permission: pulumi.Input[_builtins.str], expiry_time: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TableSignedIdentifierArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], access_policy: Optional[pulumi.Input[TableAccessPolicyArgs]] = ...) -> None:
    ...
    @access_policy.setter
    def access_policy(self, value: Optional[pulumi.Input[TableAccessPolicyArgs]]): # -> None:
        ...
...
@pulumi.input_type
class TagFilterArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], op: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str]) -> None:
...
class TriggerParametersArgs:
    def __init__(__self__, *, end_by: Optional[pulumi.Input[_builtins.str]] = ..., interval: Optional[pulumi.Input[_builtins.int]] = ..., interval_unit: Optional[pulumi.Input[IntervalUnit]] = ..., start_from: Optional[pulumi.Input[_builtins.str]] = ..., start_on: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @end_by.setter
    def end_by(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def interval_unit(self, value: Optional[pulumi.Input[IntervalUnit]]): # -> None:
        ...
    ...
    @start_from.setter
    def start_from(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @start_on.setter
    def start_on(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VirtualNetworkRuleArgs:
    def __init__(__self__, *, virtual_network_resource_id: pulumi.Input[_builtins.str], action: Optional[pulumi.Input[Action]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, State]]] = ...) -> None:
    ...
    def virtual_network_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
