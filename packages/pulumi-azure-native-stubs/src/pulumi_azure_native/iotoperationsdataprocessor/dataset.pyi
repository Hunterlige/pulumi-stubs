...
class DatasetArgs:
    def __init__(
        ...
        *,
        ...
        keys: Optional[
            pulumi.Input[Mapping[str, pulumi.Input[DatasetPropertyKeyArgs]]]
        ] = ...,
    ...
    def keys(
        self,
    ) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[DatasetPropertyKeyArgs]]]]: ...
    @keys.setter
    def keys(
        self,
        value: Optional[
...
class Dataset(pulumi.CustomResource):
        ...
        keys: Optional[
            pulumi.Input[
                Mapping[
                    str,
                    pulumi.Input[
                        Union[DatasetPropertyKeyArgs, DatasetPropertyKeyArgsDict]
                    ],
                ]
            ]
        ] = ...,
    ...
    def keys(
        self,
    ) -> pulumi.Output[Optional[Mapping[str, outputs.DatasetPropertyKeyResponse]]]: ...
    @_builtins.property
    @pulumi.getter
