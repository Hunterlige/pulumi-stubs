...
class ScheduledActionArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[ScheduledActionPropertiesArgs]] = ...,
        scheduled_action_name: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[ScheduledActionPropertiesArgs]]
    ): ...
    @_builtins.property
...
class ScheduledAction(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[ScheduledActionPropertiesArgs, ScheduledActionPropertiesArgsDict]
            ]
        ] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.ScheduledActionPropertiesResponse]: ...
    @_builtins.property
