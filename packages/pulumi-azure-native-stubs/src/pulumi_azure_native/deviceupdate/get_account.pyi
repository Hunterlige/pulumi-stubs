...
class GetAccountResult:
    ...
    def __init__(__self__, azure_api_version=..., encryption=..., host_name=..., id=..., identity=..., location=..., locations=..., name=..., private_endpoint_connections=..., provisioning_state=..., public_network_access=..., sku=..., system_data=..., tags=..., type=...) -> None:
        ...
