...
class PrivateEndpointConnectionProxyArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], private_endpoint_connection_proxy_id: Optional[pulumi.Input[_builtins.str]] = ..., remote_private_endpoint: Optional[pulumi.Input[RemotePrivateEndpointArgs]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def private_endpoint_connection_proxy_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PrivateEndpointConnectionProxy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint_connection_proxy_id: Optional[pulumi.Input[_builtins.str]] = ..., remote_private_endpoint: Optional[pulumi.Input[Union[RemotePrivateEndpointArgs, RemotePrivateEndpointArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
