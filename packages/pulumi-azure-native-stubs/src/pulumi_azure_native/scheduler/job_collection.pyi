...
class JobCollectionArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[JobCollectionPropertiesArgs]] = ...,
    ...
    def job_collection_name(self, value: Optional[pulumi.Input[_builtins.str]]): ...
    @_builtins.property
    @pulumi.getter
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[JobCollectionPropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class JobCollection(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[JobCollectionPropertiesArgs, JobCollectionPropertiesArgsDict]
            ]
        ] = ...,
