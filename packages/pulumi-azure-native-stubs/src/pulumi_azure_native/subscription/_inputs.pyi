...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['PutAliasRequestAdditionalPropertiesArgs', 'PutAliasRequestAdditionalPropertiesArgsDict', 'PutAliasRequestPropertiesArgs', 'PutAliasRequestPropertiesArgsDict', 'TargetDirectoryRequestPropertiesArgs', 'TargetDirectoryRequestPropertiesArgsDict']
...
class PutAliasRequestAdditionalPropertiesArgs:
    def __init__(__self__, *, management_group_id: Optional[pulumi.Input[_builtins.str]] = ..., subscription_owner_id: Optional[pulumi.Input[_builtins.str]] = ..., subscription_tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def management_group_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def subscription_owner_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def subscription_tenant_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PutAliasRequestPropertiesArgs:
    def __init__(__self__, *, additional_properties: Optional[pulumi.Input[PutAliasRequestAdditionalPropertiesArgs]] = ..., billing_scope: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., reseller_id: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., workload: Optional[pulumi.Input[Union[_builtins.str, Workload]]] = ...) -> None:
    ...
    def additional_properties(self, value: Optional[pulumi.Input[PutAliasRequestAdditionalPropertiesArgs]]): # -> None:
        ...
    ...
    def billing_scope(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @reseller_id.setter
    def reseller_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @workload.setter
    def workload(self, value: Optional[pulumi.Input[Union[_builtins.str, Workload]]]): # -> None:
        ...
...
class TargetDirectoryRequestPropertiesArgs:
    def __init__(__self__, *, destination_owner_id: Optional[pulumi.Input[_builtins.str]] = ..., destination_tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def destination_owner_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def destination_tenant_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
