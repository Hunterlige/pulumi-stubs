...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetNodeTypeResult', 'AwaitableGetNodeTypeResult', 'get_node_type', 'get_node_type_output']
@pulumi.output_type
class GetNodeTypeResult:
    
    def __init__(__self__, additional_data_disks=..., additional_network_interface_configurations=..., application_ports=..., azure_api_version=..., capacities=..., computer_name_prefix=..., data_disk_letter=..., data_disk_size_gb=..., data_disk_type=..., dscp_configuration_id=..., enable_accelerated_networking=..., enable_encryption_at_host=..., enable_node_public_ip=..., enable_node_public_i_pv6=..., enable_over_provisioning=..., ephemeral_ports=..., eviction_policy=..., frontend_configurations=..., host_group_id=..., id=..., is_primary=..., is_spot_vm=..., is_stateless=..., multiple_placement_groups=..., name=..., nat_configurations=..., nat_gateway_id=..., network_security_rules=..., placement_properties=..., provisioning_state=..., secure_boot_enabled=..., security_type=..., service_artifact_reference_id=..., sku=..., spot_restore_timeout=..., subnet_id=..., system_data=..., tags=..., type=..., use_default_public_load_balancer=..., use_ephemeral_os_disk=..., use_temp_data_disk=..., vm_extensions=..., vm_image_offer=..., vm_image_plan=..., vm_image_publisher=..., vm_image_resource_id=..., vm_image_sku=..., vm_image_version=..., vm_instance_count=..., vm_managed_identity=..., vm_secrets=..., vm_setup_actions=..., vm_shared_gallery_image_id=..., vm_size=..., zones=...) -> None:
        ...
...
class AwaitableGetNodeTypeResult(GetNodeTypeResult):
    def __await__(self): # -> Generator[Never, Any, GetNodeTypeResult]:
        ...
    


def get_node_type(cluster_name: Optional[_builtins.str] = ..., node_type_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetNodeTypeResult:
    
    ...

def get_node_type_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., node_type_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetNodeTypeResult]:
