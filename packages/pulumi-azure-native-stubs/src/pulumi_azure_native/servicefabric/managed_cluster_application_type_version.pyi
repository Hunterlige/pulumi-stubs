...
class ManagedClusterApplicationTypeVersionArgs:
    def __init__(
        __self__,
        *,
        app_package_url: pulumi.Input[_builtins.str],
    ...
    def app_package_url(self, value: pulumi.Input[_builtins.str]): ...
    @_builtins.property
    ...
    def application_type_name(self, value: pulumi.Input[_builtins.str]): ...
    @_builtins.property
...
class ManagedClusterApplicationTypeVersion(pulumi.CustomResource):
    ...
    def __init__(
        ...
        app_package_url: Optional[pulumi.Input[_builtins.str]] = ...,
