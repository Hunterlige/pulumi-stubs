...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = [..., 'AdditionalNetworkInterfaceConfigurationResponse', 'ApplicationHealthPolicyResponse', 'ApplicationTypeVersionsCleanupPolicyResponse', 'ApplicationUpgradePolicyResponse', 'ApplicationUserAssignedIdentityResponse', 'AveragePartitionLoadScalingTriggerResponse', 'AverageServiceLoadScalingTriggerResponse', 'AzureActiveDirectoryResponse', 'ClientCertificateResponse', 'ClusterHealthPolicyResponse', 'ClusterMonitoringPolicyResponse', 'ClusterUpgradeDeltaHealthPolicyResponse', 'ClusterUpgradePolicyResponse', 'EndpointRangeDescriptionResponse', 'FaultSimulationConstraintsResponse', 'FaultSimulationDetailsResponse', 'FaultSimulationResponse', 'FrontendConfigurationResponse', 'IpConfigurationResponse', ..., 'IpTagResponse', 'LoadBalancingRuleResponse', 'ManagedIdentityResponse', 'NamedPartitionSchemeResponse', 'NetworkSecurityRuleResponse', 'NodeTypeFaultSimulationResponse', 'NodeTypeNatConfigResponse', 'NodeTypeSkuResponse', 'PartitionInstanceCountScaleMechanismResponse', 'ResourceAzStatusResponse', 'RollingUpgradeMonitoringPolicyResponse', 'ScalingPolicyResponse', 'ServiceCorrelationResponse', 'ServiceEndpointResponse', 'ServiceLoadMetricResponse', 'ServicePlacementInvalidDomainPolicyResponse', ..., 'ServicePlacementPreferPrimaryDomainPolicyResponse', ..., 'ServicePlacementRequiredDomainPolicyResponse', 'ServiceTypeHealthPolicyResponse', 'SettingsParameterDescriptionResponse', 'SettingsSectionDescriptionResponse', 'SingletonPartitionSchemeResponse', 'SkuResponse', 'StatefulServicePropertiesResponse', 'StatelessServicePropertiesResponse', 'SubResourceResponse', 'SubnetResponse', 'SystemDataResponse', 'UniformInt64RangePartitionSchemeResponse', 'UserAssignedIdentityResponse', 'VMSSExtensionResponse', 'VaultCertificateResponse', 'VaultSecretGroupResponse', 'VmImagePlanResponse', 'VmManagedIdentityResponse', 'VmssDataDiskResponse', 'ZoneFaultSimulationContentResponse']
@pulumi.output_type
class AddRemoveIncrementalNamedPartitionScalingMechanismResponse(dict):
    ...
    def __init__(__self__, *, kind: _builtins.str, max_partition_count: _builtins.int, min_partition_count: _builtins.int, scale_increment: _builtins.int) -> None:
...
class AdditionalNetworkInterfaceConfigurationResponse(dict):
    ...
    def __init__(__self__, *, ip_configurations: Sequence[outputs.IpConfigurationResponse], name: _builtins.str, dscp_configuration: Optional[outputs.SubResourceResponse] = ..., enable_accelerated_networking: Optional[_builtins.bool] = ...) -> None:
...
class ApplicationHealthPolicyResponse(dict):
    ...
    def __init__(__self__, *, consider_warning_as_error: _builtins.bool, max_percent_unhealthy_deployed_applications: _builtins.int, default_service_type_health_policy: Optional[outputs.ServiceTypeHealthPolicyResponse] = ..., service_type_health_policy_map: Optional[Mapping[str, outputs.ServiceTypeHealthPolicyResponse]] = ...) -> None:
...
class ApplicationUpgradePolicyResponse(dict):
    ...
    def __init__(__self__, *, application_health_policy: Optional[outputs.ApplicationHealthPolicyResponse] = ..., force_restart: Optional[_builtins.bool] = ..., instance_close_delay_duration: Optional[_builtins.float] = ..., recreate_application: Optional[_builtins.bool] = ..., rolling_upgrade_monitoring_policy: Optional[outputs.RollingUpgradeMonitoringPolicyResponse] = ..., upgrade_mode: Optional[_builtins.str] = ..., upgrade_replica_set_check_timeout: Optional[_builtins.float] = ...) -> None:
...
class ApplicationUserAssignedIdentityResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, principal_id: _builtins.str) -> None:
...
class AveragePartitionLoadScalingTriggerResponse(dict):
    ...
    def __init__(__self__, *, kind: _builtins.str, lower_load_threshold: _builtins.float, metric_name: _builtins.str, scale_interval: _builtins.str, upper_load_threshold: _builtins.float) -> None:
...
class AverageServiceLoadScalingTriggerResponse(dict):
    ...
    def __init__(__self__, *, kind: _builtins.str, lower_load_threshold: _builtins.float, metric_name: _builtins.str, scale_interval: _builtins.str, upper_load_threshold: _builtins.float, use_only_primary_load: _builtins.bool) -> None:
...
class AzureActiveDirectoryResponse(dict):
    ...
    def __init__(__self__, *, client_application: Optional[_builtins.str] = ..., cluster_application: Optional[_builtins.str] = ..., tenant_id: Optional[_builtins.str] = ...) -> None:
...
class ClientCertificateResponse(dict):
    ...
    def __init__(__self__, *, is_admin: _builtins.bool, common_name: Optional[_builtins.str] = ..., issuer_thumbprint: Optional[_builtins.str] = ..., thumbprint: Optional[_builtins.str] = ...) -> None:
...
class ClusterHealthPolicyResponse(dict):
    ...
    def __init__(__self__, *, max_percent_unhealthy_applications: Optional[_builtins.int] = ..., max_percent_unhealthy_nodes: Optional[_builtins.int] = ...) -> None:
...
class ClusterMonitoringPolicyResponse(dict):
    ...
    def __init__(__self__, *, health_check_retry_timeout: _builtins.str, health_check_stable_duration: _builtins.str, health_check_wait_duration: _builtins.str, upgrade_domain_timeout: _builtins.str, upgrade_timeout: _builtins.str) -> None:
...
class ClusterUpgradeDeltaHealthPolicyResponse(dict):
    ...
    def __init__(__self__, *, max_percent_delta_unhealthy_nodes: _builtins.int, max_percent_delta_unhealthy_applications: Optional[_builtins.int] = ..., max_percent_upgrade_domain_delta_unhealthy_nodes: Optional[_builtins.int] = ...) -> None:
    ...
    def max_percent_upgrade_domain_delta_unhealthy_nodes(self) -> Optional[_builtins.int]:
...
class ClusterUpgradePolicyResponse(dict):
    ...
    def __init__(__self__, *, delta_health_policy: Optional[outputs.ClusterUpgradeDeltaHealthPolicyResponse] = ..., force_restart: Optional[_builtins.bool] = ..., health_policy: Optional[outputs.ClusterHealthPolicyResponse] = ..., monitoring_policy: Optional[outputs.ClusterMonitoringPolicyResponse] = ..., upgrade_replica_set_check_timeout: Optional[_builtins.str] = ...) -> None:
...
class EndpointRangeDescriptionResponse(dict):
    ...
    def __init__(__self__, *, end_port: _builtins.int, start_port: _builtins.int) -> None:
...
class FaultSimulationConstraintsResponse(dict):
    ...
    def __init__(__self__, *, expiration_time: Optional[_builtins.str] = ...) -> None:
...
class FaultSimulationDetailsResponse(dict):
    ...
    def __init__(__self__, *, cluster_id: Optional[_builtins.str] = ..., node_type_fault_simulation: Optional[Sequence[outputs.NodeTypeFaultSimulationResponse]] = ..., operation_id: Optional[_builtins.str] = ..., parameters: Optional[outputs.ZoneFaultSimulationContentResponse] = ...) -> None:
...
class FaultSimulationResponse(dict):
    ...
    def __init__(__self__, *, details: Optional[outputs.FaultSimulationDetailsResponse] = ..., end_time: Optional[_builtins.str] = ..., simulation_id: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class FrontendConfigurationResponse(dict):
    ...
    def __init__(__self__, *, application_gateway_backend_address_pool_id: Optional[_builtins.str] = ..., ip_address_type: Optional[_builtins.str] = ..., load_balancer_backend_address_pool_id: Optional[_builtins.str] = ..., load_balancer_inbound_nat_pool_id: Optional[_builtins.str] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="applicationGatewayBackendAddressPoolId")
    def application_gateway_backend_address_pool_id(self) -> Optional[_builtins.str]:
...
class IpConfigurationResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, application_gateway_backend_address_pools: Optional[Sequence[outputs.SubResourceResponse]] = ..., load_balancer_backend_address_pools: Optional[Sequence[outputs.SubResourceResponse]] = ..., load_balancer_inbound_nat_pools: Optional[Sequence[outputs.SubResourceResponse]] = ..., private_ip_address_version: Optional[_builtins.str] = ..., public_ip_address_configuration: Optional[outputs.IpConfigurationResponsePublicIPAddressConfiguration] = ..., subnet: Optional[outputs.SubResourceResponse] = ...) -> None:
...
class IpConfigurationResponsePublicIPAddressConfiguration(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, ip_tags: Optional[Sequence[outputs.IpTagResponse]] = ..., public_ip_address_version: Optional[_builtins.str] = ...) -> None:
...
class IpTagResponse(dict):
    ...
    def __init__(__self__, *, ip_tag_type: _builtins.str, tag: _builtins.str) -> None:
...
class LoadBalancingRuleResponse(dict):
    ...
    def __init__(__self__, *, backend_port: _builtins.int, frontend_port: _builtins.int, probe_protocol: _builtins.str, protocol: _builtins.str, load_distribution: Optional[_builtins.str] = ..., probe_port: Optional[_builtins.int] = ..., probe_request_path: Optional[_builtins.str] = ...) -> None:
...
class NamedPartitionSchemeResponse(dict):
    ...
    def __init__(__self__, *, names: Sequence[_builtins.str], partition_scheme: _builtins.str) -> None:
...
class NetworkSecurityRuleResponse(dict):
    ...
    def __init__(__self__, *, access: _builtins.str, direction: _builtins.str, name: _builtins.str, priority: _builtins.int, protocol: _builtins.str, description: Optional[_builtins.str] = ..., destination_address_prefix: Optional[_builtins.str] = ..., destination_address_prefixes: Optional[Sequence[_builtins.str]] = ..., destination_port_range: Optional[_builtins.str] = ..., destination_port_ranges: Optional[Sequence[_builtins.str]] = ..., source_address_prefix: Optional[_builtins.str] = ..., source_address_prefixes: Optional[Sequence[_builtins.str]] = ..., source_port_range: Optional[_builtins.str] = ..., source_port_ranges: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class NodeTypeFaultSimulationResponse(dict):
    ...
    def __init__(__self__, *, operation_status: _builtins.str, node_type_name: Optional[_builtins.str] = ..., operation_id: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class NodeTypeNatConfigResponse(dict):
    ...
    def __init__(__self__, *, backend_port: Optional[_builtins.int] = ..., frontend_port_range_end: Optional[_builtins.int] = ..., frontend_port_range_start: Optional[_builtins.int] = ...) -> None:
...
class PartitionInstanceCountScaleMechanismResponse(dict):
    ...
    def __init__(__self__, *, kind: _builtins.str, max_instance_count: _builtins.int, min_instance_count: _builtins.int, scale_increment: _builtins.int) -> None:
...
class ResourceAzStatusResponse(dict):
    ...
    def __init__(__self__, *, details: _builtins.str, is_zone_resilient: _builtins.bool, resource_name: _builtins.str, resource_type: _builtins.str) -> None:
...
class RollingUpgradeMonitoringPolicyResponse(dict):
    ...
    def __init__(__self__, *, failure_action: _builtins.str, health_check_retry_timeout: _builtins.str, health_check_stable_duration: _builtins.str, health_check_wait_duration: _builtins.str, upgrade_domain_timeout: _builtins.str, upgrade_timeout: _builtins.str) -> None:
...
class ServiceCorrelationResponse(dict):
    ...
    def __init__(__self__, *, scheme: _builtins.str, service_name: _builtins.str) -> None:
...
class ServiceEndpointResponse(dict):
    ...
    def __init__(__self__, *, service: _builtins.str, locations: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServiceLoadMetricResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, default_load: Optional[_builtins.int] = ..., primary_default_load: Optional[_builtins.int] = ..., secondary_default_load: Optional[_builtins.int] = ..., weight: Optional[_builtins.str] = ...) -> None:
...
class ServicePlacementInvalidDomainPolicyResponse(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, type: _builtins.str) -> None:
...
class ServiceTypeHealthPolicyResponse(dict):
    ...
    def __init__(__self__, *, max_percent_unhealthy_partitions_per_service: _builtins.int, max_percent_unhealthy_replicas_per_partition: _builtins.int, max_percent_unhealthy_services: _builtins.int) -> None:
...
class SettingsSectionDescriptionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, parameters: Sequence[outputs.SettingsParameterDescriptionResponse]) -> None:
...
class StatefulServicePropertiesResponse(dict):
    ...
    def __init__(__self__, *, partition_description: Any, provisioning_state: _builtins.str, service_kind: _builtins.str, service_type_name: _builtins.str, correlation_scheme: Optional[Sequence[outputs.ServiceCorrelationResponse]] = ..., default_move_cost: Optional[_builtins.str] = ..., has_persisted_state: Optional[_builtins.bool] = ..., min_replica_set_size: Optional[_builtins.int] = ..., placement_constraints: Optional[_builtins.str] = ..., quorum_loss_wait_duration: Optional[_builtins.str] = ..., replica_restart_wait_duration: Optional[_builtins.str] = ..., scaling_policies: Optional[Sequence[outputs.ScalingPolicyResponse]] = ..., service_dns_name: Optional[_builtins.str] = ..., service_load_metrics: Optional[Sequence[outputs.ServiceLoadMetricResponse]] = ..., service_package_activation_mode: Optional[_builtins.str] = ..., service_placement_policies: Optional[Sequence[Any]] = ..., service_placement_time_limit: Optional[_builtins.str] = ..., stand_by_replica_keep_duration: Optional[_builtins.str] = ..., target_replica_set_size: Optional[_builtins.int] = ...) -> None:
...
class StatelessServicePropertiesResponse(dict):
    ...
    def __init__(__self__, *, instance_count: _builtins.int, partition_description: Any, provisioning_state: _builtins.str, service_kind: _builtins.str, service_type_name: _builtins.str, correlation_scheme: Optional[Sequence[outputs.ServiceCorrelationResponse]] = ..., default_move_cost: Optional[_builtins.str] = ..., min_instance_count: Optional[_builtins.int] = ..., min_instance_percentage: Optional[_builtins.int] = ..., placement_constraints: Optional[_builtins.str] = ..., scaling_policies: Optional[Sequence[outputs.ScalingPolicyResponse]] = ..., service_dns_name: Optional[_builtins.str] = ..., service_load_metrics: Optional[Sequence[outputs.ServiceLoadMetricResponse]] = ..., service_package_activation_mode: Optional[_builtins.str] = ..., service_placement_policies: Optional[Sequence[Any]] = ...) -> None:
...
class SubnetResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, enable_ipv6: Optional[_builtins.bool] = ..., network_security_group_id: Optional[_builtins.str] = ..., private_endpoint_network_policies: Optional[_builtins.str] = ..., private_link_service_network_policies: Optional[_builtins.str] = ...) -> None:
...
class UniformInt64RangePartitionSchemeResponse(dict):
    ...
    def __init__(__self__, *, count: _builtins.int, high_key: _builtins.float, low_key: _builtins.float, partition_scheme: _builtins.str) -> None:
...
class VMSSExtensionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, provisioning_state: _builtins.str, publisher: _builtins.str, type: _builtins.str, type_handler_version: _builtins.str, auto_upgrade_minor_version: Optional[_builtins.bool] = ..., enable_automatic_upgrade: Optional[_builtins.bool] = ..., force_update_tag: Optional[_builtins.str] = ..., protected_settings: Optional[Any] = ..., provision_after_extensions: Optional[Sequence[_builtins.str]] = ..., settings: Optional[Any] = ..., setup_order: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class VaultCertificateResponse(dict):
    ...
    def __init__(__self__, *, certificate_store: _builtins.str, certificate_url: _builtins.str) -> None:
...
class VaultSecretGroupResponse(dict):
    ...
    def __init__(__self__, *, source_vault: outputs.SubResourceResponse, vault_certificates: Sequence[outputs.VaultCertificateResponse]) -> None:
...
class VmManagedIdentityResponse(dict):
    ...
    def __init__(__self__, *, user_assigned_identities: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class VmssDataDiskResponse(dict):
    ...
    def __init__(__self__, *, disk_letter: _builtins.str, disk_size_gb: _builtins.int, disk_type: _builtins.str, lun: _builtins.int) -> None:
...
class ZoneFaultSimulationContentResponse(dict):
    ...
    def __init__(__self__, *, fault_kind: _builtins.str, constraints: Optional[outputs.FaultSimulationConstraintsResponse] = ..., force: Optional[_builtins.bool] = ..., zones: Optional[Sequence[_builtins.str]] = ...) -> None:
