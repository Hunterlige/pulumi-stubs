...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = [..., ..., 'AdditionalNetworkInterfaceConfigurationArgs', 'AdditionalNetworkInterfaceConfigurationArgsDict', 'ApplicationHealthPolicyArgs', 'ApplicationHealthPolicyArgsDict', 'ApplicationTypeVersionsCleanupPolicyArgs', 'ApplicationTypeVersionsCleanupPolicyArgsDict', 'ApplicationUpgradePolicyArgs', 'ApplicationUpgradePolicyArgsDict', 'ApplicationUserAssignedIdentityArgs', 'ApplicationUserAssignedIdentityArgsDict', 'AveragePartitionLoadScalingTriggerArgs', 'AveragePartitionLoadScalingTriggerArgsDict', 'AverageServiceLoadScalingTriggerArgs', 'AverageServiceLoadScalingTriggerArgsDict', 'AzureActiveDirectoryArgs', 'AzureActiveDirectoryArgsDict', 'ClientCertificateArgs', 'ClientCertificateArgsDict', 'ClusterHealthPolicyArgs', 'ClusterHealthPolicyArgsDict', 'ClusterMonitoringPolicyArgs', 'ClusterMonitoringPolicyArgsDict', 'ClusterUpgradeDeltaHealthPolicyArgs', 'ClusterUpgradeDeltaHealthPolicyArgsDict', 'ClusterUpgradePolicyArgs', 'ClusterUpgradePolicyArgsDict', 'EndpointRangeDescriptionArgs', 'EndpointRangeDescriptionArgsDict', 'FrontendConfigurationArgs', 'FrontendConfigurationArgsDict', 'IpConfigurationPublicIPAddressConfigurationArgs', ..., 'IpConfigurationArgs', 'IpConfigurationArgsDict', 'IpTagArgs', 'IpTagArgsDict', 'LoadBalancingRuleArgs', 'LoadBalancingRuleArgsDict', 'ManagedIdentityArgs', 'ManagedIdentityArgsDict', 'NamedPartitionSchemeArgs', 'NamedPartitionSchemeArgsDict', 'NetworkSecurityRuleArgs', 'NetworkSecurityRuleArgsDict', 'NodeTypeNatConfigArgs', 'NodeTypeNatConfigArgsDict', 'NodeTypeSkuArgs', 'NodeTypeSkuArgsDict', 'PartitionInstanceCountScaleMechanismArgs', 'PartitionInstanceCountScaleMechanismArgsDict', 'RollingUpgradeMonitoringPolicyArgs', 'RollingUpgradeMonitoringPolicyArgsDict', 'ScalingPolicyArgs', 'ScalingPolicyArgsDict', 'ServiceCorrelationArgs', 'ServiceCorrelationArgsDict', 'ServiceEndpointArgs', 'ServiceEndpointArgsDict', 'ServiceLoadMetricArgs', 'ServiceLoadMetricArgsDict', 'ServicePlacementInvalidDomainPolicyArgs', 'ServicePlacementInvalidDomainPolicyArgsDict', 'ServicePlacementNonPartiallyPlaceServicePolicyArgs', ..., 'ServicePlacementPreferPrimaryDomainPolicyArgs', 'ServicePlacementPreferPrimaryDomainPolicyArgsDict', ..., ..., 'ServicePlacementRequiredDomainPolicyArgs', 'ServicePlacementRequiredDomainPolicyArgsDict', 'ServiceTypeHealthPolicyArgs', 'ServiceTypeHealthPolicyArgsDict', 'SettingsParameterDescriptionArgs', 'SettingsParameterDescriptionArgsDict', 'SettingsSectionDescriptionArgs', 'SettingsSectionDescriptionArgsDict', 'SingletonPartitionSchemeArgs', 'SingletonPartitionSchemeArgsDict', 'SkuArgs', 'SkuArgsDict', 'StatefulServicePropertiesArgs', 'StatefulServicePropertiesArgsDict', 'StatelessServicePropertiesArgs', 'StatelessServicePropertiesArgsDict', 'SubResourceArgs', 'SubResourceArgsDict', 'SubnetArgs', 'SubnetArgsDict', 'UniformInt64RangePartitionSchemeArgs', 'UniformInt64RangePartitionSchemeArgsDict', 'VMSSExtensionArgs', 'VMSSExtensionArgsDict', 'VaultCertificateArgs', 'VaultCertificateArgsDict', 'VaultSecretGroupArgs', 'VaultSecretGroupArgsDict', 'VmImagePlanArgs', 'VmImagePlanArgsDict', 'VmManagedIdentityArgs', 'VmManagedIdentityArgsDict', 'VmssDataDiskArgs', 'VmssDataDiskArgsDict']
...
class AddRemoveIncrementalNamedPartitionScalingMechanismArgs:
    def __init__(__self__, *, kind: pulumi.Input[_builtins.str], max_partition_count: pulumi.Input[_builtins.int], min_partition_count: pulumi.Input[_builtins.int], scale_increment: pulumi.Input[_builtins.int]) -> None:
    ...
    def max_partition_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def min_partition_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class AdditionalNetworkInterfaceConfigurationArgs:
    def __init__(__self__, *, ip_configurations: pulumi.Input[Sequence[pulumi.Input[IpConfigurationArgs]]], name: pulumi.Input[_builtins.str], dscp_configuration: Optional[pulumi.Input[SubResourceArgs]] = ..., enable_accelerated_networking: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class ApplicationHealthPolicyArgs:
    def __init__(__self__, *, consider_warning_as_error: pulumi.Input[_builtins.bool], max_percent_unhealthy_deployed_applications: pulumi.Input[_builtins.int], default_service_type_health_policy: Optional[pulumi.Input[ServiceTypeHealthPolicyArgs]] = ..., service_type_health_policy_map: Optional[pulumi.Input[Mapping[str, pulumi.Input[ServiceTypeHealthPolicyArgs]]]] = ...) -> None:
    ...
    def consider_warning_as_error(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def max_percent_unhealthy_deployed_applications(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def default_service_type_health_policy(self, value: Optional[pulumi.Input[ServiceTypeHealthPolicyArgs]]): # -> None:
        ...
    ...
    def service_type_health_policy_map(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[ServiceTypeHealthPolicyArgs]]]]): # -> None:
        ...
...
class ApplicationTypeVersionsCleanupPolicyArgs:
    def __init__(__self__, *, max_unused_versions_to_keep: pulumi.Input[_builtins.int]) -> None:
    ...
    def max_unused_versions_to_keep(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ApplicationUpgradePolicyArgs:
    def __init__(__self__, *, application_health_policy: Optional[pulumi.Input[ApplicationHealthPolicyArgs]] = ..., force_restart: Optional[pulumi.Input[_builtins.bool]] = ..., instance_close_delay_duration: Optional[pulumi.Input[_builtins.float]] = ..., recreate_application: Optional[pulumi.Input[_builtins.bool]] = ..., rolling_upgrade_monitoring_policy: Optional[pulumi.Input[RollingUpgradeMonitoringPolicyArgs]] = ..., upgrade_mode: Optional[pulumi.Input[Union[_builtins.str, RollingUpgradeMode]]] = ..., upgrade_replica_set_check_timeout: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def application_health_policy(self, value: Optional[pulumi.Input[ApplicationHealthPolicyArgs]]): # -> None:
        ...
    ...
    def force_restart(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def instance_close_delay_duration(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def recreate_application(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def rolling_upgrade_monitoring_policy(self, value: Optional[pulumi.Input[RollingUpgradeMonitoringPolicyArgs]]): # -> None:
        ...
    ...
    @upgrade_mode.setter
    def upgrade_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, RollingUpgradeMode]]]): # -> None:
        ...
    ...
    def upgrade_replica_set_check_timeout(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class ApplicationUserAssignedIdentityArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], principal_id: pulumi.Input[_builtins.str]) -> None:
...
class AveragePartitionLoadScalingTriggerArgs:
    def __init__(__self__, *, kind: pulumi.Input[_builtins.str], lower_load_threshold: pulumi.Input[_builtins.float], metric_name: pulumi.Input[_builtins.str], scale_interval: pulumi.Input[_builtins.str], upper_load_threshold: pulumi.Input[_builtins.float]) -> None:
    ...
    def scale_interval(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AverageServiceLoadScalingTriggerArgs:
    def __init__(__self__, *, kind: pulumi.Input[_builtins.str], lower_load_threshold: pulumi.Input[_builtins.float], metric_name: pulumi.Input[_builtins.str], scale_interval: pulumi.Input[_builtins.str], upper_load_threshold: pulumi.Input[_builtins.float], use_only_primary_load: pulumi.Input[_builtins.bool]) -> None:
    ...
    def use_only_primary_load(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class AzureActiveDirectoryArgs:
    def __init__(__self__, *, client_application: Optional[pulumi.Input[_builtins.str]] = ..., cluster_application: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def client_application(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def cluster_application(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClientCertificateArgs:
    def __init__(__self__, *, is_admin: pulumi.Input[_builtins.bool], common_name: Optional[pulumi.Input[_builtins.str]] = ..., issuer_thumbprint: Optional[pulumi.Input[_builtins.str]] = ..., thumbprint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def issuer_thumbprint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterHealthPolicyArgs:
    def __init__(__self__, *, max_percent_unhealthy_applications: Optional[pulumi.Input[_builtins.int]] = ..., max_percent_unhealthy_nodes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def max_percent_unhealthy_applications(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def max_percent_unhealthy_nodes(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ClusterMonitoringPolicyArgs:
    def __init__(__self__, *, health_check_retry_timeout: pulumi.Input[_builtins.str], health_check_stable_duration: pulumi.Input[_builtins.str], health_check_wait_duration: pulumi.Input[_builtins.str], upgrade_domain_timeout: pulumi.Input[_builtins.str], upgrade_timeout: pulumi.Input[_builtins.str]) -> None:
    ...
    def health_check_retry_timeout(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def health_check_stable_duration(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def health_check_wait_duration(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def upgrade_domain_timeout(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def upgrade_timeout(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterUpgradeDeltaHealthPolicyArgs:
    def __init__(__self__, *, max_percent_delta_unhealthy_nodes: pulumi.Input[_builtins.int], max_percent_delta_unhealthy_applications: Optional[pulumi.Input[_builtins.int]] = ..., max_percent_upgrade_domain_delta_unhealthy_nodes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def max_percent_delta_unhealthy_nodes(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def max_percent_delta_unhealthy_applications(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_percent_upgrade_domain_delta_unhealthy_nodes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ClusterUpgradePolicyArgs:
    def __init__(__self__, *, delta_health_policy: Optional[pulumi.Input[ClusterUpgradeDeltaHealthPolicyArgs]] = ..., force_restart: Optional[pulumi.Input[_builtins.bool]] = ..., health_policy: Optional[pulumi.Input[ClusterHealthPolicyArgs]] = ..., monitoring_policy: Optional[pulumi.Input[ClusterMonitoringPolicyArgs]] = ..., upgrade_replica_set_check_timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def delta_health_policy(self, value: Optional[pulumi.Input[ClusterUpgradeDeltaHealthPolicyArgs]]): # -> None:
        ...
    ...
    def health_policy(self, value: Optional[pulumi.Input[ClusterHealthPolicyArgs]]): # -> None:
        ...
    ...
    def monitoring_policy(self, value: Optional[pulumi.Input[ClusterMonitoringPolicyArgs]]): # -> None:
        ...
    ...
    @upgrade_replica_set_check_timeout.setter
    def upgrade_replica_set_check_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EndpointRangeDescriptionArgs:
    def __init__(__self__, *, end_port: pulumi.Input[_builtins.int], start_port: pulumi.Input[_builtins.int]) -> None:
...
class FrontendConfigurationArgs:
    def __init__(__self__, *, application_gateway_backend_address_pool_id: Optional[pulumi.Input[_builtins.str]] = ..., ip_address_type: Optional[pulumi.Input[Union[_builtins.str, IPAddressType]]] = ..., load_balancer_backend_address_pool_id: Optional[pulumi.Input[_builtins.str]] = ..., load_balancer_inbound_nat_pool_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def application_gateway_backend_address_pool_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def load_balancer_backend_address_pool_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def load_balancer_inbound_nat_pool_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IpConfigurationPublicIPAddressConfigurationArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], ip_tags: Optional[pulumi.Input[Sequence[pulumi.Input[IpTagArgs]]]] = ..., public_ip_address_version: Optional[pulumi.Input[Union[_builtins.str, PublicIPAddressVersion]]] = ...) -> None:
    ...
    def public_ip_address_version(self, value: Optional[pulumi.Input[Union[_builtins.str, PublicIPAddressVersion]]]): # -> None:
        ...
...
class IpConfigurationArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], application_gateway_backend_address_pools: Optional[pulumi.Input[Sequence[pulumi.Input[SubResourceArgs]]]] = ..., load_balancer_backend_address_pools: Optional[pulumi.Input[Sequence[pulumi.Input[SubResourceArgs]]]] = ..., load_balancer_inbound_nat_pools: Optional[pulumi.Input[Sequence[pulumi.Input[SubResourceArgs]]]] = ..., private_ip_address_version: Optional[pulumi.Input[Union[_builtins.str, PrivateIPAddressVersion]]] = ..., public_ip_address_configuration: Optional[pulumi.Input[IpConfigurationPublicIPAddressConfigurationArgs]] = ..., subnet: Optional[pulumi.Input[SubResourceArgs]] = ...) -> None:
    ...
    def private_ip_address_version(self, value: Optional[pulumi.Input[Union[_builtins.str, PrivateIPAddressVersion]]]): # -> None:
        ...
    ...
    def public_ip_address_configuration(self, value: Optional[pulumi.Input[IpConfigurationPublicIPAddressConfigurationArgs]]): # -> None:
        ...
...
@pulumi.input_type
class IpTagArgs:
    def __init__(__self__, *, ip_tag_type: pulumi.Input[_builtins.str], tag: pulumi.Input[_builtins.str]) -> None:
    ...
    @ip_tag_type.setter
    def ip_tag_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class LoadBalancingRuleArgs:
    def __init__(__self__, *, backend_port: pulumi.Input[_builtins.int], frontend_port: pulumi.Input[_builtins.int], probe_protocol: pulumi.Input[Union[_builtins.str, ProbeProtocol]], protocol: pulumi.Input[Union[_builtins.str, Protocol]], load_distribution: Optional[pulumi.Input[_builtins.str]] = ..., probe_port: Optional[pulumi.Input[_builtins.int]] = ..., probe_request_path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def probe_protocol(self, value: pulumi.Input[Union[_builtins.str, ProbeProtocol]]): # -> None:
        ...
    ...
    def load_distribution(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def probe_request_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ManagedIdentityArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[ManagedIdentityType]] = ..., user_assigned_identities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[ManagedIdentityType]]): # -> None:
        ...
...
class NamedPartitionSchemeArgs:
    def __init__(__self__, *, names: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], partition_scheme: pulumi.Input[_builtins.str]) -> None:
    ...
    @names.setter
    def names(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def partition_scheme(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class NetworkSecurityRuleArgs:
    def __init__(__self__, *, access: pulumi.Input[Union[_builtins.str, Access]], direction: pulumi.Input[Union[_builtins.str, Direction]], name: pulumi.Input[_builtins.str], priority: pulumi.Input[_builtins.int], protocol: pulumi.Input[Union[_builtins.str, NsgProtocol]], description: Optional[pulumi.Input[_builtins.str]] = ..., destination_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., destination_address_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., destination_port_range: Optional[pulumi.Input[_builtins.str]] = ..., destination_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., source_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., source_address_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., source_port_range: Optional[pulumi.Input[_builtins.str]] = ..., source_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @direction.setter
    def direction(self, value: pulumi.Input[Union[_builtins.str, Direction]]): # -> None:
        ...
    ...
    @protocol.setter
    def protocol(self, value: pulumi.Input[Union[_builtins.str, NsgProtocol]]): # -> None:
        ...
...
class NodeTypeNatConfigArgs:
    def __init__(__self__, *, backend_port: Optional[pulumi.Input[_builtins.int]] = ..., frontend_port_range_end: Optional[pulumi.Input[_builtins.int]] = ..., frontend_port_range_start: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class NodeTypeSkuArgs:
    def __init__(__self__, *, capacity: pulumi.Input[_builtins.int], name: Optional[pulumi.Input[_builtins.str]] = ..., tier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PartitionInstanceCountScaleMechanismArgs:
    def __init__(__self__, *, kind: pulumi.Input[_builtins.str], max_instance_count: pulumi.Input[_builtins.int], min_instance_count: pulumi.Input[_builtins.int], scale_increment: pulumi.Input[_builtins.int]) -> None:
    ...
    def max_instance_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def min_instance_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class RollingUpgradeMonitoringPolicyArgs:
    def __init__(__self__, *, failure_action: pulumi.Input[Union[_builtins.str, FailureAction]], health_check_retry_timeout: pulumi.Input[_builtins.str], health_check_stable_duration: pulumi.Input[_builtins.str], health_check_wait_duration: pulumi.Input[_builtins.str], upgrade_domain_timeout: pulumi.Input[_builtins.str], upgrade_timeout: pulumi.Input[_builtins.str]) -> None:
    ...
    def failure_action(self, value: pulumi.Input[Union[_builtins.str, FailureAction]]): # -> None:
        ...
...
class ScalingPolicyArgs:
    def __init__(__self__, *, scaling_mechanism: pulumi.Input[Union[AddRemoveIncrementalNamedPartitionScalingMechanismArgs, PartitionInstanceCountScaleMechanismArgs]], scaling_trigger: pulumi.Input[Union[AveragePartitionLoadScalingTriggerArgs, AverageServiceLoadScalingTriggerArgs]]) -> None:
    ...
    def scaling_mechanism(self, value: pulumi.Input[Union[AddRemoveIncrementalNamedPartitionScalingMechanismArgs, PartitionInstanceCountScaleMechanismArgs]]): # -> None:
        ...
    ...
    def scaling_trigger(self, value: pulumi.Input[Union[AveragePartitionLoadScalingTriggerArgs, AverageServiceLoadScalingTriggerArgs]]): # -> None:
        ...
...
class ServiceCorrelationArgs:
    def __init__(__self__, *, scheme: pulumi.Input[Union[_builtins.str, ServiceCorrelationScheme]], service_name: pulumi.Input[_builtins.str]) -> None:
    ...
    @scheme.setter
    def scheme(self, value: pulumi.Input[Union[_builtins.str, ServiceCorrelationScheme]]): # -> None:
        ...
...
class ServiceEndpointArgs:
    def __init__(__self__, *, service: pulumi.Input[_builtins.str], locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ServiceLoadMetricArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], default_load: Optional[pulumi.Input[_builtins.int]] = ..., primary_default_load: Optional[pulumi.Input[_builtins.int]] = ..., secondary_default_load: Optional[pulumi.Input[_builtins.int]] = ..., weight: Optional[pulumi.Input[Union[_builtins.str, ServiceLoadMetricWeight]]] = ...) -> None:
    ...
    @default_load.setter
    def default_load(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def primary_default_load(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def secondary_default_load(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @weight.setter
    def weight(self, value: Optional[pulumi.Input[Union[_builtins.str, ServiceLoadMetricWeight]]]): # -> None:
        ...
...
class ServicePlacementInvalidDomainPolicyArgs:
    def __init__(__self__, *, domain_name: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str]) -> None:
...
class ServiceTypeHealthPolicyArgs:
    def __init__(__self__, *, max_percent_unhealthy_partitions_per_service: pulumi.Input[_builtins.int], max_percent_unhealthy_replicas_per_partition: pulumi.Input[_builtins.int], max_percent_unhealthy_services: pulumi.Input[_builtins.int]) -> None:
    ...
    def max_percent_unhealthy_partitions_per_service(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def max_percent_unhealthy_replicas_per_partition(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def max_percent_unhealthy_services(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class SettingsSectionDescriptionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], parameters: pulumi.Input[Sequence[pulumi.Input[SettingsParameterDescriptionArgs]]]) -> None:
    ...
    @parameters.setter
    def parameters(self, value: pulumi.Input[Sequence[pulumi.Input[SettingsParameterDescriptionArgs]]]): # -> None:
        ...
...
class SingletonPartitionSchemeArgs:
    def __init__(__self__, *, partition_scheme: pulumi.Input[_builtins.str]) -> None:
...
class StatefulServicePropertiesArgs:
    def __init__(__self__, *, partition_description: pulumi.Input[Union[NamedPartitionSchemeArgs, SingletonPartitionSchemeArgs, UniformInt64RangePartitionSchemeArgs]], service_kind: pulumi.Input[_builtins.str], service_type_name: pulumi.Input[_builtins.str], correlation_scheme: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceCorrelationArgs]]]] = ..., default_move_cost: Optional[pulumi.Input[Union[_builtins.str, MoveCost]]] = ..., has_persisted_state: Optional[pulumi.Input[_builtins.bool]] = ..., min_replica_set_size: Optional[pulumi.Input[_builtins.int]] = ..., placement_constraints: Optional[pulumi.Input[_builtins.str]] = ..., quorum_loss_wait_duration: Optional[pulumi.Input[_builtins.str]] = ..., replica_restart_wait_duration: Optional[pulumi.Input[_builtins.str]] = ..., scaling_policies: Optional[pulumi.Input[Sequence[pulumi.Input[ScalingPolicyArgs]]]] = ..., service_dns_name: Optional[pulumi.Input[_builtins.str]] = ..., service_load_metrics: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceLoadMetricArgs]]]] = ..., service_package_activation_mode: Optional[pulumi.Input[Union[_builtins.str, ServicePackageActivationMode]]] = ..., service_placement_policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ServicePlacementInvalidDomainPolicyArgs, ServicePlacementNonPartiallyPlaceServicePolicyArgs, ServicePlacementPreferPrimaryDomainPolicyArgs, ServicePlacementRequireDomainDistributionPolicyArgs, ServicePlacementRequiredDomainPolicyArgs]]]]] = ..., service_placement_time_limit: Optional[pulumi.Input[_builtins.str]] = ..., stand_by_replica_keep_duration: Optional[pulumi.Input[_builtins.str]] = ..., target_replica_set_size: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def partition_description(self, value: pulumi.Input[Union[NamedPartitionSchemeArgs, SingletonPartitionSchemeArgs, UniformInt64RangePartitionSchemeArgs]]): # -> None:
        ...
    ...
    @service_kind.setter
    def service_kind(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def service_type_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def correlation_scheme(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceCorrelationArgs]]]]): # -> None:
        ...
    ...
    def default_move_cost(self, value: Optional[pulumi.Input[Union[_builtins.str, MoveCost]]]): # -> None:
        ...
    ...
    def has_persisted_state(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def min_replica_set_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def placement_constraints(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def quorum_loss_wait_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def replica_restart_wait_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def scaling_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ScalingPolicyArgs]]]]): # -> None:
        ...
    ...
    def service_load_metrics(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceLoadMetricArgs]]]]): # -> None:
        ...
    ...
    def service_package_activation_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, ServicePackageActivationMode]]]): # -> None:
        ...
    ...
    def service_placement_time_limit(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def stand_by_replica_keep_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_replica_set_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class StatelessServicePropertiesArgs:
    def __init__(__self__, *, instance_count: pulumi.Input[_builtins.int], partition_description: pulumi.Input[Union[NamedPartitionSchemeArgs, SingletonPartitionSchemeArgs, UniformInt64RangePartitionSchemeArgs]], service_kind: pulumi.Input[_builtins.str], service_type_name: pulumi.Input[_builtins.str], correlation_scheme: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceCorrelationArgs]]]] = ..., default_move_cost: Optional[pulumi.Input[Union[_builtins.str, MoveCost]]] = ..., min_instance_count: Optional[pulumi.Input[_builtins.int]] = ..., min_instance_percentage: Optional[pulumi.Input[_builtins.int]] = ..., placement_constraints: Optional[pulumi.Input[_builtins.str]] = ..., scaling_policies: Optional[pulumi.Input[Sequence[pulumi.Input[ScalingPolicyArgs]]]] = ..., service_dns_name: Optional[pulumi.Input[_builtins.str]] = ..., service_load_metrics: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceLoadMetricArgs]]]] = ..., service_package_activation_mode: Optional[pulumi.Input[Union[_builtins.str, ServicePackageActivationMode]]] = ..., service_placement_policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ServicePlacementInvalidDomainPolicyArgs, ServicePlacementNonPartiallyPlaceServicePolicyArgs, ServicePlacementPreferPrimaryDomainPolicyArgs, ServicePlacementRequireDomainDistributionPolicyArgs, ServicePlacementRequiredDomainPolicyArgs]]]]] = ...) -> None:
    ...
    def min_instance_percentage(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
@pulumi.input_type
class SubnetArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], enable_ipv6: Optional[pulumi.Input[_builtins.bool]] = ..., network_security_group_id: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint_network_policies: Optional[pulumi.Input[Union[_builtins.str, PrivateEndpointNetworkPolicies]]] = ..., private_link_service_network_policies: Optional[pulumi.Input[Union[_builtins.str, PrivateLinkServiceNetworkPolicies]]] = ...) -> None:
    ...
    def network_security_group_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def private_endpoint_network_policies(self, value: Optional[pulumi.Input[Union[_builtins.str, PrivateEndpointNetworkPolicies]]]): # -> None:
        ...
    ...
    def private_link_service_network_policies(self, value: Optional[pulumi.Input[Union[_builtins.str, PrivateLinkServiceNetworkPolicies]]]): # -> None:
        ...
...
class UniformInt64RangePartitionSchemeArgs:
    def __init__(__self__, *, count: pulumi.Input[_builtins.int], high_key: pulumi.Input[_builtins.float], low_key: pulumi.Input[_builtins.float], partition_scheme: pulumi.Input[_builtins.str]) -> None:
    ...
    @high_key.setter
    def high_key(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @low_key.setter
    def low_key(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class VMSSExtensionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], publisher: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], type_handler_version: pulumi.Input[_builtins.str], auto_upgrade_minor_version: Optional[pulumi.Input[_builtins.bool]] = ..., enable_automatic_upgrade: Optional[pulumi.Input[_builtins.bool]] = ..., force_update_tag: Optional[pulumi.Input[_builtins.str]] = ..., protected_settings: Optional[Any] = ..., provision_after_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., settings: Optional[Any] = ..., setup_order: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, VmssExtensionSetupOrder]]]]] = ...) -> None:
    ...
    def type_handler_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @setup_order.setter
    def setup_order(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, VmssExtensionSetupOrder]]]]]): # -> None:
        ...
...
class VaultCertificateArgs:
    def __init__(__self__, *, certificate_store: pulumi.Input[_builtins.str], certificate_url: pulumi.Input[_builtins.str]) -> None:
    ...
    def certificate_store(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def certificate_url(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class VaultSecretGroupArgs:
    def __init__(__self__, *, source_vault: pulumi.Input[SubResourceArgs], vault_certificates: pulumi.Input[Sequence[pulumi.Input[VaultCertificateArgs]]]) -> None:
    ...
    def vault_certificates(self, value: pulumi.Input[Sequence[pulumi.Input[VaultCertificateArgs]]]): # -> None:
        ...
...
class VmManagedIdentityArgs:
    def __init__(__self__, *, user_assigned_identities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class VmssDataDiskArgs:
    def __init__(__self__, *, disk_letter: pulumi.Input[_builtins.str], disk_size_gb: pulumi.Input[_builtins.int], disk_type: pulumi.Input[Union[_builtins.str, DiskType]], lun: pulumi.Input[_builtins.int]) -> None:
    ...
    @disk_letter.setter
    def disk_letter(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @disk_size_gb.setter
    def disk_size_gb(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @disk_type.setter
    def disk_type(self, value: pulumi.Input[Union[_builtins.str, DiskType]]): # -> None:
        ...
