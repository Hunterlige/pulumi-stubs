...
class GetManagedClusterResult:
    ...
    def __init__(__self__, addon_features=..., admin_password=..., admin_user_name=..., allow_rdp_access=..., application_type_versions_cleanup_policy=..., auxiliary_subnets=..., azure_active_directory=..., azure_api_version=..., client_connection_port=..., clients=..., cluster_certificate_thumbprints=..., cluster_code_version=..., cluster_id=..., cluster_state=..., cluster_upgrade_cadence=..., cluster_upgrade_mode=..., ddos_protection_plan_id=..., dns_name=..., enable_auto_os_upgrade=..., enable_http_gateway_exclusive_auth_mode=..., enable_ipv6=..., enable_service_public_ip=..., etag=..., fabric_settings=..., fqdn=..., http_gateway_connection_port=..., http_gateway_token_auth_connection_port=..., id=..., ip_tags=..., ipv4_address=..., ipv6_address=..., load_balancing_rules=..., location=..., name=..., network_security_rules=..., provisioning_state=..., public_ip_prefix_id=..., public_i_pv6_prefix_id=..., service_endpoints=..., sku=..., subnet_id=..., system_data=..., tags=..., type=..., upgrade_description=..., use_custom_vnet=..., zonal_resiliency=..., zonal_update_mode=...) -> None:
        ...
...
def get_managed_cluster(cluster_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetManagedClusterResult:
    
    ...

def get_managed_cluster_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetManagedClusterResult]:
