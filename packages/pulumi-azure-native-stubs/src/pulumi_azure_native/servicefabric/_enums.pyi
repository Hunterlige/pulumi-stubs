...
__all__ = ['Access', 'ClusterUpgradeCadence', 'ClusterUpgradeMode', 'Direction', 'DiskType', 'EvictionPolicyType', 'FailureAction', 'IPAddressType', 'ManagedClusterAddOnFeature', 'ManagedIdentityType', 'MoveCost', 'NsgProtocol', 'PartitionScheme', 'PrivateEndpointNetworkPolicies', 'PrivateIPAddressVersion', 'PrivateLinkServiceNetworkPolicies', 'ProbeProtocol', 'Protocol', 'PublicIPAddressVersion', 'RollingUpgradeMode', 'SecurityType', 'ServiceCorrelationScheme', 'ServiceKind', 'ServiceLoadMetricWeight', 'ServicePackageActivationMode', 'ServicePlacementPolicyType', 'ServiceScalingMechanismKind', 'ServiceScalingTriggerKind', 'SkuName', 'VmSetupAction', 'VmssExtensionSetupOrder', 'ZonalUpdateMode']
