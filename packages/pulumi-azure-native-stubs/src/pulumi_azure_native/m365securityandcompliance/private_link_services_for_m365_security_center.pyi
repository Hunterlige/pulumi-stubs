...
class PrivateLinkServicesForM365SecurityCenter(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: PrivateLinkServicesForM365SecurityCenterArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> PrivateLinkServicesForM365SecurityCenter:
