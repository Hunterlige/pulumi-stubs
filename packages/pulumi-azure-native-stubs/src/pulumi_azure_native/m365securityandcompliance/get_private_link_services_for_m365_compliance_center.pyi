...
class AwaitableGetPrivateLinkServicesForM365ComplianceCenterResult(
    GetPrivateLinkServicesForM365ComplianceCenterResult
):
    def __await__(self): ...

def get_private_link_services_for_m365_compliance_center(
    resource_group_name: Optional[_builtins.str] = ...,
    resource_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetPrivateLinkServicesForM365ComplianceCenterResult: ...
def get_private_link_services_for_m365_compliance_center_output(
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetPrivateLinkServicesForM365ComplianceCenterResult]: ...
