...
class AwaitableGetPrivateEndpointConnectionsAdtAPIResult(
    GetPrivateEndpointConnectionsAdtAPIResult
):
    def __await__(self): ...

def get_private_endpoint_connections_adt_api(
...
) -> pulumi.Output[GetPrivateEndpointConnectionsAdtAPIResult]: ...
