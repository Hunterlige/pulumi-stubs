...
class PublisherArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[PublisherPropertiesFormatArgs]] = ...,
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[PublisherPropertiesFormatArgs]]
    ): ...
    @_builtins.property
...
class Publisher(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[PublisherPropertiesFormatArgs, PublisherPropertiesFormatArgsDict]
            ]
        ] = ...,
        publisher_name: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.PublisherPropertiesFormatResponse]: ...
    @_builtins.property
