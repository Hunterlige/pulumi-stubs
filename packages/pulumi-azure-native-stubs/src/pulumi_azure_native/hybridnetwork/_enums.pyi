...
__all__ = ['ApplicationEnablement', 'ArtifactReplicationStrategy', 'ArtifactStoreType', 'ArtifactType', 'AzureArcKubernetesArtifactType', 'AzureCoreArtifactType', 'AzureOperatorNexusArtifactType', 'BackingResourcePublicNetworkAccess', 'ConfigurationGroupValueConfigurationType', 'ContainerizedNetworkFunctionNFVIType', 'DeviceType', 'DiskCreateOptionTypes', 'IPAllocationMethod', 'IPVersion', 'IdType', 'ManagedServiceIdentityType', 'NFVIType', 'NetworkFunctionConfigurationType', 'NetworkFunctionRoleConfigurationType', 'NetworkFunctionType', 'OperatingSystemTypes', 'PublisherScope', 'SkuDeploymentMode', 'SkuName', 'SkuType', 'TemplateType', 'Type', 'VMSwitchType', 'VirtualMachineSizeTypes', 'VirtualNetworkFunctionNFVIType']
