...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = [..., ..., 'ArmResourceDefinitionResourceElementTemplateArgs', ..., 'ArmTemplateArtifactProfileArgs', 'ArmTemplateArtifactProfileArgsDict', 'ArmTemplateMappingRuleProfileArgs', 'ArmTemplateMappingRuleProfileArgsDict', 'ArtifactManifestPropertiesFormatArgs', 'ArtifactManifestPropertiesFormatArgsDict', ..., ..., 'ArtifactStorePropertiesFormatArgs', 'ArtifactStorePropertiesFormatArgsDict', 'AzureArcK8sClusterNFVIDetailsArgs', 'AzureArcK8sClusterNFVIDetailsArgsDict', 'AzureArcKubernetesArtifactProfileArgs', 'AzureArcKubernetesArtifactProfileArgsDict', 'AzureArcKubernetesDeployMappingRuleProfileArgs', 'AzureArcKubernetesDeployMappingRuleProfileArgsDict', 'AzureArcKubernetesHelmApplicationArgs', 'AzureArcKubernetesHelmApplicationArgsDict', 'AzureArcKubernetesNetworkFunctionTemplateArgs', 'AzureArcKubernetesNetworkFunctionTemplateArgsDict', 'AzureCoreArmTemplateArtifactProfileArgs', 'AzureCoreArmTemplateArtifactProfileArgsDict', 'AzureCoreArmTemplateDeployMappingRuleProfileArgs', ..., 'AzureCoreNFVIDetailsArgs', 'AzureCoreNFVIDetailsArgsDict', 'AzureCoreNetworkFunctionArmTemplateApplicationArgs', ..., 'AzureCoreNetworkFunctionTemplateArgs', 'AzureCoreNetworkFunctionTemplateArgsDict', 'AzureCoreNetworkFunctionVhdApplicationArgs', 'AzureCoreNetworkFunctionVhdApplicationArgsDict', 'AzureCoreVhdImageArtifactProfileArgs', 'AzureCoreVhdImageArtifactProfileArgsDict', 'AzureCoreVhdImageDeployMappingRuleProfileArgs', 'AzureCoreVhdImageDeployMappingRuleProfileArgsDict', 'AzureOperatorNexusArmTemplateArtifactProfileArgs', ..., ..., ..., 'AzureOperatorNexusClusterNFVIDetailsArgs', 'AzureOperatorNexusClusterNFVIDetailsArgsDict', 'AzureOperatorNexusImageArtifactProfileArgs', 'AzureOperatorNexusImageArtifactProfileArgsDict', ..., ..., ..., ..., ..., ..., 'AzureOperatorNexusNetworkFunctionTemplateArgs', 'AzureOperatorNexusNetworkFunctionTemplateArgsDict', 'ConfigurationGroupSchemaPropertiesFormatArgs', 'ConfigurationGroupSchemaPropertiesFormatArgsDict', 'ConfigurationValueWithSecretsArgs', 'ConfigurationValueWithSecretsArgsDict', 'ConfigurationValueWithoutSecretsArgs', 'ConfigurationValueWithoutSecretsArgsDict', 'ContainerizedNetworkFunctionDefinitionVersionArgs', ..., 'CustomProfileArgs', 'CustomProfileArgsDict', 'DataDiskArgs', 'DataDiskArgsDict', 'DependsOnProfileArgs', 'DependsOnProfileArgsDict', 'HelmArtifactProfileArgs', 'HelmArtifactProfileArgsDict', 'HelmInstallOptionsArgs', 'HelmInstallOptionsArgsDict', 'HelmMappingRuleProfileOptionsArgs', 'HelmMappingRuleProfileOptionsArgsDict', 'HelmMappingRuleProfileArgs', 'HelmMappingRuleProfileArgsDict', 'HelmUpgradeOptionsArgs', 'HelmUpgradeOptionsArgsDict', 'ImageArtifactProfileArgs', 'ImageArtifactProfileArgsDict', 'ImageMappingRuleProfileArgs', 'ImageMappingRuleProfileArgsDict', 'ImageReferenceArgs', 'ImageReferenceArgsDict', 'LinuxConfigurationArgs', 'LinuxConfigurationArgsDict', 'ManagedResourceGroupConfigurationArgs', 'ManagedResourceGroupConfigurationArgsDict', 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'ManifestArtifactFormatArgs', 'ManifestArtifactFormatArgsDict', 'NSDArtifactProfileArgs', 'NSDArtifactProfileArgsDict', 'NetworkFunctionDefinitionGroupPropertiesFormatArgs', ..., ..., ..., 'NetworkFunctionRoleConfigurationArgs', 'NetworkFunctionRoleConfigurationArgsDict', 'NetworkFunctionTemplateArgs', 'NetworkFunctionTemplateArgsDict', 'NetworkFunctionValueWithSecretsArgs', 'NetworkFunctionValueWithSecretsArgsDict', 'NetworkFunctionValueWithoutSecretsArgs', 'NetworkFunctionValueWithoutSecretsArgsDict', 'NetworkInterfaceIPConfigurationArgs', 'NetworkInterfaceIPConfigurationArgsDict', 'NetworkInterfaceArgs', 'NetworkInterfaceArgsDict', 'NetworkServiceDesignGroupPropertiesFormatArgs', 'NetworkServiceDesignGroupPropertiesFormatArgsDict', 'NetworkServiceDesignVersionPropertiesFormatArgs', ..., 'NfviDetailsArgs', 'NfviDetailsArgsDict', 'OpenDeploymentResourceReferenceArgs', 'OpenDeploymentResourceReferenceArgsDict', 'OsDiskArgs', 'OsDiskArgsDict', 'OsProfileArgs', 'OsProfileArgsDict', 'PublisherPropertiesFormatArgs', 'PublisherPropertiesFormatArgsDict', 'ReferencedResourceArgs', 'ReferencedResourceArgsDict', 'SecretDeploymentResourceReferenceArgs', 'SecretDeploymentResourceReferenceArgsDict', 'SiteNetworkServicePropertiesFormatArgs', 'SiteNetworkServicePropertiesFormatArgsDict', 'SitePropertiesFormatArgs', 'SitePropertiesFormatArgsDict', 'SkuArgs', 'SkuArgsDict', 'SshConfigurationArgs', 'SshConfigurationArgsDict', 'SshPublicKeyArgs', 'SshPublicKeyArgsDict', 'StorageProfileArgs', 'StorageProfileArgsDict', 'VhdImageArtifactProfileArgs', 'VhdImageArtifactProfileArgsDict', 'VhdImageMappingRuleProfileArgs', 'VhdImageMappingRuleProfileArgsDict', 'VirtualHardDiskArgs', 'VirtualHardDiskArgsDict', ..., ...]
...
class ArmResourceDefinitionResourceElementTemplateDetailsArgs:
    def __init__(__self__, *, resource_element_type: pulumi.Input[_builtins.str], configuration: Optional[pulumi.Input[ArmResourceDefinitionResourceElementTemplateArgs]] = ..., depends_on_profile: Optional[pulumi.Input[DependsOnProfileArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def resource_element_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def configuration(self, value: Optional[pulumi.Input[ArmResourceDefinitionResourceElementTemplateArgs]]): # -> None:
        ...
    ...
    def depends_on_profile(self, value: Optional[pulumi.Input[DependsOnProfileArgs]]): # -> None:
        ...
...
class ArmResourceDefinitionResourceElementTemplateArgs:
    def __init__(__self__, *, artifact_profile: Optional[pulumi.Input[NSDArtifactProfileArgs]] = ..., parameter_values: Optional[pulumi.Input[_builtins.str]] = ..., template_type: Optional[pulumi.Input[Union[_builtins.str, TemplateType]]] = ...) -> None:
    ...
    def artifact_profile(self, value: Optional[pulumi.Input[NSDArtifactProfileArgs]]): # -> None:
        ...
    ...
    def parameter_values(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="templateType")
    def template_type(self) -> Optional[pulumi.Input[Union[_builtins.str, TemplateType]]]:
        
        ...
    
    @template_type.setter
    def template_type(self, value: Optional[pulumi.Input[Union[_builtins.str, TemplateType]]]): # -> None:
        ...
...
class ArmTemplateArtifactProfileArgs:
    def __init__(__self__, *, template_name: Optional[pulumi.Input[_builtins.str]] = ..., template_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ArmTemplateMappingRuleProfileArgs:
    def __init__(__self__, *, template_parameters: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def template_parameters(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ArtifactManifestPropertiesFormatArgs:
    def __init__(__self__, *, artifacts: Optional[pulumi.Input[Sequence[pulumi.Input[ManifestArtifactFormatArgs]]]] = ...) -> None:
    ...
    @artifacts.setter
    def artifacts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ManifestArtifactFormatArgs]]]]): # -> None:
        ...
...
class ArtifactStorePropertiesFormatArgs:
    def __init__(__self__, *, backing_resource_public_network_access: Optional[pulumi.Input[Union[_builtins.str, BackingResourcePublicNetworkAccess]]] = ..., managed_resource_group_configuration: Optional[pulumi.Input[ArtifactStorePropertiesFormatManagedResourceGroupConfigurationArgs]] = ..., replication_strategy: Optional[pulumi.Input[Union[_builtins.str, ArtifactReplicationStrategy]]] = ..., store_type: Optional[pulumi.Input[Union[_builtins.str, ArtifactStoreType]]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="backingResourcePublicNetworkAccess")
    def backing_resource_public_network_access(self) -> Optional[pulumi.Input[Union[_builtins.str, BackingResourcePublicNetworkAccess]]]:
        
        ...
    
    @backing_resource_public_network_access.setter
    def backing_resource_public_network_access(self, value: Optional[pulumi.Input[Union[_builtins.str, BackingResourcePublicNetworkAccess]]]): # -> None:
        ...
    ...
    def managed_resource_group_configuration(self, value: Optional[pulumi.Input[ArtifactStorePropertiesFormatManagedResourceGroupConfigurationArgs]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="replicationStrategy")
    def replication_strategy(self) -> Optional[pulumi.Input[Union[_builtins.str, ArtifactReplicationStrategy]]]:
        
        ...
    
    @replication_strategy.setter
    def replication_strategy(self, value: Optional[pulumi.Input[Union[_builtins.str, ArtifactReplicationStrategy]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="storeType")
    def store_type(self) -> Optional[pulumi.Input[Union[_builtins.str, ArtifactStoreType]]]:
        
        ...
    
    @store_type.setter
    def store_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ArtifactStoreType]]]): # -> None:
        ...
...
class AzureArcK8sClusterNFVIDetailsArgs:
    def __init__(__self__, *, nfvi_type: pulumi.Input[_builtins.str], custom_location_reference: Optional[pulumi.Input[ReferencedResourceArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @nfvi_type.setter
    def nfvi_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def custom_location_reference(self, value: Optional[pulumi.Input[ReferencedResourceArgs]]): # -> None:
        ...
...
class AzureArcKubernetesArtifactProfileArgs:
    def __init__(__self__, *, artifact_store: Optional[pulumi.Input[ReferencedResourceArgs]] = ..., helm_artifact_profile: Optional[pulumi.Input[HelmArtifactProfileArgs]] = ...) -> None:
    ...
    def artifact_store(self, value: Optional[pulumi.Input[ReferencedResourceArgs]]): # -> None:
        ...
    ...
    def helm_artifact_profile(self, value: Optional[pulumi.Input[HelmArtifactProfileArgs]]): # -> None:
        ...
...
class AzureArcKubernetesDeployMappingRuleProfileArgs:
    def __init__(__self__, *, application_enablement: Optional[pulumi.Input[Union[_builtins.str, ApplicationEnablement]]] = ..., helm_mapping_rule_profile: Optional[pulumi.Input[HelmMappingRuleProfileArgs]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="applicationEnablement")
    def application_enablement(self) -> Optional[pulumi.Input[Union[_builtins.str, ApplicationEnablement]]]:
        
        ...
    
    @application_enablement.setter
    def application_enablement(self, value: Optional[pulumi.Input[Union[_builtins.str, ApplicationEnablement]]]): # -> None:
        ...
    ...
    def helm_mapping_rule_profile(self, value: Optional[pulumi.Input[HelmMappingRuleProfileArgs]]): # -> None:
        ...
...
class AzureArcKubernetesHelmApplicationArgs:
    def __init__(__self__, *, artifact_type: pulumi.Input[_builtins.str], artifact_profile: Optional[pulumi.Input[AzureArcKubernetesArtifactProfileArgs]] = ..., depends_on_profile: Optional[pulumi.Input[DependsOnProfileArgs]] = ..., deploy_parameters_mapping_rule_profile: Optional[pulumi.Input[AzureArcKubernetesDeployMappingRuleProfileArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @artifact_profile.setter
    def artifact_profile(self, value: Optional[pulumi.Input[AzureArcKubernetesArtifactProfileArgs]]): # -> None:
        ...
    ...
    def deploy_parameters_mapping_rule_profile(self, value: Optional[pulumi.Input[AzureArcKubernetesDeployMappingRuleProfileArgs]]): # -> None:
        ...
...
class AzureArcKubernetesNetworkFunctionTemplateArgs:
    def __init__(__self__, *, nfvi_type: pulumi.Input[_builtins.str], network_function_applications: Optional[pulumi.Input[Sequence[pulumi.Input[AzureArcKubernetesHelmApplicationArgs]]]] = ...) -> None:
    ...
    def network_function_applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AzureArcKubernetesHelmApplicationArgs]]]]): # -> None:
        ...
...
class AzureCoreArmTemplateArtifactProfileArgs:
    def __init__(__self__, *, artifact_store: Optional[pulumi.Input[ReferencedResourceArgs]] = ..., template_artifact_profile: Optional[pulumi.Input[ArmTemplateArtifactProfileArgs]] = ...) -> None:
    ...
    def template_artifact_profile(self, value: Optional[pulumi.Input[ArmTemplateArtifactProfileArgs]]): # -> None:
        ...
...
class AzureCoreArmTemplateDeployMappingRuleProfileArgs:
    def __init__(__self__, *, application_enablement: Optional[pulumi.Input[Union[_builtins.str, ApplicationEnablement]]] = ..., template_mapping_rule_profile: Optional[pulumi.Input[ArmTemplateMappingRuleProfileArgs]] = ...) -> None:
    ...
    def template_mapping_rule_profile(self, value: Optional[pulumi.Input[ArmTemplateMappingRuleProfileArgs]]): # -> None:
        ...
...
class AzureCoreNFVIDetailsArgs:
    def __init__(__self__, *, nfvi_type: pulumi.Input[_builtins.str], location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AzureCoreNetworkFunctionArmTemplateApplicationArgs:
    def __init__(__self__, *, artifact_type: pulumi.Input[_builtins.str], artifact_profile: Optional[pulumi.Input[AzureCoreArmTemplateArtifactProfileArgs]] = ..., depends_on_profile: Optional[pulumi.Input[DependsOnProfileArgs]] = ..., deploy_parameters_mapping_rule_profile: Optional[pulumi.Input[AzureCoreArmTemplateDeployMappingRuleProfileArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @artifact_profile.setter
    def artifact_profile(self, value: Optional[pulumi.Input[AzureCoreArmTemplateArtifactProfileArgs]]): # -> None:
        ...
    ...
    @deploy_parameters_mapping_rule_profile.setter
    def deploy_parameters_mapping_rule_profile(self, value: Optional[pulumi.Input[AzureCoreArmTemplateDeployMappingRuleProfileArgs]]): # -> None:
        ...
...
class AzureCoreNetworkFunctionTemplateArgs:
    def __init__(__self__, *, nfvi_type: pulumi.Input[_builtins.str], network_function_applications: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AzureCoreNetworkFunctionArmTemplateApplicationArgs, AzureCoreNetworkFunctionVhdApplicationArgs]]]]] = ...) -> None:
    ...
    @network_function_applications.setter
    def network_function_applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AzureCoreNetworkFunctionArmTemplateApplicationArgs, AzureCoreNetworkFunctionVhdApplicationArgs]]]]]): # -> None:
        ...
...
class AzureCoreNetworkFunctionVhdApplicationArgs:
    def __init__(__self__, *, artifact_type: pulumi.Input[_builtins.str], artifact_profile: Optional[pulumi.Input[AzureCoreVhdImageArtifactProfileArgs]] = ..., depends_on_profile: Optional[pulumi.Input[DependsOnProfileArgs]] = ..., deploy_parameters_mapping_rule_profile: Optional[pulumi.Input[AzureCoreVhdImageDeployMappingRuleProfileArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @artifact_profile.setter
    def artifact_profile(self, value: Optional[pulumi.Input[AzureCoreVhdImageArtifactProfileArgs]]): # -> None:
        ...
    ...
    @deploy_parameters_mapping_rule_profile.setter
    def deploy_parameters_mapping_rule_profile(self, value: Optional[pulumi.Input[AzureCoreVhdImageDeployMappingRuleProfileArgs]]): # -> None:
        ...
...
class AzureCoreVhdImageArtifactProfileArgs:
    def __init__(__self__, *, artifact_store: Optional[pulumi.Input[ReferencedResourceArgs]] = ..., vhd_artifact_profile: Optional[pulumi.Input[VhdImageArtifactProfileArgs]] = ...) -> None:
    ...
    def vhd_artifact_profile(self, value: Optional[pulumi.Input[VhdImageArtifactProfileArgs]]): # -> None:
        ...
...
class AzureCoreVhdImageDeployMappingRuleProfileArgs:
    def __init__(__self__, *, application_enablement: Optional[pulumi.Input[Union[_builtins.str, ApplicationEnablement]]] = ..., vhd_image_mapping_rule_profile: Optional[pulumi.Input[VhdImageMappingRuleProfileArgs]] = ...) -> None:
    ...
    def vhd_image_mapping_rule_profile(self, value: Optional[pulumi.Input[VhdImageMappingRuleProfileArgs]]): # -> None:
        ...
...
class AzureOperatorNexusImageArtifactProfileArgs:
    def __init__(__self__, *, artifact_store: Optional[pulumi.Input[ReferencedResourceArgs]] = ..., image_artifact_profile: Optional[pulumi.Input[ImageArtifactProfileArgs]] = ...) -> None:
    ...
    def image_artifact_profile(self, value: Optional[pulumi.Input[ImageArtifactProfileArgs]]): # -> None:
        ...
...
class AzureOperatorNexusImageDeployMappingRuleProfileArgs:
    def __init__(__self__, *, application_enablement: Optional[pulumi.Input[Union[_builtins.str, ApplicationEnablement]]] = ..., image_mapping_rule_profile: Optional[pulumi.Input[ImageMappingRuleProfileArgs]] = ...) -> None:
    ...
    def image_mapping_rule_profile(self, value: Optional[pulumi.Input[ImageMappingRuleProfileArgs]]): # -> None:
        ...
...
class AzureOperatorNexusNetworkFunctionArmTemplateApplicationArgs:
    def __init__(__self__, *, artifact_type: pulumi.Input[_builtins.str], artifact_profile: Optional[pulumi.Input[AzureOperatorNexusArmTemplateArtifactProfileArgs]] = ..., depends_on_profile: Optional[pulumi.Input[DependsOnProfileArgs]] = ..., deploy_parameters_mapping_rule_profile: Optional[pulumi.Input[AzureOperatorNexusArmTemplateDeployMappingRuleProfileArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @artifact_profile.setter
    def artifact_profile(self, value: Optional[pulumi.Input[AzureOperatorNexusArmTemplateArtifactProfileArgs]]): # -> None:
        ...
    ...
    @deploy_parameters_mapping_rule_profile.setter
    def deploy_parameters_mapping_rule_profile(self, value: Optional[pulumi.Input[AzureOperatorNexusArmTemplateDeployMappingRuleProfileArgs]]): # -> None:
        ...
...
class AzureOperatorNexusNetworkFunctionImageApplicationArgs:
    def __init__(__self__, *, artifact_type: pulumi.Input[_builtins.str], artifact_profile: Optional[pulumi.Input[AzureOperatorNexusImageArtifactProfileArgs]] = ..., depends_on_profile: Optional[pulumi.Input[DependsOnProfileArgs]] = ..., deploy_parameters_mapping_rule_profile: Optional[pulumi.Input[AzureOperatorNexusImageDeployMappingRuleProfileArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @artifact_profile.setter
    def artifact_profile(self, value: Optional[pulumi.Input[AzureOperatorNexusImageArtifactProfileArgs]]): # -> None:
        ...
    ...
    @deploy_parameters_mapping_rule_profile.setter
    def deploy_parameters_mapping_rule_profile(self, value: Optional[pulumi.Input[AzureOperatorNexusImageDeployMappingRuleProfileArgs]]): # -> None:
        ...
...
class AzureOperatorNexusNetworkFunctionTemplateArgs:
    def __init__(__self__, *, nfvi_type: pulumi.Input[_builtins.str], network_function_applications: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AzureOperatorNexusNetworkFunctionArmTemplateApplicationArgs, AzureOperatorNexusNetworkFunctionImageApplicationArgs]]]]] = ...) -> None:
    ...
    @network_function_applications.setter
    def network_function_applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AzureOperatorNexusNetworkFunctionArmTemplateApplicationArgs, AzureOperatorNexusNetworkFunctionImageApplicationArgs]]]]]): # -> None:
        ...
...
class ConfigurationGroupSchemaPropertiesFormatArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., schema_definition: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ConfigurationValueWithSecretsArgs:
    def __init__(__self__, *, configuration_type: pulumi.Input[_builtins.str], configuration_group_schema_resource_reference: Optional[pulumi.Input[Union[OpenDeploymentResourceReferenceArgs, SecretDeploymentResourceReferenceArgs]]] = ..., secret_configuration_value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def configuration_group_schema_resource_reference(self, value: Optional[pulumi.Input[Union[OpenDeploymentResourceReferenceArgs, SecretDeploymentResourceReferenceArgs]]]): # -> None:
        ...
    ...
    def secret_configuration_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConfigurationValueWithoutSecretsArgs:
    def __init__(__self__, *, configuration_type: pulumi.Input[_builtins.str], configuration_group_schema_resource_reference: Optional[pulumi.Input[Union[OpenDeploymentResourceReferenceArgs, SecretDeploymentResourceReferenceArgs]]] = ..., configuration_value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def configuration_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ContainerizedNetworkFunctionDefinitionVersionArgs:
    def __init__(__self__, *, network_function_type: pulumi.Input[_builtins.str], deploy_parameters: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., network_function_template: Optional[pulumi.Input[AzureArcKubernetesNetworkFunctionTemplateArgs]] = ...) -> None:
    ...
    def network_function_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def deploy_parameters(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def network_function_template(self, value: Optional[pulumi.Input[AzureArcKubernetesNetworkFunctionTemplateArgs]]): # -> None:
        ...
...
class CustomProfileArgs:
    def __init__(__self__, *, metadata_configuration_path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def metadata_configuration_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class DataDiskArgs:
    def __init__(__self__, *, create_option: Optional[pulumi.Input[Union[_builtins.str, DiskCreateOptionTypes]]] = ..., disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="createOption")
    def create_option(self) -> Optional[pulumi.Input[Union[_builtins.str, DiskCreateOptionTypes]]]:
        
        ...
    
    @create_option.setter
    def create_option(self, value: Optional[pulumi.Input[Union[_builtins.str, DiskCreateOptionTypes]]]): # -> None:
        ...
...
class DependsOnProfileArgs:
    def __init__(__self__, *, install_depends_on: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., uninstall_depends_on: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., update_depends_on: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="installDependsOn")
    def install_depends_on(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @install_depends_on.setter
    def install_depends_on(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="uninstallDependsOn")
    def uninstall_depends_on(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @uninstall_depends_on.setter
    def uninstall_depends_on(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="updateDependsOn")
    def update_depends_on(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @update_depends_on.setter
    def update_depends_on(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class HelmArtifactProfileArgs:
    def __init__(__self__, *, helm_package_name: Optional[pulumi.Input[_builtins.str]] = ..., helm_package_version_range: Optional[pulumi.Input[_builtins.str]] = ..., image_pull_secrets_values_paths: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., registry_values_paths: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def helm_package_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def helm_package_version_range(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="imagePullSecretsValuesPaths")
    def image_pull_secrets_values_paths(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @image_pull_secrets_values_paths.setter
    def image_pull_secrets_values_paths(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="registryValuesPaths")
    def registry_values_paths(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @registry_values_paths.setter
    def registry_values_paths(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class HelmInstallOptionsArgs:
    def __init__(__self__, *, atomic: Optional[pulumi.Input[_builtins.str]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ..., wait: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @atomic.setter
    def atomic(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @wait.setter
    def wait(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class HelmMappingRuleProfileOptionsArgs:
    def __init__(__self__, *, install_options: Optional[pulumi.Input[HelmInstallOptionsArgs]] = ..., upgrade_options: Optional[pulumi.Input[HelmUpgradeOptionsArgs]] = ...) -> None:
    ...
    def install_options(self, value: Optional[pulumi.Input[HelmInstallOptionsArgs]]): # -> None:
        ...
    ...
    def upgrade_options(self, value: Optional[pulumi.Input[HelmUpgradeOptionsArgs]]): # -> None:
        ...
...
class HelmMappingRuleProfileArgs:
    def __init__(__self__, *, helm_package_version: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[HelmMappingRuleProfileOptionsArgs]] = ..., release_name: Optional[pulumi.Input[_builtins.str]] = ..., release_namespace: Optional[pulumi.Input[_builtins.str]] = ..., values: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def helm_package_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @options.setter
    def options(self, value: Optional[pulumi.Input[HelmMappingRuleProfileOptionsArgs]]): # -> None:
        ...
    ...
    @release_name.setter
    def release_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def release_namespace(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @values.setter
    def values(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ImageArtifactProfileArgs:
    def __init__(__self__, *, image_name: Optional[pulumi.Input[_builtins.str]] = ..., image_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ImageMappingRuleProfileArgs:
    def __init__(__self__, *, user_configuration: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def user_configuration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ImageReferenceArgs:
    def __init__(__self__, *, exact_version: Optional[pulumi.Input[_builtins.str]] = ..., offer: Optional[pulumi.Input[_builtins.str]] = ..., publisher: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def exact_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LinuxConfigurationArgs:
    def __init__(__self__, *, ssh: Optional[pulumi.Input[SshConfigurationArgs]] = ...) -> None:
...
class ManifestArtifactFormatArgs:
    def __init__(__self__, *, artifact_name: Optional[pulumi.Input[_builtins.str]] = ..., artifact_type: Optional[pulumi.Input[Union[_builtins.str, ArtifactType]]] = ..., artifact_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @_builtins.property
    @pulumi.getter(name="artifactType")
    def artifact_type(self) -> Optional[pulumi.Input[Union[_builtins.str, ArtifactType]]]:
        
        ...
    
    @artifact_type.setter
    def artifact_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ArtifactType]]]): # -> None:
        ...
    ...
    def artifact_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NSDArtifactProfileArgs:
    def __init__(__self__, *, artifact_name: Optional[pulumi.Input[_builtins.str]] = ..., artifact_store_reference: Optional[pulumi.Input[ReferencedResourceArgs]] = ..., artifact_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def artifact_store_reference(self, value: Optional[pulumi.Input[ReferencedResourceArgs]]): # -> None:
        ...
...
class NetworkFunctionRoleConfigurationArgs:
    def __init__(__self__, *, custom_profile: Optional[pulumi.Input[CustomProfileArgs]] = ..., network_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkInterfaceArgs]]]] = ..., os_profile: Optional[pulumi.Input[OsProfileArgs]] = ..., role_name: Optional[pulumi.Input[_builtins.str]] = ..., role_type: Optional[pulumi.Input[Union[_builtins.str, NetworkFunctionRoleConfigurationType]]] = ..., storage_profile: Optional[pulumi.Input[StorageProfileArgs]] = ..., user_data_parameters: Optional[Any] = ..., user_data_template: Optional[Any] = ..., virtual_machine_size: Optional[pulumi.Input[Union[_builtins.str, VirtualMachineSizeTypes]]] = ...) -> None:
    ...
    def custom_profile(self, value: Optional[pulumi.Input[CustomProfileArgs]]): # -> None:
        ...
    ...
    def network_interfaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkInterfaceArgs]]]]): # -> None:
        ...
    ...
    def role_type(self) -> Optional[pulumi.Input[Union[_builtins.str, NetworkFunctionRoleConfigurationType]]]:
        
        ...
    
    @role_type.setter
    def role_type(self, value: Optional[pulumi.Input[Union[_builtins.str, NetworkFunctionRoleConfigurationType]]]): # -> None:
        ...
    ...
    def user_data_parameters(self, value: Optional[Any]): # -> None:
        ...
    ...
    def user_data_template(self, value: Optional[Any]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="virtualMachineSize")
    def virtual_machine_size(self) -> Optional[pulumi.Input[Union[_builtins.str, VirtualMachineSizeTypes]]]:
        
        ...
    
    @virtual_machine_size.setter
    def virtual_machine_size(self, value: Optional[pulumi.Input[Union[_builtins.str, VirtualMachineSizeTypes]]]): # -> None:
        ...
...
class NetworkFunctionTemplateArgs:
    def __init__(__self__, *, network_function_role_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkFunctionRoleConfigurationArgs]]]] = ...) -> None:
    ...
    def network_function_role_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkFunctionRoleConfigurationArgs]]]]): # -> None:
        ...
...
class NetworkFunctionValueWithSecretsArgs:
    def __init__(__self__, *, configuration_type: pulumi.Input[_builtins.str], allow_software_update: Optional[pulumi.Input[_builtins.bool]] = ..., network_function_definition_group_name: Optional[pulumi.Input[_builtins.str]] = ..., network_function_definition_offering_location: Optional[pulumi.Input[_builtins.str]] = ..., network_function_definition_version: Optional[pulumi.Input[_builtins.str]] = ..., network_function_definition_version_resource_reference: Optional[pulumi.Input[Union[OpenDeploymentResourceReferenceArgs, SecretDeploymentResourceReferenceArgs]]] = ..., nfvi_id: Optional[pulumi.Input[_builtins.str]] = ..., nfvi_type: Optional[pulumi.Input[Union[_builtins.str, NFVIType]]] = ..., publisher_name: Optional[pulumi.Input[_builtins.str]] = ..., publisher_scope: Optional[pulumi.Input[Union[_builtins.str, PublisherScope]]] = ..., role_override_values: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., secret_deployment_values: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allow_software_update(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def network_function_definition_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="networkFunctionDefinitionOfferingLocation")
    def network_function_definition_offering_location(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @network_function_definition_offering_location.setter
    def network_function_definition_offering_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="networkFunctionDefinitionVersion")
    def network_function_definition_version(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @network_function_definition_version.setter
    def network_function_definition_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def network_function_definition_version_resource_reference(self, value: Optional[pulumi.Input[Union[OpenDeploymentResourceReferenceArgs, SecretDeploymentResourceReferenceArgs]]]): # -> None:
        ...
    ...
    @nfvi_id.setter
    def nfvi_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @nfvi_type.setter
    def nfvi_type(self, value: Optional[pulumi.Input[Union[_builtins.str, NFVIType]]]): # -> None:
        ...
    ...
    def publisher_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="publisherScope")
    def publisher_scope(self) -> Optional[pulumi.Input[Union[_builtins.str, PublisherScope]]]:
        
        ...
    
    @publisher_scope.setter
    def publisher_scope(self, value: Optional[pulumi.Input[Union[_builtins.str, PublisherScope]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="roleOverrideValues")
    def role_override_values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @role_override_values.setter
    def role_override_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def secret_deployment_values(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NetworkFunctionValueWithoutSecretsArgs:
    def __init__(__self__, *, configuration_type: pulumi.Input[_builtins.str], allow_software_update: Optional[pulumi.Input[_builtins.bool]] = ..., deployment_values: Optional[pulumi.Input[_builtins.str]] = ..., network_function_definition_group_name: Optional[pulumi.Input[_builtins.str]] = ..., network_function_definition_offering_location: Optional[pulumi.Input[_builtins.str]] = ..., network_function_definition_version: Optional[pulumi.Input[_builtins.str]] = ..., network_function_definition_version_resource_reference: Optional[pulumi.Input[Union[OpenDeploymentResourceReferenceArgs, SecretDeploymentResourceReferenceArgs]]] = ..., nfvi_id: Optional[pulumi.Input[_builtins.str]] = ..., nfvi_type: Optional[pulumi.Input[Union[_builtins.str, NFVIType]]] = ..., publisher_name: Optional[pulumi.Input[_builtins.str]] = ..., publisher_scope: Optional[pulumi.Input[Union[_builtins.str, PublisherScope]]] = ..., role_override_values: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def deployment_values(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NetworkInterfaceIPConfigurationArgs:
    def __init__(__self__, *, dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., gateway: Optional[pulumi.Input[_builtins.str]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., ip_allocation_method: Optional[pulumi.Input[Union[_builtins.str, IPAllocationMethod]]] = ..., ip_version: Optional[pulumi.Input[Union[_builtins.str, IPVersion]]] = ..., subnet: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ip_allocation_method(self) -> Optional[pulumi.Input[Union[_builtins.str, IPAllocationMethod]]]:
        
        ...
    
    @ip_allocation_method.setter
    def ip_allocation_method(self, value: Optional[pulumi.Input[Union[_builtins.str, IPAllocationMethod]]]): # -> None:
        ...
    ...
    @ip_version.setter
    def ip_version(self, value: Optional[pulumi.Input[Union[_builtins.str, IPVersion]]]): # -> None:
        ...
...
class NetworkInterfaceArgs:
    def __init__(__self__, *, ip_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkInterfaceIPConfigurationArgs]]]] = ..., mac_address: Optional[pulumi.Input[_builtins.str]] = ..., network_interface_name: Optional[pulumi.Input[_builtins.str]] = ..., vm_switch_type: Optional[pulumi.Input[Union[_builtins.str, VMSwitchType]]] = ...) -> None:
    ...
    def ip_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkInterfaceIPConfigurationArgs]]]]): # -> None:
        ...
    ...
    def vm_switch_type(self) -> Optional[pulumi.Input[Union[_builtins.str, VMSwitchType]]]:
        
        ...
    
    @vm_switch_type.setter
    def vm_switch_type(self, value: Optional[pulumi.Input[Union[_builtins.str, VMSwitchType]]]): # -> None:
        ...
...
class NetworkServiceDesignVersionPropertiesFormatArgs:
    def __init__(__self__, *, configuration_group_schema_references: Optional[pulumi.Input[Mapping[str, pulumi.Input[ReferencedResourceArgs]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., nfvis_from_site: Optional[pulumi.Input[Mapping[str, pulumi.Input[NfviDetailsArgs]]]] = ..., resource_element_templates: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ArmResourceDefinitionResourceElementTemplateDetailsArgs, NetworkFunctionDefinitionResourceElementTemplateDetailsArgs]]]]] = ...) -> None:
    ...
    def configuration_group_schema_references(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[ReferencedResourceArgs]]]]): # -> None:
        ...
    ...
    def nfvis_from_site(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[NfviDetailsArgs]]]]): # -> None:
        ...
    ...
    def resource_element_templates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ArmResourceDefinitionResourceElementTemplateDetailsArgs, NetworkFunctionDefinitionResourceElementTemplateDetailsArgs]]]]]): # -> None:
        ...
...
class OpenDeploymentResourceReferenceArgs:
    def __init__(__self__, *, id_type: pulumi.Input[_builtins.str], id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @id_type.setter
    def id_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
@pulumi.input_type
class OsDiskArgs:
    def __init__(__self__, *, disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., os_type: Optional[pulumi.Input[Union[_builtins.str, OperatingSystemTypes]]] = ..., vhd: Optional[pulumi.Input[VirtualHardDiskArgs]] = ...) -> None:
...
@pulumi.input_type
class OsProfileArgs:
    def __init__(__self__, *, admin_username: Optional[pulumi.Input[_builtins.str]] = ..., custom_data: Optional[pulumi.Input[_builtins.str]] = ..., custom_data_required: Optional[pulumi.Input[_builtins.bool]] = ..., linux_configuration: Optional[pulumi.Input[LinuxConfigurationArgs]] = ...) -> None:
    ...
    def custom_data_required(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class PublisherPropertiesFormatArgs:
    def __init__(__self__, *, scope: Optional[pulumi.Input[Union[_builtins.str, PublisherScope]]] = ...) -> None:
    ...
    @scope.setter
    def scope(self, value: Optional[pulumi.Input[Union[_builtins.str, PublisherScope]]]): # -> None:
        ...
...
class SiteNetworkServicePropertiesFormatArgs:
    def __init__(__self__, *, desired_state_configuration_group_value_references: Optional[pulumi.Input[Mapping[str, pulumi.Input[ReferencedResourceArgs]]]] = ..., managed_resource_group_configuration: Optional[pulumi.Input[ManagedResourceGroupConfigurationArgs]] = ..., network_service_design_version_resource_reference: Optional[pulumi.Input[Union[OpenDeploymentResourceReferenceArgs, SecretDeploymentResourceReferenceArgs]]] = ..., site_reference: Optional[pulumi.Input[ReferencedResourceArgs]] = ...) -> None:
    ...
    def desired_state_configuration_group_value_references(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[ReferencedResourceArgs]]]]): # -> None:
        ...
    ...
    def network_service_design_version_resource_reference(self, value: Optional[pulumi.Input[Union[OpenDeploymentResourceReferenceArgs, SecretDeploymentResourceReferenceArgs]]]): # -> None:
        ...
    ...
    def site_reference(self, value: Optional[pulumi.Input[ReferencedResourceArgs]]): # -> None:
        ...
...
class SitePropertiesFormatArgs:
    def __init__(__self__, *, nfvis: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AzureArcK8sClusterNFVIDetailsArgs, AzureCoreNFVIDetailsArgs, AzureOperatorNexusClusterNFVIDetailsArgs]]]]] = ...) -> None:
    ...
    @nfvis.setter
    def nfvis(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AzureArcK8sClusterNFVIDetailsArgs, AzureCoreNFVIDetailsArgs, AzureOperatorNexusClusterNFVIDetailsArgs]]]]]): # -> None:
        ...
...
class StorageProfileArgs:
    def __init__(__self__, *, data_disks: Optional[pulumi.Input[Sequence[pulumi.Input[DataDiskArgs]]]] = ..., image_reference: Optional[pulumi.Input[ImageReferenceArgs]] = ..., os_disk: Optional[pulumi.Input[OsDiskArgs]] = ...) -> None:
...
class VhdImageArtifactProfileArgs:
    def __init__(__self__, *, vhd_name: Optional[pulumi.Input[_builtins.str]] = ..., vhd_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @vhd_name.setter
    def vhd_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @vhd_version.setter
    def vhd_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VirtualNetworkFunctionNetworkFunctionDefinitionVersionArgs:
    def __init__(__self__, *, network_function_type: pulumi.Input[_builtins.str], deploy_parameters: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., network_function_template: Optional[pulumi.Input[Union[AzureCoreNetworkFunctionTemplateArgs, AzureOperatorNexusNetworkFunctionTemplateArgs]]] = ...) -> None:
    ...
    @network_function_template.setter
    def network_function_template(self, value: Optional[pulumi.Input[Union[AzureCoreNetworkFunctionTemplateArgs, AzureOperatorNexusNetworkFunctionTemplateArgs]]]): # -> None:
        ...
