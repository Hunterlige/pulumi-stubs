...
class NetworkServiceDesignVersionArgs:
    def __init__(
        ...
        *,
        ...
        network_service_design_version_name: Optional[
            pulumi.Input[_builtins.str]
        ] = ...,
        properties: Optional[
            pulumi.Input[NetworkServiceDesignVersionPropertiesFormatArgs]
        ] = ...,
    ...
    def network_service_design_version_name(
        self,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[NetworkServiceDesignVersionPropertiesFormatArgs]]: ...
    @properties.setter
    def properties(
        self,
        value: Optional[pulumi.Input[NetworkServiceDesignVersionPropertiesFormatArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class NetworkServiceDesignVersion(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.NetworkServiceDesignVersionPropertiesFormatResponse]: ...
    @_builtins.property
