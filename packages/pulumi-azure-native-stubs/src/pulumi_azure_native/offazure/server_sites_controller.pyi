...
class ServerSitesControllerArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], agent_details: Optional[pulumi.Input[SiteAgentPropertiesArgs]] = ..., appliance_name: Optional[pulumi.Input[_builtins.str]] = ..., discovery_solution_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., service_principal_identity_details: Optional[pulumi.Input[SiteSpnPropertiesArgs]] = ..., site_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ServerSitesController(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., agent_details: Optional[pulumi.Input[Union[SiteAgentPropertiesArgs, SiteAgentPropertiesArgsDict]]] = ..., appliance_name: Optional[pulumi.Input[_builtins.str]] = ..., discovery_solution_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., service_principal_identity_details: Optional[pulumi.Input[Union[SiteSpnPropertiesArgs, SiteSpnPropertiesArgsDict]]] = ..., site_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ServerSitesControllerArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ServerSitesController:
