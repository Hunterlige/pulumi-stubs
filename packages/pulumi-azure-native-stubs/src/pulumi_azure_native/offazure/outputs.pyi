...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['HealthErrorDetailsResponse', 'PrivateEndpointConnectionPropertiesResponse', 'PrivateEndpointConnectionResponse', 'PrivateLinkServiceConnectionStateResponse', 'ResourceIdResponse', 'SiteAgentPropertiesResponse', 'SiteAppliancePropertiesResponse', 'SiteHealthSummaryResponse', 'SitePropertiesResponse', 'SiteSpnPropertiesResponse', 'SystemDataResponse']
@pulumi.output_type
class HealthErrorDetailsResponse(dict):
    ...
    def __init__(__self__, *, appliance_name: _builtins.str, code: _builtins.str, discovery_scope: _builtins.str, id: _builtins.float, message: _builtins.str, message_parameters: Mapping[str, _builtins.str], possible_causes: _builtins.str, recommended_action: _builtins.str, run_as_account_id: _builtins.str, severity: _builtins.str, source: _builtins.str, summary_message: _builtins.str, updated_time_stamp: _builtins.str) -> None:
...
class PrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *, group_ids: Sequence[_builtins.str], id: _builtins.str, name: _builtins.str, private_endpoint: outputs.ResourceIdResponse, provisioning_state: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str, private_link_service_connection_state: Optional[outputs.PrivateLinkServiceConnectionStateResponse] = ...) -> None:
...
class SiteAgentPropertiesResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, last_heart_beat_utc: _builtins.str, version: _builtins.str, key_vault_id: Optional[_builtins.str] = ..., key_vault_uri: Optional[_builtins.str] = ...) -> None:
...
class SiteAppliancePropertiesResponse(dict):
    ...
    def __init__(__self__, *, agent_details: Optional[outputs.SiteAgentPropertiesResponse] = ..., appliance_name: Optional[_builtins.str] = ..., service_principal_identity_details: Optional[outputs.SiteSpnPropertiesResponse] = ...) -> None:
...
class SiteHealthSummaryResponse(dict):
    ...
    def __init__(__self__, *, affected_resource_type: _builtins.str, appliance_name: _builtins.str, error_code: _builtins.str, error_id: _builtins.float, error_message: _builtins.str, remediation_guidance: _builtins.str, severity: _builtins.str, summary_message: _builtins.str, affected_objects_count: Optional[_builtins.float] = ..., affected_resources: Optional[Sequence[_builtins.str]] = ..., fabric_layout_update_sources: Optional[Sequence[_builtins.str]] = ..., hit_count: Optional[_builtins.float] = ...) -> None:
...
class SitePropertiesResponse(dict):
    ...
    def __init__(__self__, *, service_endpoint: _builtins.str, agent_details: Optional[outputs.SiteAgentPropertiesResponse] = ..., appliance_name: Optional[_builtins.str] = ..., discovery_solution_id: Optional[_builtins.str] = ..., service_principal_identity_details: Optional[outputs.SiteSpnPropertiesResponse] = ...) -> None:
...
class SiteSpnPropertiesResponse(dict):
    ...
    def __init__(__self__, *, aad_authority: Optional[_builtins.str] = ..., application_id: Optional[_builtins.str] = ..., audience: Optional[_builtins.str] = ..., object_id: Optional[_builtins.str] = ..., raw_cert_data: Optional[_builtins.str] = ..., tenant_id: Optional[_builtins.str] = ...) -> None:
