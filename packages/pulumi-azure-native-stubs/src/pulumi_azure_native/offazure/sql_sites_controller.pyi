...
class SqlSitesControllerArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], site_name: pulumi.Input[_builtins.str], discovery_scenario: Optional[pulumi.Input[Union[_builtins.str, SqlSitePropertiesDiscoveryScenario]]] = ..., site_appliance_properties_collection: Optional[pulumi.Input[Sequence[pulumi.Input[SiteAppliancePropertiesArgs]]]] = ..., sql_site_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def discovery_scenario(self, value: Optional[pulumi.Input[Union[_builtins.str, SqlSitePropertiesDiscoveryScenario]]]): # -> None:
        ...
    ...
    def sql_site_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SqlSitesController(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., discovery_scenario: Optional[pulumi.Input[Union[_builtins.str, SqlSitePropertiesDiscoveryScenario]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., site_appliance_properties_collection: Optional[pulumi.Input[Sequence[pulumi.Input[Union[SiteAppliancePropertiesArgs, SiteAppliancePropertiesArgsDict]]]]] = ..., site_name: Optional[pulumi.Input[_builtins.str]] = ..., sql_site_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: SqlSitesControllerArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SqlSitesController:
