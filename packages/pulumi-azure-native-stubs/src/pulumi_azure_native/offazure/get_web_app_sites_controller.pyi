...
class GetWebAppSitesControllerResult:
    ...
    def site_appliance_properties_collection(
        self,
    ) -> Optional[Sequence[outputs.SiteAppliancePropertiesResponse]]: ...
    @_builtins.property
...
) -> pulumi.Output[GetWebAppSitesControllerResult]: ...
