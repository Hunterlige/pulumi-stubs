...
class InventoryItemArgs:
    def __init__(__self__, *, inventory_type: pulumi.Input[Union[_builtins.str, InventoryType]], resource_group_name: pulumi.Input[_builtins.str], vmm_server_name: pulumi.Input[_builtins.str], inventory_item_name: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def vmm_server_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
