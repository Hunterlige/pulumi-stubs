...
class GetVirtualMachineInstanceResult:
    ...
    def __init__(__self__, availability_sets=..., azure_api_version=..., extended_location=..., hardware_profile=..., id=..., infrastructure_profile=..., name=..., network_profile=..., os_profile=..., power_state=..., provisioning_state=..., storage_profile=..., system_data=..., type=...) -> None:
        ...
