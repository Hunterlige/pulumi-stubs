...
class GuestAgentArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], virtual_machine_name: pulumi.Input[_builtins.str], credentials: Optional[pulumi.Input[GuestCredentialArgs]] = ..., guest_agent_name: Optional[pulumi.Input[_builtins.str]] = ..., http_proxy_config: Optional[pulumi.Input[HttpProxyConfigurationArgs]] = ..., provisioning_action: Optional[pulumi.Input[Union[_builtins.str, ProvisioningAction]]] = ...) -> None:
    ...
    def guest_agent_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GuestAgent(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., credentials: Optional[pulumi.Input[Union[GuestCredentialArgs, GuestCredentialArgsDict]]] = ..., guest_agent_name: Optional[pulumi.Input[_builtins.str]] = ..., http_proxy_config: Optional[pulumi.Input[Union[HttpProxyConfigurationArgs, HttpProxyConfigurationArgsDict]]] = ..., provisioning_action: Optional[pulumi.Input[Union[_builtins.str, ProvisioningAction]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., virtual_machine_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
