...
class VirtualMachineInstanceArgs:
    def __init__(__self__, *, extended_location: pulumi.Input[ExtendedLocationArgs], resource_uri: pulumi.Input[_builtins.str], availability_sets: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualMachineInstancePropertiesAvailabilitySetsArgs]]]] = ..., hardware_profile: Optional[pulumi.Input[HardwareProfileArgs]] = ..., infrastructure_profile: Optional[pulumi.Input[InfrastructureProfileArgs]] = ..., network_profile: Optional[pulumi.Input[NetworkProfileArgs]] = ..., os_profile: Optional[pulumi.Input[OsProfileForVMInstanceArgs]] = ..., storage_profile: Optional[pulumi.Input[StorageProfileArgs]] = ...) -> None:
    ...
    def availability_sets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualMachineInstancePropertiesAvailabilitySetsArgs]]]]): # -> None:
        ...
...
class VirtualMachineInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., availability_sets: Optional[pulumi.Input[Sequence[pulumi.Input[Union[VirtualMachineInstancePropertiesAvailabilitySetsArgs, VirtualMachineInstancePropertiesAvailabilitySetsArgsDict]]]]] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationArgs, ExtendedLocationArgsDict]]] = ..., hardware_profile: Optional[pulumi.Input[Union[HardwareProfileArgs, HardwareProfileArgsDict]]] = ..., infrastructure_profile: Optional[pulumi.Input[Union[InfrastructureProfileArgs, InfrastructureProfileArgsDict]]] = ..., network_profile: Optional[pulumi.Input[Union[NetworkProfileArgs, NetworkProfileArgsDict]]] = ..., os_profile: Optional[pulumi.Input[Union[OsProfileForVMInstanceArgs, OsProfileForVMInstanceArgsDict]]] = ..., resource_uri: Optional[pulumi.Input[_builtins.str]] = ..., storage_profile: Optional[pulumi.Input[Union[StorageProfileArgs, StorageProfileArgsDict]]] = ..., __props__=...) -> None:
