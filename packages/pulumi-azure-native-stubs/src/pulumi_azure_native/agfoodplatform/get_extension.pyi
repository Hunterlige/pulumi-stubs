...
class GetExtensionResult:
    ...
    def __init__(__self__, additional_api_properties=..., azure_api_version=..., e_tag=..., extension_api_docs_link=..., extension_auth_link=..., extension_category=..., extension_id=..., id=..., installed_extension_version=..., name=..., system_data=..., type=...) -> None:
        ...
...
def get_extension(data_manager_for_agriculture_resource_name: Optional[_builtins.str] = ..., extension_id: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetExtensionResult:
