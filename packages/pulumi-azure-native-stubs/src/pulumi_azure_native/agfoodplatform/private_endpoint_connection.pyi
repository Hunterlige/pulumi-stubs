...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *, data_manager_for_agriculture_resource_name: pulumi.Input[_builtins.str], private_link_service_connection_state: pulumi.Input[PrivateLinkServiceConnectionStateArgs], resource_group_name: pulumi.Input[_builtins.str], private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
