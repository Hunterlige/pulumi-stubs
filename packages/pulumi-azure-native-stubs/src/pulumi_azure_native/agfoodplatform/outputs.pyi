...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApiKeyAuthCredentialsResponse', 'ApiPropertiesResponse', 'DataConnectorPropertiesResponse', 'ErrorAdditionalInfoResponse', 'ErrorDetailResponse', 'ErrorResponseResponse', 'IdentityResponse', 'KeyVaultPropertiesResponse', 'OAuthClientCredentialsResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'SensorIntegrationResponse', 'SolutionPropertiesResponse', 'SystemDataResponse']
@pulumi.output_type
class ApiKeyAuthCredentialsResponse(dict):
    ...
    def __init__(__self__, *, api_key: outputs.KeyVaultPropertiesResponse, kind: _builtins.str) -> None:
...
class ApiPropertiesResponse(dict):
    ...
    def __init__(__self__, *, api_freshness_time_in_minutes: Optional[_builtins.int] = ...) -> None:
...
class OAuthClientCredentialsResponse(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, client_secret: outputs.KeyVaultPropertiesResponse, kind: _builtins.str) -> None:
...
class SensorIntegrationResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, enabled: Optional[_builtins.str] = ..., provisioning_info: Optional[outputs.ErrorResponseResponse] = ...) -> None:
...
class SolutionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, marketplace_publisher_id: _builtins.str, offer_id: _builtins.str, partner_id: _builtins.str, plan_id: _builtins.str, saas_subscription_id: _builtins.str, saas_subscription_name: _builtins.str, term_id: _builtins.str, role_assignment_id: Optional[_builtins.str] = ...) -> None:
