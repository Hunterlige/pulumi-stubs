...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApiKeyAuthCredentialsArgs', 'ApiKeyAuthCredentialsArgsDict', 'ApiPropertiesArgs', 'ApiPropertiesArgsDict', 'DataConnectorPropertiesArgs', 'DataConnectorPropertiesArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'KeyVaultPropertiesArgs', 'KeyVaultPropertiesArgsDict', 'OAuthClientCredentialsArgs', 'OAuthClientCredentialsArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'SensorIntegrationArgs', 'SensorIntegrationArgsDict', 'SolutionPropertiesArgs', 'SolutionPropertiesArgsDict']
...
class ApiKeyAuthCredentialsArgs:
    def __init__(__self__, *, api_key: pulumi.Input[KeyVaultPropertiesArgs], kind: pulumi.Input[_builtins.str]) -> None:
    ...
    @api_key.setter
    def api_key(self, value: pulumi.Input[KeyVaultPropertiesArgs]): # -> None:
        ...
...
class ApiPropertiesArgs:
    def __init__(__self__, *, api_freshness_time_in_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def api_freshness_time_in_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class DataConnectorPropertiesArgs:
    def __init__(__self__, *, credentials: pulumi.Input[Union[ApiKeyAuthCredentialsArgs, OAuthClientCredentialsArgs]]) -> None:
    ...
    @credentials.setter
    def credentials(self, value: pulumi.Input[Union[ApiKeyAuthCredentialsArgs, OAuthClientCredentialsArgs]]): # -> None:
        ...
...
class OAuthClientCredentialsArgs:
    def __init__(__self__, *, client_id: pulumi.Input[_builtins.str], client_secret: pulumi.Input[KeyVaultPropertiesArgs], kind: pulumi.Input[_builtins.str]) -> None:
    ...
    def client_secret(self, value: pulumi.Input[KeyVaultPropertiesArgs]): # -> None:
        ...
...
class SensorIntegrationArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SolutionPropertiesArgs:
    def __init__(__self__, *, marketplace_publisher_id: pulumi.Input[_builtins.str], offer_id: pulumi.Input[_builtins.str], plan_id: pulumi.Input[_builtins.str], saas_subscription_id: pulumi.Input[_builtins.str], saas_subscription_name: pulumi.Input[_builtins.str], term_id: pulumi.Input[_builtins.str], role_assignment_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def marketplace_publisher_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def saas_subscription_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def saas_subscription_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @term_id.setter
    def term_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def role_assignment_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
