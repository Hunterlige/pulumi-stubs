...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ErrorAdditionalInfoResponse', 'ErrorDetailResponse', ..., 'OffAzureDiscoverySourceResourcePropertiesResponse', 'SystemDataResponse']
@pulumi.output_type
...
class OffAzureDiscoverySourceResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, source_id: _builtins.str, source_type: _builtins.str) -> None:
