...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DependencyProcessFilter', 'DependencyProcessFilterDict', 'OffAzureDiscoverySourceResourcePropertiesArgs', 'OffAzureDiscoverySourceResourcePropertiesArgsDict', 'ProcessNameFilter', 'ProcessNameFilterDict']
...
class DependencyProcessFilter:
    def __init__(__self__, *, process_name_filter: Optional[ProcessNameFilter] = ...) -> None:
    ...
    def process_name_filter(self, value: Optional[ProcessNameFilter]): # -> None:
        ...
...
class OffAzureDiscoverySourceResourcePropertiesArgs:
    def __init__(__self__, *, source_id: pulumi.Input[_builtins.str], source_type: pulumi.Input[_builtins.str]) -> None:
...
class ProcessNameFilter:
    def __init__(__self__, *, operator: Union[_builtins.str, ProcessNameFilterOperator], process_names: Sequence[_builtins.str]) -> None:
    ...
    @operator.setter
    def operator(self, value: Union[_builtins.str, ProcessNameFilterOperator]): # -> None:
        ...
    ...
    def process_names(self, value: Sequence[_builtins.str]): # -> None:
        ...
