...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccountResourceResponseProperties', 'CorsRuleResponse', 'EndpointAuthenticationResponse', 'ManagedServiceIdentityResponse', 'ModelingInputDataResponse', 'ModelingResourceResponseProperties', 'ServiceEndpointResourceResponseProperties', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
class AccountResourceResponseProperties(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, configuration: Optional[_builtins.str] = ..., cors: Optional[Sequence[outputs.CorsRuleResponse]] = ..., endpoint_authentications: Optional[Sequence[outputs.EndpointAuthenticationResponse]] = ..., reports_connection_string: Optional[_builtins.str] = ...) -> None:
...
class CorsRuleResponse(dict):
    ...
    def __init__(__self__, *, allowed_origins: Sequence[_builtins.str], allowed_headers: Optional[Sequence[_builtins.str]] = ..., allowed_methods: Optional[Sequence[_builtins.str]] = ..., exposed_headers: Optional[Sequence[_builtins.str]] = ..., max_age_in_seconds: Optional[_builtins.int] = ...) -> None:
...
class EndpointAuthenticationResponse(dict):
    ...
    def __init__(__self__, *, aad_tenant_id: Optional[_builtins.str] = ..., principal_id: Optional[_builtins.str] = ..., principal_type: Optional[_builtins.str] = ...) -> None:
...
class ModelingResourceResponseProperties(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, features: Optional[_builtins.str] = ..., frequency: Optional[_builtins.str] = ..., input_data: Optional[outputs.ModelingInputDataResponse] = ..., size: Optional[_builtins.str] = ...) -> None:
...
class ServiceEndpointResourceResponseProperties(dict):
    ...
    def __init__(__self__, *, paired_location: _builtins.str, provisioning_state: _builtins.str, url: _builtins.str, pre_allocated_capacity: Optional[_builtins.int] = ...) -> None:
