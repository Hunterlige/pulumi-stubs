...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EmissionPoliciesPropertiesFormatResponse', 'EmissionPolicyDestinationResponse', 'IngestionPolicyPropertiesFormatResponse', 'IngestionSourcesPropertiesFormatResponse', 'ResourceReferenceResponse', 'SystemDataResponse']
@pulumi.output_type
class EmissionPoliciesPropertiesFormatResponse(dict):
    ...
    def __init__(__self__, *, emission_destinations: Optional[Sequence[outputs.EmissionPolicyDestinationResponse]] = ..., emission_type: Optional[_builtins.str] = ...) -> None:
...
class EmissionPolicyDestinationResponse(dict):
    ...
    def __init__(__self__, *, destination_type: Optional[_builtins.str] = ...) -> None:
...
class IngestionPolicyPropertiesFormatResponse(dict):
    ...
    def __init__(__self__, *, ingestion_sources: Optional[Sequence[outputs.IngestionSourcesPropertiesFormatResponse]] = ..., ingestion_type: Optional[_builtins.str] = ...) -> None:
...
class IngestionSourcesPropertiesFormatResponse(dict):
    ...
    def __init__(__self__, *, resource_id: Optional[_builtins.str] = ..., source_type: Optional[_builtins.str] = ...) -> None:
