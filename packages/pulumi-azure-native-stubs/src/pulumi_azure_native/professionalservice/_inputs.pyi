...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ProfessionalServiceCreationPropertiesArgs', 'ProfessionalServiceCreationPropertiesArgsDict']
...
class ProfessionalServiceCreationPropertiesArgs:
    def __init__(__self__, *, auto_renew: Optional[pulumi.Input[_builtins.bool]] = ..., billing_period: Optional[pulumi.Input[_builtins.str]] = ..., offer_id: Optional[pulumi.Input[_builtins.str]] = ..., publisher_id: Optional[pulumi.Input[_builtins.str]] = ..., quote_id: Optional[pulumi.Input[_builtins.str]] = ..., sku_id: Optional[pulumi.Input[_builtins.str]] = ..., store_front: Optional[pulumi.Input[_builtins.str]] = ..., term_unit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @quote_id.setter
    def quote_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @store_front.setter
    def store_front(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
