...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ProfessionalServicePropertiesResponseTerm', 'ProfessionalServiceResourceResponseProperties']
@pulumi.output_type
class ProfessionalServicePropertiesResponseTerm(dict):
    ...
    def __init__(__self__, *, end_date: Optional[_builtins.str] = ..., start_date: Optional[_builtins.str] = ..., term_unit: Optional[_builtins.str] = ...) -> None:
...
class ProfessionalServiceResourceResponseProperties(dict):
    ...
    def __init__(__self__, *, created: _builtins.str, auto_renew: Optional[_builtins.bool] = ..., billing_period: Optional[_builtins.str] = ..., is_free_trial: Optional[_builtins.bool] = ..., last_modified: Optional[_builtins.str] = ..., offer_id: Optional[_builtins.str] = ..., payment_channel_metadata: Optional[Mapping[str, _builtins.str]] = ..., payment_channel_type: Optional[_builtins.str] = ..., publisher_id: Optional[_builtins.str] = ..., quote_id: Optional[_builtins.str] = ..., sku_id: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., store_front: Optional[_builtins.str] = ..., term: Optional[outputs.ProfessionalServicePropertiesResponseTerm] = ..., term_unit: Optional[_builtins.str] = ...) -> None:
