...
class ProfessionalServiceSubscriptionLevelArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[
            pulumi.Input[ProfessionalServiceCreationPropertiesArgs]
        ] = ...,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[ProfessionalServiceCreationPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[ProfessionalServiceCreationPropertiesArgs]]
    ): ...
    @_builtins.property
...
class ProfessionalServiceSubscriptionLevel(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.ProfessionalServiceResourceResponseProperties]: ...
    @_builtins.property
    @pulumi.getter
