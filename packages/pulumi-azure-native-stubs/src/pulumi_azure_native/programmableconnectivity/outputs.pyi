...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationPropertiesResponse', 'SaasPropertiesResponse', 'StatusResponse', 'SystemDataResponse']
@pulumi.output_type
class ApplicationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, application_description: Optional[_builtins.str] = ..., application_type: Optional[_builtins.str] = ..., legal_name: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., organization_description: Optional[_builtins.str] = ..., privacy_contact_email_address: Optional[_builtins.str] = ..., tax_number: Optional[_builtins.str] = ...) -> None:
...
class SaasPropertiesResponse(dict):
    ...
    def __init__(__self__, *, saas_resource_id: Optional[_builtins.str] = ..., saas_subscription_id: Optional[_builtins.str] = ...) -> None:
...
class StatusResponse(dict):
    ...
    def __init__(__self__, *, reason: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
