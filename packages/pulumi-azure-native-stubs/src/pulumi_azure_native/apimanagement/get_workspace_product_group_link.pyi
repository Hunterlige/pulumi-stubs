...
class GetWorkspaceProductGroupLinkResult:
    def __init__(
        __self__, azure_api_version=..., group_id=..., id=..., name=..., type=...
    ) -> None: ...
    @_builtins.property
...
def get_workspace_product_group_link(
    group_link_id: Optional[_builtins.str] = ...,
...
def get_workspace_product_group_link_output(
    group_link_id: Optional[pulumi.Input[_builtins.str]] = ...,
...
) -> pulumi.Output[GetWorkspaceProductGroupLinkResult]: ...
