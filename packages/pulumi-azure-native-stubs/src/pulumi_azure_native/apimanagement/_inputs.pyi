...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AdditionalLocationArgs', 'AdditionalLocationArgsDict', 'ApiContactInformationArgs', 'ApiContactInformationArgsDict', 'ApiCreateOrUpdatePropertiesWsdlSelectorArgs', 'ApiCreateOrUpdatePropertiesWsdlSelectorArgsDict', 'ApiLicenseInformationArgs', 'ApiLicenseInformationArgsDict', 'ApiManagementGatewaySkuPropertiesArgs', 'ApiManagementGatewaySkuPropertiesArgsDict', 'ApiManagementServiceIdentityArgs', 'ApiManagementServiceIdentityArgsDict', 'ApiManagementServiceSkuPropertiesArgs', 'ApiManagementServiceSkuPropertiesArgsDict', 'ApiVersionConstraintArgs', 'ApiVersionConstraintArgsDict', 'ApiVersionSetContractDetailsArgs', 'ApiVersionSetContractDetailsArgsDict', 'AuthenticationSettingsContractArgs', 'AuthenticationSettingsContractArgsDict', 'AuthorizationErrorArgs', 'AuthorizationErrorArgsDict', 'AuthorizationProviderOAuth2GrantTypesArgs', 'AuthorizationProviderOAuth2GrantTypesArgsDict', 'AuthorizationProviderOAuth2SettingsArgs', 'AuthorizationProviderOAuth2SettingsArgsDict', 'BackendAuthorizationHeaderCredentialsArgs', 'BackendAuthorizationHeaderCredentialsArgsDict', 'BackendBaseParametersPoolArgs', 'BackendBaseParametersPoolArgsDict', 'BackendCircuitBreakerArgs', 'BackendCircuitBreakerArgsDict', 'BackendConfigurationArgs', 'BackendConfigurationArgsDict', 'BackendCredentialsContractArgs', 'BackendCredentialsContractArgsDict', 'BackendPoolItemArgs', 'BackendPoolItemArgsDict', 'BackendPropertiesArgs', 'BackendPropertiesArgsDict', 'BackendProxyContractArgs', 'BackendProxyContractArgsDict', 'BackendServiceFabricClusterPropertiesArgs', 'BackendServiceFabricClusterPropertiesArgsDict', 'BackendSubnetConfigurationArgs', 'BackendSubnetConfigurationArgsDict', 'BackendTlsPropertiesArgs', 'BackendTlsPropertiesArgsDict', 'BodyDiagnosticSettingsArgs', 'BodyDiagnosticSettingsArgsDict', 'CertificateConfigurationArgs', 'CertificateConfigurationArgsDict', 'CertificateInformationArgs', 'CertificateInformationArgsDict', 'CircuitBreakerFailureConditionArgs', 'CircuitBreakerFailureConditionArgsDict', 'CircuitBreakerRuleArgs', 'CircuitBreakerRuleArgsDict', 'ConfigurationApiArgs', 'ConfigurationApiArgsDict', 'DataMaskingEntityArgs', 'DataMaskingEntityArgsDict', 'DataMaskingArgs', 'DataMaskingArgsDict', 'EmailTemplateParametersContractPropertiesArgs', 'EmailTemplateParametersContractPropertiesArgsDict', 'FailureStatusCodeRangeArgs', 'FailureStatusCodeRangeArgsDict', 'GatewayHostnameBindingKeyVaultArgs', 'GatewayHostnameBindingKeyVaultArgsDict', 'HostnameConfigurationArgs', 'HostnameConfigurationArgsDict', 'HttpMessageDiagnosticArgs', 'HttpMessageDiagnosticArgsDict', 'KeyVaultContractCreatePropertiesArgs', 'KeyVaultContractCreatePropertiesArgsDict', 'OAuth2AuthenticationSettingsContractArgs', 'OAuth2AuthenticationSettingsContractArgsDict', 'OpenIdAuthenticationSettingsContractArgs', 'OpenIdAuthenticationSettingsContractArgsDict', 'ParameterContractArgs', 'ParameterContractArgsDict', 'ParameterExampleContractArgs', 'ParameterExampleContractArgsDict', 'PipelineDiagnosticSettingsArgs', 'PipelineDiagnosticSettingsArgsDict', 'PrivateEndpointConnectionRequestPropertiesArgs', 'PrivateEndpointConnectionRequestPropertiesArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'RemotePrivateEndpointConnectionWrapperArgs', 'RemotePrivateEndpointConnectionWrapperArgsDict', 'RepresentationContractArgs', 'RepresentationContractArgsDict', 'RequestContractArgs', 'RequestContractArgsDict', 'ResourceLocationDataContractArgs', 'ResourceLocationDataContractArgsDict', 'ResponseContractArgs', 'ResponseContractArgsDict', 'SamplingSettingsArgs', 'SamplingSettingsArgsDict', 'SubscriptionKeyParameterNamesContractArgs', 'SubscriptionKeyParameterNamesContractArgsDict', 'TokenBodyParameterContractArgs', 'TokenBodyParameterContractArgsDict', 'UserIdentityContractArgs', 'UserIdentityContractArgsDict', 'UserIdentityPropertiesArgs', 'UserIdentityPropertiesArgsDict', 'VirtualNetworkConfigurationArgs', 'VirtualNetworkConfigurationArgsDict', 'WikiDocumentationContractArgs', 'WikiDocumentationContractArgsDict', 'X509CertificateNameArgs', 'X509CertificateNameArgsDict']
...
class AdditionalLocationArgs:
    def __init__(__self__, *, location: pulumi.Input[_builtins.str], sku: pulumi.Input[ApiManagementServiceSkuPropertiesArgs], disable_gateway: Optional[pulumi.Input[_builtins.bool]] = ..., nat_gateway_state: Optional[pulumi.Input[Union[_builtins.str, NatGatewayState]]] = ..., public_ip_address_id: Optional[pulumi.Input[_builtins.str]] = ..., virtual_network_configuration: Optional[pulumi.Input[VirtualNetworkConfigurationArgs]] = ..., zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ApiContactInformationArgs:
    def __init__(__self__, *, email: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ApiCreateOrUpdatePropertiesWsdlSelectorArgs:
    def __init__(__self__, *, wsdl_endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., wsdl_service_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def wsdl_endpoint_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def wsdl_service_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApiLicenseInformationArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ApiManagementGatewaySkuPropertiesArgs:
    def __init__(__self__, *, name: pulumi.Input[Union[_builtins.str, ApiGatewaySkuType]], capacity: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @name.setter
    def name(self, value: pulumi.Input[Union[_builtins.str, ApiGatewaySkuType]]): # -> None:
        ...
...
class ApiManagementServiceIdentityArgs:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, ApimIdentityType]], user_assigned_identities: Optional[pulumi.Input[Mapping[str, pulumi.Input[UserIdentityPropertiesArgs]]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ApimIdentityType]]): # -> None:
        ...
...
class ApiManagementServiceSkuPropertiesArgs:
    def __init__(__self__, *, capacity: pulumi.Input[_builtins.int], name: pulumi.Input[Union[_builtins.str, SkuType]]) -> None:
    ...
    @name.setter
    def name(self, value: pulumi.Input[Union[_builtins.str, SkuType]]): # -> None:
        ...
...
class ApiVersionConstraintArgs:
    def __init__(__self__, *, min_api_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def min_api_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApiVersionSetContractDetailsArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., version_header_name: Optional[pulumi.Input[_builtins.str]] = ..., version_query_name: Optional[pulumi.Input[_builtins.str]] = ..., versioning_scheme: Optional[pulumi.Input[Union[_builtins.str, VersioningScheme]]] = ...) -> None:
    ...
    def versioning_scheme(self, value: Optional[pulumi.Input[Union[_builtins.str, VersioningScheme]]]): # -> None:
        ...
...
class AuthenticationSettingsContractArgs:
    def __init__(__self__, *, o_auth2: Optional[pulumi.Input[OAuth2AuthenticationSettingsContractArgs]] = ..., o_auth2_authentication_settings: Optional[pulumi.Input[Sequence[pulumi.Input[OAuth2AuthenticationSettingsContractArgs]]]] = ..., openid: Optional[pulumi.Input[OpenIdAuthenticationSettingsContractArgs]] = ..., openid_authentication_settings: Optional[pulumi.Input[Sequence[pulumi.Input[OpenIdAuthenticationSettingsContractArgs]]]] = ...) -> None:
    ...
    @o_auth2.setter
    def o_auth2(self, value: Optional[pulumi.Input[OAuth2AuthenticationSettingsContractArgs]]): # -> None:
        ...
    ...
    def o_auth2_authentication_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[OAuth2AuthenticationSettingsContractArgs]]]]): # -> None:
        ...
    ...
    @openid.setter
    def openid(self, value: Optional[pulumi.Input[OpenIdAuthenticationSettingsContractArgs]]): # -> None:
        ...
    ...
    def openid_authentication_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[OpenIdAuthenticationSettingsContractArgs]]]]): # -> None:
        ...
...
class AuthorizationProviderOAuth2GrantTypesArgs:
    def __init__(__self__, *, authorization_code: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., client_credentials: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def authorization_code(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def client_credentials(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AuthorizationProviderOAuth2SettingsArgs:
    def __init__(__self__, *, grant_types: Optional[pulumi.Input[AuthorizationProviderOAuth2GrantTypesArgs]] = ..., redirect_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @grant_types.setter
    def grant_types(self, value: Optional[pulumi.Input[AuthorizationProviderOAuth2GrantTypesArgs]]): # -> None:
        ...
...
class BackendAuthorizationHeaderCredentialsArgs:
    def __init__(__self__, *, parameter: pulumi.Input[_builtins.str], scheme: pulumi.Input[_builtins.str]) -> None:
...
class BackendBaseParametersPoolArgs:
    def __init__(__self__, *, services: Optional[pulumi.Input[Sequence[pulumi.Input[BackendPoolItemArgs]]]] = ...) -> None:
    ...
    @services.setter
    def services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BackendPoolItemArgs]]]]): # -> None:
        ...
...
class BackendCircuitBreakerArgs:
    def __init__(__self__, *, rules: Optional[pulumi.Input[Sequence[pulumi.Input[CircuitBreakerRuleArgs]]]] = ...) -> None:
    ...
    @rules.setter
    def rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CircuitBreakerRuleArgs]]]]): # -> None:
        ...
...
class BackendConfigurationArgs:
    def __init__(__self__, *, subnet: Optional[pulumi.Input[BackendSubnetConfigurationArgs]] = ...) -> None:
    ...
    @subnet.setter
    def subnet(self, value: Optional[pulumi.Input[BackendSubnetConfigurationArgs]]): # -> None:
        ...
...
class BackendCredentialsContractArgs:
    def __init__(__self__, *, authorization: Optional[pulumi.Input[BackendAuthorizationHeaderCredentialsArgs]] = ..., certificate: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., certificate_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., header: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]] = ..., query: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]] = ...) -> None:
    ...
    def authorization(self, value: Optional[pulumi.Input[BackendAuthorizationHeaderCredentialsArgs]]): # -> None:
        ...
    ...
    @certificate.setter
    def certificate(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @header.setter
    def header(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]]): # -> None:
        ...
    ...
    @query.setter
    def query(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]]): # -> None:
        ...
...
class BackendPoolItemArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], priority: Optional[pulumi.Input[_builtins.int]] = ..., weight: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class BackendPropertiesArgs:
    def __init__(__self__, *, service_fabric_cluster: Optional[pulumi.Input[BackendServiceFabricClusterPropertiesArgs]] = ...) -> None:
    ...
    def service_fabric_cluster(self, value: Optional[pulumi.Input[BackendServiceFabricClusterPropertiesArgs]]): # -> None:
        ...
...
class BackendProxyContractArgs:
    def __init__(__self__, *, url: pulumi.Input[_builtins.str], password: Optional[pulumi.Input[_builtins.str]] = ..., username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class BackendServiceFabricClusterPropertiesArgs:
    def __init__(__self__, *, management_endpoints: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], client_certificate_id: Optional[pulumi.Input[_builtins.str]] = ..., client_certificatethumbprint: Optional[pulumi.Input[_builtins.str]] = ..., max_partition_resolution_retries: Optional[pulumi.Input[_builtins.int]] = ..., server_certificate_thumbprints: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., server_x509_names: Optional[pulumi.Input[Sequence[pulumi.Input[X509CertificateNameArgs]]]] = ...) -> None:
    ...
    def management_endpoints(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def client_certificatethumbprint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_partition_resolution_retries(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def server_certificate_thumbprints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def server_x509_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[X509CertificateNameArgs]]]]): # -> None:
        ...
...
class BackendTlsPropertiesArgs:
    def __init__(__self__, *, validate_certificate_chain: Optional[pulumi.Input[_builtins.bool]] = ..., validate_certificate_name: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def validate_certificate_chain(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def validate_certificate_name(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class BodyDiagnosticSettingsArgs:
    def __init__(__self__, *, bytes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @bytes.setter
    def bytes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class CertificateConfigurationArgs:
    def __init__(__self__, *, store_name: pulumi.Input[_builtins.str], certificate: Optional[pulumi.Input[CertificateInformationArgs]] = ..., certificate_password: Optional[pulumi.Input[_builtins.str]] = ..., encoded_certificate: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @certificate.setter
    def certificate(self, value: Optional[pulumi.Input[CertificateInformationArgs]]): # -> None:
        ...
    ...
    def encoded_certificate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CertificateInformationArgs:
    def __init__(__self__, *, expiry: pulumi.Input[_builtins.str], subject: pulumi.Input[_builtins.str], thumbprint: pulumi.Input[_builtins.str]) -> None:
    ...
    @expiry.setter
    def expiry(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class CircuitBreakerFailureConditionArgs:
    def __init__(__self__, *, count: Optional[pulumi.Input[_builtins.float]] = ..., error_reasons: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., interval: Optional[pulumi.Input[_builtins.str]] = ..., percentage: Optional[pulumi.Input[_builtins.float]] = ..., status_code_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[FailureStatusCodeRangeArgs]]]] = ...) -> None:
    ...
    def error_reasons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def status_code_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FailureStatusCodeRangeArgs]]]]): # -> None:
        ...
...
class CircuitBreakerRuleArgs:
    def __init__(__self__, *, accept_retry_after: Optional[pulumi.Input[_builtins.bool]] = ..., failure_condition: Optional[pulumi.Input[CircuitBreakerFailureConditionArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., trip_duration: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def accept_retry_after(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def failure_condition(self, value: Optional[pulumi.Input[CircuitBreakerFailureConditionArgs]]): # -> None:
        ...
    ...
    def trip_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConfigurationApiArgs:
    def __init__(__self__, *, legacy_api: Optional[pulumi.Input[Union[_builtins.str, LegacyApiState]]] = ...) -> None:
    ...
    @legacy_api.setter
    def legacy_api(self, value: Optional[pulumi.Input[Union[_builtins.str, LegacyApiState]]]): # -> None:
        ...
...
class DataMaskingEntityArgs:
    def __init__(__self__, *, mode: Optional[pulumi.Input[Union[_builtins.str, DataMaskingMode]]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @mode.setter
    def mode(self, value: Optional[pulumi.Input[Union[_builtins.str, DataMaskingMode]]]): # -> None:
        ...
...
class DataMaskingArgs:
    def __init__(__self__, *, headers: Optional[pulumi.Input[Sequence[pulumi.Input[DataMaskingEntityArgs]]]] = ..., query_params: Optional[pulumi.Input[Sequence[pulumi.Input[DataMaskingEntityArgs]]]] = ...) -> None:
    ...
    @headers.setter
    def headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataMaskingEntityArgs]]]]): # -> None:
        ...
    ...
    @query_params.setter
    def query_params(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataMaskingEntityArgs]]]]): # -> None:
        ...
...
class EmailTemplateParametersContractPropertiesArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., title: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class GatewayHostnameBindingKeyVaultArgs:
    def __init__(__self__, *, secret_id: pulumi.Input[_builtins.str], identity_client_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class HostnameConfigurationArgs:
    def __init__(__self__, *, host_name: pulumi.Input[_builtins.str], type: pulumi.Input[Union[_builtins.str, HostnameType]], certificate: Optional[pulumi.Input[CertificateInformationArgs]] = ..., certificate_password: Optional[pulumi.Input[_builtins.str]] = ..., certificate_source: Optional[pulumi.Input[Union[_builtins.str, CertificateSource]]] = ..., certificate_status: Optional[pulumi.Input[Union[_builtins.str, CertificateStatus]]] = ..., default_ssl_binding: Optional[pulumi.Input[_builtins.bool]] = ..., encoded_certificate: Optional[pulumi.Input[_builtins.str]] = ..., identity_client_id: Optional[pulumi.Input[_builtins.str]] = ..., key_vault_id: Optional[pulumi.Input[_builtins.str]] = ..., negotiate_client_certificate: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, HostnameType]]): # -> None:
        ...
    ...
    def certificate_source(self, value: Optional[pulumi.Input[Union[_builtins.str, CertificateSource]]]): # -> None:
        ...
    ...
    def certificate_status(self, value: Optional[pulumi.Input[Union[_builtins.str, CertificateStatus]]]): # -> None:
        ...
    ...
    def default_ssl_binding(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class HttpMessageDiagnosticArgs:
    def __init__(__self__, *, body: Optional[pulumi.Input[BodyDiagnosticSettingsArgs]] = ..., data_masking: Optional[pulumi.Input[DataMaskingArgs]] = ..., headers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @body.setter
    def body(self, value: Optional[pulumi.Input[BodyDiagnosticSettingsArgs]]): # -> None:
        ...
    ...
    @data_masking.setter
    def data_masking(self, value: Optional[pulumi.Input[DataMaskingArgs]]): # -> None:
        ...
...
class KeyVaultContractCreatePropertiesArgs:
    def __init__(__self__, *, identity_client_id: Optional[pulumi.Input[_builtins.str]] = ..., secret_identifier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class OAuth2AuthenticationSettingsContractArgs:
    def __init__(__self__, *, authorization_server_id: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authorization_server_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class OpenIdAuthenticationSettingsContractArgs:
    def __init__(__self__, *, bearer_token_sending_methods: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, BearerTokenSendingMethods]]]]] = ..., openid_provider_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def bearer_token_sending_methods(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, BearerTokenSendingMethods]]]]]): # -> None:
        ...
    ...
    def openid_provider_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ParameterContractArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], default_value: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., examples: Optional[pulumi.Input[Mapping[str, pulumi.Input[ParameterExampleContractArgs]]]] = ..., required: Optional[pulumi.Input[_builtins.bool]] = ..., schema_id: Optional[pulumi.Input[_builtins.str]] = ..., type_name: Optional[pulumi.Input[_builtins.str]] = ..., values: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @examples.setter
    def examples(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[ParameterExampleContractArgs]]]]): # -> None:
        ...
...
class ParameterExampleContractArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., external_value: Optional[pulumi.Input[_builtins.str]] = ..., summary: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[Any] = ...) -> None:
    ...
    def external_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipelineDiagnosticSettingsArgs:
    def __init__(__self__, *, request: Optional[pulumi.Input[HttpMessageDiagnosticArgs]] = ..., response: Optional[pulumi.Input[HttpMessageDiagnosticArgs]] = ...) -> None:
    ...
    @request.setter
    def request(self, value: Optional[pulumi.Input[HttpMessageDiagnosticArgs]]): # -> None:
        ...
    ...
    @response.setter
    def response(self, value: Optional[pulumi.Input[HttpMessageDiagnosticArgs]]): # -> None:
        ...
...
class RemotePrivateEndpointConnectionWrapperArgs:
    def __init__(__self__, *, private_link_service_connection_state: pulumi.Input[PrivateLinkServiceConnectionStateArgs], id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RepresentationContractArgs:
    def __init__(__self__, *, content_type: pulumi.Input[_builtins.str], examples: Optional[pulumi.Input[Mapping[str, pulumi.Input[ParameterExampleContractArgs]]]] = ..., form_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ParameterContractArgs]]]] = ..., schema_id: Optional[pulumi.Input[_builtins.str]] = ..., type_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def form_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ParameterContractArgs]]]]): # -> None:
        ...
...
class RequestContractArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., headers: Optional[pulumi.Input[Sequence[pulumi.Input[ParameterContractArgs]]]] = ..., query_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ParameterContractArgs]]]] = ..., representations: Optional[pulumi.Input[Sequence[pulumi.Input[RepresentationContractArgs]]]] = ...) -> None:
    ...
    @headers.setter
    def headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ParameterContractArgs]]]]): # -> None:
        ...
    ...
    def query_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ParameterContractArgs]]]]): # -> None:
        ...
    ...
    def representations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RepresentationContractArgs]]]]): # -> None:
        ...
...
class ResponseContractArgs:
    def __init__(__self__, *, status_code: pulumi.Input[_builtins.int], description: Optional[pulumi.Input[_builtins.str]] = ..., headers: Optional[pulumi.Input[Sequence[pulumi.Input[ParameterContractArgs]]]] = ..., representations: Optional[pulumi.Input[Sequence[pulumi.Input[RepresentationContractArgs]]]] = ...) -> None:
...
class SamplingSettingsArgs:
    def __init__(__self__, *, percentage: Optional[pulumi.Input[_builtins.float]] = ..., sampling_type: Optional[pulumi.Input[Union[_builtins.str, SamplingType]]] = ...) -> None:
    ...
    def sampling_type(self, value: Optional[pulumi.Input[Union[_builtins.str, SamplingType]]]): # -> None:
        ...
...
class SubscriptionKeyParameterNamesContractArgs:
    def __init__(__self__, *, header: Optional[pulumi.Input[_builtins.str]] = ..., query: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class UserIdentityContractArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., provider: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VirtualNetworkConfigurationArgs:
    def __init__(__self__, *, subnet_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WikiDocumentationContractArgs:
    def __init__(__self__, *, documentation_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class X509CertificateNameArgs:
    def __init__(__self__, *, issuer_certificate_thumbprint: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def issuer_certificate_thumbprint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
