...
class ApiGatewayArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], sku: pulumi.Input[ApiManagementGatewaySkuPropertiesArgs], backend: Optional[pulumi.Input[BackendConfigurationArgs]] = ..., gateway_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., virtual_network_type: Optional[pulumi.Input[Union[_builtins.str, VirtualNetworkType]]] = ...) -> None:
    ...
    @sku.setter
    def sku(self, value: pulumi.Input[ApiManagementGatewaySkuPropertiesArgs]): # -> None:
        ...
    ...
    @backend.setter
    def backend(self, value: Optional[pulumi.Input[BackendConfigurationArgs]]): # -> None:
        ...
...
class ApiGateway(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., backend: Optional[pulumi.Input[Union[BackendConfigurationArgs, BackendConfigurationArgsDict]]] = ..., gateway_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[ApiManagementGatewaySkuPropertiesArgs, ApiManagementGatewaySkuPropertiesArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., virtual_network_type: Optional[pulumi.Input[Union[_builtins.str, VirtualNetworkType]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ApiGatewayArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ApiGateway:
