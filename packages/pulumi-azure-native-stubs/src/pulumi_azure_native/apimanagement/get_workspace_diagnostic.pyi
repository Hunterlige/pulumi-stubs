...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetWorkspaceDiagnosticResult', 'AwaitableGetWorkspaceDiagnosticResult', 'get_workspace_diagnostic', 'get_workspace_diagnostic_output']
@pulumi.output_type
...
class AwaitableGetWorkspaceDiagnosticResult(GetWorkspaceDiagnosticResult):
    def __await__(self): # -> Generator[Never, Any, GetWorkspaceDiagnosticResult]:
        ...
    


def get_workspace_diagnostic(diagnostic_id: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., service_name: Optional[_builtins.str] = ..., workspace_id: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetWorkspaceDiagnosticResult:
    
    ...

def get_workspace_diagnostic_output(diagnostic_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., service_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_id: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetWorkspaceDiagnosticResult]:
