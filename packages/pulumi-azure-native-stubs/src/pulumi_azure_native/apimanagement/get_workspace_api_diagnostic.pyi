...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetWorkspaceApiDiagnosticResult', 'AwaitableGetWorkspaceApiDiagnosticResult', 'get_workspace_api_diagnostic', 'get_workspace_api_diagnostic_output']
@pulumi.output_type
...
class AwaitableGetWorkspaceApiDiagnosticResult(GetWorkspaceApiDiagnosticResult):
    def __await__(self): # -> Generator[Never, Any, GetWorkspaceApiDiagnosticResult]:
        ...
    


def get_workspace_api_diagnostic(api_id: Optional[_builtins.str] = ..., diagnostic_id: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., service_name: Optional[_builtins.str] = ..., workspace_id: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetWorkspaceApiDiagnosticResult:
    
    ...

def get_workspace_api_diagnostic_output(api_id: Optional[pulumi.Input[_builtins.str]] = ..., diagnostic_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., service_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_id: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetWorkspaceApiDiagnosticResult]:
