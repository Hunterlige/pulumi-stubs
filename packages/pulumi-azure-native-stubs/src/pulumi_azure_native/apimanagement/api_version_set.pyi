...
class ApiVersionSetArgs:
    def __init__(__self__, *, display_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], service_name: pulumi.Input[_builtins.str], versioning_scheme: pulumi.Input[Union[_builtins.str, VersioningScheme]], description: Optional[pulumi.Input[_builtins.str]] = ..., version_header_name: Optional[pulumi.Input[_builtins.str]] = ..., version_query_name: Optional[pulumi.Input[_builtins.str]] = ..., version_set_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ApiVersionSet(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., service_name: Optional[pulumi.Input[_builtins.str]] = ..., version_header_name: Optional[pulumi.Input[_builtins.str]] = ..., version_query_name: Optional[pulumi.Input[_builtins.str]] = ..., version_set_id: Optional[pulumi.Input[_builtins.str]] = ..., versioning_scheme: Optional[pulumi.Input[Union[_builtins.str, VersioningScheme]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ApiVersionSetArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ApiVersionSet:
