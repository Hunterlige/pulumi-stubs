...
class ApiTagDescriptionArgs:
    def __init__(__self__, *, api_id: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], service_name: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., external_docs_description: Optional[pulumi.Input[_builtins.str]] = ..., external_docs_url: Optional[pulumi.Input[_builtins.str]] = ..., tag_description_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def external_docs_description(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def external_docs_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def tag_description_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApiTagDescription(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., api_id: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., external_docs_description: Optional[pulumi.Input[_builtins.str]] = ..., external_docs_url: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., service_name: Optional[pulumi.Input[_builtins.str]] = ..., tag_description_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ApiTagDescriptionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ApiTagDescription:
