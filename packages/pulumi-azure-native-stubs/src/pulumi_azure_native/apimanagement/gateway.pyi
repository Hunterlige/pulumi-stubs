...
class GatewayArgs:
    def __init__(
        ...
        *,
        ...
        location_data: Optional[pulumi.Input[ResourceLocationDataContractArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def location_data(
        self,
    ) -> Optional[pulumi.Input[ResourceLocationDataContractArgs]]: ...
    @location_data.setter
    def location_data(
        self, value: Optional[pulumi.Input[ResourceLocationDataContractArgs]]
    ): ...
...
class Gateway(pulumi.CustomResource):
    ...
    def location_data(
        self,
    ) -> pulumi.Output[Optional[outputs.ResourceLocationDataContractResponse]]: ...
    @_builtins.property
    @pulumi.getter
