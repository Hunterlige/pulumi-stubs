...
class WorkspaceProductPolicyArgs:
    def __init__(__self__, *, product_id: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], service_name: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str], workspace_id: pulumi.Input[_builtins.str], format: Optional[pulumi.Input[Union[_builtins.str, PolicyContentFormat]]] = ..., policy_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkspaceProductPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., format: Optional[pulumi.Input[Union[_builtins.str, PolicyContentFormat]]] = ..., policy_id: Optional[pulumi.Input[_builtins.str]] = ..., product_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., service_name: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ..., workspace_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: WorkspaceProductPolicyArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WorkspaceProductPolicy:
