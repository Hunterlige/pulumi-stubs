...
class PrivateEndpointConnectionByNameArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[
            pulumi.Input[PrivateEndpointConnectionRequestPropertiesArgs]
        ] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[PrivateEndpointConnectionRequestPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self,
        value: Optional[pulumi.Input[PrivateEndpointConnectionRequestPropertiesArgs]],
    ): ...
