...
class NamedValueArgs:
    def __init__(
        ...
        *,
        ...
        key_vault: Optional[pulumi.Input[KeyVaultContractCreatePropertiesArgs]] = ...,
        named_value_id: Optional[pulumi.Input[_builtins.str]] = ...,
        secret: Optional[pulumi.Input[_builtins.bool]] = ...,
    ...
    def key_vault(
        self,
    ) -> Optional[pulumi.Input[KeyVaultContractCreatePropertiesArgs]]: ...
    @key_vault.setter
    def key_vault(
        self, value: Optional[pulumi.Input[KeyVaultContractCreatePropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter(name="namedValueId")
    def named_value_id(self) -> Optional[pulumi.Input[_builtins.str]]: ...
    @named_value_id.setter
    def named_value_id(self, value: Optional[pulumi.Input[_builtins.str]]): ...
    @_builtins.property
    @pulumi.getter
...
class NamedValue(pulumi.CustomResource):
    ...
    def key_vault(
        self,
    ) -> pulumi.Output[Optional[outputs.KeyVaultContractPropertiesResponse]]: ...
    @_builtins.property
    @pulumi.getter
