...
@pulumi.input_type
class PolicyArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], service_name: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str], format: Optional[pulumi.Input[Union[_builtins.str, PolicyContentFormat]]] = ..., policy_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.type_token("azure-native:apimanagement:Policy")
