...
class WorkspacePolicyArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], service_name: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str], workspace_id: pulumi.Input[_builtins.str], format: Optional[pulumi.Input[Union[_builtins.str, PolicyContentFormat]]] = ..., policy_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkspacePolicy(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: WorkspacePolicyArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WorkspacePolicy:
