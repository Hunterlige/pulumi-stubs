...
class PrivateCloudArgs:
    def __init__(__self__, *, management_cluster: pulumi.Input[ManagementClusterArgs], network_block: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], sku: pulumi.Input[SkuArgs], availability: Optional[pulumi.Input[AvailabilityPropertiesArgs]] = ..., dns_zone_type: Optional[pulumi.Input[Union[_builtins.str, DnsZoneType]]] = ..., encryption: Optional[pulumi.Input[EncryptionArgs]] = ..., extended_network_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., identity: Optional[pulumi.Input[SystemAssignedServiceIdentityArgs]] = ..., identity_sources: Optional[pulumi.Input[Sequence[pulumi.Input[IdentitySourceArgs]]]] = ..., internet: Optional[pulumi.Input[Union[_builtins.str, InternetEnum]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., nsxt_password: Optional[pulumi.Input[_builtins.str]] = ..., private_cloud_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., vcenter_password: Optional[pulumi.Input[_builtins.str]] = ..., virtual_network_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def management_cluster(self, value: pulumi.Input[ManagementClusterArgs]): # -> None:
        ...
    ...
    def network_block(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @availability.setter
    def availability(self, value: Optional[pulumi.Input[AvailabilityPropertiesArgs]]): # -> None:
        ...
    ...
    def dns_zone_type(self, value: Optional[pulumi.Input[Union[_builtins.str, DnsZoneType]]]): # -> None:
        ...
    ...
    def extended_network_blocks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def identity_sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IdentitySourceArgs]]]]): # -> None:
        ...
    ...
    @internet.setter
    def internet(self, value: Optional[pulumi.Input[Union[_builtins.str, InternetEnum]]]): # -> None:
        ...
    ...
    def nsxt_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def private_cloud_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def vcenter_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PrivateCloud(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., availability: Optional[pulumi.Input[Union[AvailabilityPropertiesArgs, AvailabilityPropertiesArgsDict]]] = ..., dns_zone_type: Optional[pulumi.Input[Union[_builtins.str, DnsZoneType]]] = ..., encryption: Optional[pulumi.Input[Union[EncryptionArgs, EncryptionArgsDict]]] = ..., extended_network_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., identity: Optional[pulumi.Input[Union[SystemAssignedServiceIdentityArgs, SystemAssignedServiceIdentityArgsDict]]] = ..., identity_sources: Optional[pulumi.Input[Sequence[pulumi.Input[Union[IdentitySourceArgs, IdentitySourceArgsDict]]]]] = ..., internet: Optional[pulumi.Input[Union[_builtins.str, InternetEnum]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., management_cluster: Optional[pulumi.Input[Union[ManagementClusterArgs, ManagementClusterArgsDict]]] = ..., network_block: Optional[pulumi.Input[_builtins.str]] = ..., nsxt_password: Optional[pulumi.Input[_builtins.str]] = ..., private_cloud_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[SkuArgs, SkuArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., vcenter_password: Optional[pulumi.Input[_builtins.str]] = ..., virtual_network_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> PrivateCloud:
