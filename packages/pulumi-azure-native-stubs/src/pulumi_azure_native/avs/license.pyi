...
class LicenseArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[VmwareFirewallLicensePropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[VmwareFirewallLicensePropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[VmwareFirewallLicensePropertiesArgs]]
    ): ...
...
class License(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.VmwareFirewallLicensePropertiesResponse]: ...
    @_builtins.property
