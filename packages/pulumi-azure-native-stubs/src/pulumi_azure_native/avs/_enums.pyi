...
__all__ = ['AddonType', 'AffinityStrength', 'AffinityType', 'AvailabilityStrategy', 'AzureHybridBenefitType', 'DhcpTypeEnum', 'DnsServiceLogLevelEnum', 'DnsZoneType', 'EncryptionState', 'InternetEnum', 'LicenseKind', 'MountOptionEnum', 'PlacementPolicyState', 'PlacementPolicyType', 'PortMirroringDirectionEnum', 'ScriptExecutionParameterType', 'SkuTier', 'SslEnum', 'SystemAssignedServiceIdentityType']
