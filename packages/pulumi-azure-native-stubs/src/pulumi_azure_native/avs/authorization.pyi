...
class AuthorizationArgs:
    def __init__(__self__, *, private_cloud_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], authorization_name: Optional[pulumi.Input[_builtins.str]] = ..., express_route_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class Authorization(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., authorization_name: Optional[pulumi.Input[_builtins.str]] = ..., express_route_id: Optional[pulumi.Input[_builtins.str]] = ..., private_cloud_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
