...
class WorkloadNetworkDhcpArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[
            pulumi.Input[
                Union[WorkloadNetworkDhcpRelayArgs, WorkloadNetworkDhcpServerArgs]
            ]
        ] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def properties(
        ...
        pulumi.Input[Union[WorkloadNetworkDhcpRelayArgs, WorkloadNetworkDhcpServerArgs]]
    ]: ...
    @properties.setter
    def properties(
        self,
        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    ...
                    Union[
                        WorkloadNetworkDhcpServerArgs, WorkloadNetworkDhcpServerArgsDict
                    ],
                ]
            ]
        ] = ...,
