...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetNetworkToNetworkInterconnectResult', 'AwaitableGetNetworkToNetworkInterconnectResult', 'get_network_to_network_interconnect', 'get_network_to_network_interconnect_output']
@pulumi.output_type
class GetNetworkToNetworkInterconnectResult:
    
    def __init__(__self__, administrative_state=..., azure_api_version=..., configuration_state=..., egress_acl_id=..., export_route_policy=..., id=..., import_route_policy=..., ingress_acl_id=..., is_management_type=..., layer2_configuration=..., name=..., nni_type=..., npb_static_route_configuration=..., option_b_layer3_configuration=..., provisioning_state=..., system_data=..., type=..., use_option_b=...) -> None:
        ...
...
class AwaitableGetNetworkToNetworkInterconnectResult(GetNetworkToNetworkInterconnectResult):
    def __await__(self): # -> Generator[Never, Any, GetNetworkToNetworkInterconnectResult]:
        ...
    


def get_network_to_network_interconnect(network_fabric_name: Optional[_builtins.str] = ..., network_to_network_interconnect_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetNetworkToNetworkInterconnectResult:
    
    ...

def get_network_to_network_interconnect_output(network_fabric_name: Optional[pulumi.Input[_builtins.str]] = ..., network_to_network_interconnect_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetNetworkToNetworkInterconnectResult]:
