...
class IpCommunityArgs:
    def __init__(__self__, *, ip_community_rules: pulumi.Input[Sequence[pulumi.Input[IpCommunityRuleArgs]]], resource_group_name: pulumi.Input[_builtins.str], annotation: Optional[pulumi.Input[_builtins.str]] = ..., ip_community_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def ip_community_rules(self, value: pulumi.Input[Sequence[pulumi.Input[IpCommunityRuleArgs]]]): # -> None:
        ...
    ...
    def ip_community_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IpCommunity(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., annotation: Optional[pulumi.Input[_builtins.str]] = ..., ip_community_name: Optional[pulumi.Input[_builtins.str]] = ..., ip_community_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[IpCommunityRuleArgs, IpCommunityRuleArgsDict]]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: IpCommunityArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> IpCommunity:
