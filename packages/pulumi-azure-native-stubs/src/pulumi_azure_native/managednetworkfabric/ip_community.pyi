...
class IpCommunityArgs:
    ...
    def ip_community_rules(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input[IpCommunityRuleArgs]]]: ...
    @ip_community_rules.setter
    def ip_community_rules(
        self, value: pulumi.Input[Sequence[pulumi.Input[IpCommunityRuleArgs]]]
    ): ...
    @_builtins.property
...
class IpCommunity(pulumi.CustomResource):
    ...
    def __init__(
        ...
        annotation: Optional[pulumi.Input[_builtins.str]] = ...,
        ip_community_name: Optional[pulumi.Input[_builtins.str]] = ...,
        ip_community_rules: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[Union[IpCommunityRuleArgs, IpCommunityRuleArgsDict]]
                ]
            ]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def ip_community_rules(
        self,
    ) -> pulumi.Output[Sequence[outputs.IpCommunityRuleResponse]]: ...
    @_builtins.property
    @pulumi.getter
