...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetExternalNetworkResult', 'AwaitableGetExternalNetworkResult', 'get_external_network', 'get_external_network_output']
@pulumi.output_type
class GetExternalNetworkResult:
    
    def __init__(__self__, administrative_state=..., annotation=..., azure_api_version=..., configuration_state=..., export_route_policy=..., export_route_policy_id=..., id=..., import_route_policy=..., import_route_policy_id=..., name=..., network_to_network_interconnect_id=..., option_a_properties=..., option_b_properties=..., peering_option=..., provisioning_state=..., system_data=..., type=...) -> None:
        ...
...
class AwaitableGetExternalNetworkResult(GetExternalNetworkResult):
    def __await__(self): # -> Generator[Never, Any, GetExternalNetworkResult]:
        ...
    


def get_external_network(external_network_name: Optional[_builtins.str] = ..., l3_isolation_domain_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetExternalNetworkResult:
    
    ...

def get_external_network_output(external_network_name: Optional[pulumi.Input[_builtins.str]] = ..., l3_isolation_domain_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetExternalNetworkResult]:
