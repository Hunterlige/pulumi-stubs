...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetInternalNetworkResult', 'AwaitableGetInternalNetworkResult', 'get_internal_network', 'get_internal_network_output']
@pulumi.output_type
class GetInternalNetworkResult:
    
    def __init__(__self__, administrative_state=..., annotation=..., azure_api_version=..., bgp_configuration=..., configuration_state=..., connected_i_pv4_subnets=..., connected_i_pv6_subnets=..., egress_acl_id=..., export_route_policy=..., export_route_policy_id=..., extension=..., id=..., import_route_policy=..., import_route_policy_id=..., ingress_acl_id=..., is_monitoring_enabled=..., mtu=..., name=..., provisioning_state=..., static_route_configuration=..., system_data=..., type=..., vlan_id=...) -> None:
        ...
...
class AwaitableGetInternalNetworkResult(GetInternalNetworkResult):
    def __await__(self): # -> Generator[Never, Any, GetInternalNetworkResult]:
        ...
    


def get_internal_network(internal_network_name: Optional[_builtins.str] = ..., l3_isolation_domain_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetInternalNetworkResult:
    
    ...

def get_internal_network_output(internal_network_name: Optional[pulumi.Input[_builtins.str]] = ..., l3_isolation_domain_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetInternalNetworkResult]:
