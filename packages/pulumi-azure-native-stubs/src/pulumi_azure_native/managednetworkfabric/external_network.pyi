...
class ExternalNetworkArgs:
    def __init__(__self__, *, l3_isolation_domain_name: pulumi.Input[_builtins.str], peering_option: pulumi.Input[Union[_builtins.str, PeeringOption]], resource_group_name: pulumi.Input[_builtins.str], annotation: Optional[pulumi.Input[_builtins.str]] = ..., export_route_policy: Optional[pulumi.Input[ExportRoutePolicyArgs]] = ..., export_route_policy_id: Optional[pulumi.Input[_builtins.str]] = ..., external_network_name: Optional[pulumi.Input[_builtins.str]] = ..., import_route_policy: Optional[pulumi.Input[ImportRoutePolicyArgs]] = ..., import_route_policy_id: Optional[pulumi.Input[_builtins.str]] = ..., network_to_network_interconnect_id: Optional[pulumi.Input[_builtins.str]] = ..., option_a_properties: Optional[pulumi.Input[ExternalNetworkPropertiesOptionAPropertiesArgs]] = ..., option_b_properties: Optional[pulumi.Input[L3OptionBPropertiesArgs]] = ...) -> None:
    ...
    def external_network_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def option_a_properties(self, value: Optional[pulumi.Input[ExternalNetworkPropertiesOptionAPropertiesArgs]]): # -> None:
        ...
    ...
    def option_b_properties(self, value: Optional[pulumi.Input[L3OptionBPropertiesArgs]]): # -> None:
        ...
...
class ExternalNetwork(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., annotation: Optional[pulumi.Input[_builtins.str]] = ..., export_route_policy: Optional[pulumi.Input[Union[ExportRoutePolicyArgs, ExportRoutePolicyArgsDict]]] = ..., export_route_policy_id: Optional[pulumi.Input[_builtins.str]] = ..., external_network_name: Optional[pulumi.Input[_builtins.str]] = ..., import_route_policy: Optional[pulumi.Input[Union[ImportRoutePolicyArgs, ImportRoutePolicyArgsDict]]] = ..., import_route_policy_id: Optional[pulumi.Input[_builtins.str]] = ..., l3_isolation_domain_name: Optional[pulumi.Input[_builtins.str]] = ..., network_to_network_interconnect_id: Optional[pulumi.Input[_builtins.str]] = ..., option_a_properties: Optional[pulumi.Input[Union[ExternalNetworkPropertiesOptionAPropertiesArgs, ExternalNetworkPropertiesOptionAPropertiesArgsDict]]] = ..., option_b_properties: Optional[pulumi.Input[Union[L3OptionBPropertiesArgs, L3OptionBPropertiesArgsDict]]] = ..., peering_option: Optional[pulumi.Input[Union[_builtins.str, PeeringOption]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ExternalNetworkArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ExternalNetwork:
    ...
    @_builtins.property
    @pulumi.getter(name="networkToNetworkInterconnectId")
    def network_to_network_interconnect_id(self) -> pulumi.Output[Optional[_builtins.str]]:
