...
class AwaitableListSecurityAdvisoryImpactedResourceByTenantIdAndEventIdResult(ListSecurityAdvisoryImpactedResourceByTenantIdAndEventIdResult):
    def __await__(self): # -> Generator[Never, Any, ListSecurityAdvisoryImpactedResourceByTenantIdAndEventIdResult]:
        ...
    


def list_security_advisory_impacted_resource_by_tenant_id_and_event_id(event_tracking_id: Optional[_builtins.str] = ..., filter: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableListSecurityAdvisoryImpactedResourceByTenantIdAndEventIdResult:
    
    ...

def list_security_advisory_impacted_resource_by_tenant_id_and_event_id_output(event_tracking_id: Optional[pulumi.Input[_builtins.str]] = ..., filter: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[ListSecurityAdvisoryImpactedResourceByTenantIdAndEventIdResult]:
