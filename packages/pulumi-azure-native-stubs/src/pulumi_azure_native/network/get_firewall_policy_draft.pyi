...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetFirewallPolicyDraftResult', 'AwaitableGetFirewallPolicyDraftResult', 'get_firewall_policy_draft', 'get_firewall_policy_draft_output']
@pulumi.output_type
class GetFirewallPolicyDraftResult:
    
    def __init__(__self__, azure_api_version=..., base_policy=..., dns_settings=..., explicit_proxy=..., id=..., insights=..., intrusion_detection=..., location=..., name=..., snat=..., sql=..., tags=..., threat_intel_mode=..., threat_intel_whitelist=..., type=...) -> None:
        ...
...
class AwaitableGetFirewallPolicyDraftResult(GetFirewallPolicyDraftResult):
    def __await__(self): # -> Generator[Never, Any, GetFirewallPolicyDraftResult]:
        ...
    


def get_firewall_policy_draft(firewall_policy_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetFirewallPolicyDraftResult:
    
    ...

def get_firewall_policy_draft_output(firewall_policy_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetFirewallPolicyDraftResult]:
