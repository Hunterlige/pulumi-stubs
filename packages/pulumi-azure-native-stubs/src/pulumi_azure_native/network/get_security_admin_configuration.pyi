...
class GetSecurityAdminConfigurationResult:
    ...
    def network_group_address_space_aggregation_option(
        self,
...
) -> pulumi.Output[GetSecurityAdminConfigurationResult]: ...
