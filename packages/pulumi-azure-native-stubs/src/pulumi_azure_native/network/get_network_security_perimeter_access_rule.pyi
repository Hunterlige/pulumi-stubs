...
class GetNetworkSecurityPerimeterAccessRuleResult:
    ...
    def network_security_perimeters(
        self,
    ) -> Sequence[outputs.PerimeterBasedAccessRuleResponse]: ...
    @_builtins.property
...
class AwaitableGetNetworkSecurityPerimeterAccessRuleResult(
    GetNetworkSecurityPerimeterAccessRuleResult
):
    def __await__(self): ...

def get_network_security_perimeter_access_rule(
    access_rule_name: Optional[_builtins.str] = ...,
...
def get_network_security_perimeter_access_rule_output(
...
) -> pulumi.Output[GetNetworkSecurityPerimeterAccessRuleResult]: ...
