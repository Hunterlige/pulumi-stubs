...
class VirtualNetworkGatewayNatRuleInitArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], virtual_network_gateway_name: pulumi.Input[_builtins.str], external_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[VpnNatRuleMappingArgs]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., internal_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[VpnNatRuleMappingArgs]]]] = ..., ip_configuration_id: Optional[pulumi.Input[_builtins.str]] = ..., mode: Optional[pulumi.Input[Union[_builtins.str, VpnNatRuleMode]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., nat_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, VpnNatRuleType]]] = ...) -> None:
    ...
    def virtual_network_gateway_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def nat_rule_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VirtualNetworkGatewayNatRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., external_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[VpnNatRuleMappingArgs, VpnNatRuleMappingArgsDict]]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., internal_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[VpnNatRuleMappingArgs, VpnNatRuleMappingArgsDict]]]]] = ..., ip_configuration_id: Optional[pulumi.Input[_builtins.str]] = ..., mode: Optional[pulumi.Input[Union[_builtins.str, VpnNatRuleMode]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., nat_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, VpnNatRuleType]]] = ..., virtual_network_gateway_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: VirtualNetworkGatewayNatRuleInitArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> VirtualNetworkGatewayNatRule:
