...
class VpnServerConfigurationArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[VpnServerConfigurationPropertiesArgs]] = ...,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[VpnServerConfigurationPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[VpnServerConfigurationPropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
    ...
    def vpn_server_configuration_name(
        self,
...
class VpnServerConfiguration(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.VpnServerConfigurationPropertiesResponse]: ...
    @_builtins.property
    @pulumi.getter
