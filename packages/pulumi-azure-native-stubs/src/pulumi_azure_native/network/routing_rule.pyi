...
class RoutingRuleArgs:
    def __init__(__self__, *, configuration_name: pulumi.Input[_builtins.str], destination: pulumi.Input[RoutingRuleRouteDestinationArgs], network_manager_name: pulumi.Input[_builtins.str], next_hop: pulumi.Input[RoutingRuleNextHopArgs], resource_group_name: pulumi.Input[_builtins.str], rule_collection_name: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., rule_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @destination.setter
    def destination(self, value: pulumi.Input[RoutingRuleRouteDestinationArgs]): # -> None:
        ...
    ...
    @next_hop.setter
    def next_hop(self, value: pulumi.Input[RoutingRuleNextHopArgs]): # -> None:
        ...
...
class RoutingRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., configuration_name: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination: Optional[pulumi.Input[Union[RoutingRuleRouteDestinationArgs, RoutingRuleRouteDestinationArgsDict]]] = ..., network_manager_name: Optional[pulumi.Input[_builtins.str]] = ..., next_hop: Optional[pulumi.Input[Union[RoutingRuleNextHopArgs, RoutingRuleNextHopArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., rule_collection_name: Optional[pulumi.Input[_builtins.str]] = ..., rule_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> RoutingRule:
