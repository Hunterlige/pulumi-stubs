...
class ExpressRouteCircuitPeeringInitArgs:
    def __init__(__self__, *, circuit_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], azure_asn: Optional[pulumi.Input[_builtins.int]] = ..., connections: Optional[pulumi.Input[Sequence[pulumi.Input[ExpressRouteCircuitConnectionArgs]]]] = ..., gateway_manager_etag: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., ipv6_peering_config: Optional[pulumi.Input[Ipv6ExpressRouteCircuitPeeringConfigArgs]] = ..., microsoft_peering_config: Optional[pulumi.Input[ExpressRouteCircuitPeeringConfigArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., peer_asn: Optional[pulumi.Input[_builtins.float]] = ..., peering_name: Optional[pulumi.Input[_builtins.str]] = ..., peering_type: Optional[pulumi.Input[Union[_builtins.str, ExpressRoutePeeringType]]] = ..., primary_azure_port: Optional[pulumi.Input[_builtins.str]] = ..., primary_peer_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., route_filter: Optional[pulumi.Input[SubResourceArgs]] = ..., secondary_azure_port: Optional[pulumi.Input[_builtins.str]] = ..., secondary_peer_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., shared_key: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, ExpressRoutePeeringState]]] = ..., stats: Optional[pulumi.Input[ExpressRouteCircuitStatsArgs]] = ..., vlan_id: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ExpressRouteCircuitPeering(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., azure_asn: Optional[pulumi.Input[_builtins.int]] = ..., circuit_name: Optional[pulumi.Input[_builtins.str]] = ..., connections: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ExpressRouteCircuitConnectionArgs, ExpressRouteCircuitConnectionArgsDict]]]]] = ..., gateway_manager_etag: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., ipv6_peering_config: Optional[pulumi.Input[Union[Ipv6ExpressRouteCircuitPeeringConfigArgs, Ipv6ExpressRouteCircuitPeeringConfigArgsDict]]] = ..., microsoft_peering_config: Optional[pulumi.Input[Union[ExpressRouteCircuitPeeringConfigArgs, ExpressRouteCircuitPeeringConfigArgsDict]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., peer_asn: Optional[pulumi.Input[_builtins.float]] = ..., peering_name: Optional[pulumi.Input[_builtins.str]] = ..., peering_type: Optional[pulumi.Input[Union[_builtins.str, ExpressRoutePeeringType]]] = ..., primary_azure_port: Optional[pulumi.Input[_builtins.str]] = ..., primary_peer_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., route_filter: Optional[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]] = ..., secondary_azure_port: Optional[pulumi.Input[_builtins.str]] = ..., secondary_peer_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., shared_key: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, ExpressRoutePeeringState]]] = ..., stats: Optional[pulumi.Input[Union[ExpressRouteCircuitStatsArgs, ExpressRouteCircuitStatsArgsDict]]] = ..., vlan_id: Optional[pulumi.Input[_builtins.int]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ExpressRouteCircuitPeeringInitArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ExpressRouteCircuitPeering:
