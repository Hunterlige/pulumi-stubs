...
class GetPrivateEndpointResult:
    ...
    def __init__(__self__, application_security_groups=..., azure_api_version=..., custom_dns_configs=..., custom_network_interface_name=..., etag=..., extended_location=..., id=..., ip_configurations=..., location=..., manual_private_link_service_connections=..., name=..., network_interfaces=..., private_link_service_connections=..., provisioning_state=..., subnet=..., tags=..., type=...) -> None:
        ...
...
def get_private_endpoint(expand: Optional[_builtins.str] = ..., private_endpoint_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetPrivateEndpointResult:
    
    ...

def get_private_endpoint_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., private_endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetPrivateEndpointResult]:
