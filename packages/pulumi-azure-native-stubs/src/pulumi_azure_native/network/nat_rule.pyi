...
class NatRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., external_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[VpnNatRuleMappingArgs, VpnNatRuleMappingArgsDict]]]]] = ..., gateway_name: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., internal_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[VpnNatRuleMappingArgs, VpnNatRuleMappingArgsDict]]]]] = ..., ip_configuration_id: Optional[pulumi.Input[_builtins.str]] = ..., mode: Optional[pulumi.Input[Union[_builtins.str, VpnNatRuleMode]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., nat_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, VpnNatRuleType]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: NatRuleInitArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> NatRule:
