...
class GetVirtualNetworkGatewayVpnclientIpsecParametersResult:
    ...
    def __init__(__self__, dh_group=..., ike_encryption=..., ike_integrity=..., ipsec_encryption=..., ipsec_integrity=..., pfs_group=..., sa_data_size_kilobytes=..., sa_life_time_seconds=...) -> None:
        ...
...
class AwaitableGetVirtualNetworkGatewayVpnclientIpsecParametersResult(GetVirtualNetworkGatewayVpnclientIpsecParametersResult):
    def __await__(self): # -> Generator[Never, Any, GetVirtualNetworkGatewayVpnclientIpsecParametersResult]:
        ...
    


def get_virtual_network_gateway_vpnclient_ipsec_parameters(resource_group_name: Optional[_builtins.str] = ..., virtual_network_gateway_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetVirtualNetworkGatewayVpnclientIpsecParametersResult:
    
    ...

def get_virtual_network_gateway_vpnclient_ipsec_parameters_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., virtual_network_gateway_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetVirtualNetworkGatewayVpnclientIpsecParametersResult]:
