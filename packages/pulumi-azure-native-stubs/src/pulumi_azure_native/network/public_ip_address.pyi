...
class PublicIPAddressInitArgs:
    ...
    def public_ip_address_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PublicIPAddress(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., ddos_settings: Optional[pulumi.Input[Union[DdosSettingsArgs, DdosSettingsArgsDict]]] = ..., delete_option: Optional[pulumi.Input[Union[_builtins.str, DeleteOptions]]] = ..., dns_settings: Optional[pulumi.Input[Union[PublicIPAddressDnsSettingsArgs, PublicIPAddressDnsSettingsArgsDict]]] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationArgs, ExtendedLocationArgsDict]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., idle_timeout_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., ip_tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union[IpTagArgs, IpTagArgsDict]]]]] = ..., linked_public_ip_address: Optional[pulumi.Input[Union[PublicIPAddressArgs, PublicIPAddressArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., migration_phase: Optional[pulumi.Input[Union[_builtins.str, PublicIPAddressMigrationPhase]]] = ..., nat_gateway: Optional[pulumi.Input[Union[NatGatewayArgs, NatGatewayArgsDict]]] = ..., public_ip_address_version: Optional[pulumi.Input[Union[_builtins.str, IPVersion]]] = ..., public_ip_allocation_method: Optional[pulumi.Input[Union[_builtins.str, IPAllocationMethod]]] = ..., public_ip_prefix: Optional[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]] = ..., public_ip_address_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., service_public_ip_address: Optional[pulumi.Input[Union[PublicIPAddressArgs, PublicIPAddressArgsDict]]] = ..., sku: Optional[pulumi.Input[Union[PublicIPAddressSkuArgs, PublicIPAddressSkuArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: PublicIPAddressInitArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> PublicIPAddress:
