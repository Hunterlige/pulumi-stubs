...
class NetworkInterfaceArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], auxiliary_mode: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceAuxiliaryMode]]] = ..., auxiliary_sku: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceAuxiliarySku]]] = ..., disable_tcp_state_tracking: Optional[pulumi.Input[_builtins.bool]] = ..., dns_settings: Optional[pulumi.Input[NetworkInterfaceDnsSettingsArgs]] = ..., enable_accelerated_networking: Optional[pulumi.Input[_builtins.bool]] = ..., enable_ip_forwarding: Optional[pulumi.Input[_builtins.bool]] = ..., extended_location: Optional[pulumi.Input[ExtendedLocationArgs]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., ip_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkInterfaceIPConfigurationArgs]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., migration_phase: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceMigrationPhase]]] = ..., network_interface_name: Optional[pulumi.Input[_builtins.str]] = ..., network_security_group: Optional[pulumi.Input[NetworkSecurityGroupArgs]] = ..., nic_type: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceNicType]]] = ..., private_link_service: Optional[pulumi.Input[PrivateLinkServiceArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., workload_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @dns_settings.setter
    def dns_settings(self, value: Optional[pulumi.Input[NetworkInterfaceDnsSettingsArgs]]): # -> None:
        ...
    ...
    def migration_phase(self, value: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceMigrationPhase]]]): # -> None:
        ...
    ...
    @nic_type.setter
    def nic_type(self, value: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceNicType]]]): # -> None:
        ...
    ...
    def private_link_service(self, value: Optional[pulumi.Input[PrivateLinkServiceArgs]]): # -> None:
        ...
...
class NetworkInterface(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., auxiliary_mode: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceAuxiliaryMode]]] = ..., auxiliary_sku: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceAuxiliarySku]]] = ..., disable_tcp_state_tracking: Optional[pulumi.Input[_builtins.bool]] = ..., dns_settings: Optional[pulumi.Input[Union[NetworkInterfaceDnsSettingsArgs, NetworkInterfaceDnsSettingsArgsDict]]] = ..., enable_accelerated_networking: Optional[pulumi.Input[_builtins.bool]] = ..., enable_ip_forwarding: Optional[pulumi.Input[_builtins.bool]] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationArgs, ExtendedLocationArgsDict]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., ip_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[NetworkInterfaceIPConfigurationArgs, NetworkInterfaceIPConfigurationArgsDict]]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., migration_phase: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceMigrationPhase]]] = ..., network_interface_name: Optional[pulumi.Input[_builtins.str]] = ..., network_security_group: Optional[pulumi.Input[Union[NetworkSecurityGroupArgs, NetworkSecurityGroupArgsDict]]] = ..., nic_type: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceNicType]]] = ..., private_link_service: Optional[pulumi.Input[Union[PrivateLinkServiceArgs, PrivateLinkServiceArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., workload_type: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    def default_outbound_connectivity_enabled(self) -> pulumi.Output[_builtins.bool]:
