...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetPublicIPAddressResult', 'AwaitableGetPublicIPAddressResult', 'get_public_ip_address', 'get_public_ip_address_output']
@pulumi.output_type
class GetPublicIPAddressResult:
    
    def __init__(__self__, azure_api_version=..., ddos_settings=..., delete_option=..., dns_settings=..., etag=..., extended_location=..., id=..., idle_timeout_in_minutes=..., ip_address=..., ip_configuration=..., ip_tags=..., linked_public_ip_address=..., location=..., migration_phase=..., name=..., nat_gateway=..., provisioning_state=..., public_ip_address_version=..., public_ip_allocation_method=..., public_ip_prefix=..., resource_guid=..., service_public_ip_address=..., sku=..., tags=..., type=..., zones=...) -> None:
        ...
...
class AwaitableGetPublicIPAddressResult(GetPublicIPAddressResult):
    def __await__(self): # -> Generator[Never, Any, GetPublicIPAddressResult]:
        ...
    


def get_public_ip_address(expand: Optional[_builtins.str] = ..., public_ip_address_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetPublicIPAddressResult:
    
    ...

def get_public_ip_address_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., public_ip_address_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetPublicIPAddressResult]:
