...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetNspAccessRuleResult', 'AwaitableGetNspAccessRuleResult', 'get_nsp_access_rule', 'get_nsp_access_rule_output']
@pulumi.output_type
...
class AwaitableGetNspAccessRuleResult(GetNspAccessRuleResult):
    def __await__(self): # -> Generator[Never, Any, GetNspAccessRuleResult]:
        ...
    


def get_nsp_access_rule(access_rule_name: Optional[_builtins.str] = ..., network_security_perimeter_name: Optional[_builtins.str] = ..., profile_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetNspAccessRuleResult:
    
    ...

def get_nsp_access_rule_output(access_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., network_security_perimeter_name: Optional[pulumi.Input[_builtins.str]] = ..., profile_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetNspAccessRuleResult]:
