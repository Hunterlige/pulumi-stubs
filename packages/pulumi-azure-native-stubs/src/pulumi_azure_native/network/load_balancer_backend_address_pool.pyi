...
class LoadBalancerBackendAddressPoolArgs:
    def __init__(__self__, *, load_balancer_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], backend_address_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., drain_period_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., load_balancer_backend_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[LoadBalancerBackendAddressArgs]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., sync_mode: Optional[pulumi.Input[Union[_builtins.str, SyncMode]]] = ..., tunnel_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[GatewayLoadBalancerTunnelInterfaceArgs]]]] = ..., virtual_network: Optional[pulumi.Input[SubResourceArgs]] = ...) -> None:
    ...
    def backend_address_pool_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LoadBalancerBackendAddressPool(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., backend_address_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., drain_period_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., load_balancer_backend_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[Union[LoadBalancerBackendAddressArgs, LoadBalancerBackendAddressArgsDict]]]]] = ..., load_balancer_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sync_mode: Optional[pulumi.Input[Union[_builtins.str, SyncMode]]] = ..., tunnel_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[Union[GatewayLoadBalancerTunnelInterfaceArgs, GatewayLoadBalancerTunnelInterfaceArgsDict]]]]] = ..., virtual_network: Optional[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: LoadBalancerBackendAddressPoolArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> LoadBalancerBackendAddressPool:
