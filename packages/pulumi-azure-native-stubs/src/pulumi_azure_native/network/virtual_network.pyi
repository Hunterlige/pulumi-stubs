...
class VirtualNetworkInitArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], address_space: Optional[pulumi.Input[AddressSpaceArgs]] = ..., bgp_communities: Optional[pulumi.Input[VirtualNetworkBgpCommunitiesArgs]] = ..., ddos_protection_plan: Optional[pulumi.Input[SubResourceArgs]] = ..., dhcp_options: Optional[pulumi.Input[DhcpOptionsArgs]] = ..., enable_ddos_protection: Optional[pulumi.Input[_builtins.bool]] = ..., enable_vm_protection: Optional[pulumi.Input[_builtins.bool]] = ..., encryption: Optional[pulumi.Input[VirtualNetworkEncryptionArgs]] = ..., extended_location: Optional[pulumi.Input[ExtendedLocationArgs]] = ..., flow_timeout_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., ip_allocations: Optional[pulumi.Input[Sequence[pulumi.Input[SubResourceArgs]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint_v_net_policies: Optional[pulumi.Input[Union[_builtins.str, PrivateEndpointVNetPolicies]]] = ..., subnets: Optional[pulumi.Input[Sequence[pulumi.Input[SubnetArgs]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., virtual_network_name: Optional[pulumi.Input[_builtins.str]] = ..., virtual_network_peerings: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualNetworkPeeringArgs]]]] = ...) -> None:
...
class VirtualNetwork(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., address_space: Optional[pulumi.Input[Union[AddressSpaceArgs, AddressSpaceArgsDict]]] = ..., bgp_communities: Optional[pulumi.Input[Union[VirtualNetworkBgpCommunitiesArgs, VirtualNetworkBgpCommunitiesArgsDict]]] = ..., ddos_protection_plan: Optional[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]] = ..., dhcp_options: Optional[pulumi.Input[Union[DhcpOptionsArgs, DhcpOptionsArgsDict]]] = ..., enable_ddos_protection: Optional[pulumi.Input[_builtins.bool]] = ..., enable_vm_protection: Optional[pulumi.Input[_builtins.bool]] = ..., encryption: Optional[pulumi.Input[Union[VirtualNetworkEncryptionArgs, VirtualNetworkEncryptionArgsDict]]] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationArgs, ExtendedLocationArgsDict]]] = ..., flow_timeout_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., ip_allocations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint_v_net_policies: Optional[pulumi.Input[Union[_builtins.str, PrivateEndpointVNetPolicies]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., subnets: Optional[pulumi.Input[Sequence[pulumi.Input[Union[SubnetArgs, SubnetArgsDict]]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., virtual_network_name: Optional[pulumi.Input[_builtins.str]] = ..., virtual_network_peerings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[VirtualNetworkPeeringArgs, VirtualNetworkPeeringArgsDict]]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: VirtualNetworkInitArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @_builtins.property
    @pulumi.getter(name="privateEndpointVNetPolicies")
    def private_endpoint_v_net_policies(self) -> pulumi.Output[Optional[_builtins.str]]:
