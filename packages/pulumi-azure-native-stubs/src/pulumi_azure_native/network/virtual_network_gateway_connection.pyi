...
class VirtualNetworkGatewayConnectionArgs:
    def __init__(__self__, *, connection_type: pulumi.Input[Union[_builtins.str, VirtualNetworkGatewayConnectionType]], resource_group_name: pulumi.Input[_builtins.str], virtual_network_gateway1: pulumi.Input[VirtualNetworkGatewayArgs], authorization_key: Optional[pulumi.Input[_builtins.str]] = ..., connection_mode: Optional[pulumi.Input[Union[_builtins.str, VirtualNetworkGatewayConnectionMode]]] = ..., connection_protocol: Optional[pulumi.Input[Union[_builtins.str, VirtualNetworkGatewayConnectionProtocol]]] = ..., dpd_timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ..., egress_nat_rules: Optional[pulumi.Input[Sequence[pulumi.Input[SubResourceArgs]]]] = ..., enable_bgp: Optional[pulumi.Input[_builtins.bool]] = ..., enable_private_link_fast_path: Optional[pulumi.Input[_builtins.bool]] = ..., express_route_gateway_bypass: Optional[pulumi.Input[_builtins.bool]] = ..., gateway_custom_bgp_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[GatewayCustomBgpIpAddressIpConfigurationArgs]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., ingress_nat_rules: Optional[pulumi.Input[Sequence[pulumi.Input[SubResourceArgs]]]] = ..., ipsec_policies: Optional[pulumi.Input[Sequence[pulumi.Input[IpsecPolicyArgs]]]] = ..., local_network_gateway2: Optional[pulumi.Input[LocalNetworkGatewayArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., peer: Optional[pulumi.Input[SubResourceArgs]] = ..., routing_weight: Optional[pulumi.Input[_builtins.int]] = ..., shared_key: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., traffic_selector_policies: Optional[pulumi.Input[Sequence[pulumi.Input[TrafficSelectorPolicyArgs]]]] = ..., use_local_azure_ip_address: Optional[pulumi.Input[_builtins.bool]] = ..., use_policy_based_traffic_selectors: Optional[pulumi.Input[_builtins.bool]] = ..., virtual_network_gateway2: Optional[pulumi.Input[VirtualNetworkGatewayArgs]] = ..., virtual_network_gateway_connection_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def connection_type(self, value: pulumi.Input[Union[_builtins.str, VirtualNetworkGatewayConnectionType]]): # -> None:
        ...
    ...
    def virtual_network_gateway1(self, value: pulumi.Input[VirtualNetworkGatewayArgs]): # -> None:
        ...
    ...
    def connection_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, VirtualNetworkGatewayConnectionMode]]]): # -> None:
        ...
    ...
    def connection_protocol(self, value: Optional[pulumi.Input[Union[_builtins.str, VirtualNetworkGatewayConnectionProtocol]]]): # -> None:
        ...
    ...
    def gateway_custom_bgp_ip_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[GatewayCustomBgpIpAddressIpConfigurationArgs]]]]): # -> None:
        ...
    ...
    def local_network_gateway2(self, value: Optional[pulumi.Input[LocalNetworkGatewayArgs]]): # -> None:
        ...
    ...
    @peer.setter
    def peer(self, value: Optional[pulumi.Input[SubResourceArgs]]): # -> None:
        ...
    ...
    def virtual_network_gateway2(self, value: Optional[pulumi.Input[VirtualNetworkGatewayArgs]]): # -> None:
        ...
    ...
    def virtual_network_gateway_connection_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VirtualNetworkGatewayConnection(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., authorization_key: Optional[pulumi.Input[_builtins.str]] = ..., connection_mode: Optional[pulumi.Input[Union[_builtins.str, VirtualNetworkGatewayConnectionMode]]] = ..., connection_protocol: Optional[pulumi.Input[Union[_builtins.str, VirtualNetworkGatewayConnectionProtocol]]] = ..., connection_type: Optional[pulumi.Input[Union[_builtins.str, VirtualNetworkGatewayConnectionType]]] = ..., dpd_timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ..., egress_nat_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]]]] = ..., enable_bgp: Optional[pulumi.Input[_builtins.bool]] = ..., enable_private_link_fast_path: Optional[pulumi.Input[_builtins.bool]] = ..., express_route_gateway_bypass: Optional[pulumi.Input[_builtins.bool]] = ..., gateway_custom_bgp_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[Union[GatewayCustomBgpIpAddressIpConfigurationArgs, GatewayCustomBgpIpAddressIpConfigurationArgsDict]]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., ingress_nat_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]]]] = ..., ipsec_policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union[IpsecPolicyArgs, IpsecPolicyArgsDict]]]]] = ..., local_network_gateway2: Optional[pulumi.Input[Union[LocalNetworkGatewayArgs, LocalNetworkGatewayArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., peer: Optional[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., routing_weight: Optional[pulumi.Input[_builtins.int]] = ..., shared_key: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., traffic_selector_policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union[TrafficSelectorPolicyArgs, TrafficSelectorPolicyArgsDict]]]]] = ..., use_local_azure_ip_address: Optional[pulumi.Input[_builtins.bool]] = ..., use_policy_based_traffic_selectors: Optional[pulumi.Input[_builtins.bool]] = ..., virtual_network_gateway1: Optional[pulumi.Input[Union[VirtualNetworkGatewayArgs, VirtualNetworkGatewayArgsDict]]] = ..., virtual_network_gateway2: Optional[pulumi.Input[Union[VirtualNetworkGatewayArgs, VirtualNetworkGatewayArgsDict]]] = ..., virtual_network_gateway_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: VirtualNetworkGatewayConnectionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> VirtualNetworkGatewayConnection:
