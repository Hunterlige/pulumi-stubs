...
class GetVirtualNetworkResult:
    ...
    def __init__(__self__, address_space=..., azure_api_version=..., bgp_communities=..., ddos_protection_plan=..., dhcp_options=..., enable_ddos_protection=..., enable_vm_protection=..., encryption=..., etag=..., extended_location=..., flow_logs=..., flow_timeout_in_minutes=..., id=..., ip_allocations=..., location=..., name=..., private_endpoint_v_net_policies=..., provisioning_state=..., resource_guid=..., subnets=..., tags=..., type=..., virtual_network_peerings=...) -> None:
        ...
...
def get_virtual_network(expand: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., virtual_network_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetVirtualNetworkResult:
    
    ...

def get_virtual_network_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., virtual_network_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetVirtualNetworkResult]:
