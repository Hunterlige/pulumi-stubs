...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetApplicationGatewayResult', 'AwaitableGetApplicationGatewayResult', 'get_application_gateway', 'get_application_gateway_output']
@pulumi.output_type
class GetApplicationGatewayResult:
    
    def __init__(__self__, authentication_certificates=..., autoscale_configuration=..., azure_api_version=..., backend_address_pools=..., backend_http_settings_collection=..., backend_settings_collection=..., custom_error_configurations=..., default_predefined_ssl_policy=..., enable_fips=..., enable_http2=..., etag=..., firewall_policy=..., force_firewall_policy_association=..., frontend_ip_configurations=..., frontend_ports=..., gateway_ip_configurations=..., global_configuration=..., http_listeners=..., id=..., identity=..., listeners=..., load_distribution_policies=..., location=..., name=..., operational_state=..., private_endpoint_connections=..., private_link_configurations=..., probes=..., provisioning_state=..., redirect_configurations=..., request_routing_rules=..., resource_guid=..., rewrite_rule_sets=..., routing_rules=..., sku=..., ssl_certificates=..., ssl_policy=..., ssl_profiles=..., tags=..., trusted_client_certificates=..., trusted_root_certificates=..., type=..., url_path_maps=..., web_application_firewall_configuration=..., zones=...) -> None:
        ...
...
class AwaitableGetApplicationGatewayResult(GetApplicationGatewayResult):
    def __await__(self): # -> Generator[Never, Any, GetApplicationGatewayResult]:
        ...
    


def get_application_gateway(application_gateway_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetApplicationGatewayResult:
    
    ...

def get_application_gateway_output(application_gateway_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetApplicationGatewayResult]:
