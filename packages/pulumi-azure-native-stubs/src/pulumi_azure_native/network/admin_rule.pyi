...
class AdminRuleArgs:
    ...
    @access.setter
    def access(self, value: pulumi.Input[Union[_builtins.str, SecurityConfigurationRuleAccess]]): # -> None:
        ...
...
class AdminRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., access: Optional[pulumi.Input[Union[_builtins.str, SecurityConfigurationRuleAccess]]] = ..., configuration_name: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., destinations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AddressPrefixItemArgs, AddressPrefixItemArgsDict]]]]] = ..., direction: Optional[pulumi.Input[Union[_builtins.str, SecurityConfigurationRuleDirection]]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., network_manager_name: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.int]] = ..., protocol: Optional[pulumi.Input[Union[_builtins.str, SecurityConfigurationRuleProtocol]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., rule_collection_name: Optional[pulumi.Input[_builtins.str]] = ..., rule_name: Optional[pulumi.Input[_builtins.str]] = ..., source_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., sources: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AddressPrefixItemArgs, AddressPrefixItemArgsDict]]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: AdminRuleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> AdminRule:
