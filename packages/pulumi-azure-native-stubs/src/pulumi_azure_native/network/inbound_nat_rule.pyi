...
class InboundNatRuleInitArgs:
    def __init__(__self__, *, load_balancer_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], backend_address_pool: Optional[pulumi.Input[SubResourceArgs]] = ..., backend_port: Optional[pulumi.Input[_builtins.int]] = ..., enable_floating_ip: Optional[pulumi.Input[_builtins.bool]] = ..., enable_tcp_reset: Optional[pulumi.Input[_builtins.bool]] = ..., frontend_ip_configuration: Optional[pulumi.Input[SubResourceArgs]] = ..., frontend_port: Optional[pulumi.Input[_builtins.int]] = ..., frontend_port_range_end: Optional[pulumi.Input[_builtins.int]] = ..., frontend_port_range_start: Optional[pulumi.Input[_builtins.int]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., idle_timeout_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., inbound_nat_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., protocol: Optional[pulumi.Input[Union[_builtins.str, TransportProtocol]]] = ...) -> None:
    ...
    def inbound_nat_rule_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InboundNatRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., backend_address_pool: Optional[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]] = ..., backend_port: Optional[pulumi.Input[_builtins.int]] = ..., enable_floating_ip: Optional[pulumi.Input[_builtins.bool]] = ..., enable_tcp_reset: Optional[pulumi.Input[_builtins.bool]] = ..., frontend_ip_configuration: Optional[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]] = ..., frontend_port: Optional[pulumi.Input[_builtins.int]] = ..., frontend_port_range_end: Optional[pulumi.Input[_builtins.int]] = ..., frontend_port_range_start: Optional[pulumi.Input[_builtins.int]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., idle_timeout_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., inbound_nat_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., load_balancer_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., protocol: Optional[pulumi.Input[Union[_builtins.str, TransportProtocol]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: InboundNatRuleInitArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> InboundNatRule:
