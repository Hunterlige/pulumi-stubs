...
class PrivateEndpointArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], application_security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationSecurityGroupArgs]]]] = ..., custom_dns_configs: Optional[pulumi.Input[Sequence[pulumi.Input[CustomDnsConfigPropertiesFormatArgs]]]] = ..., custom_network_interface_name: Optional[pulumi.Input[_builtins.str]] = ..., extended_location: Optional[pulumi.Input[ExtendedLocationArgs]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., ip_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateEndpointIPConfigurationArgs]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., manual_private_link_service_connections: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateLinkServiceConnectionArgs]]]] = ..., private_endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., private_link_service_connections: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateLinkServiceConnectionArgs]]]] = ..., subnet: Optional[pulumi.Input[SubnetArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def custom_dns_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CustomDnsConfigPropertiesFormatArgs]]]]): # -> None:
        ...
    ...
    def custom_network_interface_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ip_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateEndpointIPConfigurationArgs]]]]): # -> None:
        ...
...
class PrivateEndpoint(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., application_security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ApplicationSecurityGroupArgs, ApplicationSecurityGroupArgsDict]]]]] = ..., custom_dns_configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union[CustomDnsConfigPropertiesFormatArgs, CustomDnsConfigPropertiesFormatArgsDict]]]]] = ..., custom_network_interface_name: Optional[pulumi.Input[_builtins.str]] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationArgs, ExtendedLocationArgsDict]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., ip_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[PrivateEndpointIPConfigurationArgs, PrivateEndpointIPConfigurationArgsDict]]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., manual_private_link_service_connections: Optional[pulumi.Input[Sequence[pulumi.Input[Union[PrivateLinkServiceConnectionArgs, PrivateLinkServiceConnectionArgsDict]]]]] = ..., private_endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., private_link_service_connections: Optional[pulumi.Input[Sequence[pulumi.Input[Union[PrivateLinkServiceConnectionArgs, PrivateLinkServiceConnectionArgsDict]]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., subnet: Optional[pulumi.Input[Union[SubnetArgs, SubnetArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
