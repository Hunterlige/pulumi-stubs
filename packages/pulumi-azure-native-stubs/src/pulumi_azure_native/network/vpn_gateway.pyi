...
class VpnGatewayArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], bgp_settings: Optional[pulumi.Input[BgpSettingsArgs]] = ..., connections: Optional[pulumi.Input[Sequence[pulumi.Input[VpnConnectionArgs]]]] = ..., enable_bgp_route_translation_for_nat: Optional[pulumi.Input[_builtins.bool]] = ..., gateway_name: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., is_routing_preference_internet: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., nat_rules: Optional[pulumi.Input[Sequence[pulumi.Input[VpnGatewayNatRuleArgs]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., virtual_hub: Optional[pulumi.Input[SubResourceArgs]] = ..., vpn_gateway_scale_unit: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @connections.setter
    def connections(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VpnConnectionArgs]]]]): # -> None:
        ...
    ...
    @nat_rules.setter
    def nat_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VpnGatewayNatRuleArgs]]]]): # -> None:
        ...
...
class VpnGateway(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., bgp_settings: Optional[pulumi.Input[Union[BgpSettingsArgs, BgpSettingsArgsDict]]] = ..., connections: Optional[pulumi.Input[Sequence[pulumi.Input[Union[VpnConnectionArgs, VpnConnectionArgsDict]]]]] = ..., enable_bgp_route_translation_for_nat: Optional[pulumi.Input[_builtins.bool]] = ..., gateway_name: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., is_routing_preference_internet: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., nat_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[VpnGatewayNatRuleArgs, VpnGatewayNatRuleArgsDict]]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., virtual_hub: Optional[pulumi.Input[Union[SubResourceArgs, SubResourceArgsDict]]] = ..., vpn_gateway_scale_unit: Optional[pulumi.Input[_builtins.int]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: VpnGatewayArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> VpnGateway:
