...
class ServiceEndpointPolicyInitArgs:
    ...
    def service_endpoint_policy_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceEndpointPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., contextual_service_endpoint_policies: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., service_alias: Optional[pulumi.Input[_builtins.str]] = ..., service_endpoint_policy_definitions: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ServiceEndpointPolicyDefinitionArgs, ServiceEndpointPolicyDefinitionArgsDict]]]]] = ..., service_endpoint_policy_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ServiceEndpointPolicyInitArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ServiceEndpointPolicy:
