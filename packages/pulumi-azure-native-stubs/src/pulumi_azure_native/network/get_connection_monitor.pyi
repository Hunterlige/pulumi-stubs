...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetConnectionMonitorResult', 'AwaitableGetConnectionMonitorResult', 'get_connection_monitor', 'get_connection_monitor_output']
@pulumi.output_type
class GetConnectionMonitorResult:
    
    def __init__(__self__, auto_start=..., azure_api_version=..., connection_monitor_type=..., destination=..., endpoints=..., etag=..., id=..., location=..., monitoring_interval_in_seconds=..., monitoring_status=..., name=..., notes=..., outputs=..., provisioning_state=..., source=..., start_time=..., tags=..., test_configurations=..., test_groups=..., type=...) -> None:
        ...
...
class AwaitableGetConnectionMonitorResult(GetConnectionMonitorResult):
    def __await__(self): # -> Generator[Never, Any, GetConnectionMonitorResult]:
        ...
    


def get_connection_monitor(connection_monitor_name: Optional[_builtins.str] = ..., network_watcher_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetConnectionMonitorResult:
    
    ...

def get_connection_monitor_output(connection_monitor_name: Optional[pulumi.Input[_builtins.str]] = ..., network_watcher_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetConnectionMonitorResult]:
