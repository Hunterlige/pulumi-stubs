...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetDefaultAdminRuleResult', 'AwaitableGetDefaultAdminRuleResult', 'get_default_admin_rule', 'get_default_admin_rule_output']
@pulumi.output_type
class GetDefaultAdminRuleResult:
    
    def __init__(__self__, access=..., azure_api_version=..., description=..., destination_port_ranges=..., destinations=..., direction=..., etag=..., flag=..., id=..., kind=..., name=..., priority=..., protocol=..., provisioning_state=..., resource_guid=..., source_port_ranges=..., sources=..., system_data=..., type=...) -> None:
        ...
