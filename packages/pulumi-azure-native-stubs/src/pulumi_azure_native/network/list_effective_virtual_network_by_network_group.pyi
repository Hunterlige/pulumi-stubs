...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ListEffectiveVirtualNetworkByNetworkGroupResult', ..., 'list_effective_virtual_network_by_network_group', ...]
@pulumi.output_type
...
class AwaitableListEffectiveVirtualNetworkByNetworkGroupResult(ListEffectiveVirtualNetworkByNetworkGroupResult):
    def __await__(self): # -> Generator[Never, Any, ListEffectiveVirtualNetworkByNetworkGroupResult]:
        ...
    


def list_effective_virtual_network_by_network_group(network_group_name: Optional[_builtins.str] = ..., network_manager_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., skip_token: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableListEffectiveVirtualNetworkByNetworkGroupResult:
    
    ...

def list_effective_virtual_network_by_network_group_output(network_group_name: Optional[pulumi.Input[_builtins.str]] = ..., network_manager_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., skip_token: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[ListEffectiveVirtualNetworkByNetworkGroupResult]:
