...
class LocalNetworkGatewayInitArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], bgp_settings: Optional[pulumi.Input[BgpSettingsArgs]] = ..., fqdn: Optional[pulumi.Input[_builtins.str]] = ..., gateway_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., local_network_address_space: Optional[pulumi.Input[AddressSpaceArgs]] = ..., local_network_gateway_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def local_network_gateway_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LocalNetworkGateway(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., bgp_settings: Optional[pulumi.Input[Union[BgpSettingsArgs, BgpSettingsArgsDict]]] = ..., fqdn: Optional[pulumi.Input[_builtins.str]] = ..., gateway_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., local_network_address_space: Optional[pulumi.Input[Union[AddressSpaceArgs, AddressSpaceArgsDict]]] = ..., local_network_gateway_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: LocalNetworkGatewayInitArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> LocalNetworkGateway:
