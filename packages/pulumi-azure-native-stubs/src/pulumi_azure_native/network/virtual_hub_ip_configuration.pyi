...
class VirtualHubIpConfigurationArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], virtual_hub_name: pulumi.Input[_builtins.str], id: Optional[pulumi.Input[_builtins.str]] = ..., ip_config_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_allocation_method: Optional[pulumi.Input[Union[_builtins.str, IPAllocationMethod]]] = ..., public_ip_address: Optional[pulumi.Input[PublicIPAddressArgs]] = ..., subnet: Optional[pulumi.Input[SubnetArgs]] = ...) -> None:
    ...
    def ip_config_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VirtualHubIpConfiguration(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., ip_config_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_allocation_method: Optional[pulumi.Input[Union[_builtins.str, IPAllocationMethod]]] = ..., public_ip_address: Optional[pulumi.Input[Union[PublicIPAddressArgs, PublicIPAddressArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., subnet: Optional[pulumi.Input[Union[SubnetArgs, SubnetArgsDict]]] = ..., virtual_hub_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: VirtualHubIpConfigurationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> VirtualHubIpConfiguration:
