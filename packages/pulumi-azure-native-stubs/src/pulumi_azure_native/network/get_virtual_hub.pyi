...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetVirtualHubResult', 'AwaitableGetVirtualHubResult', 'get_virtual_hub', 'get_virtual_hub_output']
@pulumi.output_type
class GetVirtualHubResult:
    
    def __init__(__self__, address_prefix=..., allow_branch_to_branch_traffic=..., azure_api_version=..., azure_firewall=..., bgp_connections=..., etag=..., express_route_gateway=..., hub_routing_preference=..., id=..., ip_configurations=..., kind=..., location=..., name=..., p2_s_vpn_gateway=..., preferred_routing_gateway=..., provisioning_state=..., route_maps=..., route_table=..., routing_state=..., security_partner_provider=..., security_provider_name=..., sku=..., tags=..., type=..., virtual_hub_route_table_v2s=..., virtual_router_asn=..., virtual_router_auto_scale_configuration=..., virtual_router_ips=..., virtual_wan=..., vpn_gateway=...) -> None:
        ...
...
class AwaitableGetVirtualHubResult(GetVirtualHubResult):
    def __await__(self): # -> Generator[Never, Any, GetVirtualHubResult]:
        ...
    


def get_virtual_hub(resource_group_name: Optional[_builtins.str] = ..., virtual_hub_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetVirtualHubResult:
    
    ...

def get_virtual_hub_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., virtual_hub_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetVirtualHubResult]:
