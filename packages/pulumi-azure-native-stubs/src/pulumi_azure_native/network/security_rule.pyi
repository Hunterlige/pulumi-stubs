...
class SecurityRuleInitArgs:
    def __init__(__self__, *, access: pulumi.Input[Union[_builtins.str, SecurityRuleAccess]], direction: pulumi.Input[Union[_builtins.str, SecurityRuleDirection]], network_security_group_name: pulumi.Input[_builtins.str], priority: pulumi.Input[_builtins.int], protocol: pulumi.Input[Union[_builtins.str, SecurityRuleProtocol]], resource_group_name: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., destination_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., destination_address_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., destination_application_security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationSecurityGroupArgs]]]] = ..., destination_port_range: Optional[pulumi.Input[_builtins.str]] = ..., destination_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., security_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., source_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., source_address_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., source_application_security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationSecurityGroupArgs]]]] = ..., source_port_range: Optional[pulumi.Input[_builtins.str]] = ..., source_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def network_security_group_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def security_rule_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SecurityRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., access: Optional[pulumi.Input[Union[_builtins.str, SecurityRuleAccess]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., destination_address_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., destination_application_security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ApplicationSecurityGroupArgs, ApplicationSecurityGroupArgsDict]]]]] = ..., destination_port_range: Optional[pulumi.Input[_builtins.str]] = ..., destination_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., direction: Optional[pulumi.Input[Union[_builtins.str, SecurityRuleDirection]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., network_security_group_name: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.int]] = ..., protocol: Optional[pulumi.Input[Union[_builtins.str, SecurityRuleProtocol]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., security_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., source_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., source_address_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., source_application_security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ApplicationSecurityGroupArgs, ApplicationSecurityGroupArgsDict]]]]] = ..., source_port_range: Optional[pulumi.Input[_builtins.str]] = ..., source_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: SecurityRuleInitArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SecurityRule:
