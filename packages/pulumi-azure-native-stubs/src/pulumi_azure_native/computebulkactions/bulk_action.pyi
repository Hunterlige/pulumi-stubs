...
class BulkActionArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[
            pulumi.Input[LaunchBulkInstancesOperationPropertiesArgs]
        ] = ...,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[LaunchBulkInstancesOperationPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[LaunchBulkInstancesOperationPropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class BulkAction(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.LaunchBulkInstancesOperationPropertiesResponse]: ...
    @_builtins.property
