...
class EncryptionScopeArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], encryption_scope_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[EncryptionScopePropertiesArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[EncryptionScopePropertiesArgs]]): # -> None:
        ...
