...
class ProjectConnectionArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], project_name: pulumi.Input[_builtins.str], properties: pulumi.Input[Union[AADAuthTypeConnectionPropertiesArgs, AccessKeyAuthTypeConnectionPropertiesArgs, AccountKeyAuthTypeConnectionPropertiesArgs, ApiKeyAuthConnectionPropertiesArgs, CustomKeysConnectionPropertiesArgs, ManagedIdentityAuthTypeConnectionPropertiesArgs, NoneAuthTypeConnectionPropertiesArgs, OAuth2AuthTypeConnectionPropertiesArgs, PATAuthTypeConnectionPropertiesArgs, SASAuthTypeConnectionPropertiesArgs, ServicePrincipalAuthTypeConnectionPropertiesArgs, UsernamePasswordAuthTypeConnectionPropertiesArgs]], resource_group_name: pulumi.Input[_builtins.str], connection_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ProjectConnection(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., connection_name: Optional[pulumi.Input[_builtins.str]] = ..., project_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[Union[AADAuthTypeConnectionPropertiesArgs, AADAuthTypeConnectionPropertiesArgsDict], Union[AccessKeyAuthTypeConnectionPropertiesArgs, AccessKeyAuthTypeConnectionPropertiesArgsDict], Union[AccountKeyAuthTypeConnectionPropertiesArgs, AccountKeyAuthTypeConnectionPropertiesArgsDict], Union[ApiKeyAuthConnectionPropertiesArgs, ApiKeyAuthConnectionPropertiesArgsDict], Union[CustomKeysConnectionPropertiesArgs, CustomKeysConnectionPropertiesArgsDict], Union[ManagedIdentityAuthTypeConnectionPropertiesArgs, ManagedIdentityAuthTypeConnectionPropertiesArgsDict], Union[NoneAuthTypeConnectionPropertiesArgs, NoneAuthTypeConnectionPropertiesArgsDict], Union[OAuth2AuthTypeConnectionPropertiesArgs, OAuth2AuthTypeConnectionPropertiesArgsDict], Union[PATAuthTypeConnectionPropertiesArgs, PATAuthTypeConnectionPropertiesArgsDict], Union[SASAuthTypeConnectionPropertiesArgs, SASAuthTypeConnectionPropertiesArgsDict], Union[ServicePrincipalAuthTypeConnectionPropertiesArgs, ServicePrincipalAuthTypeConnectionPropertiesArgsDict], Union[UsernamePasswordAuthTypeConnectionPropertiesArgs, UsernamePasswordAuthTypeConnectionPropertiesArgsDict]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ProjectConnectionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ProjectConnection:
