...
class CommitmentPlanAssociationArgs:
    def __init__(__self__, *, commitment_plan_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], account_id: Optional[pulumi.Input[_builtins.str]] = ..., commitment_plan_association_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def commitment_plan_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def commitment_plan_association_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CommitmentPlanAssociation(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_id: Optional[pulumi.Input[_builtins.str]] = ..., commitment_plan_association_name: Optional[pulumi.Input[_builtins.str]] = ..., commitment_plan_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: CommitmentPlanAssociationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> CommitmentPlanAssociation:
