...
class RaiToolLabelArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[RaiToolLabelPropertiesArgs]] = ...,
        rai_tool_connection_name: Optional[pulumi.Input[_builtins.str]] = ...,
...
class RaiToolLabel(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[RaiToolLabelPropertiesArgs, RaiToolLabelPropertiesArgsDict]
            ]
        ] = ...,
        rai_tool_connection_name: Optional[pulumi.Input[_builtins.str]] = ...,
