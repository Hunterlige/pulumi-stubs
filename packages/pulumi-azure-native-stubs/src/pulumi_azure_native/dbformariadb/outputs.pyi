...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['PrivateEndpointPropertyResponse', 'PrivateLinkServiceConnectionStatePropertyResponse', 'ServerPrivateEndpointConnectionPropertiesResponse', 'ServerPrivateEndpointConnectionResponse', ..., 'SkuResponse', 'StorageProfileResponse']
@pulumi.output_type
