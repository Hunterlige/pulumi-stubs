...
class GetServerResult:
    ...
    def __init__(__self__, administrator_login=..., azure_api_version=..., earliest_restore_date=..., fully_qualified_domain_name=..., id=..., location=..., master_server_id=..., minimal_tls_version=..., name=..., private_endpoint_connections=..., public_network_access=..., replica_capacity=..., replication_role=..., sku=..., ssl_enforcement=..., storage_profile=..., tags=..., type=..., user_visible_state=..., version=...) -> None:
        ...
