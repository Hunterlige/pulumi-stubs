...
class ShareSubscriptionArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], invitation_id: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], source_share_location: pulumi.Input[_builtins.str], expiration_date: Optional[pulumi.Input[_builtins.str]] = ..., share_subscription_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def invitation_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def source_share_location(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def share_subscription_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ShareSubscription(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., expiration_date: Optional[pulumi.Input[_builtins.str]] = ..., invitation_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., share_subscription_name: Optional[pulumi.Input[_builtins.str]] = ..., source_share_location: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ShareSubscriptionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ShareSubscription:
