...
class SynapseWorkspaceSqlPoolTableDataSetArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], kind: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], share_name: pulumi.Input[_builtins.str], synapse_workspace_sql_pool_table_resource_id: pulumi.Input[_builtins.str], data_set_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SynapseWorkspaceSqlPoolTableDataSet(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., data_set_name: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., share_name: Optional[pulumi.Input[_builtins.str]] = ..., synapse_workspace_sql_pool_table_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: SynapseWorkspaceSqlPoolTableDataSetArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SynapseWorkspaceSqlPoolTableDataSet:
