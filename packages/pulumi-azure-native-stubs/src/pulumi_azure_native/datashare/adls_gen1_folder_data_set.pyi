...
class ADLSGen1FolderDataSetArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], folder_path: pulumi.Input[_builtins.str], kind: pulumi.Input[_builtins.str], resource_group: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], share_name: pulumi.Input[_builtins.str], subscription_id: pulumi.Input[_builtins.str], data_set_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ADLSGen1FolderDataSet(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., data_set_name: Optional[pulumi.Input[_builtins.str]] = ..., folder_path: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., share_name: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ADLSGen1FolderDataSetArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ADLSGen1FolderDataSet:
