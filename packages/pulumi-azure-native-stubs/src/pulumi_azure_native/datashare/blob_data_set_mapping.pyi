...
class BlobDataSetMappingArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], container_name: pulumi.Input[_builtins.str], data_set_id: pulumi.Input[_builtins.str], file_path: pulumi.Input[_builtins.str], kind: pulumi.Input[_builtins.str], resource_group: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], share_subscription_name: pulumi.Input[_builtins.str], storage_account_name: pulumi.Input[_builtins.str], subscription_id: pulumi.Input[_builtins.str], data_set_mapping_name: Optional[pulumi.Input[_builtins.str]] = ..., output_type: Optional[pulumi.Input[Union[_builtins.str, OutputType]]] = ...) -> None:
...
class BlobDataSetMapping(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., container_name: Optional[pulumi.Input[_builtins.str]] = ..., data_set_id: Optional[pulumi.Input[_builtins.str]] = ..., data_set_mapping_name: Optional[pulumi.Input[_builtins.str]] = ..., file_path: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., output_type: Optional[pulumi.Input[Union[_builtins.str, OutputType]]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., share_subscription_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_name: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: BlobDataSetMappingArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> BlobDataSetMapping:
