...
class SqlDBTableDataSetMappingArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], data_set_id: pulumi.Input[_builtins.str], database_name: pulumi.Input[_builtins.str], kind: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], schema_name: pulumi.Input[_builtins.str], share_subscription_name: pulumi.Input[_builtins.str], sql_server_resource_id: pulumi.Input[_builtins.str], table_name: pulumi.Input[_builtins.str], data_set_mapping_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SqlDBTableDataSetMapping(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., data_set_id: Optional[pulumi.Input[_builtins.str]] = ..., data_set_mapping_name: Optional[pulumi.Input[_builtins.str]] = ..., database_name: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., schema_name: Optional[pulumi.Input[_builtins.str]] = ..., share_subscription_name: Optional[pulumi.Input[_builtins.str]] = ..., sql_server_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., table_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: SqlDBTableDataSetMappingArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SqlDBTableDataSetMapping:
