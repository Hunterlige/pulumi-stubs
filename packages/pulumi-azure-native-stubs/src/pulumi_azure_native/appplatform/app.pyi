...
class AppArgs:
    def __init__(
        ...
        *,
        ...
        identity: Optional[pulumi.Input[ManagedIdentityPropertiesArgs]] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[pulumi.Input[AppResourcePropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
...
class App(pulumi.CustomResource):
    ...
    def __init__(
        ...
        identity: Optional[
            pulumi.Input[
                Union[ManagedIdentityPropertiesArgs, ManagedIdentityPropertiesArgsDict]
            ]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[
            pulumi.Input[
                Union[AppResourcePropertiesArgs, AppResourcePropertiesArgsDict]
            ]
        ] = ...,
    ...
    def identity(
        self,
    ) -> pulumi.Output[Optional[outputs.ManagedIdentityPropertiesResponse]]: ...
    @_builtins.property
    @pulumi.getter
