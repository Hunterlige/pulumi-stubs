...
class CustomizedAcceleratorArgs:
    def __init__(
        ...
        *,
        ...
        customized_accelerator_name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[pulumi.Input[CustomizedAcceleratorPropertiesArgs]] = ...,
    ...
    def customized_accelerator_name(
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[CustomizedAcceleratorPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[CustomizedAcceleratorPropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class CustomizedAccelerator(pulumi.CustomResource):
    ...
    def __init__(
        ...
        application_accelerator_name: Optional[pulumi.Input[_builtins.str]] = ...,
        customized_accelerator_name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[
            pulumi.Input[
                Union[
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.CustomizedAcceleratorPropertiesResponse]: ...
    @_builtins.property
    @pulumi.getter
