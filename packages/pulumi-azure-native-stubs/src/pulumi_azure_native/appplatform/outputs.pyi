...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AcceleratorBasicAuthSettingResponse', 'AcceleratorGitRepositoryResponse', 'AcceleratorPublicSettingResponse', 'AcceleratorSshSettingResponse', 'ApiPortalCustomDomainPropertiesResponse', 'ApiPortalInstanceResponse', 'ApiPortalPropertiesResponse', 'ApiPortalResourceRequestsResponse', 'ApmPropertiesResponse', 'ApmReferenceResponse', 'AppResourcePropertiesResponse', 'AppVNetAddonsResponse', 'ApplicationAcceleratorComponentResponse', 'ApplicationAcceleratorInstanceResponse', 'ApplicationAcceleratorPropertiesResponse', 'ApplicationAcceleratorResourceRequestsResponse', 'ApplicationInsightsAgentVersionsResponse', 'ApplicationLiveViewComponentResponse', 'ApplicationLiveViewInstanceResponse', 'ApplicationLiveViewPropertiesResponse', 'ApplicationLiveViewResourceRequestsResponse', 'AzureFileVolumeResponse', 'BindingResourcePropertiesResponse', 'BuildPropertiesResponse', 'BuildResourceRequestsResponse', 'BuildResultUserSourceInfoResponse', 'BuildServiceAgentPoolPropertiesResponse', 'BuildServiceAgentPoolSizePropertiesResponse', 'BuilderPropertiesResponse', 'BuildpackBindingLaunchPropertiesResponse', 'BuildpackBindingPropertiesResponse', 'BuildpackPropertiesResponse', 'BuildpacksGroupPropertiesResponse', 'CertificateReferenceResponse', 'ClusterResourcePropertiesResponse', 'ConfigServerGitPropertyResponse', 'ConfigServerPropertiesResponse', 'ConfigServerSettingsResponse', 'ConfigurationServiceGitPropertyResponse', 'ConfigurationServiceGitRepositoryResponse', 'ConfigurationServiceInstanceResponse', 'ConfigurationServicePropertiesResponse', 'ConfigurationServiceResourceRequestsResponse', 'ConfigurationServiceSettingsResponse', 'ContainerProbeSettingsResponse', 'ContainerRegistryBasicCredentialsResponse', 'ContainerRegistryPropertiesResponse', 'ContentCertificatePropertiesResponse', 'CustomContainerResponse', 'CustomContainerUserSourceInfoResponse', 'CustomDomainPropertiesResponse', 'CustomPersistentDiskResourceResponse', 'CustomScaleRuleResponse', 'CustomizedAcceleratorPropertiesResponse', 'DeploymentInstanceResponse', 'DeploymentResourcePropertiesResponse', 'DeploymentSettingsResponse', 'DevToolPortalComponentResponse', 'DevToolPortalFeatureDetailResponse', 'DevToolPortalFeatureSettingsResponse', 'DevToolPortalInstanceResponse', 'DevToolPortalPropertiesResponse', 'DevToolPortalResourceRequestsResponse', 'DevToolPortalSsoPropertiesResponse', 'EnvVarResponse', 'ErrorResponse', 'ExecActionResponse', 'GatewayApiMetadataPropertiesResponse', 'GatewayApiRouteResponse', 'GatewayCorsPropertiesResponse', 'GatewayCustomDomainPropertiesResponse', 'GatewayInstanceResponse', ..., ..., 'GatewayOperatorPropertiesResponse', 'GatewayOperatorResourceRequestsResponse', 'GatewayPropertiesResponse', 'GatewayPropertiesResponseClientAuth', 'GatewayPropertiesResponseEnvironmentVariables', 'GatewayResourceRequestsResponse', 'GatewayRouteConfigOpenApiPropertiesResponse', 'GatewayRouteConfigPropertiesResponse', 'GitPatternRepositoryResponse', 'HTTPGetActionResponse', 'HttpScaleRuleResponse', 'ImageRegistryCredentialResponse', 'IngressConfigResponse', 'IngressSettingsResponse', 'IngressSettingsResponseClientAuth', 'JarUploadedUserSourceInfoResponse', 'JobExecutionTemplateResponse', 'JobResourcePropertiesResponse', 'JobResourceRequestsResponse', 'KeyVaultCertificatePropertiesResponse', 'LoadedCertificateResponse', 'ManagedComponentReferenceResponse', 'ManagedIdentityPropertiesResponse', 'ManualJobTriggerConfigResponse', 'MarketplaceResourceResponse', 'MonitoringSettingPropertiesResponse', 'NetCoreZipUploadedUserSourceInfoResponse', 'NetworkProfileResponse', 'NetworkProfileResponseOutboundIPs', 'PersistentDiskResponse', 'ProbeResponse', 'QueueScaleRuleResponse', 'RequiredTrafficResponse', 'ResourceRequestsResponse', 'ScaleResponse', 'ScaleRuleAuthResponse', 'ScaleRuleResponse', 'SecretResponse', 'ServiceRegistryInstanceResponse', 'ServiceRegistryPropertiesResponse', 'ServiceRegistryResourceRequestsResponse', 'ServiceVNetAddonsResponse', 'SkuResponse', 'SourceUploadedUserSourceInfoResponse', 'SsoPropertiesResponse', 'StackPropertiesResponse', 'StorageAccountResponse', 'SystemDataResponse', 'TCPSocketActionResponse', 'TcpScaleRuleResponse', 'TemporaryDiskResponse', 'TriggeredBuildResultResponse', 'UploadedUserSourceInfoResponse', 'UserAssignedManagedIdentityResponse', 'WarUploadedUserSourceInfoResponse', 'WeeklyMaintenanceScheduleConfigurationResponse']
@pulumi.output_type
class AcceleratorBasicAuthSettingResponse(dict):
    ...
    def __init__(__self__, *, auth_type: _builtins.str, username: _builtins.str, ca_cert_resource_id: Optional[_builtins.str] = ...) -> None:
...
class AcceleratorGitRepositoryResponse(dict):
    ...
    def __init__(__self__, *, auth_setting: Any, url: _builtins.str, branch: Optional[_builtins.str] = ..., commit: Optional[_builtins.str] = ..., git_tag: Optional[_builtins.str] = ..., interval_in_seconds: Optional[_builtins.int] = ..., sub_path: Optional[_builtins.str] = ...) -> None:
...
class AcceleratorPublicSettingResponse(dict):
    ...
    def __init__(__self__, *, auth_type: _builtins.str, ca_cert_resource_id: Optional[_builtins.str] = ...) -> None:
...
class ApiPortalPropertiesResponse(dict):
    ...
    def __init__(__self__, *, instances: Sequence[outputs.ApiPortalInstanceResponse], provisioning_state: _builtins.str, resource_requests: outputs.ApiPortalResourceRequestsResponse, url: _builtins.str, api_try_out_enabled_state: Optional[_builtins.str] = ..., gateway_ids: Optional[Sequence[_builtins.str]] = ..., https_only: Optional[_builtins.bool] = ..., public: Optional[_builtins.bool] = ..., source_urls: Optional[Sequence[_builtins.str]] = ..., sso_properties: Optional[outputs.SsoPropertiesResponse] = ...) -> None:
...
class ApmPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, type: _builtins.str, properties: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class AppResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, fqdn: _builtins.str, provisioning_state: _builtins.str, url: _builtins.str, addon_configs: Optional[Mapping[str, Any]] = ..., custom_persistent_disks: Optional[Sequence[outputs.CustomPersistentDiskResourceResponse]] = ..., enable_end_to_end_tls: Optional[_builtins.bool] = ..., https_only: Optional[_builtins.bool] = ..., ingress_settings: Optional[outputs.IngressSettingsResponse] = ..., loaded_certificates: Optional[Sequence[outputs.LoadedCertificateResponse]] = ..., persistent_disk: Optional[outputs.PersistentDiskResponse] = ..., public: Optional[_builtins.bool] = ..., secrets: Optional[Sequence[outputs.SecretResponse]] = ..., temporary_disk: Optional[outputs.TemporaryDiskResponse] = ..., test_endpoint_auth_state: Optional[_builtins.str] = ..., vnet_addons: Optional[outputs.AppVNetAddonsResponse] = ..., workload_profile_name: Optional[_builtins.str] = ...) -> None:
...
class AppVNetAddonsResponse(dict):
    ...
    def __init__(__self__, *, public_endpoint_url: _builtins.str, public_endpoint: Optional[_builtins.bool] = ...) -> None:
...
class ApplicationAcceleratorComponentResponse(dict):
    ...
    def __init__(__self__, *, instances: Sequence[outputs.ApplicationAcceleratorInstanceResponse], name: _builtins.str, resource_requests: Optional[outputs.ApplicationAcceleratorResourceRequestsResponse] = ...) -> None:
        ...
...
class ApplicationAcceleratorPropertiesResponse(dict):
    ...
    def __init__(__self__, *, components: Sequence[outputs.ApplicationAcceleratorComponentResponse], provisioning_state: _builtins.str) -> None:
...
class ApplicationAcceleratorResourceRequestsResponse(dict):
    ...
    def __init__(__self__, *, cpu: _builtins.str, instance_count: _builtins.int, memory: _builtins.str) -> None:
...
class ApplicationLiveViewComponentResponse(dict):
    ...
    def __init__(__self__, *, instances: Sequence[outputs.ApplicationLiveViewInstanceResponse], name: Any, resource_requests: outputs.ApplicationLiveViewResourceRequestsResponse) -> None:
...
class ApplicationLiveViewPropertiesResponse(dict):
    ...
    def __init__(__self__, *, components: Sequence[outputs.ApplicationLiveViewComponentResponse], provisioning_state: _builtins.str) -> None:
...
class AzureFileVolumeResponse(dict):
    ...
    def __init__(__self__, *, mount_path: _builtins.str, type: _builtins.str, enable_sub_path: Optional[_builtins.bool] = ..., mount_options: Optional[Sequence[_builtins.str]] = ..., read_only: Optional[_builtins.bool] = ..., share_name: Optional[_builtins.str] = ...) -> None:
...
class BindingResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, created_at: _builtins.str, generated_properties: _builtins.str, resource_name: _builtins.str, resource_type: _builtins.str, updated_at: _builtins.str, binding_parameters: Optional[Mapping[str, _builtins.str]] = ..., key: Optional[_builtins.str] = ..., resource_id: Optional[_builtins.str] = ...) -> None:
...
class BuildPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, triggered_build_result: outputs.TriggeredBuildResultResponse, agent_pool: Optional[_builtins.str] = ..., apms: Optional[Sequence[outputs.ApmReferenceResponse]] = ..., builder: Optional[_builtins.str] = ..., certificates: Optional[Sequence[outputs.CertificateReferenceResponse]] = ..., env: Optional[Mapping[str, _builtins.str]] = ..., relative_path: Optional[_builtins.str] = ..., resource_requests: Optional[outputs.BuildResourceRequestsResponse] = ...) -> None:
...
class BuildResultUserSourceInfoResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, build_result_id: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class BuildServiceAgentPoolPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, pool_size: Optional[outputs.BuildServiceAgentPoolSizePropertiesResponse] = ...) -> None:
...
class BuildServiceAgentPoolSizePropertiesResponse(dict):
    ...
    def __init__(__self__, *, cpu: _builtins.str, memory: _builtins.str, name: Optional[_builtins.str] = ...) -> None:
...
class BuilderPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, buildpack_groups: Optional[Sequence[outputs.BuildpacksGroupPropertiesResponse]] = ..., stack: Optional[outputs.StackPropertiesResponse] = ...) -> None:
...
class BuildpackBindingLaunchPropertiesResponse(dict):
    ...
    def __init__(__self__, *, properties: Optional[Mapping[str, _builtins.str]] = ..., secrets: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class BuildpackBindingPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, binding_type: Optional[_builtins.str] = ..., launch_properties: Optional[outputs.BuildpackBindingLaunchPropertiesResponse] = ...) -> None:
...
class BuildpackPropertiesResponse(dict):
    ...
    def __init__(__self__, *, version: _builtins.str, id: Optional[_builtins.str] = ...) -> None:
...
class BuildpacksGroupPropertiesResponse(dict):
    ...
    def __init__(__self__, *, buildpacks: Optional[Sequence[outputs.BuildpackPropertiesResponse]] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class ClusterResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, fqdn: _builtins.str, power_state: _builtins.str, provisioning_state: _builtins.str, service_id: _builtins.str, version: _builtins.int, infra_resource_group: Optional[_builtins.str] = ..., maintenance_schedule_configuration: Optional[outputs.WeeklyMaintenanceScheduleConfigurationResponse] = ..., managed_environment_id: Optional[_builtins.str] = ..., marketplace_resource: Optional[outputs.MarketplaceResourceResponse] = ..., network_profile: Optional[outputs.NetworkProfileResponse] = ..., vnet_addons: Optional[outputs.ServiceVNetAddonsResponse] = ..., zone_redundant: Optional[_builtins.bool] = ...) -> None:
...
class ConfigServerGitPropertyResponse(dict):
    ...
    def __init__(__self__, *, uri: _builtins.str, host_key: Optional[_builtins.str] = ..., host_key_algorithm: Optional[_builtins.str] = ..., label: Optional[_builtins.str] = ..., password: Optional[_builtins.str] = ..., private_key: Optional[_builtins.str] = ..., repositories: Optional[Sequence[outputs.GitPatternRepositoryResponse]] = ..., search_paths: Optional[Sequence[_builtins.str]] = ..., strict_host_key_checking: Optional[_builtins.bool] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class ConfigServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, config_server: Optional[outputs.ConfigServerSettingsResponse] = ..., enabled_state: Optional[_builtins.str] = ..., error: Optional[outputs.ErrorResponse] = ...) -> None:
...
class ConfigServerSettingsResponse(dict):
    ...
    def __init__(__self__, *, git_property: Optional[outputs.ConfigServerGitPropertyResponse] = ...) -> None:
...
class ConfigurationServiceGitPropertyResponse(dict):
    ...
    def __init__(__self__, *, repositories: Optional[Sequence[outputs.ConfigurationServiceGitRepositoryResponse]] = ...) -> None:
...
class ConfigurationServiceGitRepositoryResponse(dict):
    ...
    def __init__(__self__, *, label: _builtins.str, name: _builtins.str, patterns: Sequence[_builtins.str], uri: _builtins.str, ca_cert_resource_id: Optional[_builtins.str] = ..., git_implementation: Optional[_builtins.str] = ..., host_key: Optional[_builtins.str] = ..., host_key_algorithm: Optional[_builtins.str] = ..., password: Optional[_builtins.str] = ..., private_key: Optional[_builtins.str] = ..., search_paths: Optional[Sequence[_builtins.str]] = ..., strict_host_key_checking: Optional[_builtins.bool] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class ConfigurationServicePropertiesResponse(dict):
    ...
    def __init__(__self__, *, instances: Sequence[outputs.ConfigurationServiceInstanceResponse], provisioning_state: _builtins.str, resource_requests: outputs.ConfigurationServiceResourceRequestsResponse, generation: Optional[_builtins.str] = ..., settings: Optional[outputs.ConfigurationServiceSettingsResponse] = ...) -> None:
...
class ConfigurationServiceSettingsResponse(dict):
    ...
    def __init__(__self__, *, git_property: Optional[outputs.ConfigurationServiceGitPropertyResponse] = ..., refresh_interval_in_seconds: Optional[_builtins.int] = ...) -> None:
...
class ContainerProbeSettingsResponse(dict):
    ...
    def __init__(__self__, *, disable_probe: Optional[_builtins.bool] = ...) -> None:
...
class ContainerRegistryBasicCredentialsResponse(dict):
    ...
    def __init__(__self__, *, server: _builtins.str, type: _builtins.str, username: _builtins.str) -> None:
...
class ContainerRegistryPropertiesResponse(dict):
    ...
    def __init__(__self__, *, credentials: outputs.ContainerRegistryBasicCredentialsResponse, provisioning_state: _builtins.str) -> None:
...
class ContentCertificatePropertiesResponse(dict):
    ...
    def __init__(__self__, *, activate_date: _builtins.str, dns_names: Sequence[_builtins.str], expiration_date: _builtins.str, issued_date: _builtins.str, issuer: _builtins.str, provisioning_state: _builtins.str, subject_name: _builtins.str, thumbprint: _builtins.str, type: _builtins.str) -> None:
...
class CustomContainerResponse(dict):
    ...
    def __init__(__self__, *, args: Optional[Sequence[_builtins.str]] = ..., command: Optional[Sequence[_builtins.str]] = ..., container_image: Optional[_builtins.str] = ..., image_registry_credential: Optional[outputs.ImageRegistryCredentialResponse] = ..., language_framework: Optional[_builtins.str] = ..., server: Optional[_builtins.str] = ...) -> None:
...
class CustomContainerUserSourceInfoResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, custom_container: Optional[outputs.CustomContainerResponse] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class CustomDomainPropertiesResponse(dict):
    ...
    def __init__(__self__, *, app_name: _builtins.str, provisioning_state: _builtins.str, cert_name: Optional[_builtins.str] = ..., thumbprint: Optional[_builtins.str] = ...) -> None:
...
class CustomPersistentDiskResourceResponse(dict):
    ...
    def __init__(__self__, *, storage_id: _builtins.str, custom_persistent_disk_properties: Optional[outputs.AzureFileVolumeResponse] = ...) -> None:
...
class CustomScaleRuleResponse(dict):
    ...
    def __init__(__self__, *, auth: Optional[Sequence[outputs.ScaleRuleAuthResponse]] = ..., metadata: Optional[Mapping[str, _builtins.str]] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class CustomizedAcceleratorPropertiesResponse(dict):
    ...
    def __init__(__self__, *, git_repository: outputs.AcceleratorGitRepositoryResponse, imports: Sequence[_builtins.str], provisioning_state: _builtins.str, accelerator_tags: Optional[Sequence[_builtins.str]] = ..., accelerator_type: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., icon_url: Optional[_builtins.str] = ...) -> None:
...
class DeploymentInstanceResponse(dict):
    ...
    def __init__(__self__, *, discovery_status: _builtins.str, name: _builtins.str, reason: _builtins.str, start_time: _builtins.str, status: _builtins.str, zone: _builtins.str) -> None:
...
class DeploymentResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, instances: Sequence[outputs.DeploymentInstanceResponse], provisioning_state: _builtins.str, status: _builtins.str, active: Optional[_builtins.bool] = ..., deployment_settings: Optional[outputs.DeploymentSettingsResponse] = ..., source: Optional[Any] = ...) -> None:
...
class DeploymentSettingsResponse(dict):
    ...
    def __init__(__self__, *, addon_configs: Optional[Mapping[str, Any]] = ..., apms: Optional[Sequence[outputs.ApmReferenceResponse]] = ..., container_probe_settings: Optional[outputs.ContainerProbeSettingsResponse] = ..., environment_variables: Optional[Mapping[str, _builtins.str]] = ..., liveness_probe: Optional[outputs.ProbeResponse] = ..., readiness_probe: Optional[outputs.ProbeResponse] = ..., resource_requests: Optional[outputs.ResourceRequestsResponse] = ..., scale: Optional[outputs.ScaleResponse] = ..., startup_probe: Optional[outputs.ProbeResponse] = ..., termination_grace_period_seconds: Optional[_builtins.int] = ...) -> None:
...
class DevToolPortalComponentResponse(dict):
    ...
    def __init__(__self__, *, instances: Sequence[outputs.DevToolPortalInstanceResponse], name: _builtins.str, resource_requests: outputs.DevToolPortalResourceRequestsResponse) -> None:
...
class DevToolPortalFeatureDetailResponse(dict):
    ...
    def __init__(__self__, *, route: _builtins.str, state: Optional[_builtins.str] = ...) -> None:
...
class DevToolPortalFeatureSettingsResponse(dict):
    ...
    def __init__(__self__, *, application_accelerator: Optional[outputs.DevToolPortalFeatureDetailResponse] = ..., application_live_view: Optional[outputs.DevToolPortalFeatureDetailResponse] = ...) -> None:
...
class DevToolPortalPropertiesResponse(dict):
    ...
    def __init__(__self__, *, components: Sequence[outputs.DevToolPortalComponentResponse], provisioning_state: _builtins.str, url: _builtins.str, features: Optional[outputs.DevToolPortalFeatureSettingsResponse] = ..., public: Optional[_builtins.bool] = ..., sso_properties: Optional[outputs.DevToolPortalSsoPropertiesResponse] = ...) -> None:
...
class DevToolPortalSsoPropertiesResponse(dict):
    ...
    def __init__(__self__, *, client_id: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., metadata_url: Optional[_builtins.str] = ..., scopes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class EnvVarResponse(dict):
    ...
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., secret_value: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class ExecActionResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, command: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GatewayApiMetadataPropertiesResponse(dict):
    ...
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., documentation: Optional[_builtins.str] = ..., server_url: Optional[_builtins.str] = ..., title: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class GatewayApiRouteResponse(dict):
    ...
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., filters: Optional[Sequence[_builtins.str]] = ..., order: Optional[_builtins.int] = ..., predicates: Optional[Sequence[_builtins.str]] = ..., sso_enabled: Optional[_builtins.bool] = ..., tags: Optional[Sequence[_builtins.str]] = ..., title: Optional[_builtins.str] = ..., token_relay: Optional[_builtins.bool] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class GatewayCorsPropertiesResponse(dict):
    ...
    def __init__(__self__, *, allow_credentials: Optional[_builtins.bool] = ..., allowed_headers: Optional[Sequence[_builtins.str]] = ..., allowed_methods: Optional[Sequence[_builtins.str]] = ..., allowed_origin_patterns: Optional[Sequence[_builtins.str]] = ..., allowed_origins: Optional[Sequence[_builtins.str]] = ..., exposed_headers: Optional[Sequence[_builtins.str]] = ..., max_age: Optional[_builtins.int] = ...) -> None:
...
class GatewayLocalResponseCachePerInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *, response_cache_type: _builtins.str, size: Optional[_builtins.str] = ..., time_to_live: Optional[_builtins.str] = ...) -> None:
...
class GatewayOperatorPropertiesResponse(dict):
    ...
    def __init__(__self__, *, instances: Sequence[outputs.GatewayInstanceResponse], resource_requests: outputs.GatewayOperatorResourceRequestsResponse) -> None:
...
class GatewayPropertiesResponse(dict):
    ...
    def __init__(__self__, *, instances: Sequence[outputs.GatewayInstanceResponse], operator_properties: outputs.GatewayOperatorPropertiesResponse, provisioning_state: _builtins.str, url: _builtins.str, addon_configs: Optional[Mapping[str, Any]] = ..., api_metadata_properties: Optional[outputs.GatewayApiMetadataPropertiesResponse] = ..., apm_types: Optional[Sequence[_builtins.str]] = ..., apms: Optional[Sequence[outputs.ApmReferenceResponse]] = ..., client_auth: Optional[outputs.GatewayPropertiesResponseClientAuth] = ..., cors_properties: Optional[outputs.GatewayCorsPropertiesResponse] = ..., environment_variables: Optional[outputs.GatewayPropertiesResponseEnvironmentVariables] = ..., https_only: Optional[_builtins.bool] = ..., public: Optional[_builtins.bool] = ..., resource_requests: Optional[outputs.GatewayResourceRequestsResponse] = ..., response_cache_properties: Optional[Any] = ..., sso_properties: Optional[outputs.SsoPropertiesResponse] = ...) -> None:
...
class GatewayPropertiesResponseClientAuth(dict):
    ...
    def __init__(__self__, *, certificate_verification: Optional[_builtins.str] = ..., certificates: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GatewayRouteConfigPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, app_resource_id: Optional[_builtins.str] = ..., filters: Optional[Sequence[_builtins.str]] = ..., open_api: Optional[outputs.GatewayRouteConfigOpenApiPropertiesResponse] = ..., predicates: Optional[Sequence[_builtins.str]] = ..., protocol: Optional[_builtins.str] = ..., routes: Optional[Sequence[outputs.GatewayApiRouteResponse]] = ..., sso_enabled: Optional[_builtins.bool] = ...) -> None:
...
class GitPatternRepositoryResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, uri: _builtins.str, host_key: Optional[_builtins.str] = ..., host_key_algorithm: Optional[_builtins.str] = ..., label: Optional[_builtins.str] = ..., password: Optional[_builtins.str] = ..., pattern: Optional[Sequence[_builtins.str]] = ..., private_key: Optional[_builtins.str] = ..., search_paths: Optional[Sequence[_builtins.str]] = ..., strict_host_key_checking: Optional[_builtins.bool] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class HTTPGetActionResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, path: Optional[_builtins.str] = ..., scheme: Optional[_builtins.str] = ...) -> None:
...
class HttpScaleRuleResponse(dict):
    ...
    def __init__(__self__, *, auth: Optional[Sequence[outputs.ScaleRuleAuthResponse]] = ..., metadata: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class IngressConfigResponse(dict):
    ...
    def __init__(__self__, *, read_timeout_in_seconds: Optional[_builtins.int] = ...) -> None:
...
class IngressSettingsResponse(dict):
    ...
    def __init__(__self__, *, backend_protocol: Optional[_builtins.str] = ..., client_auth: Optional[outputs.IngressSettingsResponseClientAuth] = ..., read_timeout_in_seconds: Optional[_builtins.int] = ..., send_timeout_in_seconds: Optional[_builtins.int] = ..., session_affinity: Optional[_builtins.str] = ..., session_cookie_max_age: Optional[_builtins.int] = ...) -> None:
...
class JarUploadedUserSourceInfoResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, jvm_options: Optional[_builtins.str] = ..., relative_path: Optional[_builtins.str] = ..., runtime_version: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class JobExecutionTemplateResponse(dict):
    ...
    def __init__(__self__, *, args: Optional[Sequence[_builtins.str]] = ..., environment_variables: Optional[Sequence[outputs.EnvVarResponse]] = ..., resource_requests: Optional[outputs.JobResourceRequestsResponse] = ...) -> None:
...
class JobResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, managed_component_references: Optional[Sequence[outputs.ManagedComponentReferenceResponse]] = ..., source: Optional[Any] = ..., template: Optional[outputs.JobExecutionTemplateResponse] = ..., trigger_config: Optional[outputs.ManualJobTriggerConfigResponse] = ...) -> None:
...
class KeyVaultCertificatePropertiesResponse(dict):
    ...
    def __init__(__self__, *, activate_date: _builtins.str, dns_names: Sequence[_builtins.str], expiration_date: _builtins.str, issued_date: _builtins.str, issuer: _builtins.str, key_vault_cert_name: _builtins.str, provisioning_state: _builtins.str, subject_name: _builtins.str, thumbprint: _builtins.str, type: _builtins.str, vault_uri: _builtins.str, auto_sync: Optional[_builtins.str] = ..., cert_version: Optional[_builtins.str] = ..., exclude_private_key: Optional[_builtins.bool] = ...) -> None:
...
class LoadedCertificateResponse(dict):
    ...
    def __init__(__self__, *, resource_id: _builtins.str, load_trust_store: Optional[_builtins.bool] = ...) -> None:
...
class ManagedIdentityPropertiesResponse(dict):
    ...
    def __init__(__self__, *, principal_id: Optional[_builtins.str] = ..., tenant_id: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ..., user_assigned_identities: Optional[Mapping[str, outputs.UserAssignedManagedIdentityResponse]] = ...) -> None:
...
class ManualJobTriggerConfigResponse(dict):
    ...
    def __init__(__self__, *, trigger_type: Optional[_builtins.str] = ..., parallelism: Optional[_builtins.int] = ..., retry_limit: Optional[_builtins.int] = ..., timeout_in_seconds: Optional[_builtins.int] = ...) -> None:
...
class MarketplaceResourceResponse(dict):
    ...
    def __init__(__self__, *, plan: Optional[_builtins.str] = ..., product: Optional[_builtins.str] = ..., publisher: Optional[_builtins.str] = ...) -> None:
...
class MonitoringSettingPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, app_insights_agent_versions: Optional[outputs.ApplicationInsightsAgentVersionsResponse] = ..., app_insights_instrumentation_key: Optional[_builtins.str] = ..., app_insights_sampling_rate: Optional[_builtins.float] = ..., error: Optional[outputs.ErrorResponse] = ..., trace_enabled: Optional[_builtins.bool] = ...) -> None:
...
class NetCoreZipUploadedUserSourceInfoResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, net_core_main_entry_path: Optional[_builtins.str] = ..., relative_path: Optional[_builtins.str] = ..., runtime_version: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class NetworkProfileResponse(dict):
    ...
    def __init__(__self__, *, outbound_ips: outputs.NetworkProfileResponseOutboundIPs, required_traffics: Sequence[outputs.RequiredTrafficResponse], app_network_resource_group: Optional[_builtins.str] = ..., app_subnet_id: Optional[_builtins.str] = ..., ingress_config: Optional[outputs.IngressConfigResponse] = ..., outbound_type: Optional[_builtins.str] = ..., service_cidr: Optional[_builtins.str] = ..., service_runtime_network_resource_group: Optional[_builtins.str] = ..., service_runtime_subnet_id: Optional[_builtins.str] = ...) -> None:
...
class PersistentDiskResponse(dict):
    ...
    def __init__(__self__, *, used_in_gb: _builtins.int, mount_path: Optional[_builtins.str] = ..., size_in_gb: Optional[_builtins.int] = ...) -> None:
...
class ProbeResponse(dict):
    ...
    def __init__(__self__, *, disable_probe: Optional[_builtins.bool] = ..., failure_threshold: Optional[_builtins.int] = ..., initial_delay_seconds: Optional[_builtins.int] = ..., period_seconds: Optional[_builtins.int] = ..., probe_action: Optional[Any] = ..., success_threshold: Optional[_builtins.int] = ..., timeout_seconds: Optional[_builtins.int] = ...) -> None:
...
class QueueScaleRuleResponse(dict):
    ...
    def __init__(__self__, *, auth: Optional[Sequence[outputs.ScaleRuleAuthResponse]] = ..., queue_length: Optional[_builtins.int] = ..., queue_name: Optional[_builtins.str] = ...) -> None:
...
class RequiredTrafficResponse(dict):
    ...
    def __init__(__self__, *, direction: _builtins.str, fqdns: Sequence[_builtins.str], ips: Sequence[_builtins.str], port: _builtins.int, protocol: _builtins.str) -> None:
...
class ScaleResponse(dict):
    ...
    def __init__(__self__, *, max_replicas: Optional[_builtins.int] = ..., min_replicas: Optional[_builtins.int] = ..., rules: Optional[Sequence[outputs.ScaleRuleResponse]] = ...) -> None:
...
class ServiceRegistryPropertiesResponse(dict):
    ...
    def __init__(__self__, *, instances: Sequence[outputs.ServiceRegistryInstanceResponse], provisioning_state: _builtins.str, resource_requests: outputs.ServiceRegistryResourceRequestsResponse) -> None:
...
class ServiceVNetAddonsResponse(dict):
    ...
    def __init__(__self__, *, data_plane_public_endpoint: Optional[_builtins.bool] = ..., log_stream_public_endpoint: Optional[_builtins.bool] = ...) -> None:
...
class SourceUploadedUserSourceInfoResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, artifact_selector: Optional[_builtins.str] = ..., relative_path: Optional[_builtins.str] = ..., runtime_version: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class SsoPropertiesResponse(dict):
    ...
    def __init__(__self__, *, client_id: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., issuer_uri: Optional[_builtins.str] = ..., scope: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class StorageAccountResponse(dict):
    ...
    def __init__(__self__, *, account_name: _builtins.str, storage_type: _builtins.str) -> None:
...
class TemporaryDiskResponse(dict):
    ...
    def __init__(__self__, *, mount_path: Optional[_builtins.str] = ..., size_in_gb: Optional[_builtins.int] = ...) -> None:
...
class TriggeredBuildResultResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, id: Optional[_builtins.str] = ..., image: Optional[_builtins.str] = ..., last_transition_reason: Optional[_builtins.str] = ..., last_transition_status: Optional[_builtins.str] = ..., last_transition_time: Optional[_builtins.str] = ...) -> None:
...
class UploadedUserSourceInfoResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, relative_path: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class WarUploadedUserSourceInfoResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, jvm_options: Optional[_builtins.str] = ..., relative_path: Optional[_builtins.str] = ..., runtime_version: Optional[_builtins.str] = ..., server_version: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class WeeklyMaintenanceScheduleConfigurationResponse(dict):
    ...
    def __init__(__self__, *, day: _builtins.str, duration: _builtins.str, frequency: _builtins.str, hour: _builtins.int) -> None:
