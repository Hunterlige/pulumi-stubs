...
def get_customized_accelerator(
    application_accelerator_name: Optional[_builtins.str] = ...,
    customized_accelerator_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    service_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetCustomizedAcceleratorResult: ...
def get_customized_accelerator_output(
...
) -> pulumi.Output[GetCustomizedAcceleratorResult]: ...
