...
class ContainerRegistryArgs:
    def __init__(
        ...
        *,
        ...
        container_registry_name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[pulumi.Input[ContainerRegistryPropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[ContainerRegistryPropertiesArgs]]
    ): ...
...
class ContainerRegistry(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    ContainerRegistryPropertiesArgs, ContainerRegistryPropertiesArgsDict
                ]
            ]
        ] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.ContainerRegistryPropertiesResponse]: ...
    @_builtins.property
