...
class MonitoringSettingArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[MonitoringSettingPropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[MonitoringSettingPropertiesArgs]]
    ): ...
...
class MonitoringSetting(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    MonitoringSettingPropertiesArgs, MonitoringSettingPropertiesArgsDict
                ]
            ]
        ] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.MonitoringSettingPropertiesResponse]: ...
    @_builtins.property
