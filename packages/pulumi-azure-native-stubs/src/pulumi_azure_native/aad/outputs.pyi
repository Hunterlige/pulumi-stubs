...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConfigDiagnosticsResponse', 'ConfigDiagnosticsValidatorResultIssueResponse', 'ConfigDiagnosticsValidatorResultResponse', 'ContainerAccountResponse', 'DomainSecuritySettingsResponse', 'ForestTrustResponse', 'HealthAlertResponse', 'HealthMonitorResponse', 'LdapsSettingsResponse', 'MigrationProgressResponse', 'MigrationPropertiesResponse', 'NotificationSettingsResponse', 'ReplicaSetResponse', 'ResourceForestSettingsResponse', 'SystemDataResponse']
@pulumi.output_type
class ConfigDiagnosticsResponse(dict):
    ...
    def __init__(__self__, *, last_executed: Optional[_builtins.str] = ..., validator_results: Optional[Sequence[outputs.ConfigDiagnosticsValidatorResultResponse]] = ...) -> None:
...
class ConfigDiagnosticsValidatorResultIssueResponse(dict):
    ...
    def __init__(__self__, *, description_params: Optional[Sequence[_builtins.str]] = ..., id: Optional[_builtins.str] = ...) -> None:
...
class ConfigDiagnosticsValidatorResultResponse(dict):
    ...
    def __init__(__self__, *, issues: Optional[Sequence[outputs.ConfigDiagnosticsValidatorResultIssueResponse]] = ..., replica_set_subnet_display_name: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., validator_id: Optional[_builtins.str] = ...) -> None:
...
class ContainerAccountResponse(dict):
    ...
    def __init__(__self__, *, account_name: Optional[_builtins.str] = ..., password: Optional[_builtins.str] = ..., spn: Optional[_builtins.str] = ...) -> None:
...
class DomainSecuritySettingsResponse(dict):
    ...
    def __init__(__self__, *, channel_binding: Optional[_builtins.str] = ..., kerberos_armoring: Optional[_builtins.str] = ..., kerberos_rc4_encryption: Optional[_builtins.str] = ..., ldap_signing: Optional[_builtins.str] = ..., ntlm_v1: Optional[_builtins.str] = ..., sync_kerberos_passwords: Optional[_builtins.str] = ..., sync_ntlm_passwords: Optional[_builtins.str] = ..., sync_on_prem_passwords: Optional[_builtins.str] = ..., tls_v1: Optional[_builtins.str] = ...) -> None:
...
class ForestTrustResponse(dict):
    ...
    def __init__(__self__, *, friendly_name: Optional[_builtins.str] = ..., remote_dns_ips: Optional[_builtins.str] = ..., trust_direction: Optional[_builtins.str] = ..., trust_password: Optional[_builtins.str] = ..., trusted_domain_fqdn: Optional[_builtins.str] = ...) -> None:
...
class HealthAlertResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, issue: _builtins.str, last_detected: _builtins.str, name: _builtins.str, raised: _builtins.str, resolution_uri: _builtins.str, severity: _builtins.str) -> None:
...
class HealthMonitorResponse(dict):
    ...
    def __init__(__self__, *, details: _builtins.str, id: _builtins.str, name: _builtins.str) -> None:
...
class LdapsSettingsResponse(dict):
    ...
    def __init__(__self__, *, certificate_not_after: _builtins.str, certificate_thumbprint: _builtins.str, public_certificate: _builtins.str, external_access: Optional[_builtins.str] = ..., ldaps: Optional[_builtins.str] = ..., pfx_certificate: Optional[_builtins.str] = ..., pfx_certificate_password: Optional[_builtins.str] = ...) -> None:
...
class MigrationProgressResponse(dict):
    ...
    def __init__(__self__, *, completion_percentage: Optional[_builtins.float] = ..., progress_message: Optional[_builtins.str] = ...) -> None:
...
class MigrationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, migration_progress: outputs.MigrationProgressResponse, old_subnet_id: _builtins.str, old_vnet_site_id: _builtins.str) -> None:
...
class NotificationSettingsResponse(dict):
    ...
    def __init__(__self__, *, additional_recipients: Optional[Sequence[_builtins.str]] = ..., notify_dc_admins: Optional[_builtins.str] = ..., notify_global_admins: Optional[_builtins.str] = ...) -> None:
...
class ReplicaSetResponse(dict):
    ...
    def __init__(__self__, *, domain_controller_ip_address: Sequence[_builtins.str], external_access_ip_address: _builtins.str, health_alerts: Sequence[outputs.HealthAlertResponse], health_last_evaluated: _builtins.str, health_monitors: Sequence[outputs.HealthMonitorResponse], replica_set_id: _builtins.str, service_status: _builtins.str, vnet_site_id: _builtins.str, location: Optional[_builtins.str] = ..., subnet_id: Optional[_builtins.str] = ...) -> None:
...
class ResourceForestSettingsResponse(dict):
    ...
    def __init__(__self__, *, resource_forest: Optional[_builtins.str] = ..., settings: Optional[Sequence[outputs.ForestTrustResponse]] = ...) -> None:
