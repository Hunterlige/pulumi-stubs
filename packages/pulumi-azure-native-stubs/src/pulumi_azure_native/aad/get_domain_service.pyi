...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetDomainServiceResult', 'AwaitableGetDomainServiceResult', 'get_domain_service', 'get_domain_service_output']
@pulumi.output_type
class GetDomainServiceResult:
    
    def __init__(__self__, azure_api_version=..., config_diagnostics=..., deployment_id=..., domain_configuration_type=..., domain_name=..., domain_security_settings=..., etag=..., filtered_sync=..., id=..., ldaps_settings=..., location=..., migration_properties=..., name=..., notification_settings=..., provisioning_state=..., replica_sets=..., resource_forest_settings=..., sku=..., sync_application_id=..., sync_owner=..., sync_scope=..., system_data=..., tags=..., tenant_id=..., type=..., version=...) -> None:
        ...
...
class AwaitableGetDomainServiceResult(GetDomainServiceResult):
    def __await__(self): # -> Generator[Never, Any, GetDomainServiceResult]:
        ...
    


def get_domain_service(domain_service_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDomainServiceResult:
    
    ...

def get_domain_service_output(domain_service_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDomainServiceResult]:
