...
@pulumi.input_type
class VolumeArgs:
    def __init__(__self__, *, extended_location: pulumi.Input[ExtendedLocationArgs], resource_group_name: pulumi.Input[_builtins.str], size_mi_b: pulumi.Input[_builtins.float], location: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., volume_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @size_mi_b.setter
    def size_mi_b(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class Volume(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationArgs, ExtendedLocationArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., size_mi_b: Optional[pulumi.Input[_builtins.float]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., volume_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
