...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetKubernetesClusterResult', 'AwaitableGetKubernetesClusterResult', 'get_kubernetes_cluster', 'get_kubernetes_cluster_output']
@pulumi.output_type
class GetKubernetesClusterResult:
    def __init__(__self__, aad_configuration=..., administrator_configuration=..., attached_network_ids=..., available_upgrades=..., azure_api_version=..., cluster_id=..., connected_cluster_id=..., control_plane_kubernetes_version=..., control_plane_node_configuration=..., detailed_status=..., detailed_status_message=..., etag=..., extended_location=..., feature_statuses=..., id=..., initial_agent_pool_configurations=..., kubernetes_version=..., location=..., managed_resource_group_configuration=..., name=..., network_configuration=..., nodes=..., provisioning_state=..., system_data=..., tags=..., type=...) -> None:
        ...
...
class AwaitableGetKubernetesClusterResult(GetKubernetesClusterResult):
    def __await__(self): # -> Generator[Never, Any, GetKubernetesClusterResult]:
        ...
    


def get_kubernetes_cluster(kubernetes_cluster_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetKubernetesClusterResult:
    
    ...

def get_kubernetes_cluster_output(kubernetes_cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetKubernetesClusterResult]:
