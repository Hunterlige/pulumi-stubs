...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetBareMetalMachineResult', 'AwaitableGetBareMetalMachineResult', 'get_bare_metal_machine', 'get_bare_metal_machine_output']
@pulumi.output_type
class GetBareMetalMachineResult:
    def __init__(__self__, associated_resource_ids=..., azure_api_version=..., bmc_connection_string=..., bmc_credentials=..., bmc_mac_address=..., boot_mac_address=..., cluster_id=..., cordon_status=..., detailed_status=..., detailed_status_message=..., etag=..., extended_location=..., hardware_inventory=..., hardware_validation_status=..., hybrid_aks_clusters_associated_ids=..., id=..., kubernetes_node_name=..., kubernetes_version=..., location=..., machine_cluster_version=..., machine_details=..., machine_name=..., machine_roles=..., machine_sku_id=..., name=..., oam_ipv4_address=..., oam_ipv6_address=..., os_image=..., power_state=..., provisioning_state=..., rack_id=..., rack_slot=..., ready_state=..., runtime_protection_status=..., secret_rotation_status=..., serial_number=..., service_tag=..., system_data=..., tags=..., type=..., virtual_machines_associated_ids=...) -> None:
        ...
...
class AwaitableGetBareMetalMachineResult(GetBareMetalMachineResult):
    def __await__(self): # -> Generator[Never, Any, GetBareMetalMachineResult]:
        ...
    


def get_bare_metal_machine(bare_metal_machine_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetBareMetalMachineResult:
    
    ...

def get_bare_metal_machine_output(bare_metal_machine_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetBareMetalMachineResult]:
