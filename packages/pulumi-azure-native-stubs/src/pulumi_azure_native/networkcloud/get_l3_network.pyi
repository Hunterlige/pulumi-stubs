...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetL3NetworkResult', 'AwaitableGetL3NetworkResult', 'get_l3_network', 'get_l3_network_output']
@pulumi.output_type
class GetL3NetworkResult:
    def __init__(__self__, associated_resource_ids=..., azure_api_version=..., cluster_id=..., detailed_status=..., detailed_status_message=..., etag=..., extended_location=..., hybrid_aks_clusters_associated_ids=..., hybrid_aks_ipam_enabled=..., hybrid_aks_plugin_type=..., id=..., interface_name=..., ip_allocation_type=..., ipv4_connected_prefix=..., ipv6_connected_prefix=..., l3_isolation_domain_id=..., location=..., name=..., provisioning_state=..., system_data=..., tags=..., type=..., virtual_machines_associated_ids=..., vlan=...) -> None:
        ...
...
class AwaitableGetL3NetworkResult(GetL3NetworkResult):
    def __await__(self): # -> Generator[Never, Any, GetL3NetworkResult]:
        ...
    


def get_l3_network(l3_network_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetL3NetworkResult:
    
    ...

def get_l3_network_output(l3_network_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetL3NetworkResult]:
