...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureApiManagementSourceArgs', 'AzureApiManagementSourceArgsDict', 'ContactArgs', 'ContactArgsDict', 'DeploymentServerArgs', 'DeploymentServerArgsDict', 'EnvironmentServerArgs', 'EnvironmentServerArgsDict', 'ExternalDocumentationArgs', 'ExternalDocumentationArgsDict', 'LicenseArgs', 'LicenseArgsDict', 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'MetadataAssignmentArgs', 'MetadataAssignmentArgsDict', 'OnboardingArgs', 'OnboardingArgsDict', 'TermsOfServiceArgs', 'TermsOfServiceArgsDict']
...
class AzureApiManagementSourceArgs:
    def __init__(__self__, *, resource_id: pulumi.Input[_builtins.str], msi_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DeploymentServerArgs:
    def __init__(__self__, *, runtime_uri: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @runtime_uri.setter
    def runtime_uri(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EnvironmentServerArgs:
    def __init__(__self__, *, management_portal_uri: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, EnvironmentServerType]]] = ...) -> None:
    ...
    def management_portal_uri(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, EnvironmentServerType]]]): # -> None:
        ...
...
class ExternalDocumentationArgs:
    def __init__(__self__, *, url: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., title: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class LicenseArgs:
    def __init__(__self__, *, identifier: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MetadataAssignmentArgs:
    def __init__(__self__, *, deprecated: Optional[pulumi.Input[_builtins.bool]] = ..., entity: Optional[pulumi.Input[Union[_builtins.str, MetadataAssignmentEntity]]] = ..., required: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @deprecated.setter
    def deprecated(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @entity.setter
    def entity(self, value: Optional[pulumi.Input[Union[_builtins.str, MetadataAssignmentEntity]]]): # -> None:
        ...
...
class OnboardingArgs:
    def __init__(__self__, *, developer_portal_uri: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., instructions: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def developer_portal_uri(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
