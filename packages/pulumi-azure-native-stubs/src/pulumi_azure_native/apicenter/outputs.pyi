...
class DeploymentServerResponse(dict):
    ...
    def get(self, key: str, default=...) -> Any: ...
    def __init__(
        __self__, *, runtime_uri: Optional[Sequence[_builtins.str]] = ...
    ) -> None: ...
    @_builtins.property
...
class EnvironmentServerResponse(dict):
    ...
    def __init__(
        __self__,
        *,
        management_portal_uri: Optional[Sequence[_builtins.str]] = ...,
...
class MetadataAssignmentResponse(dict):
    def __init__(
        __self__,
        *,
        deprecated: Optional[_builtins.bool] = ...,
...
class OnboardingResponse(dict):
    ...
    def __init__(
        __self__,
        *,
        developer_portal_uri: Optional[Sequence[_builtins.str]] = ...,
