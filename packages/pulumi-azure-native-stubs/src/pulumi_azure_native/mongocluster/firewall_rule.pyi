...
class FirewallRuleArgs:
    def __init__(__self__, *, mongo_cluster_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], firewall_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[FirewallRulePropertiesArgs]] = ...) -> None:
...
class FirewallRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., firewall_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., mongo_cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[FirewallRulePropertiesArgs, FirewallRulePropertiesArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
