...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *, mongo_cluster_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[PrivateEndpointConnectionPropertiesArgs]] = ...) -> None:
