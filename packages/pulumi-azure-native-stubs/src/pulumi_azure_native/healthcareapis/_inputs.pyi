...
class AnalyticsConnectorDataLakeDataDestinationArgs:
    def __init__(__self__, *, data_lake_name: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def data_lake_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AnalyticsConnectorFhirServiceDataSourceArgs:
    def __init__(__self__, *, kind: pulumi.Input[Union[_builtins.str, FhirServiceVersion]], type: pulumi.Input[_builtins.str], url: pulumi.Input[_builtins.str]) -> None:
    ...
    @kind.setter
    def kind(self, value: pulumi.Input[Union[_builtins.str, FhirServiceVersion]]): # -> None:
        ...
...
class AnalyticsConnectorFhirToParquetMappingArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], extension_schema_reference: Optional[pulumi.Input[_builtins.str]] = ..., filter_configuration_reference: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def extension_schema_reference(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def filter_configuration_reference(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CorsConfigurationArgs:
    def __init__(__self__, *, allow_credentials: Optional[pulumi.Input[_builtins.bool]] = ..., headers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., max_age: Optional[pulumi.Input[_builtins.int]] = ..., methods: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., origins: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class EncryptionCustomerManagedKeyEncryptionArgs:
    def __init__(__self__, *, key_encryption_key_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EncryptionArgs:
    def __init__(__self__, *, customer_managed_key_encryption: Optional[pulumi.Input[EncryptionCustomerManagedKeyEncryptionArgs]] = ...) -> None:
...
class FhirServiceAcrConfigurationArgs:
    def __init__(__self__, *, login_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., oci_artifacts: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceOciArtifactEntryArgs]]]] = ...) -> None:
    ...
    def login_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def oci_artifacts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceOciArtifactEntryArgs]]]]): # -> None:
        ...
...
class FhirServiceAuthenticationConfigurationArgs:
    def __init__(__self__, *, audience: Optional[pulumi.Input[_builtins.str]] = ..., authority: Optional[pulumi.Input[_builtins.str]] = ..., smart_identity_providers: Optional[pulumi.Input[Sequence[pulumi.Input[SmartIdentityProviderConfigurationArgs]]]] = ..., smart_proxy_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def smart_identity_providers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SmartIdentityProviderConfigurationArgs]]]]): # -> None:
        ...
    ...
    def smart_proxy_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class FhirServiceExportConfigurationArgs:
    def __init__(__self__, *, storage_account_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FhirServiceImportConfigurationArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., initial_import_mode: Optional[pulumi.Input[_builtins.bool]] = ..., integration_data_store: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def initial_import_mode(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def integration_data_store(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ImplementationGuidesConfigurationArgs:
    def __init__(__self__, *, us_core_missing_data: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def us_core_missing_data(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class IotEventHubIngestionEndpointConfigurationArgs:
    def __init__(__self__, *, consumer_group: Optional[pulumi.Input[_builtins.str]] = ..., event_hub_name: Optional[pulumi.Input[_builtins.str]] = ..., fully_qualified_event_hub_namespace: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def fully_qualified_event_hub_namespace(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResourceVersionPolicyConfigurationArgs:
    def __init__(__self__, *, default: Optional[pulumi.Input[Union[_builtins.str, FhirResourceVersionPolicy]]] = ..., resource_type_overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[_builtins.str, FhirResourceVersionPolicy]]]]] = ...) -> None:
    ...
    @default.setter
    def default(self, value: Optional[pulumi.Input[Union[_builtins.str, FhirResourceVersionPolicy]]]): # -> None:
        ...
    ...
    def resource_type_overrides(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[_builtins.str, FhirResourceVersionPolicy]]]]]): # -> None:
        ...
...
class ServiceAuthenticationConfigurationInfoArgs:
    def __init__(__self__, *, audience: Optional[pulumi.Input[_builtins.str]] = ..., authority: Optional[pulumi.Input[_builtins.str]] = ..., smart_proxy_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class ServiceCosmosDbConfigurationInfoArgs:
    def __init__(__self__, *, cross_tenant_cmk_application_id: Optional[pulumi.Input[_builtins.str]] = ..., key_vault_key_uri: Optional[pulumi.Input[_builtins.str]] = ..., offer_throughput: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def cross_tenant_cmk_application_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def offer_throughput(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ServiceManagedIdentityIdentityArgs:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, ServiceManagedIdentityType]], user_assigned_identities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ServiceManagedIdentityType]]): # -> None:
        ...
...
class ServiceOciArtifactEntryArgs:
    def __init__(__self__, *, digest: Optional[pulumi.Input[_builtins.str]] = ..., image_name: Optional[pulumi.Input[_builtins.str]] = ..., login_server: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServicesPropertiesArgs:
    def __init__(__self__, *, access_policies: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceAccessPolicyEntryArgs]]]] = ..., acr_configuration: Optional[pulumi.Input[ServiceAcrConfigurationInfoArgs]] = ..., authentication_configuration: Optional[pulumi.Input[ServiceAuthenticationConfigurationInfoArgs]] = ..., cors_configuration: Optional[pulumi.Input[ServiceCorsConfigurationInfoArgs]] = ..., cosmos_db_configuration: Optional[pulumi.Input[ServiceCosmosDbConfigurationInfoArgs]] = ..., export_configuration: Optional[pulumi.Input[ServiceExportConfigurationInfoArgs]] = ..., import_configuration: Optional[pulumi.Input[ServiceImportConfigurationInfoArgs]] = ..., private_endpoint_connections: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateEndpointConnectionArgs]]]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ...) -> None:
    ...
    def access_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceAccessPolicyEntryArgs]]]]): # -> None:
        ...
    ...
    def acr_configuration(self, value: Optional[pulumi.Input[ServiceAcrConfigurationInfoArgs]]): # -> None:
        ...
    ...
    def authentication_configuration(self, value: Optional[pulumi.Input[ServiceAuthenticationConfigurationInfoArgs]]): # -> None:
        ...
    ...
    def cors_configuration(self, value: Optional[pulumi.Input[ServiceCorsConfigurationInfoArgs]]): # -> None:
        ...
    ...
    def cosmos_db_configuration(self, value: Optional[pulumi.Input[ServiceCosmosDbConfigurationInfoArgs]]): # -> None:
        ...
    ...
    def export_configuration(self, value: Optional[pulumi.Input[ServiceExportConfigurationInfoArgs]]): # -> None:
        ...
    ...
    def import_configuration(self, value: Optional[pulumi.Input[ServiceImportConfigurationInfoArgs]]): # -> None:
        ...
...
class ServicesResourceIdentityArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[Union[_builtins.str, ManagedServiceIdentityType]]] = ...) -> None:
...
class SmartIdentityProviderApplicationArgs:
    def __init__(__self__, *, allowed_data_actions: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, SmartDataActions]]]]] = ..., audience: Optional[pulumi.Input[_builtins.str]] = ..., client_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allowed_data_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, SmartDataActions]]]]]): # -> None:
        ...
...
class SmartIdentityProviderConfigurationArgs:
    def __init__(__self__, *, applications: Optional[pulumi.Input[Sequence[pulumi.Input[SmartIdentityProviderApplicationArgs]]]] = ..., authority: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @applications.setter
    def applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SmartIdentityProviderApplicationArgs]]]]): # -> None:
        ...
...
class StorageConfigurationArgs:
    def __init__(__self__, *, file_system_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def file_system_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
