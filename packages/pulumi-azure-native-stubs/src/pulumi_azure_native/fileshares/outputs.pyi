...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FileShareLimitsOutputResponse', 'FileShareLimitsResponse', 'FileSharePropertiesResponse', 'FileShareProvisioningConstantsResponse', 'FileShareProvisioningRecommendationOutputResponse', 'FileShareSnapshotPropertiesResponse', 'FileShareUsageDataOutputResponse', 'LiveSharesUsageDataResponse', 'NfsProtocolPropertiesResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'PublicAccessPropertiesResponse', 'SystemDataResponse']
@pulumi.output_type
class FileShareLimitsOutputResponse(dict):
    
    def __init__(__self__, *, limits: outputs.FileShareLimitsResponse, provisioning_constants: outputs.FileShareProvisioningConstantsResponse) -> None:
...
class FileShareLimitsResponse(dict):
    ...
    def __init__(__self__, *, max_file_share_private_endpoint_connections: _builtins.int, max_file_share_snapshots: _builtins.int, max_file_share_subnets: _builtins.int, max_file_shares: _builtins.int, max_provisioned_io_per_sec: _builtins.int, max_provisioned_storage_gi_b: _builtins.int, max_provisioned_throughput_mi_b_per_sec: _builtins.int, min_provisioned_io_per_sec: _builtins.int, min_provisioned_storage_gi_b: _builtins.int, min_provisioned_throughput_mi_b_per_sec: _builtins.int) -> None:
...
class FileSharePropertiesResponse(dict):
    ...
    def __init__(__self__, *, host_name: _builtins.str, included_burst_io_per_sec: _builtins.int, max_burst_io_per_sec_credits: _builtins.float, private_endpoint_connections: Sequence[outputs.PrivateEndpointConnectionResponse], provisioned_io_per_sec_next_allowed_downgrade: _builtins.str, provisioned_storage_next_allowed_downgrade: _builtins.str, provisioned_throughput_next_allowed_downgrade: _builtins.str, provisioning_state: _builtins.str, media_tier: Optional[_builtins.str] = ..., mount_name: Optional[_builtins.str] = ..., nfs_protocol_properties: Optional[outputs.NfsProtocolPropertiesResponse] = ..., protocol: Optional[_builtins.str] = ..., provisioned_io_per_sec: Optional[_builtins.int] = ..., provisioned_storage_gi_b: Optional[_builtins.int] = ..., provisioned_throughput_mi_b_per_sec: Optional[_builtins.int] = ..., public_access_properties: Optional[outputs.PublicAccessPropertiesResponse] = ..., public_network_access: Optional[_builtins.str] = ..., redundancy: Optional[_builtins.str] = ...) -> None:
...
class FileShareProvisioningConstantsResponse(dict):
    ...
    def __init__(__self__, *, base_io_per_sec: _builtins.int, base_throughput_mi_b_per_sec: _builtins.int, scalar_io_per_sec: _builtins.float, scalar_throughput_mi_b_per_sec: _builtins.float) -> None:
...
class FileShareProvisioningRecommendationOutputResponse(dict):
    ...
    def __init__(__self__, *, available_redundancy_options: Sequence[_builtins.str], provisioned_io_per_sec: _builtins.int, provisioned_throughput_mi_b_per_sec: _builtins.int) -> None:
...
class FileShareSnapshotPropertiesResponse(dict):
    ...
    def __init__(__self__, *, initiator_id: _builtins.str, snapshot_time: _builtins.str, metadata: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class FileShareUsageDataOutputResponse(dict):
    ...
    def __init__(__self__, *, live_shares: outputs.LiveSharesUsageDataResponse) -> None:
...
class PublicAccessPropertiesResponse(dict):
    ...
    def __init__(__self__, *, allowed_subnets: Optional[Sequence[_builtins.str]] = ...) -> None:
