...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FileSharePropertiesArgs', 'FileSharePropertiesArgsDict', 'FileShareProvisioningRecommendationInput', 'FileShareProvisioningRecommendationInputDict', 'FileShareSnapshotPropertiesArgs', 'FileShareSnapshotPropertiesArgsDict', 'NfsProtocolPropertiesArgs', 'NfsProtocolPropertiesArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'PublicAccessPropertiesArgs', 'PublicAccessPropertiesArgsDict']
...
class FileSharePropertiesArgs:
    def __init__(__self__, *, media_tier: Optional[pulumi.Input[Union[_builtins.str, MediaTier]]] = ..., mount_name: Optional[pulumi.Input[_builtins.str]] = ..., nfs_protocol_properties: Optional[pulumi.Input[NfsProtocolPropertiesArgs]] = ..., protocol: Optional[pulumi.Input[Union[_builtins.str, Protocol]]] = ..., provisioned_io_per_sec: Optional[pulumi.Input[_builtins.int]] = ..., provisioned_storage_gi_b: Optional[pulumi.Input[_builtins.int]] = ..., provisioned_throughput_mi_b_per_sec: Optional[pulumi.Input[_builtins.int]] = ..., public_access_properties: Optional[pulumi.Input[PublicAccessPropertiesArgs]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., redundancy: Optional[pulumi.Input[Union[_builtins.str, Redundancy]]] = ...) -> None:
    ...
    @media_tier.setter
    def media_tier(self, value: Optional[pulumi.Input[Union[_builtins.str, MediaTier]]]): # -> None:
        ...
    ...
    def nfs_protocol_properties(self, value: Optional[pulumi.Input[NfsProtocolPropertiesArgs]]): # -> None:
        ...
    ...
    def provisioned_io_per_sec(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def provisioned_storage_gi_b(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def provisioned_throughput_mi_b_per_sec(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def public_access_properties(self, value: Optional[pulumi.Input[PublicAccessPropertiesArgs]]): # -> None:
        ...
    ...
    @redundancy.setter
    def redundancy(self, value: Optional[pulumi.Input[Union[_builtins.str, Redundancy]]]): # -> None:
        ...
...
class FileShareProvisioningRecommendationInput:
    ...
    @provisioned_storage_gi_b.setter
    def provisioned_storage_gi_b(self, value: _builtins.int): # -> None:
        ...
...
class FileShareSnapshotPropertiesArgs:
    def __init__(__self__, *, metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class NfsProtocolPropertiesArgs:
    def __init__(__self__, *, root_squash: Optional[pulumi.Input[Union[_builtins.str, ShareRootSquash]]] = ...) -> None:
    ...
    @root_squash.setter
    def root_squash(self, value: Optional[pulumi.Input[Union[_builtins.str, ShareRootSquash]]]): # -> None:
        ...
...
class PublicAccessPropertiesArgs:
    def __init__(__self__, *, allowed_subnets: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allowed_subnets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
