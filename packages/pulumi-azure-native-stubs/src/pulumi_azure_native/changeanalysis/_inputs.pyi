...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureMonitorWorkspacePropertiesArgs', 'AzureMonitorWorkspacePropertiesArgsDict', 'ConfigurationProfileResourcePropertiesArgs', 'ConfigurationProfileResourcePropertiesArgsDict', 'NotificationSettingsArgs', 'NotificationSettingsArgsDict', 'ResourceIdentityArgs', 'ResourceIdentityArgsDict']
...
class AzureMonitorWorkspacePropertiesArgs:
    def __init__(__self__, *, include_change_details: Optional[pulumi.Input[Union[_builtins.str, ChangeDetailsMode]]] = ..., workspace_id: Optional[pulumi.Input[_builtins.str]] = ..., workspace_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def include_change_details(self, value: Optional[pulumi.Input[Union[_builtins.str, ChangeDetailsMode]]]): # -> None:
        ...
...
class ConfigurationProfileResourcePropertiesArgs:
    def __init__(__self__, *, notifications: Optional[pulumi.Input[NotificationSettingsArgs]] = ...) -> None:
    ...
    def notifications(self, value: Optional[pulumi.Input[NotificationSettingsArgs]]): # -> None:
        ...
...
class NotificationSettingsArgs:
    def __init__(__self__, *, activation_state: Optional[pulumi.Input[Union[_builtins.str, NotificationsState]]] = ..., azure_monitor_workspace_properties: Optional[pulumi.Input[AzureMonitorWorkspacePropertiesArgs]] = ...) -> None:
    ...
    def activation_state(self, value: Optional[pulumi.Input[Union[_builtins.str, NotificationsState]]]): # -> None:
        ...
    ...
    def azure_monitor_workspace_properties(self, value: Optional[pulumi.Input[AzureMonitorWorkspacePropertiesArgs]]): # -> None:
        ...
