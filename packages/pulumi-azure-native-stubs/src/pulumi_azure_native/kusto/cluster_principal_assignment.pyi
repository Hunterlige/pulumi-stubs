...
class ClusterPrincipalAssignmentArgs:
    def __init__(__self__, *, cluster_name: pulumi.Input[_builtins.str], principal_id: pulumi.Input[_builtins.str], principal_type: pulumi.Input[Union[_builtins.str, PrincipalType]], resource_group_name: pulumi.Input[_builtins.str], role: pulumi.Input[Union[_builtins.str, ClusterPrincipalRole]], principal_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterPrincipalAssignment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., principal_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., principal_id: Optional[pulumi.Input[_builtins.str]] = ..., principal_type: Optional[pulumi.Input[Union[_builtins.str, PrincipalType]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., role: Optional[pulumi.Input[Union[_builtins.str, ClusterPrincipalRole]]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ClusterPrincipalAssignmentArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ClusterPrincipalAssignment:
