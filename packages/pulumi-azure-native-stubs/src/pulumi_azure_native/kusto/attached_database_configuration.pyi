...
class AttachedDatabaseConfigurationArgs:
    def __init__(__self__, *, cluster_name: pulumi.Input[_builtins.str], cluster_resource_id: pulumi.Input[_builtins.str], database_name: pulumi.Input[_builtins.str], default_principals_modification_kind: pulumi.Input[Union[_builtins.str, DefaultPrincipalsModificationKind]], resource_group_name: pulumi.Input[_builtins.str], attached_database_configuration_name: Optional[pulumi.Input[_builtins.str]] = ..., database_name_override: Optional[pulumi.Input[_builtins.str]] = ..., database_name_prefix: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., table_level_sharing_properties: Optional[pulumi.Input[TableLevelSharingPropertiesArgs]] = ...) -> None:
    ...
    def database_name_override(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def database_name_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., attached_database_configuration_name: Optional[pulumi.Input[_builtins.str]] = ..., cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., cluster_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., database_name: Optional[pulumi.Input[_builtins.str]] = ..., database_name_override: Optional[pulumi.Input[_builtins.str]] = ..., database_name_prefix: Optional[pulumi.Input[_builtins.str]] = ..., default_principals_modification_kind: Optional[pulumi.Input[Union[_builtins.str, DefaultPrincipalsModificationKind]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., table_level_sharing_properties: Optional[pulumi.Input[Union[TableLevelSharingPropertiesArgs, TableLevelSharingPropertiesArgsDict]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: AttachedDatabaseConfigurationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> AttachedDatabaseConfiguration:
