...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AcceptedAudiencesArgs', 'AcceptedAudiencesArgsDict', 'AzureSkuArgs', 'AzureSkuArgsDict', 'CalloutPolicyArgs', 'CalloutPolicyArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'KeyVaultPropertiesArgs', 'KeyVaultPropertiesArgsDict', 'LanguageExtensionsListArgs', 'LanguageExtensionsListArgsDict', 'LanguageExtensionArgs', 'LanguageExtensionArgsDict', 'OptimizedAutoscaleArgs', 'OptimizedAutoscaleArgsDict', 'PrivateLinkServiceConnectionStatePropertyArgs', 'PrivateLinkServiceConnectionStatePropertyArgsDict', 'TableLevelSharingPropertiesArgs', 'TableLevelSharingPropertiesArgsDict', 'TrustedExternalTenantArgs', 'TrustedExternalTenantArgsDict', 'VirtualNetworkConfigurationArgs', 'VirtualNetworkConfigurationArgsDict']
...
@pulumi.input_type
class AzureSkuArgs:
    def __init__(__self__, *, name: pulumi.Input[Union[_builtins.str, AzureSkuName]], tier: pulumi.Input[Union[_builtins.str, AzureSkuTier]], capacity: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class CalloutPolicyArgs:
    def __init__(__self__, *, callout_type: Optional[pulumi.Input[Union[_builtins.str, CalloutType]]] = ..., callout_uri_regex: Optional[pulumi.Input[_builtins.str]] = ..., outbound_access: Optional[pulumi.Input[Union[_builtins.str, OutboundAccess]]] = ...) -> None:
    ...
    @callout_type.setter
    def callout_type(self, value: Optional[pulumi.Input[Union[_builtins.str, CalloutType]]]): # -> None:
        ...
    ...
    def callout_uri_regex(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def outbound_access(self, value: Optional[pulumi.Input[Union[_builtins.str, OutboundAccess]]]): # -> None:
        ...
...
class KeyVaultPropertiesArgs:
    def __init__(__self__, *, key_name: Optional[pulumi.Input[_builtins.str]] = ..., key_vault_uri: Optional[pulumi.Input[_builtins.str]] = ..., key_version: Optional[pulumi.Input[_builtins.str]] = ..., user_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def user_identity(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LanguageExtensionsListArgs:
    def __init__(__self__, *, value: Optional[pulumi.Input[Sequence[pulumi.Input[LanguageExtensionArgs]]]] = ...) -> None:
    ...
    @value.setter
    def value(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LanguageExtensionArgs]]]]): # -> None:
        ...
...
class LanguageExtensionArgs:
    def __init__(__self__, *, language_extension_custom_image_name: Optional[pulumi.Input[_builtins.str]] = ..., language_extension_image_name: Optional[pulumi.Input[Union[_builtins.str, LanguageExtensionImageName]]] = ..., language_extension_name: Optional[pulumi.Input[Union[_builtins.str, LanguageExtensionName]]] = ...) -> None:
    ...
    def language_extension_custom_image_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def language_extension_image_name(self, value: Optional[pulumi.Input[Union[_builtins.str, LanguageExtensionImageName]]]): # -> None:
        ...
    ...
    def language_extension_name(self, value: Optional[pulumi.Input[Union[_builtins.str, LanguageExtensionName]]]): # -> None:
        ...
...
class TableLevelSharingPropertiesArgs:
    def __init__(__self__, *, external_tables_to_exclude: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., external_tables_to_include: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., functions_to_exclude: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., functions_to_include: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., materialized_views_to_exclude: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., materialized_views_to_include: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tables_to_exclude: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tables_to_include: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def functions_to_exclude(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def functions_to_include(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class VirtualNetworkConfigurationArgs:
    def __init__(__self__, *, data_management_public_ip_id: pulumi.Input[_builtins.str], engine_public_ip_id: pulumi.Input[_builtins.str], subnet_id: pulumi.Input[_builtins.str], state: Optional[pulumi.Input[Union[_builtins.str, VnetState]]] = ...) -> None:
    ...
    def data_management_public_ip_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def engine_public_ip_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[_builtins.str, VnetState]]]): # -> None:
        ...
