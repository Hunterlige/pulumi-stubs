...
class GetClusterResult:
    ...
    def __init__(__self__, accepted_audiences=..., allowed_fqdn_list=..., allowed_ip_range_list=..., azure_api_version=..., callout_policies=..., data_ingestion_uri=..., enable_auto_stop=..., enable_disk_encryption=..., enable_double_encryption=..., enable_purge=..., enable_streaming_ingest=..., engine_type=..., etag=..., id=..., identity=..., key_vault_properties=..., language_extensions=..., location=..., migration_cluster=..., name=..., optimized_autoscale=..., private_endpoint_connections=..., provisioning_state=..., public_ip_type=..., public_network_access=..., restrict_outbound_network_access=..., sku=..., state=..., state_reason=..., system_data=..., tags=..., trusted_external_tenants=..., type=..., uri=..., virtual_network_configuration=..., zone_status=..., zones=...) -> None:
        ...
