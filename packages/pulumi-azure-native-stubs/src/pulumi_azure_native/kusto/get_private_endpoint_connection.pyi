...
class GetPrivateEndpointConnectionResult:
    ...
    def __init__(__self__, azure_api_version=..., group_id=..., id=..., name=..., private_endpoint=..., private_link_service_connection_state=..., provisioning_state=..., system_data=..., type=...) -> None:
        ...
