...
class AzureSkuResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, tier: _builtins.str, capacity: Optional[_builtins.int] = ...) -> None:
...
class CalloutPolicyResponse(dict):
    ...
    def __init__(__self__, *, callout_id: _builtins.str, callout_type: Optional[_builtins.str] = ..., callout_uri_regex: Optional[_builtins.str] = ..., outbound_access: Optional[_builtins.str] = ...) -> None:
...
class DatabasePrincipalResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, role: _builtins.str, tenant_name: _builtins.str, type: _builtins.str, app_id: Optional[_builtins.str] = ..., email: Optional[_builtins.str] = ..., fqn: Optional[_builtins.str] = ...) -> None:
...
class FollowerDatabaseDefinitionResponse(dict):
    ...
    def __init__(__self__, *, attached_database_configuration_name: _builtins.str, cluster_resource_id: _builtins.str, database_name: _builtins.str, database_share_origin: _builtins.str, table_level_sharing_properties: outputs.TableLevelSharingPropertiesResponse) -> None:
...
class IdentityResponse(dict):
    ...
    def __init__(__self__, *, principal_id: _builtins.str, tenant_id: _builtins.str, type: _builtins.str, user_assigned_identities: Optional[Mapping[str, outputs.IdentityResponseUserAssignedIdentities]] = ...) -> None:
...
class KeyVaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *, key_name: Optional[_builtins.str] = ..., key_vault_uri: Optional[_builtins.str] = ..., key_version: Optional[_builtins.str] = ..., user_identity: Optional[_builtins.str] = ...) -> None:
...
class LanguageExtensionResponse(dict):
    ...
    def __init__(__self__, *, language_extension_custom_image_name: Optional[_builtins.str] = ..., language_extension_image_name: Optional[_builtins.str] = ..., language_extension_name: Optional[_builtins.str] = ...) -> None:
...
class MigrationClusterPropertiesResponse(dict):
    ...
    def __init__(__self__, *, data_ingestion_uri: _builtins.str, id: _builtins.str, role: _builtins.str, uri: _builtins.str) -> None:
...
class PrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *, group_id: _builtins.str, id: _builtins.str, name: _builtins.str, private_endpoint: outputs.PrivateEndpointPropertyResponse, private_link_service_connection_state: outputs.PrivateLinkServiceConnectionStatePropertyResponse, provisioning_state: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str) -> None:
...
class SuspensionDetailsResponse(dict):
    ...
    def __init__(__self__, *, suspension_start_date: Optional[_builtins.str] = ...) -> None:
...
class TableLevelSharingPropertiesResponse(dict):
    ...
    def __init__(__self__, *, external_tables_to_exclude: Optional[Sequence[_builtins.str]] = ..., external_tables_to_include: Optional[Sequence[_builtins.str]] = ..., functions_to_exclude: Optional[Sequence[_builtins.str]] = ..., functions_to_include: Optional[Sequence[_builtins.str]] = ..., materialized_views_to_exclude: Optional[Sequence[_builtins.str]] = ..., materialized_views_to_include: Optional[Sequence[_builtins.str]] = ..., tables_to_exclude: Optional[Sequence[_builtins.str]] = ..., tables_to_include: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class VirtualNetworkConfigurationResponse(dict):
    ...
    def __init__(__self__, *, data_management_public_ip_id: _builtins.str, engine_public_ip_id: _builtins.str, subnet_id: _builtins.str, state: Optional[_builtins.str] = ...) -> None:
