...
class EventHubDataConnectionArgs:
    def __init__(
        ...
        *,
        ...
        compression: Optional[pulumi.Input[Union[_builtins.str, Compression]]] = ...,
        data_connection_name: Optional[pulumi.Input[_builtins.str]] = ...,
        data_format: Optional[
            pulumi.Input[Union[_builtins.str, EventHubDataFormat]]
        ] = ...,
    ...
    def compression(
        self,
    ) -> Optional[pulumi.Input[Union[_builtins.str, Compression]]]: ...
    @compression.setter
    def compression(
        self, value: Optional[pulumi.Input[Union[_builtins.str, Compression]]]
    ): ...
    @_builtins.property
    ...
    def data_format(
        self,
    ) -> Optional[pulumi.Input[Union[_builtins.str, EventHubDataFormat]]]: ...
    @data_format.setter
    def data_format(
        self, value: Optional[pulumi.Input[Union[_builtins.str, EventHubDataFormat]]]
    ): ...
    @_builtins.property
