...
class GetIotHubDataConnectionResult:
    ...
    def __init__(__self__, azure_api_version=..., consumer_group=..., data_format=..., database_routing=..., event_system_properties=..., id=..., iot_hub_resource_id=..., kind=..., location=..., mapping_rule_name=..., name=..., provisioning_state=..., retrieval_start_date=..., shared_access_policy_name=..., table_name=..., type=...) -> None:
        ...
...
def get_iot_hub_data_connection(cluster_name: Optional[_builtins.str] = ..., data_connection_name: Optional[_builtins.str] = ..., database_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetIotHubDataConnectionResult:
    
    ...

def get_iot_hub_data_connection_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., data_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., database_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetIotHubDataConnectionResult]:
