...
class GetEventGridDataConnectionResult:
    ...
    def __init__(__self__, azure_api_version=..., blob_storage_event_type=..., consumer_group=..., data_format=..., database_routing=..., event_grid_resource_id=..., event_hub_resource_id=..., id=..., ignore_first_record=..., kind=..., location=..., managed_identity_object_id=..., managed_identity_resource_id=..., mapping_rule_name=..., name=..., provisioning_state=..., storage_account_resource_id=..., table_name=..., type=...) -> None:
        ...
...
def get_event_grid_data_connection(cluster_name: Optional[_builtins.str] = ..., data_connection_name: Optional[_builtins.str] = ..., database_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetEventGridDataConnectionResult:
    
    ...

def get_event_grid_data_connection_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., data_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., database_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetEventGridDataConnectionResult]:
