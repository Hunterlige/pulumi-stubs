...
class PrivateEndpointConnectionArgs:
    ...
    def private_link_service_connection_state(
        self, value: pulumi.Input[PrivateLinkServiceConnectionStatePropertyArgs]
    ): ...
    @_builtins.property
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def private_endpoint(
        self,
    ) -> pulumi.Output[outputs.PrivateEndpointPropertyResponse]: ...
    @_builtins.property
    @pulumi.getter(name="privateLinkServiceConnectionState")
    def private_link_service_connection_state(
        self,
    ) -> pulumi.Output[outputs.PrivateLinkServiceConnectionStatePropertyResponse]: ...
    @_builtins.property
