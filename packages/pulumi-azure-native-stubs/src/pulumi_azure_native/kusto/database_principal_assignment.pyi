...
class DatabasePrincipalAssignmentArgs:
    def __init__(__self__, *, cluster_name: pulumi.Input[_builtins.str], database_name: pulumi.Input[_builtins.str], principal_id: pulumi.Input[_builtins.str], principal_type: pulumi.Input[Union[_builtins.str, PrincipalType]], resource_group_name: pulumi.Input[_builtins.str], role: pulumi.Input[Union[_builtins.str, DatabasePrincipalRole]], principal_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DatabasePrincipalAssignment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., database_name: Optional[pulumi.Input[_builtins.str]] = ..., principal_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., principal_id: Optional[pulumi.Input[_builtins.str]] = ..., principal_type: Optional[pulumi.Input[Union[_builtins.str, PrincipalType]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., role: Optional[pulumi.Input[Union[_builtins.str, DatabasePrincipalRole]]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
