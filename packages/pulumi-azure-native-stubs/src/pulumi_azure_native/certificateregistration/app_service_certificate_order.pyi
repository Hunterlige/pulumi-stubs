...
class AppServiceCertificateOrderArgs:
    def __init__(__self__, *, product_type: pulumi.Input[CertificateProductType], resource_group_name: pulumi.Input[_builtins.str], auto_renew: Optional[pulumi.Input[_builtins.bool]] = ..., certificate_order_name: Optional[pulumi.Input[_builtins.str]] = ..., certificates: Optional[pulumi.Input[Mapping[str, pulumi.Input[AppServiceCertificateArgs]]]] = ..., csr: Optional[pulumi.Input[_builtins.str]] = ..., distinguished_name: Optional[pulumi.Input[_builtins.str]] = ..., key_size: Optional[pulumi.Input[_builtins.int]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., validity_in_years: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @product_type.setter
    def product_type(self, value: pulumi.Input[CertificateProductType]): # -> None:
        ...
    ...
    def certificate_order_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @certificates.setter
    def certificates(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[AppServiceCertificateArgs]]]]): # -> None:
        ...
    ...
    @csr.setter
    def csr(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def distinguished_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def validity_in_years(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AppServiceCertificateOrder(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., auto_renew: Optional[pulumi.Input[_builtins.bool]] = ..., certificate_order_name: Optional[pulumi.Input[_builtins.str]] = ..., certificates: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[AppServiceCertificateArgs, AppServiceCertificateArgsDict]]]]] = ..., csr: Optional[pulumi.Input[_builtins.str]] = ..., distinguished_name: Optional[pulumi.Input[_builtins.str]] = ..., key_size: Optional[pulumi.Input[_builtins.int]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., product_type: Optional[pulumi.Input[CertificateProductType]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., validity_in_years: Optional[pulumi.Input[_builtins.int]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: AppServiceCertificateOrderArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> AppServiceCertificateOrder:
