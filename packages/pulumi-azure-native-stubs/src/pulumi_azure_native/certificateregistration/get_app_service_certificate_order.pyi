...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetAppServiceCertificateOrderResult', 'AwaitableGetAppServiceCertificateOrderResult', 'get_app_service_certificate_order', 'get_app_service_certificate_order_output']
@pulumi.output_type
class GetAppServiceCertificateOrderResult:
    
    def __init__(__self__, app_service_certificate_not_renewable_reasons=..., auto_renew=..., azure_api_version=..., certificates=..., contact=..., csr=..., distinguished_name=..., domain_verification_token=..., expiration_time=..., id=..., intermediate=..., is_private_key_external=..., key_size=..., kind=..., last_certificate_issuance_time=..., location=..., name=..., next_auto_renewal_time_stamp=..., product_type=..., provisioning_state=..., root=..., serial_number=..., signed_certificate=..., status=..., tags=..., type=..., validity_in_years=...) -> None:
        ...
...
class AwaitableGetAppServiceCertificateOrderResult(GetAppServiceCertificateOrderResult):
    def __await__(self): # -> Generator[Never, Any, GetAppServiceCertificateOrderResult]:
        ...
    


def get_app_service_certificate_order(certificate_order_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAppServiceCertificateOrderResult:
    
    ...

def get_app_service_certificate_order_output(certificate_order_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAppServiceCertificateOrderResult]:
