...
class AwaitableGetRegistryEnvironmentContainerResult(
    GetRegistryEnvironmentContainerResult
):
    def __await__(self): ...

def get_registry_environment_container(
    environment_name: Optional[_builtins.str] = ...,
    registry_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetRegistryEnvironmentContainerResult: ...
def get_registry_environment_container_output(
...
) -> pulumi.Output[GetRegistryEnvironmentContainerResult]: ...
