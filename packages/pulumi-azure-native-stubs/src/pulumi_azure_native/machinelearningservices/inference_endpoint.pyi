...
class InferenceEndpointInitArgs:
    ...
    def inference_endpoint_properties(
        self, value: pulumi.Input[InferenceEndpointArgs]
    ): ...
    @_builtins.property
...
class InferenceEndpoint(pulumi.CustomResource):
    ...
    def __init__(
        ...
        inference_endpoint_properties: Optional[
            pulumi.Input[Union[InferenceEndpointArgs, InferenceEndpointArgsDict]]
        ] = ...,
        kind: Optional[pulumi.Input[_builtins.str]] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def inference_endpoint_properties(
        self,
    ) -> pulumi.Output[outputs.InferenceEndpointResponse]: ...
    @_builtins.property
    @pulumi.getter
