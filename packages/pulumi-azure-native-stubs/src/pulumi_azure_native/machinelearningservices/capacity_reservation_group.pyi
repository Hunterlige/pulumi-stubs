...
class CapacityReservationGroupInitArgs:
    def __init__(
        __self__,
        *,
        capacity_reservation_group_properties: pulumi.Input[
    ...
    def capacity_reservation_group_properties(
        self,
    ) -> pulumi.Input[CapacityReservationGroupArgs]: ...
    @capacity_reservation_group_properties.setter
    def capacity_reservation_group_properties(
        self, value: pulumi.Input[CapacityReservationGroupArgs]
    ): ...
    @_builtins.property
...
class CapacityReservationGroup(pulumi.CustomResource):
    ...
    def __init__(
        ...
        capacity_reservation_group_properties: Optional[
            pulumi.Input[
                Union[CapacityReservationGroupArgs, CapacityReservationGroupArgsDict]
            ]
        ] = ...,
        group_id: Optional[pulumi.Input[_builtins.str]] = ...,
        identity: Optional[
    ...
    def capacity_reservation_group_properties(
        self,
    ) -> pulumi.Output[outputs.CapacityReservationGroupResponse]: ...
    @_builtins.property
    @pulumi.getter
    def identity(
        self,
