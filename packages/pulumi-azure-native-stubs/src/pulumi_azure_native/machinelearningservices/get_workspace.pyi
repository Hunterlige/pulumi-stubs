...
class GetWorkspaceResult:
    ...
    def __init__(__self__, allow_public_access_when_behind_vnet=..., application_insights=..., associated_workspaces=..., azure_api_version=..., container_registry=..., description=..., discovery_url=..., enable_data_isolation=..., enable_service_side_cmk_encryption=..., encryption=..., feature_store_settings=..., friendly_name=..., hbi_workspace=..., hub_resource_id=..., id=..., identity=..., image_build_compute=..., key_vault=..., kind=..., location=..., managed_network=..., ml_flow_tracking_uri=..., name=..., notebook_info=..., primary_user_assigned_identity=..., private_endpoint_connections=..., private_link_count=..., provision_network_now=..., provisioning_state=..., public_network_access=..., serverless_compute_settings=..., service_managed_resources_settings=..., service_provisioned_resource_group=..., shared_private_link_resources=..., sku=..., storage_account=..., storage_hns_enabled=..., system_data=..., system_datastores_auth_mode=..., tags=..., tenant_id=..., type=..., v1_legacy_mode=..., workspace_hub_config=..., workspace_id=...) -> None:
        ...
