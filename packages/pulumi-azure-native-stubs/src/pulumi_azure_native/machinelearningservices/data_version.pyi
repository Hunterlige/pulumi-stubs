    ...
    def __init__(
        ...
        *,
        ...
        properties: pulumi.Input[
            Union[MLTableDataArgs, UriFileDataVersionArgs, UriFolderDataVersionArgs]
        ],
...
class DataVersion(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    Union[MLTableDataArgs, MLTableDataArgsDict],
                    Union[UriFileDataVersionArgs, UriFileDataVersionArgsDict],
                    Union[UriFolderDataVersionArgs, UriFolderDataVersionArgsDict],
                ]
            ]
        ] = ...,
