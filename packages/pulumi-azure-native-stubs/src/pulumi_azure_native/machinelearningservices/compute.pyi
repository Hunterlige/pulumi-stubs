...
class Compute(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    Union[AKSArgs, AKSArgsDict],
                    Union[AmlComputeArgs, AmlComputeArgsDict],
                    Union[ComputeInstanceArgs, ComputeInstanceArgsDict],
                    Union[DataFactoryArgs, DataFactoryArgsDict],
                    Union[DataLakeAnalyticsArgs, DataLakeAnalyticsArgsDict],
                    Union[DatabricksArgs, DatabricksArgsDict],
                    Union[HDInsightArgs, HDInsightArgsDict],
                    Union[KubernetesArgs, KubernetesArgsDict],
                    Union[SynapseSparkArgs, SynapseSparkArgsDict],
                    Union[VirtualMachineArgs, VirtualMachineArgsDict],
                ]
            ]
        ] = ...,
