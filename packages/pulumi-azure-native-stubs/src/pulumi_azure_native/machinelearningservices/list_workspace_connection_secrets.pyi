...
class ListWorkspaceConnectionSecretsResult:
    def __init__(
        __self__, id=..., name=..., properties=..., system_data=..., type=...
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
...
class AwaitableListWorkspaceConnectionSecretsResult(
    ListWorkspaceConnectionSecretsResult
):
    def __await__(self): ...

def list_workspace_connection_secrets(
...
) -> pulumi.Output[ListWorkspaceConnectionSecretsResult]: ...
