...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetDraftPackageResult', 'AwaitableGetDraftPackageResult', 'get_draft_package', 'get_draft_package_output']
@pulumi.output_type
class GetDraftPackageResult:
    
    def __init__(__self__, app_file_name=..., application_name=..., azure_api_version=..., comments=..., draft_package_path=..., edit_package=..., executable_launch_command=..., first_party_apps=..., flighting_ring=..., gallery_apps=..., highlighted_files=..., id=..., inplace_upgrade_os_pair=..., intune_enrollment_metadata=..., intune_metadata=..., last_modified_time=..., name=..., package_id=..., package_tags=..., process_name=..., provisioning_state=..., source_type=..., system_data=..., tab_state=..., target_os_list=..., test_types=..., tests=..., type=..., use_autofill=..., use_sample=..., version=..., working_path=...) -> None:
        ...
...
class AwaitableGetDraftPackageResult(GetDraftPackageResult):
    def __await__(self): # -> Generator[Never, Any, GetDraftPackageResult]:
        ...
    


def get_draft_package(draft_package_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., test_base_account_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDraftPackageResult:
    
    ...

def get_draft_package_output(draft_package_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., test_base_account_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDraftPackageResult]:
