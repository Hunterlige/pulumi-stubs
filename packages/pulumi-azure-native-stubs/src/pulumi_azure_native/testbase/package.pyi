...
@pulumi.input_type
class PackageArgs:
    def __init__(__self__, *, application_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], test_base_account_name: pulumi.Input[_builtins.str], version: pulumi.Input[_builtins.str], blob_path: Optional[pulumi.Input[_builtins.str]] = ..., draft_package_id: Optional[pulumi.Input[_builtins.str]] = ..., first_party_apps: Optional[pulumi.Input[Sequence[pulumi.Input[FirstPartyAppDefinitionArgs]]]] = ..., flighting_ring: Optional[pulumi.Input[_builtins.str]] = ..., inplace_upgrade_os_pair: Optional[pulumi.Input[InplaceUpgradeOSInfoArgs]] = ..., intune_enrollment_metadata: Optional[pulumi.Input[IntuneEnrollmentMetadataArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., package_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_os_list: Optional[pulumi.Input[Sequence[pulumi.Input[TargetOSInfoArgs]]]] = ..., tests: Optional[pulumi.Input[Sequence[pulumi.Input[TestArgs]]]] = ...) -> None:
    ...
    @blob_path.setter
    def blob_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def draft_package_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Package(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., application_name: Optional[pulumi.Input[_builtins.str]] = ..., blob_path: Optional[pulumi.Input[_builtins.str]] = ..., draft_package_id: Optional[pulumi.Input[_builtins.str]] = ..., first_party_apps: Optional[pulumi.Input[Sequence[pulumi.Input[Union[FirstPartyAppDefinitionArgs, FirstPartyAppDefinitionArgsDict]]]]] = ..., flighting_ring: Optional[pulumi.Input[_builtins.str]] = ..., inplace_upgrade_os_pair: Optional[pulumi.Input[Union[InplaceUpgradeOSInfoArgs, InplaceUpgradeOSInfoArgsDict]]] = ..., intune_enrollment_metadata: Optional[pulumi.Input[Union[IntuneEnrollmentMetadataArgs, IntuneEnrollmentMetadataArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., package_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_os_list: Optional[pulumi.Input[Sequence[pulumi.Input[Union[TargetOSInfoArgs, TargetOSInfoArgsDict]]]]] = ..., test_base_account_name: Optional[pulumi.Input[_builtins.str]] = ..., tests: Optional[pulumi.Input[Sequence[pulumi.Input[Union[TestArgs, TestArgsDict]]]]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
