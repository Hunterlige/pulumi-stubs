...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CommandArgs', 'CommandArgsDict', 'DistributionGroupListReceiverValueArgs', 'DistributionGroupListReceiverValueArgsDict', 'DraftPackageIntuneAppMetadataItemArgs', 'DraftPackageIntuneAppMetadataItemArgsDict', 'DraftPackageIntuneAppMetadataArgs', 'DraftPackageIntuneAppMetadataArgsDict', 'EnrolledIntuneAppArgs', 'EnrolledIntuneAppArgsDict', 'FirstPartyAppDefinitionArgs', 'FirstPartyAppDefinitionArgsDict', 'GalleryAppDefinitionArgs', 'GalleryAppDefinitionArgsDict', 'HighlightedFileArgs', 'HighlightedFileArgsDict', 'InplaceUpgradeOSInfoArgs', 'InplaceUpgradeOSInfoArgsDict', 'IntuneEnrollmentMetadataArgs', 'IntuneEnrollmentMetadataArgsDict', 'NotificationEventReceiverArgs', 'NotificationEventReceiverArgsDict', 'NotificationReceiverValueArgs', 'NotificationReceiverValueArgsDict', 'OsPropertiesArgs', 'OsPropertiesArgsDict', 'PreReleaseAccessRequestSpecArgs', 'PreReleaseAccessRequestSpecArgsDict', 'ReleasePropertiesArgs', 'ReleasePropertiesArgsDict', 'SubscriptionReceiverValueArgs', 'SubscriptionReceiverValueArgsDict', 'SystemAssignedServiceIdentityArgs', 'SystemAssignedServiceIdentityArgsDict', 'TabStateArgs', 'TabStateArgsDict', 'TargetOSInfoArgs', 'TargetOSInfoArgsDict', 'TestBaseAccountSKUArgs', 'TestBaseAccountSKUArgsDict', 'TestArgs', 'TestArgsDict', 'UserObjectReceiverValueArgs', 'UserObjectReceiverValueArgsDict']
...
@pulumi.input_type
class CommandArgs:
    def __init__(__self__, *, action: pulumi.Input[Union[_builtins.str, Action]], content: pulumi.Input[_builtins.str], content_type: pulumi.Input[Union[_builtins.str, ContentType]], name: pulumi.Input[_builtins.str], always_run: Optional[pulumi.Input[_builtins.bool]] = ..., apply_update_before: Optional[pulumi.Input[_builtins.bool]] = ..., enroll_intune_before: Optional[pulumi.Input[_builtins.bool]] = ..., install1_p_app_before: Optional[pulumi.Input[_builtins.bool]] = ..., max_run_time: Optional[pulumi.Input[_builtins.int]] = ..., post_upgrade: Optional[pulumi.Input[_builtins.bool]] = ..., pre_upgrade: Optional[pulumi.Input[_builtins.bool]] = ..., restart_after: Optional[pulumi.Input[_builtins.bool]] = ..., run_as_interactive: Optional[pulumi.Input[_builtins.bool]] = ..., run_elevated: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @content_type.setter
    def content_type(self, value: pulumi.Input[Union[_builtins.str, ContentType]]): # -> None:
        ...
    ...
    @always_run.setter
    def always_run(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def apply_update_before(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enroll_intune_before(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def install1_p_app_before(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @max_run_time.setter
    def max_run_time(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @post_upgrade.setter
    def post_upgrade(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @pre_upgrade.setter
    def pre_upgrade(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def restart_after(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def run_as_interactive(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DistributionGroupListReceiverValueArgs:
    def __init__(__self__, *, distribution_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def distribution_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DraftPackageIntuneAppMetadataItemArgsDict(TypedDict):
    ...
    expected_exit_codes: NotRequired[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]
...
class DraftPackageIntuneAppMetadataItemArgs:
    def __init__(__self__, *, app_id: Optional[pulumi.Input[_builtins.str]] = ..., app_name: Optional[pulumi.Input[_builtins.str]] = ..., create_date: Optional[pulumi.Input[_builtins.str]] = ..., dependency_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., dependent_app_count: Optional[pulumi.Input[_builtins.int]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., expected_exit_codes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., install_command: Optional[pulumi.Input[_builtins.str]] = ..., last_processed: Optional[pulumi.Input[_builtins.float]] = ..., minimum_supported_os: Optional[pulumi.Input[_builtins.str]] = ..., owner: Optional[pulumi.Input[_builtins.str]] = ..., publisher: Optional[pulumi.Input[_builtins.str]] = ..., setup_file: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, IntuneExtractStatus]]] = ..., uninstall_command: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dependency_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @dependency_ids.setter
    def dependency_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def dependent_app_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def expected_exit_codes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @expected_exit_codes.setter
    def expected_exit_codes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def install_command(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def last_processed(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def minimum_supported_os(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @setup_file.setter
    def setup_file(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter
    def status(self) -> Optional[pulumi.Input[Union[_builtins.str, IntuneExtractStatus]]]:
        
        ...
    
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[_builtins.str, IntuneExtractStatus]]]): # -> None:
        ...
    ...
    def uninstall_command(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DraftPackageIntuneAppMetadataArgs:
    def __init__(__self__, *, intune_app: Optional[pulumi.Input[DraftPackageIntuneAppMetadataItemArgs]] = ..., intune_app_dependencies: Optional[pulumi.Input[Sequence[pulumi.Input[DraftPackageIntuneAppMetadataItemArgs]]]] = ...) -> None:
    ...
    @intune_app.setter
    def intune_app(self, value: Optional[pulumi.Input[DraftPackageIntuneAppMetadataItemArgs]]): # -> None:
        ...
    ...
    def intune_app_dependencies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DraftPackageIntuneAppMetadataItemArgs]]]]): # -> None:
        ...
...
class EnrolledIntuneAppArgs:
    def __init__(__self__, *, app_id: pulumi.Input[_builtins.str], app_name: pulumi.Input[_builtins.str], expected_installation_path: pulumi.Input[_builtins.str]) -> None:
    ...
    def expected_installation_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class FirstPartyAppDefinitionArgsDict(TypedDict):
    ...
    interop_execution_mode: NotRequired[pulumi.Input[Union[_builtins.str, InteropExecutionMode]]]
...
class FirstPartyAppDefinitionArgs:
    def __init__(__self__, *, architecture: Optional[pulumi.Input[Union[_builtins.str, Architecture]]] = ..., channel: Optional[pulumi.Input[_builtins.str]] = ..., interop_execution_mode: Optional[pulumi.Input[Union[_builtins.str, InteropExecutionMode]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., ring: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def interop_execution_mode(self) -> Optional[pulumi.Input[Union[_builtins.str, InteropExecutionMode]]]:
        
        ...
    
    @interop_execution_mode.setter
    def interop_execution_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, InteropExecutionMode]]]): # -> None:
        ...
    ...
    @ring.setter
    def ring(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GalleryAppDefinitionArgs:
    def __init__(__self__, *, sku_id: pulumi.Input[_builtins.str], is_consented: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @sku_id.setter
    def sku_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @is_consented.setter
    def is_consented(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class HighlightedFileArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], sections: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., visited: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @_builtins.property
    @pulumi.getter
    def sections(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @sections.setter
    def sections(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @visited.setter
    def visited(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class InplaceUpgradeOSInfoArgs:
    def __init__(__self__, *, baseline_os: Optional[pulumi.Input[OsPropertiesArgs]] = ..., target_os: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @baseline_os.setter
    def baseline_os(self, value: Optional[pulumi.Input[OsPropertiesArgs]]): # -> None:
        ...
    ...
    @target_os.setter
    def target_os(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IntuneEnrollmentMetadataArgs:
    def __init__(__self__, *, app_list: Optional[pulumi.Input[Sequence[pulumi.Input[EnrolledIntuneAppArgs]]]] = ..., credential_id: Optional[pulumi.Input[_builtins.str]] = ..., expected_deployment_duration_in_minute: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @app_list.setter
    def app_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EnrolledIntuneAppArgs]]]]): # -> None:
        ...
    ...
    def credential_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="expectedDeploymentDurationInMinute")
    def expected_deployment_duration_in_minute(self) -> Optional[pulumi.Input[_builtins.int]]:
        
        ...
    
    @expected_deployment_duration_in_minute.setter
    def expected_deployment_duration_in_minute(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class NotificationEventReceiverArgs:
    def __init__(__self__, *, receiver_type: Optional[pulumi.Input[_builtins.str]] = ..., receiver_value: Optional[pulumi.Input[NotificationReceiverValueArgs]] = ...) -> None:
    ...
    def receiver_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def receiver_value(self, value: Optional[pulumi.Input[NotificationReceiverValueArgs]]): # -> None:
        ...
...
class NotificationReceiverValueArgs:
    def __init__(__self__, *, distribution_group_list_receiver_value: Optional[pulumi.Input[DistributionGroupListReceiverValueArgs]] = ..., subscription_receiver_value: Optional[pulumi.Input[SubscriptionReceiverValueArgs]] = ..., user_object_receiver_value: Optional[pulumi.Input[UserObjectReceiverValueArgs]] = ...) -> None:
    ...
    def distribution_group_list_receiver_value(self, value: Optional[pulumi.Input[DistributionGroupListReceiverValueArgs]]): # -> None:
        ...
    ...
    def subscription_receiver_value(self, value: Optional[pulumi.Input[SubscriptionReceiverValueArgs]]): # -> None:
        ...
    ...
    def user_object_receiver_value(self, value: Optional[pulumi.Input[UserObjectReceiverValueArgs]]): # -> None:
        ...
...
class OsPropertiesArgs:
    def __init__(__self__, *, custom_image_id: Optional[pulumi.Input[_builtins.str]] = ..., os_name: Optional[pulumi.Input[_builtins.str]] = ..., release_properties: Optional[pulumi.Input[ReleasePropertiesArgs]] = ...) -> None:
    ...
    def release_properties(self, value: Optional[pulumi.Input[ReleasePropertiesArgs]]): # -> None:
        ...
...
class PreReleaseAccessRequestSpecArgsDict(TypedDict):
    ...
    engagements: NotRequired[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Engagements]]]]]
...
class PreReleaseAccessRequestSpecArgs:
    def __init__(__self__, *, city: Optional[pulumi.Input[_builtins.str]] = ..., company_website: Optional[pulumi.Input[_builtins.str]] = ..., country_and_region: Optional[pulumi.Input[_builtins.str]] = ..., email: Optional[pulumi.Input[_builtins.str]] = ..., engagements: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Engagements]]]]] = ..., organization_name: Optional[pulumi.Input[_builtins.str]] = ..., state_or_province: Optional[pulumi.Input[_builtins.str]] = ..., street_address: Optional[pulumi.Input[_builtins.str]] = ..., zip_code: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    def company_website(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def country_and_region(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @_builtins.property
    @pulumi.getter
    def engagements(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Engagements]]]]]:
        ...
    
    @engagements.setter
    def engagements(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Engagements]]]]]): # -> None:
        ...
...
class ReleasePropertiesArgs:
    def __init__(__self__, *, build_number: Optional[pulumi.Input[_builtins.str]] = ..., build_revision: Optional[pulumi.Input[_builtins.str]] = ..., release_name: Optional[pulumi.Input[_builtins.str]] = ..., release_version_date: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @build_number.setter
    def build_number(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def build_revision(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def release_version_date(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SubscriptionReceiverValueArgs:
    def __init__(__self__, *, role: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., subscription_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def subscription_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TabStateArgsDict(TypedDict):
    ...
    visited_tabs: NotRequired[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, PackageStudioTabs]]]]]


@pulumi.input_type
class TabStateArgs:
    def __init__(__self__, *, current_tab: Optional[pulumi.Input[Union[_builtins.str, PackageStudioTabs]]] = ..., visited_tabs: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, PackageStudioTabs]]]]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="currentTab")
    def current_tab(self) -> Optional[pulumi.Input[Union[_builtins.str, PackageStudioTabs]]]:
        
        ...
    
    @current_tab.setter
    def current_tab(self, value: Optional[pulumi.Input[Union[_builtins.str, PackageStudioTabs]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="visitedTabs")
    def visited_tabs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, PackageStudioTabs]]]]]:
        
        ...
    
    @visited_tabs.setter
    def visited_tabs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, PackageStudioTabs]]]]]): # -> None:
        ...
...
class TargetOSInfoArgsDict(TypedDict):
    ...
    insider_channel_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]
    target_os_image_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]
    target_oss: NotRequired[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]


@pulumi.input_type
class TargetOSInfoArgs:
    def __init__(__self__, *, os_update_type: pulumi.Input[_builtins.str], baseline_oss: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., insider_channel_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., target_os_image_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., target_oss: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def os_update_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="baselineOSs")
    def baseline_oss(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @baseline_oss.setter
    def baseline_oss(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="insiderChannelIds")
    def insider_channel_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @insider_channel_ids.setter
    def insider_channel_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="targetOSImageIds")
    def target_os_image_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @target_os_image_ids.setter
    def target_os_image_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="targetOSs")
    def target_oss(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @target_oss.setter
    def target_oss(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class TestBaseAccountSKUArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], tier: pulumi.Input[Union[_builtins.str, Tier]], locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., resource_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @tier.setter
    def tier(self, value: pulumi.Input[Union[_builtins.str, Tier]]): # -> None:
        ...
...
@pulumi.input_type
class TestArgs:
    def __init__(__self__, *, commands: pulumi.Input[Sequence[pulumi.Input[CommandArgs]]], test_type: pulumi.Input[Union[_builtins.str, TestType]], is_active: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @commands.setter
    def commands(self, value: pulumi.Input[Sequence[pulumi.Input[CommandArgs]]]): # -> None:
        ...
    ...
    @test_type.setter
    def test_type(self, value: pulumi.Input[Union[_builtins.str, TestType]]): # -> None:
        ...
...
class UserObjectReceiverValueArgs:
    def __init__(__self__, *, user_object_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="userObjectIds")
    def user_object_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @user_object_ids.setter
    def user_object_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
