...
class LandingZoneAccountOperationArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[
            pulumi.Input[LandingZoneAccountResourcePropertiesArgs]
        ] = ...,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[LandingZoneAccountResourcePropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[LandingZoneAccountResourcePropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class LandingZoneAccountOperation(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.LandingZoneAccountResourcePropertiesResponse]: ...
    @_builtins.property
