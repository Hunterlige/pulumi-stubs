...
class GetOrderResult:
    ...
    def __init__(__self__, azure_api_version=..., contact_information=..., current_status=..., delivery_tracking_info=..., id=..., kind=..., name=..., order_history=..., order_id=..., return_tracking_info=..., serial_number=..., shipment_type=..., shipping_address=..., system_data=..., type=...) -> None:
        ...
...
class AwaitableGetOrderResult(GetOrderResult):
    def __await__(self): # -> Generator[Never, Any, GetOrderResult]:
        ...
    


def get_order(device_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetOrderResult:
    
    ...

def get_order_output(device_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetOrderResult]:
