...
@pulumi.input_type
class OrderArgs:
    def __init__(__self__, *, contact_information: pulumi.Input[ContactDetailsArgs], device_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], shipment_type: Optional[pulumi.Input[Union[_builtins.str, ShipmentType]]] = ..., shipping_address: Optional[pulumi.Input[AddressArgs]] = ...) -> None:
    ...
    def contact_information(self, value: pulumi.Input[ContactDetailsArgs]): # -> None:
        ...
    ...
    def shipment_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ShipmentType]]]): # -> None:
        ...
    ...
    def shipping_address(self, value: Optional[pulumi.Input[AddressArgs]]): # -> None:
        ...
...
class Order(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., contact_information: Optional[pulumi.Input[Union[ContactDetailsArgs, ContactDetailsArgsDict]]] = ..., device_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., shipment_type: Optional[pulumi.Input[Union[_builtins.str, ShipmentType]]] = ..., shipping_address: Optional[pulumi.Input[Union[AddressArgs, AddressArgsDict]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: OrderArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Order:
