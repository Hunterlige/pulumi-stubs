...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AddressResponse', 'AsymmetricEncryptedSecretResponse', 'AuthenticationResponse', 'AzureContainerInfoResponse', 'ClientAccessRightResponse', 'CniConfigResponse', 'ComputeResourceResponse', 'ContactDetailsResponse', 'DataResidencyResponse', 'EdgeProfileResponse', 'EdgeProfileSubscriptionResponse', 'EtcdInfoResponse', 'FileSourceInfoResponse', 'ImageRepositoryCredentialResponse', 'IoTDeviceInfoResponse', 'IoTEdgeAgentInfoResponse', 'KubernetesClusterInfoResponse', 'KubernetesIPConfigurationResponse', 'KubernetesRoleComputeResponse', 'KubernetesRoleNetworkResponse', 'KubernetesRoleResourcesResponse', 'KubernetesRoleStorageClassInfoResponse', 'KubernetesRoleStorageResponse', 'LoadBalancerConfigResponse', 'MetricConfigurationResponse', 'MetricCounterResponse', 'MetricCounterSetResponse', 'MetricDimensionResponse', 'MountPointMapResponse', 'NodeInfoResponse', 'OrderStatusResponse', 'PeriodicTimerSourceInfoResponse', 'RefreshDetailsResponse', 'ResourceIdentityResponse', 'ResourceMoveDetailsResponse', 'RoleSinkInfoResponse', 'SecretResponse', 'ShareAccessRightResponse', 'SkuResponse', 'SubscriptionRegisteredFeaturesResponse', 'SymmetricKeyResponse', 'SystemDataResponse', 'TrackingInfoResponse', 'UserAccessRightResponse']
@pulumi.output_type
class AddressResponse(dict):
    ...
    def __init__(__self__, *, country: _builtins.str, address_line1: Optional[_builtins.str] = ..., address_line2: Optional[_builtins.str] = ..., address_line3: Optional[_builtins.str] = ..., city: Optional[_builtins.str] = ..., postal_code: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class AsymmetricEncryptedSecretResponse(dict):
    ...
    def __init__(__self__, *, encryption_algorithm: _builtins.str, value: _builtins.str, encryption_cert_thumbprint: Optional[_builtins.str] = ...) -> None:
...
class AuthenticationResponse(dict):
    ...
    def __init__(__self__, *, symmetric_key: Optional[outputs.SymmetricKeyResponse] = ...) -> None:
...
class AzureContainerInfoResponse(dict):
    ...
    def __init__(__self__, *, container_name: _builtins.str, data_format: _builtins.str, storage_account_credential_id: _builtins.str) -> None:
...
class ClientAccessRightResponse(dict):
    ...
    def __init__(__self__, *, access_permission: _builtins.str, client: _builtins.str) -> None:
...
class CniConfigResponse(dict):
    ...
    def __init__(__self__, *, pod_subnet: _builtins.str, service_subnet: _builtins.str, type: _builtins.str, version: _builtins.str) -> None:
...
class ComputeResourceResponse(dict):
    ...
    def __init__(__self__, *, memory_in_gb: _builtins.float, processor_count: _builtins.int) -> None:
...
class ContactDetailsResponse(dict):
    ...
    def __init__(__self__, *, company_name: _builtins.str, contact_person: _builtins.str, email_list: Sequence[_builtins.str], phone: _builtins.str) -> None:
...
class EdgeProfileResponse(dict):
    ...
    def __init__(__self__, *, subscription: Optional[outputs.EdgeProfileSubscriptionResponse] = ...) -> None:
...
class EdgeProfileSubscriptionResponse(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., location_placement_id: Optional[_builtins.str] = ..., quota_id: Optional[_builtins.str] = ..., registered_features: Optional[Sequence[outputs.SubscriptionRegisteredFeaturesResponse]] = ..., registration_date: Optional[_builtins.str] = ..., registration_id: Optional[_builtins.str] = ..., serialized_details: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., subscription_id: Optional[_builtins.str] = ..., tenant_id: Optional[_builtins.str] = ...) -> None:
...
class ImageRepositoryCredentialResponse(dict):
    ...
    def __init__(__self__, *, image_repository_url: _builtins.str, user_name: _builtins.str, password: Optional[outputs.AsymmetricEncryptedSecretResponse] = ...) -> None:
...
class IoTDeviceInfoResponse(dict):
    ...
    def __init__(__self__, *, device_id: _builtins.str, io_t_host_hub: _builtins.str, authentication: Optional[outputs.AuthenticationResponse] = ..., io_t_host_hub_id: Optional[_builtins.str] = ...) -> None:
...
class IoTEdgeAgentInfoResponse(dict):
    ...
    def __init__(__self__, *, image_name: _builtins.str, tag: _builtins.str, image_repository: Optional[outputs.ImageRepositoryCredentialResponse] = ...) -> None:
...
class KubernetesClusterInfoResponse(dict):
    ...
    def __init__(__self__, *, etcd_info: outputs.EtcdInfoResponse, nodes: Sequence[outputs.NodeInfoResponse], version: _builtins.str) -> None:
...
class KubernetesIPConfigurationResponse(dict):
    ...
    def __init__(__self__, *, port: _builtins.str, ip_address: Optional[_builtins.str] = ...) -> None:
...
class KubernetesRoleComputeResponse(dict):
    ...
    def __init__(__self__, *, memory_in_bytes: _builtins.float, processor_count: _builtins.int, vm_profile: _builtins.str) -> None:
...
class KubernetesRoleNetworkResponse(dict):
    ...
    def __init__(__self__, *, cni_config: outputs.CniConfigResponse, load_balancer_config: outputs.LoadBalancerConfigResponse) -> None:
...
class KubernetesRoleResourcesResponse(dict):
    ...
    def __init__(__self__, *, compute: outputs.KubernetesRoleComputeResponse, network: outputs.KubernetesRoleNetworkResponse, storage: Optional[outputs.KubernetesRoleStorageResponse] = ...) -> None:
...
class KubernetesRoleStorageClassInfoResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, posix_compliant: _builtins.str, type: _builtins.str) -> None:
...
class KubernetesRoleStorageResponse(dict):
    ...
    def __init__(__self__, *, storage_classes: Sequence[outputs.KubernetesRoleStorageClassInfoResponse], endpoints: Optional[Sequence[outputs.MountPointMapResponse]] = ...) -> None:
...
class MetricConfigurationResponse(dict):
    ...
    def __init__(__self__, *, counter_sets: Sequence[outputs.MetricCounterSetResponse], resource_id: _builtins.str, mdm_account: Optional[_builtins.str] = ..., metric_name_space: Optional[_builtins.str] = ...) -> None:
...
class MetricCounterResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, additional_dimensions: Optional[Sequence[outputs.MetricDimensionResponse]] = ..., dimension_filter: Optional[Sequence[outputs.MetricDimensionResponse]] = ..., instance: Optional[_builtins.str] = ...) -> None:
...
class MetricCounterSetResponse(dict):
    ...
    def __init__(__self__, *, counters: Sequence[outputs.MetricCounterResponse]) -> None:
...
class MetricDimensionResponse(dict):
    ...
    def __init__(__self__, *, source_name: _builtins.str, source_type: _builtins.str) -> None:
...
class MountPointMapResponse(dict):
    ...
    def __init__(__self__, *, mount_point: _builtins.str, mount_type: _builtins.str, role_id: _builtins.str, role_type: _builtins.str, share_id: _builtins.str) -> None:
...
class NodeInfoResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, type: _builtins.str, ip_configuration: Optional[Sequence[outputs.KubernetesIPConfigurationResponse]] = ...) -> None:
...
class OrderStatusResponse(dict):
    ...
    def __init__(__self__, *, additional_order_details: Mapping[str, _builtins.str], status: _builtins.str, tracking_information: outputs.TrackingInfoResponse, update_date_time: _builtins.str, comments: Optional[_builtins.str] = ...) -> None:
...
class PeriodicTimerSourceInfoResponse(dict):
    ...
    def __init__(__self__, *, schedule: _builtins.str, start_time: _builtins.str, topic: Optional[_builtins.str] = ...) -> None:
...
class RefreshDetailsResponse(dict):
    ...
    def __init__(__self__, *, error_manifest_file: Optional[_builtins.str] = ..., in_progress_refresh_job_id: Optional[_builtins.str] = ..., last_completed_refresh_job_time_in_utc: Optional[_builtins.str] = ..., last_job: Optional[_builtins.str] = ...) -> None:
...
class ResourceMoveDetailsResponse(dict):
    ...
    def __init__(__self__, *, operation_in_progress: Optional[_builtins.str] = ..., operation_in_progress_lock_timeout_in_utc: Optional[_builtins.str] = ...) -> None:
...
class SecretResponse(dict):
    ...
    def __init__(__self__, *, encrypted_secret: Optional[outputs.AsymmetricEncryptedSecretResponse] = ..., key_vault_id: Optional[_builtins.str] = ...) -> None:
...
class ShareAccessRightResponse(dict):
    ...
    def __init__(__self__, *, access_type: _builtins.str, share_id: _builtins.str) -> None:
...
class SymmetricKeyResponse(dict):
    ...
    def __init__(__self__, *, connection_string: Optional[outputs.AsymmetricEncryptedSecretResponse] = ...) -> None:
...
class TrackingInfoResponse(dict):
    ...
    def __init__(__self__, *, carrier_name: Optional[_builtins.str] = ..., serial_number: Optional[_builtins.str] = ..., tracking_id: Optional[_builtins.str] = ..., tracking_url: Optional[_builtins.str] = ...) -> None:
...
class UserAccessRightResponse(dict):
    ...
    def __init__(__self__, *, access_type: _builtins.str, user_id: _builtins.str) -> None:
