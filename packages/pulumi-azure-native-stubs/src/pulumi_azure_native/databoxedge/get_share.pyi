...
class GetShareResult:
    ...
    def __init__(__self__, access_protocol=..., azure_api_version=..., azure_container_info=..., client_access_rights=..., data_policy=..., description=..., id=..., monitoring_status=..., name=..., refresh_details=..., share_mappings=..., share_status=..., system_data=..., type=..., user_access_rights=...) -> None:
        ...
...
class AwaitableGetShareResult(GetShareResult):
    def __await__(self): # -> Generator[Never, Any, GetShareResult]:
        ...
    


def get_share(device_name: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetShareResult:
    
    ...

def get_share_output(device_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetShareResult]:
