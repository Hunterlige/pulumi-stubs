...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AddressArgs', 'AddressArgsDict', 'AsymmetricEncryptedSecretArgs', 'AsymmetricEncryptedSecretArgsDict', 'AuthenticationArgs', 'AuthenticationArgsDict', 'AzureContainerInfoArgs', 'AzureContainerInfoArgsDict', 'ClientAccessRightArgs', 'ClientAccessRightArgsDict', 'ComputeResourceArgs', 'ComputeResourceArgsDict', 'ContactDetailsArgs', 'ContactDetailsArgsDict', 'DataResidencyArgs', 'DataResidencyArgsDict', 'FileSourceInfoArgs', 'FileSourceInfoArgsDict', 'ImageRepositoryCredentialArgs', 'ImageRepositoryCredentialArgsDict', 'IoTDeviceInfoArgs', 'IoTDeviceInfoArgsDict', 'IoTEdgeAgentInfoArgs', 'IoTEdgeAgentInfoArgsDict', 'KubernetesClusterInfoArgs', 'KubernetesClusterInfoArgsDict', 'KubernetesRoleComputeArgs', 'KubernetesRoleComputeArgsDict', 'KubernetesRoleResourcesArgs', 'KubernetesRoleResourcesArgsDict', 'KubernetesRoleStorageArgs', 'KubernetesRoleStorageArgsDict', 'MetricConfigurationArgs', 'MetricConfigurationArgsDict', 'MetricCounterSetArgs', 'MetricCounterSetArgsDict', 'MetricCounterArgs', 'MetricCounterArgsDict', 'MetricDimensionArgs', 'MetricDimensionArgsDict', 'MountPointMapArgs', 'MountPointMapArgsDict', 'PeriodicTimerSourceInfoArgs', 'PeriodicTimerSourceInfoArgsDict', 'RefreshDetailsArgs', 'RefreshDetailsArgsDict', 'ResourceIdentityArgs', 'ResourceIdentityArgsDict', 'RoleSinkInfoArgs', 'RoleSinkInfoArgsDict', 'SkuArgs', 'SkuArgsDict', 'SymmetricKeyArgs', 'SymmetricKeyArgsDict', 'UserAccessRightArgs', 'UserAccessRightArgsDict']
...
@pulumi.input_type
class AddressArgs:
    def __init__(__self__, *, country: pulumi.Input[_builtins.str], address_line1: Optional[pulumi.Input[_builtins.str]] = ..., address_line2: Optional[pulumi.Input[_builtins.str]] = ..., address_line3: Optional[pulumi.Input[_builtins.str]] = ..., city: Optional[pulumi.Input[_builtins.str]] = ..., postal_code: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AsymmetricEncryptedSecretArgs:
    def __init__(__self__, *, encryption_algorithm: pulumi.Input[Union[_builtins.str, EncryptionAlgorithm]], value: pulumi.Input[_builtins.str], encryption_cert_thumbprint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def encryption_cert_thumbprint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AuthenticationArgs:
    def __init__(__self__, *, symmetric_key: Optional[pulumi.Input[SymmetricKeyArgs]] = ...) -> None:
    ...
    def symmetric_key(self, value: Optional[pulumi.Input[SymmetricKeyArgs]]): # -> None:
        ...
...
class AzureContainerInfoArgs:
    def __init__(__self__, *, container_name: pulumi.Input[_builtins.str], data_format: pulumi.Input[Union[_builtins.str, AzureContainerDataFormat]], storage_account_credential_id: pulumi.Input[_builtins.str]) -> None:
    ...
    def storage_account_credential_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClientAccessRightArgs:
    def __init__(__self__, *, access_permission: pulumi.Input[Union[_builtins.str, ClientPermissionType]], client: pulumi.Input[_builtins.str]) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="accessPermission")
    def access_permission(self) -> pulumi.Input[Union[_builtins.str, ClientPermissionType]]:
        
        ...
    
    @access_permission.setter
    def access_permission(self, value: pulumi.Input[Union[_builtins.str, ClientPermissionType]]): # -> None:
        ...
    ...
    @client.setter
    def client(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ComputeResourceArgs:
    def __init__(__self__, *, memory_in_gb: pulumi.Input[_builtins.float], processor_count: pulumi.Input[_builtins.int]) -> None:
    ...
    def processor_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ContactDetailsArgs:
    def __init__(__self__, *, company_name: pulumi.Input[_builtins.str], contact_person: pulumi.Input[_builtins.str], email_list: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], phone: pulumi.Input[_builtins.str]) -> None:
    ...
    @company_name.setter
    def company_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def contact_person(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DataResidencyArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[Union[_builtins.str, DataResidencyType]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, DataResidencyType]]]): # -> None:
        ...
...
class FileSourceInfoArgs:
    ...
    @share_id.setter
    def share_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ImageRepositoryCredentialArgs:
    def __init__(__self__, *, image_repository_url: pulumi.Input[_builtins.str], user_name: pulumi.Input[_builtins.str], password: Optional[pulumi.Input[AsymmetricEncryptedSecretArgs]] = ...) -> None:
    ...
    def image_repository_url(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @password.setter
    def password(self, value: Optional[pulumi.Input[AsymmetricEncryptedSecretArgs]]): # -> None:
        ...
...
class IoTDeviceInfoArgs:
    def __init__(__self__, *, device_id: pulumi.Input[_builtins.str], io_t_host_hub: pulumi.Input[_builtins.str], authentication: Optional[pulumi.Input[AuthenticationArgs]] = ..., io_t_host_hub_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def io_t_host_hub(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def io_t_host_hub_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IoTEdgeAgentInfoArgs:
    def __init__(__self__, *, image_name: pulumi.Input[_builtins.str], tag: pulumi.Input[_builtins.str], image_repository: Optional[pulumi.Input[ImageRepositoryCredentialArgs]] = ...) -> None:
    ...
    def image_repository(self, value: Optional[pulumi.Input[ImageRepositoryCredentialArgs]]): # -> None:
        ...
...
class KubernetesRoleComputeArgs:
    ...
    @vm_profile.setter
    def vm_profile(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class KubernetesRoleResourcesArgs:
    def __init__(__self__, *, compute: pulumi.Input[KubernetesRoleComputeArgs], storage: Optional[pulumi.Input[KubernetesRoleStorageArgs]] = ...) -> None:
    ...
    @compute.setter
    def compute(self, value: pulumi.Input[KubernetesRoleComputeArgs]): # -> None:
        ...
    ...
    @storage.setter
    def storage(self, value: Optional[pulumi.Input[KubernetesRoleStorageArgs]]): # -> None:
        ...
...
class KubernetesRoleStorageArgs:
    def __init__(__self__, *, endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[MountPointMapArgs]]]] = ...) -> None:
    ...
    @endpoints.setter
    def endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MountPointMapArgs]]]]): # -> None:
        ...
...
class MetricConfigurationArgs:
    def __init__(__self__, *, counter_sets: pulumi.Input[Sequence[pulumi.Input[MetricCounterSetArgs]]], resource_id: pulumi.Input[_builtins.str], mdm_account: Optional[pulumi.Input[_builtins.str]] = ..., metric_name_space: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @counter_sets.setter
    def counter_sets(self, value: pulumi.Input[Sequence[pulumi.Input[MetricCounterSetArgs]]]): # -> None:
        ...
    ...
    @mdm_account.setter
    def mdm_account(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def metric_name_space(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MetricCounterSetArgs:
    def __init__(__self__, *, counters: pulumi.Input[Sequence[pulumi.Input[MetricCounterArgs]]]) -> None:
    ...
    @counters.setter
    def counters(self, value: pulumi.Input[Sequence[pulumi.Input[MetricCounterArgs]]]): # -> None:
        ...
...
class MetricCounterArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], additional_dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[MetricDimensionArgs]]]] = ..., dimension_filter: Optional[pulumi.Input[Sequence[pulumi.Input[MetricDimensionArgs]]]] = ..., instance: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def additional_dimensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MetricDimensionArgs]]]]): # -> None:
        ...
    ...
    def dimension_filter(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MetricDimensionArgs]]]]): # -> None:
        ...
...
class MetricDimensionArgs:
    def __init__(__self__, *, source_name: pulumi.Input[_builtins.str], source_type: pulumi.Input[_builtins.str]) -> None:
...
class PeriodicTimerSourceInfoArgs:
    def __init__(__self__, *, schedule: pulumi.Input[_builtins.str], start_time: pulumi.Input[_builtins.str], topic: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RefreshDetailsArgs:
    def __init__(__self__, *, error_manifest_file: Optional[pulumi.Input[_builtins.str]] = ..., in_progress_refresh_job_id: Optional[pulumi.Input[_builtins.str]] = ..., last_completed_refresh_job_time_in_utc: Optional[pulumi.Input[_builtins.str]] = ..., last_job: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def error_manifest_file(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def in_progress_refresh_job_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def last_completed_refresh_job_time_in_utc(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @last_job.setter
    def last_job(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResourceIdentityArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[Union[_builtins.str, MsiIdentityType]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, MsiIdentityType]]]): # -> None:
        ...
...
@pulumi.input_type
class SkuArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[Union[_builtins.str, SkuName]]] = ..., tier: Optional[pulumi.Input[Union[_builtins.str, SkuTier]]] = ...) -> None:
...
class SymmetricKeyArgs:
    def __init__(__self__, *, connection_string: Optional[pulumi.Input[AsymmetricEncryptedSecretArgs]] = ...) -> None:
    ...
    def connection_string(self, value: Optional[pulumi.Input[AsymmetricEncryptedSecretArgs]]): # -> None:
        ...
...
class UserAccessRightArgs:
    def __init__(__self__, *, access_type: pulumi.Input[Union[_builtins.str, ShareAccessType]], user_id: pulumi.Input[_builtins.str]) -> None:
    ...
    @access_type.setter
    def access_type(self, value: pulumi.Input[Union[_builtins.str, ShareAccessType]]): # -> None:
        ...
