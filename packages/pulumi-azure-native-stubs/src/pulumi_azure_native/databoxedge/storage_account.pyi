...
class StorageAccountArgs:
    def __init__(__self__, *, data_policy: pulumi.Input[Union[_builtins.str, DataPolicy]], device_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_credential_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_status: Optional[pulumi.Input[Union[_builtins.str, StorageAccountStatus]]] = ...) -> None:
    ...
    @data_policy.setter
    def data_policy(self, value: pulumi.Input[Union[_builtins.str, DataPolicy]]): # -> None:
        ...
    ...
    def storage_account_credential_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def storage_account_status(self, value: Optional[pulumi.Input[Union[_builtins.str, StorageAccountStatus]]]): # -> None:
        ...
...
class StorageAccount(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., data_policy: Optional[pulumi.Input[Union[_builtins.str, DataPolicy]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., device_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_credential_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_status: Optional[pulumi.Input[Union[_builtins.str, StorageAccountStatus]]] = ..., __props__=...) -> None:
    ...
    @_builtins.property
    @pulumi.getter(name="storageAccountCredentialId")
    def storage_account_credential_id(self) -> pulumi.Output[Optional[_builtins.str]]:
