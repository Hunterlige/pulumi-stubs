...
class PeriodicTimerEventTriggerArgs:
    def __init__(
        ...
        *,
        ...
        custom_context_tag: Optional[pulumi.Input[_builtins.str]] = ...,
...
class PeriodicTimerEventTrigger(pulumi.CustomResource):
    ...
    def __init__(
        ...
        sink_info: Optional[
            pulumi.Input[Union[RoleSinkInfoArgs, RoleSinkInfoArgsDict]]
        ] = ...,
        source_info: Optional[
            pulumi.Input[
                Union[PeriodicTimerSourceInfoArgs, PeriodicTimerSourceInfoArgsDict]
            ]
        ] = ...,
        __props__=...,
    ) -> None: ...
