...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ARecordArgs', 'ARecordArgsDict', 'AaaaRecordArgs', 'AaaaRecordArgsDict', 'CnameRecordArgs', 'CnameRecordArgsDict', 'MxRecordArgs', 'MxRecordArgsDict', 'PtrRecordArgs', 'PtrRecordArgsDict', 'SoaRecordArgs', 'SoaRecordArgsDict', 'SrvRecordArgs', 'SrvRecordArgsDict', 'SubResourceArgs', 'SubResourceArgsDict', 'TxtRecordArgs', 'TxtRecordArgsDict']
