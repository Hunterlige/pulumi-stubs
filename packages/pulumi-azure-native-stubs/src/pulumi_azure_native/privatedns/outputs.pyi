...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ARecordResponse', 'AaaaRecordResponse', 'CnameRecordResponse', 'MxRecordResponse', 'PtrRecordResponse', 'SoaRecordResponse', 'SrvRecordResponse', 'SubResourceResponse', 'SystemDataResponse', 'TxtRecordResponse']
@pulumi.output_type
