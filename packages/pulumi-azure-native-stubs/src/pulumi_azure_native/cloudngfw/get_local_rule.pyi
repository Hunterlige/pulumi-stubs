...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetLocalRuleResult', 'AwaitableGetLocalRuleResult', 'get_local_rule', 'get_local_rule_output']
@pulumi.output_type
class GetLocalRuleResult:
    
    def __init__(__self__, action_type=..., applications=..., audit_comment=..., azure_api_version=..., category=..., decryption_rule_type=..., description=..., destination=..., enable_logging=..., etag=..., id=..., inbound_inspection_certificate=..., name=..., negate_destination=..., negate_source=..., priority=..., protocol=..., protocol_port_list=..., provisioning_state=..., rule_name=..., rule_state=..., source=..., system_data=..., tags=..., type=...) -> None:
        ...
...
class AwaitableGetLocalRuleResult(GetLocalRuleResult):
    def __await__(self): # -> Generator[Never, Any, GetLocalRuleResult]:
        ...
    


def get_local_rule(local_rulestack_name: Optional[_builtins.str] = ..., priority: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetLocalRuleResult:
    
    ...

def get_local_rule_output(local_rulestack_name: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetLocalRuleResult]:
