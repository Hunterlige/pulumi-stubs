...
class ListPaloAltoNetworksCloudngfwOperationSupportInfoResult:
    ...
    def __init__(__self__, account_id=..., account_registration_status=..., credits=..., end_date_for_credits=..., free_trial=..., free_trial_credit_left=..., free_trial_days_left=..., help_url=..., hub_url=..., monthly_credit_left=..., product_serial=..., product_sku=..., register_url=..., start_date_for_credits=..., support_url=...) -> None:
        ...
...
class AwaitableListPaloAltoNetworksCloudngfwOperationSupportInfoResult(ListPaloAltoNetworksCloudngfwOperationSupportInfoResult):
    def __await__(self): # -> Generator[Never, Any, ListPaloAltoNetworksCloudngfwOperationSupportInfoResult]:
        ...
    


def list_palo_alto_networks_cloudngfw_operation_support_info(opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableListPaloAltoNetworksCloudngfwOperationSupportInfoResult:
    
    ...

def list_palo_alto_networks_cloudngfw_operation_support_info_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[ListPaloAltoNetworksCloudngfwOperationSupportInfoResult]:
