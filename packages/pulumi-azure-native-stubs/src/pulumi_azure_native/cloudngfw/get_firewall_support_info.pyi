...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetFirewallSupportInfoResult', 'AwaitableGetFirewallSupportInfoResult', 'get_firewall_support_info', 'get_firewall_support_info_output']
@pulumi.output_type
...
class AwaitableGetFirewallSupportInfoResult(GetFirewallSupportInfoResult):
    def __await__(self): # -> Generator[Never, Any, GetFirewallSupportInfoResult]:
        ...
    


def get_firewall_support_info(email: Optional[_builtins.str] = ..., firewall_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetFirewallSupportInfoResult:
    
    ...

def get_firewall_support_info_output(email: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., firewall_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetFirewallSupportInfoResult]:
