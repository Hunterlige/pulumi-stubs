...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetPostRuleResult', 'AwaitableGetPostRuleResult', 'get_post_rule', 'get_post_rule_output']
@pulumi.output_type
...
class AwaitableGetPostRuleResult(GetPostRuleResult):
    def __await__(self): # -> Generator[Never, Any, GetPostRuleResult]:
        ...
    


def get_post_rule(global_rulestack_name: Optional[_builtins.str] = ..., priority: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetPostRuleResult:
    
    ...

def get_post_rule_output(global_rulestack_name: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetPostRuleResult]:
