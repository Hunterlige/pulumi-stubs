...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureResourceManagerManagedIdentityPropertiesArgs', ..., 'AzureResourceManagerUserAssignedIdentityArgs', 'AzureResourceManagerUserAssignedIdentityArgsDict', 'CategoryArgs', 'CategoryArgsDict', 'DNSSettingsArgs', 'DNSSettingsArgsDict', 'DestinationAddrArgs', 'DestinationAddrArgsDict', 'EndpointConfigurationArgs', 'EndpointConfigurationArgsDict', 'FrontendSettingArgs', 'FrontendSettingArgsDict', 'IPAddressSpaceArgs', 'IPAddressSpaceArgsDict', 'IPAddressArgs', 'IPAddressArgsDict', 'MarketplaceDetailsArgs', 'MarketplaceDetailsArgsDict', 'NetworkProfileArgs', 'NetworkProfileArgsDict', 'PanoramaConfigArgs', 'PanoramaConfigArgsDict', 'PlanDataArgs', 'PlanDataArgsDict', 'RulestackDetailsArgs', 'RulestackDetailsArgsDict', 'SecurityServicesArgs', 'SecurityServicesArgsDict', 'SourceAddrArgs', 'SourceAddrArgsDict', 'StrataCloudManagerConfigArgs', 'StrataCloudManagerConfigArgsDict', 'TagInfoArgs', 'TagInfoArgsDict', 'VnetConfigurationArgs', 'VnetConfigurationArgsDict', 'VwanConfigurationArgs', 'VwanConfigurationArgsDict']
...
class AzureResourceManagerManagedIdentityPropertiesArgs:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, ManagedIdentityType]], user_assigned_identities: Optional[pulumi.Input[Mapping[str, pulumi.Input[AzureResourceManagerUserAssignedIdentityArgs]]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ManagedIdentityType]]): # -> None:
        ...
    ...
    def user_assigned_identities(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[AzureResourceManagerUserAssignedIdentityArgs]]]]): # -> None:
        ...
...
@pulumi.input_type
class CategoryArgs:
    def __init__(__self__, *, feeds: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], url_custom: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @feeds.setter
    def feeds(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @url_custom.setter
    def url_custom(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class DNSSettingsArgs:
    def __init__(__self__, *, dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[IPAddressArgs]]]] = ..., enable_dns_proxy: Optional[pulumi.Input[Union[_builtins.str, DNSProxy]]] = ..., enabled_dns_type: Optional[pulumi.Input[Union[_builtins.str, EnabledDNSType]]] = ...) -> None:
    ...
    @dns_servers.setter
    def dns_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IPAddressArgs]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="enableDnsProxy")
    def enable_dns_proxy(self) -> Optional[pulumi.Input[Union[_builtins.str, DNSProxy]]]:
        
        ...
    
    @enable_dns_proxy.setter
    def enable_dns_proxy(self, value: Optional[pulumi.Input[Union[_builtins.str, DNSProxy]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="enabledDnsType")
    def enabled_dns_type(self) -> Optional[pulumi.Input[Union[_builtins.str, EnabledDNSType]]]:
        
        ...
    
    @enabled_dns_type.setter
    def enabled_dns_type(self, value: Optional[pulumi.Input[Union[_builtins.str, EnabledDNSType]]]): # -> None:
        ...
...
class DestinationAddrArgs:
    def __init__(__self__, *, cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., countries: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., feeds: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., fqdn_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., prefix_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @countries.setter
    def countries(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @feeds.setter
    def feeds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @fqdn_lists.setter
    def fqdn_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @prefix_lists.setter
    def prefix_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EndpointConfigurationArgs:
    def __init__(__self__, *, address: pulumi.Input[IPAddressArgs], port: pulumi.Input[_builtins.str]) -> None:
    ...
    @address.setter
    def address(self, value: pulumi.Input[IPAddressArgs]): # -> None:
        ...
...
class FrontendSettingArgs:
    def __init__(__self__, *, backend_configuration: pulumi.Input[EndpointConfigurationArgs], frontend_configuration: pulumi.Input[EndpointConfigurationArgs], name: pulumi.Input[_builtins.str], protocol: pulumi.Input[Union[_builtins.str, ProtocolType]]) -> None:
    ...
    def backend_configuration(self, value: pulumi.Input[EndpointConfigurationArgs]): # -> None:
        ...
    ...
    def frontend_configuration(self, value: pulumi.Input[EndpointConfigurationArgs]): # -> None:
        ...
    ...
    @protocol.setter
    def protocol(self, value: pulumi.Input[Union[_builtins.str, ProtocolType]]): # -> None:
        ...
...
class IPAddressSpaceArgs:
    def __init__(__self__, *, address_space: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class IPAddressArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MarketplaceDetailsArgs:
    def __init__(__self__, *, offer_id: pulumi.Input[_builtins.str], publisher_id: pulumi.Input[_builtins.str], marketplace_subscription_status: Optional[pulumi.Input[Union[_builtins.str, MarketplaceSubscriptionStatus]]] = ...) -> None:
    ...
    @offer_id.setter
    def offer_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def marketplace_subscription_status(self) -> Optional[pulumi.Input[Union[_builtins.str, MarketplaceSubscriptionStatus]]]:
        
        ...
    
    @marketplace_subscription_status.setter
    def marketplace_subscription_status(self, value: Optional[pulumi.Input[Union[_builtins.str, MarketplaceSubscriptionStatus]]]): # -> None:
        ...
...
class NetworkProfileArgs:
    def __init__(__self__, *, enable_egress_nat: pulumi.Input[Union[_builtins.str, EgressNat]], network_type: pulumi.Input[Union[_builtins.str, NetworkType]], public_ips: pulumi.Input[Sequence[pulumi.Input[IPAddressArgs]]], egress_nat_ip: Optional[pulumi.Input[Sequence[pulumi.Input[IPAddressArgs]]]] = ..., private_source_nat_rules_destination: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., trusted_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., vnet_configuration: Optional[pulumi.Input[VnetConfigurationArgs]] = ..., vwan_configuration: Optional[pulumi.Input[VwanConfigurationArgs]] = ...) -> None:
    ...
    def enable_egress_nat(self, value: pulumi.Input[Union[_builtins.str, EgressNat]]): # -> None:
        ...
    ...
    @network_type.setter
    def network_type(self, value: pulumi.Input[Union[_builtins.str, NetworkType]]): # -> None:
        ...
    ...
    @public_ips.setter
    def public_ips(self, value: pulumi.Input[Sequence[pulumi.Input[IPAddressArgs]]]): # -> None:
        ...
    ...
    def egress_nat_ip(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IPAddressArgs]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="privateSourceNatRulesDestination")
    def private_source_nat_rules_destination(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @private_source_nat_rules_destination.setter
    def private_source_nat_rules_destination(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="trustedRanges")
    def trusted_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @trusted_ranges.setter
    def trusted_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def vnet_configuration(self, value: Optional[pulumi.Input[VnetConfigurationArgs]]): # -> None:
        ...
    ...
    def vwan_configuration(self, value: Optional[pulumi.Input[VwanConfigurationArgs]]): # -> None:
        ...
...
class PanoramaConfigArgs:
    ...
    def config_string(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
@pulumi.input_type
class PlanDataArgs:
    def __init__(__self__, *, billing_cycle: pulumi.Input[Union[_builtins.str, BillingCycle]], plan_id: pulumi.Input[_builtins.str], usage_type: Optional[pulumi.Input[Union[_builtins.str, UsageType]]] = ...) -> None:
    ...
    def billing_cycle(self, value: pulumi.Input[Union[_builtins.str, BillingCycle]]): # -> None:
        ...
    ...
    @usage_type.setter
    def usage_type(self, value: Optional[pulumi.Input[Union[_builtins.str, UsageType]]]): # -> None:
        ...
...
class RulestackDetailsArgs:
    def __init__(__self__, *, location: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ..., rulestack_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @rulestack_id.setter
    def rulestack_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SecurityServicesArgs:
    def __init__(__self__, *, anti_spyware_profile: Optional[pulumi.Input[_builtins.str]] = ..., anti_virus_profile: Optional[pulumi.Input[_builtins.str]] = ..., dns_subscription: Optional[pulumi.Input[_builtins.str]] = ..., file_blocking_profile: Optional[pulumi.Input[_builtins.str]] = ..., outbound_trust_certificate: Optional[pulumi.Input[_builtins.str]] = ..., outbound_un_trust_certificate: Optional[pulumi.Input[_builtins.str]] = ..., url_filtering_profile: Optional[pulumi.Input[_builtins.str]] = ..., vulnerability_profile: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def anti_spyware_profile(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def anti_virus_profile(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def dns_subscription(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def file_blocking_profile(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def outbound_trust_certificate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="outboundUnTrustCertificate")
    def outbound_un_trust_certificate(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @outbound_un_trust_certificate.setter
    def outbound_un_trust_certificate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def url_filtering_profile(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def vulnerability_profile(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SourceAddrArgs:
    def __init__(__self__, *, cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., countries: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., feeds: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., prefix_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class StrataCloudManagerConfigArgs:
    def __init__(__self__, *, cloud_manager_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def cloud_manager_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class VnetConfigurationArgs:
    def __init__(__self__, *, trust_subnet: pulumi.Input[IPAddressSpaceArgs], un_trust_subnet: pulumi.Input[IPAddressSpaceArgs], vnet: pulumi.Input[IPAddressSpaceArgs], ip_of_trust_subnet_for_udr: Optional[pulumi.Input[IPAddressArgs]] = ...) -> None:
    ...
    @trust_subnet.setter
    def trust_subnet(self, value: pulumi.Input[IPAddressSpaceArgs]): # -> None:
        ...
    ...
    def un_trust_subnet(self, value: pulumi.Input[IPAddressSpaceArgs]): # -> None:
        ...
    ...
    @vnet.setter
    def vnet(self, value: pulumi.Input[IPAddressSpaceArgs]): # -> None:
        ...
    ...
    def ip_of_trust_subnet_for_udr(self, value: Optional[pulumi.Input[IPAddressArgs]]): # -> None:
        ...
...
class VwanConfigurationArgs:
    def __init__(__self__, *, v_hub: pulumi.Input[IPAddressSpaceArgs], ip_of_trust_subnet_for_udr: Optional[pulumi.Input[IPAddressArgs]] = ..., network_virtual_appliance_id: Optional[pulumi.Input[_builtins.str]] = ..., trust_subnet: Optional[pulumi.Input[IPAddressSpaceArgs]] = ..., un_trust_subnet: Optional[pulumi.Input[IPAddressSpaceArgs]] = ...) -> None:
    ...
    @v_hub.setter
    def v_hub(self, value: pulumi.Input[IPAddressSpaceArgs]): # -> None:
        ...
    ...
    def network_virtual_appliance_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @trust_subnet.setter
    def trust_subnet(self, value: Optional[pulumi.Input[IPAddressSpaceArgs]]): # -> None:
        ...
    ...
    @un_trust_subnet.setter
    def un_trust_subnet(self, value: Optional[pulumi.Input[IPAddressSpaceArgs]]): # -> None:
        ...
