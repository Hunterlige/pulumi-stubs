...
class AwaitableGetCertificateObjectGlobalRulestackResult(
    GetCertificateObjectGlobalRulestackResult
):
    def __await__(self): ...

def get_certificate_object_global_rulestack(
    global_rulestack_name: Optional[_builtins.str] = ...,
    name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetCertificateObjectGlobalRulestackResult: ...
def get_certificate_object_global_rulestack_output(
    global_rulestack_name: Optional[pulumi.Input[_builtins.str]] = ...,
    name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetCertificateObjectGlobalRulestackResult]: ...
