...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetPreRuleResult', 'AwaitableGetPreRuleResult', 'get_pre_rule', 'get_pre_rule_output']
@pulumi.output_type
...
class AwaitableGetPreRuleResult(GetPreRuleResult):
    def __await__(self): # -> Generator[Never, Any, GetPreRuleResult]:
        ...
    


def get_pre_rule(global_rulestack_name: Optional[_builtins.str] = ..., priority: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetPreRuleResult:
    
    ...

def get_pre_rule_output(global_rulestack_name: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetPreRuleResult]:
