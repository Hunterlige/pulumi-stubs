...
class PostRuleArgs:
    ...
    def global_rulestack_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PostRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., action_type: Optional[pulumi.Input[Union[_builtins.str, ActionEnum]]] = ..., applications: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., audit_comment: Optional[pulumi.Input[_builtins.str]] = ..., category: Optional[pulumi.Input[Union[CategoryArgs, CategoryArgsDict]]] = ..., decryption_rule_type: Optional[pulumi.Input[Union[_builtins.str, DecryptionRuleTypeEnum]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination: Optional[pulumi.Input[Union[DestinationAddrArgs, DestinationAddrArgsDict]]] = ..., enable_logging: Optional[pulumi.Input[Union[_builtins.str, StateEnum]]] = ..., global_rulestack_name: Optional[pulumi.Input[_builtins.str]] = ..., inbound_inspection_certificate: Optional[pulumi.Input[_builtins.str]] = ..., negate_destination: Optional[pulumi.Input[Union[_builtins.str, BooleanEnum]]] = ..., negate_source: Optional[pulumi.Input[Union[_builtins.str, BooleanEnum]]] = ..., priority: Optional[pulumi.Input[_builtins.str]] = ..., protocol: Optional[pulumi.Input[_builtins.str]] = ..., protocol_port_list: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., rule_name: Optional[pulumi.Input[_builtins.str]] = ..., rule_state: Optional[pulumi.Input[Union[_builtins.str, StateEnum]]] = ..., source: Optional[pulumi.Input[Union[SourceAddrArgs, SourceAddrArgsDict]]] = ..., tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union[TagInfoArgs, TagInfoArgsDict]]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: PostRuleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> PostRule:
