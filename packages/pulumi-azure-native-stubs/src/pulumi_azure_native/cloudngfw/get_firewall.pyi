...
class GetFirewallResult:
    ...
    def __init__(__self__, associated_rulestack=..., azure_api_version=..., dns_settings=..., front_end_settings=..., id=..., identity=..., is_panorama_managed=..., is_strata_cloud_managed=..., location=..., marketplace_details=..., name=..., network_profile=..., pan_etag=..., panorama_config=..., plan_data=..., provisioning_state=..., strata_cloud_manager_config=..., system_data=..., tags=..., type=...) -> None:
        ...
...
def get_firewall(firewall_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetFirewallResult:
    
    ...

def get_firewall_output(firewall_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetFirewallResult]:
