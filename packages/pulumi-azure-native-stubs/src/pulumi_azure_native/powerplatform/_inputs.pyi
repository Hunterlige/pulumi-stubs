...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EnterprisePolicyIdentityArgs', 'EnterprisePolicyIdentityArgsDict', 'KeyPropertiesArgs', 'KeyPropertiesArgsDict', 'KeyVaultPropertiesArgs', 'KeyVaultPropertiesArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'PropertiesEncryptionArgs', 'PropertiesEncryptionArgsDict', 'PropertiesLockboxArgs', 'PropertiesLockboxArgsDict', 'PropertiesNetworkInjectionArgs', 'PropertiesNetworkInjectionArgsDict', 'SubnetPropertiesArgs', 'SubnetPropertiesArgsDict', 'VirtualNetworkPropertiesArgs', 'VirtualNetworkPropertiesArgsDict']
...
class KeyVaultPropertiesArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., key: Optional[pulumi.Input[KeyPropertiesArgs]] = ...) -> None:
    ...
    @key.setter
    def key(self, value: Optional[pulumi.Input[KeyPropertiesArgs]]): # -> None:
        ...
...
class PropertiesEncryptionArgs:
    def __init__(__self__, *, key_vault: Optional[pulumi.Input[KeyVaultPropertiesArgs]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, State]]] = ...) -> None:
    ...
    @key_vault.setter
    def key_vault(self, value: Optional[pulumi.Input[KeyVaultPropertiesArgs]]): # -> None:
        ...
...
class PropertiesLockboxArgs:
    def __init__(__self__, *, state: Optional[pulumi.Input[Union[_builtins.str, State]]] = ...) -> None:
...
class PropertiesNetworkInjectionArgs:
    def __init__(__self__, *, virtual_networks: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualNetworkPropertiesArgs]]]] = ...) -> None:
    ...
    def virtual_networks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualNetworkPropertiesArgs]]]]): # -> None:
        ...
...
class VirtualNetworkPropertiesArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., subnet: Optional[pulumi.Input[SubnetPropertiesArgs]] = ...) -> None:
    ...
    @subnet.setter
    def subnet(self, value: Optional[pulumi.Input[SubnetPropertiesArgs]]): # -> None:
        ...
