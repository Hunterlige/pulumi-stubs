...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EnterprisePolicyIdentityResponse', 'KeyPropertiesResponse', 'KeyVaultPropertiesResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'PropertiesResponseEncryption', 'PropertiesResponseLockbox', 'PropertiesResponseNetworkInjection', 'SubnetPropertiesResponse', 'SystemDataResponse', 'VirtualNetworkPropertiesResponse']
@pulumi.output_type
class EnterprisePolicyIdentityResponse(dict):
    ...
    def __init__(__self__, *, system_assigned_identity_principal_id: _builtins.str, tenant_id: _builtins.str, type: Optional[_builtins.str] = ...) -> None:
...
class KeyVaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., key: Optional[outputs.KeyPropertiesResponse] = ...) -> None:
...
class PropertiesResponseEncryption(dict):
    ...
    def __init__(__self__, *, key_vault: Optional[outputs.KeyVaultPropertiesResponse] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class PropertiesResponseNetworkInjection(dict):
    ...
    def __init__(__self__, *, virtual_networks: Optional[Sequence[outputs.VirtualNetworkPropertiesResponse]] = ...) -> None:
...
class VirtualNetworkPropertiesResponse(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., subnet: Optional[outputs.SubnetPropertiesResponse] = ...) -> None:
