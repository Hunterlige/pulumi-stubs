...
@pulumi.input_type
class ScheduleArgs:
    def __init__(__self__, *, lab_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], stop_at: pulumi.Input[_builtins.str], time_zone_id: pulumi.Input[_builtins.str], notes: Optional[pulumi.Input[_builtins.str]] = ..., recurrence_pattern: Optional[pulumi.Input[RecurrencePatternArgs]] = ..., schedule_name: Optional[pulumi.Input[_builtins.str]] = ..., start_at: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @stop_at.setter
    def stop_at(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def recurrence_pattern(self, value: Optional[pulumi.Input[RecurrencePatternArgs]]): # -> None:
        ...
...
class Schedule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., lab_name: Optional[pulumi.Input[_builtins.str]] = ..., notes: Optional[pulumi.Input[_builtins.str]] = ..., recurrence_pattern: Optional[pulumi.Input[Union[RecurrencePatternArgs, RecurrencePatternArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., schedule_name: Optional[pulumi.Input[_builtins.str]] = ..., start_at: Optional[pulumi.Input[_builtins.str]] = ..., stop_at: Optional[pulumi.Input[_builtins.str]] = ..., time_zone_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
