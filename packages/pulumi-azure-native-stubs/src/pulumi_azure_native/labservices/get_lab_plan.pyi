...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetLabPlanResult', 'AwaitableGetLabPlanResult', 'get_lab_plan', 'get_lab_plan_output']
@pulumi.output_type
class GetLabPlanResult:
    
    def __init__(__self__, allowed_regions=..., azure_api_version=..., default_auto_shutdown_profile=..., default_connection_profile=..., default_network_profile=..., id=..., identity=..., linked_lms_instance=..., location=..., name=..., provisioning_state=..., resource_operation_error=..., shared_gallery_id=..., support_info=..., system_data=..., tags=..., type=...) -> None:
        ...
...
class AwaitableGetLabPlanResult(GetLabPlanResult):
    def __await__(self): # -> Generator[Never, Any, GetLabPlanResult]:
        ...
    


def get_lab_plan(lab_plan_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetLabPlanResult:
    
    ...

def get_lab_plan_output(lab_plan_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetLabPlanResult]:
