...
class AlertProcessingRuleByNameArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[AlertProcessingRulePropertiesArgs]] = ...,
    ...
    def alert_processing_rule_name(
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[AlertProcessingRulePropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[AlertProcessingRulePropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class AlertProcessingRuleByName(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.AlertProcessingRulePropertiesResponse]: ...
    @_builtins.property
