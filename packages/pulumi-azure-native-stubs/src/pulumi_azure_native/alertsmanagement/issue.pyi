...
@pulumi.input_type
class IssueArgs:
    def __init__(__self__, *, resource_uri: pulumi.Input[_builtins.str], issue_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[IssuePropertiesArgs]] = ...) -> None:
...
class Issue(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., issue_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[IssuePropertiesArgs, IssuePropertiesArgsDict]]] = ..., resource_uri: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
