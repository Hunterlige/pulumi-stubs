...
class AwaitableGetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult(GetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult):
    def __await__(self): # -> Generator[Never, Any, GetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult]:
        ...
    


def get_database_migrations_mongo_to_cosmos_dbv_core_mongo(migration_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., target_resource_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult:
    
    ...

def get_database_migrations_mongo_to_cosmos_dbv_core_mongo_output(migration_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_resource_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult]:
