...
class AwaitableGetDatabaseMigrationsMongoToCosmosDbRUMongoResult(
    GetDatabaseMigrationsMongoToCosmosDbRUMongoResult
):
    def __await__(self): ...

def get_database_migrations_mongo_to_cosmos_db_ru_mongo(
...
def get_database_migrations_mongo_to_cosmos_db_ru_mongo_output(
...
) -> pulumi.Output[GetDatabaseMigrationsMongoToCosmosDbRUMongoResult]: ...
