...
class LinkedSubscriptionArgs:
    def __init__(__self__, *, linked_subscription_id: pulumi.Input[_builtins.str], registration_resource_id: pulumi.Input[_builtins.str], resource_group: pulumi.Input[_builtins.str], linked_subscription_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[Union[_builtins.str, Location]]] = ...) -> None:
    ...
    def linked_subscription_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def registration_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def linked_subscription_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @location.setter
    def location(self, value: Optional[pulumi.Input[Union[_builtins.str, Location]]]): # -> None:
        ...
...
class LinkedSubscription(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., linked_subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., linked_subscription_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[Union[_builtins.str, Location]]] = ..., registration_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: LinkedSubscriptionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> LinkedSubscription:
