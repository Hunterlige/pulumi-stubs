...
class RegistrationArgs:
    def __init__(__self__, *, registration_token: pulumi.Input[_builtins.str], resource_group: pulumi.Input[_builtins.str], location: Optional[pulumi.Input[Union[_builtins.str, Location]]] = ..., registration_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def registration_token(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def registration_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Registration(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., location: Optional[pulumi.Input[Union[_builtins.str, Location]]] = ..., registration_name: Optional[pulumi.Input[_builtins.str]] = ..., registration_token: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Registration:
