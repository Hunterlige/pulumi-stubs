...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CompatibilityResponse', 'DataDiskImageResponse', 'IconUrisResponse', 'OsDiskImageResponse', 'ProductLinkResponse', 'ProductPropertiesResponse', 'ProductResponse', 'SystemDataResponse']
@pulumi.output_type
class CompatibilityResponse(dict):
    
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., is_compatible: Optional[_builtins.bool] = ..., issues: Optional[Sequence[_builtins.str]] = ..., message: Optional[_builtins.str] = ...) -> None:
...
class DataDiskImageResponse(dict):
    ...
    def __init__(__self__, *, lun: _builtins.int, source_blob_sas_uri: _builtins.str) -> None:
...
class IconUrisResponse(dict):
    ...
    def __init__(__self__, *, hero: Optional[_builtins.str] = ..., large: Optional[_builtins.str] = ..., medium: Optional[_builtins.str] = ..., small: Optional[_builtins.str] = ..., wide: Optional[_builtins.str] = ...) -> None:
...
class OsDiskImageResponse(dict):
    ...
    def __init__(__self__, *, operating_system: _builtins.str, source_blob_sas_uri: _builtins.str) -> None:
...
class ProductLinkResponse(dict):
    ...
    def __init__(__self__, *, display_name: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class ProductResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, type: _builtins.str, billing_part_number: Optional[_builtins.str] = ..., compatibility: Optional[outputs.CompatibilityResponse] = ..., description: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., etag: Optional[_builtins.str] = ..., gallery_item_identity: Optional[_builtins.str] = ..., icon_uris: Optional[outputs.IconUrisResponse] = ..., legal_terms: Optional[_builtins.str] = ..., links: Optional[Sequence[outputs.ProductLinkResponse]] = ..., offer: Optional[_builtins.str] = ..., offer_version: Optional[_builtins.str] = ..., payload_length: Optional[_builtins.float] = ..., privacy_policy: Optional[_builtins.str] = ..., product_kind: Optional[_builtins.str] = ..., product_properties: Optional[outputs.ProductPropertiesResponse] = ..., publisher_display_name: Optional[_builtins.str] = ..., publisher_identifier: Optional[_builtins.str] = ..., sku: Optional[_builtins.str] = ..., vm_extension_type: Optional[_builtins.str] = ...) -> None:
