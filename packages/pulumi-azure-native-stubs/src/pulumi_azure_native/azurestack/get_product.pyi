...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetProductResult', 'AwaitableGetProductResult', 'get_product', 'get_product_output']
@pulumi.output_type
class GetProductResult:
    
    def __init__(__self__, billing_part_number=..., compatibility=..., description=..., display_name=..., etag=..., gallery_item_identity=..., icon_uris=..., id=..., legal_terms=..., links=..., name=..., offer=..., offer_version=..., payload_length=..., privacy_policy=..., product_kind=..., product_properties=..., publisher_display_name=..., publisher_identifier=..., sku=..., type=..., vm_extension_type=...) -> None:
        ...
...
class AwaitableGetProductResult(GetProductResult):
    def __await__(self): # -> Generator[Never, Any, GetProductResult]:
        ...
    


def get_product(product_name: Optional[_builtins.str] = ..., registration_name: Optional[_builtins.str] = ..., resource_group: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetProductResult:
    
    ...

def get_product_output(product_name: Optional[pulumi.Input[_builtins.str]] = ..., registration_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetProductResult]:
