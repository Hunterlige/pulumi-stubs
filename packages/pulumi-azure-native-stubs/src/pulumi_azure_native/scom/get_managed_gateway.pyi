...
def get_managed_gateway(
    instance_name: Optional[_builtins.str] = ...,
    managed_gateway_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetManagedGatewayResult: ...
def get_managed_gateway_output(
    instance_name: Optional[pulumi.Input[_builtins.str]] = ...,
    managed_gateway_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetManagedGatewayResult]: ...
