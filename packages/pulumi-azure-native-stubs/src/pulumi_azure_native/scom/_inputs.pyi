...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureHybridBenefitPropertiesArgs', 'AzureHybridBenefitPropertiesArgsDict', 'DatabaseInstancePropertiesArgs', 'DatabaseInstancePropertiesArgsDict', 'DomainControllerPropertiesArgs', 'DomainControllerPropertiesArgsDict', 'DomainUserCredentialsArgs', 'DomainUserCredentialsArgsDict', 'GmsaDetailsArgs', 'GmsaDetailsArgsDict', 'ManagedIdentityArgs', 'ManagedIdentityArgsDict', 'MonitoringInstancePropertiesArgs', 'MonitoringInstancePropertiesArgsDict']
...
class AzureHybridBenefitPropertiesArgs:
    def __init__(__self__, *, scom_license_type: Optional[pulumi.Input[Union[_builtins.str, HybridLicenseType]]] = ..., sql_server_license_type: Optional[pulumi.Input[Union[_builtins.str, HybridLicenseType]]] = ..., windows_server_license_type: Optional[pulumi.Input[Union[_builtins.str, HybridLicenseType]]] = ...) -> None:
    ...
    def scom_license_type(self, value: Optional[pulumi.Input[Union[_builtins.str, HybridLicenseType]]]): # -> None:
        ...
    ...
    def sql_server_license_type(self, value: Optional[pulumi.Input[Union[_builtins.str, HybridLicenseType]]]): # -> None:
        ...
    ...
    def windows_server_license_type(self, value: Optional[pulumi.Input[Union[_builtins.str, HybridLicenseType]]]): # -> None:
        ...
...
class DatabaseInstancePropertiesArgs:
    def __init__(__self__, *, database_instance_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def database_instance_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DomainControllerPropertiesArgs:
    def __init__(__self__, *, dns_server: Optional[pulumi.Input[_builtins.str]] = ..., domain_name: Optional[pulumi.Input[_builtins.str]] = ..., ou_path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DomainUserCredentialsArgs:
    def __init__(__self__, *, key_vault_url: Optional[pulumi.Input[_builtins.str]] = ..., password_secret: Optional[pulumi.Input[_builtins.str]] = ..., user_name_secret: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def user_name_secret(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GmsaDetailsArgs:
    def __init__(__self__, *, dns_name: Optional[pulumi.Input[_builtins.str]] = ..., gmsa_account: Optional[pulumi.Input[_builtins.str]] = ..., load_balancer_ip: Optional[pulumi.Input[_builtins.str]] = ..., management_server_group_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @gmsa_account.setter
    def gmsa_account(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def load_balancer_ip(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def management_server_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MonitoringInstancePropertiesArgs:
    def __init__(__self__, *, azure_hybrid_benefit: Optional[pulumi.Input[AzureHybridBenefitPropertiesArgs]] = ..., database_instance: Optional[pulumi.Input[DatabaseInstancePropertiesArgs]] = ..., domain_controller: Optional[pulumi.Input[DomainControllerPropertiesArgs]] = ..., domain_user_credentials: Optional[pulumi.Input[DomainUserCredentialsArgs]] = ..., gmsa_details: Optional[pulumi.Input[GmsaDetailsArgs]] = ..., v_net_subnet_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def azure_hybrid_benefit(self, value: Optional[pulumi.Input[AzureHybridBenefitPropertiesArgs]]): # -> None:
        ...
    ...
    def database_instance(self, value: Optional[pulumi.Input[DatabaseInstancePropertiesArgs]]): # -> None:
        ...
    ...
    def domain_controller(self, value: Optional[pulumi.Input[DomainControllerPropertiesArgs]]): # -> None:
        ...
    ...
    def domain_user_credentials(self, value: Optional[pulumi.Input[DomainUserCredentialsArgs]]): # -> None:
        ...
    ...
    @gmsa_details.setter
    def gmsa_details(self, value: Optional[pulumi.Input[GmsaDetailsArgs]]): # -> None:
        ...
    ...
    def v_net_subnet_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
