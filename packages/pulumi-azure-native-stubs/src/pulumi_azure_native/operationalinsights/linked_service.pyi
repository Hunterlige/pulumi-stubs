...
class LinkedServiceArgs:
    def __init__(
        ...
        *,
        ...
        provisioning_state: Optional[
            pulumi.Input[Union[_builtins.str, LinkedServiceEntityStatus]]
        ] = ...,
        resource_id: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        write_access_resource_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def provisioning_state(
        self,
    ) -> Optional[pulumi.Input[Union[_builtins.str, LinkedServiceEntityStatus]]]: ...
    @provisioning_state.setter
    def provisioning_state(
        self,
        value: Optional[pulumi.Input[Union[_builtins.str, LinkedServiceEntityStatus]]],
    ): ...
    @_builtins.property
