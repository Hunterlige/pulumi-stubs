...
class GetWorkspaceResult:
    ...
    def __init__(__self__, azure_api_version=..., created_date=..., customer_id=..., default_data_collection_rule_resource_id=..., etag=..., features=..., force_cmk_for_query=..., id=..., identity=..., location=..., modified_date=..., name=..., private_link_scoped_resources=..., provisioning_state=..., public_network_access_for_ingestion=..., public_network_access_for_query=..., retention_in_days=..., sku=..., system_data=..., tags=..., type=..., workspace_capping=...) -> None:
        ...
