...
@pulumi.input_type
class TableArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], workspace_name: pulumi.Input[_builtins.str], plan: Optional[pulumi.Input[Union[_builtins.str, TablePlanEnum]]] = ..., restored_logs: Optional[pulumi.Input[RestoredLogsArgs]] = ..., retention_in_days: Optional[pulumi.Input[_builtins.int]] = ..., schema: Optional[pulumi.Input[SchemaArgs]] = ..., search_results: Optional[pulumi.Input[SearchResultsArgs]] = ..., table_name: Optional[pulumi.Input[_builtins.str]] = ..., total_retention_in_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @plan.setter
    def plan(self, value: Optional[pulumi.Input[Union[_builtins.str, TablePlanEnum]]]): # -> None:
        ...
    ...
    def restored_logs(self, value: Optional[pulumi.Input[RestoredLogsArgs]]): # -> None:
        ...
    ...
    def search_results(self, value: Optional[pulumi.Input[SearchResultsArgs]]): # -> None:
        ...
    ...
    def total_retention_in_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class Table(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., plan: Optional[pulumi.Input[Union[_builtins.str, TablePlanEnum]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., restored_logs: Optional[pulumi.Input[Union[RestoredLogsArgs, RestoredLogsArgsDict]]] = ..., retention_in_days: Optional[pulumi.Input[_builtins.int]] = ..., schema: Optional[pulumi.Input[Union[SchemaArgs, SchemaArgsDict]]] = ..., search_results: Optional[pulumi.Input[Union[SearchResultsArgs, SearchResultsArgsDict]]] = ..., table_name: Optional[pulumi.Input[_builtins.str]] = ..., total_retention_in_days: Optional[pulumi.Input[_builtins.int]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Table:
