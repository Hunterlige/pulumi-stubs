...
class DevOpsConfigurationArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[DevOpsConfigurationPropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[DevOpsConfigurationPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[DevOpsConfigurationPropertiesArgs]]
    ): ...
...
class DevOpsConfiguration(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.DevOpsConfigurationPropertiesResponse]: ...
    @_builtins.property
