...
class SecurityConnectorApplicationArgs:
    def __init__(
        ...
        *,
        ...
        source_resource_type: pulumi.Input[
            Union[_builtins.str, ApplicationSourceResourceType]
        ],
    ...
    def source_resource_type(
        self,
    ) -> pulumi.Input[Union[_builtins.str, ApplicationSourceResourceType]]: ...
    @source_resource_type.setter
    def source_resource_type(
        self, value: pulumi.Input[Union[_builtins.str, ApplicationSourceResourceType]]
    ): ...
    @_builtins.property
