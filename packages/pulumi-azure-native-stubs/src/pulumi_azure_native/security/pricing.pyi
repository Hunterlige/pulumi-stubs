...
@pulumi.input_type
class PricingArgs:
    def __init__(__self__, *, pricing_tier: pulumi.Input[Union[_builtins.str, PricingTier]], scope_id: pulumi.Input[_builtins.str], enforce: Optional[pulumi.Input[Union[_builtins.str, Enforce]]] = ..., extensions: Optional[pulumi.Input[Sequence[pulumi.Input[ExtensionArgs]]]] = ..., pricing_name: Optional[pulumi.Input[_builtins.str]] = ..., sub_plan: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @enforce.setter
    def enforce(self, value: Optional[pulumi.Input[Union[_builtins.str, Enforce]]]): # -> None:
        ...
    ...
    @pricing_name.setter
    def pricing_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @sub_plan.setter
    def sub_plan(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Pricing(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., enforce: Optional[pulumi.Input[Union[_builtins.str, Enforce]]] = ..., extensions: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ExtensionArgs, ExtensionArgsDict]]]]] = ..., pricing_name: Optional[pulumi.Input[_builtins.str]] = ..., pricing_tier: Optional[pulumi.Input[Union[_builtins.str, PricingTier]]] = ..., scope_id: Optional[pulumi.Input[_builtins.str]] = ..., sub_plan: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: PricingArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Pricing:
