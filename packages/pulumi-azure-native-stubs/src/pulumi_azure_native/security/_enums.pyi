...
__all__ = ['ActionType', 'AdditionalWorkspaceDataType', 'AdditionalWorkspaceType', 'ApplicationSourceResourceType', 'AssessmentStatusCode', 'AssessmentType', 'AttestationComplianceState', 'AuthenticationType', 'AutoDiscovery', 'Categories', 'CloudName', 'DataSource', 'DevOpsProvisioningState', 'Effect', 'Enforce', 'EnvironmentType', 'EventSource', 'ExemptionCategory', 'ExportData', 'GovernanceRuleOwnerSourceType', 'GovernanceRuleSourceResourceType', 'GovernanceRuleType', 'ImplementationEffort', 'IsEnabled', 'MinimalRiskLevel', 'MinimalSeverity', 'OfferingType', 'Operator', 'OrganizationMembershipType', 'PricingTier', 'PrivateEndpointServiceConnectionStatus', 'PropertyType', 'Protocol', 'RecommendationConfigStatus', 'RecommendationSupportedClouds', 'RecommendationType', 'RuleState', 'ScanningMode', 'SecurityContactRole', 'SecurityIssue', 'SecuritySolutionStatus', ..., 'ServerVulnerabilityAssessmentsSettingKind', 'Severity', 'SeverityEnum', 'Source', 'SourceType', 'StandardSupportedCloud', 'StandardSupportedClouds', 'State', 'Status', 'StatusReason', 'SubPlan', 'Tactics', 'Techniques', 'Threats', 'Type', 'UnmaskedIpLoggingStatus', 'UserImpact']
