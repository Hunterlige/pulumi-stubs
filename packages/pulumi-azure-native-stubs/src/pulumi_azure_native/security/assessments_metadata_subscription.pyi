...
class AssessmentsMetadataSubscription(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., assessment_metadata_name: Optional[pulumi.Input[_builtins.str]] = ..., assessment_type: Optional[pulumi.Input[Union[_builtins.str, AssessmentType]]] = ..., categories: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Categories]]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., implementation_effort: Optional[pulumi.Input[Union[_builtins.str, ImplementationEffort]]] = ..., preview: Optional[pulumi.Input[_builtins.bool]] = ..., remediation_description: Optional[pulumi.Input[_builtins.str]] = ..., severity: Optional[pulumi.Input[Union[_builtins.str, Severity]]] = ..., threats: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Threats]]]]] = ..., user_impact: Optional[pulumi.Input[Union[_builtins.str, UserImpact]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: AssessmentsMetadataSubscriptionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> AssessmentsMetadataSubscription:
