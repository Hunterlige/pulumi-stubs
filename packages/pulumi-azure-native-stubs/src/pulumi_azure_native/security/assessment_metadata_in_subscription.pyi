...
class AssessmentMetadataInSubscriptionArgs:
    def __init__(__self__, *, assessment_type: pulumi.Input[Union[_builtins.str, AssessmentType]], display_name: pulumi.Input[_builtins.str], severity: pulumi.Input[Union[_builtins.str, Severity]], assessment_metadata_name: Optional[pulumi.Input[_builtins.str]] = ..., categories: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Categories]]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., implementation_effort: Optional[pulumi.Input[Union[_builtins.str, ImplementationEffort]]] = ..., partner_data: Optional[pulumi.Input[SecurityAssessmentMetadataPartnerDataArgs]] = ..., planned_deprecation_date: Optional[pulumi.Input[_builtins.str]] = ..., preview: Optional[pulumi.Input[_builtins.bool]] = ..., publish_dates: Optional[pulumi.Input[SecurityAssessmentMetadataPropertiesResponsePublishDatesArgs]] = ..., remediation_description: Optional[pulumi.Input[_builtins.str]] = ..., tactics: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Tactics]]]]] = ..., techniques: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Techniques]]]]] = ..., threats: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Threats]]]]] = ..., user_impact: Optional[pulumi.Input[Union[_builtins.str, UserImpact]]] = ...) -> None:
    ...
    def assessment_metadata_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def planned_deprecation_date(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def publish_dates(self, value: Optional[pulumi.Input[SecurityAssessmentMetadataPropertiesResponsePublishDatesArgs]]): # -> None:
        ...
    ...
    @tactics.setter
    def tactics(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Tactics]]]]]): # -> None:
        ...
    ...
    @techniques.setter
    def techniques(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Techniques]]]]]): # -> None:
        ...
...
class AssessmentMetadataInSubscription(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., assessment_metadata_name: Optional[pulumi.Input[_builtins.str]] = ..., assessment_type: Optional[pulumi.Input[Union[_builtins.str, AssessmentType]]] = ..., categories: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Categories]]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., implementation_effort: Optional[pulumi.Input[Union[_builtins.str, ImplementationEffort]]] = ..., partner_data: Optional[pulumi.Input[Union[SecurityAssessmentMetadataPartnerDataArgs, SecurityAssessmentMetadataPartnerDataArgsDict]]] = ..., planned_deprecation_date: Optional[pulumi.Input[_builtins.str]] = ..., preview: Optional[pulumi.Input[_builtins.bool]] = ..., publish_dates: Optional[pulumi.Input[Union[SecurityAssessmentMetadataPropertiesResponsePublishDatesArgs, SecurityAssessmentMetadataPropertiesResponsePublishDatesArgsDict]]] = ..., remediation_description: Optional[pulumi.Input[_builtins.str]] = ..., severity: Optional[pulumi.Input[Union[_builtins.str, Severity]]] = ..., tactics: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Tactics]]]]] = ..., techniques: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Techniques]]]]] = ..., threats: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Threats]]]]] = ..., user_impact: Optional[pulumi.Input[Union[_builtins.str, UserImpact]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: AssessmentMetadataInSubscriptionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> AssessmentMetadataInSubscription:
