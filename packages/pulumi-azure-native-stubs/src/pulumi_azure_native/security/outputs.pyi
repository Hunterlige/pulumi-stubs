...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessTokenAuthenticationResponse', 'ActionableRemediationResponse', 'AdditionalWorkspacesPropertiesResponse', 'AllowlistCustomAlertRuleResponse', 'ArcAutoProvisioningResponseConfiguration', 'AssessmentLinksResponse', 'AssessmentStatusResponseResponse', 'AssignedAssessmentItemResponse', 'AssignedComponentItemResponse', 'AssignedStandardItemResponse', 'AssignmentPropertiesResponseAdditionalData', 'AttestationEvidenceResponse', 'AuthorizationResponse', 'AutomationActionEventHubResponse', 'AutomationActionLogicAppResponse', 'AutomationActionWorkspaceResponse', 'AutomationRuleSetResponse', 'AutomationScopeResponse', 'AutomationSourceResponse', 'AutomationTriggeringRuleResponse', 'AwsEnvironmentDataResponse', 'AwsOrganizationalDataMasterResponse', 'AwsOrganizationalDataMemberResponse', 'AzureDevOpsOrgPropertiesResponse', 'AzureDevOpsOrgResponse', 'AzureDevOpsScopeEnvironmentDataResponse', 'AzureResourceDetailsResponse', 'CategoryConfigurationResponse', 'CspmMonitorAwsOfferingResponse', ..., 'CspmMonitorAzureDevOpsOfferingResponse', 'CspmMonitorDockerHubOfferingResponse', 'CspmMonitorGcpOfferingResponse', ..., 'CspmMonitorGitLabOfferingResponse', 'CspmMonitorGithubOfferingResponse', 'CspmMonitorJFrogOfferingResponse', 'DefenderCspmAwsOfferingResponse', 'DefenderCspmAwsOfferingResponseCiem', 'DefenderCspmAwsOfferingResponseCiemDiscovery', 'DefenderCspmAwsOfferingResponseCiemOidc', ..., 'DefenderCspmAwsOfferingResponseDatabasesDspm', ..., ..., 'DefenderCspmAwsOfferingResponseVmScanners', 'DefenderCspmDockerHubOfferingResponse', 'DefenderCspmGcpOfferingResponse', 'DefenderCspmGcpOfferingResponseCiemDiscovery', ..., ..., ..., 'DefenderCspmGcpOfferingResponseVmScanners', 'DefenderCspmJFrogOfferingResponse', ..., 'DefenderFoDatabasesAwsOfferingResponse', ..., ..., 'DefenderFoDatabasesAwsOfferingResponseRds', 'DefenderForContainersAwsOfferingResponse', ..., ..., ..., ..., ..., ..., 'DefenderForContainersAwsOfferingResponseVmScanners', 'DefenderForContainersDockerHubOfferingResponse', 'DefenderForContainersGcpOfferingResponse', ..., ..., ..., ..., 'DefenderForContainersGcpOfferingResponseVmScanners', 'DefenderForContainersJFrogOfferingResponse', 'DefenderForDatabasesGcpOfferingResponse', ..., ..., 'DefenderForServersAwsOfferingResponse', ..., 'DefenderForServersAwsOfferingResponseConfiguration', ..., ..., 'DefenderForServersAwsOfferingResponseSubPlan', ..., 'DefenderForServersAwsOfferingResponseVmScanners', 'DefenderForServersGcpOfferingResponse', ..., 'DefenderForServersGcpOfferingResponseConfiguration', ..., ..., 'DefenderForServersGcpOfferingResponseSubPlan', ..., 'DefenderForServersGcpOfferingResponseVmScanners', 'DefenderForStorageSettingPropertiesResponse', 'DenylistCustomAlertRuleResponse', 'DevOpsCapabilityResponse', 'DevOpsConfigurationPropertiesResponse', 'DockerHubEnvironmentDataResponse', 'ExtensionResponse', 'GcpOrganizationalDataMemberResponse', 'GcpOrganizationalDataOrganizationResponse', 'GcpProjectDetailsResponse', 'GcpProjectEnvironmentDataResponse', 'GitHubOwnerPropertiesResponse', 'GitHubOwnerResponse', 'GitLabGroupPropertiesResponse', 'GitLabGroupResponse', 'GithubScopeEnvironmentDataResponse', 'GitlabScopeEnvironmentDataResponse', 'GovernanceAssignmentAdditionalDataResponse', 'GovernanceEmailNotificationResponse', 'GovernanceRuleEmailNotificationResponse', 'GovernanceRuleMetadataResponse', 'GovernanceRuleOwnerSourceResponse', 'IdentityResponse', 'JFrogEnvironmentDataResponse', 'JitNetworkAccessPolicyVirtualMachineResponse', 'JitNetworkAccessPortRuleResponse', 'JitNetworkAccessRequestPortResponse', 'JitNetworkAccessRequestResponse', 'JitNetworkAccessRequestVirtualMachineResponse', 'MalwareScanningPropertiesResponse', 'NotificationsSourceAlertResponse', 'NotificationsSourceAttackPathResponse', 'OnPremiseResourceDetailsResponse', 'OnPremiseSqlResourceDetailsResponse', 'OnUploadPropertiesResponse', 'OperationStatusResponse', 'PartialAssessmentPropertiesResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkResourceResponse', 'PrivateLinkServiceConnectionStateResponse', 'RecommendationConfigurationPropertiesResponse', 'RemediationEtaResponse', 'RuleResultsPropertiesResponse', 'ScopeElementResponse', 'SecurityAssessmentMetadataPartnerDataResponse', 'SecurityAssessmentMetadataPropertiesResponse', ..., 'SecurityAssessmentPartnerDataResponse', ..., 'SensitiveDataDiscoveryPropertiesResponse', 'StandardAssignmentMetadataResponse', ..., 'StandardAssignmentPropertiesResponseExemptionData', 'StandardComponentPropertiesResponse', 'StandardMetadataResponse', 'SuppressionAlertsScopeResponse', 'SystemDataResponse', 'TargetBranchConfigurationResponse', 'ThresholdCustomAlertRuleResponse', 'TimeWindowCustomAlertRuleResponse', 'UserDefinedResourcesPropertiesResponse', 'VmScannersBaseResponseConfiguration']
@pulumi.output_type
class AccessTokenAuthenticationResponse(dict):
    ...
    def __init__(__self__, *, authentication_type: _builtins.str, access_token: Optional[_builtins.str] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class ActionableRemediationResponse(dict):
    ...
    def __init__(__self__, *, branch_configuration: Optional[outputs.TargetBranchConfigurationResponse] = ..., category_configurations: Optional[Sequence[outputs.CategoryConfigurationResponse]] = ..., inherit_from_parent_state: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class AdditionalWorkspacesPropertiesResponse(dict):
    ...
    def __init__(__self__, *, data_types: Optional[Sequence[_builtins.str]] = ..., type: Optional[_builtins.str] = ..., workspace: Optional[_builtins.str] = ...) -> None:
...
class AllowlistCustomAlertRuleResponse(dict):
    ...
    def __init__(__self__, *, allowlist_values: Sequence[_builtins.str], description: _builtins.str, display_name: _builtins.str, is_enabled: _builtins.bool, rule_type: _builtins.str, value_type: _builtins.str) -> None:
...
class ArcAutoProvisioningResponseConfiguration(dict):
    ...
    def __init__(__self__, *, private_link_scope: Optional[_builtins.str] = ..., proxy: Optional[_builtins.str] = ...) -> None:
...
class AssessmentStatusResponseResponse(dict):
    ...
    def __init__(__self__, *, code: _builtins.str, first_evaluation_date: _builtins.str, status_change_date: _builtins.str, cause: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class AssignedAssessmentItemResponse(dict):
    ...
    def __init__(__self__, *, assessment_key: Optional[_builtins.str] = ...) -> None:
...
class AssignmentPropertiesResponseAdditionalData(dict):
    ...
    def __init__(__self__, *, exemption_category: Optional[_builtins.str] = ...) -> None:
...
class AttestationEvidenceResponse(dict):
    ...
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., source_url: Optional[_builtins.str] = ...) -> None:
...
class AutomationActionEventHubResponse(dict):
    ...
    def __init__(__self__, *, action_type: _builtins.str, sas_policy_name: _builtins.str, connection_string: Optional[_builtins.str] = ..., event_hub_resource_id: Optional[_builtins.str] = ..., is_trusted_service_enabled: Optional[_builtins.bool] = ...) -> None:
...
class AutomationActionLogicAppResponse(dict):
    ...
    def __init__(__self__, *, action_type: _builtins.str, logic_app_resource_id: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class AutomationActionWorkspaceResponse(dict):
    ...
    def __init__(__self__, *, action_type: _builtins.str, workspace_resource_id: Optional[_builtins.str] = ...) -> None:
...
class AutomationRuleSetResponse(dict):
    ...
    def __init__(__self__, *, rules: Optional[Sequence[outputs.AutomationTriggeringRuleResponse]] = ...) -> None:
...
class AutomationScopeResponse(dict):
    ...
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., scope_path: Optional[_builtins.str] = ...) -> None:
...
class AutomationSourceResponse(dict):
    ...
    def __init__(__self__, *, event_source: Optional[_builtins.str] = ..., rule_sets: Optional[Sequence[outputs.AutomationRuleSetResponse]] = ...) -> None:
...
class AutomationTriggeringRuleResponse(dict):
    ...
    def __init__(__self__, *, expected_value: Optional[_builtins.str] = ..., operator: Optional[_builtins.str] = ..., property_j_path: Optional[_builtins.str] = ..., property_type: Optional[_builtins.str] = ...) -> None:
...
class AwsEnvironmentDataResponse(dict):
    ...
    def __init__(__self__, *, account_name: _builtins.str, environment_type: _builtins.str, organizational_data: Optional[Any] = ..., regions: Optional[Sequence[_builtins.str]] = ..., scan_interval: Optional[_builtins.float] = ...) -> None:
...
class AwsOrganizationalDataMasterResponse(dict):
    ...
    def __init__(__self__, *, organization_membership_type: _builtins.str, excluded_account_ids: Optional[Sequence[_builtins.str]] = ..., stackset_name: Optional[_builtins.str] = ...) -> None:
...
class AwsOrganizationalDataMemberResponse(dict):
    ...
    def __init__(__self__, *, organization_membership_type: _builtins.str, parent_hierarchy_id: Optional[_builtins.str] = ...) -> None:
...
class AzureDevOpsOrgPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_status_message: _builtins.str, provisioning_status_update_time_utc: _builtins.str, actionable_remediation: Optional[outputs.ActionableRemediationResponse] = ..., onboarding_state: Optional[_builtins.str] = ..., provisioning_state: Optional[_builtins.str] = ...) -> None:
...
class AzureDevOpsOrgResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str, properties: Optional[outputs.AzureDevOpsOrgPropertiesResponse] = ...) -> None:
...
class CategoryConfigurationResponse(dict):
    ...
    def __init__(__self__, *, category: Optional[_builtins.str] = ..., minimum_severity_level: Optional[_builtins.str] = ...) -> None:
...
class CspmMonitorAwsOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str, native_cloud_connection: Optional[outputs.CspmMonitorAwsOfferingResponseNativeCloudConnection] = ...) -> None:
...
class CspmMonitorAwsOfferingResponseNativeCloudConnection(dict):
    ...
    def __init__(__self__, *, cloud_role_arn: Optional[_builtins.str] = ...) -> None:
...
class CspmMonitorAzureDevOpsOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str) -> None:
...
class CspmMonitorGcpOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str, native_cloud_connection: Optional[outputs.CspmMonitorGcpOfferingResponseNativeCloudConnection] = ...) -> None:
...
class CspmMonitorGcpOfferingResponseNativeCloudConnection(dict):
    ...
    def __init__(__self__, *, service_account_email_address: Optional[_builtins.str] = ..., workload_identity_provider_id: Optional[_builtins.str] = ...) -> None:
...
class DefenderCspmAwsOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str, ciem: Optional[outputs.DefenderCspmAwsOfferingResponseCiem] = ..., data_sensitivity_discovery: Optional[outputs.DefenderCspmAwsOfferingResponseDataSensitivityDiscovery] = ..., databases_dspm: Optional[outputs.DefenderCspmAwsOfferingResponseDatabasesDspm] = ..., mdc_containers_agentless_discovery_k8s: Optional[outputs.DefenderCspmAwsOfferingResponseMdcContainersAgentlessDiscoveryK8s] = ..., mdc_containers_image_assessment: Optional[outputs.DefenderCspmAwsOfferingResponseMdcContainersImageAssessment] = ..., vm_scanners: Optional[outputs.DefenderCspmAwsOfferingResponseVmScanners] = ...) -> None:
...
class DefenderCspmAwsOfferingResponseCiem(dict):
    ...
    def __init__(__self__, *, ciem_discovery: Optional[outputs.DefenderCspmAwsOfferingResponseCiemDiscovery] = ..., ciem_oidc: Optional[outputs.DefenderCspmAwsOfferingResponseCiemOidc] = ...) -> None:
...
class DefenderCspmAwsOfferingResponseCiemOidc(dict):
    ...
    def __init__(__self__, *, azure_active_directory_app_name: Optional[_builtins.str] = ..., cloud_role_arn: Optional[_builtins.str] = ...) -> None:
...
class DefenderCspmAwsOfferingResponseDataSensitivityDiscovery(dict):
    ...
    def __init__(__self__, *, cloud_role_arn: Optional[_builtins.str] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class DefenderCspmAwsOfferingResponseVmScanners(dict):
    ...
    def __init__(__self__, *, cloud_role_arn: Optional[_builtins.str] = ..., configuration: Optional[outputs.VmScannersBaseResponseConfiguration] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class DefenderCspmGcpOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str, ciem_discovery: Optional[outputs.DefenderCspmGcpOfferingResponseCiemDiscovery] = ..., data_sensitivity_discovery: Optional[outputs.DefenderCspmGcpOfferingResponseDataSensitivityDiscovery] = ..., mdc_containers_agentless_discovery_k8s: Optional[outputs.DefenderCspmGcpOfferingResponseMdcContainersAgentlessDiscoveryK8s] = ..., mdc_containers_image_assessment: Optional[outputs.DefenderCspmGcpOfferingResponseMdcContainersImageAssessment] = ..., vm_scanners: Optional[outputs.DefenderCspmGcpOfferingResponseVmScanners] = ...) -> None:
...
class DefenderCspmGcpOfferingResponseCiemDiscovery(dict):
    ...
    def __init__(__self__, *, azure_active_directory_app_name: Optional[_builtins.str] = ..., service_account_email_address: Optional[_builtins.str] = ..., workload_identity_provider_id: Optional[_builtins.str] = ...) -> None:
...
class DefenderCspmGcpOfferingResponseDataSensitivityDiscovery(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., service_account_email_address: Optional[_builtins.str] = ..., workload_identity_provider_id: Optional[_builtins.str] = ...) -> None:
...
class DefenderCspmGcpOfferingResponseVmScanners(dict):
    ...
    def __init__(__self__, *, configuration: Optional[outputs.VmScannersBaseResponseConfiguration] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class DefenderCspmJFrogOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str, mdc_containers_image_assessment: Optional[outputs.DefenderCspmJFrogOfferingResponseMdcContainersImageAssessment] = ...) -> None:
...
class DefenderFoDatabasesAwsOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str, arc_auto_provisioning: Optional[outputs.DefenderFoDatabasesAwsOfferingResponseArcAutoProvisioning] = ..., databases_dspm: Optional[outputs.DefenderFoDatabasesAwsOfferingResponseDatabasesDspm] = ..., rds: Optional[outputs.DefenderFoDatabasesAwsOfferingResponseRds] = ...) -> None:
...
class DefenderFoDatabasesAwsOfferingResponseArcAutoProvisioning(dict):
    ...
    def __init__(__self__, *, cloud_role_arn: Optional[_builtins.str] = ..., configuration: Optional[outputs.ArcAutoProvisioningResponseConfiguration] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class DefenderForContainersAwsOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str, cloud_watch_to_kinesis: Optional[outputs.DefenderForContainersAwsOfferingResponseCloudWatchToKinesis] = ..., data_collection_external_id: Optional[_builtins.str] = ..., enable_audit_logs_auto_provisioning: Optional[_builtins.bool] = ..., enable_defender_agent_auto_provisioning: Optional[_builtins.bool] = ..., enable_policy_agent_auto_provisioning: Optional[_builtins.bool] = ..., kinesis_to_s3: Optional[outputs.DefenderForContainersAwsOfferingResponseKinesisToS3] = ..., kube_audit_retention_time: Optional[_builtins.float] = ..., kubernetes_data_collection: Optional[outputs.DefenderForContainersAwsOfferingResponseKubernetesDataCollection] = ..., kubernetes_service: Optional[outputs.DefenderForContainersAwsOfferingResponseKubernetesService] = ..., mdc_containers_agentless_discovery_k8s: Optional[outputs.DefenderForContainersAwsOfferingResponseMdcContainersAgentlessDiscoveryK8s] = ..., mdc_containers_image_assessment: Optional[outputs.DefenderForContainersAwsOfferingResponseMdcContainersImageAssessment] = ..., vm_scanners: Optional[outputs.DefenderForContainersAwsOfferingResponseVmScanners] = ...) -> None:
...
class DefenderForContainersGcpOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str, data_pipeline_native_cloud_connection: Optional[outputs.DefenderForContainersGcpOfferingResponseDataPipelineNativeCloudConnection] = ..., enable_audit_logs_auto_provisioning: Optional[_builtins.bool] = ..., enable_defender_agent_auto_provisioning: Optional[_builtins.bool] = ..., enable_policy_agent_auto_provisioning: Optional[_builtins.bool] = ..., mdc_containers_agentless_discovery_k8s: Optional[outputs.DefenderForContainersGcpOfferingResponseMdcContainersAgentlessDiscoveryK8s] = ..., mdc_containers_image_assessment: Optional[outputs.DefenderForContainersGcpOfferingResponseMdcContainersImageAssessment] = ..., native_cloud_connection: Optional[outputs.DefenderForContainersGcpOfferingResponseNativeCloudConnection] = ..., vm_scanners: Optional[outputs.DefenderForContainersGcpOfferingResponseVmScanners] = ...) -> None:
...
class DefenderForDatabasesGcpOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str, arc_auto_provisioning: Optional[outputs.DefenderForDatabasesGcpOfferingResponseArcAutoProvisioning] = ..., defender_for_databases_arc_auto_provisioning: Optional[outputs.DefenderForDatabasesGcpOfferingResponseDefenderForDatabasesArcAutoProvisioning] = ...) -> None:
...
class DefenderForDatabasesGcpOfferingResponseArcAutoProvisioning(dict):
    ...
    def __init__(__self__, *, configuration: Optional[outputs.ArcAutoProvisioningResponseConfiguration] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class DefenderForServersAwsOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str, arc_auto_provisioning: Optional[outputs.DefenderForServersAwsOfferingResponseArcAutoProvisioning] = ..., defender_for_servers: Optional[outputs.DefenderForServersAwsOfferingResponseDefenderForServers] = ..., mde_auto_provisioning: Optional[outputs.DefenderForServersAwsOfferingResponseMdeAutoProvisioning] = ..., sub_plan: Optional[outputs.DefenderForServersAwsOfferingResponseSubPlan] = ..., va_auto_provisioning: Optional[outputs.DefenderForServersAwsOfferingResponseVaAutoProvisioning] = ..., vm_scanners: Optional[outputs.DefenderForServersAwsOfferingResponseVmScanners] = ...) -> None:
...
class DefenderForServersAwsOfferingResponseMdeAutoProvisioning(dict):
    ...
    def __init__(__self__, *, configuration: Optional[Any] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class DefenderForServersAwsOfferingResponseVaAutoProvisioning(dict):
    ...
    def __init__(__self__, *, configuration: Optional[outputs.DefenderForServersAwsOfferingResponseConfiguration] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class DefenderForServersGcpOfferingResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, offering_type: _builtins.str, arc_auto_provisioning: Optional[outputs.DefenderForServersGcpOfferingResponseArcAutoProvisioning] = ..., defender_for_servers: Optional[outputs.DefenderForServersGcpOfferingResponseDefenderForServers] = ..., mde_auto_provisioning: Optional[outputs.DefenderForServersGcpOfferingResponseMdeAutoProvisioning] = ..., sub_plan: Optional[outputs.DefenderForServersGcpOfferingResponseSubPlan] = ..., va_auto_provisioning: Optional[outputs.DefenderForServersGcpOfferingResponseVaAutoProvisioning] = ..., vm_scanners: Optional[outputs.DefenderForServersGcpOfferingResponseVmScanners] = ...) -> None:
...
class DefenderForServersGcpOfferingResponseVaAutoProvisioning(dict):
    ...
    def __init__(__self__, *, configuration: Optional[outputs.DefenderForServersGcpOfferingResponseConfiguration] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class DefenderForStorageSettingPropertiesResponse(dict):
    ...
    def __init__(__self__, *, is_enabled: Optional[_builtins.bool] = ..., malware_scanning: Optional[outputs.MalwareScanningPropertiesResponse] = ..., override_subscription_level_settings: Optional[_builtins.bool] = ..., sensitive_data_discovery: Optional[outputs.SensitiveDataDiscoveryPropertiesResponse] = ...) -> None:
...
class DenylistCustomAlertRuleResponse(dict):
    ...
    def __init__(__self__, *, denylist_values: Sequence[_builtins.str], description: _builtins.str, display_name: _builtins.str, is_enabled: _builtins.bool, rule_type: _builtins.str, value_type: _builtins.str) -> None:
...
class DevOpsConfigurationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, capabilities: Sequence[outputs.DevOpsCapabilityResponse], provisioning_status_message: _builtins.str, provisioning_status_update_time_utc: _builtins.str, authorization: Optional[outputs.AuthorizationResponse] = ..., auto_discovery: Optional[_builtins.str] = ..., provisioning_state: Optional[_builtins.str] = ..., top_level_inventory_list: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DockerHubEnvironmentDataResponse(dict):
    ...
    def __init__(__self__, *, environment_type: _builtins.str, authentication: Optional[outputs.AccessTokenAuthenticationResponse] = ..., scan_interval: Optional[_builtins.float] = ...) -> None:
...
class ExtensionResponse(dict):
    ...
    def __init__(__self__, *, is_enabled: _builtins.str, name: _builtins.str, operation_status: outputs.OperationStatusResponse, additional_extension_properties: Optional[Any] = ...) -> None:
...
class GcpOrganizationalDataMemberResponse(dict):
    ...
    def __init__(__self__, *, organization_membership_type: _builtins.str, management_project_number: Optional[_builtins.str] = ..., parent_hierarchy_id: Optional[_builtins.str] = ...) -> None:
...
class GcpOrganizationalDataOrganizationResponse(dict):
    ...
    def __init__(__self__, *, organization_membership_type: _builtins.str, organization_name: _builtins.str, excluded_project_numbers: Optional[Sequence[_builtins.str]] = ..., service_account_email_address: Optional[_builtins.str] = ..., workload_identity_provider_id: Optional[_builtins.str] = ...) -> None:
...
class GcpProjectDetailsResponse(dict):
    ...
    def __init__(__self__, *, project_name: _builtins.str, workload_identity_pool_id: _builtins.str, project_id: Optional[_builtins.str] = ..., project_number: Optional[_builtins.str] = ...) -> None:
...
class GcpProjectEnvironmentDataResponse(dict):
    ...
    def __init__(__self__, *, environment_type: _builtins.str, organizational_data: Optional[Any] = ..., project_details: Optional[outputs.GcpProjectDetailsResponse] = ..., scan_interval: Optional[_builtins.float] = ...) -> None:
...
class GitHubOwnerPropertiesResponse(dict):
    ...
    def __init__(__self__, *, git_hub_internal_id: _builtins.str, owner_url: _builtins.str, provisioning_status_message: _builtins.str, provisioning_status_update_time_utc: _builtins.str, onboarding_state: Optional[_builtins.str] = ..., provisioning_state: Optional[_builtins.str] = ...) -> None:
...
class GitHubOwnerResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str, properties: Optional[outputs.GitHubOwnerPropertiesResponse] = ...) -> None:
...
class GitLabGroupPropertiesResponse(dict):
    ...
    def __init__(__self__, *, fully_qualified_friendly_name: _builtins.str, fully_qualified_name: _builtins.str, provisioning_status_message: _builtins.str, provisioning_status_update_time_utc: _builtins.str, url: _builtins.str, onboarding_state: Optional[_builtins.str] = ..., provisioning_state: Optional[_builtins.str] = ...) -> None:
...
class GitLabGroupResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str, properties: Optional[outputs.GitLabGroupPropertiesResponse] = ...) -> None:
...
class GovernanceAssignmentAdditionalDataResponse(dict):
    ...
    def __init__(__self__, *, ticket_link: Optional[_builtins.str] = ..., ticket_number: Optional[_builtins.int] = ..., ticket_status: Optional[_builtins.str] = ...) -> None:
...
class GovernanceEmailNotificationResponse(dict):
    ...
    def __init__(__self__, *, disable_manager_email_notification: Optional[_builtins.bool] = ..., disable_owner_email_notification: Optional[_builtins.bool] = ...) -> None:
...
class GovernanceRuleMetadataResponse(dict):
    ...
    def __init__(__self__, *, created_by: _builtins.str, created_on: _builtins.str, updated_by: _builtins.str, updated_on: _builtins.str) -> None:
...
class JFrogEnvironmentDataResponse(dict):
    ...
    def __init__(__self__, *, environment_type: _builtins.str, scan_interval: Optional[_builtins.int] = ...) -> None:
...
class JitNetworkAccessPolicyVirtualMachineResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, ports: Sequence[outputs.JitNetworkAccessPortRuleResponse], public_ip_address: Optional[_builtins.str] = ...) -> None:
...
class JitNetworkAccessPortRuleResponse(dict):
    ...
    def __init__(__self__, *, max_request_access_duration: _builtins.str, number: _builtins.int, protocol: _builtins.str, allowed_source_address_prefix: Optional[_builtins.str] = ..., allowed_source_address_prefixes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class JitNetworkAccessRequestPortResponse(dict):
    ...
    def __init__(__self__, *, end_time_utc: _builtins.str, number: _builtins.int, status: _builtins.str, status_reason: _builtins.str, allowed_source_address_prefix: Optional[_builtins.str] = ..., allowed_source_address_prefixes: Optional[Sequence[_builtins.str]] = ..., mapped_port: Optional[_builtins.int] = ...) -> None:
...
class JitNetworkAccessRequestResponse(dict):
    ...
    def __init__(__self__, *, requestor: _builtins.str, start_time_utc: _builtins.str, virtual_machines: Sequence[outputs.JitNetworkAccessRequestVirtualMachineResponse], justification: Optional[_builtins.str] = ...) -> None:
...
class JitNetworkAccessRequestVirtualMachineResponse(dict):
    def __init__(__self__, *, id: _builtins.str, ports: Sequence[outputs.JitNetworkAccessRequestPortResponse]) -> None:
...
class MalwareScanningPropertiesResponse(dict):
    ...
    def __init__(__self__, *, operation_status: outputs.OperationStatusResponse, on_upload: Optional[outputs.OnUploadPropertiesResponse] = ..., scan_results_event_grid_topic_resource_id: Optional[_builtins.str] = ...) -> None:
...
class NotificationsSourceAlertResponse(dict):
    ...
    def __init__(__self__, *, source_type: _builtins.str, minimal_severity: Optional[_builtins.str] = ...) -> None:
...
class NotificationsSourceAttackPathResponse(dict):
    ...
    def __init__(__self__, *, source_type: _builtins.str, minimal_risk_level: Optional[_builtins.str] = ...) -> None:
...
class OnPremiseResourceDetailsResponse(dict):
    ...
    def __init__(__self__, *, machine_name: _builtins.str, source: _builtins.str, source_computer_id: _builtins.str, vmuuid: _builtins.str, workspace_id: _builtins.str) -> None:
...
class OnPremiseSqlResourceDetailsResponse(dict):
    ...
    def __init__(__self__, *, database_name: _builtins.str, machine_name: _builtins.str, server_name: _builtins.str, source: _builtins.str, source_computer_id: _builtins.str, vmuuid: _builtins.str, workspace_id: _builtins.str) -> None:
...
class OnUploadPropertiesResponse(dict):
    ...
    def __init__(__self__, *, cap_gb_per_month: Optional[_builtins.int] = ..., is_enabled: Optional[_builtins.bool] = ...) -> None:
...
class PrivateLinkResourceResponse(dict):
    ...
    def __init__(__self__, *, group_id: _builtins.str, id: _builtins.str, name: _builtins.str, required_members: Sequence[_builtins.str], system_data: outputs.SystemDataResponse, type: _builtins.str, required_zone_names: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class RecommendationConfigurationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, recommendation_type: _builtins.str, status: Optional[_builtins.str] = ...) -> None:
...
class RemediationEtaResponse(dict):
    ...
    def __init__(__self__, *, eta: _builtins.str, justification: _builtins.str) -> None:
...
class RuleResultsPropertiesResponse(dict):
    ...
    def __init__(__self__, *, results: Optional[Sequence[Sequence[_builtins.str]]] = ...) -> None:
...
class SecurityAssessmentMetadataPartnerDataResponse(dict):
    ...
    def __init__(__self__, *, partner_name: _builtins.str, secret: _builtins.str, product_name: Optional[_builtins.str] = ...) -> None:
...
class SecurityAssessmentMetadataPropertiesResponse(dict):
    ...
    def __init__(__self__, *, assessment_type: _builtins.str, display_name: _builtins.str, policy_definition_id: _builtins.str, severity: _builtins.str, categories: Optional[Sequence[_builtins.str]] = ..., description: Optional[_builtins.str] = ..., implementation_effort: Optional[_builtins.str] = ..., partner_data: Optional[outputs.SecurityAssessmentMetadataPartnerDataResponse] = ..., preview: Optional[_builtins.bool] = ..., remediation_description: Optional[_builtins.str] = ..., threats: Optional[Sequence[_builtins.str]] = ..., user_impact: Optional[_builtins.str] = ...) -> None:
...
class SecurityAssessmentMetadataPropertiesResponseResponsePublishDates(dict):
    ...
    def __init__(__self__, *, public: _builtins.str, g_a: Optional[_builtins.str] = ...) -> None:
        ...
...
class SecurityAssessmentPartnerDataResponse(dict):
    ...
    def __init__(__self__, *, partner_name: _builtins.str, secret: _builtins.str) -> None:
...
class SecurityContactPropertiesResponseNotificationsByRole(dict):
    ...
    def __init__(__self__, *, roles: Optional[Sequence[_builtins.str]] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class SensitiveDataDiscoveryPropertiesResponse(dict):
    ...
    def __init__(__self__, *, operation_status: outputs.OperationStatusResponse, is_enabled: Optional[_builtins.bool] = ...) -> None:
...
class StandardAssignmentMetadataResponse(dict):
    ...
    def __init__(__self__, *, created_by: _builtins.str, created_on: _builtins.str, last_updated_by: _builtins.str, last_updated_on: _builtins.str) -> None:
...
class StandardAssignmentPropertiesResponseAttestationData(dict):
    ...
    def __init__(__self__, *, compliance_date: _builtins.str, assigned_assessment: Optional[outputs.AssignedAssessmentItemResponse] = ..., compliance_state: Optional[_builtins.str] = ..., evidence: Optional[Sequence[outputs.AttestationEvidenceResponse]] = ...) -> None:
...
class StandardAssignmentPropertiesResponseExemptionData(dict):
    ...
    def __init__(__self__, *, assigned_assessment: Optional[outputs.AssignedAssessmentItemResponse] = ..., exemption_category: Optional[_builtins.str] = ...) -> None:
...
class SuppressionAlertsScopeResponse(dict):
    ...
    def __init__(__self__, *, all_of: Sequence[outputs.ScopeElementResponse]) -> None:
...
class TargetBranchConfigurationResponse(dict):
    ...
    def __init__(__self__, *, annotate_default_branch: Optional[_builtins.str] = ..., branch_names: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ThresholdCustomAlertRuleResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, display_name: _builtins.str, is_enabled: _builtins.bool, max_threshold: _builtins.int, min_threshold: _builtins.int, rule_type: _builtins.str) -> None:
...
class TimeWindowCustomAlertRuleResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, display_name: _builtins.str, is_enabled: _builtins.bool, max_threshold: _builtins.int, min_threshold: _builtins.int, rule_type: _builtins.str, time_window_size: _builtins.str) -> None:
...
class UserDefinedResourcesPropertiesResponse(dict):
    ...
    def __init__(__self__, *, query: _builtins.str, query_subscriptions: Sequence[_builtins.str]) -> None:
...
class VmScannersBaseResponseConfiguration(dict):
    ...
    def __init__(__self__, *, exclusion_tags: Optional[Mapping[str, _builtins.str]] = ..., scanning_mode: Optional[_builtins.str] = ...) -> None:
