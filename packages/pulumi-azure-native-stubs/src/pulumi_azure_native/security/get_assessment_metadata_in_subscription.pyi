...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetAssessmentMetadataInSubscriptionResult', 'AwaitableGetAssessmentMetadataInSubscriptionResult', 'get_assessment_metadata_in_subscription', 'get_assessment_metadata_in_subscription_output']
@pulumi.output_type
class GetAssessmentMetadataInSubscriptionResult:
    
    def __init__(__self__, assessment_type=..., azure_api_version=..., categories=..., description=..., display_name=..., id=..., implementation_effort=..., name=..., partner_data=..., planned_deprecation_date=..., policy_definition_id=..., preview=..., publish_dates=..., remediation_description=..., severity=..., tactics=..., techniques=..., threats=..., type=..., user_impact=...) -> None:
        ...
...
class AwaitableGetAssessmentMetadataInSubscriptionResult(GetAssessmentMetadataInSubscriptionResult):
    def __await__(self): # -> Generator[Never, Any, GetAssessmentMetadataInSubscriptionResult]:
        ...
    


def get_assessment_metadata_in_subscription(assessment_metadata_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAssessmentMetadataInSubscriptionResult:
    
    ...

def get_assessment_metadata_in_subscription_output(assessment_metadata_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAssessmentMetadataInSubscriptionResult]:
