...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccountSkuArgs', 'AccountSkuArgsDict', 'CredentialsArgs', 'CredentialsArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'IngestionStorageArgs', 'IngestionStorageArgsDict', 'PrivateEndpointArgs', 'PrivateEndpointArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict']
...
class AccountSkuArgs:
    def __init__(__self__, *, capacity: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[Union[_builtins.str, AccountSkuName]]] = ...) -> None:
    ...
    @name.setter
    def name(self, value: Optional[pulumi.Input[Union[_builtins.str, AccountSkuName]]]): # -> None:
        ...
...
class CredentialsArgs:
    def __init__(__self__, *, identity_id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, KafkaConfigurationIdentityType]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, KafkaConfigurationIdentityType]]]): # -> None:
        ...
...
class IngestionStorageArgs:
    def __init__(__self__, *, public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ...) -> None:
