...
class GetAccountResult:
    ...
    def __init__(__self__, account_status=..., azure_api_version=..., cloud_connectors=..., created_at=..., created_by=..., created_by_object_id=..., default_domain=..., endpoints=..., friendly_name=..., id=..., identity=..., ingestion_storage=..., location=..., managed_event_hub_state=..., managed_resource_group_name=..., managed_resources=..., managed_resources_public_network_access=..., merge_info=..., name=..., private_endpoint_connections=..., provisioning_state=..., public_network_access=..., sku=..., system_data=..., tags=..., tenant_endpoint_state=..., type=...) -> None:
        ...
