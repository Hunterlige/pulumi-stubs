...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AlertConfigurationResponse', 'AzureMonitorWorkspaceSignalGroupResponse', 'AzureResourceSignalGroupResponse', 'DependenciesSignalGroupResponse', 'DiscoveryRulePropertiesResponse', 'DynamicDetectionRuleResponse', 'EntityAlertsResponse', 'EntityCoordinatesResponse', 'EntityPropertiesResponse', 'EvaluationRuleResponse', 'HealthModelPropertiesResponse', 'HealthStateTransitionResponse', 'IconDefinitionResponse', ..., 'LogAnalyticsSignalGroupResponse', ..., 'ManagedServiceIdentityResponse', 'ModelDiscoverySettingsResponse', ..., 'RelationshipPropertiesResponse', 'ResourceMetricSignalDefinitionPropertiesResponse', 'SignalAssignmentResponse', 'SignalGroupResponse', 'SignalHistoryDataPointResponse', 'SystemDataResponse', 'ThresholdRuleResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
...
class EntityPropertiesResponse(dict):
    ...
    def __init__(__self__, *, deletion_date: _builtins.str, discovered_by: _builtins.str, health_state: _builtins.str, provisioning_state: _builtins.str, alerts: Optional[outputs.EntityAlertsResponse] = ..., canvas_position: Optional[outputs.EntityCoordinatesResponse] = ..., display_name: Optional[_builtins.str] = ..., health_objective: Optional[_builtins.float] = ..., icon: Optional[outputs.IconDefinitionResponse] = ..., impact: Optional[_builtins.str] = ..., kind: Optional[_builtins.str] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., signals: Optional[outputs.SignalGroupResponse] = ...) -> None:
...
class HealthModelPropertiesResponse(dict):
    ...
    def __init__(__self__, *, dataplane_endpoint: _builtins.str, provisioning_state: _builtins.str, discovery: Optional[outputs.ModelDiscoverySettingsResponse] = ...) -> None:
...
class HealthStateTransitionResponse(dict):
    ...
    def __init__(__self__, *, new_state: _builtins.str, occurred_at: _builtins.str, previous_state: _builtins.str, reason: Optional[_builtins.str] = ...) -> None:
...
class LogAnalyticsQuerySignalDefinitionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, deletion_date: _builtins.str, evaluation_rules: outputs.EvaluationRuleResponse, provisioning_state: _builtins.str, query_text: _builtins.str, signal_kind: _builtins.str, data_unit: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., refresh_interval: Optional[_builtins.str] = ..., time_grain: Optional[_builtins.str] = ..., value_column_name: Optional[_builtins.str] = ...) -> None:
...
class PrometheusMetricsSignalDefinitionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, deletion_date: _builtins.str, evaluation_rules: outputs.EvaluationRuleResponse, provisioning_state: _builtins.str, query_text: _builtins.str, signal_kind: _builtins.str, data_unit: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., refresh_interval: Optional[_builtins.str] = ..., time_grain: Optional[_builtins.str] = ...) -> None:
...
class RelationshipPropertiesResponse(dict):
    ...
    def __init__(__self__, *, child_entity_name: _builtins.str, deletion_date: _builtins.str, discovered_by: _builtins.str, parent_entity_name: _builtins.str, provisioning_state: _builtins.str, display_name: Optional[_builtins.str] = ..., labels: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class SignalHistoryDataPointResponse(dict):
    ...
    def __init__(__self__, *, health_state: _builtins.str, occurred_at: _builtins.str, additional_context: Optional[_builtins.str] = ..., value: Optional[_builtins.float] = ...) -> None:
