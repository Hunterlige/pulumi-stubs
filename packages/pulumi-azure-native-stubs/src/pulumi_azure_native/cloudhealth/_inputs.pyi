...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AlertConfigurationArgs', 'AlertConfigurationArgsDict', 'AzureMonitorWorkspaceSignalGroupArgs', 'AzureMonitorWorkspaceSignalGroupArgsDict', 'AzureResourceSignalGroupArgs', 'AzureResourceSignalGroupArgsDict', 'DependenciesSignalGroupArgs', 'DependenciesSignalGroupArgsDict', 'DiscoveryRulePropertiesArgs', 'DiscoveryRulePropertiesArgsDict', 'DynamicDetectionRuleArgs', 'DynamicDetectionRuleArgsDict', 'EntityAlertsArgs', 'EntityAlertsArgsDict', 'EntityCoordinatesArgs', 'EntityCoordinatesArgsDict', 'EntityPropertiesArgs', 'EntityPropertiesArgsDict', 'EvaluationRuleArgs', 'EvaluationRuleArgsDict', 'HealthModelPropertiesArgs', 'HealthModelPropertiesArgsDict', 'IconDefinitionArgs', 'IconDefinitionArgsDict', 'LogAnalyticsQuerySignalDefinitionPropertiesArgs', ..., 'LogAnalyticsSignalGroupArgs', 'LogAnalyticsSignalGroupArgsDict', 'ManagedIdentityAuthenticationSettingPropertiesArgs', ..., 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'ModelDiscoverySettingsArgs', 'ModelDiscoverySettingsArgsDict', 'PrometheusMetricsSignalDefinitionPropertiesArgs', ..., 'RelationshipPropertiesArgs', 'RelationshipPropertiesArgsDict', 'ResourceMetricSignalDefinitionPropertiesArgs', 'ResourceMetricSignalDefinitionPropertiesArgsDict', 'SignalAssignmentArgs', 'SignalAssignmentArgsDict', 'SignalGroupArgs', 'SignalGroupArgsDict', 'ThresholdRuleArgs', 'ThresholdRuleArgsDict']
...
class LogAnalyticsQuerySignalDefinitionPropertiesArgs:
    def __init__(__self__, *, evaluation_rules: pulumi.Input[EvaluationRuleArgs], query_text: pulumi.Input[_builtins.str], signal_kind: pulumi.Input[_builtins.str], data_unit: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., refresh_interval: Optional[pulumi.Input[Union[_builtins.str, RefreshInterval]]] = ..., time_grain: Optional[pulumi.Input[_builtins.str]] = ..., value_column_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RelationshipPropertiesArgs:
    def __init__(__self__, *, child_entity_name: pulumi.Input[_builtins.str], parent_entity_name: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[_builtins.str]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
