...
class ChannelTypeDescriptionResponse(dict):
    ...
    def __init__(__self__, *, channel_description: Optional[_builtins.str] = ..., channel_functions: Optional[Sequence[_builtins.str]] = ..., channel_type: Optional[_builtins.str] = ...) -> None:
...
class KeyDescriptionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, rank: _builtins.str, value: _builtins.str) -> None:
