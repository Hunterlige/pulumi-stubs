...
class SignalRArgs:
    def __init__(
        ...
        *,
        ...
        network_acls: Optional[pulumi.Input[SignalRNetworkACLsArgs]] = ...,
        ...
        serverless: Optional[pulumi.Input[ServerlessSettingsArgs]] = ...,
        sku: Optional[pulumi.Input[ResourceSkuArgs]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tls: Optional[pulumi.Input[SignalRTlsSettingsArgs]] = ...,
        upstream: Optional[pulumi.Input[ServerlessUpstreamSettingsArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def features(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[SignalRFeatureArgs]]]]: ...
    @features.setter
    def features(
        self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SignalRFeatureArgs]]]]
    ): ...
    @_builtins.property
    @pulumi.getter
    ...
    @upstream.setter
    def upstream(
        self, value: Optional[pulumi.Input[ServerlessUpstreamSettingsArgs]]
    ): ...
...
class SignalR(pulumi.CustomResource):
    ...
    def __init__(
        ...
        cors: Optional[
            pulumi.Input[Union[SignalRCorsSettingsArgs, SignalRCorsSettingsArgsDict]]
        ] = ...,
        disable_aad_auth: Optional[pulumi.Input[_builtins.bool]] = ...,
        disable_local_auth: Optional[pulumi.Input[_builtins.bool]] = ...,
        features: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[Union[SignalRFeatureArgs, SignalRFeatureArgsDict]]
                ]
            ]
        ] = ...,
        identity: Optional[
        ...
        resource_stopped: Optional[pulumi.Input[_builtins.str]] = ...,
        serverless: Optional[
            pulumi.Input[Union[ServerlessSettingsArgs, ServerlessSettingsArgsDict]]
        ] = ...,
        sku: Optional[pulumi.Input[Union[ResourceSkuArgs, ResourceSkuArgsDict]]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tls: Optional[
            pulumi.Input[Union[SignalRTlsSettingsArgs, SignalRTlsSettingsArgsDict]]
        ] = ...,
        upstream: Optional[
            pulumi.Input[
                Union[
                    ServerlessUpstreamSettingsArgs, ServerlessUpstreamSettingsArgsDict
                ]
            ]
        ] = ...,
        __props__=...,
    ...
    def features(
        self,
    ) -> pulumi.Output[Optional[Sequence[outputs.SignalRFeatureResponse]]]: ...
    @_builtins.property
    ...
    def network_acls(
        self,
    ) -> pulumi.Output[Optional[outputs.SignalRNetworkACLsResponse]]: ...
    @_builtins.property
    ...
    def serverless(
        self,
    ) -> pulumi.Output[Optional[outputs.ServerlessSettingsResponse]]: ...
    @_builtins.property
    ...
    def upstream(
        self,
    ) -> pulumi.Output[Optional[outputs.ServerlessUpstreamSettingsResponse]]: ...
    @_builtins.property
    @pulumi.getter
