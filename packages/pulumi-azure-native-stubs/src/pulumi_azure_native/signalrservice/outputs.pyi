...
class ServerlessSettingsResponse(dict):
    ...
    def get(self, key: str, default=...) -> Any: ...
    def __init__(
        __self__, *, connection_timeout_in_seconds: Optional[_builtins.int] = ...
    ) -> None: ...
    @_builtins.property
...
class ServerlessUpstreamSettingsResponse(dict):
    def __init__(
        __self__,
        *,
        templates: Optional[Sequence[outputs.UpstreamTemplateResponse]] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
...
class SignalRCorsSettingsResponse(dict):
    ...
    def get(self, key: str, default=...) -> Any: ...
    def __init__(
        __self__, *, allowed_origins: Optional[Sequence[_builtins.str]] = ...
    ) -> None: ...
    @_builtins.property
...
class UpstreamTemplateResponse(dict):
    ...
    def __init__(
        ...
        *,
        ...
        category_pattern: Optional[_builtins.str] = ...,
        event_pattern: Optional[_builtins.str] = ...,
        hub_pattern: Optional[_builtins.str] = ...,
    ) -> None: ...
    @_builtins.property
