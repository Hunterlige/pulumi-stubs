...
class GetZoneResult:
    ...
    def __init__(__self__, azure_api_version=..., etag=..., id=..., location=..., max_number_of_record_sets=..., max_number_of_records_per_record_set=..., name=..., name_servers=..., number_of_record_sets=..., registration_virtual_networks=..., resolution_virtual_networks=..., signing_keys=..., system_data=..., tags=..., type=..., zone_type=...) -> None:
        ...
...
def get_zone(resource_group_name: Optional[_builtins.str] = ..., zone_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetZoneResult:
    
    ...

def get_zone_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., zone_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetZoneResult]:
