...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ARecordResponse', 'AaaaRecordResponse', 'CaaRecordResponse', 'CnameRecordResponse', 'DelegationSignerInfoResponse', 'DigestResponse', 'DnsResourceReferenceResponse', 'DsRecordResponse', 'MxRecordResponse', 'NaptrRecordResponse', 'NsRecordResponse', 'PtrRecordResponse', 'SigningKeyResponse', 'SoaRecordResponse', 'SrvRecordResponse', 'SubResourceResponse', 'SystemDataResponse', 'TlsaRecordResponse', 'TxtRecordResponse']
@pulumi.output_type
...
class CaaRecordResponse(dict):
    ...
    def __init__(__self__, *, flags: Optional[_builtins.int] = ..., tag: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class DelegationSignerInfoResponse(dict):
    ...
    def __init__(__self__, *, digest_algorithm_type: _builtins.int, digest_value: _builtins.str, record: _builtins.str) -> None:
...
class DigestResponse(dict):
    ...
    def __init__(__self__, *, algorithm_type: Optional[_builtins.int] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class DnsResourceReferenceResponse(dict):
    ...
    def __init__(__self__, *, dns_resources: Optional[Sequence[outputs.SubResourceResponse]] = ..., target_resource: Optional[outputs.SubResourceResponse] = ...) -> None:
...
class DsRecordResponse(dict):
    ...
    def __init__(__self__, *, algorithm: Optional[_builtins.int] = ..., digest: Optional[outputs.DigestResponse] = ..., key_tag: Optional[_builtins.int] = ...) -> None:
...
class MxRecordResponse(dict):
    ...
    def __init__(__self__, *, exchange: Optional[_builtins.str] = ..., preference: Optional[_builtins.int] = ...) -> None:
...
class NaptrRecordResponse(dict):
    ...
    def __init__(__self__, *, flags: Optional[_builtins.str] = ..., order: Optional[_builtins.int] = ..., preference: Optional[_builtins.int] = ..., regexp: Optional[_builtins.str] = ..., replacement: Optional[_builtins.str] = ..., services: Optional[_builtins.str] = ...) -> None:
...
class SigningKeyResponse(dict):
    ...
    def __init__(__self__, *, delegation_signer_info: Sequence[outputs.DelegationSignerInfoResponse], flags: _builtins.int, key_tag: _builtins.int, protocol: _builtins.int, public_key: _builtins.str, security_algorithm_type: _builtins.int) -> None:
...
class SoaRecordResponse(dict):
    ...
    def __init__(__self__, *, email: Optional[_builtins.str] = ..., expire_time: Optional[_builtins.float] = ..., host: Optional[_builtins.str] = ..., minimum_ttl: Optional[_builtins.float] = ..., refresh_time: Optional[_builtins.float] = ..., retry_time: Optional[_builtins.float] = ..., serial_number: Optional[_builtins.float] = ...) -> None:
...
class SrvRecordResponse(dict):
    ...
    def __init__(__self__, *, port: Optional[_builtins.int] = ..., priority: Optional[_builtins.int] = ..., target: Optional[_builtins.str] = ..., weight: Optional[_builtins.int] = ...) -> None:
...
class TlsaRecordResponse(dict):
    ...
    def __init__(__self__, *, cert_association_data: Optional[_builtins.str] = ..., matching_type: Optional[_builtins.int] = ..., selector: Optional[_builtins.int] = ..., usage: Optional[_builtins.int] = ...) -> None:
...
class TxtRecordResponse(dict):
    ...
    def __init__(__self__, *, value: Optional[Sequence[_builtins.str]] = ...) -> None:
