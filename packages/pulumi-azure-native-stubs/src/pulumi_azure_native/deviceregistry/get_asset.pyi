...
class GetAssetResult:
    ...
    def __init__(__self__, asset_endpoint_profile_ref=..., attributes=..., azure_api_version=..., datasets=..., default_datasets_configuration=..., default_events_configuration=..., default_topic=..., description=..., discovered_asset_refs=..., display_name=..., documentation_uri=..., enabled=..., events=..., extended_location=..., external_asset_id=..., hardware_revision=..., id=..., location=..., manufacturer=..., manufacturer_uri=..., model=..., name=..., product_code=..., provisioning_state=..., serial_number=..., software_revision=..., status=..., system_data=..., tags=..., type=..., uuid=..., version=...) -> None:
        ...
...
def get_asset(asset_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAssetResult:
    
    ...

def get_asset_output(asset_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAssetResult]:
