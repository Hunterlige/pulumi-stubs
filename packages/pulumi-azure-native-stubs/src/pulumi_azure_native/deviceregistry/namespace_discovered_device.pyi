...
class NamespaceDiscoveredDeviceArgs:
    def __init__(
        ...
        *,
        ...
        endpoints: Optional[pulumi.Input[DiscoveredMessagingEndpointsArgs]] = ...,
    ...
    @endpoints.setter
    def endpoints(
        self, value: Optional[pulumi.Input[DiscoveredMessagingEndpointsArgs]]
    ): ...
    @_builtins.property
...
class NamespaceDiscoveredDevice(pulumi.CustomResource):
    ...
    def endpoints(
        self,
    ) -> pulumi.Output[Optional[outputs.DiscoveredMessagingEndpointsResponse]]: ...
    @_builtins.property
    @pulumi.getter(name="extendedLocation")
