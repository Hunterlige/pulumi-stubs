...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AuthenticationArgs', 'AuthenticationArgsDict', 'BrokerStateStoreDestinationConfigurationArgs', 'BrokerStateStoreDestinationConfigurationArgsDict', 'CertificateAuthorityConfigurationArgs', 'CertificateAuthorityConfigurationArgsDict', 'CertificateConfigurationArgs', 'CertificateConfigurationArgsDict', 'DataPointArgs', 'DataPointArgsDict', 'DatasetBrokerStateStoreDestinationArgs', 'DatasetBrokerStateStoreDestinationArgsDict', 'DatasetMqttDestinationArgs', 'DatasetMqttDestinationArgsDict', 'DatasetStorageDestinationArgs', 'DatasetStorageDestinationArgsDict', 'DatasetArgs', 'DatasetArgsDict', 'DeviceMessagingEndpointArgs', 'DeviceMessagingEndpointArgsDict', 'DeviceRefArgs', 'DeviceRefArgsDict', 'DiscoveredDataPointArgs', 'DiscoveredDataPointArgsDict', 'DiscoveredDatasetArgs', 'DiscoveredDatasetArgsDict', 'DiscoveredEventArgs', 'DiscoveredEventArgsDict', 'DiscoveredInboundEndpointsArgs', 'DiscoveredInboundEndpointsArgsDict', 'DiscoveredMessagingEndpointsArgs', 'DiscoveredMessagingEndpointsArgsDict', 'DiscoveredOutboundEndpointsArgs', 'DiscoveredOutboundEndpointsArgsDict', 'EventMqttDestinationArgs', 'EventMqttDestinationArgsDict', 'EventStorageDestinationArgs', 'EventStorageDestinationArgsDict', 'EventArgs', 'EventArgsDict', 'ExtendedLocationArgs', 'ExtendedLocationArgsDict', 'HostAuthenticationArgs', 'HostAuthenticationArgsDict', 'InboundEndpointsArgs', 'InboundEndpointsArgsDict', 'LeafCertificateConfigurationArgs', 'LeafCertificateConfigurationArgsDict', 'ManagementActionArgs', 'ManagementActionArgsDict', 'ManagementGroupArgs', 'ManagementGroupArgsDict', 'MessagingEndpointsArgs', 'MessagingEndpointsArgsDict', 'MessagingEndpointArgs', 'MessagingEndpointArgsDict', 'MessagingArgs', 'MessagingArgsDict', 'MqttDestinationConfigurationArgs', 'MqttDestinationConfigurationArgsDict', 'NamespaceDatasetDataPointArgs', 'NamespaceDatasetDataPointArgsDict', 'NamespaceDatasetArgs', 'NamespaceDatasetArgsDict', 'NamespaceDiscoveredDatasetDataPointArgs', 'NamespaceDiscoveredDatasetDataPointArgsDict', 'NamespaceDiscoveredDatasetArgs', 'NamespaceDiscoveredDatasetArgsDict', 'NamespaceDiscoveredEventDataPointArgs', 'NamespaceDiscoveredEventDataPointArgsDict', 'NamespaceDiscoveredEventArgs', 'NamespaceDiscoveredEventArgsDict', 'NamespaceDiscoveredManagementActionArgs', 'NamespaceDiscoveredManagementActionArgsDict', 'NamespaceDiscoveredManagementGroupArgs', 'NamespaceDiscoveredManagementGroupArgsDict', 'NamespaceDiscoveredStreamArgs', 'NamespaceDiscoveredStreamArgsDict', 'NamespaceEventDataPointArgs', 'NamespaceEventDataPointArgsDict', 'NamespaceEventArgs', 'NamespaceEventArgsDict', 'NamespaceStreamArgs', 'NamespaceStreamArgsDict', 'OutboundEndpointsArgs', 'OutboundEndpointsArgsDict', 'PolicyPropertiesArgs', 'PolicyPropertiesArgsDict', 'StorageDestinationConfigurationArgs', 'StorageDestinationConfigurationArgsDict', 'StreamMqttDestinationArgs', 'StreamMqttDestinationArgsDict', 'StreamStorageDestinationArgs', 'StreamStorageDestinationArgsDict', 'SystemAssignedServiceIdentityArgs', 'SystemAssignedServiceIdentityArgsDict', 'TopicArgs', 'TopicArgsDict', 'TrustSettingsArgs', 'TrustSettingsArgsDict', 'UsernamePasswordCredentialsArgs', 'UsernamePasswordCredentialsArgsDict', 'X509CredentialsArgs', 'X509CredentialsArgsDict']
...
class AuthenticationArgs:
    def __init__(__self__, *, method: Optional[pulumi.Input[Union[_builtins.str, AuthenticationMethod]]] = ..., username_password_credentials: Optional[pulumi.Input[UsernamePasswordCredentialsArgs]] = ..., x509_credentials: Optional[pulumi.Input[X509CredentialsArgs]] = ...) -> None:
    ...
    @method.setter
    def method(self, value: pulumi.Input[Union[_builtins.str, AuthenticationMethod]]): # -> None:
        ...
    ...
    def username_password_credentials(self, value: Optional[pulumi.Input[UsernamePasswordCredentialsArgs]]): # -> None:
        ...
    ...
    def x509_credentials(self, value: Optional[pulumi.Input[X509CredentialsArgs]]): # -> None:
        ...
...
class CertificateAuthorityConfigurationArgs:
    def __init__(__self__, *, key_type: pulumi.Input[Union[_builtins.str, SupportedKeyType]]) -> None:
    ...
    @key_type.setter
    def key_type(self, value: pulumi.Input[Union[_builtins.str, SupportedKeyType]]): # -> None:
        ...
...
class CertificateConfigurationArgs:
    def __init__(__self__, *, certificate_authority_configuration: pulumi.Input[CertificateAuthorityConfigurationArgs], leaf_certificate_configuration: pulumi.Input[LeafCertificateConfigurationArgs]) -> None:
    ...
    def certificate_authority_configuration(self, value: pulumi.Input[CertificateAuthorityConfigurationArgs]): # -> None:
        ...
    ...
    def leaf_certificate_configuration(self, value: pulumi.Input[LeafCertificateConfigurationArgs]): # -> None:
        ...
...
@pulumi.input_type
class DataPointArgs:
    def __init__(__self__, *, data_source: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], data_point_configuration: Optional[pulumi.Input[_builtins.str]] = ..., observability_mode: Optional[pulumi.Input[Union[_builtins.str, DataPointObservabilityMode]]] = ...) -> None:
    ...
    def data_point_configuration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def observability_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, DataPointObservabilityMode]]]): # -> None:
        ...
...
class DatasetBrokerStateStoreDestinationArgs:
    def __init__(__self__, *, configuration: pulumi.Input[BrokerStateStoreDestinationConfigurationArgs], target: pulumi.Input[_builtins.str]) -> None:
    ...
    def configuration(self, value: pulumi.Input[BrokerStateStoreDestinationConfigurationArgs]): # -> None:
        ...
...
class DatasetMqttDestinationArgs:
    def __init__(__self__, *, configuration: pulumi.Input[MqttDestinationConfigurationArgs], target: pulumi.Input[_builtins.str]) -> None:
    ...
    @configuration.setter
    def configuration(self, value: pulumi.Input[MqttDestinationConfigurationArgs]): # -> None:
        ...
...
class DatasetStorageDestinationArgs:
    def __init__(__self__, *, configuration: pulumi.Input[StorageDestinationConfigurationArgs], target: pulumi.Input[_builtins.str]) -> None:
    ...
    @configuration.setter
    def configuration(self, value: pulumi.Input[StorageDestinationConfigurationArgs]): # -> None:
        ...
...
@pulumi.input_type
class DatasetArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], data_points: Optional[pulumi.Input[Sequence[pulumi.Input[DataPointArgs]]]] = ..., dataset_configuration: Optional[pulumi.Input[_builtins.str]] = ..., topic: Optional[pulumi.Input[TopicArgs]] = ...) -> None:
    ...
    @data_points.setter
    def data_points(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataPointArgs]]]]): # -> None:
        ...
    ...
    def dataset_configuration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @topic.setter
    def topic(self, value: Optional[pulumi.Input[TopicArgs]]): # -> None:
        ...
...
class DeviceMessagingEndpointArgs:
    def __init__(__self__, *, address: pulumi.Input[_builtins.str], endpoint_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class DeviceRefArgs:
    def __init__(__self__, *, device_name: pulumi.Input[_builtins.str], endpoint_name: pulumi.Input[_builtins.str]) -> None:
...
class DiscoveredDataPointArgs:
    def __init__(__self__, *, data_source: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], data_point_configuration: Optional[pulumi.Input[_builtins.str]] = ..., last_updated_on: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def last_updated_on(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DiscoveredDatasetArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], data_points: Optional[pulumi.Input[Sequence[pulumi.Input[DiscoveredDataPointArgs]]]] = ..., dataset_configuration: Optional[pulumi.Input[_builtins.str]] = ..., topic: Optional[pulumi.Input[TopicArgs]] = ...) -> None:
    ...
    @data_points.setter
    def data_points(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DiscoveredDataPointArgs]]]]): # -> None:
        ...
...
class DiscoveredEventArgs:
    def __init__(__self__, *, event_notifier: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], event_configuration: Optional[pulumi.Input[_builtins.str]] = ..., last_updated_on: Optional[pulumi.Input[_builtins.str]] = ..., topic: Optional[pulumi.Input[TopicArgs]] = ...) -> None:
    ...
    def event_notifier(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def event_configuration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DiscoveredInboundEndpointsArgs:
    def __init__(__self__, *, address: pulumi.Input[_builtins.str], endpoint_type: pulumi.Input[_builtins.str], additional_configuration: Optional[pulumi.Input[_builtins.str]] = ..., last_updated_on: Optional[pulumi.Input[_builtins.str]] = ..., supported_authentication_methods: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AuthenticationMethod]]]]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DiscoveredMessagingEndpointsArgs:
    def __init__(__self__, *, inbound: Optional[pulumi.Input[Mapping[str, pulumi.Input[DiscoveredInboundEndpointsArgs]]]] = ..., outbound: Optional[pulumi.Input[DiscoveredOutboundEndpointsArgs]] = ...) -> None:
    ...
    @inbound.setter
    def inbound(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[DiscoveredInboundEndpointsArgs]]]]): # -> None:
        ...
    ...
    @outbound.setter
    def outbound(self, value: Optional[pulumi.Input[DiscoveredOutboundEndpointsArgs]]): # -> None:
        ...
...
class DiscoveredOutboundEndpointsArgs:
    def __init__(__self__, *, assigned: pulumi.Input[Mapping[str, pulumi.Input[DeviceMessagingEndpointArgs]]]) -> None:
    ...
    @assigned.setter
    def assigned(self, value: pulumi.Input[Mapping[str, pulumi.Input[DeviceMessagingEndpointArgs]]]): # -> None:
        ...
...
@pulumi.input_type
class EventArgs:
    def __init__(__self__, *, event_notifier: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], event_configuration: Optional[pulumi.Input[_builtins.str]] = ..., observability_mode: Optional[pulumi.Input[Union[_builtins.str, EventObservabilityMode]]] = ..., topic: Optional[pulumi.Input[TopicArgs]] = ...) -> None:
    ...
    @observability_mode.setter
    def observability_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, EventObservabilityMode]]]): # -> None:
        ...
...
class InboundEndpointsArgs:
    def __init__(__self__, *, address: pulumi.Input[_builtins.str], endpoint_type: pulumi.Input[_builtins.str], additional_configuration: Optional[pulumi.Input[_builtins.str]] = ..., authentication: Optional[pulumi.Input[HostAuthenticationArgs]] = ..., trust_settings: Optional[pulumi.Input[TrustSettingsArgs]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authentication(self, value: Optional[pulumi.Input[HostAuthenticationArgs]]): # -> None:
        ...
    ...
    def trust_settings(self, value: Optional[pulumi.Input[TrustSettingsArgs]]): # -> None:
        ...
...
class LeafCertificateConfigurationArgs:
    def __init__(__self__, *, validity_period_in_days: pulumi.Input[_builtins.int]) -> None:
    ...
    def validity_period_in_days(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ManagementActionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], target_uri: pulumi.Input[_builtins.str], action_configuration: Optional[pulumi.Input[_builtins.str]] = ..., action_type: Optional[pulumi.Input[Union[_builtins.str, ManagementActionType]]] = ..., timeout_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., topic: Optional[pulumi.Input[_builtins.str]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def action_configuration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @action_type.setter
    def action_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ManagementActionType]]]): # -> None:
        ...
    ...
    @type_ref.setter
    def type_ref(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ManagementGroupArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], actions: Optional[pulumi.Input[Sequence[pulumi.Input[ManagementActionArgs]]]] = ..., default_timeout_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., default_topic: Optional[pulumi.Input[_builtins.str]] = ..., management_group_configuration: Optional[pulumi.Input[_builtins.str]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @actions.setter
    def actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ManagementActionArgs]]]]): # -> None:
        ...
    ...
    def default_timeout_in_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def default_topic(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def management_group_configuration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MessagingEndpointsArgs:
    def __init__(__self__, *, inbound: Optional[pulumi.Input[Mapping[str, pulumi.Input[InboundEndpointsArgs]]]] = ..., outbound: Optional[pulumi.Input[OutboundEndpointsArgs]] = ...) -> None:
    ...
    @inbound.setter
    def inbound(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[InboundEndpointsArgs]]]]): # -> None:
        ...
    ...
    @outbound.setter
    def outbound(self, value: Optional[pulumi.Input[OutboundEndpointsArgs]]): # -> None:
        ...
...
class MessagingEndpointArgs:
    def __init__(__self__, *, address: pulumi.Input[_builtins.str], endpoint_type: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class MessagingArgs:
    def __init__(__self__, *, endpoints: Optional[pulumi.Input[Mapping[str, pulumi.Input[MessagingEndpointArgs]]]] = ...) -> None:
    ...
    @endpoints.setter
    def endpoints(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[MessagingEndpointArgs]]]]): # -> None:
        ...
...
class MqttDestinationConfigurationArgs:
    def __init__(__self__, *, topic: pulumi.Input[_builtins.str], qos: Optional[pulumi.Input[Union[_builtins.str, MqttDestinationQos]]] = ..., retain: Optional[pulumi.Input[Union[_builtins.str, TopicRetainType]]] = ..., ttl: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @qos.setter
    def qos(self, value: Optional[pulumi.Input[Union[_builtins.str, MqttDestinationQos]]]): # -> None:
        ...
    ...
    @retain.setter
    def retain(self, value: Optional[pulumi.Input[Union[_builtins.str, TopicRetainType]]]): # -> None:
        ...
    ...
    @ttl.setter
    def ttl(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class NamespaceDatasetDataPointArgs:
    def __init__(__self__, *, data_source: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], data_point_configuration: Optional[pulumi.Input[_builtins.str]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NamespaceDatasetArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], data_points: Optional[pulumi.Input[Sequence[pulumi.Input[NamespaceDatasetDataPointArgs]]]] = ..., data_source: Optional[pulumi.Input[_builtins.str]] = ..., dataset_configuration: Optional[pulumi.Input[_builtins.str]] = ..., destinations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DatasetBrokerStateStoreDestinationArgs, DatasetMqttDestinationArgs, DatasetStorageDestinationArgs]]]]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_points.setter
    def data_points(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NamespaceDatasetDataPointArgs]]]]): # -> None:
        ...
    ...
    @destinations.setter
    def destinations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DatasetBrokerStateStoreDestinationArgs, DatasetMqttDestinationArgs, DatasetStorageDestinationArgs]]]]]): # -> None:
        ...
...
class NamespaceDiscoveredDatasetDataPointArgs:
    def __init__(__self__, *, data_source: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], data_point_configuration: Optional[pulumi.Input[_builtins.str]] = ..., last_updated_on: Optional[pulumi.Input[_builtins.str]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NamespaceDiscoveredDatasetArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], data_points: Optional[pulumi.Input[Sequence[pulumi.Input[NamespaceDiscoveredDatasetDataPointArgs]]]] = ..., data_source: Optional[pulumi.Input[_builtins.str]] = ..., dataset_configuration: Optional[pulumi.Input[_builtins.str]] = ..., destinations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DatasetBrokerStateStoreDestinationArgs, DatasetMqttDestinationArgs, DatasetStorageDestinationArgs]]]]] = ..., last_updated_on: Optional[pulumi.Input[_builtins.str]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_points.setter
    def data_points(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NamespaceDiscoveredDatasetDataPointArgs]]]]): # -> None:
        ...
...
class NamespaceDiscoveredEventArgs:
    def __init__(__self__, *, event_notifier: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], data_points: Optional[pulumi.Input[Sequence[pulumi.Input[NamespaceDiscoveredEventDataPointArgs]]]] = ..., destinations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[EventMqttDestinationArgs, EventStorageDestinationArgs]]]]] = ..., event_configuration: Optional[pulumi.Input[_builtins.str]] = ..., last_updated_on: Optional[pulumi.Input[_builtins.str]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_points.setter
    def data_points(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NamespaceDiscoveredEventDataPointArgs]]]]): # -> None:
        ...
    ...
    @destinations.setter
    def destinations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[EventMqttDestinationArgs, EventStorageDestinationArgs]]]]]): # -> None:
        ...
...
class NamespaceDiscoveredManagementActionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], target_uri: pulumi.Input[_builtins.str], action_configuration: Optional[pulumi.Input[_builtins.str]] = ..., action_type: Optional[pulumi.Input[Union[_builtins.str, NamespaceDiscoveredManagementActionType]]] = ..., last_updated_on: Optional[pulumi.Input[_builtins.str]] = ..., timeout_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., topic: Optional[pulumi.Input[_builtins.str]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @action_type.setter
    def action_type(self, value: Optional[pulumi.Input[Union[_builtins.str, NamespaceDiscoveredManagementActionType]]]): # -> None:
        ...
...
class NamespaceDiscoveredManagementGroupArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], actions: Optional[pulumi.Input[Sequence[pulumi.Input[NamespaceDiscoveredManagementActionArgs]]]] = ..., default_timeout_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., default_topic: Optional[pulumi.Input[_builtins.str]] = ..., last_updated_on: Optional[pulumi.Input[_builtins.str]] = ..., management_group_configuration: Optional[pulumi.Input[_builtins.str]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @actions.setter
    def actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NamespaceDiscoveredManagementActionArgs]]]]): # -> None:
        ...
...
class NamespaceDiscoveredStreamArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], destinations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[StreamMqttDestinationArgs, StreamStorageDestinationArgs]]]]] = ..., last_updated_on: Optional[pulumi.Input[_builtins.str]] = ..., stream_configuration: Optional[pulumi.Input[_builtins.str]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @destinations.setter
    def destinations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[StreamMqttDestinationArgs, StreamStorageDestinationArgs]]]]]): # -> None:
        ...
    ...
    def stream_configuration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NamespaceEventDataPointArgs:
    def __init__(__self__, *, data_source: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], data_point_configuration: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NamespaceEventArgs:
    def __init__(__self__, *, event_notifier: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], data_points: Optional[pulumi.Input[Sequence[pulumi.Input[NamespaceEventDataPointArgs]]]] = ..., destinations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[EventMqttDestinationArgs, EventStorageDestinationArgs]]]]] = ..., event_configuration: Optional[pulumi.Input[_builtins.str]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_points.setter
    def data_points(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NamespaceEventDataPointArgs]]]]): # -> None:
        ...
...
class NamespaceStreamArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], destinations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[StreamMqttDestinationArgs, StreamStorageDestinationArgs]]]]] = ..., stream_configuration: Optional[pulumi.Input[_builtins.str]] = ..., type_ref: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class OutboundEndpointsArgs:
    def __init__(__self__, *, assigned: pulumi.Input[Mapping[str, pulumi.Input[DeviceMessagingEndpointArgs]]], unassigned: Optional[pulumi.Input[Mapping[str, pulumi.Input[DeviceMessagingEndpointArgs]]]] = ...) -> None:
    ...
    @unassigned.setter
    def unassigned(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[DeviceMessagingEndpointArgs]]]]): # -> None:
        ...
...
class PolicyPropertiesArgs:
    def __init__(__self__, *, certificate: Optional[pulumi.Input[CertificateConfigurationArgs]] = ...) -> None:
    ...
    @certificate.setter
    def certificate(self, value: Optional[pulumi.Input[CertificateConfigurationArgs]]): # -> None:
        ...
...
class SystemAssignedServiceIdentityArgs:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, SystemAssignedServiceIdentityType]]) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, SystemAssignedServiceIdentityType]]): # -> None:
        ...
...
@pulumi.input_type
class TopicArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], retain: Optional[pulumi.Input[Union[_builtins.str, TopicRetainType]]] = ...) -> None:
...
class TrustSettingsArgs:
    def __init__(__self__, *, trust_list: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @trust_list.setter
    def trust_list(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class UsernamePasswordCredentialsArgs:
    def __init__(__self__, *, password_secret_name: pulumi.Input[_builtins.str], username_secret_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def password_secret_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def username_secret_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class X509CredentialsArgs:
    def __init__(__self__, *, certificate_secret_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def certificate_secret_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
