...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CustomLocationPropertiesResponseAuthentication', 'IdentityResponse', 'ResourceSyncRulePropertiesResponseSelector', 'SystemDataResponse']
@pulumi.output_type
...
class ResourceSyncRulePropertiesResponseSelector(dict):
    ...
    def __init__(__self__, *, match_labels: Optional[Mapping[str, _builtins.str]] = ...) -> None:
