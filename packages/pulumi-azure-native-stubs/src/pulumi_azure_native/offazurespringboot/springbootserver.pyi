...
class SpringbootserverArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[SpringbootserversPropertiesArgs]] = ...,
        springbootservers_name: Optional[pulumi.Input[_builtins.str]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[SpringbootserversPropertiesArgs]]
    ): ...
    @_builtins.property
...
class Springbootserver(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    SpringbootserversPropertiesArgs, SpringbootserversPropertiesArgsDict
                ]
            ]
        ] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.SpringbootserversPropertiesResponse]: ...
    @_builtins.property
