...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CertificatePropertiesResponse', 'IotDpsPropertiesDescriptionResponse', 'IotDpsSkuInfoResponse', 'IotHubDefinitionDescriptionResponse', 'IpFilterRuleResponse', 'ManagedServiceIdentityResponse', 'PrivateEndpointConnectionPropertiesResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', ..., 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
...
class IotDpsPropertiesDescriptionResponse(dict):
    ...
    def __init__(__self__, *, device_provisioning_host_name: _builtins.str, id_scope: _builtins.str, service_operations_host_name: _builtins.str, allocation_policy: Optional[_builtins.str] = ..., authorization_policies: Optional[Sequence[outputs.SharedAccessSignatureAuthorizationRuleAccessRightsDescriptionResponse]] = ..., enable_data_residency: Optional[_builtins.bool] = ..., iot_hubs: Optional[Sequence[outputs.IotHubDefinitionDescriptionResponse]] = ..., ip_filter_rules: Optional[Sequence[outputs.IpFilterRuleResponse]] = ..., portal_operations_host_name: Optional[_builtins.str] = ..., private_endpoint_connections: Optional[Sequence[outputs.PrivateEndpointConnectionResponse]] = ..., provisioning_state: Optional[_builtins.str] = ..., public_network_access: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class IotDpsSkuInfoResponse(dict):
    ...
    def __init__(__self__, *, tier: _builtins.str, capacity: Optional[_builtins.float] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class IotHubDefinitionDescriptionResponse(dict):
    ...
    def __init__(__self__, *, connection_string: _builtins.str, location: _builtins.str, name: _builtins.str, allocation_weight: Optional[_builtins.int] = ..., apply_allocation_policy: Optional[_builtins.bool] = ...) -> None:
...
class IpFilterRuleResponse(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, filter_name: _builtins.str, ip_mask: _builtins.str, target: Optional[_builtins.str] = ...) -> None:
...
class PrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, properties: outputs.PrivateEndpointConnectionPropertiesResponse, system_data: outputs.SystemDataResponse, type: _builtins.str) -> None:
