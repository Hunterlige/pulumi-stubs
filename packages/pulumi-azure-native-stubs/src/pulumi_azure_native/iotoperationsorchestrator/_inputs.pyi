...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BindingPropertiesArgs', 'BindingPropertiesArgsDict', 'ComponentPropertiesArgs', 'ComponentPropertiesArgsDict', 'ExtendedLocationArgs', 'ExtendedLocationArgsDict', 'ReconciliationPolicyArgs', 'ReconciliationPolicyArgsDict', 'TargetSelectorPropertiesArgs', 'TargetSelectorPropertiesArgsDict', 'TopologiesPropertiesArgs', 'TopologiesPropertiesArgsDict']
...
class BindingPropertiesArgs:
    def __init__(__self__, *, config: Any, provider: pulumi.Input[_builtins.str], role: pulumi.Input[_builtins.str]) -> None:
...
class ComponentPropertiesArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], dependencies: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., properties: Optional[Any] = ...) -> None:
...
class ReconciliationPolicyArgs:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, ReconciliationPolicies]], interval: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ReconciliationPolicies]]): # -> None:
        ...
...
class TopologiesPropertiesArgs:
    def __init__(__self__, *, bindings: Optional[pulumi.Input[Sequence[pulumi.Input[BindingPropertiesArgs]]]] = ...) -> None:
    ...
    @bindings.setter
    def bindings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BindingPropertiesArgs]]]]): # -> None:
        ...
