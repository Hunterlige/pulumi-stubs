...
class DataflowEndpointArgs:
    def __init__(
        ...
        *,
        ...
        dataflow_endpoint_name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[pulumi.Input[DataflowEndpointPropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[DataflowEndpointPropertiesArgs]]
    ): ...
...
class DataflowEndpoint(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    DataflowEndpointPropertiesArgs, DataflowEndpointPropertiesArgsDict
                ]
            ]
        ] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.DataflowEndpointPropertiesResponse]: ...
    @_builtins.property
