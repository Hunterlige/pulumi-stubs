...
class AkriConnectorTemplateArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[AkriConnectorTemplatePropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def akri_connector_template_name(
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[AkriConnectorTemplatePropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[AkriConnectorTemplatePropertiesArgs]]
    ): ...
...
class AkriConnectorTemplate(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.AkriConnectorTemplatePropertiesResponse]: ...
    @_builtins.property
