...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DatadogOrganizationPropertiesArgs', 'DatadogOrganizationPropertiesArgsDict', 'FilteringTagArgs', 'FilteringTagArgsDict', 'IdentityPropertiesArgs', 'IdentityPropertiesArgsDict', 'LogRulesArgs', 'LogRulesArgsDict', 'MetricRulesArgs', 'MetricRulesArgsDict', 'MonitorPropertiesArgs', 'MonitorPropertiesArgsDict', 'MonitoredSubscriptionArgs', 'MonitoredSubscriptionArgsDict', 'MonitoringTagRulesPropertiesArgs', 'MonitoringTagRulesPropertiesArgsDict', 'ResourceSkuArgs', 'ResourceSkuArgsDict', 'SubscriptionListArgs', 'SubscriptionListArgsDict', 'UserInfoArgs', 'UserInfoArgsDict']
...
class DatadogOrganizationPropertiesArgs:
    def __init__(__self__, *, api_key: Optional[pulumi.Input[_builtins.str]] = ..., application_key: Optional[pulumi.Input[_builtins.str]] = ..., cspm: Optional[pulumi.Input[_builtins.bool]] = ..., enterprise_app_id: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., linking_auth_code: Optional[pulumi.Input[_builtins.str]] = ..., linking_client_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., redirect_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def application_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @cspm.setter
    def cspm(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def linking_auth_code(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def linking_client_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class LogRulesArgs:
    def __init__(__self__, *, filtering_tags: Optional[pulumi.Input[Sequence[pulumi.Input[FilteringTagArgs]]]] = ..., send_aad_logs: Optional[pulumi.Input[_builtins.bool]] = ..., send_resource_logs: Optional[pulumi.Input[_builtins.bool]] = ..., send_subscription_logs: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def send_resource_logs(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class MetricRulesArgs:
    def __init__(__self__, *, filtering_tags: Optional[pulumi.Input[Sequence[pulumi.Input[FilteringTagArgs]]]] = ...) -> None:
...
class MonitorPropertiesArgs:
    def __init__(__self__, *, datadog_organization_properties: Optional[pulumi.Input[DatadogOrganizationPropertiesArgs]] = ..., monitoring_status: Optional[pulumi.Input[Union[_builtins.str, MonitoringStatus]]] = ..., user_info: Optional[pulumi.Input[UserInfoArgs]] = ...) -> None:
    ...
    def datadog_organization_properties(self, value: Optional[pulumi.Input[DatadogOrganizationPropertiesArgs]]): # -> None:
        ...
...
class MonitoringTagRulesPropertiesArgs:
    def __init__(__self__, *, automuting: Optional[pulumi.Input[_builtins.bool]] = ..., custom_metrics: Optional[pulumi.Input[_builtins.bool]] = ..., log_rules: Optional[pulumi.Input[LogRulesArgs]] = ..., metric_rules: Optional[pulumi.Input[MetricRulesArgs]] = ...) -> None:
    ...
    @automuting.setter
    def automuting(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def custom_metrics(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @metric_rules.setter
    def metric_rules(self, value: Optional[pulumi.Input[MetricRulesArgs]]): # -> None:
        ...
...
@pulumi.input_type
class UserInfoArgs:
    def __init__(__self__, *, email_address: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., phone_number: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
