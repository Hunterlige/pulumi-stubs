...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DatadogApiKeyResponse', 'DatadogHostMetadataResponse', 'DatadogHostResponse', 'DatadogInstallMethodResponse', 'DatadogLogsAgentResponse', 'DatadogOrganizationPropertiesResponse', 'FilteringTagResponse', 'IdentityPropertiesResponse', 'LinkedResourceResponse', 'LogRulesResponse', 'MarketplaceSaaSInfoResponse', 'MetricRulesResponse', 'MonitorPropertiesResponse', 'MonitoredResourceResponse', 'MonitoredSubscriptionResponse', 'MonitoringTagRulesPropertiesResponse', 'PartnerBillingEntityResponse', 'ResourceSkuResponse', 'SubscriptionListResponse', 'SystemDataResponse', 'UserInfoResponse']
@pulumi.output_type
class DatadogApiKeyResponse(dict):
    def __init__(__self__, *, key: _builtins.str, created: Optional[_builtins.str] = ..., created_by: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class DatadogHostMetadataResponse(dict):
    def __init__(__self__, *, agent_version: Optional[_builtins.str] = ..., install_method: Optional[outputs.DatadogInstallMethodResponse] = ..., logs_agent: Optional[outputs.DatadogLogsAgentResponse] = ...) -> None:
...
class DatadogHostResponse(dict):
    def __init__(__self__, *, aliases: Optional[Sequence[_builtins.str]] = ..., apps: Optional[Sequence[_builtins.str]] = ..., meta: Optional[outputs.DatadogHostMetadataResponse] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class DatadogInstallMethodResponse(dict):
    def __init__(__self__, *, installer_version: Optional[_builtins.str] = ..., tool: Optional[_builtins.str] = ..., tool_version: Optional[_builtins.str] = ...) -> None:
...
class DatadogOrganizationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, cspm: Optional[_builtins.bool] = ..., id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class LinkedResourceResponse(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ...) -> None:
...
class LogRulesResponse(dict):
    ...
    def __init__(__self__, *, filtering_tags: Optional[Sequence[outputs.FilteringTagResponse]] = ..., send_aad_logs: Optional[_builtins.bool] = ..., send_resource_logs: Optional[_builtins.bool] = ..., send_subscription_logs: Optional[_builtins.bool] = ...) -> None:
...
class MarketplaceSaaSInfoResponse(dict):
    ...
    def __init__(__self__, *, billed_azure_subscription_id: Optional[_builtins.str] = ..., marketplace_name: Optional[_builtins.str] = ..., marketplace_status: Optional[_builtins.str] = ..., marketplace_subscription_id: Optional[_builtins.str] = ..., subscribed: Optional[_builtins.bool] = ...) -> None:
...
class MetricRulesResponse(dict):
    ...
    def __init__(__self__, *, filtering_tags: Optional[Sequence[outputs.FilteringTagResponse]] = ...) -> None:
...
class MonitorPropertiesResponse(dict):
    ...
    def __init__(__self__, *, liftr_resource_category: _builtins.str, liftr_resource_preference: _builtins.int, marketplace_subscription_status: _builtins.str, provisioning_state: _builtins.str, datadog_organization_properties: Optional[outputs.DatadogOrganizationPropertiesResponse] = ..., monitoring_status: Optional[_builtins.str] = ..., user_info: Optional[outputs.UserInfoResponse] = ...) -> None:
...
class MonitoredResourceResponse(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., reason_for_logs_status: Optional[_builtins.str] = ..., reason_for_metrics_status: Optional[_builtins.str] = ..., sending_logs: Optional[_builtins.bool] = ..., sending_metrics: Optional[_builtins.bool] = ...) -> None:
...
class MonitoringTagRulesPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, automuting: Optional[_builtins.bool] = ..., custom_metrics: Optional[_builtins.bool] = ..., log_rules: Optional[outputs.LogRulesResponse] = ..., metric_rules: Optional[outputs.MetricRulesResponse] = ...) -> None:
...
class SubscriptionListResponse(dict):
    ...
    def __init__(__self__, *, monitored_subscription_list: Optional[Sequence[outputs.MonitoredSubscriptionResponse]] = ...) -> None:
...
class UserInfoResponse(dict):
    ...
    def __init__(__self__, *, email_address: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., phone_number: Optional[_builtins.str] = ...) -> None:
