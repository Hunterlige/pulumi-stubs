...
class ConfigurationAssignmentParentArgs:
    ...
    def resource_parent_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def resource_parent_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ConfigurationAssignmentParent(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., configuration_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., filter: Optional[pulumi.Input[Union[ConfigurationAssignmentFilterPropertiesArgs, ConfigurationAssignmentFilterPropertiesArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., maintenance_configuration_id: Optional[pulumi.Input[_builtins.str]] = ..., provider_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_name_: Optional[pulumi.Input[_builtins.str]] = ..., resource_parent_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_parent_type: Optional[pulumi.Input[_builtins.str]] = ..., resource_type: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ConfigurationAssignmentParentArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ConfigurationAssignmentParent:
