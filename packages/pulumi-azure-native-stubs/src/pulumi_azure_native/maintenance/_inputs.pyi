...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConfigurationAssignmentFilterPropertiesArgs', 'ConfigurationAssignmentFilterPropertiesArgsDict', 'InputLinuxParametersArgs', 'InputLinuxParametersArgsDict', 'InputPatchConfigurationArgs', 'InputPatchConfigurationArgsDict', 'InputWindowsParametersArgs', 'InputWindowsParametersArgsDict', 'TagSettingsPropertiesArgs', 'TagSettingsPropertiesArgsDict']
...
class ConfigurationAssignmentFilterPropertiesArgs:
    def __init__(__self__, *, locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., os_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., resource_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., resource_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tag_settings: Optional[pulumi.Input[TagSettingsPropertiesArgs]] = ...) -> None:
    ...
    @os_types.setter
    def os_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def resource_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class InputLinuxParametersArgs:
    def __init__(__self__, *, classifications_to_include: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., package_name_masks_to_exclude: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., package_name_masks_to_include: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def classifications_to_include(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def package_name_masks_to_exclude(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def package_name_masks_to_include(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class InputPatchConfigurationArgs:
    def __init__(__self__, *, linux_parameters: Optional[pulumi.Input[InputLinuxParametersArgs]] = ..., reboot_setting: Optional[pulumi.Input[Union[_builtins.str, RebootOptions]]] = ..., windows_parameters: Optional[pulumi.Input[InputWindowsParametersArgs]] = ...) -> None:
    ...
    def linux_parameters(self, value: Optional[pulumi.Input[InputLinuxParametersArgs]]): # -> None:
        ...
    ...
    def reboot_setting(self, value: Optional[pulumi.Input[Union[_builtins.str, RebootOptions]]]): # -> None:
        ...
    ...
    def windows_parameters(self, value: Optional[pulumi.Input[InputWindowsParametersArgs]]): # -> None:
        ...
...
class InputWindowsParametersArgs:
    def __init__(__self__, *, classifications_to_include: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., exclude_kbs_requiring_reboot: Optional[pulumi.Input[_builtins.bool]] = ..., kb_numbers_to_exclude: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., kb_numbers_to_include: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def exclude_kbs_requiring_reboot(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def kb_numbers_to_exclude(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def kb_numbers_to_include(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
