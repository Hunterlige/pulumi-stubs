...
class ConfigurationAssignmentsForResourceGroupArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], configuration_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., filter: Optional[pulumi.Input[ConfigurationAssignmentFilterPropertiesArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., maintenance_configuration_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ConfigurationAssignmentsForResourceGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., configuration_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., filter: Optional[pulumi.Input[Union[ConfigurationAssignmentFilterPropertiesArgs, ConfigurationAssignmentFilterPropertiesArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., maintenance_configuration_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ConfigurationAssignmentsForResourceGroupArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ConfigurationAssignmentsForResourceGroup:
