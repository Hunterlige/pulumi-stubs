...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureMonitorConfigurationResponse', 'AzureMonitorInformationResponse', 'ChangeTrackingConfigurationResponse', 'ChangeTrackingInformationResponse', 'DefenderCspmInformationResponse', 'DefenderForServersInformationResponse', 'DesiredConfigurationResponse', 'GuestConfigurationInformationResponse', 'ManagedOpsPropertiesResponse', 'PolicyAssignmentPropertiesResponse', 'ServiceInformationResponse', 'SkuResponse', 'SystemDataResponse', 'UpdateManagerInformationResponse']
@pulumi.output_type
...
class AzureMonitorInformationResponse(dict):
    ...
    def __init__(__self__, *, dcr_id: _builtins.str, enablement_status: _builtins.str) -> None:
...
class DesiredConfigurationResponse(dict):
    ...
    def __init__(__self__, *, azure_monitor_insights: outputs.AzureMonitorConfigurationResponse, change_tracking_and_inventory: outputs.ChangeTrackingConfigurationResponse, user_assigned_managed_identity_id: _builtins.str, defender_cspm: Optional[_builtins.str] = ..., defender_for_servers: Optional[_builtins.str] = ...) -> None:
...
class ManagedOpsPropertiesResponse(dict):
    ...
    def __init__(__self__, *, desired_configuration: outputs.DesiredConfigurationResponse, policy_assignment_properties: outputs.PolicyAssignmentPropertiesResponse, provisioning_state: _builtins.str, services: outputs.ServiceInformationResponse, sku: outputs.SkuResponse) -> None:
...
class PolicyAssignmentPropertiesResponse(dict):
    ...
    def __init__(__self__, *, policy_initiative_assignment_id: _builtins.str) -> None:
...
class ServiceInformationResponse(dict):
    ...
    def __init__(__self__, *, azure_monitor_insights: outputs.AzureMonitorInformationResponse, azure_policy_and_machine_configuration: outputs.GuestConfigurationInformationResponse, azure_update_manager: outputs.UpdateManagerInformationResponse, change_tracking_and_inventory: outputs.ChangeTrackingInformationResponse, defender_cspm: outputs.DefenderCspmInformationResponse, defender_for_servers: outputs.DefenderForServersInformationResponse) -> None:
