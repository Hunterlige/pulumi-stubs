...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureMonitorConfigurationArgs', 'AzureMonitorConfigurationArgsDict', 'ChangeTrackingConfigurationArgs', 'ChangeTrackingConfigurationArgsDict', 'DesiredConfigurationArgs', 'DesiredConfigurationArgsDict', 'ManagedOpsPropertiesArgs', 'ManagedOpsPropertiesArgsDict']
...
class AzureMonitorConfigurationArgs:
    def __init__(__self__, *, azure_monitor_workspace_id: pulumi.Input[_builtins.str]) -> None:
    ...
    def azure_monitor_workspace_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ChangeTrackingConfigurationArgs:
    def __init__(__self__, *, log_analytics_workspace_id: pulumi.Input[_builtins.str]) -> None:
    ...
    def log_analytics_workspace_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DesiredConfigurationArgs:
    def __init__(__self__, *, azure_monitor_insights: pulumi.Input[AzureMonitorConfigurationArgs], change_tracking_and_inventory: pulumi.Input[ChangeTrackingConfigurationArgs], user_assigned_managed_identity_id: pulumi.Input[_builtins.str], defender_cspm: Optional[pulumi.Input[Union[_builtins.str, DesiredEnablementState]]] = ..., defender_for_servers: Optional[pulumi.Input[Union[_builtins.str, DesiredEnablementState]]] = ...) -> None:
    ...
    def azure_monitor_insights(self, value: pulumi.Input[AzureMonitorConfigurationArgs]): # -> None:
        ...
    ...
    def change_tracking_and_inventory(self, value: pulumi.Input[ChangeTrackingConfigurationArgs]): # -> None:
        ...
    ...
    def user_assigned_managed_identity_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def defender_cspm(self, value: Optional[pulumi.Input[Union[_builtins.str, DesiredEnablementState]]]): # -> None:
        ...
    ...
    def defender_for_servers(self, value: Optional[pulumi.Input[Union[_builtins.str, DesiredEnablementState]]]): # -> None:
        ...
...
class ManagedOpsPropertiesArgs:
    def __init__(__self__, *, desired_configuration: pulumi.Input[DesiredConfigurationArgs]) -> None:
    ...
    def desired_configuration(self, value: pulumi.Input[DesiredConfigurationArgs]): # -> None:
        ...
