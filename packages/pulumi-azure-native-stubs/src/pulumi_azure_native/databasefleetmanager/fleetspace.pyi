...
class FleetspaceArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[FleetspacePropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[FleetspacePropertiesArgs]]): ...
...
class Fleetspace(pulumi.CustomResource):
    ...
    def __init__(
        ...
        fleetspace_name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[
            pulumi.Input[Union[FleetspacePropertiesArgs, FleetspacePropertiesArgsDict]]
        ] = ...,
