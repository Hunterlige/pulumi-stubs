...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DatabaseIdentityArgs', 'DatabaseIdentityArgsDict', 'FirewallRulePropertiesArgs', 'FirewallRulePropertiesArgsDict', 'FleetDatabasePropertiesArgs', 'FleetDatabasePropertiesArgsDict', 'FleetPropertiesArgs', 'FleetPropertiesArgsDict', 'FleetTierPropertiesArgs', 'FleetTierPropertiesArgsDict', 'FleetspacePropertiesArgs', 'FleetspacePropertiesArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'MainPrincipalArgs', 'MainPrincipalArgsDict', 'TransparentDataEncryptionArgs', 'TransparentDataEncryptionArgsDict']
...
class DatabaseIdentityArgs:
    def __init__(__self__, *, client_id: Optional[pulumi.Input[_builtins.str]] = ..., principal_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FirewallRulePropertiesArgs:
    def __init__(__self__, *, end_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., start_ip_address: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FleetDatabasePropertiesArgs:
    def __init__(__self__, *, collation: Optional[pulumi.Input[_builtins.str]] = ..., create_mode: Optional[pulumi.Input[Union[_builtins.str, DatabaseCreateMode]]] = ..., identity: Optional[pulumi.Input[IdentityArgs]] = ..., resource_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., restore_from_time: Optional[pulumi.Input[_builtins.str]] = ..., source_database_name: Optional[pulumi.Input[_builtins.str]] = ..., tier_name: Optional[pulumi.Input[_builtins.str]] = ..., transparent_data_encryption: Optional[pulumi.Input[TransparentDataEncryptionArgs]] = ...) -> None:
    ...
    def restore_from_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def transparent_data_encryption(self, value: Optional[pulumi.Input[TransparentDataEncryptionArgs]]): # -> None:
        ...
...
class FleetTierPropertiesArgs:
    def __init__(__self__, *, capacity: Optional[pulumi.Input[_builtins.int]] = ..., database_capacity_max: Optional[pulumi.Input[_builtins.float]] = ..., database_capacity_min: Optional[pulumi.Input[_builtins.float]] = ..., database_size_gb_max: Optional[pulumi.Input[_builtins.int]] = ..., family: Optional[pulumi.Input[_builtins.str]] = ..., high_availability_replica_count: Optional[pulumi.Input[_builtins.int]] = ..., pool_num_of_databases_max: Optional[pulumi.Input[_builtins.int]] = ..., pooled: Optional[pulumi.Input[_builtins.bool]] = ..., serverless: Optional[pulumi.Input[_builtins.bool]] = ..., service_tier: Optional[pulumi.Input[_builtins.str]] = ..., zone_redundancy: Optional[pulumi.Input[Union[_builtins.str, ZoneRedundancy]]] = ...) -> None:
    ...
    def database_capacity_max(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def database_capacity_min(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def database_size_gb_max(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def pool_num_of_databases_max(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @pooled.setter
    def pooled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @serverless.setter
    def serverless(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @service_tier.setter
    def service_tier(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FleetspacePropertiesArgs:
    def __init__(__self__, *, capacity_max: Optional[pulumi.Input[_builtins.int]] = ..., main_principal: Optional[pulumi.Input[MainPrincipalArgs]] = ...) -> None:
    ...
    @capacity_max.setter
    def capacity_max(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def main_principal(self, value: Optional[pulumi.Input[MainPrincipalArgs]]): # -> None:
        ...
...
@pulumi.input_type
class IdentityArgs:
    def __init__(__self__, *, federated_client_id: Optional[pulumi.Input[_builtins.str]] = ..., identity_type: Optional[pulumi.Input[Union[_builtins.str, IdentityType]]] = ..., user_assigned_identities: Optional[pulumi.Input[Sequence[pulumi.Input[DatabaseIdentityArgs]]]] = ...) -> None:
    ...
    def user_assigned_identities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DatabaseIdentityArgs]]]]): # -> None:
        ...
...
class MainPrincipalArgs:
    def __init__(__self__, *, application_id: Optional[pulumi.Input[_builtins.str]] = ..., login: Optional[pulumi.Input[_builtins.str]] = ..., object_id: Optional[pulumi.Input[_builtins.str]] = ..., principal_type: Optional[pulumi.Input[Union[_builtins.str, PrincipalType]]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TransparentDataEncryptionArgs:
    def __init__(__self__, *, enable_auto_rotation: Optional[pulumi.Input[_builtins.bool]] = ..., key_uri: Optional[pulumi.Input[_builtins.str]] = ..., keys: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def enable_auto_rotation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
