...
class FirewallRuleArgs:
    def __init__(__self__, *, fleet_name: pulumi.Input[_builtins.str], fleetspace_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], firewall_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[FirewallRulePropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[FirewallRulePropertiesArgs]]): # -> None:
        ...
...
class FirewallRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., firewall_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., fleet_name: Optional[pulumi.Input[_builtins.str]] = ..., fleetspace_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[FirewallRulePropertiesArgs, FirewallRulePropertiesArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
