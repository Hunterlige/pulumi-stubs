...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['HealthBotKeyResponse', 'HealthBotPropertiesResponse', 'IdentityResponse', 'KeyVaultPropertiesResponse', 'SkuResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
class HealthBotKeyResponse(dict):
    
    def __init__(__self__, *, key_name: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class HealthBotPropertiesResponse(dict):
    ...
    def __init__(__self__, *, bot_management_portal_link: _builtins.str, provisioning_state: _builtins.str, key_vault_properties: Optional[outputs.KeyVaultPropertiesResponse] = ...) -> None:
...
class KeyVaultPropertiesResponse(dict):
    ...
    def __init__(__self__, *, key_name: _builtins.str, key_vault_uri: _builtins.str, key_version: Optional[_builtins.str] = ..., user_identity: Optional[_builtins.str] = ...) -> None:
