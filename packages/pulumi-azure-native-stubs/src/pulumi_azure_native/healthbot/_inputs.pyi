...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['HealthBotPropertiesArgs', 'HealthBotPropertiesArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'KeyVaultPropertiesArgs', 'KeyVaultPropertiesArgsDict', 'SkuArgs', 'SkuArgsDict']
...
class KeyVaultPropertiesArgs:
    def __init__(__self__, *, key_name: pulumi.Input[_builtins.str], key_vault_uri: pulumi.Input[_builtins.str], key_version: Optional[pulumi.Input[_builtins.str]] = ..., user_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
