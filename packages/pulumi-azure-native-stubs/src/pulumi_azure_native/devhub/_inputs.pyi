...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ACRArgs', 'ACRArgsDict', 'DeploymentPropertiesArgs', 'DeploymentPropertiesArgsDict', 'GitHubWorkflowProfileOidcCredentialsArgs', 'GitHubWorkflowProfileOidcCredentialsArgsDict', 'GitHubWorkflowProfileArgs', 'GitHubWorkflowProfileArgsDict', 'IacTemplateDetailsArgs', 'IacTemplateDetailsArgsDict', 'IacTemplatePropertiesArgs', 'IacTemplatePropertiesArgsDict', 'StagePropertiesArgs', 'StagePropertiesArgsDict', 'WorkflowRunArgs', 'WorkflowRunArgsDict']
...
@pulumi.input_type
class ACRArgs:
    def __init__(__self__, *, acr_registry_name: Optional[pulumi.Input[_builtins.str]] = ..., acr_repository_name: Optional[pulumi.Input[_builtins.str]] = ..., acr_resource_group: Optional[pulumi.Input[_builtins.str]] = ..., acr_subscription_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def acr_registry_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def acr_repository_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def acr_resource_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def acr_subscription_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DeploymentPropertiesArgs:
    def __init__(__self__, *, helm_chart_path: Optional[pulumi.Input[_builtins.str]] = ..., helm_values: Optional[pulumi.Input[_builtins.str]] = ..., kube_manifest_locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., manifest_type: Optional[pulumi.Input[Union[_builtins.str, ManifestType]]] = ..., overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def helm_chart_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @helm_values.setter
    def helm_values(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="kubeManifestLocations")
    def kube_manifest_locations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        ...
    
    @kube_manifest_locations.setter
    def kube_manifest_locations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="manifestType")
    def manifest_type(self) -> Optional[pulumi.Input[Union[_builtins.str, ManifestType]]]:
        
        ...
    
    @manifest_type.setter
    def manifest_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ManifestType]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter
    def overrides(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @overrides.setter
    def overrides(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class GitHubWorkflowProfileOidcCredentialsArgs:
    def __init__(__self__, *, azure_client_id: Optional[pulumi.Input[_builtins.str]] = ..., azure_tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def azure_client_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def azure_tenant_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GitHubWorkflowProfileArgs:
    def __init__(__self__, *, acr: Optional[pulumi.Input[ACRArgs]] = ..., aks_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., branch_name: Optional[pulumi.Input[_builtins.str]] = ..., deployment_properties: Optional[pulumi.Input[DeploymentPropertiesArgs]] = ..., docker_build_context: Optional[pulumi.Input[_builtins.str]] = ..., dockerfile: Optional[pulumi.Input[_builtins.str]] = ..., last_workflow_run: Optional[pulumi.Input[WorkflowRunArgs]] = ..., namespace: Optional[pulumi.Input[_builtins.str]] = ..., oidc_credentials: Optional[pulumi.Input[GitHubWorkflowProfileOidcCredentialsArgs]] = ..., repository_name: Optional[pulumi.Input[_builtins.str]] = ..., repository_owner: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @acr.setter
    def acr(self, value: Optional[pulumi.Input[ACRArgs]]): # -> None:
        ...
    ...
    def aks_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def deployment_properties(self, value: Optional[pulumi.Input[DeploymentPropertiesArgs]]): # -> None:
        ...
    ...
    def docker_build_context(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def last_workflow_run(self, value: Optional[pulumi.Input[WorkflowRunArgs]]): # -> None:
        ...
    ...
    def oidc_credentials(self, value: Optional[pulumi.Input[GitHubWorkflowProfileOidcCredentialsArgs]]): # -> None:
        ...
    ...
    def repository_owner(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IacTemplateDetailsArgs:
    def __init__(__self__, *, count: Optional[pulumi.Input[_builtins.int]] = ..., naming_convention: Optional[pulumi.Input[_builtins.str]] = ..., product_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def naming_convention(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IacTemplatePropertiesArgs:
    def __init__(__self__, *, instance_name: Optional[pulumi.Input[_builtins.str]] = ..., instance_stage: Optional[pulumi.Input[_builtins.str]] = ..., quick_start_template_type: Optional[pulumi.Input[Union[_builtins.str, QuickStartTemplateType]]] = ..., source_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., template_details: Optional[pulumi.Input[Sequence[pulumi.Input[IacTemplateDetailsArgs]]]] = ..., template_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def instance_stage(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="quickStartTemplateType")
    def quick_start_template_type(self) -> Optional[pulumi.Input[Union[_builtins.str, QuickStartTemplateType]]]:
        
        ...
    
    @quick_start_template_type.setter
    def quick_start_template_type(self, value: Optional[pulumi.Input[Union[_builtins.str, QuickStartTemplateType]]]): # -> None:
        ...
    ...
    def template_details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IacTemplateDetailsArgs]]]]): # -> None:
        ...
...
class StagePropertiesArgs:
    def __init__(__self__, *, dependencies: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., git_environment: Optional[pulumi.Input[_builtins.str]] = ..., stage_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def git_environment(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkflowRunArgs:
    def __init__(__self__, *, workflow_run_status: Optional[pulumi.Input[Union[_builtins.str, WorkflowRunStatus]]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="workflowRunStatus")
    def workflow_run_status(self) -> Optional[pulumi.Input[Union[_builtins.str, WorkflowRunStatus]]]:
        
        ...
    
    @workflow_run_status.setter
    def workflow_run_status(self, value: Optional[pulumi.Input[Union[_builtins.str, WorkflowRunStatus]]]): # -> None:
        ...
