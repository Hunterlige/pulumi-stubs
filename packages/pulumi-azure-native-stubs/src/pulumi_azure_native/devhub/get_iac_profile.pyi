...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetIacProfileResult', 'AwaitableGetIacProfileResult', 'get_iac_profile', 'get_iac_profile_output']
@pulumi.output_type
class GetIacProfileResult:
    
    def __init__(__self__, auth_status=..., azure_api_version=..., branch_name=..., etag=..., id=..., location=..., name=..., pr_status=..., pull_number=..., repository_main_branch=..., repository_name=..., repository_owner=..., stages=..., storage_account_name=..., storage_account_resource_group=..., storage_account_subscription=..., storage_container_name=..., system_data=..., tags=..., templates=..., type=...) -> None:
        ...
...
class AwaitableGetIacProfileResult(GetIacProfileResult):
    def __await__(self): # -> Generator[Never, Any, GetIacProfileResult]:
        ...
    


def get_iac_profile(iac_profile_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetIacProfileResult:
    
    ...

def get_iac_profile_output(iac_profile_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetIacProfileResult]:
