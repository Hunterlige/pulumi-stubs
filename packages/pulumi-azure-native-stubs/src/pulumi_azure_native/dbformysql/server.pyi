...
@pulumi.input_type
class ServerArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], administrator_login: Optional[pulumi.Input[_builtins.str]] = ..., administrator_login_password: Optional[pulumi.Input[_builtins.str]] = ..., availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., backup: Optional[pulumi.Input[BackupArgs]] = ..., create_mode: Optional[pulumi.Input[Union[_builtins.str, CreateMode]]] = ..., data_encryption: Optional[pulumi.Input[DataEncryptionArgs]] = ..., high_availability: Optional[pulumi.Input[HighAvailabilityArgs]] = ..., identity: Optional[pulumi.Input[MySQLServerIdentityArgs]] = ..., import_source_properties: Optional[pulumi.Input[ImportSourcePropertiesArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., maintenance_window: Optional[pulumi.Input[MaintenanceWindowArgs]] = ..., network: Optional[pulumi.Input[NetworkArgs]] = ..., replication_role: Optional[pulumi.Input[Union[_builtins.str, ReplicationRole]]] = ..., restore_point_in_time: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[MySQLServerSkuArgs]] = ..., source_server_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., storage: Optional[pulumi.Input[StorageArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., version: Optional[pulumi.Input[Union[_builtins.str, ServerVersion]]] = ...) -> None:
    ...
    @identity.setter
    def identity(self, value: Optional[pulumi.Input[MySQLServerIdentityArgs]]): # -> None:
        ...
    ...
    def import_source_properties(self, value: Optional[pulumi.Input[ImportSourcePropertiesArgs]]): # -> None:
        ...
    ...
    @sku.setter
    def sku(self, value: Optional[pulumi.Input[MySQLServerSkuArgs]]): # -> None:
        ...
...
class Server(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., administrator_login: Optional[pulumi.Input[_builtins.str]] = ..., administrator_login_password: Optional[pulumi.Input[_builtins.str]] = ..., availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., backup: Optional[pulumi.Input[Union[BackupArgs, BackupArgsDict]]] = ..., create_mode: Optional[pulumi.Input[Union[_builtins.str, CreateMode]]] = ..., data_encryption: Optional[pulumi.Input[Union[DataEncryptionArgs, DataEncryptionArgsDict]]] = ..., high_availability: Optional[pulumi.Input[Union[HighAvailabilityArgs, HighAvailabilityArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[MySQLServerIdentityArgs, MySQLServerIdentityArgsDict]]] = ..., import_source_properties: Optional[pulumi.Input[Union[ImportSourcePropertiesArgs, ImportSourcePropertiesArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., maintenance_window: Optional[pulumi.Input[Union[MaintenanceWindowArgs, MaintenanceWindowArgsDict]]] = ..., network: Optional[pulumi.Input[Union[NetworkArgs, NetworkArgsDict]]] = ..., replication_role: Optional[pulumi.Input[Union[_builtins.str, ReplicationRole]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., restore_point_in_time: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[MySQLServerSkuArgs, MySQLServerSkuArgsDict]]] = ..., source_server_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., storage: Optional[pulumi.Input[Union[StorageArgs, StorageArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., version: Optional[pulumi.Input[Union[_builtins.str, ServerVersion]]] = ..., __props__=...) -> None:
