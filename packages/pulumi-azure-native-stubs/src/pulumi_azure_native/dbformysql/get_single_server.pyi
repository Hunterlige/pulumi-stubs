...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetSingleServerResult', 'AwaitableGetSingleServerResult', 'get_single_server', 'get_single_server_output']
@pulumi.output_type
class GetSingleServerResult:
    
    def __init__(__self__, administrator_login=..., azure_api_version=..., byok_enforcement=..., earliest_restore_date=..., fully_qualified_domain_name=..., id=..., identity=..., infrastructure_encryption=..., location=..., master_server_id=..., minimal_tls_version=..., name=..., private_endpoint_connections=..., public_network_access=..., replica_capacity=..., replication_role=..., sku=..., ssl_enforcement=..., storage_profile=..., tags=..., type=..., user_visible_state=..., version=...) -> None:
        ...
...
class AwaitableGetSingleServerResult(GetSingleServerResult):
    def __await__(self): # -> Generator[Never, Any, GetSingleServerResult]:
        ...
    


def get_single_server(resource_group_name: Optional[_builtins.str] = ..., server_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetSingleServerResult:
    
    ...

def get_single_server_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetSingleServerResult]:
