...
class ConfigurationArgs:
    def __init__(
        ...
        *,
        ...
        current_value: Optional[pulumi.Input[_builtins.str]] = ...,
        source: Optional[pulumi.Input[Union[_builtins.str, ConfigurationSource]]] = ...,
    ...
    def source(
        self,
    ) -> Optional[pulumi.Input[Union[_builtins.str, ConfigurationSource]]]: ...
    @source.setter
    def source(
        self, value: Optional[pulumi.Input[Union[_builtins.str, ConfigurationSource]]]
    ): ...
    @_builtins.property
    @pulumi.getter
