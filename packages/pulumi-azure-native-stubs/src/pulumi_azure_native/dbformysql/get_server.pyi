...
class GetServerResult:
    ...
    def __init__(__self__, administrator_login=..., availability_zone=..., azure_api_version=..., backup=..., data_encryption=..., fully_qualified_domain_name=..., high_availability=..., id=..., identity=..., import_source_properties=..., location=..., maintenance_window=..., name=..., network=..., private_endpoint_connections=..., replica_capacity=..., replication_role=..., sku=..., source_server_resource_id=..., state=..., storage=..., system_data=..., tags=..., type=..., version=...) -> None:
        ...
