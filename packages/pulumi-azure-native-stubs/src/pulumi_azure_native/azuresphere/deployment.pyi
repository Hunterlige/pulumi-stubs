...
class DeploymentArgs:
    def __init__(__self__, *, catalog_name: pulumi.Input[_builtins.str], device_group_name: pulumi.Input[_builtins.str], product_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], deployed_images: Optional[pulumi.Input[Sequence[pulumi.Input[ImageArgs]]]] = ..., deployment_id: Optional[pulumi.Input[_builtins.str]] = ..., deployment_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def deployed_images(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ImageArgs]]]]): # -> None:
        ...
...
class Deployment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., catalog_name: Optional[pulumi.Input[_builtins.str]] = ..., deployed_images: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ImageArgs, ImageArgsDict]]]]] = ..., deployment_id: Optional[pulumi.Input[_builtins.str]] = ..., deployment_name: Optional[pulumi.Input[_builtins.str]] = ..., device_group_name: Optional[pulumi.Input[_builtins.str]] = ..., product_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
