...
@pulumi.input_type
class ImageArgs:
    def __init__(__self__, *, image: Optional[pulumi.Input[_builtins.str]] = ..., image_id: Optional[pulumi.Input[_builtins.str]] = ..., regional_data_boundary: Optional[pulumi.Input[Union[_builtins.str, RegionalDataBoundary]]] = ...) -> None:
