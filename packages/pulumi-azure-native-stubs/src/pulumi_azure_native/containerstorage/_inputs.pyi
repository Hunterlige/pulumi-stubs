...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AssignmentArgs', 'AssignmentArgsDict', 'AzureDiskArgs', 'AzureDiskArgsDict', 'DiskArgs', 'DiskArgsDict', 'ElasticSanArgs', 'ElasticSanArgsDict', 'EncryptionArgs', 'EncryptionArgsDict', 'EphemeralDiskArgs', 'EphemeralDiskArgsDict', 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'PoolTypeArgs', 'PoolTypeArgsDict', 'RequestsArgs', 'RequestsArgsDict', 'ResourcesArgs', 'ResourcesArgsDict']
...
@pulumi.input_type
class AzureDiskArgs:
    def __init__(__self__, *, disks: Optional[pulumi.Input[Sequence[pulumi.Input[DiskArgs]]]] = ..., encryption: Optional[pulumi.Input[EncryptionArgs]] = ..., sku_name: Optional[pulumi.Input[Union[_builtins.str, AzureDiskSkuName]]] = ...) -> None:
    ...
    @disks.setter
    def disks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DiskArgs]]]]): # -> None:
        ...
    ...
    @sku_name.setter
    def sku_name(self, value: Optional[pulumi.Input[Union[_builtins.str, AzureDiskSkuName]]]): # -> None:
        ...
...
@pulumi.input_type
class DiskArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], reference: pulumi.Input[_builtins.str]) -> None:
    ...
    @reference.setter
    def reference(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ElasticSanArgs:
    def __init__(__self__, *, encryption: Optional[pulumi.Input[EncryptionArgs]] = ..., sku_name: Optional[pulumi.Input[Union[_builtins.str, ElasticSanSkuName]]] = ...) -> None:
    ...
    @sku_name.setter
    def sku_name(self, value: Optional[pulumi.Input[Union[_builtins.str, ElasticSanSkuName]]]): # -> None:
        ...
...
class EncryptionArgs:
    def __init__(__self__, *, key_name: pulumi.Input[_builtins.str], key_vault_uri: pulumi.Input[_builtins.str], identity: Optional[pulumi.Input[ManagedServiceIdentityArgs]] = ...) -> None:
...
class EphemeralDiskArgs:
    def __init__(__self__, *, disks: Optional[pulumi.Input[Sequence[pulumi.Input[DiskArgs]]]] = ..., replicas: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
...
@pulumi.input_type
class PoolTypeArgs:
    def __init__(__self__, *, azure_disk: Optional[pulumi.Input[AzureDiskArgs]] = ..., elastic_san: Optional[pulumi.Input[ElasticSanArgs]] = ..., ephemeral_disk: Optional[pulumi.Input[EphemeralDiskArgs]] = ...) -> None:
    ...
    @azure_disk.setter
    def azure_disk(self, value: Optional[pulumi.Input[AzureDiskArgs]]): # -> None:
        ...
    ...
    @elastic_san.setter
    def elastic_san(self, value: Optional[pulumi.Input[ElasticSanArgs]]): # -> None:
        ...
    ...
    def ephemeral_disk(self, value: Optional[pulumi.Input[EphemeralDiskArgs]]): # -> None:
        ...
...
@pulumi.input_type
class RequestsArgs:
    def __init__(__self__, *, storage: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @storage.setter
    def storage(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
@pulumi.input_type
class ResourcesArgs:
    def __init__(__self__, *, requests: Optional[pulumi.Input[RequestsArgs]] = ...) -> None:
    ...
    @requests.setter
    def requests(self, value: Optional[pulumi.Input[RequestsArgs]]): # -> None:
        ...
