...
class SubscriptionArgs:
    def __init__(__self__, *, namespace_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], topic_name: pulumi.Input[_builtins.str], auto_delete_on_idle: Optional[pulumi.Input[_builtins.str]] = ..., client_affine_properties: Optional[pulumi.Input[SBClientAffinePropertiesArgs]] = ..., dead_lettering_on_filter_evaluation_exceptions: Optional[pulumi.Input[_builtins.bool]] = ..., dead_lettering_on_message_expiration: Optional[pulumi.Input[_builtins.bool]] = ..., default_message_time_to_live: Optional[pulumi.Input[_builtins.str]] = ..., duplicate_detection_history_time_window: Optional[pulumi.Input[_builtins.str]] = ..., enable_batched_operations: Optional[pulumi.Input[_builtins.bool]] = ..., forward_dead_lettered_messages_to: Optional[pulumi.Input[_builtins.str]] = ..., forward_to: Optional[pulumi.Input[_builtins.str]] = ..., is_client_affine: Optional[pulumi.Input[_builtins.bool]] = ..., lock_duration: Optional[pulumi.Input[_builtins.str]] = ..., max_delivery_count: Optional[pulumi.Input[_builtins.int]] = ..., requires_session: Optional[pulumi.Input[_builtins.bool]] = ..., status: Optional[pulumi.Input[EntityStatus]] = ..., subscription_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def client_affine_properties(self, value: Optional[pulumi.Input[SBClientAffinePropertiesArgs]]): # -> None:
        ...
    ...
    def dead_lettering_on_filter_evaluation_exceptions(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_client_affine(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class Subscription(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., auto_delete_on_idle: Optional[pulumi.Input[_builtins.str]] = ..., client_affine_properties: Optional[pulumi.Input[Union[SBClientAffinePropertiesArgs, SBClientAffinePropertiesArgsDict]]] = ..., dead_lettering_on_filter_evaluation_exceptions: Optional[pulumi.Input[_builtins.bool]] = ..., dead_lettering_on_message_expiration: Optional[pulumi.Input[_builtins.bool]] = ..., default_message_time_to_live: Optional[pulumi.Input[_builtins.str]] = ..., duplicate_detection_history_time_window: Optional[pulumi.Input[_builtins.str]] = ..., enable_batched_operations: Optional[pulumi.Input[_builtins.bool]] = ..., forward_dead_lettered_messages_to: Optional[pulumi.Input[_builtins.str]] = ..., forward_to: Optional[pulumi.Input[_builtins.str]] = ..., is_client_affine: Optional[pulumi.Input[_builtins.bool]] = ..., lock_duration: Optional[pulumi.Input[_builtins.str]] = ..., max_delivery_count: Optional[pulumi.Input[_builtins.int]] = ..., namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., requires_session: Optional[pulumi.Input[_builtins.bool]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[EntityStatus]] = ..., subscription_name: Optional[pulumi.Input[_builtins.str]] = ..., topic_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Subscription:
