...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ActionArgs', 'ActionArgsDict', 'ConnectionStateArgs', 'ConnectionStateArgsDict', 'CorrelationFilterArgs', 'CorrelationFilterArgsDict', 'EncryptionArgs', 'EncryptionArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'KeyVaultPropertiesArgs', 'KeyVaultPropertiesArgsDict', 'NWRuleSetIpRulesArgs', 'NWRuleSetIpRulesArgsDict', 'NWRuleSetVirtualNetworkRulesArgs', 'NWRuleSetVirtualNetworkRulesArgsDict', 'PrivateEndpointConnectionArgs', 'PrivateEndpointConnectionArgsDict', 'PrivateEndpointArgs', 'PrivateEndpointArgsDict', 'SBClientAffinePropertiesArgs', 'SBClientAffinePropertiesArgsDict', 'SBSkuArgs', 'SBSkuArgsDict', 'SqlFilterArgs', 'SqlFilterArgsDict', 'SubnetArgs', 'SubnetArgsDict', 'UserAssignedIdentityPropertiesArgs', 'UserAssignedIdentityPropertiesArgsDict']
...
@pulumi.input_type
class ActionArgs:
    def __init__(__self__, *, compatibility_level: Optional[pulumi.Input[_builtins.int]] = ..., requires_preprocessing: Optional[pulumi.Input[_builtins.bool]] = ..., sql_expression: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def requires_preprocessing(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def sql_expression(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CorrelationFilterArgs:
    def __init__(__self__, *, content_type: Optional[pulumi.Input[_builtins.str]] = ..., correlation_id: Optional[pulumi.Input[_builtins.str]] = ..., label: Optional[pulumi.Input[_builtins.str]] = ..., message_id: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., reply_to: Optional[pulumi.Input[_builtins.str]] = ..., reply_to_session_id: Optional[pulumi.Input[_builtins.str]] = ..., requires_preprocessing: Optional[pulumi.Input[_builtins.bool]] = ..., session_id: Optional[pulumi.Input[_builtins.str]] = ..., to: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SBClientAffinePropertiesArgs:
    def __init__(__self__, *, client_id: Optional[pulumi.Input[_builtins.str]] = ..., is_durable: Optional[pulumi.Input[_builtins.bool]] = ..., is_shared: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @is_durable.setter
    def is_durable(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @is_shared.setter
    def is_shared(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
@pulumi.input_type
class SBSkuArgs:
    def __init__(__self__, *, name: pulumi.Input[SkuName], capacity: Optional[pulumi.Input[_builtins.int]] = ..., tier: Optional[pulumi.Input[SkuTier]] = ...) -> None:
