...
class GetSubscriptionResult:
    ...
    def __init__(__self__, accessed_at=..., auto_delete_on_idle=..., azure_api_version=..., client_affine_properties=..., count_details=..., created_at=..., dead_lettering_on_filter_evaluation_exceptions=..., dead_lettering_on_message_expiration=..., default_message_time_to_live=..., duplicate_detection_history_time_window=..., enable_batched_operations=..., forward_dead_lettered_messages_to=..., forward_to=..., id=..., is_client_affine=..., location=..., lock_duration=..., max_delivery_count=..., message_count=..., name=..., requires_session=..., status=..., system_data=..., type=..., updated_at=...) -> None:
        ...
...
def get_subscription(namespace_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., subscription_name: Optional[_builtins.str] = ..., topic_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetSubscriptionResult:
    
    ...

def get_subscription_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., subscription_name: Optional[pulumi.Input[_builtins.str]] = ..., topic_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetSubscriptionResult]:
