...
class MigrationConfigArgs:
    def __init__(__self__, *, namespace_name: pulumi.Input[_builtins.str], post_migration_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], target_namespace: pulumi.Input[_builtins.str], config_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def post_migration_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class MigrationConfig(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., config_name: Optional[pulumi.Input[_builtins.str]] = ..., namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., post_migration_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_namespace: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: MigrationConfigArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> MigrationConfig:
