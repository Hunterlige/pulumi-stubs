...
@pulumi.input_type
class TopicArgs:
    def __init__(__self__, *, namespace_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], auto_delete_on_idle: Optional[pulumi.Input[_builtins.str]] = ..., default_message_time_to_live: Optional[pulumi.Input[_builtins.str]] = ..., duplicate_detection_history_time_window: Optional[pulumi.Input[_builtins.str]] = ..., enable_batched_operations: Optional[pulumi.Input[_builtins.bool]] = ..., enable_express: Optional[pulumi.Input[_builtins.bool]] = ..., enable_partitioning: Optional[pulumi.Input[_builtins.bool]] = ..., max_message_size_in_kilobytes: Optional[pulumi.Input[_builtins.float]] = ..., max_size_in_megabytes: Optional[pulumi.Input[_builtins.int]] = ..., requires_duplicate_detection: Optional[pulumi.Input[_builtins.bool]] = ..., status: Optional[pulumi.Input[EntityStatus]] = ..., support_ordering: Optional[pulumi.Input[_builtins.bool]] = ..., topic_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def support_ordering(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class Topic(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., auto_delete_on_idle: Optional[pulumi.Input[_builtins.str]] = ..., default_message_time_to_live: Optional[pulumi.Input[_builtins.str]] = ..., duplicate_detection_history_time_window: Optional[pulumi.Input[_builtins.str]] = ..., enable_batched_operations: Optional[pulumi.Input[_builtins.bool]] = ..., enable_express: Optional[pulumi.Input[_builtins.bool]] = ..., enable_partitioning: Optional[pulumi.Input[_builtins.bool]] = ..., max_message_size_in_kilobytes: Optional[pulumi.Input[_builtins.float]] = ..., max_size_in_megabytes: Optional[pulumi.Input[_builtins.int]] = ..., namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., requires_duplicate_detection: Optional[pulumi.Input[_builtins.bool]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[EntityStatus]] = ..., support_ordering: Optional[pulumi.Input[_builtins.bool]] = ..., topic_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
