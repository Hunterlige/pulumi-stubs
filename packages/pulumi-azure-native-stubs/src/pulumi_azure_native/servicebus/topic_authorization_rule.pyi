...
class TopicAuthorizationRuleArgs:
    def __init__(__self__, *, namespace_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], rights: pulumi.Input[Sequence[pulumi.Input[AccessRights]]], topic_name: pulumi.Input[_builtins.str], authorization_rule_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TopicAuthorizationRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., authorization_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., rights: Optional[pulumi.Input[Sequence[pulumi.Input[AccessRights]]]] = ..., topic_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: TopicAuthorizationRuleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> TopicAuthorizationRule:
