...
@pulumi.input_type
class NamespaceArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], alternate_name: Optional[pulumi.Input[_builtins.str]] = ..., disable_local_auth: Optional[pulumi.Input[_builtins.bool]] = ..., encryption: Optional[pulumi.Input[EncryptionArgs]] = ..., identity: Optional[pulumi.Input[IdentityArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., minimum_tls_version: Optional[pulumi.Input[Union[_builtins.str, TlsVersion]]] = ..., namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., premium_messaging_partitions: Optional[pulumi.Input[_builtins.int]] = ..., private_endpoint_connections: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateEndpointConnectionArgs]]]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., sku: Optional[pulumi.Input[SBSkuArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., zone_redundant: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def premium_messaging_partitions(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @sku.setter
    def sku(self, value: Optional[pulumi.Input[SBSkuArgs]]): # -> None:
        ...
...
class Namespace(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., alternate_name: Optional[pulumi.Input[_builtins.str]] = ..., disable_local_auth: Optional[pulumi.Input[_builtins.bool]] = ..., encryption: Optional[pulumi.Input[Union[EncryptionArgs, EncryptionArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[IdentityArgs, IdentityArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., minimum_tls_version: Optional[pulumi.Input[Union[_builtins.str, TlsVersion]]] = ..., namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., premium_messaging_partitions: Optional[pulumi.Input[_builtins.int]] = ..., private_endpoint_connections: Optional[pulumi.Input[Sequence[pulumi.Input[Union[PrivateEndpointConnectionArgs, PrivateEndpointConnectionArgsDict]]]]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[SBSkuArgs, SBSkuArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., zone_redundant: Optional[pulumi.Input[_builtins.bool]] = ..., __props__=...) -> None:
