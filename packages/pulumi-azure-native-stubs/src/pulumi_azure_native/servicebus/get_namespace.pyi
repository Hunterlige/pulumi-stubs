...
class GetNamespaceResult:
    ...
    def __init__(__self__, alternate_name=..., azure_api_version=..., created_at=..., disable_local_auth=..., encryption=..., id=..., identity=..., location=..., metric_id=..., minimum_tls_version=..., name=..., premium_messaging_partitions=..., private_endpoint_connections=..., provisioning_state=..., public_network_access=..., service_bus_endpoint=..., sku=..., status=..., system_data=..., tags=..., type=..., updated_at=..., zone_redundant=...) -> None:
        ...
