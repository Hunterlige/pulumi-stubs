...
class GetTopicResult:
    ...
    def __init__(__self__, accessed_at=..., auto_delete_on_idle=..., azure_api_version=..., count_details=..., created_at=..., default_message_time_to_live=..., duplicate_detection_history_time_window=..., enable_batched_operations=..., enable_express=..., enable_partitioning=..., id=..., location=..., max_message_size_in_kilobytes=..., max_size_in_megabytes=..., name=..., requires_duplicate_detection=..., size_in_bytes=..., status=..., subscription_count=..., support_ordering=..., system_data=..., type=..., updated_at=...) -> None:
        ...
...
def get_topic(namespace_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., topic_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetTopicResult:
    
    ...

def get_topic_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., topic_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetTopicResult]:
