...
class GetQueueResult:
    ...
    def __init__(__self__, accessed_at=..., auto_delete_on_idle=..., azure_api_version=..., count_details=..., created_at=..., dead_lettering_on_message_expiration=..., default_message_time_to_live=..., duplicate_detection_history_time_window=..., enable_batched_operations=..., enable_express=..., enable_partitioning=..., forward_dead_lettered_messages_to=..., forward_to=..., id=..., location=..., lock_duration=..., max_delivery_count=..., max_message_size_in_kilobytes=..., max_size_in_megabytes=..., message_count=..., name=..., requires_duplicate_detection=..., requires_session=..., size_in_bytes=..., status=..., system_data=..., type=..., updated_at=...) -> None:
        ...
...
def get_queue(namespace_name: Optional[_builtins.str] = ..., queue_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetQueueResult:
    
    ...

def get_queue_output(namespace_name: Optional[pulumi.Input[_builtins.str]] = ..., queue_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetQueueResult]:
