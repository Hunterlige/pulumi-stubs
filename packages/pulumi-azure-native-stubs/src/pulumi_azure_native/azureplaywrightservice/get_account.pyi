...
class GetAccountResult:
    ...
    def __init__(__self__, azure_api_version=..., dashboard_uri=..., id=..., local_auth=..., location=..., name=..., provisioning_state=..., regional_affinity=..., reporting=..., scalable_execution=..., system_data=..., tags=..., type=...) -> None:
        ...
