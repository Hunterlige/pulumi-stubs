...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetDeploymentStackAtSubscriptionResult', 'AwaitableGetDeploymentStackAtSubscriptionResult', 'get_deployment_stack_at_subscription', 'get_deployment_stack_at_subscription_output']
@pulumi.output_type
...
class AwaitableGetDeploymentStackAtSubscriptionResult(GetDeploymentStackAtSubscriptionResult):
    def __await__(self): # -> Generator[Never, Any, GetDeploymentStackAtSubscriptionResult]:
        ...
    


def get_deployment_stack_at_subscription(deployment_stack_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDeploymentStackAtSubscriptionResult:
    
    ...

def get_deployment_stack_at_subscription_output(deployment_stack_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDeploymentStackAtSubscriptionResult]:
