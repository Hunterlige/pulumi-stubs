...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetDeploymentStackAtManagementGroupResult', 'AwaitableGetDeploymentStackAtManagementGroupResult', 'get_deployment_stack_at_management_group', 'get_deployment_stack_at_management_group_output']
@pulumi.output_type
...
class AwaitableGetDeploymentStackAtManagementGroupResult(GetDeploymentStackAtManagementGroupResult):
    def __await__(self): # -> Generator[Never, Any, GetDeploymentStackAtManagementGroupResult]:
        ...
    


def get_deployment_stack_at_management_group(deployment_stack_name: Optional[_builtins.str] = ..., management_group_id: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDeploymentStackAtManagementGroupResult:
    
    ...

def get_deployment_stack_at_management_group_output(deployment_stack_name: Optional[pulumi.Input[_builtins.str]] = ..., management_group_id: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDeploymentStackAtManagementGroupResult]:
