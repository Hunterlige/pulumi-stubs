...
class AwaitableGetDeploymentStackAtManagementGroupResult(
    GetDeploymentStackAtManagementGroupResult
):
    def __await__(self): ...

def get_deployment_stack_at_management_group(
    deployment_stack_name: Optional[_builtins.str] = ...,
    management_group_id: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetDeploymentStackAtManagementGroupResult: ...
def get_deployment_stack_at_management_group_output(
...
) -> pulumi.Output[GetDeploymentStackAtManagementGroupResult]: ...
