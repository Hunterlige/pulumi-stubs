...
class AwaitableGetAzureCliScriptResult(GetAzureCliScriptResult):
    def __await__(self): # -> Generator[Never, Any, GetAzureCliScriptResult]:
        ...
    


def get_azure_cli_script(resource_group_name: Optional[_builtins.str] = ..., script_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAzureCliScriptResult:
    
    ...

def get_azure_cli_script_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., script_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAzureCliScriptResult]:
