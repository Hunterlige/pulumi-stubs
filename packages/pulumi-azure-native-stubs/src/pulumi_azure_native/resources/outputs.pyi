...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ActionOnUnmanageResponse', 'ActionOnUnmanageResponseV1', 'ActionOnUnmanageResponseV2', 'ActionOnUnmanageResponseV3', 'AliasPathMetadataResponse', 'AliasPathResponse', 'AliasPatternResponse', 'AliasResponse', 'ApiProfileResponse', 'BasicDependencyResponse', 'ContainerConfigurationResponse', 'ContainerGroupSubnetIdResponse', 'DebugSettingResponse', 'DenySettingsResponse', 'DependencyResponse', 'DeploymentExtensionConfigItemResponse', 'DeploymentExtensionResponse', 'DeploymentParameterResponse', 'DeploymentPropertiesExtendedResponse', 'DeploymentStacksDebugSettingResponse', 'DeploymentStacksDiagnosticResponse', 'DeploymentStacksParametersLinkResponse', 'DeploymentStacksWhatIfChangeResponse', ..., ..., 'DeploymentStacksWhatIfPropertyChangeResponse', 'DeploymentStacksWhatIfResourceChangeResponse', ..., ..., ..., 'DeploymentStacksWhatIfResultPropertiesResponse', 'DeploymentStacksWhatIfResultPropertiesResponseV1', 'DeploymentStacksWhatIfResultPropertiesResponseV2', 'EnvironmentVariableResponse', 'ErrorAdditionalInfoResponse', 'ErrorDetailResponse', 'ErrorResponseResponse', 'ExtendedLocationResponse', 'IdentityResponse', 'IdentityResponseUserAssignedIdentities', 'KeyVaultParameterReferenceResponse', 'KeyVaultReferenceResponse', 'LinkedTemplateArtifactResponse', 'ManagedResourceReferenceResponse', 'ManagedServiceIdentityResponse', 'OnErrorDeploymentExtendedResponse', 'ParametersLinkResponse', 'PlanResponse', 'ProviderExtendedLocationResponse', 'ProviderResourceTypeResponse', 'ProviderResponse', 'ResourceGroupPropertiesResponse', 'ResourceReferenceExtendedResponse', 'ResourceReferenceResponse', 'ScriptStatusResponse', 'SkuResponse', 'StorageAccountConfigurationResponse', 'SystemDataResponse', 'TagsResponse', 'TemplateLinkResponse', 'TemplateSpecVersionInfoResponse', 'UserAssignedIdentityResponse', 'ZoneMappingResponse']
@pulumi.output_type
class ActionOnUnmanageResponse(dict):
    ...
    def __init__(__self__, *, resources: _builtins.str, management_groups: Optional[_builtins.str] = ..., resource_groups: Optional[_builtins.str] = ...) -> None:
...
class ActionOnUnmanageResponseV1(dict):
    ...
    def __init__(__self__, *, resources: _builtins.str, management_groups: Optional[_builtins.str] = ..., resource_groups: Optional[_builtins.str] = ..., resources_without_delete_support: Optional[_builtins.str] = ...) -> None:
...
class AliasPathMetadataResponse(dict):
    def __init__(__self__, *, attributes: _builtins.str, type: _builtins.str) -> None:
...
class AliasPathResponse(dict):
    ...
    def __init__(__self__, *, metadata: outputs.AliasPathMetadataResponse, api_versions: Optional[Sequence[_builtins.str]] = ..., path: Optional[_builtins.str] = ..., pattern: Optional[outputs.AliasPatternResponse] = ...) -> None:
...
class AliasPatternResponse(dict):
    ...
    def __init__(__self__, *, phrase: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ..., variable: Optional[_builtins.str] = ...) -> None:
...
class AliasResponse(dict):
    ...
    def __init__(__self__, *, default_metadata: outputs.AliasPathMetadataResponse, default_path: Optional[_builtins.str] = ..., default_pattern: Optional[outputs.AliasPatternResponse] = ..., name: Optional[_builtins.str] = ..., paths: Optional[Sequence[outputs.AliasPathResponse]] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ApiProfileResponse(dict):
    ...
    def __init__(__self__, *, api_version: _builtins.str, profile_version: _builtins.str) -> None:
...
class BasicDependencyResponse(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., resource_name: Optional[_builtins.str] = ..., resource_type: Optional[_builtins.str] = ...) -> None:
...
class ContainerConfigurationResponse(dict):
    ...
    def __init__(__self__, *, container_group_name: Optional[_builtins.str] = ..., subnet_ids: Optional[Sequence[outputs.ContainerGroupSubnetIdResponse]] = ...) -> None:
...
class DenySettingsResponse(dict):
    ...
    def __init__(__self__, *, mode: _builtins.str, apply_to_child_scopes: Optional[_builtins.bool] = ..., excluded_actions: Optional[Sequence[_builtins.str]] = ..., excluded_principals: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DependencyResponse(dict):
    ...
    def __init__(__self__, *, depends_on: Optional[Sequence[outputs.BasicDependencyResponse]] = ..., id: Optional[_builtins.str] = ..., resource_name: Optional[_builtins.str] = ..., resource_type: Optional[_builtins.str] = ...) -> None:
...
class DeploymentExtensionConfigItemResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, key_vault_reference: Optional[outputs.KeyVaultParameterReferenceResponse] = ..., value: Optional[Any] = ...) -> None:
...
class DeploymentExtensionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, version: _builtins.str, config: Optional[Mapping[str, outputs.DeploymentExtensionConfigItemResponse]] = ..., config_id: Optional[_builtins.str] = ...) -> None:
...
class DeploymentParameterResponse(dict):
    ...
    def __init__(__self__, *, reference: Optional[outputs.KeyVaultParameterReferenceResponse] = ..., type: Optional[_builtins.str] = ..., value: Optional[Any] = ...) -> None:
...
class DeploymentPropertiesExtendedResponse(dict):
    ...
    def __init__(__self__, *, correlation_id: _builtins.str, debug_setting: outputs.DebugSettingResponse, dependencies: Sequence[outputs.DependencyResponse], duration: _builtins.str, error: outputs.ErrorResponseResponse, mode: _builtins.str, on_error_deployment: outputs.OnErrorDeploymentExtendedResponse, output_resources: Sequence[outputs.ResourceReferenceResponse], outputs: Any, parameters: Any, parameters_link: outputs.ParametersLinkResponse, providers: Sequence[outputs.ProviderResponse], provisioning_state: _builtins.str, template_hash: _builtins.str, template_link: outputs.TemplateLinkResponse, timestamp: _builtins.str, validated_resources: Sequence[outputs.ResourceReferenceResponse]) -> None:
...
class DeploymentStacksDiagnosticResponse(dict):
    ...
    def __init__(__self__, *, code: _builtins.str, level: _builtins.str, message: _builtins.str, additional_info: Optional[Sequence[outputs.ErrorAdditionalInfoResponse]] = ..., target: Optional[_builtins.str] = ...) -> None:
...
class DeploymentStacksParametersLinkResponse(dict):
    ...
    def __init__(__self__, *, uri: _builtins.str, content_version: Optional[_builtins.str] = ...) -> None:
...
class DeploymentStacksWhatIfChangeResponse(dict):
    ...
    def __init__(__self__, *, deny_settings_change: outputs.DeploymentStacksWhatIfChangeResponseDenySettingsChange, resource_changes: Sequence[outputs.DeploymentStacksWhatIfResourceChangeResponse], deployment_scope_change: Optional[outputs.DeploymentStacksWhatIfChangeResponseDeploymentScopeChange] = ...) -> None:
...
class DeploymentStacksWhatIfChangeResponseDenySettingsChange(dict):
    ...
    def __init__(__self__, *, after: Optional[outputs.DenySettingsResponse] = ..., before: Optional[outputs.DenySettingsResponse] = ..., delta: Optional[Sequence[outputs.DeploymentStacksWhatIfPropertyChangeResponse]] = ...) -> None:
...
class DeploymentStacksWhatIfChangeResponseDeploymentScopeChange(dict):
    ...
    def __init__(__self__, *, after: Optional[_builtins.str] = ..., before: Optional[_builtins.str] = ...) -> None:
...
class DeploymentStacksWhatIfPropertyChangeResponse(dict):
    ...
    def __init__(__self__, *, change_type: _builtins.str, path: _builtins.str, after: Optional[Any] = ..., before: Optional[Any] = ..., children: Optional[Sequence[outputs.DeploymentStacksWhatIfPropertyChangeResponse]] = ...) -> None:
...
class DeploymentStacksWhatIfResourceChangeResponse(dict):
    ...
    def __init__(__self__, *, api_version: _builtins.str, change_certainty: _builtins.str, change_type: _builtins.str, extension: outputs.DeploymentExtensionResponse, id: _builtins.str, identifiers: Any, type: _builtins.str, deny_status_change: Optional[outputs.DeploymentStacksWhatIfResourceChangeResponseDenyStatusChange] = ..., deployment_id: Optional[_builtins.str] = ..., management_status_change: Optional[outputs.DeploymentStacksWhatIfResourceChangeResponseManagementStatusChange] = ..., resource_configuration_changes: Optional[outputs.DeploymentStacksWhatIfResourceChangeResponseResourceConfigurationChanges] = ..., symbolic_name: Optional[_builtins.str] = ..., unsupported_reason: Optional[_builtins.str] = ...) -> None:
...
class DeploymentStacksWhatIfResourceChangeResponseResourceConfigurationChanges(dict):
    ...
    def __init__(__self__, *, after: Optional[Any] = ..., before: Optional[Any] = ..., delta: Optional[Sequence[outputs.DeploymentStacksWhatIfPropertyChangeResponse]] = ...) -> None:
...
class DeploymentStacksWhatIfResultPropertiesResponse(dict):
    ...
    def __init__(__self__, *, action_on_unmanage: outputs.ActionOnUnmanageResponseV1, changes: outputs.DeploymentStacksWhatIfChangeResponse, correlation_id: _builtins.str, deny_settings: outputs.DenySettingsResponse, deployment_stack_last_modified: _builtins.str, deployment_stack_resource_id: _builtins.str, diagnostics: Sequence[outputs.DeploymentStacksDiagnosticResponse], error: outputs.ErrorDetailResponse, provisioning_state: _builtins.str, retention_interval: _builtins.str, debug_setting: Optional[outputs.DeploymentStacksDebugSettingResponse] = ..., deployment_scope: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., parameters: Optional[Mapping[str, outputs.DeploymentParameterResponse]] = ..., parameters_link: Optional[outputs.DeploymentStacksParametersLinkResponse] = ..., validation_level: Optional[_builtins.str] = ...) -> None:
...
class DeploymentStacksWhatIfResultPropertiesResponseV1(dict):
    ...
    def __init__(__self__, *, action_on_unmanage: outputs.ActionOnUnmanageResponseV2, changes: outputs.DeploymentStacksWhatIfChangeResponse, correlation_id: _builtins.str, deny_settings: outputs.DenySettingsResponse, deployment_stack_last_modified: _builtins.str, deployment_stack_resource_id: _builtins.str, diagnostics: Sequence[outputs.DeploymentStacksDiagnosticResponse], error: outputs.ErrorDetailResponse, provisioning_state: _builtins.str, retention_interval: _builtins.str, debug_setting: Optional[outputs.DeploymentStacksDebugSettingResponse] = ..., deployment_scope: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., parameters: Optional[Mapping[str, outputs.DeploymentParameterResponse]] = ..., parameters_link: Optional[outputs.DeploymentStacksParametersLinkResponse] = ..., validation_level: Optional[_builtins.str] = ...) -> None:
...
class DeploymentStacksWhatIfResultPropertiesResponseV2(dict):
    ...
    def __init__(__self__, *, action_on_unmanage: outputs.ActionOnUnmanageResponseV3, changes: outputs.DeploymentStacksWhatIfChangeResponse, correlation_id: _builtins.str, deny_settings: outputs.DenySettingsResponse, deployment_stack_last_modified: _builtins.str, deployment_stack_resource_id: _builtins.str, diagnostics: Sequence[outputs.DeploymentStacksDiagnosticResponse], error: outputs.ErrorDetailResponse, provisioning_state: _builtins.str, retention_interval: _builtins.str, debug_setting: Optional[outputs.DeploymentStacksDebugSettingResponse] = ..., deployment_scope: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., parameters: Optional[Mapping[str, outputs.DeploymentParameterResponse]] = ..., parameters_link: Optional[outputs.DeploymentStacksParametersLinkResponse] = ..., validation_level: Optional[_builtins.str] = ...) -> None:
...
class ErrorResponseResponse(dict):
    ...
    def __init__(__self__, *, additional_info: Sequence[outputs.ErrorAdditionalInfoResponse], code: _builtins.str, details: Sequence[outputs.ErrorResponseResponse], message: _builtins.str, target: _builtins.str) -> None:
...
class KeyVaultParameterReferenceResponse(dict):
    ...
    def __init__(__self__, *, key_vault: outputs.KeyVaultReferenceResponse, secret_name: _builtins.str, secret_version: Optional[_builtins.str] = ...) -> None:
...
class ManagedResourceReferenceResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, deny_status: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class ManagedServiceIdentityResponse(dict):
    ...
    def __init__(__self__, *, tenant_id: _builtins.str, type: Optional[_builtins.str] = ..., user_assigned_identities: Optional[Mapping[str, outputs.UserAssignedIdentityResponse]] = ...) -> None:
...
class OnErrorDeploymentExtendedResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, deployment_name: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ProviderExtendedLocationResponse(dict):
    ...
    def __init__(__self__, *, extended_locations: Optional[Sequence[_builtins.str]] = ..., location: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ProviderResourceTypeResponse(dict):
    ...
    def __init__(__self__, *, api_profiles: Sequence[outputs.ApiProfileResponse], default_api_version: _builtins.str, aliases: Optional[Sequence[outputs.AliasResponse]] = ..., api_versions: Optional[Sequence[_builtins.str]] = ..., capabilities: Optional[_builtins.str] = ..., location_mappings: Optional[Sequence[outputs.ProviderExtendedLocationResponse]] = ..., locations: Optional[Sequence[_builtins.str]] = ..., properties: Optional[Mapping[str, _builtins.str]] = ..., resource_type: Optional[_builtins.str] = ..., zone_mappings: Optional[Sequence[outputs.ZoneMappingResponse]] = ...) -> None:
...
class ProviderResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, registration_policy: _builtins.str, registration_state: _builtins.str, resource_types: Sequence[outputs.ProviderResourceTypeResponse], namespace: Optional[_builtins.str] = ..., provider_authorization_consent_state: Optional[_builtins.str] = ...) -> None:
...
class ResourceReferenceExtendedResponse(dict):
    ...
    def __init__(__self__, *, error: outputs.ErrorDetailResponse, id: _builtins.str) -> None:
...
class ScriptStatusResponse(dict):
    ...
    def __init__(__self__, *, container_instance_id: _builtins.str, end_time: _builtins.str, expiration_time: _builtins.str, start_time: _builtins.str, storage_account_id: _builtins.str, error: Optional[outputs.ErrorResponseResponse] = ...) -> None:
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *, capacity: Optional[_builtins.int] = ..., family: Optional[_builtins.str] = ..., model: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., size: Optional[_builtins.str] = ..., tier: Optional[_builtins.str] = ...) -> None:
...
class StorageAccountConfigurationResponse(dict):
    ...
    def __init__(__self__, *, storage_account_key: Optional[_builtins.str] = ..., storage_account_name: Optional[_builtins.str] = ...) -> None:
...
class TemplateLinkResponse(dict):
    ...
    def __init__(__self__, *, content_version: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., query_string: Optional[_builtins.str] = ..., relative_path: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class TemplateSpecVersionInfoResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, time_created: _builtins.str, time_modified: _builtins.str) -> None:
...
class ZoneMappingResponse(dict):
    def __init__(__self__, *, location: Optional[_builtins.str] = ..., zones: Optional[Sequence[_builtins.str]] = ...) -> None:
