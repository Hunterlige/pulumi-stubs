...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GatewayDetailsArgs', 'GatewayDetailsArgsDict', 'IPv4FirewallRuleArgs', 'IPv4FirewallRuleArgsDict', 'IPv4FirewallSettingsArgs', 'IPv4FirewallSettingsArgsDict', 'ResourceSkuArgs', 'ResourceSkuArgsDict', 'ServerAdministratorsArgs', 'ServerAdministratorsArgsDict']
...
class GatewayDetailsArgs:
    def __init__(__self__, *, gateway_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def gateway_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IPv4FirewallRuleArgs:
    def __init__(__self__, *, firewall_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., range_end: Optional[pulumi.Input[_builtins.str]] = ..., range_start: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @range_end.setter
    def range_end(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @range_start.setter
    def range_start(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IPv4FirewallSettingsArgs:
    def __init__(__self__, *, enable_power_bi_service: Optional[pulumi.Input[_builtins.bool]] = ..., firewall_rules: Optional[pulumi.Input[Sequence[pulumi.Input[IPv4FirewallRuleArgs]]]] = ...) -> None:
    ...
    def enable_power_bi_service(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def firewall_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IPv4FirewallRuleArgs]]]]): # -> None:
        ...
...
class ResourceSkuArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], capacity: Optional[pulumi.Input[_builtins.int]] = ..., tier: Optional[pulumi.Input[Union[_builtins.str, SkuTier]]] = ...) -> None:
