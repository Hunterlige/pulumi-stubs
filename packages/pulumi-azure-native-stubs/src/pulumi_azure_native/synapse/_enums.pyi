...
__all__ = ['BlobStorageEventType', 'ClusterPrincipalRole', 'Compression', 'ConfigurationType', 'CreateMode', 'DataConnectionKind', 'DataFlowComputeType', 'DatabasePrincipalRole', 'DefaultPrincipalsModificationKind', 'EventGridDataFormat', 'EventHubDataFormat', 'IntegrationRuntimeEdition', 'IntegrationRuntimeEntityReferenceType', 'IntegrationRuntimeLicenseType', 'IntegrationRuntimeSsisCatalogPricingTier', 'IntegrationRuntimeType', 'IotHubDataFormat', 'Kind', 'NodeSize', 'NodeSizeFamily', 'PrincipalType', 'ResourceIdentityType', 'SensitivityLabelRank', 'SkuName', 'SkuSize', 'StorageAccountType', 'TransparentDataEncryptionStatus', 'WorkspacePublicNetworkAccess']
