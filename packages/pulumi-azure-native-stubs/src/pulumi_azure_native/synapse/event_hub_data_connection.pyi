...
class EventHubDataConnectionArgs:
    def __init__(__self__, *, consumer_group: pulumi.Input[_builtins.str], database_name: pulumi.Input[_builtins.str], event_hub_resource_id: pulumi.Input[_builtins.str], kind: pulumi.Input[_builtins.str], kusto_pool_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], workspace_name: pulumi.Input[_builtins.str], compression: Optional[pulumi.Input[Union[_builtins.str, Compression]]] = ..., data_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., data_format: Optional[pulumi.Input[Union[_builtins.str, EventHubDataFormat]]] = ..., event_system_properties: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., managed_identity_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., mapping_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., table_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @compression.setter
    def compression(self, value: Optional[pulumi.Input[Union[_builtins.str, Compression]]]): # -> None:
        ...
    ...
    @data_format.setter
    def data_format(self, value: Optional[pulumi.Input[Union[_builtins.str, EventHubDataFormat]]]): # -> None:
        ...
...
class EventHubDataConnection(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., compression: Optional[pulumi.Input[Union[_builtins.str, Compression]]] = ..., consumer_group: Optional[pulumi.Input[_builtins.str]] = ..., data_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., data_format: Optional[pulumi.Input[Union[_builtins.str, EventHubDataFormat]]] = ..., database_name: Optional[pulumi.Input[_builtins.str]] = ..., event_hub_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., event_system_properties: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., kusto_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., managed_identity_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., mapping_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., table_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: EventHubDataConnectionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> EventHubDataConnection:
