...
class GetReadOnlyFollowingDatabaseResult:
    ...
    def __init__(__self__, attached_database_configuration_name=..., azure_api_version=..., hot_cache_period=..., id=..., kind=..., leader_cluster_resource_id=..., location=..., name=..., principals_modification_kind=..., provisioning_state=..., soft_delete_period=..., statistics=..., system_data=..., type=...) -> None:
        ...
...
def get_read_only_following_database(database_name: Optional[_builtins.str] = ..., kusto_pool_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., workspace_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetReadOnlyFollowingDatabaseResult:
    
    ...

def get_read_only_following_database_output(database_name: Optional[pulumi.Input[_builtins.str]] = ..., kusto_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetReadOnlyFollowingDatabaseResult]:
