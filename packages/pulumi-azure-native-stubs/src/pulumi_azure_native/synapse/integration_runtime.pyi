...
class IntegrationRuntimeArgs:
    def __init__(__self__, *, properties: pulumi.Input[Union[ManagedIntegrationRuntimeArgs, SelfHostedIntegrationRuntimeArgs]], resource_group_name: pulumi.Input[_builtins.str], workspace_name: pulumi.Input[_builtins.str], integration_runtime_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class IntegrationRuntime(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., integration_runtime_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[Union[ManagedIntegrationRuntimeArgs, ManagedIntegrationRuntimeArgsDict], Union[SelfHostedIntegrationRuntimeArgs, SelfHostedIntegrationRuntimeArgsDict]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
