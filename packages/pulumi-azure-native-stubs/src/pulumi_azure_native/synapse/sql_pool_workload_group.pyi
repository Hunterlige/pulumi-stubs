...
class SqlPoolWorkloadGroupArgs:
    def __init__(__self__, *, max_resource_percent: pulumi.Input[_builtins.int], min_resource_percent: pulumi.Input[_builtins.int], min_resource_percent_per_request: pulumi.Input[_builtins.float], resource_group_name: pulumi.Input[_builtins.str], sql_pool_name: pulumi.Input[_builtins.str], workspace_name: pulumi.Input[_builtins.str], importance: Optional[pulumi.Input[_builtins.str]] = ..., max_resource_percent_per_request: Optional[pulumi.Input[_builtins.float]] = ..., query_execution_timeout: Optional[pulumi.Input[_builtins.int]] = ..., workload_group_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.type_token("azure-native:synapse:SqlPoolWorkloadGroup")
class SqlPoolWorkloadGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., importance: Optional[pulumi.Input[_builtins.str]] = ..., max_resource_percent: Optional[pulumi.Input[_builtins.int]] = ..., max_resource_percent_per_request: Optional[pulumi.Input[_builtins.float]] = ..., min_resource_percent: Optional[pulumi.Input[_builtins.int]] = ..., min_resource_percent_per_request: Optional[pulumi.Input[_builtins.float]] = ..., query_execution_timeout: Optional[pulumi.Input[_builtins.int]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sql_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., workload_group_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: SqlPoolWorkloadGroupArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SqlPoolWorkloadGroup:
