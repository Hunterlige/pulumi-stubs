...
@pulumi.input_type
class SqlPoolArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], workspace_name: pulumi.Input[_builtins.str], collation: Optional[pulumi.Input[_builtins.str]] = ..., create_mode: Optional[pulumi.Input[Union[_builtins.str, CreateMode]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., max_size_bytes: Optional[pulumi.Input[_builtins.float]] = ..., provisioning_state: Optional[pulumi.Input[_builtins.str]] = ..., recoverable_database_id: Optional[pulumi.Input[_builtins.str]] = ..., restore_point_in_time: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[SkuArgs]] = ..., source_database_deletion_date: Optional[pulumi.Input[_builtins.str]] = ..., source_database_id: Optional[pulumi.Input[_builtins.str]] = ..., sql_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_type: Optional[pulumi.Input[Union[_builtins.str, StorageAccountType]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def sql_pool_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SqlPool(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., collation: Optional[pulumi.Input[_builtins.str]] = ..., create_mode: Optional[pulumi.Input[Union[_builtins.str, CreateMode]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., max_size_bytes: Optional[pulumi.Input[_builtins.float]] = ..., provisioning_state: Optional[pulumi.Input[_builtins.str]] = ..., recoverable_database_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., restore_point_in_time: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[SkuArgs, SkuArgsDict]]] = ..., source_database_deletion_date: Optional[pulumi.Input[_builtins.str]] = ..., source_database_id: Optional[pulumi.Input[_builtins.str]] = ..., sql_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_type: Optional[pulumi.Input[Union[_builtins.str, StorageAccountType]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: SqlPoolArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SqlPool:
    ...
    @_builtins.property
    @pulumi.getter(name="sourceDatabaseDeletionDate")
    def source_database_deletion_date(self) -> pulumi.Output[Optional[_builtins.str]]:
