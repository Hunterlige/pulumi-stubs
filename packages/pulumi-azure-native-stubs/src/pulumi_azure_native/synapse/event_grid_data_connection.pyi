...
class EventGridDataConnectionArgs:
    def __init__(__self__, *, consumer_group: pulumi.Input[_builtins.str], database_name: pulumi.Input[_builtins.str], event_hub_resource_id: pulumi.Input[_builtins.str], kind: pulumi.Input[_builtins.str], kusto_pool_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], storage_account_resource_id: pulumi.Input[_builtins.str], workspace_name: pulumi.Input[_builtins.str], blob_storage_event_type: Optional[pulumi.Input[Union[_builtins.str, BlobStorageEventType]]] = ..., data_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., data_format: Optional[pulumi.Input[Union[_builtins.str, EventGridDataFormat]]] = ..., ignore_first_record: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., mapping_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., table_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
