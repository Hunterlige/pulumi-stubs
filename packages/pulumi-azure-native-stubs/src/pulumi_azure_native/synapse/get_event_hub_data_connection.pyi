...
class GetEventHubDataConnectionResult:
    ...
    def __init__(__self__, azure_api_version=..., compression=..., consumer_group=..., data_format=..., event_hub_resource_id=..., event_system_properties=..., id=..., kind=..., location=..., managed_identity_resource_id=..., mapping_rule_name=..., name=..., provisioning_state=..., system_data=..., table_name=..., type=...) -> None:
        ...
...
def get_event_hub_data_connection(data_connection_name: Optional[_builtins.str] = ..., database_name: Optional[_builtins.str] = ..., kusto_pool_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., workspace_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetEventHubDataConnectionResult:
    
    ...

def get_event_hub_data_connection_output(data_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., database_name: Optional[pulumi.Input[_builtins.str]] = ..., kusto_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetEventHubDataConnectionResult]:
