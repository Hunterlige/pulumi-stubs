...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AutoPausePropertiesArgs', 'AutoPausePropertiesArgsDict', 'AutoScalePropertiesArgs', 'AutoScalePropertiesArgsDict', 'AzureSkuArgs', 'AzureSkuArgsDict', 'CmdkeySetupArgs', 'CmdkeySetupArgsDict', 'ComponentSetupArgs', 'ComponentSetupArgsDict', 'CspWorkspaceAdminPropertiesArgs', 'CspWorkspaceAdminPropertiesArgsDict', 'CustomerManagedKeyDetailsArgs', 'CustomerManagedKeyDetailsArgsDict', 'DataLakeStorageAccountDetailsArgs', 'DataLakeStorageAccountDetailsArgsDict', 'DynamicExecutorAllocationArgs', 'DynamicExecutorAllocationArgsDict', 'EncryptionDetailsArgs', 'EncryptionDetailsArgsDict', 'EntityReferenceArgs', 'EntityReferenceArgsDict', 'EnvironmentVariableSetupArgs', 'EnvironmentVariableSetupArgsDict', 'IntegrationRuntimeComputePropertiesArgs', 'IntegrationRuntimeComputePropertiesArgsDict', 'IntegrationRuntimeCustomSetupScriptPropertiesArgs', ..., 'IntegrationRuntimeCustomerVirtualNetworkArgs', 'IntegrationRuntimeCustomerVirtualNetworkArgsDict', 'IntegrationRuntimeDataFlowPropertiesArgs', 'IntegrationRuntimeDataFlowPropertiesArgsDict', 'IntegrationRuntimeDataProxyPropertiesArgs', 'IntegrationRuntimeDataProxyPropertiesArgsDict', 'IntegrationRuntimeSsisCatalogInfoArgs', 'IntegrationRuntimeSsisCatalogInfoArgsDict', 'IntegrationRuntimeSsisPropertiesArgs', 'IntegrationRuntimeSsisPropertiesArgsDict', 'IntegrationRuntimeVNetPropertiesArgs', 'IntegrationRuntimeVNetPropertiesArgsDict', 'KekIdentityPropertiesArgs', 'KekIdentityPropertiesArgsDict', 'LibraryInfoArgs', 'LibraryInfoArgsDict', 'LibraryRequirementsArgs', 'LibraryRequirementsArgsDict', 'LinkedIntegrationRuntimeKeyAuthorizationArgs', 'LinkedIntegrationRuntimeKeyAuthorizationArgsDict', 'LinkedIntegrationRuntimeRbacAuthorizationArgs', 'LinkedIntegrationRuntimeRbacAuthorizationArgsDict', 'ManagedIdentityArgs', 'ManagedIdentityArgsDict', 'ManagedIntegrationRuntimeArgs', 'ManagedIntegrationRuntimeArgsDict', 'ManagedVirtualNetworkSettingsArgs', 'ManagedVirtualNetworkSettingsArgsDict', 'OptimizedAutoscaleArgs', 'OptimizedAutoscaleArgsDict', 'PrivateEndpointConnectionArgs', 'PrivateEndpointConnectionArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'PurviewConfigurationArgs', 'PurviewConfigurationArgsDict', 'SecureStringArgs', 'SecureStringArgsDict', 'SelfHostedIntegrationRuntimeArgs', 'SelfHostedIntegrationRuntimeArgsDict', 'SkuArgs', 'SkuArgsDict', 'SparkConfigPropertiesArgs', 'SparkConfigPropertiesArgsDict', 'SqlPoolVulnerabilityAssessmentRuleBaselineItemArgs', ..., 'TableLevelSharingPropertiesArgs', 'TableLevelSharingPropertiesArgsDict', 'VirtualNetworkProfileArgs', 'VirtualNetworkProfileArgsDict', ..., ..., 'WorkspaceKeyDetailsArgs', 'WorkspaceKeyDetailsArgsDict', 'WorkspaceRepositoryConfigurationArgs', 'WorkspaceRepositoryConfigurationArgsDict']
...
@pulumi.input_type
class AzureSkuArgs:
    def __init__(__self__, *, name: pulumi.Input[Union[_builtins.str, SkuName]], size: pulumi.Input[Union[_builtins.str, SkuSize]], capacity: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @size.setter
    def size(self, value: pulumi.Input[Union[_builtins.str, SkuSize]]): # -> None:
        ...
...
class CmdkeySetupArgs:
    def __init__(__self__, *, password: pulumi.Input[SecureStringArgs], target_name: Any, type: pulumi.Input[_builtins.str], user_name: Any) -> None:
    ...
    @password.setter
    def password(self, value: pulumi.Input[SecureStringArgs]): # -> None:
        ...
    ...
    @target_name.setter
    def target_name(self, value: Any): # -> None:
        ...
    ...
    @user_name.setter
    def user_name(self, value: Any): # -> None:
        ...
...
class ComponentSetupArgs:
    def __init__(__self__, *, component_name: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], license_key: Optional[pulumi.Input[SecureStringArgs]] = ...) -> None:
    ...
    @license_key.setter
    def license_key(self, value: Optional[pulumi.Input[SecureStringArgs]]): # -> None:
        ...
...
class CspWorkspaceAdminPropertiesArgs:
    def __init__(__self__, *, initial_workspace_admin_object_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def initial_workspace_admin_object_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CustomerManagedKeyDetailsArgs:
    def __init__(__self__, *, kek_identity: Optional[pulumi.Input[KekIdentityPropertiesArgs]] = ..., key: Optional[pulumi.Input[WorkspaceKeyDetailsArgs]] = ...) -> None:
    ...
    @kek_identity.setter
    def kek_identity(self, value: Optional[pulumi.Input[KekIdentityPropertiesArgs]]): # -> None:
        ...
    ...
    @key.setter
    def key(self, value: Optional[pulumi.Input[WorkspaceKeyDetailsArgs]]): # -> None:
        ...
...
class DataLakeStorageAccountDetailsArgs:
    def __init__(__self__, *, account_url: Optional[pulumi.Input[_builtins.str]] = ..., create_managed_private_endpoint: Optional[pulumi.Input[_builtins.bool]] = ..., filesystem: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @account_url.setter
    def account_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def create_managed_private_endpoint(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @filesystem.setter
    def filesystem(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DynamicExecutorAllocationArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., max_executors: Optional[pulumi.Input[_builtins.int]] = ..., min_executors: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def max_executors(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def min_executors(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class EncryptionDetailsArgs:
    def __init__(__self__, *, cmk: Optional[pulumi.Input[CustomerManagedKeyDetailsArgs]] = ...) -> None:
    ...
    @cmk.setter
    def cmk(self, value: Optional[pulumi.Input[CustomerManagedKeyDetailsArgs]]): # -> None:
        ...
...
class EntityReferenceArgs:
    def __init__(__self__, *, reference_name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, IntegrationRuntimeEntityReferenceType]]] = ...) -> None:
    ...
    def reference_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, IntegrationRuntimeEntityReferenceType]]]): # -> None:
        ...
...
class EnvironmentVariableSetupArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], variable_name: pulumi.Input[_builtins.str], variable_value: pulumi.Input[_builtins.str]) -> None:
    ...
    def variable_value(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class IntegrationRuntimeComputePropertiesArgs:
    def __init__(__self__, *, data_flow_properties: Optional[pulumi.Input[IntegrationRuntimeDataFlowPropertiesArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., max_parallel_executions_per_node: Optional[pulumi.Input[_builtins.int]] = ..., node_size: Optional[pulumi.Input[_builtins.str]] = ..., number_of_nodes: Optional[pulumi.Input[_builtins.int]] = ..., v_net_properties: Optional[pulumi.Input[IntegrationRuntimeVNetPropertiesArgs]] = ...) -> None:
    ...
    def data_flow_properties(self, value: Optional[pulumi.Input[IntegrationRuntimeDataFlowPropertiesArgs]]): # -> None:
        ...
    ...
    def max_parallel_executions_per_node(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def v_net_properties(self, value: Optional[pulumi.Input[IntegrationRuntimeVNetPropertiesArgs]]): # -> None:
        ...
...
class IntegrationRuntimeCustomSetupScriptPropertiesArgs:
    def __init__(__self__, *, blob_container_uri: Optional[pulumi.Input[_builtins.str]] = ..., sas_token: Optional[pulumi.Input[SecureStringArgs]] = ...) -> None:
    ...
    @sas_token.setter
    def sas_token(self, value: Optional[pulumi.Input[SecureStringArgs]]): # -> None:
        ...
...
class IntegrationRuntimeDataFlowPropertiesArgs:
    def __init__(__self__, *, compute_type: Optional[pulumi.Input[Union[_builtins.str, DataFlowComputeType]]] = ..., core_count: Optional[pulumi.Input[_builtins.int]] = ..., time_to_live: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @compute_type.setter
    def compute_type(self, value: Optional[pulumi.Input[Union[_builtins.str, DataFlowComputeType]]]): # -> None:
        ...
    ...
    @time_to_live.setter
    def time_to_live(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class IntegrationRuntimeDataProxyPropertiesArgs:
    def __init__(__self__, *, connect_via: Optional[pulumi.Input[EntityReferenceArgs]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., staging_linked_service: Optional[pulumi.Input[EntityReferenceArgs]] = ...) -> None:
    ...
    @connect_via.setter
    def connect_via(self, value: Optional[pulumi.Input[EntityReferenceArgs]]): # -> None:
        ...
    ...
    def staging_linked_service(self, value: Optional[pulumi.Input[EntityReferenceArgs]]): # -> None:
        ...
...
class IntegrationRuntimeSsisCatalogInfoArgs:
    def __init__(__self__, *, catalog_admin_password: Optional[pulumi.Input[SecureStringArgs]] = ..., catalog_admin_user_name: Optional[pulumi.Input[_builtins.str]] = ..., catalog_pricing_tier: Optional[pulumi.Input[Union[_builtins.str, IntegrationRuntimeSsisCatalogPricingTier]]] = ..., catalog_server_endpoint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def catalog_admin_password(self, value: Optional[pulumi.Input[SecureStringArgs]]): # -> None:
        ...
    ...
    def catalog_admin_user_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def catalog_pricing_tier(self, value: Optional[pulumi.Input[Union[_builtins.str, IntegrationRuntimeSsisCatalogPricingTier]]]): # -> None:
        ...
    ...
    def catalog_server_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IntegrationRuntimeSsisPropertiesArgs:
    def __init__(__self__, *, catalog_info: Optional[pulumi.Input[IntegrationRuntimeSsisCatalogInfoArgs]] = ..., custom_setup_script_properties: Optional[pulumi.Input[IntegrationRuntimeCustomSetupScriptPropertiesArgs]] = ..., data_proxy_properties: Optional[pulumi.Input[IntegrationRuntimeDataProxyPropertiesArgs]] = ..., edition: Optional[pulumi.Input[Union[_builtins.str, IntegrationRuntimeEdition]]] = ..., express_custom_setup_properties: Optional[pulumi.Input[Sequence[pulumi.Input[Union[CmdkeySetupArgs, ComponentSetupArgs, EnvironmentVariableSetupArgs]]]]] = ..., license_type: Optional[pulumi.Input[Union[_builtins.str, IntegrationRuntimeLicenseType]]] = ...) -> None:
    ...
    @catalog_info.setter
    def catalog_info(self, value: Optional[pulumi.Input[IntegrationRuntimeSsisCatalogInfoArgs]]): # -> None:
        ...
    ...
    def custom_setup_script_properties(self, value: Optional[pulumi.Input[IntegrationRuntimeCustomSetupScriptPropertiesArgs]]): # -> None:
        ...
    ...
    def data_proxy_properties(self, value: Optional[pulumi.Input[IntegrationRuntimeDataProxyPropertiesArgs]]): # -> None:
        ...
    ...
    @edition.setter
    def edition(self, value: Optional[pulumi.Input[Union[_builtins.str, IntegrationRuntimeEdition]]]): # -> None:
        ...
    ...
    def express_custom_setup_properties(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[CmdkeySetupArgs, ComponentSetupArgs, EnvironmentVariableSetupArgs]]]]]): # -> None:
        ...
    ...
    @license_type.setter
    def license_type(self, value: Optional[pulumi.Input[Union[_builtins.str, IntegrationRuntimeLicenseType]]]): # -> None:
        ...
...
class IntegrationRuntimeVNetPropertiesArgs:
    def __init__(__self__, *, public_ips: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., subnet: Optional[pulumi.Input[_builtins.str]] = ..., subnet_id: Optional[pulumi.Input[_builtins.str]] = ..., v_net_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @public_ips.setter
    def public_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @v_net_id.setter
    def v_net_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class KekIdentityPropertiesArgs:
    def __init__(__self__, *, use_system_assigned_identity: Optional[Any] = ..., user_assigned_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def use_system_assigned_identity(self, value: Optional[Any]): # -> None:
        ...
...
class LibraryInfoArgs:
    def __init__(__self__, *, container_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LibraryRequirementsArgs:
    def __init__(__self__, *, content: Optional[pulumi.Input[_builtins.str]] = ..., filename: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @filename.setter
    def filename(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LinkedIntegrationRuntimeKeyAuthorizationArgs:
    def __init__(__self__, *, authorization_type: pulumi.Input[_builtins.str], key: pulumi.Input[SecureStringArgs]) -> None:
    ...
    @key.setter
    def key(self, value: pulumi.Input[SecureStringArgs]): # -> None:
        ...
...
class LinkedIntegrationRuntimeRbacAuthorizationArgs:
    def __init__(__self__, *, authorization_type: pulumi.Input[_builtins.str], resource_id: pulumi.Input[_builtins.str]) -> None:
...
class ManagedIntegrationRuntimeArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], compute_properties: Optional[pulumi.Input[IntegrationRuntimeComputePropertiesArgs]] = ..., customer_virtual_network: Optional[pulumi.Input[IntegrationRuntimeCustomerVirtualNetworkArgs]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., reference_name: Optional[pulumi.Input[_builtins.str]] = ..., ssis_properties: Optional[pulumi.Input[IntegrationRuntimeSsisPropertiesArgs]] = ...) -> None:
    ...
    def compute_properties(self, value: Optional[pulumi.Input[IntegrationRuntimeComputePropertiesArgs]]): # -> None:
        ...
    ...
    def customer_virtual_network(self, value: Optional[pulumi.Input[IntegrationRuntimeCustomerVirtualNetworkArgs]]): # -> None:
        ...
    ...
    def ssis_properties(self, value: Optional[pulumi.Input[IntegrationRuntimeSsisPropertiesArgs]]): # -> None:
        ...
...
class ManagedVirtualNetworkSettingsArgs:
    def __init__(__self__, *, allowed_aad_tenant_ids_for_linking: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., linked_access_check_on_target_resource: Optional[pulumi.Input[_builtins.bool]] = ..., prevent_data_exfiltration: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def allowed_aad_tenant_ids_for_linking(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def linked_access_check_on_target_resource(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def prevent_data_exfiltration(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class OptimizedAutoscaleArgs:
    def __init__(__self__, *, is_enabled: pulumi.Input[_builtins.bool], maximum: pulumi.Input[_builtins.int], minimum: pulumi.Input[_builtins.int], version: pulumi.Input[_builtins.int]) -> None:
...
class PurviewConfigurationArgs:
    def __init__(__self__, *, purview_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def purview_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SelfHostedIntegrationRuntimeArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., linked_info: Optional[pulumi.Input[Union[LinkedIntegrationRuntimeKeyAuthorizationArgs, LinkedIntegrationRuntimeRbacAuthorizationArgs]]] = ...) -> None:
    ...
    @linked_info.setter
    def linked_info(self, value: Optional[pulumi.Input[Union[LinkedIntegrationRuntimeKeyAuthorizationArgs, LinkedIntegrationRuntimeRbacAuthorizationArgs]]]): # -> None:
        ...
...
class SparkConfigPropertiesArgs:
    def __init__(__self__, *, configuration_type: Optional[pulumi.Input[Union[_builtins.str, ConfigurationType]]] = ..., content: Optional[pulumi.Input[_builtins.str]] = ..., filename: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def configuration_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ConfigurationType]]]): # -> None:
        ...
...
class SqlPoolVulnerabilityAssessmentRuleBaselineItemArgs:
    def __init__(__self__, *, result: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @result.setter
    def result(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class TableLevelSharingPropertiesArgs:
    def __init__(__self__, *, external_tables_to_exclude: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., external_tables_to_include: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., materialized_views_to_exclude: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., materialized_views_to_include: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tables_to_exclude: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tables_to_include: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def external_tables_to_exclude(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def external_tables_to_include(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def materialized_views_to_exclude(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def materialized_views_to_include(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def tables_to_exclude(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def tables_to_include(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class VirtualNetworkProfileArgs:
    def __init__(__self__, *, compute_subnet_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def compute_subnet_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VulnerabilityAssessmentRecurringScansPropertiesArgs:
    def __init__(__self__, *, email_subscription_admins: Optional[pulumi.Input[_builtins.bool]] = ..., emails: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., is_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def email_subscription_admins(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class WorkspaceKeyDetailsArgs:
    def __init__(__self__, *, key_vault_url: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkspaceRepositoryConfigurationArgs:
    def __init__(__self__, *, account_name: Optional[pulumi.Input[_builtins.str]] = ..., collaboration_branch: Optional[pulumi.Input[_builtins.str]] = ..., host_name: Optional[pulumi.Input[_builtins.str]] = ..., last_commit_id: Optional[pulumi.Input[_builtins.str]] = ..., project_name: Optional[pulumi.Input[_builtins.str]] = ..., repository_name: Optional[pulumi.Input[_builtins.str]] = ..., root_folder: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def collaboration_branch(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @root_folder.setter
    def root_folder(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
