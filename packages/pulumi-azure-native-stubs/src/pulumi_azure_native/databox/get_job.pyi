...
class GetJobResult:
    ...
    def __init__(__self__, all_devices_lost=..., azure_api_version=..., cancellation_reason=..., delayed_stage=..., delivery_info=..., delivery_type=..., details=..., error=..., id=..., identity=..., is_cancellable=..., is_cancellable_without_fee=..., is_deletable=..., is_prepare_to_ship_enabled=..., is_shipping_address_editable=..., location=..., name=..., reverse_shipping_details_update=..., reverse_transport_preference_update=..., sku=..., start_time=..., status=..., system_data=..., tags=..., transfer_type=..., type=...) -> None:
        ...
...
def get_job(expand: Optional[_builtins.str] = ..., job_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetJobResult:
    
    ...

def get_job_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., job_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetJobResult]:
