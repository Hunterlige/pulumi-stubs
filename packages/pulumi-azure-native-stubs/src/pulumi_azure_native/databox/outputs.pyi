...
class AdditionalErrorInfoResponse(dict):
    ...
    def __init__(__self__, *, info: Optional[Any] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ApplianceNetworkConfigurationResponse(dict):
    ...
    def __init__(__self__, *, mac_address: _builtins.str, name: _builtins.str) -> None:
...
class AzureFileFilterDetailsResponse(dict):
    ...
    def __init__(__self__, *, file_path_list: Optional[Sequence[_builtins.str]] = ..., file_prefix_list: Optional[Sequence[_builtins.str]] = ..., file_share_list: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class BlobFilterDetailsResponse(dict):
    ...
    def __init__(__self__, *, blob_path_list: Optional[Sequence[_builtins.str]] = ..., blob_prefix_list: Optional[Sequence[_builtins.str]] = ..., container_list: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CloudErrorResponse(dict):
    ...
    def __init__(__self__, *, additional_info: Sequence[outputs.AdditionalErrorInfoResponse], details: Sequence[outputs.CloudErrorResponse], code: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ..., target: Optional[_builtins.str] = ...) -> None:
...
class ContactDetailsResponse(dict):
    ...
    def __init__(__self__, *, contact_name: _builtins.str, email_list: Sequence[_builtins.str], phone: _builtins.str, mobile: Optional[_builtins.str] = ..., notification_preference: Optional[Sequence[outputs.NotificationPreferenceResponse]] = ..., phone_extension: Optional[_builtins.str] = ...) -> None:
...
class ContactInfoResponse(dict):
    ...
    def __init__(__self__, *, contact_name: _builtins.str, phone: _builtins.str, mobile: Optional[_builtins.str] = ..., phone_extension: Optional[_builtins.str] = ...) -> None:
...
class CopyProgressResponse(dict):
    ...
    def __init__(__self__, *, account_id: _builtins.str, actions: Sequence[_builtins.str], bytes_processed: _builtins.float, data_account_type: _builtins.str, directories_errored_out: _builtins.float, error: outputs.CloudErrorResponse, files_errored_out: _builtins.float, files_processed: _builtins.float, invalid_directories_processed: _builtins.float, invalid_file_bytes_uploaded: _builtins.float, invalid_files_processed: _builtins.float, is_enumeration_in_progress: _builtins.bool, renamed_container_count: _builtins.float, storage_account_name: _builtins.str, total_bytes_to_process: _builtins.float, total_files_to_process: _builtins.float, transfer_type: _builtins.str) -> None:
...
class CustomerDiskJobSecretsResponse(dict):
    ...
    def __init__(__self__, *, carrier_account_number: _builtins.str, dc_access_security_code: outputs.DcAccessSecurityCodeResponse, disk_secrets: Sequence[outputs.DiskSecretResponse], error: outputs.CloudErrorResponse, job_secrets_type: _builtins.str) -> None:
...
class DataBoxAccountCopyLogDetailsResponse(dict):
    ...
    def __init__(__self__, *, account_name: _builtins.str, copy_log_details_type: _builtins.str, copy_log_link: _builtins.str, copy_verbose_log_link: _builtins.str) -> None:
...
class DataBoxCustomerDiskCopyLogDetailsResponse(dict):
    ...
    def __init__(__self__, *, copy_log_details_type: _builtins.str, error_log_link: _builtins.str, serial_number: _builtins.str, verbose_log_link: _builtins.str) -> None:
...
class DataBoxCustomerDiskCopyProgressResponse(dict):
    ...
    def __init__(__self__, *, account_id: _builtins.str, actions: Sequence[_builtins.str], bytes_processed: _builtins.float, copy_status: _builtins.str, data_account_type: _builtins.str, directories_errored_out: _builtins.float, error: outputs.CloudErrorResponse, files_errored_out: _builtins.float, files_processed: _builtins.float, invalid_directories_processed: _builtins.float, invalid_file_bytes_uploaded: _builtins.float, invalid_files_processed: _builtins.float, is_enumeration_in_progress: _builtins.bool, renamed_container_count: _builtins.float, serial_number: _builtins.str, storage_account_name: _builtins.str, total_bytes_to_process: _builtins.float, total_files_to_process: _builtins.float, transfer_type: _builtins.str) -> None:
...
class DataBoxCustomerDiskJobDetailsResponse(dict):
    ...
    def __init__(__self__, *, actions: Sequence[_builtins.str], chain_of_custody_sas_key: _builtins.str, contact_details: outputs.ContactDetailsResponse, copy_log_details: Sequence[Any], copy_progress: Sequence[outputs.DataBoxCustomerDiskCopyProgressResponse], data_center_code: _builtins.str, datacenter_address: Any, deliver_to_dc_package_details: outputs.PackageCarrierInfoResponse, delivery_package: outputs.PackageShippingDetailsResponse, device_erasure_details: outputs.DeviceErasureDetailsResponse, export_disk_details_collection: Mapping[str, outputs.ExportDiskDetailsResponse], job_details_type: _builtins.str, job_stages: Sequence[outputs.JobStagesResponse], last_mitigation_action_on_job: outputs.LastMitigationActionOnJobResponse, return_package: outputs.PackageShippingDetailsResponse, return_to_customer_package_details: outputs.PackageCarrierDetailsResponse, reverse_shipment_label_sas_key: _builtins.str, data_export_details: Optional[Sequence[outputs.DataExportDetailsResponse]] = ..., data_import_details: Optional[Sequence[outputs.DataImportDetailsResponse]] = ..., enable_manifest_backup: Optional[_builtins.bool] = ..., expected_data_size_in_tera_bytes: Optional[_builtins.int] = ..., import_disk_details_collection: Optional[Mapping[str, outputs.ImportDiskDetailsResponse]] = ..., key_encryption_key: Optional[outputs.KeyEncryptionKeyResponse] = ..., preferences: Optional[outputs.PreferencesResponse] = ..., reverse_shipping_details: Optional[outputs.ReverseShippingDetailsResponse] = ..., shipping_address: Optional[outputs.ShippingAddressResponse] = ...) -> None:
...
class DataBoxDiskCopyLogDetailsResponse(dict):
    ...
    def __init__(__self__, *, copy_log_details_type: _builtins.str, disk_serial_number: _builtins.str, error_log_link: _builtins.str, verbose_log_link: _builtins.str) -> None:
...
class DataBoxDiskCopyProgressResponse(dict):
    ...
    def __init__(__self__, *, actions: Sequence[_builtins.str], bytes_copied: _builtins.float, error: outputs.CloudErrorResponse, percent_complete: _builtins.int, serial_number: _builtins.str, status: _builtins.str) -> None:
...
class DataBoxDiskGranularCopyLogDetailsResponse(dict):
    ...
    def __init__(__self__, *, account_id: _builtins.str, copy_log_details_type: _builtins.str, error_log_link: _builtins.str, serial_number: _builtins.str, verbose_log_link: _builtins.str) -> None:
...
class DataBoxDiskJobDetailsResponse(dict):
    ...
    def __init__(__self__, *, actions: Sequence[_builtins.str], chain_of_custody_sas_key: _builtins.str, contact_details: outputs.ContactDetailsResponse, copy_log_details: Sequence[Any], copy_progress: Sequence[outputs.DataBoxDiskCopyProgressResponse], data_center_code: _builtins.str, datacenter_address: Any, delivery_package: outputs.PackageShippingDetailsResponse, device_erasure_details: outputs.DeviceErasureDetailsResponse, disks_and_size_details: Mapping[str, _builtins.int], granular_copy_log_details: Sequence[outputs.DataBoxDiskGranularCopyLogDetailsResponse], granular_copy_progress: Sequence[outputs.DataBoxDiskGranularCopyProgressResponse], job_details_type: _builtins.str, job_stages: Sequence[outputs.JobStagesResponse], last_mitigation_action_on_job: outputs.LastMitigationActionOnJobResponse, return_package: outputs.PackageShippingDetailsResponse, reverse_shipment_label_sas_key: _builtins.str, data_export_details: Optional[Sequence[outputs.DataExportDetailsResponse]] = ..., data_import_details: Optional[Sequence[outputs.DataImportDetailsResponse]] = ..., expected_data_size_in_tera_bytes: Optional[_builtins.int] = ..., key_encryption_key: Optional[outputs.KeyEncryptionKeyResponse] = ..., passkey: Optional[_builtins.str] = ..., preferences: Optional[outputs.PreferencesResponse] = ..., preferred_disks: Optional[Mapping[str, _builtins.int]] = ..., reverse_shipping_details: Optional[outputs.ReverseShippingDetailsResponse] = ..., shipping_address: Optional[outputs.ShippingAddressResponse] = ...) -> None:
...
class DataBoxDiskJobSecretsResponse(dict):
    ...
    def __init__(__self__, *, dc_access_security_code: outputs.DcAccessSecurityCodeResponse, disk_secrets: Sequence[outputs.DiskSecretResponse], error: outputs.CloudErrorResponse, is_passkey_user_defined: _builtins.bool, job_secrets_type: _builtins.str, pass_key: _builtins.str) -> None:
...
class DataBoxHeavyAccountCopyLogDetailsResponse(dict):
    ...
    def __init__(__self__, *, account_name: _builtins.str, copy_log_details_type: _builtins.str, copy_log_link: Sequence[_builtins.str], copy_verbose_log_link: Sequence[_builtins.str]) -> None:
...
class DataBoxHeavyJobDetailsResponse(dict):
    ...
    def __init__(__self__, *, actions: Sequence[_builtins.str], chain_of_custody_sas_key: _builtins.str, contact_details: outputs.ContactDetailsResponse, copy_log_details: Sequence[Any], copy_progress: Sequence[outputs.CopyProgressResponse], data_center_code: _builtins.str, datacenter_address: Any, delivery_package: outputs.PackageShippingDetailsResponse, device_erasure_details: outputs.DeviceErasureDetailsResponse, job_details_type: _builtins.str, job_stages: Sequence[outputs.JobStagesResponse], last_mitigation_action_on_job: outputs.LastMitigationActionOnJobResponse, return_package: outputs.PackageShippingDetailsResponse, reverse_shipment_label_sas_key: _builtins.str, data_export_details: Optional[Sequence[outputs.DataExportDetailsResponse]] = ..., data_import_details: Optional[Sequence[outputs.DataImportDetailsResponse]] = ..., device_password: Optional[_builtins.str] = ..., expected_data_size_in_tera_bytes: Optional[_builtins.int] = ..., key_encryption_key: Optional[outputs.KeyEncryptionKeyResponse] = ..., preferences: Optional[outputs.PreferencesResponse] = ..., reverse_shipping_details: Optional[outputs.ReverseShippingDetailsResponse] = ..., shipping_address: Optional[outputs.ShippingAddressResponse] = ...) -> None:
...
class DataBoxHeavyJobSecretsResponse(dict):
    ...
    def __init__(__self__, *, cabinet_pod_secrets: Sequence[outputs.DataBoxHeavySecretResponse], dc_access_security_code: outputs.DcAccessSecurityCodeResponse, error: outputs.CloudErrorResponse, job_secrets_type: _builtins.str) -> None:
...
class DataBoxHeavySecretResponse(dict):
    ...
    def __init__(__self__, *, account_credential_details: Sequence[outputs.AccountCredentialDetailsResponse], device_password: _builtins.str, device_serial_number: _builtins.str, encoded_validation_cert_pub_key: _builtins.str, network_configurations: Sequence[outputs.ApplianceNetworkConfigurationResponse]) -> None:
...
class DataExportDetailsResponse(dict):
    ...
    def __init__(__self__, *, account_details: Any, transfer_configuration: outputs.TransferConfigurationResponse, log_collection_level: Optional[_builtins.str] = ...) -> None:
...
class DataImportDetailsResponse(dict):
    ...
    def __init__(__self__, *, account_details: Any, log_collection_level: Optional[_builtins.str] = ...) -> None:
...
class DataboxJobSecretsResponse(dict):
    ...
    def __init__(__self__, *, dc_access_security_code: outputs.DcAccessSecurityCodeResponse, error: outputs.CloudErrorResponse, job_secrets_type: _builtins.str, pod_secrets: Optional[Sequence[outputs.DataBoxSecretResponse]] = ...) -> None:
...
class DatacenterAddressInstructionResponseResponse(dict):
    ...
    def __init__(__self__, *, communication_instruction: _builtins.str, data_center_azure_location: _builtins.str, datacenter_address_type: _builtins.str, supported_carriers_for_return_shipment: Sequence[_builtins.str]) -> None:
...
class DatacenterAddressLocationResponseResponse(dict):
    ...
    def __init__(__self__, *, additional_shipping_information: _builtins.str, address_type: _builtins.str, city: _builtins.str, company: _builtins.str, contact_person_name: _builtins.str, country: _builtins.str, data_center_azure_location: _builtins.str, datacenter_address_type: _builtins.str, phone: _builtins.str, phone_extension: _builtins.str, state: _builtins.str, street1: _builtins.str, street2: _builtins.str, street3: _builtins.str, supported_carriers_for_return_shipment: Sequence[_builtins.str], zip: _builtins.str) -> None:
...
class DcAccessSecurityCodeResponse(dict):
    ...
    def __init__(__self__, *, forward_dc_access_code: Optional[_builtins.str] = ..., reverse_dc_access_code: Optional[_builtins.str] = ...) -> None:
...
class DeviceErasureDetailsResponse(dict):
    ...
    def __init__(__self__, *, device_erasure_status: _builtins.str, erasure_or_destruction_certificate_sas_key: _builtins.str) -> None:
...
class DiskSecretResponse(dict):
    ...
    def __init__(__self__, *, bit_locker_key: _builtins.str, disk_serial_number: _builtins.str) -> None:
...
class EncryptionPreferencesResponse(dict):
    ...
    def __init__(__self__, *, double_encryption: Optional[_builtins.str] = ..., hardware_encryption: Optional[_builtins.str] = ...) -> None:
...
class ExportDiskDetailsResponse(dict):
    ...
    def __init__(__self__, *, backup_manifest_cloud_path: _builtins.str, manifest_file: _builtins.str, manifest_hash: _builtins.str) -> None:
...
class FilterFileDetailsResponse(dict):
    ...
    def __init__(__self__, *, filter_file_path: _builtins.str, filter_file_type: _builtins.str) -> None:
...
class IdentityPropertiesResponse(dict):
    ...
    def __init__(__self__, *, type: Optional[_builtins.str] = ..., user_assigned: Optional[outputs.UserAssignedPropertiesResponse] = ...) -> None:
...
class ImportDiskDetailsResponse(dict):
    ...
    def __init__(__self__, *, backup_manifest_cloud_path: _builtins.str, bit_locker_key: _builtins.str, manifest_file: _builtins.str, manifest_hash: _builtins.str) -> None:
...
class JobDelayDetailsResponse(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, error_code: _builtins.str, resolution_time: _builtins.str, start_time: _builtins.str, status: _builtins.str) -> None:
...
class JobDeliveryInfoResponse(dict):
    ...
    def __init__(__self__, *, scheduled_date_time: Optional[_builtins.str] = ...) -> None:
...
class JobStagesResponse(dict):
    ...
    def __init__(__self__, *, delay_information: Sequence[outputs.JobDelayDetailsResponse], display_name: _builtins.str, job_stage_details: Any, stage_name: _builtins.str, stage_status: _builtins.str, stage_time: _builtins.str) -> None:
...
class KeyEncryptionKeyResponse(dict):
    ...
    def __init__(__self__, *, kek_type: Optional[_builtins.str] = ..., identity_properties: Optional[outputs.IdentityPropertiesResponse] = ..., kek_url: Optional[_builtins.str] = ..., kek_vault_resource_id: Optional[_builtins.str] = ...) -> None:
...
class LastMitigationActionOnJobResponse(dict):
    ...
    def __init__(__self__, *, action_date_time_in_utc: Optional[_builtins.str] = ..., customer_resolution: Optional[_builtins.str] = ..., is_performed_by_customer: Optional[_builtins.bool] = ...) -> None:
...
class ManagedDiskDetailsResponse(dict):
    ...
    def __init__(__self__, *, data_account_type: Optional[_builtins.str] = ..., resource_group_id: _builtins.str, staging_storage_account_id: _builtins.str) -> None:
...
class NotificationPreferenceResponse(dict):
    ...
    def __init__(__self__, *, send_notification: Optional[_builtins.bool] = ..., stage_name: _builtins.str) -> None:
...
class PackageCarrierDetailsResponse(dict):
    ...
    def __init__(__self__, *, carrier_account_number: Optional[_builtins.str] = ..., carrier_name: Optional[_builtins.str] = ..., tracking_id: Optional[_builtins.str] = ...) -> None:
...
class PackageCarrierInfoResponse(dict):
    ...
    def __init__(__self__, *, carrier_name: Optional[_builtins.str] = ..., tracking_id: Optional[_builtins.str] = ...) -> None:
...
class PackageShippingDetailsResponse(dict):
    ...
    def __init__(__self__, *, carrier_name: _builtins.str, tracking_id: _builtins.str, tracking_url: _builtins.str) -> None:
...
class PreferencesResponse(dict):
    ...
    def __init__(__self__, *, encryption_preferences: Optional[outputs.EncryptionPreferencesResponse] = ..., preferred_data_center_region: Optional[Sequence[_builtins.str]] = ..., reverse_transport_preferences: Optional[outputs.TransportPreferencesResponse] = ..., storage_account_access_tier_preferences: Optional[Sequence[_builtins.str]] = ..., transport_preferences: Optional[outputs.TransportPreferencesResponse] = ...) -> None:
...
class ReverseShippingDetailsResponse(dict):
    ...
    def __init__(__self__, *, is_updated: _builtins.bool, contact_details: Optional[outputs.ContactInfoResponse] = ..., shipping_address: Optional[outputs.ShippingAddressResponse] = ...) -> None:
...
class ShareCredentialDetailsResponse(dict):
    ...
    def __init__(__self__, *, password: _builtins.str, share_name: _builtins.str, share_type: _builtins.str, supported_access_protocols: Sequence[_builtins.str], user_name: _builtins.str) -> None:
...
class ShippingAddressResponse(dict):
    ...
    def __init__(__self__, *, country: _builtins.str, street_address1: _builtins.str, address_type: Optional[_builtins.str] = ..., city: Optional[_builtins.str] = ..., company_name: Optional[_builtins.str] = ..., postal_code: Optional[_builtins.str] = ..., skip_address_validation: Optional[_builtins.bool] = ..., state_or_province: Optional[_builtins.str] = ..., street_address2: Optional[_builtins.str] = ..., street_address3: Optional[_builtins.str] = ..., tax_identification_number: Optional[_builtins.str] = ..., zip_extended_code: Optional[_builtins.str] = ...) -> None:
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *, model: _builtins.str, name: _builtins.str, display_name: Optional[_builtins.str] = ..., family: Optional[_builtins.str] = ...) -> None:
...
class StorageAccountDetailsResponse(dict):
    ...
    def __init__(__self__, *, data_account_type: Optional[_builtins.str] = ..., storage_account_id: _builtins.str) -> None:
...
class TransferAllDetailsResponse(dict):
    ...
    def __init__(__self__, *, data_account_type: Optional[_builtins.str] = ..., transfer_all_blobs: Optional[_builtins.bool] = ..., transfer_all_files: Optional[_builtins.bool] = ...) -> None:
...
class TransferConfigurationResponse(dict):
    ...
    def __init__(__self__, *, transfer_configuration_type: _builtins.str, transfer_all_details: Optional[outputs.TransferConfigurationResponseTransferAllDetails] = ..., transfer_filter_details: Optional[outputs.TransferConfigurationResponseTransferFilterDetails] = ...) -> None:
...
class TransferConfigurationResponseTransferAllDetails(dict):
    ...
    def __init__(__self__, *, include: Optional[outputs.TransferAllDetailsResponse] = ...) -> None:
...
class TransferConfigurationResponseTransferFilterDetails(dict):
    ...
    def __init__(__self__, *, include: Optional[outputs.TransferFilterDetailsResponse] = ...) -> None:
...
class TransferFilterDetailsResponse(dict):
    ...
    def __init__(__self__, *, data_account_type: Optional[_builtins.str] = ..., azure_file_filter_details: Optional[outputs.AzureFileFilterDetailsResponse] = ..., blob_filter_details: Optional[outputs.BlobFilterDetailsResponse] = ..., filter_file_details: Optional[Sequence[outputs.FilterFileDetailsResponse]] = ...) -> None:
...
class TransportPreferencesResponse(dict):
    ...
    def __init__(__self__, *, is_updated: _builtins.bool, preferred_shipment_type: _builtins.str) -> None:
