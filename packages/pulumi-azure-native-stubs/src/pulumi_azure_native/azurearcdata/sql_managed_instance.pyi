...
class SqlManagedInstanceArgs:
    def __init__(
        ...
        *,
        ...
        sku: Optional[pulumi.Input[SqlManagedInstanceSkuArgs]] = ...,
...
class SqlManagedInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        sku: Optional[
            pulumi.Input[
                Union[SqlManagedInstanceSkuArgs, SqlManagedInstanceSkuArgsDict]
            ]
        ] = ...,
        sql_managed_instance_name: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.SqlManagedInstancePropertiesResponse]: ...
    @_builtins.property
    @pulumi.getter
