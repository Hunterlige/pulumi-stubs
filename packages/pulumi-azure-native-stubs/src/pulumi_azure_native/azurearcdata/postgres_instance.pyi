...
class PostgresInstanceArgs:
    def __init__(
        ...
        *,
        ...
        sku: Optional[pulumi.Input[PostgresInstanceSkuArgs]] = ...,
...
class PostgresInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    PostgresInstancePropertiesArgs, PostgresInstancePropertiesArgsDict
                ]
            ]
        ] = ...,
        resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
        sku: Optional[
            pulumi.Input[Union[PostgresInstanceSkuArgs, PostgresInstanceSkuArgsDict]]
        ] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        __props__=...,
    ) -> None: ...
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.PostgresInstancePropertiesResponse]: ...
    @_builtins.property
    @pulumi.getter
