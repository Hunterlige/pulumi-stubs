...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetAndroidMAMPolicyByNameResult', 'AwaitableGetAndroidMAMPolicyByNameResult', 'get_android_mam_policy_by_name', 'get_android_mam_policy_by_name_output']
@pulumi.output_type
class GetAndroidMAMPolicyByNameResult:
    
    def __init__(__self__, access_recheck_offline_timeout=..., access_recheck_online_timeout=..., app_sharing_from_level=..., app_sharing_to_level=..., authentication=..., azure_api_version=..., clipboard_sharing_level=..., data_backup=..., description=..., device_compliance=..., file_encryption=..., file_sharing_save_as=..., friendly_name=..., group_status=..., id=..., last_modified_time=..., location=..., managed_browser=..., name=..., num_of_apps=..., offline_wipe_timeout=..., pin=..., pin_num_retry=..., screen_capture=..., tags=..., type=...) -> None:
        ...
    ...
    def file_encryption(self) -> Optional[_builtins.str]:
        ...
    ...
    def screen_capture(self) -> Optional[_builtins.str]:
        ...
...
class AwaitableGetAndroidMAMPolicyByNameResult(GetAndroidMAMPolicyByNameResult):
    def __await__(self): # -> Generator[Never, Any, GetAndroidMAMPolicyByNameResult]:
        ...
    


def get_android_mam_policy_by_name(host_name: Optional[_builtins.str] = ..., policy_name: Optional[_builtins.str] = ..., select: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAndroidMAMPolicyByNameResult:
    
    ...

def get_android_mam_policy_by_name_output(host_name: Optional[pulumi.Input[_builtins.str]] = ..., policy_name: Optional[pulumi.Input[_builtins.str]] = ..., select: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAndroidMAMPolicyByNameResult]:
