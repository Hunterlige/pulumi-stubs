...
class GetConnectorResult:
    ...
    def __init__(__self__, auth_info=..., azure_api_version=..., client_type=..., configuration_info=..., id=..., name=..., provisioning_state=..., public_network_solution=..., scope=..., secret_store=..., system_data=..., target_service=..., type=..., v_net_solution=...) -> None:
        ...
...
def get_connector(connector_name: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., subscription_id: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetConnectorResult:
    
    ...

def get_connector_output(connector_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetConnectorResult]:
