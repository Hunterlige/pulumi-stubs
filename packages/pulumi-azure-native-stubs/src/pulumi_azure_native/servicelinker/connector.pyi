...
@pulumi.input_type
class ConnectorArgs:
    def __init__(__self__, *, location: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], auth_info: Optional[pulumi.Input[Union[AccessKeyInfoBaseArgs, EasyAuthMicrosoftEntraIDAuthInfoArgs, SecretAuthInfoArgs, ServicePrincipalCertificateAuthInfoArgs, ServicePrincipalSecretAuthInfoArgs, SystemAssignedIdentityAuthInfoArgs, UserAccountAuthInfoArgs, UserAssignedIdentityAuthInfoArgs]]] = ..., client_type: Optional[pulumi.Input[Union[_builtins.str, ClientType]]] = ..., configuration_info: Optional[pulumi.Input[ConfigurationInfoArgs]] = ..., connector_name: Optional[pulumi.Input[_builtins.str]] = ..., public_network_solution: Optional[pulumi.Input[PublicNetworkSolutionArgs]] = ..., scope: Optional[pulumi.Input[_builtins.str]] = ..., secret_store: Optional[pulumi.Input[SecretStoreArgs]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., target_service: Optional[pulumi.Input[Union[AzureResourceArgs, ConfluentBootstrapServerArgs, ConfluentSchemaRegistryArgs, SelfHostedServerArgs]]] = ..., v_net_solution: Optional[pulumi.Input[VNetSolutionArgs]] = ...) -> None:
