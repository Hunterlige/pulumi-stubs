...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AdditionalCapabilitiesArgs', 'AdditionalCapabilitiesArgsDict', 'AdditionalLocationsProfileArgs', 'AdditionalLocationsProfileArgsDict', 'AdditionalUnattendContentArgs', 'AdditionalUnattendContentArgsDict', 'ApiEntityReferenceArgs', 'ApiEntityReferenceArgsDict', 'ApplicationProfileArgs', 'ApplicationProfileArgsDict', 'BaseVirtualMachineProfileArgs', 'BaseVirtualMachineProfileArgsDict', 'BootDiagnosticsArgs', 'BootDiagnosticsArgsDict', 'CapacityReservationProfileArgs', 'CapacityReservationProfileArgsDict', 'ComputeProfileArgs', 'ComputeProfileArgsDict', 'DiagnosticsProfileArgs', 'DiagnosticsProfileArgsDict', 'DiffDiskSettingsArgs', 'DiffDiskSettingsArgsDict', 'DiskEncryptionSetParametersArgs', 'DiskEncryptionSetParametersArgsDict', 'EncryptionIdentityArgs', 'EncryptionIdentityArgsDict', 'ImageReferenceArgs', 'ImageReferenceArgsDict', 'KeyVaultSecretReferenceArgs', 'KeyVaultSecretReferenceArgsDict', 'LinuxConfigurationArgs', 'LinuxConfigurationArgsDict', 'LinuxPatchSettingsArgs', 'LinuxPatchSettingsArgsDict', 'LinuxVMGuestPatchAutomaticByPlatformSettingsArgs', ..., 'LocationProfileArgs', 'LocationProfileArgsDict', 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'OSImageNotificationProfileArgs', 'OSImageNotificationProfileArgsDict', 'PatchSettingsArgs', 'PatchSettingsArgsDict', 'PlanArgs', 'PlanArgsDict', 'ProxyAgentSettingsArgs', 'ProxyAgentSettingsArgsDict', 'PublicIPAddressSkuArgs', 'PublicIPAddressSkuArgsDict', 'RegularPriorityProfileArgs', 'RegularPriorityProfileArgsDict', 'ScheduledEventsProfileArgs', 'ScheduledEventsProfileArgsDict', 'SecurityPostureReferenceArgs', 'SecurityPostureReferenceArgsDict', 'SecurityProfileArgs', 'SecurityProfileArgsDict', 'ServiceArtifactReferenceArgs', 'ServiceArtifactReferenceArgsDict', 'SpotPriorityProfileArgs', 'SpotPriorityProfileArgsDict', 'SshConfigurationArgs', 'SshConfigurationArgsDict', 'SshPublicKeyArgs', 'SshPublicKeyArgsDict', 'SubResourceArgs', 'SubResourceArgsDict', 'TerminateNotificationProfileArgs', 'TerminateNotificationProfileArgsDict', 'UefiSettingsArgs', 'UefiSettingsArgsDict', 'VMAttributeMinMaxDoubleArgs', 'VMAttributeMinMaxDoubleArgsDict', 'VMAttributeMinMaxIntegerArgs', 'VMAttributeMinMaxIntegerArgsDict', 'VMAttributesArgs', 'VMAttributesArgsDict', 'VMDiskSecurityProfileArgs', 'VMDiskSecurityProfileArgsDict', 'VMGalleryApplicationArgs', 'VMGalleryApplicationArgsDict', 'VMSizePropertiesArgs', 'VMSizePropertiesArgsDict', 'VaultCertificateArgs', 'VaultCertificateArgsDict', 'VaultSecretGroupArgs', 'VaultSecretGroupArgsDict', 'VirtualHardDiskArgs', 'VirtualHardDiskArgsDict', 'VirtualMachineScaleSetDataDiskArgs', 'VirtualMachineScaleSetDataDiskArgsDict', 'VirtualMachineScaleSetExtensionProfileArgs', 'VirtualMachineScaleSetExtensionProfileArgsDict', 'VirtualMachineScaleSetExtensionPropertiesArgs', 'VirtualMachineScaleSetExtensionPropertiesArgsDict', 'VirtualMachineScaleSetExtensionArgs', 'VirtualMachineScaleSetExtensionArgsDict', 'VirtualMachineScaleSetHardwareProfileArgs', 'VirtualMachineScaleSetHardwareProfileArgsDict', ..., ..., 'VirtualMachineScaleSetIPConfigurationArgs', 'VirtualMachineScaleSetIPConfigurationArgsDict', 'VirtualMachineScaleSetIpTagArgs', 'VirtualMachineScaleSetIpTagArgsDict', 'VirtualMachineScaleSetManagedDiskParametersArgs', ..., ..., ..., ..., ..., 'VirtualMachineScaleSetNetworkConfigurationArgs', 'VirtualMachineScaleSetNetworkConfigurationArgsDict', 'VirtualMachineScaleSetNetworkProfileArgs', 'VirtualMachineScaleSetNetworkProfileArgsDict', 'VirtualMachineScaleSetOSDiskArgs', 'VirtualMachineScaleSetOSDiskArgsDict', 'VirtualMachineScaleSetOSProfileArgs', 'VirtualMachineScaleSetOSProfileArgsDict', ..., ..., ..., ..., ..., ..., 'VirtualMachineScaleSetStorageProfileArgs', 'VirtualMachineScaleSetStorageProfileArgsDict', 'VmSizeProfileArgs', 'VmSizeProfileArgsDict', 'WinRMConfigurationArgs', 'WinRMConfigurationArgsDict', 'WinRMListenerArgs', 'WinRMListenerArgsDict', 'WindowsConfigurationArgs', 'WindowsConfigurationArgsDict', 'WindowsVMGuestPatchAutomaticByPlatformSettingsArgs', ...]
...
class AdditionalLocationsProfileArgs:
    def __init__(__self__, *, location_profiles: pulumi.Input[Sequence[pulumi.Input[LocationProfileArgs]]]) -> None:
    ...
    def location_profiles(self, value: pulumi.Input[Sequence[pulumi.Input[LocationProfileArgs]]]): # -> None:
        ...
...
class ComputeProfileArgs:
    def __init__(__self__, *, base_virtual_machine_profile: pulumi.Input[BaseVirtualMachineProfileArgs], additional_virtual_machine_capabilities: Optional[pulumi.Input[AdditionalCapabilitiesArgs]] = ..., compute_api_version: Optional[pulumi.Input[_builtins.str]] = ..., platform_fault_domain_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def base_virtual_machine_profile(self, value: pulumi.Input[BaseVirtualMachineProfileArgs]): # -> None:
        ...
    ...
    def additional_virtual_machine_capabilities(self, value: Optional[pulumi.Input[AdditionalCapabilitiesArgs]]): # -> None:
        ...
...
class LocationProfileArgs:
    def __init__(__self__, *, location: pulumi.Input[_builtins.str], virtual_machine_profile_override: Optional[pulumi.Input[BaseVirtualMachineProfileArgs]] = ...) -> None:
    ...
    def virtual_machine_profile_override(self, value: Optional[pulumi.Input[BaseVirtualMachineProfileArgs]]): # -> None:
        ...
...
class ProxyAgentSettingsArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., key_incarnation_id: Optional[pulumi.Input[_builtins.int]] = ..., mode: Optional[pulumi.Input[Union[_builtins.str, Mode]]] = ...) -> None:
...
class RegularPriorityProfileArgsDict(TypedDict):
    ...
    allocation_strategy: NotRequired[pulumi.Input[Union[_builtins.str, RegularPriorityAllocationStrategy]]]
...
class RegularPriorityProfileArgs:
    def __init__(__self__, *, allocation_strategy: Optional[pulumi.Input[Union[_builtins.str, RegularPriorityAllocationStrategy]]] = ..., capacity: Optional[pulumi.Input[_builtins.int]] = ..., min_capacity: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="allocationStrategy")
    def allocation_strategy(self) -> Optional[pulumi.Input[Union[_builtins.str, RegularPriorityAllocationStrategy]]]:
        
        ...
    
    @allocation_strategy.setter
    def allocation_strategy(self, value: Optional[pulumi.Input[Union[_builtins.str, RegularPriorityAllocationStrategy]]]): # -> None:
        ...
...
class SecurityPostureReferenceArgs:
    def __init__(__self__, *, exclude_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., is_overridable: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class SpotPriorityProfileArgsDict(TypedDict):
    ...
    allocation_strategy: NotRequired[pulumi.Input[Union[_builtins.str, SpotAllocationStrategy]]]
    capacity: NotRequired[pulumi.Input[_builtins.int]]
...
class SpotPriorityProfileArgs:
    def __init__(__self__, *, allocation_strategy: Optional[pulumi.Input[Union[_builtins.str, SpotAllocationStrategy]]] = ..., capacity: Optional[pulumi.Input[_builtins.int]] = ..., eviction_policy: Optional[pulumi.Input[Union[_builtins.str, EvictionPolicy]]] = ..., maintain: Optional[pulumi.Input[_builtins.bool]] = ..., max_price_per_vm: Optional[pulumi.Input[_builtins.float]] = ..., min_capacity: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="allocationStrategy")
    def allocation_strategy(self) -> Optional[pulumi.Input[Union[_builtins.str, SpotAllocationStrategy]]]:
        
        ...
    
    @allocation_strategy.setter
    def allocation_strategy(self, value: Optional[pulumi.Input[Union[_builtins.str, SpotAllocationStrategy]]]): # -> None:
        ...
    ...
    @maintain.setter
    def maintain(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class VMAttributesArgsDict(TypedDict):
    ...
    architecture_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ArchitectureType]]]]]
...
class VMAttributesArgs:
    ...
    def architecture_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ArchitectureType]]]]]:
        
        ...
    
    @architecture_types.setter
    def architecture_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ArchitectureType]]]]]): # -> None:
        ...
...
class VirtualMachineScaleSetExtensionArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[VirtualMachineScaleSetExtensionPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[VirtualMachineScaleSetExtensionPropertiesArgs]]): # -> None:
        ...
...
class VirtualMachineScaleSetIPConfigurationArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], properties: Optional[pulumi.Input[VirtualMachineScaleSetIPConfigurationPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[VirtualMachineScaleSetIPConfigurationPropertiesArgs]]): # -> None:
        ...
...
class VirtualMachineScaleSetNetworkConfigurationPropertiesArgs:
    def __init__(__self__, *, ip_configurations: pulumi.Input[Sequence[pulumi.Input[VirtualMachineScaleSetIPConfigurationArgs]]], auxiliary_mode: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceAuxiliaryMode]]] = ..., auxiliary_sku: Optional[pulumi.Input[Union[_builtins.str, NetworkInterfaceAuxiliarySku]]] = ..., delete_option: Optional[pulumi.Input[Union[_builtins.str, DeleteOptions]]] = ..., disable_tcp_state_tracking: Optional[pulumi.Input[_builtins.bool]] = ..., dns_settings: Optional[pulumi.Input[VirtualMachineScaleSetNetworkConfigurationDnsSettingsArgs]] = ..., enable_accelerated_networking: Optional[pulumi.Input[_builtins.bool]] = ..., enable_fpga: Optional[pulumi.Input[_builtins.bool]] = ..., enable_ip_forwarding: Optional[pulumi.Input[_builtins.bool]] = ..., network_security_group: Optional[pulumi.Input[SubResourceArgs]] = ..., primary: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class VirtualMachineScaleSetNetworkConfigurationArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], properties: Optional[pulumi.Input[VirtualMachineScaleSetNetworkConfigurationPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[VirtualMachineScaleSetNetworkConfigurationPropertiesArgs]]): # -> None:
        ...
...
class VirtualMachineScaleSetOSDiskArgs:
    def __init__(__self__, *, create_option: pulumi.Input[Union[_builtins.str, DiskCreateOptionTypes]], caching: Optional[pulumi.Input[Union[_builtins.str, CachingTypes]]] = ..., delete_option: Optional[pulumi.Input[Union[_builtins.str, DiskDeleteOptionTypes]]] = ..., diff_disk_settings: Optional[pulumi.Input[DiffDiskSettingsArgs]] = ..., disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., image: Optional[pulumi.Input[VirtualHardDiskArgs]] = ..., managed_disk: Optional[pulumi.Input[VirtualMachineScaleSetManagedDiskParametersArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., os_type: Optional[pulumi.Input[Union[_builtins.str, OperatingSystemTypes]]] = ..., vhd_containers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., write_accelerator_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class VirtualMachineScaleSetPublicIPAddressConfigurationPropertiesArgs:
    def __init__(__self__, *, delete_option: Optional[pulumi.Input[Union[_builtins.str, DeleteOptions]]] = ..., dns_settings: Optional[pulumi.Input[VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettingsArgs]] = ..., idle_timeout_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ip_tags: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualMachineScaleSetIpTagArgs]]]] = ..., public_ip_address_version: Optional[pulumi.Input[Union[_builtins.str, IPVersion]]] = ..., public_ip_prefix: Optional[pulumi.Input[SubResourceArgs]] = ...) -> None:
...
class VirtualMachineScaleSetPublicIPAddressConfigurationArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], properties: Optional[pulumi.Input[VirtualMachineScaleSetPublicIPAddressConfigurationPropertiesArgs]] = ..., sku: Optional[pulumi.Input[PublicIPAddressSkuArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[VirtualMachineScaleSetPublicIPAddressConfigurationPropertiesArgs]]): # -> None:
        ...
