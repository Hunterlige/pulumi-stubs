...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AdditionalCapabilitiesResponse', 'AdditionalLocationsProfileResponse', 'AdditionalUnattendContentResponse', 'ApiEntityReferenceResponse', 'ApplicationProfileResponse', 'BaseVirtualMachineProfileResponse', 'BootDiagnosticsResponse', 'CapacityReservationProfileResponse', 'ComputeProfileResponse', 'DiagnosticsProfileResponse', 'DiffDiskSettingsResponse', 'DiskEncryptionSetParametersResponse', 'EncryptionIdentityResponse', 'ImageReferenceResponse', 'KeyVaultSecretReferenceResponse', 'LinuxConfigurationResponse', 'LinuxPatchSettingsResponse', ..., 'LocationProfileResponse', 'ManagedServiceIdentityResponse', 'OSImageNotificationProfileResponse', 'PatchSettingsResponse', 'PlanResponse', 'ProxyAgentSettingsResponse', 'PublicIPAddressSkuResponse', 'RegularPriorityProfileResponse', 'ScheduledEventsProfileResponse', 'SecurityPostureReferenceResponse', 'SecurityProfileResponse', 'ServiceArtifactReferenceResponse', 'SpotPriorityProfileResponse', 'SshConfigurationResponse', 'SshPublicKeyResponse', 'SubResourceResponse', 'SystemDataResponse', 'TerminateNotificationProfileResponse', 'UefiSettingsResponse', 'UserAssignedIdentityResponse', 'VMAttributeMinMaxDoubleResponse', 'VMAttributeMinMaxIntegerResponse', 'VMAttributesResponse', 'VMDiskSecurityProfileResponse', 'VMGalleryApplicationResponse', 'VMSizePropertiesResponse', 'VaultCertificateResponse', 'VaultSecretGroupResponse', 'VirtualHardDiskResponse', 'VirtualMachineScaleSetDataDiskResponse', 'VirtualMachineScaleSetExtensionProfileResponse', 'VirtualMachineScaleSetExtensionPropertiesResponse', 'VirtualMachineScaleSetExtensionResponse', 'VirtualMachineScaleSetHardwareProfileResponse', ..., 'VirtualMachineScaleSetIPConfigurationResponse', 'VirtualMachineScaleSetIpTagResponse', ..., ..., ..., 'VirtualMachineScaleSetNetworkConfigurationResponse', 'VirtualMachineScaleSetNetworkProfileResponse', 'VirtualMachineScaleSetOSDiskResponse', 'VirtualMachineScaleSetOSProfileResponse', ..., ..., ..., 'VirtualMachineScaleSetStorageProfileResponse', 'VmSizeProfileResponse', 'WinRMConfigurationResponse', 'WinRMListenerResponse', 'WindowsConfigurationResponse', ...]
@pulumi.output_type
...
class AdditionalLocationsProfileResponse(dict):
    ...
    def __init__(__self__, *, location_profiles: Sequence[outputs.LocationProfileResponse]) -> None:
...
class AdditionalUnattendContentResponse(dict):
    ...
    def __init__(__self__, *, component_name: Optional[_builtins.str] = ..., pass_name: Optional[_builtins.str] = ..., setting_name: Optional[_builtins.str] = ...) -> None:
...
class BaseVirtualMachineProfileResponse(dict):
    ...
    def __init__(__self__, *, time_created: _builtins.str, application_profile: Optional[outputs.ApplicationProfileResponse] = ..., capacity_reservation: Optional[outputs.CapacityReservationProfileResponse] = ..., diagnostics_profile: Optional[outputs.DiagnosticsProfileResponse] = ..., extension_profile: Optional[outputs.VirtualMachineScaleSetExtensionProfileResponse] = ..., hardware_profile: Optional[outputs.VirtualMachineScaleSetHardwareProfileResponse] = ..., license_type: Optional[_builtins.str] = ..., network_profile: Optional[outputs.VirtualMachineScaleSetNetworkProfileResponse] = ..., os_profile: Optional[outputs.VirtualMachineScaleSetOSProfileResponse] = ..., scheduled_events_profile: Optional[outputs.ScheduledEventsProfileResponse] = ..., security_posture_reference: Optional[outputs.SecurityPostureReferenceResponse] = ..., security_profile: Optional[outputs.SecurityProfileResponse] = ..., service_artifact_reference: Optional[outputs.ServiceArtifactReferenceResponse] = ..., storage_profile: Optional[outputs.VirtualMachineScaleSetStorageProfileResponse] = ..., user_data: Optional[_builtins.str] = ...) -> None:
...
class ComputeProfileResponse(dict):
    ...
    def __init__(__self__, *, base_virtual_machine_profile: outputs.BaseVirtualMachineProfileResponse, additional_virtual_machine_capabilities: Optional[outputs.AdditionalCapabilitiesResponse] = ..., compute_api_version: Optional[_builtins.str] = ..., platform_fault_domain_count: Optional[_builtins.int] = ...) -> None:
...
class LocationProfileResponse(dict):
    ...
    def __init__(__self__, *, location: _builtins.str, virtual_machine_profile_override: Optional[outputs.BaseVirtualMachineProfileResponse] = ...) -> None:
...
class ProxyAgentSettingsResponse(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., key_incarnation_id: Optional[_builtins.int] = ..., mode: Optional[_builtins.str] = ...) -> None:
...
class RegularPriorityProfileResponse(dict):
    ...
    def __init__(__self__, *, allocation_strategy: Optional[_builtins.str] = ..., capacity: Optional[_builtins.int] = ..., min_capacity: Optional[_builtins.int] = ...) -> None:
...
class SecurityPostureReferenceResponse(dict):
    ...
    def __init__(__self__, *, exclude_extensions: Optional[Sequence[_builtins.str]] = ..., id: Optional[_builtins.str] = ..., is_overridable: Optional[_builtins.bool] = ...) -> None:
...
class SpotPriorityProfileResponse(dict):
    ...
    def __init__(__self__, *, allocation_strategy: Optional[_builtins.str] = ..., capacity: Optional[_builtins.int] = ..., eviction_policy: Optional[_builtins.str] = ..., maintain: Optional[_builtins.bool] = ..., max_price_per_vm: Optional[_builtins.float] = ..., min_capacity: Optional[_builtins.int] = ...) -> None:
...
class VirtualMachineScaleSetExtensionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, auto_upgrade_minor_version: Optional[_builtins.bool] = ..., enable_automatic_upgrade: Optional[_builtins.bool] = ..., force_update_tag: Optional[_builtins.str] = ..., protected_settings_from_key_vault: Optional[outputs.KeyVaultSecretReferenceResponse] = ..., provision_after_extensions: Optional[Sequence[_builtins.str]] = ..., publisher: Optional[_builtins.str] = ..., settings: Optional[Any] = ..., suppress_failures: Optional[_builtins.bool] = ..., type: Optional[_builtins.str] = ..., type_handler_version: Optional[_builtins.str] = ...) -> None:
...
class VirtualMachineScaleSetExtensionResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, type: _builtins.str, name: Optional[_builtins.str] = ..., properties: Optional[outputs.VirtualMachineScaleSetExtensionPropertiesResponse] = ...) -> None:
...
class VirtualMachineScaleSetIPConfigurationResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, properties: Optional[outputs.VirtualMachineScaleSetIPConfigurationPropertiesResponse] = ...) -> None:
...
class VirtualMachineScaleSetNetworkConfigurationResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, properties: Optional[outputs.VirtualMachineScaleSetNetworkConfigurationPropertiesResponse] = ...) -> None:
...
class VirtualMachineScaleSetOSProfileResponse(dict):
    ...
    def __init__(__self__, *, admin_username: Optional[_builtins.str] = ..., allow_extension_operations: Optional[_builtins.bool] = ..., computer_name_prefix: Optional[_builtins.str] = ..., linux_configuration: Optional[outputs.LinuxConfigurationResponse] = ..., require_guest_provision_signal: Optional[_builtins.bool] = ..., secrets: Optional[Sequence[outputs.VaultSecretGroupResponse]] = ..., windows_configuration: Optional[outputs.WindowsConfigurationResponse] = ...) -> None:
...
class VirtualMachineScaleSetPublicIPAddressConfigurationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, delete_option: Optional[_builtins.str] = ..., dns_settings: Optional[outputs.VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettingsResponse] = ..., idle_timeout_in_minutes: Optional[_builtins.int] = ..., ip_tags: Optional[Sequence[outputs.VirtualMachineScaleSetIpTagResponse]] = ..., public_ip_address_version: Optional[_builtins.str] = ..., public_ip_prefix: Optional[outputs.SubResourceResponse] = ...) -> None:
...
class VirtualMachineScaleSetPublicIPAddressConfigurationResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, properties: Optional[outputs.VirtualMachineScaleSetPublicIPAddressConfigurationPropertiesResponse] = ..., sku: Optional[outputs.PublicIPAddressSkuResponse] = ...) -> None:
