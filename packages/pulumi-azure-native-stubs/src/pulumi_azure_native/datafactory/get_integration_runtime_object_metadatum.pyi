...
def get_integration_runtime_object_metadatum(factory_name: Optional[_builtins.str] = ..., integration_runtime_name: Optional[_builtins.str] = ..., metadata_path: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetIntegrationRuntimeObjectMetadatumResult:
    
    ...

def get_integration_runtime_object_metadatum_output(factory_name: Optional[pulumi.Input[_builtins.str]] = ..., integration_runtime_name: Optional[pulumi.Input[_builtins.str]] = ..., metadata_path: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetIntegrationRuntimeObjectMetadatumResult]:
