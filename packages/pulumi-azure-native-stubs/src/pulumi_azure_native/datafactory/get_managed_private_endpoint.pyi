...
def get_managed_private_endpoint(factory_name: Optional[_builtins.str] = ..., managed_private_endpoint_name: Optional[_builtins.str] = ..., managed_virtual_network_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetManagedPrivateEndpointResult:
    
    ...

def get_managed_private_endpoint_output(factory_name: Optional[pulumi.Input[_builtins.str]] = ..., managed_private_endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., managed_virtual_network_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetManagedPrivateEndpointResult]:
