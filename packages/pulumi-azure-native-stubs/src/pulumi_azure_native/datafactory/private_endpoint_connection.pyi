...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *, factory_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[PrivateLinkConnectionApprovalRequestArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[PrivateLinkConnectionApprovalRequestArgs]]): # -> None:
        ...
...
class PrivateEndpointConnection(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., factory_name: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[PrivateLinkConnectionApprovalRequestArgs, PrivateLinkConnectionApprovalRequestArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
