...
class AddRemoveReplicaScalingMechanismResponse(dict):
    ...
    def __init__(__self__, *, kind: _builtins.str, max_count: _builtins.int, min_count: _builtins.int, scale_increment: _builtins.int) -> None:
...
class ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskResponse(dict):
    ...
    def __init__(__self__, *, kind: _builtins.str, size_disk: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class ApplicationScopedVolumeResponse(dict):
    ...
    def __init__(__self__, *, creation_parameters: outputs.ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskResponse, destination_path: _builtins.str, name: _builtins.str, read_only: Optional[_builtins.bool] = ...) -> None:
...
class AutoScalingPolicyResponse(dict):
    ...
    def __init__(__self__, *, mechanism: outputs.AddRemoveReplicaScalingMechanismResponse, name: _builtins.str, trigger: outputs.AverageLoadScalingTriggerResponse) -> None:
...
class AverageLoadScalingTriggerResponse(dict):
    ...
    def __init__(__self__, *, kind: _builtins.str, lower_load_threshold: _builtins.float, metric: outputs.AutoScalingResourceMetricResponse, scale_interval_in_seconds: _builtins.int, upper_load_threshold: _builtins.float) -> None:
...
class AzureInternalMonitoringPipelineSinkDescriptionResponse(dict):
    ...
    def __init__(__self__, *, kind: _builtins.str, account_name: Optional[_builtins.str] = ..., auto_key_config_url: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., fluentd_config_url: Optional[Any] = ..., ma_config_url: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., namespace: Optional[_builtins.str] = ...) -> None:
...
class ContainerCodePackagePropertiesResponse(dict):
    ...
    def __init__(__self__, *, image: _builtins.str, instance_view: outputs.ContainerInstanceViewResponse, name: _builtins.str, resources: outputs.ResourceRequirementsResponse, commands: Optional[Sequence[_builtins.str]] = ..., diagnostics: Optional[outputs.DiagnosticsRefResponse] = ..., endpoints: Optional[Sequence[outputs.EndpointPropertiesResponse]] = ..., entrypoint: Optional[_builtins.str] = ..., environment_variables: Optional[Sequence[outputs.EnvironmentVariableResponse]] = ..., image_registry_credential: Optional[outputs.ImageRegistryCredentialResponse] = ..., labels: Optional[Sequence[outputs.ContainerLabelResponse]] = ..., reliable_collections_refs: Optional[Sequence[outputs.ReliableCollectionsRefResponse]] = ..., settings: Optional[Sequence[outputs.SettingResponse]] = ..., volume_refs: Optional[Sequence[outputs.VolumeReferenceResponse]] = ..., volumes: Optional[Sequence[outputs.ApplicationScopedVolumeResponse]] = ...) -> None:
...
class ContainerEventResponse(dict):
    ...
    def __init__(__self__, *, count: Optional[_builtins.int] = ..., first_timestamp: Optional[_builtins.str] = ..., last_timestamp: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ContainerInstanceViewResponse(dict):
    ...
    def __init__(__self__, *, current_state: Optional[outputs.ContainerStateResponse] = ..., events: Optional[Sequence[outputs.ContainerEventResponse]] = ..., previous_state: Optional[outputs.ContainerStateResponse] = ..., restart_count: Optional[_builtins.int] = ...) -> None:
...
class ContainerStateResponse(dict):
    ...
    def __init__(__self__, *, detail_status: Optional[_builtins.str] = ..., exit_code: Optional[_builtins.str] = ..., finish_time: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class DiagnosticsDescriptionResponse(dict):
    ...
    def __init__(__self__, *, default_sink_refs: Optional[Sequence[_builtins.str]] = ..., enabled: Optional[_builtins.bool] = ..., sinks: Optional[Sequence[outputs.AzureInternalMonitoringPipelineSinkDescriptionResponse]] = ...) -> None:
...
class DiagnosticsRefResponse(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., sink_refs: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class EndpointPropertiesResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, port: Optional[_builtins.int] = ...) -> None:
...
class GatewayDestinationResponse(dict):
    ...
    def __init__(__self__, *, application_name: _builtins.str, endpoint_name: _builtins.str, service_name: _builtins.str) -> None:
...
class HttpConfigResponse(dict):
    ...
    def __init__(__self__, *, hosts: Sequence[outputs.HttpHostConfigResponse], name: _builtins.str, port: _builtins.int) -> None:
...
class HttpHostConfigResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, routes: Sequence[outputs.HttpRouteConfigResponse]) -> None:
...
class HttpRouteConfigResponse(dict):
    ...
    def __init__(__self__, *, destination: outputs.GatewayDestinationResponse, match: outputs.HttpRouteMatchRuleResponse, name: _builtins.str) -> None:
...
class HttpRouteMatchHeaderResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, type: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class HttpRouteMatchPathResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, value: _builtins.str, rewrite: Optional[_builtins.str] = ...) -> None:
...
class HttpRouteMatchRuleResponse(dict):
    ...
    def __init__(__self__, *, path: outputs.HttpRouteMatchPathResponse, headers: Optional[Sequence[outputs.HttpRouteMatchHeaderResponse]] = ...) -> None:
...
class ImageRegistryCredentialResponse(dict):
    ...
    def __init__(__self__, *, server: _builtins.str, username: _builtins.str, password: Optional[_builtins.str] = ...) -> None:
...
class NetworkRefResponse(dict):
    ...
    def __init__(__self__, *, endpoint_refs: Optional[Sequence[outputs.EndpointRefResponse]] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class NetworkResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, kind: _builtins.str, provisioning_state: _builtins.str, status: _builtins.str, status_details: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class ReliableCollectionsRefResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, do_not_persist_state: Optional[_builtins.bool] = ...) -> None:
...
class ResourceLimitsResponse(dict):
    ...
    def __init__(__self__, *, cpu: Optional[_builtins.float] = ..., memory_in_gb: Optional[_builtins.float] = ...) -> None:
...
class ResourceRequestsResponse(dict):
    ...
    def __init__(__self__, *, cpu: _builtins.float, memory_in_gb: _builtins.float) -> None:
...
class SecretResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, kind: _builtins.str, provisioning_state: _builtins.str, status: _builtins.str, status_details: _builtins.str, content_type: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class ServiceResourceDescriptionResponse(dict):
    ...
    def __init__(__self__, *, code_packages: Sequence[outputs.ContainerCodePackagePropertiesResponse], health_state: _builtins.str, id: _builtins.str, os_type: _builtins.str, provisioning_state: _builtins.str, status: _builtins.str, status_details: _builtins.str, type: _builtins.str, unhealthy_evaluation: _builtins.str, auto_scaling_policies: Optional[Sequence[outputs.AutoScalingPolicyResponse]] = ..., description: Optional[_builtins.str] = ..., diagnostics: Optional[outputs.DiagnosticsRefResponse] = ..., name: Optional[_builtins.str] = ..., network_refs: Optional[Sequence[outputs.NetworkRefResponse]] = ..., replica_count: Optional[_builtins.int] = ...) -> None:
...
class TcpConfigResponse(dict):
    ...
    def __init__(__self__, *, destination: outputs.GatewayDestinationResponse, name: _builtins.str, port: _builtins.int) -> None:
...
class VolumeProviderParametersAzureFileResponse(dict):
    ...
    def __init__(__self__, *, account_name: _builtins.str, share_name: _builtins.str, account_key: Optional[_builtins.str] = ...) -> None:
...
class VolumeReferenceResponse(dict):
    ...
    def __init__(__self__, *, destination_path: _builtins.str, name: _builtins.str, read_only: Optional[_builtins.bool] = ...) -> None:
