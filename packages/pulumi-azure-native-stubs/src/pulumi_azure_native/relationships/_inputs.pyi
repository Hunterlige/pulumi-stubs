...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DependencyOfRelationshipPropertiesArgs', 'DependencyOfRelationshipPropertiesArgsDict', 'ServiceGroupMemberRelationshipPropertiesArgs', 'ServiceGroupMemberRelationshipPropertiesArgsDict']
...
class DependencyOfRelationshipPropertiesArgs:
    def __init__(__self__, *, target_id: pulumi.Input[_builtins.str], target_tenant: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def target_tenant(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
