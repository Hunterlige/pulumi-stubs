...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['InstancePropertiesArgs', 'InstancePropertiesArgsDict', 'LiftrBaseMarketplaceDetailsArgs', 'LiftrBaseMarketplaceDetailsArgsDict', 'LiftrBaseOfferDetailsArgs', 'LiftrBaseOfferDetailsArgsDict', 'LiftrBaseSingleSignOnPropertiesV2Args', 'LiftrBaseSingleSignOnPropertiesV2ArgsDict', 'LiftrBaseUserDetailsArgs', 'LiftrBaseUserDetailsArgsDict', 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'PartnerPropertiesArgs', 'PartnerPropertiesArgsDict']
...
class InstancePropertiesArgs:
    def __init__(__self__, *, marketplace: pulumi.Input[LiftrBaseMarketplaceDetailsArgs], user: pulumi.Input[LiftrBaseUserDetailsArgs], partner_properties: Optional[pulumi.Input[PartnerPropertiesArgs]] = ..., single_sign_on_properties: Optional[pulumi.Input[LiftrBaseSingleSignOnPropertiesV2Args]] = ...) -> None:
    ...
    @marketplace.setter
    def marketplace(self, value: pulumi.Input[LiftrBaseMarketplaceDetailsArgs]): # -> None:
        ...
    ...
    @user.setter
    def user(self, value: pulumi.Input[LiftrBaseUserDetailsArgs]): # -> None:
        ...
    ...
    def partner_properties(self, value: Optional[pulumi.Input[PartnerPropertiesArgs]]): # -> None:
        ...
    ...
    def single_sign_on_properties(self, value: Optional[pulumi.Input[LiftrBaseSingleSignOnPropertiesV2Args]]): # -> None:
        ...
...
class LiftrBaseMarketplaceDetailsArgs:
    def __init__(__self__, *, offer_details: pulumi.Input[LiftrBaseOfferDetailsArgs], subscription_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def offer_details(self, value: pulumi.Input[LiftrBaseOfferDetailsArgs]): # -> None:
        ...
...
class LiftrBaseOfferDetailsArgs:
    def __init__(__self__, *, offer_id: pulumi.Input[_builtins.str], plan_id: pulumi.Input[_builtins.str], publisher_id: pulumi.Input[_builtins.str], plan_name: Optional[pulumi.Input[_builtins.str]] = ..., term_id: Optional[pulumi.Input[_builtins.str]] = ..., term_unit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @term_unit.setter
    def term_unit(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LiftrBaseSingleSignOnPropertiesV2Args:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, SingleSignOnType]], aad_domains: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., enterprise_app_id: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, SingleSignOnStates]]] = ..., url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, SingleSignOnType]]): # -> None:
        ...
    ...
    @aad_domains.setter
    def aad_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def enterprise_app_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[_builtins.str, SingleSignOnStates]]]): # -> None:
        ...
...
class LiftrBaseUserDetailsArgs:
    def __init__(__self__, *, email_address: Optional[pulumi.Input[_builtins.str]] = ..., first_name: Optional[pulumi.Input[_builtins.str]] = ..., last_name: Optional[pulumi.Input[_builtins.str]] = ..., phone_number: Optional[pulumi.Input[_builtins.str]] = ..., upn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @upn.setter
    def upn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PartnerPropertiesArgs:
    def __init__(__self__, *, region: pulumi.Input[Union[_builtins.str, Region]], subdomain: pulumi.Input[_builtins.str]) -> None:
    ...
    @region.setter
    def region(self, value: pulumi.Input[Union[_builtins.str, Region]]): # -> None:
        ...
