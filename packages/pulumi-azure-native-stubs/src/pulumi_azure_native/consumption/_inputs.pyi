...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BudgetComparisonExpressionArgs', 'BudgetComparisonExpressionArgsDict', 'BudgetFilterPropertiesArgs', 'BudgetFilterPropertiesArgsDict', 'BudgetFilterArgs', 'BudgetFilterArgsDict', 'BudgetTimePeriodArgs', 'BudgetTimePeriodArgsDict', 'NotificationArgs', 'NotificationArgsDict']
...
class NotificationArgs:
    def __init__(__self__, *, contact_emails: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], enabled: pulumi.Input[_builtins.bool], operator: pulumi.Input[Union[_builtins.str, OperatorType]], threshold: pulumi.Input[_builtins.float], contact_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., contact_roles: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., locale: Optional[pulumi.Input[Union[_builtins.str, CultureCode]]] = ..., threshold_type: Optional[pulumi.Input[Union[_builtins.str, ThresholdType]]] = ...) -> None:
