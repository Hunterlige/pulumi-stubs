...
@pulumi.input_type
class BudgetArgs:
    def __init__(__self__, *, amount: pulumi.Input[_builtins.float], category: pulumi.Input[Union[_builtins.str, CategoryType]], scope: pulumi.Input[_builtins.str], time_grain: pulumi.Input[Union[_builtins.str, TimeGrainType]], time_period: pulumi.Input[BudgetTimePeriodArgs], budget_name: Optional[pulumi.Input[_builtins.str]] = ..., e_tag: Optional[pulumi.Input[_builtins.str]] = ..., filter: Optional[pulumi.Input[BudgetFilterArgs]] = ..., notifications: Optional[pulumi.Input[Mapping[str, pulumi.Input[NotificationArgs]]]] = ...) -> None:
    ...
    @amount.setter
    def amount(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
