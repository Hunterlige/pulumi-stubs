...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'RetentionPolicyDetailsArgs', 'RetentionPolicyDetailsArgsDict', 'RetentionPolicyPropertiesArgs', 'RetentionPolicyPropertiesArgsDict', 'SchedulerPropertiesArgs', 'SchedulerPropertiesArgsDict', 'SchedulerSkuArgs', 'SchedulerSkuArgsDict']
...
class RetentionPolicyDetailsArgs:
    def __init__(__self__, *, retention_period_in_days: pulumi.Input[_builtins.int], orchestration_state: Optional[pulumi.Input[Union[_builtins.str, PurgeableOrchestrationState]]] = ...) -> None:
    ...
    def orchestration_state(self, value: Optional[pulumi.Input[Union[_builtins.str, PurgeableOrchestrationState]]]): # -> None:
        ...
...
class RetentionPolicyPropertiesArgs:
    def __init__(__self__, *, retention_policies: Optional[pulumi.Input[Sequence[pulumi.Input[RetentionPolicyDetailsArgs]]]] = ...) -> None:
    ...
    def retention_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RetentionPolicyDetailsArgs]]]]): # -> None:
        ...
...
class SchedulerPropertiesArgs:
    def __init__(__self__, *, ip_allowlist: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], sku: pulumi.Input[SchedulerSkuArgs]) -> None:
    ...
    @ip_allowlist.setter
    def ip_allowlist(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @sku.setter
    def sku(self, value: pulumi.Input[SchedulerSkuArgs]): # -> None:
        ...
...
class SchedulerSkuArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], capacity: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
