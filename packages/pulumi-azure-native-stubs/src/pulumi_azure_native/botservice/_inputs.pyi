...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AcsChatChannelArgs', 'AcsChatChannelArgsDict', 'AlexaChannelPropertiesArgs', 'AlexaChannelPropertiesArgsDict', 'AlexaChannelArgs', 'AlexaChannelArgsDict', 'BotPropertiesArgs', 'BotPropertiesArgsDict', 'ConnectionSettingParameterArgs', 'ConnectionSettingParameterArgsDict', 'ConnectionSettingPropertiesArgs', 'ConnectionSettingPropertiesArgsDict', 'DirectLineChannelPropertiesArgs', 'DirectLineChannelPropertiesArgsDict', 'DirectLineChannelArgs', 'DirectLineChannelArgsDict', 'DirectLineSiteArgs', 'DirectLineSiteArgsDict', 'DirectLineSpeechChannelPropertiesArgs', 'DirectLineSpeechChannelPropertiesArgsDict', 'DirectLineSpeechChannelArgs', 'DirectLineSpeechChannelArgsDict', 'EmailChannelPropertiesArgs', 'EmailChannelPropertiesArgsDict', 'EmailChannelArgs', 'EmailChannelArgsDict', 'FacebookChannelPropertiesArgs', 'FacebookChannelPropertiesArgsDict', 'FacebookChannelArgs', 'FacebookChannelArgsDict', 'FacebookPageArgs', 'FacebookPageArgsDict', 'KikChannelPropertiesArgs', 'KikChannelPropertiesArgsDict', 'KikChannelArgs', 'KikChannelArgsDict', 'LineChannelPropertiesArgs', 'LineChannelPropertiesArgsDict', 'LineChannelArgs', 'LineChannelArgsDict', 'LineRegistrationArgs', 'LineRegistrationArgsDict', 'M365ExtensionsArgs', 'M365ExtensionsArgsDict', 'MsTeamsChannelPropertiesArgs', 'MsTeamsChannelPropertiesArgsDict', 'MsTeamsChannelArgs', 'MsTeamsChannelArgsDict', 'OmnichannelArgs', 'OmnichannelArgsDict', 'OutlookChannelArgs', 'OutlookChannelArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'SearchAssistantArgs', 'SearchAssistantArgsDict', 'SkuArgs', 'SkuArgsDict', 'SkypeChannelPropertiesArgs', 'SkypeChannelPropertiesArgsDict', 'SkypeChannelArgs', 'SkypeChannelArgsDict', 'SlackChannelPropertiesArgs', 'SlackChannelPropertiesArgsDict', 'SlackChannelArgs', 'SlackChannelArgsDict', 'SmsChannelPropertiesArgs', 'SmsChannelPropertiesArgsDict', 'SmsChannelArgs', 'SmsChannelArgsDict', 'TelegramChannelPropertiesArgs', 'TelegramChannelPropertiesArgsDict', 'TelegramChannelArgs', 'TelegramChannelArgsDict', 'TelephonyChannelPropertiesArgs', 'TelephonyChannelPropertiesArgsDict', 'TelephonyChannelResourceApiConfigurationArgs', 'TelephonyChannelResourceApiConfigurationArgsDict', 'TelephonyChannelArgs', 'TelephonyChannelArgsDict', 'TelephonyPhoneNumbersArgs', 'TelephonyPhoneNumbersArgsDict', 'WebChatChannelPropertiesArgs', 'WebChatChannelPropertiesArgsDict', 'WebChatChannelArgs', 'WebChatChannelArgsDict', 'WebChatSiteArgs', 'WebChatSiteArgsDict']
...
class AcsChatChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AlexaChannelPropertiesArgs:
    def __init__(__self__, *, alexa_skill_id: pulumi.Input[_builtins.str], is_enabled: pulumi.Input[_builtins.bool]) -> None:
    ...
    def alexa_skill_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AlexaChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[AlexaChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[AlexaChannelPropertiesArgs]]): # -> None:
        ...
...
class BotPropertiesArgs:
    def __init__(__self__, *, display_name: pulumi.Input[_builtins.str], endpoint: pulumi.Input[_builtins.str], msa_app_id: pulumi.Input[_builtins.str], all_settings: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., app_password_hint: Optional[pulumi.Input[_builtins.str]] = ..., cmek_key_vault_url: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., developer_app_insight_key: Optional[pulumi.Input[_builtins.str]] = ..., developer_app_insights_api_key: Optional[pulumi.Input[_builtins.str]] = ..., developer_app_insights_application_id: Optional[pulumi.Input[_builtins.str]] = ..., disable_local_auth: Optional[pulumi.Input[_builtins.bool]] = ..., icon_url: Optional[pulumi.Input[_builtins.str]] = ..., is_cmek_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_streaming_supported: Optional[pulumi.Input[_builtins.bool]] = ..., luis_app_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., luis_key: Optional[pulumi.Input[_builtins.str]] = ..., manifest_url: Optional[pulumi.Input[_builtins.str]] = ..., msa_app_msi_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., msa_app_tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., msa_app_type: Optional[pulumi.Input[Union[_builtins.str, MsaAppType]]] = ..., open_with_hint: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., publishing_credentials: Optional[pulumi.Input[_builtins.str]] = ..., schema_transformation_version: Optional[pulumi.Input[_builtins.str]] = ..., storage_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @msa_app_id.setter
    def msa_app_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="allSettings")
    def all_settings(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @all_settings.setter
    def all_settings(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def app_password_hint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def cmek_key_vault_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def developer_app_insight_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def developer_app_insights_api_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def developer_app_insights_application_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def is_cmek_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_streaming_supported(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @luis_app_ids.setter
    def luis_app_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @luis_key.setter
    def luis_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @manifest_url.setter
    def manifest_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def msa_app_msi_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def msa_app_tenant_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="msaAppType")
    def msa_app_type(self) -> Optional[pulumi.Input[Union[_builtins.str, MsaAppType]]]:
        
        ...
    
    @msa_app_type.setter
    def msa_app_type(self, value: Optional[pulumi.Input[Union[_builtins.str, MsaAppType]]]): # -> None:
        ...
    ...
    def open_with_hint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def publishing_credentials(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="schemaTransformationVersion")
    def schema_transformation_version(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @schema_transformation_version.setter
    def schema_transformation_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def storage_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectionSettingPropertiesArgs:
    def __init__(__self__, *, client_id: Optional[pulumi.Input[_builtins.str]] = ..., client_secret: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ConnectionSettingParameterArgs]]]] = ..., provisioning_state: Optional[pulumi.Input[_builtins.str]] = ..., scopes: Optional[pulumi.Input[_builtins.str]] = ..., service_provider_display_name: Optional[pulumi.Input[_builtins.str]] = ..., service_provider_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ConnectionSettingParameterArgs]]]]): # -> None:
        ...
    ...
    @scopes.setter
    def scopes(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="serviceProviderDisplayName")
    def service_provider_display_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @service_provider_display_name.setter
    def service_provider_display_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def service_provider_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DirectLineChannelPropertiesArgs:
    def __init__(__self__, *, direct_line_embed_code: Optional[pulumi.Input[_builtins.str]] = ..., extension_key1: Optional[pulumi.Input[_builtins.str]] = ..., extension_key2: Optional[pulumi.Input[_builtins.str]] = ..., sites: Optional[pulumi.Input[Sequence[pulumi.Input[DirectLineSiteArgs]]]] = ...) -> None:
    ...
    def direct_line_embed_code(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def extension_key1(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def extension_key2(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @sites.setter
    def sites(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DirectLineSiteArgs]]]]): # -> None:
        ...
...
class DirectLineChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[DirectLineChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[DirectLineChannelPropertiesArgs]]): # -> None:
        ...
...
class DirectLineSiteArgs:
    def __init__(__self__, *, is_enabled: pulumi.Input[_builtins.bool], site_name: pulumi.Input[_builtins.str], app_id: Optional[pulumi.Input[_builtins.str]] = ..., e_tag: Optional[pulumi.Input[_builtins.str]] = ..., is_block_user_upload_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_detailed_logging_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_endpoint_parameters_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_no_storage_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_secure_site_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_v1_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_v3_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_web_chat_speech_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_webchat_preview_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., trusted_origins: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def is_block_user_upload_enabled(self) -> Optional[pulumi.Input[_builtins.bool]]:
        
        ...
    
    @is_block_user_upload_enabled.setter
    def is_block_user_upload_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_detailed_logging_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="isEndpointParametersEnabled")
    def is_endpoint_parameters_enabled(self) -> Optional[pulumi.Input[_builtins.bool]]:
        
        ...
    
    @is_endpoint_parameters_enabled.setter
    def is_endpoint_parameters_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_no_storage_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_secure_site_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_v1_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_v3_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_web_chat_speech_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_webchat_preview_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def trusted_origins(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DirectLineSpeechChannelPropertiesArgs:
    def __init__(__self__, *, cognitive_service_region: Optional[pulumi.Input[_builtins.str]] = ..., cognitive_service_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., cognitive_service_subscription_key: Optional[pulumi.Input[_builtins.str]] = ..., custom_speech_model_id: Optional[pulumi.Input[_builtins.str]] = ..., custom_voice_deployment_id: Optional[pulumi.Input[_builtins.str]] = ..., is_default_bot_for_cog_svc_account: Optional[pulumi.Input[_builtins.bool]] = ..., is_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def cognitive_service_region(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="cognitiveServiceResourceId")
    def cognitive_service_resource_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @cognitive_service_resource_id.setter
    def cognitive_service_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="cognitiveServiceSubscriptionKey")
    def cognitive_service_subscription_key(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @cognitive_service_subscription_key.setter
    def cognitive_service_subscription_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def custom_speech_model_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def custom_voice_deployment_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="isDefaultBotForCogSvcAccount")
    def is_default_bot_for_cog_svc_account(self) -> Optional[pulumi.Input[_builtins.bool]]:
        
        ...
    
    @is_default_bot_for_cog_svc_account.setter
    def is_default_bot_for_cog_svc_account(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DirectLineSpeechChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[DirectLineSpeechChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[DirectLineSpeechChannelPropertiesArgs]]): # -> None:
        ...
...
class EmailChannelPropertiesArgs:
    def __init__(__self__, *, email_address: pulumi.Input[_builtins.str], is_enabled: pulumi.Input[_builtins.bool], auth_method: Optional[pulumi.Input[_builtins.float]] = ..., magic_code: Optional[pulumi.Input[_builtins.str]] = ..., password: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @auth_method.setter
    def auth_method(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @magic_code.setter
    def magic_code(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EmailChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[EmailChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[EmailChannelPropertiesArgs]]): # -> None:
        ...
...
class FacebookChannelPropertiesArgs:
    def __init__(__self__, *, app_id: pulumi.Input[_builtins.str], is_enabled: pulumi.Input[_builtins.bool], app_secret: Optional[pulumi.Input[_builtins.str]] = ..., pages: Optional[pulumi.Input[Sequence[pulumi.Input[FacebookPageArgs]]]] = ...) -> None:
    ...
    @pages.setter
    def pages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FacebookPageArgs]]]]): # -> None:
        ...
...
class FacebookChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[FacebookChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[FacebookChannelPropertiesArgs]]): # -> None:
        ...
...
class FacebookPageArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], access_token: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class KikChannelPropertiesArgs:
    def __init__(__self__, *, is_enabled: pulumi.Input[_builtins.bool], user_name: pulumi.Input[_builtins.str], api_key: Optional[pulumi.Input[_builtins.str]] = ..., is_validated: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @is_validated.setter
    def is_validated(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class KikChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[KikChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[KikChannelPropertiesArgs]]): # -> None:
        ...
...
class LineChannelPropertiesArgs:
    def __init__(__self__, *, line_registrations: pulumi.Input[Sequence[pulumi.Input[LineRegistrationArgs]]]) -> None:
    ...
    def line_registrations(self, value: pulumi.Input[Sequence[pulumi.Input[LineRegistrationArgs]]]): # -> None:
        ...
...
class LineChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[LineChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[LineChannelPropertiesArgs]]): # -> None:
        ...
...
class LineRegistrationArgs:
    def __init__(__self__, *, channel_access_token: Optional[pulumi.Input[_builtins.str]] = ..., channel_secret: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def channel_access_token(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def channel_secret(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MsTeamsChannelPropertiesArgs:
    def __init__(__self__, *, is_enabled: pulumi.Input[_builtins.bool], accepted_terms: Optional[pulumi.Input[_builtins.bool]] = ..., calling_webhook: Optional[pulumi.Input[_builtins.str]] = ..., deployment_environment: Optional[pulumi.Input[_builtins.str]] = ..., enable_calling: Optional[pulumi.Input[_builtins.bool]] = ..., incoming_call_route: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def accepted_terms(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def calling_webhook(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def deployment_environment(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def enable_calling(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def incoming_call_route(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MsTeamsChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[MsTeamsChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[MsTeamsChannelPropertiesArgs]]): # -> None:
        ...
...
class SkypeChannelPropertiesArgs:
    def __init__(__self__, *, is_enabled: pulumi.Input[_builtins.bool], calling_web_hook: Optional[pulumi.Input[_builtins.str]] = ..., enable_calling: Optional[pulumi.Input[_builtins.bool]] = ..., enable_groups: Optional[pulumi.Input[_builtins.bool]] = ..., enable_media_cards: Optional[pulumi.Input[_builtins.bool]] = ..., enable_messaging: Optional[pulumi.Input[_builtins.bool]] = ..., enable_screen_sharing: Optional[pulumi.Input[_builtins.bool]] = ..., enable_video: Optional[pulumi.Input[_builtins.bool]] = ..., groups_mode: Optional[pulumi.Input[_builtins.str]] = ..., incoming_call_route: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def calling_web_hook(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def enable_groups(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_media_cards(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_messaging(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_screen_sharing(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @enable_video.setter
    def enable_video(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @groups_mode.setter
    def groups_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SkypeChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[SkypeChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[SkypeChannelPropertiesArgs]]): # -> None:
        ...
...
class SlackChannelPropertiesArgs:
    def __init__(__self__, *, is_enabled: pulumi.Input[_builtins.bool], client_id: Optional[pulumi.Input[_builtins.str]] = ..., client_secret: Optional[pulumi.Input[_builtins.str]] = ..., landing_page_url: Optional[pulumi.Input[_builtins.str]] = ..., register_before_o_auth_flow: Optional[pulumi.Input[_builtins.bool]] = ..., scopes: Optional[pulumi.Input[_builtins.str]] = ..., signing_secret: Optional[pulumi.Input[_builtins.str]] = ..., verification_token: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def landing_page_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def register_before_o_auth_flow(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def signing_secret(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SlackChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[SlackChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[SlackChannelPropertiesArgs]]): # -> None:
        ...
...
class SmsChannelPropertiesArgs:
    def __init__(__self__, *, account_sid: pulumi.Input[_builtins.str], is_enabled: pulumi.Input[_builtins.bool], phone: pulumi.Input[_builtins.str], auth_token: Optional[pulumi.Input[_builtins.str]] = ..., is_validated: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @account_sid.setter
    def account_sid(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class SmsChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[SmsChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[SmsChannelPropertiesArgs]]): # -> None:
        ...
...
class TelegramChannelPropertiesArgs:
    def __init__(__self__, *, is_enabled: pulumi.Input[_builtins.bool], access_token: Optional[pulumi.Input[_builtins.str]] = ..., is_validated: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class TelegramChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[TelegramChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[TelegramChannelPropertiesArgs]]): # -> None:
        ...
...
class TelephonyChannelPropertiesArgs:
    def __init__(__self__, *, api_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[TelephonyChannelResourceApiConfigurationArgs]]]] = ..., cognitive_service_region: Optional[pulumi.Input[_builtins.str]] = ..., cognitive_service_subscription_key: Optional[pulumi.Input[_builtins.str]] = ..., default_locale: Optional[pulumi.Input[_builtins.str]] = ..., is_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., phone_numbers: Optional[pulumi.Input[Sequence[pulumi.Input[TelephonyPhoneNumbersArgs]]]] = ..., premium_sku: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def api_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TelephonyChannelResourceApiConfigurationArgs]]]]): # -> None:
        ...
    ...
    def default_locale(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def phone_numbers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TelephonyPhoneNumbersArgs]]]]): # -> None:
        ...
    ...
    @premium_sku.setter
    def premium_sku(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TelephonyChannelResourceApiConfigurationArgs:
    def __init__(__self__, *, cognitive_service_region: Optional[pulumi.Input[_builtins.str]] = ..., cognitive_service_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., cognitive_service_subscription_key: Optional[pulumi.Input[_builtins.str]] = ..., default_locale: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., provider_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TelephonyChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[TelephonyChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[TelephonyChannelPropertiesArgs]]): # -> None:
        ...
...
class TelephonyPhoneNumbersArgs:
    def __init__(__self__, *, acs_endpoint: Optional[pulumi.Input[_builtins.str]] = ..., acs_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., acs_secret: Optional[pulumi.Input[_builtins.str]] = ..., cognitive_service_region: Optional[pulumi.Input[_builtins.str]] = ..., cognitive_service_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., cognitive_service_subscription_key: Optional[pulumi.Input[_builtins.str]] = ..., default_locale: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., offer_type: Optional[pulumi.Input[_builtins.str]] = ..., phone_number: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @acs_endpoint.setter
    def acs_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def acs_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @acs_secret.setter
    def acs_secret(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @offer_type.setter
    def offer_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WebChatChannelPropertiesArgs:
    def __init__(__self__, *, sites: Optional[pulumi.Input[Sequence[pulumi.Input[WebChatSiteArgs]]]] = ...) -> None:
    ...
    @sites.setter
    def sites(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WebChatSiteArgs]]]]): # -> None:
        ...
...
class WebChatChannelArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], etag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[WebChatChannelPropertiesArgs]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[WebChatChannelPropertiesArgs]]): # -> None:
        ...
