...
__all__ = ['AccessKeysAuthentication', 'AofFrequency', 'ClusteringPolicy', 'CmkIdentityType', 'DeferUpgradeSetting', 'EvictionPolicy', 'HighAvailability', 'ManagedServiceIdentityType', 'PrivateEndpointServiceConnectionStatus', 'Protocol', 'RdbFrequency', 'SkuName', 'TlsVersion']
@pulumi.type_token(...)
