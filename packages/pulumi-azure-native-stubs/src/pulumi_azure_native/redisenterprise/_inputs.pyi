...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessPolicyAssignmentPropertiesUserArgs', 'AccessPolicyAssignmentPropertiesUserArgsDict', 'ClusterPropertiesCustomerManagedKeyEncryptionArgs', ..., 'ClusterPropertiesEncryptionArgs', 'ClusterPropertiesEncryptionArgsDict', 'ClusterPropertiesKeyEncryptionKeyIdentityArgs', 'ClusterPropertiesKeyEncryptionKeyIdentityArgsDict', 'DatabasePropertiesGeoReplicationArgs', 'DatabasePropertiesGeoReplicationArgsDict', 'LinkedDatabaseArgs', 'LinkedDatabaseArgsDict', 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'ModuleArgs', 'ModuleArgsDict', 'PersistenceArgs', 'PersistenceArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'SkuArgs', 'SkuArgsDict']
...
class ClusterPropertiesCustomerManagedKeyEncryptionArgs:
    def __init__(__self__, *, key_encryption_key_identity: Optional[pulumi.Input[ClusterPropertiesKeyEncryptionKeyIdentityArgs]] = ..., key_encryption_key_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def key_encryption_key_identity(self, value: Optional[pulumi.Input[ClusterPropertiesKeyEncryptionKeyIdentityArgs]]): # -> None:
        ...
...
class ClusterPropertiesEncryptionArgs:
    def __init__(__self__, *, customer_managed_key_encryption: Optional[pulumi.Input[ClusterPropertiesCustomerManagedKeyEncryptionArgs]] = ...) -> None:
    ...
    def customer_managed_key_encryption(self, value: Optional[pulumi.Input[ClusterPropertiesCustomerManagedKeyEncryptionArgs]]): # -> None:
        ...
...
class ClusterPropertiesKeyEncryptionKeyIdentityArgs:
    def __init__(__self__, *, identity_type: Optional[pulumi.Input[Union[_builtins.str, CmkIdentityType]]] = ..., user_assigned_identity_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def identity_type(self, value: Optional[pulumi.Input[Union[_builtins.str, CmkIdentityType]]]): # -> None:
        ...
...
class DatabasePropertiesGeoReplicationArgs:
    def __init__(__self__, *, group_nickname: Optional[pulumi.Input[_builtins.str]] = ..., linked_databases: Optional[pulumi.Input[Sequence[pulumi.Input[LinkedDatabaseArgs]]]] = ...) -> None:
    ...
    def group_nickname(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def linked_databases(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LinkedDatabaseArgs]]]]): # -> None:
        ...
...
@pulumi.input_type
class ModuleArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], args: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PersistenceArgs:
    def __init__(__self__, *, aof_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., aof_frequency: Optional[pulumi.Input[Union[_builtins.str, AofFrequency]]] = ..., rdb_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., rdb_frequency: Optional[pulumi.Input[Union[_builtins.str, RdbFrequency]]] = ...) -> None:
    ...
    @aof_enabled.setter
    def aof_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def aof_frequency(self, value: Optional[pulumi.Input[Union[_builtins.str, AofFrequency]]]): # -> None:
        ...
    ...
    @rdb_enabled.setter
    def rdb_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def rdb_frequency(self, value: Optional[pulumi.Input[Union[_builtins.str, RdbFrequency]]]): # -> None:
        ...
...
@pulumi.input_type
class SkuArgs:
    def __init__(__self__, *, name: pulumi.Input[Union[_builtins.str, SkuName]], capacity: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
