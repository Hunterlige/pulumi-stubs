...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessPolicyAssignmentPropertiesResponseUser', ..., 'ClusterPropertiesResponseEncryption', 'ClusterPropertiesResponseKeyEncryptionKeyIdentity', 'DatabasePropertiesResponseGeoReplication', 'LinkedDatabaseResponse', 'ManagedServiceIdentityResponse', 'ModuleResponse', 'PersistenceResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'SkuDetailsResponse', 'SkuResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
...
class ClusterPropertiesResponseCustomerManagedKeyEncryption(dict):
    ...
    def __init__(__self__, *, key_encryption_key_identity: Optional[outputs.ClusterPropertiesResponseKeyEncryptionKeyIdentity] = ..., key_encryption_key_url: Optional[_builtins.str] = ...) -> None:
...
class ClusterPropertiesResponseEncryption(dict):
    ...
    def __init__(__self__, *, customer_managed_key_encryption: Optional[outputs.ClusterPropertiesResponseCustomerManagedKeyEncryption] = ...) -> None:
...
class DatabasePropertiesResponseGeoReplication(dict):
    ...
    def __init__(__self__, *, group_nickname: Optional[_builtins.str] = ..., linked_databases: Optional[Sequence[outputs.LinkedDatabaseResponse]] = ...) -> None:
...
class LinkedDatabaseResponse(dict):
    ...
    def __init__(__self__, *, state: _builtins.str, id: Optional[_builtins.str] = ...) -> None:
...
class ModuleResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, version: _builtins.str, args: Optional[_builtins.str] = ...) -> None:
...
class PersistenceResponse(dict):
    ...
    def __init__(__self__, *, aof_enabled: Optional[_builtins.bool] = ..., aof_frequency: Optional[_builtins.str] = ..., rdb_enabled: Optional[_builtins.bool] = ..., rdb_frequency: Optional[_builtins.str] = ...) -> None:
...
class SkuDetailsResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, size_in_gb: _builtins.float) -> None:
