...
class AccessPolicyAssignmentArgs:
    def __init__(__self__, *, access_policy_name: pulumi.Input[_builtins.str], cluster_name: pulumi.Input[_builtins.str], database_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], user: pulumi.Input[AccessPolicyAssignmentPropertiesUserArgs], access_policy_assignment_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @user.setter
    def user(self, value: pulumi.Input[AccessPolicyAssignmentPropertiesUserArgs]): # -> None:
        ...
...
class AccessPolicyAssignment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., access_policy_assignment_name: Optional[pulumi.Input[_builtins.str]] = ..., access_policy_name: Optional[pulumi.Input[_builtins.str]] = ..., cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., database_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., user: Optional[pulumi.Input[Union[AccessPolicyAssignmentPropertiesUserArgs, AccessPolicyAssignmentPropertiesUserArgsDict]]] = ..., __props__=...) -> None:
