...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DistributeVersionerLatestResponse', 'DistributeVersionerSourceResponse', 'ImageTemplateAutoRunResponse', 'ImageTemplateFileCustomizerResponse', 'ImageTemplateFileValidatorResponse', 'ImageTemplateIdentityResponse', 'ImageTemplateLastRunStatusResponse', 'ImageTemplateManagedImageDistributorResponse', 'ImageTemplateManagedImageSourceResponse', 'ImageTemplatePlatformImageSourceResponse', 'ImageTemplatePowerShellCustomizerResponse', 'ImageTemplatePowerShellValidatorResponse', 'ImageTemplatePropertiesResponseErrorHandling', 'ImageTemplatePropertiesResponseOptimize', 'ImageTemplatePropertiesResponseValidate', 'ImageTemplatePropertiesResponseVmBoot', 'ImageTemplateRestartCustomizerResponse', 'ImageTemplateSharedImageDistributorResponse', 'ImageTemplateSharedImageVersionSourceResponse', 'ImageTemplateShellCustomizerResponse', 'ImageTemplateShellValidatorResponse', 'ImageTemplateVhdDistributorResponse', 'ImageTemplateVmProfileResponse', 'ImageTemplateWindowsUpdateCustomizerResponse', 'PlatformImagePurchasePlanResponse', 'ProvisioningErrorResponse', 'SystemDataResponse', 'TargetRegionResponse', 'TriggerStatusResponse', 'UserAssignedIdentityResponse', 'VirtualNetworkConfigResponse']
@pulumi.output_type
class DistributeVersionerLatestResponse(dict):
    
    def __init__(__self__, *, scheme: _builtins.str, major: Optional[_builtins.int] = ...) -> None:
...
class ImageTemplateFileCustomizerResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, destination: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., sha256_checksum: Optional[_builtins.str] = ..., source_uri: Optional[_builtins.str] = ...) -> None:
...
class ImageTemplateIdentityResponse(dict):
    ...
    def __init__(__self__, *, type: Optional[_builtins.str] = ..., user_assigned_identities: Optional[Mapping[str, outputs.UserAssignedIdentityResponse]] = ...) -> None:
...
class ImageTemplateLastRunStatusResponse(dict):
    ...
    def __init__(__self__, *, end_time: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ..., run_state: Optional[_builtins.str] = ..., run_sub_state: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ...) -> None:
...
class ImageTemplateManagedImageDistributorResponse(dict):
    ...
    def __init__(__self__, *, image_id: _builtins.str, location: _builtins.str, run_output_name: _builtins.str, type: _builtins.str, artifact_tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ImageTemplatePlatformImageSourceResponse(dict):
    ...
    def __init__(__self__, *, exact_version: _builtins.str, type: _builtins.str, offer: Optional[_builtins.str] = ..., plan_info: Optional[outputs.PlatformImagePurchasePlanResponse] = ..., publisher: Optional[_builtins.str] = ..., sku: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class ImageTemplatePowerShellCustomizerResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, inline: Optional[Sequence[_builtins.str]] = ..., name: Optional[_builtins.str] = ..., run_as_system: Optional[_builtins.bool] = ..., run_elevated: Optional[_builtins.bool] = ..., script_uri: Optional[_builtins.str] = ..., sha256_checksum: Optional[_builtins.str] = ..., valid_exit_codes: Optional[Sequence[_builtins.int]] = ...) -> None:
...
class ImageTemplatePropertiesResponseErrorHandling(dict):
    ...
    def __init__(__self__, *, on_customizer_error: Optional[_builtins.str] = ..., on_validation_error: Optional[_builtins.str] = ...) -> None:
...
class ImageTemplatePropertiesResponseOptimize(dict):
    ...
    def __init__(__self__, *, vm_boot: Optional[outputs.ImageTemplatePropertiesResponseVmBoot] = ...) -> None:
...
class ImageTemplatePropertiesResponseValidate(dict):
    ...
    def __init__(__self__, *, continue_distribute_on_failure: Optional[_builtins.bool] = ..., in_vm_validations: Optional[Sequence[Any]] = ..., source_validation_only: Optional[_builtins.bool] = ...) -> None:
...
class ImageTemplateRestartCustomizerResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, name: Optional[_builtins.str] = ..., restart_check_command: Optional[_builtins.str] = ..., restart_command: Optional[_builtins.str] = ..., restart_timeout: Optional[_builtins.str] = ...) -> None:
...
class ImageTemplateSharedImageDistributorResponse(dict):
    ...
    def __init__(__self__, *, gallery_image_id: _builtins.str, run_output_name: _builtins.str, type: _builtins.str, artifact_tags: Optional[Mapping[str, _builtins.str]] = ..., exclude_from_latest: Optional[_builtins.bool] = ..., replication_regions: Optional[Sequence[_builtins.str]] = ..., storage_account_type: Optional[_builtins.str] = ..., target_regions: Optional[Sequence[outputs.TargetRegionResponse]] = ..., versioning: Optional[Any] = ...) -> None:
...
class ImageTemplateSharedImageVersionSourceResponse(dict):
    ...
    def __init__(__self__, *, exact_version: _builtins.str, image_version_id: _builtins.str, type: _builtins.str) -> None:
...
class ImageTemplateShellCustomizerResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, inline: Optional[Sequence[_builtins.str]] = ..., name: Optional[_builtins.str] = ..., script_uri: Optional[_builtins.str] = ..., sha256_checksum: Optional[_builtins.str] = ...) -> None:
...
class ImageTemplateVhdDistributorResponse(dict):
    ...
    def __init__(__self__, *, run_output_name: _builtins.str, type: _builtins.str, artifact_tags: Optional[Mapping[str, _builtins.str]] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class ImageTemplateVmProfileResponse(dict):
    ...
    def __init__(__self__, *, os_disk_size_gb: Optional[_builtins.int] = ..., user_assigned_identities: Optional[Sequence[_builtins.str]] = ..., vm_size: Optional[_builtins.str] = ..., vnet_config: Optional[outputs.VirtualNetworkConfigResponse] = ...) -> None:
...
class ImageTemplateWindowsUpdateCustomizerResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, filters: Optional[Sequence[_builtins.str]] = ..., name: Optional[_builtins.str] = ..., search_criteria: Optional[_builtins.str] = ..., update_limit: Optional[_builtins.int] = ...) -> None:
...
class PlatformImagePurchasePlanResponse(dict):
    ...
    def __init__(__self__, *, plan_name: _builtins.str, plan_product: _builtins.str, plan_publisher: _builtins.str) -> None:
...
class ProvisioningErrorResponse(dict):
    ...
    def __init__(__self__, *, message: Optional[_builtins.str] = ..., provisioning_error_code: Optional[_builtins.str] = ...) -> None:
...
class TargetRegionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, replica_count: Optional[_builtins.int] = ..., storage_account_type: Optional[_builtins.str] = ...) -> None:
...
class TriggerStatusResponse(dict):
    ...
    def __init__(__self__, *, code: _builtins.str, message: _builtins.str, time: _builtins.str) -> None:
...
class VirtualNetworkConfigResponse(dict):
    ...
    def __init__(__self__, *, container_instance_subnet_id: Optional[_builtins.str] = ..., proxy_vm_size: Optional[_builtins.str] = ..., subnet_id: Optional[_builtins.str] = ...) -> None:
