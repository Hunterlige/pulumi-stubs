...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = [..., 'BusinessProcessIdentifierResponse', 'BusinessProcessMappingItemResponse', 'BusinessProcessReferenceResponse', 'BusinessProcessStageResponse', 'FlowTrackingDefinitionResponse', ..., 'SystemDataResponse', 'TrackingCorrelationContextResponse', 'TrackingDataStoreResponse', 'TrackingEventDefinitionResponse', 'TrackingProfileDefinitionResponse']
@pulumi.output_type
class BusinessProcessDevelopmentArtifactPropertiesResponse(dict):
    
    def __init__(__self__, *, business_process_mapping: Optional[Mapping[str, outputs.BusinessProcessMappingItemResponse]] = ..., business_process_stages: Optional[Mapping[str, outputs.BusinessProcessStageResponse]] = ..., description: Optional[_builtins.str] = ..., identifier: Optional[outputs.BusinessProcessIdentifierResponse] = ..., tracking_profiles: Optional[Mapping[str, outputs.TrackingProfileDefinitionResponse]] = ...) -> None:
...
class BusinessProcessIdentifierResponse(dict):
    ...
    def __init__(__self__, *, property_name: Optional[_builtins.str] = ..., property_type: Optional[_builtins.str] = ...) -> None:
...
class BusinessProcessMappingItemResponse(dict):
    ...
    def __init__(__self__, *, logic_app_resource_id: Optional[_builtins.str] = ..., operation_name: Optional[_builtins.str] = ..., operation_type: Optional[_builtins.str] = ..., workflow_name: Optional[_builtins.str] = ...) -> None:
...
class BusinessProcessStageResponse(dict):
    ...
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., properties: Optional[Mapping[str, _builtins.str]] = ..., stages_before: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FlowTrackingDefinitionResponse(dict):
    ...
    def __init__(__self__, *, correlation_context: Optional[outputs.TrackingCorrelationContextResponse] = ..., events: Optional[Mapping[str, outputs.TrackingEventDefinitionResponse]] = ...) -> None:
...
class SaveOrGetBusinessProcessDevelopmentArtifactResponseResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, system_data: outputs.SystemDataResponse, properties: Optional[outputs.BusinessProcessDevelopmentArtifactPropertiesResponse] = ...) -> None:
...
class TrackingCorrelationContextResponse(dict):
    ...
    def __init__(__self__, *, operation_name: Optional[_builtins.str] = ..., operation_type: Optional[_builtins.str] = ..., property_name: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class TrackingDataStoreResponse(dict):
    ...
    def __init__(__self__, *, data_store_ingestion_uri: Optional[_builtins.str] = ..., data_store_resource_id: Optional[_builtins.str] = ..., data_store_uri: Optional[_builtins.str] = ..., database_name: Optional[_builtins.str] = ...) -> None:
...
class TrackingEventDefinitionResponse(dict):
    ...
    def __init__(__self__, *, operation_name: Optional[_builtins.str] = ..., operation_type: Optional[_builtins.str] = ..., properties: Optional[Mapping[str, Any]] = ...) -> None:
...
class TrackingProfileDefinitionResponse(dict):
    ...
    def __init__(__self__, *, business_process: Optional[outputs.BusinessProcessReferenceResponse] = ..., schema: Optional[_builtins.str] = ..., tracking_definitions: Optional[Mapping[str, outputs.FlowTrackingDefinitionResponse]] = ...) -> None:
