...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BusinessProcessIdentifierArgs', 'BusinessProcessIdentifierArgsDict', 'BusinessProcessMappingItemArgs', 'BusinessProcessMappingItemArgsDict', 'BusinessProcessStageArgs', 'BusinessProcessStageArgsDict', 'TrackingDataStoreArgs', 'TrackingDataStoreArgsDict']
...
class BusinessProcessIdentifierArgs:
    def __init__(__self__, *, property_name: Optional[pulumi.Input[_builtins.str]] = ..., property_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def property_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BusinessProcessMappingItemArgs:
    def __init__(__self__, *, logic_app_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., operation_name: Optional[pulumi.Input[_builtins.str]] = ..., operation_type: Optional[pulumi.Input[_builtins.str]] = ..., workflow_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def operation_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BusinessProcessStageArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., stages_before: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def stages_before(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class TrackingDataStoreArgs:
    def __init__(__self__, *, data_store_ingestion_uri: Optional[pulumi.Input[_builtins.str]] = ..., data_store_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., data_store_uri: Optional[pulumi.Input[_builtins.str]] = ..., database_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def data_store_ingestion_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def data_store_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def data_store_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
