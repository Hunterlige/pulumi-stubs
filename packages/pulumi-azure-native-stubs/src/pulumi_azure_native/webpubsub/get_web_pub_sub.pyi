...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetWebPubSubResult', 'AwaitableGetWebPubSubResult', 'get_web_pub_sub', 'get_web_pub_sub_output']
@pulumi.output_type
class GetWebPubSubResult:
    
    def __init__(__self__, azure_api_version=..., disable_aad_auth=..., disable_local_auth=..., external_ip=..., host_name=..., host_name_prefix=..., id=..., identity=..., kind=..., live_trace_configuration=..., location=..., name=..., network_acls=..., private_endpoint_connections=..., provisioning_state=..., public_network_access=..., public_port=..., region_endpoint_enabled=..., resource_log_configuration=..., resource_stopped=..., server_port=..., shared_private_link_resources=..., sku=..., socket_io=..., system_data=..., tags=..., tls=..., type=..., version=...) -> None:
        ...
...
class AwaitableGetWebPubSubResult(GetWebPubSubResult):
    def __await__(self): # -> Generator[Never, Any, GetWebPubSubResult]:
        ...
    


def get_web_pub_sub(resource_group_name: Optional[_builtins.str] = ..., resource_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetWebPubSubResult:
    
    ...

def get_web_pub_sub_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetWebPubSubResult]:
