...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AddDataLakeStoreWithAccountParametersArgs', 'AddDataLakeStoreWithAccountParametersArgsDict', 'AddStorageAccountWithAccountParametersArgs', 'AddStorageAccountWithAccountParametersArgsDict', 'CreateComputePolicyWithAccountParametersArgs', 'CreateComputePolicyWithAccountParametersArgsDict', 'CreateFirewallRuleWithAccountParametersArgs', 'CreateFirewallRuleWithAccountParametersArgsDict']
...
class AddDataLakeStoreWithAccountParametersArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], suffix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AddStorageAccountWithAccountParametersArgs:
    def __init__(__self__, *, access_key: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], suffix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CreateComputePolicyWithAccountParametersArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], object_id: pulumi.Input[_builtins.str], object_type: pulumi.Input[Union[_builtins.str, AADObjectType]], max_degree_of_parallelism_per_job: Optional[pulumi.Input[_builtins.int]] = ..., min_priority_per_job: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
