...
@pulumi.input_type
class AccountArgs:
    def __init__(__self__, *, data_lake_store_accounts: pulumi.Input[Sequence[pulumi.Input[AddDataLakeStoreWithAccountParametersArgs]]], default_data_lake_store_account: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], account_name: Optional[pulumi.Input[_builtins.str]] = ..., compute_policies: Optional[pulumi.Input[Sequence[pulumi.Input[CreateComputePolicyWithAccountParametersArgs]]]] = ..., firewall_allow_azure_ips: Optional[pulumi.Input[FirewallAllowAzureIpsState]] = ..., firewall_rules: Optional[pulumi.Input[Sequence[pulumi.Input[CreateFirewallRuleWithAccountParametersArgs]]]] = ..., firewall_state: Optional[pulumi.Input[FirewallState]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., max_degree_of_parallelism: Optional[pulumi.Input[_builtins.int]] = ..., max_degree_of_parallelism_per_job: Optional[pulumi.Input[_builtins.int]] = ..., max_job_count: Optional[pulumi.Input[_builtins.int]] = ..., min_priority_per_job: Optional[pulumi.Input[_builtins.int]] = ..., new_tier: Optional[pulumi.Input[TierType]] = ..., query_store_retention: Optional[pulumi.Input[_builtins.int]] = ..., storage_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[AddStorageAccountWithAccountParametersArgs]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def data_lake_store_accounts(self, value: pulumi.Input[Sequence[pulumi.Input[AddDataLakeStoreWithAccountParametersArgs]]]): # -> None:
        ...
    ...
    def default_data_lake_store_account(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def compute_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CreateComputePolicyWithAccountParametersArgs]]]]): # -> None:
        ...
    ...
    def max_degree_of_parallelism(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def query_store_retention(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def storage_accounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AddStorageAccountWithAccountParametersArgs]]]]): # -> None:
        ...
...
class Account(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., compute_policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union[CreateComputePolicyWithAccountParametersArgs, CreateComputePolicyWithAccountParametersArgsDict]]]]] = ..., data_lake_store_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AddDataLakeStoreWithAccountParametersArgs, AddDataLakeStoreWithAccountParametersArgsDict]]]]] = ..., default_data_lake_store_account: Optional[pulumi.Input[_builtins.str]] = ..., firewall_allow_azure_ips: Optional[pulumi.Input[FirewallAllowAzureIpsState]] = ..., firewall_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[CreateFirewallRuleWithAccountParametersArgs, CreateFirewallRuleWithAccountParametersArgsDict]]]]] = ..., firewall_state: Optional[pulumi.Input[FirewallState]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., max_degree_of_parallelism: Optional[pulumi.Input[_builtins.int]] = ..., max_degree_of_parallelism_per_job: Optional[pulumi.Input[_builtins.int]] = ..., max_job_count: Optional[pulumi.Input[_builtins.int]] = ..., min_priority_per_job: Optional[pulumi.Input[_builtins.int]] = ..., new_tier: Optional[pulumi.Input[TierType]] = ..., query_store_retention: Optional[pulumi.Input[_builtins.int]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AddStorageAccountWithAccountParametersArgs, AddStorageAccountWithAccountParametersArgsDict]]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
