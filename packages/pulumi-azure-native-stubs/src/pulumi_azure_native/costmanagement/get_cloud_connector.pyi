...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetCloudConnectorResult', 'AwaitableGetCloudConnectorResult', 'get_cloud_connector', 'get_cloud_connector_output']
@pulumi.output_type
class GetCloudConnectorResult:
    
    def __init__(__self__, azure_api_version=..., billing_model=..., collection_info=..., created_on=..., credentials_key=..., days_trial_remaining=..., default_management_group_id=..., display_name=..., external_billing_account_id=..., id=..., kind=..., modified_on=..., name=..., provider_billing_account_display_name=..., provider_billing_account_id=..., report_id=..., status=..., subscription_id=..., type=...) -> None:
        ...
...
class AwaitableGetCloudConnectorResult(GetCloudConnectorResult):
    def __await__(self): # -> Generator[Never, Any, GetCloudConnectorResult]:
        ...
    


def get_cloud_connector(connector_name: Optional[_builtins.str] = ..., expand: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetCloudConnectorResult:
    
    ...

def get_cloud_connector_output(connector_name: Optional[pulumi.Input[_builtins.str]] = ..., expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetCloudConnectorResult]:
