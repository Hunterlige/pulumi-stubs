...
class GetBudgetResult:
    ...
    def __init__(__self__, amount=..., azure_api_version=..., category=..., current_spend=..., e_tag=..., filter=..., forecast_spend=..., id=..., name=..., notifications=..., time_grain=..., time_period=..., type=...) -> None:
        ...
