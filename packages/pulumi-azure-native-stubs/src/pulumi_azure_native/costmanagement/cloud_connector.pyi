...
class CloudConnectorArgs:
    def __init__(__self__, *, billing_model: Optional[pulumi.Input[Union[_builtins.str, ConnectorBillingModel]]] = ..., connector_name: Optional[pulumi.Input[_builtins.str]] = ..., credentials_key: Optional[pulumi.Input[_builtins.str]] = ..., credentials_secret: Optional[pulumi.Input[_builtins.str]] = ..., default_management_group_id: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., report_id: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="billingModel")
    def billing_model(self) -> Optional[pulumi.Input[Union[_builtins.str, ConnectorBillingModel]]]:
        
        ...
    
    @billing_model.setter
    def billing_model(self, value: Optional[pulumi.Input[Union[_builtins.str, ConnectorBillingModel]]]): # -> None:
        ...
    ...
    def default_management_group_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CloudConnector(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., billing_model: Optional[pulumi.Input[Union[_builtins.str, ConnectorBillingModel]]] = ..., connector_name: Optional[pulumi.Input[_builtins.str]] = ..., credentials_key: Optional[pulumi.Input[_builtins.str]] = ..., credentials_secret: Optional[pulumi.Input[_builtins.str]] = ..., default_management_group_id: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., report_id: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: Optional[CloudConnectorArgs] = ..., opts: Optional[pulumi.ResourceOptions] = ...) -> None:
