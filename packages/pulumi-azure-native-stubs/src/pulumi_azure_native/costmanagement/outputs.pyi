...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BudgetComparisonExpressionResponse', 'BudgetFilterPropertiesResponse', 'BudgetFilterResponse', 'BudgetTimePeriodResponse', 'CommonExportPropertiesResponse', 'ConnectorCollectionErrorInfoResponse', 'ConnectorCollectionErrorInfoResponseV1', 'ConnectorCollectionInfoResponse', 'ConnectorCollectionInfoResponseV1', 'CostAllocationProportionResponse', 'CostAllocationRuleDetailsResponse', 'CostAllocationRulePropertiesResponse', 'CurrentSpendResponse', 'CustomerMetadataResponse', 'ErrorDetailsResponse', 'ExportDatasetConfigurationResponse', 'ExportDatasetResponse', 'ExportDefinitionResponse', 'ExportDeliveryDestinationResponse', 'ExportDeliveryInfoResponse', 'ExportExecutionListResultResponse', 'ExportRecurrencePeriodResponse', 'ExportRunResponse', 'ExportScheduleResponse', 'ExportTimePeriodResponse', 'FileDestinationResponse', 'ForecastSpendResponse', 'KpiPropertiesResponse', 'NotificationPropertiesResponse', 'NotificationResponse', 'PivotPropertiesResponse', 'ReportAggregationResponse', 'ReportComparisonExpressionResponse', 'ReportConfigAggregationResponse', 'ReportConfigComparisonExpressionResponse', 'ReportConfigDatasetConfigurationResponse', 'ReportConfigDatasetResponse', 'ReportConfigFilterResponse', 'ReportConfigGroupingResponse', 'ReportConfigSortingResponse', 'ReportConfigTimePeriodResponse', 'ReportDatasetConfigurationResponse', 'ReportDatasetResponse', 'ReportDefinitionResponse', 'ReportDeliveryDestinationResponse', 'ReportDeliveryInfoResponse', 'ReportFilterResponse', 'ReportGroupingResponse', 'ReportRecurrencePeriodResponse', 'ReportScheduleResponse', 'ReportTimePeriodResponse', 'SchedulePropertiesResponse', 'SettingsPropertiesResponseCache', 'SourceCostAllocationResourceResponse', 'SystemAssignedServiceIdentityResponse', 'SystemDataResponse', 'TagInheritancePropertiesResponse', 'TargetCostAllocationResourceResponse']
@pulumi.output_type
...
class CommonExportPropertiesResponse(dict):
    ...
    def __init__(__self__, *, definition: outputs.ExportDefinitionResponse, delivery_info: outputs.ExportDeliveryInfoResponse, next_run_time_estimate: _builtins.str, format: Optional[_builtins.str] = ..., partition_data: Optional[_builtins.bool] = ..., run_history: Optional[outputs.ExportExecutionListResultResponse] = ...) -> None:
...
class ConnectorCollectionErrorInfoResponse(dict):
    ...
    def __init__(__self__, *, error_code: _builtins.str, error_inner_message: _builtins.str, error_message: _builtins.str, error_start_time: _builtins.str) -> None:
...
class ConnectorCollectionErrorInfoResponseV1(dict):
    ...
    def __init__(__self__, *, error_code: _builtins.str, error_message: _builtins.str, error_start_time: _builtins.str) -> None:
...
class ConnectorCollectionInfoResponse(dict):
    ...
    def __init__(__self__, *, last_checked: _builtins.str, last_updated: _builtins.str, source_last_updated: _builtins.str, error: Optional[outputs.ConnectorCollectionErrorInfoResponse] = ...) -> None:
...
class ConnectorCollectionInfoResponseV1(dict):
    ...
    def __init__(__self__, *, last_run: _builtins.str, last_updated: _builtins.str, source_last_updated: _builtins.str, error: Optional[outputs.ConnectorCollectionErrorInfoResponseV1] = ...) -> None:
...
class CostAllocationProportionResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, percentage: _builtins.float) -> None:
...
class CostAllocationRuleDetailsResponse(dict):
    ...
    def __init__(__self__, *, source_resources: Optional[Sequence[outputs.SourceCostAllocationResourceResponse]] = ..., target_resources: Optional[Sequence[outputs.TargetCostAllocationResourceResponse]] = ...) -> None:
...
class CostAllocationRulePropertiesResponse(dict):
    ...
    def __init__(__self__, *, created_date: _builtins.str, details: outputs.CostAllocationRuleDetailsResponse, status: _builtins.str, updated_date: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class CustomerMetadataResponse(dict):
    ...
    def __init__(__self__, *, billing_account_id: _builtins.str, billing_profile_id: _builtins.str) -> None:
...
class ExportDatasetConfigurationResponse(dict):
    ...
    def __init__(__self__, *, columns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ExportDatasetResponse(dict):
    ...
    def __init__(__self__, *, configuration: Optional[outputs.ExportDatasetConfigurationResponse] = ..., granularity: Optional[_builtins.str] = ...) -> None:
...
class ExportDefinitionResponse(dict):
    ...
    def __init__(__self__, *, timeframe: _builtins.str, type: _builtins.str, data_set: Optional[outputs.ExportDatasetResponse] = ..., time_period: Optional[outputs.ExportTimePeriodResponse] = ...) -> None:
...
class ExportDeliveryDestinationResponse(dict):
    ...
    def __init__(__self__, *, container: _builtins.str, resource_id: Optional[_builtins.str] = ..., root_folder_path: Optional[_builtins.str] = ..., sas_token: Optional[_builtins.str] = ..., storage_account: Optional[_builtins.str] = ...) -> None:
...
class ExportDeliveryInfoResponse(dict):
    ...
    def __init__(__self__, *, destination: outputs.ExportDeliveryDestinationResponse) -> None:
...
class ExportRecurrencePeriodResponse(dict):
    ...
    def __init__(__self__, *, from_: _builtins.str, to: Optional[_builtins.str] = ...) -> None:
...
class ExportRunResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, type: _builtins.str, e_tag: Optional[_builtins.str] = ..., error: Optional[outputs.ErrorDetailsResponse] = ..., execution_type: Optional[_builtins.str] = ..., file_name: Optional[_builtins.str] = ..., processing_end_time: Optional[_builtins.str] = ..., processing_start_time: Optional[_builtins.str] = ..., run_settings: Optional[outputs.CommonExportPropertiesResponse] = ..., status: Optional[_builtins.str] = ..., submitted_by: Optional[_builtins.str] = ..., submitted_time: Optional[_builtins.str] = ...) -> None:
...
class ExportScheduleResponse(dict):
    ...
    def __init__(__self__, *, recurrence: Optional[_builtins.str] = ..., recurrence_period: Optional[outputs.ExportRecurrencePeriodResponse] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class FileDestinationResponse(dict):
    ...
    def __init__(__self__, *, file_formats: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class KpiPropertiesResponse(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., id: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class NotificationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, subject: _builtins.str, to: Sequence[_builtins.str], language: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ..., regional_format: Optional[_builtins.str] = ...) -> None:
...
class NotificationResponse(dict):
    ...
    def __init__(__self__, *, contact_emails: Sequence[_builtins.str], enabled: _builtins.bool, operator: _builtins.str, threshold: _builtins.float, contact_groups: Optional[Sequence[_builtins.str]] = ..., contact_roles: Optional[Sequence[_builtins.str]] = ..., frequency: Optional[_builtins.str] = ..., locale: Optional[_builtins.str] = ..., threshold_type: Optional[_builtins.str] = ...) -> None:
...
class ReportConfigDatasetResponse(dict):
    ...
    def __init__(__self__, *, aggregation: Optional[Mapping[str, outputs.ReportConfigAggregationResponse]] = ..., configuration: Optional[outputs.ReportConfigDatasetConfigurationResponse] = ..., filter: Optional[outputs.ReportConfigFilterResponse] = ..., granularity: Optional[_builtins.str] = ..., grouping: Optional[Sequence[outputs.ReportConfigGroupingResponse]] = ..., sorting: Optional[Sequence[outputs.ReportConfigSortingResponse]] = ...) -> None:
...
class ReportConfigFilterResponse(dict):
    ...
    def __init__(__self__, *, and_: Optional[Sequence[outputs.ReportConfigFilterResponse]] = ..., dimensions: Optional[outputs.ReportConfigComparisonExpressionResponse] = ..., or_: Optional[Sequence[outputs.ReportConfigFilterResponse]] = ..., tags: Optional[outputs.ReportConfigComparisonExpressionResponse] = ...) -> None:
...
class ReportConfigSortingResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, direction: Optional[_builtins.str] = ...) -> None:
...
class ReportDatasetResponse(dict):
    ...
    def __init__(__self__, *, aggregation: Optional[Mapping[str, outputs.ReportAggregationResponse]] = ..., configuration: Optional[outputs.ReportDatasetConfigurationResponse] = ..., filter: Optional[outputs.ReportFilterResponse] = ..., granularity: Optional[_builtins.str] = ..., grouping: Optional[Sequence[outputs.ReportGroupingResponse]] = ...) -> None:
...
class ReportDefinitionResponse(dict):
    ...
    def __init__(__self__, *, timeframe: _builtins.str, type: _builtins.str, dataset: Optional[outputs.ReportDatasetResponse] = ..., time_period: Optional[outputs.ReportTimePeriodResponse] = ...) -> None:
...
class ReportDeliveryDestinationResponse(dict):
    ...
    def __init__(__self__, *, container: _builtins.str, resource_id: _builtins.str, root_folder_path: Optional[_builtins.str] = ...) -> None:
...
class ReportDeliveryInfoResponse(dict):
    ...
    def __init__(__self__, *, destination: outputs.ReportDeliveryDestinationResponse) -> None:
...
class ReportFilterResponse(dict):
    ...
    def __init__(__self__, *, and_: Optional[Sequence[outputs.ReportFilterResponse]] = ..., dimension: Optional[outputs.ReportComparisonExpressionResponse] = ..., not_: Optional[outputs.ReportFilterResponse] = ..., or_: Optional[Sequence[outputs.ReportFilterResponse]] = ..., tag: Optional[outputs.ReportComparisonExpressionResponse] = ...) -> None:
...
class ReportScheduleResponse(dict):
    ...
    def __init__(__self__, *, recurrence: _builtins.str, recurrence_period: Optional[outputs.ReportRecurrencePeriodResponse] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class SchedulePropertiesResponse(dict):
    ...
    def __init__(__self__, *, end_date: _builtins.str, frequency: _builtins.str, start_date: _builtins.str, day_of_month: Optional[_builtins.int] = ..., days_of_week: Optional[Sequence[_builtins.str]] = ..., hour_of_day: Optional[_builtins.int] = ..., weeks_of_month: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SettingsPropertiesResponseCache(dict):
    def __init__(__self__, *, channel: _builtins.str, id: _builtins.str, name: _builtins.str, subchannel: _builtins.str, parent: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class SourceCostAllocationResourceResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, resource_type: _builtins.str, values: Sequence[_builtins.str]) -> None:
...
class TargetCostAllocationResourceResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, policy_type: _builtins.str, resource_type: _builtins.str, values: Sequence[outputs.CostAllocationProportionResponse]) -> None:
