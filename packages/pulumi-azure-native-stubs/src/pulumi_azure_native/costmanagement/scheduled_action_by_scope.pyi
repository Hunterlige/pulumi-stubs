...
class ScheduledActionByScopeArgs:
    def __init__(__self__, *, display_name: pulumi.Input[_builtins.str], notification: pulumi.Input[NotificationPropertiesArgs], schedule: pulumi.Input[SchedulePropertiesArgs], scope: pulumi.Input[_builtins.str], status: pulumi.Input[Union[_builtins.str, ScheduledActionStatus]], view_id: pulumi.Input[_builtins.str], file_destination: Optional[pulumi.Input[FileDestinationArgs]] = ..., kind: Optional[pulumi.Input[Union[_builtins.str, ScheduledActionKind]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., notification_email: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ScheduledActionByScope(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: ScheduledActionByScopeArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ScheduledActionByScope:
