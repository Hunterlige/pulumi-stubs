...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BudgetComparisonExpressionArgs', 'BudgetComparisonExpressionArgsDict', 'BudgetFilterPropertiesArgs', 'BudgetFilterPropertiesArgsDict', 'BudgetFilterArgs', 'BudgetFilterArgsDict', 'BudgetTimePeriodArgs', 'BudgetTimePeriodArgsDict', 'CostAllocationProportionArgs', 'CostAllocationProportionArgsDict', 'CostAllocationRuleDetailsArgs', 'CostAllocationRuleDetailsArgsDict', 'CostAllocationRulePropertiesArgs', 'CostAllocationRulePropertiesArgsDict', 'CustomerMetadataArgs', 'CustomerMetadataArgsDict', 'ExportDatasetConfigurationArgs', 'ExportDatasetConfigurationArgsDict', 'ExportDatasetArgs', 'ExportDatasetArgsDict', 'ExportDefinitionArgs', 'ExportDefinitionArgsDict', 'ExportDeliveryDestinationArgs', 'ExportDeliveryDestinationArgsDict', 'ExportDeliveryInfoArgs', 'ExportDeliveryInfoArgsDict', 'ExportRecurrencePeriodArgs', 'ExportRecurrencePeriodArgsDict', 'ExportScheduleArgs', 'ExportScheduleArgsDict', 'ExportTimePeriodArgs', 'ExportTimePeriodArgsDict', 'FileDestinationArgs', 'FileDestinationArgsDict', 'KpiPropertiesArgs', 'KpiPropertiesArgsDict', 'NotificationPropertiesArgs', 'NotificationPropertiesArgsDict', 'NotificationArgs', 'NotificationArgsDict', 'PivotPropertiesArgs', 'PivotPropertiesArgsDict', 'ReportAggregationArgs', 'ReportAggregationArgsDict', 'ReportComparisonExpressionArgs', 'ReportComparisonExpressionArgsDict', 'ReportConfigAggregationArgs', 'ReportConfigAggregationArgsDict', 'ReportConfigComparisonExpressionArgs', 'ReportConfigComparisonExpressionArgsDict', 'ReportConfigDatasetConfigurationArgs', 'ReportConfigDatasetConfigurationArgsDict', 'ReportConfigDatasetArgs', 'ReportConfigDatasetArgsDict', 'ReportConfigFilterArgs', 'ReportConfigFilterArgsDict', 'ReportConfigGroupingArgs', 'ReportConfigGroupingArgsDict', 'ReportConfigSortingArgs', 'ReportConfigSortingArgsDict', 'ReportConfigTimePeriodArgs', 'ReportConfigTimePeriodArgsDict', 'ReportDatasetConfigurationArgs', 'ReportDatasetConfigurationArgsDict', 'ReportDatasetArgs', 'ReportDatasetArgsDict', 'ReportDefinitionArgs', 'ReportDefinitionArgsDict', 'ReportDeliveryDestinationArgs', 'ReportDeliveryDestinationArgsDict', 'ReportDeliveryInfoArgs', 'ReportDeliveryInfoArgsDict', 'ReportFilterArgs', 'ReportFilterArgsDict', 'ReportGroupingArgs', 'ReportGroupingArgsDict', 'ReportRecurrencePeriodArgs', 'ReportRecurrencePeriodArgsDict', 'ReportScheduleArgs', 'ReportScheduleArgsDict', 'ReportTimePeriodArgs', 'ReportTimePeriodArgsDict', 'SchedulePropertiesArgs', 'SchedulePropertiesArgsDict', 'SettingsPropertiesCacheArgs', 'SettingsPropertiesCacheArgsDict', 'SourceCostAllocationResourceArgs', 'SourceCostAllocationResourceArgsDict', 'SystemAssignedServiceIdentityArgs', 'SystemAssignedServiceIdentityArgsDict', 'TagInheritancePropertiesArgs', 'TagInheritancePropertiesArgsDict', 'TargetCostAllocationResourceArgs', 'TargetCostAllocationResourceArgsDict']
...
class BudgetComparisonExpressionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], operator: pulumi.Input[Union[_builtins.str, BudgetOperatorType]], values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, BudgetOperatorType]]): # -> None:
        ...
...
class BudgetFilterPropertiesArgs:
    def __init__(__self__, *, dimensions: Optional[pulumi.Input[BudgetComparisonExpressionArgs]] = ..., tags: Optional[pulumi.Input[BudgetComparisonExpressionArgs]] = ...) -> None:
    ...
    @dimensions.setter
    def dimensions(self, value: Optional[pulumi.Input[BudgetComparisonExpressionArgs]]): # -> None:
        ...
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[BudgetComparisonExpressionArgs]]): # -> None:
        ...
...
class BudgetFilterArgs:
    def __init__(__self__, *, and_: Optional[pulumi.Input[Sequence[pulumi.Input[BudgetFilterPropertiesArgs]]]] = ..., dimensions: Optional[pulumi.Input[BudgetComparisonExpressionArgs]] = ..., tags: Optional[pulumi.Input[BudgetComparisonExpressionArgs]] = ...) -> None:
    ...
    @and_.setter
    def and_(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BudgetFilterPropertiesArgs]]]]): # -> None:
        ...
...
class BudgetTimePeriodArgs:
    def __init__(__self__, *, start_date: pulumi.Input[_builtins.str], end_date: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CostAllocationProportionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], percentage: pulumi.Input[_builtins.float]) -> None:
...
class CostAllocationRuleDetailsArgs:
    def __init__(__self__, *, source_resources: Optional[pulumi.Input[Sequence[pulumi.Input[SourceCostAllocationResourceArgs]]]] = ..., target_resources: Optional[pulumi.Input[Sequence[pulumi.Input[TargetCostAllocationResourceArgs]]]] = ...) -> None:
    ...
    def source_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SourceCostAllocationResourceArgs]]]]): # -> None:
        ...
    ...
    def target_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TargetCostAllocationResourceArgs]]]]): # -> None:
        ...
...
class CostAllocationRulePropertiesArgs:
    def __init__(__self__, *, details: pulumi.Input[CostAllocationRuleDetailsArgs], status: pulumi.Input[Union[_builtins.str, RuleStatus]], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @details.setter
    def details(self, value: pulumi.Input[CostAllocationRuleDetailsArgs]): # -> None:
        ...
    ...
    @status.setter
    def status(self, value: pulumi.Input[Union[_builtins.str, RuleStatus]]): # -> None:
        ...
...
class CustomerMetadataArgs:
    def __init__(__self__, *, billing_account_id: pulumi.Input[_builtins.str], billing_profile_id: pulumi.Input[_builtins.str]) -> None:
...
class ExportDatasetConfigurationArgs:
    def __init__(__self__, *, columns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ExportDatasetArgs:
    def __init__(__self__, *, configuration: Optional[pulumi.Input[ExportDatasetConfigurationArgs]] = ..., granularity: Optional[pulumi.Input[Union[_builtins.str, GranularityType]]] = ...) -> None:
    ...
    def configuration(self, value: Optional[pulumi.Input[ExportDatasetConfigurationArgs]]): # -> None:
        ...
    ...
    @granularity.setter
    def granularity(self, value: Optional[pulumi.Input[Union[_builtins.str, GranularityType]]]): # -> None:
        ...
...
class ExportDefinitionArgs:
    def __init__(__self__, *, timeframe: pulumi.Input[Union[_builtins.str, TimeframeType]], type: pulumi.Input[Union[_builtins.str, ExportType]], data_set: Optional[pulumi.Input[ExportDatasetArgs]] = ..., time_period: Optional[pulumi.Input[ExportTimePeriodArgs]] = ...) -> None:
    ...
    @timeframe.setter
    def timeframe(self, value: pulumi.Input[Union[_builtins.str, TimeframeType]]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ExportType]]): # -> None:
        ...
    ...
    @data_set.setter
    def data_set(self, value: Optional[pulumi.Input[ExportDatasetArgs]]): # -> None:
        ...
    ...
    @time_period.setter
    def time_period(self, value: Optional[pulumi.Input[ExportTimePeriodArgs]]): # -> None:
        ...
...
class ExportDeliveryDestinationArgs:
    def __init__(__self__, *, container: pulumi.Input[_builtins.str], resource_id: Optional[pulumi.Input[_builtins.str]] = ..., root_folder_path: Optional[pulumi.Input[_builtins.str]] = ..., sas_token: Optional[pulumi.Input[_builtins.str]] = ..., storage_account: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def root_folder_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ExportDeliveryInfoArgs:
    def __init__(__self__, *, destination: pulumi.Input[ExportDeliveryDestinationArgs]) -> None:
    ...
    @destination.setter
    def destination(self, value: pulumi.Input[ExportDeliveryDestinationArgs]): # -> None:
        ...
...
class ExportRecurrencePeriodArgs:
    def __init__(__self__, *, from_: pulumi.Input[_builtins.str], to: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ExportScheduleArgs:
    def __init__(__self__, *, recurrence: Optional[pulumi.Input[Union[_builtins.str, RecurrenceType]]] = ..., recurrence_period: Optional[pulumi.Input[ExportRecurrencePeriodArgs]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, StatusType]]] = ...) -> None:
    ...
    @recurrence.setter
    def recurrence(self, value: Optional[pulumi.Input[Union[_builtins.str, RecurrenceType]]]): # -> None:
        ...
    ...
    def recurrence_period(self, value: Optional[pulumi.Input[ExportRecurrencePeriodArgs]]): # -> None:
        ...
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[_builtins.str, StatusType]]]): # -> None:
        ...
...
class FileDestinationArgs:
    def __init__(__self__, *, file_formats: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, FileFormat]]]]] = ...) -> None:
    ...
    @file_formats.setter
    def file_formats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, FileFormat]]]]]): # -> None:
        ...
...
class KpiPropertiesArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, KpiTypeType]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, KpiTypeType]]]): # -> None:
        ...
...
class NotificationPropertiesArgs:
    def __init__(__self__, *, subject: pulumi.Input[_builtins.str], to: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], language: Optional[pulumi.Input[_builtins.str]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ..., regional_format: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @to.setter
    def to(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def regional_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NotificationArgs:
    def __init__(__self__, *, contact_emails: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], enabled: pulumi.Input[_builtins.bool], operator: pulumi.Input[Union[_builtins.str, BudgetNotificationOperatorType]], threshold: pulumi.Input[_builtins.float], contact_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., contact_roles: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., frequency: Optional[pulumi.Input[Union[_builtins.str, Frequency]]] = ..., locale: Optional[pulumi.Input[Union[_builtins.str, CultureCode]]] = ..., threshold_type: Optional[pulumi.Input[Union[_builtins.str, ThresholdType]]] = ...) -> None:
    ...
    def contact_emails(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @_builtins.property
    @pulumi.getter
    def operator(self) -> pulumi.Input[Union[_builtins.str, BudgetNotificationOperatorType]]:
        
        ...
    
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, BudgetNotificationOperatorType]]): # -> None:
        ...
    ...
    def contact_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def contact_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @frequency.setter
    def frequency(self, value: Optional[pulumi.Input[Union[_builtins.str, Frequency]]]): # -> None:
        ...
    ...
    @locale.setter
    def locale(self, value: Optional[pulumi.Input[Union[_builtins.str, CultureCode]]]): # -> None:
        ...
    ...
    def threshold_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ThresholdType]]]): # -> None:
        ...
...
class PivotPropertiesArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, PivotTypeType]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, PivotTypeType]]]): # -> None:
        ...
...
class ReportAggregationArgs:
    def __init__(__self__, *, function: pulumi.Input[Union[_builtins.str, FunctionType]], name: pulumi.Input[_builtins.str]) -> None:
    ...
    @function.setter
    def function(self, value: pulumi.Input[Union[_builtins.str, FunctionType]]): # -> None:
        ...
...
class ReportComparisonExpressionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], operator: pulumi.Input[Union[_builtins.str, OperatorType]], values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @operator.setter
    def operator(self, value: pulumi.Input[Union[_builtins.str, OperatorType]]): # -> None:
        ...
...
class ReportConfigDatasetArgs:
    def __init__(__self__, *, aggregation: Optional[pulumi.Input[Mapping[str, pulumi.Input[ReportConfigAggregationArgs]]]] = ..., configuration: Optional[pulumi.Input[ReportConfigDatasetConfigurationArgs]] = ..., filter: Optional[pulumi.Input[ReportConfigFilterArgs]] = ..., granularity: Optional[pulumi.Input[Union[_builtins.str, ReportGranularityType]]] = ..., grouping: Optional[pulumi.Input[Sequence[pulumi.Input[ReportConfigGroupingArgs]]]] = ..., sorting: Optional[pulumi.Input[Sequence[pulumi.Input[ReportConfigSortingArgs]]]] = ...) -> None:
    ...
    @aggregation.setter
    def aggregation(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[ReportConfigAggregationArgs]]]]): # -> None:
        ...
    ...
    @configuration.setter
    def configuration(self, value: Optional[pulumi.Input[ReportConfigDatasetConfigurationArgs]]): # -> None:
        ...
    ...
    @filter.setter
    def filter(self, value: Optional[pulumi.Input[ReportConfigFilterArgs]]): # -> None:
        ...
    ...
    @granularity.setter
    def granularity(self, value: Optional[pulumi.Input[Union[_builtins.str, ReportGranularityType]]]): # -> None:
        ...
    ...
    @grouping.setter
    def grouping(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ReportConfigGroupingArgs]]]]): # -> None:
        ...
    ...
    @sorting.setter
    def sorting(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ReportConfigSortingArgs]]]]): # -> None:
        ...
...
class ReportConfigFilterArgs:
    def __init__(__self__, *, and_: Optional[pulumi.Input[Sequence[pulumi.Input[ReportConfigFilterArgs]]]] = ..., dimensions: Optional[pulumi.Input[ReportConfigComparisonExpressionArgs]] = ..., or_: Optional[pulumi.Input[Sequence[pulumi.Input[ReportConfigFilterArgs]]]] = ..., tags: Optional[pulumi.Input[ReportConfigComparisonExpressionArgs]] = ...) -> None:
    ...
    @and_.setter
    def and_(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ReportConfigFilterArgs]]]]): # -> None:
        ...
    ...
    @dimensions.setter
    def dimensions(self, value: Optional[pulumi.Input[ReportConfigComparisonExpressionArgs]]): # -> None:
        ...
    ...
    @or_.setter
    def or_(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ReportConfigFilterArgs]]]]): # -> None:
        ...
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[ReportConfigComparisonExpressionArgs]]): # -> None:
        ...
...
class ReportConfigGroupingArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], type: pulumi.Input[Union[_builtins.str, QueryColumnType]]) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, QueryColumnType]]): # -> None:
        ...
...
class ReportConfigSortingArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], direction: Optional[pulumi.Input[Union[_builtins.str, ReportConfigSortingType]]] = ...) -> None:
    ...
    @direction.setter
    def direction(self, value: Optional[pulumi.Input[Union[_builtins.str, ReportConfigSortingType]]]): # -> None:
        ...
...
class ReportDatasetArgs:
    def __init__(__self__, *, aggregation: Optional[pulumi.Input[Mapping[str, pulumi.Input[ReportAggregationArgs]]]] = ..., configuration: Optional[pulumi.Input[ReportDatasetConfigurationArgs]] = ..., filter: Optional[pulumi.Input[ReportFilterArgs]] = ..., granularity: Optional[pulumi.Input[Union[_builtins.str, GranularityType]]] = ..., grouping: Optional[pulumi.Input[Sequence[pulumi.Input[ReportGroupingArgs]]]] = ...) -> None:
    ...
    @aggregation.setter
    def aggregation(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[ReportAggregationArgs]]]]): # -> None:
        ...
    ...
    @configuration.setter
    def configuration(self, value: Optional[pulumi.Input[ReportDatasetConfigurationArgs]]): # -> None:
        ...
    ...
    @filter.setter
    def filter(self, value: Optional[pulumi.Input[ReportFilterArgs]]): # -> None:
        ...
    ...
    @grouping.setter
    def grouping(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ReportGroupingArgs]]]]): # -> None:
        ...
...
class ReportDefinitionArgs:
    def __init__(__self__, *, timeframe: pulumi.Input[Union[_builtins.str, TimeframeType]], type: pulumi.Input[Union[_builtins.str, ReportType]], dataset: Optional[pulumi.Input[ReportDatasetArgs]] = ..., time_period: Optional[pulumi.Input[ReportTimePeriodArgs]] = ...) -> None:
    ...
    @dataset.setter
    def dataset(self, value: Optional[pulumi.Input[ReportDatasetArgs]]): # -> None:
        ...
    ...
    @time_period.setter
    def time_period(self, value: Optional[pulumi.Input[ReportTimePeriodArgs]]): # -> None:
        ...
...
class ReportDeliveryDestinationArgs:
    def __init__(__self__, *, container: pulumi.Input[_builtins.str], resource_id: pulumi.Input[_builtins.str], root_folder_path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ReportDeliveryInfoArgs:
    def __init__(__self__, *, destination: pulumi.Input[ReportDeliveryDestinationArgs]) -> None:
    ...
    @destination.setter
    def destination(self, value: pulumi.Input[ReportDeliveryDestinationArgs]): # -> None:
        ...
...
class ReportFilterArgs:
    ...
    @and_.setter
    def and_(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ReportFilterArgs]]]]): # -> None:
        ...
    ...
    @dimension.setter
    def dimension(self, value: Optional[pulumi.Input[ReportComparisonExpressionArgs]]): # -> None:
        ...
    ...
    @not_.setter
    def not_(self, value: Optional[pulumi.Input[ReportFilterArgs]]): # -> None:
        ...
    ...
    @or_.setter
    def or_(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ReportFilterArgs]]]]): # -> None:
        ...
    ...
    @tag.setter
    def tag(self, value: Optional[pulumi.Input[ReportComparisonExpressionArgs]]): # -> None:
        ...
...
class ReportGroupingArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], type: pulumi.Input[Union[_builtins.str, ReportColumnType]]) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ReportColumnType]]): # -> None:
        ...
...
class ReportScheduleArgs:
    def __init__(__self__, *, recurrence: pulumi.Input[Union[_builtins.str, RecurrenceType]], recurrence_period: Optional[pulumi.Input[ReportRecurrencePeriodArgs]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, StatusType]]] = ...) -> None:
    ...
    @recurrence.setter
    def recurrence(self, value: pulumi.Input[Union[_builtins.str, RecurrenceType]]): # -> None:
        ...
    ...
    @recurrence_period.setter
    def recurrence_period(self, value: Optional[pulumi.Input[ReportRecurrencePeriodArgs]]): # -> None:
        ...
...
class SchedulePropertiesArgs:
    def __init__(__self__, *, end_date: pulumi.Input[_builtins.str], frequency: pulumi.Input[Union[_builtins.str, ScheduleFrequency]], start_date: pulumi.Input[_builtins.str], day_of_month: Optional[pulumi.Input[_builtins.int]] = ..., days_of_week: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, DaysOfWeek]]]]] = ..., hour_of_day: Optional[pulumi.Input[_builtins.int]] = ..., weeks_of_month: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, WeeksOfMonth]]]]] = ...) -> None:
    ...
    @frequency.setter
    def frequency(self, value: pulumi.Input[Union[_builtins.str, ScheduleFrequency]]): # -> None:
        ...
    ...
    @day_of_month.setter
    def day_of_month(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @days_of_week.setter
    def days_of_week(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, DaysOfWeek]]]]]): # -> None:
        ...
    ...
    @hour_of_day.setter
    def hour_of_day(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def weeks_of_month(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, WeeksOfMonth]]]]]): # -> None:
        ...
...
class SettingsPropertiesCacheArgs:
    def __init__(__self__, *, channel: pulumi.Input[_builtins.str], id: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], subchannel: pulumi.Input[_builtins.str], parent: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @subchannel.setter
    def subchannel(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class SourceCostAllocationResourceArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], resource_type: pulumi.Input[Union[_builtins.str, CostAllocationResourceType]], values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def resource_type(self) -> pulumi.Input[Union[_builtins.str, CostAllocationResourceType]]:
        
        ...
    
    @resource_type.setter
    def resource_type(self, value: pulumi.Input[Union[_builtins.str, CostAllocationResourceType]]): # -> None:
        ...
...
class TagInheritancePropertiesArgs:
    def __init__(__self__, *, prefer_container_tags: pulumi.Input[_builtins.bool]) -> None:
    ...
    def prefer_container_tags(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class TargetCostAllocationResourceArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], policy_type: pulumi.Input[Union[_builtins.str, CostAllocationPolicyType]], resource_type: pulumi.Input[Union[_builtins.str, CostAllocationResourceType]], values: pulumi.Input[Sequence[pulumi.Input[CostAllocationProportionArgs]]]) -> None:
    ...
    def policy_type(self) -> pulumi.Input[Union[_builtins.str, CostAllocationPolicyType]]:
        
        ...
    
    @policy_type.setter
    def policy_type(self, value: pulumi.Input[Union[_builtins.str, CostAllocationPolicyType]]): # -> None:
        ...
    ...
    @values.setter
    def values(self, value: pulumi.Input[Sequence[pulumi.Input[CostAllocationProportionArgs]]]): # -> None:
        ...
