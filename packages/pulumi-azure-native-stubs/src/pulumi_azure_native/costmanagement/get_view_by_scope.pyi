...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetViewByScopeResult', 'AwaitableGetViewByScopeResult', 'get_view_by_scope', 'get_view_by_scope_output']
@pulumi.output_type
...
class AwaitableGetViewByScopeResult(GetViewByScopeResult):
    def __await__(self): # -> Generator[Never, Any, GetViewByScopeResult]:
        ...
    


def get_view_by_scope(scope: Optional[_builtins.str] = ..., view_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetViewByScopeResult:
    
    ...

def get_view_by_scope_output(scope: Optional[pulumi.Input[_builtins.str]] = ..., view_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetViewByScopeResult]:
