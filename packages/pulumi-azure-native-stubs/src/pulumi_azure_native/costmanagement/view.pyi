...
@pulumi.input_type
class ViewArgs:
    def __init__(__self__, *, timeframe: pulumi.Input[Union[_builtins.str, ReportTimeframeType]], type: pulumi.Input[Union[_builtins.str, ReportType]], accumulated: Optional[pulumi.Input[Union[_builtins.str, AccumulatedType]]] = ..., chart: Optional[pulumi.Input[Union[_builtins.str, ChartType]]] = ..., data_set: Optional[pulumi.Input[ReportConfigDatasetArgs]] = ..., date_range: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., e_tag: Optional[pulumi.Input[_builtins.str]] = ..., include_monetary_commitment: Optional[pulumi.Input[_builtins.bool]] = ..., kpis: Optional[pulumi.Input[Sequence[pulumi.Input[KpiPropertiesArgs]]]] = ..., metric: Optional[pulumi.Input[Union[_builtins.str, MetricType]]] = ..., modified_on: Optional[pulumi.Input[_builtins.str]] = ..., pivots: Optional[pulumi.Input[Sequence[pulumi.Input[PivotPropertiesArgs]]]] = ..., scope: Optional[pulumi.Input[_builtins.str]] = ..., time_period: Optional[pulumi.Input[ReportConfigTimePeriodArgs]] = ..., view_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
