...
@pulumi.input_type
class StudentArgs:
    def __init__(__self__, *, billing_account_name: pulumi.Input[_builtins.str], billing_profile_name: pulumi.Input[_builtins.str], budget: pulumi.Input[AmountArgs], email: pulumi.Input[_builtins.str], expiration_date: pulumi.Input[_builtins.str], first_name: pulumi.Input[_builtins.str], invoice_section_name: pulumi.Input[_builtins.str], last_name: pulumi.Input[_builtins.str], role: pulumi.Input[Union[_builtins.str, StudentRole]], student_alias: Optional[pulumi.Input[_builtins.str]] = ..., subscription_alias: Optional[pulumi.Input[_builtins.str]] = ..., subscription_invite_last_sent_date: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @budget.setter
    def budget(self, value: pulumi.Input[AmountArgs]): # -> None:
        ...
    ...
    @role.setter
    def role(self, value: pulumi.Input[Union[_builtins.str, StudentRole]]): # -> None:
        ...
    ...
    def student_alias(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def subscription_alias(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def subscription_invite_last_sent_date(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Student(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., billing_account_name: Optional[pulumi.Input[_builtins.str]] = ..., billing_profile_name: Optional[pulumi.Input[_builtins.str]] = ..., budget: Optional[pulumi.Input[Union[AmountArgs, AmountArgsDict]]] = ..., email: Optional[pulumi.Input[_builtins.str]] = ..., expiration_date: Optional[pulumi.Input[_builtins.str]] = ..., first_name: Optional[pulumi.Input[_builtins.str]] = ..., invoice_section_name: Optional[pulumi.Input[_builtins.str]] = ..., last_name: Optional[pulumi.Input[_builtins.str]] = ..., role: Optional[pulumi.Input[Union[_builtins.str, StudentRole]]] = ..., student_alias: Optional[pulumi.Input[_builtins.str]] = ..., subscription_alias: Optional[pulumi.Input[_builtins.str]] = ..., subscription_invite_last_sent_date: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: StudentArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> Student:
