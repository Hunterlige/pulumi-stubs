...
class SaasResourceResponseProperties(dict):
    ...
    def __init__(__self__, *, created: _builtins.str, auto_renew: Optional[_builtins.bool] = ..., is_free_trial: Optional[_builtins.bool] = ..., last_modified: Optional[_builtins.str] = ..., offer_id: Optional[_builtins.str] = ..., payment_channel_metadata: Optional[Mapping[str, _builtins.str]] = ..., payment_channel_type: Optional[_builtins.str] = ..., publisher_id: Optional[_builtins.str] = ..., publisher_test_environment: Optional[_builtins.str] = ..., quantity: Optional[_builtins.float] = ..., saas_resource_name: Optional[_builtins.str] = ..., saas_session_id: Optional[_builtins.str] = ..., saas_subscription_id: Optional[_builtins.str] = ..., sku_id: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., term: Optional[outputs.SaasPropertiesResponseTerm] = ..., term_id: Optional[_builtins.str] = ...) -> None:
