...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EnvironmentStateDetailsResponse', 'EnvironmentStatusResponse', 'Gen2StorageConfigurationOutputResponse', 'IngressEnvironmentStatusResponse', 'LocalTimestampResponse', 'LocalTimestampResponseTimeZoneOffset', 'ReferenceDataSetKeyPropertyResponse', 'SkuResponse', 'TimeSeriesIdPropertyResponse', 'WarmStorageEnvironmentStatusResponse', 'WarmStoreConfigurationPropertiesResponse']
@pulumi.output_type
...
class EnvironmentStatusResponse(dict):
    ...
    def __init__(__self__, *, ingress: outputs.IngressEnvironmentStatusResponse, warm_storage: outputs.WarmStorageEnvironmentStatusResponse) -> None:
...
class IngressEnvironmentStatusResponse(dict):
    ...
    def __init__(__self__, *, state_details: outputs.EnvironmentStateDetailsResponse, state: Optional[_builtins.str] = ...) -> None:
...
class LocalTimestampResponse(dict):
    ...
    def __init__(__self__, *, format: Optional[_builtins.str] = ..., time_zone_offset: Optional[outputs.LocalTimestampResponseTimeZoneOffset] = ...) -> None:
...
class WarmStorageEnvironmentStatusResponse(dict):
    ...
    def __init__(__self__, *, current_count: Optional[_builtins.int] = ..., max_count: Optional[_builtins.int] = ..., state: Optional[_builtins.str] = ...) -> None:
