...
class ManagedInstanceLongTermRetentionPolicyArgs:
    def __init__(__self__, *, database_name: pulumi.Input[_builtins.str], managed_instance_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], backup_storage_access_tier: Optional[pulumi.Input[Union[_builtins.str, BackupStorageAccessTier]]] = ..., monthly_retention: Optional[pulumi.Input[_builtins.str]] = ..., policy_name: Optional[pulumi.Input[_builtins.str]] = ..., week_of_year: Optional[pulumi.Input[_builtins.int]] = ..., weekly_retention: Optional[pulumi.Input[_builtins.str]] = ..., yearly_retention: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def backup_storage_access_tier(self, value: Optional[pulumi.Input[Union[_builtins.str, BackupStorageAccessTier]]]): # -> None:
        ...
...
class ManagedInstanceLongTermRetentionPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., backup_storage_access_tier: Optional[pulumi.Input[Union[_builtins.str, BackupStorageAccessTier]]] = ..., database_name: Optional[pulumi.Input[_builtins.str]] = ..., managed_instance_name: Optional[pulumi.Input[_builtins.str]] = ..., monthly_retention: Optional[pulumi.Input[_builtins.str]] = ..., policy_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., week_of_year: Optional[pulumi.Input[_builtins.int]] = ..., weekly_retention: Optional[pulumi.Input[_builtins.str]] = ..., yearly_retention: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ManagedInstanceLongTermRetentionPolicyArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ManagedInstanceLongTermRetentionPolicy:
