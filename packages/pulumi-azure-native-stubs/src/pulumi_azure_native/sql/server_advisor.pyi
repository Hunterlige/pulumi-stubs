...
class ServerAdvisorArgs:
    def __init__(__self__, *, auto_execute_status: pulumi.Input[AutoExecuteStatus], resource_group_name: pulumi.Input[_builtins.str], server_name: pulumi.Input[_builtins.str], advisor_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServerAdvisor(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., advisor_name: Optional[pulumi.Input[_builtins.str]] = ..., auto_execute_status: Optional[pulumi.Input[AutoExecuteStatus]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ServerAdvisorArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ServerAdvisor:
