...
class ServerAzureADAdministratorArgs:
    def __init__(__self__, *, login: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], server_name: pulumi.Input[_builtins.str], sid: pulumi.Input[_builtins.str], administrator_name: Optional[pulumi.Input[_builtins.str]] = ..., administrator_type: Optional[pulumi.Input[Union[_builtins.str, AdministratorType]]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServerAzureADAdministrator(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: ServerAzureADAdministratorArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ServerAzureADAdministrator:
