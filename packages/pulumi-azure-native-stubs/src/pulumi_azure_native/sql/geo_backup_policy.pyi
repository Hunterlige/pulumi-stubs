...
class GeoBackupPolicyArgs:
    def __init__(
        ...
        *,
        ...
        geo_backup_policy_name: Optional[pulumi.Input[_builtins.str]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def geo_backup_policy_name(self, value: Optional[pulumi.Input[_builtins.str]]): ...
...
class GeoBackupPolicy(pulumi.CustomResource):
    ...
    def __init__(
        ...
        state: Optional[pulumi.Input[GeoBackupPolicyState]] = ...,
        __props__=...,
    ) -> None: ...
    @overload
    def __init__(
