...
class ManagedServerDnsAliasArgs:
    def __init__(__self__, *, managed_instance_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], create_dns_record: Optional[pulumi.Input[_builtins.bool]] = ..., dns_alias_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def create_dns_record(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def dns_alias_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ManagedServerDnsAlias(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., create_dns_record: Optional[pulumi.Input[_builtins.bool]] = ..., dns_alias_name: Optional[pulumi.Input[_builtins.str]] = ..., managed_instance_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ManagedServerDnsAliasArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ManagedServerDnsAlias:
