...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetServerAdvisorResult', 'AwaitableGetServerAdvisorResult', 'get_server_advisor', 'get_server_advisor_output']
@pulumi.output_type
...
class AwaitableGetServerAdvisorResult(GetServerAdvisorResult):
    def __await__(self): # -> Generator[Never, Any, GetServerAdvisorResult]:
        ...
    


def get_server_advisor(advisor_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., server_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetServerAdvisorResult:
    
    ...

def get_server_advisor_output(advisor_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetServerAdvisorResult]:
