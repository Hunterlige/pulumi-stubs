...
class DisasterRecoveryConfigurationArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], server_name: pulumi.Input[_builtins.str], disaster_recovery_configuration_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disaster_recovery_configuration_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DisasterRecoveryConfiguration(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., disaster_recovery_configuration_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: DisasterRecoveryConfigurationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> DisasterRecoveryConfiguration:
