...
class AwaitableGetExtendedServerBlobAuditingPolicyResult(
    GetExtendedServerBlobAuditingPolicyResult
):
    def __await__(self): ...

def get_extended_server_blob_auditing_policy(
...
) -> pulumi.Output[GetExtendedServerBlobAuditingPolicyResult]: ...
