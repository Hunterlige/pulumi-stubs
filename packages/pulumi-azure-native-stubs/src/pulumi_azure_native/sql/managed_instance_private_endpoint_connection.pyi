...
class ManagedInstancePrivateEndpointConnectionArgs:
    def __init__(__self__, *, managed_instance_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], private_endpoint: Optional[pulumi.Input[ManagedInstancePrivateEndpointPropertyArgs]] = ..., private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., private_link_service_connection_state: Optional[pulumi.Input[ManagedInstancePrivateLinkServiceConnectionStatePropertyArgs]] = ...) -> None:
    ...
    def private_endpoint(self, value: Optional[pulumi.Input[ManagedInstancePrivateEndpointPropertyArgs]]): # -> None:
        ...
    ...
    def private_link_service_connection_state(self, value: Optional[pulumi.Input[ManagedInstancePrivateLinkServiceConnectionStatePropertyArgs]]): # -> None:
        ...
...
class ManagedInstancePrivateEndpointConnection(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., managed_instance_name: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint: Optional[pulumi.Input[Union[ManagedInstancePrivateEndpointPropertyArgs, ManagedInstancePrivateEndpointPropertyArgsDict]]] = ..., private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., private_link_service_connection_state: Optional[pulumi.Input[Union[ManagedInstancePrivateLinkServiceConnectionStatePropertyArgs, ManagedInstancePrivateLinkServiceConnectionStatePropertyArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ManagedInstancePrivateEndpointConnectionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ManagedInstancePrivateEndpointConnection:
