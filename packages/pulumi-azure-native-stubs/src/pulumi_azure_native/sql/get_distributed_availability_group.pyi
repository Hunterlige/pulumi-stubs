...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetDistributedAvailabilityGroupResult', 'AwaitableGetDistributedAvailabilityGroupResult', 'get_distributed_availability_group', 'get_distributed_availability_group_output']
@pulumi.output_type
class GetDistributedAvailabilityGroupResult:
    
    def __init__(__self__, azure_api_version=..., databases=..., distributed_availability_group_id=..., distributed_availability_group_name=..., failover_mode=..., id=..., instance_availability_group_name=..., instance_link_role=..., name=..., partner_availability_group_name=..., partner_endpoint=..., partner_link_role=..., replication_mode=..., seeding_mode=..., type=...) -> None:
        ...
...
class AwaitableGetDistributedAvailabilityGroupResult(GetDistributedAvailabilityGroupResult):
    def __await__(self): # -> Generator[Never, Any, GetDistributedAvailabilityGroupResult]:
        ...
    


def get_distributed_availability_group(distributed_availability_group_name: Optional[_builtins.str] = ..., managed_instance_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDistributedAvailabilityGroupResult:
    
    ...

def get_distributed_availability_group_output(distributed_availability_group_name: Optional[pulumi.Input[_builtins.str]] = ..., managed_instance_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDistributedAvailabilityGroupResult]:
