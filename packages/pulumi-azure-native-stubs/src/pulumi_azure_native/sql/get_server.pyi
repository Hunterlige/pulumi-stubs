...
class GetServerResult:
    ...
    def __init__(__self__, administrator_login=..., administrators=..., azure_api_version=..., external_governance_status=..., federated_client_id=..., fully_qualified_domain_name=..., id=..., identity=..., is_i_pv6_enabled=..., key_id=..., kind=..., location=..., minimal_tls_version=..., name=..., primary_user_assigned_identity_id=..., private_endpoint_connections=..., public_network_access=..., restrict_outbound_network_access=..., state=..., tags=..., type=..., version=..., workspace_feature=...) -> None:
        ...
...
def get_server(expand: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., server_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetServerResult:
    
    ...

def get_server_output(expand: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetServerResult]:
