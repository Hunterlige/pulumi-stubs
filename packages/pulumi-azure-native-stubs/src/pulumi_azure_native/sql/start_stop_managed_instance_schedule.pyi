...
class StartStopManagedInstanceScheduleArgs:
    def __init__(__self__, *, managed_instance_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], schedule_list: pulumi.Input[Sequence[pulumi.Input[ScheduleItemArgs]]], description: Optional[pulumi.Input[_builtins.str]] = ..., start_stop_schedule_name: Optional[pulumi.Input[_builtins.str]] = ..., time_zone_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def schedule_list(self, value: pulumi.Input[Sequence[pulumi.Input[ScheduleItemArgs]]]): # -> None:
        ...
    ...
    def start_stop_schedule_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StartStopManagedInstanceSchedule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., managed_instance_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., schedule_list: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ScheduleItemArgs, ScheduleItemArgsDict]]]]] = ..., start_stop_schedule_name: Optional[pulumi.Input[_builtins.str]] = ..., time_zone_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: StartStopManagedInstanceScheduleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> StartStopManagedInstanceSchedule:
