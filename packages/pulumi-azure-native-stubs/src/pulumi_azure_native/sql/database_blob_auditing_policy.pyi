...
class DatabaseBlobAuditingPolicy(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: DatabaseBlobAuditingPolicyArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> DatabaseBlobAuditingPolicy:
