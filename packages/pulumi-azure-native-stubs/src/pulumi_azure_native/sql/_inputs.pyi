...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DatabaseIdentityArgs', 'DatabaseIdentityArgsDict', ..., ..., 'DistributedAvailabilityGroupDatabaseArgs', 'DistributedAvailabilityGroupDatabaseArgsDict', 'ElasticPoolPerDatabaseSettingsArgs', 'ElasticPoolPerDatabaseSettingsArgsDict', 'FailoverGroupReadOnlyEndpointArgs', 'FailoverGroupReadOnlyEndpointArgsDict', 'FailoverGroupReadWriteEndpointArgs', 'FailoverGroupReadWriteEndpointArgsDict', 'InstanceFailoverGroupReadOnlyEndpointArgs', 'InstanceFailoverGroupReadOnlyEndpointArgsDict', 'InstanceFailoverGroupReadWriteEndpointArgs', 'InstanceFailoverGroupReadWriteEndpointArgsDict', 'JobAgentIdentityArgs', 'JobAgentIdentityArgsDict', 'JobScheduleArgs', 'JobScheduleArgsDict', 'JobStepActionArgs', 'JobStepActionArgsDict', 'JobStepExecutionOptionsArgs', 'JobStepExecutionOptionsArgsDict', 'JobStepOutputArgs', 'JobStepOutputArgsDict', 'JobTargetArgs', 'JobTargetArgsDict', 'ManagedInstanceExternalAdministratorArgs', 'ManagedInstanceExternalAdministratorArgsDict', 'ManagedInstancePairInfoArgs', 'ManagedInstancePairInfoArgsDict', 'ManagedInstancePrivateEndpointPropertyArgs', 'ManagedInstancePrivateEndpointPropertyArgsDict', ..., ..., 'PartnerInfoArgs', 'PartnerInfoArgsDict', 'PartnerRegionInfoArgs', 'PartnerRegionInfoArgsDict', 'PrivateEndpointPropertyArgs', 'PrivateEndpointPropertyArgsDict', 'PrivateLinkServiceConnectionStatePropertyArgs', 'PrivateLinkServiceConnectionStatePropertyArgsDict', 'ResourceIdentityArgs', 'ResourceIdentityArgsDict', 'ScheduleItemArgs', 'ScheduleItemArgsDict', 'ServerExternalAdministratorArgs', 'ServerExternalAdministratorArgsDict', 'ServerInfoArgs', 'ServerInfoArgsDict', 'ServicePrincipalArgs', 'ServicePrincipalArgsDict', 'SkuArgs', 'SkuArgsDict', 'SyncGroupSchemaTableColumnArgs', 'SyncGroupSchemaTableColumnArgsDict', 'SyncGroupSchemaTableArgs', 'SyncGroupSchemaTableArgsDict', 'SyncGroupSchemaArgs', 'SyncGroupSchemaArgsDict', ..., ...]
...
class DatabaseIdentityArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[Union[_builtins.str, DatabaseIdentityType]]] = ..., user_assigned_identities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, DatabaseIdentityType]]]): # -> None:
        ...
...
class ElasticPoolPerDatabaseSettingsArgs:
    def __init__(__self__, *, auto_pause_delay: Optional[pulumi.Input[_builtins.int]] = ..., max_capacity: Optional[pulumi.Input[_builtins.float]] = ..., min_capacity: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @max_capacity.setter
    def max_capacity(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class FailoverGroupReadOnlyEndpointArgs:
    def __init__(__self__, *, failover_policy: Optional[pulumi.Input[Union[_builtins.str, ReadOnlyEndpointFailoverPolicy]]] = ..., target_server: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def failover_policy(self, value: Optional[pulumi.Input[Union[_builtins.str, ReadOnlyEndpointFailoverPolicy]]]): # -> None:
        ...
    ...
    def target_server(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FailoverGroupReadWriteEndpointArgs:
    def __init__(__self__, *, failover_policy: pulumi.Input[Union[_builtins.str, ReadWriteEndpointFailoverPolicy]], failover_with_data_loss_grace_period_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @failover_policy.setter
    def failover_policy(self, value: pulumi.Input[Union[_builtins.str, ReadWriteEndpointFailoverPolicy]]): # -> None:
        ...
    ...
    def failover_with_data_loss_grace_period_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class InstanceFailoverGroupReadOnlyEndpointArgs:
    def __init__(__self__, *, failover_policy: Optional[pulumi.Input[Union[_builtins.str, ReadOnlyEndpointFailoverPolicy]]] = ...) -> None:
...
class JobAgentIdentityArgs:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, JobAgentIdentityType]], tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., user_assigned_identities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, JobAgentIdentityType]]): # -> None:
        ...
...
class JobScheduleArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., end_time: Optional[pulumi.Input[_builtins.str]] = ..., interval: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[JobScheduleType]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[JobScheduleType]]): # -> None:
        ...
...
class JobStepActionArgs:
    def __init__(__self__, *, value: pulumi.Input[_builtins.str], source: Optional[pulumi.Input[Union[_builtins.str, JobStepActionSource]]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, JobStepActionType]]] = ...) -> None:
    ...
    @source.setter
    def source(self, value: Optional[pulumi.Input[Union[_builtins.str, JobStepActionSource]]]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, JobStepActionType]]]): # -> None:
        ...
...
class JobStepExecutionOptionsArgs:
    def __init__(__self__, *, initial_retry_interval_seconds: Optional[pulumi.Input[_builtins.int]] = ..., maximum_retry_interval_seconds: Optional[pulumi.Input[_builtins.int]] = ..., retry_attempts: Optional[pulumi.Input[_builtins.int]] = ..., retry_interval_backoff_multiplier: Optional[pulumi.Input[_builtins.float]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def initial_retry_interval_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def maximum_retry_interval_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def retry_attempts(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def retry_interval_backoff_multiplier(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class JobStepOutputArgs:
    def __init__(__self__, *, database_name: pulumi.Input[_builtins.str], server_name: pulumi.Input[_builtins.str], table_name: pulumi.Input[_builtins.str], credential: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., schema_name: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, JobStepOutputType]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, JobStepOutputType]]]): # -> None:
        ...
...
@pulumi.input_type
class JobTargetArgs:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, JobTargetType]], database_name: Optional[pulumi.Input[_builtins.str]] = ..., elastic_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., membership_type: Optional[pulumi.Input[JobTargetGroupMembershipType]] = ..., refresh_credential: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., shard_map_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, JobTargetType]]): # -> None:
        ...
    ...
    def membership_type(self, value: Optional[pulumi.Input[JobTargetGroupMembershipType]]): # -> None:
        ...
    ...
    def refresh_credential(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def shard_map_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ManagedInstanceExternalAdministratorArgs:
    def __init__(__self__, *, administrator_type: Optional[pulumi.Input[Union[_builtins.str, AdministratorType]]] = ..., azure_ad_only_authentication: Optional[pulumi.Input[_builtins.bool]] = ..., login: Optional[pulumi.Input[_builtins.str]] = ..., principal_type: Optional[pulumi.Input[Union[_builtins.str, PrincipalType]]] = ..., sid: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def administrator_type(self, value: Optional[pulumi.Input[Union[_builtins.str, AdministratorType]]]): # -> None:
        ...
    ...
    def azure_ad_only_authentication(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ManagedInstancePairInfoArgs:
    def __init__(__self__, *, partner_managed_instance_id: Optional[pulumi.Input[_builtins.str]] = ..., primary_managed_instance_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def partner_managed_instance_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def primary_managed_instance_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PrivateLinkServiceConnectionStatePropertyArgs:
    def __init__(__self__, *, description: pulumi.Input[_builtins.str], status: pulumi.Input[Union[_builtins.str, PrivateLinkServiceConnectionStateStatus]]) -> None:
    ...
    @status.setter
    def status(self, value: pulumi.Input[Union[_builtins.str, PrivateLinkServiceConnectionStateStatus]]): # -> None:
        ...
...
class ResourceIdentityArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[Union[_builtins.str, IdentityType]]] = ..., user_assigned_identities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ScheduleItemArgs:
    def __init__(__self__, *, start_day: pulumi.Input[Union[_builtins.str, DayOfWeek]], start_time: pulumi.Input[_builtins.str], stop_day: pulumi.Input[Union[_builtins.str, DayOfWeek]], stop_time: pulumi.Input[_builtins.str]) -> None:
    ...
    @start_day.setter
    def start_day(self, value: pulumi.Input[Union[_builtins.str, DayOfWeek]]): # -> None:
        ...
    ...
    @stop_day.setter
    def stop_day(self, value: pulumi.Input[Union[_builtins.str, DayOfWeek]]): # -> None:
        ...
...
class ServicePrincipalArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[Union[_builtins.str, ServicePrincipalType]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, ServicePrincipalType]]]): # -> None:
        ...
...
@pulumi.input_type
class SkuArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], capacity: Optional[pulumi.Input[_builtins.int]] = ..., family: Optional[pulumi.Input[_builtins.str]] = ..., size: Optional[pulumi.Input[_builtins.str]] = ..., tier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SyncGroupSchemaTableColumnArgs:
    def __init__(__self__, *, data_size: Optional[pulumi.Input[_builtins.str]] = ..., data_type: Optional[pulumi.Input[_builtins.str]] = ..., quoted_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_size.setter
    def data_size(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @quoted_name.setter
    def quoted_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SyncGroupSchemaTableArgs:
    def __init__(__self__, *, columns: Optional[pulumi.Input[Sequence[pulumi.Input[SyncGroupSchemaTableColumnArgs]]]] = ..., quoted_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @columns.setter
    def columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SyncGroupSchemaTableColumnArgs]]]]): # -> None:
        ...
...
class SyncGroupSchemaArgs:
    def __init__(__self__, *, master_sync_member_name: Optional[pulumi.Input[_builtins.str]] = ..., tables: Optional[pulumi.Input[Sequence[pulumi.Input[SyncGroupSchemaTableArgs]]]] = ...) -> None:
    ...
    def master_sync_member_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @tables.setter
    def tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SyncGroupSchemaTableArgs]]]]): # -> None:
        ...
