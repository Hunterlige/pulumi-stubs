...
class ServerBlobAuditingPolicyArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], server_name: pulumi.Input[_builtins.str], state: pulumi.Input[BlobAuditingPolicyState], audit_actions_and_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., blob_auditing_policy_name: Optional[pulumi.Input[_builtins.str]] = ..., is_azure_monitor_target_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_devops_audit_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_managed_identity_in_use: Optional[pulumi.Input[_builtins.bool]] = ..., is_storage_secondary_key_in_use: Optional[pulumi.Input[_builtins.bool]] = ..., queue_delay_ms: Optional[pulumi.Input[_builtins.int]] = ..., retention_days: Optional[pulumi.Input[_builtins.int]] = ..., storage_account_access_key: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_endpoint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def is_devops_audit_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ServerBlobAuditingPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., audit_actions_and_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., blob_auditing_policy_name: Optional[pulumi.Input[_builtins.str]] = ..., is_azure_monitor_target_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_devops_audit_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_managed_identity_in_use: Optional[pulumi.Input[_builtins.bool]] = ..., is_storage_secondary_key_in_use: Optional[pulumi.Input[_builtins.bool]] = ..., queue_delay_ms: Optional[pulumi.Input[_builtins.int]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., retention_days: Optional[pulumi.Input[_builtins.int]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[BlobAuditingPolicyState]] = ..., storage_account_access_key: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_endpoint: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ServerBlobAuditingPolicyArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ServerBlobAuditingPolicy:
