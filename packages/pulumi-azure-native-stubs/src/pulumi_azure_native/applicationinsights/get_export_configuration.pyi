...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetExportConfigurationResult', 'AwaitableGetExportConfigurationResult', 'get_export_configuration', 'get_export_configuration_output']
@pulumi.output_type
class GetExportConfigurationResult:
    
    def __init__(__self__, application_name=..., azure_api_version=..., container_name=..., destination_account_id=..., destination_storage_location_id=..., destination_storage_subscription_id=..., destination_type=..., export_id=..., export_status=..., instrumentation_key=..., is_user_enabled=..., last_gap_time=..., last_success_time=..., last_user_update=..., notification_queue_enabled=..., permanent_error_reason=..., record_types=..., resource_group=..., storage_name=..., subscription_id=...) -> None:
        ...
...
class AwaitableGetExportConfigurationResult(GetExportConfigurationResult):
    def __await__(self): # -> Generator[Never, Any, GetExportConfigurationResult]:
        ...
    


def get_export_configuration(export_id: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., resource_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetExportConfigurationResult:
    
    ...

def get_export_configuration_output(export_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetExportConfigurationResult]:
