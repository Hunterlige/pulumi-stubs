...
class GetVirtualMachineResult:
    ...
    def __init__(__self__, amount_of_ram=..., azure_api_version=..., controllers=..., customization=..., disks=..., dnsname=..., expose_to_guest_vm=..., folder=..., guest_os=..., guest_os_type=..., id=..., location=..., name=..., nics=..., number_of_cores=..., password=..., private_cloud_id=..., provisioning_state=..., public_ip=..., resource_pool=..., status=..., tags=..., template_id=..., type=..., username=..., v_sphere_networks=..., vm_id=..., vmwaretools=...) -> None:
        ...
