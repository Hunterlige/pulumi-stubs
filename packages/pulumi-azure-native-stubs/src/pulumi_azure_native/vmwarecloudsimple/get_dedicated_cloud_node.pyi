...
def get_dedicated_cloud_node(
    dedicated_cloud_node_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetDedicatedCloudNodeResult: ...
def get_dedicated_cloud_node_output(
    dedicated_cloud_node_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetDedicatedCloudNodeResult]: ...
