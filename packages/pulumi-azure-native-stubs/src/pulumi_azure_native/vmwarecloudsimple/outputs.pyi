...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DedicatedCloudNodePropertiesResponse', 'GuestOSCustomizationResponse', 'GuestOSNICCustomizationResponse', 'ResourcePoolResponse', 'SkuResponse', 'VirtualDiskControllerResponse', 'VirtualDiskResponse', 'VirtualNetworkResponse', 'VirtualNicResponse']
@pulumi.output_type
class DedicatedCloudNodePropertiesResponse(dict):
    ...
    def __init__(__self__, *, availability_zone_id: _builtins.str, availability_zone_name: _builtins.str, cloud_rack_name: _builtins.str, created: _builtins.str, id: _builtins.str, name: _builtins.str, nodes_count: _builtins.int, placement_group_id: _builtins.str, placement_group_name: _builtins.str, private_cloud_id: _builtins.str, private_cloud_name: _builtins.str, provisioning_state: _builtins.str, purchase_id: _builtins.str, status: _builtins.str, vmware_cluster_name: _builtins.str) -> None:
...
class GuestOSCustomizationResponse(dict):
    ...
    def __init__(__self__, *, dns_servers: Optional[Sequence[_builtins.str]] = ..., host_name: Optional[_builtins.str] = ..., password: Optional[_builtins.str] = ..., policy_id: Optional[_builtins.str] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class GuestOSNICCustomizationResponse(dict):
    ...
    def __init__(__self__, *, allocation: Optional[_builtins.str] = ..., dns_servers: Optional[Sequence[_builtins.str]] = ..., gateway: Optional[Sequence[_builtins.str]] = ..., ip_address: Optional[_builtins.str] = ..., mask: Optional[_builtins.str] = ..., primary_wins_server: Optional[_builtins.str] = ..., secondary_wins_server: Optional[_builtins.str] = ...) -> None:
...
class ResourcePoolResponse(dict):
    ...
    def __init__(__self__, *, full_name: _builtins.str, id: _builtins.str, location: _builtins.str, name: _builtins.str, private_cloud_id: _builtins.str, type: _builtins.str) -> None:
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, capacity: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., family: Optional[_builtins.str] = ..., tier: Optional[_builtins.str] = ...) -> None:
...
class VirtualDiskControllerResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, sub_type: _builtins.str, type: _builtins.str) -> None:
...
class VirtualDiskResponse(dict):
    ...
    def __init__(__self__, *, controller_id: _builtins.str, independence_mode: _builtins.str, total_size: _builtins.int, virtual_disk_name: _builtins.str, virtual_disk_id: Optional[_builtins.str] = ...) -> None:
...
class VirtualNetworkResponse(dict):
    ...
    def __init__(__self__, *, assignable: _builtins.bool, id: _builtins.str, location: _builtins.str, name: _builtins.str, private_cloud_id: _builtins.str, type: _builtins.str) -> None:
...
class VirtualNicResponse(dict):
    ...
    def __init__(__self__, *, network: outputs.VirtualNetworkResponse, nic_type: _builtins.str, virtual_nic_name: _builtins.str, customization: Optional[outputs.GuestOSNICCustomizationResponse] = ..., ip_addresses: Optional[Sequence[_builtins.str]] = ..., mac_address: Optional[_builtins.str] = ..., power_on_boot: Optional[_builtins.bool] = ..., virtual_nic_id: Optional[_builtins.str] = ...) -> None:
