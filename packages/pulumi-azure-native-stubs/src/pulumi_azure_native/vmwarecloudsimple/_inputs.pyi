...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GuestOSCustomizationArgs', 'GuestOSCustomizationArgsDict', 'GuestOSNICCustomizationArgs', 'GuestOSNICCustomizationArgsDict', 'ResourcePoolArgs', 'ResourcePoolArgsDict', 'SkuArgs', 'SkuArgsDict', 'VirtualDiskArgs', 'VirtualDiskArgsDict', 'VirtualNetworkArgs', 'VirtualNetworkArgsDict', 'VirtualNicArgs', 'VirtualNicArgsDict']
...
class GuestOSCustomizationArgs:
    def __init__(__self__, *, dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., host_name: Optional[pulumi.Input[_builtins.str]] = ..., password: Optional[pulumi.Input[_builtins.str]] = ..., policy_id: Optional[pulumi.Input[_builtins.str]] = ..., username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class GuestOSNICCustomizationArgs:
    def __init__(__self__, *, allocation: Optional[pulumi.Input[_builtins.str]] = ..., dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., gateway: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., mask: Optional[pulumi.Input[_builtins.str]] = ..., primary_wins_server: Optional[pulumi.Input[_builtins.str]] = ..., secondary_wins_server: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @allocation.setter
    def allocation(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def primary_wins_server(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def secondary_wins_server(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class SkuArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], capacity: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., family: Optional[pulumi.Input[_builtins.str]] = ..., tier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VirtualDiskArgs:
    def __init__(__self__, *, controller_id: pulumi.Input[_builtins.str], independence_mode: pulumi.Input[DiskIndependenceMode], total_size: pulumi.Input[_builtins.int], virtual_disk_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def controller_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def independence_mode(self, value: pulumi.Input[DiskIndependenceMode]): # -> None:
        ...
    ...
    def virtual_disk_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VirtualNicArgs:
    def __init__(__self__, *, network: pulumi.Input[VirtualNetworkArgs], nic_type: pulumi.Input[NICType], customization: Optional[pulumi.Input[GuestOSNICCustomizationArgs]] = ..., ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., mac_address: Optional[pulumi.Input[_builtins.str]] = ..., power_on_boot: Optional[pulumi.Input[_builtins.bool]] = ..., virtual_nic_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @network.setter
    def network(self, value: pulumi.Input[VirtualNetworkArgs]): # -> None:
        ...
    ...
    @nic_type.setter
    def nic_type(self, value: pulumi.Input[NICType]): # -> None:
        ...
    ...
    def customization(self, value: Optional[pulumi.Input[GuestOSNICCustomizationArgs]]): # -> None:
        ...
    ...
    def power_on_boot(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def virtual_nic_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
