...
class AwaitableGetMigrateProjectsControllerMigrateProjectResult(
    GetMigrateProjectsControllerMigrateProjectResult
):
    def __await__(self): ...

def get_migrate_projects_controller_migrate_project(
    migrate_project_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetMigrateProjectsControllerMigrateProjectResult: ...
def get_migrate_projects_controller_migrate_project_output(
    migrate_project_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetMigrateProjectsControllerMigrateProjectResult]: ...
