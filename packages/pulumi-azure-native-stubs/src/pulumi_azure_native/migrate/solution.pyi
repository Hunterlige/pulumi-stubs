...
@pulumi.input_type
class SolutionArgs:
    def __init__(__self__, *, migrate_project_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], properties: Optional[pulumi.Input[SolutionPropertiesArgs]] = ..., solution_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class Solution(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., migrate_project_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[SolutionPropertiesArgs, SolutionPropertiesArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., solution_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
