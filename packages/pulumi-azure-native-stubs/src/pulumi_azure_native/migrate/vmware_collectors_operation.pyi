...
class VmwareCollectorsOperationArgs:
    def __init__(__self__, *, project_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], agent_properties: Optional[pulumi.Input[CollectorAgentPropertiesBaseArgs]] = ..., discovery_site_id: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_state: Optional[pulumi.Input[Union[_builtins.str, ProvisioningState]]] = ..., vm_ware_collector_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VmwareCollectorsOperation(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., agent_properties: Optional[pulumi.Input[Union[CollectorAgentPropertiesBaseArgs, CollectorAgentPropertiesBaseArgsDict]]] = ..., discovery_site_id: Optional[pulumi.Input[_builtins.str]] = ..., project_name: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_state: Optional[pulumi.Input[Union[_builtins.str, ProvisioningState]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., vm_ware_collector_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: VmwareCollectorsOperationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> VmwareCollectorsOperation:
