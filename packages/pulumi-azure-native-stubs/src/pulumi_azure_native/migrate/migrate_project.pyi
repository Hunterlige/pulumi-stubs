...
class MigrateProjectArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], e_tag: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., migrate_project_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[MigrateProjectPropertiesArgs]] = ..., tags: Optional[pulumi.Input[MigrateProjectTagsArgs]] = ...) -> None:
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[MigrateProjectTagsArgs]]): # -> None:
        ...
...
class MigrateProject(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> MigrateProject:
