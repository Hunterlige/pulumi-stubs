...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetSqlCollectorOperationResult', 'AwaitableGetSqlCollectorOperationResult', 'get_sql_collector_operation', 'get_sql_collector_operation_output']
@pulumi.output_type
...
class AwaitableGetSqlCollectorOperationResult(GetSqlCollectorOperationResult):
    def __await__(self): # -> Generator[Never, Any, GetSqlCollectorOperationResult]:
        ...
    


def get_sql_collector_operation(collector_name: Optional[_builtins.str] = ..., project_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetSqlCollectorOperationResult:
    
    ...

def get_sql_collector_operation_output(collector_name: Optional[pulumi.Input[_builtins.str]] = ..., project_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetSqlCollectorOperationResult]:
