...
class GetWorkloadDeploymentSecretConfigurationsResult:
    def __init__(
        __self__, id=..., name=..., properties=..., system_data=..., tags=..., type=...
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
...
class AwaitableGetWorkloadDeploymentSecretConfigurationsResult(
    GetWorkloadDeploymentSecretConfigurationsResult
):
    def __await__(self): ...

def get_workload_deployment_secret_configurations(
...
def get_workload_deployment_secret_configurations_output(
...
) -> pulumi.Output[GetWorkloadDeploymentSecretConfigurationsResult]: ...
