...
class WebAppCollectorOperationArgs:
    def __init__(__self__, *, project_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], agent_properties: Optional[pulumi.Input[CollectorAgentPropertiesBaseArgs]] = ..., collector_name: Optional[pulumi.Input[_builtins.str]] = ..., discovery_site_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WebAppCollectorOperation(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: WebAppCollectorOperationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> WebAppCollectorOperation:
