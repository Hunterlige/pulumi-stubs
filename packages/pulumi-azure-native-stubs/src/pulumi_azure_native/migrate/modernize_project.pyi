...
class ModernizeProjectArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[ModernizeProjectModelPropertiesArgs]] = ...,
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[ModernizeProjectModelPropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[ModernizeProjectModelPropertiesArgs]]
    ): ...
    @_builtins.property
...
class ModernizeProject(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.ModernizeProjectModelPropertiesResponse]: ...
    @_builtins.property
    @pulumi.getter(name="systemData")
    def system_data(
        self,
    ) -> pulumi.Output[outputs.ModernizeProjectModelResponseSystemData]: ...
    @_builtins.property
    @pulumi.getter
