...
class SqlCollectorOperationArgs:
    def __init__(__self__, *, project_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], agent_properties: Optional[pulumi.Input[CollectorAgentPropertiesBaseArgs]] = ..., collector_name: Optional[pulumi.Input[_builtins.str]] = ..., discovery_site_id: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_state: Optional[pulumi.Input[Union[_builtins.str, ProvisioningState]]] = ...) -> None:
    ...
    def collector_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SqlCollectorOperation(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SqlCollectorOperation:
