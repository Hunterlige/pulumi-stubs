...
class WebAppAssessmentV3OperationArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[WebAppAssessmentV3PropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[WebAppAssessmentV3PropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[WebAppAssessmentV3PropertiesArgs]]
    ): ...
...
class WebAppAssessmentV3Operation(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.WebAppAssessmentV3PropertiesResponse]: ...
    @_builtins.property
