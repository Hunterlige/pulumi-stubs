...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ACRPropertiesArgs', 'ACRPropertiesArgsDict', 'AKSAssessmentSettingsArgs', 'AKSAssessmentSettingsArgsDict', 'AKSDeploymentPropertiesArgs', 'AKSDeploymentPropertiesArgsDict', 'AKSDeploymentSpecificationArgs', 'AKSDeploymentSpecificationArgsDict', ..., ..., 'ApacheTomcatAKSWorkloadDeploymentArgs', 'ApacheTomcatAKSWorkloadDeploymentArgsDict', 'ApacheTomcatWebApplicationArgs', 'ApacheTomcatWebApplicationArgsDict', ..., ..., 'AppInsightMonitoringPropertiesArgs', 'AppInsightMonitoringPropertiesArgsDict', 'AppSvcContainerSettingsArgs', 'AppSvcContainerSettingsArgsDict', 'AppSvcNativeSettingsArgs', 'AppSvcNativeSettingsArgsDict', 'ArgArgs', 'ArgArgsDict', 'AssessmentPropertiesArgs', 'AssessmentPropertiesArgsDict', 'AssessmentScopeParametersArgs', 'AssessmentScopeParametersArgsDict', 'AutomationArtifactArgs', 'AutomationArtifactArgsDict', 'AvailabilitySetResourceSettingsArgs', 'AvailabilitySetResourceSettingsArgsDict', 'AvsAssessmentPropertiesV2Args', 'AvsAssessmentPropertiesV2ArgsDict', 'AvsAssessmentSettingsArgs', 'AvsAssessmentSettingsArgsDict', 'AzureArcManagementSettingsArgs', 'AzureArcManagementSettingsArgsDict', 'AzureArcMonitoringSettingsArgs', 'AzureArcMonitoringSettingsArgsDict', 'AzureArcSettingsArgs', 'AzureArcSettingsArgsDict', 'AzureFileShareHydrationProfileArgs', 'AzureFileShareHydrationProfileArgsDict', 'AzureSettingsArgs', 'AzureSettingsArgsDict', 'BillingSettingsArgs', 'BillingSettingsArgsDict', 'BindingArgs', 'BindingArgsDict', 'CertArgs', 'CertArgsDict', 'CollectorAgentPropertiesBaseArgs', 'CollectorAgentPropertiesBaseArgsDict', 'CollectorAgentPropertiesArgs', 'CollectorAgentPropertiesArgsDict', 'CollectorAgentSpnPropertiesBaseArgs', 'CollectorAgentSpnPropertiesBaseArgsDict', 'CollectorBodyAgentSpnPropertiesArgs', 'CollectorBodyAgentSpnPropertiesArgsDict', 'CollectorPropertiesArgs', 'CollectorPropertiesArgsDict', 'CompoundAssessmentPropertiesArgs', 'CompoundAssessmentPropertiesArgsDict', 'ComputeSettingsArgs', 'ComputeSettingsArgsDict', 'ConnectionStateRequestBodyPropertiesArgs', 'ConnectionStateRequestBodyPropertiesArgsDict', 'ContainerImagePropertiesArgs', 'ContainerImagePropertiesArgsDict', 'DirectoryPathArgs', 'DirectoryPathArgsDict', 'DiscoveredEntityLightSummaryArgs', 'DiscoveredEntityLightSummaryArgsDict', 'DiskEncryptionSetResourceSettingsArgs', 'DiskEncryptionSetResourceSettingsArgsDict', 'EntityUptimeArgs', 'EntityUptimeArgsDict', 'FacilitySettingsArgs', 'FacilitySettingsArgsDict', 'GmsaAuthenticationPropertiesArgs', 'GmsaAuthenticationPropertiesArgsDict', 'GroupPropertiesArgs', 'GroupPropertiesArgsDict', 'HeterogeneousAssessmentPropertiesArgs', 'HeterogeneousAssessmentPropertiesArgsDict', 'HypervLicenseArgs', 'HypervLicenseArgsDict', 'HypervVirtualizationManagementSettingsArgs', 'HypervVirtualizationManagementSettingsArgsDict', 'IISAKSWorkloadDeploymentModelCustomPropertiesArgs', ..., 'IISAKSWorkloadDeploymentArgs', 'IISAKSWorkloadDeploymentArgsDict', 'IISApplicationDetailsArgs', 'IISApplicationDetailsArgsDict', 'IISVirtualApplicationDetailsArgs', 'IISVirtualApplicationDetailsArgsDict', 'IISWebApplicationArgs', 'IISWebApplicationArgsDict', 'IISWebServerArgs', 'IISWebServerArgsDict', 'IISWorkloadInstanceModelCustomPropertiesArgs', 'IISWorkloadInstanceModelCustomPropertiesArgsDict', 'IdentityModelArgs', 'IdentityModelArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'ImportCollectorPropertiesArgs', 'ImportCollectorPropertiesArgsDict', 'ImportSqlCollectorPropertiesArgs', 'ImportSqlCollectorPropertiesArgsDict', 'KeyVaultResourceSettingsArgs', 'KeyVaultResourceSettingsArgsDict', 'KeyVaultSecretStorePropertiesArgs', 'KeyVaultSecretStorePropertiesArgsDict', 'LBBackendAddressPoolResourceSettingsArgs', 'LBBackendAddressPoolResourceSettingsArgsDict', 'LBFrontendIPConfigurationResourceSettingsArgs', 'LBFrontendIPConfigurationResourceSettingsArgsDict', 'LaborSettingsArgs', 'LaborSettingsArgsDict', 'LinuxServerLicensingSettingsArgs', 'LinuxServerLicensingSettingsArgsDict', 'LoadBalancerBackendAddressPoolReferenceArgs', 'LoadBalancerBackendAddressPoolReferenceArgsDict', 'LoadBalancerNatRuleReferenceArgs', 'LoadBalancerNatRuleReferenceArgsDict', 'LoadBalancerResourceSettingsArgs', 'LoadBalancerResourceSettingsArgsDict', 'MachineAssessmentSettingsArgs', 'MachineAssessmentSettingsArgsDict', 'MachineAssessmentV2PropertiesArgs', 'MachineAssessmentV2PropertiesArgsDict', 'ManagedIdentityPropertiesArgs', 'ManagedIdentityPropertiesArgsDict', 'ManagementSettingsArgs', 'ManagementSettingsArgsDict', 'MigrateAgentModelPropertiesArgs', 'MigrateAgentModelPropertiesArgsDict', 'MigrateProjectPropertiesArgs', 'MigrateProjectPropertiesArgsDict', 'MigrateProjectTagsArgs', 'MigrateProjectTagsArgsDict', 'MigrationConfigurationArgs', 'MigrationConfigurationArgsDict', 'MigrationEntityGroupPropertiesArgs', 'MigrationEntityGroupPropertiesArgsDict', 'MigrationEntityPropertiesArgs', 'MigrationEntityPropertiesArgsDict', 'ModernizeProjectModelPropertiesArgs', 'ModernizeProjectModelPropertiesArgsDict', 'MoveCollectionPropertiesArgs', 'MoveCollectionPropertiesArgsDict', 'MoveResourceDependencyOverrideArgs', 'MoveResourceDependencyOverrideArgsDict', 'MoveResourcePropertiesArgs', 'MoveResourcePropertiesArgsDict', 'NetworkInterfaceResourceSettingsArgs', 'NetworkInterfaceResourceSettingsArgsDict', 'NetworkSecurityGroupResourceSettingsArgs', 'NetworkSecurityGroupResourceSettingsArgsDict', 'NetworkSettingsArgs', 'NetworkSettingsArgsDict', 'NicIpConfigurationResourceSettingsArgs', 'NicIpConfigurationResourceSettingsArgsDict', 'NsgReferenceArgs', 'NsgReferenceArgsDict', 'NsgSecurityRuleArgs', 'NsgSecurityRuleArgsDict', 'OnPremiseSettingsArgs', 'OnPremiseSettingsArgsDict', 'OperatingSystemDetailsArgs', 'OperatingSystemDetailsArgsDict', 'OtherManagementCostsSettingsArgs', 'OtherManagementCostsSettingsArgsDict', 'PerfDataSettingsArgs', 'PerfDataSettingsArgsDict', 'PerformanceDataArgs', 'PerformanceDataArgsDict', 'PortMappingArgs', 'PortMappingArgsDict', 'PrivateEndpointConnectionPropertiesArgs', 'PrivateEndpointConnectionPropertiesArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'ProjectPropertiesArgs', 'ProjectPropertiesArgsDict', 'PublicIPAddressResourceSettingsArgs', 'PublicIPAddressResourceSettingsArgsDict', 'PublicIpReferenceArgs', 'PublicIpReferenceArgsDict', 'ResourceGroupResourceSettingsArgs', 'ResourceGroupResourceSettingsArgsDict', 'ResourceIdentityArgs', 'ResourceIdentityArgsDict', 'ResourceRequirementsArgs', 'ResourceRequirementsArgsDict', 'SavingsSettingsArgs', 'SavingsSettingsArgsDict', 'ScopeArgs', 'ScopeArgsDict', 'SecretStoreDetailsArgs', 'SecretStoreDetailsArgsDict', 'SecretStorePropertiesArgs', 'SecretStorePropertiesArgsDict', 'SecuritySettingsArgs', 'SecuritySettingsArgsDict', 'ServerMigrationSpecificPropertiesArgs', 'ServerMigrationSpecificPropertiesArgsDict', 'SettingsArgs', 'SettingsArgsDict', 'SolutionDetailsArgs', 'SolutionDetailsArgsDict', 'SolutionPropertiesArgs', 'SolutionPropertiesArgsDict', 'SqlAssessmentSettingsArgs', 'SqlAssessmentSettingsArgsDict', 'SqlAssessmentV3PropertiesArgs', 'SqlAssessmentV3PropertiesArgsDict', 'SqlDatabaseResourceSettingsArgs', 'SqlDatabaseResourceSettingsArgsDict', 'SqlDbSettingsV3Args', 'SqlDbSettingsV3ArgsDict', 'SqlDbSettingsArgs', 'SqlDbSettingsArgsDict', 'SqlElasticPoolResourceSettingsArgs', 'SqlElasticPoolResourceSettingsArgsDict', 'SqlMiSettingsV3Args', 'SqlMiSettingsV3ArgsDict', 'SqlMiSettingsArgs', 'SqlMiSettingsArgsDict', 'SqlServerLicensingSettingsArgs', 'SqlServerLicensingSettingsArgsDict', 'SqlServerResourceSettingsArgs', 'SqlServerResourceSettingsArgsDict', 'SqlVmSettingsArgs', 'SqlVmSettingsArgsDict', 'StorageSettingsArgs', 'StorageSettingsArgsDict', 'SubnetReferenceArgs', 'SubnetReferenceArgsDict', 'SubnetResourceSettingsArgs', 'SubnetResourceSettingsArgsDict', 'TargetAssessmentArmIdsArgs', 'TargetAssessmentArmIdsArgsDict', 'TargetStorageProfileArgs', 'TargetStorageProfileArgsDict', 'TaskPropertiesArgs', 'TaskPropertiesArgsDict', 'ThirdPartyManagementSettingsArgs', 'ThirdPartyManagementSettingsArgsDict', 'UserAssignedIdentityArgs', 'UserAssignedIdentityArgsDict', 'VMwareMigrateAgentModelCustomPropertiesArgs', 'VMwareMigrateAgentModelCustomPropertiesArgsDict', 'VirtualMachineResourceSettingsArgs', 'VirtualMachineResourceSettingsArgsDict', 'VirtualNetworkResourceSettingsArgs', 'VirtualNetworkResourceSettingsArgsDict', 'VirtualizationSoftwareSettingsArgs', 'VirtualizationSoftwareSettingsArgsDict', 'VmUptimeArgs', 'VmUptimeArgsDict', 'WavePropertiesArgs', 'WavePropertiesArgsDict', 'WebAppAssessmentSettingsArgs', 'WebAppAssessmentSettingsArgsDict', 'WebAppAssessmentV3PropertiesArgs', 'WebAppAssessmentV3PropertiesArgsDict', 'WebApplicationConfigurationArgs', 'WebApplicationConfigurationArgsDict', 'WebApplicationDirectoryArgs', 'WebApplicationDirectoryArgsDict', 'WebApplicationFrameworkArgs', 'WebApplicationFrameworkArgsDict', 'WindowsServerLicensingSettingsArgs', 'WindowsServerLicensingSettingsArgsDict', 'WorkloadDeploymentModelPropertiesArgs', 'WorkloadDeploymentModelPropertiesArgsDict', 'WorkloadInstanceModelPropertiesArgs', 'WorkloadInstanceModelPropertiesArgsDict']
...
class ACRPropertiesArgs:
    def __init__(__self__, *, registry_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AKSAssessmentSettingsArgs:
    def __init__(__self__, *, azure_location: pulumi.Input[_builtins.str], category: pulumi.Input[Union[_builtins.str, AzureVmCategory]], consolidation: pulumi.Input[Union[_builtins.str, ConsolidationType]], currency: pulumi.Input[Union[_builtins.str, AzureCurrency]], environment_type: pulumi.Input[Union[_builtins.str, AzureEnvironmentType]], licensing_program: pulumi.Input[Union[_builtins.str, LicensingProgram]], pricing_tier: pulumi.Input[Union[_builtins.str, PricingTier]], savings_options: pulumi.Input[Union[_builtins.str, SavingsOptions]], sizing_criteria: pulumi.Input[Union[_builtins.str, AssessmentSizingCriterion]], discount_percentage: Optional[pulumi.Input[_builtins.float]] = ..., performance_data: Optional[pulumi.Input[PerfDataSettingsArgs]] = ..., scaling_factor: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def azure_location(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @category.setter
    def category(self, value: pulumi.Input[Union[_builtins.str, AzureVmCategory]]): # -> None:
        ...
    ...
    def consolidation(self, value: pulumi.Input[Union[_builtins.str, ConsolidationType]]): # -> None:
        ...
    ...
    @currency.setter
    def currency(self, value: pulumi.Input[Union[_builtins.str, AzureCurrency]]): # -> None:
        ...
    ...
    def environment_type(self, value: pulumi.Input[Union[_builtins.str, AzureEnvironmentType]]): # -> None:
        ...
    ...
    def licensing_program(self, value: pulumi.Input[Union[_builtins.str, LicensingProgram]]): # -> None:
        ...
    ...
    @pricing_tier.setter
    def pricing_tier(self, value: pulumi.Input[Union[_builtins.str, PricingTier]]): # -> None:
        ...
    ...
    def savings_options(self, value: pulumi.Input[Union[_builtins.str, SavingsOptions]]): # -> None:
        ...
    ...
    def sizing_criteria(self, value: pulumi.Input[Union[_builtins.str, AssessmentSizingCriterion]]): # -> None:
        ...
    ...
    def performance_data(self, value: Optional[pulumi.Input[PerfDataSettingsArgs]]): # -> None:
        ...
...
class AKSDeploymentPropertiesArgs:
    def __init__(__self__, *, aks_cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def aks_cluster_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AKSDeploymentSpecificationArgs:
    def __init__(__self__, *, kubernetes_objects_yaml: Optional[pulumi.Input[_builtins.str]] = ..., load_balancer_type: Optional[pulumi.Input[Union[_builtins.str, LoadBalancerType]]] = ..., replica_count: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def kubernetes_objects_yaml(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def replica_count(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApacheTomcatAKSWorkloadDeploymentModelCustomPropertiesArgs:
    def __init__(__self__, *, instance_type: pulumi.Input[_builtins.str], apache_tomcat_aks_workload_deployment_properties: Optional[pulumi.Input[ApacheTomcatAKSWorkloadDeploymentArgs]] = ...) -> None:
    ...
    def apache_tomcat_aks_workload_deployment_properties(self, value: Optional[pulumi.Input[ApacheTomcatAKSWorkloadDeploymentArgs]]): # -> None:
        ...
...
class ApacheTomcatAKSWorkloadDeploymentArgs:
    def __init__(__self__, *, automation_artifact_properties: Optional[pulumi.Input[AutomationArtifactArgs]] = ..., bindings: Optional[pulumi.Input[Sequence[pulumi.Input[BindingArgs]]]] = ..., build_container_images: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerImagePropertiesArgs]]]] = ..., cluster_properties: Optional[pulumi.Input[AKSDeploymentPropertiesArgs]] = ..., configurations: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationConfigurationArgs]]]] = ..., container_image_properties: Optional[pulumi.Input[ContainerImagePropertiesArgs]] = ..., deployment_name_prefix: Optional[pulumi.Input[_builtins.str]] = ..., deployment_spec: Optional[pulumi.Input[AKSDeploymentSpecificationArgs]] = ..., directories: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationDirectoryArgs]]]] = ..., limits: Optional[pulumi.Input[ResourceRequirementsArgs]] = ..., monitoring_properties: Optional[pulumi.Input[AppInsightMonitoringPropertiesArgs]] = ..., requests: Optional[pulumi.Input[ResourceRequirementsArgs]] = ..., target_platform_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def automation_artifact_properties(self, value: Optional[pulumi.Input[AutomationArtifactArgs]]): # -> None:
        ...
    ...
    @bindings.setter
    def bindings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BindingArgs]]]]): # -> None:
        ...
    ...
    def build_container_images(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerImagePropertiesArgs]]]]): # -> None:
        ...
    ...
    def cluster_properties(self, value: Optional[pulumi.Input[AKSDeploymentPropertiesArgs]]): # -> None:
        ...
    ...
    def configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationConfigurationArgs]]]]): # -> None:
        ...
    ...
    def container_image_properties(self, value: Optional[pulumi.Input[ContainerImagePropertiesArgs]]): # -> None:
        ...
    ...
    def deployment_name_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def deployment_spec(self, value: Optional[pulumi.Input[AKSDeploymentSpecificationArgs]]): # -> None:
        ...
    ...
    @directories.setter
    def directories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationDirectoryArgs]]]]): # -> None:
        ...
    ...
    @limits.setter
    def limits(self, value: Optional[pulumi.Input[ResourceRequirementsArgs]]): # -> None:
        ...
    ...
    def monitoring_properties(self, value: Optional[pulumi.Input[AppInsightMonitoringPropertiesArgs]]): # -> None:
        ...
    ...
    @requests.setter
    def requests(self, value: Optional[pulumi.Input[ResourceRequirementsArgs]]): # -> None:
        ...
    ...
    def target_platform_identity(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApacheTomcatWebApplicationArgs:
    def __init__(__self__, *, application_id: Optional[pulumi.Input[_builtins.str]] = ..., application_name: Optional[pulumi.Input[_builtins.str]] = ..., application_scratch_path: Optional[pulumi.Input[_builtins.str]] = ..., bindings: Optional[pulumi.Input[Sequence[pulumi.Input[BindingArgs]]]] = ..., configurations: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationConfigurationArgs]]]] = ..., directories: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationDirectoryArgs]]]] = ..., discovered_frameworks: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationFrameworkArgs]]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., limits: Optional[pulumi.Input[ResourceRequirementsArgs]] = ..., path: Optional[pulumi.Input[DirectoryPathArgs]] = ..., primary_framework: Optional[pulumi.Input[WebApplicationFrameworkArgs]] = ..., requests: Optional[pulumi.Input[ResourceRequirementsArgs]] = ..., web_server_id: Optional[pulumi.Input[_builtins.str]] = ..., web_server_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def application_scratch_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def discovered_frameworks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationFrameworkArgs]]]]): # -> None:
        ...
    ...
    @path.setter
    def path(self, value: Optional[pulumi.Input[DirectoryPathArgs]]): # -> None:
        ...
    ...
    def primary_framework(self, value: Optional[pulumi.Input[WebApplicationFrameworkArgs]]): # -> None:
        ...
    ...
    def web_server_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def web_server_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApacheTomcatWorkloadInstanceModelCustomPropertiesArgs:
    def __init__(__self__, *, instance_type: pulumi.Input[_builtins.str], apache_tomcat_web_application: Optional[pulumi.Input[ApacheTomcatWebApplicationArgs]] = ..., web_app_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., web_app_site_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def apache_tomcat_web_application(self, value: Optional[pulumi.Input[ApacheTomcatWebApplicationArgs]]): # -> None:
        ...
    ...
    def web_app_arm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppInsightMonitoringPropertiesArgs:
    def __init__(__self__, *, app_insights_name: Optional[pulumi.Input[_builtins.str]] = ..., is_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., secret_store_details: Optional[pulumi.Input[SecretStoreDetailsArgs]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def app_insights_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def secret_store_details(self, value: Optional[pulumi.Input[SecretStoreDetailsArgs]]): # -> None:
        ...
...
class AppSvcContainerSettingsArgs:
    def __init__(__self__, *, isolation_required: pulumi.Input[_builtins.bool]) -> None:
    ...
    def isolation_required(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class AssessmentPropertiesArgs:
    def __init__(__self__, *, azure_disk_type: pulumi.Input[Union[_builtins.str, AzureDiskType]], azure_hybrid_use_benefit: pulumi.Input[Union[_builtins.str, AzureHybridUseBenefit]], azure_location: pulumi.Input[Union[_builtins.str, AzureLocation]], azure_offer_code: pulumi.Input[Union[_builtins.str, AzureOfferCode]], azure_pricing_tier: pulumi.Input[Union[_builtins.str, AzurePricingTier]], azure_storage_redundancy: pulumi.Input[Union[_builtins.str, AzureStorageRedundancy]], azure_vm_families: pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AzureVmFamily]]]], currency: pulumi.Input[Union[_builtins.str, Currency]], discount_percentage: pulumi.Input[_builtins.float], percentile: pulumi.Input[Union[_builtins.str, Percentile]], reserved_instance: pulumi.Input[Union[_builtins.str, ReservedInstance]], scaling_factor: pulumi.Input[_builtins.float], sizing_criterion: pulumi.Input[Union[_builtins.str, AssessmentSizingCriterion]], stage: pulumi.Input[Union[_builtins.str, AssessmentStage]], time_range: pulumi.Input[Union[_builtins.str, TimeRange]], vm_uptime: pulumi.Input[VmUptimeArgs]) -> None:
    ...
    def azure_disk_type(self, value: pulumi.Input[Union[_builtins.str, AzureDiskType]]): # -> None:
        ...
    ...
    def azure_hybrid_use_benefit(self, value: pulumi.Input[Union[_builtins.str, AzureHybridUseBenefit]]): # -> None:
        ...
    ...
    @azure_location.setter
    def azure_location(self, value: pulumi.Input[Union[_builtins.str, AzureLocation]]): # -> None:
        ...
    ...
    def azure_offer_code(self, value: pulumi.Input[Union[_builtins.str, AzureOfferCode]]): # -> None:
        ...
    ...
    def azure_pricing_tier(self, value: pulumi.Input[Union[_builtins.str, AzurePricingTier]]): # -> None:
        ...
    ...
    def azure_storage_redundancy(self, value: pulumi.Input[Union[_builtins.str, AzureStorageRedundancy]]): # -> None:
        ...
    ...
    def azure_vm_families(self, value: pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AzureVmFamily]]]]): # -> None:
        ...
    ...
    @currency.setter
    def currency(self, value: pulumi.Input[Union[_builtins.str, Currency]]): # -> None:
        ...
    ...
    @discount_percentage.setter
    def discount_percentage(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @percentile.setter
    def percentile(self, value: pulumi.Input[Union[_builtins.str, Percentile]]): # -> None:
        ...
    ...
    def reserved_instance(self, value: pulumi.Input[Union[_builtins.str, ReservedInstance]]): # -> None:
        ...
    ...
    @scaling_factor.setter
    def scaling_factor(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def sizing_criterion(self, value: pulumi.Input[Union[_builtins.str, AssessmentSizingCriterion]]): # -> None:
        ...
    ...
    @stage.setter
    def stage(self, value: pulumi.Input[Union[_builtins.str, AssessmentStage]]): # -> None:
        ...
    ...
    @time_range.setter
    def time_range(self, value: pulumi.Input[Union[_builtins.str, TimeRange]]): # -> None:
        ...
    ...
    @vm_uptime.setter
    def vm_uptime(self, value: pulumi.Input[VmUptimeArgs]): # -> None:
        ...
...
class AssessmentScopeParametersArgs:
    def __init__(__self__, *, server_group_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def server_group_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AutomationArtifactArgs:
    def __init__(__self__, *, artifacts: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., azure_file_share_profile: Optional[pulumi.Input[AzureFileShareHydrationProfileArgs]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, AutomationArtifactStatus]]] = ...) -> None:
    ...
    @artifacts.setter
    def artifacts(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def azure_file_share_profile(self, value: Optional[pulumi.Input[AzureFileShareHydrationProfileArgs]]): # -> None:
        ...
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[_builtins.str, AutomationArtifactStatus]]]): # -> None:
        ...
...
class AvailabilitySetResourceSettingsArgs:
    def __init__(__self__, *, resource_type: pulumi.Input[_builtins.str], fault_domain: Optional[pulumi.Input[_builtins.int]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_resource_name: Optional[pulumi.Input[_builtins.str]] = ..., update_domain: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @fault_domain.setter
    def fault_domain(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def target_resource_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_resource_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def update_domain(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AvsAssessmentPropertiesV2Args:
    def __init__(__self__, *, fallback_machine_assessment_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[ScopeArgs]] = ..., settings: Optional[pulumi.Input[AvsAssessmentSettingsArgs]] = ...) -> None:
    ...
    def fallback_machine_assessment_arm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @scope.setter
    def scope(self, value: Optional[pulumi.Input[ScopeArgs]]): # -> None:
        ...
    ...
    @settings.setter
    def settings(self, value: Optional[pulumi.Input[AvsAssessmentSettingsArgs]]): # -> None:
        ...
...
class AvsAssessmentSettingsArgs:
    def __init__(__self__, *, avs_assessment_scenario: Optional[pulumi.Input[Union[_builtins.str, AvsAssessmentScenario]]] = ..., azure_location: Optional[pulumi.Input[_builtins.str]] = ..., billing_settings: Optional[pulumi.Input[BillingSettingsArgs]] = ..., cpu_headroom: Optional[pulumi.Input[_builtins.float]] = ..., currency: Optional[pulumi.Input[Union[_builtins.str, AzureCurrency]]] = ..., dedupe_compression: Optional[pulumi.Input[_builtins.float]] = ..., discount_percentage: Optional[pulumi.Input[_builtins.float]] = ..., environment_type: Optional[pulumi.Input[Union[_builtins.str, EnvironmentType]]] = ..., external_storage_types: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ExternalStorageType]]]]] = ..., failures_to_tolerate_and_raid_level_list: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, FttAndRaidLevel]]]]] = ..., is_stretch_cluster_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_vcf_byol_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., mem_overcommit: Optional[pulumi.Input[_builtins.float]] = ..., node_types: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AzureAvsNodeType]]]]] = ..., performance_data: Optional[pulumi.Input[PerformanceDataArgs]] = ..., savings_settings: Optional[pulumi.Input[SavingsSettingsArgs]] = ..., scaling_factor: Optional[pulumi.Input[_builtins.float]] = ..., sizing_criterion: Optional[pulumi.Input[Union[_builtins.str, AssessmentSizingCriterion]]] = ..., vcpu_oversubscription: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def billing_settings(self, value: Optional[pulumi.Input[BillingSettingsArgs]]): # -> None:
        ...
    ...
    @performance_data.setter
    def performance_data(self, value: Optional[pulumi.Input[PerformanceDataArgs]]): # -> None:
        ...
    ...
    def savings_settings(self, value: Optional[pulumi.Input[SavingsSettingsArgs]]): # -> None:
        ...
...
class AzureArcManagementSettingsArgs:
    def __init__(__self__, *, monitoring_settings: pulumi.Input[AzureArcMonitoringSettingsArgs]) -> None:
    ...
    def monitoring_settings(self, value: pulumi.Input[AzureArcMonitoringSettingsArgs]): # -> None:
        ...
...
class AzureArcMonitoringSettingsArgs:
    def __init__(__self__, *, alert_rules_count: pulumi.Input[_builtins.int], logs_volume_in_gb: pulumi.Input[_builtins.float]) -> None:
    ...
    def alert_rules_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def logs_volume_in_gb(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class AzureArcSettingsArgs:
    def __init__(__self__, *, azure_arc_state: pulumi.Input[Union[_builtins.str, AzureArcState]], labor_cost_percentage: Optional[pulumi.Input[_builtins.float]] = ..., management_settings: Optional[pulumi.Input[AzureArcManagementSettingsArgs]] = ...) -> None:
    ...
    def azure_arc_state(self, value: pulumi.Input[Union[_builtins.str, AzureArcState]]): # -> None:
        ...
    ...
    def labor_cost_percentage(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def management_settings(self, value: Optional[pulumi.Input[AzureArcManagementSettingsArgs]]): # -> None:
        ...
...
class AzureFileShareHydrationProfileArgs:
    def __init__(__self__, *, azure_file_share_dir_path: Optional[pulumi.Input[_builtins.str]] = ..., azure_file_share_name: Optional[pulumi.Input[_builtins.str]] = ..., azure_file_share_resource_group: Optional[pulumi.Input[_builtins.str]] = ..., azure_file_share_storage_account: Optional[pulumi.Input[_builtins.str]] = ..., azure_file_share_subscription_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def azure_file_share_dir_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def azure_file_share_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def azure_file_share_resource_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def azure_file_share_storage_account(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def azure_file_share_subscription_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AzureSettingsArgs:
    def __init__(__self__, *, currency: Optional[pulumi.Input[Union[_builtins.str, BusinessCaseCurrency]]] = ..., target_location: pulumi.Input[_builtins.str], avs_labor_cost_percentage: Optional[pulumi.Input[_builtins.float]] = ..., business_case_type: Optional[pulumi.Input[Union[_builtins.str, MigrationStrategy]]] = ..., comfort_factor: Optional[pulumi.Input[_builtins.float]] = ..., discount_percentage: Optional[pulumi.Input[_builtins.float]] = ..., iaas_labor_cost_percentage: Optional[pulumi.Input[_builtins.float]] = ..., infrastructure_growth_rate: Optional[pulumi.Input[_builtins.float]] = ..., network_cost_percentage: Optional[pulumi.Input[_builtins.float]] = ..., paas_labor_cost_percentage: Optional[pulumi.Input[_builtins.float]] = ..., per_year_migration_completion_percentage: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.float]]]] = ..., performance_data_end_time: Optional[pulumi.Input[_builtins.str]] = ..., performance_data_start_time: Optional[pulumi.Input[_builtins.str]] = ..., performance_utilization_percentile: Optional[pulumi.Input[_builtins.float]] = ..., savings_option: Optional[pulumi.Input[Union[_builtins.str, SavingsOption]]] = ..., wacc: Optional[pulumi.Input[_builtins.float]] = ..., workload_discovery_source: Optional[pulumi.Input[Union[_builtins.str, DiscoverySource]]] = ...) -> None:
    ...
    @currency.setter
    def currency(self, value: pulumi.Input[Union[_builtins.str, BusinessCaseCurrency]]): # -> None:
        ...
    ...
    def avs_labor_cost_percentage(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def business_case_type(self, value: Optional[pulumi.Input[Union[_builtins.str, MigrationStrategy]]]): # -> None:
        ...
    ...
    def comfort_factor(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def iaas_labor_cost_percentage(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def infrastructure_growth_rate(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def network_cost_percentage(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def paas_labor_cost_percentage(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def per_year_migration_completion_percentage(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.float]]]]): # -> None:
        ...
    ...
    def performance_data_end_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def performance_data_start_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def performance_utilization_percentile(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def savings_option(self, value: Optional[pulumi.Input[Union[_builtins.str, SavingsOption]]]): # -> None:
        ...
    ...
    @wacc.setter
    def wacc(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def workload_discovery_source(self, value: Optional[pulumi.Input[Union[_builtins.str, DiscoverySource]]]): # -> None:
        ...
...
class BillingSettingsArgs:
    def __init__(__self__, *, licensing_program: Optional[pulumi.Input[Union[_builtins.str, LicensingProgram]]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @licensing_program.setter
    def licensing_program(self, value: Optional[pulumi.Input[Union[_builtins.str, LicensingProgram]]]): # -> None:
        ...
...
@pulumi.input_type
class BindingArgs:
    def __init__(__self__, *, cert: Optional[pulumi.Input[CertArgs]] = ..., host_name: Optional[pulumi.Input[_builtins.str]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.str]] = ..., port_mapping: Optional[pulumi.Input[PortMappingArgs]] = ..., protocol: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @cert.setter
    def cert(self, value: Optional[pulumi.Input[CertArgs]]): # -> None:
        ...
    ...
    @port_mapping.setter
    def port_mapping(self, value: Optional[pulumi.Input[PortMappingArgs]]): # -> None:
        ...
...
@pulumi.input_type
class CertArgs:
    def __init__(__self__, *, cert_data: Optional[pulumi.Input[_builtins.str]] = ..., cert_needed: Optional[pulumi.Input[_builtins.bool]] = ..., cert_provided: Optional[pulumi.Input[_builtins.bool]] = ..., secret_store: Optional[pulumi.Input[Union[_builtins.str, SecretStoreType]]] = ...) -> None:
    ...
    @cert_data.setter
    def cert_data(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @cert_needed.setter
    def cert_needed(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def cert_provided(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @secret_store.setter
    def secret_store(self, value: Optional[pulumi.Input[Union[_builtins.str, SecretStoreType]]]): # -> None:
        ...
...
class CollectorAgentPropertiesBaseArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., last_heartbeat_utc: Optional[pulumi.Input[_builtins.str]] = ..., spn_details: Optional[pulumi.Input[CollectorAgentSpnPropertiesBaseArgs]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def last_heartbeat_utc(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @spn_details.setter
    def spn_details(self, value: Optional[pulumi.Input[CollectorAgentSpnPropertiesBaseArgs]]): # -> None:
        ...
...
class CollectorAgentPropertiesArgs:
    def __init__(__self__, *, spn_details: Optional[pulumi.Input[CollectorBodyAgentSpnPropertiesArgs]] = ...) -> None:
        ...
    ...
    @spn_details.setter
    def spn_details(self, value: Optional[pulumi.Input[CollectorBodyAgentSpnPropertiesArgs]]): # -> None:
        ...
...
class CollectorAgentSpnPropertiesBaseArgs:
    def __init__(__self__, *, application_id: Optional[pulumi.Input[_builtins.str]] = ..., audience: Optional[pulumi.Input[_builtins.str]] = ..., authority: Optional[pulumi.Input[_builtins.str]] = ..., object_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @authority.setter
    def authority(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CollectorPropertiesArgs:
    def __init__(__self__, *, agent_properties: Optional[pulumi.Input[CollectorAgentPropertiesArgs]] = ..., discovery_site_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def agent_properties(self, value: Optional[pulumi.Input[CollectorAgentPropertiesArgs]]): # -> None:
        ...
...
class CompoundAssessmentPropertiesArgs:
    def __init__(__self__, *, target_assessment_arm_ids: pulumi.Input[TargetAssessmentArmIdsArgs], fallback_machine_assessment_arm_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def target_assessment_arm_ids(self, value: pulumi.Input[TargetAssessmentArmIdsArgs]): # -> None:
        ...
...
class ComputeSettingsArgs:
    def __init__(__self__, *, hyperthread_core_to_memory_ratio: pulumi.Input[_builtins.float], price: pulumi.Input[_builtins.float], rhel_linux_server_licensing: pulumi.Input[LinuxServerLicensingSettingsArgs], sql_server_licensing: pulumi.Input[Sequence[pulumi.Input[SqlServerLicensingSettingsArgs]]], suse_linux_server_licensing: pulumi.Input[LinuxServerLicensingSettingsArgs], virtualization_software_settings: pulumi.Input[VirtualizationSoftwareSettingsArgs], windows_server_licensing: pulumi.Input[WindowsServerLicensingSettingsArgs]) -> None:
    ...
    def hyperthread_core_to_memory_ratio(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @price.setter
    def price(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def rhel_linux_server_licensing(self, value: pulumi.Input[LinuxServerLicensingSettingsArgs]): # -> None:
        ...
    ...
    def sql_server_licensing(self, value: pulumi.Input[Sequence[pulumi.Input[SqlServerLicensingSettingsArgs]]]): # -> None:
        ...
    ...
    def suse_linux_server_licensing(self, value: pulumi.Input[LinuxServerLicensingSettingsArgs]): # -> None:
        ...
    ...
    def virtualization_software_settings(self, value: pulumi.Input[VirtualizationSoftwareSettingsArgs]): # -> None:
        ...
    ...
    def windows_server_licensing(self, value: pulumi.Input[WindowsServerLicensingSettingsArgs]): # -> None:
        ...
...
class ConnectionStateRequestBodyPropertiesArgs:
    def __init__(__self__, *, private_link_service_connection_state: Optional[pulumi.Input[PrivateLinkServiceConnectionStateArgs]] = ...) -> None:
...
class ContainerImagePropertiesArgs:
    def __init__(__self__, *, dockerfile: Optional[pulumi.Input[_builtins.str]] = ..., image_name: Optional[pulumi.Input[_builtins.str]] = ..., image_tag: Optional[pulumi.Input[_builtins.str]] = ..., registry_properties: Optional[pulumi.Input[ACRPropertiesArgs]] = ..., run_id: Optional[pulumi.Input[_builtins.str]] = ..., run_status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @dockerfile.setter
    def dockerfile(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @image_tag.setter
    def image_tag(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def registry_properties(self, value: Optional[pulumi.Input[ACRPropertiesArgs]]): # -> None:
        ...
    ...
    @run_id.setter
    def run_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @run_status.setter
    def run_status(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DirectoryPathArgs:
    def __init__(__self__, *, physical: Optional[pulumi.Input[_builtins.str]] = ..., virtual: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @physical.setter
    def physical(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @virtual.setter
    def virtual(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DiscoveredEntityLightSummaryArgs:
    def __init__(__self__, *, number_of_machines: pulumi.Input[_builtins.int], number_of_servers: pulumi.Input[_builtins.int], number_of_web_apps: pulumi.Input[_builtins.int]) -> None:
    ...
    def number_of_machines(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def number_of_servers(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def number_of_web_apps(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class DiskEncryptionSetResourceSettingsArgs:
    def __init__(__self__, *, resource_type: pulumi.Input[_builtins.str], target_resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_resource_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EntityUptimeArgs:
    def __init__(__self__, *, days_per_month: Optional[pulumi.Input[_builtins.int]] = ..., hours_per_day: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def days_per_month(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def hours_per_day(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class FacilitySettingsArgs:
    def __init__(__self__, *, facilities_cost_per_kwh: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def facilities_cost_per_kwh(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class GmsaAuthenticationPropertiesArgs:
    def __init__(__self__, *, ad_domain_controller_dns: Optional[pulumi.Input[_builtins.str]] = ..., ad_domain_fqdn: Optional[pulumi.Input[_builtins.str]] = ..., akv_properties: Optional[pulumi.Input[KeyVaultSecretStorePropertiesArgs]] = ..., domain_admin_password: Optional[pulumi.Input[_builtins.str]] = ..., domain_admin_username: Optional[pulumi.Input[_builtins.str]] = ..., domain_controller_address: Optional[pulumi.Input[_builtins.str]] = ..., gmsa_account_name: Optional[pulumi.Input[_builtins.str]] = ..., gmsa_user_password: Optional[pulumi.Input[_builtins.str]] = ..., gmsa_username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ad_domain_controller_dns(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ad_domain_fqdn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def akv_properties(self, value: Optional[pulumi.Input[KeyVaultSecretStorePropertiesArgs]]): # -> None:
        ...
    ...
    def domain_admin_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def domain_admin_username(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def domain_controller_address(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def gmsa_account_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def gmsa_user_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def gmsa_username(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GroupPropertiesArgs:
    def __init__(__self__, *, group_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @group_type.setter
    def group_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class HeterogeneousAssessmentPropertiesArgs:
    def __init__(__self__, *, assessment_arm_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def assessment_arm_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class HypervLicenseArgs:
    def __init__(__self__, *, license_cost: pulumi.Input[_builtins.float], license_type: pulumi.Input[Union[_builtins.str, HyperVLicenseType]]) -> None:
    ...
    @license_cost.setter
    def license_cost(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @license_type.setter
    def license_type(self, value: pulumi.Input[Union[_builtins.str, HyperVLicenseType]]): # -> None:
        ...
...
class HypervVirtualizationManagementSettingsArgs:
    def __init__(__self__, *, license_and_support_list: pulumi.Input[Sequence[pulumi.Input[HypervLicenseArgs]]], number_of_physical_cores_per_license: pulumi.Input[_builtins.int], software_assurance_cost: pulumi.Input[_builtins.float]) -> None:
    ...
    def license_and_support_list(self, value: pulumi.Input[Sequence[pulumi.Input[HypervLicenseArgs]]]): # -> None:
        ...
    ...
    def number_of_physical_cores_per_license(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def software_assurance_cost(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class IISAKSWorkloadDeploymentModelCustomPropertiesArgs:
    def __init__(__self__, *, instance_type: pulumi.Input[_builtins.str], iis_aks_workload_deployment_properties: Optional[pulumi.Input[IISAKSWorkloadDeploymentArgs]] = ...) -> None:
    ...
    def iis_aks_workload_deployment_properties(self, value: Optional[pulumi.Input[IISAKSWorkloadDeploymentArgs]]): # -> None:
        ...
...
class IISAKSWorkloadDeploymentArgs:
    def __init__(__self__, *, authentication_properties: Optional[pulumi.Input[GmsaAuthenticationPropertiesArgs]] = ..., automation_artifact_properties: Optional[pulumi.Input[AutomationArtifactArgs]] = ..., bindings: Optional[pulumi.Input[Sequence[pulumi.Input[BindingArgs]]]] = ..., build_container_images: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerImagePropertiesArgs]]]] = ..., cluster_properties: Optional[pulumi.Input[AKSDeploymentPropertiesArgs]] = ..., configurations: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationConfigurationArgs]]]] = ..., container_image_properties: Optional[pulumi.Input[ContainerImagePropertiesArgs]] = ..., deployment_name_prefix: Optional[pulumi.Input[_builtins.str]] = ..., deployment_spec: Optional[pulumi.Input[AKSDeploymentSpecificationArgs]] = ..., directories: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationDirectoryArgs]]]] = ..., limits: Optional[pulumi.Input[ResourceRequirementsArgs]] = ..., monitoring_properties: Optional[pulumi.Input[AppInsightMonitoringPropertiesArgs]] = ..., requests: Optional[pulumi.Input[ResourceRequirementsArgs]] = ..., target_platform_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authentication_properties(self, value: Optional[pulumi.Input[GmsaAuthenticationPropertiesArgs]]): # -> None:
        ...
...
class IISApplicationDetailsArgs:
    def __init__(__self__, *, application_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., directories: Optional[pulumi.Input[Sequence[pulumi.Input[DirectoryPathArgs]]]] = ..., enable32_bit_api_on_win64: Optional[pulumi.Input[_builtins.bool]] = ..., managed_pipeline_mode: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[DirectoryPathArgs]] = ..., runtime_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def application_pool_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @directories.setter
    def directories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DirectoryPathArgs]]]]): # -> None:
        ...
    ...
    def enable32_bit_api_on_win64(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def managed_pipeline_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IISVirtualApplicationDetailsArgs:
    def __init__(__self__, *, directories: Optional[pulumi.Input[Sequence[pulumi.Input[DirectoryPathArgs]]]] = ..., path: Optional[pulumi.Input[DirectoryPathArgs]] = ...) -> None:
...
class IISWebApplicationArgs:
    def __init__(__self__, *, application_id: Optional[pulumi.Input[_builtins.str]] = ..., application_name: Optional[pulumi.Input[_builtins.str]] = ..., application_scratch_path: Optional[pulumi.Input[_builtins.str]] = ..., applications: Optional[pulumi.Input[Sequence[pulumi.Input[IISApplicationDetailsArgs]]]] = ..., bindings: Optional[pulumi.Input[Sequence[pulumi.Input[BindingArgs]]]] = ..., configurations: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationConfigurationArgs]]]] = ..., directories: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationDirectoryArgs]]]] = ..., discovered_frameworks: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationFrameworkArgs]]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., iis_web_server: Optional[pulumi.Input[IISWebServerArgs]] = ..., limits: Optional[pulumi.Input[ResourceRequirementsArgs]] = ..., path: Optional[pulumi.Input[DirectoryPathArgs]] = ..., primary_framework: Optional[pulumi.Input[WebApplicationFrameworkArgs]] = ..., requests: Optional[pulumi.Input[ResourceRequirementsArgs]] = ..., virtual_applications: Optional[pulumi.Input[Sequence[pulumi.Input[IISVirtualApplicationDetailsArgs]]]] = ..., web_server_id: Optional[pulumi.Input[_builtins.str]] = ..., web_server_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @applications.setter
    def applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IISApplicationDetailsArgs]]]]): # -> None:
        ...
    ...
    def iis_web_server(self, value: Optional[pulumi.Input[IISWebServerArgs]]): # -> None:
        ...
    ...
    def virtual_applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IISVirtualApplicationDetailsArgs]]]]): # -> None:
        ...
...
class IISWebServerArgs:
    def __init__(__self__, *, display_name: Optional[pulumi.Input[_builtins.str]] = ..., ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., machines: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., operating_system_details: Optional[pulumi.Input[OperatingSystemDetailsArgs]] = ..., root_configuration_location: Optional[pulumi.Input[_builtins.str]] = ..., run_as_account_id: Optional[pulumi.Input[_builtins.str]] = ..., server_fqdn: Optional[pulumi.Input[_builtins.str]] = ..., server_id: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ..., web_applications: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @machines.setter
    def machines(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def operating_system_details(self, value: Optional[pulumi.Input[OperatingSystemDetailsArgs]]): # -> None:
        ...
    ...
    def root_configuration_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @server_fqdn.setter
    def server_fqdn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def web_applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class IISWorkloadInstanceModelCustomPropertiesArgs:
    def __init__(__self__, *, instance_type: pulumi.Input[_builtins.str], container_name: Optional[pulumi.Input[_builtins.str]] = ..., fileshare_name: Optional[pulumi.Input[_builtins.str]] = ..., iis_web_application: Optional[pulumi.Input[IISWebApplicationArgs]] = ..., web_app_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., web_app_site_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def fileshare_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def iis_web_application(self, value: Optional[pulumi.Input[IISWebApplicationArgs]]): # -> None:
        ...
...
class IdentityModelArgs:
    def __init__(__self__, *, aad_authority: Optional[pulumi.Input[_builtins.str]] = ..., application_id: Optional[pulumi.Input[_builtins.str]] = ..., audience: Optional[pulumi.Input[_builtins.str]] = ..., object_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class IdentityArgs:
    def __init__(__self__, *, principal_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, ResourceIdentityType]]] = ...) -> None:
...
class ImportCollectorPropertiesArgs:
    def __init__(__self__, *, discovery_site_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
...
class KeyVaultSecretStorePropertiesArgs:
    def __init__(__self__, *, keyvault_name: Optional[pulumi.Input[_builtins.str]] = ..., managed_identity_properties: Optional[pulumi.Input[ManagedIdentityPropertiesArgs]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., secret_store_id: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    def keyvault_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def managed_identity_properties(self, value: Optional[pulumi.Input[ManagedIdentityPropertiesArgs]]): # -> None:
        ...
    ...
    def secret_store_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LBFrontendIPConfigurationResourceSettingsArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_allocation_method: Optional[pulumi.Input[_builtins.str]] = ..., subnet: Optional[pulumi.Input[SubnetReferenceArgs]] = ..., zones: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def private_ip_allocation_method(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @subnet.setter
    def subnet(self, value: Optional[pulumi.Input[SubnetReferenceArgs]]): # -> None:
        ...
    ...
    @zones.setter
    def zones(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LaborSettingsArgs:
    def __init__(__self__, *, hourly_admin_cost: pulumi.Input[_builtins.float], physical_servers_per_admin: pulumi.Input[_builtins.int], virtual_machines_per_admin: pulumi.Input[_builtins.int]) -> None:
    ...
    def hourly_admin_cost(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def physical_servers_per_admin(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def virtual_machines_per_admin(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class LoadBalancerBackendAddressPoolReferenceArgs:
    def __init__(__self__, *, source_arm_resource_id: pulumi.Input[_builtins.str], name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def source_arm_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class LoadBalancerResourceSettingsArgs:
    def __init__(__self__, *, resource_type: pulumi.Input[_builtins.str], backend_address_pools: Optional[pulumi.Input[Sequence[pulumi.Input[LBBackendAddressPoolResourceSettingsArgs]]]] = ..., frontend_ip_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[LBFrontendIPConfigurationResourceSettingsArgs]]]] = ..., sku: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_resource_name: Optional[pulumi.Input[_builtins.str]] = ..., zones: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def backend_address_pools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LBBackendAddressPoolResourceSettingsArgs]]]]): # -> None:
        ...
    ...
    def frontend_ip_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LBFrontendIPConfigurationResourceSettingsArgs]]]]): # -> None:
        ...
...
class MachineAssessmentSettingsArgs:
    def __init__(__self__, *, azure_disk_types: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AzureDiskType]]]]] = ..., azure_hybrid_use_benefit: Optional[pulumi.Input[Union[_builtins.str, AzureHybridUseBenefit]]] = ..., azure_location: Optional[pulumi.Input[_builtins.str]] = ..., azure_pricing_tier: Optional[pulumi.Input[Union[_builtins.str, AzurePricingTier]]] = ..., azure_security_offering_type: Optional[pulumi.Input[Union[_builtins.str, AzureSecurityOfferingType]]] = ..., azure_storage_redundancy: Optional[pulumi.Input[Union[_builtins.str, AzureStorageRedundancy]]] = ..., azure_vm_families: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AzureVmFamily]]]]] = ..., azure_vm_security_options: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AzureVmSecurityType]]]]] = ..., billing_settings: Optional[pulumi.Input[BillingSettingsArgs]] = ..., currency: Optional[pulumi.Input[Union[_builtins.str, AzureCurrency]]] = ..., discount_percentage: Optional[pulumi.Input[_builtins.float]] = ..., environment_type: Optional[pulumi.Input[Union[_builtins.str, EnvironmentType]]] = ..., linux_azure_hybrid_use_benefit: Optional[pulumi.Input[Union[_builtins.str, AzureHybridUseBenefit]]] = ..., performance_data: Optional[pulumi.Input[PerformanceDataArgs]] = ..., savings_settings: Optional[pulumi.Input[SavingsSettingsArgs]] = ..., scaling_factor: Optional[pulumi.Input[_builtins.float]] = ..., sizing_criterion: Optional[pulumi.Input[Union[_builtins.str, AssessmentSizingCriterion]]] = ..., vm_uptime: Optional[pulumi.Input[VmUptimeArgs]] = ...) -> None:
    ...
    def azure_vm_security_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AzureVmSecurityType]]]]]): # -> None:
        ...
...
class MachineAssessmentV2PropertiesArgs:
    def __init__(__self__, *, scope: Optional[pulumi.Input[ScopeArgs]] = ..., settings: Optional[pulumi.Input[MachineAssessmentSettingsArgs]] = ...) -> None:
    ...
    @settings.setter
    def settings(self, value: Optional[pulumi.Input[MachineAssessmentSettingsArgs]]): # -> None:
        ...
...
class ManagedIdentityPropertiesArgs:
    def __init__(__self__, *, client_id: Optional[pulumi.Input[_builtins.str]] = ..., managed_identity_name: Optional[pulumi.Input[_builtins.str]] = ..., principal_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    def managed_identity_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ManagementSettingsArgs:
    def __init__(__self__, *, hyperv_virtualization_management_settings: pulumi.Input[HypervVirtualizationManagementSettingsArgs], other_management_costs_settings: pulumi.Input[OtherManagementCostsSettingsArgs], third_party_management_settings: pulumi.Input[ThirdPartyManagementSettingsArgs]) -> None:
    ...
    def hyperv_virtualization_management_settings(self, value: pulumi.Input[HypervVirtualizationManagementSettingsArgs]): # -> None:
        ...
    ...
    def other_management_costs_settings(self, value: pulumi.Input[OtherManagementCostsSettingsArgs]): # -> None:
        ...
    ...
    def third_party_management_settings(self, value: pulumi.Input[ThirdPartyManagementSettingsArgs]): # -> None:
        ...
...
class MigrateAgentModelPropertiesArgs:
    def __init__(__self__, *, authentication_identity: Optional[pulumi.Input[IdentityModelArgs]] = ..., custom_properties: Optional[pulumi.Input[VMwareMigrateAgentModelCustomPropertiesArgs]] = ..., machine_id: Optional[pulumi.Input[_builtins.str]] = ..., machine_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authentication_identity(self, value: Optional[pulumi.Input[IdentityModelArgs]]): # -> None:
        ...
    ...
    def custom_properties(self, value: Optional[pulumi.Input[VMwareMigrateAgentModelCustomPropertiesArgs]]): # -> None:
        ...
    ...
    @machine_name.setter
    def machine_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MigrateProjectPropertiesArgs:
    def __init__(__self__, *, provisioning_state: Optional[pulumi.Input[Union[_builtins.str, ProvisioningState]]] = ..., public_network_access: Optional[pulumi.Input[_builtins.str]] = ..., registered_tools: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., service_endpoint: Optional[pulumi.Input[_builtins.str]] = ..., utility_storage_account_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def registered_tools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def utility_storage_account_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MigrateProjectTagsArgs:
    def __init__(__self__, *, additional_properties: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MigrationConfigurationArgs:
    def __init__(__self__, *, key_vault_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., migration_solution_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def migration_solution_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MigrationEntityGroupPropertiesArgs:
    def __init__(__self__, *, application_display_name: pulumi.Input[_builtins.str], application_id: pulumi.Input[_builtins.str], associated_assessment_id: Optional[pulumi.Input[_builtins.str]] = ..., associated_wave_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., migration_path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def application_display_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def associated_assessment_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def associated_wave_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def migration_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MigrationEntityPropertiesArgs:
    def __init__(__self__, *, associated_inventory_resource_id: pulumi.Input[_builtins.str], inventory_display_name: pulumi.Input[_builtins.str], assessed_entity_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., associated_assessment_id: Optional[pulumi.Input[_builtins.str]] = ..., associated_migration_entity_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., associated_wave_id: Optional[pulumi.Input[_builtins.str]] = ..., migration_path: Optional[pulumi.Input[_builtins.str]] = ..., migration_specific_properties: Optional[pulumi.Input[ServerMigrationSpecificPropertiesArgs]] = ..., migration_tool: Optional[pulumi.Input[_builtins.str]] = ..., partner_resource_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., target: Optional[pulumi.Input[_builtins.str]] = ..., target_azure_resource_arm_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def associated_inventory_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def inventory_display_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def assessed_entity_arm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def associated_migration_entity_group_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def associated_wave_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def migration_specific_properties(self, value: Optional[pulumi.Input[ServerMigrationSpecificPropertiesArgs]]): # -> None:
        ...
    ...
    def migration_tool(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def partner_resource_arm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_azure_resource_arm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ModernizeProjectModelPropertiesArgs:
    def __init__(__self__, *, migration_configuration: Optional[pulumi.Input[MigrationConfigurationArgs]] = ...) -> None:
    ...
    def migration_configuration(self, value: Optional[pulumi.Input[MigrationConfigurationArgs]]): # -> None:
        ...
...
class MoveCollectionPropertiesArgs:
    def __init__(__self__, *, move_region: Optional[pulumi.Input[_builtins.str]] = ..., move_type: Optional[pulumi.Input[Union[_builtins.str, MoveType]]] = ..., source_region: Optional[pulumi.Input[_builtins.str]] = ..., target_region: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @move_region.setter
    def move_region(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @move_type.setter
    def move_type(self, value: Optional[pulumi.Input[Union[_builtins.str, MoveType]]]): # -> None:
        ...
    ...
    def target_region(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MoveResourceDependencyOverrideArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., target_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MoveResourcePropertiesArgs:
    def __init__(__self__, *, source_id: pulumi.Input[_builtins.str], depends_on_overrides: Optional[pulumi.Input[Sequence[pulumi.Input[MoveResourceDependencyOverrideArgs]]]] = ..., existing_target_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_settings: Optional[pulumi.Input[Union[AvailabilitySetResourceSettingsArgs, DiskEncryptionSetResourceSettingsArgs, KeyVaultResourceSettingsArgs, LoadBalancerResourceSettingsArgs, NetworkInterfaceResourceSettingsArgs, NetworkSecurityGroupResourceSettingsArgs, PublicIPAddressResourceSettingsArgs, ResourceGroupResourceSettingsArgs, SqlDatabaseResourceSettingsArgs, SqlElasticPoolResourceSettingsArgs, SqlServerResourceSettingsArgs, VirtualMachineResourceSettingsArgs, VirtualNetworkResourceSettingsArgs]]] = ...) -> None:
    ...
    def depends_on_overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MoveResourceDependencyOverrideArgs]]]]): # -> None:
        ...
    ...
    def existing_target_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NetworkInterfaceResourceSettingsArgs:
    def __init__(__self__, *, resource_type: pulumi.Input[_builtins.str], enable_accelerated_networking: Optional[pulumi.Input[_builtins.bool]] = ..., ip_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[NicIpConfigurationResourceSettingsArgs]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_resource_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ip_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NicIpConfigurationResourceSettingsArgs]]]]): # -> None:
        ...
...
class NetworkSecurityGroupResourceSettingsArgs:
    def __init__(__self__, *, resource_type: pulumi.Input[_builtins.str], security_rules: Optional[pulumi.Input[Sequence[pulumi.Input[NsgSecurityRuleArgs]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_resource_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def security_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NsgSecurityRuleArgs]]]]): # -> None:
        ...
...
class NetworkSettingsArgs:
    def __init__(__self__, *, hardware_software_cost_percentage: pulumi.Input[_builtins.float], maintenance_cost_percentage: pulumi.Input[_builtins.float]) -> None:
    ...
    def hardware_software_cost_percentage(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def maintenance_cost_percentage(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class NicIpConfigurationResourceSettingsArgs:
    def __init__(__self__, *, load_balancer_backend_address_pools: Optional[pulumi.Input[Sequence[pulumi.Input[LoadBalancerBackendAddressPoolReferenceArgs]]]] = ..., load_balancer_nat_rules: Optional[pulumi.Input[Sequence[pulumi.Input[LoadBalancerNatRuleReferenceArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., primary: Optional[pulumi.Input[_builtins.bool]] = ..., private_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_allocation_method: Optional[pulumi.Input[_builtins.str]] = ..., public_ip: Optional[pulumi.Input[PublicIpReferenceArgs]] = ..., subnet: Optional[pulumi.Input[SubnetReferenceArgs]] = ...) -> None:
    ...
    def load_balancer_backend_address_pools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LoadBalancerBackendAddressPoolReferenceArgs]]]]): # -> None:
        ...
    ...
    def load_balancer_nat_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LoadBalancerNatRuleReferenceArgs]]]]): # -> None:
        ...
    ...
    @public_ip.setter
    def public_ip(self, value: Optional[pulumi.Input[PublicIpReferenceArgs]]): # -> None:
        ...
...
class NsgReferenceArgs:
    def __init__(__self__, *, source_arm_resource_id: pulumi.Input[_builtins.str]) -> None:
...
class NsgSecurityRuleArgs:
    def __init__(__self__, *, access: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., destination_port_range: Optional[pulumi.Input[_builtins.str]] = ..., direction: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.int]] = ..., protocol: Optional[pulumi.Input[_builtins.str]] = ..., source_address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., source_port_range: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @access.setter
    def access(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class OnPremiseSettingsArgs:
    def __init__(__self__, *, compute_settings: pulumi.Input[ComputeSettingsArgs], facility_settings: pulumi.Input[FacilitySettingsArgs], labor_settings: pulumi.Input[LaborSettingsArgs], network_settings: pulumi.Input[NetworkSettingsArgs], security_settings: pulumi.Input[SecuritySettingsArgs], storage_settings: pulumi.Input[StorageSettingsArgs], management_settings: Optional[pulumi.Input[ManagementSettingsArgs]] = ...) -> None:
    ...
    def compute_settings(self, value: pulumi.Input[ComputeSettingsArgs]): # -> None:
        ...
    ...
    def facility_settings(self, value: pulumi.Input[FacilitySettingsArgs]): # -> None:
        ...
    ...
    def labor_settings(self, value: pulumi.Input[LaborSettingsArgs]): # -> None:
        ...
    ...
    def network_settings(self, value: pulumi.Input[NetworkSettingsArgs]): # -> None:
        ...
    ...
    def security_settings(self, value: pulumi.Input[SecuritySettingsArgs]): # -> None:
        ...
    ...
    def storage_settings(self, value: pulumi.Input[StorageSettingsArgs]): # -> None:
        ...
    ...
    @management_settings.setter
    def management_settings(self, value: Optional[pulumi.Input[ManagementSettingsArgs]]): # -> None:
        ...
...
class OperatingSystemDetailsArgs:
    def __init__(__self__, *, os: Optional[pulumi.Input[Union[_builtins.str, OperatingSystemType]]] = ..., os_architecture: Optional[pulumi.Input[_builtins.str]] = ..., os_name: Optional[pulumi.Input[_builtins.str]] = ..., os_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    @os.setter
    def os(self, value: Optional[pulumi.Input[Union[_builtins.str, OperatingSystemType]]]): # -> None:
        ...
    ...
    @os_name.setter
    def os_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class OtherManagementCostsSettingsArgs:
    def __init__(__self__, *, data_protection_cost_per_server_per_year: pulumi.Input[_builtins.float], monitoring_cost_per_server_per_year: pulumi.Input[_builtins.float], patching_cost_per_server_per_year: pulumi.Input[_builtins.float]) -> None:
    ...
    def data_protection_cost_per_server_per_year(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def monitoring_cost_per_server_per_year(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def patching_cost_per_server_per_year(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class PerfDataSettingsArgs:
    def __init__(__self__, *, percentile: pulumi.Input[Union[_builtins.str, Percentile]], time_range: pulumi.Input[Union[_builtins.str, TimeRange]], perf_data_end_time: Optional[pulumi.Input[_builtins.str]] = ..., perf_data_start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PerformanceDataArgs:
    def __init__(__self__, *, percentile: Optional[pulumi.Input[Union[_builtins.str, Percentile]]] = ..., perf_data_end_time: Optional[pulumi.Input[_builtins.str]] = ..., perf_data_start_time: Optional[pulumi.Input[_builtins.str]] = ..., time_range: Optional[pulumi.Input[Union[_builtins.str, TimeRange]]] = ...) -> None:
...
class PortMappingArgs:
    def __init__(__self__, *, external_port: Optional[pulumi.Input[_builtins.int]] = ..., internal_port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def external_port(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def internal_port(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class PrivateLinkServiceConnectionStateArgs:
    def __init__(__self__, *, actions_required: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, PrivateEndpointServiceConnectionStatus, Status]]] = ...) -> None:
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[_builtins.str, PrivateEndpointServiceConnectionStatus, Status]]]): # -> None:
        ...
...
class ProjectPropertiesArgs:
    def __init__(__self__, *, assessment_solution_id: Optional[pulumi.Input[_builtins.str]] = ..., customer_storage_account_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., customer_workspace_id: Optional[pulumi.Input[_builtins.str]] = ..., customer_workspace_location: Optional[pulumi.Input[_builtins.str]] = ..., project_status: Optional[pulumi.Input[Union[_builtins.str, ProjectStatus]]] = ..., public_network_access: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PublicIPAddressResourceSettingsArgs:
    def __init__(__self__, *, resource_type: pulumi.Input[_builtins.str], domain_name_label: Optional[pulumi.Input[_builtins.str]] = ..., fqdn: Optional[pulumi.Input[_builtins.str]] = ..., public_ip_allocation_method: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_resource_name: Optional[pulumi.Input[_builtins.str]] = ..., zones: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def public_ip_allocation_method(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResourceIdentityArgs:
    def __init__(__self__, *, principal_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, ResourceIdentityTypes]]] = ..., user_assigned_identities: Optional[pulumi.Input[Mapping[str, pulumi.Input[UserAssignedIdentityArgs]]]] = ...) -> None:
        ...
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, ResourceIdentityTypes]]]): # -> None:
        ...
    ...
    def user_assigned_identities(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[UserAssignedIdentityArgs]]]]): # -> None:
        ...
...
class SavingsSettingsArgs:
    def __init__(__self__, *, azure_offer_code: Optional[pulumi.Input[Union[_builtins.str, AzureOffer]]] = ..., savings_options: Optional[pulumi.Input[Union[_builtins.str, SavingsOptions]]] = ...) -> None:
    ...
    @azure_offer_code.setter
    def azure_offer_code(self, value: Optional[pulumi.Input[Union[_builtins.str, AzureOffer]]]): # -> None:
        ...
    ...
    @savings_options.setter
    def savings_options(self, value: Optional[pulumi.Input[Union[_builtins.str, SavingsOptions]]]): # -> None:
        ...
...
@pulumi.input_type
class ScopeArgs:
    def __init__(__self__, *, azure_resource_graph_query: Optional[pulumi.Input[_builtins.str]] = ..., scope_type: Optional[pulumi.Input[Union[_builtins.str, ScopeType]]] = ..., server_group_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def azure_resource_graph_query(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @scope_type.setter
    def scope_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ScopeType]]]): # -> None:
        ...
...
class SecretStoreDetailsArgs:
    def __init__(__self__, *, secret_store: Optional[pulumi.Input[Union[_builtins.str, SecretStoreType]]] = ..., secret_store_properties: Optional[pulumi.Input[SecretStorePropertiesArgs]] = ...) -> None:
        ...
    ...
    def secret_store_properties(self, value: Optional[pulumi.Input[SecretStorePropertiesArgs]]): # -> None:
        ...
...
class SecretStorePropertiesArgs:
    def __init__(__self__, *, secret_store_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
...
class SecuritySettingsArgs:
    def __init__(__self__, *, server_security_cost_per_server_per_year: pulumi.Input[_builtins.float], sql_server_security_cost_per_server_per_year: pulumi.Input[_builtins.float]) -> None:
    ...
    def server_security_cost_per_server_per_year(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def sql_server_security_cost_per_server_per_year(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class ServerMigrationSpecificPropertiesArgs:
    def __init__(__self__, *, instance_type: pulumi.Input[_builtins.str], current_job_id: Optional[pulumi.Input[_builtins.str]] = ..., dr_appliance_inventory_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def current_job_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def dr_appliance_inventory_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class SettingsArgs:
    def __init__(__self__, *, azure_settings: pulumi.Input[AzureSettingsArgs], azure_arc_settings: Optional[pulumi.Input[AzureArcSettingsArgs]] = ..., on_premise_settings: Optional[pulumi.Input[OnPremiseSettingsArgs]] = ...) -> None:
    ...
    def azure_settings(self, value: pulumi.Input[AzureSettingsArgs]): # -> None:
        ...
    ...
    def azure_arc_settings(self, value: Optional[pulumi.Input[AzureArcSettingsArgs]]): # -> None:
        ...
    ...
    def on_premise_settings(self, value: Optional[pulumi.Input[OnPremiseSettingsArgs]]): # -> None:
        ...
...
class SolutionDetailsArgs:
    def __init__(__self__, *, assessment_count: Optional[pulumi.Input[_builtins.int]] = ..., extended_details: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., group_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def assessment_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def extended_details(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @group_count.setter
    def group_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class SolutionPropertiesArgs:
    def __init__(__self__, *, cleanup_state: Optional[pulumi.Input[_builtins.str]] = ..., details: Optional[pulumi.Input[SolutionDetailsArgs]] = ..., goal: Optional[pulumi.Input[_builtins.str]] = ..., purpose: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., tool: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cleanup_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @details.setter
    def details(self, value: Optional[pulumi.Input[SolutionDetailsArgs]]): # -> None:
        ...
    ...
    @goal.setter
    def goal(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SqlAssessmentSettingsArgs:
    def __init__(__self__, *, async_commit_mode_intent: Optional[pulumi.Input[Union[_builtins.str, AsyncCommitModeIntent]]] = ..., azure_location: Optional[pulumi.Input[_builtins.str]] = ..., azure_security_offering_type: Optional[pulumi.Input[Union[_builtins.str, AzureSecurityOfferingType]]] = ..., azure_sql_database_settings: Optional[pulumi.Input[SqlDbSettingsV3Args]] = ..., azure_sql_managed_instance_settings: Optional[pulumi.Input[SqlMiSettingsV3Args]] = ..., azure_sql_vm_settings: Optional[pulumi.Input[SqlVmSettingsArgs]] = ..., billing_settings: Optional[pulumi.Input[BillingSettingsArgs]] = ..., currency: Optional[pulumi.Input[Union[_builtins.str, AzureCurrency]]] = ..., disaster_recovery_location: Optional[pulumi.Input[Union[_builtins.str, AzureLocation]]] = ..., discount_percentage: Optional[pulumi.Input[_builtins.float]] = ..., enable_hadr_assessment: Optional[pulumi.Input[_builtins.bool]] = ..., entity_uptime: Optional[pulumi.Input[EntityUptimeArgs]] = ..., environment_type: Optional[pulumi.Input[Union[_builtins.str, EnvironmentType]]] = ..., is_internet_access_available: Optional[pulumi.Input[_builtins.bool]] = ..., multi_subnet_intent: Optional[pulumi.Input[Union[_builtins.str, MultiSubnetIntent]]] = ..., os_license: Optional[pulumi.Input[Union[_builtins.str, OsLicense]]] = ..., performance_data: Optional[pulumi.Input[PerformanceDataArgs]] = ..., preferred_targets: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AzureTarget]]]]] = ..., savings_settings: Optional[pulumi.Input[SavingsSettingsArgs]] = ..., scaling_factor: Optional[pulumi.Input[_builtins.float]] = ..., sizing_criterion: Optional[pulumi.Input[Union[_builtins.str, AssessmentSizingCriterion]]] = ..., sql_server_license: Optional[pulumi.Input[Union[_builtins.str, SqlServerLicense]]] = ...) -> None:
    ...
    def azure_sql_database_settings(self, value: Optional[pulumi.Input[SqlDbSettingsV3Args]]): # -> None:
        ...
    ...
    def azure_sql_managed_instance_settings(self, value: Optional[pulumi.Input[SqlMiSettingsV3Args]]): # -> None:
        ...
    ...
    def preferred_targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AzureTarget]]]]]): # -> None:
        ...
...
class SqlAssessmentV3PropertiesArgs:
    def __init__(__self__, *, fallback_machine_assessment_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[ScopeArgs]] = ..., settings: Optional[pulumi.Input[SqlAssessmentSettingsArgs]] = ...) -> None:
    ...
    @settings.setter
    def settings(self, value: Optional[pulumi.Input[SqlAssessmentSettingsArgs]]): # -> None:
        ...
...
class SqlDatabaseResourceSettingsArgs:
    def __init__(__self__, *, resource_type: pulumi.Input[_builtins.str], tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_resource_name: Optional[pulumi.Input[_builtins.str]] = ..., zone_redundant: Optional[pulumi.Input[Union[_builtins.str, ZoneRedundant]]] = ...) -> None:
    ...
    def zone_redundant(self, value: Optional[pulumi.Input[Union[_builtins.str, ZoneRedundant]]]): # -> None:
        ...
...
class SqlDbSettingsV3Args:
    def __init__(__self__, *, azure_sql_compute_tier: Optional[pulumi.Input[Union[_builtins.str, ComputeTier]]] = ..., azure_sql_data_base_type: Optional[pulumi.Input[Union[_builtins.str, AzureSqlDataBaseType]]] = ..., azure_sql_purchase_model: Optional[pulumi.Input[Union[_builtins.str, AzureSqlPurchaseModel]]] = ..., azure_sql_service_tier: Optional[pulumi.Input[Union[_builtins.str, AzureSqlServiceTierV3]]] = ...) -> None:
    ...
    def azure_sql_compute_tier(self, value: Optional[pulumi.Input[Union[_builtins.str, ComputeTier]]]): # -> None:
        ...
    ...
    def azure_sql_data_base_type(self, value: Optional[pulumi.Input[Union[_builtins.str, AzureSqlDataBaseType]]]): # -> None:
        ...
    ...
    def azure_sql_purchase_model(self, value: Optional[pulumi.Input[Union[_builtins.str, AzureSqlPurchaseModel]]]): # -> None:
        ...
    ...
    def azure_sql_service_tier(self, value: Optional[pulumi.Input[Union[_builtins.str, AzureSqlServiceTierV3]]]): # -> None:
        ...
...
class SqlDbSettingsArgs:
    def __init__(__self__, *, azure_sql_compute_tier: Optional[pulumi.Input[Union[_builtins.str, ComputeTier]]] = ..., azure_sql_data_base_type: Optional[pulumi.Input[Union[_builtins.str, AzureSqlDataBaseType]]] = ..., azure_sql_purchase_model: Optional[pulumi.Input[Union[_builtins.str, AzureSqlPurchaseModel]]] = ..., azure_sql_service_tier: Optional[pulumi.Input[Union[_builtins.str, AzureSqlServiceTier]]] = ...) -> None:
    ...
    @azure_sql_service_tier.setter
    def azure_sql_service_tier(self, value: Optional[pulumi.Input[Union[_builtins.str, AzureSqlServiceTier]]]): # -> None:
        ...
...
class SqlMiSettingsV3Args:
    def __init__(__self__, *, azure_sql_instance_type: Optional[pulumi.Input[Union[_builtins.str, AzureSqlInstanceType]]] = ..., azure_sql_service_tier: Optional[pulumi.Input[Union[_builtins.str, AzureSqlServiceTierV3]]] = ...) -> None:
    ...
    def azure_sql_instance_type(self, value: Optional[pulumi.Input[Union[_builtins.str, AzureSqlInstanceType]]]): # -> None:
        ...
...
class SqlMiSettingsArgs:
    def __init__(__self__, *, azure_sql_instance_type: Optional[pulumi.Input[Union[_builtins.str, AzureSqlInstanceType]]] = ..., azure_sql_service_tier: Optional[pulumi.Input[Union[_builtins.str, AzureSqlServiceTier]]] = ...) -> None:
...
class SqlServerLicensingSettingsArgs:
    def __init__(__self__, *, license_cost: pulumi.Input[_builtins.float], software_assurance_cost: pulumi.Input[_builtins.float], version: pulumi.Input[Union[_builtins.str, SqlServerLicenseType]]) -> None:
    ...
    @version.setter
    def version(self, value: pulumi.Input[Union[_builtins.str, SqlServerLicenseType]]): # -> None:
        ...
...
class SqlVmSettingsArgs:
    def __init__(__self__, *, instance_series: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AzureVmFamily]]]]] = ...) -> None:
    ...
    def instance_series(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, AzureVmFamily]]]]]): # -> None:
        ...
...
class StorageSettingsArgs:
    def __init__(__self__, *, cost_per_gb_per_month: pulumi.Input[_builtins.float], maintainance_cost_percentage_to_acquisition_cost: pulumi.Input[_builtins.float]) -> None:
    ...
    def cost_per_gb_per_month(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def maintainance_cost_percentage_to_acquisition_cost(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class SubnetResourceSettingsArgs:
    def __init__(__self__, *, address_prefix: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., network_security_group: Optional[pulumi.Input[NsgReferenceArgs]] = ...) -> None:
    ...
    def network_security_group(self, value: Optional[pulumi.Input[NsgReferenceArgs]]): # -> None:
        ...
...
class TargetAssessmentArmIdsArgs:
    def __init__(__self__, *, aks: Optional[pulumi.Input[_builtins.str]] = ..., azure_app_service: Optional[pulumi.Input[_builtins.str]] = ..., azure_app_service_container: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @aks.setter
    def aks(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def azure_app_service(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def azure_app_service_container(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TargetStorageProfileArgs:
    def __init__(__self__, *, azure_file_share_profile: Optional[pulumi.Input[AzureFileShareHydrationProfileArgs]] = ..., hydration_storage_provider_type: Optional[pulumi.Input[Union[_builtins.str, TargetHydrationStorageProviderType]]] = ..., persistent_volume_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_access_type: Optional[pulumi.Input[Union[_builtins.str, TargetStorageAccessType]]] = ..., storage_projection_type: Optional[pulumi.Input[Union[_builtins.str, TargetStorageProjectionType]]] = ..., target_name: Optional[pulumi.Input[_builtins.str]] = ..., target_size: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def hydration_storage_provider_type(self, value: Optional[pulumi.Input[Union[_builtins.str, TargetHydrationStorageProviderType]]]): # -> None:
        ...
    ...
    def persistent_volume_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def storage_access_type(self, value: Optional[pulumi.Input[Union[_builtins.str, TargetStorageAccessType]]]): # -> None:
        ...
    ...
    def storage_projection_type(self, value: Optional[pulumi.Input[Union[_builtins.str, TargetStorageProjectionType]]]): # -> None:
        ...
    ...
    @target_size.setter
    def target_size(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TaskPropertiesArgs:
    def __init__(__self__, *, display_name: pulumi.Input[_builtins.str], scope: pulumi.Input[Union[_builtins.str, TaskScope]], scope_id: pulumi.Input[_builtins.str], status: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., stage: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @scope.setter
    def scope(self, value: pulumi.Input[Union[_builtins.str, TaskScope]]): # -> None:
        ...
...
class ThirdPartyManagementSettingsArgs:
    def __init__(__self__, *, license_cost: pulumi.Input[_builtins.float], support_cost: pulumi.Input[_builtins.float]) -> None:
    ...
    @support_cost.setter
    def support_cost(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class VMwareMigrateAgentModelCustomPropertiesArgs:
    def __init__(__self__, *, instance_type: pulumi.Input[_builtins.str], fabric_friendly_name: Optional[pulumi.Input[_builtins.str]] = ..., vmware_site_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def fabric_friendly_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VirtualMachineResourceSettingsArgs:
    def __init__(__self__, *, resource_type: pulumi.Input[_builtins.str], tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_availability_set_id: Optional[pulumi.Input[_builtins.str]] = ..., target_availability_zone: Optional[pulumi.Input[Union[_builtins.str, TargetAvailabilityZone]]] = ..., target_resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_resource_name: Optional[pulumi.Input[_builtins.str]] = ..., target_vm_size: Optional[pulumi.Input[_builtins.str]] = ..., user_managed_identities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def target_availability_zone(self, value: Optional[pulumi.Input[Union[_builtins.str, TargetAvailabilityZone]]]): # -> None:
        ...
    ...
    def user_managed_identities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class VirtualNetworkResourceSettingsArgs:
    def __init__(__self__, *, resource_type: pulumi.Input[_builtins.str], address_space: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., enable_ddos_protection: Optional[pulumi.Input[_builtins.bool]] = ..., subnets: Optional[pulumi.Input[Sequence[pulumi.Input[SubnetResourceSettingsArgs]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., target_resource_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def address_space(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @subnets.setter
    def subnets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SubnetResourceSettingsArgs]]]]): # -> None:
        ...
...
class VirtualizationSoftwareSettingsArgs:
    def __init__(__self__, *, v_mware_cloud_foundation_license_cost: pulumi.Input[_builtins.float]) -> None:
    ...
    def v_mware_cloud_foundation_license_cost(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
@pulumi.input_type
class VmUptimeArgs:
    def __init__(__self__, *, days_per_month: Optional[pulumi.Input[_builtins.float]] = ..., hours_per_day: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @days_per_month.setter
    def days_per_month(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @hours_per_day.setter
    def hours_per_day(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class WavePropertiesArgs:
    def __init__(__self__, *, arg: pulumi.Input[ArgArgs], display_name: pulumi.Input[_builtins.str], planned_start_date: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., planned_completion_date: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @arg.setter
    def arg(self, value: pulumi.Input[ArgArgs]): # -> None:
        ...
    ...
    def planned_start_date(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def planned_completion_date(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WebAppAssessmentSettingsArgs:
    def __init__(__self__, *, app_svc_container_settings: pulumi.Input[AppSvcContainerSettingsArgs], app_svc_native_settings: pulumi.Input[AppSvcNativeSettingsArgs], azure_security_offering_type: pulumi.Input[Union[_builtins.str, AzureSecurityOfferingType]], azure_location: Optional[pulumi.Input[_builtins.str]] = ..., billing_settings: Optional[pulumi.Input[BillingSettingsArgs]] = ..., currency: Optional[pulumi.Input[Union[_builtins.str, AzureCurrency]]] = ..., discount_percentage: Optional[pulumi.Input[_builtins.float]] = ..., environment_type: Optional[pulumi.Input[Union[_builtins.str, EnvironmentType]]] = ..., performance_data: Optional[pulumi.Input[PerformanceDataArgs]] = ..., savings_settings: Optional[pulumi.Input[SavingsSettingsArgs]] = ..., scaling_factor: Optional[pulumi.Input[_builtins.float]] = ..., sizing_criterion: Optional[pulumi.Input[Union[_builtins.str, AssessmentSizingCriterion]]] = ...) -> None:
    ...
    def app_svc_container_settings(self, value: pulumi.Input[AppSvcContainerSettingsArgs]): # -> None:
        ...
    ...
    def app_svc_native_settings(self, value: pulumi.Input[AppSvcNativeSettingsArgs]): # -> None:
        ...
    ...
    @azure_security_offering_type.setter
    def azure_security_offering_type(self, value: pulumi.Input[Union[_builtins.str, AzureSecurityOfferingType]]): # -> None:
        ...
...
class WebAppAssessmentV3PropertiesArgs:
    def __init__(__self__, *, fallback_machine_assessment_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[ScopeArgs]] = ..., settings: Optional[pulumi.Input[WebAppAssessmentSettingsArgs]] = ...) -> None:
    ...
    @settings.setter
    def settings(self, value: Optional[pulumi.Input[WebAppAssessmentSettingsArgs]]): # -> None:
        ...
...
class WebApplicationConfigurationArgs:
    def __init__(__self__, *, file_path: Optional[pulumi.Input[_builtins.str]] = ..., identifier: Optional[pulumi.Input[_builtins.str]] = ..., is_deployment_time_editable: Optional[pulumi.Input[_builtins.bool]] = ..., local_file_path: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., secret_store_details: Optional[pulumi.Input[SecretStoreDetailsArgs]] = ..., section: Optional[pulumi.Input[_builtins.str]] = ..., target_file_path: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, ConfigurationType]]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def is_deployment_time_editable(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def local_file_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @section.setter
    def section(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_file_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, ConfigurationType]]]): # -> None:
        ...
...
class WebApplicationDirectoryArgs:
    def __init__(__self__, *, is_editable: Optional[pulumi.Input[_builtins.bool]] = ..., source_paths: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., source_size: Optional[pulumi.Input[_builtins.str]] = ..., storage_profile: Optional[pulumi.Input[TargetStorageProfileArgs]] = ...) -> None:
    ...
    @is_editable.setter
    def is_editable(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @source_paths.setter
    def source_paths(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @source_size.setter
    def source_size(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def storage_profile(self, value: Optional[pulumi.Input[TargetStorageProfileArgs]]): # -> None:
        ...
...
class WebApplicationFrameworkArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WindowsServerLicensingSettingsArgs:
    def __init__(__self__, *, license_cost: pulumi.Input[_builtins.float], licenses_per_core: pulumi.Input[_builtins.int], software_assurance_cost: pulumi.Input[_builtins.float]) -> None:
    ...
    def licenses_per_core(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class WorkloadDeploymentModelPropertiesArgs:
    def __init__(__self__, *, custom_properties: Optional[pulumi.Input[Union[ApacheTomcatAKSWorkloadDeploymentModelCustomPropertiesArgs, IISAKSWorkloadDeploymentModelCustomPropertiesArgs]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., target_platform: Optional[pulumi.Input[Union[_builtins.str, WorkloadDeploymentTarget]]] = ..., workload_instance_properties: Optional[pulumi.Input[WorkloadInstanceModelPropertiesArgs]] = ...) -> None:
    ...
    @custom_properties.setter
    def custom_properties(self, value: Optional[pulumi.Input[Union[ApacheTomcatAKSWorkloadDeploymentModelCustomPropertiesArgs, IISAKSWorkloadDeploymentModelCustomPropertiesArgs]]]): # -> None:
        ...
    ...
    def target_platform(self, value: Optional[pulumi.Input[Union[_builtins.str, WorkloadDeploymentTarget]]]): # -> None:
        ...
    ...
    def workload_instance_properties(self, value: Optional[pulumi.Input[WorkloadInstanceModelPropertiesArgs]]): # -> None:
        ...
...
class WorkloadInstanceModelPropertiesArgs:
    def __init__(__self__, *, custom_properties: Optional[pulumi.Input[Union[ApacheTomcatWorkloadInstanceModelCustomPropertiesArgs, IISWorkloadInstanceModelCustomPropertiesArgs]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., master_site_name: Optional[pulumi.Input[_builtins.str]] = ..., migrate_agent_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., source_name: Optional[pulumi.Input[_builtins.str]] = ..., source_platform: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @custom_properties.setter
    def custom_properties(self, value: Optional[pulumi.Input[Union[ApacheTomcatWorkloadInstanceModelCustomPropertiesArgs, IISWorkloadInstanceModelCustomPropertiesArgs]]]): # -> None:
        ...
    ...
    def master_site_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def migrate_agent_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def source_platform(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
