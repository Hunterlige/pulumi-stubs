...
class MigrationEntityArgs:
    def __init__(
        ...
        *,
        ...
        migration_entity_name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[pulumi.Input[MigrationEntityPropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[MigrationEntityPropertiesArgs]]
    ): ...
...
class MigrationEntity(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[MigrationEntityPropertiesArgs, MigrationEntityPropertiesArgsDict]
            ]
        ] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.MigrationEntityPropertiesResponse]: ...
    @_builtins.property
