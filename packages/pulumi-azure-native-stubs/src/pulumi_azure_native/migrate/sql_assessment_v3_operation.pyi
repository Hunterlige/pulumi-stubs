...
class SqlAssessmentV3OperationArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[SqlAssessmentV3PropertiesArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[SqlAssessmentV3PropertiesArgs]]
    ): ...
...
class SqlAssessmentV3Operation(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[SqlAssessmentV3PropertiesArgs, SqlAssessmentV3PropertiesArgsDict]
            ]
        ] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.SqlAssessmentV3PropertiesResponse]: ...
    @_builtins.property
