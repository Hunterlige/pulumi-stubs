...
class AksAssessmentOperationArgs:
    def __init__(
        ...
        *,
        ...
        scope: Optional[pulumi.Input[AssessmentScopeParametersArgs]] = ...,
    ) -> None: ...
    @_builtins.property
...
class AksAssessmentOperation(pulumi.CustomResource):
    ...
    def __init__(
        ...
        scope: Optional[
            pulumi.Input[
                Union[AssessmentScopeParametersArgs, AssessmentScopeParametersArgsDict]
            ]
        ] = ...,
        settings: Optional[
            pulumi.Input[
                Union[AKSAssessmentSettingsArgs, AKSAssessmentSettingsArgsDict]
            ]
        ] = ...,
        __props__=...,
    ) -> None: ...
    ...
    def scope(
        self,
    ) -> pulumi.Output[Optional[outputs.AssessmentScopeParametersResponse]]: ...
    @_builtins.property
    @pulumi.getter
