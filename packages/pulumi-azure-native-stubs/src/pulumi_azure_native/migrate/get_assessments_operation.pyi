...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetAssessmentsOperationResult', 'AwaitableGetAssessmentsOperationResult', 'get_assessments_operation', 'get_assessments_operation_output']
@pulumi.output_type
class GetAssessmentsOperationResult:
    
    def __init__(__self__, assessment_error_summary=..., assessment_type=..., azure_api_version=..., azure_disk_types=..., azure_hybrid_use_benefit=..., azure_location=..., azure_offer_code=..., azure_pricing_tier=..., azure_storage_redundancy=..., azure_vm_families=..., confidence_rating_in_percentage=..., cost_components=..., created_timestamp=..., currency=..., discount_percentage=..., distribution_by_os_name=..., distribution_by_service_pack_insight=..., distribution_by_support_status=..., ea_subscription_id=..., group_type=..., id=..., linux_azure_hybrid_use_benefit=..., monthly_bandwidth_cost=..., monthly_compute_cost=..., monthly_premium_storage_cost=..., monthly_standard_ssd_storage_cost=..., monthly_storage_cost=..., monthly_ultra_storage_cost=..., name=..., number_of_machines=..., percentile=..., perf_data_end_time=..., perf_data_start_time=..., prices_timestamp=..., provisioning_state=..., reserved_instance=..., scaling_factor=..., schema_version=..., sizing_criterion=..., stage=..., status=..., suitability_summary=..., system_data=..., time_range=..., type=..., updated_timestamp=..., vm_uptime=...) -> None:
        ...
...
class AwaitableGetAssessmentsOperationResult(GetAssessmentsOperationResult):
    def __await__(self): # -> Generator[Never, Any, GetAssessmentsOperationResult]:
        ...
    


def get_assessments_operation(assessment_name: Optional[_builtins.str] = ..., group_name: Optional[_builtins.str] = ..., project_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAssessmentsOperationResult:
    
    ...

def get_assessments_operation_output(assessment_name: Optional[pulumi.Input[_builtins.str]] = ..., group_name: Optional[pulumi.Input[_builtins.str]] = ..., project_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAssessmentsOperationResult]:
