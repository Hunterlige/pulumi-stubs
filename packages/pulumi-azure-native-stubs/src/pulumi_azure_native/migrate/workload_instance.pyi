...
class WorkloadInstanceArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[WorkloadInstanceModelPropertiesArgs]] = ...,
...
class WorkloadInstance(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.WorkloadInstanceModelPropertiesResponse]: ...
    @_builtins.property
    @pulumi.getter(name="systemData")
    def system_data(
        self,
    ) -> pulumi.Output[outputs.WorkloadInstanceModelResponseSystemData]: ...
    @_builtins.property
    @pulumi.getter
