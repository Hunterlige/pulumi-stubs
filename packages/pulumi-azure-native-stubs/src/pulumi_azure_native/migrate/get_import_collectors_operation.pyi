...
def get_import_collectors_operation(
    import_collector_name: Optional[_builtins.str] = ...,
    project_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetImportCollectorsOperationResult: ...
def get_import_collectors_operation_output(
...
) -> pulumi.Output[GetImportCollectorsOperationResult]: ...
