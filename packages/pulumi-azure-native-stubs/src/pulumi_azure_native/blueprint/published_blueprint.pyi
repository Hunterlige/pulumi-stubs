...
class PublishedBlueprintArgs:
    def __init__(__self__, *, blueprint_name: pulumi.Input[_builtins.str], resource_scope: pulumi.Input[_builtins.str], change_notes: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[ParameterDefinitionArgs]]]] = ..., resource_groups: Optional[pulumi.Input[Mapping[str, pulumi.Input[ResourceGroupDefinitionArgs]]]] = ..., target_scope: Optional[pulumi.Input[Union[_builtins.str, BlueprintTargetScope]]] = ..., version_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @change_notes.setter
    def change_notes(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_scope(self) -> Optional[pulumi.Input[Union[_builtins.str, BlueprintTargetScope]]]:
        
        ...
    
    @target_scope.setter
    def target_scope(self, value: Optional[pulumi.Input[Union[_builtins.str, BlueprintTargetScope]]]): # -> None:
        ...
...
class PublishedBlueprint(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., blueprint_name: Optional[pulumi.Input[_builtins.str]] = ..., change_notes: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[ParameterDefinitionArgs, ParameterDefinitionArgsDict]]]]] = ..., resource_groups: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[ResourceGroupDefinitionArgs, ResourceGroupDefinitionArgsDict]]]]] = ..., resource_scope: Optional[pulumi.Input[_builtins.str]] = ..., target_scope: Optional[pulumi.Input[Union[_builtins.str, BlueprintTargetScope]]] = ..., version_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: PublishedBlueprintArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> PublishedBlueprint:
