...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AssignmentLockSettingsArgs', 'AssignmentLockSettingsArgsDict', 'KeyVaultReferenceArgs', 'KeyVaultReferenceArgsDict', 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'ParameterDefinitionArgs', 'ParameterDefinitionArgsDict', 'ParameterValueArgs', 'ParameterValueArgsDict', 'ResourceGroupDefinitionArgs', 'ResourceGroupDefinitionArgsDict', 'ResourceGroupValueArgs', 'ResourceGroupValueArgsDict', 'SecretValueReferenceArgs', 'SecretValueReferenceArgsDict', 'UserAssignedIdentityArgs', 'UserAssignedIdentityArgsDict']
...
class AssignmentLockSettingsArgs:
    def __init__(__self__, *, excluded_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., excluded_principals: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., mode: Optional[pulumi.Input[Union[_builtins.str, AssignmentLockMode]]] = ...) -> None:
    ...
    @mode.setter
    def mode(self, value: Optional[pulumi.Input[Union[_builtins.str, AssignmentLockMode]]]): # -> None:
        ...
...
class ManagedServiceIdentityArgs:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, ManagedServiceIdentityType]], principal_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., user_assigned_identities: Optional[pulumi.Input[Mapping[str, pulumi.Input[UserAssignedIdentityArgs]]]] = ...) -> None:
...
class ParameterDefinitionArgs:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, TemplateParameterType]], allowed_values: Optional[pulumi.Input[Sequence[Any]]] = ..., default_value: Optional[Any] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., strong_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, TemplateParameterType]]): # -> None:
        ...
...
class ParameterValueArgs:
    def __init__(__self__, *, reference: Optional[pulumi.Input[SecretValueReferenceArgs]] = ..., value: Optional[Any] = ...) -> None:
    ...
    @reference.setter
    def reference(self, value: Optional[pulumi.Input[SecretValueReferenceArgs]]): # -> None:
        ...
...
class ResourceGroupDefinitionArgs:
    def __init__(__self__, *, depends_on: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., strong_type: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
