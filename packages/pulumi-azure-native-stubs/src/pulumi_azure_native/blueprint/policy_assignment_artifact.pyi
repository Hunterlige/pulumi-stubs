...
class PolicyAssignmentArtifactArgs:
    def __init__(__self__, *, blueprint_name: pulumi.Input[_builtins.str], kind: pulumi.Input[_builtins.str], parameters: pulumi.Input[Mapping[str, pulumi.Input[ParameterValueArgs]]], policy_definition_id: pulumi.Input[_builtins.str], resource_scope: pulumi.Input[_builtins.str], artifact_name: Optional[pulumi.Input[_builtins.str]] = ..., depends_on: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PolicyAssignmentArtifact(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., artifact_name: Optional[pulumi.Input[_builtins.str]] = ..., blueprint_name: Optional[pulumi.Input[_builtins.str]] = ..., depends_on: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[ParameterValueArgs, ParameterValueArgsDict]]]]] = ..., policy_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., resource_scope: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: PolicyAssignmentArtifactArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> PolicyAssignmentArtifact:
