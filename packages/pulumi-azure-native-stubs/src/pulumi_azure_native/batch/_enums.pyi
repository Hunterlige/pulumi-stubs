...
__all__ = ['AuthenticationMode', 'AutoStorageAuthenticationMode', 'AutoUserScope', 'CachingType', 'CertificateStoreLocation', 'CertificateVisibility', 'ComputeNodeDeallocationOption', 'ComputeNodeFillType', 'ContainerHostDataPath', 'ContainerType', 'ContainerWorkingDirectory', 'DiffDiskPlacement', 'DiskEncryptionTarget', 'DynamicVNetAssignmentScope', 'ElevationLevel', 'EndpointAccessDefaultAction', 'IPAddressProvisioningType', 'IPRuleAction', 'InboundEndpointProtocol', 'InterNodeCommunicationState', 'KeySource', 'LoginMode', 'NetworkSecurityGroupRuleAccess', 'NodeCommunicationMode', 'NodePlacementPolicyType', 'PoolAllocationMode', 'PoolIdentityType', 'PublicNetworkAccessType', 'ResourceIdentityType', 'SecurityEncryptionTypes', 'SecurityTypes', 'StorageAccountType', 'UpgradeMode']
