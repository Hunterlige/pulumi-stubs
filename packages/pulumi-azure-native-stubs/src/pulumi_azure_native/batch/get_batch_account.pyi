...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetBatchAccountResult', 'AwaitableGetBatchAccountResult', 'get_batch_account', 'get_batch_account_output']
@pulumi.output_type
class GetBatchAccountResult:
    
    def __init__(__self__, account_endpoint=..., active_job_and_job_schedule_quota=..., allowed_authentication_modes=..., auto_storage=..., azure_api_version=..., dedicated_core_quota=..., dedicated_core_quota_per_vm_family=..., dedicated_core_quota_per_vm_family_enforced=..., encryption=..., id=..., identity=..., key_vault_reference=..., location=..., low_priority_core_quota=..., name=..., network_profile=..., node_management_endpoint=..., pool_allocation_mode=..., pool_quota=..., private_endpoint_connections=..., provisioning_state=..., public_network_access=..., system_data=..., tags=..., type=...) -> None:
        ...
...
class AwaitableGetBatchAccountResult(GetBatchAccountResult):
    def __await__(self): # -> Generator[Never, Any, GetBatchAccountResult]:
        ...
    


def get_batch_account(account_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetBatchAccountResult:
    
    ...

def get_batch_account_output(account_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetBatchAccountResult]:
