...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationPackageReferenceArgs', 'ApplicationPackageReferenceArgsDict', 'AutoScaleSettingsArgs', 'AutoScaleSettingsArgsDict', 'AutoStorageBasePropertiesArgs', 'AutoStorageBasePropertiesArgsDict', 'AutoUserSpecificationArgs', 'AutoUserSpecificationArgsDict', 'AutomaticOSUpgradePolicyArgs', 'AutomaticOSUpgradePolicyArgsDict', 'AzureBlobFileSystemConfigurationArgs', 'AzureBlobFileSystemConfigurationArgsDict', 'AzureFileShareConfigurationArgs', 'AzureFileShareConfigurationArgsDict', 'BatchAccountIdentityArgs', 'BatchAccountIdentityArgsDict', 'BatchPoolIdentityArgs', 'BatchPoolIdentityArgsDict', 'CIFSMountConfigurationArgs', 'CIFSMountConfigurationArgsDict', 'CertificateReferenceArgs', 'CertificateReferenceArgsDict', 'ComputeNodeIdentityReferenceArgs', 'ComputeNodeIdentityReferenceArgsDict', 'ContainerConfigurationArgs', 'ContainerConfigurationArgsDict', 'ContainerHostBatchBindMountEntryArgs', 'ContainerHostBatchBindMountEntryArgsDict', 'ContainerRegistryArgs', 'ContainerRegistryArgsDict', 'DataDiskArgs', 'DataDiskArgsDict', 'DeploymentConfigurationArgs', 'DeploymentConfigurationArgsDict', 'DiffDiskSettingsArgs', 'DiffDiskSettingsArgsDict', 'DiskEncryptionConfigurationArgs', 'DiskEncryptionConfigurationArgsDict', 'EncryptionPropertiesArgs', 'EncryptionPropertiesArgsDict', 'EndpointAccessProfileArgs', 'EndpointAccessProfileArgsDict', 'EnvironmentSettingArgs', 'EnvironmentSettingArgsDict', 'FixedScaleSettingsArgs', 'FixedScaleSettingsArgsDict', 'IPRuleArgs', 'IPRuleArgsDict', 'ImageReferenceArgs', 'ImageReferenceArgsDict', 'InboundNatPoolArgs', 'InboundNatPoolArgsDict', 'KeyVaultPropertiesArgs', 'KeyVaultPropertiesArgsDict', 'KeyVaultReferenceArgs', 'KeyVaultReferenceArgsDict', 'LinuxUserConfigurationArgs', 'LinuxUserConfigurationArgsDict', 'ManagedDiskArgs', 'ManagedDiskArgsDict', 'MetadataItemArgs', 'MetadataItemArgsDict', 'MountConfigurationArgs', 'MountConfigurationArgsDict', 'NFSMountConfigurationArgs', 'NFSMountConfigurationArgsDict', 'NetworkConfigurationArgs', 'NetworkConfigurationArgsDict', 'NetworkProfileArgs', 'NetworkProfileArgsDict', 'NetworkSecurityGroupRuleArgs', 'NetworkSecurityGroupRuleArgsDict', 'NodePlacementConfigurationArgs', 'NodePlacementConfigurationArgsDict', 'OSDiskArgs', 'OSDiskArgsDict', 'PoolEndpointConfigurationArgs', 'PoolEndpointConfigurationArgsDict', 'PublicIPAddressConfigurationArgs', 'PublicIPAddressConfigurationArgsDict', 'ResourceFileArgs', 'ResourceFileArgsDict', 'RollingUpgradePolicyArgs', 'RollingUpgradePolicyArgsDict', 'ScaleSettingsArgs', 'ScaleSettingsArgsDict', 'SecurityProfileArgs', 'SecurityProfileArgsDict', 'ServiceArtifactReferenceArgs', 'ServiceArtifactReferenceArgsDict', 'StartTaskArgs', 'StartTaskArgsDict', 'TaskContainerSettingsArgs', 'TaskContainerSettingsArgsDict', 'TaskSchedulingPolicyArgs', 'TaskSchedulingPolicyArgsDict', 'UefiSettingsArgs', 'UefiSettingsArgsDict', 'UpgradePolicyArgs', 'UpgradePolicyArgsDict', 'UserAccountArgs', 'UserAccountArgsDict', 'UserIdentityArgs', 'UserIdentityArgsDict', 'VMDiskSecurityProfileArgs', 'VMDiskSecurityProfileArgsDict', 'VMExtensionArgs', 'VMExtensionArgsDict', 'VirtualMachineConfigurationArgs', 'VirtualMachineConfigurationArgsDict', 'WindowsConfigurationArgs', 'WindowsConfigurationArgsDict', 'WindowsUserConfigurationArgs', 'WindowsUserConfigurationArgsDict']
...
class AutoScaleSettingsArgs:
    def __init__(__self__, *, formula: pulumi.Input[_builtins.str], evaluation_interval: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AutoStorageBasePropertiesArgs:
    def __init__(__self__, *, storage_account_id: pulumi.Input[_builtins.str], authentication_mode: Optional[pulumi.Input[AutoStorageAuthenticationMode]] = ..., node_identity_reference: Optional[pulumi.Input[ComputeNodeIdentityReferenceArgs]] = ...) -> None:
    ...
    def authentication_mode(self, value: Optional[pulumi.Input[AutoStorageAuthenticationMode]]): # -> None:
        ...
    ...
    def node_identity_reference(self, value: Optional[pulumi.Input[ComputeNodeIdentityReferenceArgs]]): # -> None:
        ...
...
class AutoUserSpecificationArgs:
    def __init__(__self__, *, elevation_level: Optional[pulumi.Input[ElevationLevel]] = ..., scope: Optional[pulumi.Input[AutoUserScope]] = ...) -> None:
    ...
    def elevation_level(self, value: Optional[pulumi.Input[ElevationLevel]]): # -> None:
        ...
    ...
    @scope.setter
    def scope(self, value: Optional[pulumi.Input[AutoUserScope]]): # -> None:
        ...
...
class AzureBlobFileSystemConfigurationArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], container_name: pulumi.Input[_builtins.str], relative_mount_path: pulumi.Input[_builtins.str], account_key: Optional[pulumi.Input[_builtins.str]] = ..., blobfuse_options: Optional[pulumi.Input[_builtins.str]] = ..., identity_reference: Optional[pulumi.Input[ComputeNodeIdentityReferenceArgs]] = ..., sas_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def relative_mount_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def blobfuse_options(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def identity_reference(self, value: Optional[pulumi.Input[ComputeNodeIdentityReferenceArgs]]): # -> None:
        ...
...
class AzureFileShareConfigurationArgs:
    def __init__(__self__, *, account_key: pulumi.Input[_builtins.str], account_name: pulumi.Input[_builtins.str], azure_file_url: pulumi.Input[_builtins.str], relative_mount_path: pulumi.Input[_builtins.str], mount_options: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def azure_file_url(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BatchAccountIdentityArgs:
    def __init__(__self__, *, type: pulumi.Input[ResourceIdentityType], user_assigned_identities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class BatchPoolIdentityArgs:
    def __init__(__self__, *, type: pulumi.Input[PoolIdentityType], user_assigned_identities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[PoolIdentityType]): # -> None:
        ...
...
class CIFSMountConfigurationArgs:
    def __init__(__self__, *, password: pulumi.Input[_builtins.str], relative_mount_path: pulumi.Input[_builtins.str], source: pulumi.Input[_builtins.str], user_name: pulumi.Input[_builtins.str], mount_options: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CertificateReferenceArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], store_location: Optional[pulumi.Input[CertificateStoreLocation]] = ..., store_name: Optional[pulumi.Input[_builtins.str]] = ..., visibility: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateVisibility]]]] = ...) -> None:
    ...
    def store_location(self, value: Optional[pulumi.Input[CertificateStoreLocation]]): # -> None:
        ...
    ...
    @store_name.setter
    def store_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @visibility.setter
    def visibility(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateVisibility]]]]): # -> None:
        ...
...
class ContainerConfigurationArgs:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, ContainerType]], container_image_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., container_registries: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerRegistryArgs]]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ContainerType]]): # -> None:
        ...
    ...
    def container_image_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def container_registries(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerRegistryArgs]]]]): # -> None:
        ...
...
class ContainerHostBatchBindMountEntryArgs:
    def __init__(__self__, *, is_read_only: Optional[pulumi.Input[_builtins.bool]] = ..., source: Optional[pulumi.Input[Union[_builtins.str, ContainerHostDataPath]]] = ...) -> None:
    ...
    @source.setter
    def source(self, value: Optional[pulumi.Input[Union[_builtins.str, ContainerHostDataPath]]]): # -> None:
        ...
...
class ContainerRegistryArgs:
    def __init__(__self__, *, identity_reference: Optional[pulumi.Input[ComputeNodeIdentityReferenceArgs]] = ..., password: Optional[pulumi.Input[_builtins.str]] = ..., registry_server: Optional[pulumi.Input[_builtins.str]] = ..., user_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def registry_server(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class DataDiskArgs:
    def __init__(__self__, *, disk_size_gb: pulumi.Input[_builtins.int], lun: pulumi.Input[_builtins.int], caching: Optional[pulumi.Input[CachingType]] = ..., storage_account_type: Optional[pulumi.Input[StorageAccountType]] = ...) -> None:
    ...
    @caching.setter
    def caching(self, value: Optional[pulumi.Input[CachingType]]): # -> None:
        ...
    ...
    def storage_account_type(self, value: Optional[pulumi.Input[StorageAccountType]]): # -> None:
        ...
...
class DeploymentConfigurationArgs:
    def __init__(__self__, *, virtual_machine_configuration: Optional[pulumi.Input[VirtualMachineConfigurationArgs]] = ...) -> None:
    ...
    def virtual_machine_configuration(self, value: Optional[pulumi.Input[VirtualMachineConfigurationArgs]]): # -> None:
        ...
...
class DiffDiskSettingsArgs:
    def __init__(__self__, *, placement: Optional[pulumi.Input[DiffDiskPlacement]] = ...) -> None:
    ...
    @placement.setter
    def placement(self, value: Optional[pulumi.Input[DiffDiskPlacement]]): # -> None:
        ...
...
class DiskEncryptionConfigurationArgs:
    def __init__(__self__, *, targets: Optional[pulumi.Input[Sequence[pulumi.Input[DiskEncryptionTarget]]]] = ...) -> None:
    ...
    @targets.setter
    def targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DiskEncryptionTarget]]]]): # -> None:
        ...
...
class EncryptionPropertiesArgs:
    def __init__(__self__, *, key_source: Optional[pulumi.Input[KeySource]] = ..., key_vault_properties: Optional[pulumi.Input[KeyVaultPropertiesArgs]] = ...) -> None:
    ...
    @key_source.setter
    def key_source(self, value: Optional[pulumi.Input[KeySource]]): # -> None:
        ...
...
class EndpointAccessProfileArgs:
    def __init__(__self__, *, default_action: pulumi.Input[EndpointAccessDefaultAction], ip_rules: Optional[pulumi.Input[Sequence[pulumi.Input[IPRuleArgs]]]] = ...) -> None:
    ...
    def default_action(self, value: pulumi.Input[EndpointAccessDefaultAction]): # -> None:
        ...
...
class FixedScaleSettingsArgs:
    def __init__(__self__, *, node_deallocation_option: Optional[pulumi.Input[ComputeNodeDeallocationOption]] = ..., resize_timeout: Optional[pulumi.Input[_builtins.str]] = ..., target_dedicated_nodes: Optional[pulumi.Input[_builtins.int]] = ..., target_low_priority_nodes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def node_deallocation_option(self, value: Optional[pulumi.Input[ComputeNodeDeallocationOption]]): # -> None:
        ...
    ...
    def resize_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_dedicated_nodes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def target_low_priority_nodes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
@pulumi.input_type
class IPRuleArgs:
    def __init__(__self__, *, action: pulumi.Input[IPRuleAction], value: pulumi.Input[_builtins.str]) -> None:
    ...
    @action.setter
    def action(self, value: pulumi.Input[IPRuleAction]): # -> None:
        ...
...
class InboundNatPoolArgs:
    def __init__(__self__, *, backend_port: pulumi.Input[_builtins.int], frontend_port_range_end: pulumi.Input[_builtins.int], frontend_port_range_start: pulumi.Input[_builtins.int], name: pulumi.Input[_builtins.str], protocol: pulumi.Input[InboundEndpointProtocol], network_security_group_rules: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkSecurityGroupRuleArgs]]]] = ...) -> None:
    ...
    @protocol.setter
    def protocol(self, value: pulumi.Input[InboundEndpointProtocol]): # -> None:
        ...
    ...
    def network_security_group_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkSecurityGroupRuleArgs]]]]): # -> None:
        ...
...
class KeyVaultPropertiesArgs:
    def __init__(__self__, *, key_identifier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class KeyVaultReferenceArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], url: pulumi.Input[_builtins.str]) -> None:
...
class LinuxUserConfigurationArgs:
    def __init__(__self__, *, gid: Optional[pulumi.Input[_builtins.int]] = ..., ssh_private_key: Optional[pulumi.Input[_builtins.str]] = ..., uid: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @gid.setter
    def gid(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def ssh_private_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @uid.setter
    def uid(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ManagedDiskArgs:
    def __init__(__self__, *, security_profile: Optional[pulumi.Input[VMDiskSecurityProfileArgs]] = ..., storage_account_type: Optional[pulumi.Input[StorageAccountType]] = ...) -> None:
...
class MountConfigurationArgs:
    def __init__(__self__, *, azure_blob_file_system_configuration: Optional[pulumi.Input[AzureBlobFileSystemConfigurationArgs]] = ..., azure_file_share_configuration: Optional[pulumi.Input[AzureFileShareConfigurationArgs]] = ..., cifs_mount_configuration: Optional[pulumi.Input[CIFSMountConfigurationArgs]] = ..., nfs_mount_configuration: Optional[pulumi.Input[NFSMountConfigurationArgs]] = ...) -> None:
    ...
    def azure_blob_file_system_configuration(self, value: Optional[pulumi.Input[AzureBlobFileSystemConfigurationArgs]]): # -> None:
        ...
    ...
    def azure_file_share_configuration(self, value: Optional[pulumi.Input[AzureFileShareConfigurationArgs]]): # -> None:
        ...
    ...
    def cifs_mount_configuration(self, value: Optional[pulumi.Input[CIFSMountConfigurationArgs]]): # -> None:
        ...
    ...
    def nfs_mount_configuration(self, value: Optional[pulumi.Input[NFSMountConfigurationArgs]]): # -> None:
        ...
...
class NFSMountConfigurationArgs:
    def __init__(__self__, *, relative_mount_path: pulumi.Input[_builtins.str], source: pulumi.Input[_builtins.str], mount_options: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NetworkConfigurationArgs:
    def __init__(__self__, *, dynamic_vnet_assignment_scope: Optional[pulumi.Input[DynamicVNetAssignmentScope]] = ..., enable_accelerated_networking: Optional[pulumi.Input[_builtins.bool]] = ..., endpoint_configuration: Optional[pulumi.Input[PoolEndpointConfigurationArgs]] = ..., public_ip_address_configuration: Optional[pulumi.Input[PublicIPAddressConfigurationArgs]] = ..., subnet_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dynamic_vnet_assignment_scope(self, value: Optional[pulumi.Input[DynamicVNetAssignmentScope]]): # -> None:
        ...
    ...
    def endpoint_configuration(self, value: Optional[pulumi.Input[PoolEndpointConfigurationArgs]]): # -> None:
        ...
    ...
    def public_ip_address_configuration(self, value: Optional[pulumi.Input[PublicIPAddressConfigurationArgs]]): # -> None:
        ...
...
class NetworkProfileArgs:
    def __init__(__self__, *, account_access: Optional[pulumi.Input[EndpointAccessProfileArgs]] = ..., node_management_access: Optional[pulumi.Input[EndpointAccessProfileArgs]] = ...) -> None:
    ...
    def account_access(self, value: Optional[pulumi.Input[EndpointAccessProfileArgs]]): # -> None:
        ...
    ...
    def node_management_access(self, value: Optional[pulumi.Input[EndpointAccessProfileArgs]]): # -> None:
        ...
...
class NetworkSecurityGroupRuleArgs:
    def __init__(__self__, *, access: pulumi.Input[NetworkSecurityGroupRuleAccess], priority: pulumi.Input[_builtins.int], source_address_prefix: pulumi.Input[_builtins.str], source_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @access.setter
    def access(self, value: pulumi.Input[NetworkSecurityGroupRuleAccess]): # -> None:
        ...
    ...
    def source_address_prefix(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class NodePlacementConfigurationArgs:
    def __init__(__self__, *, policy: Optional[pulumi.Input[NodePlacementPolicyType]] = ...) -> None:
    ...
    @policy.setter
    def policy(self, value: Optional[pulumi.Input[NodePlacementPolicyType]]): # -> None:
        ...
...
@pulumi.input_type
class OSDiskArgs:
    def __init__(__self__, *, caching: Optional[pulumi.Input[CachingType]] = ..., disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., ephemeral_os_disk_settings: Optional[pulumi.Input[DiffDiskSettingsArgs]] = ..., managed_disk: Optional[pulumi.Input[ManagedDiskArgs]] = ..., write_accelerator_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def ephemeral_os_disk_settings(self, value: Optional[pulumi.Input[DiffDiskSettingsArgs]]): # -> None:
        ...
    ...
    @managed_disk.setter
    def managed_disk(self, value: Optional[pulumi.Input[ManagedDiskArgs]]): # -> None:
        ...
...
class PoolEndpointConfigurationArgs:
    def __init__(__self__, *, inbound_nat_pools: pulumi.Input[Sequence[pulumi.Input[InboundNatPoolArgs]]]) -> None:
    ...
    def inbound_nat_pools(self, value: pulumi.Input[Sequence[pulumi.Input[InboundNatPoolArgs]]]): # -> None:
        ...
...
class PublicIPAddressConfigurationArgs:
    def __init__(__self__, *, ip_address_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., provision: Optional[pulumi.Input[IPAddressProvisioningType]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="ipAddressIds")
    def ip_address_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @ip_address_ids.setter
    def ip_address_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @provision.setter
    def provision(self, value: Optional[pulumi.Input[IPAddressProvisioningType]]): # -> None:
        ...
...
class ResourceFileArgs:
    def __init__(__self__, *, auto_storage_container_name: Optional[pulumi.Input[_builtins.str]] = ..., blob_prefix: Optional[pulumi.Input[_builtins.str]] = ..., file_mode: Optional[pulumi.Input[_builtins.str]] = ..., file_path: Optional[pulumi.Input[_builtins.str]] = ..., http_url: Optional[pulumi.Input[_builtins.str]] = ..., identity_reference: Optional[pulumi.Input[ComputeNodeIdentityReferenceArgs]] = ..., storage_container_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def auto_storage_container_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @blob_prefix.setter
    def blob_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @file_mode.setter
    def file_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def storage_container_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ScaleSettingsArgs:
    def __init__(__self__, *, auto_scale: Optional[pulumi.Input[AutoScaleSettingsArgs]] = ..., fixed_scale: Optional[pulumi.Input[FixedScaleSettingsArgs]] = ...) -> None:
    ...
    @auto_scale.setter
    def auto_scale(self, value: Optional[pulumi.Input[AutoScaleSettingsArgs]]): # -> None:
        ...
    ...
    @fixed_scale.setter
    def fixed_scale(self, value: Optional[pulumi.Input[FixedScaleSettingsArgs]]): # -> None:
        ...
...
class SecurityProfileArgs:
    def __init__(__self__, *, encryption_at_host: Optional[pulumi.Input[_builtins.bool]] = ..., security_type: Optional[pulumi.Input[SecurityTypes]] = ..., uefi_settings: Optional[pulumi.Input[UefiSettingsArgs]] = ...) -> None:
    ...
    def security_type(self, value: Optional[pulumi.Input[SecurityTypes]]): # -> None:
        ...
...
@pulumi.input_type
class StartTaskArgs:
    def __init__(__self__, *, command_line: Optional[pulumi.Input[_builtins.str]] = ..., container_settings: Optional[pulumi.Input[TaskContainerSettingsArgs]] = ..., environment_settings: Optional[pulumi.Input[Sequence[pulumi.Input[EnvironmentSettingArgs]]]] = ..., max_task_retry_count: Optional[pulumi.Input[_builtins.int]] = ..., resource_files: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceFileArgs]]]] = ..., user_identity: Optional[pulumi.Input[UserIdentityArgs]] = ..., wait_for_success: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @command_line.setter
    def command_line(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def container_settings(self, value: Optional[pulumi.Input[TaskContainerSettingsArgs]]): # -> None:
        ...
    ...
    def environment_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EnvironmentSettingArgs]]]]): # -> None:
        ...
    ...
    def max_task_retry_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def resource_files(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceFileArgs]]]]): # -> None:
        ...
    ...
    def user_identity(self, value: Optional[pulumi.Input[UserIdentityArgs]]): # -> None:
        ...
    ...
    def wait_for_success(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class TaskContainerSettingsArgs:
    def __init__(__self__, *, image_name: pulumi.Input[_builtins.str], container_host_batch_bind_mounts: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerHostBatchBindMountEntryArgs]]]] = ..., container_run_options: Optional[pulumi.Input[_builtins.str]] = ..., registry: Optional[pulumi.Input[ContainerRegistryArgs]] = ..., working_directory: Optional[pulumi.Input[ContainerWorkingDirectory]] = ...) -> None:
    ...
    def container_host_batch_bind_mounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerHostBatchBindMountEntryArgs]]]]): # -> None:
        ...
    ...
    def container_run_options(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @registry.setter
    def registry(self, value: Optional[pulumi.Input[ContainerRegistryArgs]]): # -> None:
        ...
    ...
    def working_directory(self, value: Optional[pulumi.Input[ContainerWorkingDirectory]]): # -> None:
        ...
...
class TaskSchedulingPolicyArgs:
    def __init__(__self__, *, node_fill_type: Optional[pulumi.Input[ComputeNodeFillType]] = ...) -> None:
    ...
    def node_fill_type(self, value: pulumi.Input[ComputeNodeFillType]): # -> None:
        ...
...
class UpgradePolicyArgs:
    def __init__(__self__, *, mode: pulumi.Input[UpgradeMode], automatic_os_upgrade_policy: Optional[pulumi.Input[AutomaticOSUpgradePolicyArgs]] = ..., rolling_upgrade_policy: Optional[pulumi.Input[RollingUpgradePolicyArgs]] = ...) -> None:
    ...
    @mode.setter
    def mode(self, value: pulumi.Input[UpgradeMode]): # -> None:
        ...
...
class UserAccountArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], password: pulumi.Input[_builtins.str], elevation_level: Optional[pulumi.Input[ElevationLevel]] = ..., linux_user_configuration: Optional[pulumi.Input[LinuxUserConfigurationArgs]] = ..., windows_user_configuration: Optional[pulumi.Input[WindowsUserConfigurationArgs]] = ...) -> None:
    ...
    def linux_user_configuration(self, value: Optional[pulumi.Input[LinuxUserConfigurationArgs]]): # -> None:
        ...
    ...
    def windows_user_configuration(self, value: Optional[pulumi.Input[WindowsUserConfigurationArgs]]): # -> None:
        ...
...
class UserIdentityArgs:
    def __init__(__self__, *, auto_user: Optional[pulumi.Input[AutoUserSpecificationArgs]] = ..., user_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @auto_user.setter
    def auto_user(self, value: Optional[pulumi.Input[AutoUserSpecificationArgs]]): # -> None:
        ...
...
class VMDiskSecurityProfileArgs:
    def __init__(__self__, *, security_encryption_type: Optional[pulumi.Input[Union[_builtins.str, SecurityEncryptionTypes]]] = ...) -> None:
...
class VMExtensionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], publisher: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], auto_upgrade_minor_version: Optional[pulumi.Input[_builtins.bool]] = ..., enable_automatic_upgrade: Optional[pulumi.Input[_builtins.bool]] = ..., protected_settings: Optional[Any] = ..., provision_after_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., settings: Optional[Any] = ..., type_handler_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VirtualMachineConfigurationArgs:
    def __init__(__self__, *, image_reference: pulumi.Input[ImageReferenceArgs], node_agent_sku_id: pulumi.Input[_builtins.str], container_configuration: Optional[pulumi.Input[ContainerConfigurationArgs]] = ..., data_disks: Optional[pulumi.Input[Sequence[pulumi.Input[DataDiskArgs]]]] = ..., disk_encryption_configuration: Optional[pulumi.Input[DiskEncryptionConfigurationArgs]] = ..., extensions: Optional[pulumi.Input[Sequence[pulumi.Input[VMExtensionArgs]]]] = ..., license_type: Optional[pulumi.Input[_builtins.str]] = ..., node_placement_configuration: Optional[pulumi.Input[NodePlacementConfigurationArgs]] = ..., os_disk: Optional[pulumi.Input[OSDiskArgs]] = ..., security_profile: Optional[pulumi.Input[SecurityProfileArgs]] = ..., service_artifact_reference: Optional[pulumi.Input[ServiceArtifactReferenceArgs]] = ..., windows_configuration: Optional[pulumi.Input[WindowsConfigurationArgs]] = ...) -> None:
    ...
    def node_agent_sku_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def container_configuration(self, value: Optional[pulumi.Input[ContainerConfigurationArgs]]): # -> None:
        ...
    ...
    def disk_encryption_configuration(self, value: Optional[pulumi.Input[DiskEncryptionConfigurationArgs]]): # -> None:
        ...
    ...
    @extensions.setter
    def extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VMExtensionArgs]]]]): # -> None:
        ...
    ...
    def node_placement_configuration(self, value: Optional[pulumi.Input[NodePlacementConfigurationArgs]]): # -> None:
        ...
...
class WindowsConfigurationArgs:
    def __init__(__self__, *, enable_automatic_updates: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class WindowsUserConfigurationArgs:
    def __init__(__self__, *, login_mode: Optional[pulumi.Input[LoginMode]] = ...) -> None:
    ...
    @login_mode.setter
    def login_mode(self, value: Optional[pulumi.Input[LoginMode]]): # -> None:
        ...
