...
@pulumi.input_type
class PoolArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], application_licenses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., application_packages: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationPackageReferenceArgs]]]] = ..., certificates: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateReferenceArgs]]]] = ..., deployment_configuration: Optional[pulumi.Input[DeploymentConfigurationArgs]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[BatchPoolIdentityArgs]] = ..., inter_node_communication: Optional[pulumi.Input[InterNodeCommunicationState]] = ..., metadata: Optional[pulumi.Input[Sequence[pulumi.Input[MetadataItemArgs]]]] = ..., mount_configuration: Optional[pulumi.Input[Sequence[pulumi.Input[MountConfigurationArgs]]]] = ..., network_configuration: Optional[pulumi.Input[NetworkConfigurationArgs]] = ..., pool_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., scale_settings: Optional[pulumi.Input[ScaleSettingsArgs]] = ..., start_task: Optional[pulumi.Input[StartTaskArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_node_communication_mode: Optional[pulumi.Input[NodeCommunicationMode]] = ..., task_scheduling_policy: Optional[pulumi.Input[TaskSchedulingPolicyArgs]] = ..., task_slots_per_node: Optional[pulumi.Input[_builtins.int]] = ..., upgrade_policy: Optional[pulumi.Input[UpgradePolicyArgs]] = ..., user_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[UserAccountArgs]]]] = ..., vm_size: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def application_licenses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def application_packages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationPackageReferenceArgs]]]]): # -> None:
        ...
    ...
    def deployment_configuration(self, value: Optional[pulumi.Input[DeploymentConfigurationArgs]]): # -> None:
        ...
    ...
    @identity.setter
    def identity(self, value: Optional[pulumi.Input[BatchPoolIdentityArgs]]): # -> None:
        ...
    ...
    def inter_node_communication(self, value: Optional[pulumi.Input[InterNodeCommunicationState]]): # -> None:
        ...
    ...
    @metadata.setter
    def metadata(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MetadataItemArgs]]]]): # -> None:
        ...
    ...
    def mount_configuration(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MountConfigurationArgs]]]]): # -> None:
        ...
    ...
    @start_task.setter
    def start_task(self, value: Optional[pulumi.Input[StartTaskArgs]]): # -> None:
        ...
    ...
    def target_node_communication_mode(self, value: Optional[pulumi.Input[NodeCommunicationMode]]): # -> None:
        ...
    ...
    def task_scheduling_policy(self, value: Optional[pulumi.Input[TaskSchedulingPolicyArgs]]): # -> None:
        ...
    ...
    def task_slots_per_node(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def user_accounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[UserAccountArgs]]]]): # -> None:
        ...
...
class Pool(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., application_licenses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., application_packages: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ApplicationPackageReferenceArgs, ApplicationPackageReferenceArgsDict]]]]] = ..., certificates: Optional[pulumi.Input[Sequence[pulumi.Input[Union[CertificateReferenceArgs, CertificateReferenceArgsDict]]]]] = ..., deployment_configuration: Optional[pulumi.Input[Union[DeploymentConfigurationArgs, DeploymentConfigurationArgsDict]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[Union[BatchPoolIdentityArgs, BatchPoolIdentityArgsDict]]] = ..., inter_node_communication: Optional[pulumi.Input[InterNodeCommunicationState]] = ..., metadata: Optional[pulumi.Input[Sequence[pulumi.Input[Union[MetadataItemArgs, MetadataItemArgsDict]]]]] = ..., mount_configuration: Optional[pulumi.Input[Sequence[pulumi.Input[Union[MountConfigurationArgs, MountConfigurationArgsDict]]]]] = ..., network_configuration: Optional[pulumi.Input[Union[NetworkConfigurationArgs, NetworkConfigurationArgsDict]]] = ..., pool_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., scale_settings: Optional[pulumi.Input[Union[ScaleSettingsArgs, ScaleSettingsArgsDict]]] = ..., start_task: Optional[pulumi.Input[Union[StartTaskArgs, StartTaskArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_node_communication_mode: Optional[pulumi.Input[NodeCommunicationMode]] = ..., task_scheduling_policy: Optional[pulumi.Input[Union[TaskSchedulingPolicyArgs, TaskSchedulingPolicyArgsDict]]] = ..., task_slots_per_node: Optional[pulumi.Input[_builtins.int]] = ..., upgrade_policy: Optional[pulumi.Input[Union[UpgradePolicyArgs, UpgradePolicyArgsDict]]] = ..., user_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[Union[UserAccountArgs, UserAccountArgsDict]]]]] = ..., vm_size: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @_builtins.property
    @pulumi.getter(name="applicationLicenses")
    def application_licenses(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
