...
class BatchAccountArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], account_name: Optional[pulumi.Input[_builtins.str]] = ..., allowed_authentication_modes: Optional[pulumi.Input[Sequence[pulumi.Input[AuthenticationMode]]]] = ..., auto_storage: Optional[pulumi.Input[AutoStorageBasePropertiesArgs]] = ..., encryption: Optional[pulumi.Input[EncryptionPropertiesArgs]] = ..., identity: Optional[pulumi.Input[BatchAccountIdentityArgs]] = ..., key_vault_reference: Optional[pulumi.Input[KeyVaultReferenceArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., network_profile: Optional[pulumi.Input[NetworkProfileArgs]] = ..., pool_allocation_mode: Optional[pulumi.Input[PoolAllocationMode]] = ..., public_network_access: Optional[pulumi.Input[PublicNetworkAccessType]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allowed_authentication_modes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AuthenticationMode]]]]): # -> None:
        ...
    ...
    @auto_storage.setter
    def auto_storage(self, value: Optional[pulumi.Input[AutoStorageBasePropertiesArgs]]): # -> None:
        ...
    ...
    @encryption.setter
    def encryption(self, value: Optional[pulumi.Input[EncryptionPropertiesArgs]]): # -> None:
        ...
    ...
    @identity.setter
    def identity(self, value: Optional[pulumi.Input[BatchAccountIdentityArgs]]): # -> None:
        ...
    ...
    def key_vault_reference(self, value: Optional[pulumi.Input[KeyVaultReferenceArgs]]): # -> None:
        ...
    ...
    def pool_allocation_mode(self, value: Optional[pulumi.Input[PoolAllocationMode]]): # -> None:
        ...
    ...
    def public_network_access(self, value: Optional[pulumi.Input[PublicNetworkAccessType]]): # -> None:
        ...
...
class BatchAccount(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., allowed_authentication_modes: Optional[pulumi.Input[Sequence[pulumi.Input[AuthenticationMode]]]] = ..., auto_storage: Optional[pulumi.Input[Union[AutoStorageBasePropertiesArgs, AutoStorageBasePropertiesArgsDict]]] = ..., encryption: Optional[pulumi.Input[Union[EncryptionPropertiesArgs, EncryptionPropertiesArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[BatchAccountIdentityArgs, BatchAccountIdentityArgsDict]]] = ..., key_vault_reference: Optional[pulumi.Input[Union[KeyVaultReferenceArgs, KeyVaultReferenceArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., network_profile: Optional[pulumi.Input[Union[NetworkProfileArgs, NetworkProfileArgsDict]]] = ..., pool_allocation_mode: Optional[pulumi.Input[PoolAllocationMode]] = ..., public_network_access: Optional[pulumi.Input[PublicNetworkAccessType]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: BatchAccountArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> BatchAccount:
    ...
    @_builtins.property
    @pulumi.getter(name="allowedAuthenticationModes")
    def allowed_authentication_modes(self) -> pulumi.Output[Sequence[_builtins.str]]:
    ...
    def dedicated_core_quota_per_vm_family_enforced(self) -> pulumi.Output[_builtins.bool]:
