...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApiEntityReferenceResponse', 'CloudHsmClusterSkuResponse', 'CloudHsmPropertiesResponse', 'ManagedServiceIdentityResponse', 'NetworkInterfaceResponse', 'NetworkProfileResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'SkuResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
...
class CloudHsmClusterSkuResponse(dict):
    ...
    def __init__(__self__, *, family: _builtins.str, name: _builtins.str, capacity: Optional[_builtins.int] = ...) -> None:
...
class CloudHsmPropertiesResponse(dict):
    ...
    def __init__(__self__, *, fqdn: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., state_message: Optional[_builtins.str] = ...) -> None:
...
class NetworkInterfaceResponse(dict):
    ...
    def __init__(__self__, *, resource_id: _builtins.str, private_ip_address: Optional[_builtins.str] = ...) -> None:
...
class NetworkProfileResponse(dict):
    ...
    def __init__(__self__, *, network_interfaces: Optional[Sequence[outputs.NetworkInterfaceResponse]] = ..., subnet: Optional[outputs.ApiEntityReferenceResponse] = ...) -> None:
...
class PrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *, group_ids: Sequence[_builtins.str], id: _builtins.str, name: _builtins.str, private_link_service_connection_state: outputs.PrivateLinkServiceConnectionStateResponse, provisioning_state: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str, etag: Optional[_builtins.str] = ..., private_endpoint: Optional[outputs.PrivateEndpointResponse] = ...) -> None:
