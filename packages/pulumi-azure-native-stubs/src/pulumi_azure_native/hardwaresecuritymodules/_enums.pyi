...
__all__ = ['AutoGeneratedDomainNameLabelScope', 'CloudHsmClusterSkuFamily', 'CloudHsmClusterSkuName', 'ManagedServiceIdentityType', 'PrivateEndpointServiceConnectionStatus', 'PublicNetworkAccess', 'SkuName']
@pulumi.type_token(...)
