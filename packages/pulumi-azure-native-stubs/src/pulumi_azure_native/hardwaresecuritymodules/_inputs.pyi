...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApiEntityReferenceArgs', 'ApiEntityReferenceArgsDict', 'CloudHsmClusterSkuArgs', 'CloudHsmClusterSkuArgsDict', 'ManagedServiceIdentityArgs', 'ManagedServiceIdentityArgsDict', 'NetworkInterfaceArgs', 'NetworkInterfaceArgsDict', 'NetworkProfileArgs', 'NetworkProfileArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'SkuArgs', 'SkuArgsDict']
...
class CloudHsmClusterSkuArgs:
    def __init__(__self__, *, family: pulumi.Input[Union[_builtins.str, CloudHsmClusterSkuFamily]], name: pulumi.Input[CloudHsmClusterSkuName], capacity: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def family(self) -> pulumi.Input[Union[_builtins.str, CloudHsmClusterSkuFamily]]:
        
        ...
    
    @family.setter
    def family(self, value: pulumi.Input[Union[_builtins.str, CloudHsmClusterSkuFamily]]): # -> None:
        ...
    ...
    @name.setter
    def name(self, value: pulumi.Input[CloudHsmClusterSkuName]): # -> None:
        ...
...
class NetworkInterfaceArgs:
    def __init__(__self__, *, private_ip_address: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NetworkProfileArgs:
    def __init__(__self__, *, network_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkInterfaceArgs]]]] = ..., subnet: Optional[pulumi.Input[ApiEntityReferenceArgs]] = ...) -> None:
