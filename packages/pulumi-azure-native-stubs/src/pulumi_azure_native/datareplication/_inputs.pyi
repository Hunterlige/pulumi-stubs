...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzStackHCIClusterPropertiesArgs', 'AzStackHCIClusterPropertiesArgsDict', 'AzStackHCIFabricModelCustomPropertiesArgs', 'AzStackHCIFabricModelCustomPropertiesArgsDict', 'ConnectionDetailsArgs', 'ConnectionDetailsArgsDict', 'DraModelPropertiesArgs', 'DraModelPropertiesArgsDict', 'FabricAgentModelPropertiesArgs', 'FabricAgentModelPropertiesArgsDict', 'FabricModelPropertiesArgs', 'FabricModelPropertiesArgsDict', 'GroupConnectivityInformationArgs', 'GroupConnectivityInformationArgsDict', 'HyperVMigrateFabricModelCustomPropertiesArgs', 'HyperVMigrateFabricModelCustomPropertiesArgsDict', 'HyperVToAzStackHCIDiskInputArgs', 'HyperVToAzStackHCIDiskInputArgsDict', 'HyperVToAzStackHCINicInputArgs', 'HyperVToAzStackHCINicInputArgsDict', 'HyperVToAzStackHCIPolicyModelCustomPropertiesArgs', ..., ..., ..., ..., ..., 'IdentityModelArgs', 'IdentityModelArgsDict', 'PolicyModelPropertiesArgs', 'PolicyModelPropertiesArgsDict', 'PrivateEndpointConnectionProxyPropertiesArgs', 'PrivateEndpointConnectionProxyPropertiesArgsDict', 'PrivateEndpointConnectionResponsePropertiesArgs', ..., 'PrivateEndpointArgs', 'PrivateEndpointArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'PrivateLinkServiceConnectionArgs', 'PrivateLinkServiceConnectionArgsDict', 'PrivateLinkServiceProxyArgs', 'PrivateLinkServiceProxyArgsDict', 'ProtectedItemDynamicMemoryConfigArgs', 'ProtectedItemDynamicMemoryConfigArgsDict', 'ProtectedItemModelPropertiesArgs', 'ProtectedItemModelPropertiesArgsDict', 'RemotePrivateEndpointConnectionArgs', 'RemotePrivateEndpointConnectionArgsDict', 'RemotePrivateEndpointArgs', 'RemotePrivateEndpointArgsDict', 'ReplicationExtensionModelPropertiesArgs', 'ReplicationExtensionModelPropertiesArgsDict', 'StorageContainerPropertiesArgs', 'StorageContainerPropertiesArgsDict', 'VMwareDraModelCustomPropertiesArgs', 'VMwareDraModelCustomPropertiesArgsDict', 'VMwareFabricAgentModelCustomPropertiesArgs', 'VMwareFabricAgentModelCustomPropertiesArgsDict', 'VMwareMigrateFabricModelCustomPropertiesArgs', 'VMwareMigrateFabricModelCustomPropertiesArgsDict', 'VMwareToAzStackHCIDiskInputArgs', 'VMwareToAzStackHCIDiskInputArgsDict', 'VMwareToAzStackHCINicInputArgs', 'VMwareToAzStackHCINicInputArgsDict', 'VMwareToAzStackHCIPolicyModelCustomPropertiesArgs', ..., ..., ..., ..., ..., 'VaultModelPropertiesArgs', 'VaultModelPropertiesArgsDict']
...
class AzStackHCIClusterPropertiesArgs:
    def __init__(__self__, *, cluster_name: pulumi.Input[_builtins.str], resource_name: pulumi.Input[_builtins.str], storage_account_name: pulumi.Input[_builtins.str], storage_containers: pulumi.Input[Sequence[pulumi.Input[StorageContainerPropertiesArgs]]]) -> None:
    ...
    def storage_containers(self, value: pulumi.Input[Sequence[pulumi.Input[StorageContainerPropertiesArgs]]]): # -> None:
        ...
...
class AzStackHCIFabricModelCustomPropertiesArgs:
    def __init__(__self__, *, az_stack_hci_site_id: pulumi.Input[_builtins.str], cluster: pulumi.Input[AzStackHCIClusterPropertiesArgs], instance_type: pulumi.Input[_builtins.str], migration_solution_id: pulumi.Input[_builtins.str]) -> None:
    ...
    def az_stack_hci_site_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @cluster.setter
    def cluster(self, value: pulumi.Input[AzStackHCIClusterPropertiesArgs]): # -> None:
        ...
...
class ConnectionDetailsArgs:
    def __init__(__self__, *, group_id: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., link_identifier: Optional[pulumi.Input[_builtins.str]] = ..., member_name: Optional[pulumi.Input[_builtins.str]] = ..., private_ip_address: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def link_identifier(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DraModelPropertiesArgs:
    def __init__(__self__, *, authentication_identity: pulumi.Input[IdentityModelArgs], custom_properties: pulumi.Input[VMwareDraModelCustomPropertiesArgs], machine_id: pulumi.Input[_builtins.str], machine_name: pulumi.Input[_builtins.str], resource_access_identity: pulumi.Input[IdentityModelArgs]) -> None:
    ...
    def authentication_identity(self, value: pulumi.Input[IdentityModelArgs]): # -> None:
        ...
    ...
    def custom_properties(self, value: pulumi.Input[VMwareDraModelCustomPropertiesArgs]): # -> None:
        ...
    ...
    @machine_id.setter
    def machine_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def resource_access_identity(self, value: pulumi.Input[IdentityModelArgs]): # -> None:
        ...
...
class FabricAgentModelPropertiesArgs:
    def __init__(__self__, *, authentication_identity: pulumi.Input[IdentityModelArgs], custom_properties: pulumi.Input[VMwareFabricAgentModelCustomPropertiesArgs], machine_id: pulumi.Input[_builtins.str], machine_name: pulumi.Input[_builtins.str], resource_access_identity: pulumi.Input[IdentityModelArgs]) -> None:
    ...
    @custom_properties.setter
    def custom_properties(self, value: pulumi.Input[VMwareFabricAgentModelCustomPropertiesArgs]): # -> None:
        ...
...
class FabricModelPropertiesArgs:
    def __init__(__self__, *, custom_properties: pulumi.Input[Union[AzStackHCIFabricModelCustomPropertiesArgs, HyperVMigrateFabricModelCustomPropertiesArgs, VMwareMigrateFabricModelCustomPropertiesArgs]]) -> None:
    ...
    @custom_properties.setter
    def custom_properties(self, value: pulumi.Input[Union[AzStackHCIFabricModelCustomPropertiesArgs, HyperVMigrateFabricModelCustomPropertiesArgs, VMwareMigrateFabricModelCustomPropertiesArgs]]): # -> None:
        ...
...
class GroupConnectivityInformationArgs:
    def __init__(__self__, *, customer_visible_fqdns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., group_id: Optional[pulumi.Input[_builtins.str]] = ..., internal_fqdn: Optional[pulumi.Input[_builtins.str]] = ..., member_name: Optional[pulumi.Input[_builtins.str]] = ..., private_link_service_arm_region: Optional[pulumi.Input[_builtins.str]] = ..., redirect_map_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def internal_fqdn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class HyperVMigrateFabricModelCustomPropertiesArgs:
    def __init__(__self__, *, hyper_v_site_id: pulumi.Input[_builtins.str], instance_type: pulumi.Input[_builtins.str], migration_solution_id: pulumi.Input[_builtins.str]) -> None:
    ...
    def hyper_v_site_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class HyperVToAzStackHCIDiskInputArgs:
    def __init__(__self__, *, disk_file_format: pulumi.Input[_builtins.str], disk_id: pulumi.Input[_builtins.str], disk_size_gb: pulumi.Input[_builtins.float], is_os_disk: pulumi.Input[_builtins.bool], is_dynamic: Optional[pulumi.Input[_builtins.bool]] = ..., storage_container_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disk_file_format(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @is_os_disk.setter
    def is_os_disk(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    @is_dynamic.setter
    def is_dynamic(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def storage_container_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class HyperVToAzStackHCINicInputArgs:
    def __init__(__self__, *, nic_id: pulumi.Input[_builtins.str], selection_type_for_failover: pulumi.Input[Union[_builtins.str, VMNicSelection]], target_network_id: pulumi.Input[_builtins.str], test_network_id: pulumi.Input[_builtins.str]) -> None:
    ...
    @nic_id.setter
    def nic_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def selection_type_for_failover(self, value: pulumi.Input[Union[_builtins.str, VMNicSelection]]): # -> None:
        ...
    ...
    def test_network_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class HyperVToAzStackHCIPolicyModelCustomPropertiesArgs:
    def __init__(__self__, *, app_consistent_frequency_in_minutes: pulumi.Input[_builtins.int], crash_consistent_frequency_in_minutes: pulumi.Input[_builtins.int], instance_type: pulumi.Input[_builtins.str], recovery_point_history_in_minutes: pulumi.Input[_builtins.int]) -> None:
    ...
    def app_consistent_frequency_in_minutes(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def crash_consistent_frequency_in_minutes(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def recovery_point_history_in_minutes(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class HyperVToAzStackHCIProtectedItemModelCustomPropertiesArgs:
    def __init__(__self__, *, custom_location_region: pulumi.Input[_builtins.str], disks_to_include: pulumi.Input[Sequence[pulumi.Input[HyperVToAzStackHCIDiskInputArgs]]], fabric_discovery_machine_id: pulumi.Input[_builtins.str], hyper_v_generation: pulumi.Input[_builtins.str], instance_type: pulumi.Input[_builtins.str], nics_to_include: pulumi.Input[Sequence[pulumi.Input[HyperVToAzStackHCINicInputArgs]]], run_as_account_id: pulumi.Input[_builtins.str], source_dra_name: pulumi.Input[_builtins.str], storage_container_id: pulumi.Input[_builtins.str], target_arc_cluster_custom_location_id: pulumi.Input[_builtins.str], target_dra_name: pulumi.Input[_builtins.str], target_hci_cluster_id: pulumi.Input[_builtins.str], target_resource_group_id: pulumi.Input[_builtins.str], dynamic_memory_config: Optional[pulumi.Input[ProtectedItemDynamicMemoryConfigArgs]] = ..., is_dynamic_ram: Optional[pulumi.Input[_builtins.bool]] = ..., target_cpu_cores: Optional[pulumi.Input[_builtins.int]] = ..., target_memory_in_mega_bytes: Optional[pulumi.Input[_builtins.int]] = ..., target_network_id: Optional[pulumi.Input[_builtins.str]] = ..., target_vm_name: Optional[pulumi.Input[_builtins.str]] = ..., test_network_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def custom_location_region(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def disks_to_include(self, value: pulumi.Input[Sequence[pulumi.Input[HyperVToAzStackHCIDiskInputArgs]]]): # -> None:
        ...
    ...
    def hyper_v_generation(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def nics_to_include(self, value: pulumi.Input[Sequence[pulumi.Input[HyperVToAzStackHCINicInputArgs]]]): # -> None:
        ...
    ...
    def run_as_account_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def source_dra_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @storage_container_id.setter
    def storage_container_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def target_arc_cluster_custom_location_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def target_dra_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def target_hci_cluster_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def dynamic_memory_config(self, value: Optional[pulumi.Input[ProtectedItemDynamicMemoryConfigArgs]]): # -> None:
        ...
    ...
    def is_dynamic_ram(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def target_cpu_cores(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def target_memory_in_mega_bytes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class HyperVToAzStackHCIReplicationExtensionModelCustomPropertiesArgs:
    def __init__(__self__, *, az_stack_hci_fabric_arm_id: pulumi.Input[_builtins.str], hyper_v_fabric_arm_id: pulumi.Input[_builtins.str], instance_type: pulumi.Input[_builtins.str], storage_account_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_sas_secret_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def az_stack_hci_fabric_arm_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def hyper_v_fabric_arm_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PolicyModelPropertiesArgs:
    def __init__(__self__, *, custom_properties: pulumi.Input[Union[HyperVToAzStackHCIPolicyModelCustomPropertiesArgs, VMwareToAzStackHCIPolicyModelCustomPropertiesArgs]]) -> None:
    ...
    @custom_properties.setter
    def custom_properties(self, value: pulumi.Input[Union[HyperVToAzStackHCIPolicyModelCustomPropertiesArgs, VMwareToAzStackHCIPolicyModelCustomPropertiesArgs]]): # -> None:
        ...
...
class PrivateEndpointConnectionProxyPropertiesArgs:
    def __init__(__self__, *, remote_private_endpoint: Optional[pulumi.Input[RemotePrivateEndpointArgs]] = ...) -> None:
    ...
    def remote_private_endpoint(self, value: Optional[pulumi.Input[RemotePrivateEndpointArgs]]): # -> None:
        ...
...
class PrivateEndpointConnectionResponsePropertiesArgs:
    def __init__(__self__, *, private_endpoint: Optional[pulumi.Input[PrivateEndpointArgs]] = ..., private_link_service_connection_state: Optional[pulumi.Input[PrivateLinkServiceConnectionStateArgs]] = ...) -> None:
...
class PrivateLinkServiceProxyArgs:
    def __init__(__self__, *, group_connectivity_information: Optional[pulumi.Input[Sequence[pulumi.Input[GroupConnectivityInformationArgs]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., remote_private_endpoint_connection: Optional[pulumi.Input[RemotePrivateEndpointConnectionArgs]] = ..., remote_private_link_service_connection_state: Optional[pulumi.Input[PrivateLinkServiceConnectionStateArgs]] = ...) -> None:
    ...
    def remote_private_endpoint_connection(self, value: Optional[pulumi.Input[RemotePrivateEndpointConnectionArgs]]): # -> None:
        ...
...
class ProtectedItemDynamicMemoryConfigArgs:
    def __init__(__self__, *, maximum_memory_in_mega_bytes: pulumi.Input[_builtins.float], minimum_memory_in_mega_bytes: pulumi.Input[_builtins.float], target_memory_buffer_percentage: pulumi.Input[_builtins.int]) -> None:
    ...
    def maximum_memory_in_mega_bytes(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def minimum_memory_in_mega_bytes(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def target_memory_buffer_percentage(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ProtectedItemModelPropertiesArgs:
    def __init__(__self__, *, custom_properties: pulumi.Input[Union[HyperVToAzStackHCIProtectedItemModelCustomPropertiesArgs, VMwareToAzStackHCIProtectedItemModelCustomPropertiesArgs]], policy_name: pulumi.Input[_builtins.str], replication_extension_name: pulumi.Input[_builtins.str]) -> None:
    ...
    @custom_properties.setter
    def custom_properties(self, value: pulumi.Input[Union[HyperVToAzStackHCIProtectedItemModelCustomPropertiesArgs, VMwareToAzStackHCIProtectedItemModelCustomPropertiesArgs]]): # -> None:
        ...
    ...
    def replication_extension_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RemotePrivateEndpointArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], connection_details: Optional[pulumi.Input[Sequence[pulumi.Input[ConnectionDetailsArgs]]]] = ..., manual_private_link_service_connections: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateLinkServiceConnectionArgs]]]] = ..., private_link_service_connections: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateLinkServiceConnectionArgs]]]] = ..., private_link_service_proxies: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateLinkServiceProxyArgs]]]] = ...) -> None:
    ...
    def connection_details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ConnectionDetailsArgs]]]]): # -> None:
        ...
...
class ReplicationExtensionModelPropertiesArgs:
    def __init__(__self__, *, custom_properties: pulumi.Input[Union[HyperVToAzStackHCIReplicationExtensionModelCustomPropertiesArgs, VMwareToAzStackHCIReplicationExtensionModelCustomPropertiesArgs]]) -> None:
    ...
    @custom_properties.setter
    def custom_properties(self, value: pulumi.Input[Union[HyperVToAzStackHCIReplicationExtensionModelCustomPropertiesArgs, VMwareToAzStackHCIReplicationExtensionModelCustomPropertiesArgs]]): # -> None:
        ...
...
class StorageContainerPropertiesArgs:
    def __init__(__self__, *, cluster_shared_volume_path: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str]) -> None:
    ...
    def cluster_shared_volume_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class VMwareDraModelCustomPropertiesArgs:
    def __init__(__self__, *, bios_id: pulumi.Input[_builtins.str], instance_type: pulumi.Input[_builtins.str], mars_authentication_identity: pulumi.Input[IdentityModelArgs]) -> None:
    ...
    @bios_id.setter
    def bios_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def mars_authentication_identity(self, value: pulumi.Input[IdentityModelArgs]): # -> None:
        ...
...
class VMwareMigrateFabricModelCustomPropertiesArgs:
    def __init__(__self__, *, instance_type: pulumi.Input[_builtins.str], migration_solution_id: pulumi.Input[_builtins.str], vmware_site_id: pulumi.Input[_builtins.str]) -> None:
...
class VMwareToAzStackHCINicInputArgs:
    def __init__(__self__, *, label: pulumi.Input[_builtins.str], nic_id: pulumi.Input[_builtins.str], selection_type_for_failover: pulumi.Input[Union[_builtins.str, VMNicSelection]], target_network_id: pulumi.Input[_builtins.str], test_network_id: pulumi.Input[_builtins.str]) -> None:
...
class VMwareToAzStackHCIProtectedItemModelCustomPropertiesArgs:
    def __init__(__self__, *, custom_location_region: pulumi.Input[_builtins.str], disks_to_include: pulumi.Input[Sequence[pulumi.Input[VMwareToAzStackHCIDiskInputArgs]]], fabric_discovery_machine_id: pulumi.Input[_builtins.str], hyper_v_generation: pulumi.Input[_builtins.str], instance_type: pulumi.Input[_builtins.str], nics_to_include: pulumi.Input[Sequence[pulumi.Input[VMwareToAzStackHCINicInputArgs]]], run_as_account_id: pulumi.Input[_builtins.str], source_dra_name: pulumi.Input[_builtins.str], storage_container_id: pulumi.Input[_builtins.str], target_arc_cluster_custom_location_id: pulumi.Input[_builtins.str], target_dra_name: pulumi.Input[_builtins.str], target_hci_cluster_id: pulumi.Input[_builtins.str], target_resource_group_id: pulumi.Input[_builtins.str], dynamic_memory_config: Optional[pulumi.Input[ProtectedItemDynamicMemoryConfigArgs]] = ..., is_dynamic_ram: Optional[pulumi.Input[_builtins.bool]] = ..., perform_auto_resync: Optional[pulumi.Input[_builtins.bool]] = ..., target_cpu_cores: Optional[pulumi.Input[_builtins.int]] = ..., target_memory_in_mega_bytes: Optional[pulumi.Input[_builtins.int]] = ..., target_network_id: Optional[pulumi.Input[_builtins.str]] = ..., target_vm_name: Optional[pulumi.Input[_builtins.str]] = ..., test_network_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @disks_to_include.setter
    def disks_to_include(self, value: pulumi.Input[Sequence[pulumi.Input[VMwareToAzStackHCIDiskInputArgs]]]): # -> None:
        ...
    ...
    @nics_to_include.setter
    def nics_to_include(self, value: pulumi.Input[Sequence[pulumi.Input[VMwareToAzStackHCINicInputArgs]]]): # -> None:
        ...
    ...
    def perform_auto_resync(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class VMwareToAzStackHCIReplicationExtensionModelCustomPropertiesArgs:
    def __init__(__self__, *, az_stack_hci_fabric_arm_id: pulumi.Input[_builtins.str], instance_type: pulumi.Input[_builtins.str], vmware_fabric_arm_id: pulumi.Input[_builtins.str], storage_account_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_sas_secret_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def vmware_fabric_arm_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class VaultModelPropertiesArgs:
    def __init__(__self__, *, vault_type: Optional[pulumi.Input[Union[_builtins.str, ReplicationVaultType]]] = ...) -> None:
    ...
    @vault_type.setter
    def vault_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ReplicationVaultType]]]): # -> None:
        ...
