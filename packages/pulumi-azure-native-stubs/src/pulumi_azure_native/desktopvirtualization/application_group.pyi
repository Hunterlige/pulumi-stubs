...
class ApplicationGroupArgs:
    def __init__(__self__, *, application_group_type: pulumi.Input[Union[_builtins.str, ApplicationGroupType]], host_pool_arm_path: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], application_group_name: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., friendly_name: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[ResourceModelWithAllowedPropertySetIdentityArgs]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., managed_by: Optional[pulumi.Input[_builtins.str]] = ..., plan: Optional[pulumi.Input[ResourceModelWithAllowedPropertySetPlanArgs]] = ..., show_in_feed: Optional[pulumi.Input[_builtins.bool]] = ..., sku: Optional[pulumi.Input[ResourceModelWithAllowedPropertySetSkuArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="applicationGroupType")
    def application_group_type(self) -> pulumi.Input[Union[_builtins.str, ApplicationGroupType]]:
        
        ...
    
    @application_group_type.setter
    def application_group_type(self, value: pulumi.Input[Union[_builtins.str, ApplicationGroupType]]): # -> None:
        ...
    ...
    def host_pool_arm_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @show_in_feed.setter
    def show_in_feed(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ApplicationGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., application_group_name: Optional[pulumi.Input[_builtins.str]] = ..., application_group_type: Optional[pulumi.Input[Union[_builtins.str, ApplicationGroupType]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., friendly_name: Optional[pulumi.Input[_builtins.str]] = ..., host_pool_arm_path: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[Union[ResourceModelWithAllowedPropertySetIdentityArgs, ResourceModelWithAllowedPropertySetIdentityArgsDict]]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., managed_by: Optional[pulumi.Input[_builtins.str]] = ..., plan: Optional[pulumi.Input[Union[ResourceModelWithAllowedPropertySetPlanArgs, ResourceModelWithAllowedPropertySetPlanArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., show_in_feed: Optional[pulumi.Input[_builtins.bool]] = ..., sku: Optional[pulumi.Input[Union[ResourceModelWithAllowedPropertySetSkuArgs, ResourceModelWithAllowedPropertySetSkuArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
