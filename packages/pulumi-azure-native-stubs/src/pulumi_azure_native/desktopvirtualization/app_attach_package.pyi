...
class AppAttachPackageArgs:
    ...
    def app_attach_package_name(self, value: Optional[pulumi.Input[_builtins.str]]): ...
    @_builtins.property
    @pulumi.getter
...
class AppAttachPackage(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[
                    AppAttachPackagePropertiesArgs, AppAttachPackagePropertiesArgsDict
                ]
            ]
        ] = ...,
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.AppAttachPackagePropertiesResponse]: ...
    @_builtins.property
