...
class SessionHostArgs:
    def __init__(__self__, *, host_pool_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], allow_new_session: Optional[pulumi.Input[_builtins.bool]] = ..., assigned_user: Optional[pulumi.Input[_builtins.str]] = ..., friendly_name: Optional[pulumi.Input[_builtins.str]] = ..., session_host_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allow_new_session(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def assigned_user(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def session_host_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SessionHost(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., allow_new_session: Optional[pulumi.Input[_builtins.bool]] = ..., assigned_user: Optional[pulumi.Input[_builtins.str]] = ..., friendly_name: Optional[pulumi.Input[_builtins.str]] = ..., host_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., session_host_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: SessionHostArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SessionHost:
