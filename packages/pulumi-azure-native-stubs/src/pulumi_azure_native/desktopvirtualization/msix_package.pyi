...
class MSIXPackageArgs:
    def __init__(__self__, *, host_pool_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[_builtins.str]] = ..., image_path: Optional[pulumi.Input[_builtins.str]] = ..., is_active: Optional[pulumi.Input[_builtins.bool]] = ..., is_regular_registration: Optional[pulumi.Input[_builtins.bool]] = ..., last_updated: Optional[pulumi.Input[_builtins.str]] = ..., msix_package_full_name: Optional[pulumi.Input[_builtins.str]] = ..., package_applications: Optional[pulumi.Input[Sequence[pulumi.Input[MsixPackageApplicationsArgs]]]] = ..., package_dependencies: Optional[pulumi.Input[Sequence[pulumi.Input[MsixPackageDependenciesArgs]]]] = ..., package_family_name: Optional[pulumi.Input[_builtins.str]] = ..., package_name: Optional[pulumi.Input[_builtins.str]] = ..., package_relative_path: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def host_pool_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def msix_package_full_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MSIXPackage(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., host_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., image_path: Optional[pulumi.Input[_builtins.str]] = ..., is_active: Optional[pulumi.Input[_builtins.bool]] = ..., is_regular_registration: Optional[pulumi.Input[_builtins.bool]] = ..., last_updated: Optional[pulumi.Input[_builtins.str]] = ..., msix_package_full_name: Optional[pulumi.Input[_builtins.str]] = ..., package_applications: Optional[pulumi.Input[Sequence[pulumi.Input[Union[MsixPackageApplicationsArgs, MsixPackageApplicationsArgsDict]]]]] = ..., package_dependencies: Optional[pulumi.Input[Sequence[pulumi.Input[Union[MsixPackageDependenciesArgs, MsixPackageDependenciesArgsDict]]]]] = ..., package_family_name: Optional[pulumi.Input[_builtins.str]] = ..., package_name: Optional[pulumi.Input[_builtins.str]] = ..., package_relative_path: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: MSIXPackageArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> MSIXPackage:
