...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AgentUpdatePropertiesResponse', 'AppAttachPackageInfoPropertiesResponse', 'AppAttachPackagePropertiesResponse', 'MaintenanceWindowPropertiesResponse', 'MsixPackageApplicationsResponse', 'MsixPackageDependenciesResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'RegistrationInfoResponse', 'RegistrationTokenMinimalResponse', ..., 'ResourceModelWithAllowedPropertySetResponsePlan', 'ResourceModelWithAllowedPropertySetResponseSku', 'ScalingHostPoolReferenceResponse', 'ScalingScheduleResponse', 'SessionHostHealthCheckFailureDetailsResponse', 'SessionHostHealthCheckReportResponse', 'SystemDataResponse', 'TimeResponse']
@pulumi.output_type
class AgentUpdatePropertiesResponse(dict):
    ...
    def __init__(__self__, *, maintenance_window_time_zone: Optional[_builtins.str] = ..., maintenance_windows: Optional[Sequence[outputs.MaintenanceWindowPropertiesResponse]] = ..., type: Optional[_builtins.str] = ..., use_session_host_local_time: Optional[_builtins.bool] = ...) -> None:
...
class AppAttachPackageInfoPropertiesResponse(dict):
    ...
    def __init__(__self__, *, certificate_expiry: Optional[_builtins.str] = ..., certificate_name: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., image_path: Optional[_builtins.str] = ..., is_active: Optional[_builtins.bool] = ..., is_package_timestamped: Optional[_builtins.str] = ..., is_regular_registration: Optional[_builtins.bool] = ..., last_updated: Optional[_builtins.str] = ..., package_alias: Optional[_builtins.str] = ..., package_applications: Optional[Sequence[outputs.MsixPackageApplicationsResponse]] = ..., package_dependencies: Optional[Sequence[outputs.MsixPackageDependenciesResponse]] = ..., package_family_name: Optional[_builtins.str] = ..., package_full_name: Optional[_builtins.str] = ..., package_name: Optional[_builtins.str] = ..., package_relative_path: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class AppAttachPackagePropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, fail_health_check_on_staging_failure: Optional[_builtins.str] = ..., host_pool_references: Optional[Sequence[_builtins.str]] = ..., image: Optional[outputs.AppAttachPackageInfoPropertiesResponse] = ..., key_vault_url: Optional[_builtins.str] = ...) -> None:
...
class MaintenanceWindowPropertiesResponse(dict):
    ...
    def __init__(__self__, *, day_of_week: Optional[_builtins.str] = ..., hour: Optional[_builtins.int] = ...) -> None:
...
class MsixPackageApplicationsResponse(dict):
    ...
    def __init__(__self__, *, app_id: Optional[_builtins.str] = ..., app_user_model_id: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., friendly_name: Optional[_builtins.str] = ..., icon_image_name: Optional[_builtins.str] = ..., raw_icon: Optional[_builtins.str] = ..., raw_png: Optional[_builtins.str] = ...) -> None:
...
class MsixPackageDependenciesResponse(dict):
    ...
    def __init__(__self__, *, dependency_name: Optional[_builtins.str] = ..., min_version: Optional[_builtins.str] = ..., publisher: Optional[_builtins.str] = ...) -> None:
...
class RegistrationInfoResponse(dict):
    ...
    def __init__(__self__, *, expiration_time: Optional[_builtins.str] = ..., registration_token_operation: Optional[_builtins.str] = ..., token: Optional[_builtins.str] = ...) -> None:
...
class RegistrationTokenMinimalResponse(dict):
    ...
    def __init__(__self__, *, expiration_time: Optional[_builtins.str] = ..., token: Optional[_builtins.str] = ...) -> None:
...
class ScalingHostPoolReferenceResponse(dict):
    ...
    def __init__(__self__, *, host_pool_arm_path: Optional[_builtins.str] = ..., scaling_plan_enabled: Optional[_builtins.bool] = ...) -> None:
...
class ScalingScheduleResponse(dict):
    ...
    def __init__(__self__, *, days_of_week: Optional[Sequence[_builtins.str]] = ..., name: Optional[_builtins.str] = ..., off_peak_load_balancing_algorithm: Optional[_builtins.str] = ..., off_peak_start_time: Optional[outputs.TimeResponse] = ..., peak_load_balancing_algorithm: Optional[_builtins.str] = ..., peak_start_time: Optional[outputs.TimeResponse] = ..., ramp_down_capacity_threshold_pct: Optional[_builtins.int] = ..., ramp_down_force_logoff_users: Optional[_builtins.bool] = ..., ramp_down_load_balancing_algorithm: Optional[_builtins.str] = ..., ramp_down_minimum_hosts_pct: Optional[_builtins.int] = ..., ramp_down_notification_message: Optional[_builtins.str] = ..., ramp_down_start_time: Optional[outputs.TimeResponse] = ..., ramp_down_stop_hosts_when: Optional[_builtins.str] = ..., ramp_down_wait_time_minutes: Optional[_builtins.int] = ..., ramp_up_capacity_threshold_pct: Optional[_builtins.int] = ..., ramp_up_load_balancing_algorithm: Optional[_builtins.str] = ..., ramp_up_minimum_hosts_pct: Optional[_builtins.int] = ..., ramp_up_start_time: Optional[outputs.TimeResponse] = ...) -> None:
...
class SessionHostHealthCheckFailureDetailsResponse(dict):
    ...
    def __init__(__self__, *, error_code: _builtins.int, last_health_check_date_time: _builtins.str, message: _builtins.str) -> None:
...
class SessionHostHealthCheckReportResponse(dict):
    ...
    def __init__(__self__, *, additional_failure_details: outputs.SessionHostHealthCheckFailureDetailsResponse, health_check_name: _builtins.str, health_check_result: _builtins.str) -> None:
