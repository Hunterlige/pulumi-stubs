...
class ApplicationArgs:
    def __init__(__self__, *, application_group_name: pulumi.Input[_builtins.str], command_line_setting: pulumi.Input[Union[_builtins.str, CommandLineSetting]], resource_group_name: pulumi.Input[_builtins.str], application_name: Optional[pulumi.Input[_builtins.str]] = ..., application_type: Optional[pulumi.Input[Union[_builtins.str, RemoteApplicationType]]] = ..., command_line_arguments: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., file_path: Optional[pulumi.Input[_builtins.str]] = ..., friendly_name: Optional[pulumi.Input[_builtins.str]] = ..., icon_index: Optional[pulumi.Input[_builtins.int]] = ..., icon_path: Optional[pulumi.Input[_builtins.str]] = ..., msix_package_application_id: Optional[pulumi.Input[_builtins.str]] = ..., msix_package_family_name: Optional[pulumi.Input[_builtins.str]] = ..., show_in_portal: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def application_group_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def command_line_setting(self, value: pulumi.Input[Union[_builtins.str, CommandLineSetting]]): # -> None:
        ...
    ...
    def application_type(self, value: Optional[pulumi.Input[Union[_builtins.str, RemoteApplicationType]]]): # -> None:
        ...
    ...
    def command_line_arguments(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @icon_index.setter
    def icon_index(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @icon_path.setter
    def icon_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def msix_package_application_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def msix_package_family_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def show_in_portal(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class Application(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., application_group_name: Optional[pulumi.Input[_builtins.str]] = ..., application_name: Optional[pulumi.Input[_builtins.str]] = ..., application_type: Optional[pulumi.Input[Union[_builtins.str, RemoteApplicationType]]] = ..., command_line_arguments: Optional[pulumi.Input[_builtins.str]] = ..., command_line_setting: Optional[pulumi.Input[Union[_builtins.str, CommandLineSetting]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., file_path: Optional[pulumi.Input[_builtins.str]] = ..., friendly_name: Optional[pulumi.Input[_builtins.str]] = ..., icon_index: Optional[pulumi.Input[_builtins.int]] = ..., icon_path: Optional[pulumi.Input[_builtins.str]] = ..., msix_package_application_id: Optional[pulumi.Input[_builtins.str]] = ..., msix_package_family_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., show_in_portal: Optional[pulumi.Input[_builtins.bool]] = ..., __props__=...) -> None:
