...
class GetWorkspaceResult:
    ...
    def __init__(__self__, application_group_references=..., azure_api_version=..., cloud_pc_resource=..., description=..., etag=..., friendly_name=..., id=..., identity=..., kind=..., location=..., managed_by=..., name=..., object_id=..., plan=..., private_endpoint_connections=..., public_network_access=..., sku=..., system_data=..., tags=..., type=...) -> None:
        ...
