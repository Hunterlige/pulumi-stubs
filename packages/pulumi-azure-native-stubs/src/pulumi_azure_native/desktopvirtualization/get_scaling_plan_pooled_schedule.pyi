...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetScalingPlanPooledScheduleResult', 'AwaitableGetScalingPlanPooledScheduleResult', 'get_scaling_plan_pooled_schedule', 'get_scaling_plan_pooled_schedule_output']
@pulumi.output_type
class GetScalingPlanPooledScheduleResult:
    
    def __init__(__self__, azure_api_version=..., days_of_week=..., id=..., name=..., off_peak_load_balancing_algorithm=..., off_peak_start_time=..., peak_load_balancing_algorithm=..., peak_start_time=..., ramp_down_capacity_threshold_pct=..., ramp_down_force_logoff_users=..., ramp_down_load_balancing_algorithm=..., ramp_down_minimum_hosts_pct=..., ramp_down_notification_message=..., ramp_down_start_time=..., ramp_down_stop_hosts_when=..., ramp_down_wait_time_minutes=..., ramp_up_capacity_threshold_pct=..., ramp_up_load_balancing_algorithm=..., ramp_up_minimum_hosts_pct=..., ramp_up_start_time=..., system_data=..., type=...) -> None:
        ...
...
class AwaitableGetScalingPlanPooledScheduleResult(GetScalingPlanPooledScheduleResult):
    def __await__(self): # -> Generator[Never, Any, GetScalingPlanPooledScheduleResult]:
        ...
    


def get_scaling_plan_pooled_schedule(resource_group_name: Optional[_builtins.str] = ..., scaling_plan_name: Optional[_builtins.str] = ..., scaling_plan_schedule_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetScalingPlanPooledScheduleResult:
    
    ...

def get_scaling_plan_pooled_schedule_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., scaling_plan_name: Optional[pulumi.Input[_builtins.str]] = ..., scaling_plan_schedule_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetScalingPlanPooledScheduleResult]:
