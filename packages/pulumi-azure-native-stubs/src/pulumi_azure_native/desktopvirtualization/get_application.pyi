...
class GetApplicationResult:
    ...
    def __init__(__self__, application_type=..., azure_api_version=..., command_line_arguments=..., command_line_setting=..., description=..., file_path=..., friendly_name=..., icon_content=..., icon_hash=..., icon_index=..., icon_path=..., id=..., msix_package_application_id=..., msix_package_family_name=..., name=..., object_id=..., show_in_portal=..., system_data=..., type=...) -> None:
        ...
...
def get_application(application_group_name: Optional[_builtins.str] = ..., application_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetApplicationResult:
    
    ...

def get_application_output(application_group_name: Optional[pulumi.Input[_builtins.str]] = ..., application_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetApplicationResult]:
