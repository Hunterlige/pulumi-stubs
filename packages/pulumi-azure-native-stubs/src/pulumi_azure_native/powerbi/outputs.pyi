...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureSkuResponse', 'ConnectionStateResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'SystemDataResponse']
@pulumi.output_type
...
class PrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str, private_endpoint: Optional[outputs.PrivateEndpointResponse] = ..., private_link_service_connection_state: Optional[outputs.ConnectionStateResponse] = ..., provisioning_state: Optional[_builtins.str] = ...) -> None:
