...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ManagedServiceIdentityResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'RedisAccessKeysResponse', 'RedisCommonPropertiesRedisConfigurationResponse', 'RedisInstanceDetailsResponse', 'RedisLinkedServerResponse', 'ScheduleEntryResponse', 'SkuResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
...
class RedisAccessKeysResponse(dict):
    ...
    def __init__(__self__, *, primary_key: _builtins.str, secondary_key: _builtins.str) -> None:
...
class RedisCommonPropertiesRedisConfigurationResponse(dict):
    ...
    def __init__(__self__, *, maxclients: _builtins.str, preferred_data_archive_auth_method: _builtins.str, zonal_configuration: _builtins.str, aad_enabled: Optional[_builtins.str] = ..., aof_backup_enabled: Optional[_builtins.str] = ..., aof_storage_connection_string0: Optional[_builtins.str] = ..., aof_storage_connection_string1: Optional[_builtins.str] = ..., authnotrequired: Optional[_builtins.str] = ..., maxfragmentationmemory_reserved: Optional[_builtins.str] = ..., maxmemory_delta: Optional[_builtins.str] = ..., maxmemory_policy: Optional[_builtins.str] = ..., maxmemory_reserved: Optional[_builtins.str] = ..., notify_keyspace_events: Optional[_builtins.str] = ..., preferred_data_persistence_auth_method: Optional[_builtins.str] = ..., rdb_backup_enabled: Optional[_builtins.str] = ..., rdb_backup_frequency: Optional[_builtins.str] = ..., rdb_backup_max_snapshot_count: Optional[_builtins.str] = ..., rdb_storage_connection_string: Optional[_builtins.str] = ..., storage_subscription_id: Optional[_builtins.str] = ...) -> None:
...
class RedisInstanceDetailsResponse(dict):
    ...
    def __init__(__self__, *, is_master: _builtins.bool, is_primary: _builtins.bool, non_ssl_port: _builtins.int, shard_id: _builtins.int, ssl_port: _builtins.int, zone: _builtins.str) -> None:
...
class ScheduleEntryResponse(dict):
    ...
    def __init__(__self__, *, day_of_week: _builtins.str, start_hour_utc: _builtins.int, maintenance_window: Optional[_builtins.str] = ...) -> None:
...
class SkuResponse(dict):
    ...
    def __init__(__self__, *, capacity: _builtins.int, family: _builtins.str, name: _builtins.str) -> None:
