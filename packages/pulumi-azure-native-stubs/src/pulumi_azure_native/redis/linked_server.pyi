...
class LinkedServer(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: LinkedServerArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> LinkedServer:
    ...
    def primary_host_name(self) -> pulumi.Output[_builtins.str]:
