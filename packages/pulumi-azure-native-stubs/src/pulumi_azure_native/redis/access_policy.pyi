...
class AccessPolicyArgs:
    def __init__(__self__, *, cache_name: pulumi.Input[_builtins.str], permissions: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], access_policy_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AccessPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., access_policy_name: Optional[pulumi.Input[_builtins.str]] = ..., cache_name: Optional[pulumi.Input[_builtins.str]] = ..., permissions: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
