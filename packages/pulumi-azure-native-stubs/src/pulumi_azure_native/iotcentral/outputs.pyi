...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppSkuInfoResponse', 'NetworkRuleSetIpRuleResponse', 'NetworkRuleSetsResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'SystemAssignedServiceIdentityResponse', 'SystemDataResponse']
@pulumi.output_type
...
class NetworkRuleSetIpRuleResponse(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, filter_name: Optional[_builtins.str] = ..., ip_mask: Optional[_builtins.str] = ...) -> None:
...
class NetworkRuleSetsResponse(dict):
    ...
    def __init__(__self__, *, apply_to_devices: Optional[_builtins.bool] = ..., apply_to_io_t_central: Optional[_builtins.bool] = ..., default_action: Optional[_builtins.str] = ..., ip_rules: Optional[Sequence[outputs.NetworkRuleSetIpRuleResponse]] = ...) -> None:
