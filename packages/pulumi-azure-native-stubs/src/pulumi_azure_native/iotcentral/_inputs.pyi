...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppSkuInfoArgs', 'AppSkuInfoArgsDict', 'NetworkRuleSetIpRuleArgs', 'NetworkRuleSetIpRuleArgsDict', 'NetworkRuleSetsArgs', 'NetworkRuleSetsArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'SystemAssignedServiceIdentityArgs', 'SystemAssignedServiceIdentityArgsDict']
...
class AppSkuInfoArgs:
    def __init__(__self__, *, name: pulumi.Input[Union[_builtins.str, AppSku]]) -> None:
    ...
    @name.setter
    def name(self, value: pulumi.Input[Union[_builtins.str, AppSku]]): # -> None:
        ...
...
class NetworkRuleSetIpRuleArgs:
    def __init__(__self__, *, filter_name: Optional[pulumi.Input[_builtins.str]] = ..., ip_mask: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @filter_name.setter
    def filter_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NetworkRuleSetsArgs:
    def __init__(__self__, *, apply_to_devices: Optional[pulumi.Input[_builtins.bool]] = ..., apply_to_io_t_central: Optional[pulumi.Input[_builtins.bool]] = ..., default_action: Optional[pulumi.Input[Union[_builtins.str, NetworkAction]]] = ..., ip_rules: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkRuleSetIpRuleArgs]]]] = ...) -> None:
    ...
    def apply_to_devices(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def apply_to_io_t_central(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def default_action(self, value: Optional[pulumi.Input[Union[_builtins.str, NetworkAction]]]): # -> None:
        ...
    ...
    @ip_rules.setter
    def ip_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkRuleSetIpRuleArgs]]]]): # -> None:
        ...
