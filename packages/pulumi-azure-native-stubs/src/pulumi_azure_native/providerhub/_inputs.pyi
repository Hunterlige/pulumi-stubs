...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AdditionalAuthorizationArgs', 'AdditionalAuthorizationArgsDict', 'AllowedResourceNameArgs', 'AllowedResourceNameArgsDict', 'AllowedUnauthorizedActionsExtensionArgs', 'AllowedUnauthorizedActionsExtensionArgsDict', 'ApiProfileArgs', 'ApiProfileArgsDict', 'ApplicationDataAuthorizationArgs', 'ApplicationDataAuthorizationArgsDict', 'ApplicationProviderAuthorizationArgs', 'ApplicationProviderAuthorizationArgsDict', 'AsyncOperationPollingRulesArgs', 'AsyncOperationPollingRulesArgsDict', 'AsyncTimeoutRuleArgs', 'AsyncTimeoutRuleArgsDict', 'AuthorizationActionMappingArgs', 'AuthorizationActionMappingArgsDict', 'AuthorizedApplicationPropertiesArgs', 'AuthorizedApplicationPropertiesArgsDict', 'CustomRolloutPropertiesSpecificationArgs', 'CustomRolloutPropertiesSpecificationArgsDict', 'CustomRolloutPropertiesStatusArgs', 'CustomRolloutPropertiesStatusArgsDict', 'CustomRolloutPropertiesArgs', 'CustomRolloutPropertiesArgsDict', 'CustomRolloutSpecificationAutoProvisionConfigArgs', ..., 'CustomRolloutSpecificationCanaryArgs', 'CustomRolloutSpecificationCanaryArgsDict', 'CustomRolloutSpecificationProviderRegistrationArgs', ..., 'CustomRolloutStatusManifestCheckinStatusArgs', 'CustomRolloutStatusManifestCheckinStatusArgsDict', 'DefaultRolloutPropertiesSpecificationArgs', 'DefaultRolloutPropertiesSpecificationArgsDict', 'DefaultRolloutPropertiesStatusArgs', 'DefaultRolloutPropertiesStatusArgsDict', 'DefaultRolloutPropertiesArgs', 'DefaultRolloutPropertiesArgsDict', 'DefaultRolloutSpecificationAutoProvisionConfigArgs', ..., 'DefaultRolloutSpecificationCanaryArgs', 'DefaultRolloutSpecificationCanaryArgsDict', 'DefaultRolloutSpecificationExpeditedRolloutArgs', ..., 'DefaultRolloutSpecificationHighTrafficArgs', 'DefaultRolloutSpecificationHighTrafficArgsDict', 'DefaultRolloutSpecificationLowTrafficArgs', 'DefaultRolloutSpecificationLowTrafficArgsDict', 'DefaultRolloutSpecificationMediumTrafficArgs', 'DefaultRolloutSpecificationMediumTrafficArgsDict', ..., ..., ..., ..., ..., ..., 'DefaultRolloutStatusManifestCheckinStatusArgs', 'DefaultRolloutStatusManifestCheckinStatusArgsDict', 'DeleteDependencyArgs', 'DeleteDependencyArgsDict', 'EndpointInformationArgs', 'EndpointInformationArgsDict', 'ExtendedErrorInfoArgs', 'ExtendedErrorInfoArgsDict', 'ExtendedLocationOptionsArgs', 'ExtendedLocationOptionsArgsDict', 'FanoutLinkedNotificationRuleDstsConfigurationArgs', ..., 'FanoutLinkedNotificationRuleArgs', 'FanoutLinkedNotificationRuleArgsDict', 'FilterRuleArgs', 'FilterRuleArgsDict', 'LegacyDisallowedConditionArgs', 'LegacyDisallowedConditionArgsDict', 'LightHouseAuthorizationArgs', 'LightHouseAuthorizationArgsDict', 'LinkedAccessCheckArgs', 'LinkedAccessCheckArgsDict', 'LinkedNotificationRuleArgs', 'LinkedNotificationRuleArgsDict', 'LinkedOperationRuleArgs', 'LinkedOperationRuleArgsDict', 'LocationQuotaRuleArgs', 'LocationQuotaRuleArgsDict', 'LoggingRuleHiddenPropertyPathsArgs', 'LoggingRuleHiddenPropertyPathsArgsDict', 'LoggingRuleArgs', 'LoggingRuleArgsDict', 'NotificationEndpointArgs', 'NotificationEndpointArgsDict', 'NotificationRegistrationPropertiesArgs', 'NotificationRegistrationPropertiesArgsDict', 'NotificationArgs', 'NotificationArgsDict', 'OpenApiConfigurationArgs', 'OpenApiConfigurationArgsDict', 'OpenApiValidationArgs', 'OpenApiValidationArgsDict', 'ProviderHubMetadataProviderAuthenticationArgs', 'ProviderHubMetadataProviderAuthenticationArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'ProviderRegistrationPropertiesArgs', 'ProviderRegistrationPropertiesArgsDict', 'QuotaRuleArgs', 'QuotaRuleArgsDict', 'ResourceAccessRoleArgs', 'ResourceAccessRoleArgsDict', 'ResourceConcurrencyControlOptionArgs', 'ResourceConcurrencyControlOptionArgsDict', 'ResourceHydrationAccountArgs', 'ResourceHydrationAccountArgsDict', ..., ..., 'ResourceProviderAuthorizationRulesArgs', 'ResourceProviderAuthorizationRulesArgsDict', 'ResourceProviderAuthorizationArgs', 'ResourceProviderAuthorizationArgsDict', 'ResourceProviderCapabilitiesArgs', 'ResourceProviderCapabilitiesArgsDict', 'ResourceProviderEndpointFeaturesRuleArgs', 'ResourceProviderEndpointFeaturesRuleArgsDict', 'ResourceProviderEndpointArgs', 'ResourceProviderEndpointArgsDict', ..., ..., ..., ..., ..., ..., 'ResourceProviderManifestPropertiesFeaturesRuleArgs', ..., 'ResourceProviderManifestPropertiesManagementArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ResourceProviderServiceArgs', 'ResourceProviderServiceArgsDict', 'ResourceTypeEndpointDstsConfigurationArgs', 'ResourceTypeEndpointDstsConfigurationArgsDict', 'ResourceTypeEndpointFeaturesRuleArgs', 'ResourceTypeEndpointFeaturesRuleArgsDict', 'ResourceTypeEndpointArgs', 'ResourceTypeEndpointArgsDict', ..., ..., 'ResourceTypeExtensionArgs', 'ResourceTypeExtensionArgsDict', 'ResourceTypeOnBehalfOfTokenArgs', 'ResourceTypeOnBehalfOfTokenArgsDict', ..., ..., 'ResourceTypeRegistrationPropertiesCapacityRuleArgs', ..., ..., ..., ..., ..., ..., ..., 'ResourceTypeRegistrationPropertiesFeaturesRuleArgs', ..., ..., ..., 'ResourceTypeRegistrationPropertiesLegacyPolicyArgs', ..., 'ResourceTypeRegistrationPropertiesManagementArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ResourceTypeRegistrationPropertiesRoutingRuleArgs', ..., ..., ..., ..., ..., ..., ..., 'ResourceTypeRegistrationPropertiesArgs', 'ResourceTypeRegistrationPropertiesArgsDict', 'ResourceTypeRegistrationArgs', 'ResourceTypeRegistrationArgsDict', 'ServiceTreeInfoArgs', 'ServiceTreeInfoArgsDict', 'SkuCapabilityArgs', 'SkuCapabilityArgsDict', 'SkuCostArgs', 'SkuCostArgsDict', 'SkuLocationInfoArgs', 'SkuLocationInfoArgsDict', 'SkuResourcePropertiesArgs', 'SkuResourcePropertiesArgsDict', 'SkuSettingCapacityArgs', 'SkuSettingCapacityArgsDict', 'SkuSettingArgs', 'SkuSettingArgsDict', 'SkuZoneDetailArgs', 'SkuZoneDetailArgsDict', 'SubscriberSettingArgs', 'SubscriberSettingArgsDict', 'SubscriptionStateOverrideActionArgs', 'SubscriptionStateOverrideActionArgsDict', 'SubscriptionStateRuleArgs', 'SubscriptionStateRuleArgsDict', 'SwaggerSpecificationArgs', 'SwaggerSpecificationArgsDict', 'ThirdPartyExtensionArgs', 'ThirdPartyExtensionArgsDict', 'ThrottlingMetricArgs', 'ThrottlingMetricArgsDict', 'ThrottlingRuleArgs', 'ThrottlingRuleArgsDict', 'TokenAuthConfigurationArgs', 'TokenAuthConfigurationArgsDict', 'TypedErrorInfoArgs', 'TypedErrorInfoArgsDict']
...
class AdditionalAuthorizationArgs:
    def __init__(__self__, *, application_id: Optional[pulumi.Input[_builtins.str]] = ..., role_definition_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
...
class AllowedResourceNameArgs:
    def __init__(__self__, *, get_action_verb: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def get_action_verb(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AllowedUnauthorizedActionsExtensionArgs:
    def __init__(__self__, *, action: Optional[pulumi.Input[_builtins.str]] = ..., intent: Optional[pulumi.Input[Union[_builtins.str, Intent]]] = ...) -> None:
    ...
    @intent.setter
    def intent(self, value: Optional[pulumi.Input[Union[_builtins.str, Intent]]]): # -> None:
        ...
...
class ApiProfileArgs:
    def __init__(__self__, *, api_version: Optional[pulumi.Input[_builtins.str]] = ..., profile_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def profile_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApplicationDataAuthorizationArgs:
    def __init__(__self__, *, role: pulumi.Input[Union[_builtins.str, Role]], resource_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @role.setter
    def role(self, value: pulumi.Input[Union[_builtins.str, Role]]): # -> None:
        ...
...
class ApplicationProviderAuthorizationArgs:
    def __init__(__self__, *, managed_by_role_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., role_definition_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def managed_by_role_definition_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AsyncOperationPollingRulesArgs:
    def __init__(__self__, *, additional_options: Optional[pulumi.Input[Union[_builtins.str, AdditionalOptionsAsyncOperation]]] = ..., authorization_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def additional_options(self, value: Optional[pulumi.Input[Union[_builtins.str, AdditionalOptionsAsyncOperation]]]): # -> None:
        ...
    ...
    def authorization_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AsyncTimeoutRuleArgs:
    def __init__(__self__, *, action_name: Optional[pulumi.Input[_builtins.str]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @action_name.setter
    def action_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AuthorizationActionMappingArgs:
    def __init__(__self__, *, desired: Optional[pulumi.Input[_builtins.str]] = ..., original: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @desired.setter
    def desired(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @original.setter
    def original(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AuthorizedApplicationPropertiesArgs:
    def __init__(__self__, *, data_authorizations: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationDataAuthorizationArgs]]]] = ..., provider_authorization: Optional[pulumi.Input[ApplicationProviderAuthorizationArgs]] = ...) -> None:
    ...
    def data_authorizations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationDataAuthorizationArgs]]]]): # -> None:
        ...
    ...
    def provider_authorization(self, value: Optional[pulumi.Input[ApplicationProviderAuthorizationArgs]]): # -> None:
        ...
...
class CustomRolloutPropertiesSpecificationArgs:
    def __init__(__self__, *, auto_provision_config: Optional[pulumi.Input[CustomRolloutSpecificationAutoProvisionConfigArgs]] = ..., canary: Optional[pulumi.Input[CustomRolloutSpecificationCanaryArgs]] = ..., provider_registration: Optional[pulumi.Input[CustomRolloutSpecificationProviderRegistrationArgs]] = ..., refresh_subscription_registration: Optional[pulumi.Input[_builtins.bool]] = ..., release_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., resource_type_registrations: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceTypeRegistrationArgs]]]] = ..., skip_release_scope_validation: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def auto_provision_config(self, value: Optional[pulumi.Input[CustomRolloutSpecificationAutoProvisionConfigArgs]]): # -> None:
        ...
    ...
    @canary.setter
    def canary(self, value: Optional[pulumi.Input[CustomRolloutSpecificationCanaryArgs]]): # -> None:
        ...
    ...
    def provider_registration(self, value: Optional[pulumi.Input[CustomRolloutSpecificationProviderRegistrationArgs]]): # -> None:
        ...
    ...
    def refresh_subscription_registration(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def release_scopes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def resource_type_registrations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceTypeRegistrationArgs]]]]): # -> None:
        ...
    ...
    def skip_release_scope_validation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class CustomRolloutPropertiesStatusArgs:
    def __init__(__self__, *, completed_regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., failed_or_skipped_regions: Optional[pulumi.Input[Mapping[str, pulumi.Input[ExtendedErrorInfoArgs]]]] = ..., manifest_checkin_status: Optional[pulumi.Input[CustomRolloutStatusManifestCheckinStatusArgs]] = ...) -> None:
    ...
    def completed_regions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def failed_or_skipped_regions(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[ExtendedErrorInfoArgs]]]]): # -> None:
        ...
    ...
    def manifest_checkin_status(self, value: Optional[pulumi.Input[CustomRolloutStatusManifestCheckinStatusArgs]]): # -> None:
        ...
...
class CustomRolloutPropertiesArgs:
    def __init__(__self__, *, specification: pulumi.Input[CustomRolloutPropertiesSpecificationArgs], status: Optional[pulumi.Input[CustomRolloutPropertiesStatusArgs]] = ...) -> None:
    ...
    def specification(self, value: pulumi.Input[CustomRolloutPropertiesSpecificationArgs]): # -> None:
        ...
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[CustomRolloutPropertiesStatusArgs]]): # -> None:
        ...
...
class CustomRolloutSpecificationAutoProvisionConfigArgs:
    def __init__(__self__, *, resource_graph: Optional[pulumi.Input[_builtins.bool]] = ..., storage: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def resource_graph(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @storage.setter
    def storage(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class CustomRolloutSpecificationCanaryArgs:
    def __init__(__self__, *, regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class CustomRolloutSpecificationProviderRegistrationArgs:
    def __init__(__self__, *, kind: Optional[pulumi.Input[Union[_builtins.str, ProviderRegistrationKind]]] = ..., properties: Optional[pulumi.Input[ProviderRegistrationPropertiesArgs]] = ...) -> None:
...
class CustomRolloutStatusManifestCheckinStatusArgs:
    def __init__(__self__, *, is_checked_in: pulumi.Input[_builtins.bool], status_message: pulumi.Input[_builtins.str], commit_id: Optional[pulumi.Input[_builtins.str]] = ..., pull_request: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def is_checked_in(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def status_message(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @commit_id.setter
    def commit_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @pull_request.setter
    def pull_request(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DefaultRolloutPropertiesSpecificationArgs:
    def __init__(__self__, *, auto_provision_config: Optional[pulumi.Input[DefaultRolloutSpecificationAutoProvisionConfigArgs]] = ..., canary: Optional[pulumi.Input[DefaultRolloutSpecificationCanaryArgs]] = ..., expedited_rollout: Optional[pulumi.Input[DefaultRolloutSpecificationExpeditedRolloutArgs]] = ..., high_traffic: Optional[pulumi.Input[DefaultRolloutSpecificationHighTrafficArgs]] = ..., low_traffic: Optional[pulumi.Input[DefaultRolloutSpecificationLowTrafficArgs]] = ..., medium_traffic: Optional[pulumi.Input[DefaultRolloutSpecificationMediumTrafficArgs]] = ..., provider_registration: Optional[pulumi.Input[DefaultRolloutSpecificationProviderRegistrationArgs]] = ..., resource_type_registrations: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceTypeRegistrationArgs]]]] = ..., rest_of_the_world_group_one: Optional[pulumi.Input[DefaultRolloutSpecificationRestOfTheWorldGroupOneArgs]] = ..., rest_of_the_world_group_two: Optional[pulumi.Input[DefaultRolloutSpecificationRestOfTheWorldGroupTwoArgs]] = ...) -> None:
    ...
    @auto_provision_config.setter
    def auto_provision_config(self, value: Optional[pulumi.Input[DefaultRolloutSpecificationAutoProvisionConfigArgs]]): # -> None:
        ...
    ...
    @canary.setter
    def canary(self, value: Optional[pulumi.Input[DefaultRolloutSpecificationCanaryArgs]]): # -> None:
        ...
    ...
    def expedited_rollout(self, value: Optional[pulumi.Input[DefaultRolloutSpecificationExpeditedRolloutArgs]]): # -> None:
        ...
    ...
    @high_traffic.setter
    def high_traffic(self, value: Optional[pulumi.Input[DefaultRolloutSpecificationHighTrafficArgs]]): # -> None:
        ...
    ...
    @low_traffic.setter
    def low_traffic(self, value: Optional[pulumi.Input[DefaultRolloutSpecificationLowTrafficArgs]]): # -> None:
        ...
    ...
    def medium_traffic(self, value: Optional[pulumi.Input[DefaultRolloutSpecificationMediumTrafficArgs]]): # -> None:
        ...
    ...
    @provider_registration.setter
    def provider_registration(self, value: Optional[pulumi.Input[DefaultRolloutSpecificationProviderRegistrationArgs]]): # -> None:
        ...
    ...
    def rest_of_the_world_group_one(self, value: Optional[pulumi.Input[DefaultRolloutSpecificationRestOfTheWorldGroupOneArgs]]): # -> None:
        ...
    ...
    def rest_of_the_world_group_two(self, value: Optional[pulumi.Input[DefaultRolloutSpecificationRestOfTheWorldGroupTwoArgs]]): # -> None:
        ...
...
class DefaultRolloutPropertiesStatusArgs:
    def __init__(__self__, *, completed_regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., failed_or_skipped_regions: Optional[pulumi.Input[Mapping[str, pulumi.Input[ExtendedErrorInfoArgs]]]] = ..., manifest_checkin_status: Optional[pulumi.Input[DefaultRolloutStatusManifestCheckinStatusArgs]] = ..., next_traffic_region: Optional[pulumi.Input[Union[_builtins.str, TrafficRegionCategory]]] = ..., next_traffic_region_scheduled_time: Optional[pulumi.Input[_builtins.str]] = ..., subscription_reregistration_result: Optional[pulumi.Input[Union[_builtins.str, SubscriptionReregistrationResult]]] = ...) -> None:
    ...
    @manifest_checkin_status.setter
    def manifest_checkin_status(self, value: Optional[pulumi.Input[DefaultRolloutStatusManifestCheckinStatusArgs]]): # -> None:
        ...
    ...
    def next_traffic_region(self, value: Optional[pulumi.Input[Union[_builtins.str, TrafficRegionCategory]]]): # -> None:
        ...
    ...
    def next_traffic_region_scheduled_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def subscription_reregistration_result(self, value: Optional[pulumi.Input[Union[_builtins.str, SubscriptionReregistrationResult]]]): # -> None:
        ...
...
class DefaultRolloutPropertiesArgs:
    def __init__(__self__, *, specification: Optional[pulumi.Input[DefaultRolloutPropertiesSpecificationArgs]] = ..., status: Optional[pulumi.Input[DefaultRolloutPropertiesStatusArgs]] = ...) -> None:
    ...
    @specification.setter
    def specification(self, value: Optional[pulumi.Input[DefaultRolloutPropertiesSpecificationArgs]]): # -> None:
        ...
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[DefaultRolloutPropertiesStatusArgs]]): # -> None:
        ...
...
class DefaultRolloutSpecificationCanaryArgs:
    def __init__(__self__, *, regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., skip_regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @skip_regions.setter
    def skip_regions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DefaultRolloutSpecificationHighTrafficArgs:
    def __init__(__self__, *, regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., wait_duration: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def wait_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DeleteDependencyArgs:
    def __init__(__self__, *, linked_property: Optional[pulumi.Input[_builtins.str]] = ..., linked_type: Optional[pulumi.Input[_builtins.str]] = ..., required_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def linked_property(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @linked_type.setter
    def linked_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def required_features(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EndpointInformationArgs:
    def __init__(__self__, *, endpoint: Optional[pulumi.Input[_builtins.str]] = ..., endpoint_type: Optional[pulumi.Input[Union[_builtins.str, NotificationEndpointType]]] = ..., schema_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def endpoint_type(self, value: Optional[pulumi.Input[Union[_builtins.str, NotificationEndpointType]]]): # -> None:
        ...
    ...
    def schema_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ExtendedErrorInfoArgs:
    def __init__(__self__, *, additional_info: Optional[pulumi.Input[Sequence[pulumi.Input[TypedErrorInfoArgs]]]] = ..., code: Optional[pulumi.Input[_builtins.str]] = ..., details: Optional[pulumi.Input[Sequence[pulumi.Input[ExtendedErrorInfoArgs]]]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ..., target: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def additional_info(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TypedErrorInfoArgs]]]]): # -> None:
        ...
    ...
    @details.setter
    def details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExtendedErrorInfoArgs]]]]): # -> None:
        ...
...
class ExtendedLocationOptionsArgs:
    def __init__(__self__, *, supported_policy: Optional[pulumi.Input[Union[_builtins.str, ResourceTypeExtendedLocationPolicy]]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, ExtendedLocationType]]] = ...) -> None:
    ...
    def supported_policy(self, value: Optional[pulumi.Input[Union[_builtins.str, ResourceTypeExtendedLocationPolicy]]]): # -> None:
        ...
...
class FanoutLinkedNotificationRuleDstsConfigurationArgs:
    def __init__(__self__, *, service_name: pulumi.Input[_builtins.str], service_dns_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def service_dns_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FanoutLinkedNotificationRuleArgs:
    def __init__(__self__, *, actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., dsts_configuration: Optional[pulumi.Input[FanoutLinkedNotificationRuleDstsConfigurationArgs]] = ..., endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderEndpointArgs]]]] = ..., token_auth_configuration: Optional[pulumi.Input[TokenAuthConfigurationArgs]] = ...) -> None:
    ...
    def dsts_configuration(self, value: Optional[pulumi.Input[FanoutLinkedNotificationRuleDstsConfigurationArgs]]): # -> None:
        ...
    ...
    @endpoints.setter
    def endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderEndpointArgs]]]]): # -> None:
        ...
    ...
    def token_auth_configuration(self, value: Optional[pulumi.Input[TokenAuthConfigurationArgs]]): # -> None:
        ...
...
class FilterRuleArgs:
    def __init__(__self__, *, endpoint_information: Optional[pulumi.Input[Sequence[pulumi.Input[EndpointInformationArgs]]]] = ..., filter_query: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def endpoint_information(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EndpointInformationArgs]]]]): # -> None:
        ...
    ...
    @filter_query.setter
    def filter_query(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LegacyDisallowedConditionArgs:
    def __init__(__self__, *, disallowed_legacy_operations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, LegacyOperation]]]]] = ..., feature: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disallowed_legacy_operations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, LegacyOperation]]]]]): # -> None:
        ...
    ...
    @feature.setter
    def feature(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LinkedAccessCheckArgs:
    def __init__(__self__, *, action_name: Optional[pulumi.Input[_builtins.str]] = ..., linked_action: Optional[pulumi.Input[_builtins.str]] = ..., linked_action_verb: Optional[pulumi.Input[_builtins.str]] = ..., linked_property: Optional[pulumi.Input[_builtins.str]] = ..., linked_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def linked_action(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def linked_action_verb(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LinkedNotificationRuleArgs:
    def __init__(__self__, *, actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., actions_on_failed_operation: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., fast_path_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., fast_path_actions_on_failed_operation: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., linked_notification_timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def actions_on_failed_operation(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def fast_path_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def fast_path_actions_on_failed_operation(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def linked_notification_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LinkedOperationRuleArgs:
    def __init__(__self__, *, linked_action: pulumi.Input[Union[_builtins.str, LinkedAction]], linked_operation: pulumi.Input[Union[_builtins.str, LinkedOperation]], depends_on_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @linked_action.setter
    def linked_action(self, value: pulumi.Input[Union[_builtins.str, LinkedAction]]): # -> None:
        ...
    ...
    def linked_operation(self, value: pulumi.Input[Union[_builtins.str, LinkedOperation]]): # -> None:
        ...
    ...
    def depends_on_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class LocationQuotaRuleArgs:
    def __init__(__self__, *, location: Optional[pulumi.Input[_builtins.str]] = ..., policy: Optional[pulumi.Input[Union[_builtins.str, QuotaPolicy]]] = ..., quota_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @policy.setter
    def policy(self, value: Optional[pulumi.Input[Union[_builtins.str, QuotaPolicy]]]): # -> None:
        ...
...
class LoggingRuleHiddenPropertyPathsArgs:
    def __init__(__self__, *, hidden_paths_on_request: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., hidden_paths_on_response: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def hidden_paths_on_request(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def hidden_paths_on_response(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class LoggingRuleArgs:
    def __init__(__self__, *, action: pulumi.Input[_builtins.str], detail_level: pulumi.Input[Union[_builtins.str, LoggingDetails]], direction: pulumi.Input[Union[_builtins.str, LoggingDirections]], hidden_property_paths: Optional[pulumi.Input[LoggingRuleHiddenPropertyPathsArgs]] = ...) -> None:
    ...
    @detail_level.setter
    def detail_level(self, value: pulumi.Input[Union[_builtins.str, LoggingDetails]]): # -> None:
        ...
    ...
    @direction.setter
    def direction(self, value: pulumi.Input[Union[_builtins.str, LoggingDirections]]): # -> None:
        ...
    ...
    def hidden_property_paths(self, value: Optional[pulumi.Input[LoggingRuleHiddenPropertyPathsArgs]]): # -> None:
        ...
...
class NotificationEndpointArgs:
    def __init__(__self__, *, locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., notification_destination: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def notification_destination(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NotificationRegistrationPropertiesArgs:
    def __init__(__self__, *, included_events: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., message_scope: Optional[pulumi.Input[Union[_builtins.str, MessageScope]]] = ..., notification_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[NotificationEndpointArgs]]]] = ..., notification_mode: Optional[pulumi.Input[Union[_builtins.str, NotificationMode]]] = ...) -> None:
    ...
    def included_events(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def message_scope(self, value: Optional[pulumi.Input[Union[_builtins.str, MessageScope]]]): # -> None:
        ...
    ...
    def notification_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NotificationEndpointArgs]]]]): # -> None:
        ...
    ...
    def notification_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, NotificationMode]]]): # -> None:
        ...
...
class NotificationArgs:
    def __init__(__self__, *, notification_type: Optional[pulumi.Input[Union[_builtins.str, NotificationType]]] = ..., skip_notifications: Optional[pulumi.Input[Union[_builtins.str, SkipNotifications]]] = ...) -> None:
    ...
    def notification_type(self, value: Optional[pulumi.Input[Union[_builtins.str, NotificationType]]]): # -> None:
        ...
    ...
    def skip_notifications(self, value: Optional[pulumi.Input[Union[_builtins.str, SkipNotifications]]]): # -> None:
        ...
...
class OpenApiConfigurationArgs:
    def __init__(__self__, *, validation: Optional[pulumi.Input[OpenApiValidationArgs]] = ...) -> None:
    ...
    @validation.setter
    def validation(self, value: Optional[pulumi.Input[OpenApiValidationArgs]]): # -> None:
        ...
...
class OpenApiValidationArgs:
    def __init__(__self__, *, allow_noncompliant_collection_response: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def allow_noncompliant_collection_response(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ProviderHubMetadataProviderAuthenticationArgs:
    def __init__(__self__, *, allowed_audiences: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def allowed_audiences(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class ProviderHubMetadataThirdPartyProviderAuthorizationArgs:
    def __init__(__self__, *, authorizations: Optional[pulumi.Input[Sequence[pulumi.Input[LightHouseAuthorizationArgs]]]] = ..., managed_by_tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authorizations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LightHouseAuthorizationArgs]]]]): # -> None:
        ...
    ...
    def managed_by_tenant_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ProviderRegistrationPropertiesPrivateResourceProviderConfigurationArgs:
    def __init__(__self__, *, allowed_subscriptions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allowed_subscriptions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ProviderRegistrationPropertiesProviderHubMetadataArgs:
    def __init__(__self__, *, direct_rp_role_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., global_async_operation_resource_type_name: Optional[pulumi.Input[_builtins.str]] = ..., provider_authentication: Optional[pulumi.Input[ProviderHubMetadataProviderAuthenticationArgs]] = ..., provider_authorizations: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderAuthorizationArgs]]]] = ..., regional_async_operation_resource_type_name: Optional[pulumi.Input[_builtins.str]] = ..., third_party_provider_authorization: Optional[pulumi.Input[ProviderHubMetadataThirdPartyProviderAuthorizationArgs]] = ...) -> None:
    ...
    def direct_rp_role_definition_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def global_async_operation_resource_type_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def provider_authentication(self, value: Optional[pulumi.Input[ProviderHubMetadataProviderAuthenticationArgs]]): # -> None:
        ...
    ...
    def provider_authorizations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderAuthorizationArgs]]]]): # -> None:
        ...
    ...
    def regional_async_operation_resource_type_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def third_party_provider_authorization(self, value: Optional[pulumi.Input[ProviderHubMetadataThirdPartyProviderAuthorizationArgs]]): # -> None:
        ...
...
class ProviderRegistrationPropertiesSubscriptionLifecycleNotificationSpecificationsArgs:
    def __init__(__self__, *, soft_delete_ttl: Optional[pulumi.Input[_builtins.str]] = ..., subscription_state_override_actions: Optional[pulumi.Input[Sequence[pulumi.Input[SubscriptionStateOverrideActionArgs]]]] = ...) -> None:
    ...
    def soft_delete_ttl(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def subscription_state_override_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SubscriptionStateOverrideActionArgs]]]]): # -> None:
        ...
...
class ProviderRegistrationPropertiesArgs:
    def __init__(__self__, *, capabilities: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderCapabilitiesArgs]]]] = ..., cross_tenant_token_validation: Optional[pulumi.Input[Union[_builtins.str, CrossTenantTokenValidation]]] = ..., custom_manifest_version: Optional[pulumi.Input[_builtins.str]] = ..., dsts_configuration: Optional[pulumi.Input[ResourceProviderManifestPropertiesDstsConfigurationArgs]] = ..., enable_tenant_linked_notification: Optional[pulumi.Input[_builtins.bool]] = ..., features_rule: Optional[pulumi.Input[ResourceProviderManifestPropertiesFeaturesRuleArgs]] = ..., global_notification_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderEndpointArgs]]]] = ..., legacy_namespace: Optional[pulumi.Input[_builtins.str]] = ..., legacy_registrations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., linked_notification_rules: Optional[pulumi.Input[Sequence[pulumi.Input[FanoutLinkedNotificationRuleArgs]]]] = ..., management: Optional[pulumi.Input[ResourceProviderManifestPropertiesManagementArgs]] = ..., management_group_global_notification_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderEndpointArgs]]]] = ..., metadata: Optional[Any] = ..., namespace: Optional[pulumi.Input[_builtins.str]] = ..., notification_options: Optional[pulumi.Input[Union[_builtins.str, NotificationOptions]]] = ..., notification_settings: Optional[pulumi.Input[ResourceProviderManifestPropertiesNotificationSettingsArgs]] = ..., notifications: Optional[pulumi.Input[Sequence[pulumi.Input[NotificationArgs]]]] = ..., optional_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., private_resource_provider_configuration: Optional[pulumi.Input[ProviderRegistrationPropertiesPrivateResourceProviderConfigurationArgs]] = ..., provider_authentication: Optional[pulumi.Input[ResourceProviderManifestPropertiesProviderAuthenticationArgs]] = ..., provider_authorizations: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderAuthorizationArgs]]]] = ..., provider_hub_metadata: Optional[pulumi.Input[ProviderRegistrationPropertiesProviderHubMetadataArgs]] = ..., provider_type: Optional[pulumi.Input[Union[_builtins.str, ResourceProviderType]]] = ..., provider_version: Optional[pulumi.Input[_builtins.str]] = ..., request_header_options: Optional[pulumi.Input[ResourceProviderManifestPropertiesRequestHeaderOptionsArgs]] = ..., required_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., resource_group_lock_option_during_move: Optional[pulumi.Input[ResourceProviderManifestPropertiesResourceGroupLockOptionDuringMoveArgs]] = ..., resource_hydration_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceHydrationAccountArgs]]]] = ..., resource_provider_authorization_rules: Optional[pulumi.Input[ResourceProviderAuthorizationRulesArgs]] = ..., response_options: Optional[pulumi.Input[ResourceProviderManifestPropertiesResponseOptionsArgs]] = ..., service_name: Optional[pulumi.Input[_builtins.str]] = ..., services: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderServiceArgs]]]] = ..., subscription_lifecycle_notification_specifications: Optional[pulumi.Input[ProviderRegistrationPropertiesSubscriptionLifecycleNotificationSpecificationsArgs]] = ..., template_deployment_options: Optional[pulumi.Input[ResourceProviderManifestPropertiesTemplateDeploymentOptionsArgs]] = ..., token_auth_configuration: Optional[pulumi.Input[TokenAuthConfigurationArgs]] = ...) -> None:
    ...
    @capabilities.setter
    def capabilities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderCapabilitiesArgs]]]]): # -> None:
        ...
    ...
    def cross_tenant_token_validation(self, value: Optional[pulumi.Input[Union[_builtins.str, CrossTenantTokenValidation]]]): # -> None:
        ...
    ...
    def custom_manifest_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @dsts_configuration.setter
    def dsts_configuration(self, value: Optional[pulumi.Input[ResourceProviderManifestPropertiesDstsConfigurationArgs]]): # -> None:
        ...
    ...
    def enable_tenant_linked_notification(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def features_rule(self, value: Optional[pulumi.Input[ResourceProviderManifestPropertiesFeaturesRuleArgs]]): # -> None:
        ...
    ...
    def global_notification_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderEndpointArgs]]]]): # -> None:
        ...
    ...
    def legacy_namespace(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def legacy_registrations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def linked_notification_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FanoutLinkedNotificationRuleArgs]]]]): # -> None:
        ...
    ...
    @management.setter
    def management(self, value: Optional[pulumi.Input[ResourceProviderManifestPropertiesManagementArgs]]): # -> None:
        ...
    ...
    def management_group_global_notification_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderEndpointArgs]]]]): # -> None:
        ...
    ...
    def notification_options(self, value: Optional[pulumi.Input[Union[_builtins.str, NotificationOptions]]]): # -> None:
        ...
    ...
    def notification_settings(self, value: Optional[pulumi.Input[ResourceProviderManifestPropertiesNotificationSettingsArgs]]): # -> None:
        ...
    ...
    def notifications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NotificationArgs]]]]): # -> None:
        ...
    ...
    def optional_features(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def private_resource_provider_configuration(self, value: Optional[pulumi.Input[ProviderRegistrationPropertiesPrivateResourceProviderConfigurationArgs]]): # -> None:
        ...
    ...
    @provider_authentication.setter
    def provider_authentication(self, value: Optional[pulumi.Input[ResourceProviderManifestPropertiesProviderAuthenticationArgs]]): # -> None:
        ...
    ...
    def provider_hub_metadata(self, value: Optional[pulumi.Input[ProviderRegistrationPropertiesProviderHubMetadataArgs]]): # -> None:
        ...
    ...
    def provider_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ResourceProviderType]]]): # -> None:
        ...
    ...
    def provider_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def request_header_options(self, value: Optional[pulumi.Input[ResourceProviderManifestPropertiesRequestHeaderOptionsArgs]]): # -> None:
        ...
    ...
    def resource_group_lock_option_during_move(self, value: Optional[pulumi.Input[ResourceProviderManifestPropertiesResourceGroupLockOptionDuringMoveArgs]]): # -> None:
        ...
    ...
    def resource_hydration_accounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceHydrationAccountArgs]]]]): # -> None:
        ...
    ...
    def resource_provider_authorization_rules(self, value: Optional[pulumi.Input[ResourceProviderAuthorizationRulesArgs]]): # -> None:
        ...
    ...
    def response_options(self, value: Optional[pulumi.Input[ResourceProviderManifestPropertiesResponseOptionsArgs]]): # -> None:
        ...
    ...
    @services.setter
    def services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceProviderServiceArgs]]]]): # -> None:
        ...
    ...
    def subscription_lifecycle_notification_specifications(self, value: Optional[pulumi.Input[ProviderRegistrationPropertiesSubscriptionLifecycleNotificationSpecificationsArgs]]): # -> None:
        ...
    ...
    def template_deployment_options(self, value: Optional[pulumi.Input[ResourceProviderManifestPropertiesTemplateDeploymentOptionsArgs]]): # -> None:
        ...
...
@pulumi.input_type
class QuotaRuleArgs:
    def __init__(__self__, *, location_rules: Optional[pulumi.Input[Sequence[pulumi.Input[LocationQuotaRuleArgs]]]] = ..., quota_policy: Optional[pulumi.Input[Union[_builtins.str, QuotaPolicy]]] = ..., required_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def location_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LocationQuotaRuleArgs]]]]): # -> None:
        ...
    ...
    @quota_policy.setter
    def quota_policy(self, value: Optional[pulumi.Input[Union[_builtins.str, QuotaPolicy]]]): # -> None:
        ...
...
class ResourceAccessRoleArgs:
    def __init__(__self__, *, actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allowed_group_claims: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allowed_group_claims(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ResourceConcurrencyControlOptionArgs:
    def __init__(__self__, *, policy: Optional[pulumi.Input[Union[_builtins.str, Policy]]] = ...) -> None:
    ...
    @policy.setter
    def policy(self, value: Optional[pulumi.Input[Union[_builtins.str, Policy]]]): # -> None:
        ...
...
class ResourceHydrationAccountArgs:
    def __init__(__self__, *, account_name: Optional[pulumi.Input[_builtins.str]] = ..., encrypted_key: Optional[pulumi.Input[_builtins.str]] = ..., max_child_resource_consistency_job_limit: Optional[pulumi.Input[_builtins.float]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def encrypted_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_child_resource_consistency_job_limit(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class ResourceProviderAuthorizationManagedByAuthorizationArgs:
    def __init__(__self__, *, additional_authorizations: Optional[pulumi.Input[Sequence[pulumi.Input[AdditionalAuthorizationArgs]]]] = ..., allow_managed_by_inheritance: Optional[pulumi.Input[_builtins.bool]] = ..., managed_by_resource_role_definition_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def additional_authorizations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AdditionalAuthorizationArgs]]]]): # -> None:
        ...
    ...
    def allow_managed_by_inheritance(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def managed_by_resource_role_definition_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResourceProviderAuthorizationRulesArgs:
    def __init__(__self__, *, async_operation_polling_rules: Optional[pulumi.Input[AsyncOperationPollingRulesArgs]] = ...) -> None:
    ...
    def async_operation_polling_rules(self, value: Optional[pulumi.Input[AsyncOperationPollingRulesArgs]]): # -> None:
        ...
...
class ResourceProviderAuthorizationArgs:
    def __init__(__self__, *, allowed_third_party_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[ThirdPartyExtensionArgs]]]] = ..., application_id: Optional[pulumi.Input[_builtins.str]] = ..., grouping_tag: Optional[pulumi.Input[_builtins.str]] = ..., managed_by_authorization: Optional[pulumi.Input[ResourceProviderAuthorizationManagedByAuthorizationArgs]] = ..., managed_by_role_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., role_definition_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allowed_third_party_extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ThirdPartyExtensionArgs]]]]): # -> None:
        ...
    ...
    @grouping_tag.setter
    def grouping_tag(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def managed_by_authorization(self, value: Optional[pulumi.Input[ResourceProviderAuthorizationManagedByAuthorizationArgs]]): # -> None:
        ...
...
class ResourceProviderCapabilitiesArgs:
    def __init__(__self__, *, effect: pulumi.Input[Union[_builtins.str, ResourceProviderCapabilitiesEffect]], quota_id: pulumi.Input[_builtins.str], required_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @effect.setter
    def effect(self, value: pulumi.Input[Union[_builtins.str, ResourceProviderCapabilitiesEffect]]): # -> None:
        ...
    ...
    @quota_id.setter
    def quota_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ResourceProviderEndpointFeaturesRuleArgs:
    def __init__(__self__, *, required_features_policy: pulumi.Input[Union[_builtins.str, FeaturesPolicy]]) -> None:
    ...
    def required_features_policy(self, value: pulumi.Input[Union[_builtins.str, FeaturesPolicy]]): # -> None:
        ...
...
class ResourceProviderEndpointArgs:
    def __init__(__self__, *, api_versions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., endpoint_type: Optional[pulumi.Input[Union[_builtins.str, EndpointType]]] = ..., endpoint_uri: Optional[pulumi.Input[_builtins.str]] = ..., features_rule: Optional[pulumi.Input[ResourceProviderEndpointFeaturesRuleArgs]] = ..., locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., required_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., sku_link: Optional[pulumi.Input[_builtins.str]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @api_versions.setter
    def api_versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @features_rule.setter
    def features_rule(self, value: Optional[pulumi.Input[ResourceProviderEndpointFeaturesRuleArgs]]): # -> None:
        ...
    ...
    @sku_link.setter
    def sku_link(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResourceProviderManagementErrorResponseMessageOptionsArgs:
    def __init__(__self__, *, server_failure_response_message_type: Optional[pulumi.Input[Union[_builtins.str, ServerFailureResponseMessageType]]] = ...) -> None:
    ...
    def server_failure_response_message_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ServerFailureResponseMessageType]]]): # -> None:
        ...
...
class ResourceProviderManagementExpeditedRolloutMetadataArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., expedited_rollout_intent: Optional[pulumi.Input[Union[_builtins.str, ExpeditedRolloutIntent]]] = ...) -> None:
    ...
    def expedited_rollout_intent(self, value: Optional[pulumi.Input[Union[_builtins.str, ExpeditedRolloutIntent]]]): # -> None:
        ...
...
class ResourceProviderManifestPropertiesManagementArgs:
    def __init__(__self__, *, authorization_owners: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., canary_manifest_owners: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., error_response_message_options: Optional[pulumi.Input[ResourceProviderManagementErrorResponseMessageOptionsArgs]] = ..., expedited_rollout_metadata: Optional[pulumi.Input[ResourceProviderManagementExpeditedRolloutMetadataArgs]] = ..., expedited_rollout_submitters: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., incident_contact_email: Optional[pulumi.Input[_builtins.str]] = ..., incident_routing_service: Optional[pulumi.Input[_builtins.str]] = ..., incident_routing_team: Optional[pulumi.Input[_builtins.str]] = ..., manifest_owners: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., pc_code: Optional[pulumi.Input[_builtins.str]] = ..., profit_center_program_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_access_policy: Optional[pulumi.Input[ResourceAccessPolicy]] = ..., resource_access_roles: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceAccessRoleArgs]]]] = ..., schema_owners: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., service_tree_infos: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTreeInfoArgs]]]] = ...) -> None:
    ...
    def authorization_owners(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def canary_manifest_owners(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def error_response_message_options(self, value: Optional[pulumi.Input[ResourceProviderManagementErrorResponseMessageOptionsArgs]]): # -> None:
        ...
    ...
    def expedited_rollout_metadata(self, value: Optional[pulumi.Input[ResourceProviderManagementExpeditedRolloutMetadataArgs]]): # -> None:
        ...
    ...
    def expedited_rollout_submitters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def incident_contact_email(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def incident_routing_service(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def incident_routing_team(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def manifest_owners(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @pc_code.setter
    def pc_code(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def profit_center_program_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def resource_access_policy(self, value: Optional[pulumi.Input[ResourceAccessPolicy]]): # -> None:
        ...
    ...
    def resource_access_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceAccessRoleArgs]]]]): # -> None:
        ...
    ...
    def schema_owners(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def service_tree_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTreeInfoArgs]]]]): # -> None:
        ...
...
class ResourceProviderManifestPropertiesNotificationSettingsArgs:
    def __init__(__self__, *, subscriber_settings: Optional[pulumi.Input[Sequence[pulumi.Input[SubscriberSettingArgs]]]] = ...) -> None:
    ...
    def subscriber_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SubscriberSettingArgs]]]]): # -> None:
        ...
...
class ResourceProviderManifestPropertiesRequestHeaderOptionsArgs:
    def __init__(__self__, *, opt_in_headers: Optional[pulumi.Input[Union[_builtins.str, OptInHeaderType]]] = ..., opt_out_headers: Optional[pulumi.Input[Union[_builtins.str, OptOutHeaderType]]] = ...) -> None:
    ...
    def opt_in_headers(self, value: Optional[pulumi.Input[Union[_builtins.str, OptInHeaderType]]]): # -> None:
        ...
    ...
    def opt_out_headers(self, value: Optional[pulumi.Input[Union[_builtins.str, OptOutHeaderType]]]): # -> None:
        ...
...
class ResourceProviderManifestPropertiesResourceGroupLockOptionDuringMoveArgs:
    def __init__(__self__, *, block_action_verb: Optional[pulumi.Input[Union[_builtins.str, BlockActionVerb]]] = ...) -> None:
    ...
    def block_action_verb(self, value: Optional[pulumi.Input[Union[_builtins.str, BlockActionVerb]]]): # -> None:
        ...
...
class ResourceProviderManifestPropertiesResponseOptionsArgs:
    def __init__(__self__, *, service_client_options_type: Optional[pulumi.Input[Union[_builtins.str, ServiceClientOptionsType]]] = ...) -> None:
    ...
    def service_client_options_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ServiceClientOptionsType]]]): # -> None:
        ...
...
class ResourceProviderManifestPropertiesTemplateDeploymentOptionsArgs:
    def __init__(__self__, *, preflight_options: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, PreflightOption]]]]] = ..., preflight_supported: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def preflight_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, PreflightOption]]]]]): # -> None:
        ...
    ...
    def preflight_supported(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ResourceProviderServiceArgs:
    def __init__(__self__, *, service_name: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, ServiceStatus]]] = ...) -> None:
    ...
    @status.setter
    def status(self, value: Optional[pulumi.Input[Union[_builtins.str, ServiceStatus]]]): # -> None:
        ...
...
class ResourceTypeEndpointArgs:
    def __init__(__self__, *, api_version: Optional[pulumi.Input[_builtins.str]] = ..., api_versions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., data_boundary: Optional[pulumi.Input[Union[_builtins.str, DataBoundary]]] = ..., dsts_configuration: Optional[pulumi.Input[ResourceTypeEndpointDstsConfigurationArgs]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., endpoint_type: Optional[pulumi.Input[Union[_builtins.str, EndpointTypeResourceType]]] = ..., endpoint_uri: Optional[pulumi.Input[_builtins.str]] = ..., extensions: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceTypeExtensionArgs]]]] = ..., features_rule: Optional[pulumi.Input[ResourceTypeEndpointFeaturesRuleArgs]] = ..., kind: Optional[pulumi.Input[Union[_builtins.str, ResourceTypeEndpointKind]]] = ..., locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., required_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., sku_link: Optional[pulumi.Input[_builtins.str]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ..., token_auth_configuration: Optional[pulumi.Input[TokenAuthConfigurationArgs]] = ..., zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def data_boundary(self, value: Optional[pulumi.Input[Union[_builtins.str, DataBoundary]]]): # -> None:
        ...
    ...
    @dsts_configuration.setter
    def dsts_configuration(self, value: Optional[pulumi.Input[ResourceTypeEndpointDstsConfigurationArgs]]): # -> None:
        ...
    ...
    @endpoint_type.setter
    def endpoint_type(self, value: Optional[pulumi.Input[Union[_builtins.str, EndpointTypeResourceType]]]): # -> None:
        ...
    ...
    @extensions.setter
    def extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceTypeExtensionArgs]]]]): # -> None:
        ...
    ...
    @features_rule.setter
    def features_rule(self, value: Optional[pulumi.Input[ResourceTypeEndpointFeaturesRuleArgs]]): # -> None:
        ...
    ...
    @kind.setter
    def kind(self, value: Optional[pulumi.Input[Union[_builtins.str, ResourceTypeEndpointKind]]]): # -> None:
        ...
...
class ResourceTypeExtensionOptionsResourceCreationBeginArgs:
    def __init__(__self__, *, request: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ExtensionOptionType]]]]] = ..., response: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ExtensionOptionType]]]]] = ...) -> None:
    ...
    @request.setter
    def request(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ExtensionOptionType]]]]]): # -> None:
        ...
    ...
    @response.setter
    def response(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ExtensionOptionType]]]]]): # -> None:
        ...
...
class ResourceTypeExtensionArgs:
    def __init__(__self__, *, endpoint_uri: Optional[pulumi.Input[_builtins.str]] = ..., extension_categories: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ExtensionCategory]]]]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def extension_categories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, ExtensionCategory]]]]]): # -> None:
        ...
...
class ResourceTypeOnBehalfOfTokenArgs:
    def __init__(__self__, *, action_name: Optional[pulumi.Input[_builtins.str]] = ..., life_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @life_time.setter
    def life_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesAvailabilityZoneRuleArgs:
    def __init__(__self__, *, availability_zone_policy: Optional[pulumi.Input[Union[_builtins.str, AvailabilityZonePolicy]]] = ...) -> None:
    ...
    def availability_zone_policy(self, value: Optional[pulumi.Input[Union[_builtins.str, AvailabilityZonePolicy]]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesCapacityRuleArgs:
    def __init__(__self__, *, capacity_policy: Optional[pulumi.Input[Union[_builtins.str, CapacityPolicy]]] = ..., sku_alias: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def capacity_policy(self, value: Optional[pulumi.Input[Union[_builtins.str, CapacityPolicy]]]): # -> None:
        ...
    ...
    @sku_alias.setter
    def sku_alias(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesCheckNameAvailabilitySpecificationsArgs:
    def __init__(__self__, *, enable_default_validation: Optional[pulumi.Input[_builtins.bool]] = ..., resource_types_with_custom_validation: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def enable_default_validation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def resource_types_with_custom_validation(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesExtensionOptionsArgs:
    def __init__(__self__, *, resource_creation_begin: Optional[pulumi.Input[ResourceTypeExtensionOptionsResourceCreationBeginArgs]] = ...) -> None:
    ...
    def resource_creation_begin(self, value: Optional[pulumi.Input[ResourceTypeExtensionOptionsResourceCreationBeginArgs]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesIdentityManagementArgs:
    def __init__(__self__, *, application_id: Optional[pulumi.Input[_builtins.str]] = ..., application_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., delegation_app_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, IdentityManagementTypes]]] = ...) -> None:
    ...
    def application_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def delegation_app_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, IdentityManagementTypes]]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesLegacyPolicyArgs:
    def __init__(__self__, *, disallowed_conditions: Optional[pulumi.Input[Sequence[pulumi.Input[LegacyDisallowedConditionArgs]]]] = ..., disallowed_legacy_operations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, LegacyOperation]]]]] = ...) -> None:
    ...
    def disallowed_conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LegacyDisallowedConditionArgs]]]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesMarketplaceOptionsArgs:
    def __init__(__self__, *, add_on_plan_conversion_allowed: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def add_on_plan_conversion_allowed(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesResourceCacheArgs:
    def __init__(__self__, *, enable_resource_cache: Optional[pulumi.Input[_builtins.bool]] = ..., resource_cache_expiration_timespan: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def enable_resource_cache(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def resource_cache_expiration_timespan(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesResourceGraphConfigurationArgs:
    def __init__(__self__, *, api_version: Optional[pulumi.Input[_builtins.str]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesResourceManagementOptionsBatchProvisioningSupportArgs:
    def __init__(__self__, *, supported_operations: Optional[pulumi.Input[Union[_builtins.str, SupportedOperations]]] = ...) -> None:
    ...
    def supported_operations(self, value: Optional[pulumi.Input[Union[_builtins.str, SupportedOperations]]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesResourceManagementOptionsNestedProvisioningSupportArgs:
    def __init__(__self__, *, minimum_api_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def minimum_api_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesResourceManagementOptionsArgs:
    def __init__(__self__, *, batch_provisioning_support: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceManagementOptionsBatchProvisioningSupportArgs]] = ..., delete_dependencies: Optional[pulumi.Input[Sequence[pulumi.Input[DeleteDependencyArgs]]]] = ..., nested_provisioning_support: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceManagementOptionsNestedProvisioningSupportArgs]] = ...) -> None:
    ...
    def batch_provisioning_support(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceManagementOptionsBatchProvisioningSupportArgs]]): # -> None:
        ...
    ...
    def delete_dependencies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DeleteDependencyArgs]]]]): # -> None:
        ...
    ...
    def nested_provisioning_support(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceManagementOptionsNestedProvisioningSupportArgs]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesResourceMovePolicyArgs:
    def __init__(__self__, *, cross_resource_group_move_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., cross_subscription_move_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., validation_required: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def cross_resource_group_move_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def cross_subscription_move_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def validation_required(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesResourceQueryManagementArgs:
    def __init__(__self__, *, filter_option: Optional[pulumi.Input[Union[_builtins.str, FilterOption]]] = ...) -> None:
    ...
    def filter_option(self, value: Optional[pulumi.Input[Union[_builtins.str, FilterOption]]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesResourceTypeCommonAttributeManagementArgs:
    def __init__(__self__, *, common_api_versions_merge_mode: Optional[pulumi.Input[Union[_builtins.str, CommonApiVersionsMergeMode]]] = ...) -> None:
    ...
    def common_api_versions_merge_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, CommonApiVersionsMergeMode]]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesRoutingRuleArgs:
    def __init__(__self__, *, host_resource_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def host_resource_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesTemplateDeploymentPolicyArgs:
    def __init__(__self__, *, capabilities: pulumi.Input[Union[_builtins.str, TemplateDeploymentCapabilities]], preflight_options: pulumi.Input[Union[_builtins.str, TemplateDeploymentPreflightOptions]], preflight_notifications: Optional[pulumi.Input[Union[_builtins.str, TemplateDeploymentPreflightNotifications]]] = ...) -> None:
    ...
    @capabilities.setter
    def capabilities(self, value: pulumi.Input[Union[_builtins.str, TemplateDeploymentCapabilities]]): # -> None:
        ...
    ...
    @preflight_options.setter
    def preflight_options(self, value: pulumi.Input[Union[_builtins.str, TemplateDeploymentPreflightOptions]]): # -> None:
        ...
    ...
    def preflight_notifications(self, value: Optional[pulumi.Input[Union[_builtins.str, TemplateDeploymentPreflightNotifications]]]): # -> None:
        ...
...
class ResourceTypeRegistrationPropertiesArgs:
    def __init__(__self__, *, add_resource_list_target_locations: Optional[pulumi.Input[_builtins.bool]] = ..., additional_options: Optional[pulumi.Input[Union[_builtins.str, AdditionalOptionsResourceTypeRegistration]]] = ..., allow_empty_role_assignments: Optional[pulumi.Input[_builtins.bool]] = ..., allowed_resource_names: Optional[pulumi.Input[Sequence[pulumi.Input[AllowedResourceNameArgs]]]] = ..., allowed_template_deployment_reference_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allowed_unauthorized_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allowed_unauthorized_actions_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[AllowedUnauthorizedActionsExtensionArgs]]]] = ..., api_profiles: Optional[pulumi.Input[Sequence[pulumi.Input[ApiProfileArgs]]]] = ..., async_operation_resource_type_name: Optional[pulumi.Input[_builtins.str]] = ..., async_timeout_rules: Optional[pulumi.Input[Sequence[pulumi.Input[AsyncTimeoutRuleArgs]]]] = ..., authorization_action_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[AuthorizationActionMappingArgs]]]] = ..., availability_zone_rule: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesAvailabilityZoneRuleArgs]] = ..., capacity_rule: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesCapacityRuleArgs]] = ..., category: Optional[pulumi.Input[Union[_builtins.str, ResourceTypeCategory]]] = ..., check_name_availability_specifications: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesCheckNameAvailabilitySpecificationsArgs]] = ..., common_api_versions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., cross_tenant_token_validation: Optional[pulumi.Input[Union[_builtins.str, CrossTenantTokenValidation]]] = ..., default_api_version: Optional[pulumi.Input[_builtins.str]] = ..., disallowed_action_verbs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., disallowed_end_user_operations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., dsts_configuration: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesDstsConfigurationArgs]] = ..., enable_async_operation: Optional[pulumi.Input[_builtins.bool]] = ..., enable_third_party_s2_s: Optional[pulumi.Input[_builtins.bool]] = ..., endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceTypeEndpointArgs]]]] = ..., extended_locations: Optional[pulumi.Input[Sequence[pulumi.Input[ExtendedLocationOptionsArgs]]]] = ..., extension_options: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesExtensionOptionsArgs]] = ..., features_rule: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesFeaturesRuleArgs]] = ..., frontdoor_request_mode: Optional[pulumi.Input[Union[_builtins.str, FrontdoorRequestMode]]] = ..., grouping_tag: Optional[pulumi.Input[_builtins.str]] = ..., identity_management: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesIdentityManagementArgs]] = ..., is_pure_proxy: Optional[pulumi.Input[_builtins.bool]] = ..., legacy_name: Optional[pulumi.Input[_builtins.str]] = ..., legacy_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., legacy_policy: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesLegacyPolicyArgs]] = ..., linked_access_checks: Optional[pulumi.Input[Sequence[pulumi.Input[LinkedAccessCheckArgs]]]] = ..., linked_notification_rules: Optional[pulumi.Input[Sequence[pulumi.Input[LinkedNotificationRuleArgs]]]] = ..., linked_operation_rules: Optional[pulumi.Input[Sequence[pulumi.Input[LinkedOperationRuleArgs]]]] = ..., logging_rules: Optional[pulumi.Input[Sequence[pulumi.Input[LoggingRuleArgs]]]] = ..., management: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesManagementArgs]] = ..., manifest_link: Optional[pulumi.Input[_builtins.str]] = ..., marketplace_options: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesMarketplaceOptionsArgs]] = ..., marketplace_type: Optional[pulumi.Input[MarketplaceType]] = ..., metadata: Optional[Any] = ..., notifications: Optional[pulumi.Input[Sequence[pulumi.Input[NotificationArgs]]]] = ..., on_behalf_of_tokens: Optional[pulumi.Input[ResourceTypeOnBehalfOfTokenArgs]] = ..., open_api_configuration: Optional[pulumi.Input[OpenApiConfigurationArgs]] = ..., policy_execution_type: Optional[pulumi.Input[Union[_builtins.str, PolicyExecutionType]]] = ..., quota_rule: Optional[pulumi.Input[QuotaRuleArgs]] = ..., regionality: Optional[pulumi.Input[Union[_builtins.str, Regionality]]] = ..., request_header_options: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesRequestHeaderOptionsArgs]] = ..., required_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., resource_cache: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceCacheArgs]] = ..., resource_concurrency_control_options: Optional[pulumi.Input[Mapping[str, pulumi.Input[ResourceConcurrencyControlOptionArgs]]]] = ..., resource_deletion_policy: Optional[pulumi.Input[Union[_builtins.str, ResourceDeletionPolicy]]] = ..., resource_graph_configuration: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceGraphConfigurationArgs]] = ..., resource_management_options: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceManagementOptionsArgs]] = ..., resource_move_policy: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceMovePolicyArgs]] = ..., resource_provider_authorization_rules: Optional[pulumi.Input[ResourceProviderAuthorizationRulesArgs]] = ..., resource_query_management: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceQueryManagementArgs]] = ..., resource_sub_type: Optional[pulumi.Input[Union[_builtins.str, ResourceSubType]]] = ..., resource_type_common_attribute_management: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceTypeCommonAttributeManagementArgs]] = ..., resource_validation: Optional[pulumi.Input[Union[_builtins.str, ResourceValidation]]] = ..., routing_rule: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesRoutingRuleArgs]] = ..., routing_type: Optional[pulumi.Input[Union[_builtins.str, RoutingType]]] = ..., service_tree_infos: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTreeInfoArgs]]]] = ..., sku_link: Optional[pulumi.Input[_builtins.str]] = ..., subscription_lifecycle_notification_specifications: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesSubscriptionLifecycleNotificationSpecificationsArgs]] = ..., subscription_state_rules: Optional[pulumi.Input[Sequence[pulumi.Input[SubscriptionStateRuleArgs]]]] = ..., supports_tags: Optional[pulumi.Input[_builtins.bool]] = ..., swagger_specifications: Optional[pulumi.Input[Sequence[pulumi.Input[SwaggerSpecificationArgs]]]] = ..., template_deployment_options: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesTemplateDeploymentOptionsArgs]] = ..., template_deployment_policy: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesTemplateDeploymentPolicyArgs]] = ..., throttling_rules: Optional[pulumi.Input[Sequence[pulumi.Input[ThrottlingRuleArgs]]]] = ..., token_auth_configuration: Optional[pulumi.Input[TokenAuthConfigurationArgs]] = ...) -> None:
    ...
    def add_resource_list_target_locations(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @additional_options.setter
    def additional_options(self, value: Optional[pulumi.Input[Union[_builtins.str, AdditionalOptionsResourceTypeRegistration]]]): # -> None:
        ...
    ...
    def allow_empty_role_assignments(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def allowed_resource_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AllowedResourceNameArgs]]]]): # -> None:
        ...
    ...
    def allowed_template_deployment_reference_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def allowed_unauthorized_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def allowed_unauthorized_actions_extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AllowedUnauthorizedActionsExtensionArgs]]]]): # -> None:
        ...
    ...
    @api_profiles.setter
    def api_profiles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ApiProfileArgs]]]]): # -> None:
        ...
    ...
    def async_operation_resource_type_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def async_timeout_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AsyncTimeoutRuleArgs]]]]): # -> None:
        ...
    ...
    def authorization_action_mappings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AuthorizationActionMappingArgs]]]]): # -> None:
        ...
    ...
    def availability_zone_rule(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesAvailabilityZoneRuleArgs]]): # -> None:
        ...
    ...
    def capacity_rule(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesCapacityRuleArgs]]): # -> None:
        ...
    ...
    @category.setter
    def category(self, value: Optional[pulumi.Input[Union[_builtins.str, ResourceTypeCategory]]]): # -> None:
        ...
    ...
    def check_name_availability_specifications(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesCheckNameAvailabilitySpecificationsArgs]]): # -> None:
        ...
    ...
    def common_api_versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def default_api_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def disallowed_action_verbs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def disallowed_end_user_operations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @dsts_configuration.setter
    def dsts_configuration(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesDstsConfigurationArgs]]): # -> None:
        ...
    ...
    def enable_async_operation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_third_party_s2_s(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @endpoints.setter
    def endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResourceTypeEndpointArgs]]]]): # -> None:
        ...
    ...
    def extended_locations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExtendedLocationOptionsArgs]]]]): # -> None:
        ...
    ...
    def extension_options(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesExtensionOptionsArgs]]): # -> None:
        ...
    ...
    @features_rule.setter
    def features_rule(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesFeaturesRuleArgs]]): # -> None:
        ...
    ...
    def frontdoor_request_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, FrontdoorRequestMode]]]): # -> None:
        ...
    ...
    def identity_management(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesIdentityManagementArgs]]): # -> None:
        ...
    ...
    def is_pure_proxy(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @legacy_name.setter
    def legacy_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @legacy_names.setter
    def legacy_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def legacy_policy(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesLegacyPolicyArgs]]): # -> None:
        ...
    ...
    def linked_access_checks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LinkedAccessCheckArgs]]]]): # -> None:
        ...
    ...
    @linked_notification_rules.setter
    def linked_notification_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LinkedNotificationRuleArgs]]]]): # -> None:
        ...
    ...
    def linked_operation_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LinkedOperationRuleArgs]]]]): # -> None:
        ...
    ...
    def logging_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LoggingRuleArgs]]]]): # -> None:
        ...
    ...
    @management.setter
    def management(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesManagementArgs]]): # -> None:
        ...
    ...
    def manifest_link(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def marketplace_options(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesMarketplaceOptionsArgs]]): # -> None:
        ...
    ...
    def marketplace_type(self, value: Optional[pulumi.Input[MarketplaceType]]): # -> None:
        ...
    ...
    def on_behalf_of_tokens(self, value: Optional[pulumi.Input[ResourceTypeOnBehalfOfTokenArgs]]): # -> None:
        ...
    ...
    def open_api_configuration(self, value: Optional[pulumi.Input[OpenApiConfigurationArgs]]): # -> None:
        ...
    ...
    def policy_execution_type(self, value: Optional[pulumi.Input[Union[_builtins.str, PolicyExecutionType]]]): # -> None:
        ...
    ...
    @quota_rule.setter
    def quota_rule(self, value: Optional[pulumi.Input[QuotaRuleArgs]]): # -> None:
        ...
    ...
    @regionality.setter
    def regionality(self, value: Optional[pulumi.Input[Union[_builtins.str, Regionality]]]): # -> None:
        ...
    ...
    @request_header_options.setter
    def request_header_options(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesRequestHeaderOptionsArgs]]): # -> None:
        ...
    ...
    def resource_cache(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceCacheArgs]]): # -> None:
        ...
    ...
    def resource_concurrency_control_options(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[ResourceConcurrencyControlOptionArgs]]]]): # -> None:
        ...
    ...
    def resource_deletion_policy(self, value: Optional[pulumi.Input[Union[_builtins.str, ResourceDeletionPolicy]]]): # -> None:
        ...
    ...
    def resource_graph_configuration(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceGraphConfigurationArgs]]): # -> None:
        ...
    ...
    def resource_management_options(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceManagementOptionsArgs]]): # -> None:
        ...
    ...
    def resource_move_policy(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceMovePolicyArgs]]): # -> None:
        ...
    ...
    def resource_query_management(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceQueryManagementArgs]]): # -> None:
        ...
    ...
    def resource_sub_type(self, value: Optional[pulumi.Input[Union[_builtins.str, ResourceSubType]]]): # -> None:
        ...
    ...
    def resource_type_common_attribute_management(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesResourceTypeCommonAttributeManagementArgs]]): # -> None:
        ...
    ...
    def resource_validation(self, value: Optional[pulumi.Input[Union[_builtins.str, ResourceValidation]]]): # -> None:
        ...
    ...
    @routing_rule.setter
    def routing_rule(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesRoutingRuleArgs]]): # -> None:
        ...
    ...
    @routing_type.setter
    def routing_type(self, value: Optional[pulumi.Input[Union[_builtins.str, RoutingType]]]): # -> None:
        ...
    ...
    @subscription_lifecycle_notification_specifications.setter
    def subscription_lifecycle_notification_specifications(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesSubscriptionLifecycleNotificationSpecificationsArgs]]): # -> None:
        ...
    ...
    def subscription_state_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SubscriptionStateRuleArgs]]]]): # -> None:
        ...
    ...
    def supports_tags(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def swagger_specifications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SwaggerSpecificationArgs]]]]): # -> None:
        ...
    ...
    @template_deployment_options.setter
    def template_deployment_options(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesTemplateDeploymentOptionsArgs]]): # -> None:
        ...
    ...
    def template_deployment_policy(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesTemplateDeploymentPolicyArgs]]): # -> None:
        ...
    ...
    def throttling_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ThrottlingRuleArgs]]]]): # -> None:
        ...
...
class ResourceTypeRegistrationArgs:
    def __init__(__self__, *, kind: Optional[pulumi.Input[Union[_builtins.str, ResourceTypeRegistrationKind]]] = ..., properties: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesArgs]] = ...) -> None:
    ...
    @kind.setter
    def kind(self, value: Optional[pulumi.Input[Union[_builtins.str, ResourceTypeRegistrationKind]]]): # -> None:
        ...
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[ResourceTypeRegistrationPropertiesArgs]]): # -> None:
        ...
...
class ServiceTreeInfoArgs:
    def __init__(__self__, *, component_id: Optional[pulumi.Input[_builtins.str]] = ..., readiness: Optional[pulumi.Input[Union[_builtins.str, Readiness]]] = ..., service_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @readiness.setter
    def readiness(self, value: Optional[pulumi.Input[Union[_builtins.str, Readiness]]]): # -> None:
        ...
...
@pulumi.input_type
class SkuCostArgs:
    def __init__(__self__, *, meter_id: pulumi.Input[_builtins.str], extended_unit: Optional[pulumi.Input[_builtins.str]] = ..., quantity: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @meter_id.setter
    def meter_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def extended_unit(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @quantity.setter
    def quantity(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class SkuLocationInfoArgs:
    def __init__(__self__, *, location: pulumi.Input[_builtins.str], extended_locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, ExtendedLocationType]]] = ..., zone_details: Optional[pulumi.Input[Sequence[pulumi.Input[SkuZoneDetailArgs]]]] = ..., zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @extended_locations.setter
    def extended_locations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @zone_details.setter
    def zone_details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SkuZoneDetailArgs]]]]): # -> None:
        ...
...
class SkuResourcePropertiesArgs:
    def __init__(__self__, *, sku_settings: pulumi.Input[Sequence[pulumi.Input[SkuSettingArgs]]]) -> None:
    ...
    @sku_settings.setter
    def sku_settings(self, value: pulumi.Input[Sequence[pulumi.Input[SkuSettingArgs]]]): # -> None:
        ...
...
class SkuSettingCapacityArgs:
    def __init__(__self__, *, minimum: pulumi.Input[_builtins.int], default: Optional[pulumi.Input[_builtins.int]] = ..., maximum: Optional[pulumi.Input[_builtins.int]] = ..., scale_type: Optional[pulumi.Input[Union[_builtins.str, SkuScaleType]]] = ...) -> None:
    ...
    @minimum.setter
    def minimum(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @default.setter
    def default(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @maximum.setter
    def maximum(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @scale_type.setter
    def scale_type(self, value: Optional[pulumi.Input[Union[_builtins.str, SkuScaleType]]]): # -> None:
        ...
...
class SkuSettingArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], capabilities: Optional[pulumi.Input[Sequence[pulumi.Input[SkuCapabilityArgs]]]] = ..., capacity: Optional[pulumi.Input[SkuSettingCapacityArgs]] = ..., costs: Optional[pulumi.Input[Sequence[pulumi.Input[SkuCostArgs]]]] = ..., family: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., location_info: Optional[pulumi.Input[Sequence[pulumi.Input[SkuLocationInfoArgs]]]] = ..., locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., required_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., required_quota_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., size: Optional[pulumi.Input[_builtins.str]] = ..., tier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @capabilities.setter
    def capabilities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SkuCapabilityArgs]]]]): # -> None:
        ...
    ...
    @capacity.setter
    def capacity(self, value: Optional[pulumi.Input[SkuSettingCapacityArgs]]): # -> None:
        ...
    ...
    @costs.setter
    def costs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SkuCostArgs]]]]): # -> None:
        ...
    ...
    def location_info(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SkuLocationInfoArgs]]]]): # -> None:
        ...
    ...
    def required_quota_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class SkuZoneDetailArgs:
    def __init__(__self__, *, capabilities: Optional[pulumi.Input[Sequence[pulumi.Input[SkuCapabilityArgs]]]] = ..., name: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @name.setter
    def name(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class SubscriberSettingArgs:
    def __init__(__self__, *, filter_rules: Optional[pulumi.Input[Sequence[pulumi.Input[FilterRuleArgs]]]] = ...) -> None:
    ...
    @filter_rules.setter
    def filter_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FilterRuleArgs]]]]): # -> None:
        ...
...
class SubscriptionStateOverrideActionArgs:
    def __init__(__self__, *, action: pulumi.Input[Union[_builtins.str, SubscriptionNotificationOperation]], state: pulumi.Input[Union[_builtins.str, SubscriptionTransitioningState]]) -> None:
    ...
    @action.setter
    def action(self, value: pulumi.Input[Union[_builtins.str, SubscriptionNotificationOperation]]): # -> None:
        ...
    ...
    @state.setter
    def state(self, value: pulumi.Input[Union[_builtins.str, SubscriptionTransitioningState]]): # -> None:
        ...
...
class SubscriptionStateRuleArgs:
    def __init__(__self__, *, allowed_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, SubscriptionState]]] = ...) -> None:
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[_builtins.str, SubscriptionState]]]): # -> None:
        ...
...
class SwaggerSpecificationArgs:
    def __init__(__self__, *, api_versions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., swagger_spec_folder_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def swagger_spec_folder_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ThrottlingMetricArgs:
    def __init__(__self__, *, limit: pulumi.Input[_builtins.float], type: pulumi.Input[Union[_builtins.str, ThrottlingMetricType]], interval: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @limit.setter
    def limit(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: pulumi.Input[Union[_builtins.str, ThrottlingMetricType]]): # -> None:
        ...
...
class ThrottlingRuleArgs:
    def __init__(__self__, *, action: pulumi.Input[_builtins.str], metrics: pulumi.Input[Sequence[pulumi.Input[ThrottlingMetricArgs]]], application_id: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., required_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @metrics.setter
    def metrics(self, value: pulumi.Input[Sequence[pulumi.Input[ThrottlingMetricArgs]]]): # -> None:
        ...
    ...
    @application_id.setter
    def application_id(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class TokenAuthConfigurationArgs:
    def __init__(__self__, *, authentication_scheme: Optional[pulumi.Input[Union[_builtins.str, AuthenticationScheme]]] = ..., disable_certificate_authentication_fallback: Optional[pulumi.Input[_builtins.bool]] = ..., signed_request_scope: Optional[pulumi.Input[Union[_builtins.str, SignedRequestScope]]] = ...) -> None:
    ...
    def authentication_scheme(self, value: Optional[pulumi.Input[Union[_builtins.str, AuthenticationScheme]]]): # -> None:
        ...
    ...
    def disable_certificate_authentication_fallback(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def signed_request_scope(self, value: Optional[pulumi.Input[Union[_builtins.str, SignedRequestScope]]]): # -> None:
        ...
