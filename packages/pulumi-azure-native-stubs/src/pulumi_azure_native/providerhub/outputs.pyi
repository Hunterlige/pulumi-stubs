...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AdditionalAuthorizationResponse', 'AllowedResourceNameResponse', 'AllowedUnauthorizedActionsExtensionResponse', 'ApiProfileResponse', 'ApplicationDataAuthorizationResponse', 'ApplicationProviderAuthorizationResponse', 'AsyncOperationPollingRulesResponse', 'AsyncTimeoutRuleResponse', 'AuthorizationActionMappingResponse', 'AuthorizedApplicationPropertiesResponse', 'CustomRolloutPropertiesResponse', 'CustomRolloutPropertiesSpecificationResponse', 'CustomRolloutPropertiesStatusResponse', ..., 'CustomRolloutSpecificationCanaryResponse', ..., 'CustomRolloutStatusManifestCheckinStatusResponse', 'DefaultRolloutPropertiesResponse', 'DefaultRolloutPropertiesSpecificationResponse', 'DefaultRolloutPropertiesStatusResponse', ..., 'DefaultRolloutSpecificationCanaryResponse', ..., 'DefaultRolloutSpecificationHighTrafficResponse', 'DefaultRolloutSpecificationLowTrafficResponse', 'DefaultRolloutSpecificationMediumTrafficResponse', ..., ..., ..., 'DefaultRolloutStatusManifestCheckinStatusResponse', 'DeleteDependencyResponse', 'EndpointInformationResponse', 'ExtendedErrorInfoResponse', 'ExtendedLocationOptionsResponse', ..., 'FanoutLinkedNotificationRuleResponse', 'FilterRuleResponse', 'LegacyDisallowedConditionResponse', 'LightHouseAuthorizationResponse', 'LinkedAccessCheckResponse', 'LinkedNotificationRuleResponse', 'LinkedOperationRuleResponse', 'LocationQuotaRuleResponse', 'LoggingRuleHiddenPropertyPathsResponse', 'LoggingRuleResponse', 'NotificationEndpointResponse', 'NotificationRegistrationPropertiesResponse', 'NotificationResponse', 'OpenApiConfigurationResponse', 'OpenApiValidationResponse', 'ProviderHubMetadataProviderAuthenticationResponse', ..., 'ProviderMonitorSettingPropertiesResponse', ..., ..., 'ProviderRegistrationPropertiesResponse', ..., 'QuotaRuleResponse', 'ResourceAccessRoleResponse', 'ResourceConcurrencyControlOptionResponse', 'ResourceHydrationAccountResponse', ..., 'ResourceProviderAuthorizationResponse', 'ResourceProviderAuthorizationRulesResponse', 'ResourceProviderCapabilitiesResponse', 'ResourceProviderEndpointFeaturesRuleResponse', 'ResourceProviderEndpointResponse', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ResourceProviderServiceResponse', 'ResourceTypeEndpointDstsConfigurationResponse', 'ResourceTypeEndpointFeaturesRuleResponse', 'ResourceTypeEndpointResponse', ..., 'ResourceTypeExtensionResponse', 'ResourceTypeOnBehalfOfTokenResponse', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ResourceTypeRegistrationPropertiesResponse', ..., ..., ..., ..., 'ResourceTypeRegistrationResponse', 'ServiceTreeInfoResponse', 'SkuCapabilityResponse', 'SkuCostResponse', 'SkuLocationInfoResponse', 'SkuResourcePropertiesResponse', 'SkuSettingCapacityResponse', 'SkuSettingResponse', 'SkuZoneDetailResponse', 'SubscriberSettingResponse', 'SubscriptionStateOverrideActionResponse', 'SubscriptionStateRuleResponse', 'SwaggerSpecificationResponse', 'SystemDataResponse', 'ThirdPartyExtensionResponse', 'ThrottlingMetricResponse', 'ThrottlingRuleResponse', 'TokenAuthConfigurationResponse', 'TypedErrorInfoResponse']
@pulumi.output_type
class AdditionalAuthorizationResponse(dict):
    ...
    def __init__(__self__, *, application_id: Optional[_builtins.str] = ..., role_definition_id: Optional[_builtins.str] = ...) -> None:
        ...
...
class AllowedResourceNameResponse(dict):
    ...
    def __init__(__self__, *, get_action_verb: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class AllowedUnauthorizedActionsExtensionResponse(dict):
    def __init__(__self__, *, action: Optional[_builtins.str] = ..., intent: Optional[_builtins.str] = ...) -> None:
...
class ApiProfileResponse(dict):
    ...
    def __init__(__self__, *, api_version: Optional[_builtins.str] = ..., profile_version: Optional[_builtins.str] = ...) -> None:
...
class ApplicationDataAuthorizationResponse(dict):
    ...
    def __init__(__self__, *, role: _builtins.str, resource_types: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ApplicationProviderAuthorizationResponse(dict):
    ...
    def __init__(__self__, *, managed_by_role_definition_id: Optional[_builtins.str] = ..., role_definition_id: Optional[_builtins.str] = ...) -> None:
...
class AsyncOperationPollingRulesResponse(dict):
    ...
    def __init__(__self__, *, additional_options: Optional[_builtins.str] = ..., authorization_actions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AsyncTimeoutRuleResponse(dict):
    ...
    def __init__(__self__, *, action_name: Optional[_builtins.str] = ..., timeout: Optional[_builtins.str] = ...) -> None:
...
class AuthorizationActionMappingResponse(dict):
    def __init__(__self__, *, desired: Optional[_builtins.str] = ..., original: Optional[_builtins.str] = ...) -> None:
...
class AuthorizedApplicationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, data_authorizations: Optional[Sequence[outputs.ApplicationDataAuthorizationResponse]] = ..., provider_authorization: Optional[outputs.ApplicationProviderAuthorizationResponse] = ...) -> None:
...
class CustomRolloutPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, specification: outputs.CustomRolloutPropertiesSpecificationResponse, status: Optional[outputs.CustomRolloutPropertiesStatusResponse] = ...) -> None:
...
class CustomRolloutPropertiesSpecificationResponse(dict):
    ...
    def __init__(__self__, *, auto_provision_config: Optional[outputs.CustomRolloutSpecificationAutoProvisionConfigResponse] = ..., canary: Optional[outputs.CustomRolloutSpecificationCanaryResponse] = ..., provider_registration: Optional[outputs.CustomRolloutSpecificationProviderRegistrationResponse] = ..., refresh_subscription_registration: Optional[_builtins.bool] = ..., release_scopes: Optional[Sequence[_builtins.str]] = ..., resource_type_registrations: Optional[Sequence[outputs.ResourceTypeRegistrationResponse]] = ..., skip_release_scope_validation: Optional[_builtins.bool] = ...) -> None:
...
class CustomRolloutPropertiesStatusResponse(dict):
    ...
    def __init__(__self__, *, completed_regions: Optional[Sequence[_builtins.str]] = ..., failed_or_skipped_regions: Optional[Mapping[str, outputs.ExtendedErrorInfoResponse]] = ..., manifest_checkin_status: Optional[outputs.CustomRolloutStatusManifestCheckinStatusResponse] = ...) -> None:
...
class CustomRolloutSpecificationAutoProvisionConfigResponse(dict):
    ...
    def __init__(__self__, *, resource_graph: Optional[_builtins.bool] = ..., storage: Optional[_builtins.bool] = ...) -> None:
...
class CustomRolloutSpecificationCanaryResponse(dict):
    ...
    def __init__(__self__, *, regions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CustomRolloutSpecificationProviderRegistrationResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str, kind: Optional[_builtins.str] = ..., properties: Optional[outputs.ProviderRegistrationPropertiesResponse] = ...) -> None:
...
class CustomRolloutStatusManifestCheckinStatusResponse(dict):
    ...
    def __init__(__self__, *, is_checked_in: _builtins.bool, status_message: _builtins.str, commit_id: Optional[_builtins.str] = ..., pull_request: Optional[_builtins.str] = ...) -> None:
...
class DefaultRolloutPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, specification: Optional[outputs.DefaultRolloutPropertiesSpecificationResponse] = ..., status: Optional[outputs.DefaultRolloutPropertiesStatusResponse] = ...) -> None:
...
class DefaultRolloutPropertiesSpecificationResponse(dict):
    ...
    def __init__(__self__, *, auto_provision_config: Optional[outputs.DefaultRolloutSpecificationAutoProvisionConfigResponse] = ..., canary: Optional[outputs.DefaultRolloutSpecificationCanaryResponse] = ..., expedited_rollout: Optional[outputs.DefaultRolloutSpecificationExpeditedRolloutResponse] = ..., high_traffic: Optional[outputs.DefaultRolloutSpecificationHighTrafficResponse] = ..., low_traffic: Optional[outputs.DefaultRolloutSpecificationLowTrafficResponse] = ..., medium_traffic: Optional[outputs.DefaultRolloutSpecificationMediumTrafficResponse] = ..., provider_registration: Optional[outputs.DefaultRolloutSpecificationProviderRegistrationResponse] = ..., resource_type_registrations: Optional[Sequence[outputs.ResourceTypeRegistrationResponse]] = ..., rest_of_the_world_group_one: Optional[outputs.DefaultRolloutSpecificationRestOfTheWorldGroupOneResponse] = ..., rest_of_the_world_group_two: Optional[outputs.DefaultRolloutSpecificationRestOfTheWorldGroupTwoResponse] = ...) -> None:
...
class DefaultRolloutPropertiesStatusResponse(dict):
    ...
    def __init__(__self__, *, completed_regions: Optional[Sequence[_builtins.str]] = ..., failed_or_skipped_regions: Optional[Mapping[str, outputs.ExtendedErrorInfoResponse]] = ..., manifest_checkin_status: Optional[outputs.DefaultRolloutStatusManifestCheckinStatusResponse] = ..., next_traffic_region: Optional[_builtins.str] = ..., next_traffic_region_scheduled_time: Optional[_builtins.str] = ..., subscription_reregistration_result: Optional[_builtins.str] = ...) -> None:
...
class DefaultRolloutSpecificationCanaryResponse(dict):
    ...
    def __init__(__self__, *, regions: Optional[Sequence[_builtins.str]] = ..., skip_regions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DefaultRolloutSpecificationHighTrafficResponse(dict):
    ...
    def __init__(__self__, *, regions: Optional[Sequence[_builtins.str]] = ..., wait_duration: Optional[_builtins.str] = ...) -> None:
...
class DeleteDependencyResponse(dict):
    ...
    def __init__(__self__, *, linked_property: Optional[_builtins.str] = ..., linked_type: Optional[_builtins.str] = ..., required_features: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class EndpointInformationResponse(dict):
    ...
    def __init__(__self__, *, endpoint: Optional[_builtins.str] = ..., endpoint_type: Optional[_builtins.str] = ..., schema_version: Optional[_builtins.str] = ...) -> None:
...
class ExtendedErrorInfoResponse(dict):
    ...
    def __init__(__self__, *, additional_info: Optional[Sequence[outputs.TypedErrorInfoResponse]] = ..., code: Optional[_builtins.str] = ..., details: Optional[Sequence[outputs.ExtendedErrorInfoResponse]] = ..., message: Optional[_builtins.str] = ..., target: Optional[_builtins.str] = ...) -> None:
...
class ExtendedLocationOptionsResponse(dict):
    ...
    def __init__(__self__, *, supported_policy: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class FanoutLinkedNotificationRuleDstsConfigurationResponse(dict):
    ...
    def __init__(__self__, *, service_name: _builtins.str, service_dns_name: Optional[_builtins.str] = ...) -> None:
...
class FanoutLinkedNotificationRuleResponse(dict):
    ...
    def __init__(__self__, *, actions: Optional[Sequence[_builtins.str]] = ..., dsts_configuration: Optional[outputs.FanoutLinkedNotificationRuleDstsConfigurationResponse] = ..., endpoints: Optional[Sequence[outputs.ResourceProviderEndpointResponse]] = ..., token_auth_configuration: Optional[outputs.TokenAuthConfigurationResponse] = ...) -> None:
...
class FilterRuleResponse(dict):
    ...
    def __init__(__self__, *, endpoint_information: Optional[Sequence[outputs.EndpointInformationResponse]] = ..., filter_query: Optional[_builtins.str] = ...) -> None:
...
class LegacyDisallowedConditionResponse(dict):
    ...
    def __init__(__self__, *, disallowed_legacy_operations: Optional[Sequence[_builtins.str]] = ..., feature: Optional[_builtins.str] = ...) -> None:
...
class LinkedAccessCheckResponse(dict):
    ...
    def __init__(__self__, *, action_name: Optional[_builtins.str] = ..., linked_action: Optional[_builtins.str] = ..., linked_action_verb: Optional[_builtins.str] = ..., linked_property: Optional[_builtins.str] = ..., linked_type: Optional[_builtins.str] = ...) -> None:
...
class LinkedNotificationRuleResponse(dict):
    ...
    def __init__(__self__, *, actions: Optional[Sequence[_builtins.str]] = ..., actions_on_failed_operation: Optional[Sequence[_builtins.str]] = ..., fast_path_actions: Optional[Sequence[_builtins.str]] = ..., fast_path_actions_on_failed_operation: Optional[Sequence[_builtins.str]] = ..., linked_notification_timeout: Optional[_builtins.str] = ...) -> None:
...
class LinkedOperationRuleResponse(dict):
    ...
    def __init__(__self__, *, linked_action: _builtins.str, linked_operation: _builtins.str, depends_on_types: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class LocationQuotaRuleResponse(dict):
    ...
    def __init__(__self__, *, location: Optional[_builtins.str] = ..., policy: Optional[_builtins.str] = ..., quota_id: Optional[_builtins.str] = ...) -> None:
...
class LoggingRuleHiddenPropertyPathsResponse(dict):
    ...
    def __init__(__self__, *, hidden_paths_on_request: Optional[Sequence[_builtins.str]] = ..., hidden_paths_on_response: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class LoggingRuleResponse(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, detail_level: _builtins.str, direction: _builtins.str, hidden_property_paths: Optional[outputs.LoggingRuleHiddenPropertyPathsResponse] = ...) -> None:
...
class NotificationEndpointResponse(dict):
    ...
    def __init__(__self__, *, locations: Optional[Sequence[_builtins.str]] = ..., notification_destination: Optional[_builtins.str] = ...) -> None:
...
class NotificationRegistrationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, included_events: Optional[Sequence[_builtins.str]] = ..., message_scope: Optional[_builtins.str] = ..., notification_endpoints: Optional[Sequence[outputs.NotificationEndpointResponse]] = ..., notification_mode: Optional[_builtins.str] = ...) -> None:
...
class NotificationResponse(dict):
    ...
    def __init__(__self__, *, notification_type: Optional[_builtins.str] = ..., skip_notifications: Optional[_builtins.str] = ...) -> None:
...
class OpenApiConfigurationResponse(dict):
    def __init__(__self__, *, validation: Optional[outputs.OpenApiValidationResponse] = ...) -> None:
...
class OpenApiValidationResponse(dict):
    ...
    def __init__(__self__, *, allow_noncompliant_collection_response: Optional[_builtins.bool] = ...) -> None:
...
class ProviderHubMetadataThirdPartyProviderAuthorizationResponse(dict):
    ...
    def __init__(__self__, *, authorizations: Optional[Sequence[outputs.LightHouseAuthorizationResponse]] = ..., managed_by_tenant_id: Optional[_builtins.str] = ...) -> None:
...
class ProviderRegistrationPropertiesPrivateResourceProviderConfigurationResponse(dict):
    ...
    def __init__(__self__, *, allowed_subscriptions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ProviderRegistrationPropertiesProviderHubMetadataResponse(dict):
    ...
    def __init__(__self__, *, direct_rp_role_definition_id: Optional[_builtins.str] = ..., global_async_operation_resource_type_name: Optional[_builtins.str] = ..., provider_authentication: Optional[outputs.ProviderHubMetadataProviderAuthenticationResponse] = ..., provider_authorizations: Optional[Sequence[outputs.ResourceProviderAuthorizationResponse]] = ..., regional_async_operation_resource_type_name: Optional[_builtins.str] = ..., third_party_provider_authorization: Optional[outputs.ProviderHubMetadataThirdPartyProviderAuthorizationResponse] = ...) -> None:
...
class ProviderRegistrationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, capabilities: Optional[Sequence[outputs.ResourceProviderCapabilitiesResponse]] = ..., cross_tenant_token_validation: Optional[_builtins.str] = ..., custom_manifest_version: Optional[_builtins.str] = ..., dsts_configuration: Optional[outputs.ResourceProviderManifestPropertiesDstsConfigurationResponse] = ..., enable_tenant_linked_notification: Optional[_builtins.bool] = ..., features_rule: Optional[outputs.ResourceProviderManifestPropertiesFeaturesRuleResponse] = ..., global_notification_endpoints: Optional[Sequence[outputs.ResourceProviderEndpointResponse]] = ..., legacy_namespace: Optional[_builtins.str] = ..., legacy_registrations: Optional[Sequence[_builtins.str]] = ..., linked_notification_rules: Optional[Sequence[outputs.FanoutLinkedNotificationRuleResponse]] = ..., management: Optional[outputs.ResourceProviderManifestPropertiesManagementResponse] = ..., management_group_global_notification_endpoints: Optional[Sequence[outputs.ResourceProviderEndpointResponse]] = ..., metadata: Optional[Any] = ..., namespace: Optional[_builtins.str] = ..., notification_options: Optional[_builtins.str] = ..., notification_settings: Optional[outputs.ResourceProviderManifestPropertiesNotificationSettingsResponse] = ..., notifications: Optional[Sequence[outputs.NotificationResponse]] = ..., optional_features: Optional[Sequence[_builtins.str]] = ..., private_resource_provider_configuration: Optional[outputs.ProviderRegistrationPropertiesPrivateResourceProviderConfigurationResponse] = ..., provider_authentication: Optional[outputs.ResourceProviderManifestPropertiesProviderAuthenticationResponse] = ..., provider_authorizations: Optional[Sequence[outputs.ResourceProviderAuthorizationResponse]] = ..., provider_hub_metadata: Optional[outputs.ProviderRegistrationPropertiesProviderHubMetadataResponse] = ..., provider_type: Optional[_builtins.str] = ..., provider_version: Optional[_builtins.str] = ..., request_header_options: Optional[outputs.ResourceProviderManifestPropertiesRequestHeaderOptionsResponse] = ..., required_features: Optional[Sequence[_builtins.str]] = ..., resource_group_lock_option_during_move: Optional[outputs.ResourceProviderManifestPropertiesResourceGroupLockOptionDuringMoveResponse] = ..., resource_hydration_accounts: Optional[Sequence[outputs.ResourceHydrationAccountResponse]] = ..., resource_provider_authorization_rules: Optional[outputs.ResourceProviderAuthorizationRulesResponse] = ..., response_options: Optional[outputs.ResourceProviderManifestPropertiesResponseOptionsResponse] = ..., service_name: Optional[_builtins.str] = ..., services: Optional[Sequence[outputs.ResourceProviderServiceResponse]] = ..., subscription_lifecycle_notification_specifications: Optional[outputs.ProviderRegistrationPropertiesSubscriptionLifecycleNotificationSpecificationsResponse] = ..., template_deployment_options: Optional[outputs.ResourceProviderManifestPropertiesTemplateDeploymentOptionsResponse] = ..., token_auth_configuration: Optional[outputs.TokenAuthConfigurationResponse] = ...) -> None:
...
class ProviderRegistrationPropertiesSubscriptionLifecycleNotificationSpecificationsResponse(dict):
    ...
    def __init__(__self__, *, soft_delete_ttl: Optional[_builtins.str] = ..., subscription_state_override_actions: Optional[Sequence[outputs.SubscriptionStateOverrideActionResponse]] = ...) -> None:
...
class QuotaRuleResponse(dict):
    ...
    def __init__(__self__, *, location_rules: Optional[Sequence[outputs.LocationQuotaRuleResponse]] = ..., quota_policy: Optional[_builtins.str] = ..., required_features: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ResourceAccessRoleResponse(dict):
    ...
    def __init__(__self__, *, actions: Optional[Sequence[_builtins.str]] = ..., allowed_group_claims: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ResourceHydrationAccountResponse(dict):
    ...
    def __init__(__self__, *, account_name: Optional[_builtins.str] = ..., encrypted_key: Optional[_builtins.str] = ..., max_child_resource_consistency_job_limit: Optional[_builtins.float] = ..., subscription_id: Optional[_builtins.str] = ...) -> None:
...
class ResourceProviderAuthorizationManagedByAuthorizationResponse(dict):
    ...
    def __init__(__self__, *, additional_authorizations: Optional[Sequence[outputs.AdditionalAuthorizationResponse]] = ..., allow_managed_by_inheritance: Optional[_builtins.bool] = ..., managed_by_resource_role_definition_id: Optional[_builtins.str] = ...) -> None:
...
class ResourceProviderAuthorizationResponse(dict):
    ...
    def __init__(__self__, *, allowed_third_party_extensions: Optional[Sequence[outputs.ThirdPartyExtensionResponse]] = ..., application_id: Optional[_builtins.str] = ..., grouping_tag: Optional[_builtins.str] = ..., managed_by_authorization: Optional[outputs.ResourceProviderAuthorizationManagedByAuthorizationResponse] = ..., managed_by_role_definition_id: Optional[_builtins.str] = ..., role_definition_id: Optional[_builtins.str] = ...) -> None:
...
class ResourceProviderAuthorizationRulesResponse(dict):
    ...
    def __init__(__self__, *, async_operation_polling_rules: Optional[outputs.AsyncOperationPollingRulesResponse] = ...) -> None:
...
class ResourceProviderCapabilitiesResponse(dict):
    ...
    def __init__(__self__, *, effect: _builtins.str, quota_id: _builtins.str, required_features: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ResourceProviderEndpointResponse(dict):
    ...
    def __init__(__self__, *, api_versions: Optional[Sequence[_builtins.str]] = ..., enabled: Optional[_builtins.bool] = ..., endpoint_type: Optional[_builtins.str] = ..., endpoint_uri: Optional[_builtins.str] = ..., features_rule: Optional[outputs.ResourceProviderEndpointFeaturesRuleResponse] = ..., locations: Optional[Sequence[_builtins.str]] = ..., required_features: Optional[Sequence[_builtins.str]] = ..., sku_link: Optional[_builtins.str] = ..., timeout: Optional[_builtins.str] = ...) -> None:
...
class ResourceProviderManagementErrorResponseMessageOptionsResponse(dict):
    ...
    def __init__(__self__, *, server_failure_response_message_type: Optional[_builtins.str] = ...) -> None:
...
class ResourceProviderManagementExpeditedRolloutMetadataResponse(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., expedited_rollout_intent: Optional[_builtins.str] = ...) -> None:
...
class ResourceProviderManifestPropertiesManagementResponse(dict):
    ...
    def __init__(__self__, *, authorization_owners: Optional[Sequence[_builtins.str]] = ..., canary_manifest_owners: Optional[Sequence[_builtins.str]] = ..., error_response_message_options: Optional[outputs.ResourceProviderManagementErrorResponseMessageOptionsResponse] = ..., expedited_rollout_metadata: Optional[outputs.ResourceProviderManagementExpeditedRolloutMetadataResponse] = ..., expedited_rollout_submitters: Optional[Sequence[_builtins.str]] = ..., incident_contact_email: Optional[_builtins.str] = ..., incident_routing_service: Optional[_builtins.str] = ..., incident_routing_team: Optional[_builtins.str] = ..., manifest_owners: Optional[Sequence[_builtins.str]] = ..., pc_code: Optional[_builtins.str] = ..., profit_center_program_id: Optional[_builtins.str] = ..., resource_access_policy: Optional[_builtins.str] = ..., resource_access_roles: Optional[Sequence[outputs.ResourceAccessRoleResponse]] = ..., schema_owners: Optional[Sequence[_builtins.str]] = ..., service_tree_infos: Optional[Sequence[outputs.ServiceTreeInfoResponse]] = ...) -> None:
...
class ResourceProviderManifestPropertiesNotificationSettingsResponse(dict):
    ...
    def __init__(__self__, *, subscriber_settings: Optional[Sequence[outputs.SubscriberSettingResponse]] = ...) -> None:
...
class ResourceProviderManifestPropertiesRequestHeaderOptionsResponse(dict):
    ...
    def __init__(__self__, *, opt_in_headers: Optional[_builtins.str] = ..., opt_out_headers: Optional[_builtins.str] = ...) -> None:
...
class ResourceProviderManifestPropertiesResourceGroupLockOptionDuringMoveResponse(dict):
    ...
    def __init__(__self__, *, block_action_verb: Optional[_builtins.str] = ...) -> None:
...
class ResourceProviderManifestPropertiesResponseOptionsResponse(dict):
    ...
    def __init__(__self__, *, service_client_options_type: Optional[_builtins.str] = ...) -> None:
...
class ResourceProviderManifestPropertiesTemplateDeploymentOptionsResponse(dict):
    ...
    def __init__(__self__, *, preflight_options: Optional[Sequence[_builtins.str]] = ..., preflight_supported: Optional[_builtins.bool] = ...) -> None:
...
class ResourceProviderServiceResponse(dict):
    ...
    def __init__(__self__, *, service_name: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeEndpointResponse(dict):
    ...
    def __init__(__self__, *, api_version: Optional[_builtins.str] = ..., api_versions: Optional[Sequence[_builtins.str]] = ..., data_boundary: Optional[_builtins.str] = ..., dsts_configuration: Optional[outputs.ResourceTypeEndpointDstsConfigurationResponse] = ..., enabled: Optional[_builtins.bool] = ..., endpoint_type: Optional[_builtins.str] = ..., endpoint_uri: Optional[_builtins.str] = ..., extensions: Optional[Sequence[outputs.ResourceTypeExtensionResponse]] = ..., features_rule: Optional[outputs.ResourceTypeEndpointFeaturesRuleResponse] = ..., kind: Optional[_builtins.str] = ..., locations: Optional[Sequence[_builtins.str]] = ..., required_features: Optional[Sequence[_builtins.str]] = ..., sku_link: Optional[_builtins.str] = ..., timeout: Optional[_builtins.str] = ..., token_auth_configuration: Optional[outputs.TokenAuthConfigurationResponse] = ..., zones: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ResourceTypeExtensionOptionsResourceCreationBeginResponse(dict):
    ...
    def __init__(__self__, *, request: Optional[Sequence[_builtins.str]] = ..., response: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ResourceTypeExtensionResponse(dict):
    ...
    def __init__(__self__, *, endpoint_uri: Optional[_builtins.str] = ..., extension_categories: Optional[Sequence[_builtins.str]] = ..., timeout: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeOnBehalfOfTokenResponse(dict):
    ...
    def __init__(__self__, *, action_name: Optional[_builtins.str] = ..., life_time: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesAvailabilityZoneRuleResponse(dict):
    ...
    def __init__(__self__, *, availability_zone_policy: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesCapacityRuleResponse(dict):
    ...
    def __init__(__self__, *, capacity_policy: Optional[_builtins.str] = ..., sku_alias: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesCheckNameAvailabilitySpecificationsResponse(dict):
    ...
    def __init__(__self__, *, enable_default_validation: Optional[_builtins.bool] = ..., resource_types_with_custom_validation: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesExtensionOptionsResponse(dict):
    ...
    def __init__(__self__, *, resource_creation_begin: Optional[outputs.ResourceTypeExtensionOptionsResourceCreationBeginResponse] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesIdentityManagementResponse(dict):
    ...
    def __init__(__self__, *, application_id: Optional[_builtins.str] = ..., application_ids: Optional[Sequence[_builtins.str]] = ..., delegation_app_ids: Optional[Sequence[_builtins.str]] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesLegacyPolicyResponse(dict):
    ...
    def __init__(__self__, *, disallowed_conditions: Optional[Sequence[outputs.LegacyDisallowedConditionResponse]] = ..., disallowed_legacy_operations: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesMarketplaceOptionsResponse(dict):
    ...
    def __init__(__self__, *, add_on_plan_conversion_allowed: Optional[_builtins.bool] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesResourceCacheResponse(dict):
    ...
    def __init__(__self__, *, enable_resource_cache: Optional[_builtins.bool] = ..., resource_cache_expiration_timespan: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesResourceGraphConfigurationResponse(dict):
    ...
    def __init__(__self__, *, api_version: Optional[_builtins.str] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesResourceManagementOptionsBatchProvisioningSupportResponse(dict):
    ...
    def __init__(__self__, *, supported_operations: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesResourceManagementOptionsNestedProvisioningSupportResponse(dict):
    ...
    def __init__(__self__, *, minimum_api_version: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesResourceManagementOptionsResponse(dict):
    ...
    def __init__(__self__, *, batch_provisioning_support: Optional[outputs.ResourceTypeRegistrationPropertiesResourceManagementOptionsBatchProvisioningSupportResponse] = ..., delete_dependencies: Optional[Sequence[outputs.DeleteDependencyResponse]] = ..., nested_provisioning_support: Optional[outputs.ResourceTypeRegistrationPropertiesResourceManagementOptionsNestedProvisioningSupportResponse] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesResourceMovePolicyResponse(dict):
    ...
    def __init__(__self__, *, cross_resource_group_move_enabled: Optional[_builtins.bool] = ..., cross_subscription_move_enabled: Optional[_builtins.bool] = ..., validation_required: Optional[_builtins.bool] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesResourceTypeCommonAttributeManagementResponse(dict):
    ...
    def __init__(__self__, *, common_api_versions_merge_mode: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, add_resource_list_target_locations: Optional[_builtins.bool] = ..., additional_options: Optional[_builtins.str] = ..., allow_empty_role_assignments: Optional[_builtins.bool] = ..., allowed_resource_names: Optional[Sequence[outputs.AllowedResourceNameResponse]] = ..., allowed_template_deployment_reference_actions: Optional[Sequence[_builtins.str]] = ..., allowed_unauthorized_actions: Optional[Sequence[_builtins.str]] = ..., allowed_unauthorized_actions_extensions: Optional[Sequence[outputs.AllowedUnauthorizedActionsExtensionResponse]] = ..., api_profiles: Optional[Sequence[outputs.ApiProfileResponse]] = ..., async_operation_resource_type_name: Optional[_builtins.str] = ..., async_timeout_rules: Optional[Sequence[outputs.AsyncTimeoutRuleResponse]] = ..., authorization_action_mappings: Optional[Sequence[outputs.AuthorizationActionMappingResponse]] = ..., availability_zone_rule: Optional[outputs.ResourceTypeRegistrationPropertiesAvailabilityZoneRuleResponse] = ..., capacity_rule: Optional[outputs.ResourceTypeRegistrationPropertiesCapacityRuleResponse] = ..., category: Optional[_builtins.str] = ..., check_name_availability_specifications: Optional[outputs.ResourceTypeRegistrationPropertiesCheckNameAvailabilitySpecificationsResponse] = ..., common_api_versions: Optional[Sequence[_builtins.str]] = ..., cross_tenant_token_validation: Optional[_builtins.str] = ..., default_api_version: Optional[_builtins.str] = ..., disallowed_action_verbs: Optional[Sequence[_builtins.str]] = ..., disallowed_end_user_operations: Optional[Sequence[_builtins.str]] = ..., dsts_configuration: Optional[outputs.ResourceTypeRegistrationPropertiesDstsConfigurationResponse] = ..., enable_async_operation: Optional[_builtins.bool] = ..., enable_third_party_s2_s: Optional[_builtins.bool] = ..., endpoints: Optional[Sequence[outputs.ResourceTypeEndpointResponse]] = ..., extended_locations: Optional[Sequence[outputs.ExtendedLocationOptionsResponse]] = ..., extension_options: Optional[outputs.ResourceTypeRegistrationPropertiesExtensionOptionsResponse] = ..., features_rule: Optional[outputs.ResourceTypeRegistrationPropertiesFeaturesRuleResponse] = ..., frontdoor_request_mode: Optional[_builtins.str] = ..., grouping_tag: Optional[_builtins.str] = ..., identity_management: Optional[outputs.ResourceTypeRegistrationPropertiesIdentityManagementResponse] = ..., is_pure_proxy: Optional[_builtins.bool] = ..., legacy_name: Optional[_builtins.str] = ..., legacy_names: Optional[Sequence[_builtins.str]] = ..., legacy_policy: Optional[outputs.ResourceTypeRegistrationPropertiesLegacyPolicyResponse] = ..., linked_access_checks: Optional[Sequence[outputs.LinkedAccessCheckResponse]] = ..., linked_notification_rules: Optional[Sequence[outputs.LinkedNotificationRuleResponse]] = ..., linked_operation_rules: Optional[Sequence[outputs.LinkedOperationRuleResponse]] = ..., logging_rules: Optional[Sequence[outputs.LoggingRuleResponse]] = ..., management: Optional[outputs.ResourceTypeRegistrationPropertiesManagementResponse] = ..., manifest_link: Optional[_builtins.str] = ..., marketplace_options: Optional[outputs.ResourceTypeRegistrationPropertiesMarketplaceOptionsResponse] = ..., marketplace_type: Optional[_builtins.str] = ..., metadata: Optional[Any] = ..., notifications: Optional[Sequence[outputs.NotificationResponse]] = ..., on_behalf_of_tokens: Optional[outputs.ResourceTypeOnBehalfOfTokenResponse] = ..., open_api_configuration: Optional[outputs.OpenApiConfigurationResponse] = ..., policy_execution_type: Optional[_builtins.str] = ..., quota_rule: Optional[outputs.QuotaRuleResponse] = ..., regionality: Optional[_builtins.str] = ..., request_header_options: Optional[outputs.ResourceTypeRegistrationPropertiesRequestHeaderOptionsResponse] = ..., required_features: Optional[Sequence[_builtins.str]] = ..., resource_cache: Optional[outputs.ResourceTypeRegistrationPropertiesResourceCacheResponse] = ..., resource_concurrency_control_options: Optional[Mapping[str, outputs.ResourceConcurrencyControlOptionResponse]] = ..., resource_deletion_policy: Optional[_builtins.str] = ..., resource_graph_configuration: Optional[outputs.ResourceTypeRegistrationPropertiesResourceGraphConfigurationResponse] = ..., resource_management_options: Optional[outputs.ResourceTypeRegistrationPropertiesResourceManagementOptionsResponse] = ..., resource_move_policy: Optional[outputs.ResourceTypeRegistrationPropertiesResourceMovePolicyResponse] = ..., resource_provider_authorization_rules: Optional[outputs.ResourceProviderAuthorizationRulesResponse] = ..., resource_query_management: Optional[outputs.ResourceTypeRegistrationPropertiesResourceQueryManagementResponse] = ..., resource_sub_type: Optional[_builtins.str] = ..., resource_type_common_attribute_management: Optional[outputs.ResourceTypeRegistrationPropertiesResourceTypeCommonAttributeManagementResponse] = ..., resource_validation: Optional[_builtins.str] = ..., routing_rule: Optional[outputs.ResourceTypeRegistrationPropertiesRoutingRuleResponse] = ..., routing_type: Optional[_builtins.str] = ..., service_tree_infos: Optional[Sequence[outputs.ServiceTreeInfoResponse]] = ..., sku_link: Optional[_builtins.str] = ..., subscription_lifecycle_notification_specifications: Optional[outputs.ResourceTypeRegistrationPropertiesSubscriptionLifecycleNotificationSpecificationsResponse] = ..., subscription_state_rules: Optional[Sequence[outputs.SubscriptionStateRuleResponse]] = ..., supports_tags: Optional[_builtins.bool] = ..., swagger_specifications: Optional[Sequence[outputs.SwaggerSpecificationResponse]] = ..., template_deployment_options: Optional[outputs.ResourceTypeRegistrationPropertiesTemplateDeploymentOptionsResponse] = ..., template_deployment_policy: Optional[outputs.ResourceTypeRegistrationPropertiesTemplateDeploymentPolicyResponse] = ..., throttling_rules: Optional[Sequence[outputs.ThrottlingRuleResponse]] = ..., token_auth_configuration: Optional[outputs.TokenAuthConfigurationResponse] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesRoutingRuleResponse(dict):
    ...
    def __init__(__self__, *, host_resource_type: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeRegistrationPropertiesTemplateDeploymentPolicyResponse(dict):
    ...
    def __init__(__self__, *, capabilities: _builtins.str, preflight_options: _builtins.str, preflight_notifications: Optional[_builtins.str] = ...) -> None:
...
class ResourceTypeRegistrationResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, system_data: outputs.SystemDataResponse, type: _builtins.str, kind: Optional[_builtins.str] = ..., properties: Optional[outputs.ResourceTypeRegistrationPropertiesResponse] = ...) -> None:
...
class ServiceTreeInfoResponse(dict):
    ...
    def __init__(__self__, *, component_id: Optional[_builtins.str] = ..., readiness: Optional[_builtins.str] = ..., service_id: Optional[_builtins.str] = ...) -> None:
...
class SkuCostResponse(dict):
    ...
    def __init__(__self__, *, meter_id: _builtins.str, extended_unit: Optional[_builtins.str] = ..., quantity: Optional[_builtins.int] = ...) -> None:
...
class SkuLocationInfoResponse(dict):
    ...
    def __init__(__self__, *, location: _builtins.str, extended_locations: Optional[Sequence[_builtins.str]] = ..., type: Optional[_builtins.str] = ..., zone_details: Optional[Sequence[outputs.SkuZoneDetailResponse]] = ..., zones: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SkuResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, sku_settings: Sequence[outputs.SkuSettingResponse]) -> None:
...
class SkuSettingCapacityResponse(dict):
    ...
    def __init__(__self__, *, minimum: _builtins.int, default: Optional[_builtins.int] = ..., maximum: Optional[_builtins.int] = ..., scale_type: Optional[_builtins.str] = ...) -> None:
...
class SkuSettingResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, capabilities: Optional[Sequence[outputs.SkuCapabilityResponse]] = ..., capacity: Optional[outputs.SkuSettingCapacityResponse] = ..., costs: Optional[Sequence[outputs.SkuCostResponse]] = ..., family: Optional[_builtins.str] = ..., kind: Optional[_builtins.str] = ..., location_info: Optional[Sequence[outputs.SkuLocationInfoResponse]] = ..., locations: Optional[Sequence[_builtins.str]] = ..., required_features: Optional[Sequence[_builtins.str]] = ..., required_quota_ids: Optional[Sequence[_builtins.str]] = ..., size: Optional[_builtins.str] = ..., tier: Optional[_builtins.str] = ...) -> None:
...
class SkuZoneDetailResponse(dict):
    def __init__(__self__, *, capabilities: Optional[Sequence[outputs.SkuCapabilityResponse]] = ..., name: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SubscriberSettingResponse(dict):
    ...
    def __init__(__self__, *, filter_rules: Optional[Sequence[outputs.FilterRuleResponse]] = ...) -> None:
...
class SubscriptionStateRuleResponse(dict):
    ...
    def __init__(__self__, *, allowed_actions: Optional[Sequence[_builtins.str]] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class SwaggerSpecificationResponse(dict):
    ...
    def __init__(__self__, *, api_versions: Optional[Sequence[_builtins.str]] = ..., swagger_spec_folder_uri: Optional[_builtins.str] = ...) -> None:
...
class ThrottlingMetricResponse(dict):
    def __init__(__self__, *, limit: _builtins.float, type: _builtins.str, interval: Optional[_builtins.str] = ...) -> None:
...
class ThrottlingRuleResponse(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, metrics: Sequence[outputs.ThrottlingMetricResponse], application_id: Optional[Sequence[_builtins.str]] = ..., required_features: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class TokenAuthConfigurationResponse(dict):
    ...
    def __init__(__self__, *, authentication_scheme: Optional[_builtins.str] = ..., disable_certificate_authentication_fallback: Optional[_builtins.bool] = ..., signed_request_scope: Optional[_builtins.str] = ...) -> None:
