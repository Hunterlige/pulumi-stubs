...
__all__ = ['AdditionalOptionsAsyncOperation', 'AdditionalOptionsResourceTypeRegistration', 'AuthenticationScheme', 'AvailabilityZonePolicy', 'BlockActionVerb', 'CapacityPolicy', 'CommonApiVersionsMergeMode', 'CrossTenantTokenValidation', 'DataBoundary', 'EndpointType', 'EndpointTypeResourceType', 'ExpeditedRolloutIntent', 'ExtendedLocationType', 'ExtensionCategory', 'ExtensionOptionType', 'FeaturesPolicy', 'FilterOption', 'FrontdoorRequestMode', 'IdentityManagementTypes', 'Intent', 'LegacyOperation', 'LinkedAction', 'LinkedOperation', 'LoggingDetails', 'LoggingDirections', 'MarketplaceType', 'MessageScope', 'NotificationEndpointType', 'NotificationMode', 'NotificationOptions', 'NotificationType', 'OptInHeaderType', 'OptOutHeaderType', 'Policy', 'PolicyExecutionType', 'PreflightOption', 'ProviderRegistrationKind', 'QuotaPolicy', 'Readiness', 'Regionality', 'ResourceAccessPolicy', 'ResourceDeletionPolicy', 'ResourceProviderCapabilitiesEffect', 'ResourceProviderType', 'ResourceSubType', 'ResourceTypeCategory', 'ResourceTypeEndpointKind', 'ResourceTypeExtendedLocationPolicy', 'ResourceTypeRegistrationKind', 'ResourceValidation', 'Role', 'RoutingType', 'ServerFailureResponseMessageType', 'ServiceClientOptionsType', 'ServiceStatus', 'SignedRequestScope', 'SkipNotifications', 'SkuScaleType', 'SubscriptionNotificationOperation', 'SubscriptionReregistrationResult', 'SubscriptionState', 'SubscriptionTransitioningState', 'SupportedOperations', 'TemplateDeploymentCapabilities', 'TemplateDeploymentPreflightNotifications', 'TemplateDeploymentPreflightOptions', 'ThrottlingMetricType', 'TrafficRegionCategory']
@pulumi.type_token(...)
