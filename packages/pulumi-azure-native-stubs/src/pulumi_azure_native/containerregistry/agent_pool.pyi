...
class AgentPoolArgs:
    def __init__(
        ...
        *,
        ...
        os: Optional[pulumi.Input[Union[_builtins.str, OS]]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tier: Optional[pulumi.Input[_builtins.str]] = ...,
        virtual_network_subnet_resource_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @os.setter
    def os(self, value: Optional[pulumi.Input[Union[_builtins.str, OS]]]): ...
    @_builtins.property
    @pulumi.getter
    def tags(
        self,
    ...
    def virtual_network_subnet_resource_id(
        self,
