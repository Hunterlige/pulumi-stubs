...
class GetCredentialSetResult:
    ...
    def auth_credentials(
        self,
    ) -> Optional[Sequence[outputs.AuthCredentialResponse]]: ...
    @_builtins.property
...
def get_credential_set(
    credential_set_name: Optional[_builtins.str] = ...,
    registry_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetCredentialSetResult: ...
def get_credential_set_output(
...
) -> pulumi.Output[GetCredentialSetResult]: ...
