...
@pulumi.input_type
class PoolArgs:
    def __init__(__self__, *, agent_profile: pulumi.Input[Union[StatefulArgs, StatelessAgentProfileArgs]], dev_center_project_resource_id: pulumi.Input[_builtins.str], fabric_profile: pulumi.Input[VmssFabricProfileArgs], maximum_concurrency: pulumi.Input[_builtins.int], organization_profile: pulumi.Input[Union[AzureDevOpsOrganizationProfileArgs, GitHubOrganizationProfileArgs]], resource_group_name: pulumi.Input[_builtins.str], identity: Optional[pulumi.Input[ManagedServiceIdentityArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., pool_name: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_state: Optional[pulumi.Input[Union[_builtins.str, ProvisioningState]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def agent_profile(self, value: pulumi.Input[Union[StatefulArgs, StatelessAgentProfileArgs]]): # -> None:
        ...
    ...
    def dev_center_project_resource_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def fabric_profile(self, value: pulumi.Input[VmssFabricProfileArgs]): # -> None:
        ...
    ...
    def maximum_concurrency(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def organization_profile(self, value: pulumi.Input[Union[AzureDevOpsOrganizationProfileArgs, GitHubOrganizationProfileArgs]]): # -> None:
        ...
...
class Pool(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., agent_profile: Optional[pulumi.Input[Union[Union[StatefulArgs, StatefulArgsDict], Union[StatelessAgentProfileArgs, StatelessAgentProfileArgsDict]]]] = ..., dev_center_project_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., fabric_profile: Optional[pulumi.Input[Union[VmssFabricProfileArgs, VmssFabricProfileArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[ManagedServiceIdentityArgs, ManagedServiceIdentityArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., maximum_concurrency: Optional[pulumi.Input[_builtins.int]] = ..., organization_profile: Optional[pulumi.Input[Union[Union[AzureDevOpsOrganizationProfileArgs, AzureDevOpsOrganizationProfileArgsDict], Union[GitHubOrganizationProfileArgs, GitHubOrganizationProfileArgsDict]]]] = ..., pool_name: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_state: Optional[pulumi.Input[Union[_builtins.str, ProvisioningState]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
