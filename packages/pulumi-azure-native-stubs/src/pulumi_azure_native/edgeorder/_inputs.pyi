...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AdditionalConfigurationArgs', 'AdditionalConfigurationArgsDict', 'AddressDetailsArgs', 'AddressDetailsArgsDict', 'AddressPropertiesArgs', 'AddressPropertiesArgsDict', 'ChildConfigurationFilter', 'ChildConfigurationFilterDict', 'ConfigurationFilter', 'ConfigurationFilterDict', 'ContactDetailsArgs', 'ContactDetailsArgsDict', 'CustomerSubscriptionDetails', 'CustomerSubscriptionDetailsDict', 'CustomerSubscriptionRegisteredFeatures', 'CustomerSubscriptionRegisteredFeaturesDict', 'EncryptionPreferencesArgs', 'EncryptionPreferencesArgsDict', 'FilterableProperty', 'FilterablePropertyDict', 'HierarchyInformation', 'HierarchyInformationDict', 'HierarchyInformationArgs', 'HierarchyInformationArgsDict', 'ManagementResourcePreferencesArgs', 'ManagementResourcePreferencesArgsDict', 'NotificationPreferenceArgs', 'NotificationPreferenceArgsDict', 'OrderItemDetailsArgs', 'OrderItemDetailsArgsDict', 'PreferencesArgs', 'PreferencesArgsDict', 'ProductDetailsArgs', 'ProductDetailsArgsDict', 'ProvisioningDetailsArgs', 'ProvisioningDetailsArgsDict', 'ResourceIdentityArgs', 'ResourceIdentityArgsDict', 'ShippingAddressArgs', 'ShippingAddressArgsDict', 'SiteDetailsArgs', 'SiteDetailsArgsDict', 'TermCommitmentPreferencesArgs', 'TermCommitmentPreferencesArgsDict', 'TransportPreferencesArgs', 'TransportPreferencesArgsDict']
...
class AdditionalConfigurationArgs:
    def __init__(__self__, *, hierarchy_information: pulumi.Input[HierarchyInformationArgs], quantity: pulumi.Input[_builtins.int], provisioning_details: Optional[pulumi.Input[Sequence[pulumi.Input[ProvisioningDetailsArgs]]]] = ...) -> None:
    ...
    def hierarchy_information(self, value: pulumi.Input[HierarchyInformationArgs]): # -> None:
        ...
    ...
    def provisioning_details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ProvisioningDetailsArgs]]]]): # -> None:
        ...
...
class AddressDetailsArgs:
    def __init__(__self__, *, forward_address: pulumi.Input[AddressPropertiesArgs]) -> None:
    ...
    def forward_address(self, value: pulumi.Input[AddressPropertiesArgs]): # -> None:
        ...
...
class AddressPropertiesArgs:
    def __init__(__self__, *, address_classification: Optional[pulumi.Input[Union[_builtins.str, AddressClassification]]] = ..., contact_details: Optional[pulumi.Input[ContactDetailsArgs]] = ..., shipping_address: Optional[pulumi.Input[ShippingAddressArgs]] = ...) -> None:
    ...
    def address_classification(self, value: Optional[pulumi.Input[Union[_builtins.str, AddressClassification]]]): # -> None:
        ...
    ...
    def contact_details(self, value: Optional[pulumi.Input[ContactDetailsArgs]]): # -> None:
        ...
...
class ChildConfigurationFilter:
    def __init__(__self__, *, child_configuration_types: Optional[Sequence[Union[_builtins.str, ChildConfigurationType]]] = ..., hierarchy_informations: Optional[Sequence[HierarchyInformation]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="childConfigurationTypes")
    def child_configuration_types(self) -> Optional[Sequence[Union[_builtins.str, ChildConfigurationType]]]:
        
        ...
    
    @child_configuration_types.setter
    def child_configuration_types(self, value: Optional[Sequence[Union[_builtins.str, ChildConfigurationType]]]): # -> None:
        ...
    ...
    def hierarchy_informations(self, value: Optional[Sequence[HierarchyInformation]]): # -> None:
        ...
...
class ConfigurationFilter:
    def __init__(__self__, *, hierarchy_information: HierarchyInformation, child_configuration_filter: Optional[ChildConfigurationFilter] = ..., filterable_property: Optional[Sequence[FilterableProperty]] = ...) -> None:
    ...
    @hierarchy_information.setter
    def hierarchy_information(self, value: HierarchyInformation): # -> None:
        ...
    ...
    def child_configuration_filter(self, value: Optional[ChildConfigurationFilter]): # -> None:
        ...
    ...
    def filterable_property(self, value: Optional[Sequence[FilterableProperty]]): # -> None:
        ...
...
class ContactDetailsArgs:
    def __init__(__self__, *, contact_name: Optional[pulumi.Input[_builtins.str]] = ..., email_list: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., mobile: Optional[pulumi.Input[_builtins.str]] = ..., phone: Optional[pulumi.Input[_builtins.str]] = ..., phone_extension: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @contact_name.setter
    def contact_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="emailList")
    def email_list(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @email_list.setter
    def email_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class CustomerSubscriptionDetails:
    def __init__(__self__, *, quota_id: _builtins.str, location_placement_id: Optional[_builtins.str] = ..., registered_features: Optional[Sequence[CustomerSubscriptionRegisteredFeatures]] = ...) -> None:
    ...
    @quota_id.setter
    def quota_id(self, value: _builtins.str): # -> None:
        ...
    ...
    def location_placement_id(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def registered_features(self, value: Optional[Sequence[CustomerSubscriptionRegisteredFeatures]]): # -> None:
        ...
...
class CustomerSubscriptionRegisteredFeatures:
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
    ...
    @state.setter
    def state(self, value: Optional[_builtins.str]): # -> None:
        ...
...
class EncryptionPreferencesArgs:
    def __init__(__self__, *, double_encryption_status: Optional[pulumi.Input[Union[_builtins.str, DoubleEncryptionStatus]]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="doubleEncryptionStatus")
    def double_encryption_status(self) -> Optional[pulumi.Input[Union[_builtins.str, DoubleEncryptionStatus]]]:
        
        ...
    
    @double_encryption_status.setter
    def double_encryption_status(self, value: Optional[pulumi.Input[Union[_builtins.str, DoubleEncryptionStatus]]]): # -> None:
        ...
...
class FilterableProperty:
    def __init__(__self__, *, supported_values: Sequence[_builtins.str], type: Union[_builtins.str, SupportedFilterTypes]) -> None:
    ...
    def supported_values(self, value: Sequence[_builtins.str]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: Union[_builtins.str, SupportedFilterTypes]): # -> None:
        ...
...
class HierarchyInformation:
    def __init__(__self__, *, configuration_id_display_name: Optional[_builtins.str] = ..., configuration_name: Optional[_builtins.str] = ..., product_family_name: Optional[_builtins.str] = ..., product_line_name: Optional[_builtins.str] = ..., product_name: Optional[_builtins.str] = ...) -> None:
    ...
    def configuration_id_display_name(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def configuration_name(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def product_family_name(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def product_line_name(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    @product_name.setter
    def product_name(self, value: Optional[_builtins.str]): # -> None:
        ...
...
class HierarchyInformationArgs:
    def __init__(__self__, *, configuration_id_display_name: Optional[pulumi.Input[_builtins.str]] = ..., configuration_name: Optional[pulumi.Input[_builtins.str]] = ..., product_family_name: Optional[pulumi.Input[_builtins.str]] = ..., product_line_name: Optional[pulumi.Input[_builtins.str]] = ..., product_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="configurationIdDisplayName")
    def configuration_id_display_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @configuration_id_display_name.setter
    def configuration_id_display_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @product_line_name.setter
    def product_line_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ManagementResourcePreferencesArgs:
    def __init__(__self__, *, preferred_management_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="preferredManagementResourceId")
    def preferred_management_resource_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @preferred_management_resource_id.setter
    def preferred_management_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NotificationPreferenceArgs:
    def __init__(__self__, *, send_notification: pulumi.Input[_builtins.bool], stage_name: pulumi.Input[Union[_builtins.str, NotificationStageName]]) -> None:
...
class OrderItemDetailsArgs:
    def __init__(__self__, *, order_item_type: pulumi.Input[Union[_builtins.str, OrderItemType]], product_details: pulumi.Input[ProductDetailsArgs], notification_email_list: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., order_item_mode: Optional[pulumi.Input[Union[_builtins.str, OrderMode]]] = ..., preferences: Optional[pulumi.Input[PreferencesArgs]] = ..., site_details: Optional[pulumi.Input[SiteDetailsArgs]] = ...) -> None:
    ...
    def order_item_type(self, value: pulumi.Input[Union[_builtins.str, OrderItemType]]): # -> None:
        ...
    ...
    def product_details(self, value: pulumi.Input[ProductDetailsArgs]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="notificationEmailList")
    def notification_email_list(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @notification_email_list.setter
    def notification_email_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="orderItemMode")
    def order_item_mode(self) -> Optional[pulumi.Input[Union[_builtins.str, OrderMode]]]:
        
        ...
    
    @order_item_mode.setter
    def order_item_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, OrderMode]]]): # -> None:
        ...
...
class PreferencesArgs:
    def __init__(__self__, *, encryption_preferences: Optional[pulumi.Input[EncryptionPreferencesArgs]] = ..., management_resource_preferences: Optional[pulumi.Input[ManagementResourcePreferencesArgs]] = ..., notification_preferences: Optional[pulumi.Input[Sequence[pulumi.Input[NotificationPreferenceArgs]]]] = ..., term_commitment_preferences: Optional[pulumi.Input[TermCommitmentPreferencesArgs]] = ..., transport_preferences: Optional[pulumi.Input[TransportPreferencesArgs]] = ...) -> None:
    ...
    def management_resource_preferences(self, value: Optional[pulumi.Input[ManagementResourcePreferencesArgs]]): # -> None:
        ...
    ...
    def notification_preferences(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NotificationPreferenceArgs]]]]): # -> None:
        ...
    ...
    def term_commitment_preferences(self, value: Optional[pulumi.Input[TermCommitmentPreferencesArgs]]): # -> None:
        ...
...
class ProductDetailsArgs:
    def __init__(__self__, *, hierarchy_information: pulumi.Input[HierarchyInformationArgs], opt_in_additional_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[AdditionalConfigurationArgs]]]] = ..., parent_provisioning_details: Optional[pulumi.Input[ProvisioningDetailsArgs]] = ...) -> None:
    ...
    def opt_in_additional_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AdditionalConfigurationArgs]]]]): # -> None:
        ...
    ...
    def parent_provisioning_details(self, value: Optional[pulumi.Input[ProvisioningDetailsArgs]]): # -> None:
        ...
...
class ProvisioningDetailsArgs:
    def __init__(__self__, *, auto_provisioning_status: Optional[pulumi.Input[Union[_builtins.str, AutoProvisioningStatus]]] = ..., management_resource_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_end_point: Optional[pulumi.Input[_builtins.str]] = ..., quantity: Optional[pulumi.Input[_builtins.int]] = ..., ready_to_connect_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., serial_number: Optional[pulumi.Input[_builtins.str]] = ..., vendor_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="autoProvisioningStatus")
    def auto_provisioning_status(self) -> Optional[pulumi.Input[Union[_builtins.str, AutoProvisioningStatus]]]:
        
        ...
    
    @auto_provisioning_status.setter
    def auto_provisioning_status(self, value: Optional[pulumi.Input[Union[_builtins.str, AutoProvisioningStatus]]]): # -> None:
        ...
    ...
    def management_resource_arm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def provisioning_arm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def provisioning_end_point(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ready_to_connect_arm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @vendor_name.setter
    def vendor_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ShippingAddressArgs:
    def __init__(__self__, *, country: pulumi.Input[_builtins.str], address_type: Optional[pulumi.Input[Union[_builtins.str, AddressType]]] = ..., city: Optional[pulumi.Input[_builtins.str]] = ..., company_name: Optional[pulumi.Input[_builtins.str]] = ..., postal_code: Optional[pulumi.Input[_builtins.str]] = ..., state_or_province: Optional[pulumi.Input[_builtins.str]] = ..., street_address1: Optional[pulumi.Input[_builtins.str]] = ..., street_address2: Optional[pulumi.Input[_builtins.str]] = ..., street_address3: Optional[pulumi.Input[_builtins.str]] = ..., zip_extended_code: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TermCommitmentPreferencesArgs:
    def __init__(__self__, *, preferred_term_commitment_type: pulumi.Input[Union[_builtins.str, TermCommitmentType]], preferred_term_commitment_duration: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="preferredTermCommitmentType")
    def preferred_term_commitment_type(self) -> pulumi.Input[Union[_builtins.str, TermCommitmentType]]:
        
        ...
    
    @preferred_term_commitment_type.setter
    def preferred_term_commitment_type(self, value: pulumi.Input[Union[_builtins.str, TermCommitmentType]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="preferredTermCommitmentDuration")
    def preferred_term_commitment_duration(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @preferred_term_commitment_duration.setter
    def preferred_term_commitment_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
