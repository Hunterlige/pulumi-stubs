...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AdditionalConfigurationResponse', 'AddressDetailsResponse', 'AddressPropertiesResponse', 'AvailabilityInformationResponse', 'BillingMeterDetailsResponse', 'CategoryInformationResponse', 'ChildConfigurationResponse', 'ConfigurationDeviceDetailsResponse', 'ConfigurationResponse', 'ContactDetailsResponse', 'CostInformationResponse', 'DescriptionResponse', 'DeviceDetailsResponse', 'DevicePresenceVerificationDetailsResponse', 'DimensionsResponse', 'DisplayInfoResponse', 'EncryptionPreferencesResponse', 'ErrorAdditionalInfoResponse', 'ErrorDetailResponse', 'FilterablePropertyResponse', 'ForwardShippingDetailsResponse', 'GroupedChildConfigurationsResponse', 'HierarchyInformationResponse', 'ImageInformationResponse', 'LinkResponse', 'ManagementResourcePreferencesResponse', 'NotificationPreferenceResponse', 'OrderItemDetailsResponse', 'Pav2MeterDetailsResponse', 'PreferencesResponse', 'ProductDetailsResponse', 'ProductFamilyResponse', 'ProductLineResponse', 'ProductResponse', 'ProvisioningDetailsResponse', 'PurchaseMeterDetailsResponse', 'ResourceIdentityResponse', 'ResourceProviderDetailsResponse', 'ReverseShippingDetailsResponse', 'ShippingAddressResponse', 'SiteDetailsResponse', 'SpecificationResponse', 'StageDetailsResponse', 'SystemDataResponse', 'TermCommitmentInformationResponse', 'TermCommitmentPreferencesResponse', 'TermTypeDetailsResponse', 'TransportPreferencesResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
class AdditionalConfigurationResponse(dict):
    ...
    def __init__(__self__, *, hierarchy_information: outputs.HierarchyInformationResponse, quantity: _builtins.int, provisioning_details: Optional[Sequence[outputs.ProvisioningDetailsResponse]] = ...) -> None:
...
class AddressDetailsResponse(dict):
    ...
    def __init__(__self__, *, forward_address: outputs.AddressPropertiesResponse, return_address: outputs.AddressPropertiesResponse) -> None:
...
class AddressPropertiesResponse(dict):
    ...
    def __init__(__self__, *, address_validation_status: _builtins.str, provisioning_state: _builtins.str, address_classification: Optional[_builtins.str] = ..., contact_details: Optional[outputs.ContactDetailsResponse] = ..., shipping_address: Optional[outputs.ShippingAddressResponse] = ...) -> None:
...
class AvailabilityInformationResponse(dict):
    ...
    def __init__(__self__, *, availability_stage: _builtins.str, disabled_reason: _builtins.str, disabled_reason_message: _builtins.str) -> None:
...
class BillingMeterDetailsResponse(dict):
    ...
    def __init__(__self__, *, frequency: _builtins.str, meter_details: Any, metering_type: _builtins.str, name: _builtins.str, term_type_details: outputs.TermTypeDetailsResponse) -> None:
...
class CategoryInformationResponse(dict):
    ...
    def __init__(__self__, *, category_display_name: Optional[_builtins.str] = ..., category_name: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., links: Optional[Sequence[outputs.LinkResponse]] = ...) -> None:
...
class ChildConfigurationResponse(dict):
    ...
    def __init__(__self__, *, availability_information: outputs.AvailabilityInformationResponse, child_configuration_type: _builtins.str, child_configuration_types: Sequence[_builtins.str], cost_information: outputs.CostInformationResponse, description: outputs.DescriptionResponse, dimensions: outputs.DimensionsResponse, display_name: _builtins.str, filterable_properties: Sequence[outputs.FilterablePropertyResponse], fulfilled_by: _builtins.str, grouped_child_configurations: Sequence[outputs.GroupedChildConfigurationsResponse], hierarchy_information: outputs.HierarchyInformationResponse, image_information: Sequence[outputs.ImageInformationResponse], is_part_of_base_configuration: _builtins.bool, maximum_quantity: _builtins.int, minimum_quantity: _builtins.int, provisioning_support: _builtins.str, specifications: Sequence[outputs.SpecificationResponse], supported_term_commitment_durations: Sequence[_builtins.str]) -> None:
...
class ConfigurationDeviceDetailsResponse(dict):
    ...
    def __init__(__self__, *, device_details: Sequence[outputs.DeviceDetailsResponse], hierarchy_information: outputs.HierarchyInformationResponse, identification_type: _builtins.str, quantity: _builtins.int, term_commitment_information: outputs.TermCommitmentInformationResponse, display_info: Optional[outputs.DisplayInfoResponse] = ...) -> None:
...
class ConfigurationResponse(dict):
    ...
    def __init__(__self__, *, availability_information: outputs.AvailabilityInformationResponse, child_configuration_types: Sequence[_builtins.str], cost_information: outputs.CostInformationResponse, description: outputs.DescriptionResponse, dimensions: outputs.DimensionsResponse, display_name: _builtins.str, filterable_properties: Sequence[outputs.FilterablePropertyResponse], fulfilled_by: _builtins.str, grouped_child_configurations: Sequence[outputs.GroupedChildConfigurationsResponse], hierarchy_information: outputs.HierarchyInformationResponse, image_information: Sequence[outputs.ImageInformationResponse], provisioning_support: _builtins.str, specifications: Sequence[outputs.SpecificationResponse], supported_term_commitment_durations: Sequence[_builtins.str]) -> None:
...
class ContactDetailsResponse(dict):
    ...
    def __init__(__self__, *, contact_name: Optional[_builtins.str] = ..., email_list: Optional[Sequence[_builtins.str]] = ..., mobile: Optional[_builtins.str] = ..., phone: Optional[_builtins.str] = ..., phone_extension: Optional[_builtins.str] = ...) -> None:
...
class CostInformationResponse(dict):
    ...
    def __init__(__self__, *, billing_info_url: _builtins.str, billing_meter_details: Sequence[outputs.BillingMeterDetailsResponse]) -> None:
...
class DescriptionResponse(dict):
    ...
    def __init__(__self__, *, attributes: Sequence[_builtins.str], description_type: _builtins.str, keywords: Sequence[_builtins.str], links: Sequence[outputs.LinkResponse], long_description: _builtins.str, short_description: _builtins.str) -> None:
...
class DeviceDetailsResponse(dict):
    ...
    def __init__(__self__, *, display_serial_number: _builtins.str, management_resource_id: _builtins.str, management_resource_tenant_id: _builtins.str, provisioning_details: outputs.ProvisioningDetailsResponse, provisioning_support: _builtins.str, serial_number: _builtins.str) -> None:
...
class DevicePresenceVerificationDetailsResponse(dict):
    ...
    def __init__(__self__, *, message: _builtins.str, status: _builtins.str) -> None:
...
class DimensionsResponse(dict):
    ...
    def __init__(__self__, *, depth: _builtins.float, height: _builtins.float, length: _builtins.float, length_height_unit: _builtins.str, weight: _builtins.float, weight_unit: _builtins.str, width: _builtins.float) -> None:
...
class DisplayInfoResponse(dict):
    ...
    def __init__(__self__, *, configuration_display_name: _builtins.str, product_family_display_name: _builtins.str) -> None:
...
class EncryptionPreferencesResponse(dict):
    ...
    def __init__(__self__, *, double_encryption_status: Optional[_builtins.str] = ...) -> None:
...
class FilterablePropertyResponse(dict):
    ...
    def __init__(__self__, *, supported_values: Sequence[_builtins.str], type: _builtins.str) -> None:
...
class ForwardShippingDetailsResponse(dict):
    ...
    def __init__(__self__, *, carrier_display_name: _builtins.str, carrier_name: _builtins.str, tracking_id: _builtins.str, tracking_url: _builtins.str) -> None:
...
class GroupedChildConfigurationsResponse(dict):
    ...
    def __init__(__self__, *, category_information: outputs.CategoryInformationResponse, child_configurations: Sequence[outputs.ChildConfigurationResponse]) -> None:
...
class ImageInformationResponse(dict):
    ...
    def __init__(__self__, *, image_type: _builtins.str, image_url: _builtins.str) -> None:
...
class LinkResponse(dict):
    ...
    def __init__(__self__, *, link_type: _builtins.str, link_url: _builtins.str) -> None:
...
class ManagementResourcePreferencesResponse(dict):
    ...
    def __init__(__self__, *, preferred_management_resource_id: Optional[_builtins.str] = ...) -> None:
...
class NotificationPreferenceResponse(dict):
    ...
    def __init__(__self__, *, send_notification: _builtins.bool, stage_name: _builtins.str) -> None:
...
class OrderItemDetailsResponse(dict):
    ...
    def __init__(__self__, *, cancellation_reason: _builtins.str, cancellation_status: _builtins.str, current_stage: outputs.StageDetailsResponse, deletion_status: _builtins.str, error: outputs.ErrorDetailResponse, forward_shipping_details: outputs.ForwardShippingDetailsResponse, management_rp_details_list: Sequence[outputs.ResourceProviderDetailsResponse], order_item_stage_history: Sequence[outputs.StageDetailsResponse], order_item_type: _builtins.str, product_details: outputs.ProductDetailsResponse, return_reason: _builtins.str, return_status: _builtins.str, reverse_shipping_details: outputs.ReverseShippingDetailsResponse, notification_email_list: Optional[Sequence[_builtins.str]] = ..., order_item_mode: Optional[_builtins.str] = ..., preferences: Optional[outputs.PreferencesResponse] = ..., site_details: Optional[outputs.SiteDetailsResponse] = ...) -> None:
...
class Pav2MeterDetailsResponse(dict):
    ...
    def __init__(__self__, *, billing_type: _builtins.str, charging_type: _builtins.str, meter_guid: _builtins.str, multiplier: _builtins.float) -> None:
...
class PreferencesResponse(dict):
    ...
    def __init__(__self__, *, encryption_preferences: Optional[outputs.EncryptionPreferencesResponse] = ..., management_resource_preferences: Optional[outputs.ManagementResourcePreferencesResponse] = ..., notification_preferences: Optional[Sequence[outputs.NotificationPreferenceResponse]] = ..., term_commitment_preferences: Optional[outputs.TermCommitmentPreferencesResponse] = ..., transport_preferences: Optional[outputs.TransportPreferencesResponse] = ...) -> None:
...
class ProductDetailsResponse(dict):
    ...
    def __init__(__self__, *, child_configuration_device_details: Sequence[outputs.ConfigurationDeviceDetailsResponse], hierarchy_information: outputs.HierarchyInformationResponse, identification_type: _builtins.str, parent_device_details: outputs.DeviceDetailsResponse, product_double_encryption_status: _builtins.str, term_commitment_information: outputs.TermCommitmentInformationResponse, display_info: Optional[outputs.DisplayInfoResponse] = ..., opt_in_additional_configurations: Optional[Sequence[outputs.AdditionalConfigurationResponse]] = ..., parent_provisioning_details: Optional[outputs.ProvisioningDetailsResponse] = ...) -> None:
...
class ProductFamilyResponse(dict):
    ...
    def __init__(__self__, *, availability_information: outputs.AvailabilityInformationResponse, cost_information: outputs.CostInformationResponse, description: outputs.DescriptionResponse, display_name: _builtins.str, filterable_properties: Sequence[outputs.FilterablePropertyResponse], fulfilled_by: _builtins.str, hierarchy_information: outputs.HierarchyInformationResponse, image_information: Sequence[outputs.ImageInformationResponse], product_lines: Sequence[outputs.ProductLineResponse], resource_provider_details: Optional[Sequence[outputs.ResourceProviderDetailsResponse]] = ...) -> None:
...
class ProductLineResponse(dict):
    ...
    def __init__(__self__, *, availability_information: outputs.AvailabilityInformationResponse, cost_information: outputs.CostInformationResponse, description: outputs.DescriptionResponse, display_name: _builtins.str, filterable_properties: Sequence[outputs.FilterablePropertyResponse], fulfilled_by: _builtins.str, hierarchy_information: outputs.HierarchyInformationResponse, image_information: Sequence[outputs.ImageInformationResponse], products: Sequence[outputs.ProductResponse]) -> None:
...
class ProductResponse(dict):
    ...
    def __init__(__self__, *, availability_information: outputs.AvailabilityInformationResponse, configurations: Sequence[outputs.ConfigurationResponse], cost_information: outputs.CostInformationResponse, description: outputs.DescriptionResponse, display_name: _builtins.str, filterable_properties: Sequence[outputs.FilterablePropertyResponse], fulfilled_by: _builtins.str, hierarchy_information: outputs.HierarchyInformationResponse, image_information: Sequence[outputs.ImageInformationResponse]) -> None:
...
class ProvisioningDetailsResponse(dict):
    ...
    def __init__(__self__, *, unique_device_identifier: _builtins.str, auto_provisioning_status: Optional[_builtins.str] = ..., device_presence_verification: Optional[outputs.DevicePresenceVerificationDetailsResponse] = ..., management_resource_arm_id: Optional[_builtins.str] = ..., provisioning_arm_id: Optional[_builtins.str] = ..., provisioning_end_point: Optional[_builtins.str] = ..., quantity: Optional[_builtins.int] = ..., ready_to_connect_arm_id: Optional[_builtins.str] = ..., serial_number: Optional[_builtins.str] = ..., vendor_name: Optional[_builtins.str] = ...) -> None:
...
class PurchaseMeterDetailsResponse(dict):
    ...
    def __init__(__self__, *, billing_type: _builtins.str, charging_type: _builtins.str, multiplier: _builtins.float, product_id: _builtins.str, sku_id: _builtins.str, term_id: _builtins.str) -> None:
...
class ReverseShippingDetailsResponse(dict):
    ...
    def __init__(__self__, *, carrier_display_name: _builtins.str, carrier_name: _builtins.str, sas_key_for_label: _builtins.str, tracking_id: _builtins.str, tracking_url: _builtins.str) -> None:
...
class ShippingAddressResponse(dict):
    ...
    def __init__(__self__, *, country: _builtins.str, address_type: Optional[_builtins.str] = ..., city: Optional[_builtins.str] = ..., company_name: Optional[_builtins.str] = ..., postal_code: Optional[_builtins.str] = ..., state_or_province: Optional[_builtins.str] = ..., street_address1: Optional[_builtins.str] = ..., street_address2: Optional[_builtins.str] = ..., street_address3: Optional[_builtins.str] = ..., zip_extended_code: Optional[_builtins.str] = ...) -> None:
...
class StageDetailsResponse(dict):
    ...
    def __init__(__self__, *, display_name: _builtins.str, stage_name: _builtins.str, stage_status: _builtins.str, start_time: _builtins.str) -> None:
...
class TermCommitmentInformationResponse(dict):
    ...
    def __init__(__self__, *, pending_days_for_term: Optional[_builtins.int] = ..., term_commitment_type: _builtins.str, term_commitment_type_duration: _builtins.str) -> None:
...
class TermCommitmentPreferencesResponse(dict):
    ...
    def __init__(__self__, *, preferred_term_commitment_type: _builtins.str, preferred_term_commitment_duration: Optional[_builtins.str] = ...) -> None:
...
class TermTypeDetailsResponse(dict):
    ...
    def __init__(__self__, *, term_type: _builtins.str, term_type_duration: _builtins.str) -> None:
