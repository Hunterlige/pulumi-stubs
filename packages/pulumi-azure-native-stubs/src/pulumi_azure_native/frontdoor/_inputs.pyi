...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BackendPoolsSettingsArgs', 'BackendPoolsSettingsArgsDict', 'BackendPoolArgs', 'BackendPoolArgsDict', 'BackendArgs', 'BackendArgsDict', 'CacheConfigurationArgs', 'CacheConfigurationArgsDict', 'CustomRuleListArgs', 'CustomRuleListArgsDict', 'CustomRuleArgs', 'CustomRuleArgsDict', 'EndpointArgs', 'EndpointArgsDict', 'ForwardingConfigurationArgs', 'ForwardingConfigurationArgsDict', ..., ..., 'FrontendEndpointArgs', 'FrontendEndpointArgsDict', 'GroupByVariableArgs', 'GroupByVariableArgsDict', 'HeaderActionArgs', 'HeaderActionArgsDict', 'HealthProbeSettingsModelArgs', 'HealthProbeSettingsModelArgsDict', 'LoadBalancingSettingsModelArgs', 'LoadBalancingSettingsModelArgsDict', 'ManagedRuleExclusionArgs', 'ManagedRuleExclusionArgsDict', 'ManagedRuleGroupOverrideArgs', 'ManagedRuleGroupOverrideArgsDict', 'ManagedRuleOverrideArgs', 'ManagedRuleOverrideArgsDict', 'ManagedRuleSetListArgs', 'ManagedRuleSetListArgsDict', 'ManagedRuleSetArgs', 'ManagedRuleSetArgsDict', 'MatchConditionArgs', 'MatchConditionArgsDict', 'PolicySettingsArgs', 'PolicySettingsArgsDict', 'RedirectConfigurationArgs', 'RedirectConfigurationArgsDict', ..., ..., 'RoutingRuleArgs', 'RoutingRuleArgsDict', 'RulesEngineActionArgs', 'RulesEngineActionArgsDict', 'RulesEngineMatchConditionArgs', 'RulesEngineMatchConditionArgsDict', 'RulesEngineRuleArgs', 'RulesEngineRuleArgsDict', 'SkuArgs', 'SkuArgsDict', 'SubResourceArgs', 'SubResourceArgsDict', 'WebApplicationFirewallScrubbingRulesArgs', 'WebApplicationFirewallScrubbingRulesArgsDict']
...
class BackendPoolsSettingsArgs:
    def __init__(__self__, *, enforce_certificate_name_check: Optional[pulumi.Input[Union[_builtins.str, EnforceCertificateNameCheckEnabledState]]] = ..., send_recv_timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def enforce_certificate_name_check(self, value: Optional[pulumi.Input[Union[_builtins.str, EnforceCertificateNameCheckEnabledState]]]): # -> None:
        ...
    ...
    def send_recv_timeout_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class BackendPoolArgs:
    def __init__(__self__, *, backends: Optional[pulumi.Input[Sequence[pulumi.Input[BackendArgs]]]] = ..., health_probe_settings: Optional[pulumi.Input[SubResourceArgs]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., load_balancing_settings: Optional[pulumi.Input[SubResourceArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @backends.setter
    def backends(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BackendArgs]]]]): # -> None:
        ...
    ...
    def health_probe_settings(self, value: Optional[pulumi.Input[SubResourceArgs]]): # -> None:
        ...
    ...
    def load_balancing_settings(self, value: Optional[pulumi.Input[SubResourceArgs]]): # -> None:
        ...
...
@pulumi.input_type
class BackendArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., backend_host_header: Optional[pulumi.Input[_builtins.str]] = ..., enabled_state: Optional[pulumi.Input[Union[_builtins.str, BackendEnabledState]]] = ..., http_port: Optional[pulumi.Input[_builtins.int]] = ..., https_port: Optional[pulumi.Input[_builtins.int]] = ..., priority: Optional[pulumi.Input[_builtins.int]] = ..., private_link_alias: Optional[pulumi.Input[_builtins.str]] = ..., private_link_approval_message: Optional[pulumi.Input[_builtins.str]] = ..., private_link_location: Optional[pulumi.Input[_builtins.str]] = ..., private_link_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., weight: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def backend_host_header(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def enabled_state(self, value: Optional[pulumi.Input[Union[_builtins.str, BackendEnabledState]]]): # -> None:
        ...
...
class CacheConfigurationArgs:
    def __init__(__self__, *, cache_duration: Optional[pulumi.Input[_builtins.str]] = ..., dynamic_compression: Optional[pulumi.Input[Union[_builtins.str, DynamicCompressionEnabled]]] = ..., query_parameter_strip_directive: Optional[pulumi.Input[Union[_builtins.str, FrontDoorQuery]]] = ..., query_parameters: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dynamic_compression(self, value: Optional[pulumi.Input[Union[_builtins.str, DynamicCompressionEnabled]]]): # -> None:
        ...
    ...
    def query_parameter_strip_directive(self, value: Optional[pulumi.Input[Union[_builtins.str, FrontDoorQuery]]]): # -> None:
        ...
...
class CustomRuleArgs:
    def __init__(__self__, *, action: pulumi.Input[Union[_builtins.str, ActionType]], match_conditions: pulumi.Input[Sequence[pulumi.Input[MatchConditionArgs]]], priority: pulumi.Input[_builtins.int], rule_type: pulumi.Input[Union[_builtins.str, RuleType]], enabled_state: Optional[pulumi.Input[Union[_builtins.str, CustomRuleEnabledState]]] = ..., group_by: Optional[pulumi.Input[Sequence[pulumi.Input[GroupByVariableArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., rate_limit_duration_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., rate_limit_threshold: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @rule_type.setter
    def rule_type(self, value: pulumi.Input[Union[_builtins.str, RuleType]]): # -> None:
        ...
    ...
    @group_by.setter
    def group_by(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[GroupByVariableArgs]]]]): # -> None:
        ...
    ...
    def rate_limit_duration_in_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
@pulumi.input_type
class EndpointArgs:
    def __init__(__self__, *, endpoint: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ForwardingConfigurationArgs:
    def __init__(__self__, *, odata_type: pulumi.Input[_builtins.str], backend_pool: Optional[pulumi.Input[SubResourceArgs]] = ..., cache_configuration: Optional[pulumi.Input[CacheConfigurationArgs]] = ..., custom_forwarding_path: Optional[pulumi.Input[_builtins.str]] = ..., forwarding_protocol: Optional[pulumi.Input[Union[_builtins.str, FrontDoorForwardingProtocol]]] = ...) -> None:
    ...
    @backend_pool.setter
    def backend_pool(self, value: Optional[pulumi.Input[SubResourceArgs]]): # -> None:
        ...
    ...
    def custom_forwarding_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def forwarding_protocol(self, value: Optional[pulumi.Input[Union[_builtins.str, FrontDoorForwardingProtocol]]]): # -> None:
        ...
...
class FrontendEndpointArgs:
    def __init__(__self__, *, host_name: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., session_affinity_enabled_state: Optional[pulumi.Input[Union[_builtins.str, SessionAffinityEnabledState]]] = ..., session_affinity_ttl_seconds: Optional[pulumi.Input[_builtins.int]] = ..., web_application_firewall_policy_link: Optional[pulumi.Input[FrontendEndpointUpdateParametersWebApplicationFirewallPolicyLinkArgs]] = ...) -> None:
    ...
    def session_affinity_enabled_state(self, value: Optional[pulumi.Input[Union[_builtins.str, SessionAffinityEnabledState]]]): # -> None:
        ...
    ...
    def session_affinity_ttl_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def web_application_firewall_policy_link(self, value: Optional[pulumi.Input[FrontendEndpointUpdateParametersWebApplicationFirewallPolicyLinkArgs]]): # -> None:
        ...
...
class GroupByVariableArgs:
    def __init__(__self__, *, variable_name: pulumi.Input[Union[_builtins.str, VariableName]]) -> None:
    ...
    def variable_name(self, value: pulumi.Input[Union[_builtins.str, VariableName]]): # -> None:
        ...
...
class HeaderActionArgs:
    def __init__(__self__, *, header_action_type: pulumi.Input[Union[_builtins.str, HeaderActionType]], header_name: pulumi.Input[_builtins.str], value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def header_action_type(self, value: pulumi.Input[Union[_builtins.str, HeaderActionType]]): # -> None:
        ...
...
class HealthProbeSettingsModelArgs:
    def __init__(__self__, *, enabled_state: Optional[pulumi.Input[Union[_builtins.str, HealthProbeEnabled]]] = ..., health_probe_method: Optional[pulumi.Input[Union[_builtins.str, FrontDoorHealthProbeMethod]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., interval_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., protocol: Optional[pulumi.Input[Union[_builtins.str, FrontDoorProtocol]]] = ...) -> None:
    ...
    @enabled_state.setter
    def enabled_state(self, value: Optional[pulumi.Input[Union[_builtins.str, HealthProbeEnabled]]]): # -> None:
        ...
    ...
    def health_probe_method(self, value: Optional[pulumi.Input[Union[_builtins.str, FrontDoorHealthProbeMethod]]]): # -> None:
        ...
    ...
    @protocol.setter
    def protocol(self, value: Optional[pulumi.Input[Union[_builtins.str, FrontDoorProtocol]]]): # -> None:
        ...
...
class LoadBalancingSettingsModelArgs:
    def __init__(__self__, *, additional_latency_milliseconds: Optional[pulumi.Input[_builtins.int]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., sample_size: Optional[pulumi.Input[_builtins.int]] = ..., successful_samples_required: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def additional_latency_milliseconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ManagedRuleExclusionArgs:
    def __init__(__self__, *, match_variable: pulumi.Input[Union[_builtins.str, ManagedRuleExclusionMatchVariable]], selector: pulumi.Input[_builtins.str], selector_match_operator: pulumi.Input[Union[_builtins.str, ManagedRuleExclusionSelectorMatchOperator]]) -> None:
    ...
    def match_variable(self, value: pulumi.Input[Union[_builtins.str, ManagedRuleExclusionMatchVariable]]): # -> None:
        ...
    ...
    def selector_match_operator(self, value: pulumi.Input[Union[_builtins.str, ManagedRuleExclusionSelectorMatchOperator]]): # -> None:
        ...
...
class ManagedRuleGroupOverrideArgs:
    def __init__(__self__, *, rule_group_name: pulumi.Input[_builtins.str], exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[ManagedRuleExclusionArgs]]]] = ..., rules: Optional[pulumi.Input[Sequence[pulumi.Input[ManagedRuleOverrideArgs]]]] = ...) -> None:
    ...
    @exclusions.setter
    def exclusions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ManagedRuleExclusionArgs]]]]): # -> None:
        ...
...
class ManagedRuleOverrideArgs:
    def __init__(__self__, *, rule_id: pulumi.Input[_builtins.str], action: Optional[pulumi.Input[Union[_builtins.str, ActionType]]] = ..., enabled_state: Optional[pulumi.Input[Union[_builtins.str, ManagedRuleEnabledState]]] = ..., exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[ManagedRuleExclusionArgs]]]] = ...) -> None:
...
class ManagedRuleSetArgs:
    def __init__(__self__, *, rule_set_type: pulumi.Input[_builtins.str], rule_set_version: pulumi.Input[_builtins.str], exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[ManagedRuleExclusionArgs]]]] = ..., rule_group_overrides: Optional[pulumi.Input[Sequence[pulumi.Input[ManagedRuleGroupOverrideArgs]]]] = ..., rule_set_action: Optional[pulumi.Input[Union[_builtins.str, ManagedRuleSetActionType]]] = ...) -> None:
    ...
    def rule_set_action(self, value: Optional[pulumi.Input[Union[_builtins.str, ManagedRuleSetActionType]]]): # -> None:
        ...
...
class MatchConditionArgs:
    def __init__(__self__, *, match_value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], match_variable: pulumi.Input[Union[_builtins.str, MatchVariable]], operator: pulumi.Input[Union[_builtins.str, Operator]], negate_condition: Optional[pulumi.Input[_builtins.bool]] = ..., selector: Optional[pulumi.Input[_builtins.str]] = ..., transforms: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, TransformType]]]]] = ...) -> None:
    ...
    @match_variable.setter
    def match_variable(self, value: pulumi.Input[Union[_builtins.str, MatchVariable]]): # -> None:
        ...
...
class PolicySettingsArgs:
    def __init__(__self__, *, custom_block_response_body: Optional[pulumi.Input[_builtins.str]] = ..., custom_block_response_status_code: Optional[pulumi.Input[_builtins.int]] = ..., enabled_state: Optional[pulumi.Input[Union[_builtins.str, PolicyEnabledState]]] = ..., javascript_challenge_expiration_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., mode: Optional[pulumi.Input[Union[_builtins.str, PolicyMode]]] = ..., redirect_url: Optional[pulumi.Input[_builtins.str]] = ..., request_body_check: Optional[pulumi.Input[Union[_builtins.str, PolicyRequestBodyCheck]]] = ..., scrubbing_rules: Optional[pulumi.Input[Sequence[pulumi.Input[WebApplicationFirewallScrubbingRulesArgs]]]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, WebApplicationFirewallScrubbingState]]] = ...) -> None:
    ...
    def javascript_challenge_expiration_in_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def request_body_check(self, value: Optional[pulumi.Input[Union[_builtins.str, PolicyRequestBodyCheck]]]): # -> None:
        ...
...
class RedirectConfigurationArgs:
    def __init__(__self__, *, odata_type: pulumi.Input[_builtins.str], custom_fragment: Optional[pulumi.Input[_builtins.str]] = ..., custom_host: Optional[pulumi.Input[_builtins.str]] = ..., custom_path: Optional[pulumi.Input[_builtins.str]] = ..., custom_query_string: Optional[pulumi.Input[_builtins.str]] = ..., redirect_protocol: Optional[pulumi.Input[Union[_builtins.str, FrontDoorRedirectProtocol]]] = ..., redirect_type: Optional[pulumi.Input[Union[_builtins.str, FrontDoorRedirectType]]] = ...) -> None:
    ...
    @custom_host.setter
    def custom_host(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def redirect_protocol(self, value: Optional[pulumi.Input[Union[_builtins.str, FrontDoorRedirectProtocol]]]): # -> None:
        ...
    ...
    def redirect_type(self, value: Optional[pulumi.Input[Union[_builtins.str, FrontDoorRedirectType]]]): # -> None:
        ...
...
class RoutingRuleArgs:
    def __init__(__self__, *, accepted_protocols: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, FrontDoorProtocol]]]]] = ..., enabled_state: Optional[pulumi.Input[Union[_builtins.str, RoutingRuleEnabledState]]] = ..., frontend_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[SubResourceArgs]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., patterns_to_match: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., route_configuration: Optional[pulumi.Input[Union[ForwardingConfigurationArgs, RedirectConfigurationArgs]]] = ..., rules_engine: Optional[pulumi.Input[SubResourceArgs]] = ..., web_application_firewall_policy_link: Optional[pulumi.Input[RoutingRuleUpdateParametersWebApplicationFirewallPolicyLinkArgs]] = ...) -> None:
    ...
    def accepted_protocols(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, FrontDoorProtocol]]]]]): # -> None:
        ...
    ...
    @enabled_state.setter
    def enabled_state(self, value: Optional[pulumi.Input[Union[_builtins.str, RoutingRuleEnabledState]]]): # -> None:
        ...
    ...
    def frontend_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SubResourceArgs]]]]): # -> None:
        ...
    ...
    def route_configuration(self, value: Optional[pulumi.Input[Union[ForwardingConfigurationArgs, RedirectConfigurationArgs]]]): # -> None:
        ...
    ...
    @rules_engine.setter
    def rules_engine(self, value: Optional[pulumi.Input[SubResourceArgs]]): # -> None:
        ...
    ...
    @web_application_firewall_policy_link.setter
    def web_application_firewall_policy_link(self, value: Optional[pulumi.Input[RoutingRuleUpdateParametersWebApplicationFirewallPolicyLinkArgs]]): # -> None:
        ...
...
class RulesEngineActionArgs:
    def __init__(__self__, *, request_header_actions: Optional[pulumi.Input[Sequence[pulumi.Input[HeaderActionArgs]]]] = ..., response_header_actions: Optional[pulumi.Input[Sequence[pulumi.Input[HeaderActionArgs]]]] = ..., route_configuration_override: Optional[pulumi.Input[Union[ForwardingConfigurationArgs, RedirectConfigurationArgs]]] = ...) -> None:
    ...
    def request_header_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HeaderActionArgs]]]]): # -> None:
        ...
    ...
    def response_header_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HeaderActionArgs]]]]): # -> None:
        ...
    ...
    def route_configuration_override(self, value: Optional[pulumi.Input[Union[ForwardingConfigurationArgs, RedirectConfigurationArgs]]]): # -> None:
        ...
...
class RulesEngineMatchConditionArgs:
    def __init__(__self__, *, rules_engine_match_value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], rules_engine_match_variable: pulumi.Input[Union[_builtins.str, RulesEngineMatchVariable]], rules_engine_operator: pulumi.Input[Union[_builtins.str, RulesEngineOperator]], negate_condition: Optional[pulumi.Input[_builtins.bool]] = ..., selector: Optional[pulumi.Input[_builtins.str]] = ..., transforms: Optional[pulumi.Input[Sequence[pulumi.Input[Union[_builtins.str, Transform]]]]] = ...) -> None:
    ...
    def rules_engine_match_value(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def rules_engine_match_variable(self, value: pulumi.Input[Union[_builtins.str, RulesEngineMatchVariable]]): # -> None:
        ...
    ...
    def rules_engine_operator(self, value: pulumi.Input[Union[_builtins.str, RulesEngineOperator]]): # -> None:
        ...
...
class RulesEngineRuleArgs:
    def __init__(__self__, *, action: pulumi.Input[RulesEngineActionArgs], name: pulumi.Input[_builtins.str], priority: pulumi.Input[_builtins.int], match_conditions: Optional[pulumi.Input[Sequence[pulumi.Input[RulesEngineMatchConditionArgs]]]] = ..., match_processing_behavior: Optional[pulumi.Input[Union[_builtins.str, MatchProcessingBehavior]]] = ...) -> None:
    ...
    @action.setter
    def action(self, value: pulumi.Input[RulesEngineActionArgs]): # -> None:
        ...
    ...
    @match_conditions.setter
    def match_conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RulesEngineMatchConditionArgs]]]]): # -> None:
        ...
    ...
    def match_processing_behavior(self, value: Optional[pulumi.Input[Union[_builtins.str, MatchProcessingBehavior]]]): # -> None:
        ...
