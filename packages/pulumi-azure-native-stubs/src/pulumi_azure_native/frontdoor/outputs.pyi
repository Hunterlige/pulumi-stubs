...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BackendPoolResponse', 'BackendPoolsSettingsResponse', 'BackendResponse', 'CacheConfigurationResponse', 'CustomHttpsConfigurationResponse', 'CustomRuleListResponse', 'CustomRuleResponse', 'EndpointResponse', 'ForwardingConfigurationResponse', 'FrontendEndpointLinkResponse', 'FrontendEndpointResponse', ..., 'GroupByVariableResponse', 'HeaderActionResponse', 'HealthProbeSettingsModelResponse', 'KeyVaultCertificateSourceParametersResponseVault', 'LoadBalancingSettingsModelResponse', 'ManagedRuleExclusionResponse', 'ManagedRuleGroupOverrideResponse', 'ManagedRuleOverrideResponse', 'ManagedRuleSetListResponse', 'ManagedRuleSetResponse', 'MatchConditionResponse', 'PolicySettingsResponse', 'RedirectConfigurationResponse', 'RoutingRuleLinkResponse', 'RoutingRuleResponse', ..., 'RulesEngineActionResponse', 'RulesEngineMatchConditionResponse', 'RulesEngineResponse', 'RulesEngineRuleResponse', 'SecurityPolicyLinkResponse', 'SkuResponse', 'SubResourceResponse', 'WebApplicationFirewallScrubbingRulesResponse']
@pulumi.output_type
class BackendPoolResponse(dict):
    ...
    def __init__(__self__, *, resource_state: _builtins.str, type: _builtins.str, backends: Optional[Sequence[outputs.BackendResponse]] = ..., health_probe_settings: Optional[outputs.SubResourceResponse] = ..., id: Optional[_builtins.str] = ..., load_balancing_settings: Optional[outputs.SubResourceResponse] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class BackendPoolsSettingsResponse(dict):
    ...
    def __init__(__self__, *, enforce_certificate_name_check: Optional[_builtins.str] = ..., send_recv_timeout_seconds: Optional[_builtins.int] = ...) -> None:
...
class BackendResponse(dict):
    ...
    def __init__(__self__, *, private_endpoint_status: _builtins.str, address: Optional[_builtins.str] = ..., backend_host_header: Optional[_builtins.str] = ..., enabled_state: Optional[_builtins.str] = ..., http_port: Optional[_builtins.int] = ..., https_port: Optional[_builtins.int] = ..., priority: Optional[_builtins.int] = ..., private_link_alias: Optional[_builtins.str] = ..., private_link_approval_message: Optional[_builtins.str] = ..., private_link_location: Optional[_builtins.str] = ..., private_link_resource_id: Optional[_builtins.str] = ..., weight: Optional[_builtins.int] = ...) -> None:
...
class CacheConfigurationResponse(dict):
    ...
    def __init__(__self__, *, cache_duration: Optional[_builtins.str] = ..., dynamic_compression: Optional[_builtins.str] = ..., query_parameter_strip_directive: Optional[_builtins.str] = ..., query_parameters: Optional[_builtins.str] = ...) -> None:
...
class CustomHttpsConfigurationResponse(dict):
    ...
    def __init__(__self__, *, certificate_source: _builtins.str, minimum_tls_version: _builtins.str, protocol_type: _builtins.str, certificate_type: Optional[_builtins.str] = ..., secret_name: Optional[_builtins.str] = ..., secret_version: Optional[_builtins.str] = ..., vault: Optional[outputs.KeyVaultCertificateSourceParametersResponseVault] = ...) -> None:
...
class CustomRuleResponse(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, match_conditions: Sequence[outputs.MatchConditionResponse], priority: _builtins.int, rule_type: _builtins.str, enabled_state: Optional[_builtins.str] = ..., group_by: Optional[Sequence[outputs.GroupByVariableResponse]] = ..., name: Optional[_builtins.str] = ..., rate_limit_duration_in_minutes: Optional[_builtins.int] = ..., rate_limit_threshold: Optional[_builtins.int] = ...) -> None:
...
class EndpointResponse(dict):
    ...
    def __init__(__self__, *, endpoint: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class ForwardingConfigurationResponse(dict):
    ...
    def __init__(__self__, *, odata_type: _builtins.str, backend_pool: Optional[outputs.SubResourceResponse] = ..., cache_configuration: Optional[outputs.CacheConfigurationResponse] = ..., custom_forwarding_path: Optional[_builtins.str] = ..., forwarding_protocol: Optional[_builtins.str] = ...) -> None:
...
class FrontendEndpointResponse(dict):
    ...
    def __init__(__self__, *, custom_https_configuration: outputs.CustomHttpsConfigurationResponse, custom_https_provisioning_state: _builtins.str, custom_https_provisioning_substate: _builtins.str, resource_state: _builtins.str, type: _builtins.str, host_name: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., session_affinity_enabled_state: Optional[_builtins.str] = ..., session_affinity_ttl_seconds: Optional[_builtins.int] = ..., web_application_firewall_policy_link: Optional[outputs.FrontendEndpointUpdateParametersResponseWebApplicationFirewallPolicyLink] = ...) -> None:
...
class HeaderActionResponse(dict):
    ...
    def __init__(__self__, *, header_action_type: _builtins.str, header_name: _builtins.str, value: Optional[_builtins.str] = ...) -> None:
...
class HealthProbeSettingsModelResponse(dict):
    ...
    def __init__(__self__, *, resource_state: _builtins.str, type: _builtins.str, enabled_state: Optional[_builtins.str] = ..., health_probe_method: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., interval_in_seconds: Optional[_builtins.int] = ..., name: Optional[_builtins.str] = ..., path: Optional[_builtins.str] = ..., protocol: Optional[_builtins.str] = ...) -> None:
...
class LoadBalancingSettingsModelResponse(dict):
    ...
    def __init__(__self__, *, resource_state: _builtins.str, type: _builtins.str, additional_latency_milliseconds: Optional[_builtins.int] = ..., id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., sample_size: Optional[_builtins.int] = ..., successful_samples_required: Optional[_builtins.int] = ...) -> None:
...
class ManagedRuleGroupOverrideResponse(dict):
    ...
    def __init__(__self__, *, rule_group_name: _builtins.str, exclusions: Optional[Sequence[outputs.ManagedRuleExclusionResponse]] = ..., rules: Optional[Sequence[outputs.ManagedRuleOverrideResponse]] = ...) -> None:
...
class ManagedRuleOverrideResponse(dict):
    ...
    def __init__(__self__, *, rule_id: _builtins.str, action: Optional[_builtins.str] = ..., enabled_state: Optional[_builtins.str] = ..., exclusions: Optional[Sequence[outputs.ManagedRuleExclusionResponse]] = ...) -> None:
...
class ManagedRuleSetResponse(dict):
    ...
    def __init__(__self__, *, rule_set_type: _builtins.str, rule_set_version: _builtins.str, exclusions: Optional[Sequence[outputs.ManagedRuleExclusionResponse]] = ..., rule_group_overrides: Optional[Sequence[outputs.ManagedRuleGroupOverrideResponse]] = ..., rule_set_action: Optional[_builtins.str] = ...) -> None:
...
class PolicySettingsResponse(dict):
    ...
    def __init__(__self__, *, custom_block_response_body: Optional[_builtins.str] = ..., custom_block_response_status_code: Optional[_builtins.int] = ..., enabled_state: Optional[_builtins.str] = ..., javascript_challenge_expiration_in_minutes: Optional[_builtins.int] = ..., mode: Optional[_builtins.str] = ..., redirect_url: Optional[_builtins.str] = ..., request_body_check: Optional[_builtins.str] = ..., scrubbing_rules: Optional[Sequence[outputs.WebApplicationFirewallScrubbingRulesResponse]] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class RedirectConfigurationResponse(dict):
    ...
    def __init__(__self__, *, odata_type: _builtins.str, custom_fragment: Optional[_builtins.str] = ..., custom_host: Optional[_builtins.str] = ..., custom_path: Optional[_builtins.str] = ..., custom_query_string: Optional[_builtins.str] = ..., redirect_protocol: Optional[_builtins.str] = ..., redirect_type: Optional[_builtins.str] = ...) -> None:
...
class RoutingRuleResponse(dict):
    ...
    def __init__(__self__, *, resource_state: _builtins.str, type: _builtins.str, accepted_protocols: Optional[Sequence[_builtins.str]] = ..., enabled_state: Optional[_builtins.str] = ..., frontend_endpoints: Optional[Sequence[outputs.SubResourceResponse]] = ..., id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., patterns_to_match: Optional[Sequence[_builtins.str]] = ..., route_configuration: Optional[Any] = ..., rules_engine: Optional[outputs.SubResourceResponse] = ..., web_application_firewall_policy_link: Optional[outputs.RoutingRuleUpdateParametersResponseWebApplicationFirewallPolicyLink] = ...) -> None:
...
class RulesEngineActionResponse(dict):
    ...
    def __init__(__self__, *, request_header_actions: Optional[Sequence[outputs.HeaderActionResponse]] = ..., response_header_actions: Optional[Sequence[outputs.HeaderActionResponse]] = ..., route_configuration_override: Optional[Any] = ...) -> None:
...
class RulesEngineMatchConditionResponse(dict):
    ...
    def __init__(__self__, *, rules_engine_match_value: Sequence[_builtins.str], rules_engine_match_variable: _builtins.str, rules_engine_operator: _builtins.str, negate_condition: Optional[_builtins.bool] = ..., selector: Optional[_builtins.str] = ..., transforms: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class RulesEngineResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, resource_state: _builtins.str, type: _builtins.str, rules: Optional[Sequence[outputs.RulesEngineRuleResponse]] = ...) -> None:
...
class RulesEngineRuleResponse(dict):
    ...
    def __init__(__self__, *, action: outputs.RulesEngineActionResponse, name: _builtins.str, priority: _builtins.int, match_conditions: Optional[Sequence[outputs.RulesEngineMatchConditionResponse]] = ..., match_processing_behavior: Optional[_builtins.str] = ...) -> None:
