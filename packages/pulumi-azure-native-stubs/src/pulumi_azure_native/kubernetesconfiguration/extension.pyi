...
@pulumi.input_type
class ExtensionArgs:
    def __init__(__self__, *, cluster_name: pulumi.Input[_builtins.str], cluster_resource_name: pulumi.Input[_builtins.str], cluster_rp: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], aks_assigned_identity: Optional[pulumi.Input[ExtensionAksAssignedIdentityArgs]] = ..., auto_upgrade_minor_version: Optional[pulumi.Input[_builtins.bool]] = ..., configuration_protected_settings: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., configuration_settings: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., extension_name: Optional[pulumi.Input[_builtins.str]] = ..., extension_type: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[IdentityArgs]] = ..., plan: Optional[pulumi.Input[PlanArgs]] = ..., release_train: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[ScopeArgs]] = ..., statuses: Optional[pulumi.Input[Sequence[pulumi.Input[ExtensionStatusArgs]]]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def aks_assigned_identity(self, value: Optional[pulumi.Input[ExtensionAksAssignedIdentityArgs]]): # -> None:
        ...
    ...
    def configuration_settings(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def extension_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def release_train(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @statuses.setter
    def statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExtensionStatusArgs]]]]): # -> None:
        ...
...
class Extension(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., aks_assigned_identity: Optional[pulumi.Input[Union[ExtensionAksAssignedIdentityArgs, ExtensionAksAssignedIdentityArgsDict]]] = ..., auto_upgrade_minor_version: Optional[pulumi.Input[_builtins.bool]] = ..., cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., cluster_resource_name: Optional[pulumi.Input[_builtins.str]] = ..., cluster_rp: Optional[pulumi.Input[_builtins.str]] = ..., configuration_protected_settings: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., configuration_settings: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., extension_name: Optional[pulumi.Input[_builtins.str]] = ..., extension_type: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[Union[IdentityArgs, IdentityArgsDict]]] = ..., plan: Optional[pulumi.Input[Union[PlanArgs, PlanArgsDict]]] = ..., release_train: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[Union[ScopeArgs, ScopeArgsDict]]] = ..., statuses: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ExtensionStatusArgs, ExtensionStatusArgsDict]]]]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    def custom_location_settings(self) -> pulumi.Output[Mapping[str, _builtins.str]]:
