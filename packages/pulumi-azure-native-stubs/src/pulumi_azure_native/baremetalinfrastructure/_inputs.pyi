...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureBareMetalStorageInstanceIdentityArgs', 'AzureBareMetalStorageInstanceIdentityArgsDict', 'DiskArgs', 'DiskArgsDict', 'HardwareProfileArgs', 'HardwareProfileArgsDict', 'NetworkInterfaceArgs', 'NetworkInterfaceArgsDict', 'NetworkProfileArgs', 'NetworkProfileArgsDict', 'OSProfileArgs', 'OSProfileArgsDict', 'StorageBillingPropertiesArgs', 'StorageBillingPropertiesArgsDict', 'StorageProfileArgs', 'StorageProfileArgsDict', 'StoragePropertiesArgs', 'StoragePropertiesArgsDict']
...
class HardwareProfileArgs:
    def __init__(__self__, *, azure_bare_metal_instance_size: Optional[pulumi.Input[Union[_builtins.str, AzureBareMetalInstanceSizeNamesEnum]]] = ..., hardware_type: Optional[pulumi.Input[Union[_builtins.str, AzureBareMetalHardwareTypeNamesEnum]]] = ...) -> None:
    ...
    def azure_bare_metal_instance_size(self, value: Optional[pulumi.Input[Union[_builtins.str, AzureBareMetalInstanceSizeNamesEnum]]]): # -> None:
        ...
    ...
    def hardware_type(self, value: Optional[pulumi.Input[Union[_builtins.str, AzureBareMetalHardwareTypeNamesEnum]]]): # -> None:
        ...
...
class NetworkProfileArgs:
    def __init__(__self__, *, circuit_id: Optional[pulumi.Input[_builtins.str]] = ..., network_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkInterfaceArgs]]]] = ...) -> None:
...
class StorageBillingPropertiesArgs:
    def __init__(__self__, *, azure_bare_metal_storage_instance_size: Optional[pulumi.Input[_builtins.str]] = ..., billing_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def azure_bare_metal_storage_instance_size(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StoragePropertiesArgs:
    def __init__(__self__, *, generation: Optional[pulumi.Input[_builtins.str]] = ..., hardware_type: Optional[pulumi.Input[_builtins.str]] = ..., offering_type: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_state: Optional[pulumi.Input[Union[_builtins.str, ProvisioningState]]] = ..., storage_billing_properties: Optional[pulumi.Input[StorageBillingPropertiesArgs]] = ..., storage_type: Optional[pulumi.Input[_builtins.str]] = ..., workload_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @hardware_type.setter
    def hardware_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
