...
class AzureBareMetalInstanceArgs:
    def __init__(
        ...
        *,
        ...
        azure_bare_metal_instance_id: Optional[pulumi.Input[_builtins.str]] = ...,
        azure_bare_metal_instance_name: Optional[pulumi.Input[_builtins.str]] = ...,
        hardware_profile: Optional[pulumi.Input[HardwareProfileArgs]] = ...,
        hw_revision: Optional[pulumi.Input[_builtins.str]] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        network_profile: Optional[pulumi.Input[NetworkProfileArgs]] = ...,
        os_profile: Optional[pulumi.Input[OSProfileArgs]] = ...,
        partner_node_id: Optional[pulumi.Input[_builtins.str]] = ...,
        power_state: Optional[
            pulumi.Input[Union[_builtins.str, AzureBareMetalInstancePowerStateEnum]]
        ] = ...,
    ...
    def azure_bare_metal_instance_id(
        self, value: Optional[pulumi.Input[_builtins.str]]
    ): ...
    @_builtins.property
    @pulumi.getter(name="azureBareMetalInstanceName")
    def azure_bare_metal_instance_name(
        self,
