...
def get_azure_bare_metal_instance(
    azure_bare_metal_instance_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetAzureBareMetalInstanceResult: ...
def get_azure_bare_metal_instance_output(
    azure_bare_metal_instance_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetAzureBareMetalInstanceResult]: ...
