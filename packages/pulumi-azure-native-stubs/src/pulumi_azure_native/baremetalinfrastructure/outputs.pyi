...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureBareMetalStorageInstanceIdentityResponse', 'DiskResponse', 'HardwareProfileResponse', 'NetworkInterfaceResponse', 'NetworkProfileResponse', 'OSProfileResponse', 'StorageBillingPropertiesResponse', 'StorageProfileResponse', 'StoragePropertiesResponse', 'SystemDataResponse']
@pulumi.output_type
...
class HardwareProfileResponse(dict):
    ...
    def __init__(__self__, *, azure_bare_metal_instance_size: Optional[_builtins.str] = ..., hardware_type: Optional[_builtins.str] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="azureBareMetalInstanceSize")
    def azure_bare_metal_instance_size(self) -> Optional[_builtins.str]:
...
class NetworkProfileResponse(dict):
    ...
    def __init__(__self__, *, circuit_id: Optional[_builtins.str] = ..., network_interfaces: Optional[Sequence[outputs.NetworkInterfaceResponse]] = ...) -> None:
...
class StorageBillingPropertiesResponse(dict):
    ...
    def __init__(__self__, *, azure_bare_metal_storage_instance_size: Optional[_builtins.str] = ..., billing_mode: Optional[_builtins.str] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="azureBareMetalStorageInstanceSize")
    def azure_bare_metal_storage_instance_size(self) -> Optional[_builtins.str]:
...
class StoragePropertiesResponse(dict):
    ...
    def __init__(__self__, *, generation: Optional[_builtins.str] = ..., hardware_type: Optional[_builtins.str] = ..., offering_type: Optional[_builtins.str] = ..., provisioning_state: Optional[_builtins.str] = ..., storage_billing_properties: Optional[outputs.StorageBillingPropertiesResponse] = ..., storage_type: Optional[_builtins.str] = ..., workload_type: Optional[_builtins.str] = ...) -> None:
