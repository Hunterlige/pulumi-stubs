...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApiKeyResponse', 'ManagedServiceIdentityResponse', 'ProviderResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse', 'WorkspaceResourcePropertiesResponse']
@pulumi.output_type
class ApiKeyResponse(dict):
    
    def __init__(__self__, *, key: _builtins.str, created_at: Optional[_builtins.str] = ...) -> None:
...
class ProviderResponse(dict):
    ...
    def __init__(__self__, *, application_name: Optional[_builtins.str] = ..., instance_uri: Optional[_builtins.str] = ..., provider_id: Optional[_builtins.str] = ..., provider_sku: Optional[_builtins.str] = ..., provisioning_state: Optional[_builtins.str] = ..., resource_usage_id: Optional[_builtins.str] = ...) -> None:
...
class WorkspaceResourcePropertiesResponse(dict):
    ...
    def __init__(__self__, *, endpoint_uri: _builtins.str, provisioning_state: _builtins.str, usable: _builtins.str, api_key_enabled: Optional[_builtins.bool] = ..., providers: Optional[Sequence[outputs.ProviderResponse]] = ..., storage_account: Optional[_builtins.str] = ...) -> None:
