...
class GetBrokerResult:
    ...
    def __init__(__self__, auth_image=..., azure_api_version=..., broker_image=..., broker_node_tolerations=..., cardinality=..., diagnostics=..., disk_backed_message_buffer_settings=..., encrypt_internal_traffic=..., extended_location=..., health_manager_image=..., health_manager_node_tolerations=..., id=..., internal_certs=..., location=..., memory_profile=..., mode=..., name=..., provisioning_state=..., system_data=..., tags=..., type=...) -> None:
        ...
...
def get_broker(broker_name: Optional[_builtins.str] = ..., mq_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetBrokerResult:
    
    ...

def get_broker_output(broker_name: Optional[pulumi.Input[_builtins.str]] = ..., mq_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetBrokerResult]:
