...
class BrokerAuthenticationArgs:
    def __init__(__self__, *, authentication_methods: pulumi.Input[Sequence[pulumi.Input[BrokerAuthenticatorMethodsArgs]]], broker_name: pulumi.Input[_builtins.str], extended_location: pulumi.Input[ExtendedLocationPropertyArgs], listener_ref: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], mq_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], authentication_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class BrokerAuthentication(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., authentication_methods: Optional[pulumi.Input[Sequence[pulumi.Input[Union[BrokerAuthenticatorMethodsArgs, BrokerAuthenticatorMethodsArgsDict]]]]] = ..., authentication_name: Optional[pulumi.Input[_builtins.str]] = ..., broker_name: Optional[pulumi.Input[_builtins.str]] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationPropertyArgs, ExtendedLocationPropertyArgsDict]]] = ..., listener_ref: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., mq_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: BrokerAuthenticationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> BrokerAuthentication:
