...
class KafkaConnectorArgs:
    def __init__(__self__, *, extended_location: pulumi.Input[ExtendedLocationPropertyArgs], kafka_connection: pulumi.Input[KafkaRemoteBrokerConnectionSpecArgs], mq_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], client_id_prefix: Optional[pulumi.Input[_builtins.str]] = ..., image: Optional[pulumi.Input[ContainerImageArgs]] = ..., instances: Optional[pulumi.Input[_builtins.int]] = ..., kafka_connector_name: Optional[pulumi.Input[_builtins.str]] = ..., local_broker_connection: Optional[pulumi.Input[LocalBrokerConnectionSpecArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., log_level: Optional[pulumi.Input[_builtins.str]] = ..., node_tolerations: Optional[pulumi.Input[NodeTolerationsArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def kafka_connection(self, value: pulumi.Input[KafkaRemoteBrokerConnectionSpecArgs]): # -> None:
        ...
    ...
    @image.setter
    def image(self, value: Optional[pulumi.Input[ContainerImageArgs]]): # -> None:
        ...
    ...
    def kafka_connector_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class KafkaConnector(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., client_id_prefix: Optional[pulumi.Input[_builtins.str]] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationPropertyArgs, ExtendedLocationPropertyArgsDict]]] = ..., image: Optional[pulumi.Input[Union[ContainerImageArgs, ContainerImageArgsDict]]] = ..., instances: Optional[pulumi.Input[_builtins.int]] = ..., kafka_connection: Optional[pulumi.Input[Union[KafkaRemoteBrokerConnectionSpecArgs, KafkaRemoteBrokerConnectionSpecArgsDict]]] = ..., kafka_connector_name: Optional[pulumi.Input[_builtins.str]] = ..., local_broker_connection: Optional[pulumi.Input[Union[LocalBrokerConnectionSpecArgs, LocalBrokerConnectionSpecArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., log_level: Optional[pulumi.Input[_builtins.str]] = ..., mq_name: Optional[pulumi.Input[_builtins.str]] = ..., node_tolerations: Optional[pulumi.Input[Union[NodeTolerationsArgs, NodeTolerationsArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: KafkaConnectorArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> KafkaConnector:
