...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureDataExplorerConnectionPropertiesResponse', 'ConnectionPropertiesResponse', ..., 'DigitalTwinsIdentityResponse', 'EventGridResponse', 'EventHubResponse', 'ManagedIdentityReferenceResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'ServiceBusResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse']
@pulumi.output_type
class AzureDataExplorerConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, adx_database_name: _builtins.str, adx_endpoint_uri: _builtins.str, adx_resource_id: _builtins.str, connection_type: _builtins.str, event_hub_endpoint_uri: _builtins.str, event_hub_entity_path: _builtins.str, event_hub_namespace_resource_id: _builtins.str, provisioning_state: _builtins.str, adx_relationship_lifecycle_events_table_name: Optional[_builtins.str] = ..., adx_table_name: Optional[_builtins.str] = ..., adx_twin_lifecycle_events_table_name: Optional[_builtins.str] = ..., event_hub_consumer_group: Optional[_builtins.str] = ..., identity: Optional[outputs.ManagedIdentityReferenceResponse] = ..., record_property_and_item_removals: Optional[_builtins.str] = ...) -> None:
...
class ConnectionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, group_ids: Optional[Sequence[_builtins.str]] = ..., private_endpoint: Optional[outputs.PrivateEndpointResponse] = ..., private_link_service_connection_state: Optional[outputs.ConnectionPropertiesResponsePrivateLinkServiceConnectionState] = ...) -> None:
...
class EventGridResponse(dict):
    ...
    def __init__(__self__, *, access_key1: _builtins.str, created_time: _builtins.str, endpoint_type: _builtins.str, provisioning_state: _builtins.str, topic_endpoint: _builtins.str, access_key2: Optional[_builtins.str] = ..., authentication_type: Optional[_builtins.str] = ..., dead_letter_secret: Optional[_builtins.str] = ..., dead_letter_uri: Optional[_builtins.str] = ..., identity: Optional[outputs.ManagedIdentityReferenceResponse] = ...) -> None:
...
class EventHubResponse(dict):
    ...
    def __init__(__self__, *, created_time: _builtins.str, endpoint_type: _builtins.str, provisioning_state: _builtins.str, authentication_type: Optional[_builtins.str] = ..., connection_string_primary_key: Optional[_builtins.str] = ..., connection_string_secondary_key: Optional[_builtins.str] = ..., dead_letter_secret: Optional[_builtins.str] = ..., dead_letter_uri: Optional[_builtins.str] = ..., endpoint_uri: Optional[_builtins.str] = ..., entity_path: Optional[_builtins.str] = ..., identity: Optional[outputs.ManagedIdentityReferenceResponse] = ...) -> None:
...
class PrivateEndpointConnectionResponse(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, name: _builtins.str, properties: outputs.ConnectionPropertiesResponse, system_data: outputs.SystemDataResponse, type: _builtins.str) -> None:
...
class ServiceBusResponse(dict):
    ...
    def __init__(__self__, *, created_time: _builtins.str, endpoint_type: _builtins.str, provisioning_state: _builtins.str, authentication_type: Optional[_builtins.str] = ..., dead_letter_secret: Optional[_builtins.str] = ..., dead_letter_uri: Optional[_builtins.str] = ..., endpoint_uri: Optional[_builtins.str] = ..., entity_path: Optional[_builtins.str] = ..., identity: Optional[outputs.ManagedIdentityReferenceResponse] = ..., primary_connection_string: Optional[_builtins.str] = ..., secondary_connection_string: Optional[_builtins.str] = ...) -> None:
