...
class DigitalTwinArgs:
    def __init__(
        ...
        *,
        ...
        identity: Optional[pulumi.Input[DigitalTwinsIdentityArgs]] = ...,
...
class DigitalTwin(pulumi.CustomResource):
    ...
    def __init__(
        ...
        identity: Optional[
            pulumi.Input[Union[DigitalTwinsIdentityArgs, DigitalTwinsIdentityArgsDict]]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        private_endpoint_connections: Optional[
            pulumi.Input[
    ...
    def identity(
        self,
    ) -> pulumi.Output[Optional[outputs.DigitalTwinsIdentityResponse]]: ...
    @_builtins.property
