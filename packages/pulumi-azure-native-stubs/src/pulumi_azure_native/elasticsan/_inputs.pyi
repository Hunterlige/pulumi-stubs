...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EncryptionIdentityArgs', 'EncryptionIdentityArgsDict', 'EncryptionPropertiesArgs', 'EncryptionPropertiesArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'KeyVaultPropertiesArgs', 'KeyVaultPropertiesArgsDict', 'ManagedByInfoArgs', 'ManagedByInfoArgsDict', 'NetworkRuleSetArgs', 'NetworkRuleSetArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'SkuArgs', 'SkuArgsDict', 'SnapshotCreationDataArgs', 'SnapshotCreationDataArgsDict', 'SourceCreationDataArgs', 'SourceCreationDataArgsDict', 'VirtualNetworkRuleArgs', 'VirtualNetworkRuleArgsDict']
...
class EncryptionIdentityArgs:
    def __init__(__self__, *, encryption_user_assigned_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EncryptionPropertiesArgs:
    def __init__(__self__, *, encryption_identity: Optional[pulumi.Input[EncryptionIdentityArgs]] = ..., key_vault_properties: Optional[pulumi.Input[KeyVaultPropertiesArgs]] = ...) -> None:
...
class NetworkRuleSetArgs:
    def __init__(__self__, *, virtual_network_rules: Optional[pulumi.Input[Sequence[pulumi.Input[VirtualNetworkRuleArgs]]]] = ...) -> None:
...
@pulumi.input_type
class SkuArgs:
    def __init__(__self__, *, name: pulumi.Input[Union[_builtins.str, SkuName]], tier: Optional[pulumi.Input[Union[_builtins.str, SkuTier]]] = ...) -> None:
...
class SourceCreationDataArgs:
    def __init__(__self__, *, create_source: Optional[pulumi.Input[Union[_builtins.str, VolumeCreateOption]]] = ..., source_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="createSource")
    def create_source(self) -> Optional[pulumi.Input[Union[_builtins.str, VolumeCreateOption]]]:
        
        ...
    
    @create_source.setter
    def create_source(self, value: Optional[pulumi.Input[Union[_builtins.str, VolumeCreateOption]]]): # -> None:
        ...
...
class VirtualNetworkRuleArgs:
    def __init__(__self__, *, virtual_network_resource_id: pulumi.Input[_builtins.str], action: Optional[pulumi.Input[Union[_builtins.str, Action]]] = ...) -> None:
