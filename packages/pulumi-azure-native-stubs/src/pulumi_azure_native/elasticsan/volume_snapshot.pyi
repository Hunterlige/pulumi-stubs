...
class VolumeSnapshotArgs:
    def __init__(__self__, *, creation_data: pulumi.Input[SnapshotCreationDataArgs], elastic_san_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], volume_group_name: pulumi.Input[_builtins.str], snapshot_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def creation_data(self, value: pulumi.Input[SnapshotCreationDataArgs]): # -> None:
        ...
...
class VolumeSnapshot(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., creation_data: Optional[pulumi.Input[Union[SnapshotCreationDataArgs, SnapshotCreationDataArgsDict]]] = ..., elastic_san_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., snapshot_name: Optional[pulumi.Input[_builtins.str]] = ..., volume_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> VolumeSnapshot:
