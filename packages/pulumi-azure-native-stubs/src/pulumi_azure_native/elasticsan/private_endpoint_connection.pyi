...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *, elastic_san_name: pulumi.Input[_builtins.str], private_link_service_connection_state: pulumi.Input[PrivateLinkServiceConnectionStateArgs], resource_group_name: pulumi.Input[_builtins.str], group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
