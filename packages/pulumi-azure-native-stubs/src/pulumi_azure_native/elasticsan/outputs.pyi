...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EncryptionIdentityResponse', 'EncryptionPropertiesResponse', 'IdentityResponse', 'IscsiTargetInfoResponse', 'KeyVaultPropertiesResponse', 'ManagedByInfoResponse', 'NetworkRuleSetResponse', 'PrivateEndpointConnectionResponse', 'PrivateEndpointResponse', 'PrivateLinkServiceConnectionStateResponse', 'SkuResponse', 'SnapshotCreationDataResponse', 'SourceCreationDataResponse', 'SystemDataResponse', 'UserAssignedIdentityResponse', 'VirtualNetworkRuleResponse']
@pulumi.output_type
class EncryptionIdentityResponse(dict):
    ...
    def __init__(__self__, *, encryption_user_assigned_identity: Optional[_builtins.str] = ...) -> None:
...
class EncryptionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, encryption_identity: Optional[outputs.EncryptionIdentityResponse] = ..., key_vault_properties: Optional[outputs.KeyVaultPropertiesResponse] = ...) -> None:
...
class IscsiTargetInfoResponse(dict):
    ...
    def __init__(__self__, *, provisioning_state: _builtins.str, target_iqn: _builtins.str, target_portal_hostname: _builtins.str, target_portal_port: _builtins.int, status: Optional[_builtins.str] = ...) -> None:
...
class NetworkRuleSetResponse(dict):
    ...
    def __init__(__self__, *, virtual_network_rules: Optional[Sequence[outputs.VirtualNetworkRuleResponse]] = ...) -> None:
...
class SourceCreationDataResponse(dict):
    ...
    def __init__(__self__, *, create_source: Optional[_builtins.str] = ..., source_id: Optional[_builtins.str] = ...) -> None:
...
class VirtualNetworkRuleResponse(dict):
    ...
    def __init__(__self__, *, virtual_network_resource_id: _builtins.str, action: Optional[_builtins.str] = ...) -> None:
