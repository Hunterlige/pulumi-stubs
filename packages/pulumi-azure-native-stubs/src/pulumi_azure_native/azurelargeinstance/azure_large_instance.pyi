...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureLargeInstanceArgs', 'AzureLargeInstance']
@pulumi.input_type
class AzureLargeInstanceArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], azure_large_instance_id: Optional[pulumi.Input[_builtins.str]] = ..., azure_large_instance_name: Optional[pulumi.Input[_builtins.str]] = ..., hardware_profile: Optional[pulumi.Input[HardwareProfileArgs]] = ..., hw_revision: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., network_profile: Optional[pulumi.Input[NetworkProfileArgs]] = ..., os_profile: Optional[pulumi.Input[OsProfileArgs]] = ..., power_state: Optional[pulumi.Input[Union[_builtins.str, AzureLargeInstancePowerStateEnum]]] = ..., proximity_placement_group: Optional[pulumi.Input[_builtins.str]] = ..., storage_profile: Optional[pulumi.Input[StorageProfileArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def azure_large_instance_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def azure_large_instance_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @power_state.setter
    def power_state(self, value: Optional[pulumi.Input[Union[_builtins.str, AzureLargeInstancePowerStateEnum]]]): # -> None:
        ...
...
class AzureLargeInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., azure_large_instance_id: Optional[pulumi.Input[_builtins.str]] = ..., azure_large_instance_name: Optional[pulumi.Input[_builtins.str]] = ..., hardware_profile: Optional[pulumi.Input[Union[HardwareProfileArgs, HardwareProfileArgsDict]]] = ..., hw_revision: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., network_profile: Optional[pulumi.Input[Union[NetworkProfileArgs, NetworkProfileArgsDict]]] = ..., os_profile: Optional[pulumi.Input[Union[OsProfileArgs, OsProfileArgsDict]]] = ..., power_state: Optional[pulumi.Input[Union[_builtins.str, AzureLargeInstancePowerStateEnum]]] = ..., proximity_placement_group: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_profile: Optional[pulumi.Input[Union[StorageProfileArgs, StorageProfileArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: AzureLargeInstanceArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> AzureLargeInstance:
    ...
    @_builtins.property
    @pulumi.getter(name="azureLargeInstanceId")
    def azure_large_instance_id(self) -> pulumi.Output[Optional[_builtins.str]]:
