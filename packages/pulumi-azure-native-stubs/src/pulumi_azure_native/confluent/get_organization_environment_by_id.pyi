...
class GetOrganizationEnvironmentByIdResult:
    ...
    def stream_governance_config(
        self,
    ) -> Optional[outputs.StreamGovernanceConfigResponse]: ...
    @_builtins.property
...
class AwaitableGetOrganizationEnvironmentByIdResult(
    GetOrganizationEnvironmentByIdResult
):
    def __await__(self): ...

def get_organization_environment_by_id(
...
) -> pulumi.Output[GetOrganizationEnvironmentByIdResult]: ...
