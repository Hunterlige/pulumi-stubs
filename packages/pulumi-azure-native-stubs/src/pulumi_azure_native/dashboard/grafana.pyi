...
class GrafanaArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[ManagedGrafanaPropertiesArgs]] = ...,
    ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[ManagedGrafanaPropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class Grafana(pulumi.CustomResource):
    ...
    def __init__(
        ...
        properties: Optional[
            pulumi.Input[
                Union[ManagedGrafanaPropertiesArgs, ManagedGrafanaPropertiesArgsDict]
            ]
        ] = ...,
