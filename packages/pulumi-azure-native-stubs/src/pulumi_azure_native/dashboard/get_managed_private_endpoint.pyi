...
class GetManagedPrivateEndpointResult:
    ...
    def __init__(__self__, azure_api_version=..., connection_state=..., group_ids=..., id=..., location=..., name=..., private_link_resource_id=..., private_link_resource_region=..., private_link_service_private_ip=..., private_link_service_url=..., provisioning_state=..., request_message=..., system_data=..., tags=..., type=...) -> None:
        ...
...
def get_managed_private_endpoint(managed_private_endpoint_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., workspace_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetManagedPrivateEndpointResult:
    
    ...

def get_managed_private_endpoint_output(managed_private_endpoint_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetManagedPrivateEndpointResult]:
