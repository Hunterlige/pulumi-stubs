...
@pulumi.input_type
class JobArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], configuration: Optional[pulumi.Input[JobConfigurationArgs]] = ..., environment_id: Optional[pulumi.Input[_builtins.str]] = ..., extended_location: Optional[pulumi.Input[ExtendedLocationArgs]] = ..., identity: Optional[pulumi.Input[ManagedServiceIdentityArgs]] = ..., job_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., template: Optional[pulumi.Input[JobTemplateArgs]] = ..., workload_profile_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def configuration(self, value: Optional[pulumi.Input[JobConfigurationArgs]]): # -> None:
        ...
...
class Job(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., configuration: Optional[pulumi.Input[Union[JobConfigurationArgs, JobConfigurationArgsDict]]] = ..., environment_id: Optional[pulumi.Input[_builtins.str]] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationArgs, ExtendedLocationArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[ManagedServiceIdentityArgs, ManagedServiceIdentityArgsDict]]] = ..., job_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., template: Optional[pulumi.Input[Union[JobTemplateArgs, JobTemplateArgsDict]]] = ..., workload_profile_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
