...
class JavaComponentArgs:
    def __init__(__self__, *, environment_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[NacosComponentArgs, SpringBootAdminComponentArgs, SpringCloudConfigComponentArgs, SpringCloudEurekaComponentArgs, SpringCloudGatewayComponentArgs]]] = ...) -> None:
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[Union[NacosComponentArgs, SpringBootAdminComponentArgs, SpringCloudConfigComponentArgs, SpringCloudEurekaComponentArgs, SpringCloudGatewayComponentArgs]]]): # -> None:
        ...
...
class JavaComponent(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> JavaComponent:
