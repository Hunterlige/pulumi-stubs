...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetManagedEnvironmentResult', 'AwaitableGetManagedEnvironmentResult', 'get_managed_environment', 'get_managed_environment_output']
@pulumi.output_type
class GetManagedEnvironmentResult:
    
    def __init__(__self__, app_insights_configuration=..., app_logs_configuration=..., availability_zones=..., azure_api_version=..., custom_domain_configuration=..., dapr_ai_connection_string=..., dapr_ai_instrumentation_key=..., dapr_configuration=..., default_domain=..., deployment_errors=..., disk_encryption_configuration=..., event_stream_endpoint=..., id=..., identity=..., infrastructure_resource_group=..., ingress_configuration=..., keda_configuration=..., kind=..., location=..., name=..., open_telemetry_configuration=..., peer_authentication=..., peer_traffic_configuration=..., private_endpoint_connections=..., private_link_default_domain=..., provisioning_state=..., public_network_access=..., static_ip=..., system_data=..., tags=..., type=..., vnet_configuration=..., workload_profiles=..., zone_redundant=...) -> None:
        ...
...
class AwaitableGetManagedEnvironmentResult(GetManagedEnvironmentResult):
    def __await__(self): # -> Generator[Never, Any, GetManagedEnvironmentResult]:
        ...
    


def get_managed_environment(environment_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetManagedEnvironmentResult:
    
    ...

def get_managed_environment_output(environment_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetManagedEnvironmentResult]:
