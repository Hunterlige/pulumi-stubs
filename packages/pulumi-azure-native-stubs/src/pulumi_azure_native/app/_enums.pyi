...
__all__ = ['AccessMode', 'Action', 'ActiveRevisionsMode', 'Affinity', 'AppProtocol', 'BindingType', 'CertificateType', 'ClientCredentialMethod', 'ContainerType', 'CookieExpirationConvention', 'DotNetComponentType', 'ExtendedLocationTypes', 'ForwardProxyConvention', 'IdentitySettingsLifeCycle', 'ImageType', 'IngressClientCertificateMode', 'IngressTargetPortHttpScheme', 'IngressTransportMethod', 'JavaComponentType', 'Kind', 'Level', 'LifecycleType', 'LogLevel', 'ManagedCertificateDomainControlValidation', 'ManagedServiceIdentityType', 'PatchingMode', 'PoolManagementType', 'PrivateEndpointServiceConnectionStatus', 'PublicNetworkAccess', 'Scheme', 'SessionNetworkStatus', 'SessionProbeType', 'StorageType', 'TriggerType', 'Type', 'UnauthenticatedClientActionV2', 'WeekDay']
