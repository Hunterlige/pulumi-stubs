...
class ManagedEnvironmentArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], app_insights_configuration: Optional[pulumi.Input[AppInsightsConfigurationArgs]] = ..., app_logs_configuration: Optional[pulumi.Input[AppLogsConfigurationArgs]] = ..., availability_zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., custom_domain_configuration: Optional[pulumi.Input[CustomDomainConfigurationArgs]] = ..., dapr_ai_connection_string: Optional[pulumi.Input[_builtins.str]] = ..., dapr_ai_instrumentation_key: Optional[pulumi.Input[_builtins.str]] = ..., disk_encryption_configuration: Optional[pulumi.Input[DiskEncryptionConfigurationArgs]] = ..., environment_name: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[ManagedServiceIdentityArgs]] = ..., infrastructure_resource_group: Optional[pulumi.Input[_builtins.str]] = ..., ingress_configuration: Optional[pulumi.Input[IngressConfigurationArgs]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., open_telemetry_configuration: Optional[pulumi.Input[OpenTelemetryConfigurationArgs]] = ..., peer_authentication: Optional[pulumi.Input[ManagedEnvironmentPeerAuthenticationArgs]] = ..., peer_traffic_configuration: Optional[pulumi.Input[ManagedEnvironmentPeerTrafficConfigurationArgs]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., vnet_configuration: Optional[pulumi.Input[VnetConfigurationArgs]] = ..., workload_profiles: Optional[pulumi.Input[Sequence[pulumi.Input[WorkloadProfileArgs]]]] = ..., zone_redundant: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def app_insights_configuration(self, value: Optional[pulumi.Input[AppInsightsConfigurationArgs]]): # -> None:
        ...
    ...
    def app_logs_configuration(self, value: Optional[pulumi.Input[AppLogsConfigurationArgs]]): # -> None:
        ...
    ...
    def infrastructure_resource_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ingress_configuration(self, value: Optional[pulumi.Input[IngressConfigurationArgs]]): # -> None:
        ...
    ...
    def open_telemetry_configuration(self, value: Optional[pulumi.Input[OpenTelemetryConfigurationArgs]]): # -> None:
        ...
    ...
    def peer_authentication(self, value: Optional[pulumi.Input[ManagedEnvironmentPeerAuthenticationArgs]]): # -> None:
        ...
    ...
    def peer_traffic_configuration(self, value: Optional[pulumi.Input[ManagedEnvironmentPeerTrafficConfigurationArgs]]): # -> None:
        ...
    ...
    def workload_profiles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkloadProfileArgs]]]]): # -> None:
        ...
...
class ManagedEnvironment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., app_insights_configuration: Optional[pulumi.Input[Union[AppInsightsConfigurationArgs, AppInsightsConfigurationArgsDict]]] = ..., app_logs_configuration: Optional[pulumi.Input[Union[AppLogsConfigurationArgs, AppLogsConfigurationArgsDict]]] = ..., availability_zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., custom_domain_configuration: Optional[pulumi.Input[Union[CustomDomainConfigurationArgs, CustomDomainConfigurationArgsDict]]] = ..., dapr_ai_connection_string: Optional[pulumi.Input[_builtins.str]] = ..., dapr_ai_instrumentation_key: Optional[pulumi.Input[_builtins.str]] = ..., disk_encryption_configuration: Optional[pulumi.Input[Union[DiskEncryptionConfigurationArgs, DiskEncryptionConfigurationArgsDict]]] = ..., environment_name: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[Union[ManagedServiceIdentityArgs, ManagedServiceIdentityArgsDict]]] = ..., infrastructure_resource_group: Optional[pulumi.Input[_builtins.str]] = ..., ingress_configuration: Optional[pulumi.Input[Union[IngressConfigurationArgs, IngressConfigurationArgsDict]]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., open_telemetry_configuration: Optional[pulumi.Input[Union[OpenTelemetryConfigurationArgs, OpenTelemetryConfigurationArgsDict]]] = ..., peer_authentication: Optional[pulumi.Input[Union[ManagedEnvironmentPeerAuthenticationArgs, ManagedEnvironmentPeerAuthenticationArgsDict]]] = ..., peer_traffic_configuration: Optional[pulumi.Input[Union[ManagedEnvironmentPeerTrafficConfigurationArgs, ManagedEnvironmentPeerTrafficConfigurationArgsDict]]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., vnet_configuration: Optional[pulumi.Input[Union[VnetConfigurationArgs, VnetConfigurationArgsDict]]] = ..., workload_profiles: Optional[pulumi.Input[Sequence[pulumi.Input[Union[WorkloadProfileArgs, WorkloadProfileArgsDict]]]]] = ..., zone_redundant: Optional[pulumi.Input[_builtins.bool]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ManagedEnvironmentArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ManagedEnvironment:
