...
class ContainerAppsAuthConfigArgs:
    def __init__(__self__, *, container_app_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], auth_config_name: Optional[pulumi.Input[_builtins.str]] = ..., encryption_settings: Optional[pulumi.Input[EncryptionSettingsArgs]] = ..., global_validation: Optional[pulumi.Input[GlobalValidationArgs]] = ..., http_settings: Optional[pulumi.Input[HttpSettingsArgs]] = ..., identity_providers: Optional[pulumi.Input[IdentityProvidersArgs]] = ..., login: Optional[pulumi.Input[LoginArgs]] = ..., platform: Optional[pulumi.Input[AuthPlatformArgs]] = ...) -> None:
    ...
    def auth_config_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ContainerAppsAuthConfig(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., auth_config_name: Optional[pulumi.Input[_builtins.str]] = ..., container_app_name: Optional[pulumi.Input[_builtins.str]] = ..., encryption_settings: Optional[pulumi.Input[Union[EncryptionSettingsArgs, EncryptionSettingsArgsDict]]] = ..., global_validation: Optional[pulumi.Input[Union[GlobalValidationArgs, GlobalValidationArgsDict]]] = ..., http_settings: Optional[pulumi.Input[Union[HttpSettingsArgs, HttpSettingsArgsDict]]] = ..., identity_providers: Optional[pulumi.Input[Union[IdentityProvidersArgs, IdentityProvidersArgsDict]]] = ..., login: Optional[pulumi.Input[Union[LoginArgs, LoginArgsDict]]] = ..., platform: Optional[pulumi.Input[Union[AuthPlatformArgs, AuthPlatformArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ContainerAppsAuthConfigArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ContainerAppsAuthConfig:
