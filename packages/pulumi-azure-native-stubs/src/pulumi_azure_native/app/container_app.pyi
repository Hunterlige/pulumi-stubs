...
class ContainerAppArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], configuration: Optional[pulumi.Input[ConfigurationArgs]] = ..., container_app_name: Optional[pulumi.Input[_builtins.str]] = ..., environment_id: Optional[pulumi.Input[_builtins.str]] = ..., extended_location: Optional[pulumi.Input[ExtendedLocationArgs]] = ..., identity: Optional[pulumi.Input[ManagedServiceIdentityArgs]] = ..., kind: Optional[pulumi.Input[Union[_builtins.str, Kind]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., managed_by: Optional[pulumi.Input[_builtins.str]] = ..., managed_environment_id: Optional[pulumi.Input[_builtins.str]] = ..., patching_configuration: Optional[pulumi.Input[ContainerAppPatchingConfigurationArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., template: Optional[pulumi.Input[TemplateArgs]] = ..., workload_profile_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def configuration(self, value: Optional[pulumi.Input[ConfigurationArgs]]): # -> None:
        ...
    ...
    def container_app_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def patching_configuration(self, value: Optional[pulumi.Input[ContainerAppPatchingConfigurationArgs]]): # -> None:
        ...
    ...
    @template.setter
    def template(self, value: Optional[pulumi.Input[TemplateArgs]]): # -> None:
        ...
...
class ContainerApp(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., configuration: Optional[pulumi.Input[Union[ConfigurationArgs, ConfigurationArgsDict]]] = ..., container_app_name: Optional[pulumi.Input[_builtins.str]] = ..., environment_id: Optional[pulumi.Input[_builtins.str]] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationArgs, ExtendedLocationArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[ManagedServiceIdentityArgs, ManagedServiceIdentityArgsDict]]] = ..., kind: Optional[pulumi.Input[Union[_builtins.str, Kind]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., managed_by: Optional[pulumi.Input[_builtins.str]] = ..., managed_environment_id: Optional[pulumi.Input[_builtins.str]] = ..., patching_configuration: Optional[pulumi.Input[Union[ContainerAppPatchingConfigurationArgs, ContainerAppPatchingConfigurationArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., template: Optional[pulumi.Input[Union[TemplateArgs, TemplateArgsDict]]] = ..., workload_profile_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ContainerAppArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> ContainerApp:
