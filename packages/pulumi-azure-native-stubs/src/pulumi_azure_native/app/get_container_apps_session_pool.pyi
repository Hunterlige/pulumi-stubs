...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetContainerAppsSessionPoolResult', 'AwaitableGetContainerAppsSessionPoolResult', 'get_container_apps_session_pool', 'get_container_apps_session_pool_output']
@pulumi.output_type
class GetContainerAppsSessionPoolResult:
    
    def __init__(__self__, azure_api_version=..., container_type=..., custom_container_template=..., dynamic_pool_configuration=..., environment_id=..., id=..., identity=..., location=..., managed_identity_settings=..., name=..., node_count=..., pool_management_endpoint=..., pool_management_type=..., provisioning_state=..., scale_configuration=..., secrets=..., session_network_configuration=..., system_data=..., tags=..., type=...) -> None:
        ...
...
class AwaitableGetContainerAppsSessionPoolResult(GetContainerAppsSessionPoolResult):
    def __await__(self): # -> Generator[Never, Any, GetContainerAppsSessionPoolResult]:
        ...
    


def get_container_apps_session_pool(resource_group_name: Optional[_builtins.str] = ..., session_pool_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetContainerAppsSessionPoolResult:
    
    ...

def get_container_apps_session_pool_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., session_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetContainerAppsSessionPoolResult]:
