...
class ManagedCertificateArgs:
    def __init__(
        ...
        *,
        ...
        managed_certificate_name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[pulumi.Input[ManagedCertificatePropertiesArgs]] = ...,
    ...
    def managed_certificate_name(self) -> Optional[pulumi.Input[_builtins.str]]: ...
    @managed_certificate_name.setter
    def managed_certificate_name(
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[ManagedCertificatePropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[ManagedCertificatePropertiesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class ManagedCertificate(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[outputs.ManagedCertificateResponseProperties]: ...
    @_builtins.property
