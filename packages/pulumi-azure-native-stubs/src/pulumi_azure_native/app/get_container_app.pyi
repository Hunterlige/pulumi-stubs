...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetContainerAppResult', 'AwaitableGetContainerAppResult', 'get_container_app', 'get_container_app_output']
@pulumi.output_type
class GetContainerAppResult:
    
    def __init__(__self__, azure_api_version=..., configuration=..., custom_domain_verification_id=..., deployment_errors=..., environment_id=..., event_stream_endpoint=..., extended_location=..., id=..., identity=..., kind=..., latest_ready_revision_name=..., latest_revision_fqdn=..., latest_revision_name=..., location=..., managed_by=..., managed_environment_id=..., name=..., outbound_ip_addresses=..., patching_configuration=..., provisioning_state=..., running_status=..., system_data=..., tags=..., template=..., type=..., workload_profile_name=...) -> None:
        ...
...
class AwaitableGetContainerAppResult(GetContainerAppResult):
    def __await__(self): # -> Generator[Never, Any, GetContainerAppResult]:
        ...
    


def get_container_app(container_app_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetContainerAppResult:
    
    ...

def get_container_app_output(container_app_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetContainerAppResult]:
