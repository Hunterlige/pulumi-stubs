...
@pulumi.input_type
class TopicArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], data_residency_boundary: Optional[pulumi.Input[Union[_builtins.str, DataResidencyBoundary]]] = ..., disable_local_auth: Optional[pulumi.Input[_builtins.bool]] = ..., event_type_info: Optional[pulumi.Input[EventTypeInfoArgs]] = ..., identity: Optional[pulumi.Input[IdentityInfoArgs]] = ..., inbound_ip_rules: Optional[pulumi.Input[Sequence[pulumi.Input[InboundIpRuleArgs]]]] = ..., input_schema: Optional[pulumi.Input[Union[_builtins.str, InputSchema]]] = ..., input_schema_mapping: Optional[pulumi.Input[JsonInputSchemaMappingArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., minimum_tls_version_allowed: Optional[pulumi.Input[Union[_builtins.str, TlsVersion]]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., topic_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class Topic(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., data_residency_boundary: Optional[pulumi.Input[Union[_builtins.str, DataResidencyBoundary]]] = ..., disable_local_auth: Optional[pulumi.Input[_builtins.bool]] = ..., event_type_info: Optional[pulumi.Input[Union[EventTypeInfoArgs, EventTypeInfoArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[IdentityInfoArgs, IdentityInfoArgsDict]]] = ..., inbound_ip_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[InboundIpRuleArgs, InboundIpRuleArgsDict]]]]] = ..., input_schema: Optional[pulumi.Input[Union[_builtins.str, InputSchema]]] = ..., input_schema_mapping: Optional[pulumi.Input[Union[JsonInputSchemaMappingArgs, JsonInputSchemaMappingArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., minimum_tls_version_allowed: Optional[pulumi.Input[Union[_builtins.str, TlsVersion]]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., topic_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
