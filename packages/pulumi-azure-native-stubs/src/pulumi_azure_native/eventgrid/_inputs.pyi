...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AzureFunctionEventSubscriptionDestinationArgs', 'AzureFunctionEventSubscriptionDestinationArgsDict', 'BoolEqualsAdvancedFilterArgs', 'BoolEqualsAdvancedFilterArgsDict', 'BoolEqualsFilterArgs', 'BoolEqualsFilterArgsDict', 'ClientCertificateAuthenticationArgs', 'ClientCertificateAuthenticationArgsDict', 'ConnectionStateArgs', 'ConnectionStateArgsDict', 'CustomDomainConfigurationArgs', 'CustomDomainConfigurationArgsDict', 'CustomDomainIdentityArgs', 'CustomDomainIdentityArgsDict', 'DeadLetterWithResourceIdentityArgs', 'DeadLetterWithResourceIdentityArgsDict', 'DeliveryConfigurationArgs', 'DeliveryConfigurationArgsDict', 'DeliveryWithResourceIdentityArgs', 'DeliveryWithResourceIdentityArgsDict', 'DynamicDeliveryAttributeMappingArgs', 'DynamicDeliveryAttributeMappingArgsDict', 'DynamicRoutingEnrichmentArgs', 'DynamicRoutingEnrichmentArgsDict', 'EventHubEventSubscriptionDestinationArgs', 'EventHubEventSubscriptionDestinationArgsDict', 'EventSubscriptionFilterArgs', 'EventSubscriptionFilterArgsDict', 'EventSubscriptionIdentityArgs', 'EventSubscriptionIdentityArgsDict', 'EventTypeInfoArgs', 'EventTypeInfoArgsDict', 'FiltersConfigurationArgs', 'FiltersConfigurationArgsDict', 'HybridConnectionEventSubscriptionDestinationArgs', ..., 'IdentityInfoArgs', 'IdentityInfoArgsDict', 'InboundIpRuleArgs', 'InboundIpRuleArgsDict', 'InlineEventPropertiesArgs', 'InlineEventPropertiesArgsDict', 'IsNotNullAdvancedFilterArgs', 'IsNotNullAdvancedFilterArgsDict', 'IsNotNullFilterArgs', 'IsNotNullFilterArgsDict', 'IsNullOrUndefinedAdvancedFilterArgs', 'IsNullOrUndefinedAdvancedFilterArgsDict', 'IsNullOrUndefinedFilterArgs', 'IsNullOrUndefinedFilterArgsDict', 'JsonFieldWithDefaultArgs', 'JsonFieldWithDefaultArgsDict', 'JsonFieldArgs', 'JsonFieldArgsDict', 'JsonInputSchemaMappingArgs', 'JsonInputSchemaMappingArgsDict', 'MonitorAlertEventSubscriptionDestinationArgs', 'MonitorAlertEventSubscriptionDestinationArgsDict', 'NamespaceSkuArgs', 'NamespaceSkuArgsDict', 'NamespaceTopicEventSubscriptionDestinationArgs', 'NamespaceTopicEventSubscriptionDestinationArgsDict', 'NumberGreaterThanAdvancedFilterArgs', 'NumberGreaterThanAdvancedFilterArgsDict', 'NumberGreaterThanFilterArgs', 'NumberGreaterThanFilterArgsDict', 'NumberGreaterThanOrEqualsAdvancedFilterArgs', 'NumberGreaterThanOrEqualsAdvancedFilterArgsDict', 'NumberGreaterThanOrEqualsFilterArgs', 'NumberGreaterThanOrEqualsFilterArgsDict', 'NumberInAdvancedFilterArgs', 'NumberInAdvancedFilterArgsDict', 'NumberInFilterArgs', 'NumberInFilterArgsDict', 'NumberInRangeAdvancedFilterArgs', 'NumberInRangeAdvancedFilterArgsDict', 'NumberInRangeFilterArgs', 'NumberInRangeFilterArgsDict', 'NumberLessThanAdvancedFilterArgs', 'NumberLessThanAdvancedFilterArgsDict', 'NumberLessThanFilterArgs', 'NumberLessThanFilterArgsDict', 'NumberLessThanOrEqualsAdvancedFilterArgs', 'NumberLessThanOrEqualsAdvancedFilterArgsDict', 'NumberLessThanOrEqualsFilterArgs', 'NumberLessThanOrEqualsFilterArgsDict', 'NumberNotInAdvancedFilterArgs', 'NumberNotInAdvancedFilterArgsDict', 'NumberNotInFilterArgs', 'NumberNotInFilterArgsDict', 'NumberNotInRangeAdvancedFilterArgs', 'NumberNotInRangeAdvancedFilterArgsDict', 'NumberNotInRangeFilterArgs', 'NumberNotInRangeFilterArgsDict', 'PartnerAuthorizationArgs', 'PartnerAuthorizationArgsDict', 'PartnerTopicInfoArgs', 'PartnerTopicInfoArgsDict', 'PartnerArgs', 'PartnerArgsDict', 'PrivateEndpointConnectionArgs', 'PrivateEndpointConnectionArgsDict', 'PrivateEndpointArgs', 'PrivateEndpointArgsDict', 'PushInfoArgs', 'PushInfoArgsDict', 'QueueInfoArgs', 'QueueInfoArgsDict', 'RetryPolicyArgs', 'RetryPolicyArgsDict', 'RoutingEnrichmentsArgs', 'RoutingEnrichmentsArgsDict', 'RoutingIdentityInfoArgs', 'RoutingIdentityInfoArgsDict', 'ServiceBusQueueEventSubscriptionDestinationArgs', ..., 'ServiceBusTopicEventSubscriptionDestinationArgs', ..., 'StaticDeliveryAttributeMappingArgs', 'StaticDeliveryAttributeMappingArgsDict', 'StaticStringRoutingEnrichmentArgs', 'StaticStringRoutingEnrichmentArgsDict', 'StorageBlobDeadLetterDestinationArgs', 'StorageBlobDeadLetterDestinationArgsDict', 'StorageQueueEventSubscriptionDestinationArgs', 'StorageQueueEventSubscriptionDestinationArgsDict', 'StringBeginsWithAdvancedFilterArgs', 'StringBeginsWithAdvancedFilterArgsDict', 'StringBeginsWithFilterArgs', 'StringBeginsWithFilterArgsDict', 'StringContainsAdvancedFilterArgs', 'StringContainsAdvancedFilterArgsDict', 'StringContainsFilterArgs', 'StringContainsFilterArgsDict', 'StringEndsWithAdvancedFilterArgs', 'StringEndsWithAdvancedFilterArgsDict', 'StringEndsWithFilterArgs', 'StringEndsWithFilterArgsDict', 'StringInAdvancedFilterArgs', 'StringInAdvancedFilterArgsDict', 'StringInFilterArgs', 'StringInFilterArgsDict', 'StringNotBeginsWithAdvancedFilterArgs', 'StringNotBeginsWithAdvancedFilterArgsDict', 'StringNotBeginsWithFilterArgs', 'StringNotBeginsWithFilterArgsDict', 'StringNotContainsAdvancedFilterArgs', 'StringNotContainsAdvancedFilterArgsDict', 'StringNotContainsFilterArgs', 'StringNotContainsFilterArgsDict', 'StringNotEndsWithAdvancedFilterArgs', 'StringNotEndsWithAdvancedFilterArgsDict', 'StringNotEndsWithFilterArgs', 'StringNotEndsWithFilterArgsDict', 'StringNotInAdvancedFilterArgs', 'StringNotInAdvancedFilterArgsDict', 'StringNotInFilterArgs', 'StringNotInFilterArgsDict', 'TopicSpacesConfigurationArgs', 'TopicSpacesConfigurationArgsDict', 'TopicsConfigurationArgs', 'TopicsConfigurationArgsDict', 'UserIdentityPropertiesArgs', 'UserIdentityPropertiesArgsDict', 'WebHookEventSubscriptionDestinationArgs', 'WebHookEventSubscriptionDestinationArgsDict']
...
class AzureFunctionEventSubscriptionDestinationArgs:
    def __init__(__self__, *, endpoint_type: pulumi.Input[_builtins.str], delivery_attribute_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DynamicDeliveryAttributeMappingArgs, StaticDeliveryAttributeMappingArgs]]]]] = ..., max_events_per_batch: Optional[pulumi.Input[_builtins.int]] = ..., preferred_batch_size_in_kilobytes: Optional[pulumi.Input[_builtins.int]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def delivery_attribute_mappings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DynamicDeliveryAttributeMappingArgs, StaticDeliveryAttributeMappingArgs]]]]]): # -> None:
        ...
    ...
    def max_events_per_batch(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def preferred_batch_size_in_kilobytes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class BoolEqualsAdvancedFilterArgs:
    def __init__(__self__, *, operator_type: pulumi.Input[_builtins.str], key: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def operator_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClientCertificateAuthenticationArgs:
    def __init__(__self__, *, allowed_thumbprints: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., validation_scheme: Optional[pulumi.Input[Union[_builtins.str, ClientCertificateValidationScheme]]] = ...) -> None:
    ...
    def allowed_thumbprints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def validation_scheme(self, value: Optional[pulumi.Input[Union[_builtins.str, ClientCertificateValidationScheme]]]): # -> None:
        ...
...
class CustomDomainConfigurationArgs:
    def __init__(__self__, *, fully_qualified_domain_name: pulumi.Input[_builtins.str], certificate_url: Optional[pulumi.Input[_builtins.str]] = ..., expected_txt_record_name: Optional[pulumi.Input[_builtins.str]] = ..., expected_txt_record_value: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[CustomDomainIdentityArgs]] = ..., validation_state: Optional[pulumi.Input[Union[_builtins.str, CustomDomainValidationState]]] = ...) -> None:
    ...
    def fully_qualified_domain_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def expected_txt_record_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def expected_txt_record_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @identity.setter
    def identity(self, value: Optional[pulumi.Input[CustomDomainIdentityArgs]]): # -> None:
        ...
    ...
    def validation_state(self, value: Optional[pulumi.Input[Union[_builtins.str, CustomDomainValidationState]]]): # -> None:
        ...
...
class CustomDomainIdentityArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[Union[_builtins.str, CustomDomainIdentityType]]] = ..., user_assigned_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, CustomDomainIdentityType]]]): # -> None:
        ...
...
class DeadLetterWithResourceIdentityArgs:
    def __init__(__self__, *, dead_letter_destination: Optional[pulumi.Input[StorageBlobDeadLetterDestinationArgs]] = ..., identity: Optional[pulumi.Input[EventSubscriptionIdentityArgs]] = ...) -> None:
    ...
    @identity.setter
    def identity(self, value: Optional[pulumi.Input[EventSubscriptionIdentityArgs]]): # -> None:
        ...
...
class DeliveryConfigurationArgs:
    def __init__(__self__, *, delivery_mode: Optional[pulumi.Input[Union[_builtins.str, DeliveryMode]]] = ..., push: Optional[pulumi.Input[PushInfoArgs]] = ..., queue: Optional[pulumi.Input[QueueInfoArgs]] = ...) -> None:
    ...
    def delivery_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, DeliveryMode]]]): # -> None:
        ...
    ...
    @push.setter
    def push(self, value: Optional[pulumi.Input[PushInfoArgs]]): # -> None:
        ...
    ...
    @queue.setter
    def queue(self, value: Optional[pulumi.Input[QueueInfoArgs]]): # -> None:
        ...
...
class DeliveryWithResourceIdentityArgs:
    def __init__(__self__, *, destination: Optional[pulumi.Input[Union[AzureFunctionEventSubscriptionDestinationArgs, EventHubEventSubscriptionDestinationArgs, HybridConnectionEventSubscriptionDestinationArgs, MonitorAlertEventSubscriptionDestinationArgs, NamespaceTopicEventSubscriptionDestinationArgs, ServiceBusQueueEventSubscriptionDestinationArgs, ServiceBusTopicEventSubscriptionDestinationArgs, StorageQueueEventSubscriptionDestinationArgs, WebHookEventSubscriptionDestinationArgs]]] = ..., identity: Optional[pulumi.Input[EventSubscriptionIdentityArgs]] = ...) -> None:
...
class DynamicDeliveryAttributeMappingArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], name: Optional[pulumi.Input[_builtins.str]] = ..., source_field: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @source_field.setter
    def source_field(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventHubEventSubscriptionDestinationArgs:
    def __init__(__self__, *, endpoint_type: pulumi.Input[_builtins.str], delivery_attribute_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DynamicDeliveryAttributeMappingArgs, StaticDeliveryAttributeMappingArgs]]]]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EventSubscriptionFilterArgs:
    ...
    def enable_advanced_filtering_on_arrays(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def included_event_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def is_subject_case_sensitive(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def subject_begins_with(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def subject_ends_with(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventSubscriptionIdentityArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[Union[_builtins.str, EventSubscriptionIdentityType]]] = ..., user_assigned_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, EventSubscriptionIdentityType]]]): # -> None:
        ...
...
class EventTypeInfoArgs:
    def __init__(__self__, *, inline_event_types: Optional[pulumi.Input[Mapping[str, pulumi.Input[InlineEventPropertiesArgs]]]] = ..., kind: Optional[pulumi.Input[Union[_builtins.str, EventDefinitionKind]]] = ...) -> None:
    ...
    def inline_event_types(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[InlineEventPropertiesArgs]]]]): # -> None:
        ...
    ...
    @kind.setter
    def kind(self, value: Optional[pulumi.Input[Union[_builtins.str, EventDefinitionKind]]]): # -> None:
        ...
...
class IdentityInfoArgs:
    def __init__(__self__, *, principal_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, IdentityType]]] = ..., user_assigned_identities: Optional[pulumi.Input[Mapping[str, pulumi.Input[UserIdentityPropertiesArgs]]]] = ...) -> None:
    ...
    def user_assigned_identities(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[UserIdentityPropertiesArgs]]]]): # -> None:
        ...
...
class InboundIpRuleArgs:
    def __init__(__self__, *, action: Optional[pulumi.Input[Union[_builtins.str, IpActionType]]] = ..., ip_mask: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @action.setter
    def action(self, value: Optional[pulumi.Input[Union[_builtins.str, IpActionType]]]): # -> None:
        ...
    ...
    @ip_mask.setter
    def ip_mask(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InlineEventPropertiesArgs:
    def __init__(__self__, *, data_schema_url: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., documentation_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def data_schema_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def documentation_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IsNotNullAdvancedFilterArgs:
    def __init__(__self__, *, operator_type: pulumi.Input[_builtins.str], key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JsonFieldWithDefaultArgs:
    def __init__(__self__, *, default_value: Optional[pulumi.Input[_builtins.str]] = ..., source_field: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class JsonFieldArgs:
    def __init__(__self__, *, source_field: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JsonInputSchemaMappingArgs:
    def __init__(__self__, *, input_schema_mapping_type: pulumi.Input[_builtins.str], data_version: Optional[pulumi.Input[JsonFieldWithDefaultArgs]] = ..., event_time: Optional[pulumi.Input[JsonFieldArgs]] = ..., event_type: Optional[pulumi.Input[JsonFieldWithDefaultArgs]] = ..., id: Optional[pulumi.Input[JsonFieldArgs]] = ..., subject: Optional[pulumi.Input[JsonFieldWithDefaultArgs]] = ..., topic: Optional[pulumi.Input[JsonFieldArgs]] = ...) -> None:
    ...
    def input_schema_mapping_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @data_version.setter
    def data_version(self, value: Optional[pulumi.Input[JsonFieldWithDefaultArgs]]): # -> None:
        ...
    ...
    @event_time.setter
    def event_time(self, value: Optional[pulumi.Input[JsonFieldArgs]]): # -> None:
        ...
    ...
    @event_type.setter
    def event_type(self, value: Optional[pulumi.Input[JsonFieldWithDefaultArgs]]): # -> None:
        ...
    ...
    @id.setter
    def id(self, value: Optional[pulumi.Input[JsonFieldArgs]]): # -> None:
        ...
    ...
    @subject.setter
    def subject(self, value: Optional[pulumi.Input[JsonFieldWithDefaultArgs]]): # -> None:
        ...
    ...
    @topic.setter
    def topic(self, value: Optional[pulumi.Input[JsonFieldArgs]]): # -> None:
        ...
...
class MonitorAlertEventSubscriptionDestinationArgs:
    def __init__(__self__, *, endpoint_type: pulumi.Input[_builtins.str], action_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., severity: Optional[pulumi.Input[Union[_builtins.str, MonitorAlertSeverity]]] = ...) -> None:
    ...
    @severity.setter
    def severity(self, value: Optional[pulumi.Input[Union[_builtins.str, MonitorAlertSeverity]]]): # -> None:
        ...
...
class NamespaceSkuArgs:
    def __init__(__self__, *, capacity: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[Union[_builtins.str, SkuName]]] = ...) -> None:
...
class NamespaceTopicEventSubscriptionDestinationArgs:
    def __init__(__self__, *, endpoint_type: pulumi.Input[_builtins.str], resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NumberGreaterThanAdvancedFilterArgs:
    def __init__(__self__, *, operator_type: pulumi.Input[_builtins.str], key: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
...
class NumberInAdvancedFilterArgs:
    def __init__(__self__, *, operator_type: pulumi.Input[_builtins.str], key: Optional[pulumi.Input[_builtins.str]] = ..., values: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.float]]]] = ...) -> None:
    ...
    @values.setter
    def values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.float]]]]): # -> None:
        ...
...
class NumberInRangeAdvancedFilterArgs:
    def __init__(__self__, *, operator_type: pulumi.Input[_builtins.str], key: Optional[pulumi.Input[_builtins.str]] = ..., values: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[_builtins.float]]]]]] = ...) -> None:
    ...
    @values.setter
    def values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[_builtins.float]]]]]]): # -> None:
        ...
...
class PartnerAuthorizationArgs:
    def __init__(__self__, *, authorized_partners_list: Optional[pulumi.Input[Sequence[pulumi.Input[PartnerArgs]]]] = ..., default_maximum_expiration_time_in_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def authorized_partners_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PartnerArgs]]]]): # -> None:
        ...
    ...
    def default_maximum_expiration_time_in_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class PartnerTopicInfoArgs:
    def __init__(__self__, *, azure_subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., event_type_info: Optional[pulumi.Input[EventTypeInfoArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., source: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def azure_subscription_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def resource_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class PartnerArgs:
    def __init__(__self__, *, authorization_expiration_time_in_utc: Optional[pulumi.Input[_builtins.str]] = ..., partner_name: Optional[pulumi.Input[_builtins.str]] = ..., partner_registration_immutable_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authorization_expiration_time_in_utc(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @partner_name.setter
    def partner_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def partner_registration_immutable_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *, group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., private_endpoint: Optional[pulumi.Input[PrivateEndpointArgs]] = ..., private_link_service_connection_state: Optional[pulumi.Input[ConnectionStateArgs]] = ..., provisioning_state: Optional[pulumi.Input[Union[_builtins.str, ResourceProvisioningState]]] = ...) -> None:
...
@pulumi.input_type
class PushInfoArgs:
    def __init__(__self__, *, dead_letter_destination_with_resource_identity: Optional[pulumi.Input[DeadLetterWithResourceIdentityArgs]] = ..., delivery_with_resource_identity: Optional[pulumi.Input[DeliveryWithResourceIdentityArgs]] = ..., destination: Optional[pulumi.Input[Union[AzureFunctionEventSubscriptionDestinationArgs, EventHubEventSubscriptionDestinationArgs, HybridConnectionEventSubscriptionDestinationArgs, MonitorAlertEventSubscriptionDestinationArgs, NamespaceTopicEventSubscriptionDestinationArgs, ServiceBusQueueEventSubscriptionDestinationArgs, ServiceBusTopicEventSubscriptionDestinationArgs, StorageQueueEventSubscriptionDestinationArgs, WebHookEventSubscriptionDestinationArgs]]] = ..., event_time_to_live: Optional[pulumi.Input[_builtins.str]] = ..., max_delivery_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def dead_letter_destination_with_resource_identity(self, value: Optional[pulumi.Input[DeadLetterWithResourceIdentityArgs]]): # -> None:
        ...
    ...
    def event_time_to_live(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class QueueInfoArgs:
    def __init__(__self__, *, dead_letter_destination_with_resource_identity: Optional[pulumi.Input[DeadLetterWithResourceIdentityArgs]] = ..., event_time_to_live: Optional[pulumi.Input[_builtins.str]] = ..., max_delivery_count: Optional[pulumi.Input[_builtins.int]] = ..., receive_lock_duration_in_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def receive_lock_duration_in_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class RetryPolicyArgs:
    def __init__(__self__, *, event_time_to_live_in_minutes: Optional[pulumi.Input[_builtins.int]] = ..., max_delivery_attempts: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def event_time_to_live_in_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_delivery_attempts(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class RoutingEnrichmentsArgs:
    def __init__(__self__, *, dynamic: Optional[pulumi.Input[Sequence[pulumi.Input[DynamicRoutingEnrichmentArgs]]]] = ..., static: Optional[pulumi.Input[Sequence[pulumi.Input[StaticStringRoutingEnrichmentArgs]]]] = ...) -> None:
        ...
    ...
    @dynamic.setter
    def dynamic(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DynamicRoutingEnrichmentArgs]]]]): # -> None:
        ...
    ...
    @static.setter
    def static(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StaticStringRoutingEnrichmentArgs]]]]): # -> None:
        ...
...
class RoutingIdentityInfoArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[Union[_builtins.str, RoutingIdentityType]]] = ..., user_assigned_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, RoutingIdentityType]]]): # -> None:
        ...
...
class StaticDeliveryAttributeMappingArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], is_secret: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @is_secret.setter
    def is_secret(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class StaticStringRoutingEnrichmentArgs:
    def __init__(__self__, *, value_type: pulumi.Input[_builtins.str], key: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StorageBlobDeadLetterDestinationArgs:
    def __init__(__self__, *, endpoint_type: pulumi.Input[_builtins.str], blob_container_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StorageQueueEventSubscriptionDestinationArgs:
    def __init__(__self__, *, endpoint_type: pulumi.Input[_builtins.str], queue_message_time_to_live_in_seconds: Optional[pulumi.Input[_builtins.float]] = ..., queue_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def queue_message_time_to_live_in_seconds(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class StringBeginsWithAdvancedFilterArgs:
    def __init__(__self__, *, operator_type: pulumi.Input[_builtins.str], key: Optional[pulumi.Input[_builtins.str]] = ..., values: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class TopicSpacesConfigurationArgs:
    def __init__(__self__, *, custom_domains: Optional[pulumi.Input[Sequence[pulumi.Input[CustomDomainConfigurationArgs]]]] = ..., maximum_client_sessions_per_authentication_name: Optional[pulumi.Input[_builtins.int]] = ..., maximum_session_expiry_in_hours: Optional[pulumi.Input[_builtins.int]] = ..., route_topic_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., routing_enrichments: Optional[pulumi.Input[RoutingEnrichmentsArgs]] = ..., routing_identity_info: Optional[pulumi.Input[RoutingIdentityInfoArgs]] = ..., state: Optional[pulumi.Input[Union[_builtins.str, TopicSpacesConfigurationState]]] = ...) -> None:
    ...
    def custom_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CustomDomainConfigurationArgs]]]]): # -> None:
        ...
    ...
    def maximum_client_sessions_per_authentication_name(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def maximum_session_expiry_in_hours(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def route_topic_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def routing_enrichments(self, value: Optional[pulumi.Input[RoutingEnrichmentsArgs]]): # -> None:
        ...
    ...
    def routing_identity_info(self, value: Optional[pulumi.Input[RoutingIdentityInfoArgs]]): # -> None:
        ...
    ...
    @state.setter
    def state(self, value: Optional[pulumi.Input[Union[_builtins.str, TopicSpacesConfigurationState]]]): # -> None:
        ...
...
class TopicsConfigurationArgs:
    def __init__(__self__, *, custom_domains: Optional[pulumi.Input[Sequence[pulumi.Input[CustomDomainConfigurationArgs]]]] = ...) -> None:
...
class WebHookEventSubscriptionDestinationArgs:
    def __init__(__self__, *, endpoint_type: pulumi.Input[_builtins.str], azure_active_directory_application_id_or_uri: Optional[pulumi.Input[_builtins.str]] = ..., azure_active_directory_tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., delivery_attribute_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DynamicDeliveryAttributeMappingArgs, StaticDeliveryAttributeMappingArgs]]]]] = ..., endpoint_url: Optional[pulumi.Input[_builtins.str]] = ..., max_events_per_batch: Optional[pulumi.Input[_builtins.int]] = ..., minimum_tls_version_allowed: Optional[pulumi.Input[Union[_builtins.str, TlsVersion]]] = ..., preferred_batch_size_in_kilobytes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def azure_active_directory_application_id_or_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def azure_active_directory_tenant_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
