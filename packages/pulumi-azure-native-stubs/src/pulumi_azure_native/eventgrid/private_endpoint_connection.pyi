...
class PrivateEndpointConnectionInitArgs:
    def __init__(__self__, *, parent_name: pulumi.Input[_builtins.str], parent_type: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., private_endpoint: Optional[pulumi.Input[PrivateEndpointArgs]] = ..., private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., private_link_service_connection_state: Optional[pulumi.Input[ConnectionStateArgs]] = ..., provisioning_state: Optional[pulumi.Input[Union[_builtins.str, ResourceProvisioningState]]] = ...) -> None:
    ...
    @parent_name.setter
    def parent_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @parent_type.setter
    def parent_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PrivateEndpointConnection(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., parent_name: Optional[pulumi.Input[_builtins.str]] = ..., parent_type: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint: Optional[pulumi.Input[Union[PrivateEndpointArgs, PrivateEndpointArgsDict]]] = ..., private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ..., private_link_service_connection_state: Optional[pulumi.Input[Union[ConnectionStateArgs, ConnectionStateArgsDict]]] = ..., provisioning_state: Optional[pulumi.Input[Union[_builtins.str, ResourceProvisioningState]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
