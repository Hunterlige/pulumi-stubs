...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetEventSubscriptionResult', 'AwaitableGetEventSubscriptionResult', 'get_event_subscription', 'get_event_subscription_output']
@pulumi.output_type
...
class AwaitableGetEventSubscriptionResult(GetEventSubscriptionResult):
    def __await__(self): # -> Generator[Never, Any, GetEventSubscriptionResult]:
        ...
    


def get_event_subscription(event_subscription_name: Optional[_builtins.str] = ..., scope: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetEventSubscriptionResult:
    
    ...

def get_event_subscription_output(event_subscription_name: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetEventSubscriptionResult]:
