...
class PartnerTopicEventSubscriptionArgs:
    ...
    def partner_topic_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PartnerTopicEventSubscription(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> PartnerTopicEventSubscription:
