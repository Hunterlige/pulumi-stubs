...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DnsConfigArgs', 'DnsConfigArgsDict', 'EndpointPropertiesCustomHeadersItemArgs', 'EndpointPropertiesCustomHeadersItemArgsDict', 'EndpointPropertiesSubnetsItemArgs', 'EndpointPropertiesSubnetsItemArgsDict', 'EndpointArgs', 'EndpointArgsDict', 'MonitorConfigCustomHeadersItemArgs', 'MonitorConfigCustomHeadersItemArgsDict', 'MonitorConfigExpectedStatusCodeRangesItemArgs', 'MonitorConfigExpectedStatusCodeRangesItemArgsDict', 'MonitorConfigArgs', 'MonitorConfigArgsDict']
...
@pulumi.input_type
class DnsConfigArgs:
    def __init__(__self__, *, relative_name: Optional[pulumi.Input[_builtins.str]] = ..., ttl: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def relative_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EndpointPropertiesSubnetsItemArgs:
    def __init__(__self__, *, first: Optional[pulumi.Input[_builtins.str]] = ..., last: Optional[pulumi.Input[_builtins.str]] = ..., scope: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @first.setter
    def first(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @last.setter
    def last(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @scope.setter
    def scope(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class MonitorConfigArgs:
    def __init__(__self__, *, custom_headers: Optional[pulumi.Input[Sequence[pulumi.Input[MonitorConfigCustomHeadersItemArgs]]]] = ..., expected_status_code_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[MonitorConfigExpectedStatusCodeRangesItemArgs]]]] = ..., interval_in_seconds: Optional[pulumi.Input[_builtins.float]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.float]] = ..., profile_monitor_status: Optional[pulumi.Input[Union[_builtins.str, ProfileMonitorStatus]]] = ..., protocol: Optional[pulumi.Input[Union[_builtins.str, MonitorProtocol]]] = ..., timeout_in_seconds: Optional[pulumi.Input[_builtins.float]] = ..., tolerated_number_of_failures: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @custom_headers.setter
    def custom_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MonitorConfigCustomHeadersItemArgs]]]]): # -> None:
        ...
    ...
    def expected_status_code_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MonitorConfigExpectedStatusCodeRangesItemArgs]]]]): # -> None:
        ...
    ...
    def interval_in_seconds(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def profile_monitor_status(self, value: Optional[pulumi.Input[Union[_builtins.str, ProfileMonitorStatus]]]): # -> None:
        ...
    ...
    @protocol.setter
    def protocol(self, value: Optional[pulumi.Input[Union[_builtins.str, MonitorProtocol]]]): # -> None:
        ...
    ...
    def tolerated_number_of_failures(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
