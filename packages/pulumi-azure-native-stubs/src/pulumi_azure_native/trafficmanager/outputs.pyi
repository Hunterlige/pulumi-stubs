...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DnsConfigResponse', 'EndpointPropertiesCustomHeadersItemResponse', 'EndpointPropertiesSubnetsItemResponse', 'EndpointResponse', 'MonitorConfigCustomHeadersItemResponse', 'MonitorConfigExpectedStatusCodeRangesItemResponse', 'MonitorConfigResponse']
@pulumi.output_type
class DnsConfigResponse(dict):
    ...
    def __init__(__self__, *, fqdn: _builtins.str, relative_name: Optional[_builtins.str] = ..., ttl: Optional[_builtins.float] = ...) -> None:
...
class EndpointPropertiesSubnetsItemResponse(dict):
    ...
    def __init__(__self__, *, first: Optional[_builtins.str] = ..., last: Optional[_builtins.str] = ..., scope: Optional[_builtins.int] = ...) -> None:
...
class EndpointResponse(dict):
    ...
    def __init__(__self__, *, always_serve: Optional[_builtins.str] = ..., custom_headers: Optional[Sequence[outputs.EndpointPropertiesCustomHeadersItemResponse]] = ..., endpoint_location: Optional[_builtins.str] = ..., endpoint_monitor_status: Optional[_builtins.str] = ..., endpoint_status: Optional[_builtins.str] = ..., geo_mapping: Optional[Sequence[_builtins.str]] = ..., id: Optional[_builtins.str] = ..., min_child_endpoints: Optional[_builtins.float] = ..., min_child_endpoints_i_pv4: Optional[_builtins.float] = ..., min_child_endpoints_i_pv6: Optional[_builtins.float] = ..., name: Optional[_builtins.str] = ..., priority: Optional[_builtins.float] = ..., subnets: Optional[Sequence[outputs.EndpointPropertiesSubnetsItemResponse]] = ..., target: Optional[_builtins.str] = ..., target_resource_id: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ..., weight: Optional[_builtins.float] = ...) -> None:
...
class MonitorConfigResponse(dict):
    ...
    def __init__(__self__, *, custom_headers: Optional[Sequence[outputs.MonitorConfigCustomHeadersItemResponse]] = ..., expected_status_code_ranges: Optional[Sequence[outputs.MonitorConfigExpectedStatusCodeRangesItemResponse]] = ..., interval_in_seconds: Optional[_builtins.float] = ..., path: Optional[_builtins.str] = ..., port: Optional[_builtins.float] = ..., profile_monitor_status: Optional[_builtins.str] = ..., protocol: Optional[_builtins.str] = ..., timeout_in_seconds: Optional[_builtins.float] = ..., tolerated_number_of_failures: Optional[_builtins.float] = ...) -> None:
