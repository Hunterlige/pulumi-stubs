...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetVNetPeeringResult', 'AwaitableGetVNetPeeringResult', 'get_v_net_peering', 'get_v_net_peering_output']
@pulumi.output_type
class GetVNetPeeringResult:
    
    def __init__(__self__, allow_forwarded_traffic=..., allow_gateway_transit=..., allow_virtual_network_access=..., azure_api_version=..., databricks_address_space=..., databricks_virtual_network=..., id=..., name=..., peering_state=..., provisioning_state=..., remote_address_space=..., remote_virtual_network=..., type=..., use_remote_gateways=...) -> None:
        ...
...
class AwaitableGetVNetPeeringResult(GetVNetPeeringResult):
    def __await__(self): # -> Generator[Never, Any, GetVNetPeeringResult]:
        ...
    


def get_v_net_peering(peering_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., workspace_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetVNetPeeringResult:
    
    ...

def get_v_net_peering_output(peering_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetVNetPeeringResult]:
