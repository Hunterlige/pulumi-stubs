...
@pulumi.input_type
class WorkspaceArgs:
    def __init__(__self__, *, managed_resource_group_id: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], access_connector: Optional[pulumi.Input[WorkspacePropertiesAccessConnectorArgs]] = ..., authorizations: Optional[pulumi.Input[Sequence[pulumi.Input[WorkspaceProviderAuthorizationArgs]]]] = ..., default_catalog: Optional[pulumi.Input[DefaultCatalogPropertiesArgs]] = ..., default_storage_firewall: Optional[pulumi.Input[Union[_builtins.str, DefaultStorageFirewall]]] = ..., encryption: Optional[pulumi.Input[WorkspacePropertiesEncryptionArgs]] = ..., enhanced_security_compliance: Optional[pulumi.Input[EnhancedSecurityComplianceDefinitionArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[WorkspaceCustomParametersArgs]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., required_nsg_rules: Optional[pulumi.Input[Union[_builtins.str, RequiredNsgRules]]] = ..., sku: Optional[pulumi.Input[SkuArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., ui_definition_uri: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def managed_resource_group_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def access_connector(self, value: Optional[pulumi.Input[WorkspacePropertiesAccessConnectorArgs]]): # -> None:
        ...
    ...
    def authorizations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkspaceProviderAuthorizationArgs]]]]): # -> None:
        ...
    ...
    def default_catalog(self, value: Optional[pulumi.Input[DefaultCatalogPropertiesArgs]]): # -> None:
        ...
    ...
    def default_storage_firewall(self, value: Optional[pulumi.Input[Union[_builtins.str, DefaultStorageFirewall]]]): # -> None:
        ...
    ...
    @encryption.setter
    def encryption(self, value: Optional[pulumi.Input[WorkspacePropertiesEncryptionArgs]]): # -> None:
        ...
    ...
    def enhanced_security_compliance(self, value: Optional[pulumi.Input[EnhancedSecurityComplianceDefinitionArgs]]): # -> None:
        ...
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[WorkspaceCustomParametersArgs]]): # -> None:
        ...
    ...
    def required_nsg_rules(self, value: Optional[pulumi.Input[Union[_builtins.str, RequiredNsgRules]]]): # -> None:
        ...
    ...
    def ui_definition_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Workspace(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., access_connector: Optional[pulumi.Input[Union[WorkspacePropertiesAccessConnectorArgs, WorkspacePropertiesAccessConnectorArgsDict]]] = ..., authorizations: Optional[pulumi.Input[Sequence[pulumi.Input[Union[WorkspaceProviderAuthorizationArgs, WorkspaceProviderAuthorizationArgsDict]]]]] = ..., default_catalog: Optional[pulumi.Input[Union[DefaultCatalogPropertiesArgs, DefaultCatalogPropertiesArgsDict]]] = ..., default_storage_firewall: Optional[pulumi.Input[Union[_builtins.str, DefaultStorageFirewall]]] = ..., encryption: Optional[pulumi.Input[Union[WorkspacePropertiesEncryptionArgs, WorkspacePropertiesEncryptionArgsDict]]] = ..., enhanced_security_compliance: Optional[pulumi.Input[Union[EnhancedSecurityComplianceDefinitionArgs, EnhancedSecurityComplianceDefinitionArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., managed_resource_group_id: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Union[WorkspaceCustomParametersArgs, WorkspaceCustomParametersArgsDict]]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, PublicNetworkAccess]]] = ..., required_nsg_rules: Optional[pulumi.Input[Union[_builtins.str, RequiredNsgRules]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[SkuArgs, SkuArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., ui_definition_uri: Optional[pulumi.Input[_builtins.str]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
