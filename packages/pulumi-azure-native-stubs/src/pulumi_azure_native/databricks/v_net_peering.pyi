...
class VNetPeeringArgs:
    def __init__(__self__, *, remote_virtual_network: pulumi.Input[VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs], resource_group_name: pulumi.Input[_builtins.str], workspace_name: pulumi.Input[_builtins.str], allow_forwarded_traffic: Optional[pulumi.Input[_builtins.bool]] = ..., allow_gateway_transit: Optional[pulumi.Input[_builtins.bool]] = ..., allow_virtual_network_access: Optional[pulumi.Input[_builtins.bool]] = ..., databricks_address_space: Optional[pulumi.Input[AddressSpaceArgs]] = ..., databricks_virtual_network: Optional[pulumi.Input[VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgs]] = ..., peering_name: Optional[pulumi.Input[_builtins.str]] = ..., remote_address_space: Optional[pulumi.Input[AddressSpaceArgs]] = ..., use_remote_gateways: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def remote_virtual_network(self, value: pulumi.Input[VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs]): # -> None:
        ...
    ...
    def databricks_address_space(self, value: Optional[pulumi.Input[AddressSpaceArgs]]): # -> None:
        ...
    ...
    def databricks_virtual_network(self, value: Optional[pulumi.Input[VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgs]]): # -> None:
        ...
...
class VNetPeering(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., allow_forwarded_traffic: Optional[pulumi.Input[_builtins.bool]] = ..., allow_gateway_transit: Optional[pulumi.Input[_builtins.bool]] = ..., allow_virtual_network_access: Optional[pulumi.Input[_builtins.bool]] = ..., databricks_address_space: Optional[pulumi.Input[Union[AddressSpaceArgs, AddressSpaceArgsDict]]] = ..., databricks_virtual_network: Optional[pulumi.Input[Union[VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgs, VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgsDict]]] = ..., peering_name: Optional[pulumi.Input[_builtins.str]] = ..., remote_address_space: Optional[pulumi.Input[Union[AddressSpaceArgs, AddressSpaceArgsDict]]] = ..., remote_virtual_network: Optional[pulumi.Input[Union[VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs, VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., use_remote_gateways: Optional[pulumi.Input[_builtins.bool]] = ..., workspace_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: VNetPeeringArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> VNetPeering:
