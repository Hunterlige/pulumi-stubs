...
class GetClusterResult:
    ...
    def __init__(__self__, azure_api_version=..., created_at=..., id=..., location=..., metric_id=..., name=..., provisioning_state=..., sku=..., status=..., supports_scaling=..., system_data=..., tags=..., type=..., updated_at=...) -> None:
        ...
