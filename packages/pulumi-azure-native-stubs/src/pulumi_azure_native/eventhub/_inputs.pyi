...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CaptureDescriptionArgs', 'CaptureDescriptionArgsDict', 'CaptureIdentityArgs', 'CaptureIdentityArgsDict', 'ClusterSkuArgs', 'ClusterSkuArgsDict', 'ConnectionStateArgs', 'ConnectionStateArgsDict', 'DestinationArgs', 'DestinationArgsDict', 'EncryptionArgs', 'EncryptionArgsDict', 'IdentityArgs', 'IdentityArgsDict', 'KeyVaultPropertiesArgs', 'KeyVaultPropertiesArgsDict', 'NWRuleSetIpRulesArgs', 'NWRuleSetIpRulesArgsDict', 'NWRuleSetVirtualNetworkRulesArgs', 'NWRuleSetVirtualNetworkRulesArgsDict', 'PrivateEndpointConnectionArgs', 'PrivateEndpointConnectionArgsDict', 'PrivateEndpointArgs', 'PrivateEndpointArgsDict', 'RetentionDescriptionArgs', 'RetentionDescriptionArgsDict', 'SkuArgs', 'SkuArgsDict', 'SubnetArgs', 'SubnetArgsDict', 'ThrottlingPolicyArgs', 'ThrottlingPolicyArgsDict', 'UserAssignedIdentityPropertiesArgs', 'UserAssignedIdentityPropertiesArgsDict']
...
class CaptureDescriptionArgs:
    def __init__(__self__, *, destination: Optional[pulumi.Input[DestinationArgs]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., encoding: Optional[pulumi.Input[EncodingCaptureDescription]] = ..., interval_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., size_limit_in_bytes: Optional[pulumi.Input[_builtins.int]] = ..., skip_empty_archives: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @destination.setter
    def destination(self, value: Optional[pulumi.Input[DestinationArgs]]): # -> None:
        ...
    ...
    @encoding.setter
    def encoding(self, value: Optional[pulumi.Input[EncodingCaptureDescription]]): # -> None:
        ...
    ...
    def size_limit_in_bytes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def skip_empty_archives(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class CaptureIdentityArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[CaptureIdentityType]] = ..., user_assigned_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[CaptureIdentityType]]): # -> None:
        ...
...
class ClusterSkuArgs:
    def __init__(__self__, *, name: pulumi.Input[Union[_builtins.str, ClusterSkuName]], capacity: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @name.setter
    def name(self, value: pulumi.Input[Union[_builtins.str, ClusterSkuName]]): # -> None:
        ...
...
class ConnectionStateArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[Union[_builtins.str, PrivateLinkConnectionStatus]]] = ...) -> None:
...
class DestinationArgs:
    def __init__(__self__, *, archive_name_format: Optional[pulumi.Input[_builtins.str]] = ..., blob_container: Optional[pulumi.Input[_builtins.str]] = ..., data_lake_account_name: Optional[pulumi.Input[_builtins.str]] = ..., data_lake_folder_path: Optional[pulumi.Input[_builtins.str]] = ..., data_lake_subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[CaptureIdentityArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., storage_account_resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def archive_name_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def blob_container(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def data_lake_account_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def data_lake_folder_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def data_lake_subscription_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @identity.setter
    def identity(self, value: Optional[pulumi.Input[CaptureIdentityArgs]]): # -> None:
        ...
...
class EncryptionArgs:
    def __init__(__self__, *, key_source: Optional[pulumi.Input[KeySource]] = ..., key_vault_properties: Optional[pulumi.Input[Sequence[pulumi.Input[KeyVaultPropertiesArgs]]]] = ..., require_infrastructure_encryption: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def key_vault_properties(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[KeyVaultPropertiesArgs]]]]): # -> None:
        ...
...
class KeyVaultPropertiesArgs:
    def __init__(__self__, *, identity: Optional[pulumi.Input[UserAssignedIdentityPropertiesArgs]] = ..., key_name: Optional[pulumi.Input[_builtins.str]] = ..., key_vault_uri: Optional[pulumi.Input[_builtins.str]] = ..., key_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @identity.setter
    def identity(self, value: Optional[pulumi.Input[UserAssignedIdentityPropertiesArgs]]): # -> None:
        ...
...
class NWRuleSetIpRulesArgs:
    def __init__(__self__, *, action: Optional[pulumi.Input[Union[_builtins.str, NetworkRuleIPAction]]] = ..., ip_mask: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NWRuleSetVirtualNetworkRulesArgs:
    def __init__(__self__, *, ignore_missing_vnet_service_endpoint: Optional[pulumi.Input[_builtins.bool]] = ..., subnet: Optional[pulumi.Input[SubnetArgs]] = ...) -> None:
...
class PrivateEndpointConnectionArgs:
    def __init__(__self__, *, private_endpoint: Optional[pulumi.Input[PrivateEndpointArgs]] = ..., private_link_service_connection_state: Optional[pulumi.Input[ConnectionStateArgs]] = ..., provisioning_state: Optional[pulumi.Input[Union[_builtins.str, EndPointProvisioningState]]] = ...) -> None:
...
class RetentionDescriptionArgs:
    def __init__(__self__, *, cleanup_policy: Optional[pulumi.Input[Union[_builtins.str, CleanupPolicyRetentionDescription]]] = ..., retention_time_in_hours: Optional[pulumi.Input[_builtins.float]] = ..., tombstone_retention_time_in_hours: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def cleanup_policy(self, value: Optional[pulumi.Input[Union[_builtins.str, CleanupPolicyRetentionDescription]]]): # -> None:
        ...
    ...
    def retention_time_in_hours(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def tombstone_retention_time_in_hours(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
@pulumi.input_type
class SkuArgs:
    def __init__(__self__, *, name: pulumi.Input[Union[_builtins.str, SkuName]], capacity: Optional[pulumi.Input[_builtins.int]] = ..., tier: Optional[pulumi.Input[Union[_builtins.str, SkuTier]]] = ...) -> None:
...
class ThrottlingPolicyArgs:
    def __init__(__self__, *, metric_id: pulumi.Input[Union[_builtins.str, MetricId]], name: pulumi.Input[_builtins.str], rate_limit_threshold: pulumi.Input[_builtins.float], type: pulumi.Input[_builtins.str]) -> None:
    ...
    @metric_id.setter
    def metric_id(self, value: pulumi.Input[Union[_builtins.str, MetricId]]): # -> None:
        ...
    ...
    def rate_limit_threshold(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
