...
class GetNamespaceResult:
    ...
    def __init__(__self__, alternate_name=..., azure_api_version=..., cluster_arm_id=..., created_at=..., disable_local_auth=..., encryption=..., id=..., identity=..., is_auto_inflate_enabled=..., kafka_enabled=..., location=..., maximum_throughput_units=..., metric_id=..., minimum_tls_version=..., name=..., private_endpoint_connections=..., provisioning_state=..., public_network_access=..., service_bus_endpoint=..., sku=..., status=..., system_data=..., tags=..., type=..., updated_at=..., zone_redundant=...) -> None:
        ...
