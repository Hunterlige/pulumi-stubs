...
class SingleServerServerSecurityAlertPolicyArgs:
    ...
    @state.setter
    def state(self, value: pulumi.Input[ServerSecurityAlertPolicyState]): # -> None:
        ...
...
class SingleServerServerSecurityAlertPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., disabled_alerts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., email_account_admins: Optional[pulumi.Input[_builtins.bool]] = ..., email_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., retention_days: Optional[pulumi.Input[_builtins.int]] = ..., security_alert_policy_name: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[ServerSecurityAlertPolicyState]] = ..., storage_account_access_key: Optional[pulumi.Input[_builtins.str]] = ..., storage_endpoint: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: SingleServerServerSecurityAlertPolicyArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SingleServerServerSecurityAlertPolicy:
