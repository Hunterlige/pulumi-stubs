...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetMigrationResult', 'AwaitableGetMigrationResult', 'get_migration', 'get_migration_output']
@pulumi.output_type
class GetMigrationResult:
    
    def __init__(__self__, azure_api_version=..., cancel=..., current_status=..., dbs_to_cancel_migration_on=..., dbs_to_migrate=..., dbs_to_trigger_cutover_on=..., id=..., location=..., migrate_roles=..., migration_id=..., migration_instance_resource_id=..., migration_mode=..., migration_option=..., migration_window_end_time_in_utc=..., migration_window_start_time_in_utc=..., name=..., overwrite_dbs_in_target=..., setup_logical_replication_on_source_db_if_needed=..., source_db_server_fully_qualified_domain_name=..., source_db_server_metadata=..., source_db_server_resource_id=..., source_type=..., ssl_mode=..., start_data_migration=..., system_data=..., tags=..., target_db_server_fully_qualified_domain_name=..., target_db_server_metadata=..., target_db_server_resource_id=..., trigger_cutover=..., type=...) -> None:
        ...
...
class AwaitableGetMigrationResult(GetMigrationResult):
    def __await__(self): # -> Generator[Never, Any, GetMigrationResult]:
        ...
    


def get_migration(migration_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., server_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetMigrationResult:
    
    ...

def get_migration_output(migration_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetMigrationResult]:
