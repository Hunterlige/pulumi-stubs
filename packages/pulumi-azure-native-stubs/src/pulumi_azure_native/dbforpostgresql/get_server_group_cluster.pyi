...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetServerGroupClusterResult', 'AwaitableGetServerGroupClusterResult', 'get_server_group_cluster', 'get_server_group_cluster_output']
@pulumi.output_type
class GetServerGroupClusterResult:
    
    def __init__(__self__, aad_auth_enabled=..., administrator_login=..., auth_config=..., azure_api_version=..., citus_version=..., coordinator_enable_public_ip_access=..., coordinator_server_edition=..., coordinator_storage_quota_in_mb=..., coordinator_v_cores=..., data_encryption=..., database_name=..., earliest_restore_time=..., enable_geo_backup=..., enable_ha=..., enable_shards_on_coordinator=..., id=..., identity=..., location=..., maintenance_window=..., name=..., node_count=..., node_enable_public_ip_access=..., node_server_edition=..., node_storage_quota_in_mb=..., node_v_cores=..., password_enabled=..., point_in_time_utc=..., postgresql_version=..., preferred_primary_zone=..., private_endpoint_connections=..., provisioning_state=..., read_replicas=..., server_names=..., source_location=..., source_resource_id=..., state=..., system_data=..., tags=..., type=...) -> None:
        ...
...
class AwaitableGetServerGroupClusterResult(GetServerGroupClusterResult):
    def __await__(self): # -> Generator[Never, Any, GetServerGroupClusterResult]:
        ...
    


def get_server_group_cluster(cluster_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetServerGroupClusterResult:
    
    ...

def get_server_group_cluster_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetServerGroupClusterResult]:
