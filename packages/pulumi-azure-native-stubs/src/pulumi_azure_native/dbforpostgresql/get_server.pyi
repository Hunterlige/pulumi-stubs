...
class GetServerResult:
    ...
    def __init__(__self__, administrator_login=..., auth_config=..., availability_zone=..., azure_api_version=..., backup=..., cluster=..., data_encryption=..., fully_qualified_domain_name=..., high_availability=..., id=..., identity=..., location=..., maintenance_window=..., minor_version=..., name=..., network=..., private_endpoint_connections=..., replica=..., replica_capacity=..., replication_role=..., sku=..., source_server_resource_id=..., state=..., storage=..., system_data=..., tags=..., type=..., version=...) -> None:
        ...
...
def get_server(resource_group_name: Optional[_builtins.str] = ..., server_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetServerResult:
    
    ...

def get_server_output(resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., server_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetServerResult]:
