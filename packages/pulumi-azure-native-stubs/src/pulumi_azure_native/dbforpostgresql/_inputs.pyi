...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AdminCredentialsArgs', 'AdminCredentialsArgsDict', 'AuthConfigArgs', 'AuthConfigArgsDict', 'BackupArgs', 'BackupArgsDict', 'ClusterArgs', 'ClusterArgsDict', 'DataEncryptionArgs', 'DataEncryptionArgsDict', 'HighAvailabilityArgs', 'HighAvailabilityArgsDict', 'IdentityPropertiesArgs', 'IdentityPropertiesArgsDict', 'MaintenanceWindowArgs', 'MaintenanceWindowArgsDict', 'MigrationSecretParametersArgs', 'MigrationSecretParametersArgsDict', 'NetworkArgs', 'NetworkArgsDict', 'PrivateLinkServiceConnectionStateArgs', 'PrivateLinkServiceConnectionStateArgsDict', 'ReplicaArgs', 'ReplicaArgsDict', 'ResourceIdentityArgs', 'ResourceIdentityArgsDict', 'ServerGroupClusterAuthConfigArgs', 'ServerGroupClusterAuthConfigArgsDict', 'ServerGroupClusterDataEncryptionArgs', 'ServerGroupClusterDataEncryptionArgsDict', 'ServerGroupClusterMaintenanceWindowArgs', 'ServerGroupClusterMaintenanceWindowArgsDict', 'ServerPropertiesForDefaultCreateArgs', 'ServerPropertiesForDefaultCreateArgsDict', 'ServerPropertiesForGeoRestoreArgs', 'ServerPropertiesForGeoRestoreArgsDict', 'ServerPropertiesForReplicaArgs', 'ServerPropertiesForReplicaArgsDict', 'ServerPropertiesForRestoreArgs', 'ServerPropertiesForRestoreArgsDict', 'SingleServerSkuArgs', 'SingleServerSkuArgsDict', 'SkuArgs', 'SkuArgsDict', 'StorageProfileArgs', 'StorageProfileArgsDict', 'StorageArgs', 'StorageArgsDict', 'UserAssignedIdentityArgs', 'UserAssignedIdentityArgsDict', 'UserIdentityArgs', 'UserIdentityArgsDict']
...
class AdminCredentialsArgs:
    def __init__(__self__, *, source_server_password: pulumi.Input[_builtins.str], target_server_password: pulumi.Input[_builtins.str]) -> None:
    ...
    def source_server_password(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def target_server_password(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AuthConfigArgs:
    def __init__(__self__, *, active_directory_auth: Optional[pulumi.Input[Union[_builtins.str, MicrosoftEntraAuth]]] = ..., password_auth: Optional[pulumi.Input[Union[_builtins.str, PasswordBasedAuth]]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="activeDirectoryAuth")
    def active_directory_auth(self) -> Optional[pulumi.Input[Union[_builtins.str, MicrosoftEntraAuth]]]:
        
        ...
    
    @active_directory_auth.setter
    def active_directory_auth(self, value: Optional[pulumi.Input[Union[_builtins.str, MicrosoftEntraAuth]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="passwordAuth")
    def password_auth(self) -> Optional[pulumi.Input[Union[_builtins.str, PasswordBasedAuth]]]:
        
        ...
    
    @password_auth.setter
    def password_auth(self, value: Optional[pulumi.Input[Union[_builtins.str, PasswordBasedAuth]]]): # -> None:
        ...
...
@pulumi.input_type
class BackupArgs:
    def __init__(__self__, *, backup_retention_days: Optional[pulumi.Input[_builtins.int]] = ..., geo_redundant_backup: Optional[pulumi.Input[Union[_builtins.str, GeographicallyRedundantBackup]]] = ...) -> None:
    ...
    def geo_redundant_backup(self) -> Optional[pulumi.Input[Union[_builtins.str, GeographicallyRedundantBackup]]]:
        
        ...
    
    @geo_redundant_backup.setter
    def geo_redundant_backup(self, value: Optional[pulumi.Input[Union[_builtins.str, GeographicallyRedundantBackup]]]): # -> None:
        ...
...
@pulumi.input_type
class ClusterArgs:
    def __init__(__self__, *, cluster_size: Optional[pulumi.Input[_builtins.int]] = ..., default_database_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def default_database_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataEncryptionArgs:
    def __init__(__self__, *, geo_backup_key_uri: Optional[pulumi.Input[_builtins.str]] = ..., geo_backup_user_assigned_identity_id: Optional[pulumi.Input[_builtins.str]] = ..., primary_key_uri: Optional[pulumi.Input[_builtins.str]] = ..., primary_user_assigned_identity_id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, DataEncryptionType]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, DataEncryptionType]]]): # -> None:
        ...
...
class HighAvailabilityArgs:
    def __init__(__self__, *, mode: Optional[pulumi.Input[Union[_builtins.str, PostgreSqlFlexibleServerHighAvailabilityMode]]] = ..., standby_availability_zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @mode.setter
    def mode(self, value: Optional[pulumi.Input[Union[_builtins.str, PostgreSqlFlexibleServerHighAvailabilityMode]]]): # -> None:
        ...
...
class MigrationSecretParametersArgs:
    def __init__(__self__, *, admin_credentials: pulumi.Input[AdminCredentialsArgs], source_server_username: Optional[pulumi.Input[_builtins.str]] = ..., target_server_username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def admin_credentials(self, value: pulumi.Input[AdminCredentialsArgs]): # -> None:
        ...
    ...
    def source_server_username(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_server_username(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class NetworkArgs:
    def __init__(__self__, *, delegated_subnet_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., private_dns_zone_arm_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., public_network_access: Optional[pulumi.Input[Union[_builtins.str, ServerPublicNetworkAccessState]]] = ...) -> None:
    ...
    def private_dns_zone_arm_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def public_network_access(self, value: Optional[pulumi.Input[Union[_builtins.str, ServerPublicNetworkAccessState]]]): # -> None:
        ...
...
@pulumi.input_type
class ReplicaArgs:
    def __init__(__self__, *, promote_mode: Optional[pulumi.Input[Union[_builtins.str, ReadReplicaPromoteMode]]] = ..., promote_option: Optional[pulumi.Input[Union[_builtins.str, ReadReplicaPromoteOption]]] = ..., role: Optional[pulumi.Input[Union[_builtins.str, ReplicationRole]]] = ...) -> None:
    ...
    @promote_mode.setter
    def promote_mode(self, value: Optional[pulumi.Input[Union[_builtins.str, ReadReplicaPromoteMode]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="promoteOption")
    def promote_option(self) -> Optional[pulumi.Input[Union[_builtins.str, ReadReplicaPromoteOption]]]:
        
        ...
    
    @promote_option.setter
    def promote_option(self, value: Optional[pulumi.Input[Union[_builtins.str, ReadReplicaPromoteOption]]]): # -> None:
        ...
    ...
    @role.setter
    def role(self, value: Optional[pulumi.Input[Union[_builtins.str, ReplicationRole]]]): # -> None:
        ...
...
class ResourceIdentityArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[Union[_builtins.str, SingleServerIdentityProperties]]] = ...) -> None:
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, SingleServerIdentityProperties]]]): # -> None:
        ...
...
class ServerGroupClusterAuthConfigArgs:
    def __init__(__self__, *, active_directory_auth: Optional[pulumi.Input[Union[_builtins.str, ActiveDirectoryAuth]]] = ..., password_auth: Optional[pulumi.Input[Union[_builtins.str, PasswordAuth]]] = ...) -> None:
    ...
    @active_directory_auth.setter
    def active_directory_auth(self, value: Optional[pulumi.Input[Union[_builtins.str, ActiveDirectoryAuth]]]): # -> None:
        ...
    ...
    @password_auth.setter
    def password_auth(self, value: Optional[pulumi.Input[Union[_builtins.str, PasswordAuth]]]): # -> None:
        ...
...
class ServerGroupClusterDataEncryptionArgs:
    def __init__(__self__, *, primary_key_uri: Optional[pulumi.Input[_builtins.str]] = ..., primary_user_assigned_identity_id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, DataEncryptionType]]] = ...) -> None:
...
@pulumi.input_type
class SkuArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], tier: pulumi.Input[Union[_builtins.str, SkuTier]]) -> None:
    ...
    @tier.setter
    def tier(self, value: pulumi.Input[Union[_builtins.str, SkuTier]]): # -> None:
        ...
...
@pulumi.input_type
class StorageArgs:
    def __init__(__self__, *, auto_grow: Optional[pulumi.Input[Union[_builtins.str, StorageAutoGrow]]] = ..., iops: Optional[pulumi.Input[_builtins.int]] = ..., storage_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., throughput: Optional[pulumi.Input[_builtins.int]] = ..., tier: Optional[pulumi.Input[Union[_builtins.str, AzureManagedDiskPerformanceTier]]] = ..., type: Optional[pulumi.Input[Union[_builtins.str, StorageType]]] = ...) -> None:
    ...
    @auto_grow.setter
    def auto_grow(self, value: Optional[pulumi.Input[Union[_builtins.str, StorageAutoGrow]]]): # -> None:
        ...
    ...
    @_builtins.property
    @pulumi.getter
    def tier(self) -> Optional[pulumi.Input[Union[_builtins.str, AzureManagedDiskPerformanceTier]]]:
        
        ...
    
    @tier.setter
    def tier(self, value: Optional[pulumi.Input[Union[_builtins.str, AzureManagedDiskPerformanceTier]]]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: Optional[pulumi.Input[Union[_builtins.str, StorageType]]]): # -> None:
        ...
...
class UserAssignedIdentityArgs:
    def __init__(__self__, *, type: pulumi.Input[Union[_builtins.str, IdentityType]], principal_id: Optional[pulumi.Input[_builtins.str]] = ..., user_assigned_identities: Optional[pulumi.Input[Mapping[str, pulumi.Input[UserIdentityArgs]]]] = ...) -> None:
    ...
    @user_assigned_identities.setter
    def user_assigned_identities(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[UserIdentityArgs]]]]): # -> None:
        ...
