...
class ApplicationArgs:
    def __init__(__self__, *, kind: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], application_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., application_name: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[IdentityArgs]] = ..., jit_access_policy: Optional[pulumi.Input[ApplicationJitAccessPolicyArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., managed_by: Optional[pulumi.Input[_builtins.str]] = ..., managed_resource_group_id: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[Any] = ..., plan: Optional[pulumi.Input[PlanArgs]] = ..., sku: Optional[pulumi.Input[SkuArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def application_definition_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def jit_access_policy(self, value: Optional[pulumi.Input[ApplicationJitAccessPolicyArgs]]): # -> None:
        ...
    ...
    def managed_resource_group_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Application(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., application_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., application_name: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[Union[IdentityArgs, IdentityArgsDict]]] = ..., jit_access_policy: Optional[pulumi.Input[Union[ApplicationJitAccessPolicyArgs, ApplicationJitAccessPolicyArgsDict]]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., managed_by: Optional[pulumi.Input[_builtins.str]] = ..., managed_resource_group_id: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[Any] = ..., plan: Optional[pulumi.Input[Union[PlanArgs, PlanArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., sku: Optional[pulumi.Input[Union[SkuArgs, SkuArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
