...
class EmployeePropertiesArgs:
    def __init__(__self__, *, age: Optional[pulumi.Input[_builtins.int]] = ..., city: Optional[pulumi.Input[_builtins.str]] = ..., profile: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
