...
class GetCapacityDetailsResult:
    ...
    def administration(
        self,
    ) -> Optional[outputs.DedicatedCapacityAdministratorsResponse]: ...
    @_builtins.property
...
def get_capacity_details(
    dedicated_capacity_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetCapacityDetailsResult: ...
def get_capacity_details_output(
    dedicated_capacity_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetCapacityDetailsResult]: ...
