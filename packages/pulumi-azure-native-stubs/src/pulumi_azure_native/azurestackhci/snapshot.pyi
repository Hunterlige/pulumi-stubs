...
class SnapshotArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[SnapshotPropertiesArgs]] = ...,
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[SnapshotPropertiesArgs]]): ...
    @_builtins.property
...
class Snapshot(pulumi.CustomResource):
    ...
    def __init__(
        ...
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[
            pulumi.Input[Union[SnapshotPropertiesArgs, SnapshotPropertiesArgsDict]]
        ] = ...,
