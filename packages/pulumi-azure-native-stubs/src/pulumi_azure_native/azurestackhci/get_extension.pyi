...
class GetExtensionResult:
    ...
    def __init__(__self__, aggregate_state=..., auto_upgrade_minor_version=..., azure_api_version=..., enable_automatic_upgrade=..., force_update_tag=..., id=..., managed_by=..., name=..., per_node_extension_details=..., protected_settings=..., provisioning_state=..., publisher=..., settings=..., system_data=..., type=..., type_handler_version=...) -> None:
        ...
...
def get_extension(arc_setting_name: Optional[_builtins.str] = ..., cluster_name: Optional[_builtins.str] = ..., extension_name: Optional[_builtins.str] = ..., resource_group_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetExtensionResult:
    
    ...

def get_extension_output(arc_setting_name: Optional[pulumi.Input[_builtins.str]] = ..., cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., extension_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetExtensionResult]:
