...
class NatGatewayArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[NatGatewayPropertiesArgs]] = ...,
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[NatGatewayPropertiesArgs]]): ...
    @_builtins.property
    @pulumi.getter
    def tags(
        self,
...
class NatGateway(pulumi.CustomResource):
    ...
    def __init__(
        ...
        nat_gateway_name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[
            pulumi.Input[Union[NatGatewayPropertiesArgs, NatGatewayPropertiesArgsDict]]
        ] = ...,
