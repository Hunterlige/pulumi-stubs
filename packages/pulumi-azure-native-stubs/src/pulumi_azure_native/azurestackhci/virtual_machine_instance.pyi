...
class VirtualMachineInstanceArgs:
    def __init__(__self__, *, resource_uri: pulumi.Input[_builtins.str], create_from_local: Optional[pulumi.Input[_builtins.bool]] = ..., extended_location: Optional[pulumi.Input[ExtendedLocationArgs]] = ..., hardware_profile: Optional[pulumi.Input[VirtualMachineInstancePropertiesHardwareProfileArgs]] = ..., http_proxy_config: Optional[pulumi.Input[HttpProxyConfigurationArgs]] = ..., identity: Optional[pulumi.Input[ManagedServiceIdentityArgs]] = ..., network_profile: Optional[pulumi.Input[VirtualMachineInstancePropertiesNetworkProfileArgs]] = ..., os_profile: Optional[pulumi.Input[VirtualMachineInstancePropertiesOsProfileArgs]] = ..., resource_uid: Optional[pulumi.Input[_builtins.str]] = ..., security_profile: Optional[pulumi.Input[VirtualMachineInstancePropertiesSecurityProfileArgs]] = ..., storage_profile: Optional[pulumi.Input[VirtualMachineInstancePropertiesStorageProfileArgs]] = ...) -> None:
    ...
    def hardware_profile(self, value: Optional[pulumi.Input[VirtualMachineInstancePropertiesHardwareProfileArgs]]): # -> None:
        ...
    ...
    def network_profile(self, value: Optional[pulumi.Input[VirtualMachineInstancePropertiesNetworkProfileArgs]]): # -> None:
        ...
    ...
    @os_profile.setter
    def os_profile(self, value: Optional[pulumi.Input[VirtualMachineInstancePropertiesOsProfileArgs]]): # -> None:
        ...
    ...
    def security_profile(self, value: Optional[pulumi.Input[VirtualMachineInstancePropertiesSecurityProfileArgs]]): # -> None:
        ...
    ...
    def storage_profile(self, value: Optional[pulumi.Input[VirtualMachineInstancePropertiesStorageProfileArgs]]): # -> None:
        ...
...
class VirtualMachineInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., create_from_local: Optional[pulumi.Input[_builtins.bool]] = ..., extended_location: Optional[pulumi.Input[Union[ExtendedLocationArgs, ExtendedLocationArgsDict]]] = ..., hardware_profile: Optional[pulumi.Input[Union[VirtualMachineInstancePropertiesHardwareProfileArgs, VirtualMachineInstancePropertiesHardwareProfileArgsDict]]] = ..., http_proxy_config: Optional[pulumi.Input[Union[HttpProxyConfigurationArgs, HttpProxyConfigurationArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[ManagedServiceIdentityArgs, ManagedServiceIdentityArgsDict]]] = ..., network_profile: Optional[pulumi.Input[Union[VirtualMachineInstancePropertiesNetworkProfileArgs, VirtualMachineInstancePropertiesNetworkProfileArgsDict]]] = ..., os_profile: Optional[pulumi.Input[Union[VirtualMachineInstancePropertiesOsProfileArgs, VirtualMachineInstancePropertiesOsProfileArgsDict]]] = ..., resource_uid: Optional[pulumi.Input[_builtins.str]] = ..., resource_uri: Optional[pulumi.Input[_builtins.str]] = ..., security_profile: Optional[pulumi.Input[Union[VirtualMachineInstancePropertiesSecurityProfileArgs, VirtualMachineInstancePropertiesSecurityProfileArgsDict]]] = ..., storage_profile: Optional[pulumi.Input[Union[VirtualMachineInstancePropertiesStorageProfileArgs, VirtualMachineInstancePropertiesStorageProfileArgsDict]]] = ..., __props__=...) -> None:
