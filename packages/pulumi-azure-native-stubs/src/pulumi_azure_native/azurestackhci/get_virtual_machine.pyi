...
class GetVirtualMachineResult:
    ...
    def __init__(__self__, azure_api_version=..., extended_location=..., guest_agent_profile=..., hardware_profile=..., id=..., identity=..., location=..., name=..., network_profile=..., os_profile=..., provisioning_state=..., security_profile=..., status=..., storage_profile=..., system_data=..., tags=..., type=..., vm_id=...) -> None:
        ...
