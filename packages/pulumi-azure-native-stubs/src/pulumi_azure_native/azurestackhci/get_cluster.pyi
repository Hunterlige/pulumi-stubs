...
class GetClusterResult:
    ...
    def __init__(__self__, aad_application_object_id=..., aad_client_id=..., aad_service_principal_object_id=..., aad_tenant_id=..., azure_api_version=..., billing_model=..., cloud_id=..., cloud_management_endpoint=..., connectivity_status=..., desired_properties=..., id=..., isolated_vm_attestation_configuration=..., last_billing_timestamp=..., last_sync_timestamp=..., location=..., log_collection_properties=..., name=..., principal_id=..., provisioning_state=..., registration_timestamp=..., remote_support_properties=..., reported_properties=..., resource_provider_object_id=..., service_endpoint=..., software_assurance_properties=..., status=..., system_data=..., tags=..., tenant_id=..., trial_days_remaining=..., type=..., user_assigned_identities=...) -> None:
        ...
