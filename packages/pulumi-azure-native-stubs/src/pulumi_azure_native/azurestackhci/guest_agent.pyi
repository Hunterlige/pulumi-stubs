...
class GuestAgentArgs:
    def __init__(__self__, *, resource_uri: pulumi.Input[_builtins.str], credentials: Optional[pulumi.Input[GuestCredentialArgs]] = ..., provisioning_action: Optional[pulumi.Input[Union[_builtins.str, ProvisioningAction]]] = ...) -> None:
...
class GuestAgent(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., credentials: Optional[pulumi.Input[Union[GuestCredentialArgs, GuestCredentialArgsDict]]] = ..., provisioning_action: Optional[pulumi.Input[Union[_builtins.str, ProvisioningAction]]] = ..., resource_uri: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
