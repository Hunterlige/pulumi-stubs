...
def get_marketplace_gallery_image(
    marketplace_gallery_image_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetMarketplaceGalleryImageResult: ...
def get_marketplace_gallery_image_output(
    marketplace_gallery_image_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetMarketplaceGalleryImageResult]: ...
