...
class EdgeMachineJobArgs:
    def __init__(__self__, *, edge_machine_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], jobs_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[DownloadOsJobPropertiesArgs, EdgeMachineCollectLogJobPropertiesArgs, EdgeMachineRemoteSupportJobPropertiesArgs, ProvisionOsJobPropertiesArgs]]] = ...) -> None:
    ...
    def edge_machine_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[Union[DownloadOsJobPropertiesArgs, EdgeMachineCollectLogJobPropertiesArgs, EdgeMachineRemoteSupportJobPropertiesArgs, ProvisionOsJobPropertiesArgs]]]): # -> None:
        ...
...
class EdgeMachineJob(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., edge_machine_name: Optional[pulumi.Input[_builtins.str]] = ..., jobs_name: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Union[Union[DownloadOsJobPropertiesArgs, DownloadOsJobPropertiesArgsDict], Union[EdgeMachineCollectLogJobPropertiesArgs, EdgeMachineCollectLogJobPropertiesArgsDict], Union[EdgeMachineRemoteSupportJobPropertiesArgs, EdgeMachineRemoteSupportJobPropertiesArgsDict], Union[ProvisionOsJobPropertiesArgs, ProvisionOsJobPropertiesArgsDict]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: EdgeMachineJobArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> EdgeMachineJob:
