...
class AwaitableGetMHSMPrivateEndpointConnectionResult(
    GetMHSMPrivateEndpointConnectionResult
):
    def __await__(self): ...

def get_mhsm_private_endpoint_connection(
    name: Optional[_builtins.str] = ...,
    private_endpoint_connection_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetMHSMPrivateEndpointConnectionResult: ...
def get_mhsm_private_endpoint_connection_output(
    name: Optional[pulumi.Input[_builtins.str]] = ...,
    private_endpoint_connection_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetMHSMPrivateEndpointConnectionResult]: ...
