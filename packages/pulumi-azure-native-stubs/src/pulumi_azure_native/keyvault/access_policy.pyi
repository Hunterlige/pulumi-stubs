...
class AccessPolicyArgs:
    def __init__(__self__, *, policy: pulumi.Input[AccessPolicyEntryArgs], resource_group_name: pulumi.Input[_builtins.str], vault_name: pulumi.Input[_builtins.str]) -> None:
    ...
    @policy.setter
    def policy(self, value: pulumi.Input[AccessPolicyEntryArgs]): # -> None:
        ...
...
class AccessPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., policy: Optional[pulumi.Input[Union[AccessPolicyEntryArgs, AccessPolicyEntryArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., vault_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
