...
class SqlResourceSqlContainerArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], database_name: pulumi.Input[_builtins.str], resource: pulumi.Input[SqlContainerResourceArgs], resource_group_name: pulumi.Input[_builtins.str], container_name: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[CreateUpdateOptionsArgs]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class SqlResourceSqlContainer(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SqlResourceSqlContainer:
