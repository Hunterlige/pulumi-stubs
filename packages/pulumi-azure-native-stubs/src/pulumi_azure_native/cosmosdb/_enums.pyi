...
__all__ = ['AllocationState', 'AnalyticalStorageSchemaType', 'AuthenticationMethod', 'AzureConnectionType', 'BackupPolicyMigrationStatus', 'BackupPolicyType', 'BackupStorageRedundancy', 'ClusterType', 'CompositePathSortOrder', 'ConflictResolutionMode', 'ConnectorOffer', 'ContinuousTier', 'CreateMode', 'DataType', 'DatabaseAccountKind', 'DatabaseAccountOfferType', 'DedicatedGatewayType', 'DefaultConsistencyLevel', 'DefaultPriorityLevel', 'DistanceFunction', 'FleetspaceApiKind', 'IndexKind', 'IndexingMode', 'ManagedCassandraProvisioningState', 'ManagedCassandraResourceIdentityType', 'MinimalTlsVersion', 'MongoClusterCreateMode', 'MongoRoleDefinitionType', 'NetworkAclBypass', 'NodeKind', 'PartitionKind', 'PublicNetworkAccess', 'ResourceIdentityType', 'RestoreMode', 'RoleDefinitionType', 'ServerVersion', 'ServiceSize', 'ServiceTier', 'ServiceType', 'SpatialType', 'StorageLocationType', 'TriggerOperation', 'TriggerType', 'VectorDataType', 'VectorIndexType']
