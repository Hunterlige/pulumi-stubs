...
class MongoMIResourceMongoMIRoleDefinition(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: MongoMIResourceMongoMIRoleDefinitionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> MongoMIResourceMongoMIRoleDefinition:
