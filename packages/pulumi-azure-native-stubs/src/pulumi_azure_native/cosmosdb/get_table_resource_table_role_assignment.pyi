...
class AwaitableGetTableResourceTableRoleAssignmentResult(
    GetTableResourceTableRoleAssignmentResult
):
    def __await__(self): ...

def get_table_resource_table_role_assignment(
    account_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    role_assignment_id: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetTableResourceTableRoleAssignmentResult: ...
def get_table_resource_table_role_assignment_output(
    account_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    role_assignment_id: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetTableResourceTableRoleAssignmentResult]: ...
