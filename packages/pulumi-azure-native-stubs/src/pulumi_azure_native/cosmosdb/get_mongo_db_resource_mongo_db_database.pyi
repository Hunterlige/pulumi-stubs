...
class GetMongoDBResourceMongoDBDatabaseResult:
    ...
    def options(
        self,
    ) -> Optional[outputs.MongoDBDatabaseGetPropertiesResponseOptions]: ...
    @_builtins.property
    @pulumi.getter
    def resource(
        self,
    ) -> Optional[outputs.MongoDBDatabaseGetPropertiesResponseResource]: ...
    @_builtins.property
    @pulumi.getter
...
class AwaitableGetMongoDBResourceMongoDBDatabaseResult(
    GetMongoDBResourceMongoDBDatabaseResult
):
    def __await__(self): ...

def get_mongo_db_resource_mongo_db_database(
    account_name: Optional[_builtins.str] = ...,
    database_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetMongoDBResourceMongoDBDatabaseResult: ...
def get_mongo_db_resource_mongo_db_database_output(
    account_name: Optional[pulumi.Input[_builtins.str]] = ...,
    database_name: Optional[pulumi.Input[_builtins.str]] = ...,
    resource_group_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetMongoDBResourceMongoDBDatabaseResult]: ...
