...
class SqlResourceSqlDatabase(pulumi.CustomResource):
    ...
    def __init__(
        ...
        resource: Optional[
            pulumi.Input[Union[SqlDatabaseResourceArgs, SqlDatabaseResourceArgsDict]]
        ] = ...,
    ...
    def options(
        self,
    ) -> pulumi.Output[Optional[outputs.SqlDatabaseGetPropertiesResponseOptions]]: ...
    @_builtins.property
    @pulumi.getter
    def resource(
        self,
    ) -> pulumi.Output[Optional[outputs.SqlDatabaseGetPropertiesResponseResource]]: ...
    @_builtins.property
    @pulumi.getter
