...
class MongoClusterFirewallRuleArgs:
    def __init__(__self__, *, end_ip_address: pulumi.Input[_builtins.str], mongo_cluster_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], start_ip_address: pulumi.Input[_builtins.str], firewall_rule_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def mongo_cluster_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class MongoClusterFirewallRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., end_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., firewall_rule_name: Optional[pulumi.Input[_builtins.str]] = ..., mongo_cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., start_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: MongoClusterFirewallRuleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> MongoClusterFirewallRule:
