...
class GetSqlResourceSqlUserDefinedFunctionResult:
    ...
    def resource(
        self,
    ) -> Optional[outputs.SqlUserDefinedFunctionGetPropertiesResponseResource]: ...
    @_builtins.property
    @pulumi.getter
...
class AwaitableGetSqlResourceSqlUserDefinedFunctionResult(
    GetSqlResourceSqlUserDefinedFunctionResult
):
    def __await__(self): ...

def get_sql_resource_sql_user_defined_function(
    account_name: Optional[_builtins.str] = ...,
    container_name: Optional[_builtins.str] = ...,
    database_name: Optional[_builtins.str] = ...,
    resource_group_name: Optional[_builtins.str] = ...,
    user_defined_function_name: Optional[_builtins.str] = ...,
...
def get_sql_resource_sql_user_defined_function_output(
    ...
    user_defined_function_name: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetSqlResourceSqlUserDefinedFunctionResult]: ...
