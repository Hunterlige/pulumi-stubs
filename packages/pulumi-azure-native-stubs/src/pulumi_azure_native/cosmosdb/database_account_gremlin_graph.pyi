...
class DatabaseAccountGremlinGraphArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], database_name: pulumi.Input[_builtins.str], options: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], resource: pulumi.Input[GremlinGraphResourceArgs], resource_group_name: pulumi.Input[_builtins.str], graph_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @resource.setter
    def resource(self, value: pulumi.Input[GremlinGraphResourceArgs]): # -> None:
        ...
...
class DatabaseAccountGremlinGraph(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., database_name: Optional[pulumi.Input[_builtins.str]] = ..., graph_name: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., resource: Optional[pulumi.Input[Union[GremlinGraphResourceArgs, GremlinGraphResourceArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: DatabaseAccountGremlinGraphArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> DatabaseAccountGremlinGraph:
