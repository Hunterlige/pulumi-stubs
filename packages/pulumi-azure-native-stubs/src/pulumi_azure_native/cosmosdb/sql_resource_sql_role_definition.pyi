...
class SqlResourceSqlRoleDefinitionArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], resource_group_name: pulumi.Input[_builtins.str], assignable_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., permissions: Optional[pulumi.Input[Sequence[pulumi.Input[PermissionArgs]]]] = ..., role_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., role_name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[RoleDefinitionType]] = ...) -> None:
...
class SqlResourceSqlRoleDefinition(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., assignable_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., permissions: Optional[pulumi.Input[Sequence[pulumi.Input[Union[PermissionArgs, PermissionArgsDict]]]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., role_definition_id: Optional[pulumi.Input[_builtins.str]] = ..., role_name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[RoleDefinitionType]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: SqlResourceSqlRoleDefinitionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> SqlResourceSqlRoleDefinition:
