...
class DatabaseAccountCassandraKeyspaceArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], options: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], resource: pulumi.Input[CassandraKeyspaceResourceArgs], resource_group_name: pulumi.Input[_builtins.str], keyspace_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DatabaseAccountCassandraKeyspace(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_name: Optional[pulumi.Input[_builtins.str]] = ..., keyspace_name: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., resource: Optional[pulumi.Input[Union[CassandraKeyspaceResourceArgs, CassandraKeyspaceResourceArgsDict]]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: DatabaseAccountCassandraKeyspaceArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ...) -> DatabaseAccountCassandraKeyspace:
