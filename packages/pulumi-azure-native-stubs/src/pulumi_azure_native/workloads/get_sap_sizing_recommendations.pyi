...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetSAPSizingRecommendationsResult', 'AwaitableGetSAPSizingRecommendationsResult', 'get_sap_sizing_recommendations', 'get_sap_sizing_recommendations_output']
@pulumi.output_type
