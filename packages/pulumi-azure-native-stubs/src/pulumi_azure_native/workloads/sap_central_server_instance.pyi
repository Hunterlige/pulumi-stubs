...
class SapCentralServerInstance(pulumi.CustomResource):
    ...
    def enqueue_server_properties(
        self,
    ) -> pulumi.Output[Optional[outputs.EnqueueServerPropertiesResponse]]: ...
    @_builtins.property
    @pulumi.getter
    ...
    def gateway_server_properties(
        self,
    ) -> pulumi.Output[Optional[outputs.GatewayServerPropertiesResponse]]: ...
    @_builtins.property
    @pulumi.getter
    ...
    def message_server_properties(
        self,
    ) -> pulumi.Output[Optional[outputs.MessageServerPropertiesResponse]]: ...
    @_builtins.property
    @pulumi.getter
    ...
    def vm_details(
        self,
    ) -> pulumi.Output[Sequence[outputs.CentralServerVmDetailsResponse]]: ...
