...
@pulumi.input_type
class MonitorArgs:
    def __init__(__self__, *, resource_group_name: pulumi.Input[_builtins.str], app_location: Optional[pulumi.Input[_builtins.str]] = ..., app_service_plan_configuration: Optional[pulumi.Input[AppServicePlanConfigurationArgs]] = ..., identity: Optional[pulumi.Input[ManagedServiceIdentityArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., log_analytics_workspace_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., managed_resource_group_configuration: Optional[pulumi.Input[ManagedResourceGroupConfigurationArgs]] = ..., monitor_name: Optional[pulumi.Input[_builtins.str]] = ..., monitor_subnet: Optional[pulumi.Input[_builtins.str]] = ..., routing_preference: Optional[pulumi.Input[Union[_builtins.str, RoutingPreference]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., zone_redundancy_preference: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def app_service_plan_configuration(self, value: Optional[pulumi.Input[AppServicePlanConfigurationArgs]]): # -> None:
        ...
    ...
    def log_analytics_workspace_arm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def monitor_subnet(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def routing_preference(self, value: Optional[pulumi.Input[Union[_builtins.str, RoutingPreference]]]): # -> None:
        ...
    ...
    def zone_redundancy_preference(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Monitor(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., app_location: Optional[pulumi.Input[_builtins.str]] = ..., app_service_plan_configuration: Optional[pulumi.Input[Union[AppServicePlanConfigurationArgs, AppServicePlanConfigurationArgsDict]]] = ..., identity: Optional[pulumi.Input[Union[ManagedServiceIdentityArgs, ManagedServiceIdentityArgsDict]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., log_analytics_workspace_arm_id: Optional[pulumi.Input[_builtins.str]] = ..., managed_resource_group_configuration: Optional[pulumi.Input[Union[ManagedResourceGroupConfigurationArgs, ManagedResourceGroupConfigurationArgsDict]]] = ..., monitor_name: Optional[pulumi.Input[_builtins.str]] = ..., monitor_subnet: Optional[pulumi.Input[_builtins.str]] = ..., resource_group_name: Optional[pulumi.Input[_builtins.str]] = ..., routing_preference: Optional[pulumi.Input[Union[_builtins.str, RoutingPreference]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., zone_redundancy_preference: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
