...
__all__ = ['AlertAutoMitigate', 'AlertRuleStatus', 'AppServicePlanTier', 'BackupType', 'ConditionalOperator', 'DayOfWeek', 'DiskSkuName', 'FileShareConfigurationType', 'IAASVMPolicyType', 'ManagedResourcesNetworkAccessType', 'ManagedServiceIdentityType', 'MonthOfYear', 'NamingPatternType', 'OSType', 'PolicyType', 'RetentionDurationType', 'RetentionScheduleFormat', 'RoutingPreference', 'SAPConfigurationType', 'SAPDatabaseScaleMethod', 'SAPDatabaseType', 'SAPDeploymentType', 'SAPEnvironmentType', 'SAPHighAvailabilityType', 'SAPProductType', 'SAPSoftwareInstallationType', 'SAPVirtualInstanceIdentityType', 'ScheduleRunType', 'SslCryptoProvider', 'SslPreference', 'TieringMode', 'VaultType', 'WeekOfMonth', 'WorkloadType']
