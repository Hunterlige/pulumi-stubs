...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AlertQueryParameterResponse', 'AlertRulePropertiesResponse', 'AppServicePlanConfigurationResponse', 'ApplicationServerConfigurationResponse', 'ApplicationServerFullResourceNamesResponse', 'ApplicationServerVmDetailsResponse', 'CentralServerConfigurationResponse', 'CentralServerFullResourceNamesResponse', 'CentralServerVmDetailsResponse', 'ConfigurationDataResponse', 'ConnectorErrorDefinitionResponse', 'CreateAndMountFileShareConfigurationResponse', 'DBBackupPolicyPropertiesResponse', 'DailyRetentionFormatResponse', 'DailyRetentionScheduleResponse', 'DailyScheduleResponse', 'DatabaseConfigurationResponse', 'DatabaseServerFullResourceNamesResponse', 'DatabaseVmDetailsResponse', 'DayResponse', 'Db2ProviderInstancePropertiesResponse', 'DeployerVmPackagesResponse', 'DeploymentConfigurationResponse', 'DeploymentWithOSConfigurationResponse', 'DiscoveryConfigurationResponse', 'DiskConfigurationResponse', 'DiskDetailsResponse', 'DiskExclusionPropertiesResponse', 'DiskSkuResponse', 'DiskVolumeConfigurationResponse', 'EnqueueReplicationServerPropertiesResponse', 'EnqueueServerPropertiesResponse', 'ErrorAdditionalInfoResponse', 'ErrorDefinitionResponse', 'ErrorDefinitionResponseV1', 'ErrorDefinitionResponseV2', 'ErrorDefinitionResponseV3', 'ErrorDetailResponse', 'ExcelPerformanceDataResponse', 'ExistingRecoveryServicesVaultResponse', 'ExtendedLocationResponse', 'ExternalInstallationSoftwareConfigurationResponse', 'GatewayServerPropertiesResponse', 'HanaBackupDataResponse', 'HanaDbProviderInstancePropertiesResponse', 'HealthResponse', 'HighAvailabilityConfigurationResponse', 'HighAvailabilitySoftwareConfigurationResponse', 'HourlyScheduleResponse', 'ImageReferenceResponse', 'InstantRPAdditionalDetailsResponse', 'LinuxConfigurationResponse', 'LoadBalancerDetailsResponse', 'LoadBalancerResourceNamesResponse', 'LogSchedulePolicyResponse', 'LongTermRetentionPolicyResponse', 'LongTermSchedulePolicyResponse', 'ManagedRGConfigurationResponse', 'ManagedResourceGroupConfigurationResponse', 'ManagedServiceIdentityResponse', 'MessageServerPropertiesResponse', 'MonthlyRetentionScheduleResponse', 'MountFileShareConfigurationResponse', 'MsSqlServerProviderInstancePropertiesResponse', 'NativePerformanceDataResponse', 'NetworkConfigurationResponse', 'NetworkInterfaceResourceNamesResponse', 'NewRecoveryServicesVaultResponse', 'OSProfileResponse', 'OracleProviderInstancePropertiesResponse', 'OsSapConfigurationResponse', ..., 'PrometheusOsProviderInstancePropertiesResponse', 'RetentionDurationResponse', 'SAPAvailabilityZonePairResponse', 'SAPDiskConfigurationResponse', ..., 'SAPMigrateErrorResponse', 'SAPMigrateErrorResponseV1', 'SAPMigrateErrorResponseV2', 'SAPSupportedSkuResponse', 'SAPVirtualInstanceErrorResponse', 'SAPVirtualInstanceIdentityResponse', 'SSLConfigurationResponse', 'SapLandscapeMonitorMetricThresholdsResponse', 'SapLandscapeMonitorPropertiesGroupingResponse', 'SapLandscapeMonitorSidMappingResponse', 'SapNetWeaverProviderInstancePropertiesResponse', 'ServiceInitiatedSoftwareConfigurationResponse', 'SettingsResponse', 'SharedStorageResourceNamesResponse', 'SimpleRetentionPolicyResponse', 'SimpleSchedulePolicyResponse', 'SimpleSchedulePolicyV2Response', 'SingleServerConfigurationResponse', 'SingleServerFullResourceNamesResponse', 'SkipFileShareConfigurationResponse', 'SnapshotBackupAdditionalDetailsResponse', 'SqlBackupDataResponse', 'SshConfigurationResponse', 'SshKeyPairResponse', 'SshPublicKeyResponse', 'StorageConfigurationResponse', 'StorageInformationResponse', 'SubProtectionPolicyResponse', 'SystemDataResponse', 'ThreeTierConfigurationResponse', 'ThreeTierFullResourceNamesResponse', 'TieringPolicyResponse', 'UserAssignedIdentityPropertiesResponse', 'UserAssignedIdentityResponse', 'UserAssignedManagedIdentityDetailsResponse', 'UserAssignedServiceIdentityResponse', 'VMBackupDataResponse', 'VMBackupPolicyPropertiesResponse', 'VirtualMachineConfigurationResponse', 'VirtualMachineResourceNamesResponse', 'WeeklyRetentionFormatResponse', 'WeeklyRetentionScheduleResponse', 'WeeklyScheduleResponse', 'WindowsConfigurationResponse', 'YearlyRetentionScheduleResponse']
@pulumi.output_type
...
class AlertRulePropertiesResponse(dict):
    ...
    def __init__(__self__, *, action_groups: Optional[Sequence[_builtins.str]] = ..., alert_query_parameters: Optional[Sequence[outputs.AlertQueryParameterResponse]] = ..., auto_mitigate: Optional[_builtins.str] = ..., dimension: Optional[_builtins.str] = ..., evaluation_frequency: Optional[_builtins.int] = ..., failing_periods_operator: Optional[_builtins.str] = ..., failing_periods_to_alert: Optional[_builtins.int] = ..., mute_actions_duration: Optional[_builtins.int] = ..., severity: Optional[_builtins.int] = ..., status: Optional[_builtins.str] = ..., threshold: Optional[_builtins.int] = ..., threshold_operator: Optional[_builtins.str] = ..., window_size: Optional[_builtins.int] = ...) -> None:
...
class AppServicePlanConfigurationResponse(dict):
    ...
    def __init__(__self__, *, capacity: Optional[_builtins.int] = ..., tier: Optional[_builtins.str] = ...) -> None:
...
class ApplicationServerConfigurationResponse(dict):
    ...
    def __init__(__self__, *, instance_count: _builtins.float, subnet_id: _builtins.str, virtual_machine_configuration: outputs.VirtualMachineConfigurationResponse) -> None:
...
class ApplicationServerFullResourceNamesResponse(dict):
    ...
    def __init__(__self__, *, availability_set_name: Optional[_builtins.str] = ..., virtual_machines: Optional[Sequence[outputs.VirtualMachineResourceNamesResponse]] = ...) -> None:
...
class ApplicationServerVmDetailsResponse(dict):
    ...
    def __init__(__self__, *, storage_details: Sequence[outputs.StorageInformationResponse], type: _builtins.str, virtual_machine_id: _builtins.str) -> None:
...
class CentralServerFullResourceNamesResponse(dict):
    ...
    def __init__(__self__, *, availability_set_name: Optional[_builtins.str] = ..., load_balancer: Optional[outputs.LoadBalancerResourceNamesResponse] = ..., virtual_machines: Optional[Sequence[outputs.VirtualMachineResourceNamesResponse]] = ...) -> None:
...
class ConfigurationDataResponse(dict):
    ...
    def __init__(__self__, *, cpu: _builtins.int, cpu_in_mhz: _builtins.int, cpu_type: _builtins.str, database_type: _builtins.str, hardware_manufacturer: _builtins.str, model: _builtins.str, ram: _builtins.int, saps: _builtins.int, target_hana_ram_size_gb: _builtins.int, total_disk_iops: _builtins.int, total_disk_size_gb: _builtins.int) -> None:
...
class ConnectorErrorDefinitionResponse(dict):
    ...
    def __init__(__self__, *, code: _builtins.str, details: Sequence[outputs.ConnectorErrorDefinitionResponse], message: _builtins.str) -> None:
...
class CreateAndMountFileShareConfigurationResponse(dict):
    ...
    def __init__(__self__, *, configuration_type: _builtins.str, resource_group: Optional[_builtins.str] = ..., storage_account_name: Optional[_builtins.str] = ...) -> None:
...
class DatabaseConfigurationResponse(dict):
    ...
    def __init__(__self__, *, instance_count: _builtins.float, subnet_id: _builtins.str, virtual_machine_configuration: outputs.VirtualMachineConfigurationResponse, database_type: Optional[_builtins.str] = ..., disk_configuration: Optional[outputs.DiskConfigurationResponse] = ...) -> None:
...
class DatabaseVmDetailsResponse(dict):
    ...
    def __init__(__self__, *, status: _builtins.str, storage_details: Sequence[outputs.StorageInformationResponse], virtual_machine_id: _builtins.str) -> None:
...
class Db2ProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *, provider_type: _builtins.str, db_name: Optional[_builtins.str] = ..., db_password: Optional[_builtins.str] = ..., db_password_uri: Optional[_builtins.str] = ..., db_port: Optional[_builtins.str] = ..., db_username: Optional[_builtins.str] = ..., hostname: Optional[_builtins.str] = ..., sap_sid: Optional[_builtins.str] = ..., ssl_certificate_uri: Optional[_builtins.str] = ..., ssl_preference: Optional[_builtins.str] = ...) -> None:
...
class DeployerVmPackagesResponse(dict):
    ...
    def __init__(__self__, *, storage_account_id: Optional[_builtins.str] = ..., url: Optional[_builtins.str] = ...) -> None:
...
class DeploymentConfigurationResponse(dict):
    ...
    def __init__(__self__, *, configuration_type: _builtins.str, app_location: Optional[_builtins.str] = ..., infrastructure_configuration: Optional[Any] = ..., software_configuration: Optional[Any] = ...) -> None:
...
class DeploymentWithOSConfigurationResponse(dict):
    ...
    def __init__(__self__, *, configuration_type: _builtins.str, app_location: Optional[_builtins.str] = ..., infrastructure_configuration: Optional[Any] = ..., os_sap_configuration: Optional[outputs.OsSapConfigurationResponse] = ..., software_configuration: Optional[Any] = ...) -> None:
...
class DiscoveryConfigurationResponse(dict):
    ...
    def __init__(__self__, *, app_location: _builtins.str, configuration_type: _builtins.str, central_server_vm_id: Optional[_builtins.str] = ..., managed_rg_storage_account_name: Optional[_builtins.str] = ...) -> None:
...
class DiskConfigurationResponse(dict):
    ...
    def __init__(__self__, *, disk_volume_configurations: Optional[Mapping[str, outputs.DiskVolumeConfigurationResponse]] = ...) -> None:
...
class DiskDetailsResponse(dict):
    ...
    def __init__(__self__, *, disk_tier: Optional[_builtins.str] = ..., iops_read_write: Optional[_builtins.float] = ..., maximum_supported_disk_count: Optional[_builtins.float] = ..., mbps_read_write: Optional[_builtins.float] = ..., minimum_supported_disk_count: Optional[_builtins.float] = ..., size_gb: Optional[_builtins.float] = ..., sku: Optional[outputs.DiskSkuResponse] = ...) -> None:
...
class DiskExclusionPropertiesResponse(dict):
    ...
    def __init__(__self__, *, disk_lun_list: Sequence[_builtins.int], is_inclusion_list: _builtins.bool) -> None:
...
class DiskVolumeConfigurationResponse(dict):
    ...
    def __init__(__self__, *, count: Optional[_builtins.float] = ..., size_gb: Optional[_builtins.float] = ..., sku: Optional[outputs.DiskSkuResponse] = ...) -> None:
...
class EnqueueReplicationServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *, ers_version: _builtins.str, health: _builtins.str, hostname: _builtins.str, instance_no: _builtins.str, ip_address: _builtins.str, kernel_patch: _builtins.str, kernel_version: _builtins.str) -> None:
...
class EnqueueServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *, health: _builtins.str, hostname: _builtins.str, ip_address: _builtins.str, port: _builtins.float) -> None:
...
class ErrorDefinitionResponse(dict):
    ...
    def __init__(__self__, *, code: _builtins.str, details: Sequence[outputs.ErrorDefinitionResponse], message: _builtins.str) -> None:
...
class ErrorDefinitionResponseV1(dict):
    ...
    def __init__(__self__, *, code: _builtins.str, details: Sequence[outputs.ErrorDefinitionResponse], message: _builtins.str, recommendation: _builtins.str) -> None:
...
class ExcelPerformanceDataResponse(dict):
    ...
    def __init__(__self__, *, data_source: _builtins.str, max_cpu_load: _builtins.int, total_source_db_size_gb: _builtins.int) -> None:
...
class ExternalInstallationSoftwareConfigurationResponse(dict):
    ...
    def __init__(__self__, *, software_installation_type: _builtins.str, central_server_vm_id: Optional[_builtins.str] = ...) -> None:
...
class HanaBackupDataResponse(dict):
    ...
    def __init__(__self__, *, backup_policy: outputs.DBBackupPolicyPropertiesResponse, backup_type: _builtins.str, hdbuserstore_key_name: _builtins.str, recovery_services_vault: Any, db_instance_snapshot_backup_policy: Optional[outputs.DBBackupPolicyPropertiesResponse] = ..., instance_number: Optional[_builtins.str] = ..., ssl_configuration: Optional[outputs.SSLConfigurationResponse] = ...) -> None:
...
class HanaDbProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *, provider_type: _builtins.str, db_name: Optional[_builtins.str] = ..., db_password: Optional[_builtins.str] = ..., db_password_uri: Optional[_builtins.str] = ..., db_username: Optional[_builtins.str] = ..., hostname: Optional[_builtins.str] = ..., instance_number: Optional[_builtins.str] = ..., sap_sid: Optional[_builtins.str] = ..., sql_port: Optional[_builtins.str] = ..., ssl_certificate_uri: Optional[_builtins.str] = ..., ssl_host_name_in_certificate: Optional[_builtins.str] = ..., ssl_preference: Optional[_builtins.str] = ...) -> None:
...
class HealthResponse(dict):
    ...
    def __init__(__self__, *, health_state: _builtins.str, impacting_reasons: _builtins.str) -> None:
...
class HighAvailabilitySoftwareConfigurationResponse(dict):
    ...
    def __init__(__self__, *, fencing_client_id: _builtins.str, fencing_client_password: _builtins.str) -> None:
...
class ImageReferenceResponse(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., offer: Optional[_builtins.str] = ..., publisher: Optional[_builtins.str] = ..., sku: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class LinuxConfigurationResponse(dict):
    ...
    def __init__(__self__, *, os_type: _builtins.str, disable_password_authentication: Optional[_builtins.bool] = ..., ssh: Optional[outputs.SshConfigurationResponse] = ..., ssh_key_pair: Optional[outputs.SshKeyPairResponse] = ...) -> None:
...
class LoadBalancerResourceNamesResponse(dict):
    ...
    def __init__(__self__, *, backend_pool_names: Optional[Sequence[_builtins.str]] = ..., frontend_ip_configuration_names: Optional[Sequence[_builtins.str]] = ..., health_probe_names: Optional[Sequence[_builtins.str]] = ..., load_balancer_name: Optional[_builtins.str] = ...) -> None:
...
class MessageServerPropertiesResponse(dict):
    ...
    def __init__(__self__, *, health: _builtins.str, hostname: _builtins.str, http_port: _builtins.float, https_port: _builtins.float, internal_ms_port: _builtins.float, ip_address: _builtins.str, ms_port: _builtins.float) -> None:
...
class MountFileShareConfigurationResponse(dict):
    ...
    def __init__(__self__, *, configuration_type: _builtins.str, id: _builtins.str, private_endpoint_id: _builtins.str) -> None:
...
class MsSqlServerProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *, provider_type: _builtins.str, db_password: Optional[_builtins.str] = ..., db_password_uri: Optional[_builtins.str] = ..., db_port: Optional[_builtins.str] = ..., db_username: Optional[_builtins.str] = ..., hostname: Optional[_builtins.str] = ..., sap_sid: Optional[_builtins.str] = ..., ssl_certificate_uri: Optional[_builtins.str] = ..., ssl_preference: Optional[_builtins.str] = ...) -> None:
...
class NetworkConfigurationResponse(dict):
    ...
    def __init__(__self__, *, is_secondary_ip_enabled: Optional[_builtins.bool] = ...) -> None:
...
class NetworkInterfaceResourceNamesResponse(dict):
    ...
    def __init__(__self__, *, network_interface_name: Optional[_builtins.str] = ...) -> None:
...
class NewRecoveryServicesVaultResponse(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, resource_group: _builtins.str, vault_type: _builtins.str) -> None:
...
class OSProfileResponse(dict):
    ...
    def __init__(__self__, *, admin_password: Optional[_builtins.str] = ..., admin_username: Optional[_builtins.str] = ..., os_configuration: Optional[Any] = ...) -> None:
...
class OsSapConfigurationResponse(dict):
    ...
    def __init__(__self__, *, deployer_vm_packages: Optional[outputs.DeployerVmPackagesResponse] = ..., sap_fqdn: Optional[_builtins.str] = ...) -> None:
...
class PrometheusHaClusterProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *, provider_type: _builtins.str, cluster_name: Optional[_builtins.str] = ..., hostname: Optional[_builtins.str] = ..., prometheus_url: Optional[_builtins.str] = ..., sid: Optional[_builtins.str] = ..., ssl_certificate_uri: Optional[_builtins.str] = ..., ssl_preference: Optional[_builtins.str] = ...) -> None:
...
class PrometheusOsProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *, provider_type: _builtins.str, prometheus_url: Optional[_builtins.str] = ..., sap_sid: Optional[_builtins.str] = ..., ssl_certificate_uri: Optional[_builtins.str] = ..., ssl_preference: Optional[_builtins.str] = ...) -> None:
...
class SAPAvailabilityZonePairResponse(dict):
    ...
    def __init__(__self__, *, zone_a: Optional[_builtins.float] = ..., zone_b: Optional[_builtins.float] = ...) -> None:
...
class SAPDiskConfigurationResponse(dict):
    ...
    def __init__(__self__, *, recommended_configuration: Optional[outputs.DiskVolumeConfigurationResponse] = ..., supported_configurations: Optional[Sequence[outputs.DiskDetailsResponse]] = ...) -> None:
...
class SAPInstallWithoutOSConfigSoftwareConfigurationResponse(dict):
    ...
    def __init__(__self__, *, bom_url: _builtins.str, sap_bits_storage_account_id: _builtins.str, software_installation_type: _builtins.str, software_version: _builtins.str, high_availability_software_configuration: Optional[outputs.HighAvailabilitySoftwareConfigurationResponse] = ...) -> None:
...
class SAPMigrateErrorResponse(dict):
    ...
    def __init__(__self__, *, code: _builtins.str, details: Sequence[outputs.ErrorDefinitionResponseV1], message: _builtins.str, recommendation: _builtins.str) -> None:
...
class SAPMigrateErrorResponseV1(dict):
    ...
    def __init__(__self__, *, code: _builtins.str, details: Sequence[outputs.ErrorDefinitionResponseV2], message: _builtins.str, recommendation: _builtins.str) -> None:
...
class SAPMigrateErrorResponseV2(dict):
    ...
    def __init__(__self__, *, code: _builtins.str, details: Sequence[outputs.ErrorDefinitionResponseV3], message: _builtins.str, recommendation: _builtins.str) -> None:
...
class SAPSupportedSkuResponse(dict):
    ...
    def __init__(__self__, *, is_app_server_certified: Optional[_builtins.bool] = ..., is_database_certified: Optional[_builtins.bool] = ..., vm_sku: Optional[_builtins.str] = ...) -> None:
...
class SAPVirtualInstanceErrorResponse(dict):
    ...
    def __init__(__self__, *, properties: Optional[outputs.ErrorDefinitionResponse] = ...) -> None:
...
class SAPVirtualInstanceIdentityResponse(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, user_assigned_identities: Optional[Mapping[str, outputs.UserAssignedIdentityResponse]] = ...) -> None:
...
class SSLConfigurationResponse(dict):
    ...
    def __init__(__self__, *, ssl_crypto_provider: Optional[_builtins.str] = ..., ssl_host_name_in_certificate: Optional[_builtins.str] = ..., ssl_key_store: Optional[_builtins.str] = ..., ssl_trust_store: Optional[_builtins.str] = ...) -> None:
...
class SapLandscapeMonitorMetricThresholdsResponse(dict):
    ...
    def __init__(__self__, *, green: Optional[_builtins.float] = ..., name: Optional[_builtins.str] = ..., red: Optional[_builtins.float] = ..., yellow: Optional[_builtins.float] = ...) -> None:
...
class SapLandscapeMonitorPropertiesGroupingResponse(dict):
    ...
    def __init__(__self__, *, landscape: Optional[Sequence[outputs.SapLandscapeMonitorSidMappingResponse]] = ..., sap_application: Optional[Sequence[outputs.SapLandscapeMonitorSidMappingResponse]] = ...) -> None:
...
class SapLandscapeMonitorSidMappingResponse(dict):
    ...
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., top_sid: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SapNetWeaverProviderInstancePropertiesResponse(dict):
    ...
    def __init__(__self__, *, provider_type: _builtins.str, sap_client_id: Optional[_builtins.str] = ..., sap_host_file_entries: Optional[Sequence[_builtins.str]] = ..., sap_hostname: Optional[_builtins.str] = ..., sap_instance_nr: Optional[_builtins.str] = ..., sap_password: Optional[_builtins.str] = ..., sap_password_uri: Optional[_builtins.str] = ..., sap_port_number: Optional[_builtins.str] = ..., sap_sid: Optional[_builtins.str] = ..., sap_username: Optional[_builtins.str] = ..., ssl_certificate_uri: Optional[_builtins.str] = ..., ssl_preference: Optional[_builtins.str] = ...) -> None:
...
class ServiceInitiatedSoftwareConfigurationResponse(dict):
    ...
    def __init__(__self__, *, bom_url: _builtins.str, sap_bits_storage_account_id: _builtins.str, sap_fqdn: _builtins.str, software_installation_type: _builtins.str, software_version: _builtins.str, ssh_private_key: _builtins.str, high_availability_software_configuration: Optional[outputs.HighAvailabilitySoftwareConfigurationResponse] = ...) -> None:
...
class SharedStorageResourceNamesResponse(dict):
    ...
    def __init__(__self__, *, shared_storage_account_name: Optional[_builtins.str] = ..., shared_storage_account_private_end_point_name: Optional[_builtins.str] = ...) -> None:
...
class SingleServerConfigurationResponse(dict):
    ...
    def __init__(__self__, *, app_resource_group: _builtins.str, deployment_type: _builtins.str, subnet_id: _builtins.str, virtual_machine_configuration: outputs.VirtualMachineConfigurationResponse, custom_resource_names: Optional[outputs.SingleServerFullResourceNamesResponse] = ..., database_type: Optional[_builtins.str] = ..., db_disk_configuration: Optional[outputs.DiskConfigurationResponse] = ..., network_configuration: Optional[outputs.NetworkConfigurationResponse] = ...) -> None:
...
class SingleServerFullResourceNamesResponse(dict):
    ...
    def __init__(__self__, *, naming_pattern_type: _builtins.str, virtual_machine: Optional[outputs.VirtualMachineResourceNamesResponse] = ...) -> None:
...
class SqlBackupDataResponse(dict):
    ...
    def __init__(__self__, *, backup_policy: outputs.DBBackupPolicyPropertiesResponse, backup_type: _builtins.str, recovery_services_vault: Any) -> None:
...
class SshKeyPairResponse(dict):
    ...
    def __init__(__self__, *, private_key: Optional[_builtins.str] = ..., public_key: Optional[_builtins.str] = ...) -> None:
...
class StorageConfigurationResponse(dict):
    ...
    def __init__(__self__, *, transport_file_share_configuration: Optional[Any] = ...) -> None:
...
class ThreeTierConfigurationResponse(dict):
    ...
    def __init__(__self__, *, app_resource_group: _builtins.str, application_server: outputs.ApplicationServerConfigurationResponse, central_server: outputs.CentralServerConfigurationResponse, database_server: outputs.DatabaseConfigurationResponse, deployment_type: _builtins.str, custom_resource_names: Optional[outputs.ThreeTierFullResourceNamesResponse] = ..., high_availability_config: Optional[outputs.HighAvailabilityConfigurationResponse] = ..., network_configuration: Optional[outputs.NetworkConfigurationResponse] = ..., storage_configuration: Optional[outputs.StorageConfigurationResponse] = ...) -> None:
...
class ThreeTierFullResourceNamesResponse(dict):
    ...
    def __init__(__self__, *, naming_pattern_type: _builtins.str, application_server: Optional[outputs.ApplicationServerFullResourceNamesResponse] = ..., central_server: Optional[outputs.CentralServerFullResourceNamesResponse] = ..., database_server: Optional[outputs.DatabaseServerFullResourceNamesResponse] = ..., shared_storage: Optional[outputs.SharedStorageResourceNamesResponse] = ...) -> None:
...
class VMBackupDataResponse(dict):
    ...
    def __init__(__self__, *, backup_policy: outputs.VMBackupPolicyPropertiesResponse, backup_type: _builtins.str, recovery_services_vault: Any, disk_exclusion_properties: Optional[outputs.DiskExclusionPropertiesResponse] = ...) -> None:
...
class VMBackupPolicyPropertiesResponse(dict):
    ...
    def __init__(__self__, *, backup_management_type: _builtins.str, name: _builtins.str, instant_rp_details: Optional[outputs.InstantRPAdditionalDetailsResponse] = ..., instant_rp_retention_range_in_days: Optional[_builtins.int] = ..., policy_type: Optional[_builtins.str] = ..., protected_items_count: Optional[_builtins.int] = ..., resource_guard_operation_requests: Optional[Sequence[_builtins.str]] = ..., retention_policy: Optional[Any] = ..., schedule_policy: Optional[Any] = ..., tiering_policy: Optional[Mapping[str, outputs.TieringPolicyResponse]] = ..., time_zone: Optional[_builtins.str] = ...) -> None:
...
class VirtualMachineConfigurationResponse(dict):
    ...
    def __init__(__self__, *, image_reference: outputs.ImageReferenceResponse, os_profile: outputs.OSProfileResponse, vm_size: _builtins.str) -> None:
...
class VirtualMachineResourceNamesResponse(dict):
    ...
    def __init__(__self__, *, data_disk_names: Optional[Mapping[str, Sequence[_builtins.str]]] = ..., host_name: Optional[_builtins.str] = ..., network_interfaces: Optional[Sequence[outputs.NetworkInterfaceResourceNamesResponse]] = ..., os_disk_name: Optional[_builtins.str] = ..., vm_name: Optional[_builtins.str] = ...) -> None:
