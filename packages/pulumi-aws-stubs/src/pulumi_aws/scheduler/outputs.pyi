...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ScheduleFlexibleTimeWindow', 'ScheduleTarget', 'ScheduleTargetDeadLetterConfig', 'ScheduleTargetEcsParameters', ..., 'ScheduleTargetEcsParametersNetworkConfiguration', 'ScheduleTargetEcsParametersPlacementConstraint', 'ScheduleTargetEcsParametersPlacementStrategy', 'ScheduleTargetEventbridgeParameters', 'ScheduleTargetKinesisParameters', 'ScheduleTargetRetryPolicy', 'ScheduleTargetSagemakerPipelineParameters', ..., 'ScheduleTargetSqsParameters']
@pulumi.output_type
class ScheduleFlexibleTimeWindow(dict):
    ...
    def __init__(__self__, *, mode: _builtins.str, maximum_window_in_minutes: Optional[_builtins.int] = ...) -> None:
...
class ScheduleTarget(dict):
    ...
    def __init__(__self__, *, arn: _builtins.str, role_arn: _builtins.str, dead_letter_config: Optional[outputs.ScheduleTargetDeadLetterConfig] = ..., ecs_parameters: Optional[outputs.ScheduleTargetEcsParameters] = ..., eventbridge_parameters: Optional[outputs.ScheduleTargetEventbridgeParameters] = ..., input: Optional[_builtins.str] = ..., kinesis_parameters: Optional[outputs.ScheduleTargetKinesisParameters] = ..., retry_policy: Optional[outputs.ScheduleTargetRetryPolicy] = ..., sagemaker_pipeline_parameters: Optional[outputs.ScheduleTargetSagemakerPipelineParameters] = ..., sqs_parameters: Optional[outputs.ScheduleTargetSqsParameters] = ...) -> None:
...
class ScheduleTargetEcsParameters(dict):
    ...
    def __init__(__self__, *, task_definition_arn: _builtins.str, capacity_provider_strategies: Optional[Sequence[outputs.ScheduleTargetEcsParametersCapacityProviderStrategy]] = ..., enable_ecs_managed_tags: Optional[_builtins.bool] = ..., enable_execute_command: Optional[_builtins.bool] = ..., group: Optional[_builtins.str] = ..., launch_type: Optional[_builtins.str] = ..., network_configuration: Optional[outputs.ScheduleTargetEcsParametersNetworkConfiguration] = ..., placement_constraints: Optional[Sequence[outputs.ScheduleTargetEcsParametersPlacementConstraint]] = ..., placement_strategies: Optional[Sequence[outputs.ScheduleTargetEcsParametersPlacementStrategy]] = ..., platform_version: Optional[_builtins.str] = ..., propagate_tags: Optional[_builtins.str] = ..., reference_id: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., task_count: Optional[_builtins.int] = ...) -> None:
...
class ScheduleTargetEventbridgeParameters(dict):
    ...
    def __init__(__self__, *, detail_type: _builtins.str, source: _builtins.str) -> None:
...
class ScheduleTargetSagemakerPipelineParameters(dict):
    ...
    def __init__(__self__, *, pipeline_parameters: Optional[Sequence[outputs.ScheduleTargetSagemakerPipelineParametersPipelineParameter]] = ...) -> None:
