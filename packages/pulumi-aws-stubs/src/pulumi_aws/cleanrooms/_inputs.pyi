...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CollaborationDataEncryptionMetadataArgs', 'CollaborationDataEncryptionMetadataArgsDict', 'CollaborationMemberArgs', 'CollaborationMemberArgsDict', 'ConfiguredTableTableReferenceArgs', 'ConfiguredTableTableReferenceArgsDict', 'MembershipDefaultResultConfigurationArgs', 'MembershipDefaultResultConfigurationArgsDict', ..., ..., ..., ..., 'MembershipPaymentConfigurationArgs', 'MembershipPaymentConfigurationArgsDict', 'MembershipPaymentConfigurationQueryComputeArgs', 'MembershipPaymentConfigurationQueryComputeArgsDict']
...
class CollaborationDataEncryptionMetadataArgs:
    def __init__(__self__, *, allow_clear_text: pulumi.Input[_builtins.bool], allow_duplicates: pulumi.Input[_builtins.bool], allow_joins_on_columns_with_different_names: pulumi.Input[_builtins.bool], preserve_nulls: pulumi.Input[_builtins.bool]) -> None:
    ...
    def allow_clear_text(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def allow_duplicates(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def allow_joins_on_columns_with_different_names(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def preserve_nulls(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class CollaborationMemberArgs:
    def __init__(__self__, *, account_id: pulumi.Input[_builtins.str], display_name: pulumi.Input[_builtins.str], member_abilities: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def member_abilities(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class ConfiguredTableTableReferenceArgs:
    def __init__(__self__, *, database_name: pulumi.Input[_builtins.str], table_name: pulumi.Input[_builtins.str]) -> None:
        ...
...
class MembershipDefaultResultConfigurationArgs:
    def __init__(__self__, *, output_configuration: pulumi.Input[MembershipDefaultResultConfigurationOutputConfigurationArgs], role_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def output_configuration(self, value: pulumi.Input[MembershipDefaultResultConfigurationOutputConfigurationArgs]): # -> None:
        ...
...
class MembershipDefaultResultConfigurationOutputConfigurationArgs:
    def __init__(__self__, *, s3: pulumi.Input[MembershipDefaultResultConfigurationOutputConfigurationS3Args]) -> None:
        ...
    ...
    @s3.setter
    def s3(self, value: pulumi.Input[MembershipDefaultResultConfigurationOutputConfigurationS3Args]): # -> None:
        ...
...
class MembershipDefaultResultConfigurationOutputConfigurationS3Args:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], result_format: pulumi.Input[_builtins.str], key_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    def result_format(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class MembershipPaymentConfigurationArgs:
    def __init__(__self__, *, query_compute: pulumi.Input[MembershipPaymentConfigurationQueryComputeArgs]) -> None:
        ...
    ...
    def query_compute(self, value: pulumi.Input[MembershipPaymentConfigurationQueryComputeArgs]): # -> None:
        ...
...
class MembershipPaymentConfigurationQueryComputeArgs:
    ...
    def is_responsible(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
