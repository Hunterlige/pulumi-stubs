...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CollaborationDataEncryptionMetadata', 'CollaborationMember', 'ConfiguredTableTableReference', 'MembershipDefaultResultConfiguration', ..., ..., 'MembershipPaymentConfiguration', 'MembershipPaymentConfigurationQueryCompute']
@pulumi.output_type
class CollaborationDataEncryptionMetadata(dict):
    ...
    def __init__(__self__, *, allow_clear_text: _builtins.bool, allow_duplicates: _builtins.bool, allow_joins_on_columns_with_different_names: _builtins.bool, preserve_nulls: _builtins.bool) -> None:
...
class CollaborationMember(dict):
    ...
    def __init__(__self__, *, account_id: _builtins.str, display_name: _builtins.str, member_abilities: Sequence[_builtins.str], status: Optional[_builtins.str] = ...) -> None:
...
class ConfiguredTableTableReference(dict):
    ...
    def __init__(__self__, *, database_name: _builtins.str, table_name: _builtins.str) -> None:
        ...
...
class MembershipDefaultResultConfiguration(dict):
    ...
    def __init__(__self__, *, output_configuration: outputs.MembershipDefaultResultConfigurationOutputConfiguration, role_arn: Optional[_builtins.str] = ...) -> None:
...
class MembershipDefaultResultConfigurationOutputConfiguration(dict):
    def __init__(__self__, *, s3: outputs.MembershipDefaultResultConfigurationOutputConfigurationS3) -> None:
        ...
...
class MembershipDefaultResultConfigurationOutputConfigurationS3(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, result_format: _builtins.str, key_prefix: Optional[_builtins.str] = ...) -> None:
        ...
...
class MembershipPaymentConfiguration(dict):
    ...
    def __init__(__self__, *, query_compute: outputs.MembershipPaymentConfigurationQueryCompute) -> None:
        ...
