...
class CustomRoutingAcceleratorArgs:
    def __init__(
        ...
        *,
        attributes: Optional[
            pulumi.Input[CustomRoutingAcceleratorAttributesArgs]
        ] = ...,
    ...
    def attributes(
        self,
    ) -> Optional[pulumi.Input[CustomRoutingAcceleratorAttributesArgs]]: ...
    @attributes.setter
    def attributes(
        self, value: Optional[pulumi.Input[CustomRoutingAcceleratorAttributesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _CustomRoutingAcceleratorState:
    def __init__(
        ...
        *,
        ...
        ip_sets: Optional[
            pulumi.Input[Sequence[pulumi.Input[CustomRoutingAcceleratorIpSetArgs]]]
        ] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tags_all: Optional[
...
class CustomRoutingAccelerator(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[CustomRoutingAcceleratorArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
    ...
    def attributes(
        self,
    ) -> pulumi.Output[Optional[outputs.CustomRoutingAcceleratorAttributes]]: ...
    @_builtins.property
    @pulumi.getter(name="dnsName")
    ...
    def ip_sets(
        self,
    ) -> pulumi.Output[Sequence[outputs.CustomRoutingAcceleratorIpSet]]: ...
    @_builtins.property
    @pulumi.getter
