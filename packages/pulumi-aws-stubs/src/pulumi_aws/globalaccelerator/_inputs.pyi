...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AcceleratorAttributesArgs', 'AcceleratorAttributesArgsDict', 'AcceleratorIpSetArgs', 'AcceleratorIpSetArgsDict', 'CrossAccountAttachmentResourceArgs', 'CrossAccountAttachmentResourceArgsDict', 'CustomRoutingAcceleratorAttributesArgs', 'CustomRoutingAcceleratorAttributesArgsDict', 'CustomRoutingAcceleratorIpSetArgs', 'CustomRoutingAcceleratorIpSetArgsDict', ..., ..., ..., ..., 'CustomRoutingListenerPortRangeArgs', 'CustomRoutingListenerPortRangeArgsDict', 'EndpointGroupEndpointConfigurationArgs', 'EndpointGroupEndpointConfigurationArgsDict', 'EndpointGroupPortOverrideArgs', 'EndpointGroupPortOverrideArgsDict', 'ListenerPortRangeArgs', 'ListenerPortRangeArgsDict']
...
class AcceleratorAttributesArgs:
    def __init__(__self__, *, flow_logs_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., flow_logs_s3_bucket: Optional[pulumi.Input[_builtins.str]] = ..., flow_logs_s3_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def flow_logs_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def flow_logs_s3_bucket(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def flow_logs_s3_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AcceleratorIpSetArgs:
    def __init__(__self__, *, ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ip_family: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CrossAccountAttachmentResourceArgs:
    def __init__(__self__, *, cidr_block: Optional[pulumi.Input[_builtins.str]] = ..., endpoint_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CustomRoutingEndpointGroupDestinationConfigurationArgs:
    def __init__(__self__, *, from_port: pulumi.Input[_builtins.int], protocols: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], to_port: pulumi.Input[_builtins.int]) -> None:
...
class CustomRoutingEndpointGroupEndpointConfigurationArgs:
    def __init__(__self__, *, endpoint_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EndpointGroupEndpointConfigurationArgs:
    def __init__(__self__, *, attachment_arn: Optional[pulumi.Input[_builtins.str]] = ..., client_ip_preservation_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., endpoint_id: Optional[pulumi.Input[_builtins.str]] = ..., weight: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def attachment_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def client_ip_preservation_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class EndpointGroupPortOverrideArgs:
    def __init__(__self__, *, endpoint_port: pulumi.Input[_builtins.int], listener_port: pulumi.Input[_builtins.int]) -> None:
