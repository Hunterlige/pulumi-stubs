...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AcceleratorAttributes', 'AcceleratorIpSet', 'CrossAccountAttachmentResource', 'CustomRoutingAcceleratorAttributes', 'CustomRoutingAcceleratorIpSet', 'CustomRoutingEndpointGroupDestinationConfiguration', 'CustomRoutingEndpointGroupEndpointConfiguration', 'CustomRoutingListenerPortRange', 'EndpointGroupEndpointConfiguration', 'EndpointGroupPortOverride', 'ListenerPortRange', 'GetAcceleratorAttributeResult', 'GetAcceleratorIpSetResult', 'GetCustomRoutingAcceleratorAttributeResult', 'GetCustomRoutingAcceleratorIpSetResult']
@pulumi.output_type
class AcceleratorAttributes(dict):
    ...
    def __init__(__self__, *, flow_logs_enabled: Optional[_builtins.bool] = ..., flow_logs_s3_bucket: Optional[_builtins.str] = ..., flow_logs_s3_prefix: Optional[_builtins.str] = ...) -> None:
...
class AcceleratorIpSet(dict):
    ...
    def __init__(__self__, *, ip_addresses: Optional[Sequence[_builtins.str]] = ..., ip_family: Optional[_builtins.str] = ...) -> None:
...
class CrossAccountAttachmentResource(dict):
    ...
    def __init__(__self__, *, cidr_block: Optional[_builtins.str] = ..., endpoint_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ...) -> None:
...
class CustomRoutingEndpointGroupDestinationConfiguration(dict):
    ...
    def __init__(__self__, *, from_port: _builtins.int, protocols: Sequence[_builtins.str], to_port: _builtins.int) -> None:
...
class EndpointGroupEndpointConfiguration(dict):
    ...
    def __init__(__self__, *, attachment_arn: Optional[_builtins.str] = ..., client_ip_preservation_enabled: Optional[_builtins.bool] = ..., endpoint_id: Optional[_builtins.str] = ..., weight: Optional[_builtins.int] = ...) -> None:
...
class EndpointGroupPortOverride(dict):
    ...
    def __init__(__self__, *, endpoint_port: _builtins.int, listener_port: _builtins.int) -> None:
...
class GetAcceleratorAttributeResult(dict):
    def __init__(__self__, *, flow_logs_enabled: _builtins.bool, flow_logs_s3_bucket: _builtins.str, flow_logs_s3_prefix: _builtins.str) -> None:
        ...
...
class GetAcceleratorIpSetResult(dict):
    def __init__(__self__, *, ip_addresses: Sequence[_builtins.str], ip_family: _builtins.str) -> None:
        ...
