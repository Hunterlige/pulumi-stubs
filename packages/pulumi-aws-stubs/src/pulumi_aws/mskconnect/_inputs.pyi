...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectorCapacityArgs', 'ConnectorCapacityArgsDict', 'ConnectorCapacityAutoscalingArgs', 'ConnectorCapacityAutoscalingArgsDict', 'ConnectorCapacityAutoscalingScaleInPolicyArgs', 'ConnectorCapacityAutoscalingScaleInPolicyArgsDict', 'ConnectorCapacityAutoscalingScaleOutPolicyArgs', 'ConnectorCapacityAutoscalingScaleOutPolicyArgsDict', 'ConnectorCapacityProvisionedCapacityArgs', 'ConnectorCapacityProvisionedCapacityArgsDict', 'ConnectorKafkaClusterArgs', 'ConnectorKafkaClusterArgsDict', 'ConnectorKafkaClusterApacheKafkaClusterArgs', 'ConnectorKafkaClusterApacheKafkaClusterArgsDict', 'ConnectorKafkaClusterApacheKafkaClusterVpcArgs', 'ConnectorKafkaClusterApacheKafkaClusterVpcArgsDict', 'ConnectorKafkaClusterClientAuthenticationArgs', 'ConnectorKafkaClusterClientAuthenticationArgsDict', 'ConnectorKafkaClusterEncryptionInTransitArgs', 'ConnectorKafkaClusterEncryptionInTransitArgsDict', 'ConnectorLogDeliveryArgs', 'ConnectorLogDeliveryArgsDict', 'ConnectorLogDeliveryWorkerLogDeliveryArgs', 'ConnectorLogDeliveryWorkerLogDeliveryArgsDict', ..., ..., 'ConnectorLogDeliveryWorkerLogDeliveryFirehoseArgs', ..., 'ConnectorLogDeliveryWorkerLogDeliveryS3Args', 'ConnectorLogDeliveryWorkerLogDeliveryS3ArgsDict', 'ConnectorPluginArgs', 'ConnectorPluginArgsDict', 'ConnectorPluginCustomPluginArgs', 'ConnectorPluginCustomPluginArgsDict', 'ConnectorWorkerConfigurationArgs', 'ConnectorWorkerConfigurationArgsDict', 'CustomPluginLocationArgs', 'CustomPluginLocationArgsDict', 'CustomPluginLocationS3Args', 'CustomPluginLocationS3ArgsDict']
...
class ConnectorCapacityArgs:
    def __init__(__self__, *, autoscaling: Optional[pulumi.Input[ConnectorCapacityAutoscalingArgs]] = ..., provisioned_capacity: Optional[pulumi.Input[ConnectorCapacityProvisionedCapacityArgs]] = ...) -> None:
    ...
    @autoscaling.setter
    def autoscaling(self, value: Optional[pulumi.Input[ConnectorCapacityAutoscalingArgs]]): # -> None:
        ...
    ...
    def provisioned_capacity(self, value: Optional[pulumi.Input[ConnectorCapacityProvisionedCapacityArgs]]): # -> None:
        ...
...
class ConnectorCapacityAutoscalingArgs:
    def __init__(__self__, *, max_worker_count: pulumi.Input[_builtins.int], min_worker_count: pulumi.Input[_builtins.int], mcu_count: Optional[pulumi.Input[_builtins.int]] = ..., scale_in_policy: Optional[pulumi.Input[ConnectorCapacityAutoscalingScaleInPolicyArgs]] = ..., scale_out_policy: Optional[pulumi.Input[ConnectorCapacityAutoscalingScaleOutPolicyArgs]] = ...) -> None:
    ...
    def max_worker_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def min_worker_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @mcu_count.setter
    def mcu_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def scale_in_policy(self, value: Optional[pulumi.Input[ConnectorCapacityAutoscalingScaleInPolicyArgs]]): # -> None:
        ...
    ...
    def scale_out_policy(self, value: Optional[pulumi.Input[ConnectorCapacityAutoscalingScaleOutPolicyArgs]]): # -> None:
        ...
...
class ConnectorCapacityAutoscalingScaleInPolicyArgs:
    def __init__(__self__, *, cpu_utilization_percentage: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def cpu_utilization_percentage(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ConnectorCapacityProvisionedCapacityArgs:
    def __init__(__self__, *, worker_count: pulumi.Input[_builtins.int], mcu_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ConnectorKafkaClusterArgs:
    def __init__(__self__, *, apache_kafka_cluster: pulumi.Input[ConnectorKafkaClusterApacheKafkaClusterArgs]) -> None:
    ...
    def apache_kafka_cluster(self, value: pulumi.Input[ConnectorKafkaClusterApacheKafkaClusterArgs]): # -> None:
        ...
...
class ConnectorKafkaClusterApacheKafkaClusterArgs:
    def __init__(__self__, *, bootstrap_servers: pulumi.Input[_builtins.str], vpc: pulumi.Input[ConnectorKafkaClusterApacheKafkaClusterVpcArgs]) -> None:
    ...
    def bootstrap_servers(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @vpc.setter
    def vpc(self, value: pulumi.Input[ConnectorKafkaClusterApacheKafkaClusterVpcArgs]): # -> None:
        ...
...
class ConnectorKafkaClusterClientAuthenticationArgs:
    def __init__(__self__, *, authentication_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ConnectorKafkaClusterEncryptionInTransitArgs:
    def __init__(__self__, *, encryption_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ConnectorLogDeliveryArgs:
    def __init__(__self__, *, worker_log_delivery: pulumi.Input[ConnectorLogDeliveryWorkerLogDeliveryArgs]) -> None:
    ...
    def worker_log_delivery(self, value: pulumi.Input[ConnectorLogDeliveryWorkerLogDeliveryArgs]): # -> None:
        ...
...
class ConnectorLogDeliveryWorkerLogDeliveryArgs:
    def __init__(__self__, *, cloudwatch_logs: Optional[pulumi.Input[ConnectorLogDeliveryWorkerLogDeliveryCloudwatchLogsArgs]] = ..., firehose: Optional[pulumi.Input[ConnectorLogDeliveryWorkerLogDeliveryFirehoseArgs]] = ..., s3: Optional[pulumi.Input[ConnectorLogDeliveryWorkerLogDeliveryS3Args]] = ...) -> None:
    ...
    def cloudwatch_logs(self, value: Optional[pulumi.Input[ConnectorLogDeliveryWorkerLogDeliveryCloudwatchLogsArgs]]): # -> None:
        ...
    ...
    @firehose.setter
    def firehose(self, value: Optional[pulumi.Input[ConnectorLogDeliveryWorkerLogDeliveryFirehoseArgs]]): # -> None:
        ...
    ...
    @s3.setter
    def s3(self, value: Optional[pulumi.Input[ConnectorLogDeliveryWorkerLogDeliveryS3Args]]): # -> None:
        ...
...
class ConnectorPluginArgs:
    def __init__(__self__, *, custom_plugin: pulumi.Input[ConnectorPluginCustomPluginArgs]) -> None:
    ...
    def custom_plugin(self, value: pulumi.Input[ConnectorPluginCustomPluginArgs]): # -> None:
        ...
...
class CustomPluginLocationArgs:
    ...
    @s3.setter
    def s3(self, value: pulumi.Input[CustomPluginLocationS3Args]): # -> None:
        ...
