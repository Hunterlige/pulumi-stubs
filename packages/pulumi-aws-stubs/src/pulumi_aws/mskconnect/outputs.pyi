...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectorCapacity', 'ConnectorCapacityAutoscaling', 'ConnectorCapacityAutoscalingScaleInPolicy', 'ConnectorCapacityAutoscalingScaleOutPolicy', 'ConnectorCapacityProvisionedCapacity', 'ConnectorKafkaCluster', 'ConnectorKafkaClusterApacheKafkaCluster', 'ConnectorKafkaClusterApacheKafkaClusterVpc', 'ConnectorKafkaClusterClientAuthentication', 'ConnectorKafkaClusterEncryptionInTransit', 'ConnectorLogDelivery', 'ConnectorLogDeliveryWorkerLogDelivery', ..., 'ConnectorLogDeliveryWorkerLogDeliveryFirehose', 'ConnectorLogDeliveryWorkerLogDeliveryS3', 'ConnectorPlugin', 'ConnectorPluginCustomPlugin', 'ConnectorWorkerConfiguration', 'CustomPluginLocation', 'CustomPluginLocationS3']
@pulumi.output_type
class ConnectorCapacity(dict):
    ...
    def __init__(__self__, *, autoscaling: Optional[outputs.ConnectorCapacityAutoscaling] = ..., provisioned_capacity: Optional[outputs.ConnectorCapacityProvisionedCapacity] = ...) -> None:
...
class ConnectorCapacityAutoscaling(dict):
    ...
    def __init__(__self__, *, max_worker_count: _builtins.int, min_worker_count: _builtins.int, mcu_count: Optional[_builtins.int] = ..., scale_in_policy: Optional[outputs.ConnectorCapacityAutoscalingScaleInPolicy] = ..., scale_out_policy: Optional[outputs.ConnectorCapacityAutoscalingScaleOutPolicy] = ...) -> None:
...
class ConnectorCapacityAutoscalingScaleInPolicy(dict):
    ...
    def __init__(__self__, *, cpu_utilization_percentage: Optional[_builtins.int] = ...) -> None:
...
class ConnectorCapacityProvisionedCapacity(dict):
    ...
    def __init__(__self__, *, worker_count: _builtins.int, mcu_count: Optional[_builtins.int] = ...) -> None:
...
class ConnectorKafkaCluster(dict):
    ...
    def __init__(__self__, *, apache_kafka_cluster: outputs.ConnectorKafkaClusterApacheKafkaCluster) -> None:
...
class ConnectorKafkaClusterApacheKafkaCluster(dict):
    ...
    def __init__(__self__, *, bootstrap_servers: _builtins.str, vpc: outputs.ConnectorKafkaClusterApacheKafkaClusterVpc) -> None:
...
class ConnectorKafkaClusterClientAuthentication(dict):
    ...
    def __init__(__self__, *, authentication_type: Optional[_builtins.str] = ...) -> None:
...
class ConnectorKafkaClusterEncryptionInTransit(dict):
    ...
    def __init__(__self__, *, encryption_type: Optional[_builtins.str] = ...) -> None:
...
class ConnectorLogDelivery(dict):
    ...
    def __init__(__self__, *, worker_log_delivery: outputs.ConnectorLogDeliveryWorkerLogDelivery) -> None:
...
class ConnectorLogDeliveryWorkerLogDelivery(dict):
    ...
    def __init__(__self__, *, cloudwatch_logs: Optional[outputs.ConnectorLogDeliveryWorkerLogDeliveryCloudwatchLogs] = ..., firehose: Optional[outputs.ConnectorLogDeliveryWorkerLogDeliveryFirehose] = ..., s3: Optional[outputs.ConnectorLogDeliveryWorkerLogDeliveryS3] = ...) -> None:
...
class ConnectorPlugin(dict):
    ...
    def __init__(__self__, *, custom_plugin: outputs.ConnectorPluginCustomPlugin) -> None:
