...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['LifecyclePolicyPolicyDetails', 'LifecyclePolicyPolicyDetailsAction', 'LifecyclePolicyPolicyDetailsActionCrossRegionCopy', ..., ..., 'LifecyclePolicyPolicyDetailsEventSource', 'LifecyclePolicyPolicyDetailsEventSourceParameters', 'LifecyclePolicyPolicyDetailsExclusions', 'LifecyclePolicyPolicyDetailsParameters', 'LifecyclePolicyPolicyDetailsSchedule', 'LifecyclePolicyPolicyDetailsScheduleArchiveRule', ..., ..., 'LifecyclePolicyPolicyDetailsScheduleCreateRule', ..., ..., ..., ..., 'LifecyclePolicyPolicyDetailsScheduleDeprecateRule', ..., 'LifecyclePolicyPolicyDetailsScheduleRetainRule', 'LifecyclePolicyPolicyDetailsScheduleShareRule']
@pulumi.output_type
class LifecyclePolicyPolicyDetails(dict):
    ...
    def __init__(__self__, *, action: Optional[outputs.LifecyclePolicyPolicyDetailsAction] = ..., copy_tags: Optional[_builtins.bool] = ..., create_interval: Optional[_builtins.int] = ..., event_source: Optional[outputs.LifecyclePolicyPolicyDetailsEventSource] = ..., exclusions: Optional[outputs.LifecyclePolicyPolicyDetailsExclusions] = ..., extend_deletion: Optional[_builtins.bool] = ..., parameters: Optional[outputs.LifecyclePolicyPolicyDetailsParameters] = ..., policy_language: Optional[_builtins.str] = ..., policy_type: Optional[_builtins.str] = ..., resource_locations: Optional[_builtins.str] = ..., resource_type: Optional[_builtins.str] = ..., resource_types: Optional[Sequence[_builtins.str]] = ..., retain_interval: Optional[_builtins.int] = ..., schedules: Optional[Sequence[outputs.LifecyclePolicyPolicyDetailsSchedule]] = ..., target_tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class LifecyclePolicyPolicyDetailsAction(dict):
    ...
    def __init__(__self__, *, cross_region_copies: Sequence[outputs.LifecyclePolicyPolicyDetailsActionCrossRegionCopy], name: _builtins.str) -> None:
...
class LifecyclePolicyPolicyDetailsActionCrossRegionCopy(dict):
    ...
    def __init__(__self__, *, encryption_configuration: outputs.LifecyclePolicyPolicyDetailsActionCrossRegionCopyEncryptionConfiguration, target: _builtins.str, retain_rule: Optional[outputs.LifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule] = ...) -> None:
...
class LifecyclePolicyPolicyDetailsActionCrossRegionCopyEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *, cmk_arn: Optional[_builtins.str] = ..., encrypted: Optional[_builtins.bool] = ...) -> None:
        ...
...
class LifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRule(dict):
    ...
    def __init__(__self__, *, interval: _builtins.int, interval_unit: _builtins.str) -> None:
        ...
...
class LifecyclePolicyPolicyDetailsEventSource(dict):
    def __init__(__self__, *, parameters: outputs.LifecyclePolicyPolicyDetailsEventSourceParameters, type: _builtins.str) -> None:
...
class LifecyclePolicyPolicyDetailsEventSourceParameters(dict):
    ...
    def __init__(__self__, *, description_regex: _builtins.str, event_type: _builtins.str, snapshot_owners: Sequence[_builtins.str]) -> None:
...
class LifecyclePolicyPolicyDetailsExclusions(dict):
    ...
    def __init__(__self__, *, exclude_boot_volumes: Optional[_builtins.bool] = ..., exclude_tags: Optional[Mapping[str, _builtins.str]] = ..., exclude_volume_types: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class LifecyclePolicyPolicyDetailsParameters(dict):
    ...
    def __init__(__self__, *, exclude_boot_volume: Optional[_builtins.bool] = ..., no_reboot: Optional[_builtins.bool] = ...) -> None:
...
class LifecyclePolicyPolicyDetailsSchedule(dict):
    ...
    def __init__(__self__, *, create_rule: outputs.LifecyclePolicyPolicyDetailsScheduleCreateRule, name: _builtins.str, retain_rule: outputs.LifecyclePolicyPolicyDetailsScheduleRetainRule, archive_rule: Optional[outputs.LifecyclePolicyPolicyDetailsScheduleArchiveRule] = ..., copy_tags: Optional[_builtins.bool] = ..., cross_region_copy_rules: Optional[Sequence[outputs.LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRule]] = ..., deprecate_rule: Optional[outputs.LifecyclePolicyPolicyDetailsScheduleDeprecateRule] = ..., fast_restore_rule: Optional[outputs.LifecyclePolicyPolicyDetailsScheduleFastRestoreRule] = ..., share_rule: Optional[outputs.LifecyclePolicyPolicyDetailsScheduleShareRule] = ..., tags_to_add: Optional[Mapping[str, _builtins.str]] = ..., variable_tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class LifecyclePolicyPolicyDetailsScheduleArchiveRule(dict):
    ...
    def __init__(__self__, *, archive_retain_rule: outputs.LifecyclePolicyPolicyDetailsScheduleArchiveRuleArchiveRetainRule) -> None:
...
class LifecyclePolicyPolicyDetailsScheduleArchiveRuleArchiveRetainRule(dict):
    ...
    def __init__(__self__, *, retention_archive_tier: outputs.LifecyclePolicyPolicyDetailsScheduleArchiveRuleArchiveRetainRuleRetentionArchiveTier) -> None:
...
class LifecyclePolicyPolicyDetailsScheduleArchiveRuleArchiveRetainRuleRetentionArchiveTier(dict):
    ...
    def __init__(__self__, *, count: Optional[_builtins.int] = ..., interval: Optional[_builtins.int] = ..., interval_unit: Optional[_builtins.str] = ...) -> None:
        ...
...
class LifecyclePolicyPolicyDetailsScheduleCreateRule(dict):
    ...
    def __init__(__self__, *, cron_expression: Optional[_builtins.str] = ..., interval: Optional[_builtins.int] = ..., interval_unit: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., scripts: Optional[outputs.LifecyclePolicyPolicyDetailsScheduleCreateRuleScripts] = ..., times: Optional[_builtins.str] = ...) -> None:
...
class LifecyclePolicyPolicyDetailsScheduleCreateRuleScripts(dict):
    ...
    def __init__(__self__, *, execution_handler: _builtins.str, execute_operation_on_script_failure: Optional[_builtins.bool] = ..., execution_handler_service: Optional[_builtins.str] = ..., execution_timeout: Optional[_builtins.int] = ..., maximum_retry_count: Optional[_builtins.int] = ..., stages: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRule(dict):
    ...
    def __init__(__self__, *, encrypted: _builtins.bool, cmk_arn: Optional[_builtins.str] = ..., copy_tags: Optional[_builtins.bool] = ..., deprecate_rule: Optional[outputs.LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleDeprecateRule] = ..., retain_rule: Optional[outputs.LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleRetainRule] = ..., target: Optional[_builtins.str] = ..., target_region: Optional[_builtins.str] = ...) -> None:
...
class LifecyclePolicyPolicyDetailsScheduleFastRestoreRule(dict):
    ...
    def __init__(__self__, *, availability_zones: Sequence[_builtins.str], count: Optional[_builtins.int] = ..., interval: Optional[_builtins.int] = ..., interval_unit: Optional[_builtins.str] = ...) -> None:
...
class LifecyclePolicyPolicyDetailsScheduleShareRule(dict):
    ...
    def __init__(__self__, *, target_accounts: Sequence[_builtins.str], unshare_interval: Optional[_builtins.int] = ..., unshare_interval_unit: Optional[_builtins.str] = ...) -> None:
