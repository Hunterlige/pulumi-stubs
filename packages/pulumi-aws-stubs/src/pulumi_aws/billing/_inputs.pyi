...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ViewDataFilterExpressionArgs', 'ViewDataFilterExpressionArgsDict', 'ViewDataFilterExpressionDimensionsArgs', 'ViewDataFilterExpressionDimensionsArgsDict', 'ViewDataFilterExpressionTagArgs', 'ViewDataFilterExpressionTagArgsDict', 'ViewDataFilterExpressionTimeRangeArgs', 'ViewDataFilterExpressionTimeRangeArgsDict', 'ViewTimeoutsArgs', 'ViewTimeoutsArgsDict']
...
class ViewDataFilterExpressionArgs:
    def __init__(__self__, *, dimensions: Optional[pulumi.Input[ViewDataFilterExpressionDimensionsArgs]] = ..., tags: Optional[pulumi.Input[Sequence[pulumi.Input[ViewDataFilterExpressionTagArgs]]]] = ..., time_range: Optional[pulumi.Input[ViewDataFilterExpressionTimeRangeArgs]] = ...) -> None:
    ...
    @dimensions.setter
    def dimensions(self, value: Optional[pulumi.Input[ViewDataFilterExpressionDimensionsArgs]]): # -> None:
        ...
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ViewDataFilterExpressionTagArgs]]]]): # -> None:
        ...
    ...
    @time_range.setter
    def time_range(self, value: Optional[pulumi.Input[ViewDataFilterExpressionTimeRangeArgs]]): # -> None:
        ...
...
class ViewDataFilterExpressionTimeRangeArgs:
    def __init__(__self__, *, begin_date_inclusive: pulumi.Input[_builtins.str], end_date_inclusive: pulumi.Input[_builtins.str]) -> None:
    ...
    def begin_date_inclusive(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def end_date_inclusive(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
