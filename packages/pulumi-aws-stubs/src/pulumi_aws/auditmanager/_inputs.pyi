...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AssessmentAssessmentReportsDestinationArgs', 'AssessmentAssessmentReportsDestinationArgsDict', 'AssessmentRoleArgs', 'AssessmentRoleArgsDict', 'AssessmentRolesAllArgs', 'AssessmentRolesAllArgsDict', 'AssessmentScopeArgs', 'AssessmentScopeArgsDict', 'AssessmentScopeAwsAccountArgs', 'AssessmentScopeAwsAccountArgsDict', 'AssessmentScopeAwsServiceArgs', 'AssessmentScopeAwsServiceArgsDict', 'ControlControlMappingSourceArgs', 'ControlControlMappingSourceArgsDict', 'ControlControlMappingSourceSourceKeywordArgs', 'ControlControlMappingSourceSourceKeywordArgsDict', 'FrameworkControlSetArgs', 'FrameworkControlSetArgsDict', 'FrameworkControlSetControlArgs', 'FrameworkControlSetControlArgsDict']
...
class AssessmentAssessmentReportsDestinationArgs:
    def __init__(__self__, *, destination: pulumi.Input[_builtins.str], destination_type: pulumi.Input[_builtins.str]) -> None:
...
class AssessmentRoleArgs:
    def __init__(__self__, *, role_arn: pulumi.Input[_builtins.str], role_type: pulumi.Input[_builtins.str]) -> None:
...
class AssessmentScopeArgs:
    def __init__(__self__, *, aws_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[AssessmentScopeAwsAccountArgs]]]] = ..., aws_services: Optional[pulumi.Input[Sequence[pulumi.Input[AssessmentScopeAwsServiceArgs]]]] = ...) -> None:
    ...
    @aws_accounts.setter
    def aws_accounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AssessmentScopeAwsAccountArgs]]]]): # -> None:
        ...
    ...
    @aws_services.setter
    def aws_services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AssessmentScopeAwsServiceArgs]]]]): # -> None:
        ...
...
class ControlControlMappingSourceArgs:
    def __init__(__self__, *, source_name: pulumi.Input[_builtins.str], source_set_up_option: pulumi.Input[_builtins.str], source_type: pulumi.Input[_builtins.str], source_description: Optional[pulumi.Input[_builtins.str]] = ..., source_frequency: Optional[pulumi.Input[_builtins.str]] = ..., source_id: Optional[pulumi.Input[_builtins.str]] = ..., source_keyword: Optional[pulumi.Input[ControlControlMappingSourceSourceKeywordArgs]] = ..., troubleshooting_text: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def source_set_up_option(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def source_description(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def source_frequency(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def source_keyword(self, value: Optional[pulumi.Input[ControlControlMappingSourceSourceKeywordArgs]]): # -> None:
        ...
    ...
    def troubleshooting_text(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ControlControlMappingSourceSourceKeywordArgs:
    def __init__(__self__, *, keyword_input_type: pulumi.Input[_builtins.str], keyword_value: pulumi.Input[_builtins.str]) -> None:
    ...
    def keyword_input_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def keyword_value(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class FrameworkControlSetArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], controls: Optional[pulumi.Input[Sequence[pulumi.Input[FrameworkControlSetControlArgs]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @controls.setter
    def controls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FrameworkControlSetControlArgs]]]]): # -> None:
        ...
