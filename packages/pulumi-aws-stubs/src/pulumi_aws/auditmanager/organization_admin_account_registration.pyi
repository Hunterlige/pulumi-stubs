...
class _OrganizationAdminAccountRegistrationState:
    def __init__(__self__, *, admin_account_id: Optional[pulumi.Input[_builtins.str]] = ..., organization_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class OrganizationAdminAccountRegistration(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: OrganizationAdminAccountRegistrationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., admin_account_id: Optional[pulumi.Input[_builtins.str]] = ..., organization_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> OrganizationAdminAccountRegistration:
