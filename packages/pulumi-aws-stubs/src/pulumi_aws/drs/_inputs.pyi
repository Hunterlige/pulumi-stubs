...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ReplicationConfigurationTemplatePitPolicyArgs', 'ReplicationConfigurationTemplatePitPolicyArgsDict', 'ReplicationConfigurationTemplateTimeoutsArgs', 'ReplicationConfigurationTemplateTimeoutsArgsDict']
...
class ReplicationConfigurationTemplatePitPolicyArgs:
    def __init__(__self__, *, interval: pulumi.Input[_builtins.int], retention_duration: pulumi.Input[_builtins.int], units: pulumi.Input[_builtins.str], enabled: Optional[pulumi.Input[_builtins.bool]] = ..., rule_id: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def retention_duration(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @units.setter
    def units(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @rule_id.setter
    def rule_id(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
