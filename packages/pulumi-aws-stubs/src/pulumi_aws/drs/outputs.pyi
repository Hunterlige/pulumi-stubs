...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ReplicationConfigurationTemplatePitPolicy', 'ReplicationConfigurationTemplateTimeouts']
@pulumi.output_type
class ReplicationConfigurationTemplatePitPolicy(dict):
    ...
    def __init__(__self__, *, interval: _builtins.int, retention_duration: _builtins.int, units: _builtins.str, enabled: Optional[_builtins.bool] = ..., rule_id: Optional[_builtins.int] = ...) -> None:
