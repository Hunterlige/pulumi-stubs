...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['LifecyclePolicyActionArgs', 'LifecyclePolicyActionArgsDict', 'LifecyclePolicyDocumentArgs', 'LifecyclePolicyDocumentArgsDict', 'LifecyclePolicyRuleArgs', 'LifecyclePolicyRuleArgsDict', 'LifecyclePolicySelectionArgs', 'LifecyclePolicySelectionArgsDict', 'PolicyDocumentArgs', 'PolicyDocumentArgsDict', 'RegistryScanningConfigurationRuleArgs', 'RegistryScanningConfigurationRuleArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'RepositoryEncryptionConfigurationArgs', 'RepositoryEncryptionConfigurationArgsDict', 'RepositoryImageScanningConfigurationArgs', 'RepositoryImageScanningConfigurationArgsDict', 'RepositoryImageTagMutabilityExclusionFilterArgs', ..., 'GetLifecyclePolicyDocumentRuleArgs', 'GetLifecyclePolicyDocumentRuleArgsDict', 'GetLifecyclePolicyDocumentRuleActionArgs', 'GetLifecyclePolicyDocumentRuleActionArgsDict', 'GetLifecyclePolicyDocumentRuleSelectionArgs', 'GetLifecyclePolicyDocumentRuleSelectionArgsDict']
...
class LifecyclePolicyActionArgs:
    def __init__(__self__, *, type: pulumi.Input[LifecyclePolicyActionType]) -> None:
    ...
    @type.setter
    def type(self, value: pulumi.Input[LifecyclePolicyActionType]): # -> None:
        ...
...
class LifecyclePolicyDocumentArgs:
    def __init__(__self__, *, rules: pulumi.Input[Sequence[pulumi.Input[LifecyclePolicyRuleArgs]]]) -> None:
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Sequence[pulumi.Input[LifecyclePolicyRuleArgs]]]): # -> None:
        ...
...
class LifecyclePolicyRuleArgs:
    def __init__(__self__, *, action: pulumi.Input[LifecyclePolicyActionArgs], rule_priority: pulumi.Input[_builtins.int], selection: pulumi.Input[LifecyclePolicySelectionArgs], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @action.setter
    def action(self, value: pulumi.Input[LifecyclePolicyActionArgs]): # -> None:
        ...
    ...
    @selection.setter
    def selection(self, value: pulumi.Input[LifecyclePolicySelectionArgs]): # -> None:
        ...
...
class LifecyclePolicySelectionArgs:
    def __init__(__self__, *, count_number: pulumi.Input[_builtins.int], count_type: pulumi.Input[LifecyclePolicyCountType], tag_status: pulumi.Input[LifecyclePolicyTagStatus], count_unit: Optional[pulumi.Input[_builtins.str]] = ..., tag_prefix_list: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @count_number.setter
    def count_number(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @count_type.setter
    def count_type(self, value: pulumi.Input[LifecyclePolicyCountType]): # -> None:
        ...
    ...
    @tag_status.setter
    def tag_status(self, value: pulumi.Input[LifecyclePolicyTagStatus]): # -> None:
        ...
    ...
    @count_unit.setter
    def count_unit(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def tag_prefix_list(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RegistryScanningConfigurationRuleArgs:
    def __init__(__self__, *, repository_filters: pulumi.Input[Sequence[pulumi.Input[RegistryScanningConfigurationRuleRepositoryFilterArgs]]], scan_frequency: pulumi.Input[_builtins.str]) -> None:
    ...
    def repository_filters(self, value: pulumi.Input[Sequence[pulumi.Input[RegistryScanningConfigurationRuleRepositoryFilterArgs]]]): # -> None:
        ...
    ...
    def scan_frequency(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RegistryScanningConfigurationRuleRepositoryFilterArgs:
    def __init__(__self__, *, filter: pulumi.Input[_builtins.str], filter_type: pulumi.Input[_builtins.str]) -> None:
        ...
...
class ReplicationConfigurationReplicationConfigurationArgs:
    def __init__(__self__, *, rules: pulumi.Input[Sequence[pulumi.Input[ReplicationConfigurationReplicationConfigurationRuleArgs]]]) -> None:
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Sequence[pulumi.Input[ReplicationConfigurationReplicationConfigurationRuleArgs]]]): # -> None:
        ...
...
class ReplicationConfigurationReplicationConfigurationRuleArgs:
    def __init__(__self__, *, destinations: pulumi.Input[Sequence[pulumi.Input[ReplicationConfigurationReplicationConfigurationRuleDestinationArgs]]], repository_filters: Optional[pulumi.Input[Sequence[pulumi.Input[ReplicationConfigurationReplicationConfigurationRuleRepositoryFilterArgs]]]] = ...) -> None:
    ...
    @destinations.setter
    def destinations(self, value: pulumi.Input[Sequence[pulumi.Input[ReplicationConfigurationReplicationConfigurationRuleDestinationArgs]]]): # -> None:
        ...
    ...
    @repository_filters.setter
    def repository_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ReplicationConfigurationReplicationConfigurationRuleRepositoryFilterArgs]]]]): # -> None:
        ...
...
class ReplicationConfigurationReplicationConfigurationRuleDestinationArgs:
    def __init__(__self__, *, region: pulumi.Input[_builtins.str], registry_id: pulumi.Input[_builtins.str]) -> None:
...
class RepositoryCreationTemplateEncryptionConfigurationArgs:
    def __init__(__self__, *, encryption_type: Optional[pulumi.Input[_builtins.str]] = ..., kms_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RepositoryImageScanningConfigurationArgs:
    ...
    @scan_on_push.setter
    def scan_on_push(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class GetLifecyclePolicyDocumentRuleArgs:
    def __init__(__self__, *, priority: _builtins.int, selection: GetLifecyclePolicyDocumentRuleSelectionArgs, action: Optional[GetLifecyclePolicyDocumentRuleActionArgs] = ..., description: Optional[_builtins.str] = ...) -> None:
    ...
    @priority.setter
    def priority(self, value: _builtins.int): # -> None:
        ...
    ...
    @selection.setter
    def selection(self, value: GetLifecyclePolicyDocumentRuleSelectionArgs): # -> None:
        ...
    ...
    @action.setter
    def action(self, value: Optional[GetLifecyclePolicyDocumentRuleActionArgs]): # -> None:
        ...
...
class GetLifecyclePolicyDocumentRuleActionArgs:
    def __init__(__self__, *, type: _builtins.str, target_storage_class: Optional[_builtins.str] = ...) -> None:
    ...
    def target_storage_class(self, value: Optional[_builtins.str]): # -> None:
        ...
...
class GetLifecyclePolicyDocumentRuleSelectionArgs:
    def __init__(__self__, *, count_number: _builtins.int, count_type: _builtins.str, tag_status: _builtins.str, count_unit: Optional[_builtins.str] = ..., storage_class: Optional[_builtins.str] = ..., tag_pattern_lists: Optional[Sequence[_builtins.str]] = ..., tag_prefix_lists: Optional[Sequence[_builtins.str]] = ...) -> None:
    ...
    @count_number.setter
    def count_number(self, value: _builtins.int): # -> None:
        ...
    ...
    @count_type.setter
    def count_type(self, value: _builtins.str): # -> None:
        ...
    ...
    @tag_status.setter
    def tag_status(self, value: _builtins.str): # -> None:
        ...
    ...
    @count_unit.setter
    def count_unit(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def storage_class(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def tag_pattern_lists(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    def tag_prefix_lists(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
