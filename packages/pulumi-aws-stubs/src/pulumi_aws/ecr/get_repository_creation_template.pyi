...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetRepositoryCreationTemplateResult', 'AwaitableGetRepositoryCreationTemplateResult', 'get_repository_creation_template', 'get_repository_creation_template_output']
@pulumi.output_type
class GetRepositoryCreationTemplateResult:
    
    def __init__(__self__, applied_fors=..., custom_role_arn=..., description=..., encryption_configurations=..., id=..., image_tag_mutability=..., image_tag_mutability_exclusion_filters=..., lifecycle_policy=..., prefix=..., region=..., registry_id=..., repository_policy=..., resource_tags=...) -> None:
        ...
...
class AwaitableGetRepositoryCreationTemplateResult(GetRepositoryCreationTemplateResult):
    def __await__(self): # -> Generator[Never, Any, GetRepositoryCreationTemplateResult]:
        ...
    


def get_repository_creation_template(prefix: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., resource_tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetRepositoryCreationTemplateResult:
    
    ...

def get_repository_creation_template_output(prefix: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., resource_tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetRepositoryCreationTemplateResult]:
