...
class RepositoryPolicyArgs:
    def __init__(__self__, *, policy: pulumi.Input[Union[_builtins.str, PolicyDocumentArgs]], repository: pulumi.Input[_builtins.str], region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class _RepositoryPolicyState:
    def __init__(__self__, *, policy: Optional[pulumi.Input[Union[_builtins.str, PolicyDocumentArgs]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., registry_id: Optional[pulumi.Input[_builtins.str]] = ..., repository: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RepositoryPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., policy: Optional[pulumi.Input[Union[_builtins.str, Union[PolicyDocumentArgs, PolicyDocumentArgsDict]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., repository: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., policy: Optional[pulumi.Input[Union[_builtins.str, Union[PolicyDocumentArgs, PolicyDocumentArgsDict]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., registry_id: Optional[pulumi.Input[_builtins.str]] = ..., repository: Optional[pulumi.Input[_builtins.str]] = ...) -> RepositoryPolicy:
