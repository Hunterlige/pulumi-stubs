...
class GetRepositoryResult:
    ...
    def __init__(__self__, arn=..., encryption_configurations=..., id=..., image_scanning_configurations=..., image_tag_mutability=..., image_tag_mutability_exclusion_filters=..., most_recent_image_tags=..., name=..., region=..., registry_id=..., repository_url=..., tags=...) -> None:
        ...
...
def get_repository(name: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., registry_id: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetRepositoryResult:
    
    ...

def get_repository_output(name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., registry_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetRepositoryResult]:
