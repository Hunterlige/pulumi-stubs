...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['RegistryScanningConfigurationRule', 'RegistryScanningConfigurationRuleRepositoryFilter', 'ReplicationConfigurationReplicationConfiguration', ..., ..., ..., 'RepositoryCreationTemplateEncryptionConfiguration', ..., 'RepositoryEncryptionConfiguration', 'RepositoryImageScanningConfiguration', 'RepositoryImageTagMutabilityExclusionFilter', 'GetImagesImageIdResult', 'GetLifecyclePolicyDocumentRuleResult', 'GetLifecyclePolicyDocumentRuleActionResult', 'GetLifecyclePolicyDocumentRuleSelectionResult', ..., ..., 'GetRepositoryEncryptionConfigurationResult', 'GetRepositoryImageScanningConfigurationResult', ...]
@pulumi.output_type
class RegistryScanningConfigurationRule(dict):
    ...
    def __init__(__self__, *, repository_filters: Sequence[outputs.RegistryScanningConfigurationRuleRepositoryFilter], scan_frequency: _builtins.str) -> None:
...
class RegistryScanningConfigurationRuleRepositoryFilter(dict):
    ...
    def __init__(__self__, *, filter: _builtins.str, filter_type: _builtins.str) -> None:
        ...
...
class ReplicationConfigurationReplicationConfiguration(dict):
    def __init__(__self__, *, rules: Sequence[outputs.ReplicationConfigurationReplicationConfigurationRule]) -> None:
...
class ReplicationConfigurationReplicationConfigurationRule(dict):
    ...
    def __init__(__self__, *, destinations: Sequence[outputs.ReplicationConfigurationReplicationConfigurationRuleDestination], repository_filters: Optional[Sequence[outputs.ReplicationConfigurationReplicationConfigurationRuleRepositoryFilter]] = ...) -> None:
...
class ReplicationConfigurationReplicationConfigurationRuleDestination(dict):
    ...
    def __init__(__self__, *, region: _builtins.str, registry_id: _builtins.str) -> None:
...
class RepositoryCreationTemplateEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *, encryption_type: Optional[_builtins.str] = ..., kms_key: Optional[_builtins.str] = ...) -> None:
...
class GetImagesImageIdResult(dict):
    def __init__(__self__, *, image_digest: _builtins.str, image_tag: _builtins.str) -> None:
...
class GetLifecyclePolicyDocumentRuleResult(dict):
    def __init__(__self__, *, priority: _builtins.int, selection: outputs.GetLifecyclePolicyDocumentRuleSelectionResult, action: Optional[outputs.GetLifecyclePolicyDocumentRuleActionResult] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class GetRepositoryCreationTemplateEncryptionConfigurationResult(dict):
    def __init__(__self__, *, encryption_type: _builtins.str, kms_key: _builtins.str) -> None:
