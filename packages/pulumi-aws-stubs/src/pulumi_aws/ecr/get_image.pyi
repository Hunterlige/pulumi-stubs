...
class GetImageResult:
    ...
    def __init__(__self__, id=..., image_digest=..., image_pushed_at=..., image_size_in_bytes=..., image_tag=..., image_tags=..., image_uri=..., most_recent=..., region=..., registry_id=..., repository_name=...) -> None:
        ...
...
def get_image(image_digest: Optional[_builtins.str] = ..., image_tag: Optional[_builtins.str] = ..., most_recent: Optional[_builtins.bool] = ..., region: Optional[_builtins.str] = ..., registry_id: Optional[_builtins.str] = ..., repository_name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetImageResult:
    
    ...

def get_image_output(image_digest: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., image_tag: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., most_recent: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., registry_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., repository_name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetImageResult]:
