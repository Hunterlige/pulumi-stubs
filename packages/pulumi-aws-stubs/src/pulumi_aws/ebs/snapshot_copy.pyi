...
class SnapshotCopyArgs:
    def __init__(__self__, *, source_region: pulumi.Input[_builtins.str], source_snapshot_id: pulumi.Input[_builtins.str], completion_duration_minutes: Optional[pulumi.Input[_builtins.int]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., encrypted: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., permanent_restore: Optional[pulumi.Input[_builtins.bool]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., storage_tier: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., temporary_restore_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def source_region(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def source_snapshot_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def completion_duration_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class _SnapshotCopyState:
    def __init__(__self__, *, arn: Optional[pulumi.Input[_builtins.str]] = ..., completion_duration_minutes: Optional[pulumi.Input[_builtins.int]] = ..., data_encryption_key_id: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., encrypted: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., outpost_arn: Optional[pulumi.Input[_builtins.str]] = ..., owner_alias: Optional[pulumi.Input[_builtins.str]] = ..., owner_id: Optional[pulumi.Input[_builtins.str]] = ..., permanent_restore: Optional[pulumi.Input[_builtins.bool]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., source_region: Optional[pulumi.Input[_builtins.str]] = ..., source_snapshot_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_tier: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., temporary_restore_days: Optional[pulumi.Input[_builtins.int]] = ..., volume_id: Optional[pulumi.Input[_builtins.str]] = ..., volume_size: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class SnapshotCopy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., completion_duration_minutes: Optional[pulumi.Input[_builtins.int]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., encrypted: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., permanent_restore: Optional[pulumi.Input[_builtins.bool]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., source_region: Optional[pulumi.Input[_builtins.str]] = ..., source_snapshot_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_tier: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., temporary_restore_days: Optional[pulumi.Input[_builtins.int]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., arn: Optional[pulumi.Input[_builtins.str]] = ..., completion_duration_minutes: Optional[pulumi.Input[_builtins.int]] = ..., data_encryption_key_id: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., encrypted: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., outpost_arn: Optional[pulumi.Input[_builtins.str]] = ..., owner_alias: Optional[pulumi.Input[_builtins.str]] = ..., owner_id: Optional[pulumi.Input[_builtins.str]] = ..., permanent_restore: Optional[pulumi.Input[_builtins.bool]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., source_region: Optional[pulumi.Input[_builtins.str]] = ..., source_snapshot_id: Optional[pulumi.Input[_builtins.str]] = ..., storage_tier: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., temporary_restore_days: Optional[pulumi.Input[_builtins.int]] = ..., volume_id: Optional[pulumi.Input[_builtins.str]] = ..., volume_size: Optional[pulumi.Input[_builtins.int]] = ...) -> SnapshotCopy:
