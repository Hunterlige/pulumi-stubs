...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FleetComputeConfiguration', 'FleetScalingConfiguration', ..., 'FleetStatus', 'FleetVpcConfig', 'ProjectArtifacts', 'ProjectBuildBatchConfig', 'ProjectBuildBatchConfigRestrictions', 'ProjectCache', 'ProjectEnvironment', 'ProjectEnvironmentDockerServer', 'ProjectEnvironmentEnvironmentVariable', 'ProjectEnvironmentFleet', 'ProjectEnvironmentRegistryCredential', 'ProjectFileSystemLocation', 'ProjectLogsConfig', 'ProjectLogsConfigCloudwatchLogs', 'ProjectLogsConfigS3Logs', 'ProjectSecondaryArtifact', 'ProjectSecondarySource', 'ProjectSecondarySourceAuth', 'ProjectSecondarySourceBuildStatusConfig', 'ProjectSecondarySourceGitSubmodulesConfig', 'ProjectSecondarySourceVersion', 'ProjectSource', 'ProjectSourceAuth', 'ProjectSourceBuildStatusConfig', 'ProjectSourceGitSubmodulesConfig', 'ProjectVpcConfig', 'ReportGroupExportConfig', 'ReportGroupExportConfigS3Destination', 'WebhookFilterGroup', 'WebhookFilterGroupFilter', 'WebhookPullRequestBuildPolicy', 'WebhookScopeConfiguration', 'GetFleetComputeConfigurationResult', 'GetFleetScalingConfigurationResult', ..., 'GetFleetStatusResult', 'GetFleetVpcConfigResult']
@pulumi.output_type
class FleetComputeConfiguration(dict):
    ...
    def __init__(__self__, *, disk: Optional[_builtins.int] = ..., instance_type: Optional[_builtins.str] = ..., machine_type: Optional[_builtins.str] = ..., memory: Optional[_builtins.int] = ..., vcpu: Optional[_builtins.int] = ...) -> None:
...
class FleetScalingConfiguration(dict):
    ...
    def __init__(__self__, *, desired_capacity: Optional[_builtins.int] = ..., max_capacity: Optional[_builtins.int] = ..., scaling_type: Optional[_builtins.str] = ..., target_tracking_scaling_configs: Optional[Sequence[outputs.FleetScalingConfigurationTargetTrackingScalingConfig]] = ...) -> None:
...
class FleetScalingConfigurationTargetTrackingScalingConfig(dict):
    ...
    def __init__(__self__, *, metric_type: Optional[_builtins.str] = ..., target_value: Optional[_builtins.float] = ...) -> None:
...
class FleetStatus(dict):
    ...
    def __init__(__self__, *, context: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ..., status_code: Optional[_builtins.str] = ...) -> None:
...
class FleetVpcConfig(dict):
    ...
    def __init__(__self__, *, security_group_ids: Sequence[_builtins.str], subnets: Sequence[_builtins.str], vpc_id: _builtins.str) -> None:
...
class ProjectArtifacts(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, artifact_identifier: Optional[_builtins.str] = ..., bucket_owner_access: Optional[_builtins.str] = ..., encryption_disabled: Optional[_builtins.bool] = ..., location: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., namespace_type: Optional[_builtins.str] = ..., override_artifact_name: Optional[_builtins.bool] = ..., packaging: Optional[_builtins.str] = ..., path: Optional[_builtins.str] = ...) -> None:
...
class ProjectBuildBatchConfig(dict):
    ...
    def __init__(__self__, *, service_role: _builtins.str, combine_artifacts: Optional[_builtins.bool] = ..., restrictions: Optional[outputs.ProjectBuildBatchConfigRestrictions] = ..., timeout_in_mins: Optional[_builtins.int] = ...) -> None:
...
class ProjectBuildBatchConfigRestrictions(dict):
    ...
    def __init__(__self__, *, compute_types_alloweds: Optional[Sequence[_builtins.str]] = ..., maximum_builds_allowed: Optional[_builtins.int] = ...) -> None:
...
class ProjectCache(dict):
    ...
    def __init__(__self__, *, cache_namespace: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., modes: Optional[Sequence[_builtins.str]] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ProjectEnvironment(dict):
    ...
    def __init__(__self__, *, compute_type: _builtins.str, image: _builtins.str, type: _builtins.str, certificate: Optional[_builtins.str] = ..., docker_server: Optional[outputs.ProjectEnvironmentDockerServer] = ..., environment_variables: Optional[Sequence[outputs.ProjectEnvironmentEnvironmentVariable]] = ..., fleet: Optional[outputs.ProjectEnvironmentFleet] = ..., image_pull_credentials_type: Optional[_builtins.str] = ..., privileged_mode: Optional[_builtins.bool] = ..., registry_credential: Optional[outputs.ProjectEnvironmentRegistryCredential] = ...) -> None:
...
class ProjectEnvironmentDockerServer(dict):
    ...
    def __init__(__self__, *, compute_type: _builtins.str, security_group_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ProjectEnvironmentEnvironmentVariable(dict):
    def __init__(__self__, *, name: _builtins.str, value: _builtins.str, type: Optional[_builtins.str] = ...) -> None:
...
class ProjectEnvironmentRegistryCredential(dict):
    ...
    def __init__(__self__, *, credential: _builtins.str, credential_provider: _builtins.str) -> None:
...
class ProjectFileSystemLocation(dict):
    ...
    def __init__(__self__, *, identifier: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., mount_options: Optional[_builtins.str] = ..., mount_point: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ProjectLogsConfig(dict):
    ...
    def __init__(__self__, *, cloudwatch_logs: Optional[outputs.ProjectLogsConfigCloudwatchLogs] = ..., s3_logs: Optional[outputs.ProjectLogsConfigS3Logs] = ...) -> None:
...
class ProjectLogsConfigCloudwatchLogs(dict):
    ...
    def __init__(__self__, *, group_name: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., stream_name: Optional[_builtins.str] = ...) -> None:
...
class ProjectLogsConfigS3Logs(dict):
    ...
    def __init__(__self__, *, bucket_owner_access: Optional[_builtins.str] = ..., encryption_disabled: Optional[_builtins.bool] = ..., location: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class ProjectSecondaryArtifact(dict):
    ...
    def __init__(__self__, *, artifact_identifier: _builtins.str, type: _builtins.str, bucket_owner_access: Optional[_builtins.str] = ..., encryption_disabled: Optional[_builtins.bool] = ..., location: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., namespace_type: Optional[_builtins.str] = ..., override_artifact_name: Optional[_builtins.bool] = ..., packaging: Optional[_builtins.str] = ..., path: Optional[_builtins.str] = ...) -> None:
...
class ProjectSecondarySource(dict):
    ...
    def __init__(__self__, *, source_identifier: _builtins.str, type: _builtins.str, auth: Optional[outputs.ProjectSecondarySourceAuth] = ..., build_status_config: Optional[outputs.ProjectSecondarySourceBuildStatusConfig] = ..., buildspec: Optional[_builtins.str] = ..., git_clone_depth: Optional[_builtins.int] = ..., git_submodules_config: Optional[outputs.ProjectSecondarySourceGitSubmodulesConfig] = ..., insecure_ssl: Optional[_builtins.bool] = ..., location: Optional[_builtins.str] = ..., report_build_status: Optional[_builtins.bool] = ...) -> None:
...
class ProjectSecondarySourceBuildStatusConfig(dict):
    ...
    def __init__(__self__, *, context: Optional[_builtins.str] = ..., target_url: Optional[_builtins.str] = ...) -> None:
...
class ProjectSecondarySourceVersion(dict):
    ...
    def __init__(__self__, *, source_identifier: _builtins.str, source_version: _builtins.str) -> None:
...
class ProjectSource(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, auth: Optional[outputs.ProjectSourceAuth] = ..., build_status_config: Optional[outputs.ProjectSourceBuildStatusConfig] = ..., buildspec: Optional[_builtins.str] = ..., git_clone_depth: Optional[_builtins.int] = ..., git_submodules_config: Optional[outputs.ProjectSourceGitSubmodulesConfig] = ..., insecure_ssl: Optional[_builtins.bool] = ..., location: Optional[_builtins.str] = ..., report_build_status: Optional[_builtins.bool] = ...) -> None:
...
class ReportGroupExportConfig(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, s3_destination: Optional[outputs.ReportGroupExportConfigS3Destination] = ...) -> None:
...
class ReportGroupExportConfigS3Destination(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, encryption_key: _builtins.str, encryption_disabled: Optional[_builtins.bool] = ..., packaging: Optional[_builtins.str] = ..., path: Optional[_builtins.str] = ...) -> None:
...
class WebhookFilterGroup(dict):
    def __init__(__self__, *, filters: Optional[Sequence[outputs.WebhookFilterGroupFilter]] = ...) -> None:
...
class WebhookFilterGroupFilter(dict):
    ...
    def __init__(__self__, *, pattern: _builtins.str, type: _builtins.str, exclude_matched_pattern: Optional[_builtins.bool] = ...) -> None:
...
class WebhookPullRequestBuildPolicy(dict):
    ...
    def __init__(__self__, *, requires_comment_approval: _builtins.str, approver_roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class WebhookScopeConfiguration(dict):
    def __init__(__self__, *, name: _builtins.str, scope: _builtins.str, domain: Optional[_builtins.str] = ...) -> None:
...
class GetFleetComputeConfigurationResult(dict):
    def __init__(__self__, *, disk: _builtins.int, instance_type: _builtins.str, machine_type: _builtins.str, memory: _builtins.int, vcpu: _builtins.int) -> None:
...
class GetFleetScalingConfigurationResult(dict):
    def __init__(__self__, *, desired_capacity: _builtins.int, max_capacity: _builtins.int, scaling_type: _builtins.str, target_tracking_scaling_configs: Sequence[outputs.GetFleetScalingConfigurationTargetTrackingScalingConfigResult]) -> None:
...
class GetFleetScalingConfigurationTargetTrackingScalingConfigResult(dict):
    def __init__(__self__, *, metric_type: _builtins.str, target_value: _builtins.float) -> None:
...
class GetFleetStatusResult(dict):
    def __init__(__self__, *, context: _builtins.str, message: _builtins.str, status_code: _builtins.str) -> None:
