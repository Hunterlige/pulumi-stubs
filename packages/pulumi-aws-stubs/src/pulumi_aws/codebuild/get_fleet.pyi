...
class GetFleetResult:
    ...
    def __init__(__self__, arn=..., base_capacity=..., compute_configurations=..., compute_type=..., created=..., environment_type=..., fleet_service_role=..., id=..., image_id=..., last_modified=..., name=..., overflow_behavior=..., region=..., scaling_configurations=..., statuses=..., tags=..., vpc_configs=...) -> None:
        ...
...
class AwaitableGetFleetResult(GetFleetResult):
    def __await__(self): # -> Generator[Never, Any, GetFleetResult]:
        ...
    


def get_fleet(name: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetFleetResult:
    
    ...

def get_fleet_output(name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetFleetResult]:
