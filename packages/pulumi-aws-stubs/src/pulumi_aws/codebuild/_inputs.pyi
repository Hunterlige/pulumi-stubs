...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FleetComputeConfigurationArgs', 'FleetComputeConfigurationArgsDict', 'FleetScalingConfigurationArgs', 'FleetScalingConfigurationArgsDict', ..., ..., 'FleetStatusArgs', 'FleetStatusArgsDict', 'FleetVpcConfigArgs', 'FleetVpcConfigArgsDict', 'ProjectArtifactsArgs', 'ProjectArtifactsArgsDict', 'ProjectBuildBatchConfigArgs', 'ProjectBuildBatchConfigArgsDict', 'ProjectBuildBatchConfigRestrictionsArgs', 'ProjectBuildBatchConfigRestrictionsArgsDict', 'ProjectCacheArgs', 'ProjectCacheArgsDict', 'ProjectEnvironmentArgs', 'ProjectEnvironmentArgsDict', 'ProjectEnvironmentDockerServerArgs', 'ProjectEnvironmentDockerServerArgsDict', 'ProjectEnvironmentEnvironmentVariableArgs', 'ProjectEnvironmentEnvironmentVariableArgsDict', 'ProjectEnvironmentFleetArgs', 'ProjectEnvironmentFleetArgsDict', 'ProjectEnvironmentRegistryCredentialArgs', 'ProjectEnvironmentRegistryCredentialArgsDict', 'ProjectFileSystemLocationArgs', 'ProjectFileSystemLocationArgsDict', 'ProjectLogsConfigArgs', 'ProjectLogsConfigArgsDict', 'ProjectLogsConfigCloudwatchLogsArgs', 'ProjectLogsConfigCloudwatchLogsArgsDict', 'ProjectLogsConfigS3LogsArgs', 'ProjectLogsConfigS3LogsArgsDict', 'ProjectSecondaryArtifactArgs', 'ProjectSecondaryArtifactArgsDict', 'ProjectSecondarySourceArgs', 'ProjectSecondarySourceArgsDict', 'ProjectSecondarySourceAuthArgs', 'ProjectSecondarySourceAuthArgsDict', 'ProjectSecondarySourceBuildStatusConfigArgs', 'ProjectSecondarySourceBuildStatusConfigArgsDict', 'ProjectSecondarySourceGitSubmodulesConfigArgs', 'ProjectSecondarySourceGitSubmodulesConfigArgsDict', 'ProjectSecondarySourceVersionArgs', 'ProjectSecondarySourceVersionArgsDict', 'ProjectSourceArgs', 'ProjectSourceArgsDict', 'ProjectSourceAuthArgs', 'ProjectSourceAuthArgsDict', 'ProjectSourceBuildStatusConfigArgs', 'ProjectSourceBuildStatusConfigArgsDict', 'ProjectSourceGitSubmodulesConfigArgs', 'ProjectSourceGitSubmodulesConfigArgsDict', 'ProjectVpcConfigArgs', 'ProjectVpcConfigArgsDict', 'ReportGroupExportConfigArgs', 'ReportGroupExportConfigArgsDict', 'ReportGroupExportConfigS3DestinationArgs', 'ReportGroupExportConfigS3DestinationArgsDict', 'WebhookFilterGroupArgs', 'WebhookFilterGroupArgsDict', 'WebhookFilterGroupFilterArgs', 'WebhookFilterGroupFilterArgsDict', 'WebhookPullRequestBuildPolicyArgs', 'WebhookPullRequestBuildPolicyArgsDict', 'WebhookScopeConfigurationArgs', 'WebhookScopeConfigurationArgsDict']
...
class FleetComputeConfigurationArgs:
    def __init__(__self__, *, disk: Optional[pulumi.Input[_builtins.int]] = ..., instance_type: Optional[pulumi.Input[_builtins.str]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., memory: Optional[pulumi.Input[_builtins.int]] = ..., vcpu: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @disk.setter
    def disk(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @vcpu.setter
    def vcpu(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class FleetScalingConfigurationArgs:
    def __init__(__self__, *, desired_capacity: Optional[pulumi.Input[_builtins.int]] = ..., max_capacity: Optional[pulumi.Input[_builtins.int]] = ..., scaling_type: Optional[pulumi.Input[_builtins.str]] = ..., target_tracking_scaling_configs: Optional[pulumi.Input[Sequence[pulumi.Input[FleetScalingConfigurationTargetTrackingScalingConfigArgs]]]] = ...) -> None:
    ...
    @scaling_type.setter
    def scaling_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_tracking_scaling_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FleetScalingConfigurationTargetTrackingScalingConfigArgs]]]]): # -> None:
        ...
...
class FleetScalingConfigurationTargetTrackingScalingConfigArgs:
    def __init__(__self__, *, metric_type: Optional[pulumi.Input[_builtins.str]] = ..., target_value: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @metric_type.setter
    def metric_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FleetStatusArgs:
    def __init__(__self__, *, context: Optional[pulumi.Input[_builtins.str]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ..., status_code: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FleetVpcConfigArgs:
    def __init__(__self__, *, security_group_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], subnets: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], vpc_id: pulumi.Input[_builtins.str]) -> None:
...
class ProjectArtifactsArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], artifact_identifier: Optional[pulumi.Input[_builtins.str]] = ..., bucket_owner_access: Optional[pulumi.Input[_builtins.str]] = ..., encryption_disabled: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., namespace_type: Optional[pulumi.Input[_builtins.str]] = ..., override_artifact_name: Optional[pulumi.Input[_builtins.bool]] = ..., packaging: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def artifact_identifier(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def bucket_owner_access(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def encryption_disabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def namespace_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def override_artifact_name(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @packaging.setter
    def packaging(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ProjectBuildBatchConfigArgs:
    def __init__(__self__, *, service_role: pulumi.Input[_builtins.str], combine_artifacts: Optional[pulumi.Input[_builtins.bool]] = ..., restrictions: Optional[pulumi.Input[ProjectBuildBatchConfigRestrictionsArgs]] = ..., timeout_in_mins: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @service_role.setter
    def service_role(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def combine_artifacts(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @restrictions.setter
    def restrictions(self, value: Optional[pulumi.Input[ProjectBuildBatchConfigRestrictionsArgs]]): # -> None:
        ...
    ...
    def timeout_in_mins(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ProjectBuildBatchConfigRestrictionsArgs:
    def __init__(__self__, *, compute_types_alloweds: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., maximum_builds_allowed: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def compute_types_alloweds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def maximum_builds_allowed(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ProjectCacheArgs:
    def __init__(__self__, *, cache_namespace: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., modes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cache_namespace(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @modes.setter
    def modes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ProjectEnvironmentArgs:
    def __init__(__self__, *, compute_type: pulumi.Input[_builtins.str], image: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], certificate: Optional[pulumi.Input[_builtins.str]] = ..., docker_server: Optional[pulumi.Input[ProjectEnvironmentDockerServerArgs]] = ..., environment_variables: Optional[pulumi.Input[Sequence[pulumi.Input[ProjectEnvironmentEnvironmentVariableArgs]]]] = ..., fleet: Optional[pulumi.Input[ProjectEnvironmentFleetArgs]] = ..., image_pull_credentials_type: Optional[pulumi.Input[_builtins.str]] = ..., privileged_mode: Optional[pulumi.Input[_builtins.bool]] = ..., registry_credential: Optional[pulumi.Input[ProjectEnvironmentRegistryCredentialArgs]] = ...) -> None:
    ...
    def docker_server(self, value: Optional[pulumi.Input[ProjectEnvironmentDockerServerArgs]]): # -> None:
        ...
    ...
    def environment_variables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ProjectEnvironmentEnvironmentVariableArgs]]]]): # -> None:
        ...
    ...
    @fleet.setter
    def fleet(self, value: Optional[pulumi.Input[ProjectEnvironmentFleetArgs]]): # -> None:
        ...
    ...
    def image_pull_credentials_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def privileged_mode(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def registry_credential(self, value: Optional[pulumi.Input[ProjectEnvironmentRegistryCredentialArgs]]): # -> None:
        ...
...
class ProjectEnvironmentDockerServerArgs:
    def __init__(__self__, *, compute_type: pulumi.Input[_builtins.str], security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ProjectEnvironmentEnvironmentVariableArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str], type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ProjectEnvironmentFleetArgs:
    def __init__(__self__, *, fleet_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @fleet_arn.setter
    def fleet_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ProjectEnvironmentRegistryCredentialArgs:
    def __init__(__self__, *, credential: pulumi.Input[_builtins.str], credential_provider: pulumi.Input[_builtins.str]) -> None:
    ...
    @credential.setter
    def credential(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def credential_provider(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ProjectFileSystemLocationArgs:
    def __init__(__self__, *, identifier: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., mount_options: Optional[pulumi.Input[_builtins.str]] = ..., mount_point: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @mount_point.setter
    def mount_point(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ProjectLogsConfigArgs:
    def __init__(__self__, *, cloudwatch_logs: Optional[pulumi.Input[ProjectLogsConfigCloudwatchLogsArgs]] = ..., s3_logs: Optional[pulumi.Input[ProjectLogsConfigS3LogsArgs]] = ...) -> None:
    ...
    def cloudwatch_logs(self, value: Optional[pulumi.Input[ProjectLogsConfigCloudwatchLogsArgs]]): # -> None:
        ...
    ...
    @s3_logs.setter
    def s3_logs(self, value: Optional[pulumi.Input[ProjectLogsConfigS3LogsArgs]]): # -> None:
        ...
...
class ProjectLogsConfigCloudwatchLogsArgs:
    def __init__(__self__, *, group_name: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., stream_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ProjectLogsConfigS3LogsArgs:
    def __init__(__self__, *, bucket_owner_access: Optional[pulumi.Input[_builtins.str]] = ..., encryption_disabled: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ProjectSecondaryArtifactArgs:
    def __init__(__self__, *, artifact_identifier: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], bucket_owner_access: Optional[pulumi.Input[_builtins.str]] = ..., encryption_disabled: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., namespace_type: Optional[pulumi.Input[_builtins.str]] = ..., override_artifact_name: Optional[pulumi.Input[_builtins.bool]] = ..., packaging: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @artifact_identifier.setter
    def artifact_identifier(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ProjectSecondarySourceArgs:
    def __init__(__self__, *, source_identifier: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], auth: Optional[pulumi.Input[ProjectSecondarySourceAuthArgs]] = ..., build_status_config: Optional[pulumi.Input[ProjectSecondarySourceBuildStatusConfigArgs]] = ..., buildspec: Optional[pulumi.Input[_builtins.str]] = ..., git_clone_depth: Optional[pulumi.Input[_builtins.int]] = ..., git_submodules_config: Optional[pulumi.Input[ProjectSecondarySourceGitSubmodulesConfigArgs]] = ..., insecure_ssl: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., report_build_status: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def source_identifier(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @auth.setter
    def auth(self, value: Optional[pulumi.Input[ProjectSecondarySourceAuthArgs]]): # -> None:
        ...
    ...
    def build_status_config(self, value: Optional[pulumi.Input[ProjectSecondarySourceBuildStatusConfigArgs]]): # -> None:
        ...
    ...
    @buildspec.setter
    def buildspec(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def git_clone_depth(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def git_submodules_config(self, value: Optional[pulumi.Input[ProjectSecondarySourceGitSubmodulesConfigArgs]]): # -> None:
        ...
    ...
    @insecure_ssl.setter
    def insecure_ssl(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def report_build_status(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ProjectSecondarySourceAuthArgs:
    def __init__(__self__, *, resource: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str]) -> None:
...
class ProjectSecondarySourceBuildStatusConfigArgs:
    def __init__(__self__, *, context: Optional[pulumi.Input[_builtins.str]] = ..., target_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ProjectSecondarySourceGitSubmodulesConfigArgs:
    def __init__(__self__, *, fetch_submodules: pulumi.Input[_builtins.bool]) -> None:
    ...
    def fetch_submodules(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class ProjectSecondarySourceVersionArgs:
    def __init__(__self__, *, source_identifier: pulumi.Input[_builtins.str], source_version: pulumi.Input[_builtins.str]) -> None:
    ...
    def source_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ProjectSourceArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], auth: Optional[pulumi.Input[ProjectSourceAuthArgs]] = ..., build_status_config: Optional[pulumi.Input[ProjectSourceBuildStatusConfigArgs]] = ..., buildspec: Optional[pulumi.Input[_builtins.str]] = ..., git_clone_depth: Optional[pulumi.Input[_builtins.int]] = ..., git_submodules_config: Optional[pulumi.Input[ProjectSourceGitSubmodulesConfigArgs]] = ..., insecure_ssl: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., report_build_status: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @auth.setter
    def auth(self, value: Optional[pulumi.Input[ProjectSourceAuthArgs]]): # -> None:
        ...
    ...
    @build_status_config.setter
    def build_status_config(self, value: Optional[pulumi.Input[ProjectSourceBuildStatusConfigArgs]]): # -> None:
        ...
    ...
    @git_submodules_config.setter
    def git_submodules_config(self, value: Optional[pulumi.Input[ProjectSourceGitSubmodulesConfigArgs]]): # -> None:
        ...
...
class ReportGroupExportConfigArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], s3_destination: Optional[pulumi.Input[ReportGroupExportConfigS3DestinationArgs]] = ...) -> None:
    ...
    def s3_destination(self, value: Optional[pulumi.Input[ReportGroupExportConfigS3DestinationArgs]]): # -> None:
        ...
...
class ReportGroupExportConfigS3DestinationArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], encryption_key: pulumi.Input[_builtins.str], encryption_disabled: Optional[pulumi.Input[_builtins.bool]] = ..., packaging: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WebhookFilterGroupArgs:
    def __init__(__self__, *, filters: Optional[pulumi.Input[Sequence[pulumi.Input[WebhookFilterGroupFilterArgs]]]] = ...) -> None:
    ...
    @filters.setter
    def filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WebhookFilterGroupFilterArgs]]]]): # -> None:
        ...
...
class WebhookFilterGroupFilterArgs:
    def __init__(__self__, *, pattern: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], exclude_matched_pattern: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def exclude_matched_pattern(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class WebhookPullRequestBuildPolicyArgs:
    def __init__(__self__, *, requires_comment_approval: pulumi.Input[_builtins.str], approver_roles: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def requires_comment_approval(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def approver_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class WebhookScopeConfigurationArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], scope: pulumi.Input[_builtins.str], domain: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
