...
class CloudFormationTypeLoggingConfig(dict):
    ...
    def __init__(__self__, *, log_group_name: _builtins.str, log_role_arn: _builtins.str) -> None:
...
class StackInstancesDeploymentTargets(dict):
    ...
    def __init__(__self__, *, account_filter_type: Optional[_builtins.str] = ..., accounts: Optional[Sequence[_builtins.str]] = ..., accounts_url: Optional[_builtins.str] = ..., organizational_unit_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class StackInstancesOperationPreferences(dict):
    ...
    def __init__(__self__, *, concurrency_mode: Optional[_builtins.str] = ..., failure_tolerance_count: Optional[_builtins.int] = ..., failure_tolerance_percentage: Optional[_builtins.int] = ..., max_concurrent_count: Optional[_builtins.int] = ..., max_concurrent_percentage: Optional[_builtins.int] = ..., region_concurrency_type: Optional[_builtins.str] = ..., region_orders: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class StackInstancesStackInstanceSummary(dict):
    ...
    def __init__(__self__, *, account_id: Optional[_builtins.str] = ..., detailed_status: Optional[_builtins.str] = ..., drift_status: Optional[_builtins.str] = ..., organizational_unit_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., stack_id: Optional[_builtins.str] = ..., stack_set_id: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., status_reason: Optional[_builtins.str] = ...) -> None:
...
class StackSetAutoDeployment(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., retain_stacks_on_account_removal: Optional[_builtins.bool] = ...) -> None:
...
class StackSetInstanceStackInstanceSummary(dict):
    ...
    def __init__(__self__, *, account_id: Optional[_builtins.str] = ..., organizational_unit_id: Optional[_builtins.str] = ..., stack_id: Optional[_builtins.str] = ...) -> None:
...
class StackSetOperationPreferences(dict):
    ...
    def __init__(__self__, *, failure_tolerance_count: Optional[_builtins.int] = ..., failure_tolerance_percentage: Optional[_builtins.int] = ..., max_concurrent_count: Optional[_builtins.int] = ..., max_concurrent_percentage: Optional[_builtins.int] = ..., region_concurrency_type: Optional[_builtins.str] = ..., region_orders: Optional[Sequence[_builtins.str]] = ...) -> None:
