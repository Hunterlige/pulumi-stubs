...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterClusterNode', 'EndpointAccessVpcEndpoint', 'EndpointAccessVpcEndpointNetworkInterface', 'IdcApplicationAuthorizedTokenIssuer', 'IdcApplicationServiceIntegration', 'IdcApplicationServiceIntegrationLakeFormation', ..., 'IdcApplicationServiceIntegrationRedshift', 'IdcApplicationServiceIntegrationRedshiftConnect', 'IdcApplicationServiceIntegrationS3AccessGrants', ..., 'IntegrationTimeouts', 'ParameterGroupParameter', 'ScheduledActionTargetAction', 'ScheduledActionTargetActionPauseCluster', 'ScheduledActionTargetActionResizeCluster', 'ScheduledActionTargetActionResumeCluster', 'GetClusterClusterNodeResult', 'GetDataSharesDataShareResult', 'GetProducerDataSharesDataShareResult']
@pulumi.output_type
class ClusterClusterNode(dict):
    ...
    def __init__(__self__, *, node_role: Optional[_builtins.str] = ..., private_ip_address: Optional[_builtins.str] = ..., public_ip_address: Optional[_builtins.str] = ...) -> None:
...
class IdcApplicationAuthorizedTokenIssuer(dict):
    ...
    def __init__(__self__, *, authorized_audiences_lists: Optional[Sequence[_builtins.str]] = ..., trusted_token_issuer_arn: Optional[_builtins.str] = ...) -> None:
...
class IdcApplicationServiceIntegration(dict):
    ...
    def __init__(__self__, *, lake_formation: Optional[outputs.IdcApplicationServiceIntegrationLakeFormation] = ..., redshift: Optional[outputs.IdcApplicationServiceIntegrationRedshift] = ..., s3_access_grants: Optional[outputs.IdcApplicationServiceIntegrationS3AccessGrants] = ...) -> None:
...
class IdcApplicationServiceIntegrationLakeFormation(dict):
    ...
    def __init__(__self__, *, lake_formation_query: Optional[outputs.IdcApplicationServiceIntegrationLakeFormationLakeFormationQuery] = ...) -> None:
...
class IdcApplicationServiceIntegrationRedshift(dict):
    def __init__(__self__, *, connect: Optional[outputs.IdcApplicationServiceIntegrationRedshiftConnect] = ...) -> None:
...
class IdcApplicationServiceIntegrationS3AccessGrants(dict):
    ...
    def __init__(__self__, *, read_write_access: Optional[outputs.IdcApplicationServiceIntegrationS3AccessGrantsReadWriteAccess] = ...) -> None:
...
class ScheduledActionTargetAction(dict):
    ...
    def __init__(__self__, *, pause_cluster: Optional[outputs.ScheduledActionTargetActionPauseCluster] = ..., resize_cluster: Optional[outputs.ScheduledActionTargetActionResizeCluster] = ..., resume_cluster: Optional[outputs.ScheduledActionTargetActionResumeCluster] = ...) -> None:
...
class ScheduledActionTargetActionResizeCluster(dict):
    ...
    def __init__(__self__, *, cluster_identifier: _builtins.str, classic: Optional[_builtins.bool] = ..., cluster_type: Optional[_builtins.str] = ..., node_type: Optional[_builtins.str] = ..., number_of_nodes: Optional[_builtins.int] = ...) -> None:
...
class GetClusterClusterNodeResult(dict):
    def __init__(__self__, *, node_role: _builtins.str, private_ip_address: _builtins.str, public_ip_address: _builtins.str) -> None:
...
class GetDataSharesDataShareResult(dict):
    def __init__(__self__, *, data_share_arn: _builtins.str, managed_by: _builtins.str, producer_arn: _builtins.str) -> None:
