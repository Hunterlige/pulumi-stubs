...
class _HsmClientCertificateState:
    def __init__(
        ...
        *,
        ...
        hsm_client_certificate_identifier: Optional[pulumi.Input[_builtins.str]] = ...,
        hsm_client_certificate_public_key: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tags_all: Optional[
    ...
    def hsm_client_certificate_public_key(
        self,
    ) -> Optional[pulumi.Input[_builtins.str]]: ...
