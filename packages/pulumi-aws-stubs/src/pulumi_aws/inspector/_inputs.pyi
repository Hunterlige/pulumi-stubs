...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AssessmentTemplateEventSubscriptionArgs', 'AssessmentTemplateEventSubscriptionArgsDict']
...
class AssessmentTemplateEventSubscriptionArgs:
    def __init__(__self__, *, event: pulumi.Input[_builtins.str], topic_arn: pulumi.Input[_builtins.str]) -> None:
