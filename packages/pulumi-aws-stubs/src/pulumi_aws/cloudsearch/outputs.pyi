...
class DomainEndpointOptions(dict):
    ...
    def __init__(__self__, *, enforce_https: Optional[_builtins.bool] = ..., tls_security_policy: Optional[_builtins.str] = ...) -> None:
...
class DomainIndexField(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, type: _builtins.str, analysis_scheme: Optional[_builtins.str] = ..., default_value: Optional[_builtins.str] = ..., facet: Optional[_builtins.bool] = ..., highlight: Optional[_builtins.bool] = ..., return_: Optional[_builtins.bool] = ..., search: Optional[_builtins.bool] = ..., sort: Optional[_builtins.bool] = ..., source_fields: Optional[_builtins.str] = ...) -> None:
...
class DomainScalingParameters(dict):
    ...
    def __init__(__self__, *, desired_instance_type: Optional[_builtins.str] = ..., desired_partition_count: Optional[_builtins.int] = ..., desired_replication_count: Optional[_builtins.int] = ...) -> None:
