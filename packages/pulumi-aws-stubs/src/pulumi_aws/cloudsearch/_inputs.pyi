...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DomainEndpointOptionsArgs', 'DomainEndpointOptionsArgsDict', 'DomainIndexFieldArgs', 'DomainIndexFieldArgsDict', 'DomainScalingParametersArgs', 'DomainScalingParametersArgsDict']
...
class DomainEndpointOptionsArgs:
    def __init__(__self__, *, enforce_https: Optional[pulumi.Input[_builtins.bool]] = ..., tls_security_policy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DomainIndexFieldArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], analysis_scheme: Optional[pulumi.Input[_builtins.str]] = ..., default_value: Optional[pulumi.Input[_builtins.str]] = ..., facet: Optional[pulumi.Input[_builtins.bool]] = ..., highlight: Optional[pulumi.Input[_builtins.bool]] = ..., return_: Optional[pulumi.Input[_builtins.bool]] = ..., search: Optional[pulumi.Input[_builtins.bool]] = ..., sort: Optional[pulumi.Input[_builtins.bool]] = ..., source_fields: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def analysis_scheme(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @facet.setter
    def facet(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @highlight.setter
    def highlight(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @return_.setter
    def return_(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @search.setter
    def search(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @sort.setter
    def sort(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def source_fields(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DomainScalingParametersArgs:
    def __init__(__self__, *, desired_instance_type: Optional[pulumi.Input[_builtins.str]] = ..., desired_partition_count: Optional[pulumi.Input[_builtins.int]] = ..., desired_replication_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def desired_instance_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def desired_partition_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def desired_replication_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
