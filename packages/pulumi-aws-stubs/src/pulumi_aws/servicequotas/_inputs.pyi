...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ServiceQuotaUsageMetricArgs', 'ServiceQuotaUsageMetricArgsDict', 'ServiceQuotaUsageMetricMetricDimensionArgs', 'ServiceQuotaUsageMetricMetricDimensionArgsDict']
...
class ServiceQuotaUsageMetricArgs:
    def __init__(__self__, *, metric_dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceQuotaUsageMetricMetricDimensionArgs]]]] = ..., metric_name: Optional[pulumi.Input[_builtins.str]] = ..., metric_namespace: Optional[pulumi.Input[_builtins.str]] = ..., metric_statistic_recommendation: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def metric_dimensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceQuotaUsageMetricMetricDimensionArgs]]]]): # -> None:
        ...
    ...
    def metric_statistic_recommendation(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceQuotaUsageMetricMetricDimensionArgs:
    def __init__(__self__, *, class_: Optional[pulumi.Input[_builtins.str]] = ..., resource: Optional[pulumi.Input[_builtins.str]] = ..., service: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    @class_.setter
    def class_(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
