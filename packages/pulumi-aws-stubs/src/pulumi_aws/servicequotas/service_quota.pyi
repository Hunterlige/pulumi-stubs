...
class ServiceQuotaArgs:
    def __init__(__self__, *, quota_code: pulumi.Input[_builtins.str], service_code: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.float], region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class _ServiceQuotaState:
    def __init__(__self__, *, adjustable: Optional[pulumi.Input[_builtins.bool]] = ..., arn: Optional[pulumi.Input[_builtins.str]] = ..., default_value: Optional[pulumi.Input[_builtins.float]] = ..., quota_code: Optional[pulumi.Input[_builtins.str]] = ..., quota_name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., request_id: Optional[pulumi.Input[_builtins.str]] = ..., request_status: Optional[pulumi.Input[_builtins.str]] = ..., service_code: Optional[pulumi.Input[_builtins.str]] = ..., service_name: Optional[pulumi.Input[_builtins.str]] = ..., usage_metrics: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceQuotaUsageMetricArgs]]]] = ..., value: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @adjustable.setter
    def adjustable(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def default_value(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def request_status(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def usage_metrics(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceQuotaUsageMetricArgs]]]]): # -> None:
        ...
...
class ServiceQuota(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., quota_code: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., service_code: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.float]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ServiceQuotaArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., adjustable: Optional[pulumi.Input[_builtins.bool]] = ..., arn: Optional[pulumi.Input[_builtins.str]] = ..., default_value: Optional[pulumi.Input[_builtins.float]] = ..., quota_code: Optional[pulumi.Input[_builtins.str]] = ..., quota_name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., request_id: Optional[pulumi.Input[_builtins.str]] = ..., request_status: Optional[pulumi.Input[_builtins.str]] = ..., service_code: Optional[pulumi.Input[_builtins.str]] = ..., service_name: Optional[pulumi.Input[_builtins.str]] = ..., usage_metrics: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ServiceQuotaUsageMetricArgs, ServiceQuotaUsageMetricArgsDict]]]]] = ..., value: Optional[pulumi.Input[_builtins.float]] = ...) -> ServiceQuota:
