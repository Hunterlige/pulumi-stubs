...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppAuthorizationConnectionAuthRequestArgs', 'AppAuthorizationConnectionAuthRequestArgsDict', 'AppAuthorizationConnectionTenantArgs', 'AppAuthorizationConnectionTenantArgsDict', 'AppAuthorizationConnectionTimeoutsArgs', 'AppAuthorizationConnectionTimeoutsArgsDict', 'AppAuthorizationCredentialArgs', 'AppAuthorizationCredentialArgsDict', 'AppAuthorizationCredentialApiKeyCredentialArgs', 'AppAuthorizationCredentialApiKeyCredentialArgsDict', 'AppAuthorizationCredentialOauth2CredentialArgs', 'AppAuthorizationCredentialOauth2CredentialArgsDict', 'AppAuthorizationTenantArgs', 'AppAuthorizationTenantArgsDict', 'AppAuthorizationTimeoutsArgs', 'AppAuthorizationTimeoutsArgsDict', 'IngestionDestinationDestinationConfigurationArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., 'IngestionDestinationProcessingConfigurationArgs', ..., ..., ..., 'IngestionDestinationTimeoutsArgs', 'IngestionDestinationTimeoutsArgsDict']
...
class AppAuthorizationConnectionAuthRequestArgs:
    def __init__(__self__, *, code: pulumi.Input[_builtins.str], redirect_uri: pulumi.Input[_builtins.str]) -> None:
...
class AppAuthorizationConnectionTenantArgs:
    def __init__(__self__, *, tenant_display_name: pulumi.Input[_builtins.str], tenant_identifier: pulumi.Input[_builtins.str]) -> None:
        ...
    ...
    def tenant_display_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def tenant_identifier(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AppAuthorizationCredentialArgs:
    def __init__(__self__, *, api_key_credentials: Optional[pulumi.Input[Sequence[pulumi.Input[AppAuthorizationCredentialApiKeyCredentialArgs]]]] = ..., oauth2_credential: Optional[pulumi.Input[AppAuthorizationCredentialOauth2CredentialArgs]] = ...) -> None:
    ...
    def api_key_credentials(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppAuthorizationCredentialApiKeyCredentialArgs]]]]): # -> None:
        ...
    ...
    def oauth2_credential(self, value: Optional[pulumi.Input[AppAuthorizationCredentialOauth2CredentialArgs]]): # -> None:
        ...
...
class IngestionDestinationDestinationConfigurationArgs:
    def __init__(__self__, *, audit_log: pulumi.Input[IngestionDestinationDestinationConfigurationAuditLogArgs]) -> None:
    ...
    @audit_log.setter
    def audit_log(self, value: pulumi.Input[IngestionDestinationDestinationConfigurationAuditLogArgs]): # -> None:
        ...
...
class IngestionDestinationDestinationConfigurationAuditLogArgs:
    def __init__(__self__, *, destination: pulumi.Input[IngestionDestinationDestinationConfigurationAuditLogDestinationArgs]) -> None:
    ...
    @destination.setter
    def destination(self, value: pulumi.Input[IngestionDestinationDestinationConfigurationAuditLogDestinationArgs]): # -> None:
        ...
...
class IngestionDestinationDestinationConfigurationAuditLogDestinationArgs:
    def __init__(__self__, *, firehose_stream: Optional[pulumi.Input[IngestionDestinationDestinationConfigurationAuditLogDestinationFirehoseStreamArgs]] = ..., s3_bucket: Optional[pulumi.Input[IngestionDestinationDestinationConfigurationAuditLogDestinationS3BucketArgs]] = ...) -> None:
    ...
    def firehose_stream(self, value: Optional[pulumi.Input[IngestionDestinationDestinationConfigurationAuditLogDestinationFirehoseStreamArgs]]): # -> None:
        ...
    ...
    @s3_bucket.setter
    def s3_bucket(self, value: Optional[pulumi.Input[IngestionDestinationDestinationConfigurationAuditLogDestinationS3BucketArgs]]): # -> None:
        ...
...
class IngestionDestinationProcessingConfigurationArgs:
    def __init__(__self__, *, audit_log: pulumi.Input[IngestionDestinationProcessingConfigurationAuditLogArgs]) -> None:
    ...
    @audit_log.setter
    def audit_log(self, value: pulumi.Input[IngestionDestinationProcessingConfigurationAuditLogArgs]): # -> None:
        ...
...
class IngestionDestinationProcessingConfigurationAuditLogArgs:
    def __init__(__self__, *, format: pulumi.Input[_builtins.str], schema: pulumi.Input[_builtins.str]) -> None:
