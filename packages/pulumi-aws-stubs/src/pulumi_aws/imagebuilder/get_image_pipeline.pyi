...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetImagePipelineResult', 'AwaitableGetImagePipelineResult', 'get_image_pipeline', 'get_image_pipeline_output']
@pulumi.output_type
class GetImagePipelineResult:
    
    def __init__(__self__, arn=..., container_recipe_arn=..., date_created=..., date_last_run=..., date_next_run=..., date_updated=..., description=..., distribution_configuration_arn=..., enhanced_image_metadata_enabled=..., id=..., image_recipe_arn=..., image_scanning_configurations=..., image_tests_configurations=..., infrastructure_configuration_arn=..., name=..., platform=..., region=..., schedules=..., status=..., tags=...) -> None:
        ...
...
class AwaitableGetImagePipelineResult(GetImagePipelineResult):
    def __await__(self): # -> Generator[Never, Any, GetImagePipelineResult]:
        ...
    


def get_image_pipeline(arn: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetImagePipelineResult:
    
    ...

def get_image_pipeline_output(arn: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetImagePipelineResult]:
