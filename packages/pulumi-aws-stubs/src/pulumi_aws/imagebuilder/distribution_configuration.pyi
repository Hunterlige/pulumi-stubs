...
class DistributionConfigurationArgs:
    def __init__(
        __self__,
        *,
        distributions: pulumi.Input[
            Sequence[pulumi.Input[DistributionConfigurationDistributionArgs]]
        ],
...
class _DistributionConfigurationState:
    ...
    def distributions(
        ...
        pulumi.Input[Sequence[pulumi.Input[DistributionConfigurationDistributionArgs]]]
    ]: ...
    @distributions.setter
    def distributions(
        self,
...
class DistributionConfiguration(pulumi.CustomResource):
    ...
    def distributions(
        self,
    ) -> pulumi.Output[Sequence[outputs.DistributionConfigurationDistribution]]: ...
    @_builtins.property
    @pulumi.getter
