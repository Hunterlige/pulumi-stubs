...
class GetImageResult:
    ...
    def __init__(__self__, arn=..., build_version_arn=..., container_recipe_arn=..., date_created=..., distribution_configuration_arn=..., enhanced_image_metadata_enabled=..., id=..., image_recipe_arn=..., image_scanning_configurations=..., image_tests_configurations=..., infrastructure_configuration_arn=..., name=..., os_version=..., output_resources=..., platform=..., region=..., tags=..., version=...) -> None:
        ...
...
def get_image(arn: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetImageResult:
    
    ...

def get_image_output(arn: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetImageResult]:
