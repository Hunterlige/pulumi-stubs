...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ContainerRecipeComponentArgs', 'ContainerRecipeComponentArgsDict', 'ContainerRecipeComponentParameterArgs', 'ContainerRecipeComponentParameterArgsDict', 'ContainerRecipeInstanceConfigurationArgs', 'ContainerRecipeInstanceConfigurationArgsDict', ..., ..., ..., ..., 'ContainerRecipeTargetRepositoryArgs', 'ContainerRecipeTargetRepositoryArgsDict', 'DistributionConfigurationDistributionArgs', 'DistributionConfigurationDistributionArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ImageImageScanningConfigurationArgs', 'ImageImageScanningConfigurationArgsDict', ..., ..., 'ImageImageTestsConfigurationArgs', 'ImageImageTestsConfigurationArgsDict', 'ImageLoggingConfigurationArgs', 'ImageLoggingConfigurationArgsDict', 'ImageOutputResourceArgs', 'ImageOutputResourceArgsDict', 'ImageOutputResourceAmiArgs', 'ImageOutputResourceAmiArgsDict', 'ImageOutputResourceContainerArgs', 'ImageOutputResourceContainerArgsDict', 'ImagePipelineImageScanningConfigurationArgs', 'ImagePipelineImageScanningConfigurationArgsDict', ..., ..., 'ImagePipelineImageTestsConfigurationArgs', 'ImagePipelineImageTestsConfigurationArgsDict', 'ImagePipelineLoggingConfigurationArgs', 'ImagePipelineLoggingConfigurationArgsDict', 'ImagePipelineScheduleArgs', 'ImagePipelineScheduleArgsDict', 'ImagePipelineWorkflowArgs', 'ImagePipelineWorkflowArgsDict', 'ImagePipelineWorkflowParameterArgs', 'ImagePipelineWorkflowParameterArgsDict', 'ImageRecipeBlockDeviceMappingArgs', 'ImageRecipeBlockDeviceMappingArgsDict', 'ImageRecipeBlockDeviceMappingEbsArgs', 'ImageRecipeBlockDeviceMappingEbsArgsDict', 'ImageRecipeComponentArgs', 'ImageRecipeComponentArgsDict', 'ImageRecipeComponentParameterArgs', 'ImageRecipeComponentParameterArgsDict', 'ImageRecipeSystemsManagerAgentArgs', 'ImageRecipeSystemsManagerAgentArgsDict', 'ImageWorkflowArgs', 'ImageWorkflowArgsDict', 'ImageWorkflowParameterArgs', 'ImageWorkflowParameterArgsDict', ..., ..., 'InfrastructureConfigurationLoggingArgs', 'InfrastructureConfigurationLoggingArgsDict', 'InfrastructureConfigurationLoggingS3LogsArgs', 'InfrastructureConfigurationLoggingS3LogsArgsDict', 'InfrastructureConfigurationPlacementArgs', 'InfrastructureConfigurationPlacementArgsDict', 'LifecyclePolicyPolicyDetailArgs', 'LifecyclePolicyPolicyDetailArgsDict', 'LifecyclePolicyPolicyDetailActionArgs', 'LifecyclePolicyPolicyDetailActionArgsDict', ..., ..., 'LifecyclePolicyPolicyDetailExclusionRulesArgs', 'LifecyclePolicyPolicyDetailExclusionRulesArgsDict', 'LifecyclePolicyPolicyDetailExclusionRulesAmisArgs', ..., ..., ..., 'LifecyclePolicyPolicyDetailFilterArgs', 'LifecyclePolicyPolicyDetailFilterArgsDict', 'LifecyclePolicyResourceSelectionArgs', 'LifecyclePolicyResourceSelectionArgsDict', 'LifecyclePolicyResourceSelectionRecipeArgs', 'LifecyclePolicyResourceSelectionRecipeArgsDict', 'GetComponentsFilterArgs', 'GetComponentsFilterArgsDict', 'GetContainerRecipesFilterArgs', 'GetContainerRecipesFilterArgsDict', 'GetDistributionConfigurationsFilterArgs', 'GetDistributionConfigurationsFilterArgsDict', 'GetImagePipelinesFilterArgs', 'GetImagePipelinesFilterArgsDict', 'GetImageRecipesFilterArgs', 'GetImageRecipesFilterArgsDict', 'GetInfrastructureConfigurationsFilterArgs', 'GetInfrastructureConfigurationsFilterArgsDict']
...
class ContainerRecipeComponentArgs:
    def __init__(__self__, *, component_arn: pulumi.Input[_builtins.str], parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerRecipeComponentParameterArgs]]]] = ...) -> None:
    ...
    def component_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerRecipeComponentParameterArgs]]]]): # -> None:
        ...
...
class ContainerRecipeInstanceConfigurationArgs:
    def __init__(__self__, *, block_device_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerRecipeInstanceConfigurationBlockDeviceMappingArgs]]]] = ..., image: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def block_device_mappings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ContainerRecipeInstanceConfigurationBlockDeviceMappingArgs]]]]): # -> None:
        ...
...
class ContainerRecipeInstanceConfigurationBlockDeviceMappingArgs:
    def __init__(__self__, *, device_name: Optional[pulumi.Input[_builtins.str]] = ..., ebs: Optional[pulumi.Input[ContainerRecipeInstanceConfigurationBlockDeviceMappingEbsArgs]] = ..., no_device: Optional[pulumi.Input[_builtins.bool]] = ..., virtual_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ebs.setter
    def ebs(self, value: Optional[pulumi.Input[ContainerRecipeInstanceConfigurationBlockDeviceMappingEbsArgs]]): # -> None:
        ...
...
class ContainerRecipeInstanceConfigurationBlockDeviceMappingEbsArgs:
    def __init__(__self__, *, delete_on_termination: Optional[pulumi.Input[_builtins.str]] = ..., encrypted: Optional[pulumi.Input[_builtins.str]] = ..., iops: Optional[pulumi.Input[_builtins.int]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., snapshot_id: Optional[pulumi.Input[_builtins.str]] = ..., throughput: Optional[pulumi.Input[_builtins.int]] = ..., volume_size: Optional[pulumi.Input[_builtins.int]] = ..., volume_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ContainerRecipeTargetRepositoryArgs:
    def __init__(__self__, *, repository_name: pulumi.Input[_builtins.str], service: pulumi.Input[_builtins.str]) -> None:
...
class DistributionConfigurationDistributionArgs:
    def __init__(__self__, *, region: pulumi.Input[_builtins.str], ami_distribution_configuration: Optional[pulumi.Input[DistributionConfigurationDistributionAmiDistributionConfigurationArgs]] = ..., container_distribution_configuration: Optional[pulumi.Input[DistributionConfigurationDistributionContainerDistributionConfigurationArgs]] = ..., fast_launch_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[DistributionConfigurationDistributionFastLaunchConfigurationArgs]]]] = ..., launch_template_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[DistributionConfigurationDistributionLaunchTemplateConfigurationArgs]]]] = ..., license_configuration_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., s3_export_configuration: Optional[pulumi.Input[DistributionConfigurationDistributionS3ExportConfigurationArgs]] = ..., ssm_parameter_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[DistributionConfigurationDistributionSsmParameterConfigurationArgs]]]] = ...) -> None:
    ...
    def ami_distribution_configuration(self, value: Optional[pulumi.Input[DistributionConfigurationDistributionAmiDistributionConfigurationArgs]]): # -> None:
        ...
    ...
    def container_distribution_configuration(self, value: Optional[pulumi.Input[DistributionConfigurationDistributionContainerDistributionConfigurationArgs]]): # -> None:
        ...
    ...
    def fast_launch_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DistributionConfigurationDistributionFastLaunchConfigurationArgs]]]]): # -> None:
        ...
    ...
    def launch_template_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DistributionConfigurationDistributionLaunchTemplateConfigurationArgs]]]]): # -> None:
        ...
    ...
    def license_configuration_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def s3_export_configuration(self, value: Optional[pulumi.Input[DistributionConfigurationDistributionS3ExportConfigurationArgs]]): # -> None:
        ...
    ...
    def ssm_parameter_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DistributionConfigurationDistributionSsmParameterConfigurationArgs]]]]): # -> None:
        ...
...
class DistributionConfigurationDistributionAmiDistributionConfigurationArgs:
    def __init__(__self__, *, ami_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., launch_permission: Optional[pulumi.Input[DistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermissionArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., target_account_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def launch_permission(self, value: Optional[pulumi.Input[DistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermissionArgs]]): # -> None:
        ...
    ...
    def target_account_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermissionArgs:
    def __init__(__self__, *, organization_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., organizational_unit_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., user_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., user_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def organization_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def organizational_unit_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @user_groups.setter
    def user_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @user_ids.setter
    def user_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DistributionConfigurationDistributionContainerDistributionConfigurationArgs:
    def __init__(__self__, *, target_repository: pulumi.Input[DistributionConfigurationDistributionContainerDistributionConfigurationTargetRepositoryArgs], container_tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def target_repository(self, value: pulumi.Input[DistributionConfigurationDistributionContainerDistributionConfigurationTargetRepositoryArgs]): # -> None:
        ...
    ...
    def container_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DistributionConfigurationDistributionFastLaunchConfigurationArgs:
    def __init__(__self__, *, account_id: pulumi.Input[_builtins.str], enabled: pulumi.Input[_builtins.bool], launch_template: Optional[pulumi.Input[DistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplateArgs]] = ..., max_parallel_launches: Optional[pulumi.Input[_builtins.int]] = ..., snapshot_configuration: Optional[pulumi.Input[DistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfigurationArgs]] = ...) -> None:
    ...
    def launch_template(self, value: Optional[pulumi.Input[DistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplateArgs]]): # -> None:
        ...
    ...
    def max_parallel_launches(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def snapshot_configuration(self, value: Optional[pulumi.Input[DistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfigurationArgs]]): # -> None:
        ...
...
class DistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplateArgs:
    def __init__(__self__, *, launch_template_id: Optional[pulumi.Input[_builtins.str]] = ..., launch_template_name: Optional[pulumi.Input[_builtins.str]] = ..., launch_template_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def launch_template_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfigurationArgs:
    def __init__(__self__, *, target_resource_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def target_resource_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class DistributionConfigurationDistributionLaunchTemplateConfigurationArgs:
    def __init__(__self__, *, launch_template_id: pulumi.Input[_builtins.str], account_id: Optional[pulumi.Input[_builtins.str]] = ..., default: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class DistributionConfigurationDistributionS3ExportConfigurationArgs:
    def __init__(__self__, *, disk_image_format: pulumi.Input[_builtins.str], role_name: pulumi.Input[_builtins.str], s3_bucket: pulumi.Input[_builtins.str], s3_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disk_image_format(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DistributionConfigurationDistributionSsmParameterConfigurationArgs:
    def __init__(__self__, *, parameter_name: pulumi.Input[_builtins.str], ami_account_id: Optional[pulumi.Input[_builtins.str]] = ..., data_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ami_account_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ImageImageScanningConfigurationArgs:
    def __init__(__self__, *, ecr_configuration: Optional[pulumi.Input[ImageImageScanningConfigurationEcrConfigurationArgs]] = ..., image_scanning_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def ecr_configuration(self, value: Optional[pulumi.Input[ImageImageScanningConfigurationEcrConfigurationArgs]]): # -> None:
        ...
    ...
    def image_scanning_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ImageImageScanningConfigurationEcrConfigurationArgs:
    def __init__(__self__, *, container_tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., repository_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ImageImageTestsConfigurationArgs:
    def __init__(__self__, *, image_tests_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def image_tests_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ImageOutputResourceArgs:
    def __init__(__self__, *, amis: Optional[pulumi.Input[Sequence[pulumi.Input[ImageOutputResourceAmiArgs]]]] = ..., containers: Optional[pulumi.Input[Sequence[pulumi.Input[ImageOutputResourceContainerArgs]]]] = ...) -> None:
    ...
    @amis.setter
    def amis(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ImageOutputResourceAmiArgs]]]]): # -> None:
        ...
    ...
    @containers.setter
    def containers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ImageOutputResourceContainerArgs]]]]): # -> None:
        ...
...
class ImageOutputResourceAmiArgs:
    def __init__(__self__, *, account_id: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., image: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ImageOutputResourceContainerArgs:
    def __init__(__self__, *, image_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @image_uris.setter
    def image_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ImagePipelineImageScanningConfigurationArgs:
    def __init__(__self__, *, ecr_configuration: Optional[pulumi.Input[ImagePipelineImageScanningConfigurationEcrConfigurationArgs]] = ..., image_scanning_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @ecr_configuration.setter
    def ecr_configuration(self, value: Optional[pulumi.Input[ImagePipelineImageScanningConfigurationEcrConfigurationArgs]]): # -> None:
        ...
...
class ImagePipelineLoggingConfigurationArgs:
    def __init__(__self__, *, image_log_group_name: Optional[pulumi.Input[_builtins.str]] = ..., pipeline_log_group_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def image_log_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def pipeline_log_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ImagePipelineScheduleArgs:
    def __init__(__self__, *, schedule_expression: pulumi.Input[_builtins.str], pipeline_execution_start_condition: Optional[pulumi.Input[_builtins.str]] = ..., timezone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def pipeline_execution_start_condition(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ImagePipelineWorkflowArgs:
    def __init__(__self__, *, workflow_arn: pulumi.Input[_builtins.str], on_failure: Optional[pulumi.Input[_builtins.str]] = ..., parallel_group: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ImagePipelineWorkflowParameterArgs]]]] = ...) -> None:
    ...
    @workflow_arn.setter
    def workflow_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def parallel_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ImagePipelineWorkflowParameterArgs]]]]): # -> None:
        ...
...
class ImageRecipeBlockDeviceMappingArgs:
    def __init__(__self__, *, device_name: Optional[pulumi.Input[_builtins.str]] = ..., ebs: Optional[pulumi.Input[ImageRecipeBlockDeviceMappingEbsArgs]] = ..., no_device: Optional[pulumi.Input[_builtins.bool]] = ..., virtual_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ebs.setter
    def ebs(self, value: Optional[pulumi.Input[ImageRecipeBlockDeviceMappingEbsArgs]]): # -> None:
        ...
...
class ImageRecipeComponentArgs:
    def __init__(__self__, *, component_arn: pulumi.Input[_builtins.str], parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ImageRecipeComponentParameterArgs]]]] = ...) -> None:
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ImageRecipeComponentParameterArgs]]]]): # -> None:
        ...
...
class ImageRecipeSystemsManagerAgentArgs:
    def __init__(__self__, *, uninstall_after_build: pulumi.Input[_builtins.bool]) -> None:
    ...
    def uninstall_after_build(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class ImageWorkflowArgs:
    def __init__(__self__, *, workflow_arn: pulumi.Input[_builtins.str], on_failure: Optional[pulumi.Input[_builtins.str]] = ..., parallel_group: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ImageWorkflowParameterArgs]]]] = ...) -> None:
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ImageWorkflowParameterArgs]]]]): # -> None:
        ...
...
class InfrastructureConfigurationInstanceMetadataOptionsArgs:
    def __init__(__self__, *, http_put_response_hop_limit: Optional[pulumi.Input[_builtins.int]] = ..., http_tokens: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InfrastructureConfigurationLoggingArgs:
    def __init__(__self__, *, s3_logs: pulumi.Input[InfrastructureConfigurationLoggingS3LogsArgs]) -> None:
    ...
    @s3_logs.setter
    def s3_logs(self, value: pulumi.Input[InfrastructureConfigurationLoggingS3LogsArgs]): # -> None:
        ...
...
class InfrastructureConfigurationLoggingS3LogsArgs:
    def __init__(__self__, *, s3_bucket_name: pulumi.Input[_builtins.str], s3_key_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InfrastructureConfigurationPlacementArgs:
    def __init__(__self__, *, availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., host_id: Optional[pulumi.Input[_builtins.str]] = ..., host_resource_group_arn: Optional[pulumi.Input[_builtins.str]] = ..., tenancy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LifecyclePolicyPolicyDetailArgs:
    def __init__(__self__, *, action: pulumi.Input[LifecyclePolicyPolicyDetailActionArgs], filter: pulumi.Input[LifecyclePolicyPolicyDetailFilterArgs], exclusion_rules: Optional[pulumi.Input[LifecyclePolicyPolicyDetailExclusionRulesArgs]] = ...) -> None:
    ...
    @action.setter
    def action(self, value: pulumi.Input[LifecyclePolicyPolicyDetailActionArgs]): # -> None:
        ...
    ...
    @filter.setter
    def filter(self, value: pulumi.Input[LifecyclePolicyPolicyDetailFilterArgs]): # -> None:
        ...
    ...
    def exclusion_rules(self, value: Optional[pulumi.Input[LifecyclePolicyPolicyDetailExclusionRulesArgs]]): # -> None:
        ...
...
class LifecyclePolicyPolicyDetailActionArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], include_resources: Optional[pulumi.Input[LifecyclePolicyPolicyDetailActionIncludeResourcesArgs]] = ...) -> None:
    ...
    def include_resources(self, value: Optional[pulumi.Input[LifecyclePolicyPolicyDetailActionIncludeResourcesArgs]]): # -> None:
        ...
...
class LifecyclePolicyPolicyDetailActionIncludeResourcesArgs:
    def __init__(__self__, *, amis: Optional[pulumi.Input[_builtins.bool]] = ..., containers: Optional[pulumi.Input[_builtins.bool]] = ..., snapshots: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @amis.setter
    def amis(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @containers.setter
    def containers(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @snapshots.setter
    def snapshots(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class LifecyclePolicyPolicyDetailExclusionRulesArgs:
    def __init__(__self__, *, amis: Optional[pulumi.Input[LifecyclePolicyPolicyDetailExclusionRulesAmisArgs]] = ..., tag_map: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @amis.setter
    def amis(self, value: Optional[pulumi.Input[LifecyclePolicyPolicyDetailExclusionRulesAmisArgs]]): # -> None:
        ...
    ...
    @tag_map.setter
    def tag_map(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class LifecyclePolicyPolicyDetailExclusionRulesAmisArgs:
    def __init__(__self__, *, is_public: Optional[pulumi.Input[_builtins.bool]] = ..., last_launched: Optional[pulumi.Input[LifecyclePolicyPolicyDetailExclusionRulesAmisLastLaunchedArgs]] = ..., regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., shared_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tag_map: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @is_public.setter
    def is_public(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def last_launched(self, value: Optional[pulumi.Input[LifecyclePolicyPolicyDetailExclusionRulesAmisLastLaunchedArgs]]): # -> None:
        ...
...
class LifecyclePolicyPolicyDetailFilterArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.int], retain_at_least: Optional[pulumi.Input[_builtins.int]] = ..., unit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def retain_at_least(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class LifecyclePolicyResourceSelectionArgs:
    def __init__(__self__, *, recipes: Optional[pulumi.Input[Sequence[pulumi.Input[LifecyclePolicyResourceSelectionRecipeArgs]]]] = ..., tag_map: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @recipes.setter
    def recipes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LifecyclePolicyResourceSelectionRecipeArgs]]]]): # -> None:
        ...
...
class LifecyclePolicyResourceSelectionRecipeArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], semantic_version: pulumi.Input[_builtins.str]) -> None:
    ...
    def semantic_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
