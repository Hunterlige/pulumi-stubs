...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ContainerRecipeComponent', 'ContainerRecipeComponentParameter', 'ContainerRecipeInstanceConfiguration', ..., ..., 'ContainerRecipeTargetRepository', 'DistributionConfigurationDistribution', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ImageImageScanningConfiguration', 'ImageImageScanningConfigurationEcrConfiguration', 'ImageImageTestsConfiguration', 'ImageLoggingConfiguration', 'ImageOutputResource', 'ImageOutputResourceAmi', 'ImageOutputResourceContainer', 'ImagePipelineImageScanningConfiguration', ..., 'ImagePipelineImageTestsConfiguration', 'ImagePipelineLoggingConfiguration', 'ImagePipelineSchedule', 'ImagePipelineWorkflow', 'ImagePipelineWorkflowParameter', 'ImageRecipeBlockDeviceMapping', 'ImageRecipeBlockDeviceMappingEbs', 'ImageRecipeComponent', 'ImageRecipeComponentParameter', 'ImageRecipeSystemsManagerAgent', 'ImageWorkflow', 'ImageWorkflowParameter', 'InfrastructureConfigurationInstanceMetadataOptions', 'InfrastructureConfigurationLogging', 'InfrastructureConfigurationLoggingS3Logs', 'InfrastructureConfigurationPlacement', 'LifecyclePolicyPolicyDetail', 'LifecyclePolicyPolicyDetailAction', 'LifecyclePolicyPolicyDetailActionIncludeResources', 'LifecyclePolicyPolicyDetailExclusionRules', 'LifecyclePolicyPolicyDetailExclusionRulesAmis', ..., 'LifecyclePolicyPolicyDetailFilter', 'LifecyclePolicyResourceSelection', 'LifecyclePolicyResourceSelectionRecipe', 'GetComponentsFilterResult', 'GetContainerRecipeComponentResult', 'GetContainerRecipeComponentParameterResult', 'GetContainerRecipeInstanceConfigurationResult', ..., ..., 'GetContainerRecipeTargetRepositoryResult', 'GetContainerRecipesFilterResult', 'GetDistributionConfigurationDistributionResult', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetDistributionConfigurationsFilterResult', 'GetImageImageScanningConfigurationResult', ..., 'GetImageImageTestsConfigurationResult', 'GetImageOutputResourceResult', 'GetImageOutputResourceAmiResult', 'GetImageOutputResourceContainerResult', 'GetImagePipelineImageScanningConfigurationResult', ..., 'GetImagePipelineImageTestsConfigurationResult', 'GetImagePipelineScheduleResult', 'GetImagePipelinesFilterResult', 'GetImageRecipeBlockDeviceMappingResult', 'GetImageRecipeBlockDeviceMappingEbResult', 'GetImageRecipeComponentResult', 'GetImageRecipeComponentParameterResult', 'GetImageRecipesFilterResult', ..., 'GetInfrastructureConfigurationLoggingResult', 'GetInfrastructureConfigurationLoggingS3LogResult', 'GetInfrastructureConfigurationPlacementResult', 'GetInfrastructureConfigurationsFilterResult']
@pulumi.output_type
class ContainerRecipeComponent(dict):
    ...
    def __init__(__self__, *, component_arn: _builtins.str, parameters: Optional[Sequence[outputs.ContainerRecipeComponentParameter]] = ...) -> None:
...
class ContainerRecipeInstanceConfiguration(dict):
    ...
    def __init__(__self__, *, block_device_mappings: Optional[Sequence[outputs.ContainerRecipeInstanceConfigurationBlockDeviceMapping]] = ..., image: Optional[_builtins.str] = ...) -> None:
...
class ContainerRecipeInstanceConfigurationBlockDeviceMapping(dict):
    ...
    def __init__(__self__, *, device_name: Optional[_builtins.str] = ..., ebs: Optional[outputs.ContainerRecipeInstanceConfigurationBlockDeviceMappingEbs] = ..., no_device: Optional[_builtins.bool] = ..., virtual_name: Optional[_builtins.str] = ...) -> None:
...
class ContainerRecipeInstanceConfigurationBlockDeviceMappingEbs(dict):
    ...
    def __init__(__self__, *, delete_on_termination: Optional[_builtins.str] = ..., encrypted: Optional[_builtins.str] = ..., iops: Optional[_builtins.int] = ..., kms_key_id: Optional[_builtins.str] = ..., snapshot_id: Optional[_builtins.str] = ..., throughput: Optional[_builtins.int] = ..., volume_size: Optional[_builtins.int] = ..., volume_type: Optional[_builtins.str] = ...) -> None:
...
class ContainerRecipeTargetRepository(dict):
    ...
    def __init__(__self__, *, repository_name: _builtins.str, service: _builtins.str) -> None:
...
class DistributionConfigurationDistribution(dict):
    ...
    def __init__(__self__, *, region: _builtins.str, ami_distribution_configuration: Optional[outputs.DistributionConfigurationDistributionAmiDistributionConfiguration] = ..., container_distribution_configuration: Optional[outputs.DistributionConfigurationDistributionContainerDistributionConfiguration] = ..., fast_launch_configurations: Optional[Sequence[outputs.DistributionConfigurationDistributionFastLaunchConfiguration]] = ..., launch_template_configurations: Optional[Sequence[outputs.DistributionConfigurationDistributionLaunchTemplateConfiguration]] = ..., license_configuration_arns: Optional[Sequence[_builtins.str]] = ..., s3_export_configuration: Optional[outputs.DistributionConfigurationDistributionS3ExportConfiguration] = ..., ssm_parameter_configurations: Optional[Sequence[outputs.DistributionConfigurationDistributionSsmParameterConfiguration]] = ...) -> None:
...
class DistributionConfigurationDistributionAmiDistributionConfiguration(dict):
    ...
    def __init__(__self__, *, ami_tags: Optional[Mapping[str, _builtins.str]] = ..., description: Optional[_builtins.str] = ..., kms_key_id: Optional[_builtins.str] = ..., launch_permission: Optional[outputs.DistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermission] = ..., name: Optional[_builtins.str] = ..., target_account_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermission(dict):
    ...
    def __init__(__self__, *, organization_arns: Optional[Sequence[_builtins.str]] = ..., organizational_unit_arns: Optional[Sequence[_builtins.str]] = ..., user_groups: Optional[Sequence[_builtins.str]] = ..., user_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DistributionConfigurationDistributionContainerDistributionConfiguration(dict):
    ...
    def __init__(__self__, *, target_repository: outputs.DistributionConfigurationDistributionContainerDistributionConfigurationTargetRepository, container_tags: Optional[Sequence[_builtins.str]] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class DistributionConfigurationDistributionFastLaunchConfiguration(dict):
    ...
    def __init__(__self__, *, account_id: _builtins.str, enabled: _builtins.bool, launch_template: Optional[outputs.DistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplate] = ..., max_parallel_launches: Optional[_builtins.int] = ..., snapshot_configuration: Optional[outputs.DistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfiguration] = ...) -> None:
...
class DistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplate(dict):
    ...
    def __init__(__self__, *, launch_template_id: Optional[_builtins.str] = ..., launch_template_name: Optional[_builtins.str] = ..., launch_template_version: Optional[_builtins.str] = ...) -> None:
...
class DistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfiguration(dict):
    ...
    def __init__(__self__, *, target_resource_count: Optional[_builtins.int] = ...) -> None:
...
class DistributionConfigurationDistributionLaunchTemplateConfiguration(dict):
    ...
    def __init__(__self__, *, launch_template_id: _builtins.str, account_id: Optional[_builtins.str] = ..., default: Optional[_builtins.bool] = ...) -> None:
...
class DistributionConfigurationDistributionS3ExportConfiguration(dict):
    ...
    def __init__(__self__, *, disk_image_format: _builtins.str, role_name: _builtins.str, s3_bucket: _builtins.str, s3_prefix: Optional[_builtins.str] = ...) -> None:
...
class DistributionConfigurationDistributionSsmParameterConfiguration(dict):
    ...
    def __init__(__self__, *, parameter_name: _builtins.str, ami_account_id: Optional[_builtins.str] = ..., data_type: Optional[_builtins.str] = ...) -> None:
...
class ImageImageScanningConfiguration(dict):
    ...
    def __init__(__self__, *, ecr_configuration: Optional[outputs.ImageImageScanningConfigurationEcrConfiguration] = ..., image_scanning_enabled: Optional[_builtins.bool] = ...) -> None:
...
class ImageImageScanningConfigurationEcrConfiguration(dict):
    ...
    def __init__(__self__, *, container_tags: Optional[Sequence[_builtins.str]] = ..., repository_name: Optional[_builtins.str] = ...) -> None:
...
class ImageImageTestsConfiguration(dict):
    ...
    def __init__(__self__, *, image_tests_enabled: Optional[_builtins.bool] = ..., timeout_minutes: Optional[_builtins.int] = ...) -> None:
...
class ImageOutputResource(dict):
    def __init__(__self__, *, amis: Optional[Sequence[outputs.ImageOutputResourceAmi]] = ..., containers: Optional[Sequence[outputs.ImageOutputResourceContainer]] = ...) -> None:
...
class ImageOutputResourceAmi(dict):
    ...
    def __init__(__self__, *, account_id: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., image: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ...) -> None:
...
class ImageOutputResourceContainer(dict):
    ...
    def __init__(__self__, *, image_uris: Optional[Sequence[_builtins.str]] = ..., region: Optional[_builtins.str] = ...) -> None:
...
class ImagePipelineImageScanningConfiguration(dict):
    ...
    def __init__(__self__, *, ecr_configuration: Optional[outputs.ImagePipelineImageScanningConfigurationEcrConfiguration] = ..., image_scanning_enabled: Optional[_builtins.bool] = ...) -> None:
...
class ImagePipelineLoggingConfiguration(dict):
    ...
    def __init__(__self__, *, image_log_group_name: Optional[_builtins.str] = ..., pipeline_log_group_name: Optional[_builtins.str] = ...) -> None:
...
class ImagePipelineSchedule(dict):
    ...
    def __init__(__self__, *, schedule_expression: _builtins.str, pipeline_execution_start_condition: Optional[_builtins.str] = ..., timezone: Optional[_builtins.str] = ...) -> None:
...
class ImagePipelineWorkflow(dict):
    ...
    def __init__(__self__, *, workflow_arn: _builtins.str, on_failure: Optional[_builtins.str] = ..., parallel_group: Optional[_builtins.str] = ..., parameters: Optional[Sequence[outputs.ImagePipelineWorkflowParameter]] = ...) -> None:
...
class ImageRecipeBlockDeviceMapping(dict):
    ...
    def __init__(__self__, *, device_name: Optional[_builtins.str] = ..., ebs: Optional[outputs.ImageRecipeBlockDeviceMappingEbs] = ..., no_device: Optional[_builtins.bool] = ..., virtual_name: Optional[_builtins.str] = ...) -> None:
...
class ImageRecipeComponent(dict):
    ...
    def __init__(__self__, *, component_arn: _builtins.str, parameters: Optional[Sequence[outputs.ImageRecipeComponentParameter]] = ...) -> None:
...
class ImageWorkflow(dict):
    ...
    def __init__(__self__, *, workflow_arn: _builtins.str, on_failure: Optional[_builtins.str] = ..., parallel_group: Optional[_builtins.str] = ..., parameters: Optional[Sequence[outputs.ImageWorkflowParameter]] = ...) -> None:
...
class InfrastructureConfigurationInstanceMetadataOptions(dict):
    ...
    def __init__(__self__, *, http_put_response_hop_limit: Optional[_builtins.int] = ..., http_tokens: Optional[_builtins.str] = ...) -> None:
...
class InfrastructureConfigurationLogging(dict):
    ...
    def __init__(__self__, *, s3_logs: outputs.InfrastructureConfigurationLoggingS3Logs) -> None:
...
class InfrastructureConfigurationLoggingS3Logs(dict):
    ...
    def __init__(__self__, *, s3_bucket_name: _builtins.str, s3_key_prefix: Optional[_builtins.str] = ...) -> None:
...
class InfrastructureConfigurationPlacement(dict):
    ...
    def __init__(__self__, *, availability_zone: Optional[_builtins.str] = ..., host_id: Optional[_builtins.str] = ..., host_resource_group_arn: Optional[_builtins.str] = ..., tenancy: Optional[_builtins.str] = ...) -> None:
...
class LifecyclePolicyPolicyDetail(dict):
    ...
    def __init__(__self__, *, action: outputs.LifecyclePolicyPolicyDetailAction, filter: outputs.LifecyclePolicyPolicyDetailFilter, exclusion_rules: Optional[outputs.LifecyclePolicyPolicyDetailExclusionRules] = ...) -> None:
    ...
    def exclusion_rules(self) -> Optional[outputs.LifecyclePolicyPolicyDetailExclusionRules]:
...
class LifecyclePolicyPolicyDetailAction(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, include_resources: Optional[outputs.LifecyclePolicyPolicyDetailActionIncludeResources] = ...) -> None:
    ...
    def include_resources(self) -> Optional[outputs.LifecyclePolicyPolicyDetailActionIncludeResources]:
...
class LifecyclePolicyPolicyDetailActionIncludeResources(dict):
    def __init__(__self__, *, amis: Optional[_builtins.bool] = ..., containers: Optional[_builtins.bool] = ..., snapshots: Optional[_builtins.bool] = ...) -> None:
...
class LifecyclePolicyPolicyDetailExclusionRules(dict):
    ...
    def __init__(__self__, *, amis: Optional[outputs.LifecyclePolicyPolicyDetailExclusionRulesAmis] = ..., tag_map: Optional[Mapping[str, _builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def amis(self) -> Optional[outputs.LifecyclePolicyPolicyDetailExclusionRulesAmis]:
...
class LifecyclePolicyPolicyDetailExclusionRulesAmis(dict):
    ...
    def __init__(__self__, *, is_public: Optional[_builtins.bool] = ..., last_launched: Optional[outputs.LifecyclePolicyPolicyDetailExclusionRulesAmisLastLaunched] = ..., regions: Optional[Sequence[_builtins.str]] = ..., shared_accounts: Optional[Sequence[_builtins.str]] = ..., tag_map: Optional[Mapping[str, _builtins.str]] = ...) -> None:
    ...
    def last_launched(self) -> Optional[outputs.LifecyclePolicyPolicyDetailExclusionRulesAmisLastLaunched]:
...
class LifecyclePolicyPolicyDetailFilter(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, value: _builtins.int, retain_at_least: Optional[_builtins.int] = ..., unit: Optional[_builtins.str] = ...) -> None:
...
class LifecyclePolicyResourceSelection(dict):
    ...
    def __init__(__self__, *, recipes: Optional[Sequence[outputs.LifecyclePolicyResourceSelectionRecipe]] = ..., tag_map: Optional[Mapping[str, _builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def recipes(self) -> Optional[Sequence[outputs.LifecyclePolicyResourceSelectionRecipe]]:
...
class LifecyclePolicyResourceSelectionRecipe(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, semantic_version: _builtins.str) -> None:
...
class GetContainerRecipeComponentResult(dict):
    def __init__(__self__, *, component_arn: _builtins.str, parameters: Sequence[outputs.GetContainerRecipeComponentParameterResult]) -> None:
...
class GetContainerRecipeInstanceConfigurationResult(dict):
    def __init__(__self__, *, block_device_mappings: Sequence[outputs.GetContainerRecipeInstanceConfigurationBlockDeviceMappingResult], image: _builtins.str) -> None:
...
class GetContainerRecipeInstanceConfigurationBlockDeviceMappingResult(dict):
    def __init__(__self__, *, device_name: _builtins.str, ebs: Sequence[outputs.GetContainerRecipeInstanceConfigurationBlockDeviceMappingEbResult], no_device: _builtins.str, virtual_name: _builtins.str) -> None:
...
class GetContainerRecipeInstanceConfigurationBlockDeviceMappingEbResult(dict):
    def __init__(__self__, *, delete_on_termination: _builtins.bool, encrypted: _builtins.bool, iops: _builtins.int, kms_key_id: _builtins.str, snapshot_id: _builtins.str, throughput: _builtins.int, volume_size: _builtins.int, volume_type: _builtins.str) -> None:
...
class GetDistributionConfigurationDistributionResult(dict):
    def __init__(__self__, *, ami_distribution_configurations: Sequence[outputs.GetDistributionConfigurationDistributionAmiDistributionConfigurationResult], container_distribution_configurations: Sequence[outputs.GetDistributionConfigurationDistributionContainerDistributionConfigurationResult], fast_launch_configurations: Sequence[outputs.GetDistributionConfigurationDistributionFastLaunchConfigurationResult], launch_template_configurations: Sequence[outputs.GetDistributionConfigurationDistributionLaunchTemplateConfigurationResult], license_configuration_arns: Sequence[_builtins.str], region: _builtins.str, s3_export_configurations: Sequence[outputs.GetDistributionConfigurationDistributionS3ExportConfigurationResult], ssm_parameter_configurations: Sequence[outputs.GetDistributionConfigurationDistributionSsmParameterConfigurationResult]) -> None:
...
class GetDistributionConfigurationDistributionAmiDistributionConfigurationResult(dict):
    def __init__(__self__, *, ami_tags: Mapping[str, _builtins.str], description: _builtins.str, kms_key_id: _builtins.str, launch_permissions: Sequence[outputs.GetDistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermissionResult], name: _builtins.str, target_account_ids: Sequence[_builtins.str]) -> None:
...
class GetDistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermissionResult(dict):
    def __init__(__self__, *, organization_arns: Sequence[_builtins.str], organizational_unit_arns: Sequence[_builtins.str], user_groups: Sequence[_builtins.str], user_ids: Sequence[_builtins.str]) -> None:
...
class GetDistributionConfigurationDistributionContainerDistributionConfigurationResult(dict):
    def __init__(__self__, *, container_tags: Sequence[_builtins.str], description: _builtins.str, target_repositories: Sequence[outputs.GetDistributionConfigurationDistributionContainerDistributionConfigurationTargetRepositoryResult]) -> None:
...
class GetDistributionConfigurationDistributionFastLaunchConfigurationResult(dict):
    def __init__(__self__, *, account_id: _builtins.str, enabled: _builtins.bool, launch_templates: Sequence[outputs.GetDistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplateResult], max_parallel_launches: _builtins.int, snapshot_configurations: Sequence[outputs.GetDistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfigurationResult]) -> None:
...
class GetDistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplateResult(dict):
    def __init__(__self__, *, launch_template_id: _builtins.str, launch_template_name: _builtins.str, launch_template_version: _builtins.str) -> None:
...
class GetDistributionConfigurationDistributionLaunchTemplateConfigurationResult(dict):
    def __init__(__self__, *, account_id: _builtins.str, default: _builtins.bool, launch_template_id: _builtins.str) -> None:
...
class GetDistributionConfigurationDistributionS3ExportConfigurationResult(dict):
    def __init__(__self__, *, disk_image_format: _builtins.str, role_name: _builtins.str, s3_bucket: _builtins.str, s3_prefix: _builtins.str) -> None:
...
class GetDistributionConfigurationDistributionSsmParameterConfigurationResult(dict):
    def __init__(__self__, *, ami_account_id: _builtins.str, data_type: _builtins.str, parameter_name: _builtins.str) -> None:
...
class GetImageImageScanningConfigurationResult(dict):
    def __init__(__self__, *, ecr_configurations: Sequence[outputs.GetImageImageScanningConfigurationEcrConfigurationResult], image_scanning_enabled: _builtins.bool) -> None:
...
class GetImageImageScanningConfigurationEcrConfigurationResult(dict):
    def __init__(__self__, *, container_tags: Sequence[_builtins.str], repository_name: _builtins.str) -> None:
...
class GetImageImageTestsConfigurationResult(dict):
    def __init__(__self__, *, image_tests_enabled: _builtins.bool, timeout_minutes: _builtins.int) -> None:
...
class GetImageOutputResourceResult(dict):
    def __init__(__self__, *, amis: Sequence[outputs.GetImageOutputResourceAmiResult], containers: Sequence[outputs.GetImageOutputResourceContainerResult]) -> None:
...
class GetImageOutputResourceAmiResult(dict):
    def __init__(__self__, *, account_id: _builtins.str, description: _builtins.str, image: _builtins.str, name: _builtins.str, region: _builtins.str) -> None:
...
class GetImageOutputResourceContainerResult(dict):
    def __init__(__self__, *, image_uris: Sequence[_builtins.str], region: _builtins.str) -> None:
...
class GetImagePipelineImageScanningConfigurationResult(dict):
    def __init__(__self__, *, ecr_configurations: Sequence[outputs.GetImagePipelineImageScanningConfigurationEcrConfigurationResult], image_scanning_enabled: _builtins.bool) -> None:
...
class GetImagePipelineScheduleResult(dict):
    def __init__(__self__, *, pipeline_execution_start_condition: _builtins.str, schedule_expression: _builtins.str) -> None:
...
class GetImageRecipeBlockDeviceMappingResult(dict):
    def __init__(__self__, *, device_name: _builtins.str, ebs: Sequence[outputs.GetImageRecipeBlockDeviceMappingEbResult], no_device: _builtins.str, virtual_name: _builtins.str) -> None:
...
class GetImageRecipeBlockDeviceMappingEbResult(dict):
    def __init__(__self__, *, delete_on_termination: _builtins.str, encrypted: _builtins.str, iops: _builtins.int, kms_key_id: _builtins.str, snapshot_id: _builtins.str, throughput: _builtins.int, volume_size: _builtins.int, volume_type: _builtins.str) -> None:
...
class GetImageRecipeComponentResult(dict):
    def __init__(__self__, *, component_arn: _builtins.str, parameters: Sequence[outputs.GetImageRecipeComponentParameterResult]) -> None:
...
class GetInfrastructureConfigurationInstanceMetadataOptionResult(dict):
    def __init__(__self__, *, http_put_response_hop_limit: _builtins.int, http_tokens: _builtins.str) -> None:
...
class GetInfrastructureConfigurationLoggingResult(dict):
    def __init__(__self__, *, s3_logs: Sequence[outputs.GetInfrastructureConfigurationLoggingS3LogResult]) -> None:
...
class GetInfrastructureConfigurationLoggingS3LogResult(dict):
    def __init__(__self__, *, s3_bucket_name: _builtins.str, s3_key_prefix: _builtins.str) -> None:
...
class GetInfrastructureConfigurationPlacementResult(dict):
    def __init__(__self__, *, availability_zone: _builtins.str, host_id: _builtins.str, host_resource_group_arn: _builtins.str, tenancy: _builtins.str) -> None:
