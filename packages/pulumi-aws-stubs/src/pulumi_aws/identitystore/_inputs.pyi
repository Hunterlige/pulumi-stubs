...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GroupExternalIdArgs', 'GroupExternalIdArgsDict', 'UserAddressesArgs', 'UserAddressesArgsDict', 'UserEmailsArgs', 'UserEmailsArgsDict', 'UserExternalIdArgs', 'UserExternalIdArgsDict', 'UserNameArgs', 'UserNameArgsDict', 'UserPhoneNumbersArgs', 'UserPhoneNumbersArgsDict', 'GetGroupAlternateIdentifierArgs', 'GetGroupAlternateIdentifierArgsDict', 'GetGroupAlternateIdentifierExternalIdArgs', 'GetGroupAlternateIdentifierExternalIdArgsDict', 'GetGroupAlternateIdentifierUniqueAttributeArgs', 'GetGroupAlternateIdentifierUniqueAttributeArgsDict', 'GetUserAlternateIdentifierArgs', 'GetUserAlternateIdentifierArgsDict', 'GetUserAlternateIdentifierExternalIdArgs', 'GetUserAlternateIdentifierExternalIdArgsDict', 'GetUserAlternateIdentifierUniqueAttributeArgs', 'GetUserAlternateIdentifierUniqueAttributeArgsDict']
...
class GroupExternalIdArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., issuer: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class UserAddressesArgs:
    def __init__(__self__, *, country: Optional[pulumi.Input[_builtins.str]] = ..., formatted: Optional[pulumi.Input[_builtins.str]] = ..., locality: Optional[pulumi.Input[_builtins.str]] = ..., postal_code: Optional[pulumi.Input[_builtins.str]] = ..., primary: Optional[pulumi.Input[_builtins.bool]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., street_address: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @formatted.setter
    def formatted(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class UserEmailsArgs:
    def __init__(__self__, *, primary: Optional[pulumi.Input[_builtins.bool]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class UserNameArgs:
    def __init__(__self__, *, family_name: pulumi.Input[_builtins.str], given_name: pulumi.Input[_builtins.str], formatted: Optional[pulumi.Input[_builtins.str]] = ..., honorific_prefix: Optional[pulumi.Input[_builtins.str]] = ..., honorific_suffix: Optional[pulumi.Input[_builtins.str]] = ..., middle_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @given_name.setter
    def given_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def honorific_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def honorific_suffix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GetGroupAlternateIdentifierArgs:
    def __init__(__self__, *, external_id: Optional[GetGroupAlternateIdentifierExternalIdArgs] = ..., unique_attribute: Optional[GetGroupAlternateIdentifierUniqueAttributeArgs] = ...) -> None:
    ...
    @external_id.setter
    def external_id(self, value: Optional[GetGroupAlternateIdentifierExternalIdArgs]): # -> None:
        ...
    ...
    def unique_attribute(self, value: Optional[GetGroupAlternateIdentifierUniqueAttributeArgs]): # -> None:
        ...
...
class GetGroupAlternateIdentifierUniqueAttributeArgs:
    ...
    def attribute_path(self, value: _builtins.str): # -> None:
        ...
...
class GetUserAlternateIdentifierArgs:
    def __init__(__self__, *, external_id: Optional[GetUserAlternateIdentifierExternalIdArgs] = ..., unique_attribute: Optional[GetUserAlternateIdentifierUniqueAttributeArgs] = ...) -> None:
    ...
    @external_id.setter
    def external_id(self, value: Optional[GetUserAlternateIdentifierExternalIdArgs]): # -> None:
        ...
    ...
    @unique_attribute.setter
    def unique_attribute(self, value: Optional[GetUserAlternateIdentifierUniqueAttributeArgs]): # -> None:
        ...
