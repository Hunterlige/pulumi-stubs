...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CustomKeyStoreXksProxyAuthenticationCredential', 'GrantConstraint', 'GetKeyMultiRegionConfigurationResult', 'GetKeyMultiRegionConfigurationPrimaryKeyResult', 'GetKeyMultiRegionConfigurationReplicaKeyResult', 'GetKeyXksKeyConfigurationResult', 'GetSecretSecretResult', 'GetSecretsSecretResult']
@pulumi.output_type
class CustomKeyStoreXksProxyAuthenticationCredential(dict):
    ...
    def __init__(__self__, *, access_key_id: _builtins.str, raw_secret_access_key: _builtins.str) -> None:
...
class GrantConstraint(dict):
    ...
    def __init__(__self__, *, encryption_context_equals: Optional[Mapping[str, _builtins.str]] = ..., encryption_context_subset: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class GetKeyMultiRegionConfigurationResult(dict):
    def __init__(__self__, *, multi_region_key_type: _builtins.str, primary_keys: Sequence[outputs.GetKeyMultiRegionConfigurationPrimaryKeyResult], replica_keys: Sequence[outputs.GetKeyMultiRegionConfigurationReplicaKeyResult]) -> None:
