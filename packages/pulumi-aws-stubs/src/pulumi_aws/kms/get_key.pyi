...
class GetKeyResult:
    ...
    def __init__(__self__, arn=..., aws_account_id=..., cloud_hsm_cluster_id=..., creation_date=..., custom_key_store_id=..., customer_master_key_spec=..., deletion_date=..., description=..., enabled=..., expiration_model=..., grant_tokens=..., id=..., key_id=..., key_manager=..., key_spec=..., key_state=..., key_usage=..., multi_region=..., multi_region_configurations=..., origin=..., pending_deletion_window_in_days=..., region=..., valid_to=..., xks_key_configurations=...) -> None:
        ...
...
def get_key(grant_tokens: Optional[Sequence[_builtins.str]] = ..., key_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetKeyResult:
    
    ...

def get_key_output(grant_tokens: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = ..., key_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetKeyResult]:
