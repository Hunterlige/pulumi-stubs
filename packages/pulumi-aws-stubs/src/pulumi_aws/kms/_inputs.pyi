...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CustomKeyStoreXksProxyAuthenticationCredentialArgs', ..., 'GrantConstraintArgs', 'GrantConstraintArgsDict', 'GetSecretSecretArgs', 'GetSecretSecretArgsDict', 'GetSecretsSecretArgs', 'GetSecretsSecretArgsDict']
...
class CustomKeyStoreXksProxyAuthenticationCredentialArgs:
    def __init__(__self__, *, access_key_id: pulumi.Input[_builtins.str], raw_secret_access_key: pulumi.Input[_builtins.str]) -> None:
    ...
    def raw_secret_access_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class GrantConstraintArgs:
    def __init__(__self__, *, encryption_context_equals: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., encryption_context_subset: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def encryption_context_equals(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def encryption_context_subset(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class GetSecretSecretArgs:
    def __init__(__self__, *, name: _builtins.str, payload: _builtins.str, context: Optional[Mapping[str, _builtins.str]] = ..., grant_tokens: Optional[Sequence[_builtins.str]] = ...) -> None:
        ...
    ...
    @payload.setter
    def payload(self, value: _builtins.str): # -> None:
        ...
    ...
    @context.setter
    def context(self, value: Optional[Mapping[str, _builtins.str]]): # -> None:
        ...
    ...
    @grant_tokens.setter
    def grant_tokens(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
...
class GetSecretsSecretArgs:
    def __init__(__self__, *, name: _builtins.str, payload: _builtins.str, context: Optional[Mapping[str, _builtins.str]] = ..., encryption_algorithm: Optional[_builtins.str] = ..., grant_tokens: Optional[Sequence[_builtins.str]] = ..., key_id: Optional[_builtins.str] = ...) -> None:
    ...
    def encryption_algorithm(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    @key_id.setter
    def key_id(self, value: Optional[_builtins.str]): # -> None:
        ...
