...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AssociationOutputLocationArgs', 'AssociationOutputLocationArgsDict', 'AssociationTargetArgs', 'AssociationTargetArgsDict', 'ContactsRotationRecurrenceArgs', 'ContactsRotationRecurrenceArgsDict', 'ContactsRotationRecurrenceDailySettingArgs', 'ContactsRotationRecurrenceDailySettingArgsDict', 'ContactsRotationRecurrenceMonthlySettingArgs', 'ContactsRotationRecurrenceMonthlySettingArgsDict', ..., ..., 'ContactsRotationRecurrenceShiftCoverageArgs', 'ContactsRotationRecurrenceShiftCoverageArgsDict', ..., ..., ..., ..., ..., ..., 'ContactsRotationRecurrenceWeeklySettingArgs', 'ContactsRotationRecurrenceWeeklySettingArgsDict', ..., ..., 'DocumentAttachmentsSourceArgs', 'DocumentAttachmentsSourceArgsDict', 'DocumentParameterArgs', 'DocumentParameterArgsDict', 'MaintenanceWindowTargetTargetArgs', 'MaintenanceWindowTargetTargetArgsDict', 'MaintenanceWindowTaskTargetArgs', 'MaintenanceWindowTaskTargetArgsDict', 'MaintenanceWindowTaskTaskInvocationParametersArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'PatchBaselineApprovalRuleArgs', 'PatchBaselineApprovalRuleArgsDict', 'PatchBaselineApprovalRulePatchFilterArgs', 'PatchBaselineApprovalRulePatchFilterArgsDict', 'PatchBaselineGlobalFilterArgs', 'PatchBaselineGlobalFilterArgsDict', 'PatchBaselineSourceArgs', 'PatchBaselineSourceArgsDict', ..., ..., 'QuicksetupConfigurationManagerStatusSummaryArgs', ..., 'QuicksetupConfigurationManagerTimeoutsArgs', 'QuicksetupConfigurationManagerTimeoutsArgsDict', 'ResourceDataSyncS3DestinationArgs', 'ResourceDataSyncS3DestinationArgsDict', 'GetInstancesFilterArgs', 'GetInstancesFilterArgsDict', 'GetMaintenanceWindowsFilterArgs', 'GetMaintenanceWindowsFilterArgsDict', 'GetPatchBaselinesFilterArgs', 'GetPatchBaselinesFilterArgsDict']
...
class AssociationOutputLocationArgs:
    def __init__(__self__, *, s3_bucket_name: pulumi.Input[_builtins.str], s3_key_prefix: Optional[pulumi.Input[_builtins.str]] = ..., s3_region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @s3_region.setter
    def s3_region(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ContactsRotationRecurrenceArgs:
    def __init__(__self__, *, number_of_on_calls: pulumi.Input[_builtins.int], recurrence_multiplier: pulumi.Input[_builtins.int], daily_settings: Optional[pulumi.Input[Sequence[pulumi.Input[ContactsRotationRecurrenceDailySettingArgs]]]] = ..., monthly_settings: Optional[pulumi.Input[Sequence[pulumi.Input[ContactsRotationRecurrenceMonthlySettingArgs]]]] = ..., shift_coverages: Optional[pulumi.Input[Sequence[pulumi.Input[ContactsRotationRecurrenceShiftCoverageArgs]]]] = ..., weekly_settings: Optional[pulumi.Input[Sequence[pulumi.Input[ContactsRotationRecurrenceWeeklySettingArgs]]]] = ...) -> None:
    ...
    def number_of_on_calls(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def recurrence_multiplier(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def daily_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ContactsRotationRecurrenceDailySettingArgs]]]]): # -> None:
        ...
    ...
    def monthly_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ContactsRotationRecurrenceMonthlySettingArgs]]]]): # -> None:
        ...
    ...
    def shift_coverages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ContactsRotationRecurrenceShiftCoverageArgs]]]]): # -> None:
        ...
    ...
    def weekly_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ContactsRotationRecurrenceWeeklySettingArgs]]]]): # -> None:
        ...
...
class ContactsRotationRecurrenceDailySettingArgs:
    def __init__(__self__, *, hour_of_day: pulumi.Input[_builtins.int], minute_of_hour: pulumi.Input[_builtins.int]) -> None:
    ...
    def minute_of_hour(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ContactsRotationRecurrenceMonthlySettingArgs:
    def __init__(__self__, *, day_of_month: pulumi.Input[_builtins.int], hand_off_time: Optional[pulumi.Input[ContactsRotationRecurrenceMonthlySettingHandOffTimeArgs]] = ...) -> None:
    ...
    def hand_off_time(self, value: Optional[pulumi.Input[ContactsRotationRecurrenceMonthlySettingHandOffTimeArgs]]): # -> None:
        ...
...
class ContactsRotationRecurrenceShiftCoverageArgs:
    def __init__(__self__, *, coverage_times: pulumi.Input[Sequence[pulumi.Input[ContactsRotationRecurrenceShiftCoverageCoverageTimeArgs]]], map_block_key: pulumi.Input[_builtins.str]) -> None:
    ...
    def coverage_times(self, value: pulumi.Input[Sequence[pulumi.Input[ContactsRotationRecurrenceShiftCoverageCoverageTimeArgs]]]): # -> None:
        ...
...
class ContactsRotationRecurrenceShiftCoverageCoverageTimeArgs:
    def __init__(__self__, *, end: Optional[pulumi.Input[ContactsRotationRecurrenceShiftCoverageCoverageTimeEndArgs]] = ..., start: Optional[pulumi.Input[ContactsRotationRecurrenceShiftCoverageCoverageTimeStartArgs]] = ...) -> None:
    ...
    @end.setter
    def end(self, value: Optional[pulumi.Input[ContactsRotationRecurrenceShiftCoverageCoverageTimeEndArgs]]): # -> None:
        ...
    ...
    @start.setter
    def start(self, value: Optional[pulumi.Input[ContactsRotationRecurrenceShiftCoverageCoverageTimeStartArgs]]): # -> None:
        ...
...
class ContactsRotationRecurrenceWeeklySettingArgs:
    def __init__(__self__, *, day_of_week: pulumi.Input[_builtins.str], hand_off_time: Optional[pulumi.Input[ContactsRotationRecurrenceWeeklySettingHandOffTimeArgs]] = ...) -> None:
    ...
    @hand_off_time.setter
    def hand_off_time(self, value: Optional[pulumi.Input[ContactsRotationRecurrenceWeeklySettingHandOffTimeArgs]]): # -> None:
        ...
...
class DocumentAttachmentsSourceArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DocumentParameterArgs:
    def __init__(__self__, *, default_value: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MaintenanceWindowTaskTaskInvocationParametersArgs:
    def __init__(__self__, *, automation_parameters: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersAutomationParametersArgs]] = ..., lambda_parameters: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersLambdaParametersArgs]] = ..., run_command_parameters: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersArgs]] = ..., step_functions_parameters: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersStepFunctionsParametersArgs]] = ...) -> None:
    ...
    def automation_parameters(self, value: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersAutomationParametersArgs]]): # -> None:
        ...
    ...
    def lambda_parameters(self, value: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersLambdaParametersArgs]]): # -> None:
        ...
    ...
    def run_command_parameters(self, value: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersArgs]]): # -> None:
        ...
    ...
    def step_functions_parameters(self, value: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersStepFunctionsParametersArgs]]): # -> None:
        ...
...
class MaintenanceWindowTaskTaskInvocationParametersAutomationParametersArgs:
    def __init__(__self__, *, document_version: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersAutomationParametersParameterArgs]]]] = ...) -> None:
    ...
    def document_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersAutomationParametersParameterArgs]]]]): # -> None:
        ...
...
class MaintenanceWindowTaskTaskInvocationParametersLambdaParametersArgs:
    def __init__(__self__, *, client_context: Optional[pulumi.Input[_builtins.str]] = ..., payload: Optional[pulumi.Input[_builtins.str]] = ..., qualifier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def client_context(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersArgs:
    def __init__(__self__, *, cloudwatch_config: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigArgs]] = ..., comment: Optional[pulumi.Input[_builtins.str]] = ..., document_hash: Optional[pulumi.Input[_builtins.str]] = ..., document_hash_type: Optional[pulumi.Input[_builtins.str]] = ..., document_version: Optional[pulumi.Input[_builtins.str]] = ..., notification_config: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersNotificationConfigArgs]] = ..., output_s3_bucket: Optional[pulumi.Input[_builtins.str]] = ..., output_s3_key_prefix: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameterArgs]]]] = ..., service_role_arn: Optional[pulumi.Input[_builtins.str]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def cloudwatch_config(self, value: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigArgs]]): # -> None:
        ...
    ...
    def document_hash(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def document_hash_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def notification_config(self, value: Optional[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersNotificationConfigArgs]]): # -> None:
        ...
    ...
    def output_s3_bucket(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def output_s3_key_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameterArgs]]]]): # -> None:
        ...
...
class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigArgs:
    def __init__(__self__, *, cloudwatch_log_group_name: Optional[pulumi.Input[_builtins.str]] = ..., cloudwatch_output_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def cloudwatch_log_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def cloudwatch_output_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersNotificationConfigArgs:
    def __init__(__self__, *, notification_arn: Optional[pulumi.Input[_builtins.str]] = ..., notification_events: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., notification_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def notification_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def notification_events(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class MaintenanceWindowTaskTaskInvocationParametersStepFunctionsParametersArgs:
    def __init__(__self__, *, input: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PatchBaselineApprovalRuleArgs:
    def __init__(__self__, *, patch_filters: pulumi.Input[Sequence[pulumi.Input[PatchBaselineApprovalRulePatchFilterArgs]]], approve_after_days: Optional[pulumi.Input[_builtins.int]] = ..., approve_until_date: Optional[pulumi.Input[_builtins.str]] = ..., compliance_level: Optional[pulumi.Input[_builtins.str]] = ..., enable_non_security: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def patch_filters(self, value: pulumi.Input[Sequence[pulumi.Input[PatchBaselineApprovalRulePatchFilterArgs]]]): # -> None:
        ...
    ...
    def approve_after_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def approve_until_date(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def compliance_level(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def enable_non_security(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class PatchBaselineSourceArgs:
    def __init__(__self__, *, configuration: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], products: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @products.setter
    def products(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class QuicksetupConfigurationManagerConfigurationDefinitionArgs:
    def __init__(__self__, *, parameters: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], type: pulumi.Input[_builtins.str], id: Optional[pulumi.Input[_builtins.str]] = ..., local_deployment_administration_role_arn: Optional[pulumi.Input[_builtins.str]] = ..., local_deployment_execution_role_name: Optional[pulumi.Input[_builtins.str]] = ..., type_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @parameters.setter
    def parameters(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def local_deployment_administration_role_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def local_deployment_execution_role_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @type_version.setter
    def type_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class QuicksetupConfigurationManagerStatusSummaryArgs:
    def __init__(__self__, *, status: pulumi.Input[_builtins.str], status_message: pulumi.Input[_builtins.str], status_type: pulumi.Input[_builtins.str]) -> None:
    ...
    @status_type.setter
    def status_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ResourceDataSyncS3DestinationArgs:
    def __init__(__self__, *, bucket_name: pulumi.Input[_builtins.str], region: pulumi.Input[_builtins.str], kms_key_arn: Optional[pulumi.Input[_builtins.str]] = ..., prefix: Optional[pulumi.Input[_builtins.str]] = ..., sync_format: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @sync_format.setter
    def sync_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
