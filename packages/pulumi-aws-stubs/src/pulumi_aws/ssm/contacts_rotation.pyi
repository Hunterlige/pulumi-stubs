...
class _ContactsRotationState:
    def __init__(
        ...
        *,
        ...
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        recurrence: Optional[pulumi.Input[ContactsRotationRecurrenceArgs]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        start_time: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tags_all: Optional[
    ...
    @recurrence.setter
    def recurrence(
        self, value: Optional[pulumi.Input[ContactsRotationRecurrenceArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def region(self) -> Optional[pulumi.Input[_builtins.str]]: ...
...
class ContactsRotation(pulumi.CustomResource):
    ...
    def __init__(
        ...
        recurrence: Optional[
            pulumi.Input[
                Union[
                    ContactsRotationRecurrenceArgs, ContactsRotationRecurrenceArgsDict
                ]
            ]
        ] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
