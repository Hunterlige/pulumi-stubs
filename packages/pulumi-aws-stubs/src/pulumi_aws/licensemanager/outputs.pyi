...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetLicenseGrantsFilterResult', 'GetReceivedLicenseConsumptionConfigurationResult', ..., ..., 'GetReceivedLicenseEntitlementResult', 'GetReceivedLicenseIssuerResult', 'GetReceivedLicenseLicenseMetadataResult', 'GetReceivedLicenseReceivedMetadataResult', 'GetReceivedLicenseValidityResult', 'GetReceivedLicensesFilterResult']
@pulumi.output_type
...
class GetReceivedLicenseConsumptionConfigurationResult(dict):
    def __init__(__self__, *, borrow_configurations: Sequence[outputs.GetReceivedLicenseConsumptionConfigurationBorrowConfigurationResult], provisional_configurations: Sequence[outputs.GetReceivedLicenseConsumptionConfigurationProvisionalConfigurationResult], renew_type: _builtins.str) -> None:
...
class GetReceivedLicenseConsumptionConfigurationBorrowConfigurationResult(dict):
    def __init__(__self__, *, allow_early_check_in: _builtins.bool, max_time_to_live_in_minutes: _builtins.int) -> None:
...
class GetReceivedLicenseEntitlementResult(dict):
    def __init__(__self__, *, allow_check_in: _builtins.bool, max_count: _builtins.int, name: _builtins.str, overage: _builtins.bool, unit: _builtins.str, value: _builtins.str) -> None:
...
class GetReceivedLicenseIssuerResult(dict):
    def __init__(__self__, *, key_fingerprint: _builtins.str, name: _builtins.str, sign_key: _builtins.str) -> None:
...
class GetReceivedLicenseReceivedMetadataResult(dict):
    def __init__(__self__, *, allowed_operations: Sequence[_builtins.str], received_status: _builtins.str, received_status_reason: _builtins.str) -> None:
