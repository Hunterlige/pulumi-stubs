...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ScalingPlanApplicationSourceArgs', 'ScalingPlanApplicationSourceArgsDict', 'ScalingPlanApplicationSourceTagFilterArgs', 'ScalingPlanApplicationSourceTagFilterArgsDict', 'ScalingPlanScalingInstructionArgs', 'ScalingPlanScalingInstructionArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ...]
class ScalingPlanApplicationSourceArgsDict(TypedDict):
    cloudformation_stack_arn: NotRequired[pulumi.Input[_builtins.str]]
    tag_filters: NotRequired[pulumi.Input[Sequence[pulumi.Input[ScalingPlanApplicationSourceTagFilterArgsDict]]]]


@pulumi.input_type
class ScalingPlanApplicationSourceArgs:
    def __init__(__self__, *, cloudformation_stack_arn: Optional[pulumi.Input[_builtins.str]] = ..., tag_filters: Optional[pulumi.Input[Sequence[pulumi.Input[ScalingPlanApplicationSourceTagFilterArgs]]]] = ...) -> None:
    ...
    def cloudformation_stack_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @tag_filters.setter
    def tag_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ScalingPlanApplicationSourceTagFilterArgs]]]]): # -> None:
        ...
...
class ScalingPlanApplicationSourceTagFilterArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], values: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ScalingPlanScalingInstructionArgsDict(TypedDict):
    ...
    target_tracking_configurations: pulumi.Input[Sequence[pulumi.Input[ScalingPlanScalingInstructionTargetTrackingConfigurationArgsDict]]]
    customized_load_metric_specification: NotRequired[pulumi.Input[ScalingPlanScalingInstructionCustomizedLoadMetricSpecificationArgsDict]]
    disable_dynamic_scaling: NotRequired[pulumi.Input[_builtins.bool]]
    predefined_load_metric_specification: NotRequired[pulumi.Input[ScalingPlanScalingInstructionPredefinedLoadMetricSpecificationArgsDict]]
...
class ScalingPlanScalingInstructionArgs:
    def __init__(__self__, *, max_capacity: pulumi.Input[_builtins.int], min_capacity: pulumi.Input[_builtins.int], resource_id: pulumi.Input[_builtins.str], scalable_dimension: pulumi.Input[_builtins.str], service_namespace: pulumi.Input[_builtins.str], target_tracking_configurations: pulumi.Input[Sequence[pulumi.Input[ScalingPlanScalingInstructionTargetTrackingConfigurationArgs]]], customized_load_metric_specification: Optional[pulumi.Input[ScalingPlanScalingInstructionCustomizedLoadMetricSpecificationArgs]] = ..., disable_dynamic_scaling: Optional[pulumi.Input[_builtins.bool]] = ..., predefined_load_metric_specification: Optional[pulumi.Input[ScalingPlanScalingInstructionPredefinedLoadMetricSpecificationArgs]] = ..., predictive_scaling_max_capacity_behavior: Optional[pulumi.Input[_builtins.str]] = ..., predictive_scaling_max_capacity_buffer: Optional[pulumi.Input[_builtins.int]] = ..., predictive_scaling_mode: Optional[pulumi.Input[_builtins.str]] = ..., scaling_policy_update_behavior: Optional[pulumi.Input[_builtins.str]] = ..., scheduled_action_buffer_time: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def target_tracking_configurations(self, value: pulumi.Input[Sequence[pulumi.Input[ScalingPlanScalingInstructionTargetTrackingConfigurationArgs]]]): # -> None:
        ...
    ...
    def customized_load_metric_specification(self, value: Optional[pulumi.Input[ScalingPlanScalingInstructionCustomizedLoadMetricSpecificationArgs]]): # -> None:
        ...
    ...
    def disable_dynamic_scaling(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def predefined_load_metric_specification(self, value: Optional[pulumi.Input[ScalingPlanScalingInstructionPredefinedLoadMetricSpecificationArgs]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="predictiveScalingMaxCapacityBehavior")
    def predictive_scaling_max_capacity_behavior(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @predictive_scaling_max_capacity_behavior.setter
    def predictive_scaling_max_capacity_behavior(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="predictiveScalingMaxCapacityBuffer")
    def predictive_scaling_max_capacity_buffer(self) -> Optional[pulumi.Input[_builtins.int]]:
        
        ...
    
    @predictive_scaling_max_capacity_buffer.setter
    def predictive_scaling_max_capacity_buffer(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def predictive_scaling_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="scalingPolicyUpdateBehavior")
    def scaling_policy_update_behavior(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @scaling_policy_update_behavior.setter
    def scaling_policy_update_behavior(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def scheduled_action_buffer_time(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ScalingPlanScalingInstructionCustomizedLoadMetricSpecificationArgs:
    def __init__(__self__, *, metric_name: pulumi.Input[_builtins.str], namespace: pulumi.Input[_builtins.str], statistic: pulumi.Input[_builtins.str], dimensions: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., unit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ScalingPlanScalingInstructionPredefinedLoadMetricSpecificationArgs:
    def __init__(__self__, *, predefined_load_metric_type: pulumi.Input[_builtins.str], resource_label: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def predefined_load_metric_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ScalingPlanScalingInstructionTargetTrackingConfigurationArgsDict(TypedDict):
    ...
    customized_scaling_metric_specification: NotRequired[pulumi.Input[ScalingPlanScalingInstructionTargetTrackingConfigurationCustomizedScalingMetricSpecificationArgsDict]]
    disable_scale_in: NotRequired[pulumi.Input[_builtins.bool]]
    estimated_instance_warmup: NotRequired[pulumi.Input[_builtins.int]]
    predefined_scaling_metric_specification: NotRequired[pulumi.Input[ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecificationArgsDict]]
...
class ScalingPlanScalingInstructionTargetTrackingConfigurationArgs:
    def __init__(__self__, *, target_value: pulumi.Input[_builtins.float], customized_scaling_metric_specification: Optional[pulumi.Input[ScalingPlanScalingInstructionTargetTrackingConfigurationCustomizedScalingMetricSpecificationArgs]] = ..., disable_scale_in: Optional[pulumi.Input[_builtins.bool]] = ..., estimated_instance_warmup: Optional[pulumi.Input[_builtins.int]] = ..., predefined_scaling_metric_specification: Optional[pulumi.Input[ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecificationArgs]] = ..., scale_in_cooldown: Optional[pulumi.Input[_builtins.int]] = ..., scale_out_cooldown: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def customized_scaling_metric_specification(self, value: Optional[pulumi.Input[ScalingPlanScalingInstructionTargetTrackingConfigurationCustomizedScalingMetricSpecificationArgs]]): # -> None:
        ...
    ...
    def predefined_scaling_metric_specification(self, value: Optional[pulumi.Input[ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecificationArgs]]): # -> None:
        ...
...
class ScalingPlanScalingInstructionTargetTrackingConfigurationCustomizedScalingMetricSpecificationArgsDict(TypedDict):
    metric_name: pulumi.Input[_builtins.str]
    namespace: pulumi.Input[_builtins.str]
    statistic: pulumi.Input[_builtins.str]
    dimensions: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]
...
class ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecificationArgsDict(TypedDict):
...
class ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecificationArgs:
    def __init__(__self__, *, predefined_scaling_metric_type: pulumi.Input[_builtins.str], resource_label: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def predefined_scaling_metric_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
