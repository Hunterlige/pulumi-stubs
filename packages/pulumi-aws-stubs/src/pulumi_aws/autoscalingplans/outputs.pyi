...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ScalingPlanApplicationSource', 'ScalingPlanApplicationSourceTagFilter', 'ScalingPlanScalingInstruction', ..., ..., ..., ..., ...]
@pulumi.output_type
class ScalingPlanApplicationSource(dict):
    ...
    def __init__(__self__, *, cloudformation_stack_arn: Optional[_builtins.str] = ..., tag_filters: Optional[Sequence[outputs.ScalingPlanApplicationSourceTagFilter]] = ...) -> None:
...
class ScalingPlanScalingInstruction(dict):
    ...
    def __init__(__self__, *, max_capacity: _builtins.int, min_capacity: _builtins.int, resource_id: _builtins.str, scalable_dimension: _builtins.str, service_namespace: _builtins.str, target_tracking_configurations: Sequence[outputs.ScalingPlanScalingInstructionTargetTrackingConfiguration], customized_load_metric_specification: Optional[outputs.ScalingPlanScalingInstructionCustomizedLoadMetricSpecification] = ..., disable_dynamic_scaling: Optional[_builtins.bool] = ..., predefined_load_metric_specification: Optional[outputs.ScalingPlanScalingInstructionPredefinedLoadMetricSpecification] = ..., predictive_scaling_max_capacity_behavior: Optional[_builtins.str] = ..., predictive_scaling_max_capacity_buffer: Optional[_builtins.int] = ..., predictive_scaling_mode: Optional[_builtins.str] = ..., scaling_policy_update_behavior: Optional[_builtins.str] = ..., scheduled_action_buffer_time: Optional[_builtins.int] = ...) -> None:
...
class ScalingPlanScalingInstructionCustomizedLoadMetricSpecification(dict):
    ...
    def __init__(__self__, *, metric_name: _builtins.str, namespace: _builtins.str, statistic: _builtins.str, dimensions: Optional[Mapping[str, _builtins.str]] = ..., unit: Optional[_builtins.str] = ...) -> None:
...
class ScalingPlanScalingInstructionPredefinedLoadMetricSpecification(dict):
    ...
    def __init__(__self__, *, predefined_load_metric_type: _builtins.str, resource_label: Optional[_builtins.str] = ...) -> None:
...
class ScalingPlanScalingInstructionTargetTrackingConfiguration(dict):
    ...
    def __init__(__self__, *, target_value: _builtins.float, customized_scaling_metric_specification: Optional[outputs.ScalingPlanScalingInstructionTargetTrackingConfigurationCustomizedScalingMetricSpecification] = ..., disable_scale_in: Optional[_builtins.bool] = ..., estimated_instance_warmup: Optional[_builtins.int] = ..., predefined_scaling_metric_specification: Optional[outputs.ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecification] = ..., scale_in_cooldown: Optional[_builtins.int] = ..., scale_out_cooldown: Optional[_builtins.int] = ...) -> None:
...
class ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecification(dict):
    ...
    def __init__(__self__, *, predefined_scaling_metric_type: _builtins.str, resource_label: Optional[_builtins.str] = ...) -> None:
