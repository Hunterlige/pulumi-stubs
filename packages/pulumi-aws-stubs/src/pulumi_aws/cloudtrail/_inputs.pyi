...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EventDataStoreAdvancedEventSelectorArgs', 'EventDataStoreAdvancedEventSelectorArgsDict', ..., ..., 'TrailAdvancedEventSelectorArgs', 'TrailAdvancedEventSelectorArgsDict', 'TrailAdvancedEventSelectorFieldSelectorArgs', 'TrailAdvancedEventSelectorFieldSelectorArgsDict', 'TrailEventSelectorArgs', 'TrailEventSelectorArgsDict', 'TrailEventSelectorDataResourceArgs', 'TrailEventSelectorDataResourceArgsDict', 'TrailInsightSelectorArgs', 'TrailInsightSelectorArgsDict']
...
class EventDataStoreAdvancedEventSelectorArgs:
    def __init__(__self__, *, field_selectors: Optional[pulumi.Input[Sequence[pulumi.Input[EventDataStoreAdvancedEventSelectorFieldSelectorArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def field_selectors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventDataStoreAdvancedEventSelectorFieldSelectorArgs]]]]): # -> None:
        ...
...
class EventDataStoreAdvancedEventSelectorFieldSelectorArgs:
    def __init__(__self__, *, ends_withs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., equals: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., field: Optional[pulumi.Input[_builtins.str]] = ..., not_ends_withs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., not_equals: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., not_starts_withs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., starts_withs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @ends_withs.setter
    def ends_withs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def not_ends_withs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def not_starts_withs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @starts_withs.setter
    def starts_withs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class TrailAdvancedEventSelectorArgs:
    def __init__(__self__, *, field_selectors: pulumi.Input[Sequence[pulumi.Input[TrailAdvancedEventSelectorFieldSelectorArgs]]], name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @field_selectors.setter
    def field_selectors(self, value: pulumi.Input[Sequence[pulumi.Input[TrailAdvancedEventSelectorFieldSelectorArgs]]]): # -> None:
        ...
...
class TrailAdvancedEventSelectorFieldSelectorArgs:
    def __init__(__self__, *, field: pulumi.Input[_builtins.str], ends_withs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., equals: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., not_ends_withs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., not_equals: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., not_starts_withs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., starts_withs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class TrailEventSelectorArgs:
    def __init__(__self__, *, data_resources: Optional[pulumi.Input[Sequence[pulumi.Input[TrailEventSelectorDataResourceArgs]]]] = ..., exclude_management_event_sources: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., include_management_events: Optional[pulumi.Input[_builtins.bool]] = ..., read_write_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def data_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TrailEventSelectorDataResourceArgs]]]]): # -> None:
        ...
    ...
    def exclude_management_event_sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def include_management_events(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def read_write_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TrailEventSelectorDataResourceArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
...
class TrailInsightSelectorArgs:
    ...
    @insight_type.setter
    def insight_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
