...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EventDataStoreAdvancedEventSelector', 'EventDataStoreAdvancedEventSelectorFieldSelector', 'TrailAdvancedEventSelector', 'TrailAdvancedEventSelectorFieldSelector', 'TrailEventSelector', 'TrailEventSelectorDataResource', 'TrailInsightSelector']
@pulumi.output_type
class EventDataStoreAdvancedEventSelector(dict):
    ...
    def __init__(__self__, *, field_selectors: Optional[Sequence[outputs.EventDataStoreAdvancedEventSelectorFieldSelector]] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class EventDataStoreAdvancedEventSelectorFieldSelector(dict):
    ...
    def __init__(__self__, *, ends_withs: Optional[Sequence[_builtins.str]] = ..., equals: Optional[Sequence[_builtins.str]] = ..., field: Optional[_builtins.str] = ..., not_ends_withs: Optional[Sequence[_builtins.str]] = ..., not_equals: Optional[Sequence[_builtins.str]] = ..., not_starts_withs: Optional[Sequence[_builtins.str]] = ..., starts_withs: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class TrailAdvancedEventSelector(dict):
    ...
    def __init__(__self__, *, field_selectors: Sequence[outputs.TrailAdvancedEventSelectorFieldSelector], name: Optional[_builtins.str] = ...) -> None:
...
class TrailAdvancedEventSelectorFieldSelector(dict):
    ...
    def __init__(__self__, *, field: _builtins.str, ends_withs: Optional[Sequence[_builtins.str]] = ..., equals: Optional[Sequence[_builtins.str]] = ..., not_ends_withs: Optional[Sequence[_builtins.str]] = ..., not_equals: Optional[Sequence[_builtins.str]] = ..., not_starts_withs: Optional[Sequence[_builtins.str]] = ..., starts_withs: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class TrailEventSelector(dict):
    ...
    def __init__(__self__, *, data_resources: Optional[Sequence[outputs.TrailEventSelectorDataResource]] = ..., exclude_management_event_sources: Optional[Sequence[_builtins.str]] = ..., include_management_events: Optional[_builtins.bool] = ..., read_write_type: Optional[_builtins.str] = ...) -> None:
