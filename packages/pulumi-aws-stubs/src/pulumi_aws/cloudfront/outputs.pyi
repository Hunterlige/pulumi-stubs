...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AnycastIpListTimeouts', ..., ..., ..., ..., ..., ..., ..., 'ConnectionFunctionConnectionFunctionConfig', ..., 'ConnectionGroupTimeouts', ..., 'ContinuousDeploymentPolicyTrafficConfig', ..., ..., ..., 'DistributionConnectionFunctionAssociation', 'DistributionCustomErrorResponse', 'DistributionDefaultCacheBehavior', 'DistributionDefaultCacheBehaviorForwardedValues', ..., ..., 'DistributionDefaultCacheBehaviorGrpcConfig', ..., 'DistributionLoggingConfig', 'DistributionOrderedCacheBehavior', 'DistributionOrderedCacheBehaviorForwardedValues', ..., ..., 'DistributionOrderedCacheBehaviorGrpcConfig', ..., 'DistributionOrigin', 'DistributionOriginCustomHeader', 'DistributionOriginCustomOriginConfig', 'DistributionOriginGroup', 'DistributionOriginGroupFailoverCriteria', 'DistributionOriginGroupMember', 'DistributionOriginOriginShield', 'DistributionOriginS3OriginConfig', 'DistributionOriginVpcOriginConfig', 'DistributionRestrictions', 'DistributionRestrictionsGeoRestriction', 'DistributionTenantCustomizations', 'DistributionTenantCustomizationsCertificate', 'DistributionTenantCustomizationsGeoRestriction', 'DistributionTenantCustomizationsWebAcl', 'DistributionTenantDomain', 'DistributionTenantManagedCertificateRequest', 'DistributionTenantParameter', 'DistributionTenantTimeouts', 'DistributionTrustedKeyGroup', 'DistributionTrustedKeyGroupItem', 'DistributionTrustedSigner', 'DistributionTrustedSignerItem', 'DistributionViewerCertificate', 'DistributionViewerMtlsConfig', 'DistributionViewerMtlsConfigTrustStoreConfig', 'FieldLevelEncryptionConfigContentTypeProfileConfig', ..., ..., 'FieldLevelEncryptionConfigQueryArgProfileConfig', ..., ..., 'FieldLevelEncryptionProfileEncryptionEntities', 'FieldLevelEncryptionProfileEncryptionEntitiesItem', ..., 'KeyValueStoreTimeouts', 'KeyvaluestoreKeysExclusiveResourceKeyValuePair', 'MonitoringSubscriptionMonitoringSubscription', ..., 'MultitenantDistributionActiveTrustedKeyGroup', 'MultitenantDistributionActiveTrustedKeyGroupItem', 'MultitenantDistributionCacheBehavior', 'MultitenantDistributionCacheBehaviorAllowedMethods', ..., ..., ..., 'MultitenantDistributionCustomErrorResponse', 'MultitenantDistributionDefaultCacheBehavior', ..., ..., ..., ..., 'MultitenantDistributionOrigin', 'MultitenantDistributionOriginCustomHeader', 'MultitenantDistributionOriginCustomOriginConfig', 'MultitenantDistributionOriginGroup', 'MultitenantDistributionOriginGroupFailoverCriteria', 'MultitenantDistributionOriginGroupMember', 'MultitenantDistributionOriginOriginShield', 'MultitenantDistributionOriginVpcOriginConfig', 'MultitenantDistributionRestrictions', 'MultitenantDistributionRestrictionsGeoRestriction', 'MultitenantDistributionTenantConfig', ..., ..., ..., 'MultitenantDistributionTimeouts', 'MultitenantDistributionViewerCertificate', 'OriginRequestPolicyCookiesConfig', 'OriginRequestPolicyCookiesConfigCookies', 'OriginRequestPolicyHeadersConfig', 'OriginRequestPolicyHeadersConfigHeaders', 'OriginRequestPolicyQueryStringsConfig', 'OriginRequestPolicyQueryStringsConfigQueryStrings', 'RealtimeLogConfigEndpoint', 'RealtimeLogConfigEndpointKinesisStreamConfig', 'ResponseHeadersPolicyCorsConfig', ..., ..., ..., ..., 'ResponseHeadersPolicyCustomHeadersConfig', 'ResponseHeadersPolicyCustomHeadersConfigItem', 'ResponseHeadersPolicyRemoveHeadersConfig', 'ResponseHeadersPolicyRemoveHeadersConfigItem', 'ResponseHeadersPolicySecurityHeadersConfig', ..., ..., ..., ..., ..., ..., 'ResponseHeadersPolicyServerTimingHeadersConfig', 'TrustStoreCaCertificatesBundleSource', ..., 'TrustStoreTimeouts', 'VpcOriginTimeouts', 'VpcOriginVpcOriginEndpointConfig', 'VpcOriginVpcOriginEndpointConfigOriginSslProtocols', ..., ..., ..., ..., ..., ..., ..., 'GetDistributionTenantCustomizationResult', ..., ..., 'GetDistributionTenantCustomizationWebAclResult', 'GetDistributionTenantDomainResult', ..., 'GetDistributionTenantParameterResult', 'GetOriginRequestPolicyCookiesConfigResult', 'GetOriginRequestPolicyCookiesConfigCookieResult', 'GetOriginRequestPolicyHeadersConfigResult', 'GetOriginRequestPolicyHeadersConfigHeaderResult', 'GetOriginRequestPolicyQueryStringsConfigResult', ..., 'GetRealtimeLogConfigEndpointResult', ..., 'GetResponseHeadersPolicyCorsConfigResult', ..., ..., ..., ..., 'GetResponseHeadersPolicyCustomHeadersConfigResult', ..., 'GetResponseHeadersPolicyRemoveHeadersConfigResult', ..., ..., ..., ..., ..., ..., ..., ..., ...]
@pulumi.output_type
...
class CachePolicyParametersInCacheKeyAndForwardedToOrigin(dict):
    ...
    def __init__(__self__, *, cookies_config: outputs.CachePolicyParametersInCacheKeyAndForwardedToOriginCookiesConfig, headers_config: outputs.CachePolicyParametersInCacheKeyAndForwardedToOriginHeadersConfig, query_strings_config: outputs.CachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfig, enable_accept_encoding_brotli: Optional[_builtins.bool] = ..., enable_accept_encoding_gzip: Optional[_builtins.bool] = ...) -> None:
...
class CachePolicyParametersInCacheKeyAndForwardedToOriginCookiesConfig(dict):
    ...
    def __init__(__self__, *, cookie_behavior: _builtins.str, cookies: Optional[outputs.CachePolicyParametersInCacheKeyAndForwardedToOriginCookiesConfigCookies] = ...) -> None:
...
class CachePolicyParametersInCacheKeyAndForwardedToOriginHeadersConfig(dict):
    ...
    def __init__(__self__, *, header_behavior: Optional[_builtins.str] = ..., headers: Optional[outputs.CachePolicyParametersInCacheKeyAndForwardedToOriginHeadersConfigHeaders] = ...) -> None:
...
class CachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfig(dict):
    ...
    def __init__(__self__, *, query_string_behavior: _builtins.str, query_strings: Optional[outputs.CachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfigQueryStrings] = ...) -> None:
...
class ConnectionFunctionConnectionFunctionConfig(dict):
    ...
    def __init__(__self__, *, comment: _builtins.str, runtime: _builtins.str, key_value_store_association: Optional[outputs.ConnectionFunctionConnectionFunctionConfigKeyValueStoreAssociation] = ...) -> None:
...
class ContinuousDeploymentPolicyStagingDistributionDnsNames(dict):
    def __init__(__self__, *, quantity: _builtins.int, items: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ContinuousDeploymentPolicyTrafficConfig(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, single_header_config: Optional[outputs.ContinuousDeploymentPolicyTrafficConfigSingleHeaderConfig] = ..., single_weight_config: Optional[outputs.ContinuousDeploymentPolicyTrafficConfigSingleWeightConfig] = ...) -> None:
...
class ContinuousDeploymentPolicyTrafficConfigSingleWeightConfig(dict):
    ...
    def __init__(__self__, *, weight: _builtins.float, session_stickiness_config: Optional[outputs.ContinuousDeploymentPolicyTrafficConfigSingleWeightConfigSessionStickinessConfig] = ...) -> None:
...
class ContinuousDeploymentPolicyTrafficConfigSingleWeightConfigSessionStickinessConfig(dict):
    ...
    def __init__(__self__, *, idle_ttl: _builtins.int, maximum_ttl: _builtins.int) -> None:
...
class DistributionCustomErrorResponse(dict):
    ...
    def __init__(__self__, *, error_code: _builtins.int, error_caching_min_ttl: Optional[_builtins.int] = ..., response_code: Optional[_builtins.int] = ..., response_page_path: Optional[_builtins.str] = ...) -> None:
...
class DistributionDefaultCacheBehavior(dict):
    ...
    def __init__(__self__, *, allowed_methods: Sequence[_builtins.str], cached_methods: Sequence[_builtins.str], target_origin_id: _builtins.str, viewer_protocol_policy: _builtins.str, cache_policy_id: Optional[_builtins.str] = ..., compress: Optional[_builtins.bool] = ..., default_ttl: Optional[_builtins.int] = ..., field_level_encryption_id: Optional[_builtins.str] = ..., forwarded_values: Optional[outputs.DistributionDefaultCacheBehaviorForwardedValues] = ..., function_associations: Optional[Sequence[outputs.DistributionDefaultCacheBehaviorFunctionAssociation]] = ..., grpc_config: Optional[outputs.DistributionDefaultCacheBehaviorGrpcConfig] = ..., lambda_function_associations: Optional[Sequence[outputs.DistributionDefaultCacheBehaviorLambdaFunctionAssociation]] = ..., max_ttl: Optional[_builtins.int] = ..., min_ttl: Optional[_builtins.int] = ..., origin_request_policy_id: Optional[_builtins.str] = ..., realtime_log_config_arn: Optional[_builtins.str] = ..., response_headers_policy_id: Optional[_builtins.str] = ..., smooth_streaming: Optional[_builtins.bool] = ..., trusted_key_groups: Optional[Sequence[_builtins.str]] = ..., trusted_signers: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DistributionDefaultCacheBehaviorForwardedValues(dict):
    ...
    def __init__(__self__, *, cookies: outputs.DistributionDefaultCacheBehaviorForwardedValuesCookies, query_string: _builtins.bool, headers: Optional[Sequence[_builtins.str]] = ..., query_string_cache_keys: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DistributionDefaultCacheBehaviorForwardedValuesCookies(dict):
    ...
    def __init__(__self__, *, forward: _builtins.str, whitelisted_names: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DistributionDefaultCacheBehaviorFunctionAssociation(dict):
    ...
    def __init__(__self__, *, event_type: _builtins.str, function_arn: _builtins.str) -> None:
...
class DistributionDefaultCacheBehaviorLambdaFunctionAssociation(dict):
    ...
    def __init__(__self__, *, event_type: _builtins.str, lambda_arn: _builtins.str, include_body: Optional[_builtins.bool] = ...) -> None:
...
class DistributionLoggingConfig(dict):
    ...
    def __init__(__self__, *, bucket: Optional[_builtins.str] = ..., include_cookies: Optional[_builtins.bool] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class DistributionOrderedCacheBehavior(dict):
    ...
    def __init__(__self__, *, allowed_methods: Sequence[_builtins.str], cached_methods: Sequence[_builtins.str], path_pattern: _builtins.str, target_origin_id: _builtins.str, viewer_protocol_policy: _builtins.str, cache_policy_id: Optional[_builtins.str] = ..., compress: Optional[_builtins.bool] = ..., default_ttl: Optional[_builtins.int] = ..., field_level_encryption_id: Optional[_builtins.str] = ..., forwarded_values: Optional[outputs.DistributionOrderedCacheBehaviorForwardedValues] = ..., function_associations: Optional[Sequence[outputs.DistributionOrderedCacheBehaviorFunctionAssociation]] = ..., grpc_config: Optional[outputs.DistributionOrderedCacheBehaviorGrpcConfig] = ..., lambda_function_associations: Optional[Sequence[outputs.DistributionOrderedCacheBehaviorLambdaFunctionAssociation]] = ..., max_ttl: Optional[_builtins.int] = ..., min_ttl: Optional[_builtins.int] = ..., origin_request_policy_id: Optional[_builtins.str] = ..., realtime_log_config_arn: Optional[_builtins.str] = ..., response_headers_policy_id: Optional[_builtins.str] = ..., smooth_streaming: Optional[_builtins.bool] = ..., trusted_key_groups: Optional[Sequence[_builtins.str]] = ..., trusted_signers: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DistributionOrderedCacheBehaviorForwardedValues(dict):
    ...
    def __init__(__self__, *, cookies: outputs.DistributionOrderedCacheBehaviorForwardedValuesCookies, query_string: _builtins.bool, headers: Optional[Sequence[_builtins.str]] = ..., query_string_cache_keys: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DistributionOrigin(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, origin_id: _builtins.str, connection_attempts: Optional[_builtins.int] = ..., connection_timeout: Optional[_builtins.int] = ..., custom_headers: Optional[Sequence[outputs.DistributionOriginCustomHeader]] = ..., custom_origin_config: Optional[outputs.DistributionOriginCustomOriginConfig] = ..., origin_access_control_id: Optional[_builtins.str] = ..., origin_path: Optional[_builtins.str] = ..., origin_shield: Optional[outputs.DistributionOriginOriginShield] = ..., response_completion_timeout: Optional[_builtins.int] = ..., s3_origin_config: Optional[outputs.DistributionOriginS3OriginConfig] = ..., vpc_origin_config: Optional[outputs.DistributionOriginVpcOriginConfig] = ...) -> None:
...
class DistributionOriginCustomOriginConfig(dict):
    ...
    def __init__(__self__, *, http_port: _builtins.int, https_port: _builtins.int, origin_protocol_policy: _builtins.str, origin_ssl_protocols: Sequence[_builtins.str], ip_address_type: Optional[_builtins.str] = ..., origin_keepalive_timeout: Optional[_builtins.int] = ..., origin_read_timeout: Optional[_builtins.int] = ...) -> None:
...
class DistributionOriginGroup(dict):
    ...
    def __init__(__self__, *, failover_criteria: outputs.DistributionOriginGroupFailoverCriteria, members: Sequence[outputs.DistributionOriginGroupMember], origin_id: _builtins.str) -> None:
...
class DistributionOriginOriginShield(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, origin_shield_region: Optional[_builtins.str] = ...) -> None:
...
class DistributionOriginVpcOriginConfig(dict):
    ...
    def __init__(__self__, *, vpc_origin_id: _builtins.str, origin_keepalive_timeout: Optional[_builtins.int] = ..., origin_read_timeout: Optional[_builtins.int] = ..., owner_account_id: Optional[_builtins.str] = ...) -> None:
...
class DistributionRestrictions(dict):
    ...
    def __init__(__self__, *, geo_restriction: outputs.DistributionRestrictionsGeoRestriction) -> None:
        ...
...
class DistributionRestrictionsGeoRestriction(dict):
    ...
    def __init__(__self__, *, restriction_type: _builtins.str, locations: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DistributionTenantCustomizations(dict):
    ...
    def __init__(__self__, *, certificate: Optional[outputs.DistributionTenantCustomizationsCertificate] = ..., geo_restriction: Optional[outputs.DistributionTenantCustomizationsGeoRestriction] = ..., web_acl: Optional[outputs.DistributionTenantCustomizationsWebAcl] = ...) -> None:
...
class DistributionTenantCustomizationsGeoRestriction(dict):
    ...
    def __init__(__self__, *, locations: Optional[Sequence[_builtins.str]] = ..., restriction_type: Optional[_builtins.str] = ...) -> None:
...
class DistributionTenantCustomizationsWebAcl(dict):
    def __init__(__self__, *, action: Optional[_builtins.str] = ..., arn: Optional[_builtins.str] = ...) -> None:
...
class DistributionTenantDomain(dict):
    def __init__(__self__, *, domain: _builtins.str, status: Optional[_builtins.str] = ...) -> None:
...
class DistributionTenantManagedCertificateRequest(dict):
    ...
    def __init__(__self__, *, certificate_transparency_logging_preference: Optional[_builtins.str] = ..., primary_domain_name: Optional[_builtins.str] = ..., validation_token_host: Optional[_builtins.str] = ...) -> None:
...
class DistributionTrustedKeyGroup(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., items: Optional[Sequence[outputs.DistributionTrustedKeyGroupItem]] = ...) -> None:
...
class DistributionTrustedKeyGroupItem(dict):
    ...
    def __init__(__self__, *, key_group_id: Optional[_builtins.str] = ..., key_pair_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DistributionTrustedSigner(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., items: Optional[Sequence[outputs.DistributionTrustedSignerItem]] = ...) -> None:
...
class DistributionTrustedSignerItem(dict):
    ...
    def __init__(__self__, *, aws_account_number: Optional[_builtins.str] = ..., key_pair_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DistributionViewerCertificate(dict):
    ...
    def __init__(__self__, *, acm_certificate_arn: Optional[_builtins.str] = ..., cloudfront_default_certificate: Optional[_builtins.bool] = ..., iam_certificate_id: Optional[_builtins.str] = ..., minimum_protocol_version: Optional[_builtins.str] = ..., ssl_support_method: Optional[_builtins.str] = ...) -> None:
...
class DistributionViewerMtlsConfig(dict):
    ...
    def __init__(__self__, *, mode: Optional[_builtins.str] = ..., trust_store_config: Optional[outputs.DistributionViewerMtlsConfigTrustStoreConfig] = ...) -> None:
...
class DistributionViewerMtlsConfigTrustStoreConfig(dict):
    ...
    def __init__(__self__, *, trust_store_id: _builtins.str, advertise_trust_store_ca_names: Optional[_builtins.bool] = ..., ignore_certificate_expiry: Optional[_builtins.bool] = ...) -> None:
...
class FieldLevelEncryptionConfigContentTypeProfileConfig(dict):
    ...
    def __init__(__self__, *, content_type_profiles: outputs.FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfiles, forward_when_content_type_is_unknown: _builtins.bool) -> None:
...
class FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfiles(dict):
    def __init__(__self__, *, items: Sequence[outputs.FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfilesItem]) -> None:
        ...
...
class FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfilesItem(dict):
    ...
    def __init__(__self__, *, content_type: _builtins.str, format: _builtins.str, profile_id: Optional[_builtins.str] = ...) -> None:
...
class FieldLevelEncryptionConfigQueryArgProfileConfig(dict):
    ...
    def __init__(__self__, *, forward_when_query_arg_profile_is_unknown: _builtins.bool, query_arg_profiles: Optional[outputs.FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfiles] = ...) -> None:
...
class FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfiles(dict):
    def __init__(__self__, *, items: Optional[Sequence[outputs.FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfilesItem]] = ...) -> None:
        ...
...
class FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfilesItem(dict):
    ...
    def __init__(__self__, *, profile_id: _builtins.str, query_arg: _builtins.str) -> None:
...
class FieldLevelEncryptionProfileEncryptionEntities(dict):
    def __init__(__self__, *, items: Optional[Sequence[outputs.FieldLevelEncryptionProfileEncryptionEntitiesItem]] = ...) -> None:
        ...
...
class FieldLevelEncryptionProfileEncryptionEntitiesItem(dict):
    ...
    def __init__(__self__, *, field_patterns: outputs.FieldLevelEncryptionProfileEncryptionEntitiesItemFieldPatterns, provider_id: _builtins.str, public_key_id: _builtins.str) -> None:
...
class MonitoringSubscriptionMonitoringSubscription(dict):
    ...
    def __init__(__self__, *, realtime_metrics_subscription_config: outputs.MonitoringSubscriptionMonitoringSubscriptionRealtimeMetricsSubscriptionConfig) -> None:
...
class MonitoringSubscriptionMonitoringSubscriptionRealtimeMetricsSubscriptionConfig(dict):
    ...
    def __init__(__self__, *, realtime_metrics_subscription_status: _builtins.str) -> None:
...
class MultitenantDistributionActiveTrustedKeyGroup(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., items: Optional[Sequence[outputs.MultitenantDistributionActiveTrustedKeyGroupItem]] = ...) -> None:
...
class MultitenantDistributionCacheBehavior(dict):
    ...
    def __init__(__self__, *, allowed_methods: outputs.MultitenantDistributionCacheBehaviorAllowedMethods, path_pattern: _builtins.str, target_origin_id: _builtins.str, viewer_protocol_policy: _builtins.str, cache_policy_id: Optional[_builtins.str] = ..., compress: Optional[_builtins.bool] = ..., field_level_encryption_id: Optional[_builtins.str] = ..., function_associations: Optional[Sequence[outputs.MultitenantDistributionCacheBehaviorFunctionAssociation]] = ..., lambda_function_associations: Optional[Sequence[outputs.MultitenantDistributionCacheBehaviorLambdaFunctionAssociation]] = ..., origin_request_policy_id: Optional[_builtins.str] = ..., realtime_log_config_arn: Optional[_builtins.str] = ..., response_headers_policy_id: Optional[_builtins.str] = ..., trusted_key_groups: Optional[outputs.MultitenantDistributionCacheBehaviorTrustedKeyGroups] = ...) -> None:
...
class MultitenantDistributionCacheBehaviorAllowedMethods(dict):
    ...
    def __init__(__self__, *, cached_methods: Sequence[_builtins.str], items: Sequence[_builtins.str]) -> None:
...
class MultitenantDistributionCacheBehaviorLambdaFunctionAssociation(dict):
    ...
    def __init__(__self__, *, event_type: _builtins.str, lambda_function_arn: _builtins.str, include_body: Optional[_builtins.bool] = ...) -> None:
...
class MultitenantDistributionCacheBehaviorTrustedKeyGroups(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., items: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class MultitenantDistributionCustomErrorResponse(dict):
    ...
    def __init__(__self__, *, error_code: _builtins.int, error_caching_min_ttl: Optional[_builtins.int] = ..., response_code: Optional[_builtins.str] = ..., response_page_path: Optional[_builtins.str] = ...) -> None:
...
class MultitenantDistributionDefaultCacheBehavior(dict):
    ...
    def __init__(__self__, *, allowed_methods: outputs.MultitenantDistributionDefaultCacheBehaviorAllowedMethods, target_origin_id: _builtins.str, viewer_protocol_policy: _builtins.str, cache_policy_id: Optional[_builtins.str] = ..., compress: Optional[_builtins.bool] = ..., field_level_encryption_id: Optional[_builtins.str] = ..., function_associations: Optional[Sequence[outputs.MultitenantDistributionDefaultCacheBehaviorFunctionAssociation]] = ..., lambda_function_associations: Optional[Sequence[outputs.MultitenantDistributionDefaultCacheBehaviorLambdaFunctionAssociation]] = ..., origin_request_policy_id: Optional[_builtins.str] = ..., realtime_log_config_arn: Optional[_builtins.str] = ..., response_headers_policy_id: Optional[_builtins.str] = ..., trusted_key_groups: Optional[outputs.MultitenantDistributionDefaultCacheBehaviorTrustedKeyGroups] = ...) -> None:
...
class MultitenantDistributionOrigin(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, id: _builtins.str, connection_attempts: Optional[_builtins.int] = ..., connection_timeout: Optional[_builtins.int] = ..., custom_headers: Optional[Sequence[outputs.MultitenantDistributionOriginCustomHeader]] = ..., custom_origin_configs: Optional[Sequence[outputs.MultitenantDistributionOriginCustomOriginConfig]] = ..., origin_access_control_id: Optional[_builtins.str] = ..., origin_path: Optional[_builtins.str] = ..., origin_shields: Optional[Sequence[outputs.MultitenantDistributionOriginOriginShield]] = ..., response_completion_timeout: Optional[_builtins.int] = ..., vpc_origin_configs: Optional[Sequence[outputs.MultitenantDistributionOriginVpcOriginConfig]] = ...) -> None:
...
class MultitenantDistributionOriginCustomHeader(dict):
    ...
    def __init__(__self__, *, header_name: _builtins.str, header_value: _builtins.str) -> None:
...
class MultitenantDistributionOriginGroup(dict):
    ...
    def __init__(__self__, *, failover_criteria: outputs.MultitenantDistributionOriginGroupFailoverCriteria, id: _builtins.str, members: Sequence[outputs.MultitenantDistributionOriginGroupMember]) -> None:
...
class MultitenantDistributionOriginVpcOriginConfig(dict):
    ...
    def __init__(__self__, *, vpc_origin_id: _builtins.str, origin_keepalive_timeout: Optional[_builtins.int] = ..., origin_read_timeout: Optional[_builtins.int] = ...) -> None:
...
class MultitenantDistributionRestrictions(dict):
    ...
    def __init__(__self__, *, geo_restriction: outputs.MultitenantDistributionRestrictionsGeoRestriction) -> None:
...
class MultitenantDistributionRestrictionsGeoRestriction(dict):
    ...
    def __init__(__self__, *, restriction_type: _builtins.str, items: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class MultitenantDistributionTenantConfig(dict):
    ...
    def __init__(__self__, *, parameter_definitions: Optional[Sequence[outputs.MultitenantDistributionTenantConfigParameterDefinition]] = ...) -> None:
...
class MultitenantDistributionTenantConfigParameterDefinition(dict):
    def __init__(__self__, *, name: _builtins.str, definitions: Optional[Sequence[outputs.MultitenantDistributionTenantConfigParameterDefinitionDefinition]] = ...) -> None:
...
class MultitenantDistributionTenantConfigParameterDefinitionDefinition(dict):
    ...
    def __init__(__self__, *, string_schemas: Optional[Sequence[outputs.MultitenantDistributionTenantConfigParameterDefinitionDefinitionStringSchema]] = ...) -> None:
...
class MultitenantDistributionTenantConfigParameterDefinitionDefinitionStringSchema(dict):
    ...
    def __init__(__self__, *, required: _builtins.bool, comment: Optional[_builtins.str] = ..., default_value: Optional[_builtins.str] = ...) -> None:
...
class MultitenantDistributionViewerCertificate(dict):
    ...
    def __init__(__self__, *, acm_certificate_arn: Optional[_builtins.str] = ..., cloudfront_default_certificate: Optional[_builtins.bool] = ..., minimum_protocol_version: Optional[_builtins.str] = ..., ssl_support_method: Optional[_builtins.str] = ...) -> None:
...
class OriginRequestPolicyCookiesConfig(dict):
    ...
    def __init__(__self__, *, cookie_behavior: _builtins.str, cookies: Optional[outputs.OriginRequestPolicyCookiesConfigCookies] = ...) -> None:
        ...
...
class OriginRequestPolicyHeadersConfig(dict):
    ...
    def __init__(__self__, *, header_behavior: Optional[_builtins.str] = ..., headers: Optional[outputs.OriginRequestPolicyHeadersConfigHeaders] = ...) -> None:
        ...
...
class OriginRequestPolicyQueryStringsConfig(dict):
    ...
    def __init__(__self__, *, query_string_behavior: _builtins.str, query_strings: Optional[outputs.OriginRequestPolicyQueryStringsConfigQueryStrings] = ...) -> None:
        ...
...
class RealtimeLogConfigEndpoint(dict):
    ...
    def __init__(__self__, *, kinesis_stream_config: outputs.RealtimeLogConfigEndpointKinesisStreamConfig, stream_type: _builtins.str) -> None:
...
class ResponseHeadersPolicyCorsConfig(dict):
    ...
    def __init__(__self__, *, access_control_allow_credentials: _builtins.bool, access_control_allow_headers: outputs.ResponseHeadersPolicyCorsConfigAccessControlAllowHeaders, access_control_allow_methods: outputs.ResponseHeadersPolicyCorsConfigAccessControlAllowMethods, access_control_allow_origins: outputs.ResponseHeadersPolicyCorsConfigAccessControlAllowOrigins, origin_override: _builtins.bool, access_control_expose_headers: Optional[outputs.ResponseHeadersPolicyCorsConfigAccessControlExposeHeaders] = ..., access_control_max_age_sec: Optional[_builtins.int] = ...) -> None:
...
class ResponseHeadersPolicyCustomHeadersConfig(dict):
    def __init__(__self__, *, items: Optional[Sequence[outputs.ResponseHeadersPolicyCustomHeadersConfigItem]] = ...) -> None:
        ...
...
class ResponseHeadersPolicyCustomHeadersConfigItem(dict):
    def __init__(__self__, *, header: _builtins.str, override: _builtins.bool, value: _builtins.str) -> None:
...
class ResponseHeadersPolicyRemoveHeadersConfig(dict):
    def __init__(__self__, *, items: Optional[Sequence[outputs.ResponseHeadersPolicyRemoveHeadersConfigItem]] = ...) -> None:
        ...
...
class ResponseHeadersPolicySecurityHeadersConfig(dict):
    ...
    def __init__(__self__, *, content_security_policy: Optional[outputs.ResponseHeadersPolicySecurityHeadersConfigContentSecurityPolicy] = ..., content_type_options: Optional[outputs.ResponseHeadersPolicySecurityHeadersConfigContentTypeOptions] = ..., frame_options: Optional[outputs.ResponseHeadersPolicySecurityHeadersConfigFrameOptions] = ..., referrer_policy: Optional[outputs.ResponseHeadersPolicySecurityHeadersConfigReferrerPolicy] = ..., strict_transport_security: Optional[outputs.ResponseHeadersPolicySecurityHeadersConfigStrictTransportSecurity] = ..., xss_protection: Optional[outputs.ResponseHeadersPolicySecurityHeadersConfigXssProtection] = ...) -> None:
...
class ResponseHeadersPolicySecurityHeadersConfigContentSecurityPolicy(dict):
    ...
    def __init__(__self__, *, content_security_policy: _builtins.str, override: _builtins.bool) -> None:
...
class ResponseHeadersPolicySecurityHeadersConfigFrameOptions(dict):
    ...
    def __init__(__self__, *, frame_option: _builtins.str, override: _builtins.bool) -> None:
...
class ResponseHeadersPolicySecurityHeadersConfigReferrerPolicy(dict):
    ...
    def __init__(__self__, *, override: _builtins.bool, referrer_policy: _builtins.str) -> None:
...
class ResponseHeadersPolicySecurityHeadersConfigStrictTransportSecurity(dict):
    ...
    def __init__(__self__, *, access_control_max_age_sec: _builtins.int, override: _builtins.bool, include_subdomains: Optional[_builtins.bool] = ..., preload: Optional[_builtins.bool] = ...) -> None:
...
class ResponseHeadersPolicySecurityHeadersConfigXssProtection(dict):
    ...
    def __init__(__self__, *, override: _builtins.bool, protection: _builtins.bool, mode_block: Optional[_builtins.bool] = ..., report_uri: Optional[_builtins.str] = ...) -> None:
...
class ResponseHeadersPolicyServerTimingHeadersConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, sampling_rate: _builtins.float) -> None:
...
class TrustStoreCaCertificatesBundleSource(dict):
    ...
    def __init__(__self__, *, ca_certificates_bundle_s3_location: outputs.TrustStoreCaCertificatesBundleSourceCaCertificatesBundleS3Location) -> None:
...
class TrustStoreCaCertificatesBundleSourceCaCertificatesBundleS3Location(dict):
    def __init__(__self__, *, bucket: _builtins.str, key: _builtins.str, region: _builtins.str, version: Optional[_builtins.str] = ...) -> None:
...
class VpcOriginVpcOriginEndpointConfig(dict):
    ...
    def __init__(__self__, *, arn: _builtins.str, http_port: _builtins.int, https_port: _builtins.int, name: _builtins.str, origin_protocol_policy: _builtins.str, origin_ssl_protocols: outputs.VpcOriginVpcOriginEndpointConfigOriginSslProtocols) -> None:
...
class VpcOriginVpcOriginEndpointConfigOriginSslProtocols(dict):
    def __init__(__self__, *, items: Sequence[_builtins.str], quantity: _builtins.int) -> None:
        ...
...
class GetCachePolicyParametersInCacheKeyAndForwardedToOriginResult(dict):
    def __init__(__self__, *, cookies_configs: Sequence[outputs.GetCachePolicyParametersInCacheKeyAndForwardedToOriginCookiesConfigResult], enable_accept_encoding_brotli: _builtins.bool, enable_accept_encoding_gzip: _builtins.bool, headers_configs: Sequence[outputs.GetCachePolicyParametersInCacheKeyAndForwardedToOriginHeadersConfigResult], query_strings_configs: Sequence[outputs.GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfigResult]) -> None:
...
class GetCachePolicyParametersInCacheKeyAndForwardedToOriginCookiesConfigResult(dict):
    def __init__(__self__, *, cookie_behavior: _builtins.str, cookies: Sequence[outputs.GetCachePolicyParametersInCacheKeyAndForwardedToOriginCookiesConfigCookieResult]) -> None:
...
class GetCachePolicyParametersInCacheKeyAndForwardedToOriginHeadersConfigResult(dict):
    def __init__(__self__, *, header_behavior: _builtins.str, headers: Sequence[outputs.GetCachePolicyParametersInCacheKeyAndForwardedToOriginHeadersConfigHeaderResult]) -> None:
...
class GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfigResult(dict):
    def __init__(__self__, *, query_string_behavior: _builtins.str, query_strings: Sequence[outputs.GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfigQueryStringResult]) -> None:
...
class GetDistributionTenantCustomizationResult(dict):
    def __init__(__self__, *, certificates: Sequence[outputs.GetDistributionTenantCustomizationCertificateResult], geo_restrictions: Sequence[outputs.GetDistributionTenantCustomizationGeoRestrictionResult], web_acls: Sequence[outputs.GetDistributionTenantCustomizationWebAclResult]) -> None:
        ...
...
class GetDistributionTenantCustomizationGeoRestrictionResult(dict):
    def __init__(__self__, *, locations: Sequence[_builtins.str], restriction_type: _builtins.str) -> None:
        ...
...
class GetDistributionTenantManagedCertificateRequestResult(dict):
    def __init__(__self__, *, certificate_transparency_logging_preference: _builtins.str, primary_domain_name: _builtins.str, validation_token_host: _builtins.str) -> None:
        ...
...
class GetOriginRequestPolicyCookiesConfigResult(dict):
    def __init__(__self__, *, cookie_behavior: _builtins.str, cookies: Sequence[outputs.GetOriginRequestPolicyCookiesConfigCookieResult]) -> None:
        ...
...
class GetOriginRequestPolicyHeadersConfigResult(dict):
    def __init__(__self__, *, header_behavior: _builtins.str, headers: Sequence[outputs.GetOriginRequestPolicyHeadersConfigHeaderResult]) -> None:
        ...
...
class GetOriginRequestPolicyQueryStringsConfigResult(dict):
    def __init__(__self__, *, query_string_behavior: _builtins.str, query_strings: Sequence[outputs.GetOriginRequestPolicyQueryStringsConfigQueryStringResult]) -> None:
        ...
...
class GetRealtimeLogConfigEndpointResult(dict):
    def __init__(__self__, *, kinesis_stream_configs: Sequence[outputs.GetRealtimeLogConfigEndpointKinesisStreamConfigResult], stream_type: _builtins.str) -> None:
...
class GetResponseHeadersPolicyCorsConfigResult(dict):
    def __init__(__self__, *, access_control_allow_credentials: _builtins.bool, access_control_allow_headers: Sequence[outputs.GetResponseHeadersPolicyCorsConfigAccessControlAllowHeaderResult], access_control_allow_methods: Sequence[outputs.GetResponseHeadersPolicyCorsConfigAccessControlAllowMethodResult], access_control_allow_origins: Sequence[outputs.GetResponseHeadersPolicyCorsConfigAccessControlAllowOriginResult], access_control_expose_headers: Sequence[outputs.GetResponseHeadersPolicyCorsConfigAccessControlExposeHeaderResult], access_control_max_age_sec: _builtins.int, origin_override: _builtins.bool) -> None:
...
class GetResponseHeadersPolicyCustomHeadersConfigResult(dict):
    def __init__(__self__, *, items: Sequence[outputs.GetResponseHeadersPolicyCustomHeadersConfigItemResult]) -> None:
        ...
...
class GetResponseHeadersPolicyRemoveHeadersConfigResult(dict):
    def __init__(__self__, *, items: Sequence[outputs.GetResponseHeadersPolicyRemoveHeadersConfigItemResult]) -> None:
        ...
...
class GetResponseHeadersPolicySecurityHeadersConfigResult(dict):
    def __init__(__self__, *, content_security_policies: Sequence[outputs.GetResponseHeadersPolicySecurityHeadersConfigContentSecurityPolicyResult], content_type_options: Sequence[outputs.GetResponseHeadersPolicySecurityHeadersConfigContentTypeOptionResult], frame_options: Sequence[outputs.GetResponseHeadersPolicySecurityHeadersConfigFrameOptionResult], referrer_policies: Sequence[outputs.GetResponseHeadersPolicySecurityHeadersConfigReferrerPolicyResult], strict_transport_securities: Sequence[outputs.GetResponseHeadersPolicySecurityHeadersConfigStrictTransportSecurityResult], xss_protections: Sequence[outputs.GetResponseHeadersPolicySecurityHeadersConfigXssProtectionResult]) -> None:
...
class GetResponseHeadersPolicySecurityHeadersConfigStrictTransportSecurityResult(dict):
    def __init__(__self__, *, access_control_max_age_sec: _builtins.int, include_subdomains: _builtins.bool, override: _builtins.bool, preload: _builtins.bool) -> None:
...
class GetResponseHeadersPolicySecurityHeadersConfigXssProtectionResult(dict):
    def __init__(__self__, *, mode_block: _builtins.bool, override: _builtins.bool, protection: _builtins.bool, report_uri: _builtins.str) -> None:
