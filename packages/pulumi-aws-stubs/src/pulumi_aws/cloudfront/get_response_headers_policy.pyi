...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetResponseHeadersPolicyResult', 'AwaitableGetResponseHeadersPolicyResult', 'get_response_headers_policy', 'get_response_headers_policy_output']
@pulumi.output_type
class GetResponseHeadersPolicyResult:
    
    def __init__(__self__, arn=..., comment=..., cors_configs=..., custom_headers_configs=..., etag=..., id=..., name=..., remove_headers_configs=..., security_headers_configs=..., server_timing_headers_configs=...) -> None:
        ...
...
class AwaitableGetResponseHeadersPolicyResult(GetResponseHeadersPolicyResult):
    def __await__(self): # -> Generator[Never, Any, GetResponseHeadersPolicyResult]:
        ...
    


def get_response_headers_policy(id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetResponseHeadersPolicyResult:
    
    ...

def get_response_headers_policy_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., name: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetResponseHeadersPolicyResult]:
