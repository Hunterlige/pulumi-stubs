...
class DomainArgs:
    def __init__(
        __self__,
        *,
        workflow_execution_retention_period_in_days: pulumi.Input[_builtins.str],
    ...
    def workflow_execution_retention_period_in_days(
        self,
...
class _DomainState:
    def __init__(
        ...
        *,
        ...
        workflow_execution_retention_period_in_days: Optional[
            pulumi.Input[_builtins.str]
        ] = ...,
    ) -> None: ...
    @_builtins.property
