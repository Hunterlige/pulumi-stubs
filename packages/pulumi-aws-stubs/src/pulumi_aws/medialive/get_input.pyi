...
class GetInputResult:
    ...
    def __init__(__self__, arn=..., attached_channels=..., destinations=..., id=..., input_class=..., input_devices=..., input_partner_ids=..., input_source_type=..., media_connect_flows=..., name=..., region=..., role_arn=..., security_groups=..., sources=..., state=..., tags=..., type=...) -> None:
        ...
...
class AwaitableGetInputResult(GetInputResult):
    def __await__(self): # -> Generator[Never, Any, GetInputResult]:
        ...
    


def get_input(id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetInputResult:
    
    ...

def get_input_output(id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetInputResult]:
