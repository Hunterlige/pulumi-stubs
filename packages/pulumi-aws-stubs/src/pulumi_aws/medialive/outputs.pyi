...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ChannelCdiInputSpecification', 'ChannelDestination', 'ChannelDestinationMediaPackageSetting', 'ChannelDestinationMultiplexSettings', 'ChannelDestinationSetting', 'ChannelEncoderSettings', 'ChannelEncoderSettingsAudioDescription', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ChannelEncoderSettingsAvailBlanking', ..., 'ChannelEncoderSettingsCaptionDescription', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ChannelEncoderSettingsGlobalConfiguration', ..., ..., 'ChannelEncoderSettingsMotionGraphicsConfiguration', ..., ..., 'ChannelEncoderSettingsNielsenConfiguration', 'ChannelEncoderSettingsOutputGroup', 'ChannelEncoderSettingsOutputGroupOutput', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ChannelEncoderSettingsTimecodeConfig', 'ChannelEncoderSettingsVideoDescription', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ChannelInputAttachment', ..., ..., ..., ..., ..., ..., 'ChannelInputAttachmentInputSettings', 'ChannelInputAttachmentInputSettingsAudioSelector', ..., ..., ..., ..., ..., ..., ..., 'ChannelInputAttachmentInputSettingsCaptionSelector', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ChannelInputAttachmentInputSettingsVideoSelector', 'ChannelInputSpecification', 'ChannelMaintenance', 'ChannelVpc', 'InputDestination', 'InputInputDevice', 'InputMediaConnectFlow', 'InputSecurityGroupWhitelistRule', 'InputSource', 'InputVpc', 'MultiplexMultiplexSettings', 'MultiplexProgramMultiplexProgramSettings', ..., ..., ..., 'MultiplexProgramTimeouts', 'GetInputDestinationResult', 'GetInputDestinationVpcResult', 'GetInputInputDeviceResult', 'GetInputMediaConnectFlowResult', 'GetInputSourceResult']
@pulumi.output_type
...
class ChannelDestination(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, media_package_settings: Optional[Sequence[outputs.ChannelDestinationMediaPackageSetting]] = ..., multiplex_settings: Optional[outputs.ChannelDestinationMultiplexSettings] = ..., settings: Optional[Sequence[outputs.ChannelDestinationSetting]] = ...) -> None:
...
class ChannelDestinationMultiplexSettings(dict):
    ...
    def __init__(__self__, *, multiplex_id: _builtins.str, program_name: _builtins.str) -> None:
...
class ChannelDestinationSetting(dict):
    ...
    def __init__(__self__, *, password_param: Optional[_builtins.str] = ..., stream_name: Optional[_builtins.str] = ..., url: Optional[_builtins.str] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettings(dict):
    ...
    def __init__(__self__, *, output_groups: Sequence[outputs.ChannelEncoderSettingsOutputGroup], timecode_config: outputs.ChannelEncoderSettingsTimecodeConfig, audio_descriptions: Optional[Sequence[outputs.ChannelEncoderSettingsAudioDescription]] = ..., avail_blanking: Optional[outputs.ChannelEncoderSettingsAvailBlanking] = ..., caption_descriptions: Optional[Sequence[outputs.ChannelEncoderSettingsCaptionDescription]] = ..., global_configuration: Optional[outputs.ChannelEncoderSettingsGlobalConfiguration] = ..., motion_graphics_configuration: Optional[outputs.ChannelEncoderSettingsMotionGraphicsConfiguration] = ..., nielsen_configuration: Optional[outputs.ChannelEncoderSettingsNielsenConfiguration] = ..., video_descriptions: Optional[Sequence[outputs.ChannelEncoderSettingsVideoDescription]] = ...) -> None:
...
class ChannelEncoderSettingsAudioDescription(dict):
    ...
    def __init__(__self__, *, audio_selector_name: _builtins.str, name: _builtins.str, audio_normalization_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionAudioNormalizationSettings] = ..., audio_type: Optional[_builtins.str] = ..., audio_type_control: Optional[_builtins.str] = ..., audio_watermark_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettings] = ..., codec_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionCodecSettings] = ..., language_code: Optional[_builtins.str] = ..., language_code_control: Optional[_builtins.str] = ..., remix_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionRemixSettings] = ..., stream_name: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsAudioDescriptionAudioNormalizationSettings(dict):
    ...
    def __init__(__self__, *, algorithm: Optional[_builtins.str] = ..., algorithm_control: Optional[_builtins.str] = ..., target_lkfs: Optional[_builtins.float] = ...) -> None:
...
class ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettings(dict):
    ...
    def __init__(__self__, *, nielsen_watermarks_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettings] = ...) -> None:
        ...
...
class ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettings(dict):
    ...
    def __init__(__self__, *, nielsen_cbet_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettingsNielsenCbetSettings] = ..., nielsen_distribution_type: Optional[_builtins.str] = ..., nielsen_naes_ii_nw_settings: Optional[Sequence[outputs.ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettingsNielsenNaesIiNwSetting]] = ...) -> None:
...
class ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettingsNielsenCbetSettings(dict):
    ...
    def __init__(__self__, *, cbet_check_digit_string: _builtins.str, cbet_stepaside: _builtins.str, csid: _builtins.str) -> None:
...
class ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettingsNielsenNaesIiNwSetting(dict):
    ...
    def __init__(__self__, *, check_digit_string: _builtins.str, sid: _builtins.float) -> None:
...
class ChannelEncoderSettingsAudioDescriptionCodecSettings(dict):
    ...
    def __init__(__self__, *, aac_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionCodecSettingsAacSettings] = ..., ac3_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionCodecSettingsAc3Settings] = ..., eac3_atmos_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionCodecSettingsEac3AtmosSettings] = ..., eac3_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionCodecSettingsEac3Settings] = ..., mp2_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionCodecSettingsMp2Settings] = ..., pass_through_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionCodecSettingsPassThroughSettings] = ..., wav_settings: Optional[outputs.ChannelEncoderSettingsAudioDescriptionCodecSettingsWavSettings] = ...) -> None:
...
class ChannelEncoderSettingsAudioDescriptionCodecSettingsAacSettings(dict):
    ...
    def __init__(__self__, *, bitrate: Optional[_builtins.float] = ..., coding_mode: Optional[_builtins.str] = ..., input_type: Optional[_builtins.str] = ..., profile: Optional[_builtins.str] = ..., rate_control_mode: Optional[_builtins.str] = ..., raw_format: Optional[_builtins.str] = ..., sample_rate: Optional[_builtins.float] = ..., spec: Optional[_builtins.str] = ..., vbr_quality: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsAudioDescriptionCodecSettingsAc3Settings(dict):
    ...
    def __init__(__self__, *, bitrate: Optional[_builtins.float] = ..., bitstream_mode: Optional[_builtins.str] = ..., coding_mode: Optional[_builtins.str] = ..., dialnorm: Optional[_builtins.int] = ..., drc_profile: Optional[_builtins.str] = ..., lfe_filter: Optional[_builtins.str] = ..., metadata_control: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsAudioDescriptionCodecSettingsEac3AtmosSettings(dict):
    ...
    def __init__(__self__, *, bitrate: Optional[_builtins.float] = ..., coding_mode: Optional[_builtins.str] = ..., dialnorm: Optional[_builtins.float] = ..., drc_line: Optional[_builtins.str] = ..., drc_rf: Optional[_builtins.str] = ..., height_trim: Optional[_builtins.float] = ..., surround_trim: Optional[_builtins.float] = ...) -> None:
...
class ChannelEncoderSettingsAudioDescriptionCodecSettingsEac3Settings(dict):
    ...
    def __init__(__self__, *, attenuation_control: Optional[_builtins.str] = ..., bitrate: Optional[_builtins.float] = ..., bitstream_mode: Optional[_builtins.str] = ..., coding_mode: Optional[_builtins.str] = ..., dc_filter: Optional[_builtins.str] = ..., dialnorm: Optional[_builtins.int] = ..., drc_line: Optional[_builtins.str] = ..., drc_rf: Optional[_builtins.str] = ..., lfe_control: Optional[_builtins.str] = ..., lfe_filter: Optional[_builtins.str] = ..., lo_ro_center_mix_level: Optional[_builtins.float] = ..., lo_ro_surround_mix_level: Optional[_builtins.float] = ..., lt_rt_center_mix_level: Optional[_builtins.float] = ..., lt_rt_surround_mix_level: Optional[_builtins.float] = ..., metadata_control: Optional[_builtins.str] = ..., passthrough_control: Optional[_builtins.str] = ..., phase_control: Optional[_builtins.str] = ..., stereo_downmix: Optional[_builtins.str] = ..., surround_ex_mode: Optional[_builtins.str] = ..., surround_mode: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsAudioDescriptionCodecSettingsMp2Settings(dict):
    ...
    def __init__(__self__, *, bitrate: Optional[_builtins.float] = ..., coding_mode: Optional[_builtins.str] = ..., sample_rate: Optional[_builtins.float] = ...) -> None:
...
class ChannelEncoderSettingsAudioDescriptionCodecSettingsWavSettings(dict):
    ...
    def __init__(__self__, *, bit_depth: Optional[_builtins.float] = ..., coding_mode: Optional[_builtins.str] = ..., sample_rate: Optional[_builtins.float] = ...) -> None:
...
class ChannelEncoderSettingsAudioDescriptionRemixSettings(dict):
    ...
    def __init__(__self__, *, channel_mappings: Sequence[outputs.ChannelEncoderSettingsAudioDescriptionRemixSettingsChannelMapping], channels_in: Optional[_builtins.int] = ..., channels_out: Optional[_builtins.int] = ...) -> None:
        ...
...
class ChannelEncoderSettingsAudioDescriptionRemixSettingsChannelMapping(dict):
    ...
    def __init__(__self__, *, input_channel_levels: Sequence[outputs.ChannelEncoderSettingsAudioDescriptionRemixSettingsChannelMappingInputChannelLevel], output_channel: _builtins.int) -> None:
        ...
...
class ChannelEncoderSettingsAudioDescriptionRemixSettingsChannelMappingInputChannelLevel(dict):
    ...
    def __init__(__self__, *, gain: _builtins.int, input_channel: _builtins.int) -> None:
        ...
...
class ChannelEncoderSettingsAvailBlanking(dict):
    ...
    def __init__(__self__, *, avail_blanking_image: Optional[outputs.ChannelEncoderSettingsAvailBlankingAvailBlankingImage] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsAvailBlankingAvailBlankingImage(dict):
    ...
    def __init__(__self__, *, uri: _builtins.str, password_param: Optional[_builtins.str] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsCaptionDescription(dict):
    ...
    def __init__(__self__, *, caption_selector_name: _builtins.str, name: _builtins.str, accessibility: Optional[_builtins.str] = ..., destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettings] = ..., language_code: Optional[_builtins.str] = ..., language_description: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsCaptionDescriptionDestinationSettings(dict):
    ...
    def __init__(__self__, *, arib_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsAribDestinationSettings] = ..., burn_in_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsBurnInDestinationSettings] = ..., dvb_sub_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings] = ..., ebu_tt_d_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsEbuTtDDestinationSettings] = ..., embedded_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsEmbeddedDestinationSettings] = ..., embedded_plus_scte20_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsEmbeddedPlusScte20DestinationSettings] = ..., rtmp_caption_info_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsRtmpCaptionInfoDestinationSettings] = ..., scte20_plus_embedded_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsScte20PlusEmbeddedDestinationSettings] = ..., scte27_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsScte27DestinationSettings] = ..., smpte_tt_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsSmpteTtDestinationSettings] = ..., teletext_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsTeletextDestinationSettings] = ..., ttml_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsTtmlDestinationSettings] = ..., webvtt_destination_settings: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsWebvttDestinationSettings] = ...) -> None:
...
class ChannelEncoderSettingsCaptionDescriptionDestinationSettingsBurnInDestinationSettings(dict):
    ...
    def __init__(__self__, *, outline_color: _builtins.str, teletext_grid_control: _builtins.str, alignment: Optional[_builtins.str] = ..., background_color: Optional[_builtins.str] = ..., background_opacity: Optional[_builtins.int] = ..., font: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsBurnInDestinationSettingsFont] = ..., font_color: Optional[_builtins.str] = ..., font_opacity: Optional[_builtins.int] = ..., font_resolution: Optional[_builtins.int] = ..., font_size: Optional[_builtins.str] = ..., outline_size: Optional[_builtins.int] = ..., shadow_color: Optional[_builtins.str] = ..., shadow_opacity: Optional[_builtins.int] = ..., shadow_x_offset: Optional[_builtins.int] = ..., shadow_y_offset: Optional[_builtins.int] = ..., x_position: Optional[_builtins.int] = ..., y_position: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings(dict):
    ...
    def __init__(__self__, *, alignment: Optional[_builtins.str] = ..., background_color: Optional[_builtins.str] = ..., background_opacity: Optional[_builtins.int] = ..., font: Optional[outputs.ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettingsFont] = ..., font_color: Optional[_builtins.str] = ..., font_opacity: Optional[_builtins.int] = ..., font_resolution: Optional[_builtins.int] = ..., font_size: Optional[_builtins.str] = ..., outline_color: Optional[_builtins.str] = ..., outline_size: Optional[_builtins.int] = ..., shadow_color: Optional[_builtins.str] = ..., shadow_opacity: Optional[_builtins.int] = ..., shadow_x_offset: Optional[_builtins.int] = ..., shadow_y_offset: Optional[_builtins.int] = ..., teletext_grid_control: Optional[_builtins.str] = ..., x_position: Optional[_builtins.int] = ..., y_position: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsCaptionDescriptionDestinationSettingsEbuTtDDestinationSettings(dict):
    ...
    def __init__(__self__, *, copyright_holder: Optional[_builtins.str] = ..., fill_line_gap: Optional[_builtins.str] = ..., font_family: Optional[_builtins.str] = ..., style_control: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsGlobalConfiguration(dict):
    ...
    def __init__(__self__, *, initial_audio_gain: Optional[_builtins.int] = ..., input_end_action: Optional[_builtins.str] = ..., input_loss_behavior: Optional[outputs.ChannelEncoderSettingsGlobalConfigurationInputLossBehavior] = ..., output_locking_mode: Optional[_builtins.str] = ..., output_timing_source: Optional[_builtins.str] = ..., support_low_framerate_inputs: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsGlobalConfigurationInputLossBehavior(dict):
    ...
    def __init__(__self__, *, black_frame_msec: Optional[_builtins.int] = ..., input_loss_image_color: Optional[_builtins.str] = ..., input_loss_image_slate: Optional[outputs.ChannelEncoderSettingsGlobalConfigurationInputLossBehaviorInputLossImageSlate] = ..., input_loss_image_type: Optional[_builtins.str] = ..., repeat_frame_msec: Optional[_builtins.int] = ...) -> None:
        ...
...
class ChannelEncoderSettingsMotionGraphicsConfiguration(dict):
    ...
    def __init__(__self__, *, motion_graphics_settings: outputs.ChannelEncoderSettingsMotionGraphicsConfigurationMotionGraphicsSettings, motion_graphics_insertion: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsMotionGraphicsConfigurationMotionGraphicsSettings(dict):
    ...
    def __init__(__self__, *, html_motion_graphics_settings: Optional[outputs.ChannelEncoderSettingsMotionGraphicsConfigurationMotionGraphicsSettingsHtmlMotionGraphicsSettings] = ...) -> None:
...
class ChannelEncoderSettingsNielsenConfiguration(dict):
    ...
    def __init__(__self__, *, distributor_id: Optional[_builtins.str] = ..., nielsen_pcm_to_id3_tagging: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroup(dict):
    ...
    def __init__(__self__, *, output_group_settings: outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettings, outputs: Sequence[outputs.ChannelEncoderSettingsOutputGroupOutput], name: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutput(dict):
    ...
    def __init__(__self__, *, output_settings: outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettings, audio_description_names: Optional[Sequence[_builtins.str]] = ..., caption_description_names: Optional[Sequence[_builtins.str]] = ..., output_name: Optional[_builtins.str] = ..., video_description_name: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettings(dict):
    ...
    def __init__(__self__, *, archive_group_settings: Optional[Sequence[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSetting]] = ..., frame_capture_group_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettings] = ..., hls_group_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettings] = ..., media_package_group_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsMediaPackageGroupSettings] = ..., ms_smooth_group_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsMsSmoothGroupSettings] = ..., multiplex_group_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsMultiplexGroupSettings] = ..., rtmp_group_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsRtmpGroupSettings] = ..., udp_group_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsUdpGroupSettings] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSetting(dict):
    ...
    def __init__(__self__, *, destination: outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSettingDestination, archive_cdn_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSettingArchiveCdnSettings] = ..., rollover_interval: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSettingArchiveCdnSettings(dict):
    ...
    def __init__(__self__, *, archive_s3_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSettingArchiveCdnSettingsArchiveS3Settings] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettings(dict):
    ...
    def __init__(__self__, *, destination: outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettingsDestination, frame_capture_cdn_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettingsFrameCaptureCdnSettings] = ...) -> None:
        ...
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettingsFrameCaptureCdnSettings(dict):
    ...
    def __init__(__self__, *, frame_capture_s3_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettingsFrameCaptureCdnSettingsFrameCaptureS3Settings] = ...) -> None:
        ...
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettings(dict):
    ...
    def __init__(__self__, *, destination: outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsDestination, ad_markers: Optional[Sequence[_builtins.str]] = ..., base_url_content: Optional[_builtins.str] = ..., base_url_content1: Optional[_builtins.str] = ..., base_url_manifest: Optional[_builtins.str] = ..., base_url_manifest1: Optional[_builtins.str] = ..., caption_language_mappings: Optional[Sequence[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsCaptionLanguageMapping]] = ..., caption_language_setting: Optional[_builtins.str] = ..., client_cache: Optional[_builtins.str] = ..., codec_specification: Optional[_builtins.str] = ..., constant_iv: Optional[_builtins.str] = ..., directory_structure: Optional[_builtins.str] = ..., discontinuity_tags: Optional[_builtins.str] = ..., encryption_type: Optional[_builtins.str] = ..., hls_cdn_settings: Optional[Sequence[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsHlsCdnSetting]] = ..., hls_id3_segment_tagging: Optional[_builtins.str] = ..., iframe_only_playlists: Optional[_builtins.str] = ..., incomplete_segment_behavior: Optional[_builtins.str] = ..., index_n_segments: Optional[_builtins.int] = ..., input_loss_action: Optional[_builtins.str] = ..., iv_in_manifest: Optional[_builtins.str] = ..., iv_source: Optional[_builtins.str] = ..., keep_segments: Optional[_builtins.int] = ..., key_format: Optional[_builtins.str] = ..., key_format_versions: Optional[_builtins.str] = ..., key_provider_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsKeyProviderSettings] = ..., manifest_compression: Optional[_builtins.str] = ..., manifest_duration_format: Optional[_builtins.str] = ..., min_segment_length: Optional[_builtins.int] = ..., mode: Optional[_builtins.str] = ..., output_selection: Optional[_builtins.str] = ..., program_date_time: Optional[_builtins.str] = ..., program_date_time_clock: Optional[_builtins.str] = ..., program_date_time_period: Optional[_builtins.int] = ..., redundant_manifest: Optional[_builtins.str] = ..., segment_length: Optional[_builtins.int] = ..., segments_per_subdirectory: Optional[_builtins.int] = ..., stream_inf_resolution: Optional[_builtins.str] = ..., timed_metadata_id3_frame: Optional[_builtins.str] = ..., timed_metadata_id3_period: Optional[_builtins.int] = ..., timestamp_delta_milliseconds: Optional[_builtins.int] = ..., ts_file_mode: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsCaptionLanguageMapping(dict):
    ...
    def __init__(__self__, *, caption_channel: _builtins.int, language_code: _builtins.str, language_description: _builtins.str) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsHlsCdnSetting(dict):
    ...
    def __init__(__self__, *, hls_akamai_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsHlsCdnSettingHlsAkamaiSettings] = ..., hls_basic_put_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsHlsCdnSettingHlsBasicPutSettings] = ..., hls_media_store_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsHlsCdnSettingHlsMediaStoreSettings] = ..., hls_s3_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsHlsCdnSettingHlsS3Settings] = ..., hls_webdav_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsHlsCdnSettingHlsWebdavSettings] = ...) -> None:
        ...
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsHlsCdnSettingHlsAkamaiSettings(dict):
    ...
    def __init__(__self__, *, connection_retry_interval: Optional[_builtins.int] = ..., filecache_duration: Optional[_builtins.int] = ..., http_transfer_mode: Optional[_builtins.str] = ..., num_retries: Optional[_builtins.int] = ..., restart_delay: Optional[_builtins.int] = ..., salt: Optional[_builtins.str] = ..., token: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsHlsCdnSettingHlsBasicPutSettings(dict):
    ...
    def __init__(__self__, *, connection_retry_interval: Optional[_builtins.int] = ..., filecache_duration: Optional[_builtins.int] = ..., num_retries: Optional[_builtins.int] = ..., restart_delay: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsHlsCdnSettingHlsMediaStoreSettings(dict):
    ...
    def __init__(__self__, *, connection_retry_interval: Optional[_builtins.int] = ..., filecache_duration: Optional[_builtins.int] = ..., media_store_storage_class: Optional[_builtins.str] = ..., num_retries: Optional[_builtins.int] = ..., restart_delay: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsHlsCdnSettingHlsWebdavSettings(dict):
    ...
    def __init__(__self__, *, connection_retry_interval: Optional[_builtins.int] = ..., filecache_duration: Optional[_builtins.int] = ..., http_transfer_mode: Optional[_builtins.str] = ..., num_retries: Optional[_builtins.int] = ..., restart_delay: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsKeyProviderSettings(dict):
    ...
    def __init__(__self__, *, static_key_settings: Optional[Sequence[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsKeyProviderSettingsStaticKeySetting]] = ...) -> None:
        ...
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsKeyProviderSettingsStaticKeySetting(dict):
    ...
    def __init__(__self__, *, static_key_value: _builtins.str, key_provider_server: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettingsKeyProviderSettingsStaticKeySettingKeyProviderServer] = ...) -> None:
        ...
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsMediaPackageGroupSettings(dict):
    def __init__(__self__, *, destination: outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsMediaPackageGroupSettingsDestination) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsMsSmoothGroupSettings(dict):
    ...
    def __init__(__self__, *, destination: outputs.ChannelEncoderSettingsOutputGroupOutputGroupSettingsMsSmoothGroupSettingsDestination, acquisition_point_id: Optional[_builtins.str] = ..., audio_only_timecode_control: Optional[_builtins.str] = ..., certificate_mode: Optional[_builtins.str] = ..., connection_retry_interval: Optional[_builtins.int] = ..., event_id: Optional[_builtins.str] = ..., event_id_mode: Optional[_builtins.str] = ..., event_stop_behavior: Optional[_builtins.str] = ..., filecache_duration: Optional[_builtins.int] = ..., fragment_length: Optional[_builtins.int] = ..., input_loss_action: Optional[_builtins.str] = ..., num_retries: Optional[_builtins.int] = ..., restart_delay: Optional[_builtins.int] = ..., segmentation_mode: Optional[_builtins.str] = ..., send_delay_ms: Optional[_builtins.int] = ..., sparse_track_type: Optional[_builtins.str] = ..., stream_manifest_behavior: Optional[_builtins.str] = ..., timestamp_offset: Optional[_builtins.str] = ..., timestamp_offset_mode: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsRtmpGroupSettings(dict):
    ...
    def __init__(__self__, *, ad_markers: Optional[Sequence[_builtins.str]] = ..., authentication_scheme: Optional[_builtins.str] = ..., cache_full_behavior: Optional[_builtins.str] = ..., cache_length: Optional[_builtins.int] = ..., caption_data: Optional[_builtins.str] = ..., input_loss_action: Optional[_builtins.str] = ..., restart_delay: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputGroupSettingsUdpGroupSettings(dict):
    ...
    def __init__(__self__, *, input_loss_action: Optional[_builtins.str] = ..., timed_metadata_id3_frame: Optional[_builtins.str] = ..., timed_metadata_id3_period: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettings(dict):
    ...
    def __init__(__self__, *, archive_output_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettings] = ..., frame_capture_output_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsFrameCaptureOutputSettings] = ..., hls_output_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettings] = ..., media_package_output_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsMediaPackageOutputSettings] = ..., ms_smooth_output_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsMsSmoothOutputSettings] = ..., multiplex_output_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsMultiplexOutputSettings] = ..., rtmp_output_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsRtmpOutputSettings] = ..., udp_output_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettings] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettings(dict):
    ...
    def __init__(__self__, *, container_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettings] = ..., extension: Optional[_builtins.str] = ..., name_modifier: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettings(dict):
    ...
    def __init__(__self__, *, m2ts_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettings] = ..., raw_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsRawSettings] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettings(dict):
    ...
    def __init__(__self__, *, absent_input_audio_behavior: Optional[_builtins.str] = ..., arib: Optional[_builtins.str] = ..., arib_captions_pid: Optional[_builtins.str] = ..., arib_captions_pid_control: Optional[_builtins.str] = ..., audio_buffer_model: Optional[_builtins.str] = ..., audio_frames_per_pes: Optional[_builtins.int] = ..., audio_pids: Optional[_builtins.str] = ..., audio_stream_type: Optional[_builtins.str] = ..., bitrate: Optional[_builtins.int] = ..., buffer_model: Optional[_builtins.str] = ..., cc_descriptor: Optional[_builtins.str] = ..., dvb_nit_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings] = ..., dvb_sdt_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings] = ..., dvb_sub_pids: Optional[_builtins.str] = ..., dvb_tdt_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbTdtSettings] = ..., dvb_teletext_pid: Optional[_builtins.str] = ..., ebif: Optional[_builtins.str] = ..., ebp_audio_interval: Optional[_builtins.str] = ..., ebp_lookahead_ms: Optional[_builtins.int] = ..., ebp_placement: Optional[_builtins.str] = ..., ecm_pid: Optional[_builtins.str] = ..., es_rate_in_pes: Optional[_builtins.str] = ..., etv_platform_pid: Optional[_builtins.str] = ..., etv_signal_pid: Optional[_builtins.str] = ..., fragment_time: Optional[_builtins.float] = ..., klv: Optional[_builtins.str] = ..., klv_data_pids: Optional[_builtins.str] = ..., nielsen_id3_behavior: Optional[_builtins.str] = ..., null_packet_bitrate: Optional[_builtins.float] = ..., pat_interval: Optional[_builtins.int] = ..., pcr_control: Optional[_builtins.str] = ..., pcr_period: Optional[_builtins.int] = ..., pcr_pid: Optional[_builtins.str] = ..., pmt_interval: Optional[_builtins.int] = ..., pmt_pid: Optional[_builtins.str] = ..., program_num: Optional[_builtins.int] = ..., rate_mode: Optional[_builtins.str] = ..., scte27_pids: Optional[_builtins.str] = ..., scte35_control: Optional[_builtins.str] = ..., scte35_pid: Optional[_builtins.str] = ..., segmentation_markers: Optional[_builtins.str] = ..., segmentation_style: Optional[_builtins.str] = ..., segmentation_time: Optional[_builtins.float] = ..., timed_metadata_behavior: Optional[_builtins.str] = ..., timed_metadata_pid: Optional[_builtins.str] = ..., transport_stream_id: Optional[_builtins.int] = ..., video_pid: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings(dict):
    ...
    def __init__(__self__, *, network_id: _builtins.int, network_name: _builtins.str, rep_interval: Optional[_builtins.int] = ...) -> None:
        ...
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings(dict):
    ...
    def __init__(__self__, *, output_sdt: Optional[_builtins.str] = ..., rep_interval: Optional[_builtins.int] = ..., service_name: Optional[_builtins.str] = ..., service_provider_name: Optional[_builtins.str] = ...) -> None:
        ...
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettings(dict):
    ...
    def __init__(__self__, *, hls_settings: outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettings, h265_packaging_type: Optional[_builtins.str] = ..., name_modifier: Optional[_builtins.str] = ..., segment_modifier: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettings(dict):
    ...
    def __init__(__self__, *, audio_only_hls_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettings] = ..., fmp4_hls_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsFmp4HlsSettings] = ..., frame_capture_hls_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsFrameCaptureHlsSettings] = ..., standard_hls_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsStandardHlsSettings] = ...) -> None:
        ...
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettings(dict):
    ...
    def __init__(__self__, *, audio_group_id: Optional[_builtins.str] = ..., audio_only_image: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettingsAudioOnlyImage] = ..., audio_track_type: Optional[_builtins.str] = ..., segment_type: Optional[_builtins.str] = ...) -> None:
        ...
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsFmp4HlsSettings(dict):
    ...
    def __init__(__self__, *, audio_rendition_sets: Optional[_builtins.str] = ..., nielsen_id3_behavior: Optional[_builtins.str] = ..., timed_metadata_behavior: Optional[_builtins.str] = ...) -> None:
        ...
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsStandardHlsSettings(dict):
    ...
    def __init__(__self__, *, m3u8_settings: outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsStandardHlsSettingsM3u8Settings, audio_rendition_sets: Optional[_builtins.str] = ...) -> None:
        ...
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsStandardHlsSettingsM3u8Settings(dict):
    ...
    def __init__(__self__, *, audio_frames_per_pes: Optional[_builtins.int] = ..., audio_pids: Optional[_builtins.str] = ..., ecm_pid: Optional[_builtins.str] = ..., nielsen_id3_behavior: Optional[_builtins.str] = ..., pat_interval: Optional[_builtins.int] = ..., pcr_control: Optional[_builtins.str] = ..., pcr_period: Optional[_builtins.int] = ..., pcr_pid: Optional[_builtins.str] = ..., pmt_interval: Optional[_builtins.int] = ..., pmt_pid: Optional[_builtins.str] = ..., program_num: Optional[_builtins.int] = ..., scte35_behavior: Optional[_builtins.str] = ..., scte35_pid: Optional[_builtins.str] = ..., timed_metadata_behavior: Optional[_builtins.str] = ..., timed_metadata_pid: Optional[_builtins.str] = ..., transport_stream_id: Optional[_builtins.int] = ..., video_pid: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsMsSmoothOutputSettings(dict):
    ...
    def __init__(__self__, *, h265_packaging_type: Optional[_builtins.str] = ..., name_modifier: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsMultiplexOutputSettings(dict):
    def __init__(__self__, *, destination: outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsMultiplexOutputSettingsDestination) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsRtmpOutputSettings(dict):
    ...
    def __init__(__self__, *, destination: outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsRtmpOutputSettingsDestination, certificate_mode: Optional[_builtins.str] = ..., connection_retry_interval: Optional[_builtins.int] = ..., num_retries: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettings(dict):
    ...
    def __init__(__self__, *, container_settings: outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettingsContainerSettings, destination: outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettingsDestination, buffer_msec: Optional[_builtins.int] = ..., fec_output_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettingsFecOutputSettings] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettingsContainerSettings(dict):
    ...
    def __init__(__self__, *, m2ts_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettings] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettings(dict):
    ...
    def __init__(__self__, *, absent_input_audio_behavior: Optional[_builtins.str] = ..., arib: Optional[_builtins.str] = ..., arib_captions_pid: Optional[_builtins.str] = ..., arib_captions_pid_control: Optional[_builtins.str] = ..., audio_buffer_model: Optional[_builtins.str] = ..., audio_frames_per_pes: Optional[_builtins.int] = ..., audio_pids: Optional[_builtins.str] = ..., audio_stream_type: Optional[_builtins.str] = ..., bitrate: Optional[_builtins.int] = ..., buffer_model: Optional[_builtins.str] = ..., cc_descriptor: Optional[_builtins.str] = ..., dvb_nit_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings] = ..., dvb_sdt_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings] = ..., dvb_sub_pids: Optional[_builtins.str] = ..., dvb_tdt_settings: Optional[outputs.ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettingsContainerSettingsM2tsSettingsDvbTdtSettings] = ..., dvb_teletext_pid: Optional[_builtins.str] = ..., ebif: Optional[_builtins.str] = ..., ebp_audio_interval: Optional[_builtins.str] = ..., ebp_lookahead_ms: Optional[_builtins.int] = ..., ebp_placement: Optional[_builtins.str] = ..., ecm_pid: Optional[_builtins.str] = ..., es_rate_in_pes: Optional[_builtins.str] = ..., etv_platform_pid: Optional[_builtins.str] = ..., etv_signal_pid: Optional[_builtins.str] = ..., fragment_time: Optional[_builtins.float] = ..., klv: Optional[_builtins.str] = ..., klv_data_pids: Optional[_builtins.str] = ..., nielsen_id3_behavior: Optional[_builtins.str] = ..., null_packet_bitrate: Optional[_builtins.float] = ..., pat_interval: Optional[_builtins.int] = ..., pcr_control: Optional[_builtins.str] = ..., pcr_period: Optional[_builtins.int] = ..., pcr_pid: Optional[_builtins.str] = ..., pmt_interval: Optional[_builtins.int] = ..., pmt_pid: Optional[_builtins.str] = ..., program_num: Optional[_builtins.int] = ..., rate_mode: Optional[_builtins.str] = ..., scte27_pids: Optional[_builtins.str] = ..., scte35_control: Optional[_builtins.str] = ..., scte35_pid: Optional[_builtins.str] = ..., segmentation_markers: Optional[_builtins.str] = ..., segmentation_style: Optional[_builtins.str] = ..., segmentation_time: Optional[_builtins.float] = ..., timed_metadata_behavior: Optional[_builtins.str] = ..., timed_metadata_pid: Optional[_builtins.str] = ..., transport_stream_id: Optional[_builtins.int] = ..., video_pid: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettingsFecOutputSettings(dict):
    ...
    def __init__(__self__, *, column_depth: Optional[_builtins.int] = ..., include_fec: Optional[_builtins.str] = ..., row_length: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsTimecodeConfig(dict):
    ...
    def __init__(__self__, *, source: _builtins.str, sync_threshold: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsVideoDescription(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, codec_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettings] = ..., height: Optional[_builtins.int] = ..., respond_to_afd: Optional[_builtins.str] = ..., scaling_behavior: Optional[_builtins.str] = ..., sharpness: Optional[_builtins.int] = ..., width: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsVideoDescriptionCodecSettings(dict):
    ...
    def __init__(__self__, *, frame_capture_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsFrameCaptureSettings] = ..., h264_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH264Settings] = ..., h265_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH265Settings] = ...) -> None:
...
class ChannelEncoderSettingsVideoDescriptionCodecSettingsFrameCaptureSettings(dict):
    ...
    def __init__(__self__, *, capture_interval: Optional[_builtins.int] = ..., capture_interval_units: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsVideoDescriptionCodecSettingsH264Settings(dict):
    ...
    def __init__(__self__, *, adaptive_quantization: Optional[_builtins.str] = ..., afd_signaling: Optional[_builtins.str] = ..., bitrate: Optional[_builtins.int] = ..., buf_fill_pct: Optional[_builtins.int] = ..., buf_size: Optional[_builtins.int] = ..., color_metadata: Optional[_builtins.str] = ..., entropy_encoding: Optional[_builtins.str] = ..., filter_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH264SettingsFilterSettings] = ..., fixed_afd: Optional[_builtins.str] = ..., flicker_aq: Optional[_builtins.str] = ..., force_field_pictures: Optional[_builtins.str] = ..., framerate_control: Optional[_builtins.str] = ..., framerate_denominator: Optional[_builtins.int] = ..., framerate_numerator: Optional[_builtins.int] = ..., gop_b_reference: Optional[_builtins.str] = ..., gop_closed_cadence: Optional[_builtins.int] = ..., gop_num_b_frames: Optional[_builtins.int] = ..., gop_size: Optional[_builtins.float] = ..., gop_size_units: Optional[_builtins.str] = ..., level: Optional[_builtins.str] = ..., look_ahead_rate_control: Optional[_builtins.str] = ..., max_bitrate: Optional[_builtins.int] = ..., min_i_interval: Optional[_builtins.int] = ..., num_ref_frames: Optional[_builtins.int] = ..., par_control: Optional[_builtins.str] = ..., par_denominator: Optional[_builtins.int] = ..., par_numerator: Optional[_builtins.int] = ..., profile: Optional[_builtins.str] = ..., quality_level: Optional[_builtins.str] = ..., qvbr_quality_level: Optional[_builtins.int] = ..., rate_control_mode: Optional[_builtins.str] = ..., scan_type: Optional[_builtins.str] = ..., scene_change_detect: Optional[_builtins.str] = ..., slices: Optional[_builtins.int] = ..., softness: Optional[_builtins.int] = ..., spatial_aq: Optional[_builtins.str] = ..., subgop_length: Optional[_builtins.str] = ..., syntax: Optional[_builtins.str] = ..., temporal_aq: Optional[_builtins.str] = ..., timecode_insertion: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsVideoDescriptionCodecSettingsH264SettingsFilterSettings(dict):
    ...
    def __init__(__self__, *, temporal_filter_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH264SettingsFilterSettingsTemporalFilterSettings] = ...) -> None:
        ...
...
class ChannelEncoderSettingsVideoDescriptionCodecSettingsH264SettingsFilterSettingsTemporalFilterSettings(dict):
    ...
    def __init__(__self__, *, post_filter_sharpening: Optional[_builtins.str] = ..., strength: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsVideoDescriptionCodecSettingsH265Settings(dict):
    ...
    def __init__(__self__, *, bitrate: _builtins.int, framerate_denominator: _builtins.int, framerate_numerator: _builtins.int, adaptive_quantization: Optional[_builtins.str] = ..., afd_signaling: Optional[_builtins.str] = ..., alternative_transfer_function: Optional[_builtins.str] = ..., buf_size: Optional[_builtins.int] = ..., color_metadata: Optional[_builtins.str] = ..., color_space_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettings] = ..., filter_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsFilterSettings] = ..., fixed_afd: Optional[_builtins.str] = ..., flicker_aq: Optional[_builtins.str] = ..., gop_closed_cadence: Optional[_builtins.int] = ..., gop_size: Optional[_builtins.float] = ..., gop_size_units: Optional[_builtins.str] = ..., level: Optional[_builtins.str] = ..., look_ahead_rate_control: Optional[_builtins.str] = ..., max_bitrate: Optional[_builtins.int] = ..., min_i_interval: Optional[_builtins.int] = ..., min_qp: Optional[_builtins.int] = ..., mv_over_picture_boundaries: Optional[_builtins.str] = ..., mv_temporal_predictor: Optional[_builtins.str] = ..., par_denominator: Optional[_builtins.int] = ..., par_numerator: Optional[_builtins.int] = ..., profile: Optional[_builtins.str] = ..., qvbr_quality_level: Optional[_builtins.int] = ..., rate_control_mode: Optional[_builtins.str] = ..., scan_type: Optional[_builtins.str] = ..., scene_change_detect: Optional[_builtins.str] = ..., slices: Optional[_builtins.int] = ..., tier: Optional[_builtins.str] = ..., tile_height: Optional[_builtins.int] = ..., tile_padding: Optional[_builtins.str] = ..., tile_width: Optional[_builtins.int] = ..., timecode_burnin_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsTimecodeBurninSettings] = ..., timecode_insertion: Optional[_builtins.str] = ..., treeblock_size: Optional[_builtins.str] = ...) -> None:
...
class ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettings(dict):
    ...
    def __init__(__self__, *, color_space_passthrough_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettingsColorSpacePassthroughSettings] = ..., dolby_vision81_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettingsDolbyVision81Settings] = ..., hdr10_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettingsHdr10Settings] = ..., rec601_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettingsRec601Settings] = ..., rec709_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettingsRec709Settings] = ...) -> None:
...
class ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettingsHdr10Settings(dict):
    ...
    def __init__(__self__, *, max_cll: Optional[_builtins.int] = ..., max_fall: Optional[_builtins.int] = ...) -> None:
...
class ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsFilterSettings(dict):
    ...
    def __init__(__self__, *, temporal_filter_settings: Optional[outputs.ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsFilterSettingsTemporalFilterSettings] = ...) -> None:
        ...
...
class ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsTimecodeBurninSettings(dict):
    ...
    def __init__(__self__, *, prefix: Optional[_builtins.str] = ..., timecode_burnin_font_size: Optional[_builtins.str] = ..., timecode_burnin_position: Optional[_builtins.str] = ...) -> None:
...
class ChannelInputAttachment(dict):
    ...
    def __init__(__self__, *, input_attachment_name: _builtins.str, input_id: _builtins.str, automatic_input_failover_settings: Optional[outputs.ChannelInputAttachmentAutomaticInputFailoverSettings] = ..., input_settings: Optional[outputs.ChannelInputAttachmentInputSettings] = ...) -> None:
...
class ChannelInputAttachmentAutomaticInputFailoverSettings(dict):
    ...
    def __init__(__self__, *, secondary_input_id: _builtins.str, error_clear_time_msec: Optional[_builtins.int] = ..., failover_conditions: Optional[Sequence[outputs.ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverCondition]] = ..., input_preference: Optional[_builtins.str] = ...) -> None:
...
class ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverCondition(dict):
    ...
    def __init__(__self__, *, failover_condition_settings: Optional[outputs.ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettings] = ...) -> None:
...
class ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettings(dict):
    ...
    def __init__(__self__, *, audio_silence_settings: Optional[outputs.ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsAudioSilenceSettings] = ..., input_loss_settings: Optional[outputs.ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsInputLossSettings] = ..., video_black_settings: Optional[outputs.ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsVideoBlackSettings] = ...) -> None:
...
class ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsAudioSilenceSettings(dict):
    ...
    def __init__(__self__, *, audio_selector_name: _builtins.str, audio_silence_threshold_msec: Optional[_builtins.int] = ...) -> None:
...
class ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsInputLossSettings(dict):
    ...
    def __init__(__self__, *, input_loss_threshold_msec: Optional[_builtins.int] = ...) -> None:
...
class ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsVideoBlackSettings(dict):
    ...
    def __init__(__self__, *, black_detect_threshold: Optional[_builtins.float] = ..., video_black_threshold_msec: Optional[_builtins.int] = ...) -> None:
...
class ChannelInputAttachmentInputSettings(dict):
    ...
    def __init__(__self__, *, audio_selectors: Optional[Sequence[outputs.ChannelInputAttachmentInputSettingsAudioSelector]] = ..., caption_selectors: Optional[Sequence[outputs.ChannelInputAttachmentInputSettingsCaptionSelector]] = ..., deblock_filter: Optional[_builtins.str] = ..., denoise_filter: Optional[_builtins.str] = ..., filter_strength: Optional[_builtins.int] = ..., input_filter: Optional[_builtins.str] = ..., network_input_settings: Optional[outputs.ChannelInputAttachmentInputSettingsNetworkInputSettings] = ..., scte35_pid: Optional[_builtins.int] = ..., smpte2038_data_preference: Optional[_builtins.str] = ..., source_end_behavior: Optional[_builtins.str] = ..., video_selector: Optional[outputs.ChannelInputAttachmentInputSettingsVideoSelector] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsAudioSelector(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, selector_settings: Optional[outputs.ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettings] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettings(dict):
    ...
    def __init__(__self__, *, audio_hls_rendition_selection: Optional[outputs.ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettingsAudioHlsRenditionSelection] = ..., audio_language_selection: Optional[outputs.ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettingsAudioLanguageSelection] = ..., audio_pid_selection: Optional[outputs.ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettingsAudioPidSelection] = ..., audio_track_selection: Optional[outputs.ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettingsAudioTrackSelection] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettingsAudioLanguageSelection(dict):
    ...
    def __init__(__self__, *, language_code: _builtins.str, language_selection_policy: Optional[_builtins.str] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettingsAudioTrackSelection(dict):
    ...
    def __init__(__self__, *, tracks: Sequence[outputs.ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettingsAudioTrackSelectionTrack], dolby_e_decode: Optional[outputs.ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettingsAudioTrackSelectionDolbyEDecode] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsCaptionSelector(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, language_code: Optional[_builtins.str] = ..., selector_settings: Optional[outputs.ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettings] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettings(dict):
    ...
    def __init__(__self__, *, ancillary_source_settings: Optional[outputs.ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsAncillarySourceSettings] = ..., arib_source_settings: Optional[outputs.ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsAribSourceSettings] = ..., dvb_sub_source_settings: Optional[outputs.ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsDvbSubSourceSettings] = ..., embedded_source_settings: Optional[outputs.ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsEmbeddedSourceSettings] = ..., scte20_source_settings: Optional[outputs.ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsScte20SourceSettings] = ..., scte27_source_settings: Optional[outputs.ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsScte27SourceSettings] = ..., teletext_source_settings: Optional[outputs.ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsTeletextSourceSettings] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsAncillarySourceSettings(dict):
    ...
    def __init__(__self__, *, source_ancillary_channel_number: Optional[_builtins.int] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsDvbSubSourceSettings(dict):
    ...
    def __init__(__self__, *, ocr_language: Optional[_builtins.str] = ..., pid: Optional[_builtins.int] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsEmbeddedSourceSettings(dict):
    ...
    def __init__(__self__, *, convert608_to708: Optional[_builtins.str] = ..., scte20_detection: Optional[_builtins.str] = ..., source608_channel_number: Optional[_builtins.int] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsScte20SourceSettings(dict):
    ...
    def __init__(__self__, *, convert608_to708: Optional[_builtins.str] = ..., source608_channel_number: Optional[_builtins.int] = ...) -> None:
        ...
...
class ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsTeletextSourceSettings(dict):
    ...
    def __init__(__self__, *, output_rectangle: Optional[outputs.ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsTeletextSourceSettingsOutputRectangle] = ..., page_number: Optional[_builtins.str] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsTeletextSourceSettingsOutputRectangle(dict):
    ...
    def __init__(__self__, *, height: _builtins.float, left_offset: _builtins.float, top_offset: _builtins.float, width: _builtins.float) -> None:
...
class ChannelInputAttachmentInputSettingsNetworkInputSettings(dict):
    ...
    def __init__(__self__, *, hls_input_settings: Optional[outputs.ChannelInputAttachmentInputSettingsNetworkInputSettingsHlsInputSettings] = ..., server_validation: Optional[_builtins.str] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsNetworkInputSettingsHlsInputSettings(dict):
    ...
    def __init__(__self__, *, bandwidth: Optional[_builtins.int] = ..., buffer_segments: Optional[_builtins.int] = ..., retries: Optional[_builtins.int] = ..., retry_interval: Optional[_builtins.int] = ..., scte35_source: Optional[_builtins.str] = ...) -> None:
...
class ChannelInputAttachmentInputSettingsVideoSelector(dict):
    ...
    def __init__(__self__, *, color_space: Optional[_builtins.str] = ..., color_space_usage: Optional[_builtins.str] = ...) -> None:
        ...
...
class ChannelInputSpecification(dict):
    ...
    def __init__(__self__, *, codec: _builtins.str, input_resolution: _builtins.str, maximum_bitrate: _builtins.str) -> None:
        ...
...
class ChannelMaintenance(dict):
    ...
    def __init__(__self__, *, maintenance_day: _builtins.str, maintenance_start_time: _builtins.str) -> None:
...
class ChannelVpc(dict):
    ...
    def __init__(__self__, *, public_address_allocation_ids: Sequence[_builtins.str], subnet_ids: Sequence[_builtins.str], availability_zones: Optional[Sequence[_builtins.str]] = ..., network_interface_ids: Optional[Sequence[_builtins.str]] = ..., security_group_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class InputSource(dict):
    ...
    def __init__(__self__, *, password_param: _builtins.str, url: _builtins.str, username: _builtins.str) -> None:
...
class InputVpc(dict):
    ...
    def __init__(__self__, *, subnet_ids: Sequence[_builtins.str], security_group_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class MultiplexMultiplexSettings(dict):
    ...
    def __init__(__self__, *, transport_stream_bitrate: _builtins.int, transport_stream_id: _builtins.int, maximum_video_buffer_delay_milliseconds: Optional[_builtins.int] = ..., transport_stream_reserved_bitrate: Optional[_builtins.int] = ...) -> None:
...
class MultiplexProgramMultiplexProgramSettings(dict):
    ...
    def __init__(__self__, *, preferred_channel_pipeline: _builtins.str, program_number: _builtins.int, service_descriptor: Optional[outputs.MultiplexProgramMultiplexProgramSettingsServiceDescriptor] = ..., video_settings: Optional[outputs.MultiplexProgramMultiplexProgramSettingsVideoSettings] = ...) -> None:
...
class MultiplexProgramMultiplexProgramSettingsServiceDescriptor(dict):
    ...
    def __init__(__self__, *, provider_name: _builtins.str, service_name: _builtins.str) -> None:
...
class MultiplexProgramMultiplexProgramSettingsVideoSettings(dict):
    ...
    def __init__(__self__, *, constant_bitrate: Optional[_builtins.int] = ..., statmux_settings: Optional[outputs.MultiplexProgramMultiplexProgramSettingsVideoSettingsStatmuxSettings] = ...) -> None:
...
class MultiplexProgramMultiplexProgramSettingsVideoSettingsStatmuxSettings(dict):
    ...
    def __init__(__self__, *, maximum_bitrate: Optional[_builtins.int] = ..., minimum_bitrate: Optional[_builtins.int] = ..., priority: Optional[_builtins.int] = ...) -> None:
...
class GetInputDestinationResult(dict):
    def __init__(__self__, *, ip: _builtins.str, port: _builtins.str, url: _builtins.str, vpcs: Sequence[outputs.GetInputDestinationVpcResult]) -> None:
        ...
...
class GetInputDestinationVpcResult(dict):
    def __init__(__self__, *, availability_zone: _builtins.str, network_interface_id: _builtins.str) -> None:
        ...
