...
class GetDedicatedHostResult:
    ...
    def __init__(__self__, arn=..., asset_id=..., auto_placement=..., availability_zone=..., cores=..., filters=..., host_id=..., host_recovery=..., id=..., instance_family=..., instance_type=..., outpost_arn=..., owner_id=..., region=..., sockets=..., tags=..., total_vcpus=...) -> None:
        ...
...
def get_dedicated_host(filters: Optional[Sequence[Union[GetDedicatedHostFilterArgs, GetDedicatedHostFilterArgsDict]]] = ..., host_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDedicatedHostResult:
    
    ...

def get_dedicated_host_output(filters: Optional[pulumi.Input[Optional[Sequence[Union[GetDedicatedHostFilterArgs, GetDedicatedHostFilterArgsDict]]]]] = ..., host_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDedicatedHostResult]:
