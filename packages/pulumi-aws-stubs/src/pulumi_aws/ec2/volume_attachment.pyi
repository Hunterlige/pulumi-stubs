...
class VolumeAttachmentArgs:
    def __init__(__self__, *, device_name: pulumi.Input[_builtins.str], instance_id: pulumi.Input[_builtins.str], volume_id: pulumi.Input[_builtins.str], force_detach: Optional[pulumi.Input[_builtins.bool]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., skip_destroy: Optional[pulumi.Input[_builtins.bool]] = ..., stop_instance_before_detaching: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @force_detach.setter
    def force_detach(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def stop_instance_before_detaching(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class _VolumeAttachmentState:
    def __init__(__self__, *, device_name: Optional[pulumi.Input[_builtins.str]] = ..., force_detach: Optional[pulumi.Input[_builtins.bool]] = ..., instance_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., skip_destroy: Optional[pulumi.Input[_builtins.bool]] = ..., stop_instance_before_detaching: Optional[pulumi.Input[_builtins.bool]] = ..., volume_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VolumeAttachment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., device_name: Optional[pulumi.Input[_builtins.str]] = ..., force_detach: Optional[pulumi.Input[_builtins.bool]] = ..., instance_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., skip_destroy: Optional[pulumi.Input[_builtins.bool]] = ..., stop_instance_before_detaching: Optional[pulumi.Input[_builtins.bool]] = ..., volume_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: VolumeAttachmentArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., device_name: Optional[pulumi.Input[_builtins.str]] = ..., force_detach: Optional[pulumi.Input[_builtins.bool]] = ..., instance_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., skip_destroy: Optional[pulumi.Input[_builtins.bool]] = ..., stop_instance_before_detaching: Optional[pulumi.Input[_builtins.bool]] = ..., volume_id: Optional[pulumi.Input[_builtins.str]] = ...) -> VolumeAttachment:
