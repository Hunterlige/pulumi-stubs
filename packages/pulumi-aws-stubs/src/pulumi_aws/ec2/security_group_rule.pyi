...
class SecurityGroupRuleArgs:
    def __init__(__self__, *, from_port: pulumi.Input[_builtins.int], protocol: pulumi.Input[Union[_builtins.str, ProtocolType]], security_group_id: pulumi.Input[_builtins.str], to_port: pulumi.Input[_builtins.int], type: pulumi.Input[_builtins.str], cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., ipv6_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., prefix_list_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., self: Optional[pulumi.Input[_builtins.bool]] = ..., source_security_group_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class _SecurityGroupRuleState:
    def __init__(__self__, *, cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., from_port: Optional[pulumi.Input[_builtins.int]] = ..., ipv6_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., prefix_list_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., protocol: Optional[pulumi.Input[Union[_builtins.str, ProtocolType]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., security_group_id: Optional[pulumi.Input[_builtins.str]] = ..., security_group_rule_id: Optional[pulumi.Input[_builtins.str]] = ..., self: Optional[pulumi.Input[_builtins.bool]] = ..., source_security_group_id: Optional[pulumi.Input[_builtins.str]] = ..., to_port: Optional[pulumi.Input[_builtins.int]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SecurityGroupRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., from_port: Optional[pulumi.Input[_builtins.int]] = ..., ipv6_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., prefix_list_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., protocol: Optional[pulumi.Input[Union[_builtins.str, ProtocolType]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., security_group_id: Optional[pulumi.Input[_builtins.str]] = ..., self: Optional[pulumi.Input[_builtins.bool]] = ..., source_security_group_id: Optional[pulumi.Input[_builtins.str]] = ..., to_port: Optional[pulumi.Input[_builtins.int]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: SecurityGroupRuleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., from_port: Optional[pulumi.Input[_builtins.int]] = ..., ipv6_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., prefix_list_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., protocol: Optional[pulumi.Input[Union[_builtins.str, ProtocolType]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., security_group_id: Optional[pulumi.Input[_builtins.str]] = ..., security_group_rule_id: Optional[pulumi.Input[_builtins.str]] = ..., self: Optional[pulumi.Input[_builtins.bool]] = ..., source_security_group_id: Optional[pulumi.Input[_builtins.str]] = ..., to_port: Optional[pulumi.Input[_builtins.int]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> SecurityGroupRule:
