...
class VpcIpamPoolCidrAllocationArgs:
    def __init__(__self__, *, ipam_pool_id: pulumi.Input[_builtins.str], cidr: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., disallowed_cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., netmask_length: Optional[pulumi.Input[_builtins.int]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class _VpcIpamPoolCidrAllocationState:
    def __init__(__self__, *, cidr: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., disallowed_cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ipam_pool_allocation_id: Optional[pulumi.Input[_builtins.str]] = ..., ipam_pool_id: Optional[pulumi.Input[_builtins.str]] = ..., netmask_length: Optional[pulumi.Input[_builtins.int]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_owner: Optional[pulumi.Input[_builtins.str]] = ..., resource_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ipam_pool_allocation_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VpcIpamPoolCidrAllocation(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: VpcIpamPoolCidrAllocationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
