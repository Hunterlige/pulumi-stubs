...
class SerialConsoleAccess(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: Optional[SerialConsoleAccessArgs] = ..., opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> SerialConsoleAccess:
