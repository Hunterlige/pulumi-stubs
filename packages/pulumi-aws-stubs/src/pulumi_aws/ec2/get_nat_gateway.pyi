...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetNatGatewayResult', 'AwaitableGetNatGatewayResult', 'get_nat_gateway', 'get_nat_gateway_output']
@pulumi.output_type
class GetNatGatewayResult:
    
    def __init__(__self__, allocation_id=..., association_id=..., auto_provision_zones=..., auto_scaling_ips=..., availability_mode=..., availability_zone_addresses=..., connectivity_type=..., filters=..., id=..., network_interface_id=..., private_ip=..., public_ip=..., region=..., regional_nat_gateway_addresses=..., route_table_id=..., secondary_allocation_ids=..., secondary_private_ip_address_count=..., secondary_private_ip_addresses=..., state=..., subnet_id=..., tags=..., vpc_id=...) -> None:
        ...
...
class AwaitableGetNatGatewayResult(GetNatGatewayResult):
    def __await__(self): # -> Generator[Never, Any, GetNatGatewayResult]:
        ...
    


def get_nat_gateway(filters: Optional[Sequence[Union[GetNatGatewayFilterArgs, GetNatGatewayFilterArgsDict]]] = ..., id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., subnet_id: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., vpc_id: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetNatGatewayResult:
    
    ...

def get_nat_gateway_output(filters: Optional[pulumi.Input[Optional[Sequence[Union[GetNatGatewayFilterArgs, GetNatGatewayFilterArgsDict]]]]] = ..., id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., state: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., subnet_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., vpc_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetNatGatewayResult]:
