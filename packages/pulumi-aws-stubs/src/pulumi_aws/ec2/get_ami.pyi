...
class GetAmiResult:
    ...
    def __init__(__self__, allow_unsafe_filter=..., architecture=..., arn=..., block_device_mappings=..., boot_mode=..., creation_date=..., deprecation_time=..., description=..., ena_support=..., executable_users=..., filters=..., hypervisor=..., id=..., image_id=..., image_location=..., image_owner_alias=..., image_type=..., imds_support=..., include_deprecated=..., kernel_id=..., last_launched_time=..., most_recent=..., name=..., name_regex=..., owner_id=..., owners=..., platform=..., platform_details=..., product_codes=..., public=..., ramdisk_id=..., region=..., root_device_name=..., root_device_type=..., root_snapshot_id=..., sriov_net_support=..., state=..., state_reason=..., tags=..., tpm_support=..., uefi_data=..., usage_operation=..., virtualization_type=...) -> None:
        ...
...
class AwaitableGetAmiResult(GetAmiResult):
    def __await__(self): # -> Generator[Never, Any, GetAmiResult]:
        ...
    


def get_ami(allow_unsafe_filter: Optional[_builtins.bool] = ..., executable_users: Optional[Sequence[_builtins.str]] = ..., filters: Optional[Sequence[Union[GetAmiFilterArgs, GetAmiFilterArgsDict]]] = ..., include_deprecated: Optional[_builtins.bool] = ..., most_recent: Optional[_builtins.bool] = ..., name_regex: Optional[_builtins.str] = ..., owners: Optional[Sequence[_builtins.str]] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., uefi_data: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetAmiResult:
    
    ...

def get_ami_output(allow_unsafe_filter: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., executable_users: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = ..., filters: Optional[pulumi.Input[Optional[Sequence[Union[GetAmiFilterArgs, GetAmiFilterArgsDict]]]]] = ..., include_deprecated: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., most_recent: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., name_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., owners: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., uefi_data: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetAmiResult]:
