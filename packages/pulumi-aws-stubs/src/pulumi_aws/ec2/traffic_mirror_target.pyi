...
class TrafficMirrorTargetArgs:
    def __init__(
        ...
        *,
        ...
        gateway_load_balancer_endpoint_id: Optional[pulumi.Input[_builtins.str]] = ...,
        network_interface_id: Optional[pulumi.Input[_builtins.str]] = ...,
        network_load_balancer_arn: Optional[pulumi.Input[_builtins.str]] = ...,
...
class TrafficMirrorTarget(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[TrafficMirrorTargetArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
