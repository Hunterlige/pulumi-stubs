...
class AwaitableGetInstanceTypeResult(GetInstanceTypeResult):
    def __await__(self): # -> Generator[Never, Any, GetInstanceTypeResult]:
        ...
    


def get_instance_type(instance_type: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetInstanceTypeResult:
    
    ...

def get_instance_type_output(instance_type: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetInstanceTypeResult]:
