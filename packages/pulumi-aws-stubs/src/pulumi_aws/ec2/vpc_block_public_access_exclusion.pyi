...
class VpcBlockPublicAccessExclusionArgs:
    def __init__(
        ...
        *,
        ...
        timeouts: Optional[
            pulumi.Input[VpcBlockPublicAccessExclusionTimeoutsArgs]
        ] = ...,
    ...
    def timeouts(
        self,
    ) -> Optional[pulumi.Input[VpcBlockPublicAccessExclusionTimeoutsArgs]]: ...
    @timeouts.setter
    def timeouts(
        self, value: Optional[pulumi.Input[VpcBlockPublicAccessExclusionTimeoutsArgs]]
    ): ...
    @_builtins.property
...
class _VpcBlockPublicAccessExclusionState:
    def __init__(
        __self__,
        *,
        internet_gateway_exclusion_mode: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
...
class VpcBlockPublicAccessExclusion(pulumi.CustomResource):
    ...
    def timeouts(
        self,
    ) -> pulumi.Output[Optional[outputs.VpcBlockPublicAccessExclusionTimeouts]]: ...
    @_builtins.property
    @pulumi.getter(name="vpcId")
