...
class DefaultRouteTableArgs:
    def __init__(
        ...
        *,
        ...
        routes: Optional[
            pulumi.Input[Sequence[pulumi.Input[DefaultRouteTableRouteArgs]]]
        ] = ...,
    ...
    def routes(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[DefaultRouteTableRouteArgs]]]]: ...
    @routes.setter
    def routes(
        self,
        value: Optional[
        ...
        routes: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[
                            DefaultRouteTableRouteArgs, DefaultRouteTableRouteArgsDict
                        ]
                    ]
                ]
            ]
