...
class ManagedPrefixListArgs:
    def __init__(
        ...
        *,
        ...
        entries: Optional[
            pulumi.Input[Sequence[pulumi.Input[ManagedPrefixListEntryArgs]]]
        ] = ...,
    ...
    def entries(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[ManagedPrefixListEntryArgs]]]]: ...
    @entries.setter
    def entries(
        self,
        value: Optional[
...
class _ManagedPrefixListState:
    def __init__(
        ...
        *,
        ...
        max_entries: Optional[pulumi.Input[_builtins.int]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        ...
        entries: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[
                            ManagedPrefixListEntryArgs, ManagedPrefixListEntryArgsDict
                        ]
                    ]
                ]
            ]
