...
class GetInstanceResult:
    ...
    def __init__(__self__, ami=..., arn=..., associate_public_ip_address=..., availability_zone=..., credit_specifications=..., disable_api_stop=..., disable_api_termination=..., ebs_block_devices=..., ebs_optimized=..., enclave_options=..., ephemeral_block_devices=..., filters=..., get_password_data=..., get_user_data=..., host_id=..., host_resource_group_arn=..., iam_instance_profile=..., id=..., instance_id=..., instance_state=..., instance_tags=..., instance_type=..., ipv6_addresses=..., key_name=..., launch_time=..., maintenance_options=..., metadata_options=..., monitoring=..., network_interface_id=..., outpost_arn=..., password_data=..., placement_group=..., placement_group_id=..., placement_partition_number=..., private_dns=..., private_dns_name_options=..., private_ip=..., public_dns=..., public_ip=..., region=..., root_block_devices=..., secondary_private_ips=..., security_groups=..., source_dest_check=..., subnet_id=..., tags=..., tenancy=..., user_data=..., user_data_base64=..., vpc_security_group_ids=...) -> None:
        ...
...
def get_instance(filters: Optional[Sequence[Union[GetInstanceFilterArgs, GetInstanceFilterArgsDict]]] = ..., get_password_data: Optional[_builtins.bool] = ..., get_user_data: Optional[_builtins.bool] = ..., instance_id: Optional[_builtins.str] = ..., instance_tags: Optional[Mapping[str, _builtins.str]] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetInstanceResult:
    
    ...

def get_instance_output(filters: Optional[pulumi.Input[Optional[Sequence[Union[GetInstanceFilterArgs, GetInstanceFilterArgsDict]]]]] = ..., get_password_data: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., get_user_data: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., instance_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., instance_tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetInstanceResult]:
