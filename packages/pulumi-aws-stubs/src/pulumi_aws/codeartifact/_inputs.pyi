...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['RepositoryExternalConnectionsArgs', 'RepositoryExternalConnectionsArgsDict', 'RepositoryUpstreamArgs', 'RepositoryUpstreamArgsDict']
...
class RepositoryExternalConnectionsArgs:
    def __init__(__self__, *, external_connection_name: pulumi.Input[_builtins.str], package_format: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def external_connection_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def package_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
