...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessPolicyAssociationAccessScopeArgs', 'AccessPolicyAssociationAccessScopeArgsDict', 'AddonPodIdentityAssociationArgs', 'AddonPodIdentityAssociationArgsDict', 'CapabilityConfigurationArgs', 'CapabilityConfigurationArgsDict', 'CapabilityConfigurationArgoCdArgs', 'CapabilityConfigurationArgoCdArgsDict', 'CapabilityConfigurationArgoCdAwsIdcArgs', 'CapabilityConfigurationArgoCdAwsIdcArgsDict', 'CapabilityConfigurationArgoCdNetworkAccessArgs', 'CapabilityConfigurationArgoCdNetworkAccessArgsDict', 'CapabilityConfigurationArgoCdRbacRoleMappingArgs', ..., ..., ..., 'CapabilityTimeoutsArgs', 'CapabilityTimeoutsArgsDict', 'ClusterAccessConfigArgs', 'ClusterAccessConfigArgsDict', 'ClusterCertificateAuthorityArgs', 'ClusterCertificateAuthorityArgsDict', 'ClusterComputeConfigArgs', 'ClusterComputeConfigArgsDict', 'ClusterControlPlaneScalingConfigArgs', 'ClusterControlPlaneScalingConfigArgsDict', 'ClusterEncryptionConfigArgs', 'ClusterEncryptionConfigArgsDict', 'ClusterEncryptionConfigProviderArgs', 'ClusterEncryptionConfigProviderArgsDict', 'ClusterIdentityArgs', 'ClusterIdentityArgsDict', 'ClusterIdentityOidcArgs', 'ClusterIdentityOidcArgsDict', 'ClusterKubernetesNetworkConfigArgs', 'ClusterKubernetesNetworkConfigArgsDict', ..., ..., 'ClusterOutpostConfigArgs', 'ClusterOutpostConfigArgsDict', 'ClusterOutpostConfigControlPlanePlacementArgs', 'ClusterOutpostConfigControlPlanePlacementArgsDict', 'ClusterRemoteNetworkConfigArgs', 'ClusterRemoteNetworkConfigArgsDict', 'ClusterRemoteNetworkConfigRemoteNodeNetworksArgs', ..., 'ClusterRemoteNetworkConfigRemotePodNetworksArgs', ..., 'ClusterStorageConfigArgs', 'ClusterStorageConfigArgsDict', 'ClusterStorageConfigBlockStorageArgs', 'ClusterStorageConfigBlockStorageArgsDict', 'ClusterUpgradePolicyArgs', 'ClusterUpgradePolicyArgsDict', 'ClusterVpcConfigArgs', 'ClusterVpcConfigArgsDict', 'ClusterZonalShiftConfigArgs', 'ClusterZonalShiftConfigArgsDict', 'FargateProfileSelectorArgs', 'FargateProfileSelectorArgsDict', 'IdentityProviderConfigOidcArgs', 'IdentityProviderConfigOidcArgsDict', 'NodeGroupLaunchTemplateArgs', 'NodeGroupLaunchTemplateArgsDict', 'NodeGroupNodeRepairConfigArgs', 'NodeGroupNodeRepairConfigArgsDict', ..., ..., 'NodeGroupRemoteAccessArgs', 'NodeGroupRemoteAccessArgsDict', 'NodeGroupResourceArgs', 'NodeGroupResourceArgsDict', 'NodeGroupResourceAutoscalingGroupArgs', 'NodeGroupResourceAutoscalingGroupArgsDict', 'NodeGroupScalingConfigArgs', 'NodeGroupScalingConfigArgsDict', 'NodeGroupTaintArgs', 'NodeGroupTaintArgsDict', 'NodeGroupUpdateConfigArgs', 'NodeGroupUpdateConfigArgsDict']
...
class AccessPolicyAssociationAccessScopeArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], namespaces: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class AddonPodIdentityAssociationArgs:
    def __init__(__self__, *, role_arn: pulumi.Input[_builtins.str], service_account: pulumi.Input[_builtins.str]) -> None:
...
class CapabilityConfigurationArgs:
    def __init__(__self__, *, argo_cd: Optional[pulumi.Input[CapabilityConfigurationArgoCdArgs]] = ...) -> None:
    ...
    @argo_cd.setter
    def argo_cd(self, value: Optional[pulumi.Input[CapabilityConfigurationArgoCdArgs]]): # -> None:
        ...
...
class CapabilityConfigurationArgoCdArgs:
    def __init__(__self__, *, aws_idc: pulumi.Input[CapabilityConfigurationArgoCdAwsIdcArgs], namespace: Optional[pulumi.Input[_builtins.str]] = ..., network_access: Optional[pulumi.Input[CapabilityConfigurationArgoCdNetworkAccessArgs]] = ..., rbac_role_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[CapabilityConfigurationArgoCdRbacRoleMappingArgs]]]] = ..., server_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @aws_idc.setter
    def aws_idc(self, value: pulumi.Input[CapabilityConfigurationArgoCdAwsIdcArgs]): # -> None:
        ...
    ...
    def network_access(self, value: Optional[pulumi.Input[CapabilityConfigurationArgoCdNetworkAccessArgs]]): # -> None:
        ...
    ...
    def rbac_role_mappings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CapabilityConfigurationArgoCdRbacRoleMappingArgs]]]]): # -> None:
        ...
...
class CapabilityConfigurationArgoCdAwsIdcArgs:
    def __init__(__self__, *, idc_instance_arn: pulumi.Input[_builtins.str], idc_managed_application_arn: Optional[pulumi.Input[_builtins.str]] = ..., idc_region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @idc_region.setter
    def idc_region(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CapabilityConfigurationArgoCdNetworkAccessArgs:
    def __init__(__self__, *, vpce_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @vpce_ids.setter
    def vpce_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class CapabilityConfigurationArgoCdRbacRoleMappingArgs:
    def __init__(__self__, *, identities: pulumi.Input[Sequence[pulumi.Input[CapabilityConfigurationArgoCdRbacRoleMappingIdentityArgs]]], role: pulumi.Input[_builtins.str]) -> None:
    ...
    @identities.setter
    def identities(self, value: pulumi.Input[Sequence[pulumi.Input[CapabilityConfigurationArgoCdRbacRoleMappingIdentityArgs]]]): # -> None:
        ...
...
class ClusterAccessConfigArgs:
    def __init__(__self__, *, authentication_mode: Optional[pulumi.Input[_builtins.str]] = ..., bootstrap_cluster_creator_admin_permissions: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def authentication_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def bootstrap_cluster_creator_admin_permissions(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ClusterCertificateAuthorityArgs:
    def __init__(__self__, *, data: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterComputeConfigArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., node_pools: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., node_role_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @node_pools.setter
    def node_pools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def node_role_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterEncryptionConfigArgs:
    def __init__(__self__, *, provider: pulumi.Input[ClusterEncryptionConfigProviderArgs], resources: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @provider.setter
    def provider(self, value: pulumi.Input[ClusterEncryptionConfigProviderArgs]): # -> None:
        ...
...
class ClusterIdentityArgs:
    def __init__(__self__, *, oidcs: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterIdentityOidcArgs]]]] = ...) -> None:
    ...
    @oidcs.setter
    def oidcs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterIdentityOidcArgs]]]]): # -> None:
        ...
...
class ClusterIdentityOidcArgs:
    def __init__(__self__, *, issuer: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterKubernetesNetworkConfigArgs:
    def __init__(__self__, *, elastic_load_balancing: Optional[pulumi.Input[ClusterKubernetesNetworkConfigElasticLoadBalancingArgs]] = ..., ip_family: Optional[pulumi.Input[_builtins.str]] = ..., service_ipv4_cidr: Optional[pulumi.Input[_builtins.str]] = ..., service_ipv6_cidr: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def elastic_load_balancing(self, value: Optional[pulumi.Input[ClusterKubernetesNetworkConfigElasticLoadBalancingArgs]]): # -> None:
        ...
    ...
    @ip_family.setter
    def ip_family(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def service_ipv4_cidr(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def service_ipv6_cidr(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterOutpostConfigArgs:
    def __init__(__self__, *, control_plane_instance_type: pulumi.Input[_builtins.str], outpost_arns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], control_plane_placement: Optional[pulumi.Input[ClusterOutpostConfigControlPlanePlacementArgs]] = ...) -> None:
    ...
    def control_plane_instance_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @outpost_arns.setter
    def outpost_arns(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def control_plane_placement(self, value: Optional[pulumi.Input[ClusterOutpostConfigControlPlanePlacementArgs]]): # -> None:
        ...
...
class ClusterRemoteNetworkConfigArgs:
    def __init__(__self__, *, remote_node_networks: pulumi.Input[ClusterRemoteNetworkConfigRemoteNodeNetworksArgs], remote_pod_networks: Optional[pulumi.Input[ClusterRemoteNetworkConfigRemotePodNetworksArgs]] = ...) -> None:
    ...
    def remote_node_networks(self, value: pulumi.Input[ClusterRemoteNetworkConfigRemoteNodeNetworksArgs]): # -> None:
        ...
    ...
    def remote_pod_networks(self, value: Optional[pulumi.Input[ClusterRemoteNetworkConfigRemotePodNetworksArgs]]): # -> None:
        ...
...
class ClusterRemoteNetworkConfigRemoteNodeNetworksArgs:
    def __init__(__self__, *, cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ClusterStorageConfigArgs:
    def __init__(__self__, *, block_storage: Optional[pulumi.Input[ClusterStorageConfigBlockStorageArgs]] = ...) -> None:
    ...
    def block_storage(self, value: Optional[pulumi.Input[ClusterStorageConfigBlockStorageArgs]]): # -> None:
        ...
...
class ClusterUpgradePolicyArgs:
    def __init__(__self__, *, support_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @support_type.setter
    def support_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterVpcConfigArgs:
    def __init__(__self__, *, subnet_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], cluster_security_group_id: Optional[pulumi.Input[_builtins.str]] = ..., endpoint_private_access: Optional[pulumi.Input[_builtins.bool]] = ..., endpoint_public_access: Optional[pulumi.Input[_builtins.bool]] = ..., public_access_cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., vpc_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cluster_security_group_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def endpoint_private_access(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def endpoint_public_access(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def public_access_cidrs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class FargateProfileSelectorArgs:
    def __init__(__self__, *, namespace: pulumi.Input[_builtins.str], labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class IdentityProviderConfigOidcArgs:
    def __init__(__self__, *, client_id: pulumi.Input[_builtins.str], identity_provider_config_name: pulumi.Input[_builtins.str], issuer_url: pulumi.Input[_builtins.str], groups_claim: Optional[pulumi.Input[_builtins.str]] = ..., groups_prefix: Optional[pulumi.Input[_builtins.str]] = ..., required_claims: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., username_claim: Optional[pulumi.Input[_builtins.str]] = ..., username_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def identity_provider_config_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @groups_claim.setter
    def groups_claim(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def groups_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def required_claims(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def username_claim(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def username_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NodeGroupLaunchTemplateArgs:
    def __init__(__self__, *, version: pulumi.Input[_builtins.str], id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NodeGroupNodeRepairConfigArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., max_parallel_nodes_repaired_count: Optional[pulumi.Input[_builtins.int]] = ..., max_parallel_nodes_repaired_percentage: Optional[pulumi.Input[_builtins.int]] = ..., max_unhealthy_node_threshold_count: Optional[pulumi.Input[_builtins.int]] = ..., max_unhealthy_node_threshold_percentage: Optional[pulumi.Input[_builtins.int]] = ..., node_repair_config_overrides: Optional[pulumi.Input[Sequence[pulumi.Input[NodeGroupNodeRepairConfigNodeRepairConfigOverrideArgs]]]] = ...) -> None:
    ...
    def max_parallel_nodes_repaired_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_parallel_nodes_repaired_percentage(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_unhealthy_node_threshold_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_unhealthy_node_threshold_percentage(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def node_repair_config_overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NodeGroupNodeRepairConfigNodeRepairConfigOverrideArgs]]]]): # -> None:
        ...
...
class NodeGroupNodeRepairConfigNodeRepairConfigOverrideArgs:
    def __init__(__self__, *, min_repair_wait_time_mins: pulumi.Input[_builtins.int], node_monitoring_condition: pulumi.Input[_builtins.str], node_unhealthy_reason: pulumi.Input[_builtins.str], repair_action: pulumi.Input[_builtins.str]) -> None:
    ...
    def min_repair_wait_time_mins(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def node_monitoring_condition(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def node_unhealthy_reason(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def repair_action(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class NodeGroupRemoteAccessArgs:
    def __init__(__self__, *, ec2_ssh_key: Optional[pulumi.Input[_builtins.str]] = ..., source_security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @ec2_ssh_key.setter
    def ec2_ssh_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def source_security_group_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class NodeGroupResourceArgs:
    def __init__(__self__, *, autoscaling_groups: Optional[pulumi.Input[Sequence[pulumi.Input[NodeGroupResourceAutoscalingGroupArgs]]]] = ..., remote_access_security_group_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def autoscaling_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NodeGroupResourceAutoscalingGroupArgs]]]]): # -> None:
        ...
    ...
    def remote_access_security_group_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NodeGroupScalingConfigArgs:
    def __init__(__self__, *, desired_size: pulumi.Input[_builtins.int], max_size: pulumi.Input[_builtins.int], min_size: pulumi.Input[_builtins.int]) -> None:
    ...
    @desired_size.setter
    def desired_size(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class NodeGroupTaintArgs:
    def __init__(__self__, *, effect: pulumi.Input[_builtins.str], key: pulumi.Input[_builtins.str], value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NodeGroupUpdateConfigArgs:
    def __init__(__self__, *, max_unavailable: Optional[pulumi.Input[_builtins.int]] = ..., max_unavailable_percentage: Optional[pulumi.Input[_builtins.int]] = ..., update_strategy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def max_unavailable_percentage(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
