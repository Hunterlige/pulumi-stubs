...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['LinkLinkConfiguration', 'LinkLinkConfigurationLogGroupConfiguration', 'LinkLinkConfigurationMetricConfiguration', 'GetLinkLinkConfigurationResult', ..., 'GetLinkLinkConfigurationMetricConfigurationResult']
@pulumi.output_type
class LinkLinkConfiguration(dict):
    ...
    def __init__(__self__, *, log_group_configuration: Optional[outputs.LinkLinkConfigurationLogGroupConfiguration] = ..., metric_configuration: Optional[outputs.LinkLinkConfigurationMetricConfiguration] = ...) -> None:
...
class GetLinkLinkConfigurationResult(dict):
    def __init__(__self__, *, log_group_configurations: Sequence[outputs.GetLinkLinkConfigurationLogGroupConfigurationResult], metric_configurations: Sequence[outputs.GetLinkLinkConfigurationMetricConfigurationResult]) -> None:
