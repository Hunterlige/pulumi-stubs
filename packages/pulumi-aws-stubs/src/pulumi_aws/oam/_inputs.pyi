...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['LinkLinkConfigurationArgs', 'LinkLinkConfigurationArgsDict', 'LinkLinkConfigurationLogGroupConfigurationArgs', 'LinkLinkConfigurationLogGroupConfigurationArgsDict', 'LinkLinkConfigurationMetricConfigurationArgs', 'LinkLinkConfigurationMetricConfigurationArgsDict']
...
class LinkLinkConfigurationArgs:
    def __init__(__self__, *, log_group_configuration: Optional[pulumi.Input[LinkLinkConfigurationLogGroupConfigurationArgs]] = ..., metric_configuration: Optional[pulumi.Input[LinkLinkConfigurationMetricConfigurationArgs]] = ...) -> None:
    ...
    def log_group_configuration(self, value: Optional[pulumi.Input[LinkLinkConfigurationLogGroupConfigurationArgs]]): # -> None:
        ...
    ...
    def metric_configuration(self, value: Optional[pulumi.Input[LinkLinkConfigurationMetricConfigurationArgs]]): # -> None:
        ...
