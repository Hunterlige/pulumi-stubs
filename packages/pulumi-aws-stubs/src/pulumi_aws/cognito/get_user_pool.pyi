...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetUserPoolResult', 'AwaitableGetUserPoolResult', 'get_user_pool', 'get_user_pool_output']
@pulumi.output_type
class GetUserPoolResult:
    
    def __init__(__self__, account_recovery_settings=..., admin_create_user_configs=..., arn=..., auto_verified_attributes=..., creation_date=..., custom_domain=..., deletion_protection=..., device_configurations=..., domain=..., email_configurations=..., estimated_number_of_users=..., id=..., lambda_configs=..., last_modified_date=..., mfa_configuration=..., name=..., region=..., schema_attributes=..., sms_authentication_message=..., sms_configuration_failure=..., sms_verification_message=..., tags=..., user_pool_add_ons=..., user_pool_id=..., user_pool_tags=..., username_attributes=...) -> None:
        ...
...
class AwaitableGetUserPoolResult(GetUserPoolResult):
    def __await__(self): # -> Generator[Never, Any, GetUserPoolResult]:
        ...
    


def get_user_pool(region: Optional[_builtins.str] = ..., user_pool_id: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetUserPoolResult:
    
    ...

def get_user_pool_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., user_pool_id: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetUserPoolResult]:
