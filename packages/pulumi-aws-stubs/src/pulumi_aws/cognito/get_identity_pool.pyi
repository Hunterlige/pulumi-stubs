...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetIdentityPoolResult', 'AwaitableGetIdentityPoolResult', 'get_identity_pool', 'get_identity_pool_output']
@pulumi.output_type
class GetIdentityPoolResult:
    
    def __init__(__self__, allow_classic_flow=..., allow_unauthenticated_identities=..., arn=..., cognito_identity_providers=..., developer_provider_name=..., id=..., identity_pool_name=..., openid_connect_provider_arns=..., region=..., saml_provider_arns=..., supported_login_providers=..., tags=...) -> None:
        ...
...
class AwaitableGetIdentityPoolResult(GetIdentityPoolResult):
    def __await__(self): # -> Generator[Never, Any, GetIdentityPoolResult]:
        ...
    


def get_identity_pool(identity_pool_name: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetIdentityPoolResult:
    
    ...

def get_identity_pool_output(identity_pool_name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetIdentityPoolResult]:
