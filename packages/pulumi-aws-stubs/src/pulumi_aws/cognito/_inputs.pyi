...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['IdentityPoolCognitoIdentityProviderArgs', 'IdentityPoolCognitoIdentityProviderArgsDict', 'IdentityPoolRoleAttachmentRoleMappingArgs', 'IdentityPoolRoleAttachmentRoleMappingArgsDict', ..., ..., 'LogDeliveryConfigurationLogConfigurationArgs', 'LogDeliveryConfigurationLogConfigurationArgsDict', ..., ..., ..., ..., ..., ..., 'ManagedLoginBrandingAssetArgs', 'ManagedLoginBrandingAssetArgsDict', 'ManagedUserPoolClientAnalyticsConfigurationArgs', ..., 'ManagedUserPoolClientRefreshTokenRotationArgs', 'ManagedUserPoolClientRefreshTokenRotationArgsDict', 'ManagedUserPoolClientTokenValidityUnitsArgs', 'ManagedUserPoolClientTokenValidityUnitsArgsDict', 'ResourceServerScopeArgs', 'ResourceServerScopeArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'RiskConfigurationRiskExceptionConfigurationArgs', ..., 'UserPoolAccountRecoverySettingArgs', 'UserPoolAccountRecoverySettingArgsDict', ..., ..., 'UserPoolAdminCreateUserConfigArgs', 'UserPoolAdminCreateUserConfigArgsDict', ..., ..., 'UserPoolClientAnalyticsConfigurationArgs', 'UserPoolClientAnalyticsConfigurationArgsDict', 'UserPoolClientRefreshTokenRotationArgs', 'UserPoolClientRefreshTokenRotationArgsDict', 'UserPoolClientTokenValidityUnitsArgs', 'UserPoolClientTokenValidityUnitsArgsDict', 'UserPoolDeviceConfigurationArgs', 'UserPoolDeviceConfigurationArgsDict', 'UserPoolEmailConfigurationArgs', 'UserPoolEmailConfigurationArgsDict', 'UserPoolEmailMfaConfigurationArgs', 'UserPoolEmailMfaConfigurationArgsDict', 'UserPoolLambdaConfigArgs', 'UserPoolLambdaConfigArgsDict', 'UserPoolLambdaConfigCustomEmailSenderArgs', 'UserPoolLambdaConfigCustomEmailSenderArgsDict', 'UserPoolLambdaConfigCustomSmsSenderArgs', 'UserPoolLambdaConfigCustomSmsSenderArgsDict', 'UserPoolLambdaConfigPreTokenGenerationConfigArgs', ..., 'UserPoolPasswordPolicyArgs', 'UserPoolPasswordPolicyArgsDict', 'UserPoolSchemaArgs', 'UserPoolSchemaArgsDict', 'UserPoolSchemaNumberAttributeConstraintsArgs', 'UserPoolSchemaNumberAttributeConstraintsArgsDict', 'UserPoolSchemaStringAttributeConstraintsArgs', 'UserPoolSchemaStringAttributeConstraintsArgsDict', 'UserPoolSignInPolicyArgs', 'UserPoolSignInPolicyArgsDict', 'UserPoolSmsConfigurationArgs', 'UserPoolSmsConfigurationArgsDict', 'UserPoolSoftwareTokenMfaConfigurationArgs', 'UserPoolSoftwareTokenMfaConfigurationArgsDict', 'UserPoolUserAttributeUpdateSettingsArgs', 'UserPoolUserAttributeUpdateSettingsArgsDict', 'UserPoolUserPoolAddOnsArgs', 'UserPoolUserPoolAddOnsArgsDict', ..., ..., 'UserPoolUsernameConfigurationArgs', 'UserPoolUsernameConfigurationArgsDict', 'UserPoolVerificationMessageTemplateArgs', 'UserPoolVerificationMessageTemplateArgsDict', 'UserPoolWebAuthnConfigurationArgs', 'UserPoolWebAuthnConfigurationArgsDict']
...
class IdentityPoolCognitoIdentityProviderArgs:
    def __init__(__self__, *, client_id: Optional[pulumi.Input[_builtins.str]] = ..., provider_name: Optional[pulumi.Input[_builtins.str]] = ..., server_side_token_check: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def server_side_token_check(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class IdentityPoolRoleAttachmentRoleMappingArgs:
    def __init__(__self__, *, identity_provider: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], ambiguous_role_resolution: Optional[pulumi.Input[_builtins.str]] = ..., mapping_rules: Optional[pulumi.Input[Sequence[pulumi.Input[IdentityPoolRoleAttachmentRoleMappingMappingRuleArgs]]]] = ...) -> None:
    ...
    def identity_provider(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def ambiguous_role_resolution(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def mapping_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IdentityPoolRoleAttachmentRoleMappingMappingRuleArgs]]]]): # -> None:
        ...
...
class IdentityPoolRoleAttachmentRoleMappingMappingRuleArgs:
    def __init__(__self__, *, claim: pulumi.Input[_builtins.str], match_type: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str]) -> None:
    ...
    @claim.setter
    def claim(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class LogDeliveryConfigurationLogConfigurationArgs:
    def __init__(__self__, *, event_source: pulumi.Input[_builtins.str], log_level: pulumi.Input[_builtins.str], cloud_watch_logs_configuration: Optional[pulumi.Input[LogDeliveryConfigurationLogConfigurationCloudWatchLogsConfigurationArgs]] = ..., firehose_configuration: Optional[pulumi.Input[LogDeliveryConfigurationLogConfigurationFirehoseConfigurationArgs]] = ..., s3_configuration: Optional[pulumi.Input[LogDeliveryConfigurationLogConfigurationS3ConfigurationArgs]] = ...) -> None:
    ...
    def cloud_watch_logs_configuration(self, value: Optional[pulumi.Input[LogDeliveryConfigurationLogConfigurationCloudWatchLogsConfigurationArgs]]): # -> None:
        ...
    ...
    def firehose_configuration(self, value: Optional[pulumi.Input[LogDeliveryConfigurationLogConfigurationFirehoseConfigurationArgs]]): # -> None:
        ...
    ...
    def s3_configuration(self, value: Optional[pulumi.Input[LogDeliveryConfigurationLogConfigurationS3ConfigurationArgs]]): # -> None:
        ...
...
class LogDeliveryConfigurationLogConfigurationCloudWatchLogsConfigurationArgs:
    def __init__(__self__, *, log_group_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LogDeliveryConfigurationLogConfigurationFirehoseConfigurationArgs:
    def __init__(__self__, *, stream_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LogDeliveryConfigurationLogConfigurationS3ConfigurationArgs:
    def __init__(__self__, *, bucket_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @bucket_arn.setter
    def bucket_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ManagedLoginBrandingAssetArgs:
    def __init__(__self__, *, category: pulumi.Input[_builtins.str], color_mode: pulumi.Input[_builtins.str], extension: pulumi.Input[_builtins.str], bytes: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @color_mode.setter
    def color_mode(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @extension.setter
    def extension(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @bytes.setter
    def bytes(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ManagedUserPoolClientAnalyticsConfigurationArgs:
    def __init__(__self__, *, application_arn: Optional[pulumi.Input[_builtins.str]] = ..., application_id: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ..., role_arn: Optional[pulumi.Input[_builtins.str]] = ..., user_data_shared: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def user_data_shared(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ManagedUserPoolClientRefreshTokenRotationArgs:
    def __init__(__self__, *, feature: pulumi.Input[_builtins.str], retry_grace_period_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @feature.setter
    def feature(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def retry_grace_period_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ManagedUserPoolClientTokenValidityUnitsArgs:
    def __init__(__self__, *, access_token: Optional[pulumi.Input[_builtins.str]] = ..., id_token: Optional[pulumi.Input[_builtins.str]] = ..., refresh_token: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @id_token.setter
    def id_token(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResourceServerScopeArgs:
    def __init__(__self__, *, scope_description: pulumi.Input[_builtins.str], scope_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def scope_description(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RiskConfigurationAccountTakeoverRiskConfigurationArgs:
    def __init__(__self__, *, actions: pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationActionsArgs], notify_configuration: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationArgs]] = ...) -> None:
    ...
    @actions.setter
    def actions(self, value: pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationActionsArgs]): # -> None:
        ...
    ...
    def notify_configuration(self, value: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationArgs]]): # -> None:
        ...
...
class RiskConfigurationAccountTakeoverRiskConfigurationActionsArgs:
    def __init__(__self__, *, high_action: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationActionsHighActionArgs]] = ..., low_action: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationActionsLowActionArgs]] = ..., medium_action: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationActionsMediumActionArgs]] = ...) -> None:
    ...
    @high_action.setter
    def high_action(self, value: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationActionsHighActionArgs]]): # -> None:
        ...
    ...
    @low_action.setter
    def low_action(self, value: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationActionsLowActionArgs]]): # -> None:
        ...
    ...
    def medium_action(self, value: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationActionsMediumActionArgs]]): # -> None:
        ...
...
class RiskConfigurationAccountTakeoverRiskConfigurationActionsHighActionArgs:
    def __init__(__self__, *, event_action: pulumi.Input[_builtins.str], notify: pulumi.Input[_builtins.bool]) -> None:
    ...
    @event_action.setter
    def event_action(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationArgs:
    def __init__(__self__, *, source_arn: pulumi.Input[_builtins.str], block_email: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationBlockEmailArgs]] = ..., from_: Optional[pulumi.Input[_builtins.str]] = ..., mfa_email: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationMfaEmailArgs]] = ..., no_action_email: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationNoActionEmailArgs]] = ..., reply_to: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @block_email.setter
    def block_email(self, value: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationBlockEmailArgs]]): # -> None:
        ...
    ...
    @from_.setter
    def from_(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @mfa_email.setter
    def mfa_email(self, value: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationMfaEmailArgs]]): # -> None:
        ...
    ...
    def no_action_email(self, value: Optional[pulumi.Input[RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationNoActionEmailArgs]]): # -> None:
        ...
...
class RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationBlockEmailArgs:
    def __init__(__self__, *, html_body: pulumi.Input[_builtins.str], subject: pulumi.Input[_builtins.str], text_body: pulumi.Input[_builtins.str]) -> None:
    ...
    @html_body.setter
    def html_body(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @text_body.setter
    def text_body(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RiskConfigurationCompromisedCredentialsRiskConfigurationArgs:
    def __init__(__self__, *, actions: pulumi.Input[RiskConfigurationCompromisedCredentialsRiskConfigurationActionsArgs], event_filters: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @actions.setter
    def actions(self, value: pulumi.Input[RiskConfigurationCompromisedCredentialsRiskConfigurationActionsArgs]): # -> None:
        ...
    ...
    def event_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RiskConfigurationRiskExceptionConfigurationArgs:
    def __init__(__self__, *, blocked_ip_range_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., skipped_ip_range_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def blocked_ip_range_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def skipped_ip_range_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class UserPoolAccountRecoverySettingArgs:
    def __init__(__self__, *, recovery_mechanisms: Optional[pulumi.Input[Sequence[pulumi.Input[UserPoolAccountRecoverySettingRecoveryMechanismArgs]]]] = ...) -> None:
    ...
    def recovery_mechanisms(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[UserPoolAccountRecoverySettingRecoveryMechanismArgs]]]]): # -> None:
        ...
...
class UserPoolAccountRecoverySettingRecoveryMechanismArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], priority: pulumi.Input[_builtins.int]) -> None:
...
class UserPoolAdminCreateUserConfigArgs:
    def __init__(__self__, *, allow_admin_create_user_only: Optional[pulumi.Input[_builtins.bool]] = ..., invite_message_template: Optional[pulumi.Input[UserPoolAdminCreateUserConfigInviteMessageTemplateArgs]] = ...) -> None:
    ...
    def allow_admin_create_user_only(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def invite_message_template(self, value: Optional[pulumi.Input[UserPoolAdminCreateUserConfigInviteMessageTemplateArgs]]): # -> None:
        ...
...
class UserPoolAdminCreateUserConfigInviteMessageTemplateArgs:
    def __init__(__self__, *, email_message: Optional[pulumi.Input[_builtins.str]] = ..., email_subject: Optional[pulumi.Input[_builtins.str]] = ..., sms_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def email_message(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def email_subject(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @sms_message.setter
    def sms_message(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class UserPoolDeviceConfigurationArgs:
    def __init__(__self__, *, challenge_required_on_new_device: Optional[pulumi.Input[_builtins.bool]] = ..., device_only_remembered_on_user_prompt: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def challenge_required_on_new_device(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def device_only_remembered_on_user_prompt(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class UserPoolEmailConfigurationArgs:
    def __init__(__self__, *, configuration_set: Optional[pulumi.Input[_builtins.str]] = ..., email_sending_account: Optional[pulumi.Input[_builtins.str]] = ..., from_email_address: Optional[pulumi.Input[_builtins.str]] = ..., reply_to_email_address: Optional[pulumi.Input[_builtins.str]] = ..., source_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def email_sending_account(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def from_email_address(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def reply_to_email_address(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class UserPoolEmailMfaConfigurationArgs:
    def __init__(__self__, *, message: Optional[pulumi.Input[_builtins.str]] = ..., subject: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class UserPoolLambdaConfigArgs:
    def __init__(__self__, *, create_auth_challenge: Optional[pulumi.Input[_builtins.str]] = ..., custom_email_sender: Optional[pulumi.Input[UserPoolLambdaConfigCustomEmailSenderArgs]] = ..., custom_message: Optional[pulumi.Input[_builtins.str]] = ..., custom_sms_sender: Optional[pulumi.Input[UserPoolLambdaConfigCustomSmsSenderArgs]] = ..., define_auth_challenge: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., post_authentication: Optional[pulumi.Input[_builtins.str]] = ..., post_confirmation: Optional[pulumi.Input[_builtins.str]] = ..., pre_authentication: Optional[pulumi.Input[_builtins.str]] = ..., pre_sign_up: Optional[pulumi.Input[_builtins.str]] = ..., pre_token_generation: Optional[pulumi.Input[_builtins.str]] = ..., pre_token_generation_config: Optional[pulumi.Input[UserPoolLambdaConfigPreTokenGenerationConfigArgs]] = ..., user_migration: Optional[pulumi.Input[_builtins.str]] = ..., verify_auth_challenge_response: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def create_auth_challenge(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def custom_email_sender(self, value: Optional[pulumi.Input[UserPoolLambdaConfigCustomEmailSenderArgs]]): # -> None:
        ...
    ...
    def custom_message(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def custom_sms_sender(self, value: Optional[pulumi.Input[UserPoolLambdaConfigCustomSmsSenderArgs]]): # -> None:
        ...
    ...
    def define_auth_challenge(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def post_authentication(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def post_confirmation(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def pre_authentication(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @pre_sign_up.setter
    def pre_sign_up(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def pre_token_generation(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def pre_token_generation_config(self, value: Optional[pulumi.Input[UserPoolLambdaConfigPreTokenGenerationConfigArgs]]): # -> None:
        ...
    ...
    def user_migration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def verify_auth_challenge_response(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class UserPoolLambdaConfigCustomEmailSenderArgs:
    def __init__(__self__, *, lambda_arn: pulumi.Input[_builtins.str], lambda_version: pulumi.Input[_builtins.str]) -> None:
    ...
    def lambda_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class UserPoolPasswordPolicyArgs:
    def __init__(__self__, *, minimum_length: Optional[pulumi.Input[_builtins.int]] = ..., password_history_size: Optional[pulumi.Input[_builtins.int]] = ..., require_lowercase: Optional[pulumi.Input[_builtins.bool]] = ..., require_numbers: Optional[pulumi.Input[_builtins.bool]] = ..., require_symbols: Optional[pulumi.Input[_builtins.bool]] = ..., require_uppercase: Optional[pulumi.Input[_builtins.bool]] = ..., temporary_password_validity_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def minimum_length(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def password_history_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def require_lowercase(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def require_uppercase(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def temporary_password_validity_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class UserPoolSchemaArgs:
    def __init__(__self__, *, attribute_data_type: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], developer_only_attribute: Optional[pulumi.Input[_builtins.bool]] = ..., mutable: Optional[pulumi.Input[_builtins.bool]] = ..., number_attribute_constraints: Optional[pulumi.Input[UserPoolSchemaNumberAttributeConstraintsArgs]] = ..., required: Optional[pulumi.Input[_builtins.bool]] = ..., string_attribute_constraints: Optional[pulumi.Input[UserPoolSchemaStringAttributeConstraintsArgs]] = ...) -> None:
    ...
    def attribute_data_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def developer_only_attribute(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @mutable.setter
    def mutable(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def number_attribute_constraints(self, value: Optional[pulumi.Input[UserPoolSchemaNumberAttributeConstraintsArgs]]): # -> None:
        ...
    ...
    def string_attribute_constraints(self, value: Optional[pulumi.Input[UserPoolSchemaStringAttributeConstraintsArgs]]): # -> None:
        ...
...
class UserPoolSchemaNumberAttributeConstraintsArgs:
    def __init__(__self__, *, max_value: Optional[pulumi.Input[_builtins.str]] = ..., min_value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class UserPoolSchemaStringAttributeConstraintsArgs:
    def __init__(__self__, *, max_length: Optional[pulumi.Input[_builtins.str]] = ..., min_length: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @max_length.setter
    def max_length(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @min_length.setter
    def min_length(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class UserPoolSignInPolicyArgs:
    def __init__(__self__, *, allowed_first_auth_factors: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allowed_first_auth_factors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class UserPoolSmsConfigurationArgs:
    def __init__(__self__, *, external_id: pulumi.Input[_builtins.str], sns_caller_arn: pulumi.Input[_builtins.str], sns_region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def sns_caller_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @sns_region.setter
    def sns_region(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class UserPoolUserAttributeUpdateSettingsArgs:
    def __init__(__self__, *, attributes_require_verification_before_updates: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def attributes_require_verification_before_updates(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class UserPoolUserPoolAddOnsArgs:
    def __init__(__self__, *, advanced_security_mode: pulumi.Input[_builtins.str], advanced_security_additional_flows: Optional[pulumi.Input[UserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlowsArgs]] = ...) -> None:
    ...
    def advanced_security_mode(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def advanced_security_additional_flows(self, value: Optional[pulumi.Input[UserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlowsArgs]]): # -> None:
        ...
...
class UserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlowsArgs:
    def __init__(__self__, *, custom_auth_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def custom_auth_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class UserPoolUsernameConfigurationArgs:
    def __init__(__self__, *, case_sensitive: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class UserPoolVerificationMessageTemplateArgs:
    def __init__(__self__, *, default_email_option: Optional[pulumi.Input[_builtins.str]] = ..., email_message: Optional[pulumi.Input[_builtins.str]] = ..., email_message_by_link: Optional[pulumi.Input[_builtins.str]] = ..., email_subject: Optional[pulumi.Input[_builtins.str]] = ..., email_subject_by_link: Optional[pulumi.Input[_builtins.str]] = ..., sms_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def default_email_option(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def email_message_by_link(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def email_subject_by_link(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class UserPoolWebAuthnConfigurationArgs:
    def __init__(__self__, *, relying_party_id: Optional[pulumi.Input[_builtins.str]] = ..., user_verification: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def relying_party_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def user_verification(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
