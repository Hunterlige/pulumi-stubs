...
class StreamKinesisConfigurationArgs:
    def __init__(__self__, *, stream_arn: pulumi.Input[_builtins.str], aggregation_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def aggregation_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
