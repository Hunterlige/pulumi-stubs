...
class GetBudgetResult:
    ...
    def __init__(__self__, account_id=..., arn=..., auto_adjust_datas=..., billing_view_arn=..., budget_exceeded=..., budget_limits=..., budget_type=..., calculated_spends=..., cost_filters=..., cost_types=..., id=..., name=..., name_prefix=..., notifications=..., planned_limits=..., tags=..., time_period_end=..., time_period_start=..., time_unit=...) -> None:
        ...
...
def get_budget(account_id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., name_prefix: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetBudgetResult:
    
    ...

def get_budget_output(account_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., name_prefix: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetBudgetResult]:
