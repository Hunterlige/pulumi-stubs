...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ListenerDefaultAction', 'ListenerDefaultActionFixedResponse', 'ListenerDefaultActionForward', 'ListenerDefaultActionForwardTargetGroup', 'ListenerRuleAction', 'ListenerRuleActionFixedResponse', 'ListenerRuleActionForward', 'ListenerRuleActionForwardTargetGroup', 'ListenerRuleMatch', 'ListenerRuleMatchHttpMatch', 'ListenerRuleMatchHttpMatchHeaderMatch', 'ListenerRuleMatchHttpMatchHeaderMatchMatch', 'ListenerRuleMatchHttpMatchPathMatch', 'ListenerRuleMatchHttpMatchPathMatchMatch', ..., ..., ..., ..., 'ResourceConfigurationTimeouts', 'ResourceGatewayTimeouts', 'ServiceDnsEntry', 'ServiceNetworkResourceAssociationDnsEntry', 'ServiceNetworkResourceAssociationTimeouts', 'ServiceNetworkServiceAssociationDnsEntry', 'ServiceNetworkVpcAssociationDnsOptions', 'TargetGroupAttachmentTarget', 'TargetGroupConfig', 'TargetGroupConfigHealthCheck', 'TargetGroupConfigHealthCheckMatcher', 'GetListenerDefaultActionResult', 'GetListenerDefaultActionFixedResponseResult', 'GetListenerDefaultActionForwardResult', 'GetListenerDefaultActionForwardTargetGroupResult', 'GetServiceDnsEntryResult']
@pulumi.output_type
class ListenerDefaultAction(dict):
    ...
    def __init__(__self__, *, fixed_response: Optional[outputs.ListenerDefaultActionFixedResponse] = ..., forwards: Optional[Sequence[outputs.ListenerDefaultActionForward]] = ...) -> None:
...
class ListenerDefaultActionForward(dict):
    ...
    def __init__(__self__, *, target_groups: Optional[Sequence[outputs.ListenerDefaultActionForwardTargetGroup]] = ...) -> None:
...
class ListenerDefaultActionForwardTargetGroup(dict):
    ...
    def __init__(__self__, *, target_group_identifier: Optional[_builtins.str] = ..., weight: Optional[_builtins.int] = ...) -> None:
...
class ListenerRuleAction(dict):
    ...
    def __init__(__self__, *, fixed_response: Optional[outputs.ListenerRuleActionFixedResponse] = ..., forward: Optional[outputs.ListenerRuleActionForward] = ...) -> None:
...
class ListenerRuleActionForward(dict):
    ...
    def __init__(__self__, *, target_groups: Sequence[outputs.ListenerRuleActionForwardTargetGroup]) -> None:
...
class ListenerRuleActionForwardTargetGroup(dict):
    ...
    def __init__(__self__, *, target_group_identifier: _builtins.str, weight: Optional[_builtins.int] = ...) -> None:
        ...
...
class ListenerRuleMatch(dict):
    ...
    def __init__(__self__, *, http_match: outputs.ListenerRuleMatchHttpMatch) -> None:
...
class ListenerRuleMatchHttpMatch(dict):
    ...
    def __init__(__self__, *, header_matches: Optional[Sequence[outputs.ListenerRuleMatchHttpMatchHeaderMatch]] = ..., method: Optional[_builtins.str] = ..., path_match: Optional[outputs.ListenerRuleMatchHttpMatchPathMatch] = ...) -> None:
...
class ListenerRuleMatchHttpMatchHeaderMatch(dict):
    ...
    def __init__(__self__, *, match: outputs.ListenerRuleMatchHttpMatchHeaderMatchMatch, name: _builtins.str, case_sensitive: Optional[_builtins.bool] = ...) -> None:
...
class ListenerRuleMatchHttpMatchHeaderMatchMatch(dict):
    def __init__(__self__, *, contains: Optional[_builtins.str] = ..., exact: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class ListenerRuleMatchHttpMatchPathMatch(dict):
    ...
    def __init__(__self__, *, match: outputs.ListenerRuleMatchHttpMatchPathMatchMatch, case_sensitive: Optional[_builtins.bool] = ...) -> None:
...
class ListenerRuleMatchHttpMatchPathMatchMatch(dict):
    def __init__(__self__, *, exact: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class ResourceConfigurationResourceConfigurationDefinition(dict):
    ...
    def __init__(__self__, *, arn_resource: Optional[outputs.ResourceConfigurationResourceConfigurationDefinitionArnResource] = ..., dns_resource: Optional[outputs.ResourceConfigurationResourceConfigurationDefinitionDnsResource] = ..., ip_resource: Optional[outputs.ResourceConfigurationResourceConfigurationDefinitionIpResource] = ...) -> None:
...
class ResourceConfigurationResourceConfigurationDefinitionDnsResource(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, ip_address_type: _builtins.str) -> None:
...
class ServiceDnsEntry(dict):
    ...
    def __init__(__self__, *, domain_name: Optional[_builtins.str] = ..., hosted_zone_id: Optional[_builtins.str] = ...) -> None:
        ...
...
class ServiceNetworkResourceAssociationDnsEntry(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, hosted_zone_id: _builtins.str) -> None:
...
class ServiceNetworkVpcAssociationDnsOptions(dict):
    ...
    def __init__(__self__, *, private_dns_preference: Optional[_builtins.str] = ..., private_dns_specified_domains: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class TargetGroupAttachmentTarget(dict):
    def __init__(__self__, *, id: _builtins.str, port: Optional[_builtins.int] = ...) -> None:
...
class TargetGroupConfig(dict):
    ...
    def __init__(__self__, *, health_check: Optional[outputs.TargetGroupConfigHealthCheck] = ..., ip_address_type: Optional[_builtins.str] = ..., lambda_event_structure_version: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., protocol: Optional[_builtins.str] = ..., protocol_version: Optional[_builtins.str] = ..., vpc_identifier: Optional[_builtins.str] = ...) -> None:
...
class TargetGroupConfigHealthCheck(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., health_check_interval_seconds: Optional[_builtins.int] = ..., health_check_timeout_seconds: Optional[_builtins.int] = ..., healthy_threshold_count: Optional[_builtins.int] = ..., matcher: Optional[outputs.TargetGroupConfigHealthCheckMatcher] = ..., path: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., protocol: Optional[_builtins.str] = ..., protocol_version: Optional[_builtins.str] = ..., unhealthy_threshold_count: Optional[_builtins.int] = ...) -> None:
...
class GetListenerDefaultActionResult(dict):
    def __init__(__self__, *, fixed_responses: Sequence[outputs.GetListenerDefaultActionFixedResponseResult], forwards: Sequence[outputs.GetListenerDefaultActionForwardResult]) -> None:
        ...
...
class GetListenerDefaultActionForwardResult(dict):
    def __init__(__self__, *, target_groups: Sequence[outputs.GetListenerDefaultActionForwardTargetGroupResult]) -> None:
        ...
...
class GetListenerDefaultActionForwardTargetGroupResult(dict):
    def __init__(__self__, *, target_group_identifier: _builtins.str, weight: _builtins.int) -> None:
        ...
