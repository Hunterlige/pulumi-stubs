...
class TargetGroupArgs:
    def __init__(
        ...
        *,
        ...
        config: Optional[pulumi.Input[TargetGroupConfigArgs]] = ...,
...
@pulumi.type_token("aws:vpclattice/targetGroup:TargetGroup")
class TargetGroup(pulumi.CustomResource):
    ...
    def __init__(
        ...
        config: Optional[
            pulumi.Input[Union[TargetGroupConfigArgs, TargetGroupConfigArgsDict]]
        ] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
