...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['PermissionTimeouts', 'ResourceShareResourceShareConfiguration', 'GetResourceShareFilterResult']
@pulumi.output_type
...
class ResourceShareResourceShareConfiguration(dict):
    ...
    def __init__(__self__, *, retain_sharing_on_account_leave_organization: Optional[_builtins.bool] = ...) -> None:
