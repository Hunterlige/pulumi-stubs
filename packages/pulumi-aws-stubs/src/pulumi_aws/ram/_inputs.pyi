...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['PermissionTimeoutsArgs', 'PermissionTimeoutsArgsDict', 'ResourceShareResourceShareConfigurationArgs', 'ResourceShareResourceShareConfigurationArgsDict', 'GetResourceShareFilterArgs', 'GetResourceShareFilterArgsDict']
...
class ResourceShareResourceShareConfigurationArgs:
    def __init__(__self__, *, retain_sharing_on_account_leave_organization: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def retain_sharing_on_account_leave_organization(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
