...
class PermissionArgs:
    def __init__(
        ...
        *,
        ...
        timeouts: Optional[pulumi.Input[PermissionTimeoutsArgs]] = ...,
    ) -> None: ...
    @_builtins.property
...
class _PermissionState:
    def __init__(
        ...
        *,
        ...
        default_version: Optional[pulumi.Input[_builtins.bool]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        policy_template: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
...
class Permission(pulumi.CustomResource):
    ...
    def __init__(
        ...
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        timeouts: Optional[
            pulumi.Input[Union[PermissionTimeoutsArgs, PermissionTimeoutsArgsDict]]
        ] = ...,
        __props__=...,
    ) -> None: ...
    @overload
