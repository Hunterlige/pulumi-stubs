...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationPortalOptions', 'ApplicationPortalOptionsSignInOptions', ..., ..., 'CustomerManagedPolicyAttachmentsExclusiveTimeouts', 'InstanceAccessControlAttributesAttribute', 'InstanceAccessControlAttributesAttributeValue', 'ManagedPolicyAttachmentsExclusiveTimeouts', 'PermissionsBoundaryAttachmentPermissionsBoundary', ..., 'TrustedTokenIssuerTrustedTokenIssuerConfiguration', ..., ..., 'GetApplicationPortalOptionResult', 'GetApplicationPortalOptionSignInOptionResult', 'GetApplicationProvidersApplicationProviderResult', ..., ...]
@pulumi.output_type
class ApplicationPortalOptions(dict):
    ...
    def __init__(__self__, *, sign_in_options: Optional[outputs.ApplicationPortalOptionsSignInOptions] = ..., visibility: Optional[_builtins.str] = ...) -> None:
...
class ApplicationPortalOptionsSignInOptions(dict):
    ...
    def __init__(__self__, *, origin: _builtins.str, application_url: Optional[_builtins.str] = ...) -> None:
...
class CustomerManagedPolicyAttachmentCustomerManagedPolicyReference(dict):
    def __init__(__self__, *, name: _builtins.str, path: Optional[_builtins.str] = ...) -> None:
...
class InstanceAccessControlAttributesAttribute(dict):
    def __init__(__self__, *, key: _builtins.str, values: Sequence[outputs.InstanceAccessControlAttributesAttributeValue]) -> None:
...
class PermissionsBoundaryAttachmentPermissionsBoundary(dict):
    ...
    def __init__(__self__, *, customer_managed_policy_reference: Optional[outputs.PermissionsBoundaryAttachmentPermissionsBoundaryCustomerManagedPolicyReference] = ..., managed_policy_arn: Optional[_builtins.str] = ...) -> None:
...
class TrustedTokenIssuerTrustedTokenIssuerConfiguration(dict):
    ...
    def __init__(__self__, *, oidc_jwt_configuration: outputs.TrustedTokenIssuerTrustedTokenIssuerConfigurationOidcJwtConfiguration) -> None:
...
class TrustedTokenIssuerTrustedTokenIssuerConfigurationOidcJwtConfiguration(dict):
    ...
    def __init__(__self__, *, claim_attribute_path: _builtins.str, identity_store_attribute_path: _builtins.str, issuer_url: _builtins.str, jwks_retrieval_option: _builtins.str) -> None:
...
class GetApplicationPortalOptionResult(dict):
    def __init__(__self__, *, sign_in_options: Sequence[outputs.GetApplicationPortalOptionSignInOptionResult], visibility: _builtins.str) -> None:
        ...
...
class GetApplicationPortalOptionSignInOptionResult(dict):
    def __init__(__self__, *, application_url: _builtins.str, origin: _builtins.str) -> None:
        ...
...
class GetApplicationProvidersApplicationProviderResult(dict):
    def __init__(__self__, *, application_provider_arn: _builtins.str, display_datas: Sequence[outputs.GetApplicationProvidersApplicationProviderDisplayDataResult], federation_protocol: _builtins.str) -> None:
...
class GetApplicationProvidersApplicationProviderDisplayDataResult(dict):
    def __init__(__self__, *, description: _builtins.str, display_name: _builtins.str, icon_url: _builtins.str) -> None:
