...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['SecretReplicaArgs', 'SecretReplicaArgsDict', 'SecretRotationRotationRulesArgs', 'SecretRotationRotationRulesArgsDict', 'GetSecretsFilterArgs', 'GetSecretsFilterArgsDict']
...
class SecretReplicaArgs:
    def __init__(__self__, *, region: pulumi.Input[_builtins.str], kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., last_accessed_date: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., status_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def last_accessed_date(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SecretRotationRotationRulesArgs:
    def __init__(__self__, *, automatically_after_days: Optional[pulumi.Input[_builtins.int]] = ..., duration: Optional[pulumi.Input[_builtins.str]] = ..., schedule_expression: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def automatically_after_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
