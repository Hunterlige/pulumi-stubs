...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['SecretReplica', 'SecretRotationRotationRules', 'GetSecretRotationRotationRuleResult', 'GetSecretVersionsVersionResult', 'GetSecretsFilterResult']
@pulumi.output_type
class SecretReplica(dict):
    ...
    def __init__(__self__, *, region: _builtins.str, kms_key_id: Optional[_builtins.str] = ..., last_accessed_date: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., status_message: Optional[_builtins.str] = ...) -> None:
...
class SecretRotationRotationRules(dict):
    ...
    def __init__(__self__, *, automatically_after_days: Optional[_builtins.int] = ..., duration: Optional[_builtins.str] = ..., schedule_expression: Optional[_builtins.str] = ...) -> None:
...
class GetSecretRotationRotationRuleResult(dict):
    def __init__(__self__, *, automatically_after_days: _builtins.int, duration: _builtins.str, schedule_expression: _builtins.str) -> None:
...
class GetSecretVersionsVersionResult(dict):
    def __init__(__self__, *, created_time: _builtins.str, last_accessed_date: _builtins.str, version_id: _builtins.str, version_stages: Sequence[_builtins.str]) -> None:
