...
class AssetTypeFormsInputArgs:
    def __init__(__self__, *, map_block_key: pulumi.Input[_builtins.str], type_identifier: pulumi.Input[_builtins.str], type_revision: pulumi.Input[_builtins.str], required: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
        ...
    ...
    def type_identifier(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def type_revision(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DomainSingleSignOnArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[_builtins.str]] = ..., user_assignment: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    def user_assignment(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EnvironmentLastDeploymentArgs:
    def __init__(__self__, *, deployment_id: pulumi.Input[_builtins.str], deployment_status: pulumi.Input[_builtins.str], deployment_type: pulumi.Input[_builtins.str], failure_reasons: pulumi.Input[Sequence[pulumi.Input[EnvironmentLastDeploymentFailureReasonArgs]]], is_deployment_complete: pulumi.Input[_builtins.bool], messages: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
        ...
    ...
    def deployment_status(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def failure_reasons(self, value: pulumi.Input[Sequence[pulumi.Input[EnvironmentLastDeploymentFailureReasonArgs]]]): # -> None:
        ...
    ...
    def is_deployment_complete(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    @messages.setter
    def messages(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class EnvironmentLastDeploymentFailureReasonArgs:
    def __init__(__self__, *, code: pulumi.Input[_builtins.str], message: pulumi.Input[_builtins.str]) -> None:
        ...
...
class EnvironmentProvisionedResourceArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], provider: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str]) -> None:
...
class FormTypeImportArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], revision: pulumi.Input[_builtins.str]) -> None:
...
class FormTypeModelArgs:
    ...
    @smithy.setter
    def smithy(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class GlossaryTermTermRelationsArgs:
    def __init__(__self__, *, classifies: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., is_as: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @classifies.setter
    def classifies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @is_as.setter
    def is_as(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class UserProfileDetailArgs:
    def __init__(__self__, *, iams: pulumi.Input[Sequence[pulumi.Input[UserProfileDetailIamArgs]]], ssos: pulumi.Input[Sequence[pulumi.Input[UserProfileDetailSsoArgs]]]) -> None:
        ...
    ...
    @iams.setter
    def iams(self, value: pulumi.Input[Sequence[pulumi.Input[UserProfileDetailIamArgs]]]): # -> None:
        ...
    ...
    @ssos.setter
    def ssos(self, value: pulumi.Input[Sequence[pulumi.Input[UserProfileDetailSsoArgs]]]): # -> None:
        ...
...
class UserProfileDetailSsoArgs:
    def __init__(__self__, *, first_name: pulumi.Input[_builtins.str], last_name: pulumi.Input[_builtins.str], user_name: pulumi.Input[_builtins.str]) -> None:
        ...
