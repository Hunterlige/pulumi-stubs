...
@pulumi.input_type
class AssetTypeArgs:
    def __init__(__self__, *, domain_identifier: pulumi.Input[_builtins.str], owning_project_identifier: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., forms_inputs: Optional[pulumi.Input[Sequence[pulumi.Input[AssetTypeFormsInputArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., timeouts: Optional[pulumi.Input[AssetTypeTimeoutsArgs]] = ...) -> None:
    ...
    @forms_inputs.setter
    def forms_inputs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AssetTypeFormsInputArgs]]]]): # -> None:
        ...
    ...
    @timeouts.setter
    def timeouts(self, value: Optional[pulumi.Input[AssetTypeTimeoutsArgs]]): # -> None:
        ...
...
class _AssetTypeState:
    def __init__(__self__, *, created_at: Optional[pulumi.Input[_builtins.str]] = ..., created_by: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., domain_identifier: Optional[pulumi.Input[_builtins.str]] = ..., forms_inputs: Optional[pulumi.Input[Sequence[pulumi.Input[AssetTypeFormsInputArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., owning_project_identifier: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., revision: Optional[pulumi.Input[_builtins.str]] = ..., timeouts: Optional[pulumi.Input[AssetTypeTimeoutsArgs]] = ...) -> None:
...
class AssetType(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., domain_identifier: Optional[pulumi.Input[_builtins.str]] = ..., forms_inputs: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AssetTypeFormsInputArgs, AssetTypeFormsInputArgsDict]]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., owning_project_identifier: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., timeouts: Optional[pulumi.Input[Union[AssetTypeTimeoutsArgs, AssetTypeTimeoutsArgsDict]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: AssetTypeArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., created_at: Optional[pulumi.Input[_builtins.str]] = ..., created_by: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., domain_identifier: Optional[pulumi.Input[_builtins.str]] = ..., forms_inputs: Optional[pulumi.Input[Sequence[pulumi.Input[Union[AssetTypeFormsInputArgs, AssetTypeFormsInputArgsDict]]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., owning_project_identifier: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., revision: Optional[pulumi.Input[_builtins.str]] = ..., timeouts: Optional[pulumi.Input[Union[AssetTypeTimeoutsArgs, AssetTypeTimeoutsArgsDict]]] = ...) -> AssetType:
