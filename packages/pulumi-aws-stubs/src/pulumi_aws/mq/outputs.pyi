...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BrokerConfiguration', 'BrokerEncryptionOptions', 'BrokerInstance', 'BrokerLdapServerMetadata', 'BrokerLogs', 'BrokerMaintenanceWindowStartTime', 'BrokerUser', 'GetBrokerConfigurationResult', 'GetBrokerEncryptionOptionResult', 'GetBrokerEngineTypesBrokerEngineTypeResult', ..., 'GetBrokerInstanceResult', 'GetBrokerLdapServerMetadataResult', 'GetBrokerLogsResult', 'GetBrokerMaintenanceWindowStartTimeResult', 'GetBrokerUserResult', 'GetInstanceTypeOfferingsBrokerInstanceOptionResult', ...]
@pulumi.output_type
...
class BrokerEncryptionOptions(dict):
    ...
    def __init__(__self__, *, kms_key_id: Optional[_builtins.str] = ..., use_aws_owned_key: Optional[_builtins.bool] = ...) -> None:
...
class BrokerInstance(dict):
    ...
    def __init__(__self__, *, console_url: Optional[_builtins.str] = ..., endpoints: Optional[Sequence[_builtins.str]] = ..., ip_address: Optional[_builtins.str] = ...) -> None:
...
class BrokerLdapServerMetadata(dict):
    ...
    def __init__(__self__, *, hosts: Optional[Sequence[_builtins.str]] = ..., role_base: Optional[_builtins.str] = ..., role_name: Optional[_builtins.str] = ..., role_search_matching: Optional[_builtins.str] = ..., role_search_subtree: Optional[_builtins.bool] = ..., service_account_password: Optional[_builtins.str] = ..., service_account_username: Optional[_builtins.str] = ..., user_base: Optional[_builtins.str] = ..., user_role_name: Optional[_builtins.str] = ..., user_search_matching: Optional[_builtins.str] = ..., user_search_subtree: Optional[_builtins.bool] = ...) -> None:
...
class BrokerLogs(dict):
    def __init__(__self__, *, audit: Optional[_builtins.bool] = ..., general: Optional[_builtins.bool] = ...) -> None:
...
class BrokerMaintenanceWindowStartTime(dict):
    ...
    def __init__(__self__, *, day_of_week: _builtins.str, time_of_day: _builtins.str, time_zone: _builtins.str) -> None:
...
class BrokerUser(dict):
    ...
    def __init__(__self__, *, password: _builtins.str, username: _builtins.str, console_access: Optional[_builtins.bool] = ..., groups: Optional[Sequence[_builtins.str]] = ..., replication_user: Optional[_builtins.bool] = ...) -> None:
...
class GetBrokerEncryptionOptionResult(dict):
    def __init__(__self__, *, kms_key_id: _builtins.str, use_aws_owned_key: _builtins.bool) -> None:
...
class GetBrokerEngineTypesBrokerEngineTypeResult(dict):
    def __init__(__self__, *, engine_type: _builtins.str, engine_versions: Sequence[outputs.GetBrokerEngineTypesBrokerEngineTypeEngineVersionResult]) -> None:
...
class GetBrokerInstanceResult(dict):
    def __init__(__self__, *, console_url: _builtins.str, endpoints: Sequence[_builtins.str], ip_address: _builtins.str) -> None:
...
class GetBrokerLdapServerMetadataResult(dict):
    def __init__(__self__, *, hosts: Sequence[_builtins.str], role_base: _builtins.str, role_name: _builtins.str, role_search_matching: _builtins.str, role_search_subtree: _builtins.bool, service_account_password: _builtins.str, service_account_username: _builtins.str, user_base: _builtins.str, user_role_name: _builtins.str, user_search_matching: _builtins.str, user_search_subtree: _builtins.bool) -> None:
...
class GetBrokerLogsResult(dict):
    def __init__(__self__, *, audit: _builtins.bool, general: _builtins.bool) -> None:
...
class GetBrokerUserResult(dict):
    def __init__(__self__, *, console_access: _builtins.bool, groups: Sequence[_builtins.str], replication_user: _builtins.bool, username: _builtins.str) -> None:
...
class GetInstanceTypeOfferingsBrokerInstanceOptionResult(dict):
    def __init__(__self__, *, availability_zones: Sequence[outputs.GetInstanceTypeOfferingsBrokerInstanceOptionAvailabilityZoneResult], engine_type: _builtins.str, host_instance_type: _builtins.str, storage_type: _builtins.str, supported_deployment_modes: Sequence[_builtins.str], supported_engine_versions: Sequence[_builtins.str]) -> None:
