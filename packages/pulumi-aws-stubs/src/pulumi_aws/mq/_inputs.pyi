...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BrokerConfigurationArgs', 'BrokerConfigurationArgsDict', 'BrokerEncryptionOptionsArgs', 'BrokerEncryptionOptionsArgsDict', 'BrokerInstanceArgs', 'BrokerInstanceArgsDict', 'BrokerLdapServerMetadataArgs', 'BrokerLdapServerMetadataArgsDict', 'BrokerLogsArgs', 'BrokerLogsArgsDict', 'BrokerMaintenanceWindowStartTimeArgs', 'BrokerMaintenanceWindowStartTimeArgsDict', 'BrokerUserArgs', 'BrokerUserArgsDict']
...
class BrokerEncryptionOptionsArgs:
    def __init__(__self__, *, kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., use_aws_owned_key: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def use_aws_owned_key(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class BrokerInstanceArgs:
    def __init__(__self__, *, console_url: Optional[pulumi.Input[_builtins.str]] = ..., endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @console_url.setter
    def console_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @endpoints.setter
    def endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class BrokerLdapServerMetadataArgs:
    def __init__(__self__, *, hosts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., role_base: Optional[pulumi.Input[_builtins.str]] = ..., role_name: Optional[pulumi.Input[_builtins.str]] = ..., role_search_matching: Optional[pulumi.Input[_builtins.str]] = ..., role_search_subtree: Optional[pulumi.Input[_builtins.bool]] = ..., service_account_password: Optional[pulumi.Input[_builtins.str]] = ..., service_account_username: Optional[pulumi.Input[_builtins.str]] = ..., user_base: Optional[pulumi.Input[_builtins.str]] = ..., user_role_name: Optional[pulumi.Input[_builtins.str]] = ..., user_search_matching: Optional[pulumi.Input[_builtins.str]] = ..., user_search_subtree: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @role_base.setter
    def role_base(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def role_search_matching(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def role_search_subtree(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def service_account_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def service_account_username(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @user_base.setter
    def user_base(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def user_role_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def user_search_matching(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def user_search_subtree(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class BrokerLogsArgs:
    def __init__(__self__, *, audit: Optional[pulumi.Input[_builtins.bool]] = ..., general: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @audit.setter
    def audit(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @general.setter
    def general(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class BrokerMaintenanceWindowStartTimeArgs:
    def __init__(__self__, *, day_of_week: pulumi.Input[_builtins.str], time_of_day: pulumi.Input[_builtins.str], time_zone: pulumi.Input[_builtins.str]) -> None:
    ...
    @time_of_day.setter
    def time_of_day(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BrokerUserArgs:
    def __init__(__self__, *, password: pulumi.Input[_builtins.str], username: pulumi.Input[_builtins.str], console_access: Optional[pulumi.Input[_builtins.bool]] = ..., groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., replication_user: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def console_access(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def replication_user(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
