...
class GetInstanceTypeOfferingsResult:
    ...
    def __init__(__self__, broker_instance_options=..., engine_type=..., host_instance_type=..., id=..., region=..., storage_type=...) -> None:
        ...
...
def get_instance_type_offerings(engine_type: Optional[_builtins.str] = ..., host_instance_type: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., storage_type: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetInstanceTypeOfferingsResult:
    
    ...

def get_instance_type_offerings_output(engine_type: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., host_instance_type: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., storage_type: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetInstanceTypeOfferingsResult]:
