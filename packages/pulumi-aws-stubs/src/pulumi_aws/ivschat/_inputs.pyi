...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['LoggingConfigurationDestinationConfigurationArgs', ..., ..., ..., ..., ..., 'LoggingConfigurationDestinationConfigurationS3Args', ..., 'RoomMessageReviewHandlerArgs', 'RoomMessageReviewHandlerArgsDict']
...
class LoggingConfigurationDestinationConfigurationArgs:
    def __init__(__self__, *, cloudwatch_logs: Optional[pulumi.Input[LoggingConfigurationDestinationConfigurationCloudwatchLogsArgs]] = ..., firehose: Optional[pulumi.Input[LoggingConfigurationDestinationConfigurationFirehoseArgs]] = ..., s3: Optional[pulumi.Input[LoggingConfigurationDestinationConfigurationS3Args]] = ...) -> None:
    ...
    def cloudwatch_logs(self, value: Optional[pulumi.Input[LoggingConfigurationDestinationConfigurationCloudwatchLogsArgs]]): # -> None:
        ...
    ...
    @firehose.setter
    def firehose(self, value: Optional[pulumi.Input[LoggingConfigurationDestinationConfigurationFirehoseArgs]]): # -> None:
        ...
    ...
    @s3.setter
    def s3(self, value: Optional[pulumi.Input[LoggingConfigurationDestinationConfigurationS3Args]]): # -> None:
        ...
...
class LoggingConfigurationDestinationConfigurationFirehoseArgs:
    def __init__(__self__, *, delivery_stream_name: pulumi.Input[_builtins.str]) -> None:
...
class RoomMessageReviewHandlerArgs:
    def __init__(__self__, *, fallback_result: Optional[pulumi.Input[_builtins.str]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def fallback_result(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
