...
class LoggingConfigurationArgs:
    def __init__(
        ...
        *,
        destination_configuration: Optional[
            pulumi.Input[LoggingConfigurationDestinationConfigurationArgs]
        ] = ...,
    ...
    def destination_configuration(
        self,
    ) -> Optional[pulumi.Input[LoggingConfigurationDestinationConfigurationArgs]]: ...
    @destination_configuration.setter
    def destination_configuration(
        self,
        value: Optional[pulumi.Input[LoggingConfigurationDestinationConfigurationArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter
...
class LoggingConfiguration(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[LoggingConfigurationArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
    ...
    def destination_configuration(
        ...
        Optional[outputs.LoggingConfigurationDestinationConfiguration]
    ]: ...
    @_builtins.property
    @pulumi.getter
