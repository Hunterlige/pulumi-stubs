...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationLayerAutomaticResponseTimeoutsArgs', 'ApplicationLayerAutomaticResponseTimeoutsArgsDict', 'DrtAccessLogBucketAssociationTimeoutsArgs', 'DrtAccessLogBucketAssociationTimeoutsArgsDict', 'DrtAccessRoleArnAssociationTimeoutsArgs', 'DrtAccessRoleArnAssociationTimeoutsArgsDict', 'ProactiveEngagementEmergencyContactArgs', 'ProactiveEngagementEmergencyContactArgsDict']
...
class ProactiveEngagementEmergencyContactArgs:
    def __init__(__self__, *, email_address: pulumi.Input[_builtins.str], contact_notes: Optional[pulumi.Input[_builtins.str]] = ..., phone_number: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def contact_notes(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
