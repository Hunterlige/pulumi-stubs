...
class AppMonitorAppMonitorConfiguration(dict):
    ...
    def __init__(__self__, *, allow_cookies: Optional[_builtins.bool] = ..., enable_xray: Optional[_builtins.bool] = ..., excluded_pages: Optional[Sequence[_builtins.str]] = ..., favorite_pages: Optional[Sequence[_builtins.str]] = ..., guest_role_arn: Optional[_builtins.str] = ..., identity_pool_id: Optional[_builtins.str] = ..., included_pages: Optional[Sequence[_builtins.str]] = ..., session_sample_rate: Optional[_builtins.float] = ..., telemetries: Optional[Sequence[_builtins.str]] = ...) -> None:
