...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppMonitorAppMonitorConfigurationArgs', 'AppMonitorAppMonitorConfigurationArgsDict', 'AppMonitorCustomEventsArgs', 'AppMonitorCustomEventsArgsDict']
...
class AppMonitorAppMonitorConfigurationArgs:
    def __init__(__self__, *, allow_cookies: Optional[pulumi.Input[_builtins.bool]] = ..., enable_xray: Optional[pulumi.Input[_builtins.bool]] = ..., excluded_pages: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., favorite_pages: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., guest_role_arn: Optional[pulumi.Input[_builtins.str]] = ..., identity_pool_id: Optional[pulumi.Input[_builtins.str]] = ..., included_pages: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., session_sample_rate: Optional[pulumi.Input[_builtins.float]] = ..., telemetries: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allow_cookies(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @enable_xray.setter
    def enable_xray(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def excluded_pages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def favorite_pages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def guest_role_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def included_pages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def session_sample_rate(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @telemetries.setter
    def telemetries(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
