...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AssumeRoleWithWebIdentity', 'AssumeRoles', 'DefaultTags', 'Endpoints', 'IgnoreTags']
@pulumi.output_type
class AssumeRoleWithWebIdentity(dict):
    def __init__(__self__, *, duration: Optional[_builtins.str] = ..., policy: Optional[_builtins.str] = ..., policy_arns: Optional[Sequence[_builtins.str]] = ..., role_arn: Optional[_builtins.str] = ..., session_name: Optional[_builtins.str] = ..., web_identity_token: Optional[_builtins.str] = ..., web_identity_token_file: Optional[_builtins.str] = ...) -> None:
...
class AssumeRoles(dict):
    def __init__(__self__, *, duration: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ..., policy: Optional[_builtins.str] = ..., policy_arns: Optional[Sequence[_builtins.str]] = ..., role_arn: Optional[_builtins.str] = ..., session_name: Optional[_builtins.str] = ..., source_identity: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., transitive_tag_keys: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class Endpoints(dict):
    def __init__(__self__, *, accessanalyzer: Optional[_builtins.str] = ..., account: Optional[_builtins.str] = ..., acm: Optional[_builtins.str] = ..., acmpca: Optional[_builtins.str] = ..., amg: Optional[_builtins.str] = ..., amp: Optional[_builtins.str] = ..., amplify: Optional[_builtins.str] = ..., apigateway: Optional[_builtins.str] = ..., apigatewayv2: Optional[_builtins.str] = ..., appautoscaling: Optional[_builtins.str] = ..., appconfig: Optional[_builtins.str] = ..., appfabric: Optional[_builtins.str] = ..., appflow: Optional[_builtins.str] = ..., appintegrations: Optional[_builtins.str] = ..., appintegrationsservice: Optional[_builtins.str] = ..., applicationautoscaling: Optional[_builtins.str] = ..., applicationinsights: Optional[_builtins.str] = ..., applicationsignals: Optional[_builtins.str] = ..., appmesh: Optional[_builtins.str] = ..., appregistry: Optional[_builtins.str] = ..., apprunner: Optional[_builtins.str] = ..., appstream: Optional[_builtins.str] = ..., appsync: Optional[_builtins.str] = ..., arcregionswitch: Optional[_builtins.str] = ..., arczonalshift: Optional[_builtins.str] = ..., athena: Optional[_builtins.str] = ..., auditmanager: Optional[_builtins.str] = ..., autoscaling: Optional[_builtins.str] = ..., autoscalingplans: Optional[_builtins.str] = ..., backup: Optional[_builtins.str] = ..., batch: Optional[_builtins.str] = ..., bcmdataexports: Optional[_builtins.str] = ..., beanstalk: Optional[_builtins.str] = ..., bedrock: Optional[_builtins.str] = ..., bedrockagent: Optional[_builtins.str] = ..., bedrockagentcore: Optional[_builtins.str] = ..., billing: Optional[_builtins.str] = ..., budgets: Optional[_builtins.str] = ..., ce: Optional[_builtins.str] = ..., chatbot: Optional[_builtins.str] = ..., chime: Optional[_builtins.str] = ..., chimesdkmediapipelines: Optional[_builtins.str] = ..., chimesdkvoice: Optional[_builtins.str] = ..., cleanrooms: Optional[_builtins.str] = ..., cloud9: Optional[_builtins.str] = ..., cloudcontrol: Optional[_builtins.str] = ..., cloudcontrolapi: Optional[_builtins.str] = ..., cloudformation: Optional[_builtins.str] = ..., cloudfront: Optional[_builtins.str] = ..., cloudfrontkeyvaluestore: Optional[_builtins.str] = ..., cloudhsm: Optional[_builtins.str] = ..., cloudhsmv2: Optional[_builtins.str] = ..., cloudsearch: Optional[_builtins.str] = ..., cloudtrail: Optional[_builtins.str] = ..., cloudwatch: Optional[_builtins.str] = ..., cloudwatchevents: Optional[_builtins.str] = ..., cloudwatchevidently: Optional[_builtins.str] = ..., cloudwatchlog: Optional[_builtins.str] = ..., cloudwatchlogs: Optional[_builtins.str] = ..., cloudwatchobservabilityaccessmanager: Optional[_builtins.str] = ..., cloudwatchrum: Optional[_builtins.str] = ..., codeartifact: Optional[_builtins.str] = ..., codebuild: Optional[_builtins.str] = ..., codecatalyst: Optional[_builtins.str] = ..., codecommit: Optional[_builtins.str] = ..., codeconnections: Optional[_builtins.str] = ..., codedeploy: Optional[_builtins.str] = ..., codeguruprofiler: Optional[_builtins.str] = ..., codegurureviewer: Optional[_builtins.str] = ..., codepipeline: Optional[_builtins.str] = ..., codestarconnections: Optional[_builtins.str] = ..., codestarnotifications: Optional[_builtins.str] = ..., cognitoidentity: Optional[_builtins.str] = ..., cognitoidentityprovider: Optional[_builtins.str] = ..., cognitoidp: Optional[_builtins.str] = ..., comprehend: Optional[_builtins.str] = ..., computeoptimizer: Optional[_builtins.str] = ..., config: Optional[_builtins.str] = ..., configservice: Optional[_builtins.str] = ..., connect: Optional[_builtins.str] = ..., connectcases: Optional[_builtins.str] = ..., controltower: Optional[_builtins.str] = ..., costandusagereportservice: Optional[_builtins.str] = ..., costexplorer: Optional[_builtins.str] = ..., costoptimizationhub: Optional[_builtins.str] = ..., cur: Optional[_builtins.str] = ..., customerprofiles: Optional[_builtins.str] = ..., databasemigration: Optional[_builtins.str] = ..., databasemigrationservice: Optional[_builtins.str] = ..., databrew: Optional[_builtins.str] = ..., dataexchange: Optional[_builtins.str] = ..., datapipeline: Optional[_builtins.str] = ..., datasync: Optional[_builtins.str] = ..., datazone: Optional[_builtins.str] = ..., dax: Optional[_builtins.str] = ..., deploy: Optional[_builtins.str] = ..., detective: Optional[_builtins.str] = ..., devicefarm: Optional[_builtins.str] = ..., devopsguru: Optional[_builtins.str] = ..., directconnect: Optional[_builtins.str] = ..., directoryservice: Optional[_builtins.str] = ..., dlm: Optional[_builtins.str] = ..., dms: Optional[_builtins.str] = ..., docdb: Optional[_builtins.str] = ..., docdbelastic: Optional[_builtins.str] = ..., drs: Optional[_builtins.str] = ..., ds: Optional[_builtins.str] = ..., dsql: Optional[_builtins.str] = ..., dynamodb: Optional[_builtins.str] = ..., ec2: Optional[_builtins.str] = ..., ecr: Optional[_builtins.str] = ..., ecrpublic: Optional[_builtins.str] = ..., ecs: Optional[_builtins.str] = ..., efs: Optional[_builtins.str] = ..., eks: Optional[_builtins.str] = ..., elasticache: Optional[_builtins.str] = ..., elasticbeanstalk: Optional[_builtins.str] = ..., elasticloadbalancing: Optional[_builtins.str] = ..., elasticloadbalancingv2: Optional[_builtins.str] = ..., elasticsearch: Optional[_builtins.str] = ..., elasticsearchservice: Optional[_builtins.str] = ..., elastictranscoder: Optional[_builtins.str] = ..., elb: Optional[_builtins.str] = ..., elbv2: Optional[_builtins.str] = ..., emr: Optional[_builtins.str] = ..., emrcontainers: Optional[_builtins.str] = ..., emrserverless: Optional[_builtins.str] = ..., es: Optional[_builtins.str] = ..., eventbridge: Optional[_builtins.str] = ..., events: Optional[_builtins.str] = ..., evidently: Optional[_builtins.str] = ..., evs: Optional[_builtins.str] = ..., finspace: Optional[_builtins.str] = ..., firehose: Optional[_builtins.str] = ..., fis: Optional[_builtins.str] = ..., fms: Optional[_builtins.str] = ..., fsx: Optional[_builtins.str] = ..., gamelift: Optional[_builtins.str] = ..., glacier: Optional[_builtins.str] = ..., globalaccelerator: Optional[_builtins.str] = ..., glue: Optional[_builtins.str] = ..., gluedatabrew: Optional[_builtins.str] = ..., grafana: Optional[_builtins.str] = ..., greengrass: Optional[_builtins.str] = ..., groundstation: Optional[_builtins.str] = ..., guardduty: Optional[_builtins.str] = ..., healthlake: Optional[_builtins.str] = ..., iam: Optional[_builtins.str] = ..., identitystore: Optional[_builtins.str] = ..., imagebuilder: Optional[_builtins.str] = ..., inspector: Optional[_builtins.str] = ..., inspector2: Optional[_builtins.str] = ..., inspectorv2: Optional[_builtins.str] = ..., internetmonitor: Optional[_builtins.str] = ..., invoicing: Optional[_builtins.str] = ..., iot: Optional[_builtins.str] = ..., ivs: Optional[_builtins.str] = ..., ivschat: Optional[_builtins.str] = ..., kafka: Optional[_builtins.str] = ..., kafkaconnect: Optional[_builtins.str] = ..., kendra: Optional[_builtins.str] = ..., keyspaces: Optional[_builtins.str] = ..., kinesis: Optional[_builtins.str] = ..., kinesisanalytics: Optional[_builtins.str] = ..., kinesisanalyticsv2: Optional[_builtins.str] = ..., kinesisvideo: Optional[_builtins.str] = ..., kms: Optional[_builtins.str] = ..., lakeformation: Optional[_builtins.str] = ..., lambda_: Optional[_builtins.str] = ..., launchwizard: Optional[_builtins.str] = ..., lex: Optional[_builtins.str] = ..., lexmodelbuilding: Optional[_builtins.str] = ..., lexmodelbuildingservice: Optional[_builtins.str] = ..., lexmodels: Optional[_builtins.str] = ..., lexmodelsv2: Optional[_builtins.str] = ..., lexv2models: Optional[_builtins.str] = ..., licensemanager: Optional[_builtins.str] = ..., lightsail: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., locationservice: Optional[_builtins.str] = ..., logs: Optional[_builtins.str] = ..., m2: Optional[_builtins.str] = ..., macie2: Optional[_builtins.str] = ..., managedgrafana: Optional[_builtins.str] = ..., mediaconnect: Optional[_builtins.str] = ..., mediaconvert: Optional[_builtins.str] = ..., medialive: Optional[_builtins.str] = ..., mediapackage: Optional[_builtins.str] = ..., mediapackagev2: Optional[_builtins.str] = ..., mediapackagevod: Optional[_builtins.str] = ..., mediastore: Optional[_builtins.str] = ..., memorydb: Optional[_builtins.str] = ..., mgn: Optional[_builtins.str] = ..., mpa: Optional[_builtins.str] = ..., mq: Optional[_builtins.str] = ..., msk: Optional[_builtins.str] = ..., mwaa: Optional[_builtins.str] = ..., mwaaserverless: Optional[_builtins.str] = ..., neptune: Optional[_builtins.str] = ..., neptunegraph: Optional[_builtins.str] = ..., networkfirewall: Optional[_builtins.str] = ..., networkflowmonitor: Optional[_builtins.str] = ..., networkmanager: Optional[_builtins.str] = ..., networkmonitor: Optional[_builtins.str] = ..., notifications: Optional[_builtins.str] = ..., notificationscontacts: Optional[_builtins.str] = ..., oam: Optional[_builtins.str] = ..., observabilityadmin: Optional[_builtins.str] = ..., odb: Optional[_builtins.str] = ..., opensearch: Optional[_builtins.str] = ..., opensearchingestion: Optional[_builtins.str] = ..., opensearchserverless: Optional[_builtins.str] = ..., opensearchservice: Optional[_builtins.str] = ..., organizations: Optional[_builtins.str] = ..., osis: Optional[_builtins.str] = ..., outposts: Optional[_builtins.str] = ..., paymentcryptography: Optional[_builtins.str] = ..., pcaconnectorad: Optional[_builtins.str] = ..., pcs: Optional[_builtins.str] = ..., pinpoint: Optional[_builtins.str] = ..., pinpointsmsvoicev2: Optional[_builtins.str] = ..., pipes: Optional[_builtins.str] = ..., polly: Optional[_builtins.str] = ..., pricing: Optional[_builtins.str] = ..., prometheus: Optional[_builtins.str] = ..., prometheusservice: Optional[_builtins.str] = ..., qbusiness: Optional[_builtins.str] = ..., qldb: Optional[_builtins.str] = ..., quicksight: Optional[_builtins.str] = ..., ram: Optional[_builtins.str] = ..., rbin: Optional[_builtins.str] = ..., rds: Optional[_builtins.str] = ..., rdsdata: Optional[_builtins.str] = ..., rdsdataservice: Optional[_builtins.str] = ..., recyclebin: Optional[_builtins.str] = ..., redshift: Optional[_builtins.str] = ..., redshiftdata: Optional[_builtins.str] = ..., redshiftdataapiservice: Optional[_builtins.str] = ..., redshiftserverless: Optional[_builtins.str] = ..., rekognition: Optional[_builtins.str] = ..., resiliencehub: Optional[_builtins.str] = ..., resourceexplorer2: Optional[_builtins.str] = ..., resourcegroups: Optional[_builtins.str] = ..., resourcegroupstagging: Optional[_builtins.str] = ..., resourcegroupstaggingapi: Optional[_builtins.str] = ..., rolesanywhere: Optional[_builtins.str] = ..., route53: Optional[_builtins.str] = ..., route53domains: Optional[_builtins.str] = ..., route53profiles: Optional[_builtins.str] = ..., route53recoverycontrolconfig: Optional[_builtins.str] = ..., route53recoveryreadiness: Optional[_builtins.str] = ..., route53resolver: Optional[_builtins.str] = ..., rum: Optional[_builtins.str] = ..., s3: Optional[_builtins.str] = ..., s3api: Optional[_builtins.str] = ..., s3control: Optional[_builtins.str] = ..., s3outposts: Optional[_builtins.str] = ..., s3tables: Optional[_builtins.str] = ..., s3vectors: Optional[_builtins.str] = ..., sagemaker: Optional[_builtins.str] = ..., savingsplans: Optional[_builtins.str] = ..., scheduler: Optional[_builtins.str] = ..., schemas: Optional[_builtins.str] = ..., secretsmanager: Optional[_builtins.str] = ..., securityhub: Optional[_builtins.str] = ..., securitylake: Optional[_builtins.str] = ..., serverlessapplicationrepository: Optional[_builtins.str] = ..., serverlessapprepo: Optional[_builtins.str] = ..., serverlessrepo: Optional[_builtins.str] = ..., servicecatalog: Optional[_builtins.str] = ..., servicecatalogappregistry: Optional[_builtins.str] = ..., servicediscovery: Optional[_builtins.str] = ..., servicequotas: Optional[_builtins.str] = ..., ses: Optional[_builtins.str] = ..., sesv2: Optional[_builtins.str] = ..., sfn: Optional[_builtins.str] = ..., shield: Optional[_builtins.str] = ..., signer: Optional[_builtins.str] = ..., sns: Optional[_builtins.str] = ..., sqs: Optional[_builtins.str] = ..., ssm: Optional[_builtins.str] = ..., ssmcontacts: Optional[_builtins.str] = ..., ssmincidents: Optional[_builtins.str] = ..., ssmquicksetup: Optional[_builtins.str] = ..., ssmsap: Optional[_builtins.str] = ..., sso: Optional[_builtins.str] = ..., ssoadmin: Optional[_builtins.str] = ..., stepfunctions: Optional[_builtins.str] = ..., storagegateway: Optional[_builtins.str] = ..., sts: Optional[_builtins.str] = ..., swf: Optional[_builtins.str] = ..., synthetics: Optional[_builtins.str] = ..., taxsettings: Optional[_builtins.str] = ..., timestreaminfluxdb: Optional[_builtins.str] = ..., timestreamquery: Optional[_builtins.str] = ..., timestreamwrite: Optional[_builtins.str] = ..., transcribe: Optional[_builtins.str] = ..., transcribeservice: Optional[_builtins.str] = ..., transfer: Optional[_builtins.str] = ..., verifiedpermissions: Optional[_builtins.str] = ..., vpclattice: Optional[_builtins.str] = ..., waf: Optional[_builtins.str] = ..., wafregional: Optional[_builtins.str] = ..., wafv2: Optional[_builtins.str] = ..., wellarchitected: Optional[_builtins.str] = ..., workmail: Optional[_builtins.str] = ..., workspaces: Optional[_builtins.str] = ..., workspacesweb: Optional[_builtins.str] = ..., xray: Optional[_builtins.str] = ...) -> None:
...
class IgnoreTags(dict):
    def __init__(__self__, *, key_prefixes: Optional[Sequence[_builtins.str]] = ..., keys: Optional[Sequence[_builtins.str]] = ...) -> None:
