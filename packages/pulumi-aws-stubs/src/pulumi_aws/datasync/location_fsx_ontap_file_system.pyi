...
class _LocationFsxOntapFileSystemState:
    def __init__(
        ...
        *,
        ...
        protocol: Optional[pulumi.Input[LocationFsxOntapFileSystemProtocolArgs]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        security_group_arns: Optional[
            pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
        ] = ...,
        storage_virtual_machine_arn: Optional[pulumi.Input[_builtins.str]] = ...,
        subdirectory: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tags_all: Optional[
    ...
    def protocol(
        self,
    ) -> Optional[pulumi.Input[LocationFsxOntapFileSystemProtocolArgs]]: ...
    @protocol.setter
    def protocol(
        self, value: Optional[pulumi.Input[LocationFsxOntapFileSystemProtocolArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def region(self) -> Optional[pulumi.Input[_builtins.str]]: ...
