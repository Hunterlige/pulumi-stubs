...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EfsLocationEc2Config', 'FsxOpenZfsFileSystemProtocol', 'FsxOpenZfsFileSystemProtocolNfs', 'FsxOpenZfsFileSystemProtocolNfsMountOptions', 'LocationAzureBlobSasConfiguration', 'LocationFsxOntapFileSystemProtocol', 'LocationFsxOntapFileSystemProtocolNfs', 'LocationFsxOntapFileSystemProtocolNfsMountOptions', 'LocationFsxOntapFileSystemProtocolSmb', 'LocationFsxOntapFileSystemProtocolSmbMountOptions', 'LocationHdfsNameNode', 'LocationHdfsQopConfiguration', 'LocationSmbMountOptions', 'NfsLocationMountOptions', 'NfsLocationOnPremConfig', 'S3LocationS3Config', 'TaskExcludes', 'TaskIncludes', 'TaskOptions', 'TaskSchedule', 'TaskTaskReportConfig', 'TaskTaskReportConfigReportOverrides', 'TaskTaskReportConfigS3Destination']
@pulumi.output_type
class EfsLocationEc2Config(dict):
    ...
    def __init__(__self__, *, security_group_arns: Sequence[_builtins.str], subnet_arn: _builtins.str) -> None:
...
class FsxOpenZfsFileSystemProtocolNfs(dict):
    ...
    def __init__(__self__, *, mount_options: outputs.FsxOpenZfsFileSystemProtocolNfsMountOptions) -> None:
...
class LocationFsxOntapFileSystemProtocol(dict):
    def __init__(__self__, *, nfs: Optional[outputs.LocationFsxOntapFileSystemProtocolNfs] = ..., smb: Optional[outputs.LocationFsxOntapFileSystemProtocolSmb] = ...) -> None:
...
class LocationFsxOntapFileSystemProtocolNfs(dict):
    ...
    def __init__(__self__, *, mount_options: outputs.LocationFsxOntapFileSystemProtocolNfsMountOptions) -> None:
...
class LocationFsxOntapFileSystemProtocolSmb(dict):
    ...
    def __init__(__self__, *, mount_options: outputs.LocationFsxOntapFileSystemProtocolSmbMountOptions, password: _builtins.str, user: _builtins.str, domain: Optional[_builtins.str] = ...) -> None:
...
class LocationHdfsQopConfiguration(dict):
    ...
    def __init__(__self__, *, data_transfer_protection: Optional[_builtins.str] = ..., rpc_protection: Optional[_builtins.str] = ...) -> None:
...
class TaskExcludes(dict):
    ...
    def __init__(__self__, *, filter_type: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class TaskOptions(dict):
    ...
    def __init__(__self__, *, atime: Optional[_builtins.str] = ..., bytes_per_second: Optional[_builtins.int] = ..., gid: Optional[_builtins.str] = ..., log_level: Optional[_builtins.str] = ..., mtime: Optional[_builtins.str] = ..., object_tags: Optional[_builtins.str] = ..., overwrite_mode: Optional[_builtins.str] = ..., posix_permissions: Optional[_builtins.str] = ..., preserve_deleted_files: Optional[_builtins.str] = ..., preserve_devices: Optional[_builtins.str] = ..., security_descriptor_copy_flags: Optional[_builtins.str] = ..., task_queueing: Optional[_builtins.str] = ..., transfer_mode: Optional[_builtins.str] = ..., uid: Optional[_builtins.str] = ..., verify_mode: Optional[_builtins.str] = ...) -> None:
...
class TaskTaskReportConfig(dict):
    ...
    def __init__(__self__, *, s3_destination: outputs.TaskTaskReportConfigS3Destination, output_type: Optional[_builtins.str] = ..., report_level: Optional[_builtins.str] = ..., report_overrides: Optional[outputs.TaskTaskReportConfigReportOverrides] = ..., s3_object_versioning: Optional[_builtins.str] = ...) -> None:
...
class TaskTaskReportConfigReportOverrides(dict):
    ...
    def __init__(__self__, *, deleted_override: Optional[_builtins.str] = ..., skipped_override: Optional[_builtins.str] = ..., transferred_override: Optional[_builtins.str] = ..., verified_override: Optional[_builtins.str] = ...) -> None:
...
class TaskTaskReportConfigS3Destination(dict):
    ...
    def __init__(__self__, *, bucket_access_role_arn: _builtins.str, s3_bucket_arn: _builtins.str, subdirectory: Optional[_builtins.str] = ...) -> None:
