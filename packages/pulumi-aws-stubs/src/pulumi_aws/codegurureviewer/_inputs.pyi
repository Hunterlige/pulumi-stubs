...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['RepositoryAssociationKmsKeyDetailsArgs', 'RepositoryAssociationKmsKeyDetailsArgsDict', 'RepositoryAssociationRepositoryArgs', 'RepositoryAssociationRepositoryArgsDict', 'RepositoryAssociationRepositoryBitbucketArgs', 'RepositoryAssociationRepositoryBitbucketArgsDict', 'RepositoryAssociationRepositoryCodecommitArgs', 'RepositoryAssociationRepositoryCodecommitArgsDict', ..., ..., 'RepositoryAssociationRepositoryS3BucketArgs', 'RepositoryAssociationRepositoryS3BucketArgsDict', 'RepositoryAssociationS3RepositoryDetailArgs', 'RepositoryAssociationS3RepositoryDetailArgsDict', ..., ...]
...
class RepositoryAssociationKmsKeyDetailsArgs:
    def __init__(__self__, *, encryption_option: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RepositoryAssociationRepositoryArgs:
    def __init__(__self__, *, bitbucket: Optional[pulumi.Input[RepositoryAssociationRepositoryBitbucketArgs]] = ..., codecommit: Optional[pulumi.Input[RepositoryAssociationRepositoryCodecommitArgs]] = ..., github_enterprise_server: Optional[pulumi.Input[RepositoryAssociationRepositoryGithubEnterpriseServerArgs]] = ..., s3_bucket: Optional[pulumi.Input[RepositoryAssociationRepositoryS3BucketArgs]] = ...) -> None:
        ...
    ...
    @bitbucket.setter
    def bitbucket(self, value: Optional[pulumi.Input[RepositoryAssociationRepositoryBitbucketArgs]]): # -> None:
        ...
    ...
    @codecommit.setter
    def codecommit(self, value: Optional[pulumi.Input[RepositoryAssociationRepositoryCodecommitArgs]]): # -> None:
        ...
    ...
    def github_enterprise_server(self, value: Optional[pulumi.Input[RepositoryAssociationRepositoryGithubEnterpriseServerArgs]]): # -> None:
        ...
    ...
    @s3_bucket.setter
    def s3_bucket(self, value: Optional[pulumi.Input[RepositoryAssociationRepositoryS3BucketArgs]]): # -> None:
        ...
...
class RepositoryAssociationRepositoryBitbucketArgs:
    def __init__(__self__, *, connection_arn: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], owner: pulumi.Input[_builtins.str]) -> None:
...
class RepositoryAssociationRepositoryS3BucketArgs:
    def __init__(__self__, *, bucket_name: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str]) -> None:
...
class RepositoryAssociationS3RepositoryDetailArgs:
    def __init__(__self__, *, bucket_name: Optional[pulumi.Input[_builtins.str]] = ..., code_artifacts: Optional[pulumi.Input[Sequence[pulumi.Input[RepositoryAssociationS3RepositoryDetailCodeArtifactArgs]]]] = ...) -> None:
    ...
    def code_artifacts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RepositoryAssociationS3RepositoryDetailCodeArtifactArgs]]]]): # -> None:
        ...
...
class RepositoryAssociationS3RepositoryDetailCodeArtifactArgs:
    def __init__(__self__, *, build_artifacts_object_key: Optional[pulumi.Input[_builtins.str]] = ..., source_code_artifacts_object_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    def build_artifacts_object_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="sourceCodeArtifactsObjectKey")
    def source_code_artifacts_object_key(self) -> Optional[pulumi.Input[_builtins.str]]:
        ...
    
    @source_code_artifacts_object_key.setter
    def source_code_artifacts_object_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
