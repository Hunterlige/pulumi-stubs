...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['RepositoryAssociationKmsKeyDetails', 'RepositoryAssociationRepository', 'RepositoryAssociationRepositoryBitbucket', 'RepositoryAssociationRepositoryCodecommit', ..., 'RepositoryAssociationRepositoryS3Bucket', 'RepositoryAssociationS3RepositoryDetail', ...]
@pulumi.output_type
class RepositoryAssociationKmsKeyDetails(dict):
    ...
    def __init__(__self__, *, encryption_option: Optional[_builtins.str] = ..., kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class RepositoryAssociationRepository(dict):
    ...
    def __init__(__self__, *, bitbucket: Optional[outputs.RepositoryAssociationRepositoryBitbucket] = ..., codecommit: Optional[outputs.RepositoryAssociationRepositoryCodecommit] = ..., github_enterprise_server: Optional[outputs.RepositoryAssociationRepositoryGithubEnterpriseServer] = ..., s3_bucket: Optional[outputs.RepositoryAssociationRepositoryS3Bucket] = ...) -> None:
        ...
...
class RepositoryAssociationRepositoryBitbucket(dict):
    ...
    def __init__(__self__, *, connection_arn: _builtins.str, name: _builtins.str, owner: _builtins.str) -> None:
...
class RepositoryAssociationRepositoryS3Bucket(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, name: _builtins.str) -> None:
...
class RepositoryAssociationS3RepositoryDetail(dict):
    ...
    def __init__(__self__, *, bucket_name: Optional[_builtins.str] = ..., code_artifacts: Optional[Sequence[outputs.RepositoryAssociationS3RepositoryDetailCodeArtifact]] = ...) -> None:
...
class RepositoryAssociationS3RepositoryDetailCodeArtifact(dict):
    ...
    def __init__(__self__, *, build_artifacts_object_key: Optional[_builtins.str] = ..., source_code_artifacts_object_key: Optional[_builtins.str] = ...) -> None:
        ...
