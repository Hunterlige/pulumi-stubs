...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EndpointServicePrivateDnsVerificationTimeoutsArgs', ..., 'RouteServerEndpointTimeoutsArgs', 'RouteServerEndpointTimeoutsArgsDict', 'RouteServerPeerBgpOptionsArgs', 'RouteServerPeerBgpOptionsArgsDict', 'RouteServerPeerTimeoutsArgs', 'RouteServerPeerTimeoutsArgsDict', 'RouteServerPropagationTimeoutsArgs', 'RouteServerPropagationTimeoutsArgsDict', 'RouteServerTimeoutsArgs', 'RouteServerTimeoutsArgsDict', 'RouteServerVpcAssociationTimeoutsArgs', 'RouteServerVpcAssociationTimeoutsArgsDict', 'SecurityGroupVpcAssociationTimeoutsArgs', 'SecurityGroupVpcAssociationTimeoutsArgsDict', 'GetSecurityGroupRuleFilterArgs', 'GetSecurityGroupRuleFilterArgsDict', 'GetSecurityGroupRulesFilterArgs', 'GetSecurityGroupRulesFilterArgsDict']
...
class RouteServerPeerBgpOptionsArgs:
    def __init__(__self__, *, peer_asn: pulumi.Input[_builtins.int], peer_liveness_detection: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def peer_liveness_detection(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
