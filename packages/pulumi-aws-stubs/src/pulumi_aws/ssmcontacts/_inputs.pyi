...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ContactChannelDeliveryAddressArgs', 'ContactChannelDeliveryAddressArgsDict', 'PlanStageArgs', 'PlanStageArgsDict', 'PlanStageTargetArgs', 'PlanStageTargetArgsDict', 'PlanStageTargetChannelTargetInfoArgs', 'PlanStageTargetChannelTargetInfoArgsDict', 'PlanStageTargetContactTargetInfoArgs', 'PlanStageTargetContactTargetInfoArgsDict']
...
class ContactChannelDeliveryAddressArgs:
    ...
    def simple_address(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
@pulumi.input_type
class PlanStageArgs:
    def __init__(__self__, *, duration_in_minutes: pulumi.Input[_builtins.int], targets: Optional[pulumi.Input[Sequence[pulumi.Input[PlanStageTargetArgs]]]] = ...) -> None:
    ...
    def duration_in_minutes(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @targets.setter
    def targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanStageTargetArgs]]]]): # -> None:
        ...
...
class PlanStageTargetArgs:
    def __init__(__self__, *, channel_target_info: Optional[pulumi.Input[PlanStageTargetChannelTargetInfoArgs]] = ..., contact_target_info: Optional[pulumi.Input[PlanStageTargetContactTargetInfoArgs]] = ...) -> None:
    ...
    def channel_target_info(self, value: Optional[pulumi.Input[PlanStageTargetChannelTargetInfoArgs]]): # -> None:
        ...
    ...
    def contact_target_info(self, value: Optional[pulumi.Input[PlanStageTargetContactTargetInfoArgs]]): # -> None:
        ...
...
class PlanStageTargetChannelTargetInfoArgs:
    def __init__(__self__, *, contact_channel_id: pulumi.Input[_builtins.str], retry_interval_in_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def contact_channel_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def retry_interval_in_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class PlanStageTargetContactTargetInfoArgs:
    def __init__(__self__, *, is_essential: pulumi.Input[_builtins.bool], contact_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @is_essential.setter
    def is_essential(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
