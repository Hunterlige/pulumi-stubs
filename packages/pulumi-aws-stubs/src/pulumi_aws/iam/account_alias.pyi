...
class AccountAliasArgs:
    ...
    def account_alias(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class _AccountAliasState:
    def __init__(__self__, *, account_alias: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @account_alias.setter
    def account_alias(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AccountAlias(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., account_alias: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., account_alias: Optional[pulumi.Input[_builtins.str]] = ...) -> AccountAlias:
