...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['RoleInlinePolicy', 'GetAccessKeysAccessKeyResult', 'GetGroupUserResult', 'GetPolicyDocumentStatementResult', 'GetPolicyDocumentStatementConditionResult', 'GetPolicyDocumentStatementNotPrincipalResult', 'GetPolicyDocumentStatementPrincipalResult', 'GetPrincipalPolicySimulationContextResult', 'GetPrincipalPolicySimulationResultResult', ..., 'GetRoleRoleLastUsedResult']
@pulumi.output_type
class RoleInlinePolicy(dict):
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., policy: Optional[_builtins.str] = ...) -> None:
...
class GetAccessKeysAccessKeyResult(dict):
    def __init__(__self__, *, access_key_id: _builtins.str, create_date: _builtins.str, status: _builtins.str) -> None:
...
class GetGroupUserResult(dict):
    def __init__(__self__, *, arn: _builtins.str, path: _builtins.str, user_id: _builtins.str, user_name: _builtins.str) -> None:
...
class GetPolicyDocumentStatementResult(dict):
    def __init__(__self__, *, actions: Optional[Sequence[_builtins.str]] = ..., conditions: Optional[Sequence[outputs.GetPolicyDocumentStatementConditionResult]] = ..., effect: Optional[_builtins.str] = ..., not_actions: Optional[Sequence[_builtins.str]] = ..., not_principals: Optional[Sequence[outputs.GetPolicyDocumentStatementNotPrincipalResult]] = ..., not_resources: Optional[Sequence[_builtins.str]] = ..., principals: Optional[Sequence[outputs.GetPolicyDocumentStatementPrincipalResult]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., sid: Optional[_builtins.str] = ...) -> None:
...
class GetPrincipalPolicySimulationResultResult(dict):
    def __init__(__self__, *, action_name: _builtins.str, allowed: _builtins.bool, decision: _builtins.str, decision_details: Mapping[str, _builtins.str], matched_statements: Sequence[outputs.GetPrincipalPolicySimulationResultMatchedStatementResult], missing_context_keys: Sequence[_builtins.str], resource_arn: _builtins.str) -> None:
...
class GetPrincipalPolicySimulationResultMatchedStatementResult(dict):
    def __init__(__self__, *, source_policy_id: _builtins.str, source_policy_type: _builtins.str) -> None:
...
class GetRoleRoleLastUsedResult(dict):
    def __init__(__self__, *, last_used_date: _builtins.str, region: _builtins.str) -> None:
