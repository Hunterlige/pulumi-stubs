...
class UserGroupMembershipArgs:
    def __init__(__self__, *, groups: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], user: pulumi.Input[_builtins.str]) -> None:
...
class _UserGroupMembershipState:
    def __init__(__self__, *, groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., user: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class UserGroupMembership(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., user: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: UserGroupMembershipArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., user: Optional[pulumi.Input[_builtins.str]] = ...) -> UserGroupMembership:
