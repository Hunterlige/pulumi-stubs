...
@pulumi.input_type
class AccessKeyArgs:
    def __init__(__self__, *, user: pulumi.Input[_builtins.str], pgp_key: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class _AccessKeyState:
    def __init__(__self__, *, create_date: Optional[pulumi.Input[_builtins.str]] = ..., encrypted_secret: Optional[pulumi.Input[_builtins.str]] = ..., encrypted_ses_smtp_password_v4: Optional[pulumi.Input[_builtins.str]] = ..., key_fingerprint: Optional[pulumi.Input[_builtins.str]] = ..., pgp_key: Optional[pulumi.Input[_builtins.str]] = ..., secret: Optional[pulumi.Input[_builtins.str]] = ..., ses_smtp_password_v4: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., user: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def encrypted_secret(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def encrypted_ses_smtp_password_v4(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ses_smtp_password_v4(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AccessKey(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., pgp_key: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., user: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., create_date: Optional[pulumi.Input[_builtins.str]] = ..., encrypted_secret: Optional[pulumi.Input[_builtins.str]] = ..., encrypted_ses_smtp_password_v4: Optional[pulumi.Input[_builtins.str]] = ..., key_fingerprint: Optional[pulumi.Input[_builtins.str]] = ..., pgp_key: Optional[pulumi.Input[_builtins.str]] = ..., secret: Optional[pulumi.Input[_builtins.str]] = ..., ses_smtp_password_v4: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., user: Optional[pulumi.Input[_builtins.str]] = ...) -> AccessKey:
