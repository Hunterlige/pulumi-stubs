...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AWSPrincipalArgs', 'AWSPrincipalArgsDict', 'FederatedPrincipalArgs', 'FederatedPrincipalArgsDict', 'PolicyDocumentArgs', 'PolicyDocumentArgsDict', 'PolicyStatementArgs', 'PolicyStatementArgsDict', 'RoleInlinePolicyArgs', 'RoleInlinePolicyArgsDict', 'ServicePrincipalArgs', 'ServicePrincipalArgsDict', 'GetPolicyDocumentStatementArgs', 'GetPolicyDocumentStatementArgsDict', 'GetPolicyDocumentStatementConditionArgs', 'GetPolicyDocumentStatementConditionArgsDict', 'GetPolicyDocumentStatementNotPrincipalArgs', 'GetPolicyDocumentStatementNotPrincipalArgsDict', 'GetPolicyDocumentStatementPrincipalArgs', 'GetPolicyDocumentStatementPrincipalArgsDict', 'GetPrincipalPolicySimulationContextArgs', 'GetPrincipalPolicySimulationContextArgsDict']
...
class AWSPrincipalArgs:
    def __init__(__self__, *, aws: pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]) -> None:
    ...
    @aws.setter
    def aws(self, value: pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class FederatedPrincipalArgs:
    def __init__(__self__, *, federated: pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]) -> None:
    ...
    @federated.setter
    def federated(self, value: pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class PolicyDocumentArgs:
    def __init__(__self__, *, statement: pulumi.Input[Sequence[pulumi.Input[PolicyStatementArgs]]], version: pulumi.Input[PolicyDocumentVersion], id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @statement.setter
    def statement(self, value: pulumi.Input[Sequence[pulumi.Input[PolicyStatementArgs]]]): # -> None:
        ...
    ...
    @version.setter
    def version(self, value: pulumi.Input[PolicyDocumentVersion]): # -> None:
        ...
...
class PolicyStatementArgs:
    def __init__(__self__, *, effect: pulumi.Input[PolicyStatementEffect], action: Optional[pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]] = ..., condition: Optional[pulumi.Input[Mapping[str, Any]]] = ..., not_action: Optional[pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]] = ..., not_principal: Optional[pulumi.Input[Union[_builtins.str, AWSPrincipalArgs, ServicePrincipalArgs, FederatedPrincipalArgs]]] = ..., not_resource: Optional[pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]] = ..., principal: Optional[pulumi.Input[Union[_builtins.str, AWSPrincipalArgs, ServicePrincipalArgs, FederatedPrincipalArgs]]] = ..., resource: Optional[pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]] = ..., sid: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @effect.setter
    def effect(self, value: pulumi.Input[PolicyStatementEffect]): # -> None:
        ...
    ...
    @action.setter
    def action(self, value: Optional[pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]]): # -> None:
        ...
    ...
    @condition.setter
    def condition(self, value: Optional[pulumi.Input[Mapping[str, Any]]]): # -> None:
        ...
    ...
    @not_action.setter
    def not_action(self, value: Optional[pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]]): # -> None:
        ...
    ...
    def not_principal(self, value: Optional[pulumi.Input[Union[_builtins.str, AWSPrincipalArgs, ServicePrincipalArgs, FederatedPrincipalArgs]]]): # -> None:
        ...
    ...
    @not_resource.setter
    def not_resource(self, value: Optional[pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]]): # -> None:
        ...
    ...
    @principal.setter
    def principal(self, value: Optional[pulumi.Input[Union[_builtins.str, AWSPrincipalArgs, ServicePrincipalArgs, FederatedPrincipalArgs]]]): # -> None:
        ...
    ...
    @resource.setter
    def resource(self, value: Optional[pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]]): # -> None:
        ...
...
class RoleInlinePolicyArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., policy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServicePrincipalArgs:
    def __init__(__self__, *, service: pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]) -> None:
    ...
    @service.setter
    def service(self, value: pulumi.Input[Union[_builtins.str, Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class GetPolicyDocumentStatementArgs:
    def __init__(__self__, *, actions: Optional[Sequence[_builtins.str]] = ..., conditions: Optional[Sequence[GetPolicyDocumentStatementConditionArgs]] = ..., effect: Optional[_builtins.str] = ..., not_actions: Optional[Sequence[_builtins.str]] = ..., not_principals: Optional[Sequence[GetPolicyDocumentStatementNotPrincipalArgs]] = ..., not_resources: Optional[Sequence[_builtins.str]] = ..., principals: Optional[Sequence[GetPolicyDocumentStatementPrincipalArgs]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., sid: Optional[_builtins.str] = ...) -> None:
    ...
    @actions.setter
    def actions(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    @conditions.setter
    def conditions(self, value: Optional[Sequence[GetPolicyDocumentStatementConditionArgs]]): # -> None:
        ...
    ...
    @effect.setter
    def effect(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    @not_actions.setter
    def not_actions(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    def not_principals(self, value: Optional[Sequence[GetPolicyDocumentStatementNotPrincipalArgs]]): # -> None:
        ...
    ...
    def not_resources(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    @principals.setter
    def principals(self, value: Optional[Sequence[GetPolicyDocumentStatementPrincipalArgs]]): # -> None:
        ...
    ...
    @resources.setter
    def resources(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
...
class GetPolicyDocumentStatementConditionArgs:
    def __init__(__self__, *, test: _builtins.str, values: Sequence[_builtins.str], variable: _builtins.str) -> None:
    ...
    @test.setter
    def test(self, value: _builtins.str): # -> None:
        ...
    ...
    @variable.setter
    def variable(self, value: _builtins.str): # -> None:
        ...
...
class GetPolicyDocumentStatementNotPrincipalArgs:
    def __init__(__self__, *, identifiers: Sequence[_builtins.str], type: _builtins.str) -> None:
    ...
    @identifiers.setter
    def identifiers(self, value: Sequence[_builtins.str]): # -> None:
        ...
...
class GetPrincipalPolicySimulationContextArgs:
    def __init__(__self__, *, key: _builtins.str, type: _builtins.str, values: Sequence[_builtins.str]) -> None:
