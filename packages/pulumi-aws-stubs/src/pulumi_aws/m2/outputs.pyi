...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationDefinition', 'ApplicationTimeouts', 'DeploymentTimeouts', 'EnvironmentHighAvailabilityConfig', 'EnvironmentStorageConfiguration', 'EnvironmentStorageConfigurationEfs', 'EnvironmentStorageConfigurationFsx', 'EnvironmentTimeouts']
@pulumi.output_type
class ApplicationDefinition(dict):
    ...
    def __init__(__self__, *, content: Optional[_builtins.str] = ..., s3_location: Optional[_builtins.str] = ...) -> None:
...
class EnvironmentStorageConfiguration(dict):
    def __init__(__self__, *, efs: Optional[outputs.EnvironmentStorageConfigurationEfs] = ..., fsx: Optional[outputs.EnvironmentStorageConfigurationFsx] = ...) -> None:
        ...
...
class EnvironmentStorageConfigurationEfs(dict):
    ...
    def __init__(__self__, *, file_system_id: _builtins.str, mount_point: _builtins.str) -> None:
