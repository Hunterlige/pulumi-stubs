...
class GetEndpointResult:
    ...
    def __init__(__self__, certificate_arn=..., database_name=..., elasticsearch_settings=..., endpoint_arn=..., endpoint_id=..., endpoint_type=..., engine_name=..., extra_connection_attributes=..., id=..., kafka_settings=..., kinesis_settings=..., kms_key_arn=..., mongodb_settings=..., mysql_settings=..., password=..., port=..., postgres_settings=..., redis_settings=..., redshift_settings=..., region=..., s3_settings=..., secrets_manager_access_role_arn=..., secrets_manager_arn=..., server_name=..., service_access_role=..., ssl_mode=..., tags=..., username=...) -> None:
        ...
...
def get_endpoint(endpoint_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetEndpointResult:
    
    ...

def get_endpoint_output(endpoint_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetEndpointResult]:
