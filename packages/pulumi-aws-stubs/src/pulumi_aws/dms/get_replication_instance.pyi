...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetReplicationInstanceResult', 'AwaitableGetReplicationInstanceResult', 'get_replication_instance', 'get_replication_instance_output']
@pulumi.output_type
class GetReplicationInstanceResult:
    
    def __init__(__self__, allocated_storage=..., auto_minor_version_upgrade=..., availability_zone=..., engine_version=..., id=..., kms_key_arn=..., multi_az=..., network_type=..., preferred_maintenance_window=..., publicly_accessible=..., region=..., replication_instance_arn=..., replication_instance_class=..., replication_instance_id=..., replication_instance_private_ips=..., replication_instance_public_ips=..., replication_subnet_group_id=..., tags=..., vpc_security_group_ids=...) -> None:
        ...
...
class AwaitableGetReplicationInstanceResult(GetReplicationInstanceResult):
    def __await__(self): # -> Generator[Never, Any, GetReplicationInstanceResult]:
        ...
    


def get_replication_instance(region: Optional[_builtins.str] = ..., replication_instance_id: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetReplicationInstanceResult:
    
    ...

def get_replication_instance_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., replication_instance_id: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetReplicationInstanceResult]:
