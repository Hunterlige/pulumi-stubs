...
class VirtualClusterArgs:
    ...
    def container_provider(
        self,
    ) -> pulumi.Input[VirtualClusterContainerProviderArgs]: ...
    @container_provider.setter
    def container_provider(
        self, value: pulumi.Input[VirtualClusterContainerProviderArgs]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _VirtualClusterState:
    ...
    def container_provider(
        self,
    ) -> Optional[pulumi.Input[VirtualClusterContainerProviderArgs]]: ...
    @container_provider.setter
    def container_provider(
        self, value: Optional[pulumi.Input[VirtualClusterContainerProviderArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def name(self) -> Optional[pulumi.Input[_builtins.str]]: ...
...
class VirtualCluster(pulumi.CustomResource):
    ...
    def container_provider(
        self,
    ) -> pulumi.Output[outputs.VirtualClusterContainerProvider]: ...
    @_builtins.property
    @pulumi.getter
