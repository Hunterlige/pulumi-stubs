...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['JobTemplateJobTemplateDataArgs', 'JobTemplateJobTemplateDataArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'JobTemplateJobTemplateDataJobDriverArgs', 'JobTemplateJobTemplateDataJobDriverArgsDict', ..., ..., ..., ..., 'VirtualClusterContainerProviderArgs', 'VirtualClusterContainerProviderArgsDict', 'VirtualClusterContainerProviderInfoArgs', 'VirtualClusterContainerProviderInfoArgsDict', 'VirtualClusterContainerProviderInfoEksInfoArgs', 'VirtualClusterContainerProviderInfoEksInfoArgsDict']
...
class JobTemplateJobTemplateDataArgs:
    def __init__(__self__, *, execution_role_arn: pulumi.Input[_builtins.str], job_driver: pulumi.Input[JobTemplateJobTemplateDataJobDriverArgs], release_label: pulumi.Input[_builtins.str], configuration_overrides: Optional[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesArgs]] = ..., job_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @job_driver.setter
    def job_driver(self, value: pulumi.Input[JobTemplateJobTemplateDataJobDriverArgs]): # -> None:
        ...
    ...
    def configuration_overrides(self, value: Optional[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesArgs]]): # -> None:
        ...
    ...
    @job_tags.setter
    def job_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class JobTemplateJobTemplateDataConfigurationOverridesArgs:
    def __init__(__self__, *, application_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesApplicationConfigurationArgs]]]] = ..., monitoring_configuration: Optional[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationArgs]] = ...) -> None:
    ...
    def application_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesApplicationConfigurationArgs]]]]): # -> None:
        ...
    ...
    def monitoring_configuration(self, value: Optional[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationArgs]]): # -> None:
        ...
...
class JobTemplateJobTemplateDataConfigurationOverridesApplicationConfigurationArgs:
    def __init__(__self__, *, classification: pulumi.Input[_builtins.str], configurations: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesApplicationConfigurationConfigurationArgs]]]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesApplicationConfigurationConfigurationArgs]]]]): # -> None:
        ...
...
class JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationArgs:
    def __init__(__self__, *, cloud_watch_monitoring_configuration: Optional[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationCloudWatchMonitoringConfigurationArgs]] = ..., persistent_app_ui: Optional[pulumi.Input[_builtins.str]] = ..., s3_monitoring_configuration: Optional[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationS3MonitoringConfigurationArgs]] = ...) -> None:
    ...
    def cloud_watch_monitoring_configuration(self, value: Optional[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationCloudWatchMonitoringConfigurationArgs]]): # -> None:
        ...
    ...
    def persistent_app_ui(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def s3_monitoring_configuration(self, value: Optional[pulumi.Input[JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationS3MonitoringConfigurationArgs]]): # -> None:
        ...
...
class JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationCloudWatchMonitoringConfigurationArgs:
    def __init__(__self__, *, log_group_name: pulumi.Input[_builtins.str], log_stream_name_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationS3MonitoringConfigurationArgs:
    ...
    @log_uri.setter
    def log_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class JobTemplateJobTemplateDataJobDriverArgs:
    def __init__(__self__, *, spark_sql_job_driver: Optional[pulumi.Input[JobTemplateJobTemplateDataJobDriverSparkSqlJobDriverArgs]] = ..., spark_submit_job_driver: Optional[pulumi.Input[JobTemplateJobTemplateDataJobDriverSparkSubmitJobDriverArgs]] = ...) -> None:
    ...
    def spark_sql_job_driver(self, value: Optional[pulumi.Input[JobTemplateJobTemplateDataJobDriverSparkSqlJobDriverArgs]]): # -> None:
        ...
    ...
    def spark_submit_job_driver(self, value: Optional[pulumi.Input[JobTemplateJobTemplateDataJobDriverSparkSubmitJobDriverArgs]]): # -> None:
        ...
...
class JobTemplateJobTemplateDataJobDriverSparkSqlJobDriverArgs:
    def __init__(__self__, *, entry_point: Optional[pulumi.Input[_builtins.str]] = ..., spark_sql_parameters: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def spark_sql_parameters(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class JobTemplateJobTemplateDataJobDriverSparkSubmitJobDriverArgs:
    def __init__(__self__, *, entry_point: pulumi.Input[_builtins.str], entry_point_arguments: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., spark_submit_parameters: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def entry_point_arguments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def spark_submit_parameters(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VirtualClusterContainerProviderArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], info: pulumi.Input[VirtualClusterContainerProviderInfoArgs], type: pulumi.Input[_builtins.str]) -> None:
    ...
    @info.setter
    def info(self, value: pulumi.Input[VirtualClusterContainerProviderInfoArgs]): # -> None:
        ...
...
class VirtualClusterContainerProviderInfoArgs:
    def __init__(__self__, *, eks_info: pulumi.Input[VirtualClusterContainerProviderInfoEksInfoArgs]) -> None:
    ...
    @eks_info.setter
    def eks_info(self, value: pulumi.Input[VirtualClusterContainerProviderInfoEksInfoArgs]): # -> None:
        ...
...
class VirtualClusterContainerProviderInfoEksInfoArgs:
    def __init__(__self__, *, namespace: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
