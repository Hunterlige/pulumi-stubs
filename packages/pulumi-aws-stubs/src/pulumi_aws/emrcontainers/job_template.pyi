...
class JobTemplateArgs:
    ...
    def job_template_data(
        self, value: pulumi.Input[JobTemplateJobTemplateDataArgs]
    ): ...
    @_builtins.property
...
class _JobTemplateState:
    def __init__(
        ...
        *,
        ...
        job_template_data: Optional[pulumi.Input[JobTemplateJobTemplateDataArgs]] = ...,
        kms_key_arn: Optional[pulumi.Input[_builtins.str]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
    ...
    def job_template_data(
        self,
    ) -> Optional[pulumi.Input[JobTemplateJobTemplateDataArgs]]: ...
    @job_template_data.setter
    def job_template_data(
        self, value: Optional[pulumi.Input[JobTemplateJobTemplateDataArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter(name="kmsKeyArn")
    def kms_key_arn(self) -> Optional[pulumi.Input[_builtins.str]]: ...
...
class JobTemplate(pulumi.CustomResource):
    ...
    def __init__(
        ...
        job_template_data: Optional[
            pulumi.Input[
                Union[
                    JobTemplateJobTemplateDataArgs, JobTemplateJobTemplateDataArgsDict
                ]
            ]
        ] = ...,
        kms_key_arn: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def job_template_data(
        self,
    ) -> pulumi.Output[outputs.JobTemplateJobTemplateData]: ...
    @_builtins.property
    @pulumi.getter(name="kmsKeyArn")
