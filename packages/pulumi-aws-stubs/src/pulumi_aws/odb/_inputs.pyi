...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CloudAutonomousVmClusterMaintenanceWindowArgs', 'CloudAutonomousVmClusterMaintenanceWindowArgsDict', ..., ..., 'CloudAutonomousVmClusterMaintenanceWindowMonthArgs', ..., 'CloudAutonomousVmClusterTimeoutsArgs', 'CloudAutonomousVmClusterTimeoutsArgsDict', ..., ..., 'CloudExadataInfrastructureMaintenanceWindowArgs', ..., ..., ..., ..., ..., 'CloudExadataInfrastructureTimeoutsArgs', 'CloudExadataInfrastructureTimeoutsArgsDict', 'CloudVmClusterDataCollectionOptionsArgs', 'CloudVmClusterDataCollectionOptionsArgsDict', 'CloudVmClusterIormConfigCacheArgs', 'CloudVmClusterIormConfigCacheArgsDict', 'CloudVmClusterIormConfigCacheDbPlanArgs', 'CloudVmClusterIormConfigCacheDbPlanArgsDict', 'CloudVmClusterTimeoutsArgs', 'CloudVmClusterTimeoutsArgsDict', 'NetworkManagedServiceArgs', 'NetworkManagedServiceArgsDict', 'NetworkManagedServiceKmsAccessArgs', 'NetworkManagedServiceKmsAccessArgsDict', 'NetworkManagedServiceManagedS3BackupAccessArgs', 'NetworkManagedServiceManagedS3BackupAccessArgsDict', 'NetworkManagedServiceS3AccessArgs', 'NetworkManagedServiceS3AccessArgsDict', 'NetworkManagedServiceServiceNetworkEndpointArgs', ..., 'NetworkManagedServiceStsAccessArgs', 'NetworkManagedServiceStsAccessArgsDict', 'NetworkManagedServiceZeroEtlAccessArgs', 'NetworkManagedServiceZeroEtlAccessArgsDict', 'NetworkOciDnsForwardingConfigArgs', 'NetworkOciDnsForwardingConfigArgsDict', 'NetworkPeeringConnectionTimeoutsArgs', 'NetworkPeeringConnectionTimeoutsArgsDict', 'NetworkTimeoutsArgs', 'NetworkTimeoutsArgsDict']
...
class CloudAutonomousVmClusterMaintenanceWindowArgs:
    def __init__(__self__, *, preference: pulumi.Input[_builtins.str], days_of_weeks: Optional[pulumi.Input[Sequence[pulumi.Input[CloudAutonomousVmClusterMaintenanceWindowDaysOfWeekArgs]]]] = ..., hours_of_days: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ..., lead_time_in_weeks: Optional[pulumi.Input[_builtins.int]] = ..., months: Optional[pulumi.Input[Sequence[pulumi.Input[CloudAutonomousVmClusterMaintenanceWindowMonthArgs]]]] = ..., weeks_of_months: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ...) -> None:
    ...
    @preference.setter
    def preference(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def days_of_weeks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CloudAutonomousVmClusterMaintenanceWindowDaysOfWeekArgs]]]]): # -> None:
        ...
    ...
    def lead_time_in_weeks(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @months.setter
    def months(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CloudAutonomousVmClusterMaintenanceWindowMonthArgs]]]]): # -> None:
        ...
...
class CloudExadataInfrastructureMaintenanceWindowArgs:
    def __init__(__self__, *, custom_action_timeout_in_mins: pulumi.Input[_builtins.int], is_custom_action_timeout_enabled: pulumi.Input[_builtins.bool], patching_mode: pulumi.Input[_builtins.str], preference: pulumi.Input[_builtins.str], days_of_weeks: Optional[pulumi.Input[Sequence[pulumi.Input[CloudExadataInfrastructureMaintenanceWindowDaysOfWeekArgs]]]] = ..., hours_of_days: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ..., lead_time_in_weeks: Optional[pulumi.Input[_builtins.int]] = ..., months: Optional[pulumi.Input[Sequence[pulumi.Input[CloudExadataInfrastructureMaintenanceWindowMonthArgs]]]] = ..., weeks_of_months: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ...) -> None:
    ...
    def custom_action_timeout_in_mins(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def is_custom_action_timeout_enabled(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def patching_mode(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @days_of_weeks.setter
    def days_of_weeks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CloudExadataInfrastructureMaintenanceWindowDaysOfWeekArgs]]]]): # -> None:
        ...
    ...
    @months.setter
    def months(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CloudExadataInfrastructureMaintenanceWindowMonthArgs]]]]): # -> None:
        ...
...
class CloudVmClusterDataCollectionOptionsArgs:
    def __init__(__self__, *, is_diagnostics_events_enabled: pulumi.Input[_builtins.bool], is_health_monitoring_enabled: pulumi.Input[_builtins.bool], is_incident_logs_enabled: pulumi.Input[_builtins.bool]) -> None:
        ...
    ...
    def is_diagnostics_events_enabled(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def is_health_monitoring_enabled(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def is_incident_logs_enabled(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class CloudVmClusterIormConfigCacheArgs:
    def __init__(__self__, *, db_plans: pulumi.Input[Sequence[pulumi.Input[CloudVmClusterIormConfigCacheDbPlanArgs]]], lifecycle_details: pulumi.Input[_builtins.str], lifecycle_state: pulumi.Input[_builtins.str], objective: pulumi.Input[_builtins.str]) -> None:
        ...
    ...
    @db_plans.setter
    def db_plans(self, value: pulumi.Input[Sequence[pulumi.Input[CloudVmClusterIormConfigCacheDbPlanArgs]]]): # -> None:
        ...
    ...
    def lifecycle_details(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def lifecycle_state(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @objective.setter
    def objective(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class CloudVmClusterIormConfigCacheDbPlanArgs:
    def __init__(__self__, *, db_name: pulumi.Input[_builtins.str], flash_cache_limit: pulumi.Input[_builtins.str], share: pulumi.Input[_builtins.int]) -> None:
        ...
    ...
    def flash_cache_limit(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @share.setter
    def share(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class NetworkManagedServiceArgs:
    def __init__(__self__, *, kms_accesses: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceKmsAccessArgs]]], managed_s3_backup_accesses: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceManagedS3BackupAccessArgs]]], managed_service_ipv4_cidrs: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], resource_gateway_arn: pulumi.Input[_builtins.str], s3_accesses: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceS3AccessArgs]]], service_network_arn: pulumi.Input[_builtins.str], service_network_endpoints: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceServiceNetworkEndpointArgs]]], sts_accesses: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceStsAccessArgs]]], zero_etl_accesses: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceZeroEtlAccessArgs]]]) -> None:
    ...
    @kms_accesses.setter
    def kms_accesses(self, value: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceKmsAccessArgs]]]): # -> None:
        ...
    ...
    def managed_s3_backup_accesses(self, value: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceManagedS3BackupAccessArgs]]]): # -> None:
        ...
    ...
    def managed_service_ipv4_cidrs(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def resource_gateway_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @s3_accesses.setter
    def s3_accesses(self, value: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceS3AccessArgs]]]): # -> None:
        ...
    ...
    def service_network_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def service_network_endpoints(self, value: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceServiceNetworkEndpointArgs]]]): # -> None:
        ...
    ...
    @sts_accesses.setter
    def sts_accesses(self, value: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceStsAccessArgs]]]): # -> None:
        ...
    ...
    def zero_etl_accesses(self, value: pulumi.Input[Sequence[pulumi.Input[NetworkManagedServiceZeroEtlAccessArgs]]]): # -> None:
        ...
...
class NetworkManagedServiceKmsAccessArgs:
    def __init__(__self__, *, domain_name: pulumi.Input[_builtins.str], ipv4_addresses: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], kms_policy_document: pulumi.Input[_builtins.str], status: pulumi.Input[_builtins.str]) -> None:
    ...
    def ipv4_addresses(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def kms_policy_document(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class NetworkManagedServiceManagedS3BackupAccessArgs:
    def __init__(__self__, *, ipv4_addresses: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], status: pulumi.Input[_builtins.str]) -> None:
...
class NetworkManagedServiceS3AccessArgs:
    def __init__(__self__, *, domain_name: pulumi.Input[_builtins.str], ipv4_addresses: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], s3_policy_document: pulumi.Input[_builtins.str], status: pulumi.Input[_builtins.str]) -> None:
    ...
    def s3_policy_document(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class NetworkManagedServiceServiceNetworkEndpointArgs:
    def __init__(__self__, *, vpc_endpoint_id: pulumi.Input[_builtins.str], vpc_endpoint_type: pulumi.Input[_builtins.str]) -> None:
        ...
    ...
    def vpc_endpoint_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class NetworkManagedServiceStsAccessArgs:
    def __init__(__self__, *, domain_name: pulumi.Input[_builtins.str], ipv4_addresses: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], status: pulumi.Input[_builtins.str], sts_policy_document: pulumi.Input[_builtins.str]) -> None:
    ...
    def sts_policy_document(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class NetworkManagedServiceZeroEtlAccessArgs:
    def __init__(__self__, *, cidr: pulumi.Input[_builtins.str], status: pulumi.Input[_builtins.str]) -> None:
...
class NetworkOciDnsForwardingConfigArgs:
    def __init__(__self__, *, domain_name: pulumi.Input[_builtins.str], oci_dns_listener_ip: pulumi.Input[_builtins.str]) -> None:
        ...
    ...
    def oci_dns_listener_ip(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
