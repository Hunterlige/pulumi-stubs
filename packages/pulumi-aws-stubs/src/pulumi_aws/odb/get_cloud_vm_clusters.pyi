...
class GetCloudVmClustersResult:
    ...
    def __init__(__self__, cloud_vm_clusters=..., id=..., region=...) -> None:
        ...
...
def get_cloud_vm_clusters(region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetCloudVmClustersResult:
    
    ...

def get_cloud_vm_clusters_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetCloudVmClustersResult]:
