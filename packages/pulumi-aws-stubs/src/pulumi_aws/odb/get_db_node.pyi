...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetDbNodeResult', 'AwaitableGetDbNodeResult', 'get_db_node', 'get_db_node_output']
@pulumi.output_type
class GetDbNodeResult:
    
    def __init__(__self__, additional_details=..., arn=..., backup_ip_id=..., backup_vnic2_id=..., backup_vnic_id=..., cloud_vm_cluster_id=..., cpu_core_count=..., created_at=..., db_server_id=..., db_storage_size_in_gbs=..., db_system_id=..., fault_domain=..., floating_ip_address=..., host_ip_id=..., hostname=..., id=..., maintenance_type=..., memory_size_in_gbs=..., oci_resource_anchor_name=..., ocid=..., private_ip_address=..., region=..., software_storage_size_in_gbs=..., status=..., status_reason=..., time_maintenance_window_end=..., time_maintenance_window_start=..., total_cpu_core_count=..., vnic2_id=..., vnic_id=...) -> None:
        ...
...
class AwaitableGetDbNodeResult(GetDbNodeResult):
    def __await__(self): # -> Generator[Never, Any, GetDbNodeResult]:
        ...
    


def get_db_node(cloud_vm_cluster_id: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDbNodeResult:
    
    ...

def get_db_node_output(cloud_vm_cluster_id: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDbNodeResult]:
