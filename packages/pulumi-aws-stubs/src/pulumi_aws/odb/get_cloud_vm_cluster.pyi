...
class GetCloudVmClusterResult:
    ...
    def __init__(__self__, arn=..., cloud_exadata_infrastructure_arn=..., cloud_exadata_infrastructure_id=..., cluster_name=..., compute_model=..., cpu_core_count=..., created_at=..., data_collection_options=..., data_storage_size_in_tbs=..., db_node_storage_size_in_gbs=..., db_servers=..., disk_redundancy=..., display_name=..., domain=..., gi_version=..., hostname_prefix_computed=..., id=..., iorm_config_caches=..., is_local_backup_enabled=..., is_sparse_disk_group_enabled=..., last_update_history_entry_id=..., license_model=..., listener_port=..., memory_size_in_gbs=..., node_count=..., oci_resource_anchor_name=..., oci_url=..., ocid=..., odb_network_arn=..., odb_network_id=..., percent_progress=..., region=..., scan_dns_name=..., scan_dns_record_id=..., scan_ip_ids=..., shape=..., ssh_public_keys=..., status=..., status_reason=..., storage_size_in_gbs=..., system_version=..., tags=..., timezone=..., vip_ids=...) -> None:
        ...
...
def get_cloud_vm_cluster(id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetCloudVmClusterResult:
    
    ...

def get_cloud_vm_cluster_output(id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetCloudVmClusterResult]:
