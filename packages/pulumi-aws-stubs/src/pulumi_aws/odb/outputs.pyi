...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CloudAutonomousVmClusterMaintenanceWindow', ..., 'CloudAutonomousVmClusterMaintenanceWindowMonth', 'CloudAutonomousVmClusterTimeouts', ..., 'CloudExadataInfrastructureMaintenanceWindow', ..., 'CloudExadataInfrastructureMaintenanceWindowMonth', 'CloudExadataInfrastructureTimeouts', 'CloudVmClusterDataCollectionOptions', 'CloudVmClusterIormConfigCache', 'CloudVmClusterIormConfigCacheDbPlan', 'CloudVmClusterTimeouts', 'NetworkManagedService', 'NetworkManagedServiceKmsAccess', 'NetworkManagedServiceManagedS3BackupAccess', 'NetworkManagedServiceS3Access', 'NetworkManagedServiceServiceNetworkEndpoint', 'NetworkManagedServiceStsAccess', 'NetworkManagedServiceZeroEtlAccess', 'NetworkOciDnsForwardingConfig', 'NetworkPeeringConnectionTimeouts', 'NetworkTimeouts', 'GetCloudAutonomousVmClusterMaintenanceWindowResult', ..., ..., ..., ..., ..., ..., ..., ..., 'GetCloudVmClusterDataCollectionOptionResult', 'GetCloudVmClusterIormConfigCacheResult', 'GetCloudVmClusterIormConfigCacheDbPlanResult', 'GetCloudVmClustersCloudVmClusterResult', 'GetDbNodesDbNodeResult', 'GetDbServerDbServerPatchingDetailResult', 'GetDbServersDbServerResult', 'GetDbServersDbServerDbServerPatchingDetailResult', 'GetDbSystemShapesDbSystemShapeResult', 'GetGiVersionsGiVersionResult', 'GetNetworkManagedServiceResult', 'GetNetworkManagedServiceKmsAccessResult', ..., 'GetNetworkManagedServiceS3AccessResult', ..., 'GetNetworkManagedServiceStsAccessResult', 'GetNetworkManagedServiceZeroTlAccessResult', 'GetNetworkOciDnsForwardingConfigResult', ..., 'GetNetworksOdbNetworkResult']
@pulumi.output_type
class CloudAutonomousVmClusterMaintenanceWindow(dict):
    ...
    def __init__(__self__, *, preference: _builtins.str, days_of_weeks: Optional[Sequence[outputs.CloudAutonomousVmClusterMaintenanceWindowDaysOfWeek]] = ..., hours_of_days: Optional[Sequence[_builtins.int]] = ..., lead_time_in_weeks: Optional[_builtins.int] = ..., months: Optional[Sequence[outputs.CloudAutonomousVmClusterMaintenanceWindowMonth]] = ..., weeks_of_months: Optional[Sequence[_builtins.int]] = ...) -> None:
...
class CloudExadataInfrastructureMaintenanceWindow(dict):
    ...
    def __init__(__self__, *, custom_action_timeout_in_mins: _builtins.int, is_custom_action_timeout_enabled: _builtins.bool, patching_mode: _builtins.str, preference: _builtins.str, days_of_weeks: Optional[Sequence[outputs.CloudExadataInfrastructureMaintenanceWindowDaysOfWeek]] = ..., hours_of_days: Optional[Sequence[_builtins.int]] = ..., lead_time_in_weeks: Optional[_builtins.int] = ..., months: Optional[Sequence[outputs.CloudExadataInfrastructureMaintenanceWindowMonth]] = ..., weeks_of_months: Optional[Sequence[_builtins.int]] = ...) -> None:
...
class CloudVmClusterDataCollectionOptions(dict):
    ...
    def __init__(__self__, *, is_diagnostics_events_enabled: _builtins.bool, is_health_monitoring_enabled: _builtins.bool, is_incident_logs_enabled: _builtins.bool) -> None:
        ...
...
class CloudVmClusterIormConfigCache(dict):
    ...
    def __init__(__self__, *, db_plans: Sequence[outputs.CloudVmClusterIormConfigCacheDbPlan], lifecycle_details: _builtins.str, lifecycle_state: _builtins.str, objective: _builtins.str) -> None:
        ...
...
class CloudVmClusterIormConfigCacheDbPlan(dict):
    ...
    def __init__(__self__, *, db_name: _builtins.str, flash_cache_limit: _builtins.str, share: _builtins.int) -> None:
        ...
...
class NetworkManagedService(dict):
    ...
    def __init__(__self__, *, kms_accesses: Sequence[outputs.NetworkManagedServiceKmsAccess], managed_s3_backup_accesses: Sequence[outputs.NetworkManagedServiceManagedS3BackupAccess], managed_service_ipv4_cidrs: Sequence[_builtins.str], resource_gateway_arn: _builtins.str, s3_accesses: Sequence[outputs.NetworkManagedServiceS3Access], service_network_arn: _builtins.str, service_network_endpoints: Sequence[outputs.NetworkManagedServiceServiceNetworkEndpoint], sts_accesses: Sequence[outputs.NetworkManagedServiceStsAccess], zero_etl_accesses: Sequence[outputs.NetworkManagedServiceZeroEtlAccess]) -> None:
...
class NetworkManagedServiceKmsAccess(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, ipv4_addresses: Sequence[_builtins.str], kms_policy_document: _builtins.str, status: _builtins.str) -> None:
...
class NetworkManagedServiceManagedS3BackupAccess(dict):
    ...
    def __init__(__self__, *, ipv4_addresses: Sequence[_builtins.str], status: _builtins.str) -> None:
...
class NetworkManagedServiceS3Access(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, ipv4_addresses: Sequence[_builtins.str], s3_policy_document: _builtins.str, status: _builtins.str) -> None:
...
class NetworkManagedServiceServiceNetworkEndpoint(dict):
    ...
    def __init__(__self__, *, vpc_endpoint_id: _builtins.str, vpc_endpoint_type: _builtins.str) -> None:
        ...
...
class NetworkManagedServiceStsAccess(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, ipv4_addresses: Sequence[_builtins.str], status: _builtins.str, sts_policy_document: _builtins.str) -> None:
...
class NetworkOciDnsForwardingConfig(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, oci_dns_listener_ip: _builtins.str) -> None:
        ...
...
class GetCloudAutonomousVmClusterMaintenanceWindowResult(dict):
    def __init__(__self__, *, days_of_weeks: Sequence[outputs.GetCloudAutonomousVmClusterMaintenanceWindowDaysOfWeekResult], hours_of_days: Sequence[_builtins.int], lead_time_in_weeks: _builtins.int, months: Sequence[outputs.GetCloudAutonomousVmClusterMaintenanceWindowMonthResult], preference: _builtins.str, weeks_of_months: Sequence[_builtins.int]) -> None:
        ...
...
class GetCloudAutonomousVmClustersCloudAutonomousVmClusterResult(dict):
    def __init__(__self__, *, arn: _builtins.str, cloud_exadata_infrastructure_id: _builtins.str, display_name: _builtins.str, id: _builtins.str, oci_resource_anchor_name: _builtins.str, oci_url: _builtins.str, ocid: _builtins.str, odb_network_id: _builtins.str) -> None:
...
class GetCloudExadataInfrastructureMaintenanceWindowResult(dict):
    def __init__(__self__, *, custom_action_timeout_in_mins: _builtins.int, days_of_weeks: Sequence[outputs.GetCloudExadataInfrastructureMaintenanceWindowDaysOfWeekResult], hours_of_days: Sequence[_builtins.int], is_custom_action_timeout_enabled: _builtins.bool, lead_time_in_weeks: _builtins.int, months: Sequence[outputs.GetCloudExadataInfrastructureMaintenanceWindowMonthResult], patching_mode: _builtins.str, preference: _builtins.str, weeks_of_months: Sequence[_builtins.int]) -> None:
        ...
...
class GetCloudExadataInfrastructuresCloudExadataInfrastructureResult(dict):
    def __init__(__self__, *, arn: _builtins.str, display_name: _builtins.str, id: _builtins.str, oci_resource_anchor_name: _builtins.str, oci_url: _builtins.str, ocid: _builtins.str) -> None:
...
class GetCloudVmClusterIormConfigCacheResult(dict):
    def __init__(__self__, *, db_plans: Sequence[outputs.GetCloudVmClusterIormConfigCacheDbPlanResult], lifecycle_details: _builtins.str, lifecycle_state: _builtins.str, objective: _builtins.str) -> None:
        ...
...
class GetDbNodesDbNodeResult(dict):
    def __init__(__self__, *, additional_details: _builtins.str, arn: _builtins.str, backup_ip_id: _builtins.str, backup_vnic2_id: _builtins.str, backup_vnic_id: _builtins.str, cpu_core_count: _builtins.int, created_at: _builtins.str, db_node_storage_size: _builtins.int, db_server_id: _builtins.str, db_system_id: _builtins.str, fault_domain: _builtins.str, host_ip_id: _builtins.str, hostname: _builtins.str, id: _builtins.str, maintenance_type: _builtins.str, memory_size: _builtins.int, oci_resource_anchor_name: _builtins.str, ocid: _builtins.str, software_storage_size: _builtins.int, status: _builtins.str, status_reason: _builtins.str, time_maintenance_window_end: _builtins.str, time_maintenance_window_start: _builtins.str, total_cpu_core_count: _builtins.int, vnic2_id: _builtins.str, vnic_id: _builtins.str) -> None:
...
class GetDbServerDbServerPatchingDetailResult(dict):
    def __init__(__self__, *, estimated_patch_duration: _builtins.int, patching_status: _builtins.str, time_patching_ended: _builtins.str, time_patching_started: _builtins.str) -> None:
        ...
...
class GetDbServersDbServerResult(dict):
    def __init__(__self__, *, autonomous_virtual_machine_ids: Sequence[_builtins.str], autonomous_vm_cluster_ids: Sequence[_builtins.str], compute_model: _builtins.str, cpu_core_count: _builtins.int, created_at: _builtins.str, db_node_storage_size_in_gbs: _builtins.int, db_server_patching_details: Sequence[outputs.GetDbServersDbServerDbServerPatchingDetailResult], display_name: _builtins.str, exadata_infrastructure_id: _builtins.str, id: _builtins.str, max_cpu_count: _builtins.int, max_db_node_storage_in_gbs: _builtins.int, max_memory_in_gbs: _builtins.int, memory_size_in_gbs: _builtins.int, oci_resource_anchor_name: _builtins.str, ocid: _builtins.str, shape: _builtins.str, status: _builtins.str, status_reason: _builtins.str, vm_cluster_ids: Sequence[_builtins.str]) -> None:
...
class GetDbSystemShapesDbSystemShapeResult(dict):
    def __init__(__self__, *, available_core_count: _builtins.int, available_core_count_per_node: _builtins.int, available_data_storage_in_tbs: _builtins.int, available_data_storage_per_server_in_tbs: _builtins.int, available_db_node_per_node_in_gbs: _builtins.int, available_db_node_storage_in_gbs: _builtins.int, available_memory_in_gbs: _builtins.int, available_memory_per_node_in_gbs: _builtins.int, core_count_increment: _builtins.int, max_storage_count: _builtins.int, maximum_node_count: _builtins.int, min_core_count_per_node: _builtins.int, min_data_storage_in_tbs: _builtins.int, min_db_node_storage_per_node_in_gbs: _builtins.int, min_memory_per_node_in_gbs: _builtins.int, min_storage_count: _builtins.int, minimum_core_count: _builtins.int, minimum_node_count: _builtins.int, name: _builtins.str, runtime_minimum_core_count: _builtins.int, shape_family: _builtins.str, shape_type: _builtins.str) -> None:
...
class GetNetworkManagedServiceResult(dict):
    def __init__(__self__, *, kms_accesses: Sequence[outputs.GetNetworkManagedServiceKmsAccessResult], managed_s3_backup_accesses: Sequence[outputs.GetNetworkManagedServiceManagedS3BackupAccessResult], managed_service_ipv4_cidrs: Sequence[_builtins.str], resource_gateway_arn: _builtins.str, s3_accesses: Sequence[outputs.GetNetworkManagedServiceS3AccessResult], service_network_arn: _builtins.str, service_network_endpoints: Sequence[outputs.GetNetworkManagedServiceServiceNetworkEndpointResult], sts_accesses: Sequence[outputs.GetNetworkManagedServiceStsAccessResult], zero_tl_accesses: Sequence[outputs.GetNetworkManagedServiceZeroTlAccessResult]) -> None:
        ...
...
class GetNetworkPeeringConnectionsOdbPeeringConnectionResult(dict):
    def __init__(__self__, *, arn: _builtins.str, display_name: _builtins.str, id: _builtins.str, odb_network_arn: _builtins.str, peer_network_arn: _builtins.str) -> None:
...
class GetNetworksOdbNetworkResult(dict):
    def __init__(__self__, *, arn: _builtins.str, display_name: _builtins.str, id: _builtins.str, oci_network_anchor_id: _builtins.str, oci_vcn_id: _builtins.str, oci_vcn_url: _builtins.str) -> None:
