...
class GetNetworkResult:
    ...
    def __init__(__self__, arn=..., availability_zone=..., availability_zone_id=..., backup_subnet_cidr=..., client_subnet_cidr=..., created_at=..., custom_domain_name=..., default_dns_prefix=..., display_name=..., id=..., managed_services=..., oci_dns_forwarding_configs=..., oci_network_anchor_id=..., oci_network_anchor_url=..., oci_resource_anchor_name=..., oci_vcn_id=..., oci_vcn_url=..., peered_cidrs=..., percent_progress=..., region=..., status=..., status_reason=..., tags=...) -> None:
        ...
...
def get_network(id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetNetworkResult:
    
    ...

def get_network_output(id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetNetworkResult]:
