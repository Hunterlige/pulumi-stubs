...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CollectionTimeouts', 'ProjectTimeouts', 'StreamProcessorDataSharingPreference', 'StreamProcessorInput', 'StreamProcessorInputKinesisVideoStream', 'StreamProcessorNotificationChannel', 'StreamProcessorOutput', 'StreamProcessorOutputKinesisDataStream', 'StreamProcessorOutputS3Destination', 'StreamProcessorRegionsOfInterest', 'StreamProcessorRegionsOfInterestBoundingBox', 'StreamProcessorRegionsOfInterestPolygon', 'StreamProcessorSettings', 'StreamProcessorSettingsConnectedHome', 'StreamProcessorSettingsFaceSearch', 'StreamProcessorTimeouts']
@pulumi.output_type
...
class StreamProcessorInput(dict):
    ...
    def __init__(__self__, *, kinesis_video_stream: outputs.StreamProcessorInputKinesisVideoStream) -> None:
...
class StreamProcessorOutput(dict):
    ...
    def __init__(__self__, *, kinesis_data_stream: Optional[outputs.StreamProcessorOutputKinesisDataStream] = ..., s3_destination: Optional[outputs.StreamProcessorOutputS3Destination] = ...) -> None:
...
class StreamProcessorOutputS3Destination(dict):
    ...
    def __init__(__self__, *, bucket: Optional[_builtins.str] = ..., key_prefix: Optional[_builtins.str] = ...) -> None:
...
class StreamProcessorRegionsOfInterest(dict):
    ...
    def __init__(__self__, *, bounding_box: Optional[outputs.StreamProcessorRegionsOfInterestBoundingBox] = ..., polygons: Optional[Sequence[outputs.StreamProcessorRegionsOfInterestPolygon]] = ...) -> None:
...
class StreamProcessorRegionsOfInterestBoundingBox(dict):
    def __init__(__self__, *, height: Optional[_builtins.float] = ..., left: Optional[_builtins.float] = ..., top: Optional[_builtins.float] = ..., width: Optional[_builtins.float] = ...) -> None:
...
class StreamProcessorSettings(dict):
    ...
    def __init__(__self__, *, connected_home: Optional[outputs.StreamProcessorSettingsConnectedHome] = ..., face_search: Optional[outputs.StreamProcessorSettingsFaceSearch] = ...) -> None:
...
class StreamProcessorSettingsConnectedHome(dict):
    ...
    def __init__(__self__, *, labels: Optional[Sequence[_builtins.str]] = ..., min_confidence: Optional[_builtins.float] = ...) -> None:
...
class StreamProcessorSettingsFaceSearch(dict):
    ...
    def __init__(__self__, *, collection_id: _builtins.str, face_match_threshold: Optional[_builtins.float] = ...) -> None:
