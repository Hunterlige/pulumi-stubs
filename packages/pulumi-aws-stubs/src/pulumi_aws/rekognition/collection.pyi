...
class CollectionArgs:
    def __init__(
        ...
        *,
        ...
        timeouts: Optional[pulumi.Input[CollectionTimeoutsArgs]] = ...,
    ) -> None: ...
    @_builtins.property
...
class _CollectionState:
    def __init__(
        ...
        *,
        ...
        face_model_version: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tags_all: Optional[
...
class Collection(pulumi.CustomResource):
    ...
    def __init__(
        ...
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        timeouts: Optional[
            pulumi.Input[Union[CollectionTimeoutsArgs, CollectionTimeoutsArgsDict]]
        ] = ...,
        __props__=...,
    ) -> None: ...
    @overload
