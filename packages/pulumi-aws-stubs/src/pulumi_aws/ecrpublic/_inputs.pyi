...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['RepositoryCatalogDataArgs', 'RepositoryCatalogDataArgsDict', 'GetImagesImageIdArgs', 'GetImagesImageIdArgsDict']
...
class RepositoryCatalogDataArgs:
    def __init__(__self__, *, about_text: Optional[pulumi.Input[_builtins.str]] = ..., architectures: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., logo_image_blob: Optional[pulumi.Input[_builtins.str]] = ..., operating_systems: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., usage_text: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @about_text.setter
    def about_text(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def logo_image_blob(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def operating_systems(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @usage_text.setter
    def usage_text(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GetImagesImageIdArgs:
    ...
    @image_digest.setter
    def image_digest(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    @image_tag.setter
    def image_tag(self, value: Optional[_builtins.str]): # -> None:
        ...
