...
class GetDomainResult:
    ...
    def __init__(__self__, access_policies=..., advanced_options=..., advanced_security_options=..., arn=..., auto_tune_options=..., cluster_configs=..., cognito_options=..., created=..., deleted=..., domain_id=..., domain_name=..., ebs_options=..., elasticsearch_version=..., encryption_at_rests=..., endpoint=..., id=..., kibana_endpoint=..., log_publishing_options=..., node_to_node_encryptions=..., processing=..., region=..., snapshot_options=..., tags=..., vpc_options=...) -> None:
        ...
