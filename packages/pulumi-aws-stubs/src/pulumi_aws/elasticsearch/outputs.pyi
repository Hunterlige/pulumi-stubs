...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DomainAdvancedSecurityOptions', 'DomainAdvancedSecurityOptionsMasterUserOptions', 'DomainAutoTuneOptions', 'DomainAutoTuneOptionsMaintenanceSchedule', 'DomainAutoTuneOptionsMaintenanceScheduleDuration', 'DomainClusterConfig', 'DomainClusterConfigColdStorageOptions', 'DomainClusterConfigZoneAwarenessConfig', 'DomainCognitoOptions', 'DomainDomainEndpointOptions', 'DomainEbsOptions', 'DomainEncryptAtRest', 'DomainLogPublishingOption', 'DomainNodeToNodeEncryption', 'DomainSamlOptionsSamlOptions', 'DomainSamlOptionsSamlOptionsIdp', 'DomainSnapshotOptions', 'DomainVpcOptions', 'VpcEndpointVpcOptions', 'GetDomainAdvancedSecurityOptionResult', 'GetDomainAutoTuneOptionResult', 'GetDomainAutoTuneOptionMaintenanceScheduleResult', ..., 'GetDomainClusterConfigResult', 'GetDomainClusterConfigColdStorageOptionResult', 'GetDomainClusterConfigZoneAwarenessConfigResult', 'GetDomainCognitoOptionResult', 'GetDomainEbsOptionResult', 'GetDomainEncryptionAtRestResult', 'GetDomainLogPublishingOptionResult', 'GetDomainNodeToNodeEncryptionResult', 'GetDomainSnapshotOptionResult', 'GetDomainVpcOptionResult']
@pulumi.output_type
class DomainAdvancedSecurityOptions(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, internal_user_database_enabled: Optional[_builtins.bool] = ..., master_user_options: Optional[outputs.DomainAdvancedSecurityOptionsMasterUserOptions] = ...) -> None:
...
class DomainAutoTuneOptions(dict):
    ...
    def __init__(__self__, *, desired_state: _builtins.str, maintenance_schedules: Optional[Sequence[outputs.DomainAutoTuneOptionsMaintenanceSchedule]] = ..., rollback_on_disable: Optional[_builtins.str] = ...) -> None:
...
class DomainClusterConfig(dict):
    ...
    def __init__(__self__, *, cold_storage_options: Optional[outputs.DomainClusterConfigColdStorageOptions] = ..., dedicated_master_count: Optional[_builtins.int] = ..., dedicated_master_enabled: Optional[_builtins.bool] = ..., dedicated_master_type: Optional[_builtins.str] = ..., instance_count: Optional[_builtins.int] = ..., instance_type: Optional[_builtins.str] = ..., warm_count: Optional[_builtins.int] = ..., warm_enabled: Optional[_builtins.bool] = ..., warm_type: Optional[_builtins.str] = ..., zone_awareness_config: Optional[outputs.DomainClusterConfigZoneAwarenessConfig] = ..., zone_awareness_enabled: Optional[_builtins.bool] = ...) -> None:
...
class GetDomainAdvancedSecurityOptionResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, internal_user_database_enabled: _builtins.bool) -> None:
...
class GetDomainAutoTuneOptionResult(dict):
    def __init__(__self__, *, desired_state: _builtins.str, maintenance_schedules: Sequence[outputs.GetDomainAutoTuneOptionMaintenanceScheduleResult], rollback_on_disable: _builtins.str) -> None:
...
class GetDomainClusterConfigResult(dict):
    def __init__(__self__, *, cold_storage_options: Sequence[outputs.GetDomainClusterConfigColdStorageOptionResult], dedicated_master_count: _builtins.int, dedicated_master_enabled: _builtins.bool, dedicated_master_type: _builtins.str, instance_count: _builtins.int, instance_type: _builtins.str, warm_count: _builtins.int, warm_enabled: _builtins.bool, warm_type: _builtins.str, zone_awareness_configs: Sequence[outputs.GetDomainClusterConfigZoneAwarenessConfigResult], zone_awareness_enabled: _builtins.bool) -> None:
