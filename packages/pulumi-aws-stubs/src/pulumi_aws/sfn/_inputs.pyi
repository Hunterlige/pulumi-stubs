...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ActivityEncryptionConfigurationArgs', 'ActivityEncryptionConfigurationArgsDict', 'AliasRoutingConfigurationArgs', 'AliasRoutingConfigurationArgsDict', 'StateMachineEncryptionConfigurationArgs', 'StateMachineEncryptionConfigurationArgsDict', 'StateMachineLoggingConfigurationArgs', 'StateMachineLoggingConfigurationArgsDict', 'StateMachineTracingConfigurationArgs', 'StateMachineTracingConfigurationArgsDict']
...
class ActivityEncryptionConfigurationArgs:
    def __init__(__self__, *, kms_data_key_reuse_period_seconds: Optional[pulumi.Input[_builtins.int]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AliasRoutingConfigurationArgs:
    def __init__(__self__, *, state_machine_version_arn: pulumi.Input[_builtins.str], weight: pulumi.Input[_builtins.int]) -> None:
    ...
    def state_machine_version_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class StateMachineLoggingConfigurationArgs:
    def __init__(__self__, *, include_execution_data: Optional[pulumi.Input[_builtins.bool]] = ..., level: Optional[pulumi.Input[_builtins.str]] = ..., log_destination: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def include_execution_data(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
