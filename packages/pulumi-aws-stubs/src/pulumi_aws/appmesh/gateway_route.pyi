...
class GatewayRouteArgs:
    def __init__(
        ...
        *,
        ...
        virtual_gateway_name: pulumi.Input[_builtins.str],
        mesh_owner: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def virtual_gateway_name(self, value: pulumi.Input[_builtins.str]): ...
    @_builtins.property
...
class _GatewayRouteState:
    def __init__(
        ...
        *,
        ...
        spec: Optional[pulumi.Input[GatewayRouteSpecArgs]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tags_all: Optional[
    ...
    @virtual_gateway_name.setter
    def virtual_gateway_name(self, value: Optional[pulumi.Input[_builtins.str]]): ...
...
class GatewayRoute(pulumi.CustomResource):
    ...
    def __init__(
        ...
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        spec: Optional[
            pulumi.Input[Union[GatewayRouteSpecArgs, GatewayRouteSpecArgsDict]]
        ] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        virtual_gateway_name: Optional[pulumi.Input[_builtins.str]] = ...,
        __props__=...,
