...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AnalyticsApplicationCloudwatchLoggingOptions', 'AnalyticsApplicationInputs', 'AnalyticsApplicationInputsKinesisFirehose', 'AnalyticsApplicationInputsKinesisStream', 'AnalyticsApplicationInputsParallelism', 'AnalyticsApplicationInputsProcessingConfiguration', ..., 'AnalyticsApplicationInputsSchema', 'AnalyticsApplicationInputsSchemaRecordColumn', 'AnalyticsApplicationInputsSchemaRecordFormat', ..., ..., ..., ..., 'AnalyticsApplicationOutput', 'AnalyticsApplicationOutputKinesisFirehose', 'AnalyticsApplicationOutputKinesisStream', 'AnalyticsApplicationOutputLambda', 'AnalyticsApplicationOutputSchema', 'AnalyticsApplicationReferenceDataSources', 'AnalyticsApplicationReferenceDataSourcesS3', 'AnalyticsApplicationReferenceDataSourcesSchema', ..., ..., ..., ..., ..., 'FirehoseDeliveryStreamElasticsearchConfiguration', ..., ..., ..., ..., ..., ..., ..., 'FirehoseDeliveryStreamExtendedS3Configuration', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'FirehoseDeliveryStreamHttpEndpointConfiguration', ..., ..., ..., ..., ..., ..., ..., ..., ..., 'FirehoseDeliveryStreamIcebergConfiguration', ..., ..., ..., ..., ..., ..., ..., 'FirehoseDeliveryStreamKinesisSourceConfiguration', 'FirehoseDeliveryStreamMskSourceConfiguration', ..., 'FirehoseDeliveryStreamOpensearchConfiguration', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'FirehoseDeliveryStreamRedshiftConfiguration', ..., ..., ..., ..., ..., ..., ..., ..., ..., 'FirehoseDeliveryStreamServerSideEncryption', 'FirehoseDeliveryStreamSnowflakeConfiguration', ..., ..., ..., ..., ..., ..., ..., ..., ..., 'FirehoseDeliveryStreamSplunkConfiguration', ..., ..., ..., ..., ..., ..., ..., 'StreamStreamModeDetails', 'GetStreamStreamModeDetailResult']
@pulumi.output_type
class AnalyticsApplicationCloudwatchLoggingOptions(dict):
    ...
    def __init__(__self__, *, log_stream_arn: _builtins.str, role_arn: _builtins.str, id: Optional[_builtins.str] = ...) -> None:
...
class AnalyticsApplicationInputs(dict):
    ...
    def __init__(__self__, *, name_prefix: _builtins.str, schema: outputs.AnalyticsApplicationInputsSchema, id: Optional[_builtins.str] = ..., kinesis_firehose: Optional[outputs.AnalyticsApplicationInputsKinesisFirehose] = ..., kinesis_stream: Optional[outputs.AnalyticsApplicationInputsKinesisStream] = ..., parallelism: Optional[outputs.AnalyticsApplicationInputsParallelism] = ..., processing_configuration: Optional[outputs.AnalyticsApplicationInputsProcessingConfiguration] = ..., starting_position_configurations: Optional[Sequence[outputs.AnalyticsApplicationInputsStartingPositionConfiguration]] = ..., stream_names: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AnalyticsApplicationInputsKinesisFirehose(dict):
    ...
    def __init__(__self__, *, resource_arn: _builtins.str, role_arn: _builtins.str) -> None:
...
class AnalyticsApplicationInputsProcessingConfiguration(dict):
    ...
    def __init__(__self__, *, lambda_: outputs.AnalyticsApplicationInputsProcessingConfigurationLambda) -> None:
...
class AnalyticsApplicationInputsSchema(dict):
    ...
    def __init__(__self__, *, record_columns: Sequence[outputs.AnalyticsApplicationInputsSchemaRecordColumn], record_format: outputs.AnalyticsApplicationInputsSchemaRecordFormat, record_encoding: Optional[_builtins.str] = ...) -> None:
...
class AnalyticsApplicationInputsSchemaRecordColumn(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, sql_type: _builtins.str, mapping: Optional[_builtins.str] = ...) -> None:
...
class AnalyticsApplicationInputsSchemaRecordFormat(dict):
    ...
    def __init__(__self__, *, mapping_parameters: Optional[outputs.AnalyticsApplicationInputsSchemaRecordFormatMappingParameters] = ..., record_format_type: Optional[_builtins.str] = ...) -> None:
...
class AnalyticsApplicationInputsSchemaRecordFormatMappingParameters(dict):
    def __init__(__self__, *, csv: Optional[outputs.AnalyticsApplicationInputsSchemaRecordFormatMappingParametersCsv] = ..., json: Optional[outputs.AnalyticsApplicationInputsSchemaRecordFormatMappingParametersJson] = ...) -> None:
...
class AnalyticsApplicationInputsSchemaRecordFormatMappingParametersCsv(dict):
    ...
    def __init__(__self__, *, record_column_delimiter: _builtins.str, record_row_delimiter: _builtins.str) -> None:
...
class AnalyticsApplicationInputsStartingPositionConfiguration(dict):
    ...
    def __init__(__self__, *, starting_position: Optional[_builtins.str] = ...) -> None:
...
class AnalyticsApplicationOutput(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, schema: outputs.AnalyticsApplicationOutputSchema, id: Optional[_builtins.str] = ..., kinesis_firehose: Optional[outputs.AnalyticsApplicationOutputKinesisFirehose] = ..., kinesis_stream: Optional[outputs.AnalyticsApplicationOutputKinesisStream] = ..., lambda_: Optional[outputs.AnalyticsApplicationOutputLambda] = ...) -> None:
...
class AnalyticsApplicationReferenceDataSources(dict):
    ...
    def __init__(__self__, *, s3: outputs.AnalyticsApplicationReferenceDataSourcesS3, schema: outputs.AnalyticsApplicationReferenceDataSourcesSchema, table_name: _builtins.str, id: Optional[_builtins.str] = ...) -> None:
...
class AnalyticsApplicationReferenceDataSourcesS3(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, file_key: _builtins.str, role_arn: _builtins.str) -> None:
...
class AnalyticsApplicationReferenceDataSourcesSchema(dict):
    ...
    def __init__(__self__, *, record_columns: Sequence[outputs.AnalyticsApplicationReferenceDataSourcesSchemaRecordColumn], record_format: outputs.AnalyticsApplicationReferenceDataSourcesSchemaRecordFormat, record_encoding: Optional[_builtins.str] = ...) -> None:
...
class AnalyticsApplicationReferenceDataSourcesSchemaRecordFormat(dict):
    ...
    def __init__(__self__, *, mapping_parameters: Optional[outputs.AnalyticsApplicationReferenceDataSourcesSchemaRecordFormatMappingParameters] = ..., record_format_type: Optional[_builtins.str] = ...) -> None:
...
class AnalyticsApplicationReferenceDataSourcesSchemaRecordFormatMappingParameters(dict):
    def __init__(__self__, *, csv: Optional[outputs.AnalyticsApplicationReferenceDataSourcesSchemaRecordFormatMappingParametersCsv] = ..., json: Optional[outputs.AnalyticsApplicationReferenceDataSourcesSchemaRecordFormatMappingParametersJson] = ...) -> None:
...
class FirehoseDeliveryStreamElasticsearchConfiguration(dict):
    ...
    def __init__(__self__, *, index_name: _builtins.str, role_arn: _builtins.str, s3_configuration: outputs.FirehoseDeliveryStreamElasticsearchConfigurationS3Configuration, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamElasticsearchConfigurationCloudwatchLoggingOptions] = ..., cluster_endpoint: Optional[_builtins.str] = ..., domain_arn: Optional[_builtins.str] = ..., index_rotation_period: Optional[_builtins.str] = ..., processing_configuration: Optional[outputs.FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfiguration] = ..., retry_duration: Optional[_builtins.int] = ..., s3_backup_mode: Optional[_builtins.str] = ..., type_name: Optional[_builtins.str] = ..., vpc_config: Optional[outputs.FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig] = ...) -> None:
...
class FirehoseDeliveryStreamElasticsearchConfigurationCloudwatchLoggingOptions(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., log_group_name: Optional[_builtins.str] = ..., log_stream_name: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfiguration(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., processors: Optional[Sequence[outputs.FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessor]] = ...) -> None:
...
class FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessor(dict):
    def __init__(__self__, *, type: _builtins.str, parameters: Optional[Sequence[outputs.FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter]] = ...) -> None:
...
class FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter(dict):
    ...
    def __init__(__self__, *, parameter_name: _builtins.str, parameter_value: _builtins.str) -> None:
...
class FirehoseDeliveryStreamElasticsearchConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, role_arn: _builtins.str, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationCloudwatchLoggingOptions] = ..., compression_format: Optional[_builtins.str] = ..., error_output_prefix: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig(dict):
    ...
    def __init__(__self__, *, role_arn: _builtins.str, security_group_ids: Sequence[_builtins.str], subnet_ids: Sequence[_builtins.str], vpc_id: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamExtendedS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, role_arn: _builtins.str, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions] = ..., compression_format: Optional[_builtins.str] = ..., custom_time_zone: Optional[_builtins.str] = ..., data_format_conversion_configuration: Optional[outputs.FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration] = ..., dynamic_partitioning_configuration: Optional[outputs.FirehoseDeliveryStreamExtendedS3ConfigurationDynamicPartitioningConfiguration] = ..., error_output_prefix: Optional[_builtins.str] = ..., file_extension: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ..., processing_configuration: Optional[outputs.FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfiguration] = ..., s3_backup_configuration: Optional[outputs.FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration] = ..., s3_backup_mode: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationInputFormatConfiguration(dict):
    def __init__(__self__, *, deserializer: outputs.FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationInputFormatConfigurationDeserializer) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationInputFormatConfigurationDeserializer(dict):
    ...
    def __init__(__self__, *, hive_json_ser_de: Optional[outputs.FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationInputFormatConfigurationDeserializerHiveJsonSerDe] = ..., open_x_json_ser_de: Optional[outputs.FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationInputFormatConfigurationDeserializerOpenXJsonSerDe] = ...) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationInputFormatConfigurationDeserializerHiveJsonSerDe(dict):
    ...
    def __init__(__self__, *, timestamp_formats: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationInputFormatConfigurationDeserializerOpenXJsonSerDe(dict):
    ...
    def __init__(__self__, *, case_insensitive: Optional[_builtins.bool] = ..., column_to_json_key_mappings: Optional[Mapping[str, _builtins.str]] = ..., convert_dots_in_json_keys_to_underscores: Optional[_builtins.bool] = ...) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfiguration(dict):
    def __init__(__self__, *, serializer: outputs.FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfigurationSerializer) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfigurationSerializer(dict):
    ...
    def __init__(__self__, *, orc_ser_de: Optional[outputs.FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfigurationSerializerOrcSerDe] = ..., parquet_ser_de: Optional[outputs.FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfigurationSerializerParquetSerDe] = ...) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfigurationSerializerOrcSerDe(dict):
    ...
    def __init__(__self__, *, block_size_bytes: Optional[_builtins.int] = ..., bloom_filter_columns: Optional[Sequence[_builtins.str]] = ..., bloom_filter_false_positive_probability: Optional[_builtins.float] = ..., compression: Optional[_builtins.str] = ..., dictionary_key_threshold: Optional[_builtins.float] = ..., enable_padding: Optional[_builtins.bool] = ..., format_version: Optional[_builtins.str] = ..., padding_tolerance: Optional[_builtins.float] = ..., row_index_stride: Optional[_builtins.int] = ..., stripe_size_bytes: Optional[_builtins.int] = ...) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfigurationSerializerParquetSerDe(dict):
    ...
    def __init__(__self__, *, block_size_bytes: Optional[_builtins.int] = ..., compression: Optional[_builtins.str] = ..., enable_dictionary_compression: Optional[_builtins.bool] = ..., max_padding_bytes: Optional[_builtins.int] = ..., page_size_bytes: Optional[_builtins.int] = ..., writer_version: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationSchemaConfiguration(dict):
    ...
    def __init__(__self__, *, database_name: _builtins.str, role_arn: _builtins.str, table_name: _builtins.str, catalog_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., version_id: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationDynamicPartitioningConfiguration(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., retry_duration: Optional[_builtins.int] = ...) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfiguration(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., processors: Optional[Sequence[outputs.FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfigurationProcessor]] = ...) -> None:
...
class FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfigurationProcessor(dict):
    def __init__(__self__, *, type: _builtins.str, parameters: Optional[Sequence[outputs.FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfigurationProcessorParameter]] = ...) -> None:
...
class FirehoseDeliveryStreamHttpEndpointConfiguration(dict):
    ...
    def __init__(__self__, *, s3_configuration: outputs.FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration, url: _builtins.str, access_key: Optional[_builtins.str] = ..., buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamHttpEndpointConfigurationCloudwatchLoggingOptions] = ..., name: Optional[_builtins.str] = ..., processing_configuration: Optional[outputs.FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfiguration] = ..., request_configuration: Optional[outputs.FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfiguration] = ..., retry_duration: Optional[_builtins.int] = ..., role_arn: Optional[_builtins.str] = ..., s3_backup_mode: Optional[_builtins.str] = ..., secrets_manager_configuration: Optional[outputs.FirehoseDeliveryStreamHttpEndpointConfigurationSecretsManagerConfiguration] = ...) -> None:
...
class FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfiguration(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., processors: Optional[Sequence[outputs.FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessor]] = ...) -> None:
...
class FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessor(dict):
    def __init__(__self__, *, type: _builtins.str, parameters: Optional[Sequence[outputs.FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorParameter]] = ...) -> None:
...
class FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfiguration(dict):
    ...
    def __init__(__self__, *, common_attributes: Optional[Sequence[outputs.FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfigurationCommonAttribute]] = ..., content_encoding: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, role_arn: _builtins.str, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptions] = ..., compression_format: Optional[_builtins.str] = ..., error_output_prefix: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamHttpEndpointConfigurationSecretsManagerConfiguration(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., role_arn: Optional[_builtins.str] = ..., secret_arn: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamIcebergConfiguration(dict):
    ...
    def __init__(__self__, *, catalog_arn: _builtins.str, role_arn: _builtins.str, s3_configuration: outputs.FirehoseDeliveryStreamIcebergConfigurationS3Configuration, append_only: Optional[_builtins.bool] = ..., buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamIcebergConfigurationCloudwatchLoggingOptions] = ..., destination_table_configurations: Optional[Sequence[outputs.FirehoseDeliveryStreamIcebergConfigurationDestinationTableConfiguration]] = ..., processing_configuration: Optional[outputs.FirehoseDeliveryStreamIcebergConfigurationProcessingConfiguration] = ..., retry_duration: Optional[_builtins.int] = ..., s3_backup_mode: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamIcebergConfigurationDestinationTableConfiguration(dict):
    ...
    def __init__(__self__, *, database_name: _builtins.str, table_name: _builtins.str, s3_error_output_prefix: Optional[_builtins.str] = ..., unique_keys: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FirehoseDeliveryStreamIcebergConfigurationProcessingConfiguration(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., processors: Optional[Sequence[outputs.FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessor]] = ...) -> None:
...
class FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessor(dict):
    def __init__(__self__, *, type: _builtins.str, parameters: Optional[Sequence[outputs.FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessorParameter]] = ...) -> None:
...
class FirehoseDeliveryStreamIcebergConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, role_arn: _builtins.str, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamIcebergConfigurationS3ConfigurationCloudwatchLoggingOptions] = ..., compression_format: Optional[_builtins.str] = ..., error_output_prefix: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamKinesisSourceConfiguration(dict):
    ...
    def __init__(__self__, *, kinesis_stream_arn: _builtins.str, role_arn: _builtins.str) -> None:
...
class FirehoseDeliveryStreamMskSourceConfiguration(dict):
    ...
    def __init__(__self__, *, authentication_configuration: outputs.FirehoseDeliveryStreamMskSourceConfigurationAuthenticationConfiguration, msk_cluster_arn: _builtins.str, topic_name: _builtins.str, read_from_timestamp: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamMskSourceConfigurationAuthenticationConfiguration(dict):
    ...
    def __init__(__self__, *, connectivity: _builtins.str, role_arn: _builtins.str) -> None:
...
class FirehoseDeliveryStreamOpensearchConfiguration(dict):
    ...
    def __init__(__self__, *, index_name: _builtins.str, role_arn: _builtins.str, s3_configuration: outputs.FirehoseDeliveryStreamOpensearchConfigurationS3Configuration, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamOpensearchConfigurationCloudwatchLoggingOptions] = ..., cluster_endpoint: Optional[_builtins.str] = ..., document_id_options: Optional[outputs.FirehoseDeliveryStreamOpensearchConfigurationDocumentIdOptions] = ..., domain_arn: Optional[_builtins.str] = ..., index_rotation_period: Optional[_builtins.str] = ..., processing_configuration: Optional[outputs.FirehoseDeliveryStreamOpensearchConfigurationProcessingConfiguration] = ..., retry_duration: Optional[_builtins.int] = ..., s3_backup_mode: Optional[_builtins.str] = ..., type_name: Optional[_builtins.str] = ..., vpc_config: Optional[outputs.FirehoseDeliveryStreamOpensearchConfigurationVpcConfig] = ...) -> None:
...
class FirehoseDeliveryStreamOpensearchConfigurationProcessingConfiguration(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., processors: Optional[Sequence[outputs.FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessor]] = ...) -> None:
...
class FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessor(dict):
    def __init__(__self__, *, type: _builtins.str, parameters: Optional[Sequence[outputs.FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameter]] = ...) -> None:
...
class FirehoseDeliveryStreamOpensearchConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, role_arn: _builtins.str, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions] = ..., compression_format: Optional[_builtins.str] = ..., error_output_prefix: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamOpensearchserverlessConfiguration(dict):
    ...
    def __init__(__self__, *, collection_endpoint: _builtins.str, index_name: _builtins.str, role_arn: _builtins.str, s3_configuration: outputs.FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamOpensearchserverlessConfigurationCloudwatchLoggingOptions] = ..., processing_configuration: Optional[outputs.FirehoseDeliveryStreamOpensearchserverlessConfigurationProcessingConfiguration] = ..., retry_duration: Optional[_builtins.int] = ..., s3_backup_mode: Optional[_builtins.str] = ..., vpc_config: Optional[outputs.FirehoseDeliveryStreamOpensearchserverlessConfigurationVpcConfig] = ...) -> None:
...
class FirehoseDeliveryStreamOpensearchserverlessConfigurationProcessingConfiguration(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., processors: Optional[Sequence[outputs.FirehoseDeliveryStreamOpensearchserverlessConfigurationProcessingConfigurationProcessor]] = ...) -> None:
...
class FirehoseDeliveryStreamOpensearchserverlessConfigurationProcessingConfigurationProcessor(dict):
    def __init__(__self__, *, type: _builtins.str, parameters: Optional[Sequence[outputs.FirehoseDeliveryStreamOpensearchserverlessConfigurationProcessingConfigurationProcessorParameter]] = ...) -> None:
...
class FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, role_arn: _builtins.str, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationCloudwatchLoggingOptions] = ..., compression_format: Optional[_builtins.str] = ..., error_output_prefix: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamRedshiftConfiguration(dict):
    ...
    def __init__(__self__, *, cluster_jdbcurl: _builtins.str, data_table_name: _builtins.str, role_arn: _builtins.str, s3_configuration: outputs.FirehoseDeliveryStreamRedshiftConfigurationS3Configuration, cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions] = ..., copy_options: Optional[_builtins.str] = ..., data_table_columns: Optional[_builtins.str] = ..., password: Optional[_builtins.str] = ..., processing_configuration: Optional[outputs.FirehoseDeliveryStreamRedshiftConfigurationProcessingConfiguration] = ..., retry_duration: Optional[_builtins.int] = ..., s3_backup_configuration: Optional[outputs.FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration] = ..., s3_backup_mode: Optional[_builtins.str] = ..., secrets_manager_configuration: Optional[outputs.FirehoseDeliveryStreamRedshiftConfigurationSecretsManagerConfiguration] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamRedshiftConfigurationProcessingConfiguration(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., processors: Optional[Sequence[outputs.FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessor]] = ...) -> None:
...
class FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessor(dict):
    def __init__(__self__, *, type: _builtins.str, parameters: Optional[Sequence[outputs.FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameter]] = ...) -> None:
...
class FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, role_arn: _builtins.str, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions] = ..., compression_format: Optional[_builtins.str] = ..., error_output_prefix: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamRedshiftConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, role_arn: _builtins.str, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptions] = ..., compression_format: Optional[_builtins.str] = ..., error_output_prefix: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamServerSideEncryption(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., key_arn: Optional[_builtins.str] = ..., key_type: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamSnowflakeConfiguration(dict):
    ...
    def __init__(__self__, *, account_url: _builtins.str, database: _builtins.str, role_arn: _builtins.str, s3_configuration: outputs.FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration, schema: _builtins.str, table: _builtins.str, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamSnowflakeConfigurationCloudwatchLoggingOptions] = ..., content_column_name: Optional[_builtins.str] = ..., data_loading_option: Optional[_builtins.str] = ..., key_passphrase: Optional[_builtins.str] = ..., metadata_column_name: Optional[_builtins.str] = ..., private_key: Optional[_builtins.str] = ..., processing_configuration: Optional[outputs.FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfiguration] = ..., retry_duration: Optional[_builtins.int] = ..., s3_backup_mode: Optional[_builtins.str] = ..., secrets_manager_configuration: Optional[outputs.FirehoseDeliveryStreamSnowflakeConfigurationSecretsManagerConfiguration] = ..., snowflake_role_configuration: Optional[outputs.FirehoseDeliveryStreamSnowflakeConfigurationSnowflakeRoleConfiguration] = ..., snowflake_vpc_configuration: Optional[outputs.FirehoseDeliveryStreamSnowflakeConfigurationSnowflakeVpcConfiguration] = ..., user: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfiguration(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., processors: Optional[Sequence[outputs.FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfigurationProcessor]] = ...) -> None:
...
class FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfigurationProcessor(dict):
    def __init__(__self__, *, type: _builtins.str, parameters: Optional[Sequence[outputs.FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfigurationProcessorParameter]] = ...) -> None:
...
class FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, role_arn: _builtins.str, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamSnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptions] = ..., compression_format: Optional[_builtins.str] = ..., error_output_prefix: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamSnowflakeConfigurationSnowflakeRoleConfiguration(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., snowflake_role: Optional[_builtins.str] = ...) -> None:
...
class FirehoseDeliveryStreamSplunkConfiguration(dict):
    ...
    def __init__(__self__, *, hec_endpoint: _builtins.str, s3_configuration: outputs.FirehoseDeliveryStreamSplunkConfigurationS3Configuration, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions] = ..., hec_acknowledgment_timeout: Optional[_builtins.int] = ..., hec_endpoint_type: Optional[_builtins.str] = ..., hec_token: Optional[_builtins.str] = ..., processing_configuration: Optional[outputs.FirehoseDeliveryStreamSplunkConfigurationProcessingConfiguration] = ..., retry_duration: Optional[_builtins.int] = ..., s3_backup_mode: Optional[_builtins.str] = ..., secrets_manager_configuration: Optional[outputs.FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration] = ...) -> None:
...
class FirehoseDeliveryStreamSplunkConfigurationProcessingConfiguration(dict):
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., processors: Optional[Sequence[outputs.FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessor]] = ...) -> None:
...
class FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessor(dict):
    def __init__(__self__, *, type: _builtins.str, parameters: Optional[Sequence[outputs.FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter]] = ...) -> None:
...
class FirehoseDeliveryStreamSplunkConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, role_arn: _builtins.str, buffering_interval: Optional[_builtins.int] = ..., buffering_size: Optional[_builtins.int] = ..., cloudwatch_logging_options: Optional[outputs.FirehoseDeliveryStreamSplunkConfigurationS3ConfigurationCloudwatchLoggingOptions] = ..., compression_format: Optional[_builtins.str] = ..., error_output_prefix: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
