...
class DetectorDatasources(dict):
    ...
    def __init__(__self__, *, kubernetes: Optional[outputs.DetectorDatasourcesKubernetes] = ..., malware_protection: Optional[outputs.DetectorDatasourcesMalwareProtection] = ..., s3_logs: Optional[outputs.DetectorDatasourcesS3Logs] = ...) -> None:
...
class DetectorDatasourcesKubernetes(dict):
    ...
    def __init__(__self__, *, audit_logs: outputs.DetectorDatasourcesKubernetesAuditLogs) -> None:
...
class DetectorDatasourcesMalwareProtection(dict):
    ...
    def __init__(__self__, *, scan_ec2_instance_with_findings: outputs.DetectorDatasourcesMalwareProtectionScanEc2InstanceWithFindings) -> None:
...
class DetectorDatasourcesMalwareProtectionScanEc2InstanceWithFindings(dict):
    ...
    def __init__(__self__, *, ebs_volumes: outputs.DetectorDatasourcesMalwareProtectionScanEc2InstanceWithFindingsEbsVolumes) -> None:
...
class FilterFindingCriteria(dict):
    def __init__(__self__, *, criterions: Sequence[outputs.FilterFindingCriteriaCriterion]) -> None:
        ...
...
class FilterFindingCriteriaCriterion(dict):
    ...
    def __init__(__self__, *, field: _builtins.str, equals: Optional[Sequence[_builtins.str]] = ..., greater_than: Optional[_builtins.str] = ..., greater_than_or_equal: Optional[_builtins.str] = ..., less_than: Optional[_builtins.str] = ..., less_than_or_equal: Optional[_builtins.str] = ..., matches: Optional[Sequence[_builtins.str]] = ..., not_equals: Optional[Sequence[_builtins.str]] = ..., not_matches: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class MalwareProtectionPlanAction(dict):
    def __init__(__self__, *, taggings: Sequence[outputs.MalwareProtectionPlanActionTagging]) -> None:
...
class MalwareProtectionPlanProtectedResource(dict):
    ...
    def __init__(__self__, *, s3_bucket: outputs.MalwareProtectionPlanProtectedResourceS3Bucket) -> None:
...
class MalwareProtectionPlanProtectedResourceS3Bucket(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, object_prefixes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class OrganizationConfigurationDatasources(dict):
    ...
    def __init__(__self__, *, kubernetes: Optional[outputs.OrganizationConfigurationDatasourcesKubernetes] = ..., malware_protection: Optional[outputs.OrganizationConfigurationDatasourcesMalwareProtection] = ..., s3_logs: Optional[outputs.OrganizationConfigurationDatasourcesS3Logs] = ...) -> None:
...
class OrganizationConfigurationDatasourcesKubernetes(dict):
    ...
    def __init__(__self__, *, audit_logs: outputs.OrganizationConfigurationDatasourcesKubernetesAuditLogs) -> None:
...
class OrganizationConfigurationDatasourcesMalwareProtection(dict):
    ...
    def __init__(__self__, *, scan_ec2_instance_with_findings: outputs.OrganizationConfigurationDatasourcesMalwareProtectionScanEc2InstanceWithFindings) -> None:
...
class OrganizationConfigurationDatasourcesMalwareProtectionScanEc2InstanceWithFindings(dict):
    ...
    def __init__(__self__, *, ebs_volumes: outputs.OrganizationConfigurationDatasourcesMalwareProtectionScanEc2InstanceWithFindingsEbsVolumes) -> None:
...
class OrganizationConfigurationFeatureAdditionalConfiguration(dict):
    ...
    def __init__(__self__, *, auto_enable: _builtins.str, name: _builtins.str) -> None:
...
class GetDetectorFeatureResult(dict):
    def __init__(__self__, *, additional_configurations: Sequence[outputs.GetDetectorFeatureAdditionalConfigurationResult], name: _builtins.str, status: _builtins.str) -> None:
