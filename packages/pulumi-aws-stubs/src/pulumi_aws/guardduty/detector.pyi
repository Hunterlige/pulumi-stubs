...
class DetectorArgs:
    def __init__(
        __self__,
        *,
        datasources: Optional[pulumi.Input[DetectorDatasourcesArgs]] = ...,
...
class Detector(pulumi.CustomResource):
    ...
    def __init__(
        ...
        datasources: Optional[
            pulumi.Input[Union[DetectorDatasourcesArgs, DetectorDatasourcesArgsDict]]
        ] = ...,
        enable: Optional[pulumi.Input[_builtins.bool]] = ...,
        finding_publishing_frequency: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
