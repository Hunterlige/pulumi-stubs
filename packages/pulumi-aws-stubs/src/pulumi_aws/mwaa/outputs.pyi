...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EnvironmentLastUpdated', 'EnvironmentLastUpdatedError', 'EnvironmentLoggingConfiguration', 'EnvironmentLoggingConfigurationDagProcessingLogs', 'EnvironmentLoggingConfigurationSchedulerLogs', 'EnvironmentLoggingConfigurationTaskLogs', 'EnvironmentLoggingConfigurationWebserverLogs', 'EnvironmentLoggingConfigurationWorkerLogs', 'EnvironmentNetworkConfiguration']
@pulumi.output_type
class EnvironmentLastUpdated(dict):
    ...
    def __init__(__self__, *, created_at: Optional[_builtins.str] = ..., errors: Optional[Sequence[outputs.EnvironmentLastUpdatedError]] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class EnvironmentLoggingConfiguration(dict):
    ...
    def __init__(__self__, *, dag_processing_logs: Optional[outputs.EnvironmentLoggingConfigurationDagProcessingLogs] = ..., scheduler_logs: Optional[outputs.EnvironmentLoggingConfigurationSchedulerLogs] = ..., task_logs: Optional[outputs.EnvironmentLoggingConfigurationTaskLogs] = ..., webserver_logs: Optional[outputs.EnvironmentLoggingConfigurationWebserverLogs] = ..., worker_logs: Optional[outputs.EnvironmentLoggingConfigurationWorkerLogs] = ...) -> None:
...
class EnvironmentLoggingConfigurationDagProcessingLogs(dict):
    ...
    def __init__(__self__, *, cloud_watch_log_group_arn: Optional[_builtins.str] = ..., enabled: Optional[_builtins.bool] = ..., log_level: Optional[_builtins.str] = ...) -> None:
