...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DevicePoolRuleArgs', 'DevicePoolRuleArgsDict', 'TestGridProjectVpcConfigArgs', 'TestGridProjectVpcConfigArgsDict']
...
class DevicePoolRuleArgs:
    def __init__(__self__, *, attribute: Optional[pulumi.Input[_builtins.str]] = ..., operator: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TestGridProjectVpcConfigArgs:
    def __init__(__self__, *, security_group_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], subnet_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], vpc_id: pulumi.Input[_builtins.str]) -> None:
