...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CapacityReservationTimeouts', 'DatabaseAclConfiguration', 'DatabaseEncryptionConfiguration', 'WorkgroupConfiguration', ..., 'WorkgroupConfigurationEngineVersion', 'WorkgroupConfigurationIdentityCenterConfiguration', ..., ..., 'WorkgroupConfigurationMonitoringConfiguration', ..., ..., ..., ..., ..., 'WorkgroupConfigurationResultConfiguration', ..., ...]
@pulumi.output_type
...
class DatabaseEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *, encryption_option: _builtins.str, kms_key: Optional[_builtins.str] = ...) -> None:
...
class WorkgroupConfiguration(dict):
    ...
    def __init__(__self__, *, bytes_scanned_cutoff_per_query: Optional[_builtins.int] = ..., customer_content_encryption_configuration: Optional[outputs.WorkgroupConfigurationCustomerContentEncryptionConfiguration] = ..., enable_minimum_encryption_configuration: Optional[_builtins.bool] = ..., enforce_workgroup_configuration: Optional[_builtins.bool] = ..., engine_version: Optional[outputs.WorkgroupConfigurationEngineVersion] = ..., execution_role: Optional[_builtins.str] = ..., identity_center_configuration: Optional[outputs.WorkgroupConfigurationIdentityCenterConfiguration] = ..., managed_query_results_configuration: Optional[outputs.WorkgroupConfigurationManagedQueryResultsConfiguration] = ..., monitoring_configuration: Optional[outputs.WorkgroupConfigurationMonitoringConfiguration] = ..., publish_cloudwatch_metrics_enabled: Optional[_builtins.bool] = ..., query_results_s3_access_grants_configuration: Optional[outputs.WorkgroupConfigurationQueryResultsS3AccessGrantsConfiguration] = ..., requester_pays_enabled: Optional[_builtins.bool] = ..., result_configuration: Optional[outputs.WorkgroupConfigurationResultConfiguration] = ...) -> None:
...
class WorkgroupConfigurationEngineVersion(dict):
    ...
    def __init__(__self__, *, effective_engine_version: Optional[_builtins.str] = ..., selected_engine_version: Optional[_builtins.str] = ...) -> None:
...
class WorkgroupConfigurationIdentityCenterConfiguration(dict):
    ...
    def __init__(__self__, *, enable_identity_center: Optional[_builtins.bool] = ..., identity_center_instance_arn: Optional[_builtins.str] = ...) -> None:
...
class WorkgroupConfigurationManagedQueryResultsConfiguration(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., encryption_configuration: Optional[outputs.WorkgroupConfigurationManagedQueryResultsConfigurationEncryptionConfiguration] = ...) -> None:
...
class WorkgroupConfigurationMonitoringConfiguration(dict):
    ...
    def __init__(__self__, *, cloud_watch_logging_configuration: Optional[outputs.WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfiguration] = ..., managed_logging_configuration: Optional[outputs.WorkgroupConfigurationMonitoringConfigurationManagedLoggingConfiguration] = ..., s3_logging_configuration: Optional[outputs.WorkgroupConfigurationMonitoringConfigurationS3LoggingConfiguration] = ...) -> None:
...
class WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfiguration(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, log_group: Optional[_builtins.str] = ..., log_stream_name_prefix: Optional[_builtins.str] = ..., log_types: Optional[Sequence[outputs.WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationLogType]] = ...) -> None:
...
class WorkgroupConfigurationMonitoringConfigurationManagedLoggingConfiguration(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, kms_key: Optional[_builtins.str] = ...) -> None:
...
class WorkgroupConfigurationMonitoringConfigurationS3LoggingConfiguration(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, kms_key: Optional[_builtins.str] = ..., log_location: Optional[_builtins.str] = ...) -> None:
...
class WorkgroupConfigurationQueryResultsS3AccessGrantsConfiguration(dict):
    ...
    def __init__(__self__, *, authentication_type: _builtins.str, enable_s3_access_grants: _builtins.bool, create_user_level_prefix: Optional[_builtins.bool] = ...) -> None:
...
class WorkgroupConfigurationResultConfiguration(dict):
    ...
    def __init__(__self__, *, acl_configuration: Optional[outputs.WorkgroupConfigurationResultConfigurationAclConfiguration] = ..., encryption_configuration: Optional[outputs.WorkgroupConfigurationResultConfigurationEncryptionConfiguration] = ..., expected_bucket_owner: Optional[_builtins.str] = ..., output_location: Optional[_builtins.str] = ...) -> None:
...
class WorkgroupConfigurationResultConfigurationEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *, encryption_option: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ...) -> None:
