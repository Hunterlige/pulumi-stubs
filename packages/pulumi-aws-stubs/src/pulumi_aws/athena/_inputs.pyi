...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CapacityReservationTimeoutsArgs', 'CapacityReservationTimeoutsArgsDict', 'DatabaseAclConfigurationArgs', 'DatabaseAclConfigurationArgsDict', 'DatabaseEncryptionConfigurationArgs', 'DatabaseEncryptionConfigurationArgsDict', 'WorkgroupConfigurationArgs', 'WorkgroupConfigurationArgsDict', ..., ..., 'WorkgroupConfigurationEngineVersionArgs', 'WorkgroupConfigurationEngineVersionArgsDict', ..., ..., ..., ..., ..., ..., 'WorkgroupConfigurationMonitoringConfigurationArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'WorkgroupConfigurationResultConfigurationArgs', 'WorkgroupConfigurationResultConfigurationArgsDict', ..., ..., ..., ...]
...
class DatabaseAclConfigurationArgs:
    ...
    def s3_acl_option(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DatabaseEncryptionConfigurationArgs:
    def __init__(__self__, *, encryption_option: pulumi.Input[_builtins.str], kms_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def encryption_option(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class WorkgroupConfigurationArgs:
    def __init__(__self__, *, bytes_scanned_cutoff_per_query: Optional[pulumi.Input[_builtins.int]] = ..., customer_content_encryption_configuration: Optional[pulumi.Input[WorkgroupConfigurationCustomerContentEncryptionConfigurationArgs]] = ..., enable_minimum_encryption_configuration: Optional[pulumi.Input[_builtins.bool]] = ..., enforce_workgroup_configuration: Optional[pulumi.Input[_builtins.bool]] = ..., engine_version: Optional[pulumi.Input[WorkgroupConfigurationEngineVersionArgs]] = ..., execution_role: Optional[pulumi.Input[_builtins.str]] = ..., identity_center_configuration: Optional[pulumi.Input[WorkgroupConfigurationIdentityCenterConfigurationArgs]] = ..., managed_query_results_configuration: Optional[pulumi.Input[WorkgroupConfigurationManagedQueryResultsConfigurationArgs]] = ..., monitoring_configuration: Optional[pulumi.Input[WorkgroupConfigurationMonitoringConfigurationArgs]] = ..., publish_cloudwatch_metrics_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., query_results_s3_access_grants_configuration: Optional[pulumi.Input[WorkgroupConfigurationQueryResultsS3AccessGrantsConfigurationArgs]] = ..., requester_pays_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., result_configuration: Optional[pulumi.Input[WorkgroupConfigurationResultConfigurationArgs]] = ...) -> None:
    ...
    def bytes_scanned_cutoff_per_query(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def customer_content_encryption_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationCustomerContentEncryptionConfigurationArgs]]): # -> None:
        ...
    ...
    def enable_minimum_encryption_configuration(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enforce_workgroup_configuration(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def engine_version(self, value: Optional[pulumi.Input[WorkgroupConfigurationEngineVersionArgs]]): # -> None:
        ...
    ...
    def identity_center_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationIdentityCenterConfigurationArgs]]): # -> None:
        ...
    ...
    def managed_query_results_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationManagedQueryResultsConfigurationArgs]]): # -> None:
        ...
    ...
    def monitoring_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationMonitoringConfigurationArgs]]): # -> None:
        ...
    ...
    def publish_cloudwatch_metrics_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def query_results_s3_access_grants_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationQueryResultsS3AccessGrantsConfigurationArgs]]): # -> None:
        ...
    ...
    def requester_pays_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def result_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationResultConfigurationArgs]]): # -> None:
        ...
...
class WorkgroupConfigurationEngineVersionArgs:
    def __init__(__self__, *, effective_engine_version: Optional[pulumi.Input[_builtins.str]] = ..., selected_engine_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def effective_engine_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def selected_engine_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkgroupConfigurationIdentityCenterConfigurationArgs:
    def __init__(__self__, *, enable_identity_center: Optional[pulumi.Input[_builtins.bool]] = ..., identity_center_instance_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def enable_identity_center(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class WorkgroupConfigurationManagedQueryResultsConfigurationArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., encryption_configuration: Optional[pulumi.Input[WorkgroupConfigurationManagedQueryResultsConfigurationEncryptionConfigurationArgs]] = ...) -> None:
    ...
    def encryption_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationManagedQueryResultsConfigurationEncryptionConfigurationArgs]]): # -> None:
        ...
...
class WorkgroupConfigurationMonitoringConfigurationArgs:
    def __init__(__self__, *, cloud_watch_logging_configuration: Optional[pulumi.Input[WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationArgs]] = ..., managed_logging_configuration: Optional[pulumi.Input[WorkgroupConfigurationMonitoringConfigurationManagedLoggingConfigurationArgs]] = ..., s3_logging_configuration: Optional[pulumi.Input[WorkgroupConfigurationMonitoringConfigurationS3LoggingConfigurationArgs]] = ...) -> None:
    ...
    def cloud_watch_logging_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationArgs]]): # -> None:
        ...
    ...
    def managed_logging_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationMonitoringConfigurationManagedLoggingConfigurationArgs]]): # -> None:
        ...
    ...
    def s3_logging_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationMonitoringConfigurationS3LoggingConfigurationArgs]]): # -> None:
        ...
...
class WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], log_group: Optional[pulumi.Input[_builtins.str]] = ..., log_stream_name_prefix: Optional[pulumi.Input[_builtins.str]] = ..., log_types: Optional[pulumi.Input[Sequence[pulumi.Input[WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationLogTypeArgs]]]] = ...) -> None:
    ...
    def log_stream_name_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @log_types.setter
    def log_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationLogTypeArgs]]]]): # -> None:
        ...
...
class WorkgroupConfigurationMonitoringConfigurationManagedLoggingConfigurationArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], kms_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkgroupConfigurationMonitoringConfigurationS3LoggingConfigurationArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], kms_key: Optional[pulumi.Input[_builtins.str]] = ..., log_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @log_location.setter
    def log_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkgroupConfigurationQueryResultsS3AccessGrantsConfigurationArgs:
    def __init__(__self__, *, authentication_type: pulumi.Input[_builtins.str], enable_s3_access_grants: pulumi.Input[_builtins.bool], create_user_level_prefix: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def enable_s3_access_grants(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def create_user_level_prefix(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class WorkgroupConfigurationResultConfigurationArgs:
    def __init__(__self__, *, acl_configuration: Optional[pulumi.Input[WorkgroupConfigurationResultConfigurationAclConfigurationArgs]] = ..., encryption_configuration: Optional[pulumi.Input[WorkgroupConfigurationResultConfigurationEncryptionConfigurationArgs]] = ..., expected_bucket_owner: Optional[pulumi.Input[_builtins.str]] = ..., output_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def acl_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationResultConfigurationAclConfigurationArgs]]): # -> None:
        ...
    ...
    @encryption_configuration.setter
    def encryption_configuration(self, value: Optional[pulumi.Input[WorkgroupConfigurationResultConfigurationEncryptionConfigurationArgs]]): # -> None:
        ...
...
class WorkgroupConfigurationResultConfigurationEncryptionConfigurationArgs:
    def __init__(__self__, *, encryption_option: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
