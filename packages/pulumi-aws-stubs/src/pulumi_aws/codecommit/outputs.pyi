...
class TriggerTrigger(dict):
    ...
    def __init__(__self__, *, destination_arn: _builtins.str, events: Sequence[_builtins.str], name: _builtins.str, branches: Optional[Sequence[_builtins.str]] = ..., custom_data: Optional[_builtins.str] = ...) -> None:
