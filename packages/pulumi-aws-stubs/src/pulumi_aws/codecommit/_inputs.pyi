...
class TriggerTriggerArgs:
    def __init__(__self__, *, destination_arn: pulumi.Input[_builtins.str], events: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], name: pulumi.Input[_builtins.str], branches: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., custom_data: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
