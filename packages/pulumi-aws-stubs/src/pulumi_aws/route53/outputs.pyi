...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ProfilesAssociationTimeouts', 'ProfilesProfileTimeouts', 'ProfilesResourceAssociationTimeouts', 'RecordAlias', 'RecordCidrRoutingPolicy', 'RecordFailoverRoutingPolicy', 'RecordGeolocationRoutingPolicy', 'RecordGeoproximityRoutingPolicy', 'RecordGeoproximityRoutingPolicyCoordinate', 'RecordLatencyRoutingPolicy', 'RecordWeightedRoutingPolicy', 'RecordsExclusiveResourceRecordSet', 'RecordsExclusiveResourceRecordSetAliasTarget', 'RecordsExclusiveResourceRecordSetCidrRoutingConfig', 'RecordsExclusiveResourceRecordSetGeolocation', ..., ..., 'RecordsExclusiveResourceRecordSetResourceRecord', 'RecordsExclusiveTimeouts', 'ResolverEndpointIpAddress', 'ResolverRuleTargetIp', 'ZoneVpc', 'GetProfilesProfilesProfileResult', 'GetQueryLogConfigFilterResult', 'GetRecordsResourceRecordSetResult', 'GetRecordsResourceRecordSetAliasTargetResult', 'GetRecordsResourceRecordSetCidrRoutingConfigResult', 'GetRecordsResourceRecordSetGeolocationResult', ..., ..., 'GetRecordsResourceRecordSetResourceRecordResult', 'GetResolverEndpointFilterResult', 'GetResolverFirewallRulesFirewallRuleResult', 'GetResolverRuleTargetIpResult', 'GetTrafficPolicyDocumentEndpointResult', 'GetTrafficPolicyDocumentRuleResult', ..., 'GetTrafficPolicyDocumentRuleItemResult', 'GetTrafficPolicyDocumentRuleLocationResult', 'GetTrafficPolicyDocumentRulePrimaryResult', 'GetTrafficPolicyDocumentRuleRegionResult', 'GetTrafficPolicyDocumentRuleSecondaryResult']
@pulumi.output_type
...
class ProfilesProfileTimeouts(dict):
    def __init__(__self__, *, create: Optional[_builtins.str] = ..., delete: Optional[_builtins.str] = ..., read: Optional[_builtins.str] = ...) -> None:
...
class RecordAlias(dict):
    ...
    def __init__(__self__, *, evaluate_target_health: _builtins.bool, name: _builtins.str, zone_id: _builtins.str) -> None:
...
class RecordCidrRoutingPolicy(dict):
    ...
    def __init__(__self__, *, collection_id: _builtins.str, location_name: _builtins.str) -> None:
...
class RecordGeolocationRoutingPolicy(dict):
    def __init__(__self__, *, continent: Optional[_builtins.str] = ..., country: Optional[_builtins.str] = ..., subdivision: Optional[_builtins.str] = ...) -> None:
...
class RecordGeoproximityRoutingPolicy(dict):
    ...
    def __init__(__self__, *, aws_region: Optional[_builtins.str] = ..., bias: Optional[_builtins.int] = ..., coordinates: Optional[Sequence[outputs.RecordGeoproximityRoutingPolicyCoordinate]] = ..., local_zone_group: Optional[_builtins.str] = ...) -> None:
...
class RecordGeoproximityRoutingPolicyCoordinate(dict):
    def __init__(__self__, *, latitude: _builtins.str, longitude: _builtins.str) -> None:
        ...
...
class RecordsExclusiveResourceRecordSet(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, alias_target: Optional[outputs.RecordsExclusiveResourceRecordSetAliasTarget] = ..., cidr_routing_config: Optional[outputs.RecordsExclusiveResourceRecordSetCidrRoutingConfig] = ..., failover: Optional[_builtins.str] = ..., geolocation: Optional[outputs.RecordsExclusiveResourceRecordSetGeolocation] = ..., geoproximity_location: Optional[outputs.RecordsExclusiveResourceRecordSetGeoproximityLocation] = ..., health_check_id: Optional[_builtins.str] = ..., multi_value_answer: Optional[_builtins.bool] = ..., region: Optional[_builtins.str] = ..., resource_records: Optional[Sequence[outputs.RecordsExclusiveResourceRecordSetResourceRecord]] = ..., set_identifier: Optional[_builtins.str] = ..., traffic_policy_instance_id: Optional[_builtins.str] = ..., ttl: Optional[_builtins.int] = ..., type: Optional[_builtins.str] = ..., weight: Optional[_builtins.int] = ...) -> None:
...
class RecordsExclusiveResourceRecordSetAliasTarget(dict):
    ...
    def __init__(__self__, *, dns_name: _builtins.str, evaluate_target_health: _builtins.bool, hosted_zone_id: _builtins.str) -> None:
...
class RecordsExclusiveResourceRecordSetGeolocation(dict):
    ...
    def __init__(__self__, *, continent_code: Optional[_builtins.str] = ..., country_code: Optional[_builtins.str] = ..., subdivision_code: Optional[_builtins.str] = ...) -> None:
        ...
...
class RecordsExclusiveResourceRecordSetGeoproximityLocation(dict):
    ...
    def __init__(__self__, *, aws_region: Optional[_builtins.str] = ..., bias: Optional[_builtins.int] = ..., coordinates: Optional[outputs.RecordsExclusiveResourceRecordSetGeoproximityLocationCoordinates] = ..., local_zone_group: Optional[_builtins.str] = ...) -> None:
...
class ResolverEndpointIpAddress(dict):
    ...
    def __init__(__self__, *, subnet_id: _builtins.str, ip: Optional[_builtins.str] = ..., ip_id: Optional[_builtins.str] = ..., ipv6: Optional[_builtins.str] = ...) -> None:
...
class ResolverRuleTargetIp(dict):
    def __init__(__self__, *, ip: Optional[_builtins.str] = ..., ipv6: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., protocol: Optional[_builtins.str] = ...) -> None:
...
class ZoneVpc(dict):
    ...
    def __init__(__self__, *, vpc_id: _builtins.str, vpc_region: Optional[_builtins.str] = ...) -> None:
...
class GetProfilesProfilesProfileResult(dict):
    def __init__(__self__, *, arn: _builtins.str, id: _builtins.str, name: _builtins.str, share_status: _builtins.str) -> None:
...
class GetRecordsResourceRecordSetResult(dict):
    def __init__(__self__, *, alias_target: outputs.GetRecordsResourceRecordSetAliasTargetResult, cidr_routing_config: outputs.GetRecordsResourceRecordSetCidrRoutingConfigResult, failover: _builtins.str, geolocation: outputs.GetRecordsResourceRecordSetGeolocationResult, geoproximity_location: outputs.GetRecordsResourceRecordSetGeoproximityLocationResult, health_check_id: _builtins.str, multi_value_answer: _builtins.bool, name: _builtins.str, region: _builtins.str, resource_records: Sequence[outputs.GetRecordsResourceRecordSetResourceRecordResult], set_identifier: _builtins.str, traffic_policy_instance_id: _builtins.str, ttl: _builtins.int, type: _builtins.str, weight: _builtins.int) -> None:
...
class GetRecordsResourceRecordSetGeolocationResult(dict):
    def __init__(__self__, *, continent_code: _builtins.str, country_code: _builtins.str, subdivision_code: _builtins.str) -> None:
...
class GetRecordsResourceRecordSetGeoproximityLocationResult(dict):
    def __init__(__self__, *, aws_region: _builtins.str, bias: _builtins.int, coordinates: outputs.GetRecordsResourceRecordSetGeoproximityLocationCoordinatesResult, local_zone_group: _builtins.str) -> None:
...
class GetResolverFirewallRulesFirewallRuleResult(dict):
    def __init__(__self__, *, action: _builtins.str, block_override_dns_type: _builtins.str, block_override_domain: _builtins.str, block_override_ttl: _builtins.int, block_response: _builtins.str, confidence_threshold: _builtins.str, creation_time: _builtins.str, creator_request_id: _builtins.str, dns_threat_protection: _builtins.str, firewall_domain_list_id: _builtins.str, firewall_domain_redirection_action: _builtins.str, firewall_rule_group_id: _builtins.str, firewall_threat_protection_id: _builtins.str, modification_time: _builtins.str, name: _builtins.str, priority: _builtins.int, q_type: _builtins.str) -> None:
...
class GetResolverRuleTargetIpResult(dict):
    def __init__(__self__, *, ip: _builtins.str, ipv6: _builtins.str, port: _builtins.int, protocol: _builtins.str) -> None:
...
class GetTrafficPolicyDocumentRuleResult(dict):
    def __init__(__self__, *, id: _builtins.str, geo_proximity_locations: Optional[Sequence[outputs.GetTrafficPolicyDocumentRuleGeoProximityLocationResult]] = ..., items: Optional[Sequence[outputs.GetTrafficPolicyDocumentRuleItemResult]] = ..., locations: Optional[Sequence[outputs.GetTrafficPolicyDocumentRuleLocationResult]] = ..., primary: Optional[outputs.GetTrafficPolicyDocumentRulePrimaryResult] = ..., regions: Optional[Sequence[outputs.GetTrafficPolicyDocumentRuleRegionResult]] = ..., secondary: Optional[outputs.GetTrafficPolicyDocumentRuleSecondaryResult] = ..., type: Optional[_builtins.str] = ...) -> None:
