...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['TrustAnchorNotificationSettingArgs', 'TrustAnchorNotificationSettingArgsDict', 'TrustAnchorSourceArgs', 'TrustAnchorSourceArgsDict', 'TrustAnchorSourceSourceDataArgs', 'TrustAnchorSourceSourceDataArgsDict']
...
class TrustAnchorNotificationSettingArgs:
    def __init__(__self__, *, channel: Optional[pulumi.Input[_builtins.str]] = ..., configured_by: Optional[pulumi.Input[_builtins.str]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., event: Optional[pulumi.Input[_builtins.str]] = ..., threshold: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def configured_by(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TrustAnchorSourceArgs:
    def __init__(__self__, *, source_data: pulumi.Input[TrustAnchorSourceSourceDataArgs], source_type: pulumi.Input[_builtins.str]) -> None:
    ...
    @source_data.setter
    def source_data(self, value: pulumi.Input[TrustAnchorSourceSourceDataArgs]): # -> None:
        ...
...
class TrustAnchorSourceSourceDataArgs:
    def __init__(__self__, *, acm_pca_arn: Optional[pulumi.Input[_builtins.str]] = ..., x509_certificate_data: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @acm_pca_arn.setter
    def acm_pca_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def x509_certificate_data(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
