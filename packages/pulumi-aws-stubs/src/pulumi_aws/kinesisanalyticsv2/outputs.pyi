...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationApplicationConfiguration', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ApplicationCloudwatchLoggingOptions']
@pulumi.output_type
class ApplicationApplicationConfiguration(dict):
    ...
    def __init__(__self__, *, application_code_configuration: outputs.ApplicationApplicationConfigurationApplicationCodeConfiguration, application_encryption_configuration: Optional[outputs.ApplicationApplicationConfigurationApplicationEncryptionConfiguration] = ..., application_snapshot_configuration: Optional[outputs.ApplicationApplicationConfigurationApplicationSnapshotConfiguration] = ..., environment_properties: Optional[outputs.ApplicationApplicationConfigurationEnvironmentProperties] = ..., flink_application_configuration: Optional[outputs.ApplicationApplicationConfigurationFlinkApplicationConfiguration] = ..., run_configuration: Optional[outputs.ApplicationApplicationConfigurationRunConfiguration] = ..., sql_application_configuration: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfiguration] = ..., vpc_configuration: Optional[outputs.ApplicationApplicationConfigurationVpcConfiguration] = ...) -> None:
...
class ApplicationApplicationConfigurationApplicationCodeConfiguration(dict):
    ...
    def __init__(__self__, *, code_content_type: _builtins.str, code_content: Optional[outputs.ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContent] = ...) -> None:
...
class ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContent(dict):
    ...
    def __init__(__self__, *, s3_content_location: Optional[outputs.ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContentS3ContentLocation] = ..., text_content: Optional[_builtins.str] = ...) -> None:
...
class ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContentS3ContentLocation(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, file_key: _builtins.str, object_version: Optional[_builtins.str] = ...) -> None:
...
class ApplicationApplicationConfigurationApplicationEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *, key_type: _builtins.str, key_id: Optional[_builtins.str] = ...) -> None:
...
class ApplicationApplicationConfigurationEnvironmentProperties(dict):
    ...
    def __init__(__self__, *, property_groups: Sequence[outputs.ApplicationApplicationConfigurationEnvironmentPropertiesPropertyGroup]) -> None:
...
class ApplicationApplicationConfigurationEnvironmentPropertiesPropertyGroup(dict):
    ...
    def __init__(__self__, *, property_group_id: _builtins.str, property_map: Mapping[str, _builtins.str]) -> None:
...
class ApplicationApplicationConfigurationFlinkApplicationConfiguration(dict):
    ...
    def __init__(__self__, *, checkpoint_configuration: Optional[outputs.ApplicationApplicationConfigurationFlinkApplicationConfigurationCheckpointConfiguration] = ..., monitoring_configuration: Optional[outputs.ApplicationApplicationConfigurationFlinkApplicationConfigurationMonitoringConfiguration] = ..., parallelism_configuration: Optional[outputs.ApplicationApplicationConfigurationFlinkApplicationConfigurationParallelismConfiguration] = ...) -> None:
...
class ApplicationApplicationConfigurationFlinkApplicationConfigurationCheckpointConfiguration(dict):
    ...
    def __init__(__self__, *, configuration_type: _builtins.str, checkpoint_interval: Optional[_builtins.int] = ..., checkpointing_enabled: Optional[_builtins.bool] = ..., min_pause_between_checkpoints: Optional[_builtins.int] = ...) -> None:
...
class ApplicationApplicationConfigurationFlinkApplicationConfigurationMonitoringConfiguration(dict):
    ...
    def __init__(__self__, *, configuration_type: _builtins.str, log_level: Optional[_builtins.str] = ..., metrics_level: Optional[_builtins.str] = ...) -> None:
...
class ApplicationApplicationConfigurationFlinkApplicationConfigurationParallelismConfiguration(dict):
    ...
    def __init__(__self__, *, configuration_type: _builtins.str, auto_scaling_enabled: Optional[_builtins.bool] = ..., parallelism: Optional[_builtins.int] = ..., parallelism_per_kpu: Optional[_builtins.int] = ...) -> None:
...
class ApplicationApplicationConfigurationRunConfiguration(dict):
    ...
    def __init__(__self__, *, application_restore_configuration: Optional[outputs.ApplicationApplicationConfigurationRunConfigurationApplicationRestoreConfiguration] = ..., flink_run_configuration: Optional[outputs.ApplicationApplicationConfigurationRunConfigurationFlinkRunConfiguration] = ...) -> None:
...
class ApplicationApplicationConfigurationRunConfigurationApplicationRestoreConfiguration(dict):
    ...
    def __init__(__self__, *, application_restore_type: Optional[_builtins.str] = ..., snapshot_name: Optional[_builtins.str] = ...) -> None:
...
class ApplicationApplicationConfigurationRunConfigurationFlinkRunConfiguration(dict):
    ...
    def __init__(__self__, *, allow_non_restored_state: Optional[_builtins.bool] = ...) -> None:
...
class ApplicationApplicationConfigurationSqlApplicationConfiguration(dict):
    ...
    def __init__(__self__, *, input: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationInput] = ..., outputs: Optional[Sequence[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationOutput]] = ..., reference_data_source: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSource] = ...) -> None:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInput(dict):
    ...
    def __init__(__self__, *, input_schema: outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchema, name_prefix: _builtins.str, in_app_stream_names: Optional[Sequence[_builtins.str]] = ..., input_id: Optional[_builtins.str] = ..., input_parallelism: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputParallelism] = ..., input_processing_configuration: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputProcessingConfiguration] = ..., input_starting_position_configurations: Optional[Sequence[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputStartingPositionConfiguration]] = ..., kinesis_firehose_input: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationInputKinesisFirehoseInput] = ..., kinesis_streams_input: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationInputKinesisStreamsInput] = ...) -> None:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputProcessingConfiguration(dict):
    ...
    def __init__(__self__, *, input_lambda_processor: outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputProcessingConfigurationInputLambdaProcessor) -> None:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchemaRecordFormat(dict):
    ...
    def __init__(__self__, *, mapping_parameters: outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchemaRecordFormatMappingParameters, record_format_type: _builtins.str) -> None:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchemaRecordFormatMappingParameters(dict):
    ...
    def __init__(__self__, *, csv_mapping_parameters: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchemaRecordFormatMappingParametersCsvMappingParameters] = ..., json_mapping_parameters: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchemaRecordFormatMappingParametersJsonMappingParameters] = ...) -> None:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputStartingPositionConfiguration(dict):
    ...
    def __init__(__self__, *, input_starting_position: Optional[_builtins.str] = ...) -> None:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationOutput(dict):
    ...
    def __init__(__self__, *, destination_schema: outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationOutputDestinationSchema, name: _builtins.str, kinesis_firehose_output: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationOutputKinesisFirehoseOutput] = ..., kinesis_streams_output: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationOutputKinesisStreamsOutput] = ..., lambda_output: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationOutputLambdaOutput] = ..., output_id: Optional[_builtins.str] = ...) -> None:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSource(dict):
    ...
    def __init__(__self__, *, reference_schema: outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchema, s3_reference_data_source: outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceS3ReferenceDataSource, table_name: _builtins.str, reference_id: Optional[_builtins.str] = ...) -> None:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormat(dict):
    ...
    def __init__(__self__, *, mapping_parameters: outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParameters, record_format_type: _builtins.str) -> None:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParameters(dict):
    ...
    def __init__(__self__, *, csv_mapping_parameters: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParametersCsvMappingParameters] = ..., json_mapping_parameters: Optional[outputs.ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchemaRecordFormatMappingParametersJsonMappingParameters] = ...) -> None:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceS3ReferenceDataSource(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, file_key: _builtins.str) -> None:
...
class ApplicationApplicationConfigurationVpcConfiguration(dict):
    ...
    def __init__(__self__, *, security_group_ids: Sequence[_builtins.str], subnet_ids: Sequence[_builtins.str], vpc_configuration_id: Optional[_builtins.str] = ..., vpc_id: Optional[_builtins.str] = ...) -> None:
...
class ApplicationCloudwatchLoggingOptions(dict):
    ...
    def __init__(__self__, *, log_stream_arn: _builtins.str, cloudwatch_logging_option_id: Optional[_builtins.str] = ...) -> None:
