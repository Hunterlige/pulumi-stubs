...
class GroupInsightsConfigurationArgs:
    def __init__(__self__, *, insights_enabled: pulumi.Input[_builtins.bool], notifications_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def insights_enabled(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def notifications_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
