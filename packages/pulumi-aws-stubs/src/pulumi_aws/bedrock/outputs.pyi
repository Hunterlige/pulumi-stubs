...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AgentAgentActionGroupActionGroupExecutor', 'AgentAgentActionGroupApiSchema', 'AgentAgentActionGroupApiSchemaS3', 'AgentAgentActionGroupFunctionSchema', 'AgentAgentActionGroupFunctionSchemaMemberFunctions', ..., ..., 'AgentAgentActionGroupTimeouts', 'AgentAgentAliasRoutingConfiguration', 'AgentAgentAliasTimeouts', 'AgentAgentCollaboratorAgentDescriptor', 'AgentAgentCollaboratorTimeouts', 'AgentAgentGuardrailConfiguration', 'AgentAgentKnowledgeBaseAssociationTimeouts', 'AgentAgentMemoryConfiguration', ..., 'AgentAgentPromptOverrideConfiguration', ..., ..., 'AgentAgentTimeouts', 'AgentDataSourceDataSourceConfiguration', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AgentDataSourceServerSideEncryptionConfiguration', 'AgentDataSourceTimeouts', 'AgentDataSourceVectorIngestionConfiguration', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AgentFlowDefinition', 'AgentFlowDefinitionConnection', 'AgentFlowDefinitionConnectionConfiguration', ..., 'AgentFlowDefinitionConnectionConfigurationData', 'AgentFlowDefinitionNode', 'AgentFlowDefinitionNodeConfiguration', 'AgentFlowDefinitionNodeConfigurationAgent', 'AgentFlowDefinitionNodeConfigurationCollector', 'AgentFlowDefinitionNodeConfigurationCondition', ..., 'AgentFlowDefinitionNodeConfigurationInlineCode', 'AgentFlowDefinitionNodeConfigurationInput', 'AgentFlowDefinitionNodeConfigurationIterator', 'AgentFlowDefinitionNodeConfigurationKnowledgeBase', ..., ..., ..., 'AgentFlowDefinitionNodeConfigurationLambdaFunction', 'AgentFlowDefinitionNodeConfigurationLex', 'AgentFlowDefinitionNodeConfigurationOutput', 'AgentFlowDefinitionNodeConfigurationPrompt', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AgentFlowDefinitionNodeConfigurationRetrieval', ..., ..., 'AgentFlowDefinitionNodeConfigurationStorage', ..., ..., 'AgentFlowDefinitionNodeInput', 'AgentFlowDefinitionNodeOutput', 'AgentFlowTimeouts', 'AgentKnowledgeBaseKnowledgeBaseConfiguration', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AgentKnowledgeBaseStorageConfiguration', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AgentKnowledgeBaseTimeouts', 'AgentPromptVariant', 'AgentPromptVariantGenAiResource', 'AgentPromptVariantGenAiResourceAgent', 'AgentPromptVariantInferenceConfiguration', 'AgentPromptVariantInferenceConfigurationText', 'AgentPromptVariantMetadata', 'AgentPromptVariantTemplateConfiguration', 'AgentPromptVariantTemplateConfigurationChat', ..., 'AgentPromptVariantTemplateConfigurationChatMessage', ..., ..., 'AgentPromptVariantTemplateConfigurationChatSystem', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AgentPromptVariantTemplateConfigurationText', ..., ..., 'AgentcoreAgentRuntimeAgentRuntimeArtifact', ..., ..., ..., ..., 'AgentcoreAgentRuntimeAuthorizerConfiguration', ..., 'AgentcoreAgentRuntimeEndpointTimeouts', 'AgentcoreAgentRuntimeLifecycleConfiguration', 'AgentcoreAgentRuntimeNetworkConfiguration', ..., 'AgentcoreAgentRuntimeProtocolConfiguration', 'AgentcoreAgentRuntimeRequestHeaderConfiguration', 'AgentcoreAgentRuntimeTimeouts', 'AgentcoreAgentRuntimeWorkloadIdentityDetail', 'AgentcoreApiKeyCredentialProviderApiKeySecretArn', 'AgentcoreBrowserNetworkConfiguration', 'AgentcoreBrowserNetworkConfigurationVpcConfig', 'AgentcoreBrowserRecording', 'AgentcoreBrowserRecordingS3Location', 'AgentcoreBrowserTimeouts', 'AgentcoreCodeInterpreterNetworkConfiguration', ..., 'AgentcoreCodeInterpreterTimeouts', 'AgentcoreGatewayAuthorizerConfiguration', ..., 'AgentcoreGatewayInterceptorConfiguration', ..., ..., ..., 'AgentcoreGatewayProtocolConfiguration', 'AgentcoreGatewayProtocolConfigurationMcp', ..., ..., ..., ..., 'AgentcoreGatewayTargetMetadataConfiguration', 'AgentcoreGatewayTargetTargetConfiguration', 'AgentcoreGatewayTargetTargetConfigurationMcp', 'AgentcoreGatewayTargetTargetConfigurationMcpLambda', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AgentcoreGatewayTargetTimeouts', 'AgentcoreGatewayTimeouts', 'AgentcoreGatewayWorkloadIdentityDetail', 'AgentcoreMemoryStrategyConfiguration', 'AgentcoreMemoryStrategyConfigurationConsolidation', 'AgentcoreMemoryStrategyConfigurationExtraction', 'AgentcoreMemoryStrategyTimeouts', 'AgentcoreMemoryTimeouts', 'AgentcoreOauth2CredentialProviderClientSecretArn', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AgentcoreTokenVaultCmkKmsConfiguration', 'CustomModelOutputDataConfig', 'CustomModelTimeouts', 'CustomModelTrainingDataConfig', 'CustomModelTrainingMetric', 'CustomModelValidationDataConfig', 'CustomModelValidationDataConfigValidator', 'CustomModelValidationMetric', 'CustomModelVpcConfig', 'GuardrailContentPolicyConfig', 'GuardrailContentPolicyConfigFiltersConfig', 'GuardrailContentPolicyConfigTierConfig', 'GuardrailContextualGroundingPolicyConfig', ..., 'GuardrailCrossRegionConfig', 'GuardrailSensitiveInformationPolicyConfig', ..., ..., 'GuardrailTimeouts', 'GuardrailTopicPolicyConfig', 'GuardrailTopicPolicyConfigTierConfig', 'GuardrailTopicPolicyConfigTopicsConfig', 'GuardrailVersionTimeouts', 'GuardrailWordPolicyConfig', 'GuardrailWordPolicyConfigManagedWordListsConfig', 'GuardrailWordPolicyConfigWordsConfig', 'InferenceProfileModel', 'InferenceProfileModelSource', 'InferenceProfileTimeouts', 'ProvisionedModelThroughputTimeouts', 'GetAgentAgentVersionsAgentVersionSummaryResult', ..., 'GetCustomModelOutputDataConfigResult', 'GetCustomModelTrainingDataConfigResult', 'GetCustomModelTrainingMetricResult', 'GetCustomModelValidationDataConfigResult', 'GetCustomModelValidationDataConfigValidatorResult', 'GetCustomModelValidationMetricResult', 'GetCustomModelsModelSummaryResult', 'GetInferenceProfileModelResult', 'GetInferenceProfilesInferenceProfileSummaryResult', ...]
@pulumi.output_type
class AgentAgentActionGroupActionGroupExecutor(dict):
    ...
    def __init__(__self__, *, custom_control: Optional[_builtins.str] = ..., lambda_: Optional[_builtins.str] = ...) -> None:
...
class AgentAgentActionGroupApiSchema(dict):
    def __init__(__self__, *, payload: Optional[_builtins.str] = ..., s3: Optional[outputs.AgentAgentActionGroupApiSchemaS3] = ...) -> None:
...
class AgentAgentActionGroupApiSchemaS3(dict):
    ...
    def __init__(__self__, *, s3_bucket_name: Optional[_builtins.str] = ..., s3_object_key: Optional[_builtins.str] = ...) -> None:
...
class AgentAgentActionGroupFunctionSchema(dict):
    ...
    def __init__(__self__, *, member_functions: Optional[outputs.AgentAgentActionGroupFunctionSchemaMemberFunctions] = ...) -> None:
...
class AgentAgentActionGroupFunctionSchemaMemberFunctions(dict):
    def __init__(__self__, *, functions: Optional[Sequence[outputs.AgentAgentActionGroupFunctionSchemaMemberFunctionsFunction]] = ...) -> None:
...
class AgentAgentActionGroupFunctionSchemaMemberFunctionsFunction(dict):
    def __init__(__self__, *, name: _builtins.str, description: Optional[_builtins.str] = ..., parameters: Optional[Sequence[outputs.AgentAgentActionGroupFunctionSchemaMemberFunctionsFunctionParameter]] = ...) -> None:
...
class AgentAgentActionGroupFunctionSchemaMemberFunctionsFunctionParameter(dict):
    ...
    def __init__(__self__, *, map_block_key: _builtins.str, type: _builtins.str, description: Optional[_builtins.str] = ..., required: Optional[_builtins.bool] = ...) -> None:
...
class AgentAgentAliasRoutingConfiguration(dict):
    ...
    def __init__(__self__, *, agent_version: _builtins.str, provisioned_throughput: _builtins.str) -> None:
...
class AgentAgentMemoryConfiguration(dict):
    ...
    def __init__(__self__, *, enabled_memory_types: Sequence[_builtins.str], session_summary_configurations: Sequence[outputs.AgentAgentMemoryConfigurationSessionSummaryConfiguration], storage_days: _builtins.int) -> None:
...
class AgentAgentPromptOverrideConfiguration(dict):
    ...
    def __init__(__self__, *, override_lambda: _builtins.str, prompt_configurations: Sequence[outputs.AgentAgentPromptOverrideConfigurationPromptConfiguration]) -> None:
...
class AgentAgentPromptOverrideConfigurationPromptConfiguration(dict):
    ...
    def __init__(__self__, *, base_prompt_template: _builtins.str, inference_configurations: Sequence[outputs.AgentAgentPromptOverrideConfigurationPromptConfigurationInferenceConfiguration], parser_mode: _builtins.str, prompt_creation_mode: _builtins.str, prompt_state: _builtins.str, prompt_type: _builtins.str) -> None:
...
class AgentAgentPromptOverrideConfigurationPromptConfigurationInferenceConfiguration(dict):
    ...
    def __init__(__self__, *, max_length: _builtins.int, stop_sequences: Sequence[_builtins.str], temperature: _builtins.float, top_k: _builtins.int, top_p: _builtins.float) -> None:
...
class AgentDataSourceDataSourceConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, confluence_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationConfluenceConfiguration] = ..., s3_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationS3Configuration] = ..., salesforce_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationSalesforceConfiguration] = ..., share_point_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationSharePointConfiguration] = ..., web_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationWebConfiguration] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationConfluenceConfiguration(dict):
    ...
    def __init__(__self__, *, crawler_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationConfluenceConfigurationCrawlerConfiguration] = ..., source_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationConfluenceConfigurationSourceConfiguration] = ...) -> None:
        ...
...
class AgentDataSourceDataSourceConfigurationConfluenceConfigurationCrawlerConfiguration(dict):
    ...
    def __init__(__self__, *, filter_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfiguration] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, pattern_object_filters: Optional[Sequence[outputs.AgentDataSourceDataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilter]] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilter(dict):
    def __init__(__self__, *, filters: Optional[Sequence[outputs.AgentDataSourceDataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilterFilter]] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilterFilter(dict):
    ...
    def __init__(__self__, *, object_type: _builtins.str, exclusion_filters: Optional[Sequence[_builtins.str]] = ..., inclusion_filters: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationConfluenceConfigurationSourceConfiguration(dict):
    ...
    def __init__(__self__, *, auth_type: _builtins.str, credentials_secret_arn: _builtins.str, host_type: _builtins.str, host_url: _builtins.str) -> None:
...
class AgentDataSourceDataSourceConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, bucket_owner_account_id: Optional[_builtins.str] = ..., inclusion_prefixes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationSalesforceConfiguration(dict):
    ...
    def __init__(__self__, *, crawler_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationSalesforceConfigurationCrawlerConfiguration] = ..., source_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationSalesforceConfigurationSourceConfiguration] = ...) -> None:
        ...
...
class AgentDataSourceDataSourceConfigurationSalesforceConfigurationCrawlerConfiguration(dict):
    ...
    def __init__(__self__, *, filter_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationSalesforceConfigurationCrawlerConfigurationFilterConfiguration] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationSalesforceConfigurationCrawlerConfigurationFilterConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, pattern_object_filters: Optional[Sequence[outputs.AgentDataSourceDataSourceConfigurationSalesforceConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilter]] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationSalesforceConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilter(dict):
    def __init__(__self__, *, filters: Optional[Sequence[outputs.AgentDataSourceDataSourceConfigurationSalesforceConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilterFilter]] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationSalesforceConfigurationSourceConfiguration(dict):
    ...
    def __init__(__self__, *, auth_type: _builtins.str, credentials_secret_arn: _builtins.str, host_url: _builtins.str) -> None:
...
class AgentDataSourceDataSourceConfigurationSharePointConfiguration(dict):
    ...
    def __init__(__self__, *, crawler_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationSharePointConfigurationCrawlerConfiguration] = ..., source_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationSharePointConfigurationSourceConfiguration] = ...) -> None:
        ...
...
class AgentDataSourceDataSourceConfigurationSharePointConfigurationCrawlerConfiguration(dict):
    ...
    def __init__(__self__, *, filter_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationSharePointConfigurationCrawlerConfigurationFilterConfiguration] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationSharePointConfigurationCrawlerConfigurationFilterConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, pattern_object_filters: Optional[Sequence[outputs.AgentDataSourceDataSourceConfigurationSharePointConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilter]] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationSharePointConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilter(dict):
    def __init__(__self__, *, filters: Optional[Sequence[outputs.AgentDataSourceDataSourceConfigurationSharePointConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilterFilter]] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationSharePointConfigurationSourceConfiguration(dict):
    ...
    def __init__(__self__, *, auth_type: _builtins.str, credentials_secret_arn: _builtins.str, domain: _builtins.str, host_type: _builtins.str, site_urls: Sequence[_builtins.str], tenant_id: Optional[_builtins.str] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationWebConfiguration(dict):
    ...
    def __init__(__self__, *, crawler_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationWebConfigurationCrawlerConfiguration] = ..., source_configuration: Optional[outputs.AgentDataSourceDataSourceConfigurationWebConfigurationSourceConfiguration] = ...) -> None:
        ...
...
class AgentDataSourceDataSourceConfigurationWebConfigurationCrawlerConfiguration(dict):
    ...
    def __init__(__self__, *, crawler_limits: Optional[outputs.AgentDataSourceDataSourceConfigurationWebConfigurationCrawlerConfigurationCrawlerLimits] = ..., exclusion_filters: Optional[Sequence[_builtins.str]] = ..., inclusion_filters: Optional[Sequence[_builtins.str]] = ..., scope: Optional[_builtins.str] = ..., user_agent: Optional[_builtins.str] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationWebConfigurationCrawlerConfigurationCrawlerLimits(dict):
    ...
    def __init__(__self__, *, max_pages: Optional[_builtins.int] = ..., rate_limit: Optional[_builtins.int] = ...) -> None:
...
class AgentDataSourceDataSourceConfigurationWebConfigurationSourceConfiguration(dict):
    ...
    def __init__(__self__, *, url_configuration: outputs.AgentDataSourceDataSourceConfigurationWebConfigurationSourceConfigurationUrlConfiguration) -> None:
...
class AgentDataSourceDataSourceConfigurationWebConfigurationSourceConfigurationUrlConfiguration(dict):
    ...
    def __init__(__self__, *, seed_urls: Optional[Sequence[outputs.AgentDataSourceDataSourceConfigurationWebConfigurationSourceConfigurationUrlConfigurationSeedUrl]] = ...) -> None:
...
class AgentDataSourceVectorIngestionConfiguration(dict):
    ...
    def __init__(__self__, *, chunking_configuration: Optional[outputs.AgentDataSourceVectorIngestionConfigurationChunkingConfiguration] = ..., custom_transformation_configuration: Optional[outputs.AgentDataSourceVectorIngestionConfigurationCustomTransformationConfiguration] = ..., parsing_configuration: Optional[outputs.AgentDataSourceVectorIngestionConfigurationParsingConfiguration] = ...) -> None:
...
class AgentDataSourceVectorIngestionConfigurationChunkingConfiguration(dict):
    ...
    def __init__(__self__, *, chunking_strategy: _builtins.str, fixed_size_chunking_configuration: Optional[outputs.AgentDataSourceVectorIngestionConfigurationChunkingConfigurationFixedSizeChunkingConfiguration] = ..., hierarchical_chunking_configuration: Optional[outputs.AgentDataSourceVectorIngestionConfigurationChunkingConfigurationHierarchicalChunkingConfiguration] = ..., semantic_chunking_configuration: Optional[outputs.AgentDataSourceVectorIngestionConfigurationChunkingConfigurationSemanticChunkingConfiguration] = ...) -> None:
...
class AgentDataSourceVectorIngestionConfigurationChunkingConfigurationFixedSizeChunkingConfiguration(dict):
    ...
    def __init__(__self__, *, max_tokens: _builtins.int, overlap_percentage: _builtins.int) -> None:
...
class AgentDataSourceVectorIngestionConfigurationChunkingConfigurationHierarchicalChunkingConfiguration(dict):
    ...
    def __init__(__self__, *, overlap_tokens: _builtins.int, level_configurations: Optional[Sequence[outputs.AgentDataSourceVectorIngestionConfigurationChunkingConfigurationHierarchicalChunkingConfigurationLevelConfiguration]] = ...) -> None:
...
class AgentDataSourceVectorIngestionConfigurationChunkingConfigurationSemanticChunkingConfiguration(dict):
    ...
    def __init__(__self__, *, breakpoint_percentile_threshold: _builtins.int, buffer_size: _builtins.int, max_token: _builtins.int) -> None:
...
class AgentDataSourceVectorIngestionConfigurationCustomTransformationConfiguration(dict):
    ...
    def __init__(__self__, *, intermediate_storage: Optional[outputs.AgentDataSourceVectorIngestionConfigurationCustomTransformationConfigurationIntermediateStorage] = ..., transformation: Optional[outputs.AgentDataSourceVectorIngestionConfigurationCustomTransformationConfigurationTransformation] = ...) -> None:
...
class AgentDataSourceVectorIngestionConfigurationCustomTransformationConfigurationIntermediateStorage(dict):
    ...
    def __init__(__self__, *, s3_location: Optional[outputs.AgentDataSourceVectorIngestionConfigurationCustomTransformationConfigurationIntermediateStorageS3Location] = ...) -> None:
...
class AgentDataSourceVectorIngestionConfigurationCustomTransformationConfigurationTransformation(dict):
    ...
    def __init__(__self__, *, step_to_apply: _builtins.str, transformation_function: Optional[outputs.AgentDataSourceVectorIngestionConfigurationCustomTransformationConfigurationTransformationTransformationFunction] = ...) -> None:
...
class AgentDataSourceVectorIngestionConfigurationCustomTransformationConfigurationTransformationTransformationFunction(dict):
    ...
    def __init__(__self__, *, transformation_lambda_configuration: Optional[outputs.AgentDataSourceVectorIngestionConfigurationCustomTransformationConfigurationTransformationTransformationFunctionTransformationLambdaConfiguration] = ...) -> None:
...
class AgentDataSourceVectorIngestionConfigurationParsingConfiguration(dict):
    ...
    def __init__(__self__, *, parsing_strategy: _builtins.str, bedrock_data_automation_configuration: Optional[outputs.AgentDataSourceVectorIngestionConfigurationParsingConfigurationBedrockDataAutomationConfiguration] = ..., bedrock_foundation_model_configuration: Optional[outputs.AgentDataSourceVectorIngestionConfigurationParsingConfigurationBedrockFoundationModelConfiguration] = ...) -> None:
...
class AgentDataSourceVectorIngestionConfigurationParsingConfigurationBedrockDataAutomationConfiguration(dict):
    ...
    def __init__(__self__, *, parsing_modality: Optional[_builtins.str] = ...) -> None:
...
class AgentDataSourceVectorIngestionConfigurationParsingConfigurationBedrockFoundationModelConfiguration(dict):
    ...
    def __init__(__self__, *, model_arn: _builtins.str, parsing_modality: Optional[_builtins.str] = ..., parsing_prompt: Optional[outputs.AgentDataSourceVectorIngestionConfigurationParsingConfigurationBedrockFoundationModelConfigurationParsingPrompt] = ...) -> None:
...
class AgentFlowDefinition(dict):
    def __init__(__self__, *, connections: Optional[Sequence[outputs.AgentFlowDefinitionConnection]] = ..., nodes: Optional[Sequence[outputs.AgentFlowDefinitionNode]] = ...) -> None:
...
class AgentFlowDefinitionConnection(dict):
    def __init__(__self__, *, name: _builtins.str, source: _builtins.str, target: _builtins.str, type: _builtins.str, configuration: Optional[outputs.AgentFlowDefinitionConnectionConfiguration] = ...) -> None:
...
class AgentFlowDefinitionConnectionConfiguration(dict):
    def __init__(__self__, *, conditional: Optional[outputs.AgentFlowDefinitionConnectionConfigurationConditional] = ..., data: Optional[outputs.AgentFlowDefinitionConnectionConfigurationData] = ...) -> None:
...
class AgentFlowDefinitionConnectionConfigurationData(dict):
    ...
    def __init__(__self__, *, source_output: _builtins.str, target_input: _builtins.str) -> None:
...
class AgentFlowDefinitionNode(dict):
    def __init__(__self__, *, name: _builtins.str, type: _builtins.str, configuration: Optional[outputs.AgentFlowDefinitionNodeConfiguration] = ..., inputs: Optional[Sequence[outputs.AgentFlowDefinitionNodeInput]] = ..., outputs: Optional[Sequence[outputs.AgentFlowDefinitionNodeOutput]] = ...) -> None:
...
class AgentFlowDefinitionNodeConfiguration(dict):
    ...
    def __init__(__self__, *, agent: Optional[outputs.AgentFlowDefinitionNodeConfigurationAgent] = ..., collector: Optional[outputs.AgentFlowDefinitionNodeConfigurationCollector] = ..., condition: Optional[outputs.AgentFlowDefinitionNodeConfigurationCondition] = ..., inline_code: Optional[outputs.AgentFlowDefinitionNodeConfigurationInlineCode] = ..., input: Optional[outputs.AgentFlowDefinitionNodeConfigurationInput] = ..., iterator: Optional[outputs.AgentFlowDefinitionNodeConfigurationIterator] = ..., knowledge_base: Optional[outputs.AgentFlowDefinitionNodeConfigurationKnowledgeBase] = ..., lambda_function: Optional[outputs.AgentFlowDefinitionNodeConfigurationLambdaFunction] = ..., lex: Optional[outputs.AgentFlowDefinitionNodeConfigurationLex] = ..., output: Optional[outputs.AgentFlowDefinitionNodeConfigurationOutput] = ..., prompt: Optional[outputs.AgentFlowDefinitionNodeConfigurationPrompt] = ..., retrieval: Optional[outputs.AgentFlowDefinitionNodeConfigurationRetrieval] = ..., storage: Optional[outputs.AgentFlowDefinitionNodeConfigurationStorage] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationCondition(dict):
    def __init__(__self__, *, conditions: Optional[Sequence[outputs.AgentFlowDefinitionNodeConfigurationConditionCondition]] = ...) -> None:
        ...
...
class AgentFlowDefinitionNodeConfigurationConditionCondition(dict):
    def __init__(__self__, *, name: _builtins.str, expression: Optional[_builtins.str] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationKnowledgeBase(dict):
    ...
    def __init__(__self__, *, knowledge_base_id: _builtins.str, model_id: _builtins.str, guardrail_configuration: Optional[outputs.AgentFlowDefinitionNodeConfigurationKnowledgeBaseGuardrailConfiguration] = ..., inference_configuration: Optional[outputs.AgentFlowDefinitionNodeConfigurationKnowledgeBaseInferenceConfiguration] = ..., number_of_results: Optional[_builtins.int] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationKnowledgeBaseInferenceConfiguration(dict):
    def __init__(__self__, *, text: Optional[outputs.AgentFlowDefinitionNodeConfigurationKnowledgeBaseInferenceConfigurationText] = ...) -> None:
        ...
...
class AgentFlowDefinitionNodeConfigurationKnowledgeBaseInferenceConfigurationText(dict):
    ...
    def __init__(__self__, *, max_tokens: Optional[_builtins.int] = ..., stop_sequences: Optional[Sequence[_builtins.str]] = ..., temperature: Optional[_builtins.float] = ..., top_p: Optional[_builtins.float] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationLex(dict):
    ...
    def __init__(__self__, *, bot_alias_arn: _builtins.str, locale_id: _builtins.str) -> None:
...
class AgentFlowDefinitionNodeConfigurationPrompt(dict):
    ...
    def __init__(__self__, *, guardrail_configuration: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptGuardrailConfiguration] = ..., source_configuration: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfiguration] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfiguration(dict):
    def __init__(__self__, *, inline: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInline] = ..., resource: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationResource] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInline(dict):
    ...
    def __init__(__self__, *, model_id: _builtins.str, template_type: _builtins.str, additional_model_request_fields: Optional[_builtins.str] = ..., inference_configuration: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineInferenceConfiguration] = ..., template_configuration: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfiguration] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineInferenceConfiguration(dict):
    def __init__(__self__, *, text: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineInferenceConfigurationText] = ...) -> None:
        ...
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfiguration(dict):
    def __init__(__self__, *, chat: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChat] = ..., text: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationText] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChat(dict):
    ...
    def __init__(__self__, *, messages: Sequence[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatMessage], input_variables: Optional[Sequence[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatInputVariable]] = ..., systems: Optional[Sequence[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatSystem]] = ..., tool_configuration: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfiguration] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatMessage(dict):
    def __init__(__self__, *, role: _builtins.str, content: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatMessageContent] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatMessageContent(dict):
    ...
    def __init__(__self__, *, cache_point: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatMessageContentCachePoint] = ..., text: Optional[_builtins.str] = ...) -> None:
        ...
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatSystem(dict):
    ...
    def __init__(__self__, *, cache_point: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatSystemCachePoint] = ..., text: Optional[_builtins.str] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfiguration(dict):
    ...
    def __init__(__self__, *, tool_choice: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationToolChoice] = ..., tools: Optional[Sequence[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationTool]] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationTool(dict):
    ...
    def __init__(__self__, *, cache_point: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationToolCachePoint] = ..., tool_spec: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationToolToolSpec] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationToolChoice(dict):
    def __init__(__self__, *, any: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationToolChoiceAny] = ..., auto: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationToolChoiceAuto] = ..., tool: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationToolChoiceTool] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationToolToolSpec(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, description: Optional[_builtins.str] = ..., input_schema: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationChatToolConfigurationToolToolSpecInputSchema] = ...) -> None:
...
class AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationText(dict):
    ...
    def __init__(__self__, *, text: _builtins.str, cache_point: Optional[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationTextCachePoint] = ..., input_variables: Optional[Sequence[outputs.AgentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationTextInputVariable]] = ...) -> None:
        ...
...
class AgentFlowDefinitionNodeConfigurationRetrieval(dict):
    ...
    def __init__(__self__, *, service_configuration: Optional[outputs.AgentFlowDefinitionNodeConfigurationRetrievalServiceConfiguration] = ...) -> None:
        ...
...
class AgentFlowDefinitionNodeConfigurationRetrievalServiceConfiguration(dict):
    def __init__(__self__, *, s3: Optional[outputs.AgentFlowDefinitionNodeConfigurationRetrievalServiceConfigurationS3] = ...) -> None:
        ...
...
class AgentFlowDefinitionNodeConfigurationStorage(dict):
    ...
    def __init__(__self__, *, service_configuration: Optional[outputs.AgentFlowDefinitionNodeConfigurationStorageServiceConfiguration] = ...) -> None:
        ...
...
class AgentFlowDefinitionNodeConfigurationStorageServiceConfiguration(dict):
    def __init__(__self__, *, s3: Optional[outputs.AgentFlowDefinitionNodeConfigurationStorageServiceConfigurationS3] = ...) -> None:
        ...
...
class AgentFlowDefinitionNodeInput(dict):
    def __init__(__self__, *, expression: _builtins.str, name: _builtins.str, type: _builtins.str, category: Optional[_builtins.str] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, kendra_knowledge_base_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationKendraKnowledgeBaseConfiguration] = ..., sql_knowledge_base_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfiguration] = ..., vector_knowledge_base_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfiguration] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, redshift_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfiguration] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfiguration(dict):
    ...
    def __init__(__self__, *, query_engine_configuration: outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryEngineConfiguration, storage_configuration: outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationStorageConfiguration, query_generation_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfiguration] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryEngineConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, provisioned_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryEngineConfigurationProvisionedConfiguration] = ..., serverless_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryEngineConfigurationServerlessConfiguration] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryEngineConfigurationProvisionedConfiguration(dict):
    ...
    def __init__(__self__, *, auth_configuration: outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryEngineConfigurationProvisionedConfigurationAuthConfiguration, cluster_identifier: _builtins.str) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryEngineConfigurationProvisionedConfigurationAuthConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, database_user: Optional[_builtins.str] = ..., username_password_secret_arn: Optional[_builtins.str] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryEngineConfigurationServerlessConfiguration(dict):
    ...
    def __init__(__self__, *, auth_configuration: outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryEngineConfigurationServerlessConfigurationAuthConfiguration, workgroup_arn: _builtins.str) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryEngineConfigurationServerlessConfigurationAuthConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, username_password_secret_arn: Optional[_builtins.str] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfiguration(dict):
    ...
    def __init__(__self__, *, execution_timeout_seconds: Optional[_builtins.int] = ..., generation_context: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfigurationGenerationContext] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfigurationGenerationContext(dict):
    ...
    def __init__(__self__, *, curated_queries: Optional[Sequence[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfigurationGenerationContextCuratedQuery]] = ..., tables: Optional[Sequence[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfigurationGenerationContextTable]] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfigurationGenerationContextCuratedQuery(dict):
    ...
    def __init__(__self__, *, natural_language: _builtins.str, sql: _builtins.str) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfigurationGenerationContextTable(dict):
    def __init__(__self__, *, name: _builtins.str, columns: Optional[Sequence[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfigurationGenerationContextTableColumn]] = ..., description: Optional[_builtins.str] = ..., inclusion: Optional[_builtins.str] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationQueryGenerationConfigurationGenerationContextTableColumn(dict):
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., inclusion: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationStorageConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, aws_data_catalog_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationStorageConfigurationAwsDataCatalogConfiguration] = ..., redshift_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationSqlKnowledgeBaseConfigurationRedshiftConfigurationStorageConfigurationRedshiftConfiguration] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfiguration(dict):
    ...
    def __init__(__self__, *, embedding_model_arn: _builtins.str, embedding_model_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationEmbeddingModelConfiguration] = ..., supplemental_data_storage_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationSupplementalDataStorageConfiguration] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationEmbeddingModelConfiguration(dict):
    ...
    def __init__(__self__, *, bedrock_embedding_model_configuration: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationEmbeddingModelConfigurationBedrockEmbeddingModelConfiguration] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationEmbeddingModelConfigurationBedrockEmbeddingModelConfiguration(dict):
    ...
    def __init__(__self__, *, dimensions: Optional[_builtins.int] = ..., embedding_data_type: Optional[_builtins.str] = ...) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationSupplementalDataStorageConfiguration(dict):
    ...
    def __init__(__self__, *, storage_locations: Sequence[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationSupplementalDataStorageConfigurationStorageLocation]) -> None:
...
class AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationSupplementalDataStorageConfigurationStorageLocation(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, s3_location: Optional[outputs.AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationSupplementalDataStorageConfigurationStorageLocationS3Location] = ...) -> None:
...
class AgentKnowledgeBaseStorageConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, mongo_db_atlas_configuration: Optional[outputs.AgentKnowledgeBaseStorageConfigurationMongoDbAtlasConfiguration] = ..., neptune_analytics_configuration: Optional[outputs.AgentKnowledgeBaseStorageConfigurationNeptuneAnalyticsConfiguration] = ..., opensearch_managed_cluster_configuration: Optional[outputs.AgentKnowledgeBaseStorageConfigurationOpensearchManagedClusterConfiguration] = ..., opensearch_serverless_configuration: Optional[outputs.AgentKnowledgeBaseStorageConfigurationOpensearchServerlessConfiguration] = ..., pinecone_configuration: Optional[outputs.AgentKnowledgeBaseStorageConfigurationPineconeConfiguration] = ..., rds_configuration: Optional[outputs.AgentKnowledgeBaseStorageConfigurationRdsConfiguration] = ..., redis_enterprise_cloud_configuration: Optional[outputs.AgentKnowledgeBaseStorageConfigurationRedisEnterpriseCloudConfiguration] = ..., s3_vectors_configuration: Optional[outputs.AgentKnowledgeBaseStorageConfigurationS3VectorsConfiguration] = ...) -> None:
...
class AgentKnowledgeBaseStorageConfigurationMongoDbAtlasConfiguration(dict):
    ...
    def __init__(__self__, *, collection_name: _builtins.str, credentials_secret_arn: _builtins.str, database_name: _builtins.str, endpoint: _builtins.str, field_mapping: outputs.AgentKnowledgeBaseStorageConfigurationMongoDbAtlasConfigurationFieldMapping, vector_index_name: _builtins.str, endpoint_service_name: Optional[_builtins.str] = ..., text_index_name: Optional[_builtins.str] = ...) -> None:
...
class AgentKnowledgeBaseStorageConfigurationMongoDbAtlasConfigurationFieldMapping(dict):
    ...
    def __init__(__self__, *, metadata_field: _builtins.str, text_field: _builtins.str, vector_field: _builtins.str) -> None:
...
class AgentKnowledgeBaseStorageConfigurationNeptuneAnalyticsConfiguration(dict):
    ...
    def __init__(__self__, *, field_mapping: outputs.AgentKnowledgeBaseStorageConfigurationNeptuneAnalyticsConfigurationFieldMapping, graph_arn: _builtins.str) -> None:
...
class AgentKnowledgeBaseStorageConfigurationNeptuneAnalyticsConfigurationFieldMapping(dict):
    ...
    def __init__(__self__, *, metadata_field: _builtins.str, text_field: _builtins.str) -> None:
...
class AgentKnowledgeBaseStorageConfigurationOpensearchManagedClusterConfiguration(dict):
    ...
    def __init__(__self__, *, domain_arn: _builtins.str, domain_endpoint: _builtins.str, field_mapping: outputs.AgentKnowledgeBaseStorageConfigurationOpensearchManagedClusterConfigurationFieldMapping, vector_index_name: _builtins.str) -> None:
...
class AgentKnowledgeBaseStorageConfigurationOpensearchServerlessConfiguration(dict):
    ...
    def __init__(__self__, *, collection_arn: _builtins.str, field_mapping: outputs.AgentKnowledgeBaseStorageConfigurationOpensearchServerlessConfigurationFieldMapping, vector_index_name: _builtins.str) -> None:
...
class AgentKnowledgeBaseStorageConfigurationPineconeConfiguration(dict):
    ...
    def __init__(__self__, *, connection_string: _builtins.str, credentials_secret_arn: _builtins.str, field_mapping: outputs.AgentKnowledgeBaseStorageConfigurationPineconeConfigurationFieldMapping, namespace: Optional[_builtins.str] = ...) -> None:
...
class AgentKnowledgeBaseStorageConfigurationRdsConfiguration(dict):
    ...
    def __init__(__self__, *, credentials_secret_arn: _builtins.str, database_name: _builtins.str, field_mapping: outputs.AgentKnowledgeBaseStorageConfigurationRdsConfigurationFieldMapping, resource_arn: _builtins.str, table_name: _builtins.str) -> None:
...
class AgentKnowledgeBaseStorageConfigurationRdsConfigurationFieldMapping(dict):
    ...
    def __init__(__self__, *, metadata_field: _builtins.str, primary_key_field: _builtins.str, text_field: _builtins.str, vector_field: _builtins.str, custom_metadata_field: Optional[_builtins.str] = ...) -> None:
...
class AgentKnowledgeBaseStorageConfigurationRedisEnterpriseCloudConfiguration(dict):
    ...
    def __init__(__self__, *, credentials_secret_arn: _builtins.str, endpoint: _builtins.str, field_mapping: outputs.AgentKnowledgeBaseStorageConfigurationRedisEnterpriseCloudConfigurationFieldMapping, vector_index_name: _builtins.str) -> None:
...
class AgentKnowledgeBaseStorageConfigurationRedisEnterpriseCloudConfigurationFieldMapping(dict):
    ...
    def __init__(__self__, *, metadata_field: Optional[_builtins.str] = ..., text_field: Optional[_builtins.str] = ..., vector_field: Optional[_builtins.str] = ...) -> None:
...
class AgentKnowledgeBaseStorageConfigurationS3VectorsConfiguration(dict):
    ...
    def __init__(__self__, *, index_arn: Optional[_builtins.str] = ..., index_name: Optional[_builtins.str] = ..., vector_bucket_arn: Optional[_builtins.str] = ...) -> None:
...
class AgentPromptVariant(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, template_type: _builtins.str, additional_model_request_fields: Optional[_builtins.str] = ..., gen_ai_resource: Optional[outputs.AgentPromptVariantGenAiResource] = ..., inference_configuration: Optional[outputs.AgentPromptVariantInferenceConfiguration] = ..., metadatas: Optional[Sequence[outputs.AgentPromptVariantMetadata]] = ..., model_id: Optional[_builtins.str] = ..., template_configuration: Optional[outputs.AgentPromptVariantTemplateConfiguration] = ...) -> None:
...
class AgentPromptVariantGenAiResource(dict):
    def __init__(__self__, *, agent: Optional[outputs.AgentPromptVariantGenAiResourceAgent] = ...) -> None:
...
class AgentPromptVariantInferenceConfiguration(dict):
    def __init__(__self__, *, text: Optional[outputs.AgentPromptVariantInferenceConfigurationText] = ...) -> None:
...
class AgentPromptVariantTemplateConfiguration(dict):
    def __init__(__self__, *, chat: Optional[outputs.AgentPromptVariantTemplateConfigurationChat] = ..., text: Optional[outputs.AgentPromptVariantTemplateConfigurationText] = ...) -> None:
...
class AgentPromptVariantTemplateConfigurationChat(dict):
    ...
    def __init__(__self__, *, messages: Sequence[outputs.AgentPromptVariantTemplateConfigurationChatMessage], input_variables: Optional[Sequence[outputs.AgentPromptVariantTemplateConfigurationChatInputVariable]] = ..., systems: Optional[Sequence[outputs.AgentPromptVariantTemplateConfigurationChatSystem]] = ..., tool_configuration: Optional[outputs.AgentPromptVariantTemplateConfigurationChatToolConfiguration] = ...) -> None:
...
class AgentPromptVariantTemplateConfigurationChatMessage(dict):
    def __init__(__self__, *, role: _builtins.str, content: Optional[outputs.AgentPromptVariantTemplateConfigurationChatMessageContent] = ...) -> None:
...
class AgentPromptVariantTemplateConfigurationChatMessageContent(dict):
    ...
    def __init__(__self__, *, cache_point: Optional[outputs.AgentPromptVariantTemplateConfigurationChatMessageContentCachePoint] = ..., text: Optional[_builtins.str] = ...) -> None:
        ...
...
class AgentPromptVariantTemplateConfigurationChatSystem(dict):
    ...
    def __init__(__self__, *, cache_point: Optional[outputs.AgentPromptVariantTemplateConfigurationChatSystemCachePoint] = ..., text: Optional[_builtins.str] = ...) -> None:
...
class AgentPromptVariantTemplateConfigurationChatToolConfiguration(dict):
    ...
    def __init__(__self__, *, tool_choice: Optional[outputs.AgentPromptVariantTemplateConfigurationChatToolConfigurationToolChoice] = ..., tools: Optional[Sequence[outputs.AgentPromptVariantTemplateConfigurationChatToolConfigurationTool]] = ...) -> None:
...
class AgentPromptVariantTemplateConfigurationChatToolConfigurationTool(dict):
    ...
    def __init__(__self__, *, cache_point: Optional[outputs.AgentPromptVariantTemplateConfigurationChatToolConfigurationToolCachePoint] = ..., tool_spec: Optional[outputs.AgentPromptVariantTemplateConfigurationChatToolConfigurationToolToolSpec] = ...) -> None:
...
class AgentPromptVariantTemplateConfigurationChatToolConfigurationToolChoice(dict):
    def __init__(__self__, *, any: Optional[outputs.AgentPromptVariantTemplateConfigurationChatToolConfigurationToolChoiceAny] = ..., auto: Optional[outputs.AgentPromptVariantTemplateConfigurationChatToolConfigurationToolChoiceAuto] = ..., tool: Optional[outputs.AgentPromptVariantTemplateConfigurationChatToolConfigurationToolChoiceTool] = ...) -> None:
...
class AgentPromptVariantTemplateConfigurationChatToolConfigurationToolToolSpec(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, description: Optional[_builtins.str] = ..., input_schema: Optional[outputs.AgentPromptVariantTemplateConfigurationChatToolConfigurationToolToolSpecInputSchema] = ...) -> None:
...
class AgentPromptVariantTemplateConfigurationText(dict):
    ...
    def __init__(__self__, *, text: _builtins.str, cache_point: Optional[outputs.AgentPromptVariantTemplateConfigurationTextCachePoint] = ..., input_variables: Optional[Sequence[outputs.AgentPromptVariantTemplateConfigurationTextInputVariable]] = ...) -> None:
        ...
...
class AgentcoreAgentRuntimeAgentRuntimeArtifact(dict):
    ...
    def __init__(__self__, *, code_configuration: Optional[outputs.AgentcoreAgentRuntimeAgentRuntimeArtifactCodeConfiguration] = ..., container_configuration: Optional[outputs.AgentcoreAgentRuntimeAgentRuntimeArtifactContainerConfiguration] = ...) -> None:
...
class AgentcoreAgentRuntimeAgentRuntimeArtifactCodeConfiguration(dict):
    ...
    def __init__(__self__, *, entry_points: Sequence[_builtins.str], runtime: _builtins.str, code: Optional[outputs.AgentcoreAgentRuntimeAgentRuntimeArtifactCodeConfigurationCode] = ...) -> None:
...
class AgentcoreAgentRuntimeAgentRuntimeArtifactCodeConfigurationCode(dict):
    def __init__(__self__, *, s3: Optional[outputs.AgentcoreAgentRuntimeAgentRuntimeArtifactCodeConfigurationCodeS3] = ...) -> None:
...
class AgentcoreAgentRuntimeAgentRuntimeArtifactCodeConfigurationCodeS3(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, prefix: _builtins.str, version_id: Optional[_builtins.str] = ...) -> None:
...
class AgentcoreAgentRuntimeAuthorizerConfiguration(dict):
    ...
    def __init__(__self__, *, custom_jwt_authorizer: Optional[outputs.AgentcoreAgentRuntimeAuthorizerConfigurationCustomJwtAuthorizer] = ...) -> None:
...
class AgentcoreAgentRuntimeAuthorizerConfigurationCustomJwtAuthorizer(dict):
    ...
    def __init__(__self__, *, discovery_url: _builtins.str, allowed_audiences: Optional[Sequence[_builtins.str]] = ..., allowed_clients: Optional[Sequence[_builtins.str]] = ..., allowed_scopes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AgentcoreAgentRuntimeLifecycleConfiguration(dict):
    ...
    def __init__(__self__, *, idle_runtime_session_timeout: _builtins.int, max_lifetime: _builtins.int) -> None:
...
class AgentcoreAgentRuntimeNetworkConfiguration(dict):
    ...
    def __init__(__self__, *, network_mode: _builtins.str, network_mode_config: Optional[outputs.AgentcoreAgentRuntimeNetworkConfigurationNetworkModeConfig] = ...) -> None:
...
class AgentcoreAgentRuntimeProtocolConfiguration(dict):
    ...
    def __init__(__self__, *, server_protocol: Optional[_builtins.str] = ...) -> None:
...
class AgentcoreAgentRuntimeRequestHeaderConfiguration(dict):
    ...
    def __init__(__self__, *, request_header_allowlists: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AgentcoreBrowserNetworkConfiguration(dict):
    ...
    def __init__(__self__, *, network_mode: _builtins.str, vpc_config: Optional[outputs.AgentcoreBrowserNetworkConfigurationVpcConfig] = ...) -> None:
...
class AgentcoreBrowserRecording(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., s3_location: Optional[outputs.AgentcoreBrowserRecordingS3Location] = ...) -> None:
...
class AgentcoreCodeInterpreterNetworkConfiguration(dict):
    ...
    def __init__(__self__, *, network_mode: _builtins.str, vpc_config: Optional[outputs.AgentcoreCodeInterpreterNetworkConfigurationVpcConfig] = ...) -> None:
...
class AgentcoreGatewayAuthorizerConfiguration(dict):
    ...
    def __init__(__self__, *, custom_jwt_authorizer: Optional[outputs.AgentcoreGatewayAuthorizerConfigurationCustomJwtAuthorizer] = ...) -> None:
...
class AgentcoreGatewayAuthorizerConfigurationCustomJwtAuthorizer(dict):
    ...
    def __init__(__self__, *, allowed_scopes: Sequence[_builtins.str], discovery_url: _builtins.str, allowed_audiences: Optional[Sequence[_builtins.str]] = ..., allowed_clients: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AgentcoreGatewayInterceptorConfiguration(dict):
    ...
    def __init__(__self__, *, interception_points: Sequence[_builtins.str], input_configuration: Optional[outputs.AgentcoreGatewayInterceptorConfigurationInputConfiguration] = ..., interceptor: Optional[outputs.AgentcoreGatewayInterceptorConfigurationInterceptor] = ...) -> None:
...
class AgentcoreGatewayInterceptorConfigurationInterceptor(dict):
    ...
    def __init__(__self__, *, lambda_: Optional[outputs.AgentcoreGatewayInterceptorConfigurationInterceptorLambda] = ...) -> None:
...
class AgentcoreGatewayProtocolConfiguration(dict):
    def __init__(__self__, *, mcp: Optional[outputs.AgentcoreGatewayProtocolConfigurationMcp] = ...) -> None:
...
class AgentcoreGatewayProtocolConfigurationMcp(dict):
    ...
    def __init__(__self__, *, instructions: Optional[_builtins.str] = ..., search_type: Optional[_builtins.str] = ..., supported_versions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AgentcoreGatewayTargetCredentialProviderConfiguration(dict):
    ...
    def __init__(__self__, *, api_key: Optional[outputs.AgentcoreGatewayTargetCredentialProviderConfigurationApiKey] = ..., gateway_iam_role: Optional[outputs.AgentcoreGatewayTargetCredentialProviderConfigurationGatewayIamRole] = ..., oauth: Optional[outputs.AgentcoreGatewayTargetCredentialProviderConfigurationOauth] = ...) -> None:
...
class AgentcoreGatewayTargetCredentialProviderConfigurationApiKey(dict):
    ...
    def __init__(__self__, *, provider_arn: _builtins.str, credential_location: Optional[_builtins.str] = ..., credential_parameter_name: Optional[_builtins.str] = ..., credential_prefix: Optional[_builtins.str] = ...) -> None:
...
class AgentcoreGatewayTargetCredentialProviderConfigurationOauth(dict):
    ...
    def __init__(__self__, *, provider_arn: _builtins.str, scopes: Sequence[_builtins.str], custom_parameters: Optional[Mapping[str, _builtins.str]] = ..., default_return_url: Optional[_builtins.str] = ..., grant_type: Optional[_builtins.str] = ...) -> None:
...
class AgentcoreGatewayTargetMetadataConfiguration(dict):
    ...
    def __init__(__self__, *, allowed_query_parameters: Optional[Sequence[_builtins.str]] = ..., allowed_request_headers: Optional[Sequence[_builtins.str]] = ..., allowed_response_headers: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfiguration(dict):
    def __init__(__self__, *, mcp: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcp] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcp(dict):
    ...
    def __init__(__self__, *, lambda_: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambda] = ..., mcp_server: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpMcpServer] = ..., open_api_schema: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpOpenApiSchema] = ..., smithy_model: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpSmithyModel] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambda(dict):
    ...
    def __init__(__self__, *, lambda_arn: _builtins.str, tool_schema: outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchema) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchema(dict):
    ...
    def __init__(__self__, *, inline_payloads: Optional[Sequence[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayload]] = ..., s3: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaS3] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayload(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, input_schema: outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchema, name: _builtins.str, output_schema: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchema] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchema(dict):
    def __init__(__self__, *, type: _builtins.str, description: Optional[_builtins.str] = ..., items: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchemaItems] = ..., properties: Optional[Sequence[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchemaProperty]] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchemaItemsItems(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, description: Optional[_builtins.str] = ..., items_json: Optional[_builtins.str] = ..., properties_json: Optional[_builtins.str] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchemaItemsProperty(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, type: _builtins.str, description: Optional[_builtins.str] = ..., items_json: Optional[_builtins.str] = ..., properties_json: Optional[_builtins.str] = ..., required: Optional[_builtins.bool] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchemaProperty(dict):
    def __init__(__self__, *, name: _builtins.str, type: _builtins.str, description: Optional[_builtins.str] = ..., items: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchemaPropertyItems] = ..., properties: Optional[Sequence[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchemaPropertyProperty]] = ..., required: Optional[_builtins.bool] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchemaPropertyItems(dict):
    def __init__(__self__, *, type: _builtins.str, description: Optional[_builtins.str] = ..., items: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchemaPropertyItemsItems] = ..., properties: Optional[Sequence[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchemaPropertyItemsProperty]] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchema(dict):
    def __init__(__self__, *, type: _builtins.str, description: Optional[_builtins.str] = ..., items: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchemaItems] = ..., properties: Optional[Sequence[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchemaProperty]] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchemaItems(dict):
    def __init__(__self__, *, type: _builtins.str, description: Optional[_builtins.str] = ..., items: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchemaItemsItems] = ..., properties: Optional[Sequence[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchemaItemsProperty]] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchemaProperty(dict):
    def __init__(__self__, *, name: _builtins.str, type: _builtins.str, description: Optional[_builtins.str] = ..., items: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchemaPropertyItems] = ..., properties: Optional[Sequence[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchemaPropertyProperty]] = ..., required: Optional[_builtins.bool] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchemaPropertyItems(dict):
    def __init__(__self__, *, type: _builtins.str, description: Optional[_builtins.str] = ..., items: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchemaPropertyItemsItems] = ..., properties: Optional[Sequence[outputs.AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchemaPropertyItemsProperty]] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaS3(dict):
    ...
    def __init__(__self__, *, bucket_owner_account_id: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class AgentcoreGatewayTargetTargetConfigurationMcpOpenApiSchema(dict):
    ...
    def __init__(__self__, *, inline_payload: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpOpenApiSchemaInlinePayload] = ..., s3: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpOpenApiSchemaS3] = ...) -> None:
        ...
...
class AgentcoreGatewayTargetTargetConfigurationMcpSmithyModel(dict):
    ...
    def __init__(__self__, *, inline_payload: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpSmithyModelInlinePayload] = ..., s3: Optional[outputs.AgentcoreGatewayTargetTargetConfigurationMcpSmithyModelS3] = ...) -> None:
        ...
...
class AgentcoreMemoryStrategyConfiguration(dict):
    def __init__(__self__, *, type: _builtins.str, consolidation: Optional[outputs.AgentcoreMemoryStrategyConfigurationConsolidation] = ..., extraction: Optional[outputs.AgentcoreMemoryStrategyConfigurationExtraction] = ...) -> None:
...
class AgentcoreMemoryStrategyConfigurationConsolidation(dict):
    ...
    def __init__(__self__, *, append_to_prompt: _builtins.str, model_id: _builtins.str) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfig(dict):
    ...
    def __init__(__self__, *, custom_oauth2_provider_config: Optional[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigCustomOauth2ProviderConfig] = ..., github_oauth2_provider_config: Optional[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigGithubOauth2ProviderConfig] = ..., google_oauth2_provider_config: Optional[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigGoogleOauth2ProviderConfig] = ..., microsoft_oauth2_provider_config: Optional[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigMicrosoftOauth2ProviderConfig] = ..., salesforce_oauth2_provider_config: Optional[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfig] = ..., slack_oauth2_provider_config: Optional[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfig] = ...) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigCustomOauth2ProviderConfig(dict):
    ...
    def __init__(__self__, *, client_credentials_wo_version: Optional[_builtins.int] = ..., client_id: Optional[_builtins.str] = ..., client_id_wo: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., client_secret_wo: Optional[_builtins.str] = ..., oauth_discovery: Optional[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigCustomOauth2ProviderConfigOauthDiscovery] = ...) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigCustomOauth2ProviderConfigOauthDiscovery(dict):
    ...
    def __init__(__self__, *, authorization_server_metadata: Optional[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigCustomOauth2ProviderConfigOauthDiscoveryAuthorizationServerMetadata] = ..., discovery_url: Optional[_builtins.str] = ...) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigCustomOauth2ProviderConfigOauthDiscoveryAuthorizationServerMetadata(dict):
    ...
    def __init__(__self__, *, authorization_endpoint: _builtins.str, issuer: _builtins.str, token_endpoint: _builtins.str, response_types: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigGithubOauth2ProviderConfig(dict):
    ...
    def __init__(__self__, *, client_credentials_wo_version: Optional[_builtins.int] = ..., client_id: Optional[_builtins.str] = ..., client_id_wo: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., client_secret_wo: Optional[_builtins.str] = ..., oauth_discoveries: Optional[Sequence[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigGithubOauth2ProviderConfigOauthDiscovery]] = ...) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigGithubOauth2ProviderConfigOauthDiscovery(dict):
    ...
    def __init__(__self__, *, authorization_server_metadatas: Sequence[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigGithubOauth2ProviderConfigOauthDiscoveryAuthorizationServerMetadata], discovery_url: _builtins.str) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigGithubOauth2ProviderConfigOauthDiscoveryAuthorizationServerMetadata(dict):
    ...
    def __init__(__self__, *, authorization_endpoint: _builtins.str, issuer: _builtins.str, response_types: Sequence[_builtins.str], token_endpoint: _builtins.str) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigGoogleOauth2ProviderConfig(dict):
    ...
    def __init__(__self__, *, client_credentials_wo_version: Optional[_builtins.int] = ..., client_id: Optional[_builtins.str] = ..., client_id_wo: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., client_secret_wo: Optional[_builtins.str] = ..., oauth_discoveries: Optional[Sequence[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigGoogleOauth2ProviderConfigOauthDiscovery]] = ...) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigGoogleOauth2ProviderConfigOauthDiscovery(dict):
    ...
    def __init__(__self__, *, authorization_server_metadatas: Sequence[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigGoogleOauth2ProviderConfigOauthDiscoveryAuthorizationServerMetadata], discovery_url: _builtins.str) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigMicrosoftOauth2ProviderConfig(dict):
    ...
    def __init__(__self__, *, client_credentials_wo_version: Optional[_builtins.int] = ..., client_id: Optional[_builtins.str] = ..., client_id_wo: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., client_secret_wo: Optional[_builtins.str] = ..., oauth_discoveries: Optional[Sequence[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigMicrosoftOauth2ProviderConfigOauthDiscovery]] = ...) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigMicrosoftOauth2ProviderConfigOauthDiscovery(dict):
    ...
    def __init__(__self__, *, authorization_server_metadatas: Sequence[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigMicrosoftOauth2ProviderConfigOauthDiscoveryAuthorizationServerMetadata], discovery_url: _builtins.str) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfig(dict):
    ...
    def __init__(__self__, *, client_credentials_wo_version: Optional[_builtins.int] = ..., client_id: Optional[_builtins.str] = ..., client_id_wo: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., client_secret_wo: Optional[_builtins.str] = ..., oauth_discoveries: Optional[Sequence[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigOauthDiscovery]] = ...) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigOauthDiscovery(dict):
    ...
    def __init__(__self__, *, authorization_server_metadatas: Sequence[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigOauthDiscoveryAuthorizationServerMetadata], discovery_url: _builtins.str) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfig(dict):
    ...
    def __init__(__self__, *, client_credentials_wo_version: Optional[_builtins.int] = ..., client_id: Optional[_builtins.str] = ..., client_id_wo: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., client_secret_wo: Optional[_builtins.str] = ..., oauth_discoveries: Optional[Sequence[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfigOauthDiscovery]] = ...) -> None:
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfigOauthDiscovery(dict):
    ...
    def __init__(__self__, *, authorization_server_metadatas: Sequence[outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfigOauthDiscoveryAuthorizationServerMetadata], discovery_url: _builtins.str) -> None:
...
class AgentcoreTokenVaultCmkKmsConfiguration(dict):
    ...
    def __init__(__self__, *, key_type: _builtins.str, kms_key_arn: Optional[_builtins.str] = ...) -> None:
...
class CustomModelValidationDataConfig(dict):
    def __init__(__self__, *, validators: Sequence[outputs.CustomModelValidationDataConfigValidator]) -> None:
...
class CustomModelVpcConfig(dict):
    ...
    def __init__(__self__, *, security_group_ids: Sequence[_builtins.str], subnet_ids: Sequence[_builtins.str]) -> None:
...
class GuardrailContentPolicyConfig(dict):
    ...
    def __init__(__self__, *, filters_configs: Optional[Sequence[outputs.GuardrailContentPolicyConfigFiltersConfig]] = ..., tier_configs: Optional[Sequence[outputs.GuardrailContentPolicyConfigTierConfig]] = ...) -> None:
...
class GuardrailContentPolicyConfigFiltersConfig(dict):
    ...
    def __init__(__self__, *, input_strength: _builtins.str, output_strength: _builtins.str, type: _builtins.str, input_action: Optional[_builtins.str] = ..., input_enabled: Optional[_builtins.bool] = ..., input_modalities: Optional[Sequence[_builtins.str]] = ..., output_action: Optional[_builtins.str] = ..., output_enabled: Optional[_builtins.bool] = ..., output_modalities: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GuardrailContextualGroundingPolicyConfig(dict):
    ...
    def __init__(__self__, *, filters_configs: Optional[Sequence[outputs.GuardrailContextualGroundingPolicyConfigFiltersConfig]] = ...) -> None:
...
class GuardrailContextualGroundingPolicyConfigFiltersConfig(dict):
    def __init__(__self__, *, threshold: _builtins.float, type: _builtins.str) -> None:
...
class GuardrailSensitiveInformationPolicyConfig(dict):
    ...
    def __init__(__self__, *, pii_entities_configs: Optional[Sequence[outputs.GuardrailSensitiveInformationPolicyConfigPiiEntitiesConfig]] = ..., regexes_configs: Optional[Sequence[outputs.GuardrailSensitiveInformationPolicyConfigRegexesConfig]] = ...) -> None:
...
class GuardrailSensitiveInformationPolicyConfigPiiEntitiesConfig(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, type: _builtins.str, input_action: Optional[_builtins.str] = ..., input_enabled: Optional[_builtins.bool] = ..., output_action: Optional[_builtins.str] = ..., output_enabled: Optional[_builtins.bool] = ...) -> None:
...
class GuardrailSensitiveInformationPolicyConfigRegexesConfig(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, name: _builtins.str, pattern: _builtins.str, description: Optional[_builtins.str] = ..., input_action: Optional[_builtins.str] = ..., input_enabled: Optional[_builtins.bool] = ..., output_action: Optional[_builtins.str] = ..., output_enabled: Optional[_builtins.bool] = ...) -> None:
...
class GuardrailTopicPolicyConfig(dict):
    ...
    def __init__(__self__, *, tier_configs: Optional[Sequence[outputs.GuardrailTopicPolicyConfigTierConfig]] = ..., topics_configs: Optional[Sequence[outputs.GuardrailTopicPolicyConfigTopicsConfig]] = ...) -> None:
...
class GuardrailTopicPolicyConfigTopicsConfig(dict):
    def __init__(__self__, *, definition: _builtins.str, name: _builtins.str, type: _builtins.str, examples: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GuardrailWordPolicyConfig(dict):
    ...
    def __init__(__self__, *, managed_word_lists_configs: Optional[Sequence[outputs.GuardrailWordPolicyConfigManagedWordListsConfig]] = ..., words_configs: Optional[Sequence[outputs.GuardrailWordPolicyConfigWordsConfig]] = ...) -> None:
...
class GuardrailWordPolicyConfigManagedWordListsConfig(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, input_action: Optional[_builtins.str] = ..., input_enabled: Optional[_builtins.bool] = ..., output_action: Optional[_builtins.str] = ..., output_enabled: Optional[_builtins.bool] = ...) -> None:
...
class GuardrailWordPolicyConfigWordsConfig(dict):
    ...
    def __init__(__self__, *, text: _builtins.str, input_action: Optional[_builtins.str] = ..., input_enabled: Optional[_builtins.bool] = ..., output_action: Optional[_builtins.str] = ..., output_enabled: Optional[_builtins.bool] = ...) -> None:
...
class GetAgentAgentVersionsAgentVersionSummaryResult(dict):
    def __init__(__self__, *, agent_name: _builtins.str, agent_status: _builtins.str, agent_version: _builtins.str, created_at: _builtins.str, description: _builtins.str, updated_at: _builtins.str, guardrail_configurations: Optional[Sequence[outputs.GetAgentAgentVersionsAgentVersionSummaryGuardrailConfigurationResult]] = ...) -> None:
...
class GetCustomModelValidationDataConfigResult(dict):
    def __init__(__self__, *, validators: Sequence[outputs.GetCustomModelValidationDataConfigValidatorResult]) -> None:
...
class GetCustomModelsModelSummaryResult(dict):
    def __init__(__self__, *, creation_time: _builtins.str, model_arn: _builtins.str, model_name: _builtins.str) -> None:
...
class GetInferenceProfilesInferenceProfileSummaryResult(dict):
    def __init__(__self__, *, created_at: _builtins.str, description: _builtins.str, inference_profile_arn: _builtins.str, inference_profile_id: _builtins.str, inference_profile_name: _builtins.str, models: Sequence[outputs.GetInferenceProfilesInferenceProfileSummaryModelResult], status: _builtins.str, type: _builtins.str, updated_at: _builtins.str) -> None:
