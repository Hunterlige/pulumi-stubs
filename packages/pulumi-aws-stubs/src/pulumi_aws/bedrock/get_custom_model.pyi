...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetCustomModelResult', 'AwaitableGetCustomModelResult', 'get_custom_model', 'get_custom_model_output']
@pulumi.output_type
class GetCustomModelResult:
    
    def __init__(__self__, base_model_arn=..., creation_time=..., hyperparameters=..., id=..., job_arn=..., job_name=..., job_tags=..., model_arn=..., model_id=..., model_kms_key_arn=..., model_name=..., model_tags=..., output_data_configs=..., region=..., training_data_configs=..., training_metrics=..., validation_data_configs=..., validation_metrics=...) -> None:
        ...
...
class AwaitableGetCustomModelResult(GetCustomModelResult):
    def __await__(self): # -> Generator[Never, Any, GetCustomModelResult]:
        ...
    


def get_custom_model(model_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetCustomModelResult:
    
    ...

def get_custom_model_output(model_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetCustomModelResult]:
