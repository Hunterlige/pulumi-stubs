...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationAutoStartConfigurationArgs', 'ApplicationAutoStartConfigurationArgsDict', 'ApplicationAutoStopConfigurationArgs', 'ApplicationAutoStopConfigurationArgsDict', 'ApplicationImageConfigurationArgs', 'ApplicationImageConfigurationArgsDict', 'ApplicationInitialCapacityArgs', 'ApplicationInitialCapacityArgsDict', ..., ..., ..., ..., 'ApplicationInteractiveConfigurationArgs', 'ApplicationInteractiveConfigurationArgsDict', 'ApplicationJobLevelCostAllocationConfigurationArgs', ..., 'ApplicationMaximumCapacityArgs', 'ApplicationMaximumCapacityArgsDict', 'ApplicationMonitoringConfigurationArgs', 'ApplicationMonitoringConfigurationArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ApplicationNetworkConfigurationArgs', 'ApplicationNetworkConfigurationArgsDict', 'ApplicationRuntimeConfigurationArgs', 'ApplicationRuntimeConfigurationArgsDict', 'ApplicationSchedulerConfigurationArgs', 'ApplicationSchedulerConfigurationArgsDict']
...
class ApplicationAutoStopConfigurationArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., idle_timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def idle_timeout_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ApplicationInitialCapacityArgs:
    def __init__(__self__, *, initial_capacity_type: pulumi.Input[_builtins.str], initial_capacity_config: Optional[pulumi.Input[ApplicationInitialCapacityInitialCapacityConfigArgs]] = ...) -> None:
    ...
    def initial_capacity_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def initial_capacity_config(self, value: Optional[pulumi.Input[ApplicationInitialCapacityInitialCapacityConfigArgs]]): # -> None:
        ...
...
class ApplicationInitialCapacityInitialCapacityConfigArgs:
    def __init__(__self__, *, worker_count: pulumi.Input[_builtins.int], worker_configuration: Optional[pulumi.Input[ApplicationInitialCapacityInitialCapacityConfigWorkerConfigurationArgs]] = ...) -> None:
    ...
    @worker_count.setter
    def worker_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def worker_configuration(self, value: Optional[pulumi.Input[ApplicationInitialCapacityInitialCapacityConfigWorkerConfigurationArgs]]): # -> None:
        ...
...
class ApplicationInitialCapacityInitialCapacityConfigWorkerConfigurationArgs:
    def __init__(__self__, *, cpu: pulumi.Input[_builtins.str], memory: pulumi.Input[_builtins.str], disk: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @cpu.setter
    def cpu(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @memory.setter
    def memory(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ApplicationInteractiveConfigurationArgs:
    def __init__(__self__, *, livy_endpoint_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., studio_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def livy_endpoint_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def studio_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ApplicationMonitoringConfigurationArgs:
    def __init__(__self__, *, cloudwatch_logging_configuration: Optional[pulumi.Input[ApplicationMonitoringConfigurationCloudwatchLoggingConfigurationArgs]] = ..., managed_persistence_monitoring_configuration: Optional[pulumi.Input[ApplicationMonitoringConfigurationManagedPersistenceMonitoringConfigurationArgs]] = ..., prometheus_monitoring_configuration: Optional[pulumi.Input[ApplicationMonitoringConfigurationPrometheusMonitoringConfigurationArgs]] = ..., s3_monitoring_configuration: Optional[pulumi.Input[ApplicationMonitoringConfigurationS3MonitoringConfigurationArgs]] = ...) -> None:
    ...
    def cloudwatch_logging_configuration(self, value: Optional[pulumi.Input[ApplicationMonitoringConfigurationCloudwatchLoggingConfigurationArgs]]): # -> None:
        ...
    ...
    def managed_persistence_monitoring_configuration(self, value: Optional[pulumi.Input[ApplicationMonitoringConfigurationManagedPersistenceMonitoringConfigurationArgs]]): # -> None:
        ...
    ...
    def prometheus_monitoring_configuration(self, value: Optional[pulumi.Input[ApplicationMonitoringConfigurationPrometheusMonitoringConfigurationArgs]]): # -> None:
        ...
    ...
    def s3_monitoring_configuration(self, value: Optional[pulumi.Input[ApplicationMonitoringConfigurationS3MonitoringConfigurationArgs]]): # -> None:
        ...
...
class ApplicationMonitoringConfigurationCloudwatchLoggingConfigurationArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], encryption_key_arn: Optional[pulumi.Input[_builtins.str]] = ..., log_group_name: Optional[pulumi.Input[_builtins.str]] = ..., log_stream_name_prefix: Optional[pulumi.Input[_builtins.str]] = ..., log_types: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationMonitoringConfigurationCloudwatchLoggingConfigurationLogTypeArgs]]]] = ...) -> None:
    ...
    @log_types.setter
    def log_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ApplicationMonitoringConfigurationCloudwatchLoggingConfigurationLogTypeArgs]]]]): # -> None:
        ...
...
class ApplicationMonitoringConfigurationManagedPersistenceMonitoringConfigurationArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., encryption_key_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ApplicationMonitoringConfigurationPrometheusMonitoringConfigurationArgs:
    def __init__(__self__, *, remote_write_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def remote_write_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApplicationMonitoringConfigurationS3MonitoringConfigurationArgs:
    def __init__(__self__, *, encryption_key_arn: Optional[pulumi.Input[_builtins.str]] = ..., log_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ApplicationNetworkConfigurationArgs:
    def __init__(__self__, *, security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ApplicationRuntimeConfigurationArgs:
    def __init__(__self__, *, classification: pulumi.Input[_builtins.str], properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ApplicationSchedulerConfigurationArgs:
    def __init__(__self__, *, max_concurrent_runs: Optional[pulumi.Input[_builtins.int]] = ..., queue_timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def queue_timeout_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
