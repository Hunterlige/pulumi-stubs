...
class _ServiceActionState:
    def __init__(
        ...
        *,
        accept_language: Optional[pulumi.Input[_builtins.str]] = ...,
        definition: Optional[pulumi.Input[ServiceActionDefinitionArgs]] = ...,
        description: Optional[pulumi.Input[_builtins.str]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
    ) -> None: ...
    ...
    @definition.setter
    def definition(
        self, value: Optional[pulumi.Input[ServiceActionDefinitionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def description(self) -> Optional[pulumi.Input[_builtins.str]]: ...
...
class ServiceAction(pulumi.CustomResource):
    ...
    def __init__(
        ...
        definition: Optional[
            pulumi.Input[
                Union[ServiceActionDefinitionArgs, ServiceActionDefinitionArgsDict]
            ]
        ] = ...,
        description: Optional[pulumi.Input[_builtins.str]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
