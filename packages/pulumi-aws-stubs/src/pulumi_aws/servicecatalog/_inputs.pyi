...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ProductProvisioningArtifactParametersArgs', 'ProductProvisioningArtifactParametersArgsDict', 'ProvisionedProductOutputArgs', 'ProvisionedProductOutputArgsDict', 'ProvisionedProductProvisioningParameterArgs', 'ProvisionedProductProvisioningParameterArgsDict', ..., ..., 'ServiceActionDefinitionArgs', 'ServiceActionDefinitionArgsDict']
...
class ProvisionedProductOutputArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., key: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ProvisionedProductProvisioningParameterArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], use_previous_value: Optional[pulumi.Input[_builtins.bool]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def use_previous_value(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ProvisionedProductStackSetProvisioningPreferencesArgs:
    def __init__(__self__, *, accounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., failure_tolerance_count: Optional[pulumi.Input[_builtins.int]] = ..., failure_tolerance_percentage: Optional[pulumi.Input[_builtins.int]] = ..., max_concurrency_count: Optional[pulumi.Input[_builtins.int]] = ..., max_concurrency_percentage: Optional[pulumi.Input[_builtins.int]] = ..., regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def max_concurrency_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_concurrency_percentage(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ServiceActionDefinitionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], version: pulumi.Input[_builtins.str], assume_role: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @assume_role.setter
    def assume_role(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
