...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['MapConfigurationArgs', 'MapConfigurationArgsDict', 'PlaceIndexDataSourceConfigurationArgs', 'PlaceIndexDataSourceConfigurationArgsDict']
...
class MapConfigurationArgs:
    ...
    @style.setter
    def style(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PlaceIndexDataSourceConfigurationArgs:
    def __init__(__self__, *, intended_use: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @intended_use.setter
    def intended_use(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
