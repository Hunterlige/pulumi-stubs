...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationAppConfigArgs', 'ApplicationAppConfigArgsDict', 'ApplicationDataSourceArgs', 'ApplicationDataSourceArgsDict', 'ApplicationIamIdentityCenterOptionsArgs', 'ApplicationIamIdentityCenterOptionsArgsDict', 'ApplicationTimeoutsArgs', 'ApplicationTimeoutsArgsDict', 'AuthorizeVpcEndpointAccessAuthorizedPrincipalArgs', ..., 'DomainAdvancedSecurityOptionsArgs', 'DomainAdvancedSecurityOptionsArgsDict', 'DomainAdvancedSecurityOptionsJwtOptionsArgs', 'DomainAdvancedSecurityOptionsJwtOptionsArgsDict', 'DomainAdvancedSecurityOptionsMasterUserOptionsArgs', ..., 'DomainAimlOptionsArgs', 'DomainAimlOptionsArgsDict', ..., ..., 'DomainAimlOptionsS3VectorsEngineArgs', 'DomainAimlOptionsS3VectorsEngineArgsDict', 'DomainAimlOptionsServerlessVectorAccelerationArgs', ..., 'DomainAutoTuneOptionsArgs', 'DomainAutoTuneOptionsArgsDict', 'DomainAutoTuneOptionsMaintenanceScheduleArgs', 'DomainAutoTuneOptionsMaintenanceScheduleArgsDict', ..., ..., 'DomainClusterConfigArgs', 'DomainClusterConfigArgsDict', 'DomainClusterConfigColdStorageOptionsArgs', 'DomainClusterConfigColdStorageOptionsArgsDict', 'DomainClusterConfigNodeOptionArgs', 'DomainClusterConfigNodeOptionArgsDict', 'DomainClusterConfigNodeOptionNodeConfigArgs', 'DomainClusterConfigNodeOptionNodeConfigArgsDict', 'DomainClusterConfigZoneAwarenessConfigArgs', 'DomainClusterConfigZoneAwarenessConfigArgsDict', 'DomainCognitoOptionsArgs', 'DomainCognitoOptionsArgsDict', 'DomainDomainEndpointOptionsArgs', 'DomainDomainEndpointOptionsArgsDict', 'DomainEbsOptionsArgs', 'DomainEbsOptionsArgsDict', 'DomainEncryptAtRestArgs', 'DomainEncryptAtRestArgsDict', 'DomainIdentityCenterOptionsArgs', 'DomainIdentityCenterOptionsArgsDict', 'DomainLogPublishingOptionArgs', 'DomainLogPublishingOptionArgsDict', 'DomainNodeToNodeEncryptionArgs', 'DomainNodeToNodeEncryptionArgsDict', 'DomainOffPeakWindowOptionsArgs', 'DomainOffPeakWindowOptionsArgsDict', 'DomainOffPeakWindowOptionsOffPeakWindowArgs', 'DomainOffPeakWindowOptionsOffPeakWindowArgsDict', ..., ..., 'DomainSamlOptionsSamlOptionsArgs', 'DomainSamlOptionsSamlOptionsArgsDict', 'DomainSamlOptionsSamlOptionsIdpArgs', 'DomainSamlOptionsSamlOptionsIdpArgsDict', 'DomainSnapshotOptionsArgs', 'DomainSnapshotOptionsArgsDict', 'DomainSoftwareUpdateOptionsArgs', 'DomainSoftwareUpdateOptionsArgsDict', 'DomainVpcOptionsArgs', 'DomainVpcOptionsArgsDict', 'OutboundConnectionConnectionPropertiesArgs', 'OutboundConnectionConnectionPropertiesArgsDict', ..., ..., 'OutboundConnectionLocalDomainInfoArgs', 'OutboundConnectionLocalDomainInfoArgsDict', 'OutboundConnectionRemoteDomainInfoArgs', 'OutboundConnectionRemoteDomainInfoArgsDict', 'PackagePackageSourceArgs', 'PackagePackageSourceArgsDict', 'ServerlessCollectionTimeoutsArgs', 'ServerlessCollectionTimeoutsArgsDict', 'ServerlessSecurityConfigSamlOptionsArgs', 'ServerlessSecurityConfigSamlOptionsArgsDict', 'ServerlessVpcEndpointTimeoutsArgs', 'ServerlessVpcEndpointTimeoutsArgsDict', 'VpcEndpointVpcOptionsArgs', 'VpcEndpointVpcOptionsArgsDict', 'GetServerlessSecurityConfigSamlOptionArgs', 'GetServerlessSecurityConfigSamlOptionArgsDict']
...
class ApplicationDataSourceArgs:
    def __init__(__self__, *, data_source_arn: Optional[pulumi.Input[_builtins.str]] = ..., data_source_description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def data_source_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def data_source_description(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApplicationIamIdentityCenterOptionsArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., iam_identity_center_application_arn: Optional[pulumi.Input[_builtins.str]] = ..., iam_identity_center_instance_arn: Optional[pulumi.Input[_builtins.str]] = ..., iam_role_for_identity_center_application_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def iam_identity_center_application_arn(self) -> Optional[pulumi.Input[_builtins.str]]:
        ...
    
    @iam_identity_center_application_arn.setter
    def iam_identity_center_application_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def iam_role_for_identity_center_application_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AuthorizeVpcEndpointAccessAuthorizedPrincipalArgs:
    def __init__(__self__, *, principal: pulumi.Input[_builtins.str], principal_type: pulumi.Input[_builtins.str]) -> None:
...
class DomainAdvancedSecurityOptionsArgsDict(TypedDict):
    ...
    jwt_options: NotRequired[pulumi.Input[DomainAdvancedSecurityOptionsJwtOptionsArgsDict]]
...
class DomainAdvancedSecurityOptionsArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], anonymous_auth_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., internal_user_database_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., jwt_options: Optional[pulumi.Input[DomainAdvancedSecurityOptionsJwtOptionsArgs]] = ..., master_user_options: Optional[pulumi.Input[DomainAdvancedSecurityOptionsMasterUserOptionsArgs]] = ...) -> None:
    ...
    def anonymous_auth_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def jwt_options(self) -> Optional[pulumi.Input[DomainAdvancedSecurityOptionsJwtOptionsArgs]]:
        
        ...
    
    @jwt_options.setter
    def jwt_options(self, value: Optional[pulumi.Input[DomainAdvancedSecurityOptionsJwtOptionsArgs]]): # -> None:
        ...
...
class DomainAdvancedSecurityOptionsJwtOptionsArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., public_key: Optional[pulumi.Input[_builtins.str]] = ..., roles_key: Optional[pulumi.Input[_builtins.str]] = ..., subject_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DomainAimlOptionsArgs:
    def __init__(__self__, *, natural_language_query_generation_options: Optional[pulumi.Input[DomainAimlOptionsNaturalLanguageQueryGenerationOptionsArgs]] = ..., s3_vectors_engine: Optional[pulumi.Input[DomainAimlOptionsS3VectorsEngineArgs]] = ..., serverless_vector_acceleration: Optional[pulumi.Input[DomainAimlOptionsServerlessVectorAccelerationArgs]] = ...) -> None:
    ...
    def natural_language_query_generation_options(self, value: Optional[pulumi.Input[DomainAimlOptionsNaturalLanguageQueryGenerationOptionsArgs]]): # -> None:
        ...
    ...
    def s3_vectors_engine(self, value: Optional[pulumi.Input[DomainAimlOptionsS3VectorsEngineArgs]]): # -> None:
        ...
    ...
    def serverless_vector_acceleration(self, value: Optional[pulumi.Input[DomainAimlOptionsServerlessVectorAccelerationArgs]]): # -> None:
        ...
...
class DomainAimlOptionsNaturalLanguageQueryGenerationOptionsArgs:
    def __init__(__self__, *, desired_state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DomainAutoTuneOptionsArgs:
    def __init__(__self__, *, desired_state: pulumi.Input[_builtins.str], maintenance_schedules: Optional[pulumi.Input[Sequence[pulumi.Input[DomainAutoTuneOptionsMaintenanceScheduleArgs]]]] = ..., rollback_on_disable: Optional[pulumi.Input[_builtins.str]] = ..., use_off_peak_window: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def use_off_peak_window(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DomainClusterConfigArgs:
    def __init__(__self__, *, cold_storage_options: Optional[pulumi.Input[DomainClusterConfigColdStorageOptionsArgs]] = ..., dedicated_master_count: Optional[pulumi.Input[_builtins.int]] = ..., dedicated_master_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., dedicated_master_type: Optional[pulumi.Input[_builtins.str]] = ..., instance_count: Optional[pulumi.Input[_builtins.int]] = ..., instance_type: Optional[pulumi.Input[_builtins.str]] = ..., multi_az_with_standby_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., node_options: Optional[pulumi.Input[Sequence[pulumi.Input[DomainClusterConfigNodeOptionArgs]]]] = ..., warm_count: Optional[pulumi.Input[_builtins.int]] = ..., warm_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., warm_type: Optional[pulumi.Input[_builtins.str]] = ..., zone_awareness_config: Optional[pulumi.Input[DomainClusterConfigZoneAwarenessConfigArgs]] = ..., zone_awareness_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def multi_az_with_standby_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @node_options.setter
    def node_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DomainClusterConfigNodeOptionArgs]]]]): # -> None:
        ...
...
class DomainClusterConfigNodeOptionArgs:
    def __init__(__self__, *, node_config: Optional[pulumi.Input[DomainClusterConfigNodeOptionNodeConfigArgs]] = ..., node_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @node_config.setter
    def node_config(self, value: Optional[pulumi.Input[DomainClusterConfigNodeOptionNodeConfigArgs]]): # -> None:
        ...
...
class DomainClusterConfigNodeOptionNodeConfigArgs:
    def __init__(__self__, *, count: Optional[pulumi.Input[_builtins.int]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DomainIdentityCenterOptionsArgs:
    def __init__(__self__, *, enabled_api_access: Optional[pulumi.Input[_builtins.bool]] = ..., identity_center_instance_arn: Optional[pulumi.Input[_builtins.str]] = ..., roles_key: Optional[pulumi.Input[_builtins.str]] = ..., subject_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def enabled_api_access(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def identity_center_instance_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DomainOffPeakWindowOptionsArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., off_peak_window: Optional[pulumi.Input[DomainOffPeakWindowOptionsOffPeakWindowArgs]] = ...) -> None:
    ...
    def off_peak_window(self, value: Optional[pulumi.Input[DomainOffPeakWindowOptionsOffPeakWindowArgs]]): # -> None:
        ...
...
class DomainOffPeakWindowOptionsOffPeakWindowArgs:
    def __init__(__self__, *, window_start_time: Optional[pulumi.Input[DomainOffPeakWindowOptionsOffPeakWindowWindowStartTimeArgs]] = ...) -> None:
    ...
    def window_start_time(self, value: Optional[pulumi.Input[DomainOffPeakWindowOptionsOffPeakWindowWindowStartTimeArgs]]): # -> None:
        ...
...
class DomainOffPeakWindowOptionsOffPeakWindowWindowStartTimeArgs:
    def __init__(__self__, *, hours: Optional[pulumi.Input[_builtins.int]] = ..., minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class DomainSoftwareUpdateOptionsArgs:
    def __init__(__self__, *, auto_software_update_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def auto_software_update_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class OutboundConnectionConnectionPropertiesArgs:
    def __init__(__self__, *, cross_cluster_search: Optional[pulumi.Input[OutboundConnectionConnectionPropertiesCrossClusterSearchArgs]] = ..., endpoint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cross_cluster_search(self, value: Optional[pulumi.Input[OutboundConnectionConnectionPropertiesCrossClusterSearchArgs]]): # -> None:
        ...
...
class OutboundConnectionConnectionPropertiesCrossClusterSearchArgs:
    def __init__(__self__, *, skip_unavailable: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def skip_unavailable(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class OutboundConnectionLocalDomainInfoArgs:
    def __init__(__self__, *, domain_name: pulumi.Input[_builtins.str], owner_id: pulumi.Input[_builtins.str], region: pulumi.Input[_builtins.str]) -> None:
    ...
    @owner_id.setter
    def owner_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PackagePackageSourceArgs:
    def __init__(__self__, *, s3_bucket_name: pulumi.Input[_builtins.str], s3_key: pulumi.Input[_builtins.str]) -> None:
...
class ServerlessSecurityConfigSamlOptionsArgs:
    def __init__(__self__, *, metadata: pulumi.Input[_builtins.str], group_attribute: Optional[pulumi.Input[_builtins.str]] = ..., session_timeout: Optional[pulumi.Input[_builtins.int]] = ..., user_attribute: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @metadata.setter
    def metadata(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def group_attribute(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def user_attribute(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GetServerlessSecurityConfigSamlOptionArgs:
    ...
    @group_attribute.setter
    def group_attribute(self, value: _builtins.str): # -> None:
        ...
    ...
    @user_attribute.setter
    def user_attribute(self, value: _builtins.str): # -> None:
        ...
