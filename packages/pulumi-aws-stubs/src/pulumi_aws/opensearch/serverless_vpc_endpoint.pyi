...
class ServerlessVpcEndpointArgs:
    def __init__(
        ...
        *,
        ...
        timeouts: Optional[pulumi.Input[ServerlessVpcEndpointTimeoutsArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @timeouts.setter
    def timeouts(
        self, value: Optional[pulumi.Input[ServerlessVpcEndpointTimeoutsArgs]]
    ): ...
...
class ServerlessVpcEndpoint(pulumi.CustomResource):
    ...
    def timeouts(
        self,
    ) -> pulumi.Output[Optional[outputs.ServerlessVpcEndpointTimeouts]]: ...
    @_builtins.property
    @pulumi.getter(name="vpcId")
