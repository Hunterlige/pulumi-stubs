...
class GetDomainResult:
    ...
    def __init__(__self__, access_policies=..., advanced_options=..., advanced_security_options=..., arn=..., auto_tune_options=..., cluster_configs=..., cognito_options=..., created=..., dashboard_endpoint=..., dashboard_endpoint_v2=..., deleted=..., domain_endpoint_v2_hosted_zone_id=..., domain_id=..., domain_name=..., ebs_options=..., encryption_at_rests=..., endpoint=..., endpoint_v2=..., engine_version=..., id=..., identity_center_options=..., ip_address_type=..., log_publishing_options=..., node_to_node_encryptions=..., off_peak_window_options=..., processing=..., region=..., snapshot_options=..., software_update_options=..., tags=..., vpc_options=...) -> None:
        ...
...
def get_domain(domain_name: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDomainResult:
    
    ...

def get_domain_output(domain_name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDomainResult]:
