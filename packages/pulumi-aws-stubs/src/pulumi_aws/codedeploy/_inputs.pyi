...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DeploymentConfigMinimumHealthyHostsArgs', 'DeploymentConfigMinimumHealthyHostsArgsDict', 'DeploymentConfigTrafficRoutingConfigArgs', 'DeploymentConfigTrafficRoutingConfigArgsDict', ..., ..., ..., ..., 'DeploymentConfigZonalConfigArgs', 'DeploymentConfigZonalConfigArgsDict', ..., ..., 'DeploymentGroupAlarmConfigurationArgs', 'DeploymentGroupAlarmConfigurationArgsDict', 'DeploymentGroupAutoRollbackConfigurationArgs', 'DeploymentGroupAutoRollbackConfigurationArgsDict', 'DeploymentGroupBlueGreenDeploymentConfigArgs', 'DeploymentGroupBlueGreenDeploymentConfigArgsDict', ..., ..., ..., ..., ..., ..., 'DeploymentGroupDeploymentStyleArgs', 'DeploymentGroupDeploymentStyleArgsDict', 'DeploymentGroupEc2TagFilterArgs', 'DeploymentGroupEc2TagFilterArgsDict', 'DeploymentGroupEc2TagSetArgs', 'DeploymentGroupEc2TagSetArgsDict', 'DeploymentGroupEc2TagSetEc2TagFilterArgs', 'DeploymentGroupEc2TagSetEc2TagFilterArgsDict', 'DeploymentGroupEcsServiceArgs', 'DeploymentGroupEcsServiceArgsDict', 'DeploymentGroupLoadBalancerInfoArgs', 'DeploymentGroupLoadBalancerInfoArgsDict', 'DeploymentGroupLoadBalancerInfoElbInfoArgs', 'DeploymentGroupLoadBalancerInfoElbInfoArgsDict', 'DeploymentGroupLoadBalancerInfoTargetGroupInfoArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., 'DeploymentGroupOnPremisesInstanceTagFilterArgs', 'DeploymentGroupOnPremisesInstanceTagFilterArgsDict', 'DeploymentGroupTriggerConfigurationArgs', 'DeploymentGroupTriggerConfigurationArgsDict']
...
class DeploymentConfigTrafficRoutingConfigArgs:
    def __init__(__self__, *, time_based_canary: Optional[pulumi.Input[DeploymentConfigTrafficRoutingConfigTimeBasedCanaryArgs]] = ..., time_based_linear: Optional[pulumi.Input[DeploymentConfigTrafficRoutingConfigTimeBasedLinearArgs]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def time_based_canary(self, value: Optional[pulumi.Input[DeploymentConfigTrafficRoutingConfigTimeBasedCanaryArgs]]): # -> None:
        ...
    ...
    def time_based_linear(self, value: Optional[pulumi.Input[DeploymentConfigTrafficRoutingConfigTimeBasedLinearArgs]]): # -> None:
        ...
...
class DeploymentConfigTrafficRoutingConfigTimeBasedCanaryArgs:
    def __init__(__self__, *, interval: Optional[pulumi.Input[_builtins.int]] = ..., percentage: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class DeploymentConfigZonalConfigArgs:
    def __init__(__self__, *, first_zone_monitor_duration_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., minimum_healthy_hosts_per_zone: Optional[pulumi.Input[DeploymentConfigZonalConfigMinimumHealthyHostsPerZoneArgs]] = ..., monitor_duration_in_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def first_zone_monitor_duration_in_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def minimum_healthy_hosts_per_zone(self, value: Optional[pulumi.Input[DeploymentConfigZonalConfigMinimumHealthyHostsPerZoneArgs]]): # -> None:
        ...
    ...
    def monitor_duration_in_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class DeploymentGroupAlarmConfigurationArgs:
    def __init__(__self__, *, alarms: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., ignore_poll_alarm_failure: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def ignore_poll_alarm_failure(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DeploymentGroupAutoRollbackConfigurationArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., events: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class DeploymentGroupBlueGreenDeploymentConfigArgs:
    def __init__(__self__, *, deployment_ready_option: Optional[pulumi.Input[DeploymentGroupBlueGreenDeploymentConfigDeploymentReadyOptionArgs]] = ..., green_fleet_provisioning_option: Optional[pulumi.Input[DeploymentGroupBlueGreenDeploymentConfigGreenFleetProvisioningOptionArgs]] = ..., terminate_blue_instances_on_deployment_success: Optional[pulumi.Input[DeploymentGroupBlueGreenDeploymentConfigTerminateBlueInstancesOnDeploymentSuccessArgs]] = ...) -> None:
    ...
    def deployment_ready_option(self, value: Optional[pulumi.Input[DeploymentGroupBlueGreenDeploymentConfigDeploymentReadyOptionArgs]]): # -> None:
        ...
    ...
    def green_fleet_provisioning_option(self, value: Optional[pulumi.Input[DeploymentGroupBlueGreenDeploymentConfigGreenFleetProvisioningOptionArgs]]): # -> None:
        ...
    ...
    def terminate_blue_instances_on_deployment_success(self, value: Optional[pulumi.Input[DeploymentGroupBlueGreenDeploymentConfigTerminateBlueInstancesOnDeploymentSuccessArgs]]): # -> None:
        ...
...
class DeploymentGroupBlueGreenDeploymentConfigDeploymentReadyOptionArgs:
    def __init__(__self__, *, action_on_timeout: Optional[pulumi.Input[_builtins.str]] = ..., wait_time_in_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def action_on_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def wait_time_in_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class DeploymentGroupBlueGreenDeploymentConfigTerminateBlueInstancesOnDeploymentSuccessArgs:
    def __init__(__self__, *, action: Optional[pulumi.Input[_builtins.str]] = ..., termination_wait_time_in_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def termination_wait_time_in_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class DeploymentGroupDeploymentStyleArgs:
    def __init__(__self__, *, deployment_option: Optional[pulumi.Input[_builtins.str]] = ..., deployment_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def deployment_option(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DeploymentGroupEc2TagFilterArgs:
    def __init__(__self__, *, key: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DeploymentGroupEc2TagSetArgs:
    def __init__(__self__, *, ec2_tag_filters: Optional[pulumi.Input[Sequence[pulumi.Input[DeploymentGroupEc2TagSetEc2TagFilterArgs]]]] = ...) -> None:
    ...
    def ec2_tag_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DeploymentGroupEc2TagSetEc2TagFilterArgs]]]]): # -> None:
        ...
...
class DeploymentGroupEcsServiceArgs:
    def __init__(__self__, *, cluster_name: pulumi.Input[_builtins.str], service_name: pulumi.Input[_builtins.str]) -> None:
...
class DeploymentGroupLoadBalancerInfoArgs:
    def __init__(__self__, *, elb_infos: Optional[pulumi.Input[Sequence[pulumi.Input[DeploymentGroupLoadBalancerInfoElbInfoArgs]]]] = ..., target_group_infos: Optional[pulumi.Input[Sequence[pulumi.Input[DeploymentGroupLoadBalancerInfoTargetGroupInfoArgs]]]] = ..., target_group_pair_info: Optional[pulumi.Input[DeploymentGroupLoadBalancerInfoTargetGroupPairInfoArgs]] = ...) -> None:
    ...
    @elb_infos.setter
    def elb_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DeploymentGroupLoadBalancerInfoElbInfoArgs]]]]): # -> None:
        ...
    ...
    def target_group_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DeploymentGroupLoadBalancerInfoTargetGroupInfoArgs]]]]): # -> None:
        ...
    ...
    def target_group_pair_info(self, value: Optional[pulumi.Input[DeploymentGroupLoadBalancerInfoTargetGroupPairInfoArgs]]): # -> None:
        ...
...
class DeploymentGroupLoadBalancerInfoTargetGroupPairInfoArgs:
    def __init__(__self__, *, prod_traffic_route: pulumi.Input[DeploymentGroupLoadBalancerInfoTargetGroupPairInfoProdTrafficRouteArgs], target_groups: pulumi.Input[Sequence[pulumi.Input[DeploymentGroupLoadBalancerInfoTargetGroupPairInfoTargetGroupArgs]]], test_traffic_route: Optional[pulumi.Input[DeploymentGroupLoadBalancerInfoTargetGroupPairInfoTestTrafficRouteArgs]] = ...) -> None:
    ...
    def prod_traffic_route(self, value: pulumi.Input[DeploymentGroupLoadBalancerInfoTargetGroupPairInfoProdTrafficRouteArgs]): # -> None:
        ...
    ...
    def target_groups(self, value: pulumi.Input[Sequence[pulumi.Input[DeploymentGroupLoadBalancerInfoTargetGroupPairInfoTargetGroupArgs]]]): # -> None:
        ...
    ...
    def test_traffic_route(self, value: Optional[pulumi.Input[DeploymentGroupLoadBalancerInfoTargetGroupPairInfoTestTrafficRouteArgs]]): # -> None:
        ...
...
class DeploymentGroupLoadBalancerInfoTargetGroupPairInfoProdTrafficRouteArgs:
    def __init__(__self__, *, listener_arns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def listener_arns(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class DeploymentGroupTriggerConfigurationArgs:
    def __init__(__self__, *, trigger_events: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], trigger_name: pulumi.Input[_builtins.str], trigger_target_arn: pulumi.Input[_builtins.str]) -> None:
    ...
    def trigger_events(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def trigger_target_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
