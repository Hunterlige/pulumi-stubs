...
class SmsPreferencesArgs:
    def __init__(__self__, *, default_sender_id: Optional[pulumi.Input[_builtins.str]] = ..., default_sms_type: Optional[pulumi.Input[_builtins.str]] = ..., delivery_status_iam_role_arn: Optional[pulumi.Input[_builtins.str]] = ..., delivery_status_success_sampling_rate: Optional[pulumi.Input[_builtins.str]] = ..., monthly_spend_limit: Optional[pulumi.Input[_builtins.int]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., usage_report_s3_bucket: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def default_sender_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def default_sms_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def delivery_status_iam_role_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def delivery_status_success_sampling_rate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def monthly_spend_limit(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def usage_report_s3_bucket(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SmsPreferences(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., default_sender_id: Optional[pulumi.Input[_builtins.str]] = ..., default_sms_type: Optional[pulumi.Input[_builtins.str]] = ..., delivery_status_iam_role_arn: Optional[pulumi.Input[_builtins.str]] = ..., delivery_status_success_sampling_rate: Optional[pulumi.Input[_builtins.str]] = ..., monthly_spend_limit: Optional[pulumi.Input[_builtins.int]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., usage_report_s3_bucket: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: Optional[SmsPreferencesArgs] = ..., opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., default_sender_id: Optional[pulumi.Input[_builtins.str]] = ..., default_sms_type: Optional[pulumi.Input[_builtins.str]] = ..., delivery_status_iam_role_arn: Optional[pulumi.Input[_builtins.str]] = ..., delivery_status_success_sampling_rate: Optional[pulumi.Input[_builtins.str]] = ..., monthly_spend_limit: Optional[pulumi.Input[_builtins.int]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., usage_report_s3_bucket: Optional[pulumi.Input[_builtins.str]] = ...) -> SmsPreferences:
