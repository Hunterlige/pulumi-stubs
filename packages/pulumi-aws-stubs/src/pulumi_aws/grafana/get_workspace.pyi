...
class GetWorkspaceResult:
    ...
    def __init__(__self__, account_access_type=..., arn=..., authentication_providers=..., created_date=..., data_sources=..., description=..., endpoint=..., grafana_version=..., id=..., kms_key_id=..., last_updated_date=..., name=..., notification_destinations=..., organization_role_name=..., organizational_units=..., permission_type=..., region=..., role_arn=..., saml_configuration_status=..., stack_set_name=..., status=..., tags=..., workspace_id=...) -> None:
        ...
