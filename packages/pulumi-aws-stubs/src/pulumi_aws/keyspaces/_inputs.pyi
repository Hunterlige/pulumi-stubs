...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['KeyspaceReplicationSpecificationArgs', 'KeyspaceReplicationSpecificationArgsDict', 'TableCapacitySpecificationArgs', 'TableCapacitySpecificationArgsDict', 'TableClientSideTimestampsArgs', 'TableClientSideTimestampsArgsDict', 'TableCommentArgs', 'TableCommentArgsDict', 'TableEncryptionSpecificationArgs', 'TableEncryptionSpecificationArgsDict', 'TablePointInTimeRecoveryArgs', 'TablePointInTimeRecoveryArgsDict', 'TableSchemaDefinitionArgs', 'TableSchemaDefinitionArgsDict', 'TableSchemaDefinitionClusteringKeyArgs', 'TableSchemaDefinitionClusteringKeyArgsDict', 'TableSchemaDefinitionColumnArgs', 'TableSchemaDefinitionColumnArgsDict', 'TableSchemaDefinitionPartitionKeyArgs', 'TableSchemaDefinitionPartitionKeyArgsDict', 'TableSchemaDefinitionStaticColumnArgs', 'TableSchemaDefinitionStaticColumnArgsDict', 'TableTtlArgs', 'TableTtlArgsDict']
...
class KeyspaceReplicationSpecificationArgs:
    def __init__(__self__, *, region_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., replication_strategy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @region_lists.setter
    def region_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def replication_strategy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TableCapacitySpecificationArgs:
    def __init__(__self__, *, read_capacity_units: Optional[pulumi.Input[_builtins.int]] = ..., throughput_mode: Optional[pulumi.Input[_builtins.str]] = ..., write_capacity_units: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class TableEncryptionSpecificationArgs:
    def __init__(__self__, *, kms_key_identifier: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TableSchemaDefinitionArgs:
    def __init__(__self__, *, columns: pulumi.Input[Sequence[pulumi.Input[TableSchemaDefinitionColumnArgs]]], partition_keys: pulumi.Input[Sequence[pulumi.Input[TableSchemaDefinitionPartitionKeyArgs]]], clustering_keys: Optional[pulumi.Input[Sequence[pulumi.Input[TableSchemaDefinitionClusteringKeyArgs]]]] = ..., static_columns: Optional[pulumi.Input[Sequence[pulumi.Input[TableSchemaDefinitionStaticColumnArgs]]]] = ...) -> None:
    ...
    @columns.setter
    def columns(self, value: pulumi.Input[Sequence[pulumi.Input[TableSchemaDefinitionColumnArgs]]]): # -> None:
        ...
    ...
    def partition_keys(self, value: pulumi.Input[Sequence[pulumi.Input[TableSchemaDefinitionPartitionKeyArgs]]]): # -> None:
        ...
    ...
    def clustering_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TableSchemaDefinitionClusteringKeyArgs]]]]): # -> None:
        ...
    ...
    def static_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TableSchemaDefinitionStaticColumnArgs]]]]): # -> None:
        ...
...
class TableSchemaDefinitionClusteringKeyArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], order_by: pulumi.Input[_builtins.str]) -> None:
