...
class KeyspaceArgs:
    def __init__(
        ...
        *,
        ...
        replication_specification: Optional[
            pulumi.Input[KeyspaceReplicationSpecificationArgs]
        ] = ...,
    ...
    def replication_specification(
        self,
    ) -> Optional[pulumi.Input[KeyspaceReplicationSpecificationArgs]]: ...
    @replication_specification.setter
    def replication_specification(
        self, value: Optional[pulumi.Input[KeyspaceReplicationSpecificationArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class Keyspace(pulumi.CustomResource):
    ...
    def replication_specification(
        self,
    ) -> pulumi.Output[outputs.KeyspaceReplicationSpecification]: ...
    @_builtins.property
    @pulumi.getter
