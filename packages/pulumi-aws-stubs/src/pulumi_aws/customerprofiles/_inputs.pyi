...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DomainMatchingArgs', 'DomainMatchingArgsDict', 'DomainMatchingAutoMergingArgs', 'DomainMatchingAutoMergingArgsDict', 'DomainMatchingAutoMergingConflictResolutionArgs', ..., 'DomainMatchingAutoMergingConsolidationArgs', 'DomainMatchingAutoMergingConsolidationArgsDict', 'DomainMatchingExportingConfigArgs', 'DomainMatchingExportingConfigArgsDict', 'DomainMatchingExportingConfigS3ExportingArgs', 'DomainMatchingExportingConfigS3ExportingArgsDict', 'DomainMatchingJobScheduleArgs', 'DomainMatchingJobScheduleArgsDict', 'DomainRuleBasedMatchingArgs', 'DomainRuleBasedMatchingArgsDict', 'DomainRuleBasedMatchingAttributeTypesSelectorArgs', ..., 'DomainRuleBasedMatchingConflictResolutionArgs', 'DomainRuleBasedMatchingConflictResolutionArgsDict', 'DomainRuleBasedMatchingExportingConfigArgs', 'DomainRuleBasedMatchingExportingConfigArgsDict', ..., ..., 'DomainRuleBasedMatchingMatchingRuleArgs', 'DomainRuleBasedMatchingMatchingRuleArgsDict', 'ProfileAddressArgs', 'ProfileAddressArgsDict', 'ProfileBillingAddressArgs', 'ProfileBillingAddressArgsDict', 'ProfileMailingAddressArgs', 'ProfileMailingAddressArgsDict', 'ProfileShippingAddressArgs', 'ProfileShippingAddressArgsDict']
...
class DomainMatchingArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], auto_merging: Optional[pulumi.Input[DomainMatchingAutoMergingArgs]] = ..., exporting_config: Optional[pulumi.Input[DomainMatchingExportingConfigArgs]] = ..., job_schedule: Optional[pulumi.Input[DomainMatchingJobScheduleArgs]] = ...) -> None:
    ...
    @auto_merging.setter
    def auto_merging(self, value: Optional[pulumi.Input[DomainMatchingAutoMergingArgs]]): # -> None:
        ...
    ...
    def exporting_config(self, value: Optional[pulumi.Input[DomainMatchingExportingConfigArgs]]): # -> None:
        ...
    ...
    @job_schedule.setter
    def job_schedule(self, value: Optional[pulumi.Input[DomainMatchingJobScheduleArgs]]): # -> None:
        ...
...
class DomainMatchingAutoMergingArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], conflict_resolution: Optional[pulumi.Input[DomainMatchingAutoMergingConflictResolutionArgs]] = ..., consolidation: Optional[pulumi.Input[DomainMatchingAutoMergingConsolidationArgs]] = ..., min_allowed_confidence_score_for_merging: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def conflict_resolution(self, value: Optional[pulumi.Input[DomainMatchingAutoMergingConflictResolutionArgs]]): # -> None:
        ...
    ...
    def consolidation(self, value: Optional[pulumi.Input[DomainMatchingAutoMergingConsolidationArgs]]): # -> None:
        ...
    ...
    def min_allowed_confidence_score_for_merging(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class DomainMatchingAutoMergingConflictResolutionArgs:
    def __init__(__self__, *, conflict_resolving_model: pulumi.Input[_builtins.str], source_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def conflict_resolving_model(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DomainMatchingAutoMergingConsolidationArgs:
    def __init__(__self__, *, matching_attributes_lists: pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]) -> None:
    ...
    def matching_attributes_lists(self, value: pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]]): # -> None:
        ...
...
class DomainMatchingExportingConfigArgs:
    def __init__(__self__, *, s3_exporting: Optional[pulumi.Input[DomainMatchingExportingConfigS3ExportingArgs]] = ...) -> None:
        ...
    ...
    @s3_exporting.setter
    def s3_exporting(self, value: Optional[pulumi.Input[DomainMatchingExportingConfigS3ExportingArgs]]): # -> None:
        ...
...
class DomainMatchingExportingConfigS3ExportingArgs:
    def __init__(__self__, *, s3_bucket_name: pulumi.Input[_builtins.str], s3_key_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @s3_key_name.setter
    def s3_key_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DomainMatchingJobScheduleArgs:
    def __init__(__self__, *, day_of_the_week: pulumi.Input[_builtins.str], time: pulumi.Input[_builtins.str]) -> None:
    ...
    def day_of_the_week(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DomainRuleBasedMatchingArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], attribute_types_selector: Optional[pulumi.Input[DomainRuleBasedMatchingAttributeTypesSelectorArgs]] = ..., conflict_resolution: Optional[pulumi.Input[DomainRuleBasedMatchingConflictResolutionArgs]] = ..., exporting_config: Optional[pulumi.Input[DomainRuleBasedMatchingExportingConfigArgs]] = ..., matching_rules: Optional[pulumi.Input[Sequence[pulumi.Input[DomainRuleBasedMatchingMatchingRuleArgs]]]] = ..., max_allowed_rule_level_for_matching: Optional[pulumi.Input[_builtins.int]] = ..., max_allowed_rule_level_for_merging: Optional[pulumi.Input[_builtins.int]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def attribute_types_selector(self, value: Optional[pulumi.Input[DomainRuleBasedMatchingAttributeTypesSelectorArgs]]): # -> None:
        ...
    ...
    @conflict_resolution.setter
    def conflict_resolution(self, value: Optional[pulumi.Input[DomainRuleBasedMatchingConflictResolutionArgs]]): # -> None:
        ...
    ...
    @exporting_config.setter
    def exporting_config(self, value: Optional[pulumi.Input[DomainRuleBasedMatchingExportingConfigArgs]]): # -> None:
        ...
    ...
    def matching_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DomainRuleBasedMatchingMatchingRuleArgs]]]]): # -> None:
        ...
    ...
    def max_allowed_rule_level_for_matching(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_allowed_rule_level_for_merging(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class DomainRuleBasedMatchingAttributeTypesSelectorArgs:
    def __init__(__self__, *, attribute_matching_model: pulumi.Input[_builtins.str], addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., email_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., phone_numbers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def attribute_matching_model(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def phone_numbers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DomainRuleBasedMatchingExportingConfigArgs:
    def __init__(__self__, *, s3_exporting: Optional[pulumi.Input[DomainRuleBasedMatchingExportingConfigS3ExportingArgs]] = ...) -> None:
        ...
    ...
    @s3_exporting.setter
    def s3_exporting(self, value: Optional[pulumi.Input[DomainRuleBasedMatchingExportingConfigS3ExportingArgs]]): # -> None:
        ...
...
class DomainRuleBasedMatchingMatchingRuleArgs:
    def __init__(__self__, *, rules: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class ProfileAddressArgs:
    def __init__(__self__, *, address1: Optional[pulumi.Input[_builtins.str]] = ..., address2: Optional[pulumi.Input[_builtins.str]] = ..., address3: Optional[pulumi.Input[_builtins.str]] = ..., address4: Optional[pulumi.Input[_builtins.str]] = ..., city: Optional[pulumi.Input[_builtins.str]] = ..., country: Optional[pulumi.Input[_builtins.str]] = ..., county: Optional[pulumi.Input[_builtins.str]] = ..., postal_code: Optional[pulumi.Input[_builtins.str]] = ..., province: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @address1.setter
    def address1(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @address3.setter
    def address3(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @address4.setter
    def address4(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @county.setter
    def county(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
