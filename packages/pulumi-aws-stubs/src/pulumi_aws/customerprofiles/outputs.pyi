...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DomainMatching', 'DomainMatchingAutoMerging', 'DomainMatchingAutoMergingConflictResolution', 'DomainMatchingAutoMergingConsolidation', 'DomainMatchingExportingConfig', 'DomainMatchingExportingConfigS3Exporting', 'DomainMatchingJobSchedule', 'DomainRuleBasedMatching', 'DomainRuleBasedMatchingAttributeTypesSelector', 'DomainRuleBasedMatchingConflictResolution', 'DomainRuleBasedMatchingExportingConfig', 'DomainRuleBasedMatchingExportingConfigS3Exporting', 'DomainRuleBasedMatchingMatchingRule', 'ProfileAddress', 'ProfileBillingAddress', 'ProfileMailingAddress', 'ProfileShippingAddress']
@pulumi.output_type
class DomainMatching(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, auto_merging: Optional[outputs.DomainMatchingAutoMerging] = ..., exporting_config: Optional[outputs.DomainMatchingExportingConfig] = ..., job_schedule: Optional[outputs.DomainMatchingJobSchedule] = ...) -> None:
...
class DomainMatchingAutoMerging(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, conflict_resolution: Optional[outputs.DomainMatchingAutoMergingConflictResolution] = ..., consolidation: Optional[outputs.DomainMatchingAutoMergingConsolidation] = ..., min_allowed_confidence_score_for_merging: Optional[_builtins.float] = ...) -> None:
...
class DomainMatchingAutoMergingConflictResolution(dict):
    ...
    def __init__(__self__, *, conflict_resolving_model: _builtins.str, source_name: Optional[_builtins.str] = ...) -> None:
...
class DomainMatchingAutoMergingConsolidation(dict):
    ...
    def __init__(__self__, *, matching_attributes_lists: Sequence[Sequence[_builtins.str]]) -> None:
...
class DomainMatchingExportingConfig(dict):
    ...
    def __init__(__self__, *, s3_exporting: Optional[outputs.DomainMatchingExportingConfigS3Exporting] = ...) -> None:
        ...
...
class DomainMatchingExportingConfigS3Exporting(dict):
    ...
    def __init__(__self__, *, s3_bucket_name: _builtins.str, s3_key_name: Optional[_builtins.str] = ...) -> None:
...
class DomainMatchingJobSchedule(dict):
    ...
    def __init__(__self__, *, day_of_the_week: _builtins.str, time: _builtins.str) -> None:
...
class DomainRuleBasedMatching(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, attribute_types_selector: Optional[outputs.DomainRuleBasedMatchingAttributeTypesSelector] = ..., conflict_resolution: Optional[outputs.DomainRuleBasedMatchingConflictResolution] = ..., exporting_config: Optional[outputs.DomainRuleBasedMatchingExportingConfig] = ..., matching_rules: Optional[Sequence[outputs.DomainRuleBasedMatchingMatchingRule]] = ..., max_allowed_rule_level_for_matching: Optional[_builtins.int] = ..., max_allowed_rule_level_for_merging: Optional[_builtins.int] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class DomainRuleBasedMatchingAttributeTypesSelector(dict):
    ...
    def __init__(__self__, *, attribute_matching_model: _builtins.str, addresses: Optional[Sequence[_builtins.str]] = ..., email_addresses: Optional[Sequence[_builtins.str]] = ..., phone_numbers: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DomainRuleBasedMatchingExportingConfig(dict):
    ...
    def __init__(__self__, *, s3_exporting: Optional[outputs.DomainRuleBasedMatchingExportingConfigS3Exporting] = ...) -> None:
        ...
...
class ProfileAddress(dict):
    ...
    def __init__(__self__, *, address1: Optional[_builtins.str] = ..., address2: Optional[_builtins.str] = ..., address3: Optional[_builtins.str] = ..., address4: Optional[_builtins.str] = ..., city: Optional[_builtins.str] = ..., country: Optional[_builtins.str] = ..., county: Optional[_builtins.str] = ..., postal_code: Optional[_builtins.str] = ..., province: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
