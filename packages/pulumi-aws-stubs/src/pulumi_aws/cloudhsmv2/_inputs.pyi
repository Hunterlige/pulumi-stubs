...
class ClusterClusterCertificateArgs:
    def __init__(__self__, *, aws_hardware_certificate: Optional[pulumi.Input[_builtins.str]] = ..., cluster_certificate: Optional[pulumi.Input[_builtins.str]] = ..., cluster_csr: Optional[pulumi.Input[_builtins.str]] = ..., hsm_certificate: Optional[pulumi.Input[_builtins.str]] = ..., manufacturer_hardware_certificate: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def aws_hardware_certificate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def cluster_certificate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @cluster_csr.setter
    def cluster_csr(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def hsm_certificate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def manufacturer_hardware_certificate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
