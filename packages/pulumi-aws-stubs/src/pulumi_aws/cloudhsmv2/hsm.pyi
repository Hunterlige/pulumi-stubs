...
@pulumi.input_type
class HsmArgs:
    def __init__(__self__, *, cluster_id: pulumi.Input[_builtins.str], availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., subnet_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
@pulumi.input_type
class _HsmState:
    def __init__(__self__, *, availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., cluster_id: Optional[pulumi.Input[_builtins.str]] = ..., hsm_eni_id: Optional[pulumi.Input[_builtins.str]] = ..., hsm_id: Optional[pulumi.Input[_builtins.str]] = ..., hsm_state: Optional[pulumi.Input[_builtins.str]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., subnet_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @hsm_eni_id.setter
    def hsm_eni_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @hsm_id.setter
    def hsm_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @hsm_state.setter
    def hsm_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class Hsm(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., cluster_id: Optional[pulumi.Input[_builtins.str]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., subnet_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: HsmArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
