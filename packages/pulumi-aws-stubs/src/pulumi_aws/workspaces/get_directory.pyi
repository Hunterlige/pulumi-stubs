...
class GetDirectoryResult:
    ...
    def __init__(__self__, active_directory_configs=..., alias=..., certificate_based_auth_properties=..., customer_user_name=..., directory_id=..., directory_name=..., directory_type=..., dns_ip_addresses=..., iam_role_id=..., id=..., ip_group_ids=..., region=..., registration_code=..., saml_properties=..., self_service_permissions=..., subnet_ids=..., tags=..., tenancy=..., user_identity_type=..., workspace_access_properties=..., workspace_creation_properties=..., workspace_directory_description=..., workspace_directory_name=..., workspace_security_group_id=..., workspace_type=...) -> None:
        ...
