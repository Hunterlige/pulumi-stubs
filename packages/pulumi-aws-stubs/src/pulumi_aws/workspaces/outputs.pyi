...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectionAliasTimeouts', 'DirectoryActiveDirectoryConfig', 'DirectoryCertificateBasedAuthProperties', 'DirectorySamlProperties', 'DirectorySelfServicePermissions', 'DirectoryWorkspaceAccessProperties', 'DirectoryWorkspaceCreationProperties', 'IpGroupRule', 'WorkspaceWorkspaceProperties', 'GetBundleComputeTypeResult', 'GetBundleRootStorageResult', 'GetBundleUserStorageResult', 'GetDirectoryActiveDirectoryConfigResult', 'GetDirectoryCertificateBasedAuthPropertyResult', 'GetDirectorySamlPropertyResult', 'GetDirectorySelfServicePermissionResult', 'GetDirectoryWorkspaceAccessPropertyResult', 'GetDirectoryWorkspaceCreationPropertyResult', 'GetWorkspaceWorkspacePropertyResult']
@pulumi.output_type
...
class DirectoryActiveDirectoryConfig(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, service_account_secret_arn: _builtins.str) -> None:
...
class DirectoryCertificateBasedAuthProperties(dict):
    ...
    def __init__(__self__, *, certificate_authority_arn: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class DirectorySamlProperties(dict):
    ...
    def __init__(__self__, *, relay_state_parameter_name: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., user_access_url: Optional[_builtins.str] = ...) -> None:
...
class DirectorySelfServicePermissions(dict):
    ...
    def __init__(__self__, *, change_compute_type: Optional[_builtins.bool] = ..., increase_volume_size: Optional[_builtins.bool] = ..., rebuild_workspace: Optional[_builtins.bool] = ..., restart_workspace: Optional[_builtins.bool] = ..., switch_running_mode: Optional[_builtins.bool] = ...) -> None:
...
class DirectoryWorkspaceAccessProperties(dict):
    ...
    def __init__(__self__, *, device_type_android: Optional[_builtins.str] = ..., device_type_chromeos: Optional[_builtins.str] = ..., device_type_ios: Optional[_builtins.str] = ..., device_type_linux: Optional[_builtins.str] = ..., device_type_osx: Optional[_builtins.str] = ..., device_type_web: Optional[_builtins.str] = ..., device_type_windows: Optional[_builtins.str] = ..., device_type_zeroclient: Optional[_builtins.str] = ...) -> None:
...
class DirectoryWorkspaceCreationProperties(dict):
    ...
    def __init__(__self__, *, custom_security_group_id: Optional[_builtins.str] = ..., default_ou: Optional[_builtins.str] = ..., enable_internet_access: Optional[_builtins.bool] = ..., enable_maintenance_mode: Optional[_builtins.bool] = ..., user_enabled_as_local_administrator: Optional[_builtins.bool] = ...) -> None:
...
class IpGroupRule(dict):
    def __init__(__self__, *, source: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class WorkspaceWorkspaceProperties(dict):
    ...
    def __init__(__self__, *, compute_type_name: Optional[_builtins.str] = ..., root_volume_size_gib: Optional[_builtins.int] = ..., running_mode: Optional[_builtins.str] = ..., running_mode_auto_stop_timeout_in_minutes: Optional[_builtins.int] = ..., user_volume_size_gib: Optional[_builtins.int] = ...) -> None:
...
class GetDirectoryCertificateBasedAuthPropertyResult(dict):
    def __init__(__self__, *, certificate_authority_arn: _builtins.str, status: _builtins.str) -> None:
        ...
...
class GetDirectorySamlPropertyResult(dict):
    def __init__(__self__, *, relay_state_parameter_name: _builtins.str, status: _builtins.str, user_access_url: _builtins.str) -> None:
        ...
...
class GetDirectorySelfServicePermissionResult(dict):
    def __init__(__self__, *, change_compute_type: _builtins.bool, increase_volume_size: _builtins.bool, rebuild_workspace: _builtins.bool, restart_workspace: _builtins.bool, switch_running_mode: _builtins.bool) -> None:
...
class GetDirectoryWorkspaceAccessPropertyResult(dict):
    def __init__(__self__, *, device_type_android: _builtins.str, device_type_chromeos: _builtins.str, device_type_ios: _builtins.str, device_type_linux: _builtins.str, device_type_osx: _builtins.str, device_type_web: _builtins.str, device_type_windows: _builtins.str, device_type_zeroclient: _builtins.str) -> None:
...
class GetDirectoryWorkspaceCreationPropertyResult(dict):
    def __init__(__self__, *, custom_security_group_id: _builtins.str, default_ou: _builtins.str, enable_internet_access: _builtins.bool, enable_maintenance_mode: _builtins.bool, user_enabled_as_local_administrator: _builtins.bool) -> None:
...
class GetWorkspaceWorkspacePropertyResult(dict):
    def __init__(__self__, *, compute_type_name: _builtins.str, root_volume_size_gib: _builtins.int, running_mode: _builtins.str, running_mode_auto_stop_timeout_in_minutes: _builtins.int, user_volume_size_gib: _builtins.int) -> None:
