...
class ScriptArgs:
    def __init__(
        ...
        *,
        ...
        storage_location: Optional[pulumi.Input[ScriptStorageLocationArgs]] = ...,
    ...
    def storage_location(
        self, value: Optional[pulumi.Input[ScriptStorageLocationArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def tags(
...
class Script(pulumi.CustomResource):
    ...
    def __init__(
        ...
        storage_location: Optional[
            pulumi.Input[
                Union[ScriptStorageLocationArgs, ScriptStorageLocationArgsDict]
            ]
        ] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        version: Optional[pulumi.Input[_builtins.str]] = ...,
