...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AliasRoutingStrategy', 'BuildStorageLocation', 'FleetCertificateConfiguration', 'FleetEc2InboundPermission', 'FleetResourceCreationLimitPolicy', 'FleetRuntimeConfiguration', 'FleetRuntimeConfigurationServerProcess', 'GameServerGroupAutoScalingPolicy', ..., 'GameServerGroupInstanceDefinition', 'GameServerGroupLaunchTemplate', 'GameSessionQueuePlayerLatencyPolicy', 'ScriptStorageLocation']
@pulumi.output_type
class AliasRoutingStrategy(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, fleet_id: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ...) -> None:
...
class BuildStorageLocation(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, key: _builtins.str, role_arn: _builtins.str, object_version: Optional[_builtins.str] = ...) -> None:
...
class FleetCertificateConfiguration(dict):
    ...
    def __init__(__self__, *, certificate_type: Optional[_builtins.str] = ...) -> None:
...
class FleetEc2InboundPermission(dict):
    ...
    def __init__(__self__, *, from_port: _builtins.int, ip_range: _builtins.str, protocol: _builtins.str, to_port: _builtins.int) -> None:
...
class FleetResourceCreationLimitPolicy(dict):
    ...
    def __init__(__self__, *, new_game_sessions_per_creator: Optional[_builtins.int] = ..., policy_period_in_minutes: Optional[_builtins.int] = ...) -> None:
...
class FleetRuntimeConfiguration(dict):
    ...
    def __init__(__self__, *, game_session_activation_timeout_seconds: Optional[_builtins.int] = ..., max_concurrent_game_session_activations: Optional[_builtins.int] = ..., server_processes: Optional[Sequence[outputs.FleetRuntimeConfigurationServerProcess]] = ...) -> None:
...
class FleetRuntimeConfigurationServerProcess(dict):
    ...
    def __init__(__self__, *, concurrent_executions: _builtins.int, launch_path: _builtins.str, parameters: Optional[_builtins.str] = ...) -> None:
...
class GameServerGroupAutoScalingPolicy(dict):
    ...
    def __init__(__self__, *, target_tracking_configuration: outputs.GameServerGroupAutoScalingPolicyTargetTrackingConfiguration, estimated_instance_warmup: Optional[_builtins.int] = ...) -> None:
...
class GameServerGroupInstanceDefinition(dict):
    ...
    def __init__(__self__, *, instance_type: _builtins.str, weighted_capacity: Optional[_builtins.str] = ...) -> None:
...
class GameSessionQueuePlayerLatencyPolicy(dict):
    ...
    def __init__(__self__, *, maximum_individual_player_latency_milliseconds: _builtins.int, policy_duration_seconds: Optional[_builtins.int] = ...) -> None:
