...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AliasRoutingStrategyArgs', 'AliasRoutingStrategyArgsDict', 'BuildStorageLocationArgs', 'BuildStorageLocationArgsDict', 'FleetCertificateConfigurationArgs', 'FleetCertificateConfigurationArgsDict', 'FleetEc2InboundPermissionArgs', 'FleetEc2InboundPermissionArgsDict', 'FleetResourceCreationLimitPolicyArgs', 'FleetResourceCreationLimitPolicyArgsDict', 'FleetRuntimeConfigurationArgs', 'FleetRuntimeConfigurationArgsDict', 'FleetRuntimeConfigurationServerProcessArgs', 'FleetRuntimeConfigurationServerProcessArgsDict', 'GameServerGroupAutoScalingPolicyArgs', 'GameServerGroupAutoScalingPolicyArgsDict', ..., ..., 'GameServerGroupInstanceDefinitionArgs', 'GameServerGroupInstanceDefinitionArgsDict', 'GameServerGroupLaunchTemplateArgs', 'GameServerGroupLaunchTemplateArgsDict', 'GameSessionQueuePlayerLatencyPolicyArgs', 'GameSessionQueuePlayerLatencyPolicyArgsDict', 'ScriptStorageLocationArgs', 'ScriptStorageLocationArgsDict']
...
class AliasRoutingStrategyArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], fleet_id: Optional[pulumi.Input[_builtins.str]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @fleet_id.setter
    def fleet_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BuildStorageLocationArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], key: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], object_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FleetCertificateConfigurationArgs:
    def __init__(__self__, *, certificate_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def certificate_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FleetEc2InboundPermissionArgs:
    def __init__(__self__, *, from_port: pulumi.Input[_builtins.int], ip_range: pulumi.Input[_builtins.str], protocol: pulumi.Input[_builtins.str], to_port: pulumi.Input[_builtins.int]) -> None:
...
class FleetResourceCreationLimitPolicyArgs:
    def __init__(__self__, *, new_game_sessions_per_creator: Optional[pulumi.Input[_builtins.int]] = ..., policy_period_in_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def new_game_sessions_per_creator(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def policy_period_in_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class FleetRuntimeConfigurationArgs:
    def __init__(__self__, *, game_session_activation_timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ..., max_concurrent_game_session_activations: Optional[pulumi.Input[_builtins.int]] = ..., server_processes: Optional[pulumi.Input[Sequence[pulumi.Input[FleetRuntimeConfigurationServerProcessArgs]]]] = ...) -> None:
    ...
    def game_session_activation_timeout_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_concurrent_game_session_activations(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def server_processes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FleetRuntimeConfigurationServerProcessArgs]]]]): # -> None:
        ...
...
class FleetRuntimeConfigurationServerProcessArgs:
    def __init__(__self__, *, concurrent_executions: pulumi.Input[_builtins.int], launch_path: pulumi.Input[_builtins.str], parameters: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def concurrent_executions(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @launch_path.setter
    def launch_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class GameServerGroupAutoScalingPolicyArgs:
    def __init__(__self__, *, target_tracking_configuration: pulumi.Input[GameServerGroupAutoScalingPolicyTargetTrackingConfigurationArgs], estimated_instance_warmup: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def target_tracking_configuration(self, value: pulumi.Input[GameServerGroupAutoScalingPolicyTargetTrackingConfigurationArgs]): # -> None:
        ...
...
class GameServerGroupInstanceDefinitionArgs:
    def __init__(__self__, *, instance_type: pulumi.Input[_builtins.str], weighted_capacity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class GameSessionQueuePlayerLatencyPolicyArgs:
    def __init__(__self__, *, maximum_individual_player_latency_milliseconds: pulumi.Input[_builtins.int], policy_duration_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def maximum_individual_player_latency_milliseconds(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def policy_duration_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
