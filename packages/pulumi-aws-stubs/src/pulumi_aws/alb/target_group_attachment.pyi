...
class TargetGroupAttachmentArgs:
    def __init__(__self__, *, target_group_arn: pulumi.Input[_builtins.str], target_id: pulumi.Input[_builtins.str], availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., quic_server_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def quic_server_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class _TargetGroupAttachmentState:
    def __init__(__self__, *, availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., quic_server_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., target_group_arn: Optional[pulumi.Input[_builtins.str]] = ..., target_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TargetGroupAttachment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., quic_server_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., target_group_arn: Optional[pulumi.Input[_builtins.str]] = ..., target_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., quic_server_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., target_group_arn: Optional[pulumi.Input[_builtins.str]] = ..., target_id: Optional[pulumi.Input[_builtins.str]] = ...) -> TargetGroupAttachment:
