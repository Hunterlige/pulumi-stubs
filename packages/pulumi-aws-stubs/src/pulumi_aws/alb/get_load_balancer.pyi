...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetLoadBalancerResult', 'AwaitableGetLoadBalancerResult', 'get_load_balancer', 'get_load_balancer_output']
@pulumi.output_type
class GetLoadBalancerResult:
    
    def __init__(__self__, access_logs=..., arn=..., arn_suffix=..., client_keep_alive=..., connection_logs=..., customer_owned_ipv4_pool=..., desync_mitigation_mode=..., dns_name=..., dns_record_client_routing_policy=..., drop_invalid_header_fields=..., enable_cross_zone_load_balancing=..., enable_deletion_protection=..., enable_http2=..., enable_tls_version_and_cipher_suite_headers=..., enable_waf_fail_open=..., enable_xff_client_port=..., enable_zonal_shift=..., enforce_security_group_inbound_rules_on_private_link_traffic=..., health_check_logs=..., id=..., idle_timeout=..., internal=..., ip_address_type=..., ipam_pools=..., load_balancer_type=..., name=..., preserve_host_header=..., region=..., secondary_ips_auto_assigned_per_subnet=..., security_groups=..., subnet_mappings=..., subnets=..., tags=..., vpc_id=..., xff_header_processing_mode=..., zone_id=...) -> None:
        ...
...
class AwaitableGetLoadBalancerResult(GetLoadBalancerResult):
    def __await__(self): # -> Generator[Never, Any, GetLoadBalancerResult]:
        ...
    


def get_load_balancer(arn: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetLoadBalancerResult:
    
    ...

def get_load_balancer_output(arn: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., name: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetLoadBalancerResult]:
