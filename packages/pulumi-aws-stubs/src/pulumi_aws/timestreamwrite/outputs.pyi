...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['TableMagneticStoreWriteProperties', ..., ..., 'TableRetentionProperties', 'TableSchema', 'TableSchemaCompositePartitionKey', 'GetTableMagneticStoreWritePropertyResult', ..., ..., 'GetTableRetentionPropertyResult', 'GetTableSchemaResult', 'GetTableSchemaCompositePartitionKeyResult']
@pulumi.output_type
class TableMagneticStoreWriteProperties(dict):
    ...
    def __init__(__self__, *, enable_magnetic_store_writes: Optional[_builtins.bool] = ..., magnetic_store_rejected_data_location: Optional[outputs.TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocation] = ...) -> None:
...
class TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_name: Optional[_builtins.str] = ..., encryption_option: Optional[_builtins.str] = ..., kms_key_id: Optional[_builtins.str] = ..., object_key_prefix: Optional[_builtins.str] = ...) -> None:
...
class TableRetentionProperties(dict):
    ...
    def __init__(__self__, *, magnetic_store_retention_period_in_days: _builtins.int, memory_store_retention_period_in_hours: _builtins.int) -> None:
...
class TableSchema(dict):
    ...
    def __init__(__self__, *, composite_partition_key: Optional[outputs.TableSchemaCompositePartitionKey] = ...) -> None:
...
class TableSchemaCompositePartitionKey(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, enforcement_in_record: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class GetTableMagneticStoreWritePropertyResult(dict):
    def __init__(__self__, *, enable_magnetic_store_writes: _builtins.bool, magnetic_store_rejected_data_locations: Sequence[outputs.GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocationResult]) -> None:
...
class GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocationResult(dict):
    def __init__(__self__, *, s3_configurations: Sequence[outputs.GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocationS3ConfigurationResult]) -> None:
...
class GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocationS3ConfigurationResult(dict):
    def __init__(__self__, *, bucket_name: _builtins.str, encryption_option: _builtins.str, kms_key_id: _builtins.str, object_key_prefix: _builtins.str) -> None:
...
class GetTableSchemaResult(dict):
    def __init__(__self__, *, composite_partition_keys: Sequence[outputs.GetTableSchemaCompositePartitionKeyResult]) -> None:
        ...
...
class GetTableSchemaCompositePartitionKeyResult(dict):
    def __init__(__self__, *, enforcement_in_record: _builtins.str, name: _builtins.str, type: _builtins.str) -> None:
