...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['TableMagneticStoreWritePropertiesArgs', 'TableMagneticStoreWritePropertiesArgsDict', ..., ..., ..., ..., 'TableRetentionPropertiesArgs', 'TableRetentionPropertiesArgsDict', 'TableSchemaArgs', 'TableSchemaArgsDict', 'TableSchemaCompositePartitionKeyArgs', 'TableSchemaCompositePartitionKeyArgsDict']
...
class TableMagneticStoreWritePropertiesArgs:
    def __init__(__self__, *, enable_magnetic_store_writes: Optional[pulumi.Input[_builtins.bool]] = ..., magnetic_store_rejected_data_location: Optional[pulumi.Input[TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationArgs]] = ...) -> None:
    ...
    def enable_magnetic_store_writes(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def magnetic_store_rejected_data_location(self, value: Optional[pulumi.Input[TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationArgs]]): # -> None:
        ...
...
class TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationArgs:
    def __init__(__self__, *, s3_configuration: Optional[pulumi.Input[TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationS3ConfigurationArgs]] = ...) -> None:
    ...
    def s3_configuration(self, value: Optional[pulumi.Input[TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationS3ConfigurationArgs]]): # -> None:
        ...
...
class TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationS3ConfigurationArgs:
    def __init__(__self__, *, bucket_name: Optional[pulumi.Input[_builtins.str]] = ..., encryption_option: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., object_key_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TableRetentionPropertiesArgs:
    def __init__(__self__, *, magnetic_store_retention_period_in_days: pulumi.Input[_builtins.int], memory_store_retention_period_in_hours: pulumi.Input[_builtins.int]) -> None:
    ...
    def magnetic_store_retention_period_in_days(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def memory_store_retention_period_in_hours(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class TableSchemaArgs:
    def __init__(__self__, *, composite_partition_key: Optional[pulumi.Input[TableSchemaCompositePartitionKeyArgs]] = ...) -> None:
    ...
    def composite_partition_key(self, value: Optional[pulumi.Input[TableSchemaCompositePartitionKeyArgs]]): # -> None:
        ...
...
class TableSchemaCompositePartitionKeyArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], enforcement_in_record: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def enforcement_in_record(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
