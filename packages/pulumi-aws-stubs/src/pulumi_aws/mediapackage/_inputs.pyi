...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ChannelHlsIngestArgs', 'ChannelHlsIngestArgsDict', 'ChannelHlsIngestIngestEndpointArgs', 'ChannelHlsIngestIngestEndpointArgsDict']
...
class ChannelHlsIngestArgs:
    def __init__(__self__, *, ingest_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[ChannelHlsIngestIngestEndpointArgs]]]] = ...) -> None:
    ...
    def ingest_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ChannelHlsIngestIngestEndpointArgs]]]]): # -> None:
        ...
...
class ChannelHlsIngestIngestEndpointArgs:
    def __init__(__self__, *, password: Optional[pulumi.Input[_builtins.str]] = ..., url: Optional[pulumi.Input[_builtins.str]] = ..., username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
