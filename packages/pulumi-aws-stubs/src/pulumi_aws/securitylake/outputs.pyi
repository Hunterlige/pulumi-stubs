...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AwsLogSourceSource', 'CustomLogSourceAttribute', 'CustomLogSourceConfiguration', 'CustomLogSourceConfigurationCrawlerConfiguration', 'CustomLogSourceConfigurationProviderIdentity', 'CustomLogSourceProviderDetail', 'DataLakeConfiguration', 'DataLakeConfigurationEncryptionConfiguration', 'DataLakeConfigurationLifecycleConfiguration', ..., ..., 'DataLakeConfigurationReplicationConfiguration', 'DataLakeTimeouts', 'SubscriberNotificationConfiguration', ..., ..., 'SubscriberSource', 'SubscriberSourceAwsLogSourceResource', 'SubscriberSourceCustomLogSourceResource', 'SubscriberSourceCustomLogSourceResourceAttribute', 'SubscriberSourceCustomLogSourceResourceProvider', 'SubscriberSubscriberIdentity', 'SubscriberTimeouts']
@pulumi.output_type
class AwsLogSourceSource(dict):
    ...
    def __init__(__self__, *, regions: Sequence[_builtins.str], source_name: _builtins.str, accounts: Optional[Sequence[_builtins.str]] = ..., source_version: Optional[_builtins.str] = ...) -> None:
...
class CustomLogSourceAttribute(dict):
    ...
    def __init__(__self__, *, crawler_arn: _builtins.str, database_arn: _builtins.str, table_arn: _builtins.str) -> None:
...
class CustomLogSourceConfiguration(dict):
    ...
    def __init__(__self__, *, crawler_configuration: outputs.CustomLogSourceConfigurationCrawlerConfiguration, provider_identity: outputs.CustomLogSourceConfigurationProviderIdentity) -> None:
...
class CustomLogSourceConfigurationProviderIdentity(dict):
    ...
    def __init__(__self__, *, external_id: _builtins.str, principal: _builtins.str) -> None:
...
class CustomLogSourceProviderDetail(dict):
    ...
    def __init__(__self__, *, location: _builtins.str, role_arn: _builtins.str) -> None:
...
class DataLakeConfiguration(dict):
    ...
    def __init__(__self__, *, region: _builtins.str, encryption_configurations: Optional[Sequence[outputs.DataLakeConfigurationEncryptionConfiguration]] = ..., lifecycle_configuration: Optional[outputs.DataLakeConfigurationLifecycleConfiguration] = ..., replication_configuration: Optional[outputs.DataLakeConfigurationReplicationConfiguration] = ...) -> None:
...
class DataLakeConfigurationLifecycleConfiguration(dict):
    def __init__(__self__, *, expiration: Optional[outputs.DataLakeConfigurationLifecycleConfigurationExpiration] = ..., transitions: Optional[Sequence[outputs.DataLakeConfigurationLifecycleConfigurationTransition]] = ...) -> None:
...
class DataLakeConfigurationLifecycleConfigurationTransition(dict):
    ...
    def __init__(__self__, *, days: Optional[_builtins.int] = ..., storage_class: Optional[_builtins.str] = ...) -> None:
...
class DataLakeConfigurationReplicationConfiguration(dict):
    ...
    def __init__(__self__, *, regions: Optional[Sequence[_builtins.str]] = ..., role_arn: Optional[_builtins.str] = ...) -> None:
...
class SubscriberNotificationConfiguration(dict):
    ...
    def __init__(__self__, *, https_notification_configuration: Optional[outputs.SubscriberNotificationConfigurationHttpsNotificationConfiguration] = ..., sqs_notification_configuration: Optional[outputs.SubscriberNotificationConfigurationSqsNotificationConfiguration] = ...) -> None:
...
class SubscriberNotificationConfigurationHttpsNotificationConfiguration(dict):
    ...
    def __init__(__self__, *, endpoint: _builtins.str, target_role_arn: _builtins.str, authorization_api_key_name: Optional[_builtins.str] = ..., authorization_api_key_value: Optional[_builtins.str] = ..., http_method: Optional[_builtins.str] = ...) -> None:
...
class SubscriberSource(dict):
    ...
    def __init__(__self__, *, aws_log_source_resource: Optional[outputs.SubscriberSourceAwsLogSourceResource] = ..., custom_log_source_resource: Optional[outputs.SubscriberSourceCustomLogSourceResource] = ...) -> None:
...
class SubscriberSourceAwsLogSourceResource(dict):
    ...
    def __init__(__self__, *, source_name: _builtins.str, source_version: Optional[_builtins.str] = ...) -> None:
...
class SubscriberSourceCustomLogSourceResource(dict):
    ...
    def __init__(__self__, *, source_name: _builtins.str, attributes: Optional[Sequence[outputs.SubscriberSourceCustomLogSourceResourceAttribute]] = ..., providers: Optional[Sequence[outputs.SubscriberSourceCustomLogSourceResourceProvider]] = ..., source_version: Optional[_builtins.str] = ...) -> None:
