...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClassificationExportConfigurationS3Destination', 'ClassificationJobS3JobDefinition', 'ClassificationJobS3JobDefinitionBucketCriteria', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ClassificationJobS3JobDefinitionBucketDefinition', 'ClassificationJobS3JobDefinitionScoping', 'ClassificationJobS3JobDefinitionScopingExcludes', 'ClassificationJobS3JobDefinitionScopingExcludesAnd', ..., ..., ..., 'ClassificationJobS3JobDefinitionScopingIncludes', 'ClassificationJobS3JobDefinitionScopingIncludesAnd', ..., ..., ..., 'ClassificationJobScheduleFrequency', 'ClassificationJobUserPausedDetail']
@pulumi.output_type
class ClassificationExportConfigurationS3Destination(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, kms_key_arn: _builtins.str, key_prefix: Optional[_builtins.str] = ...) -> None:
...
class ClassificationJobS3JobDefinition(dict):
    ...
    def __init__(__self__, *, bucket_criteria: Optional[outputs.ClassificationJobS3JobDefinitionBucketCriteria] = ..., bucket_definitions: Optional[Sequence[outputs.ClassificationJobS3JobDefinitionBucketDefinition]] = ..., scoping: Optional[outputs.ClassificationJobS3JobDefinitionScoping] = ...) -> None:
...
class ClassificationJobS3JobDefinitionBucketCriteria(dict):
    def __init__(__self__, *, excludes: Optional[outputs.ClassificationJobS3JobDefinitionBucketCriteriaExcludes] = ..., includes: Optional[outputs.ClassificationJobS3JobDefinitionBucketCriteriaIncludes] = ...) -> None:
...
class ClassificationJobS3JobDefinitionBucketCriteriaExcludes(dict):
    def __init__(__self__, *, ands: Optional[Sequence[outputs.ClassificationJobS3JobDefinitionBucketCriteriaExcludesAnd]] = ...) -> None:
...
class ClassificationJobS3JobDefinitionBucketCriteriaExcludesAnd(dict):
    ...
    def __init__(__self__, *, simple_criterion: Optional[outputs.ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndSimpleCriterion] = ..., tag_criterion: Optional[outputs.ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterion] = ...) -> None:
...
class ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndSimpleCriterion(dict):
    def __init__(__self__, *, comparator: Optional[_builtins.str] = ..., key: Optional[_builtins.str] = ..., values: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterion(dict):
    ...
    def __init__(__self__, *, comparator: Optional[_builtins.str] = ..., tag_values: Optional[Sequence[outputs.ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterionTagValue]] = ...) -> None:
...
class ClassificationJobS3JobDefinitionBucketCriteriaIncludes(dict):
    def __init__(__self__, *, ands: Optional[Sequence[outputs.ClassificationJobS3JobDefinitionBucketCriteriaIncludesAnd]] = ...) -> None:
...
class ClassificationJobS3JobDefinitionBucketCriteriaIncludesAnd(dict):
    ...
    def __init__(__self__, *, simple_criterion: Optional[outputs.ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndSimpleCriterion] = ..., tag_criterion: Optional[outputs.ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterion] = ...) -> None:
...
class ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterion(dict):
    ...
    def __init__(__self__, *, comparator: Optional[_builtins.str] = ..., tag_values: Optional[Sequence[outputs.ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterionTagValue]] = ...) -> None:
...
class ClassificationJobS3JobDefinitionBucketDefinition(dict):
    ...
    def __init__(__self__, *, account_id: _builtins.str, buckets: Sequence[_builtins.str]) -> None:
...
class ClassificationJobS3JobDefinitionScoping(dict):
    def __init__(__self__, *, excludes: Optional[outputs.ClassificationJobS3JobDefinitionScopingExcludes] = ..., includes: Optional[outputs.ClassificationJobS3JobDefinitionScopingIncludes] = ...) -> None:
...
class ClassificationJobS3JobDefinitionScopingExcludes(dict):
    def __init__(__self__, *, ands: Optional[Sequence[outputs.ClassificationJobS3JobDefinitionScopingExcludesAnd]] = ...) -> None:
...
class ClassificationJobS3JobDefinitionScopingExcludesAnd(dict):
    ...
    def __init__(__self__, *, simple_scope_term: Optional[outputs.ClassificationJobS3JobDefinitionScopingExcludesAndSimpleScopeTerm] = ..., tag_scope_term: Optional[outputs.ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTerm] = ...) -> None:
...
class ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTerm(dict):
    ...
    def __init__(__self__, *, comparator: Optional[_builtins.str] = ..., key: Optional[_builtins.str] = ..., tag_values: Optional[Sequence[outputs.ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValue]] = ..., target: Optional[_builtins.str] = ...) -> None:
...
class ClassificationJobS3JobDefinitionScopingIncludes(dict):
    def __init__(__self__, *, ands: Optional[Sequence[outputs.ClassificationJobS3JobDefinitionScopingIncludesAnd]] = ...) -> None:
...
class ClassificationJobS3JobDefinitionScopingIncludesAnd(dict):
    ...
    def __init__(__self__, *, simple_scope_term: Optional[outputs.ClassificationJobS3JobDefinitionScopingIncludesAndSimpleScopeTerm] = ..., tag_scope_term: Optional[outputs.ClassificationJobS3JobDefinitionScopingIncludesAndTagScopeTerm] = ...) -> None:
...
class ClassificationJobS3JobDefinitionScopingIncludesAndTagScopeTerm(dict):
    ...
    def __init__(__self__, *, comparator: Optional[_builtins.str] = ..., key: Optional[_builtins.str] = ..., tag_values: Optional[Sequence[outputs.ClassificationJobS3JobDefinitionScopingIncludesAndTagScopeTermTagValue]] = ..., target: Optional[_builtins.str] = ...) -> None:
...
class ClassificationJobScheduleFrequency(dict):
    ...
    def __init__(__self__, *, daily_schedule: Optional[_builtins.bool] = ..., monthly_schedule: Optional[_builtins.int] = ..., weekly_schedule: Optional[_builtins.str] = ...) -> None:
...
class ClassificationJobUserPausedDetail(dict):
    ...
    def __init__(__self__, *, job_expires_at: Optional[_builtins.str] = ..., job_imminent_expiration_health_event_arn: Optional[_builtins.str] = ..., job_paused_at: Optional[_builtins.str] = ...) -> None:
        ...
