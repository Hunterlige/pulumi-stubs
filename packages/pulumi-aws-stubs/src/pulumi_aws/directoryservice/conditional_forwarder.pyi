...
class ConditionalForwarderArgs:
    def __init__(__self__, *, directory_id: pulumi.Input[_builtins.str], dns_ips: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], remote_domain_name: pulumi.Input[_builtins.str], region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class _ConditionalForwarderState:
    def __init__(__self__, *, directory_id: Optional[pulumi.Input[_builtins.str]] = ..., dns_ips: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., remote_domain_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ConditionalForwarder(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., directory_id: Optional[pulumi.Input[_builtins.str]] = ..., dns_ips: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., remote_domain_name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ConditionalForwarderArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., directory_id: Optional[pulumi.Input[_builtins.str]] = ..., dns_ips: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., remote_domain_name: Optional[pulumi.Input[_builtins.str]] = ...) -> ConditionalForwarder:
