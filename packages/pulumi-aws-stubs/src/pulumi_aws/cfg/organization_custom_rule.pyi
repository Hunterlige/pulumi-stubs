...
class _OrganizationCustomRuleState:
    def __init__(__self__, *, arn: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., excluded_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., input_parameters: Optional[pulumi.Input[_builtins.str]] = ..., lambda_function_arn: Optional[pulumi.Input[_builtins.str]] = ..., maximum_execution_frequency: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., resource_id_scope: Optional[pulumi.Input[_builtins.str]] = ..., resource_types_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tag_key_scope: Optional[pulumi.Input[_builtins.str]] = ..., tag_value_scope: Optional[pulumi.Input[_builtins.str]] = ..., trigger_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class OrganizationCustomRule(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: OrganizationCustomRuleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., arn: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., excluded_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., input_parameters: Optional[pulumi.Input[_builtins.str]] = ..., lambda_function_arn: Optional[pulumi.Input[_builtins.str]] = ..., maximum_execution_frequency: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., resource_id_scope: Optional[pulumi.Input[_builtins.str]] = ..., resource_types_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tag_key_scope: Optional[pulumi.Input[_builtins.str]] = ..., tag_value_scope: Optional[pulumi.Input[_builtins.str]] = ..., trigger_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> OrganizationCustomRule:
