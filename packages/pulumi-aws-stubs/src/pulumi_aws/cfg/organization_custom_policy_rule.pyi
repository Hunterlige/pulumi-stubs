...
class OrganizationCustomPolicyRuleArgs:
    ...
    def trigger_types(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def debug_log_delivery_accounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class _OrganizationCustomPolicyRuleState:
    def __init__(__self__, *, arn: Optional[pulumi.Input[_builtins.str]] = ..., debug_log_delivery_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., excluded_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., input_parameters: Optional[pulumi.Input[_builtins.str]] = ..., maximum_execution_frequency: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., policy_runtime: Optional[pulumi.Input[_builtins.str]] = ..., policy_text: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., resource_id_scope: Optional[pulumi.Input[_builtins.str]] = ..., resource_types_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tag_key_scope: Optional[pulumi.Input[_builtins.str]] = ..., tag_value_scope: Optional[pulumi.Input[_builtins.str]] = ..., trigger_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @policy_runtime.setter
    def policy_runtime(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @policy_text.setter
    def policy_text(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @trigger_types.setter
    def trigger_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class OrganizationCustomPolicyRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., debug_log_delivery_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., excluded_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., input_parameters: Optional[pulumi.Input[_builtins.str]] = ..., maximum_execution_frequency: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., policy_runtime: Optional[pulumi.Input[_builtins.str]] = ..., policy_text: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., resource_id_scope: Optional[pulumi.Input[_builtins.str]] = ..., resource_types_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tag_key_scope: Optional[pulumi.Input[_builtins.str]] = ..., tag_value_scope: Optional[pulumi.Input[_builtins.str]] = ..., trigger_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: OrganizationCustomPolicyRuleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., arn: Optional[pulumi.Input[_builtins.str]] = ..., debug_log_delivery_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., excluded_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., input_parameters: Optional[pulumi.Input[_builtins.str]] = ..., maximum_execution_frequency: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., policy_runtime: Optional[pulumi.Input[_builtins.str]] = ..., policy_text: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., resource_id_scope: Optional[pulumi.Input[_builtins.str]] = ..., resource_types_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tag_key_scope: Optional[pulumi.Input[_builtins.str]] = ..., tag_value_scope: Optional[pulumi.Input[_builtins.str]] = ..., trigger_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> OrganizationCustomPolicyRule:
