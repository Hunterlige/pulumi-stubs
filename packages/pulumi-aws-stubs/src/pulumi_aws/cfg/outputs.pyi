...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConfigurationAggregatorAccountAggregationSource', ..., 'ConformancePackInputParameter', 'DeliveryChannelSnapshotDeliveryProperties', 'OrganizationConformancePackInputParameter', 'RecorderRecordingGroup', 'RecorderRecordingGroupExclusionByResourceType', 'RecorderRecordingGroupRecordingStrategy', 'RecorderRecordingMode', 'RecorderRecordingModeRecordingModeOverride', 'RemediationConfigurationExecutionControls', ..., 'RemediationConfigurationParameter', 'RuleEvaluationMode', 'RuleScope', 'RuleSource', 'RuleSourceCustomPolicyDetails', 'RuleSourceSourceDetail']
@pulumi.output_type
class ConfigurationAggregatorAccountAggregationSource(dict):
    ...
    def __init__(__self__, *, account_ids: Sequence[_builtins.str], all_regions: Optional[_builtins.bool] = ..., regions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ConfigurationAggregatorOrganizationAggregationSource(dict):
    ...
    def __init__(__self__, *, role_arn: _builtins.str, all_regions: Optional[_builtins.bool] = ..., regions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DeliveryChannelSnapshotDeliveryProperties(dict):
    ...
    def __init__(__self__, *, delivery_frequency: Optional[_builtins.str] = ...) -> None:
...
class RecorderRecordingGroup(dict):
    ...
    def __init__(__self__, *, all_supported: Optional[_builtins.bool] = ..., exclusion_by_resource_types: Optional[Sequence[outputs.RecorderRecordingGroupExclusionByResourceType]] = ..., include_global_resource_types: Optional[_builtins.bool] = ..., recording_strategies: Optional[Sequence[outputs.RecorderRecordingGroupRecordingStrategy]] = ..., resource_types: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class RecorderRecordingGroupExclusionByResourceType(dict):
    ...
    def __init__(__self__, *, resource_types: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class RecorderRecordingMode(dict):
    ...
    def __init__(__self__, *, recording_frequency: Optional[_builtins.str] = ..., recording_mode_override: Optional[outputs.RecorderRecordingModeRecordingModeOverride] = ...) -> None:
...
class RecorderRecordingModeRecordingModeOverride(dict):
    ...
    def __init__(__self__, *, recording_frequency: _builtins.str, resource_types: Sequence[_builtins.str], description: Optional[_builtins.str] = ...) -> None:
...
class RemediationConfigurationExecutionControls(dict):
    ...
    def __init__(__self__, *, ssm_controls: Optional[outputs.RemediationConfigurationExecutionControlsSsmControls] = ...) -> None:
...
class RemediationConfigurationExecutionControlsSsmControls(dict):
    ...
    def __init__(__self__, *, concurrent_execution_rate_percentage: Optional[_builtins.int] = ..., error_percentage: Optional[_builtins.int] = ...) -> None:
...
class RemediationConfigurationParameter(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, resource_value: Optional[_builtins.str] = ..., static_value: Optional[_builtins.str] = ..., static_values: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class RuleScope(dict):
    ...
    def __init__(__self__, *, compliance_resource_id: Optional[_builtins.str] = ..., compliance_resource_types: Optional[Sequence[_builtins.str]] = ..., tag_key: Optional[_builtins.str] = ..., tag_value: Optional[_builtins.str] = ...) -> None:
...
class RuleSource(dict):
    ...
    def __init__(__self__, *, owner: _builtins.str, custom_policy_details: Optional[outputs.RuleSourceCustomPolicyDetails] = ..., source_details: Optional[Sequence[outputs.RuleSourceSourceDetail]] = ..., source_identifier: Optional[_builtins.str] = ...) -> None:
...
class RuleSourceCustomPolicyDetails(dict):
    ...
    def __init__(__self__, *, policy_runtime: _builtins.str, policy_text: _builtins.str, enable_debug_log_delivery: Optional[_builtins.bool] = ...) -> None:
...
class RuleSourceSourceDetail(dict):
    ...
    def __init__(__self__, *, event_source: Optional[_builtins.str] = ..., maximum_execution_frequency: Optional[_builtins.str] = ..., message_type: Optional[_builtins.str] = ...) -> None:
