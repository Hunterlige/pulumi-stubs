    ...
    def __init__(
        ...
        *,
        ...
        input_parameters: Optional[
            pulumi.Input[
                Sequence[pulumi.Input[OrganizationConformancePackInputParameterArgs]]
            ]
        ] = ...,
...
class OrganizationConformancePack(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[OrganizationConformancePackArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
    ...
    def input_parameters(
        ...
        Optional[Sequence[outputs.OrganizationConformancePackInputParameter]]
    ]: ...
    @_builtins.property
    @pulumi.getter
