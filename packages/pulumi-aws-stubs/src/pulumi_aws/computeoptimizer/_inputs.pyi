...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EnrollmentStatusTimeoutsArgs', 'EnrollmentStatusTimeoutsArgsDict', ..., ..., 'RecommendationPreferencesPreferredResourceArgs', 'RecommendationPreferencesPreferredResourceArgsDict', 'RecommendationPreferencesScopeArgs', 'RecommendationPreferencesScopeArgsDict', 'RecommendationPreferencesUtilizationPreferenceArgs', ..., ..., ...]
...
class RecommendationPreferencesPreferredResourceArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], exclude_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., include_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def exclude_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def include_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RecommendationPreferencesUtilizationPreferenceArgs:
    def __init__(__self__, *, metric_name: pulumi.Input[_builtins.str], metric_parameters: pulumi.Input[RecommendationPreferencesUtilizationPreferenceMetricParametersArgs]) -> None:
    ...
    def metric_parameters(self, value: pulumi.Input[RecommendationPreferencesUtilizationPreferenceMetricParametersArgs]): # -> None:
        ...
...
class RecommendationPreferencesUtilizationPreferenceMetricParametersArgs:
    def __init__(__self__, *, headroom: pulumi.Input[_builtins.str], threshold: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @headroom.setter
    def headroom(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
