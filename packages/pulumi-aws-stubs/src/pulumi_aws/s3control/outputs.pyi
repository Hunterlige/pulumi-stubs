...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessGrantAccessGrantsLocationConfiguration', 'AccessGrantGrantee', 'BucketLifecycleConfigurationRule', ..., 'BucketLifecycleConfigurationRuleExpiration', 'BucketLifecycleConfigurationRuleFilter', 'DirectoryBucketAccessPointScopeScope', 'MultiRegionAccessPointDetails', 'MultiRegionAccessPointDetailsPublicAccessBlock', 'MultiRegionAccessPointDetailsRegion', 'MultiRegionAccessPointPolicyDetails', 'ObjectLambdaAccessPointConfiguration', ..., ..., ..., 'StorageLensConfigurationStorageLensConfiguration', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetAccessPointsAccessPointResult', 'GetAccessPointsAccessPointVpcConfigurationResult', 'GetMultiRegionAccessPointPublicAccessBlockResult', 'GetMultiRegionAccessPointRegionResult', 'GetMultiRegionAccessPointsAccessPointResult', ..., 'GetMultiRegionAccessPointsAccessPointRegionResult']
@pulumi.output_type
...
class AccessGrantGrantee(dict):
    ...
    def __init__(__self__, *, grantee_identifier: _builtins.str, grantee_type: _builtins.str) -> None:
...
class BucketLifecycleConfigurationRule(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, abort_incomplete_multipart_upload: Optional[outputs.BucketLifecycleConfigurationRuleAbortIncompleteMultipartUpload] = ..., expiration: Optional[outputs.BucketLifecycleConfigurationRuleExpiration] = ..., filter: Optional[outputs.BucketLifecycleConfigurationRuleFilter] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class DirectoryBucketAccessPointScopeScope(dict):
    def __init__(__self__, *, permissions: Optional[Sequence[_builtins.str]] = ..., prefixes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class MultiRegionAccessPointDetails(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, regions: Sequence[outputs.MultiRegionAccessPointDetailsRegion], public_access_block: Optional[outputs.MultiRegionAccessPointDetailsPublicAccessBlock] = ...) -> None:
...
class MultiRegionAccessPointDetailsRegion(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, bucket_account_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ...) -> None:
...
class ObjectLambdaAccessPointConfiguration(dict):
    ...
    def __init__(__self__, *, supporting_access_point: _builtins.str, transformation_configurations: Sequence[outputs.ObjectLambdaAccessPointConfigurationTransformationConfiguration], allowed_features: Optional[Sequence[_builtins.str]] = ..., cloud_watch_metrics_enabled: Optional[_builtins.bool] = ...) -> None:
...
class ObjectLambdaAccessPointConfigurationTransformationConfiguration(dict):
    ...
    def __init__(__self__, *, actions: Sequence[_builtins.str], content_transformation: outputs.ObjectLambdaAccessPointConfigurationTransformationConfigurationContentTransformation) -> None:
...
class ObjectLambdaAccessPointConfigurationTransformationConfigurationContentTransformation(dict):
    ...
    def __init__(__self__, *, aws_lambda: outputs.ObjectLambdaAccessPointConfigurationTransformationConfigurationContentTransformationAwsLambda) -> None:
...
class ObjectLambdaAccessPointConfigurationTransformationConfigurationContentTransformationAwsLambda(dict):
    ...
    def __init__(__self__, *, function_arn: _builtins.str, function_payload: Optional[_builtins.str] = ...) -> None:
...
class StorageLensConfigurationStorageLensConfiguration(dict):
    ...
    def __init__(__self__, *, account_level: outputs.StorageLensConfigurationStorageLensConfigurationAccountLevel, enabled: _builtins.bool, aws_org: Optional[outputs.StorageLensConfigurationStorageLensConfigurationAwsOrg] = ..., data_export: Optional[outputs.StorageLensConfigurationStorageLensConfigurationDataExport] = ..., exclude: Optional[outputs.StorageLensConfigurationStorageLensConfigurationExclude] = ..., include: Optional[outputs.StorageLensConfigurationStorageLensConfigurationInclude] = ...) -> None:
...
class StorageLensConfigurationStorageLensConfigurationAccountLevel(dict):
    ...
    def __init__(__self__, *, bucket_level: outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevel, activity_metrics: Optional[outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelActivityMetrics] = ..., advanced_cost_optimization_metrics: Optional[outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelAdvancedCostOptimizationMetrics] = ..., advanced_data_protection_metrics: Optional[outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelAdvancedDataProtectionMetrics] = ..., detailed_status_code_metrics: Optional[outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelDetailedStatusCodeMetrics] = ...) -> None:
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevel(dict):
    ...
    def __init__(__self__, *, activity_metrics: Optional[outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelActivityMetrics] = ..., advanced_cost_optimization_metrics: Optional[outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelAdvancedCostOptimizationMetrics] = ..., advanced_data_protection_metrics: Optional[outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelAdvancedDataProtectionMetrics] = ..., detailed_status_code_metrics: Optional[outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelDetailedStatusCodeMetrics] = ..., prefix_level: Optional[outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevel] = ...) -> None:
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevel(dict):
    ...
    def __init__(__self__, *, storage_metrics: outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetrics) -> None:
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetrics(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., selection_criteria: Optional[outputs.StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetricsSelectionCriteria] = ...) -> None:
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetricsSelectionCriteria(dict):
    ...
    def __init__(__self__, *, delimiter: Optional[_builtins.str] = ..., max_depth: Optional[_builtins.int] = ..., min_storage_bytes_percentage: Optional[_builtins.float] = ...) -> None:
...
class StorageLensConfigurationStorageLensConfigurationDataExport(dict):
    ...
    def __init__(__self__, *, cloud_watch_metrics: Optional[outputs.StorageLensConfigurationStorageLensConfigurationDataExportCloudWatchMetrics] = ..., s3_bucket_destination: Optional[outputs.StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestination] = ...) -> None:
...
class StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestination(dict):
    ...
    def __init__(__self__, *, account_id: _builtins.str, arn: _builtins.str, format: _builtins.str, output_schema_version: _builtins.str, encryption: Optional[outputs.StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationEncryption] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationEncryption(dict):
    ...
    def __init__(__self__, *, sse_kms: Optional[outputs.StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationEncryptionSseKms] = ..., sse_s3s: Optional[Sequence[outputs.StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationEncryptionSseS3]] = ...) -> None:
...
class StorageLensConfigurationStorageLensConfigurationExclude(dict):
    def __init__(__self__, *, buckets: Optional[Sequence[_builtins.str]] = ..., regions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GetAccessPointsAccessPointResult(dict):
    def __init__(__self__, *, access_point_arn: _builtins.str, alias: _builtins.str, bucket: _builtins.str, bucket_account_id: _builtins.str, data_source_id: _builtins.str, data_source_type: _builtins.str, name: _builtins.str, network_origin: _builtins.str, vpc_configurations: Sequence[outputs.GetAccessPointsAccessPointVpcConfigurationResult]) -> None:
...
class GetMultiRegionAccessPointRegionResult(dict):
    def __init__(__self__, *, bucket: _builtins.str, bucket_account_id: _builtins.str, region: _builtins.str) -> None:
...
class GetMultiRegionAccessPointsAccessPointResult(dict):
    def __init__(__self__, *, alias: _builtins.str, created_at: _builtins.str, name: _builtins.str, public_access_blocks: Sequence[outputs.GetMultiRegionAccessPointsAccessPointPublicAccessBlockResult], regions: Sequence[outputs.GetMultiRegionAccessPointsAccessPointRegionResult], status: _builtins.str) -> None:
