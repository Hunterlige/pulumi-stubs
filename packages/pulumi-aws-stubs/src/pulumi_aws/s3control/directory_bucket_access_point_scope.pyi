...
class _DirectoryBucketAccessPointScopeState:
    def __init__(
        ...
        *,
        ...
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        scope: Optional[pulumi.Input[DirectoryBucketAccessPointScopeScopeArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter(name="accountId")
    ...
    def scope(
        self,
    ) -> Optional[pulumi.Input[DirectoryBucketAccessPointScopeScopeArgs]]: ...
    @scope.setter
    def scope(
        self, value: Optional[pulumi.Input[DirectoryBucketAccessPointScopeScopeArgs]]
    ): ...
