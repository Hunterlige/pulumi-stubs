...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessGrantAccessGrantsLocationConfigurationArgs', ..., 'AccessGrantGranteeArgs', 'AccessGrantGranteeArgsDict', 'BucketLifecycleConfigurationRuleArgs', 'BucketLifecycleConfigurationRuleArgsDict', ..., ..., 'BucketLifecycleConfigurationRuleExpirationArgs', 'BucketLifecycleConfigurationRuleExpirationArgsDict', 'BucketLifecycleConfigurationRuleFilterArgs', 'BucketLifecycleConfigurationRuleFilterArgsDict', 'DirectoryBucketAccessPointScopeScopeArgs', 'DirectoryBucketAccessPointScopeScopeArgsDict', 'MultiRegionAccessPointDetailsArgs', 'MultiRegionAccessPointDetailsArgsDict', 'MultiRegionAccessPointDetailsPublicAccessBlockArgs', ..., 'MultiRegionAccessPointDetailsRegionArgs', 'MultiRegionAccessPointDetailsRegionArgsDict', 'MultiRegionAccessPointPolicyDetailsArgs', 'MultiRegionAccessPointPolicyDetailsArgsDict', 'ObjectLambdaAccessPointConfigurationArgs', 'ObjectLambdaAccessPointConfigurationArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ...]
...
class AccessGrantAccessGrantsLocationConfigurationArgs:
    def __init__(__self__, *, s3_sub_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def s3_sub_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AccessGrantGranteeArgs:
    def __init__(__self__, *, grantee_identifier: pulumi.Input[_builtins.str], grantee_type: pulumi.Input[_builtins.str]) -> None:
    ...
    def grantee_identifier(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @grantee_type.setter
    def grantee_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BucketLifecycleConfigurationRuleArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], abort_incomplete_multipart_upload: Optional[pulumi.Input[BucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadArgs]] = ..., expiration: Optional[pulumi.Input[BucketLifecycleConfigurationRuleExpirationArgs]] = ..., filter: Optional[pulumi.Input[BucketLifecycleConfigurationRuleFilterArgs]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class BucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadArgs:
    def __init__(__self__, *, days_after_initiation: pulumi.Input[_builtins.int]) -> None:
    ...
    def days_after_initiation(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class DirectoryBucketAccessPointScopeScopeArgs:
    def __init__(__self__, *, permissions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @prefixes.setter
    def prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class MultiRegionAccessPointDetailsArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], regions: pulumi.Input[Sequence[pulumi.Input[MultiRegionAccessPointDetailsRegionArgs]]], public_access_block: Optional[pulumi.Input[MultiRegionAccessPointDetailsPublicAccessBlockArgs]] = ...) -> None:
    ...
    @regions.setter
    def regions(self, value: pulumi.Input[Sequence[pulumi.Input[MultiRegionAccessPointDetailsRegionArgs]]]): # -> None:
        ...
    ...
    def public_access_block(self, value: Optional[pulumi.Input[MultiRegionAccessPointDetailsPublicAccessBlockArgs]]): # -> None:
        ...
...
class MultiRegionAccessPointDetailsRegionArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], bucket_account_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MultiRegionAccessPointPolicyDetailsArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], policy: pulumi.Input[_builtins.str]) -> None:
...
class ObjectLambdaAccessPointConfigurationArgs:
    def __init__(__self__, *, supporting_access_point: pulumi.Input[_builtins.str], transformation_configurations: pulumi.Input[Sequence[pulumi.Input[ObjectLambdaAccessPointConfigurationTransformationConfigurationArgs]]], allowed_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., cloud_watch_metrics_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def supporting_access_point(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def transformation_configurations(self, value: pulumi.Input[Sequence[pulumi.Input[ObjectLambdaAccessPointConfigurationTransformationConfigurationArgs]]]): # -> None:
        ...
    ...
    def allowed_features(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def cloud_watch_metrics_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ObjectLambdaAccessPointConfigurationTransformationConfigurationArgs:
    def __init__(__self__, *, actions: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], content_transformation: pulumi.Input[ObjectLambdaAccessPointConfigurationTransformationConfigurationContentTransformationArgs]) -> None:
    ...
    def content_transformation(self, value: pulumi.Input[ObjectLambdaAccessPointConfigurationTransformationConfigurationContentTransformationArgs]): # -> None:
        ...
...
class ObjectLambdaAccessPointConfigurationTransformationConfigurationContentTransformationArgs:
    def __init__(__self__, *, aws_lambda: pulumi.Input[ObjectLambdaAccessPointConfigurationTransformationConfigurationContentTransformationAwsLambdaArgs]) -> None:
    ...
    @aws_lambda.setter
    def aws_lambda(self, value: pulumi.Input[ObjectLambdaAccessPointConfigurationTransformationConfigurationContentTransformationAwsLambdaArgs]): # -> None:
        ...
...
class ObjectLambdaAccessPointConfigurationTransformationConfigurationContentTransformationAwsLambdaArgs:
    def __init__(__self__, *, function_arn: pulumi.Input[_builtins.str], function_payload: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def function_payload(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StorageLensConfigurationStorageLensConfigurationArgs:
    def __init__(__self__, *, account_level: pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelArgs], enabled: pulumi.Input[_builtins.bool], aws_org: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAwsOrgArgs]] = ..., data_export: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationDataExportArgs]] = ..., exclude: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationExcludeArgs]] = ..., include: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationIncludeArgs]] = ...) -> None:
    ...
    def account_level(self, value: pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelArgs]): # -> None:
        ...
    ...
    @aws_org.setter
    def aws_org(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAwsOrgArgs]]): # -> None:
        ...
    ...
    @data_export.setter
    def data_export(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationDataExportArgs]]): # -> None:
        ...
    ...
    @exclude.setter
    def exclude(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationExcludeArgs]]): # -> None:
        ...
    ...
    @include.setter
    def include(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationIncludeArgs]]): # -> None:
        ...
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelArgs:
    def __init__(__self__, *, bucket_level: pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelArgs], activity_metrics: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelActivityMetricsArgs]] = ..., advanced_cost_optimization_metrics: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelAdvancedCostOptimizationMetricsArgs]] = ..., advanced_data_protection_metrics: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelAdvancedDataProtectionMetricsArgs]] = ..., detailed_status_code_metrics: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelDetailedStatusCodeMetricsArgs]] = ...) -> None:
    ...
    @bucket_level.setter
    def bucket_level(self, value: pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelArgs]): # -> None:
        ...
    ...
    def activity_metrics(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelActivityMetricsArgs]]): # -> None:
        ...
    ...
    def advanced_cost_optimization_metrics(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelAdvancedCostOptimizationMetricsArgs]]): # -> None:
        ...
    ...
    def advanced_data_protection_metrics(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelAdvancedDataProtectionMetricsArgs]]): # -> None:
        ...
    ...
    def detailed_status_code_metrics(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelDetailedStatusCodeMetricsArgs]]): # -> None:
        ...
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelArgs:
    def __init__(__self__, *, activity_metrics: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelActivityMetricsArgs]] = ..., advanced_cost_optimization_metrics: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelAdvancedCostOptimizationMetricsArgs]] = ..., advanced_data_protection_metrics: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelAdvancedDataProtectionMetricsArgs]] = ..., detailed_status_code_metrics: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelDetailedStatusCodeMetricsArgs]] = ..., prefix_level: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelArgs]] = ...) -> None:
    ...
    @activity_metrics.setter
    def activity_metrics(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelActivityMetricsArgs]]): # -> None:
        ...
    ...
    @advanced_cost_optimization_metrics.setter
    def advanced_cost_optimization_metrics(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelAdvancedCostOptimizationMetricsArgs]]): # -> None:
        ...
    ...
    @advanced_data_protection_metrics.setter
    def advanced_data_protection_metrics(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelAdvancedDataProtectionMetricsArgs]]): # -> None:
        ...
    ...
    @detailed_status_code_metrics.setter
    def detailed_status_code_metrics(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelDetailedStatusCodeMetricsArgs]]): # -> None:
        ...
    ...
    @prefix_level.setter
    def prefix_level(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelArgs]]): # -> None:
        ...
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelArgs:
    def __init__(__self__, *, storage_metrics: pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetricsArgs]) -> None:
    ...
    def storage_metrics(self, value: pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetricsArgs]): # -> None:
        ...
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetricsArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., selection_criteria: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetricsSelectionCriteriaArgs]] = ...) -> None:
    ...
    def selection_criteria(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetricsSelectionCriteriaArgs]]): # -> None:
        ...
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetricsSelectionCriteriaArgs:
    def __init__(__self__, *, delimiter: Optional[pulumi.Input[_builtins.str]] = ..., max_depth: Optional[pulumi.Input[_builtins.int]] = ..., min_storage_bytes_percentage: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @max_depth.setter
    def max_depth(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def min_storage_bytes_percentage(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class StorageLensConfigurationStorageLensConfigurationDataExportArgs:
    def __init__(__self__, *, cloud_watch_metrics: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationDataExportCloudWatchMetricsArgs]] = ..., s3_bucket_destination: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationArgs]] = ...) -> None:
    ...
    def cloud_watch_metrics(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationDataExportCloudWatchMetricsArgs]]): # -> None:
        ...
    ...
    def s3_bucket_destination(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationArgs]]): # -> None:
        ...
...
class StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationArgs:
    def __init__(__self__, *, account_id: pulumi.Input[_builtins.str], arn: pulumi.Input[_builtins.str], format: pulumi.Input[_builtins.str], output_schema_version: pulumi.Input[_builtins.str], encryption: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationEncryptionArgs]] = ..., prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def output_schema_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @encryption.setter
    def encryption(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationEncryptionArgs]]): # -> None:
        ...
...
class StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationEncryptionArgs:
    ...
    @sse_kms.setter
    def sse_kms(self, value: Optional[pulumi.Input[StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationEncryptionSseKmsArgs]]): # -> None:
        ...
    ...
    @sse_s3s.setter
    def sse_s3s(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationEncryptionSseS3Args]]]]): # -> None:
        ...
...
class StorageLensConfigurationStorageLensConfigurationExcludeArgs:
    def __init__(__self__, *, buckets: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @buckets.setter
    def buckets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
