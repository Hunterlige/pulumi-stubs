...
class GetBotResult:
    ...
    def __init__(__self__, arn=..., checksum=..., child_directed=..., created_date=..., description=..., detect_sentiment=..., enable_model_improvements=..., failure_reason=..., id=..., idle_session_ttl_in_seconds=..., last_updated_date=..., locale=..., name=..., nlu_intent_confidence_threshold=..., region=..., status=..., version=..., voice_id=...) -> None:
        ...
...
class AwaitableGetBotResult(GetBotResult):
    def __await__(self): # -> Generator[Never, Any, GetBotResult]:
        ...
    


def get_bot(name: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetBotResult:
    
    ...

def get_bot_output(name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., version: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetBotResult]:
