...
class V2modelsBotVersionArgs:
    def __init__(__self__, *, bot_id: pulumi.Input[_builtins.str], locale_specification: pulumi.Input[Mapping[str, pulumi.Input[V2modelsBotVersionLocaleSpecificationArgs]]], bot_version: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., timeouts: Optional[pulumi.Input[V2modelsBotVersionTimeoutsArgs]] = ...) -> None:
    ...
    def locale_specification(self, value: pulumi.Input[Mapping[str, pulumi.Input[V2modelsBotVersionLocaleSpecificationArgs]]]): # -> None:
        ...
    ...
    @timeouts.setter
    def timeouts(self, value: Optional[pulumi.Input[V2modelsBotVersionTimeoutsArgs]]): # -> None:
        ...
...
class _V2modelsBotVersionState:
    def __init__(__self__, *, bot_id: Optional[pulumi.Input[_builtins.str]] = ..., bot_version: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., locale_specification: Optional[pulumi.Input[Mapping[str, pulumi.Input[V2modelsBotVersionLocaleSpecificationArgs]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., timeouts: Optional[pulumi.Input[V2modelsBotVersionTimeoutsArgs]] = ...) -> None:
    ...
    @locale_specification.setter
    def locale_specification(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[V2modelsBotVersionLocaleSpecificationArgs]]]]): # -> None:
        ...
...
class V2modelsBotVersion(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., bot_id: Optional[pulumi.Input[_builtins.str]] = ..., bot_version: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., locale_specification: Optional[pulumi.Input[Mapping[str, pulumi.Input[Union[V2modelsBotVersionLocaleSpecificationArgs, V2modelsBotVersionLocaleSpecificationArgsDict]]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., timeouts: Optional[pulumi.Input[Union[V2modelsBotVersionTimeoutsArgs, V2modelsBotVersionTimeoutsArgsDict]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: V2modelsBotVersionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
