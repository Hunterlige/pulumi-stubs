...
class V2modelsSlotArgs:
    def __init__(__self__, *, bot_id: pulumi.Input[_builtins.str], bot_version: pulumi.Input[_builtins.str], intent_id: pulumi.Input[_builtins.str], locale_id: pulumi.Input[_builtins.str], value_elicitation_setting: pulumi.Input[V2modelsSlotValueElicitationSettingArgs], description: Optional[pulumi.Input[_builtins.str]] = ..., multiple_values_settings: Optional[pulumi.Input[Sequence[pulumi.Input[V2modelsSlotMultipleValuesSettingArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., obfuscation_settings: Optional[pulumi.Input[Sequence[pulumi.Input[V2modelsSlotObfuscationSettingArgs]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., slot_type_id: Optional[pulumi.Input[_builtins.str]] = ..., sub_slot_settings: Optional[pulumi.Input[Sequence[pulumi.Input[V2modelsSlotSubSlotSettingArgs]]]] = ..., timeouts: Optional[pulumi.Input[V2modelsSlotTimeoutsArgs]] = ...) -> None:
    ...
    def value_elicitation_setting(self, value: pulumi.Input[V2modelsSlotValueElicitationSettingArgs]): # -> None:
        ...
    ...
    def multiple_values_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[V2modelsSlotMultipleValuesSettingArgs]]]]): # -> None:
        ...
    ...
    def obfuscation_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[V2modelsSlotObfuscationSettingArgs]]]]): # -> None:
        ...
    ...
    def sub_slot_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[V2modelsSlotSubSlotSettingArgs]]]]): # -> None:
        ...
    ...
    @timeouts.setter
    def timeouts(self, value: Optional[pulumi.Input[V2modelsSlotTimeoutsArgs]]): # -> None:
        ...
...
class _V2modelsSlotState:
    def __init__(__self__, *, bot_id: Optional[pulumi.Input[_builtins.str]] = ..., bot_version: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., intent_id: Optional[pulumi.Input[_builtins.str]] = ..., locale_id: Optional[pulumi.Input[_builtins.str]] = ..., multiple_values_settings: Optional[pulumi.Input[Sequence[pulumi.Input[V2modelsSlotMultipleValuesSettingArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., obfuscation_settings: Optional[pulumi.Input[Sequence[pulumi.Input[V2modelsSlotObfuscationSettingArgs]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., slot_id: Optional[pulumi.Input[_builtins.str]] = ..., slot_type_id: Optional[pulumi.Input[_builtins.str]] = ..., sub_slot_settings: Optional[pulumi.Input[Sequence[pulumi.Input[V2modelsSlotSubSlotSettingArgs]]]] = ..., timeouts: Optional[pulumi.Input[V2modelsSlotTimeoutsArgs]] = ..., value_elicitation_setting: Optional[pulumi.Input[V2modelsSlotValueElicitationSettingArgs]] = ...) -> None:
    ...
    @slot_id.setter
    def slot_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @value_elicitation_setting.setter
    def value_elicitation_setting(self, value: Optional[pulumi.Input[V2modelsSlotValueElicitationSettingArgs]]): # -> None:
        ...
...
class V2modelsSlot(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., bot_id: Optional[pulumi.Input[_builtins.str]] = ..., bot_version: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., intent_id: Optional[pulumi.Input[_builtins.str]] = ..., locale_id: Optional[pulumi.Input[_builtins.str]] = ..., multiple_values_settings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[V2modelsSlotMultipleValuesSettingArgs, V2modelsSlotMultipleValuesSettingArgsDict]]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., obfuscation_settings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[V2modelsSlotObfuscationSettingArgs, V2modelsSlotObfuscationSettingArgsDict]]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., slot_type_id: Optional[pulumi.Input[_builtins.str]] = ..., sub_slot_settings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[V2modelsSlotSubSlotSettingArgs, V2modelsSlotSubSlotSettingArgsDict]]]]] = ..., timeouts: Optional[pulumi.Input[Union[V2modelsSlotTimeoutsArgs, V2modelsSlotTimeoutsArgsDict]]] = ..., value_elicitation_setting: Optional[pulumi.Input[Union[V2modelsSlotValueElicitationSettingArgs, V2modelsSlotValueElicitationSettingArgsDict]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: V2modelsSlotArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., bot_id: Optional[pulumi.Input[_builtins.str]] = ..., bot_version: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., intent_id: Optional[pulumi.Input[_builtins.str]] = ..., locale_id: Optional[pulumi.Input[_builtins.str]] = ..., multiple_values_settings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[V2modelsSlotMultipleValuesSettingArgs, V2modelsSlotMultipleValuesSettingArgsDict]]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., obfuscation_settings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[V2modelsSlotObfuscationSettingArgs, V2modelsSlotObfuscationSettingArgsDict]]]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., slot_id: Optional[pulumi.Input[_builtins.str]] = ..., slot_type_id: Optional[pulumi.Input[_builtins.str]] = ..., sub_slot_settings: Optional[pulumi.Input[Sequence[pulumi.Input[Union[V2modelsSlotSubSlotSettingArgs, V2modelsSlotSubSlotSettingArgsDict]]]]] = ..., timeouts: Optional[pulumi.Input[Union[V2modelsSlotTimeoutsArgs, V2modelsSlotTimeoutsArgsDict]]] = ..., value_elicitation_setting: Optional[pulumi.Input[Union[V2modelsSlotValueElicitationSettingArgs, V2modelsSlotValueElicitationSettingArgsDict]]] = ...) -> V2modelsSlot:
