...
class GetInstanceResult:
    ...
    def __init__(__self__, address=..., allocated_storage=..., auto_minor_version_upgrade=..., availability_zone=..., backup_retention_period=..., ca_cert_identifier=..., database_insights_mode=..., db_cluster_identifier=..., db_instance_arn=..., db_instance_class=..., db_instance_identifier=..., db_instance_port=..., db_name=..., db_parameter_groups=..., db_subnet_group=..., enabled_cloudwatch_logs_exports=..., endpoint=..., engine=..., engine_version=..., hosted_zone_id=..., id=..., iops=..., kms_key_id=..., license_model=..., master_user_secrets=..., master_username=..., max_allocated_storage=..., monitoring_interval=..., monitoring_role_arn=..., multi_az=..., network_type=..., option_group_memberships=..., port=..., preferred_backup_window=..., preferred_maintenance_window=..., publicly_accessible=..., region=..., replicate_source_db=..., resource_id=..., storage_encrypted=..., storage_throughput=..., storage_type=..., tags=..., timezone=..., upgrade_rollout_order=..., vpc_security_groups=...) -> None:
        ...
...
def get_instance(db_instance_identifier: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetInstanceResult:
    
    ...

def get_instance_output(db_instance_identifier: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetInstanceResult]:
