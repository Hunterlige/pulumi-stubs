...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterMasterUserSecretArgs', 'ClusterMasterUserSecretArgsDict', 'ClusterParameterGroupParameterArgs', 'ClusterParameterGroupParameterArgsDict', 'ClusterRestoreToPointInTimeArgs', 'ClusterRestoreToPointInTimeArgsDict', 'ClusterS3ImportArgs', 'ClusterS3ImportArgsDict', 'ClusterScalingConfigurationArgs', 'ClusterScalingConfigurationArgsDict', 'ClusterServerlessv2ScalingConfigurationArgs', 'ClusterServerlessv2ScalingConfigurationArgsDict', 'ClusterSnapshotCopyTimeoutsArgs', 'ClusterSnapshotCopyTimeoutsArgsDict', 'ExportTaskTimeoutsArgs', 'ExportTaskTimeoutsArgsDict', 'GlobalClusterGlobalClusterMemberArgs', 'GlobalClusterGlobalClusterMemberArgsDict', 'InstanceBlueGreenUpdateArgs', 'InstanceBlueGreenUpdateArgsDict', 'InstanceDesiredStateTimeoutsArgs', 'InstanceDesiredStateTimeoutsArgsDict', 'InstanceListenerEndpointArgs', 'InstanceListenerEndpointArgsDict', 'InstanceMasterUserSecretArgs', 'InstanceMasterUserSecretArgsDict', 'InstanceRestoreToPointInTimeArgs', 'InstanceRestoreToPointInTimeArgsDict', 'InstanceS3ImportArgs', 'InstanceS3ImportArgsDict', 'IntegrationTimeoutsArgs', 'IntegrationTimeoutsArgsDict', 'OptionGroupOptionArgs', 'OptionGroupOptionArgsDict', 'OptionGroupOptionOptionSettingArgs', 'OptionGroupOptionOptionSettingArgsDict', 'ParameterGroupParameterArgs', 'ParameterGroupParameterArgsDict', 'ProxyAuthArgs', 'ProxyAuthArgsDict', 'ProxyDefaultTargetGroupConnectionPoolConfigArgs', ..., 'ReservedInstanceRecurringChargeArgs', 'ReservedInstanceRecurringChargeArgsDict', 'ShardGroupTimeoutsArgs', 'ShardGroupTimeoutsArgsDict', 'GetClustersFilterArgs', 'GetClustersFilterArgsDict', 'GetEngineVersionFilterArgs', 'GetEngineVersionFilterArgsDict', 'GetInstancesFilterArgs', 'GetInstancesFilterArgsDict']
...
class ClusterRestoreToPointInTimeArgs:
    def __init__(__self__, *, restore_to_time: Optional[pulumi.Input[_builtins.str]] = ..., restore_type: Optional[pulumi.Input[_builtins.str]] = ..., source_cluster_identifier: Optional[pulumi.Input[_builtins.str]] = ..., source_cluster_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., use_latest_restorable_time: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def source_cluster_identifier(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def source_cluster_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterS3ImportArgs:
    def __init__(__self__, *, bucket_name: pulumi.Input[_builtins.str], ingestion_role: pulumi.Input[_builtins.str], source_engine: pulumi.Input[_builtins.str], source_engine_version: pulumi.Input[_builtins.str], bucket_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ingestion_role(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def source_engine(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def source_engine_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterScalingConfigurationArgs:
    def __init__(__self__, *, auto_pause: Optional[pulumi.Input[_builtins.bool]] = ..., max_capacity: Optional[pulumi.Input[_builtins.int]] = ..., min_capacity: Optional[pulumi.Input[_builtins.int]] = ..., seconds_before_timeout: Optional[pulumi.Input[_builtins.int]] = ..., seconds_until_auto_pause: Optional[pulumi.Input[_builtins.int]] = ..., timeout_action: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @auto_pause.setter
    def auto_pause(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def seconds_before_timeout(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def seconds_until_auto_pause(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def timeout_action(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterServerlessv2ScalingConfigurationArgs:
    def __init__(__self__, *, max_capacity: pulumi.Input[_builtins.float], min_capacity: pulumi.Input[_builtins.float], seconds_until_auto_pause: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class InstanceListenerEndpointArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., hosted_zone_id: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class InstanceRestoreToPointInTimeArgs:
    def __init__(__self__, *, restore_time: Optional[pulumi.Input[_builtins.str]] = ..., source_db_instance_automated_backups_arn: Optional[pulumi.Input[_builtins.str]] = ..., source_db_instance_identifier: Optional[pulumi.Input[_builtins.str]] = ..., source_dbi_resource_id: Optional[pulumi.Input[_builtins.str]] = ..., use_latest_restorable_time: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @restore_time.setter
    def restore_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def source_db_instance_automated_backups_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def source_db_instance_identifier(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def source_dbi_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class OptionGroupOptionArgs:
    def __init__(__self__, *, option_name: pulumi.Input[_builtins.str], db_security_group_memberships: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., option_settings: Optional[pulumi.Input[Sequence[pulumi.Input[OptionGroupOptionOptionSettingArgs]]]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ..., vpc_security_group_memberships: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @option_name.setter
    def option_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def db_security_group_memberships(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def option_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[OptionGroupOptionOptionSettingArgs]]]]): # -> None:
        ...
    ...
    def vpc_security_group_memberships(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
@pulumi.input_type
class ProxyAuthArgs:
    def __init__(__self__, *, auth_scheme: Optional[pulumi.Input[_builtins.str]] = ..., client_password_auth_type: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., iam_auth: Optional[pulumi.Input[_builtins.str]] = ..., secret_arn: Optional[pulumi.Input[_builtins.str]] = ..., username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @auth_scheme.setter
    def auth_scheme(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def client_password_auth_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @iam_auth.setter
    def iam_auth(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ProxyDefaultTargetGroupConnectionPoolConfigArgs:
    def __init__(__self__, *, connection_borrow_timeout: Optional[pulumi.Input[_builtins.int]] = ..., init_query: Optional[pulumi.Input[_builtins.str]] = ..., max_connections_percent: Optional[pulumi.Input[_builtins.int]] = ..., max_idle_connections_percent: Optional[pulumi.Input[_builtins.int]] = ..., session_pinning_filters: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def connection_borrow_timeout(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @init_query.setter
    def init_query(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_connections_percent(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_idle_connections_percent(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def session_pinning_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ReservedInstanceRecurringChargeArgs:
    def __init__(__self__, *, recurring_charge_amount: Optional[pulumi.Input[_builtins.int]] = ..., recurring_charge_frequency: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    def recurring_charge_amount(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def recurring_charge_frequency(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
