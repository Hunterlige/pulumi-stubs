...
class CertificateArgs:
    def __init__(
        __self__,
        *,
        certificate_identifier: pulumi.Input[_builtins.str],
    ...
    def certificate_identifier(self, value: pulumi.Input[_builtins.str]): ...
    @_builtins.property
    @pulumi.getter
...
class _CertificateState:
    def __init__(
        __self__,
        *,
        certificate_identifier: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter(name="certificateIdentifier")
    ...
    @certificate_identifier.setter
    def certificate_identifier(self, value: Optional[pulumi.Input[_builtins.str]]): ...
    @_builtins.property
    @pulumi.getter
    def region(self) -> Optional[pulumi.Input[_builtins.str]]: ...
    @region.setter
