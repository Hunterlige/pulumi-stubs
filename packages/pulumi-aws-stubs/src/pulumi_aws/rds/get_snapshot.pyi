...
class GetSnapshotResult:
    ...
    def __init__(__self__, allocated_storage=..., availability_zone=..., db_instance_identifier=..., db_snapshot_arn=..., db_snapshot_identifier=..., encrypted=..., engine=..., engine_version=..., id=..., include_public=..., include_shared=..., iops=..., kms_key_id=..., license_model=..., most_recent=..., option_group_name=..., original_snapshot_create_time=..., port=..., region=..., snapshot_create_time=..., snapshot_type=..., source_db_snapshot_identifier=..., source_region=..., status=..., storage_type=..., tags=..., vpc_id=...) -> None:
        ...
...
def get_snapshot(db_instance_identifier: Optional[_builtins.str] = ..., db_snapshot_identifier: Optional[_builtins.str] = ..., include_public: Optional[_builtins.bool] = ..., include_shared: Optional[_builtins.bool] = ..., most_recent: Optional[_builtins.bool] = ..., region: Optional[_builtins.str] = ..., snapshot_type: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetSnapshotResult:
    
    ...

def get_snapshot_output(db_instance_identifier: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., db_snapshot_identifier: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., include_public: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., include_shared: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., most_recent: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., snapshot_type: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetSnapshotResult]:
