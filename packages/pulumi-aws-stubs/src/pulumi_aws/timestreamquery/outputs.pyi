...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ScheduledQueryErrorReportConfiguration', ..., 'ScheduledQueryLastRunSummary', 'ScheduledQueryLastRunSummaryErrorReportLocation', ..., 'ScheduledQueryLastRunSummaryExecutionStat', 'ScheduledQueryLastRunSummaryQueryInsightsResponse', ..., ..., ..., ..., 'ScheduledQueryNotificationConfiguration', ..., 'ScheduledQueryRecentlyFailedRun', 'ScheduledQueryRecentlyFailedRunErrorReportLocation', ..., 'ScheduledQueryRecentlyFailedRunExecutionStat', ..., ..., ..., ..., ..., 'ScheduledQueryScheduleConfiguration', 'ScheduledQueryTargetConfiguration', ..., ..., ..., ..., ..., ..., 'ScheduledQueryTimeouts']
@pulumi.output_type
class ScheduledQueryErrorReportConfiguration(dict):
    ...
    def __init__(__self__, *, s3_configuration: outputs.ScheduledQueryErrorReportConfigurationS3Configuration) -> None:
...
class ScheduledQueryErrorReportConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, encryption_option: Optional[_builtins.str] = ..., object_key_prefix: Optional[_builtins.str] = ...) -> None:
...
class ScheduledQueryLastRunSummary(dict):
    ...
    def __init__(__self__, *, error_report_locations: Optional[Sequence[outputs.ScheduledQueryLastRunSummaryErrorReportLocation]] = ..., execution_stats: Optional[Sequence[outputs.ScheduledQueryLastRunSummaryExecutionStat]] = ..., failure_reason: Optional[_builtins.str] = ..., invocation_time: Optional[_builtins.str] = ..., query_insights_responses: Optional[Sequence[outputs.ScheduledQueryLastRunSummaryQueryInsightsResponse]] = ..., run_status: Optional[_builtins.str] = ..., trigger_time: Optional[_builtins.str] = ...) -> None:
...
class ScheduledQueryLastRunSummaryErrorReportLocation(dict):
    ...
    def __init__(__self__, *, s3_report_locations: Optional[Sequence[outputs.ScheduledQueryLastRunSummaryErrorReportLocationS3ReportLocation]] = ...) -> None:
...
class ScheduledQueryLastRunSummaryErrorReportLocationS3ReportLocation(dict):
    ...
    def __init__(__self__, *, bucket_name: Optional[_builtins.str] = ..., object_key: Optional[_builtins.str] = ...) -> None:
...
class ScheduledQueryLastRunSummaryExecutionStat(dict):
    ...
    def __init__(__self__, *, bytes_metered: Optional[_builtins.int] = ..., cumulative_bytes_scanned: Optional[_builtins.int] = ..., data_writes: Optional[_builtins.int] = ..., execution_time_in_millis: Optional[_builtins.int] = ..., query_result_rows: Optional[_builtins.int] = ..., records_ingested: Optional[_builtins.int] = ...) -> None:
...
class ScheduledQueryLastRunSummaryQueryInsightsResponse(dict):
    ...
    def __init__(__self__, *, output_bytes: Optional[_builtins.int] = ..., output_rows: Optional[_builtins.int] = ..., query_spatial_coverages: Optional[Sequence[outputs.ScheduledQueryLastRunSummaryQueryInsightsResponseQuerySpatialCoverage]] = ..., query_table_count: Optional[_builtins.int] = ..., query_temporal_ranges: Optional[Sequence[outputs.ScheduledQueryLastRunSummaryQueryInsightsResponseQueryTemporalRange]] = ...) -> None:
...
class ScheduledQueryLastRunSummaryQueryInsightsResponseQuerySpatialCoverage(dict):
    def __init__(__self__, *, maxes: Optional[Sequence[outputs.ScheduledQueryLastRunSummaryQueryInsightsResponseQuerySpatialCoverageMaxis]] = ...) -> None:
...
class ScheduledQueryLastRunSummaryQueryInsightsResponseQuerySpatialCoverageMaxis(dict):
    ...
    def __init__(__self__, *, partition_keys: Optional[Sequence[_builtins.str]] = ..., table_arn: Optional[_builtins.str] = ..., value: Optional[_builtins.float] = ...) -> None:
...
class ScheduledQueryLastRunSummaryQueryInsightsResponseQueryTemporalRange(dict):
    def __init__(__self__, *, maxes: Optional[Sequence[outputs.ScheduledQueryLastRunSummaryQueryInsightsResponseQueryTemporalRangeMaxis]] = ...) -> None:
...
class ScheduledQueryLastRunSummaryQueryInsightsResponseQueryTemporalRangeMaxis(dict):
    ...
    def __init__(__self__, *, table_arn: Optional[_builtins.str] = ..., value: Optional[_builtins.int] = ...) -> None:
...
class ScheduledQueryNotificationConfiguration(dict):
    ...
    def __init__(__self__, *, sns_configuration: outputs.ScheduledQueryNotificationConfigurationSnsConfiguration) -> None:
...
class ScheduledQueryRecentlyFailedRun(dict):
    ...
    def __init__(__self__, *, error_report_locations: Optional[Sequence[outputs.ScheduledQueryRecentlyFailedRunErrorReportLocation]] = ..., execution_stats: Optional[Sequence[outputs.ScheduledQueryRecentlyFailedRunExecutionStat]] = ..., failure_reason: Optional[_builtins.str] = ..., invocation_time: Optional[_builtins.str] = ..., query_insights_responses: Optional[Sequence[outputs.ScheduledQueryRecentlyFailedRunQueryInsightsResponse]] = ..., run_status: Optional[_builtins.str] = ..., trigger_time: Optional[_builtins.str] = ...) -> None:
...
class ScheduledQueryRecentlyFailedRunErrorReportLocation(dict):
    ...
    def __init__(__self__, *, s3_report_locations: Optional[Sequence[outputs.ScheduledQueryRecentlyFailedRunErrorReportLocationS3ReportLocation]] = ...) -> None:
...
class ScheduledQueryRecentlyFailedRunQueryInsightsResponse(dict):
    ...
    def __init__(__self__, *, output_bytes: Optional[_builtins.int] = ..., output_rows: Optional[_builtins.int] = ..., query_spatial_coverages: Optional[Sequence[outputs.ScheduledQueryRecentlyFailedRunQueryInsightsResponseQuerySpatialCoverage]] = ..., query_table_count: Optional[_builtins.int] = ..., query_temporal_ranges: Optional[Sequence[outputs.ScheduledQueryRecentlyFailedRunQueryInsightsResponseQueryTemporalRange]] = ...) -> None:
...
class ScheduledQueryRecentlyFailedRunQueryInsightsResponseQuerySpatialCoverage(dict):
    def __init__(__self__, *, maxes: Optional[Sequence[outputs.ScheduledQueryRecentlyFailedRunQueryInsightsResponseQuerySpatialCoverageMaxis]] = ...) -> None:
...
class ScheduledQueryRecentlyFailedRunQueryInsightsResponseQueryTemporalRange(dict):
    def __init__(__self__, *, maxes: Optional[Sequence[outputs.ScheduledQueryRecentlyFailedRunQueryInsightsResponseQueryTemporalRangeMaxis]] = ...) -> None:
...
class ScheduledQueryTargetConfiguration(dict):
    ...
    def __init__(__self__, *, timestream_configuration: outputs.ScheduledQueryTargetConfigurationTimestreamConfiguration) -> None:
...
class ScheduledQueryTargetConfigurationTimestreamConfiguration(dict):
    ...
    def __init__(__self__, *, database_name: _builtins.str, dimension_mappings: Sequence[outputs.ScheduledQueryTargetConfigurationTimestreamConfigurationDimensionMapping], table_name: _builtins.str, time_column: _builtins.str, measure_name_column: Optional[_builtins.str] = ..., mixed_measure_mappings: Optional[Sequence[outputs.ScheduledQueryTargetConfigurationTimestreamConfigurationMixedMeasureMapping]] = ..., multi_measure_mappings: Optional[outputs.ScheduledQueryTargetConfigurationTimestreamConfigurationMultiMeasureMappings] = ...) -> None:
...
class ScheduledQueryTargetConfigurationTimestreamConfigurationDimensionMapping(dict):
    ...
    def __init__(__self__, *, dimension_value_type: _builtins.str, name: _builtins.str) -> None:
...
class ScheduledQueryTargetConfigurationTimestreamConfigurationMixedMeasureMapping(dict):
    ...
    def __init__(__self__, *, measure_value_type: _builtins.str, measure_name: Optional[_builtins.str] = ..., multi_measure_attribute_mappings: Optional[Sequence[outputs.ScheduledQueryTargetConfigurationTimestreamConfigurationMixedMeasureMappingMultiMeasureAttributeMapping]] = ..., source_column: Optional[_builtins.str] = ..., target_measure_name: Optional[_builtins.str] = ...) -> None:
...
class ScheduledQueryTargetConfigurationTimestreamConfigurationMixedMeasureMappingMultiMeasureAttributeMapping(dict):
    ...
    def __init__(__self__, *, measure_value_type: _builtins.str, source_column: _builtins.str, target_multi_measure_attribute_name: Optional[_builtins.str] = ...) -> None:
...
class ScheduledQueryTargetConfigurationTimestreamConfigurationMultiMeasureMappings(dict):
    ...
    def __init__(__self__, *, multi_measure_attribute_mappings: Sequence[outputs.ScheduledQueryTargetConfigurationTimestreamConfigurationMultiMeasureMappingsMultiMeasureAttributeMapping], target_multi_measure_name: Optional[_builtins.str] = ...) -> None:
