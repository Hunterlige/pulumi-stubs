...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['KxClusterAutoScalingConfigurationArgs', 'KxClusterAutoScalingConfigurationArgsDict', 'KxClusterCacheStorageConfigurationArgs', 'KxClusterCacheStorageConfigurationArgsDict', 'KxClusterCapacityConfigurationArgs', 'KxClusterCapacityConfigurationArgsDict', 'KxClusterCodeArgs', 'KxClusterCodeArgsDict', 'KxClusterDatabaseArgs', 'KxClusterDatabaseArgsDict', 'KxClusterDatabaseCacheConfigurationArgs', 'KxClusterDatabaseCacheConfigurationArgsDict', 'KxClusterSavedownStorageConfigurationArgs', 'KxClusterSavedownStorageConfigurationArgsDict', 'KxClusterScalingGroupConfigurationArgs', 'KxClusterScalingGroupConfigurationArgsDict', 'KxClusterTickerplantLogConfigurationArgs', 'KxClusterTickerplantLogConfigurationArgsDict', 'KxClusterVpcConfigurationArgs', 'KxClusterVpcConfigurationArgsDict', 'KxDataviewSegmentConfigurationArgs', 'KxDataviewSegmentConfigurationArgsDict', 'KxEnvironmentCustomDnsConfigurationArgs', 'KxEnvironmentCustomDnsConfigurationArgsDict', 'KxEnvironmentTransitGatewayConfigurationArgs', 'KxEnvironmentTransitGatewayConfigurationArgsDict', ..., ..., ..., ..., ..., ..., 'KxVolumeAttachedClusterArgs', 'KxVolumeAttachedClusterArgsDict', 'KxVolumeNas1ConfigurationArgs', 'KxVolumeNas1ConfigurationArgsDict']
...
class KxClusterAutoScalingConfigurationArgs:
    def __init__(__self__, *, auto_scaling_metric: pulumi.Input[_builtins.str], max_node_count: pulumi.Input[_builtins.int], metric_target: pulumi.Input[_builtins.float], min_node_count: pulumi.Input[_builtins.int], scale_in_cooldown_seconds: pulumi.Input[_builtins.float], scale_out_cooldown_seconds: pulumi.Input[_builtins.float]) -> None:
    ...
    def metric_target(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def scale_in_cooldown_seconds(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def scale_out_cooldown_seconds(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class KxClusterCacheStorageConfigurationArgs:
    def __init__(__self__, *, size: pulumi.Input[_builtins.int], type: pulumi.Input[_builtins.str]) -> None:
...
class KxClusterCapacityConfigurationArgs:
    def __init__(__self__, *, node_count: pulumi.Input[_builtins.int], node_type: pulumi.Input[_builtins.str]) -> None:
...
class KxClusterCodeArgs:
    def __init__(__self__, *, s3_bucket: pulumi.Input[_builtins.str], s3_key: pulumi.Input[_builtins.str], s3_object_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class KxClusterDatabaseArgs:
    def __init__(__self__, *, database_name: pulumi.Input[_builtins.str], cache_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[KxClusterDatabaseCacheConfigurationArgs]]]] = ..., changeset_id: Optional[pulumi.Input[_builtins.str]] = ..., dataview_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cache_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[KxClusterDatabaseCacheConfigurationArgs]]]]): # -> None:
        ...
    ...
    @changeset_id.setter
    def changeset_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def dataview_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class KxClusterDatabaseCacheConfigurationArgs:
    def __init__(__self__, *, cache_type: pulumi.Input[_builtins.str], db_paths: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @cache_type.setter
    def cache_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @db_paths.setter
    def db_paths(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class KxClusterSavedownStorageConfigurationArgs:
    def __init__(__self__, *, size: Optional[pulumi.Input[_builtins.int]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ..., volume_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class KxClusterScalingGroupConfigurationArgs:
    def __init__(__self__, *, memory_reservation: pulumi.Input[_builtins.int], node_count: pulumi.Input[_builtins.int], scaling_group_name: pulumi.Input[_builtins.str], cpu: Optional[pulumi.Input[_builtins.float]] = ..., memory_limit: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def memory_reservation(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @memory_limit.setter
    def memory_limit(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class KxClusterTickerplantLogConfigurationArgs:
    def __init__(__self__, *, tickerplant_log_volumes: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
        ...
    ...
    def tickerplant_log_volumes(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class KxClusterVpcConfigurationArgs:
    def __init__(__self__, *, ip_address_type: pulumi.Input[_builtins.str], security_group_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], subnet_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], vpc_id: pulumi.Input[_builtins.str]) -> None:
...
class KxDataviewSegmentConfigurationArgs:
    def __init__(__self__, *, db_paths: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], volume_name: pulumi.Input[_builtins.str], on_demand: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @db_paths.setter
    def db_paths(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @on_demand.setter
    def on_demand(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class KxEnvironmentCustomDnsConfigurationArgs:
    def __init__(__self__, *, custom_dns_server_ip: pulumi.Input[_builtins.str], custom_dns_server_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def custom_dns_server_ip(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def custom_dns_server_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class KxEnvironmentTransitGatewayConfigurationArgs:
    def __init__(__self__, *, routable_cidr_space: pulumi.Input[_builtins.str], transit_gateway_id: pulumi.Input[_builtins.str], attachment_network_acl_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationArgs]]]] = ...) -> None:
    ...
    def routable_cidr_space(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def attachment_network_acl_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationArgs]]]]): # -> None:
        ...
...
class KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationArgs:
    def __init__(__self__, *, cidr_block: pulumi.Input[_builtins.str], protocol: pulumi.Input[_builtins.str], rule_action: pulumi.Input[_builtins.str], rule_number: pulumi.Input[_builtins.int], icmp_type_code: Optional[pulumi.Input[KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationIcmpTypeCodeArgs]] = ..., port_range: Optional[pulumi.Input[KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationPortRangeArgs]] = ...) -> None:
    ...
    def icmp_type_code(self, value: Optional[pulumi.Input[KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationIcmpTypeCodeArgs]]): # -> None:
        ...
    ...
    @port_range.setter
    def port_range(self, value: Optional[pulumi.Input[KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationPortRangeArgs]]): # -> None:
        ...
...
class KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationIcmpTypeCodeArgs:
    def __init__(__self__, *, code: pulumi.Input[_builtins.int], type: pulumi.Input[_builtins.int]) -> None:
...
class KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationPortRangeArgs:
    def __init__(__self__, *, from_: pulumi.Input[_builtins.int], to: pulumi.Input[_builtins.int]) -> None:
...
class KxVolumeAttachedClusterArgs:
    def __init__(__self__, *, cluster_name: pulumi.Input[_builtins.str], cluster_status: pulumi.Input[_builtins.str], cluster_type: pulumi.Input[_builtins.str]) -> None:
        ...
