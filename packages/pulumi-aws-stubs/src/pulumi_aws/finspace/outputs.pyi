...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['KxClusterAutoScalingConfiguration', 'KxClusterCacheStorageConfiguration', 'KxClusterCapacityConfiguration', 'KxClusterCode', 'KxClusterDatabase', 'KxClusterDatabaseCacheConfiguration', 'KxClusterSavedownStorageConfiguration', 'KxClusterScalingGroupConfiguration', 'KxClusterTickerplantLogConfiguration', 'KxClusterVpcConfiguration', 'KxDataviewSegmentConfiguration', 'KxEnvironmentCustomDnsConfiguration', 'KxEnvironmentTransitGatewayConfiguration', ..., ..., ..., 'KxVolumeAttachedCluster', 'KxVolumeNas1Configuration']
@pulumi.output_type
class KxClusterAutoScalingConfiguration(dict):
    ...
    def __init__(__self__, *, auto_scaling_metric: _builtins.str, max_node_count: _builtins.int, metric_target: _builtins.float, min_node_count: _builtins.int, scale_in_cooldown_seconds: _builtins.float, scale_out_cooldown_seconds: _builtins.float) -> None:
...
class KxClusterCapacityConfiguration(dict):
    ...
    def __init__(__self__, *, node_count: _builtins.int, node_type: _builtins.str) -> None:
...
class KxClusterCode(dict):
    ...
    def __init__(__self__, *, s3_bucket: _builtins.str, s3_key: _builtins.str, s3_object_version: Optional[_builtins.str] = ...) -> None:
...
class KxClusterDatabase(dict):
    ...
    def __init__(__self__, *, database_name: _builtins.str, cache_configurations: Optional[Sequence[outputs.KxClusterDatabaseCacheConfiguration]] = ..., changeset_id: Optional[_builtins.str] = ..., dataview_name: Optional[_builtins.str] = ...) -> None:
...
class KxClusterDatabaseCacheConfiguration(dict):
    ...
    def __init__(__self__, *, cache_type: _builtins.str, db_paths: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class KxClusterSavedownStorageConfiguration(dict):
    ...
    def __init__(__self__, *, size: Optional[_builtins.int] = ..., type: Optional[_builtins.str] = ..., volume_name: Optional[_builtins.str] = ...) -> None:
...
class KxClusterScalingGroupConfiguration(dict):
    ...
    def __init__(__self__, *, memory_reservation: _builtins.int, node_count: _builtins.int, scaling_group_name: _builtins.str, cpu: Optional[_builtins.float] = ..., memory_limit: Optional[_builtins.int] = ...) -> None:
...
class KxClusterTickerplantLogConfiguration(dict):
    ...
    def __init__(__self__, *, tickerplant_log_volumes: Sequence[_builtins.str]) -> None:
        ...
...
class KxClusterVpcConfiguration(dict):
    ...
    def __init__(__self__, *, ip_address_type: _builtins.str, security_group_ids: Sequence[_builtins.str], subnet_ids: Sequence[_builtins.str], vpc_id: _builtins.str) -> None:
...
class KxDataviewSegmentConfiguration(dict):
    ...
    def __init__(__self__, *, db_paths: Sequence[_builtins.str], volume_name: _builtins.str, on_demand: Optional[_builtins.bool] = ...) -> None:
...
class KxEnvironmentCustomDnsConfiguration(dict):
    ...
    def __init__(__self__, *, custom_dns_server_ip: _builtins.str, custom_dns_server_name: _builtins.str) -> None:
...
class KxEnvironmentTransitGatewayConfiguration(dict):
    ...
    def __init__(__self__, *, routable_cidr_space: _builtins.str, transit_gateway_id: _builtins.str, attachment_network_acl_configurations: Optional[Sequence[outputs.KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfiguration]] = ...) -> None:
...
class KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfiguration(dict):
    ...
    def __init__(__self__, *, cidr_block: _builtins.str, protocol: _builtins.str, rule_action: _builtins.str, rule_number: _builtins.int, icmp_type_code: Optional[outputs.KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationIcmpTypeCode] = ..., port_range: Optional[outputs.KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationPortRange] = ...) -> None:
...
class KxVolumeAttachedCluster(dict):
    ...
    def __init__(__self__, *, cluster_name: _builtins.str, cluster_status: _builtins.str, cluster_type: _builtins.str) -> None:
        ...
