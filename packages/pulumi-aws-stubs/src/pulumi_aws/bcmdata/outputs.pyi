...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ExportExport', 'ExportExportDataQuery', 'ExportExportDestinationConfiguration', 'ExportExportDestinationConfigurationS3Destination', ..., 'ExportExportRefreshCadence', 'ExportTimeouts']
@pulumi.output_type
class ExportExport(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, data_queries: Optional[Sequence[outputs.ExportExportDataQuery]] = ..., description: Optional[_builtins.str] = ..., destination_configurations: Optional[Sequence[outputs.ExportExportDestinationConfiguration]] = ..., export_arn: Optional[_builtins.str] = ..., refresh_cadences: Optional[Sequence[outputs.ExportExportRefreshCadence]] = ...) -> None:
...
class ExportExportDataQuery(dict):
    ...
    def __init__(__self__, *, query_statement: _builtins.str, table_configurations: Optional[Mapping[str, Mapping[str, _builtins.str]]] = ...) -> None:
...
class ExportExportDestinationConfiguration(dict):
    ...
    def __init__(__self__, *, s3_destinations: Optional[Sequence[outputs.ExportExportDestinationConfigurationS3Destination]] = ...) -> None:
...
class ExportExportDestinationConfigurationS3Destination(dict):
    ...
    def __init__(__self__, *, s3_bucket: _builtins.str, s3_prefix: _builtins.str, s3_region: _builtins.str, s3_output_configurations: Optional[Sequence[outputs.ExportExportDestinationConfigurationS3DestinationS3OutputConfiguration]] = ...) -> None:
...
class ExportExportDestinationConfigurationS3DestinationS3OutputConfiguration(dict):
    ...
    def __init__(__self__, *, compression: _builtins.str, format: _builtins.str, output_type: _builtins.str, overwrite: _builtins.str) -> None:
