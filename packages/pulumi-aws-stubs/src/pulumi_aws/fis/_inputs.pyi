...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ExperimentTemplateActionArgs', 'ExperimentTemplateActionArgsDict', 'ExperimentTemplateActionParameterArgs', 'ExperimentTemplateActionParameterArgsDict', 'ExperimentTemplateActionTargetArgs', 'ExperimentTemplateActionTargetArgsDict', 'ExperimentTemplateExperimentOptionsArgs', 'ExperimentTemplateExperimentOptionsArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ExperimentTemplateLogConfigurationArgs', 'ExperimentTemplateLogConfigurationArgsDict', ..., ..., ..., ..., 'ExperimentTemplateStopConditionArgs', 'ExperimentTemplateStopConditionArgsDict', 'ExperimentTemplateTargetArgs', 'ExperimentTemplateTargetArgsDict', 'ExperimentTemplateTargetFilterArgs', 'ExperimentTemplateTargetFilterArgsDict', 'ExperimentTemplateTargetResourceTagArgs', 'ExperimentTemplateTargetResourceTagArgsDict']
...
class ExperimentTemplateActionArgs:
    def __init__(__self__, *, action_id: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ExperimentTemplateActionParameterArgs]]]] = ..., start_afters: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., target: Optional[pulumi.Input[ExperimentTemplateActionTargetArgs]] = ...) -> None:
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExperimentTemplateActionParameterArgs]]]]): # -> None:
        ...
    ...
    @start_afters.setter
    def start_afters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @target.setter
    def target(self, value: Optional[pulumi.Input[ExperimentTemplateActionTargetArgs]]): # -> None:
        ...
...
class ExperimentTemplateExperimentOptionsArgs:
    def __init__(__self__, *, account_targeting: Optional[pulumi.Input[_builtins.str]] = ..., empty_target_resolution_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def account_targeting(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def empty_target_resolution_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ExperimentTemplateExperimentReportConfigurationArgs:
    def __init__(__self__, *, data_sources: Optional[pulumi.Input[ExperimentTemplateExperimentReportConfigurationDataSourcesArgs]] = ..., outputs: Optional[pulumi.Input[ExperimentTemplateExperimentReportConfigurationOutputsArgs]] = ..., post_experiment_duration: Optional[pulumi.Input[_builtins.str]] = ..., pre_experiment_duration: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_sources.setter
    def data_sources(self, value: Optional[pulumi.Input[ExperimentTemplateExperimentReportConfigurationDataSourcesArgs]]): # -> None:
        ...
    ...
    @outputs.setter
    def outputs(self, value: Optional[pulumi.Input[ExperimentTemplateExperimentReportConfigurationOutputsArgs]]): # -> None:
        ...
    ...
    def post_experiment_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def pre_experiment_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ExperimentTemplateExperimentReportConfigurationDataSourcesArgs:
    def __init__(__self__, *, cloudwatch_dashboards: Optional[pulumi.Input[Sequence[pulumi.Input[ExperimentTemplateExperimentReportConfigurationDataSourcesCloudwatchDashboardArgs]]]] = ...) -> None:
    ...
    def cloudwatch_dashboards(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExperimentTemplateExperimentReportConfigurationDataSourcesCloudwatchDashboardArgs]]]]): # -> None:
        ...
...
class ExperimentTemplateExperimentReportConfigurationDataSourcesCloudwatchDashboardArgs:
    def __init__(__self__, *, dashboard_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ExperimentTemplateExperimentReportConfigurationOutputsArgs:
    def __init__(__self__, *, s3_configuration: Optional[pulumi.Input[ExperimentTemplateExperimentReportConfigurationOutputsS3ConfigurationArgs]] = ...) -> None:
    ...
    def s3_configuration(self, value: Optional[pulumi.Input[ExperimentTemplateExperimentReportConfigurationOutputsS3ConfigurationArgs]]): # -> None:
        ...
...
class ExperimentTemplateExperimentReportConfigurationOutputsS3ConfigurationArgs:
    def __init__(__self__, *, bucket_name: pulumi.Input[_builtins.str], prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ExperimentTemplateLogConfigurationArgs:
    def __init__(__self__, *, log_schema_version: pulumi.Input[_builtins.int], cloudwatch_logs_configuration: Optional[pulumi.Input[ExperimentTemplateLogConfigurationCloudwatchLogsConfigurationArgs]] = ..., s3_configuration: Optional[pulumi.Input[ExperimentTemplateLogConfigurationS3ConfigurationArgs]] = ...) -> None:
    ...
    def log_schema_version(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def cloudwatch_logs_configuration(self, value: Optional[pulumi.Input[ExperimentTemplateLogConfigurationCloudwatchLogsConfigurationArgs]]): # -> None:
        ...
    ...
    @s3_configuration.setter
    def s3_configuration(self, value: Optional[pulumi.Input[ExperimentTemplateLogConfigurationS3ConfigurationArgs]]): # -> None:
        ...
...
class ExperimentTemplateStopConditionArgs:
    def __init__(__self__, *, source: pulumi.Input[_builtins.str], value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ExperimentTemplateTargetArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], resource_type: pulumi.Input[_builtins.str], selection_mode: pulumi.Input[_builtins.str], filters: Optional[pulumi.Input[Sequence[pulumi.Input[ExperimentTemplateTargetFilterArgs]]]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., resource_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., resource_tags: Optional[pulumi.Input[Sequence[pulumi.Input[ExperimentTemplateTargetResourceTagArgs]]]] = ...) -> None:
    ...
    def selection_mode(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @filters.setter
    def filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExperimentTemplateTargetFilterArgs]]]]): # -> None:
        ...
    ...
    def resource_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExperimentTemplateTargetResourceTagArgs]]]]): # -> None:
        ...
...
class ExperimentTemplateTargetFilterArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
