...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FrameworkControl', 'FrameworkControlInputParameter', 'FrameworkControlScope', 'LogicallyAirGappedVaultTimeouts', 'PlanAdvancedBackupSetting', 'PlanRule', 'PlanRuleCopyAction', 'PlanRuleCopyActionLifecycle', 'PlanRuleLifecycle', 'PlanRuleScanAction', 'PlanScanSetting', 'ReportPlanReportDeliveryChannel', 'ReportPlanReportSetting', 'RestoreTestingPlanRecoveryPointSelection', 'RestoreTestingSelectionProtectedResourceConditions', ..., ..., 'SelectionCondition', 'SelectionConditionStringEqual', 'SelectionConditionStringLike', 'SelectionConditionStringNotEqual', 'SelectionConditionStringNotLike', 'SelectionSelectionTag', 'GetFrameworkControlResult', 'GetFrameworkControlInputParameterResult', 'GetFrameworkControlScopeResult', 'GetPlanRuleResult', 'GetPlanRuleCopyActionResult', 'GetPlanRuleCopyActionLifecycleResult', 'GetPlanRuleLifecycleResult', 'GetPlanRuleScanActionResult', 'GetPlanScanSettingResult', 'GetReportPlanReportDeliveryChannelResult', 'GetReportPlanReportSettingResult']
@pulumi.output_type
class FrameworkControl(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, input_parameters: Optional[Sequence[outputs.FrameworkControlInputParameter]] = ..., scope: Optional[outputs.FrameworkControlScope] = ...) -> None:
...
class FrameworkControlScope(dict):
    ...
    def __init__(__self__, *, compliance_resource_ids: Optional[Sequence[_builtins.str]] = ..., compliance_resource_types: Optional[Sequence[_builtins.str]] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class PlanAdvancedBackupSetting(dict):
    ...
    def __init__(__self__, *, backup_options: Mapping[str, _builtins.str], resource_type: _builtins.str) -> None:
...
class PlanRule(dict):
    ...
    def __init__(__self__, *, rule_name: _builtins.str, target_vault_name: _builtins.str, completion_window: Optional[_builtins.int] = ..., copy_actions: Optional[Sequence[outputs.PlanRuleCopyAction]] = ..., enable_continuous_backup: Optional[_builtins.bool] = ..., lifecycle: Optional[outputs.PlanRuleLifecycle] = ..., recovery_point_tags: Optional[Mapping[str, _builtins.str]] = ..., scan_actions: Optional[Sequence[outputs.PlanRuleScanAction]] = ..., schedule: Optional[_builtins.str] = ..., schedule_expression_timezone: Optional[_builtins.str] = ..., start_window: Optional[_builtins.int] = ..., target_logically_air_gapped_backup_vault_arn: Optional[_builtins.str] = ...) -> None:
...
class PlanRuleCopyAction(dict):
    ...
    def __init__(__self__, *, destination_vault_arn: _builtins.str, lifecycle: Optional[outputs.PlanRuleCopyActionLifecycle] = ...) -> None:
...
class PlanRuleCopyActionLifecycle(dict):
    ...
    def __init__(__self__, *, cold_storage_after: Optional[_builtins.int] = ..., delete_after: Optional[_builtins.int] = ..., opt_in_to_archive_for_supported_resources: Optional[_builtins.bool] = ...) -> None:
...
class PlanRuleScanAction(dict):
    ...
    def __init__(__self__, *, malware_scanner: _builtins.str, scan_mode: _builtins.str) -> None:
...
class PlanScanSetting(dict):
    ...
    def __init__(__self__, *, malware_scanner: _builtins.str, resource_types: Sequence[_builtins.str], scanner_role_arn: _builtins.str) -> None:
...
class ReportPlanReportDeliveryChannel(dict):
    ...
    def __init__(__self__, *, s3_bucket_name: _builtins.str, formats: Optional[Sequence[_builtins.str]] = ..., s3_key_prefix: Optional[_builtins.str] = ...) -> None:
...
class ReportPlanReportSetting(dict):
    ...
    def __init__(__self__, *, report_template: _builtins.str, accounts: Optional[Sequence[_builtins.str]] = ..., framework_arns: Optional[Sequence[_builtins.str]] = ..., number_of_frameworks: Optional[_builtins.int] = ..., organization_units: Optional[Sequence[_builtins.str]] = ..., regions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class RestoreTestingPlanRecoveryPointSelection(dict):
    ...
    def __init__(__self__, *, algorithm: _builtins.str, include_vaults: Sequence[_builtins.str], recovery_point_types: Sequence[_builtins.str], exclude_vaults: Optional[Sequence[_builtins.str]] = ..., selection_window_days: Optional[_builtins.int] = ...) -> None:
...
class RestoreTestingSelectionProtectedResourceConditions(dict):
    ...
    def __init__(__self__, *, string_equals: Optional[Sequence[outputs.RestoreTestingSelectionProtectedResourceConditionsStringEqual]] = ..., string_not_equals: Optional[Sequence[outputs.RestoreTestingSelectionProtectedResourceConditionsStringNotEqual]] = ...) -> None:
...
class SelectionCondition(dict):
    ...
    def __init__(__self__, *, string_equals: Optional[Sequence[outputs.SelectionConditionStringEqual]] = ..., string_likes: Optional[Sequence[outputs.SelectionConditionStringLike]] = ..., string_not_equals: Optional[Sequence[outputs.SelectionConditionStringNotEqual]] = ..., string_not_likes: Optional[Sequence[outputs.SelectionConditionStringNotLike]] = ...) -> None:
...
class GetFrameworkControlResult(dict):
    def __init__(__self__, *, input_parameters: Sequence[outputs.GetFrameworkControlInputParameterResult], name: _builtins.str, scopes: Sequence[outputs.GetFrameworkControlScopeResult]) -> None:
...
class GetFrameworkControlScopeResult(dict):
    def __init__(__self__, *, compliance_resource_ids: Sequence[_builtins.str], compliance_resource_types: Sequence[_builtins.str], tags: Mapping[str, _builtins.str]) -> None:
...
class GetPlanRuleResult(dict):
    def __init__(__self__, *, completion_window: _builtins.int, copy_actions: Sequence[outputs.GetPlanRuleCopyActionResult], enable_continuous_backup: _builtins.bool, lifecycles: Sequence[outputs.GetPlanRuleLifecycleResult], rule_name: _builtins.str, scan_actions: Sequence[outputs.GetPlanRuleScanActionResult], schedule: _builtins.str, schedule_expression_timezone: _builtins.str, start_window: _builtins.int, target_logically_air_gapped_backup_vault_arn: _builtins.str, target_vault_name: _builtins.str, recovery_point_tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
        ...
...
class GetPlanRuleCopyActionResult(dict):
    def __init__(__self__, *, destination_vault_arn: _builtins.str, lifecycles: Sequence[outputs.GetPlanRuleCopyActionLifecycleResult]) -> None:
        ...
...
class GetPlanRuleCopyActionLifecycleResult(dict):
    def __init__(__self__, *, cold_storage_after: _builtins.int, delete_after: _builtins.int, opt_in_to_archive_for_supported_resources: _builtins.bool) -> None:
        ...
...
class GetReportPlanReportDeliveryChannelResult(dict):
    def __init__(__self__, *, formats: Sequence[_builtins.str], s3_bucket_name: _builtins.str, s3_key_prefix: _builtins.str) -> None:
...
class GetReportPlanReportSettingResult(dict):
    def __init__(__self__, *, accounts: Sequence[_builtins.str], framework_arns: Sequence[_builtins.str], number_of_frameworks: _builtins.int, organization_units: Sequence[_builtins.str], regions: Sequence[_builtins.str], report_template: _builtins.str) -> None:
