...
class FrameworkArgs:
    ...
    def controls(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input[FrameworkControlArgs]]]: ...
    @controls.setter
    def controls(
        self, value: pulumi.Input[Sequence[pulumi.Input[FrameworkControlArgs]]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _FrameworkState:
    ...
    def controls(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[FrameworkControlArgs]]]]: ...
    @controls.setter
    def controls(
        self,
        value: Optional[pulumi.Input[Sequence[pulumi.Input[FrameworkControlArgs]]]],
    ): ...
    @_builtins.property
...
@pulumi.type_token("aws:backup/framework:Framework")
class Framework(pulumi.CustomResource):
    ...
    def __init__(
        ...
        controls: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[Union[FrameworkControlArgs, FrameworkControlArgsDict]]
                ]
            ]
        ] = ...,
        description: Optional[pulumi.Input[_builtins.str]] = ...,
