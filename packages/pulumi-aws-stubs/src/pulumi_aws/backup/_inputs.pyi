...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FrameworkControlArgs', 'FrameworkControlArgsDict', 'FrameworkControlInputParameterArgs', 'FrameworkControlInputParameterArgsDict', 'FrameworkControlScopeArgs', 'FrameworkControlScopeArgsDict', 'LogicallyAirGappedVaultTimeoutsArgs', 'LogicallyAirGappedVaultTimeoutsArgsDict', 'PlanAdvancedBackupSettingArgs', 'PlanAdvancedBackupSettingArgsDict', 'PlanRuleArgs', 'PlanRuleArgsDict', 'PlanRuleCopyActionArgs', 'PlanRuleCopyActionArgsDict', 'PlanRuleCopyActionLifecycleArgs', 'PlanRuleCopyActionLifecycleArgsDict', 'PlanRuleLifecycleArgs', 'PlanRuleLifecycleArgsDict', 'PlanRuleScanActionArgs', 'PlanRuleScanActionArgsDict', 'PlanScanSettingArgs', 'PlanScanSettingArgsDict', 'ReportPlanReportDeliveryChannelArgs', 'ReportPlanReportDeliveryChannelArgsDict', 'ReportPlanReportSettingArgs', 'ReportPlanReportSettingArgsDict', 'RestoreTestingPlanRecoveryPointSelectionArgs', 'RestoreTestingPlanRecoveryPointSelectionArgsDict', ..., ..., ..., ..., ..., ..., 'SelectionConditionArgs', 'SelectionConditionArgsDict', 'SelectionConditionStringEqualArgs', 'SelectionConditionStringEqualArgsDict', 'SelectionConditionStringLikeArgs', 'SelectionConditionStringLikeArgsDict', 'SelectionConditionStringNotEqualArgs', 'SelectionConditionStringNotEqualArgsDict', 'SelectionConditionStringNotLikeArgs', 'SelectionConditionStringNotLikeArgsDict', 'SelectionSelectionTagArgs', 'SelectionSelectionTagArgsDict']
...
class FrameworkControlArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], input_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[FrameworkControlInputParameterArgs]]]] = ..., scope: Optional[pulumi.Input[FrameworkControlScopeArgs]] = ...) -> None:
    ...
    def input_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FrameworkControlInputParameterArgs]]]]): # -> None:
        ...
    ...
    @scope.setter
    def scope(self, value: Optional[pulumi.Input[FrameworkControlScopeArgs]]): # -> None:
        ...
...
class FrameworkControlScopeArgs:
    def __init__(__self__, *, compliance_resource_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., compliance_resource_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def compliance_resource_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class PlanAdvancedBackupSettingArgs:
    def __init__(__self__, *, backup_options: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], resource_type: pulumi.Input[_builtins.str]) -> None:
    ...
    def backup_options(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
@pulumi.input_type
class PlanRuleArgs:
    def __init__(__self__, *, rule_name: pulumi.Input[_builtins.str], target_vault_name: pulumi.Input[_builtins.str], completion_window: Optional[pulumi.Input[_builtins.int]] = ..., copy_actions: Optional[pulumi.Input[Sequence[pulumi.Input[PlanRuleCopyActionArgs]]]] = ..., enable_continuous_backup: Optional[pulumi.Input[_builtins.bool]] = ..., lifecycle: Optional[pulumi.Input[PlanRuleLifecycleArgs]] = ..., recovery_point_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., scan_actions: Optional[pulumi.Input[Sequence[pulumi.Input[PlanRuleScanActionArgs]]]] = ..., schedule: Optional[pulumi.Input[_builtins.str]] = ..., schedule_expression_timezone: Optional[pulumi.Input[_builtins.str]] = ..., start_window: Optional[pulumi.Input[_builtins.int]] = ..., target_logically_air_gapped_backup_vault_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def target_vault_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def completion_window(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @copy_actions.setter
    def copy_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanRuleCopyActionArgs]]]]): # -> None:
        ...
    ...
    def enable_continuous_backup(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @lifecycle.setter
    def lifecycle(self, value: Optional[pulumi.Input[PlanRuleLifecycleArgs]]): # -> None:
        ...
    ...
    def recovery_point_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @scan_actions.setter
    def scan_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanRuleScanActionArgs]]]]): # -> None:
        ...
    ...
    @start_window.setter
    def start_window(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def target_logically_air_gapped_backup_vault_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PlanRuleCopyActionArgs:
    def __init__(__self__, *, destination_vault_arn: pulumi.Input[_builtins.str], lifecycle: Optional[pulumi.Input[PlanRuleCopyActionLifecycleArgs]] = ...) -> None:
    ...
    def destination_vault_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @lifecycle.setter
    def lifecycle(self, value: Optional[pulumi.Input[PlanRuleCopyActionLifecycleArgs]]): # -> None:
        ...
...
class PlanRuleCopyActionLifecycleArgs:
    def __init__(__self__, *, cold_storage_after: Optional[pulumi.Input[_builtins.int]] = ..., delete_after: Optional[pulumi.Input[_builtins.int]] = ..., opt_in_to_archive_for_supported_resources: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def cold_storage_after(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @delete_after.setter
    def delete_after(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def opt_in_to_archive_for_supported_resources(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class PlanRuleScanActionArgs:
    def __init__(__self__, *, malware_scanner: pulumi.Input[_builtins.str], scan_mode: pulumi.Input[_builtins.str]) -> None:
    ...
    def malware_scanner(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @scan_mode.setter
    def scan_mode(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PlanScanSettingArgs:
    def __init__(__self__, *, malware_scanner: pulumi.Input[_builtins.str], resource_types: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], scanner_role_arn: pulumi.Input[_builtins.str]) -> None:
    ...
    def scanner_role_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ReportPlanReportDeliveryChannelArgs:
    def __init__(__self__, *, s3_bucket_name: pulumi.Input[_builtins.str], formats: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., s3_key_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @formats.setter
    def formats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ReportPlanReportSettingArgs:
    def __init__(__self__, *, report_template: pulumi.Input[_builtins.str], accounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., framework_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., number_of_frameworks: Optional[pulumi.Input[_builtins.int]] = ..., organization_units: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def report_template(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def framework_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def number_of_frameworks(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def organization_units(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RestoreTestingPlanRecoveryPointSelectionArgs:
    def __init__(__self__, *, algorithm: pulumi.Input[_builtins.str], include_vaults: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], recovery_point_types: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], exclude_vaults: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., selection_window_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def include_vaults(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def recovery_point_types(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def exclude_vaults(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def selection_window_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class RestoreTestingSelectionProtectedResourceConditionsArgs:
    def __init__(__self__, *, string_equals: Optional[pulumi.Input[Sequence[pulumi.Input[RestoreTestingSelectionProtectedResourceConditionsStringEqualArgs]]]] = ..., string_not_equals: Optional[pulumi.Input[Sequence[pulumi.Input[RestoreTestingSelectionProtectedResourceConditionsStringNotEqualArgs]]]] = ...) -> None:
    ...
    def string_equals(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RestoreTestingSelectionProtectedResourceConditionsStringEqualArgs]]]]): # -> None:
        ...
    ...
    def string_not_equals(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RestoreTestingSelectionProtectedResourceConditionsStringNotEqualArgs]]]]): # -> None:
        ...
...
class SelectionConditionArgs:
    def __init__(__self__, *, string_equals: Optional[pulumi.Input[Sequence[pulumi.Input[SelectionConditionStringEqualArgs]]]] = ..., string_likes: Optional[pulumi.Input[Sequence[pulumi.Input[SelectionConditionStringLikeArgs]]]] = ..., string_not_equals: Optional[pulumi.Input[Sequence[pulumi.Input[SelectionConditionStringNotEqualArgs]]]] = ..., string_not_likes: Optional[pulumi.Input[Sequence[pulumi.Input[SelectionConditionStringNotLikeArgs]]]] = ...) -> None:
    ...
    @string_equals.setter
    def string_equals(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SelectionConditionStringEqualArgs]]]]): # -> None:
        ...
    ...
    @string_likes.setter
    def string_likes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SelectionConditionStringLikeArgs]]]]): # -> None:
        ...
    ...
    @string_not_equals.setter
    def string_not_equals(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SelectionConditionStringNotEqualArgs]]]]): # -> None:
        ...
    ...
    def string_not_likes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SelectionConditionStringNotLikeArgs]]]]): # -> None:
        ...
