...
class GetOrderableDbInstanceResult:
    ...
    def __init__(__self__, availability_zones=..., engine=..., engine_version=..., id=..., instance_class=..., license_model=..., max_iops_per_db_instance=..., max_iops_per_gib=..., max_storage_size=..., min_iops_per_db_instance=..., min_iops_per_gib=..., min_storage_size=..., multi_az_capable=..., preferred_instance_classes=..., read_replica_capable=..., region=..., storage_type=..., supports_enhanced_monitoring=..., supports_iam_database_authentication=..., supports_iops=..., supports_performance_insights=..., supports_storage_encryption=..., vpc=...) -> None:
        ...
...
def get_orderable_db_instance(engine: Optional[_builtins.str] = ..., engine_version: Optional[_builtins.str] = ..., instance_class: Optional[_builtins.str] = ..., license_model: Optional[_builtins.str] = ..., preferred_instance_classes: Optional[Sequence[_builtins.str]] = ..., region: Optional[_builtins.str] = ..., vpc: Optional[_builtins.bool] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetOrderableDbInstanceResult:
    
    ...

def get_orderable_db_instance_output(engine: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., engine_version: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., instance_class: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., license_model: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., preferred_instance_classes: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., vpc: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetOrderableDbInstanceResult]:
