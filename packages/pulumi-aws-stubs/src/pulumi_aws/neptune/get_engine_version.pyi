...
def get_engine_version(default_only: Optional[_builtins.bool] = ..., engine: Optional[_builtins.str] = ..., has_major_target: Optional[_builtins.bool] = ..., has_minor_target: Optional[_builtins.bool] = ..., latest: Optional[_builtins.bool] = ..., parameter_group_family: Optional[_builtins.str] = ..., preferred_major_targets: Optional[Sequence[_builtins.str]] = ..., preferred_upgrade_targets: Optional[Sequence[_builtins.str]] = ..., preferred_versions: Optional[Sequence[_builtins.str]] = ..., region: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetEngineVersionResult:
    
    ...

def get_engine_version_output(default_only: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., engine: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., has_major_target: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., has_minor_target: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., latest: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., parameter_group_family: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., preferred_major_targets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = ..., preferred_upgrade_targets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = ..., preferred_versions: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., version: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetEngineVersionResult]:
