...
class HoursOfOperationArgs:
    ...
    def configs(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input[HoursOfOperationConfigArgs]]]: ...
    @configs.setter
    def configs(
        self, value: pulumi.Input[Sequence[pulumi.Input[HoursOfOperationConfigArgs]]]
    ): ...
    @_builtins.property
...
class _HoursOfOperationState:
    ...
    def configs(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[HoursOfOperationConfigArgs]]]]: ...
    @configs.setter
    def configs(
        self,
        value: Optional[
        ...
        configs: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[
                            HoursOfOperationConfigArgs, HoursOfOperationConfigArgsDict
                        ]
                    ]
                ]
            ]
