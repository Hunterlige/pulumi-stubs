...
class GetRoutingProfileResult:
    ...
    def media_concurrencies(
        self,
    ) -> Sequence[outputs.GetRoutingProfileMediaConcurrencyResult]: ...
    @_builtins.property
    @pulumi.getter
...
def get_routing_profile(
    ...
    routing_profile_id: Optional[_builtins.str] = ...,
...
def get_routing_profile_output(
    ...
    routing_profile_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ...,
    tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetRoutingProfileResult]: ...
