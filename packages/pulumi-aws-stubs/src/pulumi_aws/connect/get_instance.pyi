...
class GetInstanceResult:
    ...
    def __init__(__self__, arn=..., auto_resolve_best_voices_enabled=..., contact_flow_logs_enabled=..., contact_lens_enabled=..., created_time=..., early_media_enabled=..., id=..., identity_management_type=..., inbound_calls_enabled=..., instance_alias=..., instance_id=..., multi_party_conference_enabled=..., outbound_calls_enabled=..., region=..., service_role=..., status=..., tags=...) -> None:
        ...
...
def get_instance(instance_alias: Optional[_builtins.str] = ..., instance_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetInstanceResult:
    
    ...

def get_instance_output(instance_alias: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., instance_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetInstanceResult]:
