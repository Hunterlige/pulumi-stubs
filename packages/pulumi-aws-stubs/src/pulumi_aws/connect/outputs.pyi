...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BotAssociationLexBot', 'HoursOfOperationConfig', 'HoursOfOperationConfigEndTime', 'HoursOfOperationConfigStartTime', 'InstanceStorageConfigStorageConfig', ..., ..., ..., ..., 'InstanceStorageConfigStorageConfigS3Config', ..., 'PhoneNumberStatus', 'QueueOutboundCallerConfig', 'QuickConnectQuickConnectConfig', 'QuickConnectQuickConnectConfigPhoneConfig', 'QuickConnectQuickConnectConfigQueueConfig', 'QuickConnectQuickConnectConfigUserConfig', 'RoutingProfileMediaConcurrency', 'RoutingProfileMediaConcurrencyCrossChannelBehavior', 'RoutingProfileQueueConfig', 'UserHierarchyGroupHierarchyPath', 'UserHierarchyGroupHierarchyPathLevelFife', 'UserHierarchyGroupHierarchyPathLevelFour', 'UserHierarchyGroupHierarchyPathLevelOne', 'UserHierarchyGroupHierarchyPathLevelThree', 'UserHierarchyGroupHierarchyPathLevelTwo', 'UserHierarchyStructureHierarchyStructure', 'UserHierarchyStructureHierarchyStructureLevelFive', 'UserHierarchyStructureHierarchyStructureLevelFour', 'UserHierarchyStructureHierarchyStructureLevelOne', 'UserHierarchyStructureHierarchyStructureLevelThree', 'UserHierarchyStructureHierarchyStructureLevelTwo', 'UserIdentityInfo', 'UserPhoneConfig', 'GetBotAssociationLexBotResult', 'GetHoursOfOperationConfigResult', 'GetHoursOfOperationConfigEndTimeResult', 'GetHoursOfOperationConfigStartTimeResult', 'GetInstanceStorageConfigStorageConfigResult', ..., ..., ..., ..., ..., ..., 'GetQueueOutboundCallerConfigResult', 'GetQuickConnectQuickConnectConfigResult', 'GetQuickConnectQuickConnectConfigPhoneConfigResult', 'GetQuickConnectQuickConnectConfigQueueConfigResult', 'GetQuickConnectQuickConnectConfigUserConfigResult', 'GetRoutingProfileMediaConcurrencyResult', ..., 'GetRoutingProfileQueueConfigResult', 'GetUserHierarchyGroupHierarchyPathResult', 'GetUserHierarchyGroupHierarchyPathLevelFifeResult', 'GetUserHierarchyGroupHierarchyPathLevelFourResult', 'GetUserHierarchyGroupHierarchyPathLevelOneResult', 'GetUserHierarchyGroupHierarchyPathLevelThreeResult', 'GetUserHierarchyGroupHierarchyPathLevelTwoResult', 'GetUserHierarchyStructureHierarchyStructureResult', ..., ..., ..., ..., ..., 'GetUserIdentityInfoResult', 'GetUserPhoneConfigResult']
@pulumi.output_type
class BotAssociationLexBot(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, lex_region: Optional[_builtins.str] = ...) -> None:
...
class HoursOfOperationConfig(dict):
    ...
    def __init__(__self__, *, day: _builtins.str, end_time: outputs.HoursOfOperationConfigEndTime, start_time: outputs.HoursOfOperationConfigStartTime) -> None:
...
class InstanceStorageConfigStorageConfig(dict):
    ...
    def __init__(__self__, *, storage_type: _builtins.str, kinesis_firehose_config: Optional[outputs.InstanceStorageConfigStorageConfigKinesisFirehoseConfig] = ..., kinesis_stream_config: Optional[outputs.InstanceStorageConfigStorageConfigKinesisStreamConfig] = ..., kinesis_video_stream_config: Optional[outputs.InstanceStorageConfigStorageConfigKinesisVideoStreamConfig] = ..., s3_config: Optional[outputs.InstanceStorageConfigStorageConfigS3Config] = ...) -> None:
...
class InstanceStorageConfigStorageConfigKinesisVideoStreamConfig(dict):
    ...
    def __init__(__self__, *, encryption_config: outputs.InstanceStorageConfigStorageConfigKinesisVideoStreamConfigEncryptionConfig, prefix: _builtins.str, retention_period_hours: _builtins.int) -> None:
...
class InstanceStorageConfigStorageConfigKinesisVideoStreamConfigEncryptionConfig(dict):
    ...
    def __init__(__self__, *, encryption_type: _builtins.str, key_id: _builtins.str) -> None:
...
class InstanceStorageConfigStorageConfigS3Config(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, bucket_prefix: _builtins.str, encryption_config: Optional[outputs.InstanceStorageConfigStorageConfigS3ConfigEncryptionConfig] = ...) -> None:
...
class PhoneNumberStatus(dict):
    def __init__(__self__, *, message: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class QueueOutboundCallerConfig(dict):
    ...
    def __init__(__self__, *, outbound_caller_id_name: Optional[_builtins.str] = ..., outbound_caller_id_number_id: Optional[_builtins.str] = ..., outbound_flow_id: Optional[_builtins.str] = ...) -> None:
...
class QuickConnectQuickConnectConfig(dict):
    ...
    def __init__(__self__, *, quick_connect_type: _builtins.str, phone_configs: Optional[Sequence[outputs.QuickConnectQuickConnectConfigPhoneConfig]] = ..., queue_configs: Optional[Sequence[outputs.QuickConnectQuickConnectConfigQueueConfig]] = ..., user_configs: Optional[Sequence[outputs.QuickConnectQuickConnectConfigUserConfig]] = ...) -> None:
...
class QuickConnectQuickConnectConfigQueueConfig(dict):
    ...
    def __init__(__self__, *, contact_flow_id: _builtins.str, queue_id: _builtins.str) -> None:
...
class QuickConnectQuickConnectConfigUserConfig(dict):
    ...
    def __init__(__self__, *, contact_flow_id: _builtins.str, user_id: _builtins.str) -> None:
...
class RoutingProfileMediaConcurrency(dict):
    ...
    def __init__(__self__, *, channel: _builtins.str, concurrency: _builtins.int, cross_channel_behavior: Optional[outputs.RoutingProfileMediaConcurrencyCrossChannelBehavior] = ...) -> None:
...
class RoutingProfileQueueConfig(dict):
    ...
    def __init__(__self__, *, channel: _builtins.str, delay: _builtins.int, priority: _builtins.int, queue_id: _builtins.str, queue_arn: Optional[_builtins.str] = ..., queue_name: Optional[_builtins.str] = ...) -> None:
...
class UserHierarchyGroupHierarchyPath(dict):
    ...
    def __init__(__self__, *, level_fives: Optional[Sequence[outputs.UserHierarchyGroupHierarchyPathLevelFife]] = ..., level_fours: Optional[Sequence[outputs.UserHierarchyGroupHierarchyPathLevelFour]] = ..., level_ones: Optional[Sequence[outputs.UserHierarchyGroupHierarchyPathLevelOne]] = ..., level_threes: Optional[Sequence[outputs.UserHierarchyGroupHierarchyPathLevelThree]] = ..., level_twos: Optional[Sequence[outputs.UserHierarchyGroupHierarchyPathLevelTwo]] = ...) -> None:
...
class UserHierarchyStructureHierarchyStructure(dict):
    ...
    def __init__(__self__, *, level_five: Optional[outputs.UserHierarchyStructureHierarchyStructureLevelFive] = ..., level_four: Optional[outputs.UserHierarchyStructureHierarchyStructureLevelFour] = ..., level_one: Optional[outputs.UserHierarchyStructureHierarchyStructureLevelOne] = ..., level_three: Optional[outputs.UserHierarchyStructureHierarchyStructureLevelThree] = ..., level_two: Optional[outputs.UserHierarchyStructureHierarchyStructureLevelTwo] = ...) -> None:
...
class UserHierarchyStructureHierarchyStructureLevelFive(dict):
    def __init__(__self__, *, name: _builtins.str, arn: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ...) -> None:
...
class UserIdentityInfo(dict):
    ...
    def __init__(__self__, *, email: Optional[_builtins.str] = ..., first_name: Optional[_builtins.str] = ..., last_name: Optional[_builtins.str] = ..., secondary_email: Optional[_builtins.str] = ...) -> None:
...
class UserPhoneConfig(dict):
    ...
    def __init__(__self__, *, phone_type: _builtins.str, after_contact_work_time_limit: Optional[_builtins.int] = ..., auto_accept: Optional[_builtins.bool] = ..., desk_phone_number: Optional[_builtins.str] = ...) -> None:
...
class GetHoursOfOperationConfigResult(dict):
    def __init__(__self__, *, day: _builtins.str, end_times: Sequence[outputs.GetHoursOfOperationConfigEndTimeResult], start_times: Sequence[outputs.GetHoursOfOperationConfigStartTimeResult]) -> None:
...
class GetInstanceStorageConfigStorageConfigResult(dict):
    def __init__(__self__, *, kinesis_firehose_configs: Sequence[outputs.GetInstanceStorageConfigStorageConfigKinesisFirehoseConfigResult], kinesis_stream_configs: Sequence[outputs.GetInstanceStorageConfigStorageConfigKinesisStreamConfigResult], kinesis_video_stream_configs: Sequence[outputs.GetInstanceStorageConfigStorageConfigKinesisVideoStreamConfigResult], s3_configs: Sequence[outputs.GetInstanceStorageConfigStorageConfigS3ConfigResult], storage_type: _builtins.str) -> None:
...
class GetInstanceStorageConfigStorageConfigKinesisVideoStreamConfigResult(dict):
    def __init__(__self__, *, encryption_configs: Sequence[outputs.GetInstanceStorageConfigStorageConfigKinesisVideoStreamConfigEncryptionConfigResult], prefix: _builtins.str, retention_period_hours: _builtins.int) -> None:
...
class GetInstanceStorageConfigStorageConfigS3ConfigResult(dict):
    def __init__(__self__, *, bucket_name: _builtins.str, bucket_prefix: _builtins.str, encryption_configs: Sequence[outputs.GetInstanceStorageConfigStorageConfigS3ConfigEncryptionConfigResult]) -> None:
...
class GetQueueOutboundCallerConfigResult(dict):
    def __init__(__self__, *, outbound_caller_id_name: _builtins.str, outbound_caller_id_number_id: _builtins.str, outbound_flow_id: _builtins.str) -> None:
...
class GetQuickConnectQuickConnectConfigResult(dict):
    def __init__(__self__, *, phone_configs: Sequence[outputs.GetQuickConnectQuickConnectConfigPhoneConfigResult], queue_configs: Sequence[outputs.GetQuickConnectQuickConnectConfigQueueConfigResult], quick_connect_type: _builtins.str, user_configs: Sequence[outputs.GetQuickConnectQuickConnectConfigUserConfigResult]) -> None:
...
class GetRoutingProfileMediaConcurrencyResult(dict):
    def __init__(__self__, *, channel: _builtins.str, concurrency: _builtins.int, cross_channel_behaviors: Sequence[outputs.GetRoutingProfileMediaConcurrencyCrossChannelBehaviorResult]) -> None:
...
class GetRoutingProfileQueueConfigResult(dict):
    def __init__(__self__, *, channel: _builtins.str, delay: _builtins.int, priority: _builtins.int, queue_arn: _builtins.str, queue_id: _builtins.str, queue_name: _builtins.str) -> None:
...
class GetUserHierarchyGroupHierarchyPathResult(dict):
    def __init__(__self__, *, level_fives: Sequence[outputs.GetUserHierarchyGroupHierarchyPathLevelFifeResult], level_fours: Sequence[outputs.GetUserHierarchyGroupHierarchyPathLevelFourResult], level_ones: Sequence[outputs.GetUserHierarchyGroupHierarchyPathLevelOneResult], level_threes: Sequence[outputs.GetUserHierarchyGroupHierarchyPathLevelThreeResult], level_twos: Sequence[outputs.GetUserHierarchyGroupHierarchyPathLevelTwoResult]) -> None:
...
class GetUserHierarchyStructureHierarchyStructureResult(dict):
    def __init__(__self__, *, level_fives: Sequence[outputs.GetUserHierarchyStructureHierarchyStructureLevelFifeResult], level_fours: Sequence[outputs.GetUserHierarchyStructureHierarchyStructureLevelFourResult], level_ones: Sequence[outputs.GetUserHierarchyStructureHierarchyStructureLevelOneResult], level_threes: Sequence[outputs.GetUserHierarchyStructureHierarchyStructureLevelThreeResult], level_twos: Sequence[outputs.GetUserHierarchyStructureHierarchyStructureLevelTwoResult]) -> None:
...
class GetUserIdentityInfoResult(dict):
    def __init__(__self__, *, email: _builtins.str, first_name: _builtins.str, last_name: _builtins.str, secondary_email: _builtins.str) -> None:
...
class GetUserPhoneConfigResult(dict):
    def __init__(__self__, *, after_contact_work_time_limit: _builtins.int, auto_accept: _builtins.bool, desk_phone_number: _builtins.str, phone_type: _builtins.str) -> None:
