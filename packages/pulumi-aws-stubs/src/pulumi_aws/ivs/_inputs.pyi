...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['RecordingConfigurationDestinationConfigurationArgs', ..., ..., ..., 'RecordingConfigurationThumbnailConfigurationArgs', ...]
...
class RecordingConfigurationDestinationConfigurationArgs:
    def __init__(__self__, *, s3: pulumi.Input[RecordingConfigurationDestinationConfigurationS3Args]) -> None:
    ...
    @s3.setter
    def s3(self, value: pulumi.Input[RecordingConfigurationDestinationConfigurationS3Args]): # -> None:
        ...
...
class RecordingConfigurationThumbnailConfigurationArgs:
    def __init__(__self__, *, recording_mode: Optional[pulumi.Input[_builtins.str]] = ..., target_interval_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def recording_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_interval_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
