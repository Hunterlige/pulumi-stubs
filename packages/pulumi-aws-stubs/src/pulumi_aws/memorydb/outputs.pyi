...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterClusterEndpoint', 'ClusterShard', 'ClusterShardNode', 'ClusterShardNodeEndpoint', 'MultiRegionClusterTimeouts', 'ParameterGroupParameter', 'SnapshotClusterConfiguration', 'UserAuthenticationMode', 'GetClusterClusterEndpointResult', 'GetClusterShardResult', 'GetClusterShardNodeResult', 'GetClusterShardNodeEndpointResult', 'GetParameterGroupParameterResult', 'GetSnapshotClusterConfigurationResult', 'GetUserAuthenticationModeResult']
@pulumi.output_type
class ClusterClusterEndpoint(dict):
    def __init__(__self__, *, address: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ...) -> None:
...
class ClusterShard(dict):
    ...
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., nodes: Optional[Sequence[outputs.ClusterShardNode]] = ..., num_nodes: Optional[_builtins.int] = ..., slots: Optional[_builtins.str] = ...) -> None:
...
class ClusterShardNode(dict):
    ...
    def __init__(__self__, *, availability_zone: Optional[_builtins.str] = ..., create_time: Optional[_builtins.str] = ..., endpoints: Optional[Sequence[outputs.ClusterShardNodeEndpoint]] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class SnapshotClusterConfiguration(dict):
    ...
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., engine: Optional[_builtins.str] = ..., engine_version: Optional[_builtins.str] = ..., maintenance_window: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., node_type: Optional[_builtins.str] = ..., num_shards: Optional[_builtins.int] = ..., parameter_group_name: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., snapshot_retention_limit: Optional[_builtins.int] = ..., snapshot_window: Optional[_builtins.str] = ..., subnet_group_name: Optional[_builtins.str] = ..., topic_arn: Optional[_builtins.str] = ..., vpc_id: Optional[_builtins.str] = ...) -> None:
...
class GetClusterShardResult(dict):
    def __init__(__self__, *, name: _builtins.str, nodes: Sequence[outputs.GetClusterShardNodeResult], num_nodes: _builtins.int, slots: _builtins.str) -> None:
...
class GetClusterShardNodeResult(dict):
    def __init__(__self__, *, availability_zone: _builtins.str, create_time: _builtins.str, endpoints: Sequence[outputs.GetClusterShardNodeEndpointResult], name: _builtins.str) -> None:
...
class GetSnapshotClusterConfigurationResult(dict):
    def __init__(__self__, *, description: _builtins.str, engine: _builtins.str, engine_version: _builtins.str, maintenance_window: _builtins.str, name: _builtins.str, node_type: _builtins.str, num_shards: _builtins.int, parameter_group_name: _builtins.str, port: _builtins.int, snapshot_retention_limit: _builtins.int, snapshot_window: _builtins.str, subnet_group_name: _builtins.str, topic_arn: _builtins.str, vpc_id: _builtins.str) -> None:
...
class GetUserAuthenticationModeResult(dict):
    def __init__(__self__, *, password_count: _builtins.int, type: _builtins.str) -> None:
