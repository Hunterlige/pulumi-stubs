...
class _SnapshotState:
    def __init__(
        ...
        *,
        ...
        cluster_configurations: Optional[
            pulumi.Input[Sequence[pulumi.Input[SnapshotClusterConfigurationArgs]]]
        ] = ...,
...
class Snapshot(pulumi.CustomResource):
    ...
    def cluster_configurations(
        self,
    ) -> pulumi.Output[Sequence[outputs.SnapshotClusterConfiguration]]: ...
    @_builtins.property
    @pulumi.getter(name="clusterName")
