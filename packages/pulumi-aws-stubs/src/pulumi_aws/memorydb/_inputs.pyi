...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterClusterEndpointArgs', 'ClusterClusterEndpointArgsDict', 'ClusterShardArgs', 'ClusterShardArgsDict', 'ClusterShardNodeArgs', 'ClusterShardNodeArgsDict', 'ClusterShardNodeEndpointArgs', 'ClusterShardNodeEndpointArgsDict', 'MultiRegionClusterTimeoutsArgs', 'MultiRegionClusterTimeoutsArgsDict', 'ParameterGroupParameterArgs', 'ParameterGroupParameterArgsDict', 'SnapshotClusterConfigurationArgs', 'SnapshotClusterConfigurationArgsDict', 'UserAuthenticationModeArgs', 'UserAuthenticationModeArgsDict']
...
class ClusterClusterEndpointArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ClusterShardArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., nodes: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterShardNodeArgs]]]] = ..., num_nodes: Optional[pulumi.Input[_builtins.int]] = ..., slots: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @nodes.setter
    def nodes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterShardNodeArgs]]]]): # -> None:
        ...
...
class ClusterShardNodeArgs:
    def __init__(__self__, *, availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterShardNodeEndpointArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @endpoints.setter
    def endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterShardNodeEndpointArgs]]]]): # -> None:
        ...
...
class SnapshotClusterConfigurationArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., engine: Optional[pulumi.Input[_builtins.str]] = ..., engine_version: Optional[pulumi.Input[_builtins.str]] = ..., maintenance_window: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., node_type: Optional[pulumi.Input[_builtins.str]] = ..., num_shards: Optional[pulumi.Input[_builtins.int]] = ..., parameter_group_name: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., snapshot_retention_limit: Optional[pulumi.Input[_builtins.int]] = ..., snapshot_window: Optional[pulumi.Input[_builtins.str]] = ..., subnet_group_name: Optional[pulumi.Input[_builtins.str]] = ..., topic_arn: Optional[pulumi.Input[_builtins.str]] = ..., vpc_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
