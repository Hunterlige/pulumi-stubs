...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EventActionAction', 'EventActionActionExportRevisionToS3', 'EventActionActionExportRevisionToS3Encryption', ..., 'EventActionEvent', 'EventActionEventRevisionPublished', 'RevisionAssetsAsset', 'RevisionAssetsAssetCreateS3DataAccessFromS3Bucket', ..., ..., 'RevisionAssetsAssetImportAssetsFromS3', 'RevisionAssetsAssetImportAssetsFromS3AssetSource', 'RevisionAssetsAssetImportAssetsFromSignedUrl', 'RevisionAssetsTimeouts']
@pulumi.output_type
class EventActionAction(dict):
    ...
    def __init__(__self__, *, export_revision_to_s3: outputs.EventActionActionExportRevisionToS3) -> None:
...
class EventActionActionExportRevisionToS3(dict):
    ...
    def __init__(__self__, *, revision_destination: outputs.EventActionActionExportRevisionToS3RevisionDestination, encryption: Optional[outputs.EventActionActionExportRevisionToS3Encryption] = ...) -> None:
...
class EventActionActionExportRevisionToS3Encryption(dict):
    ...
    def __init__(__self__, *, kms_key_arn: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class EventActionActionExportRevisionToS3RevisionDestination(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, key_pattern: Optional[_builtins.str] = ...) -> None:
...
class EventActionEvent(dict):
    ...
    def __init__(__self__, *, revision_published: outputs.EventActionEventRevisionPublished) -> None:
...
class RevisionAssetsAsset(dict):
    ...
    def __init__(__self__, *, arn: Optional[_builtins.str] = ..., create_s3_data_access_from_s3_bucket: Optional[outputs.RevisionAssetsAssetCreateS3DataAccessFromS3Bucket] = ..., created_at: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., import_assets_from_s3: Optional[outputs.RevisionAssetsAssetImportAssetsFromS3] = ..., import_assets_from_signed_url: Optional[outputs.RevisionAssetsAssetImportAssetsFromSignedUrl] = ..., name: Optional[_builtins.str] = ..., updated_at: Optional[_builtins.str] = ...) -> None:
...
class RevisionAssetsAssetCreateS3DataAccessFromS3Bucket(dict):
    ...
    def __init__(__self__, *, access_point_alias: Optional[_builtins.str] = ..., access_point_arn: Optional[_builtins.str] = ..., asset_source: Optional[outputs.RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSource] = ...) -> None:
...
class RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSource(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, key_prefixes: Optional[Sequence[_builtins.str]] = ..., keys: Optional[Sequence[_builtins.str]] = ..., kms_keys_to_grants: Optional[Sequence[outputs.RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSourceKmsKeysToGrant]] = ...) -> None:
...
class RevisionAssetsAssetImportAssetsFromS3(dict):
    ...
    def __init__(__self__, *, asset_source: Optional[outputs.RevisionAssetsAssetImportAssetsFromS3AssetSource] = ...) -> None:
