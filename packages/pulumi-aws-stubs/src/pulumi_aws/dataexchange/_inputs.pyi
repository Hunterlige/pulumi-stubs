...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EventActionActionArgs', 'EventActionActionArgsDict', 'EventActionActionExportRevisionToS3Args', 'EventActionActionExportRevisionToS3ArgsDict', 'EventActionActionExportRevisionToS3EncryptionArgs', ..., ..., ..., 'EventActionEventArgs', 'EventActionEventArgsDict', 'EventActionEventRevisionPublishedArgs', 'EventActionEventRevisionPublishedArgsDict', 'RevisionAssetsAssetArgs', 'RevisionAssetsAssetArgsDict', ..., ..., ..., ..., ..., ..., 'RevisionAssetsAssetImportAssetsFromS3Args', 'RevisionAssetsAssetImportAssetsFromS3ArgsDict', ..., ..., 'RevisionAssetsAssetImportAssetsFromSignedUrlArgs', ..., 'RevisionAssetsTimeoutsArgs', 'RevisionAssetsTimeoutsArgsDict']
...
class EventActionActionArgs:
    def __init__(__self__, *, export_revision_to_s3: pulumi.Input[EventActionActionExportRevisionToS3Args]) -> None:
    ...
    def export_revision_to_s3(self, value: pulumi.Input[EventActionActionExportRevisionToS3Args]): # -> None:
        ...
...
class EventActionActionExportRevisionToS3Args:
    def __init__(__self__, *, revision_destination: pulumi.Input[EventActionActionExportRevisionToS3RevisionDestinationArgs], encryption: Optional[pulumi.Input[EventActionActionExportRevisionToS3EncryptionArgs]] = ...) -> None:
    ...
    def revision_destination(self, value: pulumi.Input[EventActionActionExportRevisionToS3RevisionDestinationArgs]): # -> None:
        ...
    ...
    @encryption.setter
    def encryption(self, value: Optional[pulumi.Input[EventActionActionExportRevisionToS3EncryptionArgs]]): # -> None:
        ...
...
class EventActionActionExportRevisionToS3EncryptionArgs:
    def __init__(__self__, *, kms_key_arn: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EventActionActionExportRevisionToS3RevisionDestinationArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], key_pattern: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @key_pattern.setter
    def key_pattern(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventActionEventArgs:
    def __init__(__self__, *, revision_published: pulumi.Input[EventActionEventRevisionPublishedArgs]) -> None:
    ...
    def revision_published(self, value: pulumi.Input[EventActionEventRevisionPublishedArgs]): # -> None:
        ...
...
class RevisionAssetsAssetArgs:
    def __init__(__self__, *, arn: Optional[pulumi.Input[_builtins.str]] = ..., create_s3_data_access_from_s3_bucket: Optional[pulumi.Input[RevisionAssetsAssetCreateS3DataAccessFromS3BucketArgs]] = ..., created_at: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., import_assets_from_s3: Optional[pulumi.Input[RevisionAssetsAssetImportAssetsFromS3Args]] = ..., import_assets_from_signed_url: Optional[pulumi.Input[RevisionAssetsAssetImportAssetsFromSignedUrlArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., updated_at: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def create_s3_data_access_from_s3_bucket(self, value: Optional[pulumi.Input[RevisionAssetsAssetCreateS3DataAccessFromS3BucketArgs]]): # -> None:
        ...
    ...
    def import_assets_from_s3(self, value: Optional[pulumi.Input[RevisionAssetsAssetImportAssetsFromS3Args]]): # -> None:
        ...
    ...
    def import_assets_from_signed_url(self, value: Optional[pulumi.Input[RevisionAssetsAssetImportAssetsFromSignedUrlArgs]]): # -> None:
        ...
...
class RevisionAssetsAssetCreateS3DataAccessFromS3BucketArgs:
    def __init__(__self__, *, access_point_alias: Optional[pulumi.Input[_builtins.str]] = ..., access_point_arn: Optional[pulumi.Input[_builtins.str]] = ..., asset_source: Optional[pulumi.Input[RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSourceArgs]] = ...) -> None:
    ...
    def access_point_alias(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @asset_source.setter
    def asset_source(self, value: Optional[pulumi.Input[RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSourceArgs]]): # -> None:
        ...
...
class RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSourceArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], key_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., keys: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., kms_keys_to_grants: Optional[pulumi.Input[Sequence[pulumi.Input[RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSourceKmsKeysToGrantArgs]]]] = ...) -> None:
    ...
    def kms_keys_to_grants(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSourceKmsKeysToGrantArgs]]]]): # -> None:
        ...
...
class RevisionAssetsAssetImportAssetsFromS3Args:
    def __init__(__self__, *, asset_source: Optional[pulumi.Input[RevisionAssetsAssetImportAssetsFromS3AssetSourceArgs]] = ...) -> None:
    ...
    @asset_source.setter
    def asset_source(self, value: Optional[pulumi.Input[RevisionAssetsAssetImportAssetsFromS3AssetSourceArgs]]): # -> None:
        ...
...
class RevisionAssetsAssetImportAssetsFromSignedUrlArgs:
    ...
    @filename.setter
    def filename(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
