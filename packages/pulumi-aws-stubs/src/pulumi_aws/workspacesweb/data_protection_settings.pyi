...
class DataProtectionSettingsArgs:
    def __init__(__self__, *, display_name: pulumi.Input[_builtins.str], additional_encryption_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., customer_managed_key: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., inline_redaction_configuration: Optional[pulumi.Input[DataProtectionSettingsInlineRedactionConfigurationArgs]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def inline_redaction_configuration(self, value: Optional[pulumi.Input[DataProtectionSettingsInlineRedactionConfigurationArgs]]): # -> None:
        ...
...
class _DataProtectionSettingsState:
    def __init__(__self__, *, additional_encryption_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., associated_portal_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., customer_managed_key: Optional[pulumi.Input[_builtins.str]] = ..., data_protection_settings_arn: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., inline_redaction_configuration: Optional[pulumi.Input[DataProtectionSettingsInlineRedactionConfigurationArgs]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class DataProtectionSettings(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., additional_encryption_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., associated_portal_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., customer_managed_key: Optional[pulumi.Input[_builtins.str]] = ..., data_protection_settings_arn: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., inline_redaction_configuration: Optional[pulumi.Input[Union[DataProtectionSettingsInlineRedactionConfigurationArgs, DataProtectionSettingsInlineRedactionConfigurationArgsDict]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> DataProtectionSettings:
