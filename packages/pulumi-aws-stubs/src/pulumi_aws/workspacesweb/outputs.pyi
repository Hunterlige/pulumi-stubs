...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DataProtectionSettingsInlineRedactionConfiguration', ..., ..., ..., 'IpAccessSettingsIpRule', 'PortalTimeouts', 'SessionLoggerEventFilter', 'SessionLoggerEventFilterAll', 'SessionLoggerLogConfiguration', 'SessionLoggerLogConfigurationS3', 'TrustStoreCertificate', 'UserSettingsCookieSynchronizationConfiguration', ..., ..., 'UserSettingsToolbarConfiguration']
@pulumi.output_type
class DataProtectionSettingsInlineRedactionConfiguration(dict):
    ...
    def __init__(__self__, *, inline_redaction_patterns: Sequence[outputs.DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPattern], global_confidence_level: Optional[_builtins.int] = ..., global_enforced_urls: Optional[Sequence[_builtins.str]] = ..., global_exempt_urls: Optional[Sequence[_builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="inlineRedactionPatterns")
    def inline_redaction_patterns(self) -> Sequence[outputs.DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPattern]:
...
class DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPattern(dict):
    ...
    def __init__(__self__, *, built_in_pattern_id: Optional[_builtins.str] = ..., confidence_level: Optional[_builtins.int] = ..., custom_pattern: Optional[outputs.DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternCustomPattern] = ..., enforced_urls: Optional[Sequence[_builtins.str]] = ..., exempt_urls: Optional[Sequence[_builtins.str]] = ..., redaction_place_holders: Optional[Sequence[outputs.DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternRedactionPlaceHolder]] = ...) -> None:
...
class DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternCustomPattern(dict):
    ...
    def __init__(__self__, *, pattern_name: _builtins.str, pattern_regex: _builtins.str, keyword_regex: Optional[_builtins.str] = ..., pattern_description: Optional[_builtins.str] = ...) -> None:
...
class DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternRedactionPlaceHolder(dict):
    ...
    def __init__(__self__, *, redaction_place_holder_type: _builtins.str, redaction_place_holder_text: Optional[_builtins.str] = ...) -> None:
...
class IpAccessSettingsIpRule(dict):
    ...
    def __init__(__self__, *, ip_range: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class SessionLoggerEventFilter(dict):
    def __init__(__self__, *, all: Optional[outputs.SessionLoggerEventFilterAll] = ..., includes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SessionLoggerLogConfiguration(dict):
    def __init__(__self__, *, s3: Optional[outputs.SessionLoggerLogConfigurationS3] = ...) -> None:
...
class SessionLoggerLogConfigurationS3(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, folder_structure: _builtins.str, log_file_format: _builtins.str, bucket_owner: Optional[_builtins.str] = ..., key_prefix: Optional[_builtins.str] = ...) -> None:
...
class TrustStoreCertificate(dict):
    ...
    def __init__(__self__, *, body: _builtins.str, issuer: Optional[_builtins.str] = ..., not_valid_after: Optional[_builtins.str] = ..., not_valid_before: Optional[_builtins.str] = ..., subject: Optional[_builtins.str] = ..., thumbprint: Optional[_builtins.str] = ...) -> None:
...
class UserSettingsCookieSynchronizationConfiguration(dict):
    def __init__(__self__, *, allowlists: Optional[Sequence[outputs.UserSettingsCookieSynchronizationConfigurationAllowlist]] = ..., blocklists: Optional[Sequence[outputs.UserSettingsCookieSynchronizationConfigurationBlocklist]] = ...) -> None:
...
class UserSettingsCookieSynchronizationConfigurationAllowlist(dict):
    def __init__(__self__, *, domain: _builtins.str, name: Optional[_builtins.str] = ..., path: Optional[_builtins.str] = ...) -> None:
...
class UserSettingsToolbarConfiguration(dict):
    ...
    def __init__(__self__, *, hidden_toolbar_items: Optional[Sequence[_builtins.str]] = ..., max_display_resolution: Optional[_builtins.str] = ..., toolbar_type: Optional[_builtins.str] = ..., visual_mode: Optional[_builtins.str] = ...) -> None:
