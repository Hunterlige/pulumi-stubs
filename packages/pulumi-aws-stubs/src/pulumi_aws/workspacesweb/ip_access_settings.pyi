...
class IpAccessSettingsArgs:
    ...
    def ip_rules(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input[IpAccessSettingsIpRuleArgs]]]: ...
    @ip_rules.setter
    def ip_rules(
        self, value: pulumi.Input[Sequence[pulumi.Input[IpAccessSettingsIpRuleArgs]]]
    ): ...
    @_builtins.property
...
class _IpAccessSettingsState:
    ...
    def ip_rules(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[IpAccessSettingsIpRuleArgs]]]]: ...
    @ip_rules.setter
    def ip_rules(
        self,
        value: Optional[
        ...
        ip_rules: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[
                            IpAccessSettingsIpRuleArgs, IpAccessSettingsIpRuleArgsDict
                        ]
                    ]
                ]
            ]
