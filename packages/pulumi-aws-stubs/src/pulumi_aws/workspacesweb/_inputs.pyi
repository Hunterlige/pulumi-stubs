...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = [..., ..., ..., ..., ..., ..., ..., ..., 'IpAccessSettingsIpRuleArgs', 'IpAccessSettingsIpRuleArgsDict', 'PortalTimeoutsArgs', 'PortalTimeoutsArgsDict', 'SessionLoggerEventFilterArgs', 'SessionLoggerEventFilterArgsDict', 'SessionLoggerEventFilterAllArgs', 'SessionLoggerEventFilterAllArgsDict', 'SessionLoggerLogConfigurationArgs', 'SessionLoggerLogConfigurationArgsDict', 'SessionLoggerLogConfigurationS3Args', 'SessionLoggerLogConfigurationS3ArgsDict', 'TrustStoreCertificateArgs', 'TrustStoreCertificateArgsDict', 'UserSettingsCookieSynchronizationConfigurationArgs', ..., ..., ..., ..., ..., 'UserSettingsToolbarConfigurationArgs', 'UserSettingsToolbarConfigurationArgsDict']
...
class DataProtectionSettingsInlineRedactionConfigurationArgs:
    def __init__(__self__, *, inline_redaction_patterns: pulumi.Input[Sequence[pulumi.Input[DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternArgs]]], global_confidence_level: Optional[pulumi.Input[_builtins.int]] = ..., global_enforced_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., global_exempt_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def inline_redaction_patterns(self, value: pulumi.Input[Sequence[pulumi.Input[DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternArgs]]]): # -> None:
        ...
    ...
    def global_confidence_level(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def global_enforced_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def global_exempt_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternArgs:
    def __init__(__self__, *, built_in_pattern_id: Optional[pulumi.Input[_builtins.str]] = ..., confidence_level: Optional[pulumi.Input[_builtins.int]] = ..., custom_pattern: Optional[pulumi.Input[DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternCustomPatternArgs]] = ..., enforced_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., exempt_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., redaction_place_holders: Optional[pulumi.Input[Sequence[pulumi.Input[DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternRedactionPlaceHolderArgs]]]] = ...) -> None:
    ...
    def built_in_pattern_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def confidence_level(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def custom_pattern(self, value: Optional[pulumi.Input[DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternCustomPatternArgs]]): # -> None:
        ...
    ...
    def enforced_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @exempt_urls.setter
    def exempt_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def redaction_place_holders(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternRedactionPlaceHolderArgs]]]]): # -> None:
        ...
...
class DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternCustomPatternArgs:
    def __init__(__self__, *, pattern_name: pulumi.Input[_builtins.str], pattern_regex: pulumi.Input[_builtins.str], keyword_regex: Optional[pulumi.Input[_builtins.str]] = ..., pattern_description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @pattern_name.setter
    def pattern_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def pattern_regex(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def keyword_regex(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def pattern_description(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternRedactionPlaceHolderArgs:
    def __init__(__self__, *, redaction_place_holder_type: pulumi.Input[_builtins.str], redaction_place_holder_text: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def redaction_place_holder_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def redaction_place_holder_text(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IpAccessSettingsIpRuleArgs:
    def __init__(__self__, *, ip_range: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SessionLoggerEventFilterArgs:
    def __init__(__self__, *, all: Optional[pulumi.Input[SessionLoggerEventFilterAllArgs]] = ..., includes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @all.setter
    def all(self, value: Optional[pulumi.Input[SessionLoggerEventFilterAllArgs]]): # -> None:
        ...
...
class SessionLoggerLogConfigurationArgs:
    def __init__(__self__, *, s3: Optional[pulumi.Input[SessionLoggerLogConfigurationS3Args]] = ...) -> None:
    ...
    @s3.setter
    def s3(self, value: Optional[pulumi.Input[SessionLoggerLogConfigurationS3Args]]): # -> None:
        ...
...
class SessionLoggerLogConfigurationS3Args:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], folder_structure: pulumi.Input[_builtins.str], log_file_format: pulumi.Input[_builtins.str], bucket_owner: Optional[pulumi.Input[_builtins.str]] = ..., key_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def folder_structure(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def log_file_format(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TrustStoreCertificateArgs:
    def __init__(__self__, *, body: pulumi.Input[_builtins.str], issuer: Optional[pulumi.Input[_builtins.str]] = ..., not_valid_after: Optional[pulumi.Input[_builtins.str]] = ..., not_valid_before: Optional[pulumi.Input[_builtins.str]] = ..., subject: Optional[pulumi.Input[_builtins.str]] = ..., thumbprint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def not_valid_after(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def not_valid_before(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class UserSettingsCookieSynchronizationConfigurationArgs:
    def __init__(__self__, *, allowlists: Optional[pulumi.Input[Sequence[pulumi.Input[UserSettingsCookieSynchronizationConfigurationAllowlistArgs]]]] = ..., blocklists: Optional[pulumi.Input[Sequence[pulumi.Input[UserSettingsCookieSynchronizationConfigurationBlocklistArgs]]]] = ...) -> None:
    ...
    @allowlists.setter
    def allowlists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[UserSettingsCookieSynchronizationConfigurationAllowlistArgs]]]]): # -> None:
        ...
    ...
    @blocklists.setter
    def blocklists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[UserSettingsCookieSynchronizationConfigurationBlocklistArgs]]]]): # -> None:
        ...
...
class UserSettingsCookieSynchronizationConfigurationAllowlistArgs:
    def __init__(__self__, *, domain: pulumi.Input[_builtins.str], name: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class UserSettingsToolbarConfigurationArgs:
    def __init__(__self__, *, hidden_toolbar_items: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., max_display_resolution: Optional[pulumi.Input[_builtins.str]] = ..., toolbar_type: Optional[pulumi.Input[_builtins.str]] = ..., visual_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def hidden_toolbar_items(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def max_display_resolution(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @toolbar_type.setter
    def toolbar_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @visual_mode.setter
    def visual_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
