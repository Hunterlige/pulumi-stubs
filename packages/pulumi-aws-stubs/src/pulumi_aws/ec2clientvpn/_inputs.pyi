...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EndpointAuthenticationOptionArgs', 'EndpointAuthenticationOptionArgsDict', 'EndpointClientConnectOptionsArgs', 'EndpointClientConnectOptionsArgsDict', 'EndpointClientLoginBannerOptionsArgs', 'EndpointClientLoginBannerOptionsArgsDict', 'EndpointClientRouteEnforcementOptionsArgs', 'EndpointClientRouteEnforcementOptionsArgsDict', 'EndpointConnectionLogOptionsArgs', 'EndpointConnectionLogOptionsArgsDict', 'GetEndpointFilterArgs', 'GetEndpointFilterArgsDict']
...
class EndpointAuthenticationOptionArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], active_directory_id: Optional[pulumi.Input[_builtins.str]] = ..., root_certificate_chain_arn: Optional[pulumi.Input[_builtins.str]] = ..., saml_provider_arn: Optional[pulumi.Input[_builtins.str]] = ..., self_service_saml_provider_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def root_certificate_chain_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def saml_provider_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def self_service_saml_provider_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EndpointClientConnectOptionsArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., lambda_function_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EndpointClientLoginBannerOptionsArgs:
    def __init__(__self__, *, banner_text: Optional[pulumi.Input[_builtins.str]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @banner_text.setter
    def banner_text(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EndpointClientRouteEnforcementOptionsArgs:
    def __init__(__self__, *, enforced: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @enforced.setter
    def enforced(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class EndpointConnectionLogOptionsArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], cloudwatch_log_group: Optional[pulumi.Input[_builtins.str]] = ..., cloudwatch_log_stream: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cloudwatch_log_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def cloudwatch_log_stream(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
