...
class GetEndpointResult:
    ...
    def __init__(__self__, arn=..., authentication_options=..., client_cidr_block=..., client_connect_options=..., client_login_banner_options=..., client_route_enforcement_options=..., client_vpn_endpoint_id=..., connection_log_options=..., description=..., dns_name=..., dns_servers=..., endpoint_ip_address_type=..., filters=..., id=..., region=..., security_group_ids=..., self_service_portal=..., self_service_portal_url=..., server_certificate_arn=..., session_timeout_hours=..., split_tunnel=..., tags=..., traffic_ip_address_type=..., transport_protocol=..., vpc_id=..., vpn_port=...) -> None:
        ...
...
def get_endpoint(client_vpn_endpoint_id: Optional[_builtins.str] = ..., filters: Optional[Sequence[Union[GetEndpointFilterArgs, GetEndpointFilterArgsDict]]] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetEndpointResult:
    
    ...

def get_endpoint_output(client_vpn_endpoint_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., filters: Optional[pulumi.Input[Optional[Sequence[Union[GetEndpointFilterArgs, GetEndpointFilterArgsDict]]]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetEndpointResult]:
