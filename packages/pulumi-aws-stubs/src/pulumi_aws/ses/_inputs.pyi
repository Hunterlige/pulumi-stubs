...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConfigurationSetDeliveryOptionsArgs', 'ConfigurationSetDeliveryOptionsArgsDict', 'ConfigurationSetTrackingOptionsArgs', 'ConfigurationSetTrackingOptionsArgsDict', 'EventDestinationCloudwatchDestinationArgs', 'EventDestinationCloudwatchDestinationArgsDict', 'EventDestinationKinesisDestinationArgs', 'EventDestinationKinesisDestinationArgsDict', 'EventDestinationSnsDestinationArgs', 'EventDestinationSnsDestinationArgsDict', 'ReceiptRuleAddHeaderActionArgs', 'ReceiptRuleAddHeaderActionArgsDict', 'ReceiptRuleBounceActionArgs', 'ReceiptRuleBounceActionArgsDict', 'ReceiptRuleLambdaActionArgs', 'ReceiptRuleLambdaActionArgsDict', 'ReceiptRuleS3ActionArgs', 'ReceiptRuleS3ActionArgsDict', 'ReceiptRuleSnsActionArgs', 'ReceiptRuleSnsActionArgsDict', 'ReceiptRuleStopActionArgs', 'ReceiptRuleStopActionArgsDict', 'ReceiptRuleWorkmailActionArgs', 'ReceiptRuleWorkmailActionArgsDict']
...
class ConfigurationSetDeliveryOptionsArgs:
    def __init__(__self__, *, tls_policy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ConfigurationSetTrackingOptionsArgs:
    def __init__(__self__, *, custom_redirect_domain: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def custom_redirect_domain(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventDestinationCloudwatchDestinationArgs:
    def __init__(__self__, *, default_value: pulumi.Input[_builtins.str], dimension_name: pulumi.Input[_builtins.str], value_source: pulumi.Input[_builtins.str]) -> None:
    ...
    @value_source.setter
    def value_source(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ReceiptRuleAddHeaderActionArgs:
    def __init__(__self__, *, header_name: pulumi.Input[_builtins.str], header_value: pulumi.Input[_builtins.str], position: pulumi.Input[_builtins.int]) -> None:
    ...
    @position.setter
    def position(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ReceiptRuleBounceActionArgs:
    def __init__(__self__, *, message: pulumi.Input[_builtins.str], position: pulumi.Input[_builtins.int], sender: pulumi.Input[_builtins.str], smtp_reply_code: pulumi.Input[_builtins.str], status_code: Optional[pulumi.Input[_builtins.str]] = ..., topic_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @sender.setter
    def sender(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def smtp_reply_code(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ReceiptRuleLambdaActionArgs:
    def __init__(__self__, *, function_arn: pulumi.Input[_builtins.str], position: pulumi.Input[_builtins.int], invocation_type: Optional[pulumi.Input[_builtins.str]] = ..., topic_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def invocation_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ReceiptRuleS3ActionArgs:
    def __init__(__self__, *, bucket_name: pulumi.Input[_builtins.str], position: pulumi.Input[_builtins.int], iam_role_arn: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_arn: Optional[pulumi.Input[_builtins.str]] = ..., object_key_prefix: Optional[pulumi.Input[_builtins.str]] = ..., topic_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ReceiptRuleSnsActionArgs:
    def __init__(__self__, *, position: pulumi.Input[_builtins.int], topic_arn: pulumi.Input[_builtins.str], encoding: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ReceiptRuleStopActionArgs:
    def __init__(__self__, *, position: pulumi.Input[_builtins.int], scope: pulumi.Input[_builtins.str], topic_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ReceiptRuleWorkmailActionArgs:
    def __init__(__self__, *, organization_arn: pulumi.Input[_builtins.str], position: pulumi.Input[_builtins.int], topic_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def organization_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
