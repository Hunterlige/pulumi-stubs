...
class AnalyzerArgs:
    def __init__(
        ...
        *,
        ...
        configuration: Optional[pulumi.Input[AnalyzerConfigurationArgs]] = ...,
    ...
    def configuration(
        self, value: Optional[pulumi.Input[AnalyzerConfigurationArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class Analyzer(pulumi.CustomResource):
    ...
    def __init__(
        ...
        configuration: Optional[
            pulumi.Input[
                Union[AnalyzerConfigurationArgs, AnalyzerConfigurationArgsDict]
            ]
        ] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
    ...
    def configuration(
        self,
    ) -> pulumi.Output[Optional[outputs.AnalyzerConfiguration]]: ...
    @_builtins.property
    @pulumi.getter
