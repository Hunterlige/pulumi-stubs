...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ListenerDefaultAction', 'ListenerDefaultActionAuthenticateCognito', 'ListenerDefaultActionAuthenticateOidc', 'ListenerDefaultActionFixedResponse', 'ListenerDefaultActionForward', 'ListenerDefaultActionForwardStickiness', 'ListenerDefaultActionForwardTargetGroup', 'ListenerDefaultActionJwtValidation', 'ListenerDefaultActionJwtValidationAdditionalClaim', 'ListenerDefaultActionRedirect', 'ListenerMutualAuthentication', 'ListenerRuleAction', 'ListenerRuleActionAuthenticateCognito', 'ListenerRuleActionAuthenticateOidc', 'ListenerRuleActionFixedResponse', 'ListenerRuleActionForward', 'ListenerRuleActionForwardStickiness', 'ListenerRuleActionForwardTargetGroup', 'ListenerRuleActionJwtValidation', 'ListenerRuleActionJwtValidationAdditionalClaim', 'ListenerRuleActionRedirect', 'ListenerRuleCondition', 'ListenerRuleConditionHostHeader', 'ListenerRuleConditionHttpHeader', 'ListenerRuleConditionHttpRequestMethod', 'ListenerRuleConditionPathPattern', 'ListenerRuleConditionQueryString', 'ListenerRuleConditionSourceIp', 'ListenerRuleTransform', 'ListenerRuleTransformHostHeaderRewriteConfig', ..., 'ListenerRuleTransformUrlRewriteConfig', 'ListenerRuleTransformUrlRewriteConfigRewrite', 'LoadBalancerAccessLogs', 'LoadBalancerConnectionLogs', 'LoadBalancerHealthCheckLogs', 'LoadBalancerIpamPools', 'LoadBalancerMinimumLoadBalancerCapacity', 'LoadBalancerSubnetMapping', 'TargetGroupHealthCheck', 'TargetGroupStickiness', 'TargetGroupTargetFailover', 'TargetGroupTargetGroupHealth', 'TargetGroupTargetGroupHealthDnsFailover', 'TargetGroupTargetGroupHealthUnhealthyStateRouting', 'TargetGroupTargetHealthState', 'GetListenerDefaultActionResult', 'GetListenerDefaultActionAuthenticateCognitoResult', 'GetListenerDefaultActionAuthenticateOidcResult', 'GetListenerDefaultActionFixedResponseResult', 'GetListenerDefaultActionForwardResult', 'GetListenerDefaultActionForwardStickinessResult', 'GetListenerDefaultActionForwardTargetGroupResult', 'GetListenerDefaultActionJwtValidationResult', ..., 'GetListenerDefaultActionRedirectResult', 'GetListenerMutualAuthenticationResult', 'GetListenerRuleActionResult', 'GetListenerRuleActionAuthenticateCognitoResult', 'GetListenerRuleActionAuthenticateOidcResult', 'GetListenerRuleActionFixedResponseResult', 'GetListenerRuleActionForwardResult', 'GetListenerRuleActionForwardStickinessResult', 'GetListenerRuleActionForwardTargetGroupResult', 'GetListenerRuleActionJwtValidationResult', ..., 'GetListenerRuleActionRedirectResult', 'GetListenerRuleConditionResult', 'GetListenerRuleConditionHostHeaderResult', 'GetListenerRuleConditionHttpHeaderResult', 'GetListenerRuleConditionHttpRequestMethodResult', 'GetListenerRuleConditionPathPatternResult', 'GetListenerRuleConditionQueryStringResult', 'GetListenerRuleConditionQueryStringValueResult', 'GetListenerRuleConditionSourceIpResult', 'GetListenerRuleTransformResult', ..., ..., 'GetListenerRuleTransformUrlRewriteConfigResult', ..., 'GetLoadBalancerAccessLogsResult', 'GetLoadBalancerConnectionLogResult', 'GetLoadBalancerHealthCheckLogResult', 'GetLoadBalancerIpamPoolResult', 'GetLoadBalancerSubnetMappingResult', 'GetTargetGroupHealthCheckResult', 'GetTargetGroupStickinessResult']
@pulumi.output_type
class ListenerDefaultAction(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, authenticate_cognito: Optional[outputs.ListenerDefaultActionAuthenticateCognito] = ..., authenticate_oidc: Optional[outputs.ListenerDefaultActionAuthenticateOidc] = ..., fixed_response: Optional[outputs.ListenerDefaultActionFixedResponse] = ..., forward: Optional[outputs.ListenerDefaultActionForward] = ..., jwt_validation: Optional[outputs.ListenerDefaultActionJwtValidation] = ..., order: Optional[_builtins.int] = ..., redirect: Optional[outputs.ListenerDefaultActionRedirect] = ..., target_group_arn: Optional[_builtins.str] = ...) -> None:
...
class ListenerDefaultActionAuthenticateCognito(dict):
    ...
    def __init__(__self__, *, user_pool_arn: _builtins.str, user_pool_client_id: _builtins.str, user_pool_domain: _builtins.str, authentication_request_extra_params: Optional[Mapping[str, _builtins.str]] = ..., on_unauthenticated_request: Optional[_builtins.str] = ..., scope: Optional[_builtins.str] = ..., session_cookie_name: Optional[_builtins.str] = ..., session_timeout: Optional[_builtins.int] = ...) -> None:
...
class ListenerDefaultActionAuthenticateOidc(dict):
    ...
    def __init__(__self__, *, authorization_endpoint: _builtins.str, client_id: _builtins.str, client_secret: _builtins.str, issuer: _builtins.str, token_endpoint: _builtins.str, user_info_endpoint: _builtins.str, authentication_request_extra_params: Optional[Mapping[str, _builtins.str]] = ..., on_unauthenticated_request: Optional[_builtins.str] = ..., scope: Optional[_builtins.str] = ..., session_cookie_name: Optional[_builtins.str] = ..., session_timeout: Optional[_builtins.int] = ...) -> None:
...
class ListenerDefaultActionFixedResponse(dict):
    ...
    def __init__(__self__, *, content_type: _builtins.str, message_body: Optional[_builtins.str] = ..., status_code: Optional[_builtins.str] = ...) -> None:
...
class ListenerDefaultActionForward(dict):
    ...
    def __init__(__self__, *, target_groups: Sequence[outputs.ListenerDefaultActionForwardTargetGroup], stickiness: Optional[outputs.ListenerDefaultActionForwardStickiness] = ...) -> None:
...
class ListenerDefaultActionForwardStickiness(dict):
    def __init__(__self__, *, duration: _builtins.int, enabled: Optional[_builtins.bool] = ...) -> None:
...
class ListenerDefaultActionForwardTargetGroup(dict):
    def __init__(__self__, *, arn: _builtins.str, weight: Optional[_builtins.int] = ...) -> None:
...
class ListenerDefaultActionJwtValidation(dict):
    ...
    def __init__(__self__, *, issuer: _builtins.str, jwks_endpoint: _builtins.str, additional_claims: Optional[Sequence[outputs.ListenerDefaultActionJwtValidationAdditionalClaim]] = ...) -> None:
...
class ListenerDefaultActionRedirect(dict):
    ...
    def __init__(__self__, *, status_code: _builtins.str, host: Optional[_builtins.str] = ..., path: Optional[_builtins.str] = ..., port: Optional[_builtins.str] = ..., protocol: Optional[_builtins.str] = ..., query: Optional[_builtins.str] = ...) -> None:
...
class ListenerMutualAuthentication(dict):
    ...
    def __init__(__self__, *, mode: _builtins.str, advertise_trust_store_ca_names: Optional[_builtins.str] = ..., ignore_client_certificate_expiry: Optional[_builtins.bool] = ..., trust_store_arn: Optional[_builtins.str] = ...) -> None:
...
class ListenerRuleAction(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, authenticate_cognito: Optional[outputs.ListenerRuleActionAuthenticateCognito] = ..., authenticate_oidc: Optional[outputs.ListenerRuleActionAuthenticateOidc] = ..., fixed_response: Optional[outputs.ListenerRuleActionFixedResponse] = ..., forward: Optional[outputs.ListenerRuleActionForward] = ..., jwt_validation: Optional[outputs.ListenerRuleActionJwtValidation] = ..., order: Optional[_builtins.int] = ..., redirect: Optional[outputs.ListenerRuleActionRedirect] = ..., target_group_arn: Optional[_builtins.str] = ...) -> None:
...
class ListenerRuleActionForward(dict):
    ...
    def __init__(__self__, *, target_groups: Sequence[outputs.ListenerRuleActionForwardTargetGroup], stickiness: Optional[outputs.ListenerRuleActionForwardStickiness] = ...) -> None:
...
class ListenerRuleActionJwtValidation(dict):
    ...
    def __init__(__self__, *, issuer: _builtins.str, jwks_endpoint: _builtins.str, additional_claims: Optional[Sequence[outputs.ListenerRuleActionJwtValidationAdditionalClaim]] = ...) -> None:
...
class ListenerRuleCondition(dict):
    ...
    def __init__(__self__, *, host_header: Optional[outputs.ListenerRuleConditionHostHeader] = ..., http_header: Optional[outputs.ListenerRuleConditionHttpHeader] = ..., http_request_method: Optional[outputs.ListenerRuleConditionHttpRequestMethod] = ..., path_pattern: Optional[outputs.ListenerRuleConditionPathPattern] = ..., query_strings: Optional[Sequence[outputs.ListenerRuleConditionQueryString]] = ..., source_ip: Optional[outputs.ListenerRuleConditionSourceIp] = ...) -> None:
...
class ListenerRuleConditionHostHeader(dict):
    ...
    def __init__(__self__, *, regex_values: Optional[Sequence[_builtins.str]] = ..., values: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ListenerRuleConditionHttpHeader(dict):
    ...
    def __init__(__self__, *, http_header_name: _builtins.str, regex_values: Optional[Sequence[_builtins.str]] = ..., values: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ListenerRuleConditionQueryString(dict):
    def __init__(__self__, *, value: _builtins.str, key: Optional[_builtins.str] = ...) -> None:
...
class ListenerRuleTransform(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, host_header_rewrite_config: Optional[outputs.ListenerRuleTransformHostHeaderRewriteConfig] = ..., url_rewrite_config: Optional[outputs.ListenerRuleTransformUrlRewriteConfig] = ...) -> None:
...
class ListenerRuleTransformHostHeaderRewriteConfig(dict):
    def __init__(__self__, *, rewrite: Optional[outputs.ListenerRuleTransformHostHeaderRewriteConfigRewrite] = ...) -> None:
...
class ListenerRuleTransformUrlRewriteConfig(dict):
    def __init__(__self__, *, rewrite: Optional[outputs.ListenerRuleTransformUrlRewriteConfigRewrite] = ...) -> None:
...
class LoadBalancerAccessLogs(dict):
    def __init__(__self__, *, bucket: _builtins.str, enabled: Optional[_builtins.bool] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class LoadBalancerSubnetMapping(dict):
    ...
    def __init__(__self__, *, subnet_id: _builtins.str, allocation_id: Optional[_builtins.str] = ..., ipv6_address: Optional[_builtins.str] = ..., outpost_id: Optional[_builtins.str] = ..., private_ipv4_address: Optional[_builtins.str] = ...) -> None:
...
class TargetGroupHealthCheck(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., healthy_threshold: Optional[_builtins.int] = ..., interval: Optional[_builtins.int] = ..., matcher: Optional[_builtins.str] = ..., path: Optional[_builtins.str] = ..., port: Optional[_builtins.str] = ..., protocol: Optional[_builtins.str] = ..., timeout: Optional[_builtins.int] = ..., unhealthy_threshold: Optional[_builtins.int] = ...) -> None:
...
class TargetGroupStickiness(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, cookie_duration: Optional[_builtins.int] = ..., cookie_name: Optional[_builtins.str] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class TargetGroupTargetFailover(dict):
    ...
    def __init__(__self__, *, on_deregistration: _builtins.str, on_unhealthy: _builtins.str) -> None:
...
class TargetGroupTargetGroupHealth(dict):
    ...
    def __init__(__self__, *, dns_failover: Optional[outputs.TargetGroupTargetGroupHealthDnsFailover] = ..., unhealthy_state_routing: Optional[outputs.TargetGroupTargetGroupHealthUnhealthyStateRouting] = ...) -> None:
...
class TargetGroupTargetGroupHealthDnsFailover(dict):
    ...
    def __init__(__self__, *, minimum_healthy_targets_count: Optional[_builtins.str] = ..., minimum_healthy_targets_percentage: Optional[_builtins.str] = ...) -> None:
...
class TargetGroupTargetGroupHealthUnhealthyStateRouting(dict):
    ...
    def __init__(__self__, *, minimum_healthy_targets_count: Optional[_builtins.int] = ..., minimum_healthy_targets_percentage: Optional[_builtins.str] = ...) -> None:
...
class TargetGroupTargetHealthState(dict):
    ...
    def __init__(__self__, *, enable_unhealthy_connection_termination: _builtins.bool, unhealthy_draining_interval: Optional[_builtins.int] = ...) -> None:
...
class GetListenerDefaultActionResult(dict):
    def __init__(__self__, *, authenticate_cognitos: Sequence[outputs.GetListenerDefaultActionAuthenticateCognitoResult], authenticate_oidcs: Sequence[outputs.GetListenerDefaultActionAuthenticateOidcResult], fixed_responses: Sequence[outputs.GetListenerDefaultActionFixedResponseResult], forwards: Sequence[outputs.GetListenerDefaultActionForwardResult], jwt_validations: Sequence[outputs.GetListenerDefaultActionJwtValidationResult], order: _builtins.int, redirects: Sequence[outputs.GetListenerDefaultActionRedirectResult], target_group_arn: _builtins.str, type: _builtins.str) -> None:
        ...
...
class GetListenerDefaultActionForwardResult(dict):
    def __init__(__self__, *, stickinesses: Sequence[outputs.GetListenerDefaultActionForwardStickinessResult], target_groups: Sequence[outputs.GetListenerDefaultActionForwardTargetGroupResult]) -> None:
        ...
...
class GetListenerDefaultActionJwtValidationResult(dict):
    def __init__(__self__, *, additional_claims: Sequence[outputs.GetListenerDefaultActionJwtValidationAdditionalClaimResult], issuer: _builtins.str, jwks_endpoint: _builtins.str) -> None:
        ...
...
class GetListenerMutualAuthenticationResult(dict):
    def __init__(__self__, *, advertise_trust_store_ca_names: _builtins.str, ignore_client_certificate_expiry: _builtins.bool, mode: _builtins.str, trust_store_arn: _builtins.str) -> None:
        ...
...
class GetListenerRuleActionResult(dict):
    def __init__(__self__, *, order: _builtins.int, type: _builtins.str, authenticate_cognitos: Optional[Sequence[outputs.GetListenerRuleActionAuthenticateCognitoResult]] = ..., authenticate_oidcs: Optional[Sequence[outputs.GetListenerRuleActionAuthenticateOidcResult]] = ..., fixed_responses: Optional[Sequence[outputs.GetListenerRuleActionFixedResponseResult]] = ..., forwards: Optional[Sequence[outputs.GetListenerRuleActionForwardResult]] = ..., jwt_validations: Optional[Sequence[outputs.GetListenerRuleActionJwtValidationResult]] = ..., redirects: Optional[Sequence[outputs.GetListenerRuleActionRedirectResult]] = ...) -> None:
...
class GetListenerRuleActionForwardResult(dict):
    def __init__(__self__, *, stickinesses: Optional[Sequence[outputs.GetListenerRuleActionForwardStickinessResult]] = ..., target_groups: Optional[Sequence[outputs.GetListenerRuleActionForwardTargetGroupResult]] = ...) -> None:
...
class GetListenerRuleActionJwtValidationResult(dict):
    def __init__(__self__, *, issuer: _builtins.str, jwks_endpoint: _builtins.str, additional_claims: Optional[Sequence[outputs.GetListenerRuleActionJwtValidationAdditionalClaimResult]] = ...) -> None:
...
class GetListenerRuleConditionResult(dict):
    def __init__(__self__, *, host_headers: Optional[Sequence[outputs.GetListenerRuleConditionHostHeaderResult]] = ..., http_headers: Optional[Sequence[outputs.GetListenerRuleConditionHttpHeaderResult]] = ..., http_request_methods: Optional[Sequence[outputs.GetListenerRuleConditionHttpRequestMethodResult]] = ..., path_patterns: Optional[Sequence[outputs.GetListenerRuleConditionPathPatternResult]] = ..., query_strings: Optional[Sequence[outputs.GetListenerRuleConditionQueryStringResult]] = ..., source_ips: Optional[Sequence[outputs.GetListenerRuleConditionSourceIpResult]] = ...) -> None:
...
class GetListenerRuleConditionQueryStringResult(dict):
    def __init__(__self__, *, values: Optional[Sequence[outputs.GetListenerRuleConditionQueryStringValueResult]] = ...) -> None:
...
class GetListenerRuleTransformResult(dict):
    def __init__(__self__, *, type: _builtins.str, host_header_rewrite_configs: Optional[Sequence[outputs.GetListenerRuleTransformHostHeaderRewriteConfigResult]] = ..., url_rewrite_configs: Optional[Sequence[outputs.GetListenerRuleTransformUrlRewriteConfigResult]] = ...) -> None:
...
class GetListenerRuleTransformHostHeaderRewriteConfigResult(dict):
    def __init__(__self__, *, rewrites: Optional[Sequence[outputs.GetListenerRuleTransformHostHeaderRewriteConfigRewriteResult]] = ...) -> None:
...
class GetListenerRuleTransformUrlRewriteConfigResult(dict):
    def __init__(__self__, *, rewrites: Optional[Sequence[outputs.GetListenerRuleTransformUrlRewriteConfigRewriteResult]] = ...) -> None:
...
class GetLoadBalancerAccessLogsResult(dict):
    def __init__(__self__, *, bucket: _builtins.str, enabled: _builtins.bool, prefix: _builtins.str) -> None:
        ...
...
class GetLoadBalancerSubnetMappingResult(dict):
    def __init__(__self__, *, allocation_id: _builtins.str, ipv6_address: _builtins.str, outpost_id: _builtins.str, private_ipv4_address: _builtins.str, subnet_id: _builtins.str) -> None:
        ...
...
class GetTargetGroupHealthCheckResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, healthy_threshold: _builtins.int, interval: _builtins.int, matcher: _builtins.str, path: _builtins.str, port: _builtins.str, protocol: _builtins.str, timeout: _builtins.int, unhealthy_threshold: _builtins.int) -> None:
        ...
...
class GetTargetGroupStickinessResult(dict):
    def __init__(__self__, *, cookie_duration: _builtins.int, cookie_name: _builtins.str, enabled: _builtins.bool, type: _builtins.str) -> None:
        ...
