...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GraphTimeoutsArgs', 'GraphTimeoutsArgsDict', 'GraphVectorSearchConfigurationArgs', 'GraphVectorSearchConfigurationArgsDict']
...
class GraphVectorSearchConfigurationArgs:
    def __init__(__self__, *, vector_search_dimension: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def vector_search_dimension(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
