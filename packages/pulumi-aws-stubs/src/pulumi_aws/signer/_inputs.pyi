...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['SigningJobDestinationArgs', 'SigningJobDestinationArgsDict', 'SigningJobDestinationS3Args', 'SigningJobDestinationS3ArgsDict', 'SigningJobRevocationRecordArgs', 'SigningJobRevocationRecordArgsDict', 'SigningJobSignedObjectArgs', 'SigningJobSignedObjectArgsDict', 'SigningJobSignedObjectS3Args', 'SigningJobSignedObjectS3ArgsDict', 'SigningJobSourceArgs', 'SigningJobSourceArgsDict', 'SigningJobSourceS3Args', 'SigningJobSourceS3ArgsDict', 'SigningProfileRevocationRecordArgs', 'SigningProfileRevocationRecordArgsDict', 'SigningProfileSignatureValidityPeriodArgs', 'SigningProfileSignatureValidityPeriodArgsDict', 'SigningProfileSigningMaterialArgs', 'SigningProfileSigningMaterialArgsDict']
...
class SigningJobDestinationArgs:
    def __init__(__self__, *, s3: pulumi.Input[SigningJobDestinationS3Args]) -> None:
    ...
    @s3.setter
    def s3(self, value: pulumi.Input[SigningJobDestinationS3Args]): # -> None:
        ...
...
class SigningJobDestinationS3Args:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SigningJobRevocationRecordArgs:
    def __init__(__self__, *, reason: Optional[pulumi.Input[_builtins.str]] = ..., revoked_at: Optional[pulumi.Input[_builtins.str]] = ..., revoked_by: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    @revoked_at.setter
    def revoked_at(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @revoked_by.setter
    def revoked_by(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SigningJobSignedObjectArgs:
    ...
    @s3s.setter
    def s3s(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[SigningJobSignedObjectS3Args]]]]): # -> None:
        ...
...
class SigningJobSourceArgs:
    ...
    @s3.setter
    def s3(self, value: pulumi.Input[SigningJobSourceS3Args]): # -> None:
        ...
...
class SigningJobSourceS3Args:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], key: pulumi.Input[_builtins.str], version: pulumi.Input[_builtins.str]) -> None:
...
class SigningProfileRevocationRecordArgs:
    def __init__(__self__, *, revocation_effective_from: Optional[pulumi.Input[_builtins.str]] = ..., revoked_at: Optional[pulumi.Input[_builtins.str]] = ..., revoked_by: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def revocation_effective_from(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
