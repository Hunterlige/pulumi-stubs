...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['SigningJobDestination', 'SigningJobDestinationS3', 'SigningJobRevocationRecord', 'SigningJobSignedObject', 'SigningJobSignedObjectS3', 'SigningJobSource', 'SigningJobSourceS3', 'SigningProfileRevocationRecord', 'SigningProfileSignatureValidityPeriod', 'SigningProfileSigningMaterial', 'GetSigningJobRevocationRecordResult', 'GetSigningJobSignedObjectResult', 'GetSigningJobSignedObjectS3Result', 'GetSigningJobSourceResult', 'GetSigningJobSourceS3Result', 'GetSigningProfileRevocationRecordResult', 'GetSigningProfileSignatureValidityPeriodResult', 'GetSigningProfileSigningMaterialResult']
@pulumi.output_type
...
class SigningJobDestinationS3(dict):
    def __init__(__self__, *, bucket: _builtins.str, prefix: Optional[_builtins.str] = ...) -> None:
...
class SigningJobRevocationRecord(dict):
    ...
    def __init__(__self__, *, reason: Optional[_builtins.str] = ..., revoked_at: Optional[_builtins.str] = ..., revoked_by: Optional[_builtins.str] = ...) -> None:
        ...
...
class SigningJobSignedObject(dict):
    def __init__(__self__, *, s3s: Optional[Sequence[outputs.SigningJobSignedObjectS3]] = ...) -> None:
        ...
...
class SigningJobSourceS3(dict):
    def __init__(__self__, *, bucket: _builtins.str, key: _builtins.str, version: _builtins.str) -> None:
...
class SigningProfileRevocationRecord(dict):
    ...
    def __init__(__self__, *, revocation_effective_from: Optional[_builtins.str] = ..., revoked_at: Optional[_builtins.str] = ..., revoked_by: Optional[_builtins.str] = ...) -> None:
...
class GetSigningJobRevocationRecordResult(dict):
    def __init__(__self__, *, reason: _builtins.str, revoked_at: _builtins.str, revoked_by: _builtins.str) -> None:
        ...
...
class GetSigningJobSignedObjectResult(dict):
    def __init__(__self__, *, s3s: Sequence[outputs.GetSigningJobSignedObjectS3Result]) -> None:
        ...
...
class GetSigningJobSourceResult(dict):
    def __init__(__self__, *, s3s: Sequence[outputs.GetSigningJobSourceS3Result]) -> None:
        ...
...
class GetSigningProfileRevocationRecordResult(dict):
    def __init__(__self__, *, revocation_effective_from: _builtins.str, revoked_at: _builtins.str, revoked_by: _builtins.str) -> None:
        ...
