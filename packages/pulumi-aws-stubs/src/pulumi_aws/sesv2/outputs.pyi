...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccountVdmAttributesDashboardAttributes', 'AccountVdmAttributesGuardianAttributes', 'ConfigurationSetDeliveryOptions', 'ConfigurationSetEventDestinationEventDestination', ..., ..., ..., ..., ..., ..., 'ConfigurationSetReputationOptions', 'ConfigurationSetSendingOptions', 'ConfigurationSetSuppressionOptions', 'ConfigurationSetTrackingOptions', 'ConfigurationSetVdmOptions', 'ConfigurationSetVdmOptionsDashboardOptions', 'ConfigurationSetVdmOptionsGuardianOptions', 'ContactListTopic', 'EmailIdentityDkimSigningAttributes', 'GetConfigurationSetDeliveryOptionResult', 'GetConfigurationSetReputationOptionResult', 'GetConfigurationSetSendingOptionResult', 'GetConfigurationSetSuppressionOptionResult', 'GetConfigurationSetTrackingOptionResult', 'GetConfigurationSetVdmOptionResult', 'GetConfigurationSetVdmOptionDashboardOptionResult', 'GetConfigurationSetVdmOptionGuardianOptionResult', 'GetDedicatedIpPoolDedicatedIpResult', 'GetEmailIdentityDkimSigningAttributeResult']
@pulumi.output_type
class AccountVdmAttributesDashboardAttributes(dict):
    ...
    def __init__(__self__, *, engagement_metrics: Optional[_builtins.str] = ...) -> None:
...
class AccountVdmAttributesGuardianAttributes(dict):
    ...
    def __init__(__self__, *, optimized_shared_delivery: Optional[_builtins.str] = ...) -> None:
...
class ConfigurationSetDeliveryOptions(dict):
    ...
    def __init__(__self__, *, max_delivery_seconds: Optional[_builtins.int] = ..., sending_pool_name: Optional[_builtins.str] = ..., tls_policy: Optional[_builtins.str] = ...) -> None:
...
class ConfigurationSetEventDestinationEventDestination(dict):
    ...
    def __init__(__self__, *, matching_event_types: Sequence[_builtins.str], cloud_watch_destination: Optional[outputs.ConfigurationSetEventDestinationEventDestinationCloudWatchDestination] = ..., enabled: Optional[_builtins.bool] = ..., event_bridge_destination: Optional[outputs.ConfigurationSetEventDestinationEventDestinationEventBridgeDestination] = ..., kinesis_firehose_destination: Optional[outputs.ConfigurationSetEventDestinationEventDestinationKinesisFirehoseDestination] = ..., pinpoint_destination: Optional[outputs.ConfigurationSetEventDestinationEventDestinationPinpointDestination] = ..., sns_destination: Optional[outputs.ConfigurationSetEventDestinationEventDestinationSnsDestination] = ...) -> None:
...
class ConfigurationSetEventDestinationEventDestinationCloudWatchDestination(dict):
    ...
    def __init__(__self__, *, dimension_configurations: Sequence[outputs.ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationDimensionConfiguration]) -> None:
...
class ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationDimensionConfiguration(dict):
    ...
    def __init__(__self__, *, default_dimension_value: _builtins.str, dimension_name: _builtins.str, dimension_value_source: _builtins.str) -> None:
...
class ConfigurationSetEventDestinationEventDestinationKinesisFirehoseDestination(dict):
    ...
    def __init__(__self__, *, delivery_stream_arn: _builtins.str, iam_role_arn: _builtins.str) -> None:
...
class ConfigurationSetReputationOptions(dict):
    ...
    def __init__(__self__, *, last_fresh_start: Optional[_builtins.str] = ..., reputation_metrics_enabled: Optional[_builtins.bool] = ...) -> None:
...
class ConfigurationSetSendingOptions(dict):
    ...
    def __init__(__self__, *, sending_enabled: Optional[_builtins.bool] = ...) -> None:
...
class ConfigurationSetSuppressionOptions(dict):
    ...
    def __init__(__self__, *, suppressed_reasons: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ConfigurationSetTrackingOptions(dict):
    ...
    def __init__(__self__, *, custom_redirect_domain: _builtins.str, https_policy: Optional[_builtins.str] = ...) -> None:
...
class ConfigurationSetVdmOptions(dict):
    ...
    def __init__(__self__, *, dashboard_options: Optional[outputs.ConfigurationSetVdmOptionsDashboardOptions] = ..., guardian_options: Optional[outputs.ConfigurationSetVdmOptionsGuardianOptions] = ...) -> None:
...
class ContactListTopic(dict):
    ...
    def __init__(__self__, *, default_subscription_status: _builtins.str, display_name: _builtins.str, topic_name: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class EmailIdentityDkimSigningAttributes(dict):
    ...
    def __init__(__self__, *, current_signing_key_length: Optional[_builtins.str] = ..., domain_signing_private_key: Optional[_builtins.str] = ..., domain_signing_selector: Optional[_builtins.str] = ..., last_key_generation_timestamp: Optional[_builtins.str] = ..., next_signing_key_length: Optional[_builtins.str] = ..., signing_attributes_origin: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., tokens: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GetConfigurationSetDeliveryOptionResult(dict):
    def __init__(__self__, *, max_delivery_seconds: _builtins.int, sending_pool_name: _builtins.str, tls_policy: _builtins.str) -> None:
...
class GetConfigurationSetReputationOptionResult(dict):
    def __init__(__self__, *, last_fresh_start: _builtins.str, reputation_metrics_enabled: _builtins.bool) -> None:
...
class GetConfigurationSetTrackingOptionResult(dict):
    def __init__(__self__, *, custom_redirect_domain: _builtins.str, https_policy: _builtins.str) -> None:
...
class GetConfigurationSetVdmOptionResult(dict):
    def __init__(__self__, *, dashboard_options: Sequence[outputs.GetConfigurationSetVdmOptionDashboardOptionResult], guardian_options: Sequence[outputs.GetConfigurationSetVdmOptionGuardianOptionResult]) -> None:
...
class GetDedicatedIpPoolDedicatedIpResult(dict):
    def __init__(__self__, *, ip: _builtins.str, warmup_percentage: _builtins.int, warmup_status: _builtins.str) -> None:
...
class GetEmailIdentityDkimSigningAttributeResult(dict):
    def __init__(__self__, *, current_signing_key_length: _builtins.str, domain_signing_private_key: _builtins.str, domain_signing_selector: _builtins.str, last_key_generation_timestamp: _builtins.str, next_signing_key_length: _builtins.str, signing_attributes_origin: _builtins.str, status: _builtins.str, tokens: Sequence[_builtins.str]) -> None:
