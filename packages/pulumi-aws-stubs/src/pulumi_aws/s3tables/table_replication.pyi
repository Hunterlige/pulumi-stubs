...
class TableReplicationArgs:
    def __init__(__self__, *, role: pulumi.Input[_builtins.str], table_arn: pulumi.Input[_builtins.str], region: Optional[pulumi.Input[_builtins.str]] = ..., rule: Optional[pulumi.Input[TableReplicationRuleArgs]] = ...) -> None:
    ...
    @rule.setter
    def rule(self, value: Optional[pulumi.Input[TableReplicationRuleArgs]]): # -> None:
        ...
...
class _TableReplicationState:
    def __init__(__self__, *, region: Optional[pulumi.Input[_builtins.str]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ..., rule: Optional[pulumi.Input[TableReplicationRuleArgs]] = ..., table_arn: Optional[pulumi.Input[_builtins.str]] = ..., version_token: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TableReplication(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ..., rule: Optional[pulumi.Input[Union[TableReplicationRuleArgs, TableReplicationRuleArgsDict]]] = ..., table_arn: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: TableReplicationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
