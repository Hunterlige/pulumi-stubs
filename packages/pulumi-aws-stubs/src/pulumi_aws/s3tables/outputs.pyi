...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['TableBucketEncryptionConfiguration', 'TableBucketMaintenanceConfiguration', ..., ..., 'TableBucketReplicationRule', 'TableBucketReplicationRuleDestination', 'TableEncryptionConfiguration', 'TableMaintenanceConfiguration', 'TableMaintenanceConfigurationIcebergCompaction', ..., ..., ..., 'TableMetadata', 'TableMetadataIceberg', 'TableMetadataIcebergSchema', 'TableMetadataIcebergSchemaField', 'TableReplicationRule', 'TableReplicationRuleDestination']
@pulumi.output_type
class TableBucketEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *, kms_key_arn: _builtins.str, sse_algorithm: _builtins.str) -> None:
...
class TableBucketMaintenanceConfiguration(dict):
    ...
    def __init__(__self__, *, iceberg_unreferenced_file_removal: outputs.TableBucketMaintenanceConfigurationIcebergUnreferencedFileRemoval) -> None:
...
class TableBucketMaintenanceConfigurationIcebergUnreferencedFileRemoval(dict):
    def __init__(__self__, *, settings: outputs.TableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalSettings, status: _builtins.str) -> None:
...
class TableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalSettings(dict):
    ...
    def __init__(__self__, *, non_current_days: _builtins.int, unreferenced_days: _builtins.int) -> None:
...
class TableBucketReplicationRule(dict):
    def __init__(__self__, *, destinations: Sequence[outputs.TableBucketReplicationRuleDestination]) -> None:
...
class TableMaintenanceConfiguration(dict):
    ...
    def __init__(__self__, *, iceberg_compaction: outputs.TableMaintenanceConfigurationIcebergCompaction, iceberg_snapshot_management: outputs.TableMaintenanceConfigurationIcebergSnapshotManagement) -> None:
...
class TableMaintenanceConfigurationIcebergCompaction(dict):
    def __init__(__self__, *, settings: outputs.TableMaintenanceConfigurationIcebergCompactionSettings, status: _builtins.str) -> None:
...
class TableMaintenanceConfigurationIcebergSnapshotManagement(dict):
    def __init__(__self__, *, settings: outputs.TableMaintenanceConfigurationIcebergSnapshotManagementSettings, status: _builtins.str) -> None:
...
class TableMaintenanceConfigurationIcebergSnapshotManagementSettings(dict):
    ...
    def __init__(__self__, *, max_snapshot_age_hours: _builtins.int, min_snapshots_to_keep: _builtins.int) -> None:
...
class TableMetadataIcebergSchema(dict):
    def __init__(__self__, *, fields: Sequence[outputs.TableMetadataIcebergSchemaField]) -> None:
...
class TableMetadataIcebergSchemaField(dict):
    def __init__(__self__, *, name: _builtins.str, type: _builtins.str, required: Optional[_builtins.bool] = ...) -> None:
...
class TableReplicationRule(dict):
    def __init__(__self__, *, destinations: Sequence[outputs.TableReplicationRuleDestination]) -> None:
