...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetDataLakeSettingsResult', 'AwaitableGetDataLakeSettingsResult', 'get_data_lake_settings', 'get_data_lake_settings_output']
@pulumi.output_type
class GetDataLakeSettingsResult:
    
    def __init__(__self__, admins=..., allow_external_data_filtering=..., allow_full_table_external_data_access=..., authorized_session_tag_value_lists=..., catalog_id=..., create_database_default_permissions=..., create_table_default_permissions=..., external_data_filtering_allow_lists=..., id=..., parameters=..., read_only_admins=..., region=..., trusted_resource_owners=...) -> None:
        ...
...
class AwaitableGetDataLakeSettingsResult(GetDataLakeSettingsResult):
    def __await__(self): # -> Generator[Never, Any, GetDataLakeSettingsResult]:
        ...
    


def get_data_lake_settings(catalog_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDataLakeSettingsResult:
    
    ...

def get_data_lake_settings_output(catalog_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDataLakeSettingsResult]:
