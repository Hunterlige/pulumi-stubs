...
class ResourceLfTagArgs:
    def __init__(__self__, *, lf_tag: pulumi.Input[ResourceLfTagLfTagArgs], catalog_id: Optional[pulumi.Input[_builtins.str]] = ..., database: Optional[pulumi.Input[ResourceLfTagDatabaseArgs]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., table: Optional[pulumi.Input[ResourceLfTagTableArgs]] = ..., table_with_columns: Optional[pulumi.Input[ResourceLfTagTableWithColumnsArgs]] = ..., timeouts: Optional[pulumi.Input[ResourceLfTagTimeoutsArgs]] = ...) -> None:
    ...
    @lf_tag.setter
    def lf_tag(self, value: pulumi.Input[ResourceLfTagLfTagArgs]): # -> None:
        ...
    ...
    @database.setter
    def database(self, value: Optional[pulumi.Input[ResourceLfTagDatabaseArgs]]): # -> None:
        ...
    ...
    @table.setter
    def table(self, value: Optional[pulumi.Input[ResourceLfTagTableArgs]]): # -> None:
        ...
    ...
    def table_with_columns(self, value: Optional[pulumi.Input[ResourceLfTagTableWithColumnsArgs]]): # -> None:
        ...
    ...
    @timeouts.setter
    def timeouts(self, value: Optional[pulumi.Input[ResourceLfTagTimeoutsArgs]]): # -> None:
        ...
...
class _ResourceLfTagState:
    def __init__(__self__, *, catalog_id: Optional[pulumi.Input[_builtins.str]] = ..., database: Optional[pulumi.Input[ResourceLfTagDatabaseArgs]] = ..., lf_tag: Optional[pulumi.Input[ResourceLfTagLfTagArgs]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., table: Optional[pulumi.Input[ResourceLfTagTableArgs]] = ..., table_with_columns: Optional[pulumi.Input[ResourceLfTagTableWithColumnsArgs]] = ..., timeouts: Optional[pulumi.Input[ResourceLfTagTimeoutsArgs]] = ...) -> None:
    ...
    @lf_tag.setter
    def lf_tag(self, value: Optional[pulumi.Input[ResourceLfTagLfTagArgs]]): # -> None:
        ...
...
class ResourceLfTag(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., catalog_id: Optional[pulumi.Input[_builtins.str]] = ..., database: Optional[pulumi.Input[Union[ResourceLfTagDatabaseArgs, ResourceLfTagDatabaseArgsDict]]] = ..., lf_tag: Optional[pulumi.Input[Union[ResourceLfTagLfTagArgs, ResourceLfTagLfTagArgsDict]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., table: Optional[pulumi.Input[Union[ResourceLfTagTableArgs, ResourceLfTagTableArgsDict]]] = ..., table_with_columns: Optional[pulumi.Input[Union[ResourceLfTagTableWithColumnsArgs, ResourceLfTagTableWithColumnsArgsDict]]] = ..., timeouts: Optional[pulumi.Input[Union[ResourceLfTagTimeoutsArgs, ResourceLfTagTimeoutsArgsDict]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ResourceLfTagArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
