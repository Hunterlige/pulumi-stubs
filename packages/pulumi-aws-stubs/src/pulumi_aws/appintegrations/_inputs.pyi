...
class DataIntegrationScheduleConfigArgs:
    def __init__(__self__, *, first_execution_from: pulumi.Input[_builtins.str], object: pulumi.Input[_builtins.str], schedule_expression: pulumi.Input[_builtins.str]) -> None:
    ...
    def first_execution_from(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
