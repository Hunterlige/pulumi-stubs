...
class DataIntegrationArgs:
    ...
    def schedule_config(
        self, value: pulumi.Input[DataIntegrationScheduleConfigArgs]
    ): ...
    @_builtins.property
...
class _DataIntegrationState:
    ...
    def schedule_config(
        self,
    ) -> Optional[pulumi.Input[DataIntegrationScheduleConfigArgs]]: ...
    @schedule_config.setter
    def schedule_config(
        self, value: Optional[pulumi.Input[DataIntegrationScheduleConfigArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter(name="sourceUri")
...
class DataIntegration(pulumi.CustomResource):
    ...
    def schedule_config(
        self,
    ) -> pulumi.Output[outputs.DataIntegrationScheduleConfig]: ...
    @_builtins.property
    @pulumi.getter(name="sourceUri")
