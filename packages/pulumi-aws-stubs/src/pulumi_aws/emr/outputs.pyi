...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = [..., 'ClusterAutoTerminationPolicy', 'ClusterBootstrapAction', 'ClusterCoreInstanceFleet', 'ClusterCoreInstanceFleetInstanceTypeConfig', ..., ..., 'ClusterCoreInstanceFleetLaunchSpecifications', ..., ..., 'ClusterCoreInstanceGroup', 'ClusterCoreInstanceGroupEbsConfig', 'ClusterEc2Attributes', 'ClusterKerberosAttributes', 'ClusterMasterInstanceFleet', 'ClusterMasterInstanceFleetInstanceTypeConfig', ..., ..., 'ClusterMasterInstanceFleetLaunchSpecifications', ..., ..., 'ClusterMasterInstanceGroup', 'ClusterMasterInstanceGroupEbsConfig', 'ClusterPlacementGroupConfig', 'ClusterStep', 'ClusterStepHadoopJarStep', 'InstanceFleetInstanceTypeConfig', 'InstanceFleetInstanceTypeConfigConfiguration', 'InstanceFleetInstanceTypeConfigEbsConfig', 'InstanceFleetLaunchSpecifications', ..., 'InstanceFleetLaunchSpecificationsSpotSpecification', 'InstanceGroupEbsConfig', 'ManagedScalingPolicyComputeLimit', 'GetReleaseLabelsFiltersResult', ...]
@pulumi.output_type
class BlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRange(dict):
    ...
    def __init__(__self__, *, max_range: _builtins.int, min_range: _builtins.int) -> None:
...
class ClusterBootstrapAction(dict):
    def __init__(__self__, *, name: _builtins.str, path: _builtins.str, args: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ClusterCoreInstanceFleet(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., instance_type_configs: Optional[Sequence[outputs.ClusterCoreInstanceFleetInstanceTypeConfig]] = ..., launch_specifications: Optional[outputs.ClusterCoreInstanceFleetLaunchSpecifications] = ..., name: Optional[_builtins.str] = ..., provisioned_on_demand_capacity: Optional[_builtins.int] = ..., provisioned_spot_capacity: Optional[_builtins.int] = ..., target_on_demand_capacity: Optional[_builtins.int] = ..., target_spot_capacity: Optional[_builtins.int] = ...) -> None:
...
class ClusterCoreInstanceFleetInstanceTypeConfig(dict):
    ...
    def __init__(__self__, *, instance_type: _builtins.str, bid_price: Optional[_builtins.str] = ..., bid_price_as_percentage_of_on_demand_price: Optional[_builtins.float] = ..., configurations: Optional[Sequence[outputs.ClusterCoreInstanceFleetInstanceTypeConfigConfiguration]] = ..., ebs_configs: Optional[Sequence[outputs.ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig]] = ..., weighted_capacity: Optional[_builtins.int] = ...) -> None:
...
class ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig(dict):
    ...
    def __init__(__self__, *, size: _builtins.int, type: _builtins.str, iops: Optional[_builtins.int] = ..., volumes_per_instance: Optional[_builtins.int] = ...) -> None:
...
class ClusterCoreInstanceFleetLaunchSpecifications(dict):
    ...
    def __init__(__self__, *, on_demand_specifications: Optional[Sequence[outputs.ClusterCoreInstanceFleetLaunchSpecificationsOnDemandSpecification]] = ..., spot_specifications: Optional[Sequence[outputs.ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification]] = ...) -> None:
...
class ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification(dict):
    ...
    def __init__(__self__, *, allocation_strategy: _builtins.str, timeout_action: _builtins.str, timeout_duration_minutes: _builtins.int, block_duration_minutes: Optional[_builtins.int] = ...) -> None:
...
class ClusterCoreInstanceGroup(dict):
    ...
    def __init__(__self__, *, instance_type: _builtins.str, autoscaling_policy: Optional[_builtins.str] = ..., bid_price: Optional[_builtins.str] = ..., ebs_configs: Optional[Sequence[outputs.ClusterCoreInstanceGroupEbsConfig]] = ..., id: Optional[_builtins.str] = ..., instance_count: Optional[_builtins.int] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class ClusterCoreInstanceGroupEbsConfig(dict):
    ...
    def __init__(__self__, *, size: _builtins.int, type: _builtins.str, iops: Optional[_builtins.int] = ..., throughput: Optional[_builtins.int] = ..., volumes_per_instance: Optional[_builtins.int] = ...) -> None:
...
class ClusterEc2Attributes(dict):
    ...
    def __init__(__self__, *, instance_profile: _builtins.str, additional_master_security_groups: Optional[_builtins.str] = ..., additional_slave_security_groups: Optional[_builtins.str] = ..., emr_managed_master_security_group: Optional[_builtins.str] = ..., emr_managed_slave_security_group: Optional[_builtins.str] = ..., key_name: Optional[_builtins.str] = ..., service_access_security_group: Optional[_builtins.str] = ..., subnet_id: Optional[_builtins.str] = ..., subnet_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ClusterKerberosAttributes(dict):
    ...
    def __init__(__self__, *, kdc_admin_password: _builtins.str, realm: _builtins.str, ad_domain_join_password: Optional[_builtins.str] = ..., ad_domain_join_user: Optional[_builtins.str] = ..., cross_realm_trust_principal_password: Optional[_builtins.str] = ...) -> None:
...
class ClusterMasterInstanceFleet(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., instance_type_configs: Optional[Sequence[outputs.ClusterMasterInstanceFleetInstanceTypeConfig]] = ..., launch_specifications: Optional[outputs.ClusterMasterInstanceFleetLaunchSpecifications] = ..., name: Optional[_builtins.str] = ..., provisioned_on_demand_capacity: Optional[_builtins.int] = ..., provisioned_spot_capacity: Optional[_builtins.int] = ..., target_on_demand_capacity: Optional[_builtins.int] = ..., target_spot_capacity: Optional[_builtins.int] = ...) -> None:
...
class ClusterMasterInstanceFleetInstanceTypeConfig(dict):
    ...
    def __init__(__self__, *, instance_type: _builtins.str, bid_price: Optional[_builtins.str] = ..., bid_price_as_percentage_of_on_demand_price: Optional[_builtins.float] = ..., configurations: Optional[Sequence[outputs.ClusterMasterInstanceFleetInstanceTypeConfigConfiguration]] = ..., ebs_configs: Optional[Sequence[outputs.ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig]] = ..., weighted_capacity: Optional[_builtins.int] = ...) -> None:
...
class ClusterMasterInstanceFleetLaunchSpecifications(dict):
    ...
    def __init__(__self__, *, on_demand_specifications: Optional[Sequence[outputs.ClusterMasterInstanceFleetLaunchSpecificationsOnDemandSpecification]] = ..., spot_specifications: Optional[Sequence[outputs.ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecification]] = ...) -> None:
...
class ClusterMasterInstanceGroup(dict):
    ...
    def __init__(__self__, *, instance_type: _builtins.str, bid_price: Optional[_builtins.str] = ..., ebs_configs: Optional[Sequence[outputs.ClusterMasterInstanceGroupEbsConfig]] = ..., id: Optional[_builtins.str] = ..., instance_count: Optional[_builtins.int] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class ClusterPlacementGroupConfig(dict):
    ...
    def __init__(__self__, *, instance_role: _builtins.str, placement_strategy: Optional[_builtins.str] = ...) -> None:
...
class ClusterStep(dict):
    ...
    def __init__(__self__, *, action_on_failure: _builtins.str, hadoop_jar_step: outputs.ClusterStepHadoopJarStep, name: _builtins.str) -> None:
...
class ClusterStepHadoopJarStep(dict):
    ...
    def __init__(__self__, *, jar: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., main_class: Optional[_builtins.str] = ..., properties: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class InstanceFleetInstanceTypeConfig(dict):
    ...
    def __init__(__self__, *, instance_type: _builtins.str, bid_price: Optional[_builtins.str] = ..., bid_price_as_percentage_of_on_demand_price: Optional[_builtins.float] = ..., configurations: Optional[Sequence[outputs.InstanceFleetInstanceTypeConfigConfiguration]] = ..., ebs_configs: Optional[Sequence[outputs.InstanceFleetInstanceTypeConfigEbsConfig]] = ..., weighted_capacity: Optional[_builtins.int] = ...) -> None:
...
class InstanceFleetLaunchSpecifications(dict):
    ...
    def __init__(__self__, *, on_demand_specifications: Optional[Sequence[outputs.InstanceFleetLaunchSpecificationsOnDemandSpecification]] = ..., spot_specifications: Optional[Sequence[outputs.InstanceFleetLaunchSpecificationsSpotSpecification]] = ...) -> None:
...
class ManagedScalingPolicyComputeLimit(dict):
    ...
    def __init__(__self__, *, maximum_capacity_units: _builtins.int, minimum_capacity_units: _builtins.int, unit_type: _builtins.str, maximum_core_capacity_units: Optional[_builtins.int] = ..., maximum_ondemand_capacity_units: Optional[_builtins.int] = ...) -> None:
...
class GetSupportedInstanceTypesSupportedInstanceTypeResult(dict):
    def __init__(__self__, *, architecture: _builtins.str, ebs_optimized_available: _builtins.bool, ebs_optimized_by_default: _builtins.bool, ebs_storage_only: _builtins.bool, instance_family_id: _builtins.str, is64_bits_only: _builtins.bool, memory_gb: _builtins.float, number_of_disks: _builtins.int, storage_gb: _builtins.int, type: _builtins.str, vcpu: _builtins.int) -> None:
