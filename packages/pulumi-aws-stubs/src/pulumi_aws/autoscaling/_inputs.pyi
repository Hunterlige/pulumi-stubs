...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GroupAvailabilityZoneDistributionArgs', 'GroupAvailabilityZoneDistributionArgsDict', 'GroupCapacityReservationSpecificationArgs', 'GroupCapacityReservationSpecificationArgsDict', ..., ..., 'GroupInitialLifecycleHookArgs', 'GroupInitialLifecycleHookArgsDict', 'GroupInstanceMaintenancePolicyArgs', 'GroupInstanceMaintenancePolicyArgsDict', 'GroupInstanceRefreshArgs', 'GroupInstanceRefreshArgsDict', 'GroupInstanceRefreshPreferencesArgs', 'GroupInstanceRefreshPreferencesArgsDict', ..., ..., 'GroupLaunchTemplateArgs', 'GroupLaunchTemplateArgsDict', 'GroupMixedInstancesPolicyArgs', 'GroupMixedInstancesPolicyArgsDict', 'GroupMixedInstancesPolicyInstancesDistributionArgs', ..., 'GroupMixedInstancesPolicyLaunchTemplateArgs', 'GroupMixedInstancesPolicyLaunchTemplateArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GroupTagArgs', 'GroupTagArgsDict', 'GroupTrafficSourceArgs', 'GroupTrafficSourceArgsDict', 'GroupWarmPoolArgs', 'GroupWarmPoolArgsDict', 'GroupWarmPoolInstanceReusePolicyArgs', 'GroupWarmPoolInstanceReusePolicyArgsDict', 'PolicyPredictiveScalingConfigurationArgs', 'PolicyPredictiveScalingConfigurationArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'PolicyStepAdjustmentArgs', 'PolicyStepAdjustmentArgsDict', 'PolicyTargetTrackingConfigurationArgs', 'PolicyTargetTrackingConfigurationArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'TagTagArgs', 'TagTagArgsDict', 'TrafficSourceAttachmentTrafficSourceArgs', 'TrafficSourceAttachmentTrafficSourceArgsDict', 'GetAmiIdsFilterArgs', 'GetAmiIdsFilterArgsDict']
...
class GroupAvailabilityZoneDistributionArgs:
    def __init__(__self__, *, capacity_distribution_strategy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def capacity_distribution_strategy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GroupCapacityReservationSpecificationArgs:
    def __init__(__self__, *, capacity_reservation_preference: Optional[pulumi.Input[_builtins.str]] = ..., capacity_reservation_target: Optional[pulumi.Input[GroupCapacityReservationSpecificationCapacityReservationTargetArgs]] = ...) -> None:
    ...
    def capacity_reservation_target(self, value: Optional[pulumi.Input[GroupCapacityReservationSpecificationCapacityReservationTargetArgs]]): # -> None:
        ...
...
class GroupCapacityReservationSpecificationCapacityReservationTargetArgs:
    def __init__(__self__, *, capacity_reservation_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., capacity_reservation_resource_group_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def capacity_reservation_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def capacity_reservation_resource_group_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class GroupInitialLifecycleHookArgs:
    def __init__(__self__, *, lifecycle_transition: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], default_result: Optional[pulumi.Input[_builtins.str]] = ..., heartbeat_timeout: Optional[pulumi.Input[_builtins.int]] = ..., notification_metadata: Optional[pulumi.Input[_builtins.str]] = ..., notification_target_arn: Optional[pulumi.Input[_builtins.str]] = ..., role_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def default_result(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def heartbeat_timeout(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def notification_metadata(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def notification_target_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GroupInstanceMaintenancePolicyArgs:
    def __init__(__self__, *, max_healthy_percentage: pulumi.Input[_builtins.int], min_healthy_percentage: pulumi.Input[_builtins.int]) -> None:
    ...
    def max_healthy_percentage(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def min_healthy_percentage(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class GroupInstanceRefreshArgs:
    def __init__(__self__, *, strategy: pulumi.Input[_builtins.str], preferences: Optional[pulumi.Input[GroupInstanceRefreshPreferencesArgs]] = ..., triggers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @preferences.setter
    def preferences(self, value: Optional[pulumi.Input[GroupInstanceRefreshPreferencesArgs]]): # -> None:
        ...
    ...
    @triggers.setter
    def triggers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class GroupInstanceRefreshPreferencesArgs:
    def __init__(__self__, *, alarm_specification: Optional[pulumi.Input[GroupInstanceRefreshPreferencesAlarmSpecificationArgs]] = ..., auto_rollback: Optional[pulumi.Input[_builtins.bool]] = ..., checkpoint_delay: Optional[pulumi.Input[_builtins.str]] = ..., checkpoint_percentages: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ..., instance_warmup: Optional[pulumi.Input[_builtins.str]] = ..., max_healthy_percentage: Optional[pulumi.Input[_builtins.int]] = ..., min_healthy_percentage: Optional[pulumi.Input[_builtins.int]] = ..., scale_in_protected_instances: Optional[pulumi.Input[_builtins.str]] = ..., skip_matching: Optional[pulumi.Input[_builtins.bool]] = ..., standby_instances: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def alarm_specification(self, value: Optional[pulumi.Input[GroupInstanceRefreshPreferencesAlarmSpecificationArgs]]): # -> None:
        ...
    ...
    def auto_rollback(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def checkpoint_delay(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def checkpoint_percentages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]): # -> None:
        ...
    ...
    def instance_warmup(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @max_healthy_percentage.setter
    def max_healthy_percentage(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @min_healthy_percentage.setter
    def min_healthy_percentage(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def scale_in_protected_instances(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def skip_matching(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def standby_instances(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GroupInstanceRefreshPreferencesAlarmSpecificationArgs:
    def __init__(__self__, *, alarms: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @alarms.setter
    def alarms(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class GroupMixedInstancesPolicyArgs:
    def __init__(__self__, *, launch_template: pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateArgs], instances_distribution: Optional[pulumi.Input[GroupMixedInstancesPolicyInstancesDistributionArgs]] = ...) -> None:
    ...
    def launch_template(self, value: pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateArgs]): # -> None:
        ...
    ...
    def instances_distribution(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyInstancesDistributionArgs]]): # -> None:
        ...
...
class GroupMixedInstancesPolicyInstancesDistributionArgs:
    def __init__(__self__, *, on_demand_allocation_strategy: Optional[pulumi.Input[_builtins.str]] = ..., on_demand_base_capacity: Optional[pulumi.Input[_builtins.int]] = ..., on_demand_percentage_above_base_capacity: Optional[pulumi.Input[_builtins.int]] = ..., spot_allocation_strategy: Optional[pulumi.Input[_builtins.str]] = ..., spot_instance_pools: Optional[pulumi.Input[_builtins.int]] = ..., spot_max_price: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def on_demand_base_capacity(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def on_demand_percentage_above_base_capacity(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def spot_allocation_strategy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def spot_instance_pools(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def spot_max_price(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GroupMixedInstancesPolicyLaunchTemplateArgs:
    def __init__(__self__, *, launch_template_specification: pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecificationArgs], overrides: Optional[pulumi.Input[Sequence[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideArgs]]]] = ...) -> None:
    ...
    def launch_template_specification(self, value: pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecificationArgs]): # -> None:
        ...
    ...
    @overrides.setter
    def overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideArgs]]]]): # -> None:
        ...
...
class GroupMixedInstancesPolicyLaunchTemplateOverrideArgs:
    def __init__(__self__, *, instance_requirements: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsArgs]] = ..., instance_type: Optional[pulumi.Input[_builtins.str]] = ..., launch_template_specification: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideLaunchTemplateSpecificationArgs]] = ..., weighted_capacity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def instance_requirements(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsArgs]]): # -> None:
        ...
    ...
    @launch_template_specification.setter
    def launch_template_specification(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideLaunchTemplateSpecificationArgs]]): # -> None:
        ...
...
class GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsArgs:
    def __init__(__self__, *, accelerator_count: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsAcceleratorCountArgs]] = ..., accelerator_manufacturers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., accelerator_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., accelerator_total_memory_mib: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsAcceleratorTotalMemoryMibArgs]] = ..., accelerator_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allowed_instance_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., bare_metal: Optional[pulumi.Input[_builtins.str]] = ..., baseline_ebs_bandwidth_mbps: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsBaselineEbsBandwidthMbpsArgs]] = ..., burstable_performance: Optional[pulumi.Input[_builtins.str]] = ..., cpu_manufacturers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., excluded_instance_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., instance_generations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., local_storage: Optional[pulumi.Input[_builtins.str]] = ..., local_storage_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., max_spot_price_as_percentage_of_optimal_on_demand_price: Optional[pulumi.Input[_builtins.int]] = ..., memory_gib_per_vcpu: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsMemoryGibPerVcpuArgs]] = ..., memory_mib: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsMemoryMibArgs]] = ..., network_bandwidth_gbps: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsNetworkBandwidthGbpsArgs]] = ..., network_interface_count: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsNetworkInterfaceCountArgs]] = ..., on_demand_max_price_percentage_over_lowest_price: Optional[pulumi.Input[_builtins.int]] = ..., require_hibernate_support: Optional[pulumi.Input[_builtins.bool]] = ..., spot_max_price_percentage_over_lowest_price: Optional[pulumi.Input[_builtins.int]] = ..., total_local_storage_gb: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsTotalLocalStorageGbArgs]] = ..., vcpu_count: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsVcpuCountArgs]] = ...) -> None:
    ...
    def accelerator_count(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsAcceleratorCountArgs]]): # -> None:
        ...
    ...
    def accelerator_total_memory_mib(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsAcceleratorTotalMemoryMibArgs]]): # -> None:
        ...
    ...
    def baseline_ebs_bandwidth_mbps(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsBaselineEbsBandwidthMbpsArgs]]): # -> None:
        ...
    ...
    def memory_gib_per_vcpu(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsMemoryGibPerVcpuArgs]]): # -> None:
        ...
    ...
    @memory_mib.setter
    def memory_mib(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsMemoryMibArgs]]): # -> None:
        ...
    ...
    def network_bandwidth_gbps(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsNetworkBandwidthGbpsArgs]]): # -> None:
        ...
    ...
    def network_interface_count(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsNetworkInterfaceCountArgs]]): # -> None:
        ...
    ...
    def total_local_storage_gb(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsTotalLocalStorageGbArgs]]): # -> None:
        ...
    ...
    @vcpu_count.setter
    def vcpu_count(self, value: Optional[pulumi.Input[GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsVcpuCountArgs]]): # -> None:
        ...
...
@pulumi.input_type
class GroupTagArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], propagate_at_launch: pulumi.Input[_builtins.bool], value: pulumi.Input[_builtins.str]) -> None:
    ...
    def propagate_at_launch(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class GroupTrafficSourceArgs:
    def __init__(__self__, *, identifier: pulumi.Input[_builtins.str], type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class GroupWarmPoolArgs:
    def __init__(__self__, *, instance_reuse_policy: Optional[pulumi.Input[GroupWarmPoolInstanceReusePolicyArgs]] = ..., max_group_prepared_capacity: Optional[pulumi.Input[_builtins.int]] = ..., min_size: Optional[pulumi.Input[_builtins.int]] = ..., pool_state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def instance_reuse_policy(self, value: Optional[pulumi.Input[GroupWarmPoolInstanceReusePolicyArgs]]): # -> None:
        ...
    ...
    def max_group_prepared_capacity(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @pool_state.setter
    def pool_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GroupWarmPoolInstanceReusePolicyArgs:
    def __init__(__self__, *, reuse_on_scale_in: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def reuse_on_scale_in(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationArgs:
    def __init__(__self__, *, metric_specification: pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationArgs], max_capacity_breach_behavior: Optional[pulumi.Input[_builtins.str]] = ..., max_capacity_buffer: Optional[pulumi.Input[_builtins.str]] = ..., mode: Optional[pulumi.Input[_builtins.str]] = ..., scheduling_buffer_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def metric_specification(self, value: pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationArgs]): # -> None:
        ...
    ...
    def max_capacity_breach_behavior(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_capacity_buffer(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def scheduling_buffer_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationArgs:
    def __init__(__self__, *, target_value: pulumi.Input[_builtins.float], customized_capacity_metric_specification: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationArgs]] = ..., customized_load_metric_specification: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationArgs]] = ..., customized_scaling_metric_specification: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationArgs]] = ..., predefined_load_metric_specification: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedLoadMetricSpecificationArgs]] = ..., predefined_metric_pair_specification: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedMetricPairSpecificationArgs]] = ..., predefined_scaling_metric_specification: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedScalingMetricSpecificationArgs]] = ...) -> None:
    ...
    @target_value.setter
    def target_value(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def customized_capacity_metric_specification(self, value: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationArgs]]): # -> None:
        ...
    ...
    def customized_load_metric_specification(self, value: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationArgs]]): # -> None:
        ...
    ...
    def customized_scaling_metric_specification(self, value: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationArgs]]): # -> None:
        ...
    ...
    def predefined_load_metric_specification(self, value: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedLoadMetricSpecificationArgs]]): # -> None:
        ...
    ...
    def predefined_metric_pair_specification(self, value: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedMetricPairSpecificationArgs]]): # -> None:
        ...
    ...
    def predefined_scaling_metric_specification(self, value: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedScalingMetricSpecificationArgs]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationArgs:
    def __init__(__self__, *, metric_data_queries: pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryArgs]]]) -> None:
    ...
    def metric_data_queries(self, value: pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryArgs]]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], expression: Optional[pulumi.Input[_builtins.str]] = ..., label: Optional[pulumi.Input[_builtins.str]] = ..., metric_stat: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryMetricStatArgs]] = ..., return_data: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @metric_stat.setter
    def metric_stat(self, value: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryMetricStatArgs]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryMetricStatArgs:
    def __init__(__self__, *, metric: pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryMetricStatMetricArgs], stat: pulumi.Input[_builtins.str], unit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @metric.setter
    def metric(self, value: pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryMetricStatMetricArgs]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryMetricStatMetricArgs:
    def __init__(__self__, *, metric_name: pulumi.Input[_builtins.str], namespace: pulumi.Input[_builtins.str], dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryMetricStatMetricDimensionArgs]]]] = ...) -> None:
    ...
    @dimensions.setter
    def dimensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryMetricStatMetricDimensionArgs]]]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationArgs:
    def __init__(__self__, *, metric_data_queries: pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryArgs]]]) -> None:
    ...
    @metric_data_queries.setter
    def metric_data_queries(self, value: pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryArgs]]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], expression: Optional[pulumi.Input[_builtins.str]] = ..., label: Optional[pulumi.Input[_builtins.str]] = ..., metric_stat: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryMetricStatArgs]] = ..., return_data: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @metric_stat.setter
    def metric_stat(self, value: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryMetricStatArgs]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryMetricStatArgs:
    def __init__(__self__, *, metric: pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryMetricStatMetricArgs], stat: pulumi.Input[_builtins.str], unit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @metric.setter
    def metric(self, value: pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryMetricStatMetricArgs]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryMetricStatMetricArgs:
    def __init__(__self__, *, metric_name: pulumi.Input[_builtins.str], namespace: pulumi.Input[_builtins.str], dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryMetricStatMetricDimensionArgs]]]] = ...) -> None:
    ...
    @dimensions.setter
    def dimensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryMetricStatMetricDimensionArgs]]]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationArgs:
    def __init__(__self__, *, metric_data_queries: pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryArgs]]]) -> None:
    ...
    @metric_data_queries.setter
    def metric_data_queries(self, value: pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryArgs]]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], expression: Optional[pulumi.Input[_builtins.str]] = ..., label: Optional[pulumi.Input[_builtins.str]] = ..., metric_stat: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryMetricStatArgs]] = ..., return_data: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @metric_stat.setter
    def metric_stat(self, value: Optional[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryMetricStatArgs]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryMetricStatArgs:
    def __init__(__self__, *, metric: pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryMetricStatMetricArgs], stat: pulumi.Input[_builtins.str], unit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @metric.setter
    def metric(self, value: pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryMetricStatMetricArgs]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryMetricStatMetricArgs:
    def __init__(__self__, *, metric_name: pulumi.Input[_builtins.str], namespace: pulumi.Input[_builtins.str], dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryMetricStatMetricDimensionArgs]]]] = ...) -> None:
    ...
    @dimensions.setter
    def dimensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryMetricStatMetricDimensionArgs]]]]): # -> None:
        ...
...
class PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedLoadMetricSpecificationArgs:
    def __init__(__self__, *, predefined_metric_type: pulumi.Input[_builtins.str], resource_label: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def resource_label(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PolicyStepAdjustmentArgs:
    def __init__(__self__, *, scaling_adjustment: pulumi.Input[_builtins.int], metric_interval_lower_bound: Optional[pulumi.Input[_builtins.str]] = ..., metric_interval_upper_bound: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def scaling_adjustment(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def metric_interval_lower_bound(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def metric_interval_upper_bound(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PolicyTargetTrackingConfigurationArgs:
    def __init__(__self__, *, target_value: pulumi.Input[_builtins.float], customized_metric_specification: Optional[pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationArgs]] = ..., disable_scale_in: Optional[pulumi.Input[_builtins.bool]] = ..., predefined_metric_specification: Optional[pulumi.Input[PolicyTargetTrackingConfigurationPredefinedMetricSpecificationArgs]] = ...) -> None:
    ...
    def customized_metric_specification(self, value: Optional[pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationArgs]]): # -> None:
        ...
    ...
    def predefined_metric_specification(self, value: Optional[pulumi.Input[PolicyTargetTrackingConfigurationPredefinedMetricSpecificationArgs]]): # -> None:
        ...
...
class PolicyTargetTrackingConfigurationCustomizedMetricSpecificationArgs:
    def __init__(__self__, *, metric_dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricDimensionArgs]]]] = ..., metric_name: Optional[pulumi.Input[_builtins.str]] = ..., metrics: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricArgs]]]] = ..., namespace: Optional[pulumi.Input[_builtins.str]] = ..., period: Optional[pulumi.Input[_builtins.int]] = ..., statistic: Optional[pulumi.Input[_builtins.str]] = ..., unit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def metric_dimensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricDimensionArgs]]]]): # -> None:
        ...
    ...
    @metrics.setter
    def metrics(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricArgs]]]]): # -> None:
        ...
...
class PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], expression: Optional[pulumi.Input[_builtins.str]] = ..., label: Optional[pulumi.Input[_builtins.str]] = ..., metric_stat: Optional[pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatArgs]] = ..., return_data: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @metric_stat.setter
    def metric_stat(self, value: Optional[pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatArgs]]): # -> None:
        ...
...
class PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatArgs:
    def __init__(__self__, *, metric: pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatMetricArgs], stat: pulumi.Input[_builtins.str], period: Optional[pulumi.Input[_builtins.int]] = ..., unit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @metric.setter
    def metric(self, value: pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatMetricArgs]): # -> None:
        ...
...
class PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatMetricArgs:
    def __init__(__self__, *, metric_name: pulumi.Input[_builtins.str], namespace: pulumi.Input[_builtins.str], dimensions: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatMetricDimensionArgs]]]] = ...) -> None:
    ...
    @dimensions.setter
    def dimensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatMetricDimensionArgs]]]]): # -> None:
        ...
