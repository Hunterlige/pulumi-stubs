...
class FindingsFilterFindingCriteria(dict):
    def __init__(__self__, *, criterions: Optional[Sequence[outputs.FindingsFilterFindingCriteriaCriterion]] = ...) -> None:
...
class FindingsFilterFindingCriteriaCriterion(dict):
    ...
    def __init__(__self__, *, field: _builtins.str, eq_exact_matches: Optional[Sequence[_builtins.str]] = ..., eqs: Optional[Sequence[_builtins.str]] = ..., gt: Optional[_builtins.str] = ..., gte: Optional[_builtins.str] = ..., lt: Optional[_builtins.str] = ..., lte: Optional[_builtins.str] = ..., neqs: Optional[Sequence[_builtins.str]] = ...) -> None:
