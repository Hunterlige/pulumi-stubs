...
class CustomDataIdentifierArgs:
    def __init__(
        ...
        *,
        ...
        keywords: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
        maximum_match_distance: Optional[pulumi.Input[_builtins.int]] = ...,
...
class CustomDataIdentifier(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[CustomDataIdentifierArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
