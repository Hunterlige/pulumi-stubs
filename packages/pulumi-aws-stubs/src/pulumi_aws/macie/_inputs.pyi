...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FindingsFilterFindingCriteriaArgs', 'FindingsFilterFindingCriteriaArgsDict', 'FindingsFilterFindingCriteriaCriterionArgs', 'FindingsFilterFindingCriteriaCriterionArgsDict']
...
class FindingsFilterFindingCriteriaArgs:
    def __init__(__self__, *, criterions: Optional[pulumi.Input[Sequence[pulumi.Input[FindingsFilterFindingCriteriaCriterionArgs]]]] = ...) -> None:
    ...
    @criterions.setter
    def criterions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FindingsFilterFindingCriteriaCriterionArgs]]]]): # -> None:
        ...
...
class FindingsFilterFindingCriteriaCriterionArgs:
    def __init__(__self__, *, field: pulumi.Input[_builtins.str], eq_exact_matches: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., eqs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., gt: Optional[pulumi.Input[_builtins.str]] = ..., gte: Optional[pulumi.Input[_builtins.str]] = ..., lt: Optional[pulumi.Input[_builtins.str]] = ..., lte: Optional[pulumi.Input[_builtins.str]] = ..., neqs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def eq_exact_matches(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @gt.setter
    def gt(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @lt.setter
    def lt(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
