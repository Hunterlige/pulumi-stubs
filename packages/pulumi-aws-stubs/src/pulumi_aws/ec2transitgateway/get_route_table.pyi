...
class GetRouteTableResult:
    ...
    def __init__(__self__, arn=..., default_association_route_table=..., default_propagation_route_table=..., filters=..., id=..., region=..., tags=..., transit_gateway_id=...) -> None:
        ...
...
def get_route_table(filters: Optional[Sequence[Union[GetRouteTableFilterArgs, GetRouteTableFilterArgsDict]]] = ..., id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetRouteTableResult:
