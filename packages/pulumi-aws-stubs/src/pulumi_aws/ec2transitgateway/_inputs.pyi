...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DefaultRouteTableAssociationTimeoutsArgs', 'DefaultRouteTableAssociationTimeoutsArgsDict', 'DefaultRouteTablePropagationTimeoutsArgs', 'DefaultRouteTablePropagationTimeoutsArgsDict', 'InstanceConnectEndpointTimeoutsArgs', 'InstanceConnectEndpointTimeoutsArgsDict', 'PeeringAttachmentOptionsArgs', 'PeeringAttachmentOptionsArgsDict', 'GetAttachmentFilterArgs', 'GetAttachmentFilterArgsDict', 'GetAttachmentsFilterArgs', 'GetAttachmentsFilterArgsDict', 'GetConnectFilterArgs', 'GetConnectFilterArgsDict', 'GetConnectPeerFilterArgs', 'GetConnectPeerFilterArgsDict', 'GetDirectConnectGatewayAttachmentFilterArgs', 'GetDirectConnectGatewayAttachmentFilterArgsDict', 'GetMulticastDomainFilterArgs', 'GetMulticastDomainFilterArgsDict', 'GetPeeringAttachmentFilterArgs', 'GetPeeringAttachmentFilterArgsDict', 'GetPeeringAttachmentsFilterArgs', 'GetPeeringAttachmentsFilterArgsDict', 'GetRouteTableAssociationsFilterArgs', 'GetRouteTableAssociationsFilterArgsDict', 'GetRouteTableFilterArgs', 'GetRouteTableFilterArgsDict', 'GetRouteTablePropagationsFilterArgs', 'GetRouteTablePropagationsFilterArgsDict', 'GetRouteTableRoutesFilterArgs', 'GetRouteTableRoutesFilterArgsDict', 'GetTransitGatewayFilterArgs', 'GetTransitGatewayFilterArgsDict', 'GetVpcAttachmentFilterArgs', 'GetVpcAttachmentFilterArgsDict', 'GetVpcAttachmentsFilterArgs', 'GetVpcAttachmentsFilterArgsDict', 'GetVpnAttachmentFilterArgs', 'GetVpnAttachmentFilterArgsDict']
...
class PeeringAttachmentOptionsArgs:
    def __init__(__self__, *, dynamic_routing: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dynamic_routing(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
