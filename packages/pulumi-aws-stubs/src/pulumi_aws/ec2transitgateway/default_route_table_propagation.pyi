...
class DefaultRouteTablePropagationArgs:
    def __init__(
        ...
        *,
        ...
        timeouts: Optional[
            pulumi.Input[DefaultRouteTablePropagationTimeoutsArgs]
        ] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @timeouts.setter
    def timeouts(
        self, value: Optional[pulumi.Input[DefaultRouteTablePropagationTimeoutsArgs]]
    ): ...
...
class DefaultRouteTablePropagation(pulumi.CustomResource):
    ...
    def timeouts(
        self,
    ) -> pulumi.Output[Optional[outputs.DefaultRouteTablePropagationTimeouts]]: ...
    @_builtins.property
    @pulumi.getter(name="transitGatewayId")
