...
class MulticastGroupMember(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: MulticastGroupMemberArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., group_ip_address: Optional[pulumi.Input[_builtins.str]] = ..., network_interface_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., transit_gateway_multicast_domain_id: Optional[pulumi.Input[_builtins.str]] = ...) -> MulticastGroupMember:
