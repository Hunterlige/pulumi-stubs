...
class _RouteTableState:
    def __init__(
        ...
        *,
        ...
        default_association_route_table: Optional[pulumi.Input[_builtins.bool]] = ...,
        default_propagation_route_table: Optional[pulumi.Input[_builtins.bool]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tags_all: Optional[
    ...
    def default_association_route_table(
        self,
    ...
    def default_propagation_route_table(
        self,
    ) -> Optional[pulumi.Input[_builtins.bool]]: ...
