...
class EventIntegrationArgs:
    def __init__(
        ...
        *,
        ...
        eventbridge_bus: pulumi.Input[_builtins.str],
    ...
    def eventbridge_bus(self, value: pulumi.Input[_builtins.str]): ...
    @_builtins.property
    @pulumi.getter
...
class _EventIntegrationState:
    def __init__(
        ...
        *,
        ...
        description: Optional[pulumi.Input[_builtins.str]] = ...,
        event_filter: Optional[pulumi.Input[EventIntegrationEventFilterArgs]] = ...,
        eventbridge_bus: Optional[pulumi.Input[_builtins.str]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tags_all: Optional[
    ...
    def event_filter(
        self,
    ) -> Optional[pulumi.Input[EventIntegrationEventFilterArgs]]: ...
    @event_filter.setter
    def event_filter(
        self, value: Optional[pulumi.Input[EventIntegrationEventFilterArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter(name="eventbridgeBus")
    def eventbridge_bus(self) -> Optional[pulumi.Input[_builtins.str]]: ...
    @eventbridge_bus.setter
    def eventbridge_bus(self, value: Optional[pulumi.Input[_builtins.str]]): ...
    @_builtins.property
    @pulumi.getter
    def name(self) -> Optional[pulumi.Input[_builtins.str]]: ...
    @name.setter
...
class EventIntegration(pulumi.CustomResource):
    ...
    def __init__(
        ...
        event_filter: Optional[
            pulumi.Input[
                Union[
                    EventIntegrationEventFilterArgs, EventIntegrationEventFilterArgsDict
                ]
            ]
        ] = ...,
        eventbridge_bus: Optional[pulumi.Input[_builtins.str]] = ...,
