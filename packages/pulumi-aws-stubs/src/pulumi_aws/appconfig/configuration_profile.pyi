...
class ConfigurationProfileArgs:
    def __init__(
        ...
        *,
        ...
        retrieval_role_arn: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        type: Optional[pulumi.Input[_builtins.str]] = ...,
        validators: Optional[
            pulumi.Input[Sequence[pulumi.Input[ConfigurationProfileValidatorArgs]]]
        ] = ...,
    ) -> None: ...
    @_builtins.property
...
class ConfigurationProfile(pulumi.CustomResource):
    ...
    def validators(
        self,
    ) -> pulumi.Output[Optional[Sequence[outputs.ConfigurationProfileValidator]]]: ...
