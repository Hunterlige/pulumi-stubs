...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['PipeEnrichmentParametersArgs', 'PipeEnrichmentParametersArgsDict', 'PipeEnrichmentParametersHttpParametersArgs', 'PipeEnrichmentParametersHttpParametersArgsDict', 'PipeLogConfigurationArgs', 'PipeLogConfigurationArgsDict', ..., ..., 'PipeLogConfigurationFirehoseLogDestinationArgs', 'PipeLogConfigurationFirehoseLogDestinationArgsDict', 'PipeLogConfigurationS3LogDestinationArgs', 'PipeLogConfigurationS3LogDestinationArgsDict', 'PipeSourceParametersArgs', 'PipeSourceParametersArgsDict', 'PipeSourceParametersActivemqBrokerParametersArgs', ..., ..., ..., 'PipeSourceParametersDynamodbStreamParametersArgs', ..., ..., ..., 'PipeSourceParametersFilterCriteriaArgs', 'PipeSourceParametersFilterCriteriaArgsDict', 'PipeSourceParametersFilterCriteriaFilterArgs', 'PipeSourceParametersFilterCriteriaFilterArgsDict', 'PipeSourceParametersKinesisStreamParametersArgs', ..., ..., ..., ..., ..., ..., ..., 'PipeSourceParametersRabbitmqBrokerParametersArgs', ..., ..., ..., 'PipeSourceParametersSelfManagedKafkaParametersArgs', ..., ..., ..., ..., ..., 'PipeSourceParametersSqsQueueParametersArgs', 'PipeSourceParametersSqsQueueParametersArgsDict', 'PipeTargetParametersArgs', 'PipeTargetParametersArgsDict', 'PipeTargetParametersBatchJobParametersArgs', 'PipeTargetParametersBatchJobParametersArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'PipeTargetParametersCloudwatchLogsParametersArgs', ..., 'PipeTargetParametersEcsTaskParametersArgs', 'PipeTargetParametersEcsTaskParametersArgsDict', ..., ..., ..., ..., ..., ..., 'PipeTargetParametersEcsTaskParametersOverridesArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'PipeTargetParametersHttpParametersArgs', 'PipeTargetParametersHttpParametersArgsDict', 'PipeTargetParametersKinesisStreamParametersArgs', ..., 'PipeTargetParametersLambdaFunctionParametersArgs', ..., 'PipeTargetParametersRedshiftDataParametersArgs', 'PipeTargetParametersRedshiftDataParametersArgsDict', ..., ..., ..., ..., 'PipeTargetParametersSqsQueueParametersArgs', 'PipeTargetParametersSqsQueueParametersArgsDict', ..., ...]
...
class PipeEnrichmentParametersArgs:
    def __init__(__self__, *, http_parameters: Optional[pulumi.Input[PipeEnrichmentParametersHttpParametersArgs]] = ..., input_template: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def http_parameters(self, value: Optional[pulumi.Input[PipeEnrichmentParametersHttpParametersArgs]]): # -> None:
        ...
    ...
    def input_template(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipeEnrichmentParametersHttpParametersArgs:
    def __init__(__self__, *, header_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., path_parameter_values: Optional[pulumi.Input[_builtins.str]] = ..., query_string_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
        ...
    ...
    def path_parameter_values(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipeLogConfigurationArgs:
    def __init__(__self__, *, level: pulumi.Input[_builtins.str], cloudwatch_logs_log_destination: Optional[pulumi.Input[PipeLogConfigurationCloudwatchLogsLogDestinationArgs]] = ..., firehose_log_destination: Optional[pulumi.Input[PipeLogConfigurationFirehoseLogDestinationArgs]] = ..., include_execution_datas: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., s3_log_destination: Optional[pulumi.Input[PipeLogConfigurationS3LogDestinationArgs]] = ...) -> None:
    ...
    def cloudwatch_logs_log_destination(self, value: Optional[pulumi.Input[PipeLogConfigurationCloudwatchLogsLogDestinationArgs]]): # -> None:
        ...
    ...
    def firehose_log_destination(self, value: Optional[pulumi.Input[PipeLogConfigurationFirehoseLogDestinationArgs]]): # -> None:
        ...
    ...
    def include_execution_datas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def s3_log_destination(self, value: Optional[pulumi.Input[PipeLogConfigurationS3LogDestinationArgs]]): # -> None:
        ...
...
class PipeLogConfigurationFirehoseLogDestinationArgs:
    def __init__(__self__, *, delivery_stream_arn: pulumi.Input[_builtins.str]) -> None:
...
class PipeLogConfigurationS3LogDestinationArgs:
    def __init__(__self__, *, bucket_name: pulumi.Input[_builtins.str], bucket_owner: pulumi.Input[_builtins.str], output_format: Optional[pulumi.Input[_builtins.str]] = ..., prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @bucket_owner.setter
    def bucket_owner(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PipeSourceParametersArgs:
    def __init__(__self__, *, activemq_broker_parameters: Optional[pulumi.Input[PipeSourceParametersActivemqBrokerParametersArgs]] = ..., dynamodb_stream_parameters: Optional[pulumi.Input[PipeSourceParametersDynamodbStreamParametersArgs]] = ..., filter_criteria: Optional[pulumi.Input[PipeSourceParametersFilterCriteriaArgs]] = ..., kinesis_stream_parameters: Optional[pulumi.Input[PipeSourceParametersKinesisStreamParametersArgs]] = ..., managed_streaming_kafka_parameters: Optional[pulumi.Input[PipeSourceParametersManagedStreamingKafkaParametersArgs]] = ..., rabbitmq_broker_parameters: Optional[pulumi.Input[PipeSourceParametersRabbitmqBrokerParametersArgs]] = ..., self_managed_kafka_parameters: Optional[pulumi.Input[PipeSourceParametersSelfManagedKafkaParametersArgs]] = ..., sqs_queue_parameters: Optional[pulumi.Input[PipeSourceParametersSqsQueueParametersArgs]] = ...) -> None:
    ...
    def activemq_broker_parameters(self, value: Optional[pulumi.Input[PipeSourceParametersActivemqBrokerParametersArgs]]): # -> None:
        ...
    ...
    def dynamodb_stream_parameters(self, value: Optional[pulumi.Input[PipeSourceParametersDynamodbStreamParametersArgs]]): # -> None:
        ...
    ...
    def filter_criteria(self, value: Optional[pulumi.Input[PipeSourceParametersFilterCriteriaArgs]]): # -> None:
        ...
    ...
    def kinesis_stream_parameters(self, value: Optional[pulumi.Input[PipeSourceParametersKinesisStreamParametersArgs]]): # -> None:
        ...
    ...
    def managed_streaming_kafka_parameters(self, value: Optional[pulumi.Input[PipeSourceParametersManagedStreamingKafkaParametersArgs]]): # -> None:
        ...
    ...
    def rabbitmq_broker_parameters(self, value: Optional[pulumi.Input[PipeSourceParametersRabbitmqBrokerParametersArgs]]): # -> None:
        ...
    ...
    def self_managed_kafka_parameters(self, value: Optional[pulumi.Input[PipeSourceParametersSelfManagedKafkaParametersArgs]]): # -> None:
        ...
    ...
    def sqs_queue_parameters(self, value: Optional[pulumi.Input[PipeSourceParametersSqsQueueParametersArgs]]): # -> None:
        ...
...
class PipeSourceParametersActivemqBrokerParametersArgs:
    def __init__(__self__, *, credentials: pulumi.Input[PipeSourceParametersActivemqBrokerParametersCredentialsArgs], queue_name: pulumi.Input[_builtins.str], batch_size: Optional[pulumi.Input[_builtins.int]] = ..., maximum_batching_window_in_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @credentials.setter
    def credentials(self, value: pulumi.Input[PipeSourceParametersActivemqBrokerParametersCredentialsArgs]): # -> None:
        ...
...
class PipeSourceParametersActivemqBrokerParametersCredentialsArgs:
    ...
    @basic_auth.setter
    def basic_auth(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PipeSourceParametersDynamodbStreamParametersArgs:
    def __init__(__self__, *, starting_position: pulumi.Input[_builtins.str], batch_size: Optional[pulumi.Input[_builtins.int]] = ..., dead_letter_config: Optional[pulumi.Input[PipeSourceParametersDynamodbStreamParametersDeadLetterConfigArgs]] = ..., maximum_batching_window_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., maximum_record_age_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., maximum_retry_attempts: Optional[pulumi.Input[_builtins.int]] = ..., on_partial_batch_item_failure: Optional[pulumi.Input[_builtins.str]] = ..., parallelization_factor: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def starting_position(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def dead_letter_config(self, value: Optional[pulumi.Input[PipeSourceParametersDynamodbStreamParametersDeadLetterConfigArgs]]): # -> None:
        ...
    ...
    def on_partial_batch_item_failure(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipeSourceParametersFilterCriteriaArgs:
    def __init__(__self__, *, filters: Optional[pulumi.Input[Sequence[pulumi.Input[PipeSourceParametersFilterCriteriaFilterArgs]]]] = ...) -> None:
    ...
    @filters.setter
    def filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeSourceParametersFilterCriteriaFilterArgs]]]]): # -> None:
        ...
...
class PipeSourceParametersKinesisStreamParametersArgs:
    def __init__(__self__, *, starting_position: pulumi.Input[_builtins.str], batch_size: Optional[pulumi.Input[_builtins.int]] = ..., dead_letter_config: Optional[pulumi.Input[PipeSourceParametersKinesisStreamParametersDeadLetterConfigArgs]] = ..., maximum_batching_window_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., maximum_record_age_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., maximum_retry_attempts: Optional[pulumi.Input[_builtins.int]] = ..., on_partial_batch_item_failure: Optional[pulumi.Input[_builtins.str]] = ..., parallelization_factor: Optional[pulumi.Input[_builtins.int]] = ..., starting_position_timestamp: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @dead_letter_config.setter
    def dead_letter_config(self, value: Optional[pulumi.Input[PipeSourceParametersKinesisStreamParametersDeadLetterConfigArgs]]): # -> None:
        ...
...
class PipeSourceParametersManagedStreamingKafkaParametersArgs:
    def __init__(__self__, *, topic_name: pulumi.Input[_builtins.str], batch_size: Optional[pulumi.Input[_builtins.int]] = ..., consumer_group_id: Optional[pulumi.Input[_builtins.str]] = ..., credentials: Optional[pulumi.Input[PipeSourceParametersManagedStreamingKafkaParametersCredentialsArgs]] = ..., maximum_batching_window_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., starting_position: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @credentials.setter
    def credentials(self, value: Optional[pulumi.Input[PipeSourceParametersManagedStreamingKafkaParametersCredentialsArgs]]): # -> None:
        ...
...
class PipeSourceParametersManagedStreamingKafkaParametersCredentialsArgs:
    def __init__(__self__, *, client_certificate_tls_auth: Optional[pulumi.Input[_builtins.str]] = ..., sasl_scram512_auth: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def client_certificate_tls_auth(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def sasl_scram512_auth(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipeSourceParametersRabbitmqBrokerParametersArgs:
    def __init__(__self__, *, credentials: pulumi.Input[PipeSourceParametersRabbitmqBrokerParametersCredentialsArgs], queue_name: pulumi.Input[_builtins.str], batch_size: Optional[pulumi.Input[_builtins.int]] = ..., maximum_batching_window_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., virtual_host: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @credentials.setter
    def credentials(self, value: pulumi.Input[PipeSourceParametersRabbitmqBrokerParametersCredentialsArgs]): # -> None:
        ...
    ...
    @virtual_host.setter
    def virtual_host(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipeSourceParametersSelfManagedKafkaParametersArgs:
    def __init__(__self__, *, topic_name: pulumi.Input[_builtins.str], additional_bootstrap_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., batch_size: Optional[pulumi.Input[_builtins.int]] = ..., consumer_group_id: Optional[pulumi.Input[_builtins.str]] = ..., credentials: Optional[pulumi.Input[PipeSourceParametersSelfManagedKafkaParametersCredentialsArgs]] = ..., maximum_batching_window_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., server_root_ca_certificate: Optional[pulumi.Input[_builtins.str]] = ..., starting_position: Optional[pulumi.Input[_builtins.str]] = ..., vpc: Optional[pulumi.Input[PipeSourceParametersSelfManagedKafkaParametersVpcArgs]] = ...) -> None:
    ...
    def additional_bootstrap_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @credentials.setter
    def credentials(self, value: Optional[pulumi.Input[PipeSourceParametersSelfManagedKafkaParametersCredentialsArgs]]): # -> None:
        ...
    ...
    @vpc.setter
    def vpc(self, value: Optional[pulumi.Input[PipeSourceParametersSelfManagedKafkaParametersVpcArgs]]): # -> None:
        ...
...
class PipeSourceParametersSelfManagedKafkaParametersCredentialsArgs:
    def __init__(__self__, *, basic_auth: Optional[pulumi.Input[_builtins.str]] = ..., client_certificate_tls_auth: Optional[pulumi.Input[_builtins.str]] = ..., sasl_scram256_auth: Optional[pulumi.Input[_builtins.str]] = ..., sasl_scram512_auth: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @basic_auth.setter
    def basic_auth(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def sasl_scram256_auth(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipeSourceParametersSelfManagedKafkaParametersVpcArgs:
    def __init__(__self__, *, security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., subnets: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
        ...
...
class PipeSourceParametersSqsQueueParametersArgs:
    def __init__(__self__, *, batch_size: Optional[pulumi.Input[_builtins.int]] = ..., maximum_batching_window_in_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class PipeTargetParametersArgs:
    def __init__(__self__, *, batch_job_parameters: Optional[pulumi.Input[PipeTargetParametersBatchJobParametersArgs]] = ..., cloudwatch_logs_parameters: Optional[pulumi.Input[PipeTargetParametersCloudwatchLogsParametersArgs]] = ..., ecs_task_parameters: Optional[pulumi.Input[PipeTargetParametersEcsTaskParametersArgs]] = ..., eventbridge_event_bus_parameters: Optional[pulumi.Input[PipeTargetParametersEventbridgeEventBusParametersArgs]] = ..., http_parameters: Optional[pulumi.Input[PipeTargetParametersHttpParametersArgs]] = ..., input_template: Optional[pulumi.Input[_builtins.str]] = ..., kinesis_stream_parameters: Optional[pulumi.Input[PipeTargetParametersKinesisStreamParametersArgs]] = ..., lambda_function_parameters: Optional[pulumi.Input[PipeTargetParametersLambdaFunctionParametersArgs]] = ..., redshift_data_parameters: Optional[pulumi.Input[PipeTargetParametersRedshiftDataParametersArgs]] = ..., sagemaker_pipeline_parameters: Optional[pulumi.Input[PipeTargetParametersSagemakerPipelineParametersArgs]] = ..., sqs_queue_parameters: Optional[pulumi.Input[PipeTargetParametersSqsQueueParametersArgs]] = ..., step_function_state_machine_parameters: Optional[pulumi.Input[PipeTargetParametersStepFunctionStateMachineParametersArgs]] = ...) -> None:
    ...
    def batch_job_parameters(self, value: Optional[pulumi.Input[PipeTargetParametersBatchJobParametersArgs]]): # -> None:
        ...
    ...
    def cloudwatch_logs_parameters(self, value: Optional[pulumi.Input[PipeTargetParametersCloudwatchLogsParametersArgs]]): # -> None:
        ...
    ...
    def ecs_task_parameters(self, value: Optional[pulumi.Input[PipeTargetParametersEcsTaskParametersArgs]]): # -> None:
        ...
    ...
    def eventbridge_event_bus_parameters(self, value: Optional[pulumi.Input[PipeTargetParametersEventbridgeEventBusParametersArgs]]): # -> None:
        ...
    ...
    @http_parameters.setter
    def http_parameters(self, value: Optional[pulumi.Input[PipeTargetParametersHttpParametersArgs]]): # -> None:
        ...
    ...
    @kinesis_stream_parameters.setter
    def kinesis_stream_parameters(self, value: Optional[pulumi.Input[PipeTargetParametersKinesisStreamParametersArgs]]): # -> None:
        ...
    ...
    def lambda_function_parameters(self, value: Optional[pulumi.Input[PipeTargetParametersLambdaFunctionParametersArgs]]): # -> None:
        ...
    ...
    def redshift_data_parameters(self, value: Optional[pulumi.Input[PipeTargetParametersRedshiftDataParametersArgs]]): # -> None:
        ...
    ...
    def sagemaker_pipeline_parameters(self, value: Optional[pulumi.Input[PipeTargetParametersSagemakerPipelineParametersArgs]]): # -> None:
        ...
    ...
    @sqs_queue_parameters.setter
    def sqs_queue_parameters(self, value: Optional[pulumi.Input[PipeTargetParametersSqsQueueParametersArgs]]): # -> None:
        ...
    ...
    def step_function_state_machine_parameters(self, value: Optional[pulumi.Input[PipeTargetParametersStepFunctionStateMachineParametersArgs]]): # -> None:
        ...
...
class PipeTargetParametersBatchJobParametersArgs:
    def __init__(__self__, *, job_definition: pulumi.Input[_builtins.str], job_name: pulumi.Input[_builtins.str], array_properties: Optional[pulumi.Input[PipeTargetParametersBatchJobParametersArrayPropertiesArgs]] = ..., container_overrides: Optional[pulumi.Input[PipeTargetParametersBatchJobParametersContainerOverridesArgs]] = ..., depends_ons: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersBatchJobParametersDependsOnArgs]]]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., retry_strategy: Optional[pulumi.Input[PipeTargetParametersBatchJobParametersRetryStrategyArgs]] = ...) -> None:
    ...
    def array_properties(self, value: Optional[pulumi.Input[PipeTargetParametersBatchJobParametersArrayPropertiesArgs]]): # -> None:
        ...
    ...
    def container_overrides(self, value: Optional[pulumi.Input[PipeTargetParametersBatchJobParametersContainerOverridesArgs]]): # -> None:
        ...
    ...
    @depends_ons.setter
    def depends_ons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersBatchJobParametersDependsOnArgs]]]]): # -> None:
        ...
    ...
    def retry_strategy(self, value: Optional[pulumi.Input[PipeTargetParametersBatchJobParametersRetryStrategyArgs]]): # -> None:
        ...
...
class PipeTargetParametersBatchJobParametersContainerOverridesArgs:
    def __init__(__self__, *, commands: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., environments: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersBatchJobParametersContainerOverridesEnvironmentArgs]]]] = ..., instance_type: Optional[pulumi.Input[_builtins.str]] = ..., resource_requirements: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementArgs]]]] = ...) -> None:
    ...
    @environments.setter
    def environments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersBatchJobParametersContainerOverridesEnvironmentArgs]]]]): # -> None:
        ...
    ...
    def resource_requirements(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementArgs]]]]): # -> None:
        ...
...
class PipeTargetParametersBatchJobParametersDependsOnArgs:
    def __init__(__self__, *, job_id: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PipeTargetParametersBatchJobParametersRetryStrategyArgs:
    def __init__(__self__, *, attempts: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class PipeTargetParametersCloudwatchLogsParametersArgs:
    def __init__(__self__, *, log_stream_name: Optional[pulumi.Input[_builtins.str]] = ..., timestamp: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PipeTargetParametersEcsTaskParametersArgs:
    def __init__(__self__, *, task_definition_arn: pulumi.Input[_builtins.str], capacity_provider_strategies: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersCapacityProviderStrategyArgs]]]] = ..., enable_ecs_managed_tags: Optional[pulumi.Input[_builtins.bool]] = ..., enable_execute_command: Optional[pulumi.Input[_builtins.bool]] = ..., group: Optional[pulumi.Input[_builtins.str]] = ..., launch_type: Optional[pulumi.Input[_builtins.str]] = ..., network_configuration: Optional[pulumi.Input[PipeTargetParametersEcsTaskParametersNetworkConfigurationArgs]] = ..., overrides: Optional[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesArgs]] = ..., placement_constraints: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersPlacementConstraintArgs]]]] = ..., placement_strategies: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersPlacementStrategyArgs]]]] = ..., platform_version: Optional[pulumi.Input[_builtins.str]] = ..., propagate_tags: Optional[pulumi.Input[_builtins.str]] = ..., reference_id: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., task_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def capacity_provider_strategies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersCapacityProviderStrategyArgs]]]]): # -> None:
        ...
    ...
    def network_configuration(self, value: Optional[pulumi.Input[PipeTargetParametersEcsTaskParametersNetworkConfigurationArgs]]): # -> None:
        ...
    ...
    @overrides.setter
    def overrides(self, value: Optional[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesArgs]]): # -> None:
        ...
    ...
    def placement_constraints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersPlacementConstraintArgs]]]]): # -> None:
        ...
    ...
    def placement_strategies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersPlacementStrategyArgs]]]]): # -> None:
        ...
...
class PipeTargetParametersEcsTaskParametersNetworkConfigurationArgs:
    def __init__(__self__, *, aws_vpc_configuration: Optional[pulumi.Input[PipeTargetParametersEcsTaskParametersNetworkConfigurationAwsVpcConfigurationArgs]] = ...) -> None:
    ...
    def aws_vpc_configuration(self, value: Optional[pulumi.Input[PipeTargetParametersEcsTaskParametersNetworkConfigurationAwsVpcConfigurationArgs]]): # -> None:
        ...
...
class PipeTargetParametersEcsTaskParametersNetworkConfigurationAwsVpcConfigurationArgs:
    def __init__(__self__, *, assign_public_ip: Optional[pulumi.Input[_builtins.str]] = ..., security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., subnets: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def assign_public_ip(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipeTargetParametersEcsTaskParametersOverridesArgs:
    def __init__(__self__, *, container_overrides: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesContainerOverrideArgs]]]] = ..., cpu: Optional[pulumi.Input[_builtins.str]] = ..., ephemeral_storage: Optional[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesEphemeralStorageArgs]] = ..., execution_role_arn: Optional[pulumi.Input[_builtins.str]] = ..., inference_accelerator_overrides: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesInferenceAcceleratorOverrideArgs]]]] = ..., memory: Optional[pulumi.Input[_builtins.str]] = ..., task_role_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @container_overrides.setter
    def container_overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesContainerOverrideArgs]]]]): # -> None:
        ...
    ...
    def ephemeral_storage(self, value: Optional[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesEphemeralStorageArgs]]): # -> None:
        ...
    ...
    def inference_accelerator_overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesInferenceAcceleratorOverrideArgs]]]]): # -> None:
        ...
...
class PipeTargetParametersEcsTaskParametersOverridesContainerOverrideArgs:
    def __init__(__self__, *, commands: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., cpu: Optional[pulumi.Input[_builtins.int]] = ..., environment_files: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesContainerOverrideEnvironmentFileArgs]]]] = ..., environments: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesContainerOverrideEnvironmentArgs]]]] = ..., memory: Optional[pulumi.Input[_builtins.int]] = ..., memory_reservation: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resource_requirements: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesContainerOverrideResourceRequirementArgs]]]] = ...) -> None:
    ...
    @cpu.setter
    def cpu(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def environment_files(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesContainerOverrideEnvironmentFileArgs]]]]): # -> None:
        ...
    ...
    @environments.setter
    def environments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesContainerOverrideEnvironmentArgs]]]]): # -> None:
        ...
    ...
    def memory_reservation(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @resource_requirements.setter
    def resource_requirements(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersEcsTaskParametersOverridesContainerOverrideResourceRequirementArgs]]]]): # -> None:
        ...
...
class PipeTargetParametersEcsTaskParametersOverridesInferenceAcceleratorOverrideArgs:
    def __init__(__self__, *, device_name: Optional[pulumi.Input[_builtins.str]] = ..., device_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @device_type.setter
    def device_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipeTargetParametersEcsTaskParametersPlacementConstraintArgs:
    def __init__(__self__, *, expression: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PipeTargetParametersEcsTaskParametersPlacementStrategyArgs:
    def __init__(__self__, *, field: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PipeTargetParametersEventbridgeEventBusParametersArgs:
    def __init__(__self__, *, detail_type: Optional[pulumi.Input[_builtins.str]] = ..., endpoint_id: Optional[pulumi.Input[_builtins.str]] = ..., resources: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., source: Optional[pulumi.Input[_builtins.str]] = ..., time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @detail_type.setter
    def detail_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipeTargetParametersRedshiftDataParametersArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], sqls: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], db_user: Optional[pulumi.Input[_builtins.str]] = ..., secret_manager_arn: Optional[pulumi.Input[_builtins.str]] = ..., statement_name: Optional[pulumi.Input[_builtins.str]] = ..., with_event: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def secret_manager_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipeTargetParametersSagemakerPipelineParametersArgs:
    def __init__(__self__, *, pipeline_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersSagemakerPipelineParametersPipelineParameterArgs]]]] = ...) -> None:
    ...
    def pipeline_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PipeTargetParametersSagemakerPipelineParametersPipelineParameterArgs]]]]): # -> None:
        ...
...
class PipeTargetParametersSqsQueueParametersArgs:
    def __init__(__self__, *, message_deduplication_id: Optional[pulumi.Input[_builtins.str]] = ..., message_group_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def message_deduplication_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
