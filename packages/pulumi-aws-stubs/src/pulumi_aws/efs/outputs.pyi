...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessPointPosixUser', 'AccessPointRootDirectory', 'AccessPointRootDirectoryCreationInfo', 'BackupPolicyBackupPolicy', 'FileSystemLifecyclePolicy', 'FileSystemProtection', 'FileSystemSizeInByte', 'ReplicationConfigurationDestination', 'GetAccessPointPosixUserResult', 'GetAccessPointRootDirectoryResult', 'GetAccessPointRootDirectoryCreationInfoResult', 'GetFileSystemLifecyclePolicyResult', 'GetFileSystemProtectionResult']
@pulumi.output_type
...
class AccessPointRootDirectory(dict):
    ...
    def __init__(__self__, *, creation_info: Optional[outputs.AccessPointRootDirectoryCreationInfo] = ..., path: Optional[_builtins.str] = ...) -> None:
...
class AccessPointRootDirectoryCreationInfo(dict):
    ...
    def __init__(__self__, *, owner_gid: _builtins.int, owner_uid: _builtins.int, permissions: _builtins.str) -> None:
...
class FileSystemLifecyclePolicy(dict):
    ...
    def __init__(__self__, *, transition_to_archive: Optional[_builtins.str] = ..., transition_to_ia: Optional[_builtins.str] = ..., transition_to_primary_storage_class: Optional[_builtins.str] = ...) -> None:
...
class FileSystemProtection(dict):
    ...
    def __init__(__self__, *, replication_overwrite: Optional[_builtins.str] = ...) -> None:
...
class FileSystemSizeInByte(dict):
    ...
    def __init__(__self__, *, value: Optional[_builtins.int] = ..., value_in_ia: Optional[_builtins.int] = ..., value_in_standard: Optional[_builtins.int] = ...) -> None:
...
class ReplicationConfigurationDestination(dict):
    ...
    def __init__(__self__, *, availability_zone_name: Optional[_builtins.str] = ..., file_system_id: Optional[_builtins.str] = ..., kms_key_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class GetAccessPointPosixUserResult(dict):
    def __init__(__self__, *, gid: _builtins.int, secondary_gids: Sequence[_builtins.int], uid: _builtins.int) -> None:
...
class GetAccessPointRootDirectoryResult(dict):
    def __init__(__self__, *, creation_infos: Sequence[outputs.GetAccessPointRootDirectoryCreationInfoResult], path: _builtins.str) -> None:
...
class GetFileSystemLifecyclePolicyResult(dict):
    def __init__(__self__, *, transition_to_archive: _builtins.str, transition_to_ia: _builtins.str, transition_to_primary_storage_class: _builtins.str) -> None:
        ...
