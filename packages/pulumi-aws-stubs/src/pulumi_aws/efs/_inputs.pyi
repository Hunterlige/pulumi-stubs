...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessPointPosixUserArgs', 'AccessPointPosixUserArgsDict', 'AccessPointRootDirectoryArgs', 'AccessPointRootDirectoryArgsDict', 'AccessPointRootDirectoryCreationInfoArgs', 'AccessPointRootDirectoryCreationInfoArgsDict', 'BackupPolicyBackupPolicyArgs', 'BackupPolicyBackupPolicyArgsDict', 'FileSystemLifecyclePolicyArgs', 'FileSystemLifecyclePolicyArgsDict', 'FileSystemProtectionArgs', 'FileSystemProtectionArgsDict', 'FileSystemSizeInByteArgs', 'FileSystemSizeInByteArgsDict', 'ReplicationConfigurationDestinationArgs', 'ReplicationConfigurationDestinationArgsDict']
...
class AccessPointRootDirectoryArgs:
    def __init__(__self__, *, creation_info: Optional[pulumi.Input[AccessPointRootDirectoryCreationInfoArgs]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def creation_info(self, value: Optional[pulumi.Input[AccessPointRootDirectoryCreationInfoArgs]]): # -> None:
        ...
...
class AccessPointRootDirectoryCreationInfoArgs:
    def __init__(__self__, *, owner_gid: pulumi.Input[_builtins.int], owner_uid: pulumi.Input[_builtins.int], permissions: pulumi.Input[_builtins.str]) -> None:
    ...
    @owner_gid.setter
    def owner_gid(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @owner_uid.setter
    def owner_uid(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class FileSystemLifecyclePolicyArgs:
    def __init__(__self__, *, transition_to_archive: Optional[pulumi.Input[_builtins.str]] = ..., transition_to_ia: Optional[pulumi.Input[_builtins.str]] = ..., transition_to_primary_storage_class: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def transition_to_archive(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def transition_to_ia(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def transition_to_primary_storage_class(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FileSystemProtectionArgs:
    def __init__(__self__, *, replication_overwrite: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def replication_overwrite(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FileSystemSizeInByteArgs:
    def __init__(__self__, *, value: Optional[pulumi.Input[_builtins.int]] = ..., value_in_ia: Optional[pulumi.Input[_builtins.int]] = ..., value_in_standard: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @value_in_ia.setter
    def value_in_ia(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def value_in_standard(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ReplicationConfigurationDestinationArgs:
    def __init__(__self__, *, availability_zone_name: Optional[pulumi.Input[_builtins.str]] = ..., file_system_id: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
