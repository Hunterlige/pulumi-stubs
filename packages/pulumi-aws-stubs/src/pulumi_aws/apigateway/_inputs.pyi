...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccountThrottleSettingArgs', 'AccountThrottleSettingArgsDict', 'DocumentationPartLocationArgs', 'DocumentationPartLocationArgsDict', 'DomainNameEndpointConfigurationArgs', 'DomainNameEndpointConfigurationArgsDict', 'DomainNameMutualTlsAuthenticationArgs', 'DomainNameMutualTlsAuthenticationArgsDict', 'IntegrationTlsConfigArgs', 'IntegrationTlsConfigArgsDict', 'MethodSettingsSettingsArgs', 'MethodSettingsSettingsArgsDict', 'RestApiEndpointConfigurationArgs', 'RestApiEndpointConfigurationArgsDict', 'RestApiPutTimeoutsArgs', 'RestApiPutTimeoutsArgsDict', 'StageAccessLogSettingsArgs', 'StageAccessLogSettingsArgsDict', 'StageCanarySettingsArgs', 'StageCanarySettingsArgsDict', 'UsagePlanApiStageArgs', 'UsagePlanApiStageArgsDict', 'UsagePlanApiStageThrottleArgs', 'UsagePlanApiStageThrottleArgsDict', 'UsagePlanQuotaSettingsArgs', 'UsagePlanQuotaSettingsArgsDict', 'UsagePlanThrottleSettingsArgs', 'UsagePlanThrottleSettingsArgsDict']
...
class AccountThrottleSettingArgs:
    def __init__(__self__, *, burst_limit: pulumi.Input[_builtins.int], rate_limit: pulumi.Input[_builtins.float]) -> None:
    ...
    @burst_limit.setter
    def burst_limit(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @rate_limit.setter
    def rate_limit(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
...
class DocumentationPartLocationArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], method: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., status_code: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DomainNameEndpointConfigurationArgs:
    def __init__(__self__, *, types: pulumi.Input[_builtins.str], ip_address_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @types.setter
    def types(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class IntegrationTlsConfigArgs:
    def __init__(__self__, *, insecure_skip_verification: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def insecure_skip_verification(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class MethodSettingsSettingsArgs:
    def __init__(__self__, *, cache_data_encrypted: Optional[pulumi.Input[_builtins.bool]] = ..., cache_ttl_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., caching_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., data_trace_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., logging_level: Optional[pulumi.Input[_builtins.str]] = ..., metrics_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., require_authorization_for_cache_control: Optional[pulumi.Input[_builtins.bool]] = ..., throttling_burst_limit: Optional[pulumi.Input[_builtins.int]] = ..., throttling_rate_limit: Optional[pulumi.Input[_builtins.float]] = ..., unauthorized_cache_control_header_strategy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cache_data_encrypted(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def cache_ttl_in_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def caching_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def metrics_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def require_authorization_for_cache_control(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def unauthorized_cache_control_header_strategy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RestApiEndpointConfigurationArgs:
    def __init__(__self__, *, types: pulumi.Input[_builtins.str], ip_address_type: Optional[pulumi.Input[_builtins.str]] = ..., vpc_endpoint_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def vpc_endpoint_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class StageCanarySettingsArgs:
    def __init__(__self__, *, deployment_id: pulumi.Input[_builtins.str], percent_traffic: Optional[pulumi.Input[_builtins.float]] = ..., stage_variable_overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., use_stage_cache: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def deployment_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def percent_traffic(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def stage_variable_overrides(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def use_stage_cache(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class UsagePlanApiStageArgs:
    def __init__(__self__, *, api_id: pulumi.Input[_builtins.str], stage: pulumi.Input[_builtins.str], throttles: Optional[pulumi.Input[Sequence[pulumi.Input[UsagePlanApiStageThrottleArgs]]]] = ...) -> None:
    ...
    @throttles.setter
    def throttles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[UsagePlanApiStageThrottleArgs]]]]): # -> None:
        ...
...
class UsagePlanApiStageThrottleArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], burst_limit: Optional[pulumi.Input[_builtins.int]] = ..., rate_limit: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @burst_limit.setter
    def burst_limit(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @rate_limit.setter
    def rate_limit(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class UsagePlanQuotaSettingsArgs:
    def __init__(__self__, *, limit: pulumi.Input[_builtins.int], period: pulumi.Input[_builtins.str], offset: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @limit.setter
    def limit(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @offset.setter
    def offset(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class UsagePlanThrottleSettingsArgs:
    def __init__(__self__, *, burst_limit: Optional[pulumi.Input[_builtins.int]] = ..., rate_limit: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
        ...
