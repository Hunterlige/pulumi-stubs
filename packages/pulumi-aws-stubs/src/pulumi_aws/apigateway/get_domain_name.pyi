...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetDomainNameResult', 'AwaitableGetDomainNameResult', 'get_domain_name', 'get_domain_name_output']
@pulumi.output_type
class GetDomainNameResult:
    
    def __init__(__self__, arn=..., certificate_arn=..., certificate_name=..., certificate_upload_date=..., cloudfront_domain_name=..., cloudfront_zone_id=..., domain_name=..., domain_name_id=..., endpoint_access_mode=..., endpoint_configurations=..., id=..., policy=..., region=..., regional_certificate_arn=..., regional_certificate_name=..., regional_domain_name=..., regional_zone_id=..., security_policy=..., tags=...) -> None:
        ...
...
class AwaitableGetDomainNameResult(GetDomainNameResult):
    def __await__(self): # -> Generator[Never, Any, GetDomainNameResult]:
        ...
    


def get_domain_name(domain_name: Optional[_builtins.str] = ..., domain_name_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDomainNameResult:
    
    ...

def get_domain_name_output(domain_name: Optional[pulumi.Input[_builtins.str]] = ..., domain_name_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDomainNameResult]:
