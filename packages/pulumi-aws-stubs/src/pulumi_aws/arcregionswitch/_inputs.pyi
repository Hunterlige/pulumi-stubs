...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['PlanAssociatedAlarmArgs', 'PlanAssociatedAlarmArgsDict', 'PlanTimeoutsArgs', 'PlanTimeoutsArgsDict', 'PlanTriggerArgs', 'PlanTriggerArgsDict', 'PlanTriggerConditionArgs', 'PlanTriggerConditionArgsDict', 'PlanWorkflowArgs', 'PlanWorkflowArgsDict', 'PlanWorkflowStepArgs', 'PlanWorkflowStepArgsDict', 'PlanWorkflowStepArcRoutingControlConfigArgs', 'PlanWorkflowStepArcRoutingControlConfigArgsDict', ..., ..., ..., ..., 'PlanWorkflowStepCustomActionLambdaConfigArgs', 'PlanWorkflowStepCustomActionLambdaConfigArgsDict', 'PlanWorkflowStepCustomActionLambdaConfigLambdaArgs', ..., ..., ..., 'PlanWorkflowStepDocumentDbConfigArgs', 'PlanWorkflowStepDocumentDbConfigArgsDict', 'PlanWorkflowStepDocumentDbConfigUngracefulArgs', 'PlanWorkflowStepDocumentDbConfigUngracefulArgsDict', 'PlanWorkflowStepEc2AsgCapacityIncreaseConfigArgs', ..., ..., ..., ..., ..., 'PlanWorkflowStepEcsCapacityIncreaseConfigArgs', 'PlanWorkflowStepEcsCapacityIncreaseConfigArgsDict', ..., ..., ..., ..., 'PlanWorkflowStepEksResourceScalingConfigArgs', 'PlanWorkflowStepEksResourceScalingConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'PlanWorkflowStepExecutionApprovalConfigArgs', 'PlanWorkflowStepExecutionApprovalConfigArgsDict', 'PlanWorkflowStepGlobalAuroraConfigArgs', 'PlanWorkflowStepGlobalAuroraConfigArgsDict', 'PlanWorkflowStepGlobalAuroraConfigUngracefulArgs', ..., 'PlanWorkflowStepParallelConfigArgs', 'PlanWorkflowStepParallelConfigArgsDict', 'PlanWorkflowStepParallelConfigStepArgs', 'PlanWorkflowStepParallelConfigStepArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'PlanWorkflowStepRegionSwitchPlanConfigArgs', 'PlanWorkflowStepRegionSwitchPlanConfigArgsDict', 'PlanWorkflowStepRoute53HealthCheckConfigArgs', 'PlanWorkflowStepRoute53HealthCheckConfigArgsDict', ..., ...]
...
class PlanAssociatedAlarmArgs:
    def __init__(__self__, *, alarm_type: pulumi.Input[_builtins.str], map_block_key: pulumi.Input[_builtins.str], resource_identifier: pulumi.Input[_builtins.str], cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @alarm_type.setter
    def alarm_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def cross_account_role(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PlanTriggerArgs:
    def __init__(__self__, *, action: pulumi.Input[_builtins.str], min_delay_minutes_between_executions: pulumi.Input[_builtins.int], target_region: pulumi.Input[_builtins.str], conditions: Optional[pulumi.Input[Sequence[pulumi.Input[PlanTriggerConditionArgs]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def min_delay_minutes_between_executions(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def target_region(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanTriggerConditionArgs]]]]): # -> None:
        ...
...
class PlanTriggerConditionArgs:
    def __init__(__self__, *, associated_alarm_name: pulumi.Input[_builtins.str], condition: pulumi.Input[_builtins.str]) -> None:
    ...
    def associated_alarm_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PlanWorkflowArgs:
    def __init__(__self__, *, workflow_target_action: pulumi.Input[_builtins.str], steps: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepArgs]]]] = ..., workflow_description: Optional[pulumi.Input[_builtins.str]] = ..., workflow_target_region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def workflow_target_action(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @steps.setter
    def steps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepArgs]]]]): # -> None:
        ...
    ...
    def workflow_description(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def workflow_target_region(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PlanWorkflowStepArgs:
    def __init__(__self__, *, execution_block_type: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], arc_routing_control_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepArcRoutingControlConfigArgs]]]] = ..., custom_action_lambda_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepCustomActionLambdaConfigArgs]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., document_db_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepDocumentDbConfigArgs]]]] = ..., ec2_asg_capacity_increase_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEc2AsgCapacityIncreaseConfigArgs]]]] = ..., ecs_capacity_increase_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEcsCapacityIncreaseConfigArgs]]]] = ..., eks_resource_scaling_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigArgs]]]] = ..., execution_approval_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepExecutionApprovalConfigArgs]]]] = ..., global_aurora_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepGlobalAuroraConfigArgs]]]] = ..., parallel_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigArgs]]]] = ..., region_switch_plan_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepRegionSwitchPlanConfigArgs]]]] = ..., route53_health_check_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepRoute53HealthCheckConfigArgs]]]] = ...) -> None:
    ...
    def execution_block_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def arc_routing_control_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepArcRoutingControlConfigArgs]]]]): # -> None:
        ...
    ...
    def custom_action_lambda_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepCustomActionLambdaConfigArgs]]]]): # -> None:
        ...
    ...
    def document_db_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepDocumentDbConfigArgs]]]]): # -> None:
        ...
    ...
    def ec2_asg_capacity_increase_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEc2AsgCapacityIncreaseConfigArgs]]]]): # -> None:
        ...
    ...
    def ecs_capacity_increase_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEcsCapacityIncreaseConfigArgs]]]]): # -> None:
        ...
    ...
    def eks_resource_scaling_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigArgs]]]]): # -> None:
        ...
    ...
    def execution_approval_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepExecutionApprovalConfigArgs]]]]): # -> None:
        ...
    ...
    def global_aurora_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepGlobalAuroraConfigArgs]]]]): # -> None:
        ...
    ...
    def parallel_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigArgs]]]]): # -> None:
        ...
    ...
    def region_switch_plan_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepRegionSwitchPlanConfigArgs]]]]): # -> None:
        ...
    ...
    def route53_health_check_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepRoute53HealthCheckConfigArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepArcRoutingControlConfigArgs:
    def __init__(__self__, *, cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ..., region_and_routing_controls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepArcRoutingControlConfigRegionAndRoutingControlArgs]]]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def region_and_routing_controls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepArcRoutingControlConfigRegionAndRoutingControlArgs]]]]): # -> None:
        ...
    ...
    def timeout_minutes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class PlanWorkflowStepArcRoutingControlConfigRegionAndRoutingControlArgs:
    def __init__(__self__, *, region: pulumi.Input[_builtins.str], routing_controls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepArcRoutingControlConfigRegionAndRoutingControlRoutingControlArgs]]]] = ...) -> None:
    ...
    def routing_controls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepArcRoutingControlConfigRegionAndRoutingControlRoutingControlArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepArcRoutingControlConfigRegionAndRoutingControlRoutingControlArgs:
    def __init__(__self__, *, routing_control_arn: pulumi.Input[_builtins.str], state: pulumi.Input[_builtins.str]) -> None:
    ...
    def routing_control_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PlanWorkflowStepCustomActionLambdaConfigArgs:
    def __init__(__self__, *, region_to_run: pulumi.Input[_builtins.str], retry_interval_minutes: pulumi.Input[_builtins.float], lambdas: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepCustomActionLambdaConfigLambdaArgs]]]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungracefuls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepCustomActionLambdaConfigUngracefulArgs]]]] = ...) -> None:
    ...
    def region_to_run(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def retry_interval_minutes(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @lambdas.setter
    def lambdas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepCustomActionLambdaConfigLambdaArgs]]]]): # -> None:
        ...
    ...
    @ungracefuls.setter
    def ungracefuls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepCustomActionLambdaConfigUngracefulArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepCustomActionLambdaConfigLambdaArgs:
    def __init__(__self__, *, arn: pulumi.Input[_builtins.str], cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PlanWorkflowStepDocumentDbConfigArgs:
    def __init__(__self__, *, behavior: pulumi.Input[_builtins.str], database_cluster_arns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], global_cluster_identifier: pulumi.Input[_builtins.str], cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungracefuls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepDocumentDbConfigUngracefulArgs]]]] = ...) -> None:
        ...
    ...
    def database_cluster_arns(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def global_cluster_identifier(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @ungracefuls.setter
    def ungracefuls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepDocumentDbConfigUngracefulArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepDocumentDbConfigUngracefulArgs:
    ...
    @ungraceful.setter
    def ungraceful(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PlanWorkflowStepEc2AsgCapacityIncreaseConfigArgs:
    def __init__(__self__, *, capacity_monitoring_approach: pulumi.Input[_builtins.str], asgs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEc2AsgCapacityIncreaseConfigAsgArgs]]]] = ..., target_percent: Optional[pulumi.Input[_builtins.int]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungraceful: Optional[pulumi.Input[PlanWorkflowStepEc2AsgCapacityIncreaseConfigUngracefulArgs]] = ...) -> None:
    ...
    def capacity_monitoring_approach(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @asgs.setter
    def asgs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEc2AsgCapacityIncreaseConfigAsgArgs]]]]): # -> None:
        ...
    ...
    def target_percent(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @ungraceful.setter
    def ungraceful(self, value: Optional[pulumi.Input[PlanWorkflowStepEc2AsgCapacityIncreaseConfigUngracefulArgs]]): # -> None:
        ...
...
class PlanWorkflowStepEc2AsgCapacityIncreaseConfigUngracefulArgs:
    def __init__(__self__, *, minimum_success_percentage: pulumi.Input[_builtins.int]) -> None:
    ...
    def minimum_success_percentage(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class PlanWorkflowStepEcsCapacityIncreaseConfigArgs:
    def __init__(__self__, *, capacity_monitoring_approach: pulumi.Input[_builtins.str], services: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEcsCapacityIncreaseConfigServiceArgs]]]] = ..., target_percent: Optional[pulumi.Input[_builtins.int]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungraceful: Optional[pulumi.Input[PlanWorkflowStepEcsCapacityIncreaseConfigUngracefulArgs]] = ...) -> None:
    ...
    @services.setter
    def services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEcsCapacityIncreaseConfigServiceArgs]]]]): # -> None:
        ...
    ...
    @ungraceful.setter
    def ungraceful(self, value: Optional[pulumi.Input[PlanWorkflowStepEcsCapacityIncreaseConfigUngracefulArgs]]): # -> None:
        ...
...
class PlanWorkflowStepEcsCapacityIncreaseConfigServiceArgs:
    def __init__(__self__, *, cluster_arn: pulumi.Input[_builtins.str], service_arn: pulumi.Input[_builtins.str], cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PlanWorkflowStepEksResourceScalingConfigArgs:
    def __init__(__self__, *, capacity_monitoring_approach: pulumi.Input[_builtins.str], target_percent: pulumi.Input[_builtins.int], eks_clusters: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigEksClusterArgs]]]] = ..., kubernetes_resource_types: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigKubernetesResourceTypeArgs]]]] = ..., scaling_resources: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigScalingResourceArgs]]]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungracefuls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigUngracefulArgs]]]] = ...) -> None:
    ...
    @target_percent.setter
    def target_percent(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @eks_clusters.setter
    def eks_clusters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigEksClusterArgs]]]]): # -> None:
        ...
    ...
    def kubernetes_resource_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigKubernetesResourceTypeArgs]]]]): # -> None:
        ...
    ...
    def scaling_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigScalingResourceArgs]]]]): # -> None:
        ...
    ...
    @ungracefuls.setter
    def ungracefuls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigUngracefulArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepEksResourceScalingConfigEksClusterArgs:
    def __init__(__self__, *, cluster_arn: pulumi.Input[_builtins.str], cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PlanWorkflowStepEksResourceScalingConfigKubernetesResourceTypeArgs:
    def __init__(__self__, *, api_version: pulumi.Input[_builtins.str], kind: pulumi.Input[_builtins.str]) -> None:
...
class PlanWorkflowStepEksResourceScalingConfigScalingResourceArgs:
    def __init__(__self__, *, namespace: pulumi.Input[_builtins.str], resources: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigScalingResourceResourceArgs]]]] = ...) -> None:
    ...
    @resources.setter
    def resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepEksResourceScalingConfigScalingResourceResourceArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepEksResourceScalingConfigScalingResourceResourceArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], namespace: pulumi.Input[_builtins.str], resource_name: pulumi.Input[_builtins.str], hpa_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @hpa_name.setter
    def hpa_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PlanWorkflowStepExecutionApprovalConfigArgs:
    def __init__(__self__, *, approval_role: pulumi.Input[_builtins.str], timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def approval_role(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PlanWorkflowStepGlobalAuroraConfigArgs:
    def __init__(__self__, *, behavior: pulumi.Input[_builtins.str], database_cluster_arns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], global_cluster_identifier: pulumi.Input[_builtins.str], cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungracefuls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepGlobalAuroraConfigUngracefulArgs]]]] = ...) -> None:
    ...
    @ungracefuls.setter
    def ungracefuls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepGlobalAuroraConfigUngracefulArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigArgs:
    def __init__(__self__, *, steps: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepArgs]]]] = ...) -> None:
    ...
    @steps.setter
    def steps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepArgs:
    def __init__(__self__, *, execution_block_type: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], arc_routing_control_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepArcRoutingControlConfigArgs]]]] = ..., custom_action_lambda_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepCustomActionLambdaConfigArgs]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., document_db_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepDocumentDbConfigArgs]]]] = ..., ec2_asg_capacity_increase_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfigArgs]]]] = ..., ecs_capacity_increase_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfigArgs]]]] = ..., eks_resource_scaling_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigArgs]]]] = ..., execution_approval_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepExecutionApprovalConfigArgs]]]] = ..., global_aurora_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepGlobalAuroraConfigArgs]]]] = ..., region_switch_plan_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepRegionSwitchPlanConfigArgs]]]] = ..., route53_health_check_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigArgs]]]] = ...) -> None:
    ...
    @arc_routing_control_configs.setter
    def arc_routing_control_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepArcRoutingControlConfigArgs]]]]): # -> None:
        ...
    ...
    @custom_action_lambda_configs.setter
    def custom_action_lambda_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepCustomActionLambdaConfigArgs]]]]): # -> None:
        ...
    ...
    @document_db_configs.setter
    def document_db_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepDocumentDbConfigArgs]]]]): # -> None:
        ...
    ...
    @ec2_asg_capacity_increase_configs.setter
    def ec2_asg_capacity_increase_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfigArgs]]]]): # -> None:
        ...
    ...
    @ecs_capacity_increase_configs.setter
    def ecs_capacity_increase_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfigArgs]]]]): # -> None:
        ...
    ...
    @eks_resource_scaling_configs.setter
    def eks_resource_scaling_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigArgs]]]]): # -> None:
        ...
    ...
    @execution_approval_configs.setter
    def execution_approval_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepExecutionApprovalConfigArgs]]]]): # -> None:
        ...
    ...
    @global_aurora_configs.setter
    def global_aurora_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepGlobalAuroraConfigArgs]]]]): # -> None:
        ...
    ...
    @region_switch_plan_configs.setter
    def region_switch_plan_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepRegionSwitchPlanConfigArgs]]]]): # -> None:
        ...
    ...
    @route53_health_check_configs.setter
    def route53_health_check_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepArcRoutingControlConfigArgs:
    def __init__(__self__, *, cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ..., region_and_routing_controls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepArcRoutingControlConfigRegionAndRoutingControlArgs]]]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @region_and_routing_controls.setter
    def region_and_routing_controls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepArcRoutingControlConfigRegionAndRoutingControlArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepArcRoutingControlConfigRegionAndRoutingControlArgs:
    def __init__(__self__, *, region: pulumi.Input[_builtins.str], routing_controls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepArcRoutingControlConfigRegionAndRoutingControlRoutingControlArgs]]]] = ...) -> None:
    ...
    @routing_controls.setter
    def routing_controls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepArcRoutingControlConfigRegionAndRoutingControlRoutingControlArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepCustomActionLambdaConfigArgs:
    def __init__(__self__, *, region_to_run: pulumi.Input[_builtins.str], retry_interval_minutes: pulumi.Input[_builtins.float], lambdas: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepCustomActionLambdaConfigLambdaArgs]]]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungracefuls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepCustomActionLambdaConfigUngracefulArgs]]]] = ...) -> None:
    ...
    @lambdas.setter
    def lambdas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepCustomActionLambdaConfigLambdaArgs]]]]): # -> None:
        ...
    ...
    @ungracefuls.setter
    def ungracefuls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepCustomActionLambdaConfigUngracefulArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepDocumentDbConfigArgs:
    def __init__(__self__, *, behavior: pulumi.Input[_builtins.str], database_cluster_arns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], global_cluster_identifier: pulumi.Input[_builtins.str], cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungracefuls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepDocumentDbConfigUngracefulArgs]]]] = ...) -> None:
        ...
    ...
    @ungracefuls.setter
    def ungracefuls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepDocumentDbConfigUngracefulArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfigArgs:
    def __init__(__self__, *, capacity_monitoring_approach: pulumi.Input[_builtins.str], asgs: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfigAsgArgs]]]] = ..., target_percent: Optional[pulumi.Input[_builtins.int]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungraceful: Optional[pulumi.Input[PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfigUngracefulArgs]] = ...) -> None:
    ...
    @asgs.setter
    def asgs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfigAsgArgs]]]]): # -> None:
        ...
    ...
    @ungraceful.setter
    def ungraceful(self, value: Optional[pulumi.Input[PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfigUngracefulArgs]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfigArgs:
    def __init__(__self__, *, capacity_monitoring_approach: pulumi.Input[_builtins.str], services: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfigServiceArgs]]]] = ..., target_percent: Optional[pulumi.Input[_builtins.int]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungraceful: Optional[pulumi.Input[PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfigUngracefulArgs]] = ...) -> None:
    ...
    @services.setter
    def services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfigServiceArgs]]]]): # -> None:
        ...
    ...
    @ungraceful.setter
    def ungraceful(self, value: Optional[pulumi.Input[PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfigUngracefulArgs]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepEksResourceScalingConfigArgs:
    def __init__(__self__, *, capacity_monitoring_approach: pulumi.Input[_builtins.str], target_percent: pulumi.Input[_builtins.int], eks_clusters: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigEksClusterArgs]]]] = ..., kubernetes_resource_types: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigKubernetesResourceTypeArgs]]]] = ..., scaling_resources: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigScalingResourceArgs]]]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungracefuls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigUngracefulArgs]]]] = ...) -> None:
    ...
    @eks_clusters.setter
    def eks_clusters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigEksClusterArgs]]]]): # -> None:
        ...
    ...
    @kubernetes_resource_types.setter
    def kubernetes_resource_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigKubernetesResourceTypeArgs]]]]): # -> None:
        ...
    ...
    @scaling_resources.setter
    def scaling_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigScalingResourceArgs]]]]): # -> None:
        ...
    ...
    @ungracefuls.setter
    def ungracefuls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigUngracefulArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepEksResourceScalingConfigScalingResourceArgs:
    def __init__(__self__, *, namespace: pulumi.Input[_builtins.str], resources: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigScalingResourceResourceArgs]]]] = ...) -> None:
    ...
    @resources.setter
    def resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepEksResourceScalingConfigScalingResourceResourceArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepGlobalAuroraConfigArgs:
    def __init__(__self__, *, behavior: pulumi.Input[_builtins.str], database_cluster_arns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], global_cluster_identifier: pulumi.Input[_builtins.str], cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ..., ungracefuls: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepGlobalAuroraConfigUngracefulArgs]]]] = ...) -> None:
    ...
    @ungracefuls.setter
    def ungracefuls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepGlobalAuroraConfigUngracefulArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigArgs:
    def __init__(__self__, *, hosted_zone_id: pulumi.Input[_builtins.str], record_name: pulumi.Input[_builtins.str], cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ..., record_sets: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigRecordSetArgs]]]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @record_name.setter
    def record_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @record_sets.setter
    def record_sets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigRecordSetArgs]]]]): # -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigRecordSetArgs:
    def __init__(__self__, *, record_set_identifier: pulumi.Input[_builtins.str], region: pulumi.Input[_builtins.str]) -> None:
    ...
    def record_set_identifier(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PlanWorkflowStepRoute53HealthCheckConfigArgs:
    def __init__(__self__, *, hosted_zone_id: pulumi.Input[_builtins.str], record_name: pulumi.Input[_builtins.str], cross_account_role: Optional[pulumi.Input[_builtins.str]] = ..., external_id: Optional[pulumi.Input[_builtins.str]] = ..., record_sets: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepRoute53HealthCheckConfigRecordSetArgs]]]] = ..., timeout_minutes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @record_sets.setter
    def record_sets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PlanWorkflowStepRoute53HealthCheckConfigRecordSetArgs]]]]): # -> None:
        ...
