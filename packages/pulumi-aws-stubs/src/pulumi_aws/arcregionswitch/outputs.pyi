...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['PlanAssociatedAlarm', 'PlanTimeouts', 'PlanTrigger', 'PlanTriggerCondition', 'PlanWorkflow', 'PlanWorkflowStep', 'PlanWorkflowStepArcRoutingControlConfig', ..., ..., 'PlanWorkflowStepCustomActionLambdaConfig', 'PlanWorkflowStepCustomActionLambdaConfigLambda', 'PlanWorkflowStepCustomActionLambdaConfigUngraceful', 'PlanWorkflowStepDocumentDbConfig', 'PlanWorkflowStepDocumentDbConfigUngraceful', 'PlanWorkflowStepEc2AsgCapacityIncreaseConfig', 'PlanWorkflowStepEc2AsgCapacityIncreaseConfigAsg', ..., 'PlanWorkflowStepEcsCapacityIncreaseConfig', 'PlanWorkflowStepEcsCapacityIncreaseConfigService', ..., 'PlanWorkflowStepEksResourceScalingConfig', 'PlanWorkflowStepEksResourceScalingConfigEksCluster', ..., ..., ..., 'PlanWorkflowStepEksResourceScalingConfigUngraceful', 'PlanWorkflowStepExecutionApprovalConfig', 'PlanWorkflowStepGlobalAuroraConfig', 'PlanWorkflowStepGlobalAuroraConfigUngraceful', 'PlanWorkflowStepParallelConfig', 'PlanWorkflowStepParallelConfigStep', ..., ..., ..., ..., ..., ..., 'PlanWorkflowStepParallelConfigStepDocumentDbConfig', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'PlanWorkflowStepRegionSwitchPlanConfig', 'PlanWorkflowStepRoute53HealthCheckConfig', 'PlanWorkflowStepRoute53HealthCheckConfigRecordSet', 'GetRoute53HealthChecksHealthCheckResult']
@pulumi.output_type
class PlanAssociatedAlarm(dict):
    ...
    def __init__(__self__, *, alarm_type: _builtins.str, map_block_key: _builtins.str, resource_identifier: _builtins.str, cross_account_role: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ...) -> None:
...
class PlanTrigger(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, min_delay_minutes_between_executions: _builtins.int, target_region: _builtins.str, conditions: Optional[Sequence[outputs.PlanTriggerCondition]] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class PlanTriggerCondition(dict):
    ...
    def __init__(__self__, *, associated_alarm_name: _builtins.str, condition: _builtins.str) -> None:
...
class PlanWorkflow(dict):
    ...
    def __init__(__self__, *, workflow_target_action: _builtins.str, steps: Optional[Sequence[outputs.PlanWorkflowStep]] = ..., workflow_description: Optional[_builtins.str] = ..., workflow_target_region: Optional[_builtins.str] = ...) -> None:
...
class PlanWorkflowStep(dict):
    ...
    def __init__(__self__, *, execution_block_type: _builtins.str, name: _builtins.str, arc_routing_control_configs: Optional[Sequence[outputs.PlanWorkflowStepArcRoutingControlConfig]] = ..., custom_action_lambda_configs: Optional[Sequence[outputs.PlanWorkflowStepCustomActionLambdaConfig]] = ..., description: Optional[_builtins.str] = ..., document_db_configs: Optional[Sequence[outputs.PlanWorkflowStepDocumentDbConfig]] = ..., ec2_asg_capacity_increase_configs: Optional[Sequence[outputs.PlanWorkflowStepEc2AsgCapacityIncreaseConfig]] = ..., ecs_capacity_increase_configs: Optional[Sequence[outputs.PlanWorkflowStepEcsCapacityIncreaseConfig]] = ..., eks_resource_scaling_configs: Optional[Sequence[outputs.PlanWorkflowStepEksResourceScalingConfig]] = ..., execution_approval_configs: Optional[Sequence[outputs.PlanWorkflowStepExecutionApprovalConfig]] = ..., global_aurora_configs: Optional[Sequence[outputs.PlanWorkflowStepGlobalAuroraConfig]] = ..., parallel_configs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfig]] = ..., region_switch_plan_configs: Optional[Sequence[outputs.PlanWorkflowStepRegionSwitchPlanConfig]] = ..., route53_health_check_configs: Optional[Sequence[outputs.PlanWorkflowStepRoute53HealthCheckConfig]] = ...) -> None:
...
class PlanWorkflowStepArcRoutingControlConfig(dict):
    ...
    def __init__(__self__, *, cross_account_role: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ..., region_and_routing_controls: Optional[Sequence[outputs.PlanWorkflowStepArcRoutingControlConfigRegionAndRoutingControl]] = ..., timeout_minutes: Optional[_builtins.int] = ...) -> None:
...
class PlanWorkflowStepArcRoutingControlConfigRegionAndRoutingControl(dict):
    ...
    def __init__(__self__, *, region: _builtins.str, routing_controls: Optional[Sequence[outputs.PlanWorkflowStepArcRoutingControlConfigRegionAndRoutingControlRoutingControl]] = ...) -> None:
...
class PlanWorkflowStepArcRoutingControlConfigRegionAndRoutingControlRoutingControl(dict):
    ...
    def __init__(__self__, *, routing_control_arn: _builtins.str, state: _builtins.str) -> None:
...
class PlanWorkflowStepCustomActionLambdaConfig(dict):
    ...
    def __init__(__self__, *, region_to_run: _builtins.str, retry_interval_minutes: _builtins.float, lambdas: Optional[Sequence[outputs.PlanWorkflowStepCustomActionLambdaConfigLambda]] = ..., timeout_minutes: Optional[_builtins.int] = ..., ungracefuls: Optional[Sequence[outputs.PlanWorkflowStepCustomActionLambdaConfigUngraceful]] = ...) -> None:
...
class PlanWorkflowStepCustomActionLambdaConfigLambda(dict):
    ...
    def __init__(__self__, *, arn: _builtins.str, cross_account_role: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ...) -> None:
...
class PlanWorkflowStepDocumentDbConfig(dict):
    ...
    def __init__(__self__, *, behavior: _builtins.str, database_cluster_arns: Sequence[_builtins.str], global_cluster_identifier: _builtins.str, cross_account_role: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ..., timeout_minutes: Optional[_builtins.int] = ..., ungracefuls: Optional[Sequence[outputs.PlanWorkflowStepDocumentDbConfigUngraceful]] = ...) -> None:
        ...
...
class PlanWorkflowStepEc2AsgCapacityIncreaseConfig(dict):
    ...
    def __init__(__self__, *, capacity_monitoring_approach: _builtins.str, asgs: Optional[Sequence[outputs.PlanWorkflowStepEc2AsgCapacityIncreaseConfigAsg]] = ..., target_percent: Optional[_builtins.int] = ..., timeout_minutes: Optional[_builtins.int] = ..., ungraceful: Optional[outputs.PlanWorkflowStepEc2AsgCapacityIncreaseConfigUngraceful] = ...) -> None:
...
class PlanWorkflowStepEcsCapacityIncreaseConfig(dict):
    ...
    def __init__(__self__, *, capacity_monitoring_approach: _builtins.str, services: Optional[Sequence[outputs.PlanWorkflowStepEcsCapacityIncreaseConfigService]] = ..., target_percent: Optional[_builtins.int] = ..., timeout_minutes: Optional[_builtins.int] = ..., ungraceful: Optional[outputs.PlanWorkflowStepEcsCapacityIncreaseConfigUngraceful] = ...) -> None:
...
class PlanWorkflowStepEcsCapacityIncreaseConfigService(dict):
    ...
    def __init__(__self__, *, cluster_arn: _builtins.str, service_arn: _builtins.str, cross_account_role: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ...) -> None:
...
class PlanWorkflowStepEksResourceScalingConfig(dict):
    ...
    def __init__(__self__, *, capacity_monitoring_approach: _builtins.str, target_percent: _builtins.int, eks_clusters: Optional[Sequence[outputs.PlanWorkflowStepEksResourceScalingConfigEksCluster]] = ..., kubernetes_resource_types: Optional[Sequence[outputs.PlanWorkflowStepEksResourceScalingConfigKubernetesResourceType]] = ..., scaling_resources: Optional[Sequence[outputs.PlanWorkflowStepEksResourceScalingConfigScalingResource]] = ..., timeout_minutes: Optional[_builtins.int] = ..., ungracefuls: Optional[Sequence[outputs.PlanWorkflowStepEksResourceScalingConfigUngraceful]] = ...) -> None:
...
class PlanWorkflowStepEksResourceScalingConfigEksCluster(dict):
    ...
    def __init__(__self__, *, cluster_arn: _builtins.str, cross_account_role: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ...) -> None:
...
class PlanWorkflowStepEksResourceScalingConfigKubernetesResourceType(dict):
    ...
    def __init__(__self__, *, api_version: _builtins.str, kind: _builtins.str) -> None:
...
class PlanWorkflowStepEksResourceScalingConfigScalingResource(dict):
    def __init__(__self__, *, namespace: _builtins.str, resources: Optional[Sequence[outputs.PlanWorkflowStepEksResourceScalingConfigScalingResourceResource]] = ...) -> None:
...
class PlanWorkflowStepEksResourceScalingConfigScalingResourceResource(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, namespace: _builtins.str, resource_name: _builtins.str, hpa_name: Optional[_builtins.str] = ...) -> None:
...
class PlanWorkflowStepExecutionApprovalConfig(dict):
    ...
    def __init__(__self__, *, approval_role: _builtins.str, timeout_minutes: Optional[_builtins.int] = ...) -> None:
...
class PlanWorkflowStepParallelConfig(dict):
    def __init__(__self__, *, steps: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStep]] = ...) -> None:
...
class PlanWorkflowStepParallelConfigStep(dict):
    ...
    def __init__(__self__, *, execution_block_type: _builtins.str, name: _builtins.str, arc_routing_control_configs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepArcRoutingControlConfig]] = ..., custom_action_lambda_configs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepCustomActionLambdaConfig]] = ..., description: Optional[_builtins.str] = ..., document_db_configs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepDocumentDbConfig]] = ..., ec2_asg_capacity_increase_configs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfig]] = ..., ecs_capacity_increase_configs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfig]] = ..., eks_resource_scaling_configs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepEksResourceScalingConfig]] = ..., execution_approval_configs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepExecutionApprovalConfig]] = ..., global_aurora_configs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepGlobalAuroraConfig]] = ..., region_switch_plan_configs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepRegionSwitchPlanConfig]] = ..., route53_health_check_configs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfig]] = ...) -> None:
...
class PlanWorkflowStepParallelConfigStepArcRoutingControlConfig(dict):
    ...
    def __init__(__self__, *, cross_account_role: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ..., region_and_routing_controls: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepArcRoutingControlConfigRegionAndRoutingControl]] = ..., timeout_minutes: Optional[_builtins.int] = ...) -> None:
...
class PlanWorkflowStepParallelConfigStepArcRoutingControlConfigRegionAndRoutingControl(dict):
    ...
    def __init__(__self__, *, region: _builtins.str, routing_controls: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepArcRoutingControlConfigRegionAndRoutingControlRoutingControl]] = ...) -> None:
...
class PlanWorkflowStepParallelConfigStepCustomActionLambdaConfig(dict):
    ...
    def __init__(__self__, *, region_to_run: _builtins.str, retry_interval_minutes: _builtins.float, lambdas: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepCustomActionLambdaConfigLambda]] = ..., timeout_minutes: Optional[_builtins.int] = ..., ungracefuls: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepCustomActionLambdaConfigUngraceful]] = ...) -> None:
...
class PlanWorkflowStepParallelConfigStepDocumentDbConfig(dict):
    ...
    def __init__(__self__, *, behavior: _builtins.str, database_cluster_arns: Sequence[_builtins.str], global_cluster_identifier: _builtins.str, cross_account_role: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ..., timeout_minutes: Optional[_builtins.int] = ..., ungracefuls: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepDocumentDbConfigUngraceful]] = ...) -> None:
        ...
...
class PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfig(dict):
    ...
    def __init__(__self__, *, capacity_monitoring_approach: _builtins.str, asgs: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfigAsg]] = ..., target_percent: Optional[_builtins.int] = ..., timeout_minutes: Optional[_builtins.int] = ..., ungraceful: Optional[outputs.PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfigUngraceful] = ...) -> None:
...
class PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfig(dict):
    ...
    def __init__(__self__, *, capacity_monitoring_approach: _builtins.str, services: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfigService]] = ..., target_percent: Optional[_builtins.int] = ..., timeout_minutes: Optional[_builtins.int] = ..., ungraceful: Optional[outputs.PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfigUngraceful] = ...) -> None:
...
class PlanWorkflowStepParallelConfigStepEksResourceScalingConfig(dict):
    ...
    def __init__(__self__, *, capacity_monitoring_approach: _builtins.str, target_percent: _builtins.int, eks_clusters: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepEksResourceScalingConfigEksCluster]] = ..., kubernetes_resource_types: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepEksResourceScalingConfigKubernetesResourceType]] = ..., scaling_resources: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepEksResourceScalingConfigScalingResource]] = ..., timeout_minutes: Optional[_builtins.int] = ..., ungracefuls: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepEksResourceScalingConfigUngraceful]] = ...) -> None:
...
class PlanWorkflowStepParallelConfigStepEksResourceScalingConfigScalingResource(dict):
    def __init__(__self__, *, namespace: _builtins.str, resources: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepEksResourceScalingConfigScalingResourceResource]] = ...) -> None:
...
class PlanWorkflowStepParallelConfigStepGlobalAuroraConfig(dict):
    ...
    def __init__(__self__, *, behavior: _builtins.str, database_cluster_arns: Sequence[_builtins.str], global_cluster_identifier: _builtins.str, cross_account_role: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ..., timeout_minutes: Optional[_builtins.int] = ..., ungracefuls: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepGlobalAuroraConfigUngraceful]] = ...) -> None:
...
class PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfig(dict):
    ...
    def __init__(__self__, *, hosted_zone_id: _builtins.str, record_name: _builtins.str, cross_account_role: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ..., record_sets: Optional[Sequence[outputs.PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigRecordSet]] = ..., timeout_minutes: Optional[_builtins.int] = ...) -> None:
...
class PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigRecordSet(dict):
    ...
    def __init__(__self__, *, record_set_identifier: _builtins.str, region: _builtins.str) -> None:
...
class PlanWorkflowStepRoute53HealthCheckConfig(dict):
    ...
    def __init__(__self__, *, hosted_zone_id: _builtins.str, record_name: _builtins.str, cross_account_role: Optional[_builtins.str] = ..., external_id: Optional[_builtins.str] = ..., record_sets: Optional[Sequence[outputs.PlanWorkflowStepRoute53HealthCheckConfigRecordSet]] = ..., timeout_minutes: Optional[_builtins.int] = ...) -> None:
...
class GetRoute53HealthChecksHealthCheckResult(dict):
    def __init__(__self__, *, health_check_id: _builtins.str, hosted_zone_id: _builtins.str, record_name: _builtins.str, region: _builtins.str, status: _builtins.str) -> None:
