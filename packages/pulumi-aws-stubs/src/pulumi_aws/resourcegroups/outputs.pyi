...
class GroupConfiguration(dict):
    def __init__(__self__, *, type: _builtins.str, parameters: Optional[Sequence[outputs.GroupConfigurationParameter]] = ...) -> None:
...
class GroupResourceQuery(dict):
    def __init__(__self__, *, query: _builtins.str, type: Optional[_builtins.str] = ...) -> None:
