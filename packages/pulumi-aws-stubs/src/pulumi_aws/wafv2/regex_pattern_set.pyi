...
class RegexPatternSetArgs:
    def __init__(
        ...
        *,
        ...
        regular_expressions: Optional[
            pulumi.Input[Sequence[pulumi.Input[RegexPatternSetRegularExpressionArgs]]]
        ] = ...,
...
@pulumi.type_token("aws:wafv2/regexPatternSet:RegexPatternSet")
class RegexPatternSet(pulumi.CustomResource):
    ...
    def regular_expressions(
        ...
        Optional[Sequence[outputs.RegexPatternSetRegularExpression]]
    ]: ...
    @_builtins.property
    @pulumi.getter
