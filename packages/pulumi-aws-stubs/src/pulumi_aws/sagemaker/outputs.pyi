...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppImageConfigCodeEditorAppImageConfig', ..., ..., 'AppImageConfigJupyterLabImageConfig', 'AppImageConfigJupyterLabImageConfigContainerConfig', ..., 'AppImageConfigKernelGatewayImageConfig', ..., 'AppImageConfigKernelGatewayImageConfigKernelSpec', 'AppResourceSpec', 'CodeRepositoryGitConfig', ..., 'DataQualityJobDefinitionDataQualityBaselineConfig', ..., ..., 'DataQualityJobDefinitionDataQualityJobInput', ..., ..., ..., ..., ..., 'DataQualityJobDefinitionDataQualityJobOutputConfig', ..., ..., 'DataQualityJobDefinitionJobResources', 'DataQualityJobDefinitionJobResourcesClusterConfig', 'DataQualityJobDefinitionNetworkConfig', 'DataQualityJobDefinitionNetworkConfigVpcConfig', 'DataQualityJobDefinitionStoppingCondition', 'DeviceDevice', 'DeviceFleetOutputConfig', 'DomainDefaultSpaceSettings', 'DomainDefaultSpaceSettingsCustomFileSystemConfig', ..., 'DomainDefaultSpaceSettingsCustomPosixUserConfig', 'DomainDefaultSpaceSettingsJupyterLabAppSettings', ..., ..., ..., ..., ..., ..., 'DomainDefaultSpaceSettingsJupyterServerAppSettings', ..., ..., 'DomainDefaultSpaceSettingsKernelGatewayAppSettings', ..., ..., 'DomainDefaultSpaceSettingsSpaceStorageSettings', ..., 'DomainDefaultUserSettings', 'DomainDefaultUserSettingsCanvasAppSettings', ..., ..., ..., ..., ..., ..., ..., ..., 'DomainDefaultUserSettingsCodeEditorAppSettings', ..., ..., ..., ..., 'DomainDefaultUserSettingsCustomFileSystemConfig', ..., 'DomainDefaultUserSettingsCustomPosixUserConfig', 'DomainDefaultUserSettingsJupyterLabAppSettings', ..., ..., ..., ..., ..., ..., 'DomainDefaultUserSettingsJupyterServerAppSettings', ..., ..., 'DomainDefaultUserSettingsKernelGatewayAppSettings', ..., ..., 'DomainDefaultUserSettingsRSessionAppSettings', ..., ..., ..., 'DomainDefaultUserSettingsSharingSettings', 'DomainDefaultUserSettingsSpaceStorageSettings', ..., 'DomainDefaultUserSettingsStudioWebPortalSettings', 'DomainDefaultUserSettingsTensorBoardAppSettings', ..., 'DomainDomainSettings', 'DomainDomainSettingsDockerSettings', 'DomainDomainSettingsRStudioServerProDomainSettings', ..., ..., 'DomainRetentionPolicy', 'EndpointConfigurationAsyncInferenceConfig', ..., ..., ..., 'EndpointConfigurationDataCaptureConfig', ..., ..., 'EndpointConfigurationProductionVariant', ..., ..., ..., ..., 'EndpointConfigurationShadowProductionVariant', ..., ..., ..., ..., 'EndpointDeploymentConfig', 'EndpointDeploymentConfigAutoRollbackConfiguration', ..., 'EndpointDeploymentConfigBlueGreenUpdatePolicy', ..., ..., ..., 'EndpointDeploymentConfigRollingUpdatePolicy', ..., ..., 'FeatureGroupFeatureDefinition', 'FeatureGroupFeatureDefinitionCollectionConfig', ..., 'FeatureGroupOfflineStoreConfig', 'FeatureGroupOfflineStoreConfigDataCatalogConfig', 'FeatureGroupOfflineStoreConfigS3StorageConfig', 'FeatureGroupOnlineStoreConfig', 'FeatureGroupOnlineStoreConfigSecurityConfig', 'FeatureGroupOnlineStoreConfigTtlDuration', 'FeatureGroupThroughputConfig', 'FlowDefinitionHumanLoopActivationConfig', ..., 'FlowDefinitionHumanLoopConfig', ..., ..., 'FlowDefinitionHumanLoopRequestSource', 'FlowDefinitionOutputConfig', 'HubS3StorageConfig', 'HumanTaskUIUiTemplate', 'LabelingJobHumanTaskConfig', ..., 'LabelingJobHumanTaskConfigPublicWorkforceTaskPrice', ..., 'LabelingJobHumanTaskConfigUiConfig', 'LabelingJobInputConfig', 'LabelingJobInputConfigDataAttributes', 'LabelingJobInputConfigDataSource', 'LabelingJobInputConfigDataSourceS3DataSource', 'LabelingJobInputConfigDataSourceSnsDataSource', 'LabelingJobLabelCounter', 'LabelingJobLabelingJobAlgorithmsConfig', ..., ..., 'LabelingJobOutputConfig', 'LabelingJobStoppingCondition', 'MlflowAppTimeouts', 'ModelCardExportJobExportArtifact', 'ModelCardExportJobOutputConfig', 'ModelCardExportJobTimeouts', 'ModelCardSecurityConfig', 'ModelCardTimeouts', 'ModelContainer', 'ModelContainerAdditionalModelDataSource', ..., ..., 'ModelContainerImageConfig', 'ModelContainerImageConfigRepositoryAuthConfig', 'ModelContainerModelDataSource', 'ModelContainerModelDataSourceS3DataSource', ..., 'ModelContainerMultiModelConfig', 'ModelInferenceExecutionConfig', 'ModelPrimaryContainer', 'ModelPrimaryContainerAdditionalModelDataSource', ..., ..., 'ModelPrimaryContainerImageConfig', ..., 'ModelPrimaryContainerModelDataSource', 'ModelPrimaryContainerModelDataSourceS3DataSource', ..., 'ModelPrimaryContainerMultiModelConfig', 'ModelVpcConfig', 'MonitoringScheduleMonitoringScheduleConfig', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'PipelineParallelismConfiguration', 'PipelinePipelineDefinitionS3Location', 'ProjectServiceCatalogProvisioningDetails', ..., 'SpaceOwnershipSettings', 'SpaceSpaceSettings', 'SpaceSpaceSettingsCodeEditorAppSettings', ..., ..., ..., 'SpaceSpaceSettingsCustomFileSystem', 'SpaceSpaceSettingsCustomFileSystemEfsFileSystem', 'SpaceSpaceSettingsJupyterLabAppSettings', ..., ..., ..., ..., 'SpaceSpaceSettingsJupyterServerAppSettings', ..., ..., 'SpaceSpaceSettingsKernelGatewayAppSettings', ..., ..., 'SpaceSpaceSettingsSpaceStorageSettings', ..., 'SpaceSpaceSharingSettings', 'UserProfileUserSettings', 'UserProfileUserSettingsCanvasAppSettings', ..., ..., ..., ..., ..., ..., ..., ..., 'UserProfileUserSettingsCodeEditorAppSettings', ..., ..., ..., ..., 'UserProfileUserSettingsCustomFileSystemConfig', ..., 'UserProfileUserSettingsCustomPosixUserConfig', 'UserProfileUserSettingsJupyterLabAppSettings', ..., ..., ..., ..., ..., ..., 'UserProfileUserSettingsJupyterServerAppSettings', ..., ..., 'UserProfileUserSettingsKernelGatewayAppSettings', ..., ..., 'UserProfileUserSettingsRSessionAppSettings', ..., ..., 'UserProfileUserSettingsRStudioServerProAppSettings', 'UserProfileUserSettingsSharingSettings', 'UserProfileUserSettingsSpaceStorageSettings', ..., 'UserProfileUserSettingsStudioWebPortalSettings', 'UserProfileUserSettingsTensorBoardAppSettings', ..., 'WorkforceCognitoConfig', 'WorkforceOidcConfig', 'WorkforceSourceIpConfig', 'WorkforceWorkforceVpcConfig', 'WorkteamMemberDefinition', 'WorkteamMemberDefinitionCognitoMemberDefinition', 'WorkteamMemberDefinitionOidcMemberDefinition', 'WorkteamNotificationConfiguration', 'WorkteamWorkerAccessConfiguration', 'WorkteamWorkerAccessConfigurationS3Presign', ...]
@pulumi.output_type
class AppImageConfigCodeEditorAppImageConfig(dict):
    ...
    def __init__(__self__, *, container_config: Optional[outputs.AppImageConfigCodeEditorAppImageConfigContainerConfig] = ..., file_system_config: Optional[outputs.AppImageConfigCodeEditorAppImageConfigFileSystemConfig] = ...) -> None:
...
class AppImageConfigCodeEditorAppImageConfigContainerConfig(dict):
    ...
    def __init__(__self__, *, container_arguments: Optional[Sequence[_builtins.str]] = ..., container_entrypoints: Optional[Sequence[_builtins.str]] = ..., container_environment_variables: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class AppImageConfigCodeEditorAppImageConfigFileSystemConfig(dict):
    ...
    def __init__(__self__, *, default_gid: Optional[_builtins.int] = ..., default_uid: Optional[_builtins.int] = ..., mount_path: Optional[_builtins.str] = ...) -> None:
...
class AppImageConfigJupyterLabImageConfig(dict):
    ...
    def __init__(__self__, *, container_config: Optional[outputs.AppImageConfigJupyterLabImageConfigContainerConfig] = ..., file_system_config: Optional[outputs.AppImageConfigJupyterLabImageConfigFileSystemConfig] = ...) -> None:
...
class AppImageConfigKernelGatewayImageConfig(dict):
    ...
    def __init__(__self__, *, kernel_specs: Sequence[outputs.AppImageConfigKernelGatewayImageConfigKernelSpec], file_system_config: Optional[outputs.AppImageConfigKernelGatewayImageConfigFileSystemConfig] = ...) -> None:
...
class AppImageConfigKernelGatewayImageConfigKernelSpec(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, display_name: Optional[_builtins.str] = ...) -> None:
...
class AppResourceSpec(dict):
    ...
    def __init__(__self__, *, instance_type: Optional[_builtins.str] = ..., lifecycle_config_arn: Optional[_builtins.str] = ..., sagemaker_image_arn: Optional[_builtins.str] = ..., sagemaker_image_version_alias: Optional[_builtins.str] = ..., sagemaker_image_version_arn: Optional[_builtins.str] = ...) -> None:
...
class CodeRepositoryGitConfig(dict):
    ...
    def __init__(__self__, *, repository_url: _builtins.str, branch: Optional[_builtins.str] = ..., secret_arn: Optional[_builtins.str] = ...) -> None:
...
class DataQualityJobDefinitionDataQualityAppSpecification(dict):
    ...
    def __init__(__self__, *, image_uri: _builtins.str, environment: Optional[Mapping[str, _builtins.str]] = ..., post_analytics_processor_source_uri: Optional[_builtins.str] = ..., record_preprocessor_source_uri: Optional[_builtins.str] = ...) -> None:
...
class DataQualityJobDefinitionDataQualityBaselineConfig(dict):
    ...
    def __init__(__self__, *, constraints_resource: Optional[outputs.DataQualityJobDefinitionDataQualityBaselineConfigConstraintsResource] = ..., statistics_resource: Optional[outputs.DataQualityJobDefinitionDataQualityBaselineConfigStatisticsResource] = ...) -> None:
...
class DataQualityJobDefinitionDataQualityJobInput(dict):
    ...
    def __init__(__self__, *, batch_transform_input: Optional[outputs.DataQualityJobDefinitionDataQualityJobInputBatchTransformInput] = ..., endpoint_input: Optional[outputs.DataQualityJobDefinitionDataQualityJobInputEndpointInput] = ...) -> None:
...
class DataQualityJobDefinitionDataQualityJobInputBatchTransformInput(dict):
    ...
    def __init__(__self__, *, data_captured_destination_s3_uri: _builtins.str, dataset_format: outputs.DataQualityJobDefinitionDataQualityJobInputBatchTransformInputDatasetFormat, local_path: Optional[_builtins.str] = ..., s3_data_distribution_type: Optional[_builtins.str] = ..., s3_input_mode: Optional[_builtins.str] = ...) -> None:
...
class DataQualityJobDefinitionDataQualityJobInputBatchTransformInputDatasetFormat(dict):
    def __init__(__self__, *, csv: Optional[outputs.DataQualityJobDefinitionDataQualityJobInputBatchTransformInputDatasetFormatCsv] = ..., json: Optional[outputs.DataQualityJobDefinitionDataQualityJobInputBatchTransformInputDatasetFormatJson] = ...) -> None:
...
class DataQualityJobDefinitionDataQualityJobInputEndpointInput(dict):
    ...
    def __init__(__self__, *, endpoint_name: _builtins.str, local_path: Optional[_builtins.str] = ..., s3_data_distribution_type: Optional[_builtins.str] = ..., s3_input_mode: Optional[_builtins.str] = ...) -> None:
...
class DataQualityJobDefinitionDataQualityJobOutputConfig(dict):
    ...
    def __init__(__self__, *, monitoring_outputs: outputs.DataQualityJobDefinitionDataQualityJobOutputConfigMonitoringOutputs, kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class DataQualityJobDefinitionDataQualityJobOutputConfigMonitoringOutputs(dict):
    ...
    def __init__(__self__, *, s3_output: outputs.DataQualityJobDefinitionDataQualityJobOutputConfigMonitoringOutputsS3Output) -> None:
...
class DataQualityJobDefinitionDataQualityJobOutputConfigMonitoringOutputsS3Output(dict):
    ...
    def __init__(__self__, *, s3_uri: _builtins.str, local_path: Optional[_builtins.str] = ..., s3_upload_mode: Optional[_builtins.str] = ...) -> None:
...
class DataQualityJobDefinitionJobResources(dict):
    ...
    def __init__(__self__, *, cluster_config: outputs.DataQualityJobDefinitionJobResourcesClusterConfig) -> None:
...
class DataQualityJobDefinitionJobResourcesClusterConfig(dict):
    ...
    def __init__(__self__, *, instance_count: _builtins.int, instance_type: _builtins.str, volume_size_in_gb: _builtins.int, volume_kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class DataQualityJobDefinitionNetworkConfig(dict):
    ...
    def __init__(__self__, *, enable_inter_container_traffic_encryption: Optional[_builtins.bool] = ..., enable_network_isolation: Optional[_builtins.bool] = ..., vpc_config: Optional[outputs.DataQualityJobDefinitionNetworkConfigVpcConfig] = ...) -> None:
...
class DataQualityJobDefinitionNetworkConfigVpcConfig(dict):
    ...
    def __init__(__self__, *, security_group_ids: Sequence[_builtins.str], subnets: Sequence[_builtins.str]) -> None:
...
class DataQualityJobDefinitionStoppingCondition(dict):
    ...
    def __init__(__self__, *, max_runtime_in_seconds: Optional[_builtins.int] = ...) -> None:
...
class DeviceDevice(dict):
    ...
    def __init__(__self__, *, device_name: _builtins.str, description: Optional[_builtins.str] = ..., iot_thing_name: Optional[_builtins.str] = ...) -> None:
...
class DeviceFleetOutputConfig(dict):
    ...
    def __init__(__self__, *, s3_output_location: _builtins.str, kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class DomainDefaultSpaceSettings(dict):
    ...
    def __init__(__self__, *, execution_role: _builtins.str, custom_file_system_configs: Optional[Sequence[outputs.DomainDefaultSpaceSettingsCustomFileSystemConfig]] = ..., custom_posix_user_config: Optional[outputs.DomainDefaultSpaceSettingsCustomPosixUserConfig] = ..., jupyter_lab_app_settings: Optional[outputs.DomainDefaultSpaceSettingsJupyterLabAppSettings] = ..., jupyter_server_app_settings: Optional[outputs.DomainDefaultSpaceSettingsJupyterServerAppSettings] = ..., kernel_gateway_app_settings: Optional[outputs.DomainDefaultSpaceSettingsKernelGatewayAppSettings] = ..., security_groups: Optional[Sequence[_builtins.str]] = ..., space_storage_settings: Optional[outputs.DomainDefaultSpaceSettingsSpaceStorageSettings] = ...) -> None:
...
class DomainDefaultSpaceSettingsCustomFileSystemConfig(dict):
    ...
    def __init__(__self__, *, efs_file_system_config: Optional[outputs.DomainDefaultSpaceSettingsCustomFileSystemConfigEfsFileSystemConfig] = ...) -> None:
...
class DomainDefaultSpaceSettingsCustomFileSystemConfigEfsFileSystemConfig(dict):
    ...
    def __init__(__self__, *, file_system_id: _builtins.str, file_system_path: _builtins.str) -> None:
...
class DomainDefaultSpaceSettingsJupyterLabAppSettings(dict):
    ...
    def __init__(__self__, *, app_lifecycle_management: Optional[outputs.DomainDefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagement] = ..., built_in_lifecycle_config_arn: Optional[_builtins.str] = ..., code_repositories: Optional[Sequence[outputs.DomainDefaultSpaceSettingsJupyterLabAppSettingsCodeRepository]] = ..., custom_images: Optional[Sequence[outputs.DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImage]] = ..., default_resource_spec: Optional[outputs.DomainDefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec] = ..., emr_settings: Optional[outputs.DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagement(dict):
    ...
    def __init__(__self__, *, idle_settings: Optional[outputs.DomainDefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagementIdleSettings] = ...) -> None:
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagementIdleSettings(dict):
    ...
    def __init__(__self__, *, idle_timeout_in_minutes: Optional[_builtins.int] = ..., lifecycle_management: Optional[_builtins.str] = ..., max_idle_timeout_in_minutes: Optional[_builtins.int] = ..., min_idle_timeout_in_minutes: Optional[_builtins.int] = ...) -> None:
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImage(dict):
    ...
    def __init__(__self__, *, app_image_config_name: _builtins.str, image_name: _builtins.str, image_version_number: Optional[_builtins.int] = ...) -> None:
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings(dict):
    ...
    def __init__(__self__, *, assumable_role_arns: Optional[Sequence[_builtins.str]] = ..., execution_role_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DomainDefaultSpaceSettingsJupyterServerAppSettings(dict):
    ...
    def __init__(__self__, *, code_repositories: Optional[Sequence[outputs.DomainDefaultSpaceSettingsJupyterServerAppSettingsCodeRepository]] = ..., default_resource_spec: Optional[outputs.DomainDefaultSpaceSettingsJupyterServerAppSettingsDefaultResourceSpec] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DomainDefaultSpaceSettingsKernelGatewayAppSettings(dict):
    ...
    def __init__(__self__, *, custom_images: Optional[Sequence[outputs.DomainDefaultSpaceSettingsKernelGatewayAppSettingsCustomImage]] = ..., default_resource_spec: Optional[outputs.DomainDefaultSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DomainDefaultSpaceSettingsSpaceStorageSettings(dict):
    ...
    def __init__(__self__, *, default_ebs_storage_settings: Optional[outputs.DomainDefaultSpaceSettingsSpaceStorageSettingsDefaultEbsStorageSettings] = ...) -> None:
...
class DomainDefaultSpaceSettingsSpaceStorageSettingsDefaultEbsStorageSettings(dict):
    ...
    def __init__(__self__, *, default_ebs_volume_size_in_gb: _builtins.int, maximum_ebs_volume_size_in_gb: _builtins.int) -> None:
...
class DomainDefaultUserSettings(dict):
    ...
    def __init__(__self__, *, execution_role: _builtins.str, auto_mount_home_efs: Optional[_builtins.str] = ..., canvas_app_settings: Optional[outputs.DomainDefaultUserSettingsCanvasAppSettings] = ..., code_editor_app_settings: Optional[outputs.DomainDefaultUserSettingsCodeEditorAppSettings] = ..., custom_file_system_configs: Optional[Sequence[outputs.DomainDefaultUserSettingsCustomFileSystemConfig]] = ..., custom_posix_user_config: Optional[outputs.DomainDefaultUserSettingsCustomPosixUserConfig] = ..., default_landing_uri: Optional[_builtins.str] = ..., jupyter_lab_app_settings: Optional[outputs.DomainDefaultUserSettingsJupyterLabAppSettings] = ..., jupyter_server_app_settings: Optional[outputs.DomainDefaultUserSettingsJupyterServerAppSettings] = ..., kernel_gateway_app_settings: Optional[outputs.DomainDefaultUserSettingsKernelGatewayAppSettings] = ..., r_session_app_settings: Optional[outputs.DomainDefaultUserSettingsRSessionAppSettings] = ..., r_studio_server_pro_app_settings: Optional[outputs.DomainDefaultUserSettingsRStudioServerProAppSettings] = ..., security_groups: Optional[Sequence[_builtins.str]] = ..., sharing_settings: Optional[outputs.DomainDefaultUserSettingsSharingSettings] = ..., space_storage_settings: Optional[outputs.DomainDefaultUserSettingsSpaceStorageSettings] = ..., studio_web_portal: Optional[_builtins.str] = ..., studio_web_portal_settings: Optional[outputs.DomainDefaultUserSettingsStudioWebPortalSettings] = ..., tensor_board_app_settings: Optional[outputs.DomainDefaultUserSettingsTensorBoardAppSettings] = ...) -> None:
...
class DomainDefaultUserSettingsCanvasAppSettings(dict):
    ...
    def __init__(__self__, *, direct_deploy_settings: Optional[outputs.DomainDefaultUserSettingsCanvasAppSettingsDirectDeploySettings] = ..., emr_serverless_settings: Optional[outputs.DomainDefaultUserSettingsCanvasAppSettingsEmrServerlessSettings] = ..., generative_ai_settings: Optional[outputs.DomainDefaultUserSettingsCanvasAppSettingsGenerativeAiSettings] = ..., identity_provider_oauth_settings: Optional[Sequence[outputs.DomainDefaultUserSettingsCanvasAppSettingsIdentityProviderOauthSetting]] = ..., kendra_settings: Optional[outputs.DomainDefaultUserSettingsCanvasAppSettingsKendraSettings] = ..., model_register_settings: Optional[outputs.DomainDefaultUserSettingsCanvasAppSettingsModelRegisterSettings] = ..., time_series_forecasting_settings: Optional[outputs.DomainDefaultUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings] = ..., workspace_settings: Optional[outputs.DomainDefaultUserSettingsCanvasAppSettingsWorkspaceSettings] = ...) -> None:
...
class DomainDefaultUserSettingsCanvasAppSettingsEmrServerlessSettings(dict):
    ...
    def __init__(__self__, *, execution_role_arn: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class DomainDefaultUserSettingsCanvasAppSettingsGenerativeAiSettings(dict):
    ...
    def __init__(__self__, *, amazon_bedrock_role_arn: Optional[_builtins.str] = ...) -> None:
        ...
...
class DomainDefaultUserSettingsCanvasAppSettingsIdentityProviderOauthSetting(dict):
    ...
    def __init__(__self__, *, secret_arn: _builtins.str, data_source_name: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class DomainDefaultUserSettingsCanvasAppSettingsModelRegisterSettings(dict):
    ...
    def __init__(__self__, *, cross_account_model_register_role_arn: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class DomainDefaultUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings(dict):
    ...
    def __init__(__self__, *, amazon_forecast_role_arn: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class DomainDefaultUserSettingsCanvasAppSettingsWorkspaceSettings(dict):
    ...
    def __init__(__self__, *, s3_artifact_path: Optional[_builtins.str] = ..., s3_kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class DomainDefaultUserSettingsCodeEditorAppSettings(dict):
    ...
    def __init__(__self__, *, app_lifecycle_management: Optional[outputs.DomainDefaultUserSettingsCodeEditorAppSettingsAppLifecycleManagement] = ..., built_in_lifecycle_config_arn: Optional[_builtins.str] = ..., custom_images: Optional[Sequence[outputs.DomainDefaultUserSettingsCodeEditorAppSettingsCustomImage]] = ..., default_resource_spec: Optional[outputs.DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DomainDefaultUserSettingsCodeEditorAppSettingsAppLifecycleManagement(dict):
    ...
    def __init__(__self__, *, idle_settings: Optional[outputs.DomainDefaultUserSettingsCodeEditorAppSettingsAppLifecycleManagementIdleSettings] = ...) -> None:
...
class DomainDefaultUserSettingsCustomFileSystemConfig(dict):
    ...
    def __init__(__self__, *, efs_file_system_config: Optional[outputs.DomainDefaultUserSettingsCustomFileSystemConfigEfsFileSystemConfig] = ...) -> None:
...
class DomainDefaultUserSettingsJupyterLabAppSettings(dict):
    ...
    def __init__(__self__, *, app_lifecycle_management: Optional[outputs.DomainDefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagement] = ..., built_in_lifecycle_config_arn: Optional[_builtins.str] = ..., code_repositories: Optional[Sequence[outputs.DomainDefaultUserSettingsJupyterLabAppSettingsCodeRepository]] = ..., custom_images: Optional[Sequence[outputs.DomainDefaultUserSettingsJupyterLabAppSettingsCustomImage]] = ..., default_resource_spec: Optional[outputs.DomainDefaultUserSettingsJupyterLabAppSettingsDefaultResourceSpec] = ..., emr_settings: Optional[outputs.DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettings] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DomainDefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagement(dict):
    ...
    def __init__(__self__, *, idle_settings: Optional[outputs.DomainDefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagementIdleSettings] = ...) -> None:
...
class DomainDefaultUserSettingsJupyterServerAppSettings(dict):
    ...
    def __init__(__self__, *, code_repositories: Optional[Sequence[outputs.DomainDefaultUserSettingsJupyterServerAppSettingsCodeRepository]] = ..., default_resource_spec: Optional[outputs.DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpec] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DomainDefaultUserSettingsKernelGatewayAppSettings(dict):
    ...
    def __init__(__self__, *, custom_images: Optional[Sequence[outputs.DomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage]] = ..., default_resource_spec: Optional[outputs.DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DomainDefaultUserSettingsRSessionAppSettings(dict):
    ...
    def __init__(__self__, *, custom_images: Optional[Sequence[outputs.DomainDefaultUserSettingsRSessionAppSettingsCustomImage]] = ..., default_resource_spec: Optional[outputs.DomainDefaultUserSettingsRSessionAppSettingsDefaultResourceSpec] = ...) -> None:
...
class DomainDefaultUserSettingsRStudioServerProAppSettings(dict):
    ...
    def __init__(__self__, *, access_status: Optional[_builtins.str] = ..., user_group: Optional[_builtins.str] = ...) -> None:
...
class DomainDefaultUserSettingsSharingSettings(dict):
    ...
    def __init__(__self__, *, notebook_output_option: Optional[_builtins.str] = ..., s3_kms_key_id: Optional[_builtins.str] = ..., s3_output_path: Optional[_builtins.str] = ...) -> None:
...
class DomainDefaultUserSettingsSpaceStorageSettings(dict):
    ...
    def __init__(__self__, *, default_ebs_storage_settings: Optional[outputs.DomainDefaultUserSettingsSpaceStorageSettingsDefaultEbsStorageSettings] = ...) -> None:
...
class DomainDefaultUserSettingsStudioWebPortalSettings(dict):
    ...
    def __init__(__self__, *, hidden_app_types: Optional[Sequence[_builtins.str]] = ..., hidden_instance_types: Optional[Sequence[_builtins.str]] = ..., hidden_ml_tools: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DomainDefaultUserSettingsTensorBoardAppSettings(dict):
    ...
    def __init__(__self__, *, default_resource_spec: Optional[outputs.DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec] = ...) -> None:
...
class DomainDomainSettings(dict):
    ...
    def __init__(__self__, *, docker_settings: Optional[outputs.DomainDomainSettingsDockerSettings] = ..., execution_role_identity_config: Optional[_builtins.str] = ..., r_studio_server_pro_domain_settings: Optional[outputs.DomainDomainSettingsRStudioServerProDomainSettings] = ..., security_group_ids: Optional[Sequence[_builtins.str]] = ..., trusted_identity_propagation_settings: Optional[outputs.DomainDomainSettingsTrustedIdentityPropagationSettings] = ...) -> None:
...
class DomainDomainSettingsDockerSettings(dict):
    ...
    def __init__(__self__, *, enable_docker_access: Optional[_builtins.str] = ..., vpc_only_trusted_accounts: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DomainDomainSettingsRStudioServerProDomainSettings(dict):
    ...
    def __init__(__self__, *, domain_execution_role_arn: _builtins.str, default_resource_spec: Optional[outputs.DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec] = ..., r_studio_connect_url: Optional[_builtins.str] = ..., r_studio_package_manager_url: Optional[_builtins.str] = ...) -> None:
...
class DomainRetentionPolicy(dict):
    ...
    def __init__(__self__, *, home_efs_file_system: Optional[_builtins.str] = ...) -> None:
...
class EndpointConfigurationAsyncInferenceConfig(dict):
    ...
    def __init__(__self__, *, output_config: outputs.EndpointConfigurationAsyncInferenceConfigOutputConfig, client_config: Optional[outputs.EndpointConfigurationAsyncInferenceConfigClientConfig] = ...) -> None:
...
class EndpointConfigurationAsyncInferenceConfigClientConfig(dict):
    ...
    def __init__(__self__, *, max_concurrent_invocations_per_instance: Optional[_builtins.int] = ...) -> None:
...
class EndpointConfigurationAsyncInferenceConfigOutputConfig(dict):
    ...
    def __init__(__self__, *, s3_output_path: _builtins.str, kms_key_id: Optional[_builtins.str] = ..., notification_config: Optional[outputs.EndpointConfigurationAsyncInferenceConfigOutputConfigNotificationConfig] = ..., s3_failure_path: Optional[_builtins.str] = ...) -> None:
...
class EndpointConfigurationAsyncInferenceConfigOutputConfigNotificationConfig(dict):
    ...
    def __init__(__self__, *, error_topic: Optional[_builtins.str] = ..., include_inference_response_ins: Optional[Sequence[_builtins.str]] = ..., success_topic: Optional[_builtins.str] = ...) -> None:
...
class EndpointConfigurationDataCaptureConfig(dict):
    ...
    def __init__(__self__, *, capture_options: Sequence[outputs.EndpointConfigurationDataCaptureConfigCaptureOption], destination_s3_uri: _builtins.str, initial_sampling_percentage: _builtins.int, capture_content_type_header: Optional[outputs.EndpointConfigurationDataCaptureConfigCaptureContentTypeHeader] = ..., enable_capture: Optional[_builtins.bool] = ..., kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class EndpointConfigurationDataCaptureConfigCaptureContentTypeHeader(dict):
    ...
    def __init__(__self__, *, csv_content_types: Optional[Sequence[_builtins.str]] = ..., json_content_types: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class EndpointConfigurationProductionVariant(dict):
    ...
    def __init__(__self__, *, accelerator_type: Optional[_builtins.str] = ..., container_startup_health_check_timeout_in_seconds: Optional[_builtins.int] = ..., core_dump_config: Optional[outputs.EndpointConfigurationProductionVariantCoreDumpConfig] = ..., enable_ssm_access: Optional[_builtins.bool] = ..., inference_ami_version: Optional[_builtins.str] = ..., initial_instance_count: Optional[_builtins.int] = ..., initial_variant_weight: Optional[_builtins.float] = ..., instance_type: Optional[_builtins.str] = ..., managed_instance_scaling: Optional[outputs.EndpointConfigurationProductionVariantManagedInstanceScaling] = ..., model_data_download_timeout_in_seconds: Optional[_builtins.int] = ..., model_name: Optional[_builtins.str] = ..., routing_configs: Optional[Sequence[outputs.EndpointConfigurationProductionVariantRoutingConfig]] = ..., serverless_config: Optional[outputs.EndpointConfigurationProductionVariantServerlessConfig] = ..., variant_name: Optional[_builtins.str] = ..., volume_size_in_gb: Optional[_builtins.int] = ...) -> None:
...
class EndpointConfigurationProductionVariantCoreDumpConfig(dict):
    ...
    def __init__(__self__, *, destination_s3_uri: _builtins.str, kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class EndpointConfigurationProductionVariantManagedInstanceScaling(dict):
    ...
    def __init__(__self__, *, max_instance_count: Optional[_builtins.int] = ..., min_instance_count: Optional[_builtins.int] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class EndpointConfigurationProductionVariantServerlessConfig(dict):
    ...
    def __init__(__self__, *, max_concurrency: _builtins.int, memory_size_in_mb: _builtins.int, provisioned_concurrency: Optional[_builtins.int] = ...) -> None:
...
class EndpointConfigurationShadowProductionVariant(dict):
    ...
    def __init__(__self__, *, accelerator_type: Optional[_builtins.str] = ..., container_startup_health_check_timeout_in_seconds: Optional[_builtins.int] = ..., core_dump_config: Optional[outputs.EndpointConfigurationShadowProductionVariantCoreDumpConfig] = ..., enable_ssm_access: Optional[_builtins.bool] = ..., inference_ami_version: Optional[_builtins.str] = ..., initial_instance_count: Optional[_builtins.int] = ..., initial_variant_weight: Optional[_builtins.float] = ..., instance_type: Optional[_builtins.str] = ..., managed_instance_scaling: Optional[outputs.EndpointConfigurationShadowProductionVariantManagedInstanceScaling] = ..., model_data_download_timeout_in_seconds: Optional[_builtins.int] = ..., model_name: Optional[_builtins.str] = ..., routing_configs: Optional[Sequence[outputs.EndpointConfigurationShadowProductionVariantRoutingConfig]] = ..., serverless_config: Optional[outputs.EndpointConfigurationShadowProductionVariantServerlessConfig] = ..., variant_name: Optional[_builtins.str] = ..., volume_size_in_gb: Optional[_builtins.int] = ...) -> None:
...
class EndpointConfigurationShadowProductionVariantCoreDumpConfig(dict):
    ...
    def __init__(__self__, *, destination_s3_uri: _builtins.str, kms_key_id: _builtins.str) -> None:
...
class EndpointDeploymentConfig(dict):
    ...
    def __init__(__self__, *, auto_rollback_configuration: Optional[outputs.EndpointDeploymentConfigAutoRollbackConfiguration] = ..., blue_green_update_policy: Optional[outputs.EndpointDeploymentConfigBlueGreenUpdatePolicy] = ..., rolling_update_policy: Optional[outputs.EndpointDeploymentConfigRollingUpdatePolicy] = ...) -> None:
...
class EndpointDeploymentConfigAutoRollbackConfiguration(dict):
    def __init__(__self__, *, alarms: Optional[Sequence[outputs.EndpointDeploymentConfigAutoRollbackConfigurationAlarm]] = ...) -> None:
...
class EndpointDeploymentConfigBlueGreenUpdatePolicy(dict):
    ...
    def __init__(__self__, *, traffic_routing_configuration: outputs.EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfiguration, maximum_execution_timeout_in_seconds: Optional[_builtins.int] = ..., termination_wait_in_seconds: Optional[_builtins.int] = ...) -> None:
...
class EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfiguration(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, wait_interval_in_seconds: _builtins.int, canary_size: Optional[outputs.EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationCanarySize] = ..., linear_step_size: Optional[outputs.EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationLinearStepSize] = ...) -> None:
...
class EndpointDeploymentConfigRollingUpdatePolicy(dict):
    ...
    def __init__(__self__, *, maximum_batch_size: outputs.EndpointDeploymentConfigRollingUpdatePolicyMaximumBatchSize, wait_interval_in_seconds: _builtins.int, maximum_execution_timeout_in_seconds: Optional[_builtins.int] = ..., rollback_maximum_batch_size: Optional[outputs.EndpointDeploymentConfigRollingUpdatePolicyRollbackMaximumBatchSize] = ...) -> None:
...
class FeatureGroupFeatureDefinition(dict):
    ...
    def __init__(__self__, *, collection_config: Optional[outputs.FeatureGroupFeatureDefinitionCollectionConfig] = ..., collection_type: Optional[_builtins.str] = ..., feature_name: Optional[_builtins.str] = ..., feature_type: Optional[_builtins.str] = ...) -> None:
...
class FeatureGroupFeatureDefinitionCollectionConfig(dict):
    ...
    def __init__(__self__, *, vector_config: Optional[outputs.FeatureGroupFeatureDefinitionCollectionConfigVectorConfig] = ...) -> None:
        ...
...
class FeatureGroupOfflineStoreConfig(dict):
    ...
    def __init__(__self__, *, s3_storage_config: outputs.FeatureGroupOfflineStoreConfigS3StorageConfig, data_catalog_config: Optional[outputs.FeatureGroupOfflineStoreConfigDataCatalogConfig] = ..., disable_glue_table_creation: Optional[_builtins.bool] = ..., table_format: Optional[_builtins.str] = ...) -> None:
...
class FeatureGroupOfflineStoreConfigDataCatalogConfig(dict):
    ...
    def __init__(__self__, *, catalog: Optional[_builtins.str] = ..., database: Optional[_builtins.str] = ..., table_name: Optional[_builtins.str] = ...) -> None:
...
class FeatureGroupOfflineStoreConfigS3StorageConfig(dict):
    ...
    def __init__(__self__, *, s3_uri: _builtins.str, kms_key_id: Optional[_builtins.str] = ..., resolved_output_s3_uri: Optional[_builtins.str] = ...) -> None:
...
class FeatureGroupOnlineStoreConfig(dict):
    ...
    def __init__(__self__, *, enable_online_store: Optional[_builtins.bool] = ..., security_config: Optional[outputs.FeatureGroupOnlineStoreConfigSecurityConfig] = ..., storage_type: Optional[_builtins.str] = ..., ttl_duration: Optional[outputs.FeatureGroupOnlineStoreConfigTtlDuration] = ...) -> None:
...
class FeatureGroupOnlineStoreConfigTtlDuration(dict):
    def __init__(__self__, *, unit: Optional[_builtins.str] = ..., value: Optional[_builtins.int] = ...) -> None:
...
class FeatureGroupThroughputConfig(dict):
    ...
    def __init__(__self__, *, provisioned_read_capacity_units: Optional[_builtins.int] = ..., provisioned_write_capacity_units: Optional[_builtins.int] = ..., throughput_mode: Optional[_builtins.str] = ...) -> None:
        ...
...
class FlowDefinitionHumanLoopActivationConfig(dict):
    ...
    def __init__(__self__, *, human_loop_activation_conditions_config: Optional[outputs.FlowDefinitionHumanLoopActivationConfigHumanLoopActivationConditionsConfig] = ...) -> None:
...
class FlowDefinitionHumanLoopActivationConfigHumanLoopActivationConditionsConfig(dict):
    ...
    def __init__(__self__, *, human_loop_activation_conditions: _builtins.str) -> None:
...
class FlowDefinitionHumanLoopConfig(dict):
    ...
    def __init__(__self__, *, human_task_ui_arn: _builtins.str, task_count: _builtins.int, task_description: _builtins.str, task_title: _builtins.str, workteam_arn: _builtins.str, public_workforce_task_price: Optional[outputs.FlowDefinitionHumanLoopConfigPublicWorkforceTaskPrice] = ..., task_availability_lifetime_in_seconds: Optional[_builtins.int] = ..., task_keywords: Optional[Sequence[_builtins.str]] = ..., task_time_limit_in_seconds: Optional[_builtins.int] = ...) -> None:
...
class FlowDefinitionHumanLoopConfigPublicWorkforceTaskPrice(dict):
    ...
    def __init__(__self__, *, amount_in_usd: Optional[outputs.FlowDefinitionHumanLoopConfigPublicWorkforceTaskPriceAmountInUsd] = ...) -> None:
...
class FlowDefinitionHumanLoopConfigPublicWorkforceTaskPriceAmountInUsd(dict):
    ...
    def __init__(__self__, *, cents: Optional[_builtins.int] = ..., dollars: Optional[_builtins.int] = ..., tenth_fractions_of_a_cent: Optional[_builtins.int] = ...) -> None:
...
class FlowDefinitionHumanLoopRequestSource(dict):
    ...
    def __init__(__self__, *, aws_managed_human_loop_request_source: _builtins.str) -> None:
...
class FlowDefinitionOutputConfig(dict):
    ...
    def __init__(__self__, *, s3_output_path: _builtins.str, kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class HubS3StorageConfig(dict):
    ...
    def __init__(__self__, *, s3_output_path: Optional[_builtins.str] = ...) -> None:
...
class HumanTaskUIUiTemplate(dict):
    ...
    def __init__(__self__, *, content: Optional[_builtins.str] = ..., content_sha256: Optional[_builtins.str] = ..., url: Optional[_builtins.str] = ...) -> None:
...
class LabelingJobHumanTaskConfig(dict):
    ...
    def __init__(__self__, *, number_of_human_workers_per_data_object: _builtins.int, task_description: _builtins.str, task_time_limit_in_seconds: _builtins.int, task_title: _builtins.str, ui_config: outputs.LabelingJobHumanTaskConfigUiConfig, workteam_arn: _builtins.str, annotation_consolidation_config: Optional[outputs.LabelingJobHumanTaskConfigAnnotationConsolidationConfig] = ..., max_concurrent_task_count: Optional[_builtins.int] = ..., pre_human_task_lambda_arn: Optional[_builtins.str] = ..., public_workforce_task_price: Optional[outputs.LabelingJobHumanTaskConfigPublicWorkforceTaskPrice] = ..., task_availability_lifetime_in_seconds: Optional[_builtins.int] = ..., task_keywords: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class LabelingJobHumanTaskConfigAnnotationConsolidationConfig(dict):
    ...
    def __init__(__self__, *, annotation_consolidation_lambda_arn: _builtins.str) -> None:
...
class LabelingJobHumanTaskConfigPublicWorkforceTaskPrice(dict):
    ...
    def __init__(__self__, *, amount_in_usd: Optional[outputs.LabelingJobHumanTaskConfigPublicWorkforceTaskPriceAmountInUsd] = ...) -> None:
...
class LabelingJobHumanTaskConfigUiConfig(dict):
    ...
    def __init__(__self__, *, human_task_ui_arn: Optional[_builtins.str] = ..., ui_template_s3_uri: Optional[_builtins.str] = ...) -> None:
...
class LabelingJobInputConfig(dict):
    ...
    def __init__(__self__, *, data_source: outputs.LabelingJobInputConfigDataSource, data_attributes: Optional[outputs.LabelingJobInputConfigDataAttributes] = ...) -> None:
...
class LabelingJobInputConfigDataAttributes(dict):
    ...
    def __init__(__self__, *, content_classifiers: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class LabelingJobInputConfigDataSource(dict):
    ...
    def __init__(__self__, *, s3_data_source: Optional[outputs.LabelingJobInputConfigDataSourceS3DataSource] = ..., sns_data_source: Optional[outputs.LabelingJobInputConfigDataSourceSnsDataSource] = ...) -> None:
...
class LabelingJobLabelCounter(dict):
    ...
    def __init__(__self__, *, failed_non_retryable_error: _builtins.int, human_labeled: _builtins.int, machine_labeled: _builtins.int, total_labeled: _builtins.int, unlabeled: _builtins.int) -> None:
...
class LabelingJobLabelingJobAlgorithmsConfig(dict):
    ...
    def __init__(__self__, *, labeling_job_algorithm_specification_arn: _builtins.str, initial_active_learning_model_arn: Optional[_builtins.str] = ..., labeling_job_resource_config: Optional[outputs.LabelingJobLabelingJobAlgorithmsConfigLabelingJobResourceConfig] = ...) -> None:
...
class LabelingJobLabelingJobAlgorithmsConfigLabelingJobResourceConfig(dict):
    ...
    def __init__(__self__, *, volume_kms_key_id: Optional[_builtins.str] = ..., vpc_config: Optional[outputs.LabelingJobLabelingJobAlgorithmsConfigLabelingJobResourceConfigVpcConfig] = ...) -> None:
...
class LabelingJobOutputConfig(dict):
    ...
    def __init__(__self__, *, s3_output_path: _builtins.str, kms_key_id: Optional[_builtins.str] = ..., sns_topic_arn: Optional[_builtins.str] = ...) -> None:
...
class LabelingJobStoppingCondition(dict):
    ...
    def __init__(__self__, *, max_human_labeled_object_count: _builtins.int, max_percentage_of_input_dataset_labeled: _builtins.int) -> None:
...
class ModelContainer(dict):
    ...
    def __init__(__self__, *, additional_model_data_sources: Optional[Sequence[outputs.ModelContainerAdditionalModelDataSource]] = ..., container_hostname: Optional[_builtins.str] = ..., environment: Optional[Mapping[str, _builtins.str]] = ..., image: Optional[_builtins.str] = ..., image_config: Optional[outputs.ModelContainerImageConfig] = ..., inference_specification_name: Optional[_builtins.str] = ..., mode: Optional[_builtins.str] = ..., model_data_source: Optional[outputs.ModelContainerModelDataSource] = ..., model_data_url: Optional[_builtins.str] = ..., model_package_name: Optional[_builtins.str] = ..., multi_model_config: Optional[outputs.ModelContainerMultiModelConfig] = ...) -> None:
...
class ModelContainerAdditionalModelDataSource(dict):
    ...
    def __init__(__self__, *, channel_name: _builtins.str, s3_data_sources: Sequence[outputs.ModelContainerAdditionalModelDataSourceS3DataSource]) -> None:
...
class ModelContainerAdditionalModelDataSourceS3DataSource(dict):
    ...
    def __init__(__self__, *, compression_type: _builtins.str, s3_data_type: _builtins.str, s3_uri: _builtins.str, model_access_config: Optional[outputs.ModelContainerAdditionalModelDataSourceS3DataSourceModelAccessConfig] = ...) -> None:
...
class ModelContainerImageConfig(dict):
    ...
    def __init__(__self__, *, repository_access_mode: _builtins.str, repository_auth_config: Optional[outputs.ModelContainerImageConfigRepositoryAuthConfig] = ...) -> None:
...
class ModelContainerImageConfigRepositoryAuthConfig(dict):
    ...
    def __init__(__self__, *, repository_credentials_provider_arn: _builtins.str) -> None:
...
class ModelContainerModelDataSource(dict):
    ...
    def __init__(__self__, *, s3_data_sources: Sequence[outputs.ModelContainerModelDataSourceS3DataSource]) -> None:
...
class ModelContainerModelDataSourceS3DataSource(dict):
    ...
    def __init__(__self__, *, compression_type: _builtins.str, s3_data_type: _builtins.str, s3_uri: _builtins.str, model_access_config: Optional[outputs.ModelContainerModelDataSourceS3DataSourceModelAccessConfig] = ...) -> None:
...
class ModelContainerMultiModelConfig(dict):
    ...
    def __init__(__self__, *, model_cache_setting: Optional[_builtins.str] = ...) -> None:
...
class ModelPrimaryContainer(dict):
    ...
    def __init__(__self__, *, additional_model_data_sources: Optional[Sequence[outputs.ModelPrimaryContainerAdditionalModelDataSource]] = ..., container_hostname: Optional[_builtins.str] = ..., environment: Optional[Mapping[str, _builtins.str]] = ..., image: Optional[_builtins.str] = ..., image_config: Optional[outputs.ModelPrimaryContainerImageConfig] = ..., inference_specification_name: Optional[_builtins.str] = ..., mode: Optional[_builtins.str] = ..., model_data_source: Optional[outputs.ModelPrimaryContainerModelDataSource] = ..., model_data_url: Optional[_builtins.str] = ..., model_package_name: Optional[_builtins.str] = ..., multi_model_config: Optional[outputs.ModelPrimaryContainerMultiModelConfig] = ...) -> None:
...
class ModelPrimaryContainerAdditionalModelDataSource(dict):
    ...
    def __init__(__self__, *, channel_name: _builtins.str, s3_data_sources: Sequence[outputs.ModelPrimaryContainerAdditionalModelDataSourceS3DataSource]) -> None:
...
class ModelPrimaryContainerAdditionalModelDataSourceS3DataSource(dict):
    ...
    def __init__(__self__, *, compression_type: _builtins.str, s3_data_type: _builtins.str, s3_uri: _builtins.str, model_access_config: Optional[outputs.ModelPrimaryContainerAdditionalModelDataSourceS3DataSourceModelAccessConfig] = ...) -> None:
...
class ModelPrimaryContainerImageConfig(dict):
    ...
    def __init__(__self__, *, repository_access_mode: _builtins.str, repository_auth_config: Optional[outputs.ModelPrimaryContainerImageConfigRepositoryAuthConfig] = ...) -> None:
...
class ModelPrimaryContainerModelDataSource(dict):
    ...
    def __init__(__self__, *, s3_data_sources: Sequence[outputs.ModelPrimaryContainerModelDataSourceS3DataSource]) -> None:
...
class ModelPrimaryContainerModelDataSourceS3DataSource(dict):
    ...
    def __init__(__self__, *, compression_type: _builtins.str, s3_data_type: _builtins.str, s3_uri: _builtins.str, model_access_config: Optional[outputs.ModelPrimaryContainerModelDataSourceS3DataSourceModelAccessConfig] = ...) -> None:
...
class MonitoringScheduleMonitoringScheduleConfig(dict):
    ...
    def __init__(__self__, *, monitoring_type: _builtins.str, monitoring_job_definition: Optional[outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinition] = ..., monitoring_job_definition_name: Optional[_builtins.str] = ..., schedule_config: Optional[outputs.MonitoringScheduleMonitoringScheduleConfigScheduleConfig] = ...) -> None:
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinition(dict):
    ...
    def __init__(__self__, *, monitoring_app_specification: outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringAppSpecification, monitoring_inputs: outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringInputs, monitoring_output_config: outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringOutputConfig, monitoring_resources: outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringResources, role_arn: _builtins.str, baseline: Optional[outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionBaseline] = ..., environment: Optional[Mapping[str, _builtins.str]] = ..., network_config: Optional[outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionNetworkConfig] = ..., stopping_conditions: Optional[Sequence[outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionStoppingCondition]] = ...) -> None:
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionBaseline(dict):
    ...
    def __init__(__self__, *, baselining_job_name: Optional[_builtins.str] = ..., constraints_resource: Optional[outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionBaselineConstraintsResource] = ..., statistics_resource: Optional[outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionBaselineStatisticsResource] = ...) -> None:
        ...
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringAppSpecification(dict):
    ...
    def __init__(__self__, *, image_uri: _builtins.str, container_arguments: Optional[Sequence[_builtins.str]] = ..., container_entrypoints: Optional[Sequence[_builtins.str]] = ..., post_analytics_processor_source_uri: Optional[_builtins.str] = ..., record_preprocessor_source_uri: Optional[_builtins.str] = ...) -> None:
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringInputs(dict):
    ...
    def __init__(__self__, *, batch_transform_input: Optional[outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringInputsBatchTransformInput] = ..., endpoint_input: Optional[outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringInputsEndpointInput] = ...) -> None:
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringInputsBatchTransformInput(dict):
    ...
    def __init__(__self__, *, data_captured_destination_s3_uri: _builtins.str, dataset_format: outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringInputsBatchTransformInputDatasetFormat, local_path: _builtins.str, end_time_offset: Optional[_builtins.str] = ..., exclude_features_attribute: Optional[_builtins.str] = ..., features_attribute: Optional[_builtins.str] = ..., inference_attribute: Optional[_builtins.str] = ..., probability_attribute: Optional[_builtins.str] = ..., probability_threshold_attribute: Optional[_builtins.float] = ..., s3_data_distribution_type: Optional[_builtins.str] = ..., s3_input_mode: Optional[_builtins.str] = ..., start_time_offset: Optional[_builtins.str] = ...) -> None:
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringInputsEndpointInput(dict):
    ...
    def __init__(__self__, *, endpoint_name: _builtins.str, local_path: _builtins.str, end_time_offset: Optional[_builtins.str] = ..., exclude_features_attribute: Optional[_builtins.str] = ..., features_attribute: Optional[_builtins.str] = ..., inference_attribute: Optional[_builtins.str] = ..., probability_attribute: Optional[_builtins.str] = ..., probability_threshold_attribute: Optional[_builtins.float] = ..., s3_data_distribution_type: Optional[_builtins.str] = ..., s3_input_mode: Optional[_builtins.str] = ..., start_time_offset: Optional[_builtins.str] = ...) -> None:
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringOutputConfig(dict):
    ...
    def __init__(__self__, *, monitoring_outputs: outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringOutputConfigMonitoringOutputs, kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringOutputConfigMonitoringOutputs(dict):
    ...
    def __init__(__self__, *, s3_output: outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringOutputConfigMonitoringOutputsS3Output) -> None:
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringOutputConfigMonitoringOutputsS3Output(dict):
    ...
    def __init__(__self__, *, local_path: _builtins.str, s3_uri: _builtins.str, s3_upload_mode: Optional[_builtins.str] = ...) -> None:
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringResources(dict):
    ...
    def __init__(__self__, *, cluster_config: outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionMonitoringResourcesClusterConfig) -> None:
...
class MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionNetworkConfig(dict):
    ...
    def __init__(__self__, *, enable_inter_container_traffic_encryption: Optional[_builtins.bool] = ..., enable_network_isolation: Optional[_builtins.bool] = ..., vpc_config: Optional[outputs.MonitoringScheduleMonitoringScheduleConfigMonitoringJobDefinitionNetworkConfigVpcConfig] = ...) -> None:
...
class NotebookInstanceInstanceMetadataServiceConfiguration(dict):
    ...
    def __init__(__self__, *, minimum_instance_metadata_service_version: Optional[_builtins.str] = ...) -> None:
...
class PipelinePipelineDefinitionS3Location(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, object_key: _builtins.str, version_id: Optional[_builtins.str] = ...) -> None:
...
class ProjectServiceCatalogProvisioningDetails(dict):
    ...
    def __init__(__self__, *, product_id: _builtins.str, path_id: Optional[_builtins.str] = ..., provisioning_artifact_id: Optional[_builtins.str] = ..., provisioning_parameters: Optional[Sequence[outputs.ProjectServiceCatalogProvisioningDetailsProvisioningParameter]] = ...) -> None:
...
class SpaceSpaceSettings(dict):
    ...
    def __init__(__self__, *, app_type: Optional[_builtins.str] = ..., code_editor_app_settings: Optional[outputs.SpaceSpaceSettingsCodeEditorAppSettings] = ..., custom_file_systems: Optional[Sequence[outputs.SpaceSpaceSettingsCustomFileSystem]] = ..., jupyter_lab_app_settings: Optional[outputs.SpaceSpaceSettingsJupyterLabAppSettings] = ..., jupyter_server_app_settings: Optional[outputs.SpaceSpaceSettingsJupyterServerAppSettings] = ..., kernel_gateway_app_settings: Optional[outputs.SpaceSpaceSettingsKernelGatewayAppSettings] = ..., space_storage_settings: Optional[outputs.SpaceSpaceSettingsSpaceStorageSettings] = ...) -> None:
...
class SpaceSpaceSettingsCodeEditorAppSettings(dict):
    ...
    def __init__(__self__, *, default_resource_spec: outputs.SpaceSpaceSettingsCodeEditorAppSettingsDefaultResourceSpec, app_lifecycle_management: Optional[outputs.SpaceSpaceSettingsCodeEditorAppSettingsAppLifecycleManagement] = ...) -> None:
...
class SpaceSpaceSettingsCodeEditorAppSettingsAppLifecycleManagement(dict):
    ...
    def __init__(__self__, *, idle_settings: Optional[outputs.SpaceSpaceSettingsCodeEditorAppSettingsAppLifecycleManagementIdleSettings] = ...) -> None:
...
class SpaceSpaceSettingsCodeEditorAppSettingsAppLifecycleManagementIdleSettings(dict):
    ...
    def __init__(__self__, *, idle_timeout_in_minutes: Optional[_builtins.int] = ...) -> None:
...
class SpaceSpaceSettingsCustomFileSystem(dict):
    ...
    def __init__(__self__, *, efs_file_system: outputs.SpaceSpaceSettingsCustomFileSystemEfsFileSystem) -> None:
...
class SpaceSpaceSettingsJupyterLabAppSettings(dict):
    ...
    def __init__(__self__, *, default_resource_spec: outputs.SpaceSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec, app_lifecycle_management: Optional[outputs.SpaceSpaceSettingsJupyterLabAppSettingsAppLifecycleManagement] = ..., code_repositories: Optional[Sequence[outputs.SpaceSpaceSettingsJupyterLabAppSettingsCodeRepository]] = ...) -> None:
...
class SpaceSpaceSettingsJupyterLabAppSettingsAppLifecycleManagement(dict):
    ...
    def __init__(__self__, *, idle_settings: Optional[outputs.SpaceSpaceSettingsJupyterLabAppSettingsAppLifecycleManagementIdleSettings] = ...) -> None:
...
class SpaceSpaceSettingsJupyterServerAppSettings(dict):
    ...
    def __init__(__self__, *, default_resource_spec: outputs.SpaceSpaceSettingsJupyterServerAppSettingsDefaultResourceSpec, code_repositories: Optional[Sequence[outputs.SpaceSpaceSettingsJupyterServerAppSettingsCodeRepository]] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SpaceSpaceSettingsKernelGatewayAppSettings(dict):
    ...
    def __init__(__self__, *, default_resource_spec: outputs.SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec, custom_images: Optional[Sequence[outputs.SpaceSpaceSettingsKernelGatewayAppSettingsCustomImage]] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SpaceSpaceSettingsSpaceStorageSettings(dict):
    ...
    def __init__(__self__, *, ebs_storage_settings: outputs.SpaceSpaceSettingsSpaceStorageSettingsEbsStorageSettings) -> None:
...
class UserProfileUserSettings(dict):
    ...
    def __init__(__self__, *, execution_role: _builtins.str, auto_mount_home_efs: Optional[_builtins.str] = ..., canvas_app_settings: Optional[outputs.UserProfileUserSettingsCanvasAppSettings] = ..., code_editor_app_settings: Optional[outputs.UserProfileUserSettingsCodeEditorAppSettings] = ..., custom_file_system_configs: Optional[Sequence[outputs.UserProfileUserSettingsCustomFileSystemConfig]] = ..., custom_posix_user_config: Optional[outputs.UserProfileUserSettingsCustomPosixUserConfig] = ..., default_landing_uri: Optional[_builtins.str] = ..., jupyter_lab_app_settings: Optional[outputs.UserProfileUserSettingsJupyterLabAppSettings] = ..., jupyter_server_app_settings: Optional[outputs.UserProfileUserSettingsJupyterServerAppSettings] = ..., kernel_gateway_app_settings: Optional[outputs.UserProfileUserSettingsKernelGatewayAppSettings] = ..., r_session_app_settings: Optional[outputs.UserProfileUserSettingsRSessionAppSettings] = ..., r_studio_server_pro_app_settings: Optional[outputs.UserProfileUserSettingsRStudioServerProAppSettings] = ..., security_groups: Optional[Sequence[_builtins.str]] = ..., sharing_settings: Optional[outputs.UserProfileUserSettingsSharingSettings] = ..., space_storage_settings: Optional[outputs.UserProfileUserSettingsSpaceStorageSettings] = ..., studio_web_portal: Optional[_builtins.str] = ..., studio_web_portal_settings: Optional[outputs.UserProfileUserSettingsStudioWebPortalSettings] = ..., tensor_board_app_settings: Optional[outputs.UserProfileUserSettingsTensorBoardAppSettings] = ...) -> None:
...
class UserProfileUserSettingsCanvasAppSettings(dict):
    ...
    def __init__(__self__, *, direct_deploy_settings: Optional[outputs.UserProfileUserSettingsCanvasAppSettingsDirectDeploySettings] = ..., emr_serverless_settings: Optional[outputs.UserProfileUserSettingsCanvasAppSettingsEmrServerlessSettings] = ..., generative_ai_settings: Optional[outputs.UserProfileUserSettingsCanvasAppSettingsGenerativeAiSettings] = ..., identity_provider_oauth_settings: Optional[Sequence[outputs.UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSetting]] = ..., kendra_settings: Optional[outputs.UserProfileUserSettingsCanvasAppSettingsKendraSettings] = ..., model_register_settings: Optional[outputs.UserProfileUserSettingsCanvasAppSettingsModelRegisterSettings] = ..., time_series_forecasting_settings: Optional[outputs.UserProfileUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings] = ..., workspace_settings: Optional[outputs.UserProfileUserSettingsCanvasAppSettingsWorkspaceSettings] = ...) -> None:
...
class UserProfileUserSettingsCodeEditorAppSettings(dict):
    ...
    def __init__(__self__, *, app_lifecycle_management: Optional[outputs.UserProfileUserSettingsCodeEditorAppSettingsAppLifecycleManagement] = ..., built_in_lifecycle_config_arn: Optional[_builtins.str] = ..., custom_images: Optional[Sequence[outputs.UserProfileUserSettingsCodeEditorAppSettingsCustomImage]] = ..., default_resource_spec: Optional[outputs.UserProfileUserSettingsCodeEditorAppSettingsDefaultResourceSpec] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class UserProfileUserSettingsCodeEditorAppSettingsAppLifecycleManagement(dict):
    ...
    def __init__(__self__, *, idle_settings: Optional[outputs.UserProfileUserSettingsCodeEditorAppSettingsAppLifecycleManagementIdleSettings] = ...) -> None:
...
class UserProfileUserSettingsCustomFileSystemConfig(dict):
    ...
    def __init__(__self__, *, efs_file_system_configs: Optional[Sequence[outputs.UserProfileUserSettingsCustomFileSystemConfigEfsFileSystemConfig]] = ...) -> None:
...
class UserProfileUserSettingsCustomFileSystemConfigEfsFileSystemConfig(dict):
    ...
    def __init__(__self__, *, file_system_id: _builtins.str, file_system_path: Optional[_builtins.str] = ...) -> None:
...
class UserProfileUserSettingsJupyterLabAppSettings(dict):
    ...
    def __init__(__self__, *, app_lifecycle_management: Optional[outputs.UserProfileUserSettingsJupyterLabAppSettingsAppLifecycleManagement] = ..., built_in_lifecycle_config_arn: Optional[_builtins.str] = ..., code_repositories: Optional[Sequence[outputs.UserProfileUserSettingsJupyterLabAppSettingsCodeRepository]] = ..., custom_images: Optional[Sequence[outputs.UserProfileUserSettingsJupyterLabAppSettingsCustomImage]] = ..., default_resource_spec: Optional[outputs.UserProfileUserSettingsJupyterLabAppSettingsDefaultResourceSpec] = ..., emr_settings: Optional[outputs.UserProfileUserSettingsJupyterLabAppSettingsEmrSettings] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class UserProfileUserSettingsJupyterLabAppSettingsAppLifecycleManagement(dict):
    ...
    def __init__(__self__, *, idle_settings: Optional[outputs.UserProfileUserSettingsJupyterLabAppSettingsAppLifecycleManagementIdleSettings] = ...) -> None:
...
class UserProfileUserSettingsJupyterServerAppSettings(dict):
    ...
    def __init__(__self__, *, code_repositories: Optional[Sequence[outputs.UserProfileUserSettingsJupyterServerAppSettingsCodeRepository]] = ..., default_resource_spec: Optional[outputs.UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpec] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class UserProfileUserSettingsKernelGatewayAppSettings(dict):
    ...
    def __init__(__self__, *, custom_images: Optional[Sequence[outputs.UserProfileUserSettingsKernelGatewayAppSettingsCustomImage]] = ..., default_resource_spec: Optional[outputs.UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpec] = ..., lifecycle_config_arns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class UserProfileUserSettingsRSessionAppSettings(dict):
    ...
    def __init__(__self__, *, custom_images: Optional[Sequence[outputs.UserProfileUserSettingsRSessionAppSettingsCustomImage]] = ..., default_resource_spec: Optional[outputs.UserProfileUserSettingsRSessionAppSettingsDefaultResourceSpec] = ...) -> None:
...
class UserProfileUserSettingsSpaceStorageSettings(dict):
    ...
    def __init__(__self__, *, default_ebs_storage_settings: Optional[outputs.UserProfileUserSettingsSpaceStorageSettingsDefaultEbsStorageSettings] = ...) -> None:
...
class UserProfileUserSettingsTensorBoardAppSettings(dict):
    ...
    def __init__(__self__, *, default_resource_spec: Optional[outputs.UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec] = ...) -> None:
...
class WorkforceCognitoConfig(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, user_pool: _builtins.str) -> None:
...
class WorkforceOidcConfig(dict):
    ...
    def __init__(__self__, *, authorization_endpoint: _builtins.str, client_id: _builtins.str, client_secret: _builtins.str, issuer: _builtins.str, jwks_uri: _builtins.str, logout_endpoint: _builtins.str, token_endpoint: _builtins.str, user_info_endpoint: _builtins.str, authentication_request_extra_params: Optional[Mapping[str, _builtins.str]] = ..., scope: Optional[_builtins.str] = ...) -> None:
...
class WorkforceWorkforceVpcConfig(dict):
    ...
    def __init__(__self__, *, security_group_ids: Optional[Sequence[_builtins.str]] = ..., subnets: Optional[Sequence[_builtins.str]] = ..., vpc_endpoint_id: Optional[_builtins.str] = ..., vpc_id: Optional[_builtins.str] = ...) -> None:
...
class WorkteamMemberDefinition(dict):
    ...
    def __init__(__self__, *, cognito_member_definition: Optional[outputs.WorkteamMemberDefinitionCognitoMemberDefinition] = ..., oidc_member_definition: Optional[outputs.WorkteamMemberDefinitionOidcMemberDefinition] = ...) -> None:
...
class WorkteamMemberDefinitionCognitoMemberDefinition(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, user_group: _builtins.str, user_pool: _builtins.str) -> None:
...
class WorkteamNotificationConfiguration(dict):
    ...
    def __init__(__self__, *, notification_topic_arn: Optional[_builtins.str] = ...) -> None:
...
class WorkteamWorkerAccessConfiguration(dict):
    ...
    def __init__(__self__, *, s3_presign: Optional[outputs.WorkteamWorkerAccessConfigurationS3Presign] = ...) -> None:
...
class WorkteamWorkerAccessConfigurationS3Presign(dict):
    ...
    def __init__(__self__, *, iam_policy_constraints: Optional[outputs.WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraints] = ...) -> None:
...
class WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraints(dict):
    ...
    def __init__(__self__, *, source_ip: Optional[_builtins.str] = ..., vpc_source_ip: Optional[_builtins.str] = ...) -> None:
