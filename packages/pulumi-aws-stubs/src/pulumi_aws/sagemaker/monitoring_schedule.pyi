...
class MonitoringScheduleArgs:
    def __init__(
        __self__,
        *,
        monitoring_schedule_config: pulumi.Input[
    ...
    def monitoring_schedule_config(
        self,
    ) -> pulumi.Input[MonitoringScheduleMonitoringScheduleConfigArgs]: ...
    @monitoring_schedule_config.setter
    def monitoring_schedule_config(
        self, value: pulumi.Input[MonitoringScheduleMonitoringScheduleConfigArgs]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _MonitoringScheduleState:
    ...
    def monitoring_schedule_config(
        self,
        value: Optional[pulumi.Input[MonitoringScheduleMonitoringScheduleConfigArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter
    def name(self) -> Optional[pulumi.Input[_builtins.str]]: ...
...
class MonitoringSchedule(pulumi.CustomResource):
    ...
    def monitoring_schedule_config(
        self,
    ) -> pulumi.Output[outputs.MonitoringScheduleMonitoringScheduleConfig]: ...
    @_builtins.property
    @pulumi.getter
