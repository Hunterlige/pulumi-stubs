...
class GetModelResult:
    ...
    def __init__(__self__, customizations_supporteds=..., id=..., inference_types_supporteds=..., input_modalities=..., model_arn=..., model_id=..., model_name=..., output_modalities=..., provider_name=..., region=..., response_streaming_supported=...) -> None:
        ...
...
class AwaitableGetModelResult(GetModelResult):
    def __await__(self): # -> Generator[Never, Any, GetModelResult]:
        ...
    


def get_model(model_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetModelResult:
    
    ...

def get_model_output(model_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetModelResult]:
