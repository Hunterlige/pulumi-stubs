...
class GetModelsModelSummaryResult(dict):
    def __init__(__self__, *, customizations_supporteds: Sequence[_builtins.str], inference_types_supporteds: Sequence[_builtins.str], input_modalities: Sequence[_builtins.str], model_arn: _builtins.str, model_id: _builtins.str, model_name: _builtins.str, output_modalities: Sequence[_builtins.str], provider_name: _builtins.str, response_streaming_supported: _builtins.bool) -> None:
