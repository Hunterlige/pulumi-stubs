...
class DocumentClassifierInputDataConfig(dict):
    ...
    def __init__(__self__, *, augmented_manifests: Optional[Sequence[outputs.DocumentClassifierInputDataConfigAugmentedManifest]] = ..., data_format: Optional[_builtins.str] = ..., label_delimiter: Optional[_builtins.str] = ..., s3_uri: Optional[_builtins.str] = ..., test_s3_uri: Optional[_builtins.str] = ...) -> None:
...
class DocumentClassifierInputDataConfigAugmentedManifest(dict):
    ...
    def __init__(__self__, *, attribute_names: Sequence[_builtins.str], s3_uri: _builtins.str, annotation_data_s3_uri: Optional[_builtins.str] = ..., document_type: Optional[_builtins.str] = ..., source_documents_s3_uri: Optional[_builtins.str] = ..., split: Optional[_builtins.str] = ...) -> None:
...
class DocumentClassifierOutputDataConfig(dict):
    ...
    def __init__(__self__, *, s3_uri: _builtins.str, kms_key_id: Optional[_builtins.str] = ..., output_s3_uri: Optional[_builtins.str] = ...) -> None:
...
class EntityRecognizerInputDataConfig(dict):
    ...
    def __init__(__self__, *, entity_types: Sequence[outputs.EntityRecognizerInputDataConfigEntityType], annotations: Optional[outputs.EntityRecognizerInputDataConfigAnnotations] = ..., augmented_manifests: Optional[Sequence[outputs.EntityRecognizerInputDataConfigAugmentedManifest]] = ..., data_format: Optional[_builtins.str] = ..., documents: Optional[outputs.EntityRecognizerInputDataConfigDocuments] = ..., entity_list: Optional[outputs.EntityRecognizerInputDataConfigEntityList] = ...) -> None:
...
class EntityRecognizerInputDataConfigAnnotations(dict):
    ...
    def __init__(__self__, *, s3_uri: _builtins.str, test_s3_uri: Optional[_builtins.str] = ...) -> None:
...
class EntityRecognizerInputDataConfigDocuments(dict):
    ...
    def __init__(__self__, *, s3_uri: _builtins.str, input_format: Optional[_builtins.str] = ..., test_s3_uri: Optional[_builtins.str] = ...) -> None:
