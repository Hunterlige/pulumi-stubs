...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BillingGroupMetadataArgs', 'BillingGroupMetadataArgsDict', 'BillingGroupPropertiesArgs', 'BillingGroupPropertiesArgsDict', 'CaCertificateRegistrationConfigArgs', 'CaCertificateRegistrationConfigArgsDict', 'CaCertificateValidityArgs', 'CaCertificateValidityArgsDict', 'DomainConfigurationAuthorizerConfigArgs', 'DomainConfigurationAuthorizerConfigArgsDict', 'DomainConfigurationTlsConfigArgs', 'DomainConfigurationTlsConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ProvisioningTemplatePreProvisioningHookArgs', 'ProvisioningTemplatePreProvisioningHookArgsDict', 'ThingGroupMetadataArgs', 'ThingGroupMetadataArgsDict', 'ThingGroupMetadataRootToParentGroupArgs', 'ThingGroupMetadataRootToParentGroupArgsDict', 'ThingGroupPropertiesArgs', 'ThingGroupPropertiesArgsDict', 'ThingGroupPropertiesAttributePayloadArgs', 'ThingGroupPropertiesAttributePayloadArgsDict', 'ThingTypePropertiesArgs', 'ThingTypePropertiesArgsDict', 'TopicRuleCloudwatchAlarmArgs', 'TopicRuleCloudwatchAlarmArgsDict', 'TopicRuleCloudwatchLogArgs', 'TopicRuleCloudwatchLogArgsDict', 'TopicRuleCloudwatchMetricArgs', 'TopicRuleCloudwatchMetricArgsDict', 'TopicRuleDestinationVpcConfigurationArgs', 'TopicRuleDestinationVpcConfigurationArgsDict', 'TopicRuleDynamodbArgs', 'TopicRuleDynamodbArgsDict', 'TopicRuleDynamodbv2Args', 'TopicRuleDynamodbv2ArgsDict', 'TopicRuleDynamodbv2PutItemArgs', 'TopicRuleDynamodbv2PutItemArgsDict', 'TopicRuleElasticsearchArgs', 'TopicRuleElasticsearchArgsDict', 'TopicRuleErrorActionArgs', 'TopicRuleErrorActionArgsDict', 'TopicRuleErrorActionCloudwatchAlarmArgs', 'TopicRuleErrorActionCloudwatchAlarmArgsDict', 'TopicRuleErrorActionCloudwatchLogsArgs', 'TopicRuleErrorActionCloudwatchLogsArgsDict', 'TopicRuleErrorActionCloudwatchMetricArgs', 'TopicRuleErrorActionCloudwatchMetricArgsDict', 'TopicRuleErrorActionDynamodbArgs', 'TopicRuleErrorActionDynamodbArgsDict', 'TopicRuleErrorActionDynamodbv2Args', 'TopicRuleErrorActionDynamodbv2ArgsDict', 'TopicRuleErrorActionDynamodbv2PutItemArgs', 'TopicRuleErrorActionDynamodbv2PutItemArgsDict', 'TopicRuleErrorActionElasticsearchArgs', 'TopicRuleErrorActionElasticsearchArgsDict', 'TopicRuleErrorActionFirehoseArgs', 'TopicRuleErrorActionFirehoseArgsDict', 'TopicRuleErrorActionHttpArgs', 'TopicRuleErrorActionHttpArgsDict', 'TopicRuleErrorActionHttpHttpHeaderArgs', 'TopicRuleErrorActionHttpHttpHeaderArgsDict', 'TopicRuleErrorActionIotAnalyticsArgs', 'TopicRuleErrorActionIotAnalyticsArgsDict', 'TopicRuleErrorActionIotEventsArgs', 'TopicRuleErrorActionIotEventsArgsDict', 'TopicRuleErrorActionKafkaArgs', 'TopicRuleErrorActionKafkaArgsDict', 'TopicRuleErrorActionKafkaHeaderArgs', 'TopicRuleErrorActionKafkaHeaderArgsDict', 'TopicRuleErrorActionKinesisArgs', 'TopicRuleErrorActionKinesisArgsDict', 'TopicRuleErrorActionLambdaArgs', 'TopicRuleErrorActionLambdaArgsDict', 'TopicRuleErrorActionRepublishArgs', 'TopicRuleErrorActionRepublishArgsDict', 'TopicRuleErrorActionS3Args', 'TopicRuleErrorActionS3ArgsDict', 'TopicRuleErrorActionSnsArgs', 'TopicRuleErrorActionSnsArgsDict', 'TopicRuleErrorActionSqsArgs', 'TopicRuleErrorActionSqsArgsDict', 'TopicRuleErrorActionStepFunctionsArgs', 'TopicRuleErrorActionStepFunctionsArgsDict', 'TopicRuleErrorActionTimestreamArgs', 'TopicRuleErrorActionTimestreamArgsDict', 'TopicRuleErrorActionTimestreamDimensionArgs', 'TopicRuleErrorActionTimestreamDimensionArgsDict', 'TopicRuleErrorActionTimestreamTimestampArgs', 'TopicRuleErrorActionTimestreamTimestampArgsDict', 'TopicRuleFirehoseArgs', 'TopicRuleFirehoseArgsDict', 'TopicRuleHttpArgs', 'TopicRuleHttpArgsDict', 'TopicRuleHttpHttpHeaderArgs', 'TopicRuleHttpHttpHeaderArgsDict', 'TopicRuleIotAnalyticArgs', 'TopicRuleIotAnalyticArgsDict', 'TopicRuleIotEventArgs', 'TopicRuleIotEventArgsDict', 'TopicRuleKafkaArgs', 'TopicRuleKafkaArgsDict', 'TopicRuleKafkaHeaderArgs', 'TopicRuleKafkaHeaderArgsDict', 'TopicRuleKinesisArgs', 'TopicRuleKinesisArgsDict', 'TopicRuleLambdaArgs', 'TopicRuleLambdaArgsDict', 'TopicRuleRepublishArgs', 'TopicRuleRepublishArgsDict', 'TopicRuleS3Args', 'TopicRuleS3ArgsDict', 'TopicRuleSnsArgs', 'TopicRuleSnsArgsDict', 'TopicRuleSqsArgs', 'TopicRuleSqsArgsDict', 'TopicRuleStepFunctionArgs', 'TopicRuleStepFunctionArgsDict', 'TopicRuleTimestreamArgs', 'TopicRuleTimestreamArgsDict', 'TopicRuleTimestreamDimensionArgs', 'TopicRuleTimestreamDimensionArgsDict', 'TopicRuleTimestreamTimestampArgs', 'TopicRuleTimestreamTimestampArgsDict']
...
class CaCertificateRegistrationConfigArgs:
    def __init__(__self__, *, role_arn: Optional[pulumi.Input[_builtins.str]] = ..., template_body: Optional[pulumi.Input[_builtins.str]] = ..., template_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CaCertificateValidityArgs:
    def __init__(__self__, *, not_after: Optional[pulumi.Input[_builtins.str]] = ..., not_before: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DomainConfigurationAuthorizerConfigArgs:
    def __init__(__self__, *, allow_authorizer_override: Optional[pulumi.Input[_builtins.bool]] = ..., default_authorizer_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allow_authorizer_override(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def default_authorizer_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DomainConfigurationTlsConfigArgs:
    def __init__(__self__, *, security_policy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class IndexingConfigurationThingGroupIndexingConfigurationArgs:
    def __init__(__self__, *, thing_group_indexing_mode: pulumi.Input[_builtins.str], custom_fields: Optional[pulumi.Input[Sequence[pulumi.Input[IndexingConfigurationThingGroupIndexingConfigurationCustomFieldArgs]]]] = ..., managed_fields: Optional[pulumi.Input[Sequence[pulumi.Input[IndexingConfigurationThingGroupIndexingConfigurationManagedFieldArgs]]]] = ...) -> None:
    ...
    def thing_group_indexing_mode(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def custom_fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IndexingConfigurationThingGroupIndexingConfigurationCustomFieldArgs]]]]): # -> None:
        ...
    ...
    def managed_fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IndexingConfigurationThingGroupIndexingConfigurationManagedFieldArgs]]]]): # -> None:
        ...
...
class IndexingConfigurationThingIndexingConfigurationArgs:
    def __init__(__self__, *, thing_indexing_mode: pulumi.Input[_builtins.str], custom_fields: Optional[pulumi.Input[Sequence[pulumi.Input[IndexingConfigurationThingIndexingConfigurationCustomFieldArgs]]]] = ..., device_defender_indexing_mode: Optional[pulumi.Input[_builtins.str]] = ..., filter: Optional[pulumi.Input[IndexingConfigurationThingIndexingConfigurationFilterArgs]] = ..., managed_fields: Optional[pulumi.Input[Sequence[pulumi.Input[IndexingConfigurationThingIndexingConfigurationManagedFieldArgs]]]] = ..., named_shadow_indexing_mode: Optional[pulumi.Input[_builtins.str]] = ..., thing_connectivity_indexing_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def thing_indexing_mode(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @custom_fields.setter
    def custom_fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IndexingConfigurationThingIndexingConfigurationCustomFieldArgs]]]]): # -> None:
        ...
    ...
    def device_defender_indexing_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @filter.setter
    def filter(self, value: Optional[pulumi.Input[IndexingConfigurationThingIndexingConfigurationFilterArgs]]): # -> None:
        ...
    ...
    @managed_fields.setter
    def managed_fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[IndexingConfigurationThingIndexingConfigurationManagedFieldArgs]]]]): # -> None:
        ...
    ...
    def named_shadow_indexing_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def thing_connectivity_indexing_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IndexingConfigurationThingIndexingConfigurationFilterArgs:
    def __init__(__self__, *, named_shadow_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def named_shadow_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ProvisioningTemplatePreProvisioningHookArgs:
    def __init__(__self__, *, target_arn: pulumi.Input[_builtins.str], payload_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def payload_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ThingGroupMetadataArgs:
    def __init__(__self__, *, creation_date: Optional[pulumi.Input[_builtins.str]] = ..., parent_group_name: Optional[pulumi.Input[_builtins.str]] = ..., root_to_parent_groups: Optional[pulumi.Input[Sequence[pulumi.Input[ThingGroupMetadataRootToParentGroupArgs]]]] = ...) -> None:
    ...
    def parent_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def root_to_parent_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ThingGroupMetadataRootToParentGroupArgs]]]]): # -> None:
        ...
...
class ThingGroupMetadataRootToParentGroupArgs:
    def __init__(__self__, *, group_arn: Optional[pulumi.Input[_builtins.str]] = ..., group_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
...
class ThingGroupPropertiesArgs:
    def __init__(__self__, *, attribute_payload: Optional[pulumi.Input[ThingGroupPropertiesAttributePayloadArgs]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def attribute_payload(self, value: Optional[pulumi.Input[ThingGroupPropertiesAttributePayloadArgs]]): # -> None:
        ...
...
class ThingTypePropertiesArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., searchable_attributes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def searchable_attributes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class TopicRuleCloudwatchAlarmArgs:
    def __init__(__self__, *, alarm_name: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], state_reason: pulumi.Input[_builtins.str], state_value: pulumi.Input[_builtins.str]) -> None:
    ...
    @state_reason.setter
    def state_reason(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @state_value.setter
    def state_value(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TopicRuleCloudwatchLogArgs:
    def __init__(__self__, *, log_group_name: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], batch_mode: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @batch_mode.setter
    def batch_mode(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class TopicRuleCloudwatchMetricArgs:
    def __init__(__self__, *, metric_name: pulumi.Input[_builtins.str], metric_namespace: pulumi.Input[_builtins.str], metric_unit: pulumi.Input[_builtins.str], metric_value: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], metric_timestamp: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @metric_unit.setter
    def metric_unit(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @metric_value.setter
    def metric_value(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def metric_timestamp(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TopicRuleDestinationVpcConfigurationArgs:
    def __init__(__self__, *, role_arn: pulumi.Input[_builtins.str], subnet_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], vpc_id: pulumi.Input[_builtins.str], security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class TopicRuleDynamodbArgs:
    def __init__(__self__, *, hash_key_field: pulumi.Input[_builtins.str], hash_key_value: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], table_name: pulumi.Input[_builtins.str], hash_key_type: Optional[pulumi.Input[_builtins.str]] = ..., operation: Optional[pulumi.Input[_builtins.str]] = ..., payload_field: Optional[pulumi.Input[_builtins.str]] = ..., range_key_field: Optional[pulumi.Input[_builtins.str]] = ..., range_key_type: Optional[pulumi.Input[_builtins.str]] = ..., range_key_value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def hash_key_field(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def hash_key_value(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def hash_key_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def payload_field(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def range_key_field(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def range_key_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def range_key_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TopicRuleDynamodbv2Args:
    def __init__(__self__, *, role_arn: pulumi.Input[_builtins.str], put_item: Optional[pulumi.Input[TopicRuleDynamodbv2PutItemArgs]] = ...) -> None:
    ...
    @put_item.setter
    def put_item(self, value: Optional[pulumi.Input[TopicRuleDynamodbv2PutItemArgs]]): # -> None:
        ...
...
class TopicRuleElasticsearchArgs:
    def __init__(__self__, *, endpoint: pulumi.Input[_builtins.str], id: pulumi.Input[_builtins.str], index: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str]) -> None:
...
class TopicRuleErrorActionArgs:
    def __init__(__self__, *, cloudwatch_alarm: Optional[pulumi.Input[TopicRuleErrorActionCloudwatchAlarmArgs]] = ..., cloudwatch_logs: Optional[pulumi.Input[TopicRuleErrorActionCloudwatchLogsArgs]] = ..., cloudwatch_metric: Optional[pulumi.Input[TopicRuleErrorActionCloudwatchMetricArgs]] = ..., dynamodb: Optional[pulumi.Input[TopicRuleErrorActionDynamodbArgs]] = ..., dynamodbv2: Optional[pulumi.Input[TopicRuleErrorActionDynamodbv2Args]] = ..., elasticsearch: Optional[pulumi.Input[TopicRuleErrorActionElasticsearchArgs]] = ..., firehose: Optional[pulumi.Input[TopicRuleErrorActionFirehoseArgs]] = ..., http: Optional[pulumi.Input[TopicRuleErrorActionHttpArgs]] = ..., iot_analytics: Optional[pulumi.Input[TopicRuleErrorActionIotAnalyticsArgs]] = ..., iot_events: Optional[pulumi.Input[TopicRuleErrorActionIotEventsArgs]] = ..., kafka: Optional[pulumi.Input[TopicRuleErrorActionKafkaArgs]] = ..., kinesis: Optional[pulumi.Input[TopicRuleErrorActionKinesisArgs]] = ..., lambda_: Optional[pulumi.Input[TopicRuleErrorActionLambdaArgs]] = ..., republish: Optional[pulumi.Input[TopicRuleErrorActionRepublishArgs]] = ..., s3: Optional[pulumi.Input[TopicRuleErrorActionS3Args]] = ..., sns: Optional[pulumi.Input[TopicRuleErrorActionSnsArgs]] = ..., sqs: Optional[pulumi.Input[TopicRuleErrorActionSqsArgs]] = ..., step_functions: Optional[pulumi.Input[TopicRuleErrorActionStepFunctionsArgs]] = ..., timestream: Optional[pulumi.Input[TopicRuleErrorActionTimestreamArgs]] = ...) -> None:
        ...
    ...
    def cloudwatch_alarm(self, value: Optional[pulumi.Input[TopicRuleErrorActionCloudwatchAlarmArgs]]): # -> None:
        ...
    ...
    def cloudwatch_logs(self, value: Optional[pulumi.Input[TopicRuleErrorActionCloudwatchLogsArgs]]): # -> None:
        ...
    ...
    def cloudwatch_metric(self, value: Optional[pulumi.Input[TopicRuleErrorActionCloudwatchMetricArgs]]): # -> None:
        ...
    ...
    @dynamodb.setter
    def dynamodb(self, value: Optional[pulumi.Input[TopicRuleErrorActionDynamodbArgs]]): # -> None:
        ...
    ...
    @dynamodbv2.setter
    def dynamodbv2(self, value: Optional[pulumi.Input[TopicRuleErrorActionDynamodbv2Args]]): # -> None:
        ...
    ...
    def elasticsearch(self, value: Optional[pulumi.Input[TopicRuleErrorActionElasticsearchArgs]]): # -> None:
        ...
    ...
    @firehose.setter
    def firehose(self, value: Optional[pulumi.Input[TopicRuleErrorActionFirehoseArgs]]): # -> None:
        ...
    ...
    @http.setter
    def http(self, value: Optional[pulumi.Input[TopicRuleErrorActionHttpArgs]]): # -> None:
        ...
    ...
    def iot_analytics(self, value: Optional[pulumi.Input[TopicRuleErrorActionIotAnalyticsArgs]]): # -> None:
        ...
    ...
    @iot_events.setter
    def iot_events(self, value: Optional[pulumi.Input[TopicRuleErrorActionIotEventsArgs]]): # -> None:
        ...
    ...
    @kafka.setter
    def kafka(self, value: Optional[pulumi.Input[TopicRuleErrorActionKafkaArgs]]): # -> None:
        ...
    ...
    @kinesis.setter
    def kinesis(self, value: Optional[pulumi.Input[TopicRuleErrorActionKinesisArgs]]): # -> None:
        ...
    ...
    @lambda_.setter
    def lambda_(self, value: Optional[pulumi.Input[TopicRuleErrorActionLambdaArgs]]): # -> None:
        ...
    ...
    @republish.setter
    def republish(self, value: Optional[pulumi.Input[TopicRuleErrorActionRepublishArgs]]): # -> None:
        ...
    ...
    @s3.setter
    def s3(self, value: Optional[pulumi.Input[TopicRuleErrorActionS3Args]]): # -> None:
        ...
    ...
    @sns.setter
    def sns(self, value: Optional[pulumi.Input[TopicRuleErrorActionSnsArgs]]): # -> None:
        ...
    ...
    @sqs.setter
    def sqs(self, value: Optional[pulumi.Input[TopicRuleErrorActionSqsArgs]]): # -> None:
        ...
    ...
    def step_functions(self, value: Optional[pulumi.Input[TopicRuleErrorActionStepFunctionsArgs]]): # -> None:
        ...
    ...
    @timestream.setter
    def timestream(self, value: Optional[pulumi.Input[TopicRuleErrorActionTimestreamArgs]]): # -> None:
        ...
...
class TopicRuleErrorActionDynamodbv2Args:
    def __init__(__self__, *, role_arn: pulumi.Input[_builtins.str], put_item: Optional[pulumi.Input[TopicRuleErrorActionDynamodbv2PutItemArgs]] = ...) -> None:
    ...
    @put_item.setter
    def put_item(self, value: Optional[pulumi.Input[TopicRuleErrorActionDynamodbv2PutItemArgs]]): # -> None:
        ...
...
class TopicRuleErrorActionFirehoseArgs:
    def __init__(__self__, *, delivery_stream_name: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], batch_mode: Optional[pulumi.Input[_builtins.bool]] = ..., separator: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def delivery_stream_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TopicRuleErrorActionHttpArgs:
    def __init__(__self__, *, url: pulumi.Input[_builtins.str], confirmation_url: Optional[pulumi.Input[_builtins.str]] = ..., http_headers: Optional[pulumi.Input[Sequence[pulumi.Input[TopicRuleErrorActionHttpHttpHeaderArgs]]]] = ...) -> None:
    ...
    def confirmation_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TopicRuleErrorActionHttpHttpHeaderArgs]]]]): # -> None:
        ...
...
class TopicRuleErrorActionIotAnalyticsArgs:
    def __init__(__self__, *, channel_name: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], batch_mode: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class TopicRuleErrorActionIotEventsArgs:
    def __init__(__self__, *, input_name: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], batch_mode: Optional[pulumi.Input[_builtins.bool]] = ..., message_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @input_name.setter
    def input_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TopicRuleErrorActionKafkaArgs:
    def __init__(__self__, *, client_properties: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], destination_arn: pulumi.Input[_builtins.str], topic: pulumi.Input[_builtins.str], headers: Optional[pulumi.Input[Sequence[pulumi.Input[TopicRuleErrorActionKafkaHeaderArgs]]]] = ..., key: Optional[pulumi.Input[_builtins.str]] = ..., partition: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def client_properties(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @headers.setter
    def headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TopicRuleErrorActionKafkaHeaderArgs]]]]): # -> None:
        ...
...
class TopicRuleErrorActionKinesisArgs:
    def __init__(__self__, *, role_arn: pulumi.Input[_builtins.str], stream_name: pulumi.Input[_builtins.str], partition_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TopicRuleErrorActionRepublishArgs:
    def __init__(__self__, *, role_arn: pulumi.Input[_builtins.str], topic: pulumi.Input[_builtins.str], qos: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class TopicRuleErrorActionS3Args:
    def __init__(__self__, *, bucket_name: pulumi.Input[_builtins.str], key: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], canned_acl: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TopicRuleErrorActionSnsArgs:
    def __init__(__self__, *, role_arn: pulumi.Input[_builtins.str], target_arn: pulumi.Input[_builtins.str], message_format: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TopicRuleErrorActionSqsArgs:
    def __init__(__self__, *, queue_url: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], use_base64: pulumi.Input[_builtins.bool]) -> None:
    ...
    @use_base64.setter
    def use_base64(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class TopicRuleErrorActionStepFunctionsArgs:
    def __init__(__self__, *, role_arn: pulumi.Input[_builtins.str], state_machine_name: pulumi.Input[_builtins.str], execution_name_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def state_machine_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def execution_name_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TopicRuleErrorActionTimestreamArgs:
    def __init__(__self__, *, database_name: pulumi.Input[_builtins.str], dimensions: pulumi.Input[Sequence[pulumi.Input[TopicRuleErrorActionTimestreamDimensionArgs]]], role_arn: pulumi.Input[_builtins.str], table_name: pulumi.Input[_builtins.str], timestamp: Optional[pulumi.Input[TopicRuleErrorActionTimestreamTimestampArgs]] = ...) -> None:
    ...
    @dimensions.setter
    def dimensions(self, value: pulumi.Input[Sequence[pulumi.Input[TopicRuleErrorActionTimestreamDimensionArgs]]]): # -> None:
        ...
    ...
    @timestamp.setter
    def timestamp(self, value: Optional[pulumi.Input[TopicRuleErrorActionTimestreamTimestampArgs]]): # -> None:
        ...
...
class TopicRuleErrorActionTimestreamTimestampArgs:
    def __init__(__self__, *, unit: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str]) -> None:
...
class TopicRuleHttpArgs:
    def __init__(__self__, *, url: pulumi.Input[_builtins.str], confirmation_url: Optional[pulumi.Input[_builtins.str]] = ..., http_headers: Optional[pulumi.Input[Sequence[pulumi.Input[TopicRuleHttpHttpHeaderArgs]]]] = ...) -> None:
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TopicRuleHttpHttpHeaderArgs]]]]): # -> None:
        ...
...
class TopicRuleKafkaArgs:
    def __init__(__self__, *, client_properties: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], destination_arn: pulumi.Input[_builtins.str], topic: pulumi.Input[_builtins.str], headers: Optional[pulumi.Input[Sequence[pulumi.Input[TopicRuleKafkaHeaderArgs]]]] = ..., key: Optional[pulumi.Input[_builtins.str]] = ..., partition: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @headers.setter
    def headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TopicRuleKafkaHeaderArgs]]]]): # -> None:
        ...
...
class TopicRuleTimestreamArgs:
    def __init__(__self__, *, database_name: pulumi.Input[_builtins.str], dimensions: pulumi.Input[Sequence[pulumi.Input[TopicRuleTimestreamDimensionArgs]]], role_arn: pulumi.Input[_builtins.str], table_name: pulumi.Input[_builtins.str], timestamp: Optional[pulumi.Input[TopicRuleTimestreamTimestampArgs]] = ...) -> None:
    ...
    @dimensions.setter
    def dimensions(self, value: pulumi.Input[Sequence[pulumi.Input[TopicRuleTimestreamDimensionArgs]]]): # -> None:
        ...
    ...
    @timestamp.setter
    def timestamp(self, value: Optional[pulumi.Input[TopicRuleTimestreamTimestampArgs]]): # -> None:
        ...
