...
class ThingTypeArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[pulumi.Input[ThingTypePropertiesArgs]] = ...,
...
class ThingType(pulumi.CustomResource):
    ...
    def __init__(
        ...
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        properties: Optional[
            pulumi.Input[Union[ThingTypePropertiesArgs, ThingTypePropertiesArgsDict]]
        ] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        __props__=...,
