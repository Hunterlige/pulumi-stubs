...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterClusterEndpointArgs', 'ClusterClusterEndpointArgsDict', 'SafetyRuleRuleConfigArgs', 'SafetyRuleRuleConfigArgsDict']
...
class ClusterClusterEndpointArgs:
    def __init__(__self__, *, endpoint: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SafetyRuleRuleConfigArgs:
    def __init__(__self__, *, inverted: pulumi.Input[_builtins.bool], threshold: pulumi.Input[_builtins.int], type: pulumi.Input[_builtins.str]) -> None:
    ...
    @inverted.setter
    def inverted(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
