...
class AnomalyMonitorArgs:
    def __init__(
        ...
        *,
        ...
        monitor_dimension: Optional[pulumi.Input[_builtins.str]] = ...,
        monitor_specification: Optional[pulumi.Input[_builtins.str]] = ...,
...
class _AnomalyMonitorState:
    def __init__(
        ...
        *,
        ...
        monitor_dimension: Optional[pulumi.Input[_builtins.str]] = ...,
        monitor_specification: Optional[pulumi.Input[_builtins.str]] = ...,
        monitor_type: Optional[pulumi.Input[_builtins.str]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        tags_all: Optional[
