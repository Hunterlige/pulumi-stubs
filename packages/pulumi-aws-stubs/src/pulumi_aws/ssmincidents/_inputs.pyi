...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ReplicationSetRegionArgs', 'ReplicationSetRegionArgsDict', 'ResponsePlanActionArgs', 'ResponsePlanActionArgsDict', 'ResponsePlanActionSsmAutomationArgs', 'ResponsePlanActionSsmAutomationArgsDict', 'ResponsePlanActionSsmAutomationParameterArgs', 'ResponsePlanActionSsmAutomationParameterArgsDict', 'ResponsePlanIncidentTemplateArgs', 'ResponsePlanIncidentTemplateArgsDict', 'ResponsePlanIncidentTemplateNotificationTargetArgs', ..., 'ResponsePlanIntegrationArgs', 'ResponsePlanIntegrationArgsDict', 'ResponsePlanIntegrationPagerdutyArgs', 'ResponsePlanIntegrationPagerdutyArgsDict']
...
class ReplicationSetRegionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], kms_key_arn: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., status_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ResponsePlanActionArgs:
    def __init__(__self__, *, ssm_automations: Optional[pulumi.Input[Sequence[pulumi.Input[ResponsePlanActionSsmAutomationArgs]]]] = ...) -> None:
    ...
    def ssm_automations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResponsePlanActionSsmAutomationArgs]]]]): # -> None:
        ...
...
class ResponsePlanActionSsmAutomationArgs:
    def __init__(__self__, *, document_name: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], document_version: Optional[pulumi.Input[_builtins.str]] = ..., dynamic_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[ResponsePlanActionSsmAutomationParameterArgs]]]] = ..., target_account: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def document_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def dynamic_parameters(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResponsePlanActionSsmAutomationParameterArgs]]]]): # -> None:
        ...
    ...
    def target_account(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ResponsePlanIncidentTemplateArgs:
    def __init__(__self__, *, impact: pulumi.Input[_builtins.int], title: pulumi.Input[_builtins.str], dedupe_string: Optional[pulumi.Input[_builtins.str]] = ..., incident_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., notification_targets: Optional[pulumi.Input[Sequence[pulumi.Input[ResponsePlanIncidentTemplateNotificationTargetArgs]]]] = ..., summary: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @impact.setter
    def impact(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def dedupe_string(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def incident_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def notification_targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResponsePlanIncidentTemplateNotificationTargetArgs]]]]): # -> None:
        ...
...
class ResponsePlanIntegrationArgs:
    def __init__(__self__, *, pagerduties: Optional[pulumi.Input[Sequence[pulumi.Input[ResponsePlanIntegrationPagerdutyArgs]]]] = ...) -> None:
    ...
    @pagerduties.setter
    def pagerduties(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ResponsePlanIntegrationPagerdutyArgs]]]]): # -> None:
        ...
...
class ResponsePlanIntegrationPagerdutyArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], secret_id: pulumi.Input[_builtins.str], service_id: pulumi.Input[_builtins.str]) -> None:
