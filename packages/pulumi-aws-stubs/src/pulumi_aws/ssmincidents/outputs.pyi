...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ReplicationSetRegion', 'ResponsePlanAction', 'ResponsePlanActionSsmAutomation', 'ResponsePlanActionSsmAutomationParameter', 'ResponsePlanIncidentTemplate', 'ResponsePlanIncidentTemplateNotificationTarget', 'ResponsePlanIntegration', 'ResponsePlanIntegrationPagerduty', 'GetReplicationSetRegionResult', 'GetResponsePlanActionResult', 'GetResponsePlanActionSsmAutomationResult', 'GetResponsePlanActionSsmAutomationParameterResult', 'GetResponsePlanIncidentTemplateResult', ..., 'GetResponsePlanIntegrationResult', 'GetResponsePlanIntegrationPagerdutyResult']
@pulumi.output_type
class ReplicationSetRegion(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, kms_key_arn: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., status_message: Optional[_builtins.str] = ...) -> None:
...
class ResponsePlanAction(dict):
    ...
    def __init__(__self__, *, ssm_automations: Optional[Sequence[outputs.ResponsePlanActionSsmAutomation]] = ...) -> None:
...
class ResponsePlanActionSsmAutomation(dict):
    ...
    def __init__(__self__, *, document_name: _builtins.str, role_arn: _builtins.str, document_version: Optional[_builtins.str] = ..., dynamic_parameters: Optional[Mapping[str, _builtins.str]] = ..., parameters: Optional[Sequence[outputs.ResponsePlanActionSsmAutomationParameter]] = ..., target_account: Optional[_builtins.str] = ...) -> None:
...
class ResponsePlanIncidentTemplate(dict):
    ...
    def __init__(__self__, *, impact: _builtins.int, title: _builtins.str, dedupe_string: Optional[_builtins.str] = ..., incident_tags: Optional[Mapping[str, _builtins.str]] = ..., notification_targets: Optional[Sequence[outputs.ResponsePlanIncidentTemplateNotificationTarget]] = ..., summary: Optional[_builtins.str] = ...) -> None:
...
class ResponsePlanIntegration(dict):
    def __init__(__self__, *, pagerduties: Optional[Sequence[outputs.ResponsePlanIntegrationPagerduty]] = ...) -> None:
...
class ResponsePlanIntegrationPagerduty(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, secret_id: _builtins.str, service_id: _builtins.str) -> None:
...
class GetReplicationSetRegionResult(dict):
    def __init__(__self__, *, kms_key_arn: _builtins.str, name: _builtins.str, status: _builtins.str, status_message: _builtins.str) -> None:
...
class GetResponsePlanActionResult(dict):
    def __init__(__self__, *, ssm_automations: Sequence[outputs.GetResponsePlanActionSsmAutomationResult]) -> None:
...
class GetResponsePlanActionSsmAutomationResult(dict):
    def __init__(__self__, *, document_name: _builtins.str, document_version: _builtins.str, dynamic_parameters: Mapping[str, _builtins.str], parameters: Sequence[outputs.GetResponsePlanActionSsmAutomationParameterResult], role_arn: _builtins.str, target_account: _builtins.str) -> None:
...
class GetResponsePlanIncidentTemplateResult(dict):
    def __init__(__self__, *, dedupe_string: _builtins.str, impact: _builtins.int, incident_tags: Mapping[str, _builtins.str], notification_targets: Sequence[outputs.GetResponsePlanIncidentTemplateNotificationTargetResult], summary: _builtins.str, title: _builtins.str) -> None:
...
class GetResponsePlanIntegrationResult(dict):
    def __init__(__self__, *, pagerduties: Sequence[outputs.GetResponsePlanIntegrationPagerdutyResult]) -> None:
