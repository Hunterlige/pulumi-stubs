...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AliasRoutingConfigArgs', 'AliasRoutingConfigArgsDict', 'CapacityProviderCapacityProviderScalingConfigArgs', ..., ..., ..., 'CapacityProviderInstanceRequirementArgs', 'CapacityProviderInstanceRequirementArgsDict', 'CapacityProviderPermissionsConfigArgs', 'CapacityProviderPermissionsConfigArgsDict', 'CapacityProviderTimeoutsArgs', 'CapacityProviderTimeoutsArgsDict', 'CapacityProviderVpcConfigArgs', 'CapacityProviderVpcConfigArgsDict', 'CodeSigningConfigAllowedPublishersArgs', 'CodeSigningConfigAllowedPublishersArgsDict', 'CodeSigningConfigPoliciesArgs', 'CodeSigningConfigPoliciesArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'EventSourceMappingDestinationConfigArgs', 'EventSourceMappingDestinationConfigArgsDict', 'EventSourceMappingDestinationConfigOnFailureArgs', ..., 'EventSourceMappingDocumentDbEventSourceConfigArgs', ..., 'EventSourceMappingFilterCriteriaArgs', 'EventSourceMappingFilterCriteriaArgsDict', 'EventSourceMappingFilterCriteriaFilterArgs', 'EventSourceMappingFilterCriteriaFilterArgsDict', 'EventSourceMappingMetricsConfigArgs', 'EventSourceMappingMetricsConfigArgsDict', 'EventSourceMappingProvisionedPollerConfigArgs', 'EventSourceMappingProvisionedPollerConfigArgsDict', 'EventSourceMappingScalingConfigArgs', 'EventSourceMappingScalingConfigArgsDict', 'EventSourceMappingSelfManagedEventSourceArgs', 'EventSourceMappingSelfManagedEventSourceArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'EventSourceMappingSourceAccessConfigurationArgs', ..., 'FunctionCapacityProviderConfigArgs', 'FunctionCapacityProviderConfigArgsDict', ..., ..., 'FunctionDeadLetterConfigArgs', 'FunctionDeadLetterConfigArgsDict', 'FunctionDurableConfigArgs', 'FunctionDurableConfigArgsDict', 'FunctionEnvironmentArgs', 'FunctionEnvironmentArgsDict', 'FunctionEphemeralStorageArgs', 'FunctionEphemeralStorageArgsDict', 'FunctionEventInvokeConfigDestinationConfigArgs', 'FunctionEventInvokeConfigDestinationConfigArgsDict', ..., ..., ..., ..., 'FunctionFileSystemConfigArgs', 'FunctionFileSystemConfigArgsDict', 'FunctionImageConfigArgs', 'FunctionImageConfigArgsDict', 'FunctionLoggingConfigArgs', 'FunctionLoggingConfigArgsDict', 'FunctionSnapStartArgs', 'FunctionSnapStartArgsDict', 'FunctionTenancyConfigArgs', 'FunctionTenancyConfigArgsDict', 'FunctionTracingConfigArgs', 'FunctionTracingConfigArgsDict', 'FunctionUrlCorsArgs', 'FunctionUrlCorsArgsDict', 'FunctionVpcConfigArgs', 'FunctionVpcConfigArgsDict']
...
class AliasRoutingConfigArgs:
    def __init__(__self__, *, additional_version_weights: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.float]]]] = ...) -> None:
    ...
    def additional_version_weights(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.float]]]]): # -> None:
        ...
...
class CapacityProviderCapacityProviderScalingConfigArgs:
    def __init__(__self__, *, max_vcpu_count: pulumi.Input[_builtins.int], scaling_mode: pulumi.Input[_builtins.str], scaling_policies: pulumi.Input[Sequence[pulumi.Input[CapacityProviderCapacityProviderScalingConfigScalingPolicyArgs]]]) -> None:
    ...
    def max_vcpu_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def scaling_policies(self, value: pulumi.Input[Sequence[pulumi.Input[CapacityProviderCapacityProviderScalingConfigScalingPolicyArgs]]]): # -> None:
        ...
...
class CapacityProviderCapacityProviderScalingConfigScalingPolicyArgs:
    def __init__(__self__, *, predefined_metric_type: pulumi.Input[_builtins.str], target_value: pulumi.Input[_builtins.float]) -> None:
...
class CapacityProviderInstanceRequirementArgs:
    def __init__(__self__, *, allowed_instance_types: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], architectures: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], excluded_instance_types: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def allowed_instance_types(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def architectures(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def excluded_instance_types(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class CapacityProviderPermissionsConfigArgs:
    def __init__(__self__, *, capacity_provider_operator_role_arn: pulumi.Input[_builtins.str]) -> None:
    ...
    def capacity_provider_operator_role_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class CodeSigningConfigAllowedPublishersArgs:
    def __init__(__self__, *, signing_profile_version_arns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def signing_profile_version_arns(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class CodeSigningConfigPoliciesArgs:
    def __init__(__self__, *, untrusted_artifact_on_deployment: pulumi.Input[_builtins.str]) -> None:
    ...
    def untrusted_artifact_on_deployment(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class EventSourceMappingAmazonManagedKafkaEventSourceConfigArgs:
    def __init__(__self__, *, consumer_group_id: Optional[pulumi.Input[_builtins.str]] = ..., schema_registry_config: Optional[pulumi.Input[EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigArgs]] = ...) -> None:
    ...
    def schema_registry_config(self, value: Optional[pulumi.Input[EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigArgs]]): # -> None:
        ...
...
class EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigArgs:
    def __init__(__self__, *, access_configs: Optional[pulumi.Input[Sequence[pulumi.Input[EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigAccessConfigArgs]]]] = ..., event_record_format: Optional[pulumi.Input[_builtins.str]] = ..., schema_registry_uri: Optional[pulumi.Input[_builtins.str]] = ..., schema_validation_configs: Optional[pulumi.Input[Sequence[pulumi.Input[EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigSchemaValidationConfigArgs]]]] = ...) -> None:
    ...
    def access_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigAccessConfigArgs]]]]): # -> None:
        ...
    ...
    def event_record_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def schema_registry_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def schema_validation_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigSchemaValidationConfigArgs]]]]): # -> None:
        ...
...
class EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigAccessConfigArgs:
    def __init__(__self__, *, type: Optional[pulumi.Input[_builtins.str]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EventSourceMappingDestinationConfigArgs:
    def __init__(__self__, *, on_failure: Optional[pulumi.Input[EventSourceMappingDestinationConfigOnFailureArgs]] = ...) -> None:
    ...
    @on_failure.setter
    def on_failure(self, value: Optional[pulumi.Input[EventSourceMappingDestinationConfigOnFailureArgs]]): # -> None:
        ...
...
class EventSourceMappingDocumentDbEventSourceConfigArgs:
    def __init__(__self__, *, database_name: pulumi.Input[_builtins.str], collection_name: Optional[pulumi.Input[_builtins.str]] = ..., full_document: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def full_document(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventSourceMappingFilterCriteriaArgs:
    def __init__(__self__, *, filters: Optional[pulumi.Input[Sequence[pulumi.Input[EventSourceMappingFilterCriteriaFilterArgs]]]] = ...) -> None:
    ...
    @filters.setter
    def filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventSourceMappingFilterCriteriaFilterArgs]]]]): # -> None:
        ...
...
class EventSourceMappingFilterCriteriaFilterArgs:
    def __init__(__self__, *, pattern: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EventSourceMappingMetricsConfigArgs:
    def __init__(__self__, *, metrics: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @metrics.setter
    def metrics(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class EventSourceMappingProvisionedPollerConfigArgs:
    def __init__(__self__, *, maximum_pollers: Optional[pulumi.Input[_builtins.int]] = ..., minimum_pollers: Optional[pulumi.Input[_builtins.int]] = ..., poller_group_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def maximum_pollers(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def minimum_pollers(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def poller_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventSourceMappingScalingConfigArgs:
    def __init__(__self__, *, maximum_concurrency: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def maximum_concurrency(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class EventSourceMappingSelfManagedEventSourceArgs:
    def __init__(__self__, *, endpoints: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]) -> None:
    ...
    @endpoints.setter
    def endpoints(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class EventSourceMappingSelfManagedKafkaEventSourceConfigArgs:
    def __init__(__self__, *, consumer_group_id: Optional[pulumi.Input[_builtins.str]] = ..., schema_registry_config: Optional[pulumi.Input[EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfigArgs]] = ...) -> None:
    ...
    @schema_registry_config.setter
    def schema_registry_config(self, value: Optional[pulumi.Input[EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfigArgs]]): # -> None:
        ...
...
class EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfigArgs:
    def __init__(__self__, *, access_configs: Optional[pulumi.Input[Sequence[pulumi.Input[EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfigAccessConfigArgs]]]] = ..., event_record_format: Optional[pulumi.Input[_builtins.str]] = ..., schema_registry_uri: Optional[pulumi.Input[_builtins.str]] = ..., schema_validation_configs: Optional[pulumi.Input[Sequence[pulumi.Input[EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfigSchemaValidationConfigArgs]]]] = ...) -> None:
    ...
    @access_configs.setter
    def access_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfigAccessConfigArgs]]]]): # -> None:
        ...
    ...
    @schema_validation_configs.setter
    def schema_validation_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfigSchemaValidationConfigArgs]]]]): # -> None:
        ...
...
class EventSourceMappingSourceAccessConfigurationArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], uri: pulumi.Input[_builtins.str]) -> None:
...
class FunctionCapacityProviderConfigArgs:
    def __init__(__self__, *, lambda_managed_instances_capacity_provider_config: pulumi.Input[FunctionCapacityProviderConfigLambdaManagedInstancesCapacityProviderConfigArgs]) -> None:
    ...
    def lambda_managed_instances_capacity_provider_config(self, value: pulumi.Input[FunctionCapacityProviderConfigLambdaManagedInstancesCapacityProviderConfigArgs]): # -> None:
        ...
...
class FunctionCapacityProviderConfigLambdaManagedInstancesCapacityProviderConfigArgs:
    def __init__(__self__, *, capacity_provider_arn: pulumi.Input[_builtins.str], execution_environment_memory_gib_per_vcpu: Optional[pulumi.Input[_builtins.float]] = ..., per_execution_environment_max_concurrency: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def capacity_provider_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def execution_environment_memory_gib_per_vcpu(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def per_execution_environment_max_concurrency(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class FunctionDurableConfigArgs:
    def __init__(__self__, *, execution_timeout: pulumi.Input[_builtins.int], retention_period: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def execution_timeout(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class FunctionEnvironmentArgs:
    def __init__(__self__, *, variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class FunctionEventInvokeConfigDestinationConfigArgs:
    def __init__(__self__, *, on_failure: Optional[pulumi.Input[FunctionEventInvokeConfigDestinationConfigOnFailureArgs]] = ..., on_success: Optional[pulumi.Input[FunctionEventInvokeConfigDestinationConfigOnSuccessArgs]] = ...) -> None:
    ...
    @on_failure.setter
    def on_failure(self, value: Optional[pulumi.Input[FunctionEventInvokeConfigDestinationConfigOnFailureArgs]]): # -> None:
        ...
    ...
    @on_success.setter
    def on_success(self, value: Optional[pulumi.Input[FunctionEventInvokeConfigDestinationConfigOnSuccessArgs]]): # -> None:
        ...
...
class FunctionFileSystemConfigArgs:
    def __init__(__self__, *, arn: pulumi.Input[_builtins.str], local_mount_path: pulumi.Input[_builtins.str]) -> None:
    ...
    def local_mount_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class FunctionImageConfigArgs:
    def __init__(__self__, *, commands: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., entry_points: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., working_directory: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @entry_points.setter
    def entry_points(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class FunctionLoggingConfigArgs:
    def __init__(__self__, *, log_format: pulumi.Input[_builtins.str], application_log_level: Optional[pulumi.Input[_builtins.str]] = ..., log_group: Optional[pulumi.Input[_builtins.str]] = ..., system_log_level: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def application_log_level(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def system_log_level(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FunctionSnapStartArgs:
    def __init__(__self__, *, apply_on: pulumi.Input[_builtins.str], optimization_status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @apply_on.setter
    def apply_on(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def optimization_status(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FunctionTenancyConfigArgs:
    def __init__(__self__, *, tenant_isolation_mode: pulumi.Input[_builtins.str]) -> None:
    ...
    def tenant_isolation_mode(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class FunctionVpcConfigArgs:
    def __init__(__self__, *, security_group_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], subnet_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], ipv6_allowed_for_dual_stack: Optional[pulumi.Input[_builtins.bool]] = ..., vpc_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
