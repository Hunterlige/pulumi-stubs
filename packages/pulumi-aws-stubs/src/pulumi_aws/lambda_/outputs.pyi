...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AliasRoutingConfig', 'CapacityProviderCapacityProviderScalingConfig', ..., 'CapacityProviderInstanceRequirement', 'CapacityProviderPermissionsConfig', 'CapacityProviderTimeouts', 'CapacityProviderVpcConfig', 'CodeSigningConfigAllowedPublishers', 'CodeSigningConfigPolicies', ..., ..., ..., ..., 'EventSourceMappingDestinationConfig', 'EventSourceMappingDestinationConfigOnFailure', 'EventSourceMappingDocumentDbEventSourceConfig', 'EventSourceMappingFilterCriteria', 'EventSourceMappingFilterCriteriaFilter', 'EventSourceMappingMetricsConfig', 'EventSourceMappingProvisionedPollerConfig', 'EventSourceMappingScalingConfig', 'EventSourceMappingSelfManagedEventSource', ..., ..., ..., ..., 'EventSourceMappingSourceAccessConfiguration', 'FunctionCapacityProviderConfig', ..., 'FunctionDeadLetterConfig', 'FunctionDurableConfig', 'FunctionEnvironment', 'FunctionEphemeralStorage', 'FunctionEventInvokeConfigDestinationConfig', ..., ..., 'FunctionFileSystemConfig', 'FunctionImageConfig', 'FunctionLoggingConfig', 'FunctionSnapStart', 'FunctionTenancyConfig', 'FunctionTracingConfig', 'FunctionUrlCors', 'FunctionVpcConfig', 'GetCodeSigningConfigAllowedPublisherResult', 'GetCodeSigningConfigPolicyResult', 'GetFunctionCapacityProviderConfigResult', ..., 'GetFunctionDeadLetterConfigResult', 'GetFunctionDurableConfigResult', 'GetFunctionEnvironmentResult', 'GetFunctionEphemeralStorageResult', 'GetFunctionFileSystemConfigResult', 'GetFunctionLoggingConfigResult', 'GetFunctionTenancyConfigResult', 'GetFunctionTracingConfigResult', 'GetFunctionUrlCorResult', 'GetFunctionVpcConfigResult']
@pulumi.output_type
class AliasRoutingConfig(dict):
    ...
    def __init__(__self__, *, additional_version_weights: Optional[Mapping[str, _builtins.float]] = ...) -> None:
...
class CapacityProviderCapacityProviderScalingConfig(dict):
    ...
    def __init__(__self__, *, max_vcpu_count: _builtins.int, scaling_mode: _builtins.str, scaling_policies: Sequence[outputs.CapacityProviderCapacityProviderScalingConfigScalingPolicy]) -> None:
...
class CapacityProviderCapacityProviderScalingConfigScalingPolicy(dict):
    ...
    def __init__(__self__, *, predefined_metric_type: _builtins.str, target_value: _builtins.float) -> None:
...
class CapacityProviderInstanceRequirement(dict):
    ...
    def __init__(__self__, *, allowed_instance_types: Sequence[_builtins.str], architectures: Sequence[_builtins.str], excluded_instance_types: Sequence[_builtins.str]) -> None:
...
class CapacityProviderPermissionsConfig(dict):
    ...
    def __init__(__self__, *, capacity_provider_operator_role_arn: _builtins.str) -> None:
...
class CodeSigningConfigAllowedPublishers(dict):
    ...
    def __init__(__self__, *, signing_profile_version_arns: Sequence[_builtins.str]) -> None:
...
class CodeSigningConfigPolicies(dict):
    ...
    def __init__(__self__, *, untrusted_artifact_on_deployment: _builtins.str) -> None:
...
class EventSourceMappingAmazonManagedKafkaEventSourceConfig(dict):
    ...
    def __init__(__self__, *, consumer_group_id: Optional[_builtins.str] = ..., schema_registry_config: Optional[outputs.EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfig] = ...) -> None:
...
class EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfig(dict):
    ...
    def __init__(__self__, *, access_configs: Optional[Sequence[outputs.EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigAccessConfig]] = ..., event_record_format: Optional[_builtins.str] = ..., schema_registry_uri: Optional[_builtins.str] = ..., schema_validation_configs: Optional[Sequence[outputs.EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigSchemaValidationConfig]] = ...) -> None:
...
class EventSourceMappingAmazonManagedKafkaEventSourceConfigSchemaRegistryConfigAccessConfig(dict):
    def __init__(__self__, *, type: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class EventSourceMappingDestinationConfig(dict):
    ...
    def __init__(__self__, *, on_failure: Optional[outputs.EventSourceMappingDestinationConfigOnFailure] = ...) -> None:
...
class EventSourceMappingDocumentDbEventSourceConfig(dict):
    ...
    def __init__(__self__, *, database_name: _builtins.str, collection_name: Optional[_builtins.str] = ..., full_document: Optional[_builtins.str] = ...) -> None:
...
class EventSourceMappingFilterCriteria(dict):
    def __init__(__self__, *, filters: Optional[Sequence[outputs.EventSourceMappingFilterCriteriaFilter]] = ...) -> None:
...
class EventSourceMappingProvisionedPollerConfig(dict):
    ...
    def __init__(__self__, *, maximum_pollers: Optional[_builtins.int] = ..., minimum_pollers: Optional[_builtins.int] = ..., poller_group_name: Optional[_builtins.str] = ...) -> None:
...
class EventSourceMappingScalingConfig(dict):
    ...
    def __init__(__self__, *, maximum_concurrency: Optional[_builtins.int] = ...) -> None:
...
class EventSourceMappingSelfManagedKafkaEventSourceConfig(dict):
    ...
    def __init__(__self__, *, consumer_group_id: Optional[_builtins.str] = ..., schema_registry_config: Optional[outputs.EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfig] = ...) -> None:
...
class EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfig(dict):
    ...
    def __init__(__self__, *, access_configs: Optional[Sequence[outputs.EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfigAccessConfig]] = ..., event_record_format: Optional[_builtins.str] = ..., schema_registry_uri: Optional[_builtins.str] = ..., schema_validation_configs: Optional[Sequence[outputs.EventSourceMappingSelfManagedKafkaEventSourceConfigSchemaRegistryConfigSchemaValidationConfig]] = ...) -> None:
...
class FunctionCapacityProviderConfig(dict):
    ...
    def __init__(__self__, *, lambda_managed_instances_capacity_provider_config: outputs.FunctionCapacityProviderConfigLambdaManagedInstancesCapacityProviderConfig) -> None:
...
class FunctionCapacityProviderConfigLambdaManagedInstancesCapacityProviderConfig(dict):
    ...
    def __init__(__self__, *, capacity_provider_arn: _builtins.str, execution_environment_memory_gib_per_vcpu: Optional[_builtins.float] = ..., per_execution_environment_max_concurrency: Optional[_builtins.int] = ...) -> None:
...
class FunctionDurableConfig(dict):
    ...
    def __init__(__self__, *, execution_timeout: _builtins.int, retention_period: Optional[_builtins.int] = ...) -> None:
...
class FunctionEnvironment(dict):
    def __init__(__self__, *, variables: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class FunctionEventInvokeConfigDestinationConfig(dict):
    ...
    def __init__(__self__, *, on_failure: Optional[outputs.FunctionEventInvokeConfigDestinationConfigOnFailure] = ..., on_success: Optional[outputs.FunctionEventInvokeConfigDestinationConfigOnSuccess] = ...) -> None:
...
class FunctionFileSystemConfig(dict):
    ...
    def __init__(__self__, *, arn: _builtins.str, local_mount_path: _builtins.str) -> None:
...
class FunctionImageConfig(dict):
    ...
    def __init__(__self__, *, commands: Optional[Sequence[_builtins.str]] = ..., entry_points: Optional[Sequence[_builtins.str]] = ..., working_directory: Optional[_builtins.str] = ...) -> None:
...
class FunctionLoggingConfig(dict):
    ...
    def __init__(__self__, *, log_format: _builtins.str, application_log_level: Optional[_builtins.str] = ..., log_group: Optional[_builtins.str] = ..., system_log_level: Optional[_builtins.str] = ...) -> None:
...
class FunctionSnapStart(dict):
    ...
    def __init__(__self__, *, apply_on: _builtins.str, optimization_status: Optional[_builtins.str] = ...) -> None:
...
class FunctionVpcConfig(dict):
    ...
    def __init__(__self__, *, security_group_ids: Sequence[_builtins.str], subnet_ids: Sequence[_builtins.str], ipv6_allowed_for_dual_stack: Optional[_builtins.bool] = ..., vpc_id: Optional[_builtins.str] = ...) -> None:
...
class GetFunctionCapacityProviderConfigResult(dict):
    def __init__(__self__, *, lambda_managed_instances_capacity_provider_configs: Sequence[outputs.GetFunctionCapacityProviderConfigLambdaManagedInstancesCapacityProviderConfigResult]) -> None:
...
class GetFunctionCapacityProviderConfigLambdaManagedInstancesCapacityProviderConfigResult(dict):
    def __init__(__self__, *, capacity_provider_arn: _builtins.str, execution_environment_memory_gib_per_vcpu: _builtins.float, per_execution_environment_max_concurrency: _builtins.int) -> None:
...
class GetFunctionDurableConfigResult(dict):
    def __init__(__self__, *, execution_timeout: _builtins.int, retention_period: _builtins.int) -> None:
...
class GetFunctionLoggingConfigResult(dict):
    def __init__(__self__, *, application_log_level: _builtins.str, log_format: _builtins.str, log_group: _builtins.str, system_log_level: _builtins.str) -> None:
...
class GetFunctionVpcConfigResult(dict):
    def __init__(__self__, *, ipv6_allowed_for_dual_stack: _builtins.bool, security_group_ids: Sequence[_builtins.str], subnet_ids: Sequence[_builtins.str], vpc_id: _builtins.str) -> None:
