...
class GetFunctionResult:
    ...
    def __init__(__self__, architectures=..., arn=..., capacity_provider_configs=..., code_sha256=..., code_signing_config_arn=..., dead_letter_config=..., description=..., durable_configs=..., environment=..., ephemeral_storages=..., file_system_configs=..., function_name=..., handler=..., id=..., image_uri=..., invoke_arn=..., kms_key_arn=..., last_modified=..., layers=..., logging_configs=..., memory_size=..., qualified_arn=..., qualified_invoke_arn=..., qualifier=..., region=..., reserved_concurrent_executions=..., response_streaming_invoke_arn=..., role=..., runtime=..., signing_job_arn=..., signing_profile_version_arn=..., source_code_hash=..., source_code_size=..., source_kms_key_arn=..., tags=..., tenancy_configs=..., timeout=..., tracing_config=..., version=..., vpc_config=...) -> None:
        ...
...
def get_function(function_name: Optional[_builtins.str] = ..., qualifier: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetFunctionResult:
    
    ...

def get_function_output(function_name: Optional[pulumi.Input[_builtins.str]] = ..., qualifier: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetFunctionResult]:
