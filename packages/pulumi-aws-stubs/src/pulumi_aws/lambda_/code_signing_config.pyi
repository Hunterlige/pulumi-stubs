...
class CodeSigningConfigArgs:
    def __init__(
        ...
        *,
        ...
        policies: Optional[pulumi.Input[CodeSigningConfigPoliciesArgs]] = ...,
    ...
    @policies.setter
    def policies(
        self, value: Optional[pulumi.Input[CodeSigningConfigPoliciesArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _CodeSigningConfigState:
    ...
    @allowed_publishers.setter
    def allowed_publishers(
        self, value: Optional[pulumi.Input[CodeSigningConfigAllowedPublishersArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class CodeSigningConfig(pulumi.CustomResource):
    ...
    def __init__(
        ...
        policies: Optional[
            pulumi.Input[
                Union[CodeSigningConfigPoliciesArgs, CodeSigningConfigPoliciesArgsDict]
            ]
        ] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
    ...
    def allowed_publishers(
        self,
    ) -> pulumi.Output[outputs.CodeSigningConfigAllowedPublishers]: ...
    @_builtins.property
    @pulumi.getter
