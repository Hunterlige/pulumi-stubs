...
class GetPoliciesResult:
    ...
    def __init__(__self__, filter=..., id=..., ids=...) -> None:
        ...
...
def get_policies_output(filter: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetPoliciesResult]:
