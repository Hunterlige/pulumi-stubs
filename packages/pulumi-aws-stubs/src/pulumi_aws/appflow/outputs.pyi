...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectorProfileConnectorProfileConfig', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'FlowDestinationFlowConfig', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'FlowMetadataCatalogConfig', 'FlowMetadataCatalogConfigGlueDataCatalog', 'FlowSourceFlowConfig', 'FlowSourceFlowConfigIncrementalPullConfig', 'FlowSourceFlowConfigSourceConnectorProperties', ..., ..., ..., ..., ..., ..., ..., 'FlowSourceFlowConfigSourceConnectorPropertiesS3', ..., ..., ..., ..., ..., ..., ..., 'FlowSourceFlowConfigSourceConnectorPropertiesSlack', ..., 'FlowSourceFlowConfigSourceConnectorPropertiesVeeva', ..., 'FlowTask', 'FlowTaskConnectorOperator', 'FlowTriggerConfig', 'FlowTriggerConfigTriggerProperties', 'FlowTriggerConfigTriggerPropertiesScheduled']
@pulumi.output_type
class ConnectorProfileConnectorProfileConfig(dict):
    ...
    def __init__(__self__, *, connector_profile_credentials: outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentials, connector_profile_properties: outputs.ConnectorProfileConnectorProfileConfigConnectorProfileProperties) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentials(dict):
    ...
    def __init__(__self__, *, amplitude: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsAmplitude] = ..., custom_connector: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnector] = ..., datadog: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsDatadog] = ..., dynatrace: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsDynatrace] = ..., google_analytics: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsGoogleAnalytics] = ..., honeycode: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsHoneycode] = ..., infor_nexus: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsInforNexus] = ..., marketo: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsMarketo] = ..., redshift: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsRedshift] = ..., salesforce: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforce] = ..., sapo_data: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSapoData] = ..., service_now: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsServiceNow] = ..., singular: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSingular] = ..., slack: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSlack] = ..., snowflake: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSnowflake] = ..., trendmicro: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsTrendmicro] = ..., veeva: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsVeeva] = ..., zendesk: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsZendesk] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsAmplitude(dict):
    ...
    def __init__(__self__, *, api_key: _builtins.str, secret_key: _builtins.str) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnector(dict):
    ...
    def __init__(__self__, *, authentication_type: _builtins.str, api_key: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorApiKey] = ..., basic: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorBasic] = ..., custom: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorCustom] = ..., oauth2: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorOauth2] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorApiKey(dict):
    ...
    def __init__(__self__, *, api_key: _builtins.str, api_secret_key: Optional[_builtins.str] = ...) -> None:
        ...
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorCustom(dict):
    ...
    def __init__(__self__, *, custom_authentication_type: _builtins.str, credentials_map: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorOauth2(dict):
    ...
    def __init__(__self__, *, access_token: Optional[_builtins.str] = ..., client_id: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., oauth_request: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorOauth2OauthRequest] = ..., refresh_token: Optional[_builtins.str] = ...) -> None:
        ...
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorOauth2OauthRequest(dict):
    ...
    def __init__(__self__, *, auth_code: Optional[_builtins.str] = ..., redirect_uri: Optional[_builtins.str] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsDatadog(dict):
    ...
    def __init__(__self__, *, api_key: _builtins.str, application_key: _builtins.str) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsGoogleAnalytics(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, client_secret: _builtins.str, access_token: Optional[_builtins.str] = ..., oauth_request: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsGoogleAnalyticsOauthRequest] = ..., refresh_token: Optional[_builtins.str] = ...) -> None:
        ...
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsHoneycode(dict):
    ...
    def __init__(__self__, *, access_token: Optional[_builtins.str] = ..., oauth_request: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsHoneycodeOauthRequest] = ..., refresh_token: Optional[_builtins.str] = ...) -> None:
        ...
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsInforNexus(dict):
    ...
    def __init__(__self__, *, access_key_id: _builtins.str, datakey: _builtins.str, secret_access_key: _builtins.str, user_id: _builtins.str) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsMarketo(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, client_secret: _builtins.str, access_token: Optional[_builtins.str] = ..., oauth_request: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsMarketoOauthRequest] = ...) -> None:
        ...
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforce(dict):
    ...
    def __init__(__self__, *, access_token: Optional[_builtins.str] = ..., client_credentials_arn: Optional[_builtins.str] = ..., jwt_token: Optional[_builtins.str] = ..., oauth2_grant_type: Optional[_builtins.str] = ..., oauth_request: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceOauthRequest] = ..., refresh_token: Optional[_builtins.str] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSapoData(dict):
    ...
    def __init__(__self__, *, basic_auth_credentials: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSapoDataBasicAuthCredentials] = ..., oauth_credentials: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSapoDataOauthCredentials] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSapoDataOauthCredentials(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, client_secret: _builtins.str, access_token: Optional[_builtins.str] = ..., oauth_request: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSapoDataOauthCredentialsOauthRequest] = ..., refresh_token: Optional[_builtins.str] = ...) -> None:
        ...
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSlack(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, client_secret: _builtins.str, access_token: Optional[_builtins.str] = ..., oauth_request: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSlackOauthRequest] = ...) -> None:
        ...
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsZendesk(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, client_secret: _builtins.str, access_token: Optional[_builtins.str] = ..., oauth_request: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsZendeskOauthRequest] = ...) -> None:
        ...
...
class ConnectorProfileConnectorProfileConfigConnectorProfileProperties(dict):
    ...
    def __init__(__self__, *, amplitude: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesAmplitude] = ..., custom_connector: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesCustomConnector] = ..., datadog: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesDatadog] = ..., dynatrace: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesDynatrace] = ..., google_analytics: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesGoogleAnalytics] = ..., honeycode: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesHoneycode] = ..., infor_nexus: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesInforNexus] = ..., marketo: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesMarketo] = ..., redshift: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesRedshift] = ..., salesforce: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSalesforce] = ..., sapo_data: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoData] = ..., service_now: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesServiceNow] = ..., singular: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSingular] = ..., slack: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSlack] = ..., snowflake: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSnowflake] = ..., trendmicro: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesTrendmicro] = ..., veeva: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesVeeva] = ..., zendesk: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesZendesk] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesCustomConnector(dict):
    ...
    def __init__(__self__, *, oauth2_properties: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesCustomConnectorOauth2Properties] = ..., profile_properties: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesCustomConnectorOauth2Properties(dict):
    ...
    def __init__(__self__, *, oauth2_grant_type: _builtins.str, token_url: _builtins.str, token_url_custom_properties: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesRedshift(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, role_arn: _builtins.str, bucket_prefix: Optional[_builtins.str] = ..., cluster_identifier: Optional[_builtins.str] = ..., data_api_role_arn: Optional[_builtins.str] = ..., database_name: Optional[_builtins.str] = ..., database_url: Optional[_builtins.str] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSalesforce(dict):
    ...
    def __init__(__self__, *, instance_url: Optional[_builtins.str] = ..., is_sandbox_environment: Optional[_builtins.bool] = ..., use_privatelink_for_metadata_and_authorization: Optional[_builtins.bool] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoData(dict):
    ...
    def __init__(__self__, *, application_host_url: _builtins.str, application_service_path: _builtins.str, client_number: _builtins.str, port_number: _builtins.int, logon_language: Optional[_builtins.str] = ..., oauth_properties: Optional[outputs.ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOauthProperties] = ..., private_link_service_name: Optional[_builtins.str] = ...) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOauthProperties(dict):
    ...
    def __init__(__self__, *, auth_code_url: _builtins.str, oauth_scopes: Sequence[_builtins.str], token_url: _builtins.str) -> None:
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSnowflake(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, stage: _builtins.str, warehouse: _builtins.str, account_name: Optional[_builtins.str] = ..., bucket_prefix: Optional[_builtins.str] = ..., private_link_service_name: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ...) -> None:
...
class FlowDestinationFlowConfig(dict):
    ...
    def __init__(__self__, *, connector_type: _builtins.str, destination_connector_properties: outputs.FlowDestinationFlowConfigDestinationConnectorProperties, api_version: Optional[_builtins.str] = ..., connector_profile_name: Optional[_builtins.str] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorProperties(dict):
    ...
    def __init__(__self__, *, custom_connector: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesCustomConnector] = ..., customer_profiles: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesCustomerProfiles] = ..., event_bridge: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesEventBridge] = ..., honeycode: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesHoneycode] = ..., lookout_metrics: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesLookoutMetrics] = ..., marketo: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesMarketo] = ..., redshift: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesRedshift] = ..., s3: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesS3] = ..., salesforce: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesSalesforce] = ..., sapo_data: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesSapoData] = ..., snowflake: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesSnowflake] = ..., upsolver: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolver] = ..., zendesk: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesZendesk] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesCustomConnector(dict):
    ...
    def __init__(__self__, *, entity_name: _builtins.str, custom_properties: Optional[Mapping[str, _builtins.str]] = ..., error_handling_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesCustomConnectorErrorHandlingConfig] = ..., id_field_names: Optional[Sequence[_builtins.str]] = ..., write_operation_type: Optional[_builtins.str] = ...) -> None:
        ...
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesCustomConnectorErrorHandlingConfig(dict):
    ...
    def __init__(__self__, *, bucket_name: Optional[_builtins.str] = ..., bucket_prefix: Optional[_builtins.str] = ..., fail_on_first_destination_error: Optional[_builtins.bool] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesCustomerProfiles(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, object_type_name: Optional[_builtins.str] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesEventBridge(dict):
    ...
    def __init__(__self__, *, object: _builtins.str, error_handling_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesEventBridgeErrorHandlingConfig] = ...) -> None:
        ...
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesHoneycode(dict):
    ...
    def __init__(__self__, *, object: _builtins.str, error_handling_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesHoneycodeErrorHandlingConfig] = ...) -> None:
        ...
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesMarketo(dict):
    ...
    def __init__(__self__, *, object: _builtins.str, error_handling_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfig] = ...) -> None:
        ...
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesRedshift(dict):
    ...
    def __init__(__self__, *, intermediate_bucket_name: _builtins.str, object: _builtins.str, bucket_prefix: Optional[_builtins.str] = ..., error_handling_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesRedshiftErrorHandlingConfig] = ...) -> None:
        ...
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesS3(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, bucket_prefix: Optional[_builtins.str] = ..., s3_output_format_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfig] = ...) -> None:
        ...
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfig(dict):
    ...
    def __init__(__self__, *, aggregation_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfigAggregationConfig] = ..., file_type: Optional[_builtins.str] = ..., prefix_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfigPrefixConfig] = ..., preserve_source_data_typing: Optional[_builtins.bool] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfigAggregationConfig(dict):
    ...
    def __init__(__self__, *, aggregation_type: Optional[_builtins.str] = ..., target_file_size: Optional[_builtins.int] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfigPrefixConfig(dict):
    ...
    def __init__(__self__, *, prefix_format: Optional[_builtins.str] = ..., prefix_hierarchies: Optional[Sequence[_builtins.str]] = ..., prefix_type: Optional[_builtins.str] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesSalesforce(dict):
    ...
    def __init__(__self__, *, object: _builtins.str, data_transfer_api: Optional[_builtins.str] = ..., error_handling_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesSalesforceErrorHandlingConfig] = ..., id_field_names: Optional[Sequence[_builtins.str]] = ..., write_operation_type: Optional[_builtins.str] = ...) -> None:
        ...
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesSapoData(dict):
    ...
    def __init__(__self__, *, object_path: _builtins.str, error_handling_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesSapoDataErrorHandlingConfig] = ..., id_field_names: Optional[Sequence[_builtins.str]] = ..., success_response_handling_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesSapoDataSuccessResponseHandlingConfig] = ..., write_operation_type: Optional[_builtins.str] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesSapoDataSuccessResponseHandlingConfig(dict):
    ...
    def __init__(__self__, *, bucket_name: Optional[_builtins.str] = ..., bucket_prefix: Optional[_builtins.str] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesSnowflake(dict):
    ...
    def __init__(__self__, *, intermediate_bucket_name: _builtins.str, object: _builtins.str, bucket_prefix: Optional[_builtins.str] = ..., error_handling_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesSnowflakeErrorHandlingConfig] = ...) -> None:
        ...
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolver(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, s3_output_format_config: outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfig, bucket_prefix: Optional[_builtins.str] = ...) -> None:
        ...
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfig(dict):
    ...
    def __init__(__self__, *, prefix_config: outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigPrefixConfig, aggregation_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigAggregationConfig] = ..., file_type: Optional[_builtins.str] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigAggregationConfig(dict):
    ...
    def __init__(__self__, *, aggregation_type: Optional[_builtins.str] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigPrefixConfig(dict):
    ...
    def __init__(__self__, *, prefix_type: _builtins.str, prefix_format: Optional[_builtins.str] = ..., prefix_hierarchies: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesZendesk(dict):
    ...
    def __init__(__self__, *, object: _builtins.str, error_handling_config: Optional[outputs.FlowDestinationFlowConfigDestinationConnectorPropertiesZendeskErrorHandlingConfig] = ..., id_field_names: Optional[Sequence[_builtins.str]] = ..., write_operation_type: Optional[_builtins.str] = ...) -> None:
        ...
...
class FlowMetadataCatalogConfig(dict):
    ...
    def __init__(__self__, *, glue_data_catalog: Optional[outputs.FlowMetadataCatalogConfigGlueDataCatalog] = ...) -> None:
        ...
...
class FlowMetadataCatalogConfigGlueDataCatalog(dict):
    ...
    def __init__(__self__, *, database_name: _builtins.str, role_arn: _builtins.str, table_prefix: _builtins.str) -> None:
...
class FlowSourceFlowConfig(dict):
    ...
    def __init__(__self__, *, connector_type: _builtins.str, source_connector_properties: outputs.FlowSourceFlowConfigSourceConnectorProperties, api_version: Optional[_builtins.str] = ..., connector_profile_name: Optional[_builtins.str] = ..., incremental_pull_config: Optional[outputs.FlowSourceFlowConfigIncrementalPullConfig] = ...) -> None:
...
class FlowSourceFlowConfigIncrementalPullConfig(dict):
    ...
    def __init__(__self__, *, datetime_type_field_name: Optional[_builtins.str] = ...) -> None:
...
class FlowSourceFlowConfigSourceConnectorProperties(dict):
    ...
    def __init__(__self__, *, amplitude: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesAmplitude] = ..., custom_connector: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesCustomConnector] = ..., datadog: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesDatadog] = ..., dynatrace: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesDynatrace] = ..., google_analytics: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesGoogleAnalytics] = ..., infor_nexus: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesInforNexus] = ..., marketo: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesMarketo] = ..., s3: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesS3] = ..., salesforce: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesSalesforce] = ..., sapo_data: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesSapoData] = ..., service_now: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesServiceNow] = ..., singular: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesSingular] = ..., slack: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesSlack] = ..., trendmicro: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesTrendmicro] = ..., veeva: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesVeeva] = ..., zendesk: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesZendesk] = ...) -> None:
...
class FlowSourceFlowConfigSourceConnectorPropertiesCustomConnector(dict):
    ...
    def __init__(__self__, *, entity_name: _builtins.str, custom_properties: Optional[Mapping[str, _builtins.str]] = ...) -> None:
        ...
...
class FlowSourceFlowConfigSourceConnectorPropertiesS3(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, bucket_prefix: _builtins.str, s3_input_format_config: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesS3S3InputFormatConfig] = ...) -> None:
...
class FlowSourceFlowConfigSourceConnectorPropertiesS3S3InputFormatConfig(dict):
    ...
    def __init__(__self__, *, s3_input_file_type: Optional[_builtins.str] = ...) -> None:
...
class FlowSourceFlowConfigSourceConnectorPropertiesSalesforce(dict):
    ...
    def __init__(__self__, *, object: _builtins.str, data_transfer_api: Optional[_builtins.str] = ..., enable_dynamic_field_update: Optional[_builtins.bool] = ..., include_deleted_records: Optional[_builtins.bool] = ...) -> None:
...
class FlowSourceFlowConfigSourceConnectorPropertiesSapoData(dict):
    ...
    def __init__(__self__, *, object_path: _builtins.str, pagination_config: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesSapoDataPaginationConfig] = ..., parallelism_config: Optional[outputs.FlowSourceFlowConfigSourceConnectorPropertiesSapoDataParallelismConfig] = ...) -> None:
...
class FlowSourceFlowConfigSourceConnectorPropertiesVeeva(dict):
    ...
    def __init__(__self__, *, object: _builtins.str, document_type: Optional[_builtins.str] = ..., include_all_versions: Optional[_builtins.bool] = ..., include_renditions: Optional[_builtins.bool] = ..., include_source_files: Optional[_builtins.bool] = ...) -> None:
...
class FlowTask(dict):
    ...
    def __init__(__self__, *, task_type: _builtins.str, connector_operators: Optional[Sequence[outputs.FlowTaskConnectorOperator]] = ..., destination_field: Optional[_builtins.str] = ..., source_fields: Optional[Sequence[_builtins.str]] = ..., task_properties: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class FlowTaskConnectorOperator(dict):
    ...
    def __init__(__self__, *, amplitude: Optional[_builtins.str] = ..., custom_connector: Optional[_builtins.str] = ..., datadog: Optional[_builtins.str] = ..., dynatrace: Optional[_builtins.str] = ..., google_analytics: Optional[_builtins.str] = ..., infor_nexus: Optional[_builtins.str] = ..., marketo: Optional[_builtins.str] = ..., s3: Optional[_builtins.str] = ..., salesforce: Optional[_builtins.str] = ..., sapo_data: Optional[_builtins.str] = ..., service_now: Optional[_builtins.str] = ..., singular: Optional[_builtins.str] = ..., slack: Optional[_builtins.str] = ..., trendmicro: Optional[_builtins.str] = ..., veeva: Optional[_builtins.str] = ..., zendesk: Optional[_builtins.str] = ...) -> None:
...
class FlowTriggerConfig(dict):
    ...
    def __init__(__self__, *, trigger_type: _builtins.str, trigger_properties: Optional[outputs.FlowTriggerConfigTriggerProperties] = ...) -> None:
...
class FlowTriggerConfigTriggerProperties(dict):
    def __init__(__self__, *, scheduled: Optional[outputs.FlowTriggerConfigTriggerPropertiesScheduled] = ...) -> None:
        ...
...
class FlowTriggerConfigTriggerPropertiesScheduled(dict):
    ...
    def __init__(__self__, *, schedule_expression: _builtins.str, data_pull_mode: Optional[_builtins.str] = ..., first_execution_from: Optional[_builtins.str] = ..., schedule_end_time: Optional[_builtins.str] = ..., schedule_offset: Optional[_builtins.int] = ..., schedule_start_time: Optional[_builtins.str] = ..., timezone: Optional[_builtins.str] = ...) -> None:
