...
class SdkvoiceVoiceProfileDomainArgs:
    def __init__(
        __self__,
        *,
        server_side_encryption_configuration: pulumi.Input[
...
class _SdkvoiceVoiceProfileDomainState:
    ...
    def server_side_encryption_configuration(
        ...
        pulumi.Input[SdkvoiceVoiceProfileDomainServerSideEncryptionConfigurationArgs]
    ]: ...
    @server_side_encryption_configuration.setter
    def server_side_encryption_configuration(
        self,
...
class SdkvoiceVoiceProfileDomain(pulumi.CustomResource):
    ...
    def server_side_encryption_configuration(
        ...
        outputs.SdkvoiceVoiceProfileDomainServerSideEncryptionConfiguration
    ]: ...
    @_builtins.property
    @pulumi.getter
