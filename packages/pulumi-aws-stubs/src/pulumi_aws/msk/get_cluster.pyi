...
class GetClusterResult:
    ...
    def __init__(__self__, arn=..., bootstrap_brokers=..., bootstrap_brokers_public_sasl_iam=..., bootstrap_brokers_public_sasl_scram=..., bootstrap_brokers_public_tls=..., bootstrap_brokers_sasl_iam=..., bootstrap_brokers_sasl_scram=..., bootstrap_brokers_tls=..., broker_node_group_infos=..., cluster_name=..., cluster_uuid=..., id=..., kafka_version=..., number_of_broker_nodes=..., region=..., tags=..., zookeeper_connect_string=..., zookeeper_connect_string_tls=...) -> None:
        ...
...
def get_cluster(cluster_name: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetClusterResult:
    
    ...

def get_cluster_output(cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetClusterResult]:
