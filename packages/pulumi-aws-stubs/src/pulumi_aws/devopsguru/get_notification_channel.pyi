...
def get_notification_channel(filters: Optional[Sequence[Union[GetNotificationChannelFilterArgs, GetNotificationChannelFilterArgsDict]]] = ..., id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., sns: Optional[Sequence[Union[GetNotificationChannelSnArgs, GetNotificationChannelSnArgsDict]]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetNotificationChannelResult:
    
    ...

def get_notification_channel_output(filters: Optional[pulumi.Input[Optional[Sequence[Union[GetNotificationChannelFilterArgs, GetNotificationChannelFilterArgsDict]]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., sns: Optional[pulumi.Input[Optional[Sequence[Union[GetNotificationChannelSnArgs, GetNotificationChannelSnArgsDict]]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetNotificationChannelResult]:
