...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EventSourcesConfigEventSource', ..., 'NotificationChannelFilters', 'NotificationChannelSns', 'ResourceCollectionCloudformation', 'ResourceCollectionTags', 'ServiceIntegrationKmsServerSideEncryption', 'ServiceIntegrationLogsAnomalyDetection', 'ServiceIntegrationOpsCenter', 'GetNotificationChannelFilterResult', 'GetNotificationChannelSnResult', 'GetResourceCollectionCloudformationResult', 'GetResourceCollectionTagResult']
@pulumi.output_type
class EventSourcesConfigEventSource(dict):
    ...
    def __init__(__self__, *, amazon_code_guru_profilers: Sequence[outputs.EventSourcesConfigEventSourceAmazonCodeGuruProfiler]) -> None:
...
class NotificationChannelFilters(dict):
    ...
    def __init__(__self__, *, message_types: Optional[Sequence[_builtins.str]] = ..., severities: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ResourceCollectionTags(dict):
    ...
    def __init__(__self__, *, app_boundary_key: _builtins.str, tag_values: Sequence[_builtins.str]) -> None:
...
class ServiceIntegrationKmsServerSideEncryption(dict):
    ...
    def __init__(__self__, *, kms_key_id: Optional[_builtins.str] = ..., opt_in_status: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
