...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EventSourcesConfigEventSourceArgs', 'EventSourcesConfigEventSourceArgsDict', ..., ..., 'NotificationChannelFiltersArgs', 'NotificationChannelFiltersArgsDict', 'NotificationChannelSnsArgs', 'NotificationChannelSnsArgsDict', 'ResourceCollectionCloudformationArgs', 'ResourceCollectionCloudformationArgsDict', 'ResourceCollectionTagsArgs', 'ResourceCollectionTagsArgsDict', 'ServiceIntegrationKmsServerSideEncryptionArgs', 'ServiceIntegrationKmsServerSideEncryptionArgsDict', 'ServiceIntegrationLogsAnomalyDetectionArgs', 'ServiceIntegrationLogsAnomalyDetectionArgsDict', 'ServiceIntegrationOpsCenterArgs', 'ServiceIntegrationOpsCenterArgsDict', 'GetNotificationChannelFilterArgs', 'GetNotificationChannelFilterArgsDict', 'GetNotificationChannelSnArgs', 'GetNotificationChannelSnArgsDict']
...
class EventSourcesConfigEventSourceArgs:
    def __init__(__self__, *, amazon_code_guru_profilers: pulumi.Input[Sequence[pulumi.Input[EventSourcesConfigEventSourceAmazonCodeGuruProfilerArgs]]]) -> None:
    ...
    def amazon_code_guru_profilers(self, value: pulumi.Input[Sequence[pulumi.Input[EventSourcesConfigEventSourceAmazonCodeGuruProfilerArgs]]]): # -> None:
        ...
...
class NotificationChannelFiltersArgs:
    def __init__(__self__, *, message_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., severities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def message_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ResourceCollectionCloudformationArgs:
    def __init__(__self__, *, stack_names: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @stack_names.setter
    def stack_names(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class ResourceCollectionTagsArgs:
    def __init__(__self__, *, app_boundary_key: pulumi.Input[_builtins.str], tag_values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def app_boundary_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ServiceIntegrationKmsServerSideEncryptionArgs:
    def __init__(__self__, *, kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., opt_in_status: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServiceIntegrationLogsAnomalyDetectionArgs:
    def __init__(__self__, *, opt_in_status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class GetNotificationChannelFilterArgs:
    def __init__(__self__, *, message_types: Sequence[_builtins.str], severities: Sequence[_builtins.str]) -> None:
    ...
    @message_types.setter
    def message_types(self, value: Sequence[_builtins.str]): # -> None:
        ...
    ...
    @severities.setter
    def severities(self, value: Sequence[_builtins.str]): # -> None:
        ...
...
class GetNotificationChannelSnArgs:
    ...
    @topic_arn.setter
    def topic_arn(self, value: _builtins.str): # -> None:
        ...
