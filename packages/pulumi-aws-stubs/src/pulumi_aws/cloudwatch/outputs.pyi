...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CompositeAlarmActionsSuppressor', 'EventBusDeadLetterConfig', 'EventBusLogConfig', 'EventConnectionAuthParameters', 'EventConnectionAuthParametersApiKey', 'EventConnectionAuthParametersBasic', ..., ..., ..., ..., ..., ..., 'EventConnectionAuthParametersOauth', 'EventConnectionAuthParametersOauthClientParameters', ..., ..., ..., ..., 'EventConnectionInvocationConnectivityParameters', ..., 'EventEndpointEventBus', 'EventEndpointReplicationConfig', 'EventEndpointRoutingConfig', 'EventEndpointRoutingConfigFailoverConfig', 'EventEndpointRoutingConfigFailoverConfigPrimary', 'EventEndpointRoutingConfigFailoverConfigSecondary', 'EventPermissionCondition', 'EventTargetAppsyncTarget', 'EventTargetBatchTarget', 'EventTargetDeadLetterConfig', 'EventTargetEcsTarget', 'EventTargetEcsTargetCapacityProviderStrategy', 'EventTargetEcsTargetNetworkConfiguration', 'EventTargetEcsTargetOrderedPlacementStrategy', 'EventTargetEcsTargetPlacementConstraint', 'EventTargetHttpTarget', 'EventTargetInputTransformer', 'EventTargetKinesisTarget', 'EventTargetRedshiftTarget', 'EventTargetRetryPolicy', 'EventTargetRunCommandTarget', 'EventTargetSagemakerPipelineTarget', ..., 'EventTargetSqsTarget', 'InternetMonitorHealthEventsConfig', 'InternetMonitorInternetMeasurementsLogDelivery', ..., ..., 'LogDeliveryS3DeliveryConfiguration', 'LogMetricFilterMetricTransformation', 'LogTransformerTransformerConfig', 'LogTransformerTransformerConfigAddKeys', 'LogTransformerTransformerConfigAddKeysEntry', 'LogTransformerTransformerConfigCopyValue', 'LogTransformerTransformerConfigCopyValueEntry', 'LogTransformerTransformerConfigCsv', 'LogTransformerTransformerConfigDateTimeConverter', 'LogTransformerTransformerConfigDeleteKey', 'LogTransformerTransformerConfigGrok', 'LogTransformerTransformerConfigListToMap', 'LogTransformerTransformerConfigLowerCaseString', 'LogTransformerTransformerConfigMoveKey', 'LogTransformerTransformerConfigMoveKeyEntry', 'LogTransformerTransformerConfigParseCloudfront', 'LogTransformerTransformerConfigParseJson', 'LogTransformerTransformerConfigParseKeyValue', 'LogTransformerTransformerConfigParsePostgres', 'LogTransformerTransformerConfigParseRoute53', 'LogTransformerTransformerConfigParseToOcsf', 'LogTransformerTransformerConfigParseVpc', 'LogTransformerTransformerConfigParseWaf', 'LogTransformerTransformerConfigRenameKey', 'LogTransformerTransformerConfigRenameKeyEntry', 'LogTransformerTransformerConfigSplitString', 'LogTransformerTransformerConfigSplitStringEntry', 'LogTransformerTransformerConfigSubstituteString', ..., 'LogTransformerTransformerConfigTrimString', 'LogTransformerTransformerConfigTypeConverter', 'LogTransformerTransformerConfigTypeConverterEntry', 'LogTransformerTransformerConfigUpperCaseString', 'MetricAlarmMetricQuery', 'MetricAlarmMetricQueryMetric', 'MetricStreamExcludeFilter', 'MetricStreamIncludeFilter', 'MetricStreamStatisticsConfiguration', 'MetricStreamStatisticsConfigurationIncludeMetric', 'GetContributorManagedInsightRulesManagedRuleResult', ..., 'GetEventBusDeadLetterConfigResult', 'GetEventBusLogConfigResult', 'GetEventBusesEventBusResult', ..., ..., 'GetLogDataProtectionPolicyDocumentStatementResult', ..., ..., ..., ..., ..., ..., ..., ...]
@pulumi.output_type
class CompositeAlarmActionsSuppressor(dict):
    ...
    def __init__(__self__, *, alarm: _builtins.str, extension_period: _builtins.int, wait_period: _builtins.int) -> None:
...
class EventBusLogConfig(dict):
    ...
    def __init__(__self__, *, include_detail: Optional[_builtins.str] = ..., level: Optional[_builtins.str] = ...) -> None:
...
class EventConnectionAuthParameters(dict):
    ...
    def __init__(__self__, *, api_key: Optional[outputs.EventConnectionAuthParametersApiKey] = ..., basic: Optional[outputs.EventConnectionAuthParametersBasic] = ..., connectivity_parameters: Optional[outputs.EventConnectionAuthParametersConnectivityParameters] = ..., invocation_http_parameters: Optional[outputs.EventConnectionAuthParametersInvocationHttpParameters] = ..., oauth: Optional[outputs.EventConnectionAuthParametersOauth] = ...) -> None:
...
class EventConnectionAuthParametersConnectivityParameters(dict):
    ...
    def __init__(__self__, *, resource_parameters: outputs.EventConnectionAuthParametersConnectivityParametersResourceParameters) -> None:
...
class EventConnectionAuthParametersConnectivityParametersResourceParameters(dict):
    ...
    def __init__(__self__, *, resource_configuration_arn: _builtins.str, resource_association_arn: Optional[_builtins.str] = ...) -> None:
...
class EventConnectionAuthParametersInvocationHttpParametersBody(dict):
    ...
    def __init__(__self__, *, is_value_secret: Optional[_builtins.bool] = ..., key: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class EventConnectionAuthParametersOauth(dict):
    ...
    def __init__(__self__, *, authorization_endpoint: _builtins.str, http_method: _builtins.str, oauth_http_parameters: outputs.EventConnectionAuthParametersOauthOauthHttpParameters, client_parameters: Optional[outputs.EventConnectionAuthParametersOauthClientParameters] = ...) -> None:
...
class EventConnectionAuthParametersOauthOauthHttpParameters(dict):
    ...
    def __init__(__self__, *, bodies: Optional[Sequence[outputs.EventConnectionAuthParametersOauthOauthHttpParametersBody]] = ..., headers: Optional[Sequence[outputs.EventConnectionAuthParametersOauthOauthHttpParametersHeader]] = ..., query_strings: Optional[Sequence[outputs.EventConnectionAuthParametersOauthOauthHttpParametersQueryString]] = ...) -> None:
...
class EventConnectionInvocationConnectivityParameters(dict):
    ...
    def __init__(__self__, *, resource_parameters: outputs.EventConnectionInvocationConnectivityParametersResourceParameters) -> None:
...
class EventEndpointRoutingConfig(dict):
    ...
    def __init__(__self__, *, failover_config: outputs.EventEndpointRoutingConfigFailoverConfig) -> None:
...
class EventEndpointRoutingConfigFailoverConfig(dict):
    def __init__(__self__, *, primary: outputs.EventEndpointRoutingConfigFailoverConfigPrimary, secondary: outputs.EventEndpointRoutingConfigFailoverConfigSecondary) -> None:
...
class EventPermissionCondition(dict):
    def __init__(__self__, *, key: _builtins.str, type: _builtins.str, value: _builtins.str) -> None:
...
class EventTargetAppsyncTarget(dict):
    ...
    def __init__(__self__, *, graphql_operation: Optional[_builtins.str] = ...) -> None:
...
class EventTargetBatchTarget(dict):
    ...
    def __init__(__self__, *, job_definition: _builtins.str, job_name: _builtins.str, array_size: Optional[_builtins.int] = ..., job_attempts: Optional[_builtins.int] = ...) -> None:
...
class EventTargetEcsTarget(dict):
    ...
    def __init__(__self__, *, task_definition_arn: _builtins.str, capacity_provider_strategies: Optional[Sequence[outputs.EventTargetEcsTargetCapacityProviderStrategy]] = ..., enable_ecs_managed_tags: Optional[_builtins.bool] = ..., enable_execute_command: Optional[_builtins.bool] = ..., group: Optional[_builtins.str] = ..., launch_type: Optional[_builtins.str] = ..., network_configuration: Optional[outputs.EventTargetEcsTargetNetworkConfiguration] = ..., ordered_placement_strategies: Optional[Sequence[outputs.EventTargetEcsTargetOrderedPlacementStrategy]] = ..., placement_constraints: Optional[Sequence[outputs.EventTargetEcsTargetPlacementConstraint]] = ..., platform_version: Optional[_builtins.str] = ..., propagate_tags: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., task_count: Optional[_builtins.int] = ...) -> None:
...
class EventTargetHttpTarget(dict):
    ...
    def __init__(__self__, *, header_parameters: Optional[Mapping[str, _builtins.str]] = ..., path_parameter_values: Optional[Sequence[_builtins.str]] = ..., query_string_parameters: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class EventTargetInputTransformer(dict):
    ...
    def __init__(__self__, *, input_template: _builtins.str, input_paths: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class EventTargetKinesisTarget(dict):
    ...
    def __init__(__self__, *, partition_key_path: Optional[_builtins.str] = ...) -> None:
...
class EventTargetRedshiftTarget(dict):
    ...
    def __init__(__self__, *, database: _builtins.str, db_user: Optional[_builtins.str] = ..., secrets_manager_arn: Optional[_builtins.str] = ..., sql: Optional[_builtins.str] = ..., statement_name: Optional[_builtins.str] = ..., with_event: Optional[_builtins.bool] = ...) -> None:
...
class EventTargetRetryPolicy(dict):
    ...
    def __init__(__self__, *, maximum_event_age_in_seconds: Optional[_builtins.int] = ..., maximum_retry_attempts: Optional[_builtins.int] = ...) -> None:
...
class EventTargetSagemakerPipelineTarget(dict):
    ...
    def __init__(__self__, *, pipeline_parameter_lists: Optional[Sequence[outputs.EventTargetSagemakerPipelineTargetPipelineParameterList]] = ...) -> None:
...
class EventTargetSqsTarget(dict):
    ...
    def __init__(__self__, *, message_group_id: Optional[_builtins.str] = ...) -> None:
...
class InternetMonitorHealthEventsConfig(dict):
    ...
    def __init__(__self__, *, availability_score_threshold: Optional[_builtins.float] = ..., performance_score_threshold: Optional[_builtins.float] = ...) -> None:
...
class InternetMonitorInternetMeasurementsLogDelivery(dict):
    ...
    def __init__(__self__, *, s3_config: Optional[outputs.InternetMonitorInternetMeasurementsLogDeliveryS3Config] = ...) -> None:
        ...
...
class InternetMonitorInternetMeasurementsLogDeliveryS3Config(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, bucket_prefix: Optional[_builtins.str] = ..., log_delivery_status: Optional[_builtins.str] = ...) -> None:
        ...
...
class LogDeliveryDestinationDeliveryDestinationConfiguration(dict):
    ...
    def __init__(__self__, *, destination_resource_arn: Optional[_builtins.str] = ...) -> None:
...
class LogDeliveryS3DeliveryConfiguration(dict):
    ...
    def __init__(__self__, *, enable_hive_compatible_path: _builtins.bool, suffix_path: _builtins.str) -> None:
...
class LogMetricFilterMetricTransformation(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, namespace: _builtins.str, value: _builtins.str, default_value: Optional[_builtins.str] = ..., dimensions: Optional[Mapping[str, _builtins.str]] = ..., unit: Optional[_builtins.str] = ...) -> None:
...
class LogTransformerTransformerConfig(dict):
    ...
    def __init__(__self__, *, add_keys: Optional[outputs.LogTransformerTransformerConfigAddKeys] = ..., copy_value: Optional[outputs.LogTransformerTransformerConfigCopyValue] = ..., csvs: Optional[Sequence[outputs.LogTransformerTransformerConfigCsv]] = ..., date_time_converters: Optional[Sequence[outputs.LogTransformerTransformerConfigDateTimeConverter]] = ..., delete_keys: Optional[Sequence[outputs.LogTransformerTransformerConfigDeleteKey]] = ..., grok: Optional[outputs.LogTransformerTransformerConfigGrok] = ..., list_to_maps: Optional[Sequence[outputs.LogTransformerTransformerConfigListToMap]] = ..., lower_case_strings: Optional[Sequence[outputs.LogTransformerTransformerConfigLowerCaseString]] = ..., move_keys: Optional[Sequence[outputs.LogTransformerTransformerConfigMoveKey]] = ..., parse_cloudfront: Optional[outputs.LogTransformerTransformerConfigParseCloudfront] = ..., parse_jsons: Optional[Sequence[outputs.LogTransformerTransformerConfigParseJson]] = ..., parse_key_values: Optional[Sequence[outputs.LogTransformerTransformerConfigParseKeyValue]] = ..., parse_postgres: Optional[outputs.LogTransformerTransformerConfigParsePostgres] = ..., parse_route53: Optional[outputs.LogTransformerTransformerConfigParseRoute53] = ..., parse_to_ocsf: Optional[outputs.LogTransformerTransformerConfigParseToOcsf] = ..., parse_vpc: Optional[outputs.LogTransformerTransformerConfigParseVpc] = ..., parse_waf: Optional[outputs.LogTransformerTransformerConfigParseWaf] = ..., rename_keys: Optional[Sequence[outputs.LogTransformerTransformerConfigRenameKey]] = ..., split_strings: Optional[Sequence[outputs.LogTransformerTransformerConfigSplitString]] = ..., substitute_strings: Optional[Sequence[outputs.LogTransformerTransformerConfigSubstituteString]] = ..., trim_strings: Optional[Sequence[outputs.LogTransformerTransformerConfigTrimString]] = ..., type_converters: Optional[Sequence[outputs.LogTransformerTransformerConfigTypeConverter]] = ..., upper_case_strings: Optional[Sequence[outputs.LogTransformerTransformerConfigUpperCaseString]] = ...) -> None:
...
class LogTransformerTransformerConfigAddKeys(dict):
    def __init__(__self__, *, entries: Sequence[outputs.LogTransformerTransformerConfigAddKeysEntry]) -> None:
...
class LogTransformerTransformerConfigAddKeysEntry(dict):
    ...
    def __init__(__self__, *, key: _builtins.str, value: _builtins.str, overwrite_if_exists: Optional[_builtins.bool] = ...) -> None:
...
class LogTransformerTransformerConfigCopyValue(dict):
    def __init__(__self__, *, entries: Sequence[outputs.LogTransformerTransformerConfigCopyValueEntry]) -> None:
...
class LogTransformerTransformerConfigCopyValueEntry(dict):
    ...
    def __init__(__self__, *, source: _builtins.str, target: _builtins.str, overwrite_if_exists: Optional[_builtins.bool] = ...) -> None:
...
class LogTransformerTransformerConfigCsv(dict):
    ...
    def __init__(__self__, *, columns: Optional[Sequence[_builtins.str]] = ..., delimiter: Optional[_builtins.str] = ..., quote_character: Optional[_builtins.str] = ..., source: Optional[_builtins.str] = ...) -> None:
...
class LogTransformerTransformerConfigDateTimeConverter(dict):
    ...
    def __init__(__self__, *, match_patterns: Sequence[_builtins.str], source: _builtins.str, target: _builtins.str, locale: Optional[_builtins.str] = ..., source_timezone: Optional[_builtins.str] = ..., target_format: Optional[_builtins.str] = ..., target_timezone: Optional[_builtins.str] = ...) -> None:
...
class LogTransformerTransformerConfigGrok(dict):
    def __init__(__self__, *, match: _builtins.str, source: Optional[_builtins.str] = ...) -> None:
...
class LogTransformerTransformerConfigListToMap(dict):
    ...
    def __init__(__self__, *, key: _builtins.str, source: _builtins.str, flatten: Optional[_builtins.bool] = ..., flattened_element: Optional[_builtins.str] = ..., target: Optional[_builtins.str] = ..., value_key: Optional[_builtins.str] = ...) -> None:
...
class LogTransformerTransformerConfigMoveKey(dict):
    def __init__(__self__, *, entries: Sequence[outputs.LogTransformerTransformerConfigMoveKeyEntry]) -> None:
...
class LogTransformerTransformerConfigParseJson(dict):
    def __init__(__self__, *, destination: Optional[_builtins.str] = ..., source: Optional[_builtins.str] = ...) -> None:
...
class LogTransformerTransformerConfigParseKeyValue(dict):
    ...
    def __init__(__self__, *, destination: Optional[_builtins.str] = ..., field_delimiter: Optional[_builtins.str] = ..., key_prefix: Optional[_builtins.str] = ..., key_value_delimiter: Optional[_builtins.str] = ..., non_match_value: Optional[_builtins.str] = ..., overwrite_if_exists: Optional[_builtins.bool] = ..., source: Optional[_builtins.str] = ...) -> None:
...
class LogTransformerTransformerConfigParseToOcsf(dict):
    ...
    def __init__(__self__, *, event_source: _builtins.str, ocsf_version: _builtins.str, source: Optional[_builtins.str] = ...) -> None:
...
class LogTransformerTransformerConfigRenameKey(dict):
    def __init__(__self__, *, entries: Sequence[outputs.LogTransformerTransformerConfigRenameKeyEntry]) -> None:
...
class LogTransformerTransformerConfigRenameKeyEntry(dict):
    ...
    def __init__(__self__, *, key: _builtins.str, rename_to: _builtins.str, overwrite_if_exists: Optional[_builtins.bool] = ...) -> None:
...
class LogTransformerTransformerConfigSplitString(dict):
    def __init__(__self__, *, entries: Sequence[outputs.LogTransformerTransformerConfigSplitStringEntry]) -> None:
...
class LogTransformerTransformerConfigSplitStringEntry(dict):
    def __init__(__self__, *, delimiter: _builtins.str, source: _builtins.str) -> None:
...
class LogTransformerTransformerConfigSubstituteString(dict):
    def __init__(__self__, *, entries: Sequence[outputs.LogTransformerTransformerConfigSubstituteStringEntry]) -> None:
...
class LogTransformerTransformerConfigSubstituteStringEntry(dict):
    ...
    def __init__(__self__, *, from_: _builtins.str, source: _builtins.str, to: _builtins.str) -> None:
...
class LogTransformerTransformerConfigTypeConverter(dict):
    def __init__(__self__, *, entries: Sequence[outputs.LogTransformerTransformerConfigTypeConverterEntry]) -> None:
...
class MetricAlarmMetricQuery(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, account_id: Optional[_builtins.str] = ..., expression: Optional[_builtins.str] = ..., label: Optional[_builtins.str] = ..., metric: Optional[outputs.MetricAlarmMetricQueryMetric] = ..., period: Optional[_builtins.int] = ..., return_data: Optional[_builtins.bool] = ...) -> None:
...
class MetricAlarmMetricQueryMetric(dict):
    ...
    def __init__(__self__, *, metric_name: _builtins.str, period: _builtins.int, stat: _builtins.str, dimensions: Optional[Mapping[str, _builtins.str]] = ..., namespace: Optional[_builtins.str] = ..., unit: Optional[_builtins.str] = ...) -> None:
...
class MetricStreamExcludeFilter(dict):
    ...
    def __init__(__self__, *, namespace: _builtins.str, metric_names: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class MetricStreamStatisticsConfiguration(dict):
    ...
    def __init__(__self__, *, additional_statistics: Sequence[_builtins.str], include_metrics: Sequence[outputs.MetricStreamStatisticsConfigurationIncludeMetric]) -> None:
...
class MetricStreamStatisticsConfigurationIncludeMetric(dict):
    ...
    def __init__(__self__, *, metric_name: _builtins.str, namespace: _builtins.str) -> None:
...
class GetContributorManagedInsightRulesManagedRuleResult(dict):
    def __init__(__self__, *, resource_arn: _builtins.str, rule_states: Sequence[outputs.GetContributorManagedInsightRulesManagedRuleRuleStateResult], template_name: _builtins.str) -> None:
...
class GetContributorManagedInsightRulesManagedRuleRuleStateResult(dict):
    def __init__(__self__, *, rule_name: _builtins.str, state: _builtins.str) -> None:
...
class GetEventBusLogConfigResult(dict):
    def __init__(__self__, *, include_detail: _builtins.str, level: _builtins.str) -> None:
...
class GetEventBusesEventBusResult(dict):
    def __init__(__self__, *, arn: _builtins.str, creation_time: _builtins.str, description: _builtins.str, last_modified_time: _builtins.str, name: _builtins.str, policy: _builtins.str) -> None:
...
class GetLogDataProtectionPolicyDocumentConfigurationResult(dict):
    def __init__(__self__, *, custom_data_identifiers: Optional[Sequence[outputs.GetLogDataProtectionPolicyDocumentConfigurationCustomDataIdentifierResult]] = ...) -> None:
...
class GetLogDataProtectionPolicyDocumentStatementResult(dict):
    def __init__(__self__, *, data_identifiers: Sequence[_builtins.str], operation: outputs.GetLogDataProtectionPolicyDocumentStatementOperationResult, sid: Optional[_builtins.str] = ...) -> None:
...
class GetLogDataProtectionPolicyDocumentStatementOperationResult(dict):
    def __init__(__self__, *, audit: Optional[outputs.GetLogDataProtectionPolicyDocumentStatementOperationAuditResult] = ..., deidentify: Optional[outputs.GetLogDataProtectionPolicyDocumentStatementOperationDeidentifyResult] = ...) -> None:
...
class GetLogDataProtectionPolicyDocumentStatementOperationAuditResult(dict):
    def __init__(__self__, *, findings_destination: outputs.GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationResult) -> None:
...
class GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationResult(dict):
    def __init__(__self__, *, cloudwatch_logs: Optional[outputs.GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationCloudwatchLogsResult] = ..., firehose: Optional[outputs.GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationFirehoseResult] = ..., s3: Optional[outputs.GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationS3Result] = ...) -> None:
...
class GetLogDataProtectionPolicyDocumentStatementOperationDeidentifyResult(dict):
    def __init__(__self__, *, mask_config: outputs.GetLogDataProtectionPolicyDocumentStatementOperationDeidentifyMaskConfigResult) -> None:
