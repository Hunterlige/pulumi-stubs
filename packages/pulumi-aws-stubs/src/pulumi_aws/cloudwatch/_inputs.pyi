...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CompositeAlarmActionsSuppressorArgs', 'CompositeAlarmActionsSuppressorArgsDict', 'EventBusDeadLetterConfigArgs', 'EventBusDeadLetterConfigArgsDict', 'EventBusLogConfigArgs', 'EventBusLogConfigArgsDict', 'EventConnectionAuthParametersArgs', 'EventConnectionAuthParametersArgsDict', 'EventConnectionAuthParametersApiKeyArgs', 'EventConnectionAuthParametersApiKeyArgsDict', 'EventConnectionAuthParametersBasicArgs', 'EventConnectionAuthParametersBasicArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'EventConnectionAuthParametersOauthArgs', 'EventConnectionAuthParametersOauthArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'EventEndpointEventBusArgs', 'EventEndpointEventBusArgsDict', 'EventEndpointReplicationConfigArgs', 'EventEndpointReplicationConfigArgsDict', 'EventEndpointRoutingConfigArgs', 'EventEndpointRoutingConfigArgsDict', 'EventEndpointRoutingConfigFailoverConfigArgs', 'EventEndpointRoutingConfigFailoverConfigArgsDict', ..., ..., ..., ..., 'EventPermissionConditionArgs', 'EventPermissionConditionArgsDict', 'EventTargetAppsyncTargetArgs', 'EventTargetAppsyncTargetArgsDict', 'EventTargetBatchTargetArgs', 'EventTargetBatchTargetArgsDict', 'EventTargetDeadLetterConfigArgs', 'EventTargetDeadLetterConfigArgsDict', 'EventTargetEcsTargetArgs', 'EventTargetEcsTargetArgsDict', 'EventTargetEcsTargetCapacityProviderStrategyArgs', ..., 'EventTargetEcsTargetNetworkConfigurationArgs', 'EventTargetEcsTargetNetworkConfigurationArgsDict', 'EventTargetEcsTargetOrderedPlacementStrategyArgs', ..., 'EventTargetEcsTargetPlacementConstraintArgs', 'EventTargetEcsTargetPlacementConstraintArgsDict', 'EventTargetHttpTargetArgs', 'EventTargetHttpTargetArgsDict', 'EventTargetInputTransformerArgs', 'EventTargetInputTransformerArgsDict', 'EventTargetKinesisTargetArgs', 'EventTargetKinesisTargetArgsDict', 'EventTargetRedshiftTargetArgs', 'EventTargetRedshiftTargetArgsDict', 'EventTargetRetryPolicyArgs', 'EventTargetRetryPolicyArgsDict', 'EventTargetRunCommandTargetArgs', 'EventTargetRunCommandTargetArgsDict', 'EventTargetSagemakerPipelineTargetArgs', 'EventTargetSagemakerPipelineTargetArgsDict', ..., ..., 'EventTargetSqsTargetArgs', 'EventTargetSqsTargetArgsDict', 'InternetMonitorHealthEventsConfigArgs', 'InternetMonitorHealthEventsConfigArgsDict', 'InternetMonitorInternetMeasurementsLogDeliveryArgs', ..., ..., ..., ..., ..., 'LogDeliveryS3DeliveryConfigurationArgs', 'LogDeliveryS3DeliveryConfigurationArgsDict', 'LogMetricFilterMetricTransformationArgs', 'LogMetricFilterMetricTransformationArgsDict', 'LogTransformerTransformerConfigArgs', 'LogTransformerTransformerConfigArgsDict', 'LogTransformerTransformerConfigAddKeysArgs', 'LogTransformerTransformerConfigAddKeysArgsDict', 'LogTransformerTransformerConfigAddKeysEntryArgs', ..., 'LogTransformerTransformerConfigCopyValueArgs', 'LogTransformerTransformerConfigCopyValueArgsDict', 'LogTransformerTransformerConfigCopyValueEntryArgs', ..., 'LogTransformerTransformerConfigCsvArgs', 'LogTransformerTransformerConfigCsvArgsDict', ..., ..., 'LogTransformerTransformerConfigDeleteKeyArgs', 'LogTransformerTransformerConfigDeleteKeyArgsDict', 'LogTransformerTransformerConfigGrokArgs', 'LogTransformerTransformerConfigGrokArgsDict', 'LogTransformerTransformerConfigListToMapArgs', 'LogTransformerTransformerConfigListToMapArgsDict', 'LogTransformerTransformerConfigLowerCaseStringArgs', ..., 'LogTransformerTransformerConfigMoveKeyArgs', 'LogTransformerTransformerConfigMoveKeyArgsDict', 'LogTransformerTransformerConfigMoveKeyEntryArgs', ..., 'LogTransformerTransformerConfigParseCloudfrontArgs', ..., 'LogTransformerTransformerConfigParseJsonArgs', 'LogTransformerTransformerConfigParseJsonArgsDict', 'LogTransformerTransformerConfigParseKeyValueArgs', ..., 'LogTransformerTransformerConfigParsePostgresArgs', ..., 'LogTransformerTransformerConfigParseRoute53Args', ..., 'LogTransformerTransformerConfigParseToOcsfArgs', 'LogTransformerTransformerConfigParseToOcsfArgsDict', 'LogTransformerTransformerConfigParseVpcArgs', 'LogTransformerTransformerConfigParseVpcArgsDict', 'LogTransformerTransformerConfigParseWafArgs', 'LogTransformerTransformerConfigParseWafArgsDict', 'LogTransformerTransformerConfigRenameKeyArgs', 'LogTransformerTransformerConfigRenameKeyArgsDict', 'LogTransformerTransformerConfigRenameKeyEntryArgs', ..., 'LogTransformerTransformerConfigSplitStringArgs', 'LogTransformerTransformerConfigSplitStringArgsDict', ..., ..., ..., ..., ..., ..., 'LogTransformerTransformerConfigTrimStringArgs', 'LogTransformerTransformerConfigTrimStringArgsDict', 'LogTransformerTransformerConfigTypeConverterArgs', ..., ..., ..., 'LogTransformerTransformerConfigUpperCaseStringArgs', ..., 'MetricAlarmMetricQueryArgs', 'MetricAlarmMetricQueryArgsDict', 'MetricAlarmMetricQueryMetricArgs', 'MetricAlarmMetricQueryMetricArgsDict', 'MetricStreamExcludeFilterArgs', 'MetricStreamExcludeFilterArgsDict', 'MetricStreamIncludeFilterArgs', 'MetricStreamIncludeFilterArgsDict', 'MetricStreamStatisticsConfigurationArgs', 'MetricStreamStatisticsConfigurationArgsDict', ..., ..., 'PolicyDocumentArgs', 'PolicyDocumentArgsDict', ..., ..., ..., ..., 'GetLogDataProtectionPolicyDocumentStatementArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ...]
...
class CompositeAlarmActionsSuppressorArgs:
    def __init__(__self__, *, alarm: pulumi.Input[_builtins.str], extension_period: pulumi.Input[_builtins.int], wait_period: pulumi.Input[_builtins.int]) -> None:
    ...
    @alarm.setter
    def alarm(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def extension_period(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @wait_period.setter
    def wait_period(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class EventBusLogConfigArgs:
    def __init__(__self__, *, include_detail: Optional[pulumi.Input[_builtins.str]] = ..., level: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def include_detail(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventConnectionAuthParametersArgs:
    def __init__(__self__, *, api_key: Optional[pulumi.Input[EventConnectionAuthParametersApiKeyArgs]] = ..., basic: Optional[pulumi.Input[EventConnectionAuthParametersBasicArgs]] = ..., connectivity_parameters: Optional[pulumi.Input[EventConnectionAuthParametersConnectivityParametersArgs]] = ..., invocation_http_parameters: Optional[pulumi.Input[EventConnectionAuthParametersInvocationHttpParametersArgs]] = ..., oauth: Optional[pulumi.Input[EventConnectionAuthParametersOauthArgs]] = ...) -> None:
    ...
    @api_key.setter
    def api_key(self, value: Optional[pulumi.Input[EventConnectionAuthParametersApiKeyArgs]]): # -> None:
        ...
    ...
    @basic.setter
    def basic(self, value: Optional[pulumi.Input[EventConnectionAuthParametersBasicArgs]]): # -> None:
        ...
    ...
    def connectivity_parameters(self, value: Optional[pulumi.Input[EventConnectionAuthParametersConnectivityParametersArgs]]): # -> None:
        ...
    ...
    def invocation_http_parameters(self, value: Optional[pulumi.Input[EventConnectionAuthParametersInvocationHttpParametersArgs]]): # -> None:
        ...
    ...
    @oauth.setter
    def oauth(self, value: Optional[pulumi.Input[EventConnectionAuthParametersOauthArgs]]): # -> None:
        ...
...
class EventConnectionAuthParametersConnectivityParametersArgs:
    def __init__(__self__, *, resource_parameters: pulumi.Input[EventConnectionAuthParametersConnectivityParametersResourceParametersArgs]) -> None:
    ...
    def resource_parameters(self, value: pulumi.Input[EventConnectionAuthParametersConnectivityParametersResourceParametersArgs]): # -> None:
        ...
...
class EventConnectionAuthParametersConnectivityParametersResourceParametersArgs:
    def __init__(__self__, *, resource_configuration_arn: pulumi.Input[_builtins.str], resource_association_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def resource_configuration_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def resource_association_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventConnectionAuthParametersInvocationHttpParametersArgs:
    def __init__(__self__, *, bodies: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersInvocationHttpParametersBodyArgs]]]] = ..., headers: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersInvocationHttpParametersHeaderArgs]]]] = ..., query_strings: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersInvocationHttpParametersQueryStringArgs]]]] = ...) -> None:
    ...
    @bodies.setter
    def bodies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersInvocationHttpParametersBodyArgs]]]]): # -> None:
        ...
    ...
    @headers.setter
    def headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersInvocationHttpParametersHeaderArgs]]]]): # -> None:
        ...
    ...
    def query_strings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersInvocationHttpParametersQueryStringArgs]]]]): # -> None:
        ...
...
class EventConnectionAuthParametersInvocationHttpParametersBodyArgs:
    def __init__(__self__, *, is_value_secret: Optional[pulumi.Input[_builtins.bool]] = ..., key: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def is_value_secret(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class EventConnectionAuthParametersOauthArgs:
    def __init__(__self__, *, authorization_endpoint: pulumi.Input[_builtins.str], http_method: pulumi.Input[_builtins.str], oauth_http_parameters: pulumi.Input[EventConnectionAuthParametersOauthOauthHttpParametersArgs], client_parameters: Optional[pulumi.Input[EventConnectionAuthParametersOauthClientParametersArgs]] = ...) -> None:
    ...
    def oauth_http_parameters(self, value: pulumi.Input[EventConnectionAuthParametersOauthOauthHttpParametersArgs]): # -> None:
        ...
    ...
    def client_parameters(self, value: Optional[pulumi.Input[EventConnectionAuthParametersOauthClientParametersArgs]]): # -> None:
        ...
...
class EventConnectionAuthParametersOauthClientParametersArgs:
    def __init__(__self__, *, client_id: pulumi.Input[_builtins.str], client_secret: pulumi.Input[_builtins.str]) -> None:
...
class EventConnectionAuthParametersOauthOauthHttpParametersArgs:
    def __init__(__self__, *, bodies: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersOauthOauthHttpParametersBodyArgs]]]] = ..., headers: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersOauthOauthHttpParametersHeaderArgs]]]] = ..., query_strings: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersOauthOauthHttpParametersQueryStringArgs]]]] = ...) -> None:
    ...
    @bodies.setter
    def bodies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersOauthOauthHttpParametersBodyArgs]]]]): # -> None:
        ...
    ...
    @headers.setter
    def headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersOauthOauthHttpParametersHeaderArgs]]]]): # -> None:
        ...
    ...
    @query_strings.setter
    def query_strings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventConnectionAuthParametersOauthOauthHttpParametersQueryStringArgs]]]]): # -> None:
        ...
...
class EventConnectionInvocationConnectivityParametersArgs:
    def __init__(__self__, *, resource_parameters: pulumi.Input[EventConnectionInvocationConnectivityParametersResourceParametersArgs]) -> None:
    ...
    @resource_parameters.setter
    def resource_parameters(self, value: pulumi.Input[EventConnectionInvocationConnectivityParametersResourceParametersArgs]): # -> None:
        ...
...
class EventEndpointRoutingConfigArgs:
    def __init__(__self__, *, failover_config: pulumi.Input[EventEndpointRoutingConfigFailoverConfigArgs]) -> None:
    ...
    def failover_config(self, value: pulumi.Input[EventEndpointRoutingConfigFailoverConfigArgs]): # -> None:
        ...
...
class EventEndpointRoutingConfigFailoverConfigArgs:
    def __init__(__self__, *, primary: pulumi.Input[EventEndpointRoutingConfigFailoverConfigPrimaryArgs], secondary: pulumi.Input[EventEndpointRoutingConfigFailoverConfigSecondaryArgs]) -> None:
    ...
    @primary.setter
    def primary(self, value: pulumi.Input[EventEndpointRoutingConfigFailoverConfigPrimaryArgs]): # -> None:
        ...
    ...
    @secondary.setter
    def secondary(self, value: pulumi.Input[EventEndpointRoutingConfigFailoverConfigSecondaryArgs]): # -> None:
        ...
...
class EventEndpointRoutingConfigFailoverConfigPrimaryArgs:
    def __init__(__self__, *, health_check: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EventEndpointRoutingConfigFailoverConfigSecondaryArgs:
    def __init__(__self__, *, route: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @route.setter
    def route(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventPermissionConditionArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str]) -> None:
...
class EventTargetAppsyncTargetArgs:
    def __init__(__self__, *, graphql_operation: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def graphql_operation(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventTargetBatchTargetArgs:
    def __init__(__self__, *, job_definition: pulumi.Input[_builtins.str], job_name: pulumi.Input[_builtins.str], array_size: Optional[pulumi.Input[_builtins.int]] = ..., job_attempts: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def job_definition(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @array_size.setter
    def array_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @job_attempts.setter
    def job_attempts(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class EventTargetEcsTargetArgs:
    def __init__(__self__, *, task_definition_arn: pulumi.Input[_builtins.str], capacity_provider_strategies: Optional[pulumi.Input[Sequence[pulumi.Input[EventTargetEcsTargetCapacityProviderStrategyArgs]]]] = ..., enable_ecs_managed_tags: Optional[pulumi.Input[_builtins.bool]] = ..., enable_execute_command: Optional[pulumi.Input[_builtins.bool]] = ..., group: Optional[pulumi.Input[_builtins.str]] = ..., launch_type: Optional[pulumi.Input[_builtins.str]] = ..., network_configuration: Optional[pulumi.Input[EventTargetEcsTargetNetworkConfigurationArgs]] = ..., ordered_placement_strategies: Optional[pulumi.Input[Sequence[pulumi.Input[EventTargetEcsTargetOrderedPlacementStrategyArgs]]]] = ..., placement_constraints: Optional[pulumi.Input[Sequence[pulumi.Input[EventTargetEcsTargetPlacementConstraintArgs]]]] = ..., platform_version: Optional[pulumi.Input[_builtins.str]] = ..., propagate_tags: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., task_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def capacity_provider_strategies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventTargetEcsTargetCapacityProviderStrategyArgs]]]]): # -> None:
        ...
    ...
    def network_configuration(self, value: Optional[pulumi.Input[EventTargetEcsTargetNetworkConfigurationArgs]]): # -> None:
        ...
    ...
    def ordered_placement_strategies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventTargetEcsTargetOrderedPlacementStrategyArgs]]]]): # -> None:
        ...
    ...
    def placement_constraints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventTargetEcsTargetPlacementConstraintArgs]]]]): # -> None:
        ...
...
class EventTargetHttpTargetArgs:
    def __init__(__self__, *, header_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., path_parameter_values: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., query_string_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def header_parameters(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def path_parameter_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def query_string_parameters(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EventTargetInputTransformerArgs:
    def __init__(__self__, *, input_template: pulumi.Input[_builtins.str], input_paths: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def input_template(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @input_paths.setter
    def input_paths(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EventTargetKinesisTargetArgs:
    def __init__(__self__, *, partition_key_path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def partition_key_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventTargetRedshiftTargetArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], db_user: Optional[pulumi.Input[_builtins.str]] = ..., secrets_manager_arn: Optional[pulumi.Input[_builtins.str]] = ..., sql: Optional[pulumi.Input[_builtins.str]] = ..., statement_name: Optional[pulumi.Input[_builtins.str]] = ..., with_event: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def secrets_manager_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EventTargetSagemakerPipelineTargetArgs:
    def __init__(__self__, *, pipeline_parameter_lists: Optional[pulumi.Input[Sequence[pulumi.Input[EventTargetSagemakerPipelineTargetPipelineParameterListArgs]]]] = ...) -> None:
    ...
    def pipeline_parameter_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EventTargetSagemakerPipelineTargetPipelineParameterListArgs]]]]): # -> None:
        ...
...
class InternetMonitorHealthEventsConfigArgs:
    def __init__(__self__, *, availability_score_threshold: Optional[pulumi.Input[_builtins.float]] = ..., performance_score_threshold: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def availability_score_threshold(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def performance_score_threshold(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class InternetMonitorInternetMeasurementsLogDeliveryArgs:
    def __init__(__self__, *, s3_config: Optional[pulumi.Input[InternetMonitorInternetMeasurementsLogDeliveryS3ConfigArgs]] = ...) -> None:
        ...
    ...
    @s3_config.setter
    def s3_config(self, value: Optional[pulumi.Input[InternetMonitorInternetMeasurementsLogDeliveryS3ConfigArgs]]): # -> None:
        ...
...
class InternetMonitorInternetMeasurementsLogDeliveryS3ConfigArgs:
    def __init__(__self__, *, bucket_name: pulumi.Input[_builtins.str], bucket_prefix: Optional[pulumi.Input[_builtins.str]] = ..., log_delivery_status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    def log_delivery_status(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LogDeliveryDestinationDeliveryDestinationConfigurationArgs:
    def __init__(__self__, *, destination_resource_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def destination_resource_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LogDeliveryS3DeliveryConfigurationArgs:
    def __init__(__self__, *, enable_hive_compatible_path: pulumi.Input[_builtins.bool], suffix_path: pulumi.Input[_builtins.str]) -> None:
    ...
    def enable_hive_compatible_path(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    @suffix_path.setter
    def suffix_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class LogMetricFilterMetricTransformationArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], namespace: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str], default_value: Optional[pulumi.Input[_builtins.str]] = ..., dimensions: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., unit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LogTransformerTransformerConfigArgs:
    def __init__(__self__, *, add_keys: Optional[pulumi.Input[LogTransformerTransformerConfigAddKeysArgs]] = ..., copy_value: Optional[pulumi.Input[LogTransformerTransformerConfigCopyValueArgs]] = ..., csvs: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigCsvArgs]]]] = ..., date_time_converters: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigDateTimeConverterArgs]]]] = ..., delete_keys: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigDeleteKeyArgs]]]] = ..., grok: Optional[pulumi.Input[LogTransformerTransformerConfigGrokArgs]] = ..., list_to_maps: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigListToMapArgs]]]] = ..., lower_case_strings: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigLowerCaseStringArgs]]]] = ..., move_keys: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigMoveKeyArgs]]]] = ..., parse_cloudfront: Optional[pulumi.Input[LogTransformerTransformerConfigParseCloudfrontArgs]] = ..., parse_jsons: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigParseJsonArgs]]]] = ..., parse_key_values: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigParseKeyValueArgs]]]] = ..., parse_postgres: Optional[pulumi.Input[LogTransformerTransformerConfigParsePostgresArgs]] = ..., parse_route53: Optional[pulumi.Input[LogTransformerTransformerConfigParseRoute53Args]] = ..., parse_to_ocsf: Optional[pulumi.Input[LogTransformerTransformerConfigParseToOcsfArgs]] = ..., parse_vpc: Optional[pulumi.Input[LogTransformerTransformerConfigParseVpcArgs]] = ..., parse_waf: Optional[pulumi.Input[LogTransformerTransformerConfigParseWafArgs]] = ..., rename_keys: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigRenameKeyArgs]]]] = ..., split_strings: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigSplitStringArgs]]]] = ..., substitute_strings: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigSubstituteStringArgs]]]] = ..., trim_strings: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigTrimStringArgs]]]] = ..., type_converters: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigTypeConverterArgs]]]] = ..., upper_case_strings: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigUpperCaseStringArgs]]]] = ...) -> None:
    ...
    @add_keys.setter
    def add_keys(self, value: Optional[pulumi.Input[LogTransformerTransformerConfigAddKeysArgs]]): # -> None:
        ...
    ...
    @copy_value.setter
    def copy_value(self, value: Optional[pulumi.Input[LogTransformerTransformerConfigCopyValueArgs]]): # -> None:
        ...
    ...
    @csvs.setter
    def csvs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigCsvArgs]]]]): # -> None:
        ...
    ...
    def date_time_converters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigDateTimeConverterArgs]]]]): # -> None:
        ...
    ...
    @delete_keys.setter
    def delete_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigDeleteKeyArgs]]]]): # -> None:
        ...
    ...
    @grok.setter
    def grok(self, value: Optional[pulumi.Input[LogTransformerTransformerConfigGrokArgs]]): # -> None:
        ...
    ...
    @list_to_maps.setter
    def list_to_maps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigListToMapArgs]]]]): # -> None:
        ...
    ...
    def lower_case_strings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigLowerCaseStringArgs]]]]): # -> None:
        ...
    ...
    @move_keys.setter
    def move_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigMoveKeyArgs]]]]): # -> None:
        ...
    ...
    def parse_cloudfront(self, value: Optional[pulumi.Input[LogTransformerTransformerConfigParseCloudfrontArgs]]): # -> None:
        ...
    ...
    @parse_jsons.setter
    def parse_jsons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigParseJsonArgs]]]]): # -> None:
        ...
    ...
    def parse_key_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigParseKeyValueArgs]]]]): # -> None:
        ...
    ...
    def parse_postgres(self, value: Optional[pulumi.Input[LogTransformerTransformerConfigParsePostgresArgs]]): # -> None:
        ...
    ...
    def parse_route53(self, value: Optional[pulumi.Input[LogTransformerTransformerConfigParseRoute53Args]]): # -> None:
        ...
    ...
    def parse_to_ocsf(self, value: Optional[pulumi.Input[LogTransformerTransformerConfigParseToOcsfArgs]]): # -> None:
        ...
    ...
    @parse_vpc.setter
    def parse_vpc(self, value: Optional[pulumi.Input[LogTransformerTransformerConfigParseVpcArgs]]): # -> None:
        ...
    ...
    @parse_waf.setter
    def parse_waf(self, value: Optional[pulumi.Input[LogTransformerTransformerConfigParseWafArgs]]): # -> None:
        ...
    ...
    @rename_keys.setter
    def rename_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigRenameKeyArgs]]]]): # -> None:
        ...
    ...
    def split_strings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigSplitStringArgs]]]]): # -> None:
        ...
    ...
    def substitute_strings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigSubstituteStringArgs]]]]): # -> None:
        ...
    ...
    @trim_strings.setter
    def trim_strings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigTrimStringArgs]]]]): # -> None:
        ...
    ...
    def type_converters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigTypeConverterArgs]]]]): # -> None:
        ...
    ...
    def upper_case_strings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigUpperCaseStringArgs]]]]): # -> None:
        ...
...
class LogTransformerTransformerConfigAddKeysArgs:
    def __init__(__self__, *, entries: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigAddKeysEntryArgs]]]) -> None:
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigAddKeysEntryArgs]]]): # -> None:
        ...
...
class LogTransformerTransformerConfigAddKeysEntryArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str], overwrite_if_exists: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def overwrite_if_exists(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class LogTransformerTransformerConfigCopyValueArgs:
    def __init__(__self__, *, entries: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigCopyValueEntryArgs]]]) -> None:
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigCopyValueEntryArgs]]]): # -> None:
        ...
...
class LogTransformerTransformerConfigCopyValueEntryArgs:
    def __init__(__self__, *, source: pulumi.Input[_builtins.str], target: pulumi.Input[_builtins.str], overwrite_if_exists: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class LogTransformerTransformerConfigCsvArgs:
    def __init__(__self__, *, columns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., delimiter: Optional[pulumi.Input[_builtins.str]] = ..., quote_character: Optional[pulumi.Input[_builtins.str]] = ..., source: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def quote_character(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LogTransformerTransformerConfigDateTimeConverterArgs:
    def __init__(__self__, *, match_patterns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], source: pulumi.Input[_builtins.str], target: pulumi.Input[_builtins.str], locale: Optional[pulumi.Input[_builtins.str]] = ..., source_timezone: Optional[pulumi.Input[_builtins.str]] = ..., target_format: Optional[pulumi.Input[_builtins.str]] = ..., target_timezone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def match_patterns(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def source_timezone(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_timezone(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LogTransformerTransformerConfigDeleteKeyArgs:
    def __init__(__self__, *, with_keys: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @with_keys.setter
    def with_keys(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class LogTransformerTransformerConfigGrokArgs:
    def __init__(__self__, *, match: pulumi.Input[_builtins.str], source: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LogTransformerTransformerConfigListToMapArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], source: pulumi.Input[_builtins.str], flatten: Optional[pulumi.Input[_builtins.bool]] = ..., flattened_element: Optional[pulumi.Input[_builtins.str]] = ..., target: Optional[pulumi.Input[_builtins.str]] = ..., value_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @flatten.setter
    def flatten(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def flattened_element(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @value_key.setter
    def value_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LogTransformerTransformerConfigMoveKeyArgs:
    def __init__(__self__, *, entries: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigMoveKeyEntryArgs]]]) -> None:
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigMoveKeyEntryArgs]]]): # -> None:
        ...
...
class LogTransformerTransformerConfigParseCloudfrontArgs:
    def __init__(__self__, *, source: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LogTransformerTransformerConfigParseJsonArgs:
    def __init__(__self__, *, destination: Optional[pulumi.Input[_builtins.str]] = ..., source: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LogTransformerTransformerConfigParseKeyValueArgs:
    def __init__(__self__, *, destination: Optional[pulumi.Input[_builtins.str]] = ..., field_delimiter: Optional[pulumi.Input[_builtins.str]] = ..., key_prefix: Optional[pulumi.Input[_builtins.str]] = ..., key_value_delimiter: Optional[pulumi.Input[_builtins.str]] = ..., non_match_value: Optional[pulumi.Input[_builtins.str]] = ..., overwrite_if_exists: Optional[pulumi.Input[_builtins.bool]] = ..., source: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def key_value_delimiter(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def non_match_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LogTransformerTransformerConfigParseToOcsfArgs:
    def __init__(__self__, *, event_source: pulumi.Input[_builtins.str], ocsf_version: pulumi.Input[_builtins.str], source: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @event_source.setter
    def event_source(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @ocsf_version.setter
    def ocsf_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class LogTransformerTransformerConfigRenameKeyArgs:
    def __init__(__self__, *, entries: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigRenameKeyEntryArgs]]]) -> None:
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigRenameKeyEntryArgs]]]): # -> None:
        ...
...
class LogTransformerTransformerConfigRenameKeyEntryArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], rename_to: pulumi.Input[_builtins.str], overwrite_if_exists: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @rename_to.setter
    def rename_to(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class LogTransformerTransformerConfigSplitStringArgs:
    def __init__(__self__, *, entries: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigSplitStringEntryArgs]]]) -> None:
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigSplitStringEntryArgs]]]): # -> None:
        ...
...
class LogTransformerTransformerConfigSplitStringEntryArgs:
    def __init__(__self__, *, delimiter: pulumi.Input[_builtins.str], source: pulumi.Input[_builtins.str]) -> None:
...
class LogTransformerTransformerConfigSubstituteStringArgs:
    def __init__(__self__, *, entries: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigSubstituteStringEntryArgs]]]) -> None:
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigSubstituteStringEntryArgs]]]): # -> None:
        ...
...
class LogTransformerTransformerConfigSubstituteStringEntryArgs:
    def __init__(__self__, *, from_: pulumi.Input[_builtins.str], source: pulumi.Input[_builtins.str], to: pulumi.Input[_builtins.str]) -> None:
...
class LogTransformerTransformerConfigTypeConverterArgs:
    def __init__(__self__, *, entries: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigTypeConverterEntryArgs]]]) -> None:
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Sequence[pulumi.Input[LogTransformerTransformerConfigTypeConverterEntryArgs]]]): # -> None:
        ...
...
class LogTransformerTransformerConfigTypeConverterEntryArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str]) -> None:
...
class MetricAlarmMetricQueryArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], account_id: Optional[pulumi.Input[_builtins.str]] = ..., expression: Optional[pulumi.Input[_builtins.str]] = ..., label: Optional[pulumi.Input[_builtins.str]] = ..., metric: Optional[pulumi.Input[MetricAlarmMetricQueryMetricArgs]] = ..., period: Optional[pulumi.Input[_builtins.int]] = ..., return_data: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @metric.setter
    def metric(self, value: Optional[pulumi.Input[MetricAlarmMetricQueryMetricArgs]]): # -> None:
        ...
    ...
    @period.setter
    def period(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @return_data.setter
    def return_data(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class MetricAlarmMetricQueryMetricArgs:
    def __init__(__self__, *, metric_name: pulumi.Input[_builtins.str], period: pulumi.Input[_builtins.int], stat: pulumi.Input[_builtins.str], dimensions: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., namespace: Optional[pulumi.Input[_builtins.str]] = ..., unit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @stat.setter
    def stat(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class MetricStreamExcludeFilterArgs:
    def __init__(__self__, *, namespace: pulumi.Input[_builtins.str], metric_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @metric_names.setter
    def metric_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class MetricStreamStatisticsConfigurationArgs:
    def __init__(__self__, *, additional_statistics: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], include_metrics: pulumi.Input[Sequence[pulumi.Input[MetricStreamStatisticsConfigurationIncludeMetricArgs]]]) -> None:
    ...
    def additional_statistics(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def include_metrics(self, value: pulumi.Input[Sequence[pulumi.Input[MetricStreamStatisticsConfigurationIncludeMetricArgs]]]): # -> None:
        ...
...
class MetricStreamStatisticsConfigurationIncludeMetricArgs:
    def __init__(__self__, *, metric_name: pulumi.Input[_builtins.str], namespace: pulumi.Input[_builtins.str]) -> None:
...
class GetLogDataProtectionPolicyDocumentConfigurationArgs:
    def __init__(__self__, *, custom_data_identifiers: Optional[Sequence[GetLogDataProtectionPolicyDocumentConfigurationCustomDataIdentifierArgs]] = ...) -> None:
    ...
    def custom_data_identifiers(self, value: Optional[Sequence[GetLogDataProtectionPolicyDocumentConfigurationCustomDataIdentifierArgs]]): # -> None:
        ...
...
class GetLogDataProtectionPolicyDocumentStatementArgs:
    def __init__(__self__, *, data_identifiers: Sequence[_builtins.str], operation: GetLogDataProtectionPolicyDocumentStatementOperationArgs, sid: Optional[_builtins.str] = ...) -> None:
    ...
    def data_identifiers(self, value: Sequence[_builtins.str]): # -> None:
        ...
    ...
    @operation.setter
    def operation(self, value: GetLogDataProtectionPolicyDocumentStatementOperationArgs): # -> None:
        ...
    ...
    @sid.setter
    def sid(self, value: Optional[_builtins.str]): # -> None:
        ...
...
class GetLogDataProtectionPolicyDocumentStatementOperationArgs:
    def __init__(__self__, *, audit: Optional[GetLogDataProtectionPolicyDocumentStatementOperationAuditArgs] = ..., deidentify: Optional[GetLogDataProtectionPolicyDocumentStatementOperationDeidentifyArgs] = ...) -> None:
    ...
    @audit.setter
    def audit(self, value: Optional[GetLogDataProtectionPolicyDocumentStatementOperationAuditArgs]): # -> None:
        ...
    ...
    @deidentify.setter
    def deidentify(self, value: Optional[GetLogDataProtectionPolicyDocumentStatementOperationDeidentifyArgs]): # -> None:
        ...
...
class GetLogDataProtectionPolicyDocumentStatementOperationAuditArgs:
    def __init__(__self__, *, findings_destination: GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationArgs) -> None:
    ...
    def findings_destination(self, value: GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationArgs): # -> None:
        ...
...
class GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationArgs:
    def __init__(__self__, *, cloudwatch_logs: Optional[GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationCloudwatchLogsArgs] = ..., firehose: Optional[GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationFirehoseArgs] = ..., s3: Optional[GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationS3Args] = ...) -> None:
    ...
    def cloudwatch_logs(self, value: Optional[GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationCloudwatchLogsArgs]): # -> None:
        ...
    ...
    @firehose.setter
    def firehose(self, value: Optional[GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationFirehoseArgs]): # -> None:
        ...
    ...
    @s3.setter
    def s3(self, value: Optional[GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationS3Args]): # -> None:
        ...
...
class GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationCloudwatchLogsArgs:
    ...
    @log_group.setter
    def log_group(self, value: _builtins.str): # -> None:
        ...
...
class GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationFirehoseArgs:
    ...
    def delivery_stream(self, value: _builtins.str): # -> None:
        ...
...
class GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationS3Args:
    ...
    @bucket.setter
    def bucket(self, value: _builtins.str): # -> None:
        ...
...
class GetLogDataProtectionPolicyDocumentStatementOperationDeidentifyArgs:
    def __init__(__self__, *, mask_config: GetLogDataProtectionPolicyDocumentStatementOperationDeidentifyMaskConfigArgs) -> None:
    ...
    @mask_config.setter
    def mask_config(self, value: GetLogDataProtectionPolicyDocumentStatementOperationDeidentifyMaskConfigArgs): # -> None:
        ...
