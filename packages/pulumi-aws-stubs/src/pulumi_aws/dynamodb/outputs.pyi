...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GlobalSecondaryIndexKeySchema', 'GlobalSecondaryIndexOnDemandThroughput', 'GlobalSecondaryIndexProjection', 'GlobalSecondaryIndexProvisionedThroughput', 'GlobalSecondaryIndexTimeouts', 'GlobalSecondaryIndexWarmThroughput', 'GlobalTableReplica', 'TableAttribute', 'TableExportIncrementalExportSpecification', 'TableGlobalSecondaryIndex', 'TableGlobalSecondaryIndexKeySchema', 'TableGlobalSecondaryIndexOnDemandThroughput', 'TableGlobalSecondaryIndexWarmThroughput', 'TableGlobalTableWitness', 'TableImportTable', 'TableImportTableInputFormatOptions', 'TableImportTableInputFormatOptionsCsv', 'TableImportTableS3BucketSource', 'TableLocalSecondaryIndex', 'TableOnDemandThroughput', 'TablePointInTimeRecovery', 'TableReplica', 'TableServerSideEncryption', 'TableTtl', 'TableWarmThroughput', 'GetTableAttributeResult', 'GetTableGlobalSecondaryIndexResult', 'GetTableGlobalSecondaryIndexKeySchemaResult', ..., 'GetTableGlobalSecondaryIndexWarmThroughputResult', 'GetTableLocalSecondaryIndexResult', 'GetTableOnDemandThroughputResult', 'GetTablePointInTimeRecoveryResult', 'GetTableReplicaResult', 'GetTableServerSideEncryptionResult', 'GetTableTtlResult', 'GetTableWarmThroughputResult']
@pulumi.output_type
class GlobalSecondaryIndexKeySchema(dict):
    ...
    def __init__(__self__, *, attribute_name: _builtins.str, attribute_type: _builtins.str, key_type: _builtins.str) -> None:
...
class GlobalSecondaryIndexOnDemandThroughput(dict):
    ...
    def __init__(__self__, *, max_read_request_units: Optional[_builtins.int] = ..., max_write_request_units: Optional[_builtins.int] = ...) -> None:
...
class GlobalSecondaryIndexProjection(dict):
    ...
    def __init__(__self__, *, projection_type: _builtins.str, non_key_attributes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GlobalSecondaryIndexProvisionedThroughput(dict):
    ...
    def __init__(__self__, *, read_capacity_units: Optional[_builtins.int] = ..., write_capacity_units: Optional[_builtins.int] = ...) -> None:
...
class GlobalSecondaryIndexWarmThroughput(dict):
    ...
    def __init__(__self__, *, read_units_per_second: _builtins.int, write_units_per_second: _builtins.int) -> None:
...
class TableExportIncrementalExportSpecification(dict):
    ...
    def __init__(__self__, *, export_from_time: Optional[_builtins.str] = ..., export_to_time: Optional[_builtins.str] = ..., export_view_type: Optional[_builtins.str] = ...) -> None:
        ...
...
class TableGlobalSecondaryIndex(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, projection_type: _builtins.str, hash_key: Optional[_builtins.str] = ..., key_schemas: Optional[Sequence[outputs.TableGlobalSecondaryIndexKeySchema]] = ..., non_key_attributes: Optional[Sequence[_builtins.str]] = ..., on_demand_throughput: Optional[outputs.TableGlobalSecondaryIndexOnDemandThroughput] = ..., range_key: Optional[_builtins.str] = ..., read_capacity: Optional[_builtins.int] = ..., warm_throughput: Optional[outputs.TableGlobalSecondaryIndexWarmThroughput] = ..., write_capacity: Optional[_builtins.int] = ...) -> None:
...
class TableGlobalSecondaryIndexKeySchema(dict):
    ...
    def __init__(__self__, *, attribute_name: _builtins.str, key_type: _builtins.str) -> None:
...
class TableGlobalSecondaryIndexWarmThroughput(dict):
    ...
    def __init__(__self__, *, read_units_per_second: Optional[_builtins.int] = ..., write_units_per_second: Optional[_builtins.int] = ...) -> None:
...
class TableImportTable(dict):
    ...
    def __init__(__self__, *, input_format: _builtins.str, s3_bucket_source: outputs.TableImportTableS3BucketSource, input_compression_type: Optional[_builtins.str] = ..., input_format_options: Optional[outputs.TableImportTableInputFormatOptions] = ...) -> None:
...
class TableImportTableInputFormatOptions(dict):
    def __init__(__self__, *, csv: Optional[outputs.TableImportTableInputFormatOptionsCsv] = ...) -> None:
...
class TableImportTableInputFormatOptionsCsv(dict):
    ...
    def __init__(__self__, *, delimiter: Optional[_builtins.str] = ..., header_lists: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class TableImportTableS3BucketSource(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, bucket_owner: Optional[_builtins.str] = ..., key_prefix: Optional[_builtins.str] = ...) -> None:
...
class TableLocalSecondaryIndex(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, projection_type: _builtins.str, range_key: _builtins.str, non_key_attributes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class TablePointInTimeRecovery(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, recovery_period_in_days: Optional[_builtins.int] = ...) -> None:
...
class TableReplica(dict):
    ...
    def __init__(__self__, *, region_name: _builtins.str, arn: Optional[_builtins.str] = ..., consistency_mode: Optional[_builtins.str] = ..., deletion_protection_enabled: Optional[_builtins.bool] = ..., kms_key_arn: Optional[_builtins.str] = ..., point_in_time_recovery: Optional[_builtins.bool] = ..., propagate_tags: Optional[_builtins.bool] = ..., stream_arn: Optional[_builtins.str] = ..., stream_label: Optional[_builtins.str] = ...) -> None:
...
class TableServerSideEncryption(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, kms_key_arn: Optional[_builtins.str] = ...) -> None:
...
class TableTtl(dict):
    ...
    def __init__(__self__, *, attribute_name: Optional[_builtins.str] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class GetTableGlobalSecondaryIndexResult(dict):
    def __init__(__self__, *, hash_key: _builtins.str, key_schemas: Sequence[outputs.GetTableGlobalSecondaryIndexKeySchemaResult], name: _builtins.str, non_key_attributes: Sequence[_builtins.str], on_demand_throughputs: Sequence[outputs.GetTableGlobalSecondaryIndexOnDemandThroughputResult], projection_type: _builtins.str, range_key: _builtins.str, read_capacity: _builtins.int, warm_throughputs: Sequence[outputs.GetTableGlobalSecondaryIndexWarmThroughputResult], write_capacity: _builtins.int) -> None:
...
class GetTableGlobalSecondaryIndexOnDemandThroughputResult(dict):
    def __init__(__self__, *, max_read_request_units: _builtins.int, max_write_request_units: _builtins.int) -> None:
        ...
...
class GetTableLocalSecondaryIndexResult(dict):
    def __init__(__self__, *, name: _builtins.str, non_key_attributes: Sequence[_builtins.str], projection_type: _builtins.str, range_key: _builtins.str) -> None:
...
class GetTablePointInTimeRecoveryResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, recovery_period_in_days: _builtins.int) -> None:
        ...
...
class GetTableReplicaResult(dict):
    def __init__(__self__, *, kms_key_arn: _builtins.str, region_name: _builtins.str) -> None:
        ...
...
class GetTableTtlResult(dict):
    def __init__(__self__, *, attribute_name: _builtins.str, enabled: _builtins.bool) -> None:
        ...
