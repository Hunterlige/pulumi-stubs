...
class GlobalTableArgs:
    ...
    def replicas(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input[GlobalTableReplicaArgs]]]: ...
    @replicas.setter
    def replicas(
        self, value: pulumi.Input[Sequence[pulumi.Input[GlobalTableReplicaArgs]]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _GlobalTableState:
    ...
    def replicas(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[GlobalTableReplicaArgs]]]]: ...
    @replicas.setter
    def replicas(
        self,
        value: Optional[pulumi.Input[Sequence[pulumi.Input[GlobalTableReplicaArgs]]]],
    ): ...
    ...
    def __init__(
        ...
        replicas: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[GlobalTableReplicaArgs, GlobalTableReplicaArgsDict]
                    ]
                ]
            ]
        ] = ...,
