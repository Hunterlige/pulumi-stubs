...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EndpointCidrOptions', 'EndpointCidrOptionsPortRange', 'EndpointLoadBalancerOptions', 'EndpointLoadBalancerOptionsPortRange', 'EndpointNetworkInterfaceOptions', 'EndpointNetworkInterfaceOptionsPortRange', 'EndpointRdsOptions', 'EndpointSseSpecification', 'GroupSseConfiguration', 'InstanceLoggingConfigurationAccessLogs', ..., ..., 'InstanceLoggingConfigurationAccessLogsS3', 'InstanceVerifiedAccessTrustProvider', 'TrustProviderDeviceOptions', 'TrustProviderNativeApplicationOidcOptions', 'TrustProviderOidcOptions', 'TrustProviderSseSpecification']
@pulumi.output_type
class EndpointCidrOptions(dict):
    ...
    def __init__(__self__, *, cidr: _builtins.str, port_ranges: Sequence[outputs.EndpointCidrOptionsPortRange], protocol: Optional[_builtins.str] = ..., subnet_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
        ...
...
class EndpointLoadBalancerOptions(dict):
    ...
    def __init__(__self__, *, load_balancer_arn: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., port_ranges: Optional[Sequence[outputs.EndpointLoadBalancerOptionsPortRange]] = ..., protocol: Optional[_builtins.str] = ..., subnet_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
        ...
...
class EndpointNetworkInterfaceOptions(dict):
    ...
    def __init__(__self__, *, network_interface_id: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., port_ranges: Optional[Sequence[outputs.EndpointNetworkInterfaceOptionsPortRange]] = ..., protocol: Optional[_builtins.str] = ...) -> None:
        ...
...
class EndpointRdsOptions(dict):
    ...
    def __init__(__self__, *, port: Optional[_builtins.int] = ..., protocol: Optional[_builtins.str] = ..., rds_db_cluster_arn: Optional[_builtins.str] = ..., rds_db_instance_arn: Optional[_builtins.str] = ..., rds_db_proxy_arn: Optional[_builtins.str] = ..., rds_endpoint: Optional[_builtins.str] = ..., subnet_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
        ...
...
class EndpointSseSpecification(dict):
    ...
    def __init__(__self__, *, customer_managed_key_enabled: Optional[_builtins.bool] = ..., kms_key_arn: Optional[_builtins.str] = ...) -> None:
        ...
...
class InstanceLoggingConfigurationAccessLogs(dict):
    ...
    def __init__(__self__, *, cloudwatch_logs: Optional[outputs.InstanceLoggingConfigurationAccessLogsCloudwatchLogs] = ..., include_trust_context: Optional[_builtins.bool] = ..., kinesis_data_firehose: Optional[outputs.InstanceLoggingConfigurationAccessLogsKinesisDataFirehose] = ..., log_version: Optional[_builtins.str] = ..., s3: Optional[outputs.InstanceLoggingConfigurationAccessLogsS3] = ...) -> None:
...
class InstanceLoggingConfigurationAccessLogsS3(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, bucket_name: Optional[_builtins.str] = ..., bucket_owner: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class InstanceVerifiedAccessTrustProvider(dict):
    ...
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., device_trust_provider_type: Optional[_builtins.str] = ..., trust_provider_type: Optional[_builtins.str] = ..., user_trust_provider_type: Optional[_builtins.str] = ..., verified_access_trust_provider_id: Optional[_builtins.str] = ...) -> None:
...
class TrustProviderNativeApplicationOidcOptions(dict):
    ...
    def __init__(__self__, *, client_secret: _builtins.str, authorization_endpoint: Optional[_builtins.str] = ..., client_id: Optional[_builtins.str] = ..., issuer: Optional[_builtins.str] = ..., public_signing_key_endpoint: Optional[_builtins.str] = ..., scope: Optional[_builtins.str] = ..., token_endpoint: Optional[_builtins.str] = ..., user_info_endpoint: Optional[_builtins.str] = ...) -> None:
        ...
...
class TrustProviderOidcOptions(dict):
    ...
    def __init__(__self__, *, client_secret: _builtins.str, authorization_endpoint: Optional[_builtins.str] = ..., client_id: Optional[_builtins.str] = ..., issuer: Optional[_builtins.str] = ..., scope: Optional[_builtins.str] = ..., token_endpoint: Optional[_builtins.str] = ..., user_info_endpoint: Optional[_builtins.str] = ...) -> None:
        ...
