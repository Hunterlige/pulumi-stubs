...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DirectoryConfigCertificateBasedAuthPropertiesArgs', ..., 'DirectoryConfigServiceAccountCredentialsArgs', 'DirectoryConfigServiceAccountCredentialsArgsDict', 'FleetComputeCapacityArgs', 'FleetComputeCapacityArgsDict', 'FleetDomainJoinInfoArgs', 'FleetDomainJoinInfoArgsDict', 'FleetVpcConfigArgs', 'FleetVpcConfigArgsDict', 'ImageBuilderAccessEndpointArgs', 'ImageBuilderAccessEndpointArgsDict', 'ImageBuilderDomainJoinInfoArgs', 'ImageBuilderDomainJoinInfoArgsDict', 'ImageBuilderVpcConfigArgs', 'ImageBuilderVpcConfigArgsDict', 'StackAccessEndpointArgs', 'StackAccessEndpointArgsDict', 'StackApplicationSettingsArgs', 'StackApplicationSettingsArgsDict', 'StackStorageConnectorArgs', 'StackStorageConnectorArgsDict', 'StackStreamingExperienceSettingsArgs', 'StackStreamingExperienceSettingsArgsDict', 'StackUserSettingArgs', 'StackUserSettingArgsDict']
...
class DirectoryConfigServiceAccountCredentialsArgs:
    def __init__(__self__, *, account_name: pulumi.Input[_builtins.str], account_password: pulumi.Input[_builtins.str]) -> None:
...
class FleetComputeCapacityArgs:
    def __init__(__self__, *, available: Optional[pulumi.Input[_builtins.int]] = ..., desired_instances: Optional[pulumi.Input[_builtins.int]] = ..., desired_sessions: Optional[pulumi.Input[_builtins.int]] = ..., in_use: Optional[pulumi.Input[_builtins.int]] = ..., running: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @available.setter
    def available(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def desired_instances(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def desired_sessions(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @in_use.setter
    def in_use(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @running.setter
    def running(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class FleetDomainJoinInfoArgs:
    def __init__(__self__, *, directory_name: Optional[pulumi.Input[_builtins.str]] = ..., organizational_unit_distinguished_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ImageBuilderAccessEndpointArgs:
    def __init__(__self__, *, endpoint_type: pulumi.Input[_builtins.str], vpce_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @vpce_id.setter
    def vpce_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StackApplicationSettingsArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], settings_group: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def settings_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StackStorageConnectorArgs:
    def __init__(__self__, *, connector_type: pulumi.Input[_builtins.str], domains: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., resource_identifier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StackStreamingExperienceSettingsArgs:
    def __init__(__self__, *, preferred_protocol: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def preferred_protocol(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StackUserSettingArgs:
    def __init__(__self__, *, action: pulumi.Input[_builtins.str], permission: pulumi.Input[_builtins.str]) -> None:
