...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DirectoryConfigCertificateBasedAuthProperties', 'DirectoryConfigServiceAccountCredentials', 'FleetComputeCapacity', 'FleetDomainJoinInfo', 'FleetVpcConfig', 'ImageBuilderAccessEndpoint', 'ImageBuilderDomainJoinInfo', 'ImageBuilderVpcConfig', 'StackAccessEndpoint', 'StackApplicationSettings', 'StackStorageConnector', 'StackStreamingExperienceSettings', 'StackUserSetting', 'GetImageApplicationResult', 'GetImageApplicationIconS3LocationResult', 'GetImageImagePermissionResult', 'GetImageStateChangeReasonResult']
@pulumi.output_type
...
class DirectoryConfigServiceAccountCredentials(dict):
    ...
    def __init__(__self__, *, account_name: _builtins.str, account_password: _builtins.str) -> None:
...
class FleetComputeCapacity(dict):
    ...
    def __init__(__self__, *, available: Optional[_builtins.int] = ..., desired_instances: Optional[_builtins.int] = ..., desired_sessions: Optional[_builtins.int] = ..., in_use: Optional[_builtins.int] = ..., running: Optional[_builtins.int] = ...) -> None:
...
class FleetDomainJoinInfo(dict):
    ...
    def __init__(__self__, *, directory_name: Optional[_builtins.str] = ..., organizational_unit_distinguished_name: Optional[_builtins.str] = ...) -> None:
...
class ImageBuilderAccessEndpoint(dict):
    ...
    def __init__(__self__, *, endpoint_type: _builtins.str, vpce_id: Optional[_builtins.str] = ...) -> None:
...
class StackApplicationSettings(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, settings_group: Optional[_builtins.str] = ...) -> None:
...
class StackStorageConnector(dict):
    ...
    def __init__(__self__, *, connector_type: _builtins.str, domains: Optional[Sequence[_builtins.str]] = ..., resource_identifier: Optional[_builtins.str] = ...) -> None:
...
class StackStreamingExperienceSettings(dict):
    ...
    def __init__(__self__, *, preferred_protocol: Optional[_builtins.str] = ...) -> None:
...
class StackUserSetting(dict):
    def __init__(__self__, *, action: _builtins.str, permission: _builtins.str) -> None:
...
class GetImageApplicationResult(dict):
    def __init__(__self__, *, app_block_arn: _builtins.str, arn: _builtins.str, created_time: _builtins.str, description: _builtins.str, display_name: _builtins.str, enabled: _builtins.bool, icon_s3_locations: Sequence[outputs.GetImageApplicationIconS3LocationResult], icon_url: _builtins.str, instance_families: Sequence[_builtins.str], launch_parameters: _builtins.str, launch_path: _builtins.str, metadata: Mapping[str, _builtins.str], name: _builtins.str, platforms: Sequence[_builtins.str], working_directory: _builtins.str) -> None:
...
class GetImageImagePermissionResult(dict):
    def __init__(__self__, *, allow_fleet: _builtins.bool, allow_image_builder: _builtins.bool) -> None:
