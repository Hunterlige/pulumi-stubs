...
class DbClusterArgs:
    def __init__(
        ...
        *,
        ...
        failover_mode: Optional[pulumi.Input[_builtins.str]] = ...,
        log_delivery_configuration: Optional[
            pulumi.Input[DbClusterLogDeliveryConfigurationArgs]
        ] = ...,
        ...
        timeouts: Optional[pulumi.Input[DbClusterTimeoutsArgs]] = ...,
    ...
    def log_delivery_configuration(
        self,
    ) -> Optional[pulumi.Input[DbClusterLogDeliveryConfigurationArgs]]: ...
    @log_delivery_configuration.setter
    def log_delivery_configuration(
        self, value: Optional[pulumi.Input[DbClusterLogDeliveryConfigurationArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class DbCluster(pulumi.CustomResource):
    ...
    def __init__(
        ...
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        timeouts: Optional[
            pulumi.Input[Union[DbClusterTimeoutsArgs, DbClusterTimeoutsArgsDict]]
        ] = ...,
        username: Optional[pulumi.Input[_builtins.str]] = ...,
        vpc_security_group_ids: Optional[
            pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
    ...
    def log_delivery_configuration(
        self,
    ) -> pulumi.Output[Optional[outputs.DbClusterLogDeliveryConfiguration]]: ...
    @_builtins.property
    @pulumi.getter
