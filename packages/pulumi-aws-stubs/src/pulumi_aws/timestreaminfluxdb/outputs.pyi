...
class DbClusterLogDeliveryConfiguration(dict):
    ...
    def __init__(
        ...
        *,
        s3_configuration: Optional[
            outputs.DbClusterLogDeliveryConfigurationS3Configuration
        ] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def s3_configuration(
        self,
    ) -> Optional[outputs.DbClusterLogDeliveryConfigurationS3Configuration]: ...
...
class DbClusterLogDeliveryConfigurationS3Configuration(dict):
    ...
    def get(self, key: str, default=...) -> Any: ...
    def __init__(
        __self__, *, bucket_name: _builtins.str, enabled: _builtins.bool
    ) -> None: ...
    @_builtins.property
...
class DbInstanceLogDeliveryConfiguration(dict):
    ...
    def __init__(
        ...
        *,
        s3_configuration: Optional[
            outputs.DbInstanceLogDeliveryConfigurationS3Configuration
        ] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter(name="s3Configuration")
    def s3_configuration(
        self,
    ) -> Optional[outputs.DbInstanceLogDeliveryConfigurationS3Configuration]: ...
