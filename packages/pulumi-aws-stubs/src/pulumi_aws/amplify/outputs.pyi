...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppAutoBranchCreationConfig', 'AppCacheConfig', 'AppCustomRule', 'AppJobConfig', 'AppProductionBranch', 'DomainAssociationCertificateSettings', 'DomainAssociationSubDomain']
@pulumi.output_type
class AppAutoBranchCreationConfig(dict):
    ...
    def __init__(__self__, *, basic_auth_credentials: Optional[_builtins.str] = ..., build_spec: Optional[_builtins.str] = ..., enable_auto_build: Optional[_builtins.bool] = ..., enable_basic_auth: Optional[_builtins.bool] = ..., enable_performance_mode: Optional[_builtins.bool] = ..., enable_pull_request_preview: Optional[_builtins.bool] = ..., environment_variables: Optional[Mapping[str, _builtins.str]] = ..., framework: Optional[_builtins.str] = ..., pull_request_environment_name: Optional[_builtins.str] = ..., stage: Optional[_builtins.str] = ...) -> None:
...
class AppCustomRule(dict):
    def __init__(__self__, *, source: _builtins.str, target: _builtins.str, condition: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class AppJobConfig(dict):
    ...
    def __init__(__self__, *, build_compute_type: Optional[_builtins.str] = ...) -> None:
...
class AppProductionBranch(dict):
    ...
    def __init__(__self__, *, branch_name: Optional[_builtins.str] = ..., last_deploy_time: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., thumbnail_url: Optional[_builtins.str] = ...) -> None:
...
class DomainAssociationCertificateSettings(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, certificate_verification_dns_record: Optional[_builtins.str] = ..., custom_certificate_arn: Optional[_builtins.str] = ...) -> None:
...
class DomainAssociationSubDomain(dict):
    ...
    def __init__(__self__, *, branch_name: _builtins.str, prefix: _builtins.str, dns_record: Optional[_builtins.str] = ..., verified: Optional[_builtins.bool] = ...) -> None:
