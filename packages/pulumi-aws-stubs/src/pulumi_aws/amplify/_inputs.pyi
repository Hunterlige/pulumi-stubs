...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppAutoBranchCreationConfigArgs', 'AppAutoBranchCreationConfigArgsDict', 'AppCacheConfigArgs', 'AppCacheConfigArgsDict', 'AppCustomRuleArgs', 'AppCustomRuleArgsDict', 'AppJobConfigArgs', 'AppJobConfigArgsDict', 'AppProductionBranchArgs', 'AppProductionBranchArgsDict', 'DomainAssociationCertificateSettingsArgs', 'DomainAssociationCertificateSettingsArgsDict', 'DomainAssociationSubDomainArgs', 'DomainAssociationSubDomainArgsDict']
...
class AppAutoBranchCreationConfigArgs:
    def __init__(__self__, *, basic_auth_credentials: Optional[pulumi.Input[_builtins.str]] = ..., build_spec: Optional[pulumi.Input[_builtins.str]] = ..., enable_auto_build: Optional[pulumi.Input[_builtins.bool]] = ..., enable_basic_auth: Optional[pulumi.Input[_builtins.bool]] = ..., enable_performance_mode: Optional[pulumi.Input[_builtins.bool]] = ..., enable_pull_request_preview: Optional[pulumi.Input[_builtins.bool]] = ..., environment_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., framework: Optional[pulumi.Input[_builtins.str]] = ..., pull_request_environment_name: Optional[pulumi.Input[_builtins.str]] = ..., stage: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppCustomRuleArgs:
    def __init__(__self__, *, source: pulumi.Input[_builtins.str], target: pulumi.Input[_builtins.str], condition: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppJobConfigArgs:
    def __init__(__self__, *, build_compute_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def build_compute_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppProductionBranchArgs:
    def __init__(__self__, *, branch_name: Optional[pulumi.Input[_builtins.str]] = ..., last_deploy_time: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., thumbnail_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def last_deploy_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def thumbnail_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DomainAssociationCertificateSettingsArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], certificate_verification_dns_record: Optional[pulumi.Input[_builtins.str]] = ..., custom_certificate_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def custom_certificate_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DomainAssociationSubDomainArgs:
    def __init__(__self__, *, branch_name: pulumi.Input[_builtins.str], prefix: pulumi.Input[_builtins.str], dns_record: Optional[pulumi.Input[_builtins.str]] = ..., verified: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @dns_record.setter
    def dns_record(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @verified.setter
    def verified(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
