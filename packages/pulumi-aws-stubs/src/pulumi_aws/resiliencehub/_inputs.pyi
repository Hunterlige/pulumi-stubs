...
class ResiliencyPolicyPolicyArgs:
    def __init__(__self__, *, az: Optional[pulumi.Input[ResiliencyPolicyPolicyAzArgs]] = ..., hardware: Optional[pulumi.Input[ResiliencyPolicyPolicyHardwareArgs]] = ..., region: Optional[pulumi.Input[ResiliencyPolicyPolicyRegionArgs]] = ..., software: Optional[pulumi.Input[ResiliencyPolicyPolicySoftwareArgs]] = ...) -> None:
    ...
    @az.setter
    def az(self, value: Optional[pulumi.Input[ResiliencyPolicyPolicyAzArgs]]): # -> None:
        ...
    ...
    @hardware.setter
    def hardware(self, value: Optional[pulumi.Input[ResiliencyPolicyPolicyHardwareArgs]]): # -> None:
        ...
    ...
    @region.setter
    def region(self, value: Optional[pulumi.Input[ResiliencyPolicyPolicyRegionArgs]]): # -> None:
        ...
    ...
    @software.setter
    def software(self, value: Optional[pulumi.Input[ResiliencyPolicyPolicySoftwareArgs]]): # -> None:
        ...
...
class ResiliencyPolicyPolicyAzArgs:
    def __init__(__self__, *, rpo: pulumi.Input[_builtins.str], rto: pulumi.Input[_builtins.str]) -> None:
    ...
    @rpo.setter
    def rpo(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @rto.setter
    def rto(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ResiliencyPolicyPolicyRegionArgs:
    def __init__(__self__, *, rpo: Optional[pulumi.Input[_builtins.str]] = ..., rto: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @rto.setter
    def rto(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
