...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ComputeEnvironmentComputeResources', 'ComputeEnvironmentComputeResourcesEc2Configuration', 'ComputeEnvironmentComputeResourcesLaunchTemplate', 'ComputeEnvironmentEksConfiguration', 'ComputeEnvironmentUpdatePolicy', 'JobDefinitionEksProperties', 'JobDefinitionEksPropertiesPodProperties', 'JobDefinitionEksPropertiesPodPropertiesContainer', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'JobDefinitionEksPropertiesPodPropertiesMetadata', 'JobDefinitionEksPropertiesPodPropertiesVolume', ..., ..., ..., 'JobDefinitionRetryStrategy', 'JobDefinitionRetryStrategyEvaluateOnExit', 'JobDefinitionTimeout', 'JobQueueComputeEnvironmentOrder', 'JobQueueJobStateTimeLimitAction', 'JobQueueTimeouts', 'SchedulingPolicyFairSharePolicy', 'SchedulingPolicyFairSharePolicyShareDistribution', 'GetComputeEnvironmentUpdatePolicyResult', 'GetJobDefinitionEksPropertyResult', 'GetJobDefinitionEksPropertyPodPropertyResult', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetJobDefinitionEksPropertyPodPropertyVolumeResult', ..., ..., ..., 'GetJobDefinitionNodePropertyResult', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetJobDefinitionRetryStrategyResult', 'GetJobDefinitionRetryStrategyEvaluateOnExitResult', 'GetJobDefinitionTimeoutResult', 'GetJobQueueComputeEnvironmentOrderResult', 'GetJobQueueJobStateTimeLimitActionResult', 'GetSchedulingPolicyFairSharePolicyResult', ...]
@pulumi.output_type
class ComputeEnvironmentComputeResources(dict):
    ...
    def __init__(__self__, *, max_vcpus: _builtins.int, subnets: Sequence[_builtins.str], type: _builtins.str, allocation_strategy: Optional[_builtins.str] = ..., bid_percentage: Optional[_builtins.int] = ..., desired_vcpus: Optional[_builtins.int] = ..., ec2_configurations: Optional[Sequence[outputs.ComputeEnvironmentComputeResourcesEc2Configuration]] = ..., ec2_key_pair: Optional[_builtins.str] = ..., image_id: Optional[_builtins.str] = ..., instance_role: Optional[_builtins.str] = ..., instance_types: Optional[Sequence[_builtins.str]] = ..., launch_template: Optional[outputs.ComputeEnvironmentComputeResourcesLaunchTemplate] = ..., min_vcpus: Optional[_builtins.int] = ..., placement_group: Optional[_builtins.str] = ..., security_group_ids: Optional[Sequence[_builtins.str]] = ..., spot_iam_fleet_role: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ComputeEnvironmentComputeResourcesEc2Configuration(dict):
    ...
    def __init__(__self__, *, image_id_override: Optional[_builtins.str] = ..., image_kubernetes_version: Optional[_builtins.str] = ..., image_type: Optional[_builtins.str] = ...) -> None:
...
class ComputeEnvironmentEksConfiguration(dict):
    ...
    def __init__(__self__, *, eks_cluster_arn: _builtins.str, kubernetes_namespace: _builtins.str) -> None:
...
class ComputeEnvironmentUpdatePolicy(dict):
    ...
    def __init__(__self__, *, job_execution_timeout_minutes: Optional[_builtins.int] = ..., terminate_jobs_on_update: Optional[_builtins.bool] = ...) -> None:
...
class JobDefinitionEksProperties(dict):
    ...
    def __init__(__self__, *, pod_properties: outputs.JobDefinitionEksPropertiesPodProperties) -> None:
...
class JobDefinitionEksPropertiesPodProperties(dict):
    ...
    def __init__(__self__, *, containers: Sequence[outputs.JobDefinitionEksPropertiesPodPropertiesContainer], dns_policy: Optional[_builtins.str] = ..., host_network: Optional[_builtins.bool] = ..., image_pull_secrets: Optional[Sequence[outputs.JobDefinitionEksPropertiesPodPropertiesImagePullSecret]] = ..., init_containers: Optional[Sequence[outputs.JobDefinitionEksPropertiesPodPropertiesInitContainer]] = ..., metadata: Optional[outputs.JobDefinitionEksPropertiesPodPropertiesMetadata] = ..., service_account_name: Optional[_builtins.str] = ..., share_process_namespace: Optional[_builtins.bool] = ..., volumes: Optional[Sequence[outputs.JobDefinitionEksPropertiesPodPropertiesVolume]] = ...) -> None:
...
class JobDefinitionEksPropertiesPodPropertiesContainer(dict):
    ...
    def __init__(__self__, *, image: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., commands: Optional[Sequence[_builtins.str]] = ..., envs: Optional[Sequence[outputs.JobDefinitionEksPropertiesPodPropertiesContainerEnv]] = ..., image_pull_policy: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., resources: Optional[outputs.JobDefinitionEksPropertiesPodPropertiesContainerResources] = ..., security_context: Optional[outputs.JobDefinitionEksPropertiesPodPropertiesContainerSecurityContext] = ..., volume_mounts: Optional[Sequence[outputs.JobDefinitionEksPropertiesPodPropertiesContainerVolumeMount]] = ...) -> None:
...
class JobDefinitionEksPropertiesPodPropertiesContainerSecurityContext(dict):
    ...
    def __init__(__self__, *, allow_privilege_escalation: Optional[_builtins.bool] = ..., privileged: Optional[_builtins.bool] = ..., read_only_root_file_system: Optional[_builtins.bool] = ..., run_as_group: Optional[_builtins.int] = ..., run_as_non_root: Optional[_builtins.bool] = ..., run_as_user: Optional[_builtins.int] = ...) -> None:
...
class JobDefinitionEksPropertiesPodPropertiesInitContainer(dict):
    ...
    def __init__(__self__, *, image: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., commands: Optional[Sequence[_builtins.str]] = ..., envs: Optional[Sequence[outputs.JobDefinitionEksPropertiesPodPropertiesInitContainerEnv]] = ..., image_pull_policy: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., resources: Optional[outputs.JobDefinitionEksPropertiesPodPropertiesInitContainerResources] = ..., security_context: Optional[outputs.JobDefinitionEksPropertiesPodPropertiesInitContainerSecurityContext] = ..., volume_mounts: Optional[Sequence[outputs.JobDefinitionEksPropertiesPodPropertiesInitContainerVolumeMount]] = ...) -> None:
...
class JobDefinitionEksPropertiesPodPropertiesVolume(dict):
    ...
    def __init__(__self__, *, empty_dir: Optional[outputs.JobDefinitionEksPropertiesPodPropertiesVolumeEmptyDir] = ..., host_path: Optional[outputs.JobDefinitionEksPropertiesPodPropertiesVolumeHostPath] = ..., name: Optional[_builtins.str] = ..., secret: Optional[outputs.JobDefinitionEksPropertiesPodPropertiesVolumeSecret] = ...) -> None:
...
class JobDefinitionEksPropertiesPodPropertiesVolumeEmptyDir(dict):
    ...
    def __init__(__self__, *, size_limit: _builtins.str, medium: Optional[_builtins.str] = ...) -> None:
...
class JobDefinitionEksPropertiesPodPropertiesVolumeSecret(dict):
    ...
    def __init__(__self__, *, secret_name: _builtins.str, optional: Optional[_builtins.bool] = ...) -> None:
...
class JobDefinitionRetryStrategy(dict):
    ...
    def __init__(__self__, *, attempts: Optional[_builtins.int] = ..., evaluate_on_exits: Optional[Sequence[outputs.JobDefinitionRetryStrategyEvaluateOnExit]] = ...) -> None:
...
class JobDefinitionRetryStrategyEvaluateOnExit(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, on_exit_code: Optional[_builtins.str] = ..., on_reason: Optional[_builtins.str] = ..., on_status_reason: Optional[_builtins.str] = ...) -> None:
...
class JobDefinitionTimeout(dict):
    ...
    def __init__(__self__, *, attempt_duration_seconds: Optional[_builtins.int] = ...) -> None:
...
class JobQueueComputeEnvironmentOrder(dict):
    ...
    def __init__(__self__, *, compute_environment: _builtins.str, order: _builtins.int) -> None:
...
class JobQueueJobStateTimeLimitAction(dict):
    ...
    def __init__(__self__, *, action: _builtins.str, max_time_seconds: _builtins.int, reason: _builtins.str, state: _builtins.str) -> None:
...
class SchedulingPolicyFairSharePolicy(dict):
    ...
    def __init__(__self__, *, compute_reservation: Optional[_builtins.int] = ..., share_decay_seconds: Optional[_builtins.int] = ..., share_distributions: Optional[Sequence[outputs.SchedulingPolicyFairSharePolicyShareDistribution]] = ...) -> None:
...
class SchedulingPolicyFairSharePolicyShareDistribution(dict):
    ...
    def __init__(__self__, *, share_identifier: _builtins.str, weight_factor: Optional[_builtins.float] = ...) -> None:
...
class GetComputeEnvironmentUpdatePolicyResult(dict):
    def __init__(__self__, *, job_execution_timeout_minutes: _builtins.int, terminate_jobs_on_update: _builtins.bool) -> None:
        ...
...
class GetJobDefinitionEksPropertyResult(dict):
    def __init__(__self__, *, pod_properties: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyResult]) -> None:
...
class GetJobDefinitionEksPropertyPodPropertyResult(dict):
    def __init__(__self__, *, containers: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyContainerResult], dns_policy: _builtins.str, host_network: _builtins.bool, image_pull_secrets: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyImagePullSecretResult], init_containers: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyInitContainerResult], metadatas: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyMetadataResult], service_account_name: _builtins.str, share_process_namespace: _builtins.bool, volumes: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyVolumeResult]) -> None:
...
class GetJobDefinitionEksPropertyPodPropertyContainerResult(dict):
    def __init__(__self__, *, args: Sequence[_builtins.str], commands: Sequence[_builtins.str], envs: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyContainerEnvResult], image: _builtins.str, image_pull_policy: _builtins.str, name: _builtins.str, resources: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyContainerResourceResult], security_contexts: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyContainerSecurityContextResult], volume_mounts: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyContainerVolumeMountResult]) -> None:
...
class GetJobDefinitionEksPropertyPodPropertyContainerSecurityContextResult(dict):
    def __init__(__self__, *, allow_privilege_escalation: _builtins.bool, privileged: _builtins.bool, read_only_root_file_system: _builtins.bool, run_as_group: _builtins.int, run_as_non_root: _builtins.bool, run_as_user: _builtins.int) -> None:
...
class GetJobDefinitionEksPropertyPodPropertyContainerVolumeMountResult(dict):
    def __init__(__self__, *, mount_path: _builtins.str, name: _builtins.str, read_only: _builtins.bool) -> None:
...
class GetJobDefinitionEksPropertyPodPropertyInitContainerResult(dict):
    def __init__(__self__, *, args: Sequence[_builtins.str], commands: Sequence[_builtins.str], envs: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyInitContainerEnvResult], image: _builtins.str, image_pull_policy: _builtins.str, name: _builtins.str, resources: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyInitContainerResourceResult], security_contexts: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyInitContainerSecurityContextResult], volume_mounts: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyInitContainerVolumeMountResult]) -> None:
...
class GetJobDefinitionEksPropertyPodPropertyVolumeResult(dict):
    def __init__(__self__, *, empty_dirs: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyVolumeEmptyDirResult], host_paths: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyVolumeHostPathResult], name: _builtins.str, secrets: Sequence[outputs.GetJobDefinitionEksPropertyPodPropertyVolumeSecretResult]) -> None:
...
class GetJobDefinitionEksPropertyPodPropertyVolumeSecretResult(dict):
    def __init__(__self__, *, optional: _builtins.bool, secret_name: _builtins.str) -> None:
...
class GetJobDefinitionNodePropertyResult(dict):
    def __init__(__self__, *, main_node: _builtins.int, node_range_properties: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyResult], num_nodes: _builtins.int) -> None:
...
class GetJobDefinitionNodePropertyNodeRangePropertyResult(dict):
    def __init__(__self__, *, containers: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerResult], target_nodes: _builtins.str) -> None:
...
class GetJobDefinitionNodePropertyNodeRangePropertyContainerResult(dict):
    def __init__(__self__, *, commands: Sequence[_builtins.str], environments: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerEnvironmentResult], ephemeral_storages: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerEphemeralStorageResult], execution_role_arn: _builtins.str, fargate_platform_configurations: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerFargatePlatformConfigurationResult], image: _builtins.str, instance_type: _builtins.str, job_role_arn: _builtins.str, linux_parameters: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerLinuxParameterResult], log_configurations: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerLogConfigurationResult], mount_points: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerMountPointResult], network_configurations: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerNetworkConfigurationResult], privileged: _builtins.bool, readonly_root_filesystem: _builtins.bool, resource_requirements: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerResourceRequirementResult], runtime_platforms: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerRuntimePlatformResult], secrets: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerSecretResult], ulimits: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerUlimitResult], user: _builtins.str, volumes: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerVolumeResult]) -> None:
...
class GetJobDefinitionNodePropertyNodeRangePropertyContainerLinuxParameterResult(dict):
    def __init__(__self__, *, devices: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerLinuxParameterDeviceResult], init_process_enabled: _builtins.bool, max_swap: _builtins.int, shared_memory_size: _builtins.int, swappiness: _builtins.int, tmpfs: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerLinuxParameterTmpfResult]) -> None:
...
class GetJobDefinitionNodePropertyNodeRangePropertyContainerLinuxParameterDeviceResult(dict):
    def __init__(__self__, *, container_path: _builtins.str, host_path: _builtins.str, permissions: Sequence[_builtins.str]) -> None:
...
class GetJobDefinitionNodePropertyNodeRangePropertyContainerLinuxParameterTmpfResult(dict):
    def __init__(__self__, *, container_path: _builtins.str, mount_options: Sequence[_builtins.str], size: _builtins.int) -> None:
...
class GetJobDefinitionNodePropertyNodeRangePropertyContainerLogConfigurationResult(dict):
    def __init__(__self__, *, log_driver: _builtins.str, options: Mapping[str, _builtins.str], secret_options: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerLogConfigurationSecretOptionResult]) -> None:
...
class GetJobDefinitionNodePropertyNodeRangePropertyContainerMountPointResult(dict):
    def __init__(__self__, *, container_path: _builtins.str, read_only: _builtins.bool, source_volume: _builtins.str) -> None:
...
class GetJobDefinitionNodePropertyNodeRangePropertyContainerUlimitResult(dict):
    def __init__(__self__, *, hard_limit: _builtins.int, name: _builtins.str, soft_limit: _builtins.int) -> None:
...
class GetJobDefinitionNodePropertyNodeRangePropertyContainerVolumeResult(dict):
    def __init__(__self__, *, efs_volume_configurations: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerVolumeEfsVolumeConfigurationResult], hosts: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerVolumeHostResult], name: _builtins.str) -> None:
...
class GetJobDefinitionNodePropertyNodeRangePropertyContainerVolumeEfsVolumeConfigurationResult(dict):
    def __init__(__self__, *, authorization_configs: Sequence[outputs.GetJobDefinitionNodePropertyNodeRangePropertyContainerVolumeEfsVolumeConfigurationAuthorizationConfigResult], file_system_id: _builtins.str, root_directory: _builtins.str, transit_encryption: _builtins.str, transit_encryption_port: _builtins.int) -> None:
...
class GetJobDefinitionRetryStrategyResult(dict):
    def __init__(__self__, *, attempts: _builtins.int, evaluate_on_exits: Sequence[outputs.GetJobDefinitionRetryStrategyEvaluateOnExitResult]) -> None:
...
class GetJobDefinitionRetryStrategyEvaluateOnExitResult(dict):
    def __init__(__self__, *, action: _builtins.str, on_exit_code: _builtins.str, on_reason: _builtins.str, on_status_reason: _builtins.str) -> None:
...
class GetSchedulingPolicyFairSharePolicyResult(dict):
    def __init__(__self__, *, compute_reservation: _builtins.int, share_decay_seconds: _builtins.int, share_distributions: Sequence[outputs.GetSchedulingPolicyFairSharePolicyShareDistributionResult]) -> None:
...
class GetSchedulingPolicyFairSharePolicyShareDistributionResult(dict):
    def __init__(__self__, *, share_identifier: _builtins.str, weight_factor: _builtins.float) -> None:
