...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['MonitorLocalResourceArgs', 'MonitorLocalResourceArgsDict', 'MonitorRemoteResourceArgs', 'MonitorRemoteResourceArgsDict', 'MonitorTimeoutsArgs', 'MonitorTimeoutsArgsDict', 'ScopeTargetArgs', 'ScopeTargetArgsDict', 'ScopeTargetTargetIdentifierArgs', 'ScopeTargetTargetIdentifierArgsDict', 'ScopeTargetTargetIdentifierTargetIdArgs', 'ScopeTargetTargetIdentifierTargetIdArgsDict', 'ScopeTimeoutsArgs', 'ScopeTimeoutsArgsDict']
...
class ScopeTargetArgs:
    def __init__(__self__, *, region: pulumi.Input[_builtins.str], target_identifier: pulumi.Input[ScopeTargetTargetIdentifierArgs]) -> None:
    ...
    def target_identifier(self, value: pulumi.Input[ScopeTargetTargetIdentifierArgs]): # -> None:
        ...
...
class ScopeTargetTargetIdentifierArgs:
    def __init__(__self__, *, target_id: pulumi.Input[ScopeTargetTargetIdentifierTargetIdArgs], target_type: pulumi.Input[_builtins.str]) -> None:
    ...
    @target_id.setter
    def target_id(self, value: pulumi.Input[ScopeTargetTargetIdentifierTargetIdArgs]): # -> None:
        ...
