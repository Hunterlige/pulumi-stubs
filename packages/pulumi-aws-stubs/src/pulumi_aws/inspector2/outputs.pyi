...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FilterFilterCriteria', 'FilterFilterCriteriaAwsAccountId', 'FilterFilterCriteriaCodeRepositoryProjectName', 'FilterFilterCriteriaCodeRepositoryProviderType', 'FilterFilterCriteriaCodeVulnerabilityDetectorName', 'FilterFilterCriteriaCodeVulnerabilityDetectorTag', 'FilterFilterCriteriaCodeVulnerabilityFilePath', 'FilterFilterCriteriaComponentId', 'FilterFilterCriteriaComponentType', 'FilterFilterCriteriaEc2InstanceImageId', 'FilterFilterCriteriaEc2InstanceSubnetId', 'FilterFilterCriteriaEc2InstanceVpcId', 'FilterFilterCriteriaEcrImageArchitecture', 'FilterFilterCriteriaEcrImageHash', 'FilterFilterCriteriaEcrImageInUseCount', 'FilterFilterCriteriaEcrImageLastInUseAt', 'FilterFilterCriteriaEcrImagePushedAt', 'FilterFilterCriteriaEcrImageRegistry', 'FilterFilterCriteriaEcrImageRepositoryName', 'FilterFilterCriteriaEcrImageTag', 'FilterFilterCriteriaEpssScore', 'FilterFilterCriteriaExploitAvailable', 'FilterFilterCriteriaFindingArn', 'FilterFilterCriteriaFindingStatus', 'FilterFilterCriteriaFindingType', 'FilterFilterCriteriaFirstObservedAt', 'FilterFilterCriteriaFixAvailable', 'FilterFilterCriteriaInspectorScore', 'FilterFilterCriteriaLambdaFunctionExecutionRoleArn', 'FilterFilterCriteriaLambdaFunctionLastModifiedAt', 'FilterFilterCriteriaLambdaFunctionLayer', 'FilterFilterCriteriaLambdaFunctionName', 'FilterFilterCriteriaLambdaFunctionRuntime', 'FilterFilterCriteriaLastObservedAt', 'FilterFilterCriteriaNetworkProtocol', 'FilterFilterCriteriaPortRange', 'FilterFilterCriteriaRelatedVulnerability', 'FilterFilterCriteriaResourceId', 'FilterFilterCriteriaResourceTag', 'FilterFilterCriteriaResourceType', 'FilterFilterCriteriaSeverity', 'FilterFilterCriteriaTitle', 'FilterFilterCriteriaUpdatedAt', 'FilterFilterCriteriaVendorSeverity', 'FilterFilterCriteriaVulnerabilityId', 'FilterFilterCriteriaVulnerabilitySource', 'FilterFilterCriteriaVulnerablePackage', 'FilterFilterCriteriaVulnerablePackageArchitecture', 'FilterFilterCriteriaVulnerablePackageEpoch', 'FilterFilterCriteriaVulnerablePackageFilePath', 'FilterFilterCriteriaVulnerablePackageName', 'FilterFilterCriteriaVulnerablePackageRelease', ..., ..., 'FilterFilterCriteriaVulnerablePackageVersion', 'OrganizationConfigurationAutoEnable']
@pulumi.output_type
class FilterFilterCriteria(dict):
    ...
    def __init__(__self__, *, aws_account_ids: Optional[Sequence[outputs.FilterFilterCriteriaAwsAccountId]] = ..., code_repository_project_names: Optional[Sequence[outputs.FilterFilterCriteriaCodeRepositoryProjectName]] = ..., code_repository_provider_types: Optional[Sequence[outputs.FilterFilterCriteriaCodeRepositoryProviderType]] = ..., code_vulnerability_detector_names: Optional[Sequence[outputs.FilterFilterCriteriaCodeVulnerabilityDetectorName]] = ..., code_vulnerability_detector_tags: Optional[Sequence[outputs.FilterFilterCriteriaCodeVulnerabilityDetectorTag]] = ..., code_vulnerability_file_paths: Optional[Sequence[outputs.FilterFilterCriteriaCodeVulnerabilityFilePath]] = ..., component_ids: Optional[Sequence[outputs.FilterFilterCriteriaComponentId]] = ..., component_types: Optional[Sequence[outputs.FilterFilterCriteriaComponentType]] = ..., ec2_instance_image_ids: Optional[Sequence[outputs.FilterFilterCriteriaEc2InstanceImageId]] = ..., ec2_instance_subnet_ids: Optional[Sequence[outputs.FilterFilterCriteriaEc2InstanceSubnetId]] = ..., ec2_instance_vpc_ids: Optional[Sequence[outputs.FilterFilterCriteriaEc2InstanceVpcId]] = ..., ecr_image_architectures: Optional[Sequence[outputs.FilterFilterCriteriaEcrImageArchitecture]] = ..., ecr_image_hashes: Optional[Sequence[outputs.FilterFilterCriteriaEcrImageHash]] = ..., ecr_image_in_use_counts: Optional[Sequence[outputs.FilterFilterCriteriaEcrImageInUseCount]] = ..., ecr_image_last_in_use_ats: Optional[Sequence[outputs.FilterFilterCriteriaEcrImageLastInUseAt]] = ..., ecr_image_pushed_ats: Optional[Sequence[outputs.FilterFilterCriteriaEcrImagePushedAt]] = ..., ecr_image_registries: Optional[Sequence[outputs.FilterFilterCriteriaEcrImageRegistry]] = ..., ecr_image_repository_names: Optional[Sequence[outputs.FilterFilterCriteriaEcrImageRepositoryName]] = ..., ecr_image_tags: Optional[Sequence[outputs.FilterFilterCriteriaEcrImageTag]] = ..., epss_scores: Optional[Sequence[outputs.FilterFilterCriteriaEpssScore]] = ..., exploit_availables: Optional[Sequence[outputs.FilterFilterCriteriaExploitAvailable]] = ..., finding_arns: Optional[Sequence[outputs.FilterFilterCriteriaFindingArn]] = ..., finding_statuses: Optional[Sequence[outputs.FilterFilterCriteriaFindingStatus]] = ..., finding_types: Optional[Sequence[outputs.FilterFilterCriteriaFindingType]] = ..., first_observed_ats: Optional[Sequence[outputs.FilterFilterCriteriaFirstObservedAt]] = ..., fix_availables: Optional[Sequence[outputs.FilterFilterCriteriaFixAvailable]] = ..., inspector_scores: Optional[Sequence[outputs.FilterFilterCriteriaInspectorScore]] = ..., lambda_function_execution_role_arns: Optional[Sequence[outputs.FilterFilterCriteriaLambdaFunctionExecutionRoleArn]] = ..., lambda_function_last_modified_ats: Optional[Sequence[outputs.FilterFilterCriteriaLambdaFunctionLastModifiedAt]] = ..., lambda_function_layers: Optional[Sequence[outputs.FilterFilterCriteriaLambdaFunctionLayer]] = ..., lambda_function_names: Optional[Sequence[outputs.FilterFilterCriteriaLambdaFunctionName]] = ..., lambda_function_runtimes: Optional[Sequence[outputs.FilterFilterCriteriaLambdaFunctionRuntime]] = ..., last_observed_ats: Optional[Sequence[outputs.FilterFilterCriteriaLastObservedAt]] = ..., network_protocols: Optional[Sequence[outputs.FilterFilterCriteriaNetworkProtocol]] = ..., port_ranges: Optional[Sequence[outputs.FilterFilterCriteriaPortRange]] = ..., related_vulnerabilities: Optional[Sequence[outputs.FilterFilterCriteriaRelatedVulnerability]] = ..., resource_ids: Optional[Sequence[outputs.FilterFilterCriteriaResourceId]] = ..., resource_tags: Optional[Sequence[outputs.FilterFilterCriteriaResourceTag]] = ..., resource_types: Optional[Sequence[outputs.FilterFilterCriteriaResourceType]] = ..., severities: Optional[Sequence[outputs.FilterFilterCriteriaSeverity]] = ..., titles: Optional[Sequence[outputs.FilterFilterCriteriaTitle]] = ..., updated_ats: Optional[Sequence[outputs.FilterFilterCriteriaUpdatedAt]] = ..., vendor_severities: Optional[Sequence[outputs.FilterFilterCriteriaVendorSeverity]] = ..., vulnerability_ids: Optional[Sequence[outputs.FilterFilterCriteriaVulnerabilityId]] = ..., vulnerability_sources: Optional[Sequence[outputs.FilterFilterCriteriaVulnerabilitySource]] = ..., vulnerable_packages: Optional[Sequence[outputs.FilterFilterCriteriaVulnerablePackage]] = ...) -> None:
...
class FilterFilterCriteriaEcrImageInUseCount(dict):
    ...
    def __init__(__self__, *, lower_inclusive: _builtins.float, upper_inclusive: _builtins.float) -> None:
...
class FilterFilterCriteriaEcrImageLastInUseAt(dict):
    ...
    def __init__(__self__, *, end_inclusive: Optional[_builtins.str] = ..., start_inclusive: Optional[_builtins.str] = ...) -> None:
...
class FilterFilterCriteriaPortRange(dict):
    ...
    def __init__(__self__, *, begin_inclusive: _builtins.int, end_inclusive: _builtins.int) -> None:
...
class FilterFilterCriteriaVulnerablePackage(dict):
    ...
    def __init__(__self__, *, architecture: Optional[outputs.FilterFilterCriteriaVulnerablePackageArchitecture] = ..., epoches: Optional[Sequence[outputs.FilterFilterCriteriaVulnerablePackageEpoch]] = ..., file_path: Optional[outputs.FilterFilterCriteriaVulnerablePackageFilePath] = ..., name: Optional[outputs.FilterFilterCriteriaVulnerablePackageName] = ..., release: Optional[outputs.FilterFilterCriteriaVulnerablePackageRelease] = ..., source_lambda_layer_arn: Optional[outputs.FilterFilterCriteriaVulnerablePackageSourceLambdaLayerArn] = ..., source_layer_hash: Optional[outputs.FilterFilterCriteriaVulnerablePackageSourceLayerHash] = ..., version: Optional[outputs.FilterFilterCriteriaVulnerablePackageVersion] = ...) -> None:
...
class OrganizationConfigurationAutoEnable(dict):
    ...
    def __init__(__self__, *, ec2: _builtins.bool, ecr: _builtins.bool, code_repository: Optional[_builtins.bool] = ..., lambda_: Optional[_builtins.bool] = ..., lambda_code: Optional[_builtins.bool] = ...) -> None:
