...
class QueueReservationPlanSettingsArgs:
    def __init__(__self__, *, commitment: pulumi.Input[_builtins.str], renewal_type: pulumi.Input[_builtins.str], reserved_slots: pulumi.Input[_builtins.int]) -> None:
    ...
    @renewal_type.setter
    def renewal_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def reserved_slots(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
