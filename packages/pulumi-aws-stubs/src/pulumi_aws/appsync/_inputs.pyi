...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApiEventConfigArgs', 'ApiEventConfigArgsDict', 'ApiEventConfigAuthProviderArgs', 'ApiEventConfigAuthProviderArgsDict', 'ApiEventConfigAuthProviderCognitoConfigArgs', 'ApiEventConfigAuthProviderCognitoConfigArgsDict', ..., ..., 'ApiEventConfigAuthProviderOpenidConnectConfigArgs', ..., 'ApiEventConfigConnectionAuthModeArgs', 'ApiEventConfigConnectionAuthModeArgsDict', 'ApiEventConfigDefaultPublishAuthModeArgs', 'ApiEventConfigDefaultPublishAuthModeArgsDict', 'ApiEventConfigDefaultSubscribeAuthModeArgs', 'ApiEventConfigDefaultSubscribeAuthModeArgsDict', 'ApiEventConfigLogConfigArgs', 'ApiEventConfigLogConfigArgsDict', 'ChannelNamespaceHandlerConfigsArgs', 'ChannelNamespaceHandlerConfigsArgsDict', 'ChannelNamespaceHandlerConfigsOnPublishArgs', 'ChannelNamespaceHandlerConfigsOnPublishArgsDict', ..., ..., ..., ..., 'ChannelNamespaceHandlerConfigsOnSubscribeArgs', 'ChannelNamespaceHandlerConfigsOnSubscribeArgsDict', ..., ..., ..., ..., 'ChannelNamespacePublishAuthModeArgs', 'ChannelNamespacePublishAuthModeArgsDict', 'ChannelNamespaceSubscribeAuthModeArgs', 'ChannelNamespaceSubscribeAuthModeArgsDict', 'DataSourceDynamodbConfigArgs', 'DataSourceDynamodbConfigArgsDict', 'DataSourceDynamodbConfigDeltaSyncConfigArgs', 'DataSourceDynamodbConfigDeltaSyncConfigArgsDict', 'DataSourceElasticsearchConfigArgs', 'DataSourceElasticsearchConfigArgsDict', 'DataSourceEventBridgeConfigArgs', 'DataSourceEventBridgeConfigArgsDict', 'DataSourceHttpConfigArgs', 'DataSourceHttpConfigArgsDict', 'DataSourceHttpConfigAuthorizationConfigArgs', 'DataSourceHttpConfigAuthorizationConfigArgsDict', ..., ..., 'DataSourceLambdaConfigArgs', 'DataSourceLambdaConfigArgsDict', 'DataSourceOpensearchserviceConfigArgs', 'DataSourceOpensearchserviceConfigArgsDict', 'DataSourceRelationalDatabaseConfigArgs', 'DataSourceRelationalDatabaseConfigArgsDict', ..., ..., 'FunctionRuntimeArgs', 'FunctionRuntimeArgsDict', 'FunctionSyncConfigArgs', 'FunctionSyncConfigArgsDict', 'FunctionSyncConfigLambdaConflictHandlerConfigArgs', ..., 'GraphQLApiAdditionalAuthenticationProviderArgs', 'GraphQLApiAdditionalAuthenticationProviderArgsDict', ..., ..., ..., ..., ..., ..., 'GraphQLApiEnhancedMetricsConfigArgs', 'GraphQLApiEnhancedMetricsConfigArgsDict', 'GraphQLApiLambdaAuthorizerConfigArgs', 'GraphQLApiLambdaAuthorizerConfigArgsDict', 'GraphQLApiLogConfigArgs', 'GraphQLApiLogConfigArgsDict', 'GraphQLApiOpenidConnectConfigArgs', 'GraphQLApiOpenidConnectConfigArgsDict', 'GraphQLApiUserPoolConfigArgs', 'GraphQLApiUserPoolConfigArgsDict', 'ResolverCachingConfigArgs', 'ResolverCachingConfigArgsDict', 'ResolverPipelineConfigArgs', 'ResolverPipelineConfigArgsDict', 'ResolverRuntimeArgs', 'ResolverRuntimeArgsDict', 'ResolverSyncConfigArgs', 'ResolverSyncConfigArgsDict', 'ResolverSyncConfigLambdaConflictHandlerConfigArgs', ..., 'SourceApiAssociationSourceApiAssociationConfigArgs', ..., 'SourceApiAssociationTimeoutsArgs', 'SourceApiAssociationTimeoutsArgsDict']
...
class ApiEventConfigArgs:
    def __init__(__self__, *, auth_providers: pulumi.Input[Sequence[pulumi.Input[ApiEventConfigAuthProviderArgs]]], connection_auth_modes: pulumi.Input[Sequence[pulumi.Input[ApiEventConfigConnectionAuthModeArgs]]], default_publish_auth_modes: pulumi.Input[Sequence[pulumi.Input[ApiEventConfigDefaultPublishAuthModeArgs]]], default_subscribe_auth_modes: pulumi.Input[Sequence[pulumi.Input[ApiEventConfigDefaultSubscribeAuthModeArgs]]], log_config: Optional[pulumi.Input[ApiEventConfigLogConfigArgs]] = ...) -> None:
    ...
    def auth_providers(self, value: pulumi.Input[Sequence[pulumi.Input[ApiEventConfigAuthProviderArgs]]]): # -> None:
        ...
    ...
    def connection_auth_modes(self, value: pulumi.Input[Sequence[pulumi.Input[ApiEventConfigConnectionAuthModeArgs]]]): # -> None:
        ...
    ...
    def default_publish_auth_modes(self, value: pulumi.Input[Sequence[pulumi.Input[ApiEventConfigDefaultPublishAuthModeArgs]]]): # -> None:
        ...
    ...
    def default_subscribe_auth_modes(self, value: pulumi.Input[Sequence[pulumi.Input[ApiEventConfigDefaultSubscribeAuthModeArgs]]]): # -> None:
        ...
    ...
    @log_config.setter
    def log_config(self, value: Optional[pulumi.Input[ApiEventConfigLogConfigArgs]]): # -> None:
        ...
...
class ApiEventConfigAuthProviderArgs:
    def __init__(__self__, *, auth_type: pulumi.Input[_builtins.str], cognito_config: Optional[pulumi.Input[ApiEventConfigAuthProviderCognitoConfigArgs]] = ..., lambda_authorizer_config: Optional[pulumi.Input[ApiEventConfigAuthProviderLambdaAuthorizerConfigArgs]] = ..., openid_connect_config: Optional[pulumi.Input[ApiEventConfigAuthProviderOpenidConnectConfigArgs]] = ...) -> None:
    ...
    def cognito_config(self, value: Optional[pulumi.Input[ApiEventConfigAuthProviderCognitoConfigArgs]]): # -> None:
        ...
    ...
    def lambda_authorizer_config(self, value: Optional[pulumi.Input[ApiEventConfigAuthProviderLambdaAuthorizerConfigArgs]]): # -> None:
        ...
    ...
    def openid_connect_config(self, value: Optional[pulumi.Input[ApiEventConfigAuthProviderOpenidConnectConfigArgs]]): # -> None:
        ...
...
class ApiEventConfigAuthProviderCognitoConfigArgs:
    def __init__(__self__, *, aws_region: pulumi.Input[_builtins.str], user_pool_id: pulumi.Input[_builtins.str], app_id_client_regex: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def app_id_client_regex(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApiEventConfigAuthProviderLambdaAuthorizerConfigArgs:
    def __init__(__self__, *, authorizer_uri: pulumi.Input[_builtins.str], authorizer_result_ttl_in_seconds: Optional[pulumi.Input[_builtins.int]] = ..., identity_validation_expression: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authorizer_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def identity_validation_expression(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApiEventConfigAuthProviderOpenidConnectConfigArgs:
    def __init__(__self__, *, issuer: pulumi.Input[_builtins.str], auth_ttl: Optional[pulumi.Input[_builtins.int]] = ..., client_id: Optional[pulumi.Input[_builtins.str]] = ..., iat_ttl: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @auth_ttl.setter
    def auth_ttl(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @iat_ttl.setter
    def iat_ttl(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ApiEventConfigLogConfigArgs:
    def __init__(__self__, *, cloudwatch_logs_role_arn: pulumi.Input[_builtins.str], log_level: pulumi.Input[_builtins.str]) -> None:
    ...
    def cloudwatch_logs_role_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ChannelNamespaceHandlerConfigsArgs:
    def __init__(__self__, *, on_publish: Optional[pulumi.Input[ChannelNamespaceHandlerConfigsOnPublishArgs]] = ..., on_subscribe: Optional[pulumi.Input[ChannelNamespaceHandlerConfigsOnSubscribeArgs]] = ...) -> None:
    ...
    @on_publish.setter
    def on_publish(self, value: Optional[pulumi.Input[ChannelNamespaceHandlerConfigsOnPublishArgs]]): # -> None:
        ...
    ...
    @on_subscribe.setter
    def on_subscribe(self, value: Optional[pulumi.Input[ChannelNamespaceHandlerConfigsOnSubscribeArgs]]): # -> None:
        ...
...
class ChannelNamespaceHandlerConfigsOnPublishArgs:
    def __init__(__self__, *, behavior: pulumi.Input[_builtins.str], integration: pulumi.Input[ChannelNamespaceHandlerConfigsOnPublishIntegrationArgs]) -> None:
    ...
    @integration.setter
    def integration(self, value: pulumi.Input[ChannelNamespaceHandlerConfigsOnPublishIntegrationArgs]): # -> None:
        ...
...
class ChannelNamespaceHandlerConfigsOnPublishIntegrationArgs:
    def __init__(__self__, *, data_source_name: pulumi.Input[_builtins.str], lambda_config: Optional[pulumi.Input[ChannelNamespaceHandlerConfigsOnPublishIntegrationLambdaConfigArgs]] = ...) -> None:
    ...
    def data_source_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def lambda_config(self, value: Optional[pulumi.Input[ChannelNamespaceHandlerConfigsOnPublishIntegrationLambdaConfigArgs]]): # -> None:
        ...
...
class ChannelNamespaceHandlerConfigsOnPublishIntegrationLambdaConfigArgs:
    def __init__(__self__, *, invoke_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @invoke_type.setter
    def invoke_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ChannelNamespaceHandlerConfigsOnSubscribeArgs:
    def __init__(__self__, *, behavior: pulumi.Input[_builtins.str], integration: pulumi.Input[ChannelNamespaceHandlerConfigsOnSubscribeIntegrationArgs]) -> None:
    ...
    @integration.setter
    def integration(self, value: pulumi.Input[ChannelNamespaceHandlerConfigsOnSubscribeIntegrationArgs]): # -> None:
        ...
...
class ChannelNamespaceHandlerConfigsOnSubscribeIntegrationArgs:
    def __init__(__self__, *, data_source_name: pulumi.Input[_builtins.str], lambda_config: Optional[pulumi.Input[ChannelNamespaceHandlerConfigsOnSubscribeIntegrationLambdaConfigArgs]] = ...) -> None:
    ...
    @lambda_config.setter
    def lambda_config(self, value: Optional[pulumi.Input[ChannelNamespaceHandlerConfigsOnSubscribeIntegrationLambdaConfigArgs]]): # -> None:
        ...
...
class DataSourceDynamodbConfigArgs:
    def __init__(__self__, *, table_name: pulumi.Input[_builtins.str], delta_sync_config: Optional[pulumi.Input[DataSourceDynamodbConfigDeltaSyncConfigArgs]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., use_caller_credentials: Optional[pulumi.Input[_builtins.bool]] = ..., versioned: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def delta_sync_config(self, value: Optional[pulumi.Input[DataSourceDynamodbConfigDeltaSyncConfigArgs]]): # -> None:
        ...
    ...
    def use_caller_credentials(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @versioned.setter
    def versioned(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DataSourceDynamodbConfigDeltaSyncConfigArgs:
    def __init__(__self__, *, delta_sync_table_name: pulumi.Input[_builtins.str], base_table_ttl: Optional[pulumi.Input[_builtins.int]] = ..., delta_sync_table_ttl: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def delta_sync_table_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def base_table_ttl(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def delta_sync_table_ttl(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class DataSourceElasticsearchConfigArgs:
    def __init__(__self__, *, endpoint: pulumi.Input[_builtins.str], region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DataSourceHttpConfigArgs:
    def __init__(__self__, *, endpoint: pulumi.Input[_builtins.str], authorization_config: Optional[pulumi.Input[DataSourceHttpConfigAuthorizationConfigArgs]] = ...) -> None:
    ...
    def authorization_config(self, value: Optional[pulumi.Input[DataSourceHttpConfigAuthorizationConfigArgs]]): # -> None:
        ...
...
class DataSourceHttpConfigAuthorizationConfigArgs:
    def __init__(__self__, *, authorization_type: Optional[pulumi.Input[_builtins.str]] = ..., aws_iam_config: Optional[pulumi.Input[DataSourceHttpConfigAuthorizationConfigAwsIamConfigArgs]] = ...) -> None:
    ...
    def aws_iam_config(self, value: Optional[pulumi.Input[DataSourceHttpConfigAuthorizationConfigAwsIamConfigArgs]]): # -> None:
        ...
...
class DataSourceHttpConfigAuthorizationConfigAwsIamConfigArgs:
    def __init__(__self__, *, signing_region: Optional[pulumi.Input[_builtins.str]] = ..., signing_service_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def signing_region(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def signing_service_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataSourceRelationalDatabaseConfigArgs:
    def __init__(__self__, *, http_endpoint_config: Optional[pulumi.Input[DataSourceRelationalDatabaseConfigHttpEndpointConfigArgs]] = ..., source_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def http_endpoint_config(self, value: Optional[pulumi.Input[DataSourceRelationalDatabaseConfigHttpEndpointConfigArgs]]): # -> None:
        ...
...
class DataSourceRelationalDatabaseConfigHttpEndpointConfigArgs:
    def __init__(__self__, *, aws_secret_store_arn: pulumi.Input[_builtins.str], db_cluster_identifier: pulumi.Input[_builtins.str], database_name: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., schema: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def aws_secret_store_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class FunctionRuntimeArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], runtime_version: pulumi.Input[_builtins.str]) -> None:
...
class FunctionSyncConfigArgs:
    def __init__(__self__, *, conflict_detection: Optional[pulumi.Input[_builtins.str]] = ..., conflict_handler: Optional[pulumi.Input[_builtins.str]] = ..., lambda_conflict_handler_config: Optional[pulumi.Input[FunctionSyncConfigLambdaConflictHandlerConfigArgs]] = ...) -> None:
    ...
    def conflict_detection(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def conflict_handler(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def lambda_conflict_handler_config(self, value: Optional[pulumi.Input[FunctionSyncConfigLambdaConflictHandlerConfigArgs]]): # -> None:
        ...
...
class FunctionSyncConfigLambdaConflictHandlerConfigArgs:
    def __init__(__self__, *, lambda_conflict_handler_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def lambda_conflict_handler_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GraphQLApiAdditionalAuthenticationProviderArgs:
    def __init__(__self__, *, authentication_type: pulumi.Input[_builtins.str], lambda_authorizer_config: Optional[pulumi.Input[GraphQLApiAdditionalAuthenticationProviderLambdaAuthorizerConfigArgs]] = ..., openid_connect_config: Optional[pulumi.Input[GraphQLApiAdditionalAuthenticationProviderOpenidConnectConfigArgs]] = ..., user_pool_config: Optional[pulumi.Input[GraphQLApiAdditionalAuthenticationProviderUserPoolConfigArgs]] = ...) -> None:
    ...
    @lambda_authorizer_config.setter
    def lambda_authorizer_config(self, value: Optional[pulumi.Input[GraphQLApiAdditionalAuthenticationProviderLambdaAuthorizerConfigArgs]]): # -> None:
        ...
    ...
    @openid_connect_config.setter
    def openid_connect_config(self, value: Optional[pulumi.Input[GraphQLApiAdditionalAuthenticationProviderOpenidConnectConfigArgs]]): # -> None:
        ...
    ...
    def user_pool_config(self, value: Optional[pulumi.Input[GraphQLApiAdditionalAuthenticationProviderUserPoolConfigArgs]]): # -> None:
        ...
...
class GraphQLApiAdditionalAuthenticationProviderUserPoolConfigArgs:
    def __init__(__self__, *, user_pool_id: pulumi.Input[_builtins.str], app_id_client_regex: Optional[pulumi.Input[_builtins.str]] = ..., aws_region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class GraphQLApiEnhancedMetricsConfigArgs:
    def __init__(__self__, *, data_source_level_metrics_behavior: pulumi.Input[_builtins.str], operation_level_metrics_config: pulumi.Input[_builtins.str], resolver_level_metrics_behavior: pulumi.Input[_builtins.str]) -> None:
    ...
    def data_source_level_metrics_behavior(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def operation_level_metrics_config(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def resolver_level_metrics_behavior(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class GraphQLApiLogConfigArgs:
    def __init__(__self__, *, cloudwatch_logs_role_arn: pulumi.Input[_builtins.str], field_log_level: pulumi.Input[_builtins.str], exclude_verbose_content: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def field_log_level(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def exclude_verbose_content(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class GraphQLApiUserPoolConfigArgs:
    def __init__(__self__, *, default_action: pulumi.Input[_builtins.str], user_pool_id: pulumi.Input[_builtins.str], app_id_client_regex: Optional[pulumi.Input[_builtins.str]] = ..., aws_region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ResolverCachingConfigArgs:
    def __init__(__self__, *, caching_keys: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ttl: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @caching_keys.setter
    def caching_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ResolverPipelineConfigArgs:
    def __init__(__self__, *, functions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @functions.setter
    def functions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ResolverSyncConfigArgs:
    def __init__(__self__, *, conflict_detection: Optional[pulumi.Input[_builtins.str]] = ..., conflict_handler: Optional[pulumi.Input[_builtins.str]] = ..., lambda_conflict_handler_config: Optional[pulumi.Input[ResolverSyncConfigLambdaConflictHandlerConfigArgs]] = ...) -> None:
    ...
    @lambda_conflict_handler_config.setter
    def lambda_conflict_handler_config(self, value: Optional[pulumi.Input[ResolverSyncConfigLambdaConflictHandlerConfigArgs]]): # -> None:
        ...
...
class SourceApiAssociationSourceApiAssociationConfigArgs:
    ...
    @merge_type.setter
    def merge_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
