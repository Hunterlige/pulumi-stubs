...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ProfilingGroupAgentOrchestrationConfigArgs', 'ProfilingGroupAgentOrchestrationConfigArgsDict']
...
class ProfilingGroupAgentOrchestrationConfigArgs:
    def __init__(__self__, *, profiling_enabled: pulumi.Input[_builtins.bool]) -> None:
    ...
    def profiling_enabled(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
