...
class ProfilingGroupArgs:
    def __init__(
        __self__,
        *,
        agent_orchestration_config: pulumi.Input[
    ...
    def agent_orchestration_config(
        self,
    ) -> pulumi.Input[ProfilingGroupAgentOrchestrationConfigArgs]: ...
    @agent_orchestration_config.setter
    def agent_orchestration_config(
        self, value: pulumi.Input[ProfilingGroupAgentOrchestrationConfigArgs]
    ): ...
    @_builtins.property
...
class _ProfilingGroupState:
    ...
    def agent_orchestration_config(
        self,
    ) -> Optional[pulumi.Input[ProfilingGroupAgentOrchestrationConfigArgs]]: ...
    @agent_orchestration_config.setter
    def agent_orchestration_config(
        self, value: Optional[pulumi.Input[ProfilingGroupAgentOrchestrationConfigArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class ProfilingGroup(pulumi.CustomResource):
    ...
    def agent_orchestration_config(
        self,
    ) -> pulumi.Output[outputs.ProfilingGroupAgentOrchestrationConfig]: ...
    @_builtins.property
    @pulumi.getter
