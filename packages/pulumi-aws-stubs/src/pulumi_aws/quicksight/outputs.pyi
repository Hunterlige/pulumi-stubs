...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccountSettingsTimeouts', 'AnalysisParameters', 'AnalysisParametersDateTimeParameter', 'AnalysisParametersDecimalParameter', 'AnalysisParametersIntegerParameter', 'AnalysisParametersStringParameter', 'AnalysisPermission', 'AnalysisSourceEntity', 'AnalysisSourceEntitySourceTemplate', 'AnalysisSourceEntitySourceTemplateDataSetReference', 'CustomPermissionsCapabilities', 'DashboardDashboardPublishOptions', ..., ..., ..., ..., 'DashboardDashboardPublishOptionsExportToCsvOption', ..., ..., ..., ..., 'DashboardDashboardPublishOptionsVisualMenuOption', 'DashboardParameters', 'DashboardParametersDateTimeParameter', 'DashboardParametersDecimalParameter', 'DashboardParametersIntegerParameter', 'DashboardParametersStringParameter', 'DashboardPermission', 'DashboardSourceEntity', 'DashboardSourceEntitySourceTemplate', ..., 'DataSetColumnGroup', 'DataSetColumnGroupGeoSpatialColumnGroup', 'DataSetColumnLevelPermissionRule', 'DataSetDataSetUsageConfiguration', 'DataSetFieldFolder', 'DataSetLogicalTableMap', 'DataSetLogicalTableMapDataTransform', ..., ..., ..., 'DataSetLogicalTableMapDataTransformFilterOperation', ..., ..., ..., ..., ..., ..., 'DataSetLogicalTableMapSource', 'DataSetLogicalTableMapSourceJoinInstruction', ..., ..., 'DataSetOutputColumn', 'DataSetPermission', 'DataSetPhysicalTableMap', 'DataSetPhysicalTableMapCustomSql', 'DataSetPhysicalTableMapCustomSqlColumn', 'DataSetPhysicalTableMapRelationalTable', 'DataSetPhysicalTableMapRelationalTableInputColumn', 'DataSetPhysicalTableMapS3Source', 'DataSetPhysicalTableMapS3SourceInputColumn', 'DataSetPhysicalTableMapS3SourceUploadSettings', 'DataSetRefreshProperties', 'DataSetRefreshPropertiesRefreshConfiguration', ..., ..., 'DataSetRowLevelPermissionDataSet', 'DataSetRowLevelPermissionTagConfiguration', 'DataSetRowLevelPermissionTagConfigurationTagRule', 'DataSourceCredentials', 'DataSourceCredentialsCredentialPair', 'DataSourceParameters', 'DataSourceParametersAmazonElasticsearch', 'DataSourceParametersAthena', 'DataSourceParametersAurora', 'DataSourceParametersAuroraPostgresql', 'DataSourceParametersAwsIotAnalytics', 'DataSourceParametersDatabricks', 'DataSourceParametersJira', 'DataSourceParametersMariaDb', 'DataSourceParametersMysql', 'DataSourceParametersOracle', 'DataSourceParametersPostgresql', 'DataSourceParametersPresto', 'DataSourceParametersRds', 'DataSourceParametersRedshift', 'DataSourceParametersS3', 'DataSourceParametersS3ManifestFileLocation', 'DataSourceParametersServiceNow', 'DataSourceParametersSnowflake', 'DataSourceParametersSpark', 'DataSourceParametersSqlServer', 'DataSourceParametersTeradata', 'DataSourceParametersTwitter', 'DataSourcePermission', 'DataSourceSslProperties', 'DataSourceVpcConnectionProperties', 'FolderPermission', 'IamPolicyAssignmentIdentities', 'KeyRegistrationKeyRegistration', 'NamespaceTimeouts', 'RefreshScheduleSchedule', 'RefreshScheduleScheduleScheduleFrequency', ..., 'TemplatePermission', 'TemplateSourceEntity', 'TemplateSourceEntitySourceAnalysis', 'TemplateSourceEntitySourceAnalysisDataSetReference', 'TemplateSourceEntitySourceTemplate', 'ThemeConfiguration', 'ThemeConfigurationDataColorPalette', 'ThemeConfigurationSheet', 'ThemeConfigurationSheetTile', 'ThemeConfigurationSheetTileBorder', 'ThemeConfigurationSheetTileLayout', 'ThemeConfigurationSheetTileLayoutGutter', 'ThemeConfigurationSheetTileLayoutMargin', 'ThemeConfigurationTypography', 'ThemeConfigurationTypographyFontFamily', 'ThemeConfigurationUiColorPalette', 'ThemePermission', 'VpcConnectionTimeouts', 'GetDataSetColumnGroupResult', 'GetDataSetColumnGroupGeoSpatialColumnGroupResult', 'GetDataSetColumnLevelPermissionRuleResult', 'GetDataSetDataSetUsageConfigurationResult', 'GetDataSetFieldFolderResult', 'GetDataSetLogicalTableMapResult', 'GetDataSetLogicalTableMapDataTransformResult', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetDataSetLogicalTableMapSourceResult', ..., ..., ..., 'GetDataSetPermissionResult', 'GetDataSetPhysicalTableMapResult', 'GetDataSetPhysicalTableMapCustomSqlResult', 'GetDataSetPhysicalTableMapCustomSqlColumnResult', 'GetDataSetPhysicalTableMapRelationalTableResult', ..., 'GetDataSetPhysicalTableMapS3SourceResult', ..., ..., 'GetDataSetRowLevelPermissionDataSetResult', 'GetDataSetRowLevelPermissionTagConfigurationResult', ..., 'GetQuicksightAnalysisPermissionResult', 'GetThemeConfigurationResult', 'GetThemeConfigurationDataColorPaletteResult', 'GetThemeConfigurationSheetResult', 'GetThemeConfigurationSheetTileResult', 'GetThemeConfigurationSheetTileBorderResult', 'GetThemeConfigurationSheetTileLayoutResult', 'GetThemeConfigurationSheetTileLayoutGutterResult', 'GetThemeConfigurationSheetTileLayoutMarginResult', 'GetThemeConfigurationTypographyResult', 'GetThemeConfigurationTypographyFontFamilyResult', 'GetThemeConfigurationUiColorPaletteResult', 'GetThemePermissionResult']
@pulumi.output_type
...
class AnalysisParameters(dict):
    ...
    def __init__(__self__, *, date_time_parameters: Optional[Sequence[outputs.AnalysisParametersDateTimeParameter]] = ..., decimal_parameters: Optional[Sequence[outputs.AnalysisParametersDecimalParameter]] = ..., integer_parameters: Optional[Sequence[outputs.AnalysisParametersIntegerParameter]] = ..., string_parameters: Optional[Sequence[outputs.AnalysisParametersStringParameter]] = ...) -> None:
...
class AnalysisParametersDecimalParameter(dict):
    def __init__(__self__, *, name: _builtins.str, values: Sequence[_builtins.float]) -> None:
...
class AnalysisParametersIntegerParameter(dict):
    def __init__(__self__, *, name: _builtins.str, values: Sequence[_builtins.int]) -> None:
...
class AnalysisPermission(dict):
    def __init__(__self__, *, actions: Sequence[_builtins.str], principal: _builtins.str) -> None:
...
class AnalysisSourceEntity(dict):
    ...
    def __init__(__self__, *, source_template: Optional[outputs.AnalysisSourceEntitySourceTemplate] = ...) -> None:
...
class AnalysisSourceEntitySourceTemplate(dict):
    ...
    def __init__(__self__, *, arn: _builtins.str, data_set_references: Sequence[outputs.AnalysisSourceEntitySourceTemplateDataSetReference]) -> None:
...
class AnalysisSourceEntitySourceTemplateDataSetReference(dict):
    ...
    def __init__(__self__, *, data_set_arn: _builtins.str, data_set_placeholder: _builtins.str) -> None:
...
class CustomPermissionsCapabilities(dict):
    ...
    def __init__(__self__, *, add_or_run_anomaly_detection_for_analyses: Optional[_builtins.str] = ..., create_and_update_dashboard_email_reports: Optional[_builtins.str] = ..., create_and_update_data_sources: Optional[_builtins.str] = ..., create_and_update_datasets: Optional[_builtins.str] = ..., create_and_update_themes: Optional[_builtins.str] = ..., create_and_update_threshold_alerts: Optional[_builtins.str] = ..., create_shared_folders: Optional[_builtins.str] = ..., create_spice_dataset: Optional[_builtins.str] = ..., export_to_csv: Optional[_builtins.str] = ..., export_to_csv_in_scheduled_reports: Optional[_builtins.str] = ..., export_to_excel: Optional[_builtins.str] = ..., export_to_excel_in_scheduled_reports: Optional[_builtins.str] = ..., export_to_pdf: Optional[_builtins.str] = ..., export_to_pdf_in_scheduled_reports: Optional[_builtins.str] = ..., include_content_in_scheduled_reports_email: Optional[_builtins.str] = ..., print_reports: Optional[_builtins.str] = ..., rename_shared_folders: Optional[_builtins.str] = ..., share_analyses: Optional[_builtins.str] = ..., share_dashboards: Optional[_builtins.str] = ..., share_data_sources: Optional[_builtins.str] = ..., share_datasets: Optional[_builtins.str] = ..., subscribe_dashboard_email_reports: Optional[_builtins.str] = ..., view_account_spice_capacity: Optional[_builtins.str] = ...) -> None:
...
class DashboardDashboardPublishOptions(dict):
    ...
    def __init__(__self__, *, ad_hoc_filtering_option: Optional[outputs.DashboardDashboardPublishOptionsAdHocFilteringOption] = ..., data_point_drill_up_down_option: Optional[outputs.DashboardDashboardPublishOptionsDataPointDrillUpDownOption] = ..., data_point_menu_label_option: Optional[outputs.DashboardDashboardPublishOptionsDataPointMenuLabelOption] = ..., data_point_tooltip_option: Optional[outputs.DashboardDashboardPublishOptionsDataPointTooltipOption] = ..., export_to_csv_option: Optional[outputs.DashboardDashboardPublishOptionsExportToCsvOption] = ..., export_with_hidden_fields_option: Optional[outputs.DashboardDashboardPublishOptionsExportWithHiddenFieldsOption] = ..., sheet_controls_option: Optional[outputs.DashboardDashboardPublishOptionsSheetControlsOption] = ..., sheet_layout_element_maximization_option: Optional[outputs.DashboardDashboardPublishOptionsSheetLayoutElementMaximizationOption] = ..., visual_axis_sort_option: Optional[outputs.DashboardDashboardPublishOptionsVisualAxisSortOption] = ..., visual_menu_option: Optional[outputs.DashboardDashboardPublishOptionsVisualMenuOption] = ...) -> None:
...
class DashboardDashboardPublishOptionsAdHocFilteringOption(dict):
    ...
    def __init__(__self__, *, availability_status: Optional[_builtins.str] = ...) -> None:
...
class DashboardDashboardPublishOptionsSheetControlsOption(dict):
    ...
    def __init__(__self__, *, visibility_state: Optional[_builtins.str] = ...) -> None:
...
class DashboardParameters(dict):
    ...
    def __init__(__self__, *, date_time_parameters: Optional[Sequence[outputs.DashboardParametersDateTimeParameter]] = ..., decimal_parameters: Optional[Sequence[outputs.DashboardParametersDecimalParameter]] = ..., integer_parameters: Optional[Sequence[outputs.DashboardParametersIntegerParameter]] = ..., string_parameters: Optional[Sequence[outputs.DashboardParametersStringParameter]] = ...) -> None:
...
class DashboardSourceEntity(dict):
    ...
    def __init__(__self__, *, source_template: Optional[outputs.DashboardSourceEntitySourceTemplate] = ...) -> None:
...
class DashboardSourceEntitySourceTemplate(dict):
    ...
    def __init__(__self__, *, arn: _builtins.str, data_set_references: Sequence[outputs.DashboardSourceEntitySourceTemplateDataSetReference]) -> None:
...
class DataSetColumnGroup(dict):
    ...
    def __init__(__self__, *, geo_spatial_column_group: Optional[outputs.DataSetColumnGroupGeoSpatialColumnGroup] = ...) -> None:
...
class DataSetColumnGroupGeoSpatialColumnGroup(dict):
    ...
    def __init__(__self__, *, columns: Sequence[_builtins.str], country_code: _builtins.str, name: _builtins.str) -> None:
...
class DataSetColumnLevelPermissionRule(dict):
    ...
    def __init__(__self__, *, column_names: Optional[Sequence[_builtins.str]] = ..., principals: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DataSetDataSetUsageConfiguration(dict):
    ...
    def __init__(__self__, *, disable_use_as_direct_query_source: Optional[_builtins.bool] = ..., disable_use_as_imported_source: Optional[_builtins.bool] = ...) -> None:
...
class DataSetFieldFolder(dict):
    ...
    def __init__(__self__, *, field_folders_id: _builtins.str, columns: Optional[Sequence[_builtins.str]] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class DataSetLogicalTableMap(dict):
    ...
    def __init__(__self__, *, alias: _builtins.str, logical_table_map_id: _builtins.str, source: outputs.DataSetLogicalTableMapSource, data_transforms: Optional[Sequence[outputs.DataSetLogicalTableMapDataTransform]] = ...) -> None:
...
class DataSetLogicalTableMapDataTransform(dict):
    ...
    def __init__(__self__, *, cast_column_type_operation: Optional[outputs.DataSetLogicalTableMapDataTransformCastColumnTypeOperation] = ..., create_columns_operation: Optional[outputs.DataSetLogicalTableMapDataTransformCreateColumnsOperation] = ..., filter_operation: Optional[outputs.DataSetLogicalTableMapDataTransformFilterOperation] = ..., project_operation: Optional[outputs.DataSetLogicalTableMapDataTransformProjectOperation] = ..., rename_column_operation: Optional[outputs.DataSetLogicalTableMapDataTransformRenameColumnOperation] = ..., tag_column_operation: Optional[outputs.DataSetLogicalTableMapDataTransformTagColumnOperation] = ..., untag_column_operation: Optional[outputs.DataSetLogicalTableMapDataTransformUntagColumnOperation] = ...) -> None:
...
class DataSetLogicalTableMapDataTransformCastColumnTypeOperation(dict):
    ...
    def __init__(__self__, *, column_name: _builtins.str, new_column_type: _builtins.str, format: Optional[_builtins.str] = ...) -> None:
...
class DataSetLogicalTableMapDataTransformCreateColumnsOperation(dict):
    def __init__(__self__, *, columns: Sequence[outputs.DataSetLogicalTableMapDataTransformCreateColumnsOperationColumn]) -> None:
...
class DataSetLogicalTableMapDataTransformCreateColumnsOperationColumn(dict):
    ...
    def __init__(__self__, *, column_id: _builtins.str, column_name: _builtins.str, expression: _builtins.str) -> None:
...
class DataSetLogicalTableMapDataTransformRenameColumnOperation(dict):
    ...
    def __init__(__self__, *, column_name: _builtins.str, new_column_name: _builtins.str) -> None:
...
class DataSetLogicalTableMapDataTransformTagColumnOperation(dict):
    ...
    def __init__(__self__, *, column_name: _builtins.str, tags: Sequence[outputs.DataSetLogicalTableMapDataTransformTagColumnOperationTag]) -> None:
...
class DataSetLogicalTableMapDataTransformTagColumnOperationTag(dict):
    ...
    def __init__(__self__, *, column_description: Optional[outputs.DataSetLogicalTableMapDataTransformTagColumnOperationTagColumnDescription] = ..., column_geographic_role: Optional[_builtins.str] = ...) -> None:
...
class DataSetLogicalTableMapDataTransformUntagColumnOperation(dict):
    ...
    def __init__(__self__, *, column_name: _builtins.str, tag_names: Sequence[_builtins.str]) -> None:
...
class DataSetLogicalTableMapSource(dict):
    ...
    def __init__(__self__, *, data_set_arn: Optional[_builtins.str] = ..., join_instruction: Optional[outputs.DataSetLogicalTableMapSourceJoinInstruction] = ..., physical_table_id: Optional[_builtins.str] = ...) -> None:
...
class DataSetOutputColumn(dict):
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class DataSetPhysicalTableMap(dict):
    ...
    def __init__(__self__, *, physical_table_map_id: _builtins.str, custom_sql: Optional[outputs.DataSetPhysicalTableMapCustomSql] = ..., relational_table: Optional[outputs.DataSetPhysicalTableMapRelationalTable] = ..., s3_source: Optional[outputs.DataSetPhysicalTableMapS3Source] = ...) -> None:
...
class DataSetPhysicalTableMapCustomSql(dict):
    ...
    def __init__(__self__, *, data_source_arn: _builtins.str, name: _builtins.str, sql_query: _builtins.str, columns: Optional[Sequence[outputs.DataSetPhysicalTableMapCustomSqlColumn]] = ...) -> None:
...
class DataSetPhysicalTableMapRelationalTable(dict):
    ...
    def __init__(__self__, *, data_source_arn: _builtins.str, input_columns: Sequence[outputs.DataSetPhysicalTableMapRelationalTableInputColumn], name: _builtins.str, catalog: Optional[_builtins.str] = ..., schema: Optional[_builtins.str] = ...) -> None:
...
class DataSetPhysicalTableMapS3Source(dict):
    ...
    def __init__(__self__, *, data_source_arn: _builtins.str, input_columns: Sequence[outputs.DataSetPhysicalTableMapS3SourceInputColumn], upload_settings: outputs.DataSetPhysicalTableMapS3SourceUploadSettings) -> None:
...
class DataSetPhysicalTableMapS3SourceUploadSettings(dict):
    ...
    def __init__(__self__, *, contains_header: Optional[_builtins.bool] = ..., delimiter: Optional[_builtins.str] = ..., format: Optional[_builtins.str] = ..., start_from_row: Optional[_builtins.int] = ..., text_qualifier: Optional[_builtins.str] = ...) -> None:
...
class DataSetRefreshProperties(dict):
    ...
    def __init__(__self__, *, refresh_configuration: outputs.DataSetRefreshPropertiesRefreshConfiguration) -> None:
...
class DataSetRefreshPropertiesRefreshConfiguration(dict):
    ...
    def __init__(__self__, *, incremental_refresh: outputs.DataSetRefreshPropertiesRefreshConfigurationIncrementalRefresh) -> None:
...
class DataSetRefreshPropertiesRefreshConfigurationIncrementalRefresh(dict):
    ...
    def __init__(__self__, *, lookback_window: outputs.DataSetRefreshPropertiesRefreshConfigurationIncrementalRefreshLookbackWindow) -> None:
...
class DataSetRefreshPropertiesRefreshConfigurationIncrementalRefreshLookbackWindow(dict):
    ...
    def __init__(__self__, *, column_name: _builtins.str, size: _builtins.int, size_unit: _builtins.str) -> None:
...
class DataSetRowLevelPermissionDataSet(dict):
    ...
    def __init__(__self__, *, arn: _builtins.str, permission_policy: _builtins.str, format_version: Optional[_builtins.str] = ..., namespace: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class DataSetRowLevelPermissionTagConfiguration(dict):
    ...
    def __init__(__self__, *, tag_rules: Sequence[outputs.DataSetRowLevelPermissionTagConfigurationTagRule], status: Optional[_builtins.str] = ...) -> None:
...
class DataSetRowLevelPermissionTagConfigurationTagRule(dict):
    ...
    def __init__(__self__, *, column_name: _builtins.str, tag_key: _builtins.str, match_all_value: Optional[_builtins.str] = ..., tag_multi_value_delimiter: Optional[_builtins.str] = ...) -> None:
...
class DataSourceCredentials(dict):
    ...
    def __init__(__self__, *, copy_source_arn: Optional[_builtins.str] = ..., credential_pair: Optional[outputs.DataSourceCredentialsCredentialPair] = ..., secret_arn: Optional[_builtins.str] = ...) -> None:
...
class DataSourceParameters(dict):
    ...
    def __init__(__self__, *, amazon_elasticsearch: Optional[outputs.DataSourceParametersAmazonElasticsearch] = ..., athena: Optional[outputs.DataSourceParametersAthena] = ..., aurora: Optional[outputs.DataSourceParametersAurora] = ..., aurora_postgresql: Optional[outputs.DataSourceParametersAuroraPostgresql] = ..., aws_iot_analytics: Optional[outputs.DataSourceParametersAwsIotAnalytics] = ..., databricks: Optional[outputs.DataSourceParametersDatabricks] = ..., jira: Optional[outputs.DataSourceParametersJira] = ..., maria_db: Optional[outputs.DataSourceParametersMariaDb] = ..., mysql: Optional[outputs.DataSourceParametersMysql] = ..., oracle: Optional[outputs.DataSourceParametersOracle] = ..., postgresql: Optional[outputs.DataSourceParametersPostgresql] = ..., presto: Optional[outputs.DataSourceParametersPresto] = ..., rds: Optional[outputs.DataSourceParametersRds] = ..., redshift: Optional[outputs.DataSourceParametersRedshift] = ..., s3: Optional[outputs.DataSourceParametersS3] = ..., service_now: Optional[outputs.DataSourceParametersServiceNow] = ..., snowflake: Optional[outputs.DataSourceParametersSnowflake] = ..., spark: Optional[outputs.DataSourceParametersSpark] = ..., sql_server: Optional[outputs.DataSourceParametersSqlServer] = ..., teradata: Optional[outputs.DataSourceParametersTeradata] = ..., twitter: Optional[outputs.DataSourceParametersTwitter] = ...) -> None:
...
class DataSourceParametersAurora(dict):
    def __init__(__self__, *, database: _builtins.str, host: _builtins.str, port: _builtins.int) -> None:
...
class DataSourceParametersDatabricks(dict):
    ...
    def __init__(__self__, *, host: _builtins.str, port: _builtins.int, sql_endpoint_path: _builtins.str) -> None:
...
class DataSourceParametersPresto(dict):
    def __init__(__self__, *, catalog: _builtins.str, host: _builtins.str, port: _builtins.int) -> None:
...
class DataSourceParametersRds(dict):
    ...
    def __init__(__self__, *, database: _builtins.str, instance_id: _builtins.str) -> None:
...
class DataSourceParametersRedshift(dict):
    ...
    def __init__(__self__, *, database: _builtins.str, cluster_id: Optional[_builtins.str] = ..., host: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ...) -> None:
...
class DataSourceParametersS3(dict):
    ...
    def __init__(__self__, *, manifest_file_location: outputs.DataSourceParametersS3ManifestFileLocation, role_arn: Optional[_builtins.str] = ...) -> None:
...
class DataSourceParametersSnowflake(dict):
    def __init__(__self__, *, database: _builtins.str, host: _builtins.str, warehouse: _builtins.str) -> None:
...
class DataSourceParametersTwitter(dict):
    ...
    def __init__(__self__, *, max_rows: _builtins.int, query: _builtins.str) -> None:
...
class IamPolicyAssignmentIdentities(dict):
    def __init__(__self__, *, groups: Optional[Sequence[_builtins.str]] = ..., users: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class KeyRegistrationKeyRegistration(dict):
    ...
    def __init__(__self__, *, key_arn: _builtins.str, default_key: Optional[_builtins.bool] = ...) -> None:
...
class RefreshScheduleSchedule(dict):
    ...
    def __init__(__self__, *, refresh_type: _builtins.str, schedule_frequency: outputs.RefreshScheduleScheduleScheduleFrequency, start_after_date_time: Optional[_builtins.str] = ...) -> None:
...
class RefreshScheduleScheduleScheduleFrequency(dict):
    ...
    def __init__(__self__, *, interval: _builtins.str, refresh_on_day: Optional[outputs.RefreshScheduleScheduleScheduleFrequencyRefreshOnDay] = ..., time_of_the_day: Optional[_builtins.str] = ..., timezone: Optional[_builtins.str] = ...) -> None:
...
class RefreshScheduleScheduleScheduleFrequencyRefreshOnDay(dict):
    ...
    def __init__(__self__, *, day_of_month: Optional[_builtins.str] = ..., day_of_week: Optional[_builtins.str] = ...) -> None:
...
class TemplateSourceEntity(dict):
    ...
    def __init__(__self__, *, source_analysis: Optional[outputs.TemplateSourceEntitySourceAnalysis] = ..., source_template: Optional[outputs.TemplateSourceEntitySourceTemplate] = ...) -> None:
...
class TemplateSourceEntitySourceAnalysis(dict):
    ...
    def __init__(__self__, *, arn: _builtins.str, data_set_references: Sequence[outputs.TemplateSourceEntitySourceAnalysisDataSetReference]) -> None:
...
class ThemeConfiguration(dict):
    ...
    def __init__(__self__, *, data_color_palette: Optional[outputs.ThemeConfigurationDataColorPalette] = ..., sheet: Optional[outputs.ThemeConfigurationSheet] = ..., typography: Optional[outputs.ThemeConfigurationTypography] = ..., ui_color_palette: Optional[outputs.ThemeConfigurationUiColorPalette] = ...) -> None:
...
class ThemeConfigurationDataColorPalette(dict):
    ...
    def __init__(__self__, *, colors: Optional[Sequence[_builtins.str]] = ..., empty_fill_color: Optional[_builtins.str] = ..., min_max_gradients: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ThemeConfigurationSheet(dict):
    ...
    def __init__(__self__, *, tile: Optional[outputs.ThemeConfigurationSheetTile] = ..., tile_layout: Optional[outputs.ThemeConfigurationSheetTileLayout] = ...) -> None:
...
class ThemeConfigurationSheetTile(dict):
    def __init__(__self__, *, border: Optional[outputs.ThemeConfigurationSheetTileBorder] = ...) -> None:
...
class ThemeConfigurationSheetTileLayout(dict):
    def __init__(__self__, *, gutter: Optional[outputs.ThemeConfigurationSheetTileLayoutGutter] = ..., margin: Optional[outputs.ThemeConfigurationSheetTileLayoutMargin] = ...) -> None:
...
class ThemeConfigurationTypography(dict):
    ...
    def __init__(__self__, *, font_families: Optional[Sequence[outputs.ThemeConfigurationTypographyFontFamily]] = ...) -> None:
...
class ThemeConfigurationUiColorPalette(dict):
    ...
    def __init__(__self__, *, accent: Optional[_builtins.str] = ..., accent_foreground: Optional[_builtins.str] = ..., danger: Optional[_builtins.str] = ..., danger_foreground: Optional[_builtins.str] = ..., dimension: Optional[_builtins.str] = ..., dimension_foreground: Optional[_builtins.str] = ..., measure: Optional[_builtins.str] = ..., measure_foreground: Optional[_builtins.str] = ..., primary_background: Optional[_builtins.str] = ..., primary_foreground: Optional[_builtins.str] = ..., secondary_background: Optional[_builtins.str] = ..., secondary_foreground: Optional[_builtins.str] = ..., success: Optional[_builtins.str] = ..., success_foreground: Optional[_builtins.str] = ..., warning: Optional[_builtins.str] = ..., warning_foreground: Optional[_builtins.str] = ...) -> None:
...
class GetDataSetColumnGroupResult(dict):
    def __init__(__self__, *, geo_spatial_column_groups: Sequence[outputs.GetDataSetColumnGroupGeoSpatialColumnGroupResult]) -> None:
        ...
...
class GetDataSetColumnLevelPermissionRuleResult(dict):
    def __init__(__self__, *, column_names: Sequence[_builtins.str], principals: Sequence[_builtins.str]) -> None:
        ...
...
class GetDataSetDataSetUsageConfigurationResult(dict):
    def __init__(__self__, *, disable_use_as_direct_query_source: _builtins.bool, disable_use_as_imported_source: _builtins.bool) -> None:
        ...
...
class GetDataSetFieldFolderResult(dict):
    def __init__(__self__, *, columns: Sequence[_builtins.str], description: _builtins.str, field_folders_id: _builtins.str) -> None:
        ...
...
class GetDataSetLogicalTableMapResult(dict):
    def __init__(__self__, *, alias: _builtins.str, data_transforms: Sequence[outputs.GetDataSetLogicalTableMapDataTransformResult], logical_table_map_id: _builtins.str, sources: Sequence[outputs.GetDataSetLogicalTableMapSourceResult]) -> None:
        ...
...
class GetDataSetLogicalTableMapDataTransformCastColumnTypeOperationResult(dict):
    def __init__(__self__, *, column_name: _builtins.str, format: _builtins.str, new_column_type: _builtins.str) -> None:
        ...
...
class GetDataSetLogicalTableMapDataTransformCreateColumnsOperationResult(dict):
    def __init__(__self__, *, columns: Sequence[outputs.GetDataSetLogicalTableMapDataTransformCreateColumnsOperationColumnResult]) -> None:
        ...
...
class GetDataSetLogicalTableMapDataTransformTagColumnOperationResult(dict):
    def __init__(__self__, *, column_name: _builtins.str, tags: Sequence[outputs.GetDataSetLogicalTableMapDataTransformTagColumnOperationTagResult]) -> None:
        ...
...
class GetDataSetLogicalTableMapDataTransformTagColumnOperationTagResult(dict):
    def __init__(__self__, *, column_descriptions: Sequence[outputs.GetDataSetLogicalTableMapDataTransformTagColumnOperationTagColumnDescriptionResult], column_geographic_role: _builtins.str) -> None:
        ...
...
class GetDataSetLogicalTableMapSourceResult(dict):
    def __init__(__self__, *, data_set_arn: _builtins.str, join_instructions: Sequence[outputs.GetDataSetLogicalTableMapSourceJoinInstructionResult], physical_table_id: _builtins.str) -> None:
        ...
...
class GetDataSetLogicalTableMapSourceJoinInstructionResult(dict):
    def __init__(__self__, *, left_join_key_properties: Sequence[outputs.GetDataSetLogicalTableMapSourceJoinInstructionLeftJoinKeyPropertyResult], left_operand: _builtins.str, on_clause: _builtins.str, right_join_key_properties: Sequence[outputs.GetDataSetLogicalTableMapSourceJoinInstructionRightJoinKeyPropertyResult], right_operand: _builtins.str, type: _builtins.str) -> None:
        ...
...
class GetDataSetPhysicalTableMapResult(dict):
    def __init__(__self__, *, custom_sqls: Sequence[outputs.GetDataSetPhysicalTableMapCustomSqlResult], physical_table_map_id: _builtins.str, relational_tables: Sequence[outputs.GetDataSetPhysicalTableMapRelationalTableResult], s3_sources: Sequence[outputs.GetDataSetPhysicalTableMapS3SourceResult]) -> None:
        ...
...
class GetDataSetPhysicalTableMapCustomSqlResult(dict):
    def __init__(__self__, *, columns: Sequence[outputs.GetDataSetPhysicalTableMapCustomSqlColumnResult], data_source_arn: _builtins.str, name: _builtins.str, sql_query: _builtins.str) -> None:
        ...
...
class GetDataSetPhysicalTableMapRelationalTableResult(dict):
    def __init__(__self__, *, catalog: _builtins.str, data_source_arn: _builtins.str, input_columns: Sequence[outputs.GetDataSetPhysicalTableMapRelationalTableInputColumnResult], name: _builtins.str, schema: _builtins.str) -> None:
        ...
...
class GetDataSetPhysicalTableMapS3SourceResult(dict):
    def __init__(__self__, *, data_source_arn: _builtins.str, input_columns: Sequence[outputs.GetDataSetPhysicalTableMapS3SourceInputColumnResult], upload_settings: Sequence[outputs.GetDataSetPhysicalTableMapS3SourceUploadSettingResult]) -> None:
        ...
...
class GetDataSetPhysicalTableMapS3SourceUploadSettingResult(dict):
    def __init__(__self__, *, contains_header: _builtins.bool, delimiter: _builtins.str, format: _builtins.str, start_from_row: _builtins.int, text_qualifier: _builtins.str) -> None:
        ...
...
class GetDataSetRowLevelPermissionDataSetResult(dict):
    def __init__(__self__, *, arn: _builtins.str, format_version: _builtins.str, namespace: _builtins.str, permission_policy: _builtins.str, status: _builtins.str) -> None:
        ...
...
class GetDataSetRowLevelPermissionTagConfigurationResult(dict):
    def __init__(__self__, *, status: _builtins.str, tag_rules: Sequence[outputs.GetDataSetRowLevelPermissionTagConfigurationTagRuleResult]) -> None:
        ...
...
class GetDataSetRowLevelPermissionTagConfigurationTagRuleResult(dict):
    def __init__(__self__, *, column_name: _builtins.str, match_all_value: _builtins.str, tag_key: _builtins.str, tag_multi_value_delimiter: _builtins.str) -> None:
        ...
...
class GetThemeConfigurationResult(dict):
    def __init__(__self__, *, data_color_palettes: Sequence[outputs.GetThemeConfigurationDataColorPaletteResult], sheets: Sequence[outputs.GetThemeConfigurationSheetResult], typographies: Sequence[outputs.GetThemeConfigurationTypographyResult], ui_color_palettes: Sequence[outputs.GetThemeConfigurationUiColorPaletteResult]) -> None:
...
class GetThemeConfigurationDataColorPaletteResult(dict):
    def __init__(__self__, *, colors: Sequence[_builtins.str], empty_fill_color: _builtins.str, min_max_gradients: Sequence[_builtins.str]) -> None:
...
class GetThemeConfigurationSheetResult(dict):
    def __init__(__self__, *, tile_layouts: Sequence[outputs.GetThemeConfigurationSheetTileLayoutResult], tiles: Sequence[outputs.GetThemeConfigurationSheetTileResult]) -> None:
...
class GetThemeConfigurationSheetTileResult(dict):
    def __init__(__self__, *, borders: Sequence[outputs.GetThemeConfigurationSheetTileBorderResult]) -> None:
...
class GetThemeConfigurationSheetTileLayoutResult(dict):
    def __init__(__self__, *, gutters: Sequence[outputs.GetThemeConfigurationSheetTileLayoutGutterResult], margins: Sequence[outputs.GetThemeConfigurationSheetTileLayoutMarginResult]) -> None:
...
class GetThemeConfigurationTypographyResult(dict):
    def __init__(__self__, *, font_families: Sequence[outputs.GetThemeConfigurationTypographyFontFamilyResult]) -> None:
...
class GetThemeConfigurationUiColorPaletteResult(dict):
    def __init__(__self__, *, accent: _builtins.str, accent_foreground: _builtins.str, danger: _builtins.str, danger_foreground: _builtins.str, dimension: _builtins.str, dimension_foreground: _builtins.str, measure: _builtins.str, measure_foreground: _builtins.str, primary_background: _builtins.str, primary_foreground: _builtins.str, secondary_background: _builtins.str, secondary_foreground: _builtins.str, success: _builtins.str, success_foreground: _builtins.str, warning: _builtins.str, warning_foreground: _builtins.str) -> None:
