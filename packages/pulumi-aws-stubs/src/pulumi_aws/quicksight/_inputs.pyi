...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccountSettingsTimeoutsArgs', 'AccountSettingsTimeoutsArgsDict', 'AnalysisParametersArgs', 'AnalysisParametersArgsDict', 'AnalysisParametersDateTimeParameterArgs', 'AnalysisParametersDateTimeParameterArgsDict', 'AnalysisParametersDecimalParameterArgs', 'AnalysisParametersDecimalParameterArgsDict', 'AnalysisParametersIntegerParameterArgs', 'AnalysisParametersIntegerParameterArgsDict', 'AnalysisParametersStringParameterArgs', 'AnalysisParametersStringParameterArgsDict', 'AnalysisPermissionArgs', 'AnalysisPermissionArgsDict', 'AnalysisSourceEntityArgs', 'AnalysisSourceEntityArgsDict', 'AnalysisSourceEntitySourceTemplateArgs', 'AnalysisSourceEntitySourceTemplateArgsDict', ..., ..., 'CustomPermissionsCapabilitiesArgs', 'CustomPermissionsCapabilitiesArgsDict', 'DashboardDashboardPublishOptionsArgs', 'DashboardDashboardPublishOptionsArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'DashboardParametersArgs', 'DashboardParametersArgsDict', 'DashboardParametersDateTimeParameterArgs', 'DashboardParametersDateTimeParameterArgsDict', 'DashboardParametersDecimalParameterArgs', 'DashboardParametersDecimalParameterArgsDict', 'DashboardParametersIntegerParameterArgs', 'DashboardParametersIntegerParameterArgsDict', 'DashboardParametersStringParameterArgs', 'DashboardParametersStringParameterArgsDict', 'DashboardPermissionArgs', 'DashboardPermissionArgsDict', 'DashboardSourceEntityArgs', 'DashboardSourceEntityArgsDict', 'DashboardSourceEntitySourceTemplateArgs', 'DashboardSourceEntitySourceTemplateArgsDict', ..., ..., 'DataSetColumnGroupArgs', 'DataSetColumnGroupArgsDict', 'DataSetColumnGroupGeoSpatialColumnGroupArgs', 'DataSetColumnGroupGeoSpatialColumnGroupArgsDict', 'DataSetColumnLevelPermissionRuleArgs', 'DataSetColumnLevelPermissionRuleArgsDict', 'DataSetDataSetUsageConfigurationArgs', 'DataSetDataSetUsageConfigurationArgsDict', 'DataSetFieldFolderArgs', 'DataSetFieldFolderArgsDict', 'DataSetLogicalTableMapArgs', 'DataSetLogicalTableMapArgsDict', 'DataSetLogicalTableMapDataTransformArgs', 'DataSetLogicalTableMapDataTransformArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'DataSetLogicalTableMapSourceArgs', 'DataSetLogicalTableMapSourceArgsDict', 'DataSetLogicalTableMapSourceJoinInstructionArgs', ..., ..., ..., ..., ..., 'DataSetOutputColumnArgs', 'DataSetOutputColumnArgsDict', 'DataSetPermissionArgs', 'DataSetPermissionArgsDict', 'DataSetPhysicalTableMapArgs', 'DataSetPhysicalTableMapArgsDict', 'DataSetPhysicalTableMapCustomSqlArgs', 'DataSetPhysicalTableMapCustomSqlArgsDict', 'DataSetPhysicalTableMapCustomSqlColumnArgs', 'DataSetPhysicalTableMapCustomSqlColumnArgsDict', 'DataSetPhysicalTableMapRelationalTableArgs', 'DataSetPhysicalTableMapRelationalTableArgsDict', ..., ..., 'DataSetPhysicalTableMapS3SourceArgs', 'DataSetPhysicalTableMapS3SourceArgsDict', 'DataSetPhysicalTableMapS3SourceInputColumnArgs', 'DataSetPhysicalTableMapS3SourceInputColumnArgsDict', 'DataSetPhysicalTableMapS3SourceUploadSettingsArgs', ..., 'DataSetRefreshPropertiesArgs', 'DataSetRefreshPropertiesArgsDict', 'DataSetRefreshPropertiesRefreshConfigurationArgs', ..., ..., ..., ..., ..., 'DataSetRowLevelPermissionDataSetArgs', 'DataSetRowLevelPermissionDataSetArgsDict', 'DataSetRowLevelPermissionTagConfigurationArgs', 'DataSetRowLevelPermissionTagConfigurationArgsDict', ..., ..., 'DataSourceCredentialsArgs', 'DataSourceCredentialsArgsDict', 'DataSourceCredentialsCredentialPairArgs', 'DataSourceCredentialsCredentialPairArgsDict', 'DataSourceParametersArgs', 'DataSourceParametersArgsDict', 'DataSourceParametersAmazonElasticsearchArgs', 'DataSourceParametersAmazonElasticsearchArgsDict', 'DataSourceParametersAthenaArgs', 'DataSourceParametersAthenaArgsDict', 'DataSourceParametersAuroraArgs', 'DataSourceParametersAuroraArgsDict', 'DataSourceParametersAuroraPostgresqlArgs', 'DataSourceParametersAuroraPostgresqlArgsDict', 'DataSourceParametersAwsIotAnalyticsArgs', 'DataSourceParametersAwsIotAnalyticsArgsDict', 'DataSourceParametersDatabricksArgs', 'DataSourceParametersDatabricksArgsDict', 'DataSourceParametersJiraArgs', 'DataSourceParametersJiraArgsDict', 'DataSourceParametersMariaDbArgs', 'DataSourceParametersMariaDbArgsDict', 'DataSourceParametersMysqlArgs', 'DataSourceParametersMysqlArgsDict', 'DataSourceParametersOracleArgs', 'DataSourceParametersOracleArgsDict', 'DataSourceParametersPostgresqlArgs', 'DataSourceParametersPostgresqlArgsDict', 'DataSourceParametersPrestoArgs', 'DataSourceParametersPrestoArgsDict', 'DataSourceParametersRdsArgs', 'DataSourceParametersRdsArgsDict', 'DataSourceParametersRedshiftArgs', 'DataSourceParametersRedshiftArgsDict', 'DataSourceParametersS3Args', 'DataSourceParametersS3ArgsDict', 'DataSourceParametersS3ManifestFileLocationArgs', 'DataSourceParametersS3ManifestFileLocationArgsDict', 'DataSourceParametersServiceNowArgs', 'DataSourceParametersServiceNowArgsDict', 'DataSourceParametersSnowflakeArgs', 'DataSourceParametersSnowflakeArgsDict', 'DataSourceParametersSparkArgs', 'DataSourceParametersSparkArgsDict', 'DataSourceParametersSqlServerArgs', 'DataSourceParametersSqlServerArgsDict', 'DataSourceParametersTeradataArgs', 'DataSourceParametersTeradataArgsDict', 'DataSourceParametersTwitterArgs', 'DataSourceParametersTwitterArgsDict', 'DataSourcePermissionArgs', 'DataSourcePermissionArgsDict', 'DataSourceSslPropertiesArgs', 'DataSourceSslPropertiesArgsDict', 'DataSourceVpcConnectionPropertiesArgs', 'DataSourceVpcConnectionPropertiesArgsDict', 'FolderPermissionArgs', 'FolderPermissionArgsDict', 'IamPolicyAssignmentIdentitiesArgs', 'IamPolicyAssignmentIdentitiesArgsDict', 'KeyRegistrationKeyRegistrationArgs', 'KeyRegistrationKeyRegistrationArgsDict', 'NamespaceTimeoutsArgs', 'NamespaceTimeoutsArgsDict', 'RefreshScheduleScheduleArgs', 'RefreshScheduleScheduleArgsDict', 'RefreshScheduleScheduleScheduleFrequencyArgs', 'RefreshScheduleScheduleScheduleFrequencyArgsDict', ..., ..., 'TemplatePermissionArgs', 'TemplatePermissionArgsDict', 'TemplateSourceEntityArgs', 'TemplateSourceEntityArgsDict', 'TemplateSourceEntitySourceAnalysisArgs', 'TemplateSourceEntitySourceAnalysisArgsDict', ..., ..., 'TemplateSourceEntitySourceTemplateArgs', 'TemplateSourceEntitySourceTemplateArgsDict', 'ThemeConfigurationArgs', 'ThemeConfigurationArgsDict', 'ThemeConfigurationDataColorPaletteArgs', 'ThemeConfigurationDataColorPaletteArgsDict', 'ThemeConfigurationSheetArgs', 'ThemeConfigurationSheetArgsDict', 'ThemeConfigurationSheetTileArgs', 'ThemeConfigurationSheetTileArgsDict', 'ThemeConfigurationSheetTileBorderArgs', 'ThemeConfigurationSheetTileBorderArgsDict', 'ThemeConfigurationSheetTileLayoutArgs', 'ThemeConfigurationSheetTileLayoutArgsDict', 'ThemeConfigurationSheetTileLayoutGutterArgs', 'ThemeConfigurationSheetTileLayoutGutterArgsDict', 'ThemeConfigurationSheetTileLayoutMarginArgs', 'ThemeConfigurationSheetTileLayoutMarginArgsDict', 'ThemeConfigurationTypographyArgs', 'ThemeConfigurationTypographyArgsDict', 'ThemeConfigurationTypographyFontFamilyArgs', 'ThemeConfigurationTypographyFontFamilyArgsDict', 'ThemeConfigurationUiColorPaletteArgs', 'ThemeConfigurationUiColorPaletteArgsDict', 'ThemePermissionArgs', 'ThemePermissionArgsDict', 'VpcConnectionTimeoutsArgs', 'VpcConnectionTimeoutsArgsDict']
...
class AnalysisParametersArgs:
    def __init__(__self__, *, date_time_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[AnalysisParametersDateTimeParameterArgs]]]] = ..., decimal_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[AnalysisParametersDecimalParameterArgs]]]] = ..., integer_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[AnalysisParametersIntegerParameterArgs]]]] = ..., string_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[AnalysisParametersStringParameterArgs]]]] = ...) -> None:
    ...
    def date_time_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AnalysisParametersDateTimeParameterArgs]]]]): # -> None:
        ...
    ...
    def decimal_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AnalysisParametersDecimalParameterArgs]]]]): # -> None:
        ...
    ...
    def integer_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AnalysisParametersIntegerParameterArgs]]]]): # -> None:
        ...
    ...
    def string_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AnalysisParametersStringParameterArgs]]]]): # -> None:
        ...
...
class AnalysisParametersDateTimeParameterArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], values: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
...
class AnalysisParametersDecimalParameterArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], values: pulumi.Input[Sequence[pulumi.Input[_builtins.float]]]) -> None:
    ...
    @values.setter
    def values(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.float]]]): # -> None:
        ...
...
class AnalysisParametersIntegerParameterArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], values: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]) -> None:
...
class AnalysisPermissionArgs:
    def __init__(__self__, *, actions: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], principal: pulumi.Input[_builtins.str]) -> None:
...
class AnalysisSourceEntityArgs:
    def __init__(__self__, *, source_template: Optional[pulumi.Input[AnalysisSourceEntitySourceTemplateArgs]] = ...) -> None:
    ...
    def source_template(self, value: Optional[pulumi.Input[AnalysisSourceEntitySourceTemplateArgs]]): # -> None:
        ...
...
class AnalysisSourceEntitySourceTemplateArgs:
    def __init__(__self__, *, arn: pulumi.Input[_builtins.str], data_set_references: pulumi.Input[Sequence[pulumi.Input[AnalysisSourceEntitySourceTemplateDataSetReferenceArgs]]]) -> None:
    ...
    def data_set_references(self, value: pulumi.Input[Sequence[pulumi.Input[AnalysisSourceEntitySourceTemplateDataSetReferenceArgs]]]): # -> None:
        ...
...
class AnalysisSourceEntitySourceTemplateDataSetReferenceArgs:
    def __init__(__self__, *, data_set_arn: pulumi.Input[_builtins.str], data_set_placeholder: pulumi.Input[_builtins.str]) -> None:
    ...
    @data_set_arn.setter
    def data_set_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def data_set_placeholder(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class CustomPermissionsCapabilitiesArgs:
    def __init__(__self__, *, add_or_run_anomaly_detection_for_analyses: Optional[pulumi.Input[_builtins.str]] = ..., create_and_update_dashboard_email_reports: Optional[pulumi.Input[_builtins.str]] = ..., create_and_update_data_sources: Optional[pulumi.Input[_builtins.str]] = ..., create_and_update_datasets: Optional[pulumi.Input[_builtins.str]] = ..., create_and_update_themes: Optional[pulumi.Input[_builtins.str]] = ..., create_and_update_threshold_alerts: Optional[pulumi.Input[_builtins.str]] = ..., create_shared_folders: Optional[pulumi.Input[_builtins.str]] = ..., create_spice_dataset: Optional[pulumi.Input[_builtins.str]] = ..., export_to_csv: Optional[pulumi.Input[_builtins.str]] = ..., export_to_csv_in_scheduled_reports: Optional[pulumi.Input[_builtins.str]] = ..., export_to_excel: Optional[pulumi.Input[_builtins.str]] = ..., export_to_excel_in_scheduled_reports: Optional[pulumi.Input[_builtins.str]] = ..., export_to_pdf: Optional[pulumi.Input[_builtins.str]] = ..., export_to_pdf_in_scheduled_reports: Optional[pulumi.Input[_builtins.str]] = ..., include_content_in_scheduled_reports_email: Optional[pulumi.Input[_builtins.str]] = ..., print_reports: Optional[pulumi.Input[_builtins.str]] = ..., rename_shared_folders: Optional[pulumi.Input[_builtins.str]] = ..., share_analyses: Optional[pulumi.Input[_builtins.str]] = ..., share_dashboards: Optional[pulumi.Input[_builtins.str]] = ..., share_data_sources: Optional[pulumi.Input[_builtins.str]] = ..., share_datasets: Optional[pulumi.Input[_builtins.str]] = ..., subscribe_dashboard_email_reports: Optional[pulumi.Input[_builtins.str]] = ..., view_account_spice_capacity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def add_or_run_anomaly_detection_for_analyses(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def create_and_update_dashboard_email_reports(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def create_and_update_data_sources(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def create_and_update_datasets(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def create_and_update_themes(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def create_and_update_threshold_alerts(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def create_shared_folders(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def create_spice_dataset(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def export_to_csv(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def export_to_csv_in_scheduled_reports(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def export_to_excel(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def export_to_excel_in_scheduled_reports(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def export_to_pdf(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def export_to_pdf_in_scheduled_reports(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def include_content_in_scheduled_reports_email(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def print_reports(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def rename_shared_folders(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def share_analyses(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def share_dashboards(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def share_data_sources(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def share_datasets(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def subscribe_dashboard_email_reports(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def view_account_spice_capacity(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DashboardDashboardPublishOptionsArgs:
    def __init__(__self__, *, ad_hoc_filtering_option: Optional[pulumi.Input[DashboardDashboardPublishOptionsAdHocFilteringOptionArgs]] = ..., data_point_drill_up_down_option: Optional[pulumi.Input[DashboardDashboardPublishOptionsDataPointDrillUpDownOptionArgs]] = ..., data_point_menu_label_option: Optional[pulumi.Input[DashboardDashboardPublishOptionsDataPointMenuLabelOptionArgs]] = ..., data_point_tooltip_option: Optional[pulumi.Input[DashboardDashboardPublishOptionsDataPointTooltipOptionArgs]] = ..., export_to_csv_option: Optional[pulumi.Input[DashboardDashboardPublishOptionsExportToCsvOptionArgs]] = ..., export_with_hidden_fields_option: Optional[pulumi.Input[DashboardDashboardPublishOptionsExportWithHiddenFieldsOptionArgs]] = ..., sheet_controls_option: Optional[pulumi.Input[DashboardDashboardPublishOptionsSheetControlsOptionArgs]] = ..., sheet_layout_element_maximization_option: Optional[pulumi.Input[DashboardDashboardPublishOptionsSheetLayoutElementMaximizationOptionArgs]] = ..., visual_axis_sort_option: Optional[pulumi.Input[DashboardDashboardPublishOptionsVisualAxisSortOptionArgs]] = ..., visual_menu_option: Optional[pulumi.Input[DashboardDashboardPublishOptionsVisualMenuOptionArgs]] = ...) -> None:
    ...
    def ad_hoc_filtering_option(self, value: Optional[pulumi.Input[DashboardDashboardPublishOptionsAdHocFilteringOptionArgs]]): # -> None:
        ...
    ...
    def data_point_drill_up_down_option(self, value: Optional[pulumi.Input[DashboardDashboardPublishOptionsDataPointDrillUpDownOptionArgs]]): # -> None:
        ...
    ...
    def data_point_menu_label_option(self, value: Optional[pulumi.Input[DashboardDashboardPublishOptionsDataPointMenuLabelOptionArgs]]): # -> None:
        ...
    ...
    def data_point_tooltip_option(self, value: Optional[pulumi.Input[DashboardDashboardPublishOptionsDataPointTooltipOptionArgs]]): # -> None:
        ...
    ...
    def export_to_csv_option(self, value: Optional[pulumi.Input[DashboardDashboardPublishOptionsExportToCsvOptionArgs]]): # -> None:
        ...
    ...
    def export_with_hidden_fields_option(self, value: Optional[pulumi.Input[DashboardDashboardPublishOptionsExportWithHiddenFieldsOptionArgs]]): # -> None:
        ...
    ...
    def sheet_controls_option(self, value: Optional[pulumi.Input[DashboardDashboardPublishOptionsSheetControlsOptionArgs]]): # -> None:
        ...
    ...
    def sheet_layout_element_maximization_option(self, value: Optional[pulumi.Input[DashboardDashboardPublishOptionsSheetLayoutElementMaximizationOptionArgs]]): # -> None:
        ...
    ...
    def visual_axis_sort_option(self, value: Optional[pulumi.Input[DashboardDashboardPublishOptionsVisualAxisSortOptionArgs]]): # -> None:
        ...
    ...
    def visual_menu_option(self, value: Optional[pulumi.Input[DashboardDashboardPublishOptionsVisualMenuOptionArgs]]): # -> None:
        ...
...
class DashboardDashboardPublishOptionsAdHocFilteringOptionArgs:
    def __init__(__self__, *, availability_status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def availability_status(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DashboardDashboardPublishOptionsSheetControlsOptionArgs:
    def __init__(__self__, *, visibility_state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def visibility_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DashboardParametersArgs:
    def __init__(__self__, *, date_time_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[DashboardParametersDateTimeParameterArgs]]]] = ..., decimal_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[DashboardParametersDecimalParameterArgs]]]] = ..., integer_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[DashboardParametersIntegerParameterArgs]]]] = ..., string_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[DashboardParametersStringParameterArgs]]]] = ...) -> None:
    ...
    @date_time_parameters.setter
    def date_time_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DashboardParametersDateTimeParameterArgs]]]]): # -> None:
        ...
    ...
    @decimal_parameters.setter
    def decimal_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DashboardParametersDecimalParameterArgs]]]]): # -> None:
        ...
    ...
    @integer_parameters.setter
    def integer_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DashboardParametersIntegerParameterArgs]]]]): # -> None:
        ...
    ...
    @string_parameters.setter
    def string_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DashboardParametersStringParameterArgs]]]]): # -> None:
        ...
...
class DashboardSourceEntityArgs:
    def __init__(__self__, *, source_template: Optional[pulumi.Input[DashboardSourceEntitySourceTemplateArgs]] = ...) -> None:
    ...
    @source_template.setter
    def source_template(self, value: Optional[pulumi.Input[DashboardSourceEntitySourceTemplateArgs]]): # -> None:
        ...
...
class DashboardSourceEntitySourceTemplateArgs:
    def __init__(__self__, *, arn: pulumi.Input[_builtins.str], data_set_references: pulumi.Input[Sequence[pulumi.Input[DashboardSourceEntitySourceTemplateDataSetReferenceArgs]]]) -> None:
    ...
    @data_set_references.setter
    def data_set_references(self, value: pulumi.Input[Sequence[pulumi.Input[DashboardSourceEntitySourceTemplateDataSetReferenceArgs]]]): # -> None:
        ...
...
class DataSetColumnGroupArgs:
    def __init__(__self__, *, geo_spatial_column_group: Optional[pulumi.Input[DataSetColumnGroupGeoSpatialColumnGroupArgs]] = ...) -> None:
    ...
    def geo_spatial_column_group(self, value: Optional[pulumi.Input[DataSetColumnGroupGeoSpatialColumnGroupArgs]]): # -> None:
        ...
...
class DataSetColumnGroupGeoSpatialColumnGroupArgs:
    def __init__(__self__, *, columns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], country_code: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str]) -> None:
...
class DataSetColumnLevelPermissionRuleArgs:
    def __init__(__self__, *, column_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., principals: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @column_names.setter
    def column_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DataSetDataSetUsageConfigurationArgs:
    def __init__(__self__, *, disable_use_as_direct_query_source: Optional[pulumi.Input[_builtins.bool]] = ..., disable_use_as_imported_source: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def disable_use_as_direct_query_source(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def disable_use_as_imported_source(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DataSetFieldFolderArgs:
    def __init__(__self__, *, field_folders_id: pulumi.Input[_builtins.str], columns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def field_folders_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @columns.setter
    def columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DataSetLogicalTableMapArgs:
    def __init__(__self__, *, alias: pulumi.Input[_builtins.str], logical_table_map_id: pulumi.Input[_builtins.str], source: pulumi.Input[DataSetLogicalTableMapSourceArgs], data_transforms: Optional[pulumi.Input[Sequence[pulumi.Input[DataSetLogicalTableMapDataTransformArgs]]]] = ...) -> None:
    ...
    def logical_table_map_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @source.setter
    def source(self, value: pulumi.Input[DataSetLogicalTableMapSourceArgs]): # -> None:
        ...
    ...
    def data_transforms(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataSetLogicalTableMapDataTransformArgs]]]]): # -> None:
        ...
...
class DataSetLogicalTableMapDataTransformArgs:
    def __init__(__self__, *, cast_column_type_operation: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformCastColumnTypeOperationArgs]] = ..., create_columns_operation: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformCreateColumnsOperationArgs]] = ..., filter_operation: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformFilterOperationArgs]] = ..., project_operation: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformProjectOperationArgs]] = ..., rename_column_operation: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformRenameColumnOperationArgs]] = ..., tag_column_operation: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformTagColumnOperationArgs]] = ..., untag_column_operation: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformUntagColumnOperationArgs]] = ...) -> None:
    ...
    def cast_column_type_operation(self, value: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformCastColumnTypeOperationArgs]]): # -> None:
        ...
    ...
    def create_columns_operation(self, value: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformCreateColumnsOperationArgs]]): # -> None:
        ...
    ...
    def filter_operation(self, value: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformFilterOperationArgs]]): # -> None:
        ...
    ...
    def project_operation(self, value: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformProjectOperationArgs]]): # -> None:
        ...
    ...
    def rename_column_operation(self, value: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformRenameColumnOperationArgs]]): # -> None:
        ...
    ...
    def tag_column_operation(self, value: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformTagColumnOperationArgs]]): # -> None:
        ...
    ...
    def untag_column_operation(self, value: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformUntagColumnOperationArgs]]): # -> None:
        ...
...
class DataSetLogicalTableMapDataTransformCastColumnTypeOperationArgs:
    def __init__(__self__, *, column_name: pulumi.Input[_builtins.str], new_column_type: pulumi.Input[_builtins.str], format: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def new_column_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DataSetLogicalTableMapDataTransformCreateColumnsOperationArgs:
    def __init__(__self__, *, columns: pulumi.Input[Sequence[pulumi.Input[DataSetLogicalTableMapDataTransformCreateColumnsOperationColumnArgs]]]) -> None:
    ...
    @columns.setter
    def columns(self, value: pulumi.Input[Sequence[pulumi.Input[DataSetLogicalTableMapDataTransformCreateColumnsOperationColumnArgs]]]): # -> None:
        ...
...
class DataSetLogicalTableMapDataTransformCreateColumnsOperationColumnArgs:
    def __init__(__self__, *, column_id: pulumi.Input[_builtins.str], column_name: pulumi.Input[_builtins.str], expression: pulumi.Input[_builtins.str]) -> None:
    ...
    @column_id.setter
    def column_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DataSetLogicalTableMapDataTransformFilterOperationArgs:
    def __init__(__self__, *, condition_expression: pulumi.Input[_builtins.str]) -> None:
...
class DataSetLogicalTableMapDataTransformProjectOperationArgs:
    def __init__(__self__, *, projected_columns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def projected_columns(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class DataSetLogicalTableMapDataTransformRenameColumnOperationArgs:
    def __init__(__self__, *, column_name: pulumi.Input[_builtins.str], new_column_name: pulumi.Input[_builtins.str]) -> None:
...
class DataSetLogicalTableMapDataTransformTagColumnOperationArgs:
    def __init__(__self__, *, column_name: pulumi.Input[_builtins.str], tags: pulumi.Input[Sequence[pulumi.Input[DataSetLogicalTableMapDataTransformTagColumnOperationTagArgs]]]) -> None:
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Sequence[pulumi.Input[DataSetLogicalTableMapDataTransformTagColumnOperationTagArgs]]]): # -> None:
        ...
...
class DataSetLogicalTableMapDataTransformTagColumnOperationTagArgs:
    def __init__(__self__, *, column_description: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformTagColumnOperationTagColumnDescriptionArgs]] = ..., column_geographic_role: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def column_description(self, value: Optional[pulumi.Input[DataSetLogicalTableMapDataTransformTagColumnOperationTagColumnDescriptionArgs]]): # -> None:
        ...
    ...
    def column_geographic_role(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataSetLogicalTableMapDataTransformUntagColumnOperationArgs:
    def __init__(__self__, *, column_name: pulumi.Input[_builtins.str], tag_names: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @tag_names.setter
    def tag_names(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class DataSetLogicalTableMapSourceArgs:
    def __init__(__self__, *, data_set_arn: Optional[pulumi.Input[_builtins.str]] = ..., join_instruction: Optional[pulumi.Input[DataSetLogicalTableMapSourceJoinInstructionArgs]] = ..., physical_table_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_set_arn.setter
    def data_set_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def join_instruction(self, value: Optional[pulumi.Input[DataSetLogicalTableMapSourceJoinInstructionArgs]]): # -> None:
        ...
    ...
    def physical_table_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataSetLogicalTableMapSourceJoinInstructionArgs:
    def __init__(__self__, *, left_operand: pulumi.Input[_builtins.str], on_clause: pulumi.Input[_builtins.str], right_operand: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], left_join_key_properties: Optional[pulumi.Input[DataSetLogicalTableMapSourceJoinInstructionLeftJoinKeyPropertiesArgs]] = ..., right_join_key_properties: Optional[pulumi.Input[DataSetLogicalTableMapSourceJoinInstructionRightJoinKeyPropertiesArgs]] = ...) -> None:
    ...
    @left_operand.setter
    def left_operand(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @on_clause.setter
    def on_clause(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def right_operand(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def left_join_key_properties(self, value: Optional[pulumi.Input[DataSetLogicalTableMapSourceJoinInstructionLeftJoinKeyPropertiesArgs]]): # -> None:
        ...
    ...
    def right_join_key_properties(self, value: Optional[pulumi.Input[DataSetLogicalTableMapSourceJoinInstructionRightJoinKeyPropertiesArgs]]): # -> None:
        ...
...
class DataSetLogicalTableMapSourceJoinInstructionLeftJoinKeyPropertiesArgs:
    def __init__(__self__, *, unique_key: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @unique_key.setter
    def unique_key(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DataSetOutputColumnArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DataSetPhysicalTableMapArgs:
    def __init__(__self__, *, physical_table_map_id: pulumi.Input[_builtins.str], custom_sql: Optional[pulumi.Input[DataSetPhysicalTableMapCustomSqlArgs]] = ..., relational_table: Optional[pulumi.Input[DataSetPhysicalTableMapRelationalTableArgs]] = ..., s3_source: Optional[pulumi.Input[DataSetPhysicalTableMapS3SourceArgs]] = ...) -> None:
    ...
    def physical_table_map_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @custom_sql.setter
    def custom_sql(self, value: Optional[pulumi.Input[DataSetPhysicalTableMapCustomSqlArgs]]): # -> None:
        ...
    ...
    def relational_table(self, value: Optional[pulumi.Input[DataSetPhysicalTableMapRelationalTableArgs]]): # -> None:
        ...
    ...
    @s3_source.setter
    def s3_source(self, value: Optional[pulumi.Input[DataSetPhysicalTableMapS3SourceArgs]]): # -> None:
        ...
...
class DataSetPhysicalTableMapCustomSqlArgs:
    def __init__(__self__, *, data_source_arn: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], sql_query: pulumi.Input[_builtins.str], columns: Optional[pulumi.Input[Sequence[pulumi.Input[DataSetPhysicalTableMapCustomSqlColumnArgs]]]] = ...) -> None:
    ...
    def data_source_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @sql_query.setter
    def sql_query(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @columns.setter
    def columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataSetPhysicalTableMapCustomSqlColumnArgs]]]]): # -> None:
        ...
...
class DataSetPhysicalTableMapRelationalTableArgs:
    def __init__(__self__, *, data_source_arn: pulumi.Input[_builtins.str], input_columns: pulumi.Input[Sequence[pulumi.Input[DataSetPhysicalTableMapRelationalTableInputColumnArgs]]], name: pulumi.Input[_builtins.str], catalog: Optional[pulumi.Input[_builtins.str]] = ..., schema: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def input_columns(self, value: pulumi.Input[Sequence[pulumi.Input[DataSetPhysicalTableMapRelationalTableInputColumnArgs]]]): # -> None:
        ...
...
class DataSetPhysicalTableMapS3SourceArgs:
    def __init__(__self__, *, data_source_arn: pulumi.Input[_builtins.str], input_columns: pulumi.Input[Sequence[pulumi.Input[DataSetPhysicalTableMapS3SourceInputColumnArgs]]], upload_settings: pulumi.Input[DataSetPhysicalTableMapS3SourceUploadSettingsArgs]) -> None:
    ...
    @input_columns.setter
    def input_columns(self, value: pulumi.Input[Sequence[pulumi.Input[DataSetPhysicalTableMapS3SourceInputColumnArgs]]]): # -> None:
        ...
    ...
    def upload_settings(self, value: pulumi.Input[DataSetPhysicalTableMapS3SourceUploadSettingsArgs]): # -> None:
        ...
...
class DataSetPhysicalTableMapS3SourceUploadSettingsArgs:
    def __init__(__self__, *, contains_header: Optional[pulumi.Input[_builtins.bool]] = ..., delimiter: Optional[pulumi.Input[_builtins.str]] = ..., format: Optional[pulumi.Input[_builtins.str]] = ..., start_from_row: Optional[pulumi.Input[_builtins.int]] = ..., text_qualifier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def contains_header(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def start_from_row(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def text_qualifier(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataSetRefreshPropertiesArgs:
    def __init__(__self__, *, refresh_configuration: pulumi.Input[DataSetRefreshPropertiesRefreshConfigurationArgs]) -> None:
    ...
    def refresh_configuration(self, value: pulumi.Input[DataSetRefreshPropertiesRefreshConfigurationArgs]): # -> None:
        ...
...
class DataSetRefreshPropertiesRefreshConfigurationArgs:
    def __init__(__self__, *, incremental_refresh: pulumi.Input[DataSetRefreshPropertiesRefreshConfigurationIncrementalRefreshArgs]) -> None:
    ...
    def incremental_refresh(self, value: pulumi.Input[DataSetRefreshPropertiesRefreshConfigurationIncrementalRefreshArgs]): # -> None:
        ...
...
class DataSetRefreshPropertiesRefreshConfigurationIncrementalRefreshArgs:
    def __init__(__self__, *, lookback_window: pulumi.Input[DataSetRefreshPropertiesRefreshConfigurationIncrementalRefreshLookbackWindowArgs]) -> None:
    ...
    def lookback_window(self, value: pulumi.Input[DataSetRefreshPropertiesRefreshConfigurationIncrementalRefreshLookbackWindowArgs]): # -> None:
        ...
...
class DataSetRefreshPropertiesRefreshConfigurationIncrementalRefreshLookbackWindowArgs:
    def __init__(__self__, *, column_name: pulumi.Input[_builtins.str], size: pulumi.Input[_builtins.int], size_unit: pulumi.Input[_builtins.str]) -> None:
    ...
    @size_unit.setter
    def size_unit(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DataSetRowLevelPermissionDataSetArgs:
    def __init__(__self__, *, arn: pulumi.Input[_builtins.str], permission_policy: pulumi.Input[_builtins.str], format_version: Optional[pulumi.Input[_builtins.str]] = ..., namespace: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def permission_policy(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DataSetRowLevelPermissionTagConfigurationArgs:
    def __init__(__self__, *, tag_rules: pulumi.Input[Sequence[pulumi.Input[DataSetRowLevelPermissionTagConfigurationTagRuleArgs]]], status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @tag_rules.setter
    def tag_rules(self, value: pulumi.Input[Sequence[pulumi.Input[DataSetRowLevelPermissionTagConfigurationTagRuleArgs]]]): # -> None:
        ...
...
class DataSetRowLevelPermissionTagConfigurationTagRuleArgs:
    def __init__(__self__, *, column_name: pulumi.Input[_builtins.str], tag_key: pulumi.Input[_builtins.str], match_all_value: Optional[pulumi.Input[_builtins.str]] = ..., tag_multi_value_delimiter: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def match_all_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def tag_multi_value_delimiter(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataSourceCredentialsArgs:
    def __init__(__self__, *, copy_source_arn: Optional[pulumi.Input[_builtins.str]] = ..., credential_pair: Optional[pulumi.Input[DataSourceCredentialsCredentialPairArgs]] = ..., secret_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def copy_source_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def credential_pair(self, value: Optional[pulumi.Input[DataSourceCredentialsCredentialPairArgs]]): # -> None:
        ...
...
class DataSourceParametersArgs:
    def __init__(__self__, *, amazon_elasticsearch: Optional[pulumi.Input[DataSourceParametersAmazonElasticsearchArgs]] = ..., athena: Optional[pulumi.Input[DataSourceParametersAthenaArgs]] = ..., aurora: Optional[pulumi.Input[DataSourceParametersAuroraArgs]] = ..., aurora_postgresql: Optional[pulumi.Input[DataSourceParametersAuroraPostgresqlArgs]] = ..., aws_iot_analytics: Optional[pulumi.Input[DataSourceParametersAwsIotAnalyticsArgs]] = ..., databricks: Optional[pulumi.Input[DataSourceParametersDatabricksArgs]] = ..., jira: Optional[pulumi.Input[DataSourceParametersJiraArgs]] = ..., maria_db: Optional[pulumi.Input[DataSourceParametersMariaDbArgs]] = ..., mysql: Optional[pulumi.Input[DataSourceParametersMysqlArgs]] = ..., oracle: Optional[pulumi.Input[DataSourceParametersOracleArgs]] = ..., postgresql: Optional[pulumi.Input[DataSourceParametersPostgresqlArgs]] = ..., presto: Optional[pulumi.Input[DataSourceParametersPrestoArgs]] = ..., rds: Optional[pulumi.Input[DataSourceParametersRdsArgs]] = ..., redshift: Optional[pulumi.Input[DataSourceParametersRedshiftArgs]] = ..., s3: Optional[pulumi.Input[DataSourceParametersS3Args]] = ..., service_now: Optional[pulumi.Input[DataSourceParametersServiceNowArgs]] = ..., snowflake: Optional[pulumi.Input[DataSourceParametersSnowflakeArgs]] = ..., spark: Optional[pulumi.Input[DataSourceParametersSparkArgs]] = ..., sql_server: Optional[pulumi.Input[DataSourceParametersSqlServerArgs]] = ..., teradata: Optional[pulumi.Input[DataSourceParametersTeradataArgs]] = ..., twitter: Optional[pulumi.Input[DataSourceParametersTwitterArgs]] = ...) -> None:
    ...
    def amazon_elasticsearch(self, value: Optional[pulumi.Input[DataSourceParametersAmazonElasticsearchArgs]]): # -> None:
        ...
    ...
    @athena.setter
    def athena(self, value: Optional[pulumi.Input[DataSourceParametersAthenaArgs]]): # -> None:
        ...
    ...
    @aurora.setter
    def aurora(self, value: Optional[pulumi.Input[DataSourceParametersAuroraArgs]]): # -> None:
        ...
    ...
    def aurora_postgresql(self, value: Optional[pulumi.Input[DataSourceParametersAuroraPostgresqlArgs]]): # -> None:
        ...
    ...
    def aws_iot_analytics(self, value: Optional[pulumi.Input[DataSourceParametersAwsIotAnalyticsArgs]]): # -> None:
        ...
    ...
    @databricks.setter
    def databricks(self, value: Optional[pulumi.Input[DataSourceParametersDatabricksArgs]]): # -> None:
        ...
    ...
    @jira.setter
    def jira(self, value: Optional[pulumi.Input[DataSourceParametersJiraArgs]]): # -> None:
        ...
    ...
    @maria_db.setter
    def maria_db(self, value: Optional[pulumi.Input[DataSourceParametersMariaDbArgs]]): # -> None:
        ...
    ...
    @mysql.setter
    def mysql(self, value: Optional[pulumi.Input[DataSourceParametersMysqlArgs]]): # -> None:
        ...
    ...
    @oracle.setter
    def oracle(self, value: Optional[pulumi.Input[DataSourceParametersOracleArgs]]): # -> None:
        ...
    ...
    @postgresql.setter
    def postgresql(self, value: Optional[pulumi.Input[DataSourceParametersPostgresqlArgs]]): # -> None:
        ...
    ...
    @presto.setter
    def presto(self, value: Optional[pulumi.Input[DataSourceParametersPrestoArgs]]): # -> None:
        ...
    ...
    @rds.setter
    def rds(self, value: Optional[pulumi.Input[DataSourceParametersRdsArgs]]): # -> None:
        ...
    ...
    @redshift.setter
    def redshift(self, value: Optional[pulumi.Input[DataSourceParametersRedshiftArgs]]): # -> None:
        ...
    ...
    @s3.setter
    def s3(self, value: Optional[pulumi.Input[DataSourceParametersS3Args]]): # -> None:
        ...
    ...
    @service_now.setter
    def service_now(self, value: Optional[pulumi.Input[DataSourceParametersServiceNowArgs]]): # -> None:
        ...
    ...
    @snowflake.setter
    def snowflake(self, value: Optional[pulumi.Input[DataSourceParametersSnowflakeArgs]]): # -> None:
        ...
    ...
    @spark.setter
    def spark(self, value: Optional[pulumi.Input[DataSourceParametersSparkArgs]]): # -> None:
        ...
    ...
    @sql_server.setter
    def sql_server(self, value: Optional[pulumi.Input[DataSourceParametersSqlServerArgs]]): # -> None:
        ...
    ...
    @teradata.setter
    def teradata(self, value: Optional[pulumi.Input[DataSourceParametersTeradataArgs]]): # -> None:
        ...
    ...
    @twitter.setter
    def twitter(self, value: Optional[pulumi.Input[DataSourceParametersTwitterArgs]]): # -> None:
        ...
...
class DataSourceParametersAthenaArgs:
    def __init__(__self__, *, work_group: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @work_group.setter
    def work_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataSourceParametersAuroraArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], host: pulumi.Input[_builtins.str], port: pulumi.Input[_builtins.int]) -> None:
...
class DataSourceParametersAwsIotAnalyticsArgs:
    ...
    def data_set_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DataSourceParametersDatabricksArgs:
    def __init__(__self__, *, host: pulumi.Input[_builtins.str], port: pulumi.Input[_builtins.int], sql_endpoint_path: pulumi.Input[_builtins.str]) -> None:
    ...
    def sql_endpoint_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DataSourceParametersJiraArgs:
    ...
    def site_base_url(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DataSourceParametersPrestoArgs:
    def __init__(__self__, *, catalog: pulumi.Input[_builtins.str], host: pulumi.Input[_builtins.str], port: pulumi.Input[_builtins.int]) -> None:
...
class DataSourceParametersRdsArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], instance_id: pulumi.Input[_builtins.str]) -> None:
...
class DataSourceParametersRedshiftArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], cluster_id: Optional[pulumi.Input[_builtins.str]] = ..., host: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class DataSourceParametersS3Args:
    def __init__(__self__, *, manifest_file_location: pulumi.Input[DataSourceParametersS3ManifestFileLocationArgs], role_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def manifest_file_location(self, value: pulumi.Input[DataSourceParametersS3ManifestFileLocationArgs]): # -> None:
        ...
...
class DataSourceParametersS3ManifestFileLocationArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], key: pulumi.Input[_builtins.str]) -> None:
...
class DataSourceParametersSnowflakeArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], host: pulumi.Input[_builtins.str], warehouse: pulumi.Input[_builtins.str]) -> None:
...
class DataSourceParametersSparkArgs:
    def __init__(__self__, *, host: pulumi.Input[_builtins.str], port: pulumi.Input[_builtins.int]) -> None:
...
class DataSourceParametersTwitterArgs:
    def __init__(__self__, *, max_rows: pulumi.Input[_builtins.int], query: pulumi.Input[_builtins.str]) -> None:
    ...
    @max_rows.setter
    def max_rows(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class DataSourceSslPropertiesArgs:
    ...
    @disable_ssl.setter
    def disable_ssl(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class DataSourceVpcConnectionPropertiesArgs:
    def __init__(__self__, *, vpc_connection_arn: pulumi.Input[_builtins.str]) -> None:
    ...
    def vpc_connection_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class IamPolicyAssignmentIdentitiesArgs:
    def __init__(__self__, *, groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., users: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class KeyRegistrationKeyRegistrationArgs:
    def __init__(__self__, *, key_arn: pulumi.Input[_builtins.str], default_key: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @key_arn.setter
    def key_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @default_key.setter
    def default_key(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class RefreshScheduleScheduleArgs:
    def __init__(__self__, *, refresh_type: pulumi.Input[_builtins.str], schedule_frequency: pulumi.Input[RefreshScheduleScheduleScheduleFrequencyArgs], start_after_date_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @refresh_type.setter
    def refresh_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def schedule_frequency(self, value: pulumi.Input[RefreshScheduleScheduleScheduleFrequencyArgs]): # -> None:
        ...
    ...
    def start_after_date_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RefreshScheduleScheduleScheduleFrequencyArgs:
    def __init__(__self__, *, interval: pulumi.Input[_builtins.str], refresh_on_day: Optional[pulumi.Input[RefreshScheduleScheduleScheduleFrequencyRefreshOnDayArgs]] = ..., time_of_the_day: Optional[pulumi.Input[_builtins.str]] = ..., timezone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def refresh_on_day(self, value: Optional[pulumi.Input[RefreshScheduleScheduleScheduleFrequencyRefreshOnDayArgs]]): # -> None:
        ...
    ...
    def time_of_the_day(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RefreshScheduleScheduleScheduleFrequencyRefreshOnDayArgs:
    def __init__(__self__, *, day_of_month: Optional[pulumi.Input[_builtins.str]] = ..., day_of_week: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @day_of_month.setter
    def day_of_month(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @day_of_week.setter
    def day_of_week(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TemplateSourceEntityArgs:
    def __init__(__self__, *, source_analysis: Optional[pulumi.Input[TemplateSourceEntitySourceAnalysisArgs]] = ..., source_template: Optional[pulumi.Input[TemplateSourceEntitySourceTemplateArgs]] = ...) -> None:
    ...
    def source_analysis(self, value: Optional[pulumi.Input[TemplateSourceEntitySourceAnalysisArgs]]): # -> None:
        ...
    ...
    @source_template.setter
    def source_template(self, value: Optional[pulumi.Input[TemplateSourceEntitySourceTemplateArgs]]): # -> None:
        ...
...
class TemplateSourceEntitySourceAnalysisArgs:
    def __init__(__self__, *, arn: pulumi.Input[_builtins.str], data_set_references: pulumi.Input[Sequence[pulumi.Input[TemplateSourceEntitySourceAnalysisDataSetReferenceArgs]]]) -> None:
    ...
    @data_set_references.setter
    def data_set_references(self, value: pulumi.Input[Sequence[pulumi.Input[TemplateSourceEntitySourceAnalysisDataSetReferenceArgs]]]): # -> None:
        ...
...
class ThemeConfigurationArgs:
    def __init__(__self__, *, data_color_palette: Optional[pulumi.Input[ThemeConfigurationDataColorPaletteArgs]] = ..., sheet: Optional[pulumi.Input[ThemeConfigurationSheetArgs]] = ..., typography: Optional[pulumi.Input[ThemeConfigurationTypographyArgs]] = ..., ui_color_palette: Optional[pulumi.Input[ThemeConfigurationUiColorPaletteArgs]] = ...) -> None:
    ...
    def data_color_palette(self, value: Optional[pulumi.Input[ThemeConfigurationDataColorPaletteArgs]]): # -> None:
        ...
    ...
    @sheet.setter
    def sheet(self, value: Optional[pulumi.Input[ThemeConfigurationSheetArgs]]): # -> None:
        ...
    ...
    @typography.setter
    def typography(self, value: Optional[pulumi.Input[ThemeConfigurationTypographyArgs]]): # -> None:
        ...
    ...
    def ui_color_palette(self, value: Optional[pulumi.Input[ThemeConfigurationUiColorPaletteArgs]]): # -> None:
        ...
...
class ThemeConfigurationDataColorPaletteArgs:
    def __init__(__self__, *, colors: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., empty_fill_color: Optional[pulumi.Input[_builtins.str]] = ..., min_max_gradients: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @colors.setter
    def colors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def empty_fill_color(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def min_max_gradients(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ThemeConfigurationSheetArgs:
    def __init__(__self__, *, tile: Optional[pulumi.Input[ThemeConfigurationSheetTileArgs]] = ..., tile_layout: Optional[pulumi.Input[ThemeConfigurationSheetTileLayoutArgs]] = ...) -> None:
    ...
    @tile.setter
    def tile(self, value: Optional[pulumi.Input[ThemeConfigurationSheetTileArgs]]): # -> None:
        ...
    ...
    @tile_layout.setter
    def tile_layout(self, value: Optional[pulumi.Input[ThemeConfigurationSheetTileLayoutArgs]]): # -> None:
        ...
...
class ThemeConfigurationSheetTileArgs:
    def __init__(__self__, *, border: Optional[pulumi.Input[ThemeConfigurationSheetTileBorderArgs]] = ...) -> None:
    ...
    @border.setter
    def border(self, value: Optional[pulumi.Input[ThemeConfigurationSheetTileBorderArgs]]): # -> None:
        ...
...
class ThemeConfigurationSheetTileBorderArgs:
    def __init__(__self__, *, show: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @show.setter
    def show(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ThemeConfigurationSheetTileLayoutArgs:
    def __init__(__self__, *, gutter: Optional[pulumi.Input[ThemeConfigurationSheetTileLayoutGutterArgs]] = ..., margin: Optional[pulumi.Input[ThemeConfigurationSheetTileLayoutMarginArgs]] = ...) -> None:
    ...
    @gutter.setter
    def gutter(self, value: Optional[pulumi.Input[ThemeConfigurationSheetTileLayoutGutterArgs]]): # -> None:
        ...
    ...
    @margin.setter
    def margin(self, value: Optional[pulumi.Input[ThemeConfigurationSheetTileLayoutMarginArgs]]): # -> None:
        ...
...
class ThemeConfigurationTypographyArgs:
    def __init__(__self__, *, font_families: Optional[pulumi.Input[Sequence[pulumi.Input[ThemeConfigurationTypographyFontFamilyArgs]]]] = ...) -> None:
    ...
    def font_families(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ThemeConfigurationTypographyFontFamilyArgs]]]]): # -> None:
        ...
...
class ThemeConfigurationTypographyFontFamilyArgs:
    def __init__(__self__, *, font_family: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ThemeConfigurationUiColorPaletteArgs:
    def __init__(__self__, *, accent: Optional[pulumi.Input[_builtins.str]] = ..., accent_foreground: Optional[pulumi.Input[_builtins.str]] = ..., danger: Optional[pulumi.Input[_builtins.str]] = ..., danger_foreground: Optional[pulumi.Input[_builtins.str]] = ..., dimension: Optional[pulumi.Input[_builtins.str]] = ..., dimension_foreground: Optional[pulumi.Input[_builtins.str]] = ..., measure: Optional[pulumi.Input[_builtins.str]] = ..., measure_foreground: Optional[pulumi.Input[_builtins.str]] = ..., primary_background: Optional[pulumi.Input[_builtins.str]] = ..., primary_foreground: Optional[pulumi.Input[_builtins.str]] = ..., secondary_background: Optional[pulumi.Input[_builtins.str]] = ..., secondary_foreground: Optional[pulumi.Input[_builtins.str]] = ..., success: Optional[pulumi.Input[_builtins.str]] = ..., success_foreground: Optional[pulumi.Input[_builtins.str]] = ..., warning: Optional[pulumi.Input[_builtins.str]] = ..., warning_foreground: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @accent.setter
    def accent(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def accent_foreground(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @danger.setter
    def danger(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def danger_foreground(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def dimension_foreground(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @measure.setter
    def measure(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def measure_foreground(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def primary_background(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def primary_foreground(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def secondary_background(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def secondary_foreground(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @success.setter
    def success(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def success_foreground(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @warning.setter
    def warning(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def warning_foreground(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
