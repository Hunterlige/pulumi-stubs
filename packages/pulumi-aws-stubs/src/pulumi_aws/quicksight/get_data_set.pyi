...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetDataSetResult', 'AwaitableGetDataSetResult', 'get_data_set', 'get_data_set_output']
@pulumi.output_type
class GetDataSetResult:
    
    def __init__(__self__, arn=..., aws_account_id=..., column_groups=..., column_level_permission_rules=..., data_set_id=..., data_set_usage_configurations=..., field_folders=..., id=..., import_mode=..., logical_table_maps=..., name=..., permissions=..., physical_table_maps=..., region=..., row_level_permission_data_sets=..., row_level_permission_tag_configurations=..., tags=...) -> None:
        ...
...
def get_data_set(aws_account_id: Optional[_builtins.str] = ..., data_set_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetDataSetResult:
    
    ...

def get_data_set_output(aws_account_id: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., data_set_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetDataSetResult]:
