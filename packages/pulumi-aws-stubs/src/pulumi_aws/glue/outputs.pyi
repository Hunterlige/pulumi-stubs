...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CatalogDatabaseCreateTableDefaultPermission', ..., 'CatalogDatabaseFederatedDatabase', 'CatalogDatabaseTargetDatabase', 'CatalogTableOpenTableFormatInput', 'CatalogTableOpenTableFormatInputIcebergInput', ..., ..., ..., ..., ..., ..., ..., 'CatalogTableOptimizerConfiguration', ..., ..., ..., ..., 'CatalogTablePartitionIndex', 'CatalogTablePartitionKey', 'CatalogTableStorageDescriptor', 'CatalogTableStorageDescriptorColumn', 'CatalogTableStorageDescriptorSchemaReference', ..., 'CatalogTableStorageDescriptorSerDeInfo', 'CatalogTableStorageDescriptorSkewedInfo', 'CatalogTableStorageDescriptorSortColumn', 'CatalogTableTargetTable', 'CatalogTableViewDefinition', 'CatalogTableViewDefinitionRepresentation', 'ClassifierCsvClassifier', 'ClassifierGrokClassifier', 'ClassifierJsonClassifier', 'ClassifierXmlClassifier', 'ConnectionPhysicalConnectionRequirements', 'CrawlerCatalogTarget', 'CrawlerDeltaTarget', 'CrawlerDynamodbTarget', 'CrawlerHudiTarget', 'CrawlerIcebergTarget', 'CrawlerJdbcTarget', 'CrawlerLakeFormationConfiguration', 'CrawlerLineageConfiguration', 'CrawlerMongodbTarget', 'CrawlerRecrawlPolicy', 'CrawlerS3Target', 'CrawlerSchemaChangePolicy', ..., ..., ..., 'DataQualityRulesetTargetTable', 'JobCommand', 'JobExecutionProperty', 'JobNotificationProperty', 'JobSourceControlDetails', 'MLTransformInputRecordTable', 'MLTransformParameters', 'MLTransformParametersFindMatchesParameters', 'MLTransformSchema', 'PartitionIndexPartitionIndex', 'PartitionStorageDescriptor', 'PartitionStorageDescriptorColumn', 'PartitionStorageDescriptorSerDeInfo', 'PartitionStorageDescriptorSkewedInfo', 'PartitionStorageDescriptorSortColumn', 'SecurityConfigurationEncryptionConfiguration', ..., ..., ..., 'TriggerAction', 'TriggerActionNotificationProperty', 'TriggerEventBatchingCondition', 'TriggerPredicate', 'TriggerPredicateCondition', 'UserDefinedFunctionResourceUri', 'GetCatalogTablePartitionIndexResult', 'GetCatalogTablePartitionKeyResult', 'GetCatalogTableStorageDescriptorResult', 'GetCatalogTableStorageDescriptorColumnResult', ..., ..., 'GetCatalogTableStorageDescriptorSerDeInfoResult', 'GetCatalogTableStorageDescriptorSkewedInfoResult', 'GetCatalogTableStorageDescriptorSortColumnResult', 'GetCatalogTableTargetTableResult', 'GetConnectionPhysicalConnectionRequirementResult', ..., ..., ..., 'GetScriptDagEdgeResult', 'GetScriptDagNodeResult', 'GetScriptDagNodeArgResult']
@pulumi.output_type
class CatalogDatabaseCreateTableDefaultPermission(dict):
    def __init__(__self__, *, permissions: Optional[Sequence[_builtins.str]] = ..., principal: Optional[outputs.CatalogDatabaseCreateTableDefaultPermissionPrincipal] = ...) -> None:
...
class CatalogDatabaseCreateTableDefaultPermissionPrincipal(dict):
    ...
    def __init__(__self__, *, data_lake_principal_identifier: Optional[_builtins.str] = ...) -> None:
...
class CatalogDatabaseFederatedDatabase(dict):
    ...
    def __init__(__self__, *, connection_name: Optional[_builtins.str] = ..., identifier: Optional[_builtins.str] = ...) -> None:
...
class CatalogDatabaseTargetDatabase(dict):
    ...
    def __init__(__self__, *, catalog_id: _builtins.str, database_name: _builtins.str, region: Optional[_builtins.str] = ...) -> None:
...
class CatalogTableOpenTableFormatInput(dict):
    ...
    def __init__(__self__, *, iceberg_input: outputs.CatalogTableOpenTableFormatInputIcebergInput) -> None:
...
class CatalogTableOpenTableFormatInputIcebergInput(dict):
    ...
    def __init__(__self__, *, metadata_operation: _builtins.str, iceberg_table_input: Optional[outputs.CatalogTableOpenTableFormatInputIcebergInputIcebergTableInput] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class CatalogTableOpenTableFormatInputIcebergInputIcebergTableInput(dict):
    ...
    def __init__(__self__, *, location: _builtins.str, schema: outputs.CatalogTableOpenTableFormatInputIcebergInputIcebergTableInputSchema, partition_spec: Optional[outputs.CatalogTableOpenTableFormatInputIcebergInputIcebergTableInputPartitionSpec] = ..., properties: Optional[Mapping[str, _builtins.str]] = ..., sort_order: Optional[outputs.CatalogTableOpenTableFormatInputIcebergInputIcebergTableInputSortOrder] = ...) -> None:
...
class CatalogTableOpenTableFormatInputIcebergInputIcebergTableInputPartitionSpec(dict):
    ...
    def __init__(__self__, *, fields: Sequence[outputs.CatalogTableOpenTableFormatInputIcebergInputIcebergTableInputPartitionSpecField], spec_id: Optional[_builtins.int] = ...) -> None:
...
class CatalogTableOpenTableFormatInputIcebergInputIcebergTableInputSchema(dict):
    ...
    def __init__(__self__, *, fields: Sequence[outputs.CatalogTableOpenTableFormatInputIcebergInputIcebergTableInputSchemaField], identifier_field_ids: Optional[Sequence[_builtins.int]] = ..., schema_id: Optional[_builtins.int] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class CatalogTableOpenTableFormatInputIcebergInputIcebergTableInputSchemaField(dict):
    ...
    def __init__(__self__, *, id: _builtins.int, name: _builtins.str, required: _builtins.bool, type: _builtins.str, doc: Optional[_builtins.str] = ..., initial_default: Optional[_builtins.str] = ..., write_default: Optional[_builtins.str] = ...) -> None:
...
class CatalogTableOpenTableFormatInputIcebergInputIcebergTableInputSortOrder(dict):
    ...
    def __init__(__self__, *, fields: Sequence[outputs.CatalogTableOpenTableFormatInputIcebergInputIcebergTableInputSortOrderField], order_id: _builtins.int) -> None:
...
class CatalogTableOpenTableFormatInputIcebergInputIcebergTableInputSortOrderField(dict):
    ...
    def __init__(__self__, *, direction: _builtins.str, null_order: _builtins.str, source_id: _builtins.int, transform: _builtins.str) -> None:
...
class CatalogTableOptimizerConfiguration(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, role_arn: _builtins.str, orphan_file_deletion_configuration: Optional[outputs.CatalogTableOptimizerConfigurationOrphanFileDeletionConfiguration] = ..., retention_configuration: Optional[outputs.CatalogTableOptimizerConfigurationRetentionConfiguration] = ...) -> None:
...
class CatalogTableOptimizerConfigurationOrphanFileDeletionConfiguration(dict):
    ...
    def __init__(__self__, *, iceberg_configuration: Optional[outputs.CatalogTableOptimizerConfigurationOrphanFileDeletionConfigurationIcebergConfiguration] = ...) -> None:
...
class CatalogTableOptimizerConfigurationOrphanFileDeletionConfigurationIcebergConfiguration(dict):
    ...
    def __init__(__self__, *, location: Optional[_builtins.str] = ..., orphan_file_retention_period_in_days: Optional[_builtins.int] = ..., run_rate_in_hours: Optional[_builtins.int] = ...) -> None:
...
class CatalogTableOptimizerConfigurationRetentionConfiguration(dict):
    ...
    def __init__(__self__, *, iceberg_configuration: Optional[outputs.CatalogTableOptimizerConfigurationRetentionConfigurationIcebergConfiguration] = ...) -> None:
...
class CatalogTableOptimizerConfigurationRetentionConfigurationIcebergConfiguration(dict):
    ...
    def __init__(__self__, *, clean_expired_files: Optional[_builtins.bool] = ..., number_of_snapshots_to_retain: Optional[_builtins.int] = ..., run_rate_in_hours: Optional[_builtins.int] = ..., snapshot_retention_period_in_days: Optional[_builtins.int] = ...) -> None:
...
class CatalogTablePartitionIndex(dict):
    ...
    def __init__(__self__, *, index_name: _builtins.str, keys: Sequence[_builtins.str], index_status: Optional[_builtins.str] = ...) -> None:
...
class CatalogTablePartitionKey(dict):
    def __init__(__self__, *, name: _builtins.str, comment: Optional[_builtins.str] = ..., parameters: Optional[Mapping[str, _builtins.str]] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class CatalogTableStorageDescriptor(dict):
    ...
    def __init__(__self__, *, additional_locations: Optional[Sequence[_builtins.str]] = ..., bucket_columns: Optional[Sequence[_builtins.str]] = ..., columns: Optional[Sequence[outputs.CatalogTableStorageDescriptorColumn]] = ..., compressed: Optional[_builtins.bool] = ..., input_format: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., number_of_buckets: Optional[_builtins.int] = ..., output_format: Optional[_builtins.str] = ..., parameters: Optional[Mapping[str, _builtins.str]] = ..., schema_reference: Optional[outputs.CatalogTableStorageDescriptorSchemaReference] = ..., ser_de_info: Optional[outputs.CatalogTableStorageDescriptorSerDeInfo] = ..., skewed_info: Optional[outputs.CatalogTableStorageDescriptorSkewedInfo] = ..., sort_columns: Optional[Sequence[outputs.CatalogTableStorageDescriptorSortColumn]] = ..., stored_as_sub_directories: Optional[_builtins.bool] = ...) -> None:
...
class CatalogTableStorageDescriptorSchemaReference(dict):
    ...
    def __init__(__self__, *, schema_version_number: _builtins.int, schema_id: Optional[outputs.CatalogTableStorageDescriptorSchemaReferenceSchemaId] = ..., schema_version_id: Optional[_builtins.str] = ...) -> None:
...
class CatalogTableStorageDescriptorSchemaReferenceSchemaId(dict):
    ...
    def __init__(__self__, *, registry_name: Optional[_builtins.str] = ..., schema_arn: Optional[_builtins.str] = ..., schema_name: Optional[_builtins.str] = ...) -> None:
...
class CatalogTableStorageDescriptorSerDeInfo(dict):
    ...
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., parameters: Optional[Mapping[str, _builtins.str]] = ..., serialization_library: Optional[_builtins.str] = ...) -> None:
...
class CatalogTableStorageDescriptorSkewedInfo(dict):
    ...
    def __init__(__self__, *, skewed_column_names: Optional[Sequence[_builtins.str]] = ..., skewed_column_value_location_maps: Optional[Mapping[str, _builtins.str]] = ..., skewed_column_values: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CatalogTableStorageDescriptorSortColumn(dict):
    ...
    def __init__(__self__, *, column: _builtins.str, sort_order: _builtins.int) -> None:
...
class CatalogTableTargetTable(dict):
    ...
    def __init__(__self__, *, catalog_id: _builtins.str, database_name: _builtins.str, name: _builtins.str, region: Optional[_builtins.str] = ...) -> None:
...
class CatalogTableViewDefinition(dict):
    ...
    def __init__(__self__, *, definer: Optional[_builtins.str] = ..., is_protected: Optional[_builtins.bool] = ..., last_refresh_type: Optional[_builtins.str] = ..., refresh_seconds: Optional[_builtins.int] = ..., representations: Optional[Sequence[outputs.CatalogTableViewDefinitionRepresentation]] = ..., sub_object_version_ids: Optional[Sequence[_builtins.int]] = ..., sub_objects: Optional[Sequence[_builtins.str]] = ..., view_version_id: Optional[_builtins.int] = ..., view_version_token: Optional[_builtins.str] = ...) -> None:
...
class CatalogTableViewDefinitionRepresentation(dict):
    ...
    def __init__(__self__, *, dialect: Optional[_builtins.str] = ..., dialect_version: Optional[_builtins.str] = ..., validation_connection: Optional[_builtins.str] = ..., view_expanded_text: Optional[_builtins.str] = ..., view_original_text: Optional[_builtins.str] = ...) -> None:
...
class ClassifierCsvClassifier(dict):
    ...
    def __init__(__self__, *, allow_single_column: Optional[_builtins.bool] = ..., contains_header: Optional[_builtins.str] = ..., custom_datatype_configured: Optional[_builtins.bool] = ..., custom_datatypes: Optional[Sequence[_builtins.str]] = ..., delimiter: Optional[_builtins.str] = ..., disable_value_trimming: Optional[_builtins.bool] = ..., headers: Optional[Sequence[_builtins.str]] = ..., quote_symbol: Optional[_builtins.str] = ..., serde: Optional[_builtins.str] = ...) -> None:
...
class ClassifierGrokClassifier(dict):
    ...
    def __init__(__self__, *, classification: _builtins.str, grok_pattern: _builtins.str, custom_patterns: Optional[_builtins.str] = ...) -> None:
...
class ClassifierXmlClassifier(dict):
    ...
    def __init__(__self__, *, classification: _builtins.str, row_tag: _builtins.str) -> None:
...
class ConnectionPhysicalConnectionRequirements(dict):
    ...
    def __init__(__self__, *, availability_zone: Optional[_builtins.str] = ..., security_group_id_lists: Optional[Sequence[_builtins.str]] = ..., subnet_id: Optional[_builtins.str] = ...) -> None:
...
class CrawlerCatalogTarget(dict):
    ...
    def __init__(__self__, *, database_name: _builtins.str, tables: Sequence[_builtins.str], connection_name: Optional[_builtins.str] = ..., dlq_event_queue_arn: Optional[_builtins.str] = ..., event_queue_arn: Optional[_builtins.str] = ...) -> None:
...
class CrawlerDeltaTarget(dict):
    ...
    def __init__(__self__, *, delta_tables: Sequence[_builtins.str], write_manifest: _builtins.bool, connection_name: Optional[_builtins.str] = ..., create_native_delta_table: Optional[_builtins.bool] = ...) -> None:
...
class CrawlerDynamodbTarget(dict):
    ...
    def __init__(__self__, *, path: _builtins.str, scan_all: Optional[_builtins.bool] = ..., scan_rate: Optional[_builtins.float] = ...) -> None:
...
class CrawlerHudiTarget(dict):
    ...
    def __init__(__self__, *, maximum_traversal_depth: _builtins.int, paths: Sequence[_builtins.str], connection_name: Optional[_builtins.str] = ..., exclusions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CrawlerJdbcTarget(dict):
    ...
    def __init__(__self__, *, connection_name: _builtins.str, path: _builtins.str, enable_additional_metadatas: Optional[Sequence[_builtins.str]] = ..., exclusions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CrawlerLakeFormationConfiguration(dict):
    ...
    def __init__(__self__, *, account_id: Optional[_builtins.str] = ..., use_lake_formation_credentials: Optional[_builtins.bool] = ...) -> None:
...
class CrawlerLineageConfiguration(dict):
    ...
    def __init__(__self__, *, crawler_lineage_settings: Optional[_builtins.str] = ...) -> None:
...
class CrawlerMongodbTarget(dict):
    ...
    def __init__(__self__, *, connection_name: _builtins.str, path: _builtins.str, scan_all: Optional[_builtins.bool] = ...) -> None:
...
class CrawlerRecrawlPolicy(dict):
    ...
    def __init__(__self__, *, recrawl_behavior: Optional[_builtins.str] = ...) -> None:
...
class CrawlerS3Target(dict):
    ...
    def __init__(__self__, *, path: _builtins.str, connection_name: Optional[_builtins.str] = ..., dlq_event_queue_arn: Optional[_builtins.str] = ..., event_queue_arn: Optional[_builtins.str] = ..., exclusions: Optional[Sequence[_builtins.str]] = ..., sample_size: Optional[_builtins.int] = ...) -> None:
...
class CrawlerSchemaChangePolicy(dict):
    ...
    def __init__(__self__, *, delete_behavior: Optional[_builtins.str] = ..., update_behavior: Optional[_builtins.str] = ...) -> None:
...
class DataCatalogEncryptionSettingsDataCatalogEncryptionSettings(dict):
    ...
    def __init__(__self__, *, connection_password_encryption: outputs.DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsConnectionPasswordEncryption, encryption_at_rest: outputs.DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEncryptionAtRest) -> None:
...
class DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsConnectionPasswordEncryption(dict):
    ...
    def __init__(__self__, *, return_connection_password_encrypted: _builtins.bool, aws_kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEncryptionAtRest(dict):
    ...
    def __init__(__self__, *, catalog_encryption_mode: _builtins.str, catalog_encryption_service_role: Optional[_builtins.str] = ..., sse_aws_kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class DataQualityRulesetTargetTable(dict):
    ...
    def __init__(__self__, *, database_name: _builtins.str, table_name: _builtins.str, catalog_id: Optional[_builtins.str] = ...) -> None:
...
class JobCommand(dict):
    ...
    def __init__(__self__, *, script_location: _builtins.str, name: Optional[_builtins.str] = ..., python_version: Optional[_builtins.str] = ..., runtime: Optional[_builtins.str] = ...) -> None:
...
class JobExecutionProperty(dict):
    ...
    def __init__(__self__, *, max_concurrent_runs: Optional[_builtins.int] = ...) -> None:
...
class JobNotificationProperty(dict):
    ...
    def __init__(__self__, *, notify_delay_after: Optional[_builtins.int] = ...) -> None:
...
class JobSourceControlDetails(dict):
    ...
    def __init__(__self__, *, auth_strategy: Optional[_builtins.str] = ..., auth_token: Optional[_builtins.str] = ..., branch: Optional[_builtins.str] = ..., folder: Optional[_builtins.str] = ..., last_commit_id: Optional[_builtins.str] = ..., owner: Optional[_builtins.str] = ..., provider: Optional[_builtins.str] = ..., repository: Optional[_builtins.str] = ...) -> None:
...
class MLTransformInputRecordTable(dict):
    ...
    def __init__(__self__, *, database_name: _builtins.str, table_name: _builtins.str, catalog_id: Optional[_builtins.str] = ..., connection_name: Optional[_builtins.str] = ...) -> None:
...
class MLTransformParameters(dict):
    ...
    def __init__(__self__, *, find_matches_parameters: outputs.MLTransformParametersFindMatchesParameters, transform_type: _builtins.str) -> None:
...
class MLTransformParametersFindMatchesParameters(dict):
    ...
    def __init__(__self__, *, accuracy_cost_trade_off: Optional[_builtins.float] = ..., enforce_provided_labels: Optional[_builtins.bool] = ..., precision_recall_trade_off: Optional[_builtins.float] = ..., primary_key_column_name: Optional[_builtins.str] = ...) -> None:
...
class MLTransformSchema(dict):
    ...
    def __init__(__self__, *, data_type: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class PartitionIndexPartitionIndex(dict):
    ...
    def __init__(__self__, *, index_name: Optional[_builtins.str] = ..., index_status: Optional[_builtins.str] = ..., keys: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class PartitionStorageDescriptor(dict):
    ...
    def __init__(__self__, *, additional_locations: Optional[Sequence[_builtins.str]] = ..., bucket_columns: Optional[Sequence[_builtins.str]] = ..., columns: Optional[Sequence[outputs.PartitionStorageDescriptorColumn]] = ..., compressed: Optional[_builtins.bool] = ..., input_format: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., number_of_buckets: Optional[_builtins.int] = ..., output_format: Optional[_builtins.str] = ..., parameters: Optional[Mapping[str, _builtins.str]] = ..., ser_de_info: Optional[outputs.PartitionStorageDescriptorSerDeInfo] = ..., skewed_info: Optional[outputs.PartitionStorageDescriptorSkewedInfo] = ..., sort_columns: Optional[Sequence[outputs.PartitionStorageDescriptorSortColumn]] = ..., stored_as_sub_directories: Optional[_builtins.bool] = ...) -> None:
...
class PartitionStorageDescriptorColumn(dict):
    def __init__(__self__, *, name: _builtins.str, comment: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class SecurityConfigurationEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *, cloudwatch_encryption: outputs.SecurityConfigurationEncryptionConfigurationCloudwatchEncryption, job_bookmarks_encryption: outputs.SecurityConfigurationEncryptionConfigurationJobBookmarksEncryption, s3_encryption: outputs.SecurityConfigurationEncryptionConfigurationS3Encryption) -> None:
...
class SecurityConfigurationEncryptionConfigurationCloudwatchEncryption(dict):
    ...
    def __init__(__self__, *, cloudwatch_encryption_mode: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ...) -> None:
...
class SecurityConfigurationEncryptionConfigurationJobBookmarksEncryption(dict):
    ...
    def __init__(__self__, *, job_bookmarks_encryption_mode: Optional[_builtins.str] = ..., kms_key_arn: Optional[_builtins.str] = ...) -> None:
...
class SecurityConfigurationEncryptionConfigurationS3Encryption(dict):
    ...
    def __init__(__self__, *, kms_key_arn: Optional[_builtins.str] = ..., s3_encryption_mode: Optional[_builtins.str] = ...) -> None:
...
class TriggerAction(dict):
    ...
    def __init__(__self__, *, arguments: Optional[Mapping[str, _builtins.str]] = ..., crawler_name: Optional[_builtins.str] = ..., job_name: Optional[_builtins.str] = ..., notification_property: Optional[outputs.TriggerActionNotificationProperty] = ..., security_configuration: Optional[_builtins.str] = ..., timeout: Optional[_builtins.int] = ...) -> None:
...
class TriggerEventBatchingCondition(dict):
    ...
    def __init__(__self__, *, batch_size: _builtins.int, batch_window: Optional[_builtins.int] = ...) -> None:
...
class TriggerPredicate(dict):
    def __init__(__self__, *, conditions: Sequence[outputs.TriggerPredicateCondition], logical: Optional[_builtins.str] = ...) -> None:
...
class TriggerPredicateCondition(dict):
    ...
    def __init__(__self__, *, crawl_state: Optional[_builtins.str] = ..., crawler_name: Optional[_builtins.str] = ..., job_name: Optional[_builtins.str] = ..., logical_operator: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class UserDefinedFunctionResourceUri(dict):
    ...
    def __init__(__self__, *, resource_type: _builtins.str, uri: _builtins.str) -> None:
...
class GetCatalogTablePartitionIndexResult(dict):
    def __init__(__self__, *, index_name: _builtins.str, index_status: _builtins.str, keys: Sequence[_builtins.str]) -> None:
...
class GetCatalogTablePartitionKeyResult(dict):
    def __init__(__self__, *, comment: _builtins.str, name: _builtins.str, parameters: Mapping[str, _builtins.str], type: _builtins.str) -> None:
...
class GetCatalogTableStorageDescriptorResult(dict):
    def __init__(__self__, *, additional_locations: Sequence[_builtins.str], bucket_columns: Sequence[_builtins.str], columns: Sequence[outputs.GetCatalogTableStorageDescriptorColumnResult], compressed: _builtins.bool, input_format: _builtins.str, location: _builtins.str, number_of_buckets: _builtins.int, output_format: _builtins.str, parameters: Mapping[str, _builtins.str], schema_references: Sequence[outputs.GetCatalogTableStorageDescriptorSchemaReferenceResult], ser_de_infos: Sequence[outputs.GetCatalogTableStorageDescriptorSerDeInfoResult], skewed_infos: Sequence[outputs.GetCatalogTableStorageDescriptorSkewedInfoResult], sort_columns: Sequence[outputs.GetCatalogTableStorageDescriptorSortColumnResult], stored_as_sub_directories: _builtins.bool) -> None:
...
class GetCatalogTableStorageDescriptorSchemaReferenceResult(dict):
    def __init__(__self__, *, schema_ids: Sequence[outputs.GetCatalogTableStorageDescriptorSchemaReferenceSchemaIdResult], schema_version_id: _builtins.str, schema_version_number: _builtins.int) -> None:
...
class GetCatalogTableStorageDescriptorSchemaReferenceSchemaIdResult(dict):
    def __init__(__self__, *, registry_name: _builtins.str, schema_arn: _builtins.str, schema_name: _builtins.str) -> None:
...
class GetCatalogTableStorageDescriptorSkewedInfoResult(dict):
    def __init__(__self__, *, skewed_column_names: Sequence[_builtins.str], skewed_column_value_location_maps: Mapping[str, _builtins.str], skewed_column_values: Sequence[_builtins.str]) -> None:
...
class GetCatalogTableTargetTableResult(dict):
    def __init__(__self__, *, catalog_id: _builtins.str, database_name: _builtins.str, name: _builtins.str, region: _builtins.str) -> None:
...
class GetConnectionPhysicalConnectionRequirementResult(dict):
    def __init__(__self__, *, availability_zone: _builtins.str, security_group_id_lists: Sequence[_builtins.str], subnet_id: _builtins.str) -> None:
        ...
...
class GetDataCatalogEncryptionSettingsDataCatalogEncryptionSettingResult(dict):
    def __init__(__self__, *, connection_password_encryptions: Sequence[outputs.GetDataCatalogEncryptionSettingsDataCatalogEncryptionSettingConnectionPasswordEncryptionResult], encryption_at_rests: Sequence[outputs.GetDataCatalogEncryptionSettingsDataCatalogEncryptionSettingEncryptionAtRestResult]) -> None:
...
class GetDataCatalogEncryptionSettingsDataCatalogEncryptionSettingConnectionPasswordEncryptionResult(dict):
    def __init__(__self__, *, aws_kms_key_id: _builtins.str, return_connection_password_encrypted: _builtins.bool) -> None:
...
class GetDataCatalogEncryptionSettingsDataCatalogEncryptionSettingEncryptionAtRestResult(dict):
    def __init__(__self__, *, catalog_encryption_mode: _builtins.str, catalog_encryption_service_role: _builtins.str, sse_aws_kms_key_id: _builtins.str) -> None:
...
class GetScriptDagNodeResult(dict):
    def __init__(__self__, *, args: Sequence[outputs.GetScriptDagNodeArgResult], id: _builtins.str, node_type: _builtins.str, line_number: Optional[_builtins.int] = ...) -> None:
