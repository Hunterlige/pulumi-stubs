...
class ApnsSandboxChannel(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: ApnsSandboxChannelArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., application_id: Optional[pulumi.Input[_builtins.str]] = ..., bundle_id: Optional[pulumi.Input[_builtins.str]] = ..., certificate: Optional[pulumi.Input[_builtins.str]] = ..., default_authentication_method: Optional[pulumi.Input[_builtins.str]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., private_key: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., team_id: Optional[pulumi.Input[_builtins.str]] = ..., token_key: Optional[pulumi.Input[_builtins.str]] = ..., token_key_id: Optional[pulumi.Input[_builtins.str]] = ...) -> ApnsSandboxChannel:
