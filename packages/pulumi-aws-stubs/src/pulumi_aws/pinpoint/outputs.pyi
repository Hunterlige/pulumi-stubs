...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppCampaignHook', 'AppLimits', 'AppQuietTime', 'EmailTemplateEmailTemplate', 'EmailTemplateEmailTemplateHeader', 'Smsvoicev2PhoneNumberTimeouts']
@pulumi.output_type
class AppCampaignHook(dict):
    ...
    def __init__(__self__, *, lambda_function_name: Optional[_builtins.str] = ..., mode: Optional[_builtins.str] = ..., web_url: Optional[_builtins.str] = ...) -> None:
...
class AppLimits(dict):
    ...
    def __init__(__self__, *, daily: Optional[_builtins.int] = ..., maximum_duration: Optional[_builtins.int] = ..., messages_per_second: Optional[_builtins.int] = ..., total: Optional[_builtins.int] = ...) -> None:
...
class EmailTemplateEmailTemplate(dict):
    ...
    def __init__(__self__, *, default_substitutions: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., headers: Optional[Sequence[outputs.EmailTemplateEmailTemplateHeader]] = ..., html_part: Optional[_builtins.str] = ..., recommender_id: Optional[_builtins.str] = ..., subject: Optional[_builtins.str] = ..., text_part: Optional[_builtins.str] = ...) -> None:
