...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppCampaignHookArgs', 'AppCampaignHookArgsDict', 'AppLimitsArgs', 'AppLimitsArgsDict', 'AppQuietTimeArgs', 'AppQuietTimeArgsDict', 'EmailTemplateEmailTemplateArgs', 'EmailTemplateEmailTemplateArgsDict', 'EmailTemplateEmailTemplateHeaderArgs', 'EmailTemplateEmailTemplateHeaderArgsDict', 'Smsvoicev2PhoneNumberTimeoutsArgs', 'Smsvoicev2PhoneNumberTimeoutsArgsDict']
...
class AppCampaignHookArgs:
    def __init__(__self__, *, lambda_function_name: Optional[pulumi.Input[_builtins.str]] = ..., mode: Optional[pulumi.Input[_builtins.str]] = ..., web_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def lambda_function_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @web_url.setter
    def web_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class AppLimitsArgs:
    def __init__(__self__, *, daily: Optional[pulumi.Input[_builtins.int]] = ..., maximum_duration: Optional[pulumi.Input[_builtins.int]] = ..., messages_per_second: Optional[pulumi.Input[_builtins.int]] = ..., total: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @daily.setter
    def daily(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def maximum_duration(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @total.setter
    def total(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class EmailTemplateEmailTemplateArgs:
    def __init__(__self__, *, default_substitutions: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., headers: Optional[pulumi.Input[Sequence[pulumi.Input[EmailTemplateEmailTemplateHeaderArgs]]]] = ..., html_part: Optional[pulumi.Input[_builtins.str]] = ..., recommender_id: Optional[pulumi.Input[_builtins.str]] = ..., subject: Optional[pulumi.Input[_builtins.str]] = ..., text_part: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def default_substitutions(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @headers.setter
    def headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EmailTemplateEmailTemplateHeaderArgs]]]]): # -> None:
        ...
    ...
    @html_part.setter
    def html_part(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def recommender_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @text_part.setter
    def text_part(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
