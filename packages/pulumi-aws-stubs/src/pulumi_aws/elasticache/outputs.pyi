...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterCacheNode', 'ClusterLogDeliveryConfiguration', 'GlobalReplicationGroupGlobalNodeGroup', 'ParameterGroupParameter', 'ReplicationGroupLogDeliveryConfiguration', 'ReplicationGroupNodeGroupConfiguration', 'ReservedCacheNodeRecurringCharge', 'ReservedCacheNodeTimeouts', 'ServerlessCacheCacheUsageLimits', 'ServerlessCacheCacheUsageLimitsDataStorage', 'ServerlessCacheCacheUsageLimitsEcpuPerSecond', 'ServerlessCacheEndpoint', 'ServerlessCacheReaderEndpoint', 'ServerlessCacheTimeouts', 'UserAuthenticationMode', 'GetClusterCacheNodeResult', 'GetClusterLogDeliveryConfigurationResult', 'GetReplicationGroupLogDeliveryConfigurationResult', 'GetReplicationGroupNodeGroupConfigurationResult', 'GetServerlessCacheCacheUsageLimitsResult', ..., ..., 'GetServerlessCacheEndpointResult', 'GetServerlessCacheReaderEndpointResult', 'GetUserAuthenticationModeResult']
@pulumi.output_type
class ClusterCacheNode(dict):
    ...
    def __init__(__self__, *, address: Optional[_builtins.str] = ..., availability_zone: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., outpost_arn: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ...) -> None:
...
class ClusterLogDeliveryConfiguration(dict):
    ...
    def __init__(__self__, *, destination: _builtins.str, destination_type: _builtins.str, log_format: _builtins.str, log_type: _builtins.str) -> None:
...
class GlobalReplicationGroupGlobalNodeGroup(dict):
    ...
    def __init__(__self__, *, global_node_group_id: Optional[_builtins.str] = ..., slots: Optional[_builtins.str] = ...) -> None:
...
class ReplicationGroupNodeGroupConfiguration(dict):
    ...
    def __init__(__self__, *, node_group_id: Optional[_builtins.str] = ..., primary_availability_zone: Optional[_builtins.str] = ..., primary_outpost_arn: Optional[_builtins.str] = ..., replica_availability_zones: Optional[Sequence[_builtins.str]] = ..., replica_count: Optional[_builtins.int] = ..., replica_outpost_arns: Optional[Sequence[_builtins.str]] = ..., slots: Optional[_builtins.str] = ...) -> None:
...
class ReservedCacheNodeRecurringCharge(dict):
    ...
    def __init__(__self__, *, recurring_charge_amount: _builtins.float, recurring_charge_frequency: _builtins.str) -> None:
        ...
...
class ServerlessCacheCacheUsageLimits(dict):
    ...
    def __init__(__self__, *, data_storage: Optional[outputs.ServerlessCacheCacheUsageLimitsDataStorage] = ..., ecpu_per_seconds: Optional[Sequence[outputs.ServerlessCacheCacheUsageLimitsEcpuPerSecond]] = ...) -> None:
...
class ServerlessCacheCacheUsageLimitsDataStorage(dict):
    def __init__(__self__, *, unit: _builtins.str, maximum: Optional[_builtins.int] = ..., minimum: Optional[_builtins.int] = ...) -> None:
...
class ServerlessCacheCacheUsageLimitsEcpuPerSecond(dict):
    def __init__(__self__, *, maximum: Optional[_builtins.int] = ..., minimum: Optional[_builtins.int] = ...) -> None:
...
class UserAuthenticationMode(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, password_count: Optional[_builtins.int] = ..., passwords: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GetClusterCacheNodeResult(dict):
    def __init__(__self__, *, address: _builtins.str, availability_zone: _builtins.str, id: _builtins.str, outpost_arn: _builtins.str, port: _builtins.int) -> None:
...
class GetReplicationGroupNodeGroupConfigurationResult(dict):
    def __init__(__self__, *, node_group_id: _builtins.str, primary_availability_zone: _builtins.str, primary_outpost_arn: _builtins.str, replica_availability_zones: Sequence[_builtins.str], replica_count: _builtins.int, replica_outpost_arns: Sequence[_builtins.str], slots: _builtins.str) -> None:
...
class GetServerlessCacheCacheUsageLimitsResult(dict):
    def __init__(__self__, *, data_storage: outputs.GetServerlessCacheCacheUsageLimitsDataStorageResult, ecpu_per_second: outputs.GetServerlessCacheCacheUsageLimitsEcpuPerSecondResult) -> None:
...
class GetServerlessCacheCacheUsageLimitsDataStorageResult(dict):
    def __init__(__self__, *, maximum: _builtins.int, minimum: _builtins.int, unit: _builtins.str) -> None:
...
class GetServerlessCacheCacheUsageLimitsEcpuPerSecondResult(dict):
    def __init__(__self__, *, maximum: _builtins.int, minimum: _builtins.int) -> None:
