...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterCacheNodeArgs', 'ClusterCacheNodeArgsDict', 'ClusterLogDeliveryConfigurationArgs', 'ClusterLogDeliveryConfigurationArgsDict', 'GlobalReplicationGroupGlobalNodeGroupArgs', 'GlobalReplicationGroupGlobalNodeGroupArgsDict', 'ParameterGroupParameterArgs', 'ParameterGroupParameterArgsDict', 'ReplicationGroupLogDeliveryConfigurationArgs', 'ReplicationGroupLogDeliveryConfigurationArgsDict', 'ReplicationGroupNodeGroupConfigurationArgs', 'ReplicationGroupNodeGroupConfigurationArgsDict', 'ReservedCacheNodeRecurringChargeArgs', 'ReservedCacheNodeRecurringChargeArgsDict', 'ReservedCacheNodeTimeoutsArgs', 'ReservedCacheNodeTimeoutsArgsDict', 'ServerlessCacheCacheUsageLimitsArgs', 'ServerlessCacheCacheUsageLimitsArgsDict', 'ServerlessCacheCacheUsageLimitsDataStorageArgs', 'ServerlessCacheCacheUsageLimitsDataStorageArgsDict', 'ServerlessCacheCacheUsageLimitsEcpuPerSecondArgs', ..., 'ServerlessCacheEndpointArgs', 'ServerlessCacheEndpointArgsDict', 'ServerlessCacheReaderEndpointArgs', 'ServerlessCacheReaderEndpointArgsDict', 'ServerlessCacheTimeoutsArgs', 'ServerlessCacheTimeoutsArgsDict', 'UserAuthenticationModeArgs', 'UserAuthenticationModeArgsDict', 'GetUserAuthenticationModeArgs', 'GetUserAuthenticationModeArgsDict']
...
class ClusterCacheNodeArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., outpost_arn: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ClusterLogDeliveryConfigurationArgs:
    def __init__(__self__, *, destination: pulumi.Input[_builtins.str], destination_type: pulumi.Input[_builtins.str], log_format: pulumi.Input[_builtins.str], log_type: pulumi.Input[_builtins.str]) -> None:
...
class GlobalReplicationGroupGlobalNodeGroupArgs:
    def __init__(__self__, *, global_node_group_id: Optional[pulumi.Input[_builtins.str]] = ..., slots: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def global_node_group_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @slots.setter
    def slots(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ReplicationGroupNodeGroupConfigurationArgs:
    def __init__(__self__, *, node_group_id: Optional[pulumi.Input[_builtins.str]] = ..., primary_availability_zone: Optional[pulumi.Input[_builtins.str]] = ..., primary_outpost_arn: Optional[pulumi.Input[_builtins.str]] = ..., replica_availability_zones: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., replica_count: Optional[pulumi.Input[_builtins.int]] = ..., replica_outpost_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., slots: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def primary_outpost_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def replica_availability_zones(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def replica_outpost_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ReservedCacheNodeRecurringChargeArgs:
    def __init__(__self__, *, recurring_charge_amount: pulumi.Input[_builtins.float], recurring_charge_frequency: pulumi.Input[_builtins.str]) -> None:
        ...
    ...
    def recurring_charge_amount(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def recurring_charge_frequency(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ServerlessCacheCacheUsageLimitsArgs:
    def __init__(__self__, *, data_storage: Optional[pulumi.Input[ServerlessCacheCacheUsageLimitsDataStorageArgs]] = ..., ecpu_per_seconds: Optional[pulumi.Input[Sequence[pulumi.Input[ServerlessCacheCacheUsageLimitsEcpuPerSecondArgs]]]] = ...) -> None:
    ...
    @data_storage.setter
    def data_storage(self, value: Optional[pulumi.Input[ServerlessCacheCacheUsageLimitsDataStorageArgs]]): # -> None:
        ...
    ...
    def ecpu_per_seconds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServerlessCacheCacheUsageLimitsEcpuPerSecondArgs]]]]): # -> None:
        ...
...
class ServerlessCacheCacheUsageLimitsDataStorageArgs:
    def __init__(__self__, *, unit: pulumi.Input[_builtins.str], maximum: Optional[pulumi.Input[_builtins.int]] = ..., minimum: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ServerlessCacheCacheUsageLimitsEcpuPerSecondArgs:
    def __init__(__self__, *, maximum: Optional[pulumi.Input[_builtins.int]] = ..., minimum: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ServerlessCacheEndpointArgs:
    def __init__(__self__, *, address: pulumi.Input[_builtins.str], port: pulumi.Input[_builtins.int]) -> None:
...
class UserAuthenticationModeArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], password_count: Optional[pulumi.Input[_builtins.int]] = ..., passwords: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def password_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class GetUserAuthenticationModeArgs:
    def __init__(__self__, *, password_count: Optional[_builtins.int] = ..., type: Optional[_builtins.str] = ...) -> None:
        ...
    ...
    @password_count.setter
    def password_count(self, value: Optional[_builtins.int]): # -> None:
        ...
