...
class GetClusterResult:
    ...
    def __init__(__self__, arn=..., availability_zone=..., cache_nodes=..., cluster_address=..., cluster_id=..., configuration_endpoint=..., engine=..., engine_version=..., id=..., ip_discovery=..., log_delivery_configurations=..., maintenance_window=..., network_type=..., node_type=..., notification_topic_arn=..., num_cache_nodes=..., parameter_group_name=..., port=..., preferred_outpost_arn=..., region=..., replication_group_id=..., security_group_ids=..., snapshot_retention_limit=..., snapshot_window=..., subnet_group_name=..., tags=...) -> None:
        ...
...
def get_cluster(cluster_id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetClusterResult:
    
    ...

def get_cluster_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetClusterResult]:
