...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FileSystemAssociationCacheAttributesArgs', 'FileSystemAssociationCacheAttributesArgsDict', 'GatewayGatewayNetworkInterfaceArgs', 'GatewayGatewayNetworkInterfaceArgsDict', 'GatewayMaintenanceStartTimeArgs', 'GatewayMaintenanceStartTimeArgsDict', 'GatewaySmbActiveDirectorySettingsArgs', 'GatewaySmbActiveDirectorySettingsArgsDict', 'NfsFileShareCacheAttributesArgs', 'NfsFileShareCacheAttributesArgsDict', 'NfsFileShareNfsFileShareDefaultsArgs', 'NfsFileShareNfsFileShareDefaultsArgsDict', 'SmbFileShareCacheAttributesArgs', 'SmbFileShareCacheAttributesArgsDict']
...
class FileSystemAssociationCacheAttributesArgs:
    def __init__(__self__, *, cache_stale_timeout_in_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def cache_stale_timeout_in_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class GatewayMaintenanceStartTimeArgs:
    def __init__(__self__, *, hour_of_day: pulumi.Input[_builtins.int], day_of_month: Optional[pulumi.Input[_builtins.str]] = ..., day_of_week: Optional[pulumi.Input[_builtins.str]] = ..., minute_of_hour: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def minute_of_hour(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class GatewaySmbActiveDirectorySettingsArgs:
    def __init__(__self__, *, domain_name: pulumi.Input[_builtins.str], password: pulumi.Input[_builtins.str], username: pulumi.Input[_builtins.str], active_directory_status: Optional[pulumi.Input[_builtins.str]] = ..., domain_controllers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., organizational_unit: Optional[pulumi.Input[_builtins.str]] = ..., timeout_in_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def active_directory_status(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def domain_controllers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class NfsFileShareNfsFileShareDefaultsArgs:
    def __init__(__self__, *, directory_mode: Optional[pulumi.Input[_builtins.str]] = ..., file_mode: Optional[pulumi.Input[_builtins.str]] = ..., group_id: Optional[pulumi.Input[_builtins.str]] = ..., owner_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def directory_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
