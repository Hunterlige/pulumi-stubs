...
class CachesIscsiVolumeArgs:
    def __init__(__self__, *, gateway_arn: pulumi.Input[_builtins.str], network_interface_id: pulumi.Input[_builtins.str], target_name: pulumi.Input[_builtins.str], volume_size_in_bytes: pulumi.Input[_builtins.int], kms_encrypted: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., snapshot_id: Optional[pulumi.Input[_builtins.str]] = ..., source_volume_arn: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def volume_size_in_bytes(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def source_volume_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class _CachesIscsiVolumeState:
    def __init__(__self__, *, arn: Optional[pulumi.Input[_builtins.str]] = ..., chap_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., gateway_arn: Optional[pulumi.Input[_builtins.str]] = ..., kms_encrypted: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key: Optional[pulumi.Input[_builtins.str]] = ..., lun_number: Optional[pulumi.Input[_builtins.int]] = ..., network_interface_id: Optional[pulumi.Input[_builtins.str]] = ..., network_interface_port: Optional[pulumi.Input[_builtins.int]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., snapshot_id: Optional[pulumi.Input[_builtins.str]] = ..., source_volume_arn: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_arn: Optional[pulumi.Input[_builtins.str]] = ..., target_name: Optional[pulumi.Input[_builtins.str]] = ..., volume_arn: Optional[pulumi.Input[_builtins.str]] = ..., volume_id: Optional[pulumi.Input[_builtins.str]] = ..., volume_size_in_bytes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @volume_arn.setter
    def volume_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CachesIscsiVolume(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., gateway_arn: Optional[pulumi.Input[_builtins.str]] = ..., kms_encrypted: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key: Optional[pulumi.Input[_builtins.str]] = ..., network_interface_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., snapshot_id: Optional[pulumi.Input[_builtins.str]] = ..., source_volume_arn: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_name: Optional[pulumi.Input[_builtins.str]] = ..., volume_size_in_bytes: Optional[pulumi.Input[_builtins.int]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: CachesIscsiVolumeArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., arn: Optional[pulumi.Input[_builtins.str]] = ..., chap_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., gateway_arn: Optional[pulumi.Input[_builtins.str]] = ..., kms_encrypted: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key: Optional[pulumi.Input[_builtins.str]] = ..., lun_number: Optional[pulumi.Input[_builtins.int]] = ..., network_interface_id: Optional[pulumi.Input[_builtins.str]] = ..., network_interface_port: Optional[pulumi.Input[_builtins.int]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., snapshot_id: Optional[pulumi.Input[_builtins.str]] = ..., source_volume_arn: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., target_arn: Optional[pulumi.Input[_builtins.str]] = ..., target_name: Optional[pulumi.Input[_builtins.str]] = ..., volume_arn: Optional[pulumi.Input[_builtins.str]] = ..., volume_id: Optional[pulumi.Input[_builtins.str]] = ..., volume_size_in_bytes: Optional[pulumi.Input[_builtins.int]] = ...) -> CachesIscsiVolume:
