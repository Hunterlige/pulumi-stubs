...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ResourceSetResource', 'ResourceSetResourceDnsTargetResource', 'ResourceSetResourceDnsTargetResourceTargetResource', ..., ...]
@pulumi.output_type
class ResourceSetResource(dict):
    ...
    def __init__(__self__, *, component_id: Optional[_builtins.str] = ..., dns_target_resource: Optional[outputs.ResourceSetResourceDnsTargetResource] = ..., readiness_scopes: Optional[Sequence[_builtins.str]] = ..., resource_arn: Optional[_builtins.str] = ...) -> None:
...
class ResourceSetResourceDnsTargetResource(dict):
    ...
    def __init__(__self__, *, domain_name: _builtins.str, hosted_zone_arn: Optional[_builtins.str] = ..., record_set_id: Optional[_builtins.str] = ..., record_type: Optional[_builtins.str] = ..., target_resource: Optional[outputs.ResourceSetResourceDnsTargetResourceTargetResource] = ...) -> None:
...
class ResourceSetResourceDnsTargetResourceTargetResource(dict):
    ...
    def __init__(__self__, *, nlb_resource: Optional[outputs.ResourceSetResourceDnsTargetResourceTargetResourceNlbResource] = ..., r53_resource: Optional[outputs.ResourceSetResourceDnsTargetResourceTargetResourceR53Resource] = ...) -> None:
...
class ResourceSetResourceDnsTargetResourceTargetResourceR53Resource(dict):
    ...
    def __init__(__self__, *, domain_name: Optional[_builtins.str] = ..., record_set_id: Optional[_builtins.str] = ...) -> None:
