...
class _ConnectionConfirmationState:
    def __init__(__self__, *, connection_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ConnectionConfirmation(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: ConnectionConfirmationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., connection_id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> ConnectionConfirmation:
