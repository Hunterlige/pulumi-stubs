...
@pulumi.input_type
class BgpPeerArgs:
    def __init__(__self__, *, address_family: pulumi.Input[_builtins.str], bgp_asn: pulumi.Input[_builtins.int], virtual_interface_id: pulumi.Input[_builtins.str], amazon_address: Optional[pulumi.Input[_builtins.str]] = ..., bgp_auth_key: Optional[pulumi.Input[_builtins.str]] = ..., customer_address: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def virtual_interface_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
@pulumi.input_type
class _BgpPeerState:
    def __init__(__self__, *, address_family: Optional[pulumi.Input[_builtins.str]] = ..., amazon_address: Optional[pulumi.Input[_builtins.str]] = ..., aws_device: Optional[pulumi.Input[_builtins.str]] = ..., bgp_asn: Optional[pulumi.Input[_builtins.int]] = ..., bgp_auth_key: Optional[pulumi.Input[_builtins.str]] = ..., bgp_peer_id: Optional[pulumi.Input[_builtins.str]] = ..., bgp_status: Optional[pulumi.Input[_builtins.str]] = ..., customer_address: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., virtual_interface_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @bgp_peer_id.setter
    def bgp_peer_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @bgp_status.setter
    def bgp_status(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @virtual_interface_id.setter
    def virtual_interface_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BgpPeer(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., address_family: Optional[pulumi.Input[_builtins.str]] = ..., amazon_address: Optional[pulumi.Input[_builtins.str]] = ..., bgp_asn: Optional[pulumi.Input[_builtins.int]] = ..., bgp_auth_key: Optional[pulumi.Input[_builtins.str]] = ..., customer_address: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., virtual_interface_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., address_family: Optional[pulumi.Input[_builtins.str]] = ..., amazon_address: Optional[pulumi.Input[_builtins.str]] = ..., aws_device: Optional[pulumi.Input[_builtins.str]] = ..., bgp_asn: Optional[pulumi.Input[_builtins.int]] = ..., bgp_auth_key: Optional[pulumi.Input[_builtins.str]] = ..., bgp_peer_id: Optional[pulumi.Input[_builtins.str]] = ..., bgp_status: Optional[pulumi.Input[_builtins.str]] = ..., customer_address: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., virtual_interface_id: Optional[pulumi.Input[_builtins.str]] = ...) -> BgpPeer:
