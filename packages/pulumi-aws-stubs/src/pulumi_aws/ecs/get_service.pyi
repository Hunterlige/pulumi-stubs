...
class GetServiceResult:
    ...
    def __init__(__self__, arn=..., availability_zone_rebalancing=..., capacity_provider_strategies=..., cluster_arn=..., created_at=..., created_by=..., deployment_configurations=..., deployment_controllers=..., deployments=..., desired_count=..., enable_ecs_managed_tags=..., enable_execute_command=..., events=..., health_check_grace_period_seconds=..., iam_role=..., id=..., launch_type=..., load_balancers=..., network_configurations=..., ordered_placement_strategies=..., pending_count=..., placement_constraints=..., platform_family=..., platform_version=..., propagate_tags=..., region=..., running_count=..., scheduling_strategy=..., service_name=..., service_registries=..., status=..., tags=..., task_definition=..., task_sets=...) -> None:
        ...
...
def get_service(cluster_arn: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., service_name: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetServiceResult:
    
    ...

def get_service_output(cluster_arn: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., service_name: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetServiceResult]:
