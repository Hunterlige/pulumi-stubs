...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetTaskDefinitionResult', 'AwaitableGetTaskDefinitionResult', 'get_task_definition', 'get_task_definition_output']
@pulumi.output_type
class GetTaskDefinitionResult:
    
    def __init__(__self__, arn=..., arn_without_revision=..., container_definitions=..., cpu=..., enable_fault_injection=..., ephemeral_storages=..., execution_role_arn=..., family=..., id=..., ipc_mode=..., memory=..., network_mode=..., pid_mode=..., placement_constraints=..., proxy_configurations=..., region=..., requires_compatibilities=..., revision=..., runtime_platforms=..., status=..., task_definition=..., task_role_arn=..., volumes=...) -> None:
        ...
...
class AwaitableGetTaskDefinitionResult(GetTaskDefinitionResult):
    def __await__(self): # -> Generator[Never, Any, GetTaskDefinitionResult]:
        ...
    


def get_task_definition(region: Optional[_builtins.str] = ..., task_definition: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetTaskDefinitionResult:
    
    ...

def get_task_definition_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., task_definition: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetTaskDefinitionResult]:
