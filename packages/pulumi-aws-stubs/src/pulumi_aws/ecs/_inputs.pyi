...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CapacityProviderAutoScalingGroupProviderArgs', 'CapacityProviderAutoScalingGroupProviderArgsDict', ..., ..., 'CapacityProviderManagedInstancesProviderArgs', 'CapacityProviderManagedInstancesProviderArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ClusterConfigurationArgs', 'ClusterConfigurationArgsDict', ..., ..., ..., ..., ..., ..., 'ClusterServiceConnectDefaultsArgs', 'ClusterServiceConnectDefaultsArgsDict', 'ClusterSettingArgs', 'ClusterSettingArgsDict', 'ExpressGatewayServiceIngressPathArgs', 'ExpressGatewayServiceIngressPathArgsDict', 'ExpressGatewayServiceNetworkConfigurationArgs', 'ExpressGatewayServiceNetworkConfigurationArgsDict', 'ExpressGatewayServicePrimaryContainerArgs', 'ExpressGatewayServicePrimaryContainerArgsDict', ..., ..., ..., ..., ..., ..., 'ExpressGatewayServicePrimaryContainerSecretArgs', ..., 'ExpressGatewayServiceScalingTargetArgs', 'ExpressGatewayServiceScalingTargetArgsDict', 'ExpressGatewayServiceTimeoutsArgs', 'ExpressGatewayServiceTimeoutsArgsDict', 'ServiceAlarmsArgs', 'ServiceAlarmsArgsDict', 'ServiceCapacityProviderStrategyArgs', 'ServiceCapacityProviderStrategyArgsDict', 'ServiceDeploymentCircuitBreakerArgs', 'ServiceDeploymentCircuitBreakerArgsDict', 'ServiceDeploymentConfigurationArgs', 'ServiceDeploymentConfigurationArgsDict', ..., ..., 'ServiceDeploymentConfigurationLifecycleHookArgs', ..., ..., ..., 'ServiceDeploymentControllerArgs', 'ServiceDeploymentControllerArgsDict', 'ServiceLoadBalancerArgs', 'ServiceLoadBalancerArgsDict', 'ServiceLoadBalancerAdvancedConfigurationArgs', 'ServiceLoadBalancerAdvancedConfigurationArgsDict', 'ServiceNetworkConfigurationArgs', 'ServiceNetworkConfigurationArgsDict', 'ServiceOrderedPlacementStrategyArgs', 'ServiceOrderedPlacementStrategyArgsDict', 'ServicePlacementConstraintArgs', 'ServicePlacementConstraintArgsDict', 'ServiceServiceConnectConfigurationArgs', 'ServiceServiceConnectConfigurationArgsDict', ..., ..., ..., ..., ..., ..., 'ServiceServiceConnectConfigurationServiceArgs', 'ServiceServiceConnectConfigurationServiceArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ServiceServiceConnectConfigurationServiceTlsArgs', ..., ..., ..., 'ServiceServiceRegistriesArgs', 'ServiceServiceRegistriesArgsDict', 'ServiceVolumeConfigurationArgs', 'ServiceVolumeConfigurationArgsDict', 'ServiceVolumeConfigurationManagedEbsVolumeArgs', 'ServiceVolumeConfigurationManagedEbsVolumeArgsDict', ..., ..., 'ServiceVpcLatticeConfigurationArgs', 'ServiceVpcLatticeConfigurationArgsDict', 'TaskDefinitionEphemeralStorageArgs', 'TaskDefinitionEphemeralStorageArgsDict', 'TaskDefinitionPlacementConstraintArgs', 'TaskDefinitionPlacementConstraintArgsDict', 'TaskDefinitionProxyConfigurationArgs', 'TaskDefinitionProxyConfigurationArgsDict', 'TaskDefinitionRuntimePlatformArgs', 'TaskDefinitionRuntimePlatformArgsDict', 'TaskDefinitionVolumeArgs', 'TaskDefinitionVolumeArgsDict', 'TaskDefinitionVolumeDockerVolumeConfigurationArgs', ..., 'TaskDefinitionVolumeEfsVolumeConfigurationArgs', 'TaskDefinitionVolumeEfsVolumeConfigurationArgsDict', ..., ..., ..., ..., ..., ..., 'TaskSetCapacityProviderStrategyArgs', 'TaskSetCapacityProviderStrategyArgsDict', 'TaskSetLoadBalancerArgs', 'TaskSetLoadBalancerArgsDict', 'TaskSetNetworkConfigurationArgs', 'TaskSetNetworkConfigurationArgsDict', 'TaskSetScaleArgs', 'TaskSetScaleArgsDict', 'TaskSetServiceRegistriesArgs', 'TaskSetServiceRegistriesArgsDict', 'GetTaskExecutionCapacityProviderStrategyArgs', 'GetTaskExecutionCapacityProviderStrategyArgsDict', 'GetTaskExecutionNetworkConfigurationArgs', 'GetTaskExecutionNetworkConfigurationArgsDict', 'GetTaskExecutionOverridesArgs', 'GetTaskExecutionOverridesArgsDict', 'GetTaskExecutionOverridesContainerOverrideArgs', 'GetTaskExecutionOverridesContainerOverrideArgsDict', ..., ..., ..., ..., 'GetTaskExecutionPlacementConstraintArgs', 'GetTaskExecutionPlacementConstraintArgsDict', 'GetTaskExecutionPlacementStrategyArgs', 'GetTaskExecutionPlacementStrategyArgsDict']
...
class CapacityProviderAutoScalingGroupProviderArgs:
    def __init__(__self__, *, auto_scaling_group_arn: pulumi.Input[_builtins.str], managed_draining: Optional[pulumi.Input[_builtins.str]] = ..., managed_scaling: Optional[pulumi.Input[CapacityProviderAutoScalingGroupProviderManagedScalingArgs]] = ..., managed_termination_protection: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def auto_scaling_group_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def managed_draining(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def managed_scaling(self, value: Optional[pulumi.Input[CapacityProviderAutoScalingGroupProviderManagedScalingArgs]]): # -> None:
        ...
    ...
    def managed_termination_protection(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CapacityProviderAutoScalingGroupProviderManagedScalingArgs:
    def __init__(__self__, *, instance_warmup_period: Optional[pulumi.Input[_builtins.int]] = ..., maximum_scaling_step_size: Optional[pulumi.Input[_builtins.int]] = ..., minimum_scaling_step_size: Optional[pulumi.Input[_builtins.int]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., target_capacity: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def instance_warmup_period(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def maximum_scaling_step_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def minimum_scaling_step_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class CapacityProviderManagedInstancesProviderArgs:
    def __init__(__self__, *, infrastructure_role_arn: pulumi.Input[_builtins.str], instance_launch_template: pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateArgs], infrastructure_optimization: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInfrastructureOptimizationArgs]] = ..., propagate_tags: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def instance_launch_template(self, value: pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateArgs]): # -> None:
        ...
    ...
    def infrastructure_optimization(self, value: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInfrastructureOptimizationArgs]]): # -> None:
        ...
...
class CapacityProviderManagedInstancesProviderInfrastructureOptimizationArgs:
    def __init__(__self__, *, scale_in_after: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def scale_in_after(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class CapacityProviderManagedInstancesProviderInstanceLaunchTemplateArgs:
    def __init__(__self__, *, ec2_instance_profile_arn: pulumi.Input[_builtins.str], network_configuration: pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateNetworkConfigurationArgs], capacity_option_type: Optional[pulumi.Input[_builtins.str]] = ..., instance_requirements: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsArgs]] = ..., monitoring: Optional[pulumi.Input[_builtins.str]] = ..., storage_configuration: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateStorageConfigurationArgs]] = ...) -> None:
    ...
    def ec2_instance_profile_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def network_configuration(self, value: pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateNetworkConfigurationArgs]): # -> None:
        ...
    ...
    def capacity_option_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def instance_requirements(self, value: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsArgs]]): # -> None:
        ...
    ...
    @monitoring.setter
    def monitoring(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def storage_configuration(self, value: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateStorageConfigurationArgs]]): # -> None:
        ...
...
class CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsArgs:
    def __init__(__self__, *, memory_mib: pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsMemoryMibArgs], vcpu_count: pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsVcpuCountArgs], accelerator_count: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorCountArgs]] = ..., accelerator_manufacturers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., accelerator_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., accelerator_total_memory_mib: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMibArgs]] = ..., accelerator_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allowed_instance_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., bare_metal: Optional[pulumi.Input[_builtins.str]] = ..., baseline_ebs_bandwidth_mbps: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbpsArgs]] = ..., burstable_performance: Optional[pulumi.Input[_builtins.str]] = ..., cpu_manufacturers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., excluded_instance_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., instance_generations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., local_storage: Optional[pulumi.Input[_builtins.str]] = ..., local_storage_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., max_spot_price_as_percentage_of_optimal_on_demand_price: Optional[pulumi.Input[_builtins.int]] = ..., memory_gib_per_vcpu: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsMemoryGibPerVcpuArgs]] = ..., network_bandwidth_gbps: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkBandwidthGbpsArgs]] = ..., network_interface_count: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkInterfaceCountArgs]] = ..., on_demand_max_price_percentage_over_lowest_price: Optional[pulumi.Input[_builtins.int]] = ..., require_hibernate_support: Optional[pulumi.Input[_builtins.bool]] = ..., spot_max_price_percentage_over_lowest_price: Optional[pulumi.Input[_builtins.int]] = ..., total_local_storage_gb: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsTotalLocalStorageGbArgs]] = ...) -> None:
    ...
    @memory_mib.setter
    def memory_mib(self, value: pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsMemoryMibArgs]): # -> None:
        ...
    ...
    @vcpu_count.setter
    def vcpu_count(self, value: pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsVcpuCountArgs]): # -> None:
        ...
    ...
    def accelerator_count(self, value: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorCountArgs]]): # -> None:
        ...
    ...
    def accelerator_total_memory_mib(self, value: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMibArgs]]): # -> None:
        ...
    ...
    def baseline_ebs_bandwidth_mbps(self, value: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbpsArgs]]): # -> None:
        ...
    ...
    def memory_gib_per_vcpu(self, value: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsMemoryGibPerVcpuArgs]]): # -> None:
        ...
    ...
    def network_bandwidth_gbps(self, value: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkBandwidthGbpsArgs]]): # -> None:
        ...
    ...
    def network_interface_count(self, value: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkInterfaceCountArgs]]): # -> None:
        ...
    ...
    def total_local_storage_gb(self, value: Optional[pulumi.Input[CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsTotalLocalStorageGbArgs]]): # -> None:
        ...
...
class CapacityProviderManagedInstancesProviderInstanceLaunchTemplateNetworkConfigurationArgs:
    def __init__(__self__, *, subnets: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class CapacityProviderManagedInstancesProviderInstanceLaunchTemplateStorageConfigurationArgs:
    def __init__(__self__, *, storage_size_gib: pulumi.Input[_builtins.int]) -> None:
    ...
    def storage_size_gib(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ClusterConfigurationArgs:
    def __init__(__self__, *, execute_command_configuration: Optional[pulumi.Input[ClusterConfigurationExecuteCommandConfigurationArgs]] = ..., managed_storage_configuration: Optional[pulumi.Input[ClusterConfigurationManagedStorageConfigurationArgs]] = ...) -> None:
    ...
    def execute_command_configuration(self, value: Optional[pulumi.Input[ClusterConfigurationExecuteCommandConfigurationArgs]]): # -> None:
        ...
    ...
    def managed_storage_configuration(self, value: Optional[pulumi.Input[ClusterConfigurationManagedStorageConfigurationArgs]]): # -> None:
        ...
...
class ClusterConfigurationExecuteCommandConfigurationArgs:
    def __init__(__self__, *, kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., log_configuration: Optional[pulumi.Input[ClusterConfigurationExecuteCommandConfigurationLogConfigurationArgs]] = ..., logging: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def log_configuration(self, value: Optional[pulumi.Input[ClusterConfigurationExecuteCommandConfigurationLogConfigurationArgs]]): # -> None:
        ...
    ...
    @logging.setter
    def logging(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterConfigurationExecuteCommandConfigurationLogConfigurationArgs:
    def __init__(__self__, *, cloud_watch_encryption_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., cloud_watch_log_group_name: Optional[pulumi.Input[_builtins.str]] = ..., s3_bucket_encryption_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., s3_bucket_name: Optional[pulumi.Input[_builtins.str]] = ..., s3_key_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cloud_watch_encryption_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def cloud_watch_log_group_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def s3_bucket_encryption_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ClusterConfigurationManagedStorageConfigurationArgs:
    def __init__(__self__, *, fargate_ephemeral_storage_kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def fargate_ephemeral_storage_kms_key_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ExpressGatewayServiceIngressPathArgs:
    def __init__(__self__, *, access_type: pulumi.Input[_builtins.str], endpoint: pulumi.Input[_builtins.str]) -> None:
        ...
...
class ExpressGatewayServicePrimaryContainerArgs:
    def __init__(__self__, *, image: pulumi.Input[_builtins.str], aws_logs_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[ExpressGatewayServicePrimaryContainerAwsLogsConfigurationArgs]]]] = ..., commands: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., container_port: Optional[pulumi.Input[_builtins.int]] = ..., environments: Optional[pulumi.Input[Sequence[pulumi.Input[ExpressGatewayServicePrimaryContainerEnvironmentArgs]]]] = ..., repository_credentials: Optional[pulumi.Input[ExpressGatewayServicePrimaryContainerRepositoryCredentialsArgs]] = ..., secrets: Optional[pulumi.Input[Sequence[pulumi.Input[ExpressGatewayServicePrimaryContainerSecretArgs]]]] = ...) -> None:
    ...
    def aws_logs_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExpressGatewayServicePrimaryContainerAwsLogsConfigurationArgs]]]]): # -> None:
        ...
    ...
    @environments.setter
    def environments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExpressGatewayServicePrimaryContainerEnvironmentArgs]]]]): # -> None:
        ...
    ...
    def repository_credentials(self, value: Optional[pulumi.Input[ExpressGatewayServicePrimaryContainerRepositoryCredentialsArgs]]): # -> None:
        ...
    ...
    @secrets.setter
    def secrets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExpressGatewayServicePrimaryContainerSecretArgs]]]]): # -> None:
        ...
...
class ExpressGatewayServicePrimaryContainerAwsLogsConfigurationArgs:
    def __init__(__self__, *, log_group: pulumi.Input[_builtins.str], log_stream_prefix: pulumi.Input[_builtins.str]) -> None:
    ...
    def log_stream_prefix(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ExpressGatewayServicePrimaryContainerRepositoryCredentialsArgs:
    def __init__(__self__, *, credentials_parameter: pulumi.Input[_builtins.str]) -> None:
    ...
    def credentials_parameter(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ExpressGatewayServicePrimaryContainerSecretArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], value_from: pulumi.Input[_builtins.str]) -> None:
    ...
    @value_from.setter
    def value_from(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ExpressGatewayServiceScalingTargetArgs:
    def __init__(__self__, *, auto_scaling_metric: pulumi.Input[_builtins.str], auto_scaling_target_value: pulumi.Input[_builtins.int], max_task_count: pulumi.Input[_builtins.int], min_task_count: pulumi.Input[_builtins.int]) -> None:
    ...
    def auto_scaling_metric(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def auto_scaling_target_value(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def max_task_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def min_task_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ServiceAlarmsArgs:
    def __init__(__self__, *, alarm_names: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], enable: pulumi.Input[_builtins.bool], rollback: pulumi.Input[_builtins.bool]) -> None:
    ...
    @alarm_names.setter
    def alarm_names(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @rollback.setter
    def rollback(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class ServiceDeploymentCircuitBreakerArgs:
    def __init__(__self__, *, enable: pulumi.Input[_builtins.bool], rollback: pulumi.Input[_builtins.bool]) -> None:
...
class ServiceDeploymentConfigurationArgs:
    def __init__(__self__, *, bake_time_in_minutes: Optional[pulumi.Input[_builtins.str]] = ..., canary_configuration: Optional[pulumi.Input[ServiceDeploymentConfigurationCanaryConfigurationArgs]] = ..., lifecycle_hooks: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceDeploymentConfigurationLifecycleHookArgs]]]] = ..., linear_configuration: Optional[pulumi.Input[ServiceDeploymentConfigurationLinearConfigurationArgs]] = ..., strategy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def bake_time_in_minutes(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def canary_configuration(self, value: Optional[pulumi.Input[ServiceDeploymentConfigurationCanaryConfigurationArgs]]): # -> None:
        ...
    ...
    def lifecycle_hooks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceDeploymentConfigurationLifecycleHookArgs]]]]): # -> None:
        ...
    ...
    def linear_configuration(self, value: Optional[pulumi.Input[ServiceDeploymentConfigurationLinearConfigurationArgs]]): # -> None:
        ...
...
class ServiceDeploymentConfigurationCanaryConfigurationArgs:
    def __init__(__self__, *, canary_bake_time_in_minutes: Optional[pulumi.Input[_builtins.str]] = ..., canary_percent: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def canary_bake_time_in_minutes(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def canary_percent(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class ServiceDeploymentConfigurationLifecycleHookArgs:
    def __init__(__self__, *, hook_target_arn: pulumi.Input[_builtins.str], lifecycle_stages: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], role_arn: pulumi.Input[_builtins.str], hook_details: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def hook_target_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def lifecycle_stages(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @hook_details.setter
    def hook_details(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceDeploymentConfigurationLinearConfigurationArgs:
    def __init__(__self__, *, step_bake_time_in_minutes: Optional[pulumi.Input[_builtins.str]] = ..., step_percent: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def step_bake_time_in_minutes(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @step_percent.setter
    def step_percent(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class ServiceLoadBalancerArgs:
    def __init__(__self__, *, container_name: pulumi.Input[_builtins.str], container_port: pulumi.Input[_builtins.int], advanced_configuration: Optional[pulumi.Input[ServiceLoadBalancerAdvancedConfigurationArgs]] = ..., elb_name: Optional[pulumi.Input[_builtins.str]] = ..., target_group_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def advanced_configuration(self, value: Optional[pulumi.Input[ServiceLoadBalancerAdvancedConfigurationArgs]]): # -> None:
        ...
    ...
    @elb_name.setter
    def elb_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceLoadBalancerAdvancedConfigurationArgs:
    def __init__(__self__, *, alternate_target_group_arn: pulumi.Input[_builtins.str], production_listener_rule: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], test_listener_rule: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def alternate_target_group_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def production_listener_rule(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def test_listener_rule(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceServiceConnectConfigurationArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], access_log_configuration: Optional[pulumi.Input[ServiceServiceConnectConfigurationAccessLogConfigurationArgs]] = ..., log_configuration: Optional[pulumi.Input[ServiceServiceConnectConfigurationLogConfigurationArgs]] = ..., namespace: Optional[pulumi.Input[_builtins.str]] = ..., services: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceServiceConnectConfigurationServiceArgs]]]] = ...) -> None:
    ...
    def access_log_configuration(self, value: Optional[pulumi.Input[ServiceServiceConnectConfigurationAccessLogConfigurationArgs]]): # -> None:
        ...
    ...
    @log_configuration.setter
    def log_configuration(self, value: Optional[pulumi.Input[ServiceServiceConnectConfigurationLogConfigurationArgs]]): # -> None:
        ...
    ...
    @services.setter
    def services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceServiceConnectConfigurationServiceArgs]]]]): # -> None:
        ...
...
class ServiceServiceConnectConfigurationAccessLogConfigurationArgs:
    def __init__(__self__, *, format: pulumi.Input[_builtins.str], include_query_parameters: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def include_query_parameters(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceServiceConnectConfigurationLogConfigurationArgs:
    def __init__(__self__, *, log_driver: pulumi.Input[_builtins.str], options: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., secret_options: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceServiceConnectConfigurationLogConfigurationSecretOptionArgs]]]] = ...) -> None:
    ...
    @log_driver.setter
    def log_driver(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def secret_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceServiceConnectConfigurationLogConfigurationSecretOptionArgs]]]]): # -> None:
        ...
...
class ServiceServiceConnectConfigurationServiceArgs:
    def __init__(__self__, *, port_name: pulumi.Input[_builtins.str], client_alias: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceServiceConnectConfigurationServiceClientAliasArgs]]]] = ..., discovery_name: Optional[pulumi.Input[_builtins.str]] = ..., ingress_port_override: Optional[pulumi.Input[_builtins.int]] = ..., timeout: Optional[pulumi.Input[ServiceServiceConnectConfigurationServiceTimeoutArgs]] = ..., tls: Optional[pulumi.Input[ServiceServiceConnectConfigurationServiceTlsArgs]] = ...) -> None:
    ...
    @port_name.setter
    def port_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @client_alias.setter
    def client_alias(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceServiceConnectConfigurationServiceClientAliasArgs]]]]): # -> None:
        ...
    ...
    def discovery_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ingress_port_override(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @timeout.setter
    def timeout(self, value: Optional[pulumi.Input[ServiceServiceConnectConfigurationServiceTimeoutArgs]]): # -> None:
        ...
    ...
    @tls.setter
    def tls(self, value: Optional[pulumi.Input[ServiceServiceConnectConfigurationServiceTlsArgs]]): # -> None:
        ...
...
class ServiceServiceConnectConfigurationServiceClientAliasArgs:
    def __init__(__self__, *, port: pulumi.Input[_builtins.int], dns_name: Optional[pulumi.Input[_builtins.str]] = ..., test_traffic_rules: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceServiceConnectConfigurationServiceClientAliasTestTrafficRuleArgs]]]] = ...) -> None:
    ...
    def test_traffic_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceServiceConnectConfigurationServiceClientAliasTestTrafficRuleArgs]]]]): # -> None:
        ...
...
class ServiceServiceConnectConfigurationServiceClientAliasTestTrafficRuleArgs:
    def __init__(__self__, *, header: Optional[pulumi.Input[ServiceServiceConnectConfigurationServiceClientAliasTestTrafficRuleHeaderArgs]] = ...) -> None:
    ...
    @header.setter
    def header(self, value: Optional[pulumi.Input[ServiceServiceConnectConfigurationServiceClientAliasTestTrafficRuleHeaderArgs]]): # -> None:
        ...
...
class ServiceServiceConnectConfigurationServiceClientAliasTestTrafficRuleHeaderArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], value: pulumi.Input[ServiceServiceConnectConfigurationServiceClientAliasTestTrafficRuleHeaderValueArgs]) -> None:
    ...
    @value.setter
    def value(self, value: pulumi.Input[ServiceServiceConnectConfigurationServiceClientAliasTestTrafficRuleHeaderValueArgs]): # -> None:
        ...
...
class ServiceServiceConnectConfigurationServiceTimeoutArgs:
    def __init__(__self__, *, idle_timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ..., per_request_timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def idle_timeout_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def per_request_timeout_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ServiceServiceConnectConfigurationServiceTlsArgs:
    def __init__(__self__, *, issuer_cert_authority: pulumi.Input[ServiceServiceConnectConfigurationServiceTlsIssuerCertAuthorityArgs], kms_key: Optional[pulumi.Input[_builtins.str]] = ..., role_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def issuer_cert_authority(self, value: pulumi.Input[ServiceServiceConnectConfigurationServiceTlsIssuerCertAuthorityArgs]): # -> None:
        ...
...
class ServiceServiceConnectConfigurationServiceTlsIssuerCertAuthorityArgs:
    def __init__(__self__, *, aws_pca_authority_arn: pulumi.Input[_builtins.str]) -> None:
    ...
    def aws_pca_authority_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ServiceServiceRegistriesArgs:
    def __init__(__self__, *, registry_arn: pulumi.Input[_builtins.str], container_name: Optional[pulumi.Input[_builtins.str]] = ..., container_port: Optional[pulumi.Input[_builtins.int]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @registry_arn.setter
    def registry_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ServiceVolumeConfigurationArgs:
    def __init__(__self__, *, managed_ebs_volume: pulumi.Input[ServiceVolumeConfigurationManagedEbsVolumeArgs], name: pulumi.Input[_builtins.str]) -> None:
    ...
    def managed_ebs_volume(self, value: pulumi.Input[ServiceVolumeConfigurationManagedEbsVolumeArgs]): # -> None:
        ...
...
class ServiceVolumeConfigurationManagedEbsVolumeArgs:
    def __init__(__self__, *, role_arn: pulumi.Input[_builtins.str], encrypted: Optional[pulumi.Input[_builtins.bool]] = ..., file_system_type: Optional[pulumi.Input[_builtins.str]] = ..., iops: Optional[pulumi.Input[_builtins.int]] = ..., kms_key_id: Optional[pulumi.Input[_builtins.str]] = ..., size_in_gb: Optional[pulumi.Input[_builtins.int]] = ..., snapshot_id: Optional[pulumi.Input[_builtins.str]] = ..., tag_specifications: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceVolumeConfigurationManagedEbsVolumeTagSpecificationArgs]]]] = ..., throughput: Optional[pulumi.Input[_builtins.int]] = ..., volume_initialization_rate: Optional[pulumi.Input[_builtins.int]] = ..., volume_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def file_system_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def tag_specifications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceVolumeConfigurationManagedEbsVolumeTagSpecificationArgs]]]]): # -> None:
        ...
...
class ServiceVolumeConfigurationManagedEbsVolumeTagSpecificationArgs:
    def __init__(__self__, *, resource_type: pulumi.Input[_builtins.str], propagate_tags: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ServiceVpcLatticeConfigurationArgs:
    def __init__(__self__, *, port_name: pulumi.Input[_builtins.str], role_arn: pulumi.Input[_builtins.str], target_group_arn: pulumi.Input[_builtins.str]) -> None:
    ...
    @target_group_arn.setter
    def target_group_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TaskDefinitionEphemeralStorageArgs:
    ...
    @size_in_gib.setter
    def size_in_gib(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class TaskDefinitionProxyConfigurationArgs:
    def __init__(__self__, *, container_name: pulumi.Input[_builtins.str], properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TaskDefinitionRuntimePlatformArgs:
    def __init__(__self__, *, cpu_architecture: Optional[pulumi.Input[_builtins.str]] = ..., operating_system_family: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cpu_architecture(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def operating_system_family(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TaskDefinitionVolumeArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], configure_at_launch: Optional[pulumi.Input[_builtins.bool]] = ..., docker_volume_configuration: Optional[pulumi.Input[TaskDefinitionVolumeDockerVolumeConfigurationArgs]] = ..., efs_volume_configuration: Optional[pulumi.Input[TaskDefinitionVolumeEfsVolumeConfigurationArgs]] = ..., fsx_windows_file_server_volume_configuration: Optional[pulumi.Input[TaskDefinitionVolumeFsxWindowsFileServerVolumeConfigurationArgs]] = ..., host_path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def configure_at_launch(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def docker_volume_configuration(self, value: Optional[pulumi.Input[TaskDefinitionVolumeDockerVolumeConfigurationArgs]]): # -> None:
        ...
    ...
    def efs_volume_configuration(self, value: Optional[pulumi.Input[TaskDefinitionVolumeEfsVolumeConfigurationArgs]]): # -> None:
        ...
    ...
    def fsx_windows_file_server_volume_configuration(self, value: Optional[pulumi.Input[TaskDefinitionVolumeFsxWindowsFileServerVolumeConfigurationArgs]]): # -> None:
        ...
    ...
    @host_path.setter
    def host_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TaskDefinitionVolumeDockerVolumeConfigurationArgs:
    def __init__(__self__, *, autoprovision: Optional[pulumi.Input[_builtins.bool]] = ..., driver: Optional[pulumi.Input[_builtins.str]] = ..., driver_opts: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., scope: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def autoprovision(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @driver.setter
    def driver(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @driver_opts.setter
    def driver_opts(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class TaskDefinitionVolumeEfsVolumeConfigurationArgs:
    def __init__(__self__, *, file_system_id: pulumi.Input[_builtins.str], authorization_config: Optional[pulumi.Input[TaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfigArgs]] = ..., root_directory: Optional[pulumi.Input[_builtins.str]] = ..., transit_encryption: Optional[pulumi.Input[_builtins.str]] = ..., transit_encryption_port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def authorization_config(self, value: Optional[pulumi.Input[TaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfigArgs]]): # -> None:
        ...
    ...
    def root_directory(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def transit_encryption(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def transit_encryption_port(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class TaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfigArgs:
    def __init__(__self__, *, access_point_id: Optional[pulumi.Input[_builtins.str]] = ..., iam: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def access_point_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TaskDefinitionVolumeFsxWindowsFileServerVolumeConfigurationArgs:
    def __init__(__self__, *, authorization_config: pulumi.Input[TaskDefinitionVolumeFsxWindowsFileServerVolumeConfigurationAuthorizationConfigArgs], file_system_id: pulumi.Input[_builtins.str], root_directory: pulumi.Input[_builtins.str]) -> None:
    ...
    @authorization_config.setter
    def authorization_config(self, value: pulumi.Input[TaskDefinitionVolumeFsxWindowsFileServerVolumeConfigurationAuthorizationConfigArgs]): # -> None:
        ...
...
class TaskDefinitionVolumeFsxWindowsFileServerVolumeConfigurationAuthorizationConfigArgs:
    def __init__(__self__, *, credentials_parameter: pulumi.Input[_builtins.str], domain: pulumi.Input[_builtins.str]) -> None:
...
class TaskSetCapacityProviderStrategyArgs:
    def __init__(__self__, *, capacity_provider: pulumi.Input[_builtins.str], weight: pulumi.Input[_builtins.int], base: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class TaskSetLoadBalancerArgs:
    def __init__(__self__, *, container_name: pulumi.Input[_builtins.str], container_port: Optional[pulumi.Input[_builtins.int]] = ..., load_balancer_name: Optional[pulumi.Input[_builtins.str]] = ..., target_group_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TaskSetScaleArgs:
    def __init__(__self__, *, unit: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
...
class GetTaskExecutionCapacityProviderStrategyArgs:
    ...
    @capacity_provider.setter
    def capacity_provider(self, value: _builtins.str): # -> None:
        ...
    ...
    @base.setter
    def base(self, value: Optional[_builtins.int]): # -> None:
        ...
    ...
    @weight.setter
    def weight(self, value: Optional[_builtins.int]): # -> None:
        ...
...
class GetTaskExecutionNetworkConfigurationArgs:
    ...
    @subnets.setter
    def subnets(self, value: Sequence[_builtins.str]): # -> None:
        ...
    ...
    @assign_public_ip.setter
    def assign_public_ip(self, value: Optional[_builtins.bool]): # -> None:
        ...
    ...
    @security_groups.setter
    def security_groups(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
...
class GetTaskExecutionOverridesArgs:
    def __init__(__self__, *, container_overrides: Optional[Sequence[GetTaskExecutionOverridesContainerOverrideArgs]] = ..., cpu: Optional[_builtins.str] = ..., execution_role_arn: Optional[_builtins.str] = ..., memory: Optional[_builtins.str] = ..., task_role_arn: Optional[_builtins.str] = ...) -> None:
    ...
    def container_overrides(self, value: Optional[Sequence[GetTaskExecutionOverridesContainerOverrideArgs]]): # -> None:
        ...
    ...
    @cpu.setter
    def cpu(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def execution_role_arn(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    @memory.setter
    def memory(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def task_role_arn(self, value: Optional[_builtins.str]): # -> None:
        ...
...
class GetTaskExecutionOverridesContainerOverrideArgs:
    def __init__(__self__, *, name: _builtins.str, commands: Optional[Sequence[_builtins.str]] = ..., cpu: Optional[_builtins.int] = ..., environments: Optional[Sequence[GetTaskExecutionOverridesContainerOverrideEnvironmentArgs]] = ..., memory: Optional[_builtins.int] = ..., memory_reservation: Optional[_builtins.int] = ..., resource_requirements: Optional[Sequence[GetTaskExecutionOverridesContainerOverrideResourceRequirementArgs]] = ...) -> None:
    ...
    @commands.setter
    def commands(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    @cpu.setter
    def cpu(self, value: Optional[_builtins.int]): # -> None:
        ...
    ...
    @environments.setter
    def environments(self, value: Optional[Sequence[GetTaskExecutionOverridesContainerOverrideEnvironmentArgs]]): # -> None:
        ...
    ...
    @memory.setter
    def memory(self, value: Optional[_builtins.int]): # -> None:
        ...
    ...
    def memory_reservation(self, value: Optional[_builtins.int]): # -> None:
        ...
    ...
    def resource_requirements(self, value: Optional[Sequence[GetTaskExecutionOverridesContainerOverrideResourceRequirementArgs]]): # -> None:
        ...
...
class GetTaskExecutionPlacementConstraintArgs:
    ...
    @expression.setter
    def expression(self, value: Optional[_builtins.str]): # -> None:
        ...
