...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = [..., ..., 'DeploymentTimeoutsArgs', 'DeploymentTimeoutsArgsDict', 'ObservabilityConfigurationTraceConfigurationArgs', ..., 'ServiceEncryptionConfigurationArgs', 'ServiceEncryptionConfigurationArgsDict', 'ServiceHealthCheckConfigurationArgs', 'ServiceHealthCheckConfigurationArgsDict', 'ServiceInstanceConfigurationArgs', 'ServiceInstanceConfigurationArgsDict', 'ServiceNetworkConfigurationArgs', 'ServiceNetworkConfigurationArgsDict', 'ServiceNetworkConfigurationEgressConfigurationArgs', ..., ..., ..., 'ServiceObservabilityConfigurationArgs', 'ServiceObservabilityConfigurationArgsDict', 'ServiceSourceConfigurationArgs', 'ServiceSourceConfigurationArgsDict', ..., ..., 'ServiceSourceConfigurationCodeRepositoryArgs', 'ServiceSourceConfigurationCodeRepositoryArgsDict', ..., ..., ..., ..., ..., ..., 'ServiceSourceConfigurationImageRepositoryArgs', 'ServiceSourceConfigurationImageRepositoryArgsDict', ..., ..., 'VpcIngressConnectionIngressVpcConfigurationArgs', ...]
...
class CustomDomainAssociationCertificateValidationRecordArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ObservabilityConfigurationTraceConfigurationArgs:
    def __init__(__self__, *, vendor: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServiceHealthCheckConfigurationArgs:
    def __init__(__self__, *, healthy_threshold: Optional[pulumi.Input[_builtins.int]] = ..., interval: Optional[pulumi.Input[_builtins.int]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., protocol: Optional[pulumi.Input[_builtins.str]] = ..., timeout: Optional[pulumi.Input[_builtins.int]] = ..., unhealthy_threshold: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ServiceInstanceConfigurationArgs:
    def __init__(__self__, *, cpu: Optional[pulumi.Input[_builtins.str]] = ..., instance_role_arn: Optional[pulumi.Input[_builtins.str]] = ..., memory: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def instance_role_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceNetworkConfigurationArgs:
    def __init__(__self__, *, egress_configuration: Optional[pulumi.Input[ServiceNetworkConfigurationEgressConfigurationArgs]] = ..., ingress_configuration: Optional[pulumi.Input[ServiceNetworkConfigurationIngressConfigurationArgs]] = ..., ip_address_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def egress_configuration(self, value: Optional[pulumi.Input[ServiceNetworkConfigurationEgressConfigurationArgs]]): # -> None:
        ...
    ...
    def ingress_configuration(self, value: Optional[pulumi.Input[ServiceNetworkConfigurationIngressConfigurationArgs]]): # -> None:
        ...
...
class ServiceNetworkConfigurationEgressConfigurationArgs:
    def __init__(__self__, *, egress_type: Optional[pulumi.Input[_builtins.str]] = ..., vpc_connector_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @egress_type.setter
    def egress_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def vpc_connector_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceNetworkConfigurationIngressConfigurationArgs:
    def __init__(__self__, *, is_publicly_accessible: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def is_publicly_accessible(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ServiceObservabilityConfigurationArgs:
    def __init__(__self__, *, observability_enabled: pulumi.Input[_builtins.bool], observability_configuration_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def observability_enabled(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def observability_configuration_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceSourceConfigurationArgs:
    def __init__(__self__, *, authentication_configuration: Optional[pulumi.Input[ServiceSourceConfigurationAuthenticationConfigurationArgs]] = ..., auto_deployments_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., code_repository: Optional[pulumi.Input[ServiceSourceConfigurationCodeRepositoryArgs]] = ..., image_repository: Optional[pulumi.Input[ServiceSourceConfigurationImageRepositoryArgs]] = ...) -> None:
    ...
    def authentication_configuration(self, value: Optional[pulumi.Input[ServiceSourceConfigurationAuthenticationConfigurationArgs]]): # -> None:
        ...
    ...
    def auto_deployments_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def code_repository(self, value: Optional[pulumi.Input[ServiceSourceConfigurationCodeRepositoryArgs]]): # -> None:
        ...
    ...
    def image_repository(self, value: Optional[pulumi.Input[ServiceSourceConfigurationImageRepositoryArgs]]): # -> None:
        ...
...
class ServiceSourceConfigurationAuthenticationConfigurationArgs:
    def __init__(__self__, *, access_role_arn: Optional[pulumi.Input[_builtins.str]] = ..., connection_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def access_role_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceSourceConfigurationCodeRepositoryArgs:
    def __init__(__self__, *, repository_url: pulumi.Input[_builtins.str], source_code_version: pulumi.Input[ServiceSourceConfigurationCodeRepositorySourceCodeVersionArgs], code_configuration: Optional[pulumi.Input[ServiceSourceConfigurationCodeRepositoryCodeConfigurationArgs]] = ..., source_directory: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def source_code_version(self, value: pulumi.Input[ServiceSourceConfigurationCodeRepositorySourceCodeVersionArgs]): # -> None:
        ...
    ...
    def code_configuration(self, value: Optional[pulumi.Input[ServiceSourceConfigurationCodeRepositoryCodeConfigurationArgs]]): # -> None:
        ...
    ...
    def source_directory(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceSourceConfigurationCodeRepositoryCodeConfigurationArgs:
    def __init__(__self__, *, configuration_source: pulumi.Input[_builtins.str], code_configuration_values: Optional[pulumi.Input[ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValuesArgs]] = ...) -> None:
    ...
    def configuration_source(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def code_configuration_values(self, value: Optional[pulumi.Input[ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValuesArgs]]): # -> None:
        ...
...
class ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValuesArgs:
    def __init__(__self__, *, runtime: pulumi.Input[_builtins.str], build_command: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.str]] = ..., runtime_environment_secrets: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., runtime_environment_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., start_command: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def build_command(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def runtime_environment_secrets(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def runtime_environment_variables(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def start_command(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceSourceConfigurationImageRepositoryArgs:
    def __init__(__self__, *, image_identifier: pulumi.Input[_builtins.str], image_repository_type: pulumi.Input[_builtins.str], image_configuration: Optional[pulumi.Input[ServiceSourceConfigurationImageRepositoryImageConfigurationArgs]] = ...) -> None:
    ...
    def image_identifier(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def image_repository_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def image_configuration(self, value: Optional[pulumi.Input[ServiceSourceConfigurationImageRepositoryImageConfigurationArgs]]): # -> None:
        ...
...
class ServiceSourceConfigurationImageRepositoryImageConfigurationArgs:
    def __init__(__self__, *, port: Optional[pulumi.Input[_builtins.str]] = ..., runtime_environment_secrets: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., runtime_environment_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., start_command: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VpcIngressConnectionIngressVpcConfigurationArgs:
    def __init__(__self__, *, vpc_endpoint_id: Optional[pulumi.Input[_builtins.str]] = ..., vpc_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
