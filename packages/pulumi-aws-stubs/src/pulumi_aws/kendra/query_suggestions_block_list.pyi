...
class QuerySuggestionsBlockListArgs:
    ...
    def source_s3_path(
        self,
    ) -> pulumi.Input[QuerySuggestionsBlockListSourceS3PathArgs]: ...
    @source_s3_path.setter
    def source_s3_path(
        self, value: pulumi.Input[QuerySuggestionsBlockListSourceS3PathArgs]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _QuerySuggestionsBlockListState:
    ...
    def query_suggestions_block_list_id(
        self,
    ...
    def source_s3_path(
        self,
    ) -> Optional[pulumi.Input[QuerySuggestionsBlockListSourceS3PathArgs]]: ...
    @source_s3_path.setter
    def source_s3_path(
        self, value: Optional[pulumi.Input[QuerySuggestionsBlockListSourceS3PathArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class QuerySuggestionsBlockList(pulumi.CustomResource):
    ...
    def source_s3_path(
        self,
    ) -> pulumi.Output[outputs.QuerySuggestionsBlockListSourceS3Path]: ...
    @_builtins.property
    @pulumi.getter
