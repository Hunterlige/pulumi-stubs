...
class GetIndexResult:
    ...
    def __init__(__self__, arn=..., capacity_units=..., created_at=..., description=..., document_metadata_configuration_updates=..., edition=..., error_message=..., id=..., index_statistics=..., name=..., region=..., role_arn=..., server_side_encryption_configurations=..., status=..., tags=..., updated_at=..., user_context_policy=..., user_group_resolution_configurations=..., user_token_configurations=...) -> None:
        ...
...
class AwaitableGetIndexResult(GetIndexResult):
    def __await__(self): # -> Generator[Never, Any, GetIndexResult]:
        ...
    


def get_index(id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetIndexResult:
    
    ...

def get_index_output(id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetIndexResult]:
