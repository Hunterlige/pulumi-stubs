...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DataSourceConfiguration', 'DataSourceConfigurationS3Configuration', ..., ..., 'DataSourceConfigurationTemplateConfiguration', 'DataSourceConfigurationWebCrawlerConfiguration', ..., ..., ..., 'DataSourceConfigurationWebCrawlerConfigurationUrls', ..., ..., 'DataSourceCustomDocumentEnrichmentConfiguration', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ExperienceConfiguration', 'ExperienceConfigurationContentSourceConfiguration', 'ExperienceConfigurationUserIdentityConfiguration', 'ExperienceEndpoint', 'FaqS3Path', 'IndexCapacityUnits', 'IndexDocumentMetadataConfigurationUpdate', 'IndexDocumentMetadataConfigurationUpdateRelevance', 'IndexDocumentMetadataConfigurationUpdateSearch', 'IndexIndexStatistic', 'IndexIndexStatisticFaqStatistic', 'IndexIndexStatisticTextDocumentStatistic', 'IndexServerSideEncryptionConfiguration', 'IndexUserGroupResolutionConfiguration', 'IndexUserTokenConfigurations', ..., ..., 'QuerySuggestionsBlockListSourceS3Path', 'ThesaurusSourceS3Path', 'GetExperienceConfigurationResult', ..., ..., 'GetExperienceEndpointResult', 'GetFaqS3PathResult', 'GetIndexCapacityUnitResult', 'GetIndexDocumentMetadataConfigurationUpdateResult', ..., ..., 'GetIndexIndexStatisticResult', 'GetIndexIndexStatisticFaqStatisticResult', 'GetIndexIndexStatisticTextDocumentStatisticResult', 'GetIndexServerSideEncryptionConfigurationResult', 'GetIndexUserGroupResolutionConfigurationResult', 'GetIndexUserTokenConfigurationResult', ..., ..., 'GetQuerySuggestionsBlockListSourceS3PathResult', 'GetThesaurusSourceS3PathResult']
@pulumi.output_type
class DataSourceConfiguration(dict):
    ...
    def __init__(__self__, *, s3_configuration: Optional[outputs.DataSourceConfigurationS3Configuration] = ..., template_configuration: Optional[outputs.DataSourceConfigurationTemplateConfiguration] = ..., web_crawler_configuration: Optional[outputs.DataSourceConfigurationWebCrawlerConfiguration] = ...) -> None:
...
class DataSourceConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *, bucket_name: _builtins.str, access_control_list_configuration: Optional[outputs.DataSourceConfigurationS3ConfigurationAccessControlListConfiguration] = ..., documents_metadata_configuration: Optional[outputs.DataSourceConfigurationS3ConfigurationDocumentsMetadataConfiguration] = ..., exclusion_patterns: Optional[Sequence[_builtins.str]] = ..., inclusion_patterns: Optional[Sequence[_builtins.str]] = ..., inclusion_prefixes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DataSourceConfigurationWebCrawlerConfiguration(dict):
    ...
    def __init__(__self__, *, urls: outputs.DataSourceConfigurationWebCrawlerConfigurationUrls, authentication_configuration: Optional[outputs.DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfiguration] = ..., crawl_depth: Optional[_builtins.int] = ..., max_content_size_per_page_in_mega_bytes: Optional[_builtins.float] = ..., max_links_per_page: Optional[_builtins.int] = ..., max_urls_per_minute_crawl_rate: Optional[_builtins.int] = ..., proxy_configuration: Optional[outputs.DataSourceConfigurationWebCrawlerConfigurationProxyConfiguration] = ..., url_exclusion_patterns: Optional[Sequence[_builtins.str]] = ..., url_inclusion_patterns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfiguration(dict):
    ...
    def __init__(__self__, *, basic_authentications: Optional[Sequence[outputs.DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfigurationBasicAuthentication]] = ...) -> None:
...
class DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfigurationBasicAuthentication(dict):
    def __init__(__self__, *, credentials: _builtins.str, host: _builtins.str, port: _builtins.int) -> None:
...
class DataSourceConfigurationWebCrawlerConfigurationProxyConfiguration(dict):
    def __init__(__self__, *, host: _builtins.str, port: _builtins.int, credentials: Optional[_builtins.str] = ...) -> None:
...
class DataSourceConfigurationWebCrawlerConfigurationUrls(dict):
    ...
    def __init__(__self__, *, seed_url_configuration: Optional[outputs.DataSourceConfigurationWebCrawlerConfigurationUrlsSeedUrlConfiguration] = ..., site_maps_configuration: Optional[outputs.DataSourceConfigurationWebCrawlerConfigurationUrlsSiteMapsConfiguration] = ...) -> None:
...
class DataSourceConfigurationWebCrawlerConfigurationUrlsSeedUrlConfiguration(dict):
    ...
    def __init__(__self__, *, seed_urls: Sequence[_builtins.str], web_crawler_mode: Optional[_builtins.str] = ...) -> None:
...
class DataSourceCustomDocumentEnrichmentConfiguration(dict):
    ...
    def __init__(__self__, *, inline_configurations: Optional[Sequence[outputs.DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration]] = ..., post_extraction_hook_configuration: Optional[outputs.DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration] = ..., pre_extraction_hook_configuration: Optional[outputs.DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration] = ..., role_arn: Optional[_builtins.str] = ...) -> None:
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration(dict):
    ...
    def __init__(__self__, *, condition: Optional[outputs.DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationCondition] = ..., document_content_deletion: Optional[_builtins.bool] = ..., target: Optional[outputs.DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget] = ...) -> None:
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationCondition(dict):
    ...
    def __init__(__self__, *, condition_document_attribute_key: _builtins.str, operator: _builtins.str, condition_on_value: Optional[outputs.DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue] = ...) -> None:
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue(dict):
    ...
    def __init__(__self__, *, date_value: Optional[_builtins.str] = ..., long_value: Optional[_builtins.int] = ..., string_list_values: Optional[Sequence[_builtins.str]] = ..., string_value: Optional[_builtins.str] = ...) -> None:
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget(dict):
    ...
    def __init__(__self__, *, target_document_attribute_key: Optional[_builtins.str] = ..., target_document_attribute_value: Optional[outputs.DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTargetTargetDocumentAttributeValue] = ..., target_document_attribute_value_deletion: Optional[_builtins.bool] = ...) -> None:
...
class DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration(dict):
    ...
    def __init__(__self__, *, lambda_arn: _builtins.str, s3_bucket: _builtins.str, invocation_condition: Optional[outputs.DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationCondition] = ...) -> None:
...
class DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationCondition(dict):
    ...
    def __init__(__self__, *, condition_document_attribute_key: _builtins.str, operator: _builtins.str, condition_on_value: Optional[outputs.DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationConditionConditionOnValue] = ...) -> None:
...
class DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration(dict):
    ...
    def __init__(__self__, *, lambda_arn: _builtins.str, s3_bucket: _builtins.str, invocation_condition: Optional[outputs.DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition] = ...) -> None:
...
class DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition(dict):
    ...
    def __init__(__self__, *, condition_document_attribute_key: _builtins.str, operator: _builtins.str, condition_on_value: Optional[outputs.DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue] = ...) -> None:
...
class ExperienceConfiguration(dict):
    ...
    def __init__(__self__, *, content_source_configuration: Optional[outputs.ExperienceConfigurationContentSourceConfiguration] = ..., user_identity_configuration: Optional[outputs.ExperienceConfigurationUserIdentityConfiguration] = ...) -> None:
...
class ExperienceConfigurationContentSourceConfiguration(dict):
    ...
    def __init__(__self__, *, data_source_ids: Optional[Sequence[_builtins.str]] = ..., direct_put_content: Optional[_builtins.bool] = ..., faq_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ExperienceEndpoint(dict):
    ...
    def __init__(__self__, *, endpoint: Optional[_builtins.str] = ..., endpoint_type: Optional[_builtins.str] = ...) -> None:
...
class IndexCapacityUnits(dict):
    ...
    def __init__(__self__, *, query_capacity_units: Optional[_builtins.int] = ..., storage_capacity_units: Optional[_builtins.int] = ...) -> None:
...
class IndexDocumentMetadataConfigurationUpdate(dict):
    def __init__(__self__, *, name: _builtins.str, type: _builtins.str, relevance: Optional[outputs.IndexDocumentMetadataConfigurationUpdateRelevance] = ..., search: Optional[outputs.IndexDocumentMetadataConfigurationUpdateSearch] = ...) -> None:
...
class IndexDocumentMetadataConfigurationUpdateRelevance(dict):
    ...
    def __init__(__self__, *, duration: Optional[_builtins.str] = ..., freshness: Optional[_builtins.bool] = ..., importance: Optional[_builtins.int] = ..., rank_order: Optional[_builtins.str] = ..., values_importance_map: Optional[Mapping[str, _builtins.int]] = ...) -> None:
...
class IndexDocumentMetadataConfigurationUpdateSearch(dict):
    def __init__(__self__, *, displayable: Optional[_builtins.bool] = ..., facetable: Optional[_builtins.bool] = ..., searchable: Optional[_builtins.bool] = ..., sortable: Optional[_builtins.bool] = ...) -> None:
...
class IndexIndexStatistic(dict):
    ...
    def __init__(__self__, *, faq_statistics: Optional[Sequence[outputs.IndexIndexStatisticFaqStatistic]] = ..., text_document_statistics: Optional[Sequence[outputs.IndexIndexStatisticTextDocumentStatistic]] = ...) -> None:
...
class IndexIndexStatisticFaqStatistic(dict):
    ...
    def __init__(__self__, *, indexed_question_answers_count: Optional[_builtins.int] = ...) -> None:
...
class IndexIndexStatisticTextDocumentStatistic(dict):
    ...
    def __init__(__self__, *, indexed_text_bytes: Optional[_builtins.int] = ..., indexed_text_documents_count: Optional[_builtins.int] = ...) -> None:
...
class IndexUserTokenConfigurations(dict):
    ...
    def __init__(__self__, *, json_token_type_configuration: Optional[outputs.IndexUserTokenConfigurationsJsonTokenTypeConfiguration] = ..., jwt_token_type_configuration: Optional[outputs.IndexUserTokenConfigurationsJwtTokenTypeConfiguration] = ...) -> None:
...
class IndexUserTokenConfigurationsJsonTokenTypeConfiguration(dict):
    ...
    def __init__(__self__, *, group_attribute_field: _builtins.str, user_name_attribute_field: _builtins.str) -> None:
...
class IndexUserTokenConfigurationsJwtTokenTypeConfiguration(dict):
    ...
    def __init__(__self__, *, key_location: _builtins.str, claim_regex: Optional[_builtins.str] = ..., group_attribute_field: Optional[_builtins.str] = ..., issuer: Optional[_builtins.str] = ..., secrets_manager_arn: Optional[_builtins.str] = ..., url: Optional[_builtins.str] = ..., user_name_attribute_field: Optional[_builtins.str] = ...) -> None:
...
class GetExperienceConfigurationResult(dict):
    def __init__(__self__, *, content_source_configurations: Sequence[outputs.GetExperienceConfigurationContentSourceConfigurationResult], user_identity_configurations: Sequence[outputs.GetExperienceConfigurationUserIdentityConfigurationResult]) -> None:
...
class GetExperienceConfigurationContentSourceConfigurationResult(dict):
    def __init__(__self__, *, data_source_ids: Sequence[_builtins.str], direct_put_content: _builtins.bool, faq_ids: Sequence[_builtins.str]) -> None:
...
class GetExperienceEndpointResult(dict):
    def __init__(__self__, *, endpoint: _builtins.str, endpoint_type: _builtins.str) -> None:
...
class GetIndexCapacityUnitResult(dict):
    def __init__(__self__, *, query_capacity_units: _builtins.int, storage_capacity_units: _builtins.int) -> None:
...
class GetIndexDocumentMetadataConfigurationUpdateResult(dict):
    def __init__(__self__, *, name: _builtins.str, relevances: Sequence[outputs.GetIndexDocumentMetadataConfigurationUpdateRelevanceResult], searches: Sequence[outputs.GetIndexDocumentMetadataConfigurationUpdateSearchResult], type: _builtins.str) -> None:
...
class GetIndexDocumentMetadataConfigurationUpdateRelevanceResult(dict):
    def __init__(__self__, *, duration: _builtins.str, freshness: _builtins.bool, importance: _builtins.int, rank_order: _builtins.str, values_importance_map: Mapping[str, _builtins.int]) -> None:
...
class GetIndexDocumentMetadataConfigurationUpdateSearchResult(dict):
    def __init__(__self__, *, displayable: _builtins.bool, facetable: _builtins.bool, searchable: _builtins.bool, sortable: _builtins.bool) -> None:
...
class GetIndexIndexStatisticResult(dict):
    def __init__(__self__, *, faq_statistics: Sequence[outputs.GetIndexIndexStatisticFaqStatisticResult], text_document_statistics: Sequence[outputs.GetIndexIndexStatisticTextDocumentStatisticResult]) -> None:
...
class GetIndexIndexStatisticFaqStatisticResult(dict):
    def __init__(__self__, *, indexed_question_answers_count: _builtins.int) -> None:
...
class GetIndexIndexStatisticTextDocumentStatisticResult(dict):
    def __init__(__self__, *, indexed_text_bytes: _builtins.int, indexed_text_documents_count: _builtins.int) -> None:
...
class GetIndexUserTokenConfigurationResult(dict):
    def __init__(__self__, *, json_token_type_configurations: Sequence[outputs.GetIndexUserTokenConfigurationJsonTokenTypeConfigurationResult], jwt_token_type_configurations: Sequence[outputs.GetIndexUserTokenConfigurationJwtTokenTypeConfigurationResult]) -> None:
...
class GetIndexUserTokenConfigurationJwtTokenTypeConfigurationResult(dict):
    def __init__(__self__, *, claim_regex: _builtins.str, group_attribute_field: _builtins.str, issuer: _builtins.str, key_location: _builtins.str, secrets_manager_arn: _builtins.str, url: _builtins.str, user_name_attribute_field: _builtins.str) -> None:
