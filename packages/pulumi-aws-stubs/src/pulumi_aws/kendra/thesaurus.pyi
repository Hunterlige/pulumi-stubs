...
class _ThesaurusState:
    def __init__(
        ...
        *,
        ...
        source_s3_path: Optional[pulumi.Input[ThesaurusSourceS3PathArgs]] = ...,
    ...
    @source_s3_path.setter
    def source_s3_path(
        self, value: Optional[pulumi.Input[ThesaurusSourceS3PathArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    ...
    @thesaurus_id.setter
    def thesaurus_id(self, value: Optional[pulumi.Input[_builtins.str]]): ...
...
class Thesaurus(pulumi.CustomResource):
    ...
    def __init__(
        ...
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        role_arn: Optional[pulumi.Input[_builtins.str]] = ...,
        source_s3_path: Optional[
            pulumi.Input[
                Union[ThesaurusSourceS3PathArgs, ThesaurusSourceS3PathArgsDict]
            ]
        ] = ...,
        tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        __props__=...,
