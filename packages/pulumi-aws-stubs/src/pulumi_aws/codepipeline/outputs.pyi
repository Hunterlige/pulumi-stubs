...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CustomActionTypeConfigurationProperty', 'CustomActionTypeInputArtifactDetails', 'CustomActionTypeOutputArtifactDetails', 'CustomActionTypeSettings', 'PipelineArtifactStore', 'PipelineArtifactStoreEncryptionKey', 'PipelineStage', 'PipelineStageAction', 'PipelineStageBeforeEntry', 'PipelineStageBeforeEntryCondition', 'PipelineStageBeforeEntryConditionRule', 'PipelineStageBeforeEntryConditionRuleRuleTypeId', 'PipelineStageOnFailure', 'PipelineStageOnFailureCondition', 'PipelineStageOnFailureConditionRule', 'PipelineStageOnFailureConditionRuleRuleTypeId', 'PipelineStageOnFailureRetryConfiguration', 'PipelineStageOnSuccess', 'PipelineStageOnSuccessCondition', 'PipelineStageOnSuccessConditionRule', 'PipelineStageOnSuccessConditionRuleRuleTypeId', 'PipelineTrigger', 'PipelineTriggerAll', 'PipelineTriggerAllGitConfiguration', 'PipelineTriggerAllGitConfigurationPullRequest', ..., ..., 'PipelineTriggerAllGitConfigurationPush', 'PipelineTriggerAllGitConfigurationPushBranch', 'PipelineTriggerAllGitConfigurationPushFilePath', 'PipelineTriggerAllGitConfigurationPushTag', 'PipelineTriggerGitConfiguration', 'PipelineTriggerGitConfigurationPullRequest', 'PipelineTriggerGitConfigurationPullRequestBranches', ..., 'PipelineTriggerGitConfigurationPush', 'PipelineTriggerGitConfigurationPushBranches', 'PipelineTriggerGitConfigurationPushFilePaths', 'PipelineTriggerGitConfigurationPushTags', 'PipelineVariable', 'WebhookAuthenticationConfiguration', 'WebhookFilter']
@pulumi.output_type
class CustomActionTypeConfigurationProperty(dict):
    def __init__(__self__, *, key: _builtins.bool, name: _builtins.str, required: _builtins.bool, secret: _builtins.bool, description: Optional[_builtins.str] = ..., queryable: Optional[_builtins.bool] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class CustomActionTypeInputArtifactDetails(dict):
    ...
    def __init__(__self__, *, maximum_count: _builtins.int, minimum_count: _builtins.int) -> None:
...
class CustomActionTypeSettings(dict):
    ...
    def __init__(__self__, *, entity_url_template: Optional[_builtins.str] = ..., execution_url_template: Optional[_builtins.str] = ..., revision_url_template: Optional[_builtins.str] = ..., third_party_configuration_url: Optional[_builtins.str] = ...) -> None:
...
class PipelineArtifactStore(dict):
    ...
    def __init__(__self__, *, location: _builtins.str, type: _builtins.str, encryption_key: Optional[outputs.PipelineArtifactStoreEncryptionKey] = ..., region: Optional[_builtins.str] = ...) -> None:
...
class PipelineStage(dict):
    ...
    def __init__(__self__, *, actions: Sequence[outputs.PipelineStageAction], name: _builtins.str, before_entry: Optional[outputs.PipelineStageBeforeEntry] = ..., on_failure: Optional[outputs.PipelineStageOnFailure] = ..., on_success: Optional[outputs.PipelineStageOnSuccess] = ...) -> None:
...
class PipelineStageAction(dict):
    ...
    def __init__(__self__, *, category: _builtins.str, name: _builtins.str, owner: _builtins.str, provider: _builtins.str, version: _builtins.str, configuration: Optional[Mapping[str, _builtins.str]] = ..., input_artifacts: Optional[Sequence[_builtins.str]] = ..., namespace: Optional[_builtins.str] = ..., output_artifacts: Optional[Sequence[_builtins.str]] = ..., region: Optional[_builtins.str] = ..., role_arn: Optional[_builtins.str] = ..., run_order: Optional[_builtins.int] = ..., timeout_in_minutes: Optional[_builtins.int] = ...) -> None:
...
class PipelineStageBeforeEntry(dict):
    def __init__(__self__, *, condition: outputs.PipelineStageBeforeEntryCondition) -> None:
...
class PipelineStageBeforeEntryCondition(dict):
    def __init__(__self__, *, rules: Sequence[outputs.PipelineStageBeforeEntryConditionRule], result: Optional[_builtins.str] = ...) -> None:
...
class PipelineStageBeforeEntryConditionRule(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, rule_type_id: outputs.PipelineStageBeforeEntryConditionRuleRuleTypeId, commands: Optional[Sequence[_builtins.str]] = ..., configuration: Optional[Mapping[str, _builtins.str]] = ..., input_artifacts: Optional[Sequence[_builtins.str]] = ..., region: Optional[_builtins.str] = ..., role_arn: Optional[_builtins.str] = ..., timeout_in_minutes: Optional[_builtins.int] = ...) -> None:
...
class PipelineStageBeforeEntryConditionRuleRuleTypeId(dict):
    def __init__(__self__, *, category: _builtins.str, provider: _builtins.str, owner: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class PipelineStageOnFailure(dict):
    ...
    def __init__(__self__, *, condition: Optional[outputs.PipelineStageOnFailureCondition] = ..., result: Optional[_builtins.str] = ..., retry_configuration: Optional[outputs.PipelineStageOnFailureRetryConfiguration] = ...) -> None:
...
class PipelineStageOnFailureCondition(dict):
    def __init__(__self__, *, rules: Sequence[outputs.PipelineStageOnFailureConditionRule], result: Optional[_builtins.str] = ...) -> None:
...
class PipelineStageOnFailureConditionRule(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, rule_type_id: outputs.PipelineStageOnFailureConditionRuleRuleTypeId, commands: Optional[Sequence[_builtins.str]] = ..., configuration: Optional[Mapping[str, _builtins.str]] = ..., input_artifacts: Optional[Sequence[_builtins.str]] = ..., region: Optional[_builtins.str] = ..., role_arn: Optional[_builtins.str] = ..., timeout_in_minutes: Optional[_builtins.int] = ...) -> None:
...
class PipelineStageOnSuccess(dict):
    def __init__(__self__, *, condition: outputs.PipelineStageOnSuccessCondition) -> None:
...
class PipelineStageOnSuccessCondition(dict):
    def __init__(__self__, *, rules: Sequence[outputs.PipelineStageOnSuccessConditionRule], result: Optional[_builtins.str] = ...) -> None:
...
class PipelineStageOnSuccessConditionRule(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, rule_type_id: outputs.PipelineStageOnSuccessConditionRuleRuleTypeId, commands: Optional[Sequence[_builtins.str]] = ..., configuration: Optional[Mapping[str, _builtins.str]] = ..., input_artifacts: Optional[Sequence[_builtins.str]] = ..., region: Optional[_builtins.str] = ..., role_arn: Optional[_builtins.str] = ..., timeout_in_minutes: Optional[_builtins.int] = ...) -> None:
...
class PipelineTrigger(dict):
    ...
    def __init__(__self__, *, git_configuration: outputs.PipelineTriggerGitConfiguration, provider_type: _builtins.str) -> None:
...
class PipelineTriggerAll(dict):
    ...
    def __init__(__self__, *, git_configurations: Optional[Sequence[outputs.PipelineTriggerAllGitConfiguration]] = ..., provider_type: Optional[_builtins.str] = ...) -> None:
...
class PipelineTriggerAllGitConfiguration(dict):
    ...
    def __init__(__self__, *, pull_requests: Optional[Sequence[outputs.PipelineTriggerAllGitConfigurationPullRequest]] = ..., pushes: Optional[Sequence[outputs.PipelineTriggerAllGitConfigurationPush]] = ..., source_action_name: Optional[_builtins.str] = ...) -> None:
...
class PipelineTriggerAllGitConfigurationPullRequest(dict):
    ...
    def __init__(__self__, *, branches: Optional[Sequence[outputs.PipelineTriggerAllGitConfigurationPullRequestBranch]] = ..., events: Optional[Sequence[_builtins.str]] = ..., file_paths: Optional[Sequence[outputs.PipelineTriggerAllGitConfigurationPullRequestFilePath]] = ...) -> None:
...
class PipelineTriggerAllGitConfigurationPullRequestBranch(dict):
    def __init__(__self__, *, excludes: Optional[Sequence[_builtins.str]] = ..., includes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class PipelineTriggerAllGitConfigurationPush(dict):
    ...
    def __init__(__self__, *, branches: Optional[Sequence[outputs.PipelineTriggerAllGitConfigurationPushBranch]] = ..., file_paths: Optional[Sequence[outputs.PipelineTriggerAllGitConfigurationPushFilePath]] = ..., tags: Optional[Sequence[outputs.PipelineTriggerAllGitConfigurationPushTag]] = ...) -> None:
...
class PipelineTriggerGitConfiguration(dict):
    ...
    def __init__(__self__, *, source_action_name: _builtins.str, pull_requests: Optional[Sequence[outputs.PipelineTriggerGitConfigurationPullRequest]] = ..., pushes: Optional[Sequence[outputs.PipelineTriggerGitConfigurationPush]] = ...) -> None:
...
class PipelineTriggerGitConfigurationPullRequest(dict):
    ...
    def __init__(__self__, *, branches: Optional[outputs.PipelineTriggerGitConfigurationPullRequestBranches] = ..., events: Optional[Sequence[_builtins.str]] = ..., file_paths: Optional[outputs.PipelineTriggerGitConfigurationPullRequestFilePaths] = ...) -> None:
...
class PipelineTriggerGitConfigurationPush(dict):
    ...
    def __init__(__self__, *, branches: Optional[outputs.PipelineTriggerGitConfigurationPushBranches] = ..., file_paths: Optional[outputs.PipelineTriggerGitConfigurationPushFilePaths] = ..., tags: Optional[outputs.PipelineTriggerGitConfigurationPushTags] = ...) -> None:
...
class PipelineVariable(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, default_value: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class WebhookAuthenticationConfiguration(dict):
    ...
    def __init__(__self__, *, allowed_ip_range: Optional[_builtins.str] = ..., secret_token: Optional[_builtins.str] = ...) -> None:
...
class WebhookFilter(dict):
    ...
    def __init__(__self__, *, json_path: _builtins.str, match_equals: _builtins.str) -> None:
