...
class ConfigurationPolicyArgs:
    ...
    def configuration_policy(
        self,
    ) -> pulumi.Input[ConfigurationPolicyConfigurationPolicyArgs]: ...
    @configuration_policy.setter
    def configuration_policy(
        self, value: pulumi.Input[ConfigurationPolicyConfigurationPolicyArgs]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _ConfigurationPolicyState:
    ...
    def configuration_policy(
        self,
    ) -> Optional[pulumi.Input[ConfigurationPolicyConfigurationPolicyArgs]]: ...
    @configuration_policy.setter
    def configuration_policy(
        self, value: Optional[pulumi.Input[ConfigurationPolicyConfigurationPolicyArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def description(self) -> Optional[pulumi.Input[_builtins.str]]: ...
...
class ConfigurationPolicy(pulumi.CustomResource):
    ...
    def configuration_policy(
        self,
    ) -> pulumi.Output[outputs.ConfigurationPolicyConfigurationPolicy]: ...
    @_builtins.property
    @pulumi.getter
