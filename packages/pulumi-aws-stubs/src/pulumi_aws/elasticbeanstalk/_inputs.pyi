...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationAppversionLifecycleArgs', 'ApplicationAppversionLifecycleArgsDict', 'ConfigurationTemplateSettingArgs', 'ConfigurationTemplateSettingArgsDict', 'EnvironmentAllSettingArgs', 'EnvironmentAllSettingArgsDict', 'EnvironmentSettingArgs', 'EnvironmentSettingArgsDict']
...
class ApplicationAppversionLifecycleArgs:
    def __init__(__self__, *, service_role: pulumi.Input[_builtins.str], delete_source_from_s3: Optional[pulumi.Input[_builtins.bool]] = ..., max_age_in_days: Optional[pulumi.Input[_builtins.int]] = ..., max_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def delete_source_from_s3(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def max_age_in_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ConfigurationTemplateSettingArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], namespace: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str], resource: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
