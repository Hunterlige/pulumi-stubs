...
class ApplicationArgs:
    def __init__(
        ...
        *,
        appversion_lifecycle: Optional[
            pulumi.Input[ApplicationAppversionLifecycleArgs]
        ] = ...,
    ...
    def appversion_lifecycle(
        self,
    ) -> Optional[pulumi.Input[ApplicationAppversionLifecycleArgs]]: ...
    @appversion_lifecycle.setter
    def appversion_lifecycle(
        self, value: Optional[pulumi.Input[ApplicationAppversionLifecycleArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class Application(pulumi.CustomResource):
    ...
    def appversion_lifecycle(
        self,
    ) -> pulumi.Output[Optional[outputs.ApplicationAppversionLifecycle]]: ...
    @_builtins.property
    @pulumi.getter
