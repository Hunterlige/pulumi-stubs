...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetFirewallResult', 'AwaitableGetFirewallResult', 'get_firewall', 'get_firewall_output']
@pulumi.output_type
class GetFirewallResult:
    
    def __init__(__self__, arn=..., availability_zone_change_protection=..., availability_zone_mappings=..., delete_protection=..., description=..., enabled_analysis_types=..., encryption_configurations=..., firewall_policy_arn=..., firewall_policy_change_protection=..., firewall_statuses=..., id=..., name=..., region=..., subnet_change_protection=..., subnet_mappings=..., tags=..., transit_gateway_id=..., transit_gateway_owner_account_id=..., update_token=..., vpc_id=...) -> None:
        ...
...
class AwaitableGetFirewallResult(GetFirewallResult):
    def __await__(self): # -> Generator[Never, Any, GetFirewallResult]:
        ...
    


def get_firewall(arn: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetFirewallResult:
    
    ...

def get_firewall_output(arn: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., name: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetFirewallResult]:
