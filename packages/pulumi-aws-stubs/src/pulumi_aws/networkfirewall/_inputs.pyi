...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FirewallAvailabilityZoneMappingArgs', 'FirewallAvailabilityZoneMappingArgsDict', 'FirewallEncryptionConfigurationArgs', 'FirewallEncryptionConfigurationArgsDict', 'FirewallFirewallStatusArgs', 'FirewallFirewallStatusArgsDict', 'FirewallFirewallStatusSyncStateArgs', 'FirewallFirewallStatusSyncStateArgsDict', 'FirewallFirewallStatusSyncStateAttachmentArgs', 'FirewallFirewallStatusSyncStateAttachmentArgsDict', ..., ..., 'FirewallPolicyEncryptionConfigurationArgs', 'FirewallPolicyEncryptionConfigurationArgsDict', 'FirewallPolicyFirewallPolicyArgs', 'FirewallPolicyFirewallPolicyArgsDict', 'FirewallPolicyFirewallPolicyPolicyVariablesArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'FirewallSubnetMappingArgs', 'FirewallSubnetMappingArgsDict', ..., ..., 'LoggingConfigurationLoggingConfigurationArgs', 'LoggingConfigurationLoggingConfigurationArgsDict', ..., ..., 'RuleGroupEncryptionConfigurationArgs', 'RuleGroupEncryptionConfigurationArgsDict', 'RuleGroupRuleGroupArgs', 'RuleGroupRuleGroupArgsDict', 'RuleGroupRuleGroupReferenceSetsArgs', 'RuleGroupRuleGroupReferenceSetsArgsDict', 'RuleGroupRuleGroupReferenceSetsIpSetReferenceArgs', ..., ..., ..., 'RuleGroupRuleGroupRuleVariablesArgs', 'RuleGroupRuleGroupRuleVariablesArgsDict', 'RuleGroupRuleGroupRuleVariablesIpSetArgs', 'RuleGroupRuleGroupRuleVariablesIpSetArgsDict', 'RuleGroupRuleGroupRuleVariablesIpSetIpSetArgs', 'RuleGroupRuleGroupRuleVariablesIpSetIpSetArgsDict', 'RuleGroupRuleGroupRuleVariablesPortSetArgs', 'RuleGroupRuleGroupRuleVariablesPortSetArgsDict', 'RuleGroupRuleGroupRuleVariablesPortSetPortSetArgs', ..., 'RuleGroupRuleGroupRulesSourceArgs', 'RuleGroupRuleGroupRulesSourceArgsDict', 'RuleGroupRuleGroupRulesSourceRulesSourceListArgs', ..., 'RuleGroupRuleGroupRulesSourceStatefulRuleArgs', 'RuleGroupRuleGroupRulesSourceStatefulRuleArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'RuleGroupRuleGroupStatefulRuleOptionsArgs', 'RuleGroupRuleGroupStatefulRuleOptionsArgsDict', 'TlsInspectionConfigurationCertificateArgs', 'TlsInspectionConfigurationCertificateArgsDict', 'TlsInspectionConfigurationCertificateAuthorityArgs', ..., ..., ..., 'TlsInspectionConfigurationTimeoutsArgs', 'TlsInspectionConfigurationTimeoutsArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'VpcEndpointAssociationSubnetMappingArgs', 'VpcEndpointAssociationSubnetMappingArgsDict', 'VpcEndpointAssociationTimeoutsArgs', 'VpcEndpointAssociationTimeoutsArgsDict', ..., ..., ..., ..., ..., ...]
...
class FirewallAvailabilityZoneMappingArgs:
    def __init__(__self__, *, availability_zone_id: pulumi.Input[_builtins.str]) -> None:
...
class FirewallEncryptionConfigurationArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], key_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FirewallFirewallStatusArgs:
    def __init__(__self__, *, sync_states: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallFirewallStatusSyncStateArgs]]]] = ..., transit_gateway_attachment_sync_states: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallFirewallStatusTransitGatewayAttachmentSyncStateArgs]]]] = ...) -> None:
    ...
    @sync_states.setter
    def sync_states(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallFirewallStatusSyncStateArgs]]]]): # -> None:
        ...
    ...
    def transit_gateway_attachment_sync_states(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallFirewallStatusTransitGatewayAttachmentSyncStateArgs]]]]): # -> None:
        ...
...
class FirewallFirewallStatusSyncStateArgs:
    def __init__(__self__, *, attachments: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallFirewallStatusSyncStateAttachmentArgs]]]] = ..., availability_zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @attachments.setter
    def attachments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallFirewallStatusSyncStateAttachmentArgs]]]]): # -> None:
        ...
...
class FirewallFirewallStatusSyncStateAttachmentArgs:
    def __init__(__self__, *, endpoint_id: Optional[pulumi.Input[_builtins.str]] = ..., subnet_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FirewallFirewallStatusTransitGatewayAttachmentSyncStateArgs:
    def __init__(__self__, *, attachment_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FirewallPolicyFirewallPolicyArgs:
    def __init__(__self__, *, stateless_default_actions: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], stateless_fragment_default_actions: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], policy_variables: Optional[pulumi.Input[FirewallPolicyFirewallPolicyPolicyVariablesArgs]] = ..., stateful_default_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., stateful_engine_options: Optional[pulumi.Input[FirewallPolicyFirewallPolicyStatefulEngineOptionsArgs]] = ..., stateful_rule_group_references: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallPolicyFirewallPolicyStatefulRuleGroupReferenceArgs]]]] = ..., stateless_custom_actions: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallPolicyFirewallPolicyStatelessCustomActionArgs]]]] = ..., stateless_rule_group_references: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallPolicyFirewallPolicyStatelessRuleGroupReferenceArgs]]]] = ..., tls_inspection_configuration_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def stateless_default_actions(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def stateless_fragment_default_actions(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def policy_variables(self, value: Optional[pulumi.Input[FirewallPolicyFirewallPolicyPolicyVariablesArgs]]): # -> None:
        ...
    ...
    def stateful_default_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def stateful_engine_options(self, value: Optional[pulumi.Input[FirewallPolicyFirewallPolicyStatefulEngineOptionsArgs]]): # -> None:
        ...
    ...
    def stateful_rule_group_references(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallPolicyFirewallPolicyStatefulRuleGroupReferenceArgs]]]]): # -> None:
        ...
    ...
    def stateless_custom_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallPolicyFirewallPolicyStatelessCustomActionArgs]]]]): # -> None:
        ...
    ...
    def stateless_rule_group_references(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallPolicyFirewallPolicyStatelessRuleGroupReferenceArgs]]]]): # -> None:
        ...
    ...
    def tls_inspection_configuration_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FirewallPolicyFirewallPolicyPolicyVariablesArgs:
    def __init__(__self__, *, rule_variables: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallPolicyFirewallPolicyPolicyVariablesRuleVariableArgs]]]] = ...) -> None:
        ...
    ...
    def rule_variables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FirewallPolicyFirewallPolicyPolicyVariablesRuleVariableArgs]]]]): # -> None:
        ...
...
class FirewallPolicyFirewallPolicyPolicyVariablesRuleVariableArgs:
    def __init__(__self__, *, ip_set: pulumi.Input[FirewallPolicyFirewallPolicyPolicyVariablesRuleVariableIpSetArgs], key: pulumi.Input[_builtins.str]) -> None:
    ...
    @ip_set.setter
    def ip_set(self, value: pulumi.Input[FirewallPolicyFirewallPolicyPolicyVariablesRuleVariableIpSetArgs]): # -> None:
        ...
...
class FirewallPolicyFirewallPolicyPolicyVariablesRuleVariableIpSetArgs:
    def __init__(__self__, *, definitions: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
...
class FirewallPolicyFirewallPolicyStatefulEngineOptionsArgs:
    def __init__(__self__, *, flow_timeouts: Optional[pulumi.Input[FirewallPolicyFirewallPolicyStatefulEngineOptionsFlowTimeoutsArgs]] = ..., rule_order: Optional[pulumi.Input[_builtins.str]] = ..., stream_exception_policy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def flow_timeouts(self, value: Optional[pulumi.Input[FirewallPolicyFirewallPolicyStatefulEngineOptionsFlowTimeoutsArgs]]): # -> None:
        ...
    ...
    @rule_order.setter
    def rule_order(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def stream_exception_policy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FirewallPolicyFirewallPolicyStatefulEngineOptionsFlowTimeoutsArgs:
    def __init__(__self__, *, tcp_idle_timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def tcp_idle_timeout_seconds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class FirewallPolicyFirewallPolicyStatefulRuleGroupReferenceArgs:
    def __init__(__self__, *, resource_arn: pulumi.Input[_builtins.str], deep_threat_inspection: Optional[pulumi.Input[_builtins.str]] = ..., override: Optional[pulumi.Input[FirewallPolicyFirewallPolicyStatefulRuleGroupReferenceOverrideArgs]] = ..., priority: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def deep_threat_inspection(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @override.setter
    def override(self, value: Optional[pulumi.Input[FirewallPolicyFirewallPolicyStatefulRuleGroupReferenceOverrideArgs]]): # -> None:
        ...
...
class FirewallPolicyFirewallPolicyStatefulRuleGroupReferenceOverrideArgs:
    def __init__(__self__, *, action: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FirewallPolicyFirewallPolicyStatelessCustomActionArgs:
    def __init__(__self__, *, action_definition: pulumi.Input[FirewallPolicyFirewallPolicyStatelessCustomActionActionDefinitionArgs], action_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def action_definition(self, value: pulumi.Input[FirewallPolicyFirewallPolicyStatelessCustomActionActionDefinitionArgs]): # -> None:
        ...
...
class FirewallPolicyFirewallPolicyStatelessCustomActionActionDefinitionArgs:
    def __init__(__self__, *, publish_metric_action: pulumi.Input[FirewallPolicyFirewallPolicyStatelessCustomActionActionDefinitionPublishMetricActionArgs]) -> None:
    ...
    def publish_metric_action(self, value: pulumi.Input[FirewallPolicyFirewallPolicyStatelessCustomActionActionDefinitionPublishMetricActionArgs]): # -> None:
        ...
...
class FirewallPolicyFirewallPolicyStatelessCustomActionActionDefinitionPublishMetricActionArgs:
    def __init__(__self__, *, dimensions: pulumi.Input[Sequence[pulumi.Input[FirewallPolicyFirewallPolicyStatelessCustomActionActionDefinitionPublishMetricActionDimensionArgs]]]) -> None:
    ...
    @dimensions.setter
    def dimensions(self, value: pulumi.Input[Sequence[pulumi.Input[FirewallPolicyFirewallPolicyStatelessCustomActionActionDefinitionPublishMetricActionDimensionArgs]]]): # -> None:
        ...
...
class FirewallPolicyFirewallPolicyStatelessRuleGroupReferenceArgs:
    def __init__(__self__, *, priority: pulumi.Input[_builtins.int], resource_arn: pulumi.Input[_builtins.str]) -> None:
...
class FirewallSubnetMappingArgs:
    def __init__(__self__, *, subnet_id: pulumi.Input[_builtins.str], ip_address_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LoggingConfigurationLoggingConfigurationArgs:
    def __init__(__self__, *, log_destination_configs: pulumi.Input[Sequence[pulumi.Input[LoggingConfigurationLoggingConfigurationLogDestinationConfigArgs]]]) -> None:
    ...
    def log_destination_configs(self, value: pulumi.Input[Sequence[pulumi.Input[LoggingConfigurationLoggingConfigurationLogDestinationConfigArgs]]]): # -> None:
        ...
...
class LoggingConfigurationLoggingConfigurationLogDestinationConfigArgs:
    def __init__(__self__, *, log_destination: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], log_destination_type: pulumi.Input[_builtins.str], log_type: pulumi.Input[_builtins.str]) -> None:
    ...
    def log_destination(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def log_destination_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RuleGroupRuleGroupArgs:
    def __init__(__self__, *, rules_source: pulumi.Input[RuleGroupRuleGroupRulesSourceArgs], reference_sets: Optional[pulumi.Input[RuleGroupRuleGroupReferenceSetsArgs]] = ..., rule_variables: Optional[pulumi.Input[RuleGroupRuleGroupRuleVariablesArgs]] = ..., stateful_rule_options: Optional[pulumi.Input[RuleGroupRuleGroupStatefulRuleOptionsArgs]] = ...) -> None:
    ...
    @rules_source.setter
    def rules_source(self, value: pulumi.Input[RuleGroupRuleGroupRulesSourceArgs]): # -> None:
        ...
    ...
    def reference_sets(self, value: Optional[pulumi.Input[RuleGroupRuleGroupReferenceSetsArgs]]): # -> None:
        ...
    ...
    @rule_variables.setter
    def rule_variables(self, value: Optional[pulumi.Input[RuleGroupRuleGroupRuleVariablesArgs]]): # -> None:
        ...
    ...
    def stateful_rule_options(self, value: Optional[pulumi.Input[RuleGroupRuleGroupStatefulRuleOptionsArgs]]): # -> None:
        ...
...
class RuleGroupRuleGroupReferenceSetsArgs:
    def __init__(__self__, *, ip_set_references: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupReferenceSetsIpSetReferenceArgs]]]] = ...) -> None:
        ...
    ...
    def ip_set_references(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupReferenceSetsIpSetReferenceArgs]]]]): # -> None:
        ...
...
class RuleGroupRuleGroupReferenceSetsIpSetReferenceArgs:
    def __init__(__self__, *, ip_set_references: pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupReferenceSetsIpSetReferenceIpSetReferenceArgs]]], key: pulumi.Input[_builtins.str]) -> None:
    ...
    @ip_set_references.setter
    def ip_set_references(self, value: pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupReferenceSetsIpSetReferenceIpSetReferenceArgs]]]): # -> None:
        ...
...
class RuleGroupRuleGroupReferenceSetsIpSetReferenceIpSetReferenceArgs:
    ...
    def reference_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RuleGroupRuleGroupRuleVariablesArgs:
    def __init__(__self__, *, ip_sets: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRuleVariablesIpSetArgs]]]] = ..., port_sets: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRuleVariablesPortSetArgs]]]] = ...) -> None:
    ...
    @ip_sets.setter
    def ip_sets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRuleVariablesIpSetArgs]]]]): # -> None:
        ...
    ...
    @port_sets.setter
    def port_sets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRuleVariablesPortSetArgs]]]]): # -> None:
        ...
...
class RuleGroupRuleGroupRuleVariablesIpSetArgs:
    def __init__(__self__, *, ip_set: pulumi.Input[RuleGroupRuleGroupRuleVariablesIpSetIpSetArgs], key: pulumi.Input[_builtins.str]) -> None:
    ...
    @ip_set.setter
    def ip_set(self, value: pulumi.Input[RuleGroupRuleGroupRuleVariablesIpSetIpSetArgs]): # -> None:
        ...
...
class RuleGroupRuleGroupRuleVariablesPortSetArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], port_set: pulumi.Input[RuleGroupRuleGroupRuleVariablesPortSetPortSetArgs]) -> None:
    ...
    @port_set.setter
    def port_set(self, value: pulumi.Input[RuleGroupRuleGroupRuleVariablesPortSetPortSetArgs]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceArgs:
    def __init__(__self__, *, rules_source_list: Optional[pulumi.Input[RuleGroupRuleGroupRulesSourceRulesSourceListArgs]] = ..., rules_string: Optional[pulumi.Input[_builtins.str]] = ..., stateful_rules: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatefulRuleArgs]]]] = ..., stateless_rules_and_custom_actions: Optional[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsArgs]] = ...) -> None:
    ...
    def rules_source_list(self, value: Optional[pulumi.Input[RuleGroupRuleGroupRulesSourceRulesSourceListArgs]]): # -> None:
        ...
    ...
    @rules_string.setter
    def rules_string(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def stateful_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatefulRuleArgs]]]]): # -> None:
        ...
    ...
    def stateless_rules_and_custom_actions(self, value: Optional[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsArgs]]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceRulesSourceListArgs:
    def __init__(__self__, *, generated_rules_type: pulumi.Input[_builtins.str], target_types: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], targets: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def generated_rules_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceStatefulRuleArgs:
    def __init__(__self__, *, action: pulumi.Input[_builtins.str], header: pulumi.Input[RuleGroupRuleGroupRulesSourceStatefulRuleHeaderArgs], rule_options: pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatefulRuleRuleOptionArgs]]]) -> None:
    ...
    @header.setter
    def header(self, value: pulumi.Input[RuleGroupRuleGroupRulesSourceStatefulRuleHeaderArgs]): # -> None:
        ...
    ...
    @rule_options.setter
    def rule_options(self, value: pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatefulRuleRuleOptionArgs]]]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceStatefulRuleHeaderArgs:
    def __init__(__self__, *, destination: pulumi.Input[_builtins.str], destination_port: pulumi.Input[_builtins.str], direction: pulumi.Input[_builtins.str], protocol: pulumi.Input[_builtins.str], source: pulumi.Input[_builtins.str], source_port: pulumi.Input[_builtins.str]) -> None:
...
class RuleGroupRuleGroupRulesSourceStatefulRuleRuleOptionArgs:
    def __init__(__self__, *, keyword: pulumi.Input[_builtins.str], settings: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @settings.setter
    def settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsArgs:
    def __init__(__self__, *, stateless_rules: pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleArgs]]], custom_actions: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionArgs]]]] = ...) -> None:
    ...
    def stateless_rules(self, value: pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleArgs]]]): # -> None:
        ...
    ...
    def custom_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionArgs]]]]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionArgs:
    def __init__(__self__, *, action_definition: pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionActionDefinitionArgs], action_name: pulumi.Input[_builtins.str]) -> None:
    ...
    @action_definition.setter
    def action_definition(self, value: pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionActionDefinitionArgs]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionActionDefinitionArgs:
    def __init__(__self__, *, publish_metric_action: pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionActionDefinitionPublishMetricActionArgs]) -> None:
    ...
    @publish_metric_action.setter
    def publish_metric_action(self, value: pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionActionDefinitionPublishMetricActionArgs]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionActionDefinitionPublishMetricActionArgs:
    def __init__(__self__, *, dimensions: pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionActionDefinitionPublishMetricActionDimensionArgs]]]) -> None:
    ...
    @dimensions.setter
    def dimensions(self, value: pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionActionDefinitionPublishMetricActionDimensionArgs]]]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleArgs:
    def __init__(__self__, *, priority: pulumi.Input[_builtins.int], rule_definition: pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionArgs]) -> None:
    ...
    def rule_definition(self, value: pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionArgs]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionArgs:
    def __init__(__self__, *, actions: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], match_attributes: pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesArgs]) -> None:
    ...
    def match_attributes(self, value: pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesArgs]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesArgs:
    def __init__(__self__, *, destination_ports: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestinationPortArgs]]]] = ..., destinations: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestinationArgs]]]] = ..., protocols: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ..., source_ports: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesSourcePortArgs]]]] = ..., sources: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesSourceArgs]]]] = ..., tcp_flags: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesTcpFlagArgs]]]] = ...) -> None:
    ...
    def destination_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestinationPortArgs]]]]): # -> None:
        ...
    ...
    @destinations.setter
    def destinations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestinationArgs]]]]): # -> None:
        ...
    ...
    @protocols.setter
    def protocols(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]): # -> None:
        ...
    ...
    @source_ports.setter
    def source_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesSourcePortArgs]]]]): # -> None:
        ...
    ...
    @sources.setter
    def sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesSourceArgs]]]]): # -> None:
        ...
    ...
    @tcp_flags.setter
    def tcp_flags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesTcpFlagArgs]]]]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestinationArgs:
    def __init__(__self__, *, address_definition: pulumi.Input[_builtins.str]) -> None:
    ...
    def address_definition(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestinationPortArgs:
    def __init__(__self__, *, from_port: pulumi.Input[_builtins.int], to_port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesTcpFlagArgs:
    def __init__(__self__, *, flags: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], masks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @flags.setter
    def flags(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @masks.setter
    def masks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RuleGroupRuleGroupStatefulRuleOptionsArgs:
    ...
    @rule_order.setter
    def rule_order(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TlsInspectionConfigurationCertificateArgs:
    def __init__(__self__, *, certificate_arn: pulumi.Input[_builtins.str], certificate_serial: pulumi.Input[_builtins.str], status: pulumi.Input[_builtins.str], status_message: pulumi.Input[_builtins.str]) -> None:
    ...
    def certificate_serial(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TlsInspectionConfigurationEncryptionConfigurationArgs:
    def __init__(__self__, *, key_id: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str]) -> None:
...
class TlsInspectionConfigurationTlsInspectionConfigurationArgsDict(TypedDict):
    server_certificate_configuration: pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationArgsDict]


@pulumi.input_type
class TlsInspectionConfigurationTlsInspectionConfigurationArgs:
    def __init__(__self__, *, server_certificate_configuration: pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationArgs]) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="serverCertificateConfiguration")
    def server_certificate_configuration(self) -> pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationArgs]:
        
        ...
    
    @server_certificate_configuration.setter
    def server_certificate_configuration(self, value: pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationArgs]): # -> None:
        ...
    


class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationArgsDict(TypedDict):
    scopes: pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeArgsDict]]]
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationArgs:
    def __init__(__self__, *, scopes: pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeArgs]]], certificate_authority_arn: Optional[pulumi.Input[_builtins.str]] = ..., check_certificate_revocation_status: Optional[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationCheckCertificateRevocationStatusArgs]] = ..., server_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationServerCertificateArgs]]]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def scopes(self) -> pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeArgs]]]:
        
        ...
    
    @scopes.setter
    def scopes(self, value: pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeArgs]]]): # -> None:
        ...
    ...
    def check_certificate_revocation_status(self, value: Optional[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationCheckCertificateRevocationStatusArgs]]): # -> None:
        ...
    ...
    def server_certificates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationServerCertificateArgs]]]]): # -> None:
        ...
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationCheckCertificateRevocationStatusArgs:
    def __init__(__self__, *, revoked_status_action: Optional[pulumi.Input[_builtins.str]] = ..., unknown_status_action: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
    ...
    def revoked_status_action(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def unknown_status_action(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    


class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeArgsDict(TypedDict):
    destinations: pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestinationArgsDict]]]
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeArgs:
    def __init__(__self__, *, destinations: pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestinationArgs]]], protocols: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]], destination_ports: Optional[pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestinationPortArgs]]]] = ..., source_ports: Optional[pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeSourcePortArgs]]]] = ..., sources: Optional[pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeSourceArgs]]]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def destinations(self) -> pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestinationArgs]]]:
        
        ...
    
    @destinations.setter
    def destinations(self, value: pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestinationArgs]]]): # -> None:
        ...
    ...
    @protocols.setter
    def protocols(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]): # -> None:
        ...
    ...
    @destination_ports.setter
    def destination_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestinationPortArgs]]]]): # -> None:
        ...
    ...
    @source_ports.setter
    def source_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeSourcePortArgs]]]]): # -> None:
        ...
    ...
    @sources.setter
    def sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeSourceArgs]]]]): # -> None:
        ...
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationServerCertificateArgs:
    def __init__(__self__, *, resource_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VpcEndpointAssociationVpcEndpointAssociationStatusArgs:
    def __init__(__self__, *, association_sync_states: pulumi.Input[Sequence[pulumi.Input[VpcEndpointAssociationVpcEndpointAssociationStatusAssociationSyncStateArgs]]]) -> None:
        ...
    ...
    def association_sync_states(self, value: pulumi.Input[Sequence[pulumi.Input[VpcEndpointAssociationVpcEndpointAssociationStatusAssociationSyncStateArgs]]]): # -> None:
        ...
...
class VpcEndpointAssociationVpcEndpointAssociationStatusAssociationSyncStateArgs:
    def __init__(__self__, *, attachments: pulumi.Input[Sequence[pulumi.Input[VpcEndpointAssociationVpcEndpointAssociationStatusAssociationSyncStateAttachmentArgs]]], availability_zone: pulumi.Input[_builtins.str]) -> None:
    ...
    @attachments.setter
    def attachments(self, value: pulumi.Input[Sequence[pulumi.Input[VpcEndpointAssociationVpcEndpointAssociationStatusAssociationSyncStateAttachmentArgs]]]): # -> None:
        ...
...
class VpcEndpointAssociationVpcEndpointAssociationStatusAssociationSyncStateAttachmentArgs:
    def __init__(__self__, *, endpoint_id: pulumi.Input[_builtins.str], status: pulumi.Input[_builtins.str], status_message: pulumi.Input[_builtins.str], subnet_id: pulumi.Input[_builtins.str]) -> None:
    ...
    @endpoint_id.setter
    def endpoint_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
