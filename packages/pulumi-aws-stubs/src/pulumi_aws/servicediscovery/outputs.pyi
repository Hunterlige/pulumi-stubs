...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ServiceDnsConfig', 'ServiceDnsConfigDnsRecord', 'ServiceHealthCheckConfig', 'ServiceHealthCheckCustomConfig', 'GetServiceDnsConfigResult', 'GetServiceDnsConfigDnsRecordResult', 'GetServiceHealthCheckConfigResult', 'GetServiceHealthCheckCustomConfigResult']
@pulumi.output_type
class ServiceDnsConfig(dict):
    ...
    def __init__(__self__, *, dns_records: Sequence[outputs.ServiceDnsConfigDnsRecord], namespace_id: _builtins.str, routing_policy: Optional[_builtins.str] = ...) -> None:
...
class ServiceHealthCheckConfig(dict):
    ...
    def __init__(__self__, *, failure_threshold: Optional[_builtins.int] = ..., resource_path: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ServiceHealthCheckCustomConfig(dict):
    ...
    def __init__(__self__, *, failure_threshold: Optional[_builtins.int] = ...) -> None:
...
class GetServiceDnsConfigResult(dict):
    def __init__(__self__, *, dns_records: Sequence[outputs.GetServiceDnsConfigDnsRecordResult], namespace_id: _builtins.str, routing_policy: _builtins.str) -> None:
...
class GetServiceHealthCheckConfigResult(dict):
    def __init__(__self__, *, failure_threshold: _builtins.int, resource_path: _builtins.str, type: _builtins.str) -> None:
