...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ServiceDnsConfigArgs', 'ServiceDnsConfigArgsDict', 'ServiceDnsConfigDnsRecordArgs', 'ServiceDnsConfigDnsRecordArgsDict', 'ServiceHealthCheckConfigArgs', 'ServiceHealthCheckConfigArgsDict', 'ServiceHealthCheckCustomConfigArgs', 'ServiceHealthCheckCustomConfigArgsDict']
...
class ServiceDnsConfigArgs:
    def __init__(__self__, *, dns_records: pulumi.Input[Sequence[pulumi.Input[ServiceDnsConfigDnsRecordArgs]]], namespace_id: pulumi.Input[_builtins.str], routing_policy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @dns_records.setter
    def dns_records(self, value: pulumi.Input[Sequence[pulumi.Input[ServiceDnsConfigDnsRecordArgs]]]): # -> None:
        ...
    ...
    def routing_policy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceDnsConfigDnsRecordArgs:
    def __init__(__self__, *, ttl: pulumi.Input[_builtins.int], type: pulumi.Input[_builtins.str]) -> None:
...
class ServiceHealthCheckConfigArgs:
    def __init__(__self__, *, failure_threshold: Optional[pulumi.Input[_builtins.int]] = ..., resource_path: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServiceHealthCheckCustomConfigArgs:
    def __init__(__self__, *, failure_threshold: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
