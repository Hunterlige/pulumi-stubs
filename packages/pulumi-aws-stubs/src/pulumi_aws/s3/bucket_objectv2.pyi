...
class BucketObjectv2Args:
    def __init__(
        ...
        *,
        ...
        override_provider: Optional[
            pulumi.Input[BucketObjectv2OverrideProviderArgs]
        ] = ...,
    ...
    def override_provider(
        self,
    ) -> Optional[pulumi.Input[BucketObjectv2OverrideProviderArgs]]: ...
    @override_provider.setter
    def override_provider(
        self, value: Optional[pulumi.Input[BucketObjectv2OverrideProviderArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class BucketObjectv2(pulumi.CustomResource):
    ...
    def override_provider(
        self,
    ) -> pulumi.Output[Optional[outputs.BucketObjectv2OverrideProvider]]: ...
    @_builtins.property
    @pulumi.getter
