...
class BucketRequestPaymentConfigurationV2(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: BucketRequestPaymentConfigurationV2Args, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., bucket: Optional[pulumi.Input[_builtins.str]] = ..., expected_bucket_owner: Optional[pulumi.Input[_builtins.str]] = ..., payer: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> BucketRequestPaymentConfigurationV2:
