...
class BucketLifecycleConfigurationV2Args:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], expected_bucket_owner: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., rules: Optional[pulumi.Input[Sequence[pulumi.Input[BucketLifecycleConfigurationV2RuleArgs]]]] = ..., timeouts: Optional[pulumi.Input[BucketLifecycleConfigurationV2TimeoutsArgs]] = ..., transition_default_minimum_object_size: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @rules.setter
    def rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BucketLifecycleConfigurationV2RuleArgs]]]]): # -> None:
        ...
    ...
    @timeouts.setter
    def timeouts(self, value: Optional[pulumi.Input[BucketLifecycleConfigurationV2TimeoutsArgs]]): # -> None:
        ...
...
class _BucketLifecycleConfigurationV2State:
    def __init__(__self__, *, bucket: Optional[pulumi.Input[_builtins.str]] = ..., expected_bucket_owner: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., rules: Optional[pulumi.Input[Sequence[pulumi.Input[BucketLifecycleConfigurationV2RuleArgs]]]] = ..., timeouts: Optional[pulumi.Input[BucketLifecycleConfigurationV2TimeoutsArgs]] = ..., transition_default_minimum_object_size: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class BucketLifecycleConfigurationV2(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., bucket: Optional[pulumi.Input[_builtins.str]] = ..., expected_bucket_owner: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[BucketLifecycleConfigurationV2RuleArgs, BucketLifecycleConfigurationV2RuleArgsDict]]]]] = ..., timeouts: Optional[pulumi.Input[Union[BucketLifecycleConfigurationV2TimeoutsArgs, BucketLifecycleConfigurationV2TimeoutsArgsDict]]] = ..., transition_default_minimum_object_size: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: BucketLifecycleConfigurationV2Args, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
