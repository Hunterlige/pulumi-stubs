...
class BucketLoggingV2Args:
    def __init__(
        ...
        *,
        ...
        target_grants: Optional[
            pulumi.Input[Sequence[pulumi.Input[BucketLoggingV2TargetGrantArgs]]]
        ] = ...,
    ...
    def target_object_key_format(
        self,
    ) -> Optional[pulumi.Input[BucketLoggingV2TargetObjectKeyFormatArgs]]: ...
    @target_object_key_format.setter
    def target_object_key_format(
        self, value: Optional[pulumi.Input[BucketLoggingV2TargetObjectKeyFormatArgs]]
    ): ...
...
class BucketLoggingV2(pulumi.CustomResource):
    ...
    def target_grants(
        self,
    ) -> pulumi.Output[Optional[Sequence[outputs.BucketLoggingV2TargetGrant]]]: ...
    @_builtins.property
    @pulumi.getter(name="targetObjectKeyFormat")
    def target_object_key_format(
        self,
    ) -> pulumi.Output[Optional[outputs.BucketLoggingV2TargetObjectKeyFormat]]: ...
    @_builtins.property
    @pulumi.getter(name="targetPrefix")
