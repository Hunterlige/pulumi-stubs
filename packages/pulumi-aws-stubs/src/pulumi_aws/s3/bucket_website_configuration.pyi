...
class BucketWebsiteConfigurationArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], error_document: Optional[pulumi.Input[BucketWebsiteConfigurationErrorDocumentArgs]] = ..., expected_bucket_owner: Optional[pulumi.Input[_builtins.str]] = ..., index_document: Optional[pulumi.Input[BucketWebsiteConfigurationIndexDocumentArgs]] = ..., redirect_all_requests_to: Optional[pulumi.Input[BucketWebsiteConfigurationRedirectAllRequestsToArgs]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., routing_rule_details: Optional[pulumi.Input[_builtins.str]] = ..., routing_rules: Optional[pulumi.Input[Sequence[pulumi.Input[BucketWebsiteConfigurationRoutingRuleArgs]]]] = ...) -> None:
    ...
    def error_document(self, value: Optional[pulumi.Input[BucketWebsiteConfigurationErrorDocumentArgs]]): # -> None:
        ...
    ...
    def index_document(self, value: Optional[pulumi.Input[BucketWebsiteConfigurationIndexDocumentArgs]]): # -> None:
        ...
    ...
    def redirect_all_requests_to(self, value: Optional[pulumi.Input[BucketWebsiteConfigurationRedirectAllRequestsToArgs]]): # -> None:
        ...
    ...
    def routing_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BucketWebsiteConfigurationRoutingRuleArgs]]]]): # -> None:
        ...
...
class BucketWebsiteConfiguration(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., bucket: Optional[pulumi.Input[_builtins.str]] = ..., error_document: Optional[pulumi.Input[Union[BucketWebsiteConfigurationErrorDocumentArgs, BucketWebsiteConfigurationErrorDocumentArgsDict]]] = ..., expected_bucket_owner: Optional[pulumi.Input[_builtins.str]] = ..., index_document: Optional[pulumi.Input[Union[BucketWebsiteConfigurationIndexDocumentArgs, BucketWebsiteConfigurationIndexDocumentArgsDict]]] = ..., redirect_all_requests_to: Optional[pulumi.Input[Union[BucketWebsiteConfigurationRedirectAllRequestsToArgs, BucketWebsiteConfigurationRedirectAllRequestsToArgsDict]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., routing_rule_details: Optional[pulumi.Input[_builtins.str]] = ..., routing_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[BucketWebsiteConfigurationRoutingRuleArgs, BucketWebsiteConfigurationRoutingRuleArgsDict]]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: BucketWebsiteConfigurationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., bucket: Optional[pulumi.Input[_builtins.str]] = ..., error_document: Optional[pulumi.Input[Union[BucketWebsiteConfigurationErrorDocumentArgs, BucketWebsiteConfigurationErrorDocumentArgsDict]]] = ..., expected_bucket_owner: Optional[pulumi.Input[_builtins.str]] = ..., index_document: Optional[pulumi.Input[Union[BucketWebsiteConfigurationIndexDocumentArgs, BucketWebsiteConfigurationIndexDocumentArgsDict]]] = ..., redirect_all_requests_to: Optional[pulumi.Input[Union[BucketWebsiteConfigurationRedirectAllRequestsToArgs, BucketWebsiteConfigurationRedirectAllRequestsToArgsDict]]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., routing_rule_details: Optional[pulumi.Input[_builtins.str]] = ..., routing_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[BucketWebsiteConfigurationRoutingRuleArgs, BucketWebsiteConfigurationRoutingRuleArgsDict]]]]] = ..., website_domain: Optional[pulumi.Input[_builtins.str]] = ..., website_endpoint: Optional[pulumi.Input[_builtins.str]] = ...) -> BucketWebsiteConfiguration:
