...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessPointPublicAccessBlockConfiguration', 'AccessPointVpcConfiguration', 'AnalyticsConfigurationFilter', 'AnalyticsConfigurationStorageClassAnalysis', ..., ..., ..., 'BucketAbacAbacStatus', 'BucketAclAccessControlPolicy', 'BucketAclAccessControlPolicyGrant', 'BucketAclAccessControlPolicyGrantGrantee', 'BucketAclAccessControlPolicyOwner', 'BucketAclV2AccessControlPolicy', 'BucketAclV2AccessControlPolicyGrant', 'BucketAclV2AccessControlPolicyGrantGrantee', 'BucketAclV2AccessControlPolicyOwner', 'BucketCorsConfigurationCorsRule', 'BucketCorsConfigurationV2CorsRule', 'BucketCorsRule', 'BucketGrant', 'BucketIntelligentTieringConfigurationFilter', 'BucketIntelligentTieringConfigurationTiering', 'BucketLifecycleConfigurationRule', ..., 'BucketLifecycleConfigurationRuleExpiration', 'BucketLifecycleConfigurationRuleFilter', 'BucketLifecycleConfigurationRuleFilterAnd', 'BucketLifecycleConfigurationRuleFilterTag', ..., ..., 'BucketLifecycleConfigurationRuleTransition', 'BucketLifecycleConfigurationTimeouts', 'BucketLifecycleConfigurationV2Rule', ..., 'BucketLifecycleConfigurationV2RuleExpiration', 'BucketLifecycleConfigurationV2RuleFilter', 'BucketLifecycleConfigurationV2RuleFilterAnd', 'BucketLifecycleConfigurationV2RuleFilterTag', ..., ..., 'BucketLifecycleConfigurationV2RuleTransition', 'BucketLifecycleConfigurationV2Timeouts', 'BucketLifecycleRule', 'BucketLifecycleRuleExpiration', 'BucketLifecycleRuleNoncurrentVersionExpiration', 'BucketLifecycleRuleNoncurrentVersionTransition', 'BucketLifecycleRuleTransition', 'BucketLogging', 'BucketLoggingTargetGrant', 'BucketLoggingTargetGrantGrantee', 'BucketLoggingTargetObjectKeyFormat', ..., 'BucketLoggingTargetObjectKeyFormatSimplePrefix', 'BucketLoggingV2TargetGrant', 'BucketLoggingV2TargetGrantGrantee', 'BucketLoggingV2TargetObjectKeyFormat', ..., 'BucketLoggingV2TargetObjectKeyFormatSimplePrefix', 'BucketMetadataConfigurationMetadataConfiguration', ..., ..., ..., ..., ..., ..., 'BucketMetadataConfigurationTimeouts', 'BucketMetricFilter', 'BucketNotificationLambdaFunction', 'BucketNotificationQueue', 'BucketNotificationTopic', 'BucketObjectLockConfiguration', 'BucketObjectLockConfigurationRule', 'BucketObjectLockConfigurationRuleDefaultRetention', 'BucketObjectLockConfigurationV2Rule', ..., 'BucketObjectv2OverrideProvider', 'BucketObjectv2OverrideProviderDefaultTags', 'BucketOwnershipControlsRule', 'BucketReplicationConfigRule', 'BucketReplicationConfigRuleDeleteMarkerReplication', 'BucketReplicationConfigRuleDestination', ..., ..., 'BucketReplicationConfigRuleDestinationMetrics', ..., ..., ..., ..., 'BucketReplicationConfigRuleFilter', 'BucketReplicationConfigRuleFilterAnd', 'BucketReplicationConfigRuleFilterTag', 'BucketReplicationConfigRuleSourceSelectionCriteria', ..., ..., 'BucketReplicationConfiguration', 'BucketReplicationConfigurationRule', 'BucketReplicationConfigurationRuleDestination', ..., ..., ..., 'BucketReplicationConfigurationRuleFilter', ..., ..., 'BucketServerSideEncryptionConfiguration', 'BucketServerSideEncryptionConfigurationRule', ..., 'BucketServerSideEncryptionConfigurationV2Rule', ..., 'BucketV2CorsRule', 'BucketV2Grant', 'BucketV2LifecycleRule', 'BucketV2LifecycleRuleExpiration', 'BucketV2LifecycleRuleNoncurrentVersionExpiration', 'BucketV2LifecycleRuleNoncurrentVersionTransition', 'BucketV2LifecycleRuleTransition', 'BucketV2Logging', 'BucketV2ObjectLockConfiguration', 'BucketV2ObjectLockConfigurationRule', ..., 'BucketV2ReplicationConfiguration', 'BucketV2ReplicationConfigurationRule', 'BucketV2ReplicationConfigurationRuleDestination', ..., ..., ..., 'BucketV2ReplicationConfigurationRuleFilter', ..., ..., 'BucketV2ServerSideEncryptionConfiguration', 'BucketV2ServerSideEncryptionConfigurationRule', ..., 'BucketV2Versioning', 'BucketV2Website', 'BucketVersioning', 'BucketVersioningV2VersioningConfiguration', 'BucketVersioningVersioningConfiguration', 'BucketWebsite', 'BucketWebsiteConfigurationErrorDocument', 'BucketWebsiteConfigurationIndexDocument', 'BucketWebsiteConfigurationRedirectAllRequestsTo', 'BucketWebsiteConfigurationRoutingRule', 'BucketWebsiteConfigurationRoutingRuleCondition', 'BucketWebsiteConfigurationRoutingRuleRedirect', 'BucketWebsiteConfigurationV2ErrorDocument', 'BucketWebsiteConfigurationV2IndexDocument', 'BucketWebsiteConfigurationV2RedirectAllRequestsTo', 'BucketWebsiteConfigurationV2RoutingRule', 'BucketWebsiteConfigurationV2RoutingRuleCondition', 'BucketWebsiteConfigurationV2RoutingRuleRedirect', 'DirectoryBucketLocation', 'InventoryDestination', 'InventoryDestinationBucket', 'InventoryDestinationBucketEncryption', 'InventoryDestinationBucketEncryptionSseKms', 'InventoryDestinationBucketEncryptionSseS3', 'InventoryFilter', 'InventorySchedule', 'ObjectCopyGrant', 'ObjectCopyOverrideProvider', 'ObjectCopyOverrideProviderDefaultTags', 'VectorsIndexEncryptionConfiguration', 'VectorsIndexMetadataConfiguration', 'VectorsVectorBucketEncryptionConfiguration', 'GetAccessPointPublicAccessBlockConfigurationResult', 'GetAccessPointVpcConfigurationResult', 'GetBucketObjectLockConfigurationRuleResult', ..., 'GetBucketReplicationConfigurationRuleResult', ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetBucketReplicationConfigurationRuleFilterResult', ..., ..., ..., ..., ..., ...]
@pulumi.output_type
class AccessPointPublicAccessBlockConfiguration(dict):
    ...
    def __init__(__self__, *, block_public_acls: Optional[_builtins.bool] = ..., block_public_policy: Optional[_builtins.bool] = ..., ignore_public_acls: Optional[_builtins.bool] = ..., restrict_public_buckets: Optional[_builtins.bool] = ...) -> None:
...
class AnalyticsConfigurationFilter(dict):
    def __init__(__self__, *, prefix: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class AnalyticsConfigurationStorageClassAnalysis(dict):
    ...
    def __init__(__self__, *, data_export: outputs.AnalyticsConfigurationStorageClassAnalysisDataExport) -> None:
...
class AnalyticsConfigurationStorageClassAnalysisDataExport(dict):
    ...
    def __init__(__self__, *, destination: outputs.AnalyticsConfigurationStorageClassAnalysisDataExportDestination, output_schema_version: Optional[_builtins.str] = ...) -> None:
...
class AnalyticsConfigurationStorageClassAnalysisDataExportDestination(dict):
    ...
    def __init__(__self__, *, s3_bucket_destination: outputs.AnalyticsConfigurationStorageClassAnalysisDataExportDestinationS3BucketDestination) -> None:
...
class AnalyticsConfigurationStorageClassAnalysisDataExportDestinationS3BucketDestination(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, bucket_account_id: Optional[_builtins.str] = ..., format: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class BucketAclAccessControlPolicy(dict):
    def __init__(__self__, *, owner: outputs.BucketAclAccessControlPolicyOwner, grants: Optional[Sequence[outputs.BucketAclAccessControlPolicyGrant]] = ...) -> None:
...
class BucketAclAccessControlPolicyGrant(dict):
    def __init__(__self__, *, permission: _builtins.str, grantee: Optional[outputs.BucketAclAccessControlPolicyGrantGrantee] = ...) -> None:
...
class BucketAclAccessControlPolicyGrantGrantee(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, display_name: Optional[_builtins.str] = ..., email_address: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class BucketAclAccessControlPolicyOwner(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, display_name: Optional[_builtins.str] = ...) -> None:
...
class BucketAclV2AccessControlPolicy(dict):
    def __init__(__self__, *, owner: outputs.BucketAclV2AccessControlPolicyOwner, grants: Optional[Sequence[outputs.BucketAclV2AccessControlPolicyGrant]] = ...) -> None:
...
class BucketAclV2AccessControlPolicyGrant(dict):
    def __init__(__self__, *, permission: _builtins.str, grantee: Optional[outputs.BucketAclV2AccessControlPolicyGrantGrantee] = ...) -> None:
...
class BucketCorsConfigurationCorsRule(dict):
    ...
    def __init__(__self__, *, allowed_methods: Sequence[_builtins.str], allowed_origins: Sequence[_builtins.str], allowed_headers: Optional[Sequence[_builtins.str]] = ..., expose_headers: Optional[Sequence[_builtins.str]] = ..., id: Optional[_builtins.str] = ..., max_age_seconds: Optional[_builtins.int] = ...) -> None:
...
class BucketCorsRule(dict):
    ...
    def __init__(__self__, *, allowed_methods: Sequence[_builtins.str], allowed_origins: Sequence[_builtins.str], allowed_headers: Optional[Sequence[_builtins.str]] = ..., expose_headers: Optional[Sequence[_builtins.str]] = ..., max_age_seconds: Optional[_builtins.int] = ...) -> None:
...
class BucketGrant(dict):
    def __init__(__self__, *, permissions: Sequence[_builtins.str], type: _builtins.str, id: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class BucketIntelligentTieringConfigurationTiering(dict):
    ...
    def __init__(__self__, *, access_tier: _builtins.str, days: _builtins.int) -> None:
...
class BucketLifecycleConfigurationRule(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, status: _builtins.str, abort_incomplete_multipart_upload: Optional[outputs.BucketLifecycleConfigurationRuleAbortIncompleteMultipartUpload] = ..., expiration: Optional[outputs.BucketLifecycleConfigurationRuleExpiration] = ..., filter: Optional[outputs.BucketLifecycleConfigurationRuleFilter] = ..., noncurrent_version_expiration: Optional[outputs.BucketLifecycleConfigurationRuleNoncurrentVersionExpiration] = ..., noncurrent_version_transitions: Optional[Sequence[outputs.BucketLifecycleConfigurationRuleNoncurrentVersionTransition]] = ..., prefix: Optional[_builtins.str] = ..., transitions: Optional[Sequence[outputs.BucketLifecycleConfigurationRuleTransition]] = ...) -> None:
...
class BucketLifecycleConfigurationRuleAbortIncompleteMultipartUpload(dict):
    ...
    def __init__(__self__, *, days_after_initiation: Optional[_builtins.int] = ...) -> None:
...
class BucketLifecycleConfigurationRuleExpiration(dict):
    ...
    def __init__(__self__, *, date: Optional[_builtins.str] = ..., days: Optional[_builtins.int] = ..., expired_object_delete_marker: Optional[_builtins.bool] = ...) -> None:
...
class BucketLifecycleConfigurationRuleFilter(dict):
    ...
    def __init__(__self__, *, and_: Optional[outputs.BucketLifecycleConfigurationRuleFilterAnd] = ..., object_size_greater_than: Optional[_builtins.int] = ..., object_size_less_than: Optional[_builtins.int] = ..., prefix: Optional[_builtins.str] = ..., tag: Optional[outputs.BucketLifecycleConfigurationRuleFilterTag] = ...) -> None:
...
class BucketLifecycleConfigurationRuleFilterAnd(dict):
    ...
    def __init__(__self__, *, object_size_greater_than: Optional[_builtins.int] = ..., object_size_less_than: Optional[_builtins.int] = ..., prefix: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class BucketLifecycleConfigurationRuleNoncurrentVersionExpiration(dict):
    ...
    def __init__(__self__, *, noncurrent_days: _builtins.int, newer_noncurrent_versions: Optional[_builtins.int] = ...) -> None:
...
class BucketLifecycleConfigurationRuleNoncurrentVersionTransition(dict):
    ...
    def __init__(__self__, *, noncurrent_days: _builtins.int, storage_class: _builtins.str, newer_noncurrent_versions: Optional[_builtins.int] = ...) -> None:
...
class BucketLifecycleConfigurationRuleTransition(dict):
    ...
    def __init__(__self__, *, storage_class: _builtins.str, date: Optional[_builtins.str] = ..., days: Optional[_builtins.int] = ...) -> None:
...
class BucketLifecycleConfigurationV2Rule(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, status: _builtins.str, abort_incomplete_multipart_upload: Optional[outputs.BucketLifecycleConfigurationV2RuleAbortIncompleteMultipartUpload] = ..., expiration: Optional[outputs.BucketLifecycleConfigurationV2RuleExpiration] = ..., filter: Optional[outputs.BucketLifecycleConfigurationV2RuleFilter] = ..., noncurrent_version_expiration: Optional[outputs.BucketLifecycleConfigurationV2RuleNoncurrentVersionExpiration] = ..., noncurrent_version_transitions: Optional[Sequence[outputs.BucketLifecycleConfigurationV2RuleNoncurrentVersionTransition]] = ..., prefix: Optional[_builtins.str] = ..., transitions: Optional[Sequence[outputs.BucketLifecycleConfigurationV2RuleTransition]] = ...) -> None:
...
class BucketLifecycleConfigurationV2RuleFilter(dict):
    ...
    def __init__(__self__, *, and_: Optional[outputs.BucketLifecycleConfigurationV2RuleFilterAnd] = ..., object_size_greater_than: Optional[_builtins.int] = ..., object_size_less_than: Optional[_builtins.int] = ..., prefix: Optional[_builtins.str] = ..., tag: Optional[outputs.BucketLifecycleConfigurationV2RuleFilterTag] = ...) -> None:
...
class BucketLifecycleRule(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, abort_incomplete_multipart_upload_days: Optional[_builtins.int] = ..., expiration: Optional[outputs.BucketLifecycleRuleExpiration] = ..., id: Optional[_builtins.str] = ..., noncurrent_version_expiration: Optional[outputs.BucketLifecycleRuleNoncurrentVersionExpiration] = ..., noncurrent_version_transitions: Optional[Sequence[outputs.BucketLifecycleRuleNoncurrentVersionTransition]] = ..., prefix: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., transitions: Optional[Sequence[outputs.BucketLifecycleRuleTransition]] = ...) -> None:
...
class BucketLifecycleRuleNoncurrentVersionTransition(dict):
    ...
    def __init__(__self__, *, storage_class: _builtins.str, days: Optional[_builtins.int] = ...) -> None:
...
class BucketLogging(dict):
    ...
    def __init__(__self__, *, target_bucket: _builtins.str, target_prefix: Optional[_builtins.str] = ...) -> None:
...
class BucketLoggingTargetGrant(dict):
    def __init__(__self__, *, grantee: outputs.BucketLoggingTargetGrantGrantee, permission: _builtins.str) -> None:
...
class BucketLoggingTargetObjectKeyFormat(dict):
    ...
    def __init__(__self__, *, partitioned_prefix: Optional[outputs.BucketLoggingTargetObjectKeyFormatPartitionedPrefix] = ..., simple_prefix: Optional[outputs.BucketLoggingTargetObjectKeyFormatSimplePrefix] = ...) -> None:
...
class BucketLoggingV2TargetGrant(dict):
    def __init__(__self__, *, grantee: outputs.BucketLoggingV2TargetGrantGrantee, permission: _builtins.str) -> None:
...
class BucketLoggingV2TargetObjectKeyFormat(dict):
    ...
    def __init__(__self__, *, partitioned_prefix: Optional[outputs.BucketLoggingV2TargetObjectKeyFormatPartitionedPrefix] = ..., simple_prefix: Optional[outputs.BucketLoggingV2TargetObjectKeyFormatSimplePrefix] = ...) -> None:
...
class BucketMetadataConfigurationMetadataConfiguration(dict):
    ...
    def __init__(__self__, *, inventory_table_configuration: outputs.BucketMetadataConfigurationMetadataConfigurationInventoryTableConfiguration, journal_table_configuration: outputs.BucketMetadataConfigurationMetadataConfigurationJournalTableConfiguration, destinations: Optional[Sequence[outputs.BucketMetadataConfigurationMetadataConfigurationDestination]] = ...) -> None:
...
class BucketMetadataConfigurationMetadataConfigurationDestination(dict):
    ...
    def __init__(__self__, *, table_bucket_arn: _builtins.str, table_bucket_type: _builtins.str, table_namespace: _builtins.str) -> None:
...
class BucketMetadataConfigurationMetadataConfigurationInventoryTableConfiguration(dict):
    ...
    def __init__(__self__, *, configuration_state: _builtins.str, encryption_configuration: Optional[outputs.BucketMetadataConfigurationMetadataConfigurationInventoryTableConfigurationEncryptionConfiguration] = ..., table_arn: Optional[_builtins.str] = ..., table_name: Optional[_builtins.str] = ...) -> None:
...
class BucketMetadataConfigurationMetadataConfigurationInventoryTableConfigurationEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *, sse_algorithm: _builtins.str, kms_key_arn: Optional[_builtins.str] = ...) -> None:
...
class BucketMetadataConfigurationMetadataConfigurationJournalTableConfiguration(dict):
    ...
    def __init__(__self__, *, record_expiration: outputs.BucketMetadataConfigurationMetadataConfigurationJournalTableConfigurationRecordExpiration, encryption_configuration: Optional[outputs.BucketMetadataConfigurationMetadataConfigurationJournalTableConfigurationEncryptionConfiguration] = ..., table_arn: Optional[_builtins.str] = ..., table_name: Optional[_builtins.str] = ...) -> None:
...
class BucketMetadataConfigurationMetadataConfigurationJournalTableConfigurationRecordExpiration(dict):
    def __init__(__self__, *, expiration: _builtins.str, days: Optional[_builtins.int] = ...) -> None:
...
class BucketMetricFilter(dict):
    ...
    def __init__(__self__, *, access_point: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class BucketNotificationLambdaFunction(dict):
    ...
    def __init__(__self__, *, events: Sequence[_builtins.str], filter_prefix: Optional[_builtins.str] = ..., filter_suffix: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., lambda_function_arn: Optional[_builtins.str] = ...) -> None:
...
class BucketNotificationQueue(dict):
    ...
    def __init__(__self__, *, events: Sequence[_builtins.str], queue_arn: _builtins.str, filter_prefix: Optional[_builtins.str] = ..., filter_suffix: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ...) -> None:
...
class BucketNotificationTopic(dict):
    ...
    def __init__(__self__, *, events: Sequence[_builtins.str], topic_arn: _builtins.str, filter_prefix: Optional[_builtins.str] = ..., filter_suffix: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ...) -> None:
...
class BucketObjectLockConfiguration(dict):
    ...
    def __init__(__self__, *, object_lock_enabled: Optional[_builtins.str] = ..., rule: Optional[outputs.BucketObjectLockConfigurationRule] = ...) -> None:
...
class BucketObjectLockConfigurationRule(dict):
    ...
    def __init__(__self__, *, default_retention: outputs.BucketObjectLockConfigurationRuleDefaultRetention) -> None:
...
class BucketObjectLockConfigurationRuleDefaultRetention(dict):
    def __init__(__self__, *, days: Optional[_builtins.int] = ..., mode: Optional[_builtins.str] = ..., years: Optional[_builtins.int] = ...) -> None:
...
class BucketObjectLockConfigurationV2Rule(dict):
    ...
    def __init__(__self__, *, default_retention: outputs.BucketObjectLockConfigurationV2RuleDefaultRetention) -> None:
...
class BucketObjectv2OverrideProvider(dict):
    ...
    def __init__(__self__, *, default_tags: Optional[outputs.BucketObjectv2OverrideProviderDefaultTags] = ...) -> None:
...
class BucketReplicationConfigRule(dict):
    ...
    def __init__(__self__, *, destination: outputs.BucketReplicationConfigRuleDestination, status: _builtins.str, delete_marker_replication: Optional[outputs.BucketReplicationConfigRuleDeleteMarkerReplication] = ..., existing_object_replication: Optional[outputs.BucketReplicationConfigRuleExistingObjectReplication] = ..., filter: Optional[outputs.BucketReplicationConfigRuleFilter] = ..., id: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ..., priority: Optional[_builtins.int] = ..., source_selection_criteria: Optional[outputs.BucketReplicationConfigRuleSourceSelectionCriteria] = ...) -> None:
...
class BucketReplicationConfigRuleDestination(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, access_control_translation: Optional[outputs.BucketReplicationConfigRuleDestinationAccessControlTranslation] = ..., account: Optional[_builtins.str] = ..., encryption_configuration: Optional[outputs.BucketReplicationConfigRuleDestinationEncryptionConfiguration] = ..., metrics: Optional[outputs.BucketReplicationConfigRuleDestinationMetrics] = ..., replication_time: Optional[outputs.BucketReplicationConfigRuleDestinationReplicationTime] = ..., storage_class: Optional[_builtins.str] = ...) -> None:
...
class BucketReplicationConfigRuleDestinationMetrics(dict):
    ...
    def __init__(__self__, *, status: _builtins.str, event_threshold: Optional[outputs.BucketReplicationConfigRuleDestinationMetricsEventThreshold] = ...) -> None:
...
class BucketReplicationConfigRuleDestinationReplicationTime(dict):
    def __init__(__self__, *, status: _builtins.str, time: outputs.BucketReplicationConfigRuleDestinationReplicationTimeTime) -> None:
...
class BucketReplicationConfigRuleFilter(dict):
    ...
    def __init__(__self__, *, and_: Optional[outputs.BucketReplicationConfigRuleFilterAnd] = ..., prefix: Optional[_builtins.str] = ..., tag: Optional[outputs.BucketReplicationConfigRuleFilterTag] = ...) -> None:
...
class BucketReplicationConfigRuleSourceSelectionCriteria(dict):
    ...
    def __init__(__self__, *, replica_modifications: Optional[outputs.BucketReplicationConfigRuleSourceSelectionCriteriaReplicaModifications] = ..., sse_kms_encrypted_objects: Optional[outputs.BucketReplicationConfigRuleSourceSelectionCriteriaSseKmsEncryptedObjects] = ...) -> None:
...
class BucketReplicationConfiguration(dict):
    def __init__(__self__, *, role: _builtins.str, rules: Sequence[outputs.BucketReplicationConfigurationRule]) -> None:
...
class BucketReplicationConfigurationRule(dict):
    ...
    def __init__(__self__, *, destination: outputs.BucketReplicationConfigurationRuleDestination, status: _builtins.str, delete_marker_replication_status: Optional[_builtins.str] = ..., filter: Optional[outputs.BucketReplicationConfigurationRuleFilter] = ..., id: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ..., priority: Optional[_builtins.int] = ..., source_selection_criteria: Optional[outputs.BucketReplicationConfigurationRuleSourceSelectionCriteria] = ...) -> None:
...
class BucketReplicationConfigurationRuleDestination(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, access_control_translation: Optional[outputs.BucketReplicationConfigurationRuleDestinationAccessControlTranslation] = ..., account_id: Optional[_builtins.str] = ..., metrics: Optional[outputs.BucketReplicationConfigurationRuleDestinationMetrics] = ..., replica_kms_key_id: Optional[_builtins.str] = ..., replication_time: Optional[outputs.BucketReplicationConfigurationRuleDestinationReplicationTime] = ..., storage_class: Optional[_builtins.str] = ...) -> None:
...
class BucketReplicationConfigurationRuleDestinationMetrics(dict):
    def __init__(__self__, *, minutes: Optional[_builtins.int] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class BucketReplicationConfigurationRuleSourceSelectionCriteria(dict):
    ...
    def __init__(__self__, *, sse_kms_encrypted_objects: Optional[outputs.BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjects] = ...) -> None:
...
class BucketServerSideEncryptionConfiguration(dict):
    def __init__(__self__, *, rule: outputs.BucketServerSideEncryptionConfigurationRule) -> None:
...
class BucketServerSideEncryptionConfigurationRule(dict):
    ...
    def __init__(__self__, *, apply_server_side_encryption_by_default: Optional[outputs.BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefault] = ..., blocked_encryption_types: Optional[Sequence[_builtins.str]] = ..., bucket_key_enabled: Optional[_builtins.bool] = ...) -> None:
...
class BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefault(dict):
    ...
    def __init__(__self__, *, sse_algorithm: _builtins.str, kms_master_key_id: Optional[_builtins.str] = ...) -> None:
...
class BucketServerSideEncryptionConfigurationV2Rule(dict):
    ...
    def __init__(__self__, *, apply_server_side_encryption_by_default: Optional[outputs.BucketServerSideEncryptionConfigurationV2RuleApplyServerSideEncryptionByDefault] = ..., blocked_encryption_types: Optional[Sequence[_builtins.str]] = ..., bucket_key_enabled: Optional[_builtins.bool] = ...) -> None:
...
class BucketV2LifecycleRule(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, abort_incomplete_multipart_upload_days: Optional[_builtins.int] = ..., expirations: Optional[Sequence[outputs.BucketV2LifecycleRuleExpiration]] = ..., id: Optional[_builtins.str] = ..., noncurrent_version_expirations: Optional[Sequence[outputs.BucketV2LifecycleRuleNoncurrentVersionExpiration]] = ..., noncurrent_version_transitions: Optional[Sequence[outputs.BucketV2LifecycleRuleNoncurrentVersionTransition]] = ..., prefix: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., transitions: Optional[Sequence[outputs.BucketV2LifecycleRuleTransition]] = ...) -> None:
...
class BucketV2ObjectLockConfiguration(dict):
    ...
    def __init__(__self__, *, object_lock_enabled: Optional[_builtins.str] = ..., rules: Optional[Sequence[outputs.BucketV2ObjectLockConfigurationRule]] = ...) -> None:
...
class BucketV2ObjectLockConfigurationRule(dict):
    ...
    def __init__(__self__, *, default_retentions: Sequence[outputs.BucketV2ObjectLockConfigurationRuleDefaultRetention]) -> None:
...
class BucketV2ObjectLockConfigurationRuleDefaultRetention(dict):
    def __init__(__self__, *, mode: _builtins.str, days: Optional[_builtins.int] = ..., years: Optional[_builtins.int] = ...) -> None:
...
class BucketV2ReplicationConfiguration(dict):
    def __init__(__self__, *, role: _builtins.str, rules: Sequence[outputs.BucketV2ReplicationConfigurationRule]) -> None:
...
class BucketV2ReplicationConfigurationRule(dict):
    ...
    def __init__(__self__, *, destinations: Sequence[outputs.BucketV2ReplicationConfigurationRuleDestination], status: _builtins.str, delete_marker_replication_status: Optional[_builtins.str] = ..., filters: Optional[Sequence[outputs.BucketV2ReplicationConfigurationRuleFilter]] = ..., id: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ..., priority: Optional[_builtins.int] = ..., source_selection_criterias: Optional[Sequence[outputs.BucketV2ReplicationConfigurationRuleSourceSelectionCriteria]] = ...) -> None:
...
class BucketV2ReplicationConfigurationRuleDestination(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, access_control_translations: Optional[Sequence[outputs.BucketV2ReplicationConfigurationRuleDestinationAccessControlTranslation]] = ..., account_id: Optional[_builtins.str] = ..., metrics: Optional[Sequence[outputs.BucketV2ReplicationConfigurationRuleDestinationMetric]] = ..., replica_kms_key_id: Optional[_builtins.str] = ..., replication_times: Optional[Sequence[outputs.BucketV2ReplicationConfigurationRuleDestinationReplicationTime]] = ..., storage_class: Optional[_builtins.str] = ...) -> None:
...
class BucketV2ReplicationConfigurationRuleSourceSelectionCriteria(dict):
    ...
    def __init__(__self__, *, sse_kms_encrypted_objects: Optional[Sequence[outputs.BucketV2ReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObject]] = ...) -> None:
...
class BucketV2ServerSideEncryptionConfiguration(dict):
    def __init__(__self__, *, rules: Sequence[outputs.BucketV2ServerSideEncryptionConfigurationRule]) -> None:
...
class BucketV2ServerSideEncryptionConfigurationRule(dict):
    ...
    def __init__(__self__, *, apply_server_side_encryption_by_defaults: Sequence[outputs.BucketV2ServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefault], bucket_key_enabled: Optional[_builtins.bool] = ...) -> None:
...
class BucketV2Versioning(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., mfa_delete: Optional[_builtins.bool] = ...) -> None:
...
class BucketV2Website(dict):
    ...
    def __init__(__self__, *, error_document: Optional[_builtins.str] = ..., index_document: Optional[_builtins.str] = ..., redirect_all_requests_to: Optional[_builtins.str] = ..., routing_rules: Optional[_builtins.str] = ...) -> None:
...
class BucketVersioningV2VersioningConfiguration(dict):
    ...
    def __init__(__self__, *, status: _builtins.str, mfa_delete: Optional[_builtins.str] = ...) -> None:
...
class BucketWebsiteConfigurationRedirectAllRequestsTo(dict):
    ...
    def __init__(__self__, *, host_name: _builtins.str, protocol: Optional[_builtins.str] = ...) -> None:
...
class BucketWebsiteConfigurationRoutingRule(dict):
    def __init__(__self__, *, redirect: outputs.BucketWebsiteConfigurationRoutingRuleRedirect, condition: Optional[outputs.BucketWebsiteConfigurationRoutingRuleCondition] = ...) -> None:
...
class BucketWebsiteConfigurationRoutingRuleCondition(dict):
    ...
    def __init__(__self__, *, http_error_code_returned_equals: Optional[_builtins.str] = ..., key_prefix_equals: Optional[_builtins.str] = ...) -> None:
...
class BucketWebsiteConfigurationRoutingRuleRedirect(dict):
    ...
    def __init__(__self__, *, host_name: Optional[_builtins.str] = ..., http_redirect_code: Optional[_builtins.str] = ..., protocol: Optional[_builtins.str] = ..., replace_key_prefix_with: Optional[_builtins.str] = ..., replace_key_with: Optional[_builtins.str] = ...) -> None:
...
class BucketWebsiteConfigurationV2RoutingRule(dict):
    def __init__(__self__, *, redirect: outputs.BucketWebsiteConfigurationV2RoutingRuleRedirect, condition: Optional[outputs.BucketWebsiteConfigurationV2RoutingRuleCondition] = ...) -> None:
...
class DirectoryBucketLocation(dict):
    def __init__(__self__, *, name: _builtins.str, type: Optional[_builtins.str] = ...) -> None:
...
class InventoryDestinationBucket(dict):
    ...
    def __init__(__self__, *, bucket_arn: _builtins.str, format: _builtins.str, account_id: Optional[_builtins.str] = ..., encryption: Optional[outputs.InventoryDestinationBucketEncryption] = ..., prefix: Optional[_builtins.str] = ...) -> None:
...
class InventoryDestinationBucketEncryption(dict):
    ...
    def __init__(__self__, *, sse_kms: Optional[outputs.InventoryDestinationBucketEncryptionSseKms] = ..., sse_s3: Optional[outputs.InventoryDestinationBucketEncryptionSseS3] = ...) -> None:
...
class ObjectCopyGrant(dict):
    def __init__(__self__, *, permissions: Sequence[_builtins.str], type: _builtins.str, email: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class ObjectCopyOverrideProvider(dict):
    ...
    def __init__(__self__, *, default_tags: Optional[outputs.ObjectCopyOverrideProviderDefaultTags] = ...) -> None:
...
class VectorsIndexEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *, kms_key_arn: _builtins.str, sse_type: _builtins.str) -> None:
...
class VectorsIndexMetadataConfiguration(dict):
    ...
    def __init__(__self__, *, non_filterable_metadata_keys: Sequence[_builtins.str]) -> None:
...
class GetAccessPointPublicAccessBlockConfigurationResult(dict):
    def __init__(__self__, *, block_public_acls: _builtins.bool, block_public_policy: _builtins.bool, ignore_public_acls: _builtins.bool, restrict_public_buckets: _builtins.bool) -> None:
...
class GetBucketObjectLockConfigurationRuleResult(dict):
    def __init__(__self__, *, default_retentions: Sequence[outputs.GetBucketObjectLockConfigurationRuleDefaultRetentionResult]) -> None:
...
class GetBucketObjectLockConfigurationRuleDefaultRetentionResult(dict):
    def __init__(__self__, *, days: _builtins.int, mode: _builtins.str, years: _builtins.int) -> None:
...
class GetBucketReplicationConfigurationRuleResult(dict):
    def __init__(__self__, *, delete_marker_replications: Sequence[outputs.GetBucketReplicationConfigurationRuleDeleteMarkerReplicationResult], destinations: Sequence[outputs.GetBucketReplicationConfigurationRuleDestinationResult], existing_object_replications: Sequence[outputs.GetBucketReplicationConfigurationRuleExistingObjectReplicationResult], filters: Sequence[outputs.GetBucketReplicationConfigurationRuleFilterResult], id: _builtins.str, prefix: _builtins.str, priority: _builtins.int, source_selection_criterias: Sequence[outputs.GetBucketReplicationConfigurationRuleSourceSelectionCriteriaResult], status: _builtins.str) -> None:
...
class GetBucketReplicationConfigurationRuleDestinationResult(dict):
    def __init__(__self__, *, access_control_translations: Sequence[outputs.GetBucketReplicationConfigurationRuleDestinationAccessControlTranslationResult], account: _builtins.str, bucket: _builtins.str, encryption_configurations: Sequence[outputs.GetBucketReplicationConfigurationRuleDestinationEncryptionConfigurationResult], metrics: Sequence[outputs.GetBucketReplicationConfigurationRuleDestinationMetricResult], replication_times: Sequence[outputs.GetBucketReplicationConfigurationRuleDestinationReplicationTimeResult], storage_class: _builtins.str) -> None:
...
class GetBucketReplicationConfigurationRuleDestinationMetricResult(dict):
    def __init__(__self__, *, event_thresholds: Sequence[outputs.GetBucketReplicationConfigurationRuleDestinationMetricEventThresholdResult], status: _builtins.str) -> None:
        ...
...
class GetBucketReplicationConfigurationRuleDestinationReplicationTimeResult(dict):
    def __init__(__self__, *, status: _builtins.str, times: Sequence[outputs.GetBucketReplicationConfigurationRuleDestinationReplicationTimeTimeResult]) -> None:
        ...
...
class GetBucketReplicationConfigurationRuleFilterResult(dict):
    def __init__(__self__, *, ands: Sequence[outputs.GetBucketReplicationConfigurationRuleFilterAndResult], prefix: _builtins.str, tags: Sequence[outputs.GetBucketReplicationConfigurationRuleFilterTagResult]) -> None:
...
class GetBucketReplicationConfigurationRuleFilterAndResult(dict):
    def __init__(__self__, *, prefix: _builtins.str, tags: Sequence[outputs.GetBucketReplicationConfigurationRuleFilterAndTagResult]) -> None:
...
class GetBucketReplicationConfigurationRuleSourceSelectionCriteriaResult(dict):
    def __init__(__self__, *, replica_modifications: Sequence[outputs.GetBucketReplicationConfigurationRuleSourceSelectionCriteriaReplicaModificationResult], sse_kms_encrypted_objects: Sequence[outputs.GetBucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjectResult]) -> None:
        ...
