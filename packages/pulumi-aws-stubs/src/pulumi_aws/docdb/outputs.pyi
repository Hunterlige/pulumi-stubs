...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterMasterUserSecret', 'ClusterParameterGroupParameter', 'ClusterRestoreToPointInTime', 'ClusterServerlessV2ScalingConfiguration', 'ElasticClusterTimeouts', 'GlobalClusterGlobalClusterMember']
@pulumi.output_type
...
class ClusterRestoreToPointInTime(dict):
    ...
    def __init__(__self__, *, source_cluster_identifier: _builtins.str, restore_to_time: Optional[_builtins.str] = ..., restore_type: Optional[_builtins.str] = ..., use_latest_restorable_time: Optional[_builtins.bool] = ...) -> None:
...
class ClusterServerlessV2ScalingConfiguration(dict):
    ...
    def __init__(__self__, *, max_capacity: _builtins.float, min_capacity: _builtins.float) -> None:
