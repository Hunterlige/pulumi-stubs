...
class GetEngineVersionResult:
    ...
    def __init__(__self__, engine=..., engine_description=..., exportable_log_types=..., id=..., parameter_group_family=..., preferred_versions=..., region=..., supports_log_exports_to_cloudwatch=..., valid_upgrade_targets=..., version=..., version_description=...) -> None:
        ...
...
def get_engine_version(engine: Optional[_builtins.str] = ..., parameter_group_family: Optional[_builtins.str] = ..., preferred_versions: Optional[Sequence[_builtins.str]] = ..., region: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetEngineVersionResult:
    
    ...

def get_engine_version_output(engine: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., parameter_group_family: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., preferred_versions: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., version: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetEngineVersionResult]:
