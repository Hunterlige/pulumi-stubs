...
class VpcAttachmentArgs:
    def __init__(__self__, *, core_network_id: pulumi.Input[_builtins.str], subnet_arns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], vpc_arn: pulumi.Input[_builtins.str], options: Optional[pulumi.Input[VpcAttachmentOptionsArgs]] = ..., routing_policy_label: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @subnet_arns.setter
    def subnet_arns(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @vpc_arn.setter
    def vpc_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @options.setter
    def options(self, value: Optional[pulumi.Input[VpcAttachmentOptionsArgs]]): # -> None:
        ...
...
class _VpcAttachmentState:
    def __init__(__self__, *, arn: Optional[pulumi.Input[_builtins.str]] = ..., attachment_policy_rule_number: Optional[pulumi.Input[_builtins.int]] = ..., attachment_type: Optional[pulumi.Input[_builtins.str]] = ..., core_network_arn: Optional[pulumi.Input[_builtins.str]] = ..., core_network_id: Optional[pulumi.Input[_builtins.str]] = ..., edge_location: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[VpcAttachmentOptionsArgs]] = ..., owner_account_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_arn: Optional[pulumi.Input[_builtins.str]] = ..., routing_policy_label: Optional[pulumi.Input[_builtins.str]] = ..., segment_name: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., subnet_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., vpc_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @vpc_arn.setter
    def vpc_arn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VpcAttachment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., core_network_id: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[Union[VpcAttachmentOptionsArgs, VpcAttachmentOptionsArgsDict]]] = ..., routing_policy_label: Optional[pulumi.Input[_builtins.str]] = ..., subnet_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., vpc_arn: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., arn: Optional[pulumi.Input[_builtins.str]] = ..., attachment_policy_rule_number: Optional[pulumi.Input[_builtins.int]] = ..., attachment_type: Optional[pulumi.Input[_builtins.str]] = ..., core_network_arn: Optional[pulumi.Input[_builtins.str]] = ..., core_network_id: Optional[pulumi.Input[_builtins.str]] = ..., edge_location: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[Union[VpcAttachmentOptionsArgs, VpcAttachmentOptionsArgsDict]]] = ..., owner_account_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_arn: Optional[pulumi.Input[_builtins.str]] = ..., routing_policy_label: Optional[pulumi.Input[_builtins.str]] = ..., segment_name: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., subnet_arns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., vpc_arn: Optional[pulumi.Input[_builtins.str]] = ...) -> VpcAttachment:
