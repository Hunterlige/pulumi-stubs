...
class VpcAttachmentArgs:
    def __init__(
        ...
        *,
        ...
        options: Optional[pulumi.Input[VpcAttachmentOptionsArgs]] = ...,
...
class _VpcAttachmentState:
    def __init__(
        ...
        *,
        ...
        vpc_arn: Optional[pulumi.Input[_builtins.str]] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
...
class VpcAttachment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        core_network_id: Optional[pulumi.Input[_builtins.str]] = ...,
        options: Optional[
            pulumi.Input[Union[VpcAttachmentOptionsArgs, VpcAttachmentOptionsArgsDict]]
        ] = ...,
        routing_policy_label: Optional[pulumi.Input[_builtins.str]] = ...,
        subnet_arns: Optional[
            pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
