...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectAttachmentOptions', 'ConnectPeerBgpOptions', 'ConnectPeerConfiguration', 'ConnectPeerConfigurationBgpConfiguration', 'CoreNetworkEdge', 'CoreNetworkSegment', 'DeviceAwsLocation', 'DeviceLocation', 'DxGatewayAttachmentTimeouts', 'LinkBandwidth', 'SiteLocation', 'VpcAttachmentOptions', 'GetCoreNetworkPolicyDocumentAttachmentPolicyResult', ..., ..., ..., ..., ..., ..., ..., ..., 'GetCoreNetworkPolicyDocumentRoutingPolicyResult', ..., ..., ..., ..., 'GetCoreNetworkPolicyDocumentSegmentResult', 'GetCoreNetworkPolicyDocumentSegmentActionResult', ..., 'GetCoreNetworkPolicyDocumentSegmentActionViaResult', ..., ..., 'GetDeviceAwsLocationResult', 'GetDeviceLocationResult', 'GetLinkBandwidthResult', 'GetSiteLocationResult']
@pulumi.output_type
...
class ConnectPeerConfiguration(dict):
    ...
    def __init__(__self__, *, bgp_configurations: Optional[Sequence[outputs.ConnectPeerConfigurationBgpConfiguration]] = ..., core_network_address: Optional[_builtins.str] = ..., inside_cidr_blocks: Optional[Sequence[_builtins.str]] = ..., peer_address: Optional[_builtins.str] = ..., protocol: Optional[_builtins.str] = ...) -> None:
...
class ConnectPeerConfigurationBgpConfiguration(dict):
    ...
    def __init__(__self__, *, core_network_address: Optional[_builtins.str] = ..., core_network_asn: Optional[_builtins.int] = ..., peer_address: Optional[_builtins.str] = ..., peer_asn: Optional[_builtins.str] = ...) -> None:
...
class CoreNetworkEdge(dict):
    ...
    def __init__(__self__, *, asn: Optional[_builtins.int] = ..., edge_location: Optional[_builtins.str] = ..., inside_cidr_blocks: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CoreNetworkSegment(dict):
    ...
    def __init__(__self__, *, edge_locations: Optional[Sequence[_builtins.str]] = ..., name: Optional[_builtins.str] = ..., shared_segments: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DeviceAwsLocation(dict):
    ...
    def __init__(__self__, *, subnet_arn: Optional[_builtins.str] = ..., zone: Optional[_builtins.str] = ...) -> None:
...
class DeviceLocation(dict):
    def __init__(__self__, *, address: Optional[_builtins.str] = ..., latitude: Optional[_builtins.str] = ..., longitude: Optional[_builtins.str] = ...) -> None:
...
class LinkBandwidth(dict):
    ...
    def __init__(__self__, *, download_speed: Optional[_builtins.int] = ..., upload_speed: Optional[_builtins.int] = ...) -> None:
...
class VpcAttachmentOptions(dict):
    ...
    def __init__(__self__, *, appliance_mode_support: Optional[_builtins.bool] = ..., dns_support: Optional[_builtins.bool] = ..., ipv6_support: Optional[_builtins.bool] = ..., security_group_referencing_support: Optional[_builtins.bool] = ...) -> None:
...
class GetCoreNetworkPolicyDocumentAttachmentPolicyResult(dict):
    def __init__(__self__, *, action: outputs.GetCoreNetworkPolicyDocumentAttachmentPolicyActionResult, conditions: Sequence[outputs.GetCoreNetworkPolicyDocumentAttachmentPolicyConditionResult], rule_number: _builtins.int, condition_logic: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class GetCoreNetworkPolicyDocumentAttachmentRoutingPolicyRuleResult(dict):
    def __init__(__self__, *, action: outputs.GetCoreNetworkPolicyDocumentAttachmentRoutingPolicyRuleActionResult, conditions: Sequence[outputs.GetCoreNetworkPolicyDocumentAttachmentRoutingPolicyRuleConditionResult], rule_number: _builtins.int, description: Optional[_builtins.str] = ..., edge_locations: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GetCoreNetworkPolicyDocumentRoutingPolicyResult(dict):
    def __init__(__self__, *, routing_policy_direction: _builtins.str, routing_policy_name: _builtins.str, routing_policy_number: _builtins.int, routing_policy_rules: Sequence[outputs.GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleResult], routing_policy_description: Optional[_builtins.str] = ...) -> None:
...
class GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleResult(dict):
    def __init__(__self__, *, rule_definition: outputs.GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionResult, rule_number: _builtins.int) -> None:
...
class GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionResult(dict):
    def __init__(__self__, *, action: outputs.GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionActionResult, condition_logic: Optional[_builtins.str] = ..., match_conditions: Optional[Sequence[outputs.GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionMatchConditionResult]] = ...) -> None:
...
class GetCoreNetworkPolicyDocumentSegmentActionResult(dict):
    def __init__(__self__, *, action: _builtins.str, segment: _builtins.str, description: Optional[_builtins.str] = ..., destination_cidr_blocks: Optional[Sequence[_builtins.str]] = ..., destinations: Optional[Sequence[_builtins.str]] = ..., edge_location_association: Optional[outputs.GetCoreNetworkPolicyDocumentSegmentActionEdgeLocationAssociationResult] = ..., mode: Optional[_builtins.str] = ..., routing_policy_names: Optional[Sequence[_builtins.str]] = ..., share_with_excepts: Optional[Sequence[_builtins.str]] = ..., share_withs: Optional[Sequence[_builtins.str]] = ..., via: Optional[outputs.GetCoreNetworkPolicyDocumentSegmentActionViaResult] = ..., when_sent_to: Optional[outputs.GetCoreNetworkPolicyDocumentSegmentActionWhenSentToResult] = ...) -> None:
...
class GetCoreNetworkPolicyDocumentSegmentActionViaResult(dict):
    def __init__(__self__, *, network_function_groups: Optional[Sequence[_builtins.str]] = ..., with_edge_overrides: Optional[Sequence[outputs.GetCoreNetworkPolicyDocumentSegmentActionViaWithEdgeOverrideResult]] = ...) -> None:
...
class GetDeviceAwsLocationResult(dict):
    def __init__(__self__, *, subnet_arn: _builtins.str, zone: _builtins.str) -> None:
...
class GetDeviceLocationResult(dict):
    def __init__(__self__, *, address: _builtins.str, latitude: _builtins.str, longitude: _builtins.str) -> None:
...
class GetLinkBandwidthResult(dict):
    def __init__(__self__, *, download_speed: _builtins.int, upload_speed: _builtins.int) -> None:
