...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectAttachmentOptionsArgs', 'ConnectAttachmentOptionsArgsDict', 'ConnectPeerBgpOptionsArgs', 'ConnectPeerBgpOptionsArgsDict', 'ConnectPeerConfigurationArgs', 'ConnectPeerConfigurationArgsDict', 'ConnectPeerConfigurationBgpConfigurationArgs', 'ConnectPeerConfigurationBgpConfigurationArgsDict', 'CoreNetworkEdgeArgs', 'CoreNetworkEdgeArgsDict', 'CoreNetworkSegmentArgs', 'CoreNetworkSegmentArgsDict', 'DeviceAwsLocationArgs', 'DeviceAwsLocationArgsDict', 'DeviceLocationArgs', 'DeviceLocationArgsDict', 'DxGatewayAttachmentTimeoutsArgs', 'DxGatewayAttachmentTimeoutsArgsDict', 'LinkBandwidthArgs', 'LinkBandwidthArgsDict', 'SiteLocationArgs', 'SiteLocationArgsDict', 'VpcAttachmentOptionsArgs', 'VpcAttachmentOptionsArgsDict', 'GetCoreNetworkPolicyDocumentAttachmentPolicyArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetCoreNetworkPolicyDocumentRoutingPolicyArgs', 'GetCoreNetworkPolicyDocumentRoutingPolicyArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'GetCoreNetworkPolicyDocumentSegmentArgs', 'GetCoreNetworkPolicyDocumentSegmentArgsDict', 'GetCoreNetworkPolicyDocumentSegmentActionArgs', 'GetCoreNetworkPolicyDocumentSegmentActionArgsDict', ..., ..., 'GetCoreNetworkPolicyDocumentSegmentActionViaArgs', ..., ..., ..., ..., ...]
...
class ConnectAttachmentOptionsArgs:
    def __init__(__self__, *, protocol: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ConnectPeerBgpOptionsArgs:
    def __init__(__self__, *, peer_asn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @peer_asn.setter
    def peer_asn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectPeerConfigurationArgs:
    def __init__(__self__, *, bgp_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[ConnectPeerConfigurationBgpConfigurationArgs]]]] = ..., core_network_address: Optional[pulumi.Input[_builtins.str]] = ..., inside_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., peer_address: Optional[pulumi.Input[_builtins.str]] = ..., protocol: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def bgp_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ConnectPeerConfigurationBgpConfigurationArgs]]]]): # -> None:
        ...
...
class ConnectPeerConfigurationBgpConfigurationArgs:
    def __init__(__self__, *, core_network_address: Optional[pulumi.Input[_builtins.str]] = ..., core_network_asn: Optional[pulumi.Input[_builtins.int]] = ..., peer_address: Optional[pulumi.Input[_builtins.str]] = ..., peer_asn: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def core_network_asn(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class CoreNetworkEdgeArgs:
    def __init__(__self__, *, asn: Optional[pulumi.Input[_builtins.int]] = ..., edge_location: Optional[pulumi.Input[_builtins.str]] = ..., inside_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class CoreNetworkSegmentArgs:
    def __init__(__self__, *, edge_locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., shared_segments: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def shared_segments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DeviceAwsLocationArgs:
    def __init__(__self__, *, subnet_arn: Optional[pulumi.Input[_builtins.str]] = ..., zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DeviceLocationArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., latitude: Optional[pulumi.Input[_builtins.str]] = ..., longitude: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @latitude.setter
    def latitude(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @longitude.setter
    def longitude(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LinkBandwidthArgs:
    def __init__(__self__, *, download_speed: Optional[pulumi.Input[_builtins.int]] = ..., upload_speed: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def download_speed(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @upload_speed.setter
    def upload_speed(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class VpcAttachmentOptionsArgs:
    def __init__(__self__, *, appliance_mode_support: Optional[pulumi.Input[_builtins.bool]] = ..., dns_support: Optional[pulumi.Input[_builtins.bool]] = ..., ipv6_support: Optional[pulumi.Input[_builtins.bool]] = ..., security_group_referencing_support: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def appliance_mode_support(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @dns_support.setter
    def dns_support(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @ipv6_support.setter
    def ipv6_support(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def security_group_referencing_support(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentAttachmentPolicyArgs:
    def __init__(__self__, *, action: GetCoreNetworkPolicyDocumentAttachmentPolicyActionArgs, conditions: Sequence[GetCoreNetworkPolicyDocumentAttachmentPolicyConditionArgs], rule_number: _builtins.int, condition_logic: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ...) -> None:
    ...
    @action.setter
    def action(self, value: GetCoreNetworkPolicyDocumentAttachmentPolicyActionArgs): # -> None:
        ...
    ...
    @conditions.setter
    def conditions(self, value: Sequence[GetCoreNetworkPolicyDocumentAttachmentPolicyConditionArgs]): # -> None:
        ...
    ...
    @rule_number.setter
    def rule_number(self, value: _builtins.int): # -> None:
        ...
    ...
    def condition_logic(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    @description.setter
    def description(self, value: Optional[_builtins.str]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentAttachmentPolicyActionArgs:
    def __init__(__self__, *, add_to_network_function_group: Optional[_builtins.str] = ..., association_method: Optional[_builtins.str] = ..., require_acceptance: Optional[_builtins.bool] = ..., segment: Optional[_builtins.str] = ..., tag_value_of_key: Optional[_builtins.str] = ...) -> None:
    ...
    def add_to_network_function_group(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def association_method(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def require_acceptance(self, value: Optional[_builtins.bool]): # -> None:
        ...
    ...
    @segment.setter
    def segment(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def tag_value_of_key(self, value: Optional[_builtins.str]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentAttachmentPolicyConditionArgs:
    def __init__(__self__, *, type: _builtins.str, key: Optional[_builtins.str] = ..., operator: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
    ...
    @operator.setter
    def operator(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    @value.setter
    def value(self, value: Optional[_builtins.str]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentAttachmentRoutingPolicyRuleArgs:
    def __init__(__self__, *, action: GetCoreNetworkPolicyDocumentAttachmentRoutingPolicyRuleActionArgs, conditions: Sequence[GetCoreNetworkPolicyDocumentAttachmentRoutingPolicyRuleConditionArgs], rule_number: _builtins.int, description: Optional[_builtins.str] = ..., edge_locations: Optional[Sequence[_builtins.str]] = ...) -> None:
    ...
    @action.setter
    def action(self, value: GetCoreNetworkPolicyDocumentAttachmentRoutingPolicyRuleActionArgs): # -> None:
        ...
    ...
    @conditions.setter
    def conditions(self, value: Sequence[GetCoreNetworkPolicyDocumentAttachmentRoutingPolicyRuleConditionArgs]): # -> None:
        ...
    ...
    @edge_locations.setter
    def edge_locations(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentAttachmentRoutingPolicyRuleActionArgs:
    def __init__(__self__, *, associate_routing_policies: Sequence[_builtins.str]) -> None:
    ...
    def associate_routing_policies(self, value: Sequence[_builtins.str]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentCoreNetworkConfigurationArgs:
    def __init__(__self__, *, asn_ranges: Sequence[_builtins.str], edge_locations: Sequence[GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocationArgs], dns_support: Optional[_builtins.bool] = ..., inside_cidr_blocks: Optional[Sequence[_builtins.str]] = ..., security_group_referencing_support: Optional[_builtins.bool] = ..., vpn_ecmp_support: Optional[_builtins.bool] = ...) -> None:
    ...
    @asn_ranges.setter
    def asn_ranges(self, value: Sequence[_builtins.str]): # -> None:
        ...
    ...
    @edge_locations.setter
    def edge_locations(self, value: Sequence[GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocationArgs]): # -> None:
        ...
    ...
    @dns_support.setter
    def dns_support(self, value: Optional[_builtins.bool]): # -> None:
        ...
    ...
    @inside_cidr_blocks.setter
    def inside_cidr_blocks(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    @security_group_referencing_support.setter
    def security_group_referencing_support(self, value: Optional[_builtins.bool]): # -> None:
        ...
    ...
    def vpn_ecmp_support(self, value: Optional[_builtins.bool]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocationArgs:
    def __init__(__self__, *, location: _builtins.str, asn: Optional[_builtins.str] = ..., inside_cidr_blocks: Optional[Sequence[_builtins.str]] = ...) -> None:
    ...
    @location.setter
    def location(self, value: _builtins.str): # -> None:
        ...
    ...
    @asn.setter
    def asn(self, value: Optional[_builtins.str]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentNetworkFunctionGroupArgs:
    def __init__(__self__, *, name: _builtins.str, require_attachment_acceptance: _builtins.bool, description: Optional[_builtins.str] = ...) -> None:
    ...
    def require_attachment_acceptance(self, value: _builtins.bool): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentRoutingPolicyArgs:
    def __init__(__self__, *, routing_policy_direction: _builtins.str, routing_policy_name: _builtins.str, routing_policy_number: _builtins.int, routing_policy_rules: Sequence[GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleArgs], routing_policy_description: Optional[_builtins.str] = ...) -> None:
    ...
    def routing_policy_direction(self, value: _builtins.str): # -> None:
        ...
    ...
    def routing_policy_name(self, value: _builtins.str): # -> None:
        ...
    ...
    def routing_policy_number(self, value: _builtins.int): # -> None:
        ...
    ...
    def routing_policy_rules(self, value: Sequence[GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleArgs]): # -> None:
        ...
    ...
    def routing_policy_description(self, value: Optional[_builtins.str]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleArgs:
    def __init__(__self__, *, rule_definition: GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionArgs, rule_number: _builtins.int) -> None:
    ...
    def rule_definition(self, value: GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionArgs): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionArgs:
    def __init__(__self__, *, action: GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionActionArgs, condition_logic: Optional[_builtins.str] = ..., match_conditions: Optional[Sequence[GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionMatchConditionArgs]] = ...) -> None:
    ...
    @action.setter
    def action(self, value: GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionActionArgs): # -> None:
        ...
    ...
    def match_conditions(self, value: Optional[Sequence[GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionMatchConditionArgs]]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentRoutingPolicyRoutingPolicyRuleRuleDefinitionActionArgs:
    def __init__(__self__, *, type: _builtins.str, value: Optional[_builtins.str] = ...) -> None:
...
class GetCoreNetworkPolicyDocumentSegmentArgs:
    def __init__(__self__, *, name: _builtins.str, allow_filters: Optional[Sequence[_builtins.str]] = ..., deny_filters: Optional[Sequence[_builtins.str]] = ..., description: Optional[_builtins.str] = ..., edge_locations: Optional[Sequence[_builtins.str]] = ..., isolate_attachments: Optional[_builtins.bool] = ..., require_attachment_acceptance: Optional[_builtins.bool] = ...) -> None:
    ...
    def allow_filters(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    @deny_filters.setter
    def deny_filters(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    def isolate_attachments(self, value: Optional[_builtins.bool]): # -> None:
        ...
    ...
    @require_attachment_acceptance.setter
    def require_attachment_acceptance(self, value: Optional[_builtins.bool]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentSegmentActionArgs:
    def __init__(__self__, *, action: _builtins.str, segment: _builtins.str, description: Optional[_builtins.str] = ..., destination_cidr_blocks: Optional[Sequence[_builtins.str]] = ..., destinations: Optional[Sequence[_builtins.str]] = ..., edge_location_association: Optional[GetCoreNetworkPolicyDocumentSegmentActionEdgeLocationAssociationArgs] = ..., mode: Optional[_builtins.str] = ..., routing_policy_names: Optional[Sequence[_builtins.str]] = ..., share_with_excepts: Optional[Sequence[_builtins.str]] = ..., share_withs: Optional[Sequence[_builtins.str]] = ..., via: Optional[GetCoreNetworkPolicyDocumentSegmentActionViaArgs] = ..., when_sent_to: Optional[GetCoreNetworkPolicyDocumentSegmentActionWhenSentToArgs] = ...) -> None:
    ...
    @action.setter
    def action(self, value: _builtins.str): # -> None:
        ...
    ...
    @segment.setter
    def segment(self, value: _builtins.str): # -> None:
        ...
    ...
    def destination_cidr_blocks(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    @destinations.setter
    def destinations(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    def edge_location_association(self, value: Optional[GetCoreNetworkPolicyDocumentSegmentActionEdgeLocationAssociationArgs]): # -> None:
        ...
    ...
    @mode.setter
    def mode(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def routing_policy_names(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    def share_with_excepts(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    @share_withs.setter
    def share_withs(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    @via.setter
    def via(self, value: Optional[GetCoreNetworkPolicyDocumentSegmentActionViaArgs]): # -> None:
        ...
    ...
    @when_sent_to.setter
    def when_sent_to(self, value: Optional[GetCoreNetworkPolicyDocumentSegmentActionWhenSentToArgs]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentSegmentActionEdgeLocationAssociationArgs:
    def __init__(__self__, *, edge_location: _builtins.str, peer_edge_location: _builtins.str, routing_policy_names: Sequence[_builtins.str]) -> None:
    ...
    @edge_location.setter
    def edge_location(self, value: _builtins.str): # -> None:
        ...
    ...
    def peer_edge_location(self, value: _builtins.str): # -> None:
        ...
    ...
    @routing_policy_names.setter
    def routing_policy_names(self, value: Sequence[_builtins.str]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentSegmentActionViaArgs:
    def __init__(__self__, *, network_function_groups: Optional[Sequence[_builtins.str]] = ..., with_edge_overrides: Optional[Sequence[GetCoreNetworkPolicyDocumentSegmentActionViaWithEdgeOverrideArgs]] = ...) -> None:
    ...
    def network_function_groups(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
    ...
    def with_edge_overrides(self, value: Optional[Sequence[GetCoreNetworkPolicyDocumentSegmentActionViaWithEdgeOverrideArgs]]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentSegmentActionViaWithEdgeOverrideArgs:
    def __init__(__self__, *, edge_sets: Optional[Sequence[Sequence[_builtins.str]]] = ..., use_edge: Optional[_builtins.str] = ..., use_edge_location: Optional[_builtins.str] = ...) -> None:
    ...
    @edge_sets.setter
    def edge_sets(self, value: Optional[Sequence[Sequence[_builtins.str]]]): # -> None:
        ...
    ...
    @use_edge.setter
    def use_edge(self, value: Optional[_builtins.str]): # -> None:
        ...
    ...
    def use_edge_location(self, value: Optional[_builtins.str]): # -> None:
        ...
...
class GetCoreNetworkPolicyDocumentSegmentActionWhenSentToArgs:
    def __init__(__self__, *, segments: Optional[Sequence[_builtins.str]] = ...) -> None:
    ...
    @segments.setter
    def segments(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
