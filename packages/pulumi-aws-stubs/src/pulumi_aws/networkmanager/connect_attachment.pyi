...
class ConnectAttachmentArgs:
    def __init__(__self__, *, core_network_id: pulumi.Input[_builtins.str], edge_location: pulumi.Input[_builtins.str], options: pulumi.Input[ConnectAttachmentOptionsArgs], transport_attachment_id: pulumi.Input[_builtins.str], routing_policy_label: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def edge_location(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @options.setter
    def options(self, value: pulumi.Input[ConnectAttachmentOptionsArgs]): # -> None:
        ...
...
class _ConnectAttachmentState:
    def __init__(__self__, *, arn: Optional[pulumi.Input[_builtins.str]] = ..., attachment_id: Optional[pulumi.Input[_builtins.str]] = ..., attachment_policy_rule_number: Optional[pulumi.Input[_builtins.int]] = ..., attachment_type: Optional[pulumi.Input[_builtins.str]] = ..., core_network_arn: Optional[pulumi.Input[_builtins.str]] = ..., core_network_id: Optional[pulumi.Input[_builtins.str]] = ..., edge_location: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[ConnectAttachmentOptionsArgs]] = ..., owner_account_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_arn: Optional[pulumi.Input[_builtins.str]] = ..., routing_policy_label: Optional[pulumi.Input[_builtins.str]] = ..., segment_name: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., transport_attachment_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @options.setter
    def options(self, value: Optional[pulumi.Input[ConnectAttachmentOptionsArgs]]): # -> None:
        ...
...
class ConnectAttachment(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., core_network_id: Optional[pulumi.Input[_builtins.str]] = ..., edge_location: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[Union[ConnectAttachmentOptionsArgs, ConnectAttachmentOptionsArgsDict]]] = ..., routing_policy_label: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., transport_attachment_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ConnectAttachmentArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., arn: Optional[pulumi.Input[_builtins.str]] = ..., attachment_id: Optional[pulumi.Input[_builtins.str]] = ..., attachment_policy_rule_number: Optional[pulumi.Input[_builtins.int]] = ..., attachment_type: Optional[pulumi.Input[_builtins.str]] = ..., core_network_arn: Optional[pulumi.Input[_builtins.str]] = ..., core_network_id: Optional[pulumi.Input[_builtins.str]] = ..., edge_location: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[Union[ConnectAttachmentOptionsArgs, ConnectAttachmentOptionsArgsDict]]] = ..., owner_account_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_arn: Optional[pulumi.Input[_builtins.str]] = ..., routing_policy_label: Optional[pulumi.Input[_builtins.str]] = ..., segment_name: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., transport_attachment_id: Optional[pulumi.Input[_builtins.str]] = ...) -> ConnectAttachment:
