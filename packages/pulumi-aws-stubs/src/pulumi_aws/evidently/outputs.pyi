...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FeatureEvaluationRule', 'FeatureVariation', 'FeatureVariationValue', 'LaunchExecution', 'LaunchGroup', 'LaunchMetricMonitor', 'LaunchMetricMonitorMetricDefinition', 'LaunchScheduledSplitsConfig', 'LaunchScheduledSplitsConfigStep', 'LaunchScheduledSplitsConfigStepSegmentOverride', 'ProjectDataDelivery', 'ProjectDataDeliveryCloudwatchLogs', 'ProjectDataDeliveryS3Destination']
@pulumi.output_type
...
class FeatureVariation(dict):
    def __init__(__self__, *, name: _builtins.str, value: outputs.FeatureVariationValue) -> None:
...
class FeatureVariationValue(dict):
    ...
    def __init__(__self__, *, bool_value: Optional[_builtins.str] = ..., double_value: Optional[_builtins.str] = ..., long_value: Optional[_builtins.str] = ..., string_value: Optional[_builtins.str] = ...) -> None:
...
class LaunchExecution(dict):
    ...
    def __init__(__self__, *, ended_time: Optional[_builtins.str] = ..., started_time: Optional[_builtins.str] = ...) -> None:
...
class LaunchGroup(dict):
    def __init__(__self__, *, feature: _builtins.str, name: _builtins.str, variation: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class LaunchMetricMonitor(dict):
    ...
    def __init__(__self__, *, metric_definition: outputs.LaunchMetricMonitorMetricDefinition) -> None:
...
class LaunchMetricMonitorMetricDefinition(dict):
    ...
    def __init__(__self__, *, entity_id_key: _builtins.str, name: _builtins.str, value_key: _builtins.str, event_pattern: Optional[_builtins.str] = ..., unit_label: Optional[_builtins.str] = ...) -> None:
...
class LaunchScheduledSplitsConfig(dict):
    def __init__(__self__, *, steps: Sequence[outputs.LaunchScheduledSplitsConfigStep]) -> None:
...
class LaunchScheduledSplitsConfigStep(dict):
    ...
    def __init__(__self__, *, group_weights: Mapping[str, _builtins.int], start_time: _builtins.str, segment_overrides: Optional[Sequence[outputs.LaunchScheduledSplitsConfigStepSegmentOverride]] = ...) -> None:
...
class LaunchScheduledSplitsConfigStepSegmentOverride(dict):
    ...
    def __init__(__self__, *, evaluation_order: _builtins.int, segment: _builtins.str, weights: Mapping[str, _builtins.int]) -> None:
...
class ProjectDataDelivery(dict):
    ...
    def __init__(__self__, *, cloudwatch_logs: Optional[outputs.ProjectDataDeliveryCloudwatchLogs] = ..., s3_destination: Optional[outputs.ProjectDataDeliveryS3Destination] = ...) -> None:
...
class ProjectDataDeliveryS3Destination(dict):
    def __init__(__self__, *, bucket: Optional[_builtins.str] = ..., prefix: Optional[_builtins.str] = ...) -> None:
