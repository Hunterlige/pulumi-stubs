...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FeatureEvaluationRuleArgs', 'FeatureEvaluationRuleArgsDict', 'FeatureVariationArgs', 'FeatureVariationArgsDict', 'FeatureVariationValueArgs', 'FeatureVariationValueArgsDict', 'LaunchExecutionArgs', 'LaunchExecutionArgsDict', 'LaunchGroupArgs', 'LaunchGroupArgsDict', 'LaunchMetricMonitorArgs', 'LaunchMetricMonitorArgsDict', 'LaunchMetricMonitorMetricDefinitionArgs', 'LaunchMetricMonitorMetricDefinitionArgsDict', 'LaunchScheduledSplitsConfigArgs', 'LaunchScheduledSplitsConfigArgsDict', 'LaunchScheduledSplitsConfigStepArgs', 'LaunchScheduledSplitsConfigStepArgsDict', 'LaunchScheduledSplitsConfigStepSegmentOverrideArgs', ..., 'ProjectDataDeliveryArgs', 'ProjectDataDeliveryArgsDict', 'ProjectDataDeliveryCloudwatchLogsArgs', 'ProjectDataDeliveryCloudwatchLogsArgsDict', 'ProjectDataDeliveryS3DestinationArgs', 'ProjectDataDeliveryS3DestinationArgsDict']
...
class FeatureVariationArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], value: pulumi.Input[FeatureVariationValueArgs]) -> None:
    ...
    @value.setter
    def value(self, value: pulumi.Input[FeatureVariationValueArgs]): # -> None:
        ...
...
class FeatureVariationValueArgs:
    def __init__(__self__, *, bool_value: Optional[pulumi.Input[_builtins.str]] = ..., double_value: Optional[pulumi.Input[_builtins.str]] = ..., long_value: Optional[pulumi.Input[_builtins.str]] = ..., string_value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @bool_value.setter
    def bool_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @double_value.setter
    def double_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @long_value.setter
    def long_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LaunchExecutionArgs:
    def __init__(__self__, *, ended_time: Optional[pulumi.Input[_builtins.str]] = ..., started_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ended_time.setter
    def ended_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @started_time.setter
    def started_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LaunchGroupArgs:
    def __init__(__self__, *, feature: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], variation: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @variation.setter
    def variation(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class LaunchMetricMonitorArgs:
    def __init__(__self__, *, metric_definition: pulumi.Input[LaunchMetricMonitorMetricDefinitionArgs]) -> None:
    ...
    def metric_definition(self, value: pulumi.Input[LaunchMetricMonitorMetricDefinitionArgs]): # -> None:
        ...
...
class LaunchMetricMonitorMetricDefinitionArgs:
    def __init__(__self__, *, entity_id_key: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], value_key: pulumi.Input[_builtins.str], event_pattern: Optional[pulumi.Input[_builtins.str]] = ..., unit_label: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def entity_id_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @value_key.setter
    def value_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @unit_label.setter
    def unit_label(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LaunchScheduledSplitsConfigArgs:
    def __init__(__self__, *, steps: pulumi.Input[Sequence[pulumi.Input[LaunchScheduledSplitsConfigStepArgs]]]) -> None:
    ...
    @steps.setter
    def steps(self, value: pulumi.Input[Sequence[pulumi.Input[LaunchScheduledSplitsConfigStepArgs]]]): # -> None:
        ...
...
class LaunchScheduledSplitsConfigStepArgs:
    def __init__(__self__, *, group_weights: pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]], start_time: pulumi.Input[_builtins.str], segment_overrides: Optional[pulumi.Input[Sequence[pulumi.Input[LaunchScheduledSplitsConfigStepSegmentOverrideArgs]]]] = ...) -> None:
    ...
    def group_weights(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]]): # -> None:
        ...
    ...
    def segment_overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[LaunchScheduledSplitsConfigStepSegmentOverrideArgs]]]]): # -> None:
        ...
...
class LaunchScheduledSplitsConfigStepSegmentOverrideArgs:
    def __init__(__self__, *, evaluation_order: pulumi.Input[_builtins.int], segment: pulumi.Input[_builtins.str], weights: pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]]) -> None:
    ...
    def evaluation_order(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @segment.setter
    def segment(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @weights.setter
    def weights(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]]): # -> None:
        ...
...
class ProjectDataDeliveryArgs:
    def __init__(__self__, *, cloudwatch_logs: Optional[pulumi.Input[ProjectDataDeliveryCloudwatchLogsArgs]] = ..., s3_destination: Optional[pulumi.Input[ProjectDataDeliveryS3DestinationArgs]] = ...) -> None:
    ...
    def cloudwatch_logs(self, value: Optional[pulumi.Input[ProjectDataDeliveryCloudwatchLogsArgs]]): # -> None:
        ...
    ...
    def s3_destination(self, value: Optional[pulumi.Input[ProjectDataDeliveryS3DestinationArgs]]): # -> None:
        ...
...
class ProjectDataDeliveryCloudwatchLogsArgs:
    def __init__(__self__, *, log_group: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ProjectDataDeliveryS3DestinationArgs:
    def __init__(__self__, *, bucket: Optional[pulumi.Input[_builtins.str]] = ..., prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
