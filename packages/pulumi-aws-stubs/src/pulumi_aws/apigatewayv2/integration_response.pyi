...
class IntegrationResponseArgs:
    def __init__(__self__, *, api_id: pulumi.Input[_builtins.str], integration_id: pulumi.Input[_builtins.str], integration_response_key: pulumi.Input[_builtins.str], content_handling_strategy: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., response_templates: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., template_selection_expression: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def integration_response_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class _IntegrationResponseState:
    def __init__(__self__, *, api_id: Optional[pulumi.Input[_builtins.str]] = ..., content_handling_strategy: Optional[pulumi.Input[_builtins.str]] = ..., integration_id: Optional[pulumi.Input[_builtins.str]] = ..., integration_response_key: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., response_templates: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., template_selection_expression: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @integration_id.setter
    def integration_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @integration_response_key.setter
    def integration_response_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IntegrationResponse(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., api_id: Optional[pulumi.Input[_builtins.str]] = ..., content_handling_strategy: Optional[pulumi.Input[_builtins.str]] = ..., integration_id: Optional[pulumi.Input[_builtins.str]] = ..., integration_response_key: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., response_templates: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., template_selection_expression: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., api_id: Optional[pulumi.Input[_builtins.str]] = ..., content_handling_strategy: Optional[pulumi.Input[_builtins.str]] = ..., integration_id: Optional[pulumi.Input[_builtins.str]] = ..., integration_response_key: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., response_templates: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., template_selection_expression: Optional[pulumi.Input[_builtins.str]] = ...) -> IntegrationResponse:
