...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetOntapFileSystemResult', 'AwaitableGetOntapFileSystemResult', 'get_ontap_file_system', 'get_ontap_file_system_output']
@pulumi.output_type
class GetOntapFileSystemResult:
    
    def __init__(__self__, arn=..., automatic_backup_retention_days=..., daily_automatic_backup_start_time=..., deployment_type=..., disk_iops_configurations=..., dns_name=..., endpoint_ip_address_range=..., endpoints=..., ha_pairs=..., id=..., kms_key_id=..., network_interface_ids=..., owner_id=..., preferred_subnet_id=..., region=..., route_table_ids=..., storage_capacity=..., storage_type=..., subnet_ids=..., tags=..., throughput_capacity=..., throughput_capacity_per_ha_pair=..., vpc_id=..., weekly_maintenance_start_time=...) -> None:
        ...
...
class AwaitableGetOntapFileSystemResult(GetOntapFileSystemResult):
    def __await__(self): # -> Generator[Never, Any, GetOntapFileSystemResult]:
        ...
    


def get_ontap_file_system(id: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetOntapFileSystemResult:
    
    ...

def get_ontap_file_system_output(id: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetOntapFileSystemResult]:
