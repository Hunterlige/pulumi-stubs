...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DataRepositoryAssociationS3', 'DataRepositoryAssociationS3AutoExportPolicy', 'DataRepositoryAssociationS3AutoImportPolicy', 'FileCacheDataRepositoryAssociation', 'FileCacheDataRepositoryAssociationNf', 'FileCacheLustreConfiguration', 'FileCacheLustreConfigurationLogConfiguration', 'FileCacheLustreConfigurationMetadataConfiguration', 'LustreFileSystemDataReadCacheConfiguration', 'LustreFileSystemLogConfiguration', 'LustreFileSystemMetadataConfiguration', 'LustreFileSystemRootSquashConfiguration', 'OntapFileSystemDiskIopsConfiguration', 'OntapFileSystemEndpoint', 'OntapFileSystemEndpointIntercluster', 'OntapFileSystemEndpointManagement', ..., ..., 'OntapStorageVirtualMachineEndpoint', 'OntapStorageVirtualMachineEndpointIscsi', 'OntapStorageVirtualMachineEndpointManagement', 'OntapStorageVirtualMachineEndpointNf', 'OntapStorageVirtualMachineEndpointSmb', 'OntapVolumeAggregateConfiguration', 'OntapVolumeSnaplockConfiguration', 'OntapVolumeSnaplockConfigurationAutocommitPeriod', 'OntapVolumeSnaplockConfigurationRetentionPeriod', ..., ..., ..., 'OntapVolumeTieringPolicy', 'OpenZfsFileSystemDiskIopsConfiguration', 'OpenZfsFileSystemReadCacheConfiguration', 'OpenZfsFileSystemRootVolumeConfiguration', 'OpenZfsFileSystemRootVolumeConfigurationNfsExports', ..., ..., 'OpenZfsVolumeNfsExports', 'OpenZfsVolumeNfsExportsClientConfiguration', 'OpenZfsVolumeOriginSnapshot', 'OpenZfsVolumeUserAndGroupQuota', 'S3AccessPointAttachmentOpenzfsConfiguration', ..., ..., 'S3AccessPointAttachmentS3AccessPoint', ..., 'S3AccessPointAttachmentTimeouts', 'WindowsFileSystemAuditLogConfiguration', 'WindowsFileSystemDiskIopsConfiguration', 'WindowsFileSystemSelfManagedActiveDirectory', 'GetOntapFileSystemDiskIopsConfigurationResult', 'GetOntapFileSystemEndpointResult', 'GetOntapFileSystemEndpointInterclusterResult', 'GetOntapFileSystemEndpointManagementResult', ..., ..., 'GetOntapStorageVirtualMachineEndpointResult', 'GetOntapStorageVirtualMachineEndpointIscsiResult', ..., 'GetOntapStorageVirtualMachineEndpointNfResult', 'GetOntapStorageVirtualMachineEndpointSmbResult', 'GetOntapStorageVirtualMachineFilterResult', ..., 'GetOntapStorageVirtualMachinesFilterResult', 'GetOpenZfsSnapshotFilterResult', 'GetWindowsFileSystemAuditLogConfigurationResult', 'GetWindowsFileSystemDiskIopsConfigurationResult']
@pulumi.output_type
class DataRepositoryAssociationS3(dict):
    ...
    def __init__(__self__, *, auto_export_policy: Optional[outputs.DataRepositoryAssociationS3AutoExportPolicy] = ..., auto_import_policy: Optional[outputs.DataRepositoryAssociationS3AutoImportPolicy] = ...) -> None:
...
class DataRepositoryAssociationS3AutoExportPolicy(dict):
    def __init__(__self__, *, events: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FileCacheDataRepositoryAssociation(dict):
    ...
    def __init__(__self__, *, data_repository_path: _builtins.str, file_cache_path: _builtins.str, association_id: Optional[_builtins.str] = ..., data_repository_subdirectories: Optional[Sequence[_builtins.str]] = ..., file_cache_id: Optional[_builtins.str] = ..., file_system_id: Optional[_builtins.str] = ..., file_system_path: Optional[_builtins.str] = ..., imported_file_chunk_size: Optional[_builtins.int] = ..., nfs: Optional[Sequence[outputs.FileCacheDataRepositoryAssociationNf]] = ..., resource_arn: Optional[_builtins.str] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class FileCacheDataRepositoryAssociationNf(dict):
    ...
    def __init__(__self__, *, version: _builtins.str, dns_ips: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FileCacheLustreConfiguration(dict):
    ...
    def __init__(__self__, *, deployment_type: _builtins.str, metadata_configurations: Sequence[outputs.FileCacheLustreConfigurationMetadataConfiguration], per_unit_storage_throughput: _builtins.int, log_configurations: Optional[Sequence[outputs.FileCacheLustreConfigurationLogConfiguration]] = ..., mount_name: Optional[_builtins.str] = ..., weekly_maintenance_start_time: Optional[_builtins.str] = ...) -> None:
...
class FileCacheLustreConfigurationLogConfiguration(dict):
    def __init__(__self__, *, destination: Optional[_builtins.str] = ..., level: Optional[_builtins.str] = ...) -> None:
        ...
...
class LustreFileSystemDataReadCacheConfiguration(dict):
    ...
    def __init__(__self__, *, sizing_mode: _builtins.str, size: Optional[_builtins.int] = ...) -> None:
...
class LustreFileSystemMetadataConfiguration(dict):
    def __init__(__self__, *, iops: Optional[_builtins.int] = ..., mode: Optional[_builtins.str] = ...) -> None:
...
class LustreFileSystemRootSquashConfiguration(dict):
    ...
    def __init__(__self__, *, no_squash_nids: Optional[Sequence[_builtins.str]] = ..., root_squash: Optional[_builtins.str] = ...) -> None:
...
class OntapFileSystemEndpoint(dict):
    def __init__(__self__, *, interclusters: Optional[Sequence[outputs.OntapFileSystemEndpointIntercluster]] = ..., managements: Optional[Sequence[outputs.OntapFileSystemEndpointManagement]] = ...) -> None:
...
class OntapFileSystemEndpointIntercluster(dict):
    ...
    def __init__(__self__, *, dns_name: Optional[_builtins.str] = ..., ip_addresses: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class OntapStorageVirtualMachineActiveDirectoryConfiguration(dict):
    ...
    def __init__(__self__, *, netbios_name: Optional[_builtins.str] = ..., self_managed_active_directory_configuration: Optional[outputs.OntapStorageVirtualMachineActiveDirectoryConfigurationSelfManagedActiveDirectoryConfiguration] = ...) -> None:
...
class OntapStorageVirtualMachineActiveDirectoryConfigurationSelfManagedActiveDirectoryConfiguration(dict):
    ...
    def __init__(__self__, *, dns_ips: Sequence[_builtins.str], domain_name: _builtins.str, password: _builtins.str, username: _builtins.str, file_system_administrators_group: Optional[_builtins.str] = ..., organizational_unit_distinguished_name: Optional[_builtins.str] = ...) -> None:
...
class OntapVolumeAggregateConfiguration(dict):
    ...
    def __init__(__self__, *, aggregates: Optional[Sequence[_builtins.str]] = ..., constituents_per_aggregate: Optional[_builtins.int] = ..., total_constituents: Optional[_builtins.int] = ...) -> None:
...
class OntapVolumeSnaplockConfiguration(dict):
    ...
    def __init__(__self__, *, snaplock_type: _builtins.str, audit_log_volume: Optional[_builtins.bool] = ..., autocommit_period: Optional[outputs.OntapVolumeSnaplockConfigurationAutocommitPeriod] = ..., privileged_delete: Optional[_builtins.str] = ..., retention_period: Optional[outputs.OntapVolumeSnaplockConfigurationRetentionPeriod] = ..., volume_append_mode_enabled: Optional[_builtins.bool] = ...) -> None:
...
class OntapVolumeSnaplockConfigurationRetentionPeriod(dict):
    ...
    def __init__(__self__, *, default_retention: Optional[outputs.OntapVolumeSnaplockConfigurationRetentionPeriodDefaultRetention] = ..., maximum_retention: Optional[outputs.OntapVolumeSnaplockConfigurationRetentionPeriodMaximumRetention] = ..., minimum_retention: Optional[outputs.OntapVolumeSnaplockConfigurationRetentionPeriodMinimumRetention] = ...) -> None:
...
class OntapVolumeTieringPolicy(dict):
    ...
    def __init__(__self__, *, cooling_period: Optional[_builtins.int] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class OpenZfsFileSystemReadCacheConfiguration(dict):
    ...
    def __init__(__self__, *, size: Optional[_builtins.int] = ..., sizing_mode: Optional[_builtins.str] = ...) -> None:
...
class OpenZfsFileSystemRootVolumeConfiguration(dict):
    ...
    def __init__(__self__, *, copy_tags_to_snapshots: Optional[_builtins.bool] = ..., data_compression_type: Optional[_builtins.str] = ..., nfs_exports: Optional[outputs.OpenZfsFileSystemRootVolumeConfigurationNfsExports] = ..., read_only: Optional[_builtins.bool] = ..., record_size_kib: Optional[_builtins.int] = ..., user_and_group_quotas: Optional[Sequence[outputs.OpenZfsFileSystemRootVolumeConfigurationUserAndGroupQuota]] = ...) -> None:
...
class OpenZfsFileSystemRootVolumeConfigurationNfsExports(dict):
    ...
    def __init__(__self__, *, client_configurations: Sequence[outputs.OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfiguration]) -> None:
...
class OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfiguration(dict):
    def __init__(__self__, *, clients: _builtins.str, options: Sequence[_builtins.str]) -> None:
...
class OpenZfsFileSystemRootVolumeConfigurationUserAndGroupQuota(dict):
    ...
    def __init__(__self__, *, id: _builtins.int, storage_capacity_quota_gib: _builtins.int, type: _builtins.str) -> None:
...
class OpenZfsVolumeNfsExports(dict):
    ...
    def __init__(__self__, *, client_configurations: Sequence[outputs.OpenZfsVolumeNfsExportsClientConfiguration]) -> None:
...
class OpenZfsVolumeOriginSnapshot(dict):
    ...
    def __init__(__self__, *, copy_strategy: _builtins.str, snapshot_arn: _builtins.str) -> None:
...
class S3AccessPointAttachmentOpenzfsConfiguration(dict):
    ...
    def __init__(__self__, *, file_system_identity: outputs.S3AccessPointAttachmentOpenzfsConfigurationFileSystemIdentity, volume_id: _builtins.str) -> None:
...
class S3AccessPointAttachmentOpenzfsConfigurationFileSystemIdentity(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, posix_user: Optional[outputs.S3AccessPointAttachmentOpenzfsConfigurationFileSystemIdentityPosixUser] = ...) -> None:
...
class S3AccessPointAttachmentS3AccessPoint(dict):
    ...
    def __init__(__self__, *, policy: Optional[_builtins.str] = ..., vpc_configuration: Optional[outputs.S3AccessPointAttachmentS3AccessPointVpcConfiguration] = ...) -> None:
...
class WindowsFileSystemAuditLogConfiguration(dict):
    ...
    def __init__(__self__, *, audit_log_destination: Optional[_builtins.str] = ..., file_access_audit_log_level: Optional[_builtins.str] = ..., file_share_access_audit_log_level: Optional[_builtins.str] = ...) -> None:
...
class WindowsFileSystemSelfManagedActiveDirectory(dict):
    ...
    def __init__(__self__, *, dns_ips: Sequence[_builtins.str], domain_name: _builtins.str, domain_join_service_account_secret: Optional[_builtins.str] = ..., file_system_administrators_group: Optional[_builtins.str] = ..., organizational_unit_distinguished_name: Optional[_builtins.str] = ..., password: Optional[_builtins.str] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class GetOntapFileSystemEndpointResult(dict):
    def __init__(__self__, *, interclusters: Sequence[outputs.GetOntapFileSystemEndpointInterclusterResult], managements: Sequence[outputs.GetOntapFileSystemEndpointManagementResult]) -> None:
...
class GetOntapFileSystemEndpointInterclusterResult(dict):
    def __init__(__self__, *, dns_name: _builtins.str, ip_addresses: Sequence[_builtins.str]) -> None:
...
class GetOntapStorageVirtualMachineActiveDirectoryConfigurationResult(dict):
    def __init__(__self__, *, netbios_name: _builtins.str, self_managed_active_directory_configurations: Sequence[outputs.GetOntapStorageVirtualMachineActiveDirectoryConfigurationSelfManagedActiveDirectoryConfigurationResult]) -> None:
...
class GetOntapStorageVirtualMachineActiveDirectoryConfigurationSelfManagedActiveDirectoryConfigurationResult(dict):
    def __init__(__self__, *, dns_ips: Sequence[_builtins.str], domain_name: _builtins.str, file_system_administrators_group: _builtins.str, organizational_unit_distinguished_name: _builtins.str, username: _builtins.str) -> None:
...
class GetOntapStorageVirtualMachineEndpointResult(dict):
    def __init__(__self__, *, iscsis: Sequence[outputs.GetOntapStorageVirtualMachineEndpointIscsiResult], managements: Sequence[outputs.GetOntapStorageVirtualMachineEndpointManagementResult], nfs: Sequence[outputs.GetOntapStorageVirtualMachineEndpointNfResult], smbs: Sequence[outputs.GetOntapStorageVirtualMachineEndpointSmbResult]) -> None:
...
class GetWindowsFileSystemAuditLogConfigurationResult(dict):
    def __init__(__self__, *, audit_log_destination: _builtins.str, file_access_audit_log_level: _builtins.str, file_share_access_audit_log_level: _builtins.str) -> None:
        ...
