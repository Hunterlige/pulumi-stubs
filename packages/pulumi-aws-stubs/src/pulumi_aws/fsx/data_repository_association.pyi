...
class DataRepositoryAssociationArgs:
    def __init__(__self__, *, data_repository_path: pulumi.Input[_builtins.str], file_system_id: pulumi.Input[_builtins.str], file_system_path: pulumi.Input[_builtins.str], batch_import_meta_data_on_create: Optional[pulumi.Input[_builtins.bool]] = ..., delete_data_in_filesystem: Optional[pulumi.Input[_builtins.bool]] = ..., imported_file_chunk_size: Optional[pulumi.Input[_builtins.int]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., s3: Optional[pulumi.Input[DataRepositoryAssociationS3Args]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def batch_import_meta_data_on_create(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def delete_data_in_filesystem(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @s3.setter
    def s3(self, value: Optional[pulumi.Input[DataRepositoryAssociationS3Args]]): # -> None:
        ...
...
class _DataRepositoryAssociationState:
    def __init__(__self__, *, arn: Optional[pulumi.Input[_builtins.str]] = ..., association_id: Optional[pulumi.Input[_builtins.str]] = ..., batch_import_meta_data_on_create: Optional[pulumi.Input[_builtins.bool]] = ..., data_repository_path: Optional[pulumi.Input[_builtins.str]] = ..., delete_data_in_filesystem: Optional[pulumi.Input[_builtins.bool]] = ..., file_system_id: Optional[pulumi.Input[_builtins.str]] = ..., file_system_path: Optional[pulumi.Input[_builtins.str]] = ..., imported_file_chunk_size: Optional[pulumi.Input[_builtins.int]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., s3: Optional[pulumi.Input[DataRepositoryAssociationS3Args]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @data_repository_path.setter
    def data_repository_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataRepositoryAssociation(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., batch_import_meta_data_on_create: Optional[pulumi.Input[_builtins.bool]] = ..., data_repository_path: Optional[pulumi.Input[_builtins.str]] = ..., delete_data_in_filesystem: Optional[pulumi.Input[_builtins.bool]] = ..., file_system_id: Optional[pulumi.Input[_builtins.str]] = ..., file_system_path: Optional[pulumi.Input[_builtins.str]] = ..., imported_file_chunk_size: Optional[pulumi.Input[_builtins.int]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., s3: Optional[pulumi.Input[Union[DataRepositoryAssociationS3Args, DataRepositoryAssociationS3ArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: DataRepositoryAssociationArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., arn: Optional[pulumi.Input[_builtins.str]] = ..., association_id: Optional[pulumi.Input[_builtins.str]] = ..., batch_import_meta_data_on_create: Optional[pulumi.Input[_builtins.bool]] = ..., data_repository_path: Optional[pulumi.Input[_builtins.str]] = ..., delete_data_in_filesystem: Optional[pulumi.Input[_builtins.bool]] = ..., file_system_id: Optional[pulumi.Input[_builtins.str]] = ..., file_system_path: Optional[pulumi.Input[_builtins.str]] = ..., imported_file_chunk_size: Optional[pulumi.Input[_builtins.int]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., s3: Optional[pulumi.Input[Union[DataRepositoryAssociationS3Args, DataRepositoryAssociationS3ArgsDict]]] = ..., tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> DataRepositoryAssociation:
