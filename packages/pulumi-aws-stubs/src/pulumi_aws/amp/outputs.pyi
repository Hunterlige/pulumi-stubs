...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['QueryLoggingConfigurationDestination', 'QueryLoggingConfigurationDestinationCloudwatchLogs', 'QueryLoggingConfigurationDestinationFilters', 'QueryLoggingConfigurationTimeouts', 'ResourcePolicyTimeouts', 'ScraperDestination', 'ScraperDestinationAmp', 'ScraperRoleConfiguration', 'ScraperSource', 'ScraperSourceEks', 'ScraperTimeouts', 'WorkspaceConfigurationLimitsPerLabelSet', 'WorkspaceConfigurationLimitsPerLabelSetLimits', 'WorkspaceConfigurationTimeouts', 'WorkspaceLoggingConfiguration']
@pulumi.output_type
class QueryLoggingConfigurationDestination(dict):
    ...
    def __init__(__self__, *, cloudwatch_logs: outputs.QueryLoggingConfigurationDestinationCloudwatchLogs, filters: outputs.QueryLoggingConfigurationDestinationFilters) -> None:
...
class ScraperDestination(dict):
    def __init__(__self__, *, amp: Optional[outputs.ScraperDestinationAmp] = ...) -> None:
...
class ScraperRoleConfiguration(dict):
    ...
    def __init__(__self__, *, source_role_arn: Optional[_builtins.str] = ..., target_role_arn: Optional[_builtins.str] = ...) -> None:
...
class ScraperSourceEks(dict):
    ...
    def __init__(__self__, *, cluster_arn: _builtins.str, subnet_ids: Sequence[_builtins.str], security_group_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class WorkspaceConfigurationLimitsPerLabelSet(dict):
    ...
    def __init__(__self__, *, label_set: Mapping[str, _builtins.str], limits: outputs.WorkspaceConfigurationLimitsPerLabelSetLimits) -> None:
