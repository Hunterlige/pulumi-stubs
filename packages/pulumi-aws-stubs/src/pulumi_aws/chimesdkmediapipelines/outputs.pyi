...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['MediaInsightsPipelineConfigurationElement', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ...]
@pulumi.output_type
class MediaInsightsPipelineConfigurationElement(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, amazon_transcribe_call_analytics_processor_configuration: Optional[outputs.MediaInsightsPipelineConfigurationElementAmazonTranscribeCallAnalyticsProcessorConfiguration] = ..., amazon_transcribe_processor_configuration: Optional[outputs.MediaInsightsPipelineConfigurationElementAmazonTranscribeProcessorConfiguration] = ..., kinesis_data_stream_sink_configuration: Optional[outputs.MediaInsightsPipelineConfigurationElementKinesisDataStreamSinkConfiguration] = ..., lambda_function_sink_configuration: Optional[outputs.MediaInsightsPipelineConfigurationElementLambdaFunctionSinkConfiguration] = ..., s3_recording_sink_configuration: Optional[outputs.MediaInsightsPipelineConfigurationElementS3RecordingSinkConfiguration] = ..., sns_topic_sink_configuration: Optional[outputs.MediaInsightsPipelineConfigurationElementSnsTopicSinkConfiguration] = ..., sqs_queue_sink_configuration: Optional[outputs.MediaInsightsPipelineConfigurationElementSqsQueueSinkConfiguration] = ..., voice_analytics_processor_configuration: Optional[outputs.MediaInsightsPipelineConfigurationElementVoiceAnalyticsProcessorConfiguration] = ...) -> None:
...
class MediaInsightsPipelineConfigurationElementAmazonTranscribeCallAnalyticsProcessorConfiguration(dict):
    ...
    def __init__(__self__, *, language_code: _builtins.str, call_analytics_stream_categories: Optional[Sequence[_builtins.str]] = ..., content_identification_type: Optional[_builtins.str] = ..., content_redaction_type: Optional[_builtins.str] = ..., enable_partial_results_stabilization: Optional[_builtins.bool] = ..., filter_partial_results: Optional[_builtins.bool] = ..., language_model_name: Optional[_builtins.str] = ..., partial_results_stability: Optional[_builtins.str] = ..., pii_entity_types: Optional[_builtins.str] = ..., post_call_analytics_settings: Optional[outputs.MediaInsightsPipelineConfigurationElementAmazonTranscribeCallAnalyticsProcessorConfigurationPostCallAnalyticsSettings] = ..., vocabulary_filter_method: Optional[_builtins.str] = ..., vocabulary_filter_name: Optional[_builtins.str] = ..., vocabulary_name: Optional[_builtins.str] = ...) -> None:
...
class MediaInsightsPipelineConfigurationElementAmazonTranscribeCallAnalyticsProcessorConfigurationPostCallAnalyticsSettings(dict):
    ...
    def __init__(__self__, *, data_access_role_arn: _builtins.str, output_location: _builtins.str, content_redaction_output: Optional[_builtins.str] = ..., output_encryption_kms_key_id: Optional[_builtins.str] = ...) -> None:
...
class MediaInsightsPipelineConfigurationElementAmazonTranscribeProcessorConfiguration(dict):
    ...
    def __init__(__self__, *, language_code: _builtins.str, content_identification_type: Optional[_builtins.str] = ..., content_redaction_type: Optional[_builtins.str] = ..., enable_partial_results_stabilization: Optional[_builtins.bool] = ..., filter_partial_results: Optional[_builtins.bool] = ..., language_model_name: Optional[_builtins.str] = ..., partial_results_stability: Optional[_builtins.str] = ..., pii_entity_types: Optional[_builtins.str] = ..., show_speaker_label: Optional[_builtins.bool] = ..., vocabulary_filter_method: Optional[_builtins.str] = ..., vocabulary_filter_name: Optional[_builtins.str] = ..., vocabulary_name: Optional[_builtins.str] = ...) -> None:
...
class MediaInsightsPipelineConfigurationElementVoiceAnalyticsProcessorConfiguration(dict):
    ...
    def __init__(__self__, *, speaker_search_status: _builtins.str, voice_tone_analysis_status: _builtins.str) -> None:
...
class MediaInsightsPipelineConfigurationRealTimeAlertConfiguration(dict):
    def __init__(__self__, *, rules: Sequence[outputs.MediaInsightsPipelineConfigurationRealTimeAlertConfigurationRule], disabled: Optional[_builtins.bool] = ...) -> None:
...
class MediaInsightsPipelineConfigurationRealTimeAlertConfigurationRule(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, issue_detection_configuration: Optional[outputs.MediaInsightsPipelineConfigurationRealTimeAlertConfigurationRuleIssueDetectionConfiguration] = ..., keyword_match_configuration: Optional[outputs.MediaInsightsPipelineConfigurationRealTimeAlertConfigurationRuleKeywordMatchConfiguration] = ..., sentiment_configuration: Optional[outputs.MediaInsightsPipelineConfigurationRealTimeAlertConfigurationRuleSentimentConfiguration] = ...) -> None:
...
class MediaInsightsPipelineConfigurationRealTimeAlertConfigurationRuleKeywordMatchConfiguration(dict):
    ...
    def __init__(__self__, *, keywords: Sequence[_builtins.str], rule_name: _builtins.str, negate: Optional[_builtins.bool] = ...) -> None:
...
class MediaInsightsPipelineConfigurationRealTimeAlertConfigurationRuleSentimentConfiguration(dict):
    ...
    def __init__(__self__, *, rule_name: _builtins.str, sentiment_type: _builtins.str, time_period: _builtins.int) -> None:
