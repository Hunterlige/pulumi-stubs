...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['WorkloadComplianceStatusArgs', 'WorkloadComplianceStatusArgsDict', 'WorkloadEkmProvisioningResponseArgs', 'WorkloadEkmProvisioningResponseArgsDict', 'WorkloadKmsSettingsArgs', 'WorkloadKmsSettingsArgsDict', 'WorkloadPartnerPermissionsArgs', 'WorkloadPartnerPermissionsArgsDict', 'WorkloadResourceArgs', 'WorkloadResourceArgsDict', 'WorkloadResourceSettingArgs', 'WorkloadResourceSettingArgsDict', 'WorkloadSaaEnrollmentResponseArgs', 'WorkloadSaaEnrollmentResponseArgsDict', 'WorkloadWorkloadOptionsArgs', 'WorkloadWorkloadOptionsArgsDict']
...
class WorkloadComplianceStatusArgs:
    def __init__(__self__, *, acknowledged_violation_counts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ..., active_violation_counts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ...) -> None:
    ...
    def acknowledged_violation_counts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]): # -> None:
        ...
    ...
    def active_violation_counts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]): # -> None:
        ...
...
class WorkloadEkmProvisioningResponseArgs:
    def __init__(__self__, *, ekm_provisioning_error_domain: Optional[pulumi.Input[_builtins.str]] = ..., ekm_provisioning_error_mapping: Optional[pulumi.Input[_builtins.str]] = ..., ekm_provisioning_state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ekm_provisioning_error_domain(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ekm_provisioning_error_mapping(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ekm_provisioning_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkloadKmsSettingsArgs:
    def __init__(__self__, *, next_rotation_time: pulumi.Input[_builtins.str], rotation_period: pulumi.Input[_builtins.str]) -> None:
    ...
    def next_rotation_time(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def rotation_period(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class WorkloadPartnerPermissionsArgs:
    def __init__(__self__, *, assured_workloads_monitoring: Optional[pulumi.Input[_builtins.bool]] = ..., data_logs_viewer: Optional[pulumi.Input[_builtins.bool]] = ..., service_access_approver: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def assured_workloads_monitoring(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def data_logs_viewer(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def service_access_approver(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class WorkloadResourceArgs:
    def __init__(__self__, *, resource_id: Optional[pulumi.Input[_builtins.int]] = ..., resource_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @resource_id.setter
    def resource_id(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class WorkloadResourceSettingArgs:
    def __init__(__self__, *, display_name: Optional[pulumi.Input[_builtins.str]] = ..., resource_id: Optional[pulumi.Input[_builtins.str]] = ..., resource_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkloadSaaEnrollmentResponseArgs:
    def __init__(__self__, *, setup_errors: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., setup_status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @setup_errors.setter
    def setup_errors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @setup_status.setter
    def setup_status(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkloadWorkloadOptionsArgs:
    def __init__(__self__, *, kaj_enrollment_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def kaj_enrollment_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
