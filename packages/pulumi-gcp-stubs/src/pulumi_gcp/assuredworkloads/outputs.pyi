...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['WorkloadComplianceStatus', 'WorkloadEkmProvisioningResponse', 'WorkloadKmsSettings', 'WorkloadPartnerPermissions', 'WorkloadResource', 'WorkloadResourceSetting', 'WorkloadSaaEnrollmentResponse', 'WorkloadWorkloadOptions']
@pulumi.output_type
class WorkloadComplianceStatus(dict):
    ...
    def __init__(__self__, *, acknowledged_violation_counts: Optional[Sequence[_builtins.int]] = ..., active_violation_counts: Optional[Sequence[_builtins.int]] = ...) -> None:
...
class WorkloadEkmProvisioningResponse(dict):
    ...
    def __init__(__self__, *, ekm_provisioning_error_domain: Optional[_builtins.str] = ..., ekm_provisioning_error_mapping: Optional[_builtins.str] = ..., ekm_provisioning_state: Optional[_builtins.str] = ...) -> None:
...
class WorkloadPartnerPermissions(dict):
    ...
    def __init__(__self__, *, assured_workloads_monitoring: Optional[_builtins.bool] = ..., data_logs_viewer: Optional[_builtins.bool] = ..., service_access_approver: Optional[_builtins.bool] = ...) -> None:
...
class WorkloadResource(dict):
    ...
    def __init__(__self__, *, resource_id: Optional[_builtins.int] = ..., resource_type: Optional[_builtins.str] = ...) -> None:
...
class WorkloadResourceSetting(dict):
    ...
    def __init__(__self__, *, display_name: Optional[_builtins.str] = ..., resource_id: Optional[_builtins.str] = ..., resource_type: Optional[_builtins.str] = ...) -> None:
...
class WorkloadSaaEnrollmentResponse(dict):
    ...
    def __init__(__self__, *, setup_errors: Optional[Sequence[_builtins.str]] = ..., setup_status: Optional[_builtins.str] = ...) -> None:
...
class WorkloadWorkloadOptions(dict):
    ...
    def __init__(__self__, *, kaj_enrollment_type: Optional[_builtins.str] = ...) -> None:
