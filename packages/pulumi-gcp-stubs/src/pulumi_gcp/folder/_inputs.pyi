...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessApprovalSettingsEnrolledServiceArgs', 'AccessApprovalSettingsEnrolledServiceArgsDict', 'IAMBindingConditionArgs', 'IAMBindingConditionArgsDict', 'IAMMemberConditionArgs', 'IAMMemberConditionArgsDict', 'IamAuditConfigAuditLogConfigArgs', 'IamAuditConfigAuditLogConfigArgsDict', 'OrganizationPolicyBooleanPolicyArgs', 'OrganizationPolicyBooleanPolicyArgsDict', 'OrganizationPolicyListPolicyArgs', 'OrganizationPolicyListPolicyArgsDict', 'OrganizationPolicyListPolicyAllowArgs', 'OrganizationPolicyListPolicyAllowArgsDict', 'OrganizationPolicyListPolicyDenyArgs', 'OrganizationPolicyListPolicyDenyArgsDict', 'OrganizationPolicyRestorePolicyArgs', 'OrganizationPolicyRestorePolicyArgsDict']
