...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GoogleApiSourceLoggingConfigArgs', 'GoogleApiSourceLoggingConfigArgsDict', 'MessageBusLoggingConfigArgs', 'MessageBusLoggingConfigArgsDict', 'PipelineDestinationArgs', 'PipelineDestinationArgsDict', 'PipelineDestinationAuthenticationConfigArgs', 'PipelineDestinationAuthenticationConfigArgsDict', ..., ..., ..., ..., 'PipelineDestinationHttpEndpointArgs', 'PipelineDestinationHttpEndpointArgsDict', 'PipelineDestinationNetworkConfigArgs', 'PipelineDestinationNetworkConfigArgsDict', 'PipelineDestinationOutputPayloadFormatArgs', 'PipelineDestinationOutputPayloadFormatArgsDict', 'PipelineDestinationOutputPayloadFormatAvroArgs', 'PipelineDestinationOutputPayloadFormatAvroArgsDict', 'PipelineDestinationOutputPayloadFormatJsonArgs', 'PipelineDestinationOutputPayloadFormatJsonArgsDict', 'PipelineDestinationOutputPayloadFormatProtobufArgs', ..., 'PipelineInputPayloadFormatArgs', 'PipelineInputPayloadFormatArgsDict', 'PipelineInputPayloadFormatAvroArgs', 'PipelineInputPayloadFormatAvroArgsDict', 'PipelineInputPayloadFormatJsonArgs', 'PipelineInputPayloadFormatJsonArgsDict', 'PipelineInputPayloadFormatProtobufArgs', 'PipelineInputPayloadFormatProtobufArgsDict', 'PipelineLoggingConfigArgs', 'PipelineLoggingConfigArgsDict', 'PipelineMediationArgs', 'PipelineMediationArgsDict', 'PipelineMediationTransformationArgs', 'PipelineMediationTransformationArgsDict', 'PipelineRetryPolicyArgs', 'PipelineRetryPolicyArgsDict', 'TriggerDestinationArgs', 'TriggerDestinationArgsDict', 'TriggerDestinationCloudRunServiceArgs', 'TriggerDestinationCloudRunServiceArgsDict', 'TriggerDestinationGkeArgs', 'TriggerDestinationGkeArgsDict', 'TriggerDestinationHttpEndpointArgs', 'TriggerDestinationHttpEndpointArgsDict', 'TriggerDestinationNetworkConfigArgs', 'TriggerDestinationNetworkConfigArgsDict', 'TriggerMatchingCriteriaArgs', 'TriggerMatchingCriteriaArgsDict', 'TriggerRetryPolicyArgs', 'TriggerRetryPolicyArgsDict', 'TriggerTransportArgs', 'TriggerTransportArgsDict', 'TriggerTransportPubsubArgs', 'TriggerTransportPubsubArgsDict']
...
class GoogleApiSourceLoggingConfigArgs:
    def __init__(__self__, *, log_severity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @log_severity.setter
    def log_severity(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipelineDestinationArgs:
    def __init__(__self__, *, authentication_config: Optional[pulumi.Input[PipelineDestinationAuthenticationConfigArgs]] = ..., http_endpoint: Optional[pulumi.Input[PipelineDestinationHttpEndpointArgs]] = ..., message_bus: Optional[pulumi.Input[_builtins.str]] = ..., network_config: Optional[pulumi.Input[PipelineDestinationNetworkConfigArgs]] = ..., output_payload_format: Optional[pulumi.Input[PipelineDestinationOutputPayloadFormatArgs]] = ..., topic: Optional[pulumi.Input[_builtins.str]] = ..., workflow: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authentication_config(self, value: Optional[pulumi.Input[PipelineDestinationAuthenticationConfigArgs]]): # -> None:
        ...
    ...
    def http_endpoint(self, value: Optional[pulumi.Input[PipelineDestinationHttpEndpointArgs]]): # -> None:
        ...
    ...
    @message_bus.setter
    def message_bus(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def network_config(self, value: Optional[pulumi.Input[PipelineDestinationNetworkConfigArgs]]): # -> None:
        ...
    ...
    def output_payload_format(self, value: Optional[pulumi.Input[PipelineDestinationOutputPayloadFormatArgs]]): # -> None:
        ...
    ...
    @workflow.setter
    def workflow(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipelineDestinationAuthenticationConfigArgs:
    def __init__(__self__, *, google_oidc: Optional[pulumi.Input[PipelineDestinationAuthenticationConfigGoogleOidcArgs]] = ..., oauth_token: Optional[pulumi.Input[PipelineDestinationAuthenticationConfigOauthTokenArgs]] = ...) -> None:
    ...
    @google_oidc.setter
    def google_oidc(self, value: Optional[pulumi.Input[PipelineDestinationAuthenticationConfigGoogleOidcArgs]]): # -> None:
        ...
    ...
    @oauth_token.setter
    def oauth_token(self, value: Optional[pulumi.Input[PipelineDestinationAuthenticationConfigOauthTokenArgs]]): # -> None:
        ...
...
class PipelineDestinationAuthenticationConfigGoogleOidcArgs:
    def __init__(__self__, *, service_account: pulumi.Input[_builtins.str], audience: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PipelineDestinationAuthenticationConfigOauthTokenArgs:
    def __init__(__self__, *, service_account: pulumi.Input[_builtins.str], scope: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PipelineDestinationHttpEndpointArgs:
    def __init__(__self__, *, uri: pulumi.Input[_builtins.str], message_binding_template: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def message_binding_template(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipelineDestinationNetworkConfigArgs:
    def __init__(__self__, *, network_attachment: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PipelineDestinationOutputPayloadFormatArgs:
    def __init__(__self__, *, avro: Optional[pulumi.Input[PipelineDestinationOutputPayloadFormatAvroArgs]] = ..., json: Optional[pulumi.Input[PipelineDestinationOutputPayloadFormatJsonArgs]] = ..., protobuf: Optional[pulumi.Input[PipelineDestinationOutputPayloadFormatProtobufArgs]] = ...) -> None:
    ...
    @avro.setter
    def avro(self, value: Optional[pulumi.Input[PipelineDestinationOutputPayloadFormatAvroArgs]]): # -> None:
        ...
    ...
    @json.setter
    def json(self, value: Optional[pulumi.Input[PipelineDestinationOutputPayloadFormatJsonArgs]]): # -> None:
        ...
    ...
    @protobuf.setter
    def protobuf(self, value: Optional[pulumi.Input[PipelineDestinationOutputPayloadFormatProtobufArgs]]): # -> None:
        ...
...
class PipelineDestinationOutputPayloadFormatAvroArgs:
    def __init__(__self__, *, schema_definition: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PipelineInputPayloadFormatArgs:
    def __init__(__self__, *, avro: Optional[pulumi.Input[PipelineInputPayloadFormatAvroArgs]] = ..., json: Optional[pulumi.Input[PipelineInputPayloadFormatJsonArgs]] = ..., protobuf: Optional[pulumi.Input[PipelineInputPayloadFormatProtobufArgs]] = ...) -> None:
    ...
    @avro.setter
    def avro(self, value: Optional[pulumi.Input[PipelineInputPayloadFormatAvroArgs]]): # -> None:
        ...
    ...
    @json.setter
    def json(self, value: Optional[pulumi.Input[PipelineInputPayloadFormatJsonArgs]]): # -> None:
        ...
    ...
    @protobuf.setter
    def protobuf(self, value: Optional[pulumi.Input[PipelineInputPayloadFormatProtobufArgs]]): # -> None:
        ...
...
class PipelineMediationArgs:
    def __init__(__self__, *, transformation: Optional[pulumi.Input[PipelineMediationTransformationArgs]] = ...) -> None:
    ...
    def transformation(self, value: Optional[pulumi.Input[PipelineMediationTransformationArgs]]): # -> None:
        ...
...
class PipelineMediationTransformationArgs:
    def __init__(__self__, *, transformation_template: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def transformation_template(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipelineRetryPolicyArgs:
    def __init__(__self__, *, max_attempts: Optional[pulumi.Input[_builtins.int]] = ..., max_retry_delay: Optional[pulumi.Input[_builtins.str]] = ..., min_retry_delay: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @max_attempts.setter
    def max_attempts(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_retry_delay(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def min_retry_delay(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TriggerDestinationArgs:
    def __init__(__self__, *, cloud_function: Optional[pulumi.Input[_builtins.str]] = ..., cloud_run_service: Optional[pulumi.Input[TriggerDestinationCloudRunServiceArgs]] = ..., gke: Optional[pulumi.Input[TriggerDestinationGkeArgs]] = ..., http_endpoint: Optional[pulumi.Input[TriggerDestinationHttpEndpointArgs]] = ..., network_config: Optional[pulumi.Input[TriggerDestinationNetworkConfigArgs]] = ..., workflow: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cloud_run_service(self, value: Optional[pulumi.Input[TriggerDestinationCloudRunServiceArgs]]): # -> None:
        ...
    ...
    @gke.setter
    def gke(self, value: Optional[pulumi.Input[TriggerDestinationGkeArgs]]): # -> None:
        ...
    ...
    @http_endpoint.setter
    def http_endpoint(self, value: Optional[pulumi.Input[TriggerDestinationHttpEndpointArgs]]): # -> None:
        ...
    ...
    @network_config.setter
    def network_config(self, value: Optional[pulumi.Input[TriggerDestinationNetworkConfigArgs]]): # -> None:
        ...
...
class TriggerDestinationCloudRunServiceArgs:
    def __init__(__self__, *, service: pulumi.Input[_builtins.str], path: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TriggerDestinationGkeArgs:
    def __init__(__self__, *, cluster: pulumi.Input[_builtins.str], location: pulumi.Input[_builtins.str], namespace: pulumi.Input[_builtins.str], service: pulumi.Input[_builtins.str], path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TriggerMatchingCriteriaArgs:
    def __init__(__self__, *, attribute: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str], operator: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TriggerRetryPolicyArgs:
    def __init__(__self__, *, max_attempts: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class TriggerTransportArgs:
    def __init__(__self__, *, pubsub: Optional[pulumi.Input[TriggerTransportPubsubArgs]] = ...) -> None:
    ...
    @pubsub.setter
    def pubsub(self, value: Optional[pulumi.Input[TriggerTransportPubsubArgs]]): # -> None:
        ...
...
class TriggerTransportPubsubArgs:
    def __init__(__self__, *, subscription: Optional[pulumi.Input[_builtins.str]] = ..., topic: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
