...
class MessageBusArgs:
    def __init__(
        ...
        *,
        ...
        logging_config: Optional[pulumi.Input[MessageBusLoggingConfigArgs]] = ...,
    ...
    def logging_config(
        self, value: Optional[pulumi.Input[MessageBusLoggingConfigArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _MessageBusState:
    def __init__(
        ...
        *,
        ...
        logging_config: Optional[pulumi.Input[MessageBusLoggingConfigArgs]] = ...,
        message_bus_id: Optional[pulumi.Input[_builtins.str]] = ...,
...
class MessageBus(pulumi.CustomResource):
    ...
    def __init__(
        ...
        logging_config: Optional[
            pulumi.Input[
                Union[MessageBusLoggingConfigArgs, MessageBusLoggingConfigArgsDict]
            ]
        ] = ...,
        message_bus_id: Optional[pulumi.Input[_builtins.str]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
