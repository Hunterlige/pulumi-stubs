...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConversationProfileAutomatedAgentConfig', 'ConversationProfileHumanAgentAssistantConfig', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ConversationProfileHumanAgentHandoffConfig', ..., 'ConversationProfileLoggingConfig', ..., ..., 'ConversationProfileNotificationConfig', 'ConversationProfileSttConfig', 'ConversationProfileTtsConfig', 'ConversationProfileTtsConfigVoice', 'CxAgentAdvancedSettings', 'CxAgentAdvancedSettingsAudioExportGcsDestination', 'CxAgentAdvancedSettingsDtmfSettings', 'CxAgentAdvancedSettingsLoggingSettings', 'CxAgentAdvancedSettingsSpeechSettings', 'CxAgentAnswerFeedbackSettings', 'CxAgentClientCertificateSettings', 'CxAgentGenAppBuilderSettings', 'CxAgentGitIntegrationSettings', 'CxAgentGitIntegrationSettingsGithubSettings', 'CxAgentPersonalizationSettings', 'CxAgentSpeechToTextSettings', 'CxAgentTextToSpeechSettings', 'CxEntityTypeEntity', 'CxEntityTypeExcludedPhrase', 'CxEnvironmentVersionConfig', 'CxFlowAdvancedSettings', 'CxFlowAdvancedSettingsAudioExportGcsDestination', 'CxFlowAdvancedSettingsDtmfSettings', 'CxFlowAdvancedSettingsLoggingSettings', 'CxFlowAdvancedSettingsSpeechSettings', 'CxFlowEventHandler', 'CxFlowEventHandlerTriggerFulfillment', ..., 'CxFlowEventHandlerTriggerFulfillmentMessage', ..., ..., ..., ..., ..., 'CxFlowEventHandlerTriggerFulfillmentMessageText', ..., 'CxFlowKnowledgeConnectorSettings', ..., 'CxFlowKnowledgeConnectorSettingsTriggerFulfillment', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'CxFlowNluSettings', 'CxFlowTransitionRoute', 'CxFlowTransitionRouteTriggerFulfillment', ..., 'CxFlowTransitionRouteTriggerFulfillmentMessage', ..., ..., ..., ..., ..., 'CxFlowTransitionRouteTriggerFulfillmentMessageText', ..., 'CxGenerativeSettingsFallbackSettings', 'CxGenerativeSettingsFallbackSettingsPromptTemplate', 'CxGenerativeSettingsGenerativeSafetySettings', ..., 'CxGenerativeSettingsKnowledgeConnectorSettings', 'CxGenerativeSettingsLlmModelSettings', 'CxGeneratorLlmModelSettings', 'CxGeneratorModelParameter', 'CxGeneratorPlaceholder', 'CxGeneratorPromptText', 'CxIntentParameter', 'CxIntentTrainingPhrase', 'CxIntentTrainingPhrasePart', 'CxPageAdvancedSettings', 'CxPageAdvancedSettingsDtmfSettings', 'CxPageEntryFulfillment', 'CxPageEntryFulfillmentConditionalCase', 'CxPageEntryFulfillmentMessage', 'CxPageEntryFulfillmentMessageConversationSuccess', 'CxPageEntryFulfillmentMessageLiveAgentHandoff', 'CxPageEntryFulfillmentMessageOutputAudioText', 'CxPageEntryFulfillmentMessagePlayAudio', 'CxPageEntryFulfillmentMessageTelephonyTransferCall', 'CxPageEntryFulfillmentMessageText', 'CxPageEntryFulfillmentSetParameterAction', 'CxPageEventHandler', 'CxPageEventHandlerTriggerFulfillment', ..., 'CxPageEventHandlerTriggerFulfillmentMessage', ..., ..., ..., ..., ..., 'CxPageEventHandlerTriggerFulfillmentMessageText', ..., 'CxPageForm', 'CxPageFormParameter', 'CxPageFormParameterAdvancedSettings', 'CxPageFormParameterAdvancedSettingsDtmfSettings', 'CxPageFormParameterFillBehavior', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'CxPageKnowledgeConnectorSettings', ..., 'CxPageKnowledgeConnectorSettingsTriggerFulfillment', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'CxPageTransitionRoute', 'CxPageTransitionRouteTriggerFulfillment', ..., 'CxPageTransitionRouteTriggerFulfillmentMessage', ..., ..., ..., ..., ..., 'CxPageTransitionRouteTriggerFulfillmentMessageText', ..., 'CxPlaybookInstruction', 'CxPlaybookInstructionStep', 'CxPlaybookLlmModelSettings', 'CxSecuritySettingsAudioExportSettings', 'CxSecuritySettingsInsightsExportSettings', 'CxTestCaseLastTestResult', 'CxTestCaseLastTestResultConversationTurn', 'CxTestCaseLastTestResultConversationTurnUserInput', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'CxTestCaseTestCaseConversationTurn', 'CxTestCaseTestCaseConversationTurnUserInput', 'CxTestCaseTestCaseConversationTurnUserInputInput', ..., ..., ..., ..., ..., ..., ..., 'CxTestCaseTestConfig', 'CxToolConnectorSpec', 'CxToolConnectorSpecAction', 'CxToolConnectorSpecActionEntityOperation', 'CxToolConnectorSpecEndUserAuthConfig', ..., ..., 'CxToolDataStoreSpec', 'CxToolDataStoreSpecDataStoreConnection', 'CxToolDataStoreSpecFallbackPrompt', 'CxToolFunctionSpec', 'CxToolOpenApiSpec', 'CxToolOpenApiSpecAuthentication', 'CxToolOpenApiSpecAuthenticationApiKeyConfig', 'CxToolOpenApiSpecAuthenticationBearerTokenConfig', 'CxToolOpenApiSpecAuthenticationOauthConfig', ..., 'CxToolOpenApiSpecServiceDirectoryConfig', 'CxToolOpenApiSpecTlsConfig', 'CxToolOpenApiSpecTlsConfigCaCert', 'CxToolVersionTool', 'CxToolVersionToolConnectorSpec', 'CxToolVersionToolConnectorSpecAction', ..., 'CxToolVersionToolConnectorSpecEndUserAuthConfig', ..., ..., 'CxToolVersionToolDataStoreSpec', 'CxToolVersionToolDataStoreSpecDataStoreConnection', 'CxToolVersionToolDataStoreSpecFallbackPrompt', 'CxToolVersionToolFunctionSpec', 'CxToolVersionToolOpenApiSpec', 'CxToolVersionToolOpenApiSpecAuthentication', ..., ..., ..., ..., 'CxToolVersionToolOpenApiSpecServiceDirectoryConfig', 'CxToolVersionToolOpenApiSpecTlsConfig', 'CxToolVersionToolOpenApiSpecTlsConfigCaCert', 'CxVersionNluSetting', 'CxWebhookGenericWebService', 'CxWebhookGenericWebServiceOauthConfig', ..., 'CxWebhookGenericWebServiceServiceAccountAuthConfig', 'CxWebhookServiceDirectory', 'CxWebhookServiceDirectoryGenericWebService', ..., ..., ..., 'EncryptionSpecEncryptionSpec', 'EntityTypeEntity', 'FulfillmentFeature', 'FulfillmentGenericWebService', 'GeneratorInferenceParameter', 'GeneratorSummarizationContext', 'GeneratorSummarizationContextFewShotExample', ..., ..., 'GeneratorSummarizationContextFewShotExampleOutput', ..., ..., ..., ..., 'GeneratorSummarizationContextSummarizationSection', 'IntentFollowupIntentInfo']
@pulumi.output_type
class ConversationProfileAutomatedAgentConfig(dict):
    ...
    def __init__(__self__, *, agent: _builtins.str, session_ttl: Optional[_builtins.str] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfig(dict):
    ...
    def __init__(__self__, *, end_user_suggestion_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfig] = ..., human_agent_suggestion_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfig] = ..., message_analysis_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigMessageAnalysisConfig] = ..., notification_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigNotificationConfig] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfig(dict):
    ...
    def __init__(__self__, *, disable_high_latency_features_sync_delivery: Optional[_builtins.bool] = ..., feature_configs: Optional[Sequence[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig]] = ..., generators: Optional[Sequence[_builtins.str]] = ..., group_suggestion_responses: Optional[_builtins.bool] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfig(dict):
    ...
    def __init__(__self__, *, conversation_model_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigConversationModelConfig] = ..., conversation_process_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigConversationProcessConfig] = ..., disable_agent_query_logging: Optional[_builtins.bool] = ..., enable_conversation_augmented_query: Optional[_builtins.bool] = ..., enable_event_based_suggestion: Optional[_builtins.bool] = ..., enable_query_suggestion_only: Optional[_builtins.bool] = ..., enable_query_suggestion_when_no_answer: Optional[_builtins.bool] = ..., query_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfig] = ..., suggestion_feature: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigSuggestionFeature] = ..., suggestion_trigger_settings: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigSuggestionTriggerSettings] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigConversationModelConfig(dict):
    ...
    def __init__(__self__, *, baseline_model_version: Optional[_builtins.str] = ..., model: Optional[_builtins.str] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigConversationProcessConfig(dict):
    ...
    def __init__(__self__, *, recent_sentences_count: Optional[_builtins.int] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfig(dict):
    ...
    def __init__(__self__, *, confidence_threshold: Optional[_builtins.float] = ..., context_filter_settings: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfigContextFilterSettings] = ..., dialogflow_query_source: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfigDialogflowQuerySource] = ..., document_query_source: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfigDocumentQuerySource] = ..., knowledge_base_query_source: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfigKnowledgeBaseQuerySource] = ..., max_results: Optional[_builtins.int] = ..., sections: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfigSections] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfigContextFilterSettings(dict):
    ...
    def __init__(__self__, *, drop_handoff_messages: Optional[_builtins.bool] = ..., drop_ivr_messages: Optional[_builtins.bool] = ..., drop_virtual_agent_messages: Optional[_builtins.bool] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfigDialogflowQuerySource(dict):
    ...
    def __init__(__self__, *, agent: _builtins.str, human_agent_side_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfigDialogflowQuerySourceHumanAgentSideConfig] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigQueryConfigSections(dict):
    ...
    def __init__(__self__, *, section_types: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigSuggestionTriggerSettings(dict):
    ...
    def __init__(__self__, *, no_small_talk: Optional[_builtins.bool] = ..., only_end_user: Optional[_builtins.bool] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfig(dict):
    ...
    def __init__(__self__, *, disable_high_latency_features_sync_delivery: Optional[_builtins.bool] = ..., feature_configs: Optional[Sequence[outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfig]] = ..., generators: Optional[Sequence[_builtins.str]] = ..., group_suggestion_responses: Optional[_builtins.bool] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfig(dict):
    ...
    def __init__(__self__, *, conversation_model_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigConversationModelConfig] = ..., conversation_process_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigConversationProcessConfig] = ..., disable_agent_query_logging: Optional[_builtins.bool] = ..., enable_conversation_augmented_query: Optional[_builtins.bool] = ..., enable_event_based_suggestion: Optional[_builtins.bool] = ..., enable_query_suggestion_only: Optional[_builtins.bool] = ..., enable_query_suggestion_when_no_answer: Optional[_builtins.bool] = ..., query_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigQueryConfig] = ..., suggestion_feature: Optional[outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigSuggestionFeature] = ..., suggestion_trigger_settings: Optional[outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigSuggestionTriggerSettings] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigQueryConfig(dict):
    ...
    def __init__(__self__, *, confidence_threshold: Optional[_builtins.float] = ..., context_filter_settings: Optional[outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigQueryConfigContextFilterSettings] = ..., dialogflow_query_source: Optional[outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigQueryConfigDialogflowQuerySource] = ..., max_results: Optional[_builtins.int] = ..., sections: Optional[outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigQueryConfigSections] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigQueryConfigDialogflowQuerySource(dict):
    ...
    def __init__(__self__, *, agent: _builtins.str, human_agent_side_config: Optional[outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigQueryConfigDialogflowQuerySourceHumanAgentSideConfig] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigMessageAnalysisConfig(dict):
    ...
    def __init__(__self__, *, enable_entity_extraction: Optional[_builtins.bool] = ..., enable_sentiment_analysis: Optional[_builtins.bool] = ...) -> None:
...
class ConversationProfileHumanAgentAssistantConfigNotificationConfig(dict):
    ...
    def __init__(__self__, *, message_format: Optional[_builtins.str] = ..., topic: Optional[_builtins.str] = ...) -> None:
...
class ConversationProfileHumanAgentHandoffConfig(dict):
    ...
    def __init__(__self__, *, live_person_config: Optional[outputs.ConversationProfileHumanAgentHandoffConfigLivePersonConfig] = ...) -> None:
...
class ConversationProfileLoggingConfig(dict):
    ...
    def __init__(__self__, *, enable_stackdriver_logging: Optional[_builtins.bool] = ...) -> None:
...
class ConversationProfileSttConfig(dict):
    ...
    def __init__(__self__, *, audio_encoding: Optional[_builtins.str] = ..., enable_word_info: Optional[_builtins.bool] = ..., language_code: Optional[_builtins.str] = ..., model: Optional[_builtins.str] = ..., sample_rate_hertz: Optional[_builtins.int] = ..., speech_model_variant: Optional[_builtins.str] = ..., use_timeout_based_endpointing: Optional[_builtins.bool] = ...) -> None:
...
class ConversationProfileTtsConfig(dict):
    ...
    def __init__(__self__, *, effects_profile_ids: Optional[Sequence[_builtins.str]] = ..., pitch: Optional[_builtins.float] = ..., speaking_rate: Optional[_builtins.float] = ..., voice: Optional[outputs.ConversationProfileTtsConfigVoice] = ..., volume_gain_db: Optional[_builtins.float] = ...) -> None:
...
class ConversationProfileTtsConfigVoice(dict):
    ...
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., ssml_gender: Optional[_builtins.str] = ...) -> None:
...
class CxAgentAdvancedSettingsDtmfSettings(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., finish_digit: Optional[_builtins.str] = ..., max_digits: Optional[_builtins.int] = ...) -> None:
...
class CxAgentAdvancedSettingsLoggingSettings(dict):
    ...
    def __init__(__self__, *, enable_consent_based_redaction: Optional[_builtins.bool] = ..., enable_interaction_logging: Optional[_builtins.bool] = ..., enable_stackdriver_logging: Optional[_builtins.bool] = ...) -> None:
...
class CxAgentAdvancedSettingsSpeechSettings(dict):
    ...
    def __init__(__self__, *, endpointer_sensitivity: Optional[_builtins.int] = ..., models: Optional[Mapping[str, _builtins.str]] = ..., no_speech_timeout: Optional[_builtins.str] = ..., use_timeout_based_endpointing: Optional[_builtins.bool] = ...) -> None:
...
class CxAgentAnswerFeedbackSettings(dict):
    ...
    def __init__(__self__, *, enable_answer_feedback: Optional[_builtins.bool] = ...) -> None:
...
class CxAgentClientCertificateSettings(dict):
    ...
    def __init__(__self__, *, private_key: _builtins.str, ssl_certificate: _builtins.str, passphrase: Optional[_builtins.str] = ...) -> None:
...
class CxAgentGitIntegrationSettings(dict):
    ...
    def __init__(__self__, *, github_settings: Optional[outputs.CxAgentGitIntegrationSettingsGithubSettings] = ...) -> None:
...
class CxAgentGitIntegrationSettingsGithubSettings(dict):
    ...
    def __init__(__self__, *, access_token: Optional[_builtins.str] = ..., branches: Optional[Sequence[_builtins.str]] = ..., display_name: Optional[_builtins.str] = ..., repository_uri: Optional[_builtins.str] = ..., tracking_branch: Optional[_builtins.str] = ...) -> None:
...
class CxAgentPersonalizationSettings(dict):
    ...
    def __init__(__self__, *, default_end_user_metadata: Optional[_builtins.str] = ...) -> None:
...
class CxAgentSpeechToTextSettings(dict):
    ...
    def __init__(__self__, *, enable_speech_adaptation: Optional[_builtins.bool] = ...) -> None:
...
class CxAgentTextToSpeechSettings(dict):
    ...
    def __init__(__self__, *, synthesize_speech_configs: Optional[_builtins.str] = ...) -> None:
...
class CxEntityTypeEntity(dict):
    def __init__(__self__, *, synonyms: Optional[Sequence[_builtins.str]] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class CxFlowEventHandler(dict):
    ...
    def __init__(__self__, *, event: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., target_flow: Optional[_builtins.str] = ..., target_page: Optional[_builtins.str] = ..., trigger_fulfillment: Optional[outputs.CxFlowEventHandlerTriggerFulfillment] = ...) -> None:
...
class CxFlowEventHandlerTriggerFulfillment(dict):
    ...
    def __init__(__self__, *, conditional_cases: Optional[Sequence[outputs.CxFlowEventHandlerTriggerFulfillmentConditionalCase]] = ..., enable_generative_fallback: Optional[_builtins.bool] = ..., messages: Optional[Sequence[outputs.CxFlowEventHandlerTriggerFulfillmentMessage]] = ..., return_partial_responses: Optional[_builtins.bool] = ..., set_parameter_actions: Optional[Sequence[outputs.CxFlowEventHandlerTriggerFulfillmentSetParameterAction]] = ..., tag: Optional[_builtins.str] = ..., webhook: Optional[_builtins.str] = ...) -> None:
...
class CxFlowEventHandlerTriggerFulfillmentMessage(dict):
    ...
    def __init__(__self__, *, channel: Optional[_builtins.str] = ..., conversation_success: Optional[outputs.CxFlowEventHandlerTriggerFulfillmentMessageConversationSuccess] = ..., live_agent_handoff: Optional[outputs.CxFlowEventHandlerTriggerFulfillmentMessageLiveAgentHandoff] = ..., output_audio_text: Optional[outputs.CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioText] = ..., payload: Optional[_builtins.str] = ..., play_audio: Optional[outputs.CxFlowEventHandlerTriggerFulfillmentMessagePlayAudio] = ..., telephony_transfer_call: Optional[outputs.CxFlowEventHandlerTriggerFulfillmentMessageTelephonyTransferCall] = ..., text: Optional[outputs.CxFlowEventHandlerTriggerFulfillmentMessageText] = ...) -> None:
...
class CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioText(dict):
    ...
    def __init__(__self__, *, allow_playback_interruption: Optional[_builtins.bool] = ..., ssml: Optional[_builtins.str] = ..., text: Optional[_builtins.str] = ...) -> None:
...
class CxFlowEventHandlerTriggerFulfillmentMessagePlayAudio(dict):
    ...
    def __init__(__self__, *, audio_uri: _builtins.str, allow_playback_interruption: Optional[_builtins.bool] = ...) -> None:
...
class CxFlowEventHandlerTriggerFulfillmentMessageText(dict):
    ...
    def __init__(__self__, *, allow_playback_interruption: Optional[_builtins.bool] = ..., texts: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CxFlowEventHandlerTriggerFulfillmentSetParameterAction(dict):
    def __init__(__self__, *, parameter: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class CxFlowKnowledgeConnectorSettings(dict):
    ...
    def __init__(__self__, *, data_store_connections: Optional[Sequence[outputs.CxFlowKnowledgeConnectorSettingsDataStoreConnection]] = ..., enabled: Optional[_builtins.bool] = ..., target_flow: Optional[_builtins.str] = ..., target_page: Optional[_builtins.str] = ..., trigger_fulfillment: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillment] = ...) -> None:
...
class CxFlowKnowledgeConnectorSettingsDataStoreConnection(dict):
    ...
    def __init__(__self__, *, data_store: Optional[_builtins.str] = ..., data_store_type: Optional[_builtins.str] = ..., document_processing_mode: Optional[_builtins.str] = ...) -> None:
...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillment(dict):
    ...
    def __init__(__self__, *, advanced_settings: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettings] = ..., conditional_cases: Optional[Sequence[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase]] = ..., enable_generative_fallback: Optional[_builtins.bool] = ..., messages: Optional[Sequence[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessage]] = ..., return_partial_responses: Optional[_builtins.bool] = ..., set_parameter_actions: Optional[Sequence[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction]] = ..., tag: Optional[_builtins.str] = ..., webhook: Optional[_builtins.str] = ...) -> None:
...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettings(dict):
    ...
    def __init__(__self__, *, dtmf_settings: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsDtmfSettings] = ..., logging_settings: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsLoggingSettings] = ..., speech_settings: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsSpeechSettings] = ...) -> None:
...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsDtmfSettings(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., endpointing_timeout_duration: Optional[_builtins.str] = ..., finish_digit: Optional[_builtins.str] = ..., interdigit_timeout_duration: Optional[_builtins.str] = ..., max_digits: Optional[_builtins.int] = ...) -> None:
...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessage(dict):
    ...
    def __init__(__self__, *, channel: Optional[_builtins.str] = ..., conversation_success: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageConversationSuccess] = ..., end_interactions: Optional[Sequence[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageEndInteraction]] = ..., knowledge_info_card: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageKnowledgeInfoCard] = ..., live_agent_handoff: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageLiveAgentHandoff] = ..., mixed_audios: Optional[Sequence[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudio]] = ..., output_audio_text: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageOutputAudioText] = ..., payload: Optional[_builtins.str] = ..., play_audio: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessagePlayAudio] = ..., telephony_transfer_call: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageTelephonyTransferCall] = ..., text: Optional[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageText] = ...) -> None:
...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudio(dict):
    def __init__(__self__, *, segments: Optional[Sequence[outputs.CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegment]] = ...) -> None:
...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegment(dict):
    ...
    def __init__(__self__, *, allow_playback_interruption: Optional[_builtins.bool] = ..., audio: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class CxFlowNluSettings(dict):
    ...
    def __init__(__self__, *, classification_threshold: Optional[_builtins.float] = ..., model_training_mode: Optional[_builtins.str] = ..., model_type: Optional[_builtins.str] = ...) -> None:
...
class CxFlowTransitionRoute(dict):
    ...
    def __init__(__self__, *, condition: Optional[_builtins.str] = ..., intent: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., target_flow: Optional[_builtins.str] = ..., target_page: Optional[_builtins.str] = ..., trigger_fulfillment: Optional[outputs.CxFlowTransitionRouteTriggerFulfillment] = ...) -> None:
...
class CxFlowTransitionRouteTriggerFulfillment(dict):
    ...
    def __init__(__self__, *, conditional_cases: Optional[Sequence[outputs.CxFlowTransitionRouteTriggerFulfillmentConditionalCase]] = ..., messages: Optional[Sequence[outputs.CxFlowTransitionRouteTriggerFulfillmentMessage]] = ..., return_partial_responses: Optional[_builtins.bool] = ..., set_parameter_actions: Optional[Sequence[outputs.CxFlowTransitionRouteTriggerFulfillmentSetParameterAction]] = ..., tag: Optional[_builtins.str] = ..., webhook: Optional[_builtins.str] = ...) -> None:
...
class CxFlowTransitionRouteTriggerFulfillmentMessage(dict):
    ...
    def __init__(__self__, *, channel: Optional[_builtins.str] = ..., conversation_success: Optional[outputs.CxFlowTransitionRouteTriggerFulfillmentMessageConversationSuccess] = ..., live_agent_handoff: Optional[outputs.CxFlowTransitionRouteTriggerFulfillmentMessageLiveAgentHandoff] = ..., output_audio_text: Optional[outputs.CxFlowTransitionRouteTriggerFulfillmentMessageOutputAudioText] = ..., payload: Optional[_builtins.str] = ..., play_audio: Optional[outputs.CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudio] = ..., telephony_transfer_call: Optional[outputs.CxFlowTransitionRouteTriggerFulfillmentMessageTelephonyTransferCall] = ..., text: Optional[outputs.CxFlowTransitionRouteTriggerFulfillmentMessageText] = ...) -> None:
...
class CxGenerativeSettingsFallbackSettings(dict):
    ...
    def __init__(__self__, *, prompt_templates: Optional[Sequence[outputs.CxGenerativeSettingsFallbackSettingsPromptTemplate]] = ..., selected_prompt: Optional[_builtins.str] = ...) -> None:
...
class CxGenerativeSettingsFallbackSettingsPromptTemplate(dict):
    ...
    def __init__(__self__, *, display_name: Optional[_builtins.str] = ..., frozen: Optional[_builtins.bool] = ..., prompt_text: Optional[_builtins.str] = ...) -> None:
...
class CxGenerativeSettingsGenerativeSafetySettings(dict):
    ...
    def __init__(__self__, *, banned_phrases: Optional[Sequence[outputs.CxGenerativeSettingsGenerativeSafetySettingsBannedPhrase]] = ..., default_banned_phrase_match_strategy: Optional[_builtins.str] = ...) -> None:
...
class CxGenerativeSettingsGenerativeSafetySettingsBannedPhrase(dict):
    ...
    def __init__(__self__, *, language_code: _builtins.str, text: _builtins.str) -> None:
...
class CxGenerativeSettingsKnowledgeConnectorSettings(dict):
    ...
    def __init__(__self__, *, agent: Optional[_builtins.str] = ..., agent_identity: Optional[_builtins.str] = ..., agent_scope: Optional[_builtins.str] = ..., business: Optional[_builtins.str] = ..., business_description: Optional[_builtins.str] = ..., disable_data_store_fallback: Optional[_builtins.bool] = ...) -> None:
...
class CxGenerativeSettingsLlmModelSettings(dict):
    ...
    def __init__(__self__, *, model: Optional[_builtins.str] = ..., prompt_text: Optional[_builtins.str] = ...) -> None:
...
class CxGeneratorModelParameter(dict):
    ...
    def __init__(__self__, *, max_decode_steps: Optional[_builtins.int] = ..., temperature: Optional[_builtins.float] = ..., top_k: Optional[_builtins.int] = ..., top_p: Optional[_builtins.float] = ...) -> None:
...
class CxIntentParameter(dict):
    ...
    def __init__(__self__, *, entity_type: _builtins.str, id: _builtins.str, is_list: Optional[_builtins.bool] = ..., redact: Optional[_builtins.bool] = ...) -> None:
...
class CxIntentTrainingPhrase(dict):
    ...
    def __init__(__self__, *, parts: Sequence[outputs.CxIntentTrainingPhrasePart], id: Optional[_builtins.str] = ..., repeat_count: Optional[_builtins.int] = ...) -> None:
...
class CxIntentTrainingPhrasePart(dict):
    ...
    def __init__(__self__, *, text: _builtins.str, parameter_id: Optional[_builtins.str] = ...) -> None:
...
class CxPageAdvancedSettings(dict):
    ...
    def __init__(__self__, *, dtmf_settings: Optional[outputs.CxPageAdvancedSettingsDtmfSettings] = ...) -> None:
...
class CxPageEntryFulfillment(dict):
    ...
    def __init__(__self__, *, conditional_cases: Optional[Sequence[outputs.CxPageEntryFulfillmentConditionalCase]] = ..., messages: Optional[Sequence[outputs.CxPageEntryFulfillmentMessage]] = ..., return_partial_responses: Optional[_builtins.bool] = ..., set_parameter_actions: Optional[Sequence[outputs.CxPageEntryFulfillmentSetParameterAction]] = ..., tag: Optional[_builtins.str] = ..., webhook: Optional[_builtins.str] = ...) -> None:
...
class CxPageEntryFulfillmentMessage(dict):
    ...
    def __init__(__self__, *, channel: Optional[_builtins.str] = ..., conversation_success: Optional[outputs.CxPageEntryFulfillmentMessageConversationSuccess] = ..., live_agent_handoff: Optional[outputs.CxPageEntryFulfillmentMessageLiveAgentHandoff] = ..., output_audio_text: Optional[outputs.CxPageEntryFulfillmentMessageOutputAudioText] = ..., payload: Optional[_builtins.str] = ..., play_audio: Optional[outputs.CxPageEntryFulfillmentMessagePlayAudio] = ..., telephony_transfer_call: Optional[outputs.CxPageEntryFulfillmentMessageTelephonyTransferCall] = ..., text: Optional[outputs.CxPageEntryFulfillmentMessageText] = ...) -> None:
...
class CxPageEventHandler(dict):
    ...
    def __init__(__self__, *, event: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., target_flow: Optional[_builtins.str] = ..., target_page: Optional[_builtins.str] = ..., trigger_fulfillment: Optional[outputs.CxPageEventHandlerTriggerFulfillment] = ...) -> None:
...
class CxPageEventHandlerTriggerFulfillment(dict):
    ...
    def __init__(__self__, *, conditional_cases: Optional[Sequence[outputs.CxPageEventHandlerTriggerFulfillmentConditionalCase]] = ..., messages: Optional[Sequence[outputs.CxPageEventHandlerTriggerFulfillmentMessage]] = ..., return_partial_responses: Optional[_builtins.bool] = ..., set_parameter_actions: Optional[Sequence[outputs.CxPageEventHandlerTriggerFulfillmentSetParameterAction]] = ..., tag: Optional[_builtins.str] = ..., webhook: Optional[_builtins.str] = ...) -> None:
...
class CxPageEventHandlerTriggerFulfillmentMessage(dict):
    ...
    def __init__(__self__, *, channel: Optional[_builtins.str] = ..., conversation_success: Optional[outputs.CxPageEventHandlerTriggerFulfillmentMessageConversationSuccess] = ..., live_agent_handoff: Optional[outputs.CxPageEventHandlerTriggerFulfillmentMessageLiveAgentHandoff] = ..., output_audio_text: Optional[outputs.CxPageEventHandlerTriggerFulfillmentMessageOutputAudioText] = ..., payload: Optional[_builtins.str] = ..., play_audio: Optional[outputs.CxPageEventHandlerTriggerFulfillmentMessagePlayAudio] = ..., telephony_transfer_call: Optional[outputs.CxPageEventHandlerTriggerFulfillmentMessageTelephonyTransferCall] = ..., text: Optional[outputs.CxPageEventHandlerTriggerFulfillmentMessageText] = ...) -> None:
...
class CxPageForm(dict):
    def __init__(__self__, *, parameters: Optional[Sequence[outputs.CxPageFormParameter]] = ...) -> None:
...
class CxPageFormParameter(dict):
    ...
    def __init__(__self__, *, advanced_settings: Optional[outputs.CxPageFormParameterAdvancedSettings] = ..., default_value: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., entity_type: Optional[_builtins.str] = ..., fill_behavior: Optional[outputs.CxPageFormParameterFillBehavior] = ..., is_list: Optional[_builtins.bool] = ..., redact: Optional[_builtins.bool] = ..., required: Optional[_builtins.bool] = ...) -> None:
...
class CxPageFormParameterAdvancedSettings(dict):
    ...
    def __init__(__self__, *, dtmf_settings: Optional[outputs.CxPageFormParameterAdvancedSettingsDtmfSettings] = ...) -> None:
...
class CxPageFormParameterFillBehavior(dict):
    ...
    def __init__(__self__, *, initial_prompt_fulfillment: Optional[outputs.CxPageFormParameterFillBehaviorInitialPromptFulfillment] = ..., reprompt_event_handlers: Optional[Sequence[outputs.CxPageFormParameterFillBehaviorRepromptEventHandler]] = ...) -> None:
...
class CxPageFormParameterFillBehaviorInitialPromptFulfillment(dict):
    ...
    def __init__(__self__, *, conditional_cases: Optional[Sequence[outputs.CxPageFormParameterFillBehaviorInitialPromptFulfillmentConditionalCase]] = ..., messages: Optional[Sequence[outputs.CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessage]] = ..., return_partial_responses: Optional[_builtins.bool] = ..., set_parameter_actions: Optional[Sequence[outputs.CxPageFormParameterFillBehaviorInitialPromptFulfillmentSetParameterAction]] = ..., tag: Optional[_builtins.str] = ..., webhook: Optional[_builtins.str] = ...) -> None:
...
class CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessage(dict):
    ...
    def __init__(__self__, *, channel: Optional[_builtins.str] = ..., conversation_success: Optional[outputs.CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessageConversationSuccess] = ..., live_agent_handoff: Optional[outputs.CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessageLiveAgentHandoff] = ..., output_audio_text: Optional[outputs.CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessageOutputAudioText] = ..., payload: Optional[_builtins.str] = ..., play_audio: Optional[outputs.CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessagePlayAudio] = ..., telephony_transfer_call: Optional[outputs.CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessageTelephonyTransferCall] = ..., text: Optional[outputs.CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessageText] = ...) -> None:
...
class CxPageFormParameterFillBehaviorRepromptEventHandler(dict):
    ...
    def __init__(__self__, *, event: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., target_flow: Optional[_builtins.str] = ..., target_page: Optional[_builtins.str] = ..., trigger_fulfillment: Optional[outputs.CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillment] = ...) -> None:
...
class CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillment(dict):
    ...
    def __init__(__self__, *, conditional_cases: Optional[Sequence[outputs.CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentConditionalCase]] = ..., messages: Optional[Sequence[outputs.CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessage]] = ..., return_partial_responses: Optional[_builtins.bool] = ..., set_parameter_actions: Optional[Sequence[outputs.CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentSetParameterAction]] = ..., tag: Optional[_builtins.str] = ..., webhook: Optional[_builtins.str] = ...) -> None:
...
class CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessage(dict):
    ...
    def __init__(__self__, *, channel: Optional[_builtins.str] = ..., conversation_success: Optional[outputs.CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageConversationSuccess] = ..., live_agent_handoff: Optional[outputs.CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageLiveAgentHandoff] = ..., output_audio_text: Optional[outputs.CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageOutputAudioText] = ..., payload: Optional[_builtins.str] = ..., play_audio: Optional[outputs.CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessagePlayAudio] = ..., telephony_transfer_call: Optional[outputs.CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTelephonyTransferCall] = ..., text: Optional[outputs.CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageText] = ...) -> None:
...
class CxPageKnowledgeConnectorSettings(dict):
    ...
    def __init__(__self__, *, data_store_connections: Optional[Sequence[outputs.CxPageKnowledgeConnectorSettingsDataStoreConnection]] = ..., enabled: Optional[_builtins.bool] = ..., target_flow: Optional[_builtins.str] = ..., target_page: Optional[_builtins.str] = ..., trigger_fulfillment: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillment] = ...) -> None:
...
class CxPageKnowledgeConnectorSettingsTriggerFulfillment(dict):
    ...
    def __init__(__self__, *, advanced_settings: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettings] = ..., conditional_cases: Optional[Sequence[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentConditionalCase]] = ..., enable_generative_fallback: Optional[_builtins.bool] = ..., messages: Optional[Sequence[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessage]] = ..., return_partial_responses: Optional[_builtins.bool] = ..., set_parameter_actions: Optional[Sequence[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterAction]] = ..., tag: Optional[_builtins.str] = ..., webhook: Optional[_builtins.str] = ...) -> None:
...
class CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettings(dict):
    ...
    def __init__(__self__, *, dtmf_settings: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsDtmfSettings] = ..., logging_settings: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsLoggingSettings] = ..., speech_settings: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsSpeechSettings] = ...) -> None:
...
class CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessage(dict):
    ...
    def __init__(__self__, *, channel: Optional[_builtins.str] = ..., conversation_success: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageConversationSuccess] = ..., end_interactions: Optional[Sequence[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageEndInteraction]] = ..., knowledge_info_card: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageKnowledgeInfoCard] = ..., live_agent_handoff: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageLiveAgentHandoff] = ..., mixed_audios: Optional[Sequence[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudio]] = ..., output_audio_text: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageOutputAudioText] = ..., payload: Optional[_builtins.str] = ..., play_audio: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessagePlayAudio] = ..., telephony_transfer_call: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTelephonyTransferCall] = ..., text: Optional[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageText] = ...) -> None:
...
class CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudio(dict):
    def __init__(__self__, *, segments: Optional[Sequence[outputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegment]] = ...) -> None:
...
class CxPageTransitionRoute(dict):
    ...
    def __init__(__self__, *, condition: Optional[_builtins.str] = ..., intent: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., target_flow: Optional[_builtins.str] = ..., target_page: Optional[_builtins.str] = ..., trigger_fulfillment: Optional[outputs.CxPageTransitionRouteTriggerFulfillment] = ...) -> None:
...
class CxPageTransitionRouteTriggerFulfillment(dict):
    ...
    def __init__(__self__, *, conditional_cases: Optional[Sequence[outputs.CxPageTransitionRouteTriggerFulfillmentConditionalCase]] = ..., messages: Optional[Sequence[outputs.CxPageTransitionRouteTriggerFulfillmentMessage]] = ..., return_partial_responses: Optional[_builtins.bool] = ..., set_parameter_actions: Optional[Sequence[outputs.CxPageTransitionRouteTriggerFulfillmentSetParameterAction]] = ..., tag: Optional[_builtins.str] = ..., webhook: Optional[_builtins.str] = ...) -> None:
...
class CxPageTransitionRouteTriggerFulfillmentMessage(dict):
    ...
    def __init__(__self__, *, channel: Optional[_builtins.str] = ..., conversation_success: Optional[outputs.CxPageTransitionRouteTriggerFulfillmentMessageConversationSuccess] = ..., live_agent_handoff: Optional[outputs.CxPageTransitionRouteTriggerFulfillmentMessageLiveAgentHandoff] = ..., output_audio_text: Optional[outputs.CxPageTransitionRouteTriggerFulfillmentMessageOutputAudioText] = ..., payload: Optional[_builtins.str] = ..., play_audio: Optional[outputs.CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio] = ..., telephony_transfer_call: Optional[outputs.CxPageTransitionRouteTriggerFulfillmentMessageTelephonyTransferCall] = ..., text: Optional[outputs.CxPageTransitionRouteTriggerFulfillmentMessageText] = ...) -> None:
...
class CxPlaybookInstruction(dict):
    def __init__(__self__, *, guidelines: Optional[_builtins.str] = ..., steps: Optional[Sequence[outputs.CxPlaybookInstructionStep]] = ...) -> None:
...
class CxPlaybookInstructionStep(dict):
    def __init__(__self__, *, steps: Optional[_builtins.str] = ..., text: Optional[_builtins.str] = ...) -> None:
...
class CxSecuritySettingsAudioExportSettings(dict):
    ...
    def __init__(__self__, *, audio_export_pattern: Optional[_builtins.str] = ..., audio_format: Optional[_builtins.str] = ..., enable_audio_redaction: Optional[_builtins.bool] = ..., gcs_bucket: Optional[_builtins.str] = ...) -> None:
...
class CxTestCaseLastTestResult(dict):
    ...
    def __init__(__self__, *, conversation_turns: Optional[Sequence[outputs.CxTestCaseLastTestResultConversationTurn]] = ..., environment: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., test_result: Optional[_builtins.str] = ..., test_time: Optional[_builtins.str] = ...) -> None:
...
class CxTestCaseLastTestResultConversationTurn(dict):
    ...
    def __init__(__self__, *, user_input: Optional[outputs.CxTestCaseLastTestResultConversationTurnUserInput] = ..., virtual_agent_output: Optional[outputs.CxTestCaseLastTestResultConversationTurnVirtualAgentOutput] = ...) -> None:
...
class CxTestCaseLastTestResultConversationTurnUserInput(dict):
    ...
    def __init__(__self__, *, enable_sentiment_analysis: Optional[_builtins.bool] = ..., injected_parameters: Optional[_builtins.str] = ..., input: Optional[outputs.CxTestCaseLastTestResultConversationTurnUserInputInput] = ..., is_webhook_enabled: Optional[_builtins.bool] = ...) -> None:
...
class CxTestCaseLastTestResultConversationTurnUserInputInput(dict):
    ...
    def __init__(__self__, *, dtmf: Optional[outputs.CxTestCaseLastTestResultConversationTurnUserInputInputDtmf] = ..., event: Optional[outputs.CxTestCaseLastTestResultConversationTurnUserInputInputEvent] = ..., language_code: Optional[_builtins.str] = ..., text: Optional[outputs.CxTestCaseLastTestResultConversationTurnUserInputInputText] = ...) -> None:
...
class CxTestCaseLastTestResultConversationTurnUserInputInputDtmf(dict):
    ...
    def __init__(__self__, *, digits: Optional[_builtins.str] = ..., finish_digit: Optional[_builtins.str] = ...) -> None:
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutput(dict):
    ...
    def __init__(__self__, *, current_page: Optional[outputs.CxTestCaseLastTestResultConversationTurnVirtualAgentOutputCurrentPage] = ..., differences: Optional[Sequence[outputs.CxTestCaseLastTestResultConversationTurnVirtualAgentOutputDifference]] = ..., session_parameters: Optional[_builtins.str] = ..., status: Optional[outputs.CxTestCaseLastTestResultConversationTurnVirtualAgentOutputStatus] = ..., text_responses: Optional[Sequence[outputs.CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTextResponse]] = ..., triggered_intent: Optional[outputs.CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTriggeredIntent] = ...) -> None:
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutputDifference(dict):
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTextResponse(dict):
    def __init__(__self__, *, texts: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CxTestCaseTestCaseConversationTurn(dict):
    ...
    def __init__(__self__, *, user_input: Optional[outputs.CxTestCaseTestCaseConversationTurnUserInput] = ..., virtual_agent_output: Optional[outputs.CxTestCaseTestCaseConversationTurnVirtualAgentOutput] = ...) -> None:
...
class CxTestCaseTestCaseConversationTurnUserInput(dict):
    ...
    def __init__(__self__, *, enable_sentiment_analysis: Optional[_builtins.bool] = ..., injected_parameters: Optional[_builtins.str] = ..., input: Optional[outputs.CxTestCaseTestCaseConversationTurnUserInputInput] = ..., is_webhook_enabled: Optional[_builtins.bool] = ...) -> None:
...
class CxTestCaseTestCaseConversationTurnUserInputInput(dict):
    ...
    def __init__(__self__, *, dtmf: Optional[outputs.CxTestCaseTestCaseConversationTurnUserInputInputDtmf] = ..., event: Optional[outputs.CxTestCaseTestCaseConversationTurnUserInputInputEvent] = ..., language_code: Optional[_builtins.str] = ..., text: Optional[outputs.CxTestCaseTestCaseConversationTurnUserInputInputText] = ...) -> None:
...
class CxTestCaseTestCaseConversationTurnVirtualAgentOutput(dict):
    ...
    def __init__(__self__, *, current_page: Optional[outputs.CxTestCaseTestCaseConversationTurnVirtualAgentOutputCurrentPage] = ..., session_parameters: Optional[_builtins.str] = ..., text_responses: Optional[Sequence[outputs.CxTestCaseTestCaseConversationTurnVirtualAgentOutputTextResponse]] = ..., triggered_intent: Optional[outputs.CxTestCaseTestCaseConversationTurnVirtualAgentOutputTriggeredIntent] = ...) -> None:
...
class CxTestCaseTestConfig(dict):
    ...
    def __init__(__self__, *, flow: Optional[_builtins.str] = ..., page: Optional[_builtins.str] = ..., tracking_parameters: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CxToolConnectorSpec(dict):
    ...
    def __init__(__self__, *, actions: Sequence[outputs.CxToolConnectorSpecAction], name: _builtins.str, end_user_auth_config: Optional[outputs.CxToolConnectorSpecEndUserAuthConfig] = ...) -> None:
...
class CxToolConnectorSpecAction(dict):
    ...
    def __init__(__self__, *, connection_action_id: Optional[_builtins.str] = ..., entity_operation: Optional[outputs.CxToolConnectorSpecActionEntityOperation] = ..., input_fields: Optional[Sequence[_builtins.str]] = ..., output_fields: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CxToolConnectorSpecActionEntityOperation(dict):
    ...
    def __init__(__self__, *, entity_id: _builtins.str, operation: _builtins.str) -> None:
...
class CxToolConnectorSpecEndUserAuthConfig(dict):
    ...
    def __init__(__self__, *, oauth2_auth_code_config: Optional[outputs.CxToolConnectorSpecEndUserAuthConfigOauth2AuthCodeConfig] = ..., oauth2_jwt_bearer_config: Optional[outputs.CxToolConnectorSpecEndUserAuthConfigOauth2JwtBearerConfig] = ...) -> None:
...
class CxToolConnectorSpecEndUserAuthConfigOauth2JwtBearerConfig(dict):
    ...
    def __init__(__self__, *, client_key: _builtins.str, issuer: _builtins.str, subject: _builtins.str) -> None:
...
class CxToolDataStoreSpec(dict):
    ...
    def __init__(__self__, *, data_store_connections: Sequence[outputs.CxToolDataStoreSpecDataStoreConnection], fallback_prompt: outputs.CxToolDataStoreSpecFallbackPrompt) -> None:
...
class CxToolFunctionSpec(dict):
    ...
    def __init__(__self__, *, input_schema: Optional[_builtins.str] = ..., output_schema: Optional[_builtins.str] = ...) -> None:
...
class CxToolOpenApiSpec(dict):
    ...
    def __init__(__self__, *, text_schema: _builtins.str, authentication: Optional[outputs.CxToolOpenApiSpecAuthentication] = ..., service_directory_config: Optional[outputs.CxToolOpenApiSpecServiceDirectoryConfig] = ..., tls_config: Optional[outputs.CxToolOpenApiSpecTlsConfig] = ...) -> None:
...
class CxToolOpenApiSpecAuthentication(dict):
    ...
    def __init__(__self__, *, api_key_config: Optional[outputs.CxToolOpenApiSpecAuthenticationApiKeyConfig] = ..., bearer_token_config: Optional[outputs.CxToolOpenApiSpecAuthenticationBearerTokenConfig] = ..., oauth_config: Optional[outputs.CxToolOpenApiSpecAuthenticationOauthConfig] = ..., service_agent_auth_config: Optional[outputs.CxToolOpenApiSpecAuthenticationServiceAgentAuthConfig] = ...) -> None:
...
class CxToolOpenApiSpecAuthenticationApiKeyConfig(dict):
    ...
    def __init__(__self__, *, key_name: _builtins.str, request_location: _builtins.str, api_key: Optional[_builtins.str] = ..., secret_version_for_api_key: Optional[_builtins.str] = ...) -> None:
...
class CxToolOpenApiSpecAuthenticationBearerTokenConfig(dict):
    ...
    def __init__(__self__, *, secret_version_for_token: Optional[_builtins.str] = ..., token: Optional[_builtins.str] = ...) -> None:
...
class CxToolOpenApiSpecAuthenticationOauthConfig(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, oauth_grant_type: _builtins.str, token_endpoint: _builtins.str, client_secret: Optional[_builtins.str] = ..., scopes: Optional[Sequence[_builtins.str]] = ..., secret_version_for_client_secret: Optional[_builtins.str] = ...) -> None:
...
class CxToolOpenApiSpecAuthenticationServiceAgentAuthConfig(dict):
    ...
    def __init__(__self__, *, service_agent_auth: Optional[_builtins.str] = ...) -> None:
...
class CxToolOpenApiSpecTlsConfig(dict):
    ...
    def __init__(__self__, *, ca_certs: Sequence[outputs.CxToolOpenApiSpecTlsConfigCaCert]) -> None:
...
class CxToolVersionTool(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, display_name: _builtins.str, connector_spec: Optional[outputs.CxToolVersionToolConnectorSpec] = ..., data_store_spec: Optional[outputs.CxToolVersionToolDataStoreSpec] = ..., function_spec: Optional[outputs.CxToolVersionToolFunctionSpec] = ..., name: Optional[_builtins.str] = ..., open_api_spec: Optional[outputs.CxToolVersionToolOpenApiSpec] = ..., tool_type: Optional[_builtins.str] = ...) -> None:
...
class CxToolVersionToolConnectorSpec(dict):
    ...
    def __init__(__self__, *, actions: Sequence[outputs.CxToolVersionToolConnectorSpecAction], name: _builtins.str, end_user_auth_config: Optional[outputs.CxToolVersionToolConnectorSpecEndUserAuthConfig] = ...) -> None:
...
class CxToolVersionToolConnectorSpecAction(dict):
    ...
    def __init__(__self__, *, connection_action_id: Optional[_builtins.str] = ..., entity_operation: Optional[outputs.CxToolVersionToolConnectorSpecActionEntityOperation] = ..., input_fields: Optional[Sequence[_builtins.str]] = ..., output_fields: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CxToolVersionToolConnectorSpecEndUserAuthConfig(dict):
    ...
    def __init__(__self__, *, oauth2_auth_code_config: Optional[outputs.CxToolVersionToolConnectorSpecEndUserAuthConfigOauth2AuthCodeConfig] = ..., oauth2_jwt_bearer_config: Optional[outputs.CxToolVersionToolConnectorSpecEndUserAuthConfigOauth2JwtBearerConfig] = ...) -> None:
...
class CxToolVersionToolDataStoreSpec(dict):
    ...
    def __init__(__self__, *, data_store_connections: Sequence[outputs.CxToolVersionToolDataStoreSpecDataStoreConnection], fallback_prompt: outputs.CxToolVersionToolDataStoreSpecFallbackPrompt) -> None:
...
class CxToolVersionToolOpenApiSpec(dict):
    ...
    def __init__(__self__, *, text_schema: _builtins.str, authentication: Optional[outputs.CxToolVersionToolOpenApiSpecAuthentication] = ..., service_directory_config: Optional[outputs.CxToolVersionToolOpenApiSpecServiceDirectoryConfig] = ..., tls_config: Optional[outputs.CxToolVersionToolOpenApiSpecTlsConfig] = ...) -> None:
...
class CxToolVersionToolOpenApiSpecAuthentication(dict):
    ...
    def __init__(__self__, *, api_key_config: Optional[outputs.CxToolVersionToolOpenApiSpecAuthenticationApiKeyConfig] = ..., bearer_token_config: Optional[outputs.CxToolVersionToolOpenApiSpecAuthenticationBearerTokenConfig] = ..., oauth_config: Optional[outputs.CxToolVersionToolOpenApiSpecAuthenticationOauthConfig] = ..., service_agent_auth_config: Optional[outputs.CxToolVersionToolOpenApiSpecAuthenticationServiceAgentAuthConfig] = ...) -> None:
...
class CxToolVersionToolOpenApiSpecTlsConfig(dict):
    ...
    def __init__(__self__, *, ca_certs: Sequence[outputs.CxToolVersionToolOpenApiSpecTlsConfigCaCert]) -> None:
...
class CxWebhookGenericWebService(dict):
    ...
    def __init__(__self__, *, uri: _builtins.str, allowed_ca_certs: Optional[Sequence[_builtins.str]] = ..., http_method: Optional[_builtins.str] = ..., oauth_config: Optional[outputs.CxWebhookGenericWebServiceOauthConfig] = ..., parameter_mapping: Optional[Mapping[str, _builtins.str]] = ..., request_body: Optional[_builtins.str] = ..., request_headers: Optional[Mapping[str, _builtins.str]] = ..., secret_version_for_username_password: Optional[_builtins.str] = ..., secret_versions_for_request_headers: Optional[Sequence[outputs.CxWebhookGenericWebServiceSecretVersionsForRequestHeader]] = ..., service_account_auth_config: Optional[outputs.CxWebhookGenericWebServiceServiceAccountAuthConfig] = ..., service_agent_auth: Optional[_builtins.str] = ..., webhook_type: Optional[_builtins.str] = ...) -> None:
...
class CxWebhookGenericWebServiceOauthConfig(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, token_endpoint: _builtins.str, client_secret: Optional[_builtins.str] = ..., scopes: Optional[Sequence[_builtins.str]] = ..., secret_version_for_client_secret: Optional[_builtins.str] = ...) -> None:
...
class CxWebhookGenericWebServiceSecretVersionsForRequestHeader(dict):
    ...
    def __init__(__self__, *, key: _builtins.str, secret_version: _builtins.str) -> None:
...
class CxWebhookServiceDirectory(dict):
    ...
    def __init__(__self__, *, service: _builtins.str, generic_web_service: Optional[outputs.CxWebhookServiceDirectoryGenericWebService] = ...) -> None:
...
class CxWebhookServiceDirectoryGenericWebService(dict):
    ...
    def __init__(__self__, *, uri: _builtins.str, allowed_ca_certs: Optional[Sequence[_builtins.str]] = ..., http_method: Optional[_builtins.str] = ..., oauth_config: Optional[outputs.CxWebhookServiceDirectoryGenericWebServiceOauthConfig] = ..., parameter_mapping: Optional[Mapping[str, _builtins.str]] = ..., request_body: Optional[_builtins.str] = ..., request_headers: Optional[Mapping[str, _builtins.str]] = ..., secret_version_for_username_password: Optional[_builtins.str] = ..., secret_versions_for_request_headers: Optional[Sequence[outputs.CxWebhookServiceDirectoryGenericWebServiceSecretVersionsForRequestHeader]] = ..., service_account_auth_config: Optional[outputs.CxWebhookServiceDirectoryGenericWebServiceServiceAccountAuthConfig] = ..., service_agent_auth: Optional[_builtins.str] = ..., webhook_type: Optional[_builtins.str] = ...) -> None:
...
class FulfillmentGenericWebService(dict):
    ...
    def __init__(__self__, *, uri: _builtins.str, password: Optional[_builtins.str] = ..., request_headers: Optional[Mapping[str, _builtins.str]] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class GeneratorInferenceParameter(dict):
    ...
    def __init__(__self__, *, max_output_tokens: Optional[_builtins.int] = ..., temperature: Optional[_builtins.float] = ..., top_k: Optional[_builtins.int] = ..., top_p: Optional[_builtins.float] = ...) -> None:
...
class GeneratorSummarizationContext(dict):
    ...
    def __init__(__self__, *, few_shot_examples: Optional[Sequence[outputs.GeneratorSummarizationContextFewShotExample]] = ..., output_language_code: Optional[_builtins.str] = ..., summarization_sections: Optional[Sequence[outputs.GeneratorSummarizationContextSummarizationSection]] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class GeneratorSummarizationContextFewShotExample(dict):
    ...
    def __init__(__self__, *, output: outputs.GeneratorSummarizationContextFewShotExampleOutput, conversation_context: Optional[outputs.GeneratorSummarizationContextFewShotExampleConversationContext] = ..., extra_info: Optional[Mapping[str, _builtins.str]] = ..., summarization_section_list: Optional[outputs.GeneratorSummarizationContextFewShotExampleSummarizationSectionList] = ...) -> None:
...
class GeneratorSummarizationContextFewShotExampleConversationContext(dict):
    ...
    def __init__(__self__, *, message_entries: Optional[Sequence[outputs.GeneratorSummarizationContextFewShotExampleConversationContextMessageEntry]] = ...) -> None:
...
class GeneratorSummarizationContextFewShotExampleConversationContextMessageEntry(dict):
    ...
    def __init__(__self__, *, create_time: Optional[_builtins.str] = ..., language_code: Optional[_builtins.str] = ..., role: Optional[_builtins.str] = ..., text: Optional[_builtins.str] = ...) -> None:
...
class GeneratorSummarizationContextFewShotExampleOutput(dict):
    ...
    def __init__(__self__, *, summary_suggestion: Optional[outputs.GeneratorSummarizationContextFewShotExampleOutputSummarySuggestion] = ...) -> None:
...
class GeneratorSummarizationContextFewShotExampleOutputSummarySuggestion(dict):
    ...
    def __init__(__self__, *, summary_sections: Sequence[outputs.GeneratorSummarizationContextFewShotExampleOutputSummarySuggestionSummarySection]) -> None:
...
class GeneratorSummarizationContextFewShotExampleOutputSummarySuggestionSummarySection(dict):
    def __init__(__self__, *, section: _builtins.str, summary: _builtins.str) -> None:
...
class GeneratorSummarizationContextFewShotExampleSummarizationSectionList(dict):
    ...
    def __init__(__self__, *, summarization_sections: Optional[Sequence[outputs.GeneratorSummarizationContextFewShotExampleSummarizationSectionListSummarizationSection]] = ...) -> None:
...
class GeneratorSummarizationContextFewShotExampleSummarizationSectionListSummarizationSection(dict):
    def __init__(__self__, *, definition: Optional[_builtins.str] = ..., key: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class IntentFollowupIntentInfo(dict):
    ...
    def __init__(__self__, *, followup_intent_name: Optional[_builtins.str] = ..., parent_followup_intent_name: Optional[_builtins.str] = ...) -> None:
