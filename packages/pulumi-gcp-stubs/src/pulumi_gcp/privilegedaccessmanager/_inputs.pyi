...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['SettingsEmailNotificationSettingsArgs', 'SettingsEmailNotificationSettingsArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'SettingsServiceAccountApproverSettingsArgs', 'SettingsServiceAccountApproverSettingsArgsDict', 'EntitlementAdditionalNotificationTargetsArgs', 'EntitlementAdditionalNotificationTargetsArgsDict', 'EntitlementApprovalWorkflowArgs', 'EntitlementApprovalWorkflowArgsDict', 'EntitlementApprovalWorkflowManualApprovalsArgs', 'EntitlementApprovalWorkflowManualApprovalsArgsDict', 'EntitlementApprovalWorkflowManualApprovalsStepArgs', ..., ..., ..., 'EntitlementEligibleUserArgs', 'EntitlementEligibleUserArgsDict', 'EntitlementPrivilegedAccessArgs', 'EntitlementPrivilegedAccessArgsDict', 'EntitlementPrivilegedAccessGcpIamAccessArgs', 'EntitlementPrivilegedAccessGcpIamAccessArgsDict', ..., ..., 'EntitlementRequesterJustificationConfigArgs', 'EntitlementRequesterJustificationConfigArgsDict', ..., ..., ..., ...]
...
class SettingsEmailNotificationSettingsArgs:
    def __init__(__self__, *, custom_notification_behavior: Optional[pulumi.Input[SettingsEmailNotificationSettingsCustomNotificationBehaviorArgs]] = ..., disable_all_notifications: Optional[pulumi.Input[SettingsEmailNotificationSettingsDisableAllNotificationsArgs]] = ...) -> None:
    ...
    def custom_notification_behavior(self, value: Optional[pulumi.Input[SettingsEmailNotificationSettingsCustomNotificationBehaviorArgs]]): # -> None:
        ...
    ...
    def disable_all_notifications(self, value: Optional[pulumi.Input[SettingsEmailNotificationSettingsDisableAllNotificationsArgs]]): # -> None:
        ...
...
class SettingsEmailNotificationSettingsCustomNotificationBehaviorArgs:
    def __init__(__self__, *, admin_notifications: Optional[pulumi.Input[SettingsEmailNotificationSettingsCustomNotificationBehaviorAdminNotificationsArgs]] = ..., approver_notifications: Optional[pulumi.Input[SettingsEmailNotificationSettingsCustomNotificationBehaviorApproverNotificationsArgs]] = ..., requester_notifications: Optional[pulumi.Input[SettingsEmailNotificationSettingsCustomNotificationBehaviorRequesterNotificationsArgs]] = ...) -> None:
    ...
    def admin_notifications(self, value: Optional[pulumi.Input[SettingsEmailNotificationSettingsCustomNotificationBehaviorAdminNotificationsArgs]]): # -> None:
        ...
    ...
    def approver_notifications(self, value: Optional[pulumi.Input[SettingsEmailNotificationSettingsCustomNotificationBehaviorApproverNotificationsArgs]]): # -> None:
        ...
    ...
    def requester_notifications(self, value: Optional[pulumi.Input[SettingsEmailNotificationSettingsCustomNotificationBehaviorRequesterNotificationsArgs]]): # -> None:
        ...
...
class SettingsEmailNotificationSettingsCustomNotificationBehaviorAdminNotificationsArgs:
    def __init__(__self__, *, grant_activated: Optional[pulumi.Input[_builtins.str]] = ..., grant_activation_failed: Optional[pulumi.Input[_builtins.str]] = ..., grant_ended: Optional[pulumi.Input[_builtins.str]] = ..., grant_externally_modified: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def grant_activated(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def grant_activation_failed(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @grant_ended.setter
    def grant_ended(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def grant_externally_modified(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SettingsEmailNotificationSettingsCustomNotificationBehaviorApproverNotificationsArgs:
    def __init__(__self__, *, pending_approval: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def pending_approval(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SettingsEmailNotificationSettingsCustomNotificationBehaviorRequesterNotificationsArgs:
    def __init__(__self__, *, entitlement_assigned: Optional[pulumi.Input[_builtins.str]] = ..., grant_activated: Optional[pulumi.Input[_builtins.str]] = ..., grant_activation_failed: Optional[pulumi.Input[_builtins.str]] = ..., grant_denied: Optional[pulumi.Input[_builtins.str]] = ..., grant_ended: Optional[pulumi.Input[_builtins.str]] = ..., grant_expired: Optional[pulumi.Input[_builtins.str]] = ..., grant_externally_modified: Optional[pulumi.Input[_builtins.str]] = ..., grant_revoked: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def entitlement_assigned(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @grant_denied.setter
    def grant_denied(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def grant_expired(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def grant_revoked(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EntitlementAdditionalNotificationTargetsArgs:
    def __init__(__self__, *, admin_email_recipients: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., requester_email_recipients: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def admin_email_recipients(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def requester_email_recipients(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EntitlementApprovalWorkflowArgs:
    def __init__(__self__, *, manual_approvals: pulumi.Input[EntitlementApprovalWorkflowManualApprovalsArgs]) -> None:
    ...
    def manual_approvals(self, value: pulumi.Input[EntitlementApprovalWorkflowManualApprovalsArgs]): # -> None:
        ...
...
class EntitlementApprovalWorkflowManualApprovalsArgs:
    def __init__(__self__, *, steps: pulumi.Input[Sequence[pulumi.Input[EntitlementApprovalWorkflowManualApprovalsStepArgs]]], require_approver_justification: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @steps.setter
    def steps(self, value: pulumi.Input[Sequence[pulumi.Input[EntitlementApprovalWorkflowManualApprovalsStepArgs]]]): # -> None:
        ...
    ...
    def require_approver_justification(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class EntitlementApprovalWorkflowManualApprovalsStepArgs:
    def __init__(__self__, *, approvers: pulumi.Input[EntitlementApprovalWorkflowManualApprovalsStepApproversArgs], approvals_needed: Optional[pulumi.Input[_builtins.int]] = ..., approver_email_recipients: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @approvers.setter
    def approvers(self, value: pulumi.Input[EntitlementApprovalWorkflowManualApprovalsStepApproversArgs]): # -> None:
        ...
    ...
    def approvals_needed(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def approver_email_recipients(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EntitlementApprovalWorkflowManualApprovalsStepApproversArgs:
    def __init__(__self__, *, principals: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @principals.setter
    def principals(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class EntitlementPrivilegedAccessArgs:
    def __init__(__self__, *, gcp_iam_access: pulumi.Input[EntitlementPrivilegedAccessGcpIamAccessArgs]) -> None:
    ...
    def gcp_iam_access(self, value: pulumi.Input[EntitlementPrivilegedAccessGcpIamAccessArgs]): # -> None:
        ...
...
class EntitlementPrivilegedAccessGcpIamAccessArgs:
    def __init__(__self__, *, resource: pulumi.Input[_builtins.str], resource_type: pulumi.Input[_builtins.str], role_bindings: pulumi.Input[Sequence[pulumi.Input[EntitlementPrivilegedAccessGcpIamAccessRoleBindingArgs]]]) -> None:
    ...
    def role_bindings(self, value: pulumi.Input[Sequence[pulumi.Input[EntitlementPrivilegedAccessGcpIamAccessRoleBindingArgs]]]): # -> None:
        ...
...
class EntitlementPrivilegedAccessGcpIamAccessRoleBindingArgs:
    def __init__(__self__, *, role: pulumi.Input[_builtins.str], condition_expression: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def condition_expression(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EntitlementRequesterJustificationConfigArgs:
    def __init__(__self__, *, not_mandatory: Optional[pulumi.Input[EntitlementRequesterJustificationConfigNotMandatoryArgs]] = ..., unstructured: Optional[pulumi.Input[EntitlementRequesterJustificationConfigUnstructuredArgs]] = ...) -> None:
    ...
    def not_mandatory(self, value: Optional[pulumi.Input[EntitlementRequesterJustificationConfigNotMandatoryArgs]]): # -> None:
        ...
    ...
    @unstructured.setter
    def unstructured(self, value: Optional[pulumi.Input[EntitlementRequesterJustificationConfigUnstructuredArgs]]): # -> None:
        ...
