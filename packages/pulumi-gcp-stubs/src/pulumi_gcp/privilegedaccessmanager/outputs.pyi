...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['SettingsEmailNotificationSettings', ..., ..., ..., ..., ..., 'SettingsServiceAccountApproverSettings', 'EntitlementAdditionalNotificationTargets', 'EntitlementApprovalWorkflow', 'EntitlementApprovalWorkflowManualApprovals', 'EntitlementApprovalWorkflowManualApprovalsStep', ..., 'EntitlementEligibleUser', 'EntitlementPrivilegedAccess', 'EntitlementPrivilegedAccessGcpIamAccess', 'EntitlementPrivilegedAccessGcpIamAccessRoleBinding', 'EntitlementRequesterJustificationConfig', ..., ..., 'GetEntitlementAdditionalNotificationTargetResult', 'GetEntitlementApprovalWorkflowResult', 'GetEntitlementApprovalWorkflowManualApprovalResult', ..., ..., 'GetEntitlementEligibleUserResult', 'GetEntitlementPrivilegedAccessResult', 'GetEntitlementPrivilegedAccessGcpIamAccessResult', ..., 'GetEntitlementRequesterJustificationConfigResult', ..., ...]
@pulumi.output_type
class SettingsEmailNotificationSettings(dict):
    ...
    def __init__(__self__, *, custom_notification_behavior: Optional[outputs.SettingsEmailNotificationSettingsCustomNotificationBehavior] = ..., disable_all_notifications: Optional[outputs.SettingsEmailNotificationSettingsDisableAllNotifications] = ...) -> None:
...
class SettingsEmailNotificationSettingsCustomNotificationBehavior(dict):
    ...
    def __init__(__self__, *, admin_notifications: Optional[outputs.SettingsEmailNotificationSettingsCustomNotificationBehaviorAdminNotifications] = ..., approver_notifications: Optional[outputs.SettingsEmailNotificationSettingsCustomNotificationBehaviorApproverNotifications] = ..., requester_notifications: Optional[outputs.SettingsEmailNotificationSettingsCustomNotificationBehaviorRequesterNotifications] = ...) -> None:
...
class SettingsEmailNotificationSettingsCustomNotificationBehaviorAdminNotifications(dict):
    ...
    def __init__(__self__, *, grant_activated: Optional[_builtins.str] = ..., grant_activation_failed: Optional[_builtins.str] = ..., grant_ended: Optional[_builtins.str] = ..., grant_externally_modified: Optional[_builtins.str] = ...) -> None:
...
class SettingsEmailNotificationSettingsCustomNotificationBehaviorApproverNotifications(dict):
    ...
    def __init__(__self__, *, pending_approval: Optional[_builtins.str] = ...) -> None:
...
class SettingsEmailNotificationSettingsCustomNotificationBehaviorRequesterNotifications(dict):
    ...
    def __init__(__self__, *, entitlement_assigned: Optional[_builtins.str] = ..., grant_activated: Optional[_builtins.str] = ..., grant_activation_failed: Optional[_builtins.str] = ..., grant_denied: Optional[_builtins.str] = ..., grant_ended: Optional[_builtins.str] = ..., grant_expired: Optional[_builtins.str] = ..., grant_externally_modified: Optional[_builtins.str] = ..., grant_revoked: Optional[_builtins.str] = ...) -> None:
...
class EntitlementAdditionalNotificationTargets(dict):
    ...
    def __init__(__self__, *, admin_email_recipients: Optional[Sequence[_builtins.str]] = ..., requester_email_recipients: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class EntitlementApprovalWorkflow(dict):
    ...
    def __init__(__self__, *, manual_approvals: outputs.EntitlementApprovalWorkflowManualApprovals) -> None:
...
class EntitlementApprovalWorkflowManualApprovals(dict):
    ...
    def __init__(__self__, *, steps: Sequence[outputs.EntitlementApprovalWorkflowManualApprovalsStep], require_approver_justification: Optional[_builtins.bool] = ...) -> None:
...
class EntitlementApprovalWorkflowManualApprovalsStep(dict):
    ...
    def __init__(__self__, *, approvers: outputs.EntitlementApprovalWorkflowManualApprovalsStepApprovers, approvals_needed: Optional[_builtins.int] = ..., approver_email_recipients: Optional[Sequence[_builtins.str]] = ..., id: Optional[_builtins.str] = ...) -> None:
...
class EntitlementPrivilegedAccess(dict):
    ...
    def __init__(__self__, *, gcp_iam_access: outputs.EntitlementPrivilegedAccessGcpIamAccess) -> None:
...
class EntitlementPrivilegedAccessGcpIamAccess(dict):
    ...
    def __init__(__self__, *, resource: _builtins.str, resource_type: _builtins.str, role_bindings: Sequence[outputs.EntitlementPrivilegedAccessGcpIamAccessRoleBinding]) -> None:
...
class EntitlementPrivilegedAccessGcpIamAccessRoleBinding(dict):
    ...
    def __init__(__self__, *, role: _builtins.str, condition_expression: Optional[_builtins.str] = ..., id: Optional[_builtins.str] = ...) -> None:
...
class EntitlementRequesterJustificationConfig(dict):
    ...
    def __init__(__self__, *, not_mandatory: Optional[outputs.EntitlementRequesterJustificationConfigNotMandatory] = ..., unstructured: Optional[outputs.EntitlementRequesterJustificationConfigUnstructured] = ...) -> None:
...
class GetEntitlementAdditionalNotificationTargetResult(dict):
    def __init__(__self__, *, admin_email_recipients: Sequence[_builtins.str], requester_email_recipients: Sequence[_builtins.str]) -> None:
...
class GetEntitlementApprovalWorkflowResult(dict):
    def __init__(__self__, *, manual_approvals: Sequence[outputs.GetEntitlementApprovalWorkflowManualApprovalResult]) -> None:
...
class GetEntitlementApprovalWorkflowManualApprovalResult(dict):
    def __init__(__self__, *, require_approver_justification: _builtins.bool, steps: Sequence[outputs.GetEntitlementApprovalWorkflowManualApprovalStepResult]) -> None:
...
class GetEntitlementApprovalWorkflowManualApprovalStepResult(dict):
    def __init__(__self__, *, approvals_needed: _builtins.int, approver_email_recipients: Sequence[_builtins.str], approvers: Sequence[outputs.GetEntitlementApprovalWorkflowManualApprovalStepApproverResult], id: _builtins.str) -> None:
...
class GetEntitlementPrivilegedAccessResult(dict):
    def __init__(__self__, *, gcp_iam_accesses: Sequence[outputs.GetEntitlementPrivilegedAccessGcpIamAccessResult]) -> None:
...
class GetEntitlementPrivilegedAccessGcpIamAccessResult(dict):
    def __init__(__self__, *, resource: _builtins.str, resource_type: _builtins.str, role_bindings: Sequence[outputs.GetEntitlementPrivilegedAccessGcpIamAccessRoleBindingResult]) -> None:
...
class GetEntitlementPrivilegedAccessGcpIamAccessRoleBindingResult(dict):
    def __init__(__self__, *, condition_expression: _builtins.str, id: _builtins.str, role: _builtins.str) -> None:
...
class GetEntitlementRequesterJustificationConfigResult(dict):
    def __init__(__self__, *, not_mandatories: Sequence[outputs.GetEntitlementRequesterJustificationConfigNotMandatoryResult], unstructureds: Sequence[outputs.GetEntitlementRequesterJustificationConfigUnstructuredResult]) -> None:
