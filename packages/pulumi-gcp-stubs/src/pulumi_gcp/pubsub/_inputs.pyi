...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['LiteSubscriptionDeliveryConfigArgs', 'LiteSubscriptionDeliveryConfigArgsDict', 'LiteTopicPartitionConfigArgs', 'LiteTopicPartitionConfigArgsDict', 'LiteTopicPartitionConfigCapacityArgs', 'LiteTopicPartitionConfigCapacityArgsDict', 'LiteTopicReservationConfigArgs', 'LiteTopicReservationConfigArgsDict', 'LiteTopicRetentionConfigArgs', 'LiteTopicRetentionConfigArgsDict', 'SchemaIamBindingConditionArgs', 'SchemaIamBindingConditionArgsDict', 'SchemaIamMemberConditionArgs', 'SchemaIamMemberConditionArgsDict', 'SubscriptionBigqueryConfigArgs', 'SubscriptionBigqueryConfigArgsDict', 'SubscriptionCloudStorageConfigArgs', 'SubscriptionCloudStorageConfigArgsDict', 'SubscriptionCloudStorageConfigAvroConfigArgs', 'SubscriptionCloudStorageConfigAvroConfigArgsDict', 'SubscriptionCloudStorageConfigTextConfigArgs', 'SubscriptionCloudStorageConfigTextConfigArgsDict', 'SubscriptionDeadLetterPolicyArgs', 'SubscriptionDeadLetterPolicyArgsDict', 'SubscriptionExpirationPolicyArgs', 'SubscriptionExpirationPolicyArgsDict', 'SubscriptionIAMBindingConditionArgs', 'SubscriptionIAMBindingConditionArgsDict', 'SubscriptionIAMMemberConditionArgs', 'SubscriptionIAMMemberConditionArgsDict', 'SubscriptionMessageTransformArgs', 'SubscriptionMessageTransformArgsDict', 'SubscriptionMessageTransformJavascriptUdfArgs', 'SubscriptionMessageTransformJavascriptUdfArgsDict', 'SubscriptionPushConfigArgs', 'SubscriptionPushConfigArgsDict', 'SubscriptionPushConfigNoWrapperArgs', 'SubscriptionPushConfigNoWrapperArgsDict', 'SubscriptionPushConfigOidcTokenArgs', 'SubscriptionPushConfigOidcTokenArgsDict', 'SubscriptionRetryPolicyArgs', 'SubscriptionRetryPolicyArgsDict', 'TopicIAMBindingConditionArgs', 'TopicIAMBindingConditionArgsDict', 'TopicIAMMemberConditionArgs', 'TopicIAMMemberConditionArgsDict', 'TopicIngestionDataSourceSettingsArgs', 'TopicIngestionDataSourceSettingsArgsDict', 'TopicIngestionDataSourceSettingsAwsKinesisArgs', 'TopicIngestionDataSourceSettingsAwsKinesisArgsDict', 'TopicIngestionDataSourceSettingsAwsMskArgs', 'TopicIngestionDataSourceSettingsAwsMskArgsDict', 'TopicIngestionDataSourceSettingsAzureEventHubsArgs', ..., 'TopicIngestionDataSourceSettingsCloudStorageArgs', ..., ..., ..., ..., ..., ..., ..., 'TopicIngestionDataSourceSettingsConfluentCloudArgs', ..., ..., ..., 'TopicMessageStoragePolicyArgs', 'TopicMessageStoragePolicyArgsDict', 'TopicMessageTransformArgs', 'TopicMessageTransformArgsDict', 'TopicMessageTransformJavascriptUdfArgs', 'TopicMessageTransformJavascriptUdfArgsDict', 'TopicSchemaSettingsArgs', 'TopicSchemaSettingsArgsDict']
...
class LiteSubscriptionDeliveryConfigArgs:
    def __init__(__self__, *, delivery_requirement: pulumi.Input[_builtins.str]) -> None:
    ...
    def delivery_requirement(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class LiteTopicPartitionConfigArgs:
    def __init__(__self__, *, count: pulumi.Input[_builtins.int], capacity: Optional[pulumi.Input[LiteTopicPartitionConfigCapacityArgs]] = ...) -> None:
    ...
    @capacity.setter
    def capacity(self, value: Optional[pulumi.Input[LiteTopicPartitionConfigCapacityArgs]]): # -> None:
        ...
...
class LiteTopicPartitionConfigCapacityArgs:
    def __init__(__self__, *, publish_mib_per_sec: pulumi.Input[_builtins.int], subscribe_mib_per_sec: pulumi.Input[_builtins.int]) -> None:
    ...
    def publish_mib_per_sec(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def subscribe_mib_per_sec(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class LiteTopicReservationConfigArgs:
    def __init__(__self__, *, throughput_reservation: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def throughput_reservation(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LiteTopicRetentionConfigArgs:
    def __init__(__self__, *, per_partition_bytes: pulumi.Input[_builtins.str], period: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def per_partition_bytes(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class SubscriptionBigqueryConfigArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], drop_unknown_fields: Optional[pulumi.Input[_builtins.bool]] = ..., service_account_email: Optional[pulumi.Input[_builtins.str]] = ..., use_table_schema: Optional[pulumi.Input[_builtins.bool]] = ..., use_topic_schema: Optional[pulumi.Input[_builtins.bool]] = ..., write_metadata: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def drop_unknown_fields(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def use_table_schema(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def use_topic_schema(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def write_metadata(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class SubscriptionCloudStorageConfigArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], avro_config: Optional[pulumi.Input[SubscriptionCloudStorageConfigAvroConfigArgs]] = ..., filename_datetime_format: Optional[pulumi.Input[_builtins.str]] = ..., filename_prefix: Optional[pulumi.Input[_builtins.str]] = ..., filename_suffix: Optional[pulumi.Input[_builtins.str]] = ..., max_bytes: Optional[pulumi.Input[_builtins.int]] = ..., max_duration: Optional[pulumi.Input[_builtins.str]] = ..., max_messages: Optional[pulumi.Input[_builtins.int]] = ..., service_account_email: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., text_config: Optional[pulumi.Input[SubscriptionCloudStorageConfigTextConfigArgs]] = ...) -> None:
    ...
    @avro_config.setter
    def avro_config(self, value: Optional[pulumi.Input[SubscriptionCloudStorageConfigAvroConfigArgs]]): # -> None:
        ...
    ...
    def filename_datetime_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def filename_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def filename_suffix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @max_duration.setter
    def max_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @text_config.setter
    def text_config(self, value: Optional[pulumi.Input[SubscriptionCloudStorageConfigTextConfigArgs]]): # -> None:
        ...
...
class SubscriptionCloudStorageConfigAvroConfigArgs:
    def __init__(__self__, *, use_topic_schema: Optional[pulumi.Input[_builtins.bool]] = ..., write_metadata: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class SubscriptionDeadLetterPolicyArgs:
    def __init__(__self__, *, dead_letter_topic: Optional[pulumi.Input[_builtins.str]] = ..., max_delivery_attempts: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class SubscriptionMessageTransformArgs:
    def __init__(__self__, *, disabled: Optional[pulumi.Input[_builtins.bool]] = ..., javascript_udf: Optional[pulumi.Input[SubscriptionMessageTransformJavascriptUdfArgs]] = ...) -> None:
    ...
    def javascript_udf(self, value: Optional[pulumi.Input[SubscriptionMessageTransformJavascriptUdfArgs]]): # -> None:
        ...
...
class SubscriptionMessageTransformJavascriptUdfArgs:
    def __init__(__self__, *, code: pulumi.Input[_builtins.str], function_name: pulumi.Input[_builtins.str]) -> None:
...
class SubscriptionPushConfigArgs:
    def __init__(__self__, *, push_endpoint: pulumi.Input[_builtins.str], attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., no_wrapper: Optional[pulumi.Input[SubscriptionPushConfigNoWrapperArgs]] = ..., oidc_token: Optional[pulumi.Input[SubscriptionPushConfigOidcTokenArgs]] = ...) -> None:
    ...
    def push_endpoint(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @no_wrapper.setter
    def no_wrapper(self, value: Optional[pulumi.Input[SubscriptionPushConfigNoWrapperArgs]]): # -> None:
        ...
    ...
    @oidc_token.setter
    def oidc_token(self, value: Optional[pulumi.Input[SubscriptionPushConfigOidcTokenArgs]]): # -> None:
        ...
...
class SubscriptionPushConfigNoWrapperArgs:
    ...
    @write_metadata.setter
    def write_metadata(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class SubscriptionPushConfigOidcTokenArgs:
    def __init__(__self__, *, service_account_email: pulumi.Input[_builtins.str], audience: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SubscriptionRetryPolicyArgs:
    def __init__(__self__, *, maximum_backoff: Optional[pulumi.Input[_builtins.str]] = ..., minimum_backoff: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def maximum_backoff(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def minimum_backoff(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TopicIngestionDataSourceSettingsArgs:
    def __init__(__self__, *, aws_kinesis: Optional[pulumi.Input[TopicIngestionDataSourceSettingsAwsKinesisArgs]] = ..., aws_msk: Optional[pulumi.Input[TopicIngestionDataSourceSettingsAwsMskArgs]] = ..., azure_event_hubs: Optional[pulumi.Input[TopicIngestionDataSourceSettingsAzureEventHubsArgs]] = ..., cloud_storage: Optional[pulumi.Input[TopicIngestionDataSourceSettingsCloudStorageArgs]] = ..., confluent_cloud: Optional[pulumi.Input[TopicIngestionDataSourceSettingsConfluentCloudArgs]] = ..., platform_logs_settings: Optional[pulumi.Input[TopicIngestionDataSourceSettingsPlatformLogsSettingsArgs]] = ...) -> None:
    ...
    @aws_kinesis.setter
    def aws_kinesis(self, value: Optional[pulumi.Input[TopicIngestionDataSourceSettingsAwsKinesisArgs]]): # -> None:
        ...
    ...
    @aws_msk.setter
    def aws_msk(self, value: Optional[pulumi.Input[TopicIngestionDataSourceSettingsAwsMskArgs]]): # -> None:
        ...
    ...
    def azure_event_hubs(self, value: Optional[pulumi.Input[TopicIngestionDataSourceSettingsAzureEventHubsArgs]]): # -> None:
        ...
    ...
    def cloud_storage(self, value: Optional[pulumi.Input[TopicIngestionDataSourceSettingsCloudStorageArgs]]): # -> None:
        ...
    ...
    def confluent_cloud(self, value: Optional[pulumi.Input[TopicIngestionDataSourceSettingsConfluentCloudArgs]]): # -> None:
        ...
    ...
    def platform_logs_settings(self, value: Optional[pulumi.Input[TopicIngestionDataSourceSettingsPlatformLogsSettingsArgs]]): # -> None:
        ...
...
class TopicIngestionDataSourceSettingsAwsKinesisArgs:
    def __init__(__self__, *, aws_role_arn: pulumi.Input[_builtins.str], consumer_arn: pulumi.Input[_builtins.str], gcp_service_account: pulumi.Input[_builtins.str], stream_arn: pulumi.Input[_builtins.str]) -> None:
    ...
    @aws_role_arn.setter
    def aws_role_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @consumer_arn.setter
    def consumer_arn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def gcp_service_account(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TopicIngestionDataSourceSettingsAwsMskArgs:
    def __init__(__self__, *, aws_role_arn: pulumi.Input[_builtins.str], cluster_arn: pulumi.Input[_builtins.str], gcp_service_account: pulumi.Input[_builtins.str], topic: pulumi.Input[_builtins.str]) -> None:
...
class TopicIngestionDataSourceSettingsAzureEventHubsArgs:
    def __init__(__self__, *, client_id: Optional[pulumi.Input[_builtins.str]] = ..., event_hub: Optional[pulumi.Input[_builtins.str]] = ..., gcp_service_account: Optional[pulumi.Input[_builtins.str]] = ..., namespace: Optional[pulumi.Input[_builtins.str]] = ..., resource_group: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ..., tenant_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @event_hub.setter
    def event_hub(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @gcp_service_account.setter
    def gcp_service_account(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TopicIngestionDataSourceSettingsCloudStorageArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], avro_format: Optional[pulumi.Input[TopicIngestionDataSourceSettingsCloudStorageAvroFormatArgs]] = ..., match_glob: Optional[pulumi.Input[_builtins.str]] = ..., minimum_object_create_time: Optional[pulumi.Input[_builtins.str]] = ..., pubsub_avro_format: Optional[pulumi.Input[TopicIngestionDataSourceSettingsCloudStoragePubsubAvroFormatArgs]] = ..., text_format: Optional[pulumi.Input[TopicIngestionDataSourceSettingsCloudStorageTextFormatArgs]] = ...) -> None:
    ...
    @avro_format.setter
    def avro_format(self, value: Optional[pulumi.Input[TopicIngestionDataSourceSettingsCloudStorageAvroFormatArgs]]): # -> None:
        ...
    ...
    @match_glob.setter
    def match_glob(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def minimum_object_create_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def pubsub_avro_format(self, value: Optional[pulumi.Input[TopicIngestionDataSourceSettingsCloudStoragePubsubAvroFormatArgs]]): # -> None:
        ...
    ...
    @text_format.setter
    def text_format(self, value: Optional[pulumi.Input[TopicIngestionDataSourceSettingsCloudStorageTextFormatArgs]]): # -> None:
        ...
...
class TopicIngestionDataSourceSettingsCloudStorageTextFormatArgs:
    def __init__(__self__, *, delimiter: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TopicIngestionDataSourceSettingsConfluentCloudArgs:
    def __init__(__self__, *, bootstrap_server: pulumi.Input[_builtins.str], gcp_service_account: pulumi.Input[_builtins.str], identity_pool_id: pulumi.Input[_builtins.str], topic: pulumi.Input[_builtins.str], cluster_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def bootstrap_server(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TopicIngestionDataSourceSettingsPlatformLogsSettingsArgs:
    def __init__(__self__, *, severity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TopicMessageStoragePolicyArgs:
    def __init__(__self__, *, allowed_persistence_regions: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], enforce_in_transit: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def allowed_persistence_regions(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def enforce_in_transit(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class TopicMessageTransformArgs:
    def __init__(__self__, *, disabled: Optional[pulumi.Input[_builtins.bool]] = ..., javascript_udf: Optional[pulumi.Input[TopicMessageTransformJavascriptUdfArgs]] = ...) -> None:
    ...
    @javascript_udf.setter
    def javascript_udf(self, value: Optional[pulumi.Input[TopicMessageTransformJavascriptUdfArgs]]): # -> None:
        ...
...
class TopicSchemaSettingsArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], encoding: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
