...
class TopicIAMBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[TopicIAMBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[TopicIAMBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class TopicIAMBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[TopicIAMBindingConditionArgs, TopicIAMBindingConditionArgsDict]
            ]
        ] = ...,
        members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.TopicIAMBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
