...
class SchemaIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[SchemaIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[SchemaIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class SchemaIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[SchemaIamBindingConditionArgs, SchemaIamBindingConditionArgsDict]
            ]
        ] = ...,
        members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.SchemaIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
