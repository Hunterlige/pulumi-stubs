...
class SchemaIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[SchemaIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[SchemaIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class SchemaIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[SchemaIamMemberConditionArgs, SchemaIamMemberConditionArgsDict]
            ]
        ] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.SchemaIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
