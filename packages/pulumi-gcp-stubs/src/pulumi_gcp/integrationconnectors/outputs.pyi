...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectionAuthConfig', 'ConnectionAuthConfigAdditionalVariable', ..., 'ConnectionAuthConfigAdditionalVariableSecretValue', 'ConnectionAuthConfigOauth2AuthCodeFlow', 'ConnectionAuthConfigOauth2AuthCodeFlowClientSecret', 'ConnectionAuthConfigOauth2ClientCredentials', ..., 'ConnectionAuthConfigOauth2JwtBearer', 'ConnectionAuthConfigOauth2JwtBearerClientKey', 'ConnectionAuthConfigOauth2JwtBearerJwtClaims', 'ConnectionAuthConfigSshPublicKey', 'ConnectionAuthConfigSshPublicKeySshClientCert', 'ConnectionAuthConfigSshPublicKeySshClientCertPass', 'ConnectionAuthConfigUserPassword', 'ConnectionAuthConfigUserPasswordPassword', 'ConnectionConfigVariable', 'ConnectionConfigVariableEncryptionKeyValue', 'ConnectionConfigVariableSecretValue', 'ConnectionConnectorVersionInfraConfig', 'ConnectionDestinationConfig', 'ConnectionDestinationConfigDestination', 'ConnectionEventingConfig', 'ConnectionEventingConfigAdditionalVariable', ..., ..., 'ConnectionEventingConfigAuthConfig', ..., ..., ..., 'ConnectionEventingConfigAuthConfigUserPassword', ..., ..., ..., 'ConnectionEventingRuntimeData', 'ConnectionEventingRuntimeDataStatus', 'ConnectionLockConfig', 'ConnectionLogConfig', 'ConnectionNodeConfig', 'ConnectionSslConfig', 'ConnectionSslConfigAdditionalVariable', ..., 'ConnectionSslConfigAdditionalVariableSecretValue', 'ConnectionSslConfigClientCertificate', 'ConnectionSslConfigClientPrivateKey', 'ConnectionSslConfigClientPrivateKeyPass', 'ConnectionSslConfigPrivateServerCertificate', 'ConnectionStatus']
@pulumi.output_type
class ConnectionAuthConfig(dict):
    ...
    def __init__(__self__, *, auth_type: _builtins.str, additional_variables: Optional[Sequence[outputs.ConnectionAuthConfigAdditionalVariable]] = ..., auth_key: Optional[_builtins.str] = ..., oauth2_auth_code_flow: Optional[outputs.ConnectionAuthConfigOauth2AuthCodeFlow] = ..., oauth2_client_credentials: Optional[outputs.ConnectionAuthConfigOauth2ClientCredentials] = ..., oauth2_jwt_bearer: Optional[outputs.ConnectionAuthConfigOauth2JwtBearer] = ..., ssh_public_key: Optional[outputs.ConnectionAuthConfigSshPublicKey] = ..., user_password: Optional[outputs.ConnectionAuthConfigUserPassword] = ...) -> None:
...
class ConnectionAuthConfigAdditionalVariable(dict):
    ...
    def __init__(__self__, *, key: _builtins.str, boolean_value: Optional[_builtins.bool] = ..., encryption_key_value: Optional[outputs.ConnectionAuthConfigAdditionalVariableEncryptionKeyValue] = ..., integer_value: Optional[_builtins.int] = ..., secret_value: Optional[outputs.ConnectionAuthConfigAdditionalVariableSecretValue] = ..., string_value: Optional[_builtins.str] = ...) -> None:
...
class ConnectionAuthConfigAdditionalVariableEncryptionKeyValue(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, kms_key_name: Optional[_builtins.str] = ...) -> None:
...
class ConnectionAuthConfigOauth2AuthCodeFlow(dict):
    ...
    def __init__(__self__, *, auth_uri: Optional[_builtins.str] = ..., client_id: Optional[_builtins.str] = ..., client_secret: Optional[outputs.ConnectionAuthConfigOauth2AuthCodeFlowClientSecret] = ..., enable_pkce: Optional[_builtins.bool] = ..., scopes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ConnectionAuthConfigOauth2ClientCredentials(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, client_secret: Optional[outputs.ConnectionAuthConfigOauth2ClientCredentialsClientSecret] = ...) -> None:
...
class ConnectionAuthConfigOauth2JwtBearer(dict):
    ...
    def __init__(__self__, *, client_key: Optional[outputs.ConnectionAuthConfigOauth2JwtBearerClientKey] = ..., jwt_claims: Optional[outputs.ConnectionAuthConfigOauth2JwtBearerJwtClaims] = ...) -> None:
...
class ConnectionAuthConfigOauth2JwtBearerJwtClaims(dict):
    def __init__(__self__, *, audience: Optional[_builtins.str] = ..., issuer: Optional[_builtins.str] = ..., subject: Optional[_builtins.str] = ...) -> None:
...
class ConnectionAuthConfigSshPublicKey(dict):
    ...
    def __init__(__self__, *, username: _builtins.str, cert_type: Optional[_builtins.str] = ..., ssh_client_cert: Optional[outputs.ConnectionAuthConfigSshPublicKeySshClientCert] = ..., ssh_client_cert_pass: Optional[outputs.ConnectionAuthConfigSshPublicKeySshClientCertPass] = ...) -> None:
...
class ConnectionAuthConfigUserPassword(dict):
    def __init__(__self__, *, username: _builtins.str, password: Optional[outputs.ConnectionAuthConfigUserPasswordPassword] = ...) -> None:
...
class ConnectionConfigVariable(dict):
    ...
    def __init__(__self__, *, key: _builtins.str, boolean_value: Optional[_builtins.bool] = ..., encryption_key_value: Optional[outputs.ConnectionConfigVariableEncryptionKeyValue] = ..., integer_value: Optional[_builtins.int] = ..., secret_value: Optional[outputs.ConnectionConfigVariableSecretValue] = ..., string_value: Optional[_builtins.str] = ...) -> None:
...
class ConnectionConnectorVersionInfraConfig(dict):
    ...
    def __init__(__self__, *, ratelimit_threshold: Optional[_builtins.str] = ...) -> None:
...
class ConnectionDestinationConfig(dict):
    def __init__(__self__, *, key: _builtins.str, destinations: Optional[Sequence[outputs.ConnectionDestinationConfigDestination]] = ...) -> None:
...
class ConnectionDestinationConfigDestination(dict):
    ...
    def __init__(__self__, *, host: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., service_attachment: Optional[_builtins.str] = ...) -> None:
...
class ConnectionEventingConfig(dict):
    ...
    def __init__(__self__, *, registration_destination_config: outputs.ConnectionEventingConfigRegistrationDestinationConfig, additional_variables: Optional[Sequence[outputs.ConnectionEventingConfigAdditionalVariable]] = ..., auth_config: Optional[outputs.ConnectionEventingConfigAuthConfig] = ..., enrichment_enabled: Optional[_builtins.bool] = ...) -> None:
...
class ConnectionEventingConfigAdditionalVariable(dict):
    ...
    def __init__(__self__, *, key: _builtins.str, boolean_value: Optional[_builtins.bool] = ..., encryption_key_value: Optional[outputs.ConnectionEventingConfigAdditionalVariableEncryptionKeyValue] = ..., integer_value: Optional[_builtins.int] = ..., secret_value: Optional[outputs.ConnectionEventingConfigAdditionalVariableSecretValue] = ..., string_value: Optional[_builtins.str] = ...) -> None:
...
class ConnectionEventingConfigAdditionalVariableEncryptionKeyValue(dict):
    ...
    def __init__(__self__, *, kms_key_name: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ConnectionEventingConfigAuthConfig(dict):
    ...
    def __init__(__self__, *, auth_type: _builtins.str, user_password: outputs.ConnectionEventingConfigAuthConfigUserPassword, additional_variables: Optional[Sequence[outputs.ConnectionEventingConfigAuthConfigAdditionalVariable]] = ..., auth_key: Optional[_builtins.str] = ...) -> None:
...
class ConnectionEventingConfigAuthConfigAdditionalVariable(dict):
    ...
    def __init__(__self__, *, key: _builtins.str, boolean_value: Optional[_builtins.bool] = ..., encryption_key_value: Optional[outputs.ConnectionEventingConfigAuthConfigAdditionalVariableEncryptionKeyValue] = ..., integer_value: Optional[_builtins.int] = ..., secret_value: Optional[outputs.ConnectionEventingConfigAuthConfigAdditionalVariableSecretValue] = ..., string_value: Optional[_builtins.str] = ...) -> None:
...
class ConnectionEventingConfigAuthConfigUserPassword(dict):
    def __init__(__self__, *, password: Optional[outputs.ConnectionEventingConfigAuthConfigUserPasswordPassword] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class ConnectionEventingConfigRegistrationDestinationConfig(dict):
    def __init__(__self__, *, destinations: Optional[Sequence[outputs.ConnectionEventingConfigRegistrationDestinationConfigDestination]] = ..., key: Optional[_builtins.str] = ...) -> None:
...
class ConnectionEventingRuntimeData(dict):
    ...
    def __init__(__self__, *, events_listener_endpoint: Optional[_builtins.str] = ..., statuses: Optional[Sequence[outputs.ConnectionEventingRuntimeDataStatus]] = ...) -> None:
...
class ConnectionEventingRuntimeDataStatus(dict):
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class ConnectionLockConfig(dict):
    def __init__(__self__, *, locked: _builtins.bool, reason: Optional[_builtins.str] = ...) -> None:
...
class ConnectionLogConfig(dict):
    def __init__(__self__, *, enabled: _builtins.bool, level: Optional[_builtins.str] = ...) -> None:
...
class ConnectionSslConfig(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, additional_variables: Optional[Sequence[outputs.ConnectionSslConfigAdditionalVariable]] = ..., client_cert_type: Optional[_builtins.str] = ..., client_certificate: Optional[outputs.ConnectionSslConfigClientCertificate] = ..., client_private_key: Optional[outputs.ConnectionSslConfigClientPrivateKey] = ..., client_private_key_pass: Optional[outputs.ConnectionSslConfigClientPrivateKeyPass] = ..., private_server_certificate: Optional[outputs.ConnectionSslConfigPrivateServerCertificate] = ..., server_cert_type: Optional[_builtins.str] = ..., trust_model: Optional[_builtins.str] = ..., use_ssl: Optional[_builtins.bool] = ...) -> None:
...
class ConnectionSslConfigAdditionalVariable(dict):
    ...
    def __init__(__self__, *, key: _builtins.str, boolean_value: Optional[_builtins.bool] = ..., encryption_key_value: Optional[outputs.ConnectionSslConfigAdditionalVariableEncryptionKeyValue] = ..., integer_value: Optional[_builtins.int] = ..., secret_value: Optional[outputs.ConnectionSslConfigAdditionalVariableSecretValue] = ..., string_value: Optional[_builtins.str] = ...) -> None:
...
class ConnectionStatus(dict):
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
