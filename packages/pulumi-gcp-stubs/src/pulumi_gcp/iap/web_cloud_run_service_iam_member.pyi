...
class WebCloudRunServiceIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[WebCloudRunServiceIamMemberConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[WebCloudRunServiceIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[WebCloudRunServiceIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class WebCloudRunServiceIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.WebCloudRunServiceIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
