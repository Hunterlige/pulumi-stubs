...
class TunnelDestGroupIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[TunnelDestGroupIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[TunnelDestGroupIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[TunnelDestGroupIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _TunnelDestGroupIamBindingState:
    def __init__(
        ...
        *,
        condition: Optional[pulumi.Input[TunnelDestGroupIamBindingConditionArgs]] = ...,
        dest_group: Optional[pulumi.Input[_builtins.str]] = ...,
...
class TunnelDestGroupIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.TunnelDestGroupIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="destGroup")
