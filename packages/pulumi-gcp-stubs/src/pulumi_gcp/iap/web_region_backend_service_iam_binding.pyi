...
class WebRegionBackendServiceIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[WebRegionBackendServiceIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[WebRegionBackendServiceIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self,
        value: Optional[pulumi.Input[WebRegionBackendServiceIamBindingConditionArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter
...
class WebRegionBackendServiceIamBinding(pulumi.CustomResource):
    ...
    def condition(
        ...
        Optional[outputs.WebRegionBackendServiceIamBindingCondition]
    ]: ...
    @_builtins.property
    @pulumi.getter
