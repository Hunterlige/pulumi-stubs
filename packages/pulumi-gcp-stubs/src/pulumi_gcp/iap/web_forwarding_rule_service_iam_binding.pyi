...
class WebForwardingRuleServiceIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[WebForwardingRuleServiceIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[WebForwardingRuleServiceIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self,
        value: Optional[pulumi.Input[WebForwardingRuleServiceIamBindingConditionArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _WebForwardingRuleServiceIamBindingState:
    def __init__(
        ...
        *,
        ...
        forwarding_rule_service_name: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    @forwarding_rule_service_name.setter
    def forwarding_rule_service_name(
...
class WebForwardingRuleServiceIamBinding(pulumi.CustomResource):
    ...
    def condition(
        ...
        Optional[outputs.WebForwardingRuleServiceIamBindingCondition]
    ]: ...
    @_builtins.property
    @pulumi.getter
