...
class WebBackendServiceIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[WebBackendServiceIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[WebBackendServiceIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[WebBackendServiceIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _WebBackendServiceIamBindingState:
    def __init__(
        ...
        *,
        ...
        web_backend_service: Optional[pulumi.Input[_builtins.str]] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
    def condition(
...
class WebBackendServiceIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.WebBackendServiceIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
