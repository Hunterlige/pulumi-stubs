...
class GetTunnelInstanceIamPolicyResult:
    def __init__(
        __self__, etag=..., id=..., instance=..., policy_data=..., project=..., zone=...
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
