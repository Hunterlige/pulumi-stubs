...
class WebTypeAppEngingIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[WebTypeAppEngingIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[WebTypeAppEngingIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[WebTypeAppEngingIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class WebTypeAppEngingIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.WebTypeAppEngingIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
