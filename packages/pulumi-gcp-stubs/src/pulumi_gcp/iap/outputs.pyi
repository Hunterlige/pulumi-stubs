...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppEngineServiceIamBindingCondition', 'AppEngineServiceIamMemberCondition', 'AppEngineVersionIamBindingCondition', 'AppEngineVersionIamMemberCondition', 'SettingsAccessSettings', 'SettingsAccessSettingsAllowedDomainsSettings', 'SettingsAccessSettingsCorsSettings', 'SettingsAccessSettingsGcipSettings', 'SettingsAccessSettingsOauthSettings', 'SettingsAccessSettingsReauthSettings', 'SettingsAccessSettingsWorkforceIdentitySettings', ..., 'SettingsApplicationSettings', ..., ..., 'SettingsApplicationSettingsCsmSettings', 'TunnelDestGroupIamBindingCondition', 'TunnelDestGroupIamMemberCondition', 'TunnelIamBindingCondition', 'TunnelIamMemberCondition', 'TunnelInstanceIAMBindingCondition', 'TunnelInstanceIAMMemberCondition', 'WebBackendServiceIamBindingCondition', 'WebBackendServiceIamMemberCondition', 'WebCloudRunServiceIamBindingCondition', 'WebCloudRunServiceIamMemberCondition', 'WebForwardingRuleServiceIamBindingCondition', 'WebForwardingRuleServiceIamMemberCondition', 'WebIamBindingCondition', 'WebIamMemberCondition', 'WebRegionBackendServiceIamBindingCondition', 'WebRegionBackendServiceIamMemberCondition', 'WebRegionForwardingRuleServiceIamBindingCondition', 'WebRegionForwardingRuleServiceIamMemberCondition', 'WebTypeAppEngingIamBindingCondition', 'WebTypeAppEngingIamMemberCondition', 'WebTypeComputeIamBindingCondition', 'WebTypeComputeIamMemberCondition']
@pulumi.output_type
...
class SettingsAccessSettings(dict):
    ...
    def __init__(__self__, *, allowed_domains_settings: Optional[outputs.SettingsAccessSettingsAllowedDomainsSettings] = ..., cors_settings: Optional[outputs.SettingsAccessSettingsCorsSettings] = ..., gcip_settings: Optional[outputs.SettingsAccessSettingsGcipSettings] = ..., identity_sources: Optional[Sequence[_builtins.str]] = ..., oauth_settings: Optional[outputs.SettingsAccessSettingsOauthSettings] = ..., reauth_settings: Optional[outputs.SettingsAccessSettingsReauthSettings] = ..., workforce_identity_settings: Optional[outputs.SettingsAccessSettingsWorkforceIdentitySettings] = ...) -> None:
...
class SettingsAccessSettingsAllowedDomainsSettings(dict):
    def __init__(__self__, *, domains: Optional[Sequence[_builtins.str]] = ..., enable: Optional[_builtins.bool] = ...) -> None:
...
class SettingsAccessSettingsCorsSettings(dict):
    ...
    def __init__(__self__, *, allow_http_options: Optional[_builtins.bool] = ...) -> None:
...
class SettingsAccessSettingsGcipSettings(dict):
    ...
    def __init__(__self__, *, login_page_uri: Optional[_builtins.str] = ..., tenant_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SettingsAccessSettingsOauthSettings(dict):
    ...
    def __init__(__self__, *, client_id: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., client_secret_sha256: Optional[_builtins.str] = ..., login_hint: Optional[_builtins.str] = ..., programmatic_clients: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SettingsAccessSettingsReauthSettings(dict):
    ...
    def __init__(__self__, *, max_age: _builtins.str, method: _builtins.str, policy_type: _builtins.str) -> None:
...
class SettingsAccessSettingsWorkforceIdentitySettings(dict):
    ...
    def __init__(__self__, *, oauth2: Optional[outputs.SettingsAccessSettingsWorkforceIdentitySettingsOauth2] = ..., workforce_pools: Optional[_builtins.str] = ...) -> None:
...
class SettingsAccessSettingsWorkforceIdentitySettingsOauth2(dict):
    ...
    def __init__(__self__, *, client_id: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., client_secret_sha256: Optional[_builtins.str] = ...) -> None:
...
class SettingsApplicationSettings(dict):
    ...
    def __init__(__self__, *, access_denied_page_settings: Optional[outputs.SettingsApplicationSettingsAccessDeniedPageSettings] = ..., attribute_propagation_settings: Optional[outputs.SettingsApplicationSettingsAttributePropagationSettings] = ..., cookie_domain: Optional[_builtins.str] = ..., csm_settings: Optional[outputs.SettingsApplicationSettingsCsmSettings] = ...) -> None:
...
class SettingsApplicationSettingsAccessDeniedPageSettings(dict):
    ...
    def __init__(__self__, *, access_denied_page_uri: Optional[_builtins.str] = ..., generate_troubleshooting_uri: Optional[_builtins.bool] = ..., remediation_token_generation_enabled: Optional[_builtins.bool] = ...) -> None:
...
class SettingsApplicationSettingsAttributePropagationSettings(dict):
    ...
    def __init__(__self__, *, enable: Optional[_builtins.bool] = ..., expression: Optional[_builtins.str] = ..., output_credentials: Optional[Sequence[_builtins.str]] = ...) -> None:
