...
class TunnelDestGroupIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[TunnelDestGroupIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[TunnelDestGroupIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[TunnelDestGroupIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class TunnelDestGroupIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.TunnelDestGroupIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="destGroup")
