...
class WebRegionForwardingRuleServiceIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[WebRegionForwardingRuleServiceIamBindingConditionArgs]
        ] = ...,
    ...
    def forwarding_rule_region_service_name(
...
class _WebRegionForwardingRuleServiceIamBindingState:
    def __init__(
        ...
        *,
        ...
        forwarding_rule_region_service_name: Optional[
...
class WebRegionForwardingRuleServiceIamBinding(pulumi.CustomResource):
    ...
    def condition(
        ...
        Optional[outputs.WebRegionForwardingRuleServiceIamBindingCondition]
    ]: ...
    @_builtins.property
    @pulumi.getter
