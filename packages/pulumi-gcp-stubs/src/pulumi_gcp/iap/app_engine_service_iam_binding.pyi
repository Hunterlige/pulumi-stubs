...
class AppEngineServiceIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[AppEngineServiceIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[AppEngineServiceIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[AppEngineServiceIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class AppEngineServiceIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.AppEngineServiceIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
