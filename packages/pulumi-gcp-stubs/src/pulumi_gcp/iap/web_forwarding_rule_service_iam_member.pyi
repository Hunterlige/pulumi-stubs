...
class WebForwardingRuleServiceIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[WebForwardingRuleServiceIamMemberConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[WebForwardingRuleServiceIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self,
        value: Optional[pulumi.Input[WebForwardingRuleServiceIamMemberConditionArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter
...
class WebForwardingRuleServiceIamMember(pulumi.CustomResource):
    ...
    def condition(
        ...
        Optional[outputs.WebForwardingRuleServiceIamMemberCondition]
    ]: ...
    @_builtins.property
    @pulumi.getter
