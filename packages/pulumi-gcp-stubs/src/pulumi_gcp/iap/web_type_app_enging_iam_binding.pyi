...
class WebTypeAppEngingIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[WebTypeAppEngingIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[WebTypeAppEngingIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[WebTypeAppEngingIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class WebTypeAppEngingIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.WebTypeAppEngingIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
