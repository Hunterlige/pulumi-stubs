...
class ServicePerimeterDryRunResource(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: ServicePerimeterDryRunResourceArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., access_policy_id: Optional[pulumi.Input[_builtins.str]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., perimeter_name: Optional[pulumi.Input[_builtins.str]] = ..., resource: Optional[pulumi.Input[_builtins.str]] = ...) -> ServicePerimeterDryRunResource:
