...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessLevelBasic', 'AccessLevelBasicCondition', 'AccessLevelBasicConditionDevicePolicy', 'AccessLevelBasicConditionDevicePolicyOsConstraint', 'AccessLevelBasicConditionVpcNetworkSource', ..., 'AccessLevelConditionDevicePolicy', 'AccessLevelConditionDevicePolicyOsConstraint', 'AccessLevelConditionVpcNetworkSource', 'AccessLevelConditionVpcNetworkSourceVpcSubnetwork', 'AccessLevelCustom', 'AccessLevelCustomExpr', 'AccessLevelsAccessLevel', 'AccessLevelsAccessLevelBasic', 'AccessLevelsAccessLevelBasicCondition', 'AccessLevelsAccessLevelBasicConditionDevicePolicy', ..., ..., ..., 'AccessLevelsAccessLevelCustom', 'AccessLevelsAccessLevelCustomExpr', 'AccessPolicyIamBindingCondition', 'AccessPolicyIamMemberCondition', 'GcpUserAccessBindingScopedAccessSetting', ..., ..., ..., 'GcpUserAccessBindingScopedAccessSettingScope', ..., ..., 'GcpUserAccessBindingSessionSettings', 'ServicePerimeterDryRunEgressPolicyEgressFrom', 'ServicePerimeterDryRunEgressPolicyEgressFromSource', 'ServicePerimeterDryRunEgressPolicyEgressTo', ..., ..., 'ServicePerimeterDryRunIngressPolicyIngressFrom', ..., 'ServicePerimeterDryRunIngressPolicyIngressTo', ..., ..., 'ServicePerimeterEgressPolicyEgressFrom', 'ServicePerimeterEgressPolicyEgressFromSource', 'ServicePerimeterEgressPolicyEgressTo', 'ServicePerimeterEgressPolicyEgressToOperation', ..., 'ServicePerimeterIngressPolicyIngressFrom', 'ServicePerimeterIngressPolicyIngressFromSource', 'ServicePerimeterIngressPolicyIngressTo', 'ServicePerimeterIngressPolicyIngressToOperation', ..., 'ServicePerimeterSpec', 'ServicePerimeterSpecEgressPolicy', 'ServicePerimeterSpecEgressPolicyEgressFrom', 'ServicePerimeterSpecEgressPolicyEgressFromSource', 'ServicePerimeterSpecEgressPolicyEgressTo', 'ServicePerimeterSpecEgressPolicyEgressToOperation', ..., 'ServicePerimeterSpecIngressPolicy', 'ServicePerimeterSpecIngressPolicyIngressFrom', 'ServicePerimeterSpecIngressPolicyIngressFromSource', 'ServicePerimeterSpecIngressPolicyIngressTo', ..., ..., 'ServicePerimeterSpecVpcAccessibleServices', 'ServicePerimeterStatus', 'ServicePerimeterStatusEgressPolicy', 'ServicePerimeterStatusEgressPolicyEgressFrom', 'ServicePerimeterStatusEgressPolicyEgressFromSource', 'ServicePerimeterStatusEgressPolicyEgressTo', ..., ..., 'ServicePerimeterStatusIngressPolicy', 'ServicePerimeterStatusIngressPolicyIngressFrom', ..., 'ServicePerimeterStatusIngressPolicyIngressTo', ..., ..., 'ServicePerimeterStatusVpcAccessibleServices', 'ServicePerimetersServicePerimeter', 'ServicePerimetersServicePerimeterSpec', 'ServicePerimetersServicePerimeterSpecEgressPolicy', ..., ..., ..., ..., ..., 'ServicePerimetersServicePerimeterSpecIngressPolicy', ..., ..., ..., ..., ..., ..., 'ServicePerimetersServicePerimeterStatus', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetSupportedServiceSupportedMethodResult', 'GetSupportedServicesSupportedServiceResult']
@pulumi.output_type
class AccessLevelBasic(dict):
    ...
    def __init__(__self__, *, conditions: Sequence[outputs.AccessLevelBasicCondition], combining_function: Optional[_builtins.str] = ...) -> None:
...
class AccessLevelBasicCondition(dict):
    ...
    def __init__(__self__, *, device_policy: Optional[outputs.AccessLevelBasicConditionDevicePolicy] = ..., ip_subnetworks: Optional[Sequence[_builtins.str]] = ..., members: Optional[Sequence[_builtins.str]] = ..., negate: Optional[_builtins.bool] = ..., regions: Optional[Sequence[_builtins.str]] = ..., required_access_levels: Optional[Sequence[_builtins.str]] = ..., vpc_network_sources: Optional[Sequence[outputs.AccessLevelBasicConditionVpcNetworkSource]] = ...) -> None:
...
class AccessLevelBasicConditionDevicePolicy(dict):
    ...
    def __init__(__self__, *, allowed_device_management_levels: Optional[Sequence[_builtins.str]] = ..., allowed_encryption_statuses: Optional[Sequence[_builtins.str]] = ..., os_constraints: Optional[Sequence[outputs.AccessLevelBasicConditionDevicePolicyOsConstraint]] = ..., require_admin_approval: Optional[_builtins.bool] = ..., require_corp_owned: Optional[_builtins.bool] = ..., require_screen_lock: Optional[_builtins.bool] = ...) -> None:
...
class AccessLevelBasicConditionDevicePolicyOsConstraint(dict):
    ...
    def __init__(__self__, *, os_type: _builtins.str, minimum_version: Optional[_builtins.str] = ..., require_verified_chrome_os: Optional[_builtins.bool] = ...) -> None:
...
class AccessLevelBasicConditionVpcNetworkSource(dict):
    ...
    def __init__(__self__, *, vpc_subnetwork: Optional[outputs.AccessLevelBasicConditionVpcNetworkSourceVpcSubnetwork] = ...) -> None:
...
class AccessLevelBasicConditionVpcNetworkSourceVpcSubnetwork(dict):
    ...
    def __init__(__self__, *, network: _builtins.str, vpc_ip_subnetworks: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AccessLevelConditionDevicePolicy(dict):
    ...
    def __init__(__self__, *, allowed_device_management_levels: Optional[Sequence[_builtins.str]] = ..., allowed_encryption_statuses: Optional[Sequence[_builtins.str]] = ..., os_constraints: Optional[Sequence[outputs.AccessLevelConditionDevicePolicyOsConstraint]] = ..., require_admin_approval: Optional[_builtins.bool] = ..., require_corp_owned: Optional[_builtins.bool] = ..., require_screen_lock: Optional[_builtins.bool] = ...) -> None:
...
class AccessLevelConditionDevicePolicyOsConstraint(dict):
    ...
    def __init__(__self__, *, os_type: _builtins.str, minimum_version: Optional[_builtins.str] = ...) -> None:
...
class AccessLevelConditionVpcNetworkSource(dict):
    ...
    def __init__(__self__, *, vpc_subnetwork: Optional[outputs.AccessLevelConditionVpcNetworkSourceVpcSubnetwork] = ...) -> None:
...
class AccessLevelsAccessLevel(dict):
    def __init__(__self__, *, name: _builtins.str, title: _builtins.str, basic: Optional[outputs.AccessLevelsAccessLevelBasic] = ..., custom: Optional[outputs.AccessLevelsAccessLevelCustom] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class AccessLevelsAccessLevelBasic(dict):
    ...
    def __init__(__self__, *, conditions: Sequence[outputs.AccessLevelsAccessLevelBasicCondition], combining_function: Optional[_builtins.str] = ...) -> None:
...
class AccessLevelsAccessLevelBasicCondition(dict):
    ...
    def __init__(__self__, *, device_policy: Optional[outputs.AccessLevelsAccessLevelBasicConditionDevicePolicy] = ..., ip_subnetworks: Optional[Sequence[_builtins.str]] = ..., members: Optional[Sequence[_builtins.str]] = ..., negate: Optional[_builtins.bool] = ..., regions: Optional[Sequence[_builtins.str]] = ..., required_access_levels: Optional[Sequence[_builtins.str]] = ..., vpc_network_sources: Optional[Sequence[outputs.AccessLevelsAccessLevelBasicConditionVpcNetworkSource]] = ...) -> None:
...
class AccessLevelsAccessLevelBasicConditionDevicePolicy(dict):
    ...
    def __init__(__self__, *, allowed_device_management_levels: Optional[Sequence[_builtins.str]] = ..., allowed_encryption_statuses: Optional[Sequence[_builtins.str]] = ..., os_constraints: Optional[Sequence[outputs.AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint]] = ..., require_admin_approval: Optional[_builtins.bool] = ..., require_corp_owned: Optional[_builtins.bool] = ..., require_screen_lock: Optional[_builtins.bool] = ...) -> None:
...
class AccessLevelsAccessLevelBasicConditionVpcNetworkSource(dict):
    ...
    def __init__(__self__, *, vpc_subnetwork: Optional[outputs.AccessLevelsAccessLevelBasicConditionVpcNetworkSourceVpcSubnetwork] = ...) -> None:
...
class AccessLevelsAccessLevelCustom(dict):
    def __init__(__self__, *, expr: outputs.AccessLevelsAccessLevelCustomExpr) -> None:
...
class GcpUserAccessBindingScopedAccessSetting(dict):
    ...
    def __init__(__self__, *, active_settings: Optional[outputs.GcpUserAccessBindingScopedAccessSettingActiveSettings] = ..., dry_run_settings: Optional[outputs.GcpUserAccessBindingScopedAccessSettingDryRunSettings] = ..., scope: Optional[outputs.GcpUserAccessBindingScopedAccessSettingScope] = ...) -> None:
...
class GcpUserAccessBindingScopedAccessSettingActiveSettings(dict):
    ...
    def __init__(__self__, *, access_levels: Optional[Sequence[_builtins.str]] = ..., session_settings: Optional[outputs.GcpUserAccessBindingScopedAccessSettingActiveSettingsSessionSettings] = ...) -> None:
...
class GcpUserAccessBindingScopedAccessSettingActiveSettingsSessionSettings(dict):
    ...
    def __init__(__self__, *, max_inactivity: Optional[_builtins.str] = ..., session_length: Optional[_builtins.str] = ..., session_length_enabled: Optional[_builtins.bool] = ..., session_reauth_method: Optional[_builtins.str] = ..., use_oidc_max_age: Optional[_builtins.bool] = ...) -> None:
...
class GcpUserAccessBindingScopedAccessSettingScope(dict):
    ...
    def __init__(__self__, *, client_scope: Optional[outputs.GcpUserAccessBindingScopedAccessSettingScopeClientScope] = ...) -> None:
...
class GcpUserAccessBindingScopedAccessSettingScopeClientScope(dict):
    ...
    def __init__(__self__, *, restricted_client_application: Optional[outputs.GcpUserAccessBindingScopedAccessSettingScopeClientScopeRestrictedClientApplication] = ...) -> None:
...
class GcpUserAccessBindingScopedAccessSettingScopeClientScopeRestrictedClientApplication(dict):
    ...
    def __init__(__self__, *, client_id: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterDryRunEgressPolicyEgressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., source_restriction: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimeterDryRunEgressPolicyEgressFromSource]] = ...) -> None:
...
class ServicePerimeterDryRunEgressPolicyEgressFromSource(dict):
    ...
    def __init__(__self__, *, access_level: Optional[_builtins.str] = ..., resource: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterDryRunEgressPolicyEgressTo(dict):
    ...
    def __init__(__self__, *, external_resources: Optional[Sequence[_builtins.str]] = ..., operations: Optional[Sequence[outputs.ServicePerimeterDryRunEgressPolicyEgressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimeterDryRunEgressPolicyEgressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimeterDryRunEgressPolicyEgressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterDryRunEgressPolicyEgressToOperationMethodSelector(dict):
    def __init__(__self__, *, method: Optional[_builtins.str] = ..., permission: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterDryRunIngressPolicyIngressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimeterDryRunIngressPolicyIngressFromSource]] = ...) -> None:
...
class ServicePerimeterDryRunIngressPolicyIngressTo(dict):
    def __init__(__self__, *, operations: Optional[Sequence[outputs.ServicePerimeterDryRunIngressPolicyIngressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimeterDryRunIngressPolicyIngressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimeterDryRunIngressPolicyIngressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterEgressPolicyEgressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., source_restriction: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimeterEgressPolicyEgressFromSource]] = ...) -> None:
...
class ServicePerimeterEgressPolicyEgressTo(dict):
    ...
    def __init__(__self__, *, external_resources: Optional[Sequence[_builtins.str]] = ..., operations: Optional[Sequence[outputs.ServicePerimeterEgressPolicyEgressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimeterEgressPolicyEgressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimeterEgressPolicyEgressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterIngressPolicyIngressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimeterIngressPolicyIngressFromSource]] = ...) -> None:
...
class ServicePerimeterIngressPolicyIngressTo(dict):
    def __init__(__self__, *, operations: Optional[Sequence[outputs.ServicePerimeterIngressPolicyIngressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimeterIngressPolicyIngressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimeterIngressPolicyIngressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterSpec(dict):
    ...
    def __init__(__self__, *, access_levels: Optional[Sequence[_builtins.str]] = ..., egress_policies: Optional[Sequence[outputs.ServicePerimeterSpecEgressPolicy]] = ..., ingress_policies: Optional[Sequence[outputs.ServicePerimeterSpecIngressPolicy]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., restricted_services: Optional[Sequence[_builtins.str]] = ..., vpc_accessible_services: Optional[outputs.ServicePerimeterSpecVpcAccessibleServices] = ...) -> None:
...
class ServicePerimeterSpecEgressPolicy(dict):
    ...
    def __init__(__self__, *, egress_from: Optional[outputs.ServicePerimeterSpecEgressPolicyEgressFrom] = ..., egress_to: Optional[outputs.ServicePerimeterSpecEgressPolicyEgressTo] = ..., title: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterSpecEgressPolicyEgressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., source_restriction: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimeterSpecEgressPolicyEgressFromSource]] = ...) -> None:
...
class ServicePerimeterSpecEgressPolicyEgressTo(dict):
    ...
    def __init__(__self__, *, external_resources: Optional[Sequence[_builtins.str]] = ..., operations: Optional[Sequence[outputs.ServicePerimeterSpecEgressPolicyEgressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimeterSpecEgressPolicyEgressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimeterSpecEgressPolicyEgressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterSpecIngressPolicy(dict):
    ...
    def __init__(__self__, *, ingress_from: Optional[outputs.ServicePerimeterSpecIngressPolicyIngressFrom] = ..., ingress_to: Optional[outputs.ServicePerimeterSpecIngressPolicyIngressTo] = ..., title: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterSpecIngressPolicyIngressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimeterSpecIngressPolicyIngressFromSource]] = ...) -> None:
...
class ServicePerimeterSpecIngressPolicyIngressTo(dict):
    def __init__(__self__, *, operations: Optional[Sequence[outputs.ServicePerimeterSpecIngressPolicyIngressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimeterSpecIngressPolicyIngressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimeterSpecIngressPolicyIngressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterSpecVpcAccessibleServices(dict):
    ...
    def __init__(__self__, *, allowed_services: Optional[Sequence[_builtins.str]] = ..., enable_restriction: Optional[_builtins.bool] = ...) -> None:
...
class ServicePerimeterStatus(dict):
    ...
    def __init__(__self__, *, access_levels: Optional[Sequence[_builtins.str]] = ..., egress_policies: Optional[Sequence[outputs.ServicePerimeterStatusEgressPolicy]] = ..., ingress_policies: Optional[Sequence[outputs.ServicePerimeterStatusIngressPolicy]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., restricted_services: Optional[Sequence[_builtins.str]] = ..., vpc_accessible_services: Optional[outputs.ServicePerimeterStatusVpcAccessibleServices] = ...) -> None:
...
class ServicePerimeterStatusEgressPolicy(dict):
    ...
    def __init__(__self__, *, egress_from: Optional[outputs.ServicePerimeterStatusEgressPolicyEgressFrom] = ..., egress_to: Optional[outputs.ServicePerimeterStatusEgressPolicyEgressTo] = ..., title: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterStatusEgressPolicyEgressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., source_restriction: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimeterStatusEgressPolicyEgressFromSource]] = ...) -> None:
...
class ServicePerimeterStatusEgressPolicyEgressTo(dict):
    ...
    def __init__(__self__, *, external_resources: Optional[Sequence[_builtins.str]] = ..., operations: Optional[Sequence[outputs.ServicePerimeterStatusEgressPolicyEgressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimeterStatusEgressPolicyEgressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimeterStatusEgressPolicyEgressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterStatusIngressPolicy(dict):
    ...
    def __init__(__self__, *, ingress_from: Optional[outputs.ServicePerimeterStatusIngressPolicyIngressFrom] = ..., ingress_to: Optional[outputs.ServicePerimeterStatusIngressPolicyIngressTo] = ..., title: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimeterStatusIngressPolicyIngressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimeterStatusIngressPolicyIngressFromSource]] = ...) -> None:
...
class ServicePerimeterStatusIngressPolicyIngressTo(dict):
    def __init__(__self__, *, operations: Optional[Sequence[outputs.ServicePerimeterStatusIngressPolicyIngressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimeterStatusIngressPolicyIngressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimeterStatusIngressPolicyIngressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimetersServicePerimeter(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, title: _builtins.str, create_time: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., perimeter_type: Optional[_builtins.str] = ..., spec: Optional[outputs.ServicePerimetersServicePerimeterSpec] = ..., status: Optional[outputs.ServicePerimetersServicePerimeterStatus] = ..., update_time: Optional[_builtins.str] = ..., use_explicit_dry_run_spec: Optional[_builtins.bool] = ...) -> None:
...
class ServicePerimetersServicePerimeterSpec(dict):
    ...
    def __init__(__self__, *, access_levels: Optional[Sequence[_builtins.str]] = ..., egress_policies: Optional[Sequence[outputs.ServicePerimetersServicePerimeterSpecEgressPolicy]] = ..., ingress_policies: Optional[Sequence[outputs.ServicePerimetersServicePerimeterSpecIngressPolicy]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., restricted_services: Optional[Sequence[_builtins.str]] = ..., vpc_accessible_services: Optional[outputs.ServicePerimetersServicePerimeterSpecVpcAccessibleServices] = ...) -> None:
...
class ServicePerimetersServicePerimeterSpecEgressPolicy(dict):
    ...
    def __init__(__self__, *, egress_from: Optional[outputs.ServicePerimetersServicePerimeterSpecEgressPolicyEgressFrom] = ..., egress_to: Optional[outputs.ServicePerimetersServicePerimeterSpecEgressPolicyEgressTo] = ..., title: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimetersServicePerimeterSpecEgressPolicyEgressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., source_restriction: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSource]] = ...) -> None:
...
class ServicePerimetersServicePerimeterSpecEgressPolicyEgressTo(dict):
    ...
    def __init__(__self__, *, external_resources: Optional[Sequence[_builtins.str]] = ..., operations: Optional[Sequence[outputs.ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimetersServicePerimeterSpecIngressPolicy(dict):
    ...
    def __init__(__self__, *, ingress_from: Optional[outputs.ServicePerimetersServicePerimeterSpecIngressPolicyIngressFrom] = ..., ingress_to: Optional[outputs.ServicePerimetersServicePerimeterSpecIngressPolicyIngressTo] = ..., title: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimetersServicePerimeterSpecIngressPolicyIngressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSource]] = ...) -> None:
...
class ServicePerimetersServicePerimeterSpecIngressPolicyIngressTo(dict):
    def __init__(__self__, *, operations: Optional[Sequence[outputs.ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimetersServicePerimeterStatus(dict):
    ...
    def __init__(__self__, *, access_levels: Optional[Sequence[_builtins.str]] = ..., egress_policies: Optional[Sequence[outputs.ServicePerimetersServicePerimeterStatusEgressPolicy]] = ..., ingress_policies: Optional[Sequence[outputs.ServicePerimetersServicePerimeterStatusIngressPolicy]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., restricted_services: Optional[Sequence[_builtins.str]] = ..., vpc_accessible_services: Optional[outputs.ServicePerimetersServicePerimeterStatusVpcAccessibleServices] = ...) -> None:
...
class ServicePerimetersServicePerimeterStatusEgressPolicy(dict):
    ...
    def __init__(__self__, *, egress_from: Optional[outputs.ServicePerimetersServicePerimeterStatusEgressPolicyEgressFrom] = ..., egress_to: Optional[outputs.ServicePerimetersServicePerimeterStatusEgressPolicyEgressTo] = ..., title: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimetersServicePerimeterStatusEgressPolicyEgressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., source_restriction: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSource]] = ...) -> None:
...
class ServicePerimetersServicePerimeterStatusEgressPolicyEgressTo(dict):
    ...
    def __init__(__self__, *, external_resources: Optional[Sequence[_builtins.str]] = ..., operations: Optional[Sequence[outputs.ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimetersServicePerimeterStatusIngressPolicy(dict):
    ...
    def __init__(__self__, *, ingress_from: Optional[outputs.ServicePerimetersServicePerimeterStatusIngressPolicyIngressFrom] = ..., ingress_to: Optional[outputs.ServicePerimetersServicePerimeterStatusIngressPolicyIngressTo] = ..., title: Optional[_builtins.str] = ...) -> None:
...
class ServicePerimetersServicePerimeterStatusIngressPolicyIngressFrom(dict):
    ...
    def __init__(__self__, *, identities: Optional[Sequence[_builtins.str]] = ..., identity_type: Optional[_builtins.str] = ..., sources: Optional[Sequence[outputs.ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSource]] = ...) -> None:
...
class ServicePerimetersServicePerimeterStatusIngressPolicyIngressTo(dict):
    def __init__(__self__, *, operations: Optional[Sequence[outputs.ServicePerimetersServicePerimeterStatusIngressPolicyIngressToOperation]] = ..., resources: Optional[Sequence[_builtins.str]] = ..., roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ServicePerimetersServicePerimeterStatusIngressPolicyIngressToOperation(dict):
    ...
    def __init__(__self__, *, method_selectors: Optional[Sequence[outputs.ServicePerimetersServicePerimeterStatusIngressPolicyIngressToOperationMethodSelector]] = ..., service_name: Optional[_builtins.str] = ...) -> None:
...
class GetSupportedServiceSupportedMethodResult(dict):
    def __init__(__self__, *, method: _builtins.str, permission: _builtins.str) -> None:
...
class GetSupportedServicesSupportedServiceResult(dict):
    def __init__(__self__, *, available_on_restricted_vip: _builtins.bool, known_limitations: _builtins.bool, name: _builtins.str, service_support_stage: _builtins.str, support_stage: _builtins.str, title: _builtins.str) -> None:
