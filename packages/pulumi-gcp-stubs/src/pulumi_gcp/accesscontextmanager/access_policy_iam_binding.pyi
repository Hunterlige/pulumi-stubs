...
class AccessPolicyIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[AccessPolicyIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[AccessPolicyIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[AccessPolicyIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class AccessPolicyIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.AccessPolicyIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
