...
class AccessPolicyIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[AccessPolicyIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[AccessPolicyIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[AccessPolicyIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class AccessPolicyIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.AccessPolicyIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
