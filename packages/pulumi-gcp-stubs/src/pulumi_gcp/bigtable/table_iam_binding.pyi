...
class TableIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[TableIamBindingConditionArgs]] = ...,
...
class TableIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[TableIamBindingConditionArgs, TableIamBindingConditionArgsDict]
            ]
        ] = ...,
        instance_name: Optional[pulumi.Input[_builtins.str]] = ...,
        members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.TableIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
