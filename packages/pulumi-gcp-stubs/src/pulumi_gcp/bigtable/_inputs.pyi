...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppProfileDataBoostIsolationReadOnlyArgs', 'AppProfileDataBoostIsolationReadOnlyArgsDict', 'AppProfileSingleClusterRoutingArgs', 'AppProfileSingleClusterRoutingArgsDict', 'AppProfileStandardIsolationArgs', 'AppProfileStandardIsolationArgsDict', 'AuthorizedViewSubsetViewArgs', 'AuthorizedViewSubsetViewArgsDict', 'AuthorizedViewSubsetViewFamilySubsetArgs', 'AuthorizedViewSubsetViewFamilySubsetArgsDict', 'GCPolicyMaxAgeArgs', 'GCPolicyMaxAgeArgsDict', 'GCPolicyMaxVersionArgs', 'GCPolicyMaxVersionArgsDict', 'InstanceClusterArgs', 'InstanceClusterArgsDict', 'InstanceClusterAutoscalingConfigArgs', 'InstanceClusterAutoscalingConfigArgsDict', 'InstanceIamBindingConditionArgs', 'InstanceIamBindingConditionArgsDict', 'InstanceIamMemberConditionArgs', 'InstanceIamMemberConditionArgsDict', 'SchemaBundleProtoSchemaArgs', 'SchemaBundleProtoSchemaArgsDict', 'TableAutomatedBackupPolicyArgs', 'TableAutomatedBackupPolicyArgsDict', 'TableColumnFamilyArgs', 'TableColumnFamilyArgsDict', 'TableIamBindingConditionArgs', 'TableIamBindingConditionArgsDict', 'TableIamMemberConditionArgs', 'TableIamMemberConditionArgsDict']
...
class AuthorizedViewSubsetViewArgs:
    def __init__(__self__, *, family_subsets: Optional[pulumi.Input[Sequence[pulumi.Input[AuthorizedViewSubsetViewFamilySubsetArgs]]]] = ..., row_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def family_subsets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AuthorizedViewSubsetViewFamilySubsetArgs]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="rowPrefixes")
    def row_prefixes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @row_prefixes.setter
    def row_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AuthorizedViewSubsetViewFamilySubsetArgs:
    def __init__(__self__, *, family_name: pulumi.Input[_builtins.str], qualifier_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., qualifiers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @family_name.setter
    def family_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="qualifierPrefixes")
    def qualifier_prefixes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @qualifier_prefixes.setter
    def qualifier_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter
    def qualifiers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @qualifiers.setter
    def qualifiers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class GCPolicyMaxAgeArgs:
    def __init__(__self__, *, days: Optional[pulumi.Input[_builtins.int]] = ..., duration: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceClusterArgs:
    def __init__(__self__, *, cluster_id: pulumi.Input[_builtins.str], autoscaling_config: Optional[pulumi.Input[InstanceClusterAutoscalingConfigArgs]] = ..., kms_key_name: Optional[pulumi.Input[_builtins.str]] = ..., node_scaling_factor: Optional[pulumi.Input[_builtins.str]] = ..., num_nodes: Optional[pulumi.Input[_builtins.int]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., storage_type: Optional[pulumi.Input[_builtins.str]] = ..., zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def autoscaling_config(self, value: Optional[pulumi.Input[InstanceClusterAutoscalingConfigArgs]]): # -> None:
        ...
    ...
    def node_scaling_factor(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstanceClusterAutoscalingConfigArgs:
    def __init__(__self__, *, cpu_target: pulumi.Input[_builtins.int], max_nodes: pulumi.Input[_builtins.int], min_nodes: pulumi.Input[_builtins.int], storage_target: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @cpu_target.setter
    def cpu_target(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def storage_target(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class SchemaBundleProtoSchemaArgs:
    def __init__(__self__, *, proto_descriptors: pulumi.Input[_builtins.str]) -> None:
    ...
    def proto_descriptors(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TableAutomatedBackupPolicyArgs:
    def __init__(__self__, *, frequency: Optional[pulumi.Input[_builtins.str]] = ..., retention_period: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TableColumnFamilyArgs:
    def __init__(__self__, *, family: pulumi.Input[_builtins.str], type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
