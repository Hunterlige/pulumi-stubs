...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppProfileDataBoostIsolationReadOnly', 'AppProfileSingleClusterRouting', 'AppProfileStandardIsolation', 'AuthorizedViewSubsetView', 'AuthorizedViewSubsetViewFamilySubset', 'GCPolicyMaxAge', 'GCPolicyMaxVersion', 'InstanceCluster', 'InstanceClusterAutoscalingConfig', 'InstanceIamBindingCondition', 'InstanceIamMemberCondition', 'SchemaBundleProtoSchema', 'TableAutomatedBackupPolicy', 'TableColumnFamily', 'TableIamBindingCondition', 'TableIamMemberCondition']
@pulumi.output_type
...
class AuthorizedViewSubsetView(dict):
    ...
    def __init__(__self__, *, family_subsets: Optional[Sequence[outputs.AuthorizedViewSubsetViewFamilySubset]] = ..., row_prefixes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AuthorizedViewSubsetViewFamilySubset(dict):
    ...
    def __init__(__self__, *, family_name: _builtins.str, qualifier_prefixes: Optional[Sequence[_builtins.str]] = ..., qualifiers: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GCPolicyMaxAge(dict):
    def __init__(__self__, *, days: Optional[_builtins.int] = ..., duration: Optional[_builtins.str] = ...) -> None:
...
class InstanceCluster(dict):
    ...
    def __init__(__self__, *, cluster_id: _builtins.str, autoscaling_config: Optional[outputs.InstanceClusterAutoscalingConfig] = ..., kms_key_name: Optional[_builtins.str] = ..., node_scaling_factor: Optional[_builtins.str] = ..., num_nodes: Optional[_builtins.int] = ..., state: Optional[_builtins.str] = ..., storage_type: Optional[_builtins.str] = ..., zone: Optional[_builtins.str] = ...) -> None:
...
class InstanceClusterAutoscalingConfig(dict):
    ...
    def __init__(__self__, *, cpu_target: _builtins.int, max_nodes: _builtins.int, min_nodes: _builtins.int, storage_target: Optional[_builtins.int] = ...) -> None:
...
class TableAutomatedBackupPolicy(dict):
    ...
    def __init__(__self__, *, frequency: Optional[_builtins.str] = ..., retention_period: Optional[_builtins.str] = ...) -> None:
...
class TableColumnFamily(dict):
    def __init__(__self__, *, family: _builtins.str, type: Optional[_builtins.str] = ...) -> None:
