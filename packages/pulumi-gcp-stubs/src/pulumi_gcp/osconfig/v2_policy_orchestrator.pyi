...
class V2PolicyOrchestratorArgs:
    def __init__(
        ...
        *,
        ...
        orchestration_scope: Optional[
            pulumi.Input[V2PolicyOrchestratorOrchestrationScopeArgs]
        ] = ...,
    ...
    def orchestrated_resource(
        self,
    ) -> pulumi.Input[V2PolicyOrchestratorOrchestratedResourceArgs]: ...
    @orchestrated_resource.setter
    def orchestrated_resource(
        self, value: pulumi.Input[V2PolicyOrchestratorOrchestratedResourceArgs]
    ): ...
    @_builtins.property
    ...
    def orchestration_scope(
        self,
    ) -> Optional[pulumi.Input[V2PolicyOrchestratorOrchestrationScopeArgs]]: ...
    @orchestration_scope.setter
    def orchestration_scope(
        self, value: Optional[pulumi.Input[V2PolicyOrchestratorOrchestrationScopeArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _V2PolicyOrchestratorState:
    def __init__(
        ...
        *,
        ...
        orchestration_states: Optional[
            pulumi.Input[
                Sequence[pulumi.Input[V2PolicyOrchestratorOrchestrationStateArgs]]
            ]
        ] = ...,
    ...
    def orchestrated_resource(
        self,
    ) -> Optional[pulumi.Input[V2PolicyOrchestratorOrchestratedResourceArgs]]: ...
    @orchestrated_resource.setter
    def orchestrated_resource(
        self,
        value: Optional[pulumi.Input[V2PolicyOrchestratorOrchestratedResourceArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter(name="orchestrationScope")
    def orchestration_scope(
    ...
    def orchestration_states(
        ...
        pulumi.Input[Sequence[pulumi.Input[V2PolicyOrchestratorOrchestrationStateArgs]]]
    ]: ...
...
class V2PolicyOrchestrator(pulumi.CustomResource):
    ...
    def orchestrated_resource(
        self,
    ) -> pulumi.Output[outputs.V2PolicyOrchestratorOrchestratedResource]: ...
    @_builtins.property
    @pulumi.getter(name="orchestrationScope")
    def orchestration_scope(
        self,
    ) -> pulumi.Output[Optional[outputs.V2PolicyOrchestratorOrchestrationScope]]: ...
    @_builtins.property
    @pulumi.getter(name="orchestrationStates")
    def orchestration_states(
        self,
    ) -> pulumi.Output[Sequence[outputs.V2PolicyOrchestratorOrchestrationState]]: ...
    @_builtins.property
    @pulumi.getter(name="policyOrchestratorId")
