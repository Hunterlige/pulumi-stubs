...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GuestPoliciesAssignment', 'GuestPoliciesAssignmentGroupLabel', 'GuestPoliciesAssignmentOsType', 'GuestPoliciesPackage', 'GuestPoliciesPackageRepository', 'GuestPoliciesPackageRepositoryApt', 'GuestPoliciesPackageRepositoryGoo', 'GuestPoliciesPackageRepositoryYum', 'GuestPoliciesPackageRepositoryZypper', 'GuestPoliciesRecipe', 'GuestPoliciesRecipeArtifact', 'GuestPoliciesRecipeArtifactGcs', 'GuestPoliciesRecipeArtifactRemote', 'GuestPoliciesRecipeInstallStep', 'GuestPoliciesRecipeInstallStepArchiveExtraction', 'GuestPoliciesRecipeInstallStepDpkgInstallation', 'GuestPoliciesRecipeInstallStepFileCopy', 'GuestPoliciesRecipeInstallStepFileExec', 'GuestPoliciesRecipeInstallStepMsiInstallation', 'GuestPoliciesRecipeInstallStepRpmInstallation', 'GuestPoliciesRecipeInstallStepScriptRun', 'GuestPoliciesRecipeUpdateStep', 'GuestPoliciesRecipeUpdateStepArchiveExtraction', 'GuestPoliciesRecipeUpdateStepDpkgInstallation', 'GuestPoliciesRecipeUpdateStepFileCopy', 'GuestPoliciesRecipeUpdateStepFileExec', 'GuestPoliciesRecipeUpdateStepMsiInstallation', 'GuestPoliciesRecipeUpdateStepRpmInstallation', 'GuestPoliciesRecipeUpdateStepScriptRun', 'OsPolicyAssignmentInstanceFilter', 'OsPolicyAssignmentInstanceFilterExclusionLabel', 'OsPolicyAssignmentInstanceFilterInclusionLabel', 'OsPolicyAssignmentInstanceFilterInventory', 'OsPolicyAssignmentOsPolicy', 'OsPolicyAssignmentOsPolicyResourceGroup', ..., 'OsPolicyAssignmentOsPolicyResourceGroupResource', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'OsPolicyAssignmentOsPolicyResourceGroupResourcePkg', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'OsPolicyAssignmentRollout', 'OsPolicyAssignmentRolloutDisruptionBudget', 'PatchDeploymentInstanceFilter', 'PatchDeploymentInstanceFilterGroupLabel', 'PatchDeploymentOneTimeSchedule', 'PatchDeploymentPatchConfig', 'PatchDeploymentPatchConfigApt', 'PatchDeploymentPatchConfigGoo', 'PatchDeploymentPatchConfigPostStep', ..., ..., ..., ..., 'PatchDeploymentPatchConfigPreStep', ..., ..., ..., ..., 'PatchDeploymentPatchConfigWindowsUpdate', 'PatchDeploymentPatchConfigYum', 'PatchDeploymentPatchConfigZypper', 'PatchDeploymentRecurringSchedule', 'PatchDeploymentRecurringScheduleMonthly', ..., 'PatchDeploymentRecurringScheduleTimeOfDay', 'PatchDeploymentRecurringScheduleTimeZone', 'PatchDeploymentRecurringScheduleWeekly', 'PatchDeploymentRollout', 'PatchDeploymentRolloutDisruptionBudget', 'V2PolicyOrchestratorForFolderOrchestratedResource', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'V2PolicyOrchestratorForFolderOrchestrationScope', ..., ..., ..., 'V2PolicyOrchestratorForFolderOrchestrationState', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'V2PolicyOrchestratorOrchestratedResource', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'V2PolicyOrchestratorOrchestrationScope', 'V2PolicyOrchestratorOrchestrationScopeSelector', ..., ..., 'V2PolicyOrchestratorOrchestrationState', ..., ..., ..., ..., ..., ...]
@pulumi.output_type
class GuestPoliciesAssignment(dict):
    ...
    def __init__(__self__, *, group_labels: Optional[Sequence[outputs.GuestPoliciesAssignmentGroupLabel]] = ..., instance_name_prefixes: Optional[Sequence[_builtins.str]] = ..., instances: Optional[Sequence[_builtins.str]] = ..., os_types: Optional[Sequence[outputs.GuestPoliciesAssignmentOsType]] = ..., zones: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GuestPoliciesAssignmentOsType(dict):
    ...
    def __init__(__self__, *, os_architecture: Optional[_builtins.str] = ..., os_short_name: Optional[_builtins.str] = ..., os_version: Optional[_builtins.str] = ...) -> None:
...
class GuestPoliciesPackage(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, desired_state: Optional[_builtins.str] = ..., manager: Optional[_builtins.str] = ...) -> None:
...
class GuestPoliciesPackageRepository(dict):
    def __init__(__self__, *, apt: Optional[outputs.GuestPoliciesPackageRepositoryApt] = ..., goo: Optional[outputs.GuestPoliciesPackageRepositoryGoo] = ..., yum: Optional[outputs.GuestPoliciesPackageRepositoryYum] = ..., zypper: Optional[outputs.GuestPoliciesPackageRepositoryZypper] = ...) -> None:
...
class GuestPoliciesPackageRepositoryApt(dict):
    ...
    def __init__(__self__, *, components: Sequence[_builtins.str], distribution: _builtins.str, uri: _builtins.str, archive_type: Optional[_builtins.str] = ..., gpg_key: Optional[_builtins.str] = ...) -> None:
...
class GuestPoliciesPackageRepositoryYum(dict):
    ...
    def __init__(__self__, *, base_url: _builtins.str, id: _builtins.str, display_name: Optional[_builtins.str] = ..., gpg_keys: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GuestPoliciesRecipe(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, artifacts: Optional[Sequence[outputs.GuestPoliciesRecipeArtifact]] = ..., desired_state: Optional[_builtins.str] = ..., install_steps: Optional[Sequence[outputs.GuestPoliciesRecipeInstallStep]] = ..., update_steps: Optional[Sequence[outputs.GuestPoliciesRecipeUpdateStep]] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class GuestPoliciesRecipeArtifact(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.GuestPoliciesRecipeArtifactGcs] = ..., remote: Optional[outputs.GuestPoliciesRecipeArtifactRemote] = ...) -> None:
...
class GuestPoliciesRecipeArtifactRemote(dict):
    ...
    def __init__(__self__, *, check_sum: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class GuestPoliciesRecipeInstallStep(dict):
    ...
    def __init__(__self__, *, archive_extraction: Optional[outputs.GuestPoliciesRecipeInstallStepArchiveExtraction] = ..., dpkg_installation: Optional[outputs.GuestPoliciesRecipeInstallStepDpkgInstallation] = ..., file_copy: Optional[outputs.GuestPoliciesRecipeInstallStepFileCopy] = ..., file_exec: Optional[outputs.GuestPoliciesRecipeInstallStepFileExec] = ..., msi_installation: Optional[outputs.GuestPoliciesRecipeInstallStepMsiInstallation] = ..., rpm_installation: Optional[outputs.GuestPoliciesRecipeInstallStepRpmInstallation] = ..., script_run: Optional[outputs.GuestPoliciesRecipeInstallStepScriptRun] = ...) -> None:
...
class GuestPoliciesRecipeInstallStepArchiveExtraction(dict):
    ...
    def __init__(__self__, *, artifact_id: _builtins.str, type: _builtins.str, destination: Optional[_builtins.str] = ...) -> None:
...
class GuestPoliciesRecipeInstallStepFileCopy(dict):
    ...
    def __init__(__self__, *, artifact_id: _builtins.str, destination: _builtins.str, overwrite: Optional[_builtins.bool] = ..., permissions: Optional[_builtins.str] = ...) -> None:
...
class GuestPoliciesRecipeInstallStepFileExec(dict):
    ...
    def __init__(__self__, *, allowed_exit_codes: Optional[_builtins.str] = ..., args: Optional[Sequence[_builtins.str]] = ..., artifact_id: Optional[_builtins.str] = ..., local_path: Optional[_builtins.str] = ...) -> None:
...
class GuestPoliciesRecipeInstallStepMsiInstallation(dict):
    ...
    def __init__(__self__, *, artifact_id: _builtins.str, allowed_exit_codes: Optional[Sequence[_builtins.int]] = ..., flags: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GuestPoliciesRecipeInstallStepScriptRun(dict):
    ...
    def __init__(__self__, *, script: _builtins.str, allowed_exit_codes: Optional[Sequence[_builtins.int]] = ..., interpreter: Optional[_builtins.str] = ...) -> None:
...
class GuestPoliciesRecipeUpdateStep(dict):
    ...
    def __init__(__self__, *, archive_extraction: Optional[outputs.GuestPoliciesRecipeUpdateStepArchiveExtraction] = ..., dpkg_installation: Optional[outputs.GuestPoliciesRecipeUpdateStepDpkgInstallation] = ..., file_copy: Optional[outputs.GuestPoliciesRecipeUpdateStepFileCopy] = ..., file_exec: Optional[outputs.GuestPoliciesRecipeUpdateStepFileExec] = ..., msi_installation: Optional[outputs.GuestPoliciesRecipeUpdateStepMsiInstallation] = ..., rpm_installation: Optional[outputs.GuestPoliciesRecipeUpdateStepRpmInstallation] = ..., script_run: Optional[outputs.GuestPoliciesRecipeUpdateStepScriptRun] = ...) -> None:
...
class GuestPoliciesRecipeUpdateStepFileExec(dict):
    ...
    def __init__(__self__, *, allowed_exit_codes: Optional[Sequence[_builtins.int]] = ..., args: Optional[Sequence[_builtins.str]] = ..., artifact_id: Optional[_builtins.str] = ..., local_path: Optional[_builtins.str] = ...) -> None:
...
class OsPolicyAssignmentInstanceFilter(dict):
    ...
    def __init__(__self__, *, all: Optional[_builtins.bool] = ..., exclusion_labels: Optional[Sequence[outputs.OsPolicyAssignmentInstanceFilterExclusionLabel]] = ..., inclusion_labels: Optional[Sequence[outputs.OsPolicyAssignmentInstanceFilterInclusionLabel]] = ..., inventories: Optional[Sequence[outputs.OsPolicyAssignmentInstanceFilterInventory]] = ...) -> None:
...
class OsPolicyAssignmentInstanceFilterInventory(dict):
    ...
    def __init__(__self__, *, os_short_name: _builtins.str, os_version: Optional[_builtins.str] = ...) -> None:
...
class OsPolicyAssignmentOsPolicy(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, mode: _builtins.str, resource_groups: Sequence[outputs.OsPolicyAssignmentOsPolicyResourceGroup], allow_no_resource_group_match: Optional[_builtins.bool] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroup(dict):
    ...
    def __init__(__self__, *, resources: Sequence[outputs.OsPolicyAssignmentOsPolicyResourceGroupResource], inventory_filters: Optional[Sequence[outputs.OsPolicyAssignmentOsPolicyResourceGroupInventoryFilter]] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResource(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, exec_: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceExec] = ..., file: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceFile] = ..., pkg: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkg] = ..., repository: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceRepository] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExec(dict):
    def __init__(__self__, *, validate: outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidate, enforce: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforce] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforce(dict):
    ...
    def __init__(__self__, *, interpreter: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., file: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFile] = ..., output_file_path: Optional[_builtins.str] = ..., script: Optional[_builtins.str] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileRemote] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcs(dict):
    def __init__(__self__, *, bucket: _builtins.str, object: _builtins.str, generation: Optional[_builtins.int] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileRemote(dict):
    ...
    def __init__(__self__, *, uri: _builtins.str, sha256_checksum: Optional[_builtins.str] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidate(dict):
    ...
    def __init__(__self__, *, interpreter: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., file: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFile] = ..., output_file_path: Optional[_builtins.str] = ..., script: Optional[_builtins.str] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileRemote] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceFile(dict):
    def __init__(__self__, *, path: _builtins.str, state: _builtins.str, content: Optional[_builtins.str] = ..., file: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceFileFile] = ..., permissions: Optional[_builtins.str] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceFileFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemote] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkg(dict):
    ...
    def __init__(__self__, *, desired_state: _builtins.str, apt: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgApt] = ..., deb: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDeb] = ..., googet: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgGooget] = ..., msi: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsi] = ..., rpm: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpm] = ..., yum: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgYum] = ..., zypper: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgZypper] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDeb(dict):
    ...
    def __init__(__self__, *, source: outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSource, pull_deps: Optional[_builtins.bool] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceRemote] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsi(dict):
    def __init__(__self__, *, source: outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsiSource, properties: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsiSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsiSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsiSourceRemote] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpm(dict):
    ...
    def __init__(__self__, *, source: outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSource, pull_deps: Optional[_builtins.bool] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemote] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceRepository(dict):
    def __init__(__self__, *, apt: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryApt] = ..., goo: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryGoo] = ..., yum: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYum] = ..., zypper: Optional[outputs.OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryZypper] = ...) -> None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryApt(dict):
    ...
    def __init__(__self__, *, archive_type: _builtins.str, components: Sequence[_builtins.str], distribution: _builtins.str, uri: _builtins.str, gpg_key: Optional[_builtins.str] = ...) -> None:
...
class OsPolicyAssignmentRollout(dict):
    ...
    def __init__(__self__, *, disruption_budget: outputs.OsPolicyAssignmentRolloutDisruptionBudget, min_wait_duration: _builtins.str) -> None:
...
class OsPolicyAssignmentRolloutDisruptionBudget(dict):
    def __init__(__self__, *, fixed: Optional[_builtins.int] = ..., percent: Optional[_builtins.int] = ...) -> None:
...
class PatchDeploymentInstanceFilter(dict):
    ...
    def __init__(__self__, *, all: Optional[_builtins.bool] = ..., group_labels: Optional[Sequence[outputs.PatchDeploymentInstanceFilterGroupLabel]] = ..., instance_name_prefixes: Optional[Sequence[_builtins.str]] = ..., instances: Optional[Sequence[_builtins.str]] = ..., zones: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class PatchDeploymentPatchConfig(dict):
    ...
    def __init__(__self__, *, apt: Optional[outputs.PatchDeploymentPatchConfigApt] = ..., goo: Optional[outputs.PatchDeploymentPatchConfigGoo] = ..., mig_instances_allowed: Optional[_builtins.bool] = ..., post_step: Optional[outputs.PatchDeploymentPatchConfigPostStep] = ..., pre_step: Optional[outputs.PatchDeploymentPatchConfigPreStep] = ..., reboot_config: Optional[_builtins.str] = ..., skip_unpatchable_vms: Optional[_builtins.bool] = ..., windows_update: Optional[outputs.PatchDeploymentPatchConfigWindowsUpdate] = ..., yum: Optional[outputs.PatchDeploymentPatchConfigYum] = ..., zypper: Optional[outputs.PatchDeploymentPatchConfigZypper] = ...) -> None:
...
class PatchDeploymentPatchConfigApt(dict):
    ...
    def __init__(__self__, *, excludes: Optional[Sequence[_builtins.str]] = ..., exclusive_packages: Optional[Sequence[_builtins.str]] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class PatchDeploymentPatchConfigPostStep(dict):
    ...
    def __init__(__self__, *, linux_exec_step_config: Optional[outputs.PatchDeploymentPatchConfigPostStepLinuxExecStepConfig] = ..., windows_exec_step_config: Optional[outputs.PatchDeploymentPatchConfigPostStepWindowsExecStepConfig] = ...) -> None:
...
class PatchDeploymentPatchConfigPostStepLinuxExecStepConfig(dict):
    ...
    def __init__(__self__, *, allowed_success_codes: Optional[Sequence[_builtins.int]] = ..., gcs_object: Optional[outputs.PatchDeploymentPatchConfigPostStepLinuxExecStepConfigGcsObject] = ..., interpreter: Optional[_builtins.str] = ..., local_path: Optional[_builtins.str] = ...) -> None:
...
class PatchDeploymentPatchConfigPostStepLinuxExecStepConfigGcsObject(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, generation_number: _builtins.str, object: _builtins.str) -> None:
...
class PatchDeploymentPatchConfigPostStepWindowsExecStepConfig(dict):
    ...
    def __init__(__self__, *, allowed_success_codes: Optional[Sequence[_builtins.int]] = ..., gcs_object: Optional[outputs.PatchDeploymentPatchConfigPostStepWindowsExecStepConfigGcsObject] = ..., interpreter: Optional[_builtins.str] = ..., local_path: Optional[_builtins.str] = ...) -> None:
...
class PatchDeploymentPatchConfigPreStep(dict):
    ...
    def __init__(__self__, *, linux_exec_step_config: Optional[outputs.PatchDeploymentPatchConfigPreStepLinuxExecStepConfig] = ..., windows_exec_step_config: Optional[outputs.PatchDeploymentPatchConfigPreStepWindowsExecStepConfig] = ...) -> None:
...
class PatchDeploymentPatchConfigPreStepLinuxExecStepConfig(dict):
    ...
    def __init__(__self__, *, allowed_success_codes: Optional[Sequence[_builtins.int]] = ..., gcs_object: Optional[outputs.PatchDeploymentPatchConfigPreStepLinuxExecStepConfigGcsObject] = ..., interpreter: Optional[_builtins.str] = ..., local_path: Optional[_builtins.str] = ...) -> None:
...
class PatchDeploymentPatchConfigPreStepWindowsExecStepConfig(dict):
    ...
    def __init__(__self__, *, allowed_success_codes: Optional[Sequence[_builtins.int]] = ..., gcs_object: Optional[outputs.PatchDeploymentPatchConfigPreStepWindowsExecStepConfigGcsObject] = ..., interpreter: Optional[_builtins.str] = ..., local_path: Optional[_builtins.str] = ...) -> None:
...
class PatchDeploymentPatchConfigWindowsUpdate(dict):
    ...
    def __init__(__self__, *, classifications: Optional[Sequence[_builtins.str]] = ..., excludes: Optional[Sequence[_builtins.str]] = ..., exclusive_patches: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class PatchDeploymentPatchConfigYum(dict):
    ...
    def __init__(__self__, *, excludes: Optional[Sequence[_builtins.str]] = ..., exclusive_packages: Optional[Sequence[_builtins.str]] = ..., minimal: Optional[_builtins.bool] = ..., security: Optional[_builtins.bool] = ...) -> None:
...
class PatchDeploymentPatchConfigZypper(dict):
    ...
    def __init__(__self__, *, categories: Optional[Sequence[_builtins.str]] = ..., excludes: Optional[Sequence[_builtins.str]] = ..., exclusive_patches: Optional[Sequence[_builtins.str]] = ..., severities: Optional[Sequence[_builtins.str]] = ..., with_optional: Optional[_builtins.bool] = ..., with_update: Optional[_builtins.bool] = ...) -> None:
...
class PatchDeploymentRecurringSchedule(dict):
    ...
    def __init__(__self__, *, time_of_day: outputs.PatchDeploymentRecurringScheduleTimeOfDay, time_zone: outputs.PatchDeploymentRecurringScheduleTimeZone, end_time: Optional[_builtins.str] = ..., last_execute_time: Optional[_builtins.str] = ..., monthly: Optional[outputs.PatchDeploymentRecurringScheduleMonthly] = ..., next_execute_time: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ..., weekly: Optional[outputs.PatchDeploymentRecurringScheduleWeekly] = ...) -> None:
...
class PatchDeploymentRecurringScheduleMonthly(dict):
    ...
    def __init__(__self__, *, month_day: Optional[_builtins.int] = ..., week_day_of_month: Optional[outputs.PatchDeploymentRecurringScheduleMonthlyWeekDayOfMonth] = ...) -> None:
...
class PatchDeploymentRecurringScheduleMonthlyWeekDayOfMonth(dict):
    ...
    def __init__(__self__, *, day_of_week: _builtins.str, week_ordinal: _builtins.int, day_offset: Optional[_builtins.int] = ...) -> None:
...
class PatchDeploymentRollout(dict):
    ...
    def __init__(__self__, *, disruption_budget: outputs.PatchDeploymentRolloutDisruptionBudget, mode: _builtins.str) -> None:
...
class PatchDeploymentRolloutDisruptionBudget(dict):
    def __init__(__self__, *, fixed: Optional[_builtins.int] = ..., percentage: Optional[_builtins.int] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResource(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., os_policy_assignment_v1_payload: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1Payload] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1Payload(dict):
    ...
    def __init__(__self__, *, instance_filter: outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilter, os_policies: Sequence[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicy], rollout: outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadRollout, baseline: Optional[_builtins.bool] = ..., deleted: Optional[_builtins.bool] = ..., description: Optional[_builtins.str] = ..., etag: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., reconciling: Optional[_builtins.bool] = ..., revision_create_time: Optional[_builtins.str] = ..., revision_id: Optional[_builtins.str] = ..., rollout_state: Optional[_builtins.str] = ..., uid: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilter(dict):
    ...
    def __init__(__self__, *, all: Optional[_builtins.bool] = ..., exclusion_labels: Optional[Sequence[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilterExclusionLabel]] = ..., inclusion_labels: Optional[Sequence[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilterInclusionLabel]] = ..., inventories: Optional[Sequence[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilterInventory]] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicy(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, mode: _builtins.str, resource_groups: Sequence[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroup], allow_no_resource_group_match: Optional[_builtins.bool] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroup(dict):
    ...
    def __init__(__self__, *, resources: Sequence[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResource], inventory_filters: Optional[Sequence[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupInventoryFilter]] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResource(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, exec_: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExec] = ..., file: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFile] = ..., pkg: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkg] = ..., repository: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepository] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExec(dict):
    def __init__(__self__, *, validate: outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidate, enforce: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforce] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforce(dict):
    ...
    def __init__(__self__, *, interpreter: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., file: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFile] = ..., output_file_path: Optional[_builtins.str] = ..., script: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFileRemote] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidate(dict):
    ...
    def __init__(__self__, *, interpreter: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., file: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFile] = ..., output_file_path: Optional[_builtins.str] = ..., script: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFileRemote] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFile(dict):
    def __init__(__self__, *, path: _builtins.str, state: _builtins.str, content: Optional[_builtins.str] = ..., file: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFile] = ..., permissions: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFileRemote] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkg(dict):
    ...
    def __init__(__self__, *, desired_state: _builtins.str, apt: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgApt] = ..., deb: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDeb] = ..., googet: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgGooget] = ..., msi: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsi] = ..., rpm: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpm] = ..., yum: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgYum] = ..., zypper: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgZypper] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDeb(dict):
    ...
    def __init__(__self__, *, source: outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSource, pull_deps: Optional[_builtins.bool] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSourceRemote] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsi(dict):
    def __init__(__self__, *, source: outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSource, properties: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSourceRemote] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpm(dict):
    ...
    def __init__(__self__, *, source: outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSource, pull_deps: Optional[_builtins.bool] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSourceRemote] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepository(dict):
    def __init__(__self__, *, apt: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryApt] = ..., goo: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryGoo] = ..., yum: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryYum] = ..., zypper: Optional[outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryZypper] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadRollout(dict):
    ...
    def __init__(__self__, *, disruption_budget: outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadRolloutDisruptionBudget, min_wait_duration: _builtins.str) -> None:
...
class V2PolicyOrchestratorForFolderOrchestrationScope(dict):
    def __init__(__self__, *, selectors: Optional[Sequence[outputs.V2PolicyOrchestratorForFolderOrchestrationScopeSelector]] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestrationScopeSelector(dict):
    ...
    def __init__(__self__, *, location_selector: Optional[outputs.V2PolicyOrchestratorForFolderOrchestrationScopeSelectorLocationSelector] = ..., resource_hierarchy_selector: Optional[outputs.V2PolicyOrchestratorForFolderOrchestrationScopeSelectorResourceHierarchySelector] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestrationScopeSelectorLocationSelector(dict):
    ...
    def __init__(__self__, *, included_locations: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestrationScopeSelectorResourceHierarchySelector(dict):
    ...
    def __init__(__self__, *, included_folders: Optional[Sequence[_builtins.str]] = ..., included_projects: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestrationState(dict):
    ...
    def __init__(__self__, *, current_iteration_states: Optional[Sequence[outputs.V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationState]] = ..., previous_iteration_states: Optional[Sequence[outputs.V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationState]] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationState(dict):
    ...
    def __init__(__self__, *, errors: Optional[Sequence[outputs.V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateError]] = ..., failed_actions: Optional[_builtins.str] = ..., finish_time: Optional[_builtins.str] = ..., performed_actions: Optional[_builtins.str] = ..., progress: Optional[_builtins.float] = ..., rollout_resource: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateError(dict):
    def __init__(__self__, *, code: Optional[_builtins.int] = ..., details: Optional[Sequence[outputs.V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateErrorDetail]] = ..., message: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateErrorDetail(dict):
    ...
    def __init__(__self__, *, type_url: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationState(dict):
    ...
    def __init__(__self__, *, errors: Optional[Sequence[outputs.V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateError]] = ..., failed_actions: Optional[_builtins.str] = ..., finish_time: Optional[_builtins.str] = ..., performed_actions: Optional[_builtins.str] = ..., progress: Optional[_builtins.float] = ..., rollout_resource: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateError(dict):
    def __init__(__self__, *, code: Optional[_builtins.int] = ..., details: Optional[Sequence[outputs.V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateErrorDetail]] = ..., message: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResource(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., os_policy_assignment_v1_payload: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1Payload] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilter(dict):
    ...
    def __init__(__self__, *, all: Optional[_builtins.bool] = ..., exclusion_labels: Optional[Sequence[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilterExclusionLabel]] = ..., inclusion_labels: Optional[Sequence[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilterInclusionLabel]] = ..., inventories: Optional[Sequence[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilterInventory]] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicy(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, mode: _builtins.str, resource_groups: Sequence[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroup], allow_no_resource_group_match: Optional[_builtins.bool] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroup(dict):
    ...
    def __init__(__self__, *, resources: Sequence[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResource], inventory_filters: Optional[Sequence[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupInventoryFilter]] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResource(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, exec_: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExec] = ..., file: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFile] = ..., pkg: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkg] = ..., repository: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepository] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExec(dict):
    def __init__(__self__, *, validate: outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidate, enforce: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforce] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforce(dict):
    ...
    def __init__(__self__, *, interpreter: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., file: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFile] = ..., output_file_path: Optional[_builtins.str] = ..., script: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFileRemote] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidate(dict):
    ...
    def __init__(__self__, *, interpreter: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., file: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFile] = ..., output_file_path: Optional[_builtins.str] = ..., script: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFileRemote] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFile(dict):
    def __init__(__self__, *, path: _builtins.str, state: _builtins.str, content: Optional[_builtins.str] = ..., file: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFile] = ..., permissions: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFileRemote] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkg(dict):
    ...
    def __init__(__self__, *, desired_state: _builtins.str, apt: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgApt] = ..., deb: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDeb] = ..., googet: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgGooget] = ..., msi: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsi] = ..., rpm: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpm] = ..., yum: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgYum] = ..., zypper: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgZypper] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDeb(dict):
    ...
    def __init__(__self__, *, source: outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSource, pull_deps: Optional[_builtins.bool] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSourceRemote] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsi(dict):
    def __init__(__self__, *, source: outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSource, properties: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSourceRemote] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpm(dict):
    ...
    def __init__(__self__, *, source: outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSource, pull_deps: Optional[_builtins.bool] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSourceRemote] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepository(dict):
    def __init__(__self__, *, apt: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryApt] = ..., goo: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryGoo] = ..., yum: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryYum] = ..., zypper: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryZypper] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadRollout(dict):
    ...
    def __init__(__self__, *, disruption_budget: outputs.V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadRolloutDisruptionBudget, min_wait_duration: _builtins.str) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestrationScope(dict):
    def __init__(__self__, *, selectors: Optional[Sequence[outputs.V2PolicyOrchestratorForOrganizationOrchestrationScopeSelector]] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestrationScopeSelector(dict):
    ...
    def __init__(__self__, *, location_selector: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorLocationSelector] = ..., resource_hierarchy_selector: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorResourceHierarchySelector] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestrationState(dict):
    ...
    def __init__(__self__, *, current_iteration_states: Optional[Sequence[outputs.V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState]] = ..., previous_iteration_state: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationState] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState(dict):
    ...
    def __init__(__self__, *, error: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateError] = ..., failed_actions: Optional[_builtins.str] = ..., finish_time: Optional[_builtins.str] = ..., performed_actions: Optional[_builtins.str] = ..., progress: Optional[_builtins.float] = ..., rollout_resource: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateError(dict):
    def __init__(__self__, *, code: Optional[_builtins.int] = ..., details: Optional[Sequence[outputs.V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateErrorDetail]] = ..., message: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationState(dict):
    ...
    def __init__(__self__, *, error: Optional[outputs.V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateError] = ..., failed_actions: Optional[_builtins.str] = ..., finish_time: Optional[_builtins.str] = ..., performed_actions: Optional[_builtins.str] = ..., progress: Optional[_builtins.float] = ..., rollout_resource: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateError(dict):
    def __init__(__self__, *, code: Optional[_builtins.int] = ..., details: Optional[Sequence[outputs.V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateErrorDetail]] = ..., message: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResource(dict):
    ...
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., os_policy_assignment_v1_payload: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1Payload] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1Payload(dict):
    ...
    def __init__(__self__, *, instance_filter: outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilter, os_policies: Sequence[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicy], rollout: outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadRollout, baseline: Optional[_builtins.bool] = ..., deleted: Optional[_builtins.bool] = ..., description: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., reconciling: Optional[_builtins.bool] = ..., revision_create_time: Optional[_builtins.str] = ..., revision_id: Optional[_builtins.str] = ..., rollout_state: Optional[_builtins.str] = ..., uid: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilter(dict):
    ...
    def __init__(__self__, *, all: Optional[_builtins.bool] = ..., exclusion_labels: Optional[Sequence[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilterExclusionLabel]] = ..., inclusion_labels: Optional[Sequence[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilterInclusionLabel]] = ..., inventories: Optional[Sequence[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilterInventory]] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicy(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, mode: _builtins.str, resource_groups: Sequence[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroup], allow_no_resource_group_match: Optional[_builtins.bool] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroup(dict):
    ...
    def __init__(__self__, *, resources: Sequence[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResource], inventory_filters: Optional[Sequence[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupInventoryFilter]] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResource(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, exec_: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExec] = ..., file: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFile] = ..., pkg: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkg] = ..., repository: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepository] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExec(dict):
    def __init__(__self__, *, validate: outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidate, enforce: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforce] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforce(dict):
    ...
    def __init__(__self__, *, interpreter: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., file: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFile] = ..., output_file_path: Optional[_builtins.str] = ..., script: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFileRemote] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidate(dict):
    ...
    def __init__(__self__, *, interpreter: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., file: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFile] = ..., output_file_path: Optional[_builtins.str] = ..., script: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecValidateFileRemote] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFile(dict):
    def __init__(__self__, *, path: _builtins.str, state: _builtins.str, content: Optional[_builtins.str] = ..., file: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFile] = ..., permissions: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFile(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFileGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFileFileRemote] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkg(dict):
    ...
    def __init__(__self__, *, desired_state: _builtins.str, apt: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgApt] = ..., deb: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDeb] = ..., googet: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgGooget] = ..., msi: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsi] = ..., rpm: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpm] = ..., yum: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgYum] = ..., zypper: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgZypper] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDeb(dict):
    ...
    def __init__(__self__, *, source: outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSource, pull_deps: Optional[_builtins.bool] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgDebSourceRemote] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsi(dict):
    def __init__(__self__, *, source: outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSource, properties: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgMsiSourceRemote] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpm(dict):
    ...
    def __init__(__self__, *, source: outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSource, pull_deps: Optional[_builtins.bool] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSource(dict):
    ...
    def __init__(__self__, *, allow_insecure: Optional[_builtins.bool] = ..., gcs: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSourceGcs] = ..., local_path: Optional[_builtins.str] = ..., remote: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgRpmSourceRemote] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepository(dict):
    def __init__(__self__, *, apt: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryApt] = ..., goo: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryGoo] = ..., yum: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryYum] = ..., zypper: Optional[outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryZypper] = ...) -> None:
...
class V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadRollout(dict):
    ...
    def __init__(__self__, *, disruption_budget: outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1PayloadRolloutDisruptionBudget, min_wait_duration: _builtins.str) -> None:
...
class V2PolicyOrchestratorOrchestrationScope(dict):
    def __init__(__self__, *, selectors: Optional[Sequence[outputs.V2PolicyOrchestratorOrchestrationScopeSelector]] = ...) -> None:
...
class V2PolicyOrchestratorOrchestrationScopeSelector(dict):
    ...
    def __init__(__self__, *, location_selector: Optional[outputs.V2PolicyOrchestratorOrchestrationScopeSelectorLocationSelector] = ..., resource_hierarchy_selector: Optional[outputs.V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelector] = ...) -> None:
...
class V2PolicyOrchestratorOrchestrationState(dict):
    ...
    def __init__(__self__, *, current_iteration_states: Optional[Sequence[outputs.V2PolicyOrchestratorOrchestrationStateCurrentIterationState]] = ..., previous_iteration_state: Optional[outputs.V2PolicyOrchestratorOrchestrationStatePreviousIterationState] = ...) -> None:
...
class V2PolicyOrchestratorOrchestrationStateCurrentIterationState(dict):
    ...
    def __init__(__self__, *, error: Optional[outputs.V2PolicyOrchestratorOrchestrationStateCurrentIterationStateError] = ..., failed_actions: Optional[_builtins.str] = ..., finish_time: Optional[_builtins.str] = ..., performed_actions: Optional[_builtins.str] = ..., progress: Optional[_builtins.float] = ..., rollout_resource: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorOrchestrationStateCurrentIterationStateError(dict):
    def __init__(__self__, *, code: Optional[_builtins.int] = ..., details: Optional[Sequence[outputs.V2PolicyOrchestratorOrchestrationStateCurrentIterationStateErrorDetail]] = ..., message: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorOrchestrationStatePreviousIterationState(dict):
    ...
    def __init__(__self__, *, error: Optional[outputs.V2PolicyOrchestratorOrchestrationStatePreviousIterationStateError] = ..., failed_actions: Optional[_builtins.str] = ..., finish_time: Optional[_builtins.str] = ..., performed_actions: Optional[_builtins.str] = ..., progress: Optional[_builtins.float] = ..., rollout_resource: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class V2PolicyOrchestratorOrchestrationStatePreviousIterationStateError(dict):
    def __init__(__self__, *, code: Optional[_builtins.int] = ..., details: Optional[Sequence[outputs.V2PolicyOrchestratorOrchestrationStatePreviousIterationStateErrorDetail]] = ..., message: Optional[_builtins.str] = ...) -> None:
