...
class RuntimeIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[RuntimeIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[RuntimeIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class RuntimeIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    RuntimeIamBindingConditionArgs, RuntimeIamBindingConditionArgsDict
                ]
            ]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.RuntimeIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
