...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EnvironmentContainerImageArgs', 'EnvironmentContainerImageArgsDict', 'EnvironmentVmImageArgs', 'EnvironmentVmImageArgsDict', 'InstanceAcceleratorConfigArgs', 'InstanceAcceleratorConfigArgsDict', 'InstanceContainerImageArgs', 'InstanceContainerImageArgsDict', 'InstanceIamBindingConditionArgs', 'InstanceIamBindingConditionArgsDict', 'InstanceIamMemberConditionArgs', 'InstanceIamMemberConditionArgsDict', 'InstanceReservationAffinityArgs', 'InstanceReservationAffinityArgsDict', 'InstanceShieldedInstanceConfigArgs', 'InstanceShieldedInstanceConfigArgsDict', 'InstanceVmImageArgs', 'InstanceVmImageArgsDict', 'RuntimeAccessConfigArgs', 'RuntimeAccessConfigArgsDict', 'RuntimeIamBindingConditionArgs', 'RuntimeIamBindingConditionArgsDict', 'RuntimeIamMemberConditionArgs', 'RuntimeIamMemberConditionArgsDict', 'RuntimeMetricArgs', 'RuntimeMetricArgsDict', 'RuntimeSoftwareConfigArgs', 'RuntimeSoftwareConfigArgsDict', 'RuntimeSoftwareConfigKernelArgs', 'RuntimeSoftwareConfigKernelArgsDict', 'RuntimeVirtualMachineArgs', 'RuntimeVirtualMachineArgsDict', 'RuntimeVirtualMachineVirtualMachineConfigArgs', 'RuntimeVirtualMachineVirtualMachineConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ...]
...
class EnvironmentContainerImageArgs:
    def __init__(__self__, *, repository: pulumi.Input[_builtins.str], tag: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EnvironmentVmImageArgs:
    def __init__(__self__, *, project: pulumi.Input[_builtins.str], image_family: Optional[pulumi.Input[_builtins.str]] = ..., image_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @image_family.setter
    def image_family(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstanceAcceleratorConfigArgs:
    def __init__(__self__, *, core_count: pulumi.Input[_builtins.int], type: pulumi.Input[_builtins.str]) -> None:
...
class RuntimeAccessConfigArgs:
    def __init__(__self__, *, access_type: Optional[pulumi.Input[_builtins.str]] = ..., proxy_uri: Optional[pulumi.Input[_builtins.str]] = ..., runtime_owner: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def runtime_owner(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RuntimeMetricArgs:
    def __init__(__self__, *, system_metrics: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def system_metrics(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RuntimeSoftwareConfigArgs:
    def __init__(__self__, *, custom_gpu_driver_path: Optional[pulumi.Input[_builtins.str]] = ..., enable_health_monitoring: Optional[pulumi.Input[_builtins.bool]] = ..., idle_shutdown: Optional[pulumi.Input[_builtins.bool]] = ..., idle_shutdown_timeout: Optional[pulumi.Input[_builtins.int]] = ..., install_gpu_driver: Optional[pulumi.Input[_builtins.bool]] = ..., kernels: Optional[pulumi.Input[Sequence[pulumi.Input[RuntimeSoftwareConfigKernelArgs]]]] = ..., notebook_upgrade_schedule: Optional[pulumi.Input[_builtins.str]] = ..., post_startup_script: Optional[pulumi.Input[_builtins.str]] = ..., post_startup_script_behavior: Optional[pulumi.Input[_builtins.str]] = ..., upgradeable: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def enable_health_monitoring(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def idle_shutdown(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def idle_shutdown_timeout(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @kernels.setter
    def kernels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuntimeSoftwareConfigKernelArgs]]]]): # -> None:
        ...
    ...
    def notebook_upgrade_schedule(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @upgradeable.setter
    def upgradeable(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class RuntimeVirtualMachineArgs:
    def __init__(__self__, *, instance_id: Optional[pulumi.Input[_builtins.str]] = ..., instance_name: Optional[pulumi.Input[_builtins.str]] = ..., virtual_machine_config: Optional[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigArgs]] = ...) -> None:
    ...
    def virtual_machine_config(self, value: Optional[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigArgs]]): # -> None:
        ...
...
class RuntimeVirtualMachineVirtualMachineConfigArgs:
    def __init__(__self__, *, data_disk: pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigDataDiskArgs], machine_type: pulumi.Input[_builtins.str], accelerator_config: Optional[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigAcceleratorConfigArgs]] = ..., container_images: Optional[pulumi.Input[Sequence[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigContainerImageArgs]]]] = ..., encryption_config: Optional[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigEncryptionConfigArgs]] = ..., guest_attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., internal_ip_only: Optional[pulumi.Input[_builtins.bool]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., nic_type: Optional[pulumi.Input[_builtins.str]] = ..., reserved_ip_range: Optional[pulumi.Input[_builtins.str]] = ..., shielded_instance_config: Optional[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs]] = ..., subnet: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_disk.setter
    def data_disk(self, value: pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigDataDiskArgs]): # -> None:
        ...
    ...
    def accelerator_config(self, value: Optional[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigAcceleratorConfigArgs]]): # -> None:
        ...
    ...
    def container_images(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigContainerImageArgs]]]]): # -> None:
        ...
    ...
    def encryption_config(self, value: Optional[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigEncryptionConfigArgs]]): # -> None:
        ...
    ...
    def guest_attributes(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def shielded_instance_config(self, value: Optional[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs]]): # -> None:
        ...
...
class RuntimeVirtualMachineVirtualMachineConfigAcceleratorConfigArgs:
    def __init__(__self__, *, core_count: Optional[pulumi.Input[_builtins.int]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RuntimeVirtualMachineVirtualMachineConfigDataDiskArgs:
    def __init__(__self__, *, auto_delete: Optional[pulumi.Input[_builtins.bool]] = ..., boot: Optional[pulumi.Input[_builtins.bool]] = ..., device_name: Optional[pulumi.Input[_builtins.str]] = ..., guest_os_features: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., index: Optional[pulumi.Input[_builtins.int]] = ..., initialize_params: Optional[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigDataDiskInitializeParamsArgs]] = ..., interface: Optional[pulumi.Input[_builtins.str]] = ..., kind: Optional[pulumi.Input[_builtins.str]] = ..., licenses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., mode: Optional[pulumi.Input[_builtins.str]] = ..., source: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def guest_os_features(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def initialize_params(self, value: Optional[pulumi.Input[RuntimeVirtualMachineVirtualMachineConfigDataDiskInitializeParamsArgs]]): # -> None:
        ...
...
class RuntimeVirtualMachineVirtualMachineConfigDataDiskInitializeParamsArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., disk_name: Optional[pulumi.Input[_builtins.str]] = ..., disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., disk_type: Optional[pulumi.Input[_builtins.str]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
