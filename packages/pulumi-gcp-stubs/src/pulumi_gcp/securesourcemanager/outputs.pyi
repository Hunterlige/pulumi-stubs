...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['HookPushOption', 'InstanceHostConfig', 'InstanceIamBindingCondition', 'InstanceIamMemberCondition', 'InstancePrivateConfig', 'InstanceWorkforceIdentityFederationConfig', 'RepositoryIamBindingCondition', 'RepositoryIamMemberCondition', 'RepositoryInitialConfig', 'RepositoryUri']
@pulumi.output_type
...
class InstanceHostConfig(dict):
    ...
    def __init__(__self__, *, api: Optional[_builtins.str] = ..., git_http: Optional[_builtins.str] = ..., git_ssh: Optional[_builtins.str] = ..., html: Optional[_builtins.str] = ...) -> None:
...
class InstancePrivateConfig(dict):
    ...
    def __init__(__self__, *, is_private: _builtins.bool, ca_pool: Optional[_builtins.str] = ..., http_service_attachment: Optional[_builtins.str] = ..., ssh_service_attachment: Optional[_builtins.str] = ...) -> None:
...
class RepositoryInitialConfig(dict):
    ...
    def __init__(__self__, *, default_branch: Optional[_builtins.str] = ..., gitignores: Optional[Sequence[_builtins.str]] = ..., license: Optional[_builtins.str] = ..., readme: Optional[_builtins.str] = ...) -> None:
...
class RepositoryUri(dict):
    ...
    def __init__(__self__, *, api: Optional[_builtins.str] = ..., git_https: Optional[_builtins.str] = ..., html: Optional[_builtins.str] = ...) -> None:
