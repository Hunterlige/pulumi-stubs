...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['HookPushOptionArgs', 'HookPushOptionArgsDict', 'InstanceHostConfigArgs', 'InstanceHostConfigArgsDict', 'InstanceIamBindingConditionArgs', 'InstanceIamBindingConditionArgsDict', 'InstanceIamMemberConditionArgs', 'InstanceIamMemberConditionArgsDict', 'InstancePrivateConfigArgs', 'InstancePrivateConfigArgsDict', 'InstanceWorkforceIdentityFederationConfigArgs', 'InstanceWorkforceIdentityFederationConfigArgsDict', 'RepositoryIamBindingConditionArgs', 'RepositoryIamBindingConditionArgsDict', 'RepositoryIamMemberConditionArgs', 'RepositoryIamMemberConditionArgsDict', 'RepositoryInitialConfigArgs', 'RepositoryInitialConfigArgsDict', 'RepositoryUriArgs', 'RepositoryUriArgsDict']
...
class HookPushOptionArgs:
    def __init__(__self__, *, branch_filter: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceHostConfigArgs:
    def __init__(__self__, *, api: Optional[pulumi.Input[_builtins.str]] = ..., git_http: Optional[pulumi.Input[_builtins.str]] = ..., git_ssh: Optional[pulumi.Input[_builtins.str]] = ..., html: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @git_http.setter
    def git_http(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @git_ssh.setter
    def git_ssh(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstancePrivateConfigArgs:
    def __init__(__self__, *, is_private: pulumi.Input[_builtins.bool], ca_pool: Optional[pulumi.Input[_builtins.str]] = ..., http_service_attachment: Optional[pulumi.Input[_builtins.str]] = ..., ssh_service_attachment: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @is_private.setter
    def is_private(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def http_service_attachment(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ssh_service_attachment(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RepositoryInitialConfigArgs:
    def __init__(__self__, *, default_branch: Optional[pulumi.Input[_builtins.str]] = ..., gitignores: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., license: Optional[pulumi.Input[_builtins.str]] = ..., readme: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @gitignores.setter
    def gitignores(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @license.setter
    def license(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @readme.setter
    def readme(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RepositoryUriArgs:
    def __init__(__self__, *, api: Optional[pulumi.Input[_builtins.str]] = ..., git_https: Optional[pulumi.Input[_builtins.str]] = ..., html: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @git_https.setter
    def git_https(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
