...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BareMetalAdminClusterClusterOperationsArgs', 'BareMetalAdminClusterClusterOperationsArgsDict', 'BareMetalAdminClusterControlPlaneArgs', 'BareMetalAdminClusterControlPlaneArgsDict', 'BareMetalAdminClusterControlPlaneApiServerArgArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., 'BareMetalAdminClusterFleetArgs', 'BareMetalAdminClusterFleetArgsDict', 'BareMetalAdminClusterLoadBalancerArgs', 'BareMetalAdminClusterLoadBalancerArgsDict', 'BareMetalAdminClusterLoadBalancerBgpLbConfigArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'BareMetalAdminClusterLoadBalancerPortConfigArgs', ..., 'BareMetalAdminClusterLoadBalancerVipConfigArgs', 'BareMetalAdminClusterLoadBalancerVipConfigArgsDict', 'BareMetalAdminClusterMaintenanceConfigArgs', 'BareMetalAdminClusterMaintenanceConfigArgsDict', 'BareMetalAdminClusterNetworkConfigArgs', 'BareMetalAdminClusterNetworkConfigArgsDict', ..., ..., ..., ..., 'BareMetalAdminClusterNodeAccessConfigArgs', 'BareMetalAdminClusterNodeAccessConfigArgsDict', 'BareMetalAdminClusterNodeConfigArgs', 'BareMetalAdminClusterNodeConfigArgsDict', 'BareMetalAdminClusterProxyArgs', 'BareMetalAdminClusterProxyArgsDict', 'BareMetalAdminClusterSecurityConfigArgs', 'BareMetalAdminClusterSecurityConfigArgsDict', ..., ..., ..., ..., 'BareMetalAdminClusterStatusArgs', 'BareMetalAdminClusterStatusArgsDict', 'BareMetalAdminClusterStatusConditionArgs', 'BareMetalAdminClusterStatusConditionArgsDict', 'BareMetalAdminClusterStorageArgs', 'BareMetalAdminClusterStorageArgsDict', ..., ..., 'BareMetalAdminClusterStorageLvpShareConfigArgs', 'BareMetalAdminClusterStorageLvpShareConfigArgsDict', ..., ..., 'BareMetalAdminClusterValidationCheckArgs', 'BareMetalAdminClusterValidationCheckArgsDict', 'BareMetalAdminClusterValidationCheckStatusArgs', 'BareMetalAdminClusterValidationCheckStatusArgsDict', ..., ..., 'BareMetalClusterBinaryAuthorizationArgs', 'BareMetalClusterBinaryAuthorizationArgsDict', 'BareMetalClusterClusterOperationsArgs', 'BareMetalClusterClusterOperationsArgsDict', 'BareMetalClusterControlPlaneArgs', 'BareMetalClusterControlPlaneArgsDict', 'BareMetalClusterControlPlaneApiServerArgArgs', 'BareMetalClusterControlPlaneApiServerArgArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'BareMetalClusterFleetArgs', 'BareMetalClusterFleetArgsDict', 'BareMetalClusterLoadBalancerArgs', 'BareMetalClusterLoadBalancerArgsDict', 'BareMetalClusterLoadBalancerBgpLbConfigArgs', 'BareMetalClusterLoadBalancerBgpLbConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'BareMetalClusterLoadBalancerManualLbConfigArgs', 'BareMetalClusterLoadBalancerManualLbConfigArgsDict', 'BareMetalClusterLoadBalancerMetalLbConfigArgs', 'BareMetalClusterLoadBalancerMetalLbConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'BareMetalClusterLoadBalancerPortConfigArgs', 'BareMetalClusterLoadBalancerPortConfigArgsDict', 'BareMetalClusterLoadBalancerVipConfigArgs', 'BareMetalClusterLoadBalancerVipConfigArgsDict', 'BareMetalClusterMaintenanceConfigArgs', 'BareMetalClusterMaintenanceConfigArgsDict', 'BareMetalClusterNetworkConfigArgs', 'BareMetalClusterNetworkConfigArgsDict', 'BareMetalClusterNetworkConfigIslandModeCidrArgs', ..., ..., ..., 'BareMetalClusterNetworkConfigSrIovConfigArgs', 'BareMetalClusterNetworkConfigSrIovConfigArgsDict', 'BareMetalClusterNodeAccessConfigArgs', 'BareMetalClusterNodeAccessConfigArgsDict', 'BareMetalClusterNodeConfigArgs', 'BareMetalClusterNodeConfigArgsDict', 'BareMetalClusterOsEnvironmentConfigArgs', 'BareMetalClusterOsEnvironmentConfigArgsDict', 'BareMetalClusterProxyArgs', 'BareMetalClusterProxyArgsDict', 'BareMetalClusterSecurityConfigArgs', 'BareMetalClusterSecurityConfigArgsDict', 'BareMetalClusterSecurityConfigAuthorizationArgs', ..., ..., ..., 'BareMetalClusterStatusArgs', 'BareMetalClusterStatusArgsDict', 'BareMetalClusterStatusConditionArgs', 'BareMetalClusterStatusConditionArgsDict', 'BareMetalClusterStorageArgs', 'BareMetalClusterStorageArgsDict', 'BareMetalClusterStorageLvpNodeMountsConfigArgs', 'BareMetalClusterStorageLvpNodeMountsConfigArgsDict', 'BareMetalClusterStorageLvpShareConfigArgs', 'BareMetalClusterStorageLvpShareConfigArgsDict', 'BareMetalClusterStorageLvpShareConfigLvpConfigArgs', ..., 'BareMetalClusterUpgradePolicyArgs', 'BareMetalClusterUpgradePolicyArgsDict', 'BareMetalClusterValidationCheckArgs', 'BareMetalClusterValidationCheckArgsDict', 'BareMetalClusterValidationCheckStatusArgs', 'BareMetalClusterValidationCheckStatusArgsDict', 'BareMetalClusterValidationCheckStatusResultArgs', ..., 'BareMetalNodePoolNodePoolConfigArgs', 'BareMetalNodePoolNodePoolConfigArgsDict', 'BareMetalNodePoolNodePoolConfigNodeConfigArgs', 'BareMetalNodePoolNodePoolConfigNodeConfigArgsDict', 'BareMetalNodePoolNodePoolConfigTaintArgs', 'BareMetalNodePoolNodePoolConfigTaintArgsDict', 'BareMetalNodePoolStatusArgs', 'BareMetalNodePoolStatusArgsDict', 'BareMetalNodePoolStatusConditionArgs', 'BareMetalNodePoolStatusConditionArgsDict', 'VMwareClusterAntiAffinityGroupsArgs', 'VMwareClusterAntiAffinityGroupsArgsDict', 'VMwareClusterAuthorizationArgs', 'VMwareClusterAuthorizationArgsDict', 'VMwareClusterAuthorizationAdminUserArgs', 'VMwareClusterAuthorizationAdminUserArgsDict', 'VMwareClusterAutoRepairConfigArgs', 'VMwareClusterAutoRepairConfigArgsDict', 'VMwareClusterControlPlaneNodeArgs', 'VMwareClusterControlPlaneNodeArgsDict', 'VMwareClusterControlPlaneNodeAutoResizeConfigArgs', ..., 'VMwareClusterControlPlaneNodeVsphereConfigArgs', 'VMwareClusterControlPlaneNodeVsphereConfigArgsDict', 'VMwareClusterDataplaneV2Args', 'VMwareClusterDataplaneV2ArgsDict', 'VMwareClusterFleetArgs', 'VMwareClusterFleetArgsDict', 'VMwareClusterLoadBalancerArgs', 'VMwareClusterLoadBalancerArgsDict', 'VMwareClusterLoadBalancerF5ConfigArgs', 'VMwareClusterLoadBalancerF5ConfigArgsDict', 'VMwareClusterLoadBalancerManualLbConfigArgs', 'VMwareClusterLoadBalancerManualLbConfigArgsDict', 'VMwareClusterLoadBalancerMetalLbConfigArgs', 'VMwareClusterLoadBalancerMetalLbConfigArgsDict', ..., ..., 'VMwareClusterLoadBalancerVipConfigArgs', 'VMwareClusterLoadBalancerVipConfigArgsDict', 'VMwareClusterNetworkConfigArgs', 'VMwareClusterNetworkConfigArgsDict', 'VMwareClusterNetworkConfigControlPlaneV2ConfigArgs', ..., ..., ..., ..., ..., 'VMwareClusterNetworkConfigDhcpIpConfigArgs', 'VMwareClusterNetworkConfigDhcpIpConfigArgsDict', 'VMwareClusterNetworkConfigHostConfigArgs', 'VMwareClusterNetworkConfigHostConfigArgsDict', 'VMwareClusterNetworkConfigStaticIpConfigArgs', 'VMwareClusterNetworkConfigStaticIpConfigArgsDict', ..., ..., ..., ..., 'VMwareClusterStatusArgs', 'VMwareClusterStatusArgsDict', 'VMwareClusterStatusConditionArgs', 'VMwareClusterStatusConditionArgsDict', 'VMwareClusterStorageArgs', 'VMwareClusterStorageArgsDict', 'VMwareClusterUpgradePolicyArgs', 'VMwareClusterUpgradePolicyArgsDict', 'VMwareClusterValidationCheckArgs', 'VMwareClusterValidationCheckArgsDict', 'VMwareClusterValidationCheckStatusArgs', 'VMwareClusterValidationCheckStatusArgsDict', 'VMwareClusterValidationCheckStatusResultArgs', 'VMwareClusterValidationCheckStatusResultArgsDict', 'VMwareClusterVcenterArgs', 'VMwareClusterVcenterArgsDict', 'VMwareNodePoolConfigArgs', 'VMwareNodePoolConfigArgsDict', 'VMwareNodePoolConfigTaintArgs', 'VMwareNodePoolConfigTaintArgsDict', 'VMwareNodePoolConfigVsphereConfigArgs', 'VMwareNodePoolConfigVsphereConfigArgsDict', 'VMwareNodePoolConfigVsphereConfigTagArgs', 'VMwareNodePoolConfigVsphereConfigTagArgsDict', 'VMwareNodePoolNodePoolAutoscalingArgs', 'VMwareNodePoolNodePoolAutoscalingArgsDict', 'VMwareNodePoolStatusArgs', 'VMwareNodePoolStatusArgsDict', 'VMwareNodePoolStatusConditionArgs', 'VMwareNodePoolStatusConditionArgsDict', 'VmwareAdminClusterAddonNodeArgs', 'VmwareAdminClusterAddonNodeArgsDict', 'VmwareAdminClusterAddonNodeAutoResizeConfigArgs', ..., 'VmwareAdminClusterAntiAffinityGroupsArgs', 'VmwareAdminClusterAntiAffinityGroupsArgsDict', 'VmwareAdminClusterAuthorizationArgs', 'VmwareAdminClusterAuthorizationArgsDict', 'VmwareAdminClusterAuthorizationViewerUserArgs', 'VmwareAdminClusterAuthorizationViewerUserArgsDict', 'VmwareAdminClusterAutoRepairConfigArgs', 'VmwareAdminClusterAutoRepairConfigArgsDict', 'VmwareAdminClusterControlPlaneNodeArgs', 'VmwareAdminClusterControlPlaneNodeArgsDict', 'VmwareAdminClusterFleetArgs', 'VmwareAdminClusterFleetArgsDict', 'VmwareAdminClusterLoadBalancerArgs', 'VmwareAdminClusterLoadBalancerArgsDict', 'VmwareAdminClusterLoadBalancerF5ConfigArgs', 'VmwareAdminClusterLoadBalancerF5ConfigArgsDict', 'VmwareAdminClusterLoadBalancerManualLbConfigArgs', ..., 'VmwareAdminClusterLoadBalancerMetalLbConfigArgs', ..., 'VmwareAdminClusterLoadBalancerVipConfigArgs', 'VmwareAdminClusterLoadBalancerVipConfigArgsDict', 'VmwareAdminClusterNetworkConfigArgs', 'VmwareAdminClusterNetworkConfigArgsDict', 'VmwareAdminClusterNetworkConfigDhcpIpConfigArgs', ..., ..., ..., ..., ..., ..., ..., 'VmwareAdminClusterNetworkConfigHostConfigArgs', 'VmwareAdminClusterNetworkConfigHostConfigArgsDict', 'VmwareAdminClusterNetworkConfigStaticIpConfigArgs', ..., ..., ..., ..., ..., 'VmwareAdminClusterPlatformConfigArgs', 'VmwareAdminClusterPlatformConfigArgsDict', 'VmwareAdminClusterPlatformConfigBundleArgs', 'VmwareAdminClusterPlatformConfigBundleArgsDict', 'VmwareAdminClusterPlatformConfigBundleStatusArgs', ..., ..., ..., 'VmwareAdminClusterPlatformConfigStatusArgs', 'VmwareAdminClusterPlatformConfigStatusArgsDict', ..., ..., 'VmwareAdminClusterPrivateRegistryConfigArgs', 'VmwareAdminClusterPrivateRegistryConfigArgsDict', 'VmwareAdminClusterProxyArgs', 'VmwareAdminClusterProxyArgsDict', 'VmwareAdminClusterStatusArgs', 'VmwareAdminClusterStatusArgsDict', 'VmwareAdminClusterStatusConditionArgs', 'VmwareAdminClusterStatusConditionArgsDict', 'VmwareAdminClusterVcenterArgs', 'VmwareAdminClusterVcenterArgsDict']
...
class BareMetalAdminClusterClusterOperationsArgs:
    def __init__(__self__, *, enable_application_logs: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def enable_application_logs(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class BareMetalAdminClusterControlPlaneArgs:
    def __init__(__self__, *, control_plane_node_pool_config: pulumi.Input[BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigArgs], api_server_args: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterControlPlaneApiServerArgArgs]]]] = ...) -> None:
    ...
    def control_plane_node_pool_config(self, value: pulumi.Input[BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigArgs]): # -> None:
        ...
    ...
    def api_server_args(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterControlPlaneApiServerArgArgs]]]]): # -> None:
        ...
...
class BareMetalAdminClusterControlPlaneApiServerArgArgs:
    def __init__(__self__, *, argument: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str]) -> None:
    ...
    @argument.setter
    def argument(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigArgs:
    def __init__(__self__, *, node_pool_config: pulumi.Input[BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigArgs]) -> None:
    ...
    def node_pool_config(self, value: pulumi.Input[BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigArgs]): # -> None:
        ...
...
class BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigArgs:
    def __init__(__self__, *, labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., node_configs: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigNodeConfigArgs]]]] = ..., operating_system: Optional[pulumi.Input[_builtins.str]] = ..., taints: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigTaintArgs]]]] = ...) -> None:
    ...
    @node_configs.setter
    def node_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigNodeConfigArgs]]]]): # -> None:
        ...
    ...
    @taints.setter
    def taints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigTaintArgs]]]]): # -> None:
        ...
...
class BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigNodeConfigArgs:
    def __init__(__self__, *, labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., node_ip: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @node_ip.setter
    def node_ip(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BareMetalAdminClusterFleetArgs:
    def __init__(__self__, *, membership: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class BareMetalAdminClusterLoadBalancerArgs:
    def __init__(__self__, *, port_config: pulumi.Input[BareMetalAdminClusterLoadBalancerPortConfigArgs], vip_config: pulumi.Input[BareMetalAdminClusterLoadBalancerVipConfigArgs], bgp_lb_config: Optional[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigArgs]] = ..., manual_lb_config: Optional[pulumi.Input[BareMetalAdminClusterLoadBalancerManualLbConfigArgs]] = ...) -> None:
    ...
    @port_config.setter
    def port_config(self, value: pulumi.Input[BareMetalAdminClusterLoadBalancerPortConfigArgs]): # -> None:
        ...
    ...
    @vip_config.setter
    def vip_config(self, value: pulumi.Input[BareMetalAdminClusterLoadBalancerVipConfigArgs]): # -> None:
        ...
    ...
    def bgp_lb_config(self, value: Optional[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigArgs]]): # -> None:
        ...
    ...
    def manual_lb_config(self, value: Optional[pulumi.Input[BareMetalAdminClusterLoadBalancerManualLbConfigArgs]]): # -> None:
        ...
...
class BareMetalAdminClusterLoadBalancerBgpLbConfigArgs:
    def __init__(__self__, *, address_pools: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigAddressPoolArgs]]]] = ..., asn: Optional[pulumi.Input[_builtins.int]] = ..., bgp_peer_configs: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigBgpPeerConfigArgs]]]] = ..., load_balancer_node_pool_config: Optional[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigArgs]] = ...) -> None:
    ...
    def address_pools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigAddressPoolArgs]]]]): # -> None:
        ...
    ...
    def bgp_peer_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigBgpPeerConfigArgs]]]]): # -> None:
        ...
    ...
    def load_balancer_node_pool_config(self, value: Optional[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigArgs]]): # -> None:
        ...
...
class BareMetalAdminClusterLoadBalancerBgpLbConfigAddressPoolArgs:
    def __init__(__self__, *, addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., avoid_buggy_ips: Optional[pulumi.Input[_builtins.bool]] = ..., manual_assign: Optional[pulumi.Input[_builtins.bool]] = ..., pool: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def avoid_buggy_ips(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def manual_assign(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class BareMetalAdminClusterLoadBalancerBgpLbConfigBgpPeerConfigArgs:
    def __init__(__self__, *, asn: Optional[pulumi.Input[_builtins.int]] = ..., control_plane_nodes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def control_plane_nodes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigArgs:
    def __init__(__self__, *, node_pool_config: Optional[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigArgs]] = ...) -> None:
    ...
    @node_pool_config.setter
    def node_pool_config(self, value: Optional[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigArgs]]): # -> None:
        ...
...
class BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigArgs:
    def __init__(__self__, *, kubelet_config: Optional[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfigArgs]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., node_configs: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigArgs]]]] = ..., operating_system: Optional[pulumi.Input[_builtins.str]] = ..., taints: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaintArgs]]]] = ...) -> None:
    ...
    def kubelet_config(self, value: Optional[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfigArgs]]): # -> None:
        ...
    ...
    @node_configs.setter
    def node_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigArgs]]]]): # -> None:
        ...
    ...
    @taints.setter
    def taints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaintArgs]]]]): # -> None:
        ...
...
class BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfigArgs:
    def __init__(__self__, *, registry_burst: Optional[pulumi.Input[_builtins.int]] = ..., registry_pull_qps: Optional[pulumi.Input[_builtins.int]] = ..., serialize_image_pulls_disabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def registry_burst(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def registry_pull_qps(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def serialize_image_pulls_disabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class BareMetalAdminClusterLoadBalancerPortConfigArgs:
    def __init__(__self__, *, control_plane_load_balancer_port: pulumi.Input[_builtins.int]) -> None:
    ...
    def control_plane_load_balancer_port(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class BareMetalAdminClusterLoadBalancerVipConfigArgs:
    def __init__(__self__, *, control_plane_vip: pulumi.Input[_builtins.str]) -> None:
    ...
    def control_plane_vip(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BareMetalAdminClusterMaintenanceConfigArgs:
    def __init__(__self__, *, maintenance_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def maintenance_address_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class BareMetalAdminClusterNetworkConfigArgs:
    def __init__(__self__, *, advanced_networking: Optional[pulumi.Input[_builtins.bool]] = ..., island_mode_cidr: Optional[pulumi.Input[BareMetalAdminClusterNetworkConfigIslandModeCidrArgs]] = ..., multiple_network_interfaces_config: Optional[pulumi.Input[BareMetalAdminClusterNetworkConfigMultipleNetworkInterfacesConfigArgs]] = ...) -> None:
    ...
    def advanced_networking(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def island_mode_cidr(self, value: Optional[pulumi.Input[BareMetalAdminClusterNetworkConfigIslandModeCidrArgs]]): # -> None:
        ...
    ...
    def multiple_network_interfaces_config(self, value: Optional[pulumi.Input[BareMetalAdminClusterNetworkConfigMultipleNetworkInterfacesConfigArgs]]): # -> None:
        ...
...
class BareMetalAdminClusterNetworkConfigIslandModeCidrArgs:
    def __init__(__self__, *, pod_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], service_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
...
class BareMetalAdminClusterNodeAccessConfigArgs:
    def __init__(__self__, *, login_user: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @login_user.setter
    def login_user(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BareMetalAdminClusterNodeConfigArgs:
    def __init__(__self__, *, max_pods_per_node: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class BareMetalAdminClusterProxyArgs:
    def __init__(__self__, *, uri: pulumi.Input[_builtins.str], no_proxies: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @no_proxies.setter
    def no_proxies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class BareMetalAdminClusterSecurityConfigArgs:
    def __init__(__self__, *, authorization: Optional[pulumi.Input[BareMetalAdminClusterSecurityConfigAuthorizationArgs]] = ...) -> None:
    ...
    def authorization(self, value: Optional[pulumi.Input[BareMetalAdminClusterSecurityConfigAuthorizationArgs]]): # -> None:
        ...
...
class BareMetalAdminClusterSecurityConfigAuthorizationArgs:
    def __init__(__self__, *, admin_users: pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterSecurityConfigAuthorizationAdminUserArgs]]]) -> None:
    ...
    @admin_users.setter
    def admin_users(self, value: pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterSecurityConfigAuthorizationAdminUserArgs]]]): # -> None:
        ...
...
class BareMetalAdminClusterStatusArgs:
    def __init__(__self__, *, conditions: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterStatusConditionArgs]]]] = ..., error_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterStatusConditionArgs]]]]): # -> None:
        ...
...
class BareMetalAdminClusterStatusConditionArgs:
    def __init__(__self__, *, last_transition_time: Optional[pulumi.Input[_builtins.str]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ..., reason: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class BareMetalAdminClusterStorageArgs:
    def __init__(__self__, *, lvp_node_mounts_config: pulumi.Input[BareMetalAdminClusterStorageLvpNodeMountsConfigArgs], lvp_share_config: pulumi.Input[BareMetalAdminClusterStorageLvpShareConfigArgs]) -> None:
    ...
    def lvp_node_mounts_config(self, value: pulumi.Input[BareMetalAdminClusterStorageLvpNodeMountsConfigArgs]): # -> None:
        ...
    ...
    def lvp_share_config(self, value: pulumi.Input[BareMetalAdminClusterStorageLvpShareConfigArgs]): # -> None:
        ...
...
class BareMetalAdminClusterStorageLvpNodeMountsConfigArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], storage_class: pulumi.Input[_builtins.str]) -> None:
...
class BareMetalAdminClusterStorageLvpShareConfigArgs:
    def __init__(__self__, *, lvp_config: pulumi.Input[BareMetalAdminClusterStorageLvpShareConfigLvpConfigArgs], shared_path_pv_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @lvp_config.setter
    def lvp_config(self, value: pulumi.Input[BareMetalAdminClusterStorageLvpShareConfigLvpConfigArgs]): # -> None:
        ...
    ...
    def shared_path_pv_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class BareMetalAdminClusterValidationCheckArgs:
    def __init__(__self__, *, options: Optional[pulumi.Input[_builtins.str]] = ..., scenario: Optional[pulumi.Input[_builtins.str]] = ..., statuses: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterValidationCheckStatusArgs]]]] = ...) -> None:
    ...
    @options.setter
    def options(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @scenario.setter
    def scenario(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @statuses.setter
    def statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterValidationCheckStatusArgs]]]]): # -> None:
        ...
...
class BareMetalAdminClusterValidationCheckStatusArgs:
    def __init__(__self__, *, results: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterValidationCheckStatusResultArgs]]]] = ...) -> None:
    ...
    @results.setter
    def results(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalAdminClusterValidationCheckStatusResultArgs]]]]): # -> None:
        ...
...
class BareMetalAdminClusterValidationCheckStatusResultArgs:
    def __init__(__self__, *, category: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., details: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[_builtins.str]] = ..., reason: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class BareMetalClusterControlPlaneArgs:
    def __init__(__self__, *, control_plane_node_pool_config: pulumi.Input[BareMetalClusterControlPlaneControlPlaneNodePoolConfigArgs], api_server_args: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterControlPlaneApiServerArgArgs]]]] = ...) -> None:
    ...
    @control_plane_node_pool_config.setter
    def control_plane_node_pool_config(self, value: pulumi.Input[BareMetalClusterControlPlaneControlPlaneNodePoolConfigArgs]): # -> None:
        ...
    ...
    @api_server_args.setter
    def api_server_args(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterControlPlaneApiServerArgArgs]]]]): # -> None:
        ...
...
class BareMetalClusterControlPlaneControlPlaneNodePoolConfigArgs:
    def __init__(__self__, *, node_pool_config: pulumi.Input[BareMetalClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigArgs]) -> None:
    ...
    @node_pool_config.setter
    def node_pool_config(self, value: pulumi.Input[BareMetalClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigArgs]): # -> None:
        ...
...
class BareMetalClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigArgs:
    def __init__(__self__, *, labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., node_configs: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigNodeConfigArgs]]]] = ..., operating_system: Optional[pulumi.Input[_builtins.str]] = ..., taints: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigTaintArgs]]]] = ...) -> None:
    ...
    @node_configs.setter
    def node_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigNodeConfigArgs]]]]): # -> None:
        ...
    ...
    @taints.setter
    def taints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigTaintArgs]]]]): # -> None:
        ...
...
class BareMetalClusterLoadBalancerArgs:
    ...
    @port_config.setter
    def port_config(self, value: pulumi.Input[BareMetalClusterLoadBalancerPortConfigArgs]): # -> None:
        ...
    ...
    @vip_config.setter
    def vip_config(self, value: pulumi.Input[BareMetalClusterLoadBalancerVipConfigArgs]): # -> None:
        ...
    ...
    @bgp_lb_config.setter
    def bgp_lb_config(self, value: Optional[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigArgs]]): # -> None:
        ...
    ...
    @manual_lb_config.setter
    def manual_lb_config(self, value: Optional[pulumi.Input[BareMetalClusterLoadBalancerManualLbConfigArgs]]): # -> None:
        ...
    ...
    def metal_lb_config(self, value: Optional[pulumi.Input[BareMetalClusterLoadBalancerMetalLbConfigArgs]]): # -> None:
        ...
...
class BareMetalClusterLoadBalancerBgpLbConfigArgs:
    def __init__(__self__, *, address_pools: pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigAddressPoolArgs]]], asn: pulumi.Input[_builtins.int], bgp_peer_configs: pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigBgpPeerConfigArgs]]], load_balancer_node_pool_config: Optional[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigArgs]] = ...) -> None:
    ...
    @address_pools.setter
    def address_pools(self, value: pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigAddressPoolArgs]]]): # -> None:
        ...
    ...
    @bgp_peer_configs.setter
    def bgp_peer_configs(self, value: pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigBgpPeerConfigArgs]]]): # -> None:
        ...
    ...
    @load_balancer_node_pool_config.setter
    def load_balancer_node_pool_config(self, value: Optional[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigArgs]]): # -> None:
        ...
...
class BareMetalClusterLoadBalancerBgpLbConfigAddressPoolArgs:
    def __init__(__self__, *, addresses: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], pool: pulumi.Input[_builtins.str], avoid_buggy_ips: Optional[pulumi.Input[_builtins.bool]] = ..., manual_assign: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class BareMetalClusterLoadBalancerBgpLbConfigBgpPeerConfigArgs:
    def __init__(__self__, *, asn: pulumi.Input[_builtins.int], ip_address: pulumi.Input[_builtins.str], control_plane_nodes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigArgs:
    def __init__(__self__, *, node_pool_config: Optional[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigArgs]] = ...) -> None:
    ...
    @node_pool_config.setter
    def node_pool_config(self, value: Optional[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigArgs]]): # -> None:
        ...
...
class BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigArgs:
    def __init__(__self__, *, kubelet_config: Optional[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfigArgs]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., node_configs: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigArgs]]]] = ..., operating_system: Optional[pulumi.Input[_builtins.str]] = ..., taints: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaintArgs]]]] = ...) -> None:
    ...
    @kubelet_config.setter
    def kubelet_config(self, value: Optional[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfigArgs]]): # -> None:
        ...
    ...
    @node_configs.setter
    def node_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigArgs]]]]): # -> None:
        ...
    ...
    @taints.setter
    def taints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaintArgs]]]]): # -> None:
        ...
...
class BareMetalClusterLoadBalancerMetalLbConfigArgs:
    def __init__(__self__, *, address_pools: pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs]]], load_balancer_node_pool_config: Optional[pulumi.Input[BareMetalClusterLoadBalancerMetalLbConfigLoadBalancerNodePoolConfigArgs]] = ...) -> None:
    ...
    @address_pools.setter
    def address_pools(self, value: pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs]]]): # -> None:
        ...
    ...
    @load_balancer_node_pool_config.setter
    def load_balancer_node_pool_config(self, value: Optional[pulumi.Input[BareMetalClusterLoadBalancerMetalLbConfigLoadBalancerNodePoolConfigArgs]]): # -> None:
        ...
...
class BareMetalClusterLoadBalancerMetalLbConfigLoadBalancerNodePoolConfigArgs:
    def __init__(__self__, *, node_pool_config: Optional[pulumi.Input[BareMetalClusterLoadBalancerMetalLbConfigLoadBalancerNodePoolConfigNodePoolConfigArgs]] = ...) -> None:
    ...
    @node_pool_config.setter
    def node_pool_config(self, value: Optional[pulumi.Input[BareMetalClusterLoadBalancerMetalLbConfigLoadBalancerNodePoolConfigNodePoolConfigArgs]]): # -> None:
        ...
...
class BareMetalClusterLoadBalancerMetalLbConfigLoadBalancerNodePoolConfigNodePoolConfigArgs:
    def __init__(__self__, *, labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., node_configs: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerMetalLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigArgs]]]] = ..., operating_system: Optional[pulumi.Input[_builtins.str]] = ..., taints: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerMetalLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaintArgs]]]] = ...) -> None:
    ...
    @node_configs.setter
    def node_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerMetalLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigArgs]]]]): # -> None:
        ...
    ...
    @taints.setter
    def taints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterLoadBalancerMetalLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaintArgs]]]]): # -> None:
        ...
...
class BareMetalClusterLoadBalancerVipConfigArgs:
    def __init__(__self__, *, control_plane_vip: pulumi.Input[_builtins.str], ingress_vip: pulumi.Input[_builtins.str]) -> None:
    ...
    @ingress_vip.setter
    def ingress_vip(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BareMetalClusterNetworkConfigArgs:
    def __init__(__self__, *, advanced_networking: Optional[pulumi.Input[_builtins.bool]] = ..., island_mode_cidr: Optional[pulumi.Input[BareMetalClusterNetworkConfigIslandModeCidrArgs]] = ..., multiple_network_interfaces_config: Optional[pulumi.Input[BareMetalClusterNetworkConfigMultipleNetworkInterfacesConfigArgs]] = ..., sr_iov_config: Optional[pulumi.Input[BareMetalClusterNetworkConfigSrIovConfigArgs]] = ...) -> None:
    ...
    @island_mode_cidr.setter
    def island_mode_cidr(self, value: Optional[pulumi.Input[BareMetalClusterNetworkConfigIslandModeCidrArgs]]): # -> None:
        ...
    ...
    @multiple_network_interfaces_config.setter
    def multiple_network_interfaces_config(self, value: Optional[pulumi.Input[BareMetalClusterNetworkConfigMultipleNetworkInterfacesConfigArgs]]): # -> None:
        ...
    ...
    def sr_iov_config(self, value: Optional[pulumi.Input[BareMetalClusterNetworkConfigSrIovConfigArgs]]): # -> None:
        ...
...
class BareMetalClusterNodeConfigArgs:
    def __init__(__self__, *, container_runtime: Optional[pulumi.Input[_builtins.str]] = ..., max_pods_per_node: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def container_runtime(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BareMetalClusterOsEnvironmentConfigArgs:
    def __init__(__self__, *, package_repo_excluded: pulumi.Input[_builtins.bool]) -> None:
    ...
    def package_repo_excluded(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class BareMetalClusterSecurityConfigArgs:
    def __init__(__self__, *, authorization: Optional[pulumi.Input[BareMetalClusterSecurityConfigAuthorizationArgs]] = ...) -> None:
    ...
    @authorization.setter
    def authorization(self, value: Optional[pulumi.Input[BareMetalClusterSecurityConfigAuthorizationArgs]]): # -> None:
        ...
...
class BareMetalClusterSecurityConfigAuthorizationArgs:
    def __init__(__self__, *, admin_users: pulumi.Input[Sequence[pulumi.Input[BareMetalClusterSecurityConfigAuthorizationAdminUserArgs]]]) -> None:
    ...
    @admin_users.setter
    def admin_users(self, value: pulumi.Input[Sequence[pulumi.Input[BareMetalClusterSecurityConfigAuthorizationAdminUserArgs]]]): # -> None:
        ...
...
class BareMetalClusterStatusArgs:
    def __init__(__self__, *, conditions: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterStatusConditionArgs]]]] = ..., error_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterStatusConditionArgs]]]]): # -> None:
        ...
...
class BareMetalClusterStorageArgs:
    def __init__(__self__, *, lvp_node_mounts_config: pulumi.Input[BareMetalClusterStorageLvpNodeMountsConfigArgs], lvp_share_config: pulumi.Input[BareMetalClusterStorageLvpShareConfigArgs]) -> None:
    ...
    @lvp_node_mounts_config.setter
    def lvp_node_mounts_config(self, value: pulumi.Input[BareMetalClusterStorageLvpNodeMountsConfigArgs]): # -> None:
        ...
    ...
    @lvp_share_config.setter
    def lvp_share_config(self, value: pulumi.Input[BareMetalClusterStorageLvpShareConfigArgs]): # -> None:
        ...
...
class BareMetalClusterStorageLvpShareConfigArgs:
    def __init__(__self__, *, lvp_config: pulumi.Input[BareMetalClusterStorageLvpShareConfigLvpConfigArgs], shared_path_pv_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @lvp_config.setter
    def lvp_config(self, value: pulumi.Input[BareMetalClusterStorageLvpShareConfigLvpConfigArgs]): # -> None:
        ...
...
class BareMetalClusterValidationCheckArgs:
    def __init__(__self__, *, options: Optional[pulumi.Input[_builtins.str]] = ..., scenario: Optional[pulumi.Input[_builtins.str]] = ..., statuses: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterValidationCheckStatusArgs]]]] = ...) -> None:
    ...
    @statuses.setter
    def statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterValidationCheckStatusArgs]]]]): # -> None:
        ...
...
class BareMetalClusterValidationCheckStatusArgs:
    def __init__(__self__, *, results: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterValidationCheckStatusResultArgs]]]] = ...) -> None:
    ...
    @results.setter
    def results(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalClusterValidationCheckStatusResultArgs]]]]): # -> None:
        ...
...
class BareMetalNodePoolNodePoolConfigArgs:
    def __init__(__self__, *, node_configs: pulumi.Input[Sequence[pulumi.Input[BareMetalNodePoolNodePoolConfigNodeConfigArgs]]], labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., operating_system: Optional[pulumi.Input[_builtins.str]] = ..., taints: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalNodePoolNodePoolConfigTaintArgs]]]] = ...) -> None:
    ...
    @node_configs.setter
    def node_configs(self, value: pulumi.Input[Sequence[pulumi.Input[BareMetalNodePoolNodePoolConfigNodeConfigArgs]]]): # -> None:
        ...
    ...
    @taints.setter
    def taints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalNodePoolNodePoolConfigTaintArgs]]]]): # -> None:
        ...
...
class BareMetalNodePoolStatusArgs:
    def __init__(__self__, *, conditions: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalNodePoolStatusConditionArgs]]]] = ..., error_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BareMetalNodePoolStatusConditionArgs]]]]): # -> None:
        ...
...
class VMwareClusterAntiAffinityGroupsArgs:
    def __init__(__self__, *, aag_config_disabled: pulumi.Input[_builtins.bool]) -> None:
    ...
    def aag_config_disabled(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class VMwareClusterAuthorizationArgs:
    def __init__(__self__, *, admin_users: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterAuthorizationAdminUserArgs]]]] = ...) -> None:
    ...
    @admin_users.setter
    def admin_users(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterAuthorizationAdminUserArgs]]]]): # -> None:
        ...
...
class VMwareClusterControlPlaneNodeArgs:
    def __init__(__self__, *, auto_resize_config: Optional[pulumi.Input[VMwareClusterControlPlaneNodeAutoResizeConfigArgs]] = ..., cpus: Optional[pulumi.Input[_builtins.int]] = ..., memory: Optional[pulumi.Input[_builtins.int]] = ..., replicas: Optional[pulumi.Input[_builtins.int]] = ..., vsphere_configs: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterControlPlaneNodeVsphereConfigArgs]]]] = ...) -> None:
    ...
    def auto_resize_config(self, value: Optional[pulumi.Input[VMwareClusterControlPlaneNodeAutoResizeConfigArgs]]): # -> None:
        ...
    ...
    @cpus.setter
    def cpus(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @memory.setter
    def memory(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def vsphere_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterControlPlaneNodeVsphereConfigArgs]]]]): # -> None:
        ...
...
class VMwareClusterControlPlaneNodeVsphereConfigArgs:
    def __init__(__self__, *, datastore: Optional[pulumi.Input[_builtins.str]] = ..., storage_policy_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @datastore.setter
    def datastore(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def storage_policy_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VMwareClusterDataplaneV2Args:
    def __init__(__self__, *, advanced_networking: Optional[pulumi.Input[_builtins.bool]] = ..., dataplane_v2_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., windows_dataplane_v2_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def dataplane_v2_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def windows_dataplane_v2_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class VMwareClusterLoadBalancerArgs:
    def __init__(__self__, *, f5_config: Optional[pulumi.Input[VMwareClusterLoadBalancerF5ConfigArgs]] = ..., manual_lb_config: Optional[pulumi.Input[VMwareClusterLoadBalancerManualLbConfigArgs]] = ..., metal_lb_config: Optional[pulumi.Input[VMwareClusterLoadBalancerMetalLbConfigArgs]] = ..., vip_config: Optional[pulumi.Input[VMwareClusterLoadBalancerVipConfigArgs]] = ...) -> None:
    ...
    @f5_config.setter
    def f5_config(self, value: Optional[pulumi.Input[VMwareClusterLoadBalancerF5ConfigArgs]]): # -> None:
        ...
    ...
    @manual_lb_config.setter
    def manual_lb_config(self, value: Optional[pulumi.Input[VMwareClusterLoadBalancerManualLbConfigArgs]]): # -> None:
        ...
    ...
    @metal_lb_config.setter
    def metal_lb_config(self, value: Optional[pulumi.Input[VMwareClusterLoadBalancerMetalLbConfigArgs]]): # -> None:
        ...
    ...
    @vip_config.setter
    def vip_config(self, value: Optional[pulumi.Input[VMwareClusterLoadBalancerVipConfigArgs]]): # -> None:
        ...
...
class VMwareClusterLoadBalancerF5ConfigArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., partition: Optional[pulumi.Input[_builtins.str]] = ..., snat_pool: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @partition.setter
    def partition(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @snat_pool.setter
    def snat_pool(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VMwareClusterLoadBalancerManualLbConfigArgs:
    def __init__(__self__, *, control_plane_node_port: Optional[pulumi.Input[_builtins.int]] = ..., ingress_http_node_port: Optional[pulumi.Input[_builtins.int]] = ..., ingress_https_node_port: Optional[pulumi.Input[_builtins.int]] = ..., konnectivity_server_node_port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def control_plane_node_port(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def ingress_http_node_port(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def ingress_https_node_port(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def konnectivity_server_node_port(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class VMwareClusterLoadBalancerMetalLbConfigArgs:
    def __init__(__self__, *, address_pools: pulumi.Input[Sequence[pulumi.Input[VMwareClusterLoadBalancerMetalLbConfigAddressPoolArgs]]]) -> None:
    ...
    @address_pools.setter
    def address_pools(self, value: pulumi.Input[Sequence[pulumi.Input[VMwareClusterLoadBalancerMetalLbConfigAddressPoolArgs]]]): # -> None:
        ...
...
class VMwareClusterLoadBalancerVipConfigArgs:
    def __init__(__self__, *, control_plane_vip: Optional[pulumi.Input[_builtins.str]] = ..., ingress_vip: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @control_plane_vip.setter
    def control_plane_vip(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @ingress_vip.setter
    def ingress_vip(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VMwareClusterNetworkConfigArgs:
    def __init__(__self__, *, pod_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], service_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], control_plane_v2_config: Optional[pulumi.Input[VMwareClusterNetworkConfigControlPlaneV2ConfigArgs]] = ..., dhcp_ip_config: Optional[pulumi.Input[VMwareClusterNetworkConfigDhcpIpConfigArgs]] = ..., host_config: Optional[pulumi.Input[VMwareClusterNetworkConfigHostConfigArgs]] = ..., static_ip_config: Optional[pulumi.Input[VMwareClusterNetworkConfigStaticIpConfigArgs]] = ..., vcenter_network: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def control_plane_v2_config(self, value: Optional[pulumi.Input[VMwareClusterNetworkConfigControlPlaneV2ConfigArgs]]): # -> None:
        ...
    ...
    def dhcp_ip_config(self, value: Optional[pulumi.Input[VMwareClusterNetworkConfigDhcpIpConfigArgs]]): # -> None:
        ...
    ...
    @host_config.setter
    def host_config(self, value: Optional[pulumi.Input[VMwareClusterNetworkConfigHostConfigArgs]]): # -> None:
        ...
    ...
    def static_ip_config(self, value: Optional[pulumi.Input[VMwareClusterNetworkConfigStaticIpConfigArgs]]): # -> None:
        ...
    ...
    def vcenter_network(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VMwareClusterNetworkConfigControlPlaneV2ConfigArgs:
    def __init__(__self__, *, control_plane_ip_block: Optional[pulumi.Input[VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockArgs]] = ...) -> None:
    ...
    def control_plane_ip_block(self, value: Optional[pulumi.Input[VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockArgs]]): # -> None:
        ...
...
class VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockArgs:
    def __init__(__self__, *, gateway: Optional[pulumi.Input[_builtins.str]] = ..., ips: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIpArgs]]]] = ..., netmask: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ips.setter
    def ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIpArgs]]]]): # -> None:
        ...
    ...
    @netmask.setter
    def netmask(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIpArgs:
    def __init__(__self__, *, hostname: Optional[pulumi.Input[_builtins.str]] = ..., ip: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ip.setter
    def ip(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VMwareClusterNetworkConfigHostConfigArgs:
    def __init__(__self__, *, dns_search_domains: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ntp_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def dns_search_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @ntp_servers.setter
    def ntp_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class VMwareClusterNetworkConfigStaticIpConfigArgs:
    def __init__(__self__, *, ip_blocks: pulumi.Input[Sequence[pulumi.Input[VMwareClusterNetworkConfigStaticIpConfigIpBlockArgs]]]) -> None:
    ...
    @ip_blocks.setter
    def ip_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[VMwareClusterNetworkConfigStaticIpConfigIpBlockArgs]]]): # -> None:
        ...
...
class VMwareClusterNetworkConfigStaticIpConfigIpBlockArgs:
    def __init__(__self__, *, gateway: pulumi.Input[_builtins.str], ips: pulumi.Input[Sequence[pulumi.Input[VMwareClusterNetworkConfigStaticIpConfigIpBlockIpArgs]]], netmask: pulumi.Input[_builtins.str]) -> None:
    ...
    @gateway.setter
    def gateway(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @ips.setter
    def ips(self, value: pulumi.Input[Sequence[pulumi.Input[VMwareClusterNetworkConfigStaticIpConfigIpBlockIpArgs]]]): # -> None:
        ...
    ...
    @netmask.setter
    def netmask(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class VMwareClusterNetworkConfigStaticIpConfigIpBlockIpArgs:
    def __init__(__self__, *, ip: pulumi.Input[_builtins.str], hostname: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VMwareClusterStatusArgs:
    def __init__(__self__, *, conditions: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterStatusConditionArgs]]]] = ..., error_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterStatusConditionArgs]]]]): # -> None:
        ...
...
class VMwareClusterStorageArgs:
    def __init__(__self__, *, vsphere_csi_disabled: pulumi.Input[_builtins.bool]) -> None:
    ...
    def vsphere_csi_disabled(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class VMwareClusterUpgradePolicyArgs:
    def __init__(__self__, *, control_plane_only: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def control_plane_only(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class VMwareClusterValidationCheckArgs:
    def __init__(__self__, *, options: Optional[pulumi.Input[_builtins.str]] = ..., scenario: Optional[pulumi.Input[_builtins.str]] = ..., statuses: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterValidationCheckStatusArgs]]]] = ...) -> None:
    ...
    @statuses.setter
    def statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterValidationCheckStatusArgs]]]]): # -> None:
        ...
...
class VMwareClusterValidationCheckStatusArgs:
    def __init__(__self__, *, results: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterValidationCheckStatusResultArgs]]]] = ...) -> None:
    ...
    @results.setter
    def results(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareClusterValidationCheckStatusResultArgs]]]]): # -> None:
        ...
...
class VMwareClusterVcenterArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., ca_cert_data: Optional[pulumi.Input[_builtins.str]] = ..., cluster: Optional[pulumi.Input[_builtins.str]] = ..., datacenter: Optional[pulumi.Input[_builtins.str]] = ..., datastore: Optional[pulumi.Input[_builtins.str]] = ..., folder: Optional[pulumi.Input[_builtins.str]] = ..., resource_pool: Optional[pulumi.Input[_builtins.str]] = ..., storage_policy_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ca_cert_data.setter
    def ca_cert_data(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @datacenter.setter
    def datacenter(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def resource_pool(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VMwareNodePoolConfigArgs:
    def __init__(__self__, *, image_type: pulumi.Input[_builtins.str], boot_disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., cpus: Optional[pulumi.Input[_builtins.int]] = ..., enable_load_balancer: Optional[pulumi.Input[_builtins.bool]] = ..., image: Optional[pulumi.Input[_builtins.str]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., memory_mb: Optional[pulumi.Input[_builtins.int]] = ..., replicas: Optional[pulumi.Input[_builtins.int]] = ..., taints: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareNodePoolConfigTaintArgs]]]] = ..., vsphere_config: Optional[pulumi.Input[VMwareNodePoolConfigVsphereConfigArgs]] = ...) -> None:
    ...
    def enable_load_balancer(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @taints.setter
    def taints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareNodePoolConfigTaintArgs]]]]): # -> None:
        ...
    ...
    def vsphere_config(self, value: Optional[pulumi.Input[VMwareNodePoolConfigVsphereConfigArgs]]): # -> None:
        ...
...
class VMwareNodePoolConfigTaintArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str], effect: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VMwareNodePoolConfigVsphereConfigArgs:
    def __init__(__self__, *, datastore: Optional[pulumi.Input[_builtins.str]] = ..., host_groups: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tags: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareNodePoolConfigVsphereConfigTagArgs]]]] = ...) -> None:
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareNodePoolConfigVsphereConfigTagArgs]]]]): # -> None:
        ...
...
class VMwareNodePoolConfigVsphereConfigTagArgs:
    def __init__(__self__, *, category: Optional[pulumi.Input[_builtins.str]] = ..., tag: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VMwareNodePoolNodePoolAutoscalingArgs:
    def __init__(__self__, *, max_replicas: pulumi.Input[_builtins.int], min_replicas: pulumi.Input[_builtins.int]) -> None:
...
class VMwareNodePoolStatusArgs:
    def __init__(__self__, *, conditions: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareNodePoolStatusConditionArgs]]]] = ..., error_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VMwareNodePoolStatusConditionArgs]]]]): # -> None:
        ...
...
class VmwareAdminClusterAddonNodeArgs:
    def __init__(__self__, *, auto_resize_config: Optional[pulumi.Input[VmwareAdminClusterAddonNodeAutoResizeConfigArgs]] = ...) -> None:
    ...
    @auto_resize_config.setter
    def auto_resize_config(self, value: Optional[pulumi.Input[VmwareAdminClusterAddonNodeAutoResizeConfigArgs]]): # -> None:
        ...
...
class VmwareAdminClusterAuthorizationArgs:
    def __init__(__self__, *, viewer_users: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterAuthorizationViewerUserArgs]]]] = ...) -> None:
    ...
    @viewer_users.setter
    def viewer_users(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterAuthorizationViewerUserArgs]]]]): # -> None:
        ...
...
class VmwareAdminClusterControlPlaneNodeArgs:
    def __init__(__self__, *, cpus: Optional[pulumi.Input[_builtins.int]] = ..., memory: Optional[pulumi.Input[_builtins.int]] = ..., replicas: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class VmwareAdminClusterLoadBalancerArgs:
    def __init__(__self__, *, vip_config: pulumi.Input[VmwareAdminClusterLoadBalancerVipConfigArgs], f5_config: Optional[pulumi.Input[VmwareAdminClusterLoadBalancerF5ConfigArgs]] = ..., manual_lb_config: Optional[pulumi.Input[VmwareAdminClusterLoadBalancerManualLbConfigArgs]] = ..., metal_lb_config: Optional[pulumi.Input[VmwareAdminClusterLoadBalancerMetalLbConfigArgs]] = ...) -> None:
    ...
    @vip_config.setter
    def vip_config(self, value: pulumi.Input[VmwareAdminClusterLoadBalancerVipConfigArgs]): # -> None:
        ...
    ...
    @f5_config.setter
    def f5_config(self, value: Optional[pulumi.Input[VmwareAdminClusterLoadBalancerF5ConfigArgs]]): # -> None:
        ...
    ...
    @manual_lb_config.setter
    def manual_lb_config(self, value: Optional[pulumi.Input[VmwareAdminClusterLoadBalancerManualLbConfigArgs]]): # -> None:
        ...
    ...
    @metal_lb_config.setter
    def metal_lb_config(self, value: Optional[pulumi.Input[VmwareAdminClusterLoadBalancerMetalLbConfigArgs]]): # -> None:
        ...
...
class VmwareAdminClusterLoadBalancerManualLbConfigArgs:
    def __init__(__self__, *, addons_node_port: Optional[pulumi.Input[_builtins.int]] = ..., control_plane_node_port: Optional[pulumi.Input[_builtins.int]] = ..., ingress_http_node_port: Optional[pulumi.Input[_builtins.int]] = ..., ingress_https_node_port: Optional[pulumi.Input[_builtins.int]] = ..., konnectivity_server_node_port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def addons_node_port(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class VmwareAdminClusterLoadBalancerVipConfigArgs:
    def __init__(__self__, *, control_plane_vip: pulumi.Input[_builtins.str], addons_vip: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @addons_vip.setter
    def addons_vip(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VmwareAdminClusterNetworkConfigArgs:
    def __init__(__self__, *, pod_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], service_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], dhcp_ip_config: Optional[pulumi.Input[VmwareAdminClusterNetworkConfigDhcpIpConfigArgs]] = ..., ha_control_plane_config: Optional[pulumi.Input[VmwareAdminClusterNetworkConfigHaControlPlaneConfigArgs]] = ..., host_config: Optional[pulumi.Input[VmwareAdminClusterNetworkConfigHostConfigArgs]] = ..., static_ip_config: Optional[pulumi.Input[VmwareAdminClusterNetworkConfigStaticIpConfigArgs]] = ..., vcenter_network: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @dhcp_ip_config.setter
    def dhcp_ip_config(self, value: Optional[pulumi.Input[VmwareAdminClusterNetworkConfigDhcpIpConfigArgs]]): # -> None:
        ...
    ...
    def ha_control_plane_config(self, value: Optional[pulumi.Input[VmwareAdminClusterNetworkConfigHaControlPlaneConfigArgs]]): # -> None:
        ...
    ...
    @host_config.setter
    def host_config(self, value: Optional[pulumi.Input[VmwareAdminClusterNetworkConfigHostConfigArgs]]): # -> None:
        ...
    ...
    @static_ip_config.setter
    def static_ip_config(self, value: Optional[pulumi.Input[VmwareAdminClusterNetworkConfigStaticIpConfigArgs]]): # -> None:
        ...
...
class VmwareAdminClusterNetworkConfigHaControlPlaneConfigArgs:
    def __init__(__self__, *, control_plane_ip_block: Optional[pulumi.Input[VmwareAdminClusterNetworkConfigHaControlPlaneConfigControlPlaneIpBlockArgs]] = ...) -> None:
    ...
    @control_plane_ip_block.setter
    def control_plane_ip_block(self, value: Optional[pulumi.Input[VmwareAdminClusterNetworkConfigHaControlPlaneConfigControlPlaneIpBlockArgs]]): # -> None:
        ...
...
class VmwareAdminClusterNetworkConfigHaControlPlaneConfigControlPlaneIpBlockArgs:
    def __init__(__self__, *, gateway: pulumi.Input[_builtins.str], ips: pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterNetworkConfigHaControlPlaneConfigControlPlaneIpBlockIpArgs]]], netmask: pulumi.Input[_builtins.str]) -> None:
    ...
    @ips.setter
    def ips(self, value: pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterNetworkConfigHaControlPlaneConfigControlPlaneIpBlockIpArgs]]]): # -> None:
        ...
...
class VmwareAdminClusterNetworkConfigStaticIpConfigArgs:
    def __init__(__self__, *, ip_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterNetworkConfigStaticIpConfigIpBlockArgs]]]] = ...) -> None:
    ...
    @ip_blocks.setter
    def ip_blocks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterNetworkConfigStaticIpConfigIpBlockArgs]]]]): # -> None:
        ...
...
class VmwareAdminClusterNetworkConfigStaticIpConfigIpBlockArgs:
    def __init__(__self__, *, gateway: pulumi.Input[_builtins.str], ips: pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterNetworkConfigStaticIpConfigIpBlockIpArgs]]], netmask: pulumi.Input[_builtins.str]) -> None:
    ...
    @ips.setter
    def ips(self, value: pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterNetworkConfigStaticIpConfigIpBlockIpArgs]]]): # -> None:
        ...
...
class VmwareAdminClusterPlatformConfigArgs:
    def __init__(__self__, *, bundles: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterPlatformConfigBundleArgs]]]] = ..., platform_version: Optional[pulumi.Input[_builtins.str]] = ..., required_platform_version: Optional[pulumi.Input[_builtins.str]] = ..., statuses: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterPlatformConfigStatusArgs]]]] = ...) -> None:
    ...
    @bundles.setter
    def bundles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterPlatformConfigBundleArgs]]]]): # -> None:
        ...
    ...
    def required_platform_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @statuses.setter
    def statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterPlatformConfigStatusArgs]]]]): # -> None:
        ...
...
class VmwareAdminClusterPlatformConfigBundleArgs:
    def __init__(__self__, *, statuses: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterPlatformConfigBundleStatusArgs]]]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @statuses.setter
    def statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterPlatformConfigBundleStatusArgs]]]]): # -> None:
        ...
...
class VmwareAdminClusterPlatformConfigBundleStatusArgs:
    def __init__(__self__, *, conditions: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterPlatformConfigBundleStatusConditionArgs]]]] = ..., error_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterPlatformConfigBundleStatusConditionArgs]]]]): # -> None:
        ...
...
class VmwareAdminClusterPlatformConfigStatusArgs:
    def __init__(__self__, *, conditions: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterPlatformConfigStatusConditionArgs]]]] = ..., error_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterPlatformConfigStatusConditionArgs]]]]): # -> None:
        ...
...
class VmwareAdminClusterPrivateRegistryConfigArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., ca_cert: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ca_cert.setter
    def ca_cert(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VmwareAdminClusterProxyArgs:
    def __init__(__self__, *, url: pulumi.Input[_builtins.str], no_proxy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @no_proxy.setter
    def no_proxy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class VmwareAdminClusterStatusArgs:
    def __init__(__self__, *, conditions: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterStatusConditionArgs]]]] = ..., error_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VmwareAdminClusterStatusConditionArgs]]]]): # -> None:
        ...
...
class VmwareAdminClusterVcenterArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., ca_cert_data: Optional[pulumi.Input[_builtins.str]] = ..., cluster: Optional[pulumi.Input[_builtins.str]] = ..., data_disk: Optional[pulumi.Input[_builtins.str]] = ..., datacenter: Optional[pulumi.Input[_builtins.str]] = ..., datastore: Optional[pulumi.Input[_builtins.str]] = ..., folder: Optional[pulumi.Input[_builtins.str]] = ..., resource_pool: Optional[pulumi.Input[_builtins.str]] = ..., storage_policy_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_disk.setter
    def data_disk(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
