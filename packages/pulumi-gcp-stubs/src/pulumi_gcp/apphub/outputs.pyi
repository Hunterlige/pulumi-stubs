...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationAttributes', 'ApplicationAttributesBusinessOwner', 'ApplicationAttributesCriticality', 'ApplicationAttributesDeveloperOwner', 'ApplicationAttributesEnvironment', 'ApplicationAttributesOperatorOwner', 'ApplicationScope', 'ServiceAttributes', 'ServiceAttributesBusinessOwner', 'ServiceAttributesCriticality', 'ServiceAttributesDeveloperOwner', 'ServiceAttributesEnvironment', 'ServiceAttributesOperatorOwner', 'ServiceServiceProperty', 'ServiceServicePropertyExtendedMetadata', 'ServiceServicePropertyExtendedMetadataValue', 'ServiceServicePropertyFunctionalType', 'ServiceServicePropertyIdentity', 'ServiceServicePropertyRegistrationType', 'ServiceServiceReference', 'WorkloadAttributes', 'WorkloadAttributesBusinessOwner', 'WorkloadAttributesCriticality', 'WorkloadAttributesDeveloperOwner', 'WorkloadAttributesEnvironment', 'WorkloadAttributesOperatorOwner', 'WorkloadWorkloadProperty', 'WorkloadWorkloadPropertyExtendedMetadata', 'WorkloadWorkloadPropertyExtendedMetadataValue', 'WorkloadWorkloadPropertyFunctionalType', 'WorkloadWorkloadPropertyIdentity', 'WorkloadWorkloadReference', 'GetApplicationAttributeResult', 'GetApplicationAttributeBusinessOwnerResult', 'GetApplicationAttributeCriticalityResult', 'GetApplicationAttributeDeveloperOwnerResult', 'GetApplicationAttributeEnvironmentResult', 'GetApplicationAttributeOperatorOwnerResult', 'GetApplicationScopeResult', 'GetDiscoveredServiceServicePropertyResult', 'GetDiscoveredServiceServiceReferenceResult', 'GetDiscoveredWorkloadWorkloadPropertyResult', 'GetDiscoveredWorkloadWorkloadReferenceResult']
@pulumi.output_type
class ApplicationAttributes(dict):
    ...
    def __init__(__self__, *, business_owners: Optional[Sequence[outputs.ApplicationAttributesBusinessOwner]] = ..., criticality: Optional[outputs.ApplicationAttributesCriticality] = ..., developer_owners: Optional[Sequence[outputs.ApplicationAttributesDeveloperOwner]] = ..., environment: Optional[outputs.ApplicationAttributesEnvironment] = ..., operator_owners: Optional[Sequence[outputs.ApplicationAttributesOperatorOwner]] = ...) -> None:
...
class ApplicationAttributesBusinessOwner(dict):
    ...
    def __init__(__self__, *, email: _builtins.str, display_name: Optional[_builtins.str] = ...) -> None:
...
class ServiceAttributes(dict):
    ...
    def __init__(__self__, *, business_owners: Optional[Sequence[outputs.ServiceAttributesBusinessOwner]] = ..., criticality: Optional[outputs.ServiceAttributesCriticality] = ..., developer_owners: Optional[Sequence[outputs.ServiceAttributesDeveloperOwner]] = ..., environment: Optional[outputs.ServiceAttributesEnvironment] = ..., operator_owners: Optional[Sequence[outputs.ServiceAttributesOperatorOwner]] = ...) -> None:
...
class ServiceServiceProperty(dict):
    ...
    def __init__(__self__, *, extended_metadatas: Optional[Sequence[outputs.ServiceServicePropertyExtendedMetadata]] = ..., functional_types: Optional[Sequence[outputs.ServiceServicePropertyFunctionalType]] = ..., gcp_project: Optional[_builtins.str] = ..., identities: Optional[Sequence[outputs.ServiceServicePropertyIdentity]] = ..., location: Optional[_builtins.str] = ..., registration_types: Optional[Sequence[outputs.ServiceServicePropertyRegistrationType]] = ..., zone: Optional[_builtins.str] = ...) -> None:
...
class ServiceServicePropertyExtendedMetadata(dict):
    def __init__(__self__, *, key: Optional[_builtins.str] = ..., values: Optional[Sequence[outputs.ServiceServicePropertyExtendedMetadataValue]] = ...) -> None:
...
class ServiceServicePropertyExtendedMetadataValue(dict):
    ...
    def __init__(__self__, *, extended_metadata_schema: Optional[_builtins.str] = ..., metadata_struct: Optional[_builtins.str] = ...) -> None:
...
class WorkloadAttributes(dict):
    ...
    def __init__(__self__, *, business_owners: Optional[Sequence[outputs.WorkloadAttributesBusinessOwner]] = ..., criticality: Optional[outputs.WorkloadAttributesCriticality] = ..., developer_owners: Optional[Sequence[outputs.WorkloadAttributesDeveloperOwner]] = ..., environment: Optional[outputs.WorkloadAttributesEnvironment] = ..., operator_owners: Optional[Sequence[outputs.WorkloadAttributesOperatorOwner]] = ...) -> None:
...
class WorkloadWorkloadProperty(dict):
    ...
    def __init__(__self__, *, extended_metadatas: Optional[Sequence[outputs.WorkloadWorkloadPropertyExtendedMetadata]] = ..., functional_types: Optional[Sequence[outputs.WorkloadWorkloadPropertyFunctionalType]] = ..., gcp_project: Optional[_builtins.str] = ..., identities: Optional[Sequence[outputs.WorkloadWorkloadPropertyIdentity]] = ..., location: Optional[_builtins.str] = ..., zone: Optional[_builtins.str] = ...) -> None:
...
class WorkloadWorkloadPropertyExtendedMetadata(dict):
    def __init__(__self__, *, key: Optional[_builtins.str] = ..., values: Optional[Sequence[outputs.WorkloadWorkloadPropertyExtendedMetadataValue]] = ...) -> None:
...
class GetApplicationAttributeResult(dict):
    def __init__(__self__, *, business_owners: Sequence[outputs.GetApplicationAttributeBusinessOwnerResult], criticalities: Sequence[outputs.GetApplicationAttributeCriticalityResult], developer_owners: Sequence[outputs.GetApplicationAttributeDeveloperOwnerResult], environments: Sequence[outputs.GetApplicationAttributeEnvironmentResult], operator_owners: Sequence[outputs.GetApplicationAttributeOperatorOwnerResult]) -> None:
...
class GetApplicationAttributeBusinessOwnerResult(dict):
    def __init__(__self__, *, display_name: _builtins.str, email: _builtins.str) -> None:
...
class GetDiscoveredServiceServicePropertyResult(dict):
    def __init__(__self__, *, gcp_project: _builtins.str, location: _builtins.str, zone: _builtins.str) -> None:
