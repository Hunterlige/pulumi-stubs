...
class ServiceArgs:
    def __init__(
        ...
        *,
        ...
        discovered_service: pulumi.Input[_builtins.str],
        location: pulumi.Input[_builtins.str],
        service_id: pulumi.Input[_builtins.str],
        attributes: Optional[pulumi.Input[ServiceAttributesArgs]] = ...,
    ...
    def discovered_service(self, value: pulumi.Input[_builtins.str]): ...
    @_builtins.property
    @pulumi.getter
...
class _ServiceState:
    def __init__(
        ...
        *,
        ...
        description: Optional[pulumi.Input[_builtins.str]] = ...,
        discovered_service: Optional[pulumi.Input[_builtins.str]] = ...,
        display_name: Optional[pulumi.Input[_builtins.str]] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
        service_id: Optional[pulumi.Input[_builtins.str]] = ...,
        service_properties: Optional[
            pulumi.Input[Sequence[pulumi.Input[ServiceServicePropertyArgs]]]
        ] = ...,
        service_references: Optional[
            pulumi.Input[Sequence[pulumi.Input[ServiceServiceReferenceArgs]]]
        ] = ...,
    ...
    @discovered_service.setter
    def discovered_service(self, value: Optional[pulumi.Input[_builtins.str]]): ...
    @_builtins.property
    @pulumi.getter(name="displayName")
    def display_name(self) -> Optional[pulumi.Input[_builtins.str]]: ...
    @display_name.setter
    ...
    def service_properties(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[ServiceServicePropertyArgs]]]]: ...
...
class Service(pulumi.CustomResource):
    ...
    def __init__(
        ...
        application_id: Optional[pulumi.Input[_builtins.str]] = ...,
        attributes: Optional[
            pulumi.Input[Union[ServiceAttributesArgs, ServiceAttributesArgsDict]]
        ] = ...,
        description: Optional[pulumi.Input[_builtins.str]] = ...,
        discovered_service: Optional[pulumi.Input[_builtins.str]] = ...,
        display_name: Optional[pulumi.Input[_builtins.str]] = ...,
        ...
        service_properties: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[
                            ServiceServicePropertyArgs, ServiceServicePropertyArgsDict
                        ]
                    ]
                ]
            ]
        ...
        service_references: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[
                            ServiceServiceReferenceArgs, ServiceServiceReferenceArgsDict
                        ]
                    ]
                ]
            ]
    ...
    def service_properties(
        self,
    ) -> pulumi.Output[Sequence[outputs.ServiceServiceProperty]]: ...
    @_builtins.property
    @pulumi.getter(name="serviceReferences")
    def service_references(
        self,
    ) -> pulumi.Output[Sequence[outputs.ServiceServiceReference]]: ...
    @_builtins.property
    @pulumi.getter
