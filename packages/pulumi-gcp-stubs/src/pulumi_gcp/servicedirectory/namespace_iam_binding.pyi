...
class NamespaceIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[NamespaceIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[NamespaceIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class NamespaceIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.NamespaceIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
