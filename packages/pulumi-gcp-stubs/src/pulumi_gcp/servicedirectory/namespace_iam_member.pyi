...
class NamespaceIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[NamespaceIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[NamespaceIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class NamespaceIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    NamespaceIamMemberConditionArgs, NamespaceIamMemberConditionArgsDict
                ]
            ]
        ] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.NamespaceIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
