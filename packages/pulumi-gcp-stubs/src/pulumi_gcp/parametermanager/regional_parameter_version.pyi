...
class RegionalParameterVersionArgs:
    def __init__(__self__, *, parameter: pulumi.Input[_builtins.str], parameter_data: pulumi.Input[_builtins.str], parameter_version_id: pulumi.Input[_builtins.str], disabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def parameter_data(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def parameter_version_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class _RegionalParameterVersionState:
    def __init__(__self__, *, create_time: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key_version: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., parameter: Optional[pulumi.Input[_builtins.str]] = ..., parameter_data: Optional[pulumi.Input[_builtins.str]] = ..., parameter_version_id: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @parameter_data.setter
    def parameter_data(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @parameter_version_id.setter
    def parameter_version_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RegionalParameterVersion(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., parameter: Optional[pulumi.Input[_builtins.str]] = ..., parameter_data: Optional[pulumi.Input[_builtins.str]] = ..., parameter_version_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: RegionalParameterVersionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key_version: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., parameter: Optional[pulumi.Input[_builtins.str]] = ..., parameter_data: Optional[pulumi.Input[_builtins.str]] = ..., parameter_version_id: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> RegionalParameterVersion:
