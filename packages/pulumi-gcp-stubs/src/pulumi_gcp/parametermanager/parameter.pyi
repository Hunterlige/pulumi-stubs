...
class _ParameterState:
    def __init__(
        ...
        *,
        ...
        policy_members: Optional[
            pulumi.Input[Sequence[pulumi.Input[ParameterPolicyMemberArgs]]]
        ] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def policy_members(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[ParameterPolicyMemberArgs]]]]: ...
...
class Parameter(pulumi.CustomResource):
    ...
    def get(
        ...
        policy_members: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[ParameterPolicyMemberArgs, ParameterPolicyMemberArgsDict]
                    ]
                ]
            ]
        ] = ...,
    ...
    def policy_members(
        self,
    ) -> pulumi.Output[Sequence[outputs.ParameterPolicyMember]]: ...
    @_builtins.property
    @pulumi.getter
