...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CodeToolsSettingEnabledTool', 'CodeToolsSettingEnabledToolConfig', 'RepositoryGroupIamBindingCondition', 'RepositoryGroupIamMemberCondition', 'RepositoryGroupRepository']
@pulumi.output_type
class CodeToolsSettingEnabledTool(dict):
    ...
    def __init__(__self__, *, handle: _builtins.str, tool: _builtins.str, account_connector: Optional[_builtins.str] = ..., configs: Optional[Sequence[outputs.CodeToolsSettingEnabledToolConfig]] = ..., uri_override: Optional[_builtins.str] = ...) -> None:
...
class RepositoryGroupRepository(dict):
    ...
    def __init__(__self__, *, branch_pattern: _builtins.str, resource: _builtins.str) -> None:
