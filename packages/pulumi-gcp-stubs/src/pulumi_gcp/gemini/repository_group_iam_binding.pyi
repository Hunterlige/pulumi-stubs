...
class RepositoryGroupIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[RepositoryGroupIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[RepositoryGroupIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[RepositoryGroupIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class RepositoryGroupIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.RepositoryGroupIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
