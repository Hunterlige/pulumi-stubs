...
class RepositoryGroupArgs:
    def __init__(
        ...
        *,
        ...
        repositories: pulumi.Input[
            Sequence[pulumi.Input[RepositoryGroupRepositoryArgs]]
        ],
    ...
    def repositories(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input[RepositoryGroupRepositoryArgs]]]: ...
    @repositories.setter
    def repositories(
        self, value: pulumi.Input[Sequence[pulumi.Input[RepositoryGroupRepositoryArgs]]]
    ): ...
    @_builtins.property
...
class _RepositoryGroupState:
    def __init__(
        __self__,
        *,
        code_repository_index: Optional[pulumi.Input[_builtins.str]] = ...,
        ...
        repository_group_id: Optional[pulumi.Input[_builtins.str]] = ...,
...
class RepositoryGroup(pulumi.CustomResource):
    ...
    def repositories(
        self,
    ) -> pulumi.Output[Sequence[outputs.RepositoryGroupRepository]]: ...
    @_builtins.property
    @pulumi.getter(name="repositoryGroupId")
