...
class CodeToolsSettingArgs:
    def __init__(
        ...
        *,
        ...
        enabled_tools: pulumi.Input[
            Sequence[pulumi.Input[CodeToolsSettingEnabledToolArgs]]
        ],
    ...
    def enabled_tools(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input[CodeToolsSettingEnabledToolArgs]]]: ...
    @enabled_tools.setter
    def enabled_tools(
        self,
        value: pulumi.Input[Sequence[pulumi.Input[CodeToolsSettingEnabledToolArgs]]],
    ): ...
    @_builtins.property
    @pulumi.getter
    def labels(
...
class _CodeToolsSettingState:
    def __init__(
        __self__,
        *,
        code_tools_setting_id: Optional[pulumi.Input[_builtins.str]] = ...,
...
class CodeToolsSetting(pulumi.CustomResource):
    ...
    def enabled_tools(
        self,
    ) -> pulumi.Output[Sequence[outputs.CodeToolsSettingEnabledTool]]: ...
    @_builtins.property
    @pulumi.getter
