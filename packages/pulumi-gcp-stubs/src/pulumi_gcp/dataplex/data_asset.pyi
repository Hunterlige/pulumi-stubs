...
class DataAssetArgs:
    ...
    def access_group_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataAssetAccessGroupConfigArgs]]]]): # -> None:
        ...
...
class DataAsset(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., access_group_configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union[DataAssetAccessGroupConfigArgs, DataAssetAccessGroupConfigArgsDict]]]]] = ..., data_asset_id: Optional[pulumi.Input[_builtins.str]] = ..., data_product_id: Optional[pulumi.Input[_builtins.str]] = ..., effective_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., resource: Optional[pulumi.Input[_builtins.str]] = ..., uid: Optional[pulumi.Input[_builtins.str]] = ...) -> DataAsset:
