...
class EntryGroupIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[EntryGroupIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[EntryGroupIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[EntryGroupIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class EntryGroupIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.EntryGroupIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="entryGroupId")
