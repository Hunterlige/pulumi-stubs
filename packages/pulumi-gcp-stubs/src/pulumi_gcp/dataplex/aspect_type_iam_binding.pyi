...
class AspectTypeIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[AspectTypeIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[AspectTypeIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[AspectTypeIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class AspectTypeIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.AspectTypeIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
