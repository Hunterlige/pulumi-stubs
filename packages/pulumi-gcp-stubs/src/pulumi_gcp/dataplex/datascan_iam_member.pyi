...
class DatascanIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[DatascanIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[DatascanIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class DatascanIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    DatascanIamMemberConditionArgs, DatascanIamMemberConditionArgsDict
                ]
            ]
        ] = ...,
        data_scan_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.DatascanIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="dataScanId")
