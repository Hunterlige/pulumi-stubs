...
class GlossaryIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[GlossaryIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[GlossaryIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class GlossaryIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    GlossaryIamMemberConditionArgs, GlossaryIamMemberConditionArgsDict
                ]
            ]
        ] = ...,
        glossary_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.GlossaryIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
