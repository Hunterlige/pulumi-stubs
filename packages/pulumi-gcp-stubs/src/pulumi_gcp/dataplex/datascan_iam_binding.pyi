...
class DatascanIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[DatascanIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[DatascanIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class DatascanIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    DatascanIamBindingConditionArgs, DatascanIamBindingConditionArgsDict
                ]
            ]
        ] = ...,
        data_scan_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.DatascanIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="dataScanId")
