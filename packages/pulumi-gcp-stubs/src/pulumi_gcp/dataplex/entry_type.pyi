...
class EntryTypeArgs:
    def __init__(
        ...
        *,
        ...
        required_aspects: Optional[
            pulumi.Input[Sequence[pulumi.Input[EntryTypeRequiredAspectArgs]]]
        ] = ...,
        system: Optional[pulumi.Input[_builtins.str]] = ...,
        type_aliases: Optional[
...
class EntryType(pulumi.CustomResource):
        ...
        required_aspects: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[
                            EntryTypeRequiredAspectArgs, EntryTypeRequiredAspectArgsDict
                        ]
                    ]
                ]
            ]
    ...
    def required_aspects(
        self,
    ) -> pulumi.Output[Optional[Sequence[outputs.EntryTypeRequiredAspect]]]: ...
    @_builtins.property
    @pulumi.getter
