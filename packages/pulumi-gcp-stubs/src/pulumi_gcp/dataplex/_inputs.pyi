...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AspectTypeIamBindingConditionArgs', 'AspectTypeIamBindingConditionArgsDict', 'AspectTypeIamMemberConditionArgs', 'AspectTypeIamMemberConditionArgsDict', 'AssetDiscoverySpecArgs', 'AssetDiscoverySpecArgsDict', 'AssetDiscoverySpecCsvOptionsArgs', 'AssetDiscoverySpecCsvOptionsArgsDict', 'AssetDiscoverySpecJsonOptionsArgs', 'AssetDiscoverySpecJsonOptionsArgsDict', 'AssetDiscoveryStatusArgs', 'AssetDiscoveryStatusArgsDict', 'AssetDiscoveryStatusStatArgs', 'AssetDiscoveryStatusStatArgsDict', 'AssetIamBindingConditionArgs', 'AssetIamBindingConditionArgsDict', 'AssetIamMemberConditionArgs', 'AssetIamMemberConditionArgsDict', 'AssetResourceSpecArgs', 'AssetResourceSpecArgsDict', 'AssetResourceStatusArgs', 'AssetResourceStatusArgsDict', 'AssetSecurityStatusArgs', 'AssetSecurityStatusArgsDict', 'DataAssetAccessGroupConfigArgs', 'DataAssetAccessGroupConfigArgsDict', 'DataProductAccessGroupArgs', 'DataProductAccessGroupArgsDict', 'DataProductAccessGroupPrincipalArgs', 'DataProductAccessGroupPrincipalArgsDict', 'DataProductDataAssetAccessGroupConfigArgs', 'DataProductDataAssetAccessGroupConfigArgsDict', 'DatascanDataArgs', 'DatascanDataArgsDict', 'DatascanDataDiscoverySpecArgs', 'DatascanDataDiscoverySpecArgsDict', ..., ..., 'DatascanDataDiscoverySpecStorageConfigArgs', 'DatascanDataDiscoverySpecStorageConfigArgsDict', ..., ..., ..., ..., 'DatascanDataDocumentationSpecArgs', 'DatascanDataDocumentationSpecArgsDict', 'DatascanDataProfileSpecArgs', 'DatascanDataProfileSpecArgsDict', 'DatascanDataProfileSpecExcludeFieldsArgs', 'DatascanDataProfileSpecExcludeFieldsArgsDict', 'DatascanDataProfileSpecIncludeFieldsArgs', 'DatascanDataProfileSpecIncludeFieldsArgsDict', 'DatascanDataProfileSpecPostScanActionsArgs', 'DatascanDataProfileSpecPostScanActionsArgsDict', ..., ..., 'DatascanDataQualitySpecArgs', 'DatascanDataQualitySpecArgsDict', 'DatascanDataQualitySpecPostScanActionsArgs', 'DatascanDataQualitySpecPostScanActionsArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'DatascanDataQualitySpecRuleArgs', 'DatascanDataQualitySpecRuleArgsDict', 'DatascanDataQualitySpecRuleNonNullExpectationArgs', ..., 'DatascanDataQualitySpecRuleRangeExpectationArgs', ..., 'DatascanDataQualitySpecRuleRegexExpectationArgs', ..., ..., ..., 'DatascanDataQualitySpecRuleSetExpectationArgs', 'DatascanDataQualitySpecRuleSetExpectationArgsDict', 'DatascanDataQualitySpecRuleSqlAssertionArgs', 'DatascanDataQualitySpecRuleSqlAssertionArgsDict', ..., ..., ..., ..., ..., ..., 'DatascanExecutionSpecArgs', 'DatascanExecutionSpecArgsDict', 'DatascanExecutionSpecTriggerArgs', 'DatascanExecutionSpecTriggerArgsDict', 'DatascanExecutionSpecTriggerOnDemandArgs', 'DatascanExecutionSpecTriggerOnDemandArgsDict', 'DatascanExecutionSpecTriggerOneTimeArgs', 'DatascanExecutionSpecTriggerOneTimeArgsDict', 'DatascanExecutionSpecTriggerScheduleArgs', 'DatascanExecutionSpecTriggerScheduleArgsDict', 'DatascanExecutionStatusArgs', 'DatascanExecutionStatusArgsDict', 'DatascanIamBindingConditionArgs', 'DatascanIamBindingConditionArgsDict', 'DatascanIamMemberConditionArgs', 'DatascanIamMemberConditionArgsDict', 'EntryAspectArgs', 'EntryAspectArgsDict', 'EntryAspectAspectArgs', 'EntryAspectAspectArgsDict', 'EntryEntrySourceArgs', 'EntryEntrySourceArgsDict', 'EntryEntrySourceAncestorArgs', 'EntryEntrySourceAncestorArgsDict', 'EntryGroupIamBindingConditionArgs', 'EntryGroupIamBindingConditionArgsDict', 'EntryGroupIamMemberConditionArgs', 'EntryGroupIamMemberConditionArgsDict', 'EntryLinkEntryReferenceArgs', 'EntryLinkEntryReferenceArgsDict', 'EntryTypeIamBindingConditionArgs', 'EntryTypeIamBindingConditionArgsDict', 'EntryTypeIamMemberConditionArgs', 'EntryTypeIamMemberConditionArgsDict', 'EntryTypeRequiredAspectArgs', 'EntryTypeRequiredAspectArgsDict', 'GlossaryIamBindingConditionArgs', 'GlossaryIamBindingConditionArgsDict', 'GlossaryIamMemberConditionArgs', 'GlossaryIamMemberConditionArgsDict', 'LakeAssetStatusArgs', 'LakeAssetStatusArgsDict', 'LakeIamBindingConditionArgs', 'LakeIamBindingConditionArgsDict', 'LakeIamMemberConditionArgs', 'LakeIamMemberConditionArgsDict', 'LakeMetastoreArgs', 'LakeMetastoreArgsDict', 'LakeMetastoreStatusArgs', 'LakeMetastoreStatusArgsDict', 'TaskExecutionSpecArgs', 'TaskExecutionSpecArgsDict', 'TaskExecutionStatusArgs', 'TaskExecutionStatusArgsDict', 'TaskExecutionStatusLatestJobArgs', 'TaskExecutionStatusLatestJobArgsDict', 'TaskIamBindingConditionArgs', 'TaskIamBindingConditionArgsDict', 'TaskIamMemberConditionArgs', 'TaskIamMemberConditionArgsDict', 'TaskNotebookArgs', 'TaskNotebookArgsDict', 'TaskNotebookInfrastructureSpecArgs', 'TaskNotebookInfrastructureSpecArgsDict', 'TaskNotebookInfrastructureSpecBatchArgs', 'TaskNotebookInfrastructureSpecBatchArgsDict', 'TaskNotebookInfrastructureSpecContainerImageArgs', ..., 'TaskNotebookInfrastructureSpecVpcNetworkArgs', 'TaskNotebookInfrastructureSpecVpcNetworkArgsDict', 'TaskSparkArgs', 'TaskSparkArgsDict', 'TaskSparkInfrastructureSpecArgs', 'TaskSparkInfrastructureSpecArgsDict', 'TaskSparkInfrastructureSpecBatchArgs', 'TaskSparkInfrastructureSpecBatchArgsDict', 'TaskSparkInfrastructureSpecContainerImageArgs', 'TaskSparkInfrastructureSpecContainerImageArgsDict', 'TaskSparkInfrastructureSpecVpcNetworkArgs', 'TaskSparkInfrastructureSpecVpcNetworkArgsDict', 'TaskTriggerSpecArgs', 'TaskTriggerSpecArgsDict', 'ZoneAssetStatusArgs', 'ZoneAssetStatusArgsDict', 'ZoneDiscoverySpecArgs', 'ZoneDiscoverySpecArgsDict', 'ZoneDiscoverySpecCsvOptionsArgs', 'ZoneDiscoverySpecCsvOptionsArgsDict', 'ZoneDiscoverySpecJsonOptionsArgs', 'ZoneDiscoverySpecJsonOptionsArgsDict', 'ZoneIamBindingConditionArgs', 'ZoneIamBindingConditionArgsDict', 'ZoneIamMemberConditionArgs', 'ZoneIamMemberConditionArgsDict', 'ZoneResourceSpecArgs', 'ZoneResourceSpecArgsDict']
...
class AssetDiscoverySpecArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], csv_options: Optional[pulumi.Input[AssetDiscoverySpecCsvOptionsArgs]] = ..., exclude_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., include_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., json_options: Optional[pulumi.Input[AssetDiscoverySpecJsonOptionsArgs]] = ..., schedule: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @csv_options.setter
    def csv_options(self, value: Optional[pulumi.Input[AssetDiscoverySpecCsvOptionsArgs]]): # -> None:
        ...
    ...
    def exclude_patterns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def include_patterns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @json_options.setter
    def json_options(self, value: Optional[pulumi.Input[AssetDiscoverySpecJsonOptionsArgs]]): # -> None:
        ...
...
class AssetDiscoverySpecCsvOptionsArgs:
    def __init__(__self__, *, delimiter: Optional[pulumi.Input[_builtins.str]] = ..., disable_type_inference: Optional[pulumi.Input[_builtins.bool]] = ..., encoding: Optional[pulumi.Input[_builtins.str]] = ..., header_rows: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def disable_type_inference(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @header_rows.setter
    def header_rows(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AssetDiscoverySpecJsonOptionsArgs:
    def __init__(__self__, *, disable_type_inference: Optional[pulumi.Input[_builtins.bool]] = ..., encoding: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AssetDiscoveryStatusArgs:
    def __init__(__self__, *, last_run_duration: Optional[pulumi.Input[_builtins.str]] = ..., last_run_time: Optional[pulumi.Input[_builtins.str]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., stats: Optional[pulumi.Input[Sequence[pulumi.Input[AssetDiscoveryStatusStatArgs]]]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def last_run_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def last_run_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @stats.setter
    def stats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AssetDiscoveryStatusStatArgs]]]]): # -> None:
        ...
...
class AssetDiscoveryStatusStatArgs:
    def __init__(__self__, *, data_items: Optional[pulumi.Input[_builtins.int]] = ..., data_size: Optional[pulumi.Input[_builtins.int]] = ..., filesets: Optional[pulumi.Input[_builtins.int]] = ..., tables: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @data_items.setter
    def data_items(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @data_size.setter
    def data_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @filesets.setter
    def filesets(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @tables.setter
    def tables(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AssetResourceSpecArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], name: Optional[pulumi.Input[_builtins.str]] = ..., read_access_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def read_access_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AssetResourceStatusArgs:
    def __init__(__self__, *, message: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DataAssetAccessGroupConfigArgs:
    def __init__(__self__, *, access_group: pulumi.Input[_builtins.str], iam_roles: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @access_group.setter
    def access_group(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DataProductAccessGroupArgs:
    def __init__(__self__, *, display_name: pulumi.Input[_builtins.str], group_id: pulumi.Input[_builtins.str], id: pulumi.Input[_builtins.str], principal: pulumi.Input[DataProductAccessGroupPrincipalArgs], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @principal.setter
    def principal(self, value: pulumi.Input[DataProductAccessGroupPrincipalArgs]): # -> None:
        ...
...
class DataProductAccessGroupPrincipalArgs:
    def __init__(__self__, *, google_group: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @google_group.setter
    def google_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DatascanDataArgs:
    def __init__(__self__, *, entity: Optional[pulumi.Input[_builtins.str]] = ..., resource: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DatascanDataDiscoverySpecArgs:
    def __init__(__self__, *, bigquery_publishing_config: Optional[pulumi.Input[DatascanDataDiscoverySpecBigqueryPublishingConfigArgs]] = ..., storage_config: Optional[pulumi.Input[DatascanDataDiscoverySpecStorageConfigArgs]] = ...) -> None:
    ...
    def bigquery_publishing_config(self, value: Optional[pulumi.Input[DatascanDataDiscoverySpecBigqueryPublishingConfigArgs]]): # -> None:
        ...
    ...
    def storage_config(self, value: Optional[pulumi.Input[DatascanDataDiscoverySpecStorageConfigArgs]]): # -> None:
        ...
...
class DatascanDataDiscoverySpecBigqueryPublishingConfigArgs:
    def __init__(__self__, *, connection: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., table_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DatascanDataDiscoverySpecStorageConfigArgs:
    def __init__(__self__, *, csv_options: Optional[pulumi.Input[DatascanDataDiscoverySpecStorageConfigCsvOptionsArgs]] = ..., exclude_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., include_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., json_options: Optional[pulumi.Input[DatascanDataDiscoverySpecStorageConfigJsonOptionsArgs]] = ...) -> None:
    ...
    @csv_options.setter
    def csv_options(self, value: Optional[pulumi.Input[DatascanDataDiscoverySpecStorageConfigCsvOptionsArgs]]): # -> None:
        ...
    ...
    @json_options.setter
    def json_options(self, value: Optional[pulumi.Input[DatascanDataDiscoverySpecStorageConfigJsonOptionsArgs]]): # -> None:
        ...
...
class DatascanDataDiscoverySpecStorageConfigCsvOptionsArgs:
    def __init__(__self__, *, delimiter: Optional[pulumi.Input[_builtins.str]] = ..., encoding: Optional[pulumi.Input[_builtins.str]] = ..., header_rows: Optional[pulumi.Input[_builtins.int]] = ..., quote: Optional[pulumi.Input[_builtins.str]] = ..., type_inference_disabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def type_inference_disabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DatascanDataDiscoverySpecStorageConfigJsonOptionsArgs:
    def __init__(__self__, *, encoding: Optional[pulumi.Input[_builtins.str]] = ..., type_inference_disabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class DatascanDataProfileSpecArgs:
    def __init__(__self__, *, catalog_publishing_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., exclude_fields: Optional[pulumi.Input[DatascanDataProfileSpecExcludeFieldsArgs]] = ..., include_fields: Optional[pulumi.Input[DatascanDataProfileSpecIncludeFieldsArgs]] = ..., post_scan_actions: Optional[pulumi.Input[DatascanDataProfileSpecPostScanActionsArgs]] = ..., row_filter: Optional[pulumi.Input[_builtins.str]] = ..., sampling_percent: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def catalog_publishing_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def exclude_fields(self, value: Optional[pulumi.Input[DatascanDataProfileSpecExcludeFieldsArgs]]): # -> None:
        ...
    ...
    def include_fields(self, value: Optional[pulumi.Input[DatascanDataProfileSpecIncludeFieldsArgs]]): # -> None:
        ...
    ...
    def post_scan_actions(self, value: Optional[pulumi.Input[DatascanDataProfileSpecPostScanActionsArgs]]): # -> None:
        ...
    ...
    @row_filter.setter
    def row_filter(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def sampling_percent(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class DatascanDataProfileSpecExcludeFieldsArgs:
    def __init__(__self__, *, field_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @field_names.setter
    def field_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DatascanDataProfileSpecPostScanActionsArgs:
    def __init__(__self__, *, bigquery_export: Optional[pulumi.Input[DatascanDataProfileSpecPostScanActionsBigqueryExportArgs]] = ...) -> None:
    ...
    def bigquery_export(self, value: Optional[pulumi.Input[DatascanDataProfileSpecPostScanActionsBigqueryExportArgs]]): # -> None:
        ...
...
class DatascanDataProfileSpecPostScanActionsBigqueryExportArgs:
    def __init__(__self__, *, results_table: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def results_table(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DatascanDataQualitySpecArgs:
    def __init__(__self__, *, catalog_publishing_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., post_scan_actions: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsArgs]] = ..., row_filter: Optional[pulumi.Input[_builtins.str]] = ..., rules: Optional[pulumi.Input[Sequence[pulumi.Input[DatascanDataQualitySpecRuleArgs]]]] = ..., sampling_percent: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @post_scan_actions.setter
    def post_scan_actions(self, value: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsArgs]]): # -> None:
        ...
    ...
    @rules.setter
    def rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DatascanDataQualitySpecRuleArgs]]]]): # -> None:
        ...
...
class DatascanDataQualitySpecPostScanActionsArgs:
    def __init__(__self__, *, bigquery_export: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsBigqueryExportArgs]] = ..., notification_report: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsNotificationReportArgs]] = ...) -> None:
    ...
    @bigquery_export.setter
    def bigquery_export(self, value: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsBigqueryExportArgs]]): # -> None:
        ...
    ...
    def notification_report(self, value: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsNotificationReportArgs]]): # -> None:
        ...
...
class DatascanDataQualitySpecPostScanActionsNotificationReportArgs:
    def __init__(__self__, *, recipients: pulumi.Input[DatascanDataQualitySpecPostScanActionsNotificationReportRecipientsArgs], job_end_trigger: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsNotificationReportJobEndTriggerArgs]] = ..., job_failure_trigger: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsNotificationReportJobFailureTriggerArgs]] = ..., score_threshold_trigger: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsNotificationReportScoreThresholdTriggerArgs]] = ...) -> None:
    ...
    @recipients.setter
    def recipients(self, value: pulumi.Input[DatascanDataQualitySpecPostScanActionsNotificationReportRecipientsArgs]): # -> None:
        ...
    ...
    def job_end_trigger(self, value: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsNotificationReportJobEndTriggerArgs]]): # -> None:
        ...
    ...
    def job_failure_trigger(self, value: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsNotificationReportJobFailureTriggerArgs]]): # -> None:
        ...
    ...
    def score_threshold_trigger(self, value: Optional[pulumi.Input[DatascanDataQualitySpecPostScanActionsNotificationReportScoreThresholdTriggerArgs]]): # -> None:
        ...
...
class DatascanDataQualitySpecPostScanActionsNotificationReportScoreThresholdTriggerArgs:
    def __init__(__self__, *, score_threshold: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def score_threshold(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class DatascanDataQualitySpecRuleArgs:
    def __init__(__self__, *, dimension: pulumi.Input[_builtins.str], column: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., ignore_null: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., non_null_expectation: Optional[pulumi.Input[DatascanDataQualitySpecRuleNonNullExpectationArgs]] = ..., range_expectation: Optional[pulumi.Input[DatascanDataQualitySpecRuleRangeExpectationArgs]] = ..., regex_expectation: Optional[pulumi.Input[DatascanDataQualitySpecRuleRegexExpectationArgs]] = ..., row_condition_expectation: Optional[pulumi.Input[DatascanDataQualitySpecRuleRowConditionExpectationArgs]] = ..., set_expectation: Optional[pulumi.Input[DatascanDataQualitySpecRuleSetExpectationArgs]] = ..., sql_assertion: Optional[pulumi.Input[DatascanDataQualitySpecRuleSqlAssertionArgs]] = ..., statistic_range_expectation: Optional[pulumi.Input[DatascanDataQualitySpecRuleStatisticRangeExpectationArgs]] = ..., suspended: Optional[pulumi.Input[_builtins.bool]] = ..., table_condition_expectation: Optional[pulumi.Input[DatascanDataQualitySpecRuleTableConditionExpectationArgs]] = ..., threshold: Optional[pulumi.Input[_builtins.float]] = ..., uniqueness_expectation: Optional[pulumi.Input[DatascanDataQualitySpecRuleUniquenessExpectationArgs]] = ...) -> None:
    ...
    @dimension.setter
    def dimension(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @ignore_null.setter
    def ignore_null(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def non_null_expectation(self, value: Optional[pulumi.Input[DatascanDataQualitySpecRuleNonNullExpectationArgs]]): # -> None:
        ...
    ...
    def range_expectation(self, value: Optional[pulumi.Input[DatascanDataQualitySpecRuleRangeExpectationArgs]]): # -> None:
        ...
    ...
    def regex_expectation(self, value: Optional[pulumi.Input[DatascanDataQualitySpecRuleRegexExpectationArgs]]): # -> None:
        ...
    ...
    def row_condition_expectation(self, value: Optional[pulumi.Input[DatascanDataQualitySpecRuleRowConditionExpectationArgs]]): # -> None:
        ...
    ...
    def set_expectation(self, value: Optional[pulumi.Input[DatascanDataQualitySpecRuleSetExpectationArgs]]): # -> None:
        ...
    ...
    def sql_assertion(self, value: Optional[pulumi.Input[DatascanDataQualitySpecRuleSqlAssertionArgs]]): # -> None:
        ...
    ...
    def statistic_range_expectation(self, value: Optional[pulumi.Input[DatascanDataQualitySpecRuleStatisticRangeExpectationArgs]]): # -> None:
        ...
    ...
    def table_condition_expectation(self, value: Optional[pulumi.Input[DatascanDataQualitySpecRuleTableConditionExpectationArgs]]): # -> None:
        ...
    ...
    def uniqueness_expectation(self, value: Optional[pulumi.Input[DatascanDataQualitySpecRuleUniquenessExpectationArgs]]): # -> None:
        ...
...
class DatascanDataQualitySpecRuleRangeExpectationArgs:
    def __init__(__self__, *, max_value: Optional[pulumi.Input[_builtins.str]] = ..., min_value: Optional[pulumi.Input[_builtins.str]] = ..., strict_max_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., strict_min_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def strict_max_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def strict_min_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DatascanDataQualitySpecRuleSqlAssertionArgs:
    ...
    def sql_statement(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DatascanDataQualitySpecRuleStatisticRangeExpectationArgs:
    def __init__(__self__, *, statistic: pulumi.Input[_builtins.str], max_value: Optional[pulumi.Input[_builtins.str]] = ..., min_value: Optional[pulumi.Input[_builtins.str]] = ..., strict_max_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., strict_min_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class DatascanExecutionSpecArgs:
    def __init__(__self__, *, trigger: pulumi.Input[DatascanExecutionSpecTriggerArgs], field: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @trigger.setter
    def trigger(self, value: pulumi.Input[DatascanExecutionSpecTriggerArgs]): # -> None:
        ...
...
class DatascanExecutionSpecTriggerArgs:
    def __init__(__self__, *, on_demand: Optional[pulumi.Input[DatascanExecutionSpecTriggerOnDemandArgs]] = ..., one_time: Optional[pulumi.Input[DatascanExecutionSpecTriggerOneTimeArgs]] = ..., schedule: Optional[pulumi.Input[DatascanExecutionSpecTriggerScheduleArgs]] = ...) -> None:
    ...
    @on_demand.setter
    def on_demand(self, value: Optional[pulumi.Input[DatascanExecutionSpecTriggerOnDemandArgs]]): # -> None:
        ...
    ...
    @one_time.setter
    def one_time(self, value: Optional[pulumi.Input[DatascanExecutionSpecTriggerOneTimeArgs]]): # -> None:
        ...
    ...
    @schedule.setter
    def schedule(self, value: Optional[pulumi.Input[DatascanExecutionSpecTriggerScheduleArgs]]): # -> None:
        ...
...
class DatascanExecutionSpecTriggerOneTimeArgs:
    def __init__(__self__, *, ttl_after_scan_completion: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ttl_after_scan_completion(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DatascanExecutionStatusArgs:
    def __init__(__self__, *, latest_job_end_time: Optional[pulumi.Input[_builtins.str]] = ..., latest_job_start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def latest_job_end_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def latest_job_start_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EntryAspectArgs:
    def __init__(__self__, *, aspect: pulumi.Input[EntryAspectAspectArgs], aspect_key: pulumi.Input[_builtins.str]) -> None:
    ...
    @aspect.setter
    def aspect(self, value: pulumi.Input[EntryAspectAspectArgs]): # -> None:
        ...
    ...
    @aspect_key.setter
    def aspect_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class EntryAspectAspectArgs:
    def __init__(__self__, *, data: pulumi.Input[_builtins.str], aspect_type: Optional[pulumi.Input[_builtins.str]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @aspect_type.setter
    def aspect_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EntryEntrySourceArgs:
    def __init__(__self__, *, ancestors: Optional[pulumi.Input[Sequence[pulumi.Input[EntryEntrySourceAncestorArgs]]]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., platform: Optional[pulumi.Input[_builtins.str]] = ..., resource: Optional[pulumi.Input[_builtins.str]] = ..., system: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ancestors.setter
    def ancestors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EntryEntrySourceAncestorArgs]]]]): # -> None:
        ...
    ...
    @system.setter
    def system(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EntryLinkEntryReferenceArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], path: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class LakeAssetStatusArgs:
    def __init__(__self__, *, active_assets: Optional[pulumi.Input[_builtins.int]] = ..., security_policy_applying_assets: Optional[pulumi.Input[_builtins.int]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def active_assets(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def security_policy_applying_assets(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class LakeMetastoreStatusArgs:
    def __init__(__self__, *, endpoint: Optional[pulumi.Input[_builtins.str]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TaskExecutionSpecArgs:
    def __init__(__self__, *, service_account: pulumi.Input[_builtins.str], args: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., kms_key: Optional[pulumi.Input[_builtins.str]] = ..., max_job_execution_lifetime: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @args.setter
    def args(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def max_job_execution_lifetime(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TaskExecutionStatusArgs:
    def __init__(__self__, *, latest_jobs: Optional[pulumi.Input[Sequence[pulumi.Input[TaskExecutionStatusLatestJobArgs]]]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @latest_jobs.setter
    def latest_jobs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TaskExecutionStatusLatestJobArgs]]]]): # -> None:
        ...
...
class TaskExecutionStatusLatestJobArgs:
    def __init__(__self__, *, end_time: Optional[pulumi.Input[_builtins.str]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., retry_count: Optional[pulumi.Input[_builtins.int]] = ..., service: Optional[pulumi.Input[_builtins.str]] = ..., service_job: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., uid: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @service_job.setter
    def service_job(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TaskNotebookArgs:
    def __init__(__self__, *, notebook: pulumi.Input[_builtins.str], archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., infrastructure_spec: Optional[pulumi.Input[TaskNotebookInfrastructureSpecArgs]] = ...) -> None:
    ...
    @notebook.setter
    def notebook(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def infrastructure_spec(self, value: Optional[pulumi.Input[TaskNotebookInfrastructureSpecArgs]]): # -> None:
        ...
...
class TaskNotebookInfrastructureSpecArgs:
    def __init__(__self__, *, batch: Optional[pulumi.Input[TaskNotebookInfrastructureSpecBatchArgs]] = ..., container_image: Optional[pulumi.Input[TaskNotebookInfrastructureSpecContainerImageArgs]] = ..., vpc_network: Optional[pulumi.Input[TaskNotebookInfrastructureSpecVpcNetworkArgs]] = ...) -> None:
    ...
    @batch.setter
    def batch(self, value: Optional[pulumi.Input[TaskNotebookInfrastructureSpecBatchArgs]]): # -> None:
        ...
    ...
    def container_image(self, value: Optional[pulumi.Input[TaskNotebookInfrastructureSpecContainerImageArgs]]): # -> None:
        ...
    ...
    @vpc_network.setter
    def vpc_network(self, value: Optional[pulumi.Input[TaskNotebookInfrastructureSpecVpcNetworkArgs]]): # -> None:
        ...
...
class TaskNotebookInfrastructureSpecBatchArgs:
    def __init__(__self__, *, executors_count: Optional[pulumi.Input[_builtins.int]] = ..., max_executors_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def executors_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_executors_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class TaskNotebookInfrastructureSpecContainerImageArgs:
    def __init__(__self__, *, image: Optional[pulumi.Input[_builtins.str]] = ..., java_jars: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., python_packages: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @java_jars.setter
    def java_jars(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def python_packages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class TaskNotebookInfrastructureSpecVpcNetworkArgs:
    def __init__(__self__, *, network: Optional[pulumi.Input[_builtins.str]] = ..., network_tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., sub_network: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @sub_network.setter
    def sub_network(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class TaskSparkArgs:
    def __init__(__self__, *, archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., infrastructure_spec: Optional[pulumi.Input[TaskSparkInfrastructureSpecArgs]] = ..., main_class: Optional[pulumi.Input[_builtins.str]] = ..., main_jar_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., python_script_file: Optional[pulumi.Input[_builtins.str]] = ..., sql_script: Optional[pulumi.Input[_builtins.str]] = ..., sql_script_file: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @infrastructure_spec.setter
    def infrastructure_spec(self, value: Optional[pulumi.Input[TaskSparkInfrastructureSpecArgs]]): # -> None:
        ...
    ...
    def python_script_file(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @sql_script.setter
    def sql_script(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def sql_script_file(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TaskSparkInfrastructureSpecArgs:
    def __init__(__self__, *, batch: Optional[pulumi.Input[TaskSparkInfrastructureSpecBatchArgs]] = ..., container_image: Optional[pulumi.Input[TaskSparkInfrastructureSpecContainerImageArgs]] = ..., vpc_network: Optional[pulumi.Input[TaskSparkInfrastructureSpecVpcNetworkArgs]] = ...) -> None:
    ...
    @batch.setter
    def batch(self, value: Optional[pulumi.Input[TaskSparkInfrastructureSpecBatchArgs]]): # -> None:
        ...
    ...
    @container_image.setter
    def container_image(self, value: Optional[pulumi.Input[TaskSparkInfrastructureSpecContainerImageArgs]]): # -> None:
        ...
    ...
    @vpc_network.setter
    def vpc_network(self, value: Optional[pulumi.Input[TaskSparkInfrastructureSpecVpcNetworkArgs]]): # -> None:
        ...
...
class TaskTriggerSpecArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], disabled: Optional[pulumi.Input[_builtins.bool]] = ..., max_retries: Optional[pulumi.Input[_builtins.int]] = ..., schedule: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ZoneDiscoverySpecArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], csv_options: Optional[pulumi.Input[ZoneDiscoverySpecCsvOptionsArgs]] = ..., exclude_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., include_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., json_options: Optional[pulumi.Input[ZoneDiscoverySpecJsonOptionsArgs]] = ..., schedule: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @csv_options.setter
    def csv_options(self, value: Optional[pulumi.Input[ZoneDiscoverySpecCsvOptionsArgs]]): # -> None:
        ...
    ...
    @json_options.setter
    def json_options(self, value: Optional[pulumi.Input[ZoneDiscoverySpecJsonOptionsArgs]]): # -> None:
        ...
...
class ZoneResourceSpecArgs:
    ...
    def location_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
