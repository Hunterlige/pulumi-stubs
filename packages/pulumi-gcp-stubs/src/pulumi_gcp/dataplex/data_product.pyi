...
class DataProductArgs:
    def __init__(
        ...
        *,
        ...
        access_groups: Optional[
            pulumi.Input[Sequence[pulumi.Input[DataProductAccessGroupArgs]]]
        ] = ...,
    ...
    def access_groups(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[DataProductAccessGroupArgs]]]]: ...
...
class _DataProductState:
    def __init__(
        ...
        *,
        ...
        asset_count: Optional[pulumi.Input[_builtins.int]] = ...,
...
class DataProduct(pulumi.CustomResource):
        ...
        access_groups: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[
                            DataProductAccessGroupArgs, DataProductAccessGroupArgsDict
                        ]
                    ]
                ]
            ]
    ...
    def access_groups(
        self,
    ) -> pulumi.Output[Optional[Sequence[outputs.DataProductAccessGroup]]]: ...
    @_builtins.property
    @pulumi.getter(name="assetCount")
