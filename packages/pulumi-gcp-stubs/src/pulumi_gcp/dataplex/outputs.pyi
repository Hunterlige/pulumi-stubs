...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AspectTypeIamBindingCondition', 'AspectTypeIamMemberCondition', 'AssetDiscoverySpec', 'AssetDiscoverySpecCsvOptions', 'AssetDiscoverySpecJsonOptions', 'AssetDiscoveryStatus', 'AssetDiscoveryStatusStat', 'AssetIamBindingCondition', 'AssetIamMemberCondition', 'AssetResourceSpec', 'AssetResourceStatus', 'AssetSecurityStatus', 'DataAssetAccessGroupConfig', 'DataProductAccessGroup', 'DataProductAccessGroupPrincipal', 'DataProductDataAssetAccessGroupConfig', 'DatascanData', 'DatascanDataDiscoverySpec', 'DatascanDataDiscoverySpecBigqueryPublishingConfig', 'DatascanDataDiscoverySpecStorageConfig', 'DatascanDataDiscoverySpecStorageConfigCsvOptions', 'DatascanDataDiscoverySpecStorageConfigJsonOptions', 'DatascanDataDocumentationSpec', 'DatascanDataProfileSpec', 'DatascanDataProfileSpecExcludeFields', 'DatascanDataProfileSpecIncludeFields', 'DatascanDataProfileSpecPostScanActions', ..., 'DatascanDataQualitySpec', 'DatascanDataQualitySpecPostScanActions', ..., ..., ..., ..., ..., ..., 'DatascanDataQualitySpecRule', 'DatascanDataQualitySpecRuleNonNullExpectation', 'DatascanDataQualitySpecRuleRangeExpectation', 'DatascanDataQualitySpecRuleRegexExpectation', 'DatascanDataQualitySpecRuleRowConditionExpectation', 'DatascanDataQualitySpecRuleSetExpectation', 'DatascanDataQualitySpecRuleSqlAssertion', ..., ..., 'DatascanDataQualitySpecRuleUniquenessExpectation', 'DatascanExecutionSpec', 'DatascanExecutionSpecTrigger', 'DatascanExecutionSpecTriggerOnDemand', 'DatascanExecutionSpecTriggerOneTime', 'DatascanExecutionSpecTriggerSchedule', 'DatascanExecutionStatus', 'DatascanIamBindingCondition', 'DatascanIamMemberCondition', 'EntryAspect', 'EntryAspectAspect', 'EntryEntrySource', 'EntryEntrySourceAncestor', 'EntryGroupIamBindingCondition', 'EntryGroupIamMemberCondition', 'EntryLinkEntryReference', 'EntryTypeIamBindingCondition', 'EntryTypeIamMemberCondition', 'EntryTypeRequiredAspect', 'GlossaryIamBindingCondition', 'GlossaryIamMemberCondition', 'LakeAssetStatus', 'LakeIamBindingCondition', 'LakeIamMemberCondition', 'LakeMetastore', 'LakeMetastoreStatus', 'TaskExecutionSpec', 'TaskExecutionStatus', 'TaskExecutionStatusLatestJob', 'TaskIamBindingCondition', 'TaskIamMemberCondition', 'TaskNotebook', 'TaskNotebookInfrastructureSpec', 'TaskNotebookInfrastructureSpecBatch', 'TaskNotebookInfrastructureSpecContainerImage', 'TaskNotebookInfrastructureSpecVpcNetwork', 'TaskSpark', 'TaskSparkInfrastructureSpec', 'TaskSparkInfrastructureSpecBatch', 'TaskSparkInfrastructureSpecContainerImage', 'TaskSparkInfrastructureSpecVpcNetwork', 'TaskTriggerSpec', 'ZoneAssetStatus', 'ZoneDiscoverySpec', 'ZoneDiscoverySpecCsvOptions', 'ZoneDiscoverySpecJsonOptions', 'ZoneIamBindingCondition', 'ZoneIamMemberCondition', 'ZoneResourceSpec', 'GetDataQualityRulesRuleResult', 'GetDataQualityRulesRuleNonNullExpectationResult', 'GetDataQualityRulesRuleRangeExpectationResult', 'GetDataQualityRulesRuleRegexExpectationResult', ..., 'GetDataQualityRulesRuleSetExpectationResult', 'GetDataQualityRulesRuleSqlAssertionResult', ..., ..., 'GetDataQualityRulesRuleUniquenessExpectationResult']
@pulumi.output_type
...
class AssetDiscoverySpec(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, csv_options: Optional[outputs.AssetDiscoverySpecCsvOptions] = ..., exclude_patterns: Optional[Sequence[_builtins.str]] = ..., include_patterns: Optional[Sequence[_builtins.str]] = ..., json_options: Optional[outputs.AssetDiscoverySpecJsonOptions] = ..., schedule: Optional[_builtins.str] = ...) -> None:
...
class AssetDiscoverySpecCsvOptions(dict):
    ...
    def __init__(__self__, *, delimiter: Optional[_builtins.str] = ..., disable_type_inference: Optional[_builtins.bool] = ..., encoding: Optional[_builtins.str] = ..., header_rows: Optional[_builtins.int] = ...) -> None:
...
class AssetDiscoverySpecJsonOptions(dict):
    ...
    def __init__(__self__, *, disable_type_inference: Optional[_builtins.bool] = ..., encoding: Optional[_builtins.str] = ...) -> None:
...
class AssetDiscoveryStatus(dict):
    ...
    def __init__(__self__, *, last_run_duration: Optional[_builtins.str] = ..., last_run_time: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., stats: Optional[Sequence[outputs.AssetDiscoveryStatusStat]] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class AssetDiscoveryStatusStat(dict):
    ...
    def __init__(__self__, *, data_items: Optional[_builtins.int] = ..., data_size: Optional[_builtins.int] = ..., filesets: Optional[_builtins.int] = ..., tables: Optional[_builtins.int] = ...) -> None:
...
class AssetResourceSpec(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, name: Optional[_builtins.str] = ..., read_access_mode: Optional[_builtins.str] = ...) -> None:
...
class AssetResourceStatus(dict):
    ...
    def __init__(__self__, *, message: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class DataAssetAccessGroupConfig(dict):
    ...
    def __init__(__self__, *, access_group: _builtins.str, iam_roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DataProductAccessGroup(dict):
    ...
    def __init__(__self__, *, display_name: _builtins.str, group_id: _builtins.str, id: _builtins.str, principal: outputs.DataProductAccessGroupPrincipal, description: Optional[_builtins.str] = ...) -> None:
...
class DatascanData(dict):
    def __init__(__self__, *, entity: Optional[_builtins.str] = ..., resource: Optional[_builtins.str] = ...) -> None:
...
class DatascanDataDiscoverySpec(dict):
    ...
    def __init__(__self__, *, bigquery_publishing_config: Optional[outputs.DatascanDataDiscoverySpecBigqueryPublishingConfig] = ..., storage_config: Optional[outputs.DatascanDataDiscoverySpecStorageConfig] = ...) -> None:
...
class DatascanDataDiscoverySpecBigqueryPublishingConfig(dict):
    ...
    def __init__(__self__, *, connection: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., table_type: Optional[_builtins.str] = ...) -> None:
...
class DatascanDataDiscoverySpecStorageConfig(dict):
    ...
    def __init__(__self__, *, csv_options: Optional[outputs.DatascanDataDiscoverySpecStorageConfigCsvOptions] = ..., exclude_patterns: Optional[Sequence[_builtins.str]] = ..., include_patterns: Optional[Sequence[_builtins.str]] = ..., json_options: Optional[outputs.DatascanDataDiscoverySpecStorageConfigJsonOptions] = ...) -> None:
...
class DatascanDataDiscoverySpecStorageConfigCsvOptions(dict):
    ...
    def __init__(__self__, *, delimiter: Optional[_builtins.str] = ..., encoding: Optional[_builtins.str] = ..., header_rows: Optional[_builtins.int] = ..., quote: Optional[_builtins.str] = ..., type_inference_disabled: Optional[_builtins.bool] = ...) -> None:
...
class DatascanDataDiscoverySpecStorageConfigJsonOptions(dict):
    ...
    def __init__(__self__, *, encoding: Optional[_builtins.str] = ..., type_inference_disabled: Optional[_builtins.bool] = ...) -> None:
...
class DatascanDataProfileSpec(dict):
    ...
    def __init__(__self__, *, catalog_publishing_enabled: Optional[_builtins.bool] = ..., exclude_fields: Optional[outputs.DatascanDataProfileSpecExcludeFields] = ..., include_fields: Optional[outputs.DatascanDataProfileSpecIncludeFields] = ..., post_scan_actions: Optional[outputs.DatascanDataProfileSpecPostScanActions] = ..., row_filter: Optional[_builtins.str] = ..., sampling_percent: Optional[_builtins.float] = ...) -> None:
...
class DatascanDataProfileSpecExcludeFields(dict):
    ...
    def __init__(__self__, *, field_names: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DatascanDataProfileSpecPostScanActions(dict):
    ...
    def __init__(__self__, *, bigquery_export: Optional[outputs.DatascanDataProfileSpecPostScanActionsBigqueryExport] = ...) -> None:
...
class DatascanDataQualitySpec(dict):
    ...
    def __init__(__self__, *, catalog_publishing_enabled: Optional[_builtins.bool] = ..., post_scan_actions: Optional[outputs.DatascanDataQualitySpecPostScanActions] = ..., row_filter: Optional[_builtins.str] = ..., rules: Optional[Sequence[outputs.DatascanDataQualitySpecRule]] = ..., sampling_percent: Optional[_builtins.float] = ...) -> None:
...
class DatascanDataQualitySpecPostScanActions(dict):
    ...
    def __init__(__self__, *, bigquery_export: Optional[outputs.DatascanDataQualitySpecPostScanActionsBigqueryExport] = ..., notification_report: Optional[outputs.DatascanDataQualitySpecPostScanActionsNotificationReport] = ...) -> None:
...
class DatascanDataQualitySpecPostScanActionsNotificationReport(dict):
    ...
    def __init__(__self__, *, recipients: outputs.DatascanDataQualitySpecPostScanActionsNotificationReportRecipients, job_end_trigger: Optional[outputs.DatascanDataQualitySpecPostScanActionsNotificationReportJobEndTrigger] = ..., job_failure_trigger: Optional[outputs.DatascanDataQualitySpecPostScanActionsNotificationReportJobFailureTrigger] = ..., score_threshold_trigger: Optional[outputs.DatascanDataQualitySpecPostScanActionsNotificationReportScoreThresholdTrigger] = ...) -> None:
...
class DatascanDataQualitySpecPostScanActionsNotificationReportScoreThresholdTrigger(dict):
    ...
    def __init__(__self__, *, score_threshold: Optional[_builtins.float] = ...) -> None:
...
class DatascanDataQualitySpecRule(dict):
    ...
    def __init__(__self__, *, dimension: _builtins.str, column: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., ignore_null: Optional[_builtins.bool] = ..., name: Optional[_builtins.str] = ..., non_null_expectation: Optional[outputs.DatascanDataQualitySpecRuleNonNullExpectation] = ..., range_expectation: Optional[outputs.DatascanDataQualitySpecRuleRangeExpectation] = ..., regex_expectation: Optional[outputs.DatascanDataQualitySpecRuleRegexExpectation] = ..., row_condition_expectation: Optional[outputs.DatascanDataQualitySpecRuleRowConditionExpectation] = ..., set_expectation: Optional[outputs.DatascanDataQualitySpecRuleSetExpectation] = ..., sql_assertion: Optional[outputs.DatascanDataQualitySpecRuleSqlAssertion] = ..., statistic_range_expectation: Optional[outputs.DatascanDataQualitySpecRuleStatisticRangeExpectation] = ..., suspended: Optional[_builtins.bool] = ..., table_condition_expectation: Optional[outputs.DatascanDataQualitySpecRuleTableConditionExpectation] = ..., threshold: Optional[_builtins.float] = ..., uniqueness_expectation: Optional[outputs.DatascanDataQualitySpecRuleUniquenessExpectation] = ...) -> None:
...
class DatascanDataQualitySpecRuleRangeExpectation(dict):
    ...
    def __init__(__self__, *, max_value: Optional[_builtins.str] = ..., min_value: Optional[_builtins.str] = ..., strict_max_enabled: Optional[_builtins.bool] = ..., strict_min_enabled: Optional[_builtins.bool] = ...) -> None:
...
class DatascanDataQualitySpecRuleStatisticRangeExpectation(dict):
    ...
    def __init__(__self__, *, statistic: _builtins.str, max_value: Optional[_builtins.str] = ..., min_value: Optional[_builtins.str] = ..., strict_max_enabled: Optional[_builtins.bool] = ..., strict_min_enabled: Optional[_builtins.bool] = ...) -> None:
...
class DatascanExecutionSpec(dict):
    def __init__(__self__, *, trigger: outputs.DatascanExecutionSpecTrigger, field: Optional[_builtins.str] = ...) -> None:
...
class DatascanExecutionSpecTrigger(dict):
    ...
    def __init__(__self__, *, on_demand: Optional[outputs.DatascanExecutionSpecTriggerOnDemand] = ..., one_time: Optional[outputs.DatascanExecutionSpecTriggerOneTime] = ..., schedule: Optional[outputs.DatascanExecutionSpecTriggerSchedule] = ...) -> None:
...
class DatascanExecutionSpecTriggerOneTime(dict):
    ...
    def __init__(__self__, *, ttl_after_scan_completion: Optional[_builtins.str] = ...) -> None:
...
class DatascanExecutionStatus(dict):
    ...
    def __init__(__self__, *, latest_job_end_time: Optional[_builtins.str] = ..., latest_job_start_time: Optional[_builtins.str] = ...) -> None:
...
class EntryAspect(dict):
    ...
    def __init__(__self__, *, aspect: outputs.EntryAspectAspect, aspect_key: _builtins.str) -> None:
...
class EntryAspectAspect(dict):
    ...
    def __init__(__self__, *, data: _builtins.str, aspect_type: Optional[_builtins.str] = ..., create_time: Optional[_builtins.str] = ..., path: Optional[_builtins.str] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class EntryEntrySource(dict):
    ...
    def __init__(__self__, *, ancestors: Optional[Sequence[outputs.EntryEntrySourceAncestor]] = ..., create_time: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., location: Optional[_builtins.str] = ..., platform: Optional[_builtins.str] = ..., resource: Optional[_builtins.str] = ..., system: Optional[_builtins.str] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class EntryLinkEntryReference(dict):
    def __init__(__self__, *, name: _builtins.str, path: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class LakeAssetStatus(dict):
    ...
    def __init__(__self__, *, active_assets: Optional[_builtins.int] = ..., security_policy_applying_assets: Optional[_builtins.int] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class LakeMetastoreStatus(dict):
    ...
    def __init__(__self__, *, endpoint: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class TaskExecutionSpec(dict):
    ...
    def __init__(__self__, *, service_account: _builtins.str, args: Optional[Mapping[str, _builtins.str]] = ..., kms_key: Optional[_builtins.str] = ..., max_job_execution_lifetime: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ...) -> None:
...
class TaskExecutionStatus(dict):
    ...
    def __init__(__self__, *, latest_jobs: Optional[Sequence[outputs.TaskExecutionStatusLatestJob]] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class TaskExecutionStatusLatestJob(dict):
    ...
    def __init__(__self__, *, end_time: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., retry_count: Optional[_builtins.int] = ..., service: Optional[_builtins.str] = ..., service_job: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., uid: Optional[_builtins.str] = ...) -> None:
...
class TaskNotebook(dict):
    ...
    def __init__(__self__, *, notebook: _builtins.str, archive_uris: Optional[Sequence[_builtins.str]] = ..., file_uris: Optional[Sequence[_builtins.str]] = ..., infrastructure_spec: Optional[outputs.TaskNotebookInfrastructureSpec] = ...) -> None:
...
class TaskNotebookInfrastructureSpec(dict):
    ...
    def __init__(__self__, *, batch: Optional[outputs.TaskNotebookInfrastructureSpecBatch] = ..., container_image: Optional[outputs.TaskNotebookInfrastructureSpecContainerImage] = ..., vpc_network: Optional[outputs.TaskNotebookInfrastructureSpecVpcNetwork] = ...) -> None:
...
class TaskNotebookInfrastructureSpecBatch(dict):
    ...
    def __init__(__self__, *, executors_count: Optional[_builtins.int] = ..., max_executors_count: Optional[_builtins.int] = ...) -> None:
...
class TaskNotebookInfrastructureSpecContainerImage(dict):
    ...
    def __init__(__self__, *, image: Optional[_builtins.str] = ..., java_jars: Optional[Sequence[_builtins.str]] = ..., properties: Optional[Mapping[str, _builtins.str]] = ..., python_packages: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class TaskNotebookInfrastructureSpecVpcNetwork(dict):
    ...
    def __init__(__self__, *, network: Optional[_builtins.str] = ..., network_tags: Optional[Sequence[_builtins.str]] = ..., sub_network: Optional[_builtins.str] = ...) -> None:
...
class TaskSpark(dict):
    ...
    def __init__(__self__, *, archive_uris: Optional[Sequence[_builtins.str]] = ..., file_uris: Optional[Sequence[_builtins.str]] = ..., infrastructure_spec: Optional[outputs.TaskSparkInfrastructureSpec] = ..., main_class: Optional[_builtins.str] = ..., main_jar_file_uri: Optional[_builtins.str] = ..., python_script_file: Optional[_builtins.str] = ..., sql_script: Optional[_builtins.str] = ..., sql_script_file: Optional[_builtins.str] = ...) -> None:
...
class TaskSparkInfrastructureSpec(dict):
    ...
    def __init__(__self__, *, batch: Optional[outputs.TaskSparkInfrastructureSpecBatch] = ..., container_image: Optional[outputs.TaskSparkInfrastructureSpecContainerImage] = ..., vpc_network: Optional[outputs.TaskSparkInfrastructureSpecVpcNetwork] = ...) -> None:
...
class TaskTriggerSpec(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, disabled: Optional[_builtins.bool] = ..., max_retries: Optional[_builtins.int] = ..., schedule: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ...) -> None:
...
class ZoneDiscoverySpec(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, csv_options: Optional[outputs.ZoneDiscoverySpecCsvOptions] = ..., exclude_patterns: Optional[Sequence[_builtins.str]] = ..., include_patterns: Optional[Sequence[_builtins.str]] = ..., json_options: Optional[outputs.ZoneDiscoverySpecJsonOptions] = ..., schedule: Optional[_builtins.str] = ...) -> None:
...
class GetDataQualityRulesRuleResult(dict):
    def __init__(__self__, *, column: _builtins.str, description: _builtins.str, dimension: _builtins.str, ignore_null: _builtins.bool, name: _builtins.str, non_null_expectations: Sequence[outputs.GetDataQualityRulesRuleNonNullExpectationResult], range_expectations: Sequence[outputs.GetDataQualityRulesRuleRangeExpectationResult], regex_expectations: Sequence[outputs.GetDataQualityRulesRuleRegexExpectationResult], row_condition_expectations: Sequence[outputs.GetDataQualityRulesRuleRowConditionExpectationResult], set_expectations: Sequence[outputs.GetDataQualityRulesRuleSetExpectationResult], sql_assertions: Sequence[outputs.GetDataQualityRulesRuleSqlAssertionResult], statistic_range_expectations: Sequence[outputs.GetDataQualityRulesRuleStatisticRangeExpectationResult], suspended: _builtins.bool, table_condition_expectations: Sequence[outputs.GetDataQualityRulesRuleTableConditionExpectationResult], threshold: _builtins.float, uniqueness_expectations: Sequence[outputs.GetDataQualityRulesRuleUniquenessExpectationResult]) -> None:
...
class GetDataQualityRulesRuleRangeExpectationResult(dict):
    def __init__(__self__, *, max_value: _builtins.str, min_value: _builtins.str, strict_max_enabled: _builtins.bool, strict_min_enabled: _builtins.bool) -> None:
...
class GetDataQualityRulesRuleStatisticRangeExpectationResult(dict):
    def __init__(__self__, *, max_value: _builtins.str, min_value: _builtins.str, statistic: _builtins.str, strict_max_enabled: _builtins.bool, strict_min_enabled: _builtins.bool) -> None:
