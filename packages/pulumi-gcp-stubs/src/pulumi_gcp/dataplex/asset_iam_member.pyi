...
class AssetIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[AssetIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(self, value: Optional[pulumi.Input[AssetIamMemberConditionArgs]]): ...
    @_builtins.property
    @pulumi.getter
...
class AssetIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[AssetIamMemberConditionArgs, AssetIamMemberConditionArgsDict]
            ]
        ] = ...,
        dataplex_zone: Optional[pulumi.Input[_builtins.str]] = ...,
        lake: Optional[pulumi.Input[_builtins.str]] = ...,
