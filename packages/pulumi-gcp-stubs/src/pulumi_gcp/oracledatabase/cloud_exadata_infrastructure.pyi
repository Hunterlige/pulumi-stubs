...
class CloudExadataInfrastructureArgs:
    def __init__(
        ...
        *,
        ...
        properties: Optional[
            pulumi.Input[CloudExadataInfrastructurePropertiesArgs]
        ] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def properties(
        self,
    ) -> Optional[pulumi.Input[CloudExadataInfrastructurePropertiesArgs]]: ...
    @properties.setter
    def properties(
        self, value: Optional[pulumi.Input[CloudExadataInfrastructurePropertiesArgs]]
    ): ...
...
class CloudExadataInfrastructure(pulumi.CustomResource):
    ...
    def properties(
        self,
    ) -> pulumi.Output[Optional[outputs.CloudExadataInfrastructureProperties]]: ...
    @_builtins.property
    @pulumi.getter(name="pulumiLabels")
