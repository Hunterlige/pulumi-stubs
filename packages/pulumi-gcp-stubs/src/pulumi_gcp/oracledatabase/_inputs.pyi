...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AutonomousDatabasePropertiesArgs', 'AutonomousDatabasePropertiesArgsDict', 'AutonomousDatabasePropertiesApexDetailArgs', 'AutonomousDatabasePropertiesApexDetailArgsDict', 'AutonomousDatabasePropertiesConnectionStringArgs', ..., ..., ..., ..., ..., 'AutonomousDatabasePropertiesConnectionUrlArgs', 'AutonomousDatabasePropertiesConnectionUrlArgsDict', 'AutonomousDatabasePropertiesCustomerContactArgs', ..., 'AutonomousDatabasePropertiesLocalStandbyDbArgs', 'AutonomousDatabasePropertiesLocalStandbyDbArgsDict', ..., ..., ..., ..., ..., ..., 'AutonomousDatabaseSourceConfigArgs', 'AutonomousDatabaseSourceConfigArgsDict', 'CloudExadataInfrastructurePropertiesArgs', 'CloudExadataInfrastructurePropertiesArgsDict', ..., ..., ..., ..., 'CloudVmClusterPropertiesArgs', 'CloudVmClusterPropertiesArgsDict', ..., ..., 'CloudVmClusterPropertiesTimeZoneArgs', 'CloudVmClusterPropertiesTimeZoneArgsDict', 'DbSystemPropertiesArgs', 'DbSystemPropertiesArgsDict', 'DbSystemPropertiesDataCollectionOptionsArgs', 'DbSystemPropertiesDataCollectionOptionsArgsDict', 'DbSystemPropertiesDbHomeArgs', 'DbSystemPropertiesDbHomeArgsDict', 'DbSystemPropertiesDbHomeDatabaseArgs', 'DbSystemPropertiesDbHomeDatabaseArgsDict', 'DbSystemPropertiesDbHomeDatabasePropertiesArgs', 'DbSystemPropertiesDbHomeDatabasePropertiesArgsDict', ..., ..., ..., ..., ..., ..., 'DbSystemPropertiesDbSystemOptionsArgs', 'DbSystemPropertiesDbSystemOptionsArgsDict', 'DbSystemPropertiesTimeZoneArgs', 'DbSystemPropertiesTimeZoneArgsDict', 'ExadbVmClusterPropertiesArgs', 'ExadbVmClusterPropertiesArgsDict', 'ExadbVmClusterPropertiesDataCollectionOptionsArgs', ..., 'ExadbVmClusterPropertiesTimeZoneArgs', 'ExadbVmClusterPropertiesTimeZoneArgsDict', 'ExadbVmClusterPropertiesVmFileSystemStorageArgs', ..., 'ExascaleDbStorageVaultPropertiesArgs', 'ExascaleDbStorageVaultPropertiesArgsDict', ..., ..., 'ExascaleDbStorageVaultPropertiesTimeZoneArgs', 'ExascaleDbStorageVaultPropertiesTimeZoneArgsDict']
...
class AutonomousDatabasePropertiesArgs:
    def __init__(__self__, *, db_workload: pulumi.Input[_builtins.str], license_type: pulumi.Input[_builtins.str], actual_used_data_storage_size_tb: Optional[pulumi.Input[_builtins.float]] = ..., allocated_storage_size_tb: Optional[pulumi.Input[_builtins.float]] = ..., apex_details: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesApexDetailArgs]]]] = ..., are_primary_allowlisted_ips_used: Optional[pulumi.Input[_builtins.bool]] = ..., autonomous_container_database_id: Optional[pulumi.Input[_builtins.str]] = ..., available_upgrade_versions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., backup_retention_period_days: Optional[pulumi.Input[_builtins.int]] = ..., character_set: Optional[pulumi.Input[_builtins.str]] = ..., compute_count: Optional[pulumi.Input[_builtins.float]] = ..., connection_strings: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesConnectionStringArgs]]]] = ..., connection_urls: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesConnectionUrlArgs]]]] = ..., cpu_core_count: Optional[pulumi.Input[_builtins.int]] = ..., customer_contacts: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesCustomerContactArgs]]]] = ..., data_safe_state: Optional[pulumi.Input[_builtins.str]] = ..., data_storage_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., data_storage_size_tb: Optional[pulumi.Input[_builtins.int]] = ..., database_management_state: Optional[pulumi.Input[_builtins.str]] = ..., db_edition: Optional[pulumi.Input[_builtins.str]] = ..., db_version: Optional[pulumi.Input[_builtins.str]] = ..., failed_data_recovery_duration: Optional[pulumi.Input[_builtins.str]] = ..., is_auto_scaling_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_local_data_guard_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_storage_auto_scaling_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., lifecycle_details: Optional[pulumi.Input[_builtins.str]] = ..., local_adg_auto_failover_max_data_loss_limit: Optional[pulumi.Input[_builtins.int]] = ..., local_disaster_recovery_type: Optional[pulumi.Input[_builtins.str]] = ..., local_standby_dbs: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesLocalStandbyDbArgs]]]] = ..., maintenance_begin_time: Optional[pulumi.Input[_builtins.str]] = ..., maintenance_end_time: Optional[pulumi.Input[_builtins.str]] = ..., maintenance_schedule_type: Optional[pulumi.Input[_builtins.str]] = ..., memory_per_oracle_compute_unit_gbs: Optional[pulumi.Input[_builtins.int]] = ..., memory_table_gbs: Optional[pulumi.Input[_builtins.int]] = ..., mtls_connection_required: Optional[pulumi.Input[_builtins.bool]] = ..., n_character_set: Optional[pulumi.Input[_builtins.str]] = ..., next_long_term_backup_time: Optional[pulumi.Input[_builtins.str]] = ..., oci_url: Optional[pulumi.Input[_builtins.str]] = ..., ocid: Optional[pulumi.Input[_builtins.str]] = ..., open_mode: Optional[pulumi.Input[_builtins.str]] = ..., operations_insights_state: Optional[pulumi.Input[_builtins.str]] = ..., peer_db_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., permission_level: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint_ip: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoint_label: Optional[pulumi.Input[_builtins.str]] = ..., refreshable_mode: Optional[pulumi.Input[_builtins.str]] = ..., refreshable_state: Optional[pulumi.Input[_builtins.str]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ..., scheduled_operation_details: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesScheduledOperationDetailArgs]]]] = ..., secret_id: Optional[pulumi.Input[_builtins.str]] = ..., sql_web_developer_url: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., supported_clone_regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., total_auto_backup_storage_size_gbs: Optional[pulumi.Input[_builtins.float]] = ..., used_data_storage_size_tbs: Optional[pulumi.Input[_builtins.int]] = ..., vault_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @db_workload.setter
    def db_workload(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def actual_used_data_storage_size_tb(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def allocated_storage_size_tb(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @apex_details.setter
    def apex_details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesApexDetailArgs]]]]): # -> None:
        ...
    ...
    def are_primary_allowlisted_ips_used(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def autonomous_container_database_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def available_upgrade_versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def backup_retention_period_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def character_set(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def compute_count(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def connection_strings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesConnectionStringArgs]]]]): # -> None:
        ...
    ...
    def connection_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesConnectionUrlArgs]]]]): # -> None:
        ...
    ...
    def customer_contacts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesCustomerContactArgs]]]]): # -> None:
        ...
    ...
    def data_safe_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def data_storage_size_gb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def data_storage_size_tb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def database_management_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @db_edition.setter
    def db_edition(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @db_version.setter
    def db_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def failed_data_recovery_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def is_auto_scaling_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_local_data_guard_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_storage_auto_scaling_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def lifecycle_details(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def local_adg_auto_failover_max_data_loss_limit(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def local_disaster_recovery_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def local_standby_dbs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesLocalStandbyDbArgs]]]]): # -> None:
        ...
    ...
    def maintenance_begin_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def maintenance_end_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def maintenance_schedule_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def memory_per_oracle_compute_unit_gbs(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def memory_table_gbs(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def mtls_connection_required(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def n_character_set(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def next_long_term_backup_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @open_mode.setter
    def open_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def operations_insights_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @peer_db_ids.setter
    def peer_db_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def permission_level(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def private_endpoint_ip(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def private_endpoint_label(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def refreshable_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def refreshable_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def scheduled_operation_details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesScheduledOperationDetailArgs]]]]): # -> None:
        ...
    ...
    def sql_web_developer_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def supported_clone_regions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def total_auto_backup_storage_size_gbs(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def used_data_storage_size_tbs(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @vault_id.setter
    def vault_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AutonomousDatabasePropertiesApexDetailArgs:
    def __init__(__self__, *, apex_version: Optional[pulumi.Input[_builtins.str]] = ..., ords_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @apex_version.setter
    def apex_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @ords_version.setter
    def ords_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AutonomousDatabasePropertiesConnectionStringArgs:
    def __init__(__self__, *, all_connection_strings: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesConnectionStringAllConnectionStringArgs]]]] = ..., dedicated: Optional[pulumi.Input[_builtins.str]] = ..., high: Optional[pulumi.Input[_builtins.str]] = ..., low: Optional[pulumi.Input[_builtins.str]] = ..., medium: Optional[pulumi.Input[_builtins.str]] = ..., profiles: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesConnectionStringProfileArgs]]]] = ...) -> None:
    ...
    def all_connection_strings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesConnectionStringAllConnectionStringArgs]]]]): # -> None:
        ...
    ...
    @dedicated.setter
    def dedicated(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @high.setter
    def high(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @low.setter
    def low(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @profiles.setter
    def profiles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesConnectionStringProfileArgs]]]]): # -> None:
        ...
...
class AutonomousDatabasePropertiesConnectionStringAllConnectionStringArgs:
    def __init__(__self__, *, high: Optional[pulumi.Input[_builtins.str]] = ..., low: Optional[pulumi.Input[_builtins.str]] = ..., medium: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AutonomousDatabasePropertiesConnectionStringProfileArgs:
    def __init__(__self__, *, consumer_group: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., host_format: Optional[pulumi.Input[_builtins.str]] = ..., is_regional: Optional[pulumi.Input[_builtins.bool]] = ..., protocol: Optional[pulumi.Input[_builtins.str]] = ..., session_mode: Optional[pulumi.Input[_builtins.str]] = ..., syntax_format: Optional[pulumi.Input[_builtins.str]] = ..., tls_authentication: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @host_format.setter
    def host_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @is_regional.setter
    def is_regional(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @session_mode.setter
    def session_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def syntax_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def tls_authentication(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AutonomousDatabasePropertiesConnectionUrlArgs:
    def __init__(__self__, *, apex_uri: Optional[pulumi.Input[_builtins.str]] = ..., database_transforms_uri: Optional[pulumi.Input[_builtins.str]] = ..., graph_studio_uri: Optional[pulumi.Input[_builtins.str]] = ..., machine_learning_notebook_uri: Optional[pulumi.Input[_builtins.str]] = ..., machine_learning_user_management_uri: Optional[pulumi.Input[_builtins.str]] = ..., mongo_db_uri: Optional[pulumi.Input[_builtins.str]] = ..., ords_uri: Optional[pulumi.Input[_builtins.str]] = ..., sql_dev_web_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @apex_uri.setter
    def apex_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def database_transforms_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def graph_studio_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def machine_learning_notebook_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def machine_learning_user_management_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @mongo_db_uri.setter
    def mongo_db_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @ords_uri.setter
    def ords_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def sql_dev_web_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AutonomousDatabasePropertiesLocalStandbyDbArgs:
    def __init__(__self__, *, data_guard_role_changed_time: Optional[pulumi.Input[_builtins.str]] = ..., disaster_recovery_role_changed_time: Optional[pulumi.Input[_builtins.str]] = ..., lag_time_duration: Optional[pulumi.Input[_builtins.str]] = ..., lifecycle_details: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def data_guard_role_changed_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def disaster_recovery_role_changed_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def lag_time_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AutonomousDatabasePropertiesScheduledOperationDetailArgs:
    def __init__(__self__, *, day_of_week: Optional[pulumi.Input[_builtins.str]] = ..., start_times: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesScheduledOperationDetailStartTimeArgs]]]] = ..., stop_times: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesScheduledOperationDetailStopTimeArgs]]]] = ...) -> None:
    ...
    @start_times.setter
    def start_times(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesScheduledOperationDetailStartTimeArgs]]]]): # -> None:
        ...
    ...
    @stop_times.setter
    def stop_times(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AutonomousDatabasePropertiesScheduledOperationDetailStopTimeArgs]]]]): # -> None:
        ...
...
class AutonomousDatabaseSourceConfigArgs:
    def __init__(__self__, *, automatic_backups_replication_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., autonomous_database: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def automatic_backups_replication_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def autonomous_database(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CloudExadataInfrastructurePropertiesArgs:
    def __init__(__self__, *, shape: pulumi.Input[_builtins.str], activated_storage_count: Optional[pulumi.Input[_builtins.int]] = ..., additional_storage_count: Optional[pulumi.Input[_builtins.int]] = ..., available_storage_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., compute_count: Optional[pulumi.Input[_builtins.int]] = ..., cpu_count: Optional[pulumi.Input[_builtins.int]] = ..., customer_contacts: Optional[pulumi.Input[Sequence[pulumi.Input[CloudExadataInfrastructurePropertiesCustomerContactArgs]]]] = ..., data_storage_size_tb: Optional[pulumi.Input[_builtins.float]] = ..., db_node_storage_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., db_server_version: Optional[pulumi.Input[_builtins.str]] = ..., maintenance_window: Optional[pulumi.Input[CloudExadataInfrastructurePropertiesMaintenanceWindowArgs]] = ..., max_cpu_count: Optional[pulumi.Input[_builtins.int]] = ..., max_data_storage_tb: Optional[pulumi.Input[_builtins.float]] = ..., max_db_node_storage_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., max_memory_gb: Optional[pulumi.Input[_builtins.int]] = ..., memory_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., monthly_db_server_version: Optional[pulumi.Input[_builtins.str]] = ..., monthly_storage_server_version: Optional[pulumi.Input[_builtins.str]] = ..., next_maintenance_run_id: Optional[pulumi.Input[_builtins.str]] = ..., next_maintenance_run_time: Optional[pulumi.Input[_builtins.str]] = ..., next_security_maintenance_run_time: Optional[pulumi.Input[_builtins.str]] = ..., oci_url: Optional[pulumi.Input[_builtins.str]] = ..., ocid: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., storage_count: Optional[pulumi.Input[_builtins.int]] = ..., storage_server_version: Optional[pulumi.Input[_builtins.str]] = ..., total_storage_size_gb: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def available_storage_size_gb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @customer_contacts.setter
    def customer_contacts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CloudExadataInfrastructurePropertiesCustomerContactArgs]]]]): # -> None:
        ...
    ...
    @data_storage_size_tb.setter
    def data_storage_size_tb(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def db_node_storage_size_gb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def maintenance_window(self, value: Optional[pulumi.Input[CloudExadataInfrastructurePropertiesMaintenanceWindowArgs]]): # -> None:
        ...
    ...
    def max_data_storage_tb(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def max_db_node_storage_size_gb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_memory_gb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def memory_size_gb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def next_maintenance_run_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def next_security_maintenance_run_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def total_storage_size_gb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class CloudExadataInfrastructurePropertiesMaintenanceWindowArgs:
    def __init__(__self__, *, custom_action_timeout_mins: Optional[pulumi.Input[_builtins.int]] = ..., days_of_weeks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., hours_of_days: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ..., is_custom_action_timeout_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., lead_time_week: Optional[pulumi.Input[_builtins.int]] = ..., months: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., patching_mode: Optional[pulumi.Input[_builtins.str]] = ..., preference: Optional[pulumi.Input[_builtins.str]] = ..., weeks_of_months: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ...) -> None:
    ...
    def custom_action_timeout_mins(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def days_of_weeks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def hours_of_days(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]): # -> None:
        ...
    ...
    def is_custom_action_timeout_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def lead_time_week(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @months.setter
    def months(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def patching_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @preference.setter
    def preference(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def weeks_of_months(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]): # -> None:
        ...
...
class CloudVmClusterPropertiesArgs:
    def __init__(__self__, *, cpu_core_count: pulumi.Input[_builtins.int], license_type: pulumi.Input[_builtins.str], cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., compartment_id: Optional[pulumi.Input[_builtins.str]] = ..., data_storage_size_tb: Optional[pulumi.Input[_builtins.float]] = ..., db_node_storage_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., db_server_ocids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., diagnostics_data_collection_options: Optional[pulumi.Input[CloudVmClusterPropertiesDiagnosticsDataCollectionOptionsArgs]] = ..., disk_redundancy: Optional[pulumi.Input[_builtins.str]] = ..., dns_listener_ip: Optional[pulumi.Input[_builtins.str]] = ..., domain: Optional[pulumi.Input[_builtins.str]] = ..., gi_version: Optional[pulumi.Input[_builtins.str]] = ..., hostname: Optional[pulumi.Input[_builtins.str]] = ..., hostname_prefix: Optional[pulumi.Input[_builtins.str]] = ..., local_backup_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., memory_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., node_count: Optional[pulumi.Input[_builtins.int]] = ..., oci_url: Optional[pulumi.Input[_builtins.str]] = ..., ocid: Optional[pulumi.Input[_builtins.str]] = ..., ocpu_count: Optional[pulumi.Input[_builtins.float]] = ..., scan_dns: Optional[pulumi.Input[_builtins.str]] = ..., scan_dns_record_id: Optional[pulumi.Input[_builtins.str]] = ..., scan_ip_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., scan_listener_port_tcp: Optional[pulumi.Input[_builtins.int]] = ..., scan_listener_port_tcp_ssl: Optional[pulumi.Input[_builtins.int]] = ..., shape: Optional[pulumi.Input[_builtins.str]] = ..., sparse_diskgroup_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., ssh_public_keys: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., storage_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., system_version: Optional[pulumi.Input[_builtins.str]] = ..., time_zone: Optional[pulumi.Input[CloudVmClusterPropertiesTimeZoneArgs]] = ...) -> None:
    ...
    def compartment_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def db_server_ocids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def diagnostics_data_collection_options(self, value: Optional[pulumi.Input[CloudVmClusterPropertiesDiagnosticsDataCollectionOptionsArgs]]): # -> None:
        ...
    ...
    def dns_listener_ip(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def local_backup_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @ocpu_count.setter
    def ocpu_count(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @scan_dns.setter
    def scan_dns(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def scan_listener_port_tcp_ssl(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def sparse_diskgroup_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @time_zone.setter
    def time_zone(self, value: Optional[pulumi.Input[CloudVmClusterPropertiesTimeZoneArgs]]): # -> None:
        ...
...
class CloudVmClusterPropertiesDiagnosticsDataCollectionOptionsArgs:
    def __init__(__self__, *, diagnostics_events_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., health_monitoring_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., incident_logs_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def diagnostics_events_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def health_monitoring_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def incident_logs_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DbSystemPropertiesArgs:
    def __init__(__self__, *, compute_count: pulumi.Input[_builtins.int], database_edition: pulumi.Input[_builtins.str], initial_data_storage_size_gb: pulumi.Input[_builtins.int], license_model: pulumi.Input[_builtins.str], shape: pulumi.Input[_builtins.str], ssh_public_keys: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], compute_model: Optional[pulumi.Input[_builtins.str]] = ..., data_collection_options: Optional[pulumi.Input[DbSystemPropertiesDataCollectionOptionsArgs]] = ..., data_storage_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., db_home: Optional[pulumi.Input[DbSystemPropertiesDbHomeArgs]] = ..., db_system_options: Optional[pulumi.Input[DbSystemPropertiesDbSystemOptionsArgs]] = ..., domain: Optional[pulumi.Input[_builtins.str]] = ..., hostname: Optional[pulumi.Input[_builtins.str]] = ..., hostname_prefix: Optional[pulumi.Input[_builtins.str]] = ..., lifecycle_state: Optional[pulumi.Input[_builtins.str]] = ..., memory_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., node_count: Optional[pulumi.Input[_builtins.int]] = ..., ocid: Optional[pulumi.Input[_builtins.str]] = ..., private_ip: Optional[pulumi.Input[_builtins.str]] = ..., reco_storage_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., time_zone: Optional[pulumi.Input[DbSystemPropertiesTimeZoneArgs]] = ...) -> None:
    ...
    @compute_count.setter
    def compute_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def database_edition(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def initial_data_storage_size_gb(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def license_model(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def data_collection_options(self, value: Optional[pulumi.Input[DbSystemPropertiesDataCollectionOptionsArgs]]): # -> None:
        ...
    ...
    @db_home.setter
    def db_home(self, value: Optional[pulumi.Input[DbSystemPropertiesDbHomeArgs]]): # -> None:
        ...
    ...
    def db_system_options(self, value: Optional[pulumi.Input[DbSystemPropertiesDbSystemOptionsArgs]]): # -> None:
        ...
    ...
    def reco_storage_size_gb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @time_zone.setter
    def time_zone(self, value: Optional[pulumi.Input[DbSystemPropertiesTimeZoneArgs]]): # -> None:
        ...
...
class DbSystemPropertiesDataCollectionOptionsArgs:
    def __init__(__self__, *, is_diagnostics_events_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_incident_logs_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def is_diagnostics_events_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_incident_logs_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DbSystemPropertiesDbHomeArgs:
    def __init__(__self__, *, database: pulumi.Input[DbSystemPropertiesDbHomeDatabaseArgs], db_version: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[_builtins.str]] = ..., is_unified_auditing_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @database.setter
    def database(self, value: pulumi.Input[DbSystemPropertiesDbHomeDatabaseArgs]): # -> None:
        ...
    ...
    def is_unified_auditing_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DbSystemPropertiesDbHomeDatabaseArgs:
    def __init__(__self__, *, admin_password: pulumi.Input[_builtins.str], database_id: pulumi.Input[_builtins.str], character_set: Optional[pulumi.Input[_builtins.str]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., db_home_name: Optional[pulumi.Input[_builtins.str]] = ..., db_name: Optional[pulumi.Input[_builtins.str]] = ..., db_unique_name: Optional[pulumi.Input[_builtins.str]] = ..., gcp_oracle_zone: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., ncharacter_set: Optional[pulumi.Input[_builtins.str]] = ..., oci_url: Optional[pulumi.Input[_builtins.str]] = ..., ops_insights_status: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[DbSystemPropertiesDbHomeDatabasePropertiesArgs]] = ..., tde_wallet_password: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @db_home_name.setter
    def db_home_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def db_unique_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ncharacter_set(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ops_insights_status(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[DbSystemPropertiesDbHomeDatabasePropertiesArgs]]): # -> None:
        ...
    ...
    def tde_wallet_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DbSystemPropertiesDbHomeDatabasePropertiesArgs:
    def __init__(__self__, *, db_version: pulumi.Input[_builtins.str], database_management_config: Optional[pulumi.Input[DbSystemPropertiesDbHomeDatabasePropertiesDatabaseManagementConfigArgs]] = ..., db_backup_config: Optional[pulumi.Input[DbSystemPropertiesDbHomeDatabasePropertiesDbBackupConfigArgs]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def database_management_config(self, value: Optional[pulumi.Input[DbSystemPropertiesDbHomeDatabasePropertiesDatabaseManagementConfigArgs]]): # -> None:
        ...
    ...
    def db_backup_config(self, value: Optional[pulumi.Input[DbSystemPropertiesDbHomeDatabasePropertiesDbBackupConfigArgs]]): # -> None:
        ...
...
class DbSystemPropertiesDbHomeDatabasePropertiesDatabaseManagementConfigArgs:
    def __init__(__self__, *, management_state: Optional[pulumi.Input[_builtins.str]] = ..., management_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def management_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DbSystemPropertiesDbHomeDatabasePropertiesDbBackupConfigArgs:
    def __init__(__self__, *, auto_backup_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., auto_full_backup_day: Optional[pulumi.Input[_builtins.str]] = ..., auto_full_backup_window: Optional[pulumi.Input[_builtins.str]] = ..., auto_incremental_backup_window: Optional[pulumi.Input[_builtins.str]] = ..., backup_deletion_policy: Optional[pulumi.Input[_builtins.str]] = ..., backup_destination_details: Optional[pulumi.Input[Sequence[pulumi.Input[DbSystemPropertiesDbHomeDatabasePropertiesDbBackupConfigBackupDestinationDetailArgs]]]] = ..., retention_period_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def auto_backup_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def auto_full_backup_day(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def auto_full_backup_window(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def auto_incremental_backup_window(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def backup_deletion_policy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def backup_destination_details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DbSystemPropertiesDbHomeDatabasePropertiesDbBackupConfigBackupDestinationDetailArgs]]]]): # -> None:
        ...
...
class DbSystemPropertiesDbSystemOptionsArgs:
    def __init__(__self__, *, storage_management: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def storage_management(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ExadbVmClusterPropertiesArgsDict(TypedDict):
    ...
    cluster_name: NotRequired[pulumi.Input[_builtins.str]]
    data_collection_options: NotRequired[pulumi.Input[ExadbVmClusterPropertiesDataCollectionOptionsArgsDict]]
    gi_version: NotRequired[pulumi.Input[_builtins.str]]
    hostname: NotRequired[pulumi.Input[_builtins.str]]
...
class ExadbVmClusterPropertiesArgs:
    def __init__(__self__, *, enabled_ecpu_count_per_node: pulumi.Input[_builtins.int], exascale_db_storage_vault: pulumi.Input[_builtins.str], grid_image_id: pulumi.Input[_builtins.str], hostname_prefix: pulumi.Input[_builtins.str], node_count: pulumi.Input[_builtins.int], shape_attribute: pulumi.Input[_builtins.str], ssh_public_keys: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], vm_file_system_storage: pulumi.Input[ExadbVmClusterPropertiesVmFileSystemStorageArgs], additional_ecpu_count_per_node: Optional[pulumi.Input[_builtins.int]] = ..., cluster_name: Optional[pulumi.Input[_builtins.str]] = ..., data_collection_options: Optional[pulumi.Input[ExadbVmClusterPropertiesDataCollectionOptionsArgs]] = ..., gi_version: Optional[pulumi.Input[_builtins.str]] = ..., hostname: Optional[pulumi.Input[_builtins.str]] = ..., license_model: Optional[pulumi.Input[_builtins.str]] = ..., lifecycle_state: Optional[pulumi.Input[_builtins.str]] = ..., memory_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., oci_uri: Optional[pulumi.Input[_builtins.str]] = ..., scan_listener_port_tcp: Optional[pulumi.Input[_builtins.int]] = ..., time_zone: Optional[pulumi.Input[ExadbVmClusterPropertiesTimeZoneArgs]] = ...) -> None:
    ...
    def enabled_ecpu_count_per_node(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def exascale_db_storage_vault(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def grid_image_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def shape_attribute(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def vm_file_system_storage(self, value: pulumi.Input[ExadbVmClusterPropertiesVmFileSystemStorageArgs]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="additionalEcpuCountPerNode")
    def additional_ecpu_count_per_node(self) -> Optional[pulumi.Input[_builtins.int]]:
        
        ...
    
    @additional_ecpu_count_per_node.setter
    def additional_ecpu_count_per_node(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @_builtins.property
    @pulumi.getter(name="dataCollectionOptions")
    def data_collection_options(self) -> Optional[pulumi.Input[ExadbVmClusterPropertiesDataCollectionOptionsArgs]]:
        
        ...
    
    @data_collection_options.setter
    def data_collection_options(self, value: Optional[pulumi.Input[ExadbVmClusterPropertiesDataCollectionOptionsArgs]]): # -> None:
        ...
    ...
    @oci_uri.setter
    def oci_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @_builtins.property
    @pulumi.getter(name="timeZone")
    def time_zone(self) -> Optional[pulumi.Input[ExadbVmClusterPropertiesTimeZoneArgs]]:
        
        ...
    
    @time_zone.setter
    def time_zone(self, value: Optional[pulumi.Input[ExadbVmClusterPropertiesTimeZoneArgs]]): # -> None:
        ...
...
class ExadbVmClusterPropertiesDataCollectionOptionsArgs:
    def __init__(__self__, *, is_diagnostics_events_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_health_monitoring_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., is_incident_logs_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def is_health_monitoring_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ExadbVmClusterPropertiesVmFileSystemStorageArgs:
    def __init__(__self__, *, size_in_gbs_per_node: pulumi.Input[_builtins.int]) -> None:
    ...
    def size_in_gbs_per_node(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ExascaleDbStorageVaultPropertiesArgs:
    def __init__(__self__, *, exascale_db_storage_details: pulumi.Input[ExascaleDbStorageVaultPropertiesExascaleDbStorageDetailsArgs], additional_flash_cache_percent: Optional[pulumi.Input[_builtins.int]] = ..., attached_shape_attributes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., available_shape_attributes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., oci_uri: Optional[pulumi.Input[_builtins.str]] = ..., ocid: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., time_zone: Optional[pulumi.Input[ExascaleDbStorageVaultPropertiesTimeZoneArgs]] = ..., vm_cluster_count: Optional[pulumi.Input[_builtins.int]] = ..., vm_cluster_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def exascale_db_storage_details(self, value: pulumi.Input[ExascaleDbStorageVaultPropertiesExascaleDbStorageDetailsArgs]): # -> None:
        ...
    ...
    def additional_flash_cache_percent(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def attached_shape_attributes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def available_shape_attributes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @time_zone.setter
    def time_zone(self, value: Optional[pulumi.Input[ExascaleDbStorageVaultPropertiesTimeZoneArgs]]): # -> None:
        ...
    ...
    def vm_cluster_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def vm_cluster_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ExascaleDbStorageVaultPropertiesExascaleDbStorageDetailsArgs:
    def __init__(__self__, *, total_size_gbs: pulumi.Input[_builtins.int], available_size_gbs: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def total_size_gbs(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def available_size_gbs(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
