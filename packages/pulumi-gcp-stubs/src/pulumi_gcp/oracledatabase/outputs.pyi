...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AutonomousDatabaseProperties', 'AutonomousDatabasePropertiesApexDetail', 'AutonomousDatabasePropertiesConnectionString', ..., ..., 'AutonomousDatabasePropertiesConnectionUrl', 'AutonomousDatabasePropertiesCustomerContact', 'AutonomousDatabasePropertiesLocalStandbyDb', ..., ..., ..., 'AutonomousDatabaseSourceConfig', 'CloudExadataInfrastructureProperties', ..., ..., 'CloudVmClusterProperties', ..., 'CloudVmClusterPropertiesTimeZone', 'DbSystemProperties', 'DbSystemPropertiesDataCollectionOptions', 'DbSystemPropertiesDbHome', 'DbSystemPropertiesDbHomeDatabase', 'DbSystemPropertiesDbHomeDatabaseProperties', ..., ..., ..., 'DbSystemPropertiesDbSystemOptions', 'DbSystemPropertiesTimeZone', 'ExadbVmClusterProperties', 'ExadbVmClusterPropertiesDataCollectionOptions', 'ExadbVmClusterPropertiesTimeZone', 'ExadbVmClusterPropertiesVmFileSystemStorage', 'ExascaleDbStorageVaultProperties', ..., 'ExascaleDbStorageVaultPropertiesTimeZone', 'GetAutonomousDatabasePropertyResult', 'GetAutonomousDatabasePropertyApexDetailResult', ..., ..., ..., 'GetAutonomousDatabasePropertyConnectionUrlResult', 'GetAutonomousDatabasePropertyCustomerContactResult', 'GetAutonomousDatabasePropertyLocalStandbyDbResult', ..., ..., ..., 'GetAutonomousDatabaseSourceConfigResult', 'GetAutonomousDatabasesAutonomousDatabaseResult', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetCloudExadataInfrastructurePropertyResult', ..., ..., ..., ..., ..., ..., 'GetCloudVmClusterPropertyResult', ..., 'GetCloudVmClusterPropertyTimeZoneResult', 'GetCloudVmClustersCloudVmClusterResult', 'GetCloudVmClustersCloudVmClusterPropertyResult', ..., ..., 'GetDbNodesDbNodeResult', 'GetDbNodesDbNodePropertyResult', 'GetDbServersDbServerResult', 'GetDbServersDbServerPropertyResult']
@pulumi.output_type
class AutonomousDatabaseProperties(dict):
    ...
    def __init__(__self__, *, db_workload: _builtins.str, license_type: _builtins.str, actual_used_data_storage_size_tb: Optional[_builtins.float] = ..., allocated_storage_size_tb: Optional[_builtins.float] = ..., apex_details: Optional[Sequence[outputs.AutonomousDatabasePropertiesApexDetail]] = ..., are_primary_allowlisted_ips_used: Optional[_builtins.bool] = ..., autonomous_container_database_id: Optional[_builtins.str] = ..., available_upgrade_versions: Optional[Sequence[_builtins.str]] = ..., backup_retention_period_days: Optional[_builtins.int] = ..., character_set: Optional[_builtins.str] = ..., compute_count: Optional[_builtins.float] = ..., connection_strings: Optional[Sequence[outputs.AutonomousDatabasePropertiesConnectionString]] = ..., connection_urls: Optional[Sequence[outputs.AutonomousDatabasePropertiesConnectionUrl]] = ..., cpu_core_count: Optional[_builtins.int] = ..., customer_contacts: Optional[Sequence[outputs.AutonomousDatabasePropertiesCustomerContact]] = ..., data_safe_state: Optional[_builtins.str] = ..., data_storage_size_gb: Optional[_builtins.int] = ..., data_storage_size_tb: Optional[_builtins.int] = ..., database_management_state: Optional[_builtins.str] = ..., db_edition: Optional[_builtins.str] = ..., db_version: Optional[_builtins.str] = ..., failed_data_recovery_duration: Optional[_builtins.str] = ..., is_auto_scaling_enabled: Optional[_builtins.bool] = ..., is_local_data_guard_enabled: Optional[_builtins.bool] = ..., is_storage_auto_scaling_enabled: Optional[_builtins.bool] = ..., lifecycle_details: Optional[_builtins.str] = ..., local_adg_auto_failover_max_data_loss_limit: Optional[_builtins.int] = ..., local_disaster_recovery_type: Optional[_builtins.str] = ..., local_standby_dbs: Optional[Sequence[outputs.AutonomousDatabasePropertiesLocalStandbyDb]] = ..., maintenance_begin_time: Optional[_builtins.str] = ..., maintenance_end_time: Optional[_builtins.str] = ..., maintenance_schedule_type: Optional[_builtins.str] = ..., memory_per_oracle_compute_unit_gbs: Optional[_builtins.int] = ..., memory_table_gbs: Optional[_builtins.int] = ..., mtls_connection_required: Optional[_builtins.bool] = ..., n_character_set: Optional[_builtins.str] = ..., next_long_term_backup_time: Optional[_builtins.str] = ..., oci_url: Optional[_builtins.str] = ..., ocid: Optional[_builtins.str] = ..., open_mode: Optional[_builtins.str] = ..., operations_insights_state: Optional[_builtins.str] = ..., peer_db_ids: Optional[Sequence[_builtins.str]] = ..., permission_level: Optional[_builtins.str] = ..., private_endpoint: Optional[_builtins.str] = ..., private_endpoint_ip: Optional[_builtins.str] = ..., private_endpoint_label: Optional[_builtins.str] = ..., refreshable_mode: Optional[_builtins.str] = ..., refreshable_state: Optional[_builtins.str] = ..., role: Optional[_builtins.str] = ..., scheduled_operation_details: Optional[Sequence[outputs.AutonomousDatabasePropertiesScheduledOperationDetail]] = ..., secret_id: Optional[_builtins.str] = ..., sql_web_developer_url: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., supported_clone_regions: Optional[Sequence[_builtins.str]] = ..., total_auto_backup_storage_size_gbs: Optional[_builtins.float] = ..., used_data_storage_size_tbs: Optional[_builtins.int] = ..., vault_id: Optional[_builtins.str] = ...) -> None:
...
class AutonomousDatabasePropertiesApexDetail(dict):
    ...
    def __init__(__self__, *, apex_version: Optional[_builtins.str] = ..., ords_version: Optional[_builtins.str] = ...) -> None:
...
class AutonomousDatabasePropertiesConnectionString(dict):
    ...
    def __init__(__self__, *, all_connection_strings: Optional[Sequence[outputs.AutonomousDatabasePropertiesConnectionStringAllConnectionString]] = ..., dedicated: Optional[_builtins.str] = ..., high: Optional[_builtins.str] = ..., low: Optional[_builtins.str] = ..., medium: Optional[_builtins.str] = ..., profiles: Optional[Sequence[outputs.AutonomousDatabasePropertiesConnectionStringProfile]] = ...) -> None:
...
class AutonomousDatabasePropertiesConnectionStringAllConnectionString(dict):
    def __init__(__self__, *, high: Optional[_builtins.str] = ..., low: Optional[_builtins.str] = ..., medium: Optional[_builtins.str] = ...) -> None:
...
class AutonomousDatabasePropertiesConnectionStringProfile(dict):
    ...
    def __init__(__self__, *, consumer_group: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., host_format: Optional[_builtins.str] = ..., is_regional: Optional[_builtins.bool] = ..., protocol: Optional[_builtins.str] = ..., session_mode: Optional[_builtins.str] = ..., syntax_format: Optional[_builtins.str] = ..., tls_authentication: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class AutonomousDatabasePropertiesConnectionUrl(dict):
    ...
    def __init__(__self__, *, apex_uri: Optional[_builtins.str] = ..., database_transforms_uri: Optional[_builtins.str] = ..., graph_studio_uri: Optional[_builtins.str] = ..., machine_learning_notebook_uri: Optional[_builtins.str] = ..., machine_learning_user_management_uri: Optional[_builtins.str] = ..., mongo_db_uri: Optional[_builtins.str] = ..., ords_uri: Optional[_builtins.str] = ..., sql_dev_web_uri: Optional[_builtins.str] = ...) -> None:
...
class AutonomousDatabasePropertiesLocalStandbyDb(dict):
    ...
    def __init__(__self__, *, data_guard_role_changed_time: Optional[_builtins.str] = ..., disaster_recovery_role_changed_time: Optional[_builtins.str] = ..., lag_time_duration: Optional[_builtins.str] = ..., lifecycle_details: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class AutonomousDatabasePropertiesScheduledOperationDetail(dict):
    ...
    def __init__(__self__, *, day_of_week: Optional[_builtins.str] = ..., start_times: Optional[Sequence[outputs.AutonomousDatabasePropertiesScheduledOperationDetailStartTime]] = ..., stop_times: Optional[Sequence[outputs.AutonomousDatabasePropertiesScheduledOperationDetailStopTime]] = ...) -> None:
...
class AutonomousDatabaseSourceConfig(dict):
    ...
    def __init__(__self__, *, automatic_backups_replication_enabled: Optional[_builtins.bool] = ..., autonomous_database: Optional[_builtins.str] = ...) -> None:
...
class CloudExadataInfrastructureProperties(dict):
    ...
    def __init__(__self__, *, shape: _builtins.str, activated_storage_count: Optional[_builtins.int] = ..., additional_storage_count: Optional[_builtins.int] = ..., available_storage_size_gb: Optional[_builtins.int] = ..., compute_count: Optional[_builtins.int] = ..., cpu_count: Optional[_builtins.int] = ..., customer_contacts: Optional[Sequence[outputs.CloudExadataInfrastructurePropertiesCustomerContact]] = ..., data_storage_size_tb: Optional[_builtins.float] = ..., db_node_storage_size_gb: Optional[_builtins.int] = ..., db_server_version: Optional[_builtins.str] = ..., maintenance_window: Optional[outputs.CloudExadataInfrastructurePropertiesMaintenanceWindow] = ..., max_cpu_count: Optional[_builtins.int] = ..., max_data_storage_tb: Optional[_builtins.float] = ..., max_db_node_storage_size_gb: Optional[_builtins.int] = ..., max_memory_gb: Optional[_builtins.int] = ..., memory_size_gb: Optional[_builtins.int] = ..., monthly_db_server_version: Optional[_builtins.str] = ..., monthly_storage_server_version: Optional[_builtins.str] = ..., next_maintenance_run_id: Optional[_builtins.str] = ..., next_maintenance_run_time: Optional[_builtins.str] = ..., next_security_maintenance_run_time: Optional[_builtins.str] = ..., oci_url: Optional[_builtins.str] = ..., ocid: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., storage_count: Optional[_builtins.int] = ..., storage_server_version: Optional[_builtins.str] = ..., total_storage_size_gb: Optional[_builtins.int] = ...) -> None:
...
class CloudExadataInfrastructurePropertiesMaintenanceWindow(dict):
    ...
    def __init__(__self__, *, custom_action_timeout_mins: Optional[_builtins.int] = ..., days_of_weeks: Optional[Sequence[_builtins.str]] = ..., hours_of_days: Optional[Sequence[_builtins.int]] = ..., is_custom_action_timeout_enabled: Optional[_builtins.bool] = ..., lead_time_week: Optional[_builtins.int] = ..., months: Optional[Sequence[_builtins.str]] = ..., patching_mode: Optional[_builtins.str] = ..., preference: Optional[_builtins.str] = ..., weeks_of_months: Optional[Sequence[_builtins.int]] = ...) -> None:
...
class CloudVmClusterProperties(dict):
    ...
    def __init__(__self__, *, cpu_core_count: _builtins.int, license_type: _builtins.str, cluster_name: Optional[_builtins.str] = ..., compartment_id: Optional[_builtins.str] = ..., data_storage_size_tb: Optional[_builtins.float] = ..., db_node_storage_size_gb: Optional[_builtins.int] = ..., db_server_ocids: Optional[Sequence[_builtins.str]] = ..., diagnostics_data_collection_options: Optional[outputs.CloudVmClusterPropertiesDiagnosticsDataCollectionOptions] = ..., disk_redundancy: Optional[_builtins.str] = ..., dns_listener_ip: Optional[_builtins.str] = ..., domain: Optional[_builtins.str] = ..., gi_version: Optional[_builtins.str] = ..., hostname: Optional[_builtins.str] = ..., hostname_prefix: Optional[_builtins.str] = ..., local_backup_enabled: Optional[_builtins.bool] = ..., memory_size_gb: Optional[_builtins.int] = ..., node_count: Optional[_builtins.int] = ..., oci_url: Optional[_builtins.str] = ..., ocid: Optional[_builtins.str] = ..., ocpu_count: Optional[_builtins.float] = ..., scan_dns: Optional[_builtins.str] = ..., scan_dns_record_id: Optional[_builtins.str] = ..., scan_ip_ids: Optional[Sequence[_builtins.str]] = ..., scan_listener_port_tcp: Optional[_builtins.int] = ..., scan_listener_port_tcp_ssl: Optional[_builtins.int] = ..., shape: Optional[_builtins.str] = ..., sparse_diskgroup_enabled: Optional[_builtins.bool] = ..., ssh_public_keys: Optional[Sequence[_builtins.str]] = ..., state: Optional[_builtins.str] = ..., storage_size_gb: Optional[_builtins.int] = ..., system_version: Optional[_builtins.str] = ..., time_zone: Optional[outputs.CloudVmClusterPropertiesTimeZone] = ...) -> None:
...
class CloudVmClusterPropertiesDiagnosticsDataCollectionOptions(dict):
    ...
    def __init__(__self__, *, diagnostics_events_enabled: Optional[_builtins.bool] = ..., health_monitoring_enabled: Optional[_builtins.bool] = ..., incident_logs_enabled: Optional[_builtins.bool] = ...) -> None:
...
class CloudVmClusterPropertiesTimeZone(dict):
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class DbSystemProperties(dict):
    ...
    def __init__(__self__, *, compute_count: _builtins.int, database_edition: _builtins.str, initial_data_storage_size_gb: _builtins.int, license_model: _builtins.str, shape: _builtins.str, ssh_public_keys: Sequence[_builtins.str], compute_model: Optional[_builtins.str] = ..., data_collection_options: Optional[outputs.DbSystemPropertiesDataCollectionOptions] = ..., data_storage_size_gb: Optional[_builtins.int] = ..., db_home: Optional[outputs.DbSystemPropertiesDbHome] = ..., db_system_options: Optional[outputs.DbSystemPropertiesDbSystemOptions] = ..., domain: Optional[_builtins.str] = ..., hostname: Optional[_builtins.str] = ..., hostname_prefix: Optional[_builtins.str] = ..., lifecycle_state: Optional[_builtins.str] = ..., memory_size_gb: Optional[_builtins.int] = ..., node_count: Optional[_builtins.int] = ..., ocid: Optional[_builtins.str] = ..., private_ip: Optional[_builtins.str] = ..., reco_storage_size_gb: Optional[_builtins.int] = ..., time_zone: Optional[outputs.DbSystemPropertiesTimeZone] = ...) -> None:
...
class DbSystemPropertiesDataCollectionOptions(dict):
    ...
    def __init__(__self__, *, is_diagnostics_events_enabled: Optional[_builtins.bool] = ..., is_incident_logs_enabled: Optional[_builtins.bool] = ...) -> None:
...
class DbSystemPropertiesDbHome(dict):
    ...
    def __init__(__self__, *, database: outputs.DbSystemPropertiesDbHomeDatabase, db_version: _builtins.str, display_name: Optional[_builtins.str] = ..., is_unified_auditing_enabled: Optional[_builtins.bool] = ...) -> None:
...
class DbSystemPropertiesDbHomeDatabase(dict):
    ...
    def __init__(__self__, *, admin_password: _builtins.str, database_id: _builtins.str, character_set: Optional[_builtins.str] = ..., create_time: Optional[_builtins.str] = ..., db_home_name: Optional[_builtins.str] = ..., db_name: Optional[_builtins.str] = ..., db_unique_name: Optional[_builtins.str] = ..., gcp_oracle_zone: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., ncharacter_set: Optional[_builtins.str] = ..., oci_url: Optional[_builtins.str] = ..., ops_insights_status: Optional[_builtins.str] = ..., properties: Optional[outputs.DbSystemPropertiesDbHomeDatabaseProperties] = ..., tde_wallet_password: Optional[_builtins.str] = ...) -> None:
...
class DbSystemPropertiesDbHomeDatabaseProperties(dict):
    ...
    def __init__(__self__, *, db_version: _builtins.str, database_management_config: Optional[outputs.DbSystemPropertiesDbHomeDatabasePropertiesDatabaseManagementConfig] = ..., db_backup_config: Optional[outputs.DbSystemPropertiesDbHomeDatabasePropertiesDbBackupConfig] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class DbSystemPropertiesDbHomeDatabasePropertiesDatabaseManagementConfig(dict):
    ...
    def __init__(__self__, *, management_state: Optional[_builtins.str] = ..., management_type: Optional[_builtins.str] = ...) -> None:
...
class DbSystemPropertiesDbHomeDatabasePropertiesDbBackupConfig(dict):
    ...
    def __init__(__self__, *, auto_backup_enabled: Optional[_builtins.bool] = ..., auto_full_backup_day: Optional[_builtins.str] = ..., auto_full_backup_window: Optional[_builtins.str] = ..., auto_incremental_backup_window: Optional[_builtins.str] = ..., backup_deletion_policy: Optional[_builtins.str] = ..., backup_destination_details: Optional[Sequence[outputs.DbSystemPropertiesDbHomeDatabasePropertiesDbBackupConfigBackupDestinationDetail]] = ..., retention_period_days: Optional[_builtins.int] = ...) -> None:
...
class DbSystemPropertiesDbSystemOptions(dict):
    ...
    def __init__(__self__, *, storage_management: Optional[_builtins.str] = ...) -> None:
...
class ExadbVmClusterProperties(dict):
    ...
    def __init__(__self__, *, enabled_ecpu_count_per_node: _builtins.int, exascale_db_storage_vault: _builtins.str, grid_image_id: _builtins.str, hostname_prefix: _builtins.str, node_count: _builtins.int, shape_attribute: _builtins.str, ssh_public_keys: Sequence[_builtins.str], vm_file_system_storage: outputs.ExadbVmClusterPropertiesVmFileSystemStorage, additional_ecpu_count_per_node: Optional[_builtins.int] = ..., cluster_name: Optional[_builtins.str] = ..., data_collection_options: Optional[outputs.ExadbVmClusterPropertiesDataCollectionOptions] = ..., gi_version: Optional[_builtins.str] = ..., hostname: Optional[_builtins.str] = ..., license_model: Optional[_builtins.str] = ..., lifecycle_state: Optional[_builtins.str] = ..., memory_size_gb: Optional[_builtins.int] = ..., oci_uri: Optional[_builtins.str] = ..., scan_listener_port_tcp: Optional[_builtins.int] = ..., time_zone: Optional[outputs.ExadbVmClusterPropertiesTimeZone] = ...) -> None:
...
class ExadbVmClusterPropertiesDataCollectionOptions(dict):
    ...
    def __init__(__self__, *, is_diagnostics_events_enabled: Optional[_builtins.bool] = ..., is_health_monitoring_enabled: Optional[_builtins.bool] = ..., is_incident_logs_enabled: Optional[_builtins.bool] = ...) -> None:
...
class ExascaleDbStorageVaultProperties(dict):
    ...
    def __init__(__self__, *, exascale_db_storage_details: outputs.ExascaleDbStorageVaultPropertiesExascaleDbStorageDetails, additional_flash_cache_percent: Optional[_builtins.int] = ..., attached_shape_attributes: Optional[Sequence[_builtins.str]] = ..., available_shape_attributes: Optional[Sequence[_builtins.str]] = ..., oci_uri: Optional[_builtins.str] = ..., ocid: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., time_zone: Optional[outputs.ExascaleDbStorageVaultPropertiesTimeZone] = ..., vm_cluster_count: Optional[_builtins.int] = ..., vm_cluster_ids: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ExascaleDbStorageVaultPropertiesExascaleDbStorageDetails(dict):
    ...
    def __init__(__self__, *, total_size_gbs: _builtins.int, available_size_gbs: Optional[_builtins.int] = ...) -> None:
...
class GetAutonomousDatabasePropertyResult(dict):
    def __init__(__self__, *, actual_used_data_storage_size_tb: _builtins.float, allocated_storage_size_tb: _builtins.float, apex_details: Sequence[outputs.GetAutonomousDatabasePropertyApexDetailResult], are_primary_allowlisted_ips_used: _builtins.bool, autonomous_container_database_id: _builtins.str, available_upgrade_versions: Sequence[_builtins.str], backup_retention_period_days: _builtins.int, character_set: _builtins.str, compute_count: _builtins.float, connection_strings: Sequence[outputs.GetAutonomousDatabasePropertyConnectionStringResult], connection_urls: Sequence[outputs.GetAutonomousDatabasePropertyConnectionUrlResult], cpu_core_count: _builtins.int, customer_contacts: Sequence[outputs.GetAutonomousDatabasePropertyCustomerContactResult], data_safe_state: _builtins.str, data_storage_size_gb: _builtins.int, data_storage_size_tb: _builtins.int, database_management_state: _builtins.str, db_edition: _builtins.str, db_version: _builtins.str, db_workload: _builtins.str, failed_data_recovery_duration: _builtins.str, is_auto_scaling_enabled: _builtins.bool, is_local_data_guard_enabled: _builtins.bool, is_storage_auto_scaling_enabled: _builtins.bool, license_type: _builtins.str, lifecycle_details: _builtins.str, local_adg_auto_failover_max_data_loss_limit: _builtins.int, local_disaster_recovery_type: _builtins.str, local_standby_dbs: Sequence[outputs.GetAutonomousDatabasePropertyLocalStandbyDbResult], maintenance_begin_time: _builtins.str, maintenance_end_time: _builtins.str, maintenance_schedule_type: _builtins.str, memory_per_oracle_compute_unit_gbs: _builtins.int, memory_table_gbs: _builtins.int, mtls_connection_required: _builtins.bool, n_character_set: _builtins.str, next_long_term_backup_time: _builtins.str, oci_url: _builtins.str, ocid: _builtins.str, open_mode: _builtins.str, operations_insights_state: _builtins.str, peer_db_ids: Sequence[_builtins.str], permission_level: _builtins.str, private_endpoint: _builtins.str, private_endpoint_ip: _builtins.str, private_endpoint_label: _builtins.str, refreshable_mode: _builtins.str, refreshable_state: _builtins.str, role: _builtins.str, scheduled_operation_details: Sequence[outputs.GetAutonomousDatabasePropertyScheduledOperationDetailResult], secret_id: _builtins.str, sql_web_developer_url: _builtins.str, state: _builtins.str, supported_clone_regions: Sequence[_builtins.str], total_auto_backup_storage_size_gbs: _builtins.float, used_data_storage_size_tbs: _builtins.int, vault_id: _builtins.str) -> None:
...
class GetAutonomousDatabasePropertyApexDetailResult(dict):
    def __init__(__self__, *, apex_version: _builtins.str, ords_version: _builtins.str) -> None:
...
class GetAutonomousDatabasePropertyConnectionStringResult(dict):
    def __init__(__self__, *, all_connection_strings: Sequence[outputs.GetAutonomousDatabasePropertyConnectionStringAllConnectionStringResult], dedicated: _builtins.str, high: _builtins.str, low: _builtins.str, medium: _builtins.str, profiles: Sequence[outputs.GetAutonomousDatabasePropertyConnectionStringProfileResult]) -> None:
...
class GetAutonomousDatabasePropertyConnectionStringAllConnectionStringResult(dict):
    def __init__(__self__, *, high: _builtins.str, low: _builtins.str, medium: _builtins.str) -> None:
...
class GetAutonomousDatabasePropertyConnectionStringProfileResult(dict):
    def __init__(__self__, *, consumer_group: _builtins.str, display_name: _builtins.str, host_format: _builtins.str, is_regional: _builtins.bool, protocol: _builtins.str, session_mode: _builtins.str, syntax_format: _builtins.str, tls_authentication: _builtins.str, value: _builtins.str) -> None:
...
class GetAutonomousDatabasePropertyConnectionUrlResult(dict):
    def __init__(__self__, *, apex_uri: _builtins.str, database_transforms_uri: _builtins.str, graph_studio_uri: _builtins.str, machine_learning_notebook_uri: _builtins.str, machine_learning_user_management_uri: _builtins.str, mongo_db_uri: _builtins.str, ords_uri: _builtins.str, sql_dev_web_uri: _builtins.str) -> None:
...
class GetAutonomousDatabasePropertyLocalStandbyDbResult(dict):
    def __init__(__self__, *, data_guard_role_changed_time: _builtins.str, disaster_recovery_role_changed_time: _builtins.str, lag_time_duration: _builtins.str, lifecycle_details: _builtins.str, state: _builtins.str) -> None:
...
class GetAutonomousDatabasePropertyScheduledOperationDetailResult(dict):
    def __init__(__self__, *, day_of_week: _builtins.str, start_times: Sequence[outputs.GetAutonomousDatabasePropertyScheduledOperationDetailStartTimeResult], stop_times: Sequence[outputs.GetAutonomousDatabasePropertyScheduledOperationDetailStopTimeResult]) -> None:
...
class GetAutonomousDatabaseSourceConfigResult(dict):
    def __init__(__self__, *, automatic_backups_replication_enabled: _builtins.bool, autonomous_database: _builtins.str) -> None:
...
class GetAutonomousDatabasesAutonomousDatabaseResult(dict):
    def __init__(__self__, *, admin_password: _builtins.str, autonomous_database_id: _builtins.str, cidr: _builtins.str, create_time: _builtins.str, database: _builtins.str, deletion_protection: _builtins.bool, disaster_recovery_supported_locations: Sequence[_builtins.str], display_name: _builtins.str, effective_labels: Mapping[str, _builtins.str], entitlement_id: _builtins.str, labels: Mapping[str, _builtins.str], location: _builtins.str, name: _builtins.str, network: _builtins.str, odb_network: _builtins.str, odb_subnet: _builtins.str, peer_autonomous_databases: Sequence[_builtins.str], project: _builtins.str, properties: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabasePropertyResult], pulumi_labels: Mapping[str, _builtins.str], source_configs: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabaseSourceConfigResult]) -> None:
...
class GetAutonomousDatabasesAutonomousDatabasePropertyResult(dict):
    def __init__(__self__, *, actual_used_data_storage_size_tb: _builtins.float, allocated_storage_size_tb: _builtins.float, apex_details: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabasePropertyApexDetailResult], are_primary_allowlisted_ips_used: _builtins.bool, autonomous_container_database_id: _builtins.str, available_upgrade_versions: Sequence[_builtins.str], backup_retention_period_days: _builtins.int, character_set: _builtins.str, compute_count: _builtins.float, connection_strings: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringResult], connection_urls: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrlResult], cpu_core_count: _builtins.int, customer_contacts: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabasePropertyCustomerContactResult], data_safe_state: _builtins.str, data_storage_size_gb: _builtins.int, data_storage_size_tb: _builtins.int, database_management_state: _builtins.str, db_edition: _builtins.str, db_version: _builtins.str, db_workload: _builtins.str, failed_data_recovery_duration: _builtins.str, is_auto_scaling_enabled: _builtins.bool, is_local_data_guard_enabled: _builtins.bool, is_storage_auto_scaling_enabled: _builtins.bool, license_type: _builtins.str, lifecycle_details: _builtins.str, local_adg_auto_failover_max_data_loss_limit: _builtins.int, local_disaster_recovery_type: _builtins.str, local_standby_dbs: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabasePropertyLocalStandbyDbResult], maintenance_begin_time: _builtins.str, maintenance_end_time: _builtins.str, maintenance_schedule_type: _builtins.str, memory_per_oracle_compute_unit_gbs: _builtins.int, memory_table_gbs: _builtins.int, mtls_connection_required: _builtins.bool, n_character_set: _builtins.str, next_long_term_backup_time: _builtins.str, oci_url: _builtins.str, ocid: _builtins.str, open_mode: _builtins.str, operations_insights_state: _builtins.str, peer_db_ids: Sequence[_builtins.str], permission_level: _builtins.str, private_endpoint: _builtins.str, private_endpoint_ip: _builtins.str, private_endpoint_label: _builtins.str, refreshable_mode: _builtins.str, refreshable_state: _builtins.str, role: _builtins.str, scheduled_operation_details: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetailResult], secret_id: _builtins.str, sql_web_developer_url: _builtins.str, state: _builtins.str, supported_clone_regions: Sequence[_builtins.str], total_auto_backup_storage_size_gbs: _builtins.float, used_data_storage_size_tbs: _builtins.int, vault_id: _builtins.str) -> None:
...
class GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringResult(dict):
    def __init__(__self__, *, all_connection_strings: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringAllConnectionStringResult], dedicated: _builtins.str, high: _builtins.str, low: _builtins.str, medium: _builtins.str, profiles: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringProfileResult]) -> None:
...
class GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetailResult(dict):
    def __init__(__self__, *, day_of_week: _builtins.str, start_times: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetailStartTimeResult], stop_times: Sequence[outputs.GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetailStopTimeResult]) -> None:
...
class GetCloudExadataInfrastructurePropertyResult(dict):
    def __init__(__self__, *, activated_storage_count: _builtins.int, additional_storage_count: _builtins.int, available_storage_size_gb: _builtins.int, compute_count: _builtins.int, cpu_count: _builtins.int, customer_contacts: Sequence[outputs.GetCloudExadataInfrastructurePropertyCustomerContactResult], data_storage_size_tb: _builtins.float, db_node_storage_size_gb: _builtins.int, db_server_version: _builtins.str, maintenance_windows: Sequence[outputs.GetCloudExadataInfrastructurePropertyMaintenanceWindowResult], max_cpu_count: _builtins.int, max_data_storage_tb: _builtins.float, max_db_node_storage_size_gb: _builtins.int, max_memory_gb: _builtins.int, memory_size_gb: _builtins.int, monthly_db_server_version: _builtins.str, monthly_storage_server_version: _builtins.str, next_maintenance_run_id: _builtins.str, next_maintenance_run_time: _builtins.str, next_security_maintenance_run_time: _builtins.str, oci_url: _builtins.str, ocid: _builtins.str, shape: _builtins.str, state: _builtins.str, storage_count: _builtins.int, storage_server_version: _builtins.str, total_storage_size_gb: _builtins.int) -> None:
...
class GetCloudExadataInfrastructurePropertyMaintenanceWindowResult(dict):
    def __init__(__self__, *, custom_action_timeout_mins: _builtins.int, days_of_weeks: Sequence[_builtins.str], hours_of_days: Sequence[_builtins.int], is_custom_action_timeout_enabled: _builtins.bool, lead_time_week: _builtins.int, months: Sequence[_builtins.str], patching_mode: _builtins.str, preference: _builtins.str, weeks_of_months: Sequence[_builtins.int]) -> None:
...
class GetCloudExadataInfrastructuresCloudExadataInfrastructureResult(dict):
    def __init__(__self__, *, cloud_exadata_infrastructure_id: _builtins.str, create_time: _builtins.str, deletion_protection: _builtins.bool, display_name: _builtins.str, effective_labels: Mapping[str, _builtins.str], entitlement_id: _builtins.str, gcp_oracle_zone: _builtins.str, labels: Mapping[str, _builtins.str], location: _builtins.str, name: _builtins.str, project: _builtins.str, properties: Sequence[outputs.GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyResult], pulumi_labels: Mapping[str, _builtins.str]) -> None:
...
class GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyResult(dict):
    def __init__(__self__, *, activated_storage_count: _builtins.int, additional_storage_count: _builtins.int, available_storage_size_gb: _builtins.int, compute_count: _builtins.int, cpu_count: _builtins.int, customer_contacts: Sequence[outputs.GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyCustomerContactResult], data_storage_size_tb: _builtins.float, db_node_storage_size_gb: _builtins.int, db_server_version: _builtins.str, maintenance_windows: Sequence[outputs.GetCloudExadataInfrastructuresCloudExadataInfrastructurePropertyMaintenanceWindowResult], max_cpu_count: _builtins.int, max_data_storage_tb: _builtins.float, max_db_node_storage_size_gb: _builtins.int, max_memory_gb: _builtins.int, memory_size_gb: _builtins.int, monthly_db_server_version: _builtins.str, monthly_storage_server_version: _builtins.str, next_maintenance_run_id: _builtins.str, next_maintenance_run_time: _builtins.str, next_security_maintenance_run_time: _builtins.str, oci_url: _builtins.str, ocid: _builtins.str, shape: _builtins.str, state: _builtins.str, storage_count: _builtins.int, storage_server_version: _builtins.str, total_storage_size_gb: _builtins.int) -> None:
...
class GetCloudVmClusterPropertyResult(dict):
    def __init__(__self__, *, cluster_name: _builtins.str, compartment_id: _builtins.str, cpu_core_count: _builtins.int, data_storage_size_tb: _builtins.float, db_node_storage_size_gb: _builtins.int, db_server_ocids: Sequence[_builtins.str], diagnostics_data_collection_options: Sequence[outputs.GetCloudVmClusterPropertyDiagnosticsDataCollectionOptionResult], disk_redundancy: _builtins.str, dns_listener_ip: _builtins.str, domain: _builtins.str, gi_version: _builtins.str, hostname: _builtins.str, hostname_prefix: _builtins.str, license_type: _builtins.str, local_backup_enabled: _builtins.bool, memory_size_gb: _builtins.int, node_count: _builtins.int, oci_url: _builtins.str, ocid: _builtins.str, ocpu_count: _builtins.float, scan_dns: _builtins.str, scan_dns_record_id: _builtins.str, scan_ip_ids: Sequence[_builtins.str], scan_listener_port_tcp: _builtins.int, scan_listener_port_tcp_ssl: _builtins.int, shape: _builtins.str, sparse_diskgroup_enabled: _builtins.bool, ssh_public_keys: Sequence[_builtins.str], state: _builtins.str, storage_size_gb: _builtins.int, system_version: _builtins.str, time_zones: Sequence[outputs.GetCloudVmClusterPropertyTimeZoneResult]) -> None:
...
class GetCloudVmClusterPropertyDiagnosticsDataCollectionOptionResult(dict):
    def __init__(__self__, *, diagnostics_events_enabled: _builtins.bool, health_monitoring_enabled: _builtins.bool, incident_logs_enabled: _builtins.bool) -> None:
...
class GetCloudVmClustersCloudVmClusterResult(dict):
    def __init__(__self__, *, backup_odb_subnet: _builtins.str, backup_subnet_cidr: _builtins.str, cidr: _builtins.str, cloud_vm_cluster_id: _builtins.str, create_time: _builtins.str, deletion_protection: _builtins.bool, display_name: _builtins.str, effective_labels: Mapping[str, _builtins.str], exadata_infrastructure: _builtins.str, gcp_oracle_zone: _builtins.str, labels: Mapping[str, _builtins.str], location: _builtins.str, name: _builtins.str, network: _builtins.str, odb_network: _builtins.str, odb_subnet: _builtins.str, project: _builtins.str, properties: Sequence[outputs.GetCloudVmClustersCloudVmClusterPropertyResult], pulumi_labels: Mapping[str, _builtins.str]) -> None:
...
class GetCloudVmClustersCloudVmClusterPropertyResult(dict):
    def __init__(__self__, *, cluster_name: _builtins.str, compartment_id: _builtins.str, cpu_core_count: _builtins.int, data_storage_size_tb: _builtins.float, db_node_storage_size_gb: _builtins.int, db_server_ocids: Sequence[_builtins.str], diagnostics_data_collection_options: Sequence[outputs.GetCloudVmClustersCloudVmClusterPropertyDiagnosticsDataCollectionOptionResult], disk_redundancy: _builtins.str, dns_listener_ip: _builtins.str, domain: _builtins.str, gi_version: _builtins.str, hostname: _builtins.str, hostname_prefix: _builtins.str, license_type: _builtins.str, local_backup_enabled: _builtins.bool, memory_size_gb: _builtins.int, node_count: _builtins.int, oci_url: _builtins.str, ocid: _builtins.str, ocpu_count: _builtins.float, scan_dns: _builtins.str, scan_dns_record_id: _builtins.str, scan_ip_ids: Sequence[_builtins.str], scan_listener_port_tcp: _builtins.int, scan_listener_port_tcp_ssl: _builtins.int, shape: _builtins.str, sparse_diskgroup_enabled: _builtins.bool, ssh_public_keys: Sequence[_builtins.str], state: _builtins.str, storage_size_gb: _builtins.int, system_version: _builtins.str, time_zones: Sequence[outputs.GetCloudVmClustersCloudVmClusterPropertyTimeZoneResult]) -> None:
...
class GetDbNodesDbNodeResult(dict):
    def __init__(__self__, *, name: _builtins.str, properties: Sequence[outputs.GetDbNodesDbNodePropertyResult]) -> None:
...
class GetDbNodesDbNodePropertyResult(dict):
    def __init__(__self__, *, db_node_storage_size_gb: _builtins.int, db_server_ocid: _builtins.str, hostname: _builtins.str, memory_size_gb: _builtins.int, ocid: _builtins.str, ocpu_count: _builtins.int, state: _builtins.str, total_cpu_core_count: _builtins.int) -> None:
...
class GetDbServersDbServerResult(dict):
    def __init__(__self__, *, display_name: _builtins.str, properties: Sequence[outputs.GetDbServersDbServerPropertyResult]) -> None:
...
class GetDbServersDbServerPropertyResult(dict):
    def __init__(__self__, *, db_node_ids: Sequence[_builtins.str], db_node_storage_size_gb: _builtins.int, max_db_node_storage_size_gb: _builtins.int, max_memory_size_gb: _builtins.int, max_ocpu_count: _builtins.int, memory_size_gb: _builtins.int, ocid: _builtins.str, ocpu_count: _builtins.int, state: _builtins.str, vm_count: _builtins.int) -> None:
