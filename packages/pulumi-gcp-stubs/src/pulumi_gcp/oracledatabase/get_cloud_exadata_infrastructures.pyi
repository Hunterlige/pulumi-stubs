...
class GetCloudExadataInfrastructuresResult:
    ...
    def __init__(__self__, cloud_exadata_infrastructures=..., id=..., location=..., project=...) -> None:
        ...
...
def get_cloud_exadata_infrastructures(location: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetCloudExadataInfrastructuresResult:
    
    ...

def get_cloud_exadata_infrastructures_output(location: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetCloudExadataInfrastructuresResult]:
