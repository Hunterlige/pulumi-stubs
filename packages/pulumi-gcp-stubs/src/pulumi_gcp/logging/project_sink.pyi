...
class ProjectSinkArgs:
    def __init__(__self__, *, destination: pulumi.Input[_builtins.str], bigquery_options: Optional[pulumi.Input[ProjectSinkBigqueryOptionsArgs]] = ..., custom_writer_identity: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[ProjectSinkExclusionArgs]]]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., unique_writer_identity: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def bigquery_options(self, value: Optional[pulumi.Input[ProjectSinkBigqueryOptionsArgs]]): # -> None:
        ...
    ...
    def custom_writer_identity(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @exclusions.setter
    def exclusions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ProjectSinkExclusionArgs]]]]): # -> None:
        ...
    ...
    def unique_writer_identity(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ProjectSink(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., bigquery_options: Optional[pulumi.Input[Union[ProjectSinkBigqueryOptionsArgs, ProjectSinkBigqueryOptionsArgsDict]]] = ..., custom_writer_identity: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ProjectSinkExclusionArgs, ProjectSinkExclusionArgsDict]]]]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., unique_writer_identity: Optional[pulumi.Input[_builtins.bool]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ProjectSinkArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., bigquery_options: Optional[pulumi.Input[Union[ProjectSinkBigqueryOptionsArgs, ProjectSinkBigqueryOptionsArgsDict]]] = ..., custom_writer_identity: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ProjectSinkExclusionArgs, ProjectSinkExclusionArgsDict]]]]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., unique_writer_identity: Optional[pulumi.Input[_builtins.bool]] = ..., writer_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> ProjectSink:
