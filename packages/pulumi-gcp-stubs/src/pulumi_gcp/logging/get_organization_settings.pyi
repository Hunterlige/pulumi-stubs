...
class GetOrganizationSettingsResult:
    ...
    def __init__(__self__, disable_default_sink=..., id=..., kms_key_name=..., kms_service_account_id=..., logging_service_account_id=..., name=..., organization=..., storage_location=...) -> None:
        ...
...
def get_organization_settings(organization: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetOrganizationSettingsResult:
    
    ...

def get_organization_settings_output(organization: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetOrganizationSettingsResult]:
