...
class LogViewIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[LogViewIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[LogViewIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class LogViewIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[LogViewIamMemberConditionArgs, LogViewIamMemberConditionArgsDict]
            ]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.LogViewIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
