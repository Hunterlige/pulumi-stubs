...
class OrganizationSettingsArgs:
    def __init__(__self__, *, organization: pulumi.Input[_builtins.str], disable_default_sink: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key_name: Optional[pulumi.Input[_builtins.str]] = ..., storage_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class _OrganizationSettingsState:
    def __init__(__self__, *, disable_default_sink: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key_name: Optional[pulumi.Input[_builtins.str]] = ..., kms_service_account_id: Optional[pulumi.Input[_builtins.str]] = ..., logging_service_account_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., storage_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class OrganizationSettings(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., disable_default_sink: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key_name: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., storage_location: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: OrganizationSettingsArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., disable_default_sink: Optional[pulumi.Input[_builtins.bool]] = ..., kms_key_name: Optional[pulumi.Input[_builtins.str]] = ..., kms_service_account_id: Optional[pulumi.Input[_builtins.str]] = ..., logging_service_account_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., storage_location: Optional[pulumi.Input[_builtins.str]] = ...) -> OrganizationSettings:
