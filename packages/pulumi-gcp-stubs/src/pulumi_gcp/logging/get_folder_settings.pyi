...
class GetFolderSettingsResult:
    ...
    def __init__(__self__, disable_default_sink=..., folder=..., id=..., kms_key_name=..., kms_service_account_id=..., logging_service_account_id=..., name=..., storage_location=...) -> None:
        ...
...
def get_folder_settings(folder: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetFolderSettingsResult:
    
    ...

def get_folder_settings_output(folder: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetFolderSettingsResult]:
