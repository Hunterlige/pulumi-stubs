...
class OrganizationBucketConfigArgs:
    def __init__(
        ...
        *,
        ...
        cmek_settings: Optional[
            pulumi.Input[OrganizationBucketConfigCmekSettingsArgs]
        ] = ...,
        description: Optional[pulumi.Input[_builtins.str]] = ...,
        index_configs: Optional[
            pulumi.Input[
                Sequence[pulumi.Input[OrganizationBucketConfigIndexConfigArgs]]
            ]
        ] = ...,
    ...
    def cmek_settings(
        self,
    ) -> Optional[pulumi.Input[OrganizationBucketConfigCmekSettingsArgs]]: ...
    @cmek_settings.setter
    def cmek_settings(
        self, value: Optional[pulumi.Input[OrganizationBucketConfigCmekSettingsArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    ...
    def index_configs(
        ...
        pulumi.Input[Sequence[pulumi.Input[OrganizationBucketConfigIndexConfigArgs]]]
    ]: ...
...
class OrganizationBucketConfig(pulumi.CustomResource):
    ...
    def cmek_settings(
        self,
    ) -> pulumi.Output[Optional[outputs.OrganizationBucketConfigCmekSettings]]: ...
    @_builtins.property
    @pulumi.getter
    ...
    def index_configs(
        self,
    ) -> pulumi.Output[Sequence[outputs.OrganizationBucketConfigIndexConfig]]: ...
    @_builtins.property
    @pulumi.getter(name="lifecycleState")
