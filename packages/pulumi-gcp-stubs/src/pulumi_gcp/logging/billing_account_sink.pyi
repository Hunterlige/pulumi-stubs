...
class BillingAccountSinkArgs:
    def __init__(__self__, *, billing_account: pulumi.Input[_builtins.str], destination: pulumi.Input[_builtins.str], bigquery_options: Optional[pulumi.Input[BillingAccountSinkBigqueryOptionsArgs]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[BillingAccountSinkExclusionArgs]]]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def bigquery_options(self, value: Optional[pulumi.Input[BillingAccountSinkBigqueryOptionsArgs]]): # -> None:
        ...
    ...
    @exclusions.setter
    def exclusions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BillingAccountSinkExclusionArgs]]]]): # -> None:
        ...
...
class _BillingAccountSinkState:
    def __init__(__self__, *, bigquery_options: Optional[pulumi.Input[BillingAccountSinkBigqueryOptionsArgs]] = ..., billing_account: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[BillingAccountSinkExclusionArgs]]]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., writer_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class BillingAccountSink(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., bigquery_options: Optional[pulumi.Input[Union[BillingAccountSinkBigqueryOptionsArgs, BillingAccountSinkBigqueryOptionsArgsDict]]] = ..., billing_account: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[Union[BillingAccountSinkExclusionArgs, BillingAccountSinkExclusionArgsDict]]]]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: BillingAccountSinkArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., bigquery_options: Optional[pulumi.Input[Union[BillingAccountSinkBigqueryOptionsArgs, BillingAccountSinkBigqueryOptionsArgsDict]]] = ..., billing_account: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[Union[BillingAccountSinkExclusionArgs, BillingAccountSinkExclusionArgsDict]]]]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., writer_identity: Optional[pulumi.Input[_builtins.str]] = ...) -> BillingAccountSink:
