...
class GetSinkResult:
    ...
    def __init__(__self__, bigquery_options=..., description=..., destination=..., disabled=..., exclusions=..., filter=..., id=..., name=..., writer_identity=...) -> None:
        ...
...
def get_sink(id: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetSinkResult:
    
    ...

def get_sink_output(id: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetSinkResult]:
