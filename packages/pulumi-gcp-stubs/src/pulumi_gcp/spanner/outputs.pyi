...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BackupScheduleEncryptionConfig', 'BackupScheduleFullBackupSpec', 'BackupScheduleIncrementalBackupSpec', 'BackupScheduleSpec', 'BackupScheduleSpecCronSpec', 'DatabaseEncryptionConfig', 'DatabaseIAMBindingCondition', 'DatabaseIAMMemberCondition', 'InstanceAutoscalingConfig', ..., ..., ..., ..., 'InstanceAutoscalingConfigAutoscalingLimits', 'InstanceAutoscalingConfigAutoscalingTargets', 'InstanceConfigReplica', 'InstanceIAMBindingCondition', 'InstanceIAMMemberCondition', 'GetDatabaseEncryptionConfigResult', 'GetInstanceAutoscalingConfigResult', ..., ..., ..., ..., 'GetInstanceAutoscalingConfigAutoscalingLimitResult', ...]
@pulumi.output_type
class BackupScheduleEncryptionConfig(dict):
    ...
    def __init__(__self__, *, encryption_type: _builtins.str, kms_key_name: Optional[_builtins.str] = ..., kms_key_names: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class BackupScheduleSpec(dict):
    ...
    def __init__(__self__, *, cron_spec: Optional[outputs.BackupScheduleSpecCronSpec] = ...) -> None:
...
class DatabaseEncryptionConfig(dict):
    ...
    def __init__(__self__, *, kms_key_name: Optional[_builtins.str] = ..., kms_key_names: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class InstanceAutoscalingConfig(dict):
    ...
    def __init__(__self__, *, asymmetric_autoscaling_options: Optional[Sequence[outputs.InstanceAutoscalingConfigAsymmetricAutoscalingOption]] = ..., autoscaling_limits: Optional[outputs.InstanceAutoscalingConfigAutoscalingLimits] = ..., autoscaling_targets: Optional[outputs.InstanceAutoscalingConfigAutoscalingTargets] = ...) -> None:
...
class InstanceAutoscalingConfigAsymmetricAutoscalingOption(dict):
    ...
    def __init__(__self__, *, overrides: outputs.InstanceAutoscalingConfigAsymmetricAutoscalingOptionOverrides, replica_selection: outputs.InstanceAutoscalingConfigAsymmetricAutoscalingOptionReplicaSelection) -> None:
...
class InstanceAutoscalingConfigAsymmetricAutoscalingOptionOverrides(dict):
    ...
    def __init__(__self__, *, autoscaling_limits: outputs.InstanceAutoscalingConfigAsymmetricAutoscalingOptionOverridesAutoscalingLimits) -> None:
...
class InstanceAutoscalingConfigAsymmetricAutoscalingOptionOverridesAutoscalingLimits(dict):
    ...
    def __init__(__self__, *, max_nodes: _builtins.int, min_nodes: _builtins.int) -> None:
...
class InstanceAutoscalingConfigAutoscalingLimits(dict):
    ...
    def __init__(__self__, *, max_nodes: Optional[_builtins.int] = ..., max_processing_units: Optional[_builtins.int] = ..., min_nodes: Optional[_builtins.int] = ..., min_processing_units: Optional[_builtins.int] = ...) -> None:
...
class InstanceAutoscalingConfigAutoscalingTargets(dict):
    ...
    def __init__(__self__, *, high_priority_cpu_utilization_percent: Optional[_builtins.int] = ..., storage_utilization_percent: Optional[_builtins.int] = ..., total_cpu_utilization_percent: Optional[_builtins.int] = ...) -> None:
...
class InstanceConfigReplica(dict):
    ...
    def __init__(__self__, *, default_leader_location: Optional[_builtins.bool] = ..., location: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class GetDatabaseEncryptionConfigResult(dict):
    def __init__(__self__, *, kms_key_name: _builtins.str, kms_key_names: Sequence[_builtins.str]) -> None:
...
class GetInstanceAutoscalingConfigResult(dict):
    def __init__(__self__, *, asymmetric_autoscaling_options: Sequence[outputs.GetInstanceAutoscalingConfigAsymmetricAutoscalingOptionResult], autoscaling_limits: Sequence[outputs.GetInstanceAutoscalingConfigAutoscalingLimitResult], autoscaling_targets: Sequence[outputs.GetInstanceAutoscalingConfigAutoscalingTargetResult]) -> None:
...
class GetInstanceAutoscalingConfigAsymmetricAutoscalingOptionResult(dict):
    def __init__(__self__, *, overrides: Sequence[outputs.GetInstanceAutoscalingConfigAsymmetricAutoscalingOptionOverrideResult], replica_selections: Sequence[outputs.GetInstanceAutoscalingConfigAsymmetricAutoscalingOptionReplicaSelectionResult]) -> None:
...
class GetInstanceAutoscalingConfigAsymmetricAutoscalingOptionOverrideResult(dict):
    def __init__(__self__, *, autoscaling_limits: Sequence[outputs.GetInstanceAutoscalingConfigAsymmetricAutoscalingOptionOverrideAutoscalingLimitResult]) -> None:
...
class GetInstanceAutoscalingConfigAutoscalingLimitResult(dict):
    def __init__(__self__, *, max_nodes: _builtins.int, max_processing_units: _builtins.int, min_nodes: _builtins.int, min_processing_units: _builtins.int) -> None:
...
class GetInstanceAutoscalingConfigAutoscalingTargetResult(dict):
    def __init__(__self__, *, high_priority_cpu_utilization_percent: _builtins.int, storage_utilization_percent: _builtins.int, total_cpu_utilization_percent: _builtins.int) -> None:
