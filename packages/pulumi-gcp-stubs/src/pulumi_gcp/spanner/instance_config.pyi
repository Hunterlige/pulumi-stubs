...
class InstanceConfigArgs:
    def __init__(
        ...
        *,
        ...
        base_config: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    @replicas.setter
    def replicas(
        self, value: pulumi.Input[Sequence[pulumi.Input[InstanceConfigReplicaArgs]]]
    ): ...
    @_builtins.property
...
class _InstanceConfigState:
    def __init__(
        ...
        *,
        base_config: Optional[pulumi.Input[_builtins.str]] = ...,
        config_type: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def replicas(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[InstanceConfigReplicaArgs]]]]: ...
    @replicas.setter
    def replicas(
        self,
        value: Optional[
    ...
    def __init__(
        ...
        replicas: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[InstanceConfigReplicaArgs, InstanceConfigReplicaArgsDict]
                    ]
                ]
            ]
        ] = ...,
