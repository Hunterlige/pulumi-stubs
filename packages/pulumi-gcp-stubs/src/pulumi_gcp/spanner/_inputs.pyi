...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BackupScheduleEncryptionConfigArgs', 'BackupScheduleEncryptionConfigArgsDict', 'BackupScheduleFullBackupSpecArgs', 'BackupScheduleFullBackupSpecArgsDict', 'BackupScheduleIncrementalBackupSpecArgs', 'BackupScheduleIncrementalBackupSpecArgsDict', 'BackupScheduleSpecArgs', 'BackupScheduleSpecArgsDict', 'BackupScheduleSpecCronSpecArgs', 'BackupScheduleSpecCronSpecArgsDict', 'DatabaseEncryptionConfigArgs', 'DatabaseEncryptionConfigArgsDict', 'DatabaseIAMBindingConditionArgs', 'DatabaseIAMBindingConditionArgsDict', 'DatabaseIAMMemberConditionArgs', 'DatabaseIAMMemberConditionArgsDict', 'InstanceAutoscalingConfigArgs', 'InstanceAutoscalingConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'InstanceAutoscalingConfigAutoscalingLimitsArgs', 'InstanceAutoscalingConfigAutoscalingLimitsArgsDict', 'InstanceAutoscalingConfigAutoscalingTargetsArgs', ..., 'InstanceConfigReplicaArgs', 'InstanceConfigReplicaArgsDict', 'InstanceIAMBindingConditionArgs', 'InstanceIAMBindingConditionArgsDict', 'InstanceIAMMemberConditionArgs', 'InstanceIAMMemberConditionArgsDict']
...
class BackupScheduleEncryptionConfigArgs:
    def __init__(__self__, *, encryption_type: pulumi.Input[_builtins.str], kms_key_name: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def kms_key_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class BackupScheduleSpecArgs:
    def __init__(__self__, *, cron_spec: Optional[pulumi.Input[BackupScheduleSpecCronSpecArgs]] = ...) -> None:
    ...
    @cron_spec.setter
    def cron_spec(self, value: Optional[pulumi.Input[BackupScheduleSpecCronSpecArgs]]): # -> None:
        ...
...
class DatabaseEncryptionConfigArgs:
    def __init__(__self__, *, kms_key_name: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class InstanceAutoscalingConfigArgs:
    def __init__(__self__, *, asymmetric_autoscaling_options: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceAutoscalingConfigAsymmetricAutoscalingOptionArgs]]]] = ..., autoscaling_limits: Optional[pulumi.Input[InstanceAutoscalingConfigAutoscalingLimitsArgs]] = ..., autoscaling_targets: Optional[pulumi.Input[InstanceAutoscalingConfigAutoscalingTargetsArgs]] = ...) -> None:
    ...
    def asymmetric_autoscaling_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceAutoscalingConfigAsymmetricAutoscalingOptionArgs]]]]): # -> None:
        ...
    ...
    def autoscaling_limits(self, value: Optional[pulumi.Input[InstanceAutoscalingConfigAutoscalingLimitsArgs]]): # -> None:
        ...
    ...
    def autoscaling_targets(self, value: Optional[pulumi.Input[InstanceAutoscalingConfigAutoscalingTargetsArgs]]): # -> None:
        ...
...
class InstanceAutoscalingConfigAsymmetricAutoscalingOptionArgs:
    def __init__(__self__, *, overrides: pulumi.Input[InstanceAutoscalingConfigAsymmetricAutoscalingOptionOverridesArgs], replica_selection: pulumi.Input[InstanceAutoscalingConfigAsymmetricAutoscalingOptionReplicaSelectionArgs]) -> None:
    ...
    @overrides.setter
    def overrides(self, value: pulumi.Input[InstanceAutoscalingConfigAsymmetricAutoscalingOptionOverridesArgs]): # -> None:
        ...
    ...
    def replica_selection(self, value: pulumi.Input[InstanceAutoscalingConfigAsymmetricAutoscalingOptionReplicaSelectionArgs]): # -> None:
        ...
...
class InstanceAutoscalingConfigAsymmetricAutoscalingOptionOverridesArgs:
    def __init__(__self__, *, autoscaling_limits: pulumi.Input[InstanceAutoscalingConfigAsymmetricAutoscalingOptionOverridesAutoscalingLimitsArgs]) -> None:
    ...
    @autoscaling_limits.setter
    def autoscaling_limits(self, value: pulumi.Input[InstanceAutoscalingConfigAsymmetricAutoscalingOptionOverridesAutoscalingLimitsArgs]): # -> None:
        ...
...
class InstanceAutoscalingConfigAsymmetricAutoscalingOptionOverridesAutoscalingLimitsArgs:
    def __init__(__self__, *, max_nodes: pulumi.Input[_builtins.int], min_nodes: pulumi.Input[_builtins.int]) -> None:
    ...
    @max_nodes.setter
    def max_nodes(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @min_nodes.setter
    def min_nodes(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class InstanceAutoscalingConfigAutoscalingLimitsArgs:
    def __init__(__self__, *, max_nodes: Optional[pulumi.Input[_builtins.int]] = ..., max_processing_units: Optional[pulumi.Input[_builtins.int]] = ..., min_nodes: Optional[pulumi.Input[_builtins.int]] = ..., min_processing_units: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @max_nodes.setter
    def max_nodes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_processing_units(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @min_nodes.setter
    def min_nodes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def min_processing_units(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class InstanceAutoscalingConfigAutoscalingTargetsArgs:
    def __init__(__self__, *, high_priority_cpu_utilization_percent: Optional[pulumi.Input[_builtins.int]] = ..., storage_utilization_percent: Optional[pulumi.Input[_builtins.int]] = ..., total_cpu_utilization_percent: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def high_priority_cpu_utilization_percent(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def storage_utilization_percent(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def total_cpu_utilization_percent(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class InstanceConfigReplicaArgs:
    def __init__(__self__, *, default_leader_location: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def default_leader_location(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
