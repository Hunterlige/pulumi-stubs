...
class GetDatabaseResult:
    ...
    def __init__(__self__, database_dialect=..., ddls=..., default_time_zone=..., deletion_protection=..., enable_drop_protection=..., encryption_configs=..., id=..., instance=..., name=..., project=..., state=..., version_retention_period=...) -> None:
        ...
