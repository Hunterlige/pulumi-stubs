...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DataAccessScopeAllowedDataAccessLabel', ..., 'DataAccessScopeDeniedDataAccessLabel', 'DataAccessScopeDeniedDataAccessLabelIngestionLabel', 'DataTableColumnInfo', 'DataTableScopeInfo', 'ReferenceListEntry', 'ReferenceListScopeInfo', 'ReferenceListScopeInfoReferenceListScope', 'RetrohuntExecutionInterval', 'RetrohuntProcessInterval', 'RuleCompilationDiagnostic', 'RuleCompilationDiagnosticPosition', 'RuleSeverity', 'WatchlistEntityCount', 'WatchlistEntityPopulationMechanism', 'WatchlistEntityPopulationMechanismManual', 'WatchlistWatchlistUserPreferences']
@pulumi.output_type
class DataAccessScopeAllowedDataAccessLabel(dict):
    ...
    def __init__(__self__, *, asset_namespace: Optional[_builtins.str] = ..., data_access_label: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., ingestion_label: Optional[outputs.DataAccessScopeAllowedDataAccessLabelIngestionLabel] = ..., log_type: Optional[_builtins.str] = ...) -> None:
...
class DataAccessScopeAllowedDataAccessLabelIngestionLabel(dict):
    ...
    def __init__(__self__, *, ingestion_label_key: _builtins.str, ingestion_label_value: Optional[_builtins.str] = ...) -> None:
...
class DataAccessScopeDeniedDataAccessLabel(dict):
    ...
    def __init__(__self__, *, asset_namespace: Optional[_builtins.str] = ..., data_access_label: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., ingestion_label: Optional[outputs.DataAccessScopeDeniedDataAccessLabelIngestionLabel] = ..., log_type: Optional[_builtins.str] = ...) -> None:
...
class DataTableColumnInfo(dict):
    ...
    def __init__(__self__, *, column_index: _builtins.int, original_column: _builtins.str, column_type: Optional[_builtins.str] = ..., key_column: Optional[_builtins.bool] = ..., mapped_column_path: Optional[_builtins.str] = ..., repeated_values: Optional[_builtins.bool] = ...) -> None:
...
class ReferenceListScopeInfo(dict):
    ...
    def __init__(__self__, *, reference_list_scope: Optional[outputs.ReferenceListScopeInfoReferenceListScope] = ...) -> None:
...
class ReferenceListScopeInfoReferenceListScope(dict):
    ...
    def __init__(__self__, *, scope_names: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class RuleCompilationDiagnostic(dict):
    def __init__(__self__, *, message: Optional[_builtins.str] = ..., position: Optional[outputs.RuleCompilationDiagnosticPosition] = ..., severity: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class RuleCompilationDiagnosticPosition(dict):
    ...
    def __init__(__self__, *, end_column: Optional[_builtins.int] = ..., end_line: Optional[_builtins.int] = ..., start_column: Optional[_builtins.int] = ..., start_line: Optional[_builtins.int] = ...) -> None:
...
class WatchlistEntityCount(dict):
    def __init__(__self__, *, asset: Optional[_builtins.int] = ..., user: Optional[_builtins.int] = ...) -> None:
...
class WatchlistEntityPopulationMechanism(dict):
    def __init__(__self__, *, manual: Optional[outputs.WatchlistEntityPopulationMechanismManual] = ...) -> None:
