...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DataAccessScopeAllowedDataAccessLabelArgs', 'DataAccessScopeAllowedDataAccessLabelArgsDict', ..., ..., 'DataAccessScopeDeniedDataAccessLabelArgs', 'DataAccessScopeDeniedDataAccessLabelArgsDict', ..., ..., 'DataTableColumnInfoArgs', 'DataTableColumnInfoArgsDict', 'DataTableScopeInfoArgs', 'DataTableScopeInfoArgsDict', 'ReferenceListEntryArgs', 'ReferenceListEntryArgsDict', 'ReferenceListScopeInfoArgs', 'ReferenceListScopeInfoArgsDict', 'ReferenceListScopeInfoReferenceListScopeArgs', 'ReferenceListScopeInfoReferenceListScopeArgsDict', 'RetrohuntExecutionIntervalArgs', 'RetrohuntExecutionIntervalArgsDict', 'RetrohuntProcessIntervalArgs', 'RetrohuntProcessIntervalArgsDict', 'RuleCompilationDiagnosticArgs', 'RuleCompilationDiagnosticArgsDict', 'RuleCompilationDiagnosticPositionArgs', 'RuleCompilationDiagnosticPositionArgsDict', 'RuleSeverityArgs', 'RuleSeverityArgsDict', 'WatchlistEntityCountArgs', 'WatchlistEntityCountArgsDict', 'WatchlistEntityPopulationMechanismArgs', 'WatchlistEntityPopulationMechanismArgsDict', 'WatchlistEntityPopulationMechanismManualArgs', 'WatchlistEntityPopulationMechanismManualArgsDict', 'WatchlistWatchlistUserPreferencesArgs', 'WatchlistWatchlistUserPreferencesArgsDict']
...
class DataAccessScopeAllowedDataAccessLabelArgs:
    def __init__(__self__, *, asset_namespace: Optional[pulumi.Input[_builtins.str]] = ..., data_access_label: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., ingestion_label: Optional[pulumi.Input[DataAccessScopeAllowedDataAccessLabelIngestionLabelArgs]] = ..., log_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def asset_namespace(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def data_access_label(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ingestion_label(self, value: Optional[pulumi.Input[DataAccessScopeAllowedDataAccessLabelIngestionLabelArgs]]): # -> None:
        ...
    ...
    @log_type.setter
    def log_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataAccessScopeAllowedDataAccessLabelIngestionLabelArgs:
    def __init__(__self__, *, ingestion_label_key: pulumi.Input[_builtins.str], ingestion_label_value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ingestion_label_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def ingestion_label_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataAccessScopeDeniedDataAccessLabelArgs:
    def __init__(__self__, *, asset_namespace: Optional[pulumi.Input[_builtins.str]] = ..., data_access_label: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., ingestion_label: Optional[pulumi.Input[DataAccessScopeDeniedDataAccessLabelIngestionLabelArgs]] = ..., log_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ingestion_label.setter
    def ingestion_label(self, value: Optional[pulumi.Input[DataAccessScopeDeniedDataAccessLabelIngestionLabelArgs]]): # -> None:
        ...
...
class DataTableColumnInfoArgs:
    def __init__(__self__, *, column_index: pulumi.Input[_builtins.int], original_column: pulumi.Input[_builtins.str], column_type: Optional[pulumi.Input[_builtins.str]] = ..., key_column: Optional[pulumi.Input[_builtins.bool]] = ..., mapped_column_path: Optional[pulumi.Input[_builtins.str]] = ..., repeated_values: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @column_index.setter
    def column_index(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def original_column(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @column_type.setter
    def column_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @key_column.setter
    def key_column(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def mapped_column_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def repeated_values(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DataTableScopeInfoArgs:
    def __init__(__self__, *, data_access_scopes: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def data_access_scopes(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class ReferenceListScopeInfoArgs:
    def __init__(__self__, *, reference_list_scope: Optional[pulumi.Input[ReferenceListScopeInfoReferenceListScopeArgs]] = ...) -> None:
    ...
    def reference_list_scope(self, value: Optional[pulumi.Input[ReferenceListScopeInfoReferenceListScopeArgs]]): # -> None:
        ...
...
class ReferenceListScopeInfoReferenceListScopeArgs:
    def __init__(__self__, *, scope_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @scope_names.setter
    def scope_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RetrohuntProcessIntervalArgs:
    def __init__(__self__, *, end_time: pulumi.Input[_builtins.str], start_time: pulumi.Input[_builtins.str]) -> None:
...
class RuleCompilationDiagnosticArgs:
    def __init__(__self__, *, message: Optional[pulumi.Input[_builtins.str]] = ..., position: Optional[pulumi.Input[RuleCompilationDiagnosticPositionArgs]] = ..., severity: Optional[pulumi.Input[_builtins.str]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @position.setter
    def position(self, value: Optional[pulumi.Input[RuleCompilationDiagnosticPositionArgs]]): # -> None:
        ...
...
class RuleCompilationDiagnosticPositionArgs:
    def __init__(__self__, *, end_column: Optional[pulumi.Input[_builtins.int]] = ..., end_line: Optional[pulumi.Input[_builtins.int]] = ..., start_column: Optional[pulumi.Input[_builtins.int]] = ..., start_line: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @end_column.setter
    def end_column(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @end_line.setter
    def end_line(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @start_column.setter
    def start_column(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @start_line.setter
    def start_line(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class WatchlistEntityCountArgs:
    def __init__(__self__, *, asset: Optional[pulumi.Input[_builtins.int]] = ..., user: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @asset.setter
    def asset(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @user.setter
    def user(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class WatchlistEntityPopulationMechanismArgs:
    def __init__(__self__, *, manual: Optional[pulumi.Input[WatchlistEntityPopulationMechanismManualArgs]] = ...) -> None:
    ...
    @manual.setter
    def manual(self, value: Optional[pulumi.Input[WatchlistEntityPopulationMechanismManualArgs]]): # -> None:
        ...
...
class WatchlistWatchlistUserPreferencesArgs:
    def __init__(__self__, *, pinned: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
