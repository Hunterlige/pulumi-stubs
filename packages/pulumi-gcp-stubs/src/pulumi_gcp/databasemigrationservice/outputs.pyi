...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectionProfileAlloydb', 'ConnectionProfileAlloydbSettings', 'ConnectionProfileAlloydbSettingsInitialUser', ..., ..., 'ConnectionProfileCloudsql', 'ConnectionProfileCloudsqlSettings', 'ConnectionProfileCloudsqlSettingsIpConfig', ..., 'ConnectionProfileError', 'ConnectionProfileMysql', 'ConnectionProfileMysqlSsl', 'ConnectionProfileOracle', 'ConnectionProfileOracleForwardSshConnectivity', 'ConnectionProfileOraclePrivateConnectivity', 'ConnectionProfileOracleSsl', 'ConnectionProfileOracleStaticServiceIpConnectivity', 'ConnectionProfilePostgresql', 'ConnectionProfilePostgresqlSsl', 'MigrationJobDumpFlags', 'MigrationJobDumpFlagsDumpFlag', 'MigrationJobError', 'MigrationJobPerformanceConfig', 'MigrationJobReverseSshConnectivity', 'MigrationJobStaticIpConnectivity', 'MigrationJobVpcPeeringConnectivity', 'PrivateConnectionError', 'PrivateConnectionVpcPeeringConfig']
@pulumi.output_type
class ConnectionProfileAlloydb(dict):
    ...
    def __init__(__self__, *, cluster_id: _builtins.str, settings: Optional[outputs.ConnectionProfileAlloydbSettings] = ...) -> None:
...
class ConnectionProfileAlloydbSettings(dict):
    ...
    def __init__(__self__, *, initial_user: outputs.ConnectionProfileAlloydbSettingsInitialUser, vpc_network: _builtins.str, labels: Optional[Mapping[str, _builtins.str]] = ..., primary_instance_settings: Optional[outputs.ConnectionProfileAlloydbSettingsPrimaryInstanceSettings] = ...) -> None:
...
class ConnectionProfileAlloydbSettingsInitialUser(dict):
    ...
    def __init__(__self__, *, password: _builtins.str, user: _builtins.str, password_set: Optional[_builtins.bool] = ...) -> None:
...
class ConnectionProfileAlloydbSettingsPrimaryInstanceSettings(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, machine_config: outputs.ConnectionProfileAlloydbSettingsPrimaryInstanceSettingsMachineConfig, database_flags: Optional[Mapping[str, _builtins.str]] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., private_ip: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfileCloudsql(dict):
    ...
    def __init__(__self__, *, cloud_sql_id: Optional[_builtins.str] = ..., private_ip: Optional[_builtins.str] = ..., public_ip: Optional[_builtins.str] = ..., settings: Optional[outputs.ConnectionProfileCloudsqlSettings] = ...) -> None:
...
class ConnectionProfileCloudsqlSettings(dict):
    ...
    def __init__(__self__, *, source_id: _builtins.str, activation_policy: Optional[_builtins.str] = ..., auto_storage_increase: Optional[_builtins.bool] = ..., cmek_key_name: Optional[_builtins.str] = ..., collation: Optional[_builtins.str] = ..., data_disk_size_gb: Optional[_builtins.str] = ..., data_disk_type: Optional[_builtins.str] = ..., database_flags: Optional[Mapping[str, _builtins.str]] = ..., database_version: Optional[_builtins.str] = ..., edition: Optional[_builtins.str] = ..., ip_config: Optional[outputs.ConnectionProfileCloudsqlSettingsIpConfig] = ..., root_password: Optional[_builtins.str] = ..., root_password_set: Optional[_builtins.bool] = ..., storage_auto_resize_limit: Optional[_builtins.str] = ..., tier: Optional[_builtins.str] = ..., user_labels: Optional[Mapping[str, _builtins.str]] = ..., zone: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfileCloudsqlSettingsIpConfig(dict):
    ...
    def __init__(__self__, *, authorized_networks: Optional[Sequence[outputs.ConnectionProfileCloudsqlSettingsIpConfigAuthorizedNetwork]] = ..., enable_ipv4: Optional[_builtins.bool] = ..., private_network: Optional[_builtins.str] = ..., require_ssl: Optional[_builtins.bool] = ...) -> None:
...
class ConnectionProfileCloudsqlSettingsIpConfigAuthorizedNetwork(dict):
    ...
    def __init__(__self__, *, value: _builtins.str, expire_time: Optional[_builtins.str] = ..., label: Optional[_builtins.str] = ..., ttl: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfileMysql(dict):
    ...
    def __init__(__self__, *, cloud_sql_id: Optional[_builtins.str] = ..., host: Optional[_builtins.str] = ..., password: Optional[_builtins.str] = ..., password_set: Optional[_builtins.bool] = ..., port: Optional[_builtins.int] = ..., ssl: Optional[outputs.ConnectionProfileMysqlSsl] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfileMysqlSsl(dict):
    ...
    def __init__(__self__, *, ca_certificate: Optional[_builtins.str] = ..., client_certificate: Optional[_builtins.str] = ..., client_key: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfileOracle(dict):
    ...
    def __init__(__self__, *, database_service: _builtins.str, host: _builtins.str, password: _builtins.str, port: _builtins.int, username: _builtins.str, forward_ssh_connectivity: Optional[outputs.ConnectionProfileOracleForwardSshConnectivity] = ..., password_set: Optional[_builtins.bool] = ..., private_connectivity: Optional[outputs.ConnectionProfileOraclePrivateConnectivity] = ..., ssl: Optional[outputs.ConnectionProfileOracleSsl] = ..., static_service_ip_connectivity: Optional[outputs.ConnectionProfileOracleStaticServiceIpConnectivity] = ...) -> None:
...
class ConnectionProfileOracleForwardSshConnectivity(dict):
    ...
    def __init__(__self__, *, hostname: _builtins.str, port: _builtins.int, username: _builtins.str, password: Optional[_builtins.str] = ..., private_key: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfilePostgresql(dict):
    ...
    def __init__(__self__, *, alloydb_cluster_id: Optional[_builtins.str] = ..., cloud_sql_id: Optional[_builtins.str] = ..., host: Optional[_builtins.str] = ..., network_architecture: Optional[_builtins.str] = ..., password: Optional[_builtins.str] = ..., password_set: Optional[_builtins.bool] = ..., port: Optional[_builtins.int] = ..., ssl: Optional[outputs.ConnectionProfilePostgresqlSsl] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class MigrationJobDumpFlags(dict):
    ...
    def __init__(__self__, *, dump_flags: Optional[Sequence[outputs.MigrationJobDumpFlagsDumpFlag]] = ...) -> None:
...
class MigrationJobPerformanceConfig(dict):
    ...
    def __init__(__self__, *, dump_parallel_level: Optional[_builtins.str] = ...) -> None:
...
class MigrationJobReverseSshConnectivity(dict):
    ...
    def __init__(__self__, *, vm: Optional[_builtins.str] = ..., vm_ip: Optional[_builtins.str] = ..., vm_port: Optional[_builtins.int] = ..., vpc: Optional[_builtins.str] = ...) -> None:
...
class PrivateConnectionVpcPeeringConfig(dict):
    ...
    def __init__(__self__, *, subnet: _builtins.str, vpc_name: _builtins.str) -> None:
