...
class WorkforcePoolProviderScimTenantArgs:
    def __init__(__self__, *, location: pulumi.Input[_builtins.str], provider_id: pulumi.Input[_builtins.str], scim_tenant_id: pulumi.Input[_builtins.str], workforce_pool_id: pulumi.Input[_builtins.str], claim_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., hard_delete: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def claim_mapping(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @hard_delete.setter
    def hard_delete(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class _WorkforcePoolProviderScimTenantState:
    def __init__(__self__, *, base_uri: Optional[pulumi.Input[_builtins.str]] = ..., claim_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., hard_delete: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., provider_id: Optional[pulumi.Input[_builtins.str]] = ..., purge_time: Optional[pulumi.Input[_builtins.str]] = ..., scim_tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., service_agent: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., workforce_pool_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @base_uri.setter
    def base_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def service_agent(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkforcePoolProviderScimTenant(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., claim_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., hard_delete: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., provider_id: Optional[pulumi.Input[_builtins.str]] = ..., scim_tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., workforce_pool_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: WorkforcePoolProviderScimTenantArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., base_uri: Optional[pulumi.Input[_builtins.str]] = ..., claim_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., hard_delete: Optional[pulumi.Input[_builtins.bool]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., provider_id: Optional[pulumi.Input[_builtins.str]] = ..., purge_time: Optional[pulumi.Input[_builtins.str]] = ..., scim_tenant_id: Optional[pulumi.Input[_builtins.str]] = ..., service_agent: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., workforce_pool_id: Optional[pulumi.Input[_builtins.str]] = ...) -> WorkforcePoolProviderScimTenant:
