...
class WorkloadIdentityPoolIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[WorkloadIdentityPoolIamMemberConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[WorkloadIdentityPoolIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[WorkloadIdentityPoolIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class WorkloadIdentityPoolIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.WorkloadIdentityPoolIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
