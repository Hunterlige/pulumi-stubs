...
__all__ = ["IcebergNamespaceIamMemberArgs", "IcebergNamespaceIamMember"]

@pulumi.input_type
class IcebergNamespaceIamMemberArgs:
    def __init__(
        __self__,
        *,
        ...
        condition: Optional[pulumi.Input[IcebergNamespaceIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[IcebergNamespaceIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[IcebergNamespaceIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
@pulumi.input_type
class _IcebergNamespaceIamMemberState:
    def __init__(
        __self__,
        *,
...
@pulumi.type_token(...)
class IcebergNamespaceIamMember(pulumi.CustomResource):
    @overload
    def __init__(
        __self__,
        resource_name: str,
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: IcebergNamespaceIamMemberArgs,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.IcebergNamespaceIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
