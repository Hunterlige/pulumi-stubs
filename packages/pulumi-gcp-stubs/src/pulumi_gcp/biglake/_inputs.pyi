...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DatabaseHiveOptionsArgs', 'DatabaseHiveOptionsArgsDict', 'IcebergCatalogIamBindingConditionArgs', 'IcebergCatalogIamBindingConditionArgsDict', 'IcebergCatalogIamMemberConditionArgs', 'IcebergCatalogIamMemberConditionArgsDict', 'IcebergCatalogReplicaArgs', 'IcebergCatalogReplicaArgsDict', 'IcebergNamespaceIamBindingConditionArgs', 'IcebergNamespaceIamBindingConditionArgsDict', 'IcebergNamespaceIamMemberConditionArgs', 'IcebergNamespaceIamMemberConditionArgsDict', 'IcebergTableIamBindingConditionArgs', 'IcebergTableIamBindingConditionArgsDict', 'IcebergTableIamMemberConditionArgs', 'IcebergTableIamMemberConditionArgsDict', 'IcebergTablePartitionSpecArgs', 'IcebergTablePartitionSpecArgsDict', 'IcebergTablePartitionSpecFieldArgs', 'IcebergTablePartitionSpecFieldArgsDict', 'IcebergTableSchemaArgs', 'IcebergTableSchemaArgsDict', 'IcebergTableSchemaFieldArgs', 'IcebergTableSchemaFieldArgsDict', 'TableHiveOptionsArgs', 'TableHiveOptionsArgsDict', 'TableHiveOptionsStorageDescriptorArgs', 'TableHiveOptionsStorageDescriptorArgsDict']
...
class DatabaseHiveOptionsArgs:
    def __init__(__self__, *, location_uri: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class IcebergCatalogReplicaArgs:
    def __init__(__self__, *, region: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class IcebergTablePartitionSpecArgs:
    def __init__(__self__, *, fields: pulumi.Input[Sequence[pulumi.Input[IcebergTablePartitionSpecFieldArgs]]], spec_id: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @fields.setter
    def fields(self, value: pulumi.Input[Sequence[pulumi.Input[IcebergTablePartitionSpecFieldArgs]]]): # -> None:
        ...
...
class IcebergTableSchemaArgs:
    def __init__(__self__, *, fields: pulumi.Input[Sequence[pulumi.Input[IcebergTableSchemaFieldArgs]]], identifier_field_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ..., schema_id: Optional[pulumi.Input[_builtins.int]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @fields.setter
    def fields(self, value: pulumi.Input[Sequence[pulumi.Input[IcebergTableSchemaFieldArgs]]]): # -> None:
        ...
...
class IcebergTableSchemaFieldArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.int], name: pulumi.Input[_builtins.str], required: pulumi.Input[_builtins.bool], type: pulumi.Input[_builtins.str], doc: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TableHiveOptionsArgs:
    def __init__(__self__, *, parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., storage_descriptor: Optional[pulumi.Input[TableHiveOptionsStorageDescriptorArgs]] = ..., table_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def storage_descriptor(self, value: Optional[pulumi.Input[TableHiveOptionsStorageDescriptorArgs]]): # -> None:
        ...
...
class TableHiveOptionsStorageDescriptorArgs:
    def __init__(__self__, *, input_format: Optional[pulumi.Input[_builtins.str]] = ..., location_uri: Optional[pulumi.Input[_builtins.str]] = ..., output_format: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
