...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApplicationFeatureSettingsArgs', 'ApplicationFeatureSettingsArgsDict', 'ApplicationIapArgs', 'ApplicationIapArgsDict', 'ApplicationUrlDispatchRuleArgs', 'ApplicationUrlDispatchRuleArgsDict', 'ApplicationUrlDispatchRulesDispatchRuleArgs', 'ApplicationUrlDispatchRulesDispatchRuleArgsDict', 'DomainMappingResourceRecordArgs', 'DomainMappingResourceRecordArgsDict', 'DomainMappingSslSettingsArgs', 'DomainMappingSslSettingsArgsDict', 'EngineSplitTrafficSplitArgs', 'EngineSplitTrafficSplitArgsDict', 'FlexibleAppVersionApiConfigArgs', 'FlexibleAppVersionApiConfigArgsDict', 'FlexibleAppVersionAutomaticScalingArgs', 'FlexibleAppVersionAutomaticScalingArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'FlexibleAppVersionDeploymentArgs', 'FlexibleAppVersionDeploymentArgsDict', 'FlexibleAppVersionDeploymentCloudBuildOptionsArgs', ..., 'FlexibleAppVersionDeploymentContainerArgs', 'FlexibleAppVersionDeploymentContainerArgsDict', 'FlexibleAppVersionDeploymentFileArgs', 'FlexibleAppVersionDeploymentFileArgsDict', 'FlexibleAppVersionDeploymentZipArgs', 'FlexibleAppVersionDeploymentZipArgsDict', 'FlexibleAppVersionEndpointsApiServiceArgs', 'FlexibleAppVersionEndpointsApiServiceArgsDict', 'FlexibleAppVersionEntrypointArgs', 'FlexibleAppVersionEntrypointArgsDict', 'FlexibleAppVersionFlexibleRuntimeSettingsArgs', 'FlexibleAppVersionFlexibleRuntimeSettingsArgsDict', 'FlexibleAppVersionHandlerArgs', 'FlexibleAppVersionHandlerArgsDict', 'FlexibleAppVersionHandlerScriptArgs', 'FlexibleAppVersionHandlerScriptArgsDict', 'FlexibleAppVersionHandlerStaticFilesArgs', 'FlexibleAppVersionHandlerStaticFilesArgsDict', 'FlexibleAppVersionLivenessCheckArgs', 'FlexibleAppVersionLivenessCheckArgsDict', 'FlexibleAppVersionManualScalingArgs', 'FlexibleAppVersionManualScalingArgsDict', 'FlexibleAppVersionNetworkArgs', 'FlexibleAppVersionNetworkArgsDict', 'FlexibleAppVersionReadinessCheckArgs', 'FlexibleAppVersionReadinessCheckArgsDict', 'FlexibleAppVersionResourcesArgs', 'FlexibleAppVersionResourcesArgsDict', 'FlexibleAppVersionResourcesVolumeArgs', 'FlexibleAppVersionResourcesVolumeArgsDict', 'FlexibleAppVersionVpcAccessConnectorArgs', 'FlexibleAppVersionVpcAccessConnectorArgsDict', 'ServiceNetworkSettingsNetworkSettingsArgs', 'ServiceNetworkSettingsNetworkSettingsArgsDict', 'StandardAppVersionAutomaticScalingArgs', 'StandardAppVersionAutomaticScalingArgsDict', ..., ..., 'StandardAppVersionBasicScalingArgs', 'StandardAppVersionBasicScalingArgsDict', 'StandardAppVersionDeploymentArgs', 'StandardAppVersionDeploymentArgsDict', 'StandardAppVersionDeploymentFileArgs', 'StandardAppVersionDeploymentFileArgsDict', 'StandardAppVersionDeploymentZipArgs', 'StandardAppVersionDeploymentZipArgsDict', 'StandardAppVersionEntrypointArgs', 'StandardAppVersionEntrypointArgsDict', 'StandardAppVersionHandlerArgs', 'StandardAppVersionHandlerArgsDict', 'StandardAppVersionHandlerScriptArgs', 'StandardAppVersionHandlerScriptArgsDict', 'StandardAppVersionHandlerStaticFilesArgs', 'StandardAppVersionHandlerStaticFilesArgsDict', 'StandardAppVersionLibraryArgs', 'StandardAppVersionLibraryArgsDict', 'StandardAppVersionManualScalingArgs', 'StandardAppVersionManualScalingArgsDict', 'StandardAppVersionVpcAccessConnectorArgs', 'StandardAppVersionVpcAccessConnectorArgsDict']
...
class ApplicationFeatureSettingsArgs:
    def __init__(__self__, *, split_health_checks: pulumi.Input[_builtins.bool]) -> None:
    ...
    def split_health_checks(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class ApplicationIapArgs:
    def __init__(__self__, *, oauth2_client_id: pulumi.Input[_builtins.str], oauth2_client_secret: pulumi.Input[_builtins.str], enabled: Optional[pulumi.Input[_builtins.bool]] = ..., oauth2_client_secret_sha256: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def oauth2_client_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def oauth2_client_secret(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def oauth2_client_secret_sha256(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApplicationUrlDispatchRuleArgs:
    def __init__(__self__, *, domain: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., service: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        ...
...
class ApplicationUrlDispatchRulesDispatchRuleArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], service: pulumi.Input[_builtins.str], domain: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DomainMappingResourceRecordArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., rrdata: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @rrdata.setter
    def rrdata(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DomainMappingSslSettingsArgs:
    def __init__(__self__, *, ssl_management_type: pulumi.Input[_builtins.str], certificate_id: Optional[pulumi.Input[_builtins.str]] = ..., pending_managed_certificate_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ssl_management_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def pending_managed_certificate_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EngineSplitTrafficSplitArgs:
    def __init__(__self__, *, allocations: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], shard_by: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @allocations.setter
    def allocations(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @shard_by.setter
    def shard_by(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FlexibleAppVersionApiConfigArgs:
    def __init__(__self__, *, script: pulumi.Input[_builtins.str], auth_fail_action: Optional[pulumi.Input[_builtins.str]] = ..., login: Optional[pulumi.Input[_builtins.str]] = ..., security_level: Optional[pulumi.Input[_builtins.str]] = ..., url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def auth_fail_action(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @login.setter
    def login(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def security_level(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FlexibleAppVersionAutomaticScalingArgs:
    def __init__(__self__, *, cpu_utilization: pulumi.Input[FlexibleAppVersionAutomaticScalingCpuUtilizationArgs], cool_down_period: Optional[pulumi.Input[_builtins.str]] = ..., disk_utilization: Optional[pulumi.Input[FlexibleAppVersionAutomaticScalingDiskUtilizationArgs]] = ..., max_concurrent_requests: Optional[pulumi.Input[_builtins.int]] = ..., max_idle_instances: Optional[pulumi.Input[_builtins.int]] = ..., max_pending_latency: Optional[pulumi.Input[_builtins.str]] = ..., max_total_instances: Optional[pulumi.Input[_builtins.int]] = ..., min_idle_instances: Optional[pulumi.Input[_builtins.int]] = ..., min_pending_latency: Optional[pulumi.Input[_builtins.str]] = ..., min_total_instances: Optional[pulumi.Input[_builtins.int]] = ..., network_utilization: Optional[pulumi.Input[FlexibleAppVersionAutomaticScalingNetworkUtilizationArgs]] = ..., request_utilization: Optional[pulumi.Input[FlexibleAppVersionAutomaticScalingRequestUtilizationArgs]] = ...) -> None:
    ...
    def cpu_utilization(self, value: pulumi.Input[FlexibleAppVersionAutomaticScalingCpuUtilizationArgs]): # -> None:
        ...
    ...
    def cool_down_period(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def disk_utilization(self, value: Optional[pulumi.Input[FlexibleAppVersionAutomaticScalingDiskUtilizationArgs]]): # -> None:
        ...
    ...
    def max_concurrent_requests(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_idle_instances(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_pending_latency(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_total_instances(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def min_idle_instances(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def min_pending_latency(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def min_total_instances(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def network_utilization(self, value: Optional[pulumi.Input[FlexibleAppVersionAutomaticScalingNetworkUtilizationArgs]]): # -> None:
        ...
    ...
    def request_utilization(self, value: Optional[pulumi.Input[FlexibleAppVersionAutomaticScalingRequestUtilizationArgs]]): # -> None:
        ...
...
class FlexibleAppVersionAutomaticScalingCpuUtilizationArgs:
    def __init__(__self__, *, target_utilization: pulumi.Input[_builtins.float], aggregation_window_length: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def target_utilization(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def aggregation_window_length(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FlexibleAppVersionAutomaticScalingDiskUtilizationArgs:
    def __init__(__self__, *, target_read_bytes_per_second: Optional[pulumi.Input[_builtins.int]] = ..., target_read_ops_per_second: Optional[pulumi.Input[_builtins.int]] = ..., target_write_bytes_per_second: Optional[pulumi.Input[_builtins.int]] = ..., target_write_ops_per_second: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def target_read_bytes_per_second(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def target_read_ops_per_second(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def target_write_bytes_per_second(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def target_write_ops_per_second(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class FlexibleAppVersionAutomaticScalingNetworkUtilizationArgs:
    def __init__(__self__, *, target_received_bytes_per_second: Optional[pulumi.Input[_builtins.int]] = ..., target_received_packets_per_second: Optional[pulumi.Input[_builtins.int]] = ..., target_sent_bytes_per_second: Optional[pulumi.Input[_builtins.int]] = ..., target_sent_packets_per_second: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def target_received_bytes_per_second(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def target_received_packets_per_second(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def target_sent_bytes_per_second(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def target_sent_packets_per_second(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class FlexibleAppVersionAutomaticScalingRequestUtilizationArgs:
    def __init__(__self__, *, target_concurrent_requests: Optional[pulumi.Input[_builtins.float]] = ..., target_request_count_per_second: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def target_concurrent_requests(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def target_request_count_per_second(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FlexibleAppVersionDeploymentArgs:
    def __init__(__self__, *, cloud_build_options: Optional[pulumi.Input[FlexibleAppVersionDeploymentCloudBuildOptionsArgs]] = ..., container: Optional[pulumi.Input[FlexibleAppVersionDeploymentContainerArgs]] = ..., files: Optional[pulumi.Input[Sequence[pulumi.Input[FlexibleAppVersionDeploymentFileArgs]]]] = ..., zip: Optional[pulumi.Input[FlexibleAppVersionDeploymentZipArgs]] = ...) -> None:
    ...
    def cloud_build_options(self, value: Optional[pulumi.Input[FlexibleAppVersionDeploymentCloudBuildOptionsArgs]]): # -> None:
        ...
    ...
    @container.setter
    def container(self, value: Optional[pulumi.Input[FlexibleAppVersionDeploymentContainerArgs]]): # -> None:
        ...
    ...
    @files.setter
    def files(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FlexibleAppVersionDeploymentFileArgs]]]]): # -> None:
        ...
    ...
    @zip.setter
    def zip(self, value: Optional[pulumi.Input[FlexibleAppVersionDeploymentZipArgs]]): # -> None:
        ...
...
class FlexibleAppVersionDeploymentCloudBuildOptionsArgs:
    def __init__(__self__, *, app_yaml_path: pulumi.Input[_builtins.str], cloud_build_timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def app_yaml_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def cloud_build_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FlexibleAppVersionDeploymentFileArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], source_url: pulumi.Input[_builtins.str], sha1_sum: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @sha1_sum.setter
    def sha1_sum(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FlexibleAppVersionDeploymentZipArgs:
    def __init__(__self__, *, source_url: pulumi.Input[_builtins.str], files_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @files_count.setter
    def files_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class FlexibleAppVersionEndpointsApiServiceArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], config_id: Optional[pulumi.Input[_builtins.str]] = ..., disable_trace_sampling: Optional[pulumi.Input[_builtins.bool]] = ..., rollout_strategy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disable_trace_sampling(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def rollout_strategy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FlexibleAppVersionEntrypointArgs:
    ...
    @shell.setter
    def shell(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class FlexibleAppVersionFlexibleRuntimeSettingsArgs:
    def __init__(__self__, *, operating_system: Optional[pulumi.Input[_builtins.str]] = ..., runtime_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FlexibleAppVersionHandlerArgs:
    def __init__(__self__, *, auth_fail_action: Optional[pulumi.Input[_builtins.str]] = ..., login: Optional[pulumi.Input[_builtins.str]] = ..., redirect_http_response_code: Optional[pulumi.Input[_builtins.str]] = ..., script: Optional[pulumi.Input[FlexibleAppVersionHandlerScriptArgs]] = ..., security_level: Optional[pulumi.Input[_builtins.str]] = ..., static_files: Optional[pulumi.Input[FlexibleAppVersionHandlerStaticFilesArgs]] = ..., url_regex: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def redirect_http_response_code(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @script.setter
    def script(self, value: Optional[pulumi.Input[FlexibleAppVersionHandlerScriptArgs]]): # -> None:
        ...
    ...
    @static_files.setter
    def static_files(self, value: Optional[pulumi.Input[FlexibleAppVersionHandlerStaticFilesArgs]]): # -> None:
        ...
    ...
    @url_regex.setter
    def url_regex(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FlexibleAppVersionHandlerScriptArgs:
    ...
    @script_path.setter
    def script_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class FlexibleAppVersionHandlerStaticFilesArgs:
    def __init__(__self__, *, application_readable: Optional[pulumi.Input[_builtins.bool]] = ..., expiration: Optional[pulumi.Input[_builtins.str]] = ..., http_headers: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., mime_type: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., require_matching_file: Optional[pulumi.Input[_builtins.bool]] = ..., upload_path_regex: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def application_readable(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def require_matching_file(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def upload_path_regex(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FlexibleAppVersionLivenessCheckArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], check_interval: Optional[pulumi.Input[_builtins.str]] = ..., failure_threshold: Optional[pulumi.Input[_builtins.float]] = ..., host: Optional[pulumi.Input[_builtins.str]] = ..., initial_delay: Optional[pulumi.Input[_builtins.str]] = ..., success_threshold: Optional[pulumi.Input[_builtins.float]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def check_interval(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def failure_threshold(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def success_threshold(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class FlexibleAppVersionManualScalingArgs:
    ...
    @instances.setter
    def instances(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class FlexibleAppVersionNetworkArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], forwarded_ports: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., instance_ip_mode: Optional[pulumi.Input[_builtins.str]] = ..., instance_tag: Optional[pulumi.Input[_builtins.str]] = ..., session_affinity: Optional[pulumi.Input[_builtins.bool]] = ..., subnetwork: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def forwarded_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def instance_ip_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @instance_tag.setter
    def instance_tag(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FlexibleAppVersionReadinessCheckArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], app_start_timeout: Optional[pulumi.Input[_builtins.str]] = ..., check_interval: Optional[pulumi.Input[_builtins.str]] = ..., failure_threshold: Optional[pulumi.Input[_builtins.float]] = ..., host: Optional[pulumi.Input[_builtins.str]] = ..., success_threshold: Optional[pulumi.Input[_builtins.float]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def app_start_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FlexibleAppVersionResourcesArgs:
    def __init__(__self__, *, cpu: Optional[pulumi.Input[_builtins.int]] = ..., disk_gb: Optional[pulumi.Input[_builtins.int]] = ..., memory_gb: Optional[pulumi.Input[_builtins.float]] = ..., volumes: Optional[pulumi.Input[Sequence[pulumi.Input[FlexibleAppVersionResourcesVolumeArgs]]]] = ...) -> None:
    ...
    @disk_gb.setter
    def disk_gb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @memory_gb.setter
    def memory_gb(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @volumes.setter
    def volumes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FlexibleAppVersionResourcesVolumeArgs]]]]): # -> None:
        ...
...
class FlexibleAppVersionResourcesVolumeArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], size_gb: pulumi.Input[_builtins.int], volume_type: pulumi.Input[_builtins.str]) -> None:
    ...
    @volume_type.setter
    def volume_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ServiceNetworkSettingsNetworkSettingsArgs:
    def __init__(__self__, *, ingress_traffic_allowed: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ingress_traffic_allowed(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StandardAppVersionAutomaticScalingArgs:
    def __init__(__self__, *, max_concurrent_requests: Optional[pulumi.Input[_builtins.int]] = ..., max_idle_instances: Optional[pulumi.Input[_builtins.int]] = ..., max_pending_latency: Optional[pulumi.Input[_builtins.str]] = ..., min_idle_instances: Optional[pulumi.Input[_builtins.int]] = ..., min_pending_latency: Optional[pulumi.Input[_builtins.str]] = ..., standard_scheduler_settings: Optional[pulumi.Input[StandardAppVersionAutomaticScalingStandardSchedulerSettingsArgs]] = ...) -> None:
    ...
    def standard_scheduler_settings(self, value: Optional[pulumi.Input[StandardAppVersionAutomaticScalingStandardSchedulerSettingsArgs]]): # -> None:
        ...
...
class StandardAppVersionAutomaticScalingStandardSchedulerSettingsArgs:
    def __init__(__self__, *, max_instances: Optional[pulumi.Input[_builtins.int]] = ..., min_instances: Optional[pulumi.Input[_builtins.int]] = ..., target_cpu_utilization: Optional[pulumi.Input[_builtins.float]] = ..., target_throughput_utilization: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def target_cpu_utilization(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def target_throughput_utilization(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class StandardAppVersionBasicScalingArgs:
    def __init__(__self__, *, max_instances: pulumi.Input[_builtins.int], idle_timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StandardAppVersionDeploymentArgs:
    def __init__(__self__, *, files: Optional[pulumi.Input[Sequence[pulumi.Input[StandardAppVersionDeploymentFileArgs]]]] = ..., zip: Optional[pulumi.Input[StandardAppVersionDeploymentZipArgs]] = ...) -> None:
    ...
    @files.setter
    def files(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StandardAppVersionDeploymentFileArgs]]]]): # -> None:
        ...
    ...
    @zip.setter
    def zip(self, value: Optional[pulumi.Input[StandardAppVersionDeploymentZipArgs]]): # -> None:
        ...
...
class StandardAppVersionHandlerArgs:
    def __init__(__self__, *, auth_fail_action: Optional[pulumi.Input[_builtins.str]] = ..., login: Optional[pulumi.Input[_builtins.str]] = ..., redirect_http_response_code: Optional[pulumi.Input[_builtins.str]] = ..., script: Optional[pulumi.Input[StandardAppVersionHandlerScriptArgs]] = ..., security_level: Optional[pulumi.Input[_builtins.str]] = ..., static_files: Optional[pulumi.Input[StandardAppVersionHandlerStaticFilesArgs]] = ..., url_regex: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @script.setter
    def script(self, value: Optional[pulumi.Input[StandardAppVersionHandlerScriptArgs]]): # -> None:
        ...
    ...
    @static_files.setter
    def static_files(self, value: Optional[pulumi.Input[StandardAppVersionHandlerStaticFilesArgs]]): # -> None:
        ...
...
class StandardAppVersionVpcAccessConnectorArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], egress_setting: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def egress_setting(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
