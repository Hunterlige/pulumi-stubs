...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterAutomatedBackupConfig', 'ClusterAutomatedBackupConfigFixedFrequencySchedule', ..., 'ClusterCrossClusterReplicationConfig', 'ClusterCrossClusterReplicationConfigMembership', ..., ..., 'ClusterCrossClusterReplicationConfigPrimaryCluster', ..., 'ClusterDiscoveryEndpoint', 'ClusterDiscoveryEndpointPscConfig', 'ClusterGcsSource', 'ClusterMaintenancePolicy', 'ClusterMaintenancePolicyWeeklyMaintenanceWindow', ..., 'ClusterMaintenanceSchedule', 'ClusterManagedBackupSource', 'ClusterManagedServerCa', 'ClusterManagedServerCaCaCert', 'ClusterPersistenceConfig', 'ClusterPersistenceConfigAofConfig', 'ClusterPersistenceConfigRdbConfig', 'ClusterPscConfig', 'ClusterPscConnection', 'ClusterPscServiceAttachment', 'ClusterStateInfo', 'ClusterStateInfoUpdateInfo', 'ClusterUserCreatedConnectionsClusterEndpoint', ..., ..., 'ClusterZoneDistributionConfig', 'InstanceMaintenancePolicy', 'InstanceMaintenancePolicyWeeklyMaintenanceWindow', ..., 'InstanceMaintenanceSchedule', 'InstanceNode', 'InstancePersistenceConfig', 'InstanceServerCaCert', 'GetClusterAutomatedBackupConfigResult', ..., ..., 'GetClusterCrossClusterReplicationConfigResult', ..., ..., ..., ..., ..., 'GetClusterDiscoveryEndpointResult', 'GetClusterDiscoveryEndpointPscConfigResult', 'GetClusterGcsSourceResult', 'GetClusterMaintenancePolicyResult', ..., ..., 'GetClusterMaintenanceScheduleResult', 'GetClusterManagedBackupSourceResult', 'GetClusterManagedServerCaResult', 'GetClusterManagedServerCaCaCertResult', 'GetClusterPersistenceConfigResult', 'GetClusterPersistenceConfigAofConfigResult', 'GetClusterPersistenceConfigRdbConfigResult', 'GetClusterPscConfigResult', 'GetClusterPscConnectionResult', 'GetClusterPscServiceAttachmentResult', 'GetClusterStateInfoResult', 'GetClusterStateInfoUpdateInfoResult', 'GetClusterZoneDistributionConfigResult', 'GetInstanceMaintenancePolicyResult', ..., ..., 'GetInstanceMaintenanceScheduleResult', 'GetInstanceNodeResult', 'GetInstancePersistenceConfigResult', 'GetInstanceServerCaCertResult']
@pulumi.output_type
class ClusterAutomatedBackupConfig(dict):
    ...
    def __init__(__self__, *, fixed_frequency_schedule: outputs.ClusterAutomatedBackupConfigFixedFrequencySchedule, retention: _builtins.str) -> None:
...
class ClusterAutomatedBackupConfigFixedFrequencySchedule(dict):
    ...
    def __init__(__self__, *, start_time: outputs.ClusterAutomatedBackupConfigFixedFrequencyScheduleStartTime) -> None:
...
class ClusterCrossClusterReplicationConfig(dict):
    ...
    def __init__(__self__, *, cluster_role: Optional[_builtins.str] = ..., memberships: Optional[Sequence[outputs.ClusterCrossClusterReplicationConfigMembership]] = ..., primary_cluster: Optional[outputs.ClusterCrossClusterReplicationConfigPrimaryCluster] = ..., secondary_clusters: Optional[Sequence[outputs.ClusterCrossClusterReplicationConfigSecondaryCluster]] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class ClusterCrossClusterReplicationConfigMembership(dict):
    ...
    def __init__(__self__, *, primary_clusters: Optional[Sequence[outputs.ClusterCrossClusterReplicationConfigMembershipPrimaryCluster]] = ..., secondary_clusters: Optional[Sequence[outputs.ClusterCrossClusterReplicationConfigMembershipSecondaryCluster]] = ...) -> None:
...
class ClusterCrossClusterReplicationConfigMembershipPrimaryCluster(dict):
    def __init__(__self__, *, cluster: Optional[_builtins.str] = ..., uid: Optional[_builtins.str] = ...) -> None:
...
class ClusterDiscoveryEndpoint(dict):
    ...
    def __init__(__self__, *, address: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., psc_config: Optional[outputs.ClusterDiscoveryEndpointPscConfig] = ...) -> None:
...
class ClusterMaintenancePolicy(dict):
    ...
    def __init__(__self__, *, create_time: Optional[_builtins.str] = ..., update_time: Optional[_builtins.str] = ..., weekly_maintenance_windows: Optional[Sequence[outputs.ClusterMaintenancePolicyWeeklyMaintenanceWindow]] = ...) -> None:
...
class ClusterMaintenancePolicyWeeklyMaintenanceWindow(dict):
    ...
    def __init__(__self__, *, day: _builtins.str, start_time: outputs.ClusterMaintenancePolicyWeeklyMaintenanceWindowStartTime, duration: Optional[_builtins.str] = ...) -> None:
...
class ClusterManagedServerCa(dict):
    ...
    def __init__(__self__, *, ca_certs: Optional[Sequence[outputs.ClusterManagedServerCaCaCert]] = ...) -> None:
...
class ClusterPersistenceConfig(dict):
    ...
    def __init__(__self__, *, aof_config: Optional[outputs.ClusterPersistenceConfigAofConfig] = ..., mode: Optional[_builtins.str] = ..., rdb_config: Optional[outputs.ClusterPersistenceConfigRdbConfig] = ...) -> None:
...
class ClusterPscConnection(dict):
    ...
    def __init__(__self__, *, address: Optional[_builtins.str] = ..., forwarding_rule: Optional[_builtins.str] = ..., network: Optional[_builtins.str] = ..., project_id: Optional[_builtins.str] = ..., psc_connection_id: Optional[_builtins.str] = ...) -> None:
...
class ClusterStateInfo(dict):
    ...
    def __init__(__self__, *, update_info: Optional[outputs.ClusterStateInfoUpdateInfo] = ...) -> None:
...
class ClusterStateInfoUpdateInfo(dict):
    ...
    def __init__(__self__, *, target_replica_count: Optional[_builtins.int] = ..., target_shard_count: Optional[_builtins.int] = ...) -> None:
...
class ClusterUserCreatedConnectionsClusterEndpoint(dict):
    def __init__(__self__, *, connections: Optional[Sequence[outputs.ClusterUserCreatedConnectionsClusterEndpointConnection]] = ...) -> None:
...
class ClusterUserCreatedConnectionsClusterEndpointConnection(dict):
    ...
    def __init__(__self__, *, psc_connection: Optional[outputs.ClusterUserCreatedConnectionsClusterEndpointConnectionPscConnection] = ...) -> None:
...
class ClusterUserCreatedConnectionsClusterEndpointConnectionPscConnection(dict):
    ...
    def __init__(__self__, *, address: _builtins.str, forwarding_rule: _builtins.str, network: _builtins.str, psc_connection_id: _builtins.str, service_attachment: _builtins.str, connection_type: Optional[_builtins.str] = ..., project_id: Optional[_builtins.str] = ..., psc_connection_status: Optional[_builtins.str] = ...) -> None:
...
class InstanceMaintenancePolicy(dict):
    ...
    def __init__(__self__, *, create_time: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., update_time: Optional[_builtins.str] = ..., weekly_maintenance_windows: Optional[Sequence[outputs.InstanceMaintenancePolicyWeeklyMaintenanceWindow]] = ...) -> None:
...
class InstanceNode(dict):
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., zone: Optional[_builtins.str] = ...) -> None:
...
class InstancePersistenceConfig(dict):
    ...
    def __init__(__self__, *, persistence_mode: Optional[_builtins.str] = ..., rdb_next_snapshot_time: Optional[_builtins.str] = ..., rdb_snapshot_period: Optional[_builtins.str] = ..., rdb_snapshot_start_time: Optional[_builtins.str] = ...) -> None:
...
class InstanceServerCaCert(dict):
    ...
    def __init__(__self__, *, cert: Optional[_builtins.str] = ..., create_time: Optional[_builtins.str] = ..., expire_time: Optional[_builtins.str] = ..., serial_number: Optional[_builtins.str] = ..., sha1_fingerprint: Optional[_builtins.str] = ...) -> None:
...
class GetClusterAutomatedBackupConfigResult(dict):
    def __init__(__self__, *, fixed_frequency_schedules: Sequence[outputs.GetClusterAutomatedBackupConfigFixedFrequencyScheduleResult], retention: _builtins.str) -> None:
...
class GetClusterAutomatedBackupConfigFixedFrequencyScheduleResult(dict):
    def __init__(__self__, *, start_times: Sequence[outputs.GetClusterAutomatedBackupConfigFixedFrequencyScheduleStartTimeResult]) -> None:
...
class GetClusterCrossClusterReplicationConfigResult(dict):
    def __init__(__self__, *, cluster_role: _builtins.str, memberships: Sequence[outputs.GetClusterCrossClusterReplicationConfigMembershipResult], primary_clusters: Sequence[outputs.GetClusterCrossClusterReplicationConfigPrimaryClusterResult], secondary_clusters: Sequence[outputs.GetClusterCrossClusterReplicationConfigSecondaryClusterResult], update_time: _builtins.str) -> None:
...
class GetClusterCrossClusterReplicationConfigMembershipResult(dict):
    def __init__(__self__, *, primary_clusters: Sequence[outputs.GetClusterCrossClusterReplicationConfigMembershipPrimaryClusterResult], secondary_clusters: Sequence[outputs.GetClusterCrossClusterReplicationConfigMembershipSecondaryClusterResult]) -> None:
...
class GetClusterDiscoveryEndpointResult(dict):
    def __init__(__self__, *, address: _builtins.str, port: _builtins.int, psc_configs: Sequence[outputs.GetClusterDiscoveryEndpointPscConfigResult]) -> None:
...
class GetClusterMaintenancePolicyResult(dict):
    def __init__(__self__, *, create_time: _builtins.str, update_time: _builtins.str, weekly_maintenance_windows: Sequence[outputs.GetClusterMaintenancePolicyWeeklyMaintenanceWindowResult]) -> None:
...
class GetClusterMaintenancePolicyWeeklyMaintenanceWindowResult(dict):
    def __init__(__self__, *, day: _builtins.str, duration: _builtins.str, start_times: Sequence[outputs.GetClusterMaintenancePolicyWeeklyMaintenanceWindowStartTimeResult]) -> None:
...
class GetClusterManagedServerCaResult(dict):
    def __init__(__self__, *, ca_certs: Sequence[outputs.GetClusterManagedServerCaCaCertResult]) -> None:
...
class GetClusterPersistenceConfigResult(dict):
    def __init__(__self__, *, aof_configs: Sequence[outputs.GetClusterPersistenceConfigAofConfigResult], mode: _builtins.str, rdb_configs: Sequence[outputs.GetClusterPersistenceConfigRdbConfigResult]) -> None:
...
class GetClusterPscConnectionResult(dict):
    def __init__(__self__, *, address: _builtins.str, forwarding_rule: _builtins.str, network: _builtins.str, project_id: _builtins.str, psc_connection_id: _builtins.str) -> None:
...
class GetClusterStateInfoResult(dict):
    def __init__(__self__, *, update_infos: Sequence[outputs.GetClusterStateInfoUpdateInfoResult]) -> None:
...
class GetClusterStateInfoUpdateInfoResult(dict):
    def __init__(__self__, *, target_replica_count: _builtins.int, target_shard_count: _builtins.int) -> None:
...
class GetInstanceMaintenancePolicyResult(dict):
    def __init__(__self__, *, create_time: _builtins.str, description: _builtins.str, update_time: _builtins.str, weekly_maintenance_windows: Sequence[outputs.GetInstanceMaintenancePolicyWeeklyMaintenanceWindowResult]) -> None:
...
class GetInstancePersistenceConfigResult(dict):
    def __init__(__self__, *, persistence_mode: _builtins.str, rdb_next_snapshot_time: _builtins.str, rdb_snapshot_period: _builtins.str, rdb_snapshot_start_time: _builtins.str) -> None:
...
class GetInstanceServerCaCertResult(dict):
    def __init__(__self__, *, cert: _builtins.str, create_time: _builtins.str, expire_time: _builtins.str, serial_number: _builtins.str, sha1_fingerprint: _builtins.str) -> None:
