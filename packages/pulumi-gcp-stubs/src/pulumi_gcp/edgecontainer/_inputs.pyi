...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterAuthorizationArgs', 'ClusterAuthorizationArgsDict', 'ClusterAuthorizationAdminUsersArgs', 'ClusterAuthorizationAdminUsersArgsDict', 'ClusterControlPlaneArgs', 'ClusterControlPlaneArgsDict', 'ClusterControlPlaneEncryptionArgs', 'ClusterControlPlaneEncryptionArgsDict', 'ClusterControlPlaneEncryptionKmsStatusArgs', 'ClusterControlPlaneEncryptionKmsStatusArgsDict', 'ClusterControlPlaneLocalArgs', 'ClusterControlPlaneLocalArgsDict', 'ClusterControlPlaneRemoteArgs', 'ClusterControlPlaneRemoteArgsDict', 'ClusterFleetArgs', 'ClusterFleetArgsDict', 'ClusterMaintenanceEventArgs', 'ClusterMaintenanceEventArgsDict', 'ClusterMaintenancePolicyArgs', 'ClusterMaintenancePolicyArgsDict', 'ClusterMaintenancePolicyMaintenanceExclusionArgs', ..., ..., ..., 'ClusterMaintenancePolicyWindowArgs', 'ClusterMaintenancePolicyWindowArgsDict', 'ClusterMaintenancePolicyWindowRecurringWindowArgs', ..., ..., ..., 'ClusterNetworkingArgs', 'ClusterNetworkingArgsDict', 'ClusterSystemAddonsConfigArgs', 'ClusterSystemAddonsConfigArgsDict', 'ClusterSystemAddonsConfigIngressArgs', 'ClusterSystemAddonsConfigIngressArgsDict', 'NodePoolLocalDiskEncryptionArgs', 'NodePoolLocalDiskEncryptionArgsDict', 'NodePoolNodeConfigArgs', 'NodePoolNodeConfigArgsDict', 'VpnConnectionDetailArgs', 'VpnConnectionDetailArgsDict', 'VpnConnectionDetailCloudRouterArgs', 'VpnConnectionDetailCloudRouterArgsDict', 'VpnConnectionDetailCloudVpnArgs', 'VpnConnectionDetailCloudVpnArgsDict', 'VpnConnectionVpcProjectArgs', 'VpnConnectionVpcProjectArgsDict']
...
class ClusterAuthorizationArgs:
    def __init__(__self__, *, admin_users: pulumi.Input[ClusterAuthorizationAdminUsersArgs]) -> None:
    ...
    @admin_users.setter
    def admin_users(self, value: pulumi.Input[ClusterAuthorizationAdminUsersArgs]): # -> None:
        ...
...
class ClusterControlPlaneArgs:
    def __init__(__self__, *, local: Optional[pulumi.Input[ClusterControlPlaneLocalArgs]] = ..., remote: Optional[pulumi.Input[ClusterControlPlaneRemoteArgs]] = ...) -> None:
    ...
    @local.setter
    def local(self, value: Optional[pulumi.Input[ClusterControlPlaneLocalArgs]]): # -> None:
        ...
    ...
    @remote.setter
    def remote(self, value: Optional[pulumi.Input[ClusterControlPlaneRemoteArgs]]): # -> None:
        ...
...
class ClusterControlPlaneEncryptionArgs:
    def __init__(__self__, *, kms_key: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_active_version: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_state: Optional[pulumi.Input[_builtins.str]] = ..., kms_statuses: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterControlPlaneEncryptionKmsStatusArgs]]]] = ...) -> None:
    ...
    def kms_key_active_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def kms_key_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @kms_statuses.setter
    def kms_statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterControlPlaneEncryptionKmsStatusArgs]]]]): # -> None:
        ...
...
class ClusterControlPlaneLocalArgs:
    def __init__(__self__, *, machine_filter: Optional[pulumi.Input[_builtins.str]] = ..., node_count: Optional[pulumi.Input[_builtins.int]] = ..., node_location: Optional[pulumi.Input[_builtins.str]] = ..., shared_deployment_policy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def shared_deployment_policy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterControlPlaneRemoteArgs:
    def __init__(__self__, *, node_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterMaintenanceEventArgs:
    def __init__(__self__, *, create_time: Optional[pulumi.Input[_builtins.str]] = ..., end_time: Optional[pulumi.Input[_builtins.str]] = ..., operation: Optional[pulumi.Input[_builtins.str]] = ..., schedule: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., target_version: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ..., uuid: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterMaintenancePolicyArgs:
    def __init__(__self__, *, window: pulumi.Input[ClusterMaintenancePolicyWindowArgs], maintenance_exclusions: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterMaintenancePolicyMaintenanceExclusionArgs]]]] = ...) -> None:
    ...
    @window.setter
    def window(self, value: pulumi.Input[ClusterMaintenancePolicyWindowArgs]): # -> None:
        ...
...
class ClusterMaintenancePolicyMaintenanceExclusionArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., window: Optional[pulumi.Input[ClusterMaintenancePolicyMaintenanceExclusionWindowArgs]] = ...) -> None:
    ...
    @window.setter
    def window(self, value: Optional[pulumi.Input[ClusterMaintenancePolicyMaintenanceExclusionWindowArgs]]): # -> None:
        ...
...
class ClusterMaintenancePolicyWindowArgs:
    def __init__(__self__, *, recurring_window: pulumi.Input[ClusterMaintenancePolicyWindowRecurringWindowArgs]) -> None:
    ...
    def recurring_window(self, value: pulumi.Input[ClusterMaintenancePolicyWindowRecurringWindowArgs]): # -> None:
        ...
...
class ClusterMaintenancePolicyWindowRecurringWindowArgs:
    def __init__(__self__, *, recurrence: Optional[pulumi.Input[_builtins.str]] = ..., window: Optional[pulumi.Input[ClusterMaintenancePolicyWindowRecurringWindowWindowArgs]] = ...) -> None:
    ...
    @window.setter
    def window(self, value: Optional[pulumi.Input[ClusterMaintenancePolicyWindowRecurringWindowWindowArgs]]): # -> None:
        ...
...
class ClusterNetworkingArgs:
    def __init__(__self__, *, cluster_ipv4_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], services_ipv4_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], cluster_ipv6_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., network_type: Optional[pulumi.Input[_builtins.str]] = ..., services_ipv6_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def cluster_ipv4_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def services_ipv4_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def cluster_ipv6_cidr_blocks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def services_ipv6_cidr_blocks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ClusterSystemAddonsConfigArgs:
    def __init__(__self__, *, ingress: Optional[pulumi.Input[ClusterSystemAddonsConfigIngressArgs]] = ...) -> None:
    ...
    @ingress.setter
    def ingress(self, value: Optional[pulumi.Input[ClusterSystemAddonsConfigIngressArgs]]): # -> None:
        ...
...
class ClusterSystemAddonsConfigIngressArgs:
    def __init__(__self__, *, disabled: Optional[pulumi.Input[_builtins.bool]] = ..., ipv4_vip: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ipv4_vip.setter
    def ipv4_vip(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NodePoolLocalDiskEncryptionArgs:
    def __init__(__self__, *, kms_key: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_active_version: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VpnConnectionDetailArgs:
    def __init__(__self__, *, cloud_routers: Optional[pulumi.Input[Sequence[pulumi.Input[VpnConnectionDetailCloudRouterArgs]]]] = ..., cloud_vpns: Optional[pulumi.Input[Sequence[pulumi.Input[VpnConnectionDetailCloudVpnArgs]]]] = ..., error: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cloud_routers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VpnConnectionDetailCloudRouterArgs]]]]): # -> None:
        ...
    ...
    @cloud_vpns.setter
    def cloud_vpns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[VpnConnectionDetailCloudVpnArgs]]]]): # -> None:
        ...
...
class VpnConnectionDetailCloudVpnArgs:
    def __init__(__self__, *, gateway: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class VpnConnectionVpcProjectArgs:
    def __init__(__self__, *, project_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
