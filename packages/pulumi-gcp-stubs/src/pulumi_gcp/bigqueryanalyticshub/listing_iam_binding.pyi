...
class ListingIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[ListingIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[ListingIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class ListingIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    ListingIamBindingConditionArgs, ListingIamBindingConditionArgsDict
                ]
            ]
        ] = ...,
        data_exchange_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.ListingIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="dataExchangeId")
