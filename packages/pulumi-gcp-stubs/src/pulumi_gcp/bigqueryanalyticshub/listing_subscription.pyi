...
class ListingSubscriptionArgs:
    def __init__(__self__, *, data_exchange_id: pulumi.Input[_builtins.str], destination_dataset: pulumi.Input[ListingSubscriptionDestinationDatasetArgs], listing_id: pulumi.Input[_builtins.str], location: pulumi.Input[_builtins.str], project: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def destination_dataset(self, value: pulumi.Input[ListingSubscriptionDestinationDatasetArgs]): # -> None:
        ...
...
class _ListingSubscriptionState:
    def __init__(__self__, *, commercial_infos: Optional[pulumi.Input[Sequence[pulumi.Input[ListingSubscriptionCommercialInfoArgs]]]] = ..., creation_time: Optional[pulumi.Input[_builtins.str]] = ..., data_exchange_id: Optional[pulumi.Input[_builtins.str]] = ..., destination_dataset: Optional[pulumi.Input[ListingSubscriptionDestinationDatasetArgs]] = ..., last_modify_time: Optional[pulumi.Input[_builtins.str]] = ..., linked_dataset_maps: Optional[pulumi.Input[Sequence[pulumi.Input[ListingSubscriptionLinkedDatasetMapArgs]]]] = ..., linked_resources: Optional[pulumi.Input[Sequence[pulumi.Input[ListingSubscriptionLinkedResourceArgs]]]] = ..., listing_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., log_linked_dataset_query_user_email: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., organization_display_name: Optional[pulumi.Input[_builtins.str]] = ..., organization_id: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., resource_type: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., subscriber_contact: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def commercial_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ListingSubscriptionCommercialInfoArgs]]]]): # -> None:
        ...
    ...
    @destination_dataset.setter
    def destination_dataset(self, value: Optional[pulumi.Input[ListingSubscriptionDestinationDatasetArgs]]): # -> None:
        ...
    ...
    def linked_dataset_maps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ListingSubscriptionLinkedDatasetMapArgs]]]]): # -> None:
        ...
    ...
    def linked_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ListingSubscriptionLinkedResourceArgs]]]]): # -> None:
        ...
...
class ListingSubscription(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., data_exchange_id: Optional[pulumi.Input[_builtins.str]] = ..., destination_dataset: Optional[pulumi.Input[Union[ListingSubscriptionDestinationDatasetArgs, ListingSubscriptionDestinationDatasetArgsDict]]] = ..., listing_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ListingSubscriptionArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., commercial_infos: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ListingSubscriptionCommercialInfoArgs, ListingSubscriptionCommercialInfoArgsDict]]]]] = ..., creation_time: Optional[pulumi.Input[_builtins.str]] = ..., data_exchange_id: Optional[pulumi.Input[_builtins.str]] = ..., destination_dataset: Optional[pulumi.Input[Union[ListingSubscriptionDestinationDatasetArgs, ListingSubscriptionDestinationDatasetArgsDict]]] = ..., last_modify_time: Optional[pulumi.Input[_builtins.str]] = ..., linked_dataset_maps: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ListingSubscriptionLinkedDatasetMapArgs, ListingSubscriptionLinkedDatasetMapArgsDict]]]]] = ..., linked_resources: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ListingSubscriptionLinkedResourceArgs, ListingSubscriptionLinkedResourceArgsDict]]]]] = ..., listing_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., log_linked_dataset_query_user_email: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., organization_display_name: Optional[pulumi.Input[_builtins.str]] = ..., organization_id: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., resource_type: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., subscriber_contact: Optional[pulumi.Input[_builtins.str]] = ..., subscription_id: Optional[pulumi.Input[_builtins.str]] = ...) -> ListingSubscription:
