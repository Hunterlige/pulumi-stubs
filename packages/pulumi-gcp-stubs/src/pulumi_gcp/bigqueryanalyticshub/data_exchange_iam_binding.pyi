...
class DataExchangeIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[DataExchangeIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[DataExchangeIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[DataExchangeIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class DataExchangeIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.DataExchangeIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="dataExchangeId")
