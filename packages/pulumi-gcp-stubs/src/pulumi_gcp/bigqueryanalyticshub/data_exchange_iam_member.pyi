...
class DataExchangeIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[DataExchangeIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[DataExchangeIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[DataExchangeIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class DataExchangeIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.DataExchangeIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="dataExchangeId")
