...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DataExchangeIamBindingConditionArgs', 'DataExchangeIamBindingConditionArgsDict', 'DataExchangeIamMemberConditionArgs', 'DataExchangeIamMemberConditionArgsDict', 'DataExchangeSharingEnvironmentConfigArgs', 'DataExchangeSharingEnvironmentConfigArgsDict', ..., ..., ..., ..., 'DataExchangeSubscriptionDestinationDatasetArgs', 'DataExchangeSubscriptionDestinationDatasetArgsDict', ..., ..., 'DataExchangeSubscriptionLinkedDatasetMapArgs', 'DataExchangeSubscriptionLinkedDatasetMapArgsDict', 'DataExchangeSubscriptionLinkedResourceArgs', 'DataExchangeSubscriptionLinkedResourceArgsDict', 'ListingBigqueryDatasetArgs', 'ListingBigqueryDatasetArgsDict', 'ListingBigqueryDatasetEffectiveReplicaArgs', 'ListingBigqueryDatasetEffectiveReplicaArgsDict', 'ListingBigqueryDatasetSelectedResourceArgs', 'ListingBigqueryDatasetSelectedResourceArgsDict', 'ListingCommercialInfoArgs', 'ListingCommercialInfoArgsDict', 'ListingCommercialInfoCloudMarketplaceArgs', 'ListingCommercialInfoCloudMarketplaceArgsDict', 'ListingDataProviderArgs', 'ListingDataProviderArgsDict', 'ListingIamBindingConditionArgs', 'ListingIamBindingConditionArgsDict', 'ListingIamMemberConditionArgs', 'ListingIamMemberConditionArgsDict', 'ListingPublisherArgs', 'ListingPublisherArgsDict', 'ListingPubsubTopicArgs', 'ListingPubsubTopicArgsDict', 'ListingRestrictedExportConfigArgs', 'ListingRestrictedExportConfigArgsDict', 'ListingSubscriptionCommercialInfoArgs', 'ListingSubscriptionCommercialInfoArgsDict', ..., ..., 'ListingSubscriptionDestinationDatasetArgs', 'ListingSubscriptionDestinationDatasetArgsDict', ..., ..., 'ListingSubscriptionLinkedDatasetMapArgs', 'ListingSubscriptionLinkedDatasetMapArgsDict', 'ListingSubscriptionLinkedResourceArgs', 'ListingSubscriptionLinkedResourceArgsDict']
...
class DataExchangeSharingEnvironmentConfigArgs:
    def __init__(__self__, *, dcr_exchange_config: Optional[pulumi.Input[DataExchangeSharingEnvironmentConfigDcrExchangeConfigArgs]] = ..., default_exchange_config: Optional[pulumi.Input[DataExchangeSharingEnvironmentConfigDefaultExchangeConfigArgs]] = ...) -> None:
    ...
    def dcr_exchange_config(self, value: Optional[pulumi.Input[DataExchangeSharingEnvironmentConfigDcrExchangeConfigArgs]]): # -> None:
        ...
    ...
    def default_exchange_config(self, value: Optional[pulumi.Input[DataExchangeSharingEnvironmentConfigDefaultExchangeConfigArgs]]): # -> None:
        ...
...
class DataExchangeSubscriptionDestinationDatasetArgs:
    def __init__(__self__, *, dataset_reference: pulumi.Input[DataExchangeSubscriptionDestinationDatasetDatasetReferenceArgs], location: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., friendly_name: Optional[pulumi.Input[_builtins.str]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def dataset_reference(self, value: pulumi.Input[DataExchangeSubscriptionDestinationDatasetDatasetReferenceArgs]): # -> None:
        ...
...
class DataExchangeSubscriptionLinkedDatasetMapArgs:
    def __init__(__self__, *, resource_name: pulumi.Input[_builtins.str], linked_dataset: Optional[pulumi.Input[_builtins.str]] = ..., linked_pubsub_subscription: Optional[pulumi.Input[_builtins.str]] = ..., listing: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def linked_dataset(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def linked_pubsub_subscription(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @listing.setter
    def listing(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataExchangeSubscriptionLinkedResourceArgs:
    def __init__(__self__, *, linked_dataset: Optional[pulumi.Input[_builtins.str]] = ..., listing: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ListingBigqueryDatasetArgs:
    def __init__(__self__, *, dataset: pulumi.Input[_builtins.str], effective_replicas: Optional[pulumi.Input[Sequence[pulumi.Input[ListingBigqueryDatasetEffectiveReplicaArgs]]]] = ..., replica_locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., selected_resources: Optional[pulumi.Input[Sequence[pulumi.Input[ListingBigqueryDatasetSelectedResourceArgs]]]] = ...) -> None:
    ...
    def effective_replicas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ListingBigqueryDatasetEffectiveReplicaArgs]]]]): # -> None:
        ...
    ...
    def replica_locations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def selected_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ListingBigqueryDatasetSelectedResourceArgs]]]]): # -> None:
        ...
...
class ListingBigqueryDatasetEffectiveReplicaArgs:
    def __init__(__self__, *, location: Optional[pulumi.Input[_builtins.str]] = ..., primary_state: Optional[pulumi.Input[_builtins.str]] = ..., replica_state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def primary_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def replica_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ListingBigqueryDatasetSelectedResourceArgs:
    def __init__(__self__, *, routine: Optional[pulumi.Input[_builtins.str]] = ..., table: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ListingCommercialInfoArgs:
    def __init__(__self__, *, cloud_marketplaces: Optional[pulumi.Input[Sequence[pulumi.Input[ListingCommercialInfoCloudMarketplaceArgs]]]] = ...) -> None:
    ...
    def cloud_marketplaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ListingCommercialInfoCloudMarketplaceArgs]]]]): # -> None:
        ...
...
class ListingCommercialInfoCloudMarketplaceArgs:
    def __init__(__self__, *, commercial_state: Optional[pulumi.Input[_builtins.str]] = ..., service: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def commercial_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ListingDataProviderArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], primary_contact: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ListingPubsubTopicArgs:
    def __init__(__self__, *, topic: pulumi.Input[_builtins.str], data_affinity_regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def data_affinity_regions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ListingRestrictedExportConfigArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., restrict_direct_table_access: Optional[pulumi.Input[_builtins.bool]] = ..., restrict_query_result: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def restrict_direct_table_access(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def restrict_query_result(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ListingSubscriptionCommercialInfoArgs:
    def __init__(__self__, *, cloud_marketplaces: Optional[pulumi.Input[Sequence[pulumi.Input[ListingSubscriptionCommercialInfoCloudMarketplaceArgs]]]] = ...) -> None:
    ...
    @cloud_marketplaces.setter
    def cloud_marketplaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ListingSubscriptionCommercialInfoCloudMarketplaceArgs]]]]): # -> None:
        ...
...
class ListingSubscriptionCommercialInfoCloudMarketplaceArgs:
    def __init__(__self__, *, order: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @order.setter
    def order(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ListingSubscriptionDestinationDatasetArgs:
    def __init__(__self__, *, dataset_reference: pulumi.Input[ListingSubscriptionDestinationDatasetDatasetReferenceArgs], location: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., friendly_name: Optional[pulumi.Input[_builtins.str]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., replica_locations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @dataset_reference.setter
    def dataset_reference(self, value: pulumi.Input[ListingSubscriptionDestinationDatasetDatasetReferenceArgs]): # -> None:
        ...
...
class ListingSubscriptionLinkedDatasetMapArgs:
    def __init__(__self__, *, resource_name: pulumi.Input[_builtins.str], linked_dataset: Optional[pulumi.Input[_builtins.str]] = ..., listing: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
