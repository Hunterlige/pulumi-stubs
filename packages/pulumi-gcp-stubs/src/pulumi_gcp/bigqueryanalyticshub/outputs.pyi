...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DataExchangeIamBindingCondition', 'DataExchangeIamMemberCondition', 'DataExchangeSharingEnvironmentConfig', ..., ..., 'DataExchangeSubscriptionDestinationDataset', ..., 'DataExchangeSubscriptionLinkedDatasetMap', 'DataExchangeSubscriptionLinkedResource', 'ListingBigqueryDataset', 'ListingBigqueryDatasetEffectiveReplica', 'ListingBigqueryDatasetSelectedResource', 'ListingCommercialInfo', 'ListingCommercialInfoCloudMarketplace', 'ListingDataProvider', 'ListingIamBindingCondition', 'ListingIamMemberCondition', 'ListingPublisher', 'ListingPubsubTopic', 'ListingRestrictedExportConfig', 'ListingSubscriptionCommercialInfo', 'ListingSubscriptionCommercialInfoCloudMarketplace', 'ListingSubscriptionDestinationDataset', ..., 'ListingSubscriptionLinkedDatasetMap', 'ListingSubscriptionLinkedResource']
@pulumi.output_type
...
class DataExchangeSharingEnvironmentConfig(dict):
    ...
    def __init__(__self__, *, dcr_exchange_config: Optional[outputs.DataExchangeSharingEnvironmentConfigDcrExchangeConfig] = ..., default_exchange_config: Optional[outputs.DataExchangeSharingEnvironmentConfigDefaultExchangeConfig] = ...) -> None:
...
class DataExchangeSubscriptionDestinationDataset(dict):
    ...
    def __init__(__self__, *, dataset_reference: outputs.DataExchangeSubscriptionDestinationDatasetDatasetReference, location: _builtins.str, description: Optional[_builtins.str] = ..., friendly_name: Optional[_builtins.str] = ..., labels: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class DataExchangeSubscriptionLinkedDatasetMap(dict):
    ...
    def __init__(__self__, *, resource_name: _builtins.str, linked_dataset: Optional[_builtins.str] = ..., linked_pubsub_subscription: Optional[_builtins.str] = ..., listing: Optional[_builtins.str] = ...) -> None:
...
class DataExchangeSubscriptionLinkedResource(dict):
    ...
    def __init__(__self__, *, linked_dataset: Optional[_builtins.str] = ..., listing: Optional[_builtins.str] = ...) -> None:
...
class ListingBigqueryDataset(dict):
    ...
    def __init__(__self__, *, dataset: _builtins.str, effective_replicas: Optional[Sequence[outputs.ListingBigqueryDatasetEffectiveReplica]] = ..., replica_locations: Optional[Sequence[_builtins.str]] = ..., selected_resources: Optional[Sequence[outputs.ListingBigqueryDatasetSelectedResource]] = ...) -> None:
...
class ListingBigqueryDatasetEffectiveReplica(dict):
    ...
    def __init__(__self__, *, location: Optional[_builtins.str] = ..., primary_state: Optional[_builtins.str] = ..., replica_state: Optional[_builtins.str] = ...) -> None:
...
class ListingBigqueryDatasetSelectedResource(dict):
    def __init__(__self__, *, routine: Optional[_builtins.str] = ..., table: Optional[_builtins.str] = ...) -> None:
...
class ListingCommercialInfo(dict):
    ...
    def __init__(__self__, *, cloud_marketplaces: Optional[Sequence[outputs.ListingCommercialInfoCloudMarketplace]] = ...) -> None:
...
class ListingCommercialInfoCloudMarketplace(dict):
    ...
    def __init__(__self__, *, commercial_state: Optional[_builtins.str] = ..., service: Optional[_builtins.str] = ...) -> None:
...
class ListingDataProvider(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, primary_contact: Optional[_builtins.str] = ...) -> None:
...
class ListingPubsubTopic(dict):
    ...
    def __init__(__self__, *, topic: _builtins.str, data_affinity_regions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ListingRestrictedExportConfig(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., restrict_direct_table_access: Optional[_builtins.bool] = ..., restrict_query_result: Optional[_builtins.bool] = ...) -> None:
...
class ListingSubscriptionCommercialInfo(dict):
    ...
    def __init__(__self__, *, cloud_marketplaces: Optional[Sequence[outputs.ListingSubscriptionCommercialInfoCloudMarketplace]] = ...) -> None:
...
class ListingSubscriptionDestinationDataset(dict):
    ...
    def __init__(__self__, *, dataset_reference: outputs.ListingSubscriptionDestinationDatasetDatasetReference, location: _builtins.str, description: Optional[_builtins.str] = ..., friendly_name: Optional[_builtins.str] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., replica_locations: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ListingSubscriptionLinkedDatasetMap(dict):
    ...
    def __init__(__self__, *, resource_name: _builtins.str, linked_dataset: Optional[_builtins.str] = ..., listing: Optional[_builtins.str] = ...) -> None:
