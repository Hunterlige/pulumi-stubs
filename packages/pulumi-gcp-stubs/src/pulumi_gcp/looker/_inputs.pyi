...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['InstanceAdminSettingsArgs', 'InstanceAdminSettingsArgsDict', 'InstanceControlledEgressConfigArgs', 'InstanceControlledEgressConfigArgsDict', 'InstanceCustomDomainArgs', 'InstanceCustomDomainArgsDict', 'InstanceDenyMaintenancePeriodArgs', 'InstanceDenyMaintenancePeriodArgsDict', 'InstanceDenyMaintenancePeriodEndDateArgs', 'InstanceDenyMaintenancePeriodEndDateArgsDict', 'InstanceDenyMaintenancePeriodStartDateArgs', 'InstanceDenyMaintenancePeriodStartDateArgsDict', 'InstanceDenyMaintenancePeriodTimeArgs', 'InstanceDenyMaintenancePeriodTimeArgsDict', 'InstanceEncryptionConfigArgs', 'InstanceEncryptionConfigArgsDict', 'InstanceMaintenanceWindowArgs', 'InstanceMaintenanceWindowArgsDict', 'InstanceMaintenanceWindowStartTimeArgs', 'InstanceMaintenanceWindowStartTimeArgsDict', 'InstanceOauthConfigArgs', 'InstanceOauthConfigArgsDict', 'InstancePeriodicExportConfigArgs', 'InstancePeriodicExportConfigArgsDict', 'InstancePeriodicExportConfigStartTimeArgs', 'InstancePeriodicExportConfigStartTimeArgsDict', 'InstancePscConfigArgs', 'InstancePscConfigArgsDict', 'InstancePscConfigServiceAttachmentArgs', 'InstancePscConfigServiceAttachmentArgsDict', 'InstanceUserMetadataArgs', 'InstanceUserMetadataArgsDict']
...
class InstanceAdminSettingsArgs:
    def __init__(__self__, *, allowed_email_domains: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allowed_email_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class InstanceControlledEgressConfigArgs:
    def __init__(__self__, *, egress_fqdns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., marketplace_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @egress_fqdns.setter
    def egress_fqdns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def marketplace_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class InstanceCustomDomainArgs:
    def __init__(__self__, *, domain: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceDenyMaintenancePeriodArgs:
    def __init__(__self__, *, end_date: pulumi.Input[InstanceDenyMaintenancePeriodEndDateArgs], start_date: pulumi.Input[InstanceDenyMaintenancePeriodStartDateArgs], time: pulumi.Input[InstanceDenyMaintenancePeriodTimeArgs]) -> None:
    ...
    @end_date.setter
    def end_date(self, value: pulumi.Input[InstanceDenyMaintenancePeriodEndDateArgs]): # -> None:
        ...
    ...
    @start_date.setter
    def start_date(self, value: pulumi.Input[InstanceDenyMaintenancePeriodStartDateArgs]): # -> None:
        ...
    ...
    @time.setter
    def time(self, value: pulumi.Input[InstanceDenyMaintenancePeriodTimeArgs]): # -> None:
        ...
...
class InstanceEncryptionConfigArgs:
    def __init__(__self__, *, kms_key_name: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_name_version: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def kms_key_name_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstanceMaintenanceWindowArgs:
    def __init__(__self__, *, day_of_week: pulumi.Input[_builtins.str], start_time: pulumi.Input[InstanceMaintenanceWindowStartTimeArgs]) -> None:
    ...
    @start_time.setter
    def start_time(self, value: pulumi.Input[InstanceMaintenanceWindowStartTimeArgs]): # -> None:
        ...
...
class InstancePeriodicExportConfigArgs:
    def __init__(__self__, *, gcs_uri: pulumi.Input[_builtins.str], kms_key: pulumi.Input[_builtins.str], start_time: pulumi.Input[InstancePeriodicExportConfigStartTimeArgs]) -> None:
    ...
    @gcs_uri.setter
    def gcs_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @start_time.setter
    def start_time(self, value: pulumi.Input[InstancePeriodicExportConfigStartTimeArgs]): # -> None:
        ...
...
class InstancePscConfigArgs:
    def __init__(__self__, *, allowed_vpcs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., looker_service_attachment_uri: Optional[pulumi.Input[_builtins.str]] = ..., service_attachments: Optional[pulumi.Input[Sequence[pulumi.Input[InstancePscConfigServiceAttachmentArgs]]]] = ...) -> None:
    ...
    @allowed_vpcs.setter
    def allowed_vpcs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def looker_service_attachment_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def service_attachments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstancePscConfigServiceAttachmentArgs]]]]): # -> None:
        ...
...
class InstancePscConfigServiceAttachmentArgs:
    def __init__(__self__, *, connection_status: Optional[pulumi.Input[_builtins.str]] = ..., local_fqdn: Optional[pulumi.Input[_builtins.str]] = ..., target_service_attachment_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @local_fqdn.setter
    def local_fqdn(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_service_attachment_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstanceUserMetadataArgs:
    def __init__(__self__, *, additional_developer_user_count: Optional[pulumi.Input[_builtins.int]] = ..., additional_standard_user_count: Optional[pulumi.Input[_builtins.int]] = ..., additional_viewer_user_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def additional_developer_user_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def additional_standard_user_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def additional_viewer_user_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
