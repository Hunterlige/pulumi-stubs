...
class OrganizationFeedArgs:
    def __init__(__self__, *, billing_project: pulumi.Input[_builtins.str], feed_id: pulumi.Input[_builtins.str], feed_output_config: pulumi.Input[OrganizationFeedFeedOutputConfigArgs], org_id: pulumi.Input[_builtins.str], asset_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., asset_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., condition: Optional[pulumi.Input[OrganizationFeedConditionArgs]] = ..., content_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def feed_output_config(self, value: pulumi.Input[OrganizationFeedFeedOutputConfigArgs]): # -> None:
        ...
    ...
    @condition.setter
    def condition(self, value: Optional[pulumi.Input[OrganizationFeedConditionArgs]]): # -> None:
        ...
...
class _OrganizationFeedState:
    def __init__(__self__, *, asset_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., asset_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., billing_project: Optional[pulumi.Input[_builtins.str]] = ..., condition: Optional[pulumi.Input[OrganizationFeedConditionArgs]] = ..., content_type: Optional[pulumi.Input[_builtins.str]] = ..., feed_id: Optional[pulumi.Input[_builtins.str]] = ..., feed_output_config: Optional[pulumi.Input[OrganizationFeedFeedOutputConfigArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., org_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @feed_output_config.setter
    def feed_output_config(self, value: Optional[pulumi.Input[OrganizationFeedFeedOutputConfigArgs]]): # -> None:
        ...
...
class OrganizationFeed(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., asset_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., asset_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., billing_project: Optional[pulumi.Input[_builtins.str]] = ..., condition: Optional[pulumi.Input[Union[OrganizationFeedConditionArgs, OrganizationFeedConditionArgsDict]]] = ..., content_type: Optional[pulumi.Input[_builtins.str]] = ..., feed_id: Optional[pulumi.Input[_builtins.str]] = ..., feed_output_config: Optional[pulumi.Input[Union[OrganizationFeedFeedOutputConfigArgs, OrganizationFeedFeedOutputConfigArgsDict]]] = ..., org_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: OrganizationFeedArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., asset_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., asset_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., billing_project: Optional[pulumi.Input[_builtins.str]] = ..., condition: Optional[pulumi.Input[Union[OrganizationFeedConditionArgs, OrganizationFeedConditionArgsDict]]] = ..., content_type: Optional[pulumi.Input[_builtins.str]] = ..., feed_id: Optional[pulumi.Input[_builtins.str]] = ..., feed_output_config: Optional[pulumi.Input[Union[OrganizationFeedFeedOutputConfigArgs, OrganizationFeedFeedOutputConfigArgsDict]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., org_id: Optional[pulumi.Input[_builtins.str]] = ...) -> OrganizationFeed:
