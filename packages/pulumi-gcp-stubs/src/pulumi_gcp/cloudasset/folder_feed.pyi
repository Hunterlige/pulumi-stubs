...
class FolderFeedArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[FolderFeedConditionArgs]] = ...,
    ...
    def feed_output_config(
        self, value: pulumi.Input[FolderFeedFeedOutputConfigArgs]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _FolderFeedState:
    def __init__(
        ...
        *,
        ...
        feed_output_config: Optional[
            pulumi.Input[FolderFeedFeedOutputConfigArgs]
        ] = ...,
    ...
    def feed_output_config(
        self,
    ) -> Optional[pulumi.Input[FolderFeedFeedOutputConfigArgs]]: ...
    @feed_output_config.setter
    def feed_output_config(
        self, value: Optional[pulumi.Input[FolderFeedFeedOutputConfigArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class FolderFeed(pulumi.CustomResource):
    ...
    def __init__(
        ...
        billing_project: Optional[pulumi.Input[_builtins.str]] = ...,
        condition: Optional[
            pulumi.Input[Union[FolderFeedConditionArgs, FolderFeedConditionArgsDict]]
        ] = ...,
        content_type: Optional[pulumi.Input[_builtins.str]] = ...,
        feed_id: Optional[pulumi.Input[_builtins.str]] = ...,
        feed_output_config: Optional[
            pulumi.Input[
                Union[
                    FolderFeedFeedOutputConfigArgs, FolderFeedFeedOutputConfigArgsDict
                ]
            ]
        ] = ...,
        folder: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def feed_output_config(
        self,
    ) -> pulumi.Output[outputs.FolderFeedFeedOutputConfig]: ...
    @_builtins.property
    @pulumi.getter
