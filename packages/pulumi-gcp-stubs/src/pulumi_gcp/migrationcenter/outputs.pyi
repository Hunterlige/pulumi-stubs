...
class PreferenceSetVirtualMachinePreferences(dict):
    ...
    def __init__(__self__, *, commitment_plan: Optional[_builtins.str] = ..., compute_engine_preferences: Optional[outputs.PreferenceSetVirtualMachinePreferencesComputeEnginePreferences] = ..., region_preferences: Optional[outputs.PreferenceSetVirtualMachinePreferencesRegionPreferences] = ..., sizing_optimization_strategy: Optional[_builtins.str] = ..., sole_tenancy_preferences: Optional[outputs.PreferenceSetVirtualMachinePreferencesSoleTenancyPreferences] = ..., target_product: Optional[_builtins.str] = ..., vmware_engine_preferences: Optional[outputs.PreferenceSetVirtualMachinePreferencesVmwareEnginePreferences] = ...) -> None:
...
class PreferenceSetVirtualMachinePreferencesComputeEnginePreferences(dict):
    ...
    def __init__(__self__, *, license_type: Optional[_builtins.str] = ..., machine_preferences: Optional[outputs.PreferenceSetVirtualMachinePreferencesComputeEnginePreferencesMachinePreferences] = ...) -> None:
...
class PreferenceSetVirtualMachinePreferencesComputeEnginePreferencesMachinePreferences(dict):
    ...
    def __init__(__self__, *, allowed_machine_series: Optional[Sequence[outputs.PreferenceSetVirtualMachinePreferencesComputeEnginePreferencesMachinePreferencesAllowedMachineSeries]] = ...) -> None:
...
class PreferenceSetVirtualMachinePreferencesRegionPreferences(dict):
    ...
    def __init__(__self__, *, preferred_regions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class PreferenceSetVirtualMachinePreferencesSoleTenancyPreferences(dict):
    ...
    def __init__(__self__, *, commitment_plan: Optional[_builtins.str] = ..., cpu_overcommit_ratio: Optional[_builtins.float] = ..., host_maintenance_policy: Optional[_builtins.str] = ..., node_types: Optional[Sequence[outputs.PreferenceSetVirtualMachinePreferencesSoleTenancyPreferencesNodeType]] = ...) -> None:
...
class PreferenceSetVirtualMachinePreferencesVmwareEnginePreferences(dict):
    ...
    def __init__(__self__, *, commitment_plan: Optional[_builtins.str] = ..., cpu_overcommit_ratio: Optional[_builtins.float] = ..., memory_overcommit_ratio: Optional[_builtins.float] = ..., storage_deduplication_compression_ratio: Optional[_builtins.float] = ...) -> None:
