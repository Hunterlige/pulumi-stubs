...
class DatasetIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[DatasetIamMemberConditionArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[DatasetIamMemberConditionArgs]]
    ): ...
...
class DatasetIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[DatasetIamMemberConditionArgs, DatasetIamMemberConditionArgsDict]
            ]
        ] = ...,
        dataset_id: Optional[pulumi.Input[_builtins.str]] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.DatasetIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="datasetId")
