...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConsentStoreIamBindingCondition', 'ConsentStoreIamMemberCondition', 'DatasetEncryptionSpec', 'DatasetIamBindingCondition', 'DatasetIamMemberCondition', 'DicomStoreIamBindingCondition', 'DicomStoreIamMemberCondition', 'DicomStoreNotificationConfig', 'DicomStoreStreamConfig', 'DicomStoreStreamConfigBigqueryDestination', 'FhirStoreConsentConfig', 'FhirStoreConsentConfigAccessDeterminationLogConfig', 'FhirStoreConsentConfigConsentHeaderHandling', 'FhirStoreIamBindingCondition', 'FhirStoreIamMemberCondition', 'FhirStoreNotificationConfig', 'FhirStoreStreamConfig', 'FhirStoreStreamConfigBigqueryDestination', ..., ..., 'FhirStoreValidationConfig', 'Hl7StoreIamBindingCondition', 'Hl7StoreIamMemberCondition', 'Hl7StoreNotificationConfig', 'Hl7StoreNotificationConfigs', 'Hl7StoreParserConfig', 'PipelineJobBackfillPipelineJob', 'PipelineJobMappingPipelineJob', 'PipelineJobMappingPipelineJobFhirStreamingSource', 'PipelineJobMappingPipelineJobMappingConfig', ..., 'PipelineJobReconciliationPipelineJob', 'PipelineJobReconciliationPipelineJobMergeConfig', ..., 'WorkspaceSettings']
@pulumi.output_type
...
class DicomStoreNotificationConfig(dict):
    ...
    def __init__(__self__, *, pubsub_topic: _builtins.str, send_for_bulk_import: Optional[_builtins.bool] = ...) -> None:
...
class DicomStoreStreamConfig(dict):
    ...
    def __init__(__self__, *, bigquery_destination: outputs.DicomStoreStreamConfigBigqueryDestination) -> None:
...
class FhirStoreConsentConfig(dict):
    ...
    def __init__(__self__, *, version: _builtins.str, access_determination_log_config: Optional[outputs.FhirStoreConsentConfigAccessDeterminationLogConfig] = ..., access_enforced: Optional[_builtins.bool] = ..., consent_header_handling: Optional[outputs.FhirStoreConsentConfigConsentHeaderHandling] = ..., enforced_admin_consents: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FhirStoreNotificationConfig(dict):
    ...
    def __init__(__self__, *, pubsub_topic: _builtins.str, send_full_resource: Optional[_builtins.bool] = ..., send_previous_resource_on_delete: Optional[_builtins.bool] = ...) -> None:
...
class FhirStoreStreamConfig(dict):
    ...
    def __init__(__self__, *, bigquery_destination: outputs.FhirStoreStreamConfigBigqueryDestination, resource_types: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FhirStoreStreamConfigBigqueryDestination(dict):
    ...
    def __init__(__self__, *, dataset_uri: _builtins.str, schema_config: outputs.FhirStoreStreamConfigBigqueryDestinationSchemaConfig) -> None:
...
class FhirStoreStreamConfigBigqueryDestinationSchemaConfig(dict):
    ...
    def __init__(__self__, *, recursive_structure_depth: _builtins.int, last_updated_partition_config: Optional[outputs.FhirStoreStreamConfigBigqueryDestinationSchemaConfigLastUpdatedPartitionConfig] = ..., schema_type: Optional[_builtins.str] = ...) -> None:
...
class FhirStoreStreamConfigBigqueryDestinationSchemaConfigLastUpdatedPartitionConfig(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, expiration_ms: Optional[_builtins.str] = ...) -> None:
...
class FhirStoreValidationConfig(dict):
    ...
    def __init__(__self__, *, disable_fhirpath_validation: Optional[_builtins.bool] = ..., disable_profile_validation: Optional[_builtins.bool] = ..., disable_reference_type_validation: Optional[_builtins.bool] = ..., disable_required_field_validation: Optional[_builtins.bool] = ..., enabled_implementation_guides: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class Hl7StoreNotificationConfigs(dict):
    ...
    def __init__(__self__, *, pubsub_topic: _builtins.str, filter: Optional[_builtins.str] = ...) -> None:
...
class Hl7StoreParserConfig(dict):
    ...
    def __init__(__self__, *, allow_null_header: Optional[_builtins.bool] = ..., schema: Optional[_builtins.str] = ..., segment_terminator: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class PipelineJobBackfillPipelineJob(dict):
    ...
    def __init__(__self__, *, mapping_pipeline_job: Optional[_builtins.str] = ...) -> None:
...
class PipelineJobMappingPipelineJob(dict):
    ...
    def __init__(__self__, *, mapping_config: outputs.PipelineJobMappingPipelineJobMappingConfig, fhir_store_destination: Optional[_builtins.str] = ..., fhir_streaming_source: Optional[outputs.PipelineJobMappingPipelineJobFhirStreamingSource] = ..., reconciliation_destination: Optional[_builtins.bool] = ...) -> None:
...
class PipelineJobMappingPipelineJobFhirStreamingSource(dict):
    ...
    def __init__(__self__, *, fhir_store: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class PipelineJobMappingPipelineJobMappingConfig(dict):
    ...
    def __init__(__self__, *, description: Optional[_builtins.str] = ..., whistle_config_source: Optional[outputs.PipelineJobMappingPipelineJobMappingConfigWhistleConfigSource] = ...) -> None:
...
class PipelineJobMappingPipelineJobMappingConfigWhistleConfigSource(dict):
    ...
    def __init__(__self__, *, import_uri_prefix: _builtins.str, uri: _builtins.str) -> None:
...
class PipelineJobReconciliationPipelineJob(dict):
    ...
    def __init__(__self__, *, matching_uri_prefix: _builtins.str, merge_config: outputs.PipelineJobReconciliationPipelineJobMergeConfig, fhir_store_destination: Optional[_builtins.str] = ...) -> None:
...
class PipelineJobReconciliationPipelineJobMergeConfig(dict):
    ...
    def __init__(__self__, *, whistle_config_source: outputs.PipelineJobReconciliationPipelineJobMergeConfigWhistleConfigSource, description: Optional[_builtins.str] = ...) -> None:
