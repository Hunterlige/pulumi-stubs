...
class Hl7StoreIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[Hl7StoreIamMemberConditionArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[Hl7StoreIamMemberConditionArgs]]
    ): ...
...
class Hl7StoreIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    Hl7StoreIamMemberConditionArgs, Hl7StoreIamMemberConditionArgsDict
                ]
            ]
        ] = ...,
        hl7_v2_store_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.Hl7StoreIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
