...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConsentStoreIamBindingConditionArgs', 'ConsentStoreIamBindingConditionArgsDict', 'ConsentStoreIamMemberConditionArgs', 'ConsentStoreIamMemberConditionArgsDict', 'DatasetEncryptionSpecArgs', 'DatasetEncryptionSpecArgsDict', 'DatasetIamBindingConditionArgs', 'DatasetIamBindingConditionArgsDict', 'DatasetIamMemberConditionArgs', 'DatasetIamMemberConditionArgsDict', 'DicomStoreIamBindingConditionArgs', 'DicomStoreIamBindingConditionArgsDict', 'DicomStoreIamMemberConditionArgs', 'DicomStoreIamMemberConditionArgsDict', 'DicomStoreNotificationConfigArgs', 'DicomStoreNotificationConfigArgsDict', 'DicomStoreStreamConfigArgs', 'DicomStoreStreamConfigArgsDict', 'DicomStoreStreamConfigBigqueryDestinationArgs', 'DicomStoreStreamConfigBigqueryDestinationArgsDict', 'FhirStoreConsentConfigArgs', 'FhirStoreConsentConfigArgsDict', ..., ..., 'FhirStoreConsentConfigConsentHeaderHandlingArgs', ..., 'FhirStoreIamBindingConditionArgs', 'FhirStoreIamBindingConditionArgsDict', 'FhirStoreIamMemberConditionArgs', 'FhirStoreIamMemberConditionArgsDict', 'FhirStoreNotificationConfigArgs', 'FhirStoreNotificationConfigArgsDict', 'FhirStoreStreamConfigArgs', 'FhirStoreStreamConfigArgsDict', 'FhirStoreStreamConfigBigqueryDestinationArgs', 'FhirStoreStreamConfigBigqueryDestinationArgsDict', ..., ..., ..., ..., 'FhirStoreValidationConfigArgs', 'FhirStoreValidationConfigArgsDict', 'Hl7StoreIamBindingConditionArgs', 'Hl7StoreIamBindingConditionArgsDict', 'Hl7StoreIamMemberConditionArgs', 'Hl7StoreIamMemberConditionArgsDict', 'Hl7StoreNotificationConfigArgs', 'Hl7StoreNotificationConfigArgsDict', 'Hl7StoreNotificationConfigsArgs', 'Hl7StoreNotificationConfigsArgsDict', 'Hl7StoreParserConfigArgs', 'Hl7StoreParserConfigArgsDict', 'PipelineJobBackfillPipelineJobArgs', 'PipelineJobBackfillPipelineJobArgsDict', 'PipelineJobMappingPipelineJobArgs', 'PipelineJobMappingPipelineJobArgsDict', ..., ..., 'PipelineJobMappingPipelineJobMappingConfigArgs', 'PipelineJobMappingPipelineJobMappingConfigArgsDict', ..., ..., 'PipelineJobReconciliationPipelineJobArgs', 'PipelineJobReconciliationPipelineJobArgsDict', ..., ..., ..., ..., 'WorkspaceSettingsArgs', 'WorkspaceSettingsArgsDict']
...
class DicomStoreNotificationConfigArgs:
    def __init__(__self__, *, pubsub_topic: pulumi.Input[_builtins.str], send_for_bulk_import: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def send_for_bulk_import(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DicomStoreStreamConfigArgs:
    def __init__(__self__, *, bigquery_destination: pulumi.Input[DicomStoreStreamConfigBigqueryDestinationArgs]) -> None:
    ...
    def bigquery_destination(self, value: pulumi.Input[DicomStoreStreamConfigBigqueryDestinationArgs]): # -> None:
        ...
...
class DicomStoreStreamConfigBigqueryDestinationArgs:
    ...
    @table_uri.setter
    def table_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class FhirStoreConsentConfigArgs:
    def __init__(__self__, *, version: pulumi.Input[_builtins.str], access_determination_log_config: Optional[pulumi.Input[FhirStoreConsentConfigAccessDeterminationLogConfigArgs]] = ..., access_enforced: Optional[pulumi.Input[_builtins.bool]] = ..., consent_header_handling: Optional[pulumi.Input[FhirStoreConsentConfigConsentHeaderHandlingArgs]] = ..., enforced_admin_consents: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def access_determination_log_config(self, value: Optional[pulumi.Input[FhirStoreConsentConfigAccessDeterminationLogConfigArgs]]): # -> None:
        ...
    ...
    def access_enforced(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def consent_header_handling(self, value: Optional[pulumi.Input[FhirStoreConsentConfigConsentHeaderHandlingArgs]]): # -> None:
        ...
    ...
    def enforced_admin_consents(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class FhirStoreConsentConfigAccessDeterminationLogConfigArgs:
    def __init__(__self__, *, log_level: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FhirStoreConsentConfigConsentHeaderHandlingArgs:
    def __init__(__self__, *, profile: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FhirStoreNotificationConfigArgs:
    def __init__(__self__, *, pubsub_topic: pulumi.Input[_builtins.str], send_full_resource: Optional[pulumi.Input[_builtins.bool]] = ..., send_previous_resource_on_delete: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def send_full_resource(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def send_previous_resource_on_delete(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class FhirStoreStreamConfigArgs:
    def __init__(__self__, *, bigquery_destination: pulumi.Input[FhirStoreStreamConfigBigqueryDestinationArgs], resource_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @bigquery_destination.setter
    def bigquery_destination(self, value: pulumi.Input[FhirStoreStreamConfigBigqueryDestinationArgs]): # -> None:
        ...
...
class FhirStoreStreamConfigBigqueryDestinationArgs:
    def __init__(__self__, *, dataset_uri: pulumi.Input[_builtins.str], schema_config: pulumi.Input[FhirStoreStreamConfigBigqueryDestinationSchemaConfigArgs]) -> None:
    ...
    @dataset_uri.setter
    def dataset_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def schema_config(self, value: pulumi.Input[FhirStoreStreamConfigBigqueryDestinationSchemaConfigArgs]): # -> None:
        ...
...
class FhirStoreStreamConfigBigqueryDestinationSchemaConfigArgs:
    def __init__(__self__, *, recursive_structure_depth: pulumi.Input[_builtins.int], last_updated_partition_config: Optional[pulumi.Input[FhirStoreStreamConfigBigqueryDestinationSchemaConfigLastUpdatedPartitionConfigArgs]] = ..., schema_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def recursive_structure_depth(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def last_updated_partition_config(self, value: Optional[pulumi.Input[FhirStoreStreamConfigBigqueryDestinationSchemaConfigLastUpdatedPartitionConfigArgs]]): # -> None:
        ...
    ...
    @schema_type.setter
    def schema_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FhirStoreStreamConfigBigqueryDestinationSchemaConfigLastUpdatedPartitionConfigArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], expiration_ms: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FhirStoreValidationConfigArgs:
    def __init__(__self__, *, disable_fhirpath_validation: Optional[pulumi.Input[_builtins.bool]] = ..., disable_profile_validation: Optional[pulumi.Input[_builtins.bool]] = ..., disable_reference_type_validation: Optional[pulumi.Input[_builtins.bool]] = ..., disable_required_field_validation: Optional[pulumi.Input[_builtins.bool]] = ..., enabled_implementation_guides: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def disable_fhirpath_validation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def disable_profile_validation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def disable_reference_type_validation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def disable_required_field_validation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enabled_implementation_guides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class Hl7StoreNotificationConfigsArgs:
    def __init__(__self__, *, pubsub_topic: pulumi.Input[_builtins.str], filter: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class Hl7StoreParserConfigArgs:
    def __init__(__self__, *, allow_null_header: Optional[pulumi.Input[_builtins.bool]] = ..., schema: Optional[pulumi.Input[_builtins.str]] = ..., segment_terminator: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allow_null_header(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def segment_terminator(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipelineJobBackfillPipelineJobArgs:
    def __init__(__self__, *, mapping_pipeline_job: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def mapping_pipeline_job(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipelineJobMappingPipelineJobArgs:
    def __init__(__self__, *, mapping_config: pulumi.Input[PipelineJobMappingPipelineJobMappingConfigArgs], fhir_store_destination: Optional[pulumi.Input[_builtins.str]] = ..., fhir_streaming_source: Optional[pulumi.Input[PipelineJobMappingPipelineJobFhirStreamingSourceArgs]] = ..., reconciliation_destination: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def mapping_config(self, value: pulumi.Input[PipelineJobMappingPipelineJobMappingConfigArgs]): # -> None:
        ...
    ...
    def fhir_store_destination(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def fhir_streaming_source(self, value: Optional[pulumi.Input[PipelineJobMappingPipelineJobFhirStreamingSourceArgs]]): # -> None:
        ...
    ...
    def reconciliation_destination(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class PipelineJobMappingPipelineJobFhirStreamingSourceArgs:
    def __init__(__self__, *, fhir_store: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @fhir_store.setter
    def fhir_store(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PipelineJobMappingPipelineJobMappingConfigArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., whistle_config_source: Optional[pulumi.Input[PipelineJobMappingPipelineJobMappingConfigWhistleConfigSourceArgs]] = ...) -> None:
    ...
    def whistle_config_source(self, value: Optional[pulumi.Input[PipelineJobMappingPipelineJobMappingConfigWhistleConfigSourceArgs]]): # -> None:
        ...
...
class PipelineJobMappingPipelineJobMappingConfigWhistleConfigSourceArgs:
    def __init__(__self__, *, import_uri_prefix: pulumi.Input[_builtins.str], uri: pulumi.Input[_builtins.str]) -> None:
    ...
    def import_uri_prefix(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PipelineJobReconciliationPipelineJobArgs:
    def __init__(__self__, *, matching_uri_prefix: pulumi.Input[_builtins.str], merge_config: pulumi.Input[PipelineJobReconciliationPipelineJobMergeConfigArgs], fhir_store_destination: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def matching_uri_prefix(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @merge_config.setter
    def merge_config(self, value: pulumi.Input[PipelineJobReconciliationPipelineJobMergeConfigArgs]): # -> None:
        ...
...
class PipelineJobReconciliationPipelineJobMergeConfigArgs:
    def __init__(__self__, *, whistle_config_source: pulumi.Input[PipelineJobReconciliationPipelineJobMergeConfigWhistleConfigSourceArgs], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @whistle_config_source.setter
    def whistle_config_source(self, value: pulumi.Input[PipelineJobReconciliationPipelineJobMergeConfigWhistleConfigSourceArgs]): # -> None:
        ...
...
class WorkspaceSettingsArgs:
    def __init__(__self__, *, data_project_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def data_project_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
