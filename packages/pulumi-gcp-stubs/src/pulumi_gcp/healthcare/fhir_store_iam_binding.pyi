...
class FhirStoreIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[FhirStoreIamBindingConditionArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[FhirStoreIamBindingConditionArgs]]
    ): ...
...
class FhirStoreIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.FhirStoreIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
