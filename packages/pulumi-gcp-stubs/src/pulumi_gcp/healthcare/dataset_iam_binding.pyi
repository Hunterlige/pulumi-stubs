...
class DatasetIamBindingArgs:
    def __init__(__self__, *, dataset_id: pulumi.Input[_builtins.str], members: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], role: pulumi.Input[_builtins.str], condition: Optional[pulumi.Input[DatasetIamBindingConditionArgs]] = ...) -> None:
...
class _DatasetIamBindingState:
    def __init__(__self__, *, condition: Optional[pulumi.Input[DatasetIamBindingConditionArgs]] = ..., dataset_id: Optional[pulumi.Input[_builtins.str]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DatasetIamBinding(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., condition: Optional[pulumi.Input[Union[DatasetIamBindingConditionArgs, DatasetIamBindingConditionArgsDict]]] = ..., dataset_id: Optional[pulumi.Input[_builtins.str]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ...) -> DatasetIamBinding:
