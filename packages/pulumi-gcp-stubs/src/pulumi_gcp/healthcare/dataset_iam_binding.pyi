...
class DatasetIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[DatasetIamBindingConditionArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[DatasetIamBindingConditionArgs]]
    ): ...
...
class DatasetIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    DatasetIamBindingConditionArgs, DatasetIamBindingConditionArgsDict
                ]
            ]
        ] = ...,
        dataset_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.DatasetIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="datasetId")
