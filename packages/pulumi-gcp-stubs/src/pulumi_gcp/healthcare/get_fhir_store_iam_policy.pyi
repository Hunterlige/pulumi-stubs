...
class GetFhirStoreIamPolicyResult:
    def __init__(
        __self__, etag=..., fhir_store_id=..., id=..., policy_data=...
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
...
def get_fhir_store_iam_policy(
    fhir_store_id: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetFhirStoreIamPolicyResult: ...
def get_fhir_store_iam_policy_output(
    fhir_store_id: Optional[pulumi.Input[_builtins.str]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetFhirStoreIamPolicyResult]: ...
