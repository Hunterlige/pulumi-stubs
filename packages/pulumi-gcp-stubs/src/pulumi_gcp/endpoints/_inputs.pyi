...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConsumersIamBindingConditionArgs', 'ConsumersIamBindingConditionArgsDict', 'ConsumersIamMemberConditionArgs', 'ConsumersIamMemberConditionArgsDict', 'ServiceApiArgs', 'ServiceApiArgsDict', 'ServiceApiMethodArgs', 'ServiceApiMethodArgsDict', 'ServiceEndpointArgs', 'ServiceEndpointArgsDict', 'ServiceIamBindingConditionArgs', 'ServiceIamBindingConditionArgsDict', 'ServiceIamMemberConditionArgs', 'ServiceIamMemberConditionArgsDict']
...
class ServiceApiArgs:
    def __init__(__self__, *, methods: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceApiMethodArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., syntax: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @methods.setter
    def methods(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceApiMethodArgs]]]]): # -> None:
        ...
...
class ServiceApiMethodArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., request_type: Optional[pulumi.Input[_builtins.str]] = ..., response_type: Optional[pulumi.Input[_builtins.str]] = ..., syntax: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServiceEndpointArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
