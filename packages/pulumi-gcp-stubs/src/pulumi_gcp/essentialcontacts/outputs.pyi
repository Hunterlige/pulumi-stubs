...
class DocumentAiWarehouseDocumentSchemaPropertyDefinition(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, date_time_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionDateTimeTypeOptions] = ..., display_name: Optional[_builtins.str] = ..., enum_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionEnumTypeOptions] = ..., float_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionFloatTypeOptions] = ..., integer_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionIntegerTypeOptions] = ..., is_filterable: Optional[_builtins.bool] = ..., is_metadata: Optional[_builtins.bool] = ..., is_repeatable: Optional[_builtins.bool] = ..., is_required: Optional[_builtins.bool] = ..., is_searchable: Optional[_builtins.bool] = ..., map_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionMapTypeOptions] = ..., property_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptions] = ..., retrieval_importance: Optional[_builtins.str] = ..., schema_sources: Optional[Sequence[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionSchemaSource]] = ..., text_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionTextTypeOptions] = ..., timestamp_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionTimestampTypeOptions] = ...) -> None:
...
class DocumentAiWarehouseDocumentSchemaPropertyDefinitionEnumTypeOptions(dict):
    ...
    def __init__(__self__, *, possible_values: Sequence[_builtins.str], validation_check_disabled: Optional[_builtins.bool] = ...) -> None:
...
class DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptions(dict):
    ...
    def __init__(__self__, *, property_definitions: Sequence[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinition]) -> None:
...
class DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinition(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, date_time_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionDateTimeTypeOptions] = ..., display_name: Optional[_builtins.str] = ..., enum_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionEnumTypeOptions] = ..., float_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionFloatTypeOptions] = ..., integer_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionIntegerTypeOptions] = ..., is_filterable: Optional[_builtins.bool] = ..., is_metadata: Optional[_builtins.bool] = ..., is_repeatable: Optional[_builtins.bool] = ..., is_required: Optional[_builtins.bool] = ..., is_searchable: Optional[_builtins.bool] = ..., map_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionMapTypeOptions] = ..., retrieval_importance: Optional[_builtins.str] = ..., schema_sources: Optional[Sequence[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionSchemaSource]] = ..., text_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionTextTypeOptions] = ..., timestamp_type_options: Optional[outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionTimestampTypeOptions] = ...) -> None:
...
class DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionSchemaSource(dict):
    ...
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., processor_type: Optional[_builtins.str] = ...) -> None:
