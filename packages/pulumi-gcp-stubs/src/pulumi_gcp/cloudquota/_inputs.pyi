...
class SQuotaPreferenceQuotaConfigArgs:
    def __init__(__self__, *, preferred_value: pulumi.Input[_builtins.str], annotations: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., granted_value: Optional[pulumi.Input[_builtins.str]] = ..., request_origin: Optional[pulumi.Input[_builtins.str]] = ..., state_detail: Optional[pulumi.Input[_builtins.str]] = ..., trace_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def preferred_value(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def granted_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def request_origin(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @state_detail.setter
    def state_detail(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @trace_id.setter
    def trace_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
