...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['SQuotaPreferenceQuotaConfig', 'GetSQuotaInfoDimensionsInfoResult', 'GetSQuotaInfoDimensionsInfoDetailResult', 'GetSQuotaInfoQuotaIncreaseEligibilityResult', 'GetSQuotaInfosQuotaInfoResult', 'GetSQuotaInfosQuotaInfoDimensionsInfoResult', 'GetSQuotaInfosQuotaInfoDimensionsInfoDetailResult', ...]
@pulumi.output_type
class SQuotaPreferenceQuotaConfig(dict):
    ...
    def __init__(__self__, *, preferred_value: _builtins.str, annotations: Optional[Mapping[str, _builtins.str]] = ..., granted_value: Optional[_builtins.str] = ..., request_origin: Optional[_builtins.str] = ..., state_detail: Optional[_builtins.str] = ..., trace_id: Optional[_builtins.str] = ...) -> None:
...
class GetSQuotaInfoDimensionsInfoResult(dict):
    def __init__(__self__, *, applicable_locations: Sequence[_builtins.str], details: Sequence[outputs.GetSQuotaInfoDimensionsInfoDetailResult], dimensions: Mapping[str, _builtins.str]) -> None:
...
class GetSQuotaInfoQuotaIncreaseEligibilityResult(dict):
    def __init__(__self__, *, ineligibility_reason: _builtins.str, is_eligible: _builtins.bool) -> None:
...
class GetSQuotaInfosQuotaInfoResult(dict):
    def __init__(__self__, *, container_type: _builtins.str, dimensions: Sequence[_builtins.str], dimensions_infos: Sequence[outputs.GetSQuotaInfosQuotaInfoDimensionsInfoResult], is_concurrent: _builtins.bool, is_fixed: _builtins.bool, is_precise: _builtins.bool, metric: _builtins.str, metric_display_name: _builtins.str, metric_unit: _builtins.str, name: _builtins.str, quota_display_name: _builtins.str, quota_id: _builtins.str, quota_increase_eligibilities: Sequence[outputs.GetSQuotaInfosQuotaInfoQuotaIncreaseEligibilityResult], refresh_interval: _builtins.str, service: _builtins.str, service_request_quota_uri: _builtins.str) -> None:
...
class GetSQuotaInfosQuotaInfoDimensionsInfoResult(dict):
    def __init__(__self__, *, applicable_locations: Sequence[_builtins.str], details: Sequence[outputs.GetSQuotaInfosQuotaInfoDimensionsInfoDetailResult], dimensions: Mapping[str, _builtins.str]) -> None:
