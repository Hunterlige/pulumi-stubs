...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AgentAfterAgentCallbackArgs', 'AgentAfterAgentCallbackArgsDict', 'AgentAfterModelCallbackArgs', 'AgentAfterModelCallbackArgsDict', 'AgentAfterToolCallbackArgs', 'AgentAfterToolCallbackArgsDict', 'AgentBeforeAgentCallbackArgs', 'AgentBeforeAgentCallbackArgsDict', 'AgentBeforeModelCallbackArgs', 'AgentBeforeModelCallbackArgsDict', 'AgentBeforeToolCallbackArgs', 'AgentBeforeToolCallbackArgsDict', 'AgentLlmAgentArgs', 'AgentLlmAgentArgsDict', 'AgentModelSettingsArgs', 'AgentModelSettingsArgsDict', 'AgentRemoteDialogflowAgentArgs', 'AgentRemoteDialogflowAgentArgsDict', 'AgentToolsetArgs', 'AgentToolsetArgsDict', 'AppAudioProcessingConfigArgs', 'AppAudioProcessingConfigArgsDict', 'AppAudioProcessingConfigAmbientSoundConfigArgs', 'AppAudioProcessingConfigAmbientSoundConfigArgsDict', 'AppAudioProcessingConfigBargeInConfigArgs', 'AppAudioProcessingConfigBargeInConfigArgsDict', 'AppAudioProcessingConfigSynthesizeSpeechConfigArgs', ..., 'AppClientCertificateSettingsArgs', 'AppClientCertificateSettingsArgsDict', 'AppDataStoreSettingsArgs', 'AppDataStoreSettingsArgsDict', 'AppDataStoreSettingsEngineArgs', 'AppDataStoreSettingsEngineArgsDict', 'AppDefaultChannelProfileArgs', 'AppDefaultChannelProfileArgsDict', 'AppDefaultChannelProfilePersonaPropertyArgs', 'AppDefaultChannelProfilePersonaPropertyArgsDict', 'AppDefaultChannelProfileWebWidgetConfigArgs', 'AppDefaultChannelProfileWebWidgetConfigArgsDict', 'AppEvaluationMetricsThresholdsArgs', 'AppEvaluationMetricsThresholdsArgsDict', ..., ..., ..., ..., ..., ..., 'AppLanguageSettingsArgs', 'AppLanguageSettingsArgsDict', 'AppLoggingSettingsArgs', 'AppLoggingSettingsArgsDict', 'AppLoggingSettingsAudioRecordingConfigArgs', 'AppLoggingSettingsAudioRecordingConfigArgsDict', 'AppLoggingSettingsBigqueryExportSettingsArgs', 'AppLoggingSettingsBigqueryExportSettingsArgsDict', 'AppLoggingSettingsCloudLoggingSettingsArgs', 'AppLoggingSettingsCloudLoggingSettingsArgsDict', 'AppLoggingSettingsConversationLoggingSettingsArgs', ..., 'AppLoggingSettingsRedactionConfigArgs', 'AppLoggingSettingsRedactionConfigArgsDict', 'AppModelSettingsArgs', 'AppModelSettingsArgsDict', 'AppTimeZoneSettingsArgs', 'AppTimeZoneSettingsArgsDict', 'AppVariableDeclarationArgs', 'AppVariableDeclarationArgsDict', 'AppVariableDeclarationSchemaArgs', 'AppVariableDeclarationSchemaArgsDict', 'AppVersionSnapshotArgs', 'AppVersionSnapshotArgsDict', 'AppVersionSnapshotAgentArgs', 'AppVersionSnapshotAgentArgsDict', 'AppVersionSnapshotAgentAfterAgentCallbackArgs', 'AppVersionSnapshotAgentAfterAgentCallbackArgsDict', 'AppVersionSnapshotAgentAfterModelCallbackArgs', 'AppVersionSnapshotAgentAfterModelCallbackArgsDict', 'AppVersionSnapshotAgentAfterToolCallbackArgs', 'AppVersionSnapshotAgentAfterToolCallbackArgsDict', 'AppVersionSnapshotAgentBeforeAgentCallbackArgs', 'AppVersionSnapshotAgentBeforeAgentCallbackArgsDict', 'AppVersionSnapshotAgentBeforeModelCallbackArgs', 'AppVersionSnapshotAgentBeforeModelCallbackArgsDict', 'AppVersionSnapshotAgentBeforeToolCallbackArgs', 'AppVersionSnapshotAgentBeforeToolCallbackArgsDict', 'AppVersionSnapshotAgentLlmAgentArgs', 'AppVersionSnapshotAgentLlmAgentArgsDict', 'AppVersionSnapshotAgentModelSettingArgs', 'AppVersionSnapshotAgentModelSettingArgsDict', 'AppVersionSnapshotAgentRemoteDialogflowAgentArgs', ..., 'AppVersionSnapshotAgentToolsetArgs', 'AppVersionSnapshotAgentToolsetArgsDict', 'AppVersionSnapshotAppArgs', 'AppVersionSnapshotAppArgsDict', 'AppVersionSnapshotAppAudioProcessingConfigArgs', 'AppVersionSnapshotAppAudioProcessingConfigArgsDict', ..., ..., ..., ..., ..., ..., 'AppVersionSnapshotAppClientCertificateSettingArgs', ..., 'AppVersionSnapshotAppDataStoreSettingArgs', 'AppVersionSnapshotAppDataStoreSettingArgsDict', 'AppVersionSnapshotAppDataStoreSettingEngineArgs', ..., 'AppVersionSnapshotAppDefaultChannelProfileArgs', 'AppVersionSnapshotAppDefaultChannelProfileArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AppVersionSnapshotAppLanguageSettingArgs', 'AppVersionSnapshotAppLanguageSettingArgsDict', 'AppVersionSnapshotAppLoggingSettingArgs', 'AppVersionSnapshotAppLoggingSettingArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AppVersionSnapshotAppModelSettingArgs', 'AppVersionSnapshotAppModelSettingArgsDict', 'AppVersionSnapshotAppTimeZoneSettingArgs', 'AppVersionSnapshotAppTimeZoneSettingArgsDict', 'AppVersionSnapshotAppVariableDeclarationArgs', 'AppVersionSnapshotAppVariableDeclarationArgsDict', 'AppVersionSnapshotAppVariableDeclarationSchemaArgs', ..., 'AppVersionSnapshotExampleArgs', 'AppVersionSnapshotExampleArgsDict', 'AppVersionSnapshotExampleMessageArgs', 'AppVersionSnapshotExampleMessageArgsDict', 'AppVersionSnapshotExampleMessageChunkArgs', 'AppVersionSnapshotExampleMessageChunkArgsDict', ..., ..., 'AppVersionSnapshotExampleMessageChunkImageArgs', 'AppVersionSnapshotExampleMessageChunkImageArgsDict', 'AppVersionSnapshotExampleMessageChunkToolCallArgs', ..., ..., ..., ..., ..., ..., ..., 'AppVersionSnapshotGuardrailArgs', 'AppVersionSnapshotGuardrailArgsDict', 'AppVersionSnapshotGuardrailActionArgs', 'AppVersionSnapshotGuardrailActionArgsDict', ..., ..., ..., ..., ..., ..., 'AppVersionSnapshotGuardrailActionTransferAgentArgs', ..., 'AppVersionSnapshotGuardrailCodeCallbackArgs', 'AppVersionSnapshotGuardrailCodeCallbackArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'AppVersionSnapshotGuardrailContentFilterArgs', 'AppVersionSnapshotGuardrailContentFilterArgsDict', 'AppVersionSnapshotGuardrailLlmPolicyArgs', 'AppVersionSnapshotGuardrailLlmPolicyArgsDict', ..., ..., 'AppVersionSnapshotGuardrailLlmPromptSecurityArgs', ..., ..., ..., ..., ..., ..., ..., 'AppVersionSnapshotGuardrailModelSafetyArgs', 'AppVersionSnapshotGuardrailModelSafetyArgsDict', ..., ..., 'AppVersionSnapshotToolArgs', 'AppVersionSnapshotToolArgsDict', 'AppVersionSnapshotToolClientFunctionArgs', 'AppVersionSnapshotToolClientFunctionArgsDict', 'AppVersionSnapshotToolClientFunctionParameterArgs', ..., 'AppVersionSnapshotToolClientFunctionResponseArgs', ..., 'AppVersionSnapshotToolDataStoreToolArgs', 'AppVersionSnapshotToolDataStoreToolArgsDict', 'AppVersionSnapshotToolDataStoreToolBoostSpecArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AppVersionSnapshotToolGoogleSearchToolArgs', 'AppVersionSnapshotToolGoogleSearchToolArgsDict', 'AppVersionSnapshotToolOpenApiToolArgs', 'AppVersionSnapshotToolOpenApiToolArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AppVersionSnapshotToolOpenApiToolTlsConfigArgs', 'AppVersionSnapshotToolOpenApiToolTlsConfigArgsDict', ..., ..., 'AppVersionSnapshotToolPythonFunctionArgs', 'AppVersionSnapshotToolPythonFunctionArgsDict', 'AppVersionSnapshotToolSystemToolArgs', 'AppVersionSnapshotToolSystemToolArgsDict', 'AppVersionSnapshotToolsetArgs', 'AppVersionSnapshotToolsetArgsDict', 'AppVersionSnapshotToolsetOpenApiToolsetArgs', 'AppVersionSnapshotToolsetOpenApiToolsetArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'DeploymentChannelProfileArgs', 'DeploymentChannelProfileArgsDict', 'DeploymentChannelProfilePersonaPropertyArgs', 'DeploymentChannelProfilePersonaPropertyArgsDict', 'DeploymentChannelProfileWebWidgetConfigArgs', 'DeploymentChannelProfileWebWidgetConfigArgsDict', 'ExampleMessageArgs', 'ExampleMessageArgsDict', 'ExampleMessageChunkArgs', 'ExampleMessageChunkArgsDict', 'ExampleMessageChunkAgentTransferArgs', 'ExampleMessageChunkAgentTransferArgsDict', 'ExampleMessageChunkImageArgs', 'ExampleMessageChunkImageArgsDict', 'ExampleMessageChunkToolCallArgs', 'ExampleMessageChunkToolCallArgsDict', 'ExampleMessageChunkToolCallToolsetToolArgs', 'ExampleMessageChunkToolCallToolsetToolArgsDict', 'ExampleMessageChunkToolResponseArgs', 'ExampleMessageChunkToolResponseArgsDict', 'ExampleMessageChunkToolResponseToolsetToolArgs', 'ExampleMessageChunkToolResponseToolsetToolArgsDict', 'GuardrailActionArgs', 'GuardrailActionArgsDict', 'GuardrailActionGenerativeAnswerArgs', 'GuardrailActionGenerativeAnswerArgsDict', 'GuardrailActionRespondImmediatelyArgs', 'GuardrailActionRespondImmediatelyArgsDict', 'GuardrailActionRespondImmediatelyResponseArgs', 'GuardrailActionRespondImmediatelyResponseArgsDict', 'GuardrailActionTransferAgentArgs', 'GuardrailActionTransferAgentArgsDict', 'GuardrailCodeCallbackArgs', 'GuardrailCodeCallbackArgsDict', 'GuardrailCodeCallbackAfterAgentCallbackArgs', 'GuardrailCodeCallbackAfterAgentCallbackArgsDict', 'GuardrailCodeCallbackAfterModelCallbackArgs', 'GuardrailCodeCallbackAfterModelCallbackArgsDict', 'GuardrailCodeCallbackBeforeAgentCallbackArgs', 'GuardrailCodeCallbackBeforeAgentCallbackArgsDict', 'GuardrailCodeCallbackBeforeModelCallbackArgs', 'GuardrailCodeCallbackBeforeModelCallbackArgsDict', 'GuardrailContentFilterArgs', 'GuardrailContentFilterArgsDict', 'GuardrailLlmPolicyArgs', 'GuardrailLlmPolicyArgsDict', 'GuardrailLlmPolicyModelSettingsArgs', 'GuardrailLlmPolicyModelSettingsArgsDict', 'GuardrailLlmPromptSecurityArgs', 'GuardrailLlmPromptSecurityArgsDict', 'GuardrailLlmPromptSecurityCustomPolicyArgs', 'GuardrailLlmPromptSecurityCustomPolicyArgsDict', ..., ..., 'GuardrailLlmPromptSecurityDefaultSettingsArgs', 'GuardrailLlmPromptSecurityDefaultSettingsArgsDict', 'GuardrailModelSafetyArgs', 'GuardrailModelSafetyArgsDict', 'GuardrailModelSafetySafetySettingArgs', 'GuardrailModelSafetySafetySettingArgsDict', 'ToolClientFunctionArgs', 'ToolClientFunctionArgsDict', 'ToolClientFunctionParametersArgs', 'ToolClientFunctionParametersArgsDict', 'ToolClientFunctionResponseArgs', 'ToolClientFunctionResponseArgsDict', 'ToolDataStoreToolArgs', 'ToolDataStoreToolArgsDict', 'ToolDataStoreToolBoostSpecArgs', 'ToolDataStoreToolBoostSpecArgsDict', 'ToolDataStoreToolBoostSpecSpecArgs', 'ToolDataStoreToolBoostSpecSpecArgsDict', ..., ..., ..., ..., ..., ..., 'ToolDataStoreToolEngineSourceArgs', 'ToolDataStoreToolEngineSourceArgsDict', 'ToolDataStoreToolEngineSourceDataStoreSourceArgs', ..., ..., ..., ..., ..., 'ToolDataStoreToolModalityConfigArgs', 'ToolDataStoreToolModalityConfigArgsDict', 'ToolDataStoreToolModalityConfigGroundingConfigArgs', ..., 'ToolDataStoreToolModalityConfigRewriterConfigArgs', ..., ..., ..., ..., ..., ..., ..., 'ToolGoogleSearchToolArgs', 'ToolGoogleSearchToolArgsDict', 'ToolOpenApiToolArgs', 'ToolOpenApiToolArgsDict', 'ToolOpenApiToolApiAuthenticationArgs', 'ToolOpenApiToolApiAuthenticationArgsDict', 'ToolOpenApiToolApiAuthenticationApiKeyConfigArgs', ..., ..., ..., 'ToolOpenApiToolApiAuthenticationOauthConfigArgs', ..., ..., ..., ..., ..., 'ToolOpenApiToolServiceDirectoryConfigArgs', 'ToolOpenApiToolServiceDirectoryConfigArgsDict', 'ToolOpenApiToolTlsConfigArgs', 'ToolOpenApiToolTlsConfigArgsDict', 'ToolOpenApiToolTlsConfigCaCertArgs', 'ToolOpenApiToolTlsConfigCaCertArgsDict', 'ToolPythonFunctionArgs', 'ToolPythonFunctionArgsDict', 'ToolSystemToolArgs', 'ToolSystemToolArgsDict', 'ToolsetMcpToolsetArgs', 'ToolsetMcpToolsetArgsDict', 'ToolsetMcpToolsetApiAuthenticationArgs', 'ToolsetMcpToolsetApiAuthenticationArgsDict', 'ToolsetMcpToolsetApiAuthenticationApiKeyConfigArgs', ..., ..., ..., 'ToolsetMcpToolsetApiAuthenticationOauthConfigArgs', ..., ..., ..., ..., ..., 'ToolsetMcpToolsetServiceDirectoryConfigArgs', 'ToolsetMcpToolsetServiceDirectoryConfigArgsDict', 'ToolsetMcpToolsetTlsConfigArgs', 'ToolsetMcpToolsetTlsConfigArgsDict', 'ToolsetMcpToolsetTlsConfigCaCertArgs', 'ToolsetMcpToolsetTlsConfigCaCertArgsDict', 'ToolsetOpenApiToolsetArgs', 'ToolsetOpenApiToolsetArgsDict', 'ToolsetOpenApiToolsetApiAuthenticationArgs', 'ToolsetOpenApiToolsetApiAuthenticationArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ToolsetOpenApiToolsetServiceDirectoryConfigArgs', ..., 'ToolsetOpenApiToolsetTlsConfigArgs', 'ToolsetOpenApiToolsetTlsConfigArgsDict', 'ToolsetOpenApiToolsetTlsConfigCaCertArgs', 'ToolsetOpenApiToolsetTlsConfigCaCertArgsDict']
...
class AgentAfterAgentCallbackArgs:
    def __init__(__self__, *, python_code: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @python_code.setter
    def python_code(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AgentModelSettingsArgs:
    def __init__(__self__, *, model: Optional[pulumi.Input[_builtins.str]] = ..., temperature: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
...
class AgentRemoteDialogflowAgentArgs:
    def __init__(__self__, *, agent: pulumi.Input[_builtins.str], flow_id: pulumi.Input[_builtins.str], environment_id: Optional[pulumi.Input[_builtins.str]] = ..., input_variable_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., output_variable_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def input_variable_mapping(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def output_variable_mapping(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AgentToolsetArgs:
    def __init__(__self__, *, toolset: pulumi.Input[_builtins.str], tool_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @toolset.setter
    def toolset(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @tool_ids.setter
    def tool_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AppAudioProcessingConfigArgs:
    def __init__(__self__, *, ambient_sound_config: Optional[pulumi.Input[AppAudioProcessingConfigAmbientSoundConfigArgs]] = ..., barge_in_config: Optional[pulumi.Input[AppAudioProcessingConfigBargeInConfigArgs]] = ..., inactivity_timeout: Optional[pulumi.Input[_builtins.str]] = ..., synthesize_speech_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppAudioProcessingConfigSynthesizeSpeechConfigArgs]]]] = ...) -> None:
    ...
    def ambient_sound_config(self, value: Optional[pulumi.Input[AppAudioProcessingConfigAmbientSoundConfigArgs]]): # -> None:
        ...
    ...
    def barge_in_config(self, value: Optional[pulumi.Input[AppAudioProcessingConfigBargeInConfigArgs]]): # -> None:
        ...
    ...
    def inactivity_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def synthesize_speech_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppAudioProcessingConfigSynthesizeSpeechConfigArgs]]]]): # -> None:
        ...
...
class AppAudioProcessingConfigAmbientSoundConfigArgs:
    def __init__(__self__, *, gcs_uri: Optional[pulumi.Input[_builtins.str]] = ..., prebuilt_ambient_sound: Optional[pulumi.Input[_builtins.str]] = ..., volume_gain_db: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @gcs_uri.setter
    def gcs_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def prebuilt_ambient_sound(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppAudioProcessingConfigBargeInConfigArgs:
    def __init__(__self__, *, barge_in_awareness: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def barge_in_awareness(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class AppAudioProcessingConfigSynthesizeSpeechConfigArgs:
    def __init__(__self__, *, language_code: pulumi.Input[_builtins.str], speaking_rate: Optional[pulumi.Input[_builtins.float]] = ..., voice: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @voice.setter
    def voice(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppClientCertificateSettingsArgs:
    def __init__(__self__, *, private_key: pulumi.Input[_builtins.str], tls_certificate: pulumi.Input[_builtins.str], passphrase: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def tls_certificate(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AppDataStoreSettingsArgs:
    def __init__(__self__, *, engines: Optional[pulumi.Input[Sequence[pulumi.Input[AppDataStoreSettingsEngineArgs]]]] = ...) -> None:
    ...
    @engines.setter
    def engines(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppDataStoreSettingsEngineArgs]]]]): # -> None:
        ...
...
class AppDefaultChannelProfileArgs:
    def __init__(__self__, *, channel_type: Optional[pulumi.Input[_builtins.str]] = ..., disable_barge_in_control: Optional[pulumi.Input[_builtins.bool]] = ..., disable_dtmf: Optional[pulumi.Input[_builtins.bool]] = ..., persona_property: Optional[pulumi.Input[AppDefaultChannelProfilePersonaPropertyArgs]] = ..., profile_id: Optional[pulumi.Input[_builtins.str]] = ..., web_widget_config: Optional[pulumi.Input[AppDefaultChannelProfileWebWidgetConfigArgs]] = ...) -> None:
    ...
    @channel_type.setter
    def channel_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def disable_barge_in_control(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @disable_dtmf.setter
    def disable_dtmf(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def persona_property(self, value: Optional[pulumi.Input[AppDefaultChannelProfilePersonaPropertyArgs]]): # -> None:
        ...
    ...
    def web_widget_config(self, value: Optional[pulumi.Input[AppDefaultChannelProfileWebWidgetConfigArgs]]): # -> None:
        ...
...
class AppDefaultChannelProfilePersonaPropertyArgs:
    def __init__(__self__, *, persona: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppDefaultChannelProfileWebWidgetConfigArgs:
    def __init__(__self__, *, modality: Optional[pulumi.Input[_builtins.str]] = ..., theme: Optional[pulumi.Input[_builtins.str]] = ..., web_widget_title: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @modality.setter
    def modality(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @theme.setter
    def theme(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def web_widget_title(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppEvaluationMetricsThresholdsArgs:
    def __init__(__self__, *, golden_evaluation_metrics_thresholds: Optional[pulumi.Input[AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholdsArgs]] = ...) -> None:
    ...
    def golden_evaluation_metrics_thresholds(self, value: Optional[pulumi.Input[AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholdsArgs]]): # -> None:
        ...
...
class AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholdsArgs:
    def __init__(__self__, *, expectation_level_metrics_thresholds: Optional[pulumi.Input[AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholdsExpectationLevelMetricsThresholdsArgs]] = ..., turn_level_metrics_thresholds: Optional[pulumi.Input[AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholdsTurnLevelMetricsThresholdsArgs]] = ...) -> None:
    ...
    def expectation_level_metrics_thresholds(self, value: Optional[pulumi.Input[AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholdsExpectationLevelMetricsThresholdsArgs]]): # -> None:
        ...
    ...
    def turn_level_metrics_thresholds(self, value: Optional[pulumi.Input[AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholdsTurnLevelMetricsThresholdsArgs]]): # -> None:
        ...
...
class AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholdsExpectationLevelMetricsThresholdsArgs:
    def __init__(__self__, *, tool_invocation_parameter_correctness_threshold: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def tool_invocation_parameter_correctness_threshold(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class AppEvaluationMetricsThresholdsGoldenEvaluationMetricsThresholdsTurnLevelMetricsThresholdsArgs:
    def __init__(__self__, *, overall_tool_invocation_correctness_threshold: Optional[pulumi.Input[_builtins.float]] = ..., semantic_similarity_success_threshold: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def overall_tool_invocation_correctness_threshold(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def semantic_similarity_success_threshold(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AppLanguageSettingsArgs:
    def __init__(__self__, *, default_language_code: Optional[pulumi.Input[_builtins.str]] = ..., enable_multilingual_support: Optional[pulumi.Input[_builtins.bool]] = ..., fallback_action: Optional[pulumi.Input[_builtins.str]] = ..., supported_language_codes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def enable_multilingual_support(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def fallback_action(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppLoggingSettingsArgs:
    def __init__(__self__, *, audio_recording_config: Optional[pulumi.Input[AppLoggingSettingsAudioRecordingConfigArgs]] = ..., bigquery_export_settings: Optional[pulumi.Input[AppLoggingSettingsBigqueryExportSettingsArgs]] = ..., cloud_logging_settings: Optional[pulumi.Input[AppLoggingSettingsCloudLoggingSettingsArgs]] = ..., conversation_logging_settings: Optional[pulumi.Input[AppLoggingSettingsConversationLoggingSettingsArgs]] = ..., redaction_config: Optional[pulumi.Input[AppLoggingSettingsRedactionConfigArgs]] = ...) -> None:
    ...
    def audio_recording_config(self, value: Optional[pulumi.Input[AppLoggingSettingsAudioRecordingConfigArgs]]): # -> None:
        ...
    ...
    def bigquery_export_settings(self, value: Optional[pulumi.Input[AppLoggingSettingsBigqueryExportSettingsArgs]]): # -> None:
        ...
    ...
    def cloud_logging_settings(self, value: Optional[pulumi.Input[AppLoggingSettingsCloudLoggingSettingsArgs]]): # -> None:
        ...
    ...
    def conversation_logging_settings(self, value: Optional[pulumi.Input[AppLoggingSettingsConversationLoggingSettingsArgs]]): # -> None:
        ...
    ...
    def redaction_config(self, value: Optional[pulumi.Input[AppLoggingSettingsRedactionConfigArgs]]): # -> None:
        ...
...
class AppLoggingSettingsAudioRecordingConfigArgs:
    def __init__(__self__, *, gcs_bucket: Optional[pulumi.Input[_builtins.str]] = ..., gcs_path_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def gcs_path_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppLoggingSettingsBigqueryExportSettingsArgs:
    def __init__(__self__, *, dataset: Optional[pulumi.Input[_builtins.str]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppLoggingSettingsCloudLoggingSettingsArgs:
    def __init__(__self__, *, enable_cloud_logging: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class AppLoggingSettingsConversationLoggingSettingsArgs:
    def __init__(__self__, *, disable_conversation_logging: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def disable_conversation_logging(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class AppLoggingSettingsRedactionConfigArgs:
    def __init__(__self__, *, deidentify_template: Optional[pulumi.Input[_builtins.str]] = ..., enable_redaction: Optional[pulumi.Input[_builtins.bool]] = ..., inspect_template: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def enable_redaction(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class AppTimeZoneSettingsArgs:
    def __init__(__self__, *, time_zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppVariableDeclarationArgs:
    def __init__(__self__, *, description: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], schema: pulumi.Input[AppVariableDeclarationSchemaArgs]) -> None:
    ...
    @schema.setter
    def schema(self, value: pulumi.Input[AppVariableDeclarationSchemaArgs]): # -> None:
        ...
...
class AppVariableDeclarationSchemaArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], additional_properties: Optional[pulumi.Input[_builtins.str]] = ..., any_of: Optional[pulumi.Input[_builtins.str]] = ..., default: Optional[pulumi.Input[_builtins.str]] = ..., defs: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., enums: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., items: Optional[pulumi.Input[_builtins.str]] = ..., nullable: Optional[pulumi.Input[_builtins.bool]] = ..., prefix_items: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[_builtins.str]] = ..., ref: Optional[pulumi.Input[_builtins.str]] = ..., requireds: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., title: Optional[pulumi.Input[_builtins.str]] = ..., unique_items: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def additional_properties(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @any_of.setter
    def any_of(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @defs.setter
    def defs(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @enums.setter
    def enums(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @items.setter
    def items(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @nullable.setter
    def nullable(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @prefix_items.setter
    def prefix_items(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @requireds.setter
    def requireds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @unique_items.setter
    def unique_items(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class AppVersionSnapshotArgs:
    def __init__(__self__, *, agents: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentArgs]]]] = ..., apps: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppArgs]]]] = ..., examples: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleArgs]]]] = ..., guardrails: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailArgs]]]] = ..., tools: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolArgs]]]] = ..., toolsets: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetArgs]]]] = ...) -> None:
    ...
    @agents.setter
    def agents(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentArgs]]]]): # -> None:
        ...
    ...
    @apps.setter
    def apps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppArgs]]]]): # -> None:
        ...
    ...
    @examples.setter
    def examples(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleArgs]]]]): # -> None:
        ...
    ...
    @guardrails.setter
    def guardrails(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailArgs]]]]): # -> None:
        ...
    ...
    @tools.setter
    def tools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolArgs]]]]): # -> None:
        ...
    ...
    @toolsets.setter
    def toolsets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotAgentArgs:
    def __init__(__self__, *, after_agent_callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentAfterAgentCallbackArgs]]]] = ..., after_model_callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentAfterModelCallbackArgs]]]] = ..., after_tool_callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentAfterToolCallbackArgs]]]] = ..., before_agent_callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentBeforeAgentCallbackArgs]]]] = ..., before_model_callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentBeforeModelCallbackArgs]]]] = ..., before_tool_callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentBeforeToolCallbackArgs]]]] = ..., child_agents: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., generated_summary: Optional[pulumi.Input[_builtins.str]] = ..., guardrails: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., instruction: Optional[pulumi.Input[_builtins.str]] = ..., llm_agents: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentLlmAgentArgs]]]] = ..., model_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentModelSettingArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., remote_dialogflow_agents: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentRemoteDialogflowAgentArgs]]]] = ..., tools: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., toolsets: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentToolsetArgs]]]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def after_agent_callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentAfterAgentCallbackArgs]]]]): # -> None:
        ...
    ...
    def after_model_callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentAfterModelCallbackArgs]]]]): # -> None:
        ...
    ...
    def after_tool_callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentAfterToolCallbackArgs]]]]): # -> None:
        ...
    ...
    def before_agent_callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentBeforeAgentCallbackArgs]]]]): # -> None:
        ...
    ...
    def before_model_callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentBeforeModelCallbackArgs]]]]): # -> None:
        ...
    ...
    def before_tool_callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentBeforeToolCallbackArgs]]]]): # -> None:
        ...
    ...
    @llm_agents.setter
    def llm_agents(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentLlmAgentArgs]]]]): # -> None:
        ...
    ...
    def model_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentModelSettingArgs]]]]): # -> None:
        ...
    ...
    def remote_dialogflow_agents(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentRemoteDialogflowAgentArgs]]]]): # -> None:
        ...
    ...
    @toolsets.setter
    def toolsets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAgentToolsetArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotAgentAfterAgentCallbackArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., python_code: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @python_code.setter
    def python_code(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotAgentRemoteDialogflowAgentArgs:
    def __init__(__self__, *, agent: Optional[pulumi.Input[_builtins.str]] = ..., environment_id: Optional[pulumi.Input[_builtins.str]] = ..., flow_id: Optional[pulumi.Input[_builtins.str]] = ..., input_variable_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., output_variable_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @flow_id.setter
    def flow_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotAgentToolsetArgs:
    def __init__(__self__, *, tool_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., toolset: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @toolset.setter
    def toolset(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotAppArgs:
    def __init__(__self__, *, audio_processing_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppAudioProcessingConfigArgs]]]] = ..., client_certificate_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppClientCertificateSettingArgs]]]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., data_store_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppDataStoreSettingArgs]]]] = ..., default_channel_profiles: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppDefaultChannelProfileArgs]]]] = ..., deployment_count: Optional[pulumi.Input[_builtins.int]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., evaluation_metrics_thresholds: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppEvaluationMetricsThresholdArgs]]]] = ..., global_instruction: Optional[pulumi.Input[_builtins.str]] = ..., guardrails: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., language_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLanguageSettingArgs]]]] = ..., logging_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingArgs]]]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., model_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppModelSettingArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., root_agent: Optional[pulumi.Input[_builtins.str]] = ..., time_zone_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppTimeZoneSettingArgs]]]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ..., variable_declarations: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppVariableDeclarationArgs]]]] = ...) -> None:
    ...
    def audio_processing_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppAudioProcessingConfigArgs]]]]): # -> None:
        ...
    ...
    def client_certificate_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppClientCertificateSettingArgs]]]]): # -> None:
        ...
    ...
    def data_store_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppDataStoreSettingArgs]]]]): # -> None:
        ...
    ...
    def default_channel_profiles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppDefaultChannelProfileArgs]]]]): # -> None:
        ...
    ...
    def deployment_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def evaluation_metrics_thresholds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppEvaluationMetricsThresholdArgs]]]]): # -> None:
        ...
    ...
    def global_instruction(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def language_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLanguageSettingArgs]]]]): # -> None:
        ...
    ...
    def logging_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingArgs]]]]): # -> None:
        ...
    ...
    @model_settings.setter
    def model_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppModelSettingArgs]]]]): # -> None:
        ...
    ...
    @root_agent.setter
    def root_agent(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def time_zone_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppTimeZoneSettingArgs]]]]): # -> None:
        ...
    ...
    def variable_declarations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppVariableDeclarationArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotAppAudioProcessingConfigArgs:
    def __init__(__self__, *, ambient_sound_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppAudioProcessingConfigAmbientSoundConfigArgs]]]] = ..., barge_in_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppAudioProcessingConfigBargeInConfigArgs]]]] = ..., inactivity_timeout: Optional[pulumi.Input[_builtins.str]] = ..., synthesize_speech_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppAudioProcessingConfigSynthesizeSpeechConfigArgs]]]] = ...) -> None:
    ...
    def ambient_sound_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppAudioProcessingConfigAmbientSoundConfigArgs]]]]): # -> None:
        ...
    ...
    def barge_in_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppAudioProcessingConfigBargeInConfigArgs]]]]): # -> None:
        ...
    ...
    @synthesize_speech_configs.setter
    def synthesize_speech_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppAudioProcessingConfigSynthesizeSpeechConfigArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotAppClientCertificateSettingArgs:
    def __init__(__self__, *, passphrase: Optional[pulumi.Input[_builtins.str]] = ..., private_key: Optional[pulumi.Input[_builtins.str]] = ..., tls_certificate: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @tls_certificate.setter
    def tls_certificate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotAppDataStoreSettingArgs:
    def __init__(__self__, *, engines: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppDataStoreSettingEngineArgs]]]] = ...) -> None:
    ...
    @engines.setter
    def engines(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppDataStoreSettingEngineArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotAppDefaultChannelProfileArgs:
    def __init__(__self__, *, channel_type: Optional[pulumi.Input[_builtins.str]] = ..., disable_barge_in_control: Optional[pulumi.Input[_builtins.bool]] = ..., disable_dtmf: Optional[pulumi.Input[_builtins.bool]] = ..., persona_properties: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppDefaultChannelProfilePersonaPropertyArgs]]]] = ..., profile_id: Optional[pulumi.Input[_builtins.str]] = ..., web_widget_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppDefaultChannelProfileWebWidgetConfigArgs]]]] = ...) -> None:
    ...
    def persona_properties(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppDefaultChannelProfilePersonaPropertyArgs]]]]): # -> None:
        ...
    ...
    def web_widget_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppDefaultChannelProfileWebWidgetConfigArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotAppEvaluationMetricsThresholdArgs:
    def __init__(__self__, *, golden_evaluation_metrics_thresholds: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppEvaluationMetricsThresholdGoldenEvaluationMetricsThresholdArgs]]]] = ...) -> None:
    ...
    @golden_evaluation_metrics_thresholds.setter
    def golden_evaluation_metrics_thresholds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppEvaluationMetricsThresholdGoldenEvaluationMetricsThresholdArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotAppEvaluationMetricsThresholdGoldenEvaluationMetricsThresholdArgs:
    def __init__(__self__, *, expectation_level_metrics_thresholds: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppEvaluationMetricsThresholdGoldenEvaluationMetricsThresholdExpectationLevelMetricsThresholdArgs]]]] = ..., turn_level_metrics_thresholds: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppEvaluationMetricsThresholdGoldenEvaluationMetricsThresholdTurnLevelMetricsThresholdArgs]]]] = ...) -> None:
    ...
    @expectation_level_metrics_thresholds.setter
    def expectation_level_metrics_thresholds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppEvaluationMetricsThresholdGoldenEvaluationMetricsThresholdExpectationLevelMetricsThresholdArgs]]]]): # -> None:
        ...
    ...
    @turn_level_metrics_thresholds.setter
    def turn_level_metrics_thresholds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppEvaluationMetricsThresholdGoldenEvaluationMetricsThresholdTurnLevelMetricsThresholdArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotAppLoggingSettingArgs:
    def __init__(__self__, *, audio_recording_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingAudioRecordingConfigArgs]]]] = ..., bigquery_export_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingBigqueryExportSettingArgs]]]] = ..., cloud_logging_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingCloudLoggingSettingArgs]]]] = ..., conversation_logging_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingConversationLoggingSettingArgs]]]] = ..., redaction_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingRedactionConfigArgs]]]] = ...) -> None:
    ...
    def audio_recording_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingAudioRecordingConfigArgs]]]]): # -> None:
        ...
    ...
    @bigquery_export_settings.setter
    def bigquery_export_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingBigqueryExportSettingArgs]]]]): # -> None:
        ...
    ...
    @cloud_logging_settings.setter
    def cloud_logging_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingCloudLoggingSettingArgs]]]]): # -> None:
        ...
    ...
    @conversation_logging_settings.setter
    def conversation_logging_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingConversationLoggingSettingArgs]]]]): # -> None:
        ...
    ...
    def redaction_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppLoggingSettingRedactionConfigArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotAppVariableDeclarationArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., schemas: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppVariableDeclarationSchemaArgs]]]] = ...) -> None:
    ...
    @schemas.setter
    def schemas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotAppVariableDeclarationSchemaArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotAppVariableDeclarationSchemaArgs:
    def __init__(__self__, *, additional_properties: Optional[pulumi.Input[_builtins.str]] = ..., any_of: Optional[pulumi.Input[_builtins.str]] = ..., default: Optional[pulumi.Input[_builtins.str]] = ..., defs: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., enums: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., items: Optional[pulumi.Input[_builtins.str]] = ..., nullable: Optional[pulumi.Input[_builtins.bool]] = ..., prefix_items: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[_builtins.str]] = ..., ref: Optional[pulumi.Input[_builtins.str]] = ..., requireds: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ..., unique_items: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class AppVersionSnapshotExampleArgs:
    def __init__(__self__, *, create_time: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., entry_agent: Optional[pulumi.Input[_builtins.str]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., invalid: Optional[pulumi.Input[_builtins.bool]] = ..., messages: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @messages.setter
    def messages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotExampleMessageArgs:
    def __init__(__self__, *, chunks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkArgs]]]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @chunks.setter
    def chunks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotExampleMessageChunkArgs:
    def __init__(__self__, *, agent_transfers: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkAgentTransferArgs]]]] = ..., images: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkImageArgs]]]] = ..., text: Optional[pulumi.Input[_builtins.str]] = ..., tool_calls: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkToolCallArgs]]]] = ..., tool_responses: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkToolResponseArgs]]]] = ..., updated_variables: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def agent_transfers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkAgentTransferArgs]]]]): # -> None:
        ...
    ...
    @images.setter
    def images(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkImageArgs]]]]): # -> None:
        ...
    ...
    @tool_calls.setter
    def tool_calls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkToolCallArgs]]]]): # -> None:
        ...
    ...
    def tool_responses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkToolResponseArgs]]]]): # -> None:
        ...
    ...
    def updated_variables(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotExampleMessageChunkAgentTransferArgs:
    def __init__(__self__, *, display_name: Optional[pulumi.Input[_builtins.str]] = ..., target_agent: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @target_agent.setter
    def target_agent(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotExampleMessageChunkImageArgs:
    def __init__(__self__, *, data: Optional[pulumi.Input[_builtins.str]] = ..., mime_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppVersionSnapshotExampleMessageChunkToolCallArgs:
    def __init__(__self__, *, args: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., tool: Optional[pulumi.Input[_builtins.str]] = ..., toolset_tools: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkToolCallToolsetToolArgs]]]] = ...) -> None:
    ...
    @tool.setter
    def tool(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def toolset_tools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkToolCallToolsetToolArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotExampleMessageChunkToolCallToolsetToolArgs:
    def __init__(__self__, *, tool_id: Optional[pulumi.Input[_builtins.str]] = ..., toolset: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppVersionSnapshotExampleMessageChunkToolResponseArgs:
    def __init__(__self__, *, display_name: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., response: Optional[pulumi.Input[_builtins.str]] = ..., tool: Optional[pulumi.Input[_builtins.str]] = ..., toolset_tools: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkToolResponseToolsetToolArgs]]]] = ...) -> None:
    ...
    @response.setter
    def response(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @toolset_tools.setter
    def toolset_tools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotExampleMessageChunkToolResponseToolsetToolArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailArgs:
    def __init__(__self__, *, actions: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailActionArgs]]]] = ..., code_callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailCodeCallbackArgs]]]] = ..., content_filters: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailContentFilterArgs]]]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., llm_policies: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPolicyArgs]]]] = ..., llm_prompt_securities: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPromptSecurityArgs]]]] = ..., model_safeties: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailModelSafetyArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @actions.setter
    def actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailActionArgs]]]]): # -> None:
        ...
    ...
    def code_callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailCodeCallbackArgs]]]]): # -> None:
        ...
    ...
    def content_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailContentFilterArgs]]]]): # -> None:
        ...
    ...
    @llm_policies.setter
    def llm_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPolicyArgs]]]]): # -> None:
        ...
    ...
    def llm_prompt_securities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPromptSecurityArgs]]]]): # -> None:
        ...
    ...
    def model_safeties(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailModelSafetyArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailActionArgs:
    def __init__(__self__, *, generative_answers: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailActionGenerativeAnswerArgs]]]] = ..., respond_immediatelies: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailActionRespondImmediatelyArgs]]]] = ..., transfer_agents: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailActionTransferAgentArgs]]]] = ...) -> None:
    ...
    def generative_answers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailActionGenerativeAnswerArgs]]]]): # -> None:
        ...
    ...
    def respond_immediatelies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailActionRespondImmediatelyArgs]]]]): # -> None:
        ...
    ...
    def transfer_agents(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailActionTransferAgentArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailActionGenerativeAnswerArgs:
    def __init__(__self__, *, prompt: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @prompt.setter
    def prompt(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailActionRespondImmediatelyArgs:
    def __init__(__self__, *, responses: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailActionRespondImmediatelyResponseArgs]]]] = ...) -> None:
    ...
    @responses.setter
    def responses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailActionRespondImmediatelyResponseArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailActionRespondImmediatelyResponseArgs:
    def __init__(__self__, *, disabled: Optional[pulumi.Input[_builtins.bool]] = ..., text: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppVersionSnapshotGuardrailCodeCallbackArgs:
    def __init__(__self__, *, after_agent_callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailCodeCallbackAfterAgentCallbackArgs]]]] = ..., after_model_callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailCodeCallbackAfterModelCallbackArgs]]]] = ..., before_agent_callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailCodeCallbackBeforeAgentCallbackArgs]]]] = ..., before_model_callbacks: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailCodeCallbackBeforeModelCallbackArgs]]]] = ...) -> None:
    ...
    @after_agent_callbacks.setter
    def after_agent_callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailCodeCallbackAfterAgentCallbackArgs]]]]): # -> None:
        ...
    ...
    @after_model_callbacks.setter
    def after_model_callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailCodeCallbackAfterModelCallbackArgs]]]]): # -> None:
        ...
    ...
    @before_agent_callbacks.setter
    def before_agent_callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailCodeCallbackBeforeAgentCallbackArgs]]]]): # -> None:
        ...
    ...
    @before_model_callbacks.setter
    def before_model_callbacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailCodeCallbackBeforeModelCallbackArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailContentFilterArgs:
    def __init__(__self__, *, banned_contents: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., banned_contents_in_agent_responses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., banned_contents_in_user_inputs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., disregard_diacritics: Optional[pulumi.Input[_builtins.bool]] = ..., match_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def banned_contents(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def banned_contents_in_agent_responses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def banned_contents_in_user_inputs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def disregard_diacritics(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @match_type.setter
    def match_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailLlmPolicyArgs:
    def __init__(__self__, *, fail_open: Optional[pulumi.Input[_builtins.bool]] = ..., max_conversation_messages: Optional[pulumi.Input[_builtins.int]] = ..., model_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPolicyModelSettingArgs]]]] = ..., policy_scope: Optional[pulumi.Input[_builtins.str]] = ..., prompt: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @fail_open.setter
    def fail_open(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def max_conversation_messages(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @model_settings.setter
    def model_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPolicyModelSettingArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailLlmPromptSecurityArgs:
    def __init__(__self__, *, custom_policies: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPromptSecurityCustomPolicyArgs]]]] = ..., default_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPromptSecurityDefaultSettingArgs]]]] = ...) -> None:
    ...
    def custom_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPromptSecurityCustomPolicyArgs]]]]): # -> None:
        ...
    ...
    def default_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPromptSecurityDefaultSettingArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailLlmPromptSecurityCustomPolicyArgs:
    def __init__(__self__, *, fail_open: Optional[pulumi.Input[_builtins.bool]] = ..., max_conversation_messages: Optional[pulumi.Input[_builtins.int]] = ..., model_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPromptSecurityCustomPolicyModelSettingArgs]]]] = ..., policy_scope: Optional[pulumi.Input[_builtins.str]] = ..., prompt: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @model_settings.setter
    def model_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailLlmPromptSecurityCustomPolicyModelSettingArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailLlmPromptSecurityDefaultSettingArgs:
    def __init__(__self__, *, default_prompt_template: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def default_prompt_template(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailModelSafetyArgs:
    def __init__(__self__, *, safety_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailModelSafetySafetySettingArgs]]]] = ...) -> None:
    ...
    def safety_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotGuardrailModelSafetySafetySettingArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotGuardrailModelSafetySafetySettingArgs:
    def __init__(__self__, *, category: Optional[pulumi.Input[_builtins.str]] = ..., threshold: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @threshold.setter
    def threshold(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotToolArgs:
    def __init__(__self__, *, client_functions: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolClientFunctionArgs]]]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., data_store_tools: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolArgs]]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., execution_type: Optional[pulumi.Input[_builtins.str]] = ..., generated_summary: Optional[pulumi.Input[_builtins.str]] = ..., google_search_tools: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolGoogleSearchToolArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., open_api_tools: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolArgs]]]] = ..., python_functions: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolPythonFunctionArgs]]]] = ..., system_tools: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolSystemToolArgs]]]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def client_functions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolClientFunctionArgs]]]]): # -> None:
        ...
    ...
    def data_store_tools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolArgs]]]]): # -> None:
        ...
    ...
    def google_search_tools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolGoogleSearchToolArgs]]]]): # -> None:
        ...
    ...
    def open_api_tools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolArgs]]]]): # -> None:
        ...
    ...
    def python_functions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolPythonFunctionArgs]]]]): # -> None:
        ...
    ...
    @system_tools.setter
    def system_tools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolSystemToolArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolClientFunctionArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolClientFunctionParameterArgs]]]] = ..., responses: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolClientFunctionResponseArgs]]]] = ...) -> None:
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolClientFunctionParameterArgs]]]]): # -> None:
        ...
    ...
    @responses.setter
    def responses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolClientFunctionResponseArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolArgs:
    def __init__(__self__, *, boost_specs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolBoostSpecArgs]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., engine_sources: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolEngineSourceArgs]]]] = ..., max_results: Optional[pulumi.Input[_builtins.int]] = ..., modality_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @boost_specs.setter
    def boost_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolBoostSpecArgs]]]]): # -> None:
        ...
    ...
    def engine_sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolEngineSourceArgs]]]]): # -> None:
        ...
    ...
    def modality_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolBoostSpecArgs:
    def __init__(__self__, *, data_stores: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., specs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolBoostSpecSpecArgs]]]] = ...) -> None:
    ...
    @data_stores.setter
    def data_stores(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @specs.setter
    def specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolBoostSpecSpecArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolBoostSpecSpecArgs:
    def __init__(__self__, *, condition_boost_specs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecArgs]]]] = ...) -> None:
    ...
    def condition_boost_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecArgs:
    def __init__(__self__, *, boost: Optional[pulumi.Input[_builtins.float]] = ..., boost_control_specs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecArgs]]]] = ..., condition: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @boost.setter
    def boost(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def boost_control_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecArgs:
    def __init__(__self__, *, attribute_type: Optional[pulumi.Input[_builtins.str]] = ..., control_points: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecControlPointArgs]]]] = ..., field_name: Optional[pulumi.Input[_builtins.str]] = ..., interpolation_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def attribute_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def control_points(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecControlPointArgs]]]]): # -> None:
        ...
    ...
    @field_name.setter
    def field_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def interpolation_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecControlPointArgs:
    def __init__(__self__, *, attribute_value: Optional[pulumi.Input[_builtins.str]] = ..., boost_amount: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @boost_amount.setter
    def boost_amount(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolEngineSourceArgs:
    def __init__(__self__, *, data_store_sources: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSourceArgs]]]] = ..., engine: Optional[pulumi.Input[_builtins.str]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def data_store_sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSourceArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSourceArgs:
    def __init__(__self__, *, data_stores: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSourceDataStoreArgs]]]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_stores.setter
    def data_stores(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSourceDataStoreArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSourceDataStoreArgs:
    def __init__(__self__, *, connector_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSourceDataStoreConnectorConfigArgs]]]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., document_processing_mode: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def connector_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSourceDataStoreConnectorConfigArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolEngineSourceDataStoreSourceDataStoreConnectorConfigArgs:
    def __init__(__self__, *, collection: Optional[pulumi.Input[_builtins.str]] = ..., collection_display_name: Optional[pulumi.Input[_builtins.str]] = ..., data_source: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppVersionSnapshotToolDataStoreToolModalityConfigArgs:
    def __init__(__self__, *, grounding_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigGroundingConfigArgs]]]] = ..., modality_type: Optional[pulumi.Input[_builtins.str]] = ..., rewriter_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigRewriterConfigArgs]]]] = ..., summarization_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigSummarizationConfigArgs]]]] = ...) -> None:
    ...
    def grounding_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigGroundingConfigArgs]]]]): # -> None:
        ...
    ...
    def modality_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def rewriter_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigRewriterConfigArgs]]]]): # -> None:
        ...
    ...
    def summarization_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigSummarizationConfigArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolModalityConfigGroundingConfigArgs:
    def __init__(__self__, *, disabled: Optional[pulumi.Input[_builtins.bool]] = ..., grounding_level: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def grounding_level(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolModalityConfigRewriterConfigArgs:
    def __init__(__self__, *, disabled: Optional[pulumi.Input[_builtins.bool]] = ..., model_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigRewriterConfigModelSettingArgs]]]] = ..., prompt: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @model_settings.setter
    def model_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigRewriterConfigModelSettingArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolDataStoreToolModalityConfigSummarizationConfigArgs:
    def __init__(__self__, *, disabled: Optional[pulumi.Input[_builtins.bool]] = ..., model_settings: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigSummarizationConfigModelSettingArgs]]]] = ..., prompt: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @model_settings.setter
    def model_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolDataStoreToolModalityConfigSummarizationConfigModelSettingArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolGoogleSearchToolArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., exclude_domains: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def exclude_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolOpenApiToolArgs:
    def __init__(__self__, *, api_authentications: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolApiAuthenticationArgs]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., ignore_unknown_fields: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., open_api_schema: Optional[pulumi.Input[_builtins.str]] = ..., service_directory_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolServiceDirectoryConfigArgs]]]] = ..., tls_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolTlsConfigArgs]]]] = ..., url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def api_authentications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolApiAuthenticationArgs]]]]): # -> None:
        ...
    ...
    def ignore_unknown_fields(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def open_api_schema(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def service_directory_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolServiceDirectoryConfigArgs]]]]): # -> None:
        ...
    ...
    @tls_configs.setter
    def tls_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolTlsConfigArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolOpenApiToolApiAuthenticationArgs:
    def __init__(__self__, *, api_key_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolApiAuthenticationApiKeyConfigArgs]]]] = ..., oauth_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolApiAuthenticationOauthConfigArgs]]]] = ..., service_account_auth_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolApiAuthenticationServiceAccountAuthConfigArgs]]]] = ..., service_agent_id_token_auth_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolApiAuthenticationServiceAgentIdTokenAuthConfigArgs]]]] = ...) -> None:
    ...
    def api_key_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolApiAuthenticationApiKeyConfigArgs]]]]): # -> None:
        ...
    ...
    def oauth_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolApiAuthenticationOauthConfigArgs]]]]): # -> None:
        ...
    ...
    def service_account_auth_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolApiAuthenticationServiceAccountAuthConfigArgs]]]]): # -> None:
        ...
    ...
    def service_agent_id_token_auth_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolApiAuthenticationServiceAgentIdTokenAuthConfigArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolOpenApiToolApiAuthenticationApiKeyConfigArgs:
    def __init__(__self__, *, api_key_secret_version: Optional[pulumi.Input[_builtins.str]] = ..., key_name: Optional[pulumi.Input[_builtins.str]] = ..., request_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def api_key_secret_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def request_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotToolOpenApiToolApiAuthenticationOauthConfigArgs:
    def __init__(__self__, *, client_id: Optional[pulumi.Input[_builtins.str]] = ..., client_secret_version: Optional[pulumi.Input[_builtins.str]] = ..., oauth_grant_type: Optional[pulumi.Input[_builtins.str]] = ..., scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., token_endpoint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def client_secret_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def oauth_grant_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppVersionSnapshotToolOpenApiToolApiAuthenticationServiceAccountAuthConfigArgs:
    def __init__(__self__, *, service_account: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppVersionSnapshotToolOpenApiToolServiceDirectoryConfigArgs:
    def __init__(__self__, *, service: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppVersionSnapshotToolOpenApiToolTlsConfigArgs:
    def __init__(__self__, *, ca_certs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolTlsConfigCaCertArgs]]]] = ...) -> None:
    ...
    @ca_certs.setter
    def ca_certs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolOpenApiToolTlsConfigCaCertArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolOpenApiToolTlsConfigCaCertArgs:
    def __init__(__self__, *, cert: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppVersionSnapshotToolPythonFunctionArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., python_code: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppVersionSnapshotToolSystemToolArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppVersionSnapshotToolsetArgs:
    def __init__(__self__, *, create_time: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., execution_type: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., open_api_toolsets: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetArgs]]]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def open_api_toolsets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolsetOpenApiToolsetArgs:
    def __init__(__self__, *, api_authentications: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationArgs]]]] = ..., ignore_unknown_fields: Optional[pulumi.Input[_builtins.bool]] = ..., open_api_schema: Optional[pulumi.Input[_builtins.str]] = ..., service_directory_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetServiceDirectoryConfigArgs]]]] = ..., tls_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetTlsConfigArgs]]]] = ..., url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @api_authentications.setter
    def api_authentications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationArgs]]]]): # -> None:
        ...
    ...
    @service_directory_configs.setter
    def service_directory_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetServiceDirectoryConfigArgs]]]]): # -> None:
        ...
    ...
    @tls_configs.setter
    def tls_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetTlsConfigArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationArgs:
    def __init__(__self__, *, api_key_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationApiKeyConfigArgs]]]] = ..., bearer_token_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationBearerTokenConfigArgs]]]] = ..., oauth_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationOauthConfigArgs]]]] = ..., service_account_auth_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationServiceAccountAuthConfigArgs]]]] = ..., service_agent_id_token_auth_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationServiceAgentIdTokenAuthConfigArgs]]]] = ...) -> None:
    ...
    @api_key_configs.setter
    def api_key_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationApiKeyConfigArgs]]]]): # -> None:
        ...
    ...
    def bearer_token_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationBearerTokenConfigArgs]]]]): # -> None:
        ...
    ...
    @oauth_configs.setter
    def oauth_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationOauthConfigArgs]]]]): # -> None:
        ...
    ...
    @service_account_auth_configs.setter
    def service_account_auth_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationServiceAccountAuthConfigArgs]]]]): # -> None:
        ...
    ...
    @service_agent_id_token_auth_configs.setter
    def service_agent_id_token_auth_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationServiceAgentIdTokenAuthConfigArgs]]]]): # -> None:
        ...
...
class AppVersionSnapshotToolsetOpenApiToolsetApiAuthenticationBearerTokenConfigArgs:
    def __init__(__self__, *, token: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppVersionSnapshotToolsetOpenApiToolsetTlsConfigArgs:
    def __init__(__self__, *, ca_certs: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetTlsConfigCaCertArgs]]]] = ...) -> None:
    ...
    @ca_certs.setter
    def ca_certs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppVersionSnapshotToolsetOpenApiToolsetTlsConfigCaCertArgs]]]]): # -> None:
        ...
...
class DeploymentChannelProfileArgs:
    def __init__(__self__, *, channel_type: Optional[pulumi.Input[_builtins.str]] = ..., disable_barge_in_control: Optional[pulumi.Input[_builtins.bool]] = ..., disable_dtmf: Optional[pulumi.Input[_builtins.bool]] = ..., persona_property: Optional[pulumi.Input[DeploymentChannelProfilePersonaPropertyArgs]] = ..., profile_id: Optional[pulumi.Input[_builtins.str]] = ..., web_widget_config: Optional[pulumi.Input[DeploymentChannelProfileWebWidgetConfigArgs]] = ...) -> None:
    ...
    @persona_property.setter
    def persona_property(self, value: Optional[pulumi.Input[DeploymentChannelProfilePersonaPropertyArgs]]): # -> None:
        ...
    ...
    @web_widget_config.setter
    def web_widget_config(self, value: Optional[pulumi.Input[DeploymentChannelProfileWebWidgetConfigArgs]]): # -> None:
        ...
...
class ExampleMessageArgs:
    def __init__(__self__, *, chunks: Optional[pulumi.Input[Sequence[pulumi.Input[ExampleMessageChunkArgs]]]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @chunks.setter
    def chunks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExampleMessageChunkArgs]]]]): # -> None:
        ...
...
class ExampleMessageChunkArgs:
    def __init__(__self__, *, agent_transfer: Optional[pulumi.Input[ExampleMessageChunkAgentTransferArgs]] = ..., image: Optional[pulumi.Input[ExampleMessageChunkImageArgs]] = ..., text: Optional[pulumi.Input[_builtins.str]] = ..., tool_call: Optional[pulumi.Input[ExampleMessageChunkToolCallArgs]] = ..., tool_response: Optional[pulumi.Input[ExampleMessageChunkToolResponseArgs]] = ..., updated_variables: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def agent_transfer(self, value: Optional[pulumi.Input[ExampleMessageChunkAgentTransferArgs]]): # -> None:
        ...
    ...
    @image.setter
    def image(self, value: Optional[pulumi.Input[ExampleMessageChunkImageArgs]]): # -> None:
        ...
    ...
    @tool_call.setter
    def tool_call(self, value: Optional[pulumi.Input[ExampleMessageChunkToolCallArgs]]): # -> None:
        ...
    ...
    def tool_response(self, value: Optional[pulumi.Input[ExampleMessageChunkToolResponseArgs]]): # -> None:
        ...
...
class ExampleMessageChunkAgentTransferArgs:
    def __init__(__self__, *, target_agent: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @target_agent.setter
    def target_agent(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ExampleMessageChunkImageArgs:
    def __init__(__self__, *, data: pulumi.Input[_builtins.str], mime_type: pulumi.Input[_builtins.str]) -> None:
    ...
    @mime_type.setter
    def mime_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ExampleMessageChunkToolCallArgs:
    def __init__(__self__, *, args: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., tool: Optional[pulumi.Input[_builtins.str]] = ..., toolset_tool: Optional[pulumi.Input[ExampleMessageChunkToolCallToolsetToolArgs]] = ...) -> None:
    ...
    @toolset_tool.setter
    def toolset_tool(self, value: Optional[pulumi.Input[ExampleMessageChunkToolCallToolsetToolArgs]]): # -> None:
        ...
...
class ExampleMessageChunkToolCallToolsetToolArgs:
    def __init__(__self__, *, toolset: pulumi.Input[_builtins.str], tool_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ExampleMessageChunkToolResponseArgs:
    def __init__(__self__, *, response: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., tool: Optional[pulumi.Input[_builtins.str]] = ..., toolset_tool: Optional[pulumi.Input[ExampleMessageChunkToolResponseToolsetToolArgs]] = ...) -> None:
    ...
    @response.setter
    def response(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @toolset_tool.setter
    def toolset_tool(self, value: Optional[pulumi.Input[ExampleMessageChunkToolResponseToolsetToolArgs]]): # -> None:
        ...
...
class GuardrailActionArgs:
    def __init__(__self__, *, generative_answer: Optional[pulumi.Input[GuardrailActionGenerativeAnswerArgs]] = ..., respond_immediately: Optional[pulumi.Input[GuardrailActionRespondImmediatelyArgs]] = ..., transfer_agent: Optional[pulumi.Input[GuardrailActionTransferAgentArgs]] = ...) -> None:
    ...
    def generative_answer(self, value: Optional[pulumi.Input[GuardrailActionGenerativeAnswerArgs]]): # -> None:
        ...
    ...
    def respond_immediately(self, value: Optional[pulumi.Input[GuardrailActionRespondImmediatelyArgs]]): # -> None:
        ...
    ...
    def transfer_agent(self, value: Optional[pulumi.Input[GuardrailActionTransferAgentArgs]]): # -> None:
        ...
...
class GuardrailActionRespondImmediatelyArgs:
    def __init__(__self__, *, responses: pulumi.Input[Sequence[pulumi.Input[GuardrailActionRespondImmediatelyResponseArgs]]]) -> None:
    ...
    @responses.setter
    def responses(self, value: pulumi.Input[Sequence[pulumi.Input[GuardrailActionRespondImmediatelyResponseArgs]]]): # -> None:
        ...
...
class GuardrailActionRespondImmediatelyResponseArgs:
    def __init__(__self__, *, text: pulumi.Input[_builtins.str], disabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class GuardrailCodeCallbackArgs:
    def __init__(__self__, *, after_agent_callback: Optional[pulumi.Input[GuardrailCodeCallbackAfterAgentCallbackArgs]] = ..., after_model_callback: Optional[pulumi.Input[GuardrailCodeCallbackAfterModelCallbackArgs]] = ..., before_agent_callback: Optional[pulumi.Input[GuardrailCodeCallbackBeforeAgentCallbackArgs]] = ..., before_model_callback: Optional[pulumi.Input[GuardrailCodeCallbackBeforeModelCallbackArgs]] = ...) -> None:
    ...
    def after_agent_callback(self, value: Optional[pulumi.Input[GuardrailCodeCallbackAfterAgentCallbackArgs]]): # -> None:
        ...
    ...
    def after_model_callback(self, value: Optional[pulumi.Input[GuardrailCodeCallbackAfterModelCallbackArgs]]): # -> None:
        ...
    ...
    def before_agent_callback(self, value: Optional[pulumi.Input[GuardrailCodeCallbackBeforeAgentCallbackArgs]]): # -> None:
        ...
    ...
    def before_model_callback(self, value: Optional[pulumi.Input[GuardrailCodeCallbackBeforeModelCallbackArgs]]): # -> None:
        ...
...
class GuardrailContentFilterArgs:
    def __init__(__self__, *, match_type: pulumi.Input[_builtins.str], banned_contents: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., banned_contents_in_agent_responses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., banned_contents_in_user_inputs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., disregard_diacritics: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class GuardrailLlmPolicyArgs:
    def __init__(__self__, *, policy_scope: pulumi.Input[_builtins.str], prompt: pulumi.Input[_builtins.str], allow_short_utterance: Optional[pulumi.Input[_builtins.bool]] = ..., fail_open: Optional[pulumi.Input[_builtins.bool]] = ..., max_conversation_messages: Optional[pulumi.Input[_builtins.int]] = ..., model_settings: Optional[pulumi.Input[GuardrailLlmPolicyModelSettingsArgs]] = ...) -> None:
    ...
    @policy_scope.setter
    def policy_scope(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def allow_short_utterance(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @model_settings.setter
    def model_settings(self, value: Optional[pulumi.Input[GuardrailLlmPolicyModelSettingsArgs]]): # -> None:
        ...
...
class GuardrailLlmPromptSecurityArgs:
    def __init__(__self__, *, custom_policy: Optional[pulumi.Input[GuardrailLlmPromptSecurityCustomPolicyArgs]] = ..., default_settings: Optional[pulumi.Input[GuardrailLlmPromptSecurityDefaultSettingsArgs]] = ...) -> None:
    ...
    def custom_policy(self, value: Optional[pulumi.Input[GuardrailLlmPromptSecurityCustomPolicyArgs]]): # -> None:
        ...
    ...
    @default_settings.setter
    def default_settings(self, value: Optional[pulumi.Input[GuardrailLlmPromptSecurityDefaultSettingsArgs]]): # -> None:
        ...
...
class GuardrailLlmPromptSecurityCustomPolicyArgs:
    def __init__(__self__, *, policy_scope: pulumi.Input[_builtins.str], prompt: pulumi.Input[_builtins.str], allow_short_utterance: Optional[pulumi.Input[_builtins.bool]] = ..., fail_open: Optional[pulumi.Input[_builtins.bool]] = ..., max_conversation_messages: Optional[pulumi.Input[_builtins.int]] = ..., model_settings: Optional[pulumi.Input[GuardrailLlmPromptSecurityCustomPolicyModelSettingsArgs]] = ...) -> None:
    ...
    @model_settings.setter
    def model_settings(self, value: Optional[pulumi.Input[GuardrailLlmPromptSecurityCustomPolicyModelSettingsArgs]]): # -> None:
        ...
...
class GuardrailModelSafetyArgs:
    def __init__(__self__, *, safety_settings: pulumi.Input[Sequence[pulumi.Input[GuardrailModelSafetySafetySettingArgs]]]) -> None:
    ...
    @safety_settings.setter
    def safety_settings(self, value: pulumi.Input[Sequence[pulumi.Input[GuardrailModelSafetySafetySettingArgs]]]): # -> None:
        ...
...
class GuardrailModelSafetySafetySettingArgs:
    def __init__(__self__, *, category: pulumi.Input[_builtins.str], threshold: pulumi.Input[_builtins.str]) -> None:
...
class ToolClientFunctionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[ToolClientFunctionParametersArgs]] = ..., response: Optional[pulumi.Input[ToolClientFunctionResponseArgs]] = ...) -> None:
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[ToolClientFunctionParametersArgs]]): # -> None:
        ...
    ...
    @response.setter
    def response(self, value: Optional[pulumi.Input[ToolClientFunctionResponseArgs]]): # -> None:
        ...
...
class ToolClientFunctionParametersArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], additional_properties: Optional[pulumi.Input[_builtins.str]] = ..., any_of: Optional[pulumi.Input[_builtins.str]] = ..., default: Optional[pulumi.Input[_builtins.str]] = ..., defs: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., enums: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., items: Optional[pulumi.Input[_builtins.str]] = ..., max_items: Optional[pulumi.Input[_builtins.int]] = ..., maximum: Optional[pulumi.Input[_builtins.float]] = ..., min_items: Optional[pulumi.Input[_builtins.int]] = ..., minimum: Optional[pulumi.Input[_builtins.float]] = ..., nullable: Optional[pulumi.Input[_builtins.bool]] = ..., prefix_items: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[_builtins.str]] = ..., ref: Optional[pulumi.Input[_builtins.str]] = ..., requireds: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., title: Optional[pulumi.Input[_builtins.str]] = ..., unique_items: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @max_items.setter
    def max_items(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @maximum.setter
    def maximum(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @min_items.setter
    def min_items(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @minimum.setter
    def minimum(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class ToolDataStoreToolArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], boost_specs: Optional[pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolBoostSpecArgs]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., engine_source: Optional[pulumi.Input[ToolDataStoreToolEngineSourceArgs]] = ..., max_results: Optional[pulumi.Input[_builtins.int]] = ..., modality_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolModalityConfigArgs]]]] = ...) -> None:
    ...
    @boost_specs.setter
    def boost_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolBoostSpecArgs]]]]): # -> None:
        ...
    ...
    def engine_source(self, value: Optional[pulumi.Input[ToolDataStoreToolEngineSourceArgs]]): # -> None:
        ...
    ...
    @modality_configs.setter
    def modality_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolModalityConfigArgs]]]]): # -> None:
        ...
...
class ToolDataStoreToolBoostSpecArgs:
    def __init__(__self__, *, data_stores: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], specs: pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolBoostSpecSpecArgs]]]) -> None:
    ...
    @data_stores.setter
    def data_stores(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @specs.setter
    def specs(self, value: pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolBoostSpecSpecArgs]]]): # -> None:
        ...
...
class ToolDataStoreToolBoostSpecSpecArgs:
    def __init__(__self__, *, condition_boost_specs: pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolBoostSpecSpecConditionBoostSpecArgs]]]) -> None:
    ...
    @condition_boost_specs.setter
    def condition_boost_specs(self, value: pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolBoostSpecSpecConditionBoostSpecArgs]]]): # -> None:
        ...
...
class ToolDataStoreToolBoostSpecSpecConditionBoostSpecArgs:
    def __init__(__self__, *, condition: pulumi.Input[_builtins.str], boost: Optional[pulumi.Input[_builtins.float]] = ..., boost_control_spec: Optional[pulumi.Input[ToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecArgs]] = ...) -> None:
    ...
    def boost_control_spec(self, value: Optional[pulumi.Input[ToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecArgs]]): # -> None:
        ...
...
class ToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecArgs:
    def __init__(__self__, *, attribute_type: Optional[pulumi.Input[_builtins.str]] = ..., control_points: Optional[pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecControlPointArgs]]]] = ..., field_name: Optional[pulumi.Input[_builtins.str]] = ..., interpolation_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @control_points.setter
    def control_points(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolBoostSpecSpecConditionBoostSpecBoostControlSpecControlPointArgs]]]]): # -> None:
        ...
...
class ToolDataStoreToolEngineSourceArgs:
    def __init__(__self__, *, engine: pulumi.Input[_builtins.str], data_store_sources: Optional[pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolEngineSourceDataStoreSourceArgs]]]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_store_sources.setter
    def data_store_sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolEngineSourceDataStoreSourceArgs]]]]): # -> None:
        ...
...
class ToolDataStoreToolEngineSourceDataStoreSourceArgs:
    def __init__(__self__, *, data_store: Optional[pulumi.Input[ToolDataStoreToolEngineSourceDataStoreSourceDataStoreArgs]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @data_store.setter
    def data_store(self, value: Optional[pulumi.Input[ToolDataStoreToolEngineSourceDataStoreSourceDataStoreArgs]]): # -> None:
        ...
...
class ToolDataStoreToolEngineSourceDataStoreSourceDataStoreArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], connector_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolEngineSourceDataStoreSourceDataStoreConnectorConfigArgs]]]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., document_processing_mode: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @connector_configs.setter
    def connector_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolDataStoreToolEngineSourceDataStoreSourceDataStoreConnectorConfigArgs]]]]): # -> None:
        ...
...
class ToolDataStoreToolModalityConfigArgs:
    def __init__(__self__, *, modality_type: pulumi.Input[_builtins.str], grounding_config: Optional[pulumi.Input[ToolDataStoreToolModalityConfigGroundingConfigArgs]] = ..., rewriter_config: Optional[pulumi.Input[ToolDataStoreToolModalityConfigRewriterConfigArgs]] = ..., summarization_config: Optional[pulumi.Input[ToolDataStoreToolModalityConfigSummarizationConfigArgs]] = ...) -> None:
    ...
    @modality_type.setter
    def modality_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def grounding_config(self, value: Optional[pulumi.Input[ToolDataStoreToolModalityConfigGroundingConfigArgs]]): # -> None:
        ...
    ...
    def rewriter_config(self, value: Optional[pulumi.Input[ToolDataStoreToolModalityConfigRewriterConfigArgs]]): # -> None:
        ...
    ...
    def summarization_config(self, value: Optional[pulumi.Input[ToolDataStoreToolModalityConfigSummarizationConfigArgs]]): # -> None:
        ...
...
class ToolDataStoreToolModalityConfigRewriterConfigArgs:
    def __init__(__self__, *, model_settings: pulumi.Input[ToolDataStoreToolModalityConfigRewriterConfigModelSettingsArgs], disabled: Optional[pulumi.Input[_builtins.bool]] = ..., prompt: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @model_settings.setter
    def model_settings(self, value: pulumi.Input[ToolDataStoreToolModalityConfigRewriterConfigModelSettingsArgs]): # -> None:
        ...
...
class ToolDataStoreToolModalityConfigSummarizationConfigArgs:
    def __init__(__self__, *, disabled: Optional[pulumi.Input[_builtins.bool]] = ..., model_settings: Optional[pulumi.Input[ToolDataStoreToolModalityConfigSummarizationConfigModelSettingsArgs]] = ..., prompt: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @model_settings.setter
    def model_settings(self, value: Optional[pulumi.Input[ToolDataStoreToolModalityConfigSummarizationConfigModelSettingsArgs]]): # -> None:
        ...
...
class ToolGoogleSearchToolArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], context_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., exclude_domains: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., preferred_domains: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @context_urls.setter
    def context_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def preferred_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ToolOpenApiToolArgs:
    def __init__(__self__, *, api_authentications: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationArgs]]]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., ignore_unknown_fields: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., open_api_schema: Optional[pulumi.Input[_builtins.str]] = ..., service_directory_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolServiceDirectoryConfigArgs]]]] = ..., tls_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolTlsConfigArgs]]]] = ..., url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @api_authentications.setter
    def api_authentications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationArgs]]]]): # -> None:
        ...
    ...
    @service_directory_configs.setter
    def service_directory_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolServiceDirectoryConfigArgs]]]]): # -> None:
        ...
    ...
    @tls_configs.setter
    def tls_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolTlsConfigArgs]]]]): # -> None:
        ...
...
class ToolOpenApiToolApiAuthenticationArgs:
    def __init__(__self__, *, api_key_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationApiKeyConfigArgs]]]] = ..., bearer_token_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationBearerTokenConfigArgs]]]] = ..., oauth_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationOauthConfigArgs]]]] = ..., service_account_auth_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationServiceAccountAuthConfigArgs]]]] = ..., service_agent_id_token_auth_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationServiceAgentIdTokenAuthConfigArgs]]]] = ...) -> None:
    ...
    @api_key_configs.setter
    def api_key_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationApiKeyConfigArgs]]]]): # -> None:
        ...
    ...
    @bearer_token_configs.setter
    def bearer_token_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationBearerTokenConfigArgs]]]]): # -> None:
        ...
    ...
    @oauth_configs.setter
    def oauth_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationOauthConfigArgs]]]]): # -> None:
        ...
    ...
    @service_account_auth_configs.setter
    def service_account_auth_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationServiceAccountAuthConfigArgs]]]]): # -> None:
        ...
    ...
    @service_agent_id_token_auth_configs.setter
    def service_agent_id_token_auth_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolApiAuthenticationServiceAgentIdTokenAuthConfigArgs]]]]): # -> None:
        ...
...
class ToolOpenApiToolTlsConfigArgs:
    def __init__(__self__, *, ca_certs: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolTlsConfigCaCertArgs]]]] = ...) -> None:
    ...
    @ca_certs.setter
    def ca_certs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ToolOpenApiToolTlsConfigCaCertArgs]]]]): # -> None:
        ...
...
class ToolsetMcpToolsetArgs:
    def __init__(__self__, *, server_address: pulumi.Input[_builtins.str], api_authentication: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationArgs]] = ..., service_directory_config: Optional[pulumi.Input[ToolsetMcpToolsetServiceDirectoryConfigArgs]] = ..., tls_config: Optional[pulumi.Input[ToolsetMcpToolsetTlsConfigArgs]] = ...) -> None:
    ...
    def server_address(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def api_authentication(self, value: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationArgs]]): # -> None:
        ...
    ...
    def service_directory_config(self, value: Optional[pulumi.Input[ToolsetMcpToolsetServiceDirectoryConfigArgs]]): # -> None:
        ...
    ...
    @tls_config.setter
    def tls_config(self, value: Optional[pulumi.Input[ToolsetMcpToolsetTlsConfigArgs]]): # -> None:
        ...
...
class ToolsetMcpToolsetApiAuthenticationArgs:
    def __init__(__self__, *, api_key_config: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationApiKeyConfigArgs]] = ..., bearer_token_config: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationBearerTokenConfigArgs]] = ..., oauth_config: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationOauthConfigArgs]] = ..., service_account_auth_config: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationServiceAccountAuthConfigArgs]] = ..., service_agent_id_token_auth_config: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationServiceAgentIdTokenAuthConfigArgs]] = ...) -> None:
    ...
    def api_key_config(self, value: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationApiKeyConfigArgs]]): # -> None:
        ...
    ...
    def bearer_token_config(self, value: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationBearerTokenConfigArgs]]): # -> None:
        ...
    ...
    @oauth_config.setter
    def oauth_config(self, value: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationOauthConfigArgs]]): # -> None:
        ...
    ...
    def service_account_auth_config(self, value: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationServiceAccountAuthConfigArgs]]): # -> None:
        ...
    ...
    def service_agent_id_token_auth_config(self, value: Optional[pulumi.Input[ToolsetMcpToolsetApiAuthenticationServiceAgentIdTokenAuthConfigArgs]]): # -> None:
        ...
...
class ToolsetMcpToolsetApiAuthenticationApiKeyConfigArgs:
    def __init__(__self__, *, api_key_secret_version: pulumi.Input[_builtins.str], key_name: pulumi.Input[_builtins.str], request_location: pulumi.Input[_builtins.str]) -> None:
    ...
    @api_key_secret_version.setter
    def api_key_secret_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ToolsetMcpToolsetApiAuthenticationOauthConfigArgs:
    def __init__(__self__, *, client_id: pulumi.Input[_builtins.str], client_secret_version: pulumi.Input[_builtins.str], oauth_grant_type: pulumi.Input[_builtins.str], token_endpoint: pulumi.Input[_builtins.str], scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @client_secret_version.setter
    def client_secret_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ToolsetMcpToolsetApiAuthenticationServiceAccountAuthConfigArgs:
    def __init__(__self__, *, service_account: pulumi.Input[_builtins.str], scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ToolsetMcpToolsetTlsConfigArgs:
    def __init__(__self__, *, ca_certs: pulumi.Input[Sequence[pulumi.Input[ToolsetMcpToolsetTlsConfigCaCertArgs]]]) -> None:
    ...
    @ca_certs.setter
    def ca_certs(self, value: pulumi.Input[Sequence[pulumi.Input[ToolsetMcpToolsetTlsConfigCaCertArgs]]]): # -> None:
        ...
...
class ToolsetOpenApiToolsetArgs:
    def __init__(__self__, *, open_api_schema: pulumi.Input[_builtins.str], api_authentication: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationArgs]] = ..., ignore_unknown_fields: Optional[pulumi.Input[_builtins.bool]] = ..., service_directory_config: Optional[pulumi.Input[ToolsetOpenApiToolsetServiceDirectoryConfigArgs]] = ..., tls_config: Optional[pulumi.Input[ToolsetOpenApiToolsetTlsConfigArgs]] = ..., url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @open_api_schema.setter
    def open_api_schema(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @api_authentication.setter
    def api_authentication(self, value: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationArgs]]): # -> None:
        ...
    ...
    @service_directory_config.setter
    def service_directory_config(self, value: Optional[pulumi.Input[ToolsetOpenApiToolsetServiceDirectoryConfigArgs]]): # -> None:
        ...
    ...
    @tls_config.setter
    def tls_config(self, value: Optional[pulumi.Input[ToolsetOpenApiToolsetTlsConfigArgs]]): # -> None:
        ...
...
class ToolsetOpenApiToolsetApiAuthenticationArgs:
    def __init__(__self__, *, api_key_config: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationApiKeyConfigArgs]] = ..., bearer_token_config: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationBearerTokenConfigArgs]] = ..., oauth_config: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationOauthConfigArgs]] = ..., service_account_auth_config: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationServiceAccountAuthConfigArgs]] = ..., service_agent_id_token_auth_config: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationServiceAgentIdTokenAuthConfigArgs]] = ...) -> None:
    ...
    @api_key_config.setter
    def api_key_config(self, value: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationApiKeyConfigArgs]]): # -> None:
        ...
    ...
    @bearer_token_config.setter
    def bearer_token_config(self, value: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationBearerTokenConfigArgs]]): # -> None:
        ...
    ...
    @oauth_config.setter
    def oauth_config(self, value: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationOauthConfigArgs]]): # -> None:
        ...
    ...
    @service_account_auth_config.setter
    def service_account_auth_config(self, value: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationServiceAccountAuthConfigArgs]]): # -> None:
        ...
    ...
    @service_agent_id_token_auth_config.setter
    def service_agent_id_token_auth_config(self, value: Optional[pulumi.Input[ToolsetOpenApiToolsetApiAuthenticationServiceAgentIdTokenAuthConfigArgs]]): # -> None:
        ...
...
class ToolsetOpenApiToolsetTlsConfigArgs:
    def __init__(__self__, *, ca_certs: pulumi.Input[Sequence[pulumi.Input[ToolsetOpenApiToolsetTlsConfigCaCertArgs]]]) -> None:
    ...
    @ca_certs.setter
    def ca_certs(self, value: pulumi.Input[Sequence[pulumi.Input[ToolsetOpenApiToolsetTlsConfigCaCertArgs]]]): # -> None:
        ...
