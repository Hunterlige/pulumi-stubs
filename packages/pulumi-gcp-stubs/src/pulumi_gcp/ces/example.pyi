...
class ExampleArgs:
    def __init__(
        ...
        *,
        ...
        messages: Optional[
            pulumi.Input[Sequence[pulumi.Input[ExampleMessageArgs]]]
        ] = ...,
    ...
    def messages(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[ExampleMessageArgs]]]]: ...
    @messages.setter
    def messages(
        self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExampleMessageArgs]]]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _ExampleState:
    def __init__(
        ...
        *,
        ...
        example_id: Optional[pulumi.Input[_builtins.str]] = ...,
...
class Example(pulumi.CustomResource):
    ...
    def __init__(
        ...
        messages: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[Union[ExampleMessageArgs, ExampleMessageArgsDict]]
                ]
            ]
        ] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
