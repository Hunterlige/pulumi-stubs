...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessApprovalSettingsEnrolledService', 'ApiKeyRestrictions', 'ApiKeyRestrictionsAndroidKeyRestrictions', ..., 'ApiKeyRestrictionsApiTarget', 'ApiKeyRestrictionsBrowserKeyRestrictions', 'ApiKeyRestrictionsIosKeyRestrictions', 'ApiKeyRestrictionsServerKeyRestrictions', 'IAMAuditConfigAuditLogConfig', 'IAMBindingCondition', 'IAMMemberCondition', 'OrganizationPolicyBooleanPolicy', 'OrganizationPolicyListPolicy', 'OrganizationPolicyListPolicyAllow', 'OrganizationPolicyListPolicyDeny', 'OrganizationPolicyRestorePolicy', 'GetAncestryAncestorResult', 'GetIamCustomRolesRoleResult', 'GetOrganizationPolicyBooleanPolicyResult', 'GetOrganizationPolicyListPolicyResult', 'GetOrganizationPolicyListPolicyAllowResult', 'GetOrganizationPolicyListPolicyDenyResult', 'GetOrganizationPolicyRestorePolicyResult', 'GetProjectProjectResult']
@pulumi.output_type
...
class ApiKeyRestrictions(dict):
    ...
    def __init__(__self__, *, android_key_restrictions: Optional[outputs.ApiKeyRestrictionsAndroidKeyRestrictions] = ..., api_targets: Optional[Sequence[outputs.ApiKeyRestrictionsApiTarget]] = ..., browser_key_restrictions: Optional[outputs.ApiKeyRestrictionsBrowserKeyRestrictions] = ..., ios_key_restrictions: Optional[outputs.ApiKeyRestrictionsIosKeyRestrictions] = ..., server_key_restrictions: Optional[outputs.ApiKeyRestrictionsServerKeyRestrictions] = ...) -> None:
...
class ApiKeyRestrictionsAndroidKeyRestrictions(dict):
    ...
    def __init__(__self__, *, allowed_applications: Sequence[outputs.ApiKeyRestrictionsAndroidKeyRestrictionsAllowedApplication]) -> None:
...
class ApiKeyRestrictionsAndroidKeyRestrictionsAllowedApplication(dict):
    ...
    def __init__(__self__, *, package_name: _builtins.str, sha1_fingerprint: _builtins.str) -> None:
...
class ApiKeyRestrictionsApiTarget(dict):
    def __init__(__self__, *, service: _builtins.str, methods: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class OrganizationPolicyListPolicy(dict):
    ...
    def __init__(__self__, *, allow: Optional[outputs.OrganizationPolicyListPolicyAllow] = ..., deny: Optional[outputs.OrganizationPolicyListPolicyDeny] = ..., inherit_from_parent: Optional[_builtins.bool] = ..., suggested_value: Optional[_builtins.str] = ...) -> None:
...
class GetOrganizationPolicyListPolicyResult(dict):
    def __init__(__self__, *, allows: Sequence[outputs.GetOrganizationPolicyListPolicyAllowResult], denies: Sequence[outputs.GetOrganizationPolicyListPolicyDenyResult], inherit_from_parent: _builtins.bool, suggested_value: _builtins.str) -> None:
...
class GetOrganizationPolicyListPolicyAllowResult(dict):
    def __init__(__self__, *, all: _builtins.bool, values: Sequence[_builtins.str]) -> None:
...
class GetProjectProjectResult(dict):
    def __init__(__self__, *, create_time: _builtins.str, labels: Mapping[str, _builtins.str], lifecycle_state: _builtins.str, name: _builtins.str, number: _builtins.str, parent: Mapping[str, _builtins.str], project_id: _builtins.str) -> None:
