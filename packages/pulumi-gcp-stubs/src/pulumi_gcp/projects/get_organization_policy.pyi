...
class GetOrganizationPolicyResult:
    ...
    def __init__(__self__, boolean_policies=..., constraint=..., etag=..., id=..., list_policies=..., project=..., restore_policies=..., update_time=..., version=...) -> None:
        ...
...
def get_organization_policy(constraint: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetOrganizationPolicyResult:
    
    ...

def get_organization_policy_output(constraint: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetOrganizationPolicyResult]:
