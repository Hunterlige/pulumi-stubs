...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessApprovalSettingsEnrolledServiceArgs', 'AccessApprovalSettingsEnrolledServiceArgsDict', 'ApiKeyRestrictionsArgs', 'ApiKeyRestrictionsArgsDict', 'ApiKeyRestrictionsAndroidKeyRestrictionsArgs', 'ApiKeyRestrictionsAndroidKeyRestrictionsArgsDict', ..., ..., 'ApiKeyRestrictionsApiTargetArgs', 'ApiKeyRestrictionsApiTargetArgsDict', 'ApiKeyRestrictionsBrowserKeyRestrictionsArgs', 'ApiKeyRestrictionsBrowserKeyRestrictionsArgsDict', 'ApiKeyRestrictionsIosKeyRestrictionsArgs', 'ApiKeyRestrictionsIosKeyRestrictionsArgsDict', 'ApiKeyRestrictionsServerKeyRestrictionsArgs', 'ApiKeyRestrictionsServerKeyRestrictionsArgsDict', 'IAMAuditConfigAuditLogConfigArgs', 'IAMAuditConfigAuditLogConfigArgsDict', 'IAMBindingConditionArgs', 'IAMBindingConditionArgsDict', 'IAMMemberConditionArgs', 'IAMMemberConditionArgsDict', 'OrganizationPolicyBooleanPolicyArgs', 'OrganizationPolicyBooleanPolicyArgsDict', 'OrganizationPolicyListPolicyArgs', 'OrganizationPolicyListPolicyArgsDict', 'OrganizationPolicyListPolicyAllowArgs', 'OrganizationPolicyListPolicyAllowArgsDict', 'OrganizationPolicyListPolicyDenyArgs', 'OrganizationPolicyListPolicyDenyArgsDict', 'OrganizationPolicyRestorePolicyArgs', 'OrganizationPolicyRestorePolicyArgsDict']
...
class AccessApprovalSettingsEnrolledServiceArgs:
    def __init__(__self__, *, cloud_product: pulumi.Input[_builtins.str], enrollment_level: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cloud_product(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def enrollment_level(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ApiKeyRestrictionsArgs:
    def __init__(__self__, *, android_key_restrictions: Optional[pulumi.Input[ApiKeyRestrictionsAndroidKeyRestrictionsArgs]] = ..., api_targets: Optional[pulumi.Input[Sequence[pulumi.Input[ApiKeyRestrictionsApiTargetArgs]]]] = ..., browser_key_restrictions: Optional[pulumi.Input[ApiKeyRestrictionsBrowserKeyRestrictionsArgs]] = ..., ios_key_restrictions: Optional[pulumi.Input[ApiKeyRestrictionsIosKeyRestrictionsArgs]] = ..., server_key_restrictions: Optional[pulumi.Input[ApiKeyRestrictionsServerKeyRestrictionsArgs]] = ...) -> None:
    ...
    def android_key_restrictions(self, value: Optional[pulumi.Input[ApiKeyRestrictionsAndroidKeyRestrictionsArgs]]): # -> None:
        ...
    ...
    @api_targets.setter
    def api_targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ApiKeyRestrictionsApiTargetArgs]]]]): # -> None:
        ...
    ...
    def browser_key_restrictions(self, value: Optional[pulumi.Input[ApiKeyRestrictionsBrowserKeyRestrictionsArgs]]): # -> None:
        ...
    ...
    def ios_key_restrictions(self, value: Optional[pulumi.Input[ApiKeyRestrictionsIosKeyRestrictionsArgs]]): # -> None:
        ...
    ...
    def server_key_restrictions(self, value: Optional[pulumi.Input[ApiKeyRestrictionsServerKeyRestrictionsArgs]]): # -> None:
        ...
...
class ApiKeyRestrictionsAndroidKeyRestrictionsArgs:
    def __init__(__self__, *, allowed_applications: pulumi.Input[Sequence[pulumi.Input[ApiKeyRestrictionsAndroidKeyRestrictionsAllowedApplicationArgs]]]) -> None:
    ...
    def allowed_applications(self, value: pulumi.Input[Sequence[pulumi.Input[ApiKeyRestrictionsAndroidKeyRestrictionsAllowedApplicationArgs]]]): # -> None:
        ...
...
class ApiKeyRestrictionsAndroidKeyRestrictionsAllowedApplicationArgs:
    def __init__(__self__, *, package_name: pulumi.Input[_builtins.str], sha1_fingerprint: pulumi.Input[_builtins.str]) -> None:
    ...
    def sha1_fingerprint(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ApiKeyRestrictionsApiTargetArgs:
    def __init__(__self__, *, service: pulumi.Input[_builtins.str], methods: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ApiKeyRestrictionsBrowserKeyRestrictionsArgs:
    def __init__(__self__, *, allowed_referrers: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def allowed_referrers(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class ApiKeyRestrictionsIosKeyRestrictionsArgs:
    def __init__(__self__, *, allowed_bundle_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def allowed_bundle_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class ApiKeyRestrictionsServerKeyRestrictionsArgs:
    def __init__(__self__, *, allowed_ips: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @allowed_ips.setter
    def allowed_ips(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class IAMAuditConfigAuditLogConfigArgs:
    def __init__(__self__, *, log_type: pulumi.Input[_builtins.str], exempted_members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def exempted_members(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class OrganizationPolicyBooleanPolicyArgs:
    ...
    @enforced.setter
    def enforced(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class OrganizationPolicyListPolicyArgs:
    def __init__(__self__, *, allow: Optional[pulumi.Input[OrganizationPolicyListPolicyAllowArgs]] = ..., deny: Optional[pulumi.Input[OrganizationPolicyListPolicyDenyArgs]] = ..., inherit_from_parent: Optional[pulumi.Input[_builtins.bool]] = ..., suggested_value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @allow.setter
    def allow(self, value: Optional[pulumi.Input[OrganizationPolicyListPolicyAllowArgs]]): # -> None:
        ...
    ...
    @deny.setter
    def deny(self, value: Optional[pulumi.Input[OrganizationPolicyListPolicyDenyArgs]]): # -> None:
        ...
    ...
    def inherit_from_parent(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def suggested_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class OrganizationPolicyListPolicyAllowArgs:
    def __init__(__self__, *, all: Optional[pulumi.Input[_builtins.bool]] = ..., values: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class OrganizationPolicyRestorePolicyArgs:
    ...
    @default.setter
    def default(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
