...
class _OrganizationPolicyState:
    def __init__(__self__, *, boolean_policy: Optional[pulumi.Input[OrganizationPolicyBooleanPolicyArgs]] = ..., constraint: Optional[pulumi.Input[_builtins.str]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., list_policy: Optional[pulumi.Input[OrganizationPolicyListPolicyArgs]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., restore_policy: Optional[pulumi.Input[OrganizationPolicyRestorePolicyArgs]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class OrganizationPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., boolean_policy: Optional[pulumi.Input[Union[OrganizationPolicyBooleanPolicyArgs, OrganizationPolicyBooleanPolicyArgsDict]]] = ..., constraint: Optional[pulumi.Input[_builtins.str]] = ..., list_policy: Optional[pulumi.Input[Union[OrganizationPolicyListPolicyArgs, OrganizationPolicyListPolicyArgsDict]]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., restore_policy: Optional[pulumi.Input[Union[OrganizationPolicyRestorePolicyArgs, OrganizationPolicyRestorePolicyArgsDict]]] = ..., version: Optional[pulumi.Input[_builtins.int]] = ..., __props__=...) -> None:
