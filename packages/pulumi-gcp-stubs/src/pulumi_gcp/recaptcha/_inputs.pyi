...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EnterpriseKeyAndroidSettingsArgs', 'EnterpriseKeyAndroidSettingsArgsDict', 'EnterpriseKeyIosSettingsArgs', 'EnterpriseKeyIosSettingsArgsDict', 'EnterpriseKeyTestingOptionsArgs', 'EnterpriseKeyTestingOptionsArgsDict', 'EnterpriseKeyWafSettingsArgs', 'EnterpriseKeyWafSettingsArgsDict', 'EnterpriseKeyWebSettingsArgs', 'EnterpriseKeyWebSettingsArgsDict']
...
class EnterpriseKeyAndroidSettingsArgs:
    def __init__(__self__, *, allow_all_package_names: Optional[pulumi.Input[_builtins.bool]] = ..., allowed_package_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allow_all_package_names(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def allowed_package_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EnterpriseKeyIosSettingsArgs:
    def __init__(__self__, *, allow_all_bundle_ids: Optional[pulumi.Input[_builtins.bool]] = ..., allowed_bundle_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allow_all_bundle_ids(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def allowed_bundle_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EnterpriseKeyTestingOptionsArgs:
    def __init__(__self__, *, testing_challenge: Optional[pulumi.Input[_builtins.str]] = ..., testing_score: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def testing_challenge(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def testing_score(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class EnterpriseKeyWafSettingsArgs:
    def __init__(__self__, *, waf_feature: pulumi.Input[_builtins.str], waf_service: pulumi.Input[_builtins.str]) -> None:
    ...
    @waf_feature.setter
    def waf_feature(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @waf_service.setter
    def waf_service(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class EnterpriseKeyWebSettingsArgs:
    def __init__(__self__, *, integration_type: pulumi.Input[_builtins.str], allow_all_domains: Optional[pulumi.Input[_builtins.bool]] = ..., allow_amp_traffic: Optional[pulumi.Input[_builtins.bool]] = ..., allowed_domains: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., challenge_security_preference: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allow_all_domains(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def allow_amp_traffic(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def allowed_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def challenge_security_preference(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
