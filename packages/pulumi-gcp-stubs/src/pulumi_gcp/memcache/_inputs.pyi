...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['InstanceMaintenancePolicyArgs', 'InstanceMaintenancePolicyArgsDict', ..., ..., ..., ..., 'InstanceMaintenanceScheduleArgs', 'InstanceMaintenanceScheduleArgsDict', 'InstanceMemcacheNodeArgs', 'InstanceMemcacheNodeArgsDict', 'InstanceMemcacheParametersArgs', 'InstanceMemcacheParametersArgsDict', 'InstanceNodeConfigArgs', 'InstanceNodeConfigArgsDict']
...
class InstanceMaintenancePolicyArgs:
    def __init__(__self__, *, weekly_maintenance_windows: pulumi.Input[Sequence[pulumi.Input[InstanceMaintenancePolicyWeeklyMaintenanceWindowArgs]]], create_time: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def weekly_maintenance_windows(self, value: pulumi.Input[Sequence[pulumi.Input[InstanceMaintenancePolicyWeeklyMaintenanceWindowArgs]]]): # -> None:
        ...
...
class InstanceMaintenancePolicyWeeklyMaintenanceWindowArgs:
    def __init__(__self__, *, day: pulumi.Input[_builtins.str], duration: pulumi.Input[_builtins.str], start_time: pulumi.Input[InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTimeArgs]) -> None:
...
class InstanceMemcacheNodeArgs:
    def __init__(__self__, *, host: Optional[pulumi.Input[_builtins.str]] = ..., node_id: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceMemcacheParametersArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., params: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class InstanceNodeConfigArgs:
    def __init__(__self__, *, cpu_count: pulumi.Input[_builtins.int], memory_size_mb: pulumi.Input[_builtins.int]) -> None:
    ...
    def memory_size_mb(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
