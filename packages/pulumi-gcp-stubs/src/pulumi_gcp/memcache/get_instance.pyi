...
class GetInstanceResult:
    ...
    def __init__(__self__, authorized_network=..., create_time=..., deletion_protection=..., discovery_endpoint=..., display_name=..., effective_labels=..., id=..., labels=..., maintenance_policies=..., maintenance_schedules=..., memcache_full_version=..., memcache_nodes=..., memcache_parameters=..., memcache_version=..., name=..., node_configs=..., node_count=..., project=..., pulumi_labels=..., region=..., reserved_ip_range_ids=..., zones=...) -> None:
        ...
