...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['InstanceMaintenancePolicy', 'InstanceMaintenancePolicyWeeklyMaintenanceWindow', ..., 'InstanceMaintenanceSchedule', 'InstanceMemcacheNode', 'InstanceMemcacheParameters', 'InstanceNodeConfig', 'GetInstanceMaintenancePolicyResult', ..., ..., 'GetInstanceMaintenanceScheduleResult', 'GetInstanceMemcacheNodeResult', 'GetInstanceMemcacheParameterResult', 'GetInstanceNodeConfigResult']
@pulumi.output_type
class InstanceMaintenancePolicy(dict):
    ...
    def __init__(__self__, *, weekly_maintenance_windows: Sequence[outputs.InstanceMaintenancePolicyWeeklyMaintenanceWindow], create_time: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class InstanceMaintenancePolicyWeeklyMaintenanceWindow(dict):
    ...
    def __init__(__self__, *, day: _builtins.str, duration: _builtins.str, start_time: outputs.InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime) -> None:
...
class InstanceMemcacheNode(dict):
    ...
    def __init__(__self__, *, host: Optional[_builtins.str] = ..., node_id: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., state: Optional[_builtins.str] = ..., zone: Optional[_builtins.str] = ...) -> None:
...
class InstanceMemcacheParameters(dict):
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., params: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class InstanceNodeConfig(dict):
    ...
    def __init__(__self__, *, cpu_count: _builtins.int, memory_size_mb: _builtins.int) -> None:
...
class GetInstanceMemcacheNodeResult(dict):
    def __init__(__self__, *, host: _builtins.str, node_id: _builtins.str, port: _builtins.int, state: _builtins.str, zone: _builtins.str) -> None:
...
class GetInstanceMemcacheParameterResult(dict):
    def __init__(__self__, *, id: _builtins.str, params: Mapping[str, _builtins.str]) -> None:
