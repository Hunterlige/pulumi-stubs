...
class ConfigIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[ConfigIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[ConfigIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class ConfigIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[ConfigIamMemberConditionArgs, ConfigIamMemberConditionArgsDict]
            ]
        ] = ...,
        config: Optional[pulumi.Input[_builtins.str]] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.ConfigIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
