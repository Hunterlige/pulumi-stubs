...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectionProfileBigqueryProfile', 'ConnectionProfileForwardSshConnectivity', 'ConnectionProfileGcsProfile', 'ConnectionProfileMongodbProfile', 'ConnectionProfileMongodbProfileHostAddress', 'ConnectionProfileMongodbProfileSrvConnectionFormat', 'ConnectionProfileMongodbProfileSslConfig', ..., 'ConnectionProfileMysqlProfile', 'ConnectionProfileMysqlProfileSslConfig', 'ConnectionProfileOracleProfile', 'ConnectionProfilePostgresqlProfile', 'ConnectionProfilePostgresqlProfileSslConfig', ..., ..., 'ConnectionProfilePrivateConnectivity', 'ConnectionProfileSalesforceProfile', ..., 'ConnectionProfileSalesforceProfileUserCredentials', 'ConnectionProfileSpannerProfile', 'ConnectionProfileSqlServerProfile', 'PrivateConnectionError', 'PrivateConnectionPscInterfaceConfig', 'PrivateConnectionVpcPeeringConfig', 'StreamBackfillAll', 'StreamBackfillAllMongodbExcludedObjects', 'StreamBackfillAllMongodbExcludedObjectsDatabase', ..., ..., 'StreamBackfillAllMysqlExcludedObjects', 'StreamBackfillAllMysqlExcludedObjectsMysqlDatabase', ..., ..., 'StreamBackfillAllOracleExcludedObjects', 'StreamBackfillAllOracleExcludedObjectsOracleSchema', ..., ..., 'StreamBackfillAllPostgresqlExcludedObjects', ..., ..., ..., 'StreamBackfillAllSalesforceExcludedObjects', 'StreamBackfillAllSalesforceExcludedObjectsObject', ..., 'StreamBackfillAllSpannerExcludedObjects', 'StreamBackfillAllSpannerExcludedObjectsSchema', 'StreamBackfillAllSpannerExcludedObjectsSchemaTable', ..., 'StreamBackfillAllSqlServerExcludedObjects', 'StreamBackfillAllSqlServerExcludedObjectsSchema', ..., ..., 'StreamBackfillNone', 'StreamDestinationConfig', 'StreamDestinationConfigBigqueryDestinationConfig', ..., ..., ..., ..., ..., ..., 'StreamDestinationConfigGcsDestinationConfig', ..., ..., 'StreamRuleSet', 'StreamRuleSetCustomizationRule', 'StreamRuleSetCustomizationRuleBigqueryClustering', 'StreamRuleSetCustomizationRuleBigqueryPartitioning', ..., ..., ..., 'StreamRuleSetObjectFilter', 'StreamRuleSetObjectFilterSourceObjectIdentifier', ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfig', 'StreamSourceConfigMongodbSourceConfig', ..., ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfigMysqlSourceConfig', ..., 'StreamSourceConfigMysqlSourceConfigExcludeObjects', ..., ..., ..., 'StreamSourceConfigMysqlSourceConfigGtid', 'StreamSourceConfigMysqlSourceConfigIncludeObjects', ..., ..., ..., 'StreamSourceConfigOracleSourceConfig', ..., 'StreamSourceConfigOracleSourceConfigExcludeObjects', ..., ..., ..., 'StreamSourceConfigOracleSourceConfigIncludeObjects', ..., ..., ..., ..., 'StreamSourceConfigPostgresqlSourceConfig', ..., ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfigSalesforceSourceConfig', ..., ..., ..., ..., ..., ..., 'StreamSourceConfigSpannerSourceConfig', ..., ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfigSqlServerSourceConfig', ..., ..., ..., ..., ..., ..., ..., ..., ..., ...]
@pulumi.output_type
...
class ConnectionProfileForwardSshConnectivity(dict):
    ...
    def __init__(__self__, *, hostname: _builtins.str, username: _builtins.str, password: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., private_key: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfileGcsProfile(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, root_path: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfileMongodbProfile(dict):
    ...
    def __init__(__self__, *, host_addresses: Sequence[outputs.ConnectionProfileMongodbProfileHostAddress], username: _builtins.str, password: Optional[_builtins.str] = ..., replica_set: Optional[_builtins.str] = ..., secret_manager_stored_password: Optional[_builtins.str] = ..., srv_connection_format: Optional[outputs.ConnectionProfileMongodbProfileSrvConnectionFormat] = ..., ssl_config: Optional[outputs.ConnectionProfileMongodbProfileSslConfig] = ..., standard_connection_format: Optional[outputs.ConnectionProfileMongodbProfileStandardConnectionFormat] = ...) -> None:
...
class ConnectionProfileMongodbProfileHostAddress(dict):
    def __init__(__self__, *, hostname: _builtins.str, port: Optional[_builtins.int] = ...) -> None:
...
class ConnectionProfileMongodbProfileSslConfig(dict):
    ...
    def __init__(__self__, *, ca_certificate: Optional[_builtins.str] = ..., ca_certificate_set: Optional[_builtins.bool] = ..., client_certificate: Optional[_builtins.str] = ..., client_certificate_set: Optional[_builtins.bool] = ..., client_key: Optional[_builtins.str] = ..., client_key_set: Optional[_builtins.bool] = ..., secret_manager_stored_client_key: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfileMongodbProfileStandardConnectionFormat(dict):
    ...
    def __init__(__self__, *, direct_connection: Optional[_builtins.bool] = ...) -> None:
...
class ConnectionProfileMysqlProfile(dict):
    ...
    def __init__(__self__, *, hostname: _builtins.str, username: _builtins.str, password: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., secret_manager_stored_password: Optional[_builtins.str] = ..., ssl_config: Optional[outputs.ConnectionProfileMysqlProfileSslConfig] = ...) -> None:
...
class ConnectionProfileMysqlProfileSslConfig(dict):
    ...
    def __init__(__self__, *, ca_certificate: Optional[_builtins.str] = ..., ca_certificate_set: Optional[_builtins.bool] = ..., client_certificate: Optional[_builtins.str] = ..., client_certificate_set: Optional[_builtins.bool] = ..., client_key: Optional[_builtins.str] = ..., client_key_set: Optional[_builtins.bool] = ...) -> None:
...
class ConnectionProfileOracleProfile(dict):
    ...
    def __init__(__self__, *, database_service: _builtins.str, hostname: _builtins.str, username: _builtins.str, connection_attributes: Optional[Mapping[str, _builtins.str]] = ..., password: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., secret_manager_stored_password: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfilePostgresqlProfile(dict):
    ...
    def __init__(__self__, *, database: _builtins.str, hostname: _builtins.str, username: _builtins.str, password: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., secret_manager_stored_password: Optional[_builtins.str] = ..., ssl_config: Optional[outputs.ConnectionProfilePostgresqlProfileSslConfig] = ...) -> None:
...
class ConnectionProfilePostgresqlProfileSslConfig(dict):
    ...
    def __init__(__self__, *, server_and_client_verification: Optional[outputs.ConnectionProfilePostgresqlProfileSslConfigServerAndClientVerification] = ..., server_verification: Optional[outputs.ConnectionProfilePostgresqlProfileSslConfigServerVerification] = ...) -> None:
...
class ConnectionProfilePostgresqlProfileSslConfigServerAndClientVerification(dict):
    ...
    def __init__(__self__, *, ca_certificate: _builtins.str, client_certificate: _builtins.str, client_key: _builtins.str) -> None:
...
class ConnectionProfileSalesforceProfile(dict):
    ...
    def __init__(__self__, *, domain: _builtins.str, oauth2_client_credentials: Optional[outputs.ConnectionProfileSalesforceProfileOauth2ClientCredentials] = ..., user_credentials: Optional[outputs.ConnectionProfileSalesforceProfileUserCredentials] = ...) -> None:
...
class ConnectionProfileSalesforceProfileOauth2ClientCredentials(dict):
    ...
    def __init__(__self__, *, client_id: Optional[_builtins.str] = ..., client_secret: Optional[_builtins.str] = ..., secret_manager_stored_client_secret: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfileSalesforceProfileUserCredentials(dict):
    ...
    def __init__(__self__, *, password: Optional[_builtins.str] = ..., secret_manager_stored_password: Optional[_builtins.str] = ..., secret_manager_stored_security_token: Optional[_builtins.str] = ..., security_token: Optional[_builtins.str] = ..., username: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfileSpannerProfile(dict):
    def __init__(__self__, *, database: _builtins.str, host: Optional[_builtins.str] = ...) -> None:
...
class ConnectionProfileSqlServerProfile(dict):
    ...
    def __init__(__self__, *, database: _builtins.str, hostname: _builtins.str, username: _builtins.str, password: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., secret_manager_stored_password: Optional[_builtins.str] = ...) -> None:
...
class PrivateConnectionError(dict):
    def __init__(__self__, *, details: Optional[Mapping[str, _builtins.str]] = ..., message: Optional[_builtins.str] = ...) -> None:
...
class StreamBackfillAll(dict):
    ...
    def __init__(__self__, *, mongodb_excluded_objects: Optional[outputs.StreamBackfillAllMongodbExcludedObjects] = ..., mysql_excluded_objects: Optional[outputs.StreamBackfillAllMysqlExcludedObjects] = ..., oracle_excluded_objects: Optional[outputs.StreamBackfillAllOracleExcludedObjects] = ..., postgresql_excluded_objects: Optional[outputs.StreamBackfillAllPostgresqlExcludedObjects] = ..., salesforce_excluded_objects: Optional[outputs.StreamBackfillAllSalesforceExcludedObjects] = ..., spanner_excluded_objects: Optional[outputs.StreamBackfillAllSpannerExcludedObjects] = ..., sql_server_excluded_objects: Optional[outputs.StreamBackfillAllSqlServerExcludedObjects] = ...) -> None:
...
class StreamBackfillAllMongodbExcludedObjects(dict):
    def __init__(__self__, *, databases: Sequence[outputs.StreamBackfillAllMongodbExcludedObjectsDatabase]) -> None:
...
class StreamBackfillAllMongodbExcludedObjectsDatabase(dict):
    def __init__(__self__, *, database: _builtins.str, collections: Optional[Sequence[outputs.StreamBackfillAllMongodbExcludedObjectsDatabaseCollection]] = ...) -> None:
...
class StreamBackfillAllMongodbExcludedObjectsDatabaseCollection(dict):
    def __init__(__self__, *, collection: _builtins.str, fields: Optional[Sequence[outputs.StreamBackfillAllMongodbExcludedObjectsDatabaseCollectionField]] = ...) -> None:
...
class StreamBackfillAllMysqlExcludedObjects(dict):
    ...
    def __init__(__self__, *, mysql_databases: Sequence[outputs.StreamBackfillAllMysqlExcludedObjectsMysqlDatabase]) -> None:
...
class StreamBackfillAllMysqlExcludedObjectsMysqlDatabase(dict):
    ...
    def __init__(__self__, *, database: _builtins.str, mysql_tables: Optional[Sequence[outputs.StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTable]] = ...) -> None:
...
class StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTable(dict):
    ...
    def __init__(__self__, *, table: _builtins.str, mysql_columns: Optional[Sequence[outputs.StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableMysqlColumn]] = ...) -> None:
...
class StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableMysqlColumn(dict):
    ...
    def __init__(__self__, *, collation: Optional[_builtins.str] = ..., column: Optional[_builtins.str] = ..., data_type: Optional[_builtins.str] = ..., length: Optional[_builtins.int] = ..., nullable: Optional[_builtins.bool] = ..., ordinal_position: Optional[_builtins.int] = ..., primary_key: Optional[_builtins.bool] = ...) -> None:
...
class StreamBackfillAllOracleExcludedObjects(dict):
    ...
    def __init__(__self__, *, oracle_schemas: Sequence[outputs.StreamBackfillAllOracleExcludedObjectsOracleSchema]) -> None:
...
class StreamBackfillAllOracleExcludedObjectsOracleSchema(dict):
    ...
    def __init__(__self__, *, schema: _builtins.str, oracle_tables: Optional[Sequence[outputs.StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTable]] = ...) -> None:
...
class StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTable(dict):
    ...
    def __init__(__self__, *, table: _builtins.str, oracle_columns: Optional[Sequence[outputs.StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableOracleColumn]] = ...) -> None:
...
class StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableOracleColumn(dict):
    ...
    def __init__(__self__, *, column: Optional[_builtins.str] = ..., data_type: Optional[_builtins.str] = ..., encoding: Optional[_builtins.str] = ..., length: Optional[_builtins.int] = ..., nullable: Optional[_builtins.bool] = ..., ordinal_position: Optional[_builtins.int] = ..., precision: Optional[_builtins.int] = ..., primary_key: Optional[_builtins.bool] = ..., scale: Optional[_builtins.int] = ...) -> None:
...
class StreamBackfillAllPostgresqlExcludedObjects(dict):
    ...
    def __init__(__self__, *, postgresql_schemas: Sequence[outputs.StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchema]) -> None:
...
class StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchema(dict):
    ...
    def __init__(__self__, *, schema: _builtins.str, postgresql_tables: Optional[Sequence[outputs.StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaPostgresqlTable]] = ...) -> None:
...
class StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaPostgresqlTable(dict):
    ...
    def __init__(__self__, *, table: _builtins.str, postgresql_columns: Optional[Sequence[outputs.StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumn]] = ...) -> None:
...
class StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumn(dict):
    ...
    def __init__(__self__, *, column: Optional[_builtins.str] = ..., data_type: Optional[_builtins.str] = ..., length: Optional[_builtins.int] = ..., nullable: Optional[_builtins.bool] = ..., ordinal_position: Optional[_builtins.int] = ..., precision: Optional[_builtins.int] = ..., primary_key: Optional[_builtins.bool] = ..., scale: Optional[_builtins.int] = ...) -> None:
...
class StreamBackfillAllSalesforceExcludedObjects(dict):
    def __init__(__self__, *, objects: Sequence[outputs.StreamBackfillAllSalesforceExcludedObjectsObject]) -> None:
...
class StreamBackfillAllSalesforceExcludedObjectsObject(dict):
    ...
    def __init__(__self__, *, fields: Optional[Sequence[outputs.StreamBackfillAllSalesforceExcludedObjectsObjectField]] = ..., object_name: Optional[_builtins.str] = ...) -> None:
...
class StreamBackfillAllSpannerExcludedObjects(dict):
    def __init__(__self__, *, schemas: Sequence[outputs.StreamBackfillAllSpannerExcludedObjectsSchema]) -> None:
...
class StreamBackfillAllSpannerExcludedObjectsSchema(dict):
    def __init__(__self__, *, schema: _builtins.str, tables: Optional[Sequence[outputs.StreamBackfillAllSpannerExcludedObjectsSchemaTable]] = ...) -> None:
...
class StreamBackfillAllSpannerExcludedObjectsSchemaTable(dict):
    def __init__(__self__, *, table: _builtins.str, columns: Optional[Sequence[outputs.StreamBackfillAllSpannerExcludedObjectsSchemaTableColumn]] = ...) -> None:
...
class StreamBackfillAllSpannerExcludedObjectsSchemaTableColumn(dict):
    ...
    def __init__(__self__, *, column: _builtins.str, data_type: Optional[_builtins.str] = ..., is_primary_key: Optional[_builtins.bool] = ..., ordinal_position: Optional[_builtins.int] = ...) -> None:
...
class StreamBackfillAllSqlServerExcludedObjects(dict):
    def __init__(__self__, *, schemas: Sequence[outputs.StreamBackfillAllSqlServerExcludedObjectsSchema]) -> None:
...
class StreamBackfillAllSqlServerExcludedObjectsSchema(dict):
    def __init__(__self__, *, schema: _builtins.str, tables: Optional[Sequence[outputs.StreamBackfillAllSqlServerExcludedObjectsSchemaTable]] = ...) -> None:
...
class StreamBackfillAllSqlServerExcludedObjectsSchemaTable(dict):
    def __init__(__self__, *, table: _builtins.str, columns: Optional[Sequence[outputs.StreamBackfillAllSqlServerExcludedObjectsSchemaTableColumn]] = ...) -> None:
...
class StreamDestinationConfig(dict):
    ...
    def __init__(__self__, *, destination_connection_profile: _builtins.str, bigquery_destination_config: Optional[outputs.StreamDestinationConfigBigqueryDestinationConfig] = ..., gcs_destination_config: Optional[outputs.StreamDestinationConfigGcsDestinationConfig] = ...) -> None:
...
class StreamDestinationConfigBigqueryDestinationConfig(dict):
    ...
    def __init__(__self__, *, append_only: Optional[outputs.StreamDestinationConfigBigqueryDestinationConfigAppendOnly] = ..., blmt_config: Optional[outputs.StreamDestinationConfigBigqueryDestinationConfigBlmtConfig] = ..., data_freshness: Optional[_builtins.str] = ..., merge: Optional[outputs.StreamDestinationConfigBigqueryDestinationConfigMerge] = ..., single_target_dataset: Optional[outputs.StreamDestinationConfigBigqueryDestinationConfigSingleTargetDataset] = ..., source_hierarchy_datasets: Optional[outputs.StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasets] = ...) -> None:
...
class StreamDestinationConfigBigqueryDestinationConfigBlmtConfig(dict):
    ...
    def __init__(__self__, *, bucket: _builtins.str, connection_name: _builtins.str, file_format: _builtins.str, table_format: _builtins.str, root_path: Optional[_builtins.str] = ...) -> None:
...
class StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasets(dict):
    ...
    def __init__(__self__, *, dataset_template: outputs.StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasetsDatasetTemplate, project_id: Optional[_builtins.str] = ...) -> None:
...
class StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasetsDatasetTemplate(dict):
    ...
    def __init__(__self__, *, location: _builtins.str, dataset_id_prefix: Optional[_builtins.str] = ..., kms_key_name: Optional[_builtins.str] = ...) -> None:
...
class StreamDestinationConfigGcsDestinationConfig(dict):
    ...
    def __init__(__self__, *, avro_file_format: Optional[outputs.StreamDestinationConfigGcsDestinationConfigAvroFileFormat] = ..., file_rotation_interval: Optional[_builtins.str] = ..., file_rotation_mb: Optional[_builtins.int] = ..., json_file_format: Optional[outputs.StreamDestinationConfigGcsDestinationConfigJsonFileFormat] = ..., path: Optional[_builtins.str] = ...) -> None:
...
class StreamDestinationConfigGcsDestinationConfigJsonFileFormat(dict):
    ...
    def __init__(__self__, *, compression: Optional[_builtins.str] = ..., schema_file_format: Optional[_builtins.str] = ...) -> None:
...
class StreamRuleSet(dict):
    ...
    def __init__(__self__, *, customization_rules: Sequence[outputs.StreamRuleSetCustomizationRule], object_filter: outputs.StreamRuleSetObjectFilter) -> None:
...
class StreamRuleSetCustomizationRule(dict):
    ...
    def __init__(__self__, *, bigquery_clustering: Optional[outputs.StreamRuleSetCustomizationRuleBigqueryClustering] = ..., bigquery_partitioning: Optional[outputs.StreamRuleSetCustomizationRuleBigqueryPartitioning] = ...) -> None:
...
class StreamRuleSetCustomizationRuleBigqueryPartitioning(dict):
    ...
    def __init__(__self__, *, ingestion_time_partition: Optional[outputs.StreamRuleSetCustomizationRuleBigqueryPartitioningIngestionTimePartition] = ..., integer_range_partition: Optional[outputs.StreamRuleSetCustomizationRuleBigqueryPartitioningIntegerRangePartition] = ..., require_partition_filter: Optional[_builtins.bool] = ..., time_unit_partition: Optional[outputs.StreamRuleSetCustomizationRuleBigqueryPartitioningTimeUnitPartition] = ...) -> None:
...
class StreamRuleSetCustomizationRuleBigqueryPartitioningIngestionTimePartition(dict):
    ...
    def __init__(__self__, *, partitioning_time_granularity: Optional[_builtins.str] = ...) -> None:
...
class StreamRuleSetCustomizationRuleBigqueryPartitioningIntegerRangePartition(dict):
    def __init__(__self__, *, column: _builtins.str, end: _builtins.int, interval: _builtins.int, start: _builtins.int) -> None:
...
class StreamRuleSetCustomizationRuleBigqueryPartitioningTimeUnitPartition(dict):
    ...
    def __init__(__self__, *, column: _builtins.str, partitioning_time_granularity: Optional[_builtins.str] = ...) -> None:
...
class StreamRuleSetObjectFilter(dict):
    ...
    def __init__(__self__, *, source_object_identifier: Optional[outputs.StreamRuleSetObjectFilterSourceObjectIdentifier] = ...) -> None:
...
class StreamRuleSetObjectFilterSourceObjectIdentifier(dict):
    ...
    def __init__(__self__, *, mongodb_identifier: Optional[outputs.StreamRuleSetObjectFilterSourceObjectIdentifierMongodbIdentifier] = ..., mysql_identifier: Optional[outputs.StreamRuleSetObjectFilterSourceObjectIdentifierMysqlIdentifier] = ..., oracle_identifier: Optional[outputs.StreamRuleSetObjectFilterSourceObjectIdentifierOracleIdentifier] = ..., postgresql_identifier: Optional[outputs.StreamRuleSetObjectFilterSourceObjectIdentifierPostgresqlIdentifier] = ..., salesforce_identifier: Optional[outputs.StreamRuleSetObjectFilterSourceObjectIdentifierSalesforceIdentifier] = ..., spanner_identifier: Optional[outputs.StreamRuleSetObjectFilterSourceObjectIdentifierSpannerIdentifier] = ..., sql_server_identifier: Optional[outputs.StreamRuleSetObjectFilterSourceObjectIdentifierSqlServerIdentifier] = ...) -> None:
...
class StreamRuleSetObjectFilterSourceObjectIdentifierMongodbIdentifier(dict):
    def __init__(__self__, *, collection: _builtins.str, database: _builtins.str) -> None:
...
class StreamRuleSetObjectFilterSourceObjectIdentifierMysqlIdentifier(dict):
    def __init__(__self__, *, database: _builtins.str, table: _builtins.str) -> None:
...
class StreamRuleSetObjectFilterSourceObjectIdentifierSpannerIdentifier(dict):
    def __init__(__self__, *, table: _builtins.str, schema: Optional[_builtins.str] = ...) -> None:
...
class StreamSourceConfig(dict):
    ...
    def __init__(__self__, *, source_connection_profile: _builtins.str, mongodb_source_config: Optional[outputs.StreamSourceConfigMongodbSourceConfig] = ..., mysql_source_config: Optional[outputs.StreamSourceConfigMysqlSourceConfig] = ..., oracle_source_config: Optional[outputs.StreamSourceConfigOracleSourceConfig] = ..., postgresql_source_config: Optional[outputs.StreamSourceConfigPostgresqlSourceConfig] = ..., salesforce_source_config: Optional[outputs.StreamSourceConfigSalesforceSourceConfig] = ..., spanner_source_config: Optional[outputs.StreamSourceConfigSpannerSourceConfig] = ..., sql_server_source_config: Optional[outputs.StreamSourceConfigSqlServerSourceConfig] = ...) -> None:
...
class StreamSourceConfigMongodbSourceConfig(dict):
    ...
    def __init__(__self__, *, exclude_objects: Optional[outputs.StreamSourceConfigMongodbSourceConfigExcludeObjects] = ..., include_objects: Optional[outputs.StreamSourceConfigMongodbSourceConfigIncludeObjects] = ..., max_concurrent_backfill_tasks: Optional[_builtins.int] = ...) -> None:
...
class StreamSourceConfigMongodbSourceConfigExcludeObjects(dict):
    def __init__(__self__, *, databases: Optional[Sequence[outputs.StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabase]] = ...) -> None:
...
class StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabase(dict):
    def __init__(__self__, *, collections: Optional[Sequence[outputs.StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabaseCollection]] = ..., database: Optional[_builtins.str] = ...) -> None:
...
class StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabaseCollection(dict):
    def __init__(__self__, *, collection: Optional[_builtins.str] = ..., fields: Optional[Sequence[outputs.StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabaseCollectionField]] = ...) -> None:
...
class StreamSourceConfigMongodbSourceConfigIncludeObjects(dict):
    def __init__(__self__, *, databases: Optional[Sequence[outputs.StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabase]] = ...) -> None:
...
class StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabase(dict):
    def __init__(__self__, *, collections: Optional[Sequence[outputs.StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabaseCollection]] = ..., database: Optional[_builtins.str] = ...) -> None:
...
class StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabaseCollection(dict):
    def __init__(__self__, *, collection: Optional[_builtins.str] = ..., fields: Optional[Sequence[outputs.StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabaseCollectionField]] = ...) -> None:
...
class StreamSourceConfigMysqlSourceConfig(dict):
    ...
    def __init__(__self__, *, binary_log_position: Optional[outputs.StreamSourceConfigMysqlSourceConfigBinaryLogPosition] = ..., exclude_objects: Optional[outputs.StreamSourceConfigMysqlSourceConfigExcludeObjects] = ..., gtid: Optional[outputs.StreamSourceConfigMysqlSourceConfigGtid] = ..., include_objects: Optional[outputs.StreamSourceConfigMysqlSourceConfigIncludeObjects] = ..., max_concurrent_backfill_tasks: Optional[_builtins.int] = ..., max_concurrent_cdc_tasks: Optional[_builtins.int] = ...) -> None:
...
class StreamSourceConfigMysqlSourceConfigExcludeObjects(dict):
    ...
    def __init__(__self__, *, mysql_databases: Sequence[outputs.StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabase]) -> None:
...
class StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabase(dict):
    ...
    def __init__(__self__, *, database: _builtins.str, mysql_tables: Optional[Sequence[outputs.StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabaseMysqlTable]] = ...) -> None:
...
class StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabaseMysqlTable(dict):
    ...
    def __init__(__self__, *, table: _builtins.str, mysql_columns: Optional[Sequence[outputs.StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabaseMysqlTableMysqlColumn]] = ...) -> None:
...
class StreamSourceConfigMysqlSourceConfigIncludeObjects(dict):
    ...
    def __init__(__self__, *, mysql_databases: Sequence[outputs.StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabase]) -> None:
...
class StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabase(dict):
    ...
    def __init__(__self__, *, database: _builtins.str, mysql_tables: Optional[Sequence[outputs.StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseMysqlTable]] = ...) -> None:
...
class StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseMysqlTable(dict):
    ...
    def __init__(__self__, *, table: _builtins.str, mysql_columns: Optional[Sequence[outputs.StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseMysqlTableMysqlColumn]] = ...) -> None:
...
class StreamSourceConfigOracleSourceConfig(dict):
    ...
    def __init__(__self__, *, drop_large_objects: Optional[outputs.StreamSourceConfigOracleSourceConfigDropLargeObjects] = ..., exclude_objects: Optional[outputs.StreamSourceConfigOracleSourceConfigExcludeObjects] = ..., include_objects: Optional[outputs.StreamSourceConfigOracleSourceConfigIncludeObjects] = ..., max_concurrent_backfill_tasks: Optional[_builtins.int] = ..., max_concurrent_cdc_tasks: Optional[_builtins.int] = ..., stream_large_objects: Optional[outputs.StreamSourceConfigOracleSourceConfigStreamLargeObjects] = ...) -> None:
...
class StreamSourceConfigOracleSourceConfigExcludeObjects(dict):
    ...
    def __init__(__self__, *, oracle_schemas: Sequence[outputs.StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchema]) -> None:
...
class StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchema(dict):
    ...
    def __init__(__self__, *, schema: _builtins.str, oracle_tables: Optional[Sequence[outputs.StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaOracleTable]] = ...) -> None:
...
class StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaOracleTable(dict):
    ...
    def __init__(__self__, *, table: _builtins.str, oracle_columns: Optional[Sequence[outputs.StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaOracleTableOracleColumn]] = ...) -> None:
...
class StreamSourceConfigOracleSourceConfigIncludeObjects(dict):
    ...
    def __init__(__self__, *, oracle_schemas: Sequence[outputs.StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchema]) -> None:
...
class StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchema(dict):
    ...
    def __init__(__self__, *, schema: _builtins.str, oracle_tables: Optional[Sequence[outputs.StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTable]] = ...) -> None:
...
class StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTable(dict):
    ...
    def __init__(__self__, *, table: _builtins.str, oracle_columns: Optional[Sequence[outputs.StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTableOracleColumn]] = ...) -> None:
...
class StreamSourceConfigPostgresqlSourceConfig(dict):
    ...
    def __init__(__self__, *, publication: _builtins.str, replication_slot: _builtins.str, exclude_objects: Optional[outputs.StreamSourceConfigPostgresqlSourceConfigExcludeObjects] = ..., include_objects: Optional[outputs.StreamSourceConfigPostgresqlSourceConfigIncludeObjects] = ..., max_concurrent_backfill_tasks: Optional[_builtins.int] = ...) -> None:
...
class StreamSourceConfigPostgresqlSourceConfigExcludeObjects(dict):
    ...
    def __init__(__self__, *, postgresql_schemas: Sequence[outputs.StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchema]) -> None:
...
class StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchema(dict):
    ...
    def __init__(__self__, *, schema: _builtins.str, postgresql_tables: Optional[Sequence[outputs.StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaPostgresqlTable]] = ...) -> None:
...
class StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaPostgresqlTable(dict):
    ...
    def __init__(__self__, *, table: _builtins.str, postgresql_columns: Optional[Sequence[outputs.StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumn]] = ...) -> None:
...
class StreamSourceConfigPostgresqlSourceConfigIncludeObjects(dict):
    ...
    def __init__(__self__, *, postgresql_schemas: Sequence[outputs.StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchema]) -> None:
...
class StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchema(dict):
    ...
    def __init__(__self__, *, schema: _builtins.str, postgresql_tables: Optional[Sequence[outputs.StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemaPostgresqlTable]] = ...) -> None:
...
class StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemaPostgresqlTable(dict):
    ...
    def __init__(__self__, *, table: _builtins.str, postgresql_columns: Optional[Sequence[outputs.StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumn]] = ...) -> None:
...
class StreamSourceConfigSalesforceSourceConfig(dict):
    ...
    def __init__(__self__, *, polling_interval: _builtins.str, exclude_objects: Optional[outputs.StreamSourceConfigSalesforceSourceConfigExcludeObjects] = ..., include_objects: Optional[outputs.StreamSourceConfigSalesforceSourceConfigIncludeObjects] = ...) -> None:
...
class StreamSourceConfigSalesforceSourceConfigExcludeObjects(dict):
    def __init__(__self__, *, objects: Sequence[outputs.StreamSourceConfigSalesforceSourceConfigExcludeObjectsObject]) -> None:
...
class StreamSourceConfigSalesforceSourceConfigExcludeObjectsObject(dict):
    ...
    def __init__(__self__, *, fields: Optional[Sequence[outputs.StreamSourceConfigSalesforceSourceConfigExcludeObjectsObjectField]] = ..., object_name: Optional[_builtins.str] = ...) -> None:
...
class StreamSourceConfigSalesforceSourceConfigIncludeObjects(dict):
    def __init__(__self__, *, objects: Sequence[outputs.StreamSourceConfigSalesforceSourceConfigIncludeObjectsObject]) -> None:
...
class StreamSourceConfigSalesforceSourceConfigIncludeObjectsObject(dict):
    ...
    def __init__(__self__, *, fields: Optional[Sequence[outputs.StreamSourceConfigSalesforceSourceConfigIncludeObjectsObjectField]] = ..., object_name: Optional[_builtins.str] = ...) -> None:
...
class StreamSourceConfigSpannerSourceConfig(dict):
    ...
    def __init__(__self__, *, backfill_data_boost_enabled: Optional[_builtins.bool] = ..., change_stream_name: Optional[_builtins.str] = ..., exclude_objects: Optional[outputs.StreamSourceConfigSpannerSourceConfigExcludeObjects] = ..., fgac_role: Optional[_builtins.str] = ..., include_objects: Optional[outputs.StreamSourceConfigSpannerSourceConfigIncludeObjects] = ..., max_concurrent_backfill_tasks: Optional[_builtins.int] = ..., max_concurrent_cdc_tasks: Optional[_builtins.int] = ..., spanner_rpc_priority: Optional[_builtins.str] = ...) -> None:
...
class StreamSourceConfigSpannerSourceConfigExcludeObjects(dict):
    def __init__(__self__, *, schemas: Sequence[outputs.StreamSourceConfigSpannerSourceConfigExcludeObjectsSchema]) -> None:
...
class StreamSourceConfigSpannerSourceConfigExcludeObjectsSchema(dict):
    def __init__(__self__, *, schema: _builtins.str, tables: Optional[Sequence[outputs.StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaTable]] = ...) -> None:
...
class StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaTable(dict):
    def __init__(__self__, *, table: _builtins.str, columns: Optional[Sequence[outputs.StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaTableColumn]] = ...) -> None:
...
class StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaTableColumn(dict):
    ...
    def __init__(__self__, *, column: Optional[_builtins.str] = ..., data_type: Optional[_builtins.str] = ..., is_primary_key: Optional[_builtins.bool] = ..., ordinal_position: Optional[_builtins.int] = ...) -> None:
...
class StreamSourceConfigSpannerSourceConfigIncludeObjects(dict):
    def __init__(__self__, *, schemas: Sequence[outputs.StreamSourceConfigSpannerSourceConfigIncludeObjectsSchema]) -> None:
...
class StreamSourceConfigSpannerSourceConfigIncludeObjectsSchema(dict):
    def __init__(__self__, *, schema: _builtins.str, tables: Optional[Sequence[outputs.StreamSourceConfigSpannerSourceConfigIncludeObjectsSchemaTable]] = ...) -> None:
...
class StreamSourceConfigSpannerSourceConfigIncludeObjectsSchemaTable(dict):
    def __init__(__self__, *, table: _builtins.str, columns: Optional[Sequence[outputs.StreamSourceConfigSpannerSourceConfigIncludeObjectsSchemaTableColumn]] = ...) -> None:
...
class StreamSourceConfigSqlServerSourceConfig(dict):
    ...
    def __init__(__self__, *, change_tables: Optional[outputs.StreamSourceConfigSqlServerSourceConfigChangeTables] = ..., exclude_objects: Optional[outputs.StreamSourceConfigSqlServerSourceConfigExcludeObjects] = ..., include_objects: Optional[outputs.StreamSourceConfigSqlServerSourceConfigIncludeObjects] = ..., max_concurrent_backfill_tasks: Optional[_builtins.int] = ..., max_concurrent_cdc_tasks: Optional[_builtins.int] = ..., transaction_logs: Optional[outputs.StreamSourceConfigSqlServerSourceConfigTransactionLogs] = ...) -> None:
...
class StreamSourceConfigSqlServerSourceConfigExcludeObjects(dict):
    def __init__(__self__, *, schemas: Sequence[outputs.StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchema]) -> None:
...
class StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchema(dict):
    def __init__(__self__, *, schema: _builtins.str, tables: Optional[Sequence[outputs.StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaTable]] = ...) -> None:
...
class StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaTable(dict):
    def __init__(__self__, *, table: _builtins.str, columns: Optional[Sequence[outputs.StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaTableColumn]] = ...) -> None:
...
class StreamSourceConfigSqlServerSourceConfigIncludeObjects(dict):
    def __init__(__self__, *, schemas: Sequence[outputs.StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchema]) -> None:
...
class StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchema(dict):
    def __init__(__self__, *, schema: _builtins.str, tables: Optional[Sequence[outputs.StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTable]] = ...) -> None:
...
class StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTable(dict):
    def __init__(__self__, *, table: _builtins.str, columns: Optional[Sequence[outputs.StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableColumn]] = ...) -> None:
