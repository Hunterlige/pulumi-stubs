...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectionProfileBigqueryProfileArgs', 'ConnectionProfileBigqueryProfileArgsDict', 'ConnectionProfileForwardSshConnectivityArgs', 'ConnectionProfileForwardSshConnectivityArgsDict', 'ConnectionProfileGcsProfileArgs', 'ConnectionProfileGcsProfileArgsDict', 'ConnectionProfileMongodbProfileArgs', 'ConnectionProfileMongodbProfileArgsDict', 'ConnectionProfileMongodbProfileHostAddressArgs', 'ConnectionProfileMongodbProfileHostAddressArgsDict', ..., ..., 'ConnectionProfileMongodbProfileSslConfigArgs', 'ConnectionProfileMongodbProfileSslConfigArgsDict', ..., ..., 'ConnectionProfileMysqlProfileArgs', 'ConnectionProfileMysqlProfileArgsDict', 'ConnectionProfileMysqlProfileSslConfigArgs', 'ConnectionProfileMysqlProfileSslConfigArgsDict', 'ConnectionProfileOracleProfileArgs', 'ConnectionProfileOracleProfileArgsDict', 'ConnectionProfilePostgresqlProfileArgs', 'ConnectionProfilePostgresqlProfileArgsDict', 'ConnectionProfilePostgresqlProfileSslConfigArgs', ..., ..., ..., ..., ..., 'ConnectionProfilePrivateConnectivityArgs', 'ConnectionProfilePrivateConnectivityArgsDict', 'ConnectionProfileSalesforceProfileArgs', 'ConnectionProfileSalesforceProfileArgsDict', ..., ..., ..., ..., 'ConnectionProfileSpannerProfileArgs', 'ConnectionProfileSpannerProfileArgsDict', 'ConnectionProfileSqlServerProfileArgs', 'ConnectionProfileSqlServerProfileArgsDict', 'PrivateConnectionErrorArgs', 'PrivateConnectionErrorArgsDict', 'PrivateConnectionPscInterfaceConfigArgs', 'PrivateConnectionPscInterfaceConfigArgsDict', 'PrivateConnectionVpcPeeringConfigArgs', 'PrivateConnectionVpcPeeringConfigArgsDict', 'StreamBackfillAllArgs', 'StreamBackfillAllArgsDict', 'StreamBackfillAllMongodbExcludedObjectsArgs', 'StreamBackfillAllMongodbExcludedObjectsArgsDict', ..., ..., ..., ..., ..., ..., 'StreamBackfillAllMysqlExcludedObjectsArgs', 'StreamBackfillAllMysqlExcludedObjectsArgsDict', ..., ..., ..., ..., ..., ..., 'StreamBackfillAllOracleExcludedObjectsArgs', 'StreamBackfillAllOracleExcludedObjectsArgsDict', ..., ..., ..., ..., ..., ..., 'StreamBackfillAllPostgresqlExcludedObjectsArgs', 'StreamBackfillAllPostgresqlExcludedObjectsArgsDict', ..., ..., ..., ..., ..., ..., 'StreamBackfillAllSalesforceExcludedObjectsArgs', 'StreamBackfillAllSalesforceExcludedObjectsArgsDict', ..., ..., ..., ..., 'StreamBackfillAllSpannerExcludedObjectsArgs', 'StreamBackfillAllSpannerExcludedObjectsArgsDict', 'StreamBackfillAllSpannerExcludedObjectsSchemaArgs', ..., ..., ..., ..., ..., 'StreamBackfillAllSqlServerExcludedObjectsArgs', 'StreamBackfillAllSqlServerExcludedObjectsArgsDict', ..., ..., ..., ..., ..., ..., 'StreamBackfillNoneArgs', 'StreamBackfillNoneArgsDict', 'StreamDestinationConfigArgs', 'StreamDestinationConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'StreamDestinationConfigGcsDestinationConfigArgs', ..., ..., ..., ..., ..., 'StreamRuleSetArgs', 'StreamRuleSetArgsDict', 'StreamRuleSetCustomizationRuleArgs', 'StreamRuleSetCustomizationRuleArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'StreamRuleSetObjectFilterArgs', 'StreamRuleSetObjectFilterArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfigArgs', 'StreamSourceConfigArgsDict', 'StreamSourceConfigMongodbSourceConfigArgs', 'StreamSourceConfigMongodbSourceConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfigMysqlSourceConfigArgs', 'StreamSourceConfigMysqlSourceConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfigMysqlSourceConfigGtidArgs', 'StreamSourceConfigMysqlSourceConfigGtidArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfigOracleSourceConfigArgs', 'StreamSourceConfigOracleSourceConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfigPostgresqlSourceConfigArgs', 'StreamSourceConfigPostgresqlSourceConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfigSalesforceSourceConfigArgs', 'StreamSourceConfigSalesforceSourceConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfigSpannerSourceConfigArgs', 'StreamSourceConfigSpannerSourceConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'StreamSourceConfigSqlServerSourceConfigArgs', 'StreamSourceConfigSqlServerSourceConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ...]
...
class ConnectionProfileForwardSshConnectivityArgs:
    def __init__(__self__, *, hostname: pulumi.Input[_builtins.str], username: pulumi.Input[_builtins.str], password: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., private_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ConnectionProfileGcsProfileArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], root_path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @root_path.setter
    def root_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectionProfileMongodbProfileArgs:
    def __init__(__self__, *, host_addresses: pulumi.Input[Sequence[pulumi.Input[ConnectionProfileMongodbProfileHostAddressArgs]]], username: pulumi.Input[_builtins.str], password: Optional[pulumi.Input[_builtins.str]] = ..., replica_set: Optional[pulumi.Input[_builtins.str]] = ..., secret_manager_stored_password: Optional[pulumi.Input[_builtins.str]] = ..., srv_connection_format: Optional[pulumi.Input[ConnectionProfileMongodbProfileSrvConnectionFormatArgs]] = ..., ssl_config: Optional[pulumi.Input[ConnectionProfileMongodbProfileSslConfigArgs]] = ..., standard_connection_format: Optional[pulumi.Input[ConnectionProfileMongodbProfileStandardConnectionFormatArgs]] = ...) -> None:
    ...
    def host_addresses(self, value: pulumi.Input[Sequence[pulumi.Input[ConnectionProfileMongodbProfileHostAddressArgs]]]): # -> None:
        ...
    ...
    @replica_set.setter
    def replica_set(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def secret_manager_stored_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def srv_connection_format(self, value: Optional[pulumi.Input[ConnectionProfileMongodbProfileSrvConnectionFormatArgs]]): # -> None:
        ...
    ...
    @ssl_config.setter
    def ssl_config(self, value: Optional[pulumi.Input[ConnectionProfileMongodbProfileSslConfigArgs]]): # -> None:
        ...
    ...
    def standard_connection_format(self, value: Optional[pulumi.Input[ConnectionProfileMongodbProfileStandardConnectionFormatArgs]]): # -> None:
        ...
...
class ConnectionProfileMongodbProfileHostAddressArgs:
    def __init__(__self__, *, hostname: pulumi.Input[_builtins.str], port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ConnectionProfileMongodbProfileSslConfigArgs:
    def __init__(__self__, *, ca_certificate: Optional[pulumi.Input[_builtins.str]] = ..., ca_certificate_set: Optional[pulumi.Input[_builtins.bool]] = ..., client_certificate: Optional[pulumi.Input[_builtins.str]] = ..., client_certificate_set: Optional[pulumi.Input[_builtins.bool]] = ..., client_key: Optional[pulumi.Input[_builtins.str]] = ..., client_key_set: Optional[pulumi.Input[_builtins.bool]] = ..., secret_manager_stored_client_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ca_certificate_set(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def client_certificate_set(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def client_key_set(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def secret_manager_stored_client_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectionProfileMongodbProfileStandardConnectionFormatArgs:
    def __init__(__self__, *, direct_connection: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def direct_connection(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ConnectionProfileMysqlProfileArgs:
    def __init__(__self__, *, hostname: pulumi.Input[_builtins.str], username: pulumi.Input[_builtins.str], password: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., secret_manager_stored_password: Optional[pulumi.Input[_builtins.str]] = ..., ssl_config: Optional[pulumi.Input[ConnectionProfileMysqlProfileSslConfigArgs]] = ...) -> None:
    ...
    @ssl_config.setter
    def ssl_config(self, value: Optional[pulumi.Input[ConnectionProfileMysqlProfileSslConfigArgs]]): # -> None:
        ...
...
class ConnectionProfileMysqlProfileSslConfigArgs:
    def __init__(__self__, *, ca_certificate: Optional[pulumi.Input[_builtins.str]] = ..., ca_certificate_set: Optional[pulumi.Input[_builtins.bool]] = ..., client_certificate: Optional[pulumi.Input[_builtins.str]] = ..., client_certificate_set: Optional[pulumi.Input[_builtins.bool]] = ..., client_key: Optional[pulumi.Input[_builtins.str]] = ..., client_key_set: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class ConnectionProfileOracleProfileArgs:
    def __init__(__self__, *, database_service: pulumi.Input[_builtins.str], hostname: pulumi.Input[_builtins.str], username: pulumi.Input[_builtins.str], connection_attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., password: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., secret_manager_stored_password: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def connection_attributes(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ConnectionProfilePostgresqlProfileArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], hostname: pulumi.Input[_builtins.str], username: pulumi.Input[_builtins.str], password: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., secret_manager_stored_password: Optional[pulumi.Input[_builtins.str]] = ..., ssl_config: Optional[pulumi.Input[ConnectionProfilePostgresqlProfileSslConfigArgs]] = ...) -> None:
    ...
    @ssl_config.setter
    def ssl_config(self, value: Optional[pulumi.Input[ConnectionProfilePostgresqlProfileSslConfigArgs]]): # -> None:
        ...
...
class ConnectionProfilePostgresqlProfileSslConfigArgs:
    def __init__(__self__, *, server_and_client_verification: Optional[pulumi.Input[ConnectionProfilePostgresqlProfileSslConfigServerAndClientVerificationArgs]] = ..., server_verification: Optional[pulumi.Input[ConnectionProfilePostgresqlProfileSslConfigServerVerificationArgs]] = ...) -> None:
    ...
    def server_and_client_verification(self, value: Optional[pulumi.Input[ConnectionProfilePostgresqlProfileSslConfigServerAndClientVerificationArgs]]): # -> None:
        ...
    ...
    def server_verification(self, value: Optional[pulumi.Input[ConnectionProfilePostgresqlProfileSslConfigServerVerificationArgs]]): # -> None:
        ...
...
class ConnectionProfilePostgresqlProfileSslConfigServerAndClientVerificationArgs:
    def __init__(__self__, *, ca_certificate: pulumi.Input[_builtins.str], client_certificate: pulumi.Input[_builtins.str], client_key: pulumi.Input[_builtins.str]) -> None:
    ...
    @client_certificate.setter
    def client_certificate(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ConnectionProfileSalesforceProfileArgs:
    def __init__(__self__, *, domain: pulumi.Input[_builtins.str], oauth2_client_credentials: Optional[pulumi.Input[ConnectionProfileSalesforceProfileOauth2ClientCredentialsArgs]] = ..., user_credentials: Optional[pulumi.Input[ConnectionProfileSalesforceProfileUserCredentialsArgs]] = ...) -> None:
    ...
    def oauth2_client_credentials(self, value: Optional[pulumi.Input[ConnectionProfileSalesforceProfileOauth2ClientCredentialsArgs]]): # -> None:
        ...
    ...
    def user_credentials(self, value: Optional[pulumi.Input[ConnectionProfileSalesforceProfileUserCredentialsArgs]]): # -> None:
        ...
...
class ConnectionProfileSalesforceProfileOauth2ClientCredentialsArgs:
    def __init__(__self__, *, client_id: Optional[pulumi.Input[_builtins.str]] = ..., client_secret: Optional[pulumi.Input[_builtins.str]] = ..., secret_manager_stored_client_secret: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def secret_manager_stored_client_secret(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectionProfileSalesforceProfileUserCredentialsArgs:
    def __init__(__self__, *, password: Optional[pulumi.Input[_builtins.str]] = ..., secret_manager_stored_password: Optional[pulumi.Input[_builtins.str]] = ..., secret_manager_stored_security_token: Optional[pulumi.Input[_builtins.str]] = ..., security_token: Optional[pulumi.Input[_builtins.str]] = ..., username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def secret_manager_stored_security_token(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectionProfileSpannerProfileArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], host: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ConnectionProfileSqlServerProfileArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], hostname: pulumi.Input[_builtins.str], username: pulumi.Input[_builtins.str], password: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., secret_manager_stored_password: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PrivateConnectionPscInterfaceConfigArgs:
    def __init__(__self__, *, network_attachment: pulumi.Input[_builtins.str]) -> None:
    ...
    def network_attachment(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PrivateConnectionVpcPeeringConfigArgs:
    def __init__(__self__, *, subnet: pulumi.Input[_builtins.str], vpc: pulumi.Input[_builtins.str]) -> None:
...
class StreamBackfillAllArgs:
    def __init__(__self__, *, mongodb_excluded_objects: Optional[pulumi.Input[StreamBackfillAllMongodbExcludedObjectsArgs]] = ..., mysql_excluded_objects: Optional[pulumi.Input[StreamBackfillAllMysqlExcludedObjectsArgs]] = ..., oracle_excluded_objects: Optional[pulumi.Input[StreamBackfillAllOracleExcludedObjectsArgs]] = ..., postgresql_excluded_objects: Optional[pulumi.Input[StreamBackfillAllPostgresqlExcludedObjectsArgs]] = ..., salesforce_excluded_objects: Optional[pulumi.Input[StreamBackfillAllSalesforceExcludedObjectsArgs]] = ..., spanner_excluded_objects: Optional[pulumi.Input[StreamBackfillAllSpannerExcludedObjectsArgs]] = ..., sql_server_excluded_objects: Optional[pulumi.Input[StreamBackfillAllSqlServerExcludedObjectsArgs]] = ...) -> None:
    ...
    def mongodb_excluded_objects(self, value: Optional[pulumi.Input[StreamBackfillAllMongodbExcludedObjectsArgs]]): # -> None:
        ...
    ...
    def mysql_excluded_objects(self, value: Optional[pulumi.Input[StreamBackfillAllMysqlExcludedObjectsArgs]]): # -> None:
        ...
    ...
    def oracle_excluded_objects(self, value: Optional[pulumi.Input[StreamBackfillAllOracleExcludedObjectsArgs]]): # -> None:
        ...
    ...
    def postgresql_excluded_objects(self, value: Optional[pulumi.Input[StreamBackfillAllPostgresqlExcludedObjectsArgs]]): # -> None:
        ...
    ...
    def salesforce_excluded_objects(self, value: Optional[pulumi.Input[StreamBackfillAllSalesforceExcludedObjectsArgs]]): # -> None:
        ...
    ...
    def spanner_excluded_objects(self, value: Optional[pulumi.Input[StreamBackfillAllSpannerExcludedObjectsArgs]]): # -> None:
        ...
    ...
    def sql_server_excluded_objects(self, value: Optional[pulumi.Input[StreamBackfillAllSqlServerExcludedObjectsArgs]]): # -> None:
        ...
...
class StreamBackfillAllMongodbExcludedObjectsArgs:
    def __init__(__self__, *, databases: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMongodbExcludedObjectsDatabaseArgs]]]) -> None:
    ...
    @databases.setter
    def databases(self, value: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMongodbExcludedObjectsDatabaseArgs]]]): # -> None:
        ...
...
class StreamBackfillAllMongodbExcludedObjectsDatabaseArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], collections: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMongodbExcludedObjectsDatabaseCollectionArgs]]]] = ...) -> None:
    ...
    @collections.setter
    def collections(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMongodbExcludedObjectsDatabaseCollectionArgs]]]]): # -> None:
        ...
...
class StreamBackfillAllMongodbExcludedObjectsDatabaseCollectionArgs:
    def __init__(__self__, *, collection: pulumi.Input[_builtins.str], fields: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMongodbExcludedObjectsDatabaseCollectionFieldArgs]]]] = ...) -> None:
    ...
    @fields.setter
    def fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMongodbExcludedObjectsDatabaseCollectionFieldArgs]]]]): # -> None:
        ...
...
class StreamBackfillAllMysqlExcludedObjectsArgs:
    def __init__(__self__, *, mysql_databases: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseArgs]]]) -> None:
    ...
    def mysql_databases(self, value: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseArgs]]]): # -> None:
        ...
...
class StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], mysql_tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableArgs]]]] = ...) -> None:
    ...
    @mysql_tables.setter
    def mysql_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableArgs]]]]): # -> None:
        ...
...
class StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], mysql_columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableMysqlColumnArgs]]]] = ...) -> None:
    ...
    def mysql_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableMysqlColumnArgs]]]]): # -> None:
        ...
...
class StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableMysqlColumnArgs:
    def __init__(__self__, *, collation: Optional[pulumi.Input[_builtins.str]] = ..., column: Optional[pulumi.Input[_builtins.str]] = ..., data_type: Optional[pulumi.Input[_builtins.str]] = ..., length: Optional[pulumi.Input[_builtins.int]] = ..., nullable: Optional[pulumi.Input[_builtins.bool]] = ..., ordinal_position: Optional[pulumi.Input[_builtins.int]] = ..., primary_key: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @length.setter
    def length(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def ordinal_position(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @primary_key.setter
    def primary_key(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class StreamBackfillAllOracleExcludedObjectsArgs:
    def __init__(__self__, *, oracle_schemas: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllOracleExcludedObjectsOracleSchemaArgs]]]) -> None:
    ...
    def oracle_schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllOracleExcludedObjectsOracleSchemaArgs]]]): # -> None:
        ...
...
class StreamBackfillAllOracleExcludedObjectsOracleSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], oracle_tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableArgs]]]] = ...) -> None:
    ...
    def oracle_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableArgs]]]]): # -> None:
        ...
...
class StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], oracle_columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableOracleColumnArgs]]]] = ...) -> None:
    ...
    def oracle_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableOracleColumnArgs]]]]): # -> None:
        ...
...
class StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableOracleColumnArgs:
    def __init__(__self__, *, column: Optional[pulumi.Input[_builtins.str]] = ..., data_type: Optional[pulumi.Input[_builtins.str]] = ..., encoding: Optional[pulumi.Input[_builtins.str]] = ..., length: Optional[pulumi.Input[_builtins.int]] = ..., nullable: Optional[pulumi.Input[_builtins.bool]] = ..., ordinal_position: Optional[pulumi.Input[_builtins.int]] = ..., precision: Optional[pulumi.Input[_builtins.int]] = ..., primary_key: Optional[pulumi.Input[_builtins.bool]] = ..., scale: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @scale.setter
    def scale(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class StreamBackfillAllPostgresqlExcludedObjectsArgs:
    def __init__(__self__, *, postgresql_schemas: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaArgs]]]) -> None:
    ...
    def postgresql_schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaArgs]]]): # -> None:
        ...
...
class StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], postgresql_tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaPostgresqlTableArgs]]]] = ...) -> None:
    ...
    def postgresql_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaPostgresqlTableArgs]]]]): # -> None:
        ...
...
class StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaPostgresqlTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], postgresql_columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumnArgs]]]] = ...) -> None:
    ...
    def postgresql_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumnArgs]]]]): # -> None:
        ...
...
class StreamBackfillAllSalesforceExcludedObjectsArgs:
    def __init__(__self__, *, objects: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSalesforceExcludedObjectsObjectArgs]]]) -> None:
    ...
    @objects.setter
    def objects(self, value: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSalesforceExcludedObjectsObjectArgs]]]): # -> None:
        ...
...
class StreamBackfillAllSalesforceExcludedObjectsObjectArgs:
    def __init__(__self__, *, fields: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSalesforceExcludedObjectsObjectFieldArgs]]]] = ..., object_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @fields.setter
    def fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSalesforceExcludedObjectsObjectFieldArgs]]]]): # -> None:
        ...
    ...
    @object_name.setter
    def object_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StreamBackfillAllSpannerExcludedObjectsArgs:
    def __init__(__self__, *, schemas: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSpannerExcludedObjectsSchemaArgs]]]) -> None:
    ...
    @schemas.setter
    def schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSpannerExcludedObjectsSchemaArgs]]]): # -> None:
        ...
...
class StreamBackfillAllSpannerExcludedObjectsSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSpannerExcludedObjectsSchemaTableArgs]]]] = ...) -> None:
    ...
    @tables.setter
    def tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSpannerExcludedObjectsSchemaTableArgs]]]]): # -> None:
        ...
...
class StreamBackfillAllSpannerExcludedObjectsSchemaTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSpannerExcludedObjectsSchemaTableColumnArgs]]]] = ...) -> None:
    ...
    @columns.setter
    def columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSpannerExcludedObjectsSchemaTableColumnArgs]]]]): # -> None:
        ...
...
class StreamBackfillAllSpannerExcludedObjectsSchemaTableColumnArgs:
    def __init__(__self__, *, column: pulumi.Input[_builtins.str], data_type: Optional[pulumi.Input[_builtins.str]] = ..., is_primary_key: Optional[pulumi.Input[_builtins.bool]] = ..., ordinal_position: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def is_primary_key(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class StreamBackfillAllSqlServerExcludedObjectsArgs:
    def __init__(__self__, *, schemas: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSqlServerExcludedObjectsSchemaArgs]]]) -> None:
    ...
    @schemas.setter
    def schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSqlServerExcludedObjectsSchemaArgs]]]): # -> None:
        ...
...
class StreamBackfillAllSqlServerExcludedObjectsSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSqlServerExcludedObjectsSchemaTableArgs]]]] = ...) -> None:
    ...
    @tables.setter
    def tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSqlServerExcludedObjectsSchemaTableArgs]]]]): # -> None:
        ...
...
class StreamBackfillAllSqlServerExcludedObjectsSchemaTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSqlServerExcludedObjectsSchemaTableColumnArgs]]]] = ...) -> None:
    ...
    @columns.setter
    def columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamBackfillAllSqlServerExcludedObjectsSchemaTableColumnArgs]]]]): # -> None:
        ...
...
class StreamDestinationConfigArgs:
    def __init__(__self__, *, destination_connection_profile: pulumi.Input[_builtins.str], bigquery_destination_config: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigArgs]] = ..., gcs_destination_config: Optional[pulumi.Input[StreamDestinationConfigGcsDestinationConfigArgs]] = ...) -> None:
    ...
    def destination_connection_profile(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def bigquery_destination_config(self, value: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigArgs]]): # -> None:
        ...
    ...
    def gcs_destination_config(self, value: Optional[pulumi.Input[StreamDestinationConfigGcsDestinationConfigArgs]]): # -> None:
        ...
...
class StreamDestinationConfigBigqueryDestinationConfigArgs:
    def __init__(__self__, *, append_only: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigAppendOnlyArgs]] = ..., blmt_config: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigBlmtConfigArgs]] = ..., data_freshness: Optional[pulumi.Input[_builtins.str]] = ..., merge: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigMergeArgs]] = ..., single_target_dataset: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigSingleTargetDatasetArgs]] = ..., source_hierarchy_datasets: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasetsArgs]] = ...) -> None:
    ...
    @append_only.setter
    def append_only(self, value: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigAppendOnlyArgs]]): # -> None:
        ...
    ...
    @blmt_config.setter
    def blmt_config(self, value: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigBlmtConfigArgs]]): # -> None:
        ...
    ...
    def data_freshness(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @merge.setter
    def merge(self, value: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigMergeArgs]]): # -> None:
        ...
    ...
    def single_target_dataset(self, value: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigSingleTargetDatasetArgs]]): # -> None:
        ...
    ...
    def source_hierarchy_datasets(self, value: Optional[pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasetsArgs]]): # -> None:
        ...
...
class StreamDestinationConfigBigqueryDestinationConfigBlmtConfigArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], connection_name: pulumi.Input[_builtins.str], file_format: pulumi.Input[_builtins.str], table_format: pulumi.Input[_builtins.str], root_path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @file_format.setter
    def file_format(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @table_format.setter
    def table_format(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasetsArgs:
    def __init__(__self__, *, dataset_template: pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasetsDatasetTemplateArgs], project_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dataset_template(self, value: pulumi.Input[StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasetsDatasetTemplateArgs]): # -> None:
        ...
...
class StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasetsDatasetTemplateArgs:
    def __init__(__self__, *, location: pulumi.Input[_builtins.str], dataset_id_prefix: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dataset_id_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StreamDestinationConfigGcsDestinationConfigArgs:
    def __init__(__self__, *, avro_file_format: Optional[pulumi.Input[StreamDestinationConfigGcsDestinationConfigAvroFileFormatArgs]] = ..., file_rotation_interval: Optional[pulumi.Input[_builtins.str]] = ..., file_rotation_mb: Optional[pulumi.Input[_builtins.int]] = ..., json_file_format: Optional[pulumi.Input[StreamDestinationConfigGcsDestinationConfigJsonFileFormatArgs]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def avro_file_format(self, value: Optional[pulumi.Input[StreamDestinationConfigGcsDestinationConfigAvroFileFormatArgs]]): # -> None:
        ...
    ...
    def file_rotation_interval(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def file_rotation_mb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def json_file_format(self, value: Optional[pulumi.Input[StreamDestinationConfigGcsDestinationConfigJsonFileFormatArgs]]): # -> None:
        ...
...
class StreamDestinationConfigGcsDestinationConfigJsonFileFormatArgs:
    def __init__(__self__, *, compression: Optional[pulumi.Input[_builtins.str]] = ..., schema_file_format: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def schema_file_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StreamRuleSetArgs:
    def __init__(__self__, *, customization_rules: pulumi.Input[Sequence[pulumi.Input[StreamRuleSetCustomizationRuleArgs]]], object_filter: pulumi.Input[StreamRuleSetObjectFilterArgs]) -> None:
    ...
    def customization_rules(self, value: pulumi.Input[Sequence[pulumi.Input[StreamRuleSetCustomizationRuleArgs]]]): # -> None:
        ...
    ...
    def object_filter(self, value: pulumi.Input[StreamRuleSetObjectFilterArgs]): # -> None:
        ...
...
class StreamRuleSetCustomizationRuleArgs:
    def __init__(__self__, *, bigquery_clustering: Optional[pulumi.Input[StreamRuleSetCustomizationRuleBigqueryClusteringArgs]] = ..., bigquery_partitioning: Optional[pulumi.Input[StreamRuleSetCustomizationRuleBigqueryPartitioningArgs]] = ...) -> None:
    ...
    def bigquery_clustering(self, value: Optional[pulumi.Input[StreamRuleSetCustomizationRuleBigqueryClusteringArgs]]): # -> None:
        ...
    ...
    def bigquery_partitioning(self, value: Optional[pulumi.Input[StreamRuleSetCustomizationRuleBigqueryPartitioningArgs]]): # -> None:
        ...
...
class StreamRuleSetCustomizationRuleBigqueryClusteringArgs:
    def __init__(__self__, *, columns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @columns.setter
    def columns(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class StreamRuleSetCustomizationRuleBigqueryPartitioningArgs:
    def __init__(__self__, *, ingestion_time_partition: Optional[pulumi.Input[StreamRuleSetCustomizationRuleBigqueryPartitioningIngestionTimePartitionArgs]] = ..., integer_range_partition: Optional[pulumi.Input[StreamRuleSetCustomizationRuleBigqueryPartitioningIntegerRangePartitionArgs]] = ..., require_partition_filter: Optional[pulumi.Input[_builtins.bool]] = ..., time_unit_partition: Optional[pulumi.Input[StreamRuleSetCustomizationRuleBigqueryPartitioningTimeUnitPartitionArgs]] = ...) -> None:
    ...
    def ingestion_time_partition(self, value: Optional[pulumi.Input[StreamRuleSetCustomizationRuleBigqueryPartitioningIngestionTimePartitionArgs]]): # -> None:
        ...
    ...
    def integer_range_partition(self, value: Optional[pulumi.Input[StreamRuleSetCustomizationRuleBigqueryPartitioningIntegerRangePartitionArgs]]): # -> None:
        ...
    ...
    def time_unit_partition(self, value: Optional[pulumi.Input[StreamRuleSetCustomizationRuleBigqueryPartitioningTimeUnitPartitionArgs]]): # -> None:
        ...
...
class StreamRuleSetCustomizationRuleBigqueryPartitioningIngestionTimePartitionArgs:
    def __init__(__self__, *, partitioning_time_granularity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def partitioning_time_granularity(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StreamRuleSetCustomizationRuleBigqueryPartitioningIntegerRangePartitionArgs:
    def __init__(__self__, *, column: pulumi.Input[_builtins.str], end: pulumi.Input[_builtins.int], interval: pulumi.Input[_builtins.int], start: pulumi.Input[_builtins.int]) -> None:
...
class StreamRuleSetCustomizationRuleBigqueryPartitioningTimeUnitPartitionArgs:
    def __init__(__self__, *, column: pulumi.Input[_builtins.str], partitioning_time_granularity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StreamRuleSetObjectFilterArgs:
    def __init__(__self__, *, source_object_identifier: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierArgs]] = ...) -> None:
    ...
    def source_object_identifier(self, value: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierArgs]]): # -> None:
        ...
...
class StreamRuleSetObjectFilterSourceObjectIdentifierArgs:
    def __init__(__self__, *, mongodb_identifier: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierMongodbIdentifierArgs]] = ..., mysql_identifier: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierMysqlIdentifierArgs]] = ..., oracle_identifier: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierOracleIdentifierArgs]] = ..., postgresql_identifier: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierPostgresqlIdentifierArgs]] = ..., salesforce_identifier: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierSalesforceIdentifierArgs]] = ..., spanner_identifier: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierSpannerIdentifierArgs]] = ..., sql_server_identifier: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierSqlServerIdentifierArgs]] = ...) -> None:
    ...
    def mongodb_identifier(self, value: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierMongodbIdentifierArgs]]): # -> None:
        ...
    ...
    def mysql_identifier(self, value: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierMysqlIdentifierArgs]]): # -> None:
        ...
    ...
    def oracle_identifier(self, value: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierOracleIdentifierArgs]]): # -> None:
        ...
    ...
    def postgresql_identifier(self, value: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierPostgresqlIdentifierArgs]]): # -> None:
        ...
    ...
    def salesforce_identifier(self, value: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierSalesforceIdentifierArgs]]): # -> None:
        ...
    ...
    def spanner_identifier(self, value: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierSpannerIdentifierArgs]]): # -> None:
        ...
    ...
    def sql_server_identifier(self, value: Optional[pulumi.Input[StreamRuleSetObjectFilterSourceObjectIdentifierSqlServerIdentifierArgs]]): # -> None:
        ...
...
class StreamRuleSetObjectFilterSourceObjectIdentifierMongodbIdentifierArgs:
    def __init__(__self__, *, collection: pulumi.Input[_builtins.str], database: pulumi.Input[_builtins.str]) -> None:
...
class StreamRuleSetObjectFilterSourceObjectIdentifierMysqlIdentifierArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], table: pulumi.Input[_builtins.str]) -> None:
...
class StreamRuleSetObjectFilterSourceObjectIdentifierOracleIdentifierArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], table: pulumi.Input[_builtins.str]) -> None:
...
class StreamRuleSetObjectFilterSourceObjectIdentifierSalesforceIdentifierArgs:
    ...
    @object_name.setter
    def object_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class StreamRuleSetObjectFilterSourceObjectIdentifierSpannerIdentifierArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], schema: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class StreamSourceConfigArgs:
    def __init__(__self__, *, source_connection_profile: pulumi.Input[_builtins.str], mongodb_source_config: Optional[pulumi.Input[StreamSourceConfigMongodbSourceConfigArgs]] = ..., mysql_source_config: Optional[pulumi.Input[StreamSourceConfigMysqlSourceConfigArgs]] = ..., oracle_source_config: Optional[pulumi.Input[StreamSourceConfigOracleSourceConfigArgs]] = ..., postgresql_source_config: Optional[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigArgs]] = ..., salesforce_source_config: Optional[pulumi.Input[StreamSourceConfigSalesforceSourceConfigArgs]] = ..., spanner_source_config: Optional[pulumi.Input[StreamSourceConfigSpannerSourceConfigArgs]] = ..., sql_server_source_config: Optional[pulumi.Input[StreamSourceConfigSqlServerSourceConfigArgs]] = ...) -> None:
    ...
    def source_connection_profile(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def mongodb_source_config(self, value: Optional[pulumi.Input[StreamSourceConfigMongodbSourceConfigArgs]]): # -> None:
        ...
    ...
    def mysql_source_config(self, value: Optional[pulumi.Input[StreamSourceConfigMysqlSourceConfigArgs]]): # -> None:
        ...
    ...
    def oracle_source_config(self, value: Optional[pulumi.Input[StreamSourceConfigOracleSourceConfigArgs]]): # -> None:
        ...
    ...
    def postgresql_source_config(self, value: Optional[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigArgs]]): # -> None:
        ...
    ...
    def salesforce_source_config(self, value: Optional[pulumi.Input[StreamSourceConfigSalesforceSourceConfigArgs]]): # -> None:
        ...
    ...
    def spanner_source_config(self, value: Optional[pulumi.Input[StreamSourceConfigSpannerSourceConfigArgs]]): # -> None:
        ...
    ...
    def sql_server_source_config(self, value: Optional[pulumi.Input[StreamSourceConfigSqlServerSourceConfigArgs]]): # -> None:
        ...
...
class StreamSourceConfigMongodbSourceConfigArgs:
    def __init__(__self__, *, exclude_objects: Optional[pulumi.Input[StreamSourceConfigMongodbSourceConfigExcludeObjectsArgs]] = ..., include_objects: Optional[pulumi.Input[StreamSourceConfigMongodbSourceConfigIncludeObjectsArgs]] = ..., max_concurrent_backfill_tasks: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def exclude_objects(self, value: Optional[pulumi.Input[StreamSourceConfigMongodbSourceConfigExcludeObjectsArgs]]): # -> None:
        ...
    ...
    def include_objects(self, value: Optional[pulumi.Input[StreamSourceConfigMongodbSourceConfigIncludeObjectsArgs]]): # -> None:
        ...
    ...
    def max_concurrent_backfill_tasks(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class StreamSourceConfigMongodbSourceConfigExcludeObjectsArgs:
    def __init__(__self__, *, databases: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabaseArgs]]]] = ...) -> None:
    ...
    @databases.setter
    def databases(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabaseArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabaseArgs:
    def __init__(__self__, *, collections: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabaseCollectionArgs]]]] = ..., database: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @collections.setter
    def collections(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabaseCollectionArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabaseCollectionArgs:
    def __init__(__self__, *, collection: Optional[pulumi.Input[_builtins.str]] = ..., fields: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabaseCollectionFieldArgs]]]] = ...) -> None:
    ...
    @fields.setter
    def fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigExcludeObjectsDatabaseCollectionFieldArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigMongodbSourceConfigIncludeObjectsArgs:
    def __init__(__self__, *, databases: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabaseArgs]]]] = ...) -> None:
    ...
    @databases.setter
    def databases(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabaseArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabaseArgs:
    def __init__(__self__, *, collections: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabaseCollectionArgs]]]] = ..., database: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @collections.setter
    def collections(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabaseCollectionArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabaseCollectionArgs:
    def __init__(__self__, *, collection: Optional[pulumi.Input[_builtins.str]] = ..., fields: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabaseCollectionFieldArgs]]]] = ...) -> None:
    ...
    @fields.setter
    def fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMongodbSourceConfigIncludeObjectsDatabaseCollectionFieldArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigMysqlSourceConfigArgs:
    def __init__(__self__, *, binary_log_position: Optional[pulumi.Input[StreamSourceConfigMysqlSourceConfigBinaryLogPositionArgs]] = ..., exclude_objects: Optional[pulumi.Input[StreamSourceConfigMysqlSourceConfigExcludeObjectsArgs]] = ..., gtid: Optional[pulumi.Input[StreamSourceConfigMysqlSourceConfigGtidArgs]] = ..., include_objects: Optional[pulumi.Input[StreamSourceConfigMysqlSourceConfigIncludeObjectsArgs]] = ..., max_concurrent_backfill_tasks: Optional[pulumi.Input[_builtins.int]] = ..., max_concurrent_cdc_tasks: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def binary_log_position(self, value: Optional[pulumi.Input[StreamSourceConfigMysqlSourceConfigBinaryLogPositionArgs]]): # -> None:
        ...
    ...
    @exclude_objects.setter
    def exclude_objects(self, value: Optional[pulumi.Input[StreamSourceConfigMysqlSourceConfigExcludeObjectsArgs]]): # -> None:
        ...
    ...
    @gtid.setter
    def gtid(self, value: Optional[pulumi.Input[StreamSourceConfigMysqlSourceConfigGtidArgs]]): # -> None:
        ...
    ...
    @include_objects.setter
    def include_objects(self, value: Optional[pulumi.Input[StreamSourceConfigMysqlSourceConfigIncludeObjectsArgs]]): # -> None:
        ...
    ...
    def max_concurrent_cdc_tasks(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class StreamSourceConfigMysqlSourceConfigExcludeObjectsArgs:
    def __init__(__self__, *, mysql_databases: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabaseArgs]]]) -> None:
    ...
    @mysql_databases.setter
    def mysql_databases(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabaseArgs]]]): # -> None:
        ...
...
class StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabaseArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], mysql_tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabaseMysqlTableArgs]]]] = ...) -> None:
    ...
    @mysql_tables.setter
    def mysql_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabaseMysqlTableArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabaseMysqlTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], mysql_columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabaseMysqlTableMysqlColumnArgs]]]] = ...) -> None:
    ...
    @mysql_columns.setter
    def mysql_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigExcludeObjectsMysqlDatabaseMysqlTableMysqlColumnArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigMysqlSourceConfigIncludeObjectsArgs:
    def __init__(__self__, *, mysql_databases: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseArgs]]]) -> None:
    ...
    @mysql_databases.setter
    def mysql_databases(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseArgs]]]): # -> None:
        ...
...
class StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], mysql_tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseMysqlTableArgs]]]] = ...) -> None:
    ...
    @mysql_tables.setter
    def mysql_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseMysqlTableArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseMysqlTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], mysql_columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseMysqlTableMysqlColumnArgs]]]] = ...) -> None:
    ...
    @mysql_columns.setter
    def mysql_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseMysqlTableMysqlColumnArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigOracleSourceConfigArgs:
    def __init__(__self__, *, drop_large_objects: Optional[pulumi.Input[StreamSourceConfigOracleSourceConfigDropLargeObjectsArgs]] = ..., exclude_objects: Optional[pulumi.Input[StreamSourceConfigOracleSourceConfigExcludeObjectsArgs]] = ..., include_objects: Optional[pulumi.Input[StreamSourceConfigOracleSourceConfigIncludeObjectsArgs]] = ..., max_concurrent_backfill_tasks: Optional[pulumi.Input[_builtins.int]] = ..., max_concurrent_cdc_tasks: Optional[pulumi.Input[_builtins.int]] = ..., stream_large_objects: Optional[pulumi.Input[StreamSourceConfigOracleSourceConfigStreamLargeObjectsArgs]] = ...) -> None:
    ...
    def drop_large_objects(self, value: Optional[pulumi.Input[StreamSourceConfigOracleSourceConfigDropLargeObjectsArgs]]): # -> None:
        ...
    ...
    @exclude_objects.setter
    def exclude_objects(self, value: Optional[pulumi.Input[StreamSourceConfigOracleSourceConfigExcludeObjectsArgs]]): # -> None:
        ...
    ...
    @include_objects.setter
    def include_objects(self, value: Optional[pulumi.Input[StreamSourceConfigOracleSourceConfigIncludeObjectsArgs]]): # -> None:
        ...
    ...
    def stream_large_objects(self, value: Optional[pulumi.Input[StreamSourceConfigOracleSourceConfigStreamLargeObjectsArgs]]): # -> None:
        ...
...
class StreamSourceConfigOracleSourceConfigExcludeObjectsArgs:
    def __init__(__self__, *, oracle_schemas: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaArgs]]]) -> None:
    ...
    @oracle_schemas.setter
    def oracle_schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaArgs]]]): # -> None:
        ...
...
class StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], oracle_tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaOracleTableArgs]]]] = ...) -> None:
    ...
    @oracle_tables.setter
    def oracle_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaOracleTableArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaOracleTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], oracle_columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaOracleTableOracleColumnArgs]]]] = ...) -> None:
    ...
    @oracle_columns.setter
    def oracle_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigExcludeObjectsOracleSchemaOracleTableOracleColumnArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigOracleSourceConfigIncludeObjectsArgs:
    def __init__(__self__, *, oracle_schemas: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaArgs]]]) -> None:
    ...
    @oracle_schemas.setter
    def oracle_schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaArgs]]]): # -> None:
        ...
...
class StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], oracle_tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTableArgs]]]] = ...) -> None:
    ...
    @oracle_tables.setter
    def oracle_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTableArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], oracle_columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTableOracleColumnArgs]]]] = ...) -> None:
    ...
    @oracle_columns.setter
    def oracle_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTableOracleColumnArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigPostgresqlSourceConfigArgs:
    def __init__(__self__, *, publication: pulumi.Input[_builtins.str], replication_slot: pulumi.Input[_builtins.str], exclude_objects: Optional[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigExcludeObjectsArgs]] = ..., include_objects: Optional[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigIncludeObjectsArgs]] = ..., max_concurrent_backfill_tasks: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @publication.setter
    def publication(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def replication_slot(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @exclude_objects.setter
    def exclude_objects(self, value: Optional[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigExcludeObjectsArgs]]): # -> None:
        ...
    ...
    @include_objects.setter
    def include_objects(self, value: Optional[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigIncludeObjectsArgs]]): # -> None:
        ...
...
class StreamSourceConfigPostgresqlSourceConfigExcludeObjectsArgs:
    def __init__(__self__, *, postgresql_schemas: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaArgs]]]) -> None:
    ...
    @postgresql_schemas.setter
    def postgresql_schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaArgs]]]): # -> None:
        ...
...
class StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], postgresql_tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaPostgresqlTableArgs]]]] = ...) -> None:
    ...
    @postgresql_tables.setter
    def postgresql_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaPostgresqlTableArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaPostgresqlTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], postgresql_columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumnArgs]]]] = ...) -> None:
    ...
    @postgresql_columns.setter
    def postgresql_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigExcludeObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumnArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigPostgresqlSourceConfigIncludeObjectsArgs:
    def __init__(__self__, *, postgresql_schemas: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemaArgs]]]) -> None:
    ...
    @postgresql_schemas.setter
    def postgresql_schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemaArgs]]]): # -> None:
        ...
...
class StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], postgresql_tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemaPostgresqlTableArgs]]]] = ...) -> None:
    ...
    @postgresql_tables.setter
    def postgresql_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemaPostgresqlTableArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemaPostgresqlTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], postgresql_columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumnArgs]]]] = ...) -> None:
    ...
    @postgresql_columns.setter
    def postgresql_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumnArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigSalesforceSourceConfigArgs:
    def __init__(__self__, *, polling_interval: pulumi.Input[_builtins.str], exclude_objects: Optional[pulumi.Input[StreamSourceConfigSalesforceSourceConfigExcludeObjectsArgs]] = ..., include_objects: Optional[pulumi.Input[StreamSourceConfigSalesforceSourceConfigIncludeObjectsArgs]] = ...) -> None:
    ...
    def polling_interval(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @exclude_objects.setter
    def exclude_objects(self, value: Optional[pulumi.Input[StreamSourceConfigSalesforceSourceConfigExcludeObjectsArgs]]): # -> None:
        ...
    ...
    @include_objects.setter
    def include_objects(self, value: Optional[pulumi.Input[StreamSourceConfigSalesforceSourceConfigIncludeObjectsArgs]]): # -> None:
        ...
...
class StreamSourceConfigSalesforceSourceConfigExcludeObjectsArgs:
    def __init__(__self__, *, objects: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSalesforceSourceConfigExcludeObjectsObjectArgs]]]) -> None:
    ...
    @objects.setter
    def objects(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSalesforceSourceConfigExcludeObjectsObjectArgs]]]): # -> None:
        ...
...
class StreamSourceConfigSalesforceSourceConfigExcludeObjectsObjectArgs:
    def __init__(__self__, *, fields: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSalesforceSourceConfigExcludeObjectsObjectFieldArgs]]]] = ..., object_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @fields.setter
    def fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSalesforceSourceConfigExcludeObjectsObjectFieldArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigSalesforceSourceConfigIncludeObjectsArgs:
    def __init__(__self__, *, objects: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSalesforceSourceConfigIncludeObjectsObjectArgs]]]) -> None:
    ...
    @objects.setter
    def objects(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSalesforceSourceConfigIncludeObjectsObjectArgs]]]): # -> None:
        ...
...
class StreamSourceConfigSalesforceSourceConfigIncludeObjectsObjectArgs:
    def __init__(__self__, *, fields: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSalesforceSourceConfigIncludeObjectsObjectFieldArgs]]]] = ..., object_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @fields.setter
    def fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSalesforceSourceConfigIncludeObjectsObjectFieldArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigSpannerSourceConfigArgs:
    def __init__(__self__, *, backfill_data_boost_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., change_stream_name: Optional[pulumi.Input[_builtins.str]] = ..., exclude_objects: Optional[pulumi.Input[StreamSourceConfigSpannerSourceConfigExcludeObjectsArgs]] = ..., fgac_role: Optional[pulumi.Input[_builtins.str]] = ..., include_objects: Optional[pulumi.Input[StreamSourceConfigSpannerSourceConfigIncludeObjectsArgs]] = ..., max_concurrent_backfill_tasks: Optional[pulumi.Input[_builtins.int]] = ..., max_concurrent_cdc_tasks: Optional[pulumi.Input[_builtins.int]] = ..., spanner_rpc_priority: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def backfill_data_boost_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def change_stream_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @exclude_objects.setter
    def exclude_objects(self, value: Optional[pulumi.Input[StreamSourceConfigSpannerSourceConfigExcludeObjectsArgs]]): # -> None:
        ...
    ...
    @fgac_role.setter
    def fgac_role(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @include_objects.setter
    def include_objects(self, value: Optional[pulumi.Input[StreamSourceConfigSpannerSourceConfigIncludeObjectsArgs]]): # -> None:
        ...
    ...
    def spanner_rpc_priority(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class StreamSourceConfigSpannerSourceConfigExcludeObjectsArgs:
    def __init__(__self__, *, schemas: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaArgs]]]) -> None:
    ...
    @schemas.setter
    def schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaArgs]]]): # -> None:
        ...
...
class StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaTableArgs]]]] = ...) -> None:
    ...
    @tables.setter
    def tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaTableArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaTableColumnArgs]]]] = ...) -> None:
    ...
    @columns.setter
    def columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaTableColumnArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigSpannerSourceConfigExcludeObjectsSchemaTableColumnArgs:
    def __init__(__self__, *, column: Optional[pulumi.Input[_builtins.str]] = ..., data_type: Optional[pulumi.Input[_builtins.str]] = ..., is_primary_key: Optional[pulumi.Input[_builtins.bool]] = ..., ordinal_position: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class StreamSourceConfigSpannerSourceConfigIncludeObjectsArgs:
    def __init__(__self__, *, schemas: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigIncludeObjectsSchemaArgs]]]) -> None:
    ...
    @schemas.setter
    def schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigIncludeObjectsSchemaArgs]]]): # -> None:
        ...
...
class StreamSourceConfigSpannerSourceConfigIncludeObjectsSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigIncludeObjectsSchemaTableArgs]]]] = ...) -> None:
    ...
    @tables.setter
    def tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigIncludeObjectsSchemaTableArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigSpannerSourceConfigIncludeObjectsSchemaTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigIncludeObjectsSchemaTableColumnArgs]]]] = ...) -> None:
    ...
    @columns.setter
    def columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSpannerSourceConfigIncludeObjectsSchemaTableColumnArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigSqlServerSourceConfigArgs:
    def __init__(__self__, *, change_tables: Optional[pulumi.Input[StreamSourceConfigSqlServerSourceConfigChangeTablesArgs]] = ..., exclude_objects: Optional[pulumi.Input[StreamSourceConfigSqlServerSourceConfigExcludeObjectsArgs]] = ..., include_objects: Optional[pulumi.Input[StreamSourceConfigSqlServerSourceConfigIncludeObjectsArgs]] = ..., max_concurrent_backfill_tasks: Optional[pulumi.Input[_builtins.int]] = ..., max_concurrent_cdc_tasks: Optional[pulumi.Input[_builtins.int]] = ..., transaction_logs: Optional[pulumi.Input[StreamSourceConfigSqlServerSourceConfigTransactionLogsArgs]] = ...) -> None:
    ...
    def change_tables(self, value: Optional[pulumi.Input[StreamSourceConfigSqlServerSourceConfigChangeTablesArgs]]): # -> None:
        ...
    ...
    @exclude_objects.setter
    def exclude_objects(self, value: Optional[pulumi.Input[StreamSourceConfigSqlServerSourceConfigExcludeObjectsArgs]]): # -> None:
        ...
    ...
    @include_objects.setter
    def include_objects(self, value: Optional[pulumi.Input[StreamSourceConfigSqlServerSourceConfigIncludeObjectsArgs]]): # -> None:
        ...
    ...
    def transaction_logs(self, value: Optional[pulumi.Input[StreamSourceConfigSqlServerSourceConfigTransactionLogsArgs]]): # -> None:
        ...
...
class StreamSourceConfigSqlServerSourceConfigExcludeObjectsArgs:
    def __init__(__self__, *, schemas: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaArgs]]]) -> None:
    ...
    @schemas.setter
    def schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaArgs]]]): # -> None:
        ...
...
class StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaTableArgs]]]] = ...) -> None:
    ...
    @tables.setter
    def tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaTableArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaTableColumnArgs]]]] = ...) -> None:
    ...
    @columns.setter
    def columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaTableColumnArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigSqlServerSourceConfigIncludeObjectsArgs:
    def __init__(__self__, *, schemas: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaArgs]]]) -> None:
    ...
    @schemas.setter
    def schemas(self, value: pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaArgs]]]): # -> None:
        ...
...
class StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaArgs:
    def __init__(__self__, *, schema: pulumi.Input[_builtins.str], tables: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableArgs]]]] = ...) -> None:
    ...
    @tables.setter
    def tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableArgs]]]]): # -> None:
        ...
...
class StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableArgs:
    def __init__(__self__, *, table: pulumi.Input[_builtins.str], columns: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableColumnArgs]]]] = ...) -> None:
    ...
    @columns.setter
    def columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[StreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemaTableColumnArgs]]]]): # -> None:
        ...
