...
class PrivateConnectionArgs:
    def __init__(
        ...
        *,
        ...
        psc_interface_config: Optional[
            pulumi.Input[PrivateConnectionPscInterfaceConfigArgs]
        ] = ...,
    ...
    def psc_interface_config(
        self,
    ) -> Optional[pulumi.Input[PrivateConnectionPscInterfaceConfigArgs]]: ...
    @psc_interface_config.setter
    def psc_interface_config(
        self, value: Optional[pulumi.Input[PrivateConnectionPscInterfaceConfigArgs]]
    ): ...
    @_builtins.property
...
class PrivateConnection(pulumi.CustomResource):
    ...
    def psc_interface_config(
        self,
    ) -> pulumi.Output[Optional[outputs.PrivateConnectionPscInterfaceConfig]]: ...
    @_builtins.property
    @pulumi.getter(name="pulumiLabels")
    ...
    def vpc_peering_config(
        self,
    ) -> pulumi.Output[Optional[outputs.PrivateConnectionVpcPeeringConfig]]: ...
