...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectionBitbucketCloudConfigArgs', 'ConnectionBitbucketCloudConfigArgsDict', ..., ..., ..., ..., 'ConnectionBitbucketDataCenterConfigArgs', 'ConnectionBitbucketDataCenterConfigArgsDict', ..., ..., ..., ..., ..., ..., 'ConnectionGithubConfigArgs', 'ConnectionGithubConfigArgsDict', 'ConnectionGithubConfigAuthorizerCredentialArgs', 'ConnectionGithubConfigAuthorizerCredentialArgsDict', 'ConnectionGithubEnterpriseConfigArgs', 'ConnectionGithubEnterpriseConfigArgsDict', ..., ..., 'ConnectionGitlabConfigArgs', 'ConnectionGitlabConfigArgsDict', 'ConnectionGitlabConfigAuthorizerCredentialArgs', 'ConnectionGitlabConfigAuthorizerCredentialArgsDict', 'ConnectionGitlabConfigReadAuthorizerCredentialArgs', ..., 'ConnectionGitlabConfigServiceDirectoryConfigArgs', ..., 'ConnectionIAMBindingConditionArgs', 'ConnectionIAMBindingConditionArgsDict', 'ConnectionIAMMemberConditionArgs', 'ConnectionIAMMemberConditionArgsDict', 'ConnectionInstallationStateArgs', 'ConnectionInstallationStateArgsDict']
...
class ConnectionBitbucketDataCenterConfigArgs:
    ...
    @ssl_ca.setter
    def ssl_ca(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectionGithubConfigArgs:
    def __init__(__self__, *, app_installation_id: Optional[pulumi.Input[_builtins.int]] = ..., authorizer_credential: Optional[pulumi.Input[ConnectionGithubConfigAuthorizerCredentialArgs]] = ...) -> None:
    ...
    def app_installation_id(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ConnectionGithubConfigAuthorizerCredentialArgs:
    def __init__(__self__, *, oauth_token_secret_version: Optional[pulumi.Input[_builtins.str]] = ..., username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def oauth_token_secret_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectionGithubEnterpriseConfigArgs:
    def __init__(__self__, *, host_uri: pulumi.Input[_builtins.str], app_id: Optional[pulumi.Input[_builtins.int]] = ..., app_installation_id: Optional[pulumi.Input[_builtins.int]] = ..., app_slug: Optional[pulumi.Input[_builtins.str]] = ..., private_key_secret_version: Optional[pulumi.Input[_builtins.str]] = ..., service_directory_config: Optional[pulumi.Input[ConnectionGithubEnterpriseConfigServiceDirectoryConfigArgs]] = ..., ssl_ca: Optional[pulumi.Input[_builtins.str]] = ..., webhook_secret_secret_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @app_id.setter
    def app_id(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ConnectionGitlabConfigArgs:
    def __init__(__self__, *, authorizer_credential: pulumi.Input[ConnectionGitlabConfigAuthorizerCredentialArgs], read_authorizer_credential: pulumi.Input[ConnectionGitlabConfigReadAuthorizerCredentialArgs], webhook_secret_secret_version: pulumi.Input[_builtins.str], host_uri: Optional[pulumi.Input[_builtins.str]] = ..., server_version: Optional[pulumi.Input[_builtins.str]] = ..., service_directory_config: Optional[pulumi.Input[ConnectionGitlabConfigServiceDirectoryConfigArgs]] = ..., ssl_ca: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @host_uri.setter
    def host_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @service_directory_config.setter
    def service_directory_config(self, value: Optional[pulumi.Input[ConnectionGitlabConfigServiceDirectoryConfigArgs]]): # -> None:
        ...
