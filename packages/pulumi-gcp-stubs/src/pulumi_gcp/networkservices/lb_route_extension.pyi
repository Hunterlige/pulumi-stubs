...
class LbRouteExtensionArgs:
    def __init__(
        __self__,
        *,
        extension_chains: pulumi.Input[
            Sequence[pulumi.Input[LbRouteExtensionExtensionChainArgs]]
        ],
    ...
    def extension_chains(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input[LbRouteExtensionExtensionChainArgs]]]: ...
    @extension_chains.setter
    def extension_chains(
        self,
        value: pulumi.Input[Sequence[pulumi.Input[LbRouteExtensionExtensionChainArgs]]],
    ): ...
    @_builtins.property
...
class _LbRouteExtensionState:
    def __init__(
        ...
        *,
        ...
        extension_chains: Optional[
            pulumi.Input[Sequence[pulumi.Input[LbRouteExtensionExtensionChainArgs]]]
        ] = ...,
        forwarding_rules: Optional[
            pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
        ] = ...,
        labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
...
class LbRouteExtension(pulumi.CustomResource):
    ...
    def extension_chains(
        self,
    ) -> pulumi.Output[Sequence[outputs.LbRouteExtensionExtensionChain]]: ...
    @_builtins.property
    @pulumi.getter(name="forwardingRules")
