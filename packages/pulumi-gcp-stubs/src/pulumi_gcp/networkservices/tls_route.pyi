...
class _TlsRouteState:
    def __init__(
        ...
        *,
        ...
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
        rules: Optional[pulumi.Input[Sequence[pulumi.Input[TlsRouteRuleArgs]]]] = ...,
    ...
    def rules(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[TlsRouteRuleArgs]]]]: ...
    @rules.setter
    def rules(
        self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TlsRouteRuleArgs]]]]
    ): ...
    @_builtins.property
...
class TlsRoute(pulumi.CustomResource):
    ...
    def __init__(
        ...
        rules: Optional[
            pulumi.Input[
                Sequence[pulumi.Input[Union[TlsRouteRuleArgs, TlsRouteRuleArgsDict]]]
            ]
        ] = ...,
        __props__=...,
    ) -> None: ...
