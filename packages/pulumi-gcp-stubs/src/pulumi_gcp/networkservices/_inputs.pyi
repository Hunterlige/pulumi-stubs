...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AgentGatewayAgentGatewayCardArgs', 'AgentGatewayAgentGatewayCardArgsDict', 'AgentGatewayGoogleManagedArgs', 'AgentGatewayGoogleManagedArgsDict', 'AgentGatewayNetworkConfigArgs', 'AgentGatewayNetworkConfigArgsDict', 'AgentGatewayNetworkConfigEgressArgs', 'AgentGatewayNetworkConfigEgressArgsDict', 'AgentGatewaySelfManagedArgs', 'AgentGatewaySelfManagedArgsDict', 'EdgeCacheKeysetPublicKeyArgs', 'EdgeCacheKeysetPublicKeyArgsDict', 'EdgeCacheKeysetValidationSharedKeyArgs', 'EdgeCacheKeysetValidationSharedKeyArgsDict', 'EdgeCacheOriginAwsV4AuthenticationArgs', 'EdgeCacheOriginAwsV4AuthenticationArgsDict', 'EdgeCacheOriginFlexShieldingArgs', 'EdgeCacheOriginFlexShieldingArgsDict', 'EdgeCacheOriginOriginOverrideActionArgs', 'EdgeCacheOriginOriginOverrideActionArgsDict', ..., ..., ..., ..., 'EdgeCacheOriginOriginOverrideActionUrlRewriteArgs', ..., 'EdgeCacheOriginOriginRedirectArgs', 'EdgeCacheOriginOriginRedirectArgsDict', 'EdgeCacheOriginTimeoutArgs', 'EdgeCacheOriginTimeoutArgsDict', 'EdgeCacheServiceLogConfigArgs', 'EdgeCacheServiceLogConfigArgsDict', 'EdgeCacheServiceRoutingArgs', 'EdgeCacheServiceRoutingArgsDict', 'EdgeCacheServiceRoutingHostRuleArgs', 'EdgeCacheServiceRoutingHostRuleArgsDict', 'EdgeCacheServiceRoutingPathMatcherArgs', 'EdgeCacheServiceRoutingPathMatcherArgsDict', 'EdgeCacheServiceRoutingPathMatcherRouteRuleArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'EndpointPolicyEndpointMatcherArgs', 'EndpointPolicyEndpointMatcherArgsDict', ..., ..., ..., ..., 'EndpointPolicyTrafficPortSelectorArgs', 'EndpointPolicyTrafficPortSelectorArgsDict', 'GrpcRouteRuleArgs', 'GrpcRouteRuleArgsDict', 'GrpcRouteRuleActionArgs', 'GrpcRouteRuleActionArgsDict', 'GrpcRouteRuleActionDestinationArgs', 'GrpcRouteRuleActionDestinationArgsDict', 'GrpcRouteRuleActionFaultInjectionPolicyArgs', 'GrpcRouteRuleActionFaultInjectionPolicyArgsDict', 'GrpcRouteRuleActionFaultInjectionPolicyAbortArgs', ..., 'GrpcRouteRuleActionFaultInjectionPolicyDelayArgs', ..., 'GrpcRouteRuleActionRetryPolicyArgs', 'GrpcRouteRuleActionRetryPolicyArgsDict', 'GrpcRouteRuleMatchArgs', 'GrpcRouteRuleMatchArgsDict', 'GrpcRouteRuleMatchHeaderArgs', 'GrpcRouteRuleMatchHeaderArgsDict', 'GrpcRouteRuleMatchMethodArgs', 'GrpcRouteRuleMatchMethodArgsDict', 'HttpRouteRuleArgs', 'HttpRouteRuleArgsDict', 'HttpRouteRuleActionArgs', 'HttpRouteRuleActionArgsDict', 'HttpRouteRuleActionCorsPolicyArgs', 'HttpRouteRuleActionCorsPolicyArgsDict', 'HttpRouteRuleActionDestinationArgs', 'HttpRouteRuleActionDestinationArgsDict', 'HttpRouteRuleActionFaultInjectionPolicyArgs', 'HttpRouteRuleActionFaultInjectionPolicyArgsDict', 'HttpRouteRuleActionFaultInjectionPolicyAbortArgs', ..., 'HttpRouteRuleActionFaultInjectionPolicyDelayArgs', ..., 'HttpRouteRuleActionRedirectArgs', 'HttpRouteRuleActionRedirectArgsDict', 'HttpRouteRuleActionRequestHeaderModifierArgs', 'HttpRouteRuleActionRequestHeaderModifierArgsDict', 'HttpRouteRuleActionRequestMirrorPolicyArgs', 'HttpRouteRuleActionRequestMirrorPolicyArgsDict', ..., ..., 'HttpRouteRuleActionResponseHeaderModifierArgs', 'HttpRouteRuleActionResponseHeaderModifierArgsDict', 'HttpRouteRuleActionRetryPolicyArgs', 'HttpRouteRuleActionRetryPolicyArgsDict', 'HttpRouteRuleActionUrlRewriteArgs', 'HttpRouteRuleActionUrlRewriteArgsDict', 'HttpRouteRuleMatchArgs', 'HttpRouteRuleMatchArgsDict', 'HttpRouteRuleMatchHeaderArgs', 'HttpRouteRuleMatchHeaderArgsDict', 'HttpRouteRuleMatchHeaderRangeMatchArgs', 'HttpRouteRuleMatchHeaderRangeMatchArgsDict', 'HttpRouteRuleMatchQueryParameterArgs', 'HttpRouteRuleMatchQueryParameterArgsDict', 'LbEdgeExtensionExtensionChainArgs', 'LbEdgeExtensionExtensionChainArgsDict', 'LbEdgeExtensionExtensionChainExtensionArgs', 'LbEdgeExtensionExtensionChainExtensionArgsDict', 'LbEdgeExtensionExtensionChainMatchConditionArgs', ..., 'LbRouteExtensionExtensionChainArgs', 'LbRouteExtensionExtensionChainArgsDict', 'LbRouteExtensionExtensionChainExtensionArgs', 'LbRouteExtensionExtensionChainExtensionArgsDict', 'LbRouteExtensionExtensionChainMatchConditionArgs', ..., 'LbTrafficExtensionExtensionChainArgs', 'LbTrafficExtensionExtensionChainArgsDict', 'LbTrafficExtensionExtensionChainExtensionArgs', 'LbTrafficExtensionExtensionChainExtensionArgsDict', 'LbTrafficExtensionExtensionChainMatchConditionArgs', ..., 'MulticastConsumerAssociationStateArgs', 'MulticastConsumerAssociationStateArgsDict', 'MulticastDomainActivationStateArgs', 'MulticastDomainActivationStateArgsDict', 'MulticastDomainActivationTrafficSpecArgs', 'MulticastDomainActivationTrafficSpecArgsDict', 'MulticastDomainConnectionConfigArgs', 'MulticastDomainConnectionConfigArgsDict', 'MulticastDomainGroupStateArgs', 'MulticastDomainGroupStateArgsDict', 'MulticastDomainStateArgs', 'MulticastDomainStateArgsDict', 'MulticastDomainUllMulticastDomainArgs', 'MulticastDomainUllMulticastDomainArgsDict', 'MulticastGroupConsumerActivationLogConfigArgs', 'MulticastGroupConsumerActivationLogConfigArgsDict', 'MulticastGroupConsumerActivationStateArgs', 'MulticastGroupConsumerActivationStateArgsDict', 'MulticastGroupProducerActivationStateArgs', 'MulticastGroupProducerActivationStateArgsDict', 'MulticastGroupRangeActivationLogConfigArgs', 'MulticastGroupRangeActivationLogConfigArgsDict', 'MulticastGroupRangeActivationStateArgs', 'MulticastGroupRangeActivationStateArgsDict', 'MulticastGroupRangeLogConfigArgs', 'MulticastGroupRangeLogConfigArgsDict', 'MulticastGroupRangeStateArgs', 'MulticastGroupRangeStateArgsDict', 'MulticastProducerAssociationStateArgs', 'MulticastProducerAssociationStateArgsDict', 'ServiceLbPoliciesAutoCapacityDrainArgs', 'ServiceLbPoliciesAutoCapacityDrainArgsDict', 'ServiceLbPoliciesFailoverConfigArgs', 'ServiceLbPoliciesFailoverConfigArgsDict', 'ServiceLbPoliciesIsolationConfigArgs', 'ServiceLbPoliciesIsolationConfigArgsDict', 'TcpRouteRuleArgs', 'TcpRouteRuleArgsDict', 'TcpRouteRuleActionArgs', 'TcpRouteRuleActionArgsDict', 'TcpRouteRuleActionDestinationArgs', 'TcpRouteRuleActionDestinationArgsDict', 'TcpRouteRuleMatchArgs', 'TcpRouteRuleMatchArgsDict', 'TlsRouteRuleArgs', 'TlsRouteRuleArgsDict', 'TlsRouteRuleActionArgs', 'TlsRouteRuleActionArgsDict', 'TlsRouteRuleActionDestinationArgs', 'TlsRouteRuleActionDestinationArgsDict', 'TlsRouteRuleMatchArgs', 'TlsRouteRuleMatchArgsDict', 'WasmPluginLogConfigArgs', 'WasmPluginLogConfigArgsDict', 'WasmPluginUsedByArgs', 'WasmPluginUsedByArgsDict', 'WasmPluginVersionArgs', 'WasmPluginVersionArgsDict']
...
class AgentGatewayAgentGatewayCardArgs:
    def __init__(__self__, *, mtls_endpoint: Optional[pulumi.Input[_builtins.str]] = ..., root_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., service_extensions_service_account: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def mtls_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def root_certificates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def service_extensions_service_account(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AgentGatewayGoogleManagedArgs:
    def __init__(__self__, *, governed_access_path: pulumi.Input[_builtins.str]) -> None:
    ...
    def governed_access_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AgentGatewayNetworkConfigArgs:
    def __init__(__self__, *, egress: pulumi.Input[AgentGatewayNetworkConfigEgressArgs]) -> None:
    ...
    @egress.setter
    def egress(self, value: pulumi.Input[AgentGatewayNetworkConfigEgressArgs]): # -> None:
        ...
...
class EdgeCacheKeysetPublicKeyArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], managed: Optional[pulumi.Input[_builtins.bool]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EdgeCacheOriginAwsV4AuthenticationArgs:
    def __init__(__self__, *, access_key_id: pulumi.Input[_builtins.str], origin_region: pulumi.Input[_builtins.str], secret_access_key_version: pulumi.Input[_builtins.str]) -> None:
    ...
    def origin_region(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def secret_access_key_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class EdgeCacheOriginFlexShieldingArgs:
    def __init__(__self__, *, flex_shielding_regions: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def flex_shielding_regions(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EdgeCacheOriginOriginOverrideActionArgs:
    def __init__(__self__, *, header_action: Optional[pulumi.Input[EdgeCacheOriginOriginOverrideActionHeaderActionArgs]] = ..., url_rewrite: Optional[pulumi.Input[EdgeCacheOriginOriginOverrideActionUrlRewriteArgs]] = ...) -> None:
    ...
    def header_action(self, value: Optional[pulumi.Input[EdgeCacheOriginOriginOverrideActionHeaderActionArgs]]): # -> None:
        ...
    ...
    @url_rewrite.setter
    def url_rewrite(self, value: Optional[pulumi.Input[EdgeCacheOriginOriginOverrideActionUrlRewriteArgs]]): # -> None:
        ...
...
class EdgeCacheOriginOriginOverrideActionHeaderActionArgs:
    def __init__(__self__, *, request_headers_to_adds: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheOriginOriginOverrideActionHeaderActionRequestHeadersToAddArgs]]]] = ...) -> None:
    ...
    def request_headers_to_adds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheOriginOriginOverrideActionHeaderActionRequestHeadersToAddArgs]]]]): # -> None:
        ...
...
class EdgeCacheOriginOriginOverrideActionHeaderActionRequestHeadersToAddArgs:
    def __init__(__self__, *, header_name: pulumi.Input[_builtins.str], header_value: pulumi.Input[_builtins.str], replace: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @replace.setter
    def replace(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class EdgeCacheOriginOriginOverrideActionUrlRewriteArgs:
    def __init__(__self__, *, host_rewrite: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @host_rewrite.setter
    def host_rewrite(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EdgeCacheOriginOriginRedirectArgs:
    def __init__(__self__, *, redirect_conditions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def redirect_conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EdgeCacheOriginTimeoutArgs:
    def __init__(__self__, *, connect_timeout: Optional[pulumi.Input[_builtins.str]] = ..., max_attempts_timeout: Optional[pulumi.Input[_builtins.str]] = ..., read_timeout: Optional[pulumi.Input[_builtins.str]] = ..., response_timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def connect_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_attempts_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @read_timeout.setter
    def read_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def response_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EdgeCacheServiceLogConfigArgs:
    def __init__(__self__, *, enable: Optional[pulumi.Input[_builtins.bool]] = ..., sample_rate: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
...
class EdgeCacheServiceRoutingArgs:
    def __init__(__self__, *, host_rules: pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingHostRuleArgs]]], path_matchers: pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherArgs]]]) -> None:
    ...
    @host_rules.setter
    def host_rules(self, value: pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingHostRuleArgs]]]): # -> None:
        ...
    ...
    def path_matchers(self, value: pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherArgs]]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingHostRuleArgs:
    def __init__(__self__, *, hosts: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], path_matcher: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @path_matcher.setter
    def path_matcher(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], route_rules: pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleArgs]]], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @route_rules.setter
    def route_rules(self, value: pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleArgs]]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleArgs:
    def __init__(__self__, *, match_rules: pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleArgs]]], priority: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., header_action: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionArgs]] = ..., origin: Optional[pulumi.Input[_builtins.str]] = ..., route_action: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionArgs]] = ..., route_methods: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteMethodsArgs]] = ..., url_redirect: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleUrlRedirectArgs]] = ...) -> None:
    ...
    @match_rules.setter
    def match_rules(self, value: pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleArgs]]]): # -> None:
        ...
    ...
    @priority.setter
    def priority(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @header_action.setter
    def header_action(self, value: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionArgs]]): # -> None:
        ...
    ...
    @route_action.setter
    def route_action(self, value: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionArgs]]): # -> None:
        ...
    ...
    def route_methods(self, value: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteMethodsArgs]]): # -> None:
        ...
    ...
    @url_redirect.setter
    def url_redirect(self, value: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleUrlRedirectArgs]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionArgs:
    def __init__(__self__, *, request_header_to_adds: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAddArgs]]]] = ..., request_header_to_removes: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToRemoveArgs]]]] = ..., response_header_to_adds: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToAddArgs]]]] = ..., response_header_to_removes: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToRemoveArgs]]]] = ...) -> None:
    ...
    def request_header_to_adds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAddArgs]]]]): # -> None:
        ...
    ...
    def request_header_to_removes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToRemoveArgs]]]]): # -> None:
        ...
    ...
    def response_header_to_adds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToAddArgs]]]]): # -> None:
        ...
    ...
    def response_header_to_removes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToRemoveArgs]]]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleArgs:
    def __init__(__self__, *, full_path_match: Optional[pulumi.Input[_builtins.str]] = ..., header_matches: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatchArgs]]]] = ..., ignore_case: Optional[pulumi.Input[_builtins.bool]] = ..., path_template_match: Optional[pulumi.Input[_builtins.str]] = ..., prefix_match: Optional[pulumi.Input[_builtins.str]] = ..., query_parameter_matches: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleQueryParameterMatchArgs]]]] = ...) -> None:
    ...
    def full_path_match(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def header_matches(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatchArgs]]]]): # -> None:
        ...
    ...
    def path_template_match(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def query_parameter_matches(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleQueryParameterMatchArgs]]]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatchArgs:
    def __init__(__self__, *, header_name: pulumi.Input[_builtins.str], exact_match: Optional[pulumi.Input[_builtins.str]] = ..., invert_match: Optional[pulumi.Input[_builtins.bool]] = ..., prefix_match: Optional[pulumi.Input[_builtins.str]] = ..., present_match: Optional[pulumi.Input[_builtins.bool]] = ..., suffix_match: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @invert_match.setter
    def invert_match(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def present_match(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleQueryParameterMatchArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], exact_match: Optional[pulumi.Input[_builtins.str]] = ..., present_match: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionArgs:
    def __init__(__self__, *, cdn_policy: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyArgs]] = ..., compression_mode: Optional[pulumi.Input[_builtins.str]] = ..., cors_policy: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCorsPolicyArgs]] = ..., url_rewrite: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionUrlRewriteArgs]] = ...) -> None:
    ...
    @cdn_policy.setter
    def cdn_policy(self, value: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyArgs]]): # -> None:
        ...
    ...
    def compression_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @cors_policy.setter
    def cors_policy(self, value: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCorsPolicyArgs]]): # -> None:
        ...
    ...
    @url_rewrite.setter
    def url_rewrite(self, value: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionUrlRewriteArgs]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyArgs:
    def __init__(__self__, *, add_signatures: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignaturesArgs]] = ..., cache_key_policy: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyCacheKeyPolicyArgs]] = ..., cache_mode: Optional[pulumi.Input[_builtins.str]] = ..., client_ttl: Optional[pulumi.Input[_builtins.str]] = ..., default_ttl: Optional[pulumi.Input[_builtins.str]] = ..., max_ttl: Optional[pulumi.Input[_builtins.str]] = ..., negative_caching: Optional[pulumi.Input[_builtins.bool]] = ..., negative_caching_policy: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., signed_request_keyset: Optional[pulumi.Input[_builtins.str]] = ..., signed_request_maximum_expiration_ttl: Optional[pulumi.Input[_builtins.str]] = ..., signed_request_mode: Optional[pulumi.Input[_builtins.str]] = ..., signed_token_options: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicySignedTokenOptionsArgs]] = ...) -> None:
    ...
    def add_signatures(self, value: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignaturesArgs]]): # -> None:
        ...
    ...
    def cache_key_policy(self, value: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyCacheKeyPolicyArgs]]): # -> None:
        ...
    ...
    @cache_mode.setter
    def cache_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @client_ttl.setter
    def client_ttl(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @default_ttl.setter
    def default_ttl(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @max_ttl.setter
    def max_ttl(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def negative_caching(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def negative_caching_policy(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def signed_request_keyset(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def signed_request_maximum_expiration_ttl(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def signed_request_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def signed_token_options(self, value: Optional[pulumi.Input[EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicySignedTokenOptionsArgs]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignaturesArgs:
    def __init__(__self__, *, actions: pulumi.Input[_builtins.str], copied_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., keyset: Optional[pulumi.Input[_builtins.str]] = ..., token_query_parameter: Optional[pulumi.Input[_builtins.str]] = ..., token_ttl: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def copied_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @keyset.setter
    def keyset(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def token_query_parameter(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyCacheKeyPolicyArgs:
    def __init__(__self__, *, exclude_host: Optional[pulumi.Input[_builtins.bool]] = ..., exclude_query_string: Optional[pulumi.Input[_builtins.bool]] = ..., excluded_query_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., include_protocol: Optional[pulumi.Input[_builtins.bool]] = ..., included_cookie_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., included_header_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., included_query_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @exclude_host.setter
    def exclude_host(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def exclude_query_string(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def excluded_query_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def include_protocol(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def included_cookie_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def included_header_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def included_query_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicySignedTokenOptionsArgs:
    def __init__(__self__, *, allowed_signature_algorithms: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., token_query_parameter: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allowed_signature_algorithms(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCorsPolicyArgs:
    def __init__(__self__, *, max_age: pulumi.Input[_builtins.str], allow_credentials: Optional[pulumi.Input[_builtins.bool]] = ..., allow_headers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allow_methods: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allow_origins: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., expose_headers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionUrlRewriteArgs:
    def __init__(__self__, *, host_rewrite: Optional[pulumi.Input[_builtins.str]] = ..., path_prefix_rewrite: Optional[pulumi.Input[_builtins.str]] = ..., path_template_rewrite: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def path_prefix_rewrite(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def path_template_rewrite(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteMethodsArgs:
    def __init__(__self__, *, allowed_methods: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleUrlRedirectArgs:
    def __init__(__self__, *, host_redirect: Optional[pulumi.Input[_builtins.str]] = ..., https_redirect: Optional[pulumi.Input[_builtins.bool]] = ..., path_redirect: Optional[pulumi.Input[_builtins.str]] = ..., prefix_redirect: Optional[pulumi.Input[_builtins.str]] = ..., redirect_response_code: Optional[pulumi.Input[_builtins.str]] = ..., strip_query: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def host_redirect(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def https_redirect(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def path_redirect(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def prefix_redirect(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def redirect_response_code(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @strip_query.setter
    def strip_query(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class EndpointPolicyEndpointMatcherArgs:
    def __init__(__self__, *, metadata_label_matcher: pulumi.Input[EndpointPolicyEndpointMatcherMetadataLabelMatcherArgs]) -> None:
    ...
    def metadata_label_matcher(self, value: pulumi.Input[EndpointPolicyEndpointMatcherMetadataLabelMatcherArgs]): # -> None:
        ...
...
class EndpointPolicyEndpointMatcherMetadataLabelMatcherArgs:
    def __init__(__self__, *, metadata_label_match_criteria: pulumi.Input[_builtins.str], metadata_labels: Optional[pulumi.Input[Sequence[pulumi.Input[EndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabelArgs]]]] = ...) -> None:
    ...
    def metadata_label_match_criteria(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def metadata_labels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabelArgs]]]]): # -> None:
        ...
...
class EndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabelArgs:
    def __init__(__self__, *, label_name: pulumi.Input[_builtins.str], label_value: pulumi.Input[_builtins.str]) -> None:
...
class EndpointPolicyTrafficPortSelectorArgs:
    def __init__(__self__, *, ports: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
...
class GrpcRouteRuleArgs:
    def __init__(__self__, *, action: Optional[pulumi.Input[GrpcRouteRuleActionArgs]] = ..., matches: Optional[pulumi.Input[Sequence[pulumi.Input[GrpcRouteRuleMatchArgs]]]] = ...) -> None:
    ...
    @action.setter
    def action(self, value: Optional[pulumi.Input[GrpcRouteRuleActionArgs]]): # -> None:
        ...
    ...
    @matches.setter
    def matches(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[GrpcRouteRuleMatchArgs]]]]): # -> None:
        ...
...
class GrpcRouteRuleActionArgs:
    def __init__(__self__, *, destinations: Optional[pulumi.Input[Sequence[pulumi.Input[GrpcRouteRuleActionDestinationArgs]]]] = ..., fault_injection_policy: Optional[pulumi.Input[GrpcRouteRuleActionFaultInjectionPolicyArgs]] = ..., retry_policy: Optional[pulumi.Input[GrpcRouteRuleActionRetryPolicyArgs]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @destinations.setter
    def destinations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[GrpcRouteRuleActionDestinationArgs]]]]): # -> None:
        ...
    ...
    def fault_injection_policy(self, value: Optional[pulumi.Input[GrpcRouteRuleActionFaultInjectionPolicyArgs]]): # -> None:
        ...
    ...
    @retry_policy.setter
    def retry_policy(self, value: Optional[pulumi.Input[GrpcRouteRuleActionRetryPolicyArgs]]): # -> None:
        ...
...
class GrpcRouteRuleActionDestinationArgs:
    def __init__(__self__, *, service_name: Optional[pulumi.Input[_builtins.str]] = ..., weight: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class GrpcRouteRuleActionFaultInjectionPolicyArgs:
    def __init__(__self__, *, abort: Optional[pulumi.Input[GrpcRouteRuleActionFaultInjectionPolicyAbortArgs]] = ..., delay: Optional[pulumi.Input[GrpcRouteRuleActionFaultInjectionPolicyDelayArgs]] = ...) -> None:
    ...
    @abort.setter
    def abort(self, value: Optional[pulumi.Input[GrpcRouteRuleActionFaultInjectionPolicyAbortArgs]]): # -> None:
        ...
    ...
    @delay.setter
    def delay(self, value: Optional[pulumi.Input[GrpcRouteRuleActionFaultInjectionPolicyDelayArgs]]): # -> None:
        ...
...
class GrpcRouteRuleActionFaultInjectionPolicyAbortArgs:
    def __init__(__self__, *, http_status: Optional[pulumi.Input[_builtins.int]] = ..., percentage: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @http_status.setter
    def http_status(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class GrpcRouteRuleActionFaultInjectionPolicyDelayArgs:
    def __init__(__self__, *, fixed_delay: Optional[pulumi.Input[_builtins.str]] = ..., percentage: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @fixed_delay.setter
    def fixed_delay(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GrpcRouteRuleActionRetryPolicyArgs:
    def __init__(__self__, *, num_retries: Optional[pulumi.Input[_builtins.int]] = ..., retry_conditions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def retry_conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class GrpcRouteRuleMatchArgs:
    def __init__(__self__, *, headers: Optional[pulumi.Input[Sequence[pulumi.Input[GrpcRouteRuleMatchHeaderArgs]]]] = ..., method: Optional[pulumi.Input[GrpcRouteRuleMatchMethodArgs]] = ...) -> None:
    ...
    @headers.setter
    def headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[GrpcRouteRuleMatchHeaderArgs]]]]): # -> None:
        ...
    ...
    @method.setter
    def method(self, value: Optional[pulumi.Input[GrpcRouteRuleMatchMethodArgs]]): # -> None:
        ...
...
class GrpcRouteRuleMatchHeaderArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], value: pulumi.Input[_builtins.str], type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class GrpcRouteRuleMatchMethodArgs:
    def __init__(__self__, *, grpc_method: pulumi.Input[_builtins.str], grpc_service: pulumi.Input[_builtins.str], case_sensitive: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @grpc_method.setter
    def grpc_method(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @grpc_service.setter
    def grpc_service(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class HttpRouteRuleArgs:
    def __init__(__self__, *, action: Optional[pulumi.Input[HttpRouteRuleActionArgs]] = ..., matches: Optional[pulumi.Input[Sequence[pulumi.Input[HttpRouteRuleMatchArgs]]]] = ...) -> None:
    ...
    @action.setter
    def action(self, value: Optional[pulumi.Input[HttpRouteRuleActionArgs]]): # -> None:
        ...
    ...
    @matches.setter
    def matches(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HttpRouteRuleMatchArgs]]]]): # -> None:
        ...
...
class HttpRouteRuleActionArgs:
    def __init__(__self__, *, cors_policy: Optional[pulumi.Input[HttpRouteRuleActionCorsPolicyArgs]] = ..., destinations: Optional[pulumi.Input[Sequence[pulumi.Input[HttpRouteRuleActionDestinationArgs]]]] = ..., fault_injection_policy: Optional[pulumi.Input[HttpRouteRuleActionFaultInjectionPolicyArgs]] = ..., redirect: Optional[pulumi.Input[HttpRouteRuleActionRedirectArgs]] = ..., request_header_modifier: Optional[pulumi.Input[HttpRouteRuleActionRequestHeaderModifierArgs]] = ..., request_mirror_policy: Optional[pulumi.Input[HttpRouteRuleActionRequestMirrorPolicyArgs]] = ..., response_header_modifier: Optional[pulumi.Input[HttpRouteRuleActionResponseHeaderModifierArgs]] = ..., retry_policy: Optional[pulumi.Input[HttpRouteRuleActionRetryPolicyArgs]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ..., url_rewrite: Optional[pulumi.Input[HttpRouteRuleActionUrlRewriteArgs]] = ...) -> None:
    ...
    @cors_policy.setter
    def cors_policy(self, value: Optional[pulumi.Input[HttpRouteRuleActionCorsPolicyArgs]]): # -> None:
        ...
    ...
    @destinations.setter
    def destinations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HttpRouteRuleActionDestinationArgs]]]]): # -> None:
        ...
    ...
    @fault_injection_policy.setter
    def fault_injection_policy(self, value: Optional[pulumi.Input[HttpRouteRuleActionFaultInjectionPolicyArgs]]): # -> None:
        ...
    ...
    @redirect.setter
    def redirect(self, value: Optional[pulumi.Input[HttpRouteRuleActionRedirectArgs]]): # -> None:
        ...
    ...
    def request_header_modifier(self, value: Optional[pulumi.Input[HttpRouteRuleActionRequestHeaderModifierArgs]]): # -> None:
        ...
    ...
    def request_mirror_policy(self, value: Optional[pulumi.Input[HttpRouteRuleActionRequestMirrorPolicyArgs]]): # -> None:
        ...
    ...
    def response_header_modifier(self, value: Optional[pulumi.Input[HttpRouteRuleActionResponseHeaderModifierArgs]]): # -> None:
        ...
    ...
    @retry_policy.setter
    def retry_policy(self, value: Optional[pulumi.Input[HttpRouteRuleActionRetryPolicyArgs]]): # -> None:
        ...
    ...
    @url_rewrite.setter
    def url_rewrite(self, value: Optional[pulumi.Input[HttpRouteRuleActionUrlRewriteArgs]]): # -> None:
        ...
...
class HttpRouteRuleActionCorsPolicyArgs:
    def __init__(__self__, *, allow_credentials: Optional[pulumi.Input[_builtins.bool]] = ..., allow_headers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allow_methods: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allow_origin_regexes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., allow_origins: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., expose_headers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., max_age: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allow_origin_regexes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @max_age.setter
    def max_age(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class HttpRouteRuleActionFaultInjectionPolicyArgs:
    def __init__(__self__, *, abort: Optional[pulumi.Input[HttpRouteRuleActionFaultInjectionPolicyAbortArgs]] = ..., delay: Optional[pulumi.Input[HttpRouteRuleActionFaultInjectionPolicyDelayArgs]] = ...) -> None:
    ...
    @abort.setter
    def abort(self, value: Optional[pulumi.Input[HttpRouteRuleActionFaultInjectionPolicyAbortArgs]]): # -> None:
        ...
    ...
    @delay.setter
    def delay(self, value: Optional[pulumi.Input[HttpRouteRuleActionFaultInjectionPolicyDelayArgs]]): # -> None:
        ...
...
class HttpRouteRuleActionRedirectArgs:
    def __init__(__self__, *, host_redirect: Optional[pulumi.Input[_builtins.str]] = ..., https_redirect: Optional[pulumi.Input[_builtins.bool]] = ..., path_redirect: Optional[pulumi.Input[_builtins.str]] = ..., port_redirect: Optional[pulumi.Input[_builtins.int]] = ..., prefix_rewrite: Optional[pulumi.Input[_builtins.str]] = ..., response_code: Optional[pulumi.Input[_builtins.str]] = ..., strip_query: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def port_redirect(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class HttpRouteRuleActionRequestHeaderModifierArgs:
    def __init__(__self__, *, add: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., removes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., set: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @add.setter
    def add(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @removes.setter
    def removes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @set.setter
    def set(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class HttpRouteRuleActionRequestMirrorPolicyArgs:
    def __init__(__self__, *, destination: Optional[pulumi.Input[HttpRouteRuleActionRequestMirrorPolicyDestinationArgs]] = ...) -> None:
    ...
    @destination.setter
    def destination(self, value: Optional[pulumi.Input[HttpRouteRuleActionRequestMirrorPolicyDestinationArgs]]): # -> None:
        ...
...
class HttpRouteRuleActionRetryPolicyArgs:
    def __init__(__self__, *, num_retries: Optional[pulumi.Input[_builtins.int]] = ..., per_try_timeout: Optional[pulumi.Input[_builtins.str]] = ..., retry_conditions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def per_try_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class HttpRouteRuleActionUrlRewriteArgs:
    def __init__(__self__, *, host_rewrite: Optional[pulumi.Input[_builtins.str]] = ..., path_prefix_rewrite: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class HttpRouteRuleMatchArgs:
    def __init__(__self__, *, full_path_match: Optional[pulumi.Input[_builtins.str]] = ..., headers: Optional[pulumi.Input[Sequence[pulumi.Input[HttpRouteRuleMatchHeaderArgs]]]] = ..., ignore_case: Optional[pulumi.Input[_builtins.bool]] = ..., prefix_match: Optional[pulumi.Input[_builtins.str]] = ..., query_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[HttpRouteRuleMatchQueryParameterArgs]]]] = ..., regex_match: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @headers.setter
    def headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HttpRouteRuleMatchHeaderArgs]]]]): # -> None:
        ...
    ...
    def query_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HttpRouteRuleMatchQueryParameterArgs]]]]): # -> None:
        ...
...
class HttpRouteRuleMatchHeaderArgs:
    def __init__(__self__, *, exact_match: Optional[pulumi.Input[_builtins.str]] = ..., header: Optional[pulumi.Input[_builtins.str]] = ..., invert_match: Optional[pulumi.Input[_builtins.bool]] = ..., prefix_match: Optional[pulumi.Input[_builtins.str]] = ..., present_match: Optional[pulumi.Input[_builtins.bool]] = ..., range_match: Optional[pulumi.Input[HttpRouteRuleMatchHeaderRangeMatchArgs]] = ..., regex_match: Optional[pulumi.Input[_builtins.str]] = ..., suffix_match: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @range_match.setter
    def range_match(self, value: Optional[pulumi.Input[HttpRouteRuleMatchHeaderRangeMatchArgs]]): # -> None:
        ...
...
class HttpRouteRuleMatchQueryParameterArgs:
    def __init__(__self__, *, exact_match: Optional[pulumi.Input[_builtins.str]] = ..., present_match: Optional[pulumi.Input[_builtins.bool]] = ..., query_parameter: Optional[pulumi.Input[_builtins.str]] = ..., regex_match: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def query_parameter(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LbEdgeExtensionExtensionChainArgs:
    def __init__(__self__, *, extensions: pulumi.Input[Sequence[pulumi.Input[LbEdgeExtensionExtensionChainExtensionArgs]]], match_condition: pulumi.Input[LbEdgeExtensionExtensionChainMatchConditionArgs], name: pulumi.Input[_builtins.str]) -> None:
    ...
    @extensions.setter
    def extensions(self, value: pulumi.Input[Sequence[pulumi.Input[LbEdgeExtensionExtensionChainExtensionArgs]]]): # -> None:
        ...
    ...
    def match_condition(self, value: pulumi.Input[LbEdgeExtensionExtensionChainMatchConditionArgs]): # -> None:
        ...
...
class LbEdgeExtensionExtensionChainExtensionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], service: pulumi.Input[_builtins.str], fail_open: Optional[pulumi.Input[_builtins.bool]] = ..., forward_headers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., supported_events: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def forward_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def supported_events(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class LbEdgeExtensionExtensionChainMatchConditionArgs:
    ...
    def cel_expression(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class LbRouteExtensionExtensionChainArgs:
    def __init__(__self__, *, extensions: pulumi.Input[Sequence[pulumi.Input[LbRouteExtensionExtensionChainExtensionArgs]]], match_condition: pulumi.Input[LbRouteExtensionExtensionChainMatchConditionArgs], name: pulumi.Input[_builtins.str]) -> None:
    ...
    @extensions.setter
    def extensions(self, value: pulumi.Input[Sequence[pulumi.Input[LbRouteExtensionExtensionChainExtensionArgs]]]): # -> None:
        ...
    ...
    @match_condition.setter
    def match_condition(self, value: pulumi.Input[LbRouteExtensionExtensionChainMatchConditionArgs]): # -> None:
        ...
...
class LbRouteExtensionExtensionChainExtensionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], service: pulumi.Input[_builtins.str], authority: Optional[pulumi.Input[_builtins.str]] = ..., fail_open: Optional[pulumi.Input[_builtins.bool]] = ..., forward_headers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., observability_mode: Optional[pulumi.Input[_builtins.bool]] = ..., request_body_send_mode: Optional[pulumi.Input[_builtins.str]] = ..., supported_events: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def observability_mode(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def request_body_send_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class LbTrafficExtensionExtensionChainArgs:
    def __init__(__self__, *, extensions: pulumi.Input[Sequence[pulumi.Input[LbTrafficExtensionExtensionChainExtensionArgs]]], match_condition: pulumi.Input[LbTrafficExtensionExtensionChainMatchConditionArgs], name: pulumi.Input[_builtins.str]) -> None:
    ...
    @extensions.setter
    def extensions(self, value: pulumi.Input[Sequence[pulumi.Input[LbTrafficExtensionExtensionChainExtensionArgs]]]): # -> None:
        ...
    ...
    @match_condition.setter
    def match_condition(self, value: pulumi.Input[LbTrafficExtensionExtensionChainMatchConditionArgs]): # -> None:
        ...
...
class LbTrafficExtensionExtensionChainExtensionArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], service: pulumi.Input[_builtins.str], authority: Optional[pulumi.Input[_builtins.str]] = ..., fail_open: Optional[pulumi.Input[_builtins.bool]] = ..., forward_headers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., supported_events: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MulticastConsumerAssociationStateArgs:
    def __init__(__self__, *, state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MulticastDomainActivationTrafficSpecArgs:
    def __init__(__self__, *, aggr_egress_pps: Optional[pulumi.Input[_builtins.str]] = ..., aggr_ingress_pps: Optional[pulumi.Input[_builtins.str]] = ..., avg_packet_size: Optional[pulumi.Input[_builtins.int]] = ..., max_per_group_ingress_pps: Optional[pulumi.Input[_builtins.str]] = ..., max_per_group_subscribers: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def aggr_egress_pps(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def aggr_ingress_pps(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def avg_packet_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_per_group_ingress_pps(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_per_group_subscribers(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MulticastDomainConnectionConfigArgs:
    def __init__(__self__, *, connection_type: pulumi.Input[_builtins.str], ncc_hub: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ncc_hub.setter
    def ncc_hub(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MulticastDomainUllMulticastDomainArgs:
    def __init__(__self__, *, preconfigured_ull_domain: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def preconfigured_ull_domain(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceLbPoliciesFailoverConfigArgs:
    def __init__(__self__, *, failover_health_threshold: pulumi.Input[_builtins.int]) -> None:
    ...
    def failover_health_threshold(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ServiceLbPoliciesIsolationConfigArgs:
    def __init__(__self__, *, isolation_granularity: Optional[pulumi.Input[_builtins.str]] = ..., isolation_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def isolation_granularity(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def isolation_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TcpRouteRuleArgs:
    def __init__(__self__, *, action: pulumi.Input[TcpRouteRuleActionArgs], matches: Optional[pulumi.Input[Sequence[pulumi.Input[TcpRouteRuleMatchArgs]]]] = ...) -> None:
    ...
    @action.setter
    def action(self, value: pulumi.Input[TcpRouteRuleActionArgs]): # -> None:
        ...
    ...
    @matches.setter
    def matches(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TcpRouteRuleMatchArgs]]]]): # -> None:
        ...
...
class TcpRouteRuleActionArgs:
    def __init__(__self__, *, destinations: Optional[pulumi.Input[Sequence[pulumi.Input[TcpRouteRuleActionDestinationArgs]]]] = ..., idle_timeout: Optional[pulumi.Input[_builtins.str]] = ..., original_destination: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @destinations.setter
    def destinations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TcpRouteRuleActionDestinationArgs]]]]): # -> None:
        ...
    ...
    def original_destination(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class TcpRouteRuleMatchArgs:
    def __init__(__self__, *, address: pulumi.Input[_builtins.str], port: pulumi.Input[_builtins.str]) -> None:
...
class TlsRouteRuleArgs:
    def __init__(__self__, *, action: pulumi.Input[TlsRouteRuleActionArgs], matches: pulumi.Input[Sequence[pulumi.Input[TlsRouteRuleMatchArgs]]]) -> None:
    ...
    @action.setter
    def action(self, value: pulumi.Input[TlsRouteRuleActionArgs]): # -> None:
        ...
    ...
    @matches.setter
    def matches(self, value: pulumi.Input[Sequence[pulumi.Input[TlsRouteRuleMatchArgs]]]): # -> None:
        ...
...
class TlsRouteRuleActionArgs:
    def __init__(__self__, *, destinations: Optional[pulumi.Input[Sequence[pulumi.Input[TlsRouteRuleActionDestinationArgs]]]] = ...) -> None:
    ...
    @destinations.setter
    def destinations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TlsRouteRuleActionDestinationArgs]]]]): # -> None:
        ...
...
class TlsRouteRuleMatchArgs:
    def __init__(__self__, *, alpns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., sni_hosts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @alpns.setter
    def alpns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @sni_hosts.setter
    def sni_hosts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class WasmPluginLogConfigArgs:
    def __init__(__self__, *, enable: Optional[pulumi.Input[_builtins.bool]] = ..., min_log_level: Optional[pulumi.Input[_builtins.str]] = ..., sample_rate: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def min_log_level(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WasmPluginVersionArgs:
    def __init__(__self__, *, version_name: pulumi.Input[_builtins.str], create_time: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., image_digest: Optional[pulumi.Input[_builtins.str]] = ..., image_uri: Optional[pulumi.Input[_builtins.str]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., plugin_config_data: Optional[pulumi.Input[_builtins.str]] = ..., plugin_config_digest: Optional[pulumi.Input[_builtins.str]] = ..., plugin_config_uri: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @image_digest.setter
    def image_digest(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def plugin_config_data(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def plugin_config_digest(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def plugin_config_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
