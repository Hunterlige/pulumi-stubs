...
class _TcpRouteState:
    def __init__(
        ...
        *,
        ...
        rules: Optional[pulumi.Input[Sequence[pulumi.Input[TcpRouteRuleArgs]]]] = ...,
    ...
    def rules(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[TcpRouteRuleArgs]]]]: ...
    @rules.setter
    def rules(
        self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TcpRouteRuleArgs]]]]
    ): ...
    @_builtins.property
...
class TcpRoute(pulumi.CustomResource):
    ...
    def __init__(
        ...
        rules: Optional[
            pulumi.Input[
                Sequence[pulumi.Input[Union[TcpRouteRuleArgs, TcpRouteRuleArgsDict]]]
            ]
        ] = ...,
        __props__=...,
    ) -> None: ...
