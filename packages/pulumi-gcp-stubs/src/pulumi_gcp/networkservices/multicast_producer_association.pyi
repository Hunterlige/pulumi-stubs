...
class _MulticastProducerAssociationState:
    def __init__(
        ...
        *,
        ...
        multicast_producer_association_id: Optional[pulumi.Input[_builtins.str]] = ...,
        ...
        states: Optional[
            pulumi.Input[Sequence[pulumi.Input[MulticastProducerAssociationStateArgs]]]
        ] = ...,
    ...
    @_builtins.property
    @pulumi.getter(name="multicastProducerAssociationId")
    def multicast_producer_association_id(
        self,
...
class MulticastProducerAssociation(pulumi.CustomResource):
    ...
    def states(
        self,
    ) -> pulumi.Output[Sequence[outputs.MulticastProducerAssociationState]]: ...
    @_builtins.property
    @pulumi.getter(name="uniqueId")
