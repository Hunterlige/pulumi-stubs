...
class LbEdgeExtensionArgs:
    def __init__(
        ...
        *,
        extension_chains: pulumi.Input[
            Sequence[pulumi.Input[LbEdgeExtensionExtensionChainArgs]]
        ],
    ...
    def extension_chains(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input[LbEdgeExtensionExtensionChainArgs]]]: ...
    @extension_chains.setter
    def extension_chains(
        self,
        value: pulumi.Input[Sequence[pulumi.Input[LbEdgeExtensionExtensionChainArgs]]],
    ): ...
    @_builtins.property
...
class LbEdgeExtension(pulumi.CustomResource):
    ...
    def extension_chains(
        self,
    ) -> pulumi.Output[Sequence[outputs.LbEdgeExtensionExtensionChain]]: ...
    @_builtins.property
    @pulumi.getter(name="forwardingRules")
