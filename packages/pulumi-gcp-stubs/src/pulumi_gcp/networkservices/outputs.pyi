...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AgentGatewayAgentGatewayCard', 'AgentGatewayGoogleManaged', 'AgentGatewayNetworkConfig', 'AgentGatewayNetworkConfigEgress', 'AgentGatewaySelfManaged', 'EdgeCacheKeysetPublicKey', 'EdgeCacheKeysetValidationSharedKey', 'EdgeCacheOriginAwsV4Authentication', 'EdgeCacheOriginFlexShielding', 'EdgeCacheOriginOriginOverrideAction', 'EdgeCacheOriginOriginOverrideActionHeaderAction', ..., 'EdgeCacheOriginOriginOverrideActionUrlRewrite', 'EdgeCacheOriginOriginRedirect', 'EdgeCacheOriginTimeout', 'EdgeCacheServiceLogConfig', 'EdgeCacheServiceRouting', 'EdgeCacheServiceRoutingHostRule', 'EdgeCacheServiceRoutingPathMatcher', 'EdgeCacheServiceRoutingPathMatcherRouteRule', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'EndpointPolicyEndpointMatcher', 'EndpointPolicyEndpointMatcherMetadataLabelMatcher', ..., 'EndpointPolicyTrafficPortSelector', 'GrpcRouteRule', 'GrpcRouteRuleAction', 'GrpcRouteRuleActionDestination', 'GrpcRouteRuleActionFaultInjectionPolicy', 'GrpcRouteRuleActionFaultInjectionPolicyAbort', 'GrpcRouteRuleActionFaultInjectionPolicyDelay', 'GrpcRouteRuleActionRetryPolicy', 'GrpcRouteRuleMatch', 'GrpcRouteRuleMatchHeader', 'GrpcRouteRuleMatchMethod', 'HttpRouteRule', 'HttpRouteRuleAction', 'HttpRouteRuleActionCorsPolicy', 'HttpRouteRuleActionDestination', 'HttpRouteRuleActionFaultInjectionPolicy', 'HttpRouteRuleActionFaultInjectionPolicyAbort', 'HttpRouteRuleActionFaultInjectionPolicyDelay', 'HttpRouteRuleActionRedirect', 'HttpRouteRuleActionRequestHeaderModifier', 'HttpRouteRuleActionRequestMirrorPolicy', 'HttpRouteRuleActionRequestMirrorPolicyDestination', 'HttpRouteRuleActionResponseHeaderModifier', 'HttpRouteRuleActionRetryPolicy', 'HttpRouteRuleActionUrlRewrite', 'HttpRouteRuleMatch', 'HttpRouteRuleMatchHeader', 'HttpRouteRuleMatchHeaderRangeMatch', 'HttpRouteRuleMatchQueryParameter', 'LbEdgeExtensionExtensionChain', 'LbEdgeExtensionExtensionChainExtension', 'LbEdgeExtensionExtensionChainMatchCondition', 'LbRouteExtensionExtensionChain', 'LbRouteExtensionExtensionChainExtension', 'LbRouteExtensionExtensionChainMatchCondition', 'LbTrafficExtensionExtensionChain', 'LbTrafficExtensionExtensionChainExtension', 'LbTrafficExtensionExtensionChainMatchCondition', 'MulticastConsumerAssociationState', 'MulticastDomainActivationState', 'MulticastDomainActivationTrafficSpec', 'MulticastDomainConnectionConfig', 'MulticastDomainGroupState', 'MulticastDomainState', 'MulticastDomainUllMulticastDomain', 'MulticastGroupConsumerActivationLogConfig', 'MulticastGroupConsumerActivationState', 'MulticastGroupProducerActivationState', 'MulticastGroupRangeActivationLogConfig', 'MulticastGroupRangeActivationState', 'MulticastGroupRangeLogConfig', 'MulticastGroupRangeState', 'MulticastProducerAssociationState', 'ServiceLbPoliciesAutoCapacityDrain', 'ServiceLbPoliciesFailoverConfig', 'ServiceLbPoliciesIsolationConfig', 'TcpRouteRule', 'TcpRouteRuleAction', 'TcpRouteRuleActionDestination', 'TcpRouteRuleMatch', 'TlsRouteRule', 'TlsRouteRuleAction', 'TlsRouteRuleActionDestination', 'TlsRouteRuleMatch', 'WasmPluginLogConfig', 'WasmPluginUsedBy', 'WasmPluginVersion']
@pulumi.output_type
class AgentGatewayAgentGatewayCard(dict):
    ...
    def __init__(__self__, *, mtls_endpoint: Optional[_builtins.str] = ..., root_certificates: Optional[Sequence[_builtins.str]] = ..., service_extensions_service_account: Optional[_builtins.str] = ...) -> None:
...
class AgentGatewayNetworkConfig(dict):
    def __init__(__self__, *, egress: outputs.AgentGatewayNetworkConfigEgress) -> None:
...
class EdgeCacheKeysetPublicKey(dict):
    def __init__(__self__, *, id: _builtins.str, managed: Optional[_builtins.bool] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class EdgeCacheOriginAwsV4Authentication(dict):
    ...
    def __init__(__self__, *, access_key_id: _builtins.str, origin_region: _builtins.str, secret_access_key_version: _builtins.str) -> None:
...
class EdgeCacheOriginFlexShielding(dict):
    ...
    def __init__(__self__, *, flex_shielding_regions: Optional[_builtins.str] = ...) -> None:
...
class EdgeCacheOriginOriginOverrideAction(dict):
    ...
    def __init__(__self__, *, header_action: Optional[outputs.EdgeCacheOriginOriginOverrideActionHeaderAction] = ..., url_rewrite: Optional[outputs.EdgeCacheOriginOriginOverrideActionUrlRewrite] = ...) -> None:
...
class EdgeCacheOriginOriginOverrideActionHeaderAction(dict):
    ...
    def __init__(__self__, *, request_headers_to_adds: Optional[Sequence[outputs.EdgeCacheOriginOriginOverrideActionHeaderActionRequestHeadersToAdd]] = ...) -> None:
...
class EdgeCacheOriginOriginOverrideActionHeaderActionRequestHeadersToAdd(dict):
    ...
    def __init__(__self__, *, header_name: _builtins.str, header_value: _builtins.str, replace: Optional[_builtins.bool] = ...) -> None:
...
class EdgeCacheOriginOriginRedirect(dict):
    ...
    def __init__(__self__, *, redirect_conditions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class EdgeCacheOriginTimeout(dict):
    ...
    def __init__(__self__, *, connect_timeout: Optional[_builtins.str] = ..., max_attempts_timeout: Optional[_builtins.str] = ..., read_timeout: Optional[_builtins.str] = ..., response_timeout: Optional[_builtins.str] = ...) -> None:
...
class EdgeCacheServiceLogConfig(dict):
    ...
    def __init__(__self__, *, enable: Optional[_builtins.bool] = ..., sample_rate: Optional[_builtins.float] = ...) -> None:
...
class EdgeCacheServiceRouting(dict):
    ...
    def __init__(__self__, *, host_rules: Sequence[outputs.EdgeCacheServiceRoutingHostRule], path_matchers: Sequence[outputs.EdgeCacheServiceRoutingPathMatcher]) -> None:
...
class EdgeCacheServiceRoutingHostRule(dict):
    ...
    def __init__(__self__, *, hosts: Sequence[_builtins.str], path_matcher: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcher(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, route_rules: Sequence[outputs.EdgeCacheServiceRoutingPathMatcherRouteRule], description: Optional[_builtins.str] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRule(dict):
    ...
    def __init__(__self__, *, match_rules: Sequence[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRule], priority: _builtins.str, description: Optional[_builtins.str] = ..., header_action: Optional[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderAction] = ..., origin: Optional[_builtins.str] = ..., route_action: Optional[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleRouteAction] = ..., route_methods: Optional[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleRouteMethods] = ..., url_redirect: Optional[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleUrlRedirect] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderAction(dict):
    ...
    def __init__(__self__, *, request_header_to_adds: Optional[Sequence[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAdd]] = ..., request_header_to_removes: Optional[Sequence[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToRemove]] = ..., response_header_to_adds: Optional[Sequence[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToAdd]] = ..., response_header_to_removes: Optional[Sequence[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToRemove]] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRule(dict):
    ...
    def __init__(__self__, *, full_path_match: Optional[_builtins.str] = ..., header_matches: Optional[Sequence[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatch]] = ..., ignore_case: Optional[_builtins.bool] = ..., path_template_match: Optional[_builtins.str] = ..., prefix_match: Optional[_builtins.str] = ..., query_parameter_matches: Optional[Sequence[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleQueryParameterMatch]] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatch(dict):
    ...
    def __init__(__self__, *, header_name: _builtins.str, exact_match: Optional[_builtins.str] = ..., invert_match: Optional[_builtins.bool] = ..., prefix_match: Optional[_builtins.str] = ..., present_match: Optional[_builtins.bool] = ..., suffix_match: Optional[_builtins.str] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleQueryParameterMatch(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, exact_match: Optional[_builtins.str] = ..., present_match: Optional[_builtins.bool] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteAction(dict):
    ...
    def __init__(__self__, *, cdn_policy: Optional[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy] = ..., compression_mode: Optional[_builtins.str] = ..., cors_policy: Optional[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCorsPolicy] = ..., url_rewrite: Optional[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionUrlRewrite] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy(dict):
    ...
    def __init__(__self__, *, add_signatures: Optional[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignatures] = ..., cache_key_policy: Optional[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyCacheKeyPolicy] = ..., cache_mode: Optional[_builtins.str] = ..., client_ttl: Optional[_builtins.str] = ..., default_ttl: Optional[_builtins.str] = ..., max_ttl: Optional[_builtins.str] = ..., negative_caching: Optional[_builtins.bool] = ..., negative_caching_policy: Optional[Mapping[str, _builtins.str]] = ..., signed_request_keyset: Optional[_builtins.str] = ..., signed_request_maximum_expiration_ttl: Optional[_builtins.str] = ..., signed_request_mode: Optional[_builtins.str] = ..., signed_token_options: Optional[outputs.EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicySignedTokenOptions] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignatures(dict):
    ...
    def __init__(__self__, *, actions: _builtins.str, copied_parameters: Optional[Sequence[_builtins.str]] = ..., keyset: Optional[_builtins.str] = ..., token_query_parameter: Optional[_builtins.str] = ..., token_ttl: Optional[_builtins.str] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyCacheKeyPolicy(dict):
    ...
    def __init__(__self__, *, exclude_host: Optional[_builtins.bool] = ..., exclude_query_string: Optional[_builtins.bool] = ..., excluded_query_parameters: Optional[Sequence[_builtins.str]] = ..., include_protocol: Optional[_builtins.bool] = ..., included_cookie_names: Optional[Sequence[_builtins.str]] = ..., included_header_names: Optional[Sequence[_builtins.str]] = ..., included_query_parameters: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicySignedTokenOptions(dict):
    ...
    def __init__(__self__, *, allowed_signature_algorithms: Optional[Sequence[_builtins.str]] = ..., token_query_parameter: Optional[_builtins.str] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCorsPolicy(dict):
    ...
    def __init__(__self__, *, max_age: _builtins.str, allow_credentials: Optional[_builtins.bool] = ..., allow_headers: Optional[Sequence[_builtins.str]] = ..., allow_methods: Optional[Sequence[_builtins.str]] = ..., allow_origins: Optional[Sequence[_builtins.str]] = ..., disabled: Optional[_builtins.bool] = ..., expose_headers: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionUrlRewrite(dict):
    ...
    def __init__(__self__, *, host_rewrite: Optional[_builtins.str] = ..., path_prefix_rewrite: Optional[_builtins.str] = ..., path_template_rewrite: Optional[_builtins.str] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteMethods(dict):
    ...
    def __init__(__self__, *, allowed_methods: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleUrlRedirect(dict):
    ...
    def __init__(__self__, *, host_redirect: Optional[_builtins.str] = ..., https_redirect: Optional[_builtins.bool] = ..., path_redirect: Optional[_builtins.str] = ..., prefix_redirect: Optional[_builtins.str] = ..., redirect_response_code: Optional[_builtins.str] = ..., strip_query: Optional[_builtins.bool] = ...) -> None:
...
class EndpointPolicyEndpointMatcher(dict):
    ...
    def __init__(__self__, *, metadata_label_matcher: outputs.EndpointPolicyEndpointMatcherMetadataLabelMatcher) -> None:
...
class EndpointPolicyEndpointMatcherMetadataLabelMatcher(dict):
    ...
    def __init__(__self__, *, metadata_label_match_criteria: _builtins.str, metadata_labels: Optional[Sequence[outputs.EndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabel]] = ...) -> None:
...
class EndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabel(dict):
    ...
    def __init__(__self__, *, label_name: _builtins.str, label_value: _builtins.str) -> None:
...
class GrpcRouteRule(dict):
    def __init__(__self__, *, action: Optional[outputs.GrpcRouteRuleAction] = ..., matches: Optional[Sequence[outputs.GrpcRouteRuleMatch]] = ...) -> None:
...
class GrpcRouteRuleAction(dict):
    ...
    def __init__(__self__, *, destinations: Optional[Sequence[outputs.GrpcRouteRuleActionDestination]] = ..., fault_injection_policy: Optional[outputs.GrpcRouteRuleActionFaultInjectionPolicy] = ..., retry_policy: Optional[outputs.GrpcRouteRuleActionRetryPolicy] = ..., timeout: Optional[_builtins.str] = ...) -> None:
...
class GrpcRouteRuleActionDestination(dict):
    ...
    def __init__(__self__, *, service_name: Optional[_builtins.str] = ..., weight: Optional[_builtins.int] = ...) -> None:
...
class GrpcRouteRuleActionFaultInjectionPolicy(dict):
    def __init__(__self__, *, abort: Optional[outputs.GrpcRouteRuleActionFaultInjectionPolicyAbort] = ..., delay: Optional[outputs.GrpcRouteRuleActionFaultInjectionPolicyDelay] = ...) -> None:
...
class GrpcRouteRuleActionFaultInjectionPolicyAbort(dict):
    ...
    def __init__(__self__, *, http_status: Optional[_builtins.int] = ..., percentage: Optional[_builtins.int] = ...) -> None:
...
class GrpcRouteRuleActionFaultInjectionPolicyDelay(dict):
    ...
    def __init__(__self__, *, fixed_delay: Optional[_builtins.str] = ..., percentage: Optional[_builtins.int] = ...) -> None:
...
class GrpcRouteRuleActionRetryPolicy(dict):
    ...
    def __init__(__self__, *, num_retries: Optional[_builtins.int] = ..., retry_conditions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class GrpcRouteRuleMatch(dict):
    def __init__(__self__, *, headers: Optional[Sequence[outputs.GrpcRouteRuleMatchHeader]] = ..., method: Optional[outputs.GrpcRouteRuleMatchMethod] = ...) -> None:
...
class GrpcRouteRuleMatchHeader(dict):
    def __init__(__self__, *, key: _builtins.str, value: _builtins.str, type: Optional[_builtins.str] = ...) -> None:
...
class GrpcRouteRuleMatchMethod(dict):
    ...
    def __init__(__self__, *, grpc_method: _builtins.str, grpc_service: _builtins.str, case_sensitive: Optional[_builtins.bool] = ...) -> None:
...
class HttpRouteRule(dict):
    def __init__(__self__, *, action: Optional[outputs.HttpRouteRuleAction] = ..., matches: Optional[Sequence[outputs.HttpRouteRuleMatch]] = ...) -> None:
...
class HttpRouteRuleAction(dict):
    ...
    def __init__(__self__, *, cors_policy: Optional[outputs.HttpRouteRuleActionCorsPolicy] = ..., destinations: Optional[Sequence[outputs.HttpRouteRuleActionDestination]] = ..., fault_injection_policy: Optional[outputs.HttpRouteRuleActionFaultInjectionPolicy] = ..., redirect: Optional[outputs.HttpRouteRuleActionRedirect] = ..., request_header_modifier: Optional[outputs.HttpRouteRuleActionRequestHeaderModifier] = ..., request_mirror_policy: Optional[outputs.HttpRouteRuleActionRequestMirrorPolicy] = ..., response_header_modifier: Optional[outputs.HttpRouteRuleActionResponseHeaderModifier] = ..., retry_policy: Optional[outputs.HttpRouteRuleActionRetryPolicy] = ..., timeout: Optional[_builtins.str] = ..., url_rewrite: Optional[outputs.HttpRouteRuleActionUrlRewrite] = ...) -> None:
...
class HttpRouteRuleActionCorsPolicy(dict):
    ...
    def __init__(__self__, *, allow_credentials: Optional[_builtins.bool] = ..., allow_headers: Optional[Sequence[_builtins.str]] = ..., allow_methods: Optional[Sequence[_builtins.str]] = ..., allow_origin_regexes: Optional[Sequence[_builtins.str]] = ..., allow_origins: Optional[Sequence[_builtins.str]] = ..., disabled: Optional[_builtins.bool] = ..., expose_headers: Optional[Sequence[_builtins.str]] = ..., max_age: Optional[_builtins.str] = ...) -> None:
...
class HttpRouteRuleActionFaultInjectionPolicy(dict):
    def __init__(__self__, *, abort: Optional[outputs.HttpRouteRuleActionFaultInjectionPolicyAbort] = ..., delay: Optional[outputs.HttpRouteRuleActionFaultInjectionPolicyDelay] = ...) -> None:
...
class HttpRouteRuleActionRedirect(dict):
    ...
    def __init__(__self__, *, host_redirect: Optional[_builtins.str] = ..., https_redirect: Optional[_builtins.bool] = ..., path_redirect: Optional[_builtins.str] = ..., port_redirect: Optional[_builtins.int] = ..., prefix_rewrite: Optional[_builtins.str] = ..., response_code: Optional[_builtins.str] = ..., strip_query: Optional[_builtins.bool] = ...) -> None:
...
class HttpRouteRuleActionRequestHeaderModifier(dict):
    def __init__(__self__, *, add: Optional[Mapping[str, _builtins.str]] = ..., removes: Optional[Sequence[_builtins.str]] = ..., set: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class HttpRouteRuleActionRequestMirrorPolicy(dict):
    def __init__(__self__, *, destination: Optional[outputs.HttpRouteRuleActionRequestMirrorPolicyDestination] = ...) -> None:
...
class HttpRouteRuleActionRetryPolicy(dict):
    ...
    def __init__(__self__, *, num_retries: Optional[_builtins.int] = ..., per_try_timeout: Optional[_builtins.str] = ..., retry_conditions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class HttpRouteRuleActionUrlRewrite(dict):
    ...
    def __init__(__self__, *, host_rewrite: Optional[_builtins.str] = ..., path_prefix_rewrite: Optional[_builtins.str] = ...) -> None:
...
class HttpRouteRuleMatch(dict):
    ...
    def __init__(__self__, *, full_path_match: Optional[_builtins.str] = ..., headers: Optional[Sequence[outputs.HttpRouteRuleMatchHeader]] = ..., ignore_case: Optional[_builtins.bool] = ..., prefix_match: Optional[_builtins.str] = ..., query_parameters: Optional[Sequence[outputs.HttpRouteRuleMatchQueryParameter]] = ..., regex_match: Optional[_builtins.str] = ...) -> None:
...
class HttpRouteRuleMatchHeader(dict):
    ...
    def __init__(__self__, *, exact_match: Optional[_builtins.str] = ..., header: Optional[_builtins.str] = ..., invert_match: Optional[_builtins.bool] = ..., prefix_match: Optional[_builtins.str] = ..., present_match: Optional[_builtins.bool] = ..., range_match: Optional[outputs.HttpRouteRuleMatchHeaderRangeMatch] = ..., regex_match: Optional[_builtins.str] = ..., suffix_match: Optional[_builtins.str] = ...) -> None:
...
class HttpRouteRuleMatchQueryParameter(dict):
    ...
    def __init__(__self__, *, exact_match: Optional[_builtins.str] = ..., present_match: Optional[_builtins.bool] = ..., query_parameter: Optional[_builtins.str] = ..., regex_match: Optional[_builtins.str] = ...) -> None:
...
class LbEdgeExtensionExtensionChain(dict):
    ...
    def __init__(__self__, *, extensions: Sequence[outputs.LbEdgeExtensionExtensionChainExtension], match_condition: outputs.LbEdgeExtensionExtensionChainMatchCondition, name: _builtins.str) -> None:
...
class LbEdgeExtensionExtensionChainExtension(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, service: _builtins.str, fail_open: Optional[_builtins.bool] = ..., forward_headers: Optional[Sequence[_builtins.str]] = ..., supported_events: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class LbRouteExtensionExtensionChain(dict):
    ...
    def __init__(__self__, *, extensions: Sequence[outputs.LbRouteExtensionExtensionChainExtension], match_condition: outputs.LbRouteExtensionExtensionChainMatchCondition, name: _builtins.str) -> None:
...
class LbRouteExtensionExtensionChainExtension(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, service: _builtins.str, authority: Optional[_builtins.str] = ..., fail_open: Optional[_builtins.bool] = ..., forward_headers: Optional[Sequence[_builtins.str]] = ..., metadata: Optional[Mapping[str, _builtins.str]] = ..., observability_mode: Optional[_builtins.bool] = ..., request_body_send_mode: Optional[_builtins.str] = ..., supported_events: Optional[Sequence[_builtins.str]] = ..., timeout: Optional[_builtins.str] = ...) -> None:
...
class LbTrafficExtensionExtensionChain(dict):
    ...
    def __init__(__self__, *, extensions: Sequence[outputs.LbTrafficExtensionExtensionChainExtension], match_condition: outputs.LbTrafficExtensionExtensionChainMatchCondition, name: _builtins.str) -> None:
...
class LbTrafficExtensionExtensionChainExtension(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, service: _builtins.str, authority: Optional[_builtins.str] = ..., fail_open: Optional[_builtins.bool] = ..., forward_headers: Optional[Sequence[_builtins.str]] = ..., metadata: Optional[Mapping[str, _builtins.str]] = ..., supported_events: Optional[Sequence[_builtins.str]] = ..., timeout: Optional[_builtins.str] = ...) -> None:
...
class MulticastDomainActivationTrafficSpec(dict):
    ...
    def __init__(__self__, *, aggr_egress_pps: Optional[_builtins.str] = ..., aggr_ingress_pps: Optional[_builtins.str] = ..., avg_packet_size: Optional[_builtins.int] = ..., max_per_group_ingress_pps: Optional[_builtins.str] = ..., max_per_group_subscribers: Optional[_builtins.str] = ...) -> None:
...
class MulticastDomainConnectionConfig(dict):
    ...
    def __init__(__self__, *, connection_type: _builtins.str, ncc_hub: Optional[_builtins.str] = ...) -> None:
...
class MulticastDomainUllMulticastDomain(dict):
    ...
    def __init__(__self__, *, preconfigured_ull_domain: Optional[_builtins.str] = ...) -> None:
...
class ServiceLbPoliciesIsolationConfig(dict):
    ...
    def __init__(__self__, *, isolation_granularity: Optional[_builtins.str] = ..., isolation_mode: Optional[_builtins.str] = ...) -> None:
...
class TcpRouteRule(dict):
    def __init__(__self__, *, action: outputs.TcpRouteRuleAction, matches: Optional[Sequence[outputs.TcpRouteRuleMatch]] = ...) -> None:
...
class TcpRouteRuleAction(dict):
    ...
    def __init__(__self__, *, destinations: Optional[Sequence[outputs.TcpRouteRuleActionDestination]] = ..., idle_timeout: Optional[_builtins.str] = ..., original_destination: Optional[_builtins.bool] = ...) -> None:
...
class TlsRouteRule(dict):
    def __init__(__self__, *, action: outputs.TlsRouteRuleAction, matches: Sequence[outputs.TlsRouteRuleMatch]) -> None:
...
class TlsRouteRuleAction(dict):
    def __init__(__self__, *, destinations: Optional[Sequence[outputs.TlsRouteRuleActionDestination]] = ...) -> None:
...
class TlsRouteRuleMatch(dict):
    ...
    def __init__(__self__, *, alpns: Optional[Sequence[_builtins.str]] = ..., sni_hosts: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class WasmPluginLogConfig(dict):
    ...
    def __init__(__self__, *, enable: Optional[_builtins.bool] = ..., min_log_level: Optional[_builtins.str] = ..., sample_rate: Optional[_builtins.float] = ...) -> None:
...
class WasmPluginVersion(dict):
    ...
    def __init__(__self__, *, version_name: _builtins.str, create_time: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., image_digest: Optional[_builtins.str] = ..., image_uri: Optional[_builtins.str] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., plugin_config_data: Optional[_builtins.str] = ..., plugin_config_digest: Optional[_builtins.str] = ..., plugin_config_uri: Optional[_builtins.str] = ..., update_time: Optional[_builtins.str] = ...) -> None:
