...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AutomationRule', 'AutomationRuleAdvanceRolloutRule', 'AutomationRulePromoteReleaseRule', 'AutomationRuleRepairRolloutRule', 'AutomationRuleRepairRolloutRuleRepairPhase', 'AutomationRuleRepairRolloutRuleRepairPhaseRetry', 'AutomationRuleRepairRolloutRuleRepairPhaseRollback', 'AutomationRuleTimedPromoteReleaseRule', 'AutomationSelector', 'AutomationSelectorTarget', 'CustomTargetTypeCustomActions', 'CustomTargetTypeCustomActionsIncludeSkaffoldModule', ..., ..., ..., 'CustomTargetTypeIamBindingCondition', 'CustomTargetTypeIamMemberCondition', 'DeliveryPipelineCondition', 'DeliveryPipelineConditionPipelineReadyCondition', 'DeliveryPipelineConditionTargetsPresentCondition', 'DeliveryPipelineConditionTargetsTypeCondition', 'DeliveryPipelineIamBindingCondition', 'DeliveryPipelineIamMemberCondition', 'DeliveryPipelineSerialPipeline', 'DeliveryPipelineSerialPipelineStage', 'DeliveryPipelineSerialPipelineStageDeployParameter', 'DeliveryPipelineSerialPipelineStageStrategy', 'DeliveryPipelineSerialPipelineStageStrategyCanary', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'DeployPolicyRule', 'DeployPolicyRuleRolloutRestriction', 'DeployPolicyRuleRolloutRestrictionTimeWindows', ..., ..., ..., ..., ..., ..., ..., ..., 'DeployPolicySelector', 'DeployPolicySelectorDeliveryPipeline', 'DeployPolicySelectorTarget', 'TargetAnthosCluster', 'TargetAssociatedEntity', 'TargetAssociatedEntityAnthosCluster', 'TargetAssociatedEntityGkeCluster', 'TargetCustomTarget', 'TargetExecutionConfig', 'TargetGke', 'TargetIamBindingCondition', 'TargetIamMemberCondition', 'TargetMultiTarget', 'TargetRun']
@pulumi.output_type
class AutomationRule(dict):
    ...
    def __init__(__self__, *, advance_rollout_rule: Optional[outputs.AutomationRuleAdvanceRolloutRule] = ..., promote_release_rule: Optional[outputs.AutomationRulePromoteReleaseRule] = ..., repair_rollout_rule: Optional[outputs.AutomationRuleRepairRolloutRule] = ..., timed_promote_release_rule: Optional[outputs.AutomationRuleTimedPromoteReleaseRule] = ...) -> None:
...
class AutomationRuleAdvanceRolloutRule(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, source_phases: Optional[Sequence[_builtins.str]] = ..., wait: Optional[_builtins.str] = ...) -> None:
...
class AutomationRulePromoteReleaseRule(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, destination_phase: Optional[_builtins.str] = ..., destination_target_id: Optional[_builtins.str] = ..., wait: Optional[_builtins.str] = ...) -> None:
...
class AutomationRuleRepairRolloutRule(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, jobs: Optional[Sequence[_builtins.str]] = ..., phases: Optional[Sequence[_builtins.str]] = ..., repair_phases: Optional[Sequence[outputs.AutomationRuleRepairRolloutRuleRepairPhase]] = ...) -> None:
...
class AutomationRuleRepairRolloutRuleRepairPhase(dict):
    def __init__(__self__, *, retry: Optional[outputs.AutomationRuleRepairRolloutRuleRepairPhaseRetry] = ..., rollback: Optional[outputs.AutomationRuleRepairRolloutRuleRepairPhaseRollback] = ...) -> None:
...
class AutomationRuleRepairRolloutRuleRepairPhaseRetry(dict):
    ...
    def __init__(__self__, *, attempts: _builtins.str, backoff_mode: Optional[_builtins.str] = ..., wait: Optional[_builtins.str] = ...) -> None:
...
class AutomationRuleRepairRolloutRuleRepairPhaseRollback(dict):
    ...
    def __init__(__self__, *, destination_phase: Optional[_builtins.str] = ..., disable_rollback_if_rollout_pending: Optional[_builtins.bool] = ...) -> None:
...
class AutomationRuleTimedPromoteReleaseRule(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, schedule: _builtins.str, time_zone: _builtins.str, destination_phase: Optional[_builtins.str] = ..., destination_target_id: Optional[_builtins.str] = ...) -> None:
...
class AutomationSelector(dict):
    def __init__(__self__, *, targets: Sequence[outputs.AutomationSelectorTarget]) -> None:
...
class AutomationSelectorTarget(dict):
    def __init__(__self__, *, id: Optional[_builtins.str] = ..., labels: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class CustomTargetTypeCustomActions(dict):
    ...
    def __init__(__self__, *, deploy_action: _builtins.str, include_skaffold_modules: Optional[Sequence[outputs.CustomTargetTypeCustomActionsIncludeSkaffoldModule]] = ..., render_action: Optional[_builtins.str] = ...) -> None:
...
class CustomTargetTypeCustomActionsIncludeSkaffoldModule(dict):
    ...
    def __init__(__self__, *, configs: Optional[Sequence[_builtins.str]] = ..., git: Optional[outputs.CustomTargetTypeCustomActionsIncludeSkaffoldModuleGit] = ..., google_cloud_build_repo: Optional[outputs.CustomTargetTypeCustomActionsIncludeSkaffoldModuleGoogleCloudBuildRepo] = ..., google_cloud_storage: Optional[outputs.CustomTargetTypeCustomActionsIncludeSkaffoldModuleGoogleCloudStorage] = ...) -> None:
...
class CustomTargetTypeCustomActionsIncludeSkaffoldModuleGit(dict):
    def __init__(__self__, *, repo: _builtins.str, path: Optional[_builtins.str] = ..., ref: Optional[_builtins.str] = ...) -> None:
...
class CustomTargetTypeCustomActionsIncludeSkaffoldModuleGoogleCloudBuildRepo(dict):
    def __init__(__self__, *, repository: _builtins.str, path: Optional[_builtins.str] = ..., ref: Optional[_builtins.str] = ...) -> None:
...
class CustomTargetTypeCustomActionsIncludeSkaffoldModuleGoogleCloudStorage(dict):
    def __init__(__self__, *, source: _builtins.str, path: Optional[_builtins.str] = ...) -> None:
...
class DeliveryPipelineCondition(dict):
    ...
    def __init__(__self__, *, pipeline_ready_conditions: Optional[Sequence[outputs.DeliveryPipelineConditionPipelineReadyCondition]] = ..., targets_present_conditions: Optional[Sequence[outputs.DeliveryPipelineConditionTargetsPresentCondition]] = ..., targets_type_conditions: Optional[Sequence[outputs.DeliveryPipelineConditionTargetsTypeCondition]] = ...) -> None:
...
class DeliveryPipelineConditionPipelineReadyCondition(dict):
    ...
    def __init__(__self__, *, status: Optional[_builtins.bool] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class DeliveryPipelineConditionTargetsPresentCondition(dict):
    ...
    def __init__(__self__, *, missing_targets: Optional[Sequence[_builtins.str]] = ..., status: Optional[_builtins.bool] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class DeliveryPipelineConditionTargetsTypeCondition(dict):
    ...
    def __init__(__self__, *, error_details: Optional[_builtins.str] = ..., status: Optional[_builtins.bool] = ...) -> None:
...
class DeliveryPipelineSerialPipeline(dict):
    def __init__(__self__, *, stages: Optional[Sequence[outputs.DeliveryPipelineSerialPipelineStage]] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStage(dict):
    ...
    def __init__(__self__, *, deploy_parameters: Optional[Sequence[outputs.DeliveryPipelineSerialPipelineStageDeployParameter]] = ..., profiles: Optional[Sequence[_builtins.str]] = ..., strategy: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategy] = ..., target_id: Optional[_builtins.str] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageDeployParameter(dict):
    ...
    def __init__(__self__, *, values: Mapping[str, _builtins.str], match_target_labels: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategy(dict):
    def __init__(__self__, *, canary: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanary] = ..., standard: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyStandard] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyCanary(dict):
    ...
    def __init__(__self__, *, canary_deployment: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryCanaryDeployment] = ..., custom_canary_deployment: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryCustomCanaryDeployment] = ..., runtime_config: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfig] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyCanaryCanaryDeployment(dict):
    def __init__(__self__, *, percentages: Sequence[_builtins.int], postdeploy: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryCanaryDeploymentPostdeploy] = ..., predeploy: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryCanaryDeploymentPredeploy] = ..., verify: Optional[_builtins.bool] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyCanaryCanaryDeploymentPostdeploy(dict):
    def __init__(__self__, *, actions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyCanaryCustomCanaryDeployment(dict):
    ...
    def __init__(__self__, *, phase_configs: Sequence[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryCustomCanaryDeploymentPhaseConfig]) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyCanaryCustomCanaryDeploymentPhaseConfig(dict):
    ...
    def __init__(__self__, *, percentage: _builtins.int, phase_id: _builtins.str, postdeploy: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryCustomCanaryDeploymentPhaseConfigPostdeploy] = ..., predeploy: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryCustomCanaryDeploymentPhaseConfigPredeploy] = ..., profiles: Optional[Sequence[_builtins.str]] = ..., verify: Optional[_builtins.bool] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfig(dict):
    ...
    def __init__(__self__, *, cloud_run: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigCloudRun] = ..., kubernetes: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigKubernetes] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigCloudRun(dict):
    ...
    def __init__(__self__, *, automatic_traffic_control: Optional[_builtins.bool] = ..., canary_revision_tags: Optional[Sequence[_builtins.str]] = ..., prior_revision_tags: Optional[Sequence[_builtins.str]] = ..., stable_revision_tags: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigKubernetes(dict):
    ...
    def __init__(__self__, *, gateway_service_mesh: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigKubernetesGatewayServiceMesh] = ..., service_networking: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigKubernetesServiceNetworking] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigKubernetesGatewayServiceMesh(dict):
    ...
    def __init__(__self__, *, deployment: _builtins.str, http_route: _builtins.str, service: _builtins.str, pod_selector_label: Optional[_builtins.str] = ..., route_destinations: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigKubernetesGatewayServiceMeshRouteDestinations] = ..., route_update_wait_time: Optional[_builtins.str] = ..., stable_cutback_duration: Optional[_builtins.str] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigKubernetesGatewayServiceMeshRouteDestinations(dict):
    ...
    def __init__(__self__, *, destination_ids: Sequence[_builtins.str], propagate_service: Optional[_builtins.bool] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyCanaryRuntimeConfigKubernetesServiceNetworking(dict):
    ...
    def __init__(__self__, *, deployment: _builtins.str, service: _builtins.str, disable_pod_overprovisioning: Optional[_builtins.bool] = ..., pod_selector_label: Optional[_builtins.str] = ...) -> None:
...
class DeliveryPipelineSerialPipelineStageStrategyStandard(dict):
    def __init__(__self__, *, postdeploy: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyStandardPostdeploy] = ..., predeploy: Optional[outputs.DeliveryPipelineSerialPipelineStageStrategyStandardPredeploy] = ..., verify: Optional[_builtins.bool] = ...) -> None:
...
class DeployPolicyRule(dict):
    ...
    def __init__(__self__, *, rollout_restriction: Optional[outputs.DeployPolicyRuleRolloutRestriction] = ...) -> None:
...
class DeployPolicyRuleRolloutRestriction(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, actions: Optional[Sequence[_builtins.str]] = ..., invokers: Optional[Sequence[_builtins.str]] = ..., time_windows: Optional[outputs.DeployPolicyRuleRolloutRestrictionTimeWindows] = ...) -> None:
...
class DeployPolicyRuleRolloutRestrictionTimeWindows(dict):
    ...
    def __init__(__self__, *, time_zone: _builtins.str, one_time_windows: Optional[Sequence[outputs.DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindow]] = ..., weekly_windows: Optional[Sequence[outputs.DeployPolicyRuleRolloutRestrictionTimeWindowsWeeklyWindow]] = ...) -> None:
...
class DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindow(dict):
    ...
    def __init__(__self__, *, end_date: outputs.DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowEndDate, end_time: outputs.DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowEndTime, start_date: outputs.DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDate, start_time: outputs.DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartTime) -> None:
...
class DeployPolicyRuleRolloutRestrictionTimeWindowsWeeklyWindow(dict):
    ...
    def __init__(__self__, *, days_of_weeks: Optional[Sequence[_builtins.str]] = ..., end_time: Optional[outputs.DeployPolicyRuleRolloutRestrictionTimeWindowsWeeklyWindowEndTime] = ..., start_time: Optional[outputs.DeployPolicyRuleRolloutRestrictionTimeWindowsWeeklyWindowStartTime] = ...) -> None:
...
class DeployPolicySelector(dict):
    ...
    def __init__(__self__, *, delivery_pipeline: Optional[outputs.DeployPolicySelectorDeliveryPipeline] = ..., target: Optional[outputs.DeployPolicySelectorTarget] = ...) -> None:
...
class TargetAssociatedEntity(dict):
    ...
    def __init__(__self__, *, entity_id: _builtins.str, anthos_clusters: Optional[Sequence[outputs.TargetAssociatedEntityAnthosCluster]] = ..., gke_clusters: Optional[Sequence[outputs.TargetAssociatedEntityGkeCluster]] = ...) -> None:
...
class TargetAssociatedEntityGkeCluster(dict):
    ...
    def __init__(__self__, *, cluster: Optional[_builtins.str] = ..., internal_ip: Optional[_builtins.bool] = ..., proxy_url: Optional[_builtins.str] = ...) -> None:
...
class TargetExecutionConfig(dict):
    ...
    def __init__(__self__, *, usages: Sequence[_builtins.str], artifact_storage: Optional[_builtins.str] = ..., execution_timeout: Optional[_builtins.str] = ..., service_account: Optional[_builtins.str] = ..., verbose: Optional[_builtins.bool] = ..., worker_pool: Optional[_builtins.str] = ...) -> None:
...
class TargetGke(dict):
    ...
    def __init__(__self__, *, cluster: Optional[_builtins.str] = ..., dns_endpoint: Optional[_builtins.bool] = ..., internal_ip: Optional[_builtins.bool] = ..., proxy_url: Optional[_builtins.str] = ...) -> None:
