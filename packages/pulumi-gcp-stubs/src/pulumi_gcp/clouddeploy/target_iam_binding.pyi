...
class TargetIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[TargetIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[TargetIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class TargetIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[TargetIamBindingConditionArgs, TargetIamBindingConditionArgsDict]
            ]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.TargetIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
