...
class CustomTargetTypeIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[CustomTargetTypeIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[CustomTargetTypeIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[CustomTargetTypeIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class CustomTargetTypeIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.CustomTargetTypeIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
