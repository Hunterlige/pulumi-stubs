...
class CustomTargetTypeIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[CustomTargetTypeIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[CustomTargetTypeIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[CustomTargetTypeIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class CustomTargetTypeIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.CustomTargetTypeIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
