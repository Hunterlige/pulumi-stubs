...
class GetFunctionResult:
    ...
    def __init__(__self__, automatic_update_policies=..., available_memory_mb=..., build_environment_variables=..., build_service_account=..., build_worker_pool=..., description=..., docker_registry=..., docker_repository=..., effective_labels=..., entry_point=..., environment_variables=..., event_triggers=..., https_trigger_security_level=..., https_trigger_url=..., id=..., ingress_settings=..., kms_key_name=..., labels=..., max_instances=..., min_instances=..., name=..., on_deploy_update_policies=..., project=..., pulumi_labels=..., region=..., runtime=..., secret_environment_variables=..., secret_volumes=..., service_account_email=..., source_archive_bucket=..., source_archive_object=..., source_repositories=..., status=..., timeout=..., trigger_http=..., version_id=..., vpc_connector=..., vpc_connector_egress_settings=...) -> None:
        ...
...
def get_function(name: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetFunctionResult:
    
    ...

def get_function_output(name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetFunctionResult]:
