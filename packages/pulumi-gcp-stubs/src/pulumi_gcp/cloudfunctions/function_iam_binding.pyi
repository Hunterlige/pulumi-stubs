...
class FunctionIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[FunctionIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[FunctionIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class FunctionIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    FunctionIamBindingConditionArgs, FunctionIamBindingConditionArgsDict
                ]
            ]
        ] = ...,
        members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.FunctionIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
