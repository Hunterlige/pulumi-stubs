...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FunctionAutomaticUpdatePolicyArgs', 'FunctionAutomaticUpdatePolicyArgsDict', 'FunctionEventTriggerArgs', 'FunctionEventTriggerArgsDict', 'FunctionEventTriggerFailurePolicyArgs', 'FunctionEventTriggerFailurePolicyArgsDict', 'FunctionIamBindingConditionArgs', 'FunctionIamBindingConditionArgsDict', 'FunctionIamMemberConditionArgs', 'FunctionIamMemberConditionArgsDict', 'FunctionOnDeployUpdatePolicyArgs', 'FunctionOnDeployUpdatePolicyArgsDict', 'FunctionSecretEnvironmentVariableArgs', 'FunctionSecretEnvironmentVariableArgsDict', 'FunctionSecretVolumeArgs', 'FunctionSecretVolumeArgsDict', 'FunctionSecretVolumeVersionArgs', 'FunctionSecretVolumeVersionArgsDict', 'FunctionSourceRepositoryArgs', 'FunctionSourceRepositoryArgsDict']
...
class FunctionEventTriggerArgs:
    def __init__(__self__, *, event_type: pulumi.Input[_builtins.str], resource: pulumi.Input[_builtins.str], failure_policy: Optional[pulumi.Input[FunctionEventTriggerFailurePolicyArgs]] = ...) -> None:
    ...
    def failure_policy(self, value: Optional[pulumi.Input[FunctionEventTriggerFailurePolicyArgs]]): # -> None:
        ...
...
class FunctionEventTriggerFailurePolicyArgs:
    ...
    @retry.setter
    def retry(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class FunctionSecretEnvironmentVariableArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], secret: pulumi.Input[_builtins.str], version: pulumi.Input[_builtins.str], project_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FunctionSecretVolumeArgs:
    def __init__(__self__, *, mount_path: pulumi.Input[_builtins.str], secret: pulumi.Input[_builtins.str], project_id: Optional[pulumi.Input[_builtins.str]] = ..., versions: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionSecretVolumeVersionArgs]]]] = ...) -> None:
    ...
    @versions.setter
    def versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionSecretVolumeVersionArgs]]]]): # -> None:
        ...
...
class FunctionSourceRepositoryArgs:
    def __init__(__self__, *, url: pulumi.Input[_builtins.str], deployed_url: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @deployed_url.setter
    def deployed_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
