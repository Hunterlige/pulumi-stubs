...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['NoteAttestationAuthorityArgs', 'NoteAttestationAuthorityArgsDict', 'NoteAttestationAuthorityHintArgs', 'NoteAttestationAuthorityHintArgsDict', 'NoteIamBindingConditionArgs', 'NoteIamBindingConditionArgsDict', 'NoteIamMemberConditionArgs', 'NoteIamMemberConditionArgsDict', 'NoteRelatedUrlArgs', 'NoteRelatedUrlArgsDict', 'OccurenceAttestationArgs', 'OccurenceAttestationArgsDict', 'OccurenceAttestationSignatureArgs', 'OccurenceAttestationSignatureArgsDict']
...
class NoteAttestationAuthorityArgs:
    ...
    @hint.setter
    def hint(self, value: pulumi.Input[NoteAttestationAuthorityHintArgs]): # -> None:
        ...
...
class NoteAttestationAuthorityHintArgs:
    def __init__(__self__, *, human_readable_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def human_readable_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class NoteRelatedUrlArgs:
    def __init__(__self__, *, url: pulumi.Input[_builtins.str], label: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class OccurenceAttestationArgs:
    def __init__(__self__, *, serialized_payload: pulumi.Input[_builtins.str], signatures: pulumi.Input[Sequence[pulumi.Input[OccurenceAttestationSignatureArgs]]]) -> None:
    ...
    def serialized_payload(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @signatures.setter
    def signatures(self, value: pulumi.Input[Sequence[pulumi.Input[OccurenceAttestationSignatureArgs]]]): # -> None:
        ...
...
class OccurenceAttestationSignatureArgs:
    def __init__(__self__, *, public_key_id: pulumi.Input[_builtins.str], signature: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
