...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['NoteAttestationAuthority', 'NoteAttestationAuthorityHint', 'NoteIamBindingCondition', 'NoteIamMemberCondition', 'NoteRelatedUrl', 'OccurenceAttestation', 'OccurenceAttestationSignature']
@pulumi.output_type
...
class NoteRelatedUrl(dict):
    def __init__(__self__, *, url: _builtins.str, label: Optional[_builtins.str] = ...) -> None:
...
class OccurenceAttestation(dict):
    ...
    def __init__(__self__, *, serialized_payload: _builtins.str, signatures: Sequence[outputs.OccurenceAttestationSignature]) -> None:
...
class OccurenceAttestationSignature(dict):
    ...
    def __init__(__self__, *, public_key_id: _builtins.str, signature: Optional[_builtins.str] = ...) -> None:
