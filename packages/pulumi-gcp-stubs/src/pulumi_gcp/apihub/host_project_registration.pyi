...
class HostProjectRegistrationArgs:
    ...
    @gcp_project.setter
    def gcp_project(self, value: pulumi.Input[_builtins.str]): ...
    @_builtins.property
    ...
    def host_project_registration_id(self, value: pulumi.Input[_builtins.str]): ...
    @_builtins.property
    @pulumi.getter
...
class _HostProjectRegistrationState:
    def __init__(
        ...
        *,
        ...
        host_project_registration_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    @host_project_registration_id.setter
    def host_project_registration_id(
