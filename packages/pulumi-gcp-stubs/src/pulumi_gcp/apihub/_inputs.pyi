...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApiHubInstanceConfigArgs', 'ApiHubInstanceConfigArgsDict', 'CurationEndpointArgs', 'CurationEndpointArgsDict', ..., ..., 'CurationPluginInstanceActionArgs', 'CurationPluginInstanceActionArgsDict', 'PluginActionsConfigArgs', 'PluginActionsConfigArgsDict', 'PluginConfigTemplateArgs', 'PluginConfigTemplateArgsDict', 'PluginConfigTemplateAdditionalConfigTemplateArgs', ..., ..., ..., ..., ..., 'PluginConfigTemplateAuthConfigTemplateArgs', 'PluginConfigTemplateAuthConfigTemplateArgsDict', ..., ..., 'PluginDocumentationArgs', 'PluginDocumentationArgsDict', 'PluginHostingServiceArgs', 'PluginHostingServiceArgsDict', 'PluginInstanceActionArgs', 'PluginInstanceActionArgsDict', 'PluginInstanceActionCurationConfigArgs', 'PluginInstanceActionCurationConfigArgsDict', ..., ..., 'PluginInstanceActionHubInstanceActionArgs', 'PluginInstanceActionHubInstanceActionArgsDict', ..., ..., 'PluginInstanceAuthConfigArgs', 'PluginInstanceAuthConfigArgsDict', 'PluginInstanceAuthConfigApiKeyConfigArgs', 'PluginInstanceAuthConfigApiKeyConfigArgsDict', 'PluginInstanceAuthConfigApiKeyConfigApiKeyArgs', 'PluginInstanceAuthConfigApiKeyConfigApiKeyArgsDict', ..., ..., ..., ..., ..., ..., 'PluginInstanceAuthConfigUserPasswordConfigArgs', 'PluginInstanceAuthConfigUserPasswordConfigArgsDict', ..., ...]
...
class ApiHubInstanceConfigArgs:
    def __init__(__self__, *, cmek_key_name: Optional[pulumi.Input[_builtins.str]] = ..., disable_search: Optional[pulumi.Input[_builtins.bool]] = ..., encryption_type: Optional[pulumi.Input[_builtins.str]] = ..., vertex_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disable_search(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def vertex_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CurationEndpointArgs:
    def __init__(__self__, *, application_integration_endpoint_details: pulumi.Input[CurationEndpointApplicationIntegrationEndpointDetailsArgs]) -> None:
    ...
    def application_integration_endpoint_details(self, value: pulumi.Input[CurationEndpointApplicationIntegrationEndpointDetailsArgs]): # -> None:
        ...
...
class CurationEndpointApplicationIntegrationEndpointDetailsArgs:
    def __init__(__self__, *, trigger_id: pulumi.Input[_builtins.str], uri: pulumi.Input[_builtins.str]) -> None:
...
class CurationPluginInstanceActionArgs:
    def __init__(__self__, *, action_id: Optional[pulumi.Input[_builtins.str]] = ..., plugin_instance: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def plugin_instance(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PluginActionsConfigArgs:
    def __init__(__self__, *, description: pulumi.Input[_builtins.str], display_name: pulumi.Input[_builtins.str], id: pulumi.Input[_builtins.str], trigger_mode: pulumi.Input[_builtins.str]) -> None:
...
class PluginConfigTemplateArgs:
    def __init__(__self__, *, additional_config_templates: Optional[pulumi.Input[Sequence[pulumi.Input[PluginConfigTemplateAdditionalConfigTemplateArgs]]]] = ..., auth_config_template: Optional[pulumi.Input[PluginConfigTemplateAuthConfigTemplateArgs]] = ...) -> None:
    ...
    def additional_config_templates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PluginConfigTemplateAdditionalConfigTemplateArgs]]]]): # -> None:
        ...
    ...
    def auth_config_template(self, value: Optional[pulumi.Input[PluginConfigTemplateAuthConfigTemplateArgs]]): # -> None:
        ...
...
class PluginConfigTemplateAdditionalConfigTemplateArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], value_type: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., enum_options: Optional[pulumi.Input[Sequence[pulumi.Input[PluginConfigTemplateAdditionalConfigTemplateEnumOptionArgs]]]] = ..., multi_select_options: Optional[pulumi.Input[Sequence[pulumi.Input[PluginConfigTemplateAdditionalConfigTemplateMultiSelectOptionArgs]]]] = ..., required: Optional[pulumi.Input[_builtins.bool]] = ..., validation_regex: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @enum_options.setter
    def enum_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PluginConfigTemplateAdditionalConfigTemplateEnumOptionArgs]]]]): # -> None:
        ...
    ...
    def multi_select_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PluginConfigTemplateAdditionalConfigTemplateMultiSelectOptionArgs]]]]): # -> None:
        ...
    ...
    def validation_regex(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PluginConfigTemplateAdditionalConfigTemplateEnumOptionArgs:
    def __init__(__self__, *, display_name: pulumi.Input[_builtins.str], id: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PluginConfigTemplateAuthConfigTemplateArgs:
    def __init__(__self__, *, supported_auth_types: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], service_account: Optional[pulumi.Input[PluginConfigTemplateAuthConfigTemplateServiceAccountArgs]] = ...) -> None:
    ...
    def supported_auth_types(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def service_account(self, value: Optional[pulumi.Input[PluginConfigTemplateAuthConfigTemplateServiceAccountArgs]]): # -> None:
        ...
...
class PluginDocumentationArgs:
    def __init__(__self__, *, external_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @external_uri.setter
    def external_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PluginHostingServiceArgs:
    def __init__(__self__, *, service_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PluginInstanceActionArgs:
    def __init__(__self__, *, action_id: pulumi.Input[_builtins.str], curation_config: Optional[pulumi.Input[PluginInstanceActionCurationConfigArgs]] = ..., hub_instance_actions: Optional[pulumi.Input[Sequence[pulumi.Input[PluginInstanceActionHubInstanceActionArgs]]]] = ..., schedule_cron_expression: Optional[pulumi.Input[_builtins.str]] = ..., schedule_time_zone: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @action_id.setter
    def action_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def curation_config(self, value: Optional[pulumi.Input[PluginInstanceActionCurationConfigArgs]]): # -> None:
        ...
    ...
    def hub_instance_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PluginInstanceActionHubInstanceActionArgs]]]]): # -> None:
        ...
    ...
    def schedule_cron_expression(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def schedule_time_zone(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PluginInstanceActionCurationConfigArgs:
    def __init__(__self__, *, curation_type: Optional[pulumi.Input[_builtins.str]] = ..., custom_curation: Optional[pulumi.Input[PluginInstanceActionCurationConfigCustomCurationArgs]] = ...) -> None:
    ...
    def curation_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def custom_curation(self, value: Optional[pulumi.Input[PluginInstanceActionCurationConfigCustomCurationArgs]]): # -> None:
        ...
...
class PluginInstanceActionCurationConfigCustomCurationArgs:
    ...
    @curation.setter
    def curation(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PluginInstanceActionHubInstanceActionArgs:
    def __init__(__self__, *, current_execution_state: Optional[pulumi.Input[_builtins.str]] = ..., last_executions: Optional[pulumi.Input[Sequence[pulumi.Input[PluginInstanceActionHubInstanceActionLastExecutionArgs]]]] = ...) -> None:
    ...
    def current_execution_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def last_executions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PluginInstanceActionHubInstanceActionLastExecutionArgs]]]]): # -> None:
        ...
...
class PluginInstanceActionHubInstanceActionLastExecutionArgs:
    def __init__(__self__, *, end_time: Optional[pulumi.Input[_builtins.str]] = ..., error_message: Optional[pulumi.Input[_builtins.str]] = ..., result: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PluginInstanceAuthConfigArgs:
    def __init__(__self__, *, auth_type: pulumi.Input[_builtins.str], api_key_config: Optional[pulumi.Input[PluginInstanceAuthConfigApiKeyConfigArgs]] = ..., google_service_account_config: Optional[pulumi.Input[PluginInstanceAuthConfigGoogleServiceAccountConfigArgs]] = ..., oauth2_client_credentials_config: Optional[pulumi.Input[PluginInstanceAuthConfigOauth2ClientCredentialsConfigArgs]] = ..., user_password_config: Optional[pulumi.Input[PluginInstanceAuthConfigUserPasswordConfigArgs]] = ...) -> None:
    ...
    def api_key_config(self, value: Optional[pulumi.Input[PluginInstanceAuthConfigApiKeyConfigArgs]]): # -> None:
        ...
    ...
    def google_service_account_config(self, value: Optional[pulumi.Input[PluginInstanceAuthConfigGoogleServiceAccountConfigArgs]]): # -> None:
        ...
    ...
    def oauth2_client_credentials_config(self, value: Optional[pulumi.Input[PluginInstanceAuthConfigOauth2ClientCredentialsConfigArgs]]): # -> None:
        ...
    ...
    def user_password_config(self, value: Optional[pulumi.Input[PluginInstanceAuthConfigUserPasswordConfigArgs]]): # -> None:
        ...
...
class PluginInstanceAuthConfigApiKeyConfigArgs:
    def __init__(__self__, *, api_key: pulumi.Input[PluginInstanceAuthConfigApiKeyConfigApiKeyArgs], http_element_location: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str]) -> None:
    ...
    @api_key.setter
    def api_key(self, value: pulumi.Input[PluginInstanceAuthConfigApiKeyConfigApiKeyArgs]): # -> None:
        ...
    ...
    def http_element_location(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PluginInstanceAuthConfigOauth2ClientCredentialsConfigArgs:
    def __init__(__self__, *, client_id: pulumi.Input[_builtins.str], client_secret: pulumi.Input[PluginInstanceAuthConfigOauth2ClientCredentialsConfigClientSecretArgs]) -> None:
    ...
    def client_secret(self, value: pulumi.Input[PluginInstanceAuthConfigOauth2ClientCredentialsConfigClientSecretArgs]): # -> None:
        ...
...
class PluginInstanceAuthConfigUserPasswordConfigArgs:
    def __init__(__self__, *, password: pulumi.Input[PluginInstanceAuthConfigUserPasswordConfigPasswordArgs], username: pulumi.Input[_builtins.str]) -> None:
    ...
    @password.setter
    def password(self, value: pulumi.Input[PluginInstanceAuthConfigUserPasswordConfigPasswordArgs]): # -> None:
        ...
