...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApiHubInstanceConfig', 'CurationEndpoint', ..., 'CurationPluginInstanceAction', 'PluginActionsConfig', 'PluginConfigTemplate', 'PluginConfigTemplateAdditionalConfigTemplate', ..., ..., 'PluginConfigTemplateAuthConfigTemplate', ..., 'PluginDocumentation', 'PluginHostingService', 'PluginInstanceAction', 'PluginInstanceActionCurationConfig', 'PluginInstanceActionCurationConfigCustomCuration', 'PluginInstanceActionHubInstanceAction', 'PluginInstanceActionHubInstanceActionLastExecution', 'PluginInstanceAuthConfig', 'PluginInstanceAuthConfigApiKeyConfig', 'PluginInstanceAuthConfigApiKeyConfigApiKey', 'PluginInstanceAuthConfigGoogleServiceAccountConfig', ..., ..., 'PluginInstanceAuthConfigUserPasswordConfig', 'PluginInstanceAuthConfigUserPasswordConfigPassword']
@pulumi.output_type
class ApiHubInstanceConfig(dict):
    ...
    def __init__(__self__, *, cmek_key_name: Optional[_builtins.str] = ..., disable_search: Optional[_builtins.bool] = ..., encryption_type: Optional[_builtins.str] = ..., vertex_location: Optional[_builtins.str] = ...) -> None:
...
class CurationEndpoint(dict):
    ...
    def __init__(__self__, *, application_integration_endpoint_details: outputs.CurationEndpointApplicationIntegrationEndpointDetails) -> None:
...
class CurationEndpointApplicationIntegrationEndpointDetails(dict):
    ...
    def __init__(__self__, *, trigger_id: _builtins.str, uri: _builtins.str) -> None:
...
class CurationPluginInstanceAction(dict):
    ...
    def __init__(__self__, *, action_id: Optional[_builtins.str] = ..., plugin_instance: Optional[_builtins.str] = ...) -> None:
...
class PluginActionsConfig(dict):
    ...
    def __init__(__self__, *, description: _builtins.str, display_name: _builtins.str, id: _builtins.str, trigger_mode: _builtins.str) -> None:
...
class PluginConfigTemplate(dict):
    ...
    def __init__(__self__, *, additional_config_templates: Optional[Sequence[outputs.PluginConfigTemplateAdditionalConfigTemplate]] = ..., auth_config_template: Optional[outputs.PluginConfigTemplateAuthConfigTemplate] = ...) -> None:
...
class PluginConfigTemplateAdditionalConfigTemplate(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, value_type: _builtins.str, description: Optional[_builtins.str] = ..., enum_options: Optional[Sequence[outputs.PluginConfigTemplateAdditionalConfigTemplateEnumOption]] = ..., multi_select_options: Optional[Sequence[outputs.PluginConfigTemplateAdditionalConfigTemplateMultiSelectOption]] = ..., required: Optional[_builtins.bool] = ..., validation_regex: Optional[_builtins.str] = ...) -> None:
...
class PluginConfigTemplateAdditionalConfigTemplateEnumOption(dict):
    ...
    def __init__(__self__, *, display_name: _builtins.str, id: _builtins.str, description: Optional[_builtins.str] = ...) -> None:
...
class PluginConfigTemplateAuthConfigTemplate(dict):
    ...
    def __init__(__self__, *, supported_auth_types: Sequence[_builtins.str], service_account: Optional[outputs.PluginConfigTemplateAuthConfigTemplateServiceAccount] = ...) -> None:
...
class PluginInstanceAction(dict):
    ...
    def __init__(__self__, *, action_id: _builtins.str, curation_config: Optional[outputs.PluginInstanceActionCurationConfig] = ..., hub_instance_actions: Optional[Sequence[outputs.PluginInstanceActionHubInstanceAction]] = ..., schedule_cron_expression: Optional[_builtins.str] = ..., schedule_time_zone: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class PluginInstanceActionCurationConfig(dict):
    ...
    def __init__(__self__, *, curation_type: Optional[_builtins.str] = ..., custom_curation: Optional[outputs.PluginInstanceActionCurationConfigCustomCuration] = ...) -> None:
...
class PluginInstanceActionHubInstanceAction(dict):
    ...
    def __init__(__self__, *, current_execution_state: Optional[_builtins.str] = ..., last_executions: Optional[Sequence[outputs.PluginInstanceActionHubInstanceActionLastExecution]] = ...) -> None:
...
class PluginInstanceActionHubInstanceActionLastExecution(dict):
    ...
    def __init__(__self__, *, end_time: Optional[_builtins.str] = ..., error_message: Optional[_builtins.str] = ..., result: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ...) -> None:
...
class PluginInstanceAuthConfig(dict):
    ...
    def __init__(__self__, *, auth_type: _builtins.str, api_key_config: Optional[outputs.PluginInstanceAuthConfigApiKeyConfig] = ..., google_service_account_config: Optional[outputs.PluginInstanceAuthConfigGoogleServiceAccountConfig] = ..., oauth2_client_credentials_config: Optional[outputs.PluginInstanceAuthConfigOauth2ClientCredentialsConfig] = ..., user_password_config: Optional[outputs.PluginInstanceAuthConfigUserPasswordConfig] = ...) -> None:
...
class PluginInstanceAuthConfigApiKeyConfig(dict):
    ...
    def __init__(__self__, *, api_key: outputs.PluginInstanceAuthConfigApiKeyConfigApiKey, http_element_location: _builtins.str, name: _builtins.str) -> None:
...
class PluginInstanceAuthConfigOauth2ClientCredentialsConfig(dict):
    ...
    def __init__(__self__, *, client_id: _builtins.str, client_secret: outputs.PluginInstanceAuthConfigOauth2ClientCredentialsConfigClientSecret) -> None:
...
class PluginInstanceAuthConfigUserPasswordConfig(dict):
    def __init__(__self__, *, password: outputs.PluginInstanceAuthConfigUserPasswordConfigPassword, username: _builtins.str) -> None:
