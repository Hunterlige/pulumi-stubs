...
class OrganizationVpcFlowLogsConfigArgs:
    def __init__(__self__, *, location: pulumi.Input[_builtins.str], organization: pulumi.Input[_builtins.str], vpc_flow_logs_config_id: pulumi.Input[_builtins.str], aggregation_interval: Optional[pulumi.Input[_builtins.str]] = ..., cross_project_metadata: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., filter_expr: Optional[pulumi.Input[_builtins.str]] = ..., flow_sampling: Optional[pulumi.Input[_builtins.float]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., metadata: Optional[pulumi.Input[_builtins.str]] = ..., metadata_fields: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cross_project_metadata(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class _OrganizationVpcFlowLogsConfigState:
    def __init__(__self__, *, aggregation_interval: Optional[pulumi.Input[_builtins.str]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., cross_project_metadata: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., effective_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., filter_expr: Optional[pulumi.Input[_builtins.str]] = ..., flow_sampling: Optional[pulumi.Input[_builtins.float]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., metadata: Optional[pulumi.Input[_builtins.str]] = ..., metadata_fields: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ..., vpc_flow_logs_config_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class OrganizationVpcFlowLogsConfig(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., aggregation_interval: Optional[pulumi.Input[_builtins.str]] = ..., cross_project_metadata: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., filter_expr: Optional[pulumi.Input[_builtins.str]] = ..., flow_sampling: Optional[pulumi.Input[_builtins.float]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., metadata: Optional[pulumi.Input[_builtins.str]] = ..., metadata_fields: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., vpc_flow_logs_config_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: OrganizationVpcFlowLogsConfigArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., aggregation_interval: Optional[pulumi.Input[_builtins.str]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., cross_project_metadata: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., effective_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., filter_expr: Optional[pulumi.Input[_builtins.str]] = ..., flow_sampling: Optional[pulumi.Input[_builtins.float]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., metadata: Optional[pulumi.Input[_builtins.str]] = ..., metadata_fields: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ..., vpc_flow_logs_config_id: Optional[pulumi.Input[_builtins.str]] = ...) -> OrganizationVpcFlowLogsConfig:
