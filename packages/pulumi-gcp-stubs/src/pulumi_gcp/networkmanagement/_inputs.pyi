...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectivityTestDestinationArgs', 'ConnectivityTestDestinationArgsDict', 'ConnectivityTestSourceArgs', 'ConnectivityTestSourceArgsDict', 'ConnectivityTestSourceAppEngineVersionArgs', 'ConnectivityTestSourceAppEngineVersionArgsDict', 'ConnectivityTestSourceCloudFunctionArgs', 'ConnectivityTestSourceCloudFunctionArgsDict', 'ConnectivityTestSourceCloudRunRevisionArgs', 'ConnectivityTestSourceCloudRunRevisionArgsDict']
...
class ConnectivityTestDestinationArgs:
    def __init__(__self__, *, cloud_sql_instance: Optional[pulumi.Input[_builtins.str]] = ..., forwarding_rule: Optional[pulumi.Input[_builtins.str]] = ..., fqdn: Optional[pulumi.Input[_builtins.str]] = ..., gke_master_cluster: Optional[pulumi.Input[_builtins.str]] = ..., instance: Optional[pulumi.Input[_builtins.str]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., project_id: Optional[pulumi.Input[_builtins.str]] = ..., redis_cluster: Optional[pulumi.Input[_builtins.str]] = ..., redis_instance: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cloud_sql_instance(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def gke_master_cluster(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def redis_cluster(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def redis_instance(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectivityTestSourceArgs:
    def __init__(__self__, *, app_engine_version: Optional[pulumi.Input[ConnectivityTestSourceAppEngineVersionArgs]] = ..., cloud_function: Optional[pulumi.Input[ConnectivityTestSourceCloudFunctionArgs]] = ..., cloud_run_revision: Optional[pulumi.Input[ConnectivityTestSourceCloudRunRevisionArgs]] = ..., cloud_sql_instance: Optional[pulumi.Input[_builtins.str]] = ..., gke_master_cluster: Optional[pulumi.Input[_builtins.str]] = ..., instance: Optional[pulumi.Input[_builtins.str]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., network_type: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., project_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def app_engine_version(self, value: Optional[pulumi.Input[ConnectivityTestSourceAppEngineVersionArgs]]): # -> None:
        ...
    ...
    def cloud_function(self, value: Optional[pulumi.Input[ConnectivityTestSourceCloudFunctionArgs]]): # -> None:
        ...
    ...
    def cloud_run_revision(self, value: Optional[pulumi.Input[ConnectivityTestSourceCloudRunRevisionArgs]]): # -> None:
        ...
