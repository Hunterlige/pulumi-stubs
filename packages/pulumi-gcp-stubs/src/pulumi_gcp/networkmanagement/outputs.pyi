...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConnectivityTestDestination', 'ConnectivityTestSource', 'ConnectivityTestSourceAppEngineVersion', 'ConnectivityTestSourceCloudFunction', 'ConnectivityTestSourceCloudRunRevision', 'GetConnectivityTestRunReachabilityDetailResult', ..., ..., ..., 'GetConnectivityTestsConnectivityTestResult', ..., 'GetConnectivityTestsConnectivityTestSourceResult', ..., ..., ...]
@pulumi.output_type
class ConnectivityTestDestination(dict):
    ...
    def __init__(__self__, *, cloud_sql_instance: Optional[_builtins.str] = ..., forwarding_rule: Optional[_builtins.str] = ..., fqdn: Optional[_builtins.str] = ..., gke_master_cluster: Optional[_builtins.str] = ..., instance: Optional[_builtins.str] = ..., ip_address: Optional[_builtins.str] = ..., network: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., project_id: Optional[_builtins.str] = ..., redis_cluster: Optional[_builtins.str] = ..., redis_instance: Optional[_builtins.str] = ...) -> None:
...
class ConnectivityTestSource(dict):
    ...
    def __init__(__self__, *, app_engine_version: Optional[outputs.ConnectivityTestSourceAppEngineVersion] = ..., cloud_function: Optional[outputs.ConnectivityTestSourceCloudFunction] = ..., cloud_run_revision: Optional[outputs.ConnectivityTestSourceCloudRunRevision] = ..., cloud_sql_instance: Optional[_builtins.str] = ..., gke_master_cluster: Optional[_builtins.str] = ..., instance: Optional[_builtins.str] = ..., ip_address: Optional[_builtins.str] = ..., network: Optional[_builtins.str] = ..., network_type: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., project_id: Optional[_builtins.str] = ...) -> None:
...
class GetConnectivityTestRunReachabilityDetailResult(dict):
    def __init__(__self__, *, result: _builtins.str, traces: Sequence[outputs.GetConnectivityTestRunReachabilityDetailTraceResult], verify_time: _builtins.str) -> None:
...
class GetConnectivityTestRunReachabilityDetailTraceResult(dict):
    def __init__(__self__, *, endpoint_infos: Sequence[outputs.GetConnectivityTestRunReachabilityDetailTraceEndpointInfoResult], forward_trace_id: _builtins.int, steps: Sequence[outputs.GetConnectivityTestRunReachabilityDetailTraceStepResult]) -> None:
...
class GetConnectivityTestRunReachabilityDetailTraceEndpointInfoResult(dict):
    def __init__(__self__, *, destination_ip: _builtins.str, destination_network_uri: _builtins.str, destination_port: _builtins.int, protocol: _builtins.str, source_agent_uri: _builtins.str, source_ip: _builtins.str, source_network_uri: _builtins.str, source_port: _builtins.int) -> None:
...
class GetConnectivityTestRunReachabilityDetailTraceStepResult(dict):
    def __init__(__self__, *, causes_drop: _builtins.bool, description: _builtins.str, project_id: _builtins.str, state: _builtins.str) -> None:
...
class GetConnectivityTestsConnectivityTestResult(dict):
    def __init__(__self__, *, bypass_firewall_checks: _builtins.bool, description: _builtins.str, destinations: Sequence[outputs.GetConnectivityTestsConnectivityTestDestinationResult], effective_labels: Mapping[str, _builtins.str], labels: Mapping[str, _builtins.str], name: _builtins.str, project: _builtins.str, protocol: _builtins.str, pulumi_labels: Mapping[str, _builtins.str], related_projects: Sequence[_builtins.str], round_trip: _builtins.bool, sources: Sequence[outputs.GetConnectivityTestsConnectivityTestSourceResult]) -> None:
...
class GetConnectivityTestsConnectivityTestDestinationResult(dict):
    def __init__(__self__, *, cloud_sql_instance: _builtins.str, forwarding_rule: _builtins.str, fqdn: _builtins.str, gke_master_cluster: _builtins.str, instance: _builtins.str, ip_address: _builtins.str, network: _builtins.str, port: _builtins.int, project_id: _builtins.str, redis_cluster: _builtins.str, redis_instance: _builtins.str) -> None:
...
class GetConnectivityTestsConnectivityTestSourceResult(dict):
    def __init__(__self__, *, app_engine_versions: Sequence[outputs.GetConnectivityTestsConnectivityTestSourceAppEngineVersionResult], cloud_functions: Sequence[outputs.GetConnectivityTestsConnectivityTestSourceCloudFunctionResult], cloud_run_revisions: Sequence[outputs.GetConnectivityTestsConnectivityTestSourceCloudRunRevisionResult], cloud_sql_instance: _builtins.str, gke_master_cluster: _builtins.str, instance: _builtins.str, ip_address: _builtins.str, network: _builtins.str, network_type: _builtins.str, port: _builtins.int, project_id: _builtins.str) -> None:
