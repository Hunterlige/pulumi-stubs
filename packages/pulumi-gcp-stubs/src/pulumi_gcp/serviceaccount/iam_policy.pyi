...
@pulumi.input_type
class IAMPolicyArgs:
    def __init__(__self__, *, policy_data: pulumi.Input[_builtins.str], service_account_id: pulumi.Input[_builtins.str]) -> None:
...
class _IAMPolicyState:
    def __init__(__self__, *, etag: Optional[pulumi.Input[_builtins.str]] = ..., policy_data: Optional[pulumi.Input[_builtins.str]] = ..., service_account_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class IAMPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., policy_data: Optional[pulumi.Input[_builtins.str]] = ..., service_account_id: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., policy_data: Optional[pulumi.Input[_builtins.str]] = ..., service_account_id: Optional[pulumi.Input[_builtins.str]] = ...) -> IAMPolicy:
