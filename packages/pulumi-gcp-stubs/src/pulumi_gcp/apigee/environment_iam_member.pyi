...
class EnvironmentIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[EnvironmentIamMemberConditionArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[EnvironmentIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[EnvironmentIamMemberConditionArgs]]
    ): ...
...
class EnvironmentIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.EnvironmentIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="envId")
