...
class _EnvironmentKeyvaluemapsState:
    def __init__(__self__, *, env_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EnvironmentKeyvaluemaps(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: EnvironmentKeyvaluemapsArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., env_id: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> EnvironmentKeyvaluemaps:
