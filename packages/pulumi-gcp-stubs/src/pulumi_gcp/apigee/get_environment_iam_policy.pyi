...
class GetEnvironmentIamPolicyResult:
    def __init__(
        __self__, env_id=..., etag=..., id=..., org_id=..., policy_data=...
    ) -> None: ...
    @_builtins.property
