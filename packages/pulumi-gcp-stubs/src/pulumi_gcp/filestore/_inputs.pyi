...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['InstanceDirectoryServicesArgs', 'InstanceDirectoryServicesArgsDict', 'InstanceDirectoryServicesLdapArgs', 'InstanceDirectoryServicesLdapArgsDict', 'InstanceEffectiveReplicationArgs', 'InstanceEffectiveReplicationArgsDict', 'InstanceEffectiveReplicationReplicaArgs', 'InstanceEffectiveReplicationReplicaArgsDict', 'InstanceFileSharesArgs', 'InstanceFileSharesArgsDict', 'InstanceFileSharesNfsExportOptionArgs', 'InstanceFileSharesNfsExportOptionArgsDict', 'InstanceInitialReplicationArgs', 'InstanceInitialReplicationArgsDict', 'InstanceInitialReplicationReplicaArgs', 'InstanceInitialReplicationReplicaArgsDict', 'InstanceNetworkArgs', 'InstanceNetworkArgsDict', 'InstanceNetworkPscConfigArgs', 'InstanceNetworkPscConfigArgsDict', 'InstancePerformanceConfigArgs', 'InstancePerformanceConfigArgsDict', 'InstancePerformanceConfigFixedIopsArgs', 'InstancePerformanceConfigFixedIopsArgsDict', 'InstancePerformanceConfigIopsPerTbArgs', 'InstancePerformanceConfigIopsPerTbArgsDict']
...
class InstanceDirectoryServicesArgs:
    def __init__(__self__, *, ldap: Optional[pulumi.Input[InstanceDirectoryServicesLdapArgs]] = ...) -> None:
    ...
    @ldap.setter
    def ldap(self, value: Optional[pulumi.Input[InstanceDirectoryServicesLdapArgs]]): # -> None:
        ...
...
class InstanceDirectoryServicesLdapArgs:
    def __init__(__self__, *, domain: pulumi.Input[_builtins.str], servers: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], groups_ou: Optional[pulumi.Input[_builtins.str]] = ..., users_ou: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @groups_ou.setter
    def groups_ou(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @users_ou.setter
    def users_ou(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstanceEffectiveReplicationArgs:
    def __init__(__self__, *, replicas: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceEffectiveReplicationReplicaArgs]]]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @replicas.setter
    def replicas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceEffectiveReplicationReplicaArgs]]]]): # -> None:
        ...
...
class InstanceEffectiveReplicationReplicaArgs:
    def __init__(__self__, *, last_active_sync_time: Optional[pulumi.Input[_builtins.str]] = ..., peer_instance: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., state_reasons: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def last_active_sync_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def peer_instance(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def state_reasons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class InstanceFileSharesArgs:
    def __init__(__self__, *, capacity_gb: pulumi.Input[_builtins.int], name: pulumi.Input[_builtins.str], nfs_export_options: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceFileSharesNfsExportOptionArgs]]]] = ..., source_backup: Optional[pulumi.Input[_builtins.str]] = ..., source_backupdr_backup: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @capacity_gb.setter
    def capacity_gb(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def nfs_export_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceFileSharesNfsExportOptionArgs]]]]): # -> None:
        ...
    ...
    def source_backupdr_backup(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstanceFileSharesNfsExportOptionArgs:
    def __init__(__self__, *, access_mode: Optional[pulumi.Input[_builtins.str]] = ..., anon_gid: Optional[pulumi.Input[_builtins.int]] = ..., anon_uid: Optional[pulumi.Input[_builtins.int]] = ..., ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., squash_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @anon_gid.setter
    def anon_gid(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class InstanceInitialReplicationArgs:
    def __init__(__self__, *, replicas: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceInitialReplicationReplicaArgs]]]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @replicas.setter
    def replicas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceInitialReplicationReplicaArgs]]]]): # -> None:
        ...
...
class InstanceInitialReplicationReplicaArgs:
    ...
    @peer_instance.setter
    def peer_instance(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class InstanceNetworkArgs:
    def __init__(__self__, *, modes: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], network: pulumi.Input[_builtins.str], connect_mode: Optional[pulumi.Input[_builtins.str]] = ..., ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., psc_config: Optional[pulumi.Input[InstanceNetworkPscConfigArgs]] = ..., reserved_ip_range: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @modes.setter
    def modes(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @psc_config.setter
    def psc_config(self, value: Optional[pulumi.Input[InstanceNetworkPscConfigArgs]]): # -> None:
        ...
...
class InstanceNetworkPscConfigArgs:
    def __init__(__self__, *, endpoint_project: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def endpoint_project(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstancePerformanceConfigArgs:
    def __init__(__self__, *, fixed_iops: Optional[pulumi.Input[InstancePerformanceConfigFixedIopsArgs]] = ..., iops_per_tb: Optional[pulumi.Input[InstancePerformanceConfigIopsPerTbArgs]] = ...) -> None:
    ...
    @fixed_iops.setter
    def fixed_iops(self, value: Optional[pulumi.Input[InstancePerformanceConfigFixedIopsArgs]]): # -> None:
        ...
    ...
    @iops_per_tb.setter
    def iops_per_tb(self, value: Optional[pulumi.Input[InstancePerformanceConfigIopsPerTbArgs]]): # -> None:
        ...
...
class InstancePerformanceConfigFixedIopsArgs:
    def __init__(__self__, *, max_iops: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @max_iops.setter
    def max_iops(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class InstancePerformanceConfigIopsPerTbArgs:
    def __init__(__self__, *, max_iops_per_tb: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def max_iops_per_tb(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
