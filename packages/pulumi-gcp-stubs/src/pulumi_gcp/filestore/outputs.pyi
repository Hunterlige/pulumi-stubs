...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['InstanceDirectoryServices', 'InstanceDirectoryServicesLdap', 'InstanceEffectiveReplication', 'InstanceEffectiveReplicationReplica', 'InstanceFileShares', 'InstanceFileSharesNfsExportOption', 'InstanceInitialReplication', 'InstanceInitialReplicationReplica', 'InstanceNetwork', 'InstanceNetworkPscConfig', 'InstancePerformanceConfig', 'InstancePerformanceConfigFixedIops', 'InstancePerformanceConfigIopsPerTb', 'GetInstanceDirectoryServiceResult', 'GetInstanceDirectoryServiceLdapResult', 'GetInstanceEffectiveReplicationResult', 'GetInstanceEffectiveReplicationReplicaResult', 'GetInstanceFileShareResult', 'GetInstanceFileShareNfsExportOptionResult', 'GetInstanceInitialReplicationResult', 'GetInstanceInitialReplicationReplicaResult', 'GetInstanceNetworkResult', 'GetInstanceNetworkPscConfigResult', 'GetInstancePerformanceConfigResult', 'GetInstancePerformanceConfigFixedIopResult', 'GetInstancePerformanceConfigIopsPerTbResult']
@pulumi.output_type
class InstanceDirectoryServices(dict):
    def __init__(__self__, *, ldap: Optional[outputs.InstanceDirectoryServicesLdap] = ...) -> None:
...
class InstanceDirectoryServicesLdap(dict):
    ...
    def __init__(__self__, *, domain: _builtins.str, servers: Sequence[_builtins.str], groups_ou: Optional[_builtins.str] = ..., users_ou: Optional[_builtins.str] = ...) -> None:
...
class InstanceEffectiveReplication(dict):
    def __init__(__self__, *, replicas: Optional[Sequence[outputs.InstanceEffectiveReplicationReplica]] = ..., role: Optional[_builtins.str] = ...) -> None:
...
class InstanceEffectiveReplicationReplica(dict):
    ...
    def __init__(__self__, *, last_active_sync_time: Optional[_builtins.str] = ..., peer_instance: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., state_reasons: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class InstanceFileShares(dict):
    ...
    def __init__(__self__, *, capacity_gb: _builtins.int, name: _builtins.str, nfs_export_options: Optional[Sequence[outputs.InstanceFileSharesNfsExportOption]] = ..., source_backup: Optional[_builtins.str] = ..., source_backupdr_backup: Optional[_builtins.str] = ...) -> None:
...
class InstanceFileSharesNfsExportOption(dict):
    ...
    def __init__(__self__, *, access_mode: Optional[_builtins.str] = ..., anon_gid: Optional[_builtins.int] = ..., anon_uid: Optional[_builtins.int] = ..., ip_ranges: Optional[Sequence[_builtins.str]] = ..., network: Optional[_builtins.str] = ..., squash_mode: Optional[_builtins.str] = ...) -> None:
...
class InstanceInitialReplication(dict):
    def __init__(__self__, *, replicas: Optional[Sequence[outputs.InstanceInitialReplicationReplica]] = ..., role: Optional[_builtins.str] = ...) -> None:
...
class InstanceNetwork(dict):
    ...
    def __init__(__self__, *, modes: Sequence[_builtins.str], network: _builtins.str, connect_mode: Optional[_builtins.str] = ..., ip_addresses: Optional[Sequence[_builtins.str]] = ..., psc_config: Optional[outputs.InstanceNetworkPscConfig] = ..., reserved_ip_range: Optional[_builtins.str] = ...) -> None:
...
class InstanceNetworkPscConfig(dict):
    ...
    def __init__(__self__, *, endpoint_project: Optional[_builtins.str] = ...) -> None:
...
class InstancePerformanceConfig(dict):
    ...
    def __init__(__self__, *, fixed_iops: Optional[outputs.InstancePerformanceConfigFixedIops] = ..., iops_per_tb: Optional[outputs.InstancePerformanceConfigIopsPerTb] = ...) -> None:
...
class InstancePerformanceConfigIopsPerTb(dict):
    ...
    def __init__(__self__, *, max_iops_per_tb: Optional[_builtins.int] = ...) -> None:
...
class GetInstanceDirectoryServiceResult(dict):
    def __init__(__self__, *, ldaps: Sequence[outputs.GetInstanceDirectoryServiceLdapResult]) -> None:
...
class GetInstanceDirectoryServiceLdapResult(dict):
    def __init__(__self__, *, domain: _builtins.str, groups_ou: _builtins.str, servers: Sequence[_builtins.str], users_ou: _builtins.str) -> None:
...
class GetInstanceEffectiveReplicationResult(dict):
    def __init__(__self__, *, replicas: Sequence[outputs.GetInstanceEffectiveReplicationReplicaResult], role: _builtins.str) -> None:
...
class GetInstanceEffectiveReplicationReplicaResult(dict):
    def __init__(__self__, *, last_active_sync_time: _builtins.str, peer_instance: _builtins.str, state: _builtins.str, state_reasons: Sequence[_builtins.str]) -> None:
...
class GetInstanceFileShareResult(dict):
    def __init__(__self__, *, capacity_gb: _builtins.int, name: _builtins.str, nfs_export_options: Sequence[outputs.GetInstanceFileShareNfsExportOptionResult], source_backup: _builtins.str, source_backupdr_backup: _builtins.str) -> None:
...
class GetInstanceFileShareNfsExportOptionResult(dict):
    def __init__(__self__, *, access_mode: _builtins.str, anon_gid: _builtins.int, anon_uid: _builtins.int, ip_ranges: Sequence[_builtins.str], network: _builtins.str, squash_mode: _builtins.str) -> None:
...
class GetInstanceInitialReplicationResult(dict):
    def __init__(__self__, *, replicas: Sequence[outputs.GetInstanceInitialReplicationReplicaResult], role: _builtins.str) -> None:
...
class GetInstanceNetworkResult(dict):
    def __init__(__self__, *, connect_mode: _builtins.str, ip_addresses: Sequence[_builtins.str], modes: Sequence[_builtins.str], network: _builtins.str, psc_configs: Sequence[outputs.GetInstanceNetworkPscConfigResult], reserved_ip_range: _builtins.str) -> None:
...
class GetInstancePerformanceConfigResult(dict):
    def __init__(__self__, *, fixed_iops: Sequence[outputs.GetInstancePerformanceConfigFixedIopResult], iops_per_tbs: Sequence[outputs.GetInstancePerformanceConfigIopsPerTbResult]) -> None:
