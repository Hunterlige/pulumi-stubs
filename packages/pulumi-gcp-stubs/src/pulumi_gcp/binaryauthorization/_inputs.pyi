...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AttestorAttestationAuthorityNoteArgs', 'AttestorAttestationAuthorityNoteArgsDict', 'AttestorAttestationAuthorityNotePublicKeyArgs', 'AttestorAttestationAuthorityNotePublicKeyArgsDict', ..., ..., 'AttestorIamBindingConditionArgs', 'AttestorIamBindingConditionArgsDict', 'AttestorIamMemberConditionArgs', 'AttestorIamMemberConditionArgsDict', 'PolicyAdmissionWhitelistPatternArgs', 'PolicyAdmissionWhitelistPatternArgsDict', 'PolicyClusterAdmissionRuleArgs', 'PolicyClusterAdmissionRuleArgsDict', 'PolicyDefaultAdmissionRuleArgs', 'PolicyDefaultAdmissionRuleArgsDict']
...
class AttestorAttestationAuthorityNoteArgs:
    def __init__(__self__, *, note_reference: pulumi.Input[_builtins.str], delegation_service_account_email: Optional[pulumi.Input[_builtins.str]] = ..., public_keys: Optional[pulumi.Input[Sequence[pulumi.Input[AttestorAttestationAuthorityNotePublicKeyArgs]]]] = ...) -> None:
    ...
    def note_reference(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def delegation_service_account_email(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @public_keys.setter
    def public_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AttestorAttestationAuthorityNotePublicKeyArgs]]]]): # -> None:
        ...
...
class AttestorAttestationAuthorityNotePublicKeyArgs:
    def __init__(__self__, *, ascii_armored_pgp_public_key: Optional[pulumi.Input[_builtins.str]] = ..., comment: Optional[pulumi.Input[_builtins.str]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., pkix_public_key: Optional[pulumi.Input[AttestorAttestationAuthorityNotePublicKeyPkixPublicKeyArgs]] = ...) -> None:
    ...
    def ascii_armored_pgp_public_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def pkix_public_key(self, value: Optional[pulumi.Input[AttestorAttestationAuthorityNotePublicKeyPkixPublicKeyArgs]]): # -> None:
        ...
...
class AttestorAttestationAuthorityNotePublicKeyPkixPublicKeyArgs:
    def __init__(__self__, *, public_key_pem: Optional[pulumi.Input[_builtins.str]] = ..., signature_algorithm: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def public_key_pem(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def signature_algorithm(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PolicyAdmissionWhitelistPatternArgs:
    ...
    @name_pattern.setter
    def name_pattern(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class PolicyClusterAdmissionRuleArgs:
    def __init__(__self__, *, cluster: pulumi.Input[_builtins.str], enforcement_mode: pulumi.Input[_builtins.str], evaluation_mode: pulumi.Input[_builtins.str], require_attestations_bies: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def evaluation_mode(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def require_attestations_bies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class PolicyDefaultAdmissionRuleArgs:
    def __init__(__self__, *, enforcement_mode: pulumi.Input[_builtins.str], evaluation_mode: pulumi.Input[_builtins.str], require_attestations_bies: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
