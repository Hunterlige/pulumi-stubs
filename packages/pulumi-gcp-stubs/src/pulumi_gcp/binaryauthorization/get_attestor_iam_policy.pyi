...
class GetAttestorIamPolicyResult:
    def __init__(
        __self__, attestor=..., etag=..., id=..., policy_data=..., project=...
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
...
def get_attestor_iam_policy(
    attestor: Optional[_builtins.str] = ...,
    project: Optional[_builtins.str] = ...,
    opts: Optional[pulumi.InvokeOptions] = ...,
) -> AwaitableGetAttestorIamPolicyResult: ...
def get_attestor_iam_policy_output(
    attestor: Optional[pulumi.Input[_builtins.str]] = ...,
    project: Optional[pulumi.Input[Optional[_builtins.str]]] = ...,
    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...,
) -> pulumi.Output[GetAttestorIamPolicyResult]: ...
