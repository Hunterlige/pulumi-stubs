...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EntryBigqueryDateShardedSpec', 'EntryBigqueryTableSpec', 'EntryBigqueryTableSpecTableSpec', 'EntryBigqueryTableSpecViewSpec', 'EntryGcsFilesetSpec', 'EntryGcsFilesetSpecSampleGcsFileSpec', 'EntryGroupIamBindingCondition', 'EntryGroupIamMemberCondition', 'PolicyTagIamBindingCondition', 'PolicyTagIamMemberCondition', 'TagField', 'TagTemplateField', 'TagTemplateFieldType', 'TagTemplateFieldTypeEnumType', 'TagTemplateFieldTypeEnumTypeAllowedValue', 'TagTemplateIamBindingCondition', 'TagTemplateIamMemberCondition', 'TaxonomyIamBindingCondition', 'TaxonomyIamMemberCondition']
@pulumi.output_type
class EntryBigqueryDateShardedSpec(dict):
    ...
    def __init__(__self__, *, dataset: Optional[_builtins.str] = ..., shard_count: Optional[_builtins.int] = ..., table_prefix: Optional[_builtins.str] = ...) -> None:
...
class EntryBigqueryTableSpec(dict):
    ...
    def __init__(__self__, *, table_source_type: Optional[_builtins.str] = ..., table_specs: Optional[Sequence[outputs.EntryBigqueryTableSpecTableSpec]] = ..., view_specs: Optional[Sequence[outputs.EntryBigqueryTableSpecViewSpec]] = ...) -> None:
...
class EntryGcsFilesetSpec(dict):
    ...
    def __init__(__self__, *, file_patterns: Sequence[_builtins.str], sample_gcs_file_specs: Optional[Sequence[outputs.EntryGcsFilesetSpecSampleGcsFileSpec]] = ...) -> None:
...
class EntryGcsFilesetSpecSampleGcsFileSpec(dict):
    ...
    def __init__(__self__, *, file_path: Optional[_builtins.str] = ..., size_bytes: Optional[_builtins.int] = ...) -> None:
...
class TagField(dict):
    ...
    def __init__(__self__, *, field_name: _builtins.str, bool_value: Optional[_builtins.bool] = ..., display_name: Optional[_builtins.str] = ..., double_value: Optional[_builtins.float] = ..., enum_value: Optional[_builtins.str] = ..., order: Optional[_builtins.int] = ..., string_value: Optional[_builtins.str] = ..., timestamp_value: Optional[_builtins.str] = ...) -> None:
...
class TagTemplateField(dict):
    ...
    def __init__(__self__, *, field_id: _builtins.str, type: outputs.TagTemplateFieldType, description: Optional[_builtins.str] = ..., display_name: Optional[_builtins.str] = ..., is_required: Optional[_builtins.bool] = ..., name: Optional[_builtins.str] = ..., order: Optional[_builtins.int] = ...) -> None:
...
class TagTemplateFieldType(dict):
    ...
    def __init__(__self__, *, enum_type: Optional[outputs.TagTemplateFieldTypeEnumType] = ..., primitive_type: Optional[_builtins.str] = ...) -> None:
...
class TagTemplateFieldTypeEnumType(dict):
    ...
    def __init__(__self__, *, allowed_values: Sequence[outputs.TagTemplateFieldTypeEnumTypeAllowedValue]) -> None:
