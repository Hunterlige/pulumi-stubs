...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['EntryBigqueryDateShardedSpecArgs', 'EntryBigqueryDateShardedSpecArgsDict', 'EntryBigqueryTableSpecArgs', 'EntryBigqueryTableSpecArgsDict', 'EntryBigqueryTableSpecTableSpecArgs', 'EntryBigqueryTableSpecTableSpecArgsDict', 'EntryBigqueryTableSpecViewSpecArgs', 'EntryBigqueryTableSpecViewSpecArgsDict', 'EntryGcsFilesetSpecArgs', 'EntryGcsFilesetSpecArgsDict', 'EntryGcsFilesetSpecSampleGcsFileSpecArgs', 'EntryGcsFilesetSpecSampleGcsFileSpecArgsDict', 'EntryGroupIamBindingConditionArgs', 'EntryGroupIamBindingConditionArgsDict', 'EntryGroupIamMemberConditionArgs', 'EntryGroupIamMemberConditionArgsDict', 'PolicyTagIamBindingConditionArgs', 'PolicyTagIamBindingConditionArgsDict', 'PolicyTagIamMemberConditionArgs', 'PolicyTagIamMemberConditionArgsDict', 'TagFieldArgs', 'TagFieldArgsDict', 'TagTemplateFieldArgs', 'TagTemplateFieldArgsDict', 'TagTemplateFieldTypeArgs', 'TagTemplateFieldTypeArgsDict', 'TagTemplateFieldTypeEnumTypeArgs', 'TagTemplateFieldTypeEnumTypeArgsDict', 'TagTemplateFieldTypeEnumTypeAllowedValueArgs', 'TagTemplateFieldTypeEnumTypeAllowedValueArgsDict', 'TagTemplateIamBindingConditionArgs', 'TagTemplateIamBindingConditionArgsDict', 'TagTemplateIamMemberConditionArgs', 'TagTemplateIamMemberConditionArgsDict', 'TaxonomyIamBindingConditionArgs', 'TaxonomyIamBindingConditionArgsDict', 'TaxonomyIamMemberConditionArgs', 'TaxonomyIamMemberConditionArgsDict']
...
class EntryBigqueryDateShardedSpecArgs:
    def __init__(__self__, *, dataset: Optional[pulumi.Input[_builtins.str]] = ..., shard_count: Optional[pulumi.Input[_builtins.int]] = ..., table_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class EntryBigqueryTableSpecArgs:
    def __init__(__self__, *, table_source_type: Optional[pulumi.Input[_builtins.str]] = ..., table_specs: Optional[pulumi.Input[Sequence[pulumi.Input[EntryBigqueryTableSpecTableSpecArgs]]]] = ..., view_specs: Optional[pulumi.Input[Sequence[pulumi.Input[EntryBigqueryTableSpecViewSpecArgs]]]] = ...) -> None:
    ...
    def table_source_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @table_specs.setter
    def table_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EntryBigqueryTableSpecTableSpecArgs]]]]): # -> None:
        ...
    ...
    @view_specs.setter
    def view_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EntryBigqueryTableSpecViewSpecArgs]]]]): # -> None:
        ...
...
class EntryBigqueryTableSpecTableSpecArgs:
    def __init__(__self__, *, grouped_entry: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def grouped_entry(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EntryBigqueryTableSpecViewSpecArgs:
    def __init__(__self__, *, view_query: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @view_query.setter
    def view_query(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EntryGcsFilesetSpecArgs:
    def __init__(__self__, *, file_patterns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], sample_gcs_file_specs: Optional[pulumi.Input[Sequence[pulumi.Input[EntryGcsFilesetSpecSampleGcsFileSpecArgs]]]] = ...) -> None:
    ...
    def sample_gcs_file_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[EntryGcsFilesetSpecSampleGcsFileSpecArgs]]]]): # -> None:
        ...
...
class EntryGcsFilesetSpecSampleGcsFileSpecArgs:
    def __init__(__self__, *, file_path: Optional[pulumi.Input[_builtins.str]] = ..., size_bytes: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @size_bytes.setter
    def size_bytes(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
@pulumi.input_type
class TagFieldArgs:
    def __init__(__self__, *, field_name: pulumi.Input[_builtins.str], bool_value: Optional[pulumi.Input[_builtins.bool]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., double_value: Optional[pulumi.Input[_builtins.float]] = ..., enum_value: Optional[pulumi.Input[_builtins.str]] = ..., order: Optional[pulumi.Input[_builtins.int]] = ..., string_value: Optional[pulumi.Input[_builtins.str]] = ..., timestamp_value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @double_value.setter
    def double_value(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @enum_value.setter
    def enum_value(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TagTemplateFieldArgs:
    def __init__(__self__, *, field_id: pulumi.Input[_builtins.str], type: pulumi.Input[TagTemplateFieldTypeArgs], description: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., is_required: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., order: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @field_id.setter
    def field_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @type.setter
    def type(self, value: pulumi.Input[TagTemplateFieldTypeArgs]): # -> None:
        ...
...
class TagTemplateFieldTypeArgs:
    def __init__(__self__, *, enum_type: Optional[pulumi.Input[TagTemplateFieldTypeEnumTypeArgs]] = ..., primitive_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @enum_type.setter
    def enum_type(self, value: Optional[pulumi.Input[TagTemplateFieldTypeEnumTypeArgs]]): # -> None:
        ...
    ...
    def primitive_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TagTemplateFieldTypeEnumTypeArgs:
    def __init__(__self__, *, allowed_values: pulumi.Input[Sequence[pulumi.Input[TagTemplateFieldTypeEnumTypeAllowedValueArgs]]]) -> None:
    ...
    def allowed_values(self, value: pulumi.Input[Sequence[pulumi.Input[TagTemplateFieldTypeEnumTypeAllowedValueArgs]]]): # -> None:
        ...
