...
class TaxonomyIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[TaxonomyIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[TaxonomyIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class TaxonomyIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    TaxonomyIamMemberConditionArgs, TaxonomyIamMemberConditionArgsDict
                ]
            ]
        ] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.TaxonomyIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
