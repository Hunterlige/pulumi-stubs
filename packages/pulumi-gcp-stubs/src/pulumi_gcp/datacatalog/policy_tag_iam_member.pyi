...
class PolicyTagIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[PolicyTagIamMemberConditionArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[PolicyTagIamMemberConditionArgs]]
    ): ...
...
class PolicyTagIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    PolicyTagIamMemberConditionArgs, PolicyTagIamMemberConditionArgsDict
                ]
            ]
        ] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.PolicyTagIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
