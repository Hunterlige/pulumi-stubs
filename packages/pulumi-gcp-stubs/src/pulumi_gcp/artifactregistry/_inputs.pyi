...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['RepositoryCleanupPolicyArgs', 'RepositoryCleanupPolicyArgsDict', 'RepositoryCleanupPolicyConditionArgs', 'RepositoryCleanupPolicyConditionArgsDict', 'RepositoryCleanupPolicyMostRecentVersionsArgs', 'RepositoryCleanupPolicyMostRecentVersionsArgsDict', 'RepositoryDockerConfigArgs', 'RepositoryDockerConfigArgsDict', 'RepositoryIamBindingConditionArgs', 'RepositoryIamBindingConditionArgsDict', 'RepositoryIamMemberConditionArgs', 'RepositoryIamMemberConditionArgsDict', 'RepositoryMavenConfigArgs', 'RepositoryMavenConfigArgsDict', 'RepositoryRemoteRepositoryConfigArgs', 'RepositoryRemoteRepositoryConfigArgsDict', 'RepositoryRemoteRepositoryConfigAptRepositoryArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'RepositoryRemoteRepositoryConfigNpmRepositoryArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'RepositoryRemoteRepositoryConfigYumRepositoryArgs', ..., ..., ..., 'RepositoryVirtualRepositoryConfigArgs', 'RepositoryVirtualRepositoryConfigArgsDict', ..., ..., 'RepositoryVulnerabilityScanningConfigArgs', 'RepositoryVulnerabilityScanningConfigArgsDict']
...
class RepositoryCleanupPolicyArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], action: Optional[pulumi.Input[_builtins.str]] = ..., condition: Optional[pulumi.Input[RepositoryCleanupPolicyConditionArgs]] = ..., most_recent_versions: Optional[pulumi.Input[RepositoryCleanupPolicyMostRecentVersionsArgs]] = ...) -> None:
    ...
    @condition.setter
    def condition(self, value: Optional[pulumi.Input[RepositoryCleanupPolicyConditionArgs]]): # -> None:
        ...
    ...
    def most_recent_versions(self, value: Optional[pulumi.Input[RepositoryCleanupPolicyMostRecentVersionsArgs]]): # -> None:
        ...
...
class RepositoryCleanupPolicyConditionArgs:
    def __init__(__self__, *, newer_than: Optional[pulumi.Input[_builtins.str]] = ..., older_than: Optional[pulumi.Input[_builtins.str]] = ..., package_name_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tag_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tag_state: Optional[pulumi.Input[_builtins.str]] = ..., version_name_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @newer_than.setter
    def newer_than(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @older_than.setter
    def older_than(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def package_name_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @tag_prefixes.setter
    def tag_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @tag_state.setter
    def tag_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def version_name_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RepositoryCleanupPolicyMostRecentVersionsArgs:
    def __init__(__self__, *, keep_count: Optional[pulumi.Input[_builtins.int]] = ..., package_name_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @keep_count.setter
    def keep_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class RepositoryDockerConfigArgs:
    def __init__(__self__, *, immutable_tags: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def immutable_tags(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class RepositoryMavenConfigArgs:
    def __init__(__self__, *, allow_snapshot_overwrites: Optional[pulumi.Input[_builtins.bool]] = ..., version_policy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allow_snapshot_overwrites(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def version_policy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RepositoryRemoteRepositoryConfigArgs:
    def __init__(__self__, *, apt_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigAptRepositoryArgs]] = ..., common_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigCommonRepositoryArgs]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., disable_upstream_validation: Optional[pulumi.Input[_builtins.bool]] = ..., docker_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigDockerRepositoryArgs]] = ..., maven_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigMavenRepositoryArgs]] = ..., npm_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigNpmRepositoryArgs]] = ..., python_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigPythonRepositoryArgs]] = ..., upstream_credentials: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigUpstreamCredentialsArgs]] = ..., yum_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigYumRepositoryArgs]] = ...) -> None:
    ...
    def apt_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigAptRepositoryArgs]]): # -> None:
        ...
    ...
    def common_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigCommonRepositoryArgs]]): # -> None:
        ...
    ...
    def disable_upstream_validation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def docker_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigDockerRepositoryArgs]]): # -> None:
        ...
    ...
    def maven_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigMavenRepositoryArgs]]): # -> None:
        ...
    ...
    def npm_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigNpmRepositoryArgs]]): # -> None:
        ...
    ...
    def python_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigPythonRepositoryArgs]]): # -> None:
        ...
    ...
    def upstream_credentials(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigUpstreamCredentialsArgs]]): # -> None:
        ...
    ...
    def yum_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigYumRepositoryArgs]]): # -> None:
        ...
...
class RepositoryRemoteRepositoryConfigAptRepositoryArgs:
    def __init__(__self__, *, public_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigAptRepositoryPublicRepositoryArgs]] = ...) -> None:
    ...
    def public_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigAptRepositoryPublicRepositoryArgs]]): # -> None:
        ...
...
class RepositoryRemoteRepositoryConfigAptRepositoryPublicRepositoryArgs:
    def __init__(__self__, *, repository_base: pulumi.Input[_builtins.str], repository_path: pulumi.Input[_builtins.str]) -> None:
    ...
    def repository_base(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def repository_path(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RepositoryRemoteRepositoryConfigDockerRepositoryArgs:
    def __init__(__self__, *, custom_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigDockerRepositoryCustomRepositoryArgs]] = ..., public_repository: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def custom_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigDockerRepositoryCustomRepositoryArgs]]): # -> None:
        ...
    ...
    @public_repository.setter
    def public_repository(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RepositoryRemoteRepositoryConfigMavenRepositoryArgs:
    def __init__(__self__, *, custom_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigMavenRepositoryCustomRepositoryArgs]] = ..., public_repository: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @custom_repository.setter
    def custom_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigMavenRepositoryCustomRepositoryArgs]]): # -> None:
        ...
...
class RepositoryRemoteRepositoryConfigNpmRepositoryArgs:
    def __init__(__self__, *, custom_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigNpmRepositoryCustomRepositoryArgs]] = ..., public_repository: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @custom_repository.setter
    def custom_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigNpmRepositoryCustomRepositoryArgs]]): # -> None:
        ...
...
class RepositoryRemoteRepositoryConfigPythonRepositoryArgs:
    def __init__(__self__, *, custom_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigPythonRepositoryCustomRepositoryArgs]] = ..., public_repository: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @custom_repository.setter
    def custom_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigPythonRepositoryCustomRepositoryArgs]]): # -> None:
        ...
...
class RepositoryRemoteRepositoryConfigUpstreamCredentialsArgs:
    def __init__(__self__, *, username_password_credentials: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigUpstreamCredentialsUsernamePasswordCredentialsArgs]] = ...) -> None:
    ...
    def username_password_credentials(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigUpstreamCredentialsUsernamePasswordCredentialsArgs]]): # -> None:
        ...
...
class RepositoryRemoteRepositoryConfigUpstreamCredentialsUsernamePasswordCredentialsArgs:
    def __init__(__self__, *, password_secret_version: Optional[pulumi.Input[_builtins.str]] = ..., username: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RepositoryRemoteRepositoryConfigYumRepositoryArgs:
    def __init__(__self__, *, public_repository: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigYumRepositoryPublicRepositoryArgs]] = ...) -> None:
    ...
    @public_repository.setter
    def public_repository(self, value: Optional[pulumi.Input[RepositoryRemoteRepositoryConfigYumRepositoryPublicRepositoryArgs]]): # -> None:
        ...
...
class RepositoryVirtualRepositoryConfigArgs:
    def __init__(__self__, *, upstream_policies: Optional[pulumi.Input[Sequence[pulumi.Input[RepositoryVirtualRepositoryConfigUpstreamPolicyArgs]]]] = ...) -> None:
    ...
    def upstream_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RepositoryVirtualRepositoryConfigUpstreamPolicyArgs]]]]): # -> None:
        ...
...
class RepositoryVirtualRepositoryConfigUpstreamPolicyArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.int]] = ..., repository: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RepositoryVulnerabilityScanningConfigArgs:
    def __init__(__self__, *, enablement_config: Optional[pulumi.Input[_builtins.str]] = ..., enablement_state: Optional[pulumi.Input[_builtins.str]] = ..., enablement_state_reason: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def enablement_config(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def enablement_state_reason(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
