...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AclAclEntryArgs', 'AclAclEntryArgsDict', 'ClusterBrokerCapacityConfigArgs', 'ClusterBrokerCapacityConfigArgsDict', 'ClusterCapacityConfigArgs', 'ClusterCapacityConfigArgsDict', 'ClusterGcpConfigArgs', 'ClusterGcpConfigArgsDict', 'ClusterGcpConfigAccessConfigArgs', 'ClusterGcpConfigAccessConfigArgsDict', 'ClusterGcpConfigAccessConfigNetworkConfigArgs', 'ClusterGcpConfigAccessConfigNetworkConfigArgsDict', 'ClusterRebalanceConfigArgs', 'ClusterRebalanceConfigArgsDict', 'ClusterTlsConfigArgs', 'ClusterTlsConfigArgsDict', 'ClusterTlsConfigTrustConfigArgs', 'ClusterTlsConfigTrustConfigArgsDict', 'ClusterTlsConfigTrustConfigCasConfigArgs', 'ClusterTlsConfigTrustConfigCasConfigArgsDict', 'ConnectClusterCapacityConfigArgs', 'ConnectClusterCapacityConfigArgsDict', 'ConnectClusterGcpConfigArgs', 'ConnectClusterGcpConfigArgsDict', 'ConnectClusterGcpConfigAccessConfigArgs', 'ConnectClusterGcpConfigAccessConfigArgsDict', ..., ..., 'ConnectorTaskRestartPolicyArgs', 'ConnectorTaskRestartPolicyArgsDict']
...
class AclAclEntryArgs:
    def __init__(__self__, *, operation: pulumi.Input[_builtins.str], principal: pulumi.Input[_builtins.str], host: Optional[pulumi.Input[_builtins.str]] = ..., permission_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterBrokerCapacityConfigArgs:
    def __init__(__self__, *, disk_size_gib: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disk_size_gib(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterCapacityConfigArgs:
    def __init__(__self__, *, memory_bytes: pulumi.Input[_builtins.str], vcpu_count: pulumi.Input[_builtins.str]) -> None:
    ...
    @memory_bytes.setter
    def memory_bytes(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @vcpu_count.setter
    def vcpu_count(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterGcpConfigArgs:
    def __init__(__self__, *, access_config: pulumi.Input[ClusterGcpConfigAccessConfigArgs], kms_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def access_config(self, value: pulumi.Input[ClusterGcpConfigAccessConfigArgs]): # -> None:
        ...
...
class ClusterGcpConfigAccessConfigArgs:
    def __init__(__self__, *, network_configs: pulumi.Input[Sequence[pulumi.Input[ClusterGcpConfigAccessConfigNetworkConfigArgs]]]) -> None:
    ...
    def network_configs(self, value: pulumi.Input[Sequence[pulumi.Input[ClusterGcpConfigAccessConfigNetworkConfigArgs]]]): # -> None:
        ...
...
class ClusterTlsConfigArgs:
    def __init__(__self__, *, ssl_principal_mapping_rules: Optional[pulumi.Input[_builtins.str]] = ..., trust_config: Optional[pulumi.Input[ClusterTlsConfigTrustConfigArgs]] = ...) -> None:
    ...
    def ssl_principal_mapping_rules(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @trust_config.setter
    def trust_config(self, value: Optional[pulumi.Input[ClusterTlsConfigTrustConfigArgs]]): # -> None:
        ...
...
class ClusterTlsConfigTrustConfigArgs:
    def __init__(__self__, *, cas_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterTlsConfigTrustConfigCasConfigArgs]]]] = ...) -> None:
    ...
    @cas_configs.setter
    def cas_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterTlsConfigTrustConfigCasConfigArgs]]]]): # -> None:
        ...
...
class ConnectClusterGcpConfigArgs:
    def __init__(__self__, *, access_config: pulumi.Input[ConnectClusterGcpConfigAccessConfigArgs]) -> None:
    ...
    @access_config.setter
    def access_config(self, value: pulumi.Input[ConnectClusterGcpConfigAccessConfigArgs]): # -> None:
        ...
...
class ConnectClusterGcpConfigAccessConfigArgs:
    def __init__(__self__, *, network_configs: pulumi.Input[Sequence[pulumi.Input[ConnectClusterGcpConfigAccessConfigNetworkConfigArgs]]]) -> None:
    ...
    @network_configs.setter
    def network_configs(self, value: pulumi.Input[Sequence[pulumi.Input[ConnectClusterGcpConfigAccessConfigNetworkConfigArgs]]]): # -> None:
        ...
...
class ConnectClusterGcpConfigAccessConfigNetworkConfigArgs:
    def __init__(__self__, *, primary_subnet: pulumi.Input[_builtins.str], additional_subnets: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., dns_domain_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def primary_subnet(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def additional_subnets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def dns_domain_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
