...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AclAclEntry', 'ClusterBrokerCapacityConfig', 'ClusterCapacityConfig', 'ClusterGcpConfig', 'ClusterGcpConfigAccessConfig', 'ClusterGcpConfigAccessConfigNetworkConfig', 'ClusterRebalanceConfig', 'ClusterTlsConfig', 'ClusterTlsConfigTrustConfig', 'ClusterTlsConfigTrustConfigCasConfig', 'ConnectClusterCapacityConfig', 'ConnectClusterGcpConfig', 'ConnectClusterGcpConfigAccessConfig', 'ConnectClusterGcpConfigAccessConfigNetworkConfig', 'ConnectorTaskRestartPolicy']
@pulumi.output_type
class AclAclEntry(dict):
    ...
    def __init__(__self__, *, operation: _builtins.str, principal: _builtins.str, host: Optional[_builtins.str] = ..., permission_type: Optional[_builtins.str] = ...) -> None:
...
class ClusterCapacityConfig(dict):
    ...
    def __init__(__self__, *, memory_bytes: _builtins.str, vcpu_count: _builtins.str) -> None:
...
class ClusterGcpConfig(dict):
    ...
    def __init__(__self__, *, access_config: outputs.ClusterGcpConfigAccessConfig, kms_key: Optional[_builtins.str] = ...) -> None:
...
class ClusterGcpConfigAccessConfig(dict):
    ...
    def __init__(__self__, *, network_configs: Sequence[outputs.ClusterGcpConfigAccessConfigNetworkConfig]) -> None:
...
class ClusterTlsConfig(dict):
    ...
    def __init__(__self__, *, ssl_principal_mapping_rules: Optional[_builtins.str] = ..., trust_config: Optional[outputs.ClusterTlsConfigTrustConfig] = ...) -> None:
...
class ClusterTlsConfigTrustConfig(dict):
    ...
    def __init__(__self__, *, cas_configs: Optional[Sequence[outputs.ClusterTlsConfigTrustConfigCasConfig]] = ...) -> None:
...
class ConnectClusterGcpConfig(dict):
    ...
    def __init__(__self__, *, access_config: outputs.ConnectClusterGcpConfigAccessConfig) -> None:
...
class ConnectClusterGcpConfigAccessConfig(dict):
    ...
    def __init__(__self__, *, network_configs: Sequence[outputs.ConnectClusterGcpConfigAccessConfigNetworkConfig]) -> None:
...
class ConnectClusterGcpConfigAccessConfigNetworkConfig(dict):
    ...
    def __init__(__self__, *, primary_subnet: _builtins.str, additional_subnets: Optional[Sequence[_builtins.str]] = ..., dns_domain_names: Optional[Sequence[_builtins.str]] = ...) -> None:
