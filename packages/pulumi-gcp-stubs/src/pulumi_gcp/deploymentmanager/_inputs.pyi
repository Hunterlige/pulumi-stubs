...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DeploymentLabelArgs', 'DeploymentLabelArgsDict', 'DeploymentTargetArgs', 'DeploymentTargetArgsDict', 'DeploymentTargetConfigArgs', 'DeploymentTargetConfigArgsDict', 'DeploymentTargetImportArgs', 'DeploymentTargetImportArgsDict']
...
class DeploymentTargetArgs:
    def __init__(__self__, *, config: pulumi.Input[DeploymentTargetConfigArgs], imports: Optional[pulumi.Input[Sequence[pulumi.Input[DeploymentTargetImportArgs]]]] = ...) -> None:
    ...
    @config.setter
    def config(self, value: pulumi.Input[DeploymentTargetConfigArgs]): # -> None:
        ...
    ...
    @imports.setter
    def imports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DeploymentTargetImportArgs]]]]): # -> None:
        ...
...
class DeploymentTargetImportArgs:
    def __init__(__self__, *, content: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
