...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccessApprovalSettingsEnrolledServiceArgs', 'AccessApprovalSettingsEnrolledServiceArgsDict', 'IAMBindingConditionArgs', 'IAMBindingConditionArgsDict', 'IAMMemberConditionArgs', 'IAMMemberConditionArgsDict', 'IamAuditConfigAuditLogConfigArgs', 'IamAuditConfigAuditLogConfigArgsDict', 'PolicyBooleanPolicyArgs', 'PolicyBooleanPolicyArgsDict', 'PolicyListPolicyArgs', 'PolicyListPolicyArgsDict', 'PolicyListPolicyAllowArgs', 'PolicyListPolicyAllowArgsDict', 'PolicyListPolicyDenyArgs', 'PolicyListPolicyDenyArgsDict', 'PolicyRestorePolicyArgs', 'PolicyRestorePolicyArgsDict', 'GetIAMPolicyAuditConfigArgs', 'GetIAMPolicyAuditConfigArgsDict', 'GetIAMPolicyAuditConfigAuditLogConfigArgs', 'GetIAMPolicyAuditConfigAuditLogConfigArgsDict', 'GetIAMPolicyBindingArgs', 'GetIAMPolicyBindingArgsDict', 'GetIAMPolicyBindingConditionArgs', 'GetIAMPolicyBindingConditionArgsDict']
...
class PolicyListPolicyArgs:
    def __init__(__self__, *, allow: Optional[pulumi.Input[PolicyListPolicyAllowArgs]] = ..., deny: Optional[pulumi.Input[PolicyListPolicyDenyArgs]] = ..., inherit_from_parent: Optional[pulumi.Input[_builtins.bool]] = ..., suggested_value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @allow.setter
    def allow(self, value: Optional[pulumi.Input[PolicyListPolicyAllowArgs]]): # -> None:
        ...
    ...
    @deny.setter
    def deny(self, value: Optional[pulumi.Input[PolicyListPolicyDenyArgs]]): # -> None:
        ...
...
class GetIAMPolicyAuditConfigArgs:
    def __init__(__self__, *, audit_log_configs: Sequence[GetIAMPolicyAuditConfigAuditLogConfigArgs], service: _builtins.str) -> None:
    ...
    def audit_log_configs(self, value: Sequence[GetIAMPolicyAuditConfigAuditLogConfigArgs]): # -> None:
        ...
    ...
    @service.setter
    def service(self, value: _builtins.str): # -> None:
        ...
...
class GetIAMPolicyAuditConfigAuditLogConfigArgs:
    ...
    @log_type.setter
    def log_type(self, value: _builtins.str): # -> None:
        ...
    ...
    @exempted_members.setter
    def exempted_members(self, value: Optional[Sequence[_builtins.str]]): # -> None:
        ...
...
class GetIAMPolicyBindingArgs:
    def __init__(__self__, *, members: Sequence[_builtins.str], role: _builtins.str, condition: Optional[GetIAMPolicyBindingConditionArgs] = ...) -> None:
    ...
    @members.setter
    def members(self, value: Sequence[_builtins.str]): # -> None:
        ...
    ...
    @condition.setter
    def condition(self, value: Optional[GetIAMPolicyBindingConditionArgs]): # -> None:
        ...
...
class GetIAMPolicyBindingConditionArgs:
    ...
    @expression.setter
    def expression(self, value: _builtins.str): # -> None:
        ...
    ...
    @title.setter
    def title(self, value: _builtins.str): # -> None:
        ...
