...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BitbucketServerConfigConnectedRepositoryArgs', 'BitbucketServerConfigConnectedRepositoryArgsDict', 'BitbucketServerConfigSecretsArgs', 'BitbucketServerConfigSecretsArgsDict', 'TriggerApprovalConfigArgs', 'TriggerApprovalConfigArgsDict', 'TriggerBitbucketServerTriggerConfigArgs', 'TriggerBitbucketServerTriggerConfigArgsDict', 'TriggerBitbucketServerTriggerConfigPullRequestArgs', ..., 'TriggerBitbucketServerTriggerConfigPushArgs', 'TriggerBitbucketServerTriggerConfigPushArgsDict', 'TriggerBuildArgs', 'TriggerBuildArgsDict', 'TriggerBuildArtifactsArgs', 'TriggerBuildArtifactsArgsDict', 'TriggerBuildArtifactsMavenArtifactArgs', 'TriggerBuildArtifactsMavenArtifactArgsDict', 'TriggerBuildArtifactsNpmPackageArgs', 'TriggerBuildArtifactsNpmPackageArgsDict', 'TriggerBuildArtifactsObjectsArgs', 'TriggerBuildArtifactsObjectsArgsDict', 'TriggerBuildArtifactsObjectsTimingArgs', 'TriggerBuildArtifactsObjectsTimingArgsDict', 'TriggerBuildArtifactsPythonPackageArgs', 'TriggerBuildArtifactsPythonPackageArgsDict', 'TriggerBuildAvailableSecretsArgs', 'TriggerBuildAvailableSecretsArgsDict', 'TriggerBuildAvailableSecretsSecretManagerArgs', 'TriggerBuildAvailableSecretsSecretManagerArgsDict', 'TriggerBuildOptionsArgs', 'TriggerBuildOptionsArgsDict', 'TriggerBuildOptionsVolumeArgs', 'TriggerBuildOptionsVolumeArgsDict', 'TriggerBuildSecretArgs', 'TriggerBuildSecretArgsDict', 'TriggerBuildSourceArgs', 'TriggerBuildSourceArgsDict', 'TriggerBuildSourceRepoSourceArgs', 'TriggerBuildSourceRepoSourceArgsDict', 'TriggerBuildSourceStorageSourceArgs', 'TriggerBuildSourceStorageSourceArgsDict', 'TriggerBuildStepArgs', 'TriggerBuildStepArgsDict', 'TriggerBuildStepVolumeArgs', 'TriggerBuildStepVolumeArgsDict', 'TriggerDeveloperConnectEventConfigArgs', 'TriggerDeveloperConnectEventConfigArgsDict', 'TriggerDeveloperConnectEventConfigPullRequestArgs', ..., 'TriggerDeveloperConnectEventConfigPushArgs', 'TriggerDeveloperConnectEventConfigPushArgsDict', 'TriggerGitFileSourceArgs', 'TriggerGitFileSourceArgsDict', 'TriggerGithubArgs', 'TriggerGithubArgsDict', 'TriggerGithubPullRequestArgs', 'TriggerGithubPullRequestArgsDict', 'TriggerGithubPushArgs', 'TriggerGithubPushArgsDict', 'TriggerPubsubConfigArgs', 'TriggerPubsubConfigArgsDict', 'TriggerRepositoryEventConfigArgs', 'TriggerRepositoryEventConfigArgsDict', 'TriggerRepositoryEventConfigPullRequestArgs', 'TriggerRepositoryEventConfigPullRequestArgsDict', 'TriggerRepositoryEventConfigPushArgs', 'TriggerRepositoryEventConfigPushArgsDict', 'TriggerSourceToBuildArgs', 'TriggerSourceToBuildArgsDict', 'TriggerTriggerTemplateArgs', 'TriggerTriggerTemplateArgsDict', 'TriggerWebhookConfigArgs', 'TriggerWebhookConfigArgsDict', 'WorkerPoolNetworkConfigArgs', 'WorkerPoolNetworkConfigArgsDict', 'WorkerPoolPrivateServiceConnectArgs', 'WorkerPoolPrivateServiceConnectArgsDict', 'WorkerPoolWorkerConfigArgs', 'WorkerPoolWorkerConfigArgsDict']
...
class BitbucketServerConfigConnectedRepositoryArgs:
    def __init__(__self__, *, project_key: pulumi.Input[_builtins.str], repo_slug: pulumi.Input[_builtins.str]) -> None:
    ...
    @repo_slug.setter
    def repo_slug(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BitbucketServerConfigSecretsArgs:
    def __init__(__self__, *, admin_access_token_version_name: pulumi.Input[_builtins.str], read_access_token_version_name: pulumi.Input[_builtins.str], webhook_secret_version_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def admin_access_token_version_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def read_access_token_version_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def webhook_secret_version_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TriggerApprovalConfigArgs:
    def __init__(__self__, *, approval_required: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def approval_required(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class TriggerBitbucketServerTriggerConfigArgs:
    def __init__(__self__, *, bitbucket_server_config_resource: pulumi.Input[_builtins.str], project_key: pulumi.Input[_builtins.str], repo_slug: pulumi.Input[_builtins.str], pull_request: Optional[pulumi.Input[TriggerBitbucketServerTriggerConfigPullRequestArgs]] = ..., push: Optional[pulumi.Input[TriggerBitbucketServerTriggerConfigPushArgs]] = ...) -> None:
    ...
    def bitbucket_server_config_resource(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @pull_request.setter
    def pull_request(self, value: Optional[pulumi.Input[TriggerBitbucketServerTriggerConfigPullRequestArgs]]): # -> None:
        ...
    ...
    @push.setter
    def push(self, value: Optional[pulumi.Input[TriggerBitbucketServerTriggerConfigPushArgs]]): # -> None:
        ...
...
class TriggerBitbucketServerTriggerConfigPullRequestArgs:
    def __init__(__self__, *, branch: pulumi.Input[_builtins.str], comment_control: Optional[pulumi.Input[_builtins.str]] = ..., invert_regex: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @branch.setter
    def branch(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def comment_control(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @invert_regex.setter
    def invert_regex(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class TriggerBitbucketServerTriggerConfigPushArgs:
    def __init__(__self__, *, branch: Optional[pulumi.Input[_builtins.str]] = ..., invert_regex: Optional[pulumi.Input[_builtins.bool]] = ..., tag: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TriggerBuildArgs:
    def __init__(__self__, *, steps: pulumi.Input[Sequence[pulumi.Input[TriggerBuildStepArgs]]], artifacts: Optional[pulumi.Input[TriggerBuildArtifactsArgs]] = ..., available_secrets: Optional[pulumi.Input[TriggerBuildAvailableSecretsArgs]] = ..., images: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logs_bucket: Optional[pulumi.Input[_builtins.str]] = ..., options: Optional[pulumi.Input[TriggerBuildOptionsArgs]] = ..., queue_ttl: Optional[pulumi.Input[_builtins.str]] = ..., secrets: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildSecretArgs]]]] = ..., source: Optional[pulumi.Input[TriggerBuildSourceArgs]] = ..., substitutions: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @steps.setter
    def steps(self, value: pulumi.Input[Sequence[pulumi.Input[TriggerBuildStepArgs]]]): # -> None:
        ...
    ...
    @artifacts.setter
    def artifacts(self, value: Optional[pulumi.Input[TriggerBuildArtifactsArgs]]): # -> None:
        ...
    ...
    def available_secrets(self, value: Optional[pulumi.Input[TriggerBuildAvailableSecretsArgs]]): # -> None:
        ...
    ...
    @images.setter
    def images(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @logs_bucket.setter
    def logs_bucket(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @options.setter
    def options(self, value: Optional[pulumi.Input[TriggerBuildOptionsArgs]]): # -> None:
        ...
    ...
    @queue_ttl.setter
    def queue_ttl(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @secrets.setter
    def secrets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildSecretArgs]]]]): # -> None:
        ...
    ...
    @source.setter
    def source(self, value: Optional[pulumi.Input[TriggerBuildSourceArgs]]): # -> None:
        ...
    ...
    def substitutions(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class TriggerBuildArtifactsArgs:
    def __init__(__self__, *, images: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., maven_artifacts: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildArtifactsMavenArtifactArgs]]]] = ..., npm_packages: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildArtifactsNpmPackageArgs]]]] = ..., objects: Optional[pulumi.Input[TriggerBuildArtifactsObjectsArgs]] = ..., python_packages: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildArtifactsPythonPackageArgs]]]] = ...) -> None:
    ...
    def maven_artifacts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildArtifactsMavenArtifactArgs]]]]): # -> None:
        ...
    ...
    @npm_packages.setter
    def npm_packages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildArtifactsNpmPackageArgs]]]]): # -> None:
        ...
    ...
    @objects.setter
    def objects(self, value: Optional[pulumi.Input[TriggerBuildArtifactsObjectsArgs]]): # -> None:
        ...
    ...
    def python_packages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildArtifactsPythonPackageArgs]]]]): # -> None:
        ...
...
class TriggerBuildArtifactsMavenArtifactArgs:
    def __init__(__self__, *, artifact_id: Optional[pulumi.Input[_builtins.str]] = ..., group_id: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., repository: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TriggerBuildArtifactsNpmPackageArgs:
    def __init__(__self__, *, package_path: Optional[pulumi.Input[_builtins.str]] = ..., repository: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @package_path.setter
    def package_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TriggerBuildArtifactsObjectsArgs:
    def __init__(__self__, *, location: Optional[pulumi.Input[_builtins.str]] = ..., paths: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., timings: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildArtifactsObjectsTimingArgs]]]] = ...) -> None:
    ...
    @timings.setter
    def timings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildArtifactsObjectsTimingArgs]]]]): # -> None:
        ...
...
class TriggerBuildArtifactsPythonPackageArgs:
    def __init__(__self__, *, paths: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., repository: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TriggerBuildAvailableSecretsArgs:
    def __init__(__self__, *, secret_managers: pulumi.Input[Sequence[pulumi.Input[TriggerBuildAvailableSecretsSecretManagerArgs]]]) -> None:
    ...
    def secret_managers(self, value: pulumi.Input[Sequence[pulumi.Input[TriggerBuildAvailableSecretsSecretManagerArgs]]]): # -> None:
        ...
...
class TriggerBuildAvailableSecretsSecretManagerArgs:
    def __init__(__self__, *, env: pulumi.Input[_builtins.str], version_name: pulumi.Input[_builtins.str]) -> None:
    ...
    @env.setter
    def env(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TriggerBuildOptionsArgsDict(TypedDict):
    ...
    source_provenance_hashes: NotRequired[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]
...
class TriggerBuildOptionsArgs:
    def __init__(__self__, *, disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., dynamic_substitutions: Optional[pulumi.Input[_builtins.bool]] = ..., envs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., log_streaming_option: Optional[pulumi.Input[_builtins.str]] = ..., logging: Optional[pulumi.Input[_builtins.str]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., requested_verify_option: Optional[pulumi.Input[_builtins.str]] = ..., secret_envs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., source_provenance_hashes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., substitution_option: Optional[pulumi.Input[_builtins.str]] = ..., volumes: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildOptionsVolumeArgs]]]] = ..., worker_pool: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dynamic_substitutions(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @envs.setter
    def envs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def log_streaming_option(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def requested_verify_option(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="secretEnvs")
    def secret_envs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @secret_envs.setter
    def secret_envs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="sourceProvenanceHashes")
    def source_provenance_hashes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @source_provenance_hashes.setter
    def source_provenance_hashes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def substitution_option(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @volumes.setter
    def volumes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildOptionsVolumeArgs]]]]): # -> None:
        ...
...
class TriggerBuildOptionsVolumeArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TriggerBuildSecretArgs:
    def __init__(__self__, *, kms_key_name: pulumi.Input[_builtins.str], secret_env: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def secret_env(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @secret_env.setter
    def secret_env(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class TriggerBuildSourceArgs:
    def __init__(__self__, *, repo_source: Optional[pulumi.Input[TriggerBuildSourceRepoSourceArgs]] = ..., storage_source: Optional[pulumi.Input[TriggerBuildSourceStorageSourceArgs]] = ...) -> None:
    ...
    @repo_source.setter
    def repo_source(self, value: Optional[pulumi.Input[TriggerBuildSourceRepoSourceArgs]]): # -> None:
        ...
    ...
    def storage_source(self, value: Optional[pulumi.Input[TriggerBuildSourceStorageSourceArgs]]): # -> None:
        ...
...
class TriggerBuildSourceRepoSourceArgs:
    def __init__(__self__, *, repo_name: pulumi.Input[_builtins.str], branch_name: Optional[pulumi.Input[_builtins.str]] = ..., commit_sha: Optional[pulumi.Input[_builtins.str]] = ..., dir: Optional[pulumi.Input[_builtins.str]] = ..., invert_regex: Optional[pulumi.Input[_builtins.bool]] = ..., project_id: Optional[pulumi.Input[_builtins.str]] = ..., substitutions: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., tag_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @dir.setter
    def dir(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TriggerBuildStepArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], allow_exit_codes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ..., allow_failure: Optional[pulumi.Input[_builtins.bool]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., dir: Optional[pulumi.Input[_builtins.str]] = ..., entrypoint: Optional[pulumi.Input[_builtins.str]] = ..., envs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., script: Optional[pulumi.Input[_builtins.str]] = ..., secret_envs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ..., timing: Optional[pulumi.Input[_builtins.str]] = ..., volumes: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildStepVolumeArgs]]]] = ..., wait_fors: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allow_exit_codes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]:
        
        ...
    
    @allow_exit_codes.setter
    def allow_exit_codes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]): # -> None:
        ...
    ...
    def allow_failure(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @timing.setter
    def timing(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @volumes.setter
    def volumes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TriggerBuildStepVolumeArgs]]]]): # -> None:
        ...
    
    @_builtins.property
    @pulumi.getter(name="waitFors")
    def wait_fors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        
        ...
    
    @wait_fors.setter
    def wait_fors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class TriggerBuildStepVolumeArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], path: pulumi.Input[_builtins.str]) -> None:
...
class TriggerDeveloperConnectEventConfigArgs:
    def __init__(__self__, *, git_repository_link: pulumi.Input[_builtins.str], git_repository_link_type: Optional[pulumi.Input[_builtins.str]] = ..., pull_request: Optional[pulumi.Input[TriggerDeveloperConnectEventConfigPullRequestArgs]] = ..., push: Optional[pulumi.Input[TriggerDeveloperConnectEventConfigPushArgs]] = ...) -> None:
    ...
    def git_repository_link_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @pull_request.setter
    def pull_request(self, value: Optional[pulumi.Input[TriggerDeveloperConnectEventConfigPullRequestArgs]]): # -> None:
        ...
    ...
    @push.setter
    def push(self, value: Optional[pulumi.Input[TriggerDeveloperConnectEventConfigPushArgs]]): # -> None:
        ...
...
class TriggerDeveloperConnectEventConfigPullRequestArgs:
    def __init__(__self__, *, branch: Optional[pulumi.Input[_builtins.str]] = ..., comment_control: Optional[pulumi.Input[_builtins.str]] = ..., invert_regex: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class TriggerGitFileSourceArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], repo_type: pulumi.Input[_builtins.str], bitbucket_server_config: Optional[pulumi.Input[_builtins.str]] = ..., github_enterprise_config: Optional[pulumi.Input[_builtins.str]] = ..., repository: Optional[pulumi.Input[_builtins.str]] = ..., revision: Optional[pulumi.Input[_builtins.str]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def bitbucket_server_config(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def github_enterprise_config(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TriggerGithubArgs:
    def __init__(__self__, *, enterprise_config_resource_name: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., owner: Optional[pulumi.Input[_builtins.str]] = ..., pull_request: Optional[pulumi.Input[TriggerGithubPullRequestArgs]] = ..., push: Optional[pulumi.Input[TriggerGithubPushArgs]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="enterpriseConfigResourceName")
    def enterprise_config_resource_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @enterprise_config_resource_name.setter
    def enterprise_config_resource_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @pull_request.setter
    def pull_request(self, value: Optional[pulumi.Input[TriggerGithubPullRequestArgs]]): # -> None:
        ...
    ...
    @push.setter
    def push(self, value: Optional[pulumi.Input[TriggerGithubPushArgs]]): # -> None:
        ...
...
class TriggerPubsubConfigArgs:
    def __init__(__self__, *, topic: pulumi.Input[_builtins.str], service_account_email: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., subscription: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @subscription.setter
    def subscription(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TriggerRepositoryEventConfigArgs:
    def __init__(__self__, *, pull_request: Optional[pulumi.Input[TriggerRepositoryEventConfigPullRequestArgs]] = ..., push: Optional[pulumi.Input[TriggerRepositoryEventConfigPushArgs]] = ..., repository: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @pull_request.setter
    def pull_request(self, value: Optional[pulumi.Input[TriggerRepositoryEventConfigPullRequestArgs]]): # -> None:
        ...
    ...
    @push.setter
    def push(self, value: Optional[pulumi.Input[TriggerRepositoryEventConfigPushArgs]]): # -> None:
        ...
...
class TriggerSourceToBuildArgs:
    def __init__(__self__, *, ref: pulumi.Input[_builtins.str], repo_type: pulumi.Input[_builtins.str], bitbucket_server_config: Optional[pulumi.Input[_builtins.str]] = ..., github_enterprise_config: Optional[pulumi.Input[_builtins.str]] = ..., repository: Optional[pulumi.Input[_builtins.str]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ref.setter
    def ref(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TriggerTriggerTemplateArgs:
    def __init__(__self__, *, branch_name: Optional[pulumi.Input[_builtins.str]] = ..., commit_sha: Optional[pulumi.Input[_builtins.str]] = ..., dir: Optional[pulumi.Input[_builtins.str]] = ..., invert_regex: Optional[pulumi.Input[_builtins.bool]] = ..., project_id: Optional[pulumi.Input[_builtins.str]] = ..., repo_name: Optional[pulumi.Input[_builtins.str]] = ..., tag_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @repo_name.setter
    def repo_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TriggerWebhookConfigArgs:
    def __init__(__self__, *, secret: pulumi.Input[_builtins.str], state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkerPoolNetworkConfigArgs:
    def __init__(__self__, *, peered_network: pulumi.Input[_builtins.str], peered_network_ip_range: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def peered_network(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def peered_network_ip_range(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkerPoolPrivateServiceConnectArgs:
    def __init__(__self__, *, network_attachment: pulumi.Input[_builtins.str], route_all_traffic: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def route_all_traffic(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class WorkerPoolWorkerConfigArgs:
    def __init__(__self__, *, disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., enable_nested_virtualization: Optional[pulumi.Input[_builtins.bool]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., no_external_ip: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def no_external_ip(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
