...
class _CertificateMapState:
    def __init__(
        ...
        *,
        ...
        gclb_targets: Optional[
            pulumi.Input[Sequence[pulumi.Input[CertificateMapGclbTargetArgs]]]
        ] = ...,
        labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
...
class CertificateMap(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[CertificateMapArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
    ...
    def gclb_targets(
        self,
    ) -> pulumi.Output[Sequence[outputs.CertificateMapGclbTarget]]: ...
    @_builtins.property
    @pulumi.getter
