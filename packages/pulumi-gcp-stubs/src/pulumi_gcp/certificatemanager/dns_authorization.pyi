...
class _DnsAuthorizationState:
    def __init__(
        ...
        *,
        description: Optional[pulumi.Input[_builtins.str]] = ...,
        dns_resource_records: Optional[
            pulumi.Input[Sequence[pulumi.Input[DnsAuthorizationDnsResourceRecordArgs]]]
        ] = ...,
...
class DnsAuthorization(pulumi.CustomResource):
    ...
    def dns_resource_records(
        self,
    ) -> pulumi.Output[Sequence[outputs.DnsAuthorizationDnsResourceRecord]]: ...
    @_builtins.property
    @pulumi.getter
