...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = [..., ..., ..., ..., 'CertificateManagedArgs', 'CertificateManagedArgsDict', 'CertificateManagedAuthorizationAttemptInfoArgs', 'CertificateManagedAuthorizationAttemptInfoArgsDict', 'CertificateManagedProvisioningIssueArgs', 'CertificateManagedProvisioningIssueArgsDict', 'CertificateMapGclbTargetArgs', 'CertificateMapGclbTargetArgsDict', 'CertificateMapGclbTargetIpConfigArgs', 'CertificateMapGclbTargetIpConfigArgsDict', 'CertificateSelfManagedArgs', 'CertificateSelfManagedArgsDict', 'DnsAuthorizationDnsResourceRecordArgs', 'DnsAuthorizationDnsResourceRecordArgsDict', 'TrustConfigAllowlistedCertificateArgs', 'TrustConfigAllowlistedCertificateArgsDict', 'TrustConfigTrustStoreArgs', 'TrustConfigTrustStoreArgsDict', 'TrustConfigTrustStoreIntermediateCaArgs', 'TrustConfigTrustStoreIntermediateCaArgsDict', 'TrustConfigTrustStoreTrustAnchorArgs', 'TrustConfigTrustStoreTrustAnchorArgsDict']
...
class CertificateIssuanceConfigCertificateAuthorityConfigArgs:
    def __init__(__self__, *, certificate_authority_service_config: Optional[pulumi.Input[CertificateIssuanceConfigCertificateAuthorityConfigCertificateAuthorityServiceConfigArgs]] = ...) -> None:
    ...
    def certificate_authority_service_config(self, value: Optional[pulumi.Input[CertificateIssuanceConfigCertificateAuthorityConfigCertificateAuthorityServiceConfigArgs]]): # -> None:
        ...
...
class CertificateManagedArgs:
    def __init__(__self__, *, authorization_attempt_infos: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateManagedAuthorizationAttemptInfoArgs]]]] = ..., dns_authorizations: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., domains: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., issuance_config: Optional[pulumi.Input[_builtins.str]] = ..., provisioning_issues: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateManagedProvisioningIssueArgs]]]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authorization_attempt_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateManagedAuthorizationAttemptInfoArgs]]]]): # -> None:
        ...
    ...
    def dns_authorizations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def issuance_config(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def provisioning_issues(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateManagedProvisioningIssueArgs]]]]): # -> None:
        ...
...
class CertificateManagedAuthorizationAttemptInfoArgs:
    def __init__(__self__, *, details: Optional[pulumi.Input[_builtins.str]] = ..., domain: Optional[pulumi.Input[_builtins.str]] = ..., failure_reason: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CertificateManagedProvisioningIssueArgs:
    def __init__(__self__, *, details: Optional[pulumi.Input[_builtins.str]] = ..., reason: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CertificateMapGclbTargetArgs:
    def __init__(__self__, *, ip_configs: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateMapGclbTargetIpConfigArgs]]]] = ..., target_https_proxy: Optional[pulumi.Input[_builtins.str]] = ..., target_ssl_proxy: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ip_configs.setter
    def ip_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateMapGclbTargetIpConfigArgs]]]]): # -> None:
        ...
    ...
    def target_https_proxy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_ssl_proxy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CertificateMapGclbTargetIpConfigArgs:
    def __init__(__self__, *, ip_address: Optional[pulumi.Input[_builtins.str]] = ..., ports: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ...) -> None:
...
class CertificateSelfManagedArgs:
    def __init__(__self__, *, certificate_pem: Optional[pulumi.Input[_builtins.str]] = ..., pem_certificate: Optional[pulumi.Input[_builtins.str]] = ..., pem_private_key: Optional[pulumi.Input[_builtins.str]] = ..., private_key_pem: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def certificate_pem(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def pem_private_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def private_key_pem(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DnsAuthorizationDnsResourceRecordArgs:
    def __init__(__self__, *, data: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TrustConfigTrustStoreArgs:
    def __init__(__self__, *, intermediate_cas: Optional[pulumi.Input[Sequence[pulumi.Input[TrustConfigTrustStoreIntermediateCaArgs]]]] = ..., trust_anchors: Optional[pulumi.Input[Sequence[pulumi.Input[TrustConfigTrustStoreTrustAnchorArgs]]]] = ...) -> None:
    ...
    def intermediate_cas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TrustConfigTrustStoreIntermediateCaArgs]]]]): # -> None:
        ...
    ...
    def trust_anchors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TrustConfigTrustStoreTrustAnchorArgs]]]]): # -> None:
        ...
