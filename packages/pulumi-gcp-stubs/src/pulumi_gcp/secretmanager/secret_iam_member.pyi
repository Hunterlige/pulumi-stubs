...
class SecretIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[SecretIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[SecretIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class SecretIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[SecretIamMemberConditionArgs, SecretIamMemberConditionArgsDict]
            ]
        ] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.SecretIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
