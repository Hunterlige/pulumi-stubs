...
class RegionalSecretIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[RegionalSecretIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[RegionalSecretIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[RegionalSecretIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class RegionalSecretIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.RegionalSecretIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
