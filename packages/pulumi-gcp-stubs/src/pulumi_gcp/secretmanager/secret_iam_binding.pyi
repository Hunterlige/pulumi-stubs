...
class SecretIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[SecretIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[SecretIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class SecretIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[SecretIamBindingConditionArgs, SecretIamBindingConditionArgsDict]
            ]
        ] = ...,
        members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.SecretIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
