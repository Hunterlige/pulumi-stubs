...
class RegionalSecretIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[RegionalSecretIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[RegionalSecretIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[RegionalSecretIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class RegionalSecretIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.RegionalSecretIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
