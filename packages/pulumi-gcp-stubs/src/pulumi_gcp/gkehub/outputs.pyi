...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FeatureFleetDefaultMemberConfig', 'FeatureFleetDefaultMemberConfigConfigmanagement', ..., ..., ..., 'FeatureFleetDefaultMemberConfigMesh', 'FeatureFleetDefaultMemberConfigPolicycontroller', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'FeatureIamBindingCondition', 'FeatureIamMemberCondition', 'FeatureMembershipConfigmanagement', 'FeatureMembershipConfigmanagementConfigSync', ..., ..., 'FeatureMembershipConfigmanagementConfigSyncGit', 'FeatureMembershipConfigmanagementConfigSyncOci', ..., 'FeatureMembershipConfigmanagementPolicyController', ..., 'FeatureMembershipMesh', 'FeatureMembershipPolicycontroller', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'FeatureResourceState', 'FeatureSpec', 'FeatureSpecClusterupgrade', 'FeatureSpecClusterupgradeGkeUpgradeOverride', ..., 'FeatureSpecClusterupgradeGkeUpgradeOverrideUpgrade', 'FeatureSpecClusterupgradePostConditions', 'FeatureSpecFleetobservability', 'FeatureSpecFleetobservabilityLoggingConfig', ..., ..., 'FeatureSpecMulticlusteringress', 'FeatureSpecRbacrolebindingactuation', 'FeatureSpecWorkloadidentity', 'FeatureState', 'FeatureStateState', 'FleetDefaultClusterConfig', 'FleetDefaultClusterConfigBinaryAuthorizationConfig', ..., 'FleetDefaultClusterConfigSecurityPostureConfig', 'FleetState', 'MembershipAuthority', 'MembershipBindingState', 'MembershipEndpoint', 'MembershipEndpointGkeCluster', 'MembershipIamBindingCondition', 'MembershipIamMemberCondition', 'MembershipRbacRoleBindingRole', 'MembershipRbacRoleBindingState', 'NamespaceState', 'RolloutSequenceStage', 'RolloutSequenceStageClusterSelector', 'ScopeIamBindingCondition', 'ScopeIamMemberCondition', 'ScopeRbacRoleBindingRole', 'ScopeRbacRoleBindingState', 'ScopeState', 'GetFeatureFleetDefaultMemberConfigResult', ..., ..., ..., ..., 'GetFeatureFleetDefaultMemberConfigMeshResult', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetFeatureResourceStateResult', 'GetFeatureSpecResult', 'GetFeatureSpecClusterupgradeResult', ..., ..., ..., 'GetFeatureSpecClusterupgradePostConditionResult', 'GetFeatureSpecFleetobservabilityResult', ..., ..., ..., 'GetFeatureSpecMulticlusteringressResult', 'GetFeatureSpecRbacrolebindingactuationResult', 'GetFeatureSpecWorkloadidentityResult', 'GetFeatureStateResult', 'GetFeatureStateStateResult', 'GetMembershipAuthorityResult', 'GetMembershipBindingStateResult', 'GetMembershipEndpointResult', 'GetMembershipEndpointGkeClusterResult']
@pulumi.output_type
class FeatureFleetDefaultMemberConfig(dict):
    def __init__(__self__, *, configmanagement: Optional[outputs.FeatureFleetDefaultMemberConfigConfigmanagement] = ..., mesh: Optional[outputs.FeatureFleetDefaultMemberConfigMesh] = ..., policycontroller: Optional[outputs.FeatureFleetDefaultMemberConfigPolicycontroller] = ...) -> None:
...
class FeatureFleetDefaultMemberConfigConfigmanagement(dict):
    ...
    def __init__(__self__, *, config_sync: Optional[outputs.FeatureFleetDefaultMemberConfigConfigmanagementConfigSync] = ..., management: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class FeatureFleetDefaultMemberConfigConfigmanagementConfigSync(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., git: Optional[outputs.FeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGit] = ..., metrics_gcp_service_account_email: Optional[_builtins.str] = ..., oci: Optional[outputs.FeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOci] = ..., prevent_drift: Optional[_builtins.bool] = ..., source_format: Optional[_builtins.str] = ...) -> None:
...
class FeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGit(dict):
    ...
    def __init__(__self__, *, secret_type: _builtins.str, gcp_service_account_email: Optional[_builtins.str] = ..., https_proxy: Optional[_builtins.str] = ..., policy_dir: Optional[_builtins.str] = ..., sync_branch: Optional[_builtins.str] = ..., sync_repo: Optional[_builtins.str] = ..., sync_rev: Optional[_builtins.str] = ..., sync_wait_secs: Optional[_builtins.str] = ...) -> None:
...
class FeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOci(dict):
    ...
    def __init__(__self__, *, secret_type: _builtins.str, gcp_service_account_email: Optional[_builtins.str] = ..., policy_dir: Optional[_builtins.str] = ..., sync_repo: Optional[_builtins.str] = ..., sync_wait_secs: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class FeatureFleetDefaultMemberConfigPolicycontroller(dict):
    ...
    def __init__(__self__, *, policy_controller_hub_config: outputs.FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfig, version: Optional[_builtins.str] = ...) -> None:
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfig(dict):
    ...
    def __init__(__self__, *, install_spec: _builtins.str, audit_interval_seconds: Optional[_builtins.int] = ..., constraint_violation_limit: Optional[_builtins.int] = ..., deployment_configs: Optional[Sequence[outputs.FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfig]] = ..., exemptable_namespaces: Optional[Sequence[_builtins.str]] = ..., log_denies_enabled: Optional[_builtins.bool] = ..., monitoring: Optional[outputs.FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoring] = ..., mutation_enabled: Optional[_builtins.bool] = ..., policy_content: Optional[outputs.FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContent] = ..., referential_rules_enabled: Optional[_builtins.bool] = ...) -> None:
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfig(dict):
    ...
    def __init__(__self__, *, component: _builtins.str, container_resources: Optional[outputs.FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResources] = ..., pod_affinity: Optional[_builtins.str] = ..., pod_tolerations: Optional[Sequence[outputs.FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigPodToleration]] = ..., replica_count: Optional[_builtins.int] = ...) -> None:
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResources(dict):
    def __init__(__self__, *, limits: Optional[outputs.FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResourcesLimits] = ..., requests: Optional[outputs.FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResourcesRequests] = ...) -> None:
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoring(dict):
    def __init__(__self__, *, backends: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContent(dict):
    ...
    def __init__(__self__, *, bundles: Optional[Sequence[outputs.FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentBundle]] = ..., template_library: Optional[outputs.FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibrary] = ...) -> None:
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentBundle(dict):
    ...
    def __init__(__self__, *, bundle: _builtins.str, exempted_namespaces: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FeatureMembershipConfigmanagement(dict):
    ...
    def __init__(__self__, *, config_sync: Optional[outputs.FeatureMembershipConfigmanagementConfigSync] = ..., hierarchy_controller: Optional[outputs.FeatureMembershipConfigmanagementHierarchyController] = ..., management: Optional[_builtins.str] = ..., policy_controller: Optional[outputs.FeatureMembershipConfigmanagementPolicyController] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class FeatureMembershipConfigmanagementConfigSync(dict):
    ...
    def __init__(__self__, *, deployment_overrides: Optional[Sequence[outputs.FeatureMembershipConfigmanagementConfigSyncDeploymentOverride]] = ..., enabled: Optional[_builtins.bool] = ..., git: Optional[outputs.FeatureMembershipConfigmanagementConfigSyncGit] = ..., metrics_gcp_service_account_email: Optional[_builtins.str] = ..., oci: Optional[outputs.FeatureMembershipConfigmanagementConfigSyncOci] = ..., prevent_drift: Optional[_builtins.bool] = ..., source_format: Optional[_builtins.str] = ..., stop_syncing: Optional[_builtins.bool] = ...) -> None:
...
class FeatureMembershipConfigmanagementConfigSyncDeploymentOverride(dict):
    ...
    def __init__(__self__, *, containers: Optional[Sequence[outputs.FeatureMembershipConfigmanagementConfigSyncDeploymentOverrideContainer]] = ..., deployment_name: Optional[_builtins.str] = ..., deployment_namespace: Optional[_builtins.str] = ...) -> None:
...
class FeatureMembershipConfigmanagementConfigSyncDeploymentOverrideContainer(dict):
    ...
    def __init__(__self__, *, container_name: Optional[_builtins.str] = ..., cpu_limit: Optional[_builtins.str] = ..., cpu_request: Optional[_builtins.str] = ..., memory_limit: Optional[_builtins.str] = ..., memory_request: Optional[_builtins.str] = ...) -> None:
...
class FeatureMembershipConfigmanagementConfigSyncGit(dict):
    ...
    def __init__(__self__, *, gcp_service_account_email: Optional[_builtins.str] = ..., https_proxy: Optional[_builtins.str] = ..., policy_dir: Optional[_builtins.str] = ..., secret_type: Optional[_builtins.str] = ..., sync_branch: Optional[_builtins.str] = ..., sync_repo: Optional[_builtins.str] = ..., sync_rev: Optional[_builtins.str] = ..., sync_wait_secs: Optional[_builtins.str] = ...) -> None:
...
class FeatureMembershipConfigmanagementConfigSyncOci(dict):
    ...
    def __init__(__self__, *, gcp_service_account_email: Optional[_builtins.str] = ..., policy_dir: Optional[_builtins.str] = ..., secret_type: Optional[_builtins.str] = ..., sync_repo: Optional[_builtins.str] = ..., sync_wait_secs: Optional[_builtins.str] = ...) -> None:
...
class FeatureMembershipConfigmanagementHierarchyController(dict):
    ...
    def __init__(__self__, *, enable_hierarchical_resource_quota: Optional[_builtins.bool] = ..., enable_pod_tree_labels: Optional[_builtins.bool] = ..., enabled: Optional[_builtins.bool] = ...) -> None:
...
class FeatureMembershipConfigmanagementPolicyController(dict):
    ...
    def __init__(__self__, *, audit_interval_seconds: Optional[_builtins.str] = ..., enabled: Optional[_builtins.bool] = ..., exemptable_namespaces: Optional[Sequence[_builtins.str]] = ..., log_denies_enabled: Optional[_builtins.bool] = ..., monitoring: Optional[outputs.FeatureMembershipConfigmanagementPolicyControllerMonitoring] = ..., mutation_enabled: Optional[_builtins.bool] = ..., referential_rules_enabled: Optional[_builtins.bool] = ..., template_library_installed: Optional[_builtins.bool] = ...) -> None:
...
class FeatureMembershipMesh(dict):
    ...
    def __init__(__self__, *, control_plane: Optional[_builtins.str] = ..., management: Optional[_builtins.str] = ...) -> None:
...
class FeatureMembershipPolicycontroller(dict):
    ...
    def __init__(__self__, *, policy_controller_hub_config: outputs.FeatureMembershipPolicycontrollerPolicyControllerHubConfig, version: Optional[_builtins.str] = ...) -> None:
...
class FeatureMembershipPolicycontrollerPolicyControllerHubConfig(dict):
    ...
    def __init__(__self__, *, audit_interval_seconds: Optional[_builtins.int] = ..., constraint_violation_limit: Optional[_builtins.int] = ..., deployment_configs: Optional[Sequence[outputs.FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfig]] = ..., exemptable_namespaces: Optional[Sequence[_builtins.str]] = ..., install_spec: Optional[_builtins.str] = ..., log_denies_enabled: Optional[_builtins.bool] = ..., monitoring: Optional[outputs.FeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoring] = ..., mutation_enabled: Optional[_builtins.bool] = ..., policy_content: Optional[outputs.FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContent] = ..., referential_rules_enabled: Optional[_builtins.bool] = ...) -> None:
...
class FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfig(dict):
    ...
    def __init__(__self__, *, component_name: _builtins.str, container_resources: Optional[outputs.FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResources] = ..., pod_affinity: Optional[_builtins.str] = ..., pod_tolerations: Optional[Sequence[outputs.FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigPodToleration]] = ..., replica_count: Optional[_builtins.int] = ...) -> None:
...
class FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResources(dict):
    def __init__(__self__, *, limits: Optional[outputs.FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResourcesLimits] = ..., requests: Optional[outputs.FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResourcesRequests] = ...) -> None:
...
class FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContent(dict):
    ...
    def __init__(__self__, *, bundles: Optional[Sequence[outputs.FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundle]] = ..., template_library: Optional[outputs.FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibrary] = ...) -> None:
...
class FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentBundle(dict):
    ...
    def __init__(__self__, *, bundle_name: _builtins.str, exempted_namespaces: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FeatureResourceState(dict):
    ...
    def __init__(__self__, *, has_resources: Optional[_builtins.bool] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class FeatureSpec(dict):
    def __init__(__self__, *, clusterupgrade: Optional[outputs.FeatureSpecClusterupgrade] = ..., fleetobservability: Optional[outputs.FeatureSpecFleetobservability] = ..., multiclusteringress: Optional[outputs.FeatureSpecMulticlusteringress] = ..., rbacrolebindingactuation: Optional[outputs.FeatureSpecRbacrolebindingactuation] = ..., workloadidentity: Optional[outputs.FeatureSpecWorkloadidentity] = ...) -> None:
...
class FeatureSpecClusterupgrade(dict):
    ...
    def __init__(__self__, *, upstream_fleets: Sequence[_builtins.str], gke_upgrade_overrides: Optional[Sequence[outputs.FeatureSpecClusterupgradeGkeUpgradeOverride]] = ..., post_conditions: Optional[outputs.FeatureSpecClusterupgradePostConditions] = ...) -> None:
...
class FeatureSpecClusterupgradeGkeUpgradeOverride(dict):
    ...
    def __init__(__self__, *, post_conditions: outputs.FeatureSpecClusterupgradeGkeUpgradeOverridePostConditions, upgrade: outputs.FeatureSpecClusterupgradeGkeUpgradeOverrideUpgrade) -> None:
...
class FeatureSpecFleetobservability(dict):
    ...
    def __init__(__self__, *, logging_config: Optional[outputs.FeatureSpecFleetobservabilityLoggingConfig] = ...) -> None:
...
class FeatureSpecFleetobservabilityLoggingConfig(dict):
    ...
    def __init__(__self__, *, default_config: Optional[outputs.FeatureSpecFleetobservabilityLoggingConfigDefaultConfig] = ..., fleet_scope_logs_config: Optional[outputs.FeatureSpecFleetobservabilityLoggingConfigFleetScopeLogsConfig] = ...) -> None:
...
class FeatureSpecRbacrolebindingactuation(dict):
    ...
    def __init__(__self__, *, allowed_custom_roles: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class FeatureState(dict):
    def __init__(__self__, *, states: Optional[Sequence[outputs.FeatureStateState]] = ...) -> None:
...
class FeatureStateState(dict):
    ...
    def __init__(__self__, *, code: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class FleetDefaultClusterConfig(dict):
    ...
    def __init__(__self__, *, binary_authorization_config: Optional[outputs.FleetDefaultClusterConfigBinaryAuthorizationConfig] = ..., security_posture_config: Optional[outputs.FleetDefaultClusterConfigSecurityPostureConfig] = ...) -> None:
...
class FleetDefaultClusterConfigBinaryAuthorizationConfig(dict):
    ...
    def __init__(__self__, *, evaluation_mode: Optional[_builtins.str] = ..., policy_bindings: Optional[Sequence[outputs.FleetDefaultClusterConfigBinaryAuthorizationConfigPolicyBinding]] = ...) -> None:
...
class MembershipEndpoint(dict):
    ...
    def __init__(__self__, *, gke_cluster: Optional[outputs.MembershipEndpointGkeCluster] = ...) -> None:
...
class RolloutSequenceStage(dict):
    ...
    def __init__(__self__, *, fleet_projects: Sequence[_builtins.str], cluster_selector: Optional[outputs.RolloutSequenceStageClusterSelector] = ..., soak_duration: Optional[_builtins.str] = ...) -> None:
...
class ScopeRbacRoleBindingRole(dict):
    ...
    def __init__(__self__, *, custom_role: Optional[_builtins.str] = ..., predefined_role: Optional[_builtins.str] = ...) -> None:
...
class GetFeatureFleetDefaultMemberConfigResult(dict):
    def __init__(__self__, *, configmanagements: Sequence[outputs.GetFeatureFleetDefaultMemberConfigConfigmanagementResult], meshes: Sequence[outputs.GetFeatureFleetDefaultMemberConfigMeshResult], policycontrollers: Sequence[outputs.GetFeatureFleetDefaultMemberConfigPolicycontrollerResult]) -> None:
...
class GetFeatureFleetDefaultMemberConfigConfigmanagementResult(dict):
    def __init__(__self__, *, config_syncs: Sequence[outputs.GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncResult], management: _builtins.str, version: _builtins.str) -> None:
...
class GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, gits: Sequence[outputs.GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGitResult], metrics_gcp_service_account_email: _builtins.str, ocis: Sequence[outputs.GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOciResult], prevent_drift: _builtins.bool, source_format: _builtins.str) -> None:
...
class GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGitResult(dict):
    def __init__(__self__, *, gcp_service_account_email: _builtins.str, https_proxy: _builtins.str, policy_dir: _builtins.str, secret_type: _builtins.str, sync_branch: _builtins.str, sync_repo: _builtins.str, sync_rev: _builtins.str, sync_wait_secs: _builtins.str) -> None:
...
class GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOciResult(dict):
    def __init__(__self__, *, gcp_service_account_email: _builtins.str, policy_dir: _builtins.str, secret_type: _builtins.str, sync_repo: _builtins.str, sync_wait_secs: _builtins.str, version: _builtins.str) -> None:
...
class GetFeatureFleetDefaultMemberConfigPolicycontrollerResult(dict):
    def __init__(__self__, *, policy_controller_hub_configs: Sequence[outputs.GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigResult], version: _builtins.str) -> None:
...
class GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigResult(dict):
    def __init__(__self__, *, audit_interval_seconds: _builtins.int, constraint_violation_limit: _builtins.int, deployment_configs: Sequence[outputs.GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigResult], exemptable_namespaces: Sequence[_builtins.str], install_spec: _builtins.str, log_denies_enabled: _builtins.bool, monitorings: Sequence[outputs.GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoringResult], mutation_enabled: _builtins.bool, policy_contents: Sequence[outputs.GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentResult], referential_rules_enabled: _builtins.bool) -> None:
...
class GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigResult(dict):
    def __init__(__self__, *, component: _builtins.str, container_resources: Sequence[outputs.GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResourceResult], pod_affinity: _builtins.str, pod_tolerations: Sequence[outputs.GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigPodTolerationResult], replica_count: _builtins.int) -> None:
...
class GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResourceResult(dict):
    def __init__(__self__, *, limits: Sequence[outputs.GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResourceLimitResult], requests: Sequence[outputs.GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResourceRequestResult]) -> None:
...
class GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigPodTolerationResult(dict):
    def __init__(__self__, *, effect: _builtins.str, key: _builtins.str, operator: _builtins.str, value: _builtins.str) -> None:
...
class GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentResult(dict):
    def __init__(__self__, *, bundles: Sequence[outputs.GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentBundleResult], template_libraries: Sequence[outputs.GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibraryResult]) -> None:
...
class GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentBundleResult(dict):
    def __init__(__self__, *, bundle: _builtins.str, exempted_namespaces: Sequence[_builtins.str]) -> None:
...
class GetFeatureResourceStateResult(dict):
    def __init__(__self__, *, has_resources: _builtins.bool, state: _builtins.str) -> None:
...
class GetFeatureSpecResult(dict):
    def __init__(__self__, *, clusterupgrades: Sequence[outputs.GetFeatureSpecClusterupgradeResult], fleetobservabilities: Sequence[outputs.GetFeatureSpecFleetobservabilityResult], multiclusteringresses: Sequence[outputs.GetFeatureSpecMulticlusteringressResult], rbacrolebindingactuations: Sequence[outputs.GetFeatureSpecRbacrolebindingactuationResult], workloadidentities: Sequence[outputs.GetFeatureSpecWorkloadidentityResult]) -> None:
...
class GetFeatureSpecClusterupgradeResult(dict):
    def __init__(__self__, *, gke_upgrade_overrides: Sequence[outputs.GetFeatureSpecClusterupgradeGkeUpgradeOverrideResult], post_conditions: Sequence[outputs.GetFeatureSpecClusterupgradePostConditionResult], upstream_fleets: Sequence[_builtins.str]) -> None:
...
class GetFeatureSpecClusterupgradeGkeUpgradeOverrideResult(dict):
    def __init__(__self__, *, post_conditions: Sequence[outputs.GetFeatureSpecClusterupgradeGkeUpgradeOverridePostConditionResult], upgrades: Sequence[outputs.GetFeatureSpecClusterupgradeGkeUpgradeOverrideUpgradeResult]) -> None:
...
class GetFeatureSpecFleetobservabilityResult(dict):
    def __init__(__self__, *, logging_configs: Sequence[outputs.GetFeatureSpecFleetobservabilityLoggingConfigResult]) -> None:
...
class GetFeatureSpecFleetobservabilityLoggingConfigResult(dict):
    def __init__(__self__, *, default_configs: Sequence[outputs.GetFeatureSpecFleetobservabilityLoggingConfigDefaultConfigResult], fleet_scope_logs_configs: Sequence[outputs.GetFeatureSpecFleetobservabilityLoggingConfigFleetScopeLogsConfigResult]) -> None:
...
class GetFeatureSpecRbacrolebindingactuationResult(dict):
    def __init__(__self__, *, allowed_custom_roles: Sequence[_builtins.str]) -> None:
...
class GetFeatureStateResult(dict):
    def __init__(__self__, *, states: Sequence[outputs.GetFeatureStateStateResult]) -> None:
...
class GetFeatureStateStateResult(dict):
    def __init__(__self__, *, code: _builtins.str, description: _builtins.str, update_time: _builtins.str) -> None:
...
class GetMembershipEndpointResult(dict):
    def __init__(__self__, *, gke_clusters: Sequence[outputs.GetMembershipEndpointGkeClusterResult]) -> None:
