...
class _ScopeState:
    def __init__(
        ...
        *,
        ...
        states: Optional[pulumi.Input[Sequence[pulumi.Input[ScopeStateArgs]]]] = ...,
    ...
    def states(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[ScopeStateArgs]]]]: ...
    @states.setter
    def states(
        self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ScopeStateArgs]]]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class Scope(pulumi.CustomResource):
    ...
    def get(
        ...
        states: Optional[
            pulumi.Input[
                Sequence[pulumi.Input[Union[ScopeStateArgs, ScopeStateArgsDict]]]
            ]
        ] = ...,
        uid: Optional[pulumi.Input[_builtins.str]] = ...,
        update_time: Optional[pulumi.Input[_builtins.str]] = ...,
