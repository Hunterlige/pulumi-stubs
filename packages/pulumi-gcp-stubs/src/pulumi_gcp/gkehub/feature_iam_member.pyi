...
class FeatureIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[FeatureIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[FeatureIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class FeatureIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[FeatureIamMemberConditionArgs, FeatureIamMemberConditionArgsDict]
            ]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.FeatureIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
