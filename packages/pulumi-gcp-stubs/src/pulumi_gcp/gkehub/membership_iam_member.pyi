...
class MembershipIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[MembershipIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[MembershipIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class MembershipIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.MembershipIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
