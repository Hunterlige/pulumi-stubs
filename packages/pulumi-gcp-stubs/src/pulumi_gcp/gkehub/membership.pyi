...
class MembershipArgs:
    def __init__(
        ...
        *,
        ...
        authority: Optional[pulumi.Input[MembershipAuthorityArgs]] = ...,
        endpoint: Optional[pulumi.Input[MembershipEndpointArgs]] = ...,
...
class Membership(pulumi.CustomResource):
    ...
    def __init__(
        ...
        authority: Optional[
            pulumi.Input[Union[MembershipAuthorityArgs, MembershipAuthorityArgsDict]]
        ] = ...,
        endpoint: Optional[
            pulumi.Input[Union[MembershipEndpointArgs, MembershipEndpointArgsDict]]
        ] = ...,
        labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        membership_id: Optional[pulumi.Input[_builtins.str]] = ...,
