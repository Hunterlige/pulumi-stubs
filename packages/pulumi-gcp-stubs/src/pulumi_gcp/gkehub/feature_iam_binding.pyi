...
class FeatureIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[FeatureIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[FeatureIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class FeatureIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    FeatureIamBindingConditionArgs, FeatureIamBindingConditionArgsDict
                ]
            ]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.FeatureIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
