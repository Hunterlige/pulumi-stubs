...
class _MembershipBindingState:
    def __init__(
        ...
        *,
        ...
        states: Optional[
            pulumi.Input[Sequence[pulumi.Input[MembershipBindingStateArgs]]]
        ] = ...,
    ...
    def states(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[MembershipBindingStateArgs]]]]: ...
    @states.setter
    def states(
        self,
        value: Optional[
        ...
        states: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[
                            MembershipBindingStateArgs, MembershipBindingStateArgsDict
                        ]
                    ]
                ]
            ]
