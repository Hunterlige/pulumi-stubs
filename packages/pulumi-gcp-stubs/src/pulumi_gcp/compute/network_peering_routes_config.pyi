...
class NetworkPeeringRoutesConfigArgs:
    def __init__(__self__, *, export_custom_routes: pulumi.Input[_builtins.bool], import_custom_routes: pulumi.Input[_builtins.bool], network: pulumi.Input[_builtins.str], peering: pulumi.Input[_builtins.str], export_subnet_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., import_subnet_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def export_custom_routes(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def import_custom_routes(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class NetworkPeeringRoutesConfig(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., export_custom_routes: Optional[pulumi.Input[_builtins.bool]] = ..., export_subnet_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., import_custom_routes: Optional[pulumi.Input[_builtins.bool]] = ..., import_subnet_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., peering: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ...) -> NetworkPeeringRoutesConfig:
