...
class GetSnapshotResult:
    ...
    def __init__(__self__, chain_name=..., creation_timestamp=..., description=..., disk_size_gb=..., effective_labels=..., filter=..., guest_flush=..., id=..., label_fingerprint=..., labels=..., licenses=..., most_recent=..., name=..., project=..., pulumi_labels=..., self_link=..., snapshot_encryption_keys=..., snapshot_id=..., snapshot_type=..., source_disk=..., source_disk_encryption_keys=..., source_instant_snapshot=..., storage_bytes=..., storage_locations=..., zone=...) -> None:
        ...
...
def get_snapshot(filter: Optional[_builtins.str] = ..., most_recent: Optional[_builtins.bool] = ..., name: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetSnapshotResult:
    
    ...

def get_snapshot_output(filter: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., most_recent: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., name: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetSnapshotResult]:
