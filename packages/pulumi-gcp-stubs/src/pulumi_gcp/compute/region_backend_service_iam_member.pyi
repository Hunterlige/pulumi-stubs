...
class RegionBackendServiceIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[RegionBackendServiceIamMemberConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[RegionBackendServiceIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[RegionBackendServiceIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class RegionBackendServiceIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.RegionBackendServiceIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
