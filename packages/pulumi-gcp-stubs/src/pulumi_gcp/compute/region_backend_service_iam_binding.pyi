...
class RegionBackendServiceIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[RegionBackendServiceIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[RegionBackendServiceIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[RegionBackendServiceIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class RegionBackendServiceIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.RegionBackendServiceIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
