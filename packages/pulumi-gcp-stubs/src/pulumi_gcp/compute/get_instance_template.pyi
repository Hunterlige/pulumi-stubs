...
class AwaitableGetInstanceTemplateResult(GetInstanceTemplateResult):
    def __await__(self): # -> Generator[Never, Any, GetInstanceTemplateResult]:
        ...
    


def get_instance_template(filter: Optional[_builtins.str] = ..., most_recent: Optional[_builtins.bool] = ..., name: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., self_link_unique: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetInstanceTemplateResult:
    
    ...

def get_instance_template_output(filter: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., most_recent: Optional[pulumi.Input[Optional[_builtins.bool]]] = ..., name: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., self_link_unique: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetInstanceTemplateResult]:
