...
class TargetHttpsProxyArgs:
    def __init__(__self__, *, url_map: pulumi.Input[_builtins.str], certificate_manager_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., certificate_map: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., http_keep_alive_timeout_sec: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., proxy_bind: Optional[pulumi.Input[_builtins.bool]] = ..., quic_override: Optional[pulumi.Input[_builtins.str]] = ..., server_tls_policy: Optional[pulumi.Input[_builtins.str]] = ..., ssl_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ssl_policy: Optional[pulumi.Input[_builtins.str]] = ..., tls_early_data: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def quic_override(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def tls_early_data(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class _TargetHttpsProxyState:
    def __init__(__self__, *, certificate_manager_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., certificate_map: Optional[pulumi.Input[_builtins.str]] = ..., creation_timestamp: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., fingerprint: Optional[pulumi.Input[_builtins.str]] = ..., http_keep_alive_timeout_sec: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., proxy_bind: Optional[pulumi.Input[_builtins.bool]] = ..., proxy_id: Optional[pulumi.Input[_builtins.int]] = ..., quic_override: Optional[pulumi.Input[_builtins.str]] = ..., self_link: Optional[pulumi.Input[_builtins.str]] = ..., server_tls_policy: Optional[pulumi.Input[_builtins.str]] = ..., ssl_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ssl_policy: Optional[pulumi.Input[_builtins.str]] = ..., tls_early_data: Optional[pulumi.Input[_builtins.str]] = ..., url_map: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TargetHttpsProxy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., certificate_manager_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., certificate_map: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., http_keep_alive_timeout_sec: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., proxy_bind: Optional[pulumi.Input[_builtins.bool]] = ..., quic_override: Optional[pulumi.Input[_builtins.str]] = ..., server_tls_policy: Optional[pulumi.Input[_builtins.str]] = ..., ssl_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ssl_policy: Optional[pulumi.Input[_builtins.str]] = ..., tls_early_data: Optional[pulumi.Input[_builtins.str]] = ..., url_map: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: TargetHttpsProxyArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., certificate_manager_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., certificate_map: Optional[pulumi.Input[_builtins.str]] = ..., creation_timestamp: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., fingerprint: Optional[pulumi.Input[_builtins.str]] = ..., http_keep_alive_timeout_sec: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., proxy_bind: Optional[pulumi.Input[_builtins.bool]] = ..., proxy_id: Optional[pulumi.Input[_builtins.int]] = ..., quic_override: Optional[pulumi.Input[_builtins.str]] = ..., self_link: Optional[pulumi.Input[_builtins.str]] = ..., server_tls_policy: Optional[pulumi.Input[_builtins.str]] = ..., ssl_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ssl_policy: Optional[pulumi.Input[_builtins.str]] = ..., tls_early_data: Optional[pulumi.Input[_builtins.str]] = ..., url_map: Optional[pulumi.Input[_builtins.str]] = ...) -> TargetHttpsProxy:
