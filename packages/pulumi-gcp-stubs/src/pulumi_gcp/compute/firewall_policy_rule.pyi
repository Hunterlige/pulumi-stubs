    ...
    def __init__(
        ...
        *,
        ...
        target_secure_tags: Optional[
            pulumi.Input[Sequence[pulumi.Input[FirewallPolicyRuleTargetSecureTagArgs]]]
        ] = ...,
...
class _FirewallPolicyRuleState:
    def __init__(
        ...
        *,
        ...
        match: Optional[pulumi.Input[FirewallPolicyRuleMatchArgs]] = ...,
...
class FirewallPolicyRule(pulumi.CustomResource):
    ...
    def __init__(
        ...
        match: Optional[
            pulumi.Input[
                Union[FirewallPolicyRuleMatchArgs, FirewallPolicyRuleMatchArgsDict]
            ]
        ] = ...,
        priority: Optional[pulumi.Input[_builtins.int]] = ...,
        security_profile_group: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def target_secure_tags(
        ...
        Optional[Sequence[outputs.FirewallPolicyRuleTargetSecureTag]]
    ]: ...
    @_builtins.property
    @pulumi.getter(name="targetServiceAccounts")
    def target_service_accounts(
