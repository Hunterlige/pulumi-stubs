...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetGlobalForwardingRuleResult', 'AwaitableGetGlobalForwardingRuleResult', 'get_global_forwarding_rule', 'get_global_forwarding_rule_output']
@pulumi.output_type
class GetGlobalForwardingRuleResult:
    
    def __init__(__self__, allow_psc_global_access=..., base_forwarding_rule=..., description=..., effective_labels=..., external_managed_backend_bucket_migration_state=..., external_managed_backend_bucket_migration_testing_percentage=..., forwarding_rule_id=..., id=..., ip_address=..., ip_protocol=..., ip_version=..., label_fingerprint=..., labels=..., load_balancing_scheme=..., metadata_filters=..., name=..., network=..., network_tier=..., no_automate_dns_zone=..., port_range=..., project=..., psc_connection_id=..., psc_connection_status=..., pulumi_labels=..., self_link=..., service_directory_registrations=..., source_ip_ranges=..., subnetwork=..., target=...) -> None:
        ...
...
class AwaitableGetGlobalForwardingRuleResult(GetGlobalForwardingRuleResult):
    def __await__(self): # -> Generator[Never, Any, GetGlobalForwardingRuleResult]:
        ...
    


def get_global_forwarding_rule(name: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetGlobalForwardingRuleResult:
    
    ...

def get_global_forwarding_rule_output(name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetGlobalForwardingRuleResult]:
