...
class InstantSnapshotIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[InstantSnapshotIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[InstantSnapshotIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[InstantSnapshotIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class InstantSnapshotIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.InstantSnapshotIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
