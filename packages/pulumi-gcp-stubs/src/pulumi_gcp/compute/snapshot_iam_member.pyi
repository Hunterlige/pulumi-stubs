...
class SnapshotIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[SnapshotIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[SnapshotIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class SnapshotIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    SnapshotIamMemberConditionArgs, SnapshotIamMemberConditionArgsDict
                ]
            ]
        ] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.SnapshotIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
