...
class RolloutPlanArgs:
    def __init__(
        ...
        *,
        ...
        location_scope: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    @waves.setter
    def waves(
        self, value: pulumi.Input[Sequence[pulumi.Input[RolloutPlanWaveArgs]]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _RolloutPlanState:
    def __init__(
        ...
        *,
        ...
        waves: Optional[
            pulumi.Input[Sequence[pulumi.Input[RolloutPlanWaveArgs]]]
        ] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
    ...
    def waves(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[RolloutPlanWaveArgs]]]]: ...
    @waves.setter
    def waves(
        self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RolloutPlanWaveArgs]]]]
    ): ...
...
class RolloutPlan(pulumi.CustomResource):
    ...
    def __init__(
        ...
        waves: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[Union[RolloutPlanWaveArgs, RolloutPlanWaveArgsDict]]
                ]
            ]
        ] = ...,
        __props__=...,
