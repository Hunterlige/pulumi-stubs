...
class InstanceTemplateIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[InstanceTemplateIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[InstanceTemplateIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[InstanceTemplateIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class InstanceTemplateIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.InstanceTemplateIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
