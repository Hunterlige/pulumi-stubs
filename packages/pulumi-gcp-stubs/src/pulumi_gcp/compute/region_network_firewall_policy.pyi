...
class _RegionNetworkFirewallPolicyState:
    def __init__(
        ...
        *,
        ...
        project: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        region_network_firewall_policy_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def region_network_firewall_policy_id(
        self,
...
class RegionNetworkFirewallPolicy(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[RegionNetworkFirewallPolicyArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
