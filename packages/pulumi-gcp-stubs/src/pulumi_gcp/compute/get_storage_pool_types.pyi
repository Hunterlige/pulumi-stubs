...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetStoragePoolTypesResult', 'AwaitableGetStoragePoolTypesResult', 'get_storage_pool_types', 'get_storage_pool_types_output']
@pulumi.output_type
class GetStoragePoolTypesResult:
    
    def __init__(__self__, creation_timestamp=..., deprecateds=..., description=..., id=..., kind=..., max_pool_provisioned_capacity_gb=..., max_pool_provisioned_iops=..., max_pool_provisioned_throughput=..., min_pool_provisioned_capacity_gb=..., min_pool_provisioned_iops=..., min_pool_provisioned_throughput=..., name=..., project=..., self_link=..., self_link_with_id=..., storage_pool_type=..., supported_disk_types=..., zone=...) -> None:
        ...
...
class AwaitableGetStoragePoolTypesResult(GetStoragePoolTypesResult):
    def __await__(self): # -> Generator[Never, Any, GetStoragePoolTypesResult]:
        ...
    


def get_storage_pool_types(project: Optional[_builtins.str] = ..., storage_pool_type: Optional[_builtins.str] = ..., zone: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetStoragePoolTypesResult:
    
    ...

def get_storage_pool_types_output(project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., storage_pool_type: Optional[pulumi.Input[_builtins.str]] = ..., zone: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetStoragePoolTypesResult]:
