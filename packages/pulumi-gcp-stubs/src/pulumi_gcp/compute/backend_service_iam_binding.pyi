...
class BackendServiceIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[BackendServiceIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[BackendServiceIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[BackendServiceIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class BackendServiceIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.BackendServiceIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
