...
class ManagedSslCertificateArgs:
    def __init__(
        ...
        *,
        ...
        managed: Optional[pulumi.Input[ManagedSslCertificateManagedArgs]] = ...,
    ...
    @managed.setter
    def managed(
        self, value: Optional[pulumi.Input[ManagedSslCertificateManagedArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class ManagedSslCertificate(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[ManagedSslCertificateArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
    ...
    def managed(
        self,
    ) -> pulumi.Output[Optional[outputs.ManagedSslCertificateManaged]]: ...
    @_builtins.property
    @pulumi.getter
