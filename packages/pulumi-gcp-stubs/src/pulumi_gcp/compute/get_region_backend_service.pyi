...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetRegionBackendServiceResult', 'AwaitableGetRegionBackendServiceResult', 'get_region_backend_service', 'get_region_backend_service_output']
@pulumi.output_type
class GetRegionBackendServiceResult:
    
    def __init__(__self__, affinity_cookie_ttl_sec=..., backends=..., cdn_policies=..., circuit_breakers=..., connection_draining_timeout_sec=..., connection_tracking_policies=..., consistent_hashes=..., creation_timestamp=..., custom_metrics=..., description=..., dynamic_forwardings=..., enable_cdn=..., failover_policies=..., fingerprint=..., generated_id=..., ha_policies=..., health_checks=..., iaps=..., id=..., ip_address_selection_policy=..., load_balancing_scheme=..., locality_lb_policy=..., log_configs=..., name=..., network=..., network_pass_through_lb_traffic_policies=..., outlier_detections=..., params=..., port_name=..., project=..., protocol=..., region=..., security_policy=..., self_link=..., session_affinity=..., strong_session_affinity_cookies=..., subsettings=..., timeout_sec=..., tls_settings=...) -> None:
        ...
...
class AwaitableGetRegionBackendServiceResult(GetRegionBackendServiceResult):
    def __await__(self): # -> Generator[Never, Any, GetRegionBackendServiceResult]:
        ...
    


def get_region_backend_service(name: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetRegionBackendServiceResult:
    
    ...

def get_region_backend_service_output(name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetRegionBackendServiceResult]:
