...
class BackendBucketIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[BackendBucketIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[BackendBucketIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[BackendBucketIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class BackendBucketIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.BackendBucketIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
