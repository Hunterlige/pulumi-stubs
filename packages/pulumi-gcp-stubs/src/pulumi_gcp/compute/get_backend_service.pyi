...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetBackendServiceResult', 'AwaitableGetBackendServiceResult', 'get_backend_service', 'get_backend_service_output']
@pulumi.output_type
class GetBackendServiceResult:
    
    def __init__(__self__, affinity_cookie_ttl_sec=..., backends=..., cdn_policies=..., circuit_breakers=..., compression_mode=..., connection_draining_timeout_sec=..., consistent_hash=..., creation_timestamp=..., custom_metrics=..., custom_request_headers=..., custom_response_headers=..., description=..., dynamic_forwardings=..., edge_security_policy=..., enable_cdn=..., external_managed_migration_state=..., external_managed_migration_testing_percentage=..., fingerprint=..., generated_id=..., health_checks=..., iaps=..., id=..., ip_address_selection_policy=..., load_balancing_scheme=..., locality_lb_policies=..., locality_lb_policy=..., log_configs=..., max_stream_durations=..., name=..., network_pass_through_lb_traffic_policies=..., outlier_detections=..., params=..., port_name=..., project=..., protocol=..., security_policy=..., security_settings=..., self_link=..., service_lb_policy=..., session_affinity=..., strong_session_affinity_cookies=..., timeout_sec=..., tls_settings=...) -> None:
        ...
...
class AwaitableGetBackendServiceResult(GetBackendServiceResult):
    def __await__(self): # -> Generator[Never, Any, GetBackendServiceResult]:
        ...
    


def get_backend_service(name: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetBackendServiceResult:
    
    ...

def get_backend_service_output(name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetBackendServiceResult]:
