...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetRegionInstanceGroupManagerResult', 'AwaitableGetRegionInstanceGroupManagerResult', 'get_region_instance_group_manager', 'get_region_instance_group_manager_output']
@pulumi.output_type
class GetRegionInstanceGroupManagerResult:
    
    def __init__(__self__, all_instances_configs=..., auto_healing_policies=..., base_instance_name=..., creation_timestamp=..., description=..., distribution_policy_target_shape=..., distribution_policy_zones=..., fingerprint=..., id=..., instance_flexibility_policies=..., instance_group=..., instance_group_manager_id=..., instance_lifecycle_policies=..., list_managed_instances_results=..., name=..., named_ports=..., params=..., project=..., region=..., self_link=..., standby_policies=..., stateful_disks=..., stateful_external_ips=..., stateful_internal_ips=..., statuses=..., target_pools=..., target_size=..., target_stopped_size=..., target_suspended_size=..., update_policies=..., versions=..., wait_for_instances=..., wait_for_instances_status=...) -> None:
        ...
...
class AwaitableGetRegionInstanceGroupManagerResult(GetRegionInstanceGroupManagerResult):
    def __await__(self): # -> Generator[Never, Any, GetRegionInstanceGroupManagerResult]:
        ...
    


def get_region_instance_group_manager(name: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., region: Optional[_builtins.str] = ..., self_link: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetRegionInstanceGroupManagerResult:
    
    ...

def get_region_instance_group_manager_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., region: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., self_link: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetRegionInstanceGroupManagerResult]:
