...
class ImageIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[ImageIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[ImageIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class ImageIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[ImageIamBindingConditionArgs, ImageIamBindingConditionArgsDict]
            ]
        ] = ...,
        image: Optional[pulumi.Input[_builtins.str]] = ...,
        members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.ImageIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
