...
class NetworkFirewallPolicyWithRulesArgs:
    def __init__(__self__, *, rules: pulumi.Input[Sequence[pulumi.Input[NetworkFirewallPolicyWithRulesRuleArgs]]], description: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., policy_type: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Sequence[pulumi.Input[NetworkFirewallPolicyWithRulesRuleArgs]]]): # -> None:
        ...
...
class _NetworkFirewallPolicyWithRulesState:
    ...
    def predefined_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkFirewallPolicyWithRulesPredefinedRuleArgs]]]]): # -> None:
        ...
    ...
    @rules.setter
    def rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[NetworkFirewallPolicyWithRulesRuleArgs]]]]): # -> None:
        ...
...
class NetworkFirewallPolicyWithRules(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., policy_type: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[NetworkFirewallPolicyWithRulesRuleArgs, NetworkFirewallPolicyWithRulesRuleArgsDict]]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: NetworkFirewallPolicyWithRulesArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., creation_timestamp: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., fingerprint: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., network_firewall_policy_id: Optional[pulumi.Input[_builtins.str]] = ..., policy_type: Optional[pulumi.Input[_builtins.str]] = ..., predefined_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[NetworkFirewallPolicyWithRulesPredefinedRuleArgs, NetworkFirewallPolicyWithRulesPredefinedRuleArgsDict]]]]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., rule_tuple_count: Optional[pulumi.Input[_builtins.int]] = ..., rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union[NetworkFirewallPolicyWithRulesRuleArgs, NetworkFirewallPolicyWithRulesRuleArgsDict]]]]] = ..., self_link: Optional[pulumi.Input[_builtins.str]] = ..., self_link_with_id: Optional[pulumi.Input[_builtins.str]] = ...) -> NetworkFirewallPolicyWithRules:
