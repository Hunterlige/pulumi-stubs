...
class RegionHealthAggregationPolicyArgs:
    def __init__(__self__, *, region: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., healthy_percent_threshold: Optional[pulumi.Input[_builtins.int]] = ..., min_healthy_threshold: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., policy_type: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def healthy_percent_threshold(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def min_healthy_threshold(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class _RegionHealthAggregationPolicyState:
    def __init__(__self__, *, creation_timestamp: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., fingerprint: Optional[pulumi.Input[_builtins.str]] = ..., healthy_percent_threshold: Optional[pulumi.Input[_builtins.int]] = ..., min_healthy_threshold: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., policy_type: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., self_link_with_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RegionHealthAggregationPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., healthy_percent_threshold: Optional[pulumi.Input[_builtins.int]] = ..., min_healthy_threshold: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., policy_type: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., region: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: RegionHealthAggregationPolicyArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
