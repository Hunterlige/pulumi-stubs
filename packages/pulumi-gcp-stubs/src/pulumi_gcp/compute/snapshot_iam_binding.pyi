...
class SnapshotIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[SnapshotIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[SnapshotIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class SnapshotIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    SnapshotIamBindingConditionArgs, SnapshotIamBindingConditionArgsDict
                ]
            ]
        ] = ...,
        members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.SnapshotIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
