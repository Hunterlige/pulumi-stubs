...
class BackendServiceIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[BackendServiceIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[BackendServiceIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[BackendServiceIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class BackendServiceIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.BackendServiceIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
