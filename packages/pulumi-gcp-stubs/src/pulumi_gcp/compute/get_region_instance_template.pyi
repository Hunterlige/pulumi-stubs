...
class GetRegionInstanceTemplateResult:
    ...
    def advanced_machine_features(
        self,
    ) -> Sequence[outputs.GetRegionInstanceTemplateAdvancedMachineFeatureResult]: ...
    @_builtins.property
    ...
    def confidential_instance_configs(
        ...
        outputs.GetRegionInstanceTemplateConfidentialInstanceConfigResult
    ]: ...
    @_builtins.property
    ...
    def guest_accelerators(
        self,
    ) -> Sequence[outputs.GetRegionInstanceTemplateGuestAcceleratorResult]: ...
    @_builtins.property
    @pulumi.getter
    ...
    def network_interfaces(
        self,
    ) -> Sequence[outputs.GetRegionInstanceTemplateNetworkInterfaceResult]: ...
    @_builtins.property
    @pulumi.getter(name="networkPerformanceConfigs")
    def network_performance_configs(
        self,
    ) -> Sequence[outputs.GetRegionInstanceTemplateNetworkPerformanceConfigResult]: ...
    @_builtins.property
    ...
    def reservation_affinities(
        self,
    ) -> Sequence[outputs.GetRegionInstanceTemplateReservationAffinityResult]: ...
    @_builtins.property
    ...
    def schedulings(
        self,
    ) -> Sequence[outputs.GetRegionInstanceTemplateSchedulingResult]: ...
    @_builtins.property
    ...
    def service_accounts(
        self,
    ) -> Sequence[outputs.GetRegionInstanceTemplateServiceAccountResult]: ...
    @_builtins.property
    @pulumi.getter(name="shieldedInstanceConfigs")
    def shielded_instance_configs(
        self,
    ) -> Sequence[outputs.GetRegionInstanceTemplateShieldedInstanceConfigResult]: ...
    @_builtins.property
    @pulumi.getter
...
def get_region_instance_template(
...
) -> pulumi.Output[GetRegionInstanceTemplateResult]: ...
