...
class RouterNamedSetArgs:
    def __init__(
        ...
        *,
        ...
        elements: Optional[
            pulumi.Input[Sequence[pulumi.Input[RouterNamedSetElementArgs]]]
        ] = ...,
    ...
    def elements(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input[RouterNamedSetElementArgs]]]]: ...
    @elements.setter
    def elements(
        self,
        value: Optional[
...
class RouterNamedSet(pulumi.CustomResource):
    ...
    def __init__(
        ...
        elements: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[RouterNamedSetElementArgs, RouterNamedSetElementArgsDict]
                    ]
                ]
            ]
        ] = ...,
    ...
    def elements(
        self,
    ) -> pulumi.Output[Optional[Sequence[outputs.RouterNamedSetElement]]]: ...
    @_builtins.property
    @pulumi.getter
