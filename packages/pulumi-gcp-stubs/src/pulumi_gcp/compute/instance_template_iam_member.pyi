...
class InstanceTemplateIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[InstanceTemplateIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[InstanceTemplateIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[InstanceTemplateIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class InstanceTemplateIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.InstanceTemplateIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
