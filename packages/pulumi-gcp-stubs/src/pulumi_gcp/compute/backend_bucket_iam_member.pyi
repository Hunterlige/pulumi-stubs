...
class BackendBucketIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[BackendBucketIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[BackendBucketIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[BackendBucketIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class BackendBucketIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.BackendBucketIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
