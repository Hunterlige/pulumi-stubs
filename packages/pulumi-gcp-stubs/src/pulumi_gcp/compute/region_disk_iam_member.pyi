...
class RegionDiskIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[RegionDiskIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[RegionDiskIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class RegionDiskIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.RegionDiskIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
