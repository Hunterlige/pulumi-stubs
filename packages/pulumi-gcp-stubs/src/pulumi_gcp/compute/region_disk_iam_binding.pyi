...
class RegionDiskIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[RegionDiskIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[RegionDiskIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[RegionDiskIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class RegionDiskIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.RegionDiskIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
