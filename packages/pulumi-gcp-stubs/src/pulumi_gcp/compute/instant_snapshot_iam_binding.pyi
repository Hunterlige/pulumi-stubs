...
class InstantSnapshotIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[InstantSnapshotIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[InstantSnapshotIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[InstantSnapshotIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class InstantSnapshotIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.InstantSnapshotIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
