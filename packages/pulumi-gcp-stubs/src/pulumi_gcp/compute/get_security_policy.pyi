...
class GetSecurityPolicyResult:
    ...
    def __init__(__self__, adaptive_protection_configs=..., advanced_options_configs=..., description=..., effective_labels=..., fingerprint=..., id=..., label_fingerprint=..., labels=..., name=..., project=..., pulumi_labels=..., recaptcha_options_configs=..., rules=..., self_link=..., type=...) -> None:
        ...
...
def get_security_policy(name: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., self_link: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetSecurityPolicyResult:
    
    ...

def get_security_policy_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., self_link: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetSecurityPolicyResult]:
