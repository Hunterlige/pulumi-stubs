...
class RepositoryIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[RepositoryIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[RepositoryIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class RepositoryIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.RepositoryIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
