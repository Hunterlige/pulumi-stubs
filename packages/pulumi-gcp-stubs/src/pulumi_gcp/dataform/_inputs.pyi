...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['RepositoryGitRemoteSettingsArgs', 'RepositoryGitRemoteSettingsArgsDict', ..., ..., 'RepositoryIamBindingConditionArgs', 'RepositoryIamBindingConditionArgsDict', 'RepositoryIamMemberConditionArgs', 'RepositoryIamMemberConditionArgsDict', 'RepositoryReleaseConfigCodeCompilationConfigArgs', ..., ..., ..., ..., ..., 'RepositoryWorkflowConfigInvocationConfigArgs', 'RepositoryWorkflowConfigInvocationConfigArgsDict', ..., ..., ..., ..., ..., ..., 'RepositoryWorkspaceCompilationOverridesArgs', 'RepositoryWorkspaceCompilationOverridesArgsDict']
...
class RepositoryGitRemoteSettingsArgs:
    def __init__(__self__, *, default_branch: pulumi.Input[_builtins.str], url: pulumi.Input[_builtins.str], authentication_token_secret_version: Optional[pulumi.Input[_builtins.str]] = ..., ssh_authentication_config: Optional[pulumi.Input[RepositoryGitRemoteSettingsSshAuthenticationConfigArgs]] = ..., token_status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def default_branch(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def authentication_token_secret_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ssh_authentication_config(self, value: Optional[pulumi.Input[RepositoryGitRemoteSettingsSshAuthenticationConfigArgs]]): # -> None:
        ...
    ...
    @token_status.setter
    def token_status(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RepositoryGitRemoteSettingsSshAuthenticationConfigArgs:
    def __init__(__self__, *, host_public_key: pulumi.Input[_builtins.str], user_private_key_secret_version: pulumi.Input[_builtins.str]) -> None:
    ...
    def host_public_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def user_private_key_secret_version(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class RepositoryReleaseConfigCodeCompilationConfigArgs:
    def __init__(__self__, *, assertion_schema: Optional[pulumi.Input[_builtins.str]] = ..., database_suffix: Optional[pulumi.Input[_builtins.str]] = ..., default_database: Optional[pulumi.Input[_builtins.str]] = ..., default_location: Optional[pulumi.Input[_builtins.str]] = ..., default_schema: Optional[pulumi.Input[_builtins.str]] = ..., schema_suffix: Optional[pulumi.Input[_builtins.str]] = ..., table_prefix: Optional[pulumi.Input[_builtins.str]] = ..., vars: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def assertion_schema(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def database_suffix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def default_database(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def default_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def default_schema(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def schema_suffix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @vars.setter
    def vars(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RepositoryReleaseConfigRecentScheduledReleaseRecordArgs:
    def __init__(__self__, *, compilation_result: Optional[pulumi.Input[_builtins.str]] = ..., error_statuses: Optional[pulumi.Input[Sequence[pulumi.Input[RepositoryReleaseConfigRecentScheduledReleaseRecordErrorStatusArgs]]]] = ..., release_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def compilation_result(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def error_statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RepositoryReleaseConfigRecentScheduledReleaseRecordErrorStatusArgs]]]]): # -> None:
        ...
    ...
    @release_time.setter
    def release_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RepositoryWorkflowConfigInvocationConfigArgs:
    def __init__(__self__, *, fully_refresh_incremental_tables_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., included_tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., included_targets: Optional[pulumi.Input[Sequence[pulumi.Input[RepositoryWorkflowConfigInvocationConfigIncludedTargetArgs]]]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., transitive_dependencies_included: Optional[pulumi.Input[_builtins.bool]] = ..., transitive_dependents_included: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def fully_refresh_incremental_tables_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def included_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def included_targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RepositoryWorkflowConfigInvocationConfigIncludedTargetArgs]]]]): # -> None:
        ...
    ...
    def transitive_dependencies_included(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def transitive_dependents_included(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class RepositoryWorkflowConfigInvocationConfigIncludedTargetArgs:
    def __init__(__self__, *, database: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., schema: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RepositoryWorkflowConfigRecentScheduledExecutionRecordArgs:
    def __init__(__self__, *, error_statuses: Optional[pulumi.Input[Sequence[pulumi.Input[RepositoryWorkflowConfigRecentScheduledExecutionRecordErrorStatusArgs]]]] = ..., execution_time: Optional[pulumi.Input[_builtins.str]] = ..., workflow_invocation: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @error_statuses.setter
    def error_statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RepositoryWorkflowConfigRecentScheduledExecutionRecordErrorStatusArgs]]]]): # -> None:
        ...
    ...
    def execution_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def workflow_invocation(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RepositoryWorkspaceCompilationOverridesArgs:
    def __init__(__self__, *, default_database: Optional[pulumi.Input[_builtins.str]] = ..., schema_suffix: Optional[pulumi.Input[_builtins.str]] = ..., table_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
