...
class AuthorizationPolicyArgs:
    def __init__(
        ...
        *,
        ...
        rules: Optional[
            pulumi.Input[Sequence[pulumi.Input[AuthorizationPolicyRuleArgs]]]
        ] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
...
class AuthorizationPolicy(pulumi.CustomResource):
        ...
        rules: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union[
                            AuthorizationPolicyRuleArgs, AuthorizationPolicyRuleArgsDict
                        ]
                    ]
                ]
            ]
    ...
    def rules(
        self,
    ) -> pulumi.Output[Optional[Sequence[outputs.AuthorizationPolicyRule]]]: ...
    @_builtins.property
    @pulumi.getter(name="updateTime")
