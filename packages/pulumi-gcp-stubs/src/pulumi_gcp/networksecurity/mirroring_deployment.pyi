...
class MirroringDeploymentArgs:
    def __init__(
        ...
        *,
        ...
        mirroring_deployment_id: pulumi.Input[_builtins.str],
    ...
    def mirroring_deployment_id(self, value: pulumi.Input[_builtins.str]): ...
    @_builtins.property
    @pulumi.getter
...
class _MirroringDeploymentState:
    def __init__(
        ...
        *,
        ...
        mirroring_deployment_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    @mirroring_deployment_id.setter
    def mirroring_deployment_id(self, value: Optional[pulumi.Input[_builtins.str]]): ...
    @_builtins.property
    @pulumi.getter
