...
class BackendAuthenticationConfigArgs:
    def __init__(
        ...
        *,
        ...
        well_known_roots: Optional[pulumi.Input[_builtins.str]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    def well_known_roots(self, value: Optional[pulumi.Input[_builtins.str]]): ...
...
class BackendAuthenticationConfig(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[BackendAuthenticationConfigArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
