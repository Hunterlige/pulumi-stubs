...
class WorkstationConfigIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[WorkstationConfigIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[WorkstationConfigIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[WorkstationConfigIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class WorkstationConfigIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.WorkstationConfigIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
