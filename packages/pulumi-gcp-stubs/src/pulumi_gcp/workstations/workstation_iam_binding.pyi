...
class WorkstationIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[WorkstationIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[WorkstationIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[WorkstationIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class WorkstationIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.WorkstationIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
