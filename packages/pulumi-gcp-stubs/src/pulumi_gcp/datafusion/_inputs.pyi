...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['InstanceAcceleratorArgs', 'InstanceAcceleratorArgsDict', 'InstanceCryptoKeyConfigArgs', 'InstanceCryptoKeyConfigArgsDict', 'InstanceEventPublishConfigArgs', 'InstanceEventPublishConfigArgsDict', 'InstanceNetworkConfigArgs', 'InstanceNetworkConfigArgsDict', ..., ...]
...
class InstanceAcceleratorArgs:
    def __init__(__self__, *, accelerator_type: pulumi.Input[_builtins.str], state: pulumi.Input[_builtins.str]) -> None:
...
class InstanceEventPublishConfigArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], topic: pulumi.Input[_builtins.str]) -> None:
...
class InstanceNetworkConfigArgs:
    def __init__(__self__, *, connection_type: Optional[pulumi.Input[_builtins.str]] = ..., ip_allocation: Optional[pulumi.Input[_builtins.str]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., private_service_connect_config: Optional[pulumi.Input[InstanceNetworkConfigPrivateServiceConnectConfigArgs]] = ...) -> None:
    ...
    def ip_allocation(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def private_service_connect_config(self, value: Optional[pulumi.Input[InstanceNetworkConfigPrivateServiceConnectConfigArgs]]): # -> None:
        ...
...
class InstanceNetworkConfigPrivateServiceConnectConfigArgs:
    def __init__(__self__, *, effective_unreachable_cidr_block: Optional[pulumi.Input[_builtins.str]] = ..., network_attachment: Optional[pulumi.Input[_builtins.str]] = ..., unreachable_cidr_block: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="effectiveUnreachableCidrBlock")
    def effective_unreachable_cidr_block(self) -> Optional[pulumi.Input[_builtins.str]]:
        
        ...
    
    @effective_unreachable_cidr_block.setter
    def effective_unreachable_cidr_block(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def unreachable_cidr_block(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
