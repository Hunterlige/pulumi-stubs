...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['V2QueuedResourceTpu', 'V2QueuedResourceTpuNodeSpec', 'V2QueuedResourceTpuNodeSpecNode', 'V2QueuedResourceTpuNodeSpecNodeNetworkConfig', 'V2VmAcceleratorConfig', 'V2VmDataDisk', 'V2VmNetworkConfig', 'V2VmNetworkEndpoint', 'V2VmNetworkEndpointAccessConfig', 'V2VmSchedulingConfig', 'V2VmServiceAccount', 'V2VmShieldedInstanceConfig', 'V2VmSymptom']
@pulumi.output_type
class V2QueuedResourceTpu(dict):
    ...
    def __init__(__self__, *, node_specs: Optional[Sequence[outputs.V2QueuedResourceTpuNodeSpec]] = ...) -> None:
...
class V2QueuedResourceTpuNodeSpec(dict):
    ...
    def __init__(__self__, *, node: outputs.V2QueuedResourceTpuNodeSpecNode, parent: _builtins.str, node_id: Optional[_builtins.str] = ...) -> None:
...
class V2QueuedResourceTpuNodeSpecNode(dict):
    ...
    def __init__(__self__, *, runtime_version: _builtins.str, accelerator_type: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ..., network_config: Optional[outputs.V2QueuedResourceTpuNodeSpecNodeNetworkConfig] = ...) -> None:
...
class V2QueuedResourceTpuNodeSpecNodeNetworkConfig(dict):
    ...
    def __init__(__self__, *, can_ip_forward: Optional[_builtins.bool] = ..., enable_external_ips: Optional[_builtins.bool] = ..., network: Optional[_builtins.str] = ..., queue_count: Optional[_builtins.int] = ..., subnetwork: Optional[_builtins.str] = ...) -> None:
...
class V2VmDataDisk(dict):
    ...
    def __init__(__self__, *, source_disk: _builtins.str, mode: Optional[_builtins.str] = ...) -> None:
...
class V2VmNetworkEndpoint(dict):
    ...
    def __init__(__self__, *, access_configs: Optional[Sequence[outputs.V2VmNetworkEndpointAccessConfig]] = ..., ip_address: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ...) -> None:
...
class V2VmSchedulingConfig(dict):
    def __init__(__self__, *, preemptible: Optional[_builtins.bool] = ..., reserved: Optional[_builtins.bool] = ..., spot: Optional[_builtins.bool] = ...) -> None:
...
class V2VmSymptom(dict):
    ...
    def __init__(__self__, *, create_time: Optional[_builtins.str] = ..., details: Optional[_builtins.str] = ..., symptom_type: Optional[_builtins.str] = ..., worker_id: Optional[_builtins.str] = ...) -> None:
