...
class _DefaultObjectAccessControlState:
    def __init__(
        ...
        *,
        ...
        project_teams: Optional[
            pulumi.Input[
                Sequence[pulumi.Input[DefaultObjectAccessControlProjectTeamArgs]]
            ]
        ] = ...,
    ...
    def project_teams(
        ...
        pulumi.Input[Sequence[pulumi.Input[DefaultObjectAccessControlProjectTeamArgs]]]
    ]: ...
...
class DefaultObjectAccessControl(pulumi.CustomResource):
    ...
    def project_teams(
        self,
    ) -> pulumi.Output[Sequence[outputs.DefaultObjectAccessControlProjectTeam]]: ...
    @_builtins.property
    @pulumi.getter
