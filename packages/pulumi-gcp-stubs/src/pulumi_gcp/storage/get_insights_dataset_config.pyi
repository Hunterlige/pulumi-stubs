...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetInsightsDatasetConfigResult', 'AwaitableGetInsightsDatasetConfigResult', 'get_insights_dataset_config', 'get_insights_dataset_config_output']
@pulumi.output_type
class GetInsightsDatasetConfigResult:
    
    def __init__(__self__, activity_data_retention_period_days=..., create_time=..., dataset_config_id=..., dataset_config_state=..., description=..., exclude_cloud_storage_buckets=..., exclude_cloud_storage_locations=..., id=..., identities=..., include_cloud_storage_buckets=..., include_cloud_storage_locations=..., include_newly_created_buckets=..., link_dataset=..., links=..., location=..., name=..., organization_number=..., organization_scope=..., project=..., retention_period_days=..., source_folders=..., source_projects=..., uid=..., update_time=...) -> None:
        ...
...
class AwaitableGetInsightsDatasetConfigResult(GetInsightsDatasetConfigResult):
    def __await__(self): # -> Generator[Never, Any, GetInsightsDatasetConfigResult]:
        ...
    


def get_insights_dataset_config(dataset_config_id: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetInsightsDatasetConfigResult:
    
    ...

def get_insights_dataset_config_output(dataset_config_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetInsightsDatasetConfigResult]:
