...
class ControlOrganizationIntelligenceConfigArgs:
    def __init__(
        ...
        *,
        ...
        filter: Optional[
            pulumi.Input[ControlOrganizationIntelligenceConfigFilterArgs]
        ] = ...,
    ...
    def filter(
        self,
    ) -> Optional[pulumi.Input[ControlOrganizationIntelligenceConfigFilterArgs]]: ...
    @filter.setter
    def filter(
        self,
        value: Optional[pulumi.Input[ControlOrganizationIntelligenceConfigFilterArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _ControlOrganizationIntelligenceConfigState:
    def __init__(
        ...
        *,
        ...
        trial_configs: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[ControlOrganizationIntelligenceConfigTrialConfigArgs]
                ]
            ]
        ] = ...,
    ...
    def trial_configs(
        ...
        pulumi.Input[
            Sequence[pulumi.Input[ControlOrganizationIntelligenceConfigTrialConfigArgs]]
        ]
    ]: ...
...
class ControlOrganizationIntelligenceConfig(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[ControlOrganizationIntelligenceConfigArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
    ...
    def filter(
        ...
        Optional[outputs.ControlOrganizationIntelligenceConfigFilter]
    ]: ...
    @_builtins.property
    @pulumi.getter
    ...
    def trial_configs(
        ...
        Sequence[outputs.ControlOrganizationIntelligenceConfigTrialConfig]
    ]: ...
    @_builtins.property
    @pulumi.getter(name="updateTime")
