...
class ObjectAccessControlArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], entity: pulumi.Input[_builtins.str], object: pulumi.Input[_builtins.str], role: pulumi.Input[_builtins.str]) -> None:
...
class _ObjectAccessControlState:
    def __init__(__self__, *, bucket: Optional[pulumi.Input[_builtins.str]] = ..., domain: Optional[pulumi.Input[_builtins.str]] = ..., email: Optional[pulumi.Input[_builtins.str]] = ..., entity: Optional[pulumi.Input[_builtins.str]] = ..., entity_id: Optional[pulumi.Input[_builtins.str]] = ..., generation: Optional[pulumi.Input[_builtins.int]] = ..., object: Optional[pulumi.Input[_builtins.str]] = ..., project_teams: Optional[pulumi.Input[Sequence[pulumi.Input[ObjectAccessControlProjectTeamArgs]]]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def project_teams(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ObjectAccessControlProjectTeamArgs]]]]): # -> None:
        ...
...
class ObjectAccessControl(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: ObjectAccessControlArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., bucket: Optional[pulumi.Input[_builtins.str]] = ..., domain: Optional[pulumi.Input[_builtins.str]] = ..., email: Optional[pulumi.Input[_builtins.str]] = ..., entity: Optional[pulumi.Input[_builtins.str]] = ..., entity_id: Optional[pulumi.Input[_builtins.str]] = ..., generation: Optional[pulumi.Input[_builtins.int]] = ..., object: Optional[pulumi.Input[_builtins.str]] = ..., project_teams: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ObjectAccessControlProjectTeamArgs, ObjectAccessControlProjectTeamArgsDict]]]]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ...) -> ObjectAccessControl:
