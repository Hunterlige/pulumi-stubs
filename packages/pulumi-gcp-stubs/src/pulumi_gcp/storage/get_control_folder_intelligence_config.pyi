...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GetControlFolderIntelligenceConfigResult', 'AwaitableGetControlFolderIntelligenceConfigResult', 'get_control_folder_intelligence_config', 'get_control_folder_intelligence_config_output']
@pulumi.output_type
...
class AwaitableGetControlFolderIntelligenceConfigResult(GetControlFolderIntelligenceConfigResult):
    def __await__(self): # -> Generator[Never, Any, GetControlFolderIntelligenceConfigResult]:
        ...
    


def get_control_folder_intelligence_config(name: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetControlFolderIntelligenceConfigResult:
    
    ...

def get_control_folder_intelligence_config_output(name: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetControlFolderIntelligenceConfigResult]:
