...
class ManagedFolderIamMemberArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], managed_folder: pulumi.Input[_builtins.str], member: pulumi.Input[_builtins.str], role: pulumi.Input[_builtins.str], condition: Optional[pulumi.Input[ManagedFolderIamMemberConditionArgs]] = ...) -> None:
    ...
    @condition.setter
    def condition(self, value: Optional[pulumi.Input[ManagedFolderIamMemberConditionArgs]]): # -> None:
        ...
...
class _ManagedFolderIamMemberState:
    def __init__(__self__, *, bucket: Optional[pulumi.Input[_builtins.str]] = ..., condition: Optional[pulumi.Input[ManagedFolderIamMemberConditionArgs]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., managed_folder: Optional[pulumi.Input[_builtins.str]] = ..., member: Optional[pulumi.Input[_builtins.str]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ManagedFolderIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., bucket: Optional[pulumi.Input[_builtins.str]] = ..., condition: Optional[pulumi.Input[Union[ManagedFolderIamMemberConditionArgs, ManagedFolderIamMemberConditionArgsDict]]] = ..., managed_folder: Optional[pulumi.Input[_builtins.str]] = ..., member: Optional[pulumi.Input[_builtins.str]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ManagedFolderIamMemberArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., bucket: Optional[pulumi.Input[_builtins.str]] = ..., condition: Optional[pulumi.Input[Union[ManagedFolderIamMemberConditionArgs, ManagedFolderIamMemberConditionArgsDict]]] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., managed_folder: Optional[pulumi.Input[_builtins.str]] = ..., member: Optional[pulumi.Input[_builtins.str]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ...) -> ManagedFolderIamMember:
