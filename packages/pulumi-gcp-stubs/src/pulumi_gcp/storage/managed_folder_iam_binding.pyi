...
class ManagedFolderIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[ManagedFolderIamBindingConditionArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[ManagedFolderIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[ManagedFolderIamBindingConditionArgs]]
    ): ...
...
class ManagedFolderIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.ManagedFolderIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
