...
class BucketIAMBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[BucketIAMBindingConditionArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[BucketIAMBindingConditionArgs]]
    ): ...
...
class BucketIAMBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[BucketIAMBindingConditionArgs, BucketIAMBindingConditionArgsDict]
            ]
        ] = ...,
        members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
        role: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.BucketIAMBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
