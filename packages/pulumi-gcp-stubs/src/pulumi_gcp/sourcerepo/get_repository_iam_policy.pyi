...
class GetRepositoryIamPolicyResult:
    def __init__(
        __self__, etag=..., id=..., policy_data=..., project=..., repository=...
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
