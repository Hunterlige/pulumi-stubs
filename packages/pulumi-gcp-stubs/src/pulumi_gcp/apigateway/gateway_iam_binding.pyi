...
class GatewayIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[GatewayIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[GatewayIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class GatewayIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    GatewayIamBindingConditionArgs, GatewayIamBindingConditionArgsDict
                ]
            ]
        ] = ...,
        gateway: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.GatewayIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
