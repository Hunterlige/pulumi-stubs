...
class ApiConfigIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[ApiConfigIamBindingConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[ApiConfigIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class ApiConfigIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.ApiConfigIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
