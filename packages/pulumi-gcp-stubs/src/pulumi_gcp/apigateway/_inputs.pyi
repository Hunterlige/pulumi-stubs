...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ApiConfigGatewayConfigArgs', 'ApiConfigGatewayConfigArgsDict', 'ApiConfigGatewayConfigBackendConfigArgs', 'ApiConfigGatewayConfigBackendConfigArgsDict', 'ApiConfigGrpcServiceArgs', 'ApiConfigGrpcServiceArgsDict', 'ApiConfigGrpcServiceFileDescriptorSetArgs', 'ApiConfigGrpcServiceFileDescriptorSetArgsDict', 'ApiConfigGrpcServiceSourceArgs', 'ApiConfigGrpcServiceSourceArgsDict', 'ApiConfigIamBindingConditionArgs', 'ApiConfigIamBindingConditionArgsDict', 'ApiConfigIamMemberConditionArgs', 'ApiConfigIamMemberConditionArgsDict', 'ApiConfigManagedServiceConfigArgs', 'ApiConfigManagedServiceConfigArgsDict', 'ApiConfigOpenapiDocumentArgs', 'ApiConfigOpenapiDocumentArgsDict', 'ApiConfigOpenapiDocumentDocumentArgs', 'ApiConfigOpenapiDocumentDocumentArgsDict', 'ApiIamBindingConditionArgs', 'ApiIamBindingConditionArgsDict', 'ApiIamMemberConditionArgs', 'ApiIamMemberConditionArgsDict', 'GatewayIamBindingConditionArgs', 'GatewayIamBindingConditionArgsDict', 'GatewayIamMemberConditionArgs', 'GatewayIamMemberConditionArgsDict']
...
class ApiConfigGatewayConfigArgs:
    def __init__(__self__, *, backend_config: pulumi.Input[ApiConfigGatewayConfigBackendConfigArgs]) -> None:
    ...
    def backend_config(self, value: pulumi.Input[ApiConfigGatewayConfigBackendConfigArgs]): # -> None:
        ...
...
class ApiConfigGatewayConfigBackendConfigArgs:
    def __init__(__self__, *, google_service_account: pulumi.Input[_builtins.str]) -> None:
    ...
    def google_service_account(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ApiConfigGrpcServiceArgs:
    def __init__(__self__, *, file_descriptor_set: pulumi.Input[ApiConfigGrpcServiceFileDescriptorSetArgs], sources: Optional[pulumi.Input[Sequence[pulumi.Input[ApiConfigGrpcServiceSourceArgs]]]] = ...) -> None:
    ...
    def file_descriptor_set(self, value: pulumi.Input[ApiConfigGrpcServiceFileDescriptorSetArgs]): # -> None:
        ...
    ...
    @sources.setter
    def sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ApiConfigGrpcServiceSourceArgs]]]]): # -> None:
        ...
...
class ApiConfigGrpcServiceFileDescriptorSetArgs:
    def __init__(__self__, *, contents: pulumi.Input[_builtins.str], path: pulumi.Input[_builtins.str]) -> None:
    ...
    @contents.setter
    def contents(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ApiConfigOpenapiDocumentArgs:
    def __init__(__self__, *, document: pulumi.Input[ApiConfigOpenapiDocumentDocumentArgs]) -> None:
    ...
    @document.setter
    def document(self, value: pulumi.Input[ApiConfigOpenapiDocumentDocumentArgs]): # -> None:
        ...
