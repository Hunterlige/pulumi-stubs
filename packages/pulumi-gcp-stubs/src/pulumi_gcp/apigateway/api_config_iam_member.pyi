...
class ApiConfigIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[ApiConfigIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[ApiConfigIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class ApiConfigIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.ApiConfigIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
