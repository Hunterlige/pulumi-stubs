...
class ApiIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[ApiIamBindingConditionArgs]] = ...,
...
@pulumi.type_token("gcp:apigateway/apiIamBinding:ApiIamBinding")
class ApiIamBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[ApiIamBindingConditionArgs, ApiIamBindingConditionArgsDict]
            ]
        ] = ...,
        members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
