...
class GatewayIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[GatewayIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[GatewayIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class GatewayIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[GatewayIamMemberConditionArgs, GatewayIamMemberConditionArgsDict]
            ]
        ] = ...,
        gateway: Optional[pulumi.Input[_builtins.str]] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.GatewayIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
