...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AclConfigIdpConfigArgs', 'AclConfigIdpConfigArgsDict', 'AclConfigIdpConfigExternalIdpConfigArgs', 'AclConfigIdpConfigExternalIdpConfigArgsDict', 'AssistantCustomerPolicyArgs', 'AssistantCustomerPolicyArgsDict', 'AssistantCustomerPolicyBannedPhraseArgs', 'AssistantCustomerPolicyBannedPhraseArgsDict', 'AssistantCustomerPolicyModelArmorConfigArgs', 'AssistantCustomerPolicyModelArmorConfigArgsDict', 'AssistantGenerationConfigArgs', 'AssistantGenerationConfigArgsDict', 'AssistantGenerationConfigSystemInstructionArgs', 'AssistantGenerationConfigSystemInstructionArgsDict', 'ChatEngineChatEngineConfigArgs', 'ChatEngineChatEngineConfigArgsDict', 'ChatEngineChatEngineConfigAgentCreationConfigArgs', ..., 'ChatEngineChatEngineMetadataArgs', 'ChatEngineChatEngineMetadataArgsDict', 'ChatEngineCommonConfigArgs', 'ChatEngineCommonConfigArgsDict', 'CmekConfigSingleRegionKeyArgs', 'CmekConfigSingleRegionKeyArgsDict', 'ControlBoostActionArgs', 'ControlBoostActionArgsDict', 'ControlBoostActionInterpolationBoostSpecArgs', 'ControlBoostActionInterpolationBoostSpecArgsDict', ..., ..., 'ControlConditionArgs', 'ControlConditionArgsDict', 'ControlConditionActiveTimeRangeArgs', 'ControlConditionActiveTimeRangeArgsDict', 'ControlConditionQueryTermArgs', 'ControlConditionQueryTermArgsDict', 'ControlFilterActionArgs', 'ControlFilterActionArgsDict', 'ControlPromoteActionArgs', 'ControlPromoteActionArgsDict', 'ControlPromoteActionSearchLinkPromotionArgs', 'ControlPromoteActionSearchLinkPromotionArgsDict', 'ControlRedirectActionArgs', 'ControlRedirectActionArgsDict', 'ControlSynonymsActionArgs', 'ControlSynonymsActionArgsDict', 'DataConnectorActionConfigArgs', 'DataConnectorActionConfigArgsDict', 'DataConnectorBapConfigArgs', 'DataConnectorBapConfigArgsDict', 'DataConnectorDestinationConfigArgs', 'DataConnectorDestinationConfigArgsDict', 'DataConnectorDestinationConfigDestinationArgs', 'DataConnectorDestinationConfigDestinationArgsDict', 'DataConnectorEntityArgs', 'DataConnectorEntityArgsDict', 'DataConnectorErrorArgs', 'DataConnectorErrorArgsDict', 'DataStoreAdvancedSiteSearchConfigArgs', 'DataStoreAdvancedSiteSearchConfigArgsDict', 'DataStoreDocumentProcessingConfigArgs', 'DataStoreDocumentProcessingConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'LicenseConfigEndDateArgs', 'LicenseConfigEndDateArgsDict', 'LicenseConfigStartDateArgs', 'LicenseConfigStartDateArgsDict', 'RecommendationEngineCommonConfigArgs', 'RecommendationEngineCommonConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'SearchEngineCommonConfigArgs', 'SearchEngineCommonConfigArgsDict', 'SearchEngineKnowledgeGraphConfigArgs', 'SearchEngineKnowledgeGraphConfigArgsDict', 'SearchEngineKnowledgeGraphConfigFeatureConfigArgs', ..., 'SearchEngineSearchEngineConfigArgs', 'SearchEngineSearchEngineConfigArgsDict', 'TargetSiteFailureReasonArgs', 'TargetSiteFailureReasonArgsDict', 'TargetSiteFailureReasonQuotaFailureArgs', 'TargetSiteFailureReasonQuotaFailureArgsDict', 'TargetSiteSiteVerificationInfoArgs', 'TargetSiteSiteVerificationInfoArgsDict', 'WidgetConfigAccessSettingsArgs', 'WidgetConfigAccessSettingsArgsDict', 'WidgetConfigHomepageSettingArgs', 'WidgetConfigHomepageSettingArgsDict', 'WidgetConfigHomepageSettingShortcutArgs', 'WidgetConfigHomepageSettingShortcutArgsDict', 'WidgetConfigHomepageSettingShortcutIconArgs', 'WidgetConfigHomepageSettingShortcutIconArgsDict', 'WidgetConfigUiBrandingArgs', 'WidgetConfigUiBrandingArgsDict', 'WidgetConfigUiBrandingLogoArgs', 'WidgetConfigUiBrandingLogoArgsDict', 'WidgetConfigUiSettingsArgs', 'WidgetConfigUiSettingsArgsDict', 'WidgetConfigUiSettingsDataStoreUiConfigArgs', 'WidgetConfigUiSettingsDataStoreUiConfigArgsDict', ..., ..., ..., ..., 'WidgetConfigUiSettingsGenerativeAnswerConfigArgs', ...]
...
class AclConfigIdpConfigArgs:
    def __init__(__self__, *, external_idp_config: Optional[pulumi.Input[AclConfigIdpConfigExternalIdpConfigArgs]] = ..., idp_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def external_idp_config(self, value: Optional[pulumi.Input[AclConfigIdpConfigExternalIdpConfigArgs]]): # -> None:
        ...
    ...
    @idp_type.setter
    def idp_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AclConfigIdpConfigExternalIdpConfigArgs:
    def __init__(__self__, *, workforce_pool_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def workforce_pool_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AssistantCustomerPolicyArgs:
    def __init__(__self__, *, banned_phrases: Optional[pulumi.Input[Sequence[pulumi.Input[AssistantCustomerPolicyBannedPhraseArgs]]]] = ..., model_armor_config: Optional[pulumi.Input[AssistantCustomerPolicyModelArmorConfigArgs]] = ...) -> None:
    ...
    def banned_phrases(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AssistantCustomerPolicyBannedPhraseArgs]]]]): # -> None:
        ...
    ...
    def model_armor_config(self, value: Optional[pulumi.Input[AssistantCustomerPolicyModelArmorConfigArgs]]): # -> None:
        ...
...
class AssistantCustomerPolicyBannedPhraseArgs:
    def __init__(__self__, *, phrase: pulumi.Input[_builtins.str], ignore_diacritics: Optional[pulumi.Input[_builtins.bool]] = ..., match_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @phrase.setter
    def phrase(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def ignore_diacritics(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class AssistantCustomerPolicyModelArmorConfigArgs:
    def __init__(__self__, *, response_template: pulumi.Input[_builtins.str], user_prompt_template: pulumi.Input[_builtins.str], failure_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def response_template(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def user_prompt_template(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @failure_mode.setter
    def failure_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AssistantGenerationConfigArgs:
    def __init__(__self__, *, default_language: Optional[pulumi.Input[_builtins.str]] = ..., system_instruction: Optional[pulumi.Input[AssistantGenerationConfigSystemInstructionArgs]] = ...) -> None:
    ...
    def system_instruction(self, value: Optional[pulumi.Input[AssistantGenerationConfigSystemInstructionArgs]]): # -> None:
        ...
...
class AssistantGenerationConfigSystemInstructionArgs:
    def __init__(__self__, *, additional_system_instruction: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def additional_system_instruction(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ChatEngineChatEngineConfigArgs:
    def __init__(__self__, *, agent_creation_config: Optional[pulumi.Input[ChatEngineChatEngineConfigAgentCreationConfigArgs]] = ..., allow_cross_region: Optional[pulumi.Input[_builtins.bool]] = ..., dialogflow_agent_to_link: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def agent_creation_config(self, value: Optional[pulumi.Input[ChatEngineChatEngineConfigAgentCreationConfigArgs]]): # -> None:
        ...
    ...
    def allow_cross_region(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def dialogflow_agent_to_link(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ChatEngineChatEngineConfigAgentCreationConfigArgs:
    def __init__(__self__, *, default_language_code: pulumi.Input[_builtins.str], time_zone: pulumi.Input[_builtins.str], business: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ChatEngineChatEngineMetadataArgs:
    def __init__(__self__, *, dialogflow_agent: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dialogflow_agent(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ChatEngineCommonConfigArgs:
    def __init__(__self__, *, company_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ControlBoostActionArgs:
    def __init__(__self__, *, data_store: pulumi.Input[_builtins.str], filter: pulumi.Input[_builtins.str], fixed_boost: Optional[pulumi.Input[_builtins.float]] = ..., interpolation_boost_spec: Optional[pulumi.Input[ControlBoostActionInterpolationBoostSpecArgs]] = ...) -> None:
    ...
    @data_store.setter
    def data_store(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @fixed_boost.setter
    def fixed_boost(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def interpolation_boost_spec(self, value: Optional[pulumi.Input[ControlBoostActionInterpolationBoostSpecArgs]]): # -> None:
        ...
...
class ControlBoostActionInterpolationBoostSpecArgs:
    def __init__(__self__, *, attribute_type: Optional[pulumi.Input[_builtins.str]] = ..., control_point: Optional[pulumi.Input[ControlBoostActionInterpolationBoostSpecControlPointArgs]] = ..., field_name: Optional[pulumi.Input[_builtins.str]] = ..., interpolation_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def control_point(self, value: Optional[pulumi.Input[ControlBoostActionInterpolationBoostSpecControlPointArgs]]): # -> None:
        ...
...
class ControlConditionArgs:
    def __init__(__self__, *, active_time_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[ControlConditionActiveTimeRangeArgs]]]] = ..., query_regex: Optional[pulumi.Input[_builtins.str]] = ..., query_terms: Optional[pulumi.Input[Sequence[pulumi.Input[ControlConditionQueryTermArgs]]]] = ...) -> None:
    ...
    def active_time_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ControlConditionActiveTimeRangeArgs]]]]): # -> None:
        ...
    ...
    @query_regex.setter
    def query_regex(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @query_terms.setter
    def query_terms(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ControlConditionQueryTermArgs]]]]): # -> None:
        ...
...
class ControlConditionActiveTimeRangeArgs:
    def __init__(__self__, *, end_time: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ControlConditionQueryTermArgs:
    def __init__(__self__, *, full_match: Optional[pulumi.Input[_builtins.bool]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @full_match.setter
    def full_match(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ControlFilterActionArgs:
    def __init__(__self__, *, data_store: pulumi.Input[_builtins.str], filter: pulumi.Input[_builtins.str]) -> None:
...
class ControlPromoteActionArgs:
    def __init__(__self__, *, data_store: pulumi.Input[_builtins.str], search_link_promotion: pulumi.Input[ControlPromoteActionSearchLinkPromotionArgs]) -> None:
    ...
    def search_link_promotion(self, value: pulumi.Input[ControlPromoteActionSearchLinkPromotionArgs]): # -> None:
        ...
...
class ControlPromoteActionSearchLinkPromotionArgs:
    def __init__(__self__, *, title: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., document: Optional[pulumi.Input[_builtins.str]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., image_uri: Optional[pulumi.Input[_builtins.str]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @document.setter
    def document(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ControlRedirectActionArgs:
    ...
    @redirect_uri.setter
    def redirect_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ControlSynonymsActionArgs:
    def __init__(__self__, *, synonyms: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class DataConnectorActionConfigArgs:
    def __init__(__self__, *, action_params: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., create_bap_connection: Optional[pulumi.Input[_builtins.bool]] = ..., is_action_configured: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def action_params(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def create_bap_connection(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def is_action_configured(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DataConnectorBapConfigArgs:
    def __init__(__self__, *, enabled_actions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., supported_connector_modes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def enabled_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def supported_connector_modes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DataConnectorDestinationConfigArgs:
    def __init__(__self__, *, destinations: Optional[pulumi.Input[Sequence[pulumi.Input[DataConnectorDestinationConfigDestinationArgs]]]] = ..., key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @destinations.setter
    def destinations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataConnectorDestinationConfigDestinationArgs]]]]): # -> None:
        ...
...
class DataConnectorDestinationConfigDestinationArgs:
    def __init__(__self__, *, host: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DataConnectorEntityArgs:
    def __init__(__self__, *, data_store: Optional[pulumi.Input[_builtins.str]] = ..., entity_name: Optional[pulumi.Input[_builtins.str]] = ..., key_property_mappings: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., params: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def key_property_mappings(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @params.setter
    def params(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DataStoreAdvancedSiteSearchConfigArgs:
    def __init__(__self__, *, disable_automatic_refresh: Optional[pulumi.Input[_builtins.bool]] = ..., disable_initial_index: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def disable_automatic_refresh(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def disable_initial_index(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DataStoreDocumentProcessingConfigArgs:
    def __init__(__self__, *, chunking_config: Optional[pulumi.Input[DataStoreDocumentProcessingConfigChunkingConfigArgs]] = ..., default_parsing_config: Optional[pulumi.Input[DataStoreDocumentProcessingConfigDefaultParsingConfigArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., parsing_config_overrides: Optional[pulumi.Input[Sequence[pulumi.Input[DataStoreDocumentProcessingConfigParsingConfigOverrideArgs]]]] = ...) -> None:
    ...
    def chunking_config(self, value: Optional[pulumi.Input[DataStoreDocumentProcessingConfigChunkingConfigArgs]]): # -> None:
        ...
    ...
    def default_parsing_config(self, value: Optional[pulumi.Input[DataStoreDocumentProcessingConfigDefaultParsingConfigArgs]]): # -> None:
        ...
    ...
    def parsing_config_overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DataStoreDocumentProcessingConfigParsingConfigOverrideArgs]]]]): # -> None:
        ...
...
class DataStoreDocumentProcessingConfigChunkingConfigArgs:
    def __init__(__self__, *, layout_based_chunking_config: Optional[pulumi.Input[DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfigArgs]] = ...) -> None:
    ...
    def layout_based_chunking_config(self, value: Optional[pulumi.Input[DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfigArgs]]): # -> None:
        ...
...
class DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfigArgs:
    def __init__(__self__, *, chunk_size: Optional[pulumi.Input[_builtins.int]] = ..., include_ancestor_headings: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @chunk_size.setter
    def chunk_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def include_ancestor_headings(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DataStoreDocumentProcessingConfigDefaultParsingConfigArgs:
    def __init__(__self__, *, digital_parsing_config: Optional[pulumi.Input[DataStoreDocumentProcessingConfigDefaultParsingConfigDigitalParsingConfigArgs]] = ..., layout_parsing_config: Optional[pulumi.Input[DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigArgs]] = ..., ocr_parsing_config: Optional[pulumi.Input[DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfigArgs]] = ...) -> None:
    ...
    def digital_parsing_config(self, value: Optional[pulumi.Input[DataStoreDocumentProcessingConfigDefaultParsingConfigDigitalParsingConfigArgs]]): # -> None:
        ...
    ...
    def layout_parsing_config(self, value: Optional[pulumi.Input[DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigArgs]]): # -> None:
        ...
    ...
    def ocr_parsing_config(self, value: Optional[pulumi.Input[DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfigArgs]]): # -> None:
        ...
...
class DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigArgs:
    def __init__(__self__, *, enable_image_annotation: Optional[pulumi.Input[_builtins.bool]] = ..., enable_table_annotation: Optional[pulumi.Input[_builtins.bool]] = ..., exclude_html_classes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., exclude_html_elements: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., exclude_html_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., structured_content_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def enable_image_annotation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_table_annotation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def exclude_html_classes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def exclude_html_elements(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def exclude_html_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def structured_content_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfigArgs:
    def __init__(__self__, *, use_native_text: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def use_native_text(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DataStoreDocumentProcessingConfigParsingConfigOverrideArgs:
    ...
    @digital_parsing_config.setter
    def digital_parsing_config(self, value: Optional[pulumi.Input[DataStoreDocumentProcessingConfigParsingConfigOverrideDigitalParsingConfigArgs]]): # -> None:
        ...
    ...
    @layout_parsing_config.setter
    def layout_parsing_config(self, value: Optional[pulumi.Input[DataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfigArgs]]): # -> None:
        ...
    ...
    @ocr_parsing_config.setter
    def ocr_parsing_config(self, value: Optional[pulumi.Input[DataStoreDocumentProcessingConfigParsingConfigOverrideOcrParsingConfigArgs]]): # -> None:
        ...
...
class RecommendationEngineMediaRecommendationEngineConfigArgs:
    def __init__(__self__, *, engine_features_config: Optional[pulumi.Input[RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigArgs]] = ..., optimization_objective: Optional[pulumi.Input[_builtins.str]] = ..., optimization_objective_config: Optional[pulumi.Input[RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigArgs]] = ..., training_state: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def engine_features_config(self, value: Optional[pulumi.Input[RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigArgs]]): # -> None:
        ...
    ...
    def optimization_objective(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def optimization_objective_config(self, value: Optional[pulumi.Input[RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigArgs]]): # -> None:
        ...
    ...
    def training_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigArgs:
    def __init__(__self__, *, most_popular_config: Optional[pulumi.Input[RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigMostPopularConfigArgs]] = ..., recommended_for_you_config: Optional[pulumi.Input[RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigRecommendedForYouConfigArgs]] = ...) -> None:
    ...
    def most_popular_config(self, value: Optional[pulumi.Input[RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigMostPopularConfigArgs]]): # -> None:
        ...
    ...
    def recommended_for_you_config(self, value: Optional[pulumi.Input[RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigRecommendedForYouConfigArgs]]): # -> None:
        ...
...
class RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigMostPopularConfigArgs:
    def __init__(__self__, *, time_window_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def time_window_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigRecommendedForYouConfigArgs:
    def __init__(__self__, *, context_event_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def context_event_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigArgs:
    def __init__(__self__, *, target_field: Optional[pulumi.Input[_builtins.str]] = ..., target_field_value_float: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @target_field.setter
    def target_field(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_field_value_float(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class SearchEngineKnowledgeGraphConfigArgs:
    def __init__(__self__, *, cloud_knowledge_graph_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., enable_cloud_knowledge_graph: Optional[pulumi.Input[_builtins.bool]] = ..., enable_private_knowledge_graph: Optional[pulumi.Input[_builtins.bool]] = ..., feature_config: Optional[pulumi.Input[SearchEngineKnowledgeGraphConfigFeatureConfigArgs]] = ...) -> None:
    ...
    def cloud_knowledge_graph_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def enable_cloud_knowledge_graph(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_private_knowledge_graph(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def feature_config(self, value: Optional[pulumi.Input[SearchEngineKnowledgeGraphConfigFeatureConfigArgs]]): # -> None:
        ...
...
class SearchEngineKnowledgeGraphConfigFeatureConfigArgs:
    def __init__(__self__, *, disable_private_kg_auto_complete: Optional[pulumi.Input[_builtins.bool]] = ..., disable_private_kg_enrichment: Optional[pulumi.Input[_builtins.bool]] = ..., disable_private_kg_query_ui_chips: Optional[pulumi.Input[_builtins.bool]] = ..., disable_private_kg_query_understanding: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def disable_private_kg_auto_complete(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def disable_private_kg_enrichment(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def disable_private_kg_query_ui_chips(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def disable_private_kg_query_understanding(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class SearchEngineSearchEngineConfigArgs:
    def __init__(__self__, *, required_subscription_tier: Optional[pulumi.Input[_builtins.str]] = ..., search_add_ons: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., search_tier: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def required_subscription_tier(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def search_add_ons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @search_tier.setter
    def search_tier(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TargetSiteFailureReasonArgs:
    def __init__(__self__, *, quota_failure: Optional[pulumi.Input[TargetSiteFailureReasonQuotaFailureArgs]] = ...) -> None:
    ...
    def quota_failure(self, value: Optional[pulumi.Input[TargetSiteFailureReasonQuotaFailureArgs]]): # -> None:
        ...
...
class TargetSiteFailureReasonQuotaFailureArgs:
    def __init__(__self__, *, total_required_quota: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def total_required_quota(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class TargetSiteSiteVerificationInfoArgs:
    def __init__(__self__, *, site_verification_state: Optional[pulumi.Input[_builtins.str]] = ..., verify_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def site_verification_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @verify_time.setter
    def verify_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WidgetConfigAccessSettingsArgs:
    def __init__(__self__, *, allow_public_access: Optional[pulumi.Input[_builtins.bool]] = ..., allowlisted_domains: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., enable_web_app: Optional[pulumi.Input[_builtins.bool]] = ..., language_code: Optional[pulumi.Input[_builtins.str]] = ..., workforce_identity_pool_provider: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allow_public_access(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def allowlisted_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def enable_web_app(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def workforce_identity_pool_provider(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WidgetConfigHomepageSettingArgs:
    def __init__(__self__, *, shortcuts: Optional[pulumi.Input[Sequence[pulumi.Input[WidgetConfigHomepageSettingShortcutArgs]]]] = ...) -> None:
    ...
    @shortcuts.setter
    def shortcuts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WidgetConfigHomepageSettingShortcutArgs]]]]): # -> None:
        ...
...
class WidgetConfigHomepageSettingShortcutArgs:
    def __init__(__self__, *, destination_uri: Optional[pulumi.Input[_builtins.str]] = ..., icon: Optional[pulumi.Input[WidgetConfigHomepageSettingShortcutIconArgs]] = ..., title: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def destination_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @icon.setter
    def icon(self, value: Optional[pulumi.Input[WidgetConfigHomepageSettingShortcutIconArgs]]): # -> None:
        ...
...
class WidgetConfigUiBrandingArgs:
    def __init__(__self__, *, logo: Optional[pulumi.Input[WidgetConfigUiBrandingLogoArgs]] = ...) -> None:
    ...
    @logo.setter
    def logo(self, value: Optional[pulumi.Input[WidgetConfigUiBrandingLogoArgs]]): # -> None:
        ...
...
class WidgetConfigUiSettingsArgs:
    def __init__(__self__, *, data_store_ui_configs: Optional[pulumi.Input[Sequence[pulumi.Input[WidgetConfigUiSettingsDataStoreUiConfigArgs]]]] = ..., default_search_request_order_by: Optional[pulumi.Input[_builtins.str]] = ..., disable_user_events_collection: Optional[pulumi.Input[_builtins.bool]] = ..., enable_autocomplete: Optional[pulumi.Input[_builtins.bool]] = ..., enable_create_agent_button: Optional[pulumi.Input[_builtins.bool]] = ..., enable_people_search: Optional[pulumi.Input[_builtins.bool]] = ..., enable_quality_feedback: Optional[pulumi.Input[_builtins.bool]] = ..., enable_safe_search: Optional[pulumi.Input[_builtins.bool]] = ..., enable_search_as_you_type: Optional[pulumi.Input[_builtins.bool]] = ..., enable_visual_content_summary: Optional[pulumi.Input[_builtins.bool]] = ..., generative_answer_config: Optional[pulumi.Input[WidgetConfigUiSettingsGenerativeAnswerConfigArgs]] = ..., interaction_type: Optional[pulumi.Input[_builtins.str]] = ..., result_description_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def data_store_ui_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WidgetConfigUiSettingsDataStoreUiConfigArgs]]]]): # -> None:
        ...
    ...
    def default_search_request_order_by(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def disable_user_events_collection(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_autocomplete(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_create_agent_button(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_people_search(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_quality_feedback(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_safe_search(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_search_as_you_type(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_visual_content_summary(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def generative_answer_config(self, value: Optional[pulumi.Input[WidgetConfigUiSettingsGenerativeAnswerConfigArgs]]): # -> None:
        ...
    ...
    def interaction_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def result_description_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WidgetConfigUiSettingsDataStoreUiConfigArgs:
    def __init__(__self__, *, facet_fields: Optional[pulumi.Input[Sequence[pulumi.Input[WidgetConfigUiSettingsDataStoreUiConfigFacetFieldArgs]]]] = ..., fields_ui_components_maps: Optional[pulumi.Input[Sequence[pulumi.Input[WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMapArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @facet_fields.setter
    def facet_fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WidgetConfigUiSettingsDataStoreUiConfigFacetFieldArgs]]]]): # -> None:
        ...
    ...
    def fields_ui_components_maps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMapArgs]]]]): # -> None:
        ...
...
class WidgetConfigUiSettingsDataStoreUiConfigFacetFieldArgs:
    def __init__(__self__, *, field: pulumi.Input[_builtins.str], display_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMapArgs:
    def __init__(__self__, *, field: pulumi.Input[_builtins.str], ui_component: pulumi.Input[_builtins.str], device_visibilities: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., display_template: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @ui_component.setter
    def ui_component(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def device_visibilities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def display_template(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WidgetConfigUiSettingsGenerativeAnswerConfigArgs:
    def __init__(__self__, *, disable_related_questions: Optional[pulumi.Input[_builtins.bool]] = ..., ignore_adversarial_query: Optional[pulumi.Input[_builtins.bool]] = ..., ignore_low_relevant_content: Optional[pulumi.Input[_builtins.bool]] = ..., ignore_non_answer_seeking_query: Optional[pulumi.Input[_builtins.bool]] = ..., image_source: Optional[pulumi.Input[_builtins.str]] = ..., language_code: Optional[pulumi.Input[_builtins.str]] = ..., max_rephrase_steps: Optional[pulumi.Input[_builtins.int]] = ..., model_prompt_preamble: Optional[pulumi.Input[_builtins.str]] = ..., model_version: Optional[pulumi.Input[_builtins.str]] = ..., result_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def disable_related_questions(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def ignore_adversarial_query(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def ignore_low_relevant_content(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def ignore_non_answer_seeking_query(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @image_source.setter
    def image_source(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_rephrase_steps(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def model_prompt_preamble(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def model_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @result_count.setter
    def result_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
