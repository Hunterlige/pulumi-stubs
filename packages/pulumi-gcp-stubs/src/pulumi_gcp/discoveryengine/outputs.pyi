...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AclConfigIdpConfig', 'AclConfigIdpConfigExternalIdpConfig', 'AssistantCustomerPolicy', 'AssistantCustomerPolicyBannedPhrase', 'AssistantCustomerPolicyModelArmorConfig', 'AssistantGenerationConfig', 'AssistantGenerationConfigSystemInstruction', 'ChatEngineChatEngineConfig', 'ChatEngineChatEngineConfigAgentCreationConfig', 'ChatEngineChatEngineMetadata', 'ChatEngineCommonConfig', 'CmekConfigSingleRegionKey', 'ControlBoostAction', 'ControlBoostActionInterpolationBoostSpec', ..., 'ControlCondition', 'ControlConditionActiveTimeRange', 'ControlConditionQueryTerm', 'ControlFilterAction', 'ControlPromoteAction', 'ControlPromoteActionSearchLinkPromotion', 'ControlRedirectAction', 'ControlSynonymsAction', 'DataConnectorActionConfig', 'DataConnectorBapConfig', 'DataConnectorDestinationConfig', 'DataConnectorDestinationConfigDestination', 'DataConnectorEntity', 'DataConnectorError', 'DataStoreAdvancedSiteSearchConfig', 'DataStoreDocumentProcessingConfig', 'DataStoreDocumentProcessingConfigChunkingConfig', ..., ..., ..., ..., ..., ..., ..., ..., ..., 'LicenseConfigEndDate', 'LicenseConfigStartDate', 'RecommendationEngineCommonConfig', ..., ..., ..., ..., ..., 'SearchEngineCommonConfig', 'SearchEngineKnowledgeGraphConfig', 'SearchEngineKnowledgeGraphConfigFeatureConfig', 'SearchEngineSearchEngineConfig', 'TargetSiteFailureReason', 'TargetSiteFailureReasonQuotaFailure', 'TargetSiteSiteVerificationInfo', 'WidgetConfigAccessSettings', 'WidgetConfigHomepageSetting', 'WidgetConfigHomepageSettingShortcut', 'WidgetConfigHomepageSettingShortcutIcon', 'WidgetConfigUiBranding', 'WidgetConfigUiBrandingLogo', 'WidgetConfigUiSettings', 'WidgetConfigUiSettingsDataStoreUiConfig', 'WidgetConfigUiSettingsDataStoreUiConfigFacetField', ..., 'WidgetConfigUiSettingsGenerativeAnswerConfig']
@pulumi.output_type
class AclConfigIdpConfig(dict):
    ...
    def __init__(__self__, *, external_idp_config: Optional[outputs.AclConfigIdpConfigExternalIdpConfig] = ..., idp_type: Optional[_builtins.str] = ...) -> None:
...
class AclConfigIdpConfigExternalIdpConfig(dict):
    ...
    def __init__(__self__, *, workforce_pool_name: Optional[_builtins.str] = ...) -> None:
...
class AssistantCustomerPolicy(dict):
    ...
    def __init__(__self__, *, banned_phrases: Optional[Sequence[outputs.AssistantCustomerPolicyBannedPhrase]] = ..., model_armor_config: Optional[outputs.AssistantCustomerPolicyModelArmorConfig] = ...) -> None:
...
class AssistantCustomerPolicyBannedPhrase(dict):
    ...
    def __init__(__self__, *, phrase: _builtins.str, ignore_diacritics: Optional[_builtins.bool] = ..., match_type: Optional[_builtins.str] = ...) -> None:
...
class AssistantCustomerPolicyModelArmorConfig(dict):
    ...
    def __init__(__self__, *, response_template: _builtins.str, user_prompt_template: _builtins.str, failure_mode: Optional[_builtins.str] = ...) -> None:
...
class AssistantGenerationConfig(dict):
    ...
    def __init__(__self__, *, default_language: Optional[_builtins.str] = ..., system_instruction: Optional[outputs.AssistantGenerationConfigSystemInstruction] = ...) -> None:
...
class AssistantGenerationConfigSystemInstruction(dict):
    ...
    def __init__(__self__, *, additional_system_instruction: Optional[_builtins.str] = ...) -> None:
...
class ChatEngineChatEngineConfig(dict):
    ...
    def __init__(__self__, *, agent_creation_config: Optional[outputs.ChatEngineChatEngineConfigAgentCreationConfig] = ..., allow_cross_region: Optional[_builtins.bool] = ..., dialogflow_agent_to_link: Optional[_builtins.str] = ...) -> None:
...
class ChatEngineChatEngineConfigAgentCreationConfig(dict):
    ...
    def __init__(__self__, *, default_language_code: _builtins.str, time_zone: _builtins.str, business: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ...) -> None:
...
class ChatEngineChatEngineMetadata(dict):
    ...
    def __init__(__self__, *, dialogflow_agent: Optional[_builtins.str] = ...) -> None:
...
class ControlBoostAction(dict):
    ...
    def __init__(__self__, *, data_store: _builtins.str, filter: _builtins.str, fixed_boost: Optional[_builtins.float] = ..., interpolation_boost_spec: Optional[outputs.ControlBoostActionInterpolationBoostSpec] = ...) -> None:
...
class ControlBoostActionInterpolationBoostSpec(dict):
    ...
    def __init__(__self__, *, attribute_type: Optional[_builtins.str] = ..., control_point: Optional[outputs.ControlBoostActionInterpolationBoostSpecControlPoint] = ..., field_name: Optional[_builtins.str] = ..., interpolation_type: Optional[_builtins.str] = ...) -> None:
...
class ControlCondition(dict):
    ...
    def __init__(__self__, *, active_time_ranges: Optional[Sequence[outputs.ControlConditionActiveTimeRange]] = ..., query_regex: Optional[_builtins.str] = ..., query_terms: Optional[Sequence[outputs.ControlConditionQueryTerm]] = ...) -> None:
...
class ControlConditionQueryTerm(dict):
    ...
    def __init__(__self__, *, full_match: Optional[_builtins.bool] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class ControlFilterAction(dict):
    ...
    def __init__(__self__, *, data_store: _builtins.str, filter: _builtins.str) -> None:
...
class ControlPromoteAction(dict):
    ...
    def __init__(__self__, *, data_store: _builtins.str, search_link_promotion: outputs.ControlPromoteActionSearchLinkPromotion) -> None:
...
class ControlPromoteActionSearchLinkPromotion(dict):
    ...
    def __init__(__self__, *, title: _builtins.str, description: Optional[_builtins.str] = ..., document: Optional[_builtins.str] = ..., enabled: Optional[_builtins.bool] = ..., image_uri: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class ControlSynonymsAction(dict):
    def __init__(__self__, *, synonyms: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DataConnectorActionConfig(dict):
    ...
    def __init__(__self__, *, action_params: Optional[Mapping[str, _builtins.str]] = ..., create_bap_connection: Optional[_builtins.bool] = ..., is_action_configured: Optional[_builtins.bool] = ...) -> None:
...
class DataConnectorBapConfig(dict):
    ...
    def __init__(__self__, *, enabled_actions: Optional[Sequence[_builtins.str]] = ..., supported_connector_modes: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DataConnectorDestinationConfig(dict):
    def __init__(__self__, *, destinations: Optional[Sequence[outputs.DataConnectorDestinationConfigDestination]] = ..., key: Optional[_builtins.str] = ...) -> None:
...
class DataConnectorEntity(dict):
    ...
    def __init__(__self__, *, data_store: Optional[_builtins.str] = ..., entity_name: Optional[_builtins.str] = ..., key_property_mappings: Optional[Mapping[str, _builtins.str]] = ..., params: Optional[_builtins.str] = ...) -> None:
...
class DataStoreAdvancedSiteSearchConfig(dict):
    ...
    def __init__(__self__, *, disable_automatic_refresh: Optional[_builtins.bool] = ..., disable_initial_index: Optional[_builtins.bool] = ...) -> None:
...
class DataStoreDocumentProcessingConfig(dict):
    ...
    def __init__(__self__, *, chunking_config: Optional[outputs.DataStoreDocumentProcessingConfigChunkingConfig] = ..., default_parsing_config: Optional[outputs.DataStoreDocumentProcessingConfigDefaultParsingConfig] = ..., name: Optional[_builtins.str] = ..., parsing_config_overrides: Optional[Sequence[outputs.DataStoreDocumentProcessingConfigParsingConfigOverride]] = ...) -> None:
...
class DataStoreDocumentProcessingConfigChunkingConfig(dict):
    ...
    def __init__(__self__, *, layout_based_chunking_config: Optional[outputs.DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfig] = ...) -> None:
...
class DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfig(dict):
    ...
    def __init__(__self__, *, chunk_size: Optional[_builtins.int] = ..., include_ancestor_headings: Optional[_builtins.bool] = ...) -> None:
...
class DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfig(dict):
    ...
    def __init__(__self__, *, enable_image_annotation: Optional[_builtins.bool] = ..., enable_table_annotation: Optional[_builtins.bool] = ..., exclude_html_classes: Optional[Sequence[_builtins.str]] = ..., exclude_html_elements: Optional[Sequence[_builtins.str]] = ..., exclude_html_ids: Optional[Sequence[_builtins.str]] = ..., structured_content_types: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfig(dict):
    ...
    def __init__(__self__, *, use_native_text: Optional[_builtins.bool] = ...) -> None:
...
class RecommendationEngineMediaRecommendationEngineConfig(dict):
    ...
    def __init__(__self__, *, engine_features_config: Optional[outputs.RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfig] = ..., optimization_objective: Optional[_builtins.str] = ..., optimization_objective_config: Optional[outputs.RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfig] = ..., training_state: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfig(dict):
    ...
    def __init__(__self__, *, most_popular_config: Optional[outputs.RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigMostPopularConfig] = ..., recommended_for_you_config: Optional[outputs.RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigRecommendedForYouConfig] = ...) -> None:
...
class RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigMostPopularConfig(dict):
    ...
    def __init__(__self__, *, time_window_days: Optional[_builtins.int] = ...) -> None:
...
class RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigRecommendedForYouConfig(dict):
    ...
    def __init__(__self__, *, context_event_type: Optional[_builtins.str] = ...) -> None:
...
class RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfig(dict):
    ...
    def __init__(__self__, *, target_field: Optional[_builtins.str] = ..., target_field_value_float: Optional[_builtins.float] = ...) -> None:
...
class SearchEngineKnowledgeGraphConfig(dict):
    ...
    def __init__(__self__, *, cloud_knowledge_graph_types: Optional[Sequence[_builtins.str]] = ..., enable_cloud_knowledge_graph: Optional[_builtins.bool] = ..., enable_private_knowledge_graph: Optional[_builtins.bool] = ..., feature_config: Optional[outputs.SearchEngineKnowledgeGraphConfigFeatureConfig] = ...) -> None:
...
class SearchEngineKnowledgeGraphConfigFeatureConfig(dict):
    ...
    def __init__(__self__, *, disable_private_kg_auto_complete: Optional[_builtins.bool] = ..., disable_private_kg_enrichment: Optional[_builtins.bool] = ..., disable_private_kg_query_ui_chips: Optional[_builtins.bool] = ..., disable_private_kg_query_understanding: Optional[_builtins.bool] = ...) -> None:
...
class SearchEngineSearchEngineConfig(dict):
    ...
    def __init__(__self__, *, required_subscription_tier: Optional[_builtins.str] = ..., search_add_ons: Optional[Sequence[_builtins.str]] = ..., search_tier: Optional[_builtins.str] = ...) -> None:
...
class TargetSiteFailureReason(dict):
    ...
    def __init__(__self__, *, quota_failure: Optional[outputs.TargetSiteFailureReasonQuotaFailure] = ...) -> None:
...
class TargetSiteFailureReasonQuotaFailure(dict):
    ...
    def __init__(__self__, *, total_required_quota: Optional[_builtins.int] = ...) -> None:
...
class TargetSiteSiteVerificationInfo(dict):
    ...
    def __init__(__self__, *, site_verification_state: Optional[_builtins.str] = ..., verify_time: Optional[_builtins.str] = ...) -> None:
...
class WidgetConfigAccessSettings(dict):
    ...
    def __init__(__self__, *, allow_public_access: Optional[_builtins.bool] = ..., allowlisted_domains: Optional[Sequence[_builtins.str]] = ..., enable_web_app: Optional[_builtins.bool] = ..., language_code: Optional[_builtins.str] = ..., workforce_identity_pool_provider: Optional[_builtins.str] = ...) -> None:
...
class WidgetConfigHomepageSetting(dict):
    def __init__(__self__, *, shortcuts: Optional[Sequence[outputs.WidgetConfigHomepageSettingShortcut]] = ...) -> None:
...
class WidgetConfigHomepageSettingShortcut(dict):
    ...
    def __init__(__self__, *, destination_uri: Optional[_builtins.str] = ..., icon: Optional[outputs.WidgetConfigHomepageSettingShortcutIcon] = ..., title: Optional[_builtins.str] = ...) -> None:
...
class WidgetConfigUiBranding(dict):
    def __init__(__self__, *, logo: Optional[outputs.WidgetConfigUiBrandingLogo] = ...) -> None:
...
class WidgetConfigUiSettings(dict):
    ...
    def __init__(__self__, *, data_store_ui_configs: Optional[Sequence[outputs.WidgetConfigUiSettingsDataStoreUiConfig]] = ..., default_search_request_order_by: Optional[_builtins.str] = ..., disable_user_events_collection: Optional[_builtins.bool] = ..., enable_autocomplete: Optional[_builtins.bool] = ..., enable_create_agent_button: Optional[_builtins.bool] = ..., enable_people_search: Optional[_builtins.bool] = ..., enable_quality_feedback: Optional[_builtins.bool] = ..., enable_safe_search: Optional[_builtins.bool] = ..., enable_search_as_you_type: Optional[_builtins.bool] = ..., enable_visual_content_summary: Optional[_builtins.bool] = ..., generative_answer_config: Optional[outputs.WidgetConfigUiSettingsGenerativeAnswerConfig] = ..., interaction_type: Optional[_builtins.str] = ..., result_description_type: Optional[_builtins.str] = ...) -> None:
...
class WidgetConfigUiSettingsDataStoreUiConfig(dict):
    ...
    def __init__(__self__, *, facet_fields: Optional[Sequence[outputs.WidgetConfigUiSettingsDataStoreUiConfigFacetField]] = ..., fields_ui_components_maps: Optional[Sequence[outputs.WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMap]] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class WidgetConfigUiSettingsDataStoreUiConfigFacetField(dict):
    ...
    def __init__(__self__, *, field: _builtins.str, display_name: Optional[_builtins.str] = ...) -> None:
...
class WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMap(dict):
    ...
    def __init__(__self__, *, field: _builtins.str, ui_component: _builtins.str, device_visibilities: Optional[Sequence[_builtins.str]] = ..., display_template: Optional[_builtins.str] = ...) -> None:
...
class WidgetConfigUiSettingsGenerativeAnswerConfig(dict):
    ...
    def __init__(__self__, *, disable_related_questions: Optional[_builtins.bool] = ..., ignore_adversarial_query: Optional[_builtins.bool] = ..., ignore_low_relevant_content: Optional[_builtins.bool] = ..., ignore_non_answer_seeking_query: Optional[_builtins.bool] = ..., image_source: Optional[_builtins.str] = ..., language_code: Optional[_builtins.str] = ..., max_rephrase_steps: Optional[_builtins.int] = ..., model_prompt_preamble: Optional[_builtins.str] = ..., model_version: Optional[_builtins.str] = ..., result_count: Optional[_builtins.int] = ...) -> None:
