...
@pulumi.output_type
class Batching(dict):
    def __init__(__self__, *, enable_batching: Optional[_builtins.bool] = ..., send_after: Optional[_builtins.str] = ...) -> None:
        ...
...
class ExternalCredentials(dict):
    def __init__(__self__, *, audience: _builtins.str, identity_token: _builtins.str, service_account_email: _builtins.str) -> None:
        ...
