...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['PipelineScheduleInfoArgs', 'PipelineScheduleInfoArgsDict', 'PipelineWorkloadArgs', 'PipelineWorkloadArgsDict', 'PipelineWorkloadDataflowFlexTemplateRequestArgs', ..., ..., ..., ..., ..., 'PipelineWorkloadDataflowLaunchTemplateRequestArgs', ..., ..., ..., ..., ...]
...
class PipelineScheduleInfoArgs:
    def __init__(__self__, *, next_job_time: Optional[pulumi.Input[_builtins.str]] = ..., schedule: Optional[pulumi.Input[_builtins.str]] = ..., time_zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def next_job_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipelineWorkloadArgs:
    def __init__(__self__, *, dataflow_flex_template_request: Optional[pulumi.Input[PipelineWorkloadDataflowFlexTemplateRequestArgs]] = ..., dataflow_launch_template_request: Optional[pulumi.Input[PipelineWorkloadDataflowLaunchTemplateRequestArgs]] = ...) -> None:
    ...
    def dataflow_flex_template_request(self, value: Optional[pulumi.Input[PipelineWorkloadDataflowFlexTemplateRequestArgs]]): # -> None:
        ...
    ...
    def dataflow_launch_template_request(self, value: Optional[pulumi.Input[PipelineWorkloadDataflowLaunchTemplateRequestArgs]]): # -> None:
        ...
...
class PipelineWorkloadDataflowFlexTemplateRequestArgs:
    def __init__(__self__, *, launch_parameter: pulumi.Input[PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterArgs], location: pulumi.Input[_builtins.str], project_id: pulumi.Input[_builtins.str], validate_only: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def launch_parameter(self, value: pulumi.Input[PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterArgs]): # -> None:
        ...
    ...
    def validate_only(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterArgs:
    def __init__(__self__, *, job_name: pulumi.Input[_builtins.str], container_spec_gcs_path: Optional[pulumi.Input[_builtins.str]] = ..., environment: Optional[pulumi.Input[PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgs]] = ..., launch_options: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., transform_name_mappings: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., update: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @environment.setter
    def environment(self, value: Optional[pulumi.Input[PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgs]]): # -> None:
        ...
    ...
    def launch_options(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def transform_name_mappings(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @update.setter
    def update(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgs:
    def __init__(__self__, *, additional_experiments: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., additional_user_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., enable_streaming_engine: Optional[pulumi.Input[_builtins.bool]] = ..., flexrs_goal: Optional[pulumi.Input[_builtins.str]] = ..., ip_configuration: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_name: Optional[pulumi.Input[_builtins.str]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., max_workers: Optional[pulumi.Input[_builtins.int]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., num_workers: Optional[pulumi.Input[_builtins.int]] = ..., service_account_email: Optional[pulumi.Input[_builtins.str]] = ..., subnetwork: Optional[pulumi.Input[_builtins.str]] = ..., temp_location: Optional[pulumi.Input[_builtins.str]] = ..., worker_region: Optional[pulumi.Input[_builtins.str]] = ..., worker_zone: Optional[pulumi.Input[_builtins.str]] = ..., zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def additional_user_labels(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @flexrs_goal.setter
    def flexrs_goal(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def worker_region(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @worker_zone.setter
    def worker_zone(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PipelineWorkloadDataflowLaunchTemplateRequestArgs:
    def __init__(__self__, *, project_id: pulumi.Input[_builtins.str], gcs_path: Optional[pulumi.Input[_builtins.str]] = ..., launch_parameters: Optional[pulumi.Input[PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersArgs]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., validate_only: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @gcs_path.setter
    def gcs_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def launch_parameters(self, value: Optional[pulumi.Input[PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersArgs]]): # -> None:
        ...
...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersArgs:
    def __init__(__self__, *, job_name: pulumi.Input[_builtins.str], environment: Optional[pulumi.Input[PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironmentArgs]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., transform_name_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., update: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @environment.setter
    def environment(self, value: Optional[pulumi.Input[PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironmentArgs]]): # -> None:
        ...
...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironmentArgs:
    def __init__(__self__, *, additional_experiments: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., additional_user_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., bypass_temp_dir_validation: Optional[pulumi.Input[_builtins.bool]] = ..., enable_streaming_engine: Optional[pulumi.Input[_builtins.bool]] = ..., ip_configuration: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_name: Optional[pulumi.Input[_builtins.str]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., max_workers: Optional[pulumi.Input[_builtins.int]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., num_workers: Optional[pulumi.Input[_builtins.int]] = ..., service_account_email: Optional[pulumi.Input[_builtins.str]] = ..., subnetwork: Optional[pulumi.Input[_builtins.str]] = ..., temp_location: Optional[pulumi.Input[_builtins.str]] = ..., worker_region: Optional[pulumi.Input[_builtins.str]] = ..., worker_zone: Optional[pulumi.Input[_builtins.str]] = ..., zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def bypass_temp_dir_validation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
