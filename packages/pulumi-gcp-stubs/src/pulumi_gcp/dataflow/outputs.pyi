...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['PipelineScheduleInfo', 'PipelineWorkload', 'PipelineWorkloadDataflowFlexTemplateRequest', ..., ..., 'PipelineWorkloadDataflowLaunchTemplateRequest', ..., ...]
@pulumi.output_type
class PipelineScheduleInfo(dict):
    ...
    def __init__(__self__, *, next_job_time: Optional[_builtins.str] = ..., schedule: Optional[_builtins.str] = ..., time_zone: Optional[_builtins.str] = ...) -> None:
...
class PipelineWorkload(dict):
    ...
    def __init__(__self__, *, dataflow_flex_template_request: Optional[outputs.PipelineWorkloadDataflowFlexTemplateRequest] = ..., dataflow_launch_template_request: Optional[outputs.PipelineWorkloadDataflowLaunchTemplateRequest] = ...) -> None:
...
class PipelineWorkloadDataflowFlexTemplateRequest(dict):
    ...
    def __init__(__self__, *, launch_parameter: outputs.PipelineWorkloadDataflowFlexTemplateRequestLaunchParameter, location: _builtins.str, project_id: _builtins.str, validate_only: Optional[_builtins.bool] = ...) -> None:
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameter(dict):
    ...
    def __init__(__self__, *, job_name: _builtins.str, container_spec_gcs_path: Optional[_builtins.str] = ..., environment: Optional[outputs.PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironment] = ..., launch_options: Optional[Mapping[str, _builtins.str]] = ..., parameters: Optional[Mapping[str, _builtins.str]] = ..., transform_name_mappings: Optional[Mapping[str, _builtins.str]] = ..., update: Optional[_builtins.bool] = ...) -> None:
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironment(dict):
    ...
    def __init__(__self__, *, additional_experiments: Optional[Sequence[_builtins.str]] = ..., additional_user_labels: Optional[Mapping[str, _builtins.str]] = ..., enable_streaming_engine: Optional[_builtins.bool] = ..., flexrs_goal: Optional[_builtins.str] = ..., ip_configuration: Optional[_builtins.str] = ..., kms_key_name: Optional[_builtins.str] = ..., machine_type: Optional[_builtins.str] = ..., max_workers: Optional[_builtins.int] = ..., network: Optional[_builtins.str] = ..., num_workers: Optional[_builtins.int] = ..., service_account_email: Optional[_builtins.str] = ..., subnetwork: Optional[_builtins.str] = ..., temp_location: Optional[_builtins.str] = ..., worker_region: Optional[_builtins.str] = ..., worker_zone: Optional[_builtins.str] = ..., zone: Optional[_builtins.str] = ...) -> None:
...
class PipelineWorkloadDataflowLaunchTemplateRequest(dict):
    ...
    def __init__(__self__, *, project_id: _builtins.str, gcs_path: Optional[_builtins.str] = ..., launch_parameters: Optional[outputs.PipelineWorkloadDataflowLaunchTemplateRequestLaunchParameters] = ..., location: Optional[_builtins.str] = ..., validate_only: Optional[_builtins.bool] = ...) -> None:
...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParameters(dict):
    ...
    def __init__(__self__, *, job_name: _builtins.str, environment: Optional[outputs.PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironment] = ..., parameters: Optional[Mapping[str, _builtins.str]] = ..., transform_name_mapping: Optional[Mapping[str, _builtins.str]] = ..., update: Optional[_builtins.bool] = ...) -> None:
...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironment(dict):
    ...
    def __init__(__self__, *, additional_experiments: Optional[Sequence[_builtins.str]] = ..., additional_user_labels: Optional[Mapping[str, _builtins.str]] = ..., bypass_temp_dir_validation: Optional[_builtins.bool] = ..., enable_streaming_engine: Optional[_builtins.bool] = ..., ip_configuration: Optional[_builtins.str] = ..., kms_key_name: Optional[_builtins.str] = ..., machine_type: Optional[_builtins.str] = ..., max_workers: Optional[_builtins.int] = ..., network: Optional[_builtins.str] = ..., num_workers: Optional[_builtins.int] = ..., service_account_email: Optional[_builtins.str] = ..., subnetwork: Optional[_builtins.str] = ..., temp_location: Optional[_builtins.str] = ..., worker_region: Optional[_builtins.str] = ..., worker_zone: Optional[_builtins.str] = ..., zone: Optional[_builtins.str] = ...) -> None:
