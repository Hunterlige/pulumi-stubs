...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['JobAppEngineHttpTargetArgs', 'JobAppEngineHttpTargetArgsDict', 'JobAppEngineHttpTargetAppEngineRoutingArgs', 'JobAppEngineHttpTargetAppEngineRoutingArgsDict', 'JobHttpTargetArgs', 'JobHttpTargetArgsDict', 'JobHttpTargetOauthTokenArgs', 'JobHttpTargetOauthTokenArgsDict', 'JobHttpTargetOidcTokenArgs', 'JobHttpTargetOidcTokenArgsDict', 'JobPubsubTargetArgs', 'JobPubsubTargetArgsDict', 'JobRetryConfigArgs', 'JobRetryConfigArgsDict']
...
class JobAppEngineHttpTargetArgs:
    def __init__(__self__, *, relative_uri: pulumi.Input[_builtins.str], app_engine_routing: Optional[pulumi.Input[JobAppEngineHttpTargetAppEngineRoutingArgs]] = ..., body: Optional[pulumi.Input[_builtins.str]] = ..., headers: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., http_method: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @relative_uri.setter
    def relative_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def app_engine_routing(self, value: Optional[pulumi.Input[JobAppEngineHttpTargetAppEngineRoutingArgs]]): # -> None:
        ...
...
class JobAppEngineHttpTargetAppEngineRoutingArgs:
    def __init__(__self__, *, instance: Optional[pulumi.Input[_builtins.str]] = ..., service: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JobHttpTargetArgs:
    def __init__(__self__, *, uri: pulumi.Input[_builtins.str], body: Optional[pulumi.Input[_builtins.str]] = ..., headers: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., http_method: Optional[pulumi.Input[_builtins.str]] = ..., oauth_token: Optional[pulumi.Input[JobHttpTargetOauthTokenArgs]] = ..., oidc_token: Optional[pulumi.Input[JobHttpTargetOidcTokenArgs]] = ...) -> None:
    ...
    @oauth_token.setter
    def oauth_token(self, value: Optional[pulumi.Input[JobHttpTargetOauthTokenArgs]]): # -> None:
        ...
    ...
    @oidc_token.setter
    def oidc_token(self, value: Optional[pulumi.Input[JobHttpTargetOidcTokenArgs]]): # -> None:
        ...
...
class JobPubsubTargetArgs:
    def __init__(__self__, *, topic_name: pulumi.Input[_builtins.str], attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., data: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JobRetryConfigArgs:
    def __init__(__self__, *, max_backoff_duration: Optional[pulumi.Input[_builtins.str]] = ..., max_doublings: Optional[pulumi.Input[_builtins.int]] = ..., max_retry_duration: Optional[pulumi.Input[_builtins.str]] = ..., min_backoff_duration: Optional[pulumi.Input[_builtins.str]] = ..., retry_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def max_backoff_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def min_backoff_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
