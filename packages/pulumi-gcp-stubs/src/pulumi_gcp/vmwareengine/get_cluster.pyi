...
class GetClusterResult:
    ...
    def __init__(__self__, autoscaling_settings=..., create_time=..., datastore_mount_configs=..., id=..., management=..., name=..., node_type_configs=..., parent=..., state=..., uid=..., update_time=...) -> None:
        ...
...
def get_cluster(name: Optional[_builtins.str] = ..., parent: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetClusterResult:
    
    ...

def get_cluster_output(name: Optional[pulumi.Input[_builtins.str]] = ..., parent: Optional[pulumi.Input[_builtins.str]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetClusterResult]:
