...
class GetPrivateCloudResult:
    ...
    def __init__(__self__, create_time=..., delete_time=..., deletion_delay_hours=..., description=..., expire_time=..., hcxes=..., id=..., location=..., management_clusters=..., name=..., network_configs=..., nsxes=..., project=..., send_deletion_delay_hours_if_zero=..., state=..., type=..., uid=..., update_time=..., vcenters=...) -> None:
        ...
...
def get_private_cloud(location: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetPrivateCloudResult:
    
    ...

def get_private_cloud_output(location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetPrivateCloudResult]:
