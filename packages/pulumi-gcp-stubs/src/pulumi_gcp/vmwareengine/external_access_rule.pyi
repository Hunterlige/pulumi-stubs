...
class ExternalAccessRuleArgs:
    def __init__(__self__, *, action: pulumi.Input[_builtins.str], destination_ip_ranges: pulumi.Input[Sequence[pulumi.Input[ExternalAccessRuleDestinationIpRangeArgs]]], destination_ports: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], ip_protocol: pulumi.Input[_builtins.str], parent: pulumi.Input[_builtins.str], priority: pulumi.Input[_builtins.int], source_ip_ranges: pulumi.Input[Sequence[pulumi.Input[ExternalAccessRuleSourceIpRangeArgs]]], source_ports: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], description: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def destination_ip_ranges(self, value: pulumi.Input[Sequence[pulumi.Input[ExternalAccessRuleDestinationIpRangeArgs]]]): # -> None:
        ...
    ...
    def source_ip_ranges(self, value: pulumi.Input[Sequence[pulumi.Input[ExternalAccessRuleSourceIpRangeArgs]]]): # -> None:
        ...
...
class _ExternalAccessRuleState:
    def __init__(__self__, *, action: Optional[pulumi.Input[_builtins.str]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[ExternalAccessRuleDestinationIpRangeArgs]]]] = ..., destination_ports: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ip_protocol: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., parent: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.int]] = ..., source_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[ExternalAccessRuleSourceIpRangeArgs]]]] = ..., source_ports: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., uid: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @destination_ip_ranges.setter
    def destination_ip_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExternalAccessRuleDestinationIpRangeArgs]]]]): # -> None:
        ...
    ...
    @source_ip_ranges.setter
    def source_ip_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ExternalAccessRuleSourceIpRangeArgs]]]]): # -> None:
        ...
    ...
    @source_ports.setter
    def source_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ExternalAccessRule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., action: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ExternalAccessRuleDestinationIpRangeArgs, ExternalAccessRuleDestinationIpRangeArgsDict]]]]] = ..., destination_ports: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ip_protocol: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., parent: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.int]] = ..., source_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ExternalAccessRuleSourceIpRangeArgs, ExternalAccessRuleSourceIpRangeArgsDict]]]]] = ..., source_ports: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ExternalAccessRuleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., action: Optional[pulumi.Input[_builtins.str]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., destination_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ExternalAccessRuleDestinationIpRangeArgs, ExternalAccessRuleDestinationIpRangeArgsDict]]]]] = ..., destination_ports: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ip_protocol: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., parent: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.int]] = ..., source_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[Union[ExternalAccessRuleSourceIpRangeArgs, ExternalAccessRuleSourceIpRangeArgsDict]]]]] = ..., source_ports: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., uid: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> ExternalAccessRule:
