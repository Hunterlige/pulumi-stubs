...
class NetworkPeeringArgs:
    def __init__(__self__, *, peer_network: pulumi.Input[_builtins.str], peer_network_type: pulumi.Input[_builtins.str], vmware_engine_network: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., export_custom_routes: Optional[pulumi.Input[_builtins.bool]] = ..., export_custom_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., import_custom_routes: Optional[pulumi.Input[_builtins.bool]] = ..., import_custom_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def peer_network_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def export_custom_routes_with_public_ip(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def import_custom_routes_with_public_ip(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class _NetworkPeeringState:
    def __init__(__self__, *, create_time: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., export_custom_routes: Optional[pulumi.Input[_builtins.bool]] = ..., export_custom_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., import_custom_routes: Optional[pulumi.Input[_builtins.bool]] = ..., import_custom_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., peer_network: Optional[pulumi.Input[_builtins.str]] = ..., peer_network_type: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., state_details: Optional[pulumi.Input[_builtins.str]] = ..., uid: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ..., vmware_engine_network: Optional[pulumi.Input[_builtins.str]] = ..., vmware_engine_network_canonical: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @peer_network_type.setter
    def peer_network_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class NetworkPeering(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., export_custom_routes: Optional[pulumi.Input[_builtins.bool]] = ..., export_custom_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., import_custom_routes: Optional[pulumi.Input[_builtins.bool]] = ..., import_custom_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., peer_network: Optional[pulumi.Input[_builtins.str]] = ..., peer_network_type: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., vmware_engine_network: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., export_custom_routes: Optional[pulumi.Input[_builtins.bool]] = ..., export_custom_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., import_custom_routes: Optional[pulumi.Input[_builtins.bool]] = ..., import_custom_routes_with_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., peer_network: Optional[pulumi.Input[_builtins.str]] = ..., peer_network_type: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., state_details: Optional[pulumi.Input[_builtins.str]] = ..., uid: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ..., vmware_engine_network: Optional[pulumi.Input[_builtins.str]] = ..., vmware_engine_network_canonical: Optional[pulumi.Input[_builtins.str]] = ...) -> NetworkPeering:
