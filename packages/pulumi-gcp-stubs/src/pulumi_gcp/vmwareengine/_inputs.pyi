...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterAutoscalingSettingsArgs', 'ClusterAutoscalingSettingsArgsDict', 'ClusterAutoscalingSettingsAutoscalingPolicyArgs', ..., ..., ..., ..., ..., ..., ..., 'ClusterDatastoreMountConfigArgs', 'ClusterDatastoreMountConfigArgsDict', 'ClusterDatastoreMountConfigDatastoreNetworkArgs', ..., 'ClusterNodeTypeConfigArgs', 'ClusterNodeTypeConfigArgsDict', 'DatastoreNfsDatastoreArgs', 'DatastoreNfsDatastoreArgsDict', 'DatastoreNfsDatastoreGoogleFileServiceArgs', 'DatastoreNfsDatastoreGoogleFileServiceArgsDict', 'DatastoreNfsDatastoreThirdPartyFileServiceArgs', 'DatastoreNfsDatastoreThirdPartyFileServiceArgsDict', 'ExternalAccessRuleDestinationIpRangeArgs', 'ExternalAccessRuleDestinationIpRangeArgsDict', 'ExternalAccessRuleSourceIpRangeArgs', 'ExternalAccessRuleSourceIpRangeArgsDict', 'NetworkPolicyExternalIpArgs', 'NetworkPolicyExternalIpArgsDict', 'NetworkPolicyInternetAccessArgs', 'NetworkPolicyInternetAccessArgsDict', 'NetworkVpcNetworkArgs', 'NetworkVpcNetworkArgsDict', 'PrivateCloudHcxArgs', 'PrivateCloudHcxArgsDict', 'PrivateCloudManagementClusterArgs', 'PrivateCloudManagementClusterArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'PrivateCloudManagementClusterNodeTypeConfigArgs', ..., ..., ..., 'PrivateCloudNetworkConfigArgs', 'PrivateCloudNetworkConfigArgsDict', 'PrivateCloudNsxArgs', 'PrivateCloudNsxArgsDict', 'PrivateCloudVcenterArgs', 'PrivateCloudVcenterArgsDict', 'SubnetDhcpAddressRangeArgs', 'SubnetDhcpAddressRangeArgsDict']
...
class ClusterAutoscalingSettingsArgs:
    def __init__(__self__, *, autoscaling_policies: pulumi.Input[Sequence[pulumi.Input[ClusterAutoscalingSettingsAutoscalingPolicyArgs]]], cool_down_period: Optional[pulumi.Input[_builtins.str]] = ..., max_cluster_node_count: Optional[pulumi.Input[_builtins.int]] = ..., min_cluster_node_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def autoscaling_policies(self, value: pulumi.Input[Sequence[pulumi.Input[ClusterAutoscalingSettingsAutoscalingPolicyArgs]]]): # -> None:
        ...
    ...
    def max_cluster_node_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def min_cluster_node_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ClusterAutoscalingSettingsAutoscalingPolicyArgs:
    def __init__(__self__, *, autoscale_policy_id: pulumi.Input[_builtins.str], node_type_id: pulumi.Input[_builtins.str], scale_out_size: pulumi.Input[_builtins.int], consumed_memory_thresholds: Optional[pulumi.Input[ClusterAutoscalingSettingsAutoscalingPolicyConsumedMemoryThresholdsArgs]] = ..., cpu_thresholds: Optional[pulumi.Input[ClusterAutoscalingSettingsAutoscalingPolicyCpuThresholdsArgs]] = ..., storage_thresholds: Optional[pulumi.Input[ClusterAutoscalingSettingsAutoscalingPolicyStorageThresholdsArgs]] = ...) -> None:
    ...
    def autoscale_policy_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @node_type_id.setter
    def node_type_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def scale_out_size(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def consumed_memory_thresholds(self, value: Optional[pulumi.Input[ClusterAutoscalingSettingsAutoscalingPolicyConsumedMemoryThresholdsArgs]]): # -> None:
        ...
    ...
    def cpu_thresholds(self, value: Optional[pulumi.Input[ClusterAutoscalingSettingsAutoscalingPolicyCpuThresholdsArgs]]): # -> None:
        ...
    ...
    def storage_thresholds(self, value: Optional[pulumi.Input[ClusterAutoscalingSettingsAutoscalingPolicyStorageThresholdsArgs]]): # -> None:
        ...
...
class ClusterAutoscalingSettingsAutoscalingPolicyConsumedMemoryThresholdsArgs:
    def __init__(__self__, *, scale_in: pulumi.Input[_builtins.int], scale_out: pulumi.Input[_builtins.int]) -> None:
    ...
    @scale_in.setter
    def scale_in(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @scale_out.setter
    def scale_out(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class ClusterDatastoreMountConfigArgs:
    def __init__(__self__, *, datastore: pulumi.Input[_builtins.str], datastore_network: pulumi.Input[ClusterDatastoreMountConfigDatastoreNetworkArgs], access_mode: Optional[pulumi.Input[_builtins.str]] = ..., file_share: Optional[pulumi.Input[_builtins.str]] = ..., ignore_colocation: Optional[pulumi.Input[_builtins.bool]] = ..., nfs_version: Optional[pulumi.Input[_builtins.str]] = ..., servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @datastore.setter
    def datastore(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def datastore_network(self, value: pulumi.Input[ClusterDatastoreMountConfigDatastoreNetworkArgs]): # -> None:
        ...
    ...
    @file_share.setter
    def file_share(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ignore_colocation(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @nfs_version.setter
    def nfs_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterDatastoreMountConfigDatastoreNetworkArgs:
    def __init__(__self__, *, subnet: pulumi.Input[_builtins.str], connection_count: Optional[pulumi.Input[_builtins.int]] = ..., mtu: Optional[pulumi.Input[_builtins.int]] = ..., network_peering: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def connection_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def network_peering(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterNodeTypeConfigArgs:
    def __init__(__self__, *, node_count: pulumi.Input[_builtins.int], node_type_id: pulumi.Input[_builtins.str], custom_core_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def custom_core_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class DatastoreNfsDatastoreArgs:
    def __init__(__self__, *, google_file_service: Optional[pulumi.Input[DatastoreNfsDatastoreGoogleFileServiceArgs]] = ..., third_party_file_service: Optional[pulumi.Input[DatastoreNfsDatastoreThirdPartyFileServiceArgs]] = ...) -> None:
    ...
    def google_file_service(self, value: Optional[pulumi.Input[DatastoreNfsDatastoreGoogleFileServiceArgs]]): # -> None:
        ...
    ...
    def third_party_file_service(self, value: Optional[pulumi.Input[DatastoreNfsDatastoreThirdPartyFileServiceArgs]]): # -> None:
        ...
...
class DatastoreNfsDatastoreGoogleFileServiceArgs:
    def __init__(__self__, *, filestore_instance: Optional[pulumi.Input[_builtins.str]] = ..., netapp_volume: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def filestore_instance(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def netapp_volume(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DatastoreNfsDatastoreThirdPartyFileServiceArgs:
    def __init__(__self__, *, file_share: pulumi.Input[_builtins.str], network: pulumi.Input[_builtins.str], servers: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @servers.setter
    def servers(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class ExternalAccessRuleDestinationIpRangeArgs:
    def __init__(__self__, *, external_address: Optional[pulumi.Input[_builtins.str]] = ..., ip_address_range: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def external_address(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def ip_address_range(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ExternalAccessRuleSourceIpRangeArgs:
    def __init__(__self__, *, ip_address: Optional[pulumi.Input[_builtins.str]] = ..., ip_address_range: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NetworkPolicyExternalIpArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class NetworkVpcNetworkArgs:
    def __init__(__self__, *, network: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PrivateCloudHcxArgs:
    def __init__(__self__, *, fqdn: Optional[pulumi.Input[_builtins.str]] = ..., internal_ip: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class PrivateCloudManagementClusterArgs:
    def __init__(__self__, *, cluster_id: pulumi.Input[_builtins.str], autoscaling_settings: Optional[pulumi.Input[PrivateCloudManagementClusterAutoscalingSettingsArgs]] = ..., node_type_configs: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateCloudManagementClusterNodeTypeConfigArgs]]]] = ..., stretched_cluster_config: Optional[pulumi.Input[PrivateCloudManagementClusterStretchedClusterConfigArgs]] = ...) -> None:
    ...
    def autoscaling_settings(self, value: Optional[pulumi.Input[PrivateCloudManagementClusterAutoscalingSettingsArgs]]): # -> None:
        ...
    ...
    def node_type_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[PrivateCloudManagementClusterNodeTypeConfigArgs]]]]): # -> None:
        ...
    ...
    def stretched_cluster_config(self, value: Optional[pulumi.Input[PrivateCloudManagementClusterStretchedClusterConfigArgs]]): # -> None:
        ...
...
class PrivateCloudManagementClusterAutoscalingSettingsArgs:
    def __init__(__self__, *, autoscaling_policies: pulumi.Input[Sequence[pulumi.Input[PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyArgs]]], cool_down_period: Optional[pulumi.Input[_builtins.str]] = ..., max_cluster_node_count: Optional[pulumi.Input[_builtins.int]] = ..., min_cluster_node_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @autoscaling_policies.setter
    def autoscaling_policies(self, value: pulumi.Input[Sequence[pulumi.Input[PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyArgs]]]): # -> None:
        ...
...
class PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyArgs:
    def __init__(__self__, *, autoscale_policy_id: pulumi.Input[_builtins.str], node_type_id: pulumi.Input[_builtins.str], scale_out_size: pulumi.Input[_builtins.int], consumed_memory_thresholds: Optional[pulumi.Input[PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyConsumedMemoryThresholdsArgs]] = ..., cpu_thresholds: Optional[pulumi.Input[PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyCpuThresholdsArgs]] = ..., storage_thresholds: Optional[pulumi.Input[PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyStorageThresholdsArgs]] = ...) -> None:
    ...
    @consumed_memory_thresholds.setter
    def consumed_memory_thresholds(self, value: Optional[pulumi.Input[PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyConsumedMemoryThresholdsArgs]]): # -> None:
        ...
    ...
    @cpu_thresholds.setter
    def cpu_thresholds(self, value: Optional[pulumi.Input[PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyCpuThresholdsArgs]]): # -> None:
        ...
    ...
    @storage_thresholds.setter
    def storage_thresholds(self, value: Optional[pulumi.Input[PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicyStorageThresholdsArgs]]): # -> None:
        ...
...
class PrivateCloudManagementClusterStretchedClusterConfigArgs:
    def __init__(__self__, *, preferred_location: Optional[pulumi.Input[_builtins.str]] = ..., secondary_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def preferred_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def secondary_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PrivateCloudNetworkConfigArgs:
    def __init__(__self__, *, management_cidr: pulumi.Input[_builtins.str], dns_server_ip: Optional[pulumi.Input[_builtins.str]] = ..., management_ip_address_layout_version: Optional[pulumi.Input[_builtins.int]] = ..., vmware_engine_network: Optional[pulumi.Input[_builtins.str]] = ..., vmware_engine_network_canonical: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def management_cidr(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def dns_server_ip(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def management_ip_address_layout_version(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def vmware_engine_network(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def vmware_engine_network_canonical(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SubnetDhcpAddressRangeArgs:
    def __init__(__self__, *, first_address: Optional[pulumi.Input[_builtins.str]] = ..., last_address: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def first_address(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @last_address.setter
    def last_address(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
