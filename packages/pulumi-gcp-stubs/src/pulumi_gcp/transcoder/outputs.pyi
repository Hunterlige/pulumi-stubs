...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['JobConfig', 'JobConfigAdBreak', 'JobConfigEditList', 'JobConfigElementaryStream', 'JobConfigElementaryStreamAudioStream', 'JobConfigElementaryStreamVideoStream', 'JobConfigElementaryStreamVideoStreamH264', 'JobConfigElementaryStreamVideoStreamH264Hlg', 'JobConfigElementaryStreamVideoStreamH264Sdr', 'JobConfigEncryption', 'JobConfigEncryptionAes128', 'JobConfigEncryptionDrmSystems', 'JobConfigEncryptionDrmSystemsClearkey', 'JobConfigEncryptionDrmSystemsFairplay', 'JobConfigEncryptionDrmSystemsPlayready', 'JobConfigEncryptionDrmSystemsWidevine', 'JobConfigEncryptionMpegCenc', 'JobConfigEncryptionSampleAes', 'JobConfigEncryptionSecretManagerKeySource', 'JobConfigInput', 'JobConfigManifest', 'JobConfigMuxStream', 'JobConfigMuxStreamSegmentSettings', 'JobConfigOutput', 'JobConfigOverlay', 'JobConfigOverlayAnimation', 'JobConfigOverlayAnimationAnimationFade', 'JobConfigOverlayAnimationAnimationFadeXy', 'JobConfigOverlayImage', 'JobConfigPubsubDestination', 'JobTemplateConfig', 'JobTemplateConfigAdBreak', 'JobTemplateConfigEditList', 'JobTemplateConfigElementaryStream', 'JobTemplateConfigElementaryStreamAudioStream', 'JobTemplateConfigElementaryStreamVideoStream', 'JobTemplateConfigElementaryStreamVideoStreamH264', ..., ..., 'JobTemplateConfigEncryption', 'JobTemplateConfigEncryptionAes128', 'JobTemplateConfigEncryptionDrmSystems', 'JobTemplateConfigEncryptionDrmSystemsClearkey', 'JobTemplateConfigEncryptionDrmSystemsFairplay', 'JobTemplateConfigEncryptionDrmSystemsPlayready', 'JobTemplateConfigEncryptionDrmSystemsWidevine', 'JobTemplateConfigEncryptionMpegCenc', 'JobTemplateConfigEncryptionSampleAes', 'JobTemplateConfigEncryptionSecretManagerKeySource', 'JobTemplateConfigInput', 'JobTemplateConfigManifest', 'JobTemplateConfigMuxStream', 'JobTemplateConfigMuxStreamSegmentSettings', 'JobTemplateConfigOutput', 'JobTemplateConfigOverlay', 'JobTemplateConfigOverlayAnimation', 'JobTemplateConfigOverlayAnimationAnimationFade', 'JobTemplateConfigOverlayAnimationAnimationFadeXy', 'JobTemplateConfigOverlayImage', 'JobTemplateConfigPubsubDestination']
@pulumi.output_type
class JobConfig(dict):
    ...
    def __init__(__self__, *, ad_breaks: Optional[Sequence[outputs.JobConfigAdBreak]] = ..., edit_lists: Optional[Sequence[outputs.JobConfigEditList]] = ..., elementary_streams: Optional[Sequence[outputs.JobConfigElementaryStream]] = ..., encryptions: Optional[Sequence[outputs.JobConfigEncryption]] = ..., inputs: Optional[Sequence[outputs.JobConfigInput]] = ..., manifests: Optional[Sequence[outputs.JobConfigManifest]] = ..., mux_streams: Optional[Sequence[outputs.JobConfigMuxStream]] = ..., output: Optional[outputs.JobConfigOutput] = ..., overlays: Optional[Sequence[outputs.JobConfigOverlay]] = ..., pubsub_destination: Optional[outputs.JobConfigPubsubDestination] = ...) -> None:
...
class JobConfigAdBreak(dict):
    ...
    def __init__(__self__, *, start_time_offset: Optional[_builtins.str] = ...) -> None:
...
class JobConfigEditList(dict):
    ...
    def __init__(__self__, *, inputs: Optional[Sequence[_builtins.str]] = ..., key: Optional[_builtins.str] = ..., start_time_offset: Optional[_builtins.str] = ...) -> None:
...
class JobConfigElementaryStream(dict):
    ...
    def __init__(__self__, *, audio_stream: Optional[outputs.JobConfigElementaryStreamAudioStream] = ..., key: Optional[_builtins.str] = ..., video_stream: Optional[outputs.JobConfigElementaryStreamVideoStream] = ...) -> None:
...
class JobConfigElementaryStreamAudioStream(dict):
    ...
    def __init__(__self__, *, bitrate_bps: _builtins.int, channel_count: Optional[_builtins.int] = ..., channel_layouts: Optional[Sequence[_builtins.str]] = ..., codec: Optional[_builtins.str] = ..., sample_rate_hertz: Optional[_builtins.int] = ...) -> None:
...
class JobConfigElementaryStreamVideoStream(dict):
    def __init__(__self__, *, h264: Optional[outputs.JobConfigElementaryStreamVideoStreamH264] = ...) -> None:
...
class JobConfigElementaryStreamVideoStreamH264(dict):
    ...
    def __init__(__self__, *, bitrate_bps: _builtins.int, frame_rate: _builtins.int, crf_level: Optional[_builtins.int] = ..., entropy_coder: Optional[_builtins.str] = ..., gop_duration: Optional[_builtins.str] = ..., height_pixels: Optional[_builtins.int] = ..., hlg: Optional[outputs.JobConfigElementaryStreamVideoStreamH264Hlg] = ..., pixel_format: Optional[_builtins.str] = ..., preset: Optional[_builtins.str] = ..., profile: Optional[_builtins.str] = ..., rate_control_mode: Optional[_builtins.str] = ..., sdr: Optional[outputs.JobConfigElementaryStreamVideoStreamH264Sdr] = ..., vbv_fullness_bits: Optional[_builtins.int] = ..., vbv_size_bits: Optional[_builtins.int] = ..., width_pixels: Optional[_builtins.int] = ...) -> None:
...
class JobConfigEncryption(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, aes128: Optional[outputs.JobConfigEncryptionAes128] = ..., drm_systems: Optional[outputs.JobConfigEncryptionDrmSystems] = ..., mpeg_cenc: Optional[outputs.JobConfigEncryptionMpegCenc] = ..., sample_aes: Optional[outputs.JobConfigEncryptionSampleAes] = ..., secret_manager_key_source: Optional[outputs.JobConfigEncryptionSecretManagerKeySource] = ...) -> None:
...
class JobConfigEncryptionDrmSystems(dict):
    def __init__(__self__, *, clearkey: Optional[outputs.JobConfigEncryptionDrmSystemsClearkey] = ..., fairplay: Optional[outputs.JobConfigEncryptionDrmSystemsFairplay] = ..., playready: Optional[outputs.JobConfigEncryptionDrmSystemsPlayready] = ..., widevine: Optional[outputs.JobConfigEncryptionDrmSystemsWidevine] = ...) -> None:
...
class JobConfigInput(dict):
    def __init__(__self__, *, key: Optional[_builtins.str] = ..., uri: Optional[_builtins.str] = ...) -> None:
...
class JobConfigManifest(dict):
    ...
    def __init__(__self__, *, file_name: Optional[_builtins.str] = ..., mux_streams: Optional[Sequence[_builtins.str]] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class JobConfigMuxStream(dict):
    ...
    def __init__(__self__, *, container: Optional[_builtins.str] = ..., elementary_streams: Optional[Sequence[_builtins.str]] = ..., encryption_id: Optional[_builtins.str] = ..., file_name: Optional[_builtins.str] = ..., key: Optional[_builtins.str] = ..., segment_settings: Optional[outputs.JobConfigMuxStreamSegmentSettings] = ...) -> None:
...
class JobConfigMuxStreamSegmentSettings(dict):
    ...
    def __init__(__self__, *, segment_duration: Optional[_builtins.str] = ...) -> None:
...
class JobConfigOverlay(dict):
    def __init__(__self__, *, animations: Optional[Sequence[outputs.JobConfigOverlayAnimation]] = ..., image: Optional[outputs.JobConfigOverlayImage] = ...) -> None:
...
class JobConfigOverlayAnimation(dict):
    ...
    def __init__(__self__, *, animation_fade: Optional[outputs.JobConfigOverlayAnimationAnimationFade] = ...) -> None:
...
class JobConfigOverlayAnimationAnimationFade(dict):
    ...
    def __init__(__self__, *, fade_type: _builtins.str, end_time_offset: Optional[_builtins.str] = ..., start_time_offset: Optional[_builtins.str] = ..., xy: Optional[outputs.JobConfigOverlayAnimationAnimationFadeXy] = ...) -> None:
...
class JobConfigOverlayAnimationAnimationFadeXy(dict):
    def __init__(__self__, *, x: Optional[_builtins.float] = ..., y: Optional[_builtins.float] = ...) -> None:
...
class JobTemplateConfig(dict):
    ...
    def __init__(__self__, *, ad_breaks: Optional[Sequence[outputs.JobTemplateConfigAdBreak]] = ..., edit_lists: Optional[Sequence[outputs.JobTemplateConfigEditList]] = ..., elementary_streams: Optional[Sequence[outputs.JobTemplateConfigElementaryStream]] = ..., encryptions: Optional[Sequence[outputs.JobTemplateConfigEncryption]] = ..., inputs: Optional[Sequence[outputs.JobTemplateConfigInput]] = ..., manifests: Optional[Sequence[outputs.JobTemplateConfigManifest]] = ..., mux_streams: Optional[Sequence[outputs.JobTemplateConfigMuxStream]] = ..., output: Optional[outputs.JobTemplateConfigOutput] = ..., overlays: Optional[Sequence[outputs.JobTemplateConfigOverlay]] = ..., pubsub_destination: Optional[outputs.JobTemplateConfigPubsubDestination] = ...) -> None:
...
class JobTemplateConfigElementaryStream(dict):
    ...
    def __init__(__self__, *, audio_stream: Optional[outputs.JobTemplateConfigElementaryStreamAudioStream] = ..., key: Optional[_builtins.str] = ..., video_stream: Optional[outputs.JobTemplateConfigElementaryStreamVideoStream] = ...) -> None:
...
class JobTemplateConfigElementaryStreamVideoStream(dict):
    def __init__(__self__, *, h264: Optional[outputs.JobTemplateConfigElementaryStreamVideoStreamH264] = ...) -> None:
...
class JobTemplateConfigElementaryStreamVideoStreamH264(dict):
    ...
    def __init__(__self__, *, bitrate_bps: _builtins.int, frame_rate: _builtins.int, crf_level: Optional[_builtins.int] = ..., entropy_coder: Optional[_builtins.str] = ..., gop_duration: Optional[_builtins.str] = ..., height_pixels: Optional[_builtins.int] = ..., hlg: Optional[outputs.JobTemplateConfigElementaryStreamVideoStreamH264Hlg] = ..., pixel_format: Optional[_builtins.str] = ..., preset: Optional[_builtins.str] = ..., profile: Optional[_builtins.str] = ..., rate_control_mode: Optional[_builtins.str] = ..., sdr: Optional[outputs.JobTemplateConfigElementaryStreamVideoStreamH264Sdr] = ..., vbv_fullness_bits: Optional[_builtins.int] = ..., vbv_size_bits: Optional[_builtins.int] = ..., width_pixels: Optional[_builtins.int] = ...) -> None:
...
class JobTemplateConfigEncryption(dict):
    ...
    def __init__(__self__, *, id: _builtins.str, aes128: Optional[outputs.JobTemplateConfigEncryptionAes128] = ..., drm_systems: Optional[outputs.JobTemplateConfigEncryptionDrmSystems] = ..., mpeg_cenc: Optional[outputs.JobTemplateConfigEncryptionMpegCenc] = ..., sample_aes: Optional[outputs.JobTemplateConfigEncryptionSampleAes] = ..., secret_manager_key_source: Optional[outputs.JobTemplateConfigEncryptionSecretManagerKeySource] = ...) -> None:
...
class JobTemplateConfigEncryptionDrmSystems(dict):
    def __init__(__self__, *, clearkey: Optional[outputs.JobTemplateConfigEncryptionDrmSystemsClearkey] = ..., fairplay: Optional[outputs.JobTemplateConfigEncryptionDrmSystemsFairplay] = ..., playready: Optional[outputs.JobTemplateConfigEncryptionDrmSystemsPlayready] = ..., widevine: Optional[outputs.JobTemplateConfigEncryptionDrmSystemsWidevine] = ...) -> None:
...
class JobTemplateConfigMuxStream(dict):
    ...
    def __init__(__self__, *, container: Optional[_builtins.str] = ..., elementary_streams: Optional[Sequence[_builtins.str]] = ..., encryption_id: Optional[_builtins.str] = ..., file_name: Optional[_builtins.str] = ..., key: Optional[_builtins.str] = ..., segment_settings: Optional[outputs.JobTemplateConfigMuxStreamSegmentSettings] = ...) -> None:
...
class JobTemplateConfigOverlay(dict):
    def __init__(__self__, *, animations: Optional[Sequence[outputs.JobTemplateConfigOverlayAnimation]] = ..., image: Optional[outputs.JobTemplateConfigOverlayImage] = ...) -> None:
...
class JobTemplateConfigOverlayAnimation(dict):
    ...
    def __init__(__self__, *, animation_fade: Optional[outputs.JobTemplateConfigOverlayAnimationAnimationFade] = ...) -> None:
...
class JobTemplateConfigOverlayAnimationAnimationFade(dict):
    ...
    def __init__(__self__, *, fade_type: _builtins.str, end_time_offset: Optional[_builtins.str] = ..., start_time_offset: Optional[_builtins.str] = ..., xy: Optional[outputs.JobTemplateConfigOverlayAnimationAnimationFadeXy] = ...) -> None:
