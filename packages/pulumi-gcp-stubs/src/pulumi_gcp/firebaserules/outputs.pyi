...
class RulesetMetadata(dict):
    def __init__(__self__, *, services: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class RulesetSource(dict):
    def __init__(__self__, *, files: Sequence[outputs.RulesetSourceFile], language: Optional[_builtins.str] = ...) -> None:
...
class RulesetSourceFile(dict):
    def __init__(__self__, *, content: _builtins.str, name: _builtins.str, fingerprint: Optional[_builtins.str] = ...) -> None:
