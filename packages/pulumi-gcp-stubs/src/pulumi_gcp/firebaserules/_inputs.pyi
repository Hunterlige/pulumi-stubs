...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['RulesetMetadataArgs', 'RulesetMetadataArgsDict', 'RulesetSourceArgs', 'RulesetSourceArgsDict', 'RulesetSourceFileArgs', 'RulesetSourceFileArgsDict']
...
class RulesetMetadataArgs:
    def __init__(__self__, *, services: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class RulesetSourceArgs:
    def __init__(__self__, *, files: pulumi.Input[Sequence[pulumi.Input[RulesetSourceFileArgs]]], language: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @files.setter
    def files(self, value: pulumi.Input[Sequence[pulumi.Input[RulesetSourceFileArgs]]]): # -> None:
        ...
...
class RulesetSourceFileArgs:
    def __init__(__self__, *, content: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], fingerprint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
