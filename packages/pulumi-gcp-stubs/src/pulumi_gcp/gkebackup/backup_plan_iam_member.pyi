...
class BackupPlanIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[BackupPlanIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[BackupPlanIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class BackupPlanIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.BackupPlanIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
