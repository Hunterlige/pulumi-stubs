...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BackupPlanBackupConfigArgs', 'BackupPlanBackupConfigArgsDict', 'BackupPlanBackupConfigEncryptionKeyArgs', 'BackupPlanBackupConfigEncryptionKeyArgsDict', 'BackupPlanBackupConfigSelectedApplicationsArgs', 'BackupPlanBackupConfigSelectedApplicationsArgsDict', ..., ..., 'BackupPlanBackupConfigSelectedNamespaceLabelsArgs', ..., ..., ..., 'BackupPlanBackupConfigSelectedNamespacesArgs', 'BackupPlanBackupConfigSelectedNamespacesArgsDict', 'BackupPlanBackupScheduleArgs', 'BackupPlanBackupScheduleArgsDict', 'BackupPlanBackupScheduleRpoConfigArgs', 'BackupPlanBackupScheduleRpoConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'BackupPlanIamBindingConditionArgs', 'BackupPlanIamBindingConditionArgsDict', 'BackupPlanIamMemberConditionArgs', 'BackupPlanIamMemberConditionArgsDict', 'BackupPlanRetentionPolicyArgs', 'BackupPlanRetentionPolicyArgsDict', 'RestorePlanIamBindingConditionArgs', 'RestorePlanIamBindingConditionArgsDict', 'RestorePlanIamMemberConditionArgs', 'RestorePlanIamMemberConditionArgsDict', 'RestorePlanRestoreConfigArgs', 'RestorePlanRestoreConfigArgsDict', ..., ..., ..., ..., ..., ..., 'RestorePlanRestoreConfigExcludedNamespacesArgs', 'RestorePlanRestoreConfigExcludedNamespacesArgsDict', 'RestorePlanRestoreConfigRestoreOrderArgs', 'RestorePlanRestoreConfigRestoreOrderArgsDict', ..., ..., ..., ..., ..., ..., 'RestorePlanRestoreConfigSelectedApplicationsArgs', ..., ..., ..., 'RestorePlanRestoreConfigSelectedNamespacesArgs', 'RestorePlanRestoreConfigSelectedNamespacesArgsDict', 'RestorePlanRestoreConfigTransformationRuleArgs', 'RestorePlanRestoreConfigTransformationRuleArgsDict', ..., ..., ..., ..., ..., ..., ..., ...]
...
class BackupPlanBackupConfigArgs:
    def __init__(__self__, *, all_namespaces: Optional[pulumi.Input[_builtins.bool]] = ..., encryption_key: Optional[pulumi.Input[BackupPlanBackupConfigEncryptionKeyArgs]] = ..., include_secrets: Optional[pulumi.Input[_builtins.bool]] = ..., include_volume_data: Optional[pulumi.Input[_builtins.bool]] = ..., permissive_mode: Optional[pulumi.Input[_builtins.bool]] = ..., selected_applications: Optional[pulumi.Input[BackupPlanBackupConfigSelectedApplicationsArgs]] = ..., selected_namespace_labels: Optional[pulumi.Input[BackupPlanBackupConfigSelectedNamespaceLabelsArgs]] = ..., selected_namespaces: Optional[pulumi.Input[BackupPlanBackupConfigSelectedNamespacesArgs]] = ...) -> None:
    ...
    def all_namespaces(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def encryption_key(self, value: Optional[pulumi.Input[BackupPlanBackupConfigEncryptionKeyArgs]]): # -> None:
        ...
    ...
    def include_secrets(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def include_volume_data(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def permissive_mode(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def selected_applications(self, value: Optional[pulumi.Input[BackupPlanBackupConfigSelectedApplicationsArgs]]): # -> None:
        ...
    ...
    def selected_namespace_labels(self, value: Optional[pulumi.Input[BackupPlanBackupConfigSelectedNamespaceLabelsArgs]]): # -> None:
        ...
    ...
    def selected_namespaces(self, value: Optional[pulumi.Input[BackupPlanBackupConfigSelectedNamespacesArgs]]): # -> None:
        ...
...
class BackupPlanBackupConfigEncryptionKeyArgs:
    def __init__(__self__, *, gcp_kms_encryption_key: pulumi.Input[_builtins.str]) -> None:
    ...
    def gcp_kms_encryption_key(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class BackupPlanBackupConfigSelectedApplicationsArgs:
    def __init__(__self__, *, namespaced_names: pulumi.Input[Sequence[pulumi.Input[BackupPlanBackupConfigSelectedApplicationsNamespacedNameArgs]]]) -> None:
    ...
    def namespaced_names(self, value: pulumi.Input[Sequence[pulumi.Input[BackupPlanBackupConfigSelectedApplicationsNamespacedNameArgs]]]): # -> None:
        ...
...
class BackupPlanBackupConfigSelectedNamespaceLabelsArgs:
    def __init__(__self__, *, resource_labels: pulumi.Input[Sequence[pulumi.Input[BackupPlanBackupConfigSelectedNamespaceLabelsResourceLabelArgs]]]) -> None:
    ...
    def resource_labels(self, value: pulumi.Input[Sequence[pulumi.Input[BackupPlanBackupConfigSelectedNamespaceLabelsResourceLabelArgs]]]): # -> None:
        ...
...
class BackupPlanBackupConfigSelectedNamespacesArgs:
    def __init__(__self__, *, namespaces: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @namespaces.setter
    def namespaces(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class BackupPlanBackupScheduleArgs:
    def __init__(__self__, *, cron_schedule: Optional[pulumi.Input[_builtins.str]] = ..., paused: Optional[pulumi.Input[_builtins.bool]] = ..., rpo_config: Optional[pulumi.Input[BackupPlanBackupScheduleRpoConfigArgs]] = ...) -> None:
    ...
    @paused.setter
    def paused(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @rpo_config.setter
    def rpo_config(self, value: Optional[pulumi.Input[BackupPlanBackupScheduleRpoConfigArgs]]): # -> None:
        ...
...
class BackupPlanBackupScheduleRpoConfigArgs:
    def __init__(__self__, *, target_rpo_minutes: pulumi.Input[_builtins.int], exclusion_windows: Optional[pulumi.Input[Sequence[pulumi.Input[BackupPlanBackupScheduleRpoConfigExclusionWindowArgs]]]] = ...) -> None:
    ...
    def target_rpo_minutes(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def exclusion_windows(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BackupPlanBackupScheduleRpoConfigExclusionWindowArgs]]]]): # -> None:
        ...
...
class BackupPlanBackupScheduleRpoConfigExclusionWindowArgs:
    def __init__(__self__, *, duration: pulumi.Input[_builtins.str], start_time: pulumi.Input[BackupPlanBackupScheduleRpoConfigExclusionWindowStartTimeArgs], daily: Optional[pulumi.Input[_builtins.bool]] = ..., days_of_week: Optional[pulumi.Input[BackupPlanBackupScheduleRpoConfigExclusionWindowDaysOfWeekArgs]] = ..., single_occurrence_date: Optional[pulumi.Input[BackupPlanBackupScheduleRpoConfigExclusionWindowSingleOccurrenceDateArgs]] = ...) -> None:
    ...
    @start_time.setter
    def start_time(self, value: pulumi.Input[BackupPlanBackupScheduleRpoConfigExclusionWindowStartTimeArgs]): # -> None:
        ...
    ...
    @daily.setter
    def daily(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @days_of_week.setter
    def days_of_week(self, value: Optional[pulumi.Input[BackupPlanBackupScheduleRpoConfigExclusionWindowDaysOfWeekArgs]]): # -> None:
        ...
    ...
    def single_occurrence_date(self, value: Optional[pulumi.Input[BackupPlanBackupScheduleRpoConfigExclusionWindowSingleOccurrenceDateArgs]]): # -> None:
        ...
...
class BackupPlanBackupScheduleRpoConfigExclusionWindowDaysOfWeekArgs:
    def __init__(__self__, *, days_of_weeks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class BackupPlanRetentionPolicyArgs:
    def __init__(__self__, *, backup_delete_lock_days: Optional[pulumi.Input[_builtins.int]] = ..., backup_retain_days: Optional[pulumi.Input[_builtins.int]] = ..., locked: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def backup_delete_lock_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def backup_retain_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class RestorePlanRestoreConfigArgs:
    def __init__(__self__, *, all_namespaces: Optional[pulumi.Input[_builtins.bool]] = ..., cluster_resource_conflict_policy: Optional[pulumi.Input[_builtins.str]] = ..., cluster_resource_restore_scope: Optional[pulumi.Input[RestorePlanRestoreConfigClusterResourceRestoreScopeArgs]] = ..., excluded_namespaces: Optional[pulumi.Input[RestorePlanRestoreConfigExcludedNamespacesArgs]] = ..., namespaced_resource_restore_mode: Optional[pulumi.Input[_builtins.str]] = ..., no_namespaces: Optional[pulumi.Input[_builtins.bool]] = ..., restore_order: Optional[pulumi.Input[RestorePlanRestoreConfigRestoreOrderArgs]] = ..., selected_applications: Optional[pulumi.Input[RestorePlanRestoreConfigSelectedApplicationsArgs]] = ..., selected_namespaces: Optional[pulumi.Input[RestorePlanRestoreConfigSelectedNamespacesArgs]] = ..., transformation_rules: Optional[pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigTransformationRuleArgs]]]] = ..., volume_data_restore_policy: Optional[pulumi.Input[_builtins.str]] = ..., volume_data_restore_policy_bindings: Optional[pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigVolumeDataRestorePolicyBindingArgs]]]] = ...) -> None:
    ...
    def cluster_resource_conflict_policy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def cluster_resource_restore_scope(self, value: Optional[pulumi.Input[RestorePlanRestoreConfigClusterResourceRestoreScopeArgs]]): # -> None:
        ...
    ...
    def excluded_namespaces(self, value: Optional[pulumi.Input[RestorePlanRestoreConfigExcludedNamespacesArgs]]): # -> None:
        ...
    ...
    def namespaced_resource_restore_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def no_namespaces(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def restore_order(self, value: Optional[pulumi.Input[RestorePlanRestoreConfigRestoreOrderArgs]]): # -> None:
        ...
    ...
    @selected_applications.setter
    def selected_applications(self, value: Optional[pulumi.Input[RestorePlanRestoreConfigSelectedApplicationsArgs]]): # -> None:
        ...
    ...
    @selected_namespaces.setter
    def selected_namespaces(self, value: Optional[pulumi.Input[RestorePlanRestoreConfigSelectedNamespacesArgs]]): # -> None:
        ...
    ...
    def transformation_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigTransformationRuleArgs]]]]): # -> None:
        ...
    ...
    def volume_data_restore_policy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def volume_data_restore_policy_bindings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigVolumeDataRestorePolicyBindingArgs]]]]): # -> None:
        ...
...
class RestorePlanRestoreConfigClusterResourceRestoreScopeArgs:
    def __init__(__self__, *, all_group_kinds: Optional[pulumi.Input[_builtins.bool]] = ..., excluded_group_kinds: Optional[pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindArgs]]]] = ..., no_group_kinds: Optional[pulumi.Input[_builtins.bool]] = ..., selected_group_kinds: Optional[pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindArgs]]]] = ...) -> None:
    ...
    def all_group_kinds(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def excluded_group_kinds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindArgs]]]]): # -> None:
        ...
    ...
    def no_group_kinds(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def selected_group_kinds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigClusterResourceRestoreScopeSelectedGroupKindArgs]]]]): # -> None:
        ...
...
class RestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindArgs:
    def __init__(__self__, *, resource_group: Optional[pulumi.Input[_builtins.str]] = ..., resource_kind: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def resource_kind(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RestorePlanRestoreConfigRestoreOrderArgs:
    def __init__(__self__, *, group_kind_dependencies: pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigRestoreOrderGroupKindDependencyArgs]]]) -> None:
    ...
    def group_kind_dependencies(self, value: pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigRestoreOrderGroupKindDependencyArgs]]]): # -> None:
        ...
...
class RestorePlanRestoreConfigRestoreOrderGroupKindDependencyArgs:
    def __init__(__self__, *, requiring: pulumi.Input[RestorePlanRestoreConfigRestoreOrderGroupKindDependencyRequiringArgs], satisfying: pulumi.Input[RestorePlanRestoreConfigRestoreOrderGroupKindDependencySatisfyingArgs]) -> None:
    ...
    @requiring.setter
    def requiring(self, value: pulumi.Input[RestorePlanRestoreConfigRestoreOrderGroupKindDependencyRequiringArgs]): # -> None:
        ...
    ...
    @satisfying.setter
    def satisfying(self, value: pulumi.Input[RestorePlanRestoreConfigRestoreOrderGroupKindDependencySatisfyingArgs]): # -> None:
        ...
...
class RestorePlanRestoreConfigSelectedApplicationsArgs:
    def __init__(__self__, *, namespaced_names: pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigSelectedApplicationsNamespacedNameArgs]]]) -> None:
    ...
    @namespaced_names.setter
    def namespaced_names(self, value: pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigSelectedApplicationsNamespacedNameArgs]]]): # -> None:
        ...
...
class RestorePlanRestoreConfigTransformationRuleArgs:
    def __init__(__self__, *, field_actions: pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigTransformationRuleFieldActionArgs]]], description: Optional[pulumi.Input[_builtins.str]] = ..., resource_filter: Optional[pulumi.Input[RestorePlanRestoreConfigTransformationRuleResourceFilterArgs]] = ...) -> None:
    ...
    def field_actions(self, value: pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigTransformationRuleFieldActionArgs]]]): # -> None:
        ...
    ...
    def resource_filter(self, value: Optional[pulumi.Input[RestorePlanRestoreConfigTransformationRuleResourceFilterArgs]]): # -> None:
        ...
...
class RestorePlanRestoreConfigTransformationRuleFieldActionArgs:
    def __init__(__self__, *, op: pulumi.Input[_builtins.str], from_path: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @from_path.setter
    def from_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RestorePlanRestoreConfigTransformationRuleResourceFilterArgs:
    def __init__(__self__, *, group_kinds: Optional[pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigTransformationRuleResourceFilterGroupKindArgs]]]] = ..., json_path: Optional[pulumi.Input[_builtins.str]] = ..., namespaces: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @group_kinds.setter
    def group_kinds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[RestorePlanRestoreConfigTransformationRuleResourceFilterGroupKindArgs]]]]): # -> None:
        ...
    ...
    @json_path.setter
    def json_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RestorePlanRestoreConfigVolumeDataRestorePolicyBindingArgs:
    def __init__(__self__, *, policy: pulumi.Input[_builtins.str], volume_type: pulumi.Input[_builtins.str]) -> None:
