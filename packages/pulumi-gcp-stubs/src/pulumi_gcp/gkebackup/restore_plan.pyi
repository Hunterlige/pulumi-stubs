...
class _RestorePlanState:
    def __init__(
        ...
        *,
        ...
        restore_config: Optional[pulumi.Input[RestorePlanRestoreConfigArgs]] = ...,
    ...
    def restore_config(
        self,
    ) -> Optional[pulumi.Input[RestorePlanRestoreConfigArgs]]: ...
    @restore_config.setter
    def restore_config(
        self, value: Optional[pulumi.Input[RestorePlanRestoreConfigArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class RestorePlan(pulumi.CustomResource):
    ...
    def __init__(
        ...
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
        restore_config: Optional[
            pulumi.Input[
                Union[RestorePlanRestoreConfigArgs, RestorePlanRestoreConfigArgsDict]
            ]
        ] = ...,
        __props__=...,
    ) -> None: ...
