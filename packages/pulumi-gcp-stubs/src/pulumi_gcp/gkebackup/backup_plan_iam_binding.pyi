...
class BackupPlanIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[BackupPlanIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[BackupPlanIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[BackupPlanIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class BackupPlanIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.BackupPlanIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
