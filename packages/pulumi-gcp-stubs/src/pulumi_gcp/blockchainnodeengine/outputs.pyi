...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BlockchainNodesConnectionInfo', 'BlockchainNodesConnectionInfoEndpointInfo', 'BlockchainNodesEthereumDetails', 'BlockchainNodesEthereumDetailsAdditionalEndpoint', 'BlockchainNodesEthereumDetailsGethDetails', 'BlockchainNodesEthereumDetailsValidatorConfig']
@pulumi.output_type
class BlockchainNodesConnectionInfo(dict):
    ...
    def __init__(__self__, *, endpoint_infos: Optional[Sequence[outputs.BlockchainNodesConnectionInfoEndpointInfo]] = ..., service_attachment: Optional[_builtins.str] = ...) -> None:
...
class BlockchainNodesConnectionInfoEndpointInfo(dict):
    ...
    def __init__(__self__, *, json_rpc_api_endpoint: Optional[_builtins.str] = ..., websockets_api_endpoint: Optional[_builtins.str] = ...) -> None:
...
class BlockchainNodesEthereumDetails(dict):
    ...
    def __init__(__self__, *, additional_endpoints: Optional[Sequence[outputs.BlockchainNodesEthereumDetailsAdditionalEndpoint]] = ..., api_enable_admin: Optional[_builtins.bool] = ..., api_enable_debug: Optional[_builtins.bool] = ..., consensus_client: Optional[_builtins.str] = ..., execution_client: Optional[_builtins.str] = ..., geth_details: Optional[outputs.BlockchainNodesEthereumDetailsGethDetails] = ..., network: Optional[_builtins.str] = ..., node_type: Optional[_builtins.str] = ..., validator_config: Optional[outputs.BlockchainNodesEthereumDetailsValidatorConfig] = ...) -> None:
...
class BlockchainNodesEthereumDetailsAdditionalEndpoint(dict):
    ...
    def __init__(__self__, *, beacon_api_endpoint: Optional[_builtins.str] = ..., beacon_prometheus_metrics_api_endpoint: Optional[_builtins.str] = ..., execution_client_prometheus_metrics_api_endpoint: Optional[_builtins.str] = ...) -> None:
...
class BlockchainNodesEthereumDetailsGethDetails(dict):
    ...
    def __init__(__self__, *, garbage_collection_mode: Optional[_builtins.str] = ...) -> None:
...
class BlockchainNodesEthereumDetailsValidatorConfig(dict):
    ...
    def __init__(__self__, *, mev_relay_urls: Optional[Sequence[_builtins.str]] = ...) -> None:
