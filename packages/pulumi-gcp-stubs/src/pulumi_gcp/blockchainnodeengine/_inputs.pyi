...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BlockchainNodesConnectionInfoArgs', 'BlockchainNodesConnectionInfoArgsDict', 'BlockchainNodesConnectionInfoEndpointInfoArgs', 'BlockchainNodesConnectionInfoEndpointInfoArgsDict', 'BlockchainNodesEthereumDetailsArgs', 'BlockchainNodesEthereumDetailsArgsDict', ..., ..., 'BlockchainNodesEthereumDetailsGethDetailsArgs', 'BlockchainNodesEthereumDetailsGethDetailsArgsDict', 'BlockchainNodesEthereumDetailsValidatorConfigArgs', ...]
...
class BlockchainNodesConnectionInfoArgs:
    def __init__(__self__, *, endpoint_infos: Optional[pulumi.Input[Sequence[pulumi.Input[BlockchainNodesConnectionInfoEndpointInfoArgs]]]] = ..., service_attachment: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def endpoint_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BlockchainNodesConnectionInfoEndpointInfoArgs]]]]): # -> None:
        ...
...
class BlockchainNodesConnectionInfoEndpointInfoArgs:
    def __init__(__self__, *, json_rpc_api_endpoint: Optional[pulumi.Input[_builtins.str]] = ..., websockets_api_endpoint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def json_rpc_api_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def websockets_api_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BlockchainNodesEthereumDetailsArgs:
    def __init__(__self__, *, additional_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[BlockchainNodesEthereumDetailsAdditionalEndpointArgs]]]] = ..., api_enable_admin: Optional[pulumi.Input[_builtins.bool]] = ..., api_enable_debug: Optional[pulumi.Input[_builtins.bool]] = ..., consensus_client: Optional[pulumi.Input[_builtins.str]] = ..., execution_client: Optional[pulumi.Input[_builtins.str]] = ..., geth_details: Optional[pulumi.Input[BlockchainNodesEthereumDetailsGethDetailsArgs]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., node_type: Optional[pulumi.Input[_builtins.str]] = ..., validator_config: Optional[pulumi.Input[BlockchainNodesEthereumDetailsValidatorConfigArgs]] = ...) -> None:
    ...
    def additional_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BlockchainNodesEthereumDetailsAdditionalEndpointArgs]]]]): # -> None:
        ...
    ...
    def api_enable_admin(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def api_enable_debug(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def consensus_client(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def execution_client(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @geth_details.setter
    def geth_details(self, value: Optional[pulumi.Input[BlockchainNodesEthereumDetailsGethDetailsArgs]]): # -> None:
        ...
    ...
    def validator_config(self, value: Optional[pulumi.Input[BlockchainNodesEthereumDetailsValidatorConfigArgs]]): # -> None:
        ...
...
class BlockchainNodesEthereumDetailsAdditionalEndpointArgs:
    def __init__(__self__, *, beacon_api_endpoint: Optional[pulumi.Input[_builtins.str]] = ..., beacon_prometheus_metrics_api_endpoint: Optional[pulumi.Input[_builtins.str]] = ..., execution_client_prometheus_metrics_api_endpoint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def beacon_api_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def beacon_prometheus_metrics_api_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def execution_client_prometheus_metrics_api_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BlockchainNodesEthereumDetailsGethDetailsArgs:
    def __init__(__self__, *, garbage_collection_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def garbage_collection_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BlockchainNodesEthereumDetailsValidatorConfigArgs:
    def __init__(__self__, *, mev_relay_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def mev_relay_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
