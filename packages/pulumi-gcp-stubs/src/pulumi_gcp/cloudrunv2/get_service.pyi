...
class GetServiceResult:
    ...
    def __init__(__self__, annotations=..., binary_authorizations=..., build_configs=..., client=..., client_version=..., conditions=..., create_time=..., creator=..., custom_audiences=..., default_uri_disabled=..., delete_time=..., deletion_protection=..., description=..., effective_annotations=..., effective_labels=..., etag=..., expire_time=..., generation=..., iap_enabled=..., id=..., ingress=..., invoker_iam_disabled=..., labels=..., last_modifier=..., latest_created_revision=..., latest_ready_revision=..., launch_stage=..., location=..., multi_region_settings=..., name=..., observed_generation=..., project=..., pulumi_labels=..., reconciling=..., scalings=..., templates=..., terminal_conditions=..., traffic_statuses=..., traffics=..., uid=..., update_time=..., uri=..., urls=...) -> None:
        ...
...
def get_service_output(location: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetServiceResult]:
