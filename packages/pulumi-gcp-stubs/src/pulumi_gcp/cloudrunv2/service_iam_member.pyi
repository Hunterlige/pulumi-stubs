...
class ServiceIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[ServiceIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[ServiceIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class ServiceIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[ServiceIamMemberConditionArgs, ServiceIamMemberConditionArgsDict]
            ]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
        member: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.ServiceIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
