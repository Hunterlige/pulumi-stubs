...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['JobBinaryAuthorizationArgs', 'JobBinaryAuthorizationArgsDict', 'JobConditionArgs', 'JobConditionArgsDict', 'JobIamBindingConditionArgs', 'JobIamBindingConditionArgsDict', 'JobIamMemberConditionArgs', 'JobIamMemberConditionArgsDict', 'JobLatestCreatedExecutionArgs', 'JobLatestCreatedExecutionArgsDict', 'JobTemplateArgs', 'JobTemplateArgsDict', 'JobTemplateTemplateArgs', 'JobTemplateTemplateArgsDict', 'JobTemplateTemplateContainerArgs', 'JobTemplateTemplateContainerArgsDict', 'JobTemplateTemplateContainerEnvArgs', 'JobTemplateTemplateContainerEnvArgsDict', 'JobTemplateTemplateContainerEnvValueSourceArgs', 'JobTemplateTemplateContainerEnvValueSourceArgsDict', ..., ..., 'JobTemplateTemplateContainerPortArgs', 'JobTemplateTemplateContainerPortArgsDict', 'JobTemplateTemplateContainerResourcesArgs', 'JobTemplateTemplateContainerResourcesArgsDict', 'JobTemplateTemplateContainerStartupProbeArgs', 'JobTemplateTemplateContainerStartupProbeArgsDict', 'JobTemplateTemplateContainerStartupProbeGrpcArgs', ..., ..., ..., ..., ..., ..., ..., 'JobTemplateTemplateContainerVolumeMountArgs', 'JobTemplateTemplateContainerVolumeMountArgsDict', 'JobTemplateTemplateNodeSelectorArgs', 'JobTemplateTemplateNodeSelectorArgsDict', 'JobTemplateTemplateVolumeArgs', 'JobTemplateTemplateVolumeArgsDict', 'JobTemplateTemplateVolumeCloudSqlInstanceArgs', 'JobTemplateTemplateVolumeCloudSqlInstanceArgsDict', 'JobTemplateTemplateVolumeEmptyDirArgs', 'JobTemplateTemplateVolumeEmptyDirArgsDict', 'JobTemplateTemplateVolumeGcsArgs', 'JobTemplateTemplateVolumeGcsArgsDict', 'JobTemplateTemplateVolumeNfsArgs', 'JobTemplateTemplateVolumeNfsArgsDict', 'JobTemplateTemplateVolumeSecretArgs', 'JobTemplateTemplateVolumeSecretArgsDict', 'JobTemplateTemplateVolumeSecretItemArgs', 'JobTemplateTemplateVolumeSecretItemArgsDict', 'JobTemplateTemplateVpcAccessArgs', 'JobTemplateTemplateVpcAccessArgsDict', 'JobTemplateTemplateVpcAccessNetworkInterfaceArgs', ..., 'JobTerminalConditionArgs', 'JobTerminalConditionArgsDict', 'ServiceBinaryAuthorizationArgs', 'ServiceBinaryAuthorizationArgsDict', 'ServiceBuildConfigArgs', 'ServiceBuildConfigArgsDict', 'ServiceConditionArgs', 'ServiceConditionArgsDict', 'ServiceIamBindingConditionArgs', 'ServiceIamBindingConditionArgsDict', 'ServiceIamMemberConditionArgs', 'ServiceIamMemberConditionArgsDict', 'ServiceMultiRegionSettingsArgs', 'ServiceMultiRegionSettingsArgsDict', 'ServiceScalingArgs', 'ServiceScalingArgsDict', 'ServiceTemplateArgs', 'ServiceTemplateArgsDict', 'ServiceTemplateContainerArgs', 'ServiceTemplateContainerArgsDict', 'ServiceTemplateContainerBuildInfoArgs', 'ServiceTemplateContainerBuildInfoArgsDict', 'ServiceTemplateContainerEnvArgs', 'ServiceTemplateContainerEnvArgsDict', 'ServiceTemplateContainerEnvValueSourceArgs', 'ServiceTemplateContainerEnvValueSourceArgsDict', ..., ..., 'ServiceTemplateContainerLivenessProbeArgs', 'ServiceTemplateContainerLivenessProbeArgsDict', 'ServiceTemplateContainerLivenessProbeGrpcArgs', 'ServiceTemplateContainerLivenessProbeGrpcArgsDict', 'ServiceTemplateContainerLivenessProbeHttpGetArgs', ..., ..., ..., 'ServiceTemplateContainerLivenessProbeTcpSocketArgs', ..., 'ServiceTemplateContainerPortsArgs', 'ServiceTemplateContainerPortsArgsDict', 'ServiceTemplateContainerReadinessProbeArgs', 'ServiceTemplateContainerReadinessProbeArgsDict', 'ServiceTemplateContainerReadinessProbeGrpcArgs', 'ServiceTemplateContainerReadinessProbeGrpcArgsDict', 'ServiceTemplateContainerReadinessProbeHttpGetArgs', ..., 'ServiceTemplateContainerResourcesArgs', 'ServiceTemplateContainerResourcesArgsDict', 'ServiceTemplateContainerSourceCodeArgs', 'ServiceTemplateContainerSourceCodeArgsDict', ..., ..., 'ServiceTemplateContainerStartupProbeArgs', 'ServiceTemplateContainerStartupProbeArgsDict', 'ServiceTemplateContainerStartupProbeGrpcArgs', 'ServiceTemplateContainerStartupProbeGrpcArgsDict', 'ServiceTemplateContainerStartupProbeHttpGetArgs', ..., ..., ..., 'ServiceTemplateContainerStartupProbeTcpSocketArgs', ..., 'ServiceTemplateContainerVolumeMountArgs', 'ServiceTemplateContainerVolumeMountArgsDict', 'ServiceTemplateNodeSelectorArgs', 'ServiceTemplateNodeSelectorArgsDict', 'ServiceTemplateScalingArgs', 'ServiceTemplateScalingArgsDict', 'ServiceTemplateServiceMeshArgs', 'ServiceTemplateServiceMeshArgsDict', 'ServiceTemplateVolumeArgs', 'ServiceTemplateVolumeArgsDict', 'ServiceTemplateVolumeCloudSqlInstanceArgs', 'ServiceTemplateVolumeCloudSqlInstanceArgsDict', 'ServiceTemplateVolumeEmptyDirArgs', 'ServiceTemplateVolumeEmptyDirArgsDict', 'ServiceTemplateVolumeGcsArgs', 'ServiceTemplateVolumeGcsArgsDict', 'ServiceTemplateVolumeNfsArgs', 'ServiceTemplateVolumeNfsArgsDict', 'ServiceTemplateVolumeSecretArgs', 'ServiceTemplateVolumeSecretArgsDict', 'ServiceTemplateVolumeSecretItemArgs', 'ServiceTemplateVolumeSecretItemArgsDict', 'ServiceTemplateVpcAccessArgs', 'ServiceTemplateVpcAccessArgsDict', 'ServiceTemplateVpcAccessNetworkInterfaceArgs', 'ServiceTemplateVpcAccessNetworkInterfaceArgsDict', 'ServiceTerminalConditionArgs', 'ServiceTerminalConditionArgsDict', 'ServiceTrafficArgs', 'ServiceTrafficArgsDict', 'ServiceTrafficStatusArgs', 'ServiceTrafficStatusArgsDict', 'WorkerPoolBinaryAuthorizationArgs', 'WorkerPoolBinaryAuthorizationArgsDict', 'WorkerPoolConditionArgs', 'WorkerPoolConditionArgsDict', 'WorkerPoolIamBindingConditionArgs', 'WorkerPoolIamBindingConditionArgsDict', 'WorkerPoolIamMemberConditionArgs', 'WorkerPoolIamMemberConditionArgsDict', 'WorkerPoolInstanceSplitArgs', 'WorkerPoolInstanceSplitArgsDict', 'WorkerPoolInstanceSplitStatusArgs', 'WorkerPoolInstanceSplitStatusArgsDict', 'WorkerPoolScalingArgs', 'WorkerPoolScalingArgsDict', 'WorkerPoolTemplateArgs', 'WorkerPoolTemplateArgsDict', 'WorkerPoolTemplateContainerArgs', 'WorkerPoolTemplateContainerArgsDict', 'WorkerPoolTemplateContainerEnvArgs', 'WorkerPoolTemplateContainerEnvArgsDict', 'WorkerPoolTemplateContainerEnvValueSourceArgs', 'WorkerPoolTemplateContainerEnvValueSourceArgsDict', ..., ..., 'WorkerPoolTemplateContainerLivenessProbeArgs', 'WorkerPoolTemplateContainerLivenessProbeArgsDict', 'WorkerPoolTemplateContainerLivenessProbeGrpcArgs', ..., ..., ..., ..., ..., ..., ..., 'WorkerPoolTemplateContainerResourcesArgs', 'WorkerPoolTemplateContainerResourcesArgsDict', 'WorkerPoolTemplateContainerStartupProbeArgs', 'WorkerPoolTemplateContainerStartupProbeArgsDict', 'WorkerPoolTemplateContainerStartupProbeGrpcArgs', ..., 'WorkerPoolTemplateContainerStartupProbeHttpGetArgs', ..., ..., ..., ..., ..., 'WorkerPoolTemplateContainerVolumeMountArgs', 'WorkerPoolTemplateContainerVolumeMountArgsDict', 'WorkerPoolTemplateNodeSelectorArgs', 'WorkerPoolTemplateNodeSelectorArgsDict', 'WorkerPoolTemplateVolumeArgs', 'WorkerPoolTemplateVolumeArgsDict', 'WorkerPoolTemplateVolumeCloudSqlInstanceArgs', 'WorkerPoolTemplateVolumeCloudSqlInstanceArgsDict', 'WorkerPoolTemplateVolumeEmptyDirArgs', 'WorkerPoolTemplateVolumeEmptyDirArgsDict', 'WorkerPoolTemplateVolumeGcsArgs', 'WorkerPoolTemplateVolumeGcsArgsDict', 'WorkerPoolTemplateVolumeNfsArgs', 'WorkerPoolTemplateVolumeNfsArgsDict', 'WorkerPoolTemplateVolumeSecretArgs', 'WorkerPoolTemplateVolumeSecretArgsDict', 'WorkerPoolTemplateVolumeSecretItemArgs', 'WorkerPoolTemplateVolumeSecretItemArgsDict', 'WorkerPoolTemplateVpcAccessArgs', 'WorkerPoolTemplateVpcAccessArgsDict', 'WorkerPoolTemplateVpcAccessNetworkInterfaceArgs', ..., 'WorkerPoolTerminalConditionArgs', 'WorkerPoolTerminalConditionArgsDict']
...
class JobBinaryAuthorizationArgs:
    def __init__(__self__, *, breakglass_justification: Optional[pulumi.Input[_builtins.str]] = ..., policy: Optional[pulumi.Input[_builtins.str]] = ..., use_default: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def breakglass_justification(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @use_default.setter
    def use_default(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class JobConditionArgs:
    def __init__(__self__, *, execution_reason: Optional[pulumi.Input[_builtins.str]] = ..., last_transition_time: Optional[pulumi.Input[_builtins.str]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ..., reason: Optional[pulumi.Input[_builtins.str]] = ..., revision_reason: Optional[pulumi.Input[_builtins.str]] = ..., severity: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def execution_reason(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def revision_reason(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class JobLatestCreatedExecutionArgs:
    def __init__(__self__, *, completion_time: Optional[pulumi.Input[_builtins.str]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def completion_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class JobTemplateArgs:
    def __init__(__self__, *, template: pulumi.Input[JobTemplateTemplateArgs], annotations: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., parallelism: Optional[pulumi.Input[_builtins.int]] = ..., task_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @template.setter
    def template(self, value: pulumi.Input[JobTemplateTemplateArgs]): # -> None:
        ...
...
class JobTemplateTemplateArgs:
    def __init__(__self__, *, containers: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateContainerArgs]]]] = ..., encryption_key: Optional[pulumi.Input[_builtins.str]] = ..., execution_environment: Optional[pulumi.Input[_builtins.str]] = ..., gpu_zonal_redundancy_disabled: Optional[pulumi.Input[_builtins.bool]] = ..., max_retries: Optional[pulumi.Input[_builtins.int]] = ..., node_selector: Optional[pulumi.Input[JobTemplateTemplateNodeSelectorArgs]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ..., volumes: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateVolumeArgs]]]] = ..., vpc_access: Optional[pulumi.Input[JobTemplateTemplateVpcAccessArgs]] = ...) -> None:
    ...
    @containers.setter
    def containers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateContainerArgs]]]]): # -> None:
        ...
    ...
    def encryption_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def execution_environment(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def gpu_zonal_redundancy_disabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def node_selector(self, value: Optional[pulumi.Input[JobTemplateTemplateNodeSelectorArgs]]): # -> None:
        ...
    ...
    @volumes.setter
    def volumes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateVolumeArgs]]]]): # -> None:
        ...
    ...
    @vpc_access.setter
    def vpc_access(self, value: Optional[pulumi.Input[JobTemplateTemplateVpcAccessArgs]]): # -> None:
        ...
...
class JobTemplateTemplateContainerArgs:
    def __init__(__self__, *, image: pulumi.Input[_builtins.str], args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., commands: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., depends_ons: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., envs: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateContainerEnvArgs]]]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., ports: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateContainerPortArgs]]]] = ..., resources: Optional[pulumi.Input[JobTemplateTemplateContainerResourcesArgs]] = ..., startup_probe: Optional[pulumi.Input[JobTemplateTemplateContainerStartupProbeArgs]] = ..., volume_mounts: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateContainerVolumeMountArgs]]]] = ..., working_dir: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @depends_ons.setter
    def depends_ons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @envs.setter
    def envs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateContainerEnvArgs]]]]): # -> None:
        ...
    ...
    @ports.setter
    def ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateContainerPortArgs]]]]): # -> None:
        ...
    ...
    @resources.setter
    def resources(self, value: Optional[pulumi.Input[JobTemplateTemplateContainerResourcesArgs]]): # -> None:
        ...
    ...
    def startup_probe(self, value: Optional[pulumi.Input[JobTemplateTemplateContainerStartupProbeArgs]]): # -> None:
        ...
    ...
    def volume_mounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateContainerVolumeMountArgs]]]]): # -> None:
        ...
...
class JobTemplateTemplateContainerEnvArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], value: Optional[pulumi.Input[_builtins.str]] = ..., value_source: Optional[pulumi.Input[JobTemplateTemplateContainerEnvValueSourceArgs]] = ...) -> None:
    ...
    @value_source.setter
    def value_source(self, value: Optional[pulumi.Input[JobTemplateTemplateContainerEnvValueSourceArgs]]): # -> None:
        ...
...
class JobTemplateTemplateContainerEnvValueSourceArgs:
    def __init__(__self__, *, secret_key_ref: Optional[pulumi.Input[JobTemplateTemplateContainerEnvValueSourceSecretKeyRefArgs]] = ...) -> None:
    ...
    def secret_key_ref(self, value: Optional[pulumi.Input[JobTemplateTemplateContainerEnvValueSourceSecretKeyRefArgs]]): # -> None:
        ...
...
class JobTemplateTemplateContainerEnvValueSourceSecretKeyRefArgs:
    def __init__(__self__, *, secret: pulumi.Input[_builtins.str], version: pulumi.Input[_builtins.str]) -> None:
...
class JobTemplateTemplateContainerPortArgs:
    def __init__(__self__, *, container_port: Optional[pulumi.Input[_builtins.int]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JobTemplateTemplateContainerResourcesArgs:
    def __init__(__self__, *, limits: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class JobTemplateTemplateContainerStartupProbeArgs:
    def __init__(__self__, *, failure_threshold: Optional[pulumi.Input[_builtins.int]] = ..., grpc: Optional[pulumi.Input[JobTemplateTemplateContainerStartupProbeGrpcArgs]] = ..., http_get: Optional[pulumi.Input[JobTemplateTemplateContainerStartupProbeHttpGetArgs]] = ..., initial_delay_seconds: Optional[pulumi.Input[_builtins.int]] = ..., period_seconds: Optional[pulumi.Input[_builtins.int]] = ..., tcp_socket: Optional[pulumi.Input[JobTemplateTemplateContainerStartupProbeTcpSocketArgs]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @grpc.setter
    def grpc(self, value: Optional[pulumi.Input[JobTemplateTemplateContainerStartupProbeGrpcArgs]]): # -> None:
        ...
    ...
    @http_get.setter
    def http_get(self, value: Optional[pulumi.Input[JobTemplateTemplateContainerStartupProbeHttpGetArgs]]): # -> None:
        ...
    ...
    @tcp_socket.setter
    def tcp_socket(self, value: Optional[pulumi.Input[JobTemplateTemplateContainerStartupProbeTcpSocketArgs]]): # -> None:
        ...
...
class JobTemplateTemplateContainerStartupProbeHttpGetArgs:
    def __init__(__self__, *, http_headers: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateContainerStartupProbeHttpGetHttpHeaderArgs]]]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateContainerStartupProbeHttpGetHttpHeaderArgs]]]]): # -> None:
        ...
...
class JobTemplateTemplateContainerVolumeMountArgs:
    def __init__(__self__, *, mount_path: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], sub_path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JobTemplateTemplateNodeSelectorArgs:
    ...
    @accelerator.setter
    def accelerator(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class JobTemplateTemplateVolumeArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], cloud_sql_instance: Optional[pulumi.Input[JobTemplateTemplateVolumeCloudSqlInstanceArgs]] = ..., empty_dir: Optional[pulumi.Input[JobTemplateTemplateVolumeEmptyDirArgs]] = ..., gcs: Optional[pulumi.Input[JobTemplateTemplateVolumeGcsArgs]] = ..., nfs: Optional[pulumi.Input[JobTemplateTemplateVolumeNfsArgs]] = ..., secret: Optional[pulumi.Input[JobTemplateTemplateVolumeSecretArgs]] = ...) -> None:
    ...
    def cloud_sql_instance(self, value: Optional[pulumi.Input[JobTemplateTemplateVolumeCloudSqlInstanceArgs]]): # -> None:
        ...
    ...
    @empty_dir.setter
    def empty_dir(self, value: Optional[pulumi.Input[JobTemplateTemplateVolumeEmptyDirArgs]]): # -> None:
        ...
    ...
    @gcs.setter
    def gcs(self, value: Optional[pulumi.Input[JobTemplateTemplateVolumeGcsArgs]]): # -> None:
        ...
    ...
    @nfs.setter
    def nfs(self, value: Optional[pulumi.Input[JobTemplateTemplateVolumeNfsArgs]]): # -> None:
        ...
    ...
    @secret.setter
    def secret(self, value: Optional[pulumi.Input[JobTemplateTemplateVolumeSecretArgs]]): # -> None:
        ...
...
class JobTemplateTemplateVolumeCloudSqlInstanceArgs:
    def __init__(__self__, *, instances: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class JobTemplateTemplateVolumeEmptyDirArgs:
    def __init__(__self__, *, medium: Optional[pulumi.Input[_builtins.str]] = ..., size_limit: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @size_limit.setter
    def size_limit(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class JobTemplateTemplateVolumeGcsArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], mount_options: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., read_only: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class JobTemplateTemplateVolumeNfsArgs:
    def __init__(__self__, *, server: pulumi.Input[_builtins.str], path: Optional[pulumi.Input[_builtins.str]] = ..., read_only: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class JobTemplateTemplateVolumeSecretArgs:
    def __init__(__self__, *, secret: pulumi.Input[_builtins.str], default_mode: Optional[pulumi.Input[_builtins.int]] = ..., items: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateVolumeSecretItemArgs]]]] = ...) -> None:
    ...
    @default_mode.setter
    def default_mode(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @items.setter
    def items(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateVolumeSecretItemArgs]]]]): # -> None:
        ...
...
class JobTemplateTemplateVolumeSecretItemArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], version: pulumi.Input[_builtins.str], mode: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @mode.setter
    def mode(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class JobTemplateTemplateVpcAccessArgs:
    def __init__(__self__, *, connector: Optional[pulumi.Input[_builtins.str]] = ..., egress: Optional[pulumi.Input[_builtins.str]] = ..., network_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateVpcAccessNetworkInterfaceArgs]]]] = ...) -> None:
    ...
    @connector.setter
    def connector(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @egress.setter
    def egress(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def network_interfaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobTemplateTemplateVpcAccessNetworkInterfaceArgs]]]]): # -> None:
        ...
...
class JobTemplateTemplateVpcAccessNetworkInterfaceArgs:
    def __init__(__self__, *, network: Optional[pulumi.Input[_builtins.str]] = ..., subnetwork: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class ServiceBuildConfigArgs:
    def __init__(__self__, *, base_image: Optional[pulumi.Input[_builtins.str]] = ..., enable_automatic_updates: Optional[pulumi.Input[_builtins.bool]] = ..., environment_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., function_target: Optional[pulumi.Input[_builtins.str]] = ..., image_uri: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., source_location: Optional[pulumi.Input[_builtins.str]] = ..., worker_pool: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def function_target(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def source_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @worker_pool.setter
    def worker_pool(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceMultiRegionSettingsArgs:
    def __init__(__self__, *, multi_region_id: Optional[pulumi.Input[_builtins.str]] = ..., regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def multi_region_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceScalingArgs:
    def __init__(__self__, *, manual_instance_count: Optional[pulumi.Input[_builtins.int]] = ..., max_instance_count: Optional[pulumi.Input[_builtins.int]] = ..., min_instance_count: Optional[pulumi.Input[_builtins.int]] = ..., scaling_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def manual_instance_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @scaling_mode.setter
    def scaling_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceTemplateArgs:
    def __init__(__self__, *, annotations: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., containers: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerArgs]]]] = ..., encryption_key: Optional[pulumi.Input[_builtins.str]] = ..., execution_environment: Optional[pulumi.Input[_builtins.str]] = ..., gpu_zonal_redundancy_disabled: Optional[pulumi.Input[_builtins.bool]] = ..., health_check_disabled: Optional[pulumi.Input[_builtins.bool]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., max_instance_request_concurrency: Optional[pulumi.Input[_builtins.int]] = ..., node_selector: Optional[pulumi.Input[ServiceTemplateNodeSelectorArgs]] = ..., revision: Optional[pulumi.Input[_builtins.str]] = ..., scaling: Optional[pulumi.Input[ServiceTemplateScalingArgs]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., service_mesh: Optional[pulumi.Input[ServiceTemplateServiceMeshArgs]] = ..., session_affinity: Optional[pulumi.Input[_builtins.bool]] = ..., timeout: Optional[pulumi.Input[_builtins.str]] = ..., volumes: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateVolumeArgs]]]] = ..., vpc_access: Optional[pulumi.Input[ServiceTemplateVpcAccessArgs]] = ...) -> None:
    ...
    @containers.setter
    def containers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerArgs]]]]): # -> None:
        ...
    ...
    def health_check_disabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def max_instance_request_concurrency(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @node_selector.setter
    def node_selector(self, value: Optional[pulumi.Input[ServiceTemplateNodeSelectorArgs]]): # -> None:
        ...
    ...
    @scaling.setter
    def scaling(self, value: Optional[pulumi.Input[ServiceTemplateScalingArgs]]): # -> None:
        ...
    ...
    @service_mesh.setter
    def service_mesh(self, value: Optional[pulumi.Input[ServiceTemplateServiceMeshArgs]]): # -> None:
        ...
    ...
    def session_affinity(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @volumes.setter
    def volumes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateVolumeArgs]]]]): # -> None:
        ...
    ...
    @vpc_access.setter
    def vpc_access(self, value: Optional[pulumi.Input[ServiceTemplateVpcAccessArgs]]): # -> None:
        ...
...
class ServiceTemplateContainerArgs:
    def __init__(__self__, *, image: pulumi.Input[_builtins.str], args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., base_image_uri: Optional[pulumi.Input[_builtins.str]] = ..., build_infos: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerBuildInfoArgs]]]] = ..., commands: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., depends_ons: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., envs: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerEnvArgs]]]] = ..., liveness_probe: Optional[pulumi.Input[ServiceTemplateContainerLivenessProbeArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., ports: Optional[pulumi.Input[ServiceTemplateContainerPortsArgs]] = ..., readiness_probe: Optional[pulumi.Input[ServiceTemplateContainerReadinessProbeArgs]] = ..., resources: Optional[pulumi.Input[ServiceTemplateContainerResourcesArgs]] = ..., source_code: Optional[pulumi.Input[ServiceTemplateContainerSourceCodeArgs]] = ..., startup_probe: Optional[pulumi.Input[ServiceTemplateContainerStartupProbeArgs]] = ..., volume_mounts: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerVolumeMountArgs]]]] = ..., working_dir: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def base_image_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @build_infos.setter
    def build_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerBuildInfoArgs]]]]): # -> None:
        ...
    ...
    @envs.setter
    def envs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerEnvArgs]]]]): # -> None:
        ...
    ...
    def liveness_probe(self, value: Optional[pulumi.Input[ServiceTemplateContainerLivenessProbeArgs]]): # -> None:
        ...
    ...
    @ports.setter
    def ports(self, value: Optional[pulumi.Input[ServiceTemplateContainerPortsArgs]]): # -> None:
        ...
    ...
    def readiness_probe(self, value: Optional[pulumi.Input[ServiceTemplateContainerReadinessProbeArgs]]): # -> None:
        ...
    ...
    @resources.setter
    def resources(self, value: Optional[pulumi.Input[ServiceTemplateContainerResourcesArgs]]): # -> None:
        ...
    ...
    @source_code.setter
    def source_code(self, value: Optional[pulumi.Input[ServiceTemplateContainerSourceCodeArgs]]): # -> None:
        ...
    ...
    @startup_probe.setter
    def startup_probe(self, value: Optional[pulumi.Input[ServiceTemplateContainerStartupProbeArgs]]): # -> None:
        ...
    ...
    @volume_mounts.setter
    def volume_mounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerVolumeMountArgs]]]]): # -> None:
        ...
...
class ServiceTemplateContainerBuildInfoArgs:
    def __init__(__self__, *, function_target: Optional[pulumi.Input[_builtins.str]] = ..., source_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServiceTemplateContainerEnvArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], value: Optional[pulumi.Input[_builtins.str]] = ..., value_source: Optional[pulumi.Input[ServiceTemplateContainerEnvValueSourceArgs]] = ...) -> None:
    ...
    @value_source.setter
    def value_source(self, value: Optional[pulumi.Input[ServiceTemplateContainerEnvValueSourceArgs]]): # -> None:
        ...
...
class ServiceTemplateContainerEnvValueSourceArgs:
    def __init__(__self__, *, secret_key_ref: Optional[pulumi.Input[ServiceTemplateContainerEnvValueSourceSecretKeyRefArgs]] = ...) -> None:
    ...
    @secret_key_ref.setter
    def secret_key_ref(self, value: Optional[pulumi.Input[ServiceTemplateContainerEnvValueSourceSecretKeyRefArgs]]): # -> None:
        ...
...
class ServiceTemplateContainerLivenessProbeArgs:
    def __init__(__self__, *, failure_threshold: Optional[pulumi.Input[_builtins.int]] = ..., grpc: Optional[pulumi.Input[ServiceTemplateContainerLivenessProbeGrpcArgs]] = ..., http_get: Optional[pulumi.Input[ServiceTemplateContainerLivenessProbeHttpGetArgs]] = ..., initial_delay_seconds: Optional[pulumi.Input[_builtins.int]] = ..., period_seconds: Optional[pulumi.Input[_builtins.int]] = ..., tcp_socket: Optional[pulumi.Input[ServiceTemplateContainerLivenessProbeTcpSocketArgs]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @grpc.setter
    def grpc(self, value: Optional[pulumi.Input[ServiceTemplateContainerLivenessProbeGrpcArgs]]): # -> None:
        ...
    ...
    @http_get.setter
    def http_get(self, value: Optional[pulumi.Input[ServiceTemplateContainerLivenessProbeHttpGetArgs]]): # -> None:
        ...
    ...
    @tcp_socket.setter
    def tcp_socket(self, value: Optional[pulumi.Input[ServiceTemplateContainerLivenessProbeTcpSocketArgs]]): # -> None:
        ...
...
class ServiceTemplateContainerLivenessProbeHttpGetArgs:
    def __init__(__self__, *, http_headers: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerLivenessProbeHttpGetHttpHeaderArgs]]]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerLivenessProbeHttpGetHttpHeaderArgs]]]]): # -> None:
        ...
...
class ServiceTemplateContainerReadinessProbeArgs:
    def __init__(__self__, *, failure_threshold: Optional[pulumi.Input[_builtins.int]] = ..., grpc: Optional[pulumi.Input[ServiceTemplateContainerReadinessProbeGrpcArgs]] = ..., http_get: Optional[pulumi.Input[ServiceTemplateContainerReadinessProbeHttpGetArgs]] = ..., period_seconds: Optional[pulumi.Input[_builtins.int]] = ..., success_threshold: Optional[pulumi.Input[_builtins.int]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @grpc.setter
    def grpc(self, value: Optional[pulumi.Input[ServiceTemplateContainerReadinessProbeGrpcArgs]]): # -> None:
        ...
    ...
    @http_get.setter
    def http_get(self, value: Optional[pulumi.Input[ServiceTemplateContainerReadinessProbeHttpGetArgs]]): # -> None:
        ...
...
class ServiceTemplateContainerReadinessProbeHttpGetArgs:
    def __init__(__self__, *, path: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ServiceTemplateContainerResourcesArgs:
    def __init__(__self__, *, cpu_idle: Optional[pulumi.Input[_builtins.bool]] = ..., limits: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., startup_cpu_boost: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @cpu_idle.setter
    def cpu_idle(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def startup_cpu_boost(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ServiceTemplateContainerSourceCodeArgs:
    def __init__(__self__, *, cloud_storage_source: Optional[pulumi.Input[ServiceTemplateContainerSourceCodeCloudStorageSourceArgs]] = ...) -> None:
    ...
    def cloud_storage_source(self, value: Optional[pulumi.Input[ServiceTemplateContainerSourceCodeCloudStorageSourceArgs]]): # -> None:
        ...
...
class ServiceTemplateContainerStartupProbeArgs:
    def __init__(__self__, *, failure_threshold: Optional[pulumi.Input[_builtins.int]] = ..., grpc: Optional[pulumi.Input[ServiceTemplateContainerStartupProbeGrpcArgs]] = ..., http_get: Optional[pulumi.Input[ServiceTemplateContainerStartupProbeHttpGetArgs]] = ..., initial_delay_seconds: Optional[pulumi.Input[_builtins.int]] = ..., period_seconds: Optional[pulumi.Input[_builtins.int]] = ..., tcp_socket: Optional[pulumi.Input[ServiceTemplateContainerStartupProbeTcpSocketArgs]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @grpc.setter
    def grpc(self, value: Optional[pulumi.Input[ServiceTemplateContainerStartupProbeGrpcArgs]]): # -> None:
        ...
    ...
    @http_get.setter
    def http_get(self, value: Optional[pulumi.Input[ServiceTemplateContainerStartupProbeHttpGetArgs]]): # -> None:
        ...
    ...
    @tcp_socket.setter
    def tcp_socket(self, value: Optional[pulumi.Input[ServiceTemplateContainerStartupProbeTcpSocketArgs]]): # -> None:
        ...
...
class ServiceTemplateContainerStartupProbeHttpGetArgs:
    def __init__(__self__, *, http_headers: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerStartupProbeHttpGetHttpHeaderArgs]]]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateContainerStartupProbeHttpGetHttpHeaderArgs]]]]): # -> None:
        ...
...
class ServiceTemplateScalingArgs:
    def __init__(__self__, *, max_instance_count: Optional[pulumi.Input[_builtins.int]] = ..., min_instance_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ServiceTemplateServiceMeshArgs:
    def __init__(__self__, *, mesh: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @mesh.setter
    def mesh(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceTemplateVolumeArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], cloud_sql_instance: Optional[pulumi.Input[ServiceTemplateVolumeCloudSqlInstanceArgs]] = ..., empty_dir: Optional[pulumi.Input[ServiceTemplateVolumeEmptyDirArgs]] = ..., gcs: Optional[pulumi.Input[ServiceTemplateVolumeGcsArgs]] = ..., nfs: Optional[pulumi.Input[ServiceTemplateVolumeNfsArgs]] = ..., secret: Optional[pulumi.Input[ServiceTemplateVolumeSecretArgs]] = ...) -> None:
    ...
    @cloud_sql_instance.setter
    def cloud_sql_instance(self, value: Optional[pulumi.Input[ServiceTemplateVolumeCloudSqlInstanceArgs]]): # -> None:
        ...
    ...
    @empty_dir.setter
    def empty_dir(self, value: Optional[pulumi.Input[ServiceTemplateVolumeEmptyDirArgs]]): # -> None:
        ...
    ...
    @gcs.setter
    def gcs(self, value: Optional[pulumi.Input[ServiceTemplateVolumeGcsArgs]]): # -> None:
        ...
    ...
    @nfs.setter
    def nfs(self, value: Optional[pulumi.Input[ServiceTemplateVolumeNfsArgs]]): # -> None:
        ...
    ...
    @secret.setter
    def secret(self, value: Optional[pulumi.Input[ServiceTemplateVolumeSecretArgs]]): # -> None:
        ...
...
class ServiceTemplateVolumeNfsArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], server: pulumi.Input[_builtins.str], read_only: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class ServiceTemplateVolumeSecretArgs:
    def __init__(__self__, *, secret: pulumi.Input[_builtins.str], default_mode: Optional[pulumi.Input[_builtins.int]] = ..., items: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateVolumeSecretItemArgs]]]] = ...) -> None:
    ...
    @items.setter
    def items(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateVolumeSecretItemArgs]]]]): # -> None:
        ...
...
class ServiceTemplateVolumeSecretItemArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], mode: Optional[pulumi.Input[_builtins.int]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServiceTemplateVpcAccessArgs:
    def __init__(__self__, *, connector: Optional[pulumi.Input[_builtins.str]] = ..., egress: Optional[pulumi.Input[_builtins.str]] = ..., network_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateVpcAccessNetworkInterfaceArgs]]]] = ...) -> None:
    ...
    @network_interfaces.setter
    def network_interfaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ServiceTemplateVpcAccessNetworkInterfaceArgs]]]]): # -> None:
        ...
...
class ServiceTrafficArgs:
    def __init__(__self__, *, percent: Optional[pulumi.Input[_builtins.int]] = ..., revision: Optional[pulumi.Input[_builtins.str]] = ..., tag: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServiceTrafficStatusArgs:
    def __init__(__self__, *, percent: Optional[pulumi.Input[_builtins.int]] = ..., revision: Optional[pulumi.Input[_builtins.str]] = ..., tag: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkerPoolInstanceSplitArgs:
    def __init__(__self__, *, percent: Optional[pulumi.Input[_builtins.int]] = ..., revision: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkerPoolTemplateArgs:
    def __init__(__self__, *, annotations: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., containers: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateContainerArgs]]]] = ..., encryption_key: Optional[pulumi.Input[_builtins.str]] = ..., encryption_key_revocation_action: Optional[pulumi.Input[_builtins.str]] = ..., encryption_key_shutdown_duration: Optional[pulumi.Input[_builtins.str]] = ..., gpu_zonal_redundancy_disabled: Optional[pulumi.Input[_builtins.bool]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., node_selector: Optional[pulumi.Input[WorkerPoolTemplateNodeSelectorArgs]] = ..., revision: Optional[pulumi.Input[_builtins.str]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., volumes: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateVolumeArgs]]]] = ..., vpc_access: Optional[pulumi.Input[WorkerPoolTemplateVpcAccessArgs]] = ...) -> None:
    ...
    @containers.setter
    def containers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateContainerArgs]]]]): # -> None:
        ...
    ...
    def encryption_key_revocation_action(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def encryption_key_shutdown_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @node_selector.setter
    def node_selector(self, value: Optional[pulumi.Input[WorkerPoolTemplateNodeSelectorArgs]]): # -> None:
        ...
    ...
    @volumes.setter
    def volumes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateVolumeArgs]]]]): # -> None:
        ...
    ...
    @vpc_access.setter
    def vpc_access(self, value: Optional[pulumi.Input[WorkerPoolTemplateVpcAccessArgs]]): # -> None:
        ...
...
class WorkerPoolTemplateContainerArgs:
    def __init__(__self__, *, image: pulumi.Input[_builtins.str], args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., commands: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., depends_ons: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., envs: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateContainerEnvArgs]]]] = ..., liveness_probe: Optional[pulumi.Input[WorkerPoolTemplateContainerLivenessProbeArgs]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., resources: Optional[pulumi.Input[WorkerPoolTemplateContainerResourcesArgs]] = ..., startup_probe: Optional[pulumi.Input[WorkerPoolTemplateContainerStartupProbeArgs]] = ..., volume_mounts: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateContainerVolumeMountArgs]]]] = ..., working_dir: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @envs.setter
    def envs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateContainerEnvArgs]]]]): # -> None:
        ...
    ...
    @liveness_probe.setter
    def liveness_probe(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerLivenessProbeArgs]]): # -> None:
        ...
    ...
    @resources.setter
    def resources(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerResourcesArgs]]): # -> None:
        ...
    ...
    @startup_probe.setter
    def startup_probe(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerStartupProbeArgs]]): # -> None:
        ...
    ...
    @volume_mounts.setter
    def volume_mounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateContainerVolumeMountArgs]]]]): # -> None:
        ...
...
class WorkerPoolTemplateContainerEnvArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], value: Optional[pulumi.Input[_builtins.str]] = ..., value_source: Optional[pulumi.Input[WorkerPoolTemplateContainerEnvValueSourceArgs]] = ...) -> None:
    ...
    @value_source.setter
    def value_source(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerEnvValueSourceArgs]]): # -> None:
        ...
...
class WorkerPoolTemplateContainerEnvValueSourceArgs:
    def __init__(__self__, *, secret_key_ref: Optional[pulumi.Input[WorkerPoolTemplateContainerEnvValueSourceSecretKeyRefArgs]] = ...) -> None:
    ...
    @secret_key_ref.setter
    def secret_key_ref(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerEnvValueSourceSecretKeyRefArgs]]): # -> None:
        ...
...
class WorkerPoolTemplateContainerLivenessProbeArgs:
    def __init__(__self__, *, failure_threshold: Optional[pulumi.Input[_builtins.int]] = ..., grpc: Optional[pulumi.Input[WorkerPoolTemplateContainerLivenessProbeGrpcArgs]] = ..., http_get: Optional[pulumi.Input[WorkerPoolTemplateContainerLivenessProbeHttpGetArgs]] = ..., initial_delay_seconds: Optional[pulumi.Input[_builtins.int]] = ..., period_seconds: Optional[pulumi.Input[_builtins.int]] = ..., tcp_socket: Optional[pulumi.Input[WorkerPoolTemplateContainerLivenessProbeTcpSocketArgs]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @grpc.setter
    def grpc(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerLivenessProbeGrpcArgs]]): # -> None:
        ...
    ...
    @http_get.setter
    def http_get(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerLivenessProbeHttpGetArgs]]): # -> None:
        ...
    ...
    @tcp_socket.setter
    def tcp_socket(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerLivenessProbeTcpSocketArgs]]): # -> None:
        ...
...
class WorkerPoolTemplateContainerLivenessProbeHttpGetArgs:
    def __init__(__self__, *, http_headers: Optional[pulumi.Input[WorkerPoolTemplateContainerLivenessProbeHttpGetHttpHeadersArgs]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerLivenessProbeHttpGetHttpHeadersArgs]]): # -> None:
        ...
...
class WorkerPoolTemplateContainerLivenessProbeHttpGetHttpHeadersArgs:
    def __init__(__self__, *, port: pulumi.Input[_builtins.int], value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkerPoolTemplateContainerStartupProbeArgs:
    def __init__(__self__, *, failure_threshold: Optional[pulumi.Input[_builtins.int]] = ..., grpc: Optional[pulumi.Input[WorkerPoolTemplateContainerStartupProbeGrpcArgs]] = ..., http_get: Optional[pulumi.Input[WorkerPoolTemplateContainerStartupProbeHttpGetArgs]] = ..., initial_delay_seconds: Optional[pulumi.Input[_builtins.int]] = ..., period_seconds: Optional[pulumi.Input[_builtins.int]] = ..., tcp_socket: Optional[pulumi.Input[WorkerPoolTemplateContainerStartupProbeTcpSocketArgs]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @grpc.setter
    def grpc(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerStartupProbeGrpcArgs]]): # -> None:
        ...
    ...
    @http_get.setter
    def http_get(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerStartupProbeHttpGetArgs]]): # -> None:
        ...
    ...
    @tcp_socket.setter
    def tcp_socket(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerStartupProbeTcpSocketArgs]]): # -> None:
        ...
...
class WorkerPoolTemplateContainerStartupProbeHttpGetArgs:
    def __init__(__self__, *, http_headers: Optional[pulumi.Input[WorkerPoolTemplateContainerStartupProbeHttpGetHttpHeadersArgs]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[WorkerPoolTemplateContainerStartupProbeHttpGetHttpHeadersArgs]]): # -> None:
        ...
...
class WorkerPoolTemplateVolumeArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], cloud_sql_instance: Optional[pulumi.Input[WorkerPoolTemplateVolumeCloudSqlInstanceArgs]] = ..., empty_dir: Optional[pulumi.Input[WorkerPoolTemplateVolumeEmptyDirArgs]] = ..., gcs: Optional[pulumi.Input[WorkerPoolTemplateVolumeGcsArgs]] = ..., nfs: Optional[pulumi.Input[WorkerPoolTemplateVolumeNfsArgs]] = ..., secret: Optional[pulumi.Input[WorkerPoolTemplateVolumeSecretArgs]] = ...) -> None:
    ...
    @cloud_sql_instance.setter
    def cloud_sql_instance(self, value: Optional[pulumi.Input[WorkerPoolTemplateVolumeCloudSqlInstanceArgs]]): # -> None:
        ...
    ...
    @empty_dir.setter
    def empty_dir(self, value: Optional[pulumi.Input[WorkerPoolTemplateVolumeEmptyDirArgs]]): # -> None:
        ...
    ...
    @gcs.setter
    def gcs(self, value: Optional[pulumi.Input[WorkerPoolTemplateVolumeGcsArgs]]): # -> None:
        ...
    ...
    @nfs.setter
    def nfs(self, value: Optional[pulumi.Input[WorkerPoolTemplateVolumeNfsArgs]]): # -> None:
        ...
    ...
    @secret.setter
    def secret(self, value: Optional[pulumi.Input[WorkerPoolTemplateVolumeSecretArgs]]): # -> None:
        ...
...
class WorkerPoolTemplateVolumeSecretArgs:
    def __init__(__self__, *, secret: pulumi.Input[_builtins.str], default_mode: Optional[pulumi.Input[_builtins.int]] = ..., items: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateVolumeSecretItemArgs]]]] = ...) -> None:
    ...
    @items.setter
    def items(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateVolumeSecretItemArgs]]]]): # -> None:
        ...
...
class WorkerPoolTemplateVpcAccessArgs:
    def __init__(__self__, *, connector: Optional[pulumi.Input[_builtins.str]] = ..., egress: Optional[pulumi.Input[_builtins.str]] = ..., network_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateVpcAccessNetworkInterfaceArgs]]]] = ...) -> None:
    ...
    @network_interfaces.setter
    def network_interfaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkerPoolTemplateVpcAccessNetworkInterfaceArgs]]]]): # -> None:
        ...
