...
class DataPolicyIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[DataPolicyIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[DataPolicyIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class DataPolicyIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.DataPolicyIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="dataPolicyId")
