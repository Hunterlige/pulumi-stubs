...
class DataPolicyIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[DataPolicyIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[DataPolicyIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[DataPolicyIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class DataPolicyIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.DataPolicyIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="dataPolicyId")
