...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FloorsettingAiPlatformFloorSetting', 'FloorsettingFilterConfig', 'FloorsettingFilterConfigMaliciousUriFilterSettings', ..., 'FloorsettingFilterConfigRaiSettings', 'FloorsettingFilterConfigRaiSettingsRaiFilter', 'FloorsettingFilterConfigSdpSettings', 'FloorsettingFilterConfigSdpSettingsAdvancedConfig', 'FloorsettingFilterConfigSdpSettingsBasicConfig', 'FloorsettingFloorSettingMetadata', ..., 'FloorsettingGoogleMcpServerFloorSetting', 'TemplateFilterConfig', 'TemplateFilterConfigMaliciousUriFilterSettings', 'TemplateFilterConfigPiAndJailbreakFilterSettings', 'TemplateFilterConfigRaiSettings', 'TemplateFilterConfigRaiSettingsRaiFilter', 'TemplateFilterConfigSdpSettings', 'TemplateFilterConfigSdpSettingsAdvancedConfig', 'TemplateFilterConfigSdpSettingsBasicConfig', 'TemplateTemplateMetadata', 'TemplateTemplateMetadataMultiLanguageDetection']
@pulumi.output_type
class FloorsettingAiPlatformFloorSetting(dict):
    ...
    def __init__(__self__, *, enable_cloud_logging: Optional[_builtins.bool] = ..., inspect_and_block: Optional[_builtins.bool] = ..., inspect_only: Optional[_builtins.bool] = ...) -> None:
...
class FloorsettingFilterConfig(dict):
    ...
    def __init__(__self__, *, malicious_uri_filter_settings: Optional[outputs.FloorsettingFilterConfigMaliciousUriFilterSettings] = ..., pi_and_jailbreak_filter_settings: Optional[outputs.FloorsettingFilterConfigPiAndJailbreakFilterSettings] = ..., rai_settings: Optional[outputs.FloorsettingFilterConfigRaiSettings] = ..., sdp_settings: Optional[outputs.FloorsettingFilterConfigSdpSettings] = ...) -> None:
...
class FloorsettingFilterConfigMaliciousUriFilterSettings(dict):
    ...
    def __init__(__self__, *, filter_enforcement: Optional[_builtins.str] = ...) -> None:
...
class FloorsettingFilterConfigPiAndJailbreakFilterSettings(dict):
    ...
    def __init__(__self__, *, confidence_level: Optional[_builtins.str] = ..., filter_enforcement: Optional[_builtins.str] = ...) -> None:
...
class FloorsettingFilterConfigRaiSettings(dict):
    ...
    def __init__(__self__, *, rai_filters: Sequence[outputs.FloorsettingFilterConfigRaiSettingsRaiFilter]) -> None:
...
class FloorsettingFilterConfigRaiSettingsRaiFilter(dict):
    ...
    def __init__(__self__, *, filter_type: _builtins.str, confidence_level: Optional[_builtins.str] = ...) -> None:
...
class FloorsettingFilterConfigSdpSettings(dict):
    ...
    def __init__(__self__, *, advanced_config: Optional[outputs.FloorsettingFilterConfigSdpSettingsAdvancedConfig] = ..., basic_config: Optional[outputs.FloorsettingFilterConfigSdpSettingsBasicConfig] = ...) -> None:
...
class FloorsettingFilterConfigSdpSettingsAdvancedConfig(dict):
    ...
    def __init__(__self__, *, deidentify_template: Optional[_builtins.str] = ..., inspect_template: Optional[_builtins.str] = ...) -> None:
...
class FloorsettingFloorSettingMetadata(dict):
    ...
    def __init__(__self__, *, multi_language_detection: Optional[outputs.FloorsettingFloorSettingMetadataMultiLanguageDetection] = ...) -> None:
...
class FloorsettingFloorSettingMetadataMultiLanguageDetection(dict):
    ...
    def __init__(__self__, *, enable_multi_language_detection: _builtins.bool) -> None:
...
class TemplateFilterConfig(dict):
    ...
    def __init__(__self__, *, malicious_uri_filter_settings: Optional[outputs.TemplateFilterConfigMaliciousUriFilterSettings] = ..., pi_and_jailbreak_filter_settings: Optional[outputs.TemplateFilterConfigPiAndJailbreakFilterSettings] = ..., rai_settings: Optional[outputs.TemplateFilterConfigRaiSettings] = ..., sdp_settings: Optional[outputs.TemplateFilterConfigSdpSettings] = ...) -> None:
...
class TemplateFilterConfigRaiSettings(dict):
    ...
    def __init__(__self__, *, rai_filters: Sequence[outputs.TemplateFilterConfigRaiSettingsRaiFilter]) -> None:
...
class TemplateFilterConfigSdpSettings(dict):
    ...
    def __init__(__self__, *, advanced_config: Optional[outputs.TemplateFilterConfigSdpSettingsAdvancedConfig] = ..., basic_config: Optional[outputs.TemplateFilterConfigSdpSettingsBasicConfig] = ...) -> None:
...
class TemplateTemplateMetadata(dict):
    ...
    def __init__(__self__, *, custom_llm_response_safety_error_code: Optional[_builtins.int] = ..., custom_llm_response_safety_error_message: Optional[_builtins.str] = ..., custom_prompt_safety_error_code: Optional[_builtins.int] = ..., custom_prompt_safety_error_message: Optional[_builtins.str] = ..., enforcement_type: Optional[_builtins.str] = ..., ignore_partial_invocation_failures: Optional[_builtins.bool] = ..., log_sanitize_operations: Optional[_builtins.bool] = ..., log_template_operations: Optional[_builtins.bool] = ..., multi_language_detection: Optional[outputs.TemplateTemplateMetadataMultiLanguageDetection] = ...) -> None:
