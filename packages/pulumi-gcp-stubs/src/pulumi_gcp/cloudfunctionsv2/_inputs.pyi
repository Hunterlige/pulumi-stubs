...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['FunctionBuildConfigArgs', 'FunctionBuildConfigArgsDict', 'FunctionBuildConfigAutomaticUpdatePolicyArgs', 'FunctionBuildConfigAutomaticUpdatePolicyArgsDict', 'FunctionBuildConfigOnDeployUpdatePolicyArgs', 'FunctionBuildConfigOnDeployUpdatePolicyArgsDict', 'FunctionBuildConfigSourceArgs', 'FunctionBuildConfigSourceArgsDict', 'FunctionBuildConfigSourceRepoSourceArgs', 'FunctionBuildConfigSourceRepoSourceArgsDict', 'FunctionBuildConfigSourceStorageSourceArgs', 'FunctionBuildConfigSourceStorageSourceArgsDict', 'FunctionEventTriggerArgs', 'FunctionEventTriggerArgsDict', 'FunctionEventTriggerEventFilterArgs', 'FunctionEventTriggerEventFilterArgsDict', 'FunctionIamBindingConditionArgs', 'FunctionIamBindingConditionArgsDict', 'FunctionIamMemberConditionArgs', 'FunctionIamMemberConditionArgsDict', 'FunctionServiceConfigArgs', 'FunctionServiceConfigArgsDict', 'FunctionServiceConfigDirectVpcNetworkInterfaceArgs', ..., 'FunctionServiceConfigSecretEnvironmentVariableArgs', ..., 'FunctionServiceConfigSecretVolumeArgs', 'FunctionServiceConfigSecretVolumeArgsDict', 'FunctionServiceConfigSecretVolumeVersionArgs', 'FunctionServiceConfigSecretVolumeVersionArgsDict']
...
class FunctionBuildConfigArgs:
    def __init__(__self__, *, automatic_update_policy: Optional[pulumi.Input[FunctionBuildConfigAutomaticUpdatePolicyArgs]] = ..., build: Optional[pulumi.Input[_builtins.str]] = ..., docker_repository: Optional[pulumi.Input[_builtins.str]] = ..., entry_point: Optional[pulumi.Input[_builtins.str]] = ..., environment_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., on_deploy_update_policy: Optional[pulumi.Input[FunctionBuildConfigOnDeployUpdatePolicyArgs]] = ..., runtime: Optional[pulumi.Input[_builtins.str]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., source: Optional[pulumi.Input[FunctionBuildConfigSourceArgs]] = ..., worker_pool: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def automatic_update_policy(self, value: Optional[pulumi.Input[FunctionBuildConfigAutomaticUpdatePolicyArgs]]): # -> None:
        ...
    ...
    def on_deploy_update_policy(self, value: Optional[pulumi.Input[FunctionBuildConfigOnDeployUpdatePolicyArgs]]): # -> None:
        ...
    ...
    @source.setter
    def source(self, value: Optional[pulumi.Input[FunctionBuildConfigSourceArgs]]): # -> None:
        ...
...
class FunctionBuildConfigOnDeployUpdatePolicyArgs:
    def __init__(__self__, *, runtime_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class FunctionBuildConfigSourceArgs:
    def __init__(__self__, *, repo_source: Optional[pulumi.Input[FunctionBuildConfigSourceRepoSourceArgs]] = ..., storage_source: Optional[pulumi.Input[FunctionBuildConfigSourceStorageSourceArgs]] = ...) -> None:
    ...
    @repo_source.setter
    def repo_source(self, value: Optional[pulumi.Input[FunctionBuildConfigSourceRepoSourceArgs]]): # -> None:
        ...
    ...
    def storage_source(self, value: Optional[pulumi.Input[FunctionBuildConfigSourceStorageSourceArgs]]): # -> None:
        ...
...
class FunctionEventTriggerArgs:
    def __init__(__self__, *, event_type: pulumi.Input[_builtins.str], event_filters: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionEventTriggerEventFilterArgs]]]] = ..., pubsub_topic: Optional[pulumi.Input[_builtins.str]] = ..., retry_policy: Optional[pulumi.Input[_builtins.str]] = ..., service_account_email: Optional[pulumi.Input[_builtins.str]] = ..., trigger: Optional[pulumi.Input[_builtins.str]] = ..., trigger_region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def event_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionEventTriggerEventFilterArgs]]]]): # -> None:
        ...
    ...
    @retry_policy.setter
    def retry_policy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @trigger.setter
    def trigger(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def trigger_region(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class FunctionServiceConfigArgs:
    def __init__(__self__, *, all_traffic_on_latest_revision: Optional[pulumi.Input[_builtins.bool]] = ..., available_cpu: Optional[pulumi.Input[_builtins.str]] = ..., available_memory: Optional[pulumi.Input[_builtins.str]] = ..., binary_authorization_policy: Optional[pulumi.Input[_builtins.str]] = ..., direct_vpc_egress: Optional[pulumi.Input[_builtins.str]] = ..., direct_vpc_network_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionServiceConfigDirectVpcNetworkInterfaceArgs]]]] = ..., environment_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., gcf_uri: Optional[pulumi.Input[_builtins.str]] = ..., ingress_settings: Optional[pulumi.Input[_builtins.str]] = ..., max_instance_count: Optional[pulumi.Input[_builtins.int]] = ..., max_instance_request_concurrency: Optional[pulumi.Input[_builtins.int]] = ..., min_instance_count: Optional[pulumi.Input[_builtins.int]] = ..., secret_environment_variables: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionServiceConfigSecretEnvironmentVariableArgs]]]] = ..., secret_volumes: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionServiceConfigSecretVolumeArgs]]]] = ..., service: Optional[pulumi.Input[_builtins.str]] = ..., service_account_email: Optional[pulumi.Input[_builtins.str]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ..., vpc_connector: Optional[pulumi.Input[_builtins.str]] = ..., vpc_connector_egress_settings: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def all_traffic_on_latest_revision(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def available_cpu(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def available_memory(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def binary_authorization_policy(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def direct_vpc_egress(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def direct_vpc_network_interfaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionServiceConfigDirectVpcNetworkInterfaceArgs]]]]): # -> None:
        ...
    ...
    @gcf_uri.setter
    def gcf_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def secret_environment_variables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionServiceConfigSecretEnvironmentVariableArgs]]]]): # -> None:
        ...
    ...
    def secret_volumes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionServiceConfigSecretVolumeArgs]]]]): # -> None:
        ...
...
class FunctionServiceConfigSecretEnvironmentVariableArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], project_id: pulumi.Input[_builtins.str], secret: pulumi.Input[_builtins.str], version: pulumi.Input[_builtins.str]) -> None:
...
class FunctionServiceConfigSecretVolumeArgs:
    def __init__(__self__, *, mount_path: pulumi.Input[_builtins.str], project_id: pulumi.Input[_builtins.str], secret: pulumi.Input[_builtins.str], versions: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionServiceConfigSecretVolumeVersionArgs]]]] = ...) -> None:
    ...
    @versions.setter
    def versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FunctionServiceConfigSecretVolumeVersionArgs]]]]): # -> None:
        ...
...
class FunctionServiceConfigSecretVolumeVersionArgs:
    def __init__(__self__, *, path: pulumi.Input[_builtins.str], version: pulumi.Input[_builtins.str]) -> None:
