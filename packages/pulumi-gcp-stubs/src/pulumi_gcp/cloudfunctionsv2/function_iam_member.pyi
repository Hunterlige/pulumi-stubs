...
class FunctionIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[FunctionIamMemberConditionArgs]] = ...,
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[FunctionIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class FunctionIamMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    FunctionIamMemberConditionArgs, FunctionIamMemberConditionArgsDict
                ]
            ]
        ] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.FunctionIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
