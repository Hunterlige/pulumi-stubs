...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConfigBlockingFunctions', 'ConfigBlockingFunctionsForwardInboundCredentials', 'ConfigBlockingFunctionsTrigger', 'ConfigClient', 'ConfigClientPermissions', 'ConfigMfa', 'ConfigMfaProviderConfig', 'ConfigMfaProviderConfigTotpProviderConfig', 'ConfigMonitoring', 'ConfigMonitoringRequestLogging', 'ConfigMultiTenant', 'ConfigQuota', 'ConfigQuotaSignUpQuotaConfig', 'ConfigSignIn', 'ConfigSignInAnonymous', 'ConfigSignInEmail', 'ConfigSignInHashConfig', 'ConfigSignInPhoneNumber', 'ConfigSmsRegionConfig', 'ConfigSmsRegionConfigAllowByDefault', 'ConfigSmsRegionConfigAllowlistOnly', 'InboundSamlConfigIdpConfig', 'InboundSamlConfigIdpConfigIdpCertificate', 'InboundSamlConfigSpConfig', 'InboundSamlConfigSpConfigSpCertificate', 'OauthIdpConfigResponseType', 'TenantClient', 'TenantClientPermissions', 'TenantInboundSamlConfigIdpConfig', 'TenantInboundSamlConfigIdpConfigIdpCertificate', 'TenantInboundSamlConfigSpConfig', 'TenantInboundSamlConfigSpConfigSpCertificate']
@pulumi.output_type
class ConfigBlockingFunctions(dict):
    ...
    def __init__(__self__, *, triggers: Sequence[outputs.ConfigBlockingFunctionsTrigger], forward_inbound_credentials: Optional[outputs.ConfigBlockingFunctionsForwardInboundCredentials] = ...) -> None:
...
class ConfigBlockingFunctionsForwardInboundCredentials(dict):
    ...
    def __init__(__self__, *, access_token: Optional[_builtins.bool] = ..., id_token: Optional[_builtins.bool] = ..., refresh_token: Optional[_builtins.bool] = ...) -> None:
...
class ConfigBlockingFunctionsTrigger(dict):
    ...
    def __init__(__self__, *, event_type: _builtins.str, function_uri: _builtins.str, update_time: Optional[_builtins.str] = ...) -> None:
...
class ConfigClient(dict):
    ...
    def __init__(__self__, *, api_key: Optional[_builtins.str] = ..., firebase_subdomain: Optional[_builtins.str] = ..., permissions: Optional[outputs.ConfigClientPermissions] = ...) -> None:
...
class ConfigClientPermissions(dict):
    ...
    def __init__(__self__, *, disabled_user_deletion: Optional[_builtins.bool] = ..., disabled_user_signup: Optional[_builtins.bool] = ...) -> None:
...
class ConfigMfa(dict):
    ...
    def __init__(__self__, *, enabled_providers: Optional[Sequence[_builtins.str]] = ..., provider_configs: Optional[Sequence[outputs.ConfigMfaProviderConfig]] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class ConfigMfaProviderConfig(dict):
    ...
    def __init__(__self__, *, state: Optional[_builtins.str] = ..., totp_provider_config: Optional[outputs.ConfigMfaProviderConfigTotpProviderConfig] = ...) -> None:
...
class ConfigMfaProviderConfigTotpProviderConfig(dict):
    ...
    def __init__(__self__, *, adjacent_intervals: Optional[_builtins.int] = ...) -> None:
...
class ConfigMonitoring(dict):
    ...
    def __init__(__self__, *, request_logging: Optional[outputs.ConfigMonitoringRequestLogging] = ...) -> None:
...
class ConfigMultiTenant(dict):
    ...
    def __init__(__self__, *, allow_tenants: Optional[_builtins.bool] = ..., default_tenant_location: Optional[_builtins.str] = ...) -> None:
...
class ConfigQuota(dict):
    ...
    def __init__(__self__, *, sign_up_quota_config: Optional[outputs.ConfigQuotaSignUpQuotaConfig] = ...) -> None:
...
class ConfigQuotaSignUpQuotaConfig(dict):
    ...
    def __init__(__self__, *, quota: Optional[_builtins.int] = ..., quota_duration: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ...) -> None:
...
class ConfigSignIn(dict):
    ...
    def __init__(__self__, *, allow_duplicate_emails: Optional[_builtins.bool] = ..., anonymous: Optional[outputs.ConfigSignInAnonymous] = ..., email: Optional[outputs.ConfigSignInEmail] = ..., hash_configs: Optional[Sequence[outputs.ConfigSignInHashConfig]] = ..., phone_number: Optional[outputs.ConfigSignInPhoneNumber] = ...) -> None:
...
class ConfigSignInEmail(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, password_required: Optional[_builtins.bool] = ...) -> None:
...
class ConfigSignInHashConfig(dict):
    ...
    def __init__(__self__, *, algorithm: Optional[_builtins.str] = ..., memory_cost: Optional[_builtins.int] = ..., rounds: Optional[_builtins.int] = ..., salt_separator: Optional[_builtins.str] = ..., signer_key: Optional[_builtins.str] = ...) -> None:
...
class ConfigSignInPhoneNumber(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, test_phone_numbers: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ConfigSmsRegionConfig(dict):
    ...
    def __init__(__self__, *, allow_by_default: Optional[outputs.ConfigSmsRegionConfigAllowByDefault] = ..., allowlist_only: Optional[outputs.ConfigSmsRegionConfigAllowlistOnly] = ...) -> None:
...
class ConfigSmsRegionConfigAllowByDefault(dict):
    ...
    def __init__(__self__, *, disallowed_regions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ConfigSmsRegionConfigAllowlistOnly(dict):
    ...
    def __init__(__self__, *, allowed_regions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class InboundSamlConfigIdpConfig(dict):
    ...
    def __init__(__self__, *, idp_certificates: Sequence[outputs.InboundSamlConfigIdpConfigIdpCertificate], idp_entity_id: _builtins.str, sso_url: _builtins.str, sign_request: Optional[_builtins.bool] = ...) -> None:
...
class InboundSamlConfigIdpConfigIdpCertificate(dict):
    ...
    def __init__(__self__, *, x509_certificate: Optional[_builtins.str] = ...) -> None:
...
class InboundSamlConfigSpConfig(dict):
    ...
    def __init__(__self__, *, callback_uri: Optional[_builtins.str] = ..., sp_certificates: Optional[Sequence[outputs.InboundSamlConfigSpConfigSpCertificate]] = ..., sp_entity_id: Optional[_builtins.str] = ...) -> None:
...
class OauthIdpConfigResponseType(dict):
    ...
    def __init__(__self__, *, code: Optional[_builtins.bool] = ..., id_token: Optional[_builtins.bool] = ...) -> None:
...
class TenantClient(dict):
    def __init__(__self__, *, permissions: Optional[outputs.TenantClientPermissions] = ...) -> None:
...
class TenantInboundSamlConfigIdpConfig(dict):
    ...
    def __init__(__self__, *, idp_certificates: Sequence[outputs.TenantInboundSamlConfigIdpConfigIdpCertificate], idp_entity_id: _builtins.str, sso_url: _builtins.str, sign_request: Optional[_builtins.bool] = ...) -> None:
...
class TenantInboundSamlConfigSpConfig(dict):
    ...
    def __init__(__self__, *, callback_uri: _builtins.str, sp_entity_id: _builtins.str, sp_certificates: Optional[Sequence[outputs.TenantInboundSamlConfigSpConfigSpCertificate]] = ...) -> None:
