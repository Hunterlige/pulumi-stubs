...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ConfigBlockingFunctionsArgs', 'ConfigBlockingFunctionsArgsDict', ..., ..., 'ConfigBlockingFunctionsTriggerArgs', 'ConfigBlockingFunctionsTriggerArgsDict', 'ConfigClientArgs', 'ConfigClientArgsDict', 'ConfigClientPermissionsArgs', 'ConfigClientPermissionsArgsDict', 'ConfigMfaArgs', 'ConfigMfaArgsDict', 'ConfigMfaProviderConfigArgs', 'ConfigMfaProviderConfigArgsDict', 'ConfigMfaProviderConfigTotpProviderConfigArgs', 'ConfigMfaProviderConfigTotpProviderConfigArgsDict', 'ConfigMonitoringArgs', 'ConfigMonitoringArgsDict', 'ConfigMonitoringRequestLoggingArgs', 'ConfigMonitoringRequestLoggingArgsDict', 'ConfigMultiTenantArgs', 'ConfigMultiTenantArgsDict', 'ConfigQuotaArgs', 'ConfigQuotaArgsDict', 'ConfigQuotaSignUpQuotaConfigArgs', 'ConfigQuotaSignUpQuotaConfigArgsDict', 'ConfigSignInArgs', 'ConfigSignInArgsDict', 'ConfigSignInAnonymousArgs', 'ConfigSignInAnonymousArgsDict', 'ConfigSignInEmailArgs', 'ConfigSignInEmailArgsDict', 'ConfigSignInHashConfigArgs', 'ConfigSignInHashConfigArgsDict', 'ConfigSignInPhoneNumberArgs', 'ConfigSignInPhoneNumberArgsDict', 'ConfigSmsRegionConfigArgs', 'ConfigSmsRegionConfigArgsDict', 'ConfigSmsRegionConfigAllowByDefaultArgs', 'ConfigSmsRegionConfigAllowByDefaultArgsDict', 'ConfigSmsRegionConfigAllowlistOnlyArgs', 'ConfigSmsRegionConfigAllowlistOnlyArgsDict', 'InboundSamlConfigIdpConfigArgs', 'InboundSamlConfigIdpConfigArgsDict', 'InboundSamlConfigIdpConfigIdpCertificateArgs', 'InboundSamlConfigIdpConfigIdpCertificateArgsDict', 'InboundSamlConfigSpConfigArgs', 'InboundSamlConfigSpConfigArgsDict', 'InboundSamlConfigSpConfigSpCertificateArgs', 'InboundSamlConfigSpConfigSpCertificateArgsDict', 'OauthIdpConfigResponseTypeArgs', 'OauthIdpConfigResponseTypeArgsDict', 'TenantClientArgs', 'TenantClientArgsDict', 'TenantClientPermissionsArgs', 'TenantClientPermissionsArgsDict', 'TenantInboundSamlConfigIdpConfigArgs', 'TenantInboundSamlConfigIdpConfigArgsDict', 'TenantInboundSamlConfigIdpConfigIdpCertificateArgs', ..., 'TenantInboundSamlConfigSpConfigArgs', 'TenantInboundSamlConfigSpConfigArgsDict', 'TenantInboundSamlConfigSpConfigSpCertificateArgs', ...]
...
class ConfigBlockingFunctionsArgs:
    def __init__(__self__, *, triggers: pulumi.Input[Sequence[pulumi.Input[ConfigBlockingFunctionsTriggerArgs]]], forward_inbound_credentials: Optional[pulumi.Input[ConfigBlockingFunctionsForwardInboundCredentialsArgs]] = ...) -> None:
    ...
    @triggers.setter
    def triggers(self, value: pulumi.Input[Sequence[pulumi.Input[ConfigBlockingFunctionsTriggerArgs]]]): # -> None:
        ...
    ...
    def forward_inbound_credentials(self, value: Optional[pulumi.Input[ConfigBlockingFunctionsForwardInboundCredentialsArgs]]): # -> None:
        ...
...
class ConfigBlockingFunctionsForwardInboundCredentialsArgs:
    def __init__(__self__, *, access_token: Optional[pulumi.Input[_builtins.bool]] = ..., id_token: Optional[pulumi.Input[_builtins.bool]] = ..., refresh_token: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @access_token.setter
    def access_token(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @id_token.setter
    def id_token(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def refresh_token(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ConfigBlockingFunctionsTriggerArgs:
    def __init__(__self__, *, event_type: pulumi.Input[_builtins.str], function_uri: pulumi.Input[_builtins.str], update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @function_uri.setter
    def function_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ConfigClientArgs:
    def __init__(__self__, *, api_key: Optional[pulumi.Input[_builtins.str]] = ..., firebase_subdomain: Optional[pulumi.Input[_builtins.str]] = ..., permissions: Optional[pulumi.Input[ConfigClientPermissionsArgs]] = ...) -> None:
    ...
    def firebase_subdomain(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @permissions.setter
    def permissions(self, value: Optional[pulumi.Input[ConfigClientPermissionsArgs]]): # -> None:
        ...
...
class ConfigClientPermissionsArgs:
    def __init__(__self__, *, disabled_user_deletion: Optional[pulumi.Input[_builtins.bool]] = ..., disabled_user_signup: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def disabled_user_deletion(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def disabled_user_signup(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
@pulumi.input_type
class ConfigMfaArgs:
    def __init__(__self__, *, enabled_providers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., provider_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ConfigMfaProviderConfigArgs]]]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def enabled_providers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def provider_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ConfigMfaProviderConfigArgs]]]]): # -> None:
        ...
...
class ConfigMfaProviderConfigArgs:
    def __init__(__self__, *, state: Optional[pulumi.Input[_builtins.str]] = ..., totp_provider_config: Optional[pulumi.Input[ConfigMfaProviderConfigTotpProviderConfigArgs]] = ...) -> None:
    ...
    def totp_provider_config(self, value: Optional[pulumi.Input[ConfigMfaProviderConfigTotpProviderConfigArgs]]): # -> None:
        ...
...
class ConfigMfaProviderConfigTotpProviderConfigArgs:
    def __init__(__self__, *, adjacent_intervals: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def adjacent_intervals(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ConfigMonitoringArgs:
    def __init__(__self__, *, request_logging: Optional[pulumi.Input[ConfigMonitoringRequestLoggingArgs]] = ...) -> None:
    ...
    def request_logging(self, value: Optional[pulumi.Input[ConfigMonitoringRequestLoggingArgs]]): # -> None:
        ...
...
class ConfigMultiTenantArgs:
    def __init__(__self__, *, allow_tenants: Optional[pulumi.Input[_builtins.bool]] = ..., default_tenant_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allow_tenants(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def default_tenant_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConfigQuotaArgs:
    def __init__(__self__, *, sign_up_quota_config: Optional[pulumi.Input[ConfigQuotaSignUpQuotaConfigArgs]] = ...) -> None:
    ...
    def sign_up_quota_config(self, value: Optional[pulumi.Input[ConfigQuotaSignUpQuotaConfigArgs]]): # -> None:
        ...
...
class ConfigQuotaSignUpQuotaConfigArgs:
    def __init__(__self__, *, quota: Optional[pulumi.Input[_builtins.int]] = ..., quota_duration: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @quota.setter
    def quota(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def quota_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConfigSignInArgs:
    def __init__(__self__, *, allow_duplicate_emails: Optional[pulumi.Input[_builtins.bool]] = ..., anonymous: Optional[pulumi.Input[ConfigSignInAnonymousArgs]] = ..., email: Optional[pulumi.Input[ConfigSignInEmailArgs]] = ..., hash_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ConfigSignInHashConfigArgs]]]] = ..., phone_number: Optional[pulumi.Input[ConfigSignInPhoneNumberArgs]] = ...) -> None:
    ...
    def allow_duplicate_emails(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @anonymous.setter
    def anonymous(self, value: Optional[pulumi.Input[ConfigSignInAnonymousArgs]]): # -> None:
        ...
    ...
    @email.setter
    def email(self, value: Optional[pulumi.Input[ConfigSignInEmailArgs]]): # -> None:
        ...
    ...
    @hash_configs.setter
    def hash_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ConfigSignInHashConfigArgs]]]]): # -> None:
        ...
    ...
    @phone_number.setter
    def phone_number(self, value: Optional[pulumi.Input[ConfigSignInPhoneNumberArgs]]): # -> None:
        ...
...
class ConfigSignInEmailArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], password_required: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def password_required(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ConfigSignInHashConfigArgs:
    def __init__(__self__, *, algorithm: Optional[pulumi.Input[_builtins.str]] = ..., memory_cost: Optional[pulumi.Input[_builtins.int]] = ..., rounds: Optional[pulumi.Input[_builtins.int]] = ..., salt_separator: Optional[pulumi.Input[_builtins.str]] = ..., signer_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @memory_cost.setter
    def memory_cost(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @rounds.setter
    def rounds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def salt_separator(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @signer_key.setter
    def signer_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConfigSignInPhoneNumberArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], test_phone_numbers: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def test_phone_numbers(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ConfigSmsRegionConfigArgs:
    def __init__(__self__, *, allow_by_default: Optional[pulumi.Input[ConfigSmsRegionConfigAllowByDefaultArgs]] = ..., allowlist_only: Optional[pulumi.Input[ConfigSmsRegionConfigAllowlistOnlyArgs]] = ...) -> None:
    ...
    def allow_by_default(self, value: Optional[pulumi.Input[ConfigSmsRegionConfigAllowByDefaultArgs]]): # -> None:
        ...
    ...
    def allowlist_only(self, value: Optional[pulumi.Input[ConfigSmsRegionConfigAllowlistOnlyArgs]]): # -> None:
        ...
...
class ConfigSmsRegionConfigAllowByDefaultArgs:
    def __init__(__self__, *, disallowed_regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def disallowed_regions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ConfigSmsRegionConfigAllowlistOnlyArgs:
    def __init__(__self__, *, allowed_regions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class InboundSamlConfigIdpConfigArgs:
    def __init__(__self__, *, idp_certificates: pulumi.Input[Sequence[pulumi.Input[InboundSamlConfigIdpConfigIdpCertificateArgs]]], idp_entity_id: pulumi.Input[_builtins.str], sso_url: pulumi.Input[_builtins.str], sign_request: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def idp_certificates(self, value: pulumi.Input[Sequence[pulumi.Input[InboundSamlConfigIdpConfigIdpCertificateArgs]]]): # -> None:
        ...
    ...
    def idp_entity_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @sso_url.setter
    def sso_url(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @sign_request.setter
    def sign_request(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class InboundSamlConfigIdpConfigIdpCertificateArgs:
    def __init__(__self__, *, x509_certificate: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def x509_certificate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InboundSamlConfigSpConfigArgs:
    def __init__(__self__, *, callback_uri: Optional[pulumi.Input[_builtins.str]] = ..., sp_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[InboundSamlConfigSpConfigSpCertificateArgs]]]] = ..., sp_entity_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @callback_uri.setter
    def callback_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def sp_certificates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InboundSamlConfigSpConfigSpCertificateArgs]]]]): # -> None:
        ...
    ...
    @sp_entity_id.setter
    def sp_entity_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class OauthIdpConfigResponseTypeArgs:
    def __init__(__self__, *, code: Optional[pulumi.Input[_builtins.bool]] = ..., id_token: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @code.setter
    def code(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class TenantClientArgs:
    def __init__(__self__, *, permissions: Optional[pulumi.Input[TenantClientPermissionsArgs]] = ...) -> None:
    ...
    @permissions.setter
    def permissions(self, value: Optional[pulumi.Input[TenantClientPermissionsArgs]]): # -> None:
        ...
...
class TenantInboundSamlConfigIdpConfigArgs:
    def __init__(__self__, *, idp_certificates: pulumi.Input[Sequence[pulumi.Input[TenantInboundSamlConfigIdpConfigIdpCertificateArgs]]], idp_entity_id: pulumi.Input[_builtins.str], sso_url: pulumi.Input[_builtins.str], sign_request: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @idp_certificates.setter
    def idp_certificates(self, value: pulumi.Input[Sequence[pulumi.Input[TenantInboundSamlConfigIdpConfigIdpCertificateArgs]]]): # -> None:
        ...
...
class TenantInboundSamlConfigSpConfigArgs:
    def __init__(__self__, *, callback_uri: pulumi.Input[_builtins.str], sp_entity_id: pulumi.Input[_builtins.str], sp_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[TenantInboundSamlConfigSpConfigSpCertificateArgs]]]] = ...) -> None:
    ...
    @callback_uri.setter
    def callback_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @sp_entity_id.setter
    def sp_entity_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @sp_certificates.setter
    def sp_certificates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TenantInboundSamlConfigSpConfigSpCertificateArgs]]]]): # -> None:
        ...
