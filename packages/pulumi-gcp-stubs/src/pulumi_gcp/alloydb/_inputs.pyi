...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BackupEncryptionConfigArgs', 'BackupEncryptionConfigArgsDict', 'BackupEncryptionInfoArgs', 'BackupEncryptionInfoArgsDict', 'BackupExpiryQuantityArgs', 'BackupExpiryQuantityArgsDict', 'ClusterAutomatedBackupPolicyArgs', 'ClusterAutomatedBackupPolicyArgsDict', 'ClusterAutomatedBackupPolicyEncryptionConfigArgs', ..., ..., ..., 'ClusterAutomatedBackupPolicyTimeBasedRetentionArgs', ..., 'ClusterAutomatedBackupPolicyWeeklyScheduleArgs', 'ClusterAutomatedBackupPolicyWeeklyScheduleArgsDict', ..., ..., 'ClusterBackupSourceArgs', 'ClusterBackupSourceArgsDict', 'ClusterBackupdrBackupSourceArgs', 'ClusterBackupdrBackupSourceArgsDict', 'ClusterContinuousBackupConfigArgs', 'ClusterContinuousBackupConfigArgsDict', 'ClusterContinuousBackupConfigEncryptionConfigArgs', ..., 'ClusterContinuousBackupInfoArgs', 'ClusterContinuousBackupInfoArgsDict', 'ClusterContinuousBackupInfoEncryptionInfoArgs', 'ClusterContinuousBackupInfoEncryptionInfoArgsDict', 'ClusterDataplexConfigArgs', 'ClusterDataplexConfigArgsDict', 'ClusterEncryptionConfigArgs', 'ClusterEncryptionConfigArgsDict', 'ClusterEncryptionInfoArgs', 'ClusterEncryptionInfoArgsDict', 'ClusterInitialUserArgs', 'ClusterInitialUserArgsDict', 'ClusterMaintenanceUpdatePolicyArgs', 'ClusterMaintenanceUpdatePolicyArgsDict', ..., ..., ..., ..., 'ClusterMigrationSourceArgs', 'ClusterMigrationSourceArgsDict', 'ClusterNetworkConfigArgs', 'ClusterNetworkConfigArgsDict', 'ClusterPscConfigArgs', 'ClusterPscConfigArgsDict', 'ClusterRestoreBackupSourceArgs', 'ClusterRestoreBackupSourceArgsDict', 'ClusterRestoreBackupdrBackupSourceArgs', 'ClusterRestoreBackupdrBackupSourceArgsDict', 'ClusterRestoreBackupdrPitrSourceArgs', 'ClusterRestoreBackupdrPitrSourceArgsDict', 'ClusterRestoreContinuousBackupSourceArgs', 'ClusterRestoreContinuousBackupSourceArgsDict', 'ClusterSecondaryConfigArgs', 'ClusterSecondaryConfigArgsDict', 'ClusterTrialMetadataArgs', 'ClusterTrialMetadataArgsDict', 'InstanceClientConnectionConfigArgs', 'InstanceClientConnectionConfigArgsDict', 'InstanceClientConnectionConfigSslConfigArgs', 'InstanceClientConnectionConfigSslConfigArgsDict', 'InstanceConnectionPoolConfigArgs', 'InstanceConnectionPoolConfigArgsDict', 'InstanceMachineConfigArgs', 'InstanceMachineConfigArgsDict', 'InstanceNetworkConfigArgs', 'InstanceNetworkConfigArgsDict', 'InstanceNetworkConfigAuthorizedExternalNetworkArgs', ..., 'InstanceObservabilityConfigArgs', 'InstanceObservabilityConfigArgsDict', 'InstancePscInstanceConfigArgs', 'InstancePscInstanceConfigArgsDict', 'InstancePscInstanceConfigPscAutoConnectionArgs', 'InstancePscInstanceConfigPscAutoConnectionArgsDict', 'InstancePscInstanceConfigPscInterfaceConfigArgs', ..., 'InstanceQueryInsightsConfigArgs', 'InstanceQueryInsightsConfigArgsDict', 'InstanceReadPoolConfigArgs', 'InstanceReadPoolConfigArgsDict']
...
class BackupEncryptionInfoArgs:
    def __init__(__self__, *, encryption_type: Optional[pulumi.Input[_builtins.str]] = ..., kms_key_versions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def kms_key_versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class BackupExpiryQuantityArgs:
    def __init__(__self__, *, retention_count: Optional[pulumi.Input[_builtins.int]] = ..., total_retention_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def retention_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def total_retention_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ClusterAutomatedBackupPolicyArgs:
    def __init__(__self__, *, backup_window: Optional[pulumi.Input[_builtins.str]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., encryption_config: Optional[pulumi.Input[ClusterAutomatedBackupPolicyEncryptionConfigArgs]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., quantity_based_retention: Optional[pulumi.Input[ClusterAutomatedBackupPolicyQuantityBasedRetentionArgs]] = ..., time_based_retention: Optional[pulumi.Input[ClusterAutomatedBackupPolicyTimeBasedRetentionArgs]] = ..., weekly_schedule: Optional[pulumi.Input[ClusterAutomatedBackupPolicyWeeklyScheduleArgs]] = ...) -> None:
    ...
    def encryption_config(self, value: Optional[pulumi.Input[ClusterAutomatedBackupPolicyEncryptionConfigArgs]]): # -> None:
        ...
    ...
    def quantity_based_retention(self, value: Optional[pulumi.Input[ClusterAutomatedBackupPolicyQuantityBasedRetentionArgs]]): # -> None:
        ...
    ...
    def time_based_retention(self, value: Optional[pulumi.Input[ClusterAutomatedBackupPolicyTimeBasedRetentionArgs]]): # -> None:
        ...
    ...
    def weekly_schedule(self, value: Optional[pulumi.Input[ClusterAutomatedBackupPolicyWeeklyScheduleArgs]]): # -> None:
        ...
...
class ClusterAutomatedBackupPolicyTimeBasedRetentionArgs:
    def __init__(__self__, *, retention_period: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def retention_period(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterAutomatedBackupPolicyWeeklyScheduleArgs:
    def __init__(__self__, *, start_times: pulumi.Input[Sequence[pulumi.Input[ClusterAutomatedBackupPolicyWeeklyScheduleStartTimeArgs]]], days_of_weeks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @start_times.setter
    def start_times(self, value: pulumi.Input[Sequence[pulumi.Input[ClusterAutomatedBackupPolicyWeeklyScheduleStartTimeArgs]]]): # -> None:
        ...
...
class ClusterBackupSourceArgs:
    def __init__(__self__, *, backup_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterBackupdrBackupSourceArgs:
    def __init__(__self__, *, backup: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterContinuousBackupConfigArgs:
    def __init__(__self__, *, enabled: Optional[pulumi.Input[_builtins.bool]] = ..., encryption_config: Optional[pulumi.Input[ClusterContinuousBackupConfigEncryptionConfigArgs]] = ..., recovery_window_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @encryption_config.setter
    def encryption_config(self, value: Optional[pulumi.Input[ClusterContinuousBackupConfigEncryptionConfigArgs]]): # -> None:
        ...
    ...
    def recovery_window_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ClusterContinuousBackupInfoArgs:
    def __init__(__self__, *, earliest_restorable_time: Optional[pulumi.Input[_builtins.str]] = ..., enabled_time: Optional[pulumi.Input[_builtins.str]] = ..., encryption_infos: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterContinuousBackupInfoEncryptionInfoArgs]]]] = ..., schedules: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def earliest_restorable_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @enabled_time.setter
    def enabled_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def encryption_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterContinuousBackupInfoEncryptionInfoArgs]]]]): # -> None:
        ...
    ...
    @schedules.setter
    def schedules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ClusterInitialUserArgs:
    def __init__(__self__, *, password: Optional[pulumi.Input[_builtins.str]] = ..., password_wo: Optional[pulumi.Input[_builtins.str]] = ..., password_wo_version: Optional[pulumi.Input[_builtins.str]] = ..., user: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterMaintenanceUpdatePolicyArgs:
    def __init__(__self__, *, maintenance_windows: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterMaintenanceUpdatePolicyMaintenanceWindowArgs]]]] = ...) -> None:
    ...
    def maintenance_windows(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterMaintenanceUpdatePolicyMaintenanceWindowArgs]]]]): # -> None:
        ...
...
class ClusterMaintenanceUpdatePolicyMaintenanceWindowArgs:
    def __init__(__self__, *, day: pulumi.Input[_builtins.str], start_time: pulumi.Input[ClusterMaintenanceUpdatePolicyMaintenanceWindowStartTimeArgs]) -> None:
    ...
    @start_time.setter
    def start_time(self, value: pulumi.Input[ClusterMaintenanceUpdatePolicyMaintenanceWindowStartTimeArgs]): # -> None:
        ...
...
class ClusterMaintenanceUpdatePolicyMaintenanceWindowStartTimeArgs:
    def __init__(__self__, *, hours: pulumi.Input[_builtins.int], minutes: Optional[pulumi.Input[_builtins.int]] = ..., nanos: Optional[pulumi.Input[_builtins.int]] = ..., seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ClusterMigrationSourceArgs:
    def __init__(__self__, *, host_port: Optional[pulumi.Input[_builtins.str]] = ..., reference_id: Optional[pulumi.Input[_builtins.str]] = ..., source_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @host_port.setter
    def host_port(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterNetworkConfigArgs:
    def __init__(__self__, *, allocated_ip_range: Optional[pulumi.Input[_builtins.str]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterPscConfigArgs:
    def __init__(__self__, *, psc_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., service_owned_project_number: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def service_owned_project_number(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ClusterRestoreBackupdrPitrSourceArgs:
    def __init__(__self__, *, data_source: pulumi.Input[_builtins.str], point_in_time: pulumi.Input[_builtins.str]) -> None:
    ...
    def point_in_time(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterRestoreContinuousBackupSourceArgs:
    def __init__(__self__, *, cluster: pulumi.Input[_builtins.str], point_in_time: pulumi.Input[_builtins.str]) -> None:
...
class ClusterSecondaryConfigArgs:
    def __init__(__self__, *, primary_cluster_name: pulumi.Input[_builtins.str]) -> None:
    ...
    def primary_cluster_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterTrialMetadataArgs:
    def __init__(__self__, *, end_time: Optional[pulumi.Input[_builtins.str]] = ..., grace_end_time: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ..., upgrade_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def grace_end_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @upgrade_time.setter
    def upgrade_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstanceClientConnectionConfigArgs:
    def __init__(__self__, *, require_connectors: Optional[pulumi.Input[_builtins.bool]] = ..., ssl_config: Optional[pulumi.Input[InstanceClientConnectionConfigSslConfigArgs]] = ...) -> None:
    ...
    def require_connectors(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @ssl_config.setter
    def ssl_config(self, value: Optional[pulumi.Input[InstanceClientConnectionConfigSslConfigArgs]]): # -> None:
        ...
...
class InstanceClientConnectionConfigSslConfigArgs:
    def __init__(__self__, *, ssl_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceConnectionPoolConfigArgs:
    def __init__(__self__, *, enabled: pulumi.Input[_builtins.bool], flags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., pooler_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @flags.setter
    def flags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @pooler_count.setter
    def pooler_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class InstanceMachineConfigArgs:
    def __init__(__self__, *, cpu_count: Optional[pulumi.Input[_builtins.int]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceNetworkConfigArgs:
    def __init__(__self__, *, allocated_ip_range_override: Optional[pulumi.Input[_builtins.str]] = ..., authorized_external_networks: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceNetworkConfigAuthorizedExternalNetworkArgs]]]] = ..., enable_outbound_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., enable_public_ip: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def allocated_ip_range_override(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def authorized_external_networks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceNetworkConfigAuthorizedExternalNetworkArgs]]]]): # -> None:
        ...
    ...
    def enable_outbound_public_ip(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_public_ip(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class InstanceNetworkConfigAuthorizedExternalNetworkArgs:
    def __init__(__self__, *, cidr_range: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceObservabilityConfigArgs:
    def __init__(__self__, *, assistive_experiences_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., max_query_string_length: Optional[pulumi.Input[_builtins.int]] = ..., preserve_comments: Optional[pulumi.Input[_builtins.bool]] = ..., query_plans_per_minute: Optional[pulumi.Input[_builtins.int]] = ..., record_application_tags: Optional[pulumi.Input[_builtins.bool]] = ..., track_active_queries: Optional[pulumi.Input[_builtins.bool]] = ..., track_wait_event_types: Optional[pulumi.Input[_builtins.bool]] = ..., track_wait_events: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def assistive_experiences_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def max_query_string_length(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def preserve_comments(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def track_active_queries(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def track_wait_event_types(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def track_wait_events(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class InstancePscInstanceConfigArgs:
    def __init__(__self__, *, allowed_consumer_projects: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., psc_auto_connections: Optional[pulumi.Input[Sequence[pulumi.Input[InstancePscInstanceConfigPscAutoConnectionArgs]]]] = ..., psc_dns_name: Optional[pulumi.Input[_builtins.str]] = ..., psc_interface_configs: Optional[pulumi.Input[Sequence[pulumi.Input[InstancePscInstanceConfigPscInterfaceConfigArgs]]]] = ..., service_attachment_link: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def psc_auto_connections(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstancePscInstanceConfigPscAutoConnectionArgs]]]]): # -> None:
        ...
    ...
    @psc_dns_name.setter
    def psc_dns_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def psc_interface_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstancePscInstanceConfigPscInterfaceConfigArgs]]]]): # -> None:
        ...
    ...
    def service_attachment_link(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstancePscInstanceConfigPscAutoConnectionArgs:
    def __init__(__self__, *, consumer_network: Optional[pulumi.Input[_builtins.str]] = ..., consumer_network_status: Optional[pulumi.Input[_builtins.str]] = ..., consumer_project: Optional[pulumi.Input[_builtins.str]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def consumer_network(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstancePscInstanceConfigPscInterfaceConfigArgs:
    def __init__(__self__, *, network_attachment_resource: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def network_attachment_resource(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstanceQueryInsightsConfigArgs:
    def __init__(__self__, *, query_plans_per_minute: Optional[pulumi.Input[_builtins.int]] = ..., query_string_length: Optional[pulumi.Input[_builtins.int]] = ..., record_application_tags: Optional[pulumi.Input[_builtins.bool]] = ..., record_client_address: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class InstanceReadPoolConfigArgs:
    def __init__(__self__, *, node_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
