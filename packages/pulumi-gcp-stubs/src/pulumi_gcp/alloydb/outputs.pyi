...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BackupEncryptionConfig', 'BackupEncryptionInfo', 'BackupExpiryQuantity', 'ClusterAutomatedBackupPolicy', 'ClusterAutomatedBackupPolicyEncryptionConfig', 'ClusterAutomatedBackupPolicyQuantityBasedRetention', 'ClusterAutomatedBackupPolicyTimeBasedRetention', 'ClusterAutomatedBackupPolicyWeeklySchedule', ..., 'ClusterBackupSource', 'ClusterBackupdrBackupSource', 'ClusterContinuousBackupConfig', 'ClusterContinuousBackupConfigEncryptionConfig', 'ClusterContinuousBackupInfo', 'ClusterContinuousBackupInfoEncryptionInfo', 'ClusterDataplexConfig', 'ClusterEncryptionConfig', 'ClusterEncryptionInfo', 'ClusterInitialUser', 'ClusterMaintenanceUpdatePolicy', 'ClusterMaintenanceUpdatePolicyMaintenanceWindow', ..., 'ClusterMigrationSource', 'ClusterNetworkConfig', 'ClusterPscConfig', 'ClusterRestoreBackupSource', 'ClusterRestoreBackupdrBackupSource', 'ClusterRestoreBackupdrPitrSource', 'ClusterRestoreContinuousBackupSource', 'ClusterSecondaryConfig', 'ClusterTrialMetadata', 'InstanceClientConnectionConfig', 'InstanceClientConnectionConfigSslConfig', 'InstanceConnectionPoolConfig', 'InstanceMachineConfig', 'InstanceNetworkConfig', 'InstanceNetworkConfigAuthorizedExternalNetwork', 'InstanceObservabilityConfig', 'InstancePscInstanceConfig', 'InstancePscInstanceConfigPscAutoConnection', 'InstancePscInstanceConfigPscInterfaceConfig', 'InstanceQueryInsightsConfig', 'InstanceReadPoolConfig', 'GetClusterAutomatedBackupPolicyResult', ..., ..., ..., ..., ..., 'GetClusterBackupSourceResult', 'GetClusterBackupdrBackupSourceResult', 'GetClusterContinuousBackupConfigResult', ..., 'GetClusterContinuousBackupInfoResult', 'GetClusterContinuousBackupInfoEncryptionInfoResult', 'GetClusterDataplexConfigResult', 'GetClusterEncryptionConfigResult', 'GetClusterEncryptionInfoResult', 'GetClusterInitialUserResult', 'GetClusterMaintenanceUpdatePolicyResult', ..., ..., 'GetClusterMigrationSourceResult', 'GetClusterNetworkConfigResult', 'GetClusterPscConfigResult', 'GetClusterRestoreBackupSourceResult', 'GetClusterRestoreBackupdrBackupSourceResult', 'GetClusterRestoreBackupdrPitrSourceResult', 'GetClusterRestoreContinuousBackupSourceResult', 'GetClusterSecondaryConfigResult', 'GetClusterTrialMetadataResult', 'GetInstanceClientConnectionConfigResult', 'GetInstanceClientConnectionConfigSslConfigResult', 'GetInstanceConnectionPoolConfigResult', 'GetInstanceMachineConfigResult', 'GetInstanceNetworkConfigResult', ..., 'GetInstanceObservabilityConfigResult', 'GetInstancePscInstanceConfigResult', ..., ..., 'GetInstanceQueryInsightsConfigResult', 'GetInstanceReadPoolConfigResult', 'GetLocationsLocationResult', ..., ..., ...]
@pulumi.output_type
...
class BackupEncryptionInfo(dict):
    ...
    def __init__(__self__, *, encryption_type: Optional[_builtins.str] = ..., kms_key_versions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class BackupExpiryQuantity(dict):
    ...
    def __init__(__self__, *, retention_count: Optional[_builtins.int] = ..., total_retention_count: Optional[_builtins.int] = ...) -> None:
...
class ClusterAutomatedBackupPolicy(dict):
    ...
    def __init__(__self__, *, backup_window: Optional[_builtins.str] = ..., enabled: Optional[_builtins.bool] = ..., encryption_config: Optional[outputs.ClusterAutomatedBackupPolicyEncryptionConfig] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., location: Optional[_builtins.str] = ..., quantity_based_retention: Optional[outputs.ClusterAutomatedBackupPolicyQuantityBasedRetention] = ..., time_based_retention: Optional[outputs.ClusterAutomatedBackupPolicyTimeBasedRetention] = ..., weekly_schedule: Optional[outputs.ClusterAutomatedBackupPolicyWeeklySchedule] = ...) -> None:
...
class ClusterAutomatedBackupPolicyTimeBasedRetention(dict):
    ...
    def __init__(__self__, *, retention_period: Optional[_builtins.str] = ...) -> None:
...
class ClusterAutomatedBackupPolicyWeeklySchedule(dict):
    ...
    def __init__(__self__, *, start_times: Sequence[outputs.ClusterAutomatedBackupPolicyWeeklyScheduleStartTime], days_of_weeks: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ClusterContinuousBackupConfig(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., encryption_config: Optional[outputs.ClusterContinuousBackupConfigEncryptionConfig] = ..., recovery_window_days: Optional[_builtins.int] = ...) -> None:
...
class ClusterContinuousBackupInfo(dict):
    ...
    def __init__(__self__, *, earliest_restorable_time: Optional[_builtins.str] = ..., enabled_time: Optional[_builtins.str] = ..., encryption_infos: Optional[Sequence[outputs.ClusterContinuousBackupInfoEncryptionInfo]] = ..., schedules: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ClusterInitialUser(dict):
    ...
    def __init__(__self__, *, password: Optional[_builtins.str] = ..., password_wo: Optional[_builtins.str] = ..., password_wo_version: Optional[_builtins.str] = ..., user: Optional[_builtins.str] = ...) -> None:
...
class ClusterMaintenanceUpdatePolicy(dict):
    ...
    def __init__(__self__, *, maintenance_windows: Optional[Sequence[outputs.ClusterMaintenanceUpdatePolicyMaintenanceWindow]] = ...) -> None:
...
class ClusterMaintenanceUpdatePolicyMaintenanceWindow(dict):
    ...
    def __init__(__self__, *, day: _builtins.str, start_time: outputs.ClusterMaintenanceUpdatePolicyMaintenanceWindowStartTime) -> None:
...
class ClusterMaintenanceUpdatePolicyMaintenanceWindowStartTime(dict):
    def __init__(__self__, *, hours: _builtins.int, minutes: Optional[_builtins.int] = ..., nanos: Optional[_builtins.int] = ..., seconds: Optional[_builtins.int] = ...) -> None:
...
class ClusterMigrationSource(dict):
    ...
    def __init__(__self__, *, host_port: Optional[_builtins.str] = ..., reference_id: Optional[_builtins.str] = ..., source_type: Optional[_builtins.str] = ...) -> None:
...
class ClusterNetworkConfig(dict):
    ...
    def __init__(__self__, *, allocated_ip_range: Optional[_builtins.str] = ..., network: Optional[_builtins.str] = ...) -> None:
...
class ClusterPscConfig(dict):
    ...
    def __init__(__self__, *, psc_enabled: Optional[_builtins.bool] = ..., service_owned_project_number: Optional[_builtins.int] = ...) -> None:
...
class ClusterRestoreBackupdrPitrSource(dict):
    ...
    def __init__(__self__, *, data_source: _builtins.str, point_in_time: _builtins.str) -> None:
...
class ClusterRestoreContinuousBackupSource(dict):
    ...
    def __init__(__self__, *, cluster: _builtins.str, point_in_time: _builtins.str) -> None:
...
class ClusterTrialMetadata(dict):
    ...
    def __init__(__self__, *, end_time: Optional[_builtins.str] = ..., grace_end_time: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ..., upgrade_time: Optional[_builtins.str] = ...) -> None:
...
class InstanceClientConnectionConfig(dict):
    ...
    def __init__(__self__, *, require_connectors: Optional[_builtins.bool] = ..., ssl_config: Optional[outputs.InstanceClientConnectionConfigSslConfig] = ...) -> None:
...
class InstanceConnectionPoolConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, flags: Optional[Mapping[str, _builtins.str]] = ..., pooler_count: Optional[_builtins.int] = ...) -> None:
...
class InstanceMachineConfig(dict):
    ...
    def __init__(__self__, *, cpu_count: Optional[_builtins.int] = ..., machine_type: Optional[_builtins.str] = ...) -> None:
...
class InstanceNetworkConfig(dict):
    ...
    def __init__(__self__, *, allocated_ip_range_override: Optional[_builtins.str] = ..., authorized_external_networks: Optional[Sequence[outputs.InstanceNetworkConfigAuthorizedExternalNetwork]] = ..., enable_outbound_public_ip: Optional[_builtins.bool] = ..., enable_public_ip: Optional[_builtins.bool] = ...) -> None:
...
class InstanceObservabilityConfig(dict):
    ...
    def __init__(__self__, *, assistive_experiences_enabled: Optional[_builtins.bool] = ..., enabled: Optional[_builtins.bool] = ..., max_query_string_length: Optional[_builtins.int] = ..., preserve_comments: Optional[_builtins.bool] = ..., query_plans_per_minute: Optional[_builtins.int] = ..., record_application_tags: Optional[_builtins.bool] = ..., track_active_queries: Optional[_builtins.bool] = ..., track_wait_event_types: Optional[_builtins.bool] = ..., track_wait_events: Optional[_builtins.bool] = ...) -> None:
...
class InstancePscInstanceConfig(dict):
    ...
    def __init__(__self__, *, allowed_consumer_projects: Optional[Sequence[_builtins.str]] = ..., psc_auto_connections: Optional[Sequence[outputs.InstancePscInstanceConfigPscAutoConnection]] = ..., psc_dns_name: Optional[_builtins.str] = ..., psc_interface_configs: Optional[Sequence[outputs.InstancePscInstanceConfigPscInterfaceConfig]] = ..., service_attachment_link: Optional[_builtins.str] = ...) -> None:
...
class InstancePscInstanceConfigPscAutoConnection(dict):
    ...
    def __init__(__self__, *, consumer_network: Optional[_builtins.str] = ..., consumer_network_status: Optional[_builtins.str] = ..., consumer_project: Optional[_builtins.str] = ..., ip_address: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class InstancePscInstanceConfigPscInterfaceConfig(dict):
    ...
    def __init__(__self__, *, network_attachment_resource: Optional[_builtins.str] = ...) -> None:
...
class InstanceQueryInsightsConfig(dict):
    ...
    def __init__(__self__, *, query_plans_per_minute: Optional[_builtins.int] = ..., query_string_length: Optional[_builtins.int] = ..., record_application_tags: Optional[_builtins.bool] = ..., record_client_address: Optional[_builtins.bool] = ...) -> None:
...
class GetClusterAutomatedBackupPolicyResult(dict):
    def __init__(__self__, *, backup_window: _builtins.str, enabled: _builtins.bool, encryption_configs: Sequence[outputs.GetClusterAutomatedBackupPolicyEncryptionConfigResult], labels: Mapping[str, _builtins.str], location: _builtins.str, quantity_based_retentions: Sequence[outputs.GetClusterAutomatedBackupPolicyQuantityBasedRetentionResult], time_based_retentions: Sequence[outputs.GetClusterAutomatedBackupPolicyTimeBasedRetentionResult], weekly_schedules: Sequence[outputs.GetClusterAutomatedBackupPolicyWeeklyScheduleResult]) -> None:
...
class GetClusterAutomatedBackupPolicyWeeklyScheduleResult(dict):
    def __init__(__self__, *, days_of_weeks: Sequence[_builtins.str], start_times: Sequence[outputs.GetClusterAutomatedBackupPolicyWeeklyScheduleStartTimeResult]) -> None:
...
class GetClusterContinuousBackupConfigResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, encryption_configs: Sequence[outputs.GetClusterContinuousBackupConfigEncryptionConfigResult], recovery_window_days: _builtins.int) -> None:
...
class GetClusterContinuousBackupInfoResult(dict):
    def __init__(__self__, *, earliest_restorable_time: _builtins.str, enabled_time: _builtins.str, encryption_infos: Sequence[outputs.GetClusterContinuousBackupInfoEncryptionInfoResult], schedules: Sequence[_builtins.str]) -> None:
...
class GetClusterContinuousBackupInfoEncryptionInfoResult(dict):
    def __init__(__self__, *, encryption_type: _builtins.str, kms_key_versions: Sequence[_builtins.str]) -> None:
...
class GetClusterInitialUserResult(dict):
    def __init__(__self__, *, password: _builtins.str, password_wo: _builtins.str, password_wo_version: _builtins.str, user: _builtins.str) -> None:
...
class GetClusterMaintenanceUpdatePolicyResult(dict):
    def __init__(__self__, *, maintenance_windows: Sequence[outputs.GetClusterMaintenanceUpdatePolicyMaintenanceWindowResult]) -> None:
...
class GetClusterMaintenanceUpdatePolicyMaintenanceWindowResult(dict):
    def __init__(__self__, *, day: _builtins.str, start_times: Sequence[outputs.GetClusterMaintenanceUpdatePolicyMaintenanceWindowStartTimeResult]) -> None:
...
class GetClusterMigrationSourceResult(dict):
    def __init__(__self__, *, host_port: _builtins.str, reference_id: _builtins.str, source_type: _builtins.str) -> None:
...
class GetClusterNetworkConfigResult(dict):
    def __init__(__self__, *, allocated_ip_range: _builtins.str, network: _builtins.str) -> None:
...
class GetClusterPscConfigResult(dict):
    def __init__(__self__, *, psc_enabled: _builtins.bool, service_owned_project_number: _builtins.int) -> None:
...
class GetClusterTrialMetadataResult(dict):
    def __init__(__self__, *, end_time: _builtins.str, grace_end_time: _builtins.str, start_time: _builtins.str, upgrade_time: _builtins.str) -> None:
...
class GetInstanceClientConnectionConfigResult(dict):
    def __init__(__self__, *, require_connectors: _builtins.bool, ssl_configs: Sequence[outputs.GetInstanceClientConnectionConfigSslConfigResult]) -> None:
...
class GetInstanceConnectionPoolConfigResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, flags: Mapping[str, _builtins.str], pooler_count: _builtins.int) -> None:
...
class GetInstanceMachineConfigResult(dict):
    def __init__(__self__, *, cpu_count: _builtins.int, machine_type: _builtins.str) -> None:
...
class GetInstanceNetworkConfigResult(dict):
    def __init__(__self__, *, allocated_ip_range_override: _builtins.str, authorized_external_networks: Sequence[outputs.GetInstanceNetworkConfigAuthorizedExternalNetworkResult], enable_outbound_public_ip: _builtins.bool, enable_public_ip: _builtins.bool) -> None:
...
class GetInstanceObservabilityConfigResult(dict):
    def __init__(__self__, *, assistive_experiences_enabled: _builtins.bool, enabled: _builtins.bool, max_query_string_length: _builtins.int, preserve_comments: _builtins.bool, query_plans_per_minute: _builtins.int, record_application_tags: _builtins.bool, track_active_queries: _builtins.bool, track_wait_event_types: _builtins.bool, track_wait_events: _builtins.bool) -> None:
...
class GetInstancePscInstanceConfigResult(dict):
    def __init__(__self__, *, allowed_consumer_projects: Sequence[_builtins.str], psc_auto_connections: Sequence[outputs.GetInstancePscInstanceConfigPscAutoConnectionResult], psc_dns_name: _builtins.str, psc_interface_configs: Sequence[outputs.GetInstancePscInstanceConfigPscInterfaceConfigResult], service_attachment_link: _builtins.str) -> None:
...
class GetInstancePscInstanceConfigPscAutoConnectionResult(dict):
    def __init__(__self__, *, consumer_network: _builtins.str, consumer_network_status: _builtins.str, consumer_project: _builtins.str, ip_address: _builtins.str, status: _builtins.str) -> None:
...
class GetInstanceQueryInsightsConfigResult(dict):
    def __init__(__self__, *, query_plans_per_minute: _builtins.int, query_string_length: _builtins.int, record_application_tags: _builtins.bool, record_client_address: _builtins.bool) -> None:
...
class GetLocationsLocationResult(dict):
    def __init__(__self__, *, display_name: _builtins.str, labels: Mapping[str, _builtins.str], location_id: _builtins.str, metadata: Mapping[str, _builtins.str], name: _builtins.str) -> None:
...
class GetSupportedDatabaseFlagsSupportedDatabaseFlagResult(dict):
    def __init__(__self__, *, accepts_multiple_values: _builtins.bool, flag_name: _builtins.str, integer_restrictions: outputs.GetSupportedDatabaseFlagsSupportedDatabaseFlagIntegerRestrictionsResult, name: _builtins.str, requires_db_restart: _builtins.bool, string_restrictions: outputs.GetSupportedDatabaseFlagsSupportedDatabaseFlagStringRestrictionsResult, supported_db_versions: Sequence[_builtins.str], value_type: _builtins.str) -> None:
