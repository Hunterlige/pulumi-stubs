...
class GetInstanceResult:
    ...
    def __init__(__self__, activation_policy=..., annotations=..., availability_type=..., client_connection_configs=..., cluster=..., cluster_id=..., connection_pool_configs=..., create_time=..., database_flags=..., display_name=..., effective_annotations=..., effective_labels=..., gce_zone=..., id=..., instance_id=..., instance_type=..., ip_address=..., labels=..., location=..., machine_configs=..., name=..., network_configs=..., observability_configs=..., outbound_public_ip_addresses=..., project=..., psc_instance_configs=..., public_ip_address=..., pulumi_labels=..., query_insights_configs=..., read_pool_configs=..., reconciling=..., state=..., uid=..., update_time=...) -> None:
        ...
...
def get_instance(cluster_id: Optional[_builtins.str] = ..., instance_id: Optional[_builtins.str] = ..., location: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ..., opts: Optional[pulumi.InvokeOptions] = ...) -> AwaitableGetInstanceResult:
    
    ...

def get_instance_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = ..., instance_id: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., project: Optional[pulumi.Input[Optional[_builtins.str]]] = ..., opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = ...) -> pulumi.Output[GetInstanceResult]:
