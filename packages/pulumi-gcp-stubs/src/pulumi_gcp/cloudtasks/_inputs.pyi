...
class QueueAppEngineRoutingOverrideArgs:
    def __init__(__self__, *, host: Optional[pulumi.Input[_builtins.str]] = ..., instance: Optional[pulumi.Input[_builtins.str]] = ..., service: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class QueueHttpTargetArgs:
    def __init__(__self__, *, header_overrides: Optional[pulumi.Input[Sequence[pulumi.Input[QueueHttpTargetHeaderOverrideArgs]]]] = ..., http_method: Optional[pulumi.Input[_builtins.str]] = ..., oauth_token: Optional[pulumi.Input[QueueHttpTargetOauthTokenArgs]] = ..., oidc_token: Optional[pulumi.Input[QueueHttpTargetOidcTokenArgs]] = ..., uri_override: Optional[pulumi.Input[QueueHttpTargetUriOverrideArgs]] = ...) -> None:
    ...
    def header_overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[QueueHttpTargetHeaderOverrideArgs]]]]): # -> None:
        ...
    ...
    @oauth_token.setter
    def oauth_token(self, value: Optional[pulumi.Input[QueueHttpTargetOauthTokenArgs]]): # -> None:
        ...
    ...
    @oidc_token.setter
    def oidc_token(self, value: Optional[pulumi.Input[QueueHttpTargetOidcTokenArgs]]): # -> None:
        ...
    ...
    @uri_override.setter
    def uri_override(self, value: Optional[pulumi.Input[QueueHttpTargetUriOverrideArgs]]): # -> None:
        ...
...
class QueueHttpTargetHeaderOverrideArgs:
    def __init__(__self__, *, header: pulumi.Input[QueueHttpTargetHeaderOverrideHeaderArgs]) -> None:
    ...
    @header.setter
    def header(self, value: pulumi.Input[QueueHttpTargetHeaderOverrideHeaderArgs]): # -> None:
        ...
...
class QueueHttpTargetOauthTokenArgs:
    def __init__(__self__, *, service_account_email: pulumi.Input[_builtins.str], scope: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class QueueHttpTargetUriOverrideArgs:
    def __init__(__self__, *, host: Optional[pulumi.Input[_builtins.str]] = ..., path_override: Optional[pulumi.Input[QueueHttpTargetUriOverridePathOverrideArgs]] = ..., port: Optional[pulumi.Input[_builtins.str]] = ..., query_override: Optional[pulumi.Input[QueueHttpTargetUriOverrideQueryOverrideArgs]] = ..., scheme: Optional[pulumi.Input[_builtins.str]] = ..., uri_override_enforce_mode: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def path_override(self, value: Optional[pulumi.Input[QueueHttpTargetUriOverridePathOverrideArgs]]): # -> None:
        ...
    ...
    def query_override(self, value: Optional[pulumi.Input[QueueHttpTargetUriOverrideQueryOverrideArgs]]): # -> None:
        ...
    ...
    def uri_override_enforce_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class QueueHttpTargetUriOverrideQueryOverrideArgs:
    def __init__(__self__, *, query_params: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @query_params.setter
    def query_params(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class QueueRateLimitsArgs:
    def __init__(__self__, *, max_burst_size: Optional[pulumi.Input[_builtins.int]] = ..., max_concurrent_dispatches: Optional[pulumi.Input[_builtins.int]] = ..., max_dispatches_per_second: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def max_burst_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_concurrent_dispatches(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_dispatches_per_second(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class QueueRetryConfigArgs:
    def __init__(__self__, *, max_attempts: Optional[pulumi.Input[_builtins.int]] = ..., max_backoff: Optional[pulumi.Input[_builtins.str]] = ..., max_doublings: Optional[pulumi.Input[_builtins.int]] = ..., max_retry_duration: Optional[pulumi.Input[_builtins.str]] = ..., min_backoff: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @max_backoff.setter
    def max_backoff(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_doublings(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def max_retry_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @min_backoff.setter
    def min_backoff(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class QueueStackdriverLoggingConfigArgs:
    def __init__(__self__, *, sampling_ratio: pulumi.Input[_builtins.float]) -> None:
    ...
    def sampling_ratio(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
