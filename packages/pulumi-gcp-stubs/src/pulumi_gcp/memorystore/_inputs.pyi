...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['InstanceAutomatedBackupConfigArgs', 'InstanceAutomatedBackupConfigArgsDict', ..., ..., ..., ..., 'InstanceCrossInstanceReplicationConfigArgs', 'InstanceCrossInstanceReplicationConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'InstanceDesiredAutoCreatedEndpointArgs', 'InstanceDesiredAutoCreatedEndpointArgsDict', 'InstanceDesiredPscAutoConnectionArgs', 'InstanceDesiredPscAutoConnectionArgsDict', ..., ..., ..., ..., ..., ..., 'InstanceDiscoveryEndpointArgs', 'InstanceDiscoveryEndpointArgsDict', 'InstanceEndpointArgs', 'InstanceEndpointArgsDict', 'InstanceEndpointConnectionArgs', 'InstanceEndpointConnectionArgsDict', 'InstanceEndpointConnectionPscAutoConnectionArgs', ..., 'InstanceGcsSourceArgs', 'InstanceGcsSourceArgsDict', 'InstanceMaintenancePolicyArgs', 'InstanceMaintenancePolicyArgsDict', ..., ..., ..., ..., 'InstanceMaintenanceScheduleArgs', 'InstanceMaintenanceScheduleArgsDict', 'InstanceManagedBackupSourceArgs', 'InstanceManagedBackupSourceArgsDict', 'InstanceManagedServerCaArgs', 'InstanceManagedServerCaArgsDict', 'InstanceManagedServerCaCaCertArgs', 'InstanceManagedServerCaCaCertArgsDict', 'InstanceNodeConfigArgs', 'InstanceNodeConfigArgsDict', 'InstancePersistenceConfigArgs', 'InstancePersistenceConfigArgsDict', 'InstancePersistenceConfigAofConfigArgs', 'InstancePersistenceConfigAofConfigArgsDict', 'InstancePersistenceConfigRdbConfigArgs', 'InstancePersistenceConfigRdbConfigArgsDict', 'InstancePscAttachmentDetailArgs', 'InstancePscAttachmentDetailArgsDict', 'InstancePscAutoConnectionArgs', 'InstancePscAutoConnectionArgsDict', 'InstanceStateInfoArgs', 'InstanceStateInfoArgsDict', 'InstanceStateInfoUpdateInfoArgs', 'InstanceStateInfoUpdateInfoArgsDict', 'InstanceZoneDistributionConfigArgs', 'InstanceZoneDistributionConfigArgsDict']
...
class InstanceAutomatedBackupConfigArgs:
    def __init__(__self__, *, fixed_frequency_schedule: pulumi.Input[InstanceAutomatedBackupConfigFixedFrequencyScheduleArgs], retention: pulumi.Input[_builtins.str]) -> None:
    ...
    def fixed_frequency_schedule(self, value: pulumi.Input[InstanceAutomatedBackupConfigFixedFrequencyScheduleArgs]): # -> None:
        ...
...
class InstanceAutomatedBackupConfigFixedFrequencyScheduleArgs:
    def __init__(__self__, *, start_time: pulumi.Input[InstanceAutomatedBackupConfigFixedFrequencyScheduleStartTimeArgs]) -> None:
    ...
    @start_time.setter
    def start_time(self, value: pulumi.Input[InstanceAutomatedBackupConfigFixedFrequencyScheduleStartTimeArgs]): # -> None:
        ...
...
class InstanceCrossInstanceReplicationConfigArgs:
    def __init__(__self__, *, instance_role: Optional[pulumi.Input[_builtins.str]] = ..., memberships: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceCrossInstanceReplicationConfigMembershipArgs]]]] = ..., primary_instance: Optional[pulumi.Input[InstanceCrossInstanceReplicationConfigPrimaryInstanceArgs]] = ..., secondary_instances: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceCrossInstanceReplicationConfigSecondaryInstanceArgs]]]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @memberships.setter
    def memberships(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceCrossInstanceReplicationConfigMembershipArgs]]]]): # -> None:
        ...
    ...
    def primary_instance(self, value: Optional[pulumi.Input[InstanceCrossInstanceReplicationConfigPrimaryInstanceArgs]]): # -> None:
        ...
    ...
    def secondary_instances(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceCrossInstanceReplicationConfigSecondaryInstanceArgs]]]]): # -> None:
        ...
...
class InstanceCrossInstanceReplicationConfigMembershipArgs:
    def __init__(__self__, *, primary_instances: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceCrossInstanceReplicationConfigMembershipPrimaryInstanceArgs]]]] = ..., secondary_instances: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceCrossInstanceReplicationConfigMembershipSecondaryInstanceArgs]]]] = ...) -> None:
    ...
    def primary_instances(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceCrossInstanceReplicationConfigMembershipPrimaryInstanceArgs]]]]): # -> None:
        ...
    ...
    @secondary_instances.setter
    def secondary_instances(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceCrossInstanceReplicationConfigMembershipSecondaryInstanceArgs]]]]): # -> None:
        ...
...
class InstanceCrossInstanceReplicationConfigMembershipPrimaryInstanceArgs:
    def __init__(__self__, *, instance: Optional[pulumi.Input[_builtins.str]] = ..., uid: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceDesiredUserCreatedEndpointsDesiredUserCreatedEndpointArgs:
    def __init__(__self__, *, connections: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceDesiredUserCreatedEndpointsDesiredUserCreatedEndpointConnectionArgs]]]] = ...) -> None:
    ...
    @connections.setter
    def connections(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceDesiredUserCreatedEndpointsDesiredUserCreatedEndpointConnectionArgs]]]]): # -> None:
        ...
...
class InstanceDesiredUserCreatedEndpointsDesiredUserCreatedEndpointConnectionArgs:
    def __init__(__self__, *, psc_connection: Optional[pulumi.Input[InstanceDesiredUserCreatedEndpointsDesiredUserCreatedEndpointConnectionPscConnectionArgs]] = ...) -> None:
    ...
    def psc_connection(self, value: Optional[pulumi.Input[InstanceDesiredUserCreatedEndpointsDesiredUserCreatedEndpointConnectionPscConnectionArgs]]): # -> None:
        ...
...
class InstanceDiscoveryEndpointArgs:
    def __init__(__self__, *, address: Optional[pulumi.Input[_builtins.str]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class InstanceEndpointArgs:
    def __init__(__self__, *, connections: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceEndpointConnectionArgs]]]] = ...) -> None:
    ...
    @connections.setter
    def connections(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceEndpointConnectionArgs]]]]): # -> None:
        ...
...
class InstanceEndpointConnectionArgs:
    def __init__(__self__, *, psc_auto_connection: Optional[pulumi.Input[InstanceEndpointConnectionPscAutoConnectionArgs]] = ...) -> None:
    ...
    def psc_auto_connection(self, value: Optional[pulumi.Input[InstanceEndpointConnectionPscAutoConnectionArgs]]): # -> None:
        ...
...
class InstanceEndpointConnectionPscAutoConnectionArgs:
    def __init__(__self__, *, connection_type: Optional[pulumi.Input[_builtins.str]] = ..., forwarding_rule: Optional[pulumi.Input[_builtins.str]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., project_id: Optional[pulumi.Input[_builtins.str]] = ..., psc_connection_id: Optional[pulumi.Input[_builtins.str]] = ..., service_attachment: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceMaintenancePolicyArgs:
    def __init__(__self__, *, create_time: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ..., weekly_maintenance_windows: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceMaintenancePolicyWeeklyMaintenanceWindowArgs]]]] = ...) -> None:
...
class InstanceManagedServerCaArgs:
    def __init__(__self__, *, ca_certs: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceManagedServerCaCaCertArgs]]]] = ...) -> None:
    ...
    @ca_certs.setter
    def ca_certs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceManagedServerCaCaCertArgs]]]]): # -> None:
        ...
...
class InstancePersistenceConfigArgs:
    def __init__(__self__, *, aof_config: Optional[pulumi.Input[InstancePersistenceConfigAofConfigArgs]] = ..., mode: Optional[pulumi.Input[_builtins.str]] = ..., rdb_config: Optional[pulumi.Input[InstancePersistenceConfigRdbConfigArgs]] = ...) -> None:
    ...
    @aof_config.setter
    def aof_config(self, value: Optional[pulumi.Input[InstancePersistenceConfigAofConfigArgs]]): # -> None:
        ...
    ...
    @rdb_config.setter
    def rdb_config(self, value: Optional[pulumi.Input[InstancePersistenceConfigRdbConfigArgs]]): # -> None:
        ...
...
class InstancePscAutoConnectionArgs:
    def __init__(__self__, *, connection_type: Optional[pulumi.Input[_builtins.str]] = ..., forwarding_rule: Optional[pulumi.Input[_builtins.str]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., project_id: Optional[pulumi.Input[_builtins.str]] = ..., psc_connection_id: Optional[pulumi.Input[_builtins.str]] = ..., psc_connection_status: Optional[pulumi.Input[_builtins.str]] = ..., service_attachment: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceStateInfoArgs:
    def __init__(__self__, *, update_infos: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceStateInfoUpdateInfoArgs]]]] = ...) -> None:
    ...
    @update_infos.setter
    def update_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceStateInfoUpdateInfoArgs]]]]): # -> None:
        ...
...
class InstanceStateInfoUpdateInfoArgs:
    def __init__(__self__, *, target_engine_version: Optional[pulumi.Input[_builtins.str]] = ..., target_node_type: Optional[pulumi.Input[_builtins.str]] = ..., target_replica_count: Optional[pulumi.Input[_builtins.int]] = ..., target_shard_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def target_engine_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_node_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
