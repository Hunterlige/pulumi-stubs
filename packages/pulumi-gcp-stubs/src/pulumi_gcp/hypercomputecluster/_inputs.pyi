...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['ClusterComputeResourceArgs', 'ClusterComputeResourceArgsDict', 'ClusterComputeResourceConfigArgs', 'ClusterComputeResourceConfigArgsDict', ..., ..., ..., ..., ..., ..., 'ClusterComputeResourceConfigNewSpotInstancesArgs', ..., 'ClusterNetworkResourceArgs', 'ClusterNetworkResourceArgsDict', 'ClusterNetworkResourceConfigArgs', 'ClusterNetworkResourceConfigArgsDict', 'ClusterNetworkResourceConfigExistingNetworkArgs', ..., 'ClusterNetworkResourceConfigNewNetworkArgs', 'ClusterNetworkResourceConfigNewNetworkArgsDict', 'ClusterNetworkResourceNetworkArgs', 'ClusterNetworkResourceNetworkArgsDict', 'ClusterOrchestratorArgs', 'ClusterOrchestratorArgsDict', 'ClusterOrchestratorSlurmArgs', 'ClusterOrchestratorSlurmArgsDict', 'ClusterOrchestratorSlurmLoginNodesArgs', 'ClusterOrchestratorSlurmLoginNodesArgsDict', 'ClusterOrchestratorSlurmLoginNodesBootDiskArgs', 'ClusterOrchestratorSlurmLoginNodesBootDiskArgsDict', 'ClusterOrchestratorSlurmLoginNodesInstanceArgs', 'ClusterOrchestratorSlurmLoginNodesInstanceArgsDict', ..., ..., 'ClusterOrchestratorSlurmNodeSetArgs', 'ClusterOrchestratorSlurmNodeSetArgsDict', 'ClusterOrchestratorSlurmNodeSetComputeInstanceArgs', ..., ..., ..., 'ClusterOrchestratorSlurmNodeSetStorageConfigArgs', ..., 'ClusterOrchestratorSlurmPartitionArgs', 'ClusterOrchestratorSlurmPartitionArgsDict', 'ClusterStorageResourceArgs', 'ClusterStorageResourceArgsDict', 'ClusterStorageResourceBucketArgs', 'ClusterStorageResourceBucketArgsDict', 'ClusterStorageResourceConfigArgs', 'ClusterStorageResourceConfigArgsDict', 'ClusterStorageResourceConfigExistingBucketArgs', 'ClusterStorageResourceConfigExistingBucketArgsDict', 'ClusterStorageResourceConfigExistingFilestoreArgs', ..., 'ClusterStorageResourceConfigExistingLustreArgs', 'ClusterStorageResourceConfigExistingLustreArgsDict', 'ClusterStorageResourceConfigNewBucketArgs', 'ClusterStorageResourceConfigNewBucketArgsDict', 'ClusterStorageResourceConfigNewBucketAutoclassArgs', ..., ..., ..., 'ClusterStorageResourceConfigNewFilestoreArgs', 'ClusterStorageResourceConfigNewFilestoreArgsDict', ..., ..., 'ClusterStorageResourceConfigNewLustreArgs', 'ClusterStorageResourceConfigNewLustreArgsDict', 'ClusterStorageResourceFilestoreArgs', 'ClusterStorageResourceFilestoreArgsDict', 'ClusterStorageResourceLustreArgs', 'ClusterStorageResourceLustreArgsDict']
...
class ClusterComputeResourceArgs:
    def __init__(__self__, *, config: pulumi.Input[ClusterComputeResourceConfigArgs], id: pulumi.Input[_builtins.str]) -> None:
    ...
    @config.setter
    def config(self, value: pulumi.Input[ClusterComputeResourceConfigArgs]): # -> None:
        ...
...
class ClusterComputeResourceConfigArgs:
    def __init__(__self__, *, new_flex_start_instances: Optional[pulumi.Input[ClusterComputeResourceConfigNewFlexStartInstancesArgs]] = ..., new_on_demand_instances: Optional[pulumi.Input[ClusterComputeResourceConfigNewOnDemandInstancesArgs]] = ..., new_reserved_instances: Optional[pulumi.Input[ClusterComputeResourceConfigNewReservedInstancesArgs]] = ..., new_spot_instances: Optional[pulumi.Input[ClusterComputeResourceConfigNewSpotInstancesArgs]] = ...) -> None:
    ...
    def new_flex_start_instances(self, value: Optional[pulumi.Input[ClusterComputeResourceConfigNewFlexStartInstancesArgs]]): # -> None:
        ...
    ...
    def new_on_demand_instances(self, value: Optional[pulumi.Input[ClusterComputeResourceConfigNewOnDemandInstancesArgs]]): # -> None:
        ...
    ...
    def new_reserved_instances(self, value: Optional[pulumi.Input[ClusterComputeResourceConfigNewReservedInstancesArgs]]): # -> None:
        ...
    ...
    def new_spot_instances(self, value: Optional[pulumi.Input[ClusterComputeResourceConfigNewSpotInstancesArgs]]): # -> None:
        ...
...
class ClusterComputeResourceConfigNewFlexStartInstancesArgs:
    def __init__(__self__, *, machine_type: pulumi.Input[_builtins.str], max_duration: pulumi.Input[_builtins.str], zone: pulumi.Input[_builtins.str]) -> None:
    ...
    @max_duration.setter
    def max_duration(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterComputeResourceConfigNewOnDemandInstancesArgs:
    def __init__(__self__, *, machine_type: pulumi.Input[_builtins.str], zone: pulumi.Input[_builtins.str]) -> None:
...
class ClusterComputeResourceConfigNewReservedInstancesArgs:
    def __init__(__self__, *, reservation: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @reservation.setter
    def reservation(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterComputeResourceConfigNewSpotInstancesArgs:
    def __init__(__self__, *, machine_type: pulumi.Input[_builtins.str], zone: pulumi.Input[_builtins.str], termination_action: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def termination_action(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterNetworkResourceArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], config: Optional[pulumi.Input[ClusterNetworkResourceConfigArgs]] = ..., networks: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterNetworkResourceNetworkArgs]]]] = ...) -> None:
    ...
    @config.setter
    def config(self, value: Optional[pulumi.Input[ClusterNetworkResourceConfigArgs]]): # -> None:
        ...
    ...
    @networks.setter
    def networks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterNetworkResourceNetworkArgs]]]]): # -> None:
        ...
...
class ClusterNetworkResourceConfigArgs:
    def __init__(__self__, *, existing_network: Optional[pulumi.Input[ClusterNetworkResourceConfigExistingNetworkArgs]] = ..., new_network: Optional[pulumi.Input[ClusterNetworkResourceConfigNewNetworkArgs]] = ...) -> None:
    ...
    def existing_network(self, value: Optional[pulumi.Input[ClusterNetworkResourceConfigExistingNetworkArgs]]): # -> None:
        ...
    ...
    @new_network.setter
    def new_network(self, value: Optional[pulumi.Input[ClusterNetworkResourceConfigNewNetworkArgs]]): # -> None:
        ...
...
class ClusterNetworkResourceConfigExistingNetworkArgs:
    def __init__(__self__, *, network: pulumi.Input[_builtins.str], subnetwork: pulumi.Input[_builtins.str]) -> None:
...
class ClusterNetworkResourceConfigNewNetworkArgs:
    def __init__(__self__, *, network: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterOrchestratorArgs:
    def __init__(__self__, *, slurm: Optional[pulumi.Input[ClusterOrchestratorSlurmArgs]] = ...) -> None:
    ...
    @slurm.setter
    def slurm(self, value: Optional[pulumi.Input[ClusterOrchestratorSlurmArgs]]): # -> None:
        ...
...
class ClusterOrchestratorSlurmArgs:
    def __init__(__self__, *, login_nodes: pulumi.Input[ClusterOrchestratorSlurmLoginNodesArgs], node_sets: pulumi.Input[Sequence[pulumi.Input[ClusterOrchestratorSlurmNodeSetArgs]]], partitions: pulumi.Input[Sequence[pulumi.Input[ClusterOrchestratorSlurmPartitionArgs]]], default_partition: Optional[pulumi.Input[_builtins.str]] = ..., epilog_bash_scripts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., prolog_bash_scripts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @login_nodes.setter
    def login_nodes(self, value: pulumi.Input[ClusterOrchestratorSlurmLoginNodesArgs]): # -> None:
        ...
    ...
    @node_sets.setter
    def node_sets(self, value: pulumi.Input[Sequence[pulumi.Input[ClusterOrchestratorSlurmNodeSetArgs]]]): # -> None:
        ...
    ...
    @partitions.setter
    def partitions(self, value: pulumi.Input[Sequence[pulumi.Input[ClusterOrchestratorSlurmPartitionArgs]]]): # -> None:
        ...
    ...
    def default_partition(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def epilog_bash_scripts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def prolog_bash_scripts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ClusterOrchestratorSlurmLoginNodesArgs:
    def __init__(__self__, *, count: pulumi.Input[_builtins.str], machine_type: pulumi.Input[_builtins.str], zone: pulumi.Input[_builtins.str], boot_disk: Optional[pulumi.Input[ClusterOrchestratorSlurmLoginNodesBootDiskArgs]] = ..., enable_os_login: Optional[pulumi.Input[_builtins.bool]] = ..., enable_public_ips: Optional[pulumi.Input[_builtins.bool]] = ..., instances: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterOrchestratorSlurmLoginNodesInstanceArgs]]]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., startup_script: Optional[pulumi.Input[_builtins.str]] = ..., storage_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterOrchestratorSlurmLoginNodesStorageConfigArgs]]]] = ...) -> None:
    ...
    @boot_disk.setter
    def boot_disk(self, value: Optional[pulumi.Input[ClusterOrchestratorSlurmLoginNodesBootDiskArgs]]): # -> None:
        ...
    ...
    def enable_os_login(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_public_ips(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @instances.setter
    def instances(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterOrchestratorSlurmLoginNodesInstanceArgs]]]]): # -> None:
        ...
    ...
    def startup_script(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def storage_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterOrchestratorSlurmLoginNodesStorageConfigArgs]]]]): # -> None:
        ...
...
class ClusterOrchestratorSlurmLoginNodesBootDiskArgs:
    def __init__(__self__, *, size_gb: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str]) -> None:
    ...
    @size_gb.setter
    def size_gb(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterOrchestratorSlurmLoginNodesInstanceArgs:
    def __init__(__self__, *, instance: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterOrchestratorSlurmLoginNodesStorageConfigArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], local_mount: pulumi.Input[_builtins.str]) -> None:
    ...
    @local_mount.setter
    def local_mount(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterOrchestratorSlurmNodeSetArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], compute_id: Optional[pulumi.Input[_builtins.str]] = ..., compute_instance: Optional[pulumi.Input[ClusterOrchestratorSlurmNodeSetComputeInstanceArgs]] = ..., max_dynamic_node_count: Optional[pulumi.Input[_builtins.str]] = ..., static_node_count: Optional[pulumi.Input[_builtins.str]] = ..., storage_configs: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterOrchestratorSlurmNodeSetStorageConfigArgs]]]] = ...) -> None:
    ...
    def compute_instance(self, value: Optional[pulumi.Input[ClusterOrchestratorSlurmNodeSetComputeInstanceArgs]]): # -> None:
        ...
    ...
    def max_dynamic_node_count(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def static_node_count(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @storage_configs.setter
    def storage_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterOrchestratorSlurmNodeSetStorageConfigArgs]]]]): # -> None:
        ...
...
class ClusterOrchestratorSlurmNodeSetComputeInstanceArgs:
    def __init__(__self__, *, boot_disk: Optional[pulumi.Input[ClusterOrchestratorSlurmNodeSetComputeInstanceBootDiskArgs]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., startup_script: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @boot_disk.setter
    def boot_disk(self, value: Optional[pulumi.Input[ClusterOrchestratorSlurmNodeSetComputeInstanceBootDiskArgs]]): # -> None:
        ...
...
class ClusterOrchestratorSlurmPartitionArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], node_set_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @node_set_ids.setter
    def node_set_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class ClusterStorageResourceArgs:
    def __init__(__self__, *, config: pulumi.Input[ClusterStorageResourceConfigArgs], id: pulumi.Input[_builtins.str], buckets: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterStorageResourceBucketArgs]]]] = ..., filestores: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterStorageResourceFilestoreArgs]]]] = ..., lustres: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterStorageResourceLustreArgs]]]] = ...) -> None:
    ...
    @config.setter
    def config(self, value: pulumi.Input[ClusterStorageResourceConfigArgs]): # -> None:
        ...
    ...
    @buckets.setter
    def buckets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterStorageResourceBucketArgs]]]]): # -> None:
        ...
    ...
    @filestores.setter
    def filestores(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterStorageResourceFilestoreArgs]]]]): # -> None:
        ...
    ...
    @lustres.setter
    def lustres(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterStorageResourceLustreArgs]]]]): # -> None:
        ...
...
class ClusterStorageResourceConfigArgs:
    def __init__(__self__, *, existing_bucket: Optional[pulumi.Input[ClusterStorageResourceConfigExistingBucketArgs]] = ..., existing_filestore: Optional[pulumi.Input[ClusterStorageResourceConfigExistingFilestoreArgs]] = ..., existing_lustre: Optional[pulumi.Input[ClusterStorageResourceConfigExistingLustreArgs]] = ..., new_bucket: Optional[pulumi.Input[ClusterStorageResourceConfigNewBucketArgs]] = ..., new_filestore: Optional[pulumi.Input[ClusterStorageResourceConfigNewFilestoreArgs]] = ..., new_lustre: Optional[pulumi.Input[ClusterStorageResourceConfigNewLustreArgs]] = ...) -> None:
    ...
    def existing_bucket(self, value: Optional[pulumi.Input[ClusterStorageResourceConfigExistingBucketArgs]]): # -> None:
        ...
    ...
    def existing_filestore(self, value: Optional[pulumi.Input[ClusterStorageResourceConfigExistingFilestoreArgs]]): # -> None:
        ...
    ...
    def existing_lustre(self, value: Optional[pulumi.Input[ClusterStorageResourceConfigExistingLustreArgs]]): # -> None:
        ...
    ...
    @new_bucket.setter
    def new_bucket(self, value: Optional[pulumi.Input[ClusterStorageResourceConfigNewBucketArgs]]): # -> None:
        ...
    ...
    def new_filestore(self, value: Optional[pulumi.Input[ClusterStorageResourceConfigNewFilestoreArgs]]): # -> None:
        ...
    ...
    @new_lustre.setter
    def new_lustre(self, value: Optional[pulumi.Input[ClusterStorageResourceConfigNewLustreArgs]]): # -> None:
        ...
...
class ClusterStorageResourceConfigExistingFilestoreArgs:
    ...
    @filestore.setter
    def filestore(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterStorageResourceConfigExistingLustreArgs:
    ...
    @lustre.setter
    def lustre(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterStorageResourceConfigNewBucketArgs:
    def __init__(__self__, *, bucket: pulumi.Input[_builtins.str], autoclass: Optional[pulumi.Input[ClusterStorageResourceConfigNewBucketAutoclassArgs]] = ..., hierarchical_namespace: Optional[pulumi.Input[ClusterStorageResourceConfigNewBucketHierarchicalNamespaceArgs]] = ..., storage_class: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @autoclass.setter
    def autoclass(self, value: Optional[pulumi.Input[ClusterStorageResourceConfigNewBucketAutoclassArgs]]): # -> None:
        ...
    ...
    def hierarchical_namespace(self, value: Optional[pulumi.Input[ClusterStorageResourceConfigNewBucketHierarchicalNamespaceArgs]]): # -> None:
        ...
...
class ClusterStorageResourceConfigNewFilestoreArgs:
    def __init__(__self__, *, file_shares: pulumi.Input[Sequence[pulumi.Input[ClusterStorageResourceConfigNewFilestoreFileShareArgs]]], filestore: pulumi.Input[_builtins.str], tier: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., protocol: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @file_shares.setter
    def file_shares(self, value: pulumi.Input[Sequence[pulumi.Input[ClusterStorageResourceConfigNewFilestoreFileShareArgs]]]): # -> None:
        ...
...
class ClusterStorageResourceConfigNewFilestoreFileShareArgs:
    def __init__(__self__, *, capacity_gb: pulumi.Input[_builtins.str], file_share: pulumi.Input[_builtins.str]) -> None:
    ...
    @capacity_gb.setter
    def capacity_gb(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @file_share.setter
    def file_share(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterStorageResourceConfigNewLustreArgs:
    def __init__(__self__, *, capacity_gb: pulumi.Input[_builtins.str], filesystem: pulumi.Input[_builtins.str], lustre: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ClusterStorageResourceFilestoreArgs:
    def __init__(__self__, *, filestore: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @filestore.setter
    def filestore(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterStorageResourceLustreArgs:
    def __init__(__self__, *, lustre: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @lustre.setter
    def lustre(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
