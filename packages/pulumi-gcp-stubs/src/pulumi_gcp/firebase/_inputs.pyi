...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AiLogicConfigGenerativeLanguageConfigArgs', 'AiLogicConfigGenerativeLanguageConfigArgsDict', 'AiLogicConfigTelemetryConfigArgs', 'AiLogicConfigTelemetryConfigArgsDict', 'AppHostingBackendCodebaseArgs', 'AppHostingBackendCodebaseArgsDict', 'AppHostingBackendManagedResourceArgs', 'AppHostingBackendManagedResourceArgsDict', 'AppHostingBackendManagedResourceRunServiceArgs', 'AppHostingBackendManagedResourceRunServiceArgsDict', 'AppHostingBuildErrorArgs', 'AppHostingBuildErrorArgsDict', 'AppHostingBuildSourceArgs', 'AppHostingBuildSourceArgsDict', 'AppHostingBuildSourceCodebaseArgs', 'AppHostingBuildSourceCodebaseArgsDict', 'AppHostingBuildSourceCodebaseAuthorArgs', 'AppHostingBuildSourceCodebaseAuthorArgsDict', 'AppHostingBuildSourceContainerArgs', 'AppHostingBuildSourceContainerArgsDict', 'AppHostingDomainCustomDomainStatusArgs', 'AppHostingDomainCustomDomainStatusArgsDict', 'AppHostingDomainCustomDomainStatusIssueArgs', 'AppHostingDomainCustomDomainStatusIssueArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AppHostingDomainServeArgs', 'AppHostingDomainServeArgsDict', 'AppHostingDomainServeRedirectArgs', 'AppHostingDomainServeRedirectArgsDict', 'AppHostingTrafficCurrentArgs', 'AppHostingTrafficCurrentArgsDict', 'AppHostingTrafficCurrentSplitArgs', 'AppHostingTrafficCurrentSplitArgsDict', 'AppHostingTrafficRolloutPolicyArgs', 'AppHostingTrafficRolloutPolicyArgsDict', 'AppHostingTrafficTargetArgs', 'AppHostingTrafficTargetArgsDict', 'AppHostingTrafficTargetSplitArgs', 'AppHostingTrafficTargetSplitArgsDict', 'ExtensionsInstanceConfigArgs', 'ExtensionsInstanceConfigArgsDict', 'ExtensionsInstanceErrorStatusArgs', 'ExtensionsInstanceErrorStatusArgsDict', 'ExtensionsInstanceRuntimeDataArgs', 'ExtensionsInstanceRuntimeDataArgsDict', 'ExtensionsInstanceRuntimeDataFatalErrorArgs', 'ExtensionsInstanceRuntimeDataFatalErrorArgsDict', 'ExtensionsInstanceRuntimeDataProcessingStateArgs', ..., 'HostingCustomDomainCertArgs', 'HostingCustomDomainCertArgsDict', 'HostingCustomDomainCertVerificationArgs', 'HostingCustomDomainCertVerificationArgsDict', 'HostingCustomDomainCertVerificationDnsArgs', 'HostingCustomDomainCertVerificationDnsArgsDict', 'HostingCustomDomainCertVerificationDnsDesiredArgs', ..., ..., ..., ..., ..., ..., ..., 'HostingCustomDomainCertVerificationHttpArgs', 'HostingCustomDomainCertVerificationHttpArgsDict', 'HostingCustomDomainIssueArgs', 'HostingCustomDomainIssueArgsDict', 'HostingCustomDomainRequiredDnsUpdateArgs', 'HostingCustomDomainRequiredDnsUpdateArgsDict', 'HostingCustomDomainRequiredDnsUpdateDesiredArgs', ..., ..., ..., 'HostingCustomDomainRequiredDnsUpdateDiscoveredArgs', ..., ..., ..., 'HostingVersionConfigArgs', 'HostingVersionConfigArgsDict', 'HostingVersionConfigHeaderArgs', 'HostingVersionConfigHeaderArgsDict', 'HostingVersionConfigRedirectArgs', 'HostingVersionConfigRedirectArgsDict', 'HostingVersionConfigRewriteArgs', 'HostingVersionConfigRewriteArgsDict', 'HostingVersionConfigRewriteRunArgs', 'HostingVersionConfigRewriteRunArgsDict']
...
class AiLogicConfigGenerativeLanguageConfigArgs:
    def __init__(__self__, *, api_key: Optional[pulumi.Input[_builtins.str]] = ..., api_key_wo: Optional[pulumi.Input[_builtins.str]] = ..., api_key_wo_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @api_key_wo.setter
    def api_key_wo(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def api_key_wo_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiLogicConfigTelemetryConfigArgs:
    def __init__(__self__, *, mode: Optional[pulumi.Input[_builtins.str]] = ..., sampling_rate: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
...
class AppHostingBackendCodebaseArgs:
    def __init__(__self__, *, repository: pulumi.Input[_builtins.str], root_directory: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppHostingBackendManagedResourceArgs:
    def __init__(__self__, *, run_services: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingBackendManagedResourceRunServiceArgs]]]] = ...) -> None:
    ...
    @run_services.setter
    def run_services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingBackendManagedResourceRunServiceArgs]]]]): # -> None:
        ...
...
class AppHostingBuildSourceArgs:
    def __init__(__self__, *, codebase: Optional[pulumi.Input[AppHostingBuildSourceCodebaseArgs]] = ..., container: Optional[pulumi.Input[AppHostingBuildSourceContainerArgs]] = ...) -> None:
    ...
    @codebase.setter
    def codebase(self, value: Optional[pulumi.Input[AppHostingBuildSourceCodebaseArgs]]): # -> None:
        ...
    ...
    @container.setter
    def container(self, value: Optional[pulumi.Input[AppHostingBuildSourceContainerArgs]]): # -> None:
        ...
...
class AppHostingBuildSourceCodebaseArgs:
    def __init__(__self__, *, authors: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingBuildSourceCodebaseAuthorArgs]]]] = ..., branch: Optional[pulumi.Input[_builtins.str]] = ..., commit: Optional[pulumi.Input[_builtins.str]] = ..., commit_message: Optional[pulumi.Input[_builtins.str]] = ..., commit_time: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., hash: Optional[pulumi.Input[_builtins.str]] = ..., uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @authors.setter
    def authors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingBuildSourceCodebaseAuthorArgs]]]]): # -> None:
        ...
    ...
    def commit_message(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @commit_time.setter
    def commit_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @hash.setter
    def hash(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppHostingBuildSourceCodebaseAuthorArgs:
    def __init__(__self__, *, display_name: Optional[pulumi.Input[_builtins.str]] = ..., email: Optional[pulumi.Input[_builtins.str]] = ..., image_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppHostingDomainCustomDomainStatusArgs:
    def __init__(__self__, *, cert_state: Optional[pulumi.Input[_builtins.str]] = ..., host_state: Optional[pulumi.Input[_builtins.str]] = ..., issues: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusIssueArgs]]]] = ..., ownership_state: Optional[pulumi.Input[_builtins.str]] = ..., required_dns_updates: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateArgs]]]] = ...) -> None:
    ...
    @cert_state.setter
    def cert_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @host_state.setter
    def host_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @issues.setter
    def issues(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusIssueArgs]]]]): # -> None:
        ...
    ...
    def ownership_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def required_dns_updates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateArgs]]]]): # -> None:
        ...
...
class AppHostingDomainCustomDomainStatusRequiredDnsUpdateArgs:
    def __init__(__self__, *, check_time: Optional[pulumi.Input[_builtins.str]] = ..., desireds: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredArgs]]]] = ..., discovereds: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDiscoveredArgs]]]] = ..., domain_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @check_time.setter
    def check_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @desireds.setter
    def desireds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredArgs]]]]): # -> None:
        ...
    ...
    @discovereds.setter
    def discovereds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDiscoveredArgs]]]]): # -> None:
        ...
...
class AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredArgs:
    def __init__(__self__, *, check_errors: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredCheckErrorArgs]]]] = ..., domain_name: Optional[pulumi.Input[_builtins.str]] = ..., records: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredRecordArgs]]]] = ...) -> None:
    ...
    @check_errors.setter
    def check_errors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredCheckErrorArgs]]]]): # -> None:
        ...
    ...
    @records.setter
    def records(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredRecordArgs]]]]): # -> None:
        ...
...
class AppHostingDomainCustomDomainStatusRequiredDnsUpdateDesiredRecordArgs:
    def __init__(__self__, *, domain_name: Optional[pulumi.Input[_builtins.str]] = ..., rdata: Optional[pulumi.Input[_builtins.str]] = ..., relevant_states: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., required_action: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @rdata.setter
    def rdata(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def relevant_states(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def required_action(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppHostingDomainCustomDomainStatusRequiredDnsUpdateDiscoveredArgs:
    def __init__(__self__, *, check_errors: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDiscoveredCheckErrorArgs]]]] = ..., domain_name: Optional[pulumi.Input[_builtins.str]] = ..., records: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDiscoveredRecordArgs]]]] = ...) -> None:
    ...
    @check_errors.setter
    def check_errors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDiscoveredCheckErrorArgs]]]]): # -> None:
        ...
    ...
    @records.setter
    def records(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingDomainCustomDomainStatusRequiredDnsUpdateDiscoveredRecordArgs]]]]): # -> None:
        ...
...
class AppHostingDomainServeArgs:
    def __init__(__self__, *, redirect: Optional[pulumi.Input[AppHostingDomainServeRedirectArgs]] = ...) -> None:
    ...
    @redirect.setter
    def redirect(self, value: Optional[pulumi.Input[AppHostingDomainServeRedirectArgs]]): # -> None:
        ...
...
class AppHostingDomainServeRedirectArgs:
    def __init__(__self__, *, uri: pulumi.Input[_builtins.str], status: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AppHostingTrafficCurrentArgs:
    def __init__(__self__, *, splits: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingTrafficCurrentSplitArgs]]]] = ...) -> None:
    ...
    @splits.setter
    def splits(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AppHostingTrafficCurrentSplitArgs]]]]): # -> None:
        ...
...
class AppHostingTrafficCurrentSplitArgs:
    def __init__(__self__, *, build: Optional[pulumi.Input[_builtins.str]] = ..., percent: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @build.setter
    def build(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppHostingTrafficRolloutPolicyArgs:
    def __init__(__self__, *, codebase_branch: Optional[pulumi.Input[_builtins.str]] = ..., disabled: Optional[pulumi.Input[_builtins.bool]] = ..., disabled_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def codebase_branch(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def disabled_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AppHostingTrafficTargetArgs:
    def __init__(__self__, *, splits: pulumi.Input[Sequence[pulumi.Input[AppHostingTrafficTargetSplitArgs]]]) -> None:
    ...
    @splits.setter
    def splits(self, value: pulumi.Input[Sequence[pulumi.Input[AppHostingTrafficTargetSplitArgs]]]): # -> None:
        ...
...
class AppHostingTrafficTargetSplitArgs:
    def __init__(__self__, *, build: pulumi.Input[_builtins.str], percent: pulumi.Input[_builtins.int]) -> None:
    ...
    @build.setter
    def build(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ExtensionsInstanceConfigArgs:
    def __init__(__self__, *, extension_ref: pulumi.Input[_builtins.str], params: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], allowed_event_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., eventarc_channel: Optional[pulumi.Input[_builtins.str]] = ..., extension_version: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., populated_postinstall_content: Optional[pulumi.Input[_builtins.str]] = ..., system_params: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def extension_ref(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def allowed_event_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def eventarc_channel(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def populated_postinstall_content(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def system_params(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ExtensionsInstanceRuntimeDataArgs:
    def __init__(__self__, *, fatal_error: Optional[pulumi.Input[ExtensionsInstanceRuntimeDataFatalErrorArgs]] = ..., processing_state: Optional[pulumi.Input[ExtensionsInstanceRuntimeDataProcessingStateArgs]] = ..., state_update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @fatal_error.setter
    def fatal_error(self, value: Optional[pulumi.Input[ExtensionsInstanceRuntimeDataFatalErrorArgs]]): # -> None:
        ...
    ...
    def processing_state(self, value: Optional[pulumi.Input[ExtensionsInstanceRuntimeDataProcessingStateArgs]]): # -> None:
        ...
    ...
    def state_update_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ExtensionsInstanceRuntimeDataFatalErrorArgs:
    def __init__(__self__, *, error_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ExtensionsInstanceRuntimeDataProcessingStateArgs:
    def __init__(__self__, *, detail_message: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def detail_message(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class HostingCustomDomainCertArgs:
    def __init__(__self__, *, state: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ..., verification: Optional[pulumi.Input[HostingCustomDomainCertVerificationArgs]] = ...) -> None:
    ...
    @verification.setter
    def verification(self, value: Optional[pulumi.Input[HostingCustomDomainCertVerificationArgs]]): # -> None:
        ...
...
class HostingCustomDomainCertVerificationArgs:
    def __init__(__self__, *, dns: Optional[pulumi.Input[HostingCustomDomainCertVerificationDnsArgs]] = ..., http: Optional[pulumi.Input[HostingCustomDomainCertVerificationHttpArgs]] = ...) -> None:
    ...
    @dns.setter
    def dns(self, value: Optional[pulumi.Input[HostingCustomDomainCertVerificationDnsArgs]]): # -> None:
        ...
    ...
    @http.setter
    def http(self, value: Optional[pulumi.Input[HostingCustomDomainCertVerificationHttpArgs]]): # -> None:
        ...
...
class HostingCustomDomainCertVerificationDnsArgs:
    def __init__(__self__, *, check_time: Optional[pulumi.Input[_builtins.str]] = ..., desireds: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainCertVerificationDnsDesiredArgs]]]] = ..., discovereds: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainCertVerificationDnsDiscoveredArgs]]]] = ...) -> None:
    ...
    @desireds.setter
    def desireds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainCertVerificationDnsDesiredArgs]]]]): # -> None:
        ...
    ...
    @discovereds.setter
    def discovereds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainCertVerificationDnsDiscoveredArgs]]]]): # -> None:
        ...
...
class HostingCustomDomainCertVerificationDnsDesiredArgs:
    def __init__(__self__, *, domain_name: Optional[pulumi.Input[_builtins.str]] = ..., records: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainCertVerificationDnsDesiredRecordArgs]]]] = ...) -> None:
    ...
    @records.setter
    def records(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainCertVerificationDnsDesiredRecordArgs]]]]): # -> None:
        ...
...
class HostingCustomDomainCertVerificationDnsDesiredRecordArgs:
    def __init__(__self__, *, domain_name: Optional[pulumi.Input[_builtins.str]] = ..., rdata: Optional[pulumi.Input[_builtins.str]] = ..., required_action: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class HostingCustomDomainCertVerificationDnsDiscoveredArgs:
    def __init__(__self__, *, domain_name: Optional[pulumi.Input[_builtins.str]] = ..., records: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainCertVerificationDnsDiscoveredRecordArgs]]]] = ...) -> None:
    ...
    @records.setter
    def records(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainCertVerificationDnsDiscoveredRecordArgs]]]]): # -> None:
        ...
...
class HostingCustomDomainCertVerificationHttpArgs:
    def __init__(__self__, *, desired: Optional[pulumi.Input[_builtins.str]] = ..., discovered: Optional[pulumi.Input[_builtins.str]] = ..., last_check_time: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @discovered.setter
    def discovered(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def last_check_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class HostingCustomDomainRequiredDnsUpdateArgs:
    def __init__(__self__, *, check_time: Optional[pulumi.Input[_builtins.str]] = ..., desireds: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainRequiredDnsUpdateDesiredArgs]]]] = ..., discovereds: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainRequiredDnsUpdateDiscoveredArgs]]]] = ...) -> None:
    ...
    @desireds.setter
    def desireds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainRequiredDnsUpdateDesiredArgs]]]]): # -> None:
        ...
    ...
    @discovereds.setter
    def discovereds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainRequiredDnsUpdateDiscoveredArgs]]]]): # -> None:
        ...
...
class HostingCustomDomainRequiredDnsUpdateDesiredArgs:
    def __init__(__self__, *, domain_name: Optional[pulumi.Input[_builtins.str]] = ..., records: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainRequiredDnsUpdateDesiredRecordArgs]]]] = ...) -> None:
    ...
    @records.setter
    def records(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainRequiredDnsUpdateDesiredRecordArgs]]]]): # -> None:
        ...
...
class HostingCustomDomainRequiredDnsUpdateDiscoveredArgs:
    def __init__(__self__, *, domain_name: Optional[pulumi.Input[_builtins.str]] = ..., records: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainRequiredDnsUpdateDiscoveredRecordArgs]]]] = ...) -> None:
    ...
    @records.setter
    def records(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HostingCustomDomainRequiredDnsUpdateDiscoveredRecordArgs]]]]): # -> None:
        ...
...
class HostingVersionConfigArgs:
    def __init__(__self__, *, headers: Optional[pulumi.Input[Sequence[pulumi.Input[HostingVersionConfigHeaderArgs]]]] = ..., redirects: Optional[pulumi.Input[Sequence[pulumi.Input[HostingVersionConfigRedirectArgs]]]] = ..., rewrites: Optional[pulumi.Input[Sequence[pulumi.Input[HostingVersionConfigRewriteArgs]]]] = ...) -> None:
    ...
    @headers.setter
    def headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HostingVersionConfigHeaderArgs]]]]): # -> None:
        ...
    ...
    @redirects.setter
    def redirects(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HostingVersionConfigRedirectArgs]]]]): # -> None:
        ...
    ...
    @rewrites.setter
    def rewrites(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[HostingVersionConfigRewriteArgs]]]]): # -> None:
        ...
...
class HostingVersionConfigHeaderArgs:
    def __init__(__self__, *, headers: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], glob: Optional[pulumi.Input[_builtins.str]] = ..., regex: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @headers.setter
    def headers(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    @glob.setter
    def glob(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class HostingVersionConfigRedirectArgs:
    def __init__(__self__, *, location: pulumi.Input[_builtins.str], status_code: pulumi.Input[_builtins.int], glob: Optional[pulumi.Input[_builtins.str]] = ..., regex: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class HostingVersionConfigRewriteArgs:
    def __init__(__self__, *, function: Optional[pulumi.Input[_builtins.str]] = ..., glob: Optional[pulumi.Input[_builtins.str]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., regex: Optional[pulumi.Input[_builtins.str]] = ..., run: Optional[pulumi.Input[HostingVersionConfigRewriteRunArgs]] = ...) -> None:
    ...
    @run.setter
    def run(self, value: Optional[pulumi.Input[HostingVersionConfigRewriteRunArgs]]): # -> None:
        ...
...
class HostingVersionConfigRewriteRunArgs:
    def __init__(__self__, *, service_id: pulumi.Input[_builtins.str], region: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
