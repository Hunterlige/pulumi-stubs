...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['InstanceGceSetupArgs', 'InstanceGceSetupArgsDict', 'InstanceGceSetupAcceleratorConfigArgs', 'InstanceGceSetupAcceleratorConfigArgsDict', 'InstanceGceSetupBootDiskArgs', 'InstanceGceSetupBootDiskArgsDict', 'InstanceGceSetupConfidentialInstanceConfigArgs', 'InstanceGceSetupConfidentialInstanceConfigArgsDict', 'InstanceGceSetupContainerImageArgs', 'InstanceGceSetupContainerImageArgsDict', 'InstanceGceSetupDataDisksArgs', 'InstanceGceSetupDataDisksArgsDict', 'InstanceGceSetupNetworkInterfaceArgs', 'InstanceGceSetupNetworkInterfaceArgsDict', 'InstanceGceSetupNetworkInterfaceAccessConfigArgs', ..., 'InstanceGceSetupReservationAffinityArgs', 'InstanceGceSetupReservationAffinityArgsDict', 'InstanceGceSetupServiceAccountArgs', 'InstanceGceSetupServiceAccountArgsDict', 'InstanceGceSetupShieldedInstanceConfigArgs', 'InstanceGceSetupShieldedInstanceConfigArgsDict', 'InstanceGceSetupVmImageArgs', 'InstanceGceSetupVmImageArgsDict', 'InstanceHealthInfoArgs', 'InstanceHealthInfoArgsDict', 'InstanceIamBindingConditionArgs', 'InstanceIamBindingConditionArgsDict', 'InstanceIamMemberConditionArgs', 'InstanceIamMemberConditionArgsDict', 'InstanceUpgradeHistoryArgs', 'InstanceUpgradeHistoryArgsDict']
...
class InstanceGceSetupArgs:
    def __init__(__self__, *, accelerator_configs: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceGceSetupAcceleratorConfigArgs]]]] = ..., boot_disk: Optional[pulumi.Input[InstanceGceSetupBootDiskArgs]] = ..., confidential_instance_config: Optional[pulumi.Input[InstanceGceSetupConfidentialInstanceConfigArgs]] = ..., container_image: Optional[pulumi.Input[InstanceGceSetupContainerImageArgs]] = ..., data_disks: Optional[pulumi.Input[InstanceGceSetupDataDisksArgs]] = ..., disable_public_ip: Optional[pulumi.Input[_builtins.bool]] = ..., enable_ip_forwarding: Optional[pulumi.Input[_builtins.bool]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., network_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceGceSetupNetworkInterfaceArgs]]]] = ..., reservation_affinity: Optional[pulumi.Input[InstanceGceSetupReservationAffinityArgs]] = ..., service_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceGceSetupServiceAccountArgs]]]] = ..., shielded_instance_config: Optional[pulumi.Input[InstanceGceSetupShieldedInstanceConfigArgs]] = ..., tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., vm_image: Optional[pulumi.Input[InstanceGceSetupVmImageArgs]] = ...) -> None:
    ...
    def accelerator_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceGceSetupAcceleratorConfigArgs]]]]): # -> None:
        ...
    ...
    @boot_disk.setter
    def boot_disk(self, value: Optional[pulumi.Input[InstanceGceSetupBootDiskArgs]]): # -> None:
        ...
    ...
    def confidential_instance_config(self, value: Optional[pulumi.Input[InstanceGceSetupConfidentialInstanceConfigArgs]]): # -> None:
        ...
    ...
    def container_image(self, value: Optional[pulumi.Input[InstanceGceSetupContainerImageArgs]]): # -> None:
        ...
    ...
    @data_disks.setter
    def data_disks(self, value: Optional[pulumi.Input[InstanceGceSetupDataDisksArgs]]): # -> None:
        ...
    ...
    def disable_public_ip(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def network_interfaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceGceSetupNetworkInterfaceArgs]]]]): # -> None:
        ...
    ...
    def reservation_affinity(self, value: Optional[pulumi.Input[InstanceGceSetupReservationAffinityArgs]]): # -> None:
        ...
    ...
    def service_accounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceGceSetupServiceAccountArgs]]]]): # -> None:
        ...
    ...
    def shielded_instance_config(self, value: Optional[pulumi.Input[InstanceGceSetupShieldedInstanceConfigArgs]]): # -> None:
        ...
    ...
    @vm_image.setter
    def vm_image(self, value: Optional[pulumi.Input[InstanceGceSetupVmImageArgs]]): # -> None:
        ...
...
class InstanceGceSetupAcceleratorConfigArgs:
    def __init__(__self__, *, core_count: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @core_count.setter
    def core_count(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class InstanceGceSetupBootDiskArgs:
    def __init__(__self__, *, disk_encryption: Optional[pulumi.Input[_builtins.str]] = ..., disk_size_gb: Optional[pulumi.Input[_builtins.str]] = ..., disk_type: Optional[pulumi.Input[_builtins.str]] = ..., kms_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceGceSetupConfidentialInstanceConfigArgs:
    def __init__(__self__, *, confidential_instance_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceGceSetupNetworkInterfaceArgs:
    def __init__(__self__, *, access_configs: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceGceSetupNetworkInterfaceAccessConfigArgs]]]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., nic_type: Optional[pulumi.Input[_builtins.str]] = ..., subnet: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def access_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[InstanceGceSetupNetworkInterfaceAccessConfigArgs]]]]): # -> None:
        ...
...
class InstanceGceSetupNetworkInterfaceAccessConfigArgs:
    ...
    @external_ip.setter
    def external_ip(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class InstanceGceSetupVmImageArgs:
    def __init__(__self__, *, family: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class InstanceUpgradeHistoryArgs:
    def __init__(__self__, *, action: Optional[pulumi.Input[_builtins.str]] = ..., container_image: Optional[pulumi.Input[_builtins.str]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., framework: Optional[pulumi.Input[_builtins.str]] = ..., snapshot: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., target_version: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ..., vm_image: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @vm_image.setter
    def vm_image(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
