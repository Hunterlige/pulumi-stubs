...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['InstanceGceSetup', 'InstanceGceSetupAcceleratorConfig', 'InstanceGceSetupBootDisk', 'InstanceGceSetupConfidentialInstanceConfig', 'InstanceGceSetupContainerImage', 'InstanceGceSetupDataDisks', 'InstanceGceSetupNetworkInterface', 'InstanceGceSetupNetworkInterfaceAccessConfig', 'InstanceGceSetupReservationAffinity', 'InstanceGceSetupServiceAccount', 'InstanceGceSetupShieldedInstanceConfig', 'InstanceGceSetupVmImage', 'InstanceHealthInfo', 'InstanceIamBindingCondition', 'InstanceIamMemberCondition', 'InstanceUpgradeHistory']
@pulumi.output_type
class InstanceGceSetup(dict):
    ...
    def __init__(__self__, *, accelerator_configs: Optional[Sequence[outputs.InstanceGceSetupAcceleratorConfig]] = ..., boot_disk: Optional[outputs.InstanceGceSetupBootDisk] = ..., confidential_instance_config: Optional[outputs.InstanceGceSetupConfidentialInstanceConfig] = ..., container_image: Optional[outputs.InstanceGceSetupContainerImage] = ..., data_disks: Optional[outputs.InstanceGceSetupDataDisks] = ..., disable_public_ip: Optional[_builtins.bool] = ..., enable_ip_forwarding: Optional[_builtins.bool] = ..., machine_type: Optional[_builtins.str] = ..., metadata: Optional[Mapping[str, _builtins.str]] = ..., network_interfaces: Optional[Sequence[outputs.InstanceGceSetupNetworkInterface]] = ..., reservation_affinity: Optional[outputs.InstanceGceSetupReservationAffinity] = ..., service_accounts: Optional[Sequence[outputs.InstanceGceSetupServiceAccount]] = ..., shielded_instance_config: Optional[outputs.InstanceGceSetupShieldedInstanceConfig] = ..., tags: Optional[Sequence[_builtins.str]] = ..., vm_image: Optional[outputs.InstanceGceSetupVmImage] = ...) -> None:
...
class InstanceGceSetupAcceleratorConfig(dict):
    ...
    def __init__(__self__, *, core_count: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class InstanceGceSetupBootDisk(dict):
    ...
    def __init__(__self__, *, disk_encryption: Optional[_builtins.str] = ..., disk_size_gb: Optional[_builtins.str] = ..., disk_type: Optional[_builtins.str] = ..., kms_key: Optional[_builtins.str] = ...) -> None:
...
class InstanceGceSetupConfidentialInstanceConfig(dict):
    ...
    def __init__(__self__, *, confidential_instance_type: Optional[_builtins.str] = ...) -> None:
...
class InstanceGceSetupNetworkInterface(dict):
    ...
    def __init__(__self__, *, access_configs: Optional[Sequence[outputs.InstanceGceSetupNetworkInterfaceAccessConfig]] = ..., network: Optional[_builtins.str] = ..., nic_type: Optional[_builtins.str] = ..., subnet: Optional[_builtins.str] = ...) -> None:
...
class InstanceGceSetupVmImage(dict):
    def __init__(__self__, *, family: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ...) -> None:
...
class InstanceUpgradeHistory(dict):
    ...
    def __init__(__self__, *, action: Optional[_builtins.str] = ..., container_image: Optional[_builtins.str] = ..., create_time: Optional[_builtins.str] = ..., framework: Optional[_builtins.str] = ..., snapshot: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ..., target_version: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ..., vm_image: Optional[_builtins.str] = ...) -> None:
