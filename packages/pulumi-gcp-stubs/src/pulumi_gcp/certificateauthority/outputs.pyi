...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AuthorityAccessUrl', 'AuthorityConfig', 'AuthorityConfigSubjectConfig', 'AuthorityConfigSubjectConfigSubject', 'AuthorityConfigSubjectConfigSubjectAltName', 'AuthorityConfigSubjectKeyId', 'AuthorityConfigX509Config', 'AuthorityConfigX509ConfigAdditionalExtension', ..., 'AuthorityConfigX509ConfigCaOptions', 'AuthorityConfigX509ConfigKeyUsage', 'AuthorityConfigX509ConfigKeyUsageBaseKeyUsage', 'AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage', ..., 'AuthorityConfigX509ConfigNameConstraints', 'AuthorityConfigX509ConfigPolicyId', 'AuthorityKeySpec', 'AuthoritySubordinateConfig', 'AuthoritySubordinateConfigPemIssuerChain', 'AuthorityUserDefinedAccessUrls', 'CaPoolEncryptionSpec', 'CaPoolIamBindingCondition', 'CaPoolIamMemberCondition', 'CaPoolIssuancePolicy', 'CaPoolIssuancePolicyAllowedIssuanceModes', 'CaPoolIssuancePolicyAllowedKeyType', 'CaPoolIssuancePolicyAllowedKeyTypeEllipticCurve', 'CaPoolIssuancePolicyAllowedKeyTypeRsa', 'CaPoolIssuancePolicyBaselineValues', ..., ..., 'CaPoolIssuancePolicyBaselineValuesCaOptions', 'CaPoolIssuancePolicyBaselineValuesKeyUsage', ..., ..., ..., 'CaPoolIssuancePolicyBaselineValuesNameConstraints', 'CaPoolIssuancePolicyBaselineValuesPolicyId', 'CaPoolIssuancePolicyIdentityConstraints', ..., 'CaPoolPublishingOptions', 'CertificateCertificateDescription', 'CertificateCertificateDescriptionAuthorityKeyId', 'CertificateCertificateDescriptionCertFingerprint', 'CertificateCertificateDescriptionPublicKey', ..., ..., ..., ..., ..., 'CertificateCertificateDescriptionSubjectKeyId', 'CertificateCertificateDescriptionX509Description', ..., ..., ..., ..., ..., ..., ..., ..., ..., 'CertificateConfig', 'CertificateConfigPublicKey', 'CertificateConfigSubjectConfig', 'CertificateConfigSubjectConfigSubject', 'CertificateConfigSubjectConfigSubjectAltName', 'CertificateConfigSubjectKeyId', 'CertificateConfigX509Config', 'CertificateConfigX509ConfigAdditionalExtension', ..., 'CertificateConfigX509ConfigCaOptions', 'CertificateConfigX509ConfigKeyUsage', 'CertificateConfigX509ConfigKeyUsageBaseKeyUsage', ..., ..., 'CertificateConfigX509ConfigNameConstraints', 'CertificateConfigX509ConfigPolicyId', 'CertificateRevocationDetail', 'CertificateTemplateIamBindingCondition', 'CertificateTemplateIamMemberCondition', 'CertificateTemplateIdentityConstraints', ..., 'CertificateTemplatePassthroughExtensions', ..., 'CertificateTemplatePredefinedValues', ..., ..., 'CertificateTemplatePredefinedValuesCaOptions', 'CertificateTemplatePredefinedValuesKeyUsage', ..., ..., ..., 'CertificateTemplatePredefinedValuesNameConstraints', 'CertificateTemplatePredefinedValuesPolicyId', 'GetAuthorityAccessUrlResult', 'GetAuthorityConfigResult', 'GetAuthorityConfigSubjectConfigResult', 'GetAuthorityConfigSubjectConfigSubjectResult', ..., 'GetAuthorityConfigSubjectKeyIdResult', 'GetAuthorityConfigX509ConfigResult', ..., ..., 'GetAuthorityConfigX509ConfigCaOptionResult', 'GetAuthorityConfigX509ConfigKeyUsageResult', ..., ..., ..., 'GetAuthorityConfigX509ConfigNameConstraintResult', 'GetAuthorityConfigX509ConfigPolicyIdResult', 'GetAuthorityKeySpecResult', 'GetAuthoritySubordinateConfigResult', 'GetAuthoritySubordinateConfigPemIssuerChainResult', 'GetAuthorityUserDefinedAccessUrlResult']
@pulumi.output_type
class AuthorityAccessUrl(dict):
    ...
    def __init__(__self__, *, ca_certificate_access_url: Optional[_builtins.str] = ..., crl_access_urls: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AuthorityConfig(dict):
    ...
    def __init__(__self__, *, subject_config: outputs.AuthorityConfigSubjectConfig, x509_config: outputs.AuthorityConfigX509Config, subject_key_id: Optional[outputs.AuthorityConfigSubjectKeyId] = ...) -> None:
...
class AuthorityConfigSubjectConfig(dict):
    ...
    def __init__(__self__, *, subject: outputs.AuthorityConfigSubjectConfigSubject, subject_alt_name: Optional[outputs.AuthorityConfigSubjectConfigSubjectAltName] = ...) -> None:
...
class AuthorityConfigSubjectConfigSubject(dict):
    ...
    def __init__(__self__, *, common_name: _builtins.str, country_code: Optional[_builtins.str] = ..., locality: Optional[_builtins.str] = ..., organization: Optional[_builtins.str] = ..., organizational_unit: Optional[_builtins.str] = ..., postal_code: Optional[_builtins.str] = ..., province: Optional[_builtins.str] = ..., street_address: Optional[_builtins.str] = ...) -> None:
...
class AuthorityConfigSubjectConfigSubjectAltName(dict):
    ...
    def __init__(__self__, *, dns_names: Optional[Sequence[_builtins.str]] = ..., email_addresses: Optional[Sequence[_builtins.str]] = ..., ip_addresses: Optional[Sequence[_builtins.str]] = ..., uris: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AuthorityConfigX509Config(dict):
    ...
    def __init__(__self__, *, ca_options: outputs.AuthorityConfigX509ConfigCaOptions, key_usage: outputs.AuthorityConfigX509ConfigKeyUsage, additional_extensions: Optional[Sequence[outputs.AuthorityConfigX509ConfigAdditionalExtension]] = ..., aia_ocsp_servers: Optional[Sequence[_builtins.str]] = ..., name_constraints: Optional[outputs.AuthorityConfigX509ConfigNameConstraints] = ..., policy_ids: Optional[Sequence[outputs.AuthorityConfigX509ConfigPolicyId]] = ...) -> None:
...
class AuthorityConfigX509ConfigAdditionalExtension(dict):
    ...
    def __init__(__self__, *, critical: _builtins.bool, object_id: outputs.AuthorityConfigX509ConfigAdditionalExtensionObjectId, value: _builtins.str) -> None:
...
class AuthorityConfigX509ConfigCaOptions(dict):
    ...
    def __init__(__self__, *, is_ca: _builtins.bool, max_issuer_path_length: Optional[_builtins.int] = ..., non_ca: Optional[_builtins.bool] = ..., zero_max_issuer_path_length: Optional[_builtins.bool] = ...) -> None:
...
class AuthorityConfigX509ConfigKeyUsage(dict):
    ...
    def __init__(__self__, *, base_key_usage: outputs.AuthorityConfigX509ConfigKeyUsageBaseKeyUsage, extended_key_usage: outputs.AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage, unknown_extended_key_usages: Optional[Sequence[outputs.AuthorityConfigX509ConfigKeyUsageUnknownExtendedKeyUsage]] = ...) -> None:
...
class AuthorityConfigX509ConfigKeyUsageBaseKeyUsage(dict):
    ...
    def __init__(__self__, *, cert_sign: Optional[_builtins.bool] = ..., content_commitment: Optional[_builtins.bool] = ..., crl_sign: Optional[_builtins.bool] = ..., data_encipherment: Optional[_builtins.bool] = ..., decipher_only: Optional[_builtins.bool] = ..., digital_signature: Optional[_builtins.bool] = ..., encipher_only: Optional[_builtins.bool] = ..., key_agreement: Optional[_builtins.bool] = ..., key_encipherment: Optional[_builtins.bool] = ...) -> None:
...
class AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage(dict):
    ...
    def __init__(__self__, *, client_auth: Optional[_builtins.bool] = ..., code_signing: Optional[_builtins.bool] = ..., email_protection: Optional[_builtins.bool] = ..., ocsp_signing: Optional[_builtins.bool] = ..., server_auth: Optional[_builtins.bool] = ..., time_stamping: Optional[_builtins.bool] = ...) -> None:
...
class AuthorityConfigX509ConfigNameConstraints(dict):
    ...
    def __init__(__self__, *, critical: _builtins.bool, excluded_dns_names: Optional[Sequence[_builtins.str]] = ..., excluded_email_addresses: Optional[Sequence[_builtins.str]] = ..., excluded_ip_ranges: Optional[Sequence[_builtins.str]] = ..., excluded_uris: Optional[Sequence[_builtins.str]] = ..., permitted_dns_names: Optional[Sequence[_builtins.str]] = ..., permitted_email_addresses: Optional[Sequence[_builtins.str]] = ..., permitted_ip_ranges: Optional[Sequence[_builtins.str]] = ..., permitted_uris: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AuthorityKeySpec(dict):
    ...
    def __init__(__self__, *, algorithm: Optional[_builtins.str] = ..., cloud_kms_key_version: Optional[_builtins.str] = ...) -> None:
...
class AuthoritySubordinateConfig(dict):
    ...
    def __init__(__self__, *, certificate_authority: Optional[_builtins.str] = ..., pem_issuer_chain: Optional[outputs.AuthoritySubordinateConfigPemIssuerChain] = ...) -> None:
...
class AuthoritySubordinateConfigPemIssuerChain(dict):
    ...
    def __init__(__self__, *, pem_certificates: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AuthorityUserDefinedAccessUrls(dict):
    ...
    def __init__(__self__, *, aia_issuing_certificate_urls: Optional[Sequence[_builtins.str]] = ..., crl_access_urls: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CaPoolIssuancePolicy(dict):
    ...
    def __init__(__self__, *, allowed_issuance_modes: Optional[outputs.CaPoolIssuancePolicyAllowedIssuanceModes] = ..., allowed_key_types: Optional[Sequence[outputs.CaPoolIssuancePolicyAllowedKeyType]] = ..., backdate_duration: Optional[_builtins.str] = ..., baseline_values: Optional[outputs.CaPoolIssuancePolicyBaselineValues] = ..., identity_constraints: Optional[outputs.CaPoolIssuancePolicyIdentityConstraints] = ..., maximum_lifetime: Optional[_builtins.str] = ...) -> None:
...
class CaPoolIssuancePolicyAllowedIssuanceModes(dict):
    ...
    def __init__(__self__, *, allow_config_based_issuance: _builtins.bool, allow_csr_based_issuance: _builtins.bool) -> None:
...
class CaPoolIssuancePolicyAllowedKeyType(dict):
    ...
    def __init__(__self__, *, elliptic_curve: Optional[outputs.CaPoolIssuancePolicyAllowedKeyTypeEllipticCurve] = ..., rsa: Optional[outputs.CaPoolIssuancePolicyAllowedKeyTypeRsa] = ...) -> None:
...
class CaPoolIssuancePolicyAllowedKeyTypeRsa(dict):
    ...
    def __init__(__self__, *, max_modulus_size: Optional[_builtins.str] = ..., min_modulus_size: Optional[_builtins.str] = ...) -> None:
...
class CaPoolIssuancePolicyBaselineValues(dict):
    ...
    def __init__(__self__, *, ca_options: outputs.CaPoolIssuancePolicyBaselineValuesCaOptions, key_usage: outputs.CaPoolIssuancePolicyBaselineValuesKeyUsage, additional_extensions: Optional[Sequence[outputs.CaPoolIssuancePolicyBaselineValuesAdditionalExtension]] = ..., aia_ocsp_servers: Optional[Sequence[_builtins.str]] = ..., name_constraints: Optional[outputs.CaPoolIssuancePolicyBaselineValuesNameConstraints] = ..., policy_ids: Optional[Sequence[outputs.CaPoolIssuancePolicyBaselineValuesPolicyId]] = ...) -> None:
...
class CaPoolIssuancePolicyBaselineValuesAdditionalExtension(dict):
    ...
    def __init__(__self__, *, critical: _builtins.bool, object_id: outputs.CaPoolIssuancePolicyBaselineValuesAdditionalExtensionObjectId, value: _builtins.str) -> None:
...
class CaPoolIssuancePolicyBaselineValuesCaOptions(dict):
    ...
    def __init__(__self__, *, is_ca: Optional[_builtins.bool] = ..., max_issuer_path_length: Optional[_builtins.int] = ..., non_ca: Optional[_builtins.bool] = ..., zero_max_issuer_path_length: Optional[_builtins.bool] = ...) -> None:
...
class CaPoolIssuancePolicyBaselineValuesKeyUsage(dict):
    ...
    def __init__(__self__, *, base_key_usage: outputs.CaPoolIssuancePolicyBaselineValuesKeyUsageBaseKeyUsage, extended_key_usage: outputs.CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsage, unknown_extended_key_usages: Optional[Sequence[outputs.CaPoolIssuancePolicyBaselineValuesKeyUsageUnknownExtendedKeyUsage]] = ...) -> None:
...
class CaPoolIssuancePolicyIdentityConstraints(dict):
    ...
    def __init__(__self__, *, allow_subject_alt_names_passthrough: _builtins.bool, allow_subject_passthrough: _builtins.bool, cel_expression: Optional[outputs.CaPoolIssuancePolicyIdentityConstraintsCelExpression] = ...) -> None:
...
class CaPoolPublishingOptions(dict):
    ...
    def __init__(__self__, *, publish_ca_cert: _builtins.bool, publish_crl: _builtins.bool, encoding_format: Optional[_builtins.str] = ...) -> None:
...
class CertificateCertificateDescription(dict):
    ...
    def __init__(__self__, *, aia_issuing_certificate_urls: Optional[Sequence[_builtins.str]] = ..., authority_key_ids: Optional[Sequence[outputs.CertificateCertificateDescriptionAuthorityKeyId]] = ..., cert_fingerprints: Optional[Sequence[outputs.CertificateCertificateDescriptionCertFingerprint]] = ..., crl_distribution_points: Optional[Sequence[_builtins.str]] = ..., public_keys: Optional[Sequence[outputs.CertificateCertificateDescriptionPublicKey]] = ..., subject_descriptions: Optional[Sequence[outputs.CertificateCertificateDescriptionSubjectDescription]] = ..., subject_key_ids: Optional[Sequence[outputs.CertificateCertificateDescriptionSubjectKeyId]] = ..., x509_descriptions: Optional[Sequence[outputs.CertificateCertificateDescriptionX509Description]] = ...) -> None:
...
class CertificateCertificateDescriptionPublicKey(dict):
    def __init__(__self__, *, format: Optional[_builtins.str] = ..., key: Optional[_builtins.str] = ...) -> None:
...
class CertificateCertificateDescriptionSubjectDescription(dict):
    ...
    def __init__(__self__, *, hex_serial_number: Optional[_builtins.str] = ..., lifetime: Optional[_builtins.str] = ..., not_after_time: Optional[_builtins.str] = ..., not_before_time: Optional[_builtins.str] = ..., subject_alt_names: Optional[Sequence[outputs.CertificateCertificateDescriptionSubjectDescriptionSubjectAltName]] = ..., subjects: Optional[Sequence[outputs.CertificateCertificateDescriptionSubjectDescriptionSubject]] = ...) -> None:
...
class CertificateCertificateDescriptionSubjectDescriptionSubject(dict):
    ...
    def __init__(__self__, *, common_name: Optional[_builtins.str] = ..., country_code: Optional[_builtins.str] = ..., locality: Optional[_builtins.str] = ..., organization: Optional[_builtins.str] = ..., organizational_unit: Optional[_builtins.str] = ..., postal_code: Optional[_builtins.str] = ..., province: Optional[_builtins.str] = ..., street_address: Optional[_builtins.str] = ...) -> None:
...
class CertificateCertificateDescriptionSubjectDescriptionSubjectAltName(dict):
    ...
    def __init__(__self__, *, custom_sans: Optional[Sequence[outputs.CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSan]] = ..., dns_names: Optional[Sequence[_builtins.str]] = ..., email_addresses: Optional[Sequence[_builtins.str]] = ..., ip_addresses: Optional[Sequence[_builtins.str]] = ..., uris: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSan(dict):
    ...
    def __init__(__self__, *, critical: Optional[_builtins.bool] = ..., obect_ids: Optional[Sequence[outputs.CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSanObectId]] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSanObectId(dict):
    ...
    def __init__(__self__, *, object_id_paths: Optional[Sequence[_builtins.int]] = ...) -> None:
...
class CertificateCertificateDescriptionX509Description(dict):
    ...
    def __init__(__self__, *, additional_extensions: Optional[Sequence[outputs.CertificateCertificateDescriptionX509DescriptionAdditionalExtension]] = ..., aia_ocsp_servers: Optional[Sequence[_builtins.str]] = ..., ca_options: Optional[Sequence[outputs.CertificateCertificateDescriptionX509DescriptionCaOption]] = ..., key_usages: Optional[Sequence[outputs.CertificateCertificateDescriptionX509DescriptionKeyUsage]] = ..., name_constraints: Optional[Sequence[outputs.CertificateCertificateDescriptionX509DescriptionNameConstraint]] = ..., policy_ids: Optional[Sequence[outputs.CertificateCertificateDescriptionX509DescriptionPolicyId]] = ...) -> None:
...
class CertificateCertificateDescriptionX509DescriptionAdditionalExtension(dict):
    ...
    def __init__(__self__, *, critical: Optional[_builtins.bool] = ..., object_ids: Optional[Sequence[outputs.CertificateCertificateDescriptionX509DescriptionAdditionalExtensionObjectId]] = ..., value: Optional[_builtins.str] = ...) -> None:
...
class CertificateCertificateDescriptionX509DescriptionCaOption(dict):
    ...
    def __init__(__self__, *, is_ca: Optional[_builtins.bool] = ..., max_issuer_path_length: Optional[_builtins.int] = ...) -> None:
...
class CertificateCertificateDescriptionX509DescriptionKeyUsage(dict):
    ...
    def __init__(__self__, *, base_key_usages: Optional[Sequence[outputs.CertificateCertificateDescriptionX509DescriptionKeyUsageBaseKeyUsage]] = ..., extended_key_usages: Optional[Sequence[outputs.CertificateCertificateDescriptionX509DescriptionKeyUsageExtendedKeyUsage]] = ..., unknown_extended_key_usages: Optional[Sequence[outputs.CertificateCertificateDescriptionX509DescriptionKeyUsageUnknownExtendedKeyUsage]] = ...) -> None:
...
class CertificateCertificateDescriptionX509DescriptionNameConstraint(dict):
    ...
    def __init__(__self__, *, critical: Optional[_builtins.bool] = ..., excluded_dns_names: Optional[Sequence[_builtins.str]] = ..., excluded_email_addresses: Optional[Sequence[_builtins.str]] = ..., excluded_ip_ranges: Optional[Sequence[_builtins.str]] = ..., excluded_uris: Optional[Sequence[_builtins.str]] = ..., permitted_dns_names: Optional[Sequence[_builtins.str]] = ..., permitted_email_addresses: Optional[Sequence[_builtins.str]] = ..., permitted_ip_ranges: Optional[Sequence[_builtins.str]] = ..., permitted_uris: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CertificateConfig(dict):
    ...
    def __init__(__self__, *, public_key: outputs.CertificateConfigPublicKey, subject_config: outputs.CertificateConfigSubjectConfig, x509_config: outputs.CertificateConfigX509Config, subject_key_id: Optional[outputs.CertificateConfigSubjectKeyId] = ...) -> None:
...
class CertificateConfigPublicKey(dict):
    def __init__(__self__, *, format: _builtins.str, key: Optional[_builtins.str] = ...) -> None:
...
class CertificateConfigSubjectConfig(dict):
    ...
    def __init__(__self__, *, subject: outputs.CertificateConfigSubjectConfigSubject, subject_alt_name: Optional[outputs.CertificateConfigSubjectConfigSubjectAltName] = ...) -> None:
...
class CertificateConfigSubjectConfigSubject(dict):
    ...
    def __init__(__self__, *, common_name: _builtins.str, organization: _builtins.str, country_code: Optional[_builtins.str] = ..., locality: Optional[_builtins.str] = ..., organizational_unit: Optional[_builtins.str] = ..., postal_code: Optional[_builtins.str] = ..., province: Optional[_builtins.str] = ..., street_address: Optional[_builtins.str] = ...) -> None:
...
class CertificateConfigX509Config(dict):
    ...
    def __init__(__self__, *, key_usage: outputs.CertificateConfigX509ConfigKeyUsage, additional_extensions: Optional[Sequence[outputs.CertificateConfigX509ConfigAdditionalExtension]] = ..., aia_ocsp_servers: Optional[Sequence[_builtins.str]] = ..., ca_options: Optional[outputs.CertificateConfigX509ConfigCaOptions] = ..., name_constraints: Optional[outputs.CertificateConfigX509ConfigNameConstraints] = ..., policy_ids: Optional[Sequence[outputs.CertificateConfigX509ConfigPolicyId]] = ...) -> None:
...
class CertificateConfigX509ConfigAdditionalExtension(dict):
    ...
    def __init__(__self__, *, critical: _builtins.bool, object_id: outputs.CertificateConfigX509ConfigAdditionalExtensionObjectId, value: _builtins.str) -> None:
...
class CertificateConfigX509ConfigKeyUsage(dict):
    ...
    def __init__(__self__, *, base_key_usage: outputs.CertificateConfigX509ConfigKeyUsageBaseKeyUsage, extended_key_usage: outputs.CertificateConfigX509ConfigKeyUsageExtendedKeyUsage, unknown_extended_key_usages: Optional[Sequence[outputs.CertificateConfigX509ConfigKeyUsageUnknownExtendedKeyUsage]] = ...) -> None:
...
class CertificateRevocationDetail(dict):
    ...
    def __init__(__self__, *, revocation_state: Optional[_builtins.str] = ..., revocation_time: Optional[_builtins.str] = ...) -> None:
...
class CertificateTemplateIdentityConstraints(dict):
    ...
    def __init__(__self__, *, allow_subject_alt_names_passthrough: _builtins.bool, allow_subject_passthrough: _builtins.bool, cel_expression: Optional[outputs.CertificateTemplateIdentityConstraintsCelExpression] = ...) -> None:
...
class CertificateTemplatePassthroughExtensions(dict):
    ...
    def __init__(__self__, *, additional_extensions: Optional[Sequence[outputs.CertificateTemplatePassthroughExtensionsAdditionalExtension]] = ..., known_extensions: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CertificateTemplatePredefinedValues(dict):
    ...
    def __init__(__self__, *, additional_extensions: Optional[Sequence[outputs.CertificateTemplatePredefinedValuesAdditionalExtension]] = ..., aia_ocsp_servers: Optional[Sequence[_builtins.str]] = ..., ca_options: Optional[outputs.CertificateTemplatePredefinedValuesCaOptions] = ..., key_usage: Optional[outputs.CertificateTemplatePredefinedValuesKeyUsage] = ..., name_constraints: Optional[outputs.CertificateTemplatePredefinedValuesNameConstraints] = ..., policy_ids: Optional[Sequence[outputs.CertificateTemplatePredefinedValuesPolicyId]] = ...) -> None:
...
class CertificateTemplatePredefinedValuesAdditionalExtension(dict):
    ...
    def __init__(__self__, *, object_id: outputs.CertificateTemplatePredefinedValuesAdditionalExtensionObjectId, value: _builtins.str, critical: Optional[_builtins.bool] = ...) -> None:
...
class CertificateTemplatePredefinedValuesCaOptions(dict):
    ...
    def __init__(__self__, *, is_ca: Optional[_builtins.bool] = ..., max_issuer_path_length: Optional[_builtins.int] = ..., null_ca: Optional[_builtins.bool] = ..., zero_max_issuer_path_length: Optional[_builtins.bool] = ...) -> None:
...
class CertificateTemplatePredefinedValuesKeyUsage(dict):
    ...
    def __init__(__self__, *, base_key_usage: Optional[outputs.CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsage] = ..., extended_key_usage: Optional[outputs.CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsage] = ..., unknown_extended_key_usages: Optional[Sequence[outputs.CertificateTemplatePredefinedValuesKeyUsageUnknownExtendedKeyUsage]] = ...) -> None:
...
class GetAuthorityAccessUrlResult(dict):
    def __init__(__self__, *, ca_certificate_access_url: _builtins.str, crl_access_urls: Sequence[_builtins.str]) -> None:
...
class GetAuthorityConfigResult(dict):
    def __init__(__self__, *, subject_configs: Sequence[outputs.GetAuthorityConfigSubjectConfigResult], subject_key_ids: Sequence[outputs.GetAuthorityConfigSubjectKeyIdResult], x509_configs: Sequence[outputs.GetAuthorityConfigX509ConfigResult]) -> None:
...
class GetAuthorityConfigSubjectConfigResult(dict):
    def __init__(__self__, *, subject_alt_names: Sequence[outputs.GetAuthorityConfigSubjectConfigSubjectAltNameResult], subjects: Sequence[outputs.GetAuthorityConfigSubjectConfigSubjectResult]) -> None:
...
class GetAuthorityConfigSubjectConfigSubjectResult(dict):
    def __init__(__self__, *, common_name: _builtins.str, country_code: _builtins.str, locality: _builtins.str, organization: _builtins.str, organizational_unit: _builtins.str, postal_code: _builtins.str, province: _builtins.str, street_address: _builtins.str) -> None:
...
class GetAuthorityConfigSubjectConfigSubjectAltNameResult(dict):
    def __init__(__self__, *, dns_names: Sequence[_builtins.str], email_addresses: Sequence[_builtins.str], ip_addresses: Sequence[_builtins.str], uris: Sequence[_builtins.str]) -> None:
...
class GetAuthorityConfigX509ConfigResult(dict):
    def __init__(__self__, *, additional_extensions: Sequence[outputs.GetAuthorityConfigX509ConfigAdditionalExtensionResult], aia_ocsp_servers: Sequence[_builtins.str], ca_options: Sequence[outputs.GetAuthorityConfigX509ConfigCaOptionResult], key_usages: Sequence[outputs.GetAuthorityConfigX509ConfigKeyUsageResult], name_constraints: Sequence[outputs.GetAuthorityConfigX509ConfigNameConstraintResult], policy_ids: Sequence[outputs.GetAuthorityConfigX509ConfigPolicyIdResult]) -> None:
...
class GetAuthorityConfigX509ConfigAdditionalExtensionResult(dict):
    def __init__(__self__, *, critical: _builtins.bool, object_ids: Sequence[outputs.GetAuthorityConfigX509ConfigAdditionalExtensionObjectIdResult], value: _builtins.str) -> None:
...
class GetAuthorityConfigX509ConfigCaOptionResult(dict):
    def __init__(__self__, *, is_ca: _builtins.bool, max_issuer_path_length: _builtins.int, non_ca: _builtins.bool, zero_max_issuer_path_length: _builtins.bool) -> None:
...
class GetAuthorityConfigX509ConfigKeyUsageResult(dict):
    def __init__(__self__, *, base_key_usages: Sequence[outputs.GetAuthorityConfigX509ConfigKeyUsageBaseKeyUsageResult], extended_key_usages: Sequence[outputs.GetAuthorityConfigX509ConfigKeyUsageExtendedKeyUsageResult], unknown_extended_key_usages: Sequence[outputs.GetAuthorityConfigX509ConfigKeyUsageUnknownExtendedKeyUsageResult]) -> None:
...
class GetAuthorityConfigX509ConfigKeyUsageBaseKeyUsageResult(dict):
    def __init__(__self__, *, cert_sign: _builtins.bool, content_commitment: _builtins.bool, crl_sign: _builtins.bool, data_encipherment: _builtins.bool, decipher_only: _builtins.bool, digital_signature: _builtins.bool, encipher_only: _builtins.bool, key_agreement: _builtins.bool, key_encipherment: _builtins.bool) -> None:
...
class GetAuthorityConfigX509ConfigKeyUsageExtendedKeyUsageResult(dict):
    def __init__(__self__, *, client_auth: _builtins.bool, code_signing: _builtins.bool, email_protection: _builtins.bool, ocsp_signing: _builtins.bool, server_auth: _builtins.bool, time_stamping: _builtins.bool) -> None:
...
class GetAuthorityConfigX509ConfigNameConstraintResult(dict):
    def __init__(__self__, *, critical: _builtins.bool, excluded_dns_names: Sequence[_builtins.str], excluded_email_addresses: Sequence[_builtins.str], excluded_ip_ranges: Sequence[_builtins.str], excluded_uris: Sequence[_builtins.str], permitted_dns_names: Sequence[_builtins.str], permitted_email_addresses: Sequence[_builtins.str], permitted_ip_ranges: Sequence[_builtins.str], permitted_uris: Sequence[_builtins.str]) -> None:
...
class GetAuthorityKeySpecResult(dict):
    def __init__(__self__, *, algorithm: _builtins.str, cloud_kms_key_version: _builtins.str) -> None:
...
class GetAuthoritySubordinateConfigResult(dict):
    def __init__(__self__, *, certificate_authority: _builtins.str, pem_issuer_chains: Sequence[outputs.GetAuthoritySubordinateConfigPemIssuerChainResult]) -> None:
...
class GetAuthorityUserDefinedAccessUrlResult(dict):
    def __init__(__self__, *, aia_issuing_certificate_urls: Sequence[_builtins.str], crl_access_urls: Sequence[_builtins.str]) -> None:
