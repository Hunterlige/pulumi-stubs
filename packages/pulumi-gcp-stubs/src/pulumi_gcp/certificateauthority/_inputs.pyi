...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AuthorityAccessUrlArgs', 'AuthorityAccessUrlArgsDict', 'AuthorityConfigArgs', 'AuthorityConfigArgsDict', 'AuthorityConfigSubjectConfigArgs', 'AuthorityConfigSubjectConfigArgsDict', 'AuthorityConfigSubjectConfigSubjectArgs', 'AuthorityConfigSubjectConfigSubjectArgsDict', 'AuthorityConfigSubjectConfigSubjectAltNameArgs', 'AuthorityConfigSubjectConfigSubjectAltNameArgsDict', 'AuthorityConfigSubjectKeyIdArgs', 'AuthorityConfigSubjectKeyIdArgsDict', 'AuthorityConfigX509ConfigArgs', 'AuthorityConfigX509ConfigArgsDict', 'AuthorityConfigX509ConfigAdditionalExtensionArgs', ..., ..., ..., 'AuthorityConfigX509ConfigCaOptionsArgs', 'AuthorityConfigX509ConfigCaOptionsArgsDict', 'AuthorityConfigX509ConfigKeyUsageArgs', 'AuthorityConfigX509ConfigKeyUsageArgsDict', 'AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs', ..., ..., ..., ..., ..., 'AuthorityConfigX509ConfigNameConstraintsArgs', 'AuthorityConfigX509ConfigNameConstraintsArgsDict', 'AuthorityConfigX509ConfigPolicyIdArgs', 'AuthorityConfigX509ConfigPolicyIdArgsDict', 'AuthorityKeySpecArgs', 'AuthorityKeySpecArgsDict', 'AuthoritySubordinateConfigArgs', 'AuthoritySubordinateConfigArgsDict', 'AuthoritySubordinateConfigPemIssuerChainArgs', 'AuthoritySubordinateConfigPemIssuerChainArgsDict', 'AuthorityUserDefinedAccessUrlsArgs', 'AuthorityUserDefinedAccessUrlsArgsDict', 'CaPoolEncryptionSpecArgs', 'CaPoolEncryptionSpecArgsDict', 'CaPoolIamBindingConditionArgs', 'CaPoolIamBindingConditionArgsDict', 'CaPoolIamMemberConditionArgs', 'CaPoolIamMemberConditionArgsDict', 'CaPoolIssuancePolicyArgs', 'CaPoolIssuancePolicyArgsDict', 'CaPoolIssuancePolicyAllowedIssuanceModesArgs', 'CaPoolIssuancePolicyAllowedIssuanceModesArgsDict', 'CaPoolIssuancePolicyAllowedKeyTypeArgs', 'CaPoolIssuancePolicyAllowedKeyTypeArgsDict', ..., ..., 'CaPoolIssuancePolicyAllowedKeyTypeRsaArgs', 'CaPoolIssuancePolicyAllowedKeyTypeRsaArgsDict', 'CaPoolIssuancePolicyBaselineValuesArgs', 'CaPoolIssuancePolicyBaselineValuesArgsDict', ..., ..., ..., ..., 'CaPoolIssuancePolicyBaselineValuesCaOptionsArgs', ..., 'CaPoolIssuancePolicyBaselineValuesKeyUsageArgs', 'CaPoolIssuancePolicyBaselineValuesKeyUsageArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'CaPoolIssuancePolicyBaselineValuesPolicyIdArgs', 'CaPoolIssuancePolicyBaselineValuesPolicyIdArgsDict', 'CaPoolIssuancePolicyIdentityConstraintsArgs', 'CaPoolIssuancePolicyIdentityConstraintsArgsDict', ..., ..., 'CaPoolPublishingOptionsArgs', 'CaPoolPublishingOptionsArgsDict', 'CertificateCertificateDescriptionArgs', 'CertificateCertificateDescriptionArgsDict', ..., ..., ..., ..., 'CertificateCertificateDescriptionPublicKeyArgs', 'CertificateCertificateDescriptionPublicKeyArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'CertificateCertificateDescriptionSubjectKeyIdArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'CertificateConfigArgs', 'CertificateConfigArgsDict', 'CertificateConfigPublicKeyArgs', 'CertificateConfigPublicKeyArgsDict', 'CertificateConfigSubjectConfigArgs', 'CertificateConfigSubjectConfigArgsDict', 'CertificateConfigSubjectConfigSubjectArgs', 'CertificateConfigSubjectConfigSubjectArgsDict', 'CertificateConfigSubjectConfigSubjectAltNameArgs', ..., 'CertificateConfigSubjectKeyIdArgs', 'CertificateConfigSubjectKeyIdArgsDict', 'CertificateConfigX509ConfigArgs', 'CertificateConfigX509ConfigArgsDict', 'CertificateConfigX509ConfigAdditionalExtensionArgs', ..., ..., ..., 'CertificateConfigX509ConfigCaOptionsArgs', 'CertificateConfigX509ConfigCaOptionsArgsDict', 'CertificateConfigX509ConfigKeyUsageArgs', 'CertificateConfigX509ConfigKeyUsageArgsDict', ..., ..., ..., ..., ..., ..., 'CertificateConfigX509ConfigNameConstraintsArgs', 'CertificateConfigX509ConfigNameConstraintsArgsDict', 'CertificateConfigX509ConfigPolicyIdArgs', 'CertificateConfigX509ConfigPolicyIdArgsDict', 'CertificateRevocationDetailArgs', 'CertificateRevocationDetailArgsDict', 'CertificateTemplateIamBindingConditionArgs', 'CertificateTemplateIamBindingConditionArgsDict', 'CertificateTemplateIamMemberConditionArgs', 'CertificateTemplateIamMemberConditionArgsDict', 'CertificateTemplateIdentityConstraintsArgs', 'CertificateTemplateIdentityConstraintsArgsDict', ..., ..., 'CertificateTemplatePassthroughExtensionsArgs', 'CertificateTemplatePassthroughExtensionsArgsDict', ..., ..., 'CertificateTemplatePredefinedValuesArgs', 'CertificateTemplatePredefinedValuesArgsDict', ..., ..., ..., ..., 'CertificateTemplatePredefinedValuesCaOptionsArgs', ..., 'CertificateTemplatePredefinedValuesKeyUsageArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., 'CertificateTemplatePredefinedValuesPolicyIdArgs', ...]
...
class AuthorityAccessUrlArgs:
    def __init__(__self__, *, ca_certificate_access_url: Optional[pulumi.Input[_builtins.str]] = ..., crl_access_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def ca_certificate_access_url(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def crl_access_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AuthorityConfigArgs:
    def __init__(__self__, *, subject_config: pulumi.Input[AuthorityConfigSubjectConfigArgs], x509_config: pulumi.Input[AuthorityConfigX509ConfigArgs], subject_key_id: Optional[pulumi.Input[AuthorityConfigSubjectKeyIdArgs]] = ...) -> None:
    ...
    def subject_config(self, value: pulumi.Input[AuthorityConfigSubjectConfigArgs]): # -> None:
        ...
    ...
    @x509_config.setter
    def x509_config(self, value: pulumi.Input[AuthorityConfigX509ConfigArgs]): # -> None:
        ...
    ...
    def subject_key_id(self, value: Optional[pulumi.Input[AuthorityConfigSubjectKeyIdArgs]]): # -> None:
        ...
...
class AuthorityConfigSubjectConfigArgs:
    def __init__(__self__, *, subject: pulumi.Input[AuthorityConfigSubjectConfigSubjectArgs], subject_alt_name: Optional[pulumi.Input[AuthorityConfigSubjectConfigSubjectAltNameArgs]] = ...) -> None:
    ...
    @subject.setter
    def subject(self, value: pulumi.Input[AuthorityConfigSubjectConfigSubjectArgs]): # -> None:
        ...
    ...
    def subject_alt_name(self, value: Optional[pulumi.Input[AuthorityConfigSubjectConfigSubjectAltNameArgs]]): # -> None:
        ...
...
class AuthorityConfigSubjectConfigSubjectArgs:
    def __init__(__self__, *, common_name: pulumi.Input[_builtins.str], country_code: Optional[pulumi.Input[_builtins.str]] = ..., locality: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., organizational_unit: Optional[pulumi.Input[_builtins.str]] = ..., postal_code: Optional[pulumi.Input[_builtins.str]] = ..., province: Optional[pulumi.Input[_builtins.str]] = ..., street_address: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @common_name.setter
    def common_name(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @province.setter
    def province(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def street_address(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AuthorityConfigSubjectConfigSubjectAltNameArgs:
    def __init__(__self__, *, dns_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., email_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @dns_names.setter
    def dns_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @uris.setter
    def uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AuthorityConfigSubjectKeyIdArgs:
    def __init__(__self__, *, key_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AuthorityConfigX509ConfigArgs:
    def __init__(__self__, *, ca_options: pulumi.Input[AuthorityConfigX509ConfigCaOptionsArgs], key_usage: pulumi.Input[AuthorityConfigX509ConfigKeyUsageArgs], additional_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[AuthorityConfigX509ConfigAdditionalExtensionArgs]]]] = ..., aia_ocsp_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., name_constraints: Optional[pulumi.Input[AuthorityConfigX509ConfigNameConstraintsArgs]] = ..., policy_ids: Optional[pulumi.Input[Sequence[pulumi.Input[AuthorityConfigX509ConfigPolicyIdArgs]]]] = ...) -> None:
    ...
    @ca_options.setter
    def ca_options(self, value: pulumi.Input[AuthorityConfigX509ConfigCaOptionsArgs]): # -> None:
        ...
    ...
    @key_usage.setter
    def key_usage(self, value: pulumi.Input[AuthorityConfigX509ConfigKeyUsageArgs]): # -> None:
        ...
    ...
    def additional_extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AuthorityConfigX509ConfigAdditionalExtensionArgs]]]]): # -> None:
        ...
    ...
    def aia_ocsp_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def name_constraints(self, value: Optional[pulumi.Input[AuthorityConfigX509ConfigNameConstraintsArgs]]): # -> None:
        ...
    ...
    @policy_ids.setter
    def policy_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AuthorityConfigX509ConfigPolicyIdArgs]]]]): # -> None:
        ...
...
class AuthorityConfigX509ConfigAdditionalExtensionArgs:
    def __init__(__self__, *, critical: pulumi.Input[_builtins.bool], object_id: pulumi.Input[AuthorityConfigX509ConfigAdditionalExtensionObjectIdArgs], value: pulumi.Input[_builtins.str]) -> None:
    ...
    @critical.setter
    def critical(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    @object_id.setter
    def object_id(self, value: pulumi.Input[AuthorityConfigX509ConfigAdditionalExtensionObjectIdArgs]): # -> None:
        ...
...
class AuthorityConfigX509ConfigAdditionalExtensionObjectIdArgs:
    def __init__(__self__, *, object_id_paths: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]) -> None:
    ...
    def object_id_paths(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]): # -> None:
        ...
...
class AuthorityConfigX509ConfigCaOptionsArgs:
    def __init__(__self__, *, is_ca: pulumi.Input[_builtins.bool], max_issuer_path_length: Optional[pulumi.Input[_builtins.int]] = ..., non_ca: Optional[pulumi.Input[_builtins.bool]] = ..., zero_max_issuer_path_length: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @is_ca.setter
    def is_ca(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def max_issuer_path_length(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @non_ca.setter
    def non_ca(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def zero_max_issuer_path_length(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class AuthorityConfigX509ConfigKeyUsageArgs:
    def __init__(__self__, *, base_key_usage: pulumi.Input[AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs], extended_key_usage: pulumi.Input[AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs], unknown_extended_key_usages: Optional[pulumi.Input[Sequence[pulumi.Input[AuthorityConfigX509ConfigKeyUsageUnknownExtendedKeyUsageArgs]]]] = ...) -> None:
    ...
    def base_key_usage(self, value: pulumi.Input[AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs]): # -> None:
        ...
    ...
    def extended_key_usage(self, value: pulumi.Input[AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs]): # -> None:
        ...
    ...
    def unknown_extended_key_usages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AuthorityConfigX509ConfigKeyUsageUnknownExtendedKeyUsageArgs]]]]): # -> None:
        ...
...
class AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs:
    def __init__(__self__, *, cert_sign: Optional[pulumi.Input[_builtins.bool]] = ..., content_commitment: Optional[pulumi.Input[_builtins.bool]] = ..., crl_sign: Optional[pulumi.Input[_builtins.bool]] = ..., data_encipherment: Optional[pulumi.Input[_builtins.bool]] = ..., decipher_only: Optional[pulumi.Input[_builtins.bool]] = ..., digital_signature: Optional[pulumi.Input[_builtins.bool]] = ..., encipher_only: Optional[pulumi.Input[_builtins.bool]] = ..., key_agreement: Optional[pulumi.Input[_builtins.bool]] = ..., key_encipherment: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @cert_sign.setter
    def cert_sign(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def content_commitment(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @crl_sign.setter
    def crl_sign(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def data_encipherment(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def decipher_only(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def digital_signature(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def encipher_only(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def key_agreement(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def key_encipherment(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs:
    def __init__(__self__, *, client_auth: Optional[pulumi.Input[_builtins.bool]] = ..., code_signing: Optional[pulumi.Input[_builtins.bool]] = ..., email_protection: Optional[pulumi.Input[_builtins.bool]] = ..., ocsp_signing: Optional[pulumi.Input[_builtins.bool]] = ..., server_auth: Optional[pulumi.Input[_builtins.bool]] = ..., time_stamping: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @client_auth.setter
    def client_auth(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @code_signing.setter
    def code_signing(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def email_protection(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @ocsp_signing.setter
    def ocsp_signing(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @server_auth.setter
    def server_auth(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def time_stamping(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class AuthorityConfigX509ConfigNameConstraintsArgs:
    def __init__(__self__, *, critical: pulumi.Input[_builtins.bool], excluded_dns_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., excluded_email_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., excluded_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., excluded_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., permitted_dns_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., permitted_email_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., permitted_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., permitted_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def excluded_dns_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def excluded_email_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def excluded_ip_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def excluded_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def permitted_dns_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def permitted_email_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def permitted_ip_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def permitted_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AuthorityKeySpecArgs:
    def __init__(__self__, *, algorithm: Optional[pulumi.Input[_builtins.str]] = ..., cloud_kms_key_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cloud_kms_key_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AuthoritySubordinateConfigArgs:
    def __init__(__self__, *, certificate_authority: Optional[pulumi.Input[_builtins.str]] = ..., pem_issuer_chain: Optional[pulumi.Input[AuthoritySubordinateConfigPemIssuerChainArgs]] = ...) -> None:
    ...
    def certificate_authority(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def pem_issuer_chain(self, value: Optional[pulumi.Input[AuthoritySubordinateConfigPemIssuerChainArgs]]): # -> None:
        ...
...
class AuthoritySubordinateConfigPemIssuerChainArgs:
    def __init__(__self__, *, pem_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def pem_certificates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AuthorityUserDefinedAccessUrlsArgs:
    def __init__(__self__, *, aia_issuing_certificate_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., crl_access_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def aia_issuing_certificate_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class CaPoolEncryptionSpecArgs:
    def __init__(__self__, *, cloud_kms_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cloud_kms_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CaPoolIssuancePolicyArgs:
    def __init__(__self__, *, allowed_issuance_modes: Optional[pulumi.Input[CaPoolIssuancePolicyAllowedIssuanceModesArgs]] = ..., allowed_key_types: Optional[pulumi.Input[Sequence[pulumi.Input[CaPoolIssuancePolicyAllowedKeyTypeArgs]]]] = ..., backdate_duration: Optional[pulumi.Input[_builtins.str]] = ..., baseline_values: Optional[pulumi.Input[CaPoolIssuancePolicyBaselineValuesArgs]] = ..., identity_constraints: Optional[pulumi.Input[CaPoolIssuancePolicyIdentityConstraintsArgs]] = ..., maximum_lifetime: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allowed_issuance_modes(self, value: Optional[pulumi.Input[CaPoolIssuancePolicyAllowedIssuanceModesArgs]]): # -> None:
        ...
    ...
    def allowed_key_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CaPoolIssuancePolicyAllowedKeyTypeArgs]]]]): # -> None:
        ...
    ...
    def backdate_duration(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def baseline_values(self, value: Optional[pulumi.Input[CaPoolIssuancePolicyBaselineValuesArgs]]): # -> None:
        ...
    ...
    def identity_constraints(self, value: Optional[pulumi.Input[CaPoolIssuancePolicyIdentityConstraintsArgs]]): # -> None:
        ...
...
class CaPoolIssuancePolicyAllowedIssuanceModesArgs:
    def __init__(__self__, *, allow_config_based_issuance: pulumi.Input[_builtins.bool], allow_csr_based_issuance: pulumi.Input[_builtins.bool]) -> None:
    ...
    def allow_config_based_issuance(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def allow_csr_based_issuance(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class CaPoolIssuancePolicyAllowedKeyTypeArgs:
    def __init__(__self__, *, elliptic_curve: Optional[pulumi.Input[CaPoolIssuancePolicyAllowedKeyTypeEllipticCurveArgs]] = ..., rsa: Optional[pulumi.Input[CaPoolIssuancePolicyAllowedKeyTypeRsaArgs]] = ...) -> None:
    ...
    def elliptic_curve(self, value: Optional[pulumi.Input[CaPoolIssuancePolicyAllowedKeyTypeEllipticCurveArgs]]): # -> None:
        ...
    ...
    @rsa.setter
    def rsa(self, value: Optional[pulumi.Input[CaPoolIssuancePolicyAllowedKeyTypeRsaArgs]]): # -> None:
        ...
...
class CaPoolIssuancePolicyAllowedKeyTypeEllipticCurveArgs:
    def __init__(__self__, *, signature_algorithm: pulumi.Input[_builtins.str]) -> None:
    ...
    def signature_algorithm(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class CaPoolIssuancePolicyAllowedKeyTypeRsaArgs:
    def __init__(__self__, *, max_modulus_size: Optional[pulumi.Input[_builtins.str]] = ..., min_modulus_size: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def max_modulus_size(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def min_modulus_size(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CaPoolIssuancePolicyBaselineValuesArgs:
    def __init__(__self__, *, ca_options: pulumi.Input[CaPoolIssuancePolicyBaselineValuesCaOptionsArgs], key_usage: pulumi.Input[CaPoolIssuancePolicyBaselineValuesKeyUsageArgs], additional_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[CaPoolIssuancePolicyBaselineValuesAdditionalExtensionArgs]]]] = ..., aia_ocsp_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., name_constraints: Optional[pulumi.Input[CaPoolIssuancePolicyBaselineValuesNameConstraintsArgs]] = ..., policy_ids: Optional[pulumi.Input[Sequence[pulumi.Input[CaPoolIssuancePolicyBaselineValuesPolicyIdArgs]]]] = ...) -> None:
    ...
    @ca_options.setter
    def ca_options(self, value: pulumi.Input[CaPoolIssuancePolicyBaselineValuesCaOptionsArgs]): # -> None:
        ...
    ...
    @key_usage.setter
    def key_usage(self, value: pulumi.Input[CaPoolIssuancePolicyBaselineValuesKeyUsageArgs]): # -> None:
        ...
    ...
    @additional_extensions.setter
    def additional_extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CaPoolIssuancePolicyBaselineValuesAdditionalExtensionArgs]]]]): # -> None:
        ...
    ...
    @name_constraints.setter
    def name_constraints(self, value: Optional[pulumi.Input[CaPoolIssuancePolicyBaselineValuesNameConstraintsArgs]]): # -> None:
        ...
    ...
    @policy_ids.setter
    def policy_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CaPoolIssuancePolicyBaselineValuesPolicyIdArgs]]]]): # -> None:
        ...
...
class CaPoolIssuancePolicyBaselineValuesAdditionalExtensionArgs:
    def __init__(__self__, *, critical: pulumi.Input[_builtins.bool], object_id: pulumi.Input[CaPoolIssuancePolicyBaselineValuesAdditionalExtensionObjectIdArgs], value: pulumi.Input[_builtins.str]) -> None:
    ...
    @object_id.setter
    def object_id(self, value: pulumi.Input[CaPoolIssuancePolicyBaselineValuesAdditionalExtensionObjectIdArgs]): # -> None:
        ...
...
class CaPoolIssuancePolicyBaselineValuesCaOptionsArgs:
    def __init__(__self__, *, is_ca: Optional[pulumi.Input[_builtins.bool]] = ..., max_issuer_path_length: Optional[pulumi.Input[_builtins.int]] = ..., non_ca: Optional[pulumi.Input[_builtins.bool]] = ..., zero_max_issuer_path_length: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @is_ca.setter
    def is_ca(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class CaPoolIssuancePolicyBaselineValuesKeyUsageArgs:
    def __init__(__self__, *, base_key_usage: pulumi.Input[CaPoolIssuancePolicyBaselineValuesKeyUsageBaseKeyUsageArgs], extended_key_usage: pulumi.Input[CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsageArgs], unknown_extended_key_usages: Optional[pulumi.Input[Sequence[pulumi.Input[CaPoolIssuancePolicyBaselineValuesKeyUsageUnknownExtendedKeyUsageArgs]]]] = ...) -> None:
    ...
    @base_key_usage.setter
    def base_key_usage(self, value: pulumi.Input[CaPoolIssuancePolicyBaselineValuesKeyUsageBaseKeyUsageArgs]): # -> None:
        ...
    ...
    @extended_key_usage.setter
    def extended_key_usage(self, value: pulumi.Input[CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsageArgs]): # -> None:
        ...
    ...
    @unknown_extended_key_usages.setter
    def unknown_extended_key_usages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CaPoolIssuancePolicyBaselineValuesKeyUsageUnknownExtendedKeyUsageArgs]]]]): # -> None:
        ...
...
class CaPoolIssuancePolicyIdentityConstraintsArgs:
    def __init__(__self__, *, allow_subject_alt_names_passthrough: pulumi.Input[_builtins.bool], allow_subject_passthrough: pulumi.Input[_builtins.bool], cel_expression: Optional[pulumi.Input[CaPoolIssuancePolicyIdentityConstraintsCelExpressionArgs]] = ...) -> None:
    ...
    def allow_subject_alt_names_passthrough(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def allow_subject_passthrough(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def cel_expression(self, value: Optional[pulumi.Input[CaPoolIssuancePolicyIdentityConstraintsCelExpressionArgs]]): # -> None:
        ...
...
class CaPoolPublishingOptionsArgs:
    def __init__(__self__, *, publish_ca_cert: pulumi.Input[_builtins.bool], publish_crl: pulumi.Input[_builtins.bool], encoding_format: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def publish_ca_cert(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    @publish_crl.setter
    def publish_crl(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def encoding_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CertificateCertificateDescriptionArgs:
    def __init__(__self__, *, aia_issuing_certificate_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., authority_key_ids: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionAuthorityKeyIdArgs]]]] = ..., cert_fingerprints: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionCertFingerprintArgs]]]] = ..., crl_distribution_points: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., public_keys: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionPublicKeyArgs]]]] = ..., subject_descriptions: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectDescriptionArgs]]]] = ..., subject_key_ids: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectKeyIdArgs]]]] = ..., x509_descriptions: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionArgs]]]] = ...) -> None:
    ...
    def authority_key_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionAuthorityKeyIdArgs]]]]): # -> None:
        ...
    ...
    def cert_fingerprints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionCertFingerprintArgs]]]]): # -> None:
        ...
    ...
    def crl_distribution_points(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @public_keys.setter
    def public_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionPublicKeyArgs]]]]): # -> None:
        ...
    ...
    def subject_descriptions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectDescriptionArgs]]]]): # -> None:
        ...
    ...
    def subject_key_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectKeyIdArgs]]]]): # -> None:
        ...
    ...
    def x509_descriptions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionArgs]]]]): # -> None:
        ...
...
class CertificateCertificateDescriptionCertFingerprintArgs:
    def __init__(__self__, *, sha256_hash: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @sha256_hash.setter
    def sha256_hash(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CertificateCertificateDescriptionPublicKeyArgs:
    def __init__(__self__, *, format: Optional[pulumi.Input[_builtins.str]] = ..., key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CertificateCertificateDescriptionSubjectDescriptionArgs:
    def __init__(__self__, *, hex_serial_number: Optional[pulumi.Input[_builtins.str]] = ..., lifetime: Optional[pulumi.Input[_builtins.str]] = ..., not_after_time: Optional[pulumi.Input[_builtins.str]] = ..., not_before_time: Optional[pulumi.Input[_builtins.str]] = ..., subject_alt_names: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameArgs]]]] = ..., subjects: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectDescriptionSubjectArgs]]]] = ...) -> None:
    ...
    def hex_serial_number(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def not_after_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def not_before_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def subject_alt_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameArgs]]]]): # -> None:
        ...
    ...
    @subjects.setter
    def subjects(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectDescriptionSubjectArgs]]]]): # -> None:
        ...
...
class CertificateCertificateDescriptionSubjectDescriptionSubjectArgs:
    def __init__(__self__, *, common_name: Optional[pulumi.Input[_builtins.str]] = ..., country_code: Optional[pulumi.Input[_builtins.str]] = ..., locality: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., organizational_unit: Optional[pulumi.Input[_builtins.str]] = ..., postal_code: Optional[pulumi.Input[_builtins.str]] = ..., province: Optional[pulumi.Input[_builtins.str]] = ..., street_address: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameArgs:
    def __init__(__self__, *, custom_sans: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSanArgs]]]] = ..., dns_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., email_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @custom_sans.setter
    def custom_sans(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSanArgs]]]]): # -> None:
        ...
...
class CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSanArgs:
    def __init__(__self__, *, critical: Optional[pulumi.Input[_builtins.bool]] = ..., obect_ids: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSanObectIdArgs]]]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @critical.setter
    def critical(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @obect_ids.setter
    def obect_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSanObectIdArgs]]]]): # -> None:
        ...
...
class CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSanObectIdArgs:
    def __init__(__self__, *, object_id_paths: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]] = ...) -> None:
    ...
    @object_id_paths.setter
    def object_id_paths(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]]): # -> None:
        ...
...
class CertificateCertificateDescriptionX509DescriptionArgs:
    def __init__(__self__, *, additional_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionAdditionalExtensionArgs]]]] = ..., aia_ocsp_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ca_options: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionCaOptionArgs]]]] = ..., key_usages: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionKeyUsageArgs]]]] = ..., name_constraints: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionNameConstraintArgs]]]] = ..., policy_ids: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionPolicyIdArgs]]]] = ...) -> None:
    ...
    @additional_extensions.setter
    def additional_extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionAdditionalExtensionArgs]]]]): # -> None:
        ...
    ...
    @ca_options.setter
    def ca_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionCaOptionArgs]]]]): # -> None:
        ...
    ...
    @key_usages.setter
    def key_usages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionKeyUsageArgs]]]]): # -> None:
        ...
    ...
    @name_constraints.setter
    def name_constraints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionNameConstraintArgs]]]]): # -> None:
        ...
    ...
    @policy_ids.setter
    def policy_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionPolicyIdArgs]]]]): # -> None:
        ...
...
class CertificateCertificateDescriptionX509DescriptionAdditionalExtensionArgs:
    def __init__(__self__, *, critical: Optional[pulumi.Input[_builtins.bool]] = ..., object_ids: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionAdditionalExtensionObjectIdArgs]]]] = ..., value: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @object_ids.setter
    def object_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionAdditionalExtensionObjectIdArgs]]]]): # -> None:
        ...
...
class CertificateCertificateDescriptionX509DescriptionCaOptionArgs:
    def __init__(__self__, *, is_ca: Optional[pulumi.Input[_builtins.bool]] = ..., max_issuer_path_length: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class CertificateCertificateDescriptionX509DescriptionKeyUsageArgs:
    def __init__(__self__, *, base_key_usages: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionKeyUsageBaseKeyUsageArgs]]]] = ..., extended_key_usages: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionKeyUsageExtendedKeyUsageArgs]]]] = ..., unknown_extended_key_usages: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionKeyUsageUnknownExtendedKeyUsageArgs]]]] = ...) -> None:
    ...
    def base_key_usages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionKeyUsageBaseKeyUsageArgs]]]]): # -> None:
        ...
    ...
    def extended_key_usages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionKeyUsageExtendedKeyUsageArgs]]]]): # -> None:
        ...
    ...
    @unknown_extended_key_usages.setter
    def unknown_extended_key_usages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateCertificateDescriptionX509DescriptionKeyUsageUnknownExtendedKeyUsageArgs]]]]): # -> None:
        ...
...
class CertificateCertificateDescriptionX509DescriptionNameConstraintArgs:
    def __init__(__self__, *, critical: Optional[pulumi.Input[_builtins.bool]] = ..., excluded_dns_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., excluded_email_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., excluded_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., excluded_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., permitted_dns_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., permitted_email_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., permitted_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., permitted_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class CertificateConfigArgs:
    def __init__(__self__, *, public_key: pulumi.Input[CertificateConfigPublicKeyArgs], subject_config: pulumi.Input[CertificateConfigSubjectConfigArgs], x509_config: pulumi.Input[CertificateConfigX509ConfigArgs], subject_key_id: Optional[pulumi.Input[CertificateConfigSubjectKeyIdArgs]] = ...) -> None:
    ...
    @public_key.setter
    def public_key(self, value: pulumi.Input[CertificateConfigPublicKeyArgs]): # -> None:
        ...
    ...
    @subject_config.setter
    def subject_config(self, value: pulumi.Input[CertificateConfigSubjectConfigArgs]): # -> None:
        ...
    ...
    @x509_config.setter
    def x509_config(self, value: pulumi.Input[CertificateConfigX509ConfigArgs]): # -> None:
        ...
    ...
    @subject_key_id.setter
    def subject_key_id(self, value: Optional[pulumi.Input[CertificateConfigSubjectKeyIdArgs]]): # -> None:
        ...
...
class CertificateConfigPublicKeyArgs:
    def __init__(__self__, *, format: pulumi.Input[_builtins.str], key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CertificateConfigSubjectConfigArgs:
    def __init__(__self__, *, subject: pulumi.Input[CertificateConfigSubjectConfigSubjectArgs], subject_alt_name: Optional[pulumi.Input[CertificateConfigSubjectConfigSubjectAltNameArgs]] = ...) -> None:
    ...
    @subject.setter
    def subject(self, value: pulumi.Input[CertificateConfigSubjectConfigSubjectArgs]): # -> None:
        ...
    ...
    @subject_alt_name.setter
    def subject_alt_name(self, value: Optional[pulumi.Input[CertificateConfigSubjectConfigSubjectAltNameArgs]]): # -> None:
        ...
...
class CertificateConfigSubjectConfigSubjectArgs:
    def __init__(__self__, *, common_name: pulumi.Input[_builtins.str], organization: pulumi.Input[_builtins.str], country_code: Optional[pulumi.Input[_builtins.str]] = ..., locality: Optional[pulumi.Input[_builtins.str]] = ..., organizational_unit: Optional[pulumi.Input[_builtins.str]] = ..., postal_code: Optional[pulumi.Input[_builtins.str]] = ..., province: Optional[pulumi.Input[_builtins.str]] = ..., street_address: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CertificateConfigX509ConfigArgs:
    def __init__(__self__, *, key_usage: pulumi.Input[CertificateConfigX509ConfigKeyUsageArgs], additional_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateConfigX509ConfigAdditionalExtensionArgs]]]] = ..., aia_ocsp_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ca_options: Optional[pulumi.Input[CertificateConfigX509ConfigCaOptionsArgs]] = ..., name_constraints: Optional[pulumi.Input[CertificateConfigX509ConfigNameConstraintsArgs]] = ..., policy_ids: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateConfigX509ConfigPolicyIdArgs]]]] = ...) -> None:
    ...
    @key_usage.setter
    def key_usage(self, value: pulumi.Input[CertificateConfigX509ConfigKeyUsageArgs]): # -> None:
        ...
    ...
    @additional_extensions.setter
    def additional_extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateConfigX509ConfigAdditionalExtensionArgs]]]]): # -> None:
        ...
    ...
    @ca_options.setter
    def ca_options(self, value: Optional[pulumi.Input[CertificateConfigX509ConfigCaOptionsArgs]]): # -> None:
        ...
    ...
    @name_constraints.setter
    def name_constraints(self, value: Optional[pulumi.Input[CertificateConfigX509ConfigNameConstraintsArgs]]): # -> None:
        ...
    ...
    @policy_ids.setter
    def policy_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateConfigX509ConfigPolicyIdArgs]]]]): # -> None:
        ...
...
class CertificateConfigX509ConfigAdditionalExtensionArgs:
    def __init__(__self__, *, critical: pulumi.Input[_builtins.bool], object_id: pulumi.Input[CertificateConfigX509ConfigAdditionalExtensionObjectIdArgs], value: pulumi.Input[_builtins.str]) -> None:
    ...
    @object_id.setter
    def object_id(self, value: pulumi.Input[CertificateConfigX509ConfigAdditionalExtensionObjectIdArgs]): # -> None:
        ...
...
class CertificateConfigX509ConfigKeyUsageArgs:
    def __init__(__self__, *, base_key_usage: pulumi.Input[CertificateConfigX509ConfigKeyUsageBaseKeyUsageArgs], extended_key_usage: pulumi.Input[CertificateConfigX509ConfigKeyUsageExtendedKeyUsageArgs], unknown_extended_key_usages: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateConfigX509ConfigKeyUsageUnknownExtendedKeyUsageArgs]]]] = ...) -> None:
    ...
    @base_key_usage.setter
    def base_key_usage(self, value: pulumi.Input[CertificateConfigX509ConfigKeyUsageBaseKeyUsageArgs]): # -> None:
        ...
    ...
    @extended_key_usage.setter
    def extended_key_usage(self, value: pulumi.Input[CertificateConfigX509ConfigKeyUsageExtendedKeyUsageArgs]): # -> None:
        ...
    ...
    @unknown_extended_key_usages.setter
    def unknown_extended_key_usages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateConfigX509ConfigKeyUsageUnknownExtendedKeyUsageArgs]]]]): # -> None:
        ...
...
class CertificateRevocationDetailArgs:
    def __init__(__self__, *, revocation_state: Optional[pulumi.Input[_builtins.str]] = ..., revocation_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def revocation_state(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def revocation_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CertificateTemplateIdentityConstraintsArgs:
    def __init__(__self__, *, allow_subject_alt_names_passthrough: pulumi.Input[_builtins.bool], allow_subject_passthrough: pulumi.Input[_builtins.bool], cel_expression: Optional[pulumi.Input[CertificateTemplateIdentityConstraintsCelExpressionArgs]] = ...) -> None:
    ...
    @cel_expression.setter
    def cel_expression(self, value: Optional[pulumi.Input[CertificateTemplateIdentityConstraintsCelExpressionArgs]]): # -> None:
        ...
...
class CertificateTemplateIdentityConstraintsCelExpressionArgs:
    def __init__(__self__, *, description: Optional[pulumi.Input[_builtins.str]] = ..., expression: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., title: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CertificateTemplatePassthroughExtensionsArgs:
    def __init__(__self__, *, additional_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateTemplatePassthroughExtensionsAdditionalExtensionArgs]]]] = ..., known_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @additional_extensions.setter
    def additional_extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateTemplatePassthroughExtensionsAdditionalExtensionArgs]]]]): # -> None:
        ...
    ...
    def known_extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class CertificateTemplatePredefinedValuesArgs:
    def __init__(__self__, *, additional_extensions: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateTemplatePredefinedValuesAdditionalExtensionArgs]]]] = ..., aia_ocsp_servers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., ca_options: Optional[pulumi.Input[CertificateTemplatePredefinedValuesCaOptionsArgs]] = ..., key_usage: Optional[pulumi.Input[CertificateTemplatePredefinedValuesKeyUsageArgs]] = ..., name_constraints: Optional[pulumi.Input[CertificateTemplatePredefinedValuesNameConstraintsArgs]] = ..., policy_ids: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateTemplatePredefinedValuesPolicyIdArgs]]]] = ...) -> None:
    ...
    @additional_extensions.setter
    def additional_extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateTemplatePredefinedValuesAdditionalExtensionArgs]]]]): # -> None:
        ...
    ...
    @ca_options.setter
    def ca_options(self, value: Optional[pulumi.Input[CertificateTemplatePredefinedValuesCaOptionsArgs]]): # -> None:
        ...
    ...
    @key_usage.setter
    def key_usage(self, value: Optional[pulumi.Input[CertificateTemplatePredefinedValuesKeyUsageArgs]]): # -> None:
        ...
    ...
    @name_constraints.setter
    def name_constraints(self, value: Optional[pulumi.Input[CertificateTemplatePredefinedValuesNameConstraintsArgs]]): # -> None:
        ...
    ...
    @policy_ids.setter
    def policy_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateTemplatePredefinedValuesPolicyIdArgs]]]]): # -> None:
        ...
...
class CertificateTemplatePredefinedValuesAdditionalExtensionArgs:
    def __init__(__self__, *, object_id: pulumi.Input[CertificateTemplatePredefinedValuesAdditionalExtensionObjectIdArgs], value: pulumi.Input[_builtins.str], critical: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @object_id.setter
    def object_id(self, value: pulumi.Input[CertificateTemplatePredefinedValuesAdditionalExtensionObjectIdArgs]): # -> None:
        ...
...
class CertificateTemplatePredefinedValuesCaOptionsArgs:
    def __init__(__self__, *, is_ca: Optional[pulumi.Input[_builtins.bool]] = ..., max_issuer_path_length: Optional[pulumi.Input[_builtins.int]] = ..., null_ca: Optional[pulumi.Input[_builtins.bool]] = ..., zero_max_issuer_path_length: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @null_ca.setter
    def null_ca(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class CertificateTemplatePredefinedValuesKeyUsageArgs:
    def __init__(__self__, *, base_key_usage: Optional[pulumi.Input[CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsageArgs]] = ..., extended_key_usage: Optional[pulumi.Input[CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs]] = ..., unknown_extended_key_usages: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateTemplatePredefinedValuesKeyUsageUnknownExtendedKeyUsageArgs]]]] = ...) -> None:
    ...
    @base_key_usage.setter
    def base_key_usage(self, value: Optional[pulumi.Input[CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsageArgs]]): # -> None:
        ...
    ...
    @extended_key_usage.setter
    def extended_key_usage(self, value: Optional[pulumi.Input[CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs]]): # -> None:
        ...
    ...
    @unknown_extended_key_usages.setter
    def unknown_extended_key_usages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[CertificateTemplatePredefinedValuesKeyUsageUnknownExtendedKeyUsageArgs]]]]): # -> None:
        ...
