...
class CertificateTemplateIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[CertificateTemplateIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[CertificateTemplateIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[CertificateTemplateIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class CertificateTemplateIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.CertificateTemplateIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
