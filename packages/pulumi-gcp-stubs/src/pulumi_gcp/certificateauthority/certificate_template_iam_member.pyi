...
class CertificateTemplateIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[CertificateTemplateIamMemberConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[CertificateTemplateIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[CertificateTemplateIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class CertificateTemplateIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.CertificateTemplateIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
