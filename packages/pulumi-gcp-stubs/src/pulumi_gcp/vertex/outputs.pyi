...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AiDatasetEncryptionSpec', 'AiDeploymentResourcePoolDedicatedResources', ..., ..., 'AiEndpointDeployedModel', 'AiEndpointDeployedModelAutomaticResource', 'AiEndpointDeployedModelDedicatedResource', ..., ..., 'AiEndpointDeployedModelPrivateEndpoint', 'AiEndpointEncryptionSpec', 'AiEndpointIamBindingCondition', 'AiEndpointIamMemberCondition', 'AiEndpointPredictRequestResponseLoggingConfig', ..., 'AiEndpointPrivateServiceConnectConfig', ..., 'AiEndpointWithModelGardenDeploymentDeployConfig', ..., ..., ..., ..., 'AiEndpointWithModelGardenDeploymentEndpointConfig', ..., ..., 'AiEndpointWithModelGardenDeploymentModelConfig', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AiFeatureGroupBigQuery', 'AiFeatureGroupBigQueryBigQuerySource', 'AiFeatureGroupIamBindingCondition', 'AiFeatureGroupIamMemberCondition', 'AiFeatureOnlineStoreBigtable', 'AiFeatureOnlineStoreBigtableAutoScaling', 'AiFeatureOnlineStoreDedicatedServingEndpoint', ..., 'AiFeatureOnlineStoreEmbeddingManagement', 'AiFeatureOnlineStoreEncryptionSpec', 'AiFeatureOnlineStoreFeatureviewBigQuerySource', ..., ..., 'AiFeatureOnlineStoreFeatureviewIamBindingCondition', 'AiFeatureOnlineStoreFeatureviewIamMemberCondition', 'AiFeatureOnlineStoreFeatureviewSyncConfig', 'AiFeatureOnlineStoreFeatureviewVectorSearchConfig', ..., ..., 'AiFeatureOnlineStoreIamBindingCondition', 'AiFeatureOnlineStoreIamMemberCondition', 'AiFeatureOnlineStoreOptimized', 'AiFeatureStoreEncryptionSpec', 'AiFeatureStoreEntityTypeIamBindingCondition', 'AiFeatureStoreEntityTypeIamMemberCondition', 'AiFeatureStoreEntityTypeMonitoringConfig', ..., ..., ..., ..., 'AiFeatureStoreIamBindingCondition', 'AiFeatureStoreIamMemberCondition', 'AiFeatureStoreOnlineServingConfig', 'AiFeatureStoreOnlineServingConfigScaling', 'AiIndexDeployedIndex', 'AiIndexEncryptionSpec', 'AiIndexEndpointDeployedIndexAutomaticResources', 'AiIndexEndpointDeployedIndexDedicatedResources', ..., ..., ..., 'AiIndexEndpointDeployedIndexPrivateEndpoint', ..., 'AiIndexEndpointEncryptionSpec', 'AiIndexEndpointPrivateServiceConnectConfig', ..., 'AiIndexIndexStat', 'AiIndexMetadata', 'AiIndexMetadataConfig', 'AiIndexMetadataConfigAlgorithmConfig', ..., 'AiIndexMetadataConfigAlgorithmConfigTreeAhConfig', 'AiMetadataStoreEncryptionSpec', 'AiMetadataStoreState', 'AiRagEngineConfigRagManagedDbConfig', 'AiRagEngineConfigRagManagedDbConfigBasic', 'AiRagEngineConfigRagManagedDbConfigScaled', 'AiRagEngineConfigRagManagedDbConfigUnprovisioned', 'AiReasoningEngineEncryptionSpec', 'AiReasoningEngineSpec', 'AiReasoningEngineSpecDeploymentSpec', 'AiReasoningEngineSpecDeploymentSpecEnv', ..., ..., 'AiReasoningEngineSpecDeploymentSpecSecretEnv', ..., 'AiReasoningEngineSpecPackageSpec', 'AiReasoningEngineSpecSourceCodeSpec', ..., ..., 'AiReasoningEngineSpecSourceCodeSpecInlineSource', 'AiReasoningEngineSpecSourceCodeSpecPythonSpec', 'AiTensorboardEncryptionSpec', 'GetAiIndexDeployedIndexResult', 'GetAiIndexEncryptionSpecResult', 'GetAiIndexIndexStatResult', 'GetAiIndexMetadataResult', 'GetAiIndexMetadataConfigResult', 'GetAiIndexMetadataConfigAlgorithmConfigResult', ..., ...]
@pulumi.output_type
...
class AiDeploymentResourcePoolDedicatedResources(dict):
    ...
    def __init__(__self__, *, machine_spec: outputs.AiDeploymentResourcePoolDedicatedResourcesMachineSpec, min_replica_count: _builtins.int, autoscaling_metric_specs: Optional[Sequence[outputs.AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpec]] = ..., max_replica_count: Optional[_builtins.int] = ...) -> None:
...
class AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpec(dict):
    ...
    def __init__(__self__, *, metric_name: _builtins.str, target: Optional[_builtins.int] = ...) -> None:
...
class AiEndpointDeployedModel(dict):
    ...
    def __init__(__self__, *, automatic_resources: Optional[Sequence[outputs.AiEndpointDeployedModelAutomaticResource]] = ..., create_time: Optional[_builtins.str] = ..., dedicated_resources: Optional[Sequence[outputs.AiEndpointDeployedModelDedicatedResource]] = ..., display_name: Optional[_builtins.str] = ..., enable_access_logging: Optional[_builtins.bool] = ..., enable_container_logging: Optional[_builtins.bool] = ..., id: Optional[_builtins.str] = ..., model: Optional[_builtins.str] = ..., model_version_id: Optional[_builtins.str] = ..., private_endpoints: Optional[Sequence[outputs.AiEndpointDeployedModelPrivateEndpoint]] = ..., service_account: Optional[_builtins.str] = ..., shared_resources: Optional[_builtins.str] = ...) -> None:
...
class AiEndpointDeployedModelAutomaticResource(dict):
    ...
    def __init__(__self__, *, max_replica_count: Optional[_builtins.int] = ..., min_replica_count: Optional[_builtins.int] = ...) -> None:
...
class AiEndpointDeployedModelDedicatedResource(dict):
    ...
    def __init__(__self__, *, autoscaling_metric_specs: Optional[Sequence[outputs.AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec]] = ..., machine_specs: Optional[Sequence[outputs.AiEndpointDeployedModelDedicatedResourceMachineSpec]] = ..., max_replica_count: Optional[_builtins.int] = ..., min_replica_count: Optional[_builtins.int] = ...) -> None:
...
class AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec(dict):
    ...
    def __init__(__self__, *, metric_name: Optional[_builtins.str] = ..., target: Optional[_builtins.int] = ...) -> None:
...
class AiEndpointDeployedModelPrivateEndpoint(dict):
    ...
    def __init__(__self__, *, explain_http_uri: Optional[_builtins.str] = ..., health_http_uri: Optional[_builtins.str] = ..., predict_http_uri: Optional[_builtins.str] = ..., service_attachment: Optional[_builtins.str] = ...) -> None:
...
class AiEndpointPredictRequestResponseLoggingConfig(dict):
    ...
    def __init__(__self__, *, bigquery_destination: Optional[outputs.AiEndpointPredictRequestResponseLoggingConfigBigqueryDestination] = ..., enabled: Optional[_builtins.bool] = ..., sampling_rate: Optional[_builtins.float] = ...) -> None:
...
class AiEndpointPrivateServiceConnectConfig(dict):
    ...
    def __init__(__self__, *, enable_private_service_connect: _builtins.bool, enable_secure_private_service_connect: Optional[_builtins.bool] = ..., project_allowlists: Optional[Sequence[_builtins.str]] = ..., psc_automation_configs: Optional[Sequence[outputs.AiEndpointPrivateServiceConnectConfigPscAutomationConfig]] = ...) -> None:
...
class AiEndpointPrivateServiceConnectConfigPscAutomationConfig(dict):
    ...
    def __init__(__self__, *, network: _builtins.str, project_id: _builtins.str, error_message: Optional[_builtins.str] = ..., forwarding_rule: Optional[_builtins.str] = ..., ip_address: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentDeployConfig(dict):
    ...
    def __init__(__self__, *, dedicated_resources: Optional[outputs.AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResources] = ..., fast_tryout_enabled: Optional[_builtins.bool] = ..., system_labels: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResources(dict):
    ...
    def __init__(__self__, *, machine_spec: outputs.AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesMachineSpec, min_replica_count: _builtins.int, autoscaling_metric_specs: Optional[Sequence[outputs.AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesAutoscalingMetricSpec]] = ..., max_replica_count: Optional[_builtins.int] = ..., required_replica_count: Optional[_builtins.int] = ..., spot: Optional[_builtins.bool] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesMachineSpec(dict):
    ...
    def __init__(__self__, *, accelerator_count: Optional[_builtins.int] = ..., accelerator_type: Optional[_builtins.str] = ..., machine_type: Optional[_builtins.str] = ..., multihost_gpu_node_count: Optional[_builtins.int] = ..., reservation_affinity: Optional[outputs.AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesMachineSpecReservationAffinity] = ..., tpu_topology: Optional[_builtins.str] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesMachineSpecReservationAffinity(dict):
    ...
    def __init__(__self__, *, reservation_affinity_type: _builtins.str, key: Optional[_builtins.str] = ..., values: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentEndpointConfig(dict):
    ...
    def __init__(__self__, *, dedicated_endpoint_enabled: Optional[_builtins.bool] = ..., endpoint_display_name: Optional[_builtins.str] = ..., private_service_connect_config: Optional[outputs.AiEndpointWithModelGardenDeploymentEndpointConfigPrivateServiceConnectConfig] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentEndpointConfigPrivateServiceConnectConfig(dict):
    ...
    def __init__(__self__, *, enable_private_service_connect: _builtins.bool, project_allowlists: Optional[Sequence[_builtins.str]] = ..., psc_automation_configs: Optional[outputs.AiEndpointWithModelGardenDeploymentEndpointConfigPrivateServiceConnectConfigPscAutomationConfigs] = ..., service_attachment: Optional[_builtins.str] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentModelConfig(dict):
    ...
    def __init__(__self__, *, accept_eula: Optional[_builtins.bool] = ..., container_spec: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpec] = ..., hugging_face_access_token: Optional[_builtins.str] = ..., hugging_face_cache_enabled: Optional[_builtins.bool] = ..., model_display_name: Optional[_builtins.str] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpec(dict):
    ...
    def __init__(__self__, *, image_uri: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., commands: Optional[Sequence[_builtins.str]] = ..., deployment_timeout: Optional[_builtins.str] = ..., envs: Optional[Sequence[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecEnv]] = ..., grpc_ports: Optional[Sequence[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecGrpcPort]] = ..., health_probe: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbe] = ..., health_route: Optional[_builtins.str] = ..., liveness_probe: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbe] = ..., ports: Optional[Sequence[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecPort]] = ..., predict_route: Optional[_builtins.str] = ..., shared_memory_size_mb: Optional[_builtins.str] = ..., startup_probe: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbe] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecGrpcPort(dict):
    ...
    def __init__(__self__, *, container_port: Optional[_builtins.int] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbe(dict):
    ...
    def __init__(__self__, *, exec_: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeExec] = ..., failure_threshold: Optional[_builtins.int] = ..., grpc: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeGrpc] = ..., http_get: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeHttpGet] = ..., initial_delay_seconds: Optional[_builtins.int] = ..., period_seconds: Optional[_builtins.int] = ..., success_threshold: Optional[_builtins.int] = ..., tcp_socket: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeTcpSocket] = ..., timeout_seconds: Optional[_builtins.int] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeHttpGet(dict):
    ...
    def __init__(__self__, *, host: Optional[_builtins.str] = ..., http_headers: Optional[Sequence[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeHttpGetHttpHeader]] = ..., path: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., scheme: Optional[_builtins.str] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbe(dict):
    ...
    def __init__(__self__, *, exec_: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeExec] = ..., failure_threshold: Optional[_builtins.int] = ..., grpc: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeGrpc] = ..., http_get: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGet] = ..., initial_delay_seconds: Optional[_builtins.int] = ..., period_seconds: Optional[_builtins.int] = ..., success_threshold: Optional[_builtins.int] = ..., tcp_socket: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeTcpSocket] = ..., timeout_seconds: Optional[_builtins.int] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGet(dict):
    ...
    def __init__(__self__, *, host: Optional[_builtins.str] = ..., http_headers: Optional[Sequence[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGetHttpHeader]] = ..., path: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., scheme: Optional[_builtins.str] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbe(dict):
    ...
    def __init__(__self__, *, exec_: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeExec] = ..., failure_threshold: Optional[_builtins.int] = ..., grpc: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeGrpc] = ..., http_get: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeHttpGet] = ..., initial_delay_seconds: Optional[_builtins.int] = ..., period_seconds: Optional[_builtins.int] = ..., success_threshold: Optional[_builtins.int] = ..., tcp_socket: Optional[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeTcpSocket] = ..., timeout_seconds: Optional[_builtins.int] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeHttpGet(dict):
    ...
    def __init__(__self__, *, host: Optional[_builtins.str] = ..., http_headers: Optional[Sequence[outputs.AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeHttpGetHttpHeader]] = ..., path: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ..., scheme: Optional[_builtins.str] = ...) -> None:
...
class AiFeatureGroupBigQuery(dict):
    ...
    def __init__(__self__, *, big_query_source: outputs.AiFeatureGroupBigQueryBigQuerySource, entity_id_columns: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AiFeatureOnlineStoreBigtable(dict):
    ...
    def __init__(__self__, *, auto_scaling: outputs.AiFeatureOnlineStoreBigtableAutoScaling, enable_direct_bigtable_access: Optional[_builtins.bool] = ..., zone: Optional[_builtins.str] = ...) -> None:
...
class AiFeatureOnlineStoreBigtableAutoScaling(dict):
    ...
    def __init__(__self__, *, max_node_count: _builtins.int, min_node_count: _builtins.int, cpu_utilization_target: Optional[_builtins.int] = ...) -> None:
...
class AiFeatureOnlineStoreDedicatedServingEndpoint(dict):
    ...
    def __init__(__self__, *, private_service_connect_config: Optional[outputs.AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfig] = ..., public_endpoint_domain_name: Optional[_builtins.str] = ..., service_attachment: Optional[_builtins.str] = ...) -> None:
...
class AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfig(dict):
    ...
    def __init__(__self__, *, enable_private_service_connect: _builtins.bool, project_allowlists: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AiFeatureOnlineStoreFeatureviewBigQuerySource(dict):
    ...
    def __init__(__self__, *, entity_id_columns: Sequence[_builtins.str], uri: _builtins.str) -> None:
...
class AiFeatureOnlineStoreFeatureviewFeatureRegistrySource(dict):
    ...
    def __init__(__self__, *, feature_groups: Sequence[outputs.AiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroup], project_number: Optional[_builtins.str] = ...) -> None:
...
class AiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroup(dict):
    ...
    def __init__(__self__, *, feature_group_id: _builtins.str, feature_ids: Sequence[_builtins.str]) -> None:
...
class AiFeatureOnlineStoreFeatureviewSyncConfig(dict):
    def __init__(__self__, *, continuous: Optional[_builtins.bool] = ..., cron: Optional[_builtins.str] = ...) -> None:
...
class AiFeatureOnlineStoreFeatureviewVectorSearchConfig(dict):
    ...
    def __init__(__self__, *, embedding_column: _builtins.str, brute_force_config: Optional[outputs.AiFeatureOnlineStoreFeatureviewVectorSearchConfigBruteForceConfig] = ..., crowding_column: Optional[_builtins.str] = ..., distance_measure_type: Optional[_builtins.str] = ..., embedding_dimension: Optional[_builtins.int] = ..., filter_columns: Optional[Sequence[_builtins.str]] = ..., tree_ah_config: Optional[outputs.AiFeatureOnlineStoreFeatureviewVectorSearchConfigTreeAhConfig] = ...) -> None:
...
class AiFeatureOnlineStoreFeatureviewVectorSearchConfigTreeAhConfig(dict):
    ...
    def __init__(__self__, *, leaf_node_embedding_count: Optional[_builtins.str] = ...) -> None:
...
class AiFeatureStoreEntityTypeMonitoringConfig(dict):
    ...
    def __init__(__self__, *, categorical_threshold_config: Optional[outputs.AiFeatureStoreEntityTypeMonitoringConfigCategoricalThresholdConfig] = ..., import_features_analysis: Optional[outputs.AiFeatureStoreEntityTypeMonitoringConfigImportFeaturesAnalysis] = ..., numerical_threshold_config: Optional[outputs.AiFeatureStoreEntityTypeMonitoringConfigNumericalThresholdConfig] = ..., snapshot_analysis: Optional[outputs.AiFeatureStoreEntityTypeMonitoringConfigSnapshotAnalysis] = ...) -> None:
...
class AiFeatureStoreEntityTypeMonitoringConfigImportFeaturesAnalysis(dict):
    ...
    def __init__(__self__, *, anomaly_detection_baseline: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class AiFeatureStoreEntityTypeMonitoringConfigSnapshotAnalysis(dict):
    ...
    def __init__(__self__, *, disabled: Optional[_builtins.bool] = ..., monitoring_interval: Optional[_builtins.str] = ..., monitoring_interval_days: Optional[_builtins.int] = ..., staleness_days: Optional[_builtins.int] = ...) -> None:
...
class AiFeatureStoreOnlineServingConfig(dict):
    ...
    def __init__(__self__, *, fixed_node_count: Optional[_builtins.int] = ..., scaling: Optional[outputs.AiFeatureStoreOnlineServingConfigScaling] = ...) -> None:
...
class AiIndexDeployedIndex(dict):
    ...
    def __init__(__self__, *, deployed_index_id: Optional[_builtins.str] = ..., index_endpoint: Optional[_builtins.str] = ...) -> None:
...
class AiIndexEndpointDeployedIndexDedicatedResources(dict):
    ...
    def __init__(__self__, *, machine_spec: outputs.AiIndexEndpointDeployedIndexDedicatedResourcesMachineSpec, min_replica_count: _builtins.int, max_replica_count: Optional[_builtins.int] = ...) -> None:
...
class AiIndexEndpointDeployedIndexDeployedIndexAuthConfig(dict):
    ...
    def __init__(__self__, *, auth_provider: Optional[outputs.AiIndexEndpointDeployedIndexDeployedIndexAuthConfigAuthProvider] = ...) -> None:
...
class AiIndexEndpointDeployedIndexDeployedIndexAuthConfigAuthProvider(dict):
    ...
    def __init__(__self__, *, allowed_issuers: Optional[Sequence[_builtins.str]] = ..., audiences: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AiIndexEndpointDeployedIndexPrivateEndpoint(dict):
    ...
    def __init__(__self__, *, match_grpc_address: Optional[_builtins.str] = ..., psc_automated_endpoints: Optional[Sequence[outputs.AiIndexEndpointDeployedIndexPrivateEndpointPscAutomatedEndpoint]] = ..., service_attachment: Optional[_builtins.str] = ...) -> None:
...
class AiIndexEndpointDeployedIndexPrivateEndpointPscAutomatedEndpoint(dict):
    ...
    def __init__(__self__, *, match_address: Optional[_builtins.str] = ..., network: Optional[_builtins.str] = ..., project_id: Optional[_builtins.str] = ...) -> None:
...
class AiIndexEndpointPrivateServiceConnectConfig(dict):
    ...
    def __init__(__self__, *, enable_private_service_connect: _builtins.bool, project_allowlists: Optional[Sequence[_builtins.str]] = ..., psc_automation_configs: Optional[Sequence[outputs.AiIndexEndpointPrivateServiceConnectConfigPscAutomationConfig]] = ...) -> None:
...
class AiIndexIndexStat(dict):
    ...
    def __init__(__self__, *, shards_count: Optional[_builtins.int] = ..., vectors_count: Optional[_builtins.str] = ...) -> None:
...
class AiIndexMetadata(dict):
    ...
    def __init__(__self__, *, config: outputs.AiIndexMetadataConfig, contents_delta_uri: Optional[_builtins.str] = ..., is_complete_overwrite: Optional[_builtins.bool] = ...) -> None:
...
class AiIndexMetadataConfig(dict):
    ...
    def __init__(__self__, *, dimensions: _builtins.int, algorithm_config: Optional[outputs.AiIndexMetadataConfigAlgorithmConfig] = ..., approximate_neighbors_count: Optional[_builtins.int] = ..., distance_measure_type: Optional[_builtins.str] = ..., feature_norm_type: Optional[_builtins.str] = ..., shard_size: Optional[_builtins.str] = ...) -> None:
...
class AiIndexMetadataConfigAlgorithmConfig(dict):
    ...
    def __init__(__self__, *, brute_force_config: Optional[outputs.AiIndexMetadataConfigAlgorithmConfigBruteForceConfig] = ..., tree_ah_config: Optional[outputs.AiIndexMetadataConfigAlgorithmConfigTreeAhConfig] = ...) -> None:
...
class AiIndexMetadataConfigAlgorithmConfigTreeAhConfig(dict):
    ...
    def __init__(__self__, *, leaf_node_embedding_count: Optional[_builtins.int] = ..., leaf_nodes_to_search_percent: Optional[_builtins.int] = ...) -> None:
...
class AiMetadataStoreState(dict):
    ...
    def __init__(__self__, *, disk_utilization_bytes: Optional[_builtins.str] = ...) -> None:
...
class AiRagEngineConfigRagManagedDbConfig(dict):
    def __init__(__self__, *, basic: Optional[outputs.AiRagEngineConfigRagManagedDbConfigBasic] = ..., scaled: Optional[outputs.AiRagEngineConfigRagManagedDbConfigScaled] = ..., unprovisioned: Optional[outputs.AiRagEngineConfigRagManagedDbConfigUnprovisioned] = ...) -> None:
...
class AiReasoningEngineSpec(dict):
    ...
    def __init__(__self__, *, agent_framework: Optional[_builtins.str] = ..., class_methods: Optional[_builtins.str] = ..., deployment_spec: Optional[outputs.AiReasoningEngineSpecDeploymentSpec] = ..., package_spec: Optional[outputs.AiReasoningEngineSpecPackageSpec] = ..., service_account: Optional[_builtins.str] = ..., source_code_spec: Optional[outputs.AiReasoningEngineSpecSourceCodeSpec] = ...) -> None:
...
class AiReasoningEngineSpecDeploymentSpec(dict):
    ...
    def __init__(__self__, *, container_concurrency: Optional[_builtins.int] = ..., envs: Optional[Sequence[outputs.AiReasoningEngineSpecDeploymentSpecEnv]] = ..., max_instances: Optional[_builtins.int] = ..., min_instances: Optional[_builtins.int] = ..., psc_interface_config: Optional[outputs.AiReasoningEngineSpecDeploymentSpecPscInterfaceConfig] = ..., resource_limits: Optional[Mapping[str, _builtins.str]] = ..., secret_envs: Optional[Sequence[outputs.AiReasoningEngineSpecDeploymentSpecSecretEnv]] = ...) -> None:
    ...
    def psc_interface_config(self) -> Optional[outputs.AiReasoningEngineSpecDeploymentSpecPscInterfaceConfig]:
...
class AiReasoningEngineSpecDeploymentSpecPscInterfaceConfig(dict):
    ...
    def __init__(__self__, *, dns_peering_configs: Optional[Sequence[outputs.AiReasoningEngineSpecDeploymentSpecPscInterfaceConfigDnsPeeringConfig]] = ..., network_attachment: Optional[_builtins.str] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter(name="dnsPeeringConfigs")
    def dns_peering_configs(self) -> Optional[Sequence[outputs.AiReasoningEngineSpecDeploymentSpecPscInterfaceConfigDnsPeeringConfig]]:
...
class AiReasoningEngineSpecDeploymentSpecPscInterfaceConfigDnsPeeringConfig(dict):
    ...
    def __init__(__self__, *, domain: _builtins.str, target_network: _builtins.str, target_project: _builtins.str) -> None:
...
class AiReasoningEngineSpecDeploymentSpecSecretEnv(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, secret_ref: outputs.AiReasoningEngineSpecDeploymentSpecSecretEnvSecretRef) -> None:
...
class AiReasoningEngineSpecPackageSpec(dict):
    ...
    def __init__(__self__, *, dependency_files_gcs_uri: Optional[_builtins.str] = ..., pickle_object_gcs_uri: Optional[_builtins.str] = ..., python_version: Optional[_builtins.str] = ..., requirements_gcs_uri: Optional[_builtins.str] = ...) -> None:
...
class AiReasoningEngineSpecSourceCodeSpec(dict):
    ...
    def __init__(__self__, *, developer_connect_source: Optional[outputs.AiReasoningEngineSpecSourceCodeSpecDeveloperConnectSource] = ..., inline_source: Optional[outputs.AiReasoningEngineSpecSourceCodeSpecInlineSource] = ..., python_spec: Optional[outputs.AiReasoningEngineSpecSourceCodeSpecPythonSpec] = ...) -> None:
...
class AiReasoningEngineSpecSourceCodeSpecDeveloperConnectSource(dict):
    def __init__(__self__, *, config: outputs.AiReasoningEngineSpecSourceCodeSpecDeveloperConnectSourceConfig) -> None:
...
class AiReasoningEngineSpecSourceCodeSpecDeveloperConnectSourceConfig(dict):
    ...
    def __init__(__self__, *, dir: _builtins.str, git_repository_link: _builtins.str, revision: _builtins.str) -> None:
...
class AiReasoningEngineSpecSourceCodeSpecInlineSource(dict):
    ...
    def __init__(__self__, *, source_archive: Optional[_builtins.str] = ...) -> None:
...
class AiReasoningEngineSpecSourceCodeSpecPythonSpec(dict):
    ...
    def __init__(__self__, *, entrypoint_module: Optional[_builtins.str] = ..., entrypoint_object: Optional[_builtins.str] = ..., requirements_file: Optional[_builtins.str] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class GetAiIndexDeployedIndexResult(dict):
    def __init__(__self__, *, deployed_index_id: _builtins.str, index_endpoint: _builtins.str) -> None:
...
class GetAiIndexIndexStatResult(dict):
    def __init__(__self__, *, shards_count: _builtins.int, vectors_count: _builtins.str) -> None:
...
class GetAiIndexMetadataResult(dict):
    def __init__(__self__, *, configs: Sequence[outputs.GetAiIndexMetadataConfigResult], contents_delta_uri: _builtins.str, is_complete_overwrite: _builtins.bool) -> None:
...
class GetAiIndexMetadataConfigResult(dict):
    def __init__(__self__, *, algorithm_configs: Sequence[outputs.GetAiIndexMetadataConfigAlgorithmConfigResult], approximate_neighbors_count: _builtins.int, dimensions: _builtins.int, distance_measure_type: _builtins.str, feature_norm_type: _builtins.str, shard_size: _builtins.str) -> None:
...
class GetAiIndexMetadataConfigAlgorithmConfigResult(dict):
    def __init__(__self__, *, brute_force_configs: Sequence[outputs.GetAiIndexMetadataConfigAlgorithmConfigBruteForceConfigResult], tree_ah_configs: Sequence[outputs.GetAiIndexMetadataConfigAlgorithmConfigTreeAhConfigResult]) -> None:
...
class GetAiIndexMetadataConfigAlgorithmConfigTreeAhConfigResult(dict):
    def __init__(__self__, *, leaf_node_embedding_count: _builtins.int, leaf_nodes_to_search_percent: _builtins.int) -> None:
