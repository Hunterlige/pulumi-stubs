...
class AiFeatureGroupArgs:
    def __init__(
        __self__,
        *,
        big_query: Optional[pulumi.Input[AiFeatureGroupBigQueryArgs]] = ...,
...
class AiFeatureGroup(pulumi.CustomResource):
    ...
    def __init__(
        ...
        big_query: Optional[
            pulumi.Input[
                Union[AiFeatureGroupBigQueryArgs, AiFeatureGroupBigQueryArgsDict]
            ]
        ] = ...,
        description: Optional[pulumi.Input[_builtins.str]] = ...,
        labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[AiFeatureGroupArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
