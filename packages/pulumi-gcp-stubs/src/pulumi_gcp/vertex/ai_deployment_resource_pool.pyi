...
class AiDeploymentResourcePoolArgs:
    def __init__(
        ...
        *,
        dedicated_resources: Optional[
            pulumi.Input[AiDeploymentResourcePoolDedicatedResourcesArgs]
        ] = ...,
    ...
    def dedicated_resources(
        self,
    ) -> Optional[pulumi.Input[AiDeploymentResourcePoolDedicatedResourcesArgs]]: ...
    @dedicated_resources.setter
    def dedicated_resources(
        self,
        value: Optional[pulumi.Input[AiDeploymentResourcePoolDedicatedResourcesArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter
...
class AiDeploymentResourcePool(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[AiDeploymentResourcePoolArgs] = ...,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
    ...
    def dedicated_resources(
        ...
        Optional[outputs.AiDeploymentResourcePoolDedicatedResources]
    ]: ...
    @_builtins.property
    @pulumi.getter
