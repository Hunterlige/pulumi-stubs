...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AiDatasetEncryptionSpecArgs', 'AiDatasetEncryptionSpecArgsDict', 'AiDeploymentResourcePoolDedicatedResourcesArgs', 'AiDeploymentResourcePoolDedicatedResourcesArgsDict', ..., ..., ..., ..., 'AiEndpointDeployedModelArgs', 'AiEndpointDeployedModelArgsDict', 'AiEndpointDeployedModelAutomaticResourceArgs', 'AiEndpointDeployedModelAutomaticResourceArgsDict', 'AiEndpointDeployedModelDedicatedResourceArgs', 'AiEndpointDeployedModelDedicatedResourceArgsDict', ..., ..., ..., ..., 'AiEndpointDeployedModelPrivateEndpointArgs', 'AiEndpointDeployedModelPrivateEndpointArgsDict', 'AiEndpointEncryptionSpecArgs', 'AiEndpointEncryptionSpecArgsDict', 'AiEndpointIamBindingConditionArgs', 'AiEndpointIamBindingConditionArgsDict', 'AiEndpointIamMemberConditionArgs', 'AiEndpointIamMemberConditionArgsDict', 'AiEndpointPredictRequestResponseLoggingConfigArgs', ..., ..., ..., 'AiEndpointPrivateServiceConnectConfigArgs', 'AiEndpointPrivateServiceConnectConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AiEndpointWithModelGardenDeploymentModelConfigArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AiFeatureGroupBigQueryArgs', 'AiFeatureGroupBigQueryArgsDict', 'AiFeatureGroupBigQueryBigQuerySourceArgs', 'AiFeatureGroupBigQueryBigQuerySourceArgsDict', 'AiFeatureGroupIamBindingConditionArgs', 'AiFeatureGroupIamBindingConditionArgsDict', 'AiFeatureGroupIamMemberConditionArgs', 'AiFeatureGroupIamMemberConditionArgsDict', 'AiFeatureOnlineStoreBigtableArgs', 'AiFeatureOnlineStoreBigtableArgsDict', 'AiFeatureOnlineStoreBigtableAutoScalingArgs', 'AiFeatureOnlineStoreBigtableAutoScalingArgsDict', 'AiFeatureOnlineStoreDedicatedServingEndpointArgs', ..., ..., ..., 'AiFeatureOnlineStoreEmbeddingManagementArgs', 'AiFeatureOnlineStoreEmbeddingManagementArgsDict', 'AiFeatureOnlineStoreEncryptionSpecArgs', 'AiFeatureOnlineStoreEncryptionSpecArgsDict', 'AiFeatureOnlineStoreFeatureviewBigQuerySourceArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., 'AiFeatureOnlineStoreFeatureviewSyncConfigArgs', 'AiFeatureOnlineStoreFeatureviewSyncConfigArgsDict', ..., ..., ..., ..., ..., ..., 'AiFeatureOnlineStoreIamBindingConditionArgs', 'AiFeatureOnlineStoreIamBindingConditionArgsDict', 'AiFeatureOnlineStoreIamMemberConditionArgs', 'AiFeatureOnlineStoreIamMemberConditionArgsDict', 'AiFeatureOnlineStoreOptimizedArgs', 'AiFeatureOnlineStoreOptimizedArgsDict', 'AiFeatureStoreEncryptionSpecArgs', 'AiFeatureStoreEncryptionSpecArgsDict', 'AiFeatureStoreEntityTypeIamBindingConditionArgs', ..., 'AiFeatureStoreEntityTypeIamMemberConditionArgs', 'AiFeatureStoreEntityTypeIamMemberConditionArgsDict', 'AiFeatureStoreEntityTypeMonitoringConfigArgs', 'AiFeatureStoreEntityTypeMonitoringConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'AiFeatureStoreIamBindingConditionArgs', 'AiFeatureStoreIamBindingConditionArgsDict', 'AiFeatureStoreIamMemberConditionArgs', 'AiFeatureStoreIamMemberConditionArgsDict', 'AiFeatureStoreOnlineServingConfigArgs', 'AiFeatureStoreOnlineServingConfigArgsDict', 'AiFeatureStoreOnlineServingConfigScalingArgs', 'AiFeatureStoreOnlineServingConfigScalingArgsDict', 'AiIndexDeployedIndexArgs', 'AiIndexDeployedIndexArgsDict', 'AiIndexEncryptionSpecArgs', 'AiIndexEncryptionSpecArgsDict', 'AiIndexEndpointDeployedIndexAutomaticResourcesArgs', ..., 'AiIndexEndpointDeployedIndexDedicatedResourcesArgs', ..., ..., ..., ..., ..., ..., ..., 'AiIndexEndpointDeployedIndexPrivateEndpointArgs', ..., ..., ..., 'AiIndexEndpointEncryptionSpecArgs', 'AiIndexEndpointEncryptionSpecArgsDict', 'AiIndexEndpointPrivateServiceConnectConfigArgs', 'AiIndexEndpointPrivateServiceConnectConfigArgsDict', ..., ..., 'AiIndexIndexStatArgs', 'AiIndexIndexStatArgsDict', 'AiIndexMetadataArgs', 'AiIndexMetadataArgsDict', 'AiIndexMetadataConfigArgs', 'AiIndexMetadataConfigArgsDict', 'AiIndexMetadataConfigAlgorithmConfigArgs', 'AiIndexMetadataConfigAlgorithmConfigArgsDict', ..., ..., ..., ..., 'AiMetadataStoreEncryptionSpecArgs', 'AiMetadataStoreEncryptionSpecArgsDict', 'AiMetadataStoreStateArgs', 'AiMetadataStoreStateArgsDict', 'AiRagEngineConfigRagManagedDbConfigArgs', 'AiRagEngineConfigRagManagedDbConfigArgsDict', 'AiRagEngineConfigRagManagedDbConfigBasicArgs', 'AiRagEngineConfigRagManagedDbConfigBasicArgsDict', 'AiRagEngineConfigRagManagedDbConfigScaledArgs', 'AiRagEngineConfigRagManagedDbConfigScaledArgsDict', ..., ..., 'AiReasoningEngineEncryptionSpecArgs', 'AiReasoningEngineEncryptionSpecArgsDict', 'AiReasoningEngineSpecArgs', 'AiReasoningEngineSpecArgsDict', 'AiReasoningEngineSpecDeploymentSpecArgs', 'AiReasoningEngineSpecDeploymentSpecArgsDict', 'AiReasoningEngineSpecDeploymentSpecEnvArgs', 'AiReasoningEngineSpecDeploymentSpecEnvArgsDict', ..., ..., ..., ..., 'AiReasoningEngineSpecDeploymentSpecSecretEnvArgs', ..., ..., ..., 'AiReasoningEngineSpecPackageSpecArgs', 'AiReasoningEngineSpecPackageSpecArgsDict', 'AiReasoningEngineSpecSourceCodeSpecArgs', 'AiReasoningEngineSpecSourceCodeSpecArgsDict', ..., ..., ..., ..., ..., ..., 'AiReasoningEngineSpecSourceCodeSpecPythonSpecArgs', ..., 'AiTensorboardEncryptionSpecArgs', 'AiTensorboardEncryptionSpecArgsDict']
...
class AiDeploymentResourcePoolDedicatedResourcesArgs:
    def __init__(__self__, *, machine_spec: pulumi.Input[AiDeploymentResourcePoolDedicatedResourcesMachineSpecArgs], min_replica_count: pulumi.Input[_builtins.int], autoscaling_metric_specs: Optional[pulumi.Input[Sequence[pulumi.Input[AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecArgs]]]] = ..., max_replica_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @machine_spec.setter
    def machine_spec(self, value: pulumi.Input[AiDeploymentResourcePoolDedicatedResourcesMachineSpecArgs]): # -> None:
        ...
    ...
    def min_replica_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def autoscaling_metric_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecArgs]]]]): # -> None:
        ...
    ...
    def max_replica_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecArgs:
    def __init__(__self__, *, metric_name: pulumi.Input[_builtins.str], target: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class AiEndpointDeployedModelArgs:
    def __init__(__self__, *, automatic_resources: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointDeployedModelAutomaticResourceArgs]]]] = ..., create_time: Optional[pulumi.Input[_builtins.str]] = ..., dedicated_resources: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointDeployedModelDedicatedResourceArgs]]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., enable_access_logging: Optional[pulumi.Input[_builtins.bool]] = ..., enable_container_logging: Optional[pulumi.Input[_builtins.bool]] = ..., id: Optional[pulumi.Input[_builtins.str]] = ..., model: Optional[pulumi.Input[_builtins.str]] = ..., model_version_id: Optional[pulumi.Input[_builtins.str]] = ..., private_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointDeployedModelPrivateEndpointArgs]]]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., shared_resources: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def automatic_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointDeployedModelAutomaticResourceArgs]]]]): # -> None:
        ...
    ...
    def dedicated_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointDeployedModelDedicatedResourceArgs]]]]): # -> None:
        ...
    ...
    def enable_container_logging(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def model_version_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def private_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointDeployedModelPrivateEndpointArgs]]]]): # -> None:
        ...
    ...
    def shared_resources(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiEndpointDeployedModelAutomaticResourceArgs:
    def __init__(__self__, *, max_replica_count: Optional[pulumi.Input[_builtins.int]] = ..., min_replica_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @min_replica_count.setter
    def min_replica_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AiEndpointDeployedModelDedicatedResourceArgs:
    def __init__(__self__, *, autoscaling_metric_specs: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpecArgs]]]] = ..., machine_specs: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointDeployedModelDedicatedResourceMachineSpecArgs]]]] = ..., max_replica_count: Optional[pulumi.Input[_builtins.int]] = ..., min_replica_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @autoscaling_metric_specs.setter
    def autoscaling_metric_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpecArgs]]]]): # -> None:
        ...
    ...
    def machine_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointDeployedModelDedicatedResourceMachineSpecArgs]]]]): # -> None:
        ...
...
class AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpecArgs:
    def __init__(__self__, *, metric_name: Optional[pulumi.Input[_builtins.str]] = ..., target: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class AiEndpointDeployedModelPrivateEndpointArgs:
    def __init__(__self__, *, explain_http_uri: Optional[pulumi.Input[_builtins.str]] = ..., health_http_uri: Optional[pulumi.Input[_builtins.str]] = ..., predict_http_uri: Optional[pulumi.Input[_builtins.str]] = ..., service_attachment: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def explain_http_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def health_http_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def predict_http_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiEndpointPredictRequestResponseLoggingConfigArgs:
    def __init__(__self__, *, bigquery_destination: Optional[pulumi.Input[AiEndpointPredictRequestResponseLoggingConfigBigqueryDestinationArgs]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., sampling_rate: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def bigquery_destination(self, value: Optional[pulumi.Input[AiEndpointPredictRequestResponseLoggingConfigBigqueryDestinationArgs]]): # -> None:
        ...
...
class AiEndpointPredictRequestResponseLoggingConfigBigqueryDestinationArgs:
    def __init__(__self__, *, output_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AiEndpointPrivateServiceConnectConfigArgs:
    def __init__(__self__, *, enable_private_service_connect: pulumi.Input[_builtins.bool], enable_secure_private_service_connect: Optional[pulumi.Input[_builtins.bool]] = ..., project_allowlists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., psc_automation_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointPrivateServiceConnectConfigPscAutomationConfigArgs]]]] = ...) -> None:
    ...
    def enable_private_service_connect(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def enable_secure_private_service_connect(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def project_allowlists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def psc_automation_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointPrivateServiceConnectConfigPscAutomationConfigArgs]]]]): # -> None:
        ...
...
class AiEndpointPrivateServiceConnectConfigPscAutomationConfigArgs:
    def __init__(__self__, *, network: pulumi.Input[_builtins.str], project_id: pulumi.Input[_builtins.str], error_message: Optional[pulumi.Input[_builtins.str]] = ..., forwarding_rule: Optional[pulumi.Input[_builtins.str]] = ..., ip_address: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentDeployConfigArgs:
    def __init__(__self__, *, dedicated_resources: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesArgs]] = ..., fast_tryout_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., system_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @dedicated_resources.setter
    def dedicated_resources(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesArgs]]): # -> None:
        ...
    ...
    def fast_tryout_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def system_labels(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesArgs:
    def __init__(__self__, *, machine_spec: pulumi.Input[AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesMachineSpecArgs], min_replica_count: pulumi.Input[_builtins.int], autoscaling_metric_specs: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesAutoscalingMetricSpecArgs]]]] = ..., max_replica_count: Optional[pulumi.Input[_builtins.int]] = ..., required_replica_count: Optional[pulumi.Input[_builtins.int]] = ..., spot: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @machine_spec.setter
    def machine_spec(self, value: pulumi.Input[AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesMachineSpecArgs]): # -> None:
        ...
    ...
    @autoscaling_metric_specs.setter
    def autoscaling_metric_specs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesAutoscalingMetricSpecArgs]]]]): # -> None:
        ...
    ...
    def required_replica_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesMachineSpecArgs:
    def __init__(__self__, *, accelerator_count: Optional[pulumi.Input[_builtins.int]] = ..., accelerator_type: Optional[pulumi.Input[_builtins.str]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., multihost_gpu_node_count: Optional[pulumi.Input[_builtins.int]] = ..., reservation_affinity: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesMachineSpecReservationAffinityArgs]] = ..., tpu_topology: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def multihost_gpu_node_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def reservation_affinity(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesMachineSpecReservationAffinityArgs]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentDeployConfigDedicatedResourcesMachineSpecReservationAffinityArgs:
    def __init__(__self__, *, reservation_affinity_type: pulumi.Input[_builtins.str], key: Optional[pulumi.Input[_builtins.str]] = ..., values: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def reservation_affinity_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentEndpointConfigArgs:
    def __init__(__self__, *, dedicated_endpoint_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., endpoint_display_name: Optional[pulumi.Input[_builtins.str]] = ..., private_service_connect_config: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentEndpointConfigPrivateServiceConnectConfigArgs]] = ...) -> None:
    ...
    def dedicated_endpoint_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def endpoint_display_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def private_service_connect_config(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentEndpointConfigPrivateServiceConnectConfigArgs]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentEndpointConfigPrivateServiceConnectConfigArgs:
    def __init__(__self__, *, enable_private_service_connect: pulumi.Input[_builtins.bool], project_allowlists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., psc_automation_configs: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentEndpointConfigPrivateServiceConnectConfigPscAutomationConfigsArgs]] = ..., service_attachment: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @psc_automation_configs.setter
    def psc_automation_configs(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentEndpointConfigPrivateServiceConnectConfigPscAutomationConfigsArgs]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentModelConfigArgs:
    def __init__(__self__, *, accept_eula: Optional[pulumi.Input[_builtins.bool]] = ..., container_spec: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecArgs]] = ..., hugging_face_access_token: Optional[pulumi.Input[_builtins.str]] = ..., hugging_face_cache_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., model_display_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @accept_eula.setter
    def accept_eula(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def container_spec(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecArgs]]): # -> None:
        ...
    ...
    def hugging_face_access_token(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def hugging_face_cache_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def model_display_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecArgs:
    def __init__(__self__, *, image_uri: pulumi.Input[_builtins.str], args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., commands: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., deployment_timeout: Optional[pulumi.Input[_builtins.str]] = ..., envs: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecEnvArgs]]]] = ..., grpc_ports: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecGrpcPortArgs]]]] = ..., health_probe: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeArgs]] = ..., health_route: Optional[pulumi.Input[_builtins.str]] = ..., liveness_probe: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeArgs]] = ..., ports: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecPortArgs]]]] = ..., predict_route: Optional[pulumi.Input[_builtins.str]] = ..., shared_memory_size_mb: Optional[pulumi.Input[_builtins.str]] = ..., startup_probe: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeArgs]] = ...) -> None:
    ...
    def deployment_timeout(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @envs.setter
    def envs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecEnvArgs]]]]): # -> None:
        ...
    ...
    @grpc_ports.setter
    def grpc_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecGrpcPortArgs]]]]): # -> None:
        ...
    ...
    @health_probe.setter
    def health_probe(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeArgs]]): # -> None:
        ...
    ...
    @health_route.setter
    def health_route(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def liveness_probe(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeArgs]]): # -> None:
        ...
    ...
    @ports.setter
    def ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecPortArgs]]]]): # -> None:
        ...
    ...
    def predict_route(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def shared_memory_size_mb(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def startup_probe(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeArgs]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecGrpcPortArgs:
    def __init__(__self__, *, container_port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def container_port(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeArgs:
    def __init__(__self__, *, exec_: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeExecArgs]] = ..., failure_threshold: Optional[pulumi.Input[_builtins.int]] = ..., grpc: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeGrpcArgs]] = ..., http_get: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeHttpGetArgs]] = ..., initial_delay_seconds: Optional[pulumi.Input[_builtins.int]] = ..., period_seconds: Optional[pulumi.Input[_builtins.int]] = ..., success_threshold: Optional[pulumi.Input[_builtins.int]] = ..., tcp_socket: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeTcpSocketArgs]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @exec_.setter
    def exec_(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeExecArgs]]): # -> None:
        ...
    ...
    @grpc.setter
    def grpc(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeGrpcArgs]]): # -> None:
        ...
    ...
    @http_get.setter
    def http_get(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeHttpGetArgs]]): # -> None:
        ...
    ...
    @tcp_socket.setter
    def tcp_socket(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeTcpSocketArgs]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeGrpcArgs:
    def __init__(__self__, *, port: Optional[pulumi.Input[_builtins.int]] = ..., service: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeHttpGetArgs:
    def __init__(__self__, *, host: Optional[pulumi.Input[_builtins.str]] = ..., http_headers: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeHttpGetHttpHeaderArgs]]]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., scheme: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeHttpGetHttpHeaderArgs]]]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecHealthProbeTcpSocketArgs:
    def __init__(__self__, *, host: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeArgs:
    def __init__(__self__, *, exec_: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeExecArgs]] = ..., failure_threshold: Optional[pulumi.Input[_builtins.int]] = ..., grpc: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeGrpcArgs]] = ..., http_get: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGetArgs]] = ..., initial_delay_seconds: Optional[pulumi.Input[_builtins.int]] = ..., period_seconds: Optional[pulumi.Input[_builtins.int]] = ..., success_threshold: Optional[pulumi.Input[_builtins.int]] = ..., tcp_socket: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeTcpSocketArgs]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @exec_.setter
    def exec_(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeExecArgs]]): # -> None:
        ...
    ...
    @grpc.setter
    def grpc(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeGrpcArgs]]): # -> None:
        ...
    ...
    @http_get.setter
    def http_get(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGetArgs]]): # -> None:
        ...
    ...
    @tcp_socket.setter
    def tcp_socket(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeTcpSocketArgs]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGetArgs:
    def __init__(__self__, *, host: Optional[pulumi.Input[_builtins.str]] = ..., http_headers: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGetHttpHeaderArgs]]]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., scheme: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecLivenessProbeHttpGetHttpHeaderArgs]]]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeArgs:
    def __init__(__self__, *, exec_: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeExecArgs]] = ..., failure_threshold: Optional[pulumi.Input[_builtins.int]] = ..., grpc: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeGrpcArgs]] = ..., http_get: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeHttpGetArgs]] = ..., initial_delay_seconds: Optional[pulumi.Input[_builtins.int]] = ..., period_seconds: Optional[pulumi.Input[_builtins.int]] = ..., success_threshold: Optional[pulumi.Input[_builtins.int]] = ..., tcp_socket: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeTcpSocketArgs]] = ..., timeout_seconds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @exec_.setter
    def exec_(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeExecArgs]]): # -> None:
        ...
    ...
    @grpc.setter
    def grpc(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeGrpcArgs]]): # -> None:
        ...
    ...
    @http_get.setter
    def http_get(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeHttpGetArgs]]): # -> None:
        ...
    ...
    @tcp_socket.setter
    def tcp_socket(self, value: Optional[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeTcpSocketArgs]]): # -> None:
        ...
...
class AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeHttpGetArgs:
    def __init__(__self__, *, host: Optional[pulumi.Input[_builtins.str]] = ..., http_headers: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeHttpGetHttpHeaderArgs]]]] = ..., path: Optional[pulumi.Input[_builtins.str]] = ..., port: Optional[pulumi.Input[_builtins.int]] = ..., scheme: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @http_headers.setter
    def http_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiEndpointWithModelGardenDeploymentModelConfigContainerSpecStartupProbeHttpGetHttpHeaderArgs]]]]): # -> None:
        ...
...
class AiFeatureGroupBigQueryArgs:
    def __init__(__self__, *, big_query_source: pulumi.Input[AiFeatureGroupBigQueryBigQuerySourceArgs], entity_id_columns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def big_query_source(self, value: pulumi.Input[AiFeatureGroupBigQueryBigQuerySourceArgs]): # -> None:
        ...
    ...
    def entity_id_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AiFeatureGroupBigQueryBigQuerySourceArgs:
    ...
    @input_uri.setter
    def input_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AiFeatureOnlineStoreBigtableArgs:
    def __init__(__self__, *, auto_scaling: pulumi.Input[AiFeatureOnlineStoreBigtableAutoScalingArgs], enable_direct_bigtable_access: Optional[pulumi.Input[_builtins.bool]] = ..., zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @auto_scaling.setter
    def auto_scaling(self, value: pulumi.Input[AiFeatureOnlineStoreBigtableAutoScalingArgs]): # -> None:
        ...
    ...
    def enable_direct_bigtable_access(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class AiFeatureOnlineStoreBigtableAutoScalingArgs:
    def __init__(__self__, *, max_node_count: pulumi.Input[_builtins.int], min_node_count: pulumi.Input[_builtins.int], cpu_utilization_target: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def cpu_utilization_target(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AiFeatureOnlineStoreDedicatedServingEndpointArgs:
    def __init__(__self__, *, private_service_connect_config: Optional[pulumi.Input[AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfigArgs]] = ..., public_endpoint_domain_name: Optional[pulumi.Input[_builtins.str]] = ..., service_attachment: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @private_service_connect_config.setter
    def private_service_connect_config(self, value: Optional[pulumi.Input[AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfigArgs]]): # -> None:
        ...
    ...
    def public_endpoint_domain_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfigArgs:
    def __init__(__self__, *, enable_private_service_connect: pulumi.Input[_builtins.bool], project_allowlists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class AiFeatureOnlineStoreFeatureviewBigQuerySourceArgs:
    def __init__(__self__, *, entity_id_columns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], uri: pulumi.Input[_builtins.str]) -> None:
    ...
    @entity_id_columns.setter
    def entity_id_columns(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class AiFeatureOnlineStoreFeatureviewFeatureRegistrySourceArgs:
    def __init__(__self__, *, feature_groups: pulumi.Input[Sequence[pulumi.Input[AiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupArgs]]], project_number: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def feature_groups(self, value: pulumi.Input[Sequence[pulumi.Input[AiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupArgs]]]): # -> None:
        ...
...
class AiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupArgs:
    def __init__(__self__, *, feature_group_id: pulumi.Input[_builtins.str], feature_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def feature_group_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @feature_ids.setter
    def feature_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class AiFeatureOnlineStoreFeatureviewSyncConfigArgs:
    def __init__(__self__, *, continuous: Optional[pulumi.Input[_builtins.bool]] = ..., cron: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @continuous.setter
    def continuous(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @cron.setter
    def cron(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiFeatureOnlineStoreFeatureviewVectorSearchConfigArgs:
    def __init__(__self__, *, embedding_column: pulumi.Input[_builtins.str], brute_force_config: Optional[pulumi.Input[AiFeatureOnlineStoreFeatureviewVectorSearchConfigBruteForceConfigArgs]] = ..., crowding_column: Optional[pulumi.Input[_builtins.str]] = ..., distance_measure_type: Optional[pulumi.Input[_builtins.str]] = ..., embedding_dimension: Optional[pulumi.Input[_builtins.int]] = ..., filter_columns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., tree_ah_config: Optional[pulumi.Input[AiFeatureOnlineStoreFeatureviewVectorSearchConfigTreeAhConfigArgs]] = ...) -> None:
    ...
    def embedding_column(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def brute_force_config(self, value: Optional[pulumi.Input[AiFeatureOnlineStoreFeatureviewVectorSearchConfigBruteForceConfigArgs]]): # -> None:
        ...
    ...
    def crowding_column(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def distance_measure_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def embedding_dimension(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def filter_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def tree_ah_config(self, value: Optional[pulumi.Input[AiFeatureOnlineStoreFeatureviewVectorSearchConfigTreeAhConfigArgs]]): # -> None:
        ...
...
class AiFeatureOnlineStoreFeatureviewVectorSearchConfigTreeAhConfigArgs:
    def __init__(__self__, *, leaf_node_embedding_count: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def leaf_node_embedding_count(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiFeatureStoreEntityTypeMonitoringConfigArgs:
    def __init__(__self__, *, categorical_threshold_config: Optional[pulumi.Input[AiFeatureStoreEntityTypeMonitoringConfigCategoricalThresholdConfigArgs]] = ..., import_features_analysis: Optional[pulumi.Input[AiFeatureStoreEntityTypeMonitoringConfigImportFeaturesAnalysisArgs]] = ..., numerical_threshold_config: Optional[pulumi.Input[AiFeatureStoreEntityTypeMonitoringConfigNumericalThresholdConfigArgs]] = ..., snapshot_analysis: Optional[pulumi.Input[AiFeatureStoreEntityTypeMonitoringConfigSnapshotAnalysisArgs]] = ...) -> None:
    ...
    def categorical_threshold_config(self, value: Optional[pulumi.Input[AiFeatureStoreEntityTypeMonitoringConfigCategoricalThresholdConfigArgs]]): # -> None:
        ...
    ...
    def import_features_analysis(self, value: Optional[pulumi.Input[AiFeatureStoreEntityTypeMonitoringConfigImportFeaturesAnalysisArgs]]): # -> None:
        ...
    ...
    def numerical_threshold_config(self, value: Optional[pulumi.Input[AiFeatureStoreEntityTypeMonitoringConfigNumericalThresholdConfigArgs]]): # -> None:
        ...
    ...
    def snapshot_analysis(self, value: Optional[pulumi.Input[AiFeatureStoreEntityTypeMonitoringConfigSnapshotAnalysisArgs]]): # -> None:
        ...
...
class AiFeatureStoreEntityTypeMonitoringConfigImportFeaturesAnalysisArgs:
    def __init__(__self__, *, anomaly_detection_baseline: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def anomaly_detection_baseline(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiFeatureStoreEntityTypeMonitoringConfigSnapshotAnalysisArgs:
    def __init__(__self__, *, disabled: Optional[pulumi.Input[_builtins.bool]] = ..., monitoring_interval: Optional[pulumi.Input[_builtins.str]] = ..., monitoring_interval_days: Optional[pulumi.Input[_builtins.int]] = ..., staleness_days: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def monitoring_interval(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def monitoring_interval_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def staleness_days(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AiFeatureStoreOnlineServingConfigArgs:
    def __init__(__self__, *, fixed_node_count: Optional[pulumi.Input[_builtins.int]] = ..., scaling: Optional[pulumi.Input[AiFeatureStoreOnlineServingConfigScalingArgs]] = ...) -> None:
    ...
    def fixed_node_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @scaling.setter
    def scaling(self, value: Optional[pulumi.Input[AiFeatureStoreOnlineServingConfigScalingArgs]]): # -> None:
        ...
...
class AiIndexDeployedIndexArgs:
    def __init__(__self__, *, deployed_index_id: Optional[pulumi.Input[_builtins.str]] = ..., index_endpoint: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AiIndexEndpointDeployedIndexDedicatedResourcesArgs:
    def __init__(__self__, *, machine_spec: pulumi.Input[AiIndexEndpointDeployedIndexDedicatedResourcesMachineSpecArgs], min_replica_count: pulumi.Input[_builtins.int], max_replica_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @machine_spec.setter
    def machine_spec(self, value: pulumi.Input[AiIndexEndpointDeployedIndexDedicatedResourcesMachineSpecArgs]): # -> None:
        ...
...
class AiIndexEndpointDeployedIndexDedicatedResourcesMachineSpecArgs:
    def __init__(__self__, *, machine_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AiIndexEndpointDeployedIndexDeployedIndexAuthConfigArgs:
    def __init__(__self__, *, auth_provider: Optional[pulumi.Input[AiIndexEndpointDeployedIndexDeployedIndexAuthConfigAuthProviderArgs]] = ...) -> None:
    ...
    def auth_provider(self, value: Optional[pulumi.Input[AiIndexEndpointDeployedIndexDeployedIndexAuthConfigAuthProviderArgs]]): # -> None:
        ...
...
class AiIndexEndpointDeployedIndexDeployedIndexAuthConfigAuthProviderArgs:
    def __init__(__self__, *, allowed_issuers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., audiences: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allowed_issuers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class AiIndexEndpointDeployedIndexPrivateEndpointArgs:
    def __init__(__self__, *, match_grpc_address: Optional[pulumi.Input[_builtins.str]] = ..., psc_automated_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[AiIndexEndpointDeployedIndexPrivateEndpointPscAutomatedEndpointArgs]]]] = ..., service_attachment: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def match_grpc_address(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def psc_automated_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiIndexEndpointDeployedIndexPrivateEndpointPscAutomatedEndpointArgs]]]]): # -> None:
        ...
...
class AiIndexEndpointDeployedIndexPrivateEndpointPscAutomatedEndpointArgs:
    def __init__(__self__, *, match_address: Optional[pulumi.Input[_builtins.str]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., project_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def match_address(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiIndexEndpointPrivateServiceConnectConfigArgs:
    def __init__(__self__, *, enable_private_service_connect: pulumi.Input[_builtins.bool], project_allowlists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., psc_automation_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AiIndexEndpointPrivateServiceConnectConfigPscAutomationConfigArgs]]]] = ...) -> None:
    ...
    @psc_automation_configs.setter
    def psc_automation_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiIndexEndpointPrivateServiceConnectConfigPscAutomationConfigArgs]]]]): # -> None:
        ...
...
class AiIndexEndpointPrivateServiceConnectConfigPscAutomationConfigArgs:
    def __init__(__self__, *, network: pulumi.Input[_builtins.str], project_id: pulumi.Input[_builtins.str]) -> None:
...
class AiIndexIndexStatArgs:
    def __init__(__self__, *, shards_count: Optional[pulumi.Input[_builtins.int]] = ..., vectors_count: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @shards_count.setter
    def shards_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def vectors_count(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiIndexMetadataArgs:
    def __init__(__self__, *, config: pulumi.Input[AiIndexMetadataConfigArgs], contents_delta_uri: Optional[pulumi.Input[_builtins.str]] = ..., is_complete_overwrite: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @config.setter
    def config(self, value: pulumi.Input[AiIndexMetadataConfigArgs]): # -> None:
        ...
    ...
    def contents_delta_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def is_complete_overwrite(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class AiIndexMetadataConfigArgs:
    def __init__(__self__, *, dimensions: pulumi.Input[_builtins.int], algorithm_config: Optional[pulumi.Input[AiIndexMetadataConfigAlgorithmConfigArgs]] = ..., approximate_neighbors_count: Optional[pulumi.Input[_builtins.int]] = ..., distance_measure_type: Optional[pulumi.Input[_builtins.str]] = ..., feature_norm_type: Optional[pulumi.Input[_builtins.str]] = ..., shard_size: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def algorithm_config(self, value: Optional[pulumi.Input[AiIndexMetadataConfigAlgorithmConfigArgs]]): # -> None:
        ...
    ...
    def approximate_neighbors_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def feature_norm_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @shard_size.setter
    def shard_size(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiIndexMetadataConfigAlgorithmConfigArgs:
    def __init__(__self__, *, brute_force_config: Optional[pulumi.Input[AiIndexMetadataConfigAlgorithmConfigBruteForceConfigArgs]] = ..., tree_ah_config: Optional[pulumi.Input[AiIndexMetadataConfigAlgorithmConfigTreeAhConfigArgs]] = ...) -> None:
    ...
    @brute_force_config.setter
    def brute_force_config(self, value: Optional[pulumi.Input[AiIndexMetadataConfigAlgorithmConfigBruteForceConfigArgs]]): # -> None:
        ...
    ...
    @tree_ah_config.setter
    def tree_ah_config(self, value: Optional[pulumi.Input[AiIndexMetadataConfigAlgorithmConfigTreeAhConfigArgs]]): # -> None:
        ...
...
class AiIndexMetadataConfigAlgorithmConfigTreeAhConfigArgs:
    def __init__(__self__, *, leaf_node_embedding_count: Optional[pulumi.Input[_builtins.int]] = ..., leaf_nodes_to_search_percent: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @leaf_node_embedding_count.setter
    def leaf_node_embedding_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def leaf_nodes_to_search_percent(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class AiMetadataStoreStateArgs:
    def __init__(__self__, *, disk_utilization_bytes: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disk_utilization_bytes(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiRagEngineConfigRagManagedDbConfigArgs:
    def __init__(__self__, *, basic: Optional[pulumi.Input[AiRagEngineConfigRagManagedDbConfigBasicArgs]] = ..., scaled: Optional[pulumi.Input[AiRagEngineConfigRagManagedDbConfigScaledArgs]] = ..., unprovisioned: Optional[pulumi.Input[AiRagEngineConfigRagManagedDbConfigUnprovisionedArgs]] = ...) -> None:
    ...
    @basic.setter
    def basic(self, value: Optional[pulumi.Input[AiRagEngineConfigRagManagedDbConfigBasicArgs]]): # -> None:
        ...
    ...
    @scaled.setter
    def scaled(self, value: Optional[pulumi.Input[AiRagEngineConfigRagManagedDbConfigScaledArgs]]): # -> None:
        ...
    ...
    def unprovisioned(self, value: Optional[pulumi.Input[AiRagEngineConfigRagManagedDbConfigUnprovisionedArgs]]): # -> None:
        ...
...
class AiReasoningEngineSpecArgs:
    def __init__(__self__, *, agent_framework: Optional[pulumi.Input[_builtins.str]] = ..., class_methods: Optional[pulumi.Input[_builtins.str]] = ..., deployment_spec: Optional[pulumi.Input[AiReasoningEngineSpecDeploymentSpecArgs]] = ..., package_spec: Optional[pulumi.Input[AiReasoningEngineSpecPackageSpecArgs]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., source_code_spec: Optional[pulumi.Input[AiReasoningEngineSpecSourceCodeSpecArgs]] = ...) -> None:
    ...
    def agent_framework(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def class_methods(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def deployment_spec(self, value: Optional[pulumi.Input[AiReasoningEngineSpecDeploymentSpecArgs]]): # -> None:
        ...
    ...
    @package_spec.setter
    def package_spec(self, value: Optional[pulumi.Input[AiReasoningEngineSpecPackageSpecArgs]]): # -> None:
        ...
    ...
    def source_code_spec(self, value: Optional[pulumi.Input[AiReasoningEngineSpecSourceCodeSpecArgs]]): # -> None:
        ...
...
class AiReasoningEngineSpecDeploymentSpecArgs:
    def __init__(__self__, *, container_concurrency: Optional[pulumi.Input[_builtins.int]] = ..., envs: Optional[pulumi.Input[Sequence[pulumi.Input[AiReasoningEngineSpecDeploymentSpecEnvArgs]]]] = ..., max_instances: Optional[pulumi.Input[_builtins.int]] = ..., min_instances: Optional[pulumi.Input[_builtins.int]] = ..., psc_interface_config: Optional[pulumi.Input[AiReasoningEngineSpecDeploymentSpecPscInterfaceConfigArgs]] = ..., resource_limits: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., secret_envs: Optional[pulumi.Input[Sequence[pulumi.Input[AiReasoningEngineSpecDeploymentSpecSecretEnvArgs]]]] = ...) -> None:
    ...
    def container_concurrency(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @envs.setter
    def envs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiReasoningEngineSpecDeploymentSpecEnvArgs]]]]): # -> None:
        ...
    ...
    def psc_interface_config(self, value: Optional[pulumi.Input[AiReasoningEngineSpecDeploymentSpecPscInterfaceConfigArgs]]): # -> None:
        ...
    ...
    def resource_limits(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @secret_envs.setter
    def secret_envs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiReasoningEngineSpecDeploymentSpecSecretEnvArgs]]]]): # -> None:
        ...
...
class AiReasoningEngineSpecDeploymentSpecPscInterfaceConfigArgs:
    def __init__(__self__, *, dns_peering_configs: Optional[pulumi.Input[Sequence[pulumi.Input[AiReasoningEngineSpecDeploymentSpecPscInterfaceConfigDnsPeeringConfigArgs]]]] = ..., network_attachment: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dns_peering_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[AiReasoningEngineSpecDeploymentSpecPscInterfaceConfigDnsPeeringConfigArgs]]]]): # -> None:
        ...
    ...
    def network_attachment(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiReasoningEngineSpecDeploymentSpecPscInterfaceConfigDnsPeeringConfigArgs:
    def __init__(__self__, *, domain: pulumi.Input[_builtins.str], target_network: pulumi.Input[_builtins.str], target_project: pulumi.Input[_builtins.str]) -> None:
    ...
    def target_network(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def target_project(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AiReasoningEngineSpecDeploymentSpecSecretEnvArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], secret_ref: pulumi.Input[AiReasoningEngineSpecDeploymentSpecSecretEnvSecretRefArgs]) -> None:
    ...
    @secret_ref.setter
    def secret_ref(self, value: pulumi.Input[AiReasoningEngineSpecDeploymentSpecSecretEnvSecretRefArgs]): # -> None:
        ...
...
class AiReasoningEngineSpecDeploymentSpecSecretEnvSecretRefArgs:
    def __init__(__self__, *, secret: pulumi.Input[_builtins.str], version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class AiReasoningEngineSpecPackageSpecArgs:
    def __init__(__self__, *, dependency_files_gcs_uri: Optional[pulumi.Input[_builtins.str]] = ..., pickle_object_gcs_uri: Optional[pulumi.Input[_builtins.str]] = ..., python_version: Optional[pulumi.Input[_builtins.str]] = ..., requirements_gcs_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dependency_files_gcs_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def pickle_object_gcs_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def requirements_gcs_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiReasoningEngineSpecSourceCodeSpecArgs:
    def __init__(__self__, *, developer_connect_source: Optional[pulumi.Input[AiReasoningEngineSpecSourceCodeSpecDeveloperConnectSourceArgs]] = ..., inline_source: Optional[pulumi.Input[AiReasoningEngineSpecSourceCodeSpecInlineSourceArgs]] = ..., python_spec: Optional[pulumi.Input[AiReasoningEngineSpecSourceCodeSpecPythonSpecArgs]] = ...) -> None:
    ...
    def developer_connect_source(self, value: Optional[pulumi.Input[AiReasoningEngineSpecSourceCodeSpecDeveloperConnectSourceArgs]]): # -> None:
        ...
    ...
    def inline_source(self, value: Optional[pulumi.Input[AiReasoningEngineSpecSourceCodeSpecInlineSourceArgs]]): # -> None:
        ...
    ...
    @python_spec.setter
    def python_spec(self, value: Optional[pulumi.Input[AiReasoningEngineSpecSourceCodeSpecPythonSpecArgs]]): # -> None:
        ...
...
class AiReasoningEngineSpecSourceCodeSpecDeveloperConnectSourceArgs:
    def __init__(__self__, *, config: pulumi.Input[AiReasoningEngineSpecSourceCodeSpecDeveloperConnectSourceConfigArgs]) -> None:
    ...
    @config.setter
    def config(self, value: pulumi.Input[AiReasoningEngineSpecSourceCodeSpecDeveloperConnectSourceConfigArgs]): # -> None:
        ...
...
class AiReasoningEngineSpecSourceCodeSpecDeveloperConnectSourceConfigArgs:
    def __init__(__self__, *, dir: pulumi.Input[_builtins.str], git_repository_link: pulumi.Input[_builtins.str], revision: pulumi.Input[_builtins.str]) -> None:
    ...
    @dir.setter
    def dir(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def git_repository_link(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AiReasoningEngineSpecSourceCodeSpecInlineSourceArgs:
    def __init__(__self__, *, source_archive: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def source_archive(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AiReasoningEngineSpecSourceCodeSpecPythonSpecArgs:
    def __init__(__self__, *, entrypoint_module: Optional[pulumi.Input[_builtins.str]] = ..., entrypoint_object: Optional[pulumi.Input[_builtins.str]] = ..., requirements_file: Optional[pulumi.Input[_builtins.str]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def entrypoint_module(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def entrypoint_object(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def requirements_file(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
