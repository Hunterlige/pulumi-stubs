...
class AiFeatureOnlineStoreIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[AiFeatureOnlineStoreIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[AiFeatureOnlineStoreIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[AiFeatureOnlineStoreIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class AiFeatureOnlineStoreIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.AiFeatureOnlineStoreIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
