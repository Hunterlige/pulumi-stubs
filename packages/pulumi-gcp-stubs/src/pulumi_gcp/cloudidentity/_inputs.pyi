...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['GroupAdditionalGroupKeyArgs', 'GroupAdditionalGroupKeyArgsDict', 'GroupGroupKeyArgs', 'GroupGroupKeyArgsDict', 'GroupMembershipMemberKeyArgs', 'GroupMembershipMemberKeyArgsDict', 'GroupMembershipPreferredMemberKeyArgs', 'GroupMembershipPreferredMemberKeyArgsDict', 'GroupMembershipRoleArgs', 'GroupMembershipRoleArgsDict', 'GroupMembershipRoleExpiryDetailArgs', 'GroupMembershipRoleExpiryDetailArgsDict', 'PolicyPolicyQueryArgs', 'PolicyPolicyQueryArgsDict', 'PolicySettingArgs', 'PolicySettingArgsDict', 'GetGroupLookupGroupKeyArgs', 'GetGroupLookupGroupKeyArgsDict']
...
class GroupAdditionalGroupKeyArgs:
    def __init__(__self__, *, id: Optional[pulumi.Input[_builtins.str]] = ..., namespace: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class GroupGroupKeyArgs:
    def __init__(__self__, *, id: pulumi.Input[_builtins.str], namespace: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class GroupMembershipRoleArgs:
    def __init__(__self__, *, name: pulumi.Input[_builtins.str], expiry_detail: Optional[pulumi.Input[GroupMembershipRoleExpiryDetailArgs]] = ...) -> None:
    ...
    def expiry_detail(self, value: Optional[pulumi.Input[GroupMembershipRoleExpiryDetailArgs]]): # -> None:
        ...
...
class PolicyPolicyQueryArgs:
    def __init__(__self__, *, org_unit: pulumi.Input[_builtins.str], group: Optional[pulumi.Input[_builtins.str]] = ..., query: Optional[pulumi.Input[_builtins.str]] = ..., sort_order: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @org_unit.setter
    def org_unit(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @sort_order.setter
    def sort_order(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class PolicySettingArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], value_json: pulumi.Input[_builtins.str]) -> None:
    ...
    @value_json.setter
    def value_json(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class GetGroupLookupGroupKeyArgs:
    ...
    @namespace.setter
    def namespace(self, value: Optional[_builtins.str]): # -> None:
        ...
