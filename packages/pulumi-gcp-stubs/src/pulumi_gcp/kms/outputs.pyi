...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CryptoKeyIAMBindingCondition', 'CryptoKeyIAMMemberCondition', 'CryptoKeyKeyAccessJustificationsPolicy', 'CryptoKeyPrimary', 'CryptoKeyVersionAttestation', 'CryptoKeyVersionAttestationCertChains', ..., 'CryptoKeyVersionExternalProtectionLevelOptions', 'CryptoKeyVersionTemplate', 'EkmConnectionIamBindingCondition', 'EkmConnectionIamMemberCondition', 'EkmConnectionServiceResolver', 'EkmConnectionServiceResolverServerCertificate', ..., 'KeyRingIAMBindingCondition', 'KeyRingIAMMemberCondition', 'KeyRingImportJobAttestation', 'KeyRingImportJobPublicKey', ..., ..., 'GetCryptoKeyLatestVersionPublicKeyResult', 'GetCryptoKeyVersionsPublicKeyResult', 'GetCryptoKeyVersionsVersionResult', 'GetCryptoKeyVersionsVersionPublicKeyResult', 'GetCryptoKeysKeyResult', ..., 'GetCryptoKeysKeyPrimaryResult', 'GetCryptoKeysKeyVersionTemplateResult', 'GetKMSCryptoKeyKeyAccessJustificationsPolicyResult', 'GetKMSCryptoKeyPrimaryResult', 'GetKMSCryptoKeyVersionPublicKeyResult', 'GetKMSCryptoKeyVersionTemplateResult', 'GetKeyHandlesKeyHandleResult', 'GetKeyRingsKeyRingResult']
@pulumi.output_type
...
class CryptoKeyKeyAccessJustificationsPolicy(dict):
    ...
    def __init__(__self__, *, allowed_access_reasons: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CryptoKeyVersionAttestation(dict):
    ...
    def __init__(__self__, *, cert_chains: Optional[outputs.CryptoKeyVersionAttestationCertChains] = ..., content: Optional[_builtins.str] = ..., external_protection_level_options: Optional[outputs.CryptoKeyVersionAttestationExternalProtectionLevelOptions] = ..., format: Optional[_builtins.str] = ...) -> None:
...
class CryptoKeyVersionAttestationCertChains(dict):
    ...
    def __init__(__self__, *, cavium_certs: Optional[Sequence[_builtins.str]] = ..., google_card_certs: Optional[Sequence[_builtins.str]] = ..., google_partition_certs: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class CryptoKeyVersionAttestationExternalProtectionLevelOptions(dict):
    ...
    def __init__(__self__, *, ekm_connection_key_path: Optional[_builtins.str] = ..., external_key_uri: Optional[_builtins.str] = ...) -> None:
...
class CryptoKeyVersionTemplate(dict):
    ...
    def __init__(__self__, *, algorithm: _builtins.str, protection_level: Optional[_builtins.str] = ...) -> None:
...
class EkmConnectionServiceResolver(dict):
    ...
    def __init__(__self__, *, hostname: _builtins.str, server_certificates: Sequence[outputs.EkmConnectionServiceResolverServerCertificate], service_directory_service: _builtins.str, endpoint_filter: Optional[_builtins.str] = ...) -> None:
...
class EkmConnectionServiceResolverServerCertificate(dict):
    ...
    def __init__(__self__, *, raw_der: _builtins.str, issuer: Optional[_builtins.str] = ..., not_after_time: Optional[_builtins.str] = ..., not_before_time: Optional[_builtins.str] = ..., parsed: Optional[_builtins.bool] = ..., serial_number: Optional[_builtins.str] = ..., sha256_fingerprint: Optional[_builtins.str] = ..., subject: Optional[_builtins.str] = ..., subject_alternative_dns_names: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class KeyRingImportJobAttestation(dict):
    def __init__(__self__, *, content: Optional[_builtins.str] = ..., format: Optional[_builtins.str] = ...) -> None:
...
class GetCryptoKeyVersionsVersionResult(dict):
    def __init__(__self__, *, algorithm: _builtins.str, crypto_key: _builtins.str, id: _builtins.str, name: _builtins.str, protection_level: _builtins.str, public_keys: Sequence[outputs.GetCryptoKeyVersionsVersionPublicKeyResult], state: _builtins.str, version: _builtins.int) -> None:
...
class GetCryptoKeysKeyResult(dict):
    def __init__(__self__, *, crypto_key_backend: _builtins.str, destroy_scheduled_duration: _builtins.str, effective_labels: Mapping[str, _builtins.str], id: _builtins.str, import_only: _builtins.bool, key_access_justifications_policies: Sequence[outputs.GetCryptoKeysKeyKeyAccessJustificationsPolicyResult], labels: Mapping[str, _builtins.str], primaries: Sequence[outputs.GetCryptoKeysKeyPrimaryResult], pulumi_labels: Mapping[str, _builtins.str], purpose: _builtins.str, rotation_period: _builtins.str, skip_initial_version_creation: _builtins.bool, version_templates: Sequence[outputs.GetCryptoKeysKeyVersionTemplateResult], key_ring: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class GetCryptoKeysKeyKeyAccessJustificationsPolicyResult(dict):
    def __init__(__self__, *, allowed_access_reasons: Sequence[_builtins.str]) -> None:
...
class GetCryptoKeysKeyVersionTemplateResult(dict):
    def __init__(__self__, *, algorithm: _builtins.str, protection_level: _builtins.str) -> None:
...
class GetKeyHandlesKeyHandleResult(dict):
    def __init__(__self__, *, kms_key: _builtins.str, name: _builtins.str, resource_type_selector: _builtins.str) -> None:
