...
class CryptoKeyIAMMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[CryptoKeyIAMMemberConditionArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[CryptoKeyIAMMemberConditionArgs]]
    ): ...
...
class CryptoKeyIAMMember(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    CryptoKeyIAMMemberConditionArgs, CryptoKeyIAMMemberConditionArgsDict
                ]
            ]
        ] = ...,
        crypto_key_id: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.CryptoKeyIAMMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="cryptoKeyId")
