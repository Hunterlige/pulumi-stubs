...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CryptoKeyIAMBindingConditionArgs', 'CryptoKeyIAMBindingConditionArgsDict', 'CryptoKeyIAMMemberConditionArgs', 'CryptoKeyIAMMemberConditionArgsDict', 'CryptoKeyKeyAccessJustificationsPolicyArgs', 'CryptoKeyKeyAccessJustificationsPolicyArgsDict', 'CryptoKeyPrimaryArgs', 'CryptoKeyPrimaryArgsDict', 'CryptoKeyVersionAttestationArgs', 'CryptoKeyVersionAttestationArgsDict', 'CryptoKeyVersionAttestationCertChainsArgs', 'CryptoKeyVersionAttestationCertChainsArgsDict', ..., ..., 'CryptoKeyVersionExternalProtectionLevelOptionsArgs', ..., 'CryptoKeyVersionTemplateArgs', 'CryptoKeyVersionTemplateArgsDict', 'EkmConnectionIamBindingConditionArgs', 'EkmConnectionIamBindingConditionArgsDict', 'EkmConnectionIamMemberConditionArgs', 'EkmConnectionIamMemberConditionArgsDict', 'EkmConnectionServiceResolverArgs', 'EkmConnectionServiceResolverArgsDict', 'EkmConnectionServiceResolverServerCertificateArgs', ..., ..., ..., 'KeyRingIAMBindingConditionArgs', 'KeyRingIAMBindingConditionArgsDict', 'KeyRingIAMMemberConditionArgs', 'KeyRingIAMMemberConditionArgsDict', 'KeyRingImportJobAttestationArgs', 'KeyRingImportJobAttestationArgsDict', 'KeyRingImportJobPublicKeyArgs', 'KeyRingImportJobPublicKeyArgsDict', ..., ..., ..., ...]
...
class CryptoKeyKeyAccessJustificationsPolicyArgs:
    def __init__(__self__, *, allowed_access_reasons: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def allowed_access_reasons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class CryptoKeyPrimaryArgs:
    def __init__(__self__, *, name: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class CryptoKeyVersionAttestationArgs:
    def __init__(__self__, *, cert_chains: Optional[pulumi.Input[CryptoKeyVersionAttestationCertChainsArgs]] = ..., content: Optional[pulumi.Input[_builtins.str]] = ..., external_protection_level_options: Optional[pulumi.Input[CryptoKeyVersionAttestationExternalProtectionLevelOptionsArgs]] = ..., format: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @cert_chains.setter
    def cert_chains(self, value: Optional[pulumi.Input[CryptoKeyVersionAttestationCertChainsArgs]]): # -> None:
        ...
    ...
    def external_protection_level_options(self, value: Optional[pulumi.Input[CryptoKeyVersionAttestationExternalProtectionLevelOptionsArgs]]): # -> None:
        ...
...
class CryptoKeyVersionAttestationCertChainsArgs:
    def __init__(__self__, *, cavium_certs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., google_card_certs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., google_partition_certs: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @cavium_certs.setter
    def cavium_certs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def google_card_certs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def google_partition_certs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class CryptoKeyVersionAttestationExternalProtectionLevelOptionsArgs:
    def __init__(__self__, *, ekm_connection_key_path: Optional[pulumi.Input[_builtins.str]] = ..., external_key_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def ekm_connection_key_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def external_key_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class CryptoKeyVersionTemplateArgs:
    def __init__(__self__, *, algorithm: pulumi.Input[_builtins.str], protection_level: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def protection_level(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EkmConnectionServiceResolverArgs:
    def __init__(__self__, *, hostname: pulumi.Input[_builtins.str], server_certificates: pulumi.Input[Sequence[pulumi.Input[EkmConnectionServiceResolverServerCertificateArgs]]], service_directory_service: pulumi.Input[_builtins.str], endpoint_filter: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def server_certificates(self, value: pulumi.Input[Sequence[pulumi.Input[EkmConnectionServiceResolverServerCertificateArgs]]]): # -> None:
        ...
    ...
    def service_directory_service(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def endpoint_filter(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class EkmConnectionServiceResolverServerCertificateArgs:
    def __init__(__self__, *, raw_der: pulumi.Input[_builtins.str], issuer: Optional[pulumi.Input[_builtins.str]] = ..., not_after_time: Optional[pulumi.Input[_builtins.str]] = ..., not_before_time: Optional[pulumi.Input[_builtins.str]] = ..., parsed: Optional[pulumi.Input[_builtins.bool]] = ..., serial_number: Optional[pulumi.Input[_builtins.str]] = ..., sha256_fingerprint: Optional[pulumi.Input[_builtins.str]] = ..., subject: Optional[pulumi.Input[_builtins.str]] = ..., subject_alternative_dns_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @raw_der.setter
    def raw_der(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @parsed.setter
    def parsed(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def sha256_fingerprint(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def subject_alternative_dns_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class KeyRingImportJobAttestationArgs:
    def __init__(__self__, *, content: Optional[pulumi.Input[_builtins.str]] = ..., format: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
