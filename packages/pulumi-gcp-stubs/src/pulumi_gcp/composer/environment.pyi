...
class EnvironmentArgs:
    def __init__(
        __self__,
        *,
        config: Optional[pulumi.Input[EnvironmentConfigArgs]] = ...,
        labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
        storage_config: Optional[pulumi.Input[EnvironmentStorageConfigArgs]] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
    ...
    def storage_config(
        self,
    ) -> Optional[pulumi.Input[EnvironmentStorageConfigArgs]]: ...
    @storage_config.setter
    def storage_config(
        self, value: Optional[pulumi.Input[EnvironmentStorageConfigArgs]]
    ): ...
...
class Environment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        config: Optional[
            pulumi.Input[Union[EnvironmentConfigArgs, EnvironmentConfigArgsDict]]
        ] = ...,
        labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
        ...
        storage_config: Optional[
            pulumi.Input[
                Union[EnvironmentStorageConfigArgs, EnvironmentStorageConfigArgsDict]
            ]
        ] = ...,
        __props__=...,
    ) -> None: ...
