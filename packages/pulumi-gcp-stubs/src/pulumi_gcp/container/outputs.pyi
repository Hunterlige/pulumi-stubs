...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AttachedClusterAuthorization', 'AttachedClusterBinaryAuthorization', 'AttachedClusterError', 'AttachedClusterFleet', 'AttachedClusterLoggingConfig', 'AttachedClusterLoggingConfigComponentConfig', 'AttachedClusterMonitoringConfig', ..., 'AttachedClusterOidcConfig', 'AttachedClusterProxyConfig', 'AttachedClusterProxyConfigKubernetesSecret', 'AttachedClusterSecurityPostureConfig', 'AttachedClusterWorkloadIdentityConfig', 'AwsClusterAuthorization', 'AwsClusterAuthorizationAdminGroup', 'AwsClusterAuthorizationAdminUser', 'AwsClusterBinaryAuthorization', 'AwsClusterControlPlane', 'AwsClusterControlPlaneAwsServicesAuthentication', 'AwsClusterControlPlaneConfigEncryption', 'AwsClusterControlPlaneDatabaseEncryption', 'AwsClusterControlPlaneInstancePlacement', 'AwsClusterControlPlaneMainVolume', 'AwsClusterControlPlaneProxyConfig', 'AwsClusterControlPlaneRootVolume', 'AwsClusterControlPlaneSshConfig', 'AwsClusterFleet', 'AwsClusterLoggingConfig', 'AwsClusterLoggingConfigComponentConfig', 'AwsClusterNetworking', 'AwsClusterWorkloadIdentityConfig', 'AwsNodePoolAutoscaling', 'AwsNodePoolConfig', 'AwsNodePoolConfigAutoscalingMetricsCollection', 'AwsNodePoolConfigConfigEncryption', 'AwsNodePoolConfigInstancePlacement', 'AwsNodePoolConfigProxyConfig', 'AwsNodePoolConfigRootVolume', 'AwsNodePoolConfigSpotConfig', 'AwsNodePoolConfigSshConfig', 'AwsNodePoolConfigTaint', 'AwsNodePoolKubeletConfig', 'AwsNodePoolManagement', 'AwsNodePoolMaxPodsConstraint', 'AwsNodePoolUpdateSettings', 'AwsNodePoolUpdateSettingsSurgeSettings', 'AzureClusterAuthorization', 'AzureClusterAuthorizationAdminGroup', 'AzureClusterAuthorizationAdminUser', 'AzureClusterAzureServicesAuthentication', 'AzureClusterControlPlane', 'AzureClusterControlPlaneDatabaseEncryption', 'AzureClusterControlPlaneMainVolume', 'AzureClusterControlPlaneProxyConfig', 'AzureClusterControlPlaneReplicaPlacement', 'AzureClusterControlPlaneRootVolume', 'AzureClusterControlPlaneSshConfig', 'AzureClusterFleet', 'AzureClusterLoggingConfig', 'AzureClusterLoggingConfigComponentConfig', 'AzureClusterNetworking', 'AzureClusterWorkloadIdentityConfig', 'AzureNodePoolAutoscaling', 'AzureNodePoolConfig', 'AzureNodePoolConfigProxyConfig', 'AzureNodePoolConfigRootVolume', 'AzureNodePoolConfigSshConfig', 'AzureNodePoolManagement', 'AzureNodePoolMaxPodsConstraint', 'ClusterAddonsConfig', 'ClusterAddonsConfigCloudrunConfig', 'ClusterAddonsConfigConfigConnectorConfig', 'ClusterAddonsConfigDnsCacheConfig', ..., 'ClusterAddonsConfigGcpFilestoreCsiDriverConfig', 'ClusterAddonsConfigGcsFuseCsiDriverConfig', 'ClusterAddonsConfigGkeBackupAgentConfig', 'ClusterAddonsConfigHorizontalPodAutoscaling', 'ClusterAddonsConfigHttpLoadBalancing', 'ClusterAddonsConfigIstioConfig', 'ClusterAddonsConfigKalmConfig', 'ClusterAddonsConfigLustreCsiDriverConfig', 'ClusterAddonsConfigNetworkPolicyConfig', 'ClusterAddonsConfigParallelstoreCsiDriverConfig', 'ClusterAddonsConfigPodSnapshotConfig', 'ClusterAddonsConfigRayOperatorConfig', ..., ..., 'ClusterAddonsConfigSliceControllerConfig', 'ClusterAddonsConfigStatefulHaConfig', 'ClusterAnonymousAuthenticationConfig', 'ClusterAuthenticatorGroupsConfig', 'ClusterBinaryAuthorization', 'ClusterClusterAutoscaling', 'ClusterClusterAutoscalingAutoProvisioningDefaults', ..., ..., ..., ..., ..., ..., 'ClusterClusterAutoscalingResourceLimit', 'ClusterClusterTelemetry', 'ClusterConfidentialNodes', 'ClusterControlPlaneEndpointsConfig', ..., ..., 'ClusterCostManagementConfig', 'ClusterDatabaseEncryption', 'ClusterDefaultSnatStatus', 'ClusterDnsConfig', 'ClusterEnableK8sBetaApis', 'ClusterEnterpriseConfig', 'ClusterFleet', 'ClusterGatewayApiConfig', 'ClusterGkeAutoUpgradeConfig', 'ClusterIdentityServiceConfig', 'ClusterIpAllocationPolicy', 'ClusterIpAllocationPolicyAdditionalIpRangesConfig', 'ClusterIpAllocationPolicyAdditionalPodRangesConfig', 'ClusterIpAllocationPolicyAutoIpamConfig', 'ClusterIpAllocationPolicyNetworkTierConfig', ..., 'ClusterLoggingConfig', 'ClusterMaintenancePolicy', 'ClusterMaintenancePolicyDailyMaintenanceWindow', 'ClusterMaintenancePolicyDisruptionBudget', 'ClusterMaintenancePolicyMaintenanceExclusion', ..., 'ClusterMaintenancePolicyRecurringWindow', 'ClusterManagedOpentelemetryConfig', 'ClusterMasterAuth', 'ClusterMasterAuthClientCertificateConfig', 'ClusterMasterAuthorizedNetworksConfig', 'ClusterMasterAuthorizedNetworksConfigCidrBlock', 'ClusterMeshCertificates', 'ClusterMonitoringConfig', ..., 'ClusterMonitoringConfigManagedPrometheus', ..., 'ClusterNetworkPerformanceConfig', 'ClusterNetworkPolicy', 'ClusterNodeConfig', 'ClusterNodeConfigAdvancedMachineFeatures', 'ClusterNodeConfigBootDisk', 'ClusterNodeConfigConfidentialNodes', 'ClusterNodeConfigContainerdConfig', ..., ..., ..., 'ClusterNodeConfigContainerdConfigRegistryHost', 'ClusterNodeConfigContainerdConfigRegistryHostHost', ..., ..., ..., ..., ..., 'ClusterNodeConfigContainerdConfigWritableCgroups', 'ClusterNodeConfigEffectiveTaint', 'ClusterNodeConfigEphemeralStorageConfig', 'ClusterNodeConfigEphemeralStorageLocalSsdConfig', 'ClusterNodeConfigFastSocket', 'ClusterNodeConfigGcfsConfig', 'ClusterNodeConfigGuestAccelerator', ..., 'ClusterNodeConfigGuestAcceleratorGpuSharingConfig', 'ClusterNodeConfigGvnic', 'ClusterNodeConfigHostMaintenancePolicy', 'ClusterNodeConfigKubeletConfig', ..., 'ClusterNodeConfigKubeletConfigEvictionSoft', ..., 'ClusterNodeConfigKubeletConfigMemoryManager', 'ClusterNodeConfigKubeletConfigTopologyManager', 'ClusterNodeConfigLinuxNodeConfig', 'ClusterNodeConfigLinuxNodeConfigHugepagesConfig', ..., 'ClusterNodeConfigLocalNvmeSsdBlockConfig', 'ClusterNodeConfigReservationAffinity', 'ClusterNodeConfigSandboxConfig', 'ClusterNodeConfigSecondaryBootDisk', 'ClusterNodeConfigShieldedInstanceConfig', 'ClusterNodeConfigSoleTenantConfig', 'ClusterNodeConfigSoleTenantConfigNodeAffinity', 'ClusterNodeConfigTaint', 'ClusterNodeConfigWindowsNodeConfig', 'ClusterNodeConfigWorkloadMetadataConfig', 'ClusterNodePool', 'ClusterNodePoolAutoConfig', 'ClusterNodePoolAutoConfigLinuxNodeConfig', ..., 'ClusterNodePoolAutoConfigNetworkTags', 'ClusterNodePoolAutoConfigNodeKubeletConfig', 'ClusterNodePoolAutoscaling', 'ClusterNodePoolDefaults', 'ClusterNodePoolDefaultsNodeConfigDefaults', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ClusterNodePoolManagement', 'ClusterNodePoolNetworkConfig', ..., ..., ..., ..., 'ClusterNodePoolNodeConfig', 'ClusterNodePoolNodeConfigAdvancedMachineFeatures', 'ClusterNodePoolNodeConfigBootDisk', 'ClusterNodePoolNodeConfigConfidentialNodes', 'ClusterNodePoolNodeConfigContainerdConfig', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ClusterNodePoolNodeConfigEffectiveTaint', 'ClusterNodePoolNodeConfigEphemeralStorageConfig', ..., 'ClusterNodePoolNodeConfigFastSocket', 'ClusterNodePoolNodeConfigGcfsConfig', 'ClusterNodePoolNodeConfigGuestAccelerator', ..., ..., 'ClusterNodePoolNodeConfigGvnic', 'ClusterNodePoolNodeConfigHostMaintenancePolicy', 'ClusterNodePoolNodeConfigKubeletConfig', ..., 'ClusterNodePoolNodeConfigKubeletConfigEvictionSoft', ..., ..., ..., 'ClusterNodePoolNodeConfigLinuxNodeConfig', ..., ..., 'ClusterNodePoolNodeConfigLocalNvmeSsdBlockConfig', 'ClusterNodePoolNodeConfigReservationAffinity', 'ClusterNodePoolNodeConfigSandboxConfig', 'ClusterNodePoolNodeConfigSecondaryBootDisk', 'ClusterNodePoolNodeConfigShieldedInstanceConfig', 'ClusterNodePoolNodeConfigSoleTenantConfig', ..., 'ClusterNodePoolNodeConfigTaint', 'ClusterNodePoolNodeConfigWindowsNodeConfig', 'ClusterNodePoolNodeConfigWorkloadMetadataConfig', 'ClusterNodePoolNodeDrainConfig', 'ClusterNodePoolPlacementPolicy', 'ClusterNodePoolQueuedProvisioning', 'ClusterNodePoolUpgradeSettings', 'ClusterNodePoolUpgradeSettingsBlueGreenSettings', ..., ..., 'ClusterNotificationConfig', 'ClusterNotificationConfigPubsub', 'ClusterNotificationConfigPubsubFilter', 'ClusterPodAutoscaling', 'ClusterPodSecurityPolicyConfig', 'ClusterPrivateClusterConfig', ..., 'ClusterProtectConfig', 'ClusterProtectConfigWorkloadConfig', 'ClusterRbacBindingConfig', 'ClusterReleaseChannel', 'ClusterResourceUsageExportConfig', ..., 'ClusterSecretManagerConfig', 'ClusterSecretManagerConfigRotationConfig', 'ClusterSecretSyncConfig', 'ClusterSecretSyncConfigRotationConfig', 'ClusterSecurityPostureConfig', 'ClusterServiceExternalIpsConfig', 'ClusterTpuConfig', 'ClusterUserManagedKeysConfig', 'ClusterVerticalPodAutoscaling', 'ClusterWorkloadAltsConfig', 'ClusterWorkloadIdentityConfig', 'NodePoolAutoscaling', 'NodePoolManagement', 'NodePoolNetworkConfig', 'NodePoolNetworkConfigAdditionalNodeNetworkConfig', 'NodePoolNetworkConfigAdditionalPodNetworkConfig', 'NodePoolNetworkConfigNetworkPerformanceConfig', 'NodePoolNetworkConfigPodCidrOverprovisionConfig', 'NodePoolNodeConfig', 'NodePoolNodeConfigAdvancedMachineFeatures', 'NodePoolNodeConfigBootDisk', 'NodePoolNodeConfigConfidentialNodes', 'NodePoolNodeConfigContainerdConfig', ..., ..., ..., 'NodePoolNodeConfigContainerdConfigRegistryHost', 'NodePoolNodeConfigContainerdConfigRegistryHostHost', ..., ..., ..., ..., ..., 'NodePoolNodeConfigContainerdConfigWritableCgroups', 'NodePoolNodeConfigEffectiveTaint', 'NodePoolNodeConfigEphemeralStorageConfig', 'NodePoolNodeConfigEphemeralStorageLocalSsdConfig', 'NodePoolNodeConfigFastSocket', 'NodePoolNodeConfigGcfsConfig', 'NodePoolNodeConfigGuestAccelerator', ..., 'NodePoolNodeConfigGuestAcceleratorGpuSharingConfig', 'NodePoolNodeConfigGvnic', 'NodePoolNodeConfigHostMaintenancePolicy', 'NodePoolNodeConfigKubeletConfig', ..., 'NodePoolNodeConfigKubeletConfigEvictionSoft', ..., 'NodePoolNodeConfigKubeletConfigMemoryManager', 'NodePoolNodeConfigKubeletConfigTopologyManager', 'NodePoolNodeConfigLinuxNodeConfig', 'NodePoolNodeConfigLinuxNodeConfigHugepagesConfig', ..., 'NodePoolNodeConfigLocalNvmeSsdBlockConfig', 'NodePoolNodeConfigReservationAffinity', 'NodePoolNodeConfigSandboxConfig', 'NodePoolNodeConfigSecondaryBootDisk', 'NodePoolNodeConfigShieldedInstanceConfig', 'NodePoolNodeConfigSoleTenantConfig', 'NodePoolNodeConfigSoleTenantConfigNodeAffinity', 'NodePoolNodeConfigTaint', 'NodePoolNodeConfigWindowsNodeConfig', 'NodePoolNodeConfigWorkloadMetadataConfig', 'NodePoolNodeDrainConfig', 'NodePoolPlacementPolicy', 'NodePoolQueuedProvisioning', 'NodePoolUpgradeSettings', 'NodePoolUpgradeSettingsBlueGreenSettings', ..., ..., 'GetClusterAddonsConfigResult', 'GetClusterAddonsConfigCloudrunConfigResult', 'GetClusterAddonsConfigConfigConnectorConfigResult', 'GetClusterAddonsConfigDnsCacheConfigResult', ..., ..., 'GetClusterAddonsConfigGcsFuseCsiDriverConfigResult', 'GetClusterAddonsConfigGkeBackupAgentConfigResult', ..., 'GetClusterAddonsConfigHttpLoadBalancingResult', 'GetClusterAddonsConfigIstioConfigResult', 'GetClusterAddonsConfigKalmConfigResult', 'GetClusterAddonsConfigLustreCsiDriverConfigResult', 'GetClusterAddonsConfigNetworkPolicyConfigResult', ..., 'GetClusterAddonsConfigPodSnapshotConfigResult', 'GetClusterAddonsConfigRayOperatorConfigResult', ..., ..., 'GetClusterAddonsConfigSliceControllerConfigResult', 'GetClusterAddonsConfigStatefulHaConfigResult', 'GetClusterAnonymousAuthenticationConfigResult', 'GetClusterAuthenticatorGroupsConfigResult', 'GetClusterBinaryAuthorizationResult', 'GetClusterClusterAutoscalingResult', ..., ..., ..., ..., ..., ..., ..., 'GetClusterClusterAutoscalingResourceLimitResult', 'GetClusterClusterTelemetryResult', 'GetClusterConfidentialNodeResult', 'GetClusterControlPlaneEndpointsConfigResult', ..., ..., 'GetClusterCostManagementConfigResult', 'GetClusterDatabaseEncryptionResult', 'GetClusterDefaultSnatStatusResult', 'GetClusterDnsConfigResult', 'GetClusterEnableK8sBetaApiResult', 'GetClusterEnterpriseConfigResult', 'GetClusterFleetResult', 'GetClusterGatewayApiConfigResult', 'GetClusterGkeAutoUpgradeConfigResult', 'GetClusterIdentityServiceConfigResult', 'GetClusterIpAllocationPolicyResult', ..., ..., 'GetClusterIpAllocationPolicyAutoIpamConfigResult', ..., ..., 'GetClusterLoggingConfigResult', 'GetClusterMaintenancePolicyResult', ..., 'GetClusterMaintenancePolicyDisruptionBudgetResult', ..., ..., 'GetClusterMaintenancePolicyRecurringWindowResult', 'GetClusterManagedOpentelemetryConfigResult', 'GetClusterMasterAuthResult', 'GetClusterMasterAuthClientCertificateConfigResult', 'GetClusterMasterAuthorizedNetworksConfigResult', ..., 'GetClusterMeshCertificateResult', 'GetClusterMonitoringConfigResult', ..., 'GetClusterMonitoringConfigManagedPrometheusResult', ..., 'GetClusterNetworkPerformanceConfigResult', 'GetClusterNetworkPolicyResult', 'GetClusterNodeConfigResult', 'GetClusterNodeConfigAdvancedMachineFeatureResult', 'GetClusterNodeConfigBootDiskResult', 'GetClusterNodeConfigConfidentialNodeResult', 'GetClusterNodeConfigContainerdConfigResult', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetClusterNodeConfigEffectiveTaintResult', 'GetClusterNodeConfigEphemeralStorageConfigResult', ..., 'GetClusterNodeConfigFastSocketResult', 'GetClusterNodeConfigGcfsConfigResult', 'GetClusterNodeConfigGuestAcceleratorResult', ..., ..., 'GetClusterNodeConfigGvnicResult', 'GetClusterNodeConfigHostMaintenancePolicyResult', 'GetClusterNodeConfigKubeletConfigResult', ..., ..., ..., ..., ..., 'GetClusterNodeConfigLinuxNodeConfigResult', ..., ..., 'GetClusterNodeConfigLocalNvmeSsdBlockConfigResult', 'GetClusterNodeConfigReservationAffinityResult', 'GetClusterNodeConfigSandboxConfigResult', 'GetClusterNodeConfigSecondaryBootDiskResult', 'GetClusterNodeConfigShieldedInstanceConfigResult', 'GetClusterNodeConfigSoleTenantConfigResult', ..., 'GetClusterNodeConfigTaintResult', 'GetClusterNodeConfigWindowsNodeConfigResult', 'GetClusterNodeConfigWorkloadMetadataConfigResult', 'GetClusterNodePoolResult', 'GetClusterNodePoolAutoConfigResult', 'GetClusterNodePoolAutoConfigLinuxNodeConfigResult', ..., 'GetClusterNodePoolAutoConfigNetworkTagResult', ..., 'GetClusterNodePoolAutoscalingResult', 'GetClusterNodePoolDefaultResult', 'GetClusterNodePoolDefaultNodeConfigDefaultResult', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetClusterNodePoolManagementResult', 'GetClusterNodePoolNetworkConfigResult', ..., ..., ..., ..., 'GetClusterNodePoolNodeConfigResult', ..., 'GetClusterNodePoolNodeConfigBootDiskResult', 'GetClusterNodePoolNodeConfigConfidentialNodeResult', 'GetClusterNodePoolNodeConfigContainerdConfigResult', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GetClusterNodePoolNodeConfigEffectiveTaintResult', ..., ..., 'GetClusterNodePoolNodeConfigFastSocketResult', 'GetClusterNodePoolNodeConfigGcfsConfigResult', 'GetClusterNodePoolNodeConfigGuestAcceleratorResult', ..., ..., 'GetClusterNodePoolNodeConfigGvnicResult', ..., 'GetClusterNodePoolNodeConfigKubeletConfigResult', ..., ..., ..., ..., ..., 'GetClusterNodePoolNodeConfigLinuxNodeConfigResult', ..., ..., ..., ..., 'GetClusterNodePoolNodeConfigSandboxConfigResult', ..., ..., 'GetClusterNodePoolNodeConfigSoleTenantConfigResult', ..., 'GetClusterNodePoolNodeConfigTaintResult', ..., ..., 'GetClusterNodePoolNodeDrainConfigResult', 'GetClusterNodePoolPlacementPolicyResult', 'GetClusterNodePoolQueuedProvisioningResult', 'GetClusterNodePoolUpgradeSettingResult', ..., ..., ..., 'GetClusterNotificationConfigResult', 'GetClusterNotificationConfigPubsubResult', 'GetClusterNotificationConfigPubsubFilterResult', 'GetClusterPodAutoscalingResult', 'GetClusterPodSecurityPolicyConfigResult', 'GetClusterPrivateClusterConfigResult', ..., 'GetClusterProtectConfigResult', 'GetClusterProtectConfigWorkloadConfigResult', 'GetClusterRbacBindingConfigResult', 'GetClusterReleaseChannelResult', 'GetClusterResourceUsageExportConfigResult', ..., 'GetClusterSecretManagerConfigResult', 'GetClusterSecretManagerConfigRotationConfigResult', 'GetClusterSecretSyncConfigResult', 'GetClusterSecretSyncConfigRotationConfigResult', 'GetClusterSecurityPostureConfigResult', 'GetClusterServiceExternalIpsConfigResult', 'GetClusterTpuConfigResult', 'GetClusterUserManagedKeysConfigResult', 'GetClusterVerticalPodAutoscalingResult', 'GetClusterWorkloadAltsConfigResult', 'GetClusterWorkloadIdentityConfigResult']
@pulumi.output_type
class AttachedClusterAuthorization(dict):
    ...
    def __init__(__self__, *, admin_groups: Optional[Sequence[_builtins.str]] = ..., admin_users: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AttachedClusterLoggingConfig(dict):
    ...
    def __init__(__self__, *, component_config: Optional[outputs.AttachedClusterLoggingConfigComponentConfig] = ...) -> None:
...
class AttachedClusterLoggingConfigComponentConfig(dict):
    ...
    def __init__(__self__, *, enable_components: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AttachedClusterMonitoringConfig(dict):
    ...
    def __init__(__self__, *, managed_prometheus_config: Optional[outputs.AttachedClusterMonitoringConfigManagedPrometheusConfig] = ...) -> None:
...
class AttachedClusterOidcConfig(dict):
    ...
    def __init__(__self__, *, issuer_url: _builtins.str, jwks: Optional[_builtins.str] = ...) -> None:
...
class AttachedClusterProxyConfig(dict):
    ...
    def __init__(__self__, *, kubernetes_secret: Optional[outputs.AttachedClusterProxyConfigKubernetesSecret] = ...) -> None:
...
class AttachedClusterWorkloadIdentityConfig(dict):
    ...
    def __init__(__self__, *, identity_provider: Optional[_builtins.str] = ..., issuer_uri: Optional[_builtins.str] = ..., workload_pool: Optional[_builtins.str] = ...) -> None:
...
class AwsClusterAuthorization(dict):
    ...
    def __init__(__self__, *, admin_users: Sequence[outputs.AwsClusterAuthorizationAdminUser], admin_groups: Optional[Sequence[outputs.AwsClusterAuthorizationAdminGroup]] = ...) -> None:
...
class AwsClusterControlPlane(dict):
    ...
    def __init__(__self__, *, aws_services_authentication: outputs.AwsClusterControlPlaneAwsServicesAuthentication, config_encryption: outputs.AwsClusterControlPlaneConfigEncryption, database_encryption: outputs.AwsClusterControlPlaneDatabaseEncryption, iam_instance_profile: _builtins.str, subnet_ids: Sequence[_builtins.str], version: _builtins.str, instance_placement: Optional[outputs.AwsClusterControlPlaneInstancePlacement] = ..., instance_type: Optional[_builtins.str] = ..., main_volume: Optional[outputs.AwsClusterControlPlaneMainVolume] = ..., proxy_config: Optional[outputs.AwsClusterControlPlaneProxyConfig] = ..., root_volume: Optional[outputs.AwsClusterControlPlaneRootVolume] = ..., security_group_ids: Optional[Sequence[_builtins.str]] = ..., ssh_config: Optional[outputs.AwsClusterControlPlaneSshConfig] = ..., tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class AwsClusterControlPlaneAwsServicesAuthentication(dict):
    ...
    def __init__(__self__, *, role_arn: _builtins.str, role_session_name: Optional[_builtins.str] = ...) -> None:
...
class AwsClusterControlPlaneMainVolume(dict):
    ...
    def __init__(__self__, *, iops: Optional[_builtins.int] = ..., kms_key_arn: Optional[_builtins.str] = ..., size_gib: Optional[_builtins.int] = ..., throughput: Optional[_builtins.int] = ..., volume_type: Optional[_builtins.str] = ...) -> None:
...
class AwsClusterControlPlaneProxyConfig(dict):
    ...
    def __init__(__self__, *, secret_arn: _builtins.str, secret_version: _builtins.str) -> None:
...
class AwsClusterFleet(dict):
    def __init__(__self__, *, membership: Optional[_builtins.str] = ..., project: Optional[_builtins.str] = ...) -> None:
...
class AwsClusterLoggingConfig(dict):
    ...
    def __init__(__self__, *, component_config: Optional[outputs.AwsClusterLoggingConfigComponentConfig] = ...) -> None:
...
class AwsClusterNetworking(dict):
    ...
    def __init__(__self__, *, pod_address_cidr_blocks: Sequence[_builtins.str], service_address_cidr_blocks: Sequence[_builtins.str], vpc_id: _builtins.str, per_node_pool_sg_rules_disabled: Optional[_builtins.bool] = ...) -> None:
...
class AwsNodePoolAutoscaling(dict):
    ...
    def __init__(__self__, *, max_node_count: _builtins.int, min_node_count: _builtins.int) -> None:
...
class AwsNodePoolConfig(dict):
    ...
    def __init__(__self__, *, config_encryption: outputs.AwsNodePoolConfigConfigEncryption, iam_instance_profile: _builtins.str, autoscaling_metrics_collection: Optional[outputs.AwsNodePoolConfigAutoscalingMetricsCollection] = ..., image_type: Optional[_builtins.str] = ..., instance_placement: Optional[outputs.AwsNodePoolConfigInstancePlacement] = ..., instance_type: Optional[_builtins.str] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., proxy_config: Optional[outputs.AwsNodePoolConfigProxyConfig] = ..., root_volume: Optional[outputs.AwsNodePoolConfigRootVolume] = ..., security_group_ids: Optional[Sequence[_builtins.str]] = ..., spot_config: Optional[outputs.AwsNodePoolConfigSpotConfig] = ..., ssh_config: Optional[outputs.AwsNodePoolConfigSshConfig] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., taints: Optional[Sequence[outputs.AwsNodePoolConfigTaint]] = ...) -> None:
...
class AwsNodePoolConfigAutoscalingMetricsCollection(dict):
    def __init__(__self__, *, granularity: _builtins.str, metrics: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class AwsNodePoolKubeletConfig(dict):
    ...
    def __init__(__self__, *, cpu_cfs_quota: Optional[_builtins.bool] = ..., cpu_cfs_quota_period: Optional[_builtins.str] = ..., cpu_manager_policy: Optional[_builtins.str] = ..., pod_pids_limit: Optional[_builtins.int] = ...) -> None:
...
class AwsNodePoolUpdateSettings(dict):
    ...
    def __init__(__self__, *, surge_settings: Optional[outputs.AwsNodePoolUpdateSettingsSurgeSettings] = ...) -> None:
...
class AwsNodePoolUpdateSettingsSurgeSettings(dict):
    ...
    def __init__(__self__, *, max_surge: Optional[_builtins.int] = ..., max_unavailable: Optional[_builtins.int] = ...) -> None:
...
class AzureClusterAuthorization(dict):
    ...
    def __init__(__self__, *, admin_users: Sequence[outputs.AzureClusterAuthorizationAdminUser], admin_groups: Optional[Sequence[outputs.AzureClusterAuthorizationAdminGroup]] = ...) -> None:
...
class AzureClusterAzureServicesAuthentication(dict):
    ...
    def __init__(__self__, *, application_id: _builtins.str, tenant_id: _builtins.str) -> None:
...
class AzureClusterControlPlane(dict):
    ...
    def __init__(__self__, *, ssh_config: outputs.AzureClusterControlPlaneSshConfig, subnet_id: _builtins.str, version: _builtins.str, database_encryption: Optional[outputs.AzureClusterControlPlaneDatabaseEncryption] = ..., main_volume: Optional[outputs.AzureClusterControlPlaneMainVolume] = ..., proxy_config: Optional[outputs.AzureClusterControlPlaneProxyConfig] = ..., replica_placements: Optional[Sequence[outputs.AzureClusterControlPlaneReplicaPlacement]] = ..., root_volume: Optional[outputs.AzureClusterControlPlaneRootVolume] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., vm_size: Optional[_builtins.str] = ...) -> None:
...
class AzureClusterControlPlaneProxyConfig(dict):
    ...
    def __init__(__self__, *, resource_group_id: _builtins.str, secret_id: _builtins.str) -> None:
...
class AzureClusterControlPlaneReplicaPlacement(dict):
    ...
    def __init__(__self__, *, azure_availability_zone: _builtins.str, subnet_id: _builtins.str) -> None:
...
class AzureClusterLoggingConfig(dict):
    ...
    def __init__(__self__, *, component_config: Optional[outputs.AzureClusterLoggingConfigComponentConfig] = ...) -> None:
...
class AzureClusterNetworking(dict):
    ...
    def __init__(__self__, *, pod_address_cidr_blocks: Sequence[_builtins.str], service_address_cidr_blocks: Sequence[_builtins.str], virtual_network_id: _builtins.str) -> None:
...
class AzureNodePoolConfig(dict):
    ...
    def __init__(__self__, *, ssh_config: outputs.AzureNodePoolConfigSshConfig, image_type: Optional[_builtins.str] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., proxy_config: Optional[outputs.AzureNodePoolConfigProxyConfig] = ..., root_volume: Optional[outputs.AzureNodePoolConfigRootVolume] = ..., tags: Optional[Mapping[str, _builtins.str]] = ..., vm_size: Optional[_builtins.str] = ...) -> None:
...
class ClusterAddonsConfig(dict):
    ...
    def __init__(__self__, *, cloudrun_config: Optional[outputs.ClusterAddonsConfigCloudrunConfig] = ..., config_connector_config: Optional[outputs.ClusterAddonsConfigConfigConnectorConfig] = ..., dns_cache_config: Optional[outputs.ClusterAddonsConfigDnsCacheConfig] = ..., gce_persistent_disk_csi_driver_config: Optional[outputs.ClusterAddonsConfigGcePersistentDiskCsiDriverConfig] = ..., gcp_filestore_csi_driver_config: Optional[outputs.ClusterAddonsConfigGcpFilestoreCsiDriverConfig] = ..., gcs_fuse_csi_driver_config: Optional[outputs.ClusterAddonsConfigGcsFuseCsiDriverConfig] = ..., gke_backup_agent_config: Optional[outputs.ClusterAddonsConfigGkeBackupAgentConfig] = ..., horizontal_pod_autoscaling: Optional[outputs.ClusterAddonsConfigHorizontalPodAutoscaling] = ..., http_load_balancing: Optional[outputs.ClusterAddonsConfigHttpLoadBalancing] = ..., istio_config: Optional[outputs.ClusterAddonsConfigIstioConfig] = ..., kalm_config: Optional[outputs.ClusterAddonsConfigKalmConfig] = ..., lustre_csi_driver_config: Optional[outputs.ClusterAddonsConfigLustreCsiDriverConfig] = ..., network_policy_config: Optional[outputs.ClusterAddonsConfigNetworkPolicyConfig] = ..., parallelstore_csi_driver_config: Optional[outputs.ClusterAddonsConfigParallelstoreCsiDriverConfig] = ..., pod_snapshot_config: Optional[outputs.ClusterAddonsConfigPodSnapshotConfig] = ..., ray_operator_configs: Optional[Sequence[outputs.ClusterAddonsConfigRayOperatorConfig]] = ..., slice_controller_config: Optional[outputs.ClusterAddonsConfigSliceControllerConfig] = ..., stateful_ha_config: Optional[outputs.ClusterAddonsConfigStatefulHaConfig] = ...) -> None:
...
class ClusterAddonsConfigCloudrunConfig(dict):
    ...
    def __init__(__self__, *, disabled: _builtins.bool, load_balancer_type: Optional[_builtins.str] = ...) -> None:
...
class ClusterAddonsConfigIstioConfig(dict):
    def __init__(__self__, *, disabled: _builtins.bool, auth: Optional[_builtins.str] = ...) -> None:
...
class ClusterAddonsConfigLustreCsiDriverConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, enable_legacy_lustre_port: Optional[_builtins.bool] = ...) -> None:
...
class ClusterAddonsConfigRayOperatorConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, ray_cluster_logging_config: Optional[outputs.ClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfig] = ..., ray_cluster_monitoring_config: Optional[outputs.ClusterAddonsConfigRayOperatorConfigRayClusterMonitoringConfig] = ...) -> None:
...
class ClusterBinaryAuthorization(dict):
    ...
    def __init__(__self__, *, enabled: Optional[_builtins.bool] = ..., evaluation_mode: Optional[_builtins.str] = ...) -> None:
...
class ClusterClusterAutoscaling(dict):
    ...
    def __init__(__self__, *, auto_provisioning_defaults: Optional[outputs.ClusterClusterAutoscalingAutoProvisioningDefaults] = ..., auto_provisioning_locations: Optional[Sequence[_builtins.str]] = ..., autoscaling_profile: Optional[_builtins.str] = ..., default_compute_class_enabled: Optional[_builtins.bool] = ..., enabled: Optional[_builtins.bool] = ..., resource_limits: Optional[Sequence[outputs.ClusterClusterAutoscalingResourceLimit]] = ...) -> None:
...
class ClusterClusterAutoscalingAutoProvisioningDefaults(dict):
    ...
    def __init__(__self__, *, boot_disk_kms_key: Optional[_builtins.str] = ..., disk_size: Optional[_builtins.int] = ..., disk_type: Optional[_builtins.str] = ..., image_type: Optional[_builtins.str] = ..., management: Optional[outputs.ClusterClusterAutoscalingAutoProvisioningDefaultsManagement] = ..., min_cpu_platform: Optional[_builtins.str] = ..., oauth_scopes: Optional[Sequence[_builtins.str]] = ..., service_account: Optional[_builtins.str] = ..., shielded_instance_config: Optional[outputs.ClusterClusterAutoscalingAutoProvisioningDefaultsShieldedInstanceConfig] = ..., upgrade_settings: Optional[outputs.ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettings] = ...) -> None:
...
class ClusterClusterAutoscalingAutoProvisioningDefaultsManagement(dict):
    ...
    def __init__(__self__, *, auto_repair: Optional[_builtins.bool] = ..., auto_upgrade: Optional[_builtins.bool] = ..., upgrade_options: Optional[Sequence[outputs.ClusterClusterAutoscalingAutoProvisioningDefaultsManagementUpgradeOption]] = ...) -> None:
...
class ClusterClusterAutoscalingAutoProvisioningDefaultsManagementUpgradeOption(dict):
    ...
    def __init__(__self__, *, auto_upgrade_start_time: Optional[_builtins.str] = ..., description: Optional[_builtins.str] = ...) -> None:
...
class ClusterClusterAutoscalingAutoProvisioningDefaultsShieldedInstanceConfig(dict):
    ...
    def __init__(__self__, *, enable_integrity_monitoring: Optional[_builtins.bool] = ..., enable_secure_boot: Optional[_builtins.bool] = ...) -> None:
...
class ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettings(dict):
    ...
    def __init__(__self__, *, blue_green_settings: Optional[outputs.ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettingsBlueGreenSettings] = ..., max_surge: Optional[_builtins.int] = ..., max_unavailable: Optional[_builtins.int] = ..., strategy: Optional[_builtins.str] = ...) -> None:
...
class ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettingsBlueGreenSettings(dict):
    ...
    def __init__(__self__, *, node_pool_soak_duration: Optional[_builtins.str] = ..., standard_rollout_policy: Optional[outputs.ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettingsBlueGreenSettingsStandardRolloutPolicy] = ...) -> None:
...
class ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettingsBlueGreenSettingsStandardRolloutPolicy(dict):
    ...
    def __init__(__self__, *, batch_node_count: Optional[_builtins.int] = ..., batch_percentage: Optional[_builtins.float] = ..., batch_soak_duration: Optional[_builtins.str] = ...) -> None:
...
class ClusterClusterAutoscalingResourceLimit(dict):
    ...
    def __init__(__self__, *, maximum: _builtins.int, resource_type: _builtins.str, minimum: Optional[_builtins.int] = ...) -> None:
...
class ClusterConfidentialNodes(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, confidential_instance_type: Optional[_builtins.str] = ...) -> None:
...
class ClusterControlPlaneEndpointsConfig(dict):
    ...
    def __init__(__self__, *, dns_endpoint_config: Optional[outputs.ClusterControlPlaneEndpointsConfigDnsEndpointConfig] = ..., ip_endpoints_config: Optional[outputs.ClusterControlPlaneEndpointsConfigIpEndpointsConfig] = ...) -> None:
...
class ClusterControlPlaneEndpointsConfigDnsEndpointConfig(dict):
    ...
    def __init__(__self__, *, allow_external_traffic: Optional[_builtins.bool] = ..., enable_k8s_certs_via_dns: Optional[_builtins.bool] = ..., enable_k8s_tokens_via_dns: Optional[_builtins.bool] = ..., endpoint: Optional[_builtins.str] = ...) -> None:
...
class ClusterDatabaseEncryption(dict):
    ...
    def __init__(__self__, *, state: _builtins.str, key_name: Optional[_builtins.str] = ...) -> None:
...
class ClusterDnsConfig(dict):
    ...
    def __init__(__self__, *, additive_vpc_scope_dns_domain: Optional[_builtins.str] = ..., cluster_dns: Optional[_builtins.str] = ..., cluster_dns_domain: Optional[_builtins.str] = ..., cluster_dns_scope: Optional[_builtins.str] = ...) -> None:
...
class ClusterEnterpriseConfig(dict):
    ...
    def __init__(__self__, *, cluster_tier: Optional[_builtins.str] = ..., desired_tier: Optional[_builtins.str] = ...) -> None:
...
class ClusterFleet(dict):
    ...
    def __init__(__self__, *, membership: Optional[_builtins.str] = ..., membership_id: Optional[_builtins.str] = ..., membership_location: Optional[_builtins.str] = ..., membership_type: Optional[_builtins.str] = ..., pre_registered: Optional[_builtins.bool] = ..., project: Optional[_builtins.str] = ...) -> None:
...
class ClusterIpAllocationPolicy(dict):
    ...
    def __init__(__self__, *, additional_ip_ranges_configs: Optional[Sequence[outputs.ClusterIpAllocationPolicyAdditionalIpRangesConfig]] = ..., additional_pod_ranges_config: Optional[outputs.ClusterIpAllocationPolicyAdditionalPodRangesConfig] = ..., auto_ipam_config: Optional[outputs.ClusterIpAllocationPolicyAutoIpamConfig] = ..., cluster_ipv4_cidr_block: Optional[_builtins.str] = ..., cluster_secondary_range_name: Optional[_builtins.str] = ..., network_tier_config: Optional[outputs.ClusterIpAllocationPolicyNetworkTierConfig] = ..., pod_cidr_overprovision_config: Optional[outputs.ClusterIpAllocationPolicyPodCidrOverprovisionConfig] = ..., services_ipv4_cidr_block: Optional[_builtins.str] = ..., services_secondary_range_name: Optional[_builtins.str] = ..., stack_type: Optional[_builtins.str] = ...) -> None:
...
class ClusterIpAllocationPolicyAdditionalIpRangesConfig(dict):
    ...
    def __init__(__self__, *, subnetwork: _builtins.str, pod_ipv4_range_names: Optional[Sequence[_builtins.str]] = ..., status: Optional[_builtins.str] = ...) -> None:
...
class ClusterMaintenancePolicy(dict):
    ...
    def __init__(__self__, *, daily_maintenance_window: Optional[outputs.ClusterMaintenancePolicyDailyMaintenanceWindow] = ..., disruption_budget: Optional[outputs.ClusterMaintenancePolicyDisruptionBudget] = ..., maintenance_exclusions: Optional[Sequence[outputs.ClusterMaintenancePolicyMaintenanceExclusion]] = ..., recurring_window: Optional[outputs.ClusterMaintenancePolicyRecurringWindow] = ...) -> None:
...
class ClusterMaintenancePolicyDailyMaintenanceWindow(dict):
    ...
    def __init__(__self__, *, start_time: _builtins.str, duration: Optional[_builtins.str] = ...) -> None:
        ...
...
class ClusterMaintenancePolicyDisruptionBudget(dict):
    ...
    def __init__(__self__, *, last_disruption_time: Optional[_builtins.str] = ..., last_minor_version_disruption_time: Optional[_builtins.str] = ..., minor_version_disruption_interval: Optional[_builtins.str] = ..., patch_version_disruption_interval: Optional[_builtins.str] = ...) -> None:
...
class ClusterMaintenancePolicyMaintenanceExclusion(dict):
    ...
    def __init__(__self__, *, exclusion_name: _builtins.str, start_time: _builtins.str, end_time: Optional[_builtins.str] = ..., exclusion_options: Optional[outputs.ClusterMaintenancePolicyMaintenanceExclusionExclusionOptions] = ...) -> None:
...
class ClusterMaintenancePolicyMaintenanceExclusionExclusionOptions(dict):
    ...
    def __init__(__self__, *, scope: _builtins.str, end_time_behavior: Optional[_builtins.str] = ...) -> None:
...
class ClusterMasterAuth(dict):
    ...
    def __init__(__self__, *, client_certificate_config: outputs.ClusterMasterAuthClientCertificateConfig, client_certificate: Optional[_builtins.str] = ..., client_key: Optional[_builtins.str] = ..., cluster_ca_certificate: Optional[_builtins.str] = ...) -> None:
...
class ClusterMasterAuthorizedNetworksConfig(dict):
    ...
    def __init__(__self__, *, cidr_blocks: Optional[Sequence[outputs.ClusterMasterAuthorizedNetworksConfigCidrBlock]] = ..., gcp_public_cidrs_access_enabled: Optional[_builtins.bool] = ..., private_endpoint_enforcement_enabled: Optional[_builtins.bool] = ...) -> None:
...
class ClusterMonitoringConfig(dict):
    ...
    def __init__(__self__, *, advanced_datapath_observability_config: Optional[outputs.ClusterMonitoringConfigAdvancedDatapathObservabilityConfig] = ..., enable_components: Optional[Sequence[_builtins.str]] = ..., managed_prometheus: Optional[outputs.ClusterMonitoringConfigManagedPrometheus] = ...) -> None:
...
class ClusterMonitoringConfigAdvancedDatapathObservabilityConfig(dict):
    ...
    def __init__(__self__, *, enable_metrics: _builtins.bool, enable_relay: _builtins.bool) -> None:
...
class ClusterMonitoringConfigManagedPrometheus(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, auto_monitoring_config: Optional[outputs.ClusterMonitoringConfigManagedPrometheusAutoMonitoringConfig] = ...) -> None:
...
class ClusterNetworkPolicy(dict):
    def __init__(__self__, *, enabled: _builtins.bool, provider: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodeConfig(dict):
    ...
    def __init__(__self__, *, advanced_machine_features: Optional[outputs.ClusterNodeConfigAdvancedMachineFeatures] = ..., boot_disk: Optional[outputs.ClusterNodeConfigBootDisk] = ..., boot_disk_kms_key: Optional[_builtins.str] = ..., confidential_nodes: Optional[outputs.ClusterNodeConfigConfidentialNodes] = ..., containerd_config: Optional[outputs.ClusterNodeConfigContainerdConfig] = ..., disk_size_gb: Optional[_builtins.int] = ..., disk_type: Optional[_builtins.str] = ..., effective_taints: Optional[Sequence[outputs.ClusterNodeConfigEffectiveTaint]] = ..., enable_confidential_storage: Optional[_builtins.bool] = ..., ephemeral_storage_config: Optional[outputs.ClusterNodeConfigEphemeralStorageConfig] = ..., ephemeral_storage_local_ssd_config: Optional[outputs.ClusterNodeConfigEphemeralStorageLocalSsdConfig] = ..., fast_socket: Optional[outputs.ClusterNodeConfigFastSocket] = ..., flex_start: Optional[_builtins.bool] = ..., gcfs_config: Optional[outputs.ClusterNodeConfigGcfsConfig] = ..., guest_accelerators: Optional[Sequence[outputs.ClusterNodeConfigGuestAccelerator]] = ..., gvnic: Optional[outputs.ClusterNodeConfigGvnic] = ..., host_maintenance_policy: Optional[outputs.ClusterNodeConfigHostMaintenancePolicy] = ..., image_type: Optional[_builtins.str] = ..., kubelet_config: Optional[outputs.ClusterNodeConfigKubeletConfig] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., linux_node_config: Optional[outputs.ClusterNodeConfigLinuxNodeConfig] = ..., local_nvme_ssd_block_config: Optional[outputs.ClusterNodeConfigLocalNvmeSsdBlockConfig] = ..., local_ssd_count: Optional[_builtins.int] = ..., local_ssd_encryption_mode: Optional[_builtins.str] = ..., logging_variant: Optional[_builtins.str] = ..., machine_type: Optional[_builtins.str] = ..., max_run_duration: Optional[_builtins.str] = ..., metadata: Optional[Mapping[str, _builtins.str]] = ..., min_cpu_platform: Optional[_builtins.str] = ..., node_group: Optional[_builtins.str] = ..., oauth_scopes: Optional[Sequence[_builtins.str]] = ..., preemptible: Optional[_builtins.bool] = ..., reservation_affinity: Optional[outputs.ClusterNodeConfigReservationAffinity] = ..., resource_labels: Optional[Mapping[str, _builtins.str]] = ..., resource_manager_tags: Optional[Mapping[str, _builtins.str]] = ..., sandbox_config: Optional[outputs.ClusterNodeConfigSandboxConfig] = ..., secondary_boot_disks: Optional[Sequence[outputs.ClusterNodeConfigSecondaryBootDisk]] = ..., service_account: Optional[_builtins.str] = ..., shielded_instance_config: Optional[outputs.ClusterNodeConfigShieldedInstanceConfig] = ..., sole_tenant_config: Optional[outputs.ClusterNodeConfigSoleTenantConfig] = ..., spot: Optional[_builtins.bool] = ..., storage_pools: Optional[Sequence[_builtins.str]] = ..., tags: Optional[Sequence[_builtins.str]] = ..., taints: Optional[Sequence[outputs.ClusterNodeConfigTaint]] = ..., windows_node_config: Optional[outputs.ClusterNodeConfigWindowsNodeConfig] = ..., workload_metadata_config: Optional[outputs.ClusterNodeConfigWorkloadMetadataConfig] = ...) -> None:
...
class ClusterNodeConfigAdvancedMachineFeatures(dict):
    ...
    def __init__(__self__, *, threads_per_core: _builtins.int, enable_nested_virtualization: Optional[_builtins.bool] = ..., performance_monitoring_unit: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodeConfigBootDisk(dict):
    ...
    def __init__(__self__, *, disk_type: Optional[_builtins.str] = ..., provisioned_iops: Optional[_builtins.int] = ..., provisioned_throughput: Optional[_builtins.int] = ..., size_gb: Optional[_builtins.int] = ...) -> None:
...
class ClusterNodeConfigContainerdConfig(dict):
    ...
    def __init__(__self__, *, private_registry_access_config: Optional[outputs.ClusterNodeConfigContainerdConfigPrivateRegistryAccessConfig] = ..., registry_hosts: Optional[Sequence[outputs.ClusterNodeConfigContainerdConfigRegistryHost]] = ..., writable_cgroups: Optional[outputs.ClusterNodeConfigContainerdConfigWritableCgroups] = ...) -> None:
...
class ClusterNodeConfigContainerdConfigPrivateRegistryAccessConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, certificate_authority_domain_configs: Optional[Sequence[outputs.ClusterNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig]] = ...) -> None:
...
class ClusterNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig(dict):
    ...
    def __init__(__self__, *, fqdns: Sequence[_builtins.str], gcp_secret_manager_certificate_config: outputs.ClusterNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigGcpSecretManagerCertificateConfig) -> None:
...
class ClusterNodeConfigContainerdConfigRegistryHost(dict):
    def __init__(__self__, *, server: _builtins.str, hosts: Optional[Sequence[outputs.ClusterNodeConfigContainerdConfigRegistryHostHost]] = ...) -> None:
...
class ClusterNodeConfigContainerdConfigRegistryHostHost(dict):
    ...
    def __init__(__self__, *, host: _builtins.str, capabilities: Optional[Sequence[_builtins.str]] = ..., cas: Optional[Sequence[outputs.ClusterNodeConfigContainerdConfigRegistryHostHostCa]] = ..., clients: Optional[Sequence[outputs.ClusterNodeConfigContainerdConfigRegistryHostHostClient]] = ..., dial_timeout: Optional[_builtins.str] = ..., headers: Optional[Sequence[outputs.ClusterNodeConfigContainerdConfigRegistryHostHostHeader]] = ..., override_path: Optional[_builtins.bool] = ...) -> None:
...
class ClusterNodeConfigContainerdConfigRegistryHostHostCa(dict):
    ...
    def __init__(__self__, *, gcp_secret_manager_secret_uri: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodeConfigContainerdConfigRegistryHostHostClient(dict):
    def __init__(__self__, *, cert: outputs.ClusterNodeConfigContainerdConfigRegistryHostHostClientCert, key: Optional[outputs.ClusterNodeConfigContainerdConfigRegistryHostHostClientKey] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def cert(self) -> outputs.ClusterNodeConfigContainerdConfigRegistryHostHostClientCert:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def key(self) -> Optional[outputs.ClusterNodeConfigContainerdConfigRegistryHostHostClientKey]:
...
class ClusterNodeConfigEphemeralStorageLocalSsdConfig(dict):
    ...
    def __init__(__self__, *, local_ssd_count: _builtins.int, data_cache_count: Optional[_builtins.int] = ...) -> None:
...
class ClusterNodeConfigGuestAccelerator(dict):
    ...
    def __init__(__self__, *, count: _builtins.int, type: _builtins.str, gpu_driver_installation_config: Optional[outputs.ClusterNodeConfigGuestAcceleratorGpuDriverInstallationConfig] = ..., gpu_partition_size: Optional[_builtins.str] = ..., gpu_sharing_config: Optional[outputs.ClusterNodeConfigGuestAcceleratorGpuSharingConfig] = ...) -> None:
...
class ClusterNodeConfigGuestAcceleratorGpuSharingConfig(dict):
    ...
    def __init__(__self__, *, gpu_sharing_strategy: _builtins.str, max_shared_clients_per_gpu: _builtins.int) -> None:
...
class ClusterNodeConfigKubeletConfig(dict):
    ...
    def __init__(__self__, *, allowed_unsafe_sysctls: Optional[Sequence[_builtins.str]] = ..., container_log_max_files: Optional[_builtins.int] = ..., container_log_max_size: Optional[_builtins.str] = ..., cpu_cfs_quota: Optional[_builtins.bool] = ..., cpu_cfs_quota_period: Optional[_builtins.str] = ..., cpu_manager_policy: Optional[_builtins.str] = ..., eviction_max_pod_grace_period_seconds: Optional[_builtins.int] = ..., eviction_minimum_reclaim: Optional[outputs.ClusterNodeConfigKubeletConfigEvictionMinimumReclaim] = ..., eviction_soft: Optional[outputs.ClusterNodeConfigKubeletConfigEvictionSoft] = ..., eviction_soft_grace_period: Optional[outputs.ClusterNodeConfigKubeletConfigEvictionSoftGracePeriod] = ..., image_gc_high_threshold_percent: Optional[_builtins.int] = ..., image_gc_low_threshold_percent: Optional[_builtins.int] = ..., image_maximum_gc_age: Optional[_builtins.str] = ..., image_minimum_gc_age: Optional[_builtins.str] = ..., insecure_kubelet_readonly_port_enabled: Optional[_builtins.str] = ..., max_parallel_image_pulls: Optional[_builtins.int] = ..., memory_manager: Optional[outputs.ClusterNodeConfigKubeletConfigMemoryManager] = ..., pod_pids_limit: Optional[_builtins.int] = ..., single_process_oom_kill: Optional[_builtins.bool] = ..., topology_manager: Optional[outputs.ClusterNodeConfigKubeletConfigTopologyManager] = ...) -> None:
...
class ClusterNodeConfigKubeletConfigEvictionMinimumReclaim(dict):
    ...
    def __init__(__self__, *, imagefs_available: Optional[_builtins.str] = ..., imagefs_inodes_free: Optional[_builtins.str] = ..., memory_available: Optional[_builtins.str] = ..., nodefs_available: Optional[_builtins.str] = ..., nodefs_inodes_free: Optional[_builtins.str] = ..., pid_available: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodeConfigKubeletConfigTopologyManager(dict):
    def __init__(__self__, *, policy: Optional[_builtins.str] = ..., scope: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodeConfigLinuxNodeConfig(dict):
    ...
    def __init__(__self__, *, cgroup_mode: Optional[_builtins.str] = ..., hugepages_config: Optional[outputs.ClusterNodeConfigLinuxNodeConfigHugepagesConfig] = ..., node_kernel_module_loading: Optional[outputs.ClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading] = ..., sysctls: Optional[Mapping[str, _builtins.str]] = ..., transparent_hugepage_defrag: Optional[_builtins.str] = ..., transparent_hugepage_enabled: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodeConfigLinuxNodeConfigHugepagesConfig(dict):
    ...
    def __init__(__self__, *, hugepage_size1g: Optional[_builtins.int] = ..., hugepage_size2m: Optional[_builtins.int] = ...) -> None:
...
class ClusterNodeConfigSandboxConfig(dict):
    ...
    def __init__(__self__, *, sandbox_type: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodeConfigSecondaryBootDisk(dict):
    ...
    def __init__(__self__, *, disk_image: _builtins.str, mode: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodeConfigSoleTenantConfig(dict):
    ...
    def __init__(__self__, *, node_affinities: Sequence[outputs.ClusterNodeConfigSoleTenantConfigNodeAffinity], min_node_cpus: Optional[_builtins.int] = ...) -> None:
...
class ClusterNodeConfigSoleTenantConfigNodeAffinity(dict):
    def __init__(__self__, *, key: _builtins.str, operator: _builtins.str, values: Sequence[_builtins.str]) -> None:
...
class ClusterNodePool(dict):
    ...
    def __init__(__self__, *, autoscaling: Optional[outputs.ClusterNodePoolAutoscaling] = ..., initial_node_count: Optional[_builtins.int] = ..., instance_group_urls: Optional[Sequence[_builtins.str]] = ..., managed_instance_group_urls: Optional[Sequence[_builtins.str]] = ..., management: Optional[outputs.ClusterNodePoolManagement] = ..., max_pods_per_node: Optional[_builtins.int] = ..., name: Optional[_builtins.str] = ..., name_prefix: Optional[_builtins.str] = ..., network_config: Optional[outputs.ClusterNodePoolNetworkConfig] = ..., node_config: Optional[outputs.ClusterNodePoolNodeConfig] = ..., node_count: Optional[_builtins.int] = ..., node_drain_configs: Optional[Sequence[outputs.ClusterNodePoolNodeDrainConfig]] = ..., node_locations: Optional[Sequence[_builtins.str]] = ..., placement_policy: Optional[outputs.ClusterNodePoolPlacementPolicy] = ..., queued_provisioning: Optional[outputs.ClusterNodePoolQueuedProvisioning] = ..., upgrade_settings: Optional[outputs.ClusterNodePoolUpgradeSettings] = ..., version: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodePoolAutoConfig(dict):
    ...
    def __init__(__self__, *, linux_node_config: Optional[outputs.ClusterNodePoolAutoConfigLinuxNodeConfig] = ..., network_tags: Optional[outputs.ClusterNodePoolAutoConfigNetworkTags] = ..., node_kubelet_config: Optional[outputs.ClusterNodePoolAutoConfigNodeKubeletConfig] = ..., resource_manager_tags: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ClusterNodePoolAutoConfigLinuxNodeConfig(dict):
    ...
    def __init__(__self__, *, cgroup_mode: Optional[_builtins.str] = ..., node_kernel_module_loading: Optional[outputs.ClusterNodePoolAutoConfigLinuxNodeConfigNodeKernelModuleLoading] = ...) -> None:
...
class ClusterNodePoolAutoConfigNetworkTags(dict):
    def __init__(__self__, *, tags: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class ClusterNodePoolAutoConfigNodeKubeletConfig(dict):
    ...
    def __init__(__self__, *, insecure_kubelet_readonly_port_enabled: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodePoolAutoscaling(dict):
    ...
    def __init__(__self__, *, location_policy: Optional[_builtins.str] = ..., max_node_count: Optional[_builtins.int] = ..., min_node_count: Optional[_builtins.int] = ..., total_max_node_count: Optional[_builtins.int] = ..., total_min_node_count: Optional[_builtins.int] = ...) -> None:
...
class ClusterNodePoolDefaults(dict):
    ...
    def __init__(__self__, *, node_config_defaults: Optional[outputs.ClusterNodePoolDefaultsNodeConfigDefaults] = ...) -> None:
...
class ClusterNodePoolDefaultsNodeConfigDefaults(dict):
    ...
    def __init__(__self__, *, containerd_config: Optional[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfig] = ..., gcfs_config: Optional[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsGcfsConfig] = ..., insecure_kubelet_readonly_port_enabled: Optional[_builtins.str] = ..., logging_variant: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfig(dict):
    ...
    def __init__(__self__, *, private_registry_access_config: Optional[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigPrivateRegistryAccessConfig] = ..., registry_hosts: Optional[Sequence[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHost]] = ..., writable_cgroups: Optional[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigWritableCgroups] = ...) -> None:
...
class ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigPrivateRegistryAccessConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, certificate_authority_domain_configs: Optional[Sequence[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig]] = ...) -> None:
...
class ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig(dict):
    ...
    def __init__(__self__, *, fqdns: Sequence[_builtins.str], gcp_secret_manager_certificate_config: outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigGcpSecretManagerCertificateConfig) -> None:
...
class ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHost(dict):
    def __init__(__self__, *, server: _builtins.str, hosts: Optional[Sequence[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHost]] = ...) -> None:
...
class ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHost(dict):
    ...
    def __init__(__self__, *, host: _builtins.str, capabilities: Optional[Sequence[_builtins.str]] = ..., cas: Optional[Sequence[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostCa]] = ..., clients: Optional[Sequence[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostClient]] = ..., dial_timeout: Optional[_builtins.str] = ..., headers: Optional[Sequence[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostHeader]] = ..., override_path: Optional[_builtins.bool] = ...) -> None:
...
@pulumi.output_type
class ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostClient(dict):
    def __init__(__self__, *, cert: outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostClientCert, key: Optional[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostClientKey] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def cert(self) -> outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostClientCert:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def key(self) -> Optional[outputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostClientKey]:
...
@pulumi.output_type
class ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostClientCert(dict):
    def __getitem__(self, key: str) -> Any:
        ...
...
@pulumi.output_type
class ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostClientKey(dict):
    def __getitem__(self, key: str) -> Any:
        ...
...
@pulumi.output_type
class ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostHeader(dict):
    def __init__(__self__, *, key: _builtins.str, values: Sequence[_builtins.str]) -> None:
...
class ClusterNodePoolManagement(dict):
    ...
    def __init__(__self__, *, auto_repair: Optional[_builtins.bool] = ..., auto_upgrade: Optional[_builtins.bool] = ...) -> None:
...
class ClusterNodePoolNetworkConfig(dict):
    ...
    def __init__(__self__, *, accelerator_network_profile: Optional[_builtins.str] = ..., additional_node_network_configs: Optional[Sequence[outputs.ClusterNodePoolNetworkConfigAdditionalNodeNetworkConfig]] = ..., additional_pod_network_configs: Optional[Sequence[outputs.ClusterNodePoolNetworkConfigAdditionalPodNetworkConfig]] = ..., create_pod_range: Optional[_builtins.bool] = ..., enable_private_nodes: Optional[_builtins.bool] = ..., network_performance_config: Optional[outputs.ClusterNodePoolNetworkConfigNetworkPerformanceConfig] = ..., pod_cidr_overprovision_config: Optional[outputs.ClusterNodePoolNetworkConfigPodCidrOverprovisionConfig] = ..., pod_ipv4_cidr_block: Optional[_builtins.str] = ..., pod_range: Optional[_builtins.str] = ..., subnetwork: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodePoolNetworkConfigAdditionalNodeNetworkConfig(dict):
    def __init__(__self__, *, network: Optional[_builtins.str] = ..., subnetwork: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodePoolNetworkConfigAdditionalPodNetworkConfig(dict):
    ...
    def __init__(__self__, *, max_pods_per_node: Optional[_builtins.int] = ..., secondary_pod_range: Optional[_builtins.str] = ..., subnetwork: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodePoolNodeConfig(dict):
    ...
    def __init__(__self__, *, advanced_machine_features: Optional[outputs.ClusterNodePoolNodeConfigAdvancedMachineFeatures] = ..., boot_disk: Optional[outputs.ClusterNodePoolNodeConfigBootDisk] = ..., boot_disk_kms_key: Optional[_builtins.str] = ..., confidential_nodes: Optional[outputs.ClusterNodePoolNodeConfigConfidentialNodes] = ..., containerd_config: Optional[outputs.ClusterNodePoolNodeConfigContainerdConfig] = ..., disk_size_gb: Optional[_builtins.int] = ..., disk_type: Optional[_builtins.str] = ..., effective_taints: Optional[Sequence[outputs.ClusterNodePoolNodeConfigEffectiveTaint]] = ..., enable_confidential_storage: Optional[_builtins.bool] = ..., ephemeral_storage_config: Optional[outputs.ClusterNodePoolNodeConfigEphemeralStorageConfig] = ..., ephemeral_storage_local_ssd_config: Optional[outputs.ClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfig] = ..., fast_socket: Optional[outputs.ClusterNodePoolNodeConfigFastSocket] = ..., flex_start: Optional[_builtins.bool] = ..., gcfs_config: Optional[outputs.ClusterNodePoolNodeConfigGcfsConfig] = ..., guest_accelerators: Optional[Sequence[outputs.ClusterNodePoolNodeConfigGuestAccelerator]] = ..., gvnic: Optional[outputs.ClusterNodePoolNodeConfigGvnic] = ..., host_maintenance_policy: Optional[outputs.ClusterNodePoolNodeConfigHostMaintenancePolicy] = ..., image_type: Optional[_builtins.str] = ..., kubelet_config: Optional[outputs.ClusterNodePoolNodeConfigKubeletConfig] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., linux_node_config: Optional[outputs.ClusterNodePoolNodeConfigLinuxNodeConfig] = ..., local_nvme_ssd_block_config: Optional[outputs.ClusterNodePoolNodeConfigLocalNvmeSsdBlockConfig] = ..., local_ssd_count: Optional[_builtins.int] = ..., local_ssd_encryption_mode: Optional[_builtins.str] = ..., logging_variant: Optional[_builtins.str] = ..., machine_type: Optional[_builtins.str] = ..., max_run_duration: Optional[_builtins.str] = ..., metadata: Optional[Mapping[str, _builtins.str]] = ..., min_cpu_platform: Optional[_builtins.str] = ..., node_group: Optional[_builtins.str] = ..., oauth_scopes: Optional[Sequence[_builtins.str]] = ..., preemptible: Optional[_builtins.bool] = ..., reservation_affinity: Optional[outputs.ClusterNodePoolNodeConfigReservationAffinity] = ..., resource_labels: Optional[Mapping[str, _builtins.str]] = ..., resource_manager_tags: Optional[Mapping[str, _builtins.str]] = ..., sandbox_config: Optional[outputs.ClusterNodePoolNodeConfigSandboxConfig] = ..., secondary_boot_disks: Optional[Sequence[outputs.ClusterNodePoolNodeConfigSecondaryBootDisk]] = ..., service_account: Optional[_builtins.str] = ..., shielded_instance_config: Optional[outputs.ClusterNodePoolNodeConfigShieldedInstanceConfig] = ..., sole_tenant_config: Optional[outputs.ClusterNodePoolNodeConfigSoleTenantConfig] = ..., spot: Optional[_builtins.bool] = ..., storage_pools: Optional[Sequence[_builtins.str]] = ..., tags: Optional[Sequence[_builtins.str]] = ..., taints: Optional[Sequence[outputs.ClusterNodePoolNodeConfigTaint]] = ..., windows_node_config: Optional[outputs.ClusterNodePoolNodeConfigWindowsNodeConfig] = ..., workload_metadata_config: Optional[outputs.ClusterNodePoolNodeConfigWorkloadMetadataConfig] = ...) -> None:
...
class ClusterNodePoolNodeConfigContainerdConfig(dict):
    ...
    def __init__(__self__, *, private_registry_access_config: Optional[outputs.ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig] = ..., registry_hosts: Optional[Sequence[outputs.ClusterNodePoolNodeConfigContainerdConfigRegistryHost]] = ..., writable_cgroups: Optional[outputs.ClusterNodePoolNodeConfigContainerdConfigWritableCgroups] = ...) -> None:
...
class ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, certificate_authority_domain_configs: Optional[Sequence[outputs.ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig]] = ...) -> None:
...
class ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig(dict):
    ...
    def __init__(__self__, *, fqdns: Sequence[_builtins.str], gcp_secret_manager_certificate_config: outputs.ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigGcpSecretManagerCertificateConfig) -> None:
...
class ClusterNodePoolNodeConfigContainerdConfigRegistryHost(dict):
    def __init__(__self__, *, server: _builtins.str, hosts: Optional[Sequence[outputs.ClusterNodePoolNodeConfigContainerdConfigRegistryHostHost]] = ...) -> None:
...
class ClusterNodePoolNodeConfigContainerdConfigRegistryHostHost(dict):
    ...
    def __init__(__self__, *, host: _builtins.str, capabilities: Optional[Sequence[_builtins.str]] = ..., cas: Optional[Sequence[outputs.ClusterNodePoolNodeConfigContainerdConfigRegistryHostHostCa]] = ..., clients: Optional[Sequence[outputs.ClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClient]] = ..., dial_timeout: Optional[_builtins.str] = ..., headers: Optional[Sequence[outputs.ClusterNodePoolNodeConfigContainerdConfigRegistryHostHostHeader]] = ..., override_path: Optional[_builtins.bool] = ...) -> None:
...
class ClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClient(dict):
    def __init__(__self__, *, cert: outputs.ClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientCert, key: Optional[outputs.ClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientKey] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def cert(self) -> outputs.ClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientCert:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def key(self) -> Optional[outputs.ClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientKey]:
...
class ClusterNodePoolNodeConfigGuestAccelerator(dict):
    ...
    def __init__(__self__, *, count: _builtins.int, type: _builtins.str, gpu_driver_installation_config: Optional[outputs.ClusterNodePoolNodeConfigGuestAcceleratorGpuDriverInstallationConfig] = ..., gpu_partition_size: Optional[_builtins.str] = ..., gpu_sharing_config: Optional[outputs.ClusterNodePoolNodeConfigGuestAcceleratorGpuSharingConfig] = ...) -> None:
...
class ClusterNodePoolNodeConfigKubeletConfig(dict):
    ...
    def __init__(__self__, *, allowed_unsafe_sysctls: Optional[Sequence[_builtins.str]] = ..., container_log_max_files: Optional[_builtins.int] = ..., container_log_max_size: Optional[_builtins.str] = ..., cpu_cfs_quota: Optional[_builtins.bool] = ..., cpu_cfs_quota_period: Optional[_builtins.str] = ..., cpu_manager_policy: Optional[_builtins.str] = ..., eviction_max_pod_grace_period_seconds: Optional[_builtins.int] = ..., eviction_minimum_reclaim: Optional[outputs.ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim] = ..., eviction_soft: Optional[outputs.ClusterNodePoolNodeConfigKubeletConfigEvictionSoft] = ..., eviction_soft_grace_period: Optional[outputs.ClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod] = ..., image_gc_high_threshold_percent: Optional[_builtins.int] = ..., image_gc_low_threshold_percent: Optional[_builtins.int] = ..., image_maximum_gc_age: Optional[_builtins.str] = ..., image_minimum_gc_age: Optional[_builtins.str] = ..., insecure_kubelet_readonly_port_enabled: Optional[_builtins.str] = ..., max_parallel_image_pulls: Optional[_builtins.int] = ..., memory_manager: Optional[outputs.ClusterNodePoolNodeConfigKubeletConfigMemoryManager] = ..., pod_pids_limit: Optional[_builtins.int] = ..., single_process_oom_kill: Optional[_builtins.bool] = ..., topology_manager: Optional[outputs.ClusterNodePoolNodeConfigKubeletConfigTopologyManager] = ...) -> None:
...
class ClusterNodePoolNodeConfigLinuxNodeConfig(dict):
    ...
    def __init__(__self__, *, cgroup_mode: Optional[_builtins.str] = ..., hugepages_config: Optional[outputs.ClusterNodePoolNodeConfigLinuxNodeConfigHugepagesConfig] = ..., node_kernel_module_loading: Optional[outputs.ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading] = ..., sysctls: Optional[Mapping[str, _builtins.str]] = ..., transparent_hugepage_defrag: Optional[_builtins.str] = ..., transparent_hugepage_enabled: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodePoolNodeConfigSoleTenantConfig(dict):
    ...
    def __init__(__self__, *, node_affinities: Sequence[outputs.ClusterNodePoolNodeConfigSoleTenantConfigNodeAffinity], min_node_cpus: Optional[_builtins.int] = ...) -> None:
...
class ClusterNodePoolNodeDrainConfig(dict):
    ...
    def __init__(__self__, *, respect_pdb_during_node_pool_deletion: Optional[_builtins.bool] = ...) -> None:
...
class ClusterNodePoolPlacementPolicy(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, policy_name: Optional[_builtins.str] = ..., tpu_topology: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodePoolUpgradeSettings(dict):
    ...
    def __init__(__self__, *, blue_green_settings: Optional[outputs.ClusterNodePoolUpgradeSettingsBlueGreenSettings] = ..., max_surge: Optional[_builtins.int] = ..., max_unavailable: Optional[_builtins.int] = ..., strategy: Optional[_builtins.str] = ...) -> None:
...
class ClusterNodePoolUpgradeSettingsBlueGreenSettings(dict):
    ...
    def __init__(__self__, *, autoscaled_rollout_policy: Optional[outputs.ClusterNodePoolUpgradeSettingsBlueGreenSettingsAutoscaledRolloutPolicy] = ..., node_pool_soak_duration: Optional[_builtins.str] = ..., standard_rollout_policy: Optional[outputs.ClusterNodePoolUpgradeSettingsBlueGreenSettingsStandardRolloutPolicy] = ...) -> None:
...
class ClusterNodePoolUpgradeSettingsBlueGreenSettingsAutoscaledRolloutPolicy(dict):
    ...
    def __init__(__self__, *, wait_for_drain_duration: Optional[_builtins.str] = ...) -> None:
...
class ClusterNotificationConfig(dict):
    def __init__(__self__, *, pubsub: outputs.ClusterNotificationConfigPubsub) -> None:
...
class ClusterNotificationConfigPubsub(dict):
    def __init__(__self__, *, enabled: _builtins.bool, filter: Optional[outputs.ClusterNotificationConfigPubsubFilter] = ..., topic: Optional[_builtins.str] = ...) -> None:
...
class ClusterPrivateClusterConfig(dict):
    ...
    def __init__(__self__, *, enable_private_endpoint: Optional[_builtins.bool] = ..., enable_private_nodes: Optional[_builtins.bool] = ..., master_global_access_config: Optional[outputs.ClusterPrivateClusterConfigMasterGlobalAccessConfig] = ..., master_ipv4_cidr_block: Optional[_builtins.str] = ..., peering_name: Optional[_builtins.str] = ..., private_endpoint: Optional[_builtins.str] = ..., private_endpoint_subnetwork: Optional[_builtins.str] = ..., public_endpoint: Optional[_builtins.str] = ...) -> None:
...
class ClusterProtectConfig(dict):
    ...
    def __init__(__self__, *, workload_config: Optional[outputs.ClusterProtectConfigWorkloadConfig] = ..., workload_vulnerability_mode: Optional[_builtins.str] = ...) -> None:
...
class ClusterRbacBindingConfig(dict):
    ...
    def __init__(__self__, *, enable_insecure_binding_system_authenticated: Optional[_builtins.bool] = ..., enable_insecure_binding_system_unauthenticated: Optional[_builtins.bool] = ...) -> None:
...
class ClusterResourceUsageExportConfig(dict):
    ...
    def __init__(__self__, *, bigquery_destination: outputs.ClusterResourceUsageExportConfigBigqueryDestination, enable_network_egress_metering: Optional[_builtins.bool] = ..., enable_resource_consumption_metering: Optional[_builtins.bool] = ...) -> None:
...
class ClusterSecretManagerConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, rotation_config: Optional[outputs.ClusterSecretManagerConfigRotationConfig] = ...) -> None:
...
class ClusterSecretManagerConfigRotationConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, rotation_interval: Optional[_builtins.str] = ...) -> None:
...
class ClusterSecretSyncConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, rotation_config: Optional[outputs.ClusterSecretSyncConfigRotationConfig] = ...) -> None:
...
class ClusterSecurityPostureConfig(dict):
    ...
    def __init__(__self__, *, mode: Optional[_builtins.str] = ..., vulnerability_mode: Optional[_builtins.str] = ...) -> None:
...
class ClusterTpuConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, ipv4_cidr_block: Optional[_builtins.str] = ..., use_service_networking: Optional[_builtins.bool] = ...) -> None:
...
class ClusterUserManagedKeysConfig(dict):
    ...
    def __init__(__self__, *, aggregation_ca: Optional[_builtins.str] = ..., cluster_ca: Optional[_builtins.str] = ..., control_plane_disk_encryption_key: Optional[_builtins.str] = ..., control_plane_disk_encryption_key_versions: Optional[Sequence[_builtins.str]] = ..., etcd_api_ca: Optional[_builtins.str] = ..., etcd_peer_ca: Optional[_builtins.str] = ..., gkeops_etcd_backup_encryption_key: Optional[_builtins.str] = ..., service_account_signing_keys: Optional[Sequence[_builtins.str]] = ..., service_account_verification_keys: Optional[Sequence[_builtins.str]] = ...) -> None:
    ...
    def control_plane_disk_encryption_key_versions(self) -> Optional[Sequence[_builtins.str]]:
...
class NodePoolNetworkConfig(dict):
    ...
    def __init__(__self__, *, accelerator_network_profile: Optional[_builtins.str] = ..., additional_node_network_configs: Optional[Sequence[outputs.NodePoolNetworkConfigAdditionalNodeNetworkConfig]] = ..., additional_pod_network_configs: Optional[Sequence[outputs.NodePoolNetworkConfigAdditionalPodNetworkConfig]] = ..., create_pod_range: Optional[_builtins.bool] = ..., enable_private_nodes: Optional[_builtins.bool] = ..., network_performance_config: Optional[outputs.NodePoolNetworkConfigNetworkPerformanceConfig] = ..., pod_cidr_overprovision_config: Optional[outputs.NodePoolNetworkConfigPodCidrOverprovisionConfig] = ..., pod_ipv4_cidr_block: Optional[_builtins.str] = ..., pod_range: Optional[_builtins.str] = ..., subnetwork: Optional[_builtins.str] = ...) -> None:
...
class NodePoolNodeConfig(dict):
    ...
    def __init__(__self__, *, advanced_machine_features: Optional[outputs.NodePoolNodeConfigAdvancedMachineFeatures] = ..., boot_disk: Optional[outputs.NodePoolNodeConfigBootDisk] = ..., boot_disk_kms_key: Optional[_builtins.str] = ..., confidential_nodes: Optional[outputs.NodePoolNodeConfigConfidentialNodes] = ..., containerd_config: Optional[outputs.NodePoolNodeConfigContainerdConfig] = ..., disk_size_gb: Optional[_builtins.int] = ..., disk_type: Optional[_builtins.str] = ..., effective_taints: Optional[Sequence[outputs.NodePoolNodeConfigEffectiveTaint]] = ..., enable_confidential_storage: Optional[_builtins.bool] = ..., ephemeral_storage_config: Optional[outputs.NodePoolNodeConfigEphemeralStorageConfig] = ..., ephemeral_storage_local_ssd_config: Optional[outputs.NodePoolNodeConfigEphemeralStorageLocalSsdConfig] = ..., fast_socket: Optional[outputs.NodePoolNodeConfigFastSocket] = ..., flex_start: Optional[_builtins.bool] = ..., gcfs_config: Optional[outputs.NodePoolNodeConfigGcfsConfig] = ..., guest_accelerators: Optional[Sequence[outputs.NodePoolNodeConfigGuestAccelerator]] = ..., gvnic: Optional[outputs.NodePoolNodeConfigGvnic] = ..., host_maintenance_policy: Optional[outputs.NodePoolNodeConfigHostMaintenancePolicy] = ..., image_type: Optional[_builtins.str] = ..., kubelet_config: Optional[outputs.NodePoolNodeConfigKubeletConfig] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., linux_node_config: Optional[outputs.NodePoolNodeConfigLinuxNodeConfig] = ..., local_nvme_ssd_block_config: Optional[outputs.NodePoolNodeConfigLocalNvmeSsdBlockConfig] = ..., local_ssd_count: Optional[_builtins.int] = ..., local_ssd_encryption_mode: Optional[_builtins.str] = ..., logging_variant: Optional[_builtins.str] = ..., machine_type: Optional[_builtins.str] = ..., max_run_duration: Optional[_builtins.str] = ..., metadata: Optional[Mapping[str, _builtins.str]] = ..., min_cpu_platform: Optional[_builtins.str] = ..., node_group: Optional[_builtins.str] = ..., oauth_scopes: Optional[Sequence[_builtins.str]] = ..., preemptible: Optional[_builtins.bool] = ..., reservation_affinity: Optional[outputs.NodePoolNodeConfigReservationAffinity] = ..., resource_labels: Optional[Mapping[str, _builtins.str]] = ..., resource_manager_tags: Optional[Mapping[str, _builtins.str]] = ..., sandbox_config: Optional[outputs.NodePoolNodeConfigSandboxConfig] = ..., secondary_boot_disks: Optional[Sequence[outputs.NodePoolNodeConfigSecondaryBootDisk]] = ..., service_account: Optional[_builtins.str] = ..., shielded_instance_config: Optional[outputs.NodePoolNodeConfigShieldedInstanceConfig] = ..., sole_tenant_config: Optional[outputs.NodePoolNodeConfigSoleTenantConfig] = ..., spot: Optional[_builtins.bool] = ..., storage_pools: Optional[Sequence[_builtins.str]] = ..., tags: Optional[Sequence[_builtins.str]] = ..., taints: Optional[Sequence[outputs.NodePoolNodeConfigTaint]] = ..., windows_node_config: Optional[outputs.NodePoolNodeConfigWindowsNodeConfig] = ..., workload_metadata_config: Optional[outputs.NodePoolNodeConfigWorkloadMetadataConfig] = ...) -> None:
...
class NodePoolNodeConfigContainerdConfig(dict):
    ...
    def __init__(__self__, *, private_registry_access_config: Optional[outputs.NodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig] = ..., registry_hosts: Optional[Sequence[outputs.NodePoolNodeConfigContainerdConfigRegistryHost]] = ..., writable_cgroups: Optional[outputs.NodePoolNodeConfigContainerdConfigWritableCgroups] = ...) -> None:
    ...
    @_builtins.property
    @pulumi.getter(name="registryHosts")
    def registry_hosts(self) -> Optional[Sequence[outputs.NodePoolNodeConfigContainerdConfigRegistryHost]]:
...
class NodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig(dict):
    ...
    def __init__(__self__, *, enabled: _builtins.bool, certificate_authority_domain_configs: Optional[Sequence[outputs.NodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig]] = ...) -> None:
...
class NodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig(dict):
    ...
    def __init__(__self__, *, fqdns: Sequence[_builtins.str], gcp_secret_manager_certificate_config: outputs.NodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigGcpSecretManagerCertificateConfig) -> None:
...
class NodePoolNodeConfigContainerdConfigRegistryHost(dict):
    def __init__(__self__, *, server: _builtins.str, hosts: Optional[Sequence[outputs.NodePoolNodeConfigContainerdConfigRegistryHostHost]] = ...) -> None:
    ...
    @_builtins.property
    @pulumi.getter
    def hosts(self) -> Optional[Sequence[outputs.NodePoolNodeConfigContainerdConfigRegistryHostHost]]:
...
class NodePoolNodeConfigContainerdConfigRegistryHostHost(dict):
    ...
    def __init__(__self__, *, host: _builtins.str, capabilities: Optional[Sequence[_builtins.str]] = ..., cas: Optional[Sequence[outputs.NodePoolNodeConfigContainerdConfigRegistryHostHostCa]] = ..., clients: Optional[Sequence[outputs.NodePoolNodeConfigContainerdConfigRegistryHostHostClient]] = ..., dial_timeout: Optional[_builtins.str] = ..., headers: Optional[Sequence[outputs.NodePoolNodeConfigContainerdConfigRegistryHostHostHeader]] = ..., override_path: Optional[_builtins.bool] = ...) -> None:
    ...
    @_builtins.property
    @pulumi.getter
    def cas(self) -> Optional[Sequence[outputs.NodePoolNodeConfigContainerdConfigRegistryHostHostCa]]:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def clients(self) -> Optional[Sequence[outputs.NodePoolNodeConfigContainerdConfigRegistryHostHostClient]]:
    ...
    @_builtins.property
    @pulumi.getter
    def headers(self) -> Optional[Sequence[outputs.NodePoolNodeConfigContainerdConfigRegistryHostHostHeader]]:
...
class NodePoolNodeConfigContainerdConfigRegistryHostHostClient(dict):
    def __init__(__self__, *, cert: outputs.NodePoolNodeConfigContainerdConfigRegistryHostHostClientCert, key: Optional[outputs.NodePoolNodeConfigContainerdConfigRegistryHostHostClientKey] = ...) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def cert(self) -> outputs.NodePoolNodeConfigContainerdConfigRegistryHostHostClientCert:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def key(self) -> Optional[outputs.NodePoolNodeConfigContainerdConfigRegistryHostHostClientKey]:
...
class NodePoolNodeConfigGuestAccelerator(dict):
    ...
    def __init__(__self__, *, count: _builtins.int, type: _builtins.str, gpu_driver_installation_config: Optional[outputs.NodePoolNodeConfigGuestAcceleratorGpuDriverInstallationConfig] = ..., gpu_partition_size: Optional[_builtins.str] = ..., gpu_sharing_config: Optional[outputs.NodePoolNodeConfigGuestAcceleratorGpuSharingConfig] = ...) -> None:
...
class NodePoolNodeConfigKubeletConfig(dict):
    ...
    def __init__(__self__, *, allowed_unsafe_sysctls: Optional[Sequence[_builtins.str]] = ..., container_log_max_files: Optional[_builtins.int] = ..., container_log_max_size: Optional[_builtins.str] = ..., cpu_cfs_quota: Optional[_builtins.bool] = ..., cpu_cfs_quota_period: Optional[_builtins.str] = ..., cpu_manager_policy: Optional[_builtins.str] = ..., eviction_max_pod_grace_period_seconds: Optional[_builtins.int] = ..., eviction_minimum_reclaim: Optional[outputs.NodePoolNodeConfigKubeletConfigEvictionMinimumReclaim] = ..., eviction_soft: Optional[outputs.NodePoolNodeConfigKubeletConfigEvictionSoft] = ..., eviction_soft_grace_period: Optional[outputs.NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod] = ..., image_gc_high_threshold_percent: Optional[_builtins.int] = ..., image_gc_low_threshold_percent: Optional[_builtins.int] = ..., image_maximum_gc_age: Optional[_builtins.str] = ..., image_minimum_gc_age: Optional[_builtins.str] = ..., insecure_kubelet_readonly_port_enabled: Optional[_builtins.str] = ..., max_parallel_image_pulls: Optional[_builtins.int] = ..., memory_manager: Optional[outputs.NodePoolNodeConfigKubeletConfigMemoryManager] = ..., pod_pids_limit: Optional[_builtins.int] = ..., single_process_oom_kill: Optional[_builtins.bool] = ..., topology_manager: Optional[outputs.NodePoolNodeConfigKubeletConfigTopologyManager] = ...) -> None:
...
class NodePoolNodeConfigLinuxNodeConfig(dict):
    ...
    def __init__(__self__, *, cgroup_mode: Optional[_builtins.str] = ..., hugepages_config: Optional[outputs.NodePoolNodeConfigLinuxNodeConfigHugepagesConfig] = ..., node_kernel_module_loading: Optional[outputs.NodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading] = ..., sysctls: Optional[Mapping[str, _builtins.str]] = ..., transparent_hugepage_defrag: Optional[_builtins.str] = ..., transparent_hugepage_enabled: Optional[_builtins.str] = ...) -> None:
...
class NodePoolNodeConfigSoleTenantConfig(dict):
    ...
    def __init__(__self__, *, node_affinities: Sequence[outputs.NodePoolNodeConfigSoleTenantConfigNodeAffinity], min_node_cpus: Optional[_builtins.int] = ...) -> None:
...
class NodePoolUpgradeSettings(dict):
    ...
    def __init__(__self__, *, blue_green_settings: Optional[outputs.NodePoolUpgradeSettingsBlueGreenSettings] = ..., max_surge: Optional[_builtins.int] = ..., max_unavailable: Optional[_builtins.int] = ..., strategy: Optional[_builtins.str] = ...) -> None:
...
class NodePoolUpgradeSettingsBlueGreenSettings(dict):
    ...
    def __init__(__self__, *, autoscaled_rollout_policy: Optional[outputs.NodePoolUpgradeSettingsBlueGreenSettingsAutoscaledRolloutPolicy] = ..., node_pool_soak_duration: Optional[_builtins.str] = ..., standard_rollout_policy: Optional[outputs.NodePoolUpgradeSettingsBlueGreenSettingsStandardRolloutPolicy] = ...) -> None:
...
class GetClusterAddonsConfigResult(dict):
    def __init__(__self__, *, cloudrun_configs: Sequence[outputs.GetClusterAddonsConfigCloudrunConfigResult], config_connector_configs: Sequence[outputs.GetClusterAddonsConfigConfigConnectorConfigResult], dns_cache_configs: Sequence[outputs.GetClusterAddonsConfigDnsCacheConfigResult], gce_persistent_disk_csi_driver_configs: Sequence[outputs.GetClusterAddonsConfigGcePersistentDiskCsiDriverConfigResult], gcp_filestore_csi_driver_configs: Sequence[outputs.GetClusterAddonsConfigGcpFilestoreCsiDriverConfigResult], gcs_fuse_csi_driver_configs: Sequence[outputs.GetClusterAddonsConfigGcsFuseCsiDriverConfigResult], gke_backup_agent_configs: Sequence[outputs.GetClusterAddonsConfigGkeBackupAgentConfigResult], horizontal_pod_autoscalings: Sequence[outputs.GetClusterAddonsConfigHorizontalPodAutoscalingResult], http_load_balancings: Sequence[outputs.GetClusterAddonsConfigHttpLoadBalancingResult], istio_configs: Sequence[outputs.GetClusterAddonsConfigIstioConfigResult], kalm_configs: Sequence[outputs.GetClusterAddonsConfigKalmConfigResult], lustre_csi_driver_configs: Sequence[outputs.GetClusterAddonsConfigLustreCsiDriverConfigResult], network_policy_configs: Sequence[outputs.GetClusterAddonsConfigNetworkPolicyConfigResult], parallelstore_csi_driver_configs: Sequence[outputs.GetClusterAddonsConfigParallelstoreCsiDriverConfigResult], pod_snapshot_configs: Sequence[outputs.GetClusterAddonsConfigPodSnapshotConfigResult], ray_operator_configs: Sequence[outputs.GetClusterAddonsConfigRayOperatorConfigResult], slice_controller_configs: Sequence[outputs.GetClusterAddonsConfigSliceControllerConfigResult], stateful_ha_configs: Sequence[outputs.GetClusterAddonsConfigStatefulHaConfigResult]) -> None:
...
class GetClusterAddonsConfigCloudrunConfigResult(dict):
    def __init__(__self__, *, disabled: _builtins.bool, load_balancer_type: _builtins.str) -> None:
        ...
...
class GetClusterAddonsConfigIstioConfigResult(dict):
    def __init__(__self__, *, auth: _builtins.str, disabled: _builtins.bool) -> None:
...
class GetClusterAddonsConfigLustreCsiDriverConfigResult(dict):
    def __init__(__self__, *, enable_legacy_lustre_port: _builtins.bool, enabled: _builtins.bool) -> None:
...
class GetClusterAddonsConfigRayOperatorConfigResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, ray_cluster_logging_configs: Sequence[outputs.GetClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfigResult], ray_cluster_monitoring_configs: Sequence[outputs.GetClusterAddonsConfigRayOperatorConfigRayClusterMonitoringConfigResult]) -> None:
...
class GetClusterBinaryAuthorizationResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, evaluation_mode: _builtins.str) -> None:
...
class GetClusterClusterAutoscalingResult(dict):
    def __init__(__self__, *, auto_provisioning_defaults: Sequence[outputs.GetClusterClusterAutoscalingAutoProvisioningDefaultResult], auto_provisioning_locations: Sequence[_builtins.str], autoscaling_profile: _builtins.str, default_compute_class_enabled: _builtins.bool, enabled: _builtins.bool, resource_limits: Sequence[outputs.GetClusterClusterAutoscalingResourceLimitResult]) -> None:
...
class GetClusterClusterAutoscalingAutoProvisioningDefaultResult(dict):
    def __init__(__self__, *, boot_disk_kms_key: _builtins.str, disk_size: _builtins.int, disk_type: _builtins.str, image_type: _builtins.str, managements: Sequence[outputs.GetClusterClusterAutoscalingAutoProvisioningDefaultManagementResult], min_cpu_platform: _builtins.str, oauth_scopes: Sequence[_builtins.str], service_account: _builtins.str, shielded_instance_configs: Sequence[outputs.GetClusterClusterAutoscalingAutoProvisioningDefaultShieldedInstanceConfigResult], upgrade_settings: Sequence[outputs.GetClusterClusterAutoscalingAutoProvisioningDefaultUpgradeSettingResult]) -> None:
...
class GetClusterClusterAutoscalingAutoProvisioningDefaultManagementResult(dict):
    def __init__(__self__, *, auto_repair: _builtins.bool, auto_upgrade: _builtins.bool, upgrade_options: Sequence[outputs.GetClusterClusterAutoscalingAutoProvisioningDefaultManagementUpgradeOptionResult]) -> None:
...
class GetClusterClusterAutoscalingAutoProvisioningDefaultManagementUpgradeOptionResult(dict):
    def __init__(__self__, *, auto_upgrade_start_time: _builtins.str, description: _builtins.str) -> None:
...
class GetClusterClusterAutoscalingAutoProvisioningDefaultShieldedInstanceConfigResult(dict):
    def __init__(__self__, *, enable_integrity_monitoring: _builtins.bool, enable_secure_boot: _builtins.bool) -> None:
...
class GetClusterClusterAutoscalingAutoProvisioningDefaultUpgradeSettingResult(dict):
    def __init__(__self__, *, blue_green_settings: Sequence[outputs.GetClusterClusterAutoscalingAutoProvisioningDefaultUpgradeSettingBlueGreenSettingResult], max_surge: _builtins.int, max_unavailable: _builtins.int, strategy: _builtins.str) -> None:
...
class GetClusterClusterAutoscalingAutoProvisioningDefaultUpgradeSettingBlueGreenSettingResult(dict):
    def __init__(__self__, *, node_pool_soak_duration: _builtins.str, standard_rollout_policies: Sequence[outputs.GetClusterClusterAutoscalingAutoProvisioningDefaultUpgradeSettingBlueGreenSettingStandardRolloutPolicyResult]) -> None:
...
class GetClusterClusterAutoscalingAutoProvisioningDefaultUpgradeSettingBlueGreenSettingStandardRolloutPolicyResult(dict):
    def __init__(__self__, *, batch_node_count: _builtins.int, batch_percentage: _builtins.float, batch_soak_duration: _builtins.str) -> None:
...
class GetClusterClusterAutoscalingResourceLimitResult(dict):
    def __init__(__self__, *, maximum: _builtins.int, minimum: _builtins.int, resource_type: _builtins.str) -> None:
...
class GetClusterConfidentialNodeResult(dict):
    def __init__(__self__, *, confidential_instance_type: _builtins.str, enabled: _builtins.bool) -> None:
...
class GetClusterControlPlaneEndpointsConfigResult(dict):
    def __init__(__self__, *, dns_endpoint_configs: Sequence[outputs.GetClusterControlPlaneEndpointsConfigDnsEndpointConfigResult], ip_endpoints_configs: Sequence[outputs.GetClusterControlPlaneEndpointsConfigIpEndpointsConfigResult]) -> None:
...
class GetClusterControlPlaneEndpointsConfigDnsEndpointConfigResult(dict):
    def __init__(__self__, *, allow_external_traffic: _builtins.bool, enable_k8s_certs_via_dns: _builtins.bool, enable_k8s_tokens_via_dns: _builtins.bool, endpoint: _builtins.str) -> None:
...
class GetClusterDatabaseEncryptionResult(dict):
    def __init__(__self__, *, key_name: _builtins.str, state: _builtins.str) -> None:
...
class GetClusterDnsConfigResult(dict):
    def __init__(__self__, *, additive_vpc_scope_dns_domain: _builtins.str, cluster_dns: _builtins.str, cluster_dns_domain: _builtins.str, cluster_dns_scope: _builtins.str) -> None:
...
class GetClusterEnterpriseConfigResult(dict):
    def __init__(__self__, *, cluster_tier: _builtins.str, desired_tier: _builtins.str) -> None:
...
class GetClusterFleetResult(dict):
    def __init__(__self__, *, membership: _builtins.str, membership_id: _builtins.str, membership_location: _builtins.str, membership_type: _builtins.str, pre_registered: _builtins.bool, project: _builtins.str) -> None:
...
class GetClusterIpAllocationPolicyResult(dict):
    def __init__(__self__, *, additional_ip_ranges_configs: Sequence[outputs.GetClusterIpAllocationPolicyAdditionalIpRangesConfigResult], additional_pod_ranges_configs: Sequence[outputs.GetClusterIpAllocationPolicyAdditionalPodRangesConfigResult], auto_ipam_configs: Sequence[outputs.GetClusterIpAllocationPolicyAutoIpamConfigResult], cluster_ipv4_cidr_block: _builtins.str, cluster_secondary_range_name: _builtins.str, network_tier_configs: Sequence[outputs.GetClusterIpAllocationPolicyNetworkTierConfigResult], pod_cidr_overprovision_configs: Sequence[outputs.GetClusterIpAllocationPolicyPodCidrOverprovisionConfigResult], services_ipv4_cidr_block: _builtins.str, services_secondary_range_name: _builtins.str, stack_type: _builtins.str) -> None:
...
class GetClusterIpAllocationPolicyAdditionalIpRangesConfigResult(dict):
    def __init__(__self__, *, pod_ipv4_range_names: Sequence[_builtins.str], status: _builtins.str, subnetwork: _builtins.str) -> None:
...
class GetClusterMaintenancePolicyResult(dict):
    def __init__(__self__, *, daily_maintenance_windows: Sequence[outputs.GetClusterMaintenancePolicyDailyMaintenanceWindowResult], disruption_budgets: Sequence[outputs.GetClusterMaintenancePolicyDisruptionBudgetResult], maintenance_exclusions: Sequence[outputs.GetClusterMaintenancePolicyMaintenanceExclusionResult], recurring_windows: Sequence[outputs.GetClusterMaintenancePolicyRecurringWindowResult]) -> None:
...
class GetClusterMaintenancePolicyDailyMaintenanceWindowResult(dict):
    def __init__(__self__, *, duration: _builtins.str, start_time: _builtins.str) -> None:
        ...
...
class GetClusterMaintenancePolicyDisruptionBudgetResult(dict):
    def __init__(__self__, *, last_disruption_time: _builtins.str, last_minor_version_disruption_time: _builtins.str, minor_version_disruption_interval: _builtins.str, patch_version_disruption_interval: _builtins.str) -> None:
        ...
...
class GetClusterMaintenancePolicyMaintenanceExclusionResult(dict):
    def __init__(__self__, *, end_time: _builtins.str, exclusion_name: _builtins.str, exclusion_options: Sequence[outputs.GetClusterMaintenancePolicyMaintenanceExclusionExclusionOptionResult], start_time: _builtins.str) -> None:
...
class GetClusterMaintenancePolicyMaintenanceExclusionExclusionOptionResult(dict):
    def __init__(__self__, *, end_time_behavior: _builtins.str, scope: _builtins.str) -> None:
...
class GetClusterMasterAuthResult(dict):
    def __init__(__self__, *, client_certificate: _builtins.str, client_certificate_configs: Sequence[outputs.GetClusterMasterAuthClientCertificateConfigResult], client_key: _builtins.str, cluster_ca_certificate: _builtins.str) -> None:
...
class GetClusterMasterAuthorizedNetworksConfigResult(dict):
    def __init__(__self__, *, cidr_blocks: Sequence[outputs.GetClusterMasterAuthorizedNetworksConfigCidrBlockResult], gcp_public_cidrs_access_enabled: _builtins.bool, private_endpoint_enforcement_enabled: _builtins.bool) -> None:
...
class GetClusterMonitoringConfigResult(dict):
    def __init__(__self__, *, advanced_datapath_observability_configs: Sequence[outputs.GetClusterMonitoringConfigAdvancedDatapathObservabilityConfigResult], enable_components: Sequence[_builtins.str], managed_prometheuses: Sequence[outputs.GetClusterMonitoringConfigManagedPrometheusResult]) -> None:
...
class GetClusterMonitoringConfigManagedPrometheusResult(dict):
    def __init__(__self__, *, auto_monitoring_configs: Sequence[outputs.GetClusterMonitoringConfigManagedPrometheusAutoMonitoringConfigResult], enabled: _builtins.bool) -> None:
...
class GetClusterNetworkPolicyResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, provider: _builtins.str) -> None:
...
class GetClusterNodeConfigResult(dict):
    def __init__(__self__, *, advanced_machine_features: Sequence[outputs.GetClusterNodeConfigAdvancedMachineFeatureResult], boot_disk_kms_key: _builtins.str, boot_disks: Sequence[outputs.GetClusterNodeConfigBootDiskResult], confidential_nodes: Sequence[outputs.GetClusterNodeConfigConfidentialNodeResult], containerd_configs: Sequence[outputs.GetClusterNodeConfigContainerdConfigResult], disk_size_gb: _builtins.int, disk_type: _builtins.str, effective_taints: Sequence[outputs.GetClusterNodeConfigEffectiveTaintResult], enable_confidential_storage: _builtins.bool, ephemeral_storage_configs: Sequence[outputs.GetClusterNodeConfigEphemeralStorageConfigResult], ephemeral_storage_local_ssd_configs: Sequence[outputs.GetClusterNodeConfigEphemeralStorageLocalSsdConfigResult], fast_sockets: Sequence[outputs.GetClusterNodeConfigFastSocketResult], flex_start: _builtins.bool, gcfs_configs: Sequence[outputs.GetClusterNodeConfigGcfsConfigResult], guest_accelerators: Sequence[outputs.GetClusterNodeConfigGuestAcceleratorResult], gvnics: Sequence[outputs.GetClusterNodeConfigGvnicResult], host_maintenance_policies: Sequence[outputs.GetClusterNodeConfigHostMaintenancePolicyResult], image_type: _builtins.str, kubelet_configs: Sequence[outputs.GetClusterNodeConfigKubeletConfigResult], labels: Mapping[str, _builtins.str], linux_node_configs: Sequence[outputs.GetClusterNodeConfigLinuxNodeConfigResult], local_nvme_ssd_block_configs: Sequence[outputs.GetClusterNodeConfigLocalNvmeSsdBlockConfigResult], local_ssd_count: _builtins.int, local_ssd_encryption_mode: _builtins.str, logging_variant: _builtins.str, machine_type: _builtins.str, max_run_duration: _builtins.str, metadata: Mapping[str, _builtins.str], min_cpu_platform: _builtins.str, node_group: _builtins.str, oauth_scopes: Sequence[_builtins.str], preemptible: _builtins.bool, reservation_affinities: Sequence[outputs.GetClusterNodeConfigReservationAffinityResult], resource_labels: Mapping[str, _builtins.str], resource_manager_tags: Mapping[str, _builtins.str], sandbox_configs: Sequence[outputs.GetClusterNodeConfigSandboxConfigResult], secondary_boot_disks: Sequence[outputs.GetClusterNodeConfigSecondaryBootDiskResult], service_account: _builtins.str, shielded_instance_configs: Sequence[outputs.GetClusterNodeConfigShieldedInstanceConfigResult], sole_tenant_configs: Sequence[outputs.GetClusterNodeConfigSoleTenantConfigResult], spot: _builtins.bool, storage_pools: Sequence[_builtins.str], tags: Sequence[_builtins.str], taints: Sequence[outputs.GetClusterNodeConfigTaintResult], windows_node_configs: Sequence[outputs.GetClusterNodeConfigWindowsNodeConfigResult], workload_metadata_configs: Sequence[outputs.GetClusterNodeConfigWorkloadMetadataConfigResult]) -> None:
...
class GetClusterNodeConfigAdvancedMachineFeatureResult(dict):
    def __init__(__self__, *, enable_nested_virtualization: _builtins.bool, performance_monitoring_unit: _builtins.str, threads_per_core: _builtins.int) -> None:
...
class GetClusterNodeConfigBootDiskResult(dict):
    def __init__(__self__, *, disk_type: _builtins.str, provisioned_iops: _builtins.int, provisioned_throughput: _builtins.int, size_gb: _builtins.int) -> None:
...
class GetClusterNodeConfigContainerdConfigResult(dict):
    def __init__(__self__, *, private_registry_access_configs: Sequence[outputs.GetClusterNodeConfigContainerdConfigPrivateRegistryAccessConfigResult], registry_hosts: Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostResult], writable_cgroups: Sequence[outputs.GetClusterNodeConfigContainerdConfigWritableCgroupResult]) -> None:
    ...
    @_builtins.property
    @pulumi.getter(name="registryHosts")
    def registry_hosts(self) -> Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostResult]:
...
class GetClusterNodeConfigContainerdConfigPrivateRegistryAccessConfigResult(dict):
    def __init__(__self__, *, certificate_authority_domain_configs: Sequence[outputs.GetClusterNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigResult], enabled: _builtins.bool) -> None:
...
class GetClusterNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigResult(dict):
    def __init__(__self__, *, fqdns: Sequence[_builtins.str], gcp_secret_manager_certificate_configs: Sequence[outputs.GetClusterNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigGcpSecretManagerCertificateConfigResult]) -> None:
...
class GetClusterNodeConfigContainerdConfigRegistryHostResult(dict):
    def __init__(__self__, *, hosts: Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostResult], server: _builtins.str) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def hosts(self) -> Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostResult]:
...
class GetClusterNodeConfigContainerdConfigRegistryHostHostResult(dict):
    def __init__(__self__, *, capabilities: Sequence[_builtins.str], cas: Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostCaResult], clients: Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostClientResult], dial_timeout: _builtins.str, headers: Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostHeaderResult], host: _builtins.str, override_path: _builtins.bool) -> None:
    ...
    @_builtins.property
    @pulumi.getter
    def cas(self) -> Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostCaResult]:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def clients(self) -> Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostClientResult]:
    ...
    @_builtins.property
    @pulumi.getter
    def headers(self) -> Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostHeaderResult]:
...
class GetClusterNodeConfigContainerdConfigRegistryHostHostClientResult(dict):
    def __init__(__self__, *, certs: Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostClientCertResult], keys: Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostClientKeyResult]) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def certs(self) -> Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostClientCertResult]:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def keys(self) -> Sequence[outputs.GetClusterNodeConfigContainerdConfigRegistryHostHostClientKeyResult]:
...
class GetClusterNodeConfigEphemeralStorageLocalSsdConfigResult(dict):
    def __init__(__self__, *, data_cache_count: _builtins.int, local_ssd_count: _builtins.int) -> None:
...
class GetClusterNodeConfigGuestAcceleratorResult(dict):
    def __init__(__self__, *, count: _builtins.int, gpu_driver_installation_configs: Sequence[outputs.GetClusterNodeConfigGuestAcceleratorGpuDriverInstallationConfigResult], gpu_partition_size: _builtins.str, gpu_sharing_configs: Sequence[outputs.GetClusterNodeConfigGuestAcceleratorGpuSharingConfigResult], type: _builtins.str) -> None:
...
class GetClusterNodeConfigKubeletConfigResult(dict):
    def __init__(__self__, *, allowed_unsafe_sysctls: Sequence[_builtins.str], container_log_max_files: _builtins.int, container_log_max_size: _builtins.str, cpu_cfs_quota: _builtins.bool, cpu_cfs_quota_period: _builtins.str, cpu_manager_policy: _builtins.str, eviction_max_pod_grace_period_seconds: _builtins.int, eviction_minimum_reclaims: Sequence[outputs.GetClusterNodeConfigKubeletConfigEvictionMinimumReclaimResult], eviction_soft_grace_periods: Sequence[outputs.GetClusterNodeConfigKubeletConfigEvictionSoftGracePeriodResult], eviction_softs: Sequence[outputs.GetClusterNodeConfigKubeletConfigEvictionSoftResult], image_gc_high_threshold_percent: _builtins.int, image_gc_low_threshold_percent: _builtins.int, image_maximum_gc_age: _builtins.str, image_minimum_gc_age: _builtins.str, insecure_kubelet_readonly_port_enabled: _builtins.str, max_parallel_image_pulls: _builtins.int, memory_managers: Sequence[outputs.GetClusterNodeConfigKubeletConfigMemoryManagerResult], pod_pids_limit: _builtins.int, single_process_oom_kill: _builtins.bool, topology_managers: Sequence[outputs.GetClusterNodeConfigKubeletConfigTopologyManagerResult]) -> None:
...
class GetClusterNodeConfigKubeletConfigEvictionMinimumReclaimResult(dict):
    def __init__(__self__, *, imagefs_available: _builtins.str, imagefs_inodes_free: _builtins.str, memory_available: _builtins.str, nodefs_available: _builtins.str, nodefs_inodes_free: _builtins.str, pid_available: _builtins.str) -> None:
...
class GetClusterNodeConfigLinuxNodeConfigResult(dict):
    def __init__(__self__, *, cgroup_mode: _builtins.str, hugepages_configs: Sequence[outputs.GetClusterNodeConfigLinuxNodeConfigHugepagesConfigResult], node_kernel_module_loadings: Sequence[outputs.GetClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoadingResult], sysctls: Mapping[str, _builtins.str], transparent_hugepage_defrag: _builtins.str, transparent_hugepage_enabled: _builtins.str) -> None:
...
class GetClusterNodeConfigLinuxNodeConfigHugepagesConfigResult(dict):
    def __init__(__self__, *, hugepage_size1g: _builtins.int, hugepage_size2m: _builtins.int) -> None:
...
class GetClusterNodeConfigReservationAffinityResult(dict):
    def __init__(__self__, *, consume_reservation_type: _builtins.str, key: _builtins.str, values: Sequence[_builtins.str]) -> None:
...
class GetClusterNodeConfigSandboxConfigResult(dict):
    def __init__(__self__, *, sandbox_type: _builtins.str, type: _builtins.str) -> None:
...
class GetClusterNodeConfigSecondaryBootDiskResult(dict):
    def __init__(__self__, *, disk_image: _builtins.str, mode: _builtins.str) -> None:
...
class GetClusterNodeConfigSoleTenantConfigResult(dict):
    def __init__(__self__, *, min_node_cpus: _builtins.int, node_affinities: Sequence[outputs.GetClusterNodeConfigSoleTenantConfigNodeAffinityResult]) -> None:
...
class GetClusterNodePoolResult(dict):
    def __init__(__self__, *, autoscalings: Sequence[outputs.GetClusterNodePoolAutoscalingResult], initial_node_count: _builtins.int, instance_group_urls: Sequence[_builtins.str], managed_instance_group_urls: Sequence[_builtins.str], managements: Sequence[outputs.GetClusterNodePoolManagementResult], max_pods_per_node: _builtins.int, name: _builtins.str, name_prefix: _builtins.str, network_configs: Sequence[outputs.GetClusterNodePoolNetworkConfigResult], node_configs: Sequence[outputs.GetClusterNodePoolNodeConfigResult], node_count: _builtins.int, node_drain_configs: Sequence[outputs.GetClusterNodePoolNodeDrainConfigResult], node_locations: Sequence[_builtins.str], placement_policies: Sequence[outputs.GetClusterNodePoolPlacementPolicyResult], queued_provisionings: Sequence[outputs.GetClusterNodePoolQueuedProvisioningResult], upgrade_settings: Sequence[outputs.GetClusterNodePoolUpgradeSettingResult], version: _builtins.str) -> None:
...
class GetClusterNodePoolAutoConfigResult(dict):
    def __init__(__self__, *, linux_node_configs: Sequence[outputs.GetClusterNodePoolAutoConfigLinuxNodeConfigResult], network_tags: Sequence[outputs.GetClusterNodePoolAutoConfigNetworkTagResult], node_kubelet_configs: Sequence[outputs.GetClusterNodePoolAutoConfigNodeKubeletConfigResult], resource_manager_tags: Mapping[str, _builtins.str]) -> None:
...
class GetClusterNodePoolAutoConfigLinuxNodeConfigResult(dict):
    def __init__(__self__, *, cgroup_mode: _builtins.str, node_kernel_module_loadings: Sequence[outputs.GetClusterNodePoolAutoConfigLinuxNodeConfigNodeKernelModuleLoadingResult]) -> None:
...
class GetClusterNodePoolAutoConfigNodeKubeletConfigResult(dict):
    def __init__(__self__, *, insecure_kubelet_readonly_port_enabled: _builtins.str) -> None:
...
class GetClusterNodePoolAutoscalingResult(dict):
    def __init__(__self__, *, location_policy: _builtins.str, max_node_count: _builtins.int, min_node_count: _builtins.int, total_max_node_count: _builtins.int, total_min_node_count: _builtins.int) -> None:
...
class GetClusterNodePoolDefaultResult(dict):
    def __init__(__self__, *, node_config_defaults: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultResult]) -> None:
...
class GetClusterNodePoolDefaultNodeConfigDefaultResult(dict):
    def __init__(__self__, *, containerd_configs: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigResult], gcfs_configs: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultGcfsConfigResult], insecure_kubelet_readonly_port_enabled: _builtins.str, logging_variant: _builtins.str) -> None:
...
class GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigResult(dict):
    def __init__(__self__, *, private_registry_access_configs: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigPrivateRegistryAccessConfigResult], registry_hosts: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostResult], writable_cgroups: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigWritableCgroupResult]) -> None:
    ...
    @_builtins.property
    @pulumi.getter(name="registryHosts")
    def registry_hosts(self) -> Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostResult]:
...
class GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigPrivateRegistryAccessConfigResult(dict):
    def __init__(__self__, *, certificate_authority_domain_configs: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigResult], enabled: _builtins.bool) -> None:
...
class GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigResult(dict):
    def __init__(__self__, *, fqdns: Sequence[_builtins.str], gcp_secret_manager_certificate_configs: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigGcpSecretManagerCertificateConfigResult]) -> None:
...
@pulumi.output_type
class GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostResult(dict):
    def __init__(__self__, *, hosts: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostResult], server: _builtins.str) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def hosts(self) -> Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostResult]:
...
@pulumi.output_type
class GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostResult(dict):
    def __init__(__self__, *, capabilities: Sequence[_builtins.str], cas: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostCaResult], clients: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostClientResult], dial_timeout: _builtins.str, headers: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostHeaderResult], host: _builtins.str, override_path: _builtins.bool) -> None:
    ...
    @_builtins.property
    @pulumi.getter
    def cas(self) -> Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostCaResult]:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def clients(self) -> Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostClientResult]:
    ...
    @_builtins.property
    @pulumi.getter
    def headers(self) -> Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostHeaderResult]:
...
@pulumi.output_type
class GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostCaResult(dict):
    def __init__(__self__, *, gcp_secret_manager_secret_uri: _builtins.str) -> None:
...
@pulumi.output_type
class GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostClientResult(dict):
    def __init__(__self__, *, certs: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostClientCertResult], keys: Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostClientKeyResult]) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def certs(self) -> Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostClientCertResult]:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def keys(self) -> Sequence[outputs.GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostClientKeyResult]:
...
@pulumi.output_type
class GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostClientCertResult(dict):
    def __init__(__self__, *, gcp_secret_manager_secret_uri: _builtins.str) -> None:
...
@pulumi.output_type
class GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostClientKeyResult(dict):
    def __init__(__self__, *, gcp_secret_manager_secret_uri: _builtins.str) -> None:
...
@pulumi.output_type
class GetClusterNodePoolDefaultNodeConfigDefaultContainerdConfigRegistryHostHostHeaderResult(dict):
    def __init__(__self__, *, key: _builtins.str, values: Sequence[_builtins.str]) -> None:
...
class GetClusterNodePoolManagementResult(dict):
    def __init__(__self__, *, auto_repair: _builtins.bool, auto_upgrade: _builtins.bool) -> None:
...
class GetClusterNodePoolNetworkConfigResult(dict):
    def __init__(__self__, *, accelerator_network_profile: _builtins.str, additional_node_network_configs: Sequence[outputs.GetClusterNodePoolNetworkConfigAdditionalNodeNetworkConfigResult], additional_pod_network_configs: Sequence[outputs.GetClusterNodePoolNetworkConfigAdditionalPodNetworkConfigResult], create_pod_range: _builtins.bool, enable_private_nodes: _builtins.bool, network_performance_configs: Sequence[outputs.GetClusterNodePoolNetworkConfigNetworkPerformanceConfigResult], pod_cidr_overprovision_configs: Sequence[outputs.GetClusterNodePoolNetworkConfigPodCidrOverprovisionConfigResult], pod_ipv4_cidr_block: _builtins.str, pod_range: _builtins.str, subnetwork: _builtins.str) -> None:
...
class GetClusterNodePoolNetworkConfigAdditionalNodeNetworkConfigResult(dict):
    def __init__(__self__, *, network: _builtins.str, subnetwork: _builtins.str) -> None:
...
class GetClusterNodePoolNetworkConfigAdditionalPodNetworkConfigResult(dict):
    def __init__(__self__, *, max_pods_per_node: _builtins.int, secondary_pod_range: _builtins.str, subnetwork: _builtins.str) -> None:
...
class GetClusterNodePoolNodeConfigResult(dict):
    def __init__(__self__, *, advanced_machine_features: Sequence[outputs.GetClusterNodePoolNodeConfigAdvancedMachineFeatureResult], boot_disk_kms_key: _builtins.str, boot_disks: Sequence[outputs.GetClusterNodePoolNodeConfigBootDiskResult], confidential_nodes: Sequence[outputs.GetClusterNodePoolNodeConfigConfidentialNodeResult], containerd_configs: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigResult], disk_size_gb: _builtins.int, disk_type: _builtins.str, effective_taints: Sequence[outputs.GetClusterNodePoolNodeConfigEffectiveTaintResult], enable_confidential_storage: _builtins.bool, ephemeral_storage_configs: Sequence[outputs.GetClusterNodePoolNodeConfigEphemeralStorageConfigResult], ephemeral_storage_local_ssd_configs: Sequence[outputs.GetClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfigResult], fast_sockets: Sequence[outputs.GetClusterNodePoolNodeConfigFastSocketResult], flex_start: _builtins.bool, gcfs_configs: Sequence[outputs.GetClusterNodePoolNodeConfigGcfsConfigResult], guest_accelerators: Sequence[outputs.GetClusterNodePoolNodeConfigGuestAcceleratorResult], gvnics: Sequence[outputs.GetClusterNodePoolNodeConfigGvnicResult], host_maintenance_policies: Sequence[outputs.GetClusterNodePoolNodeConfigHostMaintenancePolicyResult], image_type: _builtins.str, kubelet_configs: Sequence[outputs.GetClusterNodePoolNodeConfigKubeletConfigResult], labels: Mapping[str, _builtins.str], linux_node_configs: Sequence[outputs.GetClusterNodePoolNodeConfigLinuxNodeConfigResult], local_nvme_ssd_block_configs: Sequence[outputs.GetClusterNodePoolNodeConfigLocalNvmeSsdBlockConfigResult], local_ssd_count: _builtins.int, local_ssd_encryption_mode: _builtins.str, logging_variant: _builtins.str, machine_type: _builtins.str, max_run_duration: _builtins.str, metadata: Mapping[str, _builtins.str], min_cpu_platform: _builtins.str, node_group: _builtins.str, oauth_scopes: Sequence[_builtins.str], preemptible: _builtins.bool, reservation_affinities: Sequence[outputs.GetClusterNodePoolNodeConfigReservationAffinityResult], resource_labels: Mapping[str, _builtins.str], resource_manager_tags: Mapping[str, _builtins.str], sandbox_configs: Sequence[outputs.GetClusterNodePoolNodeConfigSandboxConfigResult], secondary_boot_disks: Sequence[outputs.GetClusterNodePoolNodeConfigSecondaryBootDiskResult], service_account: _builtins.str, shielded_instance_configs: Sequence[outputs.GetClusterNodePoolNodeConfigShieldedInstanceConfigResult], sole_tenant_configs: Sequence[outputs.GetClusterNodePoolNodeConfigSoleTenantConfigResult], spot: _builtins.bool, storage_pools: Sequence[_builtins.str], tags: Sequence[_builtins.str], taints: Sequence[outputs.GetClusterNodePoolNodeConfigTaintResult], windows_node_configs: Sequence[outputs.GetClusterNodePoolNodeConfigWindowsNodeConfigResult], workload_metadata_configs: Sequence[outputs.GetClusterNodePoolNodeConfigWorkloadMetadataConfigResult]) -> None:
...
class GetClusterNodePoolNodeConfigContainerdConfigResult(dict):
    def __init__(__self__, *, private_registry_access_configs: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigResult], registry_hosts: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostResult], writable_cgroups: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigWritableCgroupResult]) -> None:
    ...
    @_builtins.property
    @pulumi.getter(name="registryHosts")
    def registry_hosts(self) -> Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostResult]:
...
class GetClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigResult(dict):
    def __init__(__self__, *, certificate_authority_domain_configs: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigResult], enabled: _builtins.bool) -> None:
...
class GetClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigResult(dict):
    def __init__(__self__, *, fqdns: Sequence[_builtins.str], gcp_secret_manager_certificate_configs: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfigGcpSecretManagerCertificateConfigResult]) -> None:
...
class GetClusterNodePoolNodeConfigContainerdConfigRegistryHostResult(dict):
    def __init__(__self__, *, hosts: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostResult], server: _builtins.str) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def hosts(self) -> Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostResult]:
...
class GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostResult(dict):
    def __init__(__self__, *, capabilities: Sequence[_builtins.str], cas: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostCaResult], clients: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientResult], dial_timeout: _builtins.str, headers: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostHeaderResult], host: _builtins.str, override_path: _builtins.bool) -> None:
    ...
    @_builtins.property
    @pulumi.getter
    def cas(self) -> Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostCaResult]:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def clients(self) -> Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientResult]:
    ...
    @_builtins.property
    @pulumi.getter
    def headers(self) -> Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostHeaderResult]:
...
class GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientResult(dict):
    def __init__(__self__, *, certs: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientCertResult], keys: Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientKeyResult]) -> None:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def certs(self) -> Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientCertResult]:
        
        ...
    
    @_builtins.property
    @pulumi.getter
    def keys(self) -> Sequence[outputs.GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientKeyResult]:
...
@pulumi.output_type
class GetClusterNodePoolNodeConfigContainerdConfigRegistryHostHostClientCertResult(dict):
    def __init__(__self__, *, gcp_secret_manager_secret_uri: _builtins.str) -> None:
...
class GetClusterNodePoolNodeConfigGuestAcceleratorResult(dict):
    def __init__(__self__, *, count: _builtins.int, gpu_driver_installation_configs: Sequence[outputs.GetClusterNodePoolNodeConfigGuestAcceleratorGpuDriverInstallationConfigResult], gpu_partition_size: _builtins.str, gpu_sharing_configs: Sequence[outputs.GetClusterNodePoolNodeConfigGuestAcceleratorGpuSharingConfigResult], type: _builtins.str) -> None:
...
class GetClusterNodePoolNodeConfigKubeletConfigResult(dict):
    def __init__(__self__, *, allowed_unsafe_sysctls: Sequence[_builtins.str], container_log_max_files: _builtins.int, container_log_max_size: _builtins.str, cpu_cfs_quota: _builtins.bool, cpu_cfs_quota_period: _builtins.str, cpu_manager_policy: _builtins.str, eviction_max_pod_grace_period_seconds: _builtins.int, eviction_minimum_reclaims: Sequence[outputs.GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaimResult], eviction_soft_grace_periods: Sequence[outputs.GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodResult], eviction_softs: Sequence[outputs.GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftResult], image_gc_high_threshold_percent: _builtins.int, image_gc_low_threshold_percent: _builtins.int, image_maximum_gc_age: _builtins.str, image_minimum_gc_age: _builtins.str, insecure_kubelet_readonly_port_enabled: _builtins.str, max_parallel_image_pulls: _builtins.int, memory_managers: Sequence[outputs.GetClusterNodePoolNodeConfigKubeletConfigMemoryManagerResult], pod_pids_limit: _builtins.int, single_process_oom_kill: _builtins.bool, topology_managers: Sequence[outputs.GetClusterNodePoolNodeConfigKubeletConfigTopologyManagerResult]) -> None:
...
class GetClusterNodePoolNodeConfigLinuxNodeConfigResult(dict):
    def __init__(__self__, *, cgroup_mode: _builtins.str, hugepages_configs: Sequence[outputs.GetClusterNodePoolNodeConfigLinuxNodeConfigHugepagesConfigResult], node_kernel_module_loadings: Sequence[outputs.GetClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoadingResult], sysctls: Mapping[str, _builtins.str], transparent_hugepage_defrag: _builtins.str, transparent_hugepage_enabled: _builtins.str) -> None:
...
class GetClusterNodePoolNodeConfigSoleTenantConfigResult(dict):
    def __init__(__self__, *, min_node_cpus: _builtins.int, node_affinities: Sequence[outputs.GetClusterNodePoolNodeConfigSoleTenantConfigNodeAffinityResult]) -> None:
...
class GetClusterNodePoolNodeDrainConfigResult(dict):
    def __init__(__self__, *, respect_pdb_during_node_pool_deletion: _builtins.bool) -> None:
...
class GetClusterNodePoolPlacementPolicyResult(dict):
    def __init__(__self__, *, policy_name: _builtins.str, tpu_topology: _builtins.str, type: _builtins.str) -> None:
...
class GetClusterNodePoolUpgradeSettingResult(dict):
    def __init__(__self__, *, blue_green_settings: Sequence[outputs.GetClusterNodePoolUpgradeSettingBlueGreenSettingResult], max_surge: _builtins.int, max_unavailable: _builtins.int, strategy: _builtins.str) -> None:
...
class GetClusterNodePoolUpgradeSettingBlueGreenSettingResult(dict):
    def __init__(__self__, *, autoscaled_rollout_policies: Sequence[outputs.GetClusterNodePoolUpgradeSettingBlueGreenSettingAutoscaledRolloutPolicyResult], node_pool_soak_duration: _builtins.str, standard_rollout_policies: Sequence[outputs.GetClusterNodePoolUpgradeSettingBlueGreenSettingStandardRolloutPolicyResult]) -> None:
...
class GetClusterNotificationConfigResult(dict):
    def __init__(__self__, *, pubsubs: Sequence[outputs.GetClusterNotificationConfigPubsubResult]) -> None:
...
class GetClusterNotificationConfigPubsubResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, filters: Sequence[outputs.GetClusterNotificationConfigPubsubFilterResult], topic: _builtins.str) -> None:
...
class GetClusterPrivateClusterConfigResult(dict):
    def __init__(__self__, *, enable_private_endpoint: _builtins.bool, enable_private_nodes: _builtins.bool, master_global_access_configs: Sequence[outputs.GetClusterPrivateClusterConfigMasterGlobalAccessConfigResult], master_ipv4_cidr_block: _builtins.str, peering_name: _builtins.str, private_endpoint: _builtins.str, private_endpoint_subnetwork: _builtins.str, public_endpoint: _builtins.str) -> None:
...
class GetClusterProtectConfigResult(dict):
    def __init__(__self__, *, workload_configs: Sequence[outputs.GetClusterProtectConfigWorkloadConfigResult], workload_vulnerability_mode: _builtins.str) -> None:
...
class GetClusterRbacBindingConfigResult(dict):
    def __init__(__self__, *, enable_insecure_binding_system_authenticated: _builtins.bool, enable_insecure_binding_system_unauthenticated: _builtins.bool) -> None:
...
class GetClusterResourceUsageExportConfigResult(dict):
    def __init__(__self__, *, bigquery_destinations: Sequence[outputs.GetClusterResourceUsageExportConfigBigqueryDestinationResult], enable_network_egress_metering: _builtins.bool, enable_resource_consumption_metering: _builtins.bool) -> None:
...
class GetClusterSecretManagerConfigResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, rotation_configs: Sequence[outputs.GetClusterSecretManagerConfigRotationConfigResult]) -> None:
...
class GetClusterSecretManagerConfigRotationConfigResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, rotation_interval: _builtins.str) -> None:
...
class GetClusterSecretSyncConfigResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, rotation_configs: Sequence[outputs.GetClusterSecretSyncConfigRotationConfigResult]) -> None:
...
class GetClusterSecurityPostureConfigResult(dict):
    def __init__(__self__, *, mode: _builtins.str, vulnerability_mode: _builtins.str) -> None:
...
class GetClusterTpuConfigResult(dict):
    def __init__(__self__, *, enabled: _builtins.bool, ipv4_cidr_block: _builtins.str, use_service_networking: _builtins.bool) -> None:
...
class GetClusterUserManagedKeysConfigResult(dict):
    def __init__(__self__, *, aggregation_ca: _builtins.str, cluster_ca: _builtins.str, control_plane_disk_encryption_key: _builtins.str, control_plane_disk_encryption_key_versions: Sequence[_builtins.str], etcd_api_ca: _builtins.str, etcd_peer_ca: _builtins.str, gkeops_etcd_backup_encryption_key: _builtins.str, service_account_signing_keys: Sequence[_builtins.str], service_account_verification_keys: Sequence[_builtins.str]) -> None:
