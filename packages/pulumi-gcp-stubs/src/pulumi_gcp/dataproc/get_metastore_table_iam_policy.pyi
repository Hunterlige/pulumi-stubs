...
def get_metastore_table_iam_policy(
    database_id: Optional[_builtins.str] = ...,
...
def get_metastore_table_iam_policy_output(
...
) -> pulumi.Output[GetMetastoreTableIamPolicyResult]: ...
