...
class ClusterIAMBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[ClusterIAMBindingConditionArgs]] = ...,
...
class ClusterIAMBinding(pulumi.CustomResource):
    ...
    def __init__(
        ...
        condition: Optional[
            pulumi.Input[
                Union[
                    ClusterIAMBindingConditionArgs, ClusterIAMBindingConditionArgsDict
                ]
            ]
        ] = ...,
        members: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...,
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.ClusterIAMBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
