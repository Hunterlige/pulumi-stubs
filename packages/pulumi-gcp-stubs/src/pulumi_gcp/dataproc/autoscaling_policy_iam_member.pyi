...
class AutoscalingPolicyIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[AutoscalingPolicyIamMemberConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[AutoscalingPolicyIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[AutoscalingPolicyIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class AutoscalingPolicyIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.AutoscalingPolicyIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
