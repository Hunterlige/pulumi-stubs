...
class MetastoreFederationIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[MetastoreFederationIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[MetastoreFederationIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[MetastoreFederationIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _MetastoreFederationIamBindingState:
    def __init__(
        ...
        *,
        ...
        federation_id: Optional[pulumi.Input[_builtins.str]] = ...,
        location: Optional[pulumi.Input[_builtins.str]] = ...,
...
class MetastoreFederationIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.MetastoreFederationIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
