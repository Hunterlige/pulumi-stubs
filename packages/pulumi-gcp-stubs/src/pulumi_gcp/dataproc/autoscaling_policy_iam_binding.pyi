...
class AutoscalingPolicyIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[AutoscalingPolicyIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[AutoscalingPolicyIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[AutoscalingPolicyIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class AutoscalingPolicyIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.AutoscalingPolicyIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
