...
class MetastoreFederationArgs:
    def __init__(
        __self__,
        *,
        backend_metastores: pulumi.Input[
            Sequence[pulumi.Input[MetastoreFederationBackendMetastoreArgs]]
        ],
...
class _MetastoreFederationState:
    ...
    def backend_metastores(
        ...
        pulumi.Input[Sequence[pulumi.Input[MetastoreFederationBackendMetastoreArgs]]]
    ]: ...
    @backend_metastores.setter
    def backend_metastores(
        self,
...
class MetastoreFederation(pulumi.CustomResource):
    ...
    def backend_metastores(
        self,
    ) -> pulumi.Output[Sequence[outputs.MetastoreFederationBackendMetastore]]: ...
    @_builtins.property
    @pulumi.getter(name="createTime")
