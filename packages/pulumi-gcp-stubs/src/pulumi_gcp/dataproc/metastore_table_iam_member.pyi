...
class MetastoreTableIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[MetastoreTableIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[MetastoreTableIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[MetastoreTableIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class MetastoreTableIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.MetastoreTableIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="databaseId")
