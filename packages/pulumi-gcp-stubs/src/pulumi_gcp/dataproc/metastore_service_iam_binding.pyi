...
class MetastoreServiceIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[MetastoreServiceIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[MetastoreServiceIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[MetastoreServiceIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class MetastoreServiceIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.MetastoreServiceIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
