...
class GdcApplicationEnvironmentArgs:
    def __init__(
        ...
        *,
        ...
        application_environment_id: Optional[pulumi.Input[_builtins.str]] = ...,
        display_name: Optional[pulumi.Input[_builtins.str]] = ...,
        labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        namespace: Optional[pulumi.Input[_builtins.str]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
        spark_application_environment_config: Optional[
            pulumi.Input[GdcApplicationEnvironmentSparkApplicationEnvironmentConfigArgs]
        ] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
...
class GdcApplicationEnvironment(pulumi.CustomResource):
    ...
    def spark_application_environment_config(
        ...
        Optional[outputs.GdcApplicationEnvironmentSparkApplicationEnvironmentConfig]
    ]: ...
    @_builtins.property
    @pulumi.getter
