...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AutoscalingPolicyBasicAlgorithmArgs', 'AutoscalingPolicyBasicAlgorithmArgsDict', 'AutoscalingPolicyBasicAlgorithmYarnConfigArgs', 'AutoscalingPolicyBasicAlgorithmYarnConfigArgsDict', 'AutoscalingPolicyIamBindingConditionArgs', 'AutoscalingPolicyIamBindingConditionArgsDict', 'AutoscalingPolicyIamMemberConditionArgs', 'AutoscalingPolicyIamMemberConditionArgsDict', 'AutoscalingPolicySecondaryWorkerConfigArgs', 'AutoscalingPolicySecondaryWorkerConfigArgsDict', 'AutoscalingPolicyWorkerConfigArgs', 'AutoscalingPolicyWorkerConfigArgsDict', 'BatchEnvironmentConfigArgs', 'BatchEnvironmentConfigArgsDict', 'BatchEnvironmentConfigExecutionConfigArgs', 'BatchEnvironmentConfigExecutionConfigArgsDict', ..., ..., 'BatchEnvironmentConfigPeripheralsConfigArgs', 'BatchEnvironmentConfigPeripheralsConfigArgsDict', ..., ..., 'BatchPysparkBatchArgs', 'BatchPysparkBatchArgsDict', 'BatchRuntimeConfigArgs', 'BatchRuntimeConfigArgsDict', 'BatchRuntimeConfigAutotuningConfigArgs', 'BatchRuntimeConfigAutotuningConfigArgsDict', 'BatchRuntimeInfoArgs', 'BatchRuntimeInfoArgsDict', 'BatchRuntimeInfoApproximateUsageArgs', 'BatchRuntimeInfoApproximateUsageArgsDict', 'BatchRuntimeInfoCurrentUsageArgs', 'BatchRuntimeInfoCurrentUsageArgsDict', 'BatchSparkBatchArgs', 'BatchSparkBatchArgsDict', 'BatchSparkRBatchArgs', 'BatchSparkRBatchArgsDict', 'BatchSparkSqlBatchArgs', 'BatchSparkSqlBatchArgsDict', 'BatchStateHistoryArgs', 'BatchStateHistoryArgsDict', 'ClusterClusterConfigArgs', 'ClusterClusterConfigArgsDict', 'ClusterClusterConfigAutoscalingConfigArgs', 'ClusterClusterConfigAutoscalingConfigArgsDict', 'ClusterClusterConfigAuxiliaryNodeGroupArgs', 'ClusterClusterConfigAuxiliaryNodeGroupArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'ClusterClusterConfigDataprocMetricConfigArgs', 'ClusterClusterConfigDataprocMetricConfigArgsDict', 'ClusterClusterConfigDataprocMetricConfigMetricArgs', ..., 'ClusterClusterConfigEncryptionConfigArgs', 'ClusterClusterConfigEncryptionConfigArgsDict', 'ClusterClusterConfigEndpointConfigArgs', 'ClusterClusterConfigEndpointConfigArgsDict', 'ClusterClusterConfigGceClusterConfigArgs', 'ClusterClusterConfigGceClusterConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'ClusterClusterConfigInitializationActionArgs', 'ClusterClusterConfigInitializationActionArgsDict', 'ClusterClusterConfigLifecycleConfigArgs', 'ClusterClusterConfigLifecycleConfigArgsDict', 'ClusterClusterConfigMasterConfigArgs', 'ClusterClusterConfigMasterConfigArgsDict', 'ClusterClusterConfigMasterConfigAcceleratorArgs', ..., 'ClusterClusterConfigMasterConfigDiskConfigArgs', 'ClusterClusterConfigMasterConfigDiskConfigArgsDict', ..., ..., ..., ..., ..., ..., 'ClusterClusterConfigMetastoreConfigArgs', 'ClusterClusterConfigMetastoreConfigArgsDict', 'ClusterClusterConfigPreemptibleWorkerConfigArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'ClusterClusterConfigSecurityConfigArgs', 'ClusterClusterConfigSecurityConfigArgsDict', ..., ..., ..., ..., 'ClusterClusterConfigSoftwareConfigArgs', 'ClusterClusterConfigSoftwareConfigArgsDict', 'ClusterClusterConfigWorkerConfigArgs', 'ClusterClusterConfigWorkerConfigArgsDict', 'ClusterClusterConfigWorkerConfigAcceleratorArgs', ..., 'ClusterClusterConfigWorkerConfigDiskConfigArgs', 'ClusterClusterConfigWorkerConfigDiskConfigArgsDict', ..., ..., ..., ..., ..., ..., 'ClusterIAMBindingConditionArgs', 'ClusterIAMBindingConditionArgsDict', 'ClusterIAMMemberConditionArgs', 'ClusterIAMMemberConditionArgsDict', 'ClusterVirtualClusterConfigArgs', 'ClusterVirtualClusterConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., 'GdcServiceInstanceGdceClusterArgs', 'GdcServiceInstanceGdceClusterArgsDict', 'GdcServiceInstanceSparkServiceInstanceConfigArgs', ..., 'GdcSparkApplicationPysparkApplicationConfigArgs', ..., 'GdcSparkApplicationSparkApplicationConfigArgs', 'GdcSparkApplicationSparkApplicationConfigArgsDict', 'GdcSparkApplicationSparkRApplicationConfigArgs', 'GdcSparkApplicationSparkRApplicationConfigArgsDict', 'GdcSparkApplicationSparkSqlApplicationConfigArgs', ..., ..., ..., 'JobHadoopConfigArgs', 'JobHadoopConfigArgsDict', 'JobHadoopConfigLoggingConfigArgs', 'JobHadoopConfigLoggingConfigArgsDict', 'JobHiveConfigArgs', 'JobHiveConfigArgsDict', 'JobIAMBindingConditionArgs', 'JobIAMBindingConditionArgsDict', 'JobIAMMemberConditionArgs', 'JobIAMMemberConditionArgsDict', 'JobPigConfigArgs', 'JobPigConfigArgsDict', 'JobPigConfigLoggingConfigArgs', 'JobPigConfigLoggingConfigArgsDict', 'JobPlacementArgs', 'JobPlacementArgsDict', 'JobPrestoConfigArgs', 'JobPrestoConfigArgsDict', 'JobPrestoConfigLoggingConfigArgs', 'JobPrestoConfigLoggingConfigArgsDict', 'JobPysparkConfigArgs', 'JobPysparkConfigArgsDict', 'JobPysparkConfigLoggingConfigArgs', 'JobPysparkConfigLoggingConfigArgsDict', 'JobReferenceArgs', 'JobReferenceArgsDict', 'JobSchedulingArgs', 'JobSchedulingArgsDict', 'JobSparkConfigArgs', 'JobSparkConfigArgsDict', 'JobSparkConfigLoggingConfigArgs', 'JobSparkConfigLoggingConfigArgsDict', 'JobSparksqlConfigArgs', 'JobSparksqlConfigArgsDict', 'JobSparksqlConfigLoggingConfigArgs', 'JobSparksqlConfigLoggingConfigArgsDict', 'JobStatusArgs', 'JobStatusArgsDict', 'MetastoreDatabaseIamBindingConditionArgs', 'MetastoreDatabaseIamBindingConditionArgsDict', 'MetastoreDatabaseIamMemberConditionArgs', 'MetastoreDatabaseIamMemberConditionArgsDict', 'MetastoreFederationBackendMetastoreArgs', 'MetastoreFederationBackendMetastoreArgsDict', 'MetastoreFederationIamBindingConditionArgs', 'MetastoreFederationIamBindingConditionArgsDict', 'MetastoreFederationIamMemberConditionArgs', 'MetastoreFederationIamMemberConditionArgsDict', 'MetastoreServiceEncryptionConfigArgs', 'MetastoreServiceEncryptionConfigArgsDict', 'MetastoreServiceHiveMetastoreConfigArgs', 'MetastoreServiceHiveMetastoreConfigArgsDict', ..., ..., ..., ..., ..., ..., 'MetastoreServiceIamBindingConditionArgs', 'MetastoreServiceIamBindingConditionArgsDict', 'MetastoreServiceIamMemberConditionArgs', 'MetastoreServiceIamMemberConditionArgsDict', 'MetastoreServiceMaintenanceWindowArgs', 'MetastoreServiceMaintenanceWindowArgsDict', 'MetastoreServiceMetadataIntegrationArgs', 'MetastoreServiceMetadataIntegrationArgsDict', ..., ..., 'MetastoreServiceNetworkConfigArgs', 'MetastoreServiceNetworkConfigArgsDict', 'MetastoreServiceNetworkConfigConsumerArgs', 'MetastoreServiceNetworkConfigConsumerArgsDict', 'MetastoreServiceScalingConfigArgs', 'MetastoreServiceScalingConfigArgsDict', 'MetastoreServiceScalingConfigAutoscalingConfigArgs', ..., ..., ..., 'MetastoreServiceScheduledBackupArgs', 'MetastoreServiceScheduledBackupArgsDict', 'MetastoreServiceTelemetryConfigArgs', 'MetastoreServiceTelemetryConfigArgsDict', 'MetastoreTableIamBindingConditionArgs', 'MetastoreTableIamBindingConditionArgsDict', 'MetastoreTableIamMemberConditionArgs', 'MetastoreTableIamMemberConditionArgsDict', 'SessionTemplateEnvironmentConfigArgs', 'SessionTemplateEnvironmentConfigArgsDict', ..., ..., ..., ..., ..., ..., ..., ..., 'SessionTemplateJupyterSessionArgs', 'SessionTemplateJupyterSessionArgsDict', 'SessionTemplateRuntimeConfigArgs', 'SessionTemplateRuntimeConfigArgsDict', 'SessionTemplateSparkConnectSessionArgs', 'SessionTemplateSparkConnectSessionArgsDict', 'WorkflowTemplateEncryptionConfigArgs', 'WorkflowTemplateEncryptionConfigArgsDict', 'WorkflowTemplateJobArgs', 'WorkflowTemplateJobArgsDict', 'WorkflowTemplateJobHadoopJobArgs', 'WorkflowTemplateJobHadoopJobArgsDict', 'WorkflowTemplateJobHadoopJobLoggingConfigArgs', 'WorkflowTemplateJobHadoopJobLoggingConfigArgsDict', 'WorkflowTemplateJobHiveJobArgs', 'WorkflowTemplateJobHiveJobArgsDict', 'WorkflowTemplateJobHiveJobQueryListArgs', 'WorkflowTemplateJobHiveJobQueryListArgsDict', 'WorkflowTemplateJobPigJobArgs', 'WorkflowTemplateJobPigJobArgsDict', 'WorkflowTemplateJobPigJobLoggingConfigArgs', 'WorkflowTemplateJobPigJobLoggingConfigArgsDict', 'WorkflowTemplateJobPigJobQueryListArgs', 'WorkflowTemplateJobPigJobQueryListArgsDict', 'WorkflowTemplateJobPrestoJobArgs', 'WorkflowTemplateJobPrestoJobArgsDict', 'WorkflowTemplateJobPrestoJobLoggingConfigArgs', 'WorkflowTemplateJobPrestoJobLoggingConfigArgsDict', 'WorkflowTemplateJobPrestoJobQueryListArgs', 'WorkflowTemplateJobPrestoJobQueryListArgsDict', 'WorkflowTemplateJobPysparkJobArgs', 'WorkflowTemplateJobPysparkJobArgsDict', 'WorkflowTemplateJobPysparkJobLoggingConfigArgs', 'WorkflowTemplateJobPysparkJobLoggingConfigArgsDict', 'WorkflowTemplateJobSchedulingArgs', 'WorkflowTemplateJobSchedulingArgsDict', 'WorkflowTemplateJobSparkJobArgs', 'WorkflowTemplateJobSparkJobArgsDict', 'WorkflowTemplateJobSparkJobLoggingConfigArgs', 'WorkflowTemplateJobSparkJobLoggingConfigArgsDict', 'WorkflowTemplateJobSparkRJobArgs', 'WorkflowTemplateJobSparkRJobArgsDict', 'WorkflowTemplateJobSparkRJobLoggingConfigArgs', 'WorkflowTemplateJobSparkRJobLoggingConfigArgsDict', 'WorkflowTemplateJobSparkSqlJobArgs', 'WorkflowTemplateJobSparkSqlJobArgsDict', 'WorkflowTemplateJobSparkSqlJobLoggingConfigArgs', ..., 'WorkflowTemplateJobSparkSqlJobQueryListArgs', 'WorkflowTemplateJobSparkSqlJobQueryListArgsDict', 'WorkflowTemplateParameterArgs', 'WorkflowTemplateParameterArgsDict', 'WorkflowTemplateParameterValidationArgs', 'WorkflowTemplateParameterValidationArgsDict', 'WorkflowTemplateParameterValidationRegexArgs', 'WorkflowTemplateParameterValidationRegexArgsDict', 'WorkflowTemplateParameterValidationValuesArgs', 'WorkflowTemplateParameterValidationValuesArgsDict', 'WorkflowTemplatePlacementArgs', 'WorkflowTemplatePlacementArgsDict', 'WorkflowTemplatePlacementClusterSelectorArgs', 'WorkflowTemplatePlacementClusterSelectorArgsDict', 'WorkflowTemplatePlacementManagedClusterArgs', 'WorkflowTemplatePlacementManagedClusterArgsDict', 'WorkflowTemplatePlacementManagedClusterConfigArgs', ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ..., ...]
...
class AutoscalingPolicyBasicAlgorithmArgs:
    def __init__(__self__, *, yarn_config: pulumi.Input[AutoscalingPolicyBasicAlgorithmYarnConfigArgs], cooldown_period: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @yarn_config.setter
    def yarn_config(self, value: pulumi.Input[AutoscalingPolicyBasicAlgorithmYarnConfigArgs]): # -> None:
        ...
    ...
    def cooldown_period(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class AutoscalingPolicyBasicAlgorithmYarnConfigArgs:
    def __init__(__self__, *, graceful_decommission_timeout: pulumi.Input[_builtins.str], scale_down_factor: pulumi.Input[_builtins.float], scale_up_factor: pulumi.Input[_builtins.float], scale_down_min_worker_fraction: Optional[pulumi.Input[_builtins.float]] = ..., scale_up_min_worker_fraction: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def graceful_decommission_timeout(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def scale_down_factor(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def scale_up_factor(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    def scale_down_min_worker_fraction(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def scale_up_min_worker_fraction(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class AutoscalingPolicySecondaryWorkerConfigArgs:
    def __init__(__self__, *, max_instances: Optional[pulumi.Input[_builtins.int]] = ..., min_instances: Optional[pulumi.Input[_builtins.int]] = ..., weight: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class AutoscalingPolicyWorkerConfigArgs:
    def __init__(__self__, *, max_instances: pulumi.Input[_builtins.int], min_instances: Optional[pulumi.Input[_builtins.int]] = ..., weight: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @max_instances.setter
    def max_instances(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class BatchEnvironmentConfigArgs:
    def __init__(__self__, *, execution_config: Optional[pulumi.Input[BatchEnvironmentConfigExecutionConfigArgs]] = ..., peripherals_config: Optional[pulumi.Input[BatchEnvironmentConfigPeripheralsConfigArgs]] = ...) -> None:
    ...
    def execution_config(self, value: Optional[pulumi.Input[BatchEnvironmentConfigExecutionConfigArgs]]): # -> None:
        ...
    ...
    def peripherals_config(self, value: Optional[pulumi.Input[BatchEnvironmentConfigPeripheralsConfigArgs]]): # -> None:
        ...
...
class BatchEnvironmentConfigExecutionConfigArgs:
    def __init__(__self__, *, authentication_config: Optional[pulumi.Input[BatchEnvironmentConfigExecutionConfigAuthenticationConfigArgs]] = ..., kms_key: Optional[pulumi.Input[_builtins.str]] = ..., network_tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., network_uri: Optional[pulumi.Input[_builtins.str]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., staging_bucket: Optional[pulumi.Input[_builtins.str]] = ..., subnetwork_uri: Optional[pulumi.Input[_builtins.str]] = ..., ttl: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def authentication_config(self, value: Optional[pulumi.Input[BatchEnvironmentConfigExecutionConfigAuthenticationConfigArgs]]): # -> None:
        ...
    ...
    @network_tags.setter
    def network_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @network_uri.setter
    def network_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def staging_bucket(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def subnetwork_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BatchEnvironmentConfigExecutionConfigAuthenticationConfigArgs:
    def __init__(__self__, *, user_workload_authentication_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def user_workload_authentication_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BatchEnvironmentConfigPeripheralsConfigArgs:
    def __init__(__self__, *, metastore_service: Optional[pulumi.Input[_builtins.str]] = ..., spark_history_server_config: Optional[pulumi.Input[BatchEnvironmentConfigPeripheralsConfigSparkHistoryServerConfigArgs]] = ...) -> None:
    ...
    def metastore_service(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def spark_history_server_config(self, value: Optional[pulumi.Input[BatchEnvironmentConfigPeripheralsConfigSparkHistoryServerConfigArgs]]): # -> None:
        ...
...
class BatchEnvironmentConfigPeripheralsConfigSparkHistoryServerConfigArgs:
    def __init__(__self__, *, dataproc_cluster: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def dataproc_cluster(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BatchPysparkBatchArgs:
    def __init__(__self__, *, archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., main_python_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., python_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @archive_uris.setter
    def archive_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @file_uris.setter
    def file_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def jar_file_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def main_python_file_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def python_file_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class BatchRuntimeConfigArgs:
    def __init__(__self__, *, autotuning_config: Optional[pulumi.Input[BatchRuntimeConfigAutotuningConfigArgs]] = ..., cohort: Optional[pulumi.Input[_builtins.str]] = ..., container_image: Optional[pulumi.Input[_builtins.str]] = ..., effective_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def autotuning_config(self, value: Optional[pulumi.Input[BatchRuntimeConfigAutotuningConfigArgs]]): # -> None:
        ...
    ...
    @cohort.setter
    def cohort(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def effective_properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class BatchRuntimeConfigAutotuningConfigArgs:
    def __init__(__self__, *, scenarios: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class BatchRuntimeInfoArgs:
    def __init__(__self__, *, approximate_usages: Optional[pulumi.Input[Sequence[pulumi.Input[BatchRuntimeInfoApproximateUsageArgs]]]] = ..., current_usages: Optional[pulumi.Input[Sequence[pulumi.Input[BatchRuntimeInfoCurrentUsageArgs]]]] = ..., diagnostic_output_uri: Optional[pulumi.Input[_builtins.str]] = ..., endpoints: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., output_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def approximate_usages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BatchRuntimeInfoApproximateUsageArgs]]]]): # -> None:
        ...
    ...
    def current_usages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[BatchRuntimeInfoCurrentUsageArgs]]]]): # -> None:
        ...
    ...
    def diagnostic_output_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @endpoints.setter
    def endpoints(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @output_uri.setter
    def output_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BatchRuntimeInfoApproximateUsageArgs:
    def __init__(__self__, *, accelerator_type: Optional[pulumi.Input[_builtins.str]] = ..., milli_accelerator_seconds: Optional[pulumi.Input[_builtins.str]] = ..., milli_dcu_seconds: Optional[pulumi.Input[_builtins.str]] = ..., shuffle_storage_gb_seconds: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def milli_accelerator_seconds(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def milli_dcu_seconds(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def shuffle_storage_gb_seconds(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BatchRuntimeInfoCurrentUsageArgs:
    def __init__(__self__, *, accelerator_type: Optional[pulumi.Input[_builtins.str]] = ..., milli_accelerator: Optional[pulumi.Input[_builtins.str]] = ..., milli_dcu: Optional[pulumi.Input[_builtins.str]] = ..., milli_dcu_premium: Optional[pulumi.Input[_builtins.str]] = ..., shuffle_storage_gb: Optional[pulumi.Input[_builtins.str]] = ..., shuffle_storage_gb_premium: Optional[pulumi.Input[_builtins.str]] = ..., snapshot_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def milli_accelerator(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @milli_dcu.setter
    def milli_dcu(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def milli_dcu_premium(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def shuffle_storage_gb(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def shuffle_storage_gb_premium(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BatchSparkBatchArgs:
    def __init__(__self__, *, archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., main_class: Optional[pulumi.Input[_builtins.str]] = ..., main_jar_file_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @main_class.setter
    def main_class(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def main_jar_file_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BatchSparkRBatchArgs:
    def __init__(__self__, *, archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., main_r_file_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def main_r_file_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class BatchSparkSqlBatchArgs:
    def __init__(__self__, *, jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., query_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., query_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def query_file_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def query_variables(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class BatchStateHistoryArgs:
    def __init__(__self__, *, state: Optional[pulumi.Input[_builtins.str]] = ..., state_message: Optional[pulumi.Input[_builtins.str]] = ..., state_start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def state_start_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterClusterConfigArgs:
    def __init__(__self__, *, autoscaling_config: Optional[pulumi.Input[ClusterClusterConfigAutoscalingConfigArgs]] = ..., auxiliary_node_groups: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigAuxiliaryNodeGroupArgs]]]] = ..., bucket: Optional[pulumi.Input[_builtins.str]] = ..., cluster_tier: Optional[pulumi.Input[_builtins.str]] = ..., cluster_type: Optional[pulumi.Input[_builtins.str]] = ..., dataproc_metric_config: Optional[pulumi.Input[ClusterClusterConfigDataprocMetricConfigArgs]] = ..., encryption_config: Optional[pulumi.Input[ClusterClusterConfigEncryptionConfigArgs]] = ..., endpoint_config: Optional[pulumi.Input[ClusterClusterConfigEndpointConfigArgs]] = ..., gce_cluster_config: Optional[pulumi.Input[ClusterClusterConfigGceClusterConfigArgs]] = ..., initialization_actions: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigInitializationActionArgs]]]] = ..., lifecycle_config: Optional[pulumi.Input[ClusterClusterConfigLifecycleConfigArgs]] = ..., master_config: Optional[pulumi.Input[ClusterClusterConfigMasterConfigArgs]] = ..., metastore_config: Optional[pulumi.Input[ClusterClusterConfigMetastoreConfigArgs]] = ..., preemptible_worker_config: Optional[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigArgs]] = ..., security_config: Optional[pulumi.Input[ClusterClusterConfigSecurityConfigArgs]] = ..., software_config: Optional[pulumi.Input[ClusterClusterConfigSoftwareConfigArgs]] = ..., staging_bucket: Optional[pulumi.Input[_builtins.str]] = ..., temp_bucket: Optional[pulumi.Input[_builtins.str]] = ..., worker_config: Optional[pulumi.Input[ClusterClusterConfigWorkerConfigArgs]] = ...) -> None:
    ...
    def autoscaling_config(self, value: Optional[pulumi.Input[ClusterClusterConfigAutoscalingConfigArgs]]): # -> None:
        ...
    ...
    def auxiliary_node_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigAuxiliaryNodeGroupArgs]]]]): # -> None:
        ...
    ...
    def dataproc_metric_config(self, value: Optional[pulumi.Input[ClusterClusterConfigDataprocMetricConfigArgs]]): # -> None:
        ...
    ...
    def encryption_config(self, value: Optional[pulumi.Input[ClusterClusterConfigEncryptionConfigArgs]]): # -> None:
        ...
    ...
    def endpoint_config(self, value: Optional[pulumi.Input[ClusterClusterConfigEndpointConfigArgs]]): # -> None:
        ...
    ...
    def gce_cluster_config(self, value: Optional[pulumi.Input[ClusterClusterConfigGceClusterConfigArgs]]): # -> None:
        ...
    ...
    def initialization_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigInitializationActionArgs]]]]): # -> None:
        ...
    ...
    def lifecycle_config(self, value: Optional[pulumi.Input[ClusterClusterConfigLifecycleConfigArgs]]): # -> None:
        ...
    ...
    def master_config(self, value: Optional[pulumi.Input[ClusterClusterConfigMasterConfigArgs]]): # -> None:
        ...
    ...
    def metastore_config(self, value: Optional[pulumi.Input[ClusterClusterConfigMetastoreConfigArgs]]): # -> None:
        ...
    ...
    def preemptible_worker_config(self, value: Optional[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigArgs]]): # -> None:
        ...
    ...
    def security_config(self, value: Optional[pulumi.Input[ClusterClusterConfigSecurityConfigArgs]]): # -> None:
        ...
    ...
    def software_config(self, value: Optional[pulumi.Input[ClusterClusterConfigSoftwareConfigArgs]]): # -> None:
        ...
    ...
    @temp_bucket.setter
    def temp_bucket(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def worker_config(self, value: Optional[pulumi.Input[ClusterClusterConfigWorkerConfigArgs]]): # -> None:
        ...
...
class ClusterClusterConfigAutoscalingConfigArgs:
    ...
    @policy_uri.setter
    def policy_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterClusterConfigAuxiliaryNodeGroupArgs:
    def __init__(__self__, *, node_groups: pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigAuxiliaryNodeGroupNodeGroupArgs]]], node_group_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @node_groups.setter
    def node_groups(self, value: pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigAuxiliaryNodeGroupNodeGroupArgs]]]): # -> None:
        ...
    ...
    def node_group_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupArgs:
    def __init__(__self__, *, roles: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], name: Optional[pulumi.Input[_builtins.str]] = ..., node_group_config: Optional[pulumi.Input[ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigArgs]] = ...) -> None:
    ...
    @roles.setter
    def roles(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def node_group_config(self, value: Optional[pulumi.Input[ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigArgs]]): # -> None:
        ...
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigArgs:
    def __init__(__self__, *, accelerators: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigAcceleratorArgs]]]] = ..., disk_config: Optional[pulumi.Input[ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigDiskConfigArgs]] = ..., instance_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., min_cpu_platform: Optional[pulumi.Input[_builtins.str]] = ..., num_instances: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @accelerators.setter
    def accelerators(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigAcceleratorArgs]]]]): # -> None:
        ...
    ...
    @disk_config.setter
    def disk_config(self, value: Optional[pulumi.Input[ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigDiskConfigArgs]]): # -> None:
        ...
    ...
    def instance_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def num_instances(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigAcceleratorArgs:
    def __init__(__self__, *, accelerator_count: pulumi.Input[_builtins.int], accelerator_type: pulumi.Input[_builtins.str]) -> None:
    ...
    def accelerator_count(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    @accelerator_type.setter
    def accelerator_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigDiskConfigArgs:
    def __init__(__self__, *, boot_disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., boot_disk_type: Optional[pulumi.Input[_builtins.str]] = ..., local_ssd_interface: Optional[pulumi.Input[_builtins.str]] = ..., num_local_ssds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def boot_disk_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def local_ssd_interface(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def num_local_ssds(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ClusterClusterConfigDataprocMetricConfigArgs:
    def __init__(__self__, *, metrics: pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigDataprocMetricConfigMetricArgs]]]) -> None:
    ...
    @metrics.setter
    def metrics(self, value: pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigDataprocMetricConfigMetricArgs]]]): # -> None:
        ...
...
class ClusterClusterConfigDataprocMetricConfigMetricArgs:
    def __init__(__self__, *, metric_source: pulumi.Input[_builtins.str], metric_overrides: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def metric_source(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def metric_overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ClusterClusterConfigEndpointConfigArgs:
    def __init__(__self__, *, enable_http_port_access: pulumi.Input[_builtins.bool], http_ports: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def enable_http_port_access(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    @http_ports.setter
    def http_ports(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ClusterClusterConfigGceClusterConfigArgs:
    def __init__(__self__, *, confidential_instance_config: Optional[pulumi.Input[ClusterClusterConfigGceClusterConfigConfidentialInstanceConfigArgs]] = ..., internal_ip_only: Optional[pulumi.Input[_builtins.bool]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., node_group_affinity: Optional[pulumi.Input[ClusterClusterConfigGceClusterConfigNodeGroupAffinityArgs]] = ..., reservation_affinity: Optional[pulumi.Input[ClusterClusterConfigGceClusterConfigReservationAffinityArgs]] = ..., resource_manager_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., service_account_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., shielded_instance_config: Optional[pulumi.Input[ClusterClusterConfigGceClusterConfigShieldedInstanceConfigArgs]] = ..., subnetwork: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def confidential_instance_config(self, value: Optional[pulumi.Input[ClusterClusterConfigGceClusterConfigConfidentialInstanceConfigArgs]]): # -> None:
        ...
    ...
    def internal_ip_only(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def node_group_affinity(self, value: Optional[pulumi.Input[ClusterClusterConfigGceClusterConfigNodeGroupAffinityArgs]]): # -> None:
        ...
    ...
    def reservation_affinity(self, value: Optional[pulumi.Input[ClusterClusterConfigGceClusterConfigReservationAffinityArgs]]): # -> None:
        ...
    ...
    def shielded_instance_config(self, value: Optional[pulumi.Input[ClusterClusterConfigGceClusterConfigShieldedInstanceConfigArgs]]): # -> None:
        ...
...
class ClusterClusterConfigGceClusterConfigNodeGroupAffinityArgs:
    ...
    def node_group_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterClusterConfigGceClusterConfigReservationAffinityArgs:
    def __init__(__self__, *, consume_reservation_type: Optional[pulumi.Input[_builtins.str]] = ..., key: Optional[pulumi.Input[_builtins.str]] = ..., values: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def consume_reservation_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterClusterConfigInitializationActionArgs:
    def __init__(__self__, *, script: pulumi.Input[_builtins.str], timeout_sec: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ClusterClusterConfigLifecycleConfigArgs:
    def __init__(__self__, *, auto_delete_time: Optional[pulumi.Input[_builtins.str]] = ..., auto_stop_time: Optional[pulumi.Input[_builtins.str]] = ..., idle_delete_ttl: Optional[pulumi.Input[_builtins.str]] = ..., idle_start_time: Optional[pulumi.Input[_builtins.str]] = ..., idle_stop_ttl: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def auto_delete_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def auto_stop_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def idle_delete_ttl(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def idle_start_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def idle_stop_ttl(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterClusterConfigMasterConfigArgs:
    def __init__(__self__, *, accelerators: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigMasterConfigAcceleratorArgs]]]] = ..., disk_config: Optional[pulumi.Input[ClusterClusterConfigMasterConfigDiskConfigArgs]] = ..., image_uri: Optional[pulumi.Input[_builtins.str]] = ..., instance_flexibility_policy: Optional[pulumi.Input[ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyArgs]] = ..., instance_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., min_cpu_platform: Optional[pulumi.Input[_builtins.str]] = ..., num_instances: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @accelerators.setter
    def accelerators(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigMasterConfigAcceleratorArgs]]]]): # -> None:
        ...
    ...
    @disk_config.setter
    def disk_config(self, value: Optional[pulumi.Input[ClusterClusterConfigMasterConfigDiskConfigArgs]]): # -> None:
        ...
    ...
    def instance_flexibility_policy(self, value: Optional[pulumi.Input[ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyArgs]]): # -> None:
        ...
...
class ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyArgs:
    def __init__(__self__, *, instance_selection_lists: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListArgs]]]] = ..., instance_selection_results: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionResultArgs]]]] = ...) -> None:
    ...
    def instance_selection_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListArgs]]]]): # -> None:
        ...
    ...
    def instance_selection_results(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionResultArgs]]]]): # -> None:
        ...
...
class ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListArgs:
    def __init__(__self__, *, machine_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., rank: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def machine_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionResultArgs:
    def __init__(__self__, *, machine_type: Optional[pulumi.Input[_builtins.str]] = ..., vm_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @vm_count.setter
    def vm_count(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ClusterClusterConfigMetastoreConfigArgs:
    def __init__(__self__, *, dataproc_metastore_service: pulumi.Input[_builtins.str]) -> None:
    ...
    def dataproc_metastore_service(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ClusterClusterConfigPreemptibleWorkerConfigArgs:
    def __init__(__self__, *, disk_config: Optional[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigDiskConfigArgs]] = ..., instance_flexibility_policy: Optional[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyArgs]] = ..., instance_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., num_instances: Optional[pulumi.Input[_builtins.int]] = ..., preemptibility: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @disk_config.setter
    def disk_config(self, value: Optional[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigDiskConfigArgs]]): # -> None:
        ...
    ...
    @instance_flexibility_policy.setter
    def instance_flexibility_policy(self, value: Optional[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyArgs]]): # -> None:
        ...
    ...
    def preemptibility(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyArgs:
    def __init__(__self__, *, instance_selection_lists: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArgs]]]] = ..., instance_selection_results: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResultArgs]]]] = ..., provisioning_model_mix: Optional[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyProvisioningModelMixArgs]] = ...) -> None:
    ...
    @instance_selection_lists.setter
    def instance_selection_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArgs]]]]): # -> None:
        ...
    ...
    @instance_selection_results.setter
    def instance_selection_results(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResultArgs]]]]): # -> None:
        ...
    ...
    def provisioning_model_mix(self, value: Optional[pulumi.Input[ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyProvisioningModelMixArgs]]): # -> None:
        ...
...
class ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyProvisioningModelMixArgs:
    def __init__(__self__, *, standard_capacity_base: Optional[pulumi.Input[_builtins.int]] = ..., standard_capacity_percent_above_base: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def standard_capacity_base(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def standard_capacity_percent_above_base(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ClusterClusterConfigSecurityConfigArgs:
    def __init__(__self__, *, identity_config: Optional[pulumi.Input[ClusterClusterConfigSecurityConfigIdentityConfigArgs]] = ..., kerberos_config: Optional[pulumi.Input[ClusterClusterConfigSecurityConfigKerberosConfigArgs]] = ...) -> None:
    ...
    def identity_config(self, value: Optional[pulumi.Input[ClusterClusterConfigSecurityConfigIdentityConfigArgs]]): # -> None:
        ...
    ...
    def kerberos_config(self, value: Optional[pulumi.Input[ClusterClusterConfigSecurityConfigKerberosConfigArgs]]): # -> None:
        ...
...
class ClusterClusterConfigSecurityConfigIdentityConfigArgs:
    def __init__(__self__, *, user_service_account_mapping: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]) -> None:
    ...
    def user_service_account_mapping(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class ClusterClusterConfigSecurityConfigKerberosConfigArgs:
    def __init__(__self__, *, kms_key_uri: pulumi.Input[_builtins.str], root_principal_password_uri: pulumi.Input[_builtins.str], cross_realm_trust_admin_server: Optional[pulumi.Input[_builtins.str]] = ..., cross_realm_trust_kdc: Optional[pulumi.Input[_builtins.str]] = ..., cross_realm_trust_realm: Optional[pulumi.Input[_builtins.str]] = ..., cross_realm_trust_shared_password_uri: Optional[pulumi.Input[_builtins.str]] = ..., enable_kerberos: Optional[pulumi.Input[_builtins.bool]] = ..., kdc_db_key_uri: Optional[pulumi.Input[_builtins.str]] = ..., key_password_uri: Optional[pulumi.Input[_builtins.str]] = ..., keystore_password_uri: Optional[pulumi.Input[_builtins.str]] = ..., keystore_uri: Optional[pulumi.Input[_builtins.str]] = ..., realm: Optional[pulumi.Input[_builtins.str]] = ..., tgt_lifetime_hours: Optional[pulumi.Input[_builtins.int]] = ..., truststore_password_uri: Optional[pulumi.Input[_builtins.str]] = ..., truststore_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @kms_key_uri.setter
    def kms_key_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def root_principal_password_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def cross_realm_trust_admin_server(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def cross_realm_trust_kdc(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def cross_realm_trust_realm(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def cross_realm_trust_shared_password_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def enable_kerberos(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def kdc_db_key_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def key_password_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def keystore_password_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @keystore_uri.setter
    def keystore_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def tgt_lifetime_hours(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def truststore_password_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def truststore_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterClusterConfigSoftwareConfigArgs:
    def __init__(__self__, *, image_version: Optional[pulumi.Input[_builtins.str]] = ..., optional_components: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., override_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def image_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def optional_components(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def override_properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class ClusterClusterConfigWorkerConfigArgs:
    def __init__(__self__, *, accelerators: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigWorkerConfigAcceleratorArgs]]]] = ..., disk_config: Optional[pulumi.Input[ClusterClusterConfigWorkerConfigDiskConfigArgs]] = ..., image_uri: Optional[pulumi.Input[_builtins.str]] = ..., instance_flexibility_policy: Optional[pulumi.Input[ClusterClusterConfigWorkerConfigInstanceFlexibilityPolicyArgs]] = ..., instance_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., min_cpu_platform: Optional[pulumi.Input[_builtins.str]] = ..., min_num_instances: Optional[pulumi.Input[_builtins.int]] = ..., num_instances: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @accelerators.setter
    def accelerators(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigWorkerConfigAcceleratorArgs]]]]): # -> None:
        ...
    ...
    @disk_config.setter
    def disk_config(self, value: Optional[pulumi.Input[ClusterClusterConfigWorkerConfigDiskConfigArgs]]): # -> None:
        ...
    ...
    @instance_flexibility_policy.setter
    def instance_flexibility_policy(self, value: Optional[pulumi.Input[ClusterClusterConfigWorkerConfigInstanceFlexibilityPolicyArgs]]): # -> None:
        ...
    ...
    def min_num_instances(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ClusterClusterConfigWorkerConfigInstanceFlexibilityPolicyArgs:
    def __init__(__self__, *, instance_selection_lists: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArgs]]]] = ..., instance_selection_results: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResultArgs]]]] = ...) -> None:
    ...
    @instance_selection_lists.setter
    def instance_selection_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArgs]]]]): # -> None:
        ...
    ...
    @instance_selection_results.setter
    def instance_selection_results(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterClusterConfigWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResultArgs]]]]): # -> None:
        ...
...
class ClusterVirtualClusterConfigArgs:
    def __init__(__self__, *, auxiliary_services_config: Optional[pulumi.Input[ClusterVirtualClusterConfigAuxiliaryServicesConfigArgs]] = ..., kubernetes_cluster_config: Optional[pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigArgs]] = ..., staging_bucket: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def auxiliary_services_config(self, value: Optional[pulumi.Input[ClusterVirtualClusterConfigAuxiliaryServicesConfigArgs]]): # -> None:
        ...
    ...
    def kubernetes_cluster_config(self, value: Optional[pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigArgs]]): # -> None:
        ...
...
class ClusterVirtualClusterConfigAuxiliaryServicesConfigArgs:
    def __init__(__self__, *, metastore_config: Optional[pulumi.Input[ClusterVirtualClusterConfigAuxiliaryServicesConfigMetastoreConfigArgs]] = ..., spark_history_server_config: Optional[pulumi.Input[ClusterVirtualClusterConfigAuxiliaryServicesConfigSparkHistoryServerConfigArgs]] = ...) -> None:
    ...
    @metastore_config.setter
    def metastore_config(self, value: Optional[pulumi.Input[ClusterVirtualClusterConfigAuxiliaryServicesConfigMetastoreConfigArgs]]): # -> None:
        ...
    ...
    @spark_history_server_config.setter
    def spark_history_server_config(self, value: Optional[pulumi.Input[ClusterVirtualClusterConfigAuxiliaryServicesConfigSparkHistoryServerConfigArgs]]): # -> None:
        ...
...
class ClusterVirtualClusterConfigAuxiliaryServicesConfigMetastoreConfigArgs:
    def __init__(__self__, *, dataproc_metastore_service: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @dataproc_metastore_service.setter
    def dataproc_metastore_service(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterVirtualClusterConfigKubernetesClusterConfigArgs:
    ...
    def gke_cluster_config(self, value: pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigArgs]): # -> None:
        ...
    ...
    def kubernetes_software_config(self, value: pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigKubernetesSoftwareConfigArgs]): # -> None:
        ...
    ...
    def kubernetes_namespace(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigArgs:
    def __init__(__self__, *, gke_cluster_target: Optional[pulumi.Input[_builtins.str]] = ..., node_pool_targets: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetArgs]]]] = ...) -> None:
    ...
    def gke_cluster_target(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def node_pool_targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetArgs]]]]): # -> None:
        ...
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetArgs:
    def __init__(__self__, *, node_pool: pulumi.Input[_builtins.str], roles: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], node_pool_config: Optional[pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigArgs]] = ...) -> None:
    ...
    @node_pool.setter
    def node_pool(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def node_pool_config(self, value: Optional[pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigArgs]]): # -> None:
        ...
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigArgs:
    def __init__(__self__, *, locations: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], autoscaling: Optional[pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigAutoscalingArgs]] = ..., config: Optional[pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigConfigArgs]] = ...) -> None:
    ...
    @autoscaling.setter
    def autoscaling(self, value: Optional[pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigAutoscalingArgs]]): # -> None:
        ...
    ...
    @config.setter
    def config(self, value: Optional[pulumi.Input[ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigConfigArgs]]): # -> None:
        ...
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigAutoscalingArgs:
    def __init__(__self__, *, max_node_count: Optional[pulumi.Input[_builtins.int]] = ..., min_node_count: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigConfigArgs:
    def __init__(__self__, *, local_ssd_count: Optional[pulumi.Input[_builtins.int]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., min_cpu_platform: Optional[pulumi.Input[_builtins.str]] = ..., preemptible: Optional[pulumi.Input[_builtins.bool]] = ..., spot: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
...
class ClusterVirtualClusterConfigKubernetesClusterConfigKubernetesSoftwareConfigArgs:
    def __init__(__self__, *, component_version: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def component_version(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class GdcApplicationEnvironmentSparkApplicationEnvironmentConfigArgs:
    def __init__(__self__, *, default_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., default_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def default_properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def default_version(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class GdcServiceInstanceGdceClusterArgs:
    ...
    @gdce_cluster.setter
    def gdce_cluster(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class GdcSparkApplicationPysparkApplicationConfigArgs:
    def __init__(__self__, *, main_python_file_uri: pulumi.Input[_builtins.str], archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., python_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @main_python_file_uri.setter
    def main_python_file_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class GdcSparkApplicationSparkRApplicationConfigArgs:
    def __init__(__self__, *, main_r_file_uri: pulumi.Input[_builtins.str], archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @main_r_file_uri.setter
    def main_r_file_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class GdcSparkApplicationSparkSqlApplicationConfigArgs:
    def __init__(__self__, *, jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., query_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., query_list: Optional[pulumi.Input[GdcSparkApplicationSparkSqlApplicationConfigQueryListArgs]] = ..., script_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @query_list.setter
    def query_list(self, value: Optional[pulumi.Input[GdcSparkApplicationSparkSqlApplicationConfigQueryListArgs]]): # -> None:
        ...
    ...
    def script_variables(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class GdcSparkApplicationSparkSqlApplicationConfigQueryListArgs:
    def __init__(__self__, *, queries: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @queries.setter
    def queries(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class JobHadoopConfigArgs:
    def __init__(__self__, *, archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logging_config: Optional[pulumi.Input[JobHadoopConfigLoggingConfigArgs]] = ..., main_class: Optional[pulumi.Input[_builtins.str]] = ..., main_jar_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def logging_config(self, value: Optional[pulumi.Input[JobHadoopConfigLoggingConfigArgs]]): # -> None:
        ...
...
class JobHadoopConfigLoggingConfigArgs:
    def __init__(__self__, *, driver_log_levels: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]) -> None:
    ...
    def driver_log_levels(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class JobHiveConfigArgs:
    def __init__(__self__, *, continue_on_failure: Optional[pulumi.Input[_builtins.bool]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., query_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., query_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., script_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def continue_on_failure(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @query_lists.setter
    def query_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class JobPigConfigArgs:
    def __init__(__self__, *, continue_on_failure: Optional[pulumi.Input[_builtins.bool]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logging_config: Optional[pulumi.Input[JobPigConfigLoggingConfigArgs]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., query_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., query_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., script_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[JobPigConfigLoggingConfigArgs]]): # -> None:
        ...
...
class JobPlacementArgs:
    def __init__(__self__, *, cluster_name: pulumi.Input[_builtins.str], cluster_uuid: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JobPrestoConfigArgs:
    def __init__(__self__, *, client_tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., continue_on_failure: Optional[pulumi.Input[_builtins.bool]] = ..., logging_config: Optional[pulumi.Input[JobPrestoConfigLoggingConfigArgs]] = ..., output_format: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., query_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., query_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @client_tags.setter
    def client_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[JobPrestoConfigLoggingConfigArgs]]): # -> None:
        ...
...
class JobPysparkConfigArgs:
    def __init__(__self__, *, main_python_file_uri: pulumi.Input[_builtins.str], archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logging_config: Optional[pulumi.Input[JobPysparkConfigLoggingConfigArgs]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., python_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[JobPysparkConfigLoggingConfigArgs]]): # -> None:
        ...
...
class JobReferenceArgs:
    def __init__(__self__, *, job_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JobSchedulingArgs:
    def __init__(__self__, *, max_failures_per_hour: pulumi.Input[_builtins.int], max_failures_total: pulumi.Input[_builtins.int]) -> None:
    ...
    def max_failures_per_hour(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
    ...
    def max_failures_total(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class JobSparkConfigArgs:
    def __init__(__self__, *, archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logging_config: Optional[pulumi.Input[JobSparkConfigLoggingConfigArgs]] = ..., main_class: Optional[pulumi.Input[_builtins.str]] = ..., main_jar_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[JobSparkConfigLoggingConfigArgs]]): # -> None:
        ...
...
class JobSparksqlConfigArgs:
    def __init__(__self__, *, jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logging_config: Optional[pulumi.Input[JobSparksqlConfigLoggingConfigArgs]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., query_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., query_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., script_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[JobSparksqlConfigLoggingConfigArgs]]): # -> None:
        ...
...
@pulumi.input_type
class JobStatusArgs:
    def __init__(__self__, *, details: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ..., state_start_time: Optional[pulumi.Input[_builtins.str]] = ..., substate: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @substate.setter
    def substate(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MetastoreFederationBackendMetastoreArgs:
    def __init__(__self__, *, metastore_type: pulumi.Input[_builtins.str], name: pulumi.Input[_builtins.str], rank: pulumi.Input[_builtins.str]) -> None:
    ...
    def metastore_type(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @rank.setter
    def rank(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class MetastoreServiceHiveMetastoreConfigArgs:
    def __init__(__self__, *, version: pulumi.Input[_builtins.str], auxiliary_versions: Optional[pulumi.Input[Sequence[pulumi.Input[MetastoreServiceHiveMetastoreConfigAuxiliaryVersionArgs]]]] = ..., config_overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., endpoint_protocol: Optional[pulumi.Input[_builtins.str]] = ..., kerberos_config: Optional[pulumi.Input[MetastoreServiceHiveMetastoreConfigKerberosConfigArgs]] = ...) -> None:
    ...
    def auxiliary_versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MetastoreServiceHiveMetastoreConfigAuxiliaryVersionArgs]]]]): # -> None:
        ...
    ...
    def config_overrides(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def endpoint_protocol(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @kerberos_config.setter
    def kerberos_config(self, value: Optional[pulumi.Input[MetastoreServiceHiveMetastoreConfigKerberosConfigArgs]]): # -> None:
        ...
...
class MetastoreServiceHiveMetastoreConfigAuxiliaryVersionArgs:
    def __init__(__self__, *, key: pulumi.Input[_builtins.str], version: pulumi.Input[_builtins.str], config_overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class MetastoreServiceHiveMetastoreConfigKerberosConfigArgs:
    def __init__(__self__, *, keytab: pulumi.Input[MetastoreServiceHiveMetastoreConfigKerberosConfigKeytabArgs], krb5_config_gcs_uri: pulumi.Input[_builtins.str], principal: pulumi.Input[_builtins.str]) -> None:
    ...
    @keytab.setter
    def keytab(self, value: pulumi.Input[MetastoreServiceHiveMetastoreConfigKerberosConfigKeytabArgs]): # -> None:
        ...
    ...
    def krb5_config_gcs_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class MetastoreServiceHiveMetastoreConfigKerberosConfigKeytabArgs:
    ...
    @cloud_secret.setter
    def cloud_secret(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class MetastoreServiceMaintenanceWindowArgs:
    def __init__(__self__, *, day_of_week: pulumi.Input[_builtins.str], hour_of_day: pulumi.Input[_builtins.int]) -> None:
    ...
    @hour_of_day.setter
    def hour_of_day(self, value: pulumi.Input[_builtins.int]): # -> None:
        ...
...
class MetastoreServiceMetadataIntegrationArgs:
    def __init__(__self__, *, data_catalog_config: pulumi.Input[MetastoreServiceMetadataIntegrationDataCatalogConfigArgs]) -> None:
    ...
    def data_catalog_config(self, value: pulumi.Input[MetastoreServiceMetadataIntegrationDataCatalogConfigArgs]): # -> None:
        ...
...
class MetastoreServiceNetworkConfigArgs:
    def __init__(__self__, *, consumers: pulumi.Input[Sequence[pulumi.Input[MetastoreServiceNetworkConfigConsumerArgs]]], custom_routes_enabled: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @consumers.setter
    def consumers(self, value: pulumi.Input[Sequence[pulumi.Input[MetastoreServiceNetworkConfigConsumerArgs]]]): # -> None:
        ...
    ...
    def custom_routes_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class MetastoreServiceNetworkConfigConsumerArgs:
    def __init__(__self__, *, subnetwork: pulumi.Input[_builtins.str], endpoint_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class MetastoreServiceScalingConfigArgs:
    def __init__(__self__, *, autoscaling_config: Optional[pulumi.Input[MetastoreServiceScalingConfigAutoscalingConfigArgs]] = ..., instance_size: Optional[pulumi.Input[_builtins.str]] = ..., scaling_factor: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    @autoscaling_config.setter
    def autoscaling_config(self, value: Optional[pulumi.Input[MetastoreServiceScalingConfigAutoscalingConfigArgs]]): # -> None:
        ...
    ...
    def instance_size(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MetastoreServiceScalingConfigAutoscalingConfigArgs:
    def __init__(__self__, *, autoscaling_enabled: Optional[pulumi.Input[_builtins.bool]] = ..., autoscaling_factor: Optional[pulumi.Input[_builtins.float]] = ..., limit_config: Optional[pulumi.Input[MetastoreServiceScalingConfigAutoscalingConfigLimitConfigArgs]] = ...) -> None:
    ...
    def autoscaling_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def autoscaling_factor(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    @limit_config.setter
    def limit_config(self, value: Optional[pulumi.Input[MetastoreServiceScalingConfigAutoscalingConfigLimitConfigArgs]]): # -> None:
        ...
...
class MetastoreServiceScalingConfigAutoscalingConfigLimitConfigArgs:
    def __init__(__self__, *, max_scaling_factor: Optional[pulumi.Input[_builtins.float]] = ..., min_scaling_factor: Optional[pulumi.Input[_builtins.float]] = ...) -> None:
    ...
    def max_scaling_factor(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def min_scaling_factor(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
...
class MetastoreServiceScheduledBackupArgs:
    def __init__(__self__, *, backup_location: pulumi.Input[_builtins.str], cron_schedule: Optional[pulumi.Input[_builtins.str]] = ..., enabled: Optional[pulumi.Input[_builtins.bool]] = ..., time_zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def backup_location(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def cron_schedule(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class MetastoreServiceTelemetryConfigArgs:
    def __init__(__self__, *, log_format: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SessionTemplateEnvironmentConfigArgs:
    def __init__(__self__, *, execution_config: Optional[pulumi.Input[SessionTemplateEnvironmentConfigExecutionConfigArgs]] = ..., peripherals_config: Optional[pulumi.Input[SessionTemplateEnvironmentConfigPeripheralsConfigArgs]] = ...) -> None:
    ...
    @execution_config.setter
    def execution_config(self, value: Optional[pulumi.Input[SessionTemplateEnvironmentConfigExecutionConfigArgs]]): # -> None:
        ...
    ...
    @peripherals_config.setter
    def peripherals_config(self, value: Optional[pulumi.Input[SessionTemplateEnvironmentConfigPeripheralsConfigArgs]]): # -> None:
        ...
...
class SessionTemplateEnvironmentConfigExecutionConfigArgs:
    def __init__(__self__, *, authentication_config: Optional[pulumi.Input[SessionTemplateEnvironmentConfigExecutionConfigAuthenticationConfigArgs]] = ..., idle_ttl: Optional[pulumi.Input[_builtins.str]] = ..., kms_key: Optional[pulumi.Input[_builtins.str]] = ..., network_tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., staging_bucket: Optional[pulumi.Input[_builtins.str]] = ..., subnetwork_uri: Optional[pulumi.Input[_builtins.str]] = ..., ttl: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @authentication_config.setter
    def authentication_config(self, value: Optional[pulumi.Input[SessionTemplateEnvironmentConfigExecutionConfigAuthenticationConfigArgs]]): # -> None:
        ...
    ...
    @idle_ttl.setter
    def idle_ttl(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SessionTemplateEnvironmentConfigPeripheralsConfigArgs:
    def __init__(__self__, *, metastore_service: Optional[pulumi.Input[_builtins.str]] = ..., spark_history_server_config: Optional[pulumi.Input[SessionTemplateEnvironmentConfigPeripheralsConfigSparkHistoryServerConfigArgs]] = ...) -> None:
    ...
    @spark_history_server_config.setter
    def spark_history_server_config(self, value: Optional[pulumi.Input[SessionTemplateEnvironmentConfigPeripheralsConfigSparkHistoryServerConfigArgs]]): # -> None:
        ...
...
class SessionTemplateJupyterSessionArgs:
    def __init__(__self__, *, display_name: Optional[pulumi.Input[_builtins.str]] = ..., kernel: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @kernel.setter
    def kernel(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SessionTemplateRuntimeConfigArgs:
    def __init__(__self__, *, container_image: Optional[pulumi.Input[_builtins.str]] = ..., effective_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkflowTemplateEncryptionConfigArgs:
    def __init__(__self__, *, kms_key: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkflowTemplateJobArgs:
    def __init__(__self__, *, step_id: pulumi.Input[_builtins.str], hadoop_job: Optional[pulumi.Input[WorkflowTemplateJobHadoopJobArgs]] = ..., hive_job: Optional[pulumi.Input[WorkflowTemplateJobHiveJobArgs]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., pig_job: Optional[pulumi.Input[WorkflowTemplateJobPigJobArgs]] = ..., prerequisite_step_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., presto_job: Optional[pulumi.Input[WorkflowTemplateJobPrestoJobArgs]] = ..., pyspark_job: Optional[pulumi.Input[WorkflowTemplateJobPysparkJobArgs]] = ..., scheduling: Optional[pulumi.Input[WorkflowTemplateJobSchedulingArgs]] = ..., spark_job: Optional[pulumi.Input[WorkflowTemplateJobSparkJobArgs]] = ..., spark_r_job: Optional[pulumi.Input[WorkflowTemplateJobSparkRJobArgs]] = ..., spark_sql_job: Optional[pulumi.Input[WorkflowTemplateJobSparkSqlJobArgs]] = ...) -> None:
    ...
    @step_id.setter
    def step_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @hadoop_job.setter
    def hadoop_job(self, value: Optional[pulumi.Input[WorkflowTemplateJobHadoopJobArgs]]): # -> None:
        ...
    ...
    @hive_job.setter
    def hive_job(self, value: Optional[pulumi.Input[WorkflowTemplateJobHiveJobArgs]]): # -> None:
        ...
    ...
    @pig_job.setter
    def pig_job(self, value: Optional[pulumi.Input[WorkflowTemplateJobPigJobArgs]]): # -> None:
        ...
    ...
    def prerequisite_step_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @presto_job.setter
    def presto_job(self, value: Optional[pulumi.Input[WorkflowTemplateJobPrestoJobArgs]]): # -> None:
        ...
    ...
    @pyspark_job.setter
    def pyspark_job(self, value: Optional[pulumi.Input[WorkflowTemplateJobPysparkJobArgs]]): # -> None:
        ...
    ...
    @scheduling.setter
    def scheduling(self, value: Optional[pulumi.Input[WorkflowTemplateJobSchedulingArgs]]): # -> None:
        ...
    ...
    @spark_job.setter
    def spark_job(self, value: Optional[pulumi.Input[WorkflowTemplateJobSparkJobArgs]]): # -> None:
        ...
    ...
    @spark_r_job.setter
    def spark_r_job(self, value: Optional[pulumi.Input[WorkflowTemplateJobSparkRJobArgs]]): # -> None:
        ...
    ...
    def spark_sql_job(self, value: Optional[pulumi.Input[WorkflowTemplateJobSparkSqlJobArgs]]): # -> None:
        ...
...
class WorkflowTemplateJobHadoopJobArgs:
    def __init__(__self__, *, archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logging_config: Optional[pulumi.Input[WorkflowTemplateJobHadoopJobLoggingConfigArgs]] = ..., main_class: Optional[pulumi.Input[_builtins.str]] = ..., main_jar_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[WorkflowTemplateJobHadoopJobLoggingConfigArgs]]): # -> None:
        ...
...
class WorkflowTemplateJobHadoopJobLoggingConfigArgs:
    def __init__(__self__, *, driver_log_levels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @driver_log_levels.setter
    def driver_log_levels(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class WorkflowTemplateJobHiveJobArgs:
    def __init__(__self__, *, continue_on_failure: Optional[pulumi.Input[_builtins.bool]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., query_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., query_list: Optional[pulumi.Input[WorkflowTemplateJobHiveJobQueryListArgs]] = ..., script_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @query_list.setter
    def query_list(self, value: Optional[pulumi.Input[WorkflowTemplateJobHiveJobQueryListArgs]]): # -> None:
        ...
...
class WorkflowTemplateJobPigJobArgs:
    def __init__(__self__, *, continue_on_failure: Optional[pulumi.Input[_builtins.bool]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logging_config: Optional[pulumi.Input[WorkflowTemplateJobPigJobLoggingConfigArgs]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., query_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., query_list: Optional[pulumi.Input[WorkflowTemplateJobPigJobQueryListArgs]] = ..., script_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[WorkflowTemplateJobPigJobLoggingConfigArgs]]): # -> None:
        ...
    ...
    @query_list.setter
    def query_list(self, value: Optional[pulumi.Input[WorkflowTemplateJobPigJobQueryListArgs]]): # -> None:
        ...
...
class WorkflowTemplateJobPrestoJobArgs:
    def __init__(__self__, *, client_tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., continue_on_failure: Optional[pulumi.Input[_builtins.bool]] = ..., logging_config: Optional[pulumi.Input[WorkflowTemplateJobPrestoJobLoggingConfigArgs]] = ..., output_format: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., query_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., query_list: Optional[pulumi.Input[WorkflowTemplateJobPrestoJobQueryListArgs]] = ...) -> None:
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[WorkflowTemplateJobPrestoJobLoggingConfigArgs]]): # -> None:
        ...
    ...
    @query_list.setter
    def query_list(self, value: Optional[pulumi.Input[WorkflowTemplateJobPrestoJobQueryListArgs]]): # -> None:
        ...
...
class WorkflowTemplateJobPysparkJobArgs:
    def __init__(__self__, *, main_python_file_uri: pulumi.Input[_builtins.str], archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logging_config: Optional[pulumi.Input[WorkflowTemplateJobPysparkJobLoggingConfigArgs]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., python_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[WorkflowTemplateJobPysparkJobLoggingConfigArgs]]): # -> None:
        ...
...
class WorkflowTemplateJobSchedulingArgs:
    def __init__(__self__, *, max_failures_per_hour: Optional[pulumi.Input[_builtins.int]] = ..., max_failures_total: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @max_failures_per_hour.setter
    def max_failures_per_hour(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @max_failures_total.setter
    def max_failures_total(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class WorkflowTemplateJobSparkJobArgs:
    def __init__(__self__, *, archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logging_config: Optional[pulumi.Input[WorkflowTemplateJobSparkJobLoggingConfigArgs]] = ..., main_class: Optional[pulumi.Input[_builtins.str]] = ..., main_jar_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[WorkflowTemplateJobSparkJobLoggingConfigArgs]]): # -> None:
        ...
...
class WorkflowTemplateJobSparkRJobArgs:
    def __init__(__self__, *, main_r_file_uri: pulumi.Input[_builtins.str], archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., args: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logging_config: Optional[pulumi.Input[WorkflowTemplateJobSparkRJobLoggingConfigArgs]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[WorkflowTemplateJobSparkRJobLoggingConfigArgs]]): # -> None:
        ...
...
class WorkflowTemplateJobSparkSqlJobArgs:
    def __init__(__self__, *, jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., logging_config: Optional[pulumi.Input[WorkflowTemplateJobSparkSqlJobLoggingConfigArgs]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., query_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., query_list: Optional[pulumi.Input[WorkflowTemplateJobSparkSqlJobQueryListArgs]] = ..., script_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @logging_config.setter
    def logging_config(self, value: Optional[pulumi.Input[WorkflowTemplateJobSparkSqlJobLoggingConfigArgs]]): # -> None:
        ...
    ...
    @query_list.setter
    def query_list(self, value: Optional[pulumi.Input[WorkflowTemplateJobSparkSqlJobQueryListArgs]]): # -> None:
        ...
...
class WorkflowTemplateParameterArgs:
    def __init__(__self__, *, fields: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], name: pulumi.Input[_builtins.str], description: Optional[pulumi.Input[_builtins.str]] = ..., validation: Optional[pulumi.Input[WorkflowTemplateParameterValidationArgs]] = ...) -> None:
    ...
    @validation.setter
    def validation(self, value: Optional[pulumi.Input[WorkflowTemplateParameterValidationArgs]]): # -> None:
        ...
...
class WorkflowTemplateParameterValidationArgs:
    def __init__(__self__, *, regex: Optional[pulumi.Input[WorkflowTemplateParameterValidationRegexArgs]] = ..., values: Optional[pulumi.Input[WorkflowTemplateParameterValidationValuesArgs]] = ...) -> None:
    ...
    @regex.setter
    def regex(self, value: Optional[pulumi.Input[WorkflowTemplateParameterValidationRegexArgs]]): # -> None:
        ...
    ...
    @values.setter
    def values(self, value: Optional[pulumi.Input[WorkflowTemplateParameterValidationValuesArgs]]): # -> None:
        ...
...
class WorkflowTemplateParameterValidationRegexArgs:
    def __init__(__self__, *, regexes: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @regexes.setter
    def regexes(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class WorkflowTemplatePlacementArgs:
    def __init__(__self__, *, cluster_selector: Optional[pulumi.Input[WorkflowTemplatePlacementClusterSelectorArgs]] = ..., managed_cluster: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterArgs]] = ...) -> None:
    ...
    def cluster_selector(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementClusterSelectorArgs]]): # -> None:
        ...
    ...
    def managed_cluster(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterArgs]]): # -> None:
        ...
...
class WorkflowTemplatePlacementClusterSelectorArgs:
    def __init__(__self__, *, cluster_labels: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]], zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cluster_labels(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterArgs:
    def __init__(__self__, *, cluster_name: pulumi.Input[_builtins.str], config: pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigArgs], labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @config.setter
    def config(self, value: pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigArgs]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigArgs:
    def __init__(__self__, *, autoscaling_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigAutoscalingConfigArgs]] = ..., encryption_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigEncryptionConfigArgs]] = ..., endpoint_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigEndpointConfigArgs]] = ..., gce_cluster_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigArgs]] = ..., gke_cluster_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigArgs]] = ..., initialization_actions: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigInitializationActionArgs]]]] = ..., lifecycle_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigLifecycleConfigArgs]] = ..., master_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigMasterConfigArgs]] = ..., metastore_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigMetastoreConfigArgs]] = ..., secondary_worker_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigArgs]] = ..., security_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecurityConfigArgs]] = ..., software_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSoftwareConfigArgs]] = ..., staging_bucket: Optional[pulumi.Input[_builtins.str]] = ..., temp_bucket: Optional[pulumi.Input[_builtins.str]] = ..., worker_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigWorkerConfigArgs]] = ...) -> None:
    ...
    @autoscaling_config.setter
    def autoscaling_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigAutoscalingConfigArgs]]): # -> None:
        ...
    ...
    @encryption_config.setter
    def encryption_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigEncryptionConfigArgs]]): # -> None:
        ...
    ...
    @endpoint_config.setter
    def endpoint_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigEndpointConfigArgs]]): # -> None:
        ...
    ...
    @gce_cluster_config.setter
    def gce_cluster_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigArgs]]): # -> None:
        ...
    ...
    @gke_cluster_config.setter
    def gke_cluster_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigArgs]]): # -> None:
        ...
    ...
    @initialization_actions.setter
    def initialization_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigInitializationActionArgs]]]]): # -> None:
        ...
    ...
    @lifecycle_config.setter
    def lifecycle_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigLifecycleConfigArgs]]): # -> None:
        ...
    ...
    @master_config.setter
    def master_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigMasterConfigArgs]]): # -> None:
        ...
    ...
    @metastore_config.setter
    def metastore_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigMetastoreConfigArgs]]): # -> None:
        ...
    ...
    def secondary_worker_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigArgs]]): # -> None:
        ...
    ...
    @security_config.setter
    def security_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecurityConfigArgs]]): # -> None:
        ...
    ...
    @software_config.setter
    def software_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSoftwareConfigArgs]]): # -> None:
        ...
    ...
    @worker_config.setter
    def worker_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigWorkerConfigArgs]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigEncryptionConfigArgs:
    def __init__(__self__, *, gce_pd_kms_key_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def gce_pd_kms_key_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigEndpointConfigArgs:
    def __init__(__self__, *, enable_http_port_access: Optional[pulumi.Input[_builtins.bool]] = ..., http_ports: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @enable_http_port_access.setter
    def enable_http_port_access(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigArgs:
    def __init__(__self__, *, internal_ip_only: Optional[pulumi.Input[_builtins.bool]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., network: Optional[pulumi.Input[_builtins.str]] = ..., node_group_affinity: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinityArgs]] = ..., private_ipv6_google_access: Optional[pulumi.Input[_builtins.str]] = ..., reservation_affinity: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigReservationAffinityArgs]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., service_account_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., shielded_instance_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigShieldedInstanceConfigArgs]] = ..., subnetwork: Optional[pulumi.Input[_builtins.str]] = ..., tags: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., zone: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @node_group_affinity.setter
    def node_group_affinity(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinityArgs]]): # -> None:
        ...
    ...
    @reservation_affinity.setter
    def reservation_affinity(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigReservationAffinityArgs]]): # -> None:
        ...
    ...
    @shielded_instance_config.setter
    def shielded_instance_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigShieldedInstanceConfigArgs]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinityArgs:
    ...
    @node_group.setter
    def node_group(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigArgs:
    def __init__(__self__, *, namespaced_gke_deployment_target: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetArgs]] = ...) -> None:
    ...
    def namespaced_gke_deployment_target(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetArgs]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetArgs:
    def __init__(__self__, *, cluster_namespace: Optional[pulumi.Input[_builtins.str]] = ..., target_gke_cluster: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cluster_namespace(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def target_gke_cluster(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigInitializationActionArgs:
    def __init__(__self__, *, executable_file: Optional[pulumi.Input[_builtins.str]] = ..., execution_timeout: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def executable_file(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigLifecycleConfigArgs:
    def __init__(__self__, *, auto_delete_time: Optional[pulumi.Input[_builtins.str]] = ..., auto_delete_ttl: Optional[pulumi.Input[_builtins.str]] = ..., idle_delete_ttl: Optional[pulumi.Input[_builtins.str]] = ..., idle_start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def auto_delete_ttl(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigArgs:
    def __init__(__self__, *, accelerators: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorArgs]]]] = ..., disk_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfigArgs]] = ..., image: Optional[pulumi.Input[_builtins.str]] = ..., instance_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., is_preemptible: Optional[pulumi.Input[_builtins.bool]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., managed_group_configs: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfigArgs]]]] = ..., min_cpu_platform: Optional[pulumi.Input[_builtins.str]] = ..., num_instances: Optional[pulumi.Input[_builtins.int]] = ..., preemptibility: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @accelerators.setter
    def accelerators(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorArgs]]]]): # -> None:
        ...
    ...
    @disk_config.setter
    def disk_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfigArgs]]): # -> None:
        ...
    ...
    def is_preemptible(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def managed_group_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfigArgs]]]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorArgs:
    def __init__(__self__, *, accelerator_count: Optional[pulumi.Input[_builtins.int]] = ..., accelerator_type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfigArgs:
    def __init__(__self__, *, boot_disk_size_gb: Optional[pulumi.Input[_builtins.int]] = ..., boot_disk_type: Optional[pulumi.Input[_builtins.str]] = ..., num_local_ssds: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfigArgs:
    def __init__(__self__, *, instance_group_manager_name: Optional[pulumi.Input[_builtins.str]] = ..., instance_template_name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def instance_group_manager_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def instance_template_name(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigArgs:
    def __init__(__self__, *, accelerators: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigAcceleratorArgs]]]] = ..., disk_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfigArgs]] = ..., image: Optional[pulumi.Input[_builtins.str]] = ..., instance_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., is_preemptible: Optional[pulumi.Input[_builtins.bool]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., managed_group_configs: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigManagedGroupConfigArgs]]]] = ..., min_cpu_platform: Optional[pulumi.Input[_builtins.str]] = ..., num_instances: Optional[pulumi.Input[_builtins.int]] = ..., preemptibility: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @accelerators.setter
    def accelerators(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigAcceleratorArgs]]]]): # -> None:
        ...
    ...
    @disk_config.setter
    def disk_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfigArgs]]): # -> None:
        ...
    ...
    @managed_group_configs.setter
    def managed_group_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigManagedGroupConfigArgs]]]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigSecurityConfigArgs:
    def __init__(__self__, *, kerberos_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecurityConfigKerberosConfigArgs]] = ...) -> None:
    ...
    @kerberos_config.setter
    def kerberos_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigSecurityConfigKerberosConfigArgs]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigSecurityConfigKerberosConfigArgs:
    def __init__(__self__, *, cross_realm_trust_admin_server: Optional[pulumi.Input[_builtins.str]] = ..., cross_realm_trust_kdc: Optional[pulumi.Input[_builtins.str]] = ..., cross_realm_trust_realm: Optional[pulumi.Input[_builtins.str]] = ..., cross_realm_trust_shared_password: Optional[pulumi.Input[_builtins.str]] = ..., enable_kerberos: Optional[pulumi.Input[_builtins.bool]] = ..., kdc_db_key: Optional[pulumi.Input[_builtins.str]] = ..., key_password: Optional[pulumi.Input[_builtins.str]] = ..., keystore: Optional[pulumi.Input[_builtins.str]] = ..., keystore_password: Optional[pulumi.Input[_builtins.str]] = ..., kms_key: Optional[pulumi.Input[_builtins.str]] = ..., realm: Optional[pulumi.Input[_builtins.str]] = ..., root_principal_password: Optional[pulumi.Input[_builtins.str]] = ..., tgt_lifetime_hours: Optional[pulumi.Input[_builtins.int]] = ..., truststore: Optional[pulumi.Input[_builtins.str]] = ..., truststore_password: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def cross_realm_trust_shared_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @kdc_db_key.setter
    def kdc_db_key(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @key_password.setter
    def key_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @keystore.setter
    def keystore(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def keystore_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def root_principal_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @truststore.setter
    def truststore(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def truststore_password(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class WorkflowTemplatePlacementManagedClusterConfigSoftwareConfigArgs:
    def __init__(__self__, *, image_version: Optional[pulumi.Input[_builtins.str]] = ..., optional_components: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class WorkflowTemplatePlacementManagedClusterConfigWorkerConfigArgs:
    def __init__(__self__, *, accelerators: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAcceleratorArgs]]]] = ..., disk_config: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigArgs]] = ..., image: Optional[pulumi.Input[_builtins.str]] = ..., instance_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., is_preemptible: Optional[pulumi.Input[_builtins.bool]] = ..., machine_type: Optional[pulumi.Input[_builtins.str]] = ..., managed_group_configs: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfigArgs]]]] = ..., min_cpu_platform: Optional[pulumi.Input[_builtins.str]] = ..., num_instances: Optional[pulumi.Input[_builtins.int]] = ..., preemptibility: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @accelerators.setter
    def accelerators(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAcceleratorArgs]]]]): # -> None:
        ...
    ...
    @disk_config.setter
    def disk_config(self, value: Optional[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigArgs]]): # -> None:
        ...
    ...
    @managed_group_configs.setter
    def managed_group_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfigArgs]]]]): # -> None:
        ...
