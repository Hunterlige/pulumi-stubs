...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DomainMappingMetadata', 'DomainMappingSpec', 'DomainMappingStatus', 'DomainMappingStatusCondition', 'DomainMappingStatusResourceRecord', 'IamBindingCondition', 'IamMemberCondition', 'ServiceMetadata', 'ServiceStatus', 'ServiceStatusCondition', 'ServiceStatusTraffic', 'ServiceTemplate', 'ServiceTemplateMetadata', 'ServiceTemplateSpec', 'ServiceTemplateSpecContainer', 'ServiceTemplateSpecContainerEnv', 'ServiceTemplateSpecContainerEnvFrom', 'ServiceTemplateSpecContainerEnvFromConfigMapRef', ..., 'ServiceTemplateSpecContainerEnvFromSecretRef', ..., 'ServiceTemplateSpecContainerEnvValueFrom', ..., 'ServiceTemplateSpecContainerLivenessProbe', 'ServiceTemplateSpecContainerLivenessProbeGrpc', 'ServiceTemplateSpecContainerLivenessProbeHttpGet', ..., 'ServiceTemplateSpecContainerPort', 'ServiceTemplateSpecContainerReadinessProbe', 'ServiceTemplateSpecContainerReadinessProbeGrpc', 'ServiceTemplateSpecContainerReadinessProbeHttpGet', 'ServiceTemplateSpecContainerResources', 'ServiceTemplateSpecContainerStartupProbe', 'ServiceTemplateSpecContainerStartupProbeGrpc', 'ServiceTemplateSpecContainerStartupProbeHttpGet', ..., 'ServiceTemplateSpecContainerStartupProbeTcpSocket', 'ServiceTemplateSpecContainerVolumeMount', 'ServiceTemplateSpecVolume', 'ServiceTemplateSpecVolumeCsi', 'ServiceTemplateSpecVolumeEmptyDir', 'ServiceTemplateSpecVolumeNfs', 'ServiceTemplateSpecVolumeSecret', 'ServiceTemplateSpecVolumeSecretItem', 'ServiceTraffic', 'GetServiceMetadataResult', 'GetServiceStatusResult', 'GetServiceStatusConditionResult', 'GetServiceStatusTrafficResult', 'GetServiceTemplateResult', 'GetServiceTemplateMetadataResult', 'GetServiceTemplateSpecResult', 'GetServiceTemplateSpecContainerResult', 'GetServiceTemplateSpecContainerEnvResult', 'GetServiceTemplateSpecContainerEnvFromResult', ..., ..., ..., ..., 'GetServiceTemplateSpecContainerEnvValueFromResult', ..., 'GetServiceTemplateSpecContainerLivenessProbeResult', ..., ..., ..., 'GetServiceTemplateSpecContainerPortResult', ..., ..., ..., 'GetServiceTemplateSpecContainerResourceResult', 'GetServiceTemplateSpecContainerStartupProbeResult', ..., ..., ..., ..., 'GetServiceTemplateSpecContainerVolumeMountResult', 'GetServiceTemplateSpecVolumeResult', 'GetServiceTemplateSpecVolumeCsiResult', 'GetServiceTemplateSpecVolumeEmptyDirResult', 'GetServiceTemplateSpecVolumeNfResult', 'GetServiceTemplateSpecVolumeSecretResult', 'GetServiceTemplateSpecVolumeSecretItemResult', 'GetServiceTrafficResult']
@pulumi.output_type
class DomainMappingMetadata(dict):
    ...
    def __init__(__self__, *, namespace: _builtins.str, annotations: Optional[Mapping[str, _builtins.str]] = ..., effective_annotations: Optional[Mapping[str, _builtins.str]] = ..., effective_labels: Optional[Mapping[str, _builtins.str]] = ..., generation: Optional[_builtins.int] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., pulumi_labels: Optional[Mapping[str, _builtins.str]] = ..., resource_version: Optional[_builtins.str] = ..., self_link: Optional[_builtins.str] = ..., uid: Optional[_builtins.str] = ...) -> None:
...
class DomainMappingSpec(dict):
    ...
    def __init__(__self__, *, route_name: _builtins.str, certificate_mode: Optional[_builtins.str] = ..., force_override: Optional[_builtins.bool] = ...) -> None:
...
class DomainMappingStatus(dict):
    ...
    def __init__(__self__, *, conditions: Optional[Sequence[outputs.DomainMappingStatusCondition]] = ..., mapped_route_name: Optional[_builtins.str] = ..., observed_generation: Optional[_builtins.int] = ..., resource_records: Optional[Sequence[outputs.DomainMappingStatusResourceRecord]] = ...) -> None:
...
class DomainMappingStatusCondition(dict):
    def __init__(__self__, *, message: Optional[_builtins.str] = ..., reason: Optional[_builtins.str] = ..., status: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class ServiceMetadata(dict):
    ...
    def __init__(__self__, *, annotations: Optional[Mapping[str, _builtins.str]] = ..., effective_annotations: Optional[Mapping[str, _builtins.str]] = ..., effective_labels: Optional[Mapping[str, _builtins.str]] = ..., generation: Optional[_builtins.int] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., namespace: Optional[_builtins.str] = ..., pulumi_labels: Optional[Mapping[str, _builtins.str]] = ..., resource_version: Optional[_builtins.str] = ..., self_link: Optional[_builtins.str] = ..., uid: Optional[_builtins.str] = ...) -> None:
...
class ServiceStatus(dict):
    ...
    def __init__(__self__, *, conditions: Optional[Sequence[outputs.ServiceStatusCondition]] = ..., latest_created_revision_name: Optional[_builtins.str] = ..., latest_ready_revision_name: Optional[_builtins.str] = ..., observed_generation: Optional[_builtins.int] = ..., traffics: Optional[Sequence[outputs.ServiceStatusTraffic]] = ..., url: Optional[_builtins.str] = ...) -> None:
...
class ServiceStatusTraffic(dict):
    ...
    def __init__(__self__, *, latest_revision: Optional[_builtins.bool] = ..., percent: Optional[_builtins.int] = ..., revision_name: Optional[_builtins.str] = ..., tag: Optional[_builtins.str] = ..., url: Optional[_builtins.str] = ...) -> None:
...
class ServiceTemplate(dict):
    def __init__(__self__, *, metadata: Optional[outputs.ServiceTemplateMetadata] = ..., spec: Optional[outputs.ServiceTemplateSpec] = ...) -> None:
...
class ServiceTemplateMetadata(dict):
    ...
    def __init__(__self__, *, annotations: Optional[Mapping[str, _builtins.str]] = ..., generation: Optional[_builtins.int] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., name: Optional[_builtins.str] = ..., namespace: Optional[_builtins.str] = ..., resource_version: Optional[_builtins.str] = ..., self_link: Optional[_builtins.str] = ..., uid: Optional[_builtins.str] = ...) -> None:
...
class ServiceTemplateSpec(dict):
    ...
    def __init__(__self__, *, container_concurrency: Optional[_builtins.int] = ..., containers: Optional[Sequence[outputs.ServiceTemplateSpecContainer]] = ..., node_selector: Optional[Mapping[str, _builtins.str]] = ..., service_account_name: Optional[_builtins.str] = ..., serving_state: Optional[_builtins.str] = ..., timeout_seconds: Optional[_builtins.int] = ..., volumes: Optional[Sequence[outputs.ServiceTemplateSpecVolume]] = ...) -> None:
...
class ServiceTemplateSpecContainer(dict):
    ...
    def __init__(__self__, *, image: _builtins.str, args: Optional[Sequence[_builtins.str]] = ..., commands: Optional[Sequence[_builtins.str]] = ..., env_froms: Optional[Sequence[outputs.ServiceTemplateSpecContainerEnvFrom]] = ..., envs: Optional[Sequence[outputs.ServiceTemplateSpecContainerEnv]] = ..., liveness_probe: Optional[outputs.ServiceTemplateSpecContainerLivenessProbe] = ..., name: Optional[_builtins.str] = ..., ports: Optional[Sequence[outputs.ServiceTemplateSpecContainerPort]] = ..., readiness_probe: Optional[outputs.ServiceTemplateSpecContainerReadinessProbe] = ..., resources: Optional[outputs.ServiceTemplateSpecContainerResources] = ..., startup_probe: Optional[outputs.ServiceTemplateSpecContainerStartupProbe] = ..., volume_mounts: Optional[Sequence[outputs.ServiceTemplateSpecContainerVolumeMount]] = ..., working_dir: Optional[_builtins.str] = ...) -> None:
...
class ServiceTemplateSpecContainerEnv(dict):
    ...
    def __init__(__self__, *, name: Optional[_builtins.str] = ..., value: Optional[_builtins.str] = ..., value_from: Optional[outputs.ServiceTemplateSpecContainerEnvValueFrom] = ...) -> None:
...
class ServiceTemplateSpecContainerEnvFrom(dict):
    ...
    def __init__(__self__, *, config_map_ref: Optional[outputs.ServiceTemplateSpecContainerEnvFromConfigMapRef] = ..., prefix: Optional[_builtins.str] = ..., secret_ref: Optional[outputs.ServiceTemplateSpecContainerEnvFromSecretRef] = ...) -> None:
...
class ServiceTemplateSpecContainerEnvFromConfigMapRef(dict):
    ...
    def __init__(__self__, *, local_object_reference: Optional[outputs.ServiceTemplateSpecContainerEnvFromConfigMapRefLocalObjectReference] = ..., optional: Optional[_builtins.bool] = ...) -> None:
...
class ServiceTemplateSpecContainerEnvFromSecretRef(dict):
    ...
    def __init__(__self__, *, local_object_reference: Optional[outputs.ServiceTemplateSpecContainerEnvFromSecretRefLocalObjectReference] = ..., optional: Optional[_builtins.bool] = ...) -> None:
...
class ServiceTemplateSpecContainerEnvValueFrom(dict):
    ...
    def __init__(__self__, *, secret_key_ref: outputs.ServiceTemplateSpecContainerEnvValueFromSecretKeyRef) -> None:
...
class ServiceTemplateSpecContainerLivenessProbe(dict):
    ...
    def __init__(__self__, *, failure_threshold: Optional[_builtins.int] = ..., grpc: Optional[outputs.ServiceTemplateSpecContainerLivenessProbeGrpc] = ..., http_get: Optional[outputs.ServiceTemplateSpecContainerLivenessProbeHttpGet] = ..., initial_delay_seconds: Optional[_builtins.int] = ..., period_seconds: Optional[_builtins.int] = ..., timeout_seconds: Optional[_builtins.int] = ...) -> None:
...
class ServiceTemplateSpecContainerLivenessProbeHttpGet(dict):
    ...
    def __init__(__self__, *, http_headers: Optional[Sequence[outputs.ServiceTemplateSpecContainerLivenessProbeHttpGetHttpHeader]] = ..., path: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ...) -> None:
...
class ServiceTemplateSpecContainerPort(dict):
    ...
    def __init__(__self__, *, container_port: Optional[_builtins.int] = ..., name: Optional[_builtins.str] = ..., protocol: Optional[_builtins.str] = ...) -> None:
...
class ServiceTemplateSpecContainerReadinessProbe(dict):
    ...
    def __init__(__self__, *, failure_threshold: Optional[_builtins.int] = ..., grpc: Optional[outputs.ServiceTemplateSpecContainerReadinessProbeGrpc] = ..., http_get: Optional[outputs.ServiceTemplateSpecContainerReadinessProbeHttpGet] = ..., period_seconds: Optional[_builtins.int] = ..., success_threshold: Optional[_builtins.int] = ..., timeout_seconds: Optional[_builtins.int] = ...) -> None:
...
class ServiceTemplateSpecContainerStartupProbe(dict):
    ...
    def __init__(__self__, *, failure_threshold: Optional[_builtins.int] = ..., grpc: Optional[outputs.ServiceTemplateSpecContainerStartupProbeGrpc] = ..., http_get: Optional[outputs.ServiceTemplateSpecContainerStartupProbeHttpGet] = ..., initial_delay_seconds: Optional[_builtins.int] = ..., period_seconds: Optional[_builtins.int] = ..., tcp_socket: Optional[outputs.ServiceTemplateSpecContainerStartupProbeTcpSocket] = ..., timeout_seconds: Optional[_builtins.int] = ...) -> None:
...
class ServiceTemplateSpecContainerStartupProbeHttpGet(dict):
    ...
    def __init__(__self__, *, http_headers: Optional[Sequence[outputs.ServiceTemplateSpecContainerStartupProbeHttpGetHttpHeader]] = ..., path: Optional[_builtins.str] = ..., port: Optional[_builtins.int] = ...) -> None:
...
class ServiceTemplateSpecVolume(dict):
    ...
    def __init__(__self__, *, name: _builtins.str, csi: Optional[outputs.ServiceTemplateSpecVolumeCsi] = ..., empty_dir: Optional[outputs.ServiceTemplateSpecVolumeEmptyDir] = ..., nfs: Optional[outputs.ServiceTemplateSpecVolumeNfs] = ..., secret: Optional[outputs.ServiceTemplateSpecVolumeSecret] = ...) -> None:
...
class ServiceTemplateSpecVolumeCsi(dict):
    ...
    def __init__(__self__, *, driver: _builtins.str, read_only: Optional[_builtins.bool] = ..., volume_attributes: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class ServiceTemplateSpecVolumeSecret(dict):
    ...
    def __init__(__self__, *, secret_name: _builtins.str, default_mode: Optional[_builtins.int] = ..., items: Optional[Sequence[outputs.ServiceTemplateSpecVolumeSecretItem]] = ...) -> None:
...
class ServiceTemplateSpecVolumeSecretItem(dict):
    def __init__(__self__, *, key: _builtins.str, path: _builtins.str, mode: Optional[_builtins.int] = ...) -> None:
...
class ServiceTraffic(dict):
    ...
    def __init__(__self__, *, percent: _builtins.int, latest_revision: Optional[_builtins.bool] = ..., revision_name: Optional[_builtins.str] = ..., tag: Optional[_builtins.str] = ..., url: Optional[_builtins.str] = ...) -> None:
...
class GetServiceMetadataResult(dict):
    def __init__(__self__, *, annotations: Mapping[str, _builtins.str], effective_annotations: Mapping[str, _builtins.str], effective_labels: Mapping[str, _builtins.str], generation: _builtins.int, labels: Mapping[str, _builtins.str], namespace: _builtins.str, pulumi_labels: Mapping[str, _builtins.str], resource_version: _builtins.str, self_link: _builtins.str, uid: _builtins.str) -> None:
...
class GetServiceStatusResult(dict):
    def __init__(__self__, *, conditions: Sequence[outputs.GetServiceStatusConditionResult], latest_created_revision_name: _builtins.str, latest_ready_revision_name: _builtins.str, observed_generation: _builtins.int, traffics: Sequence[outputs.GetServiceStatusTrafficResult], url: _builtins.str) -> None:
...
class GetServiceStatusConditionResult(dict):
    def __init__(__self__, *, message: _builtins.str, reason: _builtins.str, status: _builtins.str, type: _builtins.str) -> None:
...
class GetServiceStatusTrafficResult(dict):
    def __init__(__self__, *, latest_revision: _builtins.bool, percent: _builtins.int, revision_name: _builtins.str, tag: _builtins.str, url: _builtins.str) -> None:
...
class GetServiceTemplateResult(dict):
    def __init__(__self__, *, metadatas: Sequence[outputs.GetServiceTemplateMetadataResult], specs: Sequence[outputs.GetServiceTemplateSpecResult]) -> None:
...
class GetServiceTemplateMetadataResult(dict):
    def __init__(__self__, *, annotations: Mapping[str, _builtins.str], generation: _builtins.int, labels: Mapping[str, _builtins.str], name: _builtins.str, namespace: _builtins.str, resource_version: _builtins.str, self_link: _builtins.str, uid: _builtins.str) -> None:
...
class GetServiceTemplateSpecResult(dict):
    def __init__(__self__, *, container_concurrency: _builtins.int, containers: Sequence[outputs.GetServiceTemplateSpecContainerResult], node_selector: Mapping[str, _builtins.str], service_account_name: _builtins.str, serving_state: _builtins.str, timeout_seconds: _builtins.int, volumes: Sequence[outputs.GetServiceTemplateSpecVolumeResult]) -> None:
...
class GetServiceTemplateSpecContainerResult(dict):
    def __init__(__self__, *, args: Sequence[_builtins.str], commands: Sequence[_builtins.str], env_froms: Sequence[outputs.GetServiceTemplateSpecContainerEnvFromResult], envs: Sequence[outputs.GetServiceTemplateSpecContainerEnvResult], image: _builtins.str, liveness_probes: Sequence[outputs.GetServiceTemplateSpecContainerLivenessProbeResult], name: _builtins.str, ports: Sequence[outputs.GetServiceTemplateSpecContainerPortResult], readiness_probes: Sequence[outputs.GetServiceTemplateSpecContainerReadinessProbeResult], resources: Sequence[outputs.GetServiceTemplateSpecContainerResourceResult], startup_probes: Sequence[outputs.GetServiceTemplateSpecContainerStartupProbeResult], volume_mounts: Sequence[outputs.GetServiceTemplateSpecContainerVolumeMountResult], working_dir: _builtins.str) -> None:
...
class GetServiceTemplateSpecContainerEnvResult(dict):
    def __init__(__self__, *, name: _builtins.str, value: _builtins.str, value_froms: Sequence[outputs.GetServiceTemplateSpecContainerEnvValueFromResult]) -> None:
...
class GetServiceTemplateSpecContainerEnvFromResult(dict):
    def __init__(__self__, *, config_map_reves: Sequence[outputs.GetServiceTemplateSpecContainerEnvFromConfigMapRefResult], prefix: _builtins.str, secret_reves: Sequence[outputs.GetServiceTemplateSpecContainerEnvFromSecretRefResult]) -> None:
...
class GetServiceTemplateSpecContainerEnvFromConfigMapRefResult(dict):
    def __init__(__self__, *, local_object_references: Sequence[outputs.GetServiceTemplateSpecContainerEnvFromConfigMapRefLocalObjectReferenceResult], optional: _builtins.bool) -> None:
...
class GetServiceTemplateSpecContainerEnvFromSecretRefResult(dict):
    def __init__(__self__, *, local_object_references: Sequence[outputs.GetServiceTemplateSpecContainerEnvFromSecretRefLocalObjectReferenceResult], optional: _builtins.bool) -> None:
...
class GetServiceTemplateSpecContainerEnvValueFromResult(dict):
    def __init__(__self__, *, secret_key_reves: Sequence[outputs.GetServiceTemplateSpecContainerEnvValueFromSecretKeyRefResult]) -> None:
...
class GetServiceTemplateSpecContainerLivenessProbeResult(dict):
    def __init__(__self__, *, failure_threshold: _builtins.int, grpcs: Sequence[outputs.GetServiceTemplateSpecContainerLivenessProbeGrpcResult], http_gets: Sequence[outputs.GetServiceTemplateSpecContainerLivenessProbeHttpGetResult], initial_delay_seconds: _builtins.int, period_seconds: _builtins.int, timeout_seconds: _builtins.int) -> None:
...
class GetServiceTemplateSpecContainerLivenessProbeHttpGetResult(dict):
    def __init__(__self__, *, http_headers: Sequence[outputs.GetServiceTemplateSpecContainerLivenessProbeHttpGetHttpHeaderResult], path: _builtins.str, port: _builtins.int) -> None:
...
class GetServiceTemplateSpecContainerPortResult(dict):
    def __init__(__self__, *, container_port: _builtins.int, name: _builtins.str, protocol: _builtins.str) -> None:
...
class GetServiceTemplateSpecContainerReadinessProbeResult(dict):
    def __init__(__self__, *, failure_threshold: _builtins.int, grpcs: Sequence[outputs.GetServiceTemplateSpecContainerReadinessProbeGrpcResult], http_gets: Sequence[outputs.GetServiceTemplateSpecContainerReadinessProbeHttpGetResult], period_seconds: _builtins.int, success_threshold: _builtins.int, timeout_seconds: _builtins.int) -> None:
...
class GetServiceTemplateSpecContainerResourceResult(dict):
    def __init__(__self__, *, limits: Mapping[str, _builtins.str], requests: Mapping[str, _builtins.str]) -> None:
...
class GetServiceTemplateSpecContainerStartupProbeResult(dict):
    def __init__(__self__, *, failure_threshold: _builtins.int, grpcs: Sequence[outputs.GetServiceTemplateSpecContainerStartupProbeGrpcResult], http_gets: Sequence[outputs.GetServiceTemplateSpecContainerStartupProbeHttpGetResult], initial_delay_seconds: _builtins.int, period_seconds: _builtins.int, tcp_sockets: Sequence[outputs.GetServiceTemplateSpecContainerStartupProbeTcpSocketResult], timeout_seconds: _builtins.int) -> None:
...
class GetServiceTemplateSpecContainerStartupProbeHttpGetResult(dict):
    def __init__(__self__, *, http_headers: Sequence[outputs.GetServiceTemplateSpecContainerStartupProbeHttpGetHttpHeaderResult], path: _builtins.str, port: _builtins.int) -> None:
...
class GetServiceTemplateSpecVolumeResult(dict):
    def __init__(__self__, *, csis: Sequence[outputs.GetServiceTemplateSpecVolumeCsiResult], empty_dirs: Sequence[outputs.GetServiceTemplateSpecVolumeEmptyDirResult], name: _builtins.str, nfs: Sequence[outputs.GetServiceTemplateSpecVolumeNfResult], secrets: Sequence[outputs.GetServiceTemplateSpecVolumeSecretResult]) -> None:
...
class GetServiceTemplateSpecVolumeCsiResult(dict):
    def __init__(__self__, *, driver: _builtins.str, read_only: _builtins.bool, volume_attributes: Mapping[str, _builtins.str]) -> None:
...
class GetServiceTemplateSpecVolumeSecretResult(dict):
    def __init__(__self__, *, default_mode: _builtins.int, items: Sequence[outputs.GetServiceTemplateSpecVolumeSecretItemResult], secret_name: _builtins.str) -> None:
...
class GetServiceTemplateSpecVolumeSecretItemResult(dict):
    def __init__(__self__, *, key: _builtins.str, mode: _builtins.int, path: _builtins.str) -> None:
