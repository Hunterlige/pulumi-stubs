...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DestinationEndpointArgs', 'DestinationEndpointArgsDict', 'DestinationStateTimelineArgs', 'DestinationStateTimelineArgsDict', 'DestinationStateTimelineStateArgs', 'DestinationStateTimelineStateArgsDict', 'GroupAutoAcceptArgs', 'GroupAutoAcceptArgsDict', 'HubRoutingVpcArgs', 'HubRoutingVpcArgsDict', 'InternalRangeAllocationOptionsArgs', 'InternalRangeAllocationOptionsArgsDict', 'InternalRangeMigrationArgs', 'InternalRangeMigrationArgsDict', 'MulticloudDataTransferConfigServiceArgs', 'MulticloudDataTransferConfigServiceArgsDict', 'MulticloudDataTransferConfigServiceStateArgs', 'MulticloudDataTransferConfigServiceStateArgsDict', 'PolicyBasedRouteFilterArgs', 'PolicyBasedRouteFilterArgsDict', 'PolicyBasedRouteInterconnectAttachmentArgs', 'PolicyBasedRouteInterconnectAttachmentArgsDict', 'PolicyBasedRouteVirtualMachineArgs', 'PolicyBasedRouteVirtualMachineArgsDict', 'PolicyBasedRouteWarningArgs', 'PolicyBasedRouteWarningArgsDict', 'ServiceConnectionPolicyPscConfigArgs', 'ServiceConnectionPolicyPscConfigArgsDict', 'ServiceConnectionPolicyPscConnectionArgs', 'ServiceConnectionPolicyPscConnectionArgsDict', 'ServiceConnectionPolicyPscConnectionErrorArgs', 'ServiceConnectionPolicyPscConnectionErrorArgsDict', 'ServiceConnectionPolicyPscConnectionErrorInfoArgs', ..., 'SpokeGatewayArgs', 'SpokeGatewayArgsDict', 'SpokeGatewayIpRangeReservationArgs', 'SpokeGatewayIpRangeReservationArgsDict', 'SpokeLinkedInterconnectAttachmentsArgs', 'SpokeLinkedInterconnectAttachmentsArgsDict', 'SpokeLinkedProducerVpcNetworkArgs', 'SpokeLinkedProducerVpcNetworkArgsDict', 'SpokeLinkedRouterApplianceInstancesArgs', 'SpokeLinkedRouterApplianceInstancesArgsDict', 'SpokeLinkedRouterApplianceInstancesInstanceArgs', ..., 'SpokeLinkedVpcNetworkArgs', 'SpokeLinkedVpcNetworkArgsDict', 'SpokeLinkedVpnTunnelsArgs', 'SpokeLinkedVpnTunnelsArgsDict', 'SpokeReasonArgs', 'SpokeReasonArgsDict']
...
class DestinationEndpointArgs:
    def __init__(__self__, *, asn: pulumi.Input[_builtins.str], csp: pulumi.Input[_builtins.str], state: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @asn.setter
    def asn(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    @csp.setter
    def csp(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class DestinationStateTimelineArgs:
    def __init__(__self__, *, states: Optional[pulumi.Input[Sequence[pulumi.Input[DestinationStateTimelineStateArgs]]]] = ...) -> None:
    ...
    @states.setter
    def states(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[DestinationStateTimelineStateArgs]]]]): # -> None:
        ...
...
class DestinationStateTimelineStateArgs:
    def __init__(__self__, *, effective_time: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class GroupAutoAcceptArgs:
    def __init__(__self__, *, auto_accept_projects: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    def auto_accept_projects(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class InternalRangeAllocationOptionsArgs:
    def __init__(__self__, *, allocation_strategy: Optional[pulumi.Input[_builtins.str]] = ..., first_available_ranges_lookup_size: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def first_available_ranges_lookup_size(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class InternalRangeMigrationArgs:
    def __init__(__self__, *, source: pulumi.Input[_builtins.str], target: pulumi.Input[_builtins.str]) -> None:
...
class MulticloudDataTransferConfigServiceArgs:
    def __init__(__self__, *, service_name: pulumi.Input[_builtins.str], states: Optional[pulumi.Input[Sequence[pulumi.Input[MulticloudDataTransferConfigServiceStateArgs]]]] = ...) -> None:
    ...
    @states.setter
    def states(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[MulticloudDataTransferConfigServiceStateArgs]]]]): # -> None:
        ...
...
class PolicyBasedRouteFilterArgs:
    def __init__(__self__, *, protocol_version: pulumi.Input[_builtins.str], dest_range: Optional[pulumi.Input[_builtins.str]] = ..., ip_protocol: Optional[pulumi.Input[_builtins.str]] = ..., src_range: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @dest_range.setter
    def dest_range(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @ip_protocol.setter
    def ip_protocol(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @src_range.setter
    def src_range(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class PolicyBasedRouteVirtualMachineArgs:
    def __init__(__self__, *, tags: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
...
class PolicyBasedRouteWarningArgs:
    def __init__(__self__, *, code: Optional[pulumi.Input[_builtins.str]] = ..., data: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., warning_message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ServiceConnectionPolicyPscConfigArgs:
    def __init__(__self__, *, subnetworks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], allowed_google_producers_resource_hierarchy_levels: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., limit: Optional[pulumi.Input[_builtins.str]] = ..., producer_instance_location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allowed_google_producers_resource_hierarchy_levels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def producer_instance_location(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceConnectionPolicyPscConnectionArgs:
    def __init__(__self__, *, consumer_address: Optional[pulumi.Input[_builtins.str]] = ..., consumer_forwarding_rule: Optional[pulumi.Input[_builtins.str]] = ..., consumer_target_project: Optional[pulumi.Input[_builtins.str]] = ..., error: Optional[pulumi.Input[ServiceConnectionPolicyPscConnectionErrorArgs]] = ..., error_info: Optional[pulumi.Input[ServiceConnectionPolicyPscConnectionErrorInfoArgs]] = ..., error_type: Optional[pulumi.Input[_builtins.str]] = ..., gce_operation: Optional[pulumi.Input[_builtins.str]] = ..., psc_connection_id: Optional[pulumi.Input[_builtins.str]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def consumer_address(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def consumer_forwarding_rule(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def consumer_target_project(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @error.setter
    def error(self, value: Optional[pulumi.Input[ServiceConnectionPolicyPscConnectionErrorArgs]]): # -> None:
        ...
    ...
    @error_info.setter
    def error_info(self, value: Optional[pulumi.Input[ServiceConnectionPolicyPscConnectionErrorInfoArgs]]): # -> None:
        ...
    ...
    def gce_operation(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ServiceConnectionPolicyPscConnectionErrorInfoArgs:
    def __init__(__self__, *, domain: Optional[pulumi.Input[_builtins.str]] = ..., metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., reason: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class SpokeGatewayArgs:
    def __init__(__self__, *, capacity: pulumi.Input[_builtins.str], ip_range_reservations: pulumi.Input[Sequence[pulumi.Input[SpokeGatewayIpRangeReservationArgs]]], routers: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @capacity.setter
    def capacity(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def ip_range_reservations(self, value: pulumi.Input[Sequence[pulumi.Input[SpokeGatewayIpRangeReservationArgs]]]): # -> None:
        ...
    ...
    @routers.setter
    def routers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class SpokeGatewayIpRangeReservationArgs:
    ...
    @ip_range.setter
    def ip_range(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class SpokeLinkedInterconnectAttachmentsArgs:
    def __init__(__self__, *, site_to_site_data_transfer: pulumi.Input[_builtins.bool], uris: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], include_import_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def site_to_site_data_transfer(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    def include_import_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class SpokeLinkedProducerVpcNetworkArgs:
    def __init__(__self__, *, network: pulumi.Input[_builtins.str], peering: pulumi.Input[_builtins.str], exclude_export_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., include_export_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., producer_network: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @peering.setter
    def peering(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def exclude_export_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def include_export_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def producer_network(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class SpokeLinkedRouterApplianceInstancesArgs:
    def __init__(__self__, *, instances: pulumi.Input[Sequence[pulumi.Input[SpokeLinkedRouterApplianceInstancesInstanceArgs]]], site_to_site_data_transfer: pulumi.Input[_builtins.bool], include_import_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @instances.setter
    def instances(self, value: pulumi.Input[Sequence[pulumi.Input[SpokeLinkedRouterApplianceInstancesInstanceArgs]]]): # -> None:
        ...
...
class SpokeLinkedRouterApplianceInstancesInstanceArgs:
    def __init__(__self__, *, ip_address: pulumi.Input[_builtins.str], virtual_machine: pulumi.Input[_builtins.str]) -> None:
    ...
    def virtual_machine(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class SpokeLinkedVpcNetworkArgs:
    def __init__(__self__, *, uri: pulumi.Input[_builtins.str], exclude_export_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., include_export_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
...
class SpokeReasonArgs:
    def __init__(__self__, *, code: Optional[pulumi.Input[_builtins.str]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ..., user_details: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @user_details.setter
    def user_details(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
