...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['DestinationEndpoint', 'DestinationStateTimeline', 'DestinationStateTimelineState', 'GroupAutoAccept', 'HubRoutingVpc', 'InternalRangeAllocationOptions', 'InternalRangeMigration', 'MulticloudDataTransferConfigService', 'MulticloudDataTransferConfigServiceState', 'PolicyBasedRouteFilter', 'PolicyBasedRouteInterconnectAttachment', 'PolicyBasedRouteVirtualMachine', 'PolicyBasedRouteWarning', 'ServiceConnectionPolicyPscConfig', 'ServiceConnectionPolicyPscConnection', 'ServiceConnectionPolicyPscConnectionError', 'ServiceConnectionPolicyPscConnectionErrorInfo', 'SpokeGateway', 'SpokeGatewayIpRangeReservation', 'SpokeLinkedInterconnectAttachments', 'SpokeLinkedProducerVpcNetwork', 'SpokeLinkedRouterApplianceInstances', 'SpokeLinkedRouterApplianceInstancesInstance', 'SpokeLinkedVpcNetwork', 'SpokeLinkedVpnTunnels', 'SpokeReason']
@pulumi.output_type
class DestinationEndpoint(dict):
    ...
    def __init__(__self__, *, asn: _builtins.str, csp: _builtins.str, state: Optional[_builtins.str] = ..., update_time: Optional[_builtins.str] = ...) -> None:
...
class DestinationStateTimeline(dict):
    def __init__(__self__, *, states: Optional[Sequence[outputs.DestinationStateTimelineState]] = ...) -> None:
...
class DestinationStateTimelineState(dict):
    ...
    def __init__(__self__, *, effective_time: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class GroupAutoAccept(dict):
    ...
    def __init__(__self__, *, auto_accept_projects: Sequence[_builtins.str]) -> None:
...
class InternalRangeAllocationOptions(dict):
    ...
    def __init__(__self__, *, allocation_strategy: Optional[_builtins.str] = ..., first_available_ranges_lookup_size: Optional[_builtins.int] = ...) -> None:
...
class MulticloudDataTransferConfigService(dict):
    ...
    def __init__(__self__, *, service_name: _builtins.str, states: Optional[Sequence[outputs.MulticloudDataTransferConfigServiceState]] = ...) -> None:
...
class PolicyBasedRouteFilter(dict):
    ...
    def __init__(__self__, *, protocol_version: _builtins.str, dest_range: Optional[_builtins.str] = ..., ip_protocol: Optional[_builtins.str] = ..., src_range: Optional[_builtins.str] = ...) -> None:
...
class PolicyBasedRouteWarning(dict):
    ...
    def __init__(__self__, *, code: Optional[_builtins.str] = ..., data: Optional[Mapping[str, _builtins.str]] = ..., warning_message: Optional[_builtins.str] = ...) -> None:
...
class ServiceConnectionPolicyPscConfig(dict):
    ...
    def __init__(__self__, *, subnetworks: Sequence[_builtins.str], allowed_google_producers_resource_hierarchy_levels: Optional[Sequence[_builtins.str]] = ..., limit: Optional[_builtins.str] = ..., producer_instance_location: Optional[_builtins.str] = ...) -> None:
...
class ServiceConnectionPolicyPscConnection(dict):
    ...
    def __init__(__self__, *, consumer_address: Optional[_builtins.str] = ..., consumer_forwarding_rule: Optional[_builtins.str] = ..., consumer_target_project: Optional[_builtins.str] = ..., error: Optional[outputs.ServiceConnectionPolicyPscConnectionError] = ..., error_info: Optional[outputs.ServiceConnectionPolicyPscConnectionErrorInfo] = ..., error_type: Optional[_builtins.str] = ..., gce_operation: Optional[_builtins.str] = ..., psc_connection_id: Optional[_builtins.str] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class ServiceConnectionPolicyPscConnectionErrorInfo(dict):
    def __init__(__self__, *, domain: Optional[_builtins.str] = ..., metadata: Optional[Mapping[str, _builtins.str]] = ..., reason: Optional[_builtins.str] = ...) -> None:
...
class SpokeGateway(dict):
    ...
    def __init__(__self__, *, capacity: _builtins.str, ip_range_reservations: Sequence[outputs.SpokeGatewayIpRangeReservation], routers: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SpokeLinkedInterconnectAttachments(dict):
    ...
    def __init__(__self__, *, site_to_site_data_transfer: _builtins.bool, uris: Sequence[_builtins.str], include_import_ranges: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SpokeLinkedProducerVpcNetwork(dict):
    ...
    def __init__(__self__, *, network: _builtins.str, peering: _builtins.str, exclude_export_ranges: Optional[Sequence[_builtins.str]] = ..., include_export_ranges: Optional[Sequence[_builtins.str]] = ..., producer_network: Optional[_builtins.str] = ...) -> None:
...
class SpokeLinkedRouterApplianceInstances(dict):
    ...
    def __init__(__self__, *, instances: Sequence[outputs.SpokeLinkedRouterApplianceInstancesInstance], site_to_site_data_transfer: _builtins.bool, include_import_ranges: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SpokeLinkedRouterApplianceInstancesInstance(dict):
    ...
    def __init__(__self__, *, ip_address: _builtins.str, virtual_machine: _builtins.str) -> None:
...
class SpokeLinkedVpcNetwork(dict):
    ...
    def __init__(__self__, *, uri: _builtins.str, exclude_export_ranges: Optional[Sequence[_builtins.str]] = ..., include_export_ranges: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class SpokeReason(dict):
    ...
    def __init__(__self__, *, code: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ..., user_details: Optional[_builtins.str] = ...) -> None:
