...
class OrganizationCustomModuleArgs:
    def __init__(__self__, *, custom_config: pulumi.Input[OrganizationCustomModuleCustomConfigArgs], display_name: pulumi.Input[_builtins.str], enablement_state: pulumi.Input[_builtins.str], organization: pulumi.Input[_builtins.str]) -> None:
    ...
    def custom_config(self, value: pulumi.Input[OrganizationCustomModuleCustomConfigArgs]): # -> None:
        ...
...
class _OrganizationCustomModuleState:
    ...
    @custom_config.setter
    def custom_config(self, value: Optional[pulumi.Input[OrganizationCustomModuleCustomConfigArgs]]): # -> None:
        ...
...
class OrganizationCustomModule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., custom_config: Optional[pulumi.Input[Union[OrganizationCustomModuleCustomConfigArgs, OrganizationCustomModuleCustomConfigArgsDict]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., enablement_state: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: OrganizationCustomModuleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., ancestor_module: Optional[pulumi.Input[_builtins.str]] = ..., custom_config: Optional[pulumi.Input[Union[OrganizationCustomModuleCustomConfigArgs, OrganizationCustomModuleCustomConfigArgsDict]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., enablement_state: Optional[pulumi.Input[_builtins.str]] = ..., last_editor: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> OrganizationCustomModule:
