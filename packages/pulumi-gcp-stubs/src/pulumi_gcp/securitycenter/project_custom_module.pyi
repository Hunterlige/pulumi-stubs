...
class ProjectCustomModuleArgs:
    ...
    def custom_config(
        self, value: pulumi.Input[ProjectCustomModuleCustomConfigArgs]
    ): ...
    @_builtins.property
...
class _ProjectCustomModuleState:
    def __init__(
        ...
        *,
        ...
        custom_config: Optional[
            pulumi.Input[ProjectCustomModuleCustomConfigArgs]
        ] = ...,
    ...
    def custom_config(
        self,
    ) -> Optional[pulumi.Input[ProjectCustomModuleCustomConfigArgs]]: ...
    @custom_config.setter
    def custom_config(
        self, value: Optional[pulumi.Input[ProjectCustomModuleCustomConfigArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter(name="displayName")
...
class ProjectCustomModule(pulumi.CustomResource):
    ...
    def custom_config(
        self,
    ) -> pulumi.Output[outputs.ProjectCustomModuleCustomConfig]: ...
    @_builtins.property
    @pulumi.getter(name="displayName")
