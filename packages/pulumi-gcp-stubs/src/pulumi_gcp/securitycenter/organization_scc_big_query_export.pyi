...
class OrganizationSccBigQueryExportArgs:
    def __init__(__self__, *, big_query_export_id: pulumi.Input[_builtins.str], organization: pulumi.Input[_builtins.str], dataset: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class OrganizationSccBigQueryExport(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., big_query_export_id: Optional[pulumi.Input[_builtins.str]] = ..., dataset: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., filter: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: OrganizationSccBigQueryExportArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
