...
class NotificationConfigArgs:
    def __init__(__self__, *, config_id: pulumi.Input[_builtins.str], organization: pulumi.Input[_builtins.str], pubsub_topic: pulumi.Input[_builtins.str], streaming_config: pulumi.Input[NotificationConfigStreamingConfigArgs], description: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def streaming_config(self, value: pulumi.Input[NotificationConfigStreamingConfigArgs]): # -> None:
        ...
...
class _NotificationConfigState:
    ...
    @streaming_config.setter
    def streaming_config(self, value: Optional[pulumi.Input[NotificationConfigStreamingConfigArgs]]): # -> None:
        ...
