...
class V2FolderNotificationConfigArgs:
    ...
    def streaming_config(
        self,
    ) -> pulumi.Input[V2FolderNotificationConfigStreamingConfigArgs]: ...
    @streaming_config.setter
    def streaming_config(
        self, value: pulumi.Input[V2FolderNotificationConfigStreamingConfigArgs]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _V2FolderNotificationConfigState:
    ...
    def streaming_config(
        self,
    ) -> Optional[pulumi.Input[V2FolderNotificationConfigStreamingConfigArgs]]: ...
    @streaming_config.setter
    def streaming_config(
        self,
        value: Optional[pulumi.Input[V2FolderNotificationConfigStreamingConfigArgs]],
    ): ...
...
class V2FolderNotificationConfig(pulumi.CustomResource):
    ...
    def streaming_config(
        self,
    ) -> pulumi.Output[outputs.V2FolderNotificationConfigStreamingConfig]: ...
