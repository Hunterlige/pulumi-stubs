...
class FolderCustomModuleArgs:
    ...
    def custom_config(
        self, value: pulumi.Input[FolderCustomModuleCustomConfigArgs]
    ): ...
    @_builtins.property
...
class _FolderCustomModuleState:
    def __init__(
        ...
        *,
        ...
        custom_config: Optional[pulumi.Input[FolderCustomModuleCustomConfigArgs]] = ...,
    ...
    def custom_config(
        self,
    ) -> Optional[pulumi.Input[FolderCustomModuleCustomConfigArgs]]: ...
    @custom_config.setter
    def custom_config(
        self, value: Optional[pulumi.Input[FolderCustomModuleCustomConfigArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter(name="displayName")
...
class FolderCustomModule(pulumi.CustomResource):
    ...
    def custom_config(
        self,
    ) -> pulumi.Output[outputs.FolderCustomModuleCustomConfig]: ...
    @_builtins.property
    @pulumi.getter(name="displayName")
