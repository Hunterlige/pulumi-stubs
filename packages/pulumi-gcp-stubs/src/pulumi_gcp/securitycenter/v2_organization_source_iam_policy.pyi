...
class V2OrganizationSourceIamPolicy(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: V2OrganizationSourceIamPolicyArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., etag: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., policy_data: Optional[pulumi.Input[_builtins.str]] = ..., source: Optional[pulumi.Input[_builtins.str]] = ...) -> V2OrganizationSourceIamPolicy:
