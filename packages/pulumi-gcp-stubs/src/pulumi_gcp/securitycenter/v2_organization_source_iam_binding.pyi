...
class V2OrganizationSourceIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[V2OrganizationSourceIamBindingConditionArgs]
        ] = ...,
    ) -> None: ...
    @_builtins.property
    @pulumi.getter
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[V2OrganizationSourceIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[V2OrganizationSourceIamBindingConditionArgs]]
    ): ...
...
class V2OrganizationSourceIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.V2OrganizationSourceIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
