...
class ManagementOrganizationSecurityHealthAnalyticsCustomModuleArgs:
    def __init__(__self__, *, organization: pulumi.Input[_builtins.str], custom_config: Optional[pulumi.Input[ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgs]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., enablement_state: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def custom_config(self, value: Optional[pulumi.Input[ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgs]]): # -> None:
        ...
...
class _ManagementOrganizationSecurityHealthAnalyticsCustomModuleState:
    def __init__(__self__, *, ancestor_module: Optional[pulumi.Input[_builtins.str]] = ..., custom_config: Optional[pulumi.Input[ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgs]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., enablement_state: Optional[pulumi.Input[_builtins.str]] = ..., last_editor: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ManagementOrganizationSecurityHealthAnalyticsCustomModule(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., custom_config: Optional[pulumi.Input[Union[ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgs, ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgsDict]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., enablement_state: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: ManagementOrganizationSecurityHealthAnalyticsCustomModuleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
    ...
    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = ..., ancestor_module: Optional[pulumi.Input[_builtins.str]] = ..., custom_config: Optional[pulumi.Input[Union[ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgs, ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgsDict]]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., enablement_state: Optional[pulumi.Input[_builtins.str]] = ..., last_editor: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., organization: Optional[pulumi.Input[_builtins.str]] = ..., update_time: Optional[pulumi.Input[_builtins.str]] = ...) -> ManagementOrganizationSecurityHealthAnalyticsCustomModule:
