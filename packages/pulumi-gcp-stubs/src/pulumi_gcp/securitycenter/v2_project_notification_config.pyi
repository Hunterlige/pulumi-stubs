...
class V2ProjectNotificationConfigArgs:
    def __init__(__self__, *, config_id: pulumi.Input[_builtins.str], streaming_config: pulumi.Input[V2ProjectNotificationConfigStreamingConfigArgs], description: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., pubsub_topic: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def streaming_config(self, value: pulumi.Input[V2ProjectNotificationConfigStreamingConfigArgs]): # -> None:
        ...
...
class _V2ProjectNotificationConfigState:
    def __init__(__self__, *, config_id: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., pubsub_topic: Optional[pulumi.Input[_builtins.str]] = ..., service_account: Optional[pulumi.Input[_builtins.str]] = ..., streaming_config: Optional[pulumi.Input[V2ProjectNotificationConfigStreamingConfigArgs]] = ...) -> None:
    ...
    @streaming_config.setter
    def streaming_config(self, value: Optional[pulumi.Input[V2ProjectNotificationConfigStreamingConfigArgs]]): # -> None:
        ...
...
class V2ProjectNotificationConfig(pulumi.CustomResource):
    @overload
    def __init__(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions] = ..., config_id: Optional[pulumi.Input[_builtins.str]] = ..., description: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., project: Optional[pulumi.Input[_builtins.str]] = ..., pubsub_topic: Optional[pulumi.Input[_builtins.str]] = ..., streaming_config: Optional[pulumi.Input[Union[V2ProjectNotificationConfigStreamingConfigArgs, V2ProjectNotificationConfigStreamingConfigArgsDict]]] = ..., __props__=...) -> None:
        
        ...
    
    @overload
    def __init__(__self__, resource_name: str, args: V2ProjectNotificationConfigArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
