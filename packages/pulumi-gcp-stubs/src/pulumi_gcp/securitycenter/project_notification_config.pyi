...
class ProjectNotificationConfigArgs:
    ...
    def streaming_config(
        self,
    ) -> pulumi.Input[ProjectNotificationConfigStreamingConfigArgs]: ...
    @streaming_config.setter
    def streaming_config(
        self, value: pulumi.Input[ProjectNotificationConfigStreamingConfigArgs]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class _ProjectNotificationConfigState:
    ...
    def streaming_config(
        self,
        value: Optional[pulumi.Input[ProjectNotificationConfigStreamingConfigArgs]],
    ): ...
...
class ProjectNotificationConfig(pulumi.CustomResource):
    ...
    def streaming_config(
        self,
    ) -> pulumi.Output[outputs.ProjectNotificationConfigStreamingConfig]: ...
