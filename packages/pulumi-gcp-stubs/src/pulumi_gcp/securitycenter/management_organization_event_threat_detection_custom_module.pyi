...
class ManagementOrganizationEventThreatDetectionCustomModuleArgs:
    def __init__(__self__, *, organization: pulumi.Input[_builtins.str], config: Optional[pulumi.Input[_builtins.str]] = ..., display_name: Optional[pulumi.Input[_builtins.str]] = ..., enablement_state: Optional[pulumi.Input[_builtins.str]] = ..., location: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ManagementOrganizationEventThreatDetectionCustomModule(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: ManagementOrganizationEventThreatDetectionCustomModuleArgs, opts: Optional[pulumi.ResourceOptions] = ...) -> None:
