...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['BackupScheduleDailyRecurrenceArgs', 'BackupScheduleDailyRecurrenceArgsDict', 'BackupScheduleWeeklyRecurrenceArgs', 'BackupScheduleWeeklyRecurrenceArgsDict', 'DatabaseCmekConfigArgs', 'DatabaseCmekConfigArgsDict', 'FieldIndexConfigArgs', 'FieldIndexConfigArgsDict', 'FieldIndexConfigIndexArgs', 'FieldIndexConfigIndexArgsDict', 'FieldTtlConfigArgs', 'FieldTtlConfigArgsDict', 'IndexFieldArgs', 'IndexFieldArgsDict', 'IndexFieldVectorConfigArgs', 'IndexFieldVectorConfigArgsDict', 'IndexFieldVectorConfigFlatArgs', 'IndexFieldVectorConfigFlatArgsDict', 'UserCredsResourceIdentityArgs', 'UserCredsResourceIdentityArgsDict']
...
class BackupScheduleWeeklyRecurrenceArgs:
    def __init__(__self__, *, day: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DatabaseCmekConfigArgs:
    def __init__(__self__, *, kms_key_name: pulumi.Input[_builtins.str], active_key_versions: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def active_key_versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class FieldIndexConfigArgs:
    def __init__(__self__, *, indexes: Optional[pulumi.Input[Sequence[pulumi.Input[FieldIndexConfigIndexArgs]]]] = ...) -> None:
    ...
    @indexes.setter
    def indexes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[FieldIndexConfigIndexArgs]]]]): # -> None:
        ...
...
class FieldIndexConfigIndexArgs:
    def __init__(__self__, *, array_config: Optional[pulumi.Input[_builtins.str]] = ..., order: Optional[pulumi.Input[_builtins.str]] = ..., query_scope: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @array_config.setter
    def array_config(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class IndexFieldArgs:
    def __init__(__self__, *, array_config: Optional[pulumi.Input[_builtins.str]] = ..., field_path: Optional[pulumi.Input[_builtins.str]] = ..., order: Optional[pulumi.Input[_builtins.str]] = ..., vector_config: Optional[pulumi.Input[IndexFieldVectorConfigArgs]] = ...) -> None:
    ...
    @field_path.setter
    def field_path(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def vector_config(self, value: Optional[pulumi.Input[IndexFieldVectorConfigArgs]]): # -> None:
        ...
...
class IndexFieldVectorConfigArgs:
    def __init__(__self__, *, dimension: Optional[pulumi.Input[_builtins.int]] = ..., flat: Optional[pulumi.Input[IndexFieldVectorConfigFlatArgs]] = ...) -> None:
    ...
    @flat.setter
    def flat(self, value: Optional[pulumi.Input[IndexFieldVectorConfigFlatArgs]]): # -> None:
        ...
