...
class _UserCredsState:
    def __init__(
        ...
        *,
        ...
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
        resource_identities: Optional[
            pulumi.Input[Sequence[pulumi.Input[UserCredsResourceIdentityArgs]]]
        ] = ...,
        secure_password: Optional[pulumi.Input[_builtins.str]] = ...,
...
class UserCreds(pulumi.CustomResource):
    ...
    def resource_identities(
        self,
    ) -> pulumi.Output[Sequence[outputs.UserCredsResourceIdentity]]: ...
    @_builtins.property
    @pulumi.getter(name="securePassword")
