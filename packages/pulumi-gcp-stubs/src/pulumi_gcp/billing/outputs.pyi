...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccountIamBindingCondition', 'AccountIamMemberCondition', 'BudgetAllUpdatesRule', 'BudgetAmount', 'BudgetAmountSpecifiedAmount', 'BudgetBudgetFilter', 'BudgetBudgetFilterCustomPeriod', 'BudgetBudgetFilterCustomPeriodEndDate', 'BudgetBudgetFilterCustomPeriodStartDate', 'BudgetThresholdRule']
@pulumi.output_type
...
class BudgetAllUpdatesRule(dict):
    ...
    def __init__(__self__, *, disable_default_iam_recipients: Optional[_builtins.bool] = ..., enable_project_level_recipients: Optional[_builtins.bool] = ..., monitoring_notification_channels: Optional[Sequence[_builtins.str]] = ..., pubsub_topic: Optional[_builtins.str] = ..., schema_version: Optional[_builtins.str] = ...) -> None:
...
class BudgetAmount(dict):
    ...
    def __init__(__self__, *, last_period_amount: Optional[_builtins.bool] = ..., specified_amount: Optional[outputs.BudgetAmountSpecifiedAmount] = ...) -> None:
...
class BudgetAmountSpecifiedAmount(dict):
    ...
    def __init__(__self__, *, currency_code: Optional[_builtins.str] = ..., nanos: Optional[_builtins.int] = ..., units: Optional[_builtins.str] = ...) -> None:
...
class BudgetBudgetFilter(dict):
    ...
    def __init__(__self__, *, calendar_period: Optional[_builtins.str] = ..., credit_types: Optional[Sequence[_builtins.str]] = ..., credit_types_treatment: Optional[_builtins.str] = ..., custom_period: Optional[outputs.BudgetBudgetFilterCustomPeriod] = ..., labels: Optional[Mapping[str, _builtins.str]] = ..., projects: Optional[Sequence[_builtins.str]] = ..., resource_ancestors: Optional[Sequence[_builtins.str]] = ..., services: Optional[Sequence[_builtins.str]] = ..., subaccounts: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class BudgetBudgetFilterCustomPeriod(dict):
    ...
    def __init__(__self__, *, start_date: outputs.BudgetBudgetFilterCustomPeriodStartDate, end_date: Optional[outputs.BudgetBudgetFilterCustomPeriodEndDate] = ...) -> None:
...
class BudgetThresholdRule(dict):
    ...
    def __init__(__self__, *, threshold_percent: _builtins.float, spend_basis: Optional[_builtins.str] = ...) -> None:
