...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AccountIamBindingConditionArgs', 'AccountIamBindingConditionArgsDict', 'AccountIamMemberConditionArgs', 'AccountIamMemberConditionArgsDict', 'BudgetAllUpdatesRuleArgs', 'BudgetAllUpdatesRuleArgsDict', 'BudgetAmountArgs', 'BudgetAmountArgsDict', 'BudgetAmountSpecifiedAmountArgs', 'BudgetAmountSpecifiedAmountArgsDict', 'BudgetBudgetFilterArgs', 'BudgetBudgetFilterArgsDict', 'BudgetBudgetFilterCustomPeriodArgs', 'BudgetBudgetFilterCustomPeriodArgsDict', 'BudgetBudgetFilterCustomPeriodEndDateArgs', 'BudgetBudgetFilterCustomPeriodEndDateArgsDict', 'BudgetBudgetFilterCustomPeriodStartDateArgs', 'BudgetBudgetFilterCustomPeriodStartDateArgsDict', 'BudgetThresholdRuleArgs', 'BudgetThresholdRuleArgsDict']
...
class BudgetAllUpdatesRuleArgs:
    def __init__(__self__, *, disable_default_iam_recipients: Optional[pulumi.Input[_builtins.bool]] = ..., enable_project_level_recipients: Optional[pulumi.Input[_builtins.bool]] = ..., monitoring_notification_channels: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., pubsub_topic: Optional[pulumi.Input[_builtins.str]] = ..., schema_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disable_default_iam_recipients(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_project_level_recipients(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def monitoring_notification_channels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class BudgetAmountArgs:
    def __init__(__self__, *, last_period_amount: Optional[pulumi.Input[_builtins.bool]] = ..., specified_amount: Optional[pulumi.Input[BudgetAmountSpecifiedAmountArgs]] = ...) -> None:
    ...
    def last_period_amount(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def specified_amount(self, value: Optional[pulumi.Input[BudgetAmountSpecifiedAmountArgs]]): # -> None:
        ...
...
class BudgetAmountSpecifiedAmountArgs:
    def __init__(__self__, *, currency_code: Optional[pulumi.Input[_builtins.str]] = ..., nanos: Optional[pulumi.Input[_builtins.int]] = ..., units: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class BudgetBudgetFilterArgs:
    def __init__(__self__, *, calendar_period: Optional[pulumi.Input[_builtins.str]] = ..., credit_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., credit_types_treatment: Optional[pulumi.Input[_builtins.str]] = ..., custom_period: Optional[pulumi.Input[BudgetBudgetFilterCustomPeriodArgs]] = ..., labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., projects: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., resource_ancestors: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., services: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., subaccounts: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @credit_types.setter
    def credit_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def credit_types_treatment(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def custom_period(self, value: Optional[pulumi.Input[BudgetBudgetFilterCustomPeriodArgs]]): # -> None:
        ...
    ...
    def resource_ancestors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @services.setter
    def services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @subaccounts.setter
    def subaccounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class BudgetBudgetFilterCustomPeriodArgs:
    def __init__(__self__, *, start_date: pulumi.Input[BudgetBudgetFilterCustomPeriodStartDateArgs], end_date: Optional[pulumi.Input[BudgetBudgetFilterCustomPeriodEndDateArgs]] = ...) -> None:
    ...
    @start_date.setter
    def start_date(self, value: pulumi.Input[BudgetBudgetFilterCustomPeriodStartDateArgs]): # -> None:
        ...
    ...
    @end_date.setter
    def end_date(self, value: Optional[pulumi.Input[BudgetBudgetFilterCustomPeriodEndDateArgs]]): # -> None:
        ...
...
class BudgetThresholdRuleArgs:
    def __init__(__self__, *, threshold_percent: pulumi.Input[_builtins.float], spend_basis: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def threshold_percent(self, value: pulumi.Input[_builtins.float]): # -> None:
        ...
    ...
    @spend_basis.setter
    def spend_basis(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
