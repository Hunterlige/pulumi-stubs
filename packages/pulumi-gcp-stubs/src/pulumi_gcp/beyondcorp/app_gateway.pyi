...
class AppGatewayArgs:
    def __init__(
        ...
        *,
        ...
        host_type: Optional[pulumi.Input[_builtins.str]] = ...,
...
class _AppGatewayState:
    def __init__(
        __self__,
        *,
        allocated_connections: Optional[
            pulumi.Input[Sequence[pulumi.Input[AppGatewayAllocatedConnectionArgs]]]
        ] = ...,
        display_name: Optional[pulumi.Input[_builtins.str]] = ...,
...
class AppGateway(pulumi.CustomResource):
    ...
    def allocated_connections(
        self,
    ) -> pulumi.Output[Sequence[outputs.AppGatewayAllocatedConnection]]: ...
    @_builtins.property
    @pulumi.getter(name="displayName")
