...
class SecurityGatewayApplicationIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[SecurityGatewayApplicationIamBindingConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[SecurityGatewayApplicationIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self,
        value: Optional[
...
class SecurityGatewayApplicationIamBinding(pulumi.CustomResource):
    ...
    def condition(
        ...
        Optional[outputs.SecurityGatewayApplicationIamBindingCondition]
    ]: ...
    @_builtins.property
    @pulumi.getter
