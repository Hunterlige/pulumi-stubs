...
class SecurityGatewayIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[SecurityGatewayIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[SecurityGatewayIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[SecurityGatewayIamBindingConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class SecurityGatewayIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.SecurityGatewayIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter
