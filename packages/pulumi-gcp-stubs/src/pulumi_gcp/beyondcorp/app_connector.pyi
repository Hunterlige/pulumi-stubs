...
class _AppConnectorState:
    def __init__(
        ...
        *,
        ...
        labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        principal_info: Optional[pulumi.Input[AppConnectorPrincipalInfoArgs]] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
    ...
    def principal_info(
        self,
    ) -> Optional[pulumi.Input[AppConnectorPrincipalInfoArgs]]: ...
    @principal_info.setter
    def principal_info(
        self, value: Optional[pulumi.Input[AppConnectorPrincipalInfoArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
    def project(self) -> Optional[pulumi.Input[_builtins.str]]: ...
...
class AppConnector(pulumi.CustomResource):
    ...
    def __init__(
        ...
        labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...,
        name: Optional[pulumi.Input[_builtins.str]] = ...,
        principal_info: Optional[
            pulumi.Input[
                Union[AppConnectorPrincipalInfoArgs, AppConnectorPrincipalInfoArgsDict]
            ]
        ] = ...,
        project: Optional[pulumi.Input[_builtins.str]] = ...,
        region: Optional[pulumi.Input[_builtins.str]] = ...,
