...
class SecurityGatewayIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[SecurityGatewayIamMemberConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[SecurityGatewayIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self, value: Optional[pulumi.Input[SecurityGatewayIamMemberConditionArgs]]
    ): ...
    @_builtins.property
    @pulumi.getter
...
class SecurityGatewayIamMember(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.SecurityGatewayIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter
