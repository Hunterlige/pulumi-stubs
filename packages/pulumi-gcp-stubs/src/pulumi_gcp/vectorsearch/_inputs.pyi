...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['CollectionVectorSchemaArgs', 'CollectionVectorSchemaArgsDict', 'CollectionVectorSchemaDenseVectorArgs', 'CollectionVectorSchemaDenseVectorArgsDict', ..., ..., 'CollectionVectorSchemaSparseVectorArgs', 'CollectionVectorSchemaSparseVectorArgsDict']
...
class CollectionVectorSchemaArgs:
    def __init__(__self__, *, field_name: pulumi.Input[_builtins.str], dense_vector: Optional[pulumi.Input[CollectionVectorSchemaDenseVectorArgs]] = ..., sparse_vector: Optional[pulumi.Input[CollectionVectorSchemaSparseVectorArgs]] = ...) -> None:
    ...
    @dense_vector.setter
    def dense_vector(self, value: Optional[pulumi.Input[CollectionVectorSchemaDenseVectorArgs]]): # -> None:
        ...
    ...
    def sparse_vector(self, value: Optional[pulumi.Input[CollectionVectorSchemaSparseVectorArgs]]): # -> None:
        ...
...
class CollectionVectorSchemaDenseVectorArgs:
    def __init__(__self__, *, dimensions: Optional[pulumi.Input[_builtins.int]] = ..., vertex_embedding_config: Optional[pulumi.Input[CollectionVectorSchemaDenseVectorVertexEmbeddingConfigArgs]] = ...) -> None:
    ...
    def vertex_embedding_config(self, value: Optional[pulumi.Input[CollectionVectorSchemaDenseVectorVertexEmbeddingConfigArgs]]): # -> None:
        ...
...
class CollectionVectorSchemaDenseVectorVertexEmbeddingConfigArgs:
    def __init__(__self__, *, model_id: pulumi.Input[_builtins.str], task_type: pulumi.Input[_builtins.str], text_template: pulumi.Input[_builtins.str]) -> None:
    ...
    def text_template(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
