...
class ConnectionIamBindingArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[pulumi.Input[ConnectionIamBindingConditionArgs]] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[ConnectionIamBindingConditionArgs]]: ...
    @condition.setter
    def condition(
...
class ConnectionIamBinding(pulumi.CustomResource):
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.ConnectionIamBindingCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="connectionId")
