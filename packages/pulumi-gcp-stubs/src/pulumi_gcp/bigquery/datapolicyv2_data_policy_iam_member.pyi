...
class Datapolicyv2DataPolicyIamMemberArgs:
    def __init__(
        ...
        *,
        ...
        condition: Optional[
            pulumi.Input[Datapolicyv2DataPolicyIamMemberConditionArgs]
        ] = ...,
    ...
    def condition(
        self,
    ) -> Optional[pulumi.Input[Datapolicyv2DataPolicyIamMemberConditionArgs]]: ...
    @condition.setter
    def condition(
        self,
        value: Optional[pulumi.Input[Datapolicyv2DataPolicyIamMemberConditionArgs]],
    ): ...
    @_builtins.property
    @pulumi.getter
...
class Datapolicyv2DataPolicyIamMember(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Datapolicyv2DataPolicyIamMemberArgs,
        opts: Optional[pulumi.ResourceOptions] = ...,
    ) -> None: ...
    ...
    def condition(
        self,
    ) -> pulumi.Output[Optional[outputs.Datapolicyv2DataPolicyIamMemberCondition]]: ...
    @_builtins.property
    @pulumi.getter(name="dataPolicyId")
