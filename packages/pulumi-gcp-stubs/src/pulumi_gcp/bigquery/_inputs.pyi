...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppProfileDataBoostIsolationReadOnlyArgs', 'AppProfileDataBoostIsolationReadOnlyArgsDict', 'AppProfileSingleClusterRoutingArgs', 'AppProfileSingleClusterRoutingArgsDict', 'AppProfileStandardIsolationArgs', 'AppProfileStandardIsolationArgsDict', 'BiReservationPreferredTableArgs', 'BiReservationPreferredTableArgsDict', 'ConnectionAwsArgs', 'ConnectionAwsArgsDict', 'ConnectionAwsAccessRoleArgs', 'ConnectionAwsAccessRoleArgsDict', 'ConnectionAzureArgs', 'ConnectionAzureArgsDict', 'ConnectionCloudResourceArgs', 'ConnectionCloudResourceArgsDict', 'ConnectionCloudSpannerArgs', 'ConnectionCloudSpannerArgsDict', 'ConnectionCloudSqlArgs', 'ConnectionCloudSqlArgsDict', 'ConnectionCloudSqlCredentialArgs', 'ConnectionCloudSqlCredentialArgsDict', 'ConnectionIamBindingConditionArgs', 'ConnectionIamBindingConditionArgsDict', 'ConnectionIamMemberConditionArgs', 'ConnectionIamMemberConditionArgsDict', 'ConnectionSparkArgs', 'ConnectionSparkArgsDict', 'ConnectionSparkMetastoreServiceConfigArgs', 'ConnectionSparkMetastoreServiceConfigArgsDict', 'ConnectionSparkSparkHistoryServerConfigArgs', 'ConnectionSparkSparkHistoryServerConfigArgsDict', 'DataTransferConfigEmailPreferencesArgs', 'DataTransferConfigEmailPreferencesArgsDict', 'DataTransferConfigEncryptionConfigurationArgs', 'DataTransferConfigEncryptionConfigurationArgsDict', 'DataTransferConfigScheduleOptionsArgs', 'DataTransferConfigScheduleOptionsArgsDict', 'DataTransferConfigSensitiveParamsArgs', 'DataTransferConfigSensitiveParamsArgsDict', 'Datapolicyv2DataPolicyDataMaskingPolicyArgs', 'Datapolicyv2DataPolicyDataMaskingPolicyArgsDict', 'Datapolicyv2DataPolicyIamBindingConditionArgs', 'Datapolicyv2DataPolicyIamBindingConditionArgsDict', 'Datapolicyv2DataPolicyIamMemberConditionArgs', 'Datapolicyv2DataPolicyIamMemberConditionArgsDict', 'DatasetAccessArgs', 'DatasetAccessArgsDict', 'DatasetAccessAuthorizedDatasetArgs', 'DatasetAccessAuthorizedDatasetArgsDict', 'DatasetAccessAuthorizedDatasetDatasetArgs', 'DatasetAccessAuthorizedDatasetDatasetArgsDict', 'DatasetAccessConditionArgs', 'DatasetAccessConditionArgsDict', 'DatasetAccessDatasetArgs', 'DatasetAccessDatasetArgsDict', 'DatasetAccessDatasetDatasetArgs', 'DatasetAccessDatasetDatasetArgsDict', 'DatasetAccessRoutineArgs', 'DatasetAccessRoutineArgsDict', 'DatasetAccessViewArgs', 'DatasetAccessViewArgsDict', 'DatasetDefaultEncryptionConfigurationArgs', 'DatasetDefaultEncryptionConfigurationArgsDict', 'DatasetExternalCatalogDatasetOptionsArgs', 'DatasetExternalCatalogDatasetOptionsArgsDict', 'DatasetExternalDatasetReferenceArgs', 'DatasetExternalDatasetReferenceArgsDict', 'DatasetIamBindingConditionArgs', 'DatasetIamBindingConditionArgsDict', 'DatasetIamMemberConditionArgs', 'DatasetIamMemberConditionArgsDict', 'IamBindingConditionArgs', 'IamBindingConditionArgsDict', 'IamMemberConditionArgs', 'IamMemberConditionArgsDict', 'JobCopyArgs', 'JobCopyArgsDict', 'JobCopyDestinationEncryptionConfigurationArgs', 'JobCopyDestinationEncryptionConfigurationArgsDict', 'JobCopyDestinationTableArgs', 'JobCopyDestinationTableArgsDict', 'JobCopySourceTableArgs', 'JobCopySourceTableArgsDict', 'JobExtractArgs', 'JobExtractArgsDict', 'JobExtractSourceModelArgs', 'JobExtractSourceModelArgsDict', 'JobExtractSourceTableArgs', 'JobExtractSourceTableArgsDict', 'JobLoadArgs', 'JobLoadArgsDict', 'JobLoadDestinationEncryptionConfigurationArgs', 'JobLoadDestinationEncryptionConfigurationArgsDict', 'JobLoadDestinationTableArgs', 'JobLoadDestinationTableArgsDict', 'JobLoadParquetOptionsArgs', 'JobLoadParquetOptionsArgsDict', 'JobLoadTimePartitioningArgs', 'JobLoadTimePartitioningArgsDict', 'JobQueryArgs', 'JobQueryArgsDict', 'JobQueryConnectionPropertyArgs', 'JobQueryConnectionPropertyArgsDict', 'JobQueryDefaultDatasetArgs', 'JobQueryDefaultDatasetArgsDict', 'JobQueryDestinationEncryptionConfigurationArgs', 'JobQueryDestinationEncryptionConfigurationArgsDict', 'JobQueryDestinationTableArgs', 'JobQueryDestinationTableArgsDict', 'JobQueryScriptOptionsArgs', 'JobQueryScriptOptionsArgsDict', 'JobQueryUserDefinedFunctionResourceArgs', 'JobQueryUserDefinedFunctionResourceArgsDict', 'JobStatusArgs', 'JobStatusArgsDict', 'JobStatusErrorArgs', 'JobStatusErrorArgsDict', 'JobStatusErrorResultArgs', 'JobStatusErrorResultArgsDict', 'ReservationAutoscaleArgs', 'ReservationAutoscaleArgsDict', 'ReservationReplicationStatusArgs', 'ReservationReplicationStatusArgsDict', 'ReservationReplicationStatusErrorArgs', 'ReservationReplicationStatusErrorArgsDict', 'RoutineArgumentArgs', 'RoutineArgumentArgsDict', 'RoutineExternalRuntimeOptionsArgs', 'RoutineExternalRuntimeOptionsArgsDict', 'RoutinePythonOptionsArgs', 'RoutinePythonOptionsArgsDict', 'RoutineRemoteFunctionOptionsArgs', 'RoutineRemoteFunctionOptionsArgsDict', 'RoutineSparkOptionsArgs', 'RoutineSparkOptionsArgsDict', 'TableBiglakeConfigurationArgs', 'TableBiglakeConfigurationArgsDict', 'TableEncryptionConfigurationArgs', 'TableEncryptionConfigurationArgsDict', 'TableExternalCatalogTableOptionsArgs', 'TableExternalCatalogTableOptionsArgsDict', ..., ..., ..., ..., 'TableExternalDataConfigurationArgs', 'TableExternalDataConfigurationArgsDict', 'TableExternalDataConfigurationAvroOptionsArgs', 'TableExternalDataConfigurationAvroOptionsArgsDict', 'TableExternalDataConfigurationBigtableOptionsArgs', ..., ..., ..., ..., ..., 'TableExternalDataConfigurationCsvOptionsArgs', 'TableExternalDataConfigurationCsvOptionsArgsDict', ..., ..., ..., ..., 'TableExternalDataConfigurationJsonOptionsArgs', 'TableExternalDataConfigurationJsonOptionsArgsDict', 'TableExternalDataConfigurationParquetOptionsArgs', ..., 'TableMaterializedViewArgs', 'TableMaterializedViewArgsDict', 'TableRangePartitioningArgs', 'TableRangePartitioningArgsDict', 'TableRangePartitioningRangeArgs', 'TableRangePartitioningRangeArgsDict', 'TableSchemaForeignTypeInfoArgs', 'TableSchemaForeignTypeInfoArgsDict', 'TableTableConstraintsArgs', 'TableTableConstraintsArgsDict', 'TableTableConstraintsForeignKeyArgs', 'TableTableConstraintsForeignKeyArgsDict', ..., ..., 'TableTableConstraintsForeignKeyReferencedTableArgs', ..., 'TableTableConstraintsPrimaryKeyArgs', 'TableTableConstraintsPrimaryKeyArgsDict', 'TableTableReplicationInfoArgs', 'TableTableReplicationInfoArgsDict', 'TableTimePartitioningArgs', 'TableTimePartitioningArgsDict', 'TableViewArgs', 'TableViewArgsDict']
...
class AppProfileDataBoostIsolationReadOnlyArgs:
    def __init__(__self__, *, compute_billing_owner: pulumi.Input[_builtins.str]) -> None:
    ...
    def compute_billing_owner(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class AppProfileSingleClusterRoutingArgs:
    def __init__(__self__, *, cluster_id: pulumi.Input[_builtins.str], allow_transactional_writes: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def allow_transactional_writes(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ConnectionAwsArgs:
    def __init__(__self__, *, access_role: pulumi.Input[ConnectionAwsAccessRoleArgs]) -> None:
    ...
    @access_role.setter
    def access_role(self, value: pulumi.Input[ConnectionAwsAccessRoleArgs]): # -> None:
        ...
...
class ConnectionAwsAccessRoleArgs:
    def __init__(__self__, *, iam_role_id: pulumi.Input[_builtins.str], identity: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @iam_role_id.setter
    def iam_role_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class ConnectionAzureArgs:
    def __init__(__self__, *, customer_tenant_id: pulumi.Input[_builtins.str], application: Optional[pulumi.Input[_builtins.str]] = ..., client_id: Optional[pulumi.Input[_builtins.str]] = ..., federated_application_client_id: Optional[pulumi.Input[_builtins.str]] = ..., identity: Optional[pulumi.Input[_builtins.str]] = ..., object_id: Optional[pulumi.Input[_builtins.str]] = ..., redirect_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def customer_tenant_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def federated_application_client_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ConnectionCloudResourceArgs:
    def __init__(__self__, *, service_account_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ConnectionCloudSpannerArgs:
    def __init__(__self__, *, database: pulumi.Input[_builtins.str], database_role: Optional[pulumi.Input[_builtins.str]] = ..., max_parallelism: Optional[pulumi.Input[_builtins.int]] = ..., use_data_boost: Optional[pulumi.Input[_builtins.bool]] = ..., use_parallelism: Optional[pulumi.Input[_builtins.bool]] = ..., use_serverless_analytics: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def database_role(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def use_data_boost(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def use_parallelism(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def use_serverless_analytics(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class ConnectionCloudSqlArgs:
    def __init__(__self__, *, credential: pulumi.Input[ConnectionCloudSqlCredentialArgs], database: pulumi.Input[_builtins.str], instance_id: pulumi.Input[_builtins.str], type: pulumi.Input[_builtins.str], service_account_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @credential.setter
    def credential(self, value: pulumi.Input[ConnectionCloudSqlCredentialArgs]): # -> None:
        ...
...
class ConnectionSparkArgs:
    def __init__(__self__, *, metastore_service_config: Optional[pulumi.Input[ConnectionSparkMetastoreServiceConfigArgs]] = ..., service_account_id: Optional[pulumi.Input[_builtins.str]] = ..., spark_history_server_config: Optional[pulumi.Input[ConnectionSparkSparkHistoryServerConfigArgs]] = ...) -> None:
    ...
    def metastore_service_config(self, value: Optional[pulumi.Input[ConnectionSparkMetastoreServiceConfigArgs]]): # -> None:
        ...
    ...
    def spark_history_server_config(self, value: Optional[pulumi.Input[ConnectionSparkSparkHistoryServerConfigArgs]]): # -> None:
        ...
...
class ConnectionSparkMetastoreServiceConfigArgs:
    def __init__(__self__, *, metastore_service: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class DataTransferConfigEmailPreferencesArgs:
    def __init__(__self__, *, enable_failure_email: pulumi.Input[_builtins.bool]) -> None:
    ...
    def enable_failure_email(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class DataTransferConfigScheduleOptionsArgs:
    def __init__(__self__, *, disable_auto_scheduling: Optional[pulumi.Input[_builtins.bool]] = ..., end_time: Optional[pulumi.Input[_builtins.str]] = ..., start_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def disable_auto_scheduling(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class DataTransferConfigSensitiveParamsArgs:
    def __init__(__self__, *, secret_access_key: Optional[pulumi.Input[_builtins.str]] = ..., secret_access_key_wo: Optional[pulumi.Input[_builtins.str]] = ..., secret_access_key_wo_version: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def secret_access_key_wo(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def secret_access_key_wo_version(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class Datapolicyv2DataPolicyDataMaskingPolicyArgs:
    def __init__(__self__, *, predefined_expression: Optional[pulumi.Input[_builtins.str]] = ..., routine: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def predefined_expression(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @routine.setter
    def routine(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DatasetAccessArgs:
    def __init__(__self__, *, condition: Optional[pulumi.Input[DatasetAccessConditionArgs]] = ..., dataset: Optional[pulumi.Input[DatasetAccessDatasetArgs]] = ..., domain: Optional[pulumi.Input[_builtins.str]] = ..., group_by_email: Optional[pulumi.Input[_builtins.str]] = ..., iam_member: Optional[pulumi.Input[_builtins.str]] = ..., role: Optional[pulumi.Input[_builtins.str]] = ..., routine: Optional[pulumi.Input[DatasetAccessRoutineArgs]] = ..., special_group: Optional[pulumi.Input[_builtins.str]] = ..., user_by_email: Optional[pulumi.Input[_builtins.str]] = ..., view: Optional[pulumi.Input[DatasetAccessViewArgs]] = ...) -> None:
    ...
    @condition.setter
    def condition(self, value: Optional[pulumi.Input[DatasetAccessConditionArgs]]): # -> None:
        ...
    ...
    @dataset.setter
    def dataset(self, value: Optional[pulumi.Input[DatasetAccessDatasetArgs]]): # -> None:
        ...
    ...
    def group_by_email(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @iam_member.setter
    def iam_member(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @routine.setter
    def routine(self, value: Optional[pulumi.Input[DatasetAccessRoutineArgs]]): # -> None:
        ...
    ...
    def special_group(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def user_by_email(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @view.setter
    def view(self, value: Optional[pulumi.Input[DatasetAccessViewArgs]]): # -> None:
        ...
...
class DatasetAccessAuthorizedDatasetArgs:
    def __init__(__self__, *, dataset: pulumi.Input[DatasetAccessAuthorizedDatasetDatasetArgs], target_types: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @dataset.setter
    def dataset(self, value: pulumi.Input[DatasetAccessAuthorizedDatasetDatasetArgs]): # -> None:
        ...
    ...
    @target_types.setter
    def target_types(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
...
class DatasetAccessAuthorizedDatasetDatasetArgs:
    def __init__(__self__, *, dataset_id: pulumi.Input[_builtins.str], project_id: pulumi.Input[_builtins.str]) -> None:
...
class DatasetAccessDatasetArgs:
    def __init__(__self__, *, dataset: pulumi.Input[DatasetAccessDatasetDatasetArgs], target_types: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]) -> None:
    ...
    @dataset.setter
    def dataset(self, value: pulumi.Input[DatasetAccessDatasetDatasetArgs]): # -> None:
        ...
...
class DatasetAccessRoutineArgs:
    def __init__(__self__, *, dataset_id: pulumi.Input[_builtins.str], project_id: pulumi.Input[_builtins.str], routine_id: pulumi.Input[_builtins.str]) -> None:
...
class DatasetExternalCatalogDatasetOptionsArgs:
    def __init__(__self__, *, default_storage_location_uri: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def default_storage_location_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class DatasetExternalDatasetReferenceArgs:
    def __init__(__self__, *, connection: pulumi.Input[_builtins.str], external_source: pulumi.Input[_builtins.str]) -> None:
    ...
    @connection.setter
    def connection(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def external_source(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
@pulumi.input_type
class JobCopyArgs:
    def __init__(__self__, *, source_tables: pulumi.Input[Sequence[pulumi.Input[JobCopySourceTableArgs]]], create_disposition: Optional[pulumi.Input[_builtins.str]] = ..., destination_encryption_configuration: Optional[pulumi.Input[JobCopyDestinationEncryptionConfigurationArgs]] = ..., destination_table: Optional[pulumi.Input[JobCopyDestinationTableArgs]] = ..., write_disposition: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def source_tables(self, value: pulumi.Input[Sequence[pulumi.Input[JobCopySourceTableArgs]]]): # -> None:
        ...
    ...
    def create_disposition(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def destination_encryption_configuration(self, value: Optional[pulumi.Input[JobCopyDestinationEncryptionConfigurationArgs]]): # -> None:
        ...
    ...
    def destination_table(self, value: Optional[pulumi.Input[JobCopyDestinationTableArgs]]): # -> None:
        ...
    ...
    def write_disposition(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class JobCopyDestinationEncryptionConfigurationArgs:
    def __init__(__self__, *, kms_key_name: pulumi.Input[_builtins.str], kms_key_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JobCopyDestinationTableArgs:
    def __init__(__self__, *, table_id: pulumi.Input[_builtins.str], dataset_id: Optional[pulumi.Input[_builtins.str]] = ..., project_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JobExtractArgs:
    def __init__(__self__, *, destination_uris: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], compression: Optional[pulumi.Input[_builtins.str]] = ..., destination_format: Optional[pulumi.Input[_builtins.str]] = ..., field_delimiter: Optional[pulumi.Input[_builtins.str]] = ..., print_header: Optional[pulumi.Input[_builtins.bool]] = ..., source_model: Optional[pulumi.Input[JobExtractSourceModelArgs]] = ..., source_table: Optional[pulumi.Input[JobExtractSourceTableArgs]] = ..., use_avro_logical_types: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def destination_uris(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def destination_format(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @print_header.setter
    def print_header(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @source_model.setter
    def source_model(self, value: Optional[pulumi.Input[JobExtractSourceModelArgs]]): # -> None:
        ...
    ...
    @source_table.setter
    def source_table(self, value: Optional[pulumi.Input[JobExtractSourceTableArgs]]): # -> None:
        ...
    ...
    def use_avro_logical_types(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class JobExtractSourceModelArgs:
    def __init__(__self__, *, dataset_id: pulumi.Input[_builtins.str], model_id: pulumi.Input[_builtins.str], project_id: pulumi.Input[_builtins.str]) -> None:
...
@pulumi.input_type
class JobLoadArgs:
    def __init__(__self__, *, destination_table: pulumi.Input[JobLoadDestinationTableArgs], source_uris: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], allow_jagged_rows: Optional[pulumi.Input[_builtins.bool]] = ..., allow_quoted_newlines: Optional[pulumi.Input[_builtins.bool]] = ..., autodetect: Optional[pulumi.Input[_builtins.bool]] = ..., create_disposition: Optional[pulumi.Input[_builtins.str]] = ..., destination_encryption_configuration: Optional[pulumi.Input[JobLoadDestinationEncryptionConfigurationArgs]] = ..., encoding: Optional[pulumi.Input[_builtins.str]] = ..., field_delimiter: Optional[pulumi.Input[_builtins.str]] = ..., ignore_unknown_values: Optional[pulumi.Input[_builtins.bool]] = ..., json_extension: Optional[pulumi.Input[_builtins.str]] = ..., max_bad_records: Optional[pulumi.Input[_builtins.int]] = ..., null_marker: Optional[pulumi.Input[_builtins.str]] = ..., parquet_options: Optional[pulumi.Input[JobLoadParquetOptionsArgs]] = ..., projection_fields: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., quote: Optional[pulumi.Input[_builtins.str]] = ..., schema_update_options: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., skip_leading_rows: Optional[pulumi.Input[_builtins.int]] = ..., source_format: Optional[pulumi.Input[_builtins.str]] = ..., time_partitioning: Optional[pulumi.Input[JobLoadTimePartitioningArgs]] = ..., write_disposition: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @destination_table.setter
    def destination_table(self, value: pulumi.Input[JobLoadDestinationTableArgs]): # -> None:
        ...
    ...
    @source_uris.setter
    def source_uris(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]): # -> None:
        ...
    ...
    def allow_jagged_rows(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def allow_quoted_newlines(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @autodetect.setter
    def autodetect(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    @destination_encryption_configuration.setter
    def destination_encryption_configuration(self, value: Optional[pulumi.Input[JobLoadDestinationEncryptionConfigurationArgs]]): # -> None:
        ...
    ...
    def ignore_unknown_values(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def json_extension(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_bad_records(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @null_marker.setter
    def null_marker(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def parquet_options(self, value: Optional[pulumi.Input[JobLoadParquetOptionsArgs]]): # -> None:
        ...
    ...
    def projection_fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    @quote.setter
    def quote(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def schema_update_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def skip_leading_rows(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def time_partitioning(self, value: Optional[pulumi.Input[JobLoadTimePartitioningArgs]]): # -> None:
        ...
...
class JobLoadParquetOptionsArgs:
    def __init__(__self__, *, enable_list_inference: Optional[pulumi.Input[_builtins.bool]] = ..., enum_as_string: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def enable_list_inference(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enum_as_string(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class JobLoadTimePartitioningArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], expiration_ms: Optional[pulumi.Input[_builtins.str]] = ..., field: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def expiration_ms(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class JobQueryArgs:
    def __init__(__self__, *, query: pulumi.Input[_builtins.str], allow_large_results: Optional[pulumi.Input[_builtins.bool]] = ..., connection_properties: Optional[pulumi.Input[Sequence[pulumi.Input[JobQueryConnectionPropertyArgs]]]] = ..., continuous: Optional[pulumi.Input[_builtins.bool]] = ..., create_disposition: Optional[pulumi.Input[_builtins.str]] = ..., default_dataset: Optional[pulumi.Input[JobQueryDefaultDatasetArgs]] = ..., destination_encryption_configuration: Optional[pulumi.Input[JobQueryDestinationEncryptionConfigurationArgs]] = ..., destination_table: Optional[pulumi.Input[JobQueryDestinationTableArgs]] = ..., flatten_results: Optional[pulumi.Input[_builtins.bool]] = ..., maximum_billing_tier: Optional[pulumi.Input[_builtins.int]] = ..., maximum_bytes_billed: Optional[pulumi.Input[_builtins.str]] = ..., parameter_mode: Optional[pulumi.Input[_builtins.str]] = ..., priority: Optional[pulumi.Input[_builtins.str]] = ..., schema_update_options: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., script_options: Optional[pulumi.Input[JobQueryScriptOptionsArgs]] = ..., use_legacy_sql: Optional[pulumi.Input[_builtins.bool]] = ..., use_query_cache: Optional[pulumi.Input[_builtins.bool]] = ..., user_defined_function_resources: Optional[pulumi.Input[Sequence[pulumi.Input[JobQueryUserDefinedFunctionResourceArgs]]]] = ..., write_disposition: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def allow_large_results(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def connection_properties(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobQueryConnectionPropertyArgs]]]]): # -> None:
        ...
    ...
    def default_dataset(self, value: Optional[pulumi.Input[JobQueryDefaultDatasetArgs]]): # -> None:
        ...
    ...
    @destination_encryption_configuration.setter
    def destination_encryption_configuration(self, value: Optional[pulumi.Input[JobQueryDestinationEncryptionConfigurationArgs]]): # -> None:
        ...
    ...
    @destination_table.setter
    def destination_table(self, value: Optional[pulumi.Input[JobQueryDestinationTableArgs]]): # -> None:
        ...
    ...
    def flatten_results(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def maximum_billing_tier(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    def maximum_bytes_billed(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def parameter_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def script_options(self, value: Optional[pulumi.Input[JobQueryScriptOptionsArgs]]): # -> None:
        ...
    ...
    def use_legacy_sql(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def use_query_cache(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def user_defined_function_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobQueryUserDefinedFunctionResourceArgs]]]]): # -> None:
        ...
...
class JobQueryDefaultDatasetArgs:
    def __init__(__self__, *, dataset_id: pulumi.Input[_builtins.str], project_id: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class JobQueryScriptOptionsArgs:
    def __init__(__self__, *, key_result_statement: Optional[pulumi.Input[_builtins.str]] = ..., statement_byte_budget: Optional[pulumi.Input[_builtins.str]] = ..., statement_timeout_ms: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def key_result_statement(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def statement_byte_budget(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def statement_timeout_ms(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class JobQueryUserDefinedFunctionResourceArgs:
    def __init__(__self__, *, inline_code: Optional[pulumi.Input[_builtins.str]] = ..., resource_uri: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @inline_code.setter
    def inline_code(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
@pulumi.input_type
class JobStatusArgs:
    def __init__(__self__, *, error_results: Optional[pulumi.Input[Sequence[pulumi.Input[JobStatusErrorResultArgs]]]] = ..., errors: Optional[pulumi.Input[Sequence[pulumi.Input[JobStatusErrorArgs]]]] = ..., state: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def error_results(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobStatusErrorResultArgs]]]]): # -> None:
        ...
    ...
    @errors.setter
    def errors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[JobStatusErrorArgs]]]]): # -> None:
        ...
...
class JobStatusErrorArgs:
    def __init__(__self__, *, location: Optional[pulumi.Input[_builtins.str]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ..., reason: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class ReservationAutoscaleArgs:
    def __init__(__self__, *, current_slots: Optional[pulumi.Input[_builtins.int]] = ..., max_slots: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def current_slots(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
    ...
    @max_slots.setter
    def max_slots(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class ReservationReplicationStatusArgs:
    def __init__(__self__, *, errors: Optional[pulumi.Input[Sequence[pulumi.Input[ReservationReplicationStatusErrorArgs]]]] = ..., last_error_time: Optional[pulumi.Input[_builtins.str]] = ..., last_replication_time: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @errors.setter
    def errors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[ReservationReplicationStatusErrorArgs]]]]): # -> None:
        ...
    ...
    def last_error_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def last_replication_time(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class ReservationReplicationStatusErrorArgs:
    def __init__(__self__, *, code: Optional[pulumi.Input[_builtins.int]] = ..., message: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class RoutineArgumentArgs:
    def __init__(__self__, *, argument_kind: Optional[pulumi.Input[_builtins.str]] = ..., data_type: Optional[pulumi.Input[_builtins.str]] = ..., mode: Optional[pulumi.Input[_builtins.str]] = ..., name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def argument_kind(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RoutineExternalRuntimeOptionsArgs:
    def __init__(__self__, *, container_cpu: Optional[pulumi.Input[_builtins.float]] = ..., container_memory: Optional[pulumi.Input[_builtins.str]] = ..., max_batching_rows: Optional[pulumi.Input[_builtins.str]] = ..., runtime_connection: Optional[pulumi.Input[_builtins.str]] = ..., runtime_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def container_cpu(self, value: Optional[pulumi.Input[_builtins.float]]): # -> None:
        ...
    ...
    def container_memory(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def max_batching_rows(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def runtime_connection(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class RoutinePythonOptionsArgs:
    def __init__(__self__, *, entry_point: pulumi.Input[_builtins.str], packages: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @packages.setter
    def packages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RoutineRemoteFunctionOptionsArgs:
    def __init__(__self__, *, connection: Optional[pulumi.Input[_builtins.str]] = ..., endpoint: Optional[pulumi.Input[_builtins.str]] = ..., max_batching_rows: Optional[pulumi.Input[_builtins.str]] = ..., user_defined_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    @connection.setter
    def connection(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def user_defined_context(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class RoutineSparkOptionsArgs:
    def __init__(__self__, *, archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., connection: Optional[pulumi.Input[_builtins.str]] = ..., container_image: Optional[pulumi.Input[_builtins.str]] = ..., file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., jar_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., main_class: Optional[pulumi.Input[_builtins.str]] = ..., main_file_uri: Optional[pulumi.Input[_builtins.str]] = ..., properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., py_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., runtime_version: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @jar_uris.setter
    def jar_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def main_file_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @py_file_uris.setter
    def py_file_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
...
class TableBiglakeConfigurationArgs:
    def __init__(__self__, *, connection_id: pulumi.Input[_builtins.str], file_format: pulumi.Input[_builtins.str], storage_uri: pulumi.Input[_builtins.str], table_format: pulumi.Input[_builtins.str]) -> None:
    ...
    @storage_uri.setter
    def storage_uri(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TableExternalCatalogTableOptionsArgs:
    def __init__(__self__, *, connection_id: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ..., storage_descriptor: Optional[pulumi.Input[TableExternalCatalogTableOptionsStorageDescriptorArgs]] = ...) -> None:
    ...
    def storage_descriptor(self, value: Optional[pulumi.Input[TableExternalCatalogTableOptionsStorageDescriptorArgs]]): # -> None:
        ...
...
class TableExternalCatalogTableOptionsStorageDescriptorArgs:
    def __init__(__self__, *, input_format: Optional[pulumi.Input[_builtins.str]] = ..., location_uri: Optional[pulumi.Input[_builtins.str]] = ..., output_format: Optional[pulumi.Input[_builtins.str]] = ..., serde_info: Optional[pulumi.Input[TableExternalCatalogTableOptionsStorageDescriptorSerdeInfoArgs]] = ...) -> None:
    ...
    @serde_info.setter
    def serde_info(self, value: Optional[pulumi.Input[TableExternalCatalogTableOptionsStorageDescriptorSerdeInfoArgs]]): # -> None:
        ...
...
class TableExternalCatalogTableOptionsStorageDescriptorSerdeInfoArgs:
    def __init__(__self__, *, serialization_library: pulumi.Input[_builtins.str], name: Optional[pulumi.Input[_builtins.str]] = ..., parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = ...) -> None:
    ...
    def serialization_library(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TableExternalDataConfigurationArgs:
    def __init__(__self__, *, autodetect: pulumi.Input[_builtins.bool], source_uris: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]], avro_options: Optional[pulumi.Input[TableExternalDataConfigurationAvroOptionsArgs]] = ..., bigtable_options: Optional[pulumi.Input[TableExternalDataConfigurationBigtableOptionsArgs]] = ..., compression: Optional[pulumi.Input[_builtins.str]] = ..., connection_id: Optional[pulumi.Input[_builtins.str]] = ..., csv_options: Optional[pulumi.Input[TableExternalDataConfigurationCsvOptionsArgs]] = ..., decimal_target_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = ..., file_set_spec_type: Optional[pulumi.Input[_builtins.str]] = ..., google_sheets_options: Optional[pulumi.Input[TableExternalDataConfigurationGoogleSheetsOptionsArgs]] = ..., hive_partitioning_options: Optional[pulumi.Input[TableExternalDataConfigurationHivePartitioningOptionsArgs]] = ..., ignore_unknown_values: Optional[pulumi.Input[_builtins.bool]] = ..., json_extension: Optional[pulumi.Input[_builtins.str]] = ..., json_options: Optional[pulumi.Input[TableExternalDataConfigurationJsonOptionsArgs]] = ..., max_bad_records: Optional[pulumi.Input[_builtins.int]] = ..., metadata_cache_mode: Optional[pulumi.Input[_builtins.str]] = ..., object_metadata: Optional[pulumi.Input[_builtins.str]] = ..., parquet_options: Optional[pulumi.Input[TableExternalDataConfigurationParquetOptionsArgs]] = ..., reference_file_schema_uri: Optional[pulumi.Input[_builtins.str]] = ..., schema: Optional[pulumi.Input[_builtins.str]] = ..., source_format: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @autodetect.setter
    def autodetect(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
    ...
    @avro_options.setter
    def avro_options(self, value: Optional[pulumi.Input[TableExternalDataConfigurationAvroOptionsArgs]]): # -> None:
        ...
    ...
    def bigtable_options(self, value: Optional[pulumi.Input[TableExternalDataConfigurationBigtableOptionsArgs]]): # -> None:
        ...
    ...
    @csv_options.setter
    def csv_options(self, value: Optional[pulumi.Input[TableExternalDataConfigurationCsvOptionsArgs]]): # -> None:
        ...
    ...
    def decimal_target_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]): # -> None:
        ...
    ...
    def file_set_spec_type(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def google_sheets_options(self, value: Optional[pulumi.Input[TableExternalDataConfigurationGoogleSheetsOptionsArgs]]): # -> None:
        ...
    ...
    def hive_partitioning_options(self, value: Optional[pulumi.Input[TableExternalDataConfigurationHivePartitioningOptionsArgs]]): # -> None:
        ...
    ...
    @json_options.setter
    def json_options(self, value: Optional[pulumi.Input[TableExternalDataConfigurationJsonOptionsArgs]]): # -> None:
        ...
    ...
    def metadata_cache_mode(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def object_metadata(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    @parquet_options.setter
    def parquet_options(self, value: Optional[pulumi.Input[TableExternalDataConfigurationParquetOptionsArgs]]): # -> None:
        ...
    ...
    def reference_file_schema_uri(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TableExternalDataConfigurationAvroOptionsArgs:
    def __init__(__self__, *, use_avro_logical_types: pulumi.Input[_builtins.bool]) -> None:
    ...
    @use_avro_logical_types.setter
    def use_avro_logical_types(self, value: pulumi.Input[_builtins.bool]): # -> None:
        ...
...
class TableExternalDataConfigurationBigtableOptionsArgs:
    def __init__(__self__, *, column_families: Optional[pulumi.Input[Sequence[pulumi.Input[TableExternalDataConfigurationBigtableOptionsColumnFamilyArgs]]]] = ..., ignore_unspecified_column_families: Optional[pulumi.Input[_builtins.bool]] = ..., output_column_families_as_json: Optional[pulumi.Input[_builtins.bool]] = ..., read_rowkey_as_string: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    def column_families(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TableExternalDataConfigurationBigtableOptionsColumnFamilyArgs]]]]): # -> None:
        ...
    ...
    def ignore_unspecified_column_families(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def output_column_families_as_json(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def read_rowkey_as_string(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class TableExternalDataConfigurationBigtableOptionsColumnFamilyArgs:
    def __init__(__self__, *, columns: Optional[pulumi.Input[Sequence[pulumi.Input[TableExternalDataConfigurationBigtableOptionsColumnFamilyColumnArgs]]]] = ..., encoding: Optional[pulumi.Input[_builtins.str]] = ..., family_id: Optional[pulumi.Input[_builtins.str]] = ..., only_read_latest: Optional[pulumi.Input[_builtins.bool]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @columns.setter
    def columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TableExternalDataConfigurationBigtableOptionsColumnFamilyColumnArgs]]]]): # -> None:
        ...
    ...
    @family_id.setter
    def family_id(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def only_read_latest(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
...
class TableExternalDataConfigurationBigtableOptionsColumnFamilyColumnArgs:
    def __init__(__self__, *, encoding: Optional[pulumi.Input[_builtins.str]] = ..., field_name: Optional[pulumi.Input[_builtins.str]] = ..., only_read_latest: Optional[pulumi.Input[_builtins.bool]] = ..., qualifier_encoded: Optional[pulumi.Input[_builtins.str]] = ..., qualifier_string: Optional[pulumi.Input[_builtins.str]] = ..., type: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def qualifier_encoded(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
    ...
    def qualifier_string(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TableExternalDataConfigurationCsvOptionsArgs:
    def __init__(__self__, *, quote: pulumi.Input[_builtins.str], allow_jagged_rows: Optional[pulumi.Input[_builtins.bool]] = ..., allow_quoted_newlines: Optional[pulumi.Input[_builtins.bool]] = ..., encoding: Optional[pulumi.Input[_builtins.str]] = ..., field_delimiter: Optional[pulumi.Input[_builtins.str]] = ..., skip_leading_rows: Optional[pulumi.Input[_builtins.int]] = ..., source_column_match: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    @quote.setter
    def quote(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def source_column_match(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TableExternalDataConfigurationGoogleSheetsOptionsArgs:
    def __init__(__self__, *, range: Optional[pulumi.Input[_builtins.str]] = ..., skip_leading_rows: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    @range.setter
    def range(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TableExternalDataConfigurationHivePartitioningOptionsArgs:
    def __init__(__self__, *, mode: Optional[pulumi.Input[_builtins.str]] = ..., require_partition_filter: Optional[pulumi.Input[_builtins.bool]] = ..., source_uri_prefix: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def source_uri_prefix(self, value: Optional[pulumi.Input[_builtins.str]]): # -> None:
        ...
...
class TableExternalDataConfigurationJsonOptionsArgs:
    def __init__(__self__, *, encoding: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
...
class TableMaterializedViewArgs:
    def __init__(__self__, *, query: pulumi.Input[_builtins.str], allow_non_incremental_definition: Optional[pulumi.Input[_builtins.bool]] = ..., enable_refresh: Optional[pulumi.Input[_builtins.bool]] = ..., refresh_interval_ms: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def allow_non_incremental_definition(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def enable_refresh(self, value: Optional[pulumi.Input[_builtins.bool]]): # -> None:
        ...
    ...
    def refresh_interval_ms(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class TableRangePartitioningArgs:
    def __init__(__self__, *, field: pulumi.Input[_builtins.str], range: pulumi.Input[TableRangePartitioningRangeArgs]) -> None:
    ...
    @range.setter
    def range(self, value: pulumi.Input[TableRangePartitioningRangeArgs]): # -> None:
        ...
...
class TableRangePartitioningRangeArgs:
    def __init__(__self__, *, end: pulumi.Input[_builtins.int], interval: pulumi.Input[_builtins.int], start: pulumi.Input[_builtins.int]) -> None:
...
class TableSchemaForeignTypeInfoArgs:
    ...
    @type_system.setter
    def type_system(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TableTableConstraintsArgs:
    def __init__(__self__, *, foreign_keys: Optional[pulumi.Input[Sequence[pulumi.Input[TableTableConstraintsForeignKeyArgs]]]] = ..., primary_key: Optional[pulumi.Input[TableTableConstraintsPrimaryKeyArgs]] = ...) -> None:
    ...
    @foreign_keys.setter
    def foreign_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[TableTableConstraintsForeignKeyArgs]]]]): # -> None:
        ...
    ...
    @primary_key.setter
    def primary_key(self, value: Optional[pulumi.Input[TableTableConstraintsPrimaryKeyArgs]]): # -> None:
        ...
...
class TableTableConstraintsForeignKeyArgs:
    def __init__(__self__, *, column_references: pulumi.Input[TableTableConstraintsForeignKeyColumnReferencesArgs], referenced_table: pulumi.Input[TableTableConstraintsForeignKeyReferencedTableArgs], name: Optional[pulumi.Input[_builtins.str]] = ...) -> None:
    ...
    def column_references(self, value: pulumi.Input[TableTableConstraintsForeignKeyColumnReferencesArgs]): # -> None:
        ...
    ...
    def referenced_table(self, value: pulumi.Input[TableTableConstraintsForeignKeyReferencedTableArgs]): # -> None:
        ...
...
class TableTableConstraintsForeignKeyColumnReferencesArgs:
    def __init__(__self__, *, referenced_column: pulumi.Input[_builtins.str], referencing_column: pulumi.Input[_builtins.str]) -> None:
    ...
    def referenced_column(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def referencing_column(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
...
class TableTableReplicationInfoArgs:
    def __init__(__self__, *, source_dataset_id: pulumi.Input[_builtins.str], source_project_id: pulumi.Input[_builtins.str], source_table_id: pulumi.Input[_builtins.str], replication_interval_ms: Optional[pulumi.Input[_builtins.int]] = ...) -> None:
    ...
    def source_dataset_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def source_project_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def source_table_id(self, value: pulumi.Input[_builtins.str]): # -> None:
        ...
    ...
    def replication_interval_ms(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
class TableTimePartitioningArgs:
    def __init__(__self__, *, type: pulumi.Input[_builtins.str], expiration_ms: Optional[pulumi.Input[_builtins.int]] = ..., field: Optional[pulumi.Input[_builtins.str]] = ..., require_partition_filter: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
    ...
    @expiration_ms.setter
    def expiration_ms(self, value: Optional[pulumi.Input[_builtins.int]]): # -> None:
        ...
...
@pulumi.input_type
class TableViewArgs:
    def __init__(__self__, *, query: pulumi.Input[_builtins.str], use_legacy_sql: Optional[pulumi.Input[_builtins.bool]] = ...) -> None:
