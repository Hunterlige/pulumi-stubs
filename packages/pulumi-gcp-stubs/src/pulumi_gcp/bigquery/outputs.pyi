...
if sys.version_info >= (3, 11):
    ...
    ...
__all__ = ['AppProfileDataBoostIsolationReadOnly', 'AppProfileSingleClusterRouting', 'AppProfileStandardIsolation', 'BiReservationPreferredTable', 'ConnectionAws', 'ConnectionAwsAccessRole', 'ConnectionAzure', 'ConnectionCloudResource', 'ConnectionCloudSpanner', 'ConnectionCloudSql', 'ConnectionCloudSqlCredential', 'ConnectionIamBindingCondition', 'ConnectionIamMemberCondition', 'ConnectionSpark', 'ConnectionSparkMetastoreServiceConfig', 'ConnectionSparkSparkHistoryServerConfig', 'DataTransferConfigEmailPreferences', 'DataTransferConfigEncryptionConfiguration', 'DataTransferConfigScheduleOptions', 'DataTransferConfigSensitiveParams', 'Datapolicyv2DataPolicyDataMaskingPolicy', 'Datapolicyv2DataPolicyIamBindingCondition', 'Datapolicyv2DataPolicyIamMemberCondition', 'DatasetAccess', 'DatasetAccessAuthorizedDataset', 'DatasetAccessAuthorizedDatasetDataset', 'DatasetAccessCondition', 'DatasetAccessDataset', 'DatasetAccessDatasetDataset', 'DatasetAccessRoutine', 'DatasetAccessView', 'DatasetDefaultEncryptionConfiguration', 'DatasetExternalCatalogDatasetOptions', 'DatasetExternalDatasetReference', 'DatasetIamBindingCondition', 'DatasetIamMemberCondition', 'IamBindingCondition', 'IamMemberCondition', 'JobCopy', 'JobCopyDestinationEncryptionConfiguration', 'JobCopyDestinationTable', 'JobCopySourceTable', 'JobExtract', 'JobExtractSourceModel', 'JobExtractSourceTable', 'JobLoad', 'JobLoadDestinationEncryptionConfiguration', 'JobLoadDestinationTable', 'JobLoadParquetOptions', 'JobLoadTimePartitioning', 'JobQuery', 'JobQueryConnectionProperty', 'JobQueryDefaultDataset', 'JobQueryDestinationEncryptionConfiguration', 'JobQueryDestinationTable', 'JobQueryScriptOptions', 'JobQueryUserDefinedFunctionResource', 'JobStatus', 'JobStatusError', 'JobStatusErrorResult', 'ReservationAutoscale', 'ReservationReplicationStatus', 'ReservationReplicationStatusError', 'RoutineArgument', 'RoutineExternalRuntimeOptions', 'RoutinePythonOptions', 'RoutineRemoteFunctionOptions', 'RoutineSparkOptions', 'TableBiglakeConfiguration', 'TableEncryptionConfiguration', 'TableExternalCatalogTableOptions', 'TableExternalCatalogTableOptionsStorageDescriptor', ..., 'TableExternalDataConfiguration', 'TableExternalDataConfigurationAvroOptions', 'TableExternalDataConfigurationBigtableOptions', ..., ..., 'TableExternalDataConfigurationCsvOptions', 'TableExternalDataConfigurationGoogleSheetsOptions', ..., 'TableExternalDataConfigurationJsonOptions', 'TableExternalDataConfigurationParquetOptions', 'TableMaterializedView', 'TableRangePartitioning', 'TableRangePartitioningRange', 'TableSchemaForeignTypeInfo', 'TableTableConstraints', 'TableTableConstraintsForeignKey', 'TableTableConstraintsForeignKeyColumnReferences', 'TableTableConstraintsForeignKeyReferencedTable', 'TableTableConstraintsPrimaryKey', 'TableTableReplicationInfo', 'TableTimePartitioning', 'TableView', 'GetDatasetAccessResult', 'GetDatasetAccessConditionResult', 'GetDatasetAccessDatasetResult', 'GetDatasetAccessDatasetDatasetResult', 'GetDatasetAccessRoutineResult', 'GetDatasetAccessViewResult', 'GetDatasetDefaultEncryptionConfigurationResult', 'GetDatasetExternalCatalogDatasetOptionResult', 'GetDatasetExternalDatasetReferenceResult', 'GetDatasetsDatasetResult', 'GetTableBiglakeConfigurationResult', 'GetTableEncryptionConfigurationResult', 'GetTableExternalCatalogTableOptionResult', ..., ..., 'GetTableExternalDataConfigurationResult', 'GetTableExternalDataConfigurationAvroOptionResult', ..., ..., ..., 'GetTableExternalDataConfigurationCsvOptionResult', ..., ..., 'GetTableExternalDataConfigurationJsonOptionResult', ..., 'GetTableMaterializedViewResult', 'GetTableRangePartitioningResult', 'GetTableRangePartitioningRangeResult', 'GetTableSchemaForeignTypeInfoResult', 'GetTableTableConstraintResult', 'GetTableTableConstraintForeignKeyResult', ..., ..., 'GetTableTableConstraintPrimaryKeyResult', 'GetTableTableReplicationInfoResult', 'GetTableTimePartitioningResult', 'GetTableViewResult', 'GetTablesTableResult']
@pulumi.output_type
...
class AppProfileSingleClusterRouting(dict):
    ...
    def __init__(__self__, *, cluster_id: _builtins.str, allow_transactional_writes: Optional[_builtins.bool] = ...) -> None:
...
class ConnectionAwsAccessRole(dict):
    ...
    def __init__(__self__, *, iam_role_id: _builtins.str, identity: Optional[_builtins.str] = ...) -> None:
...
class ConnectionAzure(dict):
    ...
    def __init__(__self__, *, customer_tenant_id: _builtins.str, application: Optional[_builtins.str] = ..., client_id: Optional[_builtins.str] = ..., federated_application_client_id: Optional[_builtins.str] = ..., identity: Optional[_builtins.str] = ..., object_id: Optional[_builtins.str] = ..., redirect_uri: Optional[_builtins.str] = ...) -> None:
...
class ConnectionCloudResource(dict):
    ...
    def __init__(__self__, *, service_account_id: Optional[_builtins.str] = ...) -> None:
...
class ConnectionCloudSpanner(dict):
    ...
    def __init__(__self__, *, database: _builtins.str, database_role: Optional[_builtins.str] = ..., max_parallelism: Optional[_builtins.int] = ..., use_data_boost: Optional[_builtins.bool] = ..., use_parallelism: Optional[_builtins.bool] = ..., use_serverless_analytics: Optional[_builtins.bool] = ...) -> None:
...
class ConnectionCloudSql(dict):
    ...
    def __init__(__self__, *, credential: outputs.ConnectionCloudSqlCredential, database: _builtins.str, instance_id: _builtins.str, type: _builtins.str, service_account_id: Optional[_builtins.str] = ...) -> None:
...
class ConnectionSpark(dict):
    ...
    def __init__(__self__, *, metastore_service_config: Optional[outputs.ConnectionSparkMetastoreServiceConfig] = ..., service_account_id: Optional[_builtins.str] = ..., spark_history_server_config: Optional[outputs.ConnectionSparkSparkHistoryServerConfig] = ...) -> None:
...
class ConnectionSparkMetastoreServiceConfig(dict):
    ...
    def __init__(__self__, *, metastore_service: Optional[_builtins.str] = ...) -> None:
...
class DataTransferConfigScheduleOptions(dict):
    ...
    def __init__(__self__, *, disable_auto_scheduling: Optional[_builtins.bool] = ..., end_time: Optional[_builtins.str] = ..., start_time: Optional[_builtins.str] = ...) -> None:
...
class DataTransferConfigSensitiveParams(dict):
    ...
    def __init__(__self__, *, secret_access_key: Optional[_builtins.str] = ..., secret_access_key_wo: Optional[_builtins.str] = ..., secret_access_key_wo_version: Optional[_builtins.int] = ...) -> None:
...
class Datapolicyv2DataPolicyDataMaskingPolicy(dict):
    ...
    def __init__(__self__, *, predefined_expression: Optional[_builtins.str] = ..., routine: Optional[_builtins.str] = ...) -> None:
...
class DatasetAccess(dict):
    ...
    def __init__(__self__, *, condition: Optional[outputs.DatasetAccessCondition] = ..., dataset: Optional[outputs.DatasetAccessDataset] = ..., domain: Optional[_builtins.str] = ..., group_by_email: Optional[_builtins.str] = ..., iam_member: Optional[_builtins.str] = ..., role: Optional[_builtins.str] = ..., routine: Optional[outputs.DatasetAccessRoutine] = ..., special_group: Optional[_builtins.str] = ..., user_by_email: Optional[_builtins.str] = ..., view: Optional[outputs.DatasetAccessView] = ...) -> None:
...
class DatasetAccessAuthorizedDataset(dict):
    ...
    def __init__(__self__, *, dataset: outputs.DatasetAccessAuthorizedDatasetDataset, target_types: Sequence[_builtins.str]) -> None:
...
class DatasetAccessAuthorizedDatasetDataset(dict):
    ...
    def __init__(__self__, *, dataset_id: _builtins.str, project_id: _builtins.str) -> None:
...
class DatasetAccessDataset(dict):
    ...
    def __init__(__self__, *, dataset: outputs.DatasetAccessDatasetDataset, target_types: Sequence[_builtins.str]) -> None:
...
class DatasetAccessRoutine(dict):
    ...
    def __init__(__self__, *, dataset_id: _builtins.str, project_id: _builtins.str, routine_id: _builtins.str) -> None:
...
class DatasetExternalCatalogDatasetOptions(dict):
    ...
    def __init__(__self__, *, default_storage_location_uri: Optional[_builtins.str] = ..., parameters: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class DatasetExternalDatasetReference(dict):
    ...
    def __init__(__self__, *, connection: _builtins.str, external_source: _builtins.str) -> None:
...
class JobCopy(dict):
    ...
    def __init__(__self__, *, source_tables: Sequence[outputs.JobCopySourceTable], create_disposition: Optional[_builtins.str] = ..., destination_encryption_configuration: Optional[outputs.JobCopyDestinationEncryptionConfiguration] = ..., destination_table: Optional[outputs.JobCopyDestinationTable] = ..., write_disposition: Optional[_builtins.str] = ...) -> None:
...
class JobCopyDestinationEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *, kms_key_name: _builtins.str, kms_key_version: Optional[_builtins.str] = ...) -> None:
...
class JobCopyDestinationTable(dict):
    ...
    def __init__(__self__, *, table_id: _builtins.str, dataset_id: Optional[_builtins.str] = ..., project_id: Optional[_builtins.str] = ...) -> None:
...
class JobExtract(dict):
    ...
    def __init__(__self__, *, destination_uris: Sequence[_builtins.str], compression: Optional[_builtins.str] = ..., destination_format: Optional[_builtins.str] = ..., field_delimiter: Optional[_builtins.str] = ..., print_header: Optional[_builtins.bool] = ..., source_model: Optional[outputs.JobExtractSourceModel] = ..., source_table: Optional[outputs.JobExtractSourceTable] = ..., use_avro_logical_types: Optional[_builtins.bool] = ...) -> None:
...
class JobExtractSourceModel(dict):
    ...
    def __init__(__self__, *, dataset_id: _builtins.str, model_id: _builtins.str, project_id: _builtins.str) -> None:
...
class JobLoad(dict):
    ...
    def __init__(__self__, *, destination_table: outputs.JobLoadDestinationTable, source_uris: Sequence[_builtins.str], allow_jagged_rows: Optional[_builtins.bool] = ..., allow_quoted_newlines: Optional[_builtins.bool] = ..., autodetect: Optional[_builtins.bool] = ..., create_disposition: Optional[_builtins.str] = ..., destination_encryption_configuration: Optional[outputs.JobLoadDestinationEncryptionConfiguration] = ..., encoding: Optional[_builtins.str] = ..., field_delimiter: Optional[_builtins.str] = ..., ignore_unknown_values: Optional[_builtins.bool] = ..., json_extension: Optional[_builtins.str] = ..., max_bad_records: Optional[_builtins.int] = ..., null_marker: Optional[_builtins.str] = ..., parquet_options: Optional[outputs.JobLoadParquetOptions] = ..., projection_fields: Optional[Sequence[_builtins.str]] = ..., quote: Optional[_builtins.str] = ..., schema_update_options: Optional[Sequence[_builtins.str]] = ..., skip_leading_rows: Optional[_builtins.int] = ..., source_format: Optional[_builtins.str] = ..., time_partitioning: Optional[outputs.JobLoadTimePartitioning] = ..., write_disposition: Optional[_builtins.str] = ...) -> None:
...
class JobLoadParquetOptions(dict):
    ...
    def __init__(__self__, *, enable_list_inference: Optional[_builtins.bool] = ..., enum_as_string: Optional[_builtins.bool] = ...) -> None:
...
class JobLoadTimePartitioning(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, expiration_ms: Optional[_builtins.str] = ..., field: Optional[_builtins.str] = ...) -> None:
...
class JobQuery(dict):
    ...
    def __init__(__self__, *, query: _builtins.str, allow_large_results: Optional[_builtins.bool] = ..., connection_properties: Optional[Sequence[outputs.JobQueryConnectionProperty]] = ..., continuous: Optional[_builtins.bool] = ..., create_disposition: Optional[_builtins.str] = ..., default_dataset: Optional[outputs.JobQueryDefaultDataset] = ..., destination_encryption_configuration: Optional[outputs.JobQueryDestinationEncryptionConfiguration] = ..., destination_table: Optional[outputs.JobQueryDestinationTable] = ..., flatten_results: Optional[_builtins.bool] = ..., maximum_billing_tier: Optional[_builtins.int] = ..., maximum_bytes_billed: Optional[_builtins.str] = ..., parameter_mode: Optional[_builtins.str] = ..., priority: Optional[_builtins.str] = ..., schema_update_options: Optional[Sequence[_builtins.str]] = ..., script_options: Optional[outputs.JobQueryScriptOptions] = ..., use_legacy_sql: Optional[_builtins.bool] = ..., use_query_cache: Optional[_builtins.bool] = ..., user_defined_function_resources: Optional[Sequence[outputs.JobQueryUserDefinedFunctionResource]] = ..., write_disposition: Optional[_builtins.str] = ...) -> None:
...
class JobQueryDefaultDataset(dict):
    ...
    def __init__(__self__, *, dataset_id: _builtins.str, project_id: Optional[_builtins.str] = ...) -> None:
...
class JobQueryScriptOptions(dict):
    ...
    def __init__(__self__, *, key_result_statement: Optional[_builtins.str] = ..., statement_byte_budget: Optional[_builtins.str] = ..., statement_timeout_ms: Optional[_builtins.str] = ...) -> None:
...
class JobQueryUserDefinedFunctionResource(dict):
    ...
    def __init__(__self__, *, inline_code: Optional[_builtins.str] = ..., resource_uri: Optional[_builtins.str] = ...) -> None:
...
class JobStatus(dict):
    ...
    def __init__(__self__, *, error_results: Optional[Sequence[outputs.JobStatusErrorResult]] = ..., errors: Optional[Sequence[outputs.JobStatusError]] = ..., state: Optional[_builtins.str] = ...) -> None:
...
class JobStatusError(dict):
    def __init__(__self__, *, location: Optional[_builtins.str] = ..., message: Optional[_builtins.str] = ..., reason: Optional[_builtins.str] = ...) -> None:
...
class ReservationAutoscale(dict):
    ...
    def __init__(__self__, *, current_slots: Optional[_builtins.int] = ..., max_slots: Optional[_builtins.int] = ...) -> None:
...
class ReservationReplicationStatus(dict):
    ...
    def __init__(__self__, *, errors: Optional[Sequence[outputs.ReservationReplicationStatusError]] = ..., last_error_time: Optional[_builtins.str] = ..., last_replication_time: Optional[_builtins.str] = ...) -> None:
...
class RoutineArgument(dict):
    ...
    def __init__(__self__, *, argument_kind: Optional[_builtins.str] = ..., data_type: Optional[_builtins.str] = ..., mode: Optional[_builtins.str] = ..., name: Optional[_builtins.str] = ...) -> None:
...
class RoutineExternalRuntimeOptions(dict):
    ...
    def __init__(__self__, *, container_cpu: Optional[_builtins.float] = ..., container_memory: Optional[_builtins.str] = ..., max_batching_rows: Optional[_builtins.str] = ..., runtime_connection: Optional[_builtins.str] = ..., runtime_version: Optional[_builtins.str] = ...) -> None:
...
class RoutinePythonOptions(dict):
    ...
    def __init__(__self__, *, entry_point: _builtins.str, packages: Optional[Sequence[_builtins.str]] = ...) -> None:
...
class RoutineRemoteFunctionOptions(dict):
    ...
    def __init__(__self__, *, connection: Optional[_builtins.str] = ..., endpoint: Optional[_builtins.str] = ..., max_batching_rows: Optional[_builtins.str] = ..., user_defined_context: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class RoutineSparkOptions(dict):
    ...
    def __init__(__self__, *, archive_uris: Optional[Sequence[_builtins.str]] = ..., connection: Optional[_builtins.str] = ..., container_image: Optional[_builtins.str] = ..., file_uris: Optional[Sequence[_builtins.str]] = ..., jar_uris: Optional[Sequence[_builtins.str]] = ..., main_class: Optional[_builtins.str] = ..., main_file_uri: Optional[_builtins.str] = ..., properties: Optional[Mapping[str, _builtins.str]] = ..., py_file_uris: Optional[Sequence[_builtins.str]] = ..., runtime_version: Optional[_builtins.str] = ...) -> None:
...
class TableBiglakeConfiguration(dict):
    ...
    def __init__(__self__, *, connection_id: _builtins.str, file_format: _builtins.str, storage_uri: _builtins.str, table_format: _builtins.str) -> None:
...
class TableExternalCatalogTableOptions(dict):
    ...
    def __init__(__self__, *, connection_id: Optional[_builtins.str] = ..., parameters: Optional[Mapping[str, _builtins.str]] = ..., storage_descriptor: Optional[outputs.TableExternalCatalogTableOptionsStorageDescriptor] = ...) -> None:
...
class TableExternalCatalogTableOptionsStorageDescriptor(dict):
    ...
    def __init__(__self__, *, input_format: Optional[_builtins.str] = ..., location_uri: Optional[_builtins.str] = ..., output_format: Optional[_builtins.str] = ..., serde_info: Optional[outputs.TableExternalCatalogTableOptionsStorageDescriptorSerdeInfo] = ...) -> None:
...
class TableExternalCatalogTableOptionsStorageDescriptorSerdeInfo(dict):
    ...
    def __init__(__self__, *, serialization_library: _builtins.str, name: Optional[_builtins.str] = ..., parameters: Optional[Mapping[str, _builtins.str]] = ...) -> None:
...
class TableExternalDataConfiguration(dict):
    ...
    def __init__(__self__, *, autodetect: _builtins.bool, source_uris: Sequence[_builtins.str], avro_options: Optional[outputs.TableExternalDataConfigurationAvroOptions] = ..., bigtable_options: Optional[outputs.TableExternalDataConfigurationBigtableOptions] = ..., compression: Optional[_builtins.str] = ..., connection_id: Optional[_builtins.str] = ..., csv_options: Optional[outputs.TableExternalDataConfigurationCsvOptions] = ..., decimal_target_types: Optional[Sequence[_builtins.str]] = ..., file_set_spec_type: Optional[_builtins.str] = ..., google_sheets_options: Optional[outputs.TableExternalDataConfigurationGoogleSheetsOptions] = ..., hive_partitioning_options: Optional[outputs.TableExternalDataConfigurationHivePartitioningOptions] = ..., ignore_unknown_values: Optional[_builtins.bool] = ..., json_extension: Optional[_builtins.str] = ..., json_options: Optional[outputs.TableExternalDataConfigurationJsonOptions] = ..., max_bad_records: Optional[_builtins.int] = ..., metadata_cache_mode: Optional[_builtins.str] = ..., object_metadata: Optional[_builtins.str] = ..., parquet_options: Optional[outputs.TableExternalDataConfigurationParquetOptions] = ..., reference_file_schema_uri: Optional[_builtins.str] = ..., schema: Optional[_builtins.str] = ..., source_format: Optional[_builtins.str] = ...) -> None:
...
class TableExternalDataConfigurationBigtableOptions(dict):
    ...
    def __init__(__self__, *, column_families: Optional[Sequence[outputs.TableExternalDataConfigurationBigtableOptionsColumnFamily]] = ..., ignore_unspecified_column_families: Optional[_builtins.bool] = ..., output_column_families_as_json: Optional[_builtins.bool] = ..., read_rowkey_as_string: Optional[_builtins.bool] = ...) -> None:
...
class TableExternalDataConfigurationBigtableOptionsColumnFamily(dict):
    ...
    def __init__(__self__, *, columns: Optional[Sequence[outputs.TableExternalDataConfigurationBigtableOptionsColumnFamilyColumn]] = ..., encoding: Optional[_builtins.str] = ..., family_id: Optional[_builtins.str] = ..., only_read_latest: Optional[_builtins.bool] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class TableExternalDataConfigurationBigtableOptionsColumnFamilyColumn(dict):
    ...
    def __init__(__self__, *, encoding: Optional[_builtins.str] = ..., field_name: Optional[_builtins.str] = ..., only_read_latest: Optional[_builtins.bool] = ..., qualifier_encoded: Optional[_builtins.str] = ..., qualifier_string: Optional[_builtins.str] = ..., type: Optional[_builtins.str] = ...) -> None:
...
class TableExternalDataConfigurationCsvOptions(dict):
    ...
    def __init__(__self__, *, quote: _builtins.str, allow_jagged_rows: Optional[_builtins.bool] = ..., allow_quoted_newlines: Optional[_builtins.bool] = ..., encoding: Optional[_builtins.str] = ..., field_delimiter: Optional[_builtins.str] = ..., skip_leading_rows: Optional[_builtins.int] = ..., source_column_match: Optional[_builtins.str] = ...) -> None:
...
class TableExternalDataConfigurationGoogleSheetsOptions(dict):
    ...
    def __init__(__self__, *, range: Optional[_builtins.str] = ..., skip_leading_rows: Optional[_builtins.int] = ...) -> None:
...
class TableExternalDataConfigurationHivePartitioningOptions(dict):
    ...
    def __init__(__self__, *, mode: Optional[_builtins.str] = ..., require_partition_filter: Optional[_builtins.bool] = ..., source_uri_prefix: Optional[_builtins.str] = ...) -> None:
...
class TableMaterializedView(dict):
    ...
    def __init__(__self__, *, query: _builtins.str, allow_non_incremental_definition: Optional[_builtins.bool] = ..., enable_refresh: Optional[_builtins.bool] = ..., refresh_interval_ms: Optional[_builtins.int] = ...) -> None:
...
class TableRangePartitioning(dict):
    def __init__(__self__, *, field: _builtins.str, range: outputs.TableRangePartitioningRange) -> None:
...
class TableRangePartitioningRange(dict):
    def __init__(__self__, *, end: _builtins.int, interval: _builtins.int, start: _builtins.int) -> None:
...
class TableTableConstraints(dict):
    ...
    def __init__(__self__, *, foreign_keys: Optional[Sequence[outputs.TableTableConstraintsForeignKey]] = ..., primary_key: Optional[outputs.TableTableConstraintsPrimaryKey] = ...) -> None:
...
class TableTableConstraintsForeignKey(dict):
    ...
    def __init__(__self__, *, column_references: outputs.TableTableConstraintsForeignKeyColumnReferences, referenced_table: outputs.TableTableConstraintsForeignKeyReferencedTable, name: Optional[_builtins.str] = ...) -> None:
...
class TableTableConstraintsForeignKeyColumnReferences(dict):
    ...
    def __init__(__self__, *, referenced_column: _builtins.str, referencing_column: _builtins.str) -> None:
...
class TableTableReplicationInfo(dict):
    ...
    def __init__(__self__, *, source_dataset_id: _builtins.str, source_project_id: _builtins.str, source_table_id: _builtins.str, replication_interval_ms: Optional[_builtins.int] = ...) -> None:
...
class TableTimePartitioning(dict):
    ...
    def __init__(__self__, *, type: _builtins.str, expiration_ms: Optional[_builtins.int] = ..., field: Optional[_builtins.str] = ..., require_partition_filter: Optional[_builtins.bool] = ...) -> None:
...
class TableView(dict):
    ...
    def __init__(__self__, *, query: _builtins.str, use_legacy_sql: Optional[_builtins.bool] = ...) -> None:
...
class GetDatasetAccessResult(dict):
    def __init__(__self__, *, conditions: Sequence[outputs.GetDatasetAccessConditionResult], datasets: Sequence[outputs.GetDatasetAccessDatasetResult], domain: _builtins.str, group_by_email: _builtins.str, iam_member: _builtins.str, role: _builtins.str, routines: Sequence[outputs.GetDatasetAccessRoutineResult], special_group: _builtins.str, user_by_email: _builtins.str, views: Sequence[outputs.GetDatasetAccessViewResult]) -> None:
...
class GetDatasetAccessConditionResult(dict):
    def __init__(__self__, *, description: _builtins.str, expression: _builtins.str, location: _builtins.str, title: _builtins.str) -> None:
...
class GetDatasetAccessDatasetResult(dict):
    def __init__(__self__, *, datasets: Sequence[outputs.GetDatasetAccessDatasetDatasetResult], target_types: Sequence[_builtins.str]) -> None:
...
class GetDatasetExternalCatalogDatasetOptionResult(dict):
    def __init__(__self__, *, default_storage_location_uri: _builtins.str, parameters: Mapping[str, _builtins.str]) -> None:
...
class GetDatasetsDatasetResult(dict):
    def __init__(__self__, *, dataset_id: _builtins.str, friendly_name: _builtins.str, labels: Mapping[str, _builtins.str], location: _builtins.str) -> None:
...
class GetTableEncryptionConfigurationResult(dict):
    def __init__(__self__, *, kms_key_name: _builtins.str, kms_key_version: _builtins.str) -> None:
...
class GetTableExternalCatalogTableOptionResult(dict):
    def __init__(__self__, *, connection_id: _builtins.str, parameters: Mapping[str, _builtins.str], storage_descriptors: Sequence[outputs.GetTableExternalCatalogTableOptionStorageDescriptorResult]) -> None:
...
class GetTableExternalCatalogTableOptionStorageDescriptorResult(dict):
    def __init__(__self__, *, input_format: _builtins.str, location_uri: _builtins.str, output_format: _builtins.str, serde_infos: Sequence[outputs.GetTableExternalCatalogTableOptionStorageDescriptorSerdeInfoResult]) -> None:
...
class GetTableExternalCatalogTableOptionStorageDescriptorSerdeInfoResult(dict):
    def __init__(__self__, *, name: _builtins.str, parameters: Mapping[str, _builtins.str], serialization_library: _builtins.str) -> None:
...
class GetTableExternalDataConfigurationResult(dict):
    def __init__(__self__, *, autodetect: _builtins.bool, avro_options: Sequence[outputs.GetTableExternalDataConfigurationAvroOptionResult], bigtable_options: Sequence[outputs.GetTableExternalDataConfigurationBigtableOptionResult], compression: _builtins.str, connection_id: _builtins.str, csv_options: Sequence[outputs.GetTableExternalDataConfigurationCsvOptionResult], decimal_target_types: Sequence[_builtins.str], file_set_spec_type: _builtins.str, google_sheets_options: Sequence[outputs.GetTableExternalDataConfigurationGoogleSheetsOptionResult], hive_partitioning_options: Sequence[outputs.GetTableExternalDataConfigurationHivePartitioningOptionResult], ignore_unknown_values: _builtins.bool, json_extension: _builtins.str, json_options: Sequence[outputs.GetTableExternalDataConfigurationJsonOptionResult], max_bad_records: _builtins.int, metadata_cache_mode: _builtins.str, object_metadata: _builtins.str, parquet_options: Sequence[outputs.GetTableExternalDataConfigurationParquetOptionResult], reference_file_schema_uri: _builtins.str, schema: _builtins.str, source_format: _builtins.str, source_uris: Sequence[_builtins.str]) -> None:
...
class GetTableExternalDataConfigurationBigtableOptionResult(dict):
    def __init__(__self__, *, column_families: Sequence[outputs.GetTableExternalDataConfigurationBigtableOptionColumnFamilyResult], ignore_unspecified_column_families: _builtins.bool, output_column_families_as_json: _builtins.bool, read_rowkey_as_string: _builtins.bool) -> None:
...
class GetTableExternalDataConfigurationBigtableOptionColumnFamilyResult(dict):
    def __init__(__self__, *, columns: Sequence[outputs.GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumnResult], encoding: _builtins.str, family_id: _builtins.str, only_read_latest: _builtins.bool, type: _builtins.str) -> None:
...
class GetTableExternalDataConfigurationBigtableOptionColumnFamilyColumnResult(dict):
    def __init__(__self__, *, encoding: _builtins.str, field_name: _builtins.str, only_read_latest: _builtins.bool, qualifier_encoded: _builtins.str, qualifier_string: _builtins.str, type: _builtins.str) -> None:
...
class GetTableExternalDataConfigurationCsvOptionResult(dict):
    def __init__(__self__, *, allow_jagged_rows: _builtins.bool, allow_quoted_newlines: _builtins.bool, encoding: _builtins.str, field_delimiter: _builtins.str, quote: _builtins.str, skip_leading_rows: _builtins.int, source_column_match: _builtins.str) -> None:
...
class GetTableExternalDataConfigurationGoogleSheetsOptionResult(dict):
    def __init__(__self__, *, range: _builtins.str, skip_leading_rows: _builtins.int) -> None:
...
class GetTableExternalDataConfigurationHivePartitioningOptionResult(dict):
    def __init__(__self__, *, mode: _builtins.str, require_partition_filter: _builtins.bool, source_uri_prefix: _builtins.str) -> None:
...
class GetTableExternalDataConfigurationParquetOptionResult(dict):
    def __init__(__self__, *, enable_list_inference: _builtins.bool, enum_as_string: _builtins.bool) -> None:
...
class GetTableMaterializedViewResult(dict):
    def __init__(__self__, *, allow_non_incremental_definition: _builtins.bool, enable_refresh: _builtins.bool, query: _builtins.str, refresh_interval_ms: _builtins.int) -> None:
...
class GetTableRangePartitioningResult(dict):
    def __init__(__self__, *, field: _builtins.str, ranges: Sequence[outputs.GetTableRangePartitioningRangeResult]) -> None:
...
class GetTableTableConstraintResult(dict):
    def __init__(__self__, *, foreign_keys: Sequence[outputs.GetTableTableConstraintForeignKeyResult], primary_keys: Sequence[outputs.GetTableTableConstraintPrimaryKeyResult]) -> None:
...
class GetTableTableConstraintForeignKeyResult(dict):
    def __init__(__self__, *, column_references: Sequence[outputs.GetTableTableConstraintForeignKeyColumnReferenceResult], name: _builtins.str, referenced_tables: Sequence[outputs.GetTableTableConstraintForeignKeyReferencedTableResult]) -> None:
...
class GetTableTableReplicationInfoResult(dict):
    def __init__(__self__, *, replication_interval_ms: _builtins.int, source_dataset_id: _builtins.str, source_project_id: _builtins.str, source_table_id: _builtins.str) -> None:
...
class GetTableTimePartitioningResult(dict):
    def __init__(__self__, *, expiration_ms: _builtins.int, field: _builtins.str, require_partition_filter: _builtins.bool, type: _builtins.str) -> None:
...
class GetTableViewResult(dict):
    def __init__(__self__, *, query: _builtins.str, use_legacy_sql: _builtins.bool) -> None:
...
class GetTablesTableResult(dict):
    def __init__(__self__, *, labels: Mapping[str, _builtins.str], table_id: _builtins.str) -> None:
